...
class AccountBase {
    ...
    /**
     * Validates the JSON data with respect to <code>AccountBase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountBase</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountBase.RequiredProperties) {
...
AccountBase.RequiredProperties = ["account_id", "balances", "mask", "name", "official_name", "subtype", "type"];
