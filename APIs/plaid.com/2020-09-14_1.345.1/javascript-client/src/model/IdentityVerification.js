...
/**
 * The IdentityVerification model module.
 * @module model/IdentityVerification
 * @version 2020-09-14_1.345.1
 */
class IdentityVerification {
    /**
     * Constructs a new <code>IdentityVerification</code>.
     * A identity verification attempt represents a customer&#39;s attempt to verify their identity, reflecting the required steps for completing the session, the results for each step, and information collected in the process.
     * @alias module:model/IdentityVerification
     * @extends Object
     ...
     */
    constructor(clientUserId, completedAt, createdAt, documentaryVerification, id, kycCheck, previousAttemptId, redactedAt, riskCheck, shareableUrl, status, steps, template, user, watchlistScreeningId) { 
        
        IdentityVerification.initialize(this, clientUserId, completedAt, createdAt, documentaryVerification, id, kycCheck, previousAttemptId, redactedAt, riskCheck, shareableUrl, status, steps, template, user, watchlistScreeningId);
    }
     ...
     */
    static initialize(obj, clientUserId, completedAt, createdAt, documentaryVerification, id, kycCheck, previousAttemptId, redactedAt, riskCheck, shareableUrl, status, steps, template, user, watchlistScreeningId) { 
    ...
    /**
     * Constructs a <code>IdentityVerification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IdentityVerification} obj Optional instance to populate.
     * @return {module:model/IdentityVerification} The populated <code>IdentityVerification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IdentityVerification();
    ...
    /**
     * Validates the JSON data with respect to <code>IdentityVerification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IdentityVerification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IdentityVerification.RequiredProperties) {
...
IdentityVerification.RequiredProperties = ["client_user_id", "completed_at", "created_at", "documentary_verification", "id", "kyc_check", "previous_attempt_id", "redacted_at", "risk_check", "shareable_url", "status", "steps", "template", "user", "watchlist_screening_id"];

/**
 * An identifier to help you connect this object to your internal systems. For example, your database ID corresponding to this object.
 * @member {String} client_user_id
 */
IdentityVerification.prototype['client_user_id'] = undefined;

/**
 * An ISO8601 formatted timestamp.
 * @member {Date} completed_at
 */
IdentityVerification.prototype['completed_at'] = undefined;

/**
 * An ISO8601 formatted timestamp.
 * @member {Date} created_at
 */
IdentityVerification.prototype['created_at'] = undefined;

/**
 * @member {module:model/DocumentaryVerification} documentary_verification
 */
IdentityVerification.prototype['documentary_verification'] = undefined;

/**
 * ID of the associated Identity Verification attempt.
 * @member {String} id
 */
IdentityVerification.prototype['id'] = undefined;

/**
 * @member {module:model/KYCCheckDetails} kyc_check
 */
IdentityVerification.prototype['kyc_check'] = undefined;
 ...
 */
IdentityVerification.prototype['previous_attempt_id'] = undefined;

/**
 * An ISO8601 formatted timestamp.
 * @member {Date} redacted_at
 */
IdentityVerification.prototype['redacted_at'] = undefined;

/**
 * @member {module:model/RiskCheckDetails} risk_check
 */
IdentityVerification.prototype['risk_check'] = undefined;

/**
 * A shareable URL that can be sent directly to the user to complete verification
 * @member {String} shareable_url
 */
IdentityVerification.prototype['shareable_url'] = undefined;

/**
 * @member {module:model/IdentityVerificationStatus} status
 */
IdentityVerification.prototype['status'] = undefined;

/**
 * @member {module:model/IdentityVerificationStepSummary} steps
 */
IdentityVerification.prototype['steps'] = undefined;

/**
 * @member {module:model/IdentityVerificationTemplateReference} template
 */
IdentityVerification.prototype['template'] = undefined;

/**
 * @member {module:model/IdentityVerificationUserData} user
 */
IdentityVerification.prototype['user'] = undefined;

/**
 * ID of the associated screening.
 * @member {String} watchlist_screening_id
 */
IdentityVerification.prototype['watchlist_screening_id'] = undefined;
