...
/**
 * The RecurringTransferNullable model module.
 * @module model/RecurringTransferNullable
 * @version 2020-09-14_1.345.1
 */
class RecurringTransferNullable {
    /**
     * Constructs a new <code>RecurringTransferNullable</code>.
     * Represents a recurring transfer within the Transfers API.
     * @alias module:model/RecurringTransferNullable
     * @extends Object
     * @implements module:model/RecurringTransfer
    ...
    constructor(accountId, amount, created, description, fundingAccountId, isoCurrencyCode, network, nextOriginationDate, originationAccountId, recurringTransferId, schedule, status, transferIds, type, user) { 
        ...
        RecurringTransferNullable.initialize(this, accountId, amount, created, description, fundingAccountId, isoCurrencyCode, network, nextOriginationDate, originationAccountId, recurringTransferId, schedule, status, transferIds, type, user);
    }
    ...
    /**
     * Constructs a <code>RecurringTransferNullable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RecurringTransferNullable} obj Optional instance to populate.
     * @return {module:model/RecurringTransferNullable} The populated <code>RecurringTransferNullable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecurringTransferNullable();

            ApiClient.constructFromObject(data, obj, 'Object');
            
            RecurringTransfer.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>RecurringTransferNullable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RecurringTransferNullable</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RecurringTransferNullable.RequiredProperties) {
...
RecurringTransferNullable.RequiredProperties = ["account_id", "amount", "created", "description", "funding_account_id", "iso_currency_code", "network", "next_origination_date", "origination_account_id", "recurring_transfer_id", "schedule", "status", "transfer_ids", "type", "user"];

/**
 * The Plaid `account_id` corresponding to the end-user account that will be debited or credited.
 * @member {String} account_id
 */
RecurringTransferNullable.prototype['account_id'] = undefined;

/**
 * @member {module:model/ACHClass} ach_class
 */
RecurringTransferNullable.prototype['ach_class'] = undefined;

/**
 * The amount of the transfer (decimal string with two digits of precision e.g. \"10.00\").
 * @member {String} amount
 */
RecurringTransferNullable.prototype['amount'] = undefined;

/**
 * The datetime when this transfer was created. This will be of the form `2006-01-02T15:04:05Z`
 * @member {Date} created
 */
RecurringTransferNullable.prototype['created'] = undefined;

/**
 * The description of the recurring transfer.
 * @member {String} description
 */
RecurringTransferNullable.prototype['description'] = undefined;

/**
 * The id of the funding account to use, available in the Plaid Dashboard. This determines which of your business checking accounts will be credited or debited.
 * @member {String} funding_account_id
 */
RecurringTransferNullable.prototype['funding_account_id'] = undefined;

/**
 * The currency of the transfer amount, e.g. \"USD\"
 * @member {String} iso_currency_code
 */
RecurringTransferNullable.prototype['iso_currency_code'] = undefined;

/**
 * @member {module:model/TransferNetwork} network
 */
RecurringTransferNullable.prototype['network'] = undefined;
 ...
 */
RecurringTransferNullable.prototype['next_origination_date'] = undefined;

/**
 * Plaid’s unique identifier for the origination account that was used for this transfer.
 * @member {String} origination_account_id
 */
RecurringTransferNullable.prototype['origination_account_id'] = undefined;

/**
 * Plaid’s unique identifier for a recurring transfer.
 * @member {String} recurring_transfer_id
 */
RecurringTransferNullable.prototype['recurring_transfer_id'] = undefined;

/**
 * @member {module:model/TransferRecurringSchedule} schedule
 */
RecurringTransferNullable.prototype['schedule'] = undefined;

/**
 * @member {module:model/TransferRecurringStatus} status
 */
RecurringTransferNullable.prototype['status'] = undefined;

/**
 * Plaid’s unique identifier for a test clock.
 * @member {String} test_clock_id
 */
RecurringTransferNullable.prototype['test_clock_id'] = undefined;

/**
 * @member {Array.<String>} transfer_ids
 */
RecurringTransferNullable.prototype['transfer_ids'] = undefined;

/**
 * @member {module:model/TransferType} type
 */
RecurringTransferNullable.prototype['type'] = undefined;

/**
 * @member {module:model/TransferUserInResponse} user
 */
RecurringTransferNullable.prototype['user'] = undefined;


// Implement RecurringTransfer interface:
/**
 * The Plaid `account_id` corresponding to the end-user account that will be debited or credited.
 * @member {String} account_id
 */
...
export default RecurringTransferNullable;
