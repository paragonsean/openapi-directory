...
/**
 * The WatchlistScreeningIndividualUpdateResponse model module.
 * @module model/WatchlistScreeningIndividualUpdateResponse
 * @version 2020-09-14_1.345.1
 */
class WatchlistScreeningIndividualUpdateResponse {
    /**
     * Constructs a new <code>WatchlistScreeningIndividualUpdateResponse</code>.
     ...
     * @alias module:model/WatchlistScreeningIndividualUpdateResponse
     * @extends Object
    ...
    constructor(assignee, auditTrail, clientUserId, id, requestId, searchTerms, status) { 
        ...
        WatchlistScreeningIndividualUpdateResponse.initialize(this, assignee, auditTrail, clientUserId, id, requestId, searchTerms, status);
    }
    ...
    /**
     * Constructs a <code>WatchlistScreeningIndividualUpdateResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WatchlistScreeningIndividualUpdateResponse} obj Optional instance to populate.
     * @return {module:model/WatchlistScreeningIndividualUpdateResponse} The populated <code>WatchlistScreeningIndividualUpdateResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WatchlistScreeningIndividualUpdateResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>WatchlistScreeningIndividualUpdateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WatchlistScreeningIndividualUpdateResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WatchlistScreeningIndividualUpdateResponse.RequiredProperties) {
...
WatchlistScreeningIndividualUpdateResponse.RequiredProperties = ["assignee", "audit_trail", "client_user_id", "id", "request_id", "search_terms", "status"];

/**
 * ID of the associated user.
 * @member {String} assignee
 */
WatchlistScreeningIndividualUpdateResponse.prototype['assignee'] = undefined;

/**
 * @member {module:model/WatchlistScreeningAuditTrail} audit_trail
 */
WatchlistScreeningIndividualUpdateResponse.prototype['audit_trail'] = undefined;

/**
 * An identifier to help you connect this object to your internal systems. For example, your database ID corresponding to this object.
 * @member {String} client_user_id
 */
WatchlistScreeningIndividualUpdateResponse.prototype['client_user_id'] = undefined;

/**
 * ID of the associated screening.
 * @member {String} id
 */
WatchlistScreeningIndividualUpdateResponse.prototype['id'] = undefined;

/**
 * A unique identifier for the request, which can be used for troubleshooting. This identifier, like all Plaid identifiers, is case sensitive.
 * @member {String} request_id
 */
WatchlistScreeningIndividualUpdateResponse.prototype['request_id'] = undefined;

/**
 * @member {module:model/WatchlistScreeningSearchTerms} search_terms
 */
WatchlistScreeningIndividualUpdateResponse.prototype['search_terms'] = undefined;

/**
 * @member {module:model/WatchlistScreeningStatus} status
 */
WatchlistScreeningIndividualUpdateResponse.prototype['status'] = undefined;
...
export default WatchlistScreeningIndividualUpdateResponse;
