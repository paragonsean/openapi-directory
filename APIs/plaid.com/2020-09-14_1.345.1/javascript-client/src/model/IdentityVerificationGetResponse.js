...
/**
 * The IdentityVerificationGetResponse model module.
 * @module model/IdentityVerificationGetResponse
 * @version 2020-09-14_1.345.1
 */
class IdentityVerificationGetResponse {
    /**
     * Constructs a new <code>IdentityVerificationGetResponse</code>.
     * A identity verification attempt represents a customer&#39;s attempt to verify their identity, reflecting the required steps for completing the session, the results for each step, and information collected in the process.
     * @alias module:model/IdentityVerificationGetResponse
     * @extends Object
    ...
    constructor(clientUserId, completedAt, createdAt, documentaryVerification, id, kycCheck, previousAttemptId, redactedAt, requestId, riskCheck, shareableUrl, status, steps, template, user, watchlistScreeningId) { 
        ...
        IdentityVerificationGetResponse.initialize(this, clientUserId, completedAt, createdAt, documentaryVerification, id, kycCheck, previousAttemptId, redactedAt, requestId, riskCheck, shareableUrl, status, steps, template, user, watchlistScreeningId);
    }
    ...
    /**
     * Constructs a <code>IdentityVerificationGetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IdentityVerificationGetResponse} obj Optional instance to populate.
     * @return {module:model/IdentityVerificationGetResponse} The populated <code>IdentityVerificationGetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IdentityVerificationGetResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>IdentityVerificationGetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IdentityVerificationGetResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IdentityVerificationGetResponse.RequiredProperties) {
...
IdentityVerificationGetResponse.RequiredProperties = ["client_user_id", "completed_at", "created_at", "documentary_verification", "id", "kyc_check", "previous_attempt_id", "redacted_at", "request_id", "risk_check", "shareable_url", "status", "steps", "template", "user", "watchlist_screening_id"];

/**
 * An identifier to help you connect this object to your internal systems. For example, your database ID corresponding to this object.
 * @member {String} client_user_id
 */
IdentityVerificationGetResponse.prototype['client_user_id'] = undefined;

/**
 * An ISO8601 formatted timestamp.
 * @member {Date} completed_at
 */
IdentityVerificationGetResponse.prototype['completed_at'] = undefined;

/**
 * An ISO8601 formatted timestamp.
 * @member {Date} created_at
 */
IdentityVerificationGetResponse.prototype['created_at'] = undefined;

/**
 * @member {module:model/DocumentaryVerification} documentary_verification
 */
IdentityVerificationGetResponse.prototype['documentary_verification'] = undefined;

/**
 * ID of the associated Identity Verification attempt.
 * @member {String} id
 */
IdentityVerificationGetResponse.prototype['id'] = undefined;

/**
 * @member {module:model/KYCCheckDetails} kyc_check
 */
IdentityVerificationGetResponse.prototype['kyc_check'] = undefined;
 ...
 */
IdentityVerificationGetResponse.prototype['previous_attempt_id'] = undefined;

/**
 * An ISO8601 formatted timestamp.
 * @member {Date} redacted_at
 */
IdentityVerificationGetResponse.prototype['redacted_at'] = undefined;

/**
 * A unique identifier for the request, which can be used for troubleshooting. This identifier, like all Plaid identifiers, is case sensitive.
 * @member {String} request_id
 */
IdentityVerificationGetResponse.prototype['request_id'] = undefined;

/**
 * @member {module:model/RiskCheckDetails} risk_check
 */
IdentityVerificationGetResponse.prototype['risk_check'] = undefined;

/**
 * A shareable URL that can be sent directly to the user to complete verification
 * @member {String} shareable_url
 */
IdentityVerificationGetResponse.prototype['shareable_url'] = undefined;

/**
 * @member {module:model/IdentityVerificationStatus} status
 */
IdentityVerificationGetResponse.prototype['status'] = undefined;

/**
 * @member {module:model/IdentityVerificationStepSummary} steps
 */
IdentityVerificationGetResponse.prototype['steps'] = undefined;

/**
 * @member {module:model/IdentityVerificationTemplateReference} template
 */
IdentityVerificationGetResponse.prototype['template'] = undefined;

/**
 * @member {module:model/IdentityVerificationUserData} user
 */
IdentityVerificationGetResponse.prototype['user'] = undefined;

/**
 * ID of the associated screening.
 * @member {String} watchlist_screening_id
 */
IdentityVerificationGetResponse.prototype['watchlist_screening_id'] = undefined;
...
export default IdentityVerificationGetResponse;
