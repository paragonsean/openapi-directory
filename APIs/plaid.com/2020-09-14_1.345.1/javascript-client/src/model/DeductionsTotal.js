...
/**
 * The DeductionsTotal model module.
 * @module model/DeductionsTotal
 * @version 2020-09-14_1.345.1
 */
class DeductionsTotal {
    /**
     * Constructs a new <code>DeductionsTotal</code>.
     * An object representing the total deductions for the pay period
     * @alias module:model/DeductionsTotal
     * @extends Object
     */
    constructor() { 
        
        DeductionsTotal.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeductionsTotal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeductionsTotal} obj Optional instance to populate.
     * @return {module:model/DeductionsTotal} The populated <code>DeductionsTotal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeductionsTotal();
    ...
    /**
     * Validates the JSON data with respect to <code>DeductionsTotal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeductionsTotal</code>.
     */
 ...
 */
DeductionsTotal.prototype['current_amount'] = undefined;

/**
 * The ISO-4217 currency code of the line item. Always `null` if `unofficial_currency_code` is non-null.
 * @member {String} iso_currency_code
 */
DeductionsTotal.prototype['iso_currency_code'] = undefined;
 ...
 */
DeductionsTotal.prototype['unofficial_currency_code'] = undefined;

/**
 * The year-to-date total amount of the deductions
 * @member {Number} ytd_amount
 */
DeductionsTotal.prototype['ytd_amount'] = undefined;
...
export default DeductionsTotal;
