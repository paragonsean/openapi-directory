...
/**
 * The NumbersACHNullable model module.
 * @module model/NumbersACHNullable
 * @version 2020-09-14_1.345.1
 */
class NumbersACHNullable {
    /**
     * Constructs a new <code>NumbersACHNullable</code>.
     * Identifying information for transferring money to or from a US account via ACH or wire transfer.
     * @alias module:model/NumbersACHNullable
     * @implements module:model/NumbersACH
    ...
    constructor(account, accountId, routing, wireRouting) { 
        ...
        NumbersACHNullable.initialize(this, account, accountId, routing, wireRouting);
    }
    ...
    /**
     * Constructs a <code>NumbersACHNullable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NumbersACHNullable} obj Optional instance to populate.
     * @return {module:model/NumbersACHNullable} The populated <code>NumbersACHNullable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NumbersACHNullable();
            NumbersACH.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>NumbersACHNullable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NumbersACHNullable</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NumbersACHNullable.RequiredProperties) {
...
NumbersACHNullable.RequiredProperties = ["account", "account_id", "routing", "wire_routing"];
 ...
 */
NumbersACHNullable.prototype['account'] = undefined;

/**
 * The Plaid account ID associated with the account numbers
 * @member {String} account_id
 */
NumbersACHNullable.prototype['account_id'] = undefined;

/**
 * Whether the account supports ACH transfers into the account
 * @member {Boolean} can_transfer_in
 */
NumbersACHNullable.prototype['can_transfer_in'] = undefined;

/**
 * Whether the account supports ACH transfers out of the account
 * @member {Boolean} can_transfer_out
 */
NumbersACHNullable.prototype['can_transfer_out'] = undefined;
 ...
 */
NumbersACHNullable.prototype['routing'] = undefined;

/**
 * The wire transfer routing number for the account, if available
 * @member {String} wire_routing
 */
NumbersACHNullable.prototype['wire_routing'] = undefined;


// Implement NumbersACH interface:
/**
 * The ACH account number for the account.  Note that when using OAuth with Chase Bank (`ins_56`), Chase will issue \"tokenized\" routing and account numbers, which are not the user's actual account and routing numbers. These tokenized numbers should work identically to normal account and routing numbers. The digits returned in the `mask` field will continue to reflect the actual account number, rather than the tokenized account number; for this reason, when displaying account numbers to the user to help them identify their account in your UI, always use the `mask` rather than truncating the `account` number. If a user revokes their permissions to your app, the tokenized numbers will continue to work for ACH deposits, but not withdrawals.
 * @member {String} account
 */
...
export default NumbersACHNullable;
