...
/**
 * The PaymentInitiationPaymentGetResponse model module.
 * @module model/PaymentInitiationPaymentGetResponse
 * @version 2020-09-14_1.345.1
 */
class PaymentInitiationPaymentGetResponse {
    /**
     * Constructs a new <code>PaymentInitiationPaymentGetResponse</code>.
     * PaymentInitiationPaymentGetResponse defines the response schema for &#x60;/payment_initation/payment/get&#x60;
     * @alias module:model/PaymentInitiationPaymentGetResponse
     * @extends Object
     * @implements module:model/PaymentInitiationPayment
     ...
     */
    constructor(amount, bacs, iban, lastStatusUpdate, paymentId, recipientId, reference, status, requestId) { 
        PaymentInitiationPayment.initialize(this, amount, bacs, iban, lastStatusUpdate, paymentId, recipientId, reference, status);
        PaymentInitiationPaymentGetResponse.initialize(this, amount, bacs, iban, lastStatusUpdate, paymentId, recipientId, reference, status, requestId);
    }
     ...
     */
    static initialize(obj, amount, bacs, iban, lastStatusUpdate, paymentId, recipientId, reference, status, requestId) { 
        obj['amount'] = amount;
        obj['bacs'] = bacs;
        obj['iban'] = iban;
    ...
    /**
     * Constructs a <code>PaymentInitiationPaymentGetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentInitiationPaymentGetResponse} obj Optional instance to populate.
     * @return {module:model/PaymentInitiationPaymentGetResponse} The populated <code>PaymentInitiationPaymentGetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentInitiationPaymentGetResponse();

            ApiClient.constructFromObject(data, obj, 'Object');
            
            PaymentInitiationPayment.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentInitiationPaymentGetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentInitiationPaymentGetResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentInitiationPaymentGetResponse.RequiredProperties) {
...
PaymentInitiationPaymentGetResponse.RequiredProperties = ["amount", "bacs", "iban", "last_status_update", "payment_id", "recipient_id", "reference", "status", "request_id"];

/**
 * The value of the reference sent to the bank after adjustment to pass bank validation rules.
 * @member {String} adjusted_reference
 */
PaymentInitiationPaymentGetResponse.prototype['adjusted_reference'] = undefined;

/**
 * @member {module:model/PaymentScheme} adjusted_scheme
 */
PaymentInitiationPaymentGetResponse.prototype['adjusted_scheme'] = undefined;

/**
 * @member {module:model/PaymentAmount} amount
 */
PaymentInitiationPaymentGetResponse.prototype['amount'] = undefined;

/**
 * @member {module:model/PaymentAmountRefunded} amount_refunded
 */
PaymentInitiationPaymentGetResponse.prototype['amount_refunded'] = undefined;

/**
 * @member {module:model/SenderBACSNullable} bacs
 */
PaymentInitiationPaymentGetResponse.prototype['bacs'] = undefined;
 ...
 */
PaymentInitiationPaymentGetResponse.prototype['consent_id'] = undefined;

/**
 * The International Bank Account Number (IBAN) for the sender, if specified in the `/payment_initiation/payment/create` call.
 * @member {String} iban
 */
PaymentInitiationPaymentGetResponse.prototype['iban'] = undefined;

/**
 * The date and time of the last time the `status` was updated, in IS0 8601 format
 * @member {Date} last_status_update
 */
PaymentInitiationPaymentGetResponse.prototype['last_status_update'] = undefined;

/**
 * The ID of the payment. Like all Plaid identifiers, the `payment_id` is case sensitive.
 * @member {String} payment_id
 */
PaymentInitiationPaymentGetResponse.prototype['payment_id'] = undefined;

/**
 * The ID of the recipient
 * @member {String} recipient_id
 */
PaymentInitiationPaymentGetResponse.prototype['recipient_id'] = undefined;

/**
 * A reference for the payment.
 * @member {String} reference
 */
PaymentInitiationPaymentGetResponse.prototype['reference'] = undefined;

/**
 * @member {module:model/ExternalPaymentRefundDetails} refund_details
 */
PaymentInitiationPaymentGetResponse.prototype['refund_details'] = undefined;

/**
 * Refund IDs associated with the payment.
 * @member {Array.<String>} refund_ids
 */
PaymentInitiationPaymentGetResponse.prototype['refund_ids'] = undefined;

/**
 * @member {module:model/ExternalPaymentScheduleGet} schedule
 */
PaymentInitiationPaymentGetResponse.prototype['schedule'] = undefined;

/**
 * @member {module:model/PaymentScheme} scheme
 */
PaymentInitiationPaymentGetResponse.prototype['scheme'] = undefined;

/**
 * @member {module:model/PaymentInitiationPaymentStatus} status
 */
PaymentInitiationPaymentGetResponse.prototype['status'] = undefined;
 ...
 */
PaymentInitiationPaymentGetResponse.prototype['transaction_id'] = undefined;

/**
 * The EMI (E-Money Institution) wallet that this payment is associated with, if any. This wallet is used as an intermediary account to enable Plaid to reconcile the settlement of funds for Payment Initiation requests.
 * @member {String} wallet_id
 */
PaymentInitiationPaymentGetResponse.prototype['wallet_id'] = undefined;

/**
 * A unique identifier for the request, which can be used for troubleshooting. This identifier, like all Plaid identifiers, is case sensitive.
 * @member {String} request_id
 */
PaymentInitiationPaymentGetResponse.prototype['request_id'] = undefined;


// Implement PaymentInitiationPayment interface:
/**
 * The value of the reference sent to the bank after adjustment to pass bank validation rules.
 * @member {String} adjusted_reference
 */
...
export default PaymentInitiationPaymentGetResponse;
