...
/**
 * The ExternalPaymentScheduleRequest model module.
 * @module model/ExternalPaymentScheduleRequest
 * @version 2020-09-14_1.345.1
 */
class ExternalPaymentScheduleRequest {
    /**
     * Constructs a new <code>ExternalPaymentScheduleRequest</code>.
     * The schedule that the payment will be executed on. If a schedule is provided, the payment is automatically set up as a standing order. If no schedule is specified, the payment will be executed only once.
     * @alias module:model/ExternalPaymentScheduleRequest
     * @extends Object
     ...
     */
    constructor(interval, intervalExecutionDay, startDate) { 
        ExternalPaymentScheduleBase.initialize(this);
        ExternalPaymentScheduleRequest.initialize(this, interval, intervalExecutionDay, startDate);
    }
     ...
     */
    static initialize(obj, interval, intervalExecutionDay, startDate) { 
    ...
    /**
     * Constructs a <code>ExternalPaymentScheduleRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExternalPaymentScheduleRequest} obj Optional instance to populate.
     * @return {module:model/ExternalPaymentScheduleRequest} The populated <code>ExternalPaymentScheduleRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExternalPaymentScheduleRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ExternalPaymentScheduleRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExternalPaymentScheduleRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExternalPaymentScheduleRequest.RequiredProperties) {
...
ExternalPaymentScheduleRequest.RequiredProperties = ["interval", "interval_execution_day", "start_date"];
 ...
 */
ExternalPaymentScheduleRequest.prototype['adjusted_start_date'] = undefined;
 ...
 */
ExternalPaymentScheduleRequest.prototype['end_date'] = undefined;

/**
 * @member {module:model/PaymentScheduleInterval} interval
 */
ExternalPaymentScheduleRequest.prototype['interval'] = undefined;
 ...
 */
ExternalPaymentScheduleRequest.prototype['interval_execution_day'] = undefined;
 ...
 */
ExternalPaymentScheduleRequest.prototype['start_date'] = undefined;
...
export default ExternalPaymentScheduleRequest;
