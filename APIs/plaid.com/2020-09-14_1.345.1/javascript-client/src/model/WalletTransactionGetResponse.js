...
/**
 * The WalletTransactionGetResponse model module.
 * @module model/WalletTransactionGetResponse
 * @version 2020-09-14_1.345.1
 */
class WalletTransactionGetResponse {
    /**
     * Constructs a new <code>WalletTransactionGetResponse</code>.
     * WalletTransactionGetResponse defines the response schema for &#x60;/wallet/transaction/get&#x60;
     * @alias module:model/WalletTransactionGetResponse
     * @extends Object
     * @implements module:model/WalletTransaction
     ...
     */
    constructor(amount, counterparty, createdAt, lastStatusUpdate, reference, status, transactionId, type, walletId, requestId) { 
        ...
        WalletTransactionGetResponse.initialize(this, amount, counterparty, createdAt, lastStatusUpdate, reference, status, transactionId, type, walletId, requestId);
    }
     ...
     */
    static initialize(obj, amount, counterparty, createdAt, lastStatusUpdate, reference, status, transactionId, type, walletId, requestId) { 
        obj['amount'] = amount;
    ...
    /**
     * Constructs a <code>WalletTransactionGetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WalletTransactionGetResponse} obj Optional instance to populate.
     * @return {module:model/WalletTransactionGetResponse} The populated <code>WalletTransactionGetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WalletTransactionGetResponse();

            ApiClient.constructFromObject(data, obj, 'Object');
            
            WalletTransaction.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>WalletTransactionGetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WalletTransactionGetResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WalletTransactionGetResponse.RequiredProperties) {
...
WalletTransactionGetResponse.RequiredProperties = ["amount", "counterparty", "created_at", "last_status_update", "reference", "status", "transaction_id", "type", "wallet_id", "request_id"];

/**
 * @member {module:model/WalletTransactionAmount} amount
 */
WalletTransactionGetResponse.prototype['amount'] = undefined;

/**
 * @member {module:model/WalletTransactionCounterparty} counterparty
 */
WalletTransactionGetResponse.prototype['counterparty'] = undefined;

/**
 * Timestamp when the transaction was created, in [ISO 8601](https://wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} created_at
 */
WalletTransactionGetResponse.prototype['created_at'] = undefined;

/**
 * The date and time of the last time the `status` was updated, in IS0 8601 format
 * @member {Date} last_status_update
 */
WalletTransactionGetResponse.prototype['last_status_update'] = undefined;
 ...
 */
WalletTransactionGetResponse.prototype['payment_id'] = undefined;

/**
 * A reference for the transaction
 * @member {String} reference
 */
WalletTransactionGetResponse.prototype['reference'] = undefined;

/**
 * @member {module:model/WalletTransactionStatus} status
 */
WalletTransactionGetResponse.prototype['status'] = undefined;

/**
 * A unique ID identifying the transaction
 * @member {String} transaction_id
 */
WalletTransactionGetResponse.prototype['transaction_id'] = undefined;

/**
 * The type of the transaction. The supported transaction types that are returned are: `BANK_TRANSFER:` a transaction which credits an e-wallet through an external bank transfer.  `PAYOUT:` a transaction which debits an e-wallet by disbursing funds to a counterparty.  `PIS_PAY_IN:` a payment which credits an e-wallet through Plaid's Payment Initiation Services (PIS) APIs. For more information see the [Payment Initiation endpoints](https://plaid.com/docs/api/products/payment-initiation/).  `REFUND:` a transaction which debits an e-wallet by refunding a previously initiated payment made through Plaid's [PIS APIs](https://plaid.com/docs/api/products/payment-initiation/).  `FUNDS_SWEEP`: an automated transaction which debits funds from an e-wallet to a designated client-owned account.
 * @member {module:model/WalletTransactionGetResponse.TypeEnum} type
 */
WalletTransactionGetResponse.prototype['type'] = undefined;

/**
 * The EMI (E-Money Institution) wallet that this payment is associated with, if any. This wallet is used as an intermediary account to enable Plaid to reconcile the settlement of funds for Payment Initiation requests.
 * @member {String} wallet_id
 */
WalletTransactionGetResponse.prototype['wallet_id'] = undefined;

/**
 * A unique identifier for the request, which can be used for troubleshooting. This identifier, like all Plaid identifiers, is case sensitive.
 * @member {String} request_id
 */
WalletTransactionGetResponse.prototype['request_id'] = undefined;


// Implement WalletTransaction interface:
/**
 * @member {module:model/WalletTransactionAmount} amount
 */
...
export default WalletTransactionGetResponse;
