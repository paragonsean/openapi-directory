...
**count** | **Number** | The maximum number of transfers to return. | [optional] [default to 25]
...
**offset** | **Number** | The number of transfers to skip before returning results. | [optional] [default to 0]
