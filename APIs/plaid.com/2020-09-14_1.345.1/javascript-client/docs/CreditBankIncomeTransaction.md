# ThePlaidApi.CreditBankIncomeTransaction
...
**pending** | **Boolean** | When true, identifies the transaction as pending or unsettled. Pending transaction details (name, type, amount, category ID) may change before they are settled. | [optional] 
