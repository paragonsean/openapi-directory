# ThePlaidApi.SandboxTransferTestClockListRequest
...
**count** | **Number** | The maximum number of test clocks to return. | [optional] [default to 25]
...
**offset** | **Number** | The number of test clocks to skip before returning results. | [optional] [default to 0]
