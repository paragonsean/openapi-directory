...
------------ | ------------- | ------------- | -------------
**currentAmount** | **Number** | Total amount of the earnings for this pay period. | 
**hours** | **Number** | Total number of hours worked for this pay period. | 
...
**ytdAmount** | **Number** | The total year-to-date amount of the earnings. | 
