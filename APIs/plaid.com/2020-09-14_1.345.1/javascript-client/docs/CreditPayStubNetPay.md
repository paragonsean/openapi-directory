# ThePlaidApi.CreditPayStubNetPay

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**currentAmount** | **Number** | Raw amount of the net pay for the pay period. | 
...
**ytdAmount** | **Number** | The year-to-date amount of the net pay. | 
