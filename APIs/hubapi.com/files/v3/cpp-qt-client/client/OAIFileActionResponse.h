...
/*
 * OAIFileActionResponse.h
 *
 * 
 */

#ifndef OAIFileActionResponse_H
#define OAIFileActionResponse_H
...
class OAIFileActionResponse : public OAIObject {
public:
    OAIFileActionResponse();
    OAIFileActionResponse(QString json);
    ~OAIFileActionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileActionResponse)

#endif // OAIFileActionResponse_H
