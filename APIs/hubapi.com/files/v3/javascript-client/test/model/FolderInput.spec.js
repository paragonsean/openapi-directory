...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FilesFiles.FolderInput();
  });
  ...
  describe('FolderInput', function() {
    it('should create an instance of FolderInput', function() {
      // uncomment below and update the code to test FolderInput
      //var instance = new FilesFiles.FolderInput();
      //expect(instance).to.be.a(FilesFiles.FolderInput);
    });
