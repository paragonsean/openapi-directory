...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FilesFiles.FolderActionResponse();
  });
  ...
  describe('FolderActionResponse', function() {
    it('should create an instance of FolderActionResponse', function() {
      // uncomment below and update the code to test FolderActionResponse
      //var instance = new FilesFiles.FolderActionResponse();
      //expect(instance).to.be.a(FilesFiles.FolderActionResponse);
    });
