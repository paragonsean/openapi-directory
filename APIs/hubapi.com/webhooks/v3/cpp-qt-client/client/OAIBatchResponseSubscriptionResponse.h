...
/*
 * OAIBatchResponseSubscriptionResponse.h
 *
 * 
 */

#ifndef OAIBatchResponseSubscriptionResponse_H
#define OAIBatchResponseSubscriptionResponse_H
...
class OAIBatchResponseSubscriptionResponse : public OAIObject {
public:
    OAIBatchResponseSubscriptionResponse();
    OAIBatchResponseSubscriptionResponse(QString json);
    ~OAIBatchResponseSubscriptionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchResponseSubscriptionResponse)

#endif // OAIBatchResponseSubscriptionResponse_H
