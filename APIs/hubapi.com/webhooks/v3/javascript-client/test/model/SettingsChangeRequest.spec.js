...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebhooksWebhooks.SettingsChangeRequest();
  });
  ...
  describe('SettingsChangeRequest', function() {
    it('should create an instance of SettingsChangeRequest', function() {
      // uncomment below and update the code to test SettingsChangeRequest
      //var instance = new WebhooksWebhooks.SettingsChangeRequest();
      //expect(instance).to.be.a(WebhooksWebhooks.SettingsChangeRequest);
    });
