...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebhooksWebhooks.SubscriptionResponse();
  });
  ...
  describe('SubscriptionResponse', function() {
    it('should create an instance of SubscriptionResponse', function() {
      ...
      //var instance = new WebhooksWebhooks.SubscriptionResponse();
      //expect(instance).to.be.a(WebhooksWebhooks.SubscriptionResponse);
    });
