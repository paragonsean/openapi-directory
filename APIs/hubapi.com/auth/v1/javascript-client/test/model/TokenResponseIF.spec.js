...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthOauth.TokenResponseIF();
  });
  ...
  describe('TokenResponseIF', function() {
    it('should create an instance of TokenResponseIF', function() {
      // uncomment below and update the code to test TokenResponseIF
      //var instance = new AuthOauth.TokenResponseIF();
      //expect(instance).to.be.a(AuthOauth.TokenResponseIF);
    });
