...
/*
 * OAIAccessTokenInfoResponse.h
 *
 * 
 */

#ifndef OAIAccessTokenInfoResponse_H
#define OAIAccessTokenInfoResponse_H
...
class OAIAccessTokenInfoResponse : public OAIObject {
public:
    OAIAccessTokenInfoResponse();
    OAIAccessTokenInfoResponse(QString json);
    ~OAIAccessTokenInfoResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessTokenInfoResponse)

#endif // OAIAccessTokenInfoResponse_H
