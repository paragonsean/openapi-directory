...
/*
 * OAITokenResponseIF.h
 *
 * 
 */

#ifndef OAITokenResponseIF_H
#define OAITokenResponseIF_H
...
class OAITokenResponseIF : public OAIObject {
public:
    OAITokenResponseIF();
    OAITokenResponseIF(QString json);
    ~OAITokenResponseIF() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokenResponseIF)

#endif // OAITokenResponseIF_H
