...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EventsSendEventCompletions.ErrorDetail();
  });
  ...
  describe('ErrorDetail', function() {
    it('should create an instance of ErrorDetail', function() {
      ...
      //var instance = new EventsSendEventCompletions.ErrorDetail();
      //expect(instance).to.be.a(EventsSendEventCompletions.ErrorDetail);
    });
