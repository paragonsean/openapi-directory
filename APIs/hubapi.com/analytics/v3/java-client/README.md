...
- API version: v3
  - Build date: 2024-10-12T12:33:13.719494-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*CustomEventDataApi* | [**postEventsV3SendSend**](docs/CustomEventDataApi.md#postEventsV3SendSend) | **POST** /events/v3/send | Send custom event completion
