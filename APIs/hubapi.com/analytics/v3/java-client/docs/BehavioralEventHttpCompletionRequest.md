...
|**occurredAt** | **OffsetDateTime** | The time when this event occurred (if any). If this isn&#39;t set, the current time will be used |  [optional] |
|**properties** | **Map&lt;String, String&gt;** | Map of properties for the event in the format property internal name - property value |  [optional] |
