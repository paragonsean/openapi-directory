...
/**
 * Model tests for CardCreateRequest
 */
public class CardCreateRequestTest {
    private final CardCreateRequest model = new CardCreateRequest();
