...
public class ApiClient {
    ...
    private String basePath = "https://api.hubapi.com/crm/v3/extensions/cards";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.hubapi.com/crm/v3/extensions/cards
