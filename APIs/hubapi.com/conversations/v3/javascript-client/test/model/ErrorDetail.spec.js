...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisitorIdentification.ErrorDetail();
  });
  ...
  describe('ErrorDetail', function() {
    it('should create an instance of ErrorDetail', function() {
      ...
      //var instance = new VisitorIdentification.ErrorDetail();
      //expect(instance).to.be.a(VisitorIdentification.ErrorDetail);
    });
