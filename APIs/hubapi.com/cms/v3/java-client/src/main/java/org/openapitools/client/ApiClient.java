...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("oauth2_legacy", new OAuth());
        authentications.put("private_apps", new ApiKeyAuth("header", "private-app"));
        authentications.put("private_apps_legacy", new ApiKeyAuth("header", "private-app-legacy"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.hubapi.com
