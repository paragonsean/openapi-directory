...
public class MarketingEventDefaultResponse {
  ...
  public MarketingEventDefaultResponse customProperties(List<PropertyValue> customProperties) {
    this.customProperties = customProperties;
    return this;
  }

  public MarketingEventDefaultResponse addCustomPropertiesItem(PropertyValue customPropertiesItem) {
  ...
  public MarketingEventDefaultResponse endDateTime(OffsetDateTime endDateTime) {
  ...
  public MarketingEventDefaultResponse eventCancelled(Boolean eventCancelled) {
  ...
  public MarketingEventDefaultResponse eventDescription(String eventDescription) {
  ...
  public MarketingEventDefaultResponse eventName(String eventName) {
  ...
  public MarketingEventDefaultResponse eventOrganizer(String eventOrganizer) {
  ...
  public MarketingEventDefaultResponse eventType(String eventType) {
  ...
  public MarketingEventDefaultResponse eventUrl(String eventUrl) {
  ...
  public MarketingEventDefaultResponse startDateTime(OffsetDateTime startDateTime) {
  ...
  public boolean equals(Object o) {
    ...
    MarketingEventDefaultResponse marketingEventDefaultResponse = (MarketingEventDefaultResponse) o;
    return Objects.equals(this.customProperties, marketingEventDefaultResponse.customProperties) &&
        Objects.equals(this.endDateTime, marketingEventDefaultResponse.endDateTime) &&
        Objects.equals(this.eventCancelled, marketingEventDefaultResponse.eventCancelled) &&
        Objects.equals(this.eventDescription, marketingEventDefaultResponse.eventDescription) &&
        Objects.equals(this.eventName, marketingEventDefaultResponse.eventName) &&
        Objects.equals(this.eventOrganizer, marketingEventDefaultResponse.eventOrganizer) &&
        Objects.equals(this.eventType, marketingEventDefaultResponse.eventType) &&
        Objects.equals(this.eventUrl, marketingEventDefaultResponse.eventUrl) &&
        Objects.equals(this.startDateTime, marketingEventDefaultResponse.startDateTime);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MarketingEventDefaultResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MarketingEventDefaultResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MarketingEventDefaultResponse is not found in the empty JSON string", MarketingEventDefaultResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MarketingEventDefaultResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MarketingEventDefaultResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MarketingEventDefaultResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MarketingEventDefaultResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MarketingEventDefaultResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MarketingEventDefaultResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MarketingEventDefaultResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MarketingEventDefaultResponse>() {
           @Override
           public void write(JsonWriter out, MarketingEventDefaultResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MarketingEventDefaultResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MarketingEventDefaultResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MarketingEventDefaultResponse
   * @throws IOException if the JSON string is invalid with respect to MarketingEventDefaultResponse
   */
  public static MarketingEventDefaultResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MarketingEventDefaultResponse.class);
  }

  /**
   * Convert an instance of MarketingEventDefaultResponse to an JSON string
   *
   * @return JSON string
   */
