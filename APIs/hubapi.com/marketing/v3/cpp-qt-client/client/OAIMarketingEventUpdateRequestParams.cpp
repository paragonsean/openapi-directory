...
OAIMarketingEventUpdateRequestParams::OAIMarketingEventUpdateRequestParams(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMarketingEventUpdateRequestParams::OAIMarketingEventUpdateRequestParams() {
    this->initializeModel();
}

OAIMarketingEventUpdateRequestParams::~OAIMarketingEventUpdateRequestParams() {}

void OAIMarketingEventUpdateRequestParams::initializeModel() {
...
void OAIMarketingEventUpdateRequestParams::fromJson(QString jsonString) {
...
void OAIMarketingEventUpdateRequestParams::fromJsonObject(QJsonObject json) {
...
QString OAIMarketingEventUpdateRequestParams::asJson() const {
...
QJsonObject OAIMarketingEventUpdateRequestParams::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIPropertyValue> OAIMarketingEventUpdateRequestParams::getCustomProperties() const {
    return m_custom_properties;
}
void OAIMarketingEventUpdateRequestParams::setCustomProperties(const QList<OAIPropertyValue> &custom_properties) {
    m_custom_properties = custom_properties;
    m_custom_properties_isSet = true;
}

bool OAIMarketingEventUpdateRequestParams::is_custom_properties_Set() const{
    return m_custom_properties_isSet;
}

bool OAIMarketingEventUpdateRequestParams::is_custom_properties_Valid() const{
    return m_custom_properties_isValid;
}

QDateTime OAIMarketingEventUpdateRequestParams::getEndDateTime() const {
    return m_end_date_time;
}
void OAIMarketingEventUpdateRequestParams::setEndDateTime(const QDateTime &end_date_time) {
    m_end_date_time = end_date_time;
    m_end_date_time_isSet = true;
}

bool OAIMarketingEventUpdateRequestParams::is_end_date_time_Set() const{
    return m_end_date_time_isSet;
}

bool OAIMarketingEventUpdateRequestParams::is_end_date_time_Valid() const{
    return m_end_date_time_isValid;
}

bool OAIMarketingEventUpdateRequestParams::isEventCancelled() const {
    return m_event_cancelled;
}
void OAIMarketingEventUpdateRequestParams::setEventCancelled(const bool &event_cancelled) {
    m_event_cancelled = event_cancelled;
    m_event_cancelled_isSet = true;
}

bool OAIMarketingEventUpdateRequestParams::is_event_cancelled_Set() const{
    return m_event_cancelled_isSet;
}

bool OAIMarketingEventUpdateRequestParams::is_event_cancelled_Valid() const{
    return m_event_cancelled_isValid;
}

QString OAIMarketingEventUpdateRequestParams::getEventDescription() const {
    return m_event_description;
}
void OAIMarketingEventUpdateRequestParams::setEventDescription(const QString &event_description) {
    m_event_description = event_description;
    m_event_description_isSet = true;
}

bool OAIMarketingEventUpdateRequestParams::is_event_description_Set() const{
    return m_event_description_isSet;
}

bool OAIMarketingEventUpdateRequestParams::is_event_description_Valid() const{
    return m_event_description_isValid;
}

QString OAIMarketingEventUpdateRequestParams::getEventName() const {
    return m_event_name;
}
void OAIMarketingEventUpdateRequestParams::setEventName(const QString &event_name) {
    m_event_name = event_name;
    m_event_name_isSet = true;
}

bool OAIMarketingEventUpdateRequestParams::is_event_name_Set() const{
    return m_event_name_isSet;
}

bool OAIMarketingEventUpdateRequestParams::is_event_name_Valid() const{
    return m_event_name_isValid;
}

QString OAIMarketingEventUpdateRequestParams::getEventOrganizer() const {
    return m_event_organizer;
}
void OAIMarketingEventUpdateRequestParams::setEventOrganizer(const QString &event_organizer) {
    m_event_organizer = event_organizer;
    m_event_organizer_isSet = true;
}

bool OAIMarketingEventUpdateRequestParams::is_event_organizer_Set() const{
    return m_event_organizer_isSet;
}

bool OAIMarketingEventUpdateRequestParams::is_event_organizer_Valid() const{
    return m_event_organizer_isValid;
}

QString OAIMarketingEventUpdateRequestParams::getEventType() const {
    return m_event_type;
}
void OAIMarketingEventUpdateRequestParams::setEventType(const QString &event_type) {
    m_event_type = event_type;
    m_event_type_isSet = true;
}

bool OAIMarketingEventUpdateRequestParams::is_event_type_Set() const{
    return m_event_type_isSet;
}

bool OAIMarketingEventUpdateRequestParams::is_event_type_Valid() const{
    return m_event_type_isValid;
}

QString OAIMarketingEventUpdateRequestParams::getEventUrl() const {
    return m_event_url;
}
void OAIMarketingEventUpdateRequestParams::setEventUrl(const QString &event_url) {
    m_event_url = event_url;
    m_event_url_isSet = true;
}

bool OAIMarketingEventUpdateRequestParams::is_event_url_Set() const{
    return m_event_url_isSet;
}

bool OAIMarketingEventUpdateRequestParams::is_event_url_Valid() const{
    return m_event_url_isValid;
}

QDateTime OAIMarketingEventUpdateRequestParams::getStartDateTime() const {
    return m_start_date_time;
}
void OAIMarketingEventUpdateRequestParams::setStartDateTime(const QDateTime &start_date_time) {
    m_start_date_time = start_date_time;
    m_start_date_time_isSet = true;
}

bool OAIMarketingEventUpdateRequestParams::is_start_date_time_Set() const{
    return m_start_date_time_isSet;
}

bool OAIMarketingEventUpdateRequestParams::is_start_date_time_Valid() const{
    return m_start_date_time_isValid;
}

bool OAIMarketingEventUpdateRequestParams::isSet() const {
...
bool OAIMarketingEventUpdateRequestParams::isValid() const {
