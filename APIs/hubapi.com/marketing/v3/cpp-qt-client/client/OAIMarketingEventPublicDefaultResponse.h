...
/*
 * OAIMarketingEventPublicDefaultResponse.h
 *
 * 
 */

#ifndef OAIMarketingEventPublicDefaultResponse_H
#define OAIMarketingEventPublicDefaultResponse_H
...
class OAIMarketingEventPublicDefaultResponse : public OAIObject {
public:
    OAIMarketingEventPublicDefaultResponse();
    OAIMarketingEventPublicDefaultResponse(QString json);
    ~OAIMarketingEventPublicDefaultResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarketingEventPublicDefaultResponse)

#endif // OAIMarketingEventPublicDefaultResponse_H
