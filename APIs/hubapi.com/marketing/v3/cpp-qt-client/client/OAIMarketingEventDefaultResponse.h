...
/*
 * OAIMarketingEventDefaultResponse.h
 *
 * 
 */

#ifndef OAIMarketingEventDefaultResponse_H
#define OAIMarketingEventDefaultResponse_H
...
class OAIMarketingEventDefaultResponse : public OAIObject {
public:
    OAIMarketingEventDefaultResponse();
    OAIMarketingEventDefaultResponse(QString json);
    ~OAIMarketingEventDefaultResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarketingEventDefaultResponse)

#endif // OAIMarketingEventDefaultResponse_H
