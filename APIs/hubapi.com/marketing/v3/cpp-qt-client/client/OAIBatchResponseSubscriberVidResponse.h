...
/*
 * OAIBatchResponseSubscriberVidResponse.h
 *
 * 
 */

#ifndef OAIBatchResponseSubscriberVidResponse_H
#define OAIBatchResponseSubscriberVidResponse_H
...
class OAISubscriberVidResponse;

class OAIBatchResponseSubscriberVidResponse : public OAIObject {
public:
    OAIBatchResponseSubscriberVidResponse();
    OAIBatchResponseSubscriberVidResponse(QString json);
    ~OAIBatchResponseSubscriberVidResponse() override;
    ...
    QList<OAISubscriberVidResponse> getResults() const;
    void setResults(const QList<OAISubscriberVidResponse> &results);
...
private:
    ...
    QList<OAISubscriberVidResponse> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchResponseSubscriberVidResponse)

#endif // OAIBatchResponseSubscriberVidResponse_H
