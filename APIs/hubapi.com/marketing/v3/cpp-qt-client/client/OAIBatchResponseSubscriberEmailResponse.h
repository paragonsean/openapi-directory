...
/*
 * OAIBatchResponseSubscriberEmailResponse.h
 *
 * 
 */

#ifndef OAIBatchResponseSubscriberEmailResponse_H
#define OAIBatchResponseSubscriberEmailResponse_H
...
class OAISubscriberEmailResponse;

class OAIBatchResponseSubscriberEmailResponse : public OAIObject {
public:
    OAIBatchResponseSubscriberEmailResponse();
    OAIBatchResponseSubscriberEmailResponse(QString json);
    ~OAIBatchResponseSubscriberEmailResponse() override;
    ...
    QList<OAISubscriberEmailResponse> getResults() const;
    void setResults(const QList<OAISubscriberEmailResponse> &results);
...
private:
    ...
    QList<OAISubscriberEmailResponse> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchResponseSubscriberEmailResponse)

#endif // OAIBatchResponseSubscriberEmailResponse_H
