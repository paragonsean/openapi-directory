...
/*
 * OAIMarketingEventUpdateRequestParams.h
 *
 * 
 */

#ifndef OAIMarketingEventUpdateRequestParams_H
#define OAIMarketingEventUpdateRequestParams_H
...
class OAIMarketingEventUpdateRequestParams : public OAIObject {
public:
    OAIMarketingEventUpdateRequestParams();
    OAIMarketingEventUpdateRequestParams(QString json);
    ~OAIMarketingEventUpdateRequestParams() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarketingEventUpdateRequestParams)

#endif // OAIMarketingEventUpdateRequestParams_H
