...
void OAISearchApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_marketing_v3_marketingEvents_events_searchDoSearch", defaultConf);
    _serverIndices.insert("get_marketing_v3_marketingEvents_events_searchDoSearch", 0);
}
...
void OAISearchApi::get_marketing_v3_marketingEvents_events_searchDoSearch(const QString &q) {
    QString fullPath = QString(_serverConfigs["get_marketing_v3_marketingEvents_events_searchDoSearch"][_serverIndices.value("get_marketing_v3_marketingEvents_events_searchDoSearch")].URL()+"/marketing/v3/marketing-events/events/search");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::get_marketing_v3_marketingEvents_events_searchDoSearchCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::get_marketing_v3_marketingEvents_events_searchDoSearchCallback);
...
void OAISearchApi::get_marketing_v3_marketingEvents_events_searchDoSearchCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICollectionResponseMarketingEventExternalUniqueIdentifierNoPaging output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_marketing_v3_marketingEvents_events_searchDoSearchSignal(output);
        Q_EMIT get_marketing_v3_marketingEvents_events_searchDoSearchSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_marketing_v3_marketingEvents_events_searchDoSearchSignalE(output, error_type, error_str);
        Q_EMIT get_marketing_v3_marketingEvents_events_searchDoSearchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_marketing_v3_marketingEvents_events_searchDoSearchSignalError(output, error_type, error_str);
        Q_EMIT get_marketing_v3_marketingEvents_events_searchDoSearchSignalErrorFull(worker, error_type, error_str);
    }
}
