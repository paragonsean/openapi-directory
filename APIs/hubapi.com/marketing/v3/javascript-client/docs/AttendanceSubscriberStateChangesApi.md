...
> BatchResponseSubscriberVidResponse postMarketingV3MarketingEventsAttendanceExternalEventIdSubscriberStateCreateCreate(externalEventId, subscriberState, batchInputMarketingEventSubscriber, opts)
...
let apiInstance = new MarketingEvents.AttendanceSubscriberStateChangesApi();
let externalEventId = "externalEventId_example"; // String | The id of the marketing event
let subscriberState = "subscriberState_example"; // String | The new subscriber state for the HubSpot contacts and the specified marketing event. For example: 'register', 'attend' or 'cancel'.
let batchInputMarketingEventSubscriber = new MarketingEvents.BatchInputMarketingEventSubscriber(); // BatchInputMarketingEventSubscriber | The details of the contacts to subscribe to the event. Parameters of join and left time if state is Attended.
let opts = {
  'externalAccountId': "externalAccountId_example" // String | The account id associated with the marketing event
};
apiInstance.postMarketingV3MarketingEventsAttendanceExternalEventIdSubscriberStateCreateCreate(externalEventId, subscriberState, batchInputMarketingEventSubscriber, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> BatchResponseSubscriberEmailResponse postMarketingV3MarketingEventsAttendanceExternalEventIdSubscriberStateEmailCreateCreateByEmail(externalEventId, subscriberState, batchInputMarketingEventEmailSubscriber, opts)
...
let externalEventId = "externalEventId_example"; // String | The id of the marketing event
let subscriberState = "subscriberState_example"; // String | The new subscriber state for the HubSpot contacts and the specified marketing event. For example: 'register', 'attend' or 'cancel'.
let batchInputMarketingEventEmailSubscriber = new MarketingEvents.BatchInputMarketingEventEmailSubscriber(); // BatchInputMarketingEventEmailSubscriber | The details of the contacts to subscribe to the event. Parameters of join and left time if state is Attended.
let opts = {
  'externalAccountId': "externalAccountId_example" // String | The account id associated with the marketing event
};
apiInstance.postMarketingV3MarketingEventsAttendanceExternalEventIdSubscriberStateEmailCreateCreateByEmail(externalEventId, subscriberState, batchInputMarketingEventEmailSubscriber, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
