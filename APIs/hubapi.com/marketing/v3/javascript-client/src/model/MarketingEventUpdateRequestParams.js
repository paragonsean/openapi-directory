...
/**
 * The MarketingEventUpdateRequestParams model module.
 * @module model/MarketingEventUpdateRequestParams
 * @version v3
 */
class MarketingEventUpdateRequestParams {
    /**
     * Constructs a new <code>MarketingEventUpdateRequestParams</code>.
     * @alias module:model/MarketingEventUpdateRequestParams
     */
    constructor() { 
        
        MarketingEventUpdateRequestParams.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MarketingEventUpdateRequestParams</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MarketingEventUpdateRequestParams} obj Optional instance to populate.
     * @return {module:model/MarketingEventUpdateRequestParams} The populated <code>MarketingEventUpdateRequestParams</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MarketingEventUpdateRequestParams();
    ...
    /**
     * Validates the JSON data with respect to <code>MarketingEventUpdateRequestParams</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MarketingEventUpdateRequestParams</code>.
     */
 ...
 */
MarketingEventUpdateRequestParams.prototype['customProperties'] = undefined;

/**
 * The end date and time of the marketing event.
 * @member {Date} endDateTime
 */
MarketingEventUpdateRequestParams.prototype['endDateTime'] = undefined;

/**
 * Indicates if the marketing event has been cancelled. Defaults to `false`
 * @member {Boolean} eventCancelled
 */
MarketingEventUpdateRequestParams.prototype['eventCancelled'] = undefined;

/**
 * The description of the marketing event.
 * @member {String} eventDescription
 */
MarketingEventUpdateRequestParams.prototype['eventDescription'] = undefined;

/**
 * The name of the marketing event.
 * @member {String} eventName
 */
MarketingEventUpdateRequestParams.prototype['eventName'] = undefined;

/**
 * The name of the organizer of the marketing event.
 * @member {String} eventOrganizer
 */
MarketingEventUpdateRequestParams.prototype['eventOrganizer'] = undefined;

/**
 * Describes what type of event this is.  For example: `WEBINAR`, `CONFERENCE`, `WORKSHOP`
 * @member {String} eventType
 */
MarketingEventUpdateRequestParams.prototype['eventType'] = undefined;

/**
 * A URL in the external event application where the marketing event can be managed.
 * @member {String} eventUrl
 */
MarketingEventUpdateRequestParams.prototype['eventUrl'] = undefined;

/**
 * The start date and time of the marketing event.
 * @member {Date} startDateTime
 */
MarketingEventUpdateRequestParams.prototype['startDateTime'] = undefined;
...
export default MarketingEventUpdateRequestParams;
