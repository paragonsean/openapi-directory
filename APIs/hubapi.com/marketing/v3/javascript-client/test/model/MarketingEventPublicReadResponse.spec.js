...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketingEvents.MarketingEventPublicReadResponse();
  });
  ...
  describe('MarketingEventPublicReadResponse', function() {
    it('should create an instance of MarketingEventPublicReadResponse', function() {
      // uncomment below and update the code to test MarketingEventPublicReadResponse
      //var instance = new MarketingEvents.MarketingEventPublicReadResponse();
      //expect(instance).to.be.a(MarketingEvents.MarketingEventPublicReadResponse);
    });
    ...
    it('should have the property noShows (base name: "noShows")', function() {
      // uncomment below and update the code to test the property noShows
      //var instance = new MarketingEvents.MarketingEventPublicReadResponse();
      //expect(instance).to.be();
    });

    it('should have the property registrants (base name: "registrants")', function() {
      // uncomment below and update the code to test the property registrants
      //var instance = new MarketingEvents.MarketingEventPublicReadResponse();
      //expect(instance).to.be();
    });
