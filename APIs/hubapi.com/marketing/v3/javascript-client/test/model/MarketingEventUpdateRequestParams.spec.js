...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketingEvents.MarketingEventUpdateRequestParams();
  });
  ...
  describe('MarketingEventUpdateRequestParams', function() {
    it('should create an instance of MarketingEventUpdateRequestParams', function() {
      // uncomment below and update the code to test MarketingEventUpdateRequestParams
      //var instance = new MarketingEvents.MarketingEventUpdateRequestParams();
      //expect(instance).to.be.a(MarketingEvents.MarketingEventUpdateRequestParams);
    });
