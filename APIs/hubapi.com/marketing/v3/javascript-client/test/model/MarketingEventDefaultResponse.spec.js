...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketingEvents.MarketingEventDefaultResponse();
  });
  ...
  describe('MarketingEventDefaultResponse', function() {
    it('should create an instance of MarketingEventDefaultResponse', function() {
      // uncomment below and update the code to test MarketingEventDefaultResponse
      //var instance = new MarketingEvents.MarketingEventDefaultResponse();
      //expect(instance).to.be.a(MarketingEvents.MarketingEventDefaultResponse);
    });
