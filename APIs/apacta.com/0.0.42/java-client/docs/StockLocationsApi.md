...
<a id="stockLocationsGet"></a>
# **stockLocationsGet**
> StockLocationsGet200Response stockLocationsGet(name)
...
import org.openapitools.client.api.StockLocationsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    StockLocationsApi apiInstance = new StockLocationsApi(defaultClient);
    String name = "name_example"; // String | Used to filter on the `name` of the stock_locations
    try {
      StockLocationsGet200Response result = apiInstance.stockLocationsGet(name);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StockLocationsApi#stockLocationsGet");
...
<a id="stockLocationsLocationIdDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ClockingRecordsClockingRecordIdPut200Response result = apiInstance.stockLocationsLocationIdDelete(locationId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StockLocationsApi#stockLocationsLocationIdDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="stockLocationsLocationIdGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String locationId = "locationId_example"; // String | 
    try {
      StockLocationsLocationIdGet200Response result = apiInstance.stockLocationsLocationIdGet(locationId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StockLocationsApi#stockLocationsLocationIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="stockLocationsLocationIdPut"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String locationId = "locationId_example"; // String | 
    try {
      ClockingRecordsClockingRecordIdPut200Response result = apiInstance.stockLocationsLocationIdPut(locationId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StockLocationsApi#stockLocationsLocationIdPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="stockLocationsPost"></a>
# **stockLocationsPost**
> ClockingRecordsPost201Response stockLocationsPost(stockLocationsPostRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    StockLocationsApi apiInstance = new StockLocationsApi(defaultClient);
    StockLocationsPostRequest stockLocationsPostRequest = new StockLocationsPostRequest(); // StockLocationsPostRequest | 
    try {
      ClockingRecordsPost201Response result = apiInstance.stockLocationsPost(stockLocationsPostRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StockLocationsApi#stockLocationsPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
