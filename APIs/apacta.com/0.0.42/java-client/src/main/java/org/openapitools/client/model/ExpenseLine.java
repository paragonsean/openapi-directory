...
public class ExpenseLine {
  ...
  public ExpenseLine buyingPrice(Float buyingPrice) {
  ...
  public ExpenseLine createdById(UUID createdById) {
  ...
  public ExpenseLine currencyId(UUID currencyId) {
  ...
  public ExpenseLine expenseId(UUID expenseId) {
  ...
  public ExpenseLine isInvoiced(String isInvoiced) {
  ...
  public ExpenseLine quantity(Integer quantity) {
  ...
  public ExpenseLine sellingPrice(Float sellingPrice) {
  ...
  public ExpenseLine text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExpenseLine expenseLine = (ExpenseLine) o;
    return Objects.equals(this.buyingPrice, expenseLine.buyingPrice) &&
        Objects.equals(this.created, expenseLine.created) &&
        Objects.equals(this.createdById, expenseLine.createdById) &&
        Objects.equals(this.currencyId, expenseLine.currencyId) &&
        Objects.equals(this.deleted, expenseLine.deleted) &&
        Objects.equals(this.expenseId, expenseLine.expenseId) &&
        Objects.equals(this.id, expenseLine.id) &&
        Objects.equals(this.isInvoiced, expenseLine.isInvoiced) &&
        Objects.equals(this.modified, expenseLine.modified) &&
        Objects.equals(this.quantity, expenseLine.quantity) &&
        Objects.equals(this.sellingPrice, expenseLine.sellingPrice) &&
        Objects.equals(this.text, expenseLine.text);
  }

  @Override
  public int hashCode() {
    return Objects.hash(buyingPrice, created, createdById, currencyId, deleted, expenseId, id, isInvoiced, modified, quantity, sellingPrice, text);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpenseLine
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpenseLine.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExpenseLine is not found in the empty JSON string", ExpenseLine.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExpenseLine.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExpenseLine` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpenseLine.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpenseLine' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpenseLine> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpenseLine.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpenseLine>() {
           @Override
           public void write(JsonWriter out, ExpenseLine value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExpenseLine read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExpenseLine given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExpenseLine
   * @throws IOException if the JSON string is invalid with respect to ExpenseLine
   */
  public static ExpenseLine fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpenseLine.class);
  }

  /**
   * Convert an instance of ExpenseLine to an JSON string
   *
   * @return JSON string
   */
