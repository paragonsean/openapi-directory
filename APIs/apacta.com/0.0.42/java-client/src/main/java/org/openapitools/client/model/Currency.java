...
public class Currency {
  ...
  public static final String SERIALIZED_NAME_CURRENCY_SIGN = "currency_sign";
  ...
  public Currency centigaId(String centigaId) {
  ...
  public Currency currencySign(String currencySign) {
  ...
  public Currency identifier(String identifier) {
  ...
  public Currency pogoId(String pogoId) {
    this.pogoId = pogoId;
    return this;
  }
  ...
  public Currency tripletexId(String tripletexId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.centigaId, currency.centigaId) &&
        Objects.equals(this.created, currency.created) &&
        Objects.equals(this.currencySign, currency.currencySign) &&
        Objects.equals(this.deleted, currency.deleted) &&
        Objects.equals(this.description, currency.description) &&
        Objects.equals(this.id, currency.id) &&
        Objects.equals(this.identifier, currency.identifier) &&
        Objects.equals(this.modified, currency.modified) &&
        Objects.equals(this.name, currency.name) &&
        Objects.equals(this.pogoId, currency.pogoId) &&
        Objects.equals(this.tripletexId, currency.tripletexId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(centigaId, created, currencySign, deleted, description, id, identifier, modified, name, pogoId, tripletexId);
  }
  ...
  static {
    ...
    openapiFields.add("currency_sign");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("currency_sign") != null && !jsonObj.get("currency_sign").isJsonNull()) && !jsonObj.get("currency_sign").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `currency_sign` to be a primitive type in the JSON string but got `%s`", jsonObj.get("currency_sign").toString()));
      }
