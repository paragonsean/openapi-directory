...
public class UnauthorizedError {
  ...
  private UnauthorizedErrorData data;
  ...
  public UnauthorizedError data(UnauthorizedErrorData data) {
    this.data = data;
    return this;
  }
  ...
  public UnauthorizedErrorData getData() {
    return data;
  }

  public void setData(UnauthorizedErrorData data) {
    this.data = data;
  }


  public UnauthorizedError success(Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, unauthorizedError.data) &&
        Objects.equals(this.success, unauthorizedError.success);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        UnauthorizedErrorData.validateJsonElement(jsonObj.get("data"));
      }
  }
