...
public class ContactType {
  ...
  public ContactType createdById(UUID createdById) {
  ...
  public ContactType identifier(IdentifierEnum identifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, contactType.created) &&
        Objects.equals(this.createdById, contactType.createdById) &&
        Objects.equals(this.deleted, contactType.deleted) &&
        Objects.equals(this.description, contactType.description) &&
        Objects.equals(this.id, contactType.id) &&
        Objects.equals(this.identifier, contactType.identifier) &&
        Objects.equals(this.modified, contactType.modified) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
