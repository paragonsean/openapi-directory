...
public class Event {
  ...
  public Event createdById(UUID createdById) {
  ...
  public Event modifiedById(UUID modifiedById) {
  ...
  public Event projectId(UUID projectId) {
  ...
  public boolean equals(Object o) {
    ...
    Event event = (Event) o;
    return Objects.equals(this.companyId, event.companyId) &&
        ...
        Objects.equals(this.modifiedById, event.modifiedById) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(companyId, created, createdById, deleted, description, end, id, modified, modifiedById, name, projectId, start, userId);
  }
