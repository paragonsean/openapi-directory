...
public class TimeEntryRate {
  ...
  public static final String SERIALIZED_NAME_SELLING_AMOUNT = "selling_amount";
  @SerializedName(SERIALIZED_NAME_SELLING_AMOUNT)
  ...
  public TimeEntryRate amount(Float amount) {
    this.amount = amount;
    return this;
  }
  ...
  public TimeEntryRate companyId(UUID companyId) {
  ...
  public TimeEntryRate createdById(UUID createdById) {
  ...
  public TimeEntryRate currencyId(UUID currencyId) {
  ...
  public TimeEntryRate id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public TimeEntryRate modifiedById(UUID modifiedById) {
  ...
  public TimeEntryRate sellingAmount(Float sellingAmount) {
  ...
  public TimeEntryRate timeEntryTypeId(UUID timeEntryTypeId) {
  ...
  public boolean equals(Object o) {
    ...
    TimeEntryRate timeEntryRate = (TimeEntryRate) o;
    return Objects.equals(this.amount, timeEntryRate.amount) &&
        Objects.equals(this.companyId, timeEntryRate.companyId) &&
        Objects.equals(this.created, timeEntryRate.created) &&
        Objects.equals(this.createdById, timeEntryRate.createdById) &&
        Objects.equals(this.currencyId, timeEntryRate.currencyId) &&
        Objects.equals(this.deleted, timeEntryRate.deleted) &&
        Objects.equals(this.id, timeEntryRate.id) &&
        Objects.equals(this.modified, timeEntryRate.modified) &&
        Objects.equals(this.modifiedById, timeEntryRate.modifiedById) &&
        Objects.equals(this.sellingAmount, timeEntryRate.sellingAmount) &&
        Objects.equals(this.timeEntryTypeId, timeEntryRate.timeEntryTypeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, companyId, created, createdById, currencyId, deleted, id, modified, modifiedById, sellingAmount, timeEntryTypeId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TimeEntryRate {\n");
    ...
    sb.append("    sellingAmount: ").append(toIndentedString(sellingAmount)).append("\n");
  ...
  static {
    ...
    openapiFields.add("selling_amount");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeEntryRate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeEntryRate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeEntryRate is not found in the empty JSON string", TimeEntryRate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimeEntryRate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeEntryRate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimeEntryRate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeEntryRate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimeEntryRate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeEntryRate.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeEntryRate>() {
           @Override
           public void write(JsonWriter out, TimeEntryRate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimeEntryRate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimeEntryRate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimeEntryRate
   * @throws IOException if the JSON string is invalid with respect to TimeEntryRate
   */
  public static TimeEntryRate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimeEntryRate.class);
  }

  /**
   * Convert an instance of TimeEntryRate to an JSON string
   *
   * @return JSON string
   */
