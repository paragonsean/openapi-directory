...
public class Vendor {
  ...
  public Vendor isCustom(Boolean isCustom) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, vendor.created) &&
        Objects.equals(this.cvr, vendor.cvr) &&
        Objects.equals(this.deleted, vendor.deleted) &&
        Objects.equals(this.email, vendor.email) &&
        Objects.equals(this.id, vendor.id) &&
        Objects.equals(this.identifier, vendor.identifier) &&
        Objects.equals(this.isCustom, vendor.isCustom) &&
        Objects.equals(this.modified, vendor.modified) &&
        Objects.equals(this.name, vendor.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, cvr, deleted, email, id, identifier, isCustom, modified, name);
  }
