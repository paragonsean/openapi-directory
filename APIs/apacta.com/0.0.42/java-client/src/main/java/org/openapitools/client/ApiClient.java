...
public class ApiClient {
    ...
    private String basePath = "https://app.apacta.com/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("X-Auth-Token", new ApiKeyAuth("header", "X-Auth-Token"));
        authentications.put("api_key", new ApiKeyAuth("query", "api_token"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.0.42/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://app.apacta.com/api/v1
