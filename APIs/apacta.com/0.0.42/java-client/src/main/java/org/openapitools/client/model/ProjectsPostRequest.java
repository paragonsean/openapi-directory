...
public class ProjectsPostRequest {
  public static final String SERIALIZED_NAME_CHILD_PROJECTS = "child_projects";
  @SerializedName(SERIALIZED_NAME_CHILD_PROJECTS)
  private List<Object> childProjects = new ArrayList<>();
  ...
  public ProjectsPostRequest childProjects(List<Object> childProjects) {
    this.childProjects = childProjects;
    return this;
  }

  public ProjectsPostRequest addChildProjectsItem(Object childProjectsItem) {
    if (this.childProjects == null) {
      this.childProjects = new ArrayList<>();
    }
    this.childProjects.add(childProjectsItem);
    return this;
  }
  ...
  public List<Object> getChildProjects() {
    return childProjects;
  }

  public void setChildProjects(List<Object> childProjects) {
    this.childProjects = childProjects;
  }


  public ProjectsPostRequest cityId(UUID cityId) {
    this.cityId = cityId;
    return this;
  }
  ...
  public ProjectsPostRequest contactId(UUID contactId) {
  ...
  public ProjectsPostRequest description(String description) {
  ...
  public ProjectsPostRequest erpProjectId(String erpProjectId) {
  ...
  public ProjectsPostRequest erpTaskId(String erpTaskId) {
  ...
  public ProjectsPostRequest parentId(UUID parentId) {
  ...
  public ProjectsPostRequest projectStatusId(UUID projectStatusId) {
  ...
  public ProjectsPostRequest startTime(String startTime) {
  ...
  public ProjectsPostRequest streetName(String streetName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.childProjects, projectsPostRequest.childProjects) &&
        Objects.equals(this.cityId, projectsPostRequest.cityId) &&
        Objects.equals(this.contactId, projectsPostRequest.contactId) &&
        Objects.equals(this.description, projectsPostRequest.description) &&
        Objects.equals(this.erpProjectId, projectsPostRequest.erpProjectId) &&
        Objects.equals(this.erpTaskId, projectsPostRequest.erpTaskId) &&
        Objects.equals(this.name, projectsPostRequest.name) &&
        Objects.equals(this.parentId, projectsPostRequest.parentId) &&
        Objects.equals(this.projectStatusId, projectsPostRequest.projectStatusId) &&
        Objects.equals(this.startTime, projectsPostRequest.startTime) &&
        Objects.equals(this.streetName, projectsPostRequest.streetName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(childProjects, cityId, contactId, description, erpProjectId, erpTaskId, name, parentId, projectStatusId, startTime, streetName);
  }
  ...
  public String toString() {
    ...
    sb.append("    childProjects: ").append(toIndentedString(childProjects)).append("\n");
  ...
  static {
    ...
    openapiFields.add("child_projects");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectsPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectsPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectsPostRequest is not found in the empty JSON string", ProjectsPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectsPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectsPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectsPostRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("child_projects") != null && !jsonObj.get("child_projects").isJsonNull() && !jsonObj.get("child_projects").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `child_projects` to be an array in the JSON string but got `%s`", jsonObj.get("child_projects").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectsPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectsPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectsPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectsPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectsPostRequest>() {
           @Override
           public void write(JsonWriter out, ProjectsPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectsPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectsPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectsPostRequest
   * @throws IOException if the JSON string is invalid with respect to ProjectsPostRequest
   */
  public static ProjectsPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectsPostRequest.class);
  }

  /**
   * Convert an instance of ProjectsPostRequest to an JSON string
   *
   * @return JSON string
   */
