...
public class City {
  ...
  public boolean equals(Object o) {
    ...
    City city = (City) o;
    return Objects.equals(this.created, city.created) &&
        Objects.equals(this.deleted, city.deleted) &&
        Objects.equals(this.id, city.id) &&
        Objects.equals(this.modified, city.modified) &&
        Objects.equals(this.name, city.name) &&
        Objects.equals(this.zipCode, city.zipCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, deleted, id, modified, name, zipCode);
  }
