...
#ifndef OAIOfferStatus_H
#define OAIOfferStatus_H
...
class OAIOfferStatus : public OAIObject {
public:
    OAIOfferStatus();
    OAIOfferStatus(QString json);
    ~OAIOfferStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferStatus)

#endif // OAIOfferStatus_H
