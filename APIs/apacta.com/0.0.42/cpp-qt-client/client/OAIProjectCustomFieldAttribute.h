...
/*
 * OAIProjectCustomFieldAttribute.h
 *
 * 
 */

#ifndef OAIProjectCustomFieldAttribute_H
#define OAIProjectCustomFieldAttribute_H
...
class OAIProjectCustomFieldAttribute : public OAIObject {
public:
    OAIProjectCustomFieldAttribute();
    OAIProjectCustomFieldAttribute(QString json);
    ~OAIProjectCustomFieldAttribute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectCustomFieldAttribute)

#endif // OAIProjectCustomFieldAttribute_H
