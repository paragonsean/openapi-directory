...
#ifndef OAIMassMessage_H
#define OAIMassMessage_H
...
class OAIMassMessage : public OAIObject {
public:
    OAIMassMessage();
    OAIMassMessage(QString json);
    ~OAIMassMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMassMessage)

#endif // OAIMassMessage_H
