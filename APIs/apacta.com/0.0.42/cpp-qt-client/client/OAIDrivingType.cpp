...
OAIDrivingType::OAIDrivingType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDrivingType::OAIDrivingType() {
    this->initializeModel();
}

OAIDrivingType::~OAIDrivingType() {}

void OAIDrivingType::initializeModel() {
...
void OAIDrivingType::fromJson(QString jsonString) {
...
void OAIDrivingType::fromJsonObject(QJsonObject json) {
...
QString OAIDrivingType::asJson() const {
...
QJsonObject OAIDrivingType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDrivingType::getCompanyId() const {
    return m_company_id;
}
void OAIDrivingType::setCompanyId(const QString &company_id) {
    m_company_id = company_id;
    m_company_id_isSet = true;
}

bool OAIDrivingType::is_company_id_Set() const{
    return m_company_id_isSet;
}

bool OAIDrivingType::is_company_id_Valid() const{
    return m_company_id_isValid;
}

QString OAIDrivingType::getCreated() const {
    return m_created;
}
void OAIDrivingType::setCreated(const QString &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIDrivingType::is_created_Set() const{
    return m_created_isSet;
}

bool OAIDrivingType::is_created_Valid() const{
    return m_created_isValid;
}

QString OAIDrivingType::getCreatedById() const {
    return m_created_by_id;
}
void OAIDrivingType::setCreatedById(const QString &created_by_id) {
    m_created_by_id = created_by_id;
    m_created_by_id_isSet = true;
}

bool OAIDrivingType::is_created_by_id_Set() const{
    return m_created_by_id_isSet;
}

bool OAIDrivingType::is_created_by_id_Valid() const{
    return m_created_by_id_isValid;
}

QString OAIDrivingType::getDeleted() const {
    return m_deleted;
}
void OAIDrivingType::setDeleted(const QString &deleted) {
    m_deleted = deleted;
    m_deleted_isSet = true;
}

bool OAIDrivingType::is_deleted_Set() const{
    return m_deleted_isSet;
}

bool OAIDrivingType::is_deleted_Valid() const{
    return m_deleted_isValid;
}

double OAIDrivingType::getEmployeePrice() const {
    return m_employee_price;
}
void OAIDrivingType::setEmployeePrice(const double &employee_price) {
    m_employee_price = employee_price;
    m_employee_price_isSet = true;
}

bool OAIDrivingType::is_employee_price_Set() const{
    return m_employee_price_isSet;
}

bool OAIDrivingType::is_employee_price_Valid() const{
    return m_employee_price_isValid;
}

QString OAIDrivingType::getErpId() const {
    return m_erp_id;
}
void OAIDrivingType::setErpId(const QString &erp_id) {
    m_erp_id = erp_id;
    m_erp_id_isSet = true;
}

bool OAIDrivingType::is_erp_id_Set() const{
    return m_erp_id_isSet;
}

bool OAIDrivingType::is_erp_id_Valid() const{
    return m_erp_id_isValid;
}

QString OAIDrivingType::getId() const {
    return m_id;
}
void OAIDrivingType::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDrivingType::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDrivingType::is_id_Valid() const{
    return m_id_isValid;
}

double OAIDrivingType::getInvoicePrice() const {
    return m_invoice_price;
}
void OAIDrivingType::setInvoicePrice(const double &invoice_price) {
    m_invoice_price = invoice_price;
    m_invoice_price_isSet = true;
}

bool OAIDrivingType::is_invoice_price_Set() const{
    return m_invoice_price_isSet;
}

bool OAIDrivingType::is_invoice_price_Valid() const{
    return m_invoice_price_isValid;
}

QString OAIDrivingType::getModified() const {
    return m_modified;
}
void OAIDrivingType::setModified(const QString &modified) {
    m_modified = modified;
    m_modified_isSet = true;
}

bool OAIDrivingType::is_modified_Set() const{
    return m_modified_isSet;
}

bool OAIDrivingType::is_modified_Valid() const{
    return m_modified_isValid;
}

QString OAIDrivingType::getModifiedById() const {
    return m_modified_by_id;
}
void OAIDrivingType::setModifiedById(const QString &modified_by_id) {
    m_modified_by_id = modified_by_id;
    m_modified_by_id_isSet = true;
}

bool OAIDrivingType::is_modified_by_id_Set() const{
    return m_modified_by_id_isSet;
}

bool OAIDrivingType::is_modified_by_id_Valid() const{
    return m_modified_by_id_isValid;
}

QString OAIDrivingType::getName() const {
    return m_name;
}
void OAIDrivingType::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDrivingType::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDrivingType::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDrivingType::getSalaryId() const {
    return m_salary_id;
}
void OAIDrivingType::setSalaryId(const QString &salary_id) {
    m_salary_id = salary_id;
    m_salary_id_isSet = true;
}

bool OAIDrivingType::is_salary_id_Set() const{
    return m_salary_id_isSet;
}

bool OAIDrivingType::is_salary_id_Valid() const{
    return m_salary_id_isValid;
}

bool OAIDrivingType::isSet() const {
...
bool OAIDrivingType::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_company_id_isValid && m_created_isValid && m_employee_price_isValid && m_id_isValid && m_invoice_price_isValid && m_modified_isValid && m_name_isValid && true;
}
