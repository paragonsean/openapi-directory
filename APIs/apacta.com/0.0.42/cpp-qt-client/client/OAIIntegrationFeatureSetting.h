...
/*
 * OAIIntegrationFeatureSetting.h
 *
 * 
 */

#ifndef OAIIntegrationFeatureSetting_H
#define OAIIntegrationFeatureSetting_H
...
class OAIIntegrationFeatureSetting : public OAIObject {
public:
    OAIIntegrationFeatureSetting();
    OAIIntegrationFeatureSetting(QString json);
    ~OAIIntegrationFeatureSetting() override;
    ...
    QString getIntegrationFeatureId() const;
    void setIntegrationFeatureId(const QString &integration_feature_id);
    bool is_integration_feature_id_Set() const;
    bool is_integration_feature_id_Valid() const;

    bool isIsCustomSetting() const;
    void setIsCustomSetting(const bool &is_custom_setting);
    bool is_is_custom_setting_Set() const;
    bool is_is_custom_setting_Valid() const;
...
private:
    ...
    QString m_integration_feature_id;
    bool m_integration_feature_id_isSet;
    bool m_integration_feature_id_isValid;

    bool m_is_custom_setting;
    bool m_is_custom_setting_isSet;
    bool m_is_custom_setting_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntegrationFeatureSetting)

#endif // OAIIntegrationFeatureSetting_H
