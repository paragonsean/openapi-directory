...
/*
 * OAIContactCustomFieldAttribute.h
 *
 * 
 */

#ifndef OAIContactCustomFieldAttribute_H
#define OAIContactCustomFieldAttribute_H
...
class OAIContactCustomFieldAttribute : public OAIObject {
public:
    OAIContactCustomFieldAttribute();
    OAIContactCustomFieldAttribute(QString json);
    ~OAIContactCustomFieldAttribute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactCustomFieldAttribute)

#endif // OAIContactCustomFieldAttribute_H
