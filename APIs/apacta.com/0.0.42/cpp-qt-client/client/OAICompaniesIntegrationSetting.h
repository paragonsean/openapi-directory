...
/*
 * OAICompaniesIntegrationSetting.h
 *
 * 
 */

#ifndef OAICompaniesIntegrationSetting_H
#define OAICompaniesIntegrationSetting_H
...
class OAICompaniesIntegrationSetting : public OAIObject {
public:
    OAICompaniesIntegrationSetting();
    OAICompaniesIntegrationSetting(QString json);
    ~OAICompaniesIntegrationSetting() override;
    ...
    QString getIntegrationSettingId() const;
    void setIntegrationSettingId(const QString &integration_setting_id);
    bool is_integration_setting_id_Set() const;
    bool is_integration_setting_id_Valid() const;
...
private:
    ...
    QString m_integration_setting_id;
    bool m_integration_setting_id_isSet;
    bool m_integration_setting_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompaniesIntegrationSetting)

#endif // OAICompaniesIntegrationSetting_H
