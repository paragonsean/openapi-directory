...
/*
 * OAIContactCustomFieldValue.h
 *
 * 
 */

#ifndef OAIContactCustomFieldValue_H
#define OAIContactCustomFieldValue_H
...
class OAIContactCustomFieldValue : public OAIObject {
public:
    OAIContactCustomFieldValue();
    OAIContactCustomFieldValue(QString json);
    ~OAIContactCustomFieldValue() override;
    ...
    QString getContactCustomFieldAttributeId() const;
    void setContactCustomFieldAttributeId(const QString &contact_custom_field_attribute_id);
    bool is_contact_custom_field_attribute_id_Set() const;
    bool is_contact_custom_field_attribute_id_Valid() const;
...
private:
    ...
    QString m_contact_custom_field_attribute_id;
    bool m_contact_custom_field_attribute_id_isSet;
    bool m_contact_custom_field_attribute_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactCustomFieldValue)

#endif // OAIContactCustomFieldValue_H
