...
Q_SIGNALS:
    ...
    void rolesGetSignal(OAI_roles_get_200_response summary);


    void rolesGetSignalFull(OAIHttpRequestWorker *worker, OAI_roles_get_200_response summary);

    Q_DECL_DEPRECATED_X("Use rolesGetSignalError() instead")
    void rolesGetSignalE(OAI_roles_get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void rolesGetSignalError(OAI_roles_get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
