...
/*
 * OAIVendorProductPriceFile.h
 *
 * 
 */

#ifndef OAIVendorProductPriceFile_H
#define OAIVendorProductPriceFile_H
...
class OAIVendorProductPriceFile : public OAIObject {
public:
    OAIVendorProductPriceFile();
    OAIVendorProductPriceFile(QString json);
    ~OAIVendorProductPriceFile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVendorProductPriceFile)

#endif // OAIVendorProductPriceFile_H
