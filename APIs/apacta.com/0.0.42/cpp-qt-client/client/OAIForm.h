...
public:
    ...
    void setApprovedById(const QString &approved_by_id);
    bool is_approved_by_id_Set() const;
    bool is_approved_by_id_Valid() const;
    ...
    QString getMassFormId() const;
    void setMassFormId(const QString &mass_form_id);
    bool is_mass_form_id_Set() const;
    bool is_mass_form_id_Valid() const;
...
private:
    ...
    QString m_approved_by_id;
    bool m_approved_by_id_isSet;
    bool m_approved_by_id_isValid;
    ...
    QString m_mass_form_id;
    bool m_mass_form_id_isSet;
    bool m_mass_form_id_isValid;
