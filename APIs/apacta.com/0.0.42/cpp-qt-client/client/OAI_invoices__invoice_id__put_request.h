...
/*
 * OAI_invoices__invoice_id__put_request.h
 *
 * 
 */

#ifndef OAI_invoices__invoice_id__put_request_H
#define OAI_invoices__invoice_id__put_request_H
...
class OAI_invoices__invoice_id__put_request : public OAIObject {
public:
    OAI_invoices__invoice_id__put_request();
    OAI_invoices__invoice_id__put_request(QString json);
    ~OAI_invoices__invoice_id__put_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_invoices__invoice_id__put_request)

#endif // OAI_invoices__invoice_id__put_request_H
