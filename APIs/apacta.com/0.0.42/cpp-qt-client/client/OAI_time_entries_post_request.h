...
/*
 * OAI_time_entries_post_request.h
 *
 * 
 */

#ifndef OAI_time_entries_post_request_H
#define OAI_time_entries_post_request_H
...
class OAI_time_entries_post_request : public OAIObject {
public:
    OAI_time_entries_post_request();
    OAI_time_entries_post_request(QString json);
    ~OAI_time_entries_post_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_time_entries_post_request)

#endif // OAI_time_entries_post_request_H
