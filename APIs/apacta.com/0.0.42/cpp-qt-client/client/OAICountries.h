...
public:
    ...
    QString getPhoneCode() const;
    void setPhoneCode(const QString &phone_code);
    bool is_phone_code_Set() const;
    bool is_phone_code_Valid() const;
...
private:
    ...
    QString m_phone_code;
    bool m_phone_code_isSet;
    bool m_phone_code_isValid;
