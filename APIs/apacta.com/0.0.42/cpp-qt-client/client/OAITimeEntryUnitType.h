...
/*
 * OAITimeEntryUnitType.h
 *
 * 
 */

#ifndef OAITimeEntryUnitType_H
#define OAITimeEntryUnitType_H
...
class OAITimeEntryUnitType : public OAIObject {
public:
    OAITimeEntryUnitType();
    OAITimeEntryUnitType(QString json);
    ~OAITimeEntryUnitType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeEntryUnitType)

#endif // OAITimeEntryUnitType_H
