...
/*
 * OAI_projects_post_request.h
 *
 * 
 */

#ifndef OAI_projects_post_request_H
#define OAI_projects_post_request_H
...
class OAI_projects_post_request : public OAIObject {
public:
    OAI_projects_post_request();
    OAI_projects_post_request(QString json);
    ~OAI_projects_post_request() override;
    ...
    QList<OAIObject> getChildProjects() const;
    void setChildProjects(const QList<OAIObject> &child_projects);
    bool is_child_projects_Set() const;
    bool is_child_projects_Valid() const;
...
private:
    ...
    QList<OAIObject> m_child_projects;
    bool m_child_projects_isSet;
    bool m_child_projects_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_projects_post_request)

#endif // OAI_projects_post_request_H
