...
/*
 * OAI_events_post_request.h
 *
 * 
 */

#ifndef OAI_events_post_request_H
#define OAI_events_post_request_H
...
class OAI_events_post_request : public OAIObject {
public:
    OAI_events_post_request();
    OAI_events_post_request(QString json);
    ~OAI_events_post_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_events_post_request)

#endif // OAI_events_post_request_H
