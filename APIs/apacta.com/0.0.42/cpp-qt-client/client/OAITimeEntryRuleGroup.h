...
/*
 * OAITimeEntryRuleGroup.h
 *
 * 
 */

#ifndef OAITimeEntryRuleGroup_H
#define OAITimeEntryRuleGroup_H
...
class OAITimeEntryRuleGroup : public OAIObject {
public:
    OAITimeEntryRuleGroup();
    OAITimeEntryRuleGroup(QString json);
    ~OAITimeEntryRuleGroup() override;
    ...
    float getSalaryPeriodDays() const;
    void setSalaryPeriodDays(const float &salary_period_days);
    bool is_salary_period_days_Set() const;
    bool is_salary_period_days_Valid() const;

    QString getSalaryPeriodFrom() const;
    void setSalaryPeriodFrom(const QString &salary_period_from);
    bool is_salary_period_from_Set() const;
    bool is_salary_period_from_Valid() const;
...
private:
    ...
    float m_salary_period_days;
    bool m_salary_period_days_isSet;
    bool m_salary_period_days_isValid;

    QString m_salary_period_from;
    bool m_salary_period_from_isSet;
    bool m_salary_period_from_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITimeEntryRuleGroup)

#endif // OAITimeEntryRuleGroup_H
