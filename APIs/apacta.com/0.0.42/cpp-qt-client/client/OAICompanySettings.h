...
/*
 * OAICompanySettings.h
 *
 * 
 */

#ifndef OAICompanySettings_H
#define OAICompanySettings_H
...
class OAICompanySettings : public OAIObject {
public:
    OAICompanySettings();
    OAICompanySettings(QString json);
    ~OAICompanySettings() override;
    ...
    QString getCompanySettingsCategoryId() const;
    void setCompanySettingsCategoryId(const QString &company_settings_category_id);
    bool is_company_settings_category_id_Set() const;
    bool is_company_settings_category_id_Valid() const;
    ...
    qint32 getPlacement() const;
    void setPlacement(const qint32 &placement);
...
private:
    ...
    QString m_company_settings_category_id;
    bool m_company_settings_category_id_isSet;
    bool m_company_settings_category_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompanySettings)

#endif // OAICompanySettings_H
