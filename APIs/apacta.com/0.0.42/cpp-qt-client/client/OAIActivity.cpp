...
QString OAIActivity::getCreated() const {
    return m_created;
}
void OAIActivity::setCreated(const QString &created) {
    m_created = created;
...
QString OAIActivity::getCreatedById() const {
    return m_created_by_id;
}
void OAIActivity::setCreatedById(const QString &created_by_id) {
    m_created_by_id = created_by_id;
    m_created_by_id_isSet = true;
}

bool OAIActivity::is_created_by_id_Set() const{
    return m_created_by_id_isSet;
}

bool OAIActivity::is_created_by_id_Valid() const{
    return m_created_by_id_isValid;
}

QString OAIActivity::getDeleted() const {
    return m_deleted;
}
void OAIActivity::setDeleted(const QString &deleted) {
    m_deleted = deleted;
...
QString OAIActivity::getHexCode() const {
    return m_hex_code;
}
void OAIActivity::setHexCode(const QString &hex_code) {
    m_hex_code = hex_code;
    m_hex_code_isSet = true;
}

bool OAIActivity::is_hex_code_Set() const{
    return m_hex_code_isSet;
}

bool OAIActivity::is_hex_code_Valid() const{
...
QString OAIActivity::getModified() const {
    return m_modified;
}
void OAIActivity::setModified(const QString &modified) {
    m_modified = modified;
    m_modified_isSet = true;
}

bool OAIActivity::is_modified_Set() const{
    return m_modified_isSet;
}

bool OAIActivity::is_modified_Valid() const{
