...
#ifndef OAIMaterialRental_H
#define OAIMaterialRental_H
...
class OAIMaterialRental : public OAIObject {
public:
    OAIMaterialRental();
    OAIMaterialRental(QString json);
    ~OAIMaterialRental() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMaterialRental)

#endif // OAIMaterialRental_H
