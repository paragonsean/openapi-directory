...
/*
 * OAI_expenses_post_request.h
 *
 * 
 */

#ifndef OAI_expenses_post_request_H
#define OAI_expenses_post_request_H
...
class OAI_expenses_post_request : public OAIObject {
public:
    OAI_expenses_post_request();
    OAI_expenses_post_request(QString json);
    ~OAI_expenses_post_request() override;
    ...
    QString getSupplierInvoiceNumber() const;
    void setSupplierInvoiceNumber(const QString &supplier_invoice_number);
    bool is_supplier_invoice_number_Set() const;
    bool is_supplier_invoice_number_Valid() const;
...
private:
    ...
    QString m_supplier_invoice_number;
    bool m_supplier_invoice_number_isSet;
    bool m_supplier_invoice_number_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAI_expenses_post_request)

#endif // OAI_expenses_post_request_H
