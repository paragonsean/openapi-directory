...
#ifndef OAIVendorProduct_H
#define OAIVendorProduct_H
...
class OAIVendorProduct : public OAIObject {
public:
    OAIVendorProduct();
    OAIVendorProduct(QString json);
    ~OAIVendorProduct() override;
    ...
    QString getProductCategoryNumber() const;
    void setProductCategoryNumber(const QString &product_category_number);
    bool is_product_category_number_Set() const;
    bool is_product_category_number_Valid() const;
...
private:
    ...
    QString m_product_category_number;
    bool m_product_category_number_isSet;
    bool m_product_category_number_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVendorProduct)

#endif // OAIVendorProduct_H
