...
/*
 * OAITimeEntryInterval.h
 *
 * 
 */

#ifndef OAITimeEntryInterval_H
#define OAITimeEntryInterval_H
...
class OAITimeEntryInterval : public OAIObject {
public:
    OAITimeEntryInterval();
    OAITimeEntryInterval(QString json);
    ~OAITimeEntryInterval() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeEntryInterval)

#endif // OAITimeEntryInterval_H
