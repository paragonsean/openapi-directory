...
#ifndef OAIWallPost_H
#define OAIWallPost_H
...
class OAIWallPost : public OAIObject {
public:
    OAIWallPost();
    OAIWallPost(QString json);
    ~OAIWallPost() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWallPost)
