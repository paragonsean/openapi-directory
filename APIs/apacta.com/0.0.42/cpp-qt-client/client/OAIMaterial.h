...
public:
    ...
    bool isIsSingleUsage() const;
    void setIsSingleUsage(const bool &is_single_usage);
    bool is_is_single_usage_Set() const;
    bool is_is_single_usage_Valid() const;
...
private:
    ...
    bool m_is_single_usage;
    bool m_is_single_usage_isSet;
    bool m_is_single_usage_isValid;
