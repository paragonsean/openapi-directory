...
#ifndef OAIInvoiceFile_H
#define OAIInvoiceFile_H
...
class OAIInvoiceFile : public OAIObject {
public:
    OAIInvoiceFile();
    OAIInvoiceFile(QString json);
    ~OAIInvoiceFile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceFile)

#endif // OAIInvoiceFile_H
