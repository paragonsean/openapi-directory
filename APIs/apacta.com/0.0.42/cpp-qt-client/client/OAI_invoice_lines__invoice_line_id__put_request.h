...
/*
 * OAI_invoice_lines__invoice_line_id__put_request.h
 *
 * 
 */

#ifndef OAI_invoice_lines__invoice_line_id__put_request_H
#define OAI_invoice_lines__invoice_line_id__put_request_H
...
class OAI_invoice_lines__invoice_line_id__put_request : public OAIObject {
public:
    OAI_invoice_lines__invoice_line_id__put_request();
    OAI_invoice_lines__invoice_line_id__put_request(QString json);
    ~OAI_invoice_lines__invoice_line_id__put_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_invoice_lines__invoice_line_id__put_request)

#endif // OAI_invoice_lines__invoice_line_id__put_request_H
