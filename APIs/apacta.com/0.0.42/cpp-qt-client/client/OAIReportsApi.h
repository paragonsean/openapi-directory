...
Q_SIGNALS:
    ...
    void reportsGetSignal();


    void reportsGetSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use reportsGetSignalError() instead")
    void reportsGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void reportsGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
