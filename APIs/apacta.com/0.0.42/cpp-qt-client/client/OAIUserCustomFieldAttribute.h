...
/*
 * OAIUserCustomFieldAttribute.h
 *
 * 
 */

#ifndef OAIUserCustomFieldAttribute_H
#define OAIUserCustomFieldAttribute_H
...
class OAIUserCustomFieldAttribute : public OAIObject {
public:
    OAIUserCustomFieldAttribute();
    OAIUserCustomFieldAttribute(QString json);
    ~OAIUserCustomFieldAttribute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserCustomFieldAttribute)

#endif // OAIUserCustomFieldAttribute_H
