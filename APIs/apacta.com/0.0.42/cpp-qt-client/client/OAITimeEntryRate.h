...
#ifndef OAITimeEntryRate_H
#define OAITimeEntryRate_H
...
class OAITimeEntryRate : public OAIObject {
public:
    OAITimeEntryRate();
    OAITimeEntryRate(QString json);
    ~OAITimeEntryRate() override;
    ...
    float getSellingAmount() const;
    void setSellingAmount(const float &selling_amount);
    bool is_selling_amount_Set() const;
    bool is_selling_amount_Valid() const;

    QString getTimeEntryTypeId() const;
    void setTimeEntryTypeId(const QString &time_entry_type_id);
    bool is_time_entry_type_id_Set() const;
    bool is_time_entry_type_id_Valid() const;
...
private:
    ...
    float m_selling_amount;
    bool m_selling_amount_isSet;
    bool m_selling_amount_isValid;

    QString m_time_entry_type_id;
    bool m_time_entry_type_id_isSet;
    bool m_time_entry_type_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITimeEntryRate)

#endif // OAITimeEntryRate_H
