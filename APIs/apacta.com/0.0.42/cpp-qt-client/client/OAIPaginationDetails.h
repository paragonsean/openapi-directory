...
/*
 * OAIPaginationDetails.h
 *
 * 
 */

#ifndef OAIPaginationDetails_H
#define OAIPaginationDetails_H
...
class OAIPaginationDetails : public OAIObject {
public:
    OAIPaginationDetails();
    OAIPaginationDetails(QString json);
    ~OAIPaginationDetails() override;
    ...
    bool is_has_prev_page_Set() const;
    bool is_has_prev_page_Valid() const;
    ...
    void setPageCount(const QString &page_count);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaginationDetails)

#endif // OAIPaginationDetails_H
