...
QString OAIEvent::getCompanyId() const {
    return m_company_id;
}
void OAIEvent::setCompanyId(const QString &company_id) {
    m_company_id = company_id;
    m_company_id_isSet = true;
}

bool OAIEvent::is_company_id_Set() const{
    return m_company_id_isSet;
}

bool OAIEvent::is_company_id_Valid() const{
    return m_company_id_isValid;
}

QString OAIEvent::getCreated() const {
    return m_created;
}
void OAIEvent::setCreated(const QString &created) {
    m_created = created;
...
QString OAIEvent::getCreatedById() const {
    return m_created_by_id;
}
void OAIEvent::setCreatedById(const QString &created_by_id) {
    m_created_by_id = created_by_id;
    m_created_by_id_isSet = true;
}

bool OAIEvent::is_created_by_id_Set() const{
    return m_created_by_id_isSet;
}

bool OAIEvent::is_created_by_id_Valid() const{
    return m_created_by_id_isValid;
}

QString OAIEvent::getDeleted() const {
    return m_deleted;
}
void OAIEvent::setDeleted(const QString &deleted) {
    m_deleted = deleted;
...
QString OAIEvent::getEnd() const {
    return m_end;
}
void OAIEvent::setEnd(const QString &end) {
    m_end = end;
    m_end_isSet = true;
}
...
QString OAIEvent::getModified() const {
    return m_modified;
}
void OAIEvent::setModified(const QString &modified) {
    m_modified = modified;
    m_modified_isSet = true;
}

bool OAIEvent::is_modified_Set() const{
    return m_modified_isSet;
}

bool OAIEvent::is_modified_Valid() const{
    return m_modified_isValid;
}

QString OAIEvent::getModifiedById() const {
    return m_modified_by_id;
}
void OAIEvent::setModifiedById(const QString &modified_by_id) {
    m_modified_by_id = modified_by_id;
    m_modified_by_id_isSet = true;
}

bool OAIEvent::is_modified_by_id_Set() const{
    return m_modified_by_id_isSet;
}

bool OAIEvent::is_modified_by_id_Valid() const{
...
QString OAIEvent::getStart() const {
    return m_start;
}
void OAIEvent::setStart(const QString &start) {
    m_start = start;
    m_start_isSet = true;
}
