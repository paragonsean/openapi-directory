...
/*
 * OAICompaniesVendor.h
 *
 * 
 */

#ifndef OAICompaniesVendor_H
#define OAICompaniesVendor_H
...
class OAICompaniesVendor : public OAIObject {
public:
    OAICompaniesVendor();
    OAICompaniesVendor(QString json);
    ~OAICompaniesVendor() override;
    ...
    QString getCompanyPassword() const;
    void setCompanyPassword(const QString &company_password);
    bool is_company_password_Set() const;
    bool is_company_password_Valid() const;
    ...
    OAIVendor getVendor() const;
    void setVendor(const OAIVendor &vendor);
...
private:
    ...
    QString m_company_password;
    bool m_company_password_isSet;
    bool m_company_password_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompaniesVendor)

#endif // OAICompaniesVendor_H
