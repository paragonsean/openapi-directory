...
/*
 * OAICompaniesIntegrationFeatureSetting.h
 *
 * 
 */

#ifndef OAICompaniesIntegrationFeatureSetting_H
#define OAICompaniesIntegrationFeatureSetting_H
...
class OAICompaniesIntegrationFeatureSetting : public OAIObject {
public:
    OAICompaniesIntegrationFeatureSetting();
    OAICompaniesIntegrationFeatureSetting(QString json);
    ~OAICompaniesIntegrationFeatureSetting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompaniesIntegrationFeatureSetting)

#endif // OAICompaniesIntegrationFeatureSetting_H
