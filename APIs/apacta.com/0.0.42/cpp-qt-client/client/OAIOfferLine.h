...
#ifndef OAIOfferLine_H
#define OAIOfferLine_H
...
class OAIOfferLine : public OAIObject {
public:
    OAIOfferLine();
    OAIOfferLine(QString json);
    ~OAIOfferLine() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferLine)

#endif // OAIOfferLine_H
