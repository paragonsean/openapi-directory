...
#ifndef OAITimeEntry_H
#define OAITimeEntry_H
...
class OAITimeEntry : public OAIObject {
public:
    OAITimeEntry();
    OAITimeEntry(QString json);
    ~OAITimeEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeEntry)

#endif // OAITimeEntry_H
