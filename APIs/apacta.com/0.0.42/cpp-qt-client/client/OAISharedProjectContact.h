...
/*
 * OAISharedProjectContact.h
 *
 * 
 */

#ifndef OAISharedProjectContact_H
#define OAISharedProjectContact_H
...
class OAISharedProjectContact : public OAIObject {
public:
    OAISharedProjectContact();
    OAISharedProjectContact(QString json);
    ~OAISharedProjectContact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISharedProjectContact)

#endif // OAISharedProjectContact_H
