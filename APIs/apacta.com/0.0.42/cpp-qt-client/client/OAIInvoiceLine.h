...
public:
    ...
    QString getDiscountText() const;
    void setDiscountText(const QString &discount_text);
    bool is_discount_text_Set() const;
    bool is_discount_text_Valid() const;

    QString getEanProductId() const;
    void setEanProductId(const QString &ean_product_id);
    bool is_ean_product_id_Set() const;
    bool is_ean_product_id_Valid() const;
    ...
    void setMaterialId(const QString &material_id);
    ...
    QString getProductBundleId() const;
    void setProductBundleId(const QString &product_bundle_id);
    bool is_product_bundle_id_Set() const;
    bool is_product_bundle_id_Valid() const;
...
private:
    ...
    QString m_discount_text;
    bool m_discount_text_isSet;
    bool m_discount_text_isValid;

    QString m_ean_product_id;
    bool m_ean_product_id_isSet;
    bool m_ean_product_id_isValid;
    ...
    QString m_product_bundle_id;
    bool m_product_bundle_id_isSet;
    bool m_product_bundle_id_isValid;
