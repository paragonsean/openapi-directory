...
#ifndef OAIStockLocation_H
#define OAIStockLocation_H
...
class OAIStockLocation : public OAIObject {
public:
    OAIStockLocation();
    OAIStockLocation(QString json);
    ~OAIStockLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStockLocation)

#endif // OAIStockLocation_H
