...
/*
 * OAICompaniesFormTemplates.h
 *
 * 
 */

#ifndef OAICompaniesFormTemplates_H
#define OAICompaniesFormTemplates_H
...
class OAICompaniesFormTemplates : public OAIObject {
public:
    OAICompaniesFormTemplates();
    OAICompaniesFormTemplates(QString json);
    ~OAICompaniesFormTemplates() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompaniesFormTemplates)

#endif // OAICompaniesFormTemplates_H
