...
/*
 * OAIInvoiceLineText.h
 *
 * 
 */

#ifndef OAIInvoiceLineText_H
#define OAIInvoiceLineText_H
...
class OAIInvoiceLineText : public OAIObject {
public:
    OAIInvoiceLineText();
    OAIInvoiceLineText(QString json);
    ~OAIInvoiceLineText() override;
    ...
    QString getInvoiceLineId() const;
    void setInvoiceLineId(const QString &invoice_line_id);
    bool is_invoice_line_id_Set() const;
    bool is_invoice_line_id_Valid() const;
...
private:
    ...
    QString m_invoice_line_id;
    bool m_invoice_line_id_isSet;
    bool m_invoice_line_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceLineText)

#endif // OAIInvoiceLineText_H
