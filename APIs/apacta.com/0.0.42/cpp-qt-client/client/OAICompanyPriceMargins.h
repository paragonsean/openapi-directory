...
/*
 * OAICompanyPriceMargins.h
 *
 * 
 */

#ifndef OAICompanyPriceMargins_H
#define OAICompanyPriceMargins_H
...
class OAICompanyPriceMargins : public OAIObject {
public:
    OAICompanyPriceMargins();
    OAICompanyPriceMargins(QString json);
    ~OAICompanyPriceMargins() override;
    ...
    double getPercentageRatio() const;
    void setPercentageRatio(const double &percentage_ratio);
    bool is_percentage_ratio_Set() const;
    bool is_percentage_ratio_Valid() const;
...
private:
    ...
    double m_percentage_ratio;
    bool m_percentage_ratio_isSet;
    bool m_percentage_ratio_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompanyPriceMargins)

#endif // OAICompanyPriceMargins_H
