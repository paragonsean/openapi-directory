...
/*
 * OAI_invoices_post_request.h
 *
 * 
 */

#ifndef OAI_invoices_post_request_H
#define OAI_invoices_post_request_H
...
class OAI_invoices_post_request : public OAIObject {
public:
    OAI_invoices_post_request();
    OAI_invoices_post_request(QString json);
    ~OAI_invoices_post_request() override;
    ...
    QDate getCreatedOrModifiedGte() const;
    void setCreatedOrModifiedGte(const QDate &created_or_modified_gte);
    bool is_created_or_modified_gte_Set() const;
    bool is_created_or_modified_gte_Valid() const;
...
private:
    ...
    QDate m_created_or_modified_gte;
    bool m_created_or_modified_gte_isSet;
    bool m_created_or_modified_gte_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_invoices_post_request)

#endif // OAI_invoices_post_request_H
