...
#ifndef OAIExpenseFile_H
#define OAIExpenseFile_H
...
class OAIExpenseFile : public OAIObject {
public:
    OAIExpenseFile();
    OAIExpenseFile(QString json);
    ~OAIExpenseFile() override;
    ...
    QString getFileOriginalName() const;
    void setFileOriginalName(const QString &file_original_name);
    bool is_file_original_name_Set() const;
    bool is_file_original_name_Valid() const;
...
private:
    ...
    QString m_file_original_name;
    bool m_file_original_name_isSet;
    bool m_file_original_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExpenseFile)

#endif // OAIExpenseFile_H
