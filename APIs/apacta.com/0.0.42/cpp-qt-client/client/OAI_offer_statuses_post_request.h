...
/*
 * OAI_offer_statuses_post_request.h
 *
 * 
 */

#ifndef OAI_offer_statuses_post_request_H
#define OAI_offer_statuses_post_request_H
...
class OAI_offer_statuses_post_request : public OAIObject {
public:
    OAI_offer_statuses_post_request();
    OAI_offer_statuses_post_request(QString json);
    ~OAI_offer_statuses_post_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_offer_statuses_post_request)

#endif // OAI_offer_statuses_post_request_H
