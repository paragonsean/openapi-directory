...
QString OAIRole::getCreated() const {
    return m_created;
}
void OAIRole::setCreated(const QString &created) {
    m_created = created;
...
QString OAIRole::getCreatedById() const {
    return m_created_by_id;
}
void OAIRole::setCreatedById(const QString &created_by_id) {
    m_created_by_id = created_by_id;
    m_created_by_id_isSet = true;
}

bool OAIRole::is_created_by_id_Set() const{
    return m_created_by_id_isSet;
}

bool OAIRole::is_created_by_id_Valid() const{
    return m_created_by_id_isValid;
}

QString OAIRole::getDeleted() const {
    return m_deleted;
}
void OAIRole::setDeleted(const QString &deleted) {
    m_deleted = deleted;
    m_deleted_isSet = true;
}

bool OAIRole::is_deleted_Set() const{
    return m_deleted_isSet;
}

bool OAIRole::is_deleted_Valid() const{
...
QString OAIRole::getIdentifier() const {
    return m_identifier;
}
void OAIRole::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIRole::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIRole::is_identifier_Valid() const{
    return m_identifier_isValid;
}

QString OAIRole::getModified() const {
    return m_modified;
}
void OAIRole::setModified(const QString &modified) {
    m_modified = modified;
    m_modified_isSet = true;
}

bool OAIRole::is_modified_Set() const{
    return m_modified_isSet;
}

bool OAIRole::is_modified_Valid() const{
