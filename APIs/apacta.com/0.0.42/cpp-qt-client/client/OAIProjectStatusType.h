...
/*
 * OAIProjectStatusType.h
 *
 * 
 */

#ifndef OAIProjectStatusType_H
#define OAIProjectStatusType_H
...
class OAIProjectStatusType : public OAIObject {
public:
    OAIProjectStatusType();
    OAIProjectStatusType(QString json);
    ~OAIProjectStatusType() override;
    ...
    bool is__locale_Set() const;
    bool is__locale_Valid() const;
...
private:
    ...
    QString m__locale;
    bool m__locale_isSet;
    bool m__locale_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectStatusType)

#endif // OAIProjectStatusType_H
