...
/*
 * OAISharedProjectVendor.h
 *
 * 
 */

#ifndef OAISharedProjectVendor_H
#define OAISharedProjectVendor_H
...
class OAISharedProjectVendor : public OAIObject {
public:
    OAISharedProjectVendor();
    OAISharedProjectVendor(QString json);
    ~OAISharedProjectVendor() override;
    ...
    bool isSentEmail() const;
    void setSentEmail(const bool &sent_email);
    bool is_sent_email_Set() const;
    bool is_sent_email_Valid() const;

    bool isSentSms() const;
    void setSentSms(const bool &sent_sms);
    bool is_sent_sms_Set() const;
    bool is_sent_sms_Valid() const;
...
private:
    ...
    bool m_sent_email;
    bool m_sent_email_isSet;
    bool m_sent_email_isValid;

    bool m_sent_sms;
    bool m_sent_sms_isSet;
    bool m_sent_sms_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISharedProjectVendor)

#endif // OAISharedProjectVendor_H
