...
#ifndef OAIExpenseLine_H
#define OAIExpenseLine_H
...
class OAIExpenseLine : public OAIObject {
public:
    OAIExpenseLine();
    OAIExpenseLine(QString json);
    ~OAIExpenseLine() override;
    ...
    QString getIsInvoiced() const;
    void setIsInvoiced(const QString &is_invoiced);
...
Q_DECLARE_METATYPE(OpenAPI::OAIExpenseLine)

#endif // OAIExpenseLine_H
