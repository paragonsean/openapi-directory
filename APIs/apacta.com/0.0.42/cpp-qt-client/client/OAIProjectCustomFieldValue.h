...
/*
 * OAIProjectCustomFieldValue.h
 *
 * 
 */

#ifndef OAIProjectCustomFieldValue_H
#define OAIProjectCustomFieldValue_H
...
class OAIProjectCustomFieldValue : public OAIObject {
public:
    OAIProjectCustomFieldValue();
    OAIProjectCustomFieldValue(QString json);
    ~OAIProjectCustomFieldValue() override;
    ...
    QString getProjectCustomFieldAttributeId() const;
    void setProjectCustomFieldAttributeId(const QString &project_custom_field_attribute_id);
    bool is_project_custom_field_attribute_id_Set() const;
    bool is_project_custom_field_attribute_id_Valid() const;
...
private:
    ...
    QString m_project_custom_field_attribute_id;
    bool m_project_custom_field_attribute_id_isSet;
    bool m_project_custom_field_attribute_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectCustomFieldValue)

#endif // OAIProjectCustomFieldValue_H
