...
/*
 * OAIInvoiceLineTextTemplate.h
 *
 * 
 */

#ifndef OAIInvoiceLineTextTemplate_H
#define OAIInvoiceLineTextTemplate_H
...
class OAIInvoiceLineTextTemplate : public OAIObject {
public:
    OAIInvoiceLineTextTemplate();
    OAIInvoiceLineTextTemplate(QString json);
    ~OAIInvoiceLineTextTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceLineTextTemplate)

#endif // OAIInvoiceLineTextTemplate_H
