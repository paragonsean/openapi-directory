...
/*
 * OAI_projects__project_id__put_request.h
 *
 * 
 */

#ifndef OAI_projects__project_id__put_request_H
#define OAI_projects__project_id__put_request_H
...
class OAI_projects__project_id__put_request : public OAIObject {
public:
    OAI_projects__project_id__put_request();
    OAI_projects__project_id__put_request(QString json);
    ~OAI_projects__project_id__put_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_projects__project_id__put_request)

#endif // OAI_projects__project_id__put_request_H
