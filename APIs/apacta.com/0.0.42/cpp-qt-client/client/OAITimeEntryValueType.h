...
/*
 * OAITimeEntryValueType.h
 *
 * 
 */

#ifndef OAITimeEntryValueType_H
#define OAITimeEntryValueType_H
...
class OAITimeEntryValueType : public OAIObject {
public:
    OAITimeEntryValueType();
    OAITimeEntryValueType(QString json);
    ~OAITimeEntryValueType() override;
    ...
    QString getTimeEntryUnitTypeId() const;
    void setTimeEntryUnitTypeId(const QString &time_entry_unit_type_id);
    bool is_time_entry_unit_type_id_Set() const;
    bool is_time_entry_unit_type_id_Valid() const;
...
private:
    ...
    QString m_time_entry_unit_type_id;
    bool m_time_entry_unit_type_id_isSet;
    bool m_time_entry_unit_type_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITimeEntryValueType)

#endif // OAITimeEntryValueType_H
