...
/*
 * OAIAddVendor_request.h
 *
 * 
 */

#ifndef OAIAddVendor_request_H
#define OAIAddVendor_request_H
...
class OAIAddVendor_request : public OAIObject {
public:
    OAIAddVendor_request();
    OAIAddVendor_request(QString json);
    ~OAIAddVendor_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddVendor_request)

#endif // OAIAddVendor_request_H
