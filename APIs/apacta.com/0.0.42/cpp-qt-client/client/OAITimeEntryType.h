...
#ifndef OAITimeEntryType_H
#define OAITimeEntryType_H
...
class OAITimeEntryType : public OAIObject {
public:
    OAITimeEntryType();
    OAITimeEntryType(QString json);
    ~OAITimeEntryType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeEntryType)

#endif // OAITimeEntryType_H
