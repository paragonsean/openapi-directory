...
class OAIExpense : public OAIObject {
public:
    OAIExpense();
    OAIExpense(QString json);
    ~OAIExpense() override;
    ...
    QString getFileReference() const;
    void setFileReference(const QString &file_reference);
    bool is_file_reference_Set() const;
    bool is_file_reference_Valid() const;
    ...
    QString getIsImported() const;
    void setIsImported(const QString &is_imported);
    bool is_is_imported_Set() const;
    bool is_is_imported_Valid() const;
    ...
    QString getReadsoftId() const;
    void setReadsoftId(const QString &readsoft_id);
    bool is_readsoft_id_Set() const;
    bool is_readsoft_id_Valid() const;
    ...
    QString getRogerId() const;
    void setRogerId(const QString &roger_id);
    bool is_roger_id_Set() const;
    bool is_roger_id_Valid() const;

    QString getSentToEmail() const;
    void setSentToEmail(const QString &sent_to_email);
    bool is_sent_to_email_Set() const;
    bool is_sent_to_email_Valid() const;
    ...
    float getTotalBuyingPrice() const;
    void setTotalBuyingPrice(const float &total_buying_price);
    bool is_total_buying_price_Set() const;
    bool is_total_buying_price_Valid() const;

    float getTotalSellingPrice() const;
    void setTotalSellingPrice(const float &total_selling_price);
    bool is_total_selling_price_Set() const;
    bool is_total_selling_price_Valid() const;
...
private:
    ...
    QString m_file_reference;
    bool m_file_reference_isSet;
    bool m_file_reference_isValid;

    QString m_id;
    bool m_id_isSet;
    bool m_id_isValid;

    QString m_is_imported;
    bool m_is_imported_isSet;
    bool m_is_imported_isValid;
    ...
    QString m_readsoft_id;
    bool m_readsoft_id_isSet;
    bool m_readsoft_id_isValid;
    ...
    QString m_roger_id;
    bool m_roger_id_isSet;
    bool m_roger_id_isValid;

    QString m_sent_to_email;
    bool m_sent_to_email_isSet;
    bool m_sent_to_email_isValid;
    ...
    float m_total_buying_price;
    bool m_total_buying_price_isSet;
    bool m_total_buying_price_isValid;

    float m_total_selling_price;
    bool m_total_selling_price_isSet;
    bool m_total_selling_price_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIExpense)
