...
#ifndef OAIDrivingType_H
#define OAIDrivingType_H
...
class OAIDrivingType : public OAIObject {
public:
    OAIDrivingType();
    OAIDrivingType(QString json);
    ~OAIDrivingType() override;
    ...
    double getInvoicePrice() const;
    void setInvoicePrice(const double &invoice_price);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDrivingType)

#endif // OAIDrivingType_H
