...
void OAIReportsApi::reportsGet() {
    QString fullPath = QString(_serverConfigs["reportsGet"][_serverIndices.value("reportsGet")].URL()+"/reports");
...
void OAIReportsApi::reportsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT reportsGetSignal();
        Q_EMIT reportsGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT reportsGetSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT reportsGetSignalError(error_type, error_str);
