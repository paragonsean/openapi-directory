...
#ifndef OAIPlannedProduct_H
#define OAIPlannedProduct_H
...
class OAIPlannedProduct : public OAIObject {
public:
    OAIPlannedProduct();
    OAIPlannedProduct(QString json);
    ~OAIPlannedProduct() override;
    ...
    QString getVendorProductId() const;
    void setVendorProductId(const QString &vendor_product_id);
    bool is_vendor_product_id_Set() const;
    bool is_vendor_product_id_Valid() const;
...
private:
    ...
    QString m_vendor_product_id;
    bool m_vendor_product_id_isSet;
    bool m_vendor_product_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPlannedProduct)

#endif // OAIPlannedProduct_H
