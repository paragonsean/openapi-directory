...
#ifndef OAIFormFieldType_H
#define OAIFormFieldType_H
...
class OAIFormFieldType : public OAIObject {
public:
    OAIFormFieldType();
    OAIFormFieldType(QString json);
    ~OAIFormFieldType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormFieldType)

#endif // OAIFormFieldType_H
