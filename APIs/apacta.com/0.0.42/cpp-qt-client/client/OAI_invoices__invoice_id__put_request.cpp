...
OAI_invoices__invoice_id__put_request::OAI_invoices__invoice_id__put_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_invoices__invoice_id__put_request::OAI_invoices__invoice_id__put_request() {
    this->initializeModel();
}

OAI_invoices__invoice_id__put_request::~OAI_invoices__invoice_id__put_request() {}

void OAI_invoices__invoice_id__put_request::initializeModel() {
...
void OAI_invoices__invoice_id__put_request::fromJson(QString jsonString) {
...
void OAI_invoices__invoice_id__put_request::fromJsonObject(QJsonObject json) {
...
QString OAI_invoices__invoice_id__put_request::asJson() const {
...
QJsonObject OAI_invoices__invoice_id__put_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAI_invoices__invoice_id__put_request::getContactId() const {
    return m_contact_id;
}
void OAI_invoices__invoice_id__put_request::setContactId(const QString &contact_id) {
    m_contact_id = contact_id;
    m_contact_id_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_contact_id_Set() const{
    return m_contact_id_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_contact_id_Valid() const{
    return m_contact_id_isValid;
}

QDate OAI_invoices__invoice_id__put_request::getDateFrom() const {
    return m_date_from;
}
void OAI_invoices__invoice_id__put_request::setDateFrom(const QDate &date_from) {
    m_date_from = date_from;
    m_date_from_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_date_from_Set() const{
    return m_date_from_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_date_from_Valid() const{
    return m_date_from_isValid;
}

QDate OAI_invoices__invoice_id__put_request::getDateTo() const {
    return m_date_to;
}
void OAI_invoices__invoice_id__put_request::setDateTo(const QDate &date_to) {
    m_date_to = date_to;
    m_date_to_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_date_to_Set() const{
    return m_date_to_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_date_to_Valid() const{
    return m_date_to_isValid;
}

QString OAI_invoices__invoice_id__put_request::getErpId() const {
    return m_erp_id;
}
void OAI_invoices__invoice_id__put_request::setErpId(const QString &erp_id) {
    m_erp_id = erp_id;
    m_erp_id_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_erp_id_Set() const{
    return m_erp_id_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_erp_id_Valid() const{
    return m_erp_id_isValid;
}

QString OAI_invoices__invoice_id__put_request::getErpPaymentTermId() const {
    return m_erp_payment_term_id;
}
void OAI_invoices__invoice_id__put_request::setErpPaymentTermId(const QString &erp_payment_term_id) {
    m_erp_payment_term_id = erp_payment_term_id;
    m_erp_payment_term_id_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_erp_payment_term_id_Set() const{
    return m_erp_payment_term_id_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_erp_payment_term_id_Valid() const{
    return m_erp_payment_term_id_isValid;
}

qint32 OAI_invoices__invoice_id__put_request::getInvoiceNumber() const {
    return m_invoice_number;
}
void OAI_invoices__invoice_id__put_request::setInvoiceNumber(const qint32 &invoice_number) {
    m_invoice_number = invoice_number;
    m_invoice_number_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_invoice_number_Set() const{
    return m_invoice_number_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_invoice_number_Valid() const{
    return m_invoice_number_isValid;
}

bool OAI_invoices__invoice_id__put_request::isIsDraft() const {
    return m_is_draft;
}
void OAI_invoices__invoice_id__put_request::setIsDraft(const bool &is_draft) {
    m_is_draft = is_draft;
    m_is_draft_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_is_draft_Set() const{
    return m_is_draft_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_is_draft_Valid() const{
    return m_is_draft_isValid;
}

bool OAI_invoices__invoice_id__put_request::isIsLocked() const {
    return m_is_locked;
}
void OAI_invoices__invoice_id__put_request::setIsLocked(const bool &is_locked) {
    m_is_locked = is_locked;
    m_is_locked_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_is_locked_Set() const{
    return m_is_locked_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_is_locked_Valid() const{
    return m_is_locked_isValid;
}

bool OAI_invoices__invoice_id__put_request::isIsOffer() const {
    return m_is_offer;
}
void OAI_invoices__invoice_id__put_request::setIsOffer(const bool &is_offer) {
    m_is_offer = is_offer;
    m_is_offer_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_is_offer_Set() const{
    return m_is_offer_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_is_offer_Valid() const{
    return m_is_offer_isValid;
}

QDate OAI_invoices__invoice_id__put_request::getIssuedDate() const {
    return m_issued_date;
}
void OAI_invoices__invoice_id__put_request::setIssuedDate(const QDate &issued_date) {
    m_issued_date = issued_date;
    m_issued_date_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_issued_date_Set() const{
    return m_issued_date_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_issued_date_Valid() const{
    return m_issued_date_isValid;
}

QString OAI_invoices__invoice_id__put_request::getMessage() const {
    return m_message;
}
void OAI_invoices__invoice_id__put_request::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_message_Set() const{
    return m_message_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_message_Valid() const{
    return m_message_isValid;
}

qint32 OAI_invoices__invoice_id__put_request::getOfferNumber() const {
    return m_offer_number;
}
void OAI_invoices__invoice_id__put_request::setOfferNumber(const qint32 &offer_number) {
    m_offer_number = offer_number;
    m_offer_number_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_offer_number_Set() const{
    return m_offer_number_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_offer_number_Valid() const{
    return m_offer_number_isValid;
}

QDate OAI_invoices__invoice_id__put_request::getPaymentDueDate() const {
    return m_payment_due_date;
}
void OAI_invoices__invoice_id__put_request::setPaymentDueDate(const QDate &payment_due_date) {
    m_payment_due_date = payment_due_date;
    m_payment_due_date_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_payment_due_date_Set() const{
    return m_payment_due_date_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_payment_due_date_Valid() const{
    return m_payment_due_date_isValid;
}

QString OAI_invoices__invoice_id__put_request::getPaymentTermId() const {
    return m_payment_term_id;
}
void OAI_invoices__invoice_id__put_request::setPaymentTermId(const QString &payment_term_id) {
    m_payment_term_id = payment_term_id;
    m_payment_term_id_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_payment_term_id_Set() const{
    return m_payment_term_id_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_payment_term_id_Valid() const{
    return m_payment_term_id_isValid;
}

QString OAI_invoices__invoice_id__put_request::getProjectId() const {
    return m_project_id;
}
void OAI_invoices__invoice_id__put_request::setProjectId(const QString &project_id) {
    m_project_id = project_id;
    m_project_id_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_project_id_Set() const{
    return m_project_id_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_project_id_Valid() const{
    return m_project_id_isValid;
}

QString OAI_invoices__invoice_id__put_request::getReference() const {
    return m_reference;
}
void OAI_invoices__invoice_id__put_request::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_reference_Valid() const{
    return m_reference_isValid;
}

qint32 OAI_invoices__invoice_id__put_request::getVatPercent() const {
    return m_vat_percent;
}
void OAI_invoices__invoice_id__put_request::setVatPercent(const qint32 &vat_percent) {
    m_vat_percent = vat_percent;
    m_vat_percent_isSet = true;
}

bool OAI_invoices__invoice_id__put_request::is_vat_percent_Set() const{
    return m_vat_percent_isSet;
}

bool OAI_invoices__invoice_id__put_request::is_vat_percent_Valid() const{
    return m_vat_percent_isValid;
}

bool OAI_invoices__invoice_id__put_request::isSet() const {
...
bool OAI_invoices__invoice_id__put_request::isValid() const {
