...
void Example::exampleFunction1(){
     OAIActivitiesApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIActivitiesApi::activitiesActivityIdDeleteSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIActivitiesApi::activitiesActivityIdDeleteSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString activity_id = create(); // QString | 
      apiInstance.activitiesActivityIdDelete(activity_id);
