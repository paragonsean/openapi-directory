...
let apiInstance = new Apacta.OffersApi();
apiInstance.offersGet((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.offersOfferIdDelete(offerId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Apacta.OffersApi();
let offerId = "offerId_example"; // String | 
apiInstance.offersOfferIdGet(offerId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> EmptySuccessResponse offersOfferIdPut(offerId, opts)
...
apiInstance.offersOfferIdPut(offerId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CreateSuccessResponse offersPost(opts)
...
let apiInstance = new Apacta.OffersApi();
let opts = {
  'offersPostRequest': new Apacta.OffersPostRequest() // OffersPostRequest | 
};
apiInstance.offersPost(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
