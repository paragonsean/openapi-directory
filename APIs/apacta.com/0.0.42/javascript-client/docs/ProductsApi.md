...
let apiInstance = new Apacta.ProductsApi();
let bulkActionRequestBody = new Apacta.BulkActionRequestBody(); // BulkActionRequestBody | Products ids
apiInstance.bulkDeleteProducts(bulkActionRequestBody, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ProductsGet200Response productsGet(opts)
...
let apiInstance = new Apacta.ProductsApi();
let opts = {
  'name': "name_example", // String | Used to filter on the `name` of the products
  'productNumber': "productNumber_example", // String | Used to filter on the `product_number` of the products
  'barcode': "barcode_example", // String | Used to filter on the `barcode` of the products
 ...
 **productNumber** | **String**| Used to filter on the &#x60;product_number&#x60; of the products | [optional] 
...
> ClockingRecordsPost201Response productsPost(opts)
...
let apiInstance = new Apacta.ProductsApi();
let opts = {
  'productsPostRequest': new Apacta.ProductsPostRequest() // ProductsPostRequest | 
};
apiInstance.productsPost(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.productsProductIdDelete(productId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Apacta.ProductsApi();
let productId = "productId_example"; // String | 
apiInstance.productsProductIdGet(productId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Apacta.ProductsApi();
let productId = "productId_example"; // String | 
apiInstance.productsProductIdPut(productId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Apacta.ProductsApi();
let productId = "productId_example"; // String | 
apiInstance.productsUndeleteProductIdPost(productId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> uploadOrDeleteProductImage(productId, opts)
...
apiInstance.uploadOrDeleteProductImage(productId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
