...
> MaterialsGet200Response materialsGet(opts)
...
let apiInstance = new Apacta.MaterialsApi();
let opts = {
  'barcode': "barcode_example", // String | Used to filter on the `barcode` of the materials
  'name': "name_example", // String | Used to filter on the `name` of the materials
  'projectId': "projectId_example", // String | Used to find materials used in specific project by `project_id`
  'currentlyRented': true // Boolean | Used to find currently rented materials
};
 ...
 **projectId** | **String**| Used to find materials used in specific project by &#x60;project_id&#x60; | [optional] 
...
apiInstance.materialsMaterialIdDelete(materialId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Apacta.MaterialsApi();
let materialId = "materialId_example"; // String | 
apiInstance.materialsMaterialIdGet(materialId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Apacta.MaterialsApi();
let materialId = "materialId_example"; // String | 
apiInstance.materialsMaterialIdPut(materialId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ClockingRecordsPost201Response materialsPost(opts)
...
let apiInstance = new Apacta.MaterialsApi();
let opts = {
  'materialsPostRequest': new Apacta.MaterialsPostRequest() // MaterialsPostRequest | 
};
apiInstance.materialsPost(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
