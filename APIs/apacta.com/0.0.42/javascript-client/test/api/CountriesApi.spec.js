...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.CountriesApi();
  });
  ...
  describe('CountriesApi', function() {
    describe('countriesCountryIdGet', function() {
      it('should call countriesCountryIdGet successfully', function(done) {
        //uncomment below and update the code to test countriesCountryIdGet
        //instance.countriesCountryIdGet(function(error) {
