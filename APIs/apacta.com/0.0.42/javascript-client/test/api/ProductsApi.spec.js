...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.ProductsApi();
  });
  ...
  describe('ProductsApi', function() {
    describe('bulkDeleteProducts', function() {
      it('should call bulkDeleteProducts successfully', function(done) {
        //uncomment below and update the code to test bulkDeleteProducts
        //instance.bulkDeleteProducts(function(error) {
    ...
    describe('productsProductIdDelete', function() {
      it('should call productsProductIdDelete successfully', function(done) {
        ...
        //instance.productsProductIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('productsProductIdPut', function() {
      it('should call productsProductIdPut successfully', function(done) {
        ...
        //instance.productsProductIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('productsUndeleteProductIdPost', function() {
      it('should call productsUndeleteProductIdPost successfully', function(done) {
        //uncomment below and update the code to test productsUndeleteProductIdPost
        //instance.productsUndeleteProductIdPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('uploadOrDeleteProductImage', function() {
      it('should call uploadOrDeleteProductImage successfully', function(done) {
        //uncomment below and update the code to test uploadOrDeleteProductImage
        //instance.uploadOrDeleteProductImage(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
