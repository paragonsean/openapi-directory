...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.OfferStatus();
  });
  ...
  describe('OfferStatus', function() {
    it('should create an instance of OfferStatus', function() {
      // uncomment below and update the code to test OfferStatus
      //var instance = new Apacta.OfferStatus();
      //expect(instance).to.be.a(Apacta.OfferStatus);
    });
