...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.InvoiceLinesInvoiceLineIdPutRequest();
  });
  ...
  describe('InvoiceLinesInvoiceLineIdPutRequest', function() {
    it('should create an instance of InvoiceLinesInvoiceLineIdPutRequest', function() {
      // uncomment below and update the code to test InvoiceLinesInvoiceLineIdPutRequest
      //var instance = new Apacta.InvoiceLinesInvoiceLineIdPutRequest();
      //expect(instance).to.be.a(Apacta.InvoiceLinesInvoiceLineIdPutRequest);
    });
    ...
    it('should have the property discountText (base name: "discount_text")', function() {
      // uncomment below and update the code to test the property discountText
      //var instance = new Apacta.InvoiceLinesInvoiceLineIdPutRequest();
      //expect(instance).to.be();
    });
