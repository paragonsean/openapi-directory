...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.InvoicesInvoiceIdPutRequest();
  });
  ...
  describe('InvoicesInvoiceIdPutRequest', function() {
    it('should create an instance of InvoicesInvoiceIdPutRequest', function() {
      // uncomment below and update the code to test InvoicesInvoiceIdPutRequest
      //var instance = new Apacta.InvoicesInvoiceIdPutRequest();
      //expect(instance).to.be.a(Apacta.InvoicesInvoiceIdPutRequest);
    });
