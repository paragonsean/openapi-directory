...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.CompaniesVendor();
  });
  ...
  describe('CompaniesVendor', function() {
    it('should create an instance of CompaniesVendor', function() {
      // uncomment below and update the code to test CompaniesVendor
      //var instance = new Apacta.CompaniesVendor();
      //expect(instance).to.be.a(Apacta.CompaniesVendor);
    });
    ...
    it('should have the property companyPassword (base name: "company_password")', function() {
      // uncomment below and update the code to test the property companyPassword
      //var instance = new Apacta.CompaniesVendor();
      //expect(instance).to.be();
    });
