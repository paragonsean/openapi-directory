...
(function(root, factory) {
  ...
  describe('Countries', function() {
    it('should create an instance of Countries', function() {
      ...
      //var instance = new Apacta.Countries();
      //expect(instance).to.be.a(Apacta.Countries);
    });
    ...
    it('should have the property phoneCode (base name: "phone_code")', function() {
