...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.TimeEntryUnitType();
  });
  ...
  describe('TimeEntryUnitType', function() {
    it('should create an instance of TimeEntryUnitType', function() {
      // uncomment below and update the code to test TimeEntryUnitType
      //var instance = new Apacta.TimeEntryUnitType();
      //expect(instance).to.be.a(Apacta.TimeEntryUnitType);
    });
