...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.ContactType();
  });
  ...
  describe('ContactType', function() {
    it('should create an instance of ContactType', function() {
      // uncomment below and update the code to test ContactType
      //var instance = new Apacta.ContactType();
      //expect(instance).to.be.a(Apacta.ContactType);
    });
