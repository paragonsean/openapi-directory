...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.FormFieldType();
  });
  ...
  describe('FormFieldType', function() {
    it('should create an instance of FormFieldType', function() {
      // uncomment below and update the code to test FormFieldType
      //var instance = new Apacta.FormFieldType();
      //expect(instance).to.be.a(Apacta.FormFieldType);
    });
