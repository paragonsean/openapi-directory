...
(function(root, factory) {
  ...
  describe('Form', function() {
    it('should create an instance of Form', function() {
      ...
      //var instance = new Apacta.Form();
      //expect(instance).to.be.a(Apacta.Form);
    });

    it('should have the property approvedById (base name: "approved_by_id")', function() {
      // uncomment below and update the code to test the property approvedById
      //var instance = new Apacta.Form();
    ...
    it('should have the property formDate (base name: "form_date")', function() {
      // uncomment below and update the code to test the property formDate
      //var instance = new Apacta.Form();
      //expect(instance).to.be();
    });

    it('should have the property formTemplateId (base name: "form_template_id")', function() {
      // uncomment below and update the code to test the property formTemplateId
      //var instance = new Apacta.Form();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isInvoiced (base name: "is_invoiced")', function() {
    ...
    it('should have the property massFormId (base name: "mass_form_id")', function() {
      // uncomment below and update the code to test the property massFormId
      //var instance = new Apacta.Form();
      //expect(instance).to.be();
    });
