...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.TimeEntriesPostRequest();
  });
  ...
  describe('TimeEntriesPostRequest', function() {
    it('should create an instance of TimeEntriesPostRequest', function() {
      // uncomment below and update the code to test TimeEntriesPostRequest
      //var instance = new Apacta.TimeEntriesPostRequest();
      //expect(instance).to.be.a(Apacta.TimeEntriesPostRequest);
    });
