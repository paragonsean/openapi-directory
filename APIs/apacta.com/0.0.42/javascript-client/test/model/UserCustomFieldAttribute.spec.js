...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.UserCustomFieldAttribute();
  });
  ...
  describe('UserCustomFieldAttribute', function() {
    it('should create an instance of UserCustomFieldAttribute', function() {
      // uncomment below and update the code to test UserCustomFieldAttribute
      //var instance = new Apacta.UserCustomFieldAttribute();
      //expect(instance).to.be.a(Apacta.UserCustomFieldAttribute);
    });
