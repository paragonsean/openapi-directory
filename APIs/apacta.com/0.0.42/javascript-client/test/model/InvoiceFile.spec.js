...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.InvoiceFile();
  });
  ...
  describe('InvoiceFile', function() {
    it('should create an instance of InvoiceFile', function() {
      // uncomment below and update the code to test InvoiceFile
      //var instance = new Apacta.InvoiceFile();
      //expect(instance).to.be.a(Apacta.InvoiceFile);
    });
