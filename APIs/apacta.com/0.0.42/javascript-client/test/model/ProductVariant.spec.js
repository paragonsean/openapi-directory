...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.ProductVariant();
  });
  ...
  describe('ProductVariant', function() {
    it('should create an instance of ProductVariant', function() {
      ...
      //var instance = new Apacta.ProductVariant();
      //expect(instance).to.be.a(Apacta.ProductVariant);
    });
    ...
    it('should have the property variantType (base name: "variant_type")', function() {
