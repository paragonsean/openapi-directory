...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.ProjectsPostRequest();
  });
  ...
  describe('ProjectsPostRequest', function() {
    it('should create an instance of ProjectsPostRequest', function() {
      // uncomment below and update the code to test ProjectsPostRequest
      //var instance = new Apacta.ProjectsPostRequest();
      //expect(instance).to.be.a(Apacta.ProjectsPostRequest);
    });

    it('should have the property childProjects (base name: "child_projects")', function() {
      // uncomment below and update the code to test the property childProjects
      //var instance = new Apacta.ProjectsPostRequest();
