...
(function(root, factory) {
  ...
  describe('Material', function() {
    it('should create an instance of Material', function() {
      ...
      //var instance = new Apacta.Material();
      //expect(instance).to.be.a(Apacta.Material);
    });
    ...
    it('should have the property centigaId (base name: "centiga_id")', function() {
      // uncomment below and update the code to test the property centigaId
      //var instance = new Apacta.Material();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pogoId (base name: "pogo_id")', function() {
      // uncomment below and update the code to test the property pogoId
      //var instance = new Apacta.Material();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tripletexId (base name: "tripletex_id")', function() {
      // uncomment below and update the code to test the property tripletexId
      //var instance = new Apacta.Material();
      //expect(instance).to.be();
    });
