...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.ExpenseLine();
  });
  ...
  describe('ExpenseLine', function() {
    it('should create an instance of ExpenseLine', function() {
      // uncomment below and update the code to test ExpenseLine
      //var instance = new Apacta.ExpenseLine();
      //expect(instance).to.be.a(Apacta.ExpenseLine);
    });
