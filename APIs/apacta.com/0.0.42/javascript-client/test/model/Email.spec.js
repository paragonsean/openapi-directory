...
(function(root, factory) {
  ...
  describe('Email', function() {
    it('should create an instance of Email', function() {
      ...
      //var instance = new Apacta.Email();
      //expect(instance).to.be.a(Apacta.Email);
    });

    it('should have the property apiResponse (base name: "api_response")', function() {
      // uncomment below and update the code to test the property apiResponse
      //var instance = new Apacta.Email();
    ...
    it('should have the property carbonCopy (base name: "carbon_copy")', function() {
      // uncomment below and update the code to test the property carbonCopy
      //var instance = new Apacta.Email();
      //expect(instance).to.be();
    });
