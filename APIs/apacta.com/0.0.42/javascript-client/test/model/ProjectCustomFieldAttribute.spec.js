...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.ProjectCustomFieldAttribute();
  });
  ...
  describe('ProjectCustomFieldAttribute', function() {
    it('should create an instance of ProjectCustomFieldAttribute', function() {
      // uncomment below and update the code to test ProjectCustomFieldAttribute
      //var instance = new Apacta.ProjectCustomFieldAttribute();
      //expect(instance).to.be.a(Apacta.ProjectCustomFieldAttribute);
    });
