...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.TimeEntryInterval();
  });
  ...
  describe('TimeEntryInterval', function() {
    it('should create an instance of TimeEntryInterval', function() {
      // uncomment below and update the code to test TimeEntryInterval
      //var instance = new Apacta.TimeEntryInterval();
      //expect(instance).to.be.a(Apacta.TimeEntryInterval);
    });
