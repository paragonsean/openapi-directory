...
(function(root, factory) {
  ...
  describe('FormField', function() {
    it('should create an instance of FormField', function() {
      ...
      //var instance = new Apacta.FormField();
      //expect(instance).to.be.a(Apacta.FormField);
    });
    ...
    it('should have the property contentValue (base name: "content_value")', function() {
    ...
    it('should have the property formFieldTypeId (base name: "form_field_type_id")', function() {
      // uncomment below and update the code to test the property formFieldTypeId
      //var instance = new Apacta.FormField();
      //expect(instance).to.be();
    });
    ...
    it('should have the property formTemplateFieldId (base name: "form_template_field_id")', function() {
      // uncomment below and update the code to test the property formTemplateFieldId
      //var instance = new Apacta.FormField();
      //expect(instance).to.be();
    });
