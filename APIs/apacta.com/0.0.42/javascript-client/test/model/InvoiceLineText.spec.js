...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.InvoiceLineText();
  });
  ...
  describe('InvoiceLineText', function() {
    it('should create an instance of InvoiceLineText', function() {
      // uncomment below and update the code to test InvoiceLineText
      //var instance = new Apacta.InvoiceLineText();
      //expect(instance).to.be.a(Apacta.InvoiceLineText);
    });
    ...
    it('should have the property invoiceLineId (base name: "invoice_line_id")', function() {
      // uncomment below and update the code to test the property invoiceLineId
      //var instance = new Apacta.InvoiceLineText();
      //expect(instance).to.be();
    });
