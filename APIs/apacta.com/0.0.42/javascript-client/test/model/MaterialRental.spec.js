...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.MaterialRental();
  });
  ...
  describe('MaterialRental', function() {
    it('should create an instance of MaterialRental', function() {
      // uncomment below and update the code to test MaterialRental
      //var instance = new Apacta.MaterialRental();
      //expect(instance).to.be.a(Apacta.MaterialRental);
    });
