...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.AddVendorRequest();
  });
  ...
  describe('AddVendorRequest', function() {
    it('should create an instance of AddVendorRequest', function() {
      // uncomment below and update the code to test AddVendorRequest
      //var instance = new Apacta.AddVendorRequest();
      //expect(instance).to.be.a(Apacta.AddVendorRequest);
    });
