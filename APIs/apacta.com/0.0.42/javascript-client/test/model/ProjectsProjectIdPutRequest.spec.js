...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.ProjectsProjectIdPutRequest();
  });
  ...
  describe('ProjectsProjectIdPutRequest', function() {
    it('should create an instance of ProjectsProjectIdPutRequest', function() {
      // uncomment below and update the code to test ProjectsProjectIdPutRequest
      //var instance = new Apacta.ProjectsProjectIdPutRequest();
      //expect(instance).to.be.a(Apacta.ProjectsProjectIdPutRequest);
    });
