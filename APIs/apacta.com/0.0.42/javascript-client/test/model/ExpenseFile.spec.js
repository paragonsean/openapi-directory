...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.ExpenseFile();
  });
  ...
  describe('ExpenseFile', function() {
    it('should create an instance of ExpenseFile', function() {
      // uncomment below and update the code to test ExpenseFile
      //var instance = new Apacta.ExpenseFile();
      //expect(instance).to.be.a(Apacta.ExpenseFile);
    });
    ...
    it('should have the property fileOriginalName (base name: "file_original_name")', function() {
