...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.ContactCustomFieldAttribute();
  });
  ...
  describe('ContactCustomFieldAttribute', function() {
    it('should create an instance of ContactCustomFieldAttribute', function() {
      // uncomment below and update the code to test ContactCustomFieldAttribute
      //var instance = new Apacta.ContactCustomFieldAttribute();
      //expect(instance).to.be.a(Apacta.ContactCustomFieldAttribute);
    });
