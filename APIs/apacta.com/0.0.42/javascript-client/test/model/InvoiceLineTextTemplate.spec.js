...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.InvoiceLineTextTemplate();
  });
  ...
  describe('InvoiceLineTextTemplate', function() {
    it('should create an instance of InvoiceLineTextTemplate', function() {
      // uncomment below and update the code to test InvoiceLineTextTemplate
      //var instance = new Apacta.InvoiceLineTextTemplate();
      //expect(instance).to.be.a(Apacta.InvoiceLineTextTemplate);
    });
