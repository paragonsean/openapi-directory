...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.UsersPostRequest();
  });
  ...
  describe('UsersPostRequest', function() {
    it('should create an instance of UsersPostRequest', function() {
      // uncomment below and update the code to test UsersPostRequest
      //var instance = new Apacta.UsersPostRequest();
      //expect(instance).to.be.a(Apacta.UsersPostRequest);
    });
    ...
    it('should have the property expectedBillableHours (base name: "expected_billable_hours")', function() {
      // uncomment below and update the code to test the property expectedBillableHours
      //var instance = new Apacta.UsersPostRequest();
      //expect(instance).to.be();
    });

    it('should have the property extraPrice (base name: "extra_price")', function() {
    ...
    it('should have the property hideAddress (base name: "hide_address")', function() {
      // uncomment below and update the code to test the property hideAddress
      //var instance = new Apacta.UsersPostRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property mobileCountrycode (base name: "mobile_countrycode")', function() {
