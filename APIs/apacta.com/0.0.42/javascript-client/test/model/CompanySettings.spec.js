...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.CompanySettings();
  });
  ...
  describe('CompanySettings', function() {
    it('should create an instance of CompanySettings', function() {
      // uncomment below and update the code to test CompanySettings
      //var instance = new Apacta.CompanySettings();
      //expect(instance).to.be.a(Apacta.CompanySettings);
    });

    it('should have the property companySettingsCategoryId (base name: "company_settings_category_id")', function() {
      // uncomment below and update the code to test the property companySettingsCategoryId
      //var instance = new Apacta.CompanySettings();
