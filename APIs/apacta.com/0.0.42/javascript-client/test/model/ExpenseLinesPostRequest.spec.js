...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.ExpenseLinesPostRequest();
  });
  ...
  describe('ExpenseLinesPostRequest', function() {
    it('should create an instance of ExpenseLinesPostRequest', function() {
      // uncomment below and update the code to test ExpenseLinesPostRequest
      //var instance = new Apacta.ExpenseLinesPostRequest();
      //expect(instance).to.be.a(Apacta.ExpenseLinesPostRequest);
    });
    ...
    it('should have the property expenseId (base name: "expense_id")', function() {
