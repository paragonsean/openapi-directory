...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.OfferStatusesPostRequest();
  });
  ...
  describe('OfferStatusesPostRequest', function() {
    it('should create an instance of OfferStatusesPostRequest', function() {
      // uncomment below and update the code to test OfferStatusesPostRequest
      //var instance = new Apacta.OfferStatusesPostRequest();
      //expect(instance).to.be.a(Apacta.OfferStatusesPostRequest);
    });
