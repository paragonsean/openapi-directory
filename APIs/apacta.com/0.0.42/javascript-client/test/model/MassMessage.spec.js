...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.MassMessage();
  });
  ...
  describe('MassMessage', function() {
    it('should create an instance of MassMessage', function() {
      // uncomment below and update the code to test MassMessage
      //var instance = new Apacta.MassMessage();
      //expect(instance).to.be.a(Apacta.MassMessage);
    });
