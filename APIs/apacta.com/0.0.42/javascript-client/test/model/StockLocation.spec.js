...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.StockLocation();
  });
  ...
  describe('StockLocation', function() {
    it('should create an instance of StockLocation', function() {
      // uncomment below and update the code to test StockLocation
      //var instance = new Apacta.StockLocation();
      //expect(instance).to.be.a(Apacta.StockLocation);
    });
