...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Apacta.CompanyPriceMargins();
  });
  ...
  describe('CompanyPriceMargins', function() {
    it('should create an instance of CompanyPriceMargins', function() {
      // uncomment below and update the code to test CompanyPriceMargins
      //var instance = new Apacta.CompanyPriceMargins();
      //expect(instance).to.be.a(Apacta.CompanyPriceMargins);
    });
    ...
    it('should have the property percentageRatio (base name: "percentage_ratio")', function() {
      // uncomment below and update the code to test the property percentageRatio
      //var instance = new Apacta.CompanyPriceMargins();
      //expect(instance).to.be();
    });
