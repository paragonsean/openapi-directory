...
(function(root, factory) {
  ...
  describe('TimeEntry', function() {
    it('should create an instance of TimeEntry', function() {
      // uncomment below and update the code to test TimeEntry
      //var instance = new Apacta.TimeEntry();
      //expect(instance).to.be.a(Apacta.TimeEntry);
    });
    ...
    it('should have the property timeEntryTypeId (base name: "time_entry_type_id")', function() {
      // uncomment below and update the code to test the property timeEntryTypeId
      //var instance = new Apacta.TimeEntry();
      //expect(instance).to.be();
    });
