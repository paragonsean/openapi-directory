...
export default class CountriesApi {
    ...
    */
     ...
     * @callback module:api/CountriesApi~countriesCountryIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CountriesCountryIdGet200Response} data The data returned by the service call.
     ...
     * @param {module:api/CountriesApi~countriesCountryIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CountriesCountryIdGet200Response}
     */
    countriesCountryIdGet(countryId, callback) {
      let postBody = null;
      ...
      let returnType = CountriesCountryIdGet200Response;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/CountriesGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/CountriesGet200Response}
     */
    countriesGet(callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CountriesGet200Response;
      return this.apiClient.callApi(
        '/countries', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
