...
export default class CitiesApi {
    ...
    */
     ...
     * @callback module:api/CitiesApi~citiesCityIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CitiesCityIdGet200Response} data The data returned by the service call.
     ...
     * @param {String} cityId 
     * @param {module:api/CitiesApi~citiesCityIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CitiesCityIdGet200Response}
     */
    citiesCityIdGet(cityId, callback) {
      let postBody = null;
      ...
      let returnType = CitiesCityIdGet200Response;
     ...
     * @callback module:api/CitiesApi~citiesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CitiesGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/CitiesApi~citiesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CitiesGet200Response}
     */
    citiesGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CitiesGet200Response;
      return this.apiClient.callApi(
        '/cities', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
