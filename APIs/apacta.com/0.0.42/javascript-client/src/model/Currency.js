...
class Currency {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('currency_sign')) {
                obj['currency_sign'] = ApiClient.convertToType(data['currency_sign'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['currency_sign'] && !(typeof data['currency_sign'] === 'string' || data['currency_sign'] instanceof String)) {
            throw new Error("Expected the field `currency_sign` to be a primitive type in the JSON string but got " + data['currency_sign']);
        }
        // ensure the json data is a string
 ...
 */
Currency.prototype['centiga_id'] = undefined;

/**
 * @member {String} created
 */
Currency.prototype['created'] = undefined;

/**
 * @member {String} currency_sign
 */
Currency.prototype['currency_sign'] = undefined;
 ...
 */
Currency.prototype['identifier'] = undefined;

/**
 * @member {String} modified
 */
Currency.prototype['modified'] = undefined;
 ...
 */
Currency.prototype['pogo_id'] = undefined;

/**
 * @member {String} tripletex_id
 */
Currency.prototype['tripletex_id'] = undefined;
