...
class InvoiceLine {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ean_product_id')) {
                obj['ean_product_id'] = ApiClient.convertToType(data['ean_product_id'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['ean_product_id'] && !(typeof data['ean_product_id'] === 'string' || data['ean_product_id'] instanceof String)) {
            throw new Error("Expected the field `ean_product_id` to be a primitive type in the JSON string but got " + data['ean_product_id']);
        }
        // ensure the json data is a string
 ...
 */
InvoiceLine.prototype['created'] = undefined;

/**
 * @member {String} created_by_id
 */
InvoiceLine.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
InvoiceLine.prototype['deleted'] = undefined;
 ...
 */
InvoiceLine.prototype['discount_percent'] = undefined;

/**
 * @member {String} discount_text
 */
InvoiceLine.prototype['discount_text'] = undefined;

/**
 * @member {String} ean_product_id
 */
InvoiceLine.prototype['ean_product_id'] = undefined;

/**
 * @member {String} form_id
 */
InvoiceLine.prototype['form_id'] = undefined;

/**
 * @member {String} id
 */
InvoiceLine.prototype['id'] = undefined;

/**
 * @member {String} invoice_id
 */
InvoiceLine.prototype['invoice_id'] = undefined;

/**
 * @member {String} material_id
 */
InvoiceLine.prototype['material_id'] = undefined;

/**
 * @member {String} modified
 */
InvoiceLine.prototype['modified'] = undefined;
 ...
 */
InvoiceLine.prototype['parent_id'] = undefined;

/**
 * @member {String} product_bundle_id
 */
InvoiceLine.prototype['product_bundle_id'] = undefined;

/**
 * @member {String} product_id
 */
InvoiceLine.prototype['product_id'] = undefined;

/**
 * @member {Number} quantity
 */
InvoiceLine.prototype['quantity'] = undefined;

/**
 * @member {Number} selling_price
 */
InvoiceLine.prototype['selling_price'] = undefined;

/**
 * @member {module:model/InvoiceLine.TypeEnum} type
 */
InvoiceLine.prototype['type'] = undefined;

/**
 * @member {String} user_id
 */
InvoiceLine.prototype['user_id'] = undefined;
