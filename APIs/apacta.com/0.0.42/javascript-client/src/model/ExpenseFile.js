...
/**
 * The ExpenseFile model module.
 * @module model/ExpenseFile
 * @version 0.0.42
 */
class ExpenseFile {
    /**
     * Constructs a new <code>ExpenseFile</code>.
     * @alias module:model/ExpenseFile
     */
    constructor() { 
        
        ExpenseFile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExpenseFile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExpenseFile} obj Optional instance to populate.
     * @return {module:model/ExpenseFile} The populated <code>ExpenseFile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExpenseFile();
            ...
            if (data.hasOwnProperty('file_original_name')) {
                obj['file_original_name'] = ApiClient.convertToType(data['file_original_name'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ExpenseFile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExpenseFile</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['file_original_name'] && !(typeof data['file_original_name'] === 'string' || data['file_original_name'] instanceof String)) {
            throw new Error("Expected the field `file_original_name` to be a primitive type in the JSON string but got " + data['file_original_name']);
        }
        // ensure the json data is a string
 ...
 */
ExpenseFile.prototype['created'] = undefined;

/**
 * Read-only
 * @member {String} created_by_id
 */
ExpenseFile.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
ExpenseFile.prototype['deleted'] = undefined;

/**
 * @member {String} description
 */
ExpenseFile.prototype['description'] = undefined;

/**
 * @member {String} expense_id
 */
ExpenseFile.prototype['expense_id'] = undefined;

/**
 * File's name
 * @member {String} file
 */
ExpenseFile.prototype['file'] = undefined;

/**
 * @member {String} file_extension
 */
ExpenseFile.prototype['file_extension'] = undefined;

/**
 * @member {String} file_original_name
 */
ExpenseFile.prototype['file_original_name'] = undefined;

/**
 * File size in bytes
 * @member {String} file_size
 */
ExpenseFile.prototype['file_size'] = undefined;

/**
 * File's MIME type
 * @member {String} file_type
 */
ExpenseFile.prototype['file_type'] = undefined;

/**
 * Read-only
 * @member {String} file_url
 */
ExpenseFile.prototype['file_url'] = undefined;

/**
 * Read-only
 * @member {String} id
 */
ExpenseFile.prototype['id'] = undefined;

/**
 * @member {String} modified
 */
ExpenseFile.prototype['modified'] = undefined;
