...
/**
 * The TimeEntryInterval model module.
 * @module model/TimeEntryInterval
 * @version 0.0.42
 */
class TimeEntryInterval {
    /**
     * Constructs a new <code>TimeEntryInterval</code>.
     * @alias module:model/TimeEntryInterval
     */
    constructor() { 
        
        TimeEntryInterval.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TimeEntryInterval</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeEntryInterval} obj Optional instance to populate.
     * @return {module:model/TimeEntryInterval} The populated <code>TimeEntryInterval</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeEntryInterval();
    ...
    /**
     * Validates the JSON data with respect to <code>TimeEntryInterval</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimeEntryInterval</code>.
     */
 ...
 */
TimeEntryInterval.prototype['created'] = undefined;

/**
 * @member {String} created_by_id
 */
TimeEntryInterval.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
TimeEntryInterval.prototype['deleted'] = undefined;

/**
 * @member {String} description
 */
TimeEntryInterval.prototype['description'] = undefined;

/**
 * @member {String} id
 */
TimeEntryInterval.prototype['id'] = undefined;

/**
 * @member {String} identifier
 */
TimeEntryInterval.prototype['identifier'] = undefined;

/**
 * @member {String} modified
 */
TimeEntryInterval.prototype['modified'] = undefined;

/**
 * @member {String} modified_by_id
 */
TimeEntryInterval.prototype['modified_by_id'] = undefined;

/**
 * @member {String} name
 */
TimeEntryInterval.prototype['name'] = undefined;
...
export default TimeEntryInterval;
