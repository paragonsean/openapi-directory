...
import BadRequestResponseData from './BadRequestResponseData';
...
class BadRequestResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = BadRequestResponseData.constructFromObject(data['data']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          BadRequestResponseData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/BadRequestResponseData} data
 */
BadRequestResponse.prototype['data'] = undefined;

/**
 * @member {Boolean} success
 * @default false
 */
BadRequestResponse.prototype['success'] = false;
