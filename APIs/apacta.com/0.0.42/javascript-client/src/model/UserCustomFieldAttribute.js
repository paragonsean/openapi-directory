...
/**
 * The UserCustomFieldAttribute model module.
 * @module model/UserCustomFieldAttribute
 * @version 0.0.42
 */
class UserCustomFieldAttribute {
    /**
     * Constructs a new <code>UserCustomFieldAttribute</code>.
     * @alias module:model/UserCustomFieldAttribute
     */
    constructor() { 
        
        UserCustomFieldAttribute.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserCustomFieldAttribute</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserCustomFieldAttribute} obj Optional instance to populate.
     * @return {module:model/UserCustomFieldAttribute} The populated <code>UserCustomFieldAttribute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserCustomFieldAttribute();
    ...
    /**
     * Validates the JSON data with respect to <code>UserCustomFieldAttribute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserCustomFieldAttribute</code>.
     */
 ...
 */
UserCustomFieldAttribute.prototype['access_type'] = undefined;

/**
 * @member {String} company_id
 */
UserCustomFieldAttribute.prototype['company_id'] = undefined;

/**
 * @member {String} created
 */
UserCustomFieldAttribute.prototype['created'] = undefined;

/**
 * Read-only
 * @member {String} created_by_id
 */
UserCustomFieldAttribute.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
UserCustomFieldAttribute.prototype['deleted'] = undefined;

/**
 * @member {String} id
 */
UserCustomFieldAttribute.prototype['id'] = undefined;

/**
 * @member {Boolean} is_active
 */
UserCustomFieldAttribute.prototype['is_active'] = undefined;

/**
 * @member {String} modified
 */
UserCustomFieldAttribute.prototype['modified'] = undefined;

/**
 * @member {String} name
 */
UserCustomFieldAttribute.prototype['name'] = undefined;

/**
 * @member {Number} placement
 */
UserCustomFieldAttribute.prototype['placement'] = undefined;
...
export default UserCustomFieldAttribute;
