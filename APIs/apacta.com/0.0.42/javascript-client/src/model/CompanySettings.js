...
/**
 * The CompanySettings model module.
 * @module model/CompanySettings
 * @version 0.0.42
 */
class CompanySettings {
    /**
     * Constructs a new <code>CompanySettings</code>.
     * @alias module:model/CompanySettings
     */
    constructor() { 
        
        CompanySettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CompanySettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompanySettings} obj Optional instance to populate.
     * @return {module:model/CompanySettings} The populated <code>CompanySettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompanySettings();

            if (data.hasOwnProperty('company_settings_category_id')) {
                obj['company_settings_category_id'] = ApiClient.convertToType(data['company_settings_category_id'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CompanySettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompanySettings</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['company_settings_category_id'] && !(typeof data['company_settings_category_id'] === 'string' || data['company_settings_category_id'] instanceof String)) {
            throw new Error("Expected the field `company_settings_category_id` to be a primitive type in the JSON string but got " + data['company_settings_category_id']);
        }
        // ensure the json data is a string
...
/**
 * @member {String} company_settings_category_id
 */
CompanySettings.prototype['company_settings_category_id'] = undefined;

/**
 * @member {String} created
 */
CompanySettings.prototype['created'] = undefined;

/**
 * @member {String} created_by_id
 */
CompanySettings.prototype['created_by_id'] = undefined;

/**
 * @member {String} default_value
 */
CompanySettings.prototype['default_value'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
CompanySettings.prototype['deleted'] = undefined;

/**
 * @member {String} description
 */
CompanySettings.prototype['description'] = undefined;

/**
 * @member {String} feature_id
 */
CompanySettings.prototype['feature_id'] = undefined;

/**
 * @member {String} id
 */
CompanySettings.prototype['id'] = undefined;

/**
 * @member {String} identifier
 */
CompanySettings.prototype['identifier'] = undefined;

/**
 * @member {String} modified
 */
CompanySettings.prototype['modified'] = undefined;

/**
 * @member {String} modified_by_id
 */
CompanySettings.prototype['modified_by_id'] = undefined;

/**
 * @member {String} name
 */
CompanySettings.prototype['name'] = undefined;

/**
 * @member {String} options
 */
CompanySettings.prototype['options'] = undefined;

/**
 * @member {Number} placement
 */
CompanySettings.prototype['placement'] = undefined;

/**
 * @member {String} type
 */
CompanySettings.prototype['type'] = undefined;
