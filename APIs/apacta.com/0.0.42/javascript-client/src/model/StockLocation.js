...
/**
 * The StockLocation model module.
 * @module model/StockLocation
 * @version 0.0.42
 */
class StockLocation {
    /**
     * Constructs a new <code>StockLocation</code>.
     * @alias module:model/StockLocation
     */
    constructor() { 
        
        StockLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StockLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StockLocation} obj Optional instance to populate.
     * @return {module:model/StockLocation} The populated <code>StockLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StockLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>StockLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StockLocation</code>.
     */
 ...
 */
StockLocation.prototype['company_id'] = undefined;

/**
 * @member {String} created
 */
StockLocation.prototype['created'] = undefined;

/**
 * @member {String} created_by_id
 */
StockLocation.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
StockLocation.prototype['deleted'] = undefined;

/**
 * @member {String} id
 */
StockLocation.prototype['id'] = undefined;

/**
 * @member {String} modified
 */
StockLocation.prototype['modified'] = undefined;

/**
 * @member {String} name
 */
StockLocation.prototype['name'] = undefined;
