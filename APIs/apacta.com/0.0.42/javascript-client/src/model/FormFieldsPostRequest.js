...
/**
 * The FormFieldsPostRequest model module.
 * @module model/FormFieldsPostRequest
 * @version 0.0.42
 */
class FormFieldsPostRequest {
    /**
     * Constructs a new <code>FormFieldsPostRequest</code>.
     * @alias module:model/FormFieldsPostRequest
     */
    constructor() { 
        
        FormFieldsPostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FormFieldsPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormFieldsPostRequest} obj Optional instance to populate.
     * @return {module:model/FormFieldsPostRequest} The populated <code>FormFieldsPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormFieldsPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>FormFieldsPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormFieldsPostRequest</code>.
     */
 ...
 */
FormFieldsPostRequest.prototype['comment'] = undefined;

/**
 * @member {String} content_value
 */
FormFieldsPostRequest.prototype['content_value'] = undefined;

/**
 * @member {String} file_id
 */
FormFieldsPostRequest.prototype['file_id'] = undefined;

/**
 * @member {String} form_field_type_id
 */
FormFieldsPostRequest.prototype['form_field_type_id'] = undefined;

/**
 * @member {String} form_id
 */
FormFieldsPostRequest.prototype['form_id'] = undefined;

/**
 * @member {String} form_template_field_id
 */
FormFieldsPostRequest.prototype['form_template_field_id'] = undefined;

/**
 * @member {Number} placement
 */
FormFieldsPostRequest.prototype['placement'] = undefined;
...
export default FormFieldsPostRequest;
