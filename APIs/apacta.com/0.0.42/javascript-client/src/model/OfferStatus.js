...
/**
 * The OfferStatus model module.
 * @module model/OfferStatus
 * @version 0.0.42
 */
class OfferStatus {
    /**
     * Constructs a new <code>OfferStatus</code>.
     * @alias module:model/OfferStatus
     */
    constructor() { 
        
        OfferStatus.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OfferStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OfferStatus} obj Optional instance to populate.
     * @return {module:model/OfferStatus} The populated <code>OfferStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OfferStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>OfferStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OfferStatus</code>.
     */
 ...
 */
OfferStatus.prototype['created'] = undefined;

/**
 * @member {String} created_by_id
 */
OfferStatus.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
OfferStatus.prototype['deleted'] = undefined;

/**
 * @member {String} description
 */
OfferStatus.prototype['description'] = undefined;

/**
 * @member {String} id
 */
OfferStatus.prototype['id'] = undefined;

/**
 * One of 6 values
 * @member {module:model/OfferStatus.IdentifierEnum} identifier
 */
OfferStatus.prototype['identifier'] = undefined;

/**
 * @member {Boolean} is_custom
 */
OfferStatus.prototype['is_custom'] = undefined;

/**
 * @member {String} modified
 */
OfferStatus.prototype['modified'] = undefined;

/**
 * @member {String} modified_by_id
 */
OfferStatus.prototype['modified_by_id'] = undefined;

/**
 * @member {String} name
 */
OfferStatus.prototype['name'] = undefined;
