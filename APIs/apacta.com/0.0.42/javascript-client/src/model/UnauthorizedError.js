...
import UnauthorizedErrorData from './UnauthorizedErrorData';
...
class UnauthorizedError {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = UnauthorizedErrorData.constructFromObject(data['data']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          UnauthorizedErrorData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/UnauthorizedErrorData} data
 */
UnauthorizedError.prototype['data'] = undefined;

/**
 * @member {Boolean} success
 * @default false
 */
UnauthorizedError.prototype['success'] = false;
