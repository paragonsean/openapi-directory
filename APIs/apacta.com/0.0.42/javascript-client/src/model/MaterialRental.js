...
/**
 * The MaterialRental model module.
 * @module model/MaterialRental
 * @version 0.0.42
 */
class MaterialRental {
    /**
     * Constructs a new <code>MaterialRental</code>.
     * @alias module:model/MaterialRental
     */
    constructor() { 
        
        MaterialRental.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MaterialRental</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MaterialRental} obj Optional instance to populate.
     * @return {module:model/MaterialRental} The populated <code>MaterialRental</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MaterialRental();
    ...
    /**
     * Validates the JSON data with respect to <code>MaterialRental</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MaterialRental</code>.
     */
 ...
 */
MaterialRental.prototype['amount'] = undefined;

/**
 * @member {String} created
 */
MaterialRental.prototype['created'] = undefined;

/**
 * @member {String} created_by_id
 */
MaterialRental.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
MaterialRental.prototype['deleted'] = undefined;

/**
 * @member {String} from_date
 */
MaterialRental.prototype['from_date'] = undefined;

/**
 * @member {String} id
 */
MaterialRental.prototype['id'] = undefined;

/**
 * @member {String} is_invoiced
 */
MaterialRental.prototype['is_invoiced'] = undefined;

/**
 * @member {String} material_id
 */
MaterialRental.prototype['material_id'] = undefined;

/**
 * @member {String} modified
 */
MaterialRental.prototype['modified'] = undefined;

/**
 * @member {String} modified_by_id
 */
MaterialRental.prototype['modified_by_id'] = undefined;

/**
 * @member {String} project_id
 */
MaterialRental.prototype['project_id'] = undefined;

/**
 * @member {Number} quantity
 */
MaterialRental.prototype['quantity'] = undefined;

/**
 * @member {String} to_date
 */
MaterialRental.prototype['to_date'] = undefined;
