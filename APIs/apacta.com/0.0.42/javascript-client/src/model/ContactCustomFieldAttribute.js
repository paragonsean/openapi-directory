...
/**
 * The ContactCustomFieldAttribute model module.
 * @module model/ContactCustomFieldAttribute
 * @version 0.0.42
 */
class ContactCustomFieldAttribute {
    /**
     * Constructs a new <code>ContactCustomFieldAttribute</code>.
     * @alias module:model/ContactCustomFieldAttribute
     */
    constructor() { 
        
        ContactCustomFieldAttribute.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContactCustomFieldAttribute</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactCustomFieldAttribute} obj Optional instance to populate.
     * @return {module:model/ContactCustomFieldAttribute} The populated <code>ContactCustomFieldAttribute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactCustomFieldAttribute();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactCustomFieldAttribute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactCustomFieldAttribute</code>.
     */
 ...
 */
ContactCustomFieldAttribute.prototype['access_type'] = undefined;

/**
 * @member {String} company_id
 */
ContactCustomFieldAttribute.prototype['company_id'] = undefined;

/**
 * @member {String} created
 */
ContactCustomFieldAttribute.prototype['created'] = undefined;

/**
 * Read-only
 * @member {String} created_by_id
 */
ContactCustomFieldAttribute.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
ContactCustomFieldAttribute.prototype['deleted'] = undefined;

/**
 * @member {String} id
 */
ContactCustomFieldAttribute.prototype['id'] = undefined;

/**
 * @member {Boolean} is_active
 */
ContactCustomFieldAttribute.prototype['is_active'] = undefined;

/**
 * @member {String} modified
 */
ContactCustomFieldAttribute.prototype['modified'] = undefined;

/**
 * @member {String} name
 */
ContactCustomFieldAttribute.prototype['name'] = undefined;

/**
 * @member {Number} placement
 */
ContactCustomFieldAttribute.prototype['placement'] = undefined;
...
export default ContactCustomFieldAttribute;
