...
/**
 * The ProjectCustomFieldAttribute model module.
 * @module model/ProjectCustomFieldAttribute
 * @version 0.0.42
 */
class ProjectCustomFieldAttribute {
    /**
     * Constructs a new <code>ProjectCustomFieldAttribute</code>.
     * @alias module:model/ProjectCustomFieldAttribute
     */
    constructor() { 
        
        ProjectCustomFieldAttribute.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectCustomFieldAttribute</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectCustomFieldAttribute} obj Optional instance to populate.
     * @return {module:model/ProjectCustomFieldAttribute} The populated <code>ProjectCustomFieldAttribute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectCustomFieldAttribute();
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectCustomFieldAttribute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectCustomFieldAttribute</code>.
     */
 ...
 */
ProjectCustomFieldAttribute.prototype['access_type'] = undefined;

/**
 * @member {String} company_id
 */
ProjectCustomFieldAttribute.prototype['company_id'] = undefined;

/**
 * @member {String} created
 */
ProjectCustomFieldAttribute.prototype['created'] = undefined;

/**
 * Read-only
 * @member {String} created_by_id
 */
ProjectCustomFieldAttribute.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
ProjectCustomFieldAttribute.prototype['deleted'] = undefined;

/**
 * @member {String} id
 */
ProjectCustomFieldAttribute.prototype['id'] = undefined;

/**
 * @member {Boolean} is_active
 */
ProjectCustomFieldAttribute.prototype['is_active'] = undefined;

/**
 * @member {String} modified
 */
ProjectCustomFieldAttribute.prototype['modified'] = undefined;

/**
 * @member {String} name
 */
ProjectCustomFieldAttribute.prototype['name'] = undefined;

/**
 * @member {Number} placement
 */
ProjectCustomFieldAttribute.prototype['placement'] = undefined;
...
export default ProjectCustomFieldAttribute;
