...
/**
 * The VendorProduct model module.
 * @module model/VendorProduct
 * @version 0.0.42
 */
class VendorProduct {
    /**
     * Constructs a new <code>VendorProduct</code>.
     * @alias module:model/VendorProduct
     */
    constructor() { 
        
        VendorProduct.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VendorProduct</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VendorProduct} obj Optional instance to populate.
     * @return {module:model/VendorProduct} The populated <code>VendorProduct</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VendorProduct();
            ...
            if (data.hasOwnProperty('product_category_number')) {
                obj['product_category_number'] = ApiClient.convertToType(data['product_category_number'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VendorProduct</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VendorProduct</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['product_category_number'] && !(typeof data['product_category_number'] === 'string' || data['product_category_number'] instanceof String)) {
            throw new Error("Expected the field `product_category_number` to be a primitive type in the JSON string but got " + data['product_category_number']);
        }
        // ensure the json data is a string
 ...
 */
VendorProduct.prototype['barcode'] = undefined;

/**
 * @member {String} created
 */
VendorProduct.prototype['created'] = undefined;

/**
 * @member {String} created_by_id
 */
VendorProduct.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
VendorProduct.prototype['deleted'] = undefined;

/**
 * @member {String} description
 */
VendorProduct.prototype['description'] = undefined;

/**
 * @member {String} id
 */
VendorProduct.prototype['id'] = undefined;

/**
 * @member {String} modified
 */
VendorProduct.prototype['modified'] = undefined;

/**
 * @member {String} name
 */
VendorProduct.prototype['name'] = undefined;

/**
 * @member {Number} price
 */
VendorProduct.prototype['price'] = undefined;

/**
 * @member {String} product_category_number
 */
VendorProduct.prototype['product_category_number'] = undefined;

/**
 * @member {String} product_number
 */
VendorProduct.prototype['product_number'] = undefined;

/**
 * @member {String} vendor_id
 */
VendorProduct.prototype['vendor_id'] = undefined;
