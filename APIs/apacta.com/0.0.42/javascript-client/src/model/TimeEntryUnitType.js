...
/**
 * The TimeEntryUnitType model module.
 * @module model/TimeEntryUnitType
 * @version 0.0.42
 */
class TimeEntryUnitType {
    /**
     * Constructs a new <code>TimeEntryUnitType</code>.
     * @alias module:model/TimeEntryUnitType
     */
    constructor() { 
        
        TimeEntryUnitType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TimeEntryUnitType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeEntryUnitType} obj Optional instance to populate.
     * @return {module:model/TimeEntryUnitType} The populated <code>TimeEntryUnitType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeEntryUnitType();
    ...
    /**
     * Validates the JSON data with respect to <code>TimeEntryUnitType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimeEntryUnitType</code>.
     */
 ...
 */
TimeEntryUnitType.prototype['abbreviation'] = undefined;

/**
 * @member {String} created
 */
TimeEntryUnitType.prototype['created'] = undefined;

/**
 * @member {String} created_by_id
 */
TimeEntryUnitType.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
TimeEntryUnitType.prototype['deleted'] = undefined;

/**
 * @member {String} description
 */
TimeEntryUnitType.prototype['description'] = undefined;

/**
 * @member {String} id
 */
TimeEntryUnitType.prototype['id'] = undefined;

/**
 * @member {String} identifier
 */
TimeEntryUnitType.prototype['identifier'] = undefined;

/**
 * @member {String} modified
 */
TimeEntryUnitType.prototype['modified'] = undefined;

/**
 * @member {String} modified_by_id
 */
TimeEntryUnitType.prototype['modified_by_id'] = undefined;

/**
 * @member {String} name
 */
TimeEntryUnitType.prototype['name'] = undefined;
...
export default TimeEntryUnitType;
