...
/**
 * The MassMessage model module.
 * @module model/MassMessage
 * @version 0.0.42
 */
class MassMessage {
    /**
     * Constructs a new <code>MassMessage</code>.
     * @alias module:model/MassMessage
     */
    constructor() { 
        
        MassMessage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MassMessage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MassMessage} obj Optional instance to populate.
     * @return {module:model/MassMessage} The populated <code>MassMessage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MassMessage();
    ...
    /**
     * Validates the JSON data with respect to <code>MassMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MassMessage</code>.
     */
 ...
 */
MassMessage.prototype['company_id'] = undefined;

/**
 * @member {String} content
 */
MassMessage.prototype['content'] = undefined;

/**
 * @member {String} created
 */
MassMessage.prototype['created'] = undefined;

/**
 * @member {String} created_by_id
 */
MassMessage.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
MassMessage.prototype['deleted'] = undefined;

/**
 * @member {String} id
 */
MassMessage.prototype['id'] = undefined;

/**
 * @member {String} modified
 */
MassMessage.prototype['modified'] = undefined;
