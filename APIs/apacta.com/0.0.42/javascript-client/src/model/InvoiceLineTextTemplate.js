...
/**
 * The InvoiceLineTextTemplate model module.
 * @module model/InvoiceLineTextTemplate
 * @version 0.0.42
 */
class InvoiceLineTextTemplate {
    /**
     * Constructs a new <code>InvoiceLineTextTemplate</code>.
     * @alias module:model/InvoiceLineTextTemplate
     */
    constructor() { 
        
        InvoiceLineTextTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InvoiceLineTextTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InvoiceLineTextTemplate} obj Optional instance to populate.
     * @return {module:model/InvoiceLineTextTemplate} The populated <code>InvoiceLineTextTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InvoiceLineTextTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>InvoiceLineTextTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InvoiceLineTextTemplate</code>.
     */
 ...
 */
InvoiceLineTextTemplate.prototype['company_id'] = undefined;

/**
 * @member {String} created
 */
InvoiceLineTextTemplate.prototype['created'] = undefined;

/**
 * @member {String} created_by_id
 */
InvoiceLineTextTemplate.prototype['created_by_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
InvoiceLineTextTemplate.prototype['deleted'] = undefined;

/**
 * @member {String} html
 */
InvoiceLineTextTemplate.prototype['html'] = undefined;

/**
 * @member {String} id
 */
InvoiceLineTextTemplate.prototype['id'] = undefined;

/**
 * @member {String} image
 */
InvoiceLineTextTemplate.prototype['image'] = undefined;

/**
 * @member {String} modified
 */
InvoiceLineTextTemplate.prototype['modified'] = undefined;
...
export default InvoiceLineTextTemplate;
