...
/**
 * The InvoicesPostRequest model module.
 * @module model/InvoicesPostRequest
 * @version 0.0.42
 */
class InvoicesPostRequest {
    /**
     * Constructs a new <code>InvoicesPostRequest</code>.
     * @alias module:model/InvoicesPostRequest
     */
    constructor() { 
        
        InvoicesPostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InvoicesPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InvoicesPostRequest} obj Optional instance to populate.
     * @return {module:model/InvoicesPostRequest} The populated <code>InvoicesPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InvoicesPostRequest();

            if (data.hasOwnProperty('contact_id')) {
                obj['contact_id'] = ApiClient.convertToType(data['contact_id'], 'String');
            }
            if (data.hasOwnProperty('created_or_modified_gte')) {
                obj['created_or_modified_gte'] = ApiClient.convertToType(data['created_or_modified_gte'], 'Date');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>InvoicesPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InvoicesPostRequest</code>.
     */
 ...
 */
InvoicesPostRequest.prototype['contact_id'] = undefined;

/**
 * @member {Date} created_or_modified_gte
 */
InvoicesPostRequest.prototype['created_or_modified_gte'] = undefined;

/**
 * @member {Date} date_from
 */
InvoicesPostRequest.prototype['date_from'] = undefined;

/**
 * @member {Date} date_to
 */
InvoicesPostRequest.prototype['date_to'] = undefined;

/**
 * @member {String} erp_id
 */
InvoicesPostRequest.prototype['erp_id'] = undefined;

/**
 * @member {String} erp_payment_term_id
 */
InvoicesPostRequest.prototype['erp_payment_term_id'] = undefined;

/**
 * @member {Number} invoice_number
 */
InvoicesPostRequest.prototype['invoice_number'] = undefined;

/**
 * @member {Boolean} is_draft
 */
InvoicesPostRequest.prototype['is_draft'] = undefined;

/**
 * @member {Boolean} is_locked
 */
InvoicesPostRequest.prototype['is_locked'] = undefined;

/**
 * @member {Boolean} is_offer
 */
InvoicesPostRequest.prototype['is_offer'] = undefined;

/**
 * @member {Date} issued_date
 */
InvoicesPostRequest.prototype['issued_date'] = undefined;

/**
 * @member {String} message
 */
InvoicesPostRequest.prototype['message'] = undefined;

/**
 * @member {Number} offer_number
 */
InvoicesPostRequest.prototype['offer_number'] = undefined;

/**
 * @member {Date} payment_due_date
 */
InvoicesPostRequest.prototype['payment_due_date'] = undefined;

/**
 * @member {String} payment_term_id
 */
InvoicesPostRequest.prototype['payment_term_id'] = undefined;

/**
 * @member {String} project_id
 */
InvoicesPostRequest.prototype['project_id'] = undefined;

/**
 * @member {String} reference
 */
InvoicesPostRequest.prototype['reference'] = undefined;

/**
 * @member {Number} vat_percent
 */
InvoicesPostRequest.prototype['vat_percent'] = undefined;
...
export default InvoicesPostRequest;
