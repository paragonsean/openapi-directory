...
/**
 * The VendorProductPriceFile model module.
 * @module model/VendorProductPriceFile
 * @version 0.0.42
 */
class VendorProductPriceFile {
    /**
     * Constructs a new <code>VendorProductPriceFile</code>.
     * @alias module:model/VendorProductPriceFile
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>VendorProductPriceFile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VendorProductPriceFile} obj Optional instance to populate.
     * @return {module:model/VendorProductPriceFile} The populated <code>VendorProductPriceFile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VendorProductPriceFile();
    ...
    /**
     * Validates the JSON data with respect to <code>VendorProductPriceFile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VendorProductPriceFile</code>.
     */
 ...
 * @readonly
 */
VendorProductPriceFile['StatusEnum'] = {
...
export default VendorProductPriceFile;
