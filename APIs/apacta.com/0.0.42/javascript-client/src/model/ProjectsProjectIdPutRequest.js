...
/**
 * The ProjectsProjectIdPutRequest model module.
 * @module model/ProjectsProjectIdPutRequest
 * @version 0.0.42
 */
class ProjectsProjectIdPutRequest {
    /**
     * Constructs a new <code>ProjectsProjectIdPutRequest</code>.
     * @alias module:model/ProjectsProjectIdPutRequest
     * @param name {String} 
     */
    constructor(name) { 
        
        ProjectsProjectIdPutRequest.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>ProjectsProjectIdPutRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectsProjectIdPutRequest} obj Optional instance to populate.
     * @return {module:model/ProjectsProjectIdPutRequest} The populated <code>ProjectsProjectIdPutRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectsProjectIdPutRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectsProjectIdPutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectsProjectIdPutRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProjectsProjectIdPutRequest.RequiredProperties) {
...
ProjectsProjectIdPutRequest.RequiredProperties = ["name"];

/**
 * @member {String} contact_id
 */
ProjectsProjectIdPutRequest.prototype['contact_id'] = undefined;

/**
 * @member {String} description
 */
ProjectsProjectIdPutRequest.prototype['description'] = undefined;

/**
 * @member {String} erp_project_id
 */
ProjectsProjectIdPutRequest.prototype['erp_project_id'] = undefined;

/**
 * @member {String} erp_task_id
 */
ProjectsProjectIdPutRequest.prototype['erp_task_id'] = undefined;

/**
 * @member {String} name
 */
ProjectsProjectIdPutRequest.prototype['name'] = undefined;

/**
 * @member {String} project_status_id
 */
ProjectsProjectIdPutRequest.prototype['project_status_id'] = undefined;

/**
 * @member {String} start_time
 */
ProjectsProjectIdPutRequest.prototype['start_time'] = undefined;

/**
 * @member {String} street_name
 */
ProjectsProjectIdPutRequest.prototype['street_name'] = undefined;
...
export default ProjectsProjectIdPutRequest;
