...
class ProductVariant {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('variant_type')) {
                obj['variant_type'] = ApiClient.convertToType(data['variant_type'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['variant_type'] && !(typeof data['variant_type'] === 'string' || data['variant_type'] instanceof String)) {
            throw new Error("Expected the field `variant_type` to be a primitive type in the JSON string but got " + data['variant_type']);
        }
 ...
 */
ProductVariant.prototype['product_number'] = undefined;

/**
 * @member {String} variant_id
 */
ProductVariant.prototype['variant_id'] = undefined;

/**
 * @member {module:model/ProductVariant.VariantTypeEnum} variant_type
 */
ProductVariant.prototype['variant_type'] = undefined;
...
/**
 * Allowed values for the <code>variant_type</code> property.
 * @enum {String}
 * @readonly
 */
ProductVariant['VariantTypeEnum'] = {
