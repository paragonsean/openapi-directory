...
/**
 * The TimeEntryRate model module.
 * @module model/TimeEntryRate
 * @version 0.0.42
 */
class TimeEntryRate {
    /**
     * Constructs a new <code>TimeEntryRate</code>.
     * @alias module:model/TimeEntryRate
     */
    constructor() { 
        
        TimeEntryRate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TimeEntryRate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeEntryRate} obj Optional instance to populate.
     * @return {module:model/TimeEntryRate} The populated <code>TimeEntryRate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeEntryRate();
            ...
            if (data.hasOwnProperty('selling_amount')) {
                obj['selling_amount'] = ApiClient.convertToType(data['selling_amount'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TimeEntryRate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimeEntryRate</code>.
     */
 ...
 */
TimeEntryRate.prototype['amount'] = undefined;

/**
 * @member {String} company_id
 */
TimeEntryRate.prototype['company_id'] = undefined;

/**
 * @member {String} created
 */
TimeEntryRate.prototype['created'] = undefined;

/**
 * @member {String} created_by_id
 */
TimeEntryRate.prototype['created_by_id'] = undefined;

/**
 * @member {String} currency_id
 */
TimeEntryRate.prototype['currency_id'] = undefined;

/**
 * Only present if it's a deleted object
 * @member {String} deleted
 */
TimeEntryRate.prototype['deleted'] = undefined;

/**
 * @member {String} id
 */
TimeEntryRate.prototype['id'] = undefined;

/**
 * @member {String} modified
 */
TimeEntryRate.prototype['modified'] = undefined;

/**
 * @member {String} modified_by_id
 */
TimeEntryRate.prototype['modified_by_id'] = undefined;

/**
 * @member {Number} selling_amount
 */
TimeEntryRate.prototype['selling_amount'] = undefined;

/**
 * @member {String} time_entry_type_id
 */
TimeEntryRate.prototype['time_entry_type_id'] = undefined;
