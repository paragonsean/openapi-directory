...
/*
 * OAIControllers_AdvisoryItemAttributes.h
 *
 * 
 */

#ifndef OAIControllers_AdvisoryItemAttributes_H
#define OAIControllers_AdvisoryItemAttributes_H
...
class OAIControllers_AdvisoryItemAttributes : public OAIObject {
public:
    OAIControllers_AdvisoryItemAttributes();
    OAIControllers_AdvisoryItemAttributes(QString json);
    ~OAIControllers_AdvisoryItemAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIControllers_AdvisoryItemAttributes)

#endif // OAIControllers_AdvisoryItemAttributes_H
