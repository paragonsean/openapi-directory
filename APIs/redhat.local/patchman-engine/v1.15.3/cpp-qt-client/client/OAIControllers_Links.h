...
/*
 * OAIControllers_Links.h
 *
 * 
 */

#ifndef OAIControllers_Links_H
#define OAIControllers_Links_H
...
class OAIControllers_Links : public OAIObject {
public:
    OAIControllers_Links();
    OAIControllers_Links(QString json);
    ~OAIControllers_Links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIControllers_Links)

#endif // OAIControllers_Links_H
