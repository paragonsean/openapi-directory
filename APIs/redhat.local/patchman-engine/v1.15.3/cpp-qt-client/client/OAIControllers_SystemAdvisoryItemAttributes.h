...
/*
 * OAIControllers_SystemAdvisoryItemAttributes.h
 *
 * 
 */

#ifndef OAIControllers_SystemAdvisoryItemAttributes_H
#define OAIControllers_SystemAdvisoryItemAttributes_H
...
class OAIControllers_SystemAdvisoryItemAttributes : public OAIObject {
public:
    OAIControllers_SystemAdvisoryItemAttributes();
    OAIControllers_SystemAdvisoryItemAttributes(QString json);
    ~OAIControllers_SystemAdvisoryItemAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIControllers_SystemAdvisoryItemAttributes)

#endif // OAIControllers_SystemAdvisoryItemAttributes_H
