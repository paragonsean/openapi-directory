...
/*
 * OAIControllers_SystemInlineItem.h
 *
 * 
 */

#ifndef OAIControllers_SystemInlineItem_H
#define OAIControllers_SystemInlineItem_H
...
class OAIControllers_SystemInlineItem : public OAIObject {
public:
    OAIControllers_SystemInlineItem();
    OAIControllers_SystemInlineItem(QString json);
    ~OAIControllers_SystemInlineItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIControllers_SystemInlineItem)

#endif // OAIControllers_SystemInlineItem_H
