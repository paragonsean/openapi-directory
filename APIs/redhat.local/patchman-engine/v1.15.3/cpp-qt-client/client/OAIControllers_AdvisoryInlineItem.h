...
/*
 * OAIControllers_AdvisoryInlineItem.h
 *
 * 
 */

#ifndef OAIControllers_AdvisoryInlineItem_H
#define OAIControllers_AdvisoryInlineItem_H
...
class OAIControllers_AdvisoryInlineItem : public OAIObject {
public:
    OAIControllers_AdvisoryInlineItem();
    OAIControllers_AdvisoryInlineItem(QString json);
    ~OAIControllers_AdvisoryInlineItem() override;
    ...
    qint32 getApplicableSystems() const;
    void setApplicableSystems(const qint32 &applicable_systems);
    bool is_applicable_systems_Set() const;
    bool is_applicable_systems_Valid() const;
...
private:
    ...
    qint32 m_applicable_systems;
    bool m_applicable_systems_isSet;
    bool m_applicable_systems_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIControllers_AdvisoryInlineItem)

#endif // OAIControllers_AdvisoryInlineItem_H
