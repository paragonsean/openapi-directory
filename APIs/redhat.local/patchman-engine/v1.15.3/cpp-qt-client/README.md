...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::deletesystemSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::deletesystemSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString inventory_id = create(); // QString | Inventory ID
      apiInstance.deletesystem(inventory_id);
...
GPLv3 for more information visit [GPLv3](https://www.gnu.org/licenses/gpl-3.0.en.html)