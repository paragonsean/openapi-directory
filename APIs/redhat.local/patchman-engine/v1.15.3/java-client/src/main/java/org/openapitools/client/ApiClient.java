...
public class ApiClient {
    ...
    private String basePath = "http://redhat.local";
    ...
    public ApiClient() {
        ...
        authentications.put("RhIdentity", new ApiKeyAuth("header", "x-rh-identity"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1.15.3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://redhat.local
