...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PatchmanEngineApi.ControllersFilterData();
  });
  ...
  describe('ControllersFilterData', function() {
    it('should create an instance of ControllersFilterData', function() {
      // uncomment below and update the code to test ControllersFilterData
      //var instance = new PatchmanEngineApi.ControllersFilterData();
      //expect(instance).to.be.a(PatchmanEngineApi.ControllersFilterData);
    });
