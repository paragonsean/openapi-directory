...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PatchmanEngineApi.ControllersSystemItemAttributes();
  });
  ...
  describe('ControllersSystemItemAttributes', function() {
    it('should create an instance of ControllersSystemItemAttributes', function() {
      // uncomment below and update the code to test ControllersSystemItemAttributes
      //var instance = new PatchmanEngineApi.ControllersSystemItemAttributes();
      //expect(instance).to.be.a(PatchmanEngineApi.ControllersSystemItemAttributes);
    });
