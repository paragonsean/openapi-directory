...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://redhat.local') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://redhat.local
         */
        ...
        this.authentications = {
            'RhIdentity': {type: 'apiKey', 'in': 'header', name: 'x-rh-identity'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v1.15.3/Javascript'
        };
