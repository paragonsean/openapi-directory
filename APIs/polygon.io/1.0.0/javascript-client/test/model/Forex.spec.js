...
(function(root, factory) {
  ...
  describe('Forex', function() {
    it('should create an instance of Forex', function() {
      // uncomment below and update the code to test Forex
      //var instance = new Polygon.Forex();
      //expect(instance).to.be.a(Polygon.Forex);
    });
