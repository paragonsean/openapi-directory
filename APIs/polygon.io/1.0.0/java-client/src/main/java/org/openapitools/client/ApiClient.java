...
public class ApiClient {
    ...
    private String basePath = "https://api.polygon.io";
    ...
    public ApiClient() {
        ...
        authentications.put("apiKey", new ApiKeyAuth("query", "apiKey"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.polygon.io
