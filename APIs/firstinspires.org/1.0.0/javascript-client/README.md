...
FrcEvents - JavaScript client for frc_events
...
To use the link you just defined in your project, switch to the directory you want to use your frc_events from, and run:
...
```javascript
var FrcEvents = require('frc_events');
