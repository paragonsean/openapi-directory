...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedirectionIo.ProjectWrite();
  });
  ...
  describe('ProjectWrite', function() {
    it('should create an instance of ProjectWrite', function() {
      // uncomment below and update the code to test ProjectWrite
      //var instance = new RedirectionIo.ProjectWrite();
      //expect(instance).to.be.a(RedirectionIo.ProjectWrite);
    });
