...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedirectionIo.CrawlReadDetails();
  });
  ...
  describe('CrawlReadDetails', function() {
    it('should create an instance of CrawlReadDetails', function() {
      // uncomment below and update the code to test CrawlReadDetails
      //var instance = new RedirectionIo.CrawlReadDetails();
      //expect(instance).to.be.a(RedirectionIo.CrawlReadDetails);
    });
