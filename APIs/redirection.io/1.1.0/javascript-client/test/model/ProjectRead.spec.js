...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedirectionIo.ProjectRead();
  });
  ...
  describe('ProjectRead', function() {
    it('should create an instance of ProjectRead', function() {
      // uncomment below and update the code to test ProjectRead
      //var instance = new RedirectionIo.ProjectRead();
      //expect(instance).to.be.a(RedirectionIo.ProjectRead);
    });
