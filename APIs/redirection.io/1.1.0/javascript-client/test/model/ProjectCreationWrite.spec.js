...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedirectionIo.ProjectCreationWrite();
  });
  ...
  describe('ProjectCreationWrite', function() {
    it('should create an instance of ProjectCreationWrite', function() {
      // uncomment below and update the code to test ProjectCreationWrite
      //var instance = new RedirectionIo.ProjectCreationWrite();
      //expect(instance).to.be.a(RedirectionIo.ProjectCreationWrite);
    });
