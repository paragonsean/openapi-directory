...
async def get_aggregate_log_collection(request: web.Request, page=None, project_id=None, created_at=None, source=None, target=None, status_code=None, referrer=None, user_agent=None, user_agent_type=None, simplified_user_agent=None, rule_id=None, instance_name=None, exclude_urls=None, exclude_empty_referrer=None, created_at_gt=None, created_at_gte=None, created_at_lt=None, created_at_lte=None, status_code_gt=None, status_code_gte=None, status_code_lt=None, status_code_lte=None) -> web.Response:
...
async def get_aggregate_log_item(request: web.Request, id) -> web.Response:
