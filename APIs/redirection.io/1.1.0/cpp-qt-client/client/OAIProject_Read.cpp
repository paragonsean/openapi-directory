...
OAIProject_Read::OAIProject_Read(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProject_Read::OAIProject_Read() {
    this->initializeModel();
}

OAIProject_Read::~OAIProject_Read() {}

void OAIProject_Read::initializeModel() {
...
void OAIProject_Read::fromJson(QString jsonString) {
...
void OAIProject_Read::fromJsonObject(QJsonObject json) {
...
QString OAIProject_Read::asJson() const {
...
QJsonObject OAIProject_Read::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIProject_Read::getComplexRulesCount() const {
    return m_complex_rules_count;
}
void OAIProject_Read::setComplexRulesCount(const qint32 &complex_rules_count) {
    m_complex_rules_count = complex_rules_count;
    m_complex_rules_count_isSet = true;
}

bool OAIProject_Read::is_complex_rules_count_Set() const{
    return m_complex_rules_count_isSet;
}

bool OAIProject_Read::is_complex_rules_count_Valid() const{
    return m_complex_rules_count_isValid;
}

QDateTime OAIProject_Read::getComplexRulesUpdatedAt() const {
    return m_complex_rules_updated_at;
}
void OAIProject_Read::setComplexRulesUpdatedAt(const QDateTime &complex_rules_updated_at) {
    m_complex_rules_updated_at = complex_rules_updated_at;
    m_complex_rules_updated_at_isSet = true;
}

bool OAIProject_Read::is_complex_rules_updated_at_Set() const{
    return m_complex_rules_updated_at_isSet;
}

bool OAIProject_Read::is_complex_rules_updated_at_Valid() const{
    return m_complex_rules_updated_at_isValid;
}

QList<QString> OAIProject_Read::getConfiguration() const {
    return m_configuration;
}
void OAIProject_Read::setConfiguration(const QList<QString> &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAIProject_Read::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAIProject_Read::is_configuration_Valid() const{
    return m_configuration_isValid;
}

QDateTime OAIProject_Read::getCreatedAt() const {
    return m_created_at;
}
void OAIProject_Read::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIProject_Read::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIProject_Read::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIRuleSetVersion_Read OAIProject_Read::getCurrentVersion() const {
    return m_current_version;
}
void OAIProject_Read::setCurrentVersion(const OAIRuleSetVersion_Read &current_version) {
    m_current_version = current_version;
    m_current_version_isSet = true;
}

bool OAIProject_Read::is_current_version_Set() const{
    return m_current_version_isSet;
}

bool OAIProject_Read::is_current_version_Valid() const{
    return m_current_version_isValid;
}

QString OAIProject_Read::getId() const {
    return m_id;
}
void OAIProject_Read::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIProject_Read::is_id_Set() const{
    return m_id_isSet;
}

bool OAIProject_Read::is_id_Valid() const{
    return m_id_isValid;
}

QList<QString> OAIProject_Read::getIgnoreProjectTypes() const {
    return m_ignore_project_types;
}
void OAIProject_Read::setIgnoreProjectTypes(const QList<QString> &ignore_project_types) {
    m_ignore_project_types = ignore_project_types;
    m_ignore_project_types_isSet = true;
}

bool OAIProject_Read::is_ignore_project_types_Set() const{
    return m_ignore_project_types_isSet;
}

bool OAIProject_Read::is_ignore_project_types_Valid() const{
    return m_ignore_project_types_isValid;
}

bool OAIProject_Read::isIsPublishing() const {
    return m_is_publishing;
}
void OAIProject_Read::setIsPublishing(const bool &is_publishing) {
    m_is_publishing = is_publishing;
    m_is_publishing_isSet = true;
}

bool OAIProject_Read::is_is_publishing_Set() const{
    return m_is_publishing_isSet;
}

bool OAIProject_Read::is_is_publishing_Valid() const{
    return m_is_publishing_isValid;
}

QString OAIProject_Read::getName() const {
    return m_name;
}
void OAIProject_Read::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProject_Read::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProject_Read::is_name_Valid() const{
    return m_name_isValid;
}

QList<QString> OAIProject_Read::getOnboardingCompletedDemos() const {
    return m_onboarding_completed_demos;
}
void OAIProject_Read::setOnboardingCompletedDemos(const QList<QString> &onboarding_completed_demos) {
    m_onboarding_completed_demos = onboarding_completed_demos;
    m_onboarding_completed_demos_isSet = true;
}

bool OAIProject_Read::is_onboarding_completed_demos_Set() const{
    return m_onboarding_completed_demos_isSet;
}

bool OAIProject_Read::is_onboarding_completed_demos_Valid() const{
    return m_onboarding_completed_demos_isValid;
}

OAIOrganization_Read OAIProject_Read::getOrganization() const {
    return m_organization;
}
void OAIProject_Read::setOrganization(const OAIOrganization_Read &organization) {
    m_organization = organization;
    m_organization_isSet = true;
}

bool OAIProject_Read::is_organization_Set() const{
    return m_organization_isSet;
}

bool OAIProject_Read::is_organization_Valid() const{
    return m_organization_isValid;
}

qint32 OAIProject_Read::getPlan() const {
    return m_plan;
}
void OAIProject_Read::setPlan(const qint32 &plan) {
    m_plan = plan;
    m_plan_isSet = true;
}

bool OAIProject_Read::is_plan_Set() const{
    return m_plan_isSet;
}

bool OAIProject_Read::is_plan_Valid() const{
    return m_plan_isValid;
}

QString OAIProject_Read::getRulesHash() const {
    return m_rules_hash;
}
void OAIProject_Read::setRulesHash(const QString &rules_hash) {
    m_rules_hash = rules_hash;
    m_rules_hash_isSet = true;
}

bool OAIProject_Read::is_rules_hash_Set() const{
    return m_rules_hash_isSet;
}

bool OAIProject_Read::is_rules_hash_Valid() const{
    return m_rules_hash_isValid;
}

QString OAIProject_Read::getSlug() const {
    return m_slug;
}
void OAIProject_Read::setSlug(const QString &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAIProject_Read::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAIProject_Read::is_slug_Valid() const{
    return m_slug_isValid;
}

qint32 OAIProject_Read::getStraightRulesCount() const {
    return m_straight_rules_count;
}
void OAIProject_Read::setStraightRulesCount(const qint32 &straight_rules_count) {
    m_straight_rules_count = straight_rules_count;
    m_straight_rules_count_isSet = true;
}

bool OAIProject_Read::is_straight_rules_count_Set() const{
    return m_straight_rules_count_isSet;
}

bool OAIProject_Read::is_straight_rules_count_Valid() const{
    return m_straight_rules_count_isValid;
}

QDateTime OAIProject_Read::getStraightRulesUpdatedAt() const {
    return m_straight_rules_updated_at;
}
void OAIProject_Read::setStraightRulesUpdatedAt(const QDateTime &straight_rules_updated_at) {
    m_straight_rules_updated_at = straight_rules_updated_at;
    m_straight_rules_updated_at_isSet = true;
}

bool OAIProject_Read::is_straight_rules_updated_at_Set() const{
    return m_straight_rules_updated_at_isSet;
}

bool OAIProject_Read::is_straight_rules_updated_at_Valid() const{
    return m_straight_rules_updated_at_isValid;
}

QString OAIProject_Read::getToken() const {
    return m_token;
}
void OAIProject_Read::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIProject_Read::is_token_Set() const{
    return m_token_isSet;
}

bool OAIProject_Read::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIProject_Read::getUpdatedAt() const {
    return m_updated_at;
}
void OAIProject_Read::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIProject_Read::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIProject_Read::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QList<OAIUserProject_Read> OAIProject_Read::getUserProjects() const {
    return m_user_projects;
}
void OAIProject_Read::setUserProjects(const QList<OAIUserProject_Read> &user_projects) {
    m_user_projects = user_projects;
    m_user_projects_isSet = true;
}

bool OAIProject_Read::is_user_projects_Set() const{
    return m_user_projects_isSet;
}

bool OAIProject_Read::is_user_projects_Valid() const{
    return m_user_projects_isValid;
}

QList<OAIUserProjectFlattened_Read> OAIProject_Read::getUsersFlattened() const {
    return m_users_flattened;
}
void OAIProject_Read::setUsersFlattened(const QList<OAIUserProjectFlattened_Read> &users_flattened) {
    m_users_flattened = users_flattened;
    m_users_flattened_isSet = true;
}

bool OAIProject_Read::is_users_flattened_Set() const{
    return m_users_flattened_isSet;
}

bool OAIProject_Read::is_users_flattened_Valid() const{
    return m_users_flattened_isValid;
}

OAIRuleSetVersion_Read OAIProject_Read::getWorkingVersion() const {
    return m_working_version;
}
void OAIProject_Read::setWorkingVersion(const OAIRuleSetVersion_Read &working_version) {
    m_working_version = working_version;
    m_working_version_isSet = true;
}

bool OAIProject_Read::is_working_version_Set() const{
    return m_working_version_isSet;
}

bool OAIProject_Read::is_working_version_Valid() const{
    return m_working_version_isValid;
}

bool OAIProject_Read::isSet() const {
...
bool OAIProject_Read::isValid() const {
