...
public:
    ...
    qint32 getCurrentConcurrency() const;
    void setCurrentConcurrency(const qint32 &current_concurrency);
    bool is_current_concurrency_Set() const;
    bool is_current_concurrency_Valid() const;
    ...
    QList<QString> getMarking() const;
    void setMarking(const QList<QString> &marking);
    bool is_marking_Set() const;
    bool is_marking_Valid() const;
...
private:
    ...
    qint32 m_current_concurrency;
    bool m_current_concurrency_isSet;
    bool m_current_concurrency_isValid;
    ...
    QList<QString> m_marking;
    bool m_marking_isSet;
    bool m_marking_isValid;
