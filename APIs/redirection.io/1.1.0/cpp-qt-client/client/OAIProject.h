...
namespace OpenAPI {
class OAIRuleSetVersion;
class OAIOrganization;
class OAIUserProject;
class OAIUserProjectFlattened;
...
public:
    ...
    OAIRuleSetVersion getCurrentVersion() const;
    void setCurrentVersion(const OAIRuleSetVersion &current_version);
    ...
    QList<OAIUserProject> getUserProjects() const;
    void setUserProjects(const QList<OAIUserProject> &user_projects);
    bool is_user_projects_Set() const;
    bool is_user_projects_Valid() const;

    QList<OAIUserProjectFlattened> getUsersFlattened() const;
    void setUsersFlattened(const QList<OAIUserProjectFlattened> &users_flattened);
    bool is_users_flattened_Set() const;
    bool is_users_flattened_Valid() const;

    OAIRuleSetVersion getWorkingVersion() const;
    void setWorkingVersion(const OAIRuleSetVersion &working_version);
...
private:
    ...
    OAIRuleSetVersion m_current_version;
    ...
    QList<OAIUserProject> m_user_projects;
    bool m_user_projects_isSet;
    bool m_user_projects_isValid;

    QList<OAIUserProjectFlattened> m_users_flattened;
    bool m_users_flattened_isSet;
    bool m_users_flattened_isValid;

    OAIRuleSetVersion m_working_version;
