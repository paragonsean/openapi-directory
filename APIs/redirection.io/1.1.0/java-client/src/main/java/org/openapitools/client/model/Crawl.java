...
public class Crawl {
  ...
  public static final String SERIALIZED_NAME_CURRENT_CONCURRENCY = "currentConcurrency";
  @SerializedName(SERIALIZED_NAME_CURRENT_CONCURRENCY)
  ...
  public static final String SERIALIZED_NAME_MARKING = "marking";
  @SerializedName(SERIALIZED_NAME_MARKING)
  private List<String> marking = new ArrayList<>();
  ...
  public Crawl author(User author) {
    this.author = author;
    return this;
  }
  ...
  public Crawl currentConcurrency(Integer currentConcurrency) {
  ...
  public Crawl marking(List<String> marking) {
    this.marking = marking;
    return this;
  }

  public Crawl addMarkingItem(String markingItem) {
    if (this.marking == null) {
      this.marking = new ArrayList<>();
    }
    this.marking.add(markingItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<String> getMarking() {
    return marking;
  }

  public void setMarking(List<String> marking) {
    this.marking = marking;
  }


  public Crawl stats(List<String> stats) {
    this.stats = stats;
    return this;
  }

  public Crawl addStatsItem(String statsItem) {
    if (this.stats == null) {
  ...
  public boolean equals(Object o) {
    ...
    Crawl crawl = (Crawl) o;
    return Objects.equals(this.archived, crawl.archived) &&
        Objects.equals(this.author, crawl.author) &&
        Objects.equals(this.createdAt, crawl.createdAt) &&
        Objects.equals(this.currentConcurrency, crawl.currentConcurrency) &&
        Objects.equals(this.error, crawl.error) &&
        Objects.equals(this.finishedAt, crawl.finishedAt) &&
        Objects.equals(this.firstUrl, crawl.firstUrl) &&
        Objects.equals(this.id, crawl.id) &&
        Objects.equals(this.marking, crawl.marking) &&
        Objects.equals(this.stats, crawl.stats) &&
        Objects.equals(this.trigger, crawl.trigger) &&
        Objects.equals(this.updatedAt, crawl.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(archived, author, createdAt, currentConcurrency, error, finishedAt, firstUrl, id, marking, stats, trigger, updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("    currentConcurrency: ").append(toIndentedString(currentConcurrency)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("marking") != null && !jsonObj.get("marking").isJsonNull() && !jsonObj.get("marking").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `marking` to be an array in the JSON string but got `%s`", jsonObj.get("marking").toString()));
      }
      // ensure the optional json data is an array if present
