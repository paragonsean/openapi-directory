...
/*
 * OAIActionShortResponse.h
 *
 * 
 */

#ifndef OAIActionShortResponse_H
#define OAIActionShortResponse_H
...
class OAIActionShortResponse : public OAIObject {
public:
    OAIActionShortResponse();
    OAIActionShortResponse(QString json);
    ~OAIActionShortResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionShortResponse)

#endif // OAIActionShortResponse_H
