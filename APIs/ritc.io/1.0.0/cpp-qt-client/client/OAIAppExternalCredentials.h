...
/*
 * OAIAppExternalCredentials.h
 *
 * 
 */

#ifndef OAIAppExternalCredentials_H
#define OAIAppExternalCredentials_H
...
class OAIAppExternalCredentials : public OAIObject {
public:
    OAIAppExternalCredentials();
    OAIAppExternalCredentials(QString json);
    ~OAIAppExternalCredentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppExternalCredentials)

#endif // OAIAppExternalCredentials_H
