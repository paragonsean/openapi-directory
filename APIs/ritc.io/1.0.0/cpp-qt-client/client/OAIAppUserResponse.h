...
/*
 * OAIAppUserResponse.h
 *
 * 
 */

#ifndef OAIAppUserResponse_H
#define OAIAppUserResponse_H
...
class OAIAppUserResponse : public OAIObject {
public:
    OAIAppUserResponse();
    OAIAppUserResponse(QString json);
    ~OAIAppUserResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppUserResponse)

#endif // OAIAppUserResponse_H
