...
QString OAIAction::getChannelId() const {
    return m_channel_id;
}
void OAIAction::setChannelId(const QString &channel_id) {
    m_channel_id = channel_id;
    m_channel_id_isSet = true;
}

bool OAIAction::is_channel_id_Set() const{
    return m_channel_id_isSet;
}

bool OAIAction::is_channel_id_Valid() const{
    return m_channel_id_isValid;
}

QString OAIAction::getCreatedDate() const {
    return m_created_date;
}
void OAIAction::setCreatedDate(const QString &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIAction::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIAction::is_created_date_Valid() const{
...
QString OAIAction::getFunctionId() const {
    return m_function_id;
}
void OAIAction::setFunctionId(const QString &function_id) {
    m_function_id = function_id;
    m_function_id_isSet = true;
}

bool OAIAction::is_function_id_Set() const{
    return m_function_id_isSet;
}

bool OAIAction::is_function_id_Valid() const{
...
QString OAIAction::getModifiedDate() const {
    return m_modified_date;
}
void OAIAction::setModifiedDate(const QString &modified_date) {
    m_modified_date = modified_date;
    m_modified_date_isSet = true;
}

bool OAIAction::is_modified_date_Set() const{
    return m_modified_date_isSet;
}

bool OAIAction::is_modified_date_Valid() const{
...
OAIStatus OAIAction::getStatus() const {
    return m_status;
}
void OAIAction::setStatus(const OAIStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
