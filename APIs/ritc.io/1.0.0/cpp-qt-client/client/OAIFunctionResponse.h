...
/*
 * OAIFunctionResponse.h
 *
 * 
 */

#ifndef OAIFunctionResponse_H
#define OAIFunctionResponse_H
...
class OAIFunctionResponse : public OAIObject {
public:
    OAIFunctionResponse();
    OAIFunctionResponse(QString json);
    ~OAIFunctionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFunctionResponse)

#endif // OAIFunctionResponse_H
