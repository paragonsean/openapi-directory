...
/*
 * OAITriggerShortResponse.h
 *
 * 
 */

#ifndef OAITriggerShortResponse_H
#define OAITriggerShortResponse_H
...
class OAITriggerShortResponse : public OAIObject {
public:
    OAITriggerShortResponse();
    OAITriggerShortResponse(QString json);
    ~OAITriggerShortResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITriggerShortResponse)

#endif // OAITriggerShortResponse_H
