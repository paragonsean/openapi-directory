...
/*
 * OAIRuleShortResponse.h
 *
 * 
 */

#ifndef OAIRuleShortResponse_H
#define OAIRuleShortResponse_H
...
class OAIRuleShortResponse : public OAIObject {
public:
    OAIRuleShortResponse();
    OAIRuleShortResponse(QString json);
    ~OAIRuleShortResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleShortResponse)

#endif // OAIRuleShortResponse_H
