...
/*
 * OAIActionFullResponse.h
 *
 * 
 */

#ifndef OAIActionFullResponse_H
#define OAIActionFullResponse_H
...
class OAIActionFullResponse : public OAIObject {
public:
    OAIActionFullResponse();
    OAIActionFullResponse(QString json);
    ~OAIActionFullResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionFullResponse)

#endif // OAIActionFullResponse_H
