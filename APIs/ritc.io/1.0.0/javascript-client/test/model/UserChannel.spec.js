...
(function(root, factory) {
  ...
  describe('UserChannel', function() {
    it('should create an instance of UserChannel', function() {
      // uncomment below and update the code to test UserChannel
      //var instance = new Ritc.UserChannel();
      //expect(instance).to.be.a(Ritc.UserChannel);
    });
