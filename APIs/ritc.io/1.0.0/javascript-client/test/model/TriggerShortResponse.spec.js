...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ritc.TriggerShortResponse();
  });
  ...
  describe('TriggerShortResponse', function() {
    it('should create an instance of TriggerShortResponse', function() {
      // uncomment below and update the code to test TriggerShortResponse
      //var instance = new Ritc.TriggerShortResponse();
      //expect(instance).to.be.a(Ritc.TriggerShortResponse);
    });
