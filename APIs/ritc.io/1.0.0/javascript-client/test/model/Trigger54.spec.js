...
(function(root, factory) {
  ...
  describe('Trigger54', function() {
    it('should create an instance of Trigger54', function() {
      // uncomment below and update the code to test Trigger54
      //var instance = new Ritc.Trigger54();
      //expect(instance).to.be.a(Ritc.Trigger54);
    });
