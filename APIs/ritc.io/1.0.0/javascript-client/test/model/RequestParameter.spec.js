...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ritc.RequestParameter();
  });
  ...
  describe('RequestParameter', function() {
    it('should create an instance of RequestParameter', function() {
      // uncomment below and update the code to test RequestParameter
      //var instance = new Ritc.RequestParameter();
      //expect(instance).to.be.a(Ritc.RequestParameter);
    });
