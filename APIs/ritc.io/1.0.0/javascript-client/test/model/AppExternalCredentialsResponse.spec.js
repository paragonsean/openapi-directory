...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ritc.AppExternalCredentialsResponse();
  });
  ...
  describe('AppExternalCredentialsResponse', function() {
    it('should create an instance of AppExternalCredentialsResponse', function() {
      // uncomment below and update the code to test AppExternalCredentialsResponse
      //var instance = new Ritc.AppExternalCredentialsResponse();
      //expect(instance).to.be.a(Ritc.AppExternalCredentialsResponse);
    });
