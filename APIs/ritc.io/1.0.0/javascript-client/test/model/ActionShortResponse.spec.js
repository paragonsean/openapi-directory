...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ritc.ActionShortResponse();
  });
  ...
  describe('ActionShortResponse', function() {
    it('should create an instance of ActionShortResponse', function() {
      // uncomment below and update the code to test ActionShortResponse
      //var instance = new Ritc.ActionShortResponse();
      //expect(instance).to.be.a(Ritc.ActionShortResponse);
    });
