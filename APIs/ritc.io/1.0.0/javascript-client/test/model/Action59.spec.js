...
(function(root, factory) {
  ...
  describe('Action59', function() {
    it('should create an instance of Action59', function() {
      // uncomment below and update the code to test Action59
      //var instance = new Ritc.Action59();
      //expect(instance).to.be.a(Ritc.Action59);
    });
