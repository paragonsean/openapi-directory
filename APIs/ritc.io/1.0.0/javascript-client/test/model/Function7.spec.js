...
(function(root, factory) {
  ...
  describe('Function7', function() {
    it('should create an instance of Function7', function() {
      // uncomment below and update the code to test Function7
      //var instance = new Ritc.Function7();
      //expect(instance).to.be.a(Ritc.Function7);
    });
    ...
    it('should have the property responseFormat (base name: "responseFormat")', function() {
