...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ritc.ActionFullResponse();
  });
  ...
  describe('ActionFullResponse', function() {
    it('should create an instance of ActionFullResponse', function() {
      // uncomment below and update the code to test ActionFullResponse
      //var instance = new Ritc.ActionFullResponse();
      //expect(instance).to.be.a(Ritc.ActionFullResponse);
    });
