...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ritc.FunctionResponse();
  });
  ...
  describe('FunctionResponse', function() {
    it('should create an instance of FunctionResponse', function() {
      // uncomment below and update the code to test FunctionResponse
      //var instance = new Ritc.FunctionResponse();
      //expect(instance).to.be.a(Ritc.FunctionResponse);
    });
