...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ritc.RuleFullResponse();
  });
  ...
  describe('RuleFullResponse', function() {
    it('should create an instance of RuleFullResponse', function() {
      // uncomment below and update the code to test RuleFullResponse
      //var instance = new Ritc.RuleFullResponse();
      //expect(instance).to.be.a(Ritc.RuleFullResponse);
    });
