...
(function(root, factory) {
  ...
  describe('OrgsApi', function() {
    ...
    describe('getMyOrganization', function() {
      it('should call getMyOrganization successfully', function(done) {
        //uncomment below and update the code to test getMyOrganization
        //instance.getMyOrganization(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
