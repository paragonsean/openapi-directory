...
OAIToo_many_requests_error_response_object::OAIToo_many_requests_error_response_object(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIToo_many_requests_error_response_object::OAIToo_many_requests_error_response_object() {
    this->initializeModel();
}

OAIToo_many_requests_error_response_object::~OAIToo_many_requests_error_response_object() {}

void OAIToo_many_requests_error_response_object::initializeModel() {

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIToo_many_requests_error_response_object::fromJson(QString jsonString) {
...
void OAIToo_many_requests_error_response_object::fromJsonObject(QJsonObject json) {

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("errors")]);
    m_errors_isSet = !json[QString("errors")].isNull() && m_errors_isValid;
}

QString OAIToo_many_requests_error_response_object::asJson() const {
...
QJsonObject OAIToo_many_requests_error_response_object::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIToo_many_requests_error_response_object_errors_inner> OAIToo_many_requests_error_response_object::getErrors() const {
    return m_errors;
}
void OAIToo_many_requests_error_response_object::setErrors(const QList<OAIToo_many_requests_error_response_object_errors_inner> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIToo_many_requests_error_response_object::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIToo_many_requests_error_response_object::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIToo_many_requests_error_response_object::isSet() const {
...
bool OAIToo_many_requests_error_response_object::isValid() const {
