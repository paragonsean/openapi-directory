...
/*
 * OAIWebhook_subscription_response_object_data.h
 *
 * 
 */

#ifndef OAIWebhook_subscription_response_object_data_H
#define OAIWebhook_subscription_response_object_data_H
...
namespace OpenAPI {
class OAIWebhook_subscription_response_object_data_attributes;
class OAIWebhook_subscription_response_object_data_relationships;

class OAIWebhook_subscription_response_object_data : public OAIObject {
public:
    OAIWebhook_subscription_response_object_data();
    OAIWebhook_subscription_response_object_data(QString json);
    ~OAIWebhook_subscription_response_object_data() override;
    ...
    OAIWebhook_subscription_response_object_data_attributes getAttributes() const;
    void setAttributes(const OAIWebhook_subscription_response_object_data_attributes &attributes);
    ...
    OAIWebhook_subscription_response_object_data_relationships getRelationships() const;
    void setRelationships(const OAIWebhook_subscription_response_object_data_relationships &relationships);
...
private:
    ...
    OAIWebhook_subscription_response_object_data_attributes m_attributes;
    ...
    OAIWebhook_subscription_response_object_data_relationships m_relationships;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhook_subscription_response_object_data)

#endif // OAIWebhook_subscription_response_object_data_H
