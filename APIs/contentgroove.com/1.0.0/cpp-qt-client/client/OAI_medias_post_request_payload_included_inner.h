...
/*
 * OAI_medias_post_request_payload_included_inner.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_included_inner_H
#define OAI_medias_post_request_payload_included_inner_H
...
class OAI_medias_post_request_payload_included_inner : public OAIObject {
public:
    OAI_medias_post_request_payload_included_inner();
    OAI_medias_post_request_payload_included_inner(QString json);
    ~OAI_medias_post_request_payload_included_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_included_inner)

#endif // OAI_medias_post_request_payload_included_inner_H
