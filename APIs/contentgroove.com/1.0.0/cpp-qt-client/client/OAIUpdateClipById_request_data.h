...
/*
 * OAIUpdateClipById_request_data.h
 *
 * 
 */

#ifndef OAIUpdateClipById_request_data_H
#define OAIUpdateClipById_request_data_H

#include <QJsonObject>

#include "OAIUpdateClipById_request_data_attributes.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateClipById_request_data_attributes;

class OAIUpdateClipById_request_data : public OAIObject {
public:
    OAIUpdateClipById_request_data();
    OAIUpdateClipById_request_data(QString json);
    ~OAIUpdateClipById_request_data() override;
    ...
    OAIUpdateClipById_request_data_attributes getAttributes() const;
    void setAttributes(const OAIUpdateClipById_request_data_attributes &attributes);
...
private:
    ...
    OAIUpdateClipById_request_data_attributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateClipById_request_data)

#endif // OAIUpdateClipById_request_data_H
