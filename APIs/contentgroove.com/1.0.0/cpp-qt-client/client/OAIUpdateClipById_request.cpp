...
OAIUpdateClipById_request::OAIUpdateClipById_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateClipById_request::OAIUpdateClipById_request() {
    this->initializeModel();
}

OAIUpdateClipById_request::~OAIUpdateClipById_request() {}

void OAIUpdateClipById_request::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIUpdateClipById_request::fromJson(QString jsonString) {
...
void OAIUpdateClipById_request::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIUpdateClipById_request::asJson() const {
...
QJsonObject OAIUpdateClipById_request::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIUpdateClipById_request_data OAIUpdateClipById_request::getData() const {
    return m_data;
}
void OAIUpdateClipById_request::setData(const OAIUpdateClipById_request_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIUpdateClipById_request::is_data_Set() const{
    return m_data_isSet;
}

bool OAIUpdateClipById_request::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIUpdateClipById_request::isSet() const {
...
bool OAIUpdateClipById_request::isValid() const {
