...
#include "OAI_medias_post_request_payload_included_inner_oneOf.h"
...
OAI_medias_post_request_payload_included_inner_oneOf::OAI_medias_post_request_payload_included_inner_oneOf(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_medias_post_request_payload_included_inner_oneOf::OAI_medias_post_request_payload_included_inner_oneOf() {
    this->initializeModel();
}

OAI_medias_post_request_payload_included_inner_oneOf::~OAI_medias_post_request_payload_included_inner_oneOf() {}

void OAI_medias_post_request_payload_included_inner_oneOf::initializeModel() {
...
void OAI_medias_post_request_payload_included_inner_oneOf::fromJson(QString jsonString) {
...
void OAI_medias_post_request_payload_included_inner_oneOf::fromJsonObject(QJsonObject json) {
...
QString OAI_medias_post_request_payload_included_inner_oneOf::asJson() const {
...
QJsonObject OAI_medias_post_request_payload_included_inner_oneOf::asJsonObject() const {
    QJsonObject obj;
...
OAI_medias_post_request_payload_included_inner_oneOf_attributes OAI_medias_post_request_payload_included_inner_oneOf::getAttributes() const {
    return m_attributes;
}
void OAI_medias_post_request_payload_included_inner_oneOf::setAttributes(const OAI_medias_post_request_payload_included_inner_oneOf_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner_oneOf::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAI_medias_post_request_payload_included_inner_oneOf::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAI_medias_post_request_payload_included_inner_oneOf::getId() const {
    return m_id;
}
void OAI_medias_post_request_payload_included_inner_oneOf::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner_oneOf::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_medias_post_request_payload_included_inner_oneOf::is_id_Valid() const{
    return m_id_isValid;
}

OAI_medias_post_request_payload_included_inner_oneOf_relationships OAI_medias_post_request_payload_included_inner_oneOf::getRelationships() const {
    return m_relationships;
}
void OAI_medias_post_request_payload_included_inner_oneOf::setRelationships(const OAI_medias_post_request_payload_included_inner_oneOf_relationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner_oneOf::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAI_medias_post_request_payload_included_inner_oneOf::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAI_medias_post_request_payload_included_inner_oneOf::getType() const {
    return m_type;
}
void OAI_medias_post_request_payload_included_inner_oneOf::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner_oneOf::is_type_Set() const{
    return m_type_isSet;
}

bool OAI_medias_post_request_payload_included_inner_oneOf::is_type_Valid() const{
    return m_type_isValid;
}

bool OAI_medias_post_request_payload_included_inner_oneOf::isSet() const {
...
bool OAI_medias_post_request_payload_included_inner_oneOf::isValid() const {
