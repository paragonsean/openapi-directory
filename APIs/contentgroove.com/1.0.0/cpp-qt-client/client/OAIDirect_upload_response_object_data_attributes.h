...
/*
 * OAIDirect_upload_response_object_data_attributes.h
 *
 * 
 */

#ifndef OAIDirect_upload_response_object_data_attributes_H
#define OAIDirect_upload_response_object_data_attributes_H
...
class OAIDirect_upload_response_object_data_attributes : public OAIObject {
public:
    OAIDirect_upload_response_object_data_attributes();
    OAIDirect_upload_response_object_data_attributes(QString json);
    ~OAIDirect_upload_response_object_data_attributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDirect_upload_response_object_data_attributes)

#endif // OAIDirect_upload_response_object_data_attributes_H
