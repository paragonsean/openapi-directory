...
OAICreateMedia_request_data::OAICreateMedia_request_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMedia_request_data::OAICreateMedia_request_data() {
    this->initializeModel();
}

OAICreateMedia_request_data::~OAICreateMedia_request_data() {}

void OAICreateMedia_request_data::initializeModel() {

    m_attributes_isSet = false;
    m_attributes_isValid = false;
}

void OAICreateMedia_request_data::fromJson(QString jsonString) {
...
void OAICreateMedia_request_data::fromJsonObject(QJsonObject json) {

    m_attributes_isValid = ::OpenAPI::fromJsonValue(m_attributes, json[QString("attributes")]);
    m_attributes_isSet = !json[QString("attributes")].isNull() && m_attributes_isValid;
}

QString OAICreateMedia_request_data::asJson() const {
...
QJsonObject OAICreateMedia_request_data::asJsonObject() const {
    QJsonObject obj;
...
OAICreateMedia_request_data_attributes OAICreateMedia_request_data::getAttributes() const {
    return m_attributes;
}
void OAICreateMedia_request_data::setAttributes(const OAICreateMedia_request_data_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAICreateMedia_request_data::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAICreateMedia_request_data::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAICreateMedia_request_data::isSet() const {
...
bool OAICreateMedia_request_data::isValid() const {
