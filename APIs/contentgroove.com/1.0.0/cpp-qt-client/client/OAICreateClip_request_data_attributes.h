...
/*
 * OAICreateClip_request_data_attributes.h
 *
 * 
 */

#ifndef OAICreateClip_request_data_attributes_H
#define OAICreateClip_request_data_attributes_H
...
class OAICreateClip_request_data_attributes : public OAIObject {
public:
    OAICreateClip_request_data_attributes();
    OAICreateClip_request_data_attributes(QString json);
    ~OAICreateClip_request_data_attributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateClip_request_data_attributes)

#endif // OAICreateClip_request_data_attributes_H
