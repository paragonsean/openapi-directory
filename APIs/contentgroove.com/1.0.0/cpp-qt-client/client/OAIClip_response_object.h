...
/*
 * OAIClip_response_object.h
 *
 * 
 */

#ifndef OAIClip_response_object_H
#define OAIClip_response_object_H
...
class OAIClip_response_object : public OAIObject {
public:
    OAIClip_response_object();
    OAIClip_response_object(QString json);
    ~OAIClip_response_object() override;
    ...
    OAIClip_response_object_data getData() const;
    void setData(const OAIClip_response_object_data &data);
...
private:
    ...
    OAIClip_response_object_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClip_response_object)

#endif // OAIClip_response_object_H
