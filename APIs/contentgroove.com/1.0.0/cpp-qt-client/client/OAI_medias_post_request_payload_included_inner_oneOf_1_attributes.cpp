...
OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::OAI_medias_post_request_payload_included_inner_oneOf_1_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::OAI_medias_post_request_payload_included_inner_oneOf_1_attributes() {
    this->initializeModel();
}

OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::~OAI_medias_post_request_payload_included_inner_oneOf_1_attributes() {}

void OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::initializeModel() {

    m_text_isSet = false;
    m_text_isValid = false;
}

void OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::fromJson(QString jsonString) {
...
void OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::fromJsonObject(QJsonObject json) {

    m_text_isValid = ::OpenAPI::fromJsonValue(m_text, json[QString("text")]);
    m_text_isSet = !json[QString("text")].isNull() && m_text_isValid;
}

QString OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::asJson() const {
...
QJsonObject OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::asJsonObject() const {
    QJsonObject obj;
    if (m_text_isSet) {
...
QString OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::getText() const {
    return m_text;
}
void OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::is_text_Set() const{
    return m_text_isSet;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::is_text_Valid() const{
    return m_text_isValid;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::isSet() const {
...
bool OAI_medias_post_request_payload_included_inner_oneOf_1_attributes::isValid() const {
