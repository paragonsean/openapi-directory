...
OAI_medias_post_request_payload_data_relationships::OAI_medias_post_request_payload_data_relationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_medias_post_request_payload_data_relationships::OAI_medias_post_request_payload_data_relationships() {
    this->initializeModel();
}

OAI_medias_post_request_payload_data_relationships::~OAI_medias_post_request_payload_data_relationships() {}

void OAI_medias_post_request_payload_data_relationships::initializeModel() {

    m_clips_isSet = false;
    m_clips_isValid = false;
}

void OAI_medias_post_request_payload_data_relationships::fromJson(QString jsonString) {
...
void OAI_medias_post_request_payload_data_relationships::fromJsonObject(QJsonObject json) {

    m_clips_isValid = ::OpenAPI::fromJsonValue(m_clips, json[QString("clips")]);
    m_clips_isSet = !json[QString("clips")].isNull() && m_clips_isValid;
}

QString OAI_medias_post_request_payload_data_relationships::asJson() const {
...
QJsonObject OAI_medias_post_request_payload_data_relationships::asJsonObject() const {
    QJsonObject obj;
    if (m_clips.isSet()) {
...
OAI_medias_post_request_payload_data_relationships_clips OAI_medias_post_request_payload_data_relationships::getClips() const {
    return m_clips;
}
void OAI_medias_post_request_payload_data_relationships::setClips(const OAI_medias_post_request_payload_data_relationships_clips &clips) {
    m_clips = clips;
    m_clips_isSet = true;
}

bool OAI_medias_post_request_payload_data_relationships::is_clips_Set() const{
    return m_clips_isSet;
}

bool OAI_medias_post_request_payload_data_relationships::is_clips_Valid() const{
    return m_clips_isValid;
}

bool OAI_medias_post_request_payload_data_relationships::isSet() const {
...
bool OAI_medias_post_request_payload_data_relationships::isValid() const {
