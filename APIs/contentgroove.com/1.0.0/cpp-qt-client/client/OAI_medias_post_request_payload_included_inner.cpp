...
#include "OAI_medias_post_request_payload_included_inner.h"
...
OAI_medias_post_request_payload_included_inner::OAI_medias_post_request_payload_included_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_medias_post_request_payload_included_inner::OAI_medias_post_request_payload_included_inner() {
    this->initializeModel();
}

OAI_medias_post_request_payload_included_inner::~OAI_medias_post_request_payload_included_inner() {}

void OAI_medias_post_request_payload_included_inner::initializeModel() {
...
void OAI_medias_post_request_payload_included_inner::fromJson(QString jsonString) {
...
void OAI_medias_post_request_payload_included_inner::fromJsonObject(QJsonObject json) {
...
QString OAI_medias_post_request_payload_included_inner::asJson() const {
...
QJsonObject OAI_medias_post_request_payload_included_inner::asJsonObject() const {
    QJsonObject obj;
...
OAI_medias_post_request_payload_included_inner_oneOf_1_attributes OAI_medias_post_request_payload_included_inner::getAttributes() const {
    return m_attributes;
}
void OAI_medias_post_request_payload_included_inner::setAttributes(const OAI_medias_post_request_payload_included_inner_oneOf_1_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAI_medias_post_request_payload_included_inner::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAI_medias_post_request_payload_included_inner::getId() const {
    return m_id;
}
void OAI_medias_post_request_payload_included_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_medias_post_request_payload_included_inner::is_id_Valid() const{
    return m_id_isValid;
}

OAIObject OAI_medias_post_request_payload_included_inner::getRelationships() const {
    return m_relationships;
}
void OAI_medias_post_request_payload_included_inner::setRelationships(const OAIObject &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAI_medias_post_request_payload_included_inner::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAI_medias_post_request_payload_included_inner::getType() const {
    return m_type;
}
void OAI_medias_post_request_payload_included_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAI_medias_post_request_payload_included_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAI_medias_post_request_payload_included_inner::isSet() const {
...
bool OAI_medias_post_request_payload_included_inner::isValid() const {
