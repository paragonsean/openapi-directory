...
/*
 * OAIClips_response_object.h
 *
 * 
 */

#ifndef OAIClips_response_object_H
#define OAIClips_response_object_H

#include <QJsonObject>

#include "OAIClip_response_object_data.h"
...
namespace OpenAPI {
class OAIClip_response_object_data;
class OAILinks_object_data;

class OAIClips_response_object : public OAIObject {
public:
    OAIClips_response_object();
    OAIClips_response_object(QString json);
    ~OAIClips_response_object() override;
    ...
    QList<OAIClip_response_object_data> getData() const;
    void setData(const QList<OAIClip_response_object_data> &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAILinks_object_data getLinks() const;
    void setLinks(const OAILinks_object_data &links);
...
private:
    ...
    QList<OAIClip_response_object_data> m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAILinks_object_data m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClips_response_object)

#endif // OAIClips_response_object_H
