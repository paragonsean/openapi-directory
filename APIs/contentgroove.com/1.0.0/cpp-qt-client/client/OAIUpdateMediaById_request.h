...
/*
 * OAIUpdateMediaById_request.h
 *
 * 
 */

#ifndef OAIUpdateMediaById_request_H
#define OAIUpdateMediaById_request_H
...
namespace OpenAPI {
class OAIUpdateMediaById_request_data;

class OAIUpdateMediaById_request : public OAIObject {
public:
    OAIUpdateMediaById_request();
    OAIUpdateMediaById_request(QString json);
    ~OAIUpdateMediaById_request() override;
    ...
    OAIUpdateMediaById_request_data getData() const;
    void setData(const OAIUpdateMediaById_request_data &data);
...
private:
    ...
    OAIUpdateMediaById_request_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMediaById_request)

#endif // OAIUpdateMediaById_request_H
