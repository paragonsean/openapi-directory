...
OAICreateClip_request_data::OAICreateClip_request_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateClip_request_data::OAICreateClip_request_data() {
    this->initializeModel();
}

OAICreateClip_request_data::~OAICreateClip_request_data() {}

void OAICreateClip_request_data::initializeModel() {

    m_attributes_isSet = false;
    m_attributes_isValid = false;
}

void OAICreateClip_request_data::fromJson(QString jsonString) {
...
void OAICreateClip_request_data::fromJsonObject(QJsonObject json) {

    m_attributes_isValid = ::OpenAPI::fromJsonValue(m_attributes, json[QString("attributes")]);
    m_attributes_isSet = !json[QString("attributes")].isNull() && m_attributes_isValid;
}

QString OAICreateClip_request_data::asJson() const {
...
QJsonObject OAICreateClip_request_data::asJsonObject() const {
    QJsonObject obj;
...
OAICreateClip_request_data_attributes OAICreateClip_request_data::getAttributes() const {
    return m_attributes;
}
void OAICreateClip_request_data::setAttributes(const OAICreateClip_request_data_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAICreateClip_request_data::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAICreateClip_request_data::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAICreateClip_request_data::isSet() const {
...
bool OAICreateClip_request_data::isValid() const {
