...
/*
 * OAI_medias_post_request_payload_data.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_data_H
#define OAI_medias_post_request_payload_data_H

#include <QJsonObject>

#include "OAI_medias_post_request_payload_data_attributes.h"
#include "OAI_medias_post_request_payload_data_relationships.h"
...
namespace OpenAPI {
class OAI_medias_post_request_payload_data_attributes;
class OAI_medias_post_request_payload_data_relationships;
class OAI_medias_post_request_payload_data_transcription;

class OAI_medias_post_request_payload_data : public OAIObject {
public:
    OAI_medias_post_request_payload_data();
    OAI_medias_post_request_payload_data(QString json);
    ~OAI_medias_post_request_payload_data() override;
    ...
    OAI_medias_post_request_payload_data_attributes getAttributes() const;
    void setAttributes(const OAI_medias_post_request_payload_data_attributes &attributes);
    ...
    OAI_medias_post_request_payload_data_relationships getRelationships() const;
    void setRelationships(const OAI_medias_post_request_payload_data_relationships &relationships);
    bool is_relationships_Set() const;
    bool is_relationships_Valid() const;

    OAI_medias_post_request_payload_data_transcription getTranscription() const;
    void setTranscription(const OAI_medias_post_request_payload_data_transcription &transcription);
...
private:
    ...
    OAI_medias_post_request_payload_data_attributes m_attributes;
    ...
    OAI_medias_post_request_payload_data_relationships m_relationships;
    bool m_relationships_isSet;
    bool m_relationships_isValid;

    OAI_medias_post_request_payload_data_transcription m_transcription;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_data)

#endif // OAI_medias_post_request_payload_data_H
