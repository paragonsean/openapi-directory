...
OAIWebhook_subscription_response_object_data::OAIWebhook_subscription_response_object_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWebhook_subscription_response_object_data::OAIWebhook_subscription_response_object_data() {
    this->initializeModel();
}

OAIWebhook_subscription_response_object_data::~OAIWebhook_subscription_response_object_data() {}

void OAIWebhook_subscription_response_object_data::initializeModel() {
...
void OAIWebhook_subscription_response_object_data::fromJson(QString jsonString) {
...
void OAIWebhook_subscription_response_object_data::fromJsonObject(QJsonObject json) {
...
QString OAIWebhook_subscription_response_object_data::asJson() const {
...
QJsonObject OAIWebhook_subscription_response_object_data::asJsonObject() const {
    QJsonObject obj;
...
OAIWebhook_subscription_response_object_data_attributes OAIWebhook_subscription_response_object_data::getAttributes() const {
    return m_attributes;
}
void OAIWebhook_subscription_response_object_data::setAttributes(const OAIWebhook_subscription_response_object_data_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIWebhook_subscription_response_object_data::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIWebhook_subscription_response_object_data::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIWebhook_subscription_response_object_data::getId() const {
    return m_id;
}
void OAIWebhook_subscription_response_object_data::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIWebhook_subscription_response_object_data::is_id_Set() const{
    return m_id_isSet;
}

bool OAIWebhook_subscription_response_object_data::is_id_Valid() const{
    return m_id_isValid;
}

OAIWebhook_subscription_response_object_data_relationships OAIWebhook_subscription_response_object_data::getRelationships() const {
    return m_relationships;
}
void OAIWebhook_subscription_response_object_data::setRelationships(const OAIWebhook_subscription_response_object_data_relationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIWebhook_subscription_response_object_data::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIWebhook_subscription_response_object_data::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAIWebhook_subscription_response_object_data::getType() const {
    return m_type;
}
void OAIWebhook_subscription_response_object_data::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIWebhook_subscription_response_object_data::is_type_Set() const{
    return m_type_isSet;
}

bool OAIWebhook_subscription_response_object_data::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIWebhook_subscription_response_object_data::isSet() const {
...
bool OAIWebhook_subscription_response_object_data::isValid() const {
