...
/*
 * OAIClip_response_object_data_relationships_media.h
 *
 * 
 */

#ifndef OAIClip_response_object_data_relationships_media_H
#define OAIClip_response_object_data_relationships_media_H
...
class OAIClip_response_object_data_relationships_media : public OAIObject {
public:
    OAIClip_response_object_data_relationships_media();
    OAIClip_response_object_data_relationships_media(QString json);
    ~OAIClip_response_object_data_relationships_media() override;
    ...
    OAIClip_response_object_data_relationships_media_data getData() const;
    void setData(const OAIClip_response_object_data_relationships_media_data &data);
...
private:
    ...
    OAIClip_response_object_data_relationships_media_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIClip_response_object_data_relationships_media)

#endif // OAIClip_response_object_data_relationships_media_H
