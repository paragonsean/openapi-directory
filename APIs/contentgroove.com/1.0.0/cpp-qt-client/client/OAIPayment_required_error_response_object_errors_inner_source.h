...
/*
 * OAIPayment_required_error_response_object_errors_inner_source.h
 *
 * 
 */

#ifndef OAIPayment_required_error_response_object_errors_inner_source_H
#define OAIPayment_required_error_response_object_errors_inner_source_H
...
class OAIPayment_required_error_response_object_errors_inner_source : public OAIObject {
public:
    OAIPayment_required_error_response_object_errors_inner_source();
    OAIPayment_required_error_response_object_errors_inner_source(QString json);
    ~OAIPayment_required_error_response_object_errors_inner_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayment_required_error_response_object_errors_inner_source)

#endif // OAIPayment_required_error_response_object_errors_inner_source_H
