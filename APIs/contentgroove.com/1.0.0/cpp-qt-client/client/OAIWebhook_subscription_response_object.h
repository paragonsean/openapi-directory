...
/*
 * OAIWebhook_subscription_response_object.h
 *
 * 
 */

#ifndef OAIWebhook_subscription_response_object_H
#define OAIWebhook_subscription_response_object_H

#include <QJsonObject>

#include "OAILinks_object_data.h"
#include "OAIWebhook_subscription_response_object_data.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIWebhook_subscription_response_object_data;
class OAILinks_object_data;

class OAIWebhook_subscription_response_object : public OAIObject {
public:
    OAIWebhook_subscription_response_object();
    OAIWebhook_subscription_response_object(QString json);
    ~OAIWebhook_subscription_response_object() override;
    ...
    OAIWebhook_subscription_response_object_data getData() const;
    void setData(const OAIWebhook_subscription_response_object_data &data);
...
private:
    ...
    OAIWebhook_subscription_response_object_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhook_subscription_response_object)

#endif // OAIWebhook_subscription_response_object_H
