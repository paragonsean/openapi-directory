...
/*
 * OAIUpdateMediaById_request_data.h
 *
 * 
 */

#ifndef OAIUpdateMediaById_request_data_H
#define OAIUpdateMediaById_request_data_H

#include <QJsonObject>

#include "OAIUpdateMediaById_request_data_attributes.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateMediaById_request_data_attributes;

class OAIUpdateMediaById_request_data : public OAIObject {
public:
    OAIUpdateMediaById_request_data();
    OAIUpdateMediaById_request_data(QString json);
    ~OAIUpdateMediaById_request_data() override;
    ...
    OAIUpdateMediaById_request_data_attributes getAttributes() const;
    void setAttributes(const OAIUpdateMediaById_request_data_attributes &attributes);
...
private:
    ...
    OAIUpdateMediaById_request_data_attributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMediaById_request_data)

#endif // OAIUpdateMediaById_request_data_H
