...
OAIClip_response_object_data::OAIClip_response_object_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClip_response_object_data::OAIClip_response_object_data() {
    this->initializeModel();
}

OAIClip_response_object_data::~OAIClip_response_object_data() {}

void OAIClip_response_object_data::initializeModel() {
...
void OAIClip_response_object_data::fromJson(QString jsonString) {
...
void OAIClip_response_object_data::fromJsonObject(QJsonObject json) {
...
QString OAIClip_response_object_data::asJson() const {
...
QJsonObject OAIClip_response_object_data::asJsonObject() const {
    QJsonObject obj;
...
OAIClip_response_object_data_attributes OAIClip_response_object_data::getAttributes() const {
    return m_attributes;
}
void OAIClip_response_object_data::setAttributes(const OAIClip_response_object_data_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIClip_response_object_data::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIClip_response_object_data::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIClip_response_object_data::getId() const {
    return m_id;
}
void OAIClip_response_object_data::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIClip_response_object_data::is_id_Set() const{
    return m_id_isSet;
}

bool OAIClip_response_object_data::is_id_Valid() const{
    return m_id_isValid;
}

OAIClip_response_object_data_relationships OAIClip_response_object_data::getRelationships() const {
    return m_relationships;
}
void OAIClip_response_object_data::setRelationships(const OAIClip_response_object_data_relationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIClip_response_object_data::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIClip_response_object_data::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAIClip_response_object_data::getType() const {
    return m_type;
}
void OAIClip_response_object_data::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIClip_response_object_data::is_type_Set() const{
    return m_type_isSet;
}

bool OAIClip_response_object_data::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIClip_response_object_data::isSet() const {
...
bool OAIClip_response_object_data::isValid() const {
