...
OAIClips_response_object::OAIClips_response_object(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClips_response_object::OAIClips_response_object() {
    this->initializeModel();
}

OAIClips_response_object::~OAIClips_response_object() {}

void OAIClips_response_object::initializeModel() {
...
void OAIClips_response_object::fromJson(QString jsonString) {
...
void OAIClips_response_object::fromJsonObject(QJsonObject json) {
...
QString OAIClips_response_object::asJson() const {
...
QJsonObject OAIClips_response_object::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIClip_response_object_data> OAIClips_response_object::getData() const {
    return m_data;
}
void OAIClips_response_object::setData(const QList<OAIClip_response_object_data> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIClips_response_object::is_data_Set() const{
    return m_data_isSet;
}

bool OAIClips_response_object::is_data_Valid() const{
    return m_data_isValid;
}

OAILinks_object_data OAIClips_response_object::getLinks() const {
    return m_links;
}
void OAIClips_response_object::setLinks(const OAILinks_object_data &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIClips_response_object::is_links_Set() const{
    return m_links_isSet;
}

bool OAIClips_response_object::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIClips_response_object::isSet() const {
...
bool OAIClips_response_object::isValid() const {
