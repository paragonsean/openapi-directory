...
#include "OAI_medias_post_request_payload_data_relationships_clips_data_inner.h"
...
OAI_medias_post_request_payload_data_relationships_clips_data_inner::OAI_medias_post_request_payload_data_relationships_clips_data_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_medias_post_request_payload_data_relationships_clips_data_inner::OAI_medias_post_request_payload_data_relationships_clips_data_inner() {
    this->initializeModel();
}

OAI_medias_post_request_payload_data_relationships_clips_data_inner::~OAI_medias_post_request_payload_data_relationships_clips_data_inner() {}

void OAI_medias_post_request_payload_data_relationships_clips_data_inner::initializeModel() {
...
void OAI_medias_post_request_payload_data_relationships_clips_data_inner::fromJson(QString jsonString) {
...
void OAI_medias_post_request_payload_data_relationships_clips_data_inner::fromJsonObject(QJsonObject json) {
...
QString OAI_medias_post_request_payload_data_relationships_clips_data_inner::asJson() const {
...
QJsonObject OAI_medias_post_request_payload_data_relationships_clips_data_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAI_medias_post_request_payload_data_relationships_clips_data_inner::getId() const {
    return m_id;
}
void OAI_medias_post_request_payload_data_relationships_clips_data_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_medias_post_request_payload_data_relationships_clips_data_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_medias_post_request_payload_data_relationships_clips_data_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAI_medias_post_request_payload_data_relationships_clips_data_inner::getType() const {
    return m_type;
}
void OAI_medias_post_request_payload_data_relationships_clips_data_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAI_medias_post_request_payload_data_relationships_clips_data_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAI_medias_post_request_payload_data_relationships_clips_data_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAI_medias_post_request_payload_data_relationships_clips_data_inner::isSet() const {
...
bool OAI_medias_post_request_payload_data_relationships_clips_data_inner::isValid() const {
