...
/*
 * OAICreateWebhookSubscription_request_data.h
 *
 * 
 */

#ifndef OAICreateWebhookSubscription_request_data_H
#define OAICreateWebhookSubscription_request_data_H
...
namespace OpenAPI {
class OAICreateWebhookSubscription_request_data_attributes;

class OAICreateWebhookSubscription_request_data : public OAIObject {
public:
    OAICreateWebhookSubscription_request_data();
    OAICreateWebhookSubscription_request_data(QString json);
    ~OAICreateWebhookSubscription_request_data() override;
    ...
    OAICreateWebhookSubscription_request_data_attributes getAttributes() const;
    void setAttributes(const OAICreateWebhookSubscription_request_data_attributes &attributes);
...
private:
    ...
    OAICreateWebhookSubscription_request_data_attributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWebhookSubscription_request_data)

#endif // OAICreateWebhookSubscription_request_data_H
