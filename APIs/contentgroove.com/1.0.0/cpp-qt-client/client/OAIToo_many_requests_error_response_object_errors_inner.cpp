...
OAIToo_many_requests_error_response_object_errors_inner::OAIToo_many_requests_error_response_object_errors_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIToo_many_requests_error_response_object_errors_inner::OAIToo_many_requests_error_response_object_errors_inner() {
    this->initializeModel();
}

OAIToo_many_requests_error_response_object_errors_inner::~OAIToo_many_requests_error_response_object_errors_inner() {}

void OAIToo_many_requests_error_response_object_errors_inner::initializeModel() {
...
void OAIToo_many_requests_error_response_object_errors_inner::fromJson(QString jsonString) {
...
void OAIToo_many_requests_error_response_object_errors_inner::fromJsonObject(QJsonObject json) {
...
QString OAIToo_many_requests_error_response_object_errors_inner::asJson() const {
...
QJsonObject OAIToo_many_requests_error_response_object_errors_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_detail_isSet) {
...
QString OAIToo_many_requests_error_response_object_errors_inner::getDetail() const {
    return m_detail;
}
void OAIToo_many_requests_error_response_object_errors_inner::setDetail(const QString &detail) {
    m_detail = detail;
    m_detail_isSet = true;
}

bool OAIToo_many_requests_error_response_object_errors_inner::is_detail_Set() const{
    return m_detail_isSet;
}

bool OAIToo_many_requests_error_response_object_errors_inner::is_detail_Valid() const{
    return m_detail_isValid;
}

QString OAIToo_many_requests_error_response_object_errors_inner::getStatus() const {
    return m_status;
}
void OAIToo_many_requests_error_response_object_errors_inner::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIToo_many_requests_error_response_object_errors_inner::is_status_Set() const{
    return m_status_isSet;
}

bool OAIToo_many_requests_error_response_object_errors_inner::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIToo_many_requests_error_response_object_errors_inner::getTitle() const {
    return m_title;
}
void OAIToo_many_requests_error_response_object_errors_inner::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIToo_many_requests_error_response_object_errors_inner::is_title_Set() const{
    return m_title_isSet;
}

bool OAIToo_many_requests_error_response_object_errors_inner::is_title_Valid() const{
    return m_title_isValid;
}

bool OAIToo_many_requests_error_response_object_errors_inner::isSet() const {
...
bool OAIToo_many_requests_error_response_object_errors_inner::isValid() const {
