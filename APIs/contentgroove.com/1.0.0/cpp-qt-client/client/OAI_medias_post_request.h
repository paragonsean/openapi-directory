...
/*
 * OAI_medias_post_request.h
 *
 * 
 */

#ifndef OAI_medias_post_request_H
#define OAI_medias_post_request_H
...
namespace OpenAPI {
class OAI_medias_post_request_payload;

class OAI_medias_post_request : public OAIObject {
public:
    OAI_medias_post_request();
    OAI_medias_post_request(QString json);
    ~OAI_medias_post_request() override;
    ...
    OAI_medias_post_request_payload getPayload() const;
    void setPayload(const OAI_medias_post_request_payload &payload);
...
private:
    ...
    OAI_medias_post_request_payload m_payload;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request)

#endif // OAI_medias_post_request_H
