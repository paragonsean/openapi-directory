...
#include "OAIMedia_response_object_data_relationships.h"
...
OAIMedia_response_object_data_relationships::OAIMedia_response_object_data_relationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMedia_response_object_data_relationships::OAIMedia_response_object_data_relationships() {
    this->initializeModel();
}

OAIMedia_response_object_data_relationships::~OAIMedia_response_object_data_relationships() {}

void OAIMedia_response_object_data_relationships::initializeModel() {

    m_clips_isSet = false;
    m_clips_isValid = false;
}

void OAIMedia_response_object_data_relationships::fromJson(QString jsonString) {
...
void OAIMedia_response_object_data_relationships::fromJsonObject(QJsonObject json) {

    m_clips_isValid = ::OpenAPI::fromJsonValue(m_clips, json[QString("clips")]);
    m_clips_isSet = !json[QString("clips")].isNull() && m_clips_isValid;
}

QString OAIMedia_response_object_data_relationships::asJson() const {
...
QJsonObject OAIMedia_response_object_data_relationships::asJsonObject() const {
    QJsonObject obj;
    if (m_clips.isSet()) {
...
OAIMedia_response_object_data_relationships_clips OAIMedia_response_object_data_relationships::getClips() const {
    return m_clips;
}
void OAIMedia_response_object_data_relationships::setClips(const OAIMedia_response_object_data_relationships_clips &clips) {
    m_clips = clips;
    m_clips_isSet = true;
}

bool OAIMedia_response_object_data_relationships::is_clips_Set() const{
    return m_clips_isSet;
}

bool OAIMedia_response_object_data_relationships::is_clips_Valid() const{
    return m_clips_isValid;
}

bool OAIMedia_response_object_data_relationships::isSet() const {
...
bool OAIMedia_response_object_data_relationships::isValid() const {
