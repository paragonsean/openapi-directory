...
/*
 * OAI_medias_post_request_payload_included_inner_oneOf_1_attributes.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_included_inner_oneOf_1_attributes_H
#define OAI_medias_post_request_payload_included_inner_oneOf_1_attributes_H
...
class OAI_medias_post_request_payload_included_inner_oneOf_1_attributes : public OAIObject {
public:
    OAI_medias_post_request_payload_included_inner_oneOf_1_attributes();
    OAI_medias_post_request_payload_included_inner_oneOf_1_attributes(QString json);
    ~OAI_medias_post_request_payload_included_inner_oneOf_1_attributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_included_inner_oneOf_1_attributes)

#endif // OAI_medias_post_request_payload_included_inner_oneOf_1_attributes_H
