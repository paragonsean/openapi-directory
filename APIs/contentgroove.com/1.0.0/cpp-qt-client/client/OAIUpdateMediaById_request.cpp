...
OAIUpdateMediaById_request::OAIUpdateMediaById_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateMediaById_request::OAIUpdateMediaById_request() {
    this->initializeModel();
}

OAIUpdateMediaById_request::~OAIUpdateMediaById_request() {}

void OAIUpdateMediaById_request::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIUpdateMediaById_request::fromJson(QString jsonString) {
...
void OAIUpdateMediaById_request::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIUpdateMediaById_request::asJson() const {
...
QJsonObject OAIUpdateMediaById_request::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIUpdateMediaById_request_data OAIUpdateMediaById_request::getData() const {
    return m_data;
}
void OAIUpdateMediaById_request::setData(const OAIUpdateMediaById_request_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIUpdateMediaById_request::is_data_Set() const{
    return m_data_isSet;
}

bool OAIUpdateMediaById_request::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIUpdateMediaById_request::isSet() const {
...
bool OAIUpdateMediaById_request::isValid() const {
