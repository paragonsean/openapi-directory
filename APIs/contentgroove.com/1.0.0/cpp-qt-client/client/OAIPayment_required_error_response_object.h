...
/*
 * OAIPayment_required_error_response_object.h
 *
 * 
 */

#ifndef OAIPayment_required_error_response_object_H
#define OAIPayment_required_error_response_object_H

#include <QJsonObject>

#include "OAIPayment_required_error_response_object_errors_inner.h"
#include <QList>
...
namespace OpenAPI {
class OAIPayment_required_error_response_object_errors_inner;

class OAIPayment_required_error_response_object : public OAIObject {
public:
    OAIPayment_required_error_response_object();
    OAIPayment_required_error_response_object(QString json);
    ~OAIPayment_required_error_response_object() override;
    ...
    QList<OAIPayment_required_error_response_object_errors_inner> getErrors() const;
    void setErrors(const QList<OAIPayment_required_error_response_object_errors_inner> &errors);
...
private:
    ...
    QList<OAIPayment_required_error_response_object_errors_inner> m_errors;
    bool m_errors_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayment_required_error_response_object)

#endif // OAIPayment_required_error_response_object_H
