...
/*
 * OAIToo_many_requests_error_response_object.h
 *
 * 
 */

#ifndef OAIToo_many_requests_error_response_object_H
#define OAIToo_many_requests_error_response_object_H

#include <QJsonObject>

#include "OAIToo_many_requests_error_response_object_errors_inner.h"
#include <QList>
...
namespace OpenAPI {
class OAIToo_many_requests_error_response_object_errors_inner;

class OAIToo_many_requests_error_response_object : public OAIObject {
public:
    OAIToo_many_requests_error_response_object();
    OAIToo_many_requests_error_response_object(QString json);
    ~OAIToo_many_requests_error_response_object() override;
    ...
    QList<OAIToo_many_requests_error_response_object_errors_inner> getErrors() const;
    void setErrors(const QList<OAIToo_many_requests_error_response_object_errors_inner> &errors);
...
private:
    ...
    QList<OAIToo_many_requests_error_response_object_errors_inner> m_errors;
    bool m_errors_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIToo_many_requests_error_response_object)

#endif // OAIToo_many_requests_error_response_object_H
