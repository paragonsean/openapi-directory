...
/*
 * OAI_medias_post_request_payload_included_inner_oneOf_relationships.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_included_inner_oneOf_relationships_H
#define OAI_medias_post_request_payload_included_inner_oneOf_relationships_H
...
namespace OpenAPI {
class OAI_medias_post_request_payload_included_inner_oneOf_relationships_media;

class OAI_medias_post_request_payload_included_inner_oneOf_relationships : public OAIObject {
public:
    OAI_medias_post_request_payload_included_inner_oneOf_relationships();
    OAI_medias_post_request_payload_included_inner_oneOf_relationships(QString json);
    ~OAI_medias_post_request_payload_included_inner_oneOf_relationships() override;
    ...
    OAI_medias_post_request_payload_included_inner_oneOf_relationships_media getMedia() const;
    void setMedia(const OAI_medias_post_request_payload_included_inner_oneOf_relationships_media &media);
...
private:
    ...
    OAI_medias_post_request_payload_included_inner_oneOf_relationships_media m_media;
    bool m_media_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_included_inner_oneOf_relationships)

#endif // OAI_medias_post_request_payload_included_inner_oneOf_relationships_H
