...
OAIUpdateClipById_request_data_attributes::OAIUpdateClipById_request_data_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateClipById_request_data_attributes::OAIUpdateClipById_request_data_attributes() {
    this->initializeModel();
}

OAIUpdateClipById_request_data_attributes::~OAIUpdateClipById_request_data_attributes() {}

void OAIUpdateClipById_request_data_attributes::initializeModel() {
...
void OAIUpdateClipById_request_data_attributes::fromJson(QString jsonString) {
...
void OAIUpdateClipById_request_data_attributes::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateClipById_request_data_attributes::asJson() const {
...
QJsonObject OAIUpdateClipById_request_data_attributes::asJsonObject() const {
    QJsonObject obj;
    if (m_end_time_isSet) {
...
double OAIUpdateClipById_request_data_attributes::getEndTime() const {
    return m_end_time;
}
void OAIUpdateClipById_request_data_attributes::setEndTime(const double &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIUpdateClipById_request_data_attributes::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIUpdateClipById_request_data_attributes::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QString OAIUpdateClipById_request_data_attributes::getName() const {
    return m_name;
}
void OAIUpdateClipById_request_data_attributes::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateClipById_request_data_attributes::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateClipById_request_data_attributes::is_name_Valid() const{
    return m_name_isValid;
}

double OAIUpdateClipById_request_data_attributes::getStartTime() const {
    return m_start_time;
}
void OAIUpdateClipById_request_data_attributes::setStartTime(const double &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIUpdateClipById_request_data_attributes::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIUpdateClipById_request_data_attributes::is_start_time_Valid() const{
    return m_start_time_isValid;
}

bool OAIUpdateClipById_request_data_attributes::isSet() const {
...
bool OAIUpdateClipById_request_data_attributes::isValid() const {
