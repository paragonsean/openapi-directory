...
OAIWebhook_subscription_response_object::OAIWebhook_subscription_response_object(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWebhook_subscription_response_object::OAIWebhook_subscription_response_object() {
    this->initializeModel();
}

OAIWebhook_subscription_response_object::~OAIWebhook_subscription_response_object() {}

void OAIWebhook_subscription_response_object::initializeModel() {
...
void OAIWebhook_subscription_response_object::fromJson(QString jsonString) {
...
void OAIWebhook_subscription_response_object::fromJsonObject(QJsonObject json) {
...
QString OAIWebhook_subscription_response_object::asJson() const {
...
QJsonObject OAIWebhook_subscription_response_object::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIWebhook_subscription_response_object_data OAIWebhook_subscription_response_object::getData() const {
    return m_data;
}
void OAIWebhook_subscription_response_object::setData(const OAIWebhook_subscription_response_object_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIWebhook_subscription_response_object::is_data_Set() const{
    return m_data_isSet;
}

bool OAIWebhook_subscription_response_object::is_data_Valid() const{
    return m_data_isValid;
}

OAILinks_object_data OAIWebhook_subscription_response_object::getLinks() const {
    return m_links;
}
void OAIWebhook_subscription_response_object::setLinks(const OAILinks_object_data &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIWebhook_subscription_response_object::is_links_Set() const{
    return m_links_isSet;
}

bool OAIWebhook_subscription_response_object::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIWebhook_subscription_response_object::isSet() const {
...
bool OAIWebhook_subscription_response_object::isValid() const {
