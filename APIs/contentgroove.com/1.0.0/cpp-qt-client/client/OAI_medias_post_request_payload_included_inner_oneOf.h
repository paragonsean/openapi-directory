...
/*
 * OAI_medias_post_request_payload_included_inner_oneOf.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_included_inner_oneOf_H
#define OAI_medias_post_request_payload_included_inner_oneOf_H
...
namespace OpenAPI {
class OAI_medias_post_request_payload_included_inner_oneOf_attributes;
class OAI_medias_post_request_payload_included_inner_oneOf_relationships;

class OAI_medias_post_request_payload_included_inner_oneOf : public OAIObject {
public:
    OAI_medias_post_request_payload_included_inner_oneOf();
    OAI_medias_post_request_payload_included_inner_oneOf(QString json);
    ~OAI_medias_post_request_payload_included_inner_oneOf() override;
    ...
    OAI_medias_post_request_payload_included_inner_oneOf_attributes getAttributes() const;
    void setAttributes(const OAI_medias_post_request_payload_included_inner_oneOf_attributes &attributes);
    ...
    OAI_medias_post_request_payload_included_inner_oneOf_relationships getRelationships() const;
    void setRelationships(const OAI_medias_post_request_payload_included_inner_oneOf_relationships &relationships);
...
private:
    ...
    OAI_medias_post_request_payload_included_inner_oneOf_attributes m_attributes;
    ...
    OAI_medias_post_request_payload_included_inner_oneOf_relationships m_relationships;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_included_inner_oneOf)

#endif // OAI_medias_post_request_payload_included_inner_oneOf_H
