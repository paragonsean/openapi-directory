...
OAIClip_response_object_data_attributes::OAIClip_response_object_data_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClip_response_object_data_attributes::OAIClip_response_object_data_attributes() {
    this->initializeModel();
}

OAIClip_response_object_data_attributes::~OAIClip_response_object_data_attributes() {}

void OAIClip_response_object_data_attributes::initializeModel() {
    ...
    m_media_file_content_duration_isSet = false;
    m_media_file_content_duration_isValid = false;
...
void OAIClip_response_object_data_attributes::fromJson(QString jsonString) {
...
void OAIClip_response_object_data_attributes::fromJsonObject(QJsonObject json) {
    ...
    m_media_file_content_duration_isValid = ::OpenAPI::fromJsonValue(m_media_file_content_duration, json[QString("media_file_content_duration")]);
    m_media_file_content_duration_isSet = !json[QString("media_file_content_duration")].isNull() && m_media_file_content_duration_isValid;
...
QString OAIClip_response_object_data_attributes::asJson() const {
...
QJsonObject OAIClip_response_object_data_attributes::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_media_file_content_duration_isSet) {
        obj.insert(QString("media_file_content_duration"), ::OpenAPI::toJsonValue(m_media_file_content_duration));
    }
...
QString OAIClip_response_object_data_attributes::getCreatedAt() const {
    return m_created_at;
}
void OAIClip_response_object_data_attributes::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIClip_response_object_data_attributes::is_created_at_Valid() const{
    return m_created_at_isValid;
}

qint32 OAIClip_response_object_data_attributes::getEndChar() const {
    return m_end_char;
}
void OAIClip_response_object_data_attributes::setEndChar(const qint32 &end_char) {
    m_end_char = end_char;
    m_end_char_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_end_char_Set() const{
    return m_end_char_isSet;
}

bool OAIClip_response_object_data_attributes::is_end_char_Valid() const{
    return m_end_char_isValid;
}

double OAIClip_response_object_data_attributes::getEndTime() const {
    return m_end_time;
}
void OAIClip_response_object_data_attributes::setEndTime(const double &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIClip_response_object_data_attributes::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QString OAIClip_response_object_data_attributes::getExternalId() const {
    return m_external_id;
}
void OAIClip_response_object_data_attributes::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAIClip_response_object_data_attributes::is_external_id_Valid() const{
    return m_external_id_isValid;
}

bool OAIClip_response_object_data_attributes::isIsProcessing() const {
    return m_is_processing;
}
void OAIClip_response_object_data_attributes::setIsProcessing(const bool &is_processing) {
    m_is_processing = is_processing;
    m_is_processing_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_is_processing_Set() const{
    return m_is_processing_isSet;
}

bool OAIClip_response_object_data_attributes::is_is_processing_Valid() const{
    return m_is_processing_isValid;
}

QString OAIClip_response_object_data_attributes::getMediaFileContentDuration() const {
    return m_media_file_content_duration;
}
void OAIClip_response_object_data_attributes::setMediaFileContentDuration(const QString &media_file_content_duration) {
    m_media_file_content_duration = media_file_content_duration;
    m_media_file_content_duration_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_media_file_content_duration_Set() const{
    return m_media_file_content_duration_isSet;
}

bool OAIClip_response_object_data_attributes::is_media_file_content_duration_Valid() const{
    return m_media_file_content_duration_isValid;
}

QString OAIClip_response_object_data_attributes::getMediaFileContentType() const {
    return m_media_file_content_type;
}
void OAIClip_response_object_data_attributes::setMediaFileContentType(const QString &media_file_content_type) {
    m_media_file_content_type = media_file_content_type;
    m_media_file_content_type_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_media_file_content_type_Set() const{
    return m_media_file_content_type_isSet;
}

bool OAIClip_response_object_data_attributes::is_media_file_content_type_Valid() const{
    return m_media_file_content_type_isValid;
}

QString OAIClip_response_object_data_attributes::getMediaFileHeight() const {
    return m_media_file_height;
}
void OAIClip_response_object_data_attributes::setMediaFileHeight(const QString &media_file_height) {
    m_media_file_height = media_file_height;
    m_media_file_height_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_media_file_height_Set() const{
    return m_media_file_height_isSet;
}

bool OAIClip_response_object_data_attributes::is_media_file_height_Valid() const{
    return m_media_file_height_isValid;
}

QString OAIClip_response_object_data_attributes::getMediaFilePreviewImageUrl() const {
    return m_media_file_preview_image_url;
}
void OAIClip_response_object_data_attributes::setMediaFilePreviewImageUrl(const QString &media_file_preview_image_url) {
    m_media_file_preview_image_url = media_file_preview_image_url;
    m_media_file_preview_image_url_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_media_file_preview_image_url_Set() const{
    return m_media_file_preview_image_url_isSet;
}

bool OAIClip_response_object_data_attributes::is_media_file_preview_image_url_Valid() const{
    return m_media_file_preview_image_url_isValid;
}

QString OAIClip_response_object_data_attributes::getMediaFileUrl() const {
    return m_media_file_url;
}
void OAIClip_response_object_data_attributes::setMediaFileUrl(const QString &media_file_url) {
    m_media_file_url = media_file_url;
    m_media_file_url_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_media_file_url_Set() const{
    return m_media_file_url_isSet;
}

bool OAIClip_response_object_data_attributes::is_media_file_url_Valid() const{
    return m_media_file_url_isValid;
}

QString OAIClip_response_object_data_attributes::getMediaFileWidth() const {
    return m_media_file_width;
}
void OAIClip_response_object_data_attributes::setMediaFileWidth(const QString &media_file_width) {
    m_media_file_width = media_file_width;
    m_media_file_width_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_media_file_width_Set() const{
    return m_media_file_width_isSet;
}

bool OAIClip_response_object_data_attributes::is_media_file_width_Valid() const{
    return m_media_file_width_isValid;
}

QString OAIClip_response_object_data_attributes::getName() const {
    return m_name;
}
void OAIClip_response_object_data_attributes::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_name_Set() const{
    return m_name_isSet;
}

bool OAIClip_response_object_data_attributes::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIClip_response_object_data_attributes::getProcessingStartedAt() const {
    return m_processing_started_at;
}
void OAIClip_response_object_data_attributes::setProcessingStartedAt(const QString &processing_started_at) {
    m_processing_started_at = processing_started_at;
    m_processing_started_at_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_processing_started_at_Set() const{
    return m_processing_started_at_isSet;
}

bool OAIClip_response_object_data_attributes::is_processing_started_at_Valid() const{
    return m_processing_started_at_isValid;
}

qint32 OAIClip_response_object_data_attributes::getRank() const {
    return m_rank;
}
void OAIClip_response_object_data_attributes::setRank(const qint32 &rank) {
    m_rank = rank;
    m_rank_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_rank_Set() const{
    return m_rank_isSet;
}

bool OAIClip_response_object_data_attributes::is_rank_Valid() const{
    return m_rank_isValid;
}

qint32 OAIClip_response_object_data_attributes::getStartChar() const {
    return m_start_char;
}
void OAIClip_response_object_data_attributes::setStartChar(const qint32 &start_char) {
    m_start_char = start_char;
    m_start_char_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_start_char_Set() const{
    return m_start_char_isSet;
}

bool OAIClip_response_object_data_attributes::is_start_char_Valid() const{
    return m_start_char_isValid;
}

double OAIClip_response_object_data_attributes::getStartTime() const {
    return m_start_time;
}
void OAIClip_response_object_data_attributes::setStartTime(const double &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIClip_response_object_data_attributes::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QString OAIClip_response_object_data_attributes::getText() const {
    return m_text;
}
void OAIClip_response_object_data_attributes::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIClip_response_object_data_attributes::is_text_Set() const{
    return m_text_isSet;
}

bool OAIClip_response_object_data_attributes::is_text_Valid() const{
    return m_text_isValid;
}

bool OAIClip_response_object_data_attributes::isSet() const {
...
bool OAIClip_response_object_data_attributes::isValid() const {
