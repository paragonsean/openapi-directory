...
/*
 * OAI_medias_post_request_payload_included_inner_oneOf_relationships_media.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_H
#define OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_H
...
namespace OpenAPI {
class OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data;

class OAI_medias_post_request_payload_included_inner_oneOf_relationships_media : public OAIObject {
public:
    OAI_medias_post_request_payload_included_inner_oneOf_relationships_media();
    OAI_medias_post_request_payload_included_inner_oneOf_relationships_media(QString json);
    ~OAI_medias_post_request_payload_included_inner_oneOf_relationships_media() override;
    ...
    OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data getData() const;
    void setData(const OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data &data);
...
private:
    ...
    OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_included_inner_oneOf_relationships_media)

#endif // OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_H
