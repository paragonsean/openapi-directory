...
/*
 * OAIMedia_response_object_data.h
 *
 * 
 */

#ifndef OAIMedia_response_object_data_H
#define OAIMedia_response_object_data_H
...
namespace OpenAPI {
class OAIMedia_response_object_data_attributes;
class OAIMedia_response_object_data_relationships;

class OAIMedia_response_object_data : public OAIObject {
public:
    OAIMedia_response_object_data();
    OAIMedia_response_object_data(QString json);
    ~OAIMedia_response_object_data() override;
    ...
    OAIMedia_response_object_data_attributes getAttributes() const;
    void setAttributes(const OAIMedia_response_object_data_attributes &attributes);
    ...
    OAIMedia_response_object_data_relationships getRelationships() const;
    void setRelationships(const OAIMedia_response_object_data_relationships &relationships);
...
private:
    ...
    OAIMedia_response_object_data_attributes m_attributes;
    ...
    OAIMedia_response_object_data_relationships m_relationships;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMedia_response_object_data)

#endif // OAIMedia_response_object_data_H
