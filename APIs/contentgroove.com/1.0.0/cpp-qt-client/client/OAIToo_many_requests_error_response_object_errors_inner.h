...
/*
 * OAIToo_many_requests_error_response_object_errors_inner.h
 *
 * 
 */

#ifndef OAIToo_many_requests_error_response_object_errors_inner_H
#define OAIToo_many_requests_error_response_object_errors_inner_H
...
class OAIToo_many_requests_error_response_object_errors_inner : public OAIObject {
public:
    OAIToo_many_requests_error_response_object_errors_inner();
    OAIToo_many_requests_error_response_object_errors_inner(QString json);
    ~OAIToo_many_requests_error_response_object_errors_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIToo_many_requests_error_response_object_errors_inner)

#endif // OAIToo_many_requests_error_response_object_errors_inner_H
