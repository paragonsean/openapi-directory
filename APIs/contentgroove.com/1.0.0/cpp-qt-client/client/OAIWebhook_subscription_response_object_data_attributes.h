...
/*
 * OAIWebhook_subscription_response_object_data_attributes.h
 *
 * 
 */

#ifndef OAIWebhook_subscription_response_object_data_attributes_H
#define OAIWebhook_subscription_response_object_data_attributes_H
...
class OAIWebhook_subscription_response_object_data_attributes : public OAIObject {
public:
    OAIWebhook_subscription_response_object_data_attributes();
    OAIWebhook_subscription_response_object_data_attributes(QString json);
    ~OAIWebhook_subscription_response_object_data_attributes() override;
    ...
    QList<QString> getSubscribedEvents() const;
    void setSubscribedEvents(const QList<QString> &subscribed_events);
    bool is_subscribed_events_Set() const;
    bool is_subscribed_events_Valid() const;
...
private:
    ...
    QList<QString> m_subscribed_events;
    bool m_subscribed_events_isSet;
    bool m_subscribed_events_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhook_subscription_response_object_data_attributes)

#endif // OAIWebhook_subscription_response_object_data_attributes_H
