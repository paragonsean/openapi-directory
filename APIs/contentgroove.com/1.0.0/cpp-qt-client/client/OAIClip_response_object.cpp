...
OAIClip_response_object::OAIClip_response_object(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClip_response_object::OAIClip_response_object() {
    this->initializeModel();
}

OAIClip_response_object::~OAIClip_response_object() {}

void OAIClip_response_object::initializeModel() {
...
void OAIClip_response_object::fromJson(QString jsonString) {
...
void OAIClip_response_object::fromJsonObject(QJsonObject json) {
...
QString OAIClip_response_object::asJson() const {
...
QJsonObject OAIClip_response_object::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIClip_response_object_data OAIClip_response_object::getData() const {
    return m_data;
}
void OAIClip_response_object::setData(const OAIClip_response_object_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIClip_response_object::is_data_Set() const{
    return m_data_isSet;
}

bool OAIClip_response_object::is_data_Valid() const{
    return m_data_isValid;
}

OAILinks_object_data OAIClip_response_object::getLinks() const {
    return m_links;
}
void OAIClip_response_object::setLinks(const OAILinks_object_data &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIClip_response_object::is_links_Set() const{
    return m_links_isSet;
}

bool OAIClip_response_object::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIClip_response_object::isSet() const {
...
bool OAIClip_response_object::isValid() const {
