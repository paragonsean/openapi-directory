...
OAIDirect_upload_response_object::OAIDirect_upload_response_object(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDirect_upload_response_object::OAIDirect_upload_response_object() {
    this->initializeModel();
}

OAIDirect_upload_response_object::~OAIDirect_upload_response_object() {}

void OAIDirect_upload_response_object::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIDirect_upload_response_object::fromJson(QString jsonString) {
...
void OAIDirect_upload_response_object::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIDirect_upload_response_object::asJson() const {
...
QJsonObject OAIDirect_upload_response_object::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIDirect_upload_response_object_data OAIDirect_upload_response_object::getData() const {
    return m_data;
}
void OAIDirect_upload_response_object::setData(const OAIDirect_upload_response_object_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIDirect_upload_response_object::is_data_Set() const{
    return m_data_isSet;
}

bool OAIDirect_upload_response_object::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIDirect_upload_response_object::isSet() const {
...
bool OAIDirect_upload_response_object::isValid() const {
