...
OAICreateMedia_request::OAICreateMedia_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMedia_request::OAICreateMedia_request() {
    this->initializeModel();
}

OAICreateMedia_request::~OAICreateMedia_request() {}

void OAICreateMedia_request::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAICreateMedia_request::fromJson(QString jsonString) {
...
void OAICreateMedia_request::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAICreateMedia_request::asJson() const {
...
QJsonObject OAICreateMedia_request::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAICreateMedia_request_data OAICreateMedia_request::getData() const {
    return m_data;
}
void OAICreateMedia_request::setData(const OAICreateMedia_request_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICreateMedia_request::is_data_Set() const{
    return m_data_isSet;
}

bool OAICreateMedia_request::is_data_Valid() const{
    return m_data_isValid;
}

bool OAICreateMedia_request::isSet() const {
...
bool OAICreateMedia_request::isValid() const {
