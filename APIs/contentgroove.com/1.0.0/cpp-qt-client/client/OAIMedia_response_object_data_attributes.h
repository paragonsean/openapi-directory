...
/*
 * OAIMedia_response_object_data_attributes.h
 *
 * 
 */

#ifndef OAIMedia_response_object_data_attributes_H
#define OAIMedia_response_object_data_attributes_H
...
class OAIMedia_response_object_data_attributes : public OAIObject {
public:
    OAIMedia_response_object_data_attributes();
    OAIMedia_response_object_data_attributes(QString json);
    ~OAIMedia_response_object_data_attributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMedia_response_object_data_attributes)

#endif // OAIMedia_response_object_data_attributes_H
