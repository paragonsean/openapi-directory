...
/*
 * OAI_medias_post_request_payload_data_transcription_data.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_data_transcription_data_H
#define OAI_medias_post_request_payload_data_transcription_data_H
...
class OAI_medias_post_request_payload_data_transcription_data : public OAIObject {
public:
    OAI_medias_post_request_payload_data_transcription_data();
    OAI_medias_post_request_payload_data_transcription_data(QString json);
    ~OAI_medias_post_request_payload_data_transcription_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_data_transcription_data)

#endif // OAI_medias_post_request_payload_data_transcription_data_H
