...
OAIClip_response_object_data_relationships_media_data::OAIClip_response_object_data_relationships_media_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClip_response_object_data_relationships_media_data::OAIClip_response_object_data_relationships_media_data() {
    this->initializeModel();
}

OAIClip_response_object_data_relationships_media_data::~OAIClip_response_object_data_relationships_media_data() {}

void OAIClip_response_object_data_relationships_media_data::initializeModel() {
...
void OAIClip_response_object_data_relationships_media_data::fromJson(QString jsonString) {
...
void OAIClip_response_object_data_relationships_media_data::fromJsonObject(QJsonObject json) {
...
QString OAIClip_response_object_data_relationships_media_data::asJson() const {
...
QJsonObject OAIClip_response_object_data_relationships_media_data::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIClip_response_object_data_relationships_media_data::getId() const {
    return m_id;
}
void OAIClip_response_object_data_relationships_media_data::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIClip_response_object_data_relationships_media_data::is_id_Set() const{
    return m_id_isSet;
}

bool OAIClip_response_object_data_relationships_media_data::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIClip_response_object_data_relationships_media_data::getType() const {
    return m_type;
}
void OAIClip_response_object_data_relationships_media_data::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIClip_response_object_data_relationships_media_data::is_type_Set() const{
    return m_type_isSet;
}

bool OAIClip_response_object_data_relationships_media_data::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIClip_response_object_data_relationships_media_data::isSet() const {
...
bool OAIClip_response_object_data_relationships_media_data::isValid() const {
