...
OAIMedias_response_object::OAIMedias_response_object(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMedias_response_object::OAIMedias_response_object() {
    this->initializeModel();
}

OAIMedias_response_object::~OAIMedias_response_object() {}

void OAIMedias_response_object::initializeModel() {
...
void OAIMedias_response_object::fromJson(QString jsonString) {
...
void OAIMedias_response_object::fromJsonObject(QJsonObject json) {
...
QString OAIMedias_response_object::asJson() const {
...
QJsonObject OAIMedias_response_object::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIMedia_response_object_data> OAIMedias_response_object::getData() const {
    return m_data;
}
void OAIMedias_response_object::setData(const QList<OAIMedia_response_object_data> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIMedias_response_object::is_data_Set() const{
    return m_data_isSet;
}

bool OAIMedias_response_object::is_data_Valid() const{
    return m_data_isValid;
}

OAILinks_object_data OAIMedias_response_object::getLinks() const {
    return m_links;
}
void OAIMedias_response_object::setLinks(const OAILinks_object_data &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIMedias_response_object::is_links_Set() const{
    return m_links_isSet;
}

bool OAIMedias_response_object::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIMedias_response_object::isSet() const {
...
bool OAIMedias_response_object::isValid() const {
