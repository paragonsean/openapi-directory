...
/*
 * OAICreateMedia_request_data_attributes.h
 *
 * 
 */

#ifndef OAICreateMedia_request_data_attributes_H
#define OAICreateMedia_request_data_attributes_H
...
class OAICreateMedia_request_data_attributes : public OAIObject {
public:
    OAICreateMedia_request_data_attributes();
    OAICreateMedia_request_data_attributes(QString json);
    ~OAICreateMedia_request_data_attributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMedia_request_data_attributes)

#endif // OAICreateMedia_request_data_attributes_H
