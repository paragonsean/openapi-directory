...
/*
 * OAI_medias_post_request_payload_data_transcription.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_data_transcription_H
#define OAI_medias_post_request_payload_data_transcription_H
...
namespace OpenAPI {
class OAI_medias_post_request_payload_data_transcription_data;

class OAI_medias_post_request_payload_data_transcription : public OAIObject {
public:
    OAI_medias_post_request_payload_data_transcription();
    OAI_medias_post_request_payload_data_transcription(QString json);
    ~OAI_medias_post_request_payload_data_transcription() override;
    ...
    OAI_medias_post_request_payload_data_transcription_data getData() const;
    void setData(const OAI_medias_post_request_payload_data_transcription_data &data);
...
private:
    ...
    OAI_medias_post_request_payload_data_transcription_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_data_transcription)

#endif // OAI_medias_post_request_payload_data_transcription_H
