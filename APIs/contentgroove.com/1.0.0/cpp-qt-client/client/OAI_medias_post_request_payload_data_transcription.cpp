...
#include "OAI_medias_post_request_payload_data_transcription.h"
...
OAI_medias_post_request_payload_data_transcription::OAI_medias_post_request_payload_data_transcription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_medias_post_request_payload_data_transcription::OAI_medias_post_request_payload_data_transcription() {
    this->initializeModel();
}

OAI_medias_post_request_payload_data_transcription::~OAI_medias_post_request_payload_data_transcription() {}

void OAI_medias_post_request_payload_data_transcription::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAI_medias_post_request_payload_data_transcription::fromJson(QString jsonString) {
...
void OAI_medias_post_request_payload_data_transcription::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAI_medias_post_request_payload_data_transcription::asJson() const {
...
QJsonObject OAI_medias_post_request_payload_data_transcription::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAI_medias_post_request_payload_data_transcription_data OAI_medias_post_request_payload_data_transcription::getData() const {
    return m_data;
}
void OAI_medias_post_request_payload_data_transcription::setData(const OAI_medias_post_request_payload_data_transcription_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAI_medias_post_request_payload_data_transcription::is_data_Set() const{
    return m_data_isSet;
}

bool OAI_medias_post_request_payload_data_transcription::is_data_Valid() const{
    return m_data_isValid;
}

bool OAI_medias_post_request_payload_data_transcription::isSet() const {
...
bool OAI_medias_post_request_payload_data_transcription::isValid() const {
