...
/*
 * OAIClip_response_object_data_relationships_media_data.h
 *
 * 
 */

#ifndef OAIClip_response_object_data_relationships_media_data_H
#define OAIClip_response_object_data_relationships_media_data_H
...
class OAIClip_response_object_data_relationships_media_data : public OAIObject {
public:
    OAIClip_response_object_data_relationships_media_data();
    OAIClip_response_object_data_relationships_media_data(QString json);
    ~OAIClip_response_object_data_relationships_media_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClip_response_object_data_relationships_media_data)

#endif // OAIClip_response_object_data_relationships_media_data_H
