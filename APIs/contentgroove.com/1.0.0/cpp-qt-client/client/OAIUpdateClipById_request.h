...
/*
 * OAIUpdateClipById_request.h
 *
 * 
 */

#ifndef OAIUpdateClipById_request_H
#define OAIUpdateClipById_request_H
...
namespace OpenAPI {
class OAIUpdateClipById_request_data;

class OAIUpdateClipById_request : public OAIObject {
public:
    OAIUpdateClipById_request();
    OAIUpdateClipById_request(QString json);
    ~OAIUpdateClipById_request() override;
    ...
    OAIUpdateClipById_request_data getData() const;
    void setData(const OAIUpdateClipById_request_data &data);
...
private:
    ...
    OAIUpdateClipById_request_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateClipById_request)

#endif // OAIUpdateClipById_request_H
