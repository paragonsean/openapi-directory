...
/*
 * OAICreateClip_request_data.h
 *
 * 
 */

#ifndef OAICreateClip_request_data_H
#define OAICreateClip_request_data_H
...
namespace OpenAPI {
class OAICreateClip_request_data_attributes;

class OAICreateClip_request_data : public OAIObject {
public:
    OAICreateClip_request_data();
    OAICreateClip_request_data(QString json);
    ~OAICreateClip_request_data() override;
    ...
    OAICreateClip_request_data_attributes getAttributes() const;
    void setAttributes(const OAICreateClip_request_data_attributes &attributes);
...
private:
    ...
    OAICreateClip_request_data_attributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateClip_request_data)

#endif // OAICreateClip_request_data_H
