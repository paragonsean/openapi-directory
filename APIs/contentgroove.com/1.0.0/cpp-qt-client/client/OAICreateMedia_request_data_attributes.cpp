...
#include "OAICreateMedia_request_data_attributes.h"
...
OAICreateMedia_request_data_attributes::OAICreateMedia_request_data_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMedia_request_data_attributes::OAICreateMedia_request_data_attributes() {
    this->initializeModel();
}

OAICreateMedia_request_data_attributes::~OAICreateMedia_request_data_attributes() {}

void OAICreateMedia_request_data_attributes::initializeModel() {
...
void OAICreateMedia_request_data_attributes::fromJson(QString jsonString) {
...
void OAICreateMedia_request_data_attributes::fromJsonObject(QJsonObject json) {
...
QString OAICreateMedia_request_data_attributes::asJson() const {
...
QJsonObject OAICreateMedia_request_data_attributes::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateMedia_request_data_attributes::getDescription() const {
    return m_description;
}
void OAICreateMedia_request_data_attributes::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateMedia_request_data_attributes::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateMedia_request_data_attributes::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateMedia_request_data_attributes::getName() const {
    return m_name;
}
void OAICreateMedia_request_data_attributes::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateMedia_request_data_attributes::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateMedia_request_data_attributes::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateMedia_request_data_attributes::getSourceUrl() const {
    return m_source_url;
}
void OAICreateMedia_request_data_attributes::setSourceUrl(const QString &source_url) {
    m_source_url = source_url;
    m_source_url_isSet = true;
}

bool OAICreateMedia_request_data_attributes::is_source_url_Set() const{
    return m_source_url_isSet;
}

bool OAICreateMedia_request_data_attributes::is_source_url_Valid() const{
    return m_source_url_isValid;
}

QString OAICreateMedia_request_data_attributes::getUploadId() const {
    return m_upload_id;
}
void OAICreateMedia_request_data_attributes::setUploadId(const QString &upload_id) {
    m_upload_id = upload_id;
    m_upload_id_isSet = true;
}

bool OAICreateMedia_request_data_attributes::is_upload_id_Set() const{
    return m_upload_id_isSet;
}

bool OAICreateMedia_request_data_attributes::is_upload_id_Valid() const{
    return m_upload_id_isValid;
}

bool OAICreateMedia_request_data_attributes::isSet() const {
...
bool OAICreateMedia_request_data_attributes::isValid() const {
