...
OAIMedia_response_object_data_relationships_clips::OAIMedia_response_object_data_relationships_clips(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMedia_response_object_data_relationships_clips::OAIMedia_response_object_data_relationships_clips() {
    this->initializeModel();
}

OAIMedia_response_object_data_relationships_clips::~OAIMedia_response_object_data_relationships_clips() {}

void OAIMedia_response_object_data_relationships_clips::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIMedia_response_object_data_relationships_clips::fromJson(QString jsonString) {
...
void OAIMedia_response_object_data_relationships_clips::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIMedia_response_object_data_relationships_clips::asJson() const {
...
QJsonObject OAIMedia_response_object_data_relationships_clips::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIClip_response_object_data_relationships_media_data> OAIMedia_response_object_data_relationships_clips::getData() const {
    return m_data;
}
void OAIMedia_response_object_data_relationships_clips::setData(const QList<OAIClip_response_object_data_relationships_media_data> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIMedia_response_object_data_relationships_clips::is_data_Set() const{
    return m_data_isSet;
}

bool OAIMedia_response_object_data_relationships_clips::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIMedia_response_object_data_relationships_clips::isSet() const {
...
bool OAIMedia_response_object_data_relationships_clips::isValid() const {
