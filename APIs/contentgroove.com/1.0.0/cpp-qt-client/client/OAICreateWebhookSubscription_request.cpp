...
OAICreateWebhookSubscription_request::OAICreateWebhookSubscription_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateWebhookSubscription_request::OAICreateWebhookSubscription_request() {
    this->initializeModel();
}

OAICreateWebhookSubscription_request::~OAICreateWebhookSubscription_request() {}

void OAICreateWebhookSubscription_request::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAICreateWebhookSubscription_request::fromJson(QString jsonString) {
...
void OAICreateWebhookSubscription_request::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAICreateWebhookSubscription_request::asJson() const {
...
QJsonObject OAICreateWebhookSubscription_request::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAICreateWebhookSubscription_request_data OAICreateWebhookSubscription_request::getData() const {
    return m_data;
}
void OAICreateWebhookSubscription_request::setData(const OAICreateWebhookSubscription_request_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICreateWebhookSubscription_request::is_data_Set() const{
    return m_data_isSet;
}

bool OAICreateWebhookSubscription_request::is_data_Valid() const{
    return m_data_isValid;
}

bool OAICreateWebhookSubscription_request::isSet() const {
...
bool OAICreateWebhookSubscription_request::isValid() const {
