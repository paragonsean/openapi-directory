...
OAIUnauthorized_error_response_object::OAIUnauthorized_error_response_object(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnauthorized_error_response_object::OAIUnauthorized_error_response_object() {
    this->initializeModel();
}

OAIUnauthorized_error_response_object::~OAIUnauthorized_error_response_object() {}

void OAIUnauthorized_error_response_object::initializeModel() {

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIUnauthorized_error_response_object::fromJson(QString jsonString) {
...
void OAIUnauthorized_error_response_object::fromJsonObject(QJsonObject json) {

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("errors")]);
    m_errors_isSet = !json[QString("errors")].isNull() && m_errors_isValid;
}

QString OAIUnauthorized_error_response_object::asJson() const {
...
QJsonObject OAIUnauthorized_error_response_object::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIUnauthorized_error_response_object_errors_inner> OAIUnauthorized_error_response_object::getErrors() const {
    return m_errors;
}
void OAIUnauthorized_error_response_object::setErrors(const QList<OAIUnauthorized_error_response_object_errors_inner> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIUnauthorized_error_response_object::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIUnauthorized_error_response_object::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIUnauthorized_error_response_object::isSet() const {
...
bool OAIUnauthorized_error_response_object::isValid() const {
