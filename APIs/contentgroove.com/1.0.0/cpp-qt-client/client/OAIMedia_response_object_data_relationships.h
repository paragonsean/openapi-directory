...
/*
 * OAIMedia_response_object_data_relationships.h
 *
 * 
 */

#ifndef OAIMedia_response_object_data_relationships_H
#define OAIMedia_response_object_data_relationships_H
...
class OAIMedia_response_object_data_relationships : public OAIObject {
public:
    OAIMedia_response_object_data_relationships();
    OAIMedia_response_object_data_relationships(QString json);
    ~OAIMedia_response_object_data_relationships() override;
    ...
    OAIMedia_response_object_data_relationships_clips getClips() const;
    void setClips(const OAIMedia_response_object_data_relationships_clips &clips);
...
private:
    ...
    OAIMedia_response_object_data_relationships_clips m_clips;
    bool m_clips_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMedia_response_object_data_relationships)

#endif // OAIMedia_response_object_data_relationships_H
