...
/*
 * OAIMedia_response_object_data_relationships_clips.h
 *
 * 
 */

#ifndef OAIMedia_response_object_data_relationships_clips_H
#define OAIMedia_response_object_data_relationships_clips_H

#include <QJsonObject>

#include "OAIClip_response_object_data_relationships_media_data.h"
#include <QList>
...
namespace OpenAPI {
class OAIClip_response_object_data_relationships_media_data;

class OAIMedia_response_object_data_relationships_clips : public OAIObject {
public:
    OAIMedia_response_object_data_relationships_clips();
    OAIMedia_response_object_data_relationships_clips(QString json);
    ~OAIMedia_response_object_data_relationships_clips() override;
    ...
    QList<OAIClip_response_object_data_relationships_media_data> getData() const;
    void setData(const QList<OAIClip_response_object_data_relationships_media_data> &data);
...
private:
    ...
    QList<OAIClip_response_object_data_relationships_media_data> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIMedia_response_object_data_relationships_clips)

#endif // OAIMedia_response_object_data_relationships_clips_H
