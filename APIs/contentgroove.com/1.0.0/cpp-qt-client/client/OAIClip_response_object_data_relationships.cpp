...
#include "OAIClip_response_object_data_relationships.h"
...
OAIClip_response_object_data_relationships::OAIClip_response_object_data_relationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClip_response_object_data_relationships::OAIClip_response_object_data_relationships() {
    this->initializeModel();
}

OAIClip_response_object_data_relationships::~OAIClip_response_object_data_relationships() {}

void OAIClip_response_object_data_relationships::initializeModel() {

    m_media_isSet = false;
    m_media_isValid = false;
}

void OAIClip_response_object_data_relationships::fromJson(QString jsonString) {
...
void OAIClip_response_object_data_relationships::fromJsonObject(QJsonObject json) {

    m_media_isValid = ::OpenAPI::fromJsonValue(m_media, json[QString("media")]);
    m_media_isSet = !json[QString("media")].isNull() && m_media_isValid;
}

QString OAIClip_response_object_data_relationships::asJson() const {
...
QJsonObject OAIClip_response_object_data_relationships::asJsonObject() const {
    QJsonObject obj;
    if (m_media.isSet()) {
...
OAIClip_response_object_data_relationships_media OAIClip_response_object_data_relationships::getMedia() const {
    return m_media;
}
void OAIClip_response_object_data_relationships::setMedia(const OAIClip_response_object_data_relationships_media &media) {
    m_media = media;
    m_media_isSet = true;
}

bool OAIClip_response_object_data_relationships::is_media_Set() const{
    return m_media_isSet;
}

bool OAIClip_response_object_data_relationships::is_media_Valid() const{
    return m_media_isValid;
}

bool OAIClip_response_object_data_relationships::isSet() const {
...
bool OAIClip_response_object_data_relationships::isValid() const {
