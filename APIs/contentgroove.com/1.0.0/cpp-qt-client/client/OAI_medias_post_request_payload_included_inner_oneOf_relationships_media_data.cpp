...
#include "OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data.h"
...
OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data() {
    this->initializeModel();
}

OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::~OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data() {}

void OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::initializeModel() {
...
void OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::fromJson(QString jsonString) {
...
void OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::fromJsonObject(QJsonObject json) {
...
QString OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::asJson() const {
...
QJsonObject OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::getId() const {
    return m_id;
}
void OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::is_id_Valid() const{
    return m_id_isValid;
}

QString OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::getType() const {
    return m_type;
}
void OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::is_type_Set() const{
    return m_type_isSet;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::is_type_Valid() const{
    return m_type_isValid;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::isSet() const {
...
bool OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data::isValid() const {
