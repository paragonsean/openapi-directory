...
/*
 * OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data_H
#define OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data_H
...
class OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data : public OAIObject {
public:
    OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data();
    OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data(QString json);
    ~OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data)

#endif // OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data_H
