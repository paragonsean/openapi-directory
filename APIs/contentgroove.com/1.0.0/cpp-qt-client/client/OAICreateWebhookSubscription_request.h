...
/*
 * OAICreateWebhookSubscription_request.h
 *
 * 
 */

#ifndef OAICreateWebhookSubscription_request_H
#define OAICreateWebhookSubscription_request_H

#include <QJsonObject>

#include "OAICreateWebhookSubscription_request_data.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateWebhookSubscription_request_data;

class OAICreateWebhookSubscription_request : public OAIObject {
public:
    OAICreateWebhookSubscription_request();
    OAICreateWebhookSubscription_request(QString json);
    ~OAICreateWebhookSubscription_request() override;
    ...
    OAICreateWebhookSubscription_request_data getData() const;
    void setData(const OAICreateWebhookSubscription_request_data &data);
...
private:
    ...
    OAICreateWebhookSubscription_request_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWebhookSubscription_request)

#endif // OAICreateWebhookSubscription_request_H
