...
/*
 * OAICreateClip_request.h
 *
 * 
 */

#ifndef OAICreateClip_request_H
#define OAICreateClip_request_H

#include <QJsonObject>

#include "OAICreateClip_request_data.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateClip_request_data;

class OAICreateClip_request : public OAIObject {
public:
    OAICreateClip_request();
    OAICreateClip_request(QString json);
    ~OAICreateClip_request() override;
    ...
    OAICreateClip_request_data getData() const;
    void setData(const OAICreateClip_request_data &data);
...
private:
    ...
    OAICreateClip_request_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateClip_request)

#endif // OAICreateClip_request_H
