...
/*
 * OAIClip_response_object_data_attributes.h
 *
 * 
 */

#ifndef OAIClip_response_object_data_attributes_H
#define OAIClip_response_object_data_attributes_H
...
class OAIClip_response_object_data_attributes : public OAIObject {
public:
    OAIClip_response_object_data_attributes();
    OAIClip_response_object_data_attributes(QString json);
    ~OAIClip_response_object_data_attributes() override;
    ...
    qint32 getEndChar() const;
    void setEndChar(const qint32 &end_char);
    ...
    QString getMediaFileContentDuration() const;
    void setMediaFileContentDuration(const QString &media_file_content_duration);
    bool is_media_file_content_duration_Set() const;
    bool is_media_file_content_duration_Valid() const;
    ...
    QString getMediaFileHeight() const;
    void setMediaFileHeight(const QString &media_file_height);
    ...
    QString getMediaFileWidth() const;
    void setMediaFileWidth(const QString &media_file_width);
...
private:
    ...
    QString m_media_file_content_duration;
    bool m_media_file_content_duration_isSet;
    bool m_media_file_content_duration_isValid;

    QString m_media_file_content_type;
    bool m_media_file_content_type_isSet;
    bool m_media_file_content_type_isValid;

    QString m_media_file_height;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClip_response_object_data_attributes)

#endif // OAIClip_response_object_data_attributes_H
