...
/*
 * OAI_medias_post_request_payload.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_H
#define OAI_medias_post_request_payload_H
...
namespace OpenAPI {
class OAI_medias_post_request_payload_data;
class OAI_medias_post_request_payload_included_inner;

class OAI_medias_post_request_payload : public OAIObject {
public:
    OAI_medias_post_request_payload();
    OAI_medias_post_request_payload(QString json);
    ~OAI_medias_post_request_payload() override;
    ...
    OAI_medias_post_request_payload_data getData() const;
    void setData(const OAI_medias_post_request_payload_data &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    QList<OAI_medias_post_request_payload_included_inner> getIncluded() const;
    void setIncluded(const QList<OAI_medias_post_request_payload_included_inner> &included);
...
private:
    ...
    OAI_medias_post_request_payload_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    QList<OAI_medias_post_request_payload_included_inner> m_included;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload)

#endif // OAI_medias_post_request_payload_H
