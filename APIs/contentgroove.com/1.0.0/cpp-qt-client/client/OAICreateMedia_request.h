...
/*
 * OAICreateMedia_request.h
 *
 * 
 */

#ifndef OAICreateMedia_request_H
#define OAICreateMedia_request_H

#include <QJsonObject>

#include "OAICreateMedia_request_data.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateMedia_request_data;

class OAICreateMedia_request : public OAIObject {
public:
    OAICreateMedia_request();
    OAICreateMedia_request(QString json);
    ~OAICreateMedia_request() override;
    ...
    OAICreateMedia_request_data getData() const;
    void setData(const OAICreateMedia_request_data &data);
...
private:
    ...
    OAICreateMedia_request_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMedia_request)

#endif // OAICreateMedia_request_H
