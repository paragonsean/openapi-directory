...
/*
 * OAIUnauthorized_error_response_object_errors_inner.h
 *
 * 
 */

#ifndef OAIUnauthorized_error_response_object_errors_inner_H
#define OAIUnauthorized_error_response_object_errors_inner_H
...
class OAIUnauthorized_error_response_object_errors_inner : public OAIObject {
public:
    OAIUnauthorized_error_response_object_errors_inner();
    OAIUnauthorized_error_response_object_errors_inner(QString json);
    ~OAIUnauthorized_error_response_object_errors_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnauthorized_error_response_object_errors_inner)

#endif // OAIUnauthorized_error_response_object_errors_inner_H
