...
OAIPayment_required_error_response_object::OAIPayment_required_error_response_object(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayment_required_error_response_object::OAIPayment_required_error_response_object() {
    this->initializeModel();
}

OAIPayment_required_error_response_object::~OAIPayment_required_error_response_object() {}

void OAIPayment_required_error_response_object::initializeModel() {

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIPayment_required_error_response_object::fromJson(QString jsonString) {
...
void OAIPayment_required_error_response_object::fromJsonObject(QJsonObject json) {

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("errors")]);
    m_errors_isSet = !json[QString("errors")].isNull() && m_errors_isValid;
}

QString OAIPayment_required_error_response_object::asJson() const {
...
QJsonObject OAIPayment_required_error_response_object::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIPayment_required_error_response_object_errors_inner> OAIPayment_required_error_response_object::getErrors() const {
    return m_errors;
}
void OAIPayment_required_error_response_object::setErrors(const QList<OAIPayment_required_error_response_object_errors_inner> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIPayment_required_error_response_object::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIPayment_required_error_response_object::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIPayment_required_error_response_object::isSet() const {
...
bool OAIPayment_required_error_response_object::isValid() const {
