...
#include "OAIWebhook_subscription_response_object_data_relationships.h"
...
OAIWebhook_subscription_response_object_data_relationships::OAIWebhook_subscription_response_object_data_relationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWebhook_subscription_response_object_data_relationships::OAIWebhook_subscription_response_object_data_relationships() {
    this->initializeModel();
}

OAIWebhook_subscription_response_object_data_relationships::~OAIWebhook_subscription_response_object_data_relationships() {}

void OAIWebhook_subscription_response_object_data_relationships::initializeModel() {
...
void OAIWebhook_subscription_response_object_data_relationships::fromJson(QString jsonString) {
...
void OAIWebhook_subscription_response_object_data_relationships::fromJsonObject(QJsonObject json) {
...
QString OAIWebhook_subscription_response_object_data_relationships::asJson() const {
...
QJsonObject OAIWebhook_subscription_response_object_data_relationships::asJsonObject() const {
    QJsonObject obj;
    if (m_user.isSet()) {
        obj.insert(QString("user"), ::OpenAPI::toJsonValue(m_user));
    }
    if (m_webhook_events.isSet()) {
        obj.insert(QString("webhook_events"), ::OpenAPI::toJsonValue(m_webhook_events));
    }
    return obj;
}

OAIClip_response_object_data_relationships_media OAIWebhook_subscription_response_object_data_relationships::getUser() const {
    return m_user;
}
void OAIWebhook_subscription_response_object_data_relationships::setUser(const OAIClip_response_object_data_relationships_media &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIWebhook_subscription_response_object_data_relationships::is_user_Set() const{
    return m_user_isSet;
}

bool OAIWebhook_subscription_response_object_data_relationships::is_user_Valid() const{
    return m_user_isValid;
}

OAIMedia_response_object_data_relationships_clips OAIWebhook_subscription_response_object_data_relationships::getWebhookEvents() const {
    return m_webhook_events;
}
void OAIWebhook_subscription_response_object_data_relationships::setWebhookEvents(const OAIMedia_response_object_data_relationships_clips &webhook_events) {
    m_webhook_events = webhook_events;
    m_webhook_events_isSet = true;
}

bool OAIWebhook_subscription_response_object_data_relationships::is_webhook_events_Set() const{
    return m_webhook_events_isSet;
}

bool OAIWebhook_subscription_response_object_data_relationships::is_webhook_events_Valid() const{
    return m_webhook_events_isValid;
}

bool OAIWebhook_subscription_response_object_data_relationships::isSet() const {
...
bool OAIWebhook_subscription_response_object_data_relationships::isValid() const {
