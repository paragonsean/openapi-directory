...
/*
 * OAIUpdateClipById_request_data_attributes.h
 *
 * 
 */

#ifndef OAIUpdateClipById_request_data_attributes_H
#define OAIUpdateClipById_request_data_attributes_H
...
class OAIUpdateClipById_request_data_attributes : public OAIObject {
public:
    OAIUpdateClipById_request_data_attributes();
    OAIUpdateClipById_request_data_attributes(QString json);
    ~OAIUpdateClipById_request_data_attributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateClipById_request_data_attributes)

#endif // OAIUpdateClipById_request_data_attributes_H
