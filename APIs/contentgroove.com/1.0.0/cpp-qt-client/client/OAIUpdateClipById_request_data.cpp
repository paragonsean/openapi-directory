...
#include "OAIUpdateClipById_request_data.h"
...
OAIUpdateClipById_request_data::OAIUpdateClipById_request_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateClipById_request_data::OAIUpdateClipById_request_data() {
    this->initializeModel();
}

OAIUpdateClipById_request_data::~OAIUpdateClipById_request_data() {}

void OAIUpdateClipById_request_data::initializeModel() {

    m_attributes_isSet = false;
    m_attributes_isValid = false;
}

void OAIUpdateClipById_request_data::fromJson(QString jsonString) {
...
void OAIUpdateClipById_request_data::fromJsonObject(QJsonObject json) {

    m_attributes_isValid = ::OpenAPI::fromJsonValue(m_attributes, json[QString("attributes")]);
    m_attributes_isSet = !json[QString("attributes")].isNull() && m_attributes_isValid;
}

QString OAIUpdateClipById_request_data::asJson() const {
...
QJsonObject OAIUpdateClipById_request_data::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateClipById_request_data_attributes OAIUpdateClipById_request_data::getAttributes() const {
    return m_attributes;
}
void OAIUpdateClipById_request_data::setAttributes(const OAIUpdateClipById_request_data_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIUpdateClipById_request_data::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIUpdateClipById_request_data::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAIUpdateClipById_request_data::isSet() const {
...
bool OAIUpdateClipById_request_data::isValid() const {
