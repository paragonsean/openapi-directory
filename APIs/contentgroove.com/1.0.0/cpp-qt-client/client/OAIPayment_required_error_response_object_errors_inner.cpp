...
OAIPayment_required_error_response_object_errors_inner::OAIPayment_required_error_response_object_errors_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayment_required_error_response_object_errors_inner::OAIPayment_required_error_response_object_errors_inner() {
    this->initializeModel();
}

OAIPayment_required_error_response_object_errors_inner::~OAIPayment_required_error_response_object_errors_inner() {}

void OAIPayment_required_error_response_object_errors_inner::initializeModel() {
...
void OAIPayment_required_error_response_object_errors_inner::fromJson(QString jsonString) {
...
void OAIPayment_required_error_response_object_errors_inner::fromJsonObject(QJsonObject json) {
...
QString OAIPayment_required_error_response_object_errors_inner::asJson() const {
...
QJsonObject OAIPayment_required_error_response_object_errors_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIPayment_required_error_response_object_errors_inner::getCode() const {
    return m_code;
}
void OAIPayment_required_error_response_object_errors_inner::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIPayment_required_error_response_object_errors_inner::is_code_Set() const{
    return m_code_isSet;
}

bool OAIPayment_required_error_response_object_errors_inner::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIPayment_required_error_response_object_errors_inner::getDetail() const {
    return m_detail;
}
void OAIPayment_required_error_response_object_errors_inner::setDetail(const QString &detail) {
    m_detail = detail;
    m_detail_isSet = true;
}

bool OAIPayment_required_error_response_object_errors_inner::is_detail_Set() const{
    return m_detail_isSet;
}

bool OAIPayment_required_error_response_object_errors_inner::is_detail_Valid() const{
    return m_detail_isValid;
}

OAIPayment_required_error_response_object_errors_inner_source OAIPayment_required_error_response_object_errors_inner::getSource() const {
    return m_source;
}
void OAIPayment_required_error_response_object_errors_inner::setSource(const OAIPayment_required_error_response_object_errors_inner_source &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIPayment_required_error_response_object_errors_inner::is_source_Set() const{
    return m_source_isSet;
}

bool OAIPayment_required_error_response_object_errors_inner::is_source_Valid() const{
    return m_source_isValid;
}

QString OAIPayment_required_error_response_object_errors_inner::getStatus() const {
    return m_status;
}
void OAIPayment_required_error_response_object_errors_inner::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPayment_required_error_response_object_errors_inner::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPayment_required_error_response_object_errors_inner::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIPayment_required_error_response_object_errors_inner::getTitle() const {
    return m_title;
}
void OAIPayment_required_error_response_object_errors_inner::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIPayment_required_error_response_object_errors_inner::is_title_Set() const{
    return m_title_isSet;
}

bool OAIPayment_required_error_response_object_errors_inner::is_title_Valid() const{
    return m_title_isValid;
}

bool OAIPayment_required_error_response_object_errors_inner::isSet() const {
...
bool OAIPayment_required_error_response_object_errors_inner::isValid() const {
