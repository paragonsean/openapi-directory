...
OAIClip_response_object_data_relationships_media::OAIClip_response_object_data_relationships_media(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClip_response_object_data_relationships_media::OAIClip_response_object_data_relationships_media() {
    this->initializeModel();
}

OAIClip_response_object_data_relationships_media::~OAIClip_response_object_data_relationships_media() {}

void OAIClip_response_object_data_relationships_media::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIClip_response_object_data_relationships_media::fromJson(QString jsonString) {
...
void OAIClip_response_object_data_relationships_media::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIClip_response_object_data_relationships_media::asJson() const {
...
QJsonObject OAIClip_response_object_data_relationships_media::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIClip_response_object_data_relationships_media_data OAIClip_response_object_data_relationships_media::getData() const {
    return m_data;
}
void OAIClip_response_object_data_relationships_media::setData(const OAIClip_response_object_data_relationships_media_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIClip_response_object_data_relationships_media::is_data_Set() const{
    return m_data_isSet;
}

bool OAIClip_response_object_data_relationships_media::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIClip_response_object_data_relationships_media::isSet() const {
...
bool OAIClip_response_object_data_relationships_media::isValid() const {
