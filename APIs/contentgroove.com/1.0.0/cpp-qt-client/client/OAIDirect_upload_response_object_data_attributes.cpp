...
OAIDirect_upload_response_object_data_attributes::OAIDirect_upload_response_object_data_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDirect_upload_response_object_data_attributes::OAIDirect_upload_response_object_data_attributes() {
    this->initializeModel();
}

OAIDirect_upload_response_object_data_attributes::~OAIDirect_upload_response_object_data_attributes() {}

void OAIDirect_upload_response_object_data_attributes::initializeModel() {
...
void OAIDirect_upload_response_object_data_attributes::fromJson(QString jsonString) {
...
void OAIDirect_upload_response_object_data_attributes::fromJsonObject(QJsonObject json) {
...
QString OAIDirect_upload_response_object_data_attributes::asJson() const {
...
QJsonObject OAIDirect_upload_response_object_data_attributes::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDirect_upload_response_object_data_attributes::getUploadId() const {
    return m_upload_id;
}
void OAIDirect_upload_response_object_data_attributes::setUploadId(const QString &upload_id) {
    m_upload_id = upload_id;
    m_upload_id_isSet = true;
}

bool OAIDirect_upload_response_object_data_attributes::is_upload_id_Set() const{
    return m_upload_id_isSet;
}

bool OAIDirect_upload_response_object_data_attributes::is_upload_id_Valid() const{
    return m_upload_id_isValid;
}

QString OAIDirect_upload_response_object_data_attributes::getUploadUrl() const {
    return m_upload_url;
}
void OAIDirect_upload_response_object_data_attributes::setUploadUrl(const QString &upload_url) {
    m_upload_url = upload_url;
    m_upload_url_isSet = true;
}

bool OAIDirect_upload_response_object_data_attributes::is_upload_url_Set() const{
    return m_upload_url_isSet;
}

bool OAIDirect_upload_response_object_data_attributes::is_upload_url_Valid() const{
    return m_upload_url_isValid;
}

bool OAIDirect_upload_response_object_data_attributes::isSet() const {
...
bool OAIDirect_upload_response_object_data_attributes::isValid() const {
