...
#include "OAI_medias_post_request.h"
...
OAI_medias_post_request::OAI_medias_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_medias_post_request::OAI_medias_post_request() {
    this->initializeModel();
}

OAI_medias_post_request::~OAI_medias_post_request() {}

void OAI_medias_post_request::initializeModel() {
...
void OAI_medias_post_request::fromJson(QString jsonString) {
...
void OAI_medias_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_medias_post_request::asJson() const {
...
QJsonObject OAI_medias_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_event_isSet) {
...
QString OAI_medias_post_request::getEvent() const {
    return m_event;
}
void OAI_medias_post_request::setEvent(const QString &event) {
    m_event = event;
    m_event_isSet = true;
}

bool OAI_medias_post_request::is_event_Set() const{
    return m_event_isSet;
}

bool OAI_medias_post_request::is_event_Valid() const{
    return m_event_isValid;
}

OAI_medias_post_request_payload OAI_medias_post_request::getPayload() const {
    return m_payload;
}
void OAI_medias_post_request::setPayload(const OAI_medias_post_request_payload &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAI_medias_post_request::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAI_medias_post_request::is_payload_Valid() const{
    return m_payload_isValid;
}

bool OAI_medias_post_request::isSet() const {
...
bool OAI_medias_post_request::isValid() const {
