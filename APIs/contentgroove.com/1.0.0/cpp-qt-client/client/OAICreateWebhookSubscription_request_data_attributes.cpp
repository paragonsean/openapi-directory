...
#include "OAICreateWebhookSubscription_request_data_attributes.h"
...
OAICreateWebhookSubscription_request_data_attributes::OAICreateWebhookSubscription_request_data_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateWebhookSubscription_request_data_attributes::OAICreateWebhookSubscription_request_data_attributes() {
    this->initializeModel();
}

OAICreateWebhookSubscription_request_data_attributes::~OAICreateWebhookSubscription_request_data_attributes() {}

void OAICreateWebhookSubscription_request_data_attributes::initializeModel() {
...
void OAICreateWebhookSubscription_request_data_attributes::fromJson(QString jsonString) {
...
void OAICreateWebhookSubscription_request_data_attributes::fromJsonObject(QJsonObject json) {
...
QString OAICreateWebhookSubscription_request_data_attributes::asJson() const {
...
QJsonObject OAICreateWebhookSubscription_request_data_attributes::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAICreateWebhookSubscription_request_data_attributes::getSubscribedEvents() const {
    return m_subscribed_events;
}
void OAICreateWebhookSubscription_request_data_attributes::setSubscribedEvents(const QList<QString> &subscribed_events) {
    m_subscribed_events = subscribed_events;
    m_subscribed_events_isSet = true;
}

bool OAICreateWebhookSubscription_request_data_attributes::is_subscribed_events_Set() const{
    return m_subscribed_events_isSet;
}

bool OAICreateWebhookSubscription_request_data_attributes::is_subscribed_events_Valid() const{
    return m_subscribed_events_isValid;
}

QString OAICreateWebhookSubscription_request_data_attributes::getUrl() const {
    return m_url;
}
void OAICreateWebhookSubscription_request_data_attributes::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAICreateWebhookSubscription_request_data_attributes::is_url_Set() const{
    return m_url_isSet;
}

bool OAICreateWebhookSubscription_request_data_attributes::is_url_Valid() const{
    return m_url_isValid;
}

bool OAICreateWebhookSubscription_request_data_attributes::isSet() const {
...
bool OAICreateWebhookSubscription_request_data_attributes::isValid() const {
