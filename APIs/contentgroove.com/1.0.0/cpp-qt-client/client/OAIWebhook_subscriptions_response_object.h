...
/*
 * OAIWebhook_subscriptions_response_object.h
 *
 * 
 */

#ifndef OAIWebhook_subscriptions_response_object_H
#define OAIWebhook_subscriptions_response_object_H
...
class OAIWebhook_subscriptions_response_object : public OAIObject {
public:
    OAIWebhook_subscriptions_response_object();
    OAIWebhook_subscriptions_response_object(QString json);
    ~OAIWebhook_subscriptions_response_object() override;
    ...
    QList<OAIWebhook_subscription_response_object_data> getData() const;
    void setData(const QList<OAIWebhook_subscription_response_object_data> &data);
...
private:
    ...
    QList<OAIWebhook_subscription_response_object_data> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhook_subscriptions_response_object)

#endif // OAIWebhook_subscriptions_response_object_H
