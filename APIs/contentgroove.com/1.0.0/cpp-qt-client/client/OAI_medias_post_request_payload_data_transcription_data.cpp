...
#include "OAI_medias_post_request_payload_data_transcription_data.h"
...
OAI_medias_post_request_payload_data_transcription_data::OAI_medias_post_request_payload_data_transcription_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_medias_post_request_payload_data_transcription_data::OAI_medias_post_request_payload_data_transcription_data() {
    this->initializeModel();
}

OAI_medias_post_request_payload_data_transcription_data::~OAI_medias_post_request_payload_data_transcription_data() {}

void OAI_medias_post_request_payload_data_transcription_data::initializeModel() {
...
void OAI_medias_post_request_payload_data_transcription_data::fromJson(QString jsonString) {
...
void OAI_medias_post_request_payload_data_transcription_data::fromJsonObject(QJsonObject json) {
...
QString OAI_medias_post_request_payload_data_transcription_data::asJson() const {
...
QJsonObject OAI_medias_post_request_payload_data_transcription_data::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAI_medias_post_request_payload_data_transcription_data::getId() const {
    return m_id;
}
void OAI_medias_post_request_payload_data_transcription_data::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_medias_post_request_payload_data_transcription_data::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_medias_post_request_payload_data_transcription_data::is_id_Valid() const{
    return m_id_isValid;
}

QString OAI_medias_post_request_payload_data_transcription_data::getType() const {
    return m_type;
}
void OAI_medias_post_request_payload_data_transcription_data::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAI_medias_post_request_payload_data_transcription_data::is_type_Set() const{
    return m_type_isSet;
}

bool OAI_medias_post_request_payload_data_transcription_data::is_type_Valid() const{
    return m_type_isValid;
}

bool OAI_medias_post_request_payload_data_transcription_data::isSet() const {
...
bool OAI_medias_post_request_payload_data_transcription_data::isValid() const {
