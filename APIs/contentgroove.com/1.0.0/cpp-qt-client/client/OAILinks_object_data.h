...
/*
 * OAILinks_object_data.h
 *
 * 
 */

#ifndef OAILinks_object_data_H
#define OAILinks_object_data_H
...
class OAILinks_object_data : public OAIObject {
public:
    OAILinks_object_data();
    OAILinks_object_data(QString json);
    ~OAILinks_object_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_object_data)

#endif // OAILinks_object_data_H
