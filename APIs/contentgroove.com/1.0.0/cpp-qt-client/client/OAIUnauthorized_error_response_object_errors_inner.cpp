...
OAIUnauthorized_error_response_object_errors_inner::OAIUnauthorized_error_response_object_errors_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnauthorized_error_response_object_errors_inner::OAIUnauthorized_error_response_object_errors_inner() {
    this->initializeModel();
}

OAIUnauthorized_error_response_object_errors_inner::~OAIUnauthorized_error_response_object_errors_inner() {}

void OAIUnauthorized_error_response_object_errors_inner::initializeModel() {

    m_message_isSet = false;
    m_message_isValid = false;
}

void OAIUnauthorized_error_response_object_errors_inner::fromJson(QString jsonString) {
...
void OAIUnauthorized_error_response_object_errors_inner::fromJsonObject(QJsonObject json) {

    m_message_isValid = ::OpenAPI::fromJsonValue(m_message, json[QString("message")]);
    m_message_isSet = !json[QString("message")].isNull() && m_message_isValid;
}

QString OAIUnauthorized_error_response_object_errors_inner::asJson() const {
...
QJsonObject OAIUnauthorized_error_response_object_errors_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIUnauthorized_error_response_object_errors_inner::getMessage() const {
    return m_message;
}
void OAIUnauthorized_error_response_object_errors_inner::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIUnauthorized_error_response_object_errors_inner::is_message_Set() const{
    return m_message_isSet;
}

bool OAIUnauthorized_error_response_object_errors_inner::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIUnauthorized_error_response_object_errors_inner::isSet() const {
...
bool OAIUnauthorized_error_response_object_errors_inner::isValid() const {
