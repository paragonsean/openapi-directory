...
/*
 * OAI_medias_post_request_payload_data_relationships_clips.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_data_relationships_clips_H
#define OAI_medias_post_request_payload_data_relationships_clips_H
...
namespace OpenAPI {
class OAI_medias_post_request_payload_data_relationships_clips_data_inner;

class OAI_medias_post_request_payload_data_relationships_clips : public OAIObject {
public:
    OAI_medias_post_request_payload_data_relationships_clips();
    OAI_medias_post_request_payload_data_relationships_clips(QString json);
    ~OAI_medias_post_request_payload_data_relationships_clips() override;
    ...
    QList<OAI_medias_post_request_payload_data_relationships_clips_data_inner> getData() const;
    void setData(const QList<OAI_medias_post_request_payload_data_relationships_clips_data_inner> &data);
...
private:
    ...
    QList<OAI_medias_post_request_payload_data_relationships_clips_data_inner> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_data_relationships_clips)

#endif // OAI_medias_post_request_payload_data_relationships_clips_H
