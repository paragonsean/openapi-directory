...
#include "OAIMedia_response_object_data.h"
...
OAIMedia_response_object_data::OAIMedia_response_object_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMedia_response_object_data::OAIMedia_response_object_data() {
    this->initializeModel();
}

OAIMedia_response_object_data::~OAIMedia_response_object_data() {}

void OAIMedia_response_object_data::initializeModel() {
...
void OAIMedia_response_object_data::fromJson(QString jsonString) {
...
void OAIMedia_response_object_data::fromJsonObject(QJsonObject json) {
...
QString OAIMedia_response_object_data::asJson() const {
...
QJsonObject OAIMedia_response_object_data::asJsonObject() const {
    QJsonObject obj;
...
OAIMedia_response_object_data_attributes OAIMedia_response_object_data::getAttributes() const {
    return m_attributes;
}
void OAIMedia_response_object_data::setAttributes(const OAIMedia_response_object_data_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIMedia_response_object_data::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIMedia_response_object_data::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIMedia_response_object_data::getId() const {
    return m_id;
}
void OAIMedia_response_object_data::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMedia_response_object_data::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMedia_response_object_data::is_id_Valid() const{
    return m_id_isValid;
}

OAIMedia_response_object_data_relationships OAIMedia_response_object_data::getRelationships() const {
    return m_relationships;
}
void OAIMedia_response_object_data::setRelationships(const OAIMedia_response_object_data_relationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIMedia_response_object_data::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIMedia_response_object_data::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAIMedia_response_object_data::getType() const {
    return m_type;
}
void OAIMedia_response_object_data::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIMedia_response_object_data::is_type_Set() const{
    return m_type_isSet;
}

bool OAIMedia_response_object_data::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIMedia_response_object_data::isSet() const {
...
bool OAIMedia_response_object_data::isValid() const {
