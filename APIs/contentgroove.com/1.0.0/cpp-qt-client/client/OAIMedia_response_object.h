...
/*
 * OAIMedia_response_object.h
 *
 * 
 */

#ifndef OAIMedia_response_object_H
#define OAIMedia_response_object_H
...
namespace OpenAPI {
class OAIMedia_response_object_data;
class OAILinks_object_data;

class OAIMedia_response_object : public OAIObject {
public:
    OAIMedia_response_object();
    OAIMedia_response_object(QString json);
    ~OAIMedia_response_object() override;
    ...
    OAIMedia_response_object_data getData() const;
    void setData(const OAIMedia_response_object_data &data);
...
private:
    ...
    OAIMedia_response_object_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMedia_response_object)

#endif // OAIMedia_response_object_H
