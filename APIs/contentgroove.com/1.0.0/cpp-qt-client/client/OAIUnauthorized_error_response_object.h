...
/*
 * OAIUnauthorized_error_response_object.h
 *
 * 
 */

#ifndef OAIUnauthorized_error_response_object_H
#define OAIUnauthorized_error_response_object_H

#include <QJsonObject>

#include "OAIUnauthorized_error_response_object_errors_inner.h"
#include <QList>
...
namespace OpenAPI {
class OAIUnauthorized_error_response_object_errors_inner;

class OAIUnauthorized_error_response_object : public OAIObject {
public:
    OAIUnauthorized_error_response_object();
    OAIUnauthorized_error_response_object(QString json);
    ~OAIUnauthorized_error_response_object() override;
    ...
    QList<OAIUnauthorized_error_response_object_errors_inner> getErrors() const;
    void setErrors(const QList<OAIUnauthorized_error_response_object_errors_inner> &errors);
...
private:
    ...
    QList<OAIUnauthorized_error_response_object_errors_inner> m_errors;
    bool m_errors_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnauthorized_error_response_object)

#endif // OAIUnauthorized_error_response_object_H
