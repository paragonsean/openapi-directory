...
/*
 * OAIUpdateMediaById_request_data_attributes.h
 *
 * 
 */

#ifndef OAIUpdateMediaById_request_data_attributes_H
#define OAIUpdateMediaById_request_data_attributes_H
...
class OAIUpdateMediaById_request_data_attributes : public OAIObject {
public:
    OAIUpdateMediaById_request_data_attributes();
    OAIUpdateMediaById_request_data_attributes(QString json);
    ~OAIUpdateMediaById_request_data_attributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMediaById_request_data_attributes)

#endif // OAIUpdateMediaById_request_data_attributes_H
