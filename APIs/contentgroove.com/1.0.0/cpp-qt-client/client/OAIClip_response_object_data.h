...
/*
 * OAIClip_response_object_data.h
 *
 * 
 */

#ifndef OAIClip_response_object_data_H
#define OAIClip_response_object_data_H

#include <QJsonObject>

#include "OAIClip_response_object_data_attributes.h"
...
namespace OpenAPI {
class OAIClip_response_object_data_attributes;
class OAIClip_response_object_data_relationships;

class OAIClip_response_object_data : public OAIObject {
public:
    OAIClip_response_object_data();
    OAIClip_response_object_data(QString json);
    ~OAIClip_response_object_data() override;
    ...
    OAIClip_response_object_data_attributes getAttributes() const;
    void setAttributes(const OAIClip_response_object_data_attributes &attributes);
    ...
    OAIClip_response_object_data_relationships getRelationships() const;
    void setRelationships(const OAIClip_response_object_data_relationships &relationships);
...
private:
    ...
    OAIClip_response_object_data_attributes m_attributes;
    ...
    OAIClip_response_object_data_relationships m_relationships;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClip_response_object_data)

#endif // OAIClip_response_object_data_H
