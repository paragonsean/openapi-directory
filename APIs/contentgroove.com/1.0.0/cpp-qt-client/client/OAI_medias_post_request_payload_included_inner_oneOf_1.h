...
/*
 * OAI_medias_post_request_payload_included_inner_oneOf_1.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_included_inner_oneOf_1_H
#define OAI_medias_post_request_payload_included_inner_oneOf_1_H

#include <QJsonObject>

#include "OAIObject.h"
#include "OAI_medias_post_request_payload_included_inner_oneOf_1_attributes.h"
#include <QString>
...
namespace OpenAPI {
class OAI_medias_post_request_payload_included_inner_oneOf_1_attributes;

class OAI_medias_post_request_payload_included_inner_oneOf_1 : public OAIObject {
public:
    OAI_medias_post_request_payload_included_inner_oneOf_1();
    OAI_medias_post_request_payload_included_inner_oneOf_1(QString json);
    ~OAI_medias_post_request_payload_included_inner_oneOf_1() override;
    ...
    OAI_medias_post_request_payload_included_inner_oneOf_1_attributes getAttributes() const;
    void setAttributes(const OAI_medias_post_request_payload_included_inner_oneOf_1_attributes &attributes);
...
private:
    ...
    OAI_medias_post_request_payload_included_inner_oneOf_1_attributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_included_inner_oneOf_1)

#endif // OAI_medias_post_request_payload_included_inner_oneOf_1_H
