...
#include "OAIMedia_response_object_data_attributes.h"
...
OAIMedia_response_object_data_attributes::OAIMedia_response_object_data_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMedia_response_object_data_attributes::OAIMedia_response_object_data_attributes() {
    this->initializeModel();
}

OAIMedia_response_object_data_attributes::~OAIMedia_response_object_data_attributes() {}

void OAIMedia_response_object_data_attributes::initializeModel() {
...
void OAIMedia_response_object_data_attributes::fromJson(QString jsonString) {
...
void OAIMedia_response_object_data_attributes::fromJsonObject(QJsonObject json) {
...
QString OAIMedia_response_object_data_attributes::asJson() const {
...
QJsonObject OAIMedia_response_object_data_attributes::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMedia_response_object_data_attributes::getCreatedAt() const {
    return m_created_at;
}
void OAIMedia_response_object_data_attributes::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIMedia_response_object_data_attributes::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIMedia_response_object_data_attributes::getDescription() const {
    return m_description;
}
void OAIMedia_response_object_data_attributes::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_description_Set() const{
    return m_description_isSet;
}

bool OAIMedia_response_object_data_attributes::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIMedia_response_object_data_attributes::getExternalId() const {
    return m_external_id;
}
void OAIMedia_response_object_data_attributes::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAIMedia_response_object_data_attributes::is_external_id_Valid() const{
    return m_external_id_isValid;
}

bool OAIMedia_response_object_data_attributes::isHasFetchError() const {
    return m_has_fetch_error;
}
void OAIMedia_response_object_data_attributes::setHasFetchError(const bool &has_fetch_error) {
    m_has_fetch_error = has_fetch_error;
    m_has_fetch_error_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_has_fetch_error_Set() const{
    return m_has_fetch_error_isSet;
}

bool OAIMedia_response_object_data_attributes::is_has_fetch_error_Valid() const{
    return m_has_fetch_error_isValid;
}

bool OAIMedia_response_object_data_attributes::isIsProcessing() const {
    return m_is_processing;
}
void OAIMedia_response_object_data_attributes::setIsProcessing(const bool &is_processing) {
    m_is_processing = is_processing;
    m_is_processing_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_is_processing_Set() const{
    return m_is_processing_isSet;
}

bool OAIMedia_response_object_data_attributes::is_is_processing_Valid() const{
    return m_is_processing_isValid;
}

QString OAIMedia_response_object_data_attributes::getName() const {
    return m_name;
}
void OAIMedia_response_object_data_attributes::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMedia_response_object_data_attributes::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIMedia_response_object_data_attributes::getOriginalCreatedAt() const {
    return m_original_created_at;
}
void OAIMedia_response_object_data_attributes::setOriginalCreatedAt(const QString &original_created_at) {
    m_original_created_at = original_created_at;
    m_original_created_at_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_original_created_at_Set() const{
    return m_original_created_at_isSet;
}

bool OAIMedia_response_object_data_attributes::is_original_created_at_Valid() const{
    return m_original_created_at_isValid;
}

QString OAIMedia_response_object_data_attributes::getProcessingStartedAt() const {
    return m_processing_started_at;
}
void OAIMedia_response_object_data_attributes::setProcessingStartedAt(const QString &processing_started_at) {
    m_processing_started_at = processing_started_at;
    m_processing_started_at_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_processing_started_at_Set() const{
    return m_processing_started_at_isSet;
}

bool OAIMedia_response_object_data_attributes::is_processing_started_at_Valid() const{
    return m_processing_started_at_isValid;
}

QString OAIMedia_response_object_data_attributes::getSourceCreatedAt() const {
    return m_source_created_at;
}
void OAIMedia_response_object_data_attributes::setSourceCreatedAt(const QString &source_created_at) {
    m_source_created_at = source_created_at;
    m_source_created_at_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_source_created_at_Set() const{
    return m_source_created_at_isSet;
}

bool OAIMedia_response_object_data_attributes::is_source_created_at_Valid() const{
    return m_source_created_at_isValid;
}

QString OAIMedia_response_object_data_attributes::getSourceFileContentType() const {
    return m_source_file_content_type;
}
void OAIMedia_response_object_data_attributes::setSourceFileContentType(const QString &source_file_content_type) {
    m_source_file_content_type = source_file_content_type;
    m_source_file_content_type_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_source_file_content_type_Set() const{
    return m_source_file_content_type_isSet;
}

bool OAIMedia_response_object_data_attributes::is_source_file_content_type_Valid() const{
    return m_source_file_content_type_isValid;
}

double OAIMedia_response_object_data_attributes::getSourceFileDuration() const {
    return m_source_file_duration;
}
void OAIMedia_response_object_data_attributes::setSourceFileDuration(const double &source_file_duration) {
    m_source_file_duration = source_file_duration;
    m_source_file_duration_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_source_file_duration_Set() const{
    return m_source_file_duration_isSet;
}

bool OAIMedia_response_object_data_attributes::is_source_file_duration_Valid() const{
    return m_source_file_duration_isValid;
}

double OAIMedia_response_object_data_attributes::getSourceFileHeight() const {
    return m_source_file_height;
}
void OAIMedia_response_object_data_attributes::setSourceFileHeight(const double &source_file_height) {
    m_source_file_height = source_file_height;
    m_source_file_height_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_source_file_height_Set() const{
    return m_source_file_height_isSet;
}

bool OAIMedia_response_object_data_attributes::is_source_file_height_Valid() const{
    return m_source_file_height_isValid;
}

QString OAIMedia_response_object_data_attributes::getSourceFilePreviewImageUrl() const {
    return m_source_file_preview_image_url;
}
void OAIMedia_response_object_data_attributes::setSourceFilePreviewImageUrl(const QString &source_file_preview_image_url) {
    m_source_file_preview_image_url = source_file_preview_image_url;
    m_source_file_preview_image_url_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_source_file_preview_image_url_Set() const{
    return m_source_file_preview_image_url_isSet;
}

bool OAIMedia_response_object_data_attributes::is_source_file_preview_image_url_Valid() const{
    return m_source_file_preview_image_url_isValid;
}

double OAIMedia_response_object_data_attributes::getSourceFileWidth() const {
    return m_source_file_width;
}
void OAIMedia_response_object_data_attributes::setSourceFileWidth(const double &source_file_width) {
    m_source_file_width = source_file_width;
    m_source_file_width_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_source_file_width_Set() const{
    return m_source_file_width_isSet;
}

bool OAIMedia_response_object_data_attributes::is_source_file_width_Valid() const{
    return m_source_file_width_isValid;
}

QString OAIMedia_response_object_data_attributes::getSourceUrl() const {
    return m_source_url;
}
void OAIMedia_response_object_data_attributes::setSourceUrl(const QString &source_url) {
    m_source_url = source_url;
    m_source_url_isSet = true;
}

bool OAIMedia_response_object_data_attributes::is_source_url_Set() const{
    return m_source_url_isSet;
}

bool OAIMedia_response_object_data_attributes::is_source_url_Valid() const{
    return m_source_url_isValid;
}

bool OAIMedia_response_object_data_attributes::isSet() const {
...
bool OAIMedia_response_object_data_attributes::isValid() const {
