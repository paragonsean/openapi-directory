...
/*
 * OAI_medias_post_request_payload_data_relationships.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_data_relationships_H
#define OAI_medias_post_request_payload_data_relationships_H
...
namespace OpenAPI {
class OAI_medias_post_request_payload_data_relationships_clips;

class OAI_medias_post_request_payload_data_relationships : public OAIObject {
public:
    OAI_medias_post_request_payload_data_relationships();
    OAI_medias_post_request_payload_data_relationships(QString json);
    ~OAI_medias_post_request_payload_data_relationships() override;
    ...
    OAI_medias_post_request_payload_data_relationships_clips getClips() const;
    void setClips(const OAI_medias_post_request_payload_data_relationships_clips &clips);
...
private:
    ...
    OAI_medias_post_request_payload_data_relationships_clips m_clips;
    bool m_clips_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_data_relationships)

#endif // OAI_medias_post_request_payload_data_relationships_H
