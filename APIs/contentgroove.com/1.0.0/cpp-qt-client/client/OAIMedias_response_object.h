...
/*
 * OAIMedias_response_object.h
 *
 * 
 */

#ifndef OAIMedias_response_object_H
#define OAIMedias_response_object_H
...
class OAIMedias_response_object : public OAIObject {
public:
    OAIMedias_response_object();
    OAIMedias_response_object(QString json);
    ~OAIMedias_response_object() override;
    ...
    QList<OAIMedia_response_object_data> getData() const;
    void setData(const QList<OAIMedia_response_object_data> &data);
...
private:
    ...
    QList<OAIMedia_response_object_data> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMedias_response_object)

#endif // OAIMedias_response_object_H
