...
/*
 * OAI_medias_post_request_payload_included_inner_oneOf_attributes.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_included_inner_oneOf_attributes_H
#define OAI_medias_post_request_payload_included_inner_oneOf_attributes_H
...
class OAI_medias_post_request_payload_included_inner_oneOf_attributes : public OAIObject {
public:
    OAI_medias_post_request_payload_included_inner_oneOf_attributes();
    OAI_medias_post_request_payload_included_inner_oneOf_attributes(QString json);
    ~OAI_medias_post_request_payload_included_inner_oneOf_attributes() override;
    ...
    QString getEndChar() const;
    void setEndChar(const QString &end_char);
    bool is_end_char_Set() const;
    bool is_end_char_Valid() const;
    ...
    QString getMediaFileContentType() const;
    void setMediaFileContentType(const QString &media_file_content_type);
    bool is_media_file_content_type_Set() const;
    bool is_media_file_content_type_Valid() const;

    double getMediaFileDuration() const;
    void setMediaFileDuration(const double &media_file_duration);
    bool is_media_file_duration_Set() const;
    bool is_media_file_duration_Valid() const;

    double getMediaFileHeight() const;
    void setMediaFileHeight(const double &media_file_height);
    bool is_media_file_height_Set() const;
    bool is_media_file_height_Valid() const;

    QString getMediaFilePreviewImageUrl() const;
    void setMediaFilePreviewImageUrl(const QString &media_file_preview_image_url);
    bool is_media_file_preview_image_url_Set() const;
    bool is_media_file_preview_image_url_Valid() const;

    QString getMediaFileUrl() const;
    void setMediaFileUrl(const QString &media_file_url);
    bool is_media_file_url_Set() const;
    bool is_media_file_url_Valid() const;

    double getMediaFileWidth() const;
    void setMediaFileWidth(const double &media_file_width);
    bool is_media_file_width_Set() const;
    bool is_media_file_width_Valid() const;
    ...
    qint32 getStartChar() const;
    void setStartChar(const qint32 &start_char);
    bool is_start_char_Set() const;
    bool is_start_char_Valid() const;
...
private:
    ...
    QString m_end_char;
    bool m_end_char_isSet;
    bool m_end_char_isValid;
    ...
    QString m_media_file_content_type;
    bool m_media_file_content_type_isSet;
    bool m_media_file_content_type_isValid;

    double m_media_file_duration;
    bool m_media_file_duration_isSet;
    bool m_media_file_duration_isValid;

    double m_media_file_height;
    bool m_media_file_height_isSet;
    bool m_media_file_height_isValid;

    QString m_media_file_preview_image_url;
    bool m_media_file_preview_image_url_isSet;
    bool m_media_file_preview_image_url_isValid;

    QString m_media_file_url;
    bool m_media_file_url_isSet;
    bool m_media_file_url_isValid;

    double m_media_file_width;
    bool m_media_file_width_isSet;
    bool m_media_file_width_isValid;
    ...
    qint32 m_start_char;
    bool m_start_char_isSet;
    bool m_start_char_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_included_inner_oneOf_attributes)

#endif // OAI_medias_post_request_payload_included_inner_oneOf_attributes_H
