...
/*
 * OAI_medias_post_request_payload_data_relationships_clips_data_inner.h
 *
 * 
 */

#ifndef OAI_medias_post_request_payload_data_relationships_clips_data_inner_H
#define OAI_medias_post_request_payload_data_relationships_clips_data_inner_H
...
class OAI_medias_post_request_payload_data_relationships_clips_data_inner : public OAIObject {
public:
    OAI_medias_post_request_payload_data_relationships_clips_data_inner();
    OAI_medias_post_request_payload_data_relationships_clips_data_inner(QString json);
    ~OAI_medias_post_request_payload_data_relationships_clips_data_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_medias_post_request_payload_data_relationships_clips_data_inner)

#endif // OAI_medias_post_request_payload_data_relationships_clips_data_inner_H
