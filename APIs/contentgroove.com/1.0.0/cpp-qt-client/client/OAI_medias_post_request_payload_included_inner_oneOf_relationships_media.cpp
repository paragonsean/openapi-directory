...
#include "OAI_medias_post_request_payload_included_inner_oneOf_relationships_media.h"
...
OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::OAI_medias_post_request_payload_included_inner_oneOf_relationships_media(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::OAI_medias_post_request_payload_included_inner_oneOf_relationships_media() {
    this->initializeModel();
}

OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::~OAI_medias_post_request_payload_included_inner_oneOf_relationships_media() {}

void OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::fromJson(QString jsonString) {
...
void OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::asJson() const {
...
QJsonObject OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::getData() const {
    return m_data;
}
void OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::setData(const OAI_medias_post_request_payload_included_inner_oneOf_relationships_media_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::is_data_Set() const{
    return m_data_isSet;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::is_data_Valid() const{
    return m_data_isValid;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::isSet() const {
...
bool OAI_medias_post_request_payload_included_inner_oneOf_relationships_media::isValid() const {
