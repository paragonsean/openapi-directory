...
/*
 * OAIDirect_upload_response_object_data.h
 *
 * 
 */

#ifndef OAIDirect_upload_response_object_data_H
#define OAIDirect_upload_response_object_data_H

#include <QJsonObject>

#include "OAIDirect_upload_response_object_data_attributes.h"
#include <QString>
...
namespace OpenAPI {
class OAIDirect_upload_response_object_data_attributes;

class OAIDirect_upload_response_object_data : public OAIObject {
public:
    OAIDirect_upload_response_object_data();
    OAIDirect_upload_response_object_data(QString json);
    ~OAIDirect_upload_response_object_data() override;
    ...
    OAIDirect_upload_response_object_data_attributes getAttributes() const;
    void setAttributes(const OAIDirect_upload_response_object_data_attributes &attributes);
...
private:
    ...
    OAIDirect_upload_response_object_data_attributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDirect_upload_response_object_data)

#endif // OAIDirect_upload_response_object_data_H
