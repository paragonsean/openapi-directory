...
OAIMedia_response_object::OAIMedia_response_object(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMedia_response_object::OAIMedia_response_object() {
    this->initializeModel();
}

OAIMedia_response_object::~OAIMedia_response_object() {}

void OAIMedia_response_object::initializeModel() {
...
void OAIMedia_response_object::fromJson(QString jsonString) {
...
void OAIMedia_response_object::fromJsonObject(QJsonObject json) {
...
QString OAIMedia_response_object::asJson() const {
...
QJsonObject OAIMedia_response_object::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIMedia_response_object_data OAIMedia_response_object::getData() const {
    return m_data;
}
void OAIMedia_response_object::setData(const OAIMedia_response_object_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIMedia_response_object::is_data_Set() const{
    return m_data_isSet;
}

bool OAIMedia_response_object::is_data_Valid() const{
    return m_data_isValid;
}

OAILinks_object_data OAIMedia_response_object::getLinks() const {
    return m_links;
}
void OAIMedia_response_object::setLinks(const OAILinks_object_data &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIMedia_response_object::is_links_Set() const{
    return m_links_isSet;
}

bool OAIMedia_response_object::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIMedia_response_object::isSet() const {
...
bool OAIMedia_response_object::isValid() const {
