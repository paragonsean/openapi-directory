...
OAICreateWebhookSubscription_request_data::OAICreateWebhookSubscription_request_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateWebhookSubscription_request_data::OAICreateWebhookSubscription_request_data() {
    this->initializeModel();
}

OAICreateWebhookSubscription_request_data::~OAICreateWebhookSubscription_request_data() {}

void OAICreateWebhookSubscription_request_data::initializeModel() {

    m_attributes_isSet = false;
    m_attributes_isValid = false;
}

void OAICreateWebhookSubscription_request_data::fromJson(QString jsonString) {
...
void OAICreateWebhookSubscription_request_data::fromJsonObject(QJsonObject json) {

    m_attributes_isValid = ::OpenAPI::fromJsonValue(m_attributes, json[QString("attributes")]);
    m_attributes_isSet = !json[QString("attributes")].isNull() && m_attributes_isValid;
}

QString OAICreateWebhookSubscription_request_data::asJson() const {
...
QJsonObject OAICreateWebhookSubscription_request_data::asJsonObject() const {
    QJsonObject obj;
...
OAICreateWebhookSubscription_request_data_attributes OAICreateWebhookSubscription_request_data::getAttributes() const {
    return m_attributes;
}
void OAICreateWebhookSubscription_request_data::setAttributes(const OAICreateWebhookSubscription_request_data_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAICreateWebhookSubscription_request_data::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAICreateWebhookSubscription_request_data::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAICreateWebhookSubscription_request_data::isSet() const {
...
bool OAICreateWebhookSubscription_request_data::isValid() const {
