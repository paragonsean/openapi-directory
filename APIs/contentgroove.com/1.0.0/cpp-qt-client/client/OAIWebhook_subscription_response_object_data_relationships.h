...
/*
 * OAIWebhook_subscription_response_object_data_relationships.h
 *
 * 
 */

#ifndef OAIWebhook_subscription_response_object_data_relationships_H
#define OAIWebhook_subscription_response_object_data_relationships_H

#include <QJsonObject>

#include "OAIClip_response_object_data_relationships_media.h"
#include "OAIMedia_response_object_data_relationships_clips.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIClip_response_object_data_relationships_media;
class OAIMedia_response_object_data_relationships_clips;

class OAIWebhook_subscription_response_object_data_relationships : public OAIObject {
public:
    OAIWebhook_subscription_response_object_data_relationships();
    OAIWebhook_subscription_response_object_data_relationships(QString json);
    ~OAIWebhook_subscription_response_object_data_relationships() override;
    ...
    OAIClip_response_object_data_relationships_media getUser() const;
    void setUser(const OAIClip_response_object_data_relationships_media &user);
    bool is_user_Set() const;
    bool is_user_Valid() const;

    OAIMedia_response_object_data_relationships_clips getWebhookEvents() const;
    void setWebhookEvents(const OAIMedia_response_object_data_relationships_clips &webhook_events);
...
private:
    ...
    OAIClip_response_object_data_relationships_media m_user;
    bool m_user_isSet;
    bool m_user_isValid;

    OAIMedia_response_object_data_relationships_clips m_webhook_events;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhook_subscription_response_object_data_relationships)

#endif // OAIWebhook_subscription_response_object_data_relationships_H
