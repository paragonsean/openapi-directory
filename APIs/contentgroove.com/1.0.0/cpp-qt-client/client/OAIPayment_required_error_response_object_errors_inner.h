...
/*
 * OAIPayment_required_error_response_object_errors_inner.h
 *
 * 
 */

#ifndef OAIPayment_required_error_response_object_errors_inner_H
#define OAIPayment_required_error_response_object_errors_inner_H

#include <QJsonObject>

#include "OAIPayment_required_error_response_object_errors_inner_source.h"
#include <QString>
...
namespace OpenAPI {
class OAIPayment_required_error_response_object_errors_inner_source;

class OAIPayment_required_error_response_object_errors_inner : public OAIObject {
public:
    OAIPayment_required_error_response_object_errors_inner();
    OAIPayment_required_error_response_object_errors_inner(QString json);
    ~OAIPayment_required_error_response_object_errors_inner() override;
    ...
    OAIPayment_required_error_response_object_errors_inner_source getSource() const;
    void setSource(const OAIPayment_required_error_response_object_errors_inner_source &source);
...
private:
    ...
    OAIPayment_required_error_response_object_errors_inner_source m_source;
    bool m_source_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayment_required_error_response_object_errors_inner)

#endif // OAIPayment_required_error_response_object_errors_inner_H
