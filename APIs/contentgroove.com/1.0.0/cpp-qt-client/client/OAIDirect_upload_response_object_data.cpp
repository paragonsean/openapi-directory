...
#include "OAIDirect_upload_response_object_data.h"
...
OAIDirect_upload_response_object_data::OAIDirect_upload_response_object_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDirect_upload_response_object_data::OAIDirect_upload_response_object_data() {
    this->initializeModel();
}

OAIDirect_upload_response_object_data::~OAIDirect_upload_response_object_data() {}

void OAIDirect_upload_response_object_data::initializeModel() {
...
void OAIDirect_upload_response_object_data::fromJson(QString jsonString) {
...
void OAIDirect_upload_response_object_data::fromJsonObject(QJsonObject json) {
...
QString OAIDirect_upload_response_object_data::asJson() const {
...
QJsonObject OAIDirect_upload_response_object_data::asJsonObject() const {
    QJsonObject obj;
...
OAIDirect_upload_response_object_data_attributes OAIDirect_upload_response_object_data::getAttributes() const {
    return m_attributes;
}
void OAIDirect_upload_response_object_data::setAttributes(const OAIDirect_upload_response_object_data_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIDirect_upload_response_object_data::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIDirect_upload_response_object_data::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIDirect_upload_response_object_data::getId() const {
    return m_id;
}
void OAIDirect_upload_response_object_data::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDirect_upload_response_object_data::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDirect_upload_response_object_data::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDirect_upload_response_object_data::getType() const {
    return m_type;
}
void OAIDirect_upload_response_object_data::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDirect_upload_response_object_data::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDirect_upload_response_object_data::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDirect_upload_response_object_data::isSet() const {
...
bool OAIDirect_upload_response_object_data::isValid() const {
