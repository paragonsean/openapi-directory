...
/*
 * OAIClip_response_object_data_relationships.h
 *
 * 
 */

#ifndef OAIClip_response_object_data_relationships_H
#define OAIClip_response_object_data_relationships_H
...
class OAIClip_response_object_data_relationships : public OAIObject {
public:
    OAIClip_response_object_data_relationships();
    OAIClip_response_object_data_relationships(QString json);
    ~OAIClip_response_object_data_relationships() override;
    ...
    OAIClip_response_object_data_relationships_media getMedia() const;
    void setMedia(const OAIClip_response_object_data_relationships_media &media);
...
private:
    ...
    OAIClip_response_object_data_relationships_media m_media;
    bool m_media_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClip_response_object_data_relationships)

#endif // OAIClip_response_object_data_relationships_H
