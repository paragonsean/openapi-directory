...
#include "OAI_medias_post_request_payload_included_inner_oneOf_relationships.h"
...
OAI_medias_post_request_payload_included_inner_oneOf_relationships::OAI_medias_post_request_payload_included_inner_oneOf_relationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_medias_post_request_payload_included_inner_oneOf_relationships::OAI_medias_post_request_payload_included_inner_oneOf_relationships() {
    this->initializeModel();
}

OAI_medias_post_request_payload_included_inner_oneOf_relationships::~OAI_medias_post_request_payload_included_inner_oneOf_relationships() {}

void OAI_medias_post_request_payload_included_inner_oneOf_relationships::initializeModel() {

    m_media_isSet = false;
    m_media_isValid = false;
}

void OAI_medias_post_request_payload_included_inner_oneOf_relationships::fromJson(QString jsonString) {
...
void OAI_medias_post_request_payload_included_inner_oneOf_relationships::fromJsonObject(QJsonObject json) {

    m_media_isValid = ::OpenAPI::fromJsonValue(m_media, json[QString("media")]);
    m_media_isSet = !json[QString("media")].isNull() && m_media_isValid;
}

QString OAI_medias_post_request_payload_included_inner_oneOf_relationships::asJson() const {
...
QJsonObject OAI_medias_post_request_payload_included_inner_oneOf_relationships::asJsonObject() const {
    QJsonObject obj;
    if (m_media.isSet()) {
...
OAI_medias_post_request_payload_included_inner_oneOf_relationships_media OAI_medias_post_request_payload_included_inner_oneOf_relationships::getMedia() const {
    return m_media;
}
void OAI_medias_post_request_payload_included_inner_oneOf_relationships::setMedia(const OAI_medias_post_request_payload_included_inner_oneOf_relationships_media &media) {
    m_media = media;
    m_media_isSet = true;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_relationships::is_media_Set() const{
    return m_media_isSet;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_relationships::is_media_Valid() const{
    return m_media_isValid;
}

bool OAI_medias_post_request_payload_included_inner_oneOf_relationships::isSet() const {
...
bool OAI_medias_post_request_payload_included_inner_oneOf_relationships::isValid() const {
