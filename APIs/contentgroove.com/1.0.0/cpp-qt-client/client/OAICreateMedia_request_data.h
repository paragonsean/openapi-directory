...
/*
 * OAICreateMedia_request_data.h
 *
 * 
 */

#ifndef OAICreateMedia_request_data_H
#define OAICreateMedia_request_data_H
...
namespace OpenAPI {
class OAICreateMedia_request_data_attributes;

class OAICreateMedia_request_data : public OAIObject {
public:
    OAICreateMedia_request_data();
    OAICreateMedia_request_data(QString json);
    ~OAICreateMedia_request_data() override;
    ...
    OAICreateMedia_request_data_attributes getAttributes() const;
    void setAttributes(const OAICreateMedia_request_data_attributes &attributes);
...
private:
    ...
    OAICreateMedia_request_data_attributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMedia_request_data)

#endif // OAICreateMedia_request_data_H
