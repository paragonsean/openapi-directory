...
#include "OAIUpdateMediaById_request_data.h"
...
OAIUpdateMediaById_request_data::OAIUpdateMediaById_request_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateMediaById_request_data::OAIUpdateMediaById_request_data() {
    this->initializeModel();
}

OAIUpdateMediaById_request_data::~OAIUpdateMediaById_request_data() {}

void OAIUpdateMediaById_request_data::initializeModel() {

    m_attributes_isSet = false;
    m_attributes_isValid = false;
}

void OAIUpdateMediaById_request_data::fromJson(QString jsonString) {
...
void OAIUpdateMediaById_request_data::fromJsonObject(QJsonObject json) {

    m_attributes_isValid = ::OpenAPI::fromJsonValue(m_attributes, json[QString("attributes")]);
    m_attributes_isSet = !json[QString("attributes")].isNull() && m_attributes_isValid;
}

QString OAIUpdateMediaById_request_data::asJson() const {
...
QJsonObject OAIUpdateMediaById_request_data::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateMediaById_request_data_attributes OAIUpdateMediaById_request_data::getAttributes() const {
    return m_attributes;
}
void OAIUpdateMediaById_request_data::setAttributes(const OAIUpdateMediaById_request_data_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIUpdateMediaById_request_data::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIUpdateMediaById_request_data::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAIUpdateMediaById_request_data::isSet() const {
...
bool OAIUpdateMediaById_request_data::isValid() const {
