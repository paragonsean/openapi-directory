...
/*
 * OAIDirect_upload_response_object.h
 *
 * 
 */

#ifndef OAIDirect_upload_response_object_H
#define OAIDirect_upload_response_object_H
...
namespace OpenAPI {
class OAIDirect_upload_response_object_data;

class OAIDirect_upload_response_object : public OAIObject {
public:
    OAIDirect_upload_response_object();
    OAIDirect_upload_response_object(QString json);
    ~OAIDirect_upload_response_object() override;
    ...
    OAIDirect_upload_response_object_data getData() const;
    void setData(const OAIDirect_upload_response_object_data &data);
...
private:
    ...
    OAIDirect_upload_response_object_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIDirect_upload_response_object)

#endif // OAIDirect_upload_response_object_H
