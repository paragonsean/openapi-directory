...
/*
 * OAICreateWebhookSubscription_request_data_attributes.h
 *
 * 
 */

#ifndef OAICreateWebhookSubscription_request_data_attributes_H
#define OAICreateWebhookSubscription_request_data_attributes_H
...
class OAICreateWebhookSubscription_request_data_attributes : public OAIObject {
public:
    OAICreateWebhookSubscription_request_data_attributes();
    OAICreateWebhookSubscription_request_data_attributes(QString json);
    ~OAICreateWebhookSubscription_request_data_attributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWebhookSubscription_request_data_attributes)

#endif // OAICreateWebhookSubscription_request_data_attributes_H
