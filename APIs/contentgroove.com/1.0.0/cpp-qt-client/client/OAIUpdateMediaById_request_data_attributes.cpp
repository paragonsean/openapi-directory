...
OAIUpdateMediaById_request_data_attributes::OAIUpdateMediaById_request_data_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateMediaById_request_data_attributes::OAIUpdateMediaById_request_data_attributes() {
    this->initializeModel();
}

OAIUpdateMediaById_request_data_attributes::~OAIUpdateMediaById_request_data_attributes() {}

void OAIUpdateMediaById_request_data_attributes::initializeModel() {
...
void OAIUpdateMediaById_request_data_attributes::fromJson(QString jsonString) {
...
void OAIUpdateMediaById_request_data_attributes::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateMediaById_request_data_attributes::asJson() const {
...
QJsonObject OAIUpdateMediaById_request_data_attributes::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateMediaById_request_data_attributes::getDescription() const {
    return m_description;
}
void OAIUpdateMediaById_request_data_attributes::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateMediaById_request_data_attributes::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateMediaById_request_data_attributes::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateMediaById_request_data_attributes::getName() const {
    return m_name;
}
void OAIUpdateMediaById_request_data_attributes::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateMediaById_request_data_attributes::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateMediaById_request_data_attributes::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIUpdateMediaById_request_data_attributes::isSet() const {
...
bool OAIUpdateMediaById_request_data_attributes::isValid() const {
