...
OAIPayment_required_error_response_object_errors_inner_source::OAIPayment_required_error_response_object_errors_inner_source(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayment_required_error_response_object_errors_inner_source::OAIPayment_required_error_response_object_errors_inner_source() {
    this->initializeModel();
}

OAIPayment_required_error_response_object_errors_inner_source::~OAIPayment_required_error_response_object_errors_inner_source() {}

void OAIPayment_required_error_response_object_errors_inner_source::initializeModel() {

    m_pointer_isSet = false;
    m_pointer_isValid = false;
}

void OAIPayment_required_error_response_object_errors_inner_source::fromJson(QString jsonString) {
...
void OAIPayment_required_error_response_object_errors_inner_source::fromJsonObject(QJsonObject json) {
...
QString OAIPayment_required_error_response_object_errors_inner_source::asJson() const {
...
QJsonObject OAIPayment_required_error_response_object_errors_inner_source::asJsonObject() const {
    QJsonObject obj;
    if (m_pointer_isSet) {
...
QString OAIPayment_required_error_response_object_errors_inner_source::getPointer() const {
    return m_pointer;
}
void OAIPayment_required_error_response_object_errors_inner_source::setPointer(const QString &pointer) {
    m_pointer = pointer;
    m_pointer_isSet = true;
}

bool OAIPayment_required_error_response_object_errors_inner_source::is_pointer_Set() const{
    return m_pointer_isSet;
}

bool OAIPayment_required_error_response_object_errors_inner_source::is_pointer_Valid() const{
    return m_pointer_isValid;
}

bool OAIPayment_required_error_response_object_errors_inner_source::isSet() const {
...
bool OAIPayment_required_error_response_object_errors_inner_source::isValid() const {
