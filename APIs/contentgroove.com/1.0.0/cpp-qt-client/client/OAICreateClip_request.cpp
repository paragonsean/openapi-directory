...
OAICreateClip_request::OAICreateClip_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateClip_request::OAICreateClip_request() {
    this->initializeModel();
}

OAICreateClip_request::~OAICreateClip_request() {}

void OAICreateClip_request::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAICreateClip_request::fromJson(QString jsonString) {
...
void OAICreateClip_request::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAICreateClip_request::asJson() const {
...
QJsonObject OAICreateClip_request::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAICreateClip_request_data OAICreateClip_request::getData() const {
    return m_data;
}
void OAICreateClip_request::setData(const OAICreateClip_request_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICreateClip_request::is_data_Set() const{
    return m_data_isSet;
}

bool OAICreateClip_request::is_data_Valid() const{
    return m_data_isValid;
}

bool OAICreateClip_request::isSet() const {
...
bool OAICreateClip_request::isValid() const {
