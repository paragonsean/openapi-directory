...
#include "OAI_medias_post_request_payload.h"
...
OAI_medias_post_request_payload::OAI_medias_post_request_payload(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_medias_post_request_payload::OAI_medias_post_request_payload() {
    this->initializeModel();
}

OAI_medias_post_request_payload::~OAI_medias_post_request_payload() {}

void OAI_medias_post_request_payload::initializeModel() {
...
void OAI_medias_post_request_payload::fromJson(QString jsonString) {
...
void OAI_medias_post_request_payload::fromJsonObject(QJsonObject json) {
...
QString OAI_medias_post_request_payload::asJson() const {
...
QJsonObject OAI_medias_post_request_payload::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAI_medias_post_request_payload_data OAI_medias_post_request_payload::getData() const {
    return m_data;
}
void OAI_medias_post_request_payload::setData(const OAI_medias_post_request_payload_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAI_medias_post_request_payload::is_data_Set() const{
    return m_data_isSet;
}

bool OAI_medias_post_request_payload::is_data_Valid() const{
    return m_data_isValid;
}

QList<OAI_medias_post_request_payload_included_inner> OAI_medias_post_request_payload::getIncluded() const {
    return m_included;
}
void OAI_medias_post_request_payload::setIncluded(const QList<OAI_medias_post_request_payload_included_inner> &included) {
    m_included = included;
    m_included_isSet = true;
}

bool OAI_medias_post_request_payload::is_included_Set() const{
    return m_included_isSet;
}

bool OAI_medias_post_request_payload::is_included_Valid() const{
    return m_included_isValid;
}

bool OAI_medias_post_request_payload::isSet() const {
...
bool OAI_medias_post_request_payload::isValid() const {
