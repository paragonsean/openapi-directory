...
import org.openapitools.client.model.WebhookSubscriptionResponseObjectData;
...
public class WebhookSubscriptionResponseObject {
  ...
  private WebhookSubscriptionResponseObjectData data;
  ...
  public WebhookSubscriptionResponseObject data(WebhookSubscriptionResponseObjectData data) {
    this.data = data;
    return this;
  }
  ...
  public WebhookSubscriptionResponseObjectData getData() {
    return data;
  }

  public void setData(WebhookSubscriptionResponseObjectData data) {
    this.data = data;
  }


  public WebhookSubscriptionResponseObject links(LinksObjectData links) {
    this.links = links;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebhookSubscriptionResponseObject webhookSubscriptionResponseObject = (WebhookSubscriptionResponseObject) o;
    return Objects.equals(this.data, webhookSubscriptionResponseObject.data) &&
        Objects.equals(this.links, webhookSubscriptionResponseObject.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookSubscriptionResponseObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookSubscriptionResponseObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookSubscriptionResponseObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookSubscriptionResponseObject is not found in the empty JSON string", WebhookSubscriptionResponseObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookSubscriptionResponseObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookSubscriptionResponseObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        WebhookSubscriptionResponseObjectData.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookSubscriptionResponseObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookSubscriptionResponseObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookSubscriptionResponseObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookSubscriptionResponseObject.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookSubscriptionResponseObject>() {
           @Override
           public void write(JsonWriter out, WebhookSubscriptionResponseObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookSubscriptionResponseObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebhookSubscriptionResponseObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebhookSubscriptionResponseObject
   * @throws IOException if the JSON string is invalid with respect to WebhookSubscriptionResponseObject
   */
  public static WebhookSubscriptionResponseObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookSubscriptionResponseObject.class);
  }

  /**
   * Convert an instance of WebhookSubscriptionResponseObject to an JSON string
   *
   * @return JSON string
   */
