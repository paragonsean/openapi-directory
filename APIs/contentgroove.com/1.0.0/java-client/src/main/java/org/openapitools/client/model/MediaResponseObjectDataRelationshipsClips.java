...
public class MediaResponseObjectDataRelationshipsClips {
  ...
  private List<ClipResponseObjectDataRelationshipsMediaData> data = new ArrayList<>();

  public MediaResponseObjectDataRelationshipsClips() {
  }

  public MediaResponseObjectDataRelationshipsClips data(List<ClipResponseObjectDataRelationshipsMediaData> data) {
    this.data = data;
    return this;
  }

  public MediaResponseObjectDataRelationshipsClips addDataItem(ClipResponseObjectDataRelationshipsMediaData dataItem) {
    if (this.data == null) {
  ...
  public List<ClipResponseObjectDataRelationshipsMediaData> getData() {
    return data;
  }

  public void setData(List<ClipResponseObjectDataRelationshipsMediaData> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediaResponseObjectDataRelationshipsClips mediaResponseObjectDataRelationshipsClips = (MediaResponseObjectDataRelationshipsClips) o;
    return Objects.equals(this.data, mediaResponseObjectDataRelationshipsClips.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediaResponseObjectDataRelationshipsClips {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediaResponseObjectDataRelationshipsClips
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediaResponseObjectDataRelationshipsClips.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediaResponseObjectDataRelationshipsClips is not found in the empty JSON string", MediaResponseObjectDataRelationshipsClips.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediaResponseObjectDataRelationshipsClips.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediaResponseObjectDataRelationshipsClips` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ClipResponseObjectDataRelationshipsMediaData.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediaResponseObjectDataRelationshipsClips.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediaResponseObjectDataRelationshipsClips' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediaResponseObjectDataRelationshipsClips> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediaResponseObjectDataRelationshipsClips.class));

       return (TypeAdapter<T>) new TypeAdapter<MediaResponseObjectDataRelationshipsClips>() {
           @Override
           public void write(JsonWriter out, MediaResponseObjectDataRelationshipsClips value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediaResponseObjectDataRelationshipsClips read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediaResponseObjectDataRelationshipsClips given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediaResponseObjectDataRelationshipsClips
   * @throws IOException if the JSON string is invalid with respect to MediaResponseObjectDataRelationshipsClips
   */
  public static MediaResponseObjectDataRelationshipsClips fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediaResponseObjectDataRelationshipsClips.class);
  }

  /**
   * Convert an instance of MediaResponseObjectDataRelationshipsClips to an JSON string
   *
   * @return JSON string
   */
