...
import org.openapitools.client.model.MediaResponseObjectDataAttributes;
import org.openapitools.client.model.MediaResponseObjectDataRelationships;
...
public class MediaResponseObjectData {
  ...
  private MediaResponseObjectDataAttributes attributes;
  ...
  private MediaResponseObjectDataRelationships relationships;
  ...
  public MediaResponseObjectData attributes(MediaResponseObjectDataAttributes attributes) {
  ...
  public MediaResponseObjectDataAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(MediaResponseObjectDataAttributes attributes) {
    this.attributes = attributes;
  }


  public MediaResponseObjectData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MediaResponseObjectData relationships(MediaResponseObjectDataRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public MediaResponseObjectDataRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(MediaResponseObjectDataRelationships relationships) {
    this.relationships = relationships;
  }


  public MediaResponseObjectData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediaResponseObjectData mediaResponseObjectData = (MediaResponseObjectData) o;
    return Objects.equals(this.attributes, mediaResponseObjectData.attributes) &&
        Objects.equals(this.id, mediaResponseObjectData.id) &&
        Objects.equals(this.relationships, mediaResponseObjectData.relationships) &&
        Objects.equals(this.type, mediaResponseObjectData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediaResponseObjectData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediaResponseObjectData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediaResponseObjectData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediaResponseObjectData is not found in the empty JSON string", MediaResponseObjectData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediaResponseObjectData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediaResponseObjectData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        MediaResponseObjectDataAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        MediaResponseObjectDataRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediaResponseObjectData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediaResponseObjectData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediaResponseObjectData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediaResponseObjectData.class));

       return (TypeAdapter<T>) new TypeAdapter<MediaResponseObjectData>() {
           @Override
           public void write(JsonWriter out, MediaResponseObjectData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediaResponseObjectData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediaResponseObjectData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediaResponseObjectData
   * @throws IOException if the JSON string is invalid with respect to MediaResponseObjectData
   */
  public static MediaResponseObjectData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediaResponseObjectData.class);
  }

  /**
   * Convert an instance of MediaResponseObjectData to an JSON string
   *
   * @return JSON string
   */
