...
import org.openapitools.client.model.UpdateMediaByIdRequestData;
...
public class UpdateMediaByIdRequest {
  ...
  private UpdateMediaByIdRequestData data;

  public UpdateMediaByIdRequest() {
  }

  public UpdateMediaByIdRequest data(UpdateMediaByIdRequestData data) {
    this.data = data;
    return this;
  }
  ...
  public UpdateMediaByIdRequestData getData() {
    return data;
  }

  public void setData(UpdateMediaByIdRequestData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateMediaByIdRequest updateMediaByIdRequest = (UpdateMediaByIdRequest) o;
    return Objects.equals(this.data, updateMediaByIdRequest.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateMediaByIdRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMediaByIdRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMediaByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMediaByIdRequest is not found in the empty JSON string", UpdateMediaByIdRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMediaByIdRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMediaByIdRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateMediaByIdRequest.openapiRequiredFields) {
      ...
      UpdateMediaByIdRequestData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMediaByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMediaByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMediaByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMediaByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMediaByIdRequest>() {
           @Override
           public void write(JsonWriter out, UpdateMediaByIdRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMediaByIdRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMediaByIdRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMediaByIdRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateMediaByIdRequest
   */
  public static UpdateMediaByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMediaByIdRequest.class);
  }

  /**
   * Convert an instance of UpdateMediaByIdRequest to an JSON string
   *
   * @return JSON string
   */
