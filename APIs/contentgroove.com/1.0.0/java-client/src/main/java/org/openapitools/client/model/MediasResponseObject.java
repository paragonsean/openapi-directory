...
public class MediasResponseObject {
  ...
  private List<MediaResponseObjectData> data = new ArrayList<>();
  ...
  public MediasResponseObject data(List<MediaResponseObjectData> data) {
    this.data = data;
    return this;
  }

  public MediasResponseObject addDataItem(MediaResponseObjectData dataItem) {
    if (this.data == null) {
  ...
  public List<MediaResponseObjectData> getData() {
    return data;
  }

  public void setData(List<MediaResponseObjectData> data) {
    this.data = data;
  }


  public MediasResponseObject links(LinksObjectData links) {
    this.links = links;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasResponseObject mediasResponseObject = (MediasResponseObject) o;
    return Objects.equals(this.data, mediasResponseObject.data) &&
        Objects.equals(this.links, mediasResponseObject.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasResponseObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasResponseObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasResponseObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasResponseObject is not found in the empty JSON string", MediasResponseObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasResponseObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasResponseObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            MediaResponseObjectData.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasResponseObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasResponseObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasResponseObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasResponseObject.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasResponseObject>() {
           @Override
           public void write(JsonWriter out, MediasResponseObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasResponseObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasResponseObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasResponseObject
   * @throws IOException if the JSON string is invalid with respect to MediasResponseObject
   */
  public static MediasResponseObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasResponseObject.class);
  }

  /**
   * Convert an instance of MediasResponseObject to an JSON string
   *
   * @return JSON string
   */
