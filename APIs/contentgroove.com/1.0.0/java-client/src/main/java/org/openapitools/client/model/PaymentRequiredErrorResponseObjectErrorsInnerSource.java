...
public class PaymentRequiredErrorResponseObjectErrorsInnerSource {
  public static final String SERIALIZED_NAME_POINTER = "pointer";
  @SerializedName(SERIALIZED_NAME_POINTER)
  private String pointer;

  public PaymentRequiredErrorResponseObjectErrorsInnerSource() {
  }

  public PaymentRequiredErrorResponseObjectErrorsInnerSource pointer(String pointer) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentRequiredErrorResponseObjectErrorsInnerSource paymentRequiredErrorResponseObjectErrorsInnerSource = (PaymentRequiredErrorResponseObjectErrorsInnerSource) o;
    return Objects.equals(this.pointer, paymentRequiredErrorResponseObjectErrorsInnerSource.pointer);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentRequiredErrorResponseObjectErrorsInnerSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentRequiredErrorResponseObjectErrorsInnerSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentRequiredErrorResponseObjectErrorsInnerSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentRequiredErrorResponseObjectErrorsInnerSource is not found in the empty JSON string", PaymentRequiredErrorResponseObjectErrorsInnerSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentRequiredErrorResponseObjectErrorsInnerSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentRequiredErrorResponseObjectErrorsInnerSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentRequiredErrorResponseObjectErrorsInnerSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentRequiredErrorResponseObjectErrorsInnerSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentRequiredErrorResponseObjectErrorsInnerSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentRequiredErrorResponseObjectErrorsInnerSource.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentRequiredErrorResponseObjectErrorsInnerSource>() {
           @Override
           public void write(JsonWriter out, PaymentRequiredErrorResponseObjectErrorsInnerSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentRequiredErrorResponseObjectErrorsInnerSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentRequiredErrorResponseObjectErrorsInnerSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentRequiredErrorResponseObjectErrorsInnerSource
   * @throws IOException if the JSON string is invalid with respect to PaymentRequiredErrorResponseObjectErrorsInnerSource
   */
  public static PaymentRequiredErrorResponseObjectErrorsInnerSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentRequiredErrorResponseObjectErrorsInnerSource.class);
  }

  /**
   * Convert an instance of PaymentRequiredErrorResponseObjectErrorsInnerSource to an JSON string
   *
   * @return JSON string
   */
