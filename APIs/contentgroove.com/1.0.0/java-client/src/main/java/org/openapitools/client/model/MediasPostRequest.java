...
import org.openapitools.client.model.MediasPostRequestPayload;
...
public class MediasPostRequest {
  ...
  private MediasPostRequestPayload payload;

  public MediasPostRequest() {
  }

  public MediasPostRequest event(String event) {
    this.event = event;
    return this;
  }
  ...
  public MediasPostRequest payload(MediasPostRequestPayload payload) {
   ...
   */
  @javax.annotation.Nullable
  public MediasPostRequestPayload getPayload() {
    return payload;
  }

  public void setPayload(MediasPostRequestPayload payload) {
    this.payload = payload;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequest mediasPostRequest = (MediasPostRequest) o;
    return Objects.equals(this.event, mediasPostRequest.event) &&
        Objects.equals(this.payload, mediasPostRequest.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequest is not found in the empty JSON string", MediasPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("payload") != null && !jsonObj.get("payload").isJsonNull()) {
        MediasPostRequestPayload.validateJsonElement(jsonObj.get("payload"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequest>() {
           @Override
           public void write(JsonWriter out, MediasPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequest
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequest
   */
  public static MediasPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequest.class);
  }

  /**
   * Convert an instance of MediasPostRequest to an JSON string
   *
   * @return JSON string
   */
