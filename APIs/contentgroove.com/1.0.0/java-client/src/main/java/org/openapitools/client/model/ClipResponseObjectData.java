...
import org.openapitools.client.model.ClipResponseObjectDataAttributes;
import org.openapitools.client.model.ClipResponseObjectDataRelationships;
...
public class ClipResponseObjectData {
  public static final String SERIALIZED_NAME_ATTRIBUTES = "attributes";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES)
  private ClipResponseObjectDataAttributes attributes;
  ...
  private ClipResponseObjectDataRelationships relationships;

  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private String type;

  public ClipResponseObjectData() {
  }

  public ClipResponseObjectData attributes(ClipResponseObjectDataAttributes attributes) {
  ...
  public ClipResponseObjectDataAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(ClipResponseObjectDataAttributes attributes) {
    this.attributes = attributes;
  }


  public ClipResponseObjectData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ClipResponseObjectData relationships(ClipResponseObjectDataRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public ClipResponseObjectDataRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(ClipResponseObjectDataRelationships relationships) {
    this.relationships = relationships;
  }


  public ClipResponseObjectData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClipResponseObjectData clipResponseObjectData = (ClipResponseObjectData) o;
    return Objects.equals(this.attributes, clipResponseObjectData.attributes) &&
        Objects.equals(this.id, clipResponseObjectData.id) &&
        Objects.equals(this.relationships, clipResponseObjectData.relationships) &&
        Objects.equals(this.type, clipResponseObjectData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClipResponseObjectData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClipResponseObjectData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClipResponseObjectData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClipResponseObjectData is not found in the empty JSON string", ClipResponseObjectData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClipResponseObjectData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClipResponseObjectData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        ClipResponseObjectDataAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        ClipResponseObjectDataRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClipResponseObjectData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClipResponseObjectData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClipResponseObjectData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClipResponseObjectData.class));

       return (TypeAdapter<T>) new TypeAdapter<ClipResponseObjectData>() {
           @Override
           public void write(JsonWriter out, ClipResponseObjectData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClipResponseObjectData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClipResponseObjectData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClipResponseObjectData
   * @throws IOException if the JSON string is invalid with respect to ClipResponseObjectData
   */
  public static ClipResponseObjectData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClipResponseObjectData.class);
  }

  /**
   * Convert an instance of ClipResponseObjectData to an JSON string
   *
   * @return JSON string
   */
