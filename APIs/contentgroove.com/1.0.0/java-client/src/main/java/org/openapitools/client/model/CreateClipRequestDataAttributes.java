...
public class CreateClipRequestDataAttributes {
  ...
  public CreateClipRequestDataAttributes() {
  }

  public CreateClipRequestDataAttributes endTime(BigDecimal endTime) {
  ...
  public CreateClipRequestDataAttributes mediaId(String mediaId) {
  ...
  public CreateClipRequestDataAttributes name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateClipRequestDataAttributes startTime(BigDecimal startTime) {
  ...
  public boolean equals(Object o) {
    ...
    CreateClipRequestDataAttributes createClipRequestDataAttributes = (CreateClipRequestDataAttributes) o;
    return Objects.equals(this.endTime, createClipRequestDataAttributes.endTime) &&
        Objects.equals(this.mediaId, createClipRequestDataAttributes.mediaId) &&
        Objects.equals(this.name, createClipRequestDataAttributes.name) &&
        Objects.equals(this.startTime, createClipRequestDataAttributes.startTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endTime, mediaId, name, startTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateClipRequestDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateClipRequestDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateClipRequestDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateClipRequestDataAttributes is not found in the empty JSON string", CreateClipRequestDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateClipRequestDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateClipRequestDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateClipRequestDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateClipRequestDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateClipRequestDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateClipRequestDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateClipRequestDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateClipRequestDataAttributes>() {
           @Override
           public void write(JsonWriter out, CreateClipRequestDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateClipRequestDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateClipRequestDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateClipRequestDataAttributes
   * @throws IOException if the JSON string is invalid with respect to CreateClipRequestDataAttributes
   */
  public static CreateClipRequestDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateClipRequestDataAttributes.class);
  }

  /**
   * Convert an instance of CreateClipRequestDataAttributes to an JSON string
   *
   * @return JSON string
   */
