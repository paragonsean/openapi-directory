...
import org.openapitools.client.model.TooManyRequestsErrorResponseObjectErrorsInner;
...
public class TooManyRequestsErrorResponseObject {
  ...
  private List<TooManyRequestsErrorResponseObjectErrorsInner> errors = new ArrayList<>();

  public TooManyRequestsErrorResponseObject() {
  }

  public TooManyRequestsErrorResponseObject errors(List<TooManyRequestsErrorResponseObjectErrorsInner> errors) {
    this.errors = errors;
    return this;
  }

  public TooManyRequestsErrorResponseObject addErrorsItem(TooManyRequestsErrorResponseObjectErrorsInner errorsItem) {
    if (this.errors == null) {
  ...
  public List<TooManyRequestsErrorResponseObjectErrorsInner> getErrors() {
    return errors;
  }

  public void setErrors(List<TooManyRequestsErrorResponseObjectErrorsInner> errors) {
    this.errors = errors;
  }
  ...
  public boolean equals(Object o) {
    ...
    TooManyRequestsErrorResponseObject tooManyRequestsErrorResponseObject = (TooManyRequestsErrorResponseObject) o;
    return Objects.equals(this.errors, tooManyRequestsErrorResponseObject.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class TooManyRequestsErrorResponseObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TooManyRequestsErrorResponseObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TooManyRequestsErrorResponseObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TooManyRequestsErrorResponseObject is not found in the empty JSON string", TooManyRequestsErrorResponseObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TooManyRequestsErrorResponseObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TooManyRequestsErrorResponseObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("errors") != null && !jsonObj.get("errors").isJsonNull()) {
        ...
        if (jsonArrayerrors != null) {
          ...
          for (int i = 0; i < jsonArrayerrors.size(); i++) {
            TooManyRequestsErrorResponseObjectErrorsInner.validateJsonElement(jsonArrayerrors.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TooManyRequestsErrorResponseObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TooManyRequestsErrorResponseObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TooManyRequestsErrorResponseObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TooManyRequestsErrorResponseObject.class));

       return (TypeAdapter<T>) new TypeAdapter<TooManyRequestsErrorResponseObject>() {
           @Override
           public void write(JsonWriter out, TooManyRequestsErrorResponseObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TooManyRequestsErrorResponseObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TooManyRequestsErrorResponseObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TooManyRequestsErrorResponseObject
   * @throws IOException if the JSON string is invalid with respect to TooManyRequestsErrorResponseObject
   */
  public static TooManyRequestsErrorResponseObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TooManyRequestsErrorResponseObject.class);
  }

  /**
   * Convert an instance of TooManyRequestsErrorResponseObject to an JSON string
   *
   * @return JSON string
   */
