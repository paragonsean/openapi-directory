...
import org.openapitools.client.model.PaymentRequiredErrorResponseObjectErrorsInner;
...
public class PaymentRequiredErrorResponseObject {
  ...
  private List<PaymentRequiredErrorResponseObjectErrorsInner> errors = new ArrayList<>();

  public PaymentRequiredErrorResponseObject() {
  }

  public PaymentRequiredErrorResponseObject errors(List<PaymentRequiredErrorResponseObjectErrorsInner> errors) {
    this.errors = errors;
    return this;
  }

  public PaymentRequiredErrorResponseObject addErrorsItem(PaymentRequiredErrorResponseObjectErrorsInner errorsItem) {
    if (this.errors == null) {
  ...
  public List<PaymentRequiredErrorResponseObjectErrorsInner> getErrors() {
    return errors;
  }

  public void setErrors(List<PaymentRequiredErrorResponseObjectErrorsInner> errors) {
    this.errors = errors;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentRequiredErrorResponseObject paymentRequiredErrorResponseObject = (PaymentRequiredErrorResponseObject) o;
    return Objects.equals(this.errors, paymentRequiredErrorResponseObject.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentRequiredErrorResponseObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentRequiredErrorResponseObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentRequiredErrorResponseObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentRequiredErrorResponseObject is not found in the empty JSON string", PaymentRequiredErrorResponseObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentRequiredErrorResponseObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentRequiredErrorResponseObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("errors") != null && !jsonObj.get("errors").isJsonNull()) {
        ...
        if (jsonArrayerrors != null) {
          ...
          for (int i = 0; i < jsonArrayerrors.size(); i++) {
            PaymentRequiredErrorResponseObjectErrorsInner.validateJsonElement(jsonArrayerrors.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentRequiredErrorResponseObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentRequiredErrorResponseObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentRequiredErrorResponseObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentRequiredErrorResponseObject.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentRequiredErrorResponseObject>() {
           @Override
           public void write(JsonWriter out, PaymentRequiredErrorResponseObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentRequiredErrorResponseObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentRequiredErrorResponseObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentRequiredErrorResponseObject
   * @throws IOException if the JSON string is invalid with respect to PaymentRequiredErrorResponseObject
   */
  public static PaymentRequiredErrorResponseObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentRequiredErrorResponseObject.class);
  }

  /**
   * Convert an instance of PaymentRequiredErrorResponseObject to an JSON string
   *
   * @return JSON string
   */
