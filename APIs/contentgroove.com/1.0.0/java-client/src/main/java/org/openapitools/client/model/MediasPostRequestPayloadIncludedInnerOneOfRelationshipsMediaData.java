...
public class MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData {
  ...
  public MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData() {
  }

  public MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData mediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData = (MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData) o;
    return Objects.equals(this.id, mediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.id) &&
        Objects.equals(this.type, mediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData is not found in the empty JSON string", MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData
   */
  public static MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData to an JSON string
   *
   * @return JSON string
   */
