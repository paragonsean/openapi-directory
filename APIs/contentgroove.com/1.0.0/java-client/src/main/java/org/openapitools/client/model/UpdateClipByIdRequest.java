...
public class UpdateClipByIdRequest {
  ...
  private UpdateClipByIdRequestData data;

  public UpdateClipByIdRequest() {
  }

  public UpdateClipByIdRequest data(UpdateClipByIdRequestData data) {
    this.data = data;
    return this;
  }
  ...
  public UpdateClipByIdRequestData getData() {
    return data;
  }

  public void setData(UpdateClipByIdRequestData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateClipByIdRequest updateClipByIdRequest = (UpdateClipByIdRequest) o;
    return Objects.equals(this.data, updateClipByIdRequest.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateClipByIdRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateClipByIdRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateClipByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateClipByIdRequest is not found in the empty JSON string", UpdateClipByIdRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateClipByIdRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateClipByIdRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateClipByIdRequest.openapiRequiredFields) {
      ...
      UpdateClipByIdRequestData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateClipByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateClipByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateClipByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateClipByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateClipByIdRequest>() {
           @Override
           public void write(JsonWriter out, UpdateClipByIdRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateClipByIdRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateClipByIdRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateClipByIdRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateClipByIdRequest
   */
  public static UpdateClipByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateClipByIdRequest.class);
  }

  /**
   * Convert an instance of UpdateClipByIdRequest to an JSON string
   *
   * @return JSON string
   */
