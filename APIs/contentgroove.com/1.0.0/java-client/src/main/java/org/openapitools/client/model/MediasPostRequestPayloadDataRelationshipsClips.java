...
public class MediasPostRequestPayloadDataRelationshipsClips {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<MediasPostRequestPayloadDataRelationshipsClipsDataInner> data = new ArrayList<>();

  public MediasPostRequestPayloadDataRelationshipsClips() {
  }

  public MediasPostRequestPayloadDataRelationshipsClips data(List<MediasPostRequestPayloadDataRelationshipsClipsDataInner> data) {
    this.data = data;
    return this;
  }

  public MediasPostRequestPayloadDataRelationshipsClips addDataItem(MediasPostRequestPayloadDataRelationshipsClipsDataInner dataItem) {
    if (this.data == null) {
  ...
  public List<MediasPostRequestPayloadDataRelationshipsClipsDataInner> getData() {
    return data;
  }

  public void setData(List<MediasPostRequestPayloadDataRelationshipsClipsDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayloadDataRelationshipsClips mediasPostRequestPayloadDataRelationshipsClips = (MediasPostRequestPayloadDataRelationshipsClips) o;
    return Objects.equals(this.data, mediasPostRequestPayloadDataRelationshipsClips.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequestPayloadDataRelationshipsClips {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayloadDataRelationshipsClips
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayloadDataRelationshipsClips.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayloadDataRelationshipsClips is not found in the empty JSON string", MediasPostRequestPayloadDataRelationshipsClips.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayloadDataRelationshipsClips.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayloadDataRelationshipsClips` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            MediasPostRequestPayloadDataRelationshipsClipsDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayloadDataRelationshipsClips.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayloadDataRelationshipsClips' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayloadDataRelationshipsClips> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayloadDataRelationshipsClips.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayloadDataRelationshipsClips>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayloadDataRelationshipsClips value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayloadDataRelationshipsClips read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayloadDataRelationshipsClips given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayloadDataRelationshipsClips
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayloadDataRelationshipsClips
   */
  public static MediasPostRequestPayloadDataRelationshipsClips fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayloadDataRelationshipsClips.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayloadDataRelationshipsClips to an JSON string
   *
   * @return JSON string
   */
