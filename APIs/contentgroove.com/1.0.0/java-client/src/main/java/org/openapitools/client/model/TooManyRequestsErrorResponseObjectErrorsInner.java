...
public class TooManyRequestsErrorResponseObjectErrorsInner {
  ...
  public TooManyRequestsErrorResponseObjectErrorsInner() {
  }

  public TooManyRequestsErrorResponseObjectErrorsInner detail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  public TooManyRequestsErrorResponseObjectErrorsInner status(String status) {
    this.status = status;
    return this;
  }
  ...
  public TooManyRequestsErrorResponseObjectErrorsInner title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TooManyRequestsErrorResponseObjectErrorsInner tooManyRequestsErrorResponseObjectErrorsInner = (TooManyRequestsErrorResponseObjectErrorsInner) o;
    return Objects.equals(this.detail, tooManyRequestsErrorResponseObjectErrorsInner.detail) &&
        Objects.equals(this.status, tooManyRequestsErrorResponseObjectErrorsInner.status) &&
        Objects.equals(this.title, tooManyRequestsErrorResponseObjectErrorsInner.title);
  }
  ...
  public String toString() {
    ...
    sb.append("class TooManyRequestsErrorResponseObjectErrorsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TooManyRequestsErrorResponseObjectErrorsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TooManyRequestsErrorResponseObjectErrorsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TooManyRequestsErrorResponseObjectErrorsInner is not found in the empty JSON string", TooManyRequestsErrorResponseObjectErrorsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TooManyRequestsErrorResponseObjectErrorsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TooManyRequestsErrorResponseObjectErrorsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TooManyRequestsErrorResponseObjectErrorsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TooManyRequestsErrorResponseObjectErrorsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TooManyRequestsErrorResponseObjectErrorsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TooManyRequestsErrorResponseObjectErrorsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<TooManyRequestsErrorResponseObjectErrorsInner>() {
           @Override
           public void write(JsonWriter out, TooManyRequestsErrorResponseObjectErrorsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TooManyRequestsErrorResponseObjectErrorsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TooManyRequestsErrorResponseObjectErrorsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TooManyRequestsErrorResponseObjectErrorsInner
   * @throws IOException if the JSON string is invalid with respect to TooManyRequestsErrorResponseObjectErrorsInner
   */
  public static TooManyRequestsErrorResponseObjectErrorsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TooManyRequestsErrorResponseObjectErrorsInner.class);
  }

  /**
   * Convert an instance of TooManyRequestsErrorResponseObjectErrorsInner to an JSON string
   *
   * @return JSON string
   */
