...
import org.openapitools.client.model.DirectUploadResponseObjectDataAttributes;
...
public class DirectUploadResponseObjectData {
  public static final String SERIALIZED_NAME_ATTRIBUTES = "attributes";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES)
  private DirectUploadResponseObjectDataAttributes attributes;
  ...
  public DirectUploadResponseObjectData() {
  }

  public DirectUploadResponseObjectData attributes(DirectUploadResponseObjectDataAttributes attributes) {
  ...
  public DirectUploadResponseObjectDataAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(DirectUploadResponseObjectDataAttributes attributes) {
    this.attributes = attributes;
  }


  public DirectUploadResponseObjectData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DirectUploadResponseObjectData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DirectUploadResponseObjectData directUploadResponseObjectData = (DirectUploadResponseObjectData) o;
    return Objects.equals(this.attributes, directUploadResponseObjectData.attributes) &&
        Objects.equals(this.id, directUploadResponseObjectData.id) &&
        Objects.equals(this.type, directUploadResponseObjectData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DirectUploadResponseObjectData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DirectUploadResponseObjectData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DirectUploadResponseObjectData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DirectUploadResponseObjectData is not found in the empty JSON string", DirectUploadResponseObjectData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DirectUploadResponseObjectData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DirectUploadResponseObjectData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        DirectUploadResponseObjectDataAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DirectUploadResponseObjectData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DirectUploadResponseObjectData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DirectUploadResponseObjectData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DirectUploadResponseObjectData.class));

       return (TypeAdapter<T>) new TypeAdapter<DirectUploadResponseObjectData>() {
           @Override
           public void write(JsonWriter out, DirectUploadResponseObjectData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DirectUploadResponseObjectData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DirectUploadResponseObjectData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DirectUploadResponseObjectData
   * @throws IOException if the JSON string is invalid with respect to DirectUploadResponseObjectData
   */
  public static DirectUploadResponseObjectData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DirectUploadResponseObjectData.class);
  }

  /**
   * Convert an instance of DirectUploadResponseObjectData to an JSON string
   *
   * @return JSON string
   */
