...
public class ClipResponseObject {
  ...
  private ClipResponseObjectData data;
  ...
  public ClipResponseObject data(ClipResponseObjectData data) {
    this.data = data;
    return this;
  }
  ...
  public ClipResponseObjectData getData() {
    return data;
  }

  public void setData(ClipResponseObjectData data) {
    this.data = data;
  }


  public ClipResponseObject links(LinksObjectData links) {
    this.links = links;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClipResponseObject clipResponseObject = (ClipResponseObject) o;
    return Objects.equals(this.data, clipResponseObject.data) &&
        Objects.equals(this.links, clipResponseObject.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClipResponseObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClipResponseObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClipResponseObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClipResponseObject is not found in the empty JSON string", ClipResponseObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClipResponseObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClipResponseObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ClipResponseObjectData.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClipResponseObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClipResponseObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClipResponseObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClipResponseObject.class));

       return (TypeAdapter<T>) new TypeAdapter<ClipResponseObject>() {
           @Override
           public void write(JsonWriter out, ClipResponseObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClipResponseObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClipResponseObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClipResponseObject
   * @throws IOException if the JSON string is invalid with respect to ClipResponseObject
   */
  public static ClipResponseObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClipResponseObject.class);
  }

  /**
   * Convert an instance of ClipResponseObject to an JSON string
   *
   * @return JSON string
   */
