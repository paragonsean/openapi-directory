...
public class UpdateClipByIdRequestDataAttributes {
  ...
  public UpdateClipByIdRequestDataAttributes() {
  }

  public UpdateClipByIdRequestDataAttributes endTime(BigDecimal endTime) {
  ...
  public UpdateClipByIdRequestDataAttributes name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateClipByIdRequestDataAttributes startTime(BigDecimal startTime) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateClipByIdRequestDataAttributes updateClipByIdRequestDataAttributes = (UpdateClipByIdRequestDataAttributes) o;
    return Objects.equals(this.endTime, updateClipByIdRequestDataAttributes.endTime) &&
        Objects.equals(this.name, updateClipByIdRequestDataAttributes.name) &&
        Objects.equals(this.startTime, updateClipByIdRequestDataAttributes.startTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateClipByIdRequestDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateClipByIdRequestDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateClipByIdRequestDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateClipByIdRequestDataAttributes is not found in the empty JSON string", UpdateClipByIdRequestDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateClipByIdRequestDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateClipByIdRequestDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateClipByIdRequestDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateClipByIdRequestDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateClipByIdRequestDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateClipByIdRequestDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateClipByIdRequestDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdateClipByIdRequestDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateClipByIdRequestDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateClipByIdRequestDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateClipByIdRequestDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdateClipByIdRequestDataAttributes
   */
  public static UpdateClipByIdRequestDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateClipByIdRequestDataAttributes.class);
  }

  /**
   * Convert an instance of UpdateClipByIdRequestDataAttributes to an JSON string
   *
   * @return JSON string
   */
