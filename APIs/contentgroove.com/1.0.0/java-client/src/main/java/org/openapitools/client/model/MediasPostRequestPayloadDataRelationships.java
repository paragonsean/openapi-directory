...
import org.openapitools.client.model.MediasPostRequestPayloadDataRelationshipsClips;
...
public class MediasPostRequestPayloadDataRelationships {
  public static final String SERIALIZED_NAME_CLIPS = "clips";
  @SerializedName(SERIALIZED_NAME_CLIPS)
  private MediasPostRequestPayloadDataRelationshipsClips clips;

  public MediasPostRequestPayloadDataRelationships() {
  }

  public MediasPostRequestPayloadDataRelationships clips(MediasPostRequestPayloadDataRelationshipsClips clips) {
    this.clips = clips;
    return this;
  }
  ...
  public MediasPostRequestPayloadDataRelationshipsClips getClips() {
    return clips;
  }

  public void setClips(MediasPostRequestPayloadDataRelationshipsClips clips) {
    this.clips = clips;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayloadDataRelationships mediasPostRequestPayloadDataRelationships = (MediasPostRequestPayloadDataRelationships) o;
    return Objects.equals(this.clips, mediasPostRequestPayloadDataRelationships.clips);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequestPayloadDataRelationships {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayloadDataRelationships
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayloadDataRelationships.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayloadDataRelationships is not found in the empty JSON string", MediasPostRequestPayloadDataRelationships.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayloadDataRelationships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayloadDataRelationships` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `clips`
      if (jsonObj.get("clips") != null && !jsonObj.get("clips").isJsonNull()) {
        MediasPostRequestPayloadDataRelationshipsClips.validateJsonElement(jsonObj.get("clips"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayloadDataRelationships.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayloadDataRelationships' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayloadDataRelationships> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayloadDataRelationships.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayloadDataRelationships>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayloadDataRelationships value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayloadDataRelationships read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayloadDataRelationships given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayloadDataRelationships
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayloadDataRelationships
   */
  public static MediasPostRequestPayloadDataRelationships fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayloadDataRelationships.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayloadDataRelationships to an JSON string
   *
   * @return JSON string
   */
