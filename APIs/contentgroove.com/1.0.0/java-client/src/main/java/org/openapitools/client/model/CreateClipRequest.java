...
import org.openapitools.client.model.CreateClipRequestData;
...
public class CreateClipRequest {
  ...
  private CreateClipRequestData data;

  public CreateClipRequest() {
  }

  public CreateClipRequest data(CreateClipRequestData data) {
    this.data = data;
    return this;
  }
  ...
  public CreateClipRequestData getData() {
    return data;
  }

  public void setData(CreateClipRequestData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateClipRequest createClipRequest = (CreateClipRequest) o;
    return Objects.equals(this.data, createClipRequest.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateClipRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateClipRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateClipRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateClipRequest is not found in the empty JSON string", CreateClipRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateClipRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateClipRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateClipRequest.openapiRequiredFields) {
      ...
      CreateClipRequestData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateClipRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateClipRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateClipRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateClipRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateClipRequest>() {
           @Override
           public void write(JsonWriter out, CreateClipRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateClipRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateClipRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateClipRequest
   * @throws IOException if the JSON string is invalid with respect to CreateClipRequest
   */
  public static CreateClipRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateClipRequest.class);
  }

  /**
   * Convert an instance of CreateClipRequest to an JSON string
   *
   * @return JSON string
   */
