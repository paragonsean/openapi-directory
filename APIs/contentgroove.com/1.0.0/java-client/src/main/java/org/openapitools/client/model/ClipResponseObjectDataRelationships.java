...
import org.openapitools.client.model.ClipResponseObjectDataRelationshipsMedia;
...
public class ClipResponseObjectDataRelationships {
  ...
  private ClipResponseObjectDataRelationshipsMedia media;

  public ClipResponseObjectDataRelationships() {
  }

  public ClipResponseObjectDataRelationships media(ClipResponseObjectDataRelationshipsMedia media) {
    this.media = media;
    return this;
  }
  ...
  public ClipResponseObjectDataRelationshipsMedia getMedia() {
    return media;
  }

  public void setMedia(ClipResponseObjectDataRelationshipsMedia media) {
    this.media = media;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClipResponseObjectDataRelationships clipResponseObjectDataRelationships = (ClipResponseObjectDataRelationships) o;
    return Objects.equals(this.media, clipResponseObjectDataRelationships.media);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClipResponseObjectDataRelationships {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClipResponseObjectDataRelationships
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClipResponseObjectDataRelationships.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClipResponseObjectDataRelationships is not found in the empty JSON string", ClipResponseObjectDataRelationships.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClipResponseObjectDataRelationships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClipResponseObjectDataRelationships` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `media`
      if (jsonObj.get("media") != null && !jsonObj.get("media").isJsonNull()) {
        ClipResponseObjectDataRelationshipsMedia.validateJsonElement(jsonObj.get("media"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClipResponseObjectDataRelationships.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClipResponseObjectDataRelationships' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClipResponseObjectDataRelationships> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClipResponseObjectDataRelationships.class));

       return (TypeAdapter<T>) new TypeAdapter<ClipResponseObjectDataRelationships>() {
           @Override
           public void write(JsonWriter out, ClipResponseObjectDataRelationships value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClipResponseObjectDataRelationships read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClipResponseObjectDataRelationships given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClipResponseObjectDataRelationships
   * @throws IOException if the JSON string is invalid with respect to ClipResponseObjectDataRelationships
   */
  public static ClipResponseObjectDataRelationships fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClipResponseObjectDataRelationships.class);
  }

  /**
   * Convert an instance of ClipResponseObjectDataRelationships to an JSON string
   *
   * @return JSON string
   */
