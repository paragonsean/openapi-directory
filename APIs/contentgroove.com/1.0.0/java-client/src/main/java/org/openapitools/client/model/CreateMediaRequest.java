...
public class CreateMediaRequest {
  ...
  private CreateMediaRequestData data;

  public CreateMediaRequest() {
  }

  public CreateMediaRequest data(CreateMediaRequestData data) {
    this.data = data;
    return this;
  }
  ...
  public CreateMediaRequestData getData() {
    return data;
  }

  public void setData(CreateMediaRequestData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createMediaRequest.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMediaRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMediaRequest is not found in the empty JSON string", CreateMediaRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMediaRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMediaRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateMediaRequest.openapiRequiredFields) {
      ...
      CreateMediaRequestData.validateJsonElement(jsonObj.get("data"));
  }
