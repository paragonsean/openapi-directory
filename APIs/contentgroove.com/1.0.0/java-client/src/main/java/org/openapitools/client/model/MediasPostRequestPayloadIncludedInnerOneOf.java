...
import org.openapitools.client.model.MediasPostRequestPayloadIncludedInnerOneOfAttributes;
import org.openapitools.client.model.MediasPostRequestPayloadIncludedInnerOneOfRelationships;
...
public class MediasPostRequestPayloadIncludedInnerOneOf {
  public static final String SERIALIZED_NAME_ATTRIBUTES = "attributes";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES)
  private MediasPostRequestPayloadIncludedInnerOneOfAttributes attributes;
  ...
  private MediasPostRequestPayloadIncludedInnerOneOfRelationships relationships;

  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private String type;

  public MediasPostRequestPayloadIncludedInnerOneOf() {
  }

  public MediasPostRequestPayloadIncludedInnerOneOf attributes(MediasPostRequestPayloadIncludedInnerOneOfAttributes attributes) {
  ...
  public MediasPostRequestPayloadIncludedInnerOneOfAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(MediasPostRequestPayloadIncludedInnerOneOfAttributes attributes) {
    this.attributes = attributes;
  }


  public MediasPostRequestPayloadIncludedInnerOneOf id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MediasPostRequestPayloadIncludedInnerOneOf relationships(MediasPostRequestPayloadIncludedInnerOneOfRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public MediasPostRequestPayloadIncludedInnerOneOfRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(MediasPostRequestPayloadIncludedInnerOneOfRelationships relationships) {
    this.relationships = relationships;
  }


  public MediasPostRequestPayloadIncludedInnerOneOf type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayloadIncludedInnerOneOf mediasPostRequestPayloadIncludedInnerOneOf = (MediasPostRequestPayloadIncludedInnerOneOf) o;
    return Objects.equals(this.attributes, mediasPostRequestPayloadIncludedInnerOneOf.attributes) &&
        Objects.equals(this.id, mediasPostRequestPayloadIncludedInnerOneOf.id) &&
        Objects.equals(this.relationships, mediasPostRequestPayloadIncludedInnerOneOf.relationships) &&
        Objects.equals(this.type, mediasPostRequestPayloadIncludedInnerOneOf.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequestPayloadIncludedInnerOneOf {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayloadIncludedInnerOneOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayloadIncludedInnerOneOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayloadIncludedInnerOneOf is not found in the empty JSON string", MediasPostRequestPayloadIncludedInnerOneOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayloadIncludedInnerOneOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayloadIncludedInnerOneOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        MediasPostRequestPayloadIncludedInnerOneOfAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        MediasPostRequestPayloadIncludedInnerOneOfRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayloadIncludedInnerOneOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayloadIncludedInnerOneOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayloadIncludedInnerOneOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayloadIncludedInnerOneOf.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayloadIncludedInnerOneOf>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayloadIncludedInnerOneOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayloadIncludedInnerOneOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayloadIncludedInnerOneOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayloadIncludedInnerOneOf
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayloadIncludedInnerOneOf
   */
  public static MediasPostRequestPayloadIncludedInnerOneOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayloadIncludedInnerOneOf.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayloadIncludedInnerOneOf to an JSON string
   *
   * @return JSON string
   */
