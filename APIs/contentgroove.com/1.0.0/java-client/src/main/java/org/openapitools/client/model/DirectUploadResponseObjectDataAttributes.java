...
public class DirectUploadResponseObjectDataAttributes {
  ...
  public DirectUploadResponseObjectDataAttributes uploadId(String uploadId) {
  ...
  public DirectUploadResponseObjectDataAttributes uploadUrl(String uploadUrl) {
  ...
  public boolean equals(Object o) {
    ...
    DirectUploadResponseObjectDataAttributes directUploadResponseObjectDataAttributes = (DirectUploadResponseObjectDataAttributes) o;
    return Objects.equals(this.uploadId, directUploadResponseObjectDataAttributes.uploadId) &&
        Objects.equals(this.uploadUrl, directUploadResponseObjectDataAttributes.uploadUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class DirectUploadResponseObjectDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DirectUploadResponseObjectDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DirectUploadResponseObjectDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DirectUploadResponseObjectDataAttributes is not found in the empty JSON string", DirectUploadResponseObjectDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DirectUploadResponseObjectDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DirectUploadResponseObjectDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DirectUploadResponseObjectDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DirectUploadResponseObjectDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DirectUploadResponseObjectDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DirectUploadResponseObjectDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<DirectUploadResponseObjectDataAttributes>() {
           @Override
           public void write(JsonWriter out, DirectUploadResponseObjectDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DirectUploadResponseObjectDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DirectUploadResponseObjectDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DirectUploadResponseObjectDataAttributes
   * @throws IOException if the JSON string is invalid with respect to DirectUploadResponseObjectDataAttributes
   */
  public static DirectUploadResponseObjectDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DirectUploadResponseObjectDataAttributes.class);
  }

  /**
   * Convert an instance of DirectUploadResponseObjectDataAttributes to an JSON string
   *
   * @return JSON string
   */
