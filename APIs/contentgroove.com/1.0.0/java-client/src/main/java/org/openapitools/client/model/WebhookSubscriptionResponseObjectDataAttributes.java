...
public class WebhookSubscriptionResponseObjectDataAttributes {
  ...
  public WebhookSubscriptionResponseObjectDataAttributes active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public WebhookSubscriptionResponseObjectDataAttributes createdAt(String createdAt) {
  ...
  public WebhookSubscriptionResponseObjectDataAttributes subscribedEvents(List<String> subscribedEvents) {
    this.subscribedEvents = subscribedEvents;
    return this;
  }

  public WebhookSubscriptionResponseObjectDataAttributes addSubscribedEventsItem(String subscribedEventsItem) {
  ...
  public WebhookSubscriptionResponseObjectDataAttributes updatedAt(String updatedAt) {
  ...
  public WebhookSubscriptionResponseObjectDataAttributes url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebhookSubscriptionResponseObjectDataAttributes webhookSubscriptionResponseObjectDataAttributes = (WebhookSubscriptionResponseObjectDataAttributes) o;
    return Objects.equals(this.active, webhookSubscriptionResponseObjectDataAttributes.active) &&
        Objects.equals(this.createdAt, webhookSubscriptionResponseObjectDataAttributes.createdAt) &&
        Objects.equals(this.subscribedEvents, webhookSubscriptionResponseObjectDataAttributes.subscribedEvents) &&
        Objects.equals(this.updatedAt, webhookSubscriptionResponseObjectDataAttributes.updatedAt) &&
        Objects.equals(this.url, webhookSubscriptionResponseObjectDataAttributes.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, createdAt, subscribedEvents, updatedAt, url);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhookSubscriptionResponseObjectDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookSubscriptionResponseObjectDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookSubscriptionResponseObjectDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookSubscriptionResponseObjectDataAttributes is not found in the empty JSON string", WebhookSubscriptionResponseObjectDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookSubscriptionResponseObjectDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookSubscriptionResponseObjectDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookSubscriptionResponseObjectDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookSubscriptionResponseObjectDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookSubscriptionResponseObjectDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookSubscriptionResponseObjectDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookSubscriptionResponseObjectDataAttributes>() {
           @Override
           public void write(JsonWriter out, WebhookSubscriptionResponseObjectDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookSubscriptionResponseObjectDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebhookSubscriptionResponseObjectDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebhookSubscriptionResponseObjectDataAttributes
   * @throws IOException if the JSON string is invalid with respect to WebhookSubscriptionResponseObjectDataAttributes
   */
  public static WebhookSubscriptionResponseObjectDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookSubscriptionResponseObjectDataAttributes.class);
  }

  /**
   * Convert an instance of WebhookSubscriptionResponseObjectDataAttributes to an JSON string
   *
   * @return JSON string
   */
