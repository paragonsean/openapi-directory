...
public class LinksObjectData {
  ...
  public LinksObjectData current(String current) {
  ...
  public LinksObjectData first(String first) {
    this.first = first;
    return this;
  }
  ...
  public LinksObjectData last(String last) {
    this.last = last;
    return this;
  }
  ...
  public LinksObjectData next(String next) {
    this.next = next;
    return this;
  }
  ...
  public LinksObjectData prev(String prev) {
    this.prev = prev;
    return this;
  }
  ...
  public LinksObjectData self(String self) {
    this.self = self;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LinksObjectData linksObjectData = (LinksObjectData) o;
    return Objects.equals(this.current, linksObjectData.current) &&
        Objects.equals(this.first, linksObjectData.first) &&
        Objects.equals(this.last, linksObjectData.last) &&
        Objects.equals(this.next, linksObjectData.next) &&
        Objects.equals(this.prev, linksObjectData.prev) &&
        Objects.equals(this.self, linksObjectData.self);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(current, first, last, next, prev, self);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksObjectData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksObjectData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksObjectData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksObjectData is not found in the empty JSON string", LinksObjectData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksObjectData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksObjectData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksObjectData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksObjectData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksObjectData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksObjectData.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksObjectData>() {
           @Override
           public void write(JsonWriter out, LinksObjectData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksObjectData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksObjectData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksObjectData
   * @throws IOException if the JSON string is invalid with respect to LinksObjectData
   */
  public static LinksObjectData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksObjectData.class);
  }

  /**
   * Convert an instance of LinksObjectData to an JSON string
   *
   * @return JSON string
   */
