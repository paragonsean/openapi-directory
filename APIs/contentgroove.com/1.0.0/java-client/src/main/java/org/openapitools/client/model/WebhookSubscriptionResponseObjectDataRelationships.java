...
public class WebhookSubscriptionResponseObjectDataRelationships {
  ...
  private ClipResponseObjectDataRelationshipsMedia user;

  public static final String SERIALIZED_NAME_WEBHOOK_EVENTS = "webhook_events";
  @SerializedName(SERIALIZED_NAME_WEBHOOK_EVENTS)
  private MediaResponseObjectDataRelationshipsClips webhookEvents;

  public WebhookSubscriptionResponseObjectDataRelationships() {
  }

  public WebhookSubscriptionResponseObjectDataRelationships user(ClipResponseObjectDataRelationshipsMedia user) {
    this.user = user;
    return this;
  }
  ...
  public ClipResponseObjectDataRelationshipsMedia getUser() {
    return user;
  }

  public void setUser(ClipResponseObjectDataRelationshipsMedia user) {
    this.user = user;
  }


  public WebhookSubscriptionResponseObjectDataRelationships webhookEvents(MediaResponseObjectDataRelationshipsClips webhookEvents) {
   ...
   */
  @javax.annotation.Nullable
  public MediaResponseObjectDataRelationshipsClips getWebhookEvents() {
    return webhookEvents;
  }

  public void setWebhookEvents(MediaResponseObjectDataRelationshipsClips webhookEvents) {
    this.webhookEvents = webhookEvents;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebhookSubscriptionResponseObjectDataRelationships webhookSubscriptionResponseObjectDataRelationships = (WebhookSubscriptionResponseObjectDataRelationships) o;
    return Objects.equals(this.user, webhookSubscriptionResponseObjectDataRelationships.user) &&
        Objects.equals(this.webhookEvents, webhookSubscriptionResponseObjectDataRelationships.webhookEvents);
  }

  @Override
  public int hashCode() {
    return Objects.hash(user, webhookEvents);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhookSubscriptionResponseObjectDataRelationships {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookSubscriptionResponseObjectDataRelationships
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookSubscriptionResponseObjectDataRelationships.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookSubscriptionResponseObjectDataRelationships is not found in the empty JSON string", WebhookSubscriptionResponseObjectDataRelationships.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookSubscriptionResponseObjectDataRelationships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookSubscriptionResponseObjectDataRelationships` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `user`
      if (jsonObj.get("user") != null && !jsonObj.get("user").isJsonNull()) {
        ClipResponseObjectDataRelationshipsMedia.validateJsonElement(jsonObj.get("user"));
      }
      // validate the optional field `webhook_events`
      if (jsonObj.get("webhook_events") != null && !jsonObj.get("webhook_events").isJsonNull()) {
        MediaResponseObjectDataRelationshipsClips.validateJsonElement(jsonObj.get("webhook_events"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookSubscriptionResponseObjectDataRelationships.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookSubscriptionResponseObjectDataRelationships' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookSubscriptionResponseObjectDataRelationships> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookSubscriptionResponseObjectDataRelationships.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookSubscriptionResponseObjectDataRelationships>() {
           @Override
           public void write(JsonWriter out, WebhookSubscriptionResponseObjectDataRelationships value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookSubscriptionResponseObjectDataRelationships read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebhookSubscriptionResponseObjectDataRelationships given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebhookSubscriptionResponseObjectDataRelationships
   * @throws IOException if the JSON string is invalid with respect to WebhookSubscriptionResponseObjectDataRelationships
   */
  public static WebhookSubscriptionResponseObjectDataRelationships fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookSubscriptionResponseObjectDataRelationships.class);
  }

  /**
   * Convert an instance of WebhookSubscriptionResponseObjectDataRelationships to an JSON string
   *
   * @return JSON string
   */
