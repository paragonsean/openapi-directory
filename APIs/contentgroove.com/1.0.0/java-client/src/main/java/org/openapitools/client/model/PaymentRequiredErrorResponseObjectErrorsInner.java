...
public class PaymentRequiredErrorResponseObjectErrorsInner {
  ...
  private PaymentRequiredErrorResponseObjectErrorsInnerSource source;
  ...
  public PaymentRequiredErrorResponseObjectErrorsInner() {
  }

  public PaymentRequiredErrorResponseObjectErrorsInner code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PaymentRequiredErrorResponseObjectErrorsInner detail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  public PaymentRequiredErrorResponseObjectErrorsInner source(PaymentRequiredErrorResponseObjectErrorsInnerSource source) {
    this.source = source;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PaymentRequiredErrorResponseObjectErrorsInnerSource getSource() {
    return source;
  }

  public void setSource(PaymentRequiredErrorResponseObjectErrorsInnerSource source) {
    this.source = source;
  }


  public PaymentRequiredErrorResponseObjectErrorsInner status(String status) {
    this.status = status;
    return this;
  }
  ...
  public PaymentRequiredErrorResponseObjectErrorsInner title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentRequiredErrorResponseObjectErrorsInner paymentRequiredErrorResponseObjectErrorsInner = (PaymentRequiredErrorResponseObjectErrorsInner) o;
    return Objects.equals(this.code, paymentRequiredErrorResponseObjectErrorsInner.code) &&
        Objects.equals(this.detail, paymentRequiredErrorResponseObjectErrorsInner.detail) &&
        Objects.equals(this.source, paymentRequiredErrorResponseObjectErrorsInner.source) &&
        Objects.equals(this.status, paymentRequiredErrorResponseObjectErrorsInner.status) &&
        Objects.equals(this.title, paymentRequiredErrorResponseObjectErrorsInner.title);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentRequiredErrorResponseObjectErrorsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentRequiredErrorResponseObjectErrorsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentRequiredErrorResponseObjectErrorsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentRequiredErrorResponseObjectErrorsInner is not found in the empty JSON string", PaymentRequiredErrorResponseObjectErrorsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentRequiredErrorResponseObjectErrorsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentRequiredErrorResponseObjectErrorsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("source") != null && !jsonObj.get("source").isJsonNull()) {
        PaymentRequiredErrorResponseObjectErrorsInnerSource.validateJsonElement(jsonObj.get("source"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentRequiredErrorResponseObjectErrorsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentRequiredErrorResponseObjectErrorsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentRequiredErrorResponseObjectErrorsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentRequiredErrorResponseObjectErrorsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentRequiredErrorResponseObjectErrorsInner>() {
           @Override
           public void write(JsonWriter out, PaymentRequiredErrorResponseObjectErrorsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentRequiredErrorResponseObjectErrorsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentRequiredErrorResponseObjectErrorsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentRequiredErrorResponseObjectErrorsInner
   * @throws IOException if the JSON string is invalid with respect to PaymentRequiredErrorResponseObjectErrorsInner
   */
  public static PaymentRequiredErrorResponseObjectErrorsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentRequiredErrorResponseObjectErrorsInner.class);
  }

  /**
   * Convert an instance of PaymentRequiredErrorResponseObjectErrorsInner to an JSON string
   *
   * @return JSON string
   */
