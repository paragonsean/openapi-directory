...
public class MediasPostRequestPayload {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private MediasPostRequestPayloadData data;

  public static final String SERIALIZED_NAME_INCLUDED = "included";
  @SerializedName(SERIALIZED_NAME_INCLUDED)
  private List<MediasPostRequestPayloadIncludedInner> included = new ArrayList<>();

  public MediasPostRequestPayload() {
  }

  public MediasPostRequestPayload data(MediasPostRequestPayloadData data) {
    this.data = data;
    return this;
  }
  ...
  public MediasPostRequestPayloadData getData() {
    return data;
  }

  public void setData(MediasPostRequestPayloadData data) {
    this.data = data;
  }


  public MediasPostRequestPayload included(List<MediasPostRequestPayloadIncludedInner> included) {
    this.included = included;
    return this;
  }

  public MediasPostRequestPayload addIncludedItem(MediasPostRequestPayloadIncludedInner includedItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<MediasPostRequestPayloadIncludedInner> getIncluded() {
    return included;
  }

  public void setIncluded(List<MediasPostRequestPayloadIncludedInner> included) {
    this.included = included;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayload mediasPostRequestPayload = (MediasPostRequestPayload) o;
    return Objects.equals(this.data, mediasPostRequestPayload.data) &&
        Objects.equals(this.included, mediasPostRequestPayload.included);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequestPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayload is not found in the empty JSON string", MediasPostRequestPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        MediasPostRequestPayloadData.validateJsonElement(jsonObj.get("data"));
      }
      if (jsonObj.get("included") != null && !jsonObj.get("included").isJsonNull()) {
        ...
        if (jsonArrayincluded != null) {
          ...
          for (int i = 0; i < jsonArrayincluded.size(); i++) {
            MediasPostRequestPayloadIncludedInner.validateJsonElement(jsonArrayincluded.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayload>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayload
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayload
   */
  public static MediasPostRequestPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayload.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayload to an JSON string
   *
   * @return JSON string
   */
