...
public class ClipResponseObjectDataAttributes {
  ...
  public static final String SERIALIZED_NAME_MEDIA_FILE_CONTENT_DURATION = "media_file_content_duration";
  @SerializedName(SERIALIZED_NAME_MEDIA_FILE_CONTENT_DURATION)
  private String mediaFileContentDuration;
  ...
  private String mediaFileHeight;
  ...
  public ClipResponseObjectDataAttributes createdAt(String createdAt) {
  ...
  public ClipResponseObjectDataAttributes endChar(Integer endChar) {
  ...
  public ClipResponseObjectDataAttributes endTime(BigDecimal endTime) {
  ...
  public ClipResponseObjectDataAttributes externalId(String externalId) {
  ...
  public ClipResponseObjectDataAttributes isProcessing(Boolean isProcessing) {
  ...
  public ClipResponseObjectDataAttributes mediaFileContentDuration(String mediaFileContentDuration) {
    this.mediaFileContentDuration = mediaFileContentDuration;
    return this;
  }

  /**
   * Get mediaFileContentDuration
   * @return mediaFileContentDuration
   */
  @javax.annotation.Nullable
  public String getMediaFileContentDuration() {
    return mediaFileContentDuration;
  }

  public void setMediaFileContentDuration(String mediaFileContentDuration) {
    this.mediaFileContentDuration = mediaFileContentDuration;
  }


  public ClipResponseObjectDataAttributes mediaFileContentType(String mediaFileContentType) {
  ...
  public ClipResponseObjectDataAttributes mediaFileHeight(String mediaFileHeight) {
  ...
  public void setMediaFileHeight(String mediaFileHeight) {
    this.mediaFileHeight = mediaFileHeight;
  }


  public ClipResponseObjectDataAttributes mediaFilePreviewImageUrl(String mediaFilePreviewImageUrl) {
  ...
  public ClipResponseObjectDataAttributes mediaFileUrl(String mediaFileUrl) {
  ...
  public ClipResponseObjectDataAttributes mediaFileWidth(String mediaFileWidth) {
  ...
  public void setMediaFileWidth(String mediaFileWidth) {
    this.mediaFileWidth = mediaFileWidth;
  }


  public ClipResponseObjectDataAttributes name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ClipResponseObjectDataAttributes processingStartedAt(String processingStartedAt) {
  ...
  public ClipResponseObjectDataAttributes rank(Integer rank) {
    this.rank = rank;
    return this;
  }
  ...
  public ClipResponseObjectDataAttributes startChar(Integer startChar) {
  ...
  public ClipResponseObjectDataAttributes startTime(BigDecimal startTime) {
  ...
  public ClipResponseObjectDataAttributes text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClipResponseObjectDataAttributes clipResponseObjectDataAttributes = (ClipResponseObjectDataAttributes) o;
    return Objects.equals(this.createdAt, clipResponseObjectDataAttributes.createdAt) &&
        Objects.equals(this.endChar, clipResponseObjectDataAttributes.endChar) &&
        Objects.equals(this.endTime, clipResponseObjectDataAttributes.endTime) &&
        Objects.equals(this.externalId, clipResponseObjectDataAttributes.externalId) &&
        Objects.equals(this.isProcessing, clipResponseObjectDataAttributes.isProcessing) &&
        Objects.equals(this.mediaFileContentDuration, clipResponseObjectDataAttributes.mediaFileContentDuration) &&
        Objects.equals(this.mediaFileContentType, clipResponseObjectDataAttributes.mediaFileContentType) &&
        Objects.equals(this.mediaFileHeight, clipResponseObjectDataAttributes.mediaFileHeight) &&
        Objects.equals(this.mediaFilePreviewImageUrl, clipResponseObjectDataAttributes.mediaFilePreviewImageUrl) &&
        Objects.equals(this.mediaFileUrl, clipResponseObjectDataAttributes.mediaFileUrl) &&
        Objects.equals(this.mediaFileWidth, clipResponseObjectDataAttributes.mediaFileWidth) &&
        Objects.equals(this.name, clipResponseObjectDataAttributes.name) &&
        Objects.equals(this.processingStartedAt, clipResponseObjectDataAttributes.processingStartedAt) &&
        Objects.equals(this.rank, clipResponseObjectDataAttributes.rank) &&
        Objects.equals(this.startChar, clipResponseObjectDataAttributes.startChar) &&
        Objects.equals(this.startTime, clipResponseObjectDataAttributes.startTime) &&
        Objects.equals(this.text, clipResponseObjectDataAttributes.text);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, endChar, endTime, externalId, isProcessing, mediaFileContentDuration, mediaFileContentType, mediaFileHeight, mediaFilePreviewImageUrl, mediaFileUrl, mediaFileWidth, name, processingStartedAt, rank, startChar, startTime, text);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClipResponseObjectDataAttributes {\n");
    ...
    sb.append("    mediaFileContentDuration: ").append(toIndentedString(mediaFileContentDuration)).append("\n");
  ...
  static {
    ...
    openapiFields.add("media_file_content_duration");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClipResponseObjectDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClipResponseObjectDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClipResponseObjectDataAttributes is not found in the empty JSON string", ClipResponseObjectDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClipResponseObjectDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClipResponseObjectDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("media_file_content_duration") != null && !jsonObj.get("media_file_content_duration").isJsonNull()) && !jsonObj.get("media_file_content_duration").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `media_file_content_duration` to be a primitive type in the JSON string but got `%s`", jsonObj.get("media_file_content_duration").toString()));
      }
      ...
      if ((jsonObj.get("media_file_height") != null && !jsonObj.get("media_file_height").isJsonNull()) && !jsonObj.get("media_file_height").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `media_file_height` to be a primitive type in the JSON string but got `%s`", jsonObj.get("media_file_height").toString()));
      }
      ...
      if ((jsonObj.get("media_file_width") != null && !jsonObj.get("media_file_width").isJsonNull()) && !jsonObj.get("media_file_width").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `media_file_width` to be a primitive type in the JSON string but got `%s`", jsonObj.get("media_file_width").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClipResponseObjectDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClipResponseObjectDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClipResponseObjectDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClipResponseObjectDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ClipResponseObjectDataAttributes>() {
           @Override
           public void write(JsonWriter out, ClipResponseObjectDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClipResponseObjectDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClipResponseObjectDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClipResponseObjectDataAttributes
   * @throws IOException if the JSON string is invalid with respect to ClipResponseObjectDataAttributes
   */
  public static ClipResponseObjectDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClipResponseObjectDataAttributes.class);
  }

  /**
   * Convert an instance of ClipResponseObjectDataAttributes to an JSON string
   *
   * @return JSON string
   */
