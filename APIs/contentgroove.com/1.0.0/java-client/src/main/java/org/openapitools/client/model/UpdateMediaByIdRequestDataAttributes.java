...
public class UpdateMediaByIdRequestDataAttributes {
  ...
  public UpdateMediaByIdRequestDataAttributes() {
  }

  public UpdateMediaByIdRequestDataAttributes description(String description) {
  ...
  public UpdateMediaByIdRequestDataAttributes name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateMediaByIdRequestDataAttributes updateMediaByIdRequestDataAttributes = (UpdateMediaByIdRequestDataAttributes) o;
    return Objects.equals(this.description, updateMediaByIdRequestDataAttributes.description) &&
        Objects.equals(this.name, updateMediaByIdRequestDataAttributes.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateMediaByIdRequestDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMediaByIdRequestDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMediaByIdRequestDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMediaByIdRequestDataAttributes is not found in the empty JSON string", UpdateMediaByIdRequestDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMediaByIdRequestDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMediaByIdRequestDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMediaByIdRequestDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMediaByIdRequestDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMediaByIdRequestDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMediaByIdRequestDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMediaByIdRequestDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdateMediaByIdRequestDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMediaByIdRequestDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMediaByIdRequestDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMediaByIdRequestDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdateMediaByIdRequestDataAttributes
   */
  public static UpdateMediaByIdRequestDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMediaByIdRequestDataAttributes.class);
  }

  /**
   * Convert an instance of UpdateMediaByIdRequestDataAttributes to an JSON string
   *
   * @return JSON string
   */
