...
public class WebhookSubscriptionsResponseObject {
  ...
  private List<WebhookSubscriptionResponseObjectData> data = new ArrayList<>();
  ...
  public WebhookSubscriptionsResponseObject data(List<WebhookSubscriptionResponseObjectData> data) {
    this.data = data;
    return this;
  }

  public WebhookSubscriptionsResponseObject addDataItem(WebhookSubscriptionResponseObjectData dataItem) {
    if (this.data == null) {
  ...
  public List<WebhookSubscriptionResponseObjectData> getData() {
    return data;
  }

  public void setData(List<WebhookSubscriptionResponseObjectData> data) {
    this.data = data;
  }


  public WebhookSubscriptionsResponseObject links(LinksObjectData links) {
    this.links = links;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebhookSubscriptionsResponseObject webhookSubscriptionsResponseObject = (WebhookSubscriptionsResponseObject) o;
    return Objects.equals(this.data, webhookSubscriptionsResponseObject.data) &&
        Objects.equals(this.links, webhookSubscriptionsResponseObject.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookSubscriptionsResponseObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookSubscriptionsResponseObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookSubscriptionsResponseObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookSubscriptionsResponseObject is not found in the empty JSON string", WebhookSubscriptionsResponseObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookSubscriptionsResponseObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookSubscriptionsResponseObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            WebhookSubscriptionResponseObjectData.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookSubscriptionsResponseObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookSubscriptionsResponseObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookSubscriptionsResponseObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookSubscriptionsResponseObject.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookSubscriptionsResponseObject>() {
           @Override
           public void write(JsonWriter out, WebhookSubscriptionsResponseObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookSubscriptionsResponseObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebhookSubscriptionsResponseObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebhookSubscriptionsResponseObject
   * @throws IOException if the JSON string is invalid with respect to WebhookSubscriptionsResponseObject
   */
  public static WebhookSubscriptionsResponseObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookSubscriptionsResponseObject.class);
  }

  /**
   * Convert an instance of WebhookSubscriptionsResponseObject to an JSON string
   *
   * @return JSON string
   */
