...
public class MediasPostRequestPayloadDataTranscriptionData {
  ...
  public MediasPostRequestPayloadDataTranscriptionData() {
  }

  public MediasPostRequestPayloadDataTranscriptionData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MediasPostRequestPayloadDataTranscriptionData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayloadDataTranscriptionData mediasPostRequestPayloadDataTranscriptionData = (MediasPostRequestPayloadDataTranscriptionData) o;
    return Objects.equals(this.id, mediasPostRequestPayloadDataTranscriptionData.id) &&
        Objects.equals(this.type, mediasPostRequestPayloadDataTranscriptionData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequestPayloadDataTranscriptionData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayloadDataTranscriptionData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayloadDataTranscriptionData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayloadDataTranscriptionData is not found in the empty JSON string", MediasPostRequestPayloadDataTranscriptionData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayloadDataTranscriptionData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayloadDataTranscriptionData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayloadDataTranscriptionData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayloadDataTranscriptionData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayloadDataTranscriptionData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayloadDataTranscriptionData.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayloadDataTranscriptionData>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayloadDataTranscriptionData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayloadDataTranscriptionData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayloadDataTranscriptionData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayloadDataTranscriptionData
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayloadDataTranscriptionData
   */
  public static MediasPostRequestPayloadDataTranscriptionData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayloadDataTranscriptionData.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayloadDataTranscriptionData to an JSON string
   *
   * @return JSON string
   */
