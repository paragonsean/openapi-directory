...
public class MediasPostRequestPayloadIncludedInnerOneOf1 {
  public static final String SERIALIZED_NAME_ATTRIBUTES = "attributes";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES)
  private MediasPostRequestPayloadIncludedInnerOneOf1Attributes attributes;
  ...
  public MediasPostRequestPayloadIncludedInnerOneOf1() {
  }

  public MediasPostRequestPayloadIncludedInnerOneOf1 attributes(MediasPostRequestPayloadIncludedInnerOneOf1Attributes attributes) {
  ...
  public MediasPostRequestPayloadIncludedInnerOneOf1Attributes getAttributes() {
    return attributes;
  }

  public void setAttributes(MediasPostRequestPayloadIncludedInnerOneOf1Attributes attributes) {
    this.attributes = attributes;
  }


  public MediasPostRequestPayloadIncludedInnerOneOf1 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MediasPostRequestPayloadIncludedInnerOneOf1 relationships(Object relationships) {
  ...
  public MediasPostRequestPayloadIncludedInnerOneOf1 type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayloadIncludedInnerOneOf1 mediasPostRequestPayloadIncludedInnerOneOf1 = (MediasPostRequestPayloadIncludedInnerOneOf1) o;
    return Objects.equals(this.attributes, mediasPostRequestPayloadIncludedInnerOneOf1.attributes) &&
        Objects.equals(this.id, mediasPostRequestPayloadIncludedInnerOneOf1.id) &&
        Objects.equals(this.relationships, mediasPostRequestPayloadIncludedInnerOneOf1.relationships) &&
        Objects.equals(this.type, mediasPostRequestPayloadIncludedInnerOneOf1.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequestPayloadIncludedInnerOneOf1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayloadIncludedInnerOneOf1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayloadIncludedInnerOneOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayloadIncludedInnerOneOf1 is not found in the empty JSON string", MediasPostRequestPayloadIncludedInnerOneOf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayloadIncludedInnerOneOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayloadIncludedInnerOneOf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        MediasPostRequestPayloadIncludedInnerOneOf1Attributes.validateJsonElement(jsonObj.get("attributes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayloadIncludedInnerOneOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayloadIncludedInnerOneOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayloadIncludedInnerOneOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayloadIncludedInnerOneOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayloadIncludedInnerOneOf1>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayloadIncludedInnerOneOf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayloadIncludedInnerOneOf1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayloadIncludedInnerOneOf1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayloadIncludedInnerOneOf1
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayloadIncludedInnerOneOf1
   */
  public static MediasPostRequestPayloadIncludedInnerOneOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayloadIncludedInnerOneOf1.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayloadIncludedInnerOneOf1 to an JSON string
   *
   * @return JSON string
   */
