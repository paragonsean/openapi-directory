...
public class MediasPostRequestPayloadIncludedInnerOneOf1Attributes {
  public static final String SERIALIZED_NAME_TEXT = "text";
  @SerializedName(SERIALIZED_NAME_TEXT)
  private String text;

  public MediasPostRequestPayloadIncludedInnerOneOf1Attributes() {
  }

  public MediasPostRequestPayloadIncludedInnerOneOf1Attributes text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayloadIncludedInnerOneOf1Attributes mediasPostRequestPayloadIncludedInnerOneOf1Attributes = (MediasPostRequestPayloadIncludedInnerOneOf1Attributes) o;
    return Objects.equals(this.text, mediasPostRequestPayloadIncludedInnerOneOf1Attributes.text);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequestPayloadIncludedInnerOneOf1Attributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayloadIncludedInnerOneOf1Attributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayloadIncludedInnerOneOf1Attributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayloadIncludedInnerOneOf1Attributes is not found in the empty JSON string", MediasPostRequestPayloadIncludedInnerOneOf1Attributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayloadIncludedInnerOneOf1Attributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayloadIncludedInnerOneOf1Attributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayloadIncludedInnerOneOf1Attributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayloadIncludedInnerOneOf1Attributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayloadIncludedInnerOneOf1Attributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayloadIncludedInnerOneOf1Attributes.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayloadIncludedInnerOneOf1Attributes>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayloadIncludedInnerOneOf1Attributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayloadIncludedInnerOneOf1Attributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayloadIncludedInnerOneOf1Attributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayloadIncludedInnerOneOf1Attributes
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayloadIncludedInnerOneOf1Attributes
   */
  public static MediasPostRequestPayloadIncludedInnerOneOf1Attributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayloadIncludedInnerOneOf1Attributes.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayloadIncludedInnerOneOf1Attributes to an JSON string
   *
   * @return JSON string
   */
