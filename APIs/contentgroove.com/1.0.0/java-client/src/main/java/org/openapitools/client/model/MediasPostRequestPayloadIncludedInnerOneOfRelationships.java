...
import org.openapitools.client.model.MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia;
...
public class MediasPostRequestPayloadIncludedInnerOneOfRelationships {
  public static final String SERIALIZED_NAME_MEDIA = "media";
  @SerializedName(SERIALIZED_NAME_MEDIA)
  private MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia media;

  public MediasPostRequestPayloadIncludedInnerOneOfRelationships() {
  }

  public MediasPostRequestPayloadIncludedInnerOneOfRelationships media(MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia media) {
    this.media = media;
    return this;
  }
  ...
  public MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia getMedia() {
    return media;
  }

  public void setMedia(MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia media) {
    this.media = media;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayloadIncludedInnerOneOfRelationships mediasPostRequestPayloadIncludedInnerOneOfRelationships = (MediasPostRequestPayloadIncludedInnerOneOfRelationships) o;
    return Objects.equals(this.media, mediasPostRequestPayloadIncludedInnerOneOfRelationships.media);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequestPayloadIncludedInnerOneOfRelationships {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayloadIncludedInnerOneOfRelationships
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayloadIncludedInnerOneOfRelationships.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayloadIncludedInnerOneOfRelationships is not found in the empty JSON string", MediasPostRequestPayloadIncludedInnerOneOfRelationships.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayloadIncludedInnerOneOfRelationships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayloadIncludedInnerOneOfRelationships` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `media`
      if (jsonObj.get("media") != null && !jsonObj.get("media").isJsonNull()) {
        MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia.validateJsonElement(jsonObj.get("media"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayloadIncludedInnerOneOfRelationships.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayloadIncludedInnerOneOfRelationships' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayloadIncludedInnerOneOfRelationships> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayloadIncludedInnerOneOfRelationships.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayloadIncludedInnerOneOfRelationships>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayloadIncludedInnerOneOfRelationships value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayloadIncludedInnerOneOfRelationships read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayloadIncludedInnerOneOfRelationships given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayloadIncludedInnerOneOfRelationships
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayloadIncludedInnerOneOfRelationships
   */
  public static MediasPostRequestPayloadIncludedInnerOneOfRelationships fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayloadIncludedInnerOneOfRelationships.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayloadIncludedInnerOneOfRelationships to an JSON string
   *
   * @return JSON string
   */
