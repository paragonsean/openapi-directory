...
import org.openapitools.client.model.WebhookSubscriptionResponseObjectDataAttributes;
import org.openapitools.client.model.WebhookSubscriptionResponseObjectDataRelationships;
...
public class WebhookSubscriptionResponseObjectData {
  ...
  private WebhookSubscriptionResponseObjectDataAttributes attributes;
  ...
  private WebhookSubscriptionResponseObjectDataRelationships relationships;
  ...
  public WebhookSubscriptionResponseObjectData attributes(WebhookSubscriptionResponseObjectDataAttributes attributes) {
  ...
  public WebhookSubscriptionResponseObjectDataAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(WebhookSubscriptionResponseObjectDataAttributes attributes) {
    this.attributes = attributes;
  }


  public WebhookSubscriptionResponseObjectData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public WebhookSubscriptionResponseObjectData relationships(WebhookSubscriptionResponseObjectDataRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public WebhookSubscriptionResponseObjectDataRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(WebhookSubscriptionResponseObjectDataRelationships relationships) {
    this.relationships = relationships;
  }


  public WebhookSubscriptionResponseObjectData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebhookSubscriptionResponseObjectData webhookSubscriptionResponseObjectData = (WebhookSubscriptionResponseObjectData) o;
    return Objects.equals(this.attributes, webhookSubscriptionResponseObjectData.attributes) &&
        Objects.equals(this.id, webhookSubscriptionResponseObjectData.id) &&
        Objects.equals(this.relationships, webhookSubscriptionResponseObjectData.relationships) &&
        Objects.equals(this.type, webhookSubscriptionResponseObjectData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookSubscriptionResponseObjectData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookSubscriptionResponseObjectData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookSubscriptionResponseObjectData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookSubscriptionResponseObjectData is not found in the empty JSON string", WebhookSubscriptionResponseObjectData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookSubscriptionResponseObjectData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookSubscriptionResponseObjectData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        WebhookSubscriptionResponseObjectDataAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        WebhookSubscriptionResponseObjectDataRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookSubscriptionResponseObjectData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookSubscriptionResponseObjectData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookSubscriptionResponseObjectData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookSubscriptionResponseObjectData.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookSubscriptionResponseObjectData>() {
           @Override
           public void write(JsonWriter out, WebhookSubscriptionResponseObjectData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookSubscriptionResponseObjectData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebhookSubscriptionResponseObjectData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebhookSubscriptionResponseObjectData
   * @throws IOException if the JSON string is invalid with respect to WebhookSubscriptionResponseObjectData
   */
  public static WebhookSubscriptionResponseObjectData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookSubscriptionResponseObjectData.class);
  }

  /**
   * Convert an instance of WebhookSubscriptionResponseObjectData to an JSON string
   *
   * @return JSON string
   */
