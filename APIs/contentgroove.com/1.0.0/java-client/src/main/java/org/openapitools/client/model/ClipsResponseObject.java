...
import org.openapitools.client.model.ClipResponseObjectData;
import org.openapitools.client.model.LinksObjectData;
...
public class ClipsResponseObject {
  ...
  private List<ClipResponseObjectData> data = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private LinksObjectData links;

  public ClipsResponseObject() {
  }

  public ClipsResponseObject data(List<ClipResponseObjectData> data) {
    this.data = data;
    return this;
  }

  public ClipsResponseObject addDataItem(ClipResponseObjectData dataItem) {
    if (this.data == null) {
  ...
  public List<ClipResponseObjectData> getData() {
    return data;
  }

  public void setData(List<ClipResponseObjectData> data) {
    this.data = data;
  }


  public ClipsResponseObject links(LinksObjectData links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public LinksObjectData getLinks() {
    return links;
  }

  public void setLinks(LinksObjectData links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClipsResponseObject clipsResponseObject = (ClipsResponseObject) o;
    return Objects.equals(this.data, clipsResponseObject.data) &&
        Objects.equals(this.links, clipsResponseObject.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClipsResponseObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClipsResponseObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClipsResponseObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClipsResponseObject is not found in the empty JSON string", ClipsResponseObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClipsResponseObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClipsResponseObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ClipResponseObjectData.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        LinksObjectData.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClipsResponseObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClipsResponseObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClipsResponseObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClipsResponseObject.class));

       return (TypeAdapter<T>) new TypeAdapter<ClipsResponseObject>() {
           @Override
           public void write(JsonWriter out, ClipsResponseObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClipsResponseObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClipsResponseObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClipsResponseObject
   * @throws IOException if the JSON string is invalid with respect to ClipsResponseObject
   */
  public static ClipsResponseObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClipsResponseObject.class);
  }

  /**
   * Convert an instance of ClipsResponseObject to an JSON string
   *
   * @return JSON string
   */
