...
public class CreateClipRequestData {
  public static final String SERIALIZED_NAME_ATTRIBUTES = "attributes";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES)
  private CreateClipRequestDataAttributes attributes;

  public CreateClipRequestData() {
  }

  public CreateClipRequestData attributes(CreateClipRequestDataAttributes attributes) {
  ...
  public CreateClipRequestDataAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(CreateClipRequestDataAttributes attributes) {
    this.attributes = attributes;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateClipRequestData createClipRequestData = (CreateClipRequestData) o;
    return Objects.equals(this.attributes, createClipRequestData.attributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateClipRequestData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateClipRequestData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateClipRequestData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateClipRequestData is not found in the empty JSON string", CreateClipRequestData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateClipRequestData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateClipRequestData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateClipRequestData.openapiRequiredFields) {
      ...
      CreateClipRequestDataAttributes.validateJsonElement(jsonObj.get("attributes"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateClipRequestData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateClipRequestData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateClipRequestData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateClipRequestData.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateClipRequestData>() {
           @Override
           public void write(JsonWriter out, CreateClipRequestData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateClipRequestData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateClipRequestData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateClipRequestData
   * @throws IOException if the JSON string is invalid with respect to CreateClipRequestData
   */
  public static CreateClipRequestData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateClipRequestData.class);
  }

  /**
   * Convert an instance of CreateClipRequestData to an JSON string
   *
   * @return JSON string
   */
