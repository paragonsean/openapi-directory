...
import org.openapitools.client.model.MediasPostRequestPayloadDataAttributes;
import org.openapitools.client.model.MediasPostRequestPayloadDataRelationships;
import org.openapitools.client.model.MediasPostRequestPayloadDataTranscription;
...
public class MediasPostRequestPayloadData {
  public static final String SERIALIZED_NAME_ATTRIBUTES = "attributes";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES)
  private MediasPostRequestPayloadDataAttributes attributes;
  ...
  private MediasPostRequestPayloadDataRelationships relationships;

  public static final String SERIALIZED_NAME_TRANSCRIPTION = "transcription";
  @SerializedName(SERIALIZED_NAME_TRANSCRIPTION)
  private MediasPostRequestPayloadDataTranscription transcription;

  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private String type;

  public MediasPostRequestPayloadData() {
  }

  public MediasPostRequestPayloadData attributes(MediasPostRequestPayloadDataAttributes attributes) {
  ...
  public MediasPostRequestPayloadDataAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(MediasPostRequestPayloadDataAttributes attributes) {
    this.attributes = attributes;
  }


  public MediasPostRequestPayloadData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MediasPostRequestPayloadData relationships(MediasPostRequestPayloadDataRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public MediasPostRequestPayloadDataRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(MediasPostRequestPayloadDataRelationships relationships) {
    this.relationships = relationships;
  }


  public MediasPostRequestPayloadData transcription(MediasPostRequestPayloadDataTranscription transcription) {
   ...
   */
  @javax.annotation.Nullable
  public MediasPostRequestPayloadDataTranscription getTranscription() {
    return transcription;
  }

  public void setTranscription(MediasPostRequestPayloadDataTranscription transcription) {
    this.transcription = transcription;
  }


  public MediasPostRequestPayloadData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayloadData mediasPostRequestPayloadData = (MediasPostRequestPayloadData) o;
    return Objects.equals(this.attributes, mediasPostRequestPayloadData.attributes) &&
        Objects.equals(this.id, mediasPostRequestPayloadData.id) &&
        Objects.equals(this.relationships, mediasPostRequestPayloadData.relationships) &&
        Objects.equals(this.transcription, mediasPostRequestPayloadData.transcription) &&
        Objects.equals(this.type, mediasPostRequestPayloadData.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributes, id, relationships, transcription, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MediasPostRequestPayloadData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayloadData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayloadData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayloadData is not found in the empty JSON string", MediasPostRequestPayloadData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayloadData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayloadData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        MediasPostRequestPayloadDataAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        MediasPostRequestPayloadDataRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
      // validate the optional field `transcription`
      if (jsonObj.get("transcription") != null && !jsonObj.get("transcription").isJsonNull()) {
        MediasPostRequestPayloadDataTranscription.validateJsonElement(jsonObj.get("transcription"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayloadData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayloadData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayloadData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayloadData.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayloadData>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayloadData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayloadData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayloadData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayloadData
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayloadData
   */
  public static MediasPostRequestPayloadData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayloadData.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayloadData to an JSON string
   *
   * @return JSON string
   */
