...
public class UnauthorizedErrorResponseObject {
  ...
  private List<UnauthorizedErrorResponseObjectErrorsInner> errors = new ArrayList<>();

  public UnauthorizedErrorResponseObject() {
  }

  public UnauthorizedErrorResponseObject errors(List<UnauthorizedErrorResponseObjectErrorsInner> errors) {
    this.errors = errors;
    return this;
  }

  public UnauthorizedErrorResponseObject addErrorsItem(UnauthorizedErrorResponseObjectErrorsInner errorsItem) {
    if (this.errors == null) {
  ...
  public List<UnauthorizedErrorResponseObjectErrorsInner> getErrors() {
    return errors;
  }

  public void setErrors(List<UnauthorizedErrorResponseObjectErrorsInner> errors) {
    this.errors = errors;
  }
  ...
  public boolean equals(Object o) {
    ...
    UnauthorizedErrorResponseObject unauthorizedErrorResponseObject = (UnauthorizedErrorResponseObject) o;
    return Objects.equals(this.errors, unauthorizedErrorResponseObject.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class UnauthorizedErrorResponseObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnauthorizedErrorResponseObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnauthorizedErrorResponseObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnauthorizedErrorResponseObject is not found in the empty JSON string", UnauthorizedErrorResponseObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnauthorizedErrorResponseObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnauthorizedErrorResponseObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("errors") != null && !jsonObj.get("errors").isJsonNull()) {
        ...
        if (jsonArrayerrors != null) {
          ...
          for (int i = 0; i < jsonArrayerrors.size(); i++) {
            UnauthorizedErrorResponseObjectErrorsInner.validateJsonElement(jsonArrayerrors.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnauthorizedErrorResponseObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnauthorizedErrorResponseObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnauthorizedErrorResponseObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnauthorizedErrorResponseObject.class));

       return (TypeAdapter<T>) new TypeAdapter<UnauthorizedErrorResponseObject>() {
           @Override
           public void write(JsonWriter out, UnauthorizedErrorResponseObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnauthorizedErrorResponseObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnauthorizedErrorResponseObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnauthorizedErrorResponseObject
   * @throws IOException if the JSON string is invalid with respect to UnauthorizedErrorResponseObject
   */
  public static UnauthorizedErrorResponseObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnauthorizedErrorResponseObject.class);
  }

  /**
   * Convert an instance of UnauthorizedErrorResponseObject to an JSON string
   *
   * @return JSON string
   */
