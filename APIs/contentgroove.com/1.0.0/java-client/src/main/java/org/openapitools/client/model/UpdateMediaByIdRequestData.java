...
import org.openapitools.client.model.UpdateMediaByIdRequestDataAttributes;
...
public class UpdateMediaByIdRequestData {
  public static final String SERIALIZED_NAME_ATTRIBUTES = "attributes";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES)
  private UpdateMediaByIdRequestDataAttributes attributes;

  public UpdateMediaByIdRequestData() {
  }

  public UpdateMediaByIdRequestData attributes(UpdateMediaByIdRequestDataAttributes attributes) {
  ...
  public UpdateMediaByIdRequestDataAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(UpdateMediaByIdRequestDataAttributes attributes) {
    this.attributes = attributes;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateMediaByIdRequestData updateMediaByIdRequestData = (UpdateMediaByIdRequestData) o;
    return Objects.equals(this.attributes, updateMediaByIdRequestData.attributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateMediaByIdRequestData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMediaByIdRequestData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMediaByIdRequestData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMediaByIdRequestData is not found in the empty JSON string", UpdateMediaByIdRequestData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMediaByIdRequestData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMediaByIdRequestData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateMediaByIdRequestData.openapiRequiredFields) {
      ...
      UpdateMediaByIdRequestDataAttributes.validateJsonElement(jsonObj.get("attributes"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMediaByIdRequestData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMediaByIdRequestData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMediaByIdRequestData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMediaByIdRequestData.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMediaByIdRequestData>() {
           @Override
           public void write(JsonWriter out, UpdateMediaByIdRequestData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMediaByIdRequestData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMediaByIdRequestData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMediaByIdRequestData
   * @throws IOException if the JSON string is invalid with respect to UpdateMediaByIdRequestData
   */
  public static UpdateMediaByIdRequestData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMediaByIdRequestData.class);
  }

  /**
   * Convert an instance of UpdateMediaByIdRequestData to an JSON string
   *
   * @return JSON string
   */
