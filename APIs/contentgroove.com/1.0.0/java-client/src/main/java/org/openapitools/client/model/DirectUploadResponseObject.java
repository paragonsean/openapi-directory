...
public class DirectUploadResponseObject {
  ...
  private DirectUploadResponseObjectData data;

  public DirectUploadResponseObject() {
  }

  public DirectUploadResponseObject data(DirectUploadResponseObjectData data) {
    this.data = data;
    return this;
  }
  ...
  public DirectUploadResponseObjectData getData() {
    return data;
  }

  public void setData(DirectUploadResponseObjectData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    DirectUploadResponseObject directUploadResponseObject = (DirectUploadResponseObject) o;
    return Objects.equals(this.data, directUploadResponseObject.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DirectUploadResponseObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DirectUploadResponseObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DirectUploadResponseObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DirectUploadResponseObject is not found in the empty JSON string", DirectUploadResponseObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DirectUploadResponseObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DirectUploadResponseObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        DirectUploadResponseObjectData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DirectUploadResponseObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DirectUploadResponseObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DirectUploadResponseObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DirectUploadResponseObject.class));

       return (TypeAdapter<T>) new TypeAdapter<DirectUploadResponseObject>() {
           @Override
           public void write(JsonWriter out, DirectUploadResponseObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DirectUploadResponseObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DirectUploadResponseObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DirectUploadResponseObject
   * @throws IOException if the JSON string is invalid with respect to DirectUploadResponseObject
   */
  public static DirectUploadResponseObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DirectUploadResponseObject.class);
  }

  /**
   * Convert an instance of DirectUploadResponseObject to an JSON string
   *
   * @return JSON string
   */
