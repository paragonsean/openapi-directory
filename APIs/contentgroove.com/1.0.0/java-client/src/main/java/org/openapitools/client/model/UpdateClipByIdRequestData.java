...
public class UpdateClipByIdRequestData {
  public static final String SERIALIZED_NAME_ATTRIBUTES = "attributes";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES)
  private UpdateClipByIdRequestDataAttributes attributes;

  public UpdateClipByIdRequestData() {
  }

  public UpdateClipByIdRequestData attributes(UpdateClipByIdRequestDataAttributes attributes) {
  ...
  public UpdateClipByIdRequestDataAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(UpdateClipByIdRequestDataAttributes attributes) {
    this.attributes = attributes;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateClipByIdRequestData updateClipByIdRequestData = (UpdateClipByIdRequestData) o;
    return Objects.equals(this.attributes, updateClipByIdRequestData.attributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateClipByIdRequestData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateClipByIdRequestData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateClipByIdRequestData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateClipByIdRequestData is not found in the empty JSON string", UpdateClipByIdRequestData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateClipByIdRequestData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateClipByIdRequestData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateClipByIdRequestData.openapiRequiredFields) {
      ...
      UpdateClipByIdRequestDataAttributes.validateJsonElement(jsonObj.get("attributes"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateClipByIdRequestData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateClipByIdRequestData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateClipByIdRequestData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateClipByIdRequestData.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateClipByIdRequestData>() {
           @Override
           public void write(JsonWriter out, UpdateClipByIdRequestData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateClipByIdRequestData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateClipByIdRequestData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateClipByIdRequestData
   * @throws IOException if the JSON string is invalid with respect to UpdateClipByIdRequestData
   */
  public static UpdateClipByIdRequestData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateClipByIdRequestData.class);
  }

  /**
   * Convert an instance of UpdateClipByIdRequestData to an JSON string
   *
   * @return JSON string
   */
