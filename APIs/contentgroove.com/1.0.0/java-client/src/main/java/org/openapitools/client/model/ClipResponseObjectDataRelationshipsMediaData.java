...
public class ClipResponseObjectDataRelationshipsMediaData {
  ...
  public ClipResponseObjectDataRelationshipsMediaData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ClipResponseObjectDataRelationshipsMediaData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClipResponseObjectDataRelationshipsMediaData clipResponseObjectDataRelationshipsMediaData = (ClipResponseObjectDataRelationshipsMediaData) o;
    return Objects.equals(this.id, clipResponseObjectDataRelationshipsMediaData.id) &&
        Objects.equals(this.type, clipResponseObjectDataRelationshipsMediaData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClipResponseObjectDataRelationshipsMediaData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClipResponseObjectDataRelationshipsMediaData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClipResponseObjectDataRelationshipsMediaData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClipResponseObjectDataRelationshipsMediaData is not found in the empty JSON string", ClipResponseObjectDataRelationshipsMediaData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClipResponseObjectDataRelationshipsMediaData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClipResponseObjectDataRelationshipsMediaData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClipResponseObjectDataRelationshipsMediaData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClipResponseObjectDataRelationshipsMediaData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClipResponseObjectDataRelationshipsMediaData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClipResponseObjectDataRelationshipsMediaData.class));

       return (TypeAdapter<T>) new TypeAdapter<ClipResponseObjectDataRelationshipsMediaData>() {
           @Override
           public void write(JsonWriter out, ClipResponseObjectDataRelationshipsMediaData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClipResponseObjectDataRelationshipsMediaData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClipResponseObjectDataRelationshipsMediaData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClipResponseObjectDataRelationshipsMediaData
   * @throws IOException if the JSON string is invalid with respect to ClipResponseObjectDataRelationshipsMediaData
   */
  public static ClipResponseObjectDataRelationshipsMediaData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClipResponseObjectDataRelationshipsMediaData.class);
  }

  /**
   * Convert an instance of ClipResponseObjectDataRelationshipsMediaData to an JSON string
   *
   * @return JSON string
   */
