...
public class CreateMediaRequestData {
  public static final String SERIALIZED_NAME_ATTRIBUTES = "attributes";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES)
  private CreateMediaRequestDataAttributes attributes;

  public CreateMediaRequestData() {
  }

  public CreateMediaRequestData attributes(CreateMediaRequestDataAttributes attributes) {
  ...
  public CreateMediaRequestDataAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(CreateMediaRequestDataAttributes attributes) {
    this.attributes = attributes;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateMediaRequestData createMediaRequestData = (CreateMediaRequestData) o;
    return Objects.equals(this.attributes, createMediaRequestData.attributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateMediaRequestData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMediaRequestData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMediaRequestData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMediaRequestData is not found in the empty JSON string", CreateMediaRequestData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMediaRequestData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMediaRequestData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateMediaRequestData.openapiRequiredFields) {
      ...
      CreateMediaRequestDataAttributes.validateJsonElement(jsonObj.get("attributes"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMediaRequestData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMediaRequestData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMediaRequestData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMediaRequestData.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMediaRequestData>() {
           @Override
           public void write(JsonWriter out, CreateMediaRequestData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMediaRequestData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMediaRequestData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMediaRequestData
   * @throws IOException if the JSON string is invalid with respect to CreateMediaRequestData
   */
  public static CreateMediaRequestData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMediaRequestData.class);
  }

  /**
   * Convert an instance of CreateMediaRequestData to an JSON string
   *
   * @return JSON string
   */
