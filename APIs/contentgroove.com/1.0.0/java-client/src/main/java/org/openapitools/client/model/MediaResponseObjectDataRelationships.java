...
import org.openapitools.client.model.MediaResponseObjectDataRelationshipsClips;
...
public class MediaResponseObjectDataRelationships {
  ...
  private MediaResponseObjectDataRelationshipsClips clips;

  public MediaResponseObjectDataRelationships() {
  }

  public MediaResponseObjectDataRelationships clips(MediaResponseObjectDataRelationshipsClips clips) {
    this.clips = clips;
    return this;
  }
  ...
  public MediaResponseObjectDataRelationshipsClips getClips() {
    return clips;
  }

  public void setClips(MediaResponseObjectDataRelationshipsClips clips) {
    this.clips = clips;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediaResponseObjectDataRelationships mediaResponseObjectDataRelationships = (MediaResponseObjectDataRelationships) o;
    return Objects.equals(this.clips, mediaResponseObjectDataRelationships.clips);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediaResponseObjectDataRelationships {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediaResponseObjectDataRelationships
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediaResponseObjectDataRelationships.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediaResponseObjectDataRelationships is not found in the empty JSON string", MediaResponseObjectDataRelationships.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediaResponseObjectDataRelationships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediaResponseObjectDataRelationships` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `clips`
      if (jsonObj.get("clips") != null && !jsonObj.get("clips").isJsonNull()) {
        MediaResponseObjectDataRelationshipsClips.validateJsonElement(jsonObj.get("clips"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediaResponseObjectDataRelationships.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediaResponseObjectDataRelationships' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediaResponseObjectDataRelationships> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediaResponseObjectDataRelationships.class));

       return (TypeAdapter<T>) new TypeAdapter<MediaResponseObjectDataRelationships>() {
           @Override
           public void write(JsonWriter out, MediaResponseObjectDataRelationships value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediaResponseObjectDataRelationships read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediaResponseObjectDataRelationships given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediaResponseObjectDataRelationships
   * @throws IOException if the JSON string is invalid with respect to MediaResponseObjectDataRelationships
   */
  public static MediaResponseObjectDataRelationships fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediaResponseObjectDataRelationships.class);
  }

  /**
   * Convert an instance of MediaResponseObjectDataRelationships to an JSON string
   *
   * @return JSON string
   */
