...
public class MediasPostRequestPayloadDataTranscription {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private MediasPostRequestPayloadDataTranscriptionData data;

  public MediasPostRequestPayloadDataTranscription() {
  }

  public MediasPostRequestPayloadDataTranscription data(MediasPostRequestPayloadDataTranscriptionData data) {
    this.data = data;
    return this;
  }
  ...
  public MediasPostRequestPayloadDataTranscriptionData getData() {
    return data;
  }

  public void setData(MediasPostRequestPayloadDataTranscriptionData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayloadDataTranscription mediasPostRequestPayloadDataTranscription = (MediasPostRequestPayloadDataTranscription) o;
    return Objects.equals(this.data, mediasPostRequestPayloadDataTranscription.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequestPayloadDataTranscription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayloadDataTranscription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayloadDataTranscription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayloadDataTranscription is not found in the empty JSON string", MediasPostRequestPayloadDataTranscription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayloadDataTranscription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayloadDataTranscription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        MediasPostRequestPayloadDataTranscriptionData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayloadDataTranscription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayloadDataTranscription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayloadDataTranscription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayloadDataTranscription.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayloadDataTranscription>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayloadDataTranscription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayloadDataTranscription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayloadDataTranscription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayloadDataTranscription
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayloadDataTranscription
   */
  public static MediasPostRequestPayloadDataTranscription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayloadDataTranscription.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayloadDataTranscription to an JSON string
   *
   * @return JSON string
   */
