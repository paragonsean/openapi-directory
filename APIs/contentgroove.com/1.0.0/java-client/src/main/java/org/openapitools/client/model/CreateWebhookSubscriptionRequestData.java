...
import org.openapitools.client.model.CreateWebhookSubscriptionRequestDataAttributes;
...
public class CreateWebhookSubscriptionRequestData {
  ...
  public CreateWebhookSubscriptionRequestData attributes(CreateWebhookSubscriptionRequestDataAttributes attributes) {
  ...
  public CreateWebhookSubscriptionRequestDataAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(CreateWebhookSubscriptionRequestDataAttributes attributes) {
    this.attributes = attributes;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateWebhookSubscriptionRequestData createWebhookSubscriptionRequestData = (CreateWebhookSubscriptionRequestData) o;
    return Objects.equals(this.attributes, createWebhookSubscriptionRequestData.attributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateWebhookSubscriptionRequestData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateWebhookSubscriptionRequestData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateWebhookSubscriptionRequestData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateWebhookSubscriptionRequestData is not found in the empty JSON string", CreateWebhookSubscriptionRequestData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateWebhookSubscriptionRequestData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateWebhookSubscriptionRequestData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateWebhookSubscriptionRequestData.openapiRequiredFields) {
      ...
      CreateWebhookSubscriptionRequestDataAttributes.validateJsonElement(jsonObj.get("attributes"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateWebhookSubscriptionRequestData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateWebhookSubscriptionRequestData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateWebhookSubscriptionRequestData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateWebhookSubscriptionRequestData.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateWebhookSubscriptionRequestData>() {
           @Override
           public void write(JsonWriter out, CreateWebhookSubscriptionRequestData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateWebhookSubscriptionRequestData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateWebhookSubscriptionRequestData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateWebhookSubscriptionRequestData
   * @throws IOException if the JSON string is invalid with respect to CreateWebhookSubscriptionRequestData
   */
  public static CreateWebhookSubscriptionRequestData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateWebhookSubscriptionRequestData.class);
  }

  /**
   * Convert an instance of CreateWebhookSubscriptionRequestData to an JSON string
   *
   * @return JSON string
   */
