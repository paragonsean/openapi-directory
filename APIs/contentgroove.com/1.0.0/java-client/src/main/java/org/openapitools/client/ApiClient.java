...
public class ApiClient {
    ...
    private String basePath = "https://api.contentgroove.com/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("BearerHeader", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.contentgroove.com/api/v1
