...
public class MediasPostRequestPayloadDataRelationshipsClipsDataInner {
  ...
  public MediasPostRequestPayloadDataRelationshipsClipsDataInner() {
  }

  public MediasPostRequestPayloadDataRelationshipsClipsDataInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MediasPostRequestPayloadDataRelationshipsClipsDataInner type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayloadDataRelationshipsClipsDataInner mediasPostRequestPayloadDataRelationshipsClipsDataInner = (MediasPostRequestPayloadDataRelationshipsClipsDataInner) o;
    return Objects.equals(this.id, mediasPostRequestPayloadDataRelationshipsClipsDataInner.id) &&
        Objects.equals(this.type, mediasPostRequestPayloadDataRelationshipsClipsDataInner.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequestPayloadDataRelationshipsClipsDataInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayloadDataRelationshipsClipsDataInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayloadDataRelationshipsClipsDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayloadDataRelationshipsClipsDataInner is not found in the empty JSON string", MediasPostRequestPayloadDataRelationshipsClipsDataInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayloadDataRelationshipsClipsDataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayloadDataRelationshipsClipsDataInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayloadDataRelationshipsClipsDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayloadDataRelationshipsClipsDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayloadDataRelationshipsClipsDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayloadDataRelationshipsClipsDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayloadDataRelationshipsClipsDataInner>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayloadDataRelationshipsClipsDataInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayloadDataRelationshipsClipsDataInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayloadDataRelationshipsClipsDataInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayloadDataRelationshipsClipsDataInner
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayloadDataRelationshipsClipsDataInner
   */
  public static MediasPostRequestPayloadDataRelationshipsClipsDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayloadDataRelationshipsClipsDataInner.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayloadDataRelationshipsClipsDataInner to an JSON string
   *
   * @return JSON string
   */
