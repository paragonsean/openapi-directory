...
import org.openapitools.client.model.MediaResponseObjectData;
...
public class MediaResponseObject {
  ...
  private MediaResponseObjectData data;
  ...
  public MediaResponseObject data(MediaResponseObjectData data) {
    this.data = data;
    return this;
  }
  ...
  public MediaResponseObjectData getData() {
    return data;
  }

  public void setData(MediaResponseObjectData data) {
    this.data = data;
  }


  public MediaResponseObject links(LinksObjectData links) {
    this.links = links;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediaResponseObject mediaResponseObject = (MediaResponseObject) o;
    return Objects.equals(this.data, mediaResponseObject.data) &&
        Objects.equals(this.links, mediaResponseObject.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediaResponseObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediaResponseObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediaResponseObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediaResponseObject is not found in the empty JSON string", MediaResponseObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediaResponseObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediaResponseObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        MediaResponseObjectData.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediaResponseObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediaResponseObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediaResponseObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediaResponseObject.class));

       return (TypeAdapter<T>) new TypeAdapter<MediaResponseObject>() {
           @Override
           public void write(JsonWriter out, MediaResponseObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediaResponseObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediaResponseObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediaResponseObject
   * @throws IOException if the JSON string is invalid with respect to MediaResponseObject
   */
  public static MediaResponseObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediaResponseObject.class);
  }

  /**
   * Convert an instance of MediaResponseObject to an JSON string
   *
   * @return JSON string
   */
