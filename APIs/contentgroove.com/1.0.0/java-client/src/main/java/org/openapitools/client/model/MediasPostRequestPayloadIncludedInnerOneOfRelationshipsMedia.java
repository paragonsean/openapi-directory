...
import org.openapitools.client.model.MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData;
...
public class MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData data;

  public MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia() {
  }

  public MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia data(MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData data) {
    this.data = data;
    return this;
  }
  ...
  public MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData getData() {
    return data;
  }

  public void setData(MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia mediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia = (MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia) o;
    return Objects.equals(this.data, mediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia is not found in the empty JSON string", MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia.class));

       return (TypeAdapter<T>) new TypeAdapter<MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia>() {
           @Override
           public void write(JsonWriter out, MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia
   * @throws IOException if the JSON string is invalid with respect to MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia
   */
  public static MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia.class);
  }

  /**
   * Convert an instance of MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia to an JSON string
   *
   * @return JSON string
   */
