...
public class UnauthorizedErrorResponseObjectErrorsInner {
  public static final String SERIALIZED_NAME_MESSAGE = "message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  private String message;

  public UnauthorizedErrorResponseObjectErrorsInner() {
  }

  public UnauthorizedErrorResponseObjectErrorsInner message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    UnauthorizedErrorResponseObjectErrorsInner unauthorizedErrorResponseObjectErrorsInner = (UnauthorizedErrorResponseObjectErrorsInner) o;
    return Objects.equals(this.message, unauthorizedErrorResponseObjectErrorsInner.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class UnauthorizedErrorResponseObjectErrorsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnauthorizedErrorResponseObjectErrorsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnauthorizedErrorResponseObjectErrorsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnauthorizedErrorResponseObjectErrorsInner is not found in the empty JSON string", UnauthorizedErrorResponseObjectErrorsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnauthorizedErrorResponseObjectErrorsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnauthorizedErrorResponseObjectErrorsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnauthorizedErrorResponseObjectErrorsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnauthorizedErrorResponseObjectErrorsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnauthorizedErrorResponseObjectErrorsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnauthorizedErrorResponseObjectErrorsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<UnauthorizedErrorResponseObjectErrorsInner>() {
           @Override
           public void write(JsonWriter out, UnauthorizedErrorResponseObjectErrorsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnauthorizedErrorResponseObjectErrorsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnauthorizedErrorResponseObjectErrorsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnauthorizedErrorResponseObjectErrorsInner
   * @throws IOException if the JSON string is invalid with respect to UnauthorizedErrorResponseObjectErrorsInner
   */
  public static UnauthorizedErrorResponseObjectErrorsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnauthorizedErrorResponseObjectErrorsInner.class);
  }

  /**
   * Convert an instance of UnauthorizedErrorResponseObjectErrorsInner to an JSON string
   *
   * @return JSON string
   */
