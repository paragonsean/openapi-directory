...
import org.openapitools.client.model.ClipResponseObjectDataRelationshipsMediaData;
...
public class ClipResponseObjectDataRelationshipsMedia {
  ...
  private ClipResponseObjectDataRelationshipsMediaData data;

  public ClipResponseObjectDataRelationshipsMedia() {
  }

  public ClipResponseObjectDataRelationshipsMedia data(ClipResponseObjectDataRelationshipsMediaData data) {
    this.data = data;
    return this;
  }
  ...
  public ClipResponseObjectDataRelationshipsMediaData getData() {
    return data;
  }

  public void setData(ClipResponseObjectDataRelationshipsMediaData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClipResponseObjectDataRelationshipsMedia clipResponseObjectDataRelationshipsMedia = (ClipResponseObjectDataRelationshipsMedia) o;
    return Objects.equals(this.data, clipResponseObjectDataRelationshipsMedia.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClipResponseObjectDataRelationshipsMedia {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClipResponseObjectDataRelationshipsMedia
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClipResponseObjectDataRelationshipsMedia.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClipResponseObjectDataRelationshipsMedia is not found in the empty JSON string", ClipResponseObjectDataRelationshipsMedia.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClipResponseObjectDataRelationshipsMedia.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClipResponseObjectDataRelationshipsMedia` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ClipResponseObjectDataRelationshipsMediaData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClipResponseObjectDataRelationshipsMedia.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClipResponseObjectDataRelationshipsMedia' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClipResponseObjectDataRelationshipsMedia> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClipResponseObjectDataRelationshipsMedia.class));

       return (TypeAdapter<T>) new TypeAdapter<ClipResponseObjectDataRelationshipsMedia>() {
           @Override
           public void write(JsonWriter out, ClipResponseObjectDataRelationshipsMedia value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClipResponseObjectDataRelationshipsMedia read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClipResponseObjectDataRelationshipsMedia given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClipResponseObjectDataRelationshipsMedia
   * @throws IOException if the JSON string is invalid with respect to ClipResponseObjectDataRelationshipsMedia
   */
  public static ClipResponseObjectDataRelationshipsMedia fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClipResponseObjectDataRelationshipsMedia.class);
  }

  /**
   * Convert an instance of ClipResponseObjectDataRelationshipsMedia to an JSON string
   *
   * @return JSON string
   */
