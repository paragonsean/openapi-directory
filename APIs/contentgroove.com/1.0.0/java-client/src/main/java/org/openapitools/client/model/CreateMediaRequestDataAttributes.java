...
public class CreateMediaRequestDataAttributes {
  ...
  public CreateMediaRequestDataAttributes() {
  }

  public CreateMediaRequestDataAttributes description(String description) {
  ...
  public CreateMediaRequestDataAttributes name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateMediaRequestDataAttributes sourceUrl(String sourceUrl) {
  ...
  public CreateMediaRequestDataAttributes uploadId(String uploadId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateMediaRequestDataAttributes createMediaRequestDataAttributes = (CreateMediaRequestDataAttributes) o;
    return Objects.equals(this.description, createMediaRequestDataAttributes.description) &&
        Objects.equals(this.name, createMediaRequestDataAttributes.name) &&
        Objects.equals(this.sourceUrl, createMediaRequestDataAttributes.sourceUrl) &&
        Objects.equals(this.uploadId, createMediaRequestDataAttributes.uploadId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, name, sourceUrl, uploadId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateMediaRequestDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMediaRequestDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMediaRequestDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMediaRequestDataAttributes is not found in the empty JSON string", CreateMediaRequestDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMediaRequestDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMediaRequestDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMediaRequestDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMediaRequestDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMediaRequestDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMediaRequestDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMediaRequestDataAttributes>() {
           @Override
           public void write(JsonWriter out, CreateMediaRequestDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMediaRequestDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMediaRequestDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMediaRequestDataAttributes
   * @throws IOException if the JSON string is invalid with respect to CreateMediaRequestDataAttributes
   */
  public static CreateMediaRequestDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMediaRequestDataAttributes.class);
  }

  /**
   * Convert an instance of CreateMediaRequestDataAttributes to an JSON string
   *
   * @return JSON string
   */
