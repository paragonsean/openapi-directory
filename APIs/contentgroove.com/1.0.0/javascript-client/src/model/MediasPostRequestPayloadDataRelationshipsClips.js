...
import MediasPostRequestPayloadDataRelationshipsClipsDataInner from './MediasPostRequestPayloadDataRelationshipsClipsDataInner';

/**
 * The MediasPostRequestPayloadDataRelationshipsClips model module.
 * @module model/MediasPostRequestPayloadDataRelationshipsClips
 * @version 1.0.0
 */
class MediasPostRequestPayloadDataRelationshipsClips {
    /**
     * Constructs a new <code>MediasPostRequestPayloadDataRelationshipsClips</code>.
     * @alias module:model/MediasPostRequestPayloadDataRelationshipsClips
     */
    constructor() { 
        
        MediasPostRequestPayloadDataRelationshipsClips.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadDataRelationshipsClips</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadDataRelationshipsClips} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadDataRelationshipsClips} The populated <code>MediasPostRequestPayloadDataRelationshipsClips</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadDataRelationshipsClips();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [MediasPostRequestPayloadDataRelationshipsClipsDataInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadDataRelationshipsClips</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadDataRelationshipsClips</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                MediasPostRequestPayloadDataRelationshipsClipsDataInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/MediasPostRequestPayloadDataRelationshipsClipsDataInner>} data
 */
MediasPostRequestPayloadDataRelationshipsClips.prototype['data'] = undefined;
...
export default MediasPostRequestPayloadDataRelationshipsClips;
