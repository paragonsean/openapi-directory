...
/**
 * The MediaResponseObjectDataAttributes model module.
 * @module model/MediaResponseObjectDataAttributes
 * @version 1.0.0
 */
class MediaResponseObjectDataAttributes {
    /**
     * Constructs a new <code>MediaResponseObjectDataAttributes</code>.
     * @alias module:model/MediaResponseObjectDataAttributes
     */
    constructor() { 
        
        MediaResponseObjectDataAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediaResponseObjectDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediaResponseObjectDataAttributes} obj Optional instance to populate.
     * @return {module:model/MediaResponseObjectDataAttributes} The populated <code>MediaResponseObjectDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediaResponseObjectDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>MediaResponseObjectDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediaResponseObjectDataAttributes</code>.
     */
 ...
 */
MediaResponseObjectDataAttributes.prototype['created_at'] = undefined;

/**
 * @member {String} description
 */
MediaResponseObjectDataAttributes.prototype['description'] = undefined;

/**
 * @member {String} external_id
 */
MediaResponseObjectDataAttributes.prototype['external_id'] = undefined;

/**
 * @member {Boolean} has_fetch_error
 */
MediaResponseObjectDataAttributes.prototype['has_fetch_error'] = undefined;

/**
 * @member {Boolean} is_processing
 */
MediaResponseObjectDataAttributes.prototype['is_processing'] = undefined;

/**
 * @member {String} name
 */
MediaResponseObjectDataAttributes.prototype['name'] = undefined;

/**
 * @member {String} original_created_at
 */
MediaResponseObjectDataAttributes.prototype['original_created_at'] = undefined;

/**
 * @member {String} processing_started_at
 */
MediaResponseObjectDataAttributes.prototype['processing_started_at'] = undefined;

/**
 * @member {String} source_created_at
 */
MediaResponseObjectDataAttributes.prototype['source_created_at'] = undefined;

/**
 * @member {String} source_file_content_type
 */
MediaResponseObjectDataAttributes.prototype['source_file_content_type'] = undefined;

/**
 * @member {Number} source_file_duration
 */
MediaResponseObjectDataAttributes.prototype['source_file_duration'] = undefined;

/**
 * @member {Number} source_file_height
 */
MediaResponseObjectDataAttributes.prototype['source_file_height'] = undefined;

/**
 * @member {String} source_file_preview_image_url
 */
MediaResponseObjectDataAttributes.prototype['source_file_preview_image_url'] = undefined;

/**
 * @member {Number} source_file_width
 */
MediaResponseObjectDataAttributes.prototype['source_file_width'] = undefined;

/**
 * @member {String} source_url
 */
MediaResponseObjectDataAttributes.prototype['source_url'] = undefined;
...
export default MediaResponseObjectDataAttributes;
