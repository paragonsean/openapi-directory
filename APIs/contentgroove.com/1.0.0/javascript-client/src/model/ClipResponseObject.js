...
import ClipResponseObjectData from './ClipResponseObjectData';
import LinksObjectData from './LinksObjectData';

/**
 * The ClipResponseObject model module.
 * @module model/ClipResponseObject
 * @version 1.0.0
 */
class ClipResponseObject {
    /**
     * Constructs a new <code>ClipResponseObject</code>.
     * @alias module:model/ClipResponseObject
     */
    constructor() { 
        
        ClipResponseObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClipResponseObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClipResponseObject} obj Optional instance to populate.
     * @return {module:model/ClipResponseObject} The populated <code>ClipResponseObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClipResponseObject();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ClipResponseObjectData.constructFromObject(data['data']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ClipResponseObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClipResponseObject</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          ClipResponseObjectData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/ClipResponseObjectData} data
 */
ClipResponseObject.prototype['data'] = undefined;

/**
 * @member {module:model/LinksObjectData} links
 */
ClipResponseObject.prototype['links'] = undefined;
...
export default ClipResponseObject;
