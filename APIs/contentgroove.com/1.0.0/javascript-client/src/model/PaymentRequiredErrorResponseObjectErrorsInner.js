...
import PaymentRequiredErrorResponseObjectErrorsInnerSource from './PaymentRequiredErrorResponseObjectErrorsInnerSource';

/**
 * The PaymentRequiredErrorResponseObjectErrorsInner model module.
 * @module model/PaymentRequiredErrorResponseObjectErrorsInner
 * @version 1.0.0
 */
class PaymentRequiredErrorResponseObjectErrorsInner {
    /**
     * Constructs a new <code>PaymentRequiredErrorResponseObjectErrorsInner</code>.
     * @alias module:model/PaymentRequiredErrorResponseObjectErrorsInner
     */
    constructor() { 
        
        PaymentRequiredErrorResponseObjectErrorsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentRequiredErrorResponseObjectErrorsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentRequiredErrorResponseObjectErrorsInner} obj Optional instance to populate.
     * @return {module:model/PaymentRequiredErrorResponseObjectErrorsInner} The populated <code>PaymentRequiredErrorResponseObjectErrorsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentRequiredErrorResponseObjectErrorsInner();
            ...
            if (data.hasOwnProperty('source')) {
                obj['source'] = PaymentRequiredErrorResponseObjectErrorsInnerSource.constructFromObject(data['source']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentRequiredErrorResponseObjectErrorsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentRequiredErrorResponseObjectErrorsInner</code>.
     */
    static validateJSON(data) {
        ...
        if (data['source']) { // data not null
          PaymentRequiredErrorResponseObjectErrorsInnerSource.validateJSON(data['source']);
        }
        // ensure the json data is a string
 ...
 * @member {String} code
 */
PaymentRequiredErrorResponseObjectErrorsInner.prototype['code'] = undefined;

/**
 * @member {String} detail
 */
PaymentRequiredErrorResponseObjectErrorsInner.prototype['detail'] = undefined;

/**
 * @member {module:model/PaymentRequiredErrorResponseObjectErrorsInnerSource} source
 */
PaymentRequiredErrorResponseObjectErrorsInner.prototype['source'] = undefined;

/**
 * @member {String} status
 */
PaymentRequiredErrorResponseObjectErrorsInner.prototype['status'] = undefined;

/**
 * @member {String} title
 */
PaymentRequiredErrorResponseObjectErrorsInner.prototype['title'] = undefined;
...
export default PaymentRequiredErrorResponseObjectErrorsInner;
