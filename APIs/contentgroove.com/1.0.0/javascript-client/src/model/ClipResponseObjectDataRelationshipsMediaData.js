...
/**
 * The ClipResponseObjectDataRelationshipsMediaData model module.
 * @module model/ClipResponseObjectDataRelationshipsMediaData
 * @version 1.0.0
 */
class ClipResponseObjectDataRelationshipsMediaData {
    /**
     * Constructs a new <code>ClipResponseObjectDataRelationshipsMediaData</code>.
     * @alias module:model/ClipResponseObjectDataRelationshipsMediaData
     */
    constructor() { 
        
        ClipResponseObjectDataRelationshipsMediaData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClipResponseObjectDataRelationshipsMediaData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClipResponseObjectDataRelationshipsMediaData} obj Optional instance to populate.
     * @return {module:model/ClipResponseObjectDataRelationshipsMediaData} The populated <code>ClipResponseObjectDataRelationshipsMediaData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClipResponseObjectDataRelationshipsMediaData();
    ...
    /**
     * Validates the JSON data with respect to <code>ClipResponseObjectDataRelationshipsMediaData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClipResponseObjectDataRelationshipsMediaData</code>.
     */
 ...
 * @member {String} id
 */
ClipResponseObjectDataRelationshipsMediaData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
ClipResponseObjectDataRelationshipsMediaData.prototype['type'] = undefined;
...
export default ClipResponseObjectDataRelationshipsMediaData;
