...
import MediasPostRequestPayloadIncludedInnerOneOfAttributes from './MediasPostRequestPayloadIncludedInnerOneOfAttributes';
import MediasPostRequestPayloadIncludedInnerOneOfRelationships from './MediasPostRequestPayloadIncludedInnerOneOfRelationships';

/**
 * The MediasPostRequestPayloadIncludedInnerOneOf model module.
 * @module model/MediasPostRequestPayloadIncludedInnerOneOf
 * @version 1.0.0
 */
class MediasPostRequestPayloadIncludedInnerOneOf {
    /**
     * Constructs a new <code>MediasPostRequestPayloadIncludedInnerOneOf</code>.
     * @alias module:model/MediasPostRequestPayloadIncludedInnerOneOf
     */
    constructor() { 
        
        MediasPostRequestPayloadIncludedInnerOneOf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadIncludedInnerOneOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadIncludedInnerOneOf} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadIncludedInnerOneOf} The populated <code>MediasPostRequestPayloadIncludedInnerOneOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadIncludedInnerOneOf();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = MediasPostRequestPayloadIncludedInnerOneOfAttributes.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = MediasPostRequestPayloadIncludedInnerOneOfRelationships.constructFromObject(data['relationships']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadIncludedInnerOneOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadIncludedInnerOneOf</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          MediasPostRequestPayloadIncludedInnerOneOfAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          MediasPostRequestPayloadIncludedInnerOneOfRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/MediasPostRequestPayloadIncludedInnerOneOfAttributes} attributes
 */
MediasPostRequestPayloadIncludedInnerOneOf.prototype['attributes'] = undefined;

/**
 * @member {String} id
 */
MediasPostRequestPayloadIncludedInnerOneOf.prototype['id'] = undefined;

/**
 * @member {module:model/MediasPostRequestPayloadIncludedInnerOneOfRelationships} relationships
 */
MediasPostRequestPayloadIncludedInnerOneOf.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
MediasPostRequestPayloadIncludedInnerOneOf.prototype['type'] = undefined;
...
export default MediasPostRequestPayloadIncludedInnerOneOf;
