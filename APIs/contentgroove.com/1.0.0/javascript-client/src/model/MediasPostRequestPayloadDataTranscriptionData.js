...
/**
 * The MediasPostRequestPayloadDataTranscriptionData model module.
 * @module model/MediasPostRequestPayloadDataTranscriptionData
 * @version 1.0.0
 */
class MediasPostRequestPayloadDataTranscriptionData {
    /**
     * Constructs a new <code>MediasPostRequestPayloadDataTranscriptionData</code>.
     * @alias module:model/MediasPostRequestPayloadDataTranscriptionData
     */
    constructor() { 
        
        MediasPostRequestPayloadDataTranscriptionData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadDataTranscriptionData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadDataTranscriptionData} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadDataTranscriptionData} The populated <code>MediasPostRequestPayloadDataTranscriptionData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadDataTranscriptionData();
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadDataTranscriptionData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadDataTranscriptionData</code>.
     */
 ...
 * @member {String} id
 */
MediasPostRequestPayloadDataTranscriptionData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
MediasPostRequestPayloadDataTranscriptionData.prototype['type'] = undefined;
...
export default MediasPostRequestPayloadDataTranscriptionData;
