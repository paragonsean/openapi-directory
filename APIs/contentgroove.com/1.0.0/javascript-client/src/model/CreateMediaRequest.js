...
import CreateMediaRequestData from './CreateMediaRequestData';

/**
 * The CreateMediaRequest model module.
 * @module model/CreateMediaRequest
 * @version 1.0.0
 */
class CreateMediaRequest {
    /**
     * Constructs a new <code>CreateMediaRequest</code>.
     * @alias module:model/CreateMediaRequest
     * @param data {module:model/CreateMediaRequestData} 
     */
    constructor(data) { 
        
        CreateMediaRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>CreateMediaRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMediaRequest} obj Optional instance to populate.
     * @return {module:model/CreateMediaRequest} The populated <code>CreateMediaRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMediaRequest();

            if (data.hasOwnProperty('data')) {
                obj['data'] = CreateMediaRequestData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMediaRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMediaRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateMediaRequest.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          CreateMediaRequestData.validateJSON(data['data']);
        }
...
CreateMediaRequest.RequiredProperties = ["data"];

/**
 * @member {module:model/CreateMediaRequestData} data
 */
CreateMediaRequest.prototype['data'] = undefined;
...
export default CreateMediaRequest;
