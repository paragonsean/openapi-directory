...
/**
 * The WebhookSubscriptionResponseObject model module.
 * @module model/WebhookSubscriptionResponseObject
 * @version 1.0.0
 */
class WebhookSubscriptionResponseObject {
    /**
     * Constructs a new <code>WebhookSubscriptionResponseObject</code>.
     * @alias module:model/WebhookSubscriptionResponseObject
     */
    constructor() { 
        
        WebhookSubscriptionResponseObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhookSubscriptionResponseObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookSubscriptionResponseObject} obj Optional instance to populate.
     * @return {module:model/WebhookSubscriptionResponseObject} The populated <code>WebhookSubscriptionResponseObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookSubscriptionResponseObject();

            if (data.hasOwnProperty('data')) {
                obj['data'] = WebhookSubscriptionResponseObjectData.constructFromObject(data['data']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookSubscriptionResponseObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookSubscriptionResponseObject</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          WebhookSubscriptionResponseObjectData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/WebhookSubscriptionResponseObjectData} data
 */
WebhookSubscriptionResponseObject.prototype['data'] = undefined;

/**
 * @member {module:model/LinksObjectData} links
 */
WebhookSubscriptionResponseObject.prototype['links'] = undefined;
...
export default WebhookSubscriptionResponseObject;
