...
import MediasPostRequestPayloadIncludedInnerOneOf from './MediasPostRequestPayloadIncludedInnerOneOf';
import MediasPostRequestPayloadIncludedInnerOneOf1 from './MediasPostRequestPayloadIncludedInnerOneOf1';
import MediasPostRequestPayloadIncludedInnerOneOf1Attributes from './MediasPostRequestPayloadIncludedInnerOneOf1Attributes';

/**
 * The MediasPostRequestPayloadIncludedInner model module.
 * @module model/MediasPostRequestPayloadIncludedInner
 * @version 1.0.0
 */
class MediasPostRequestPayloadIncludedInner {
    /**
     * Constructs a new <code>MediasPostRequestPayloadIncludedInner</code>.
     * @alias module:model/MediasPostRequestPayloadIncludedInner
     * @param {(module:model/MediasPostRequestPayloadIncludedInnerOneOf|module:model/MediasPostRequestPayloadIncludedInnerOneOf1)} instance The actual instance to initialize MediasPostRequestPayloadIncludedInner.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "MediasPostRequestPayloadIncludedInnerOneOf") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                MediasPostRequestPayloadIncludedInnerOneOf.validateJSON(instance); // throw an exception if no match
                // create MediasPostRequestPayloadIncludedInnerOneOf from JS object
                this.actualInstance = MediasPostRequestPayloadIncludedInnerOneOf.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into MediasPostRequestPayloadIncludedInnerOneOf
            errorMessages.push("Failed to construct MediasPostRequestPayloadIncludedInnerOneOf: " + err)
        }

        try {
            if (typeof instance === "MediasPostRequestPayloadIncludedInnerOneOf1") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                MediasPostRequestPayloadIncludedInnerOneOf1.validateJSON(instance); // throw an exception if no match
                // create MediasPostRequestPayloadIncludedInnerOneOf1 from JS object
                this.actualInstance = MediasPostRequestPayloadIncludedInnerOneOf1.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into MediasPostRequestPayloadIncludedInnerOneOf1
            errorMessages.push("Failed to construct MediasPostRequestPayloadIncludedInnerOneOf1: " + err)
        }

        if (match > 1) {
            throw new Error("Multiple matches found constructing `MediasPostRequestPayloadIncludedInner` with oneOf schemas MediasPostRequestPayloadIncludedInnerOneOf, MediasPostRequestPayloadIncludedInnerOneOf1. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `MediasPostRequestPayloadIncludedInner` with oneOf schemas MediasPostRequestPayloadIncludedInnerOneOf, MediasPostRequestPayloadIncludedInnerOneOf1. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadIncludedInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadIncludedInner} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadIncludedInner} The populated <code>MediasPostRequestPayloadIncludedInner</code> instance.
     */
    static constructFromObject(data, obj) {
        return new MediasPostRequestPayloadIncludedInner(data);
    }

    /**
     * Gets the actual instance, which can be <code>MediasPostRequestPayloadIncludedInnerOneOf</code>, <code>MediasPostRequestPayloadIncludedInnerOneOf1</code>.
     * @return {(module:model/MediasPostRequestPayloadIncludedInnerOneOf|module:model/MediasPostRequestPayloadIncludedInnerOneOf1)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>MediasPostRequestPayloadIncludedInnerOneOf</code>, <code>MediasPostRequestPayloadIncludedInnerOneOf1</code>.
     * @param {(module:model/MediasPostRequestPayloadIncludedInnerOneOf|module:model/MediasPostRequestPayloadIncludedInnerOneOf1)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = MediasPostRequestPayloadIncludedInner.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of MediasPostRequestPayloadIncludedInner from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/MediasPostRequestPayloadIncludedInner} An instance of MediasPostRequestPayloadIncludedInner.
     */
    static fromJSON = function(json_string){
        return MediasPostRequestPayloadIncludedInner.constructFromObject(JSON.parse(json_string));
    }
}

/**
 * @member {module:model/MediasPostRequestPayloadIncludedInnerOneOf1Attributes} attributes
 */
MediasPostRequestPayloadIncludedInner.prototype['attributes'] = undefined;

/**
 * @member {String} id
 */
MediasPostRequestPayloadIncludedInner.prototype['id'] = undefined;

/**
 * @member {Object} relationships
 */
MediasPostRequestPayloadIncludedInner.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
MediasPostRequestPayloadIncludedInner.prototype['type'] = undefined;


MediasPostRequestPayloadIncludedInner.OneOf = ["MediasPostRequestPayloadIncludedInnerOneOf", "MediasPostRequestPayloadIncludedInnerOneOf1"];

export default MediasPostRequestPayloadIncludedInner;
