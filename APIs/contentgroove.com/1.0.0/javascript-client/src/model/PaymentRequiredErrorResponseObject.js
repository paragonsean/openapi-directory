...
import PaymentRequiredErrorResponseObjectErrorsInner from './PaymentRequiredErrorResponseObjectErrorsInner';

/**
 * The PaymentRequiredErrorResponseObject model module.
 * @module model/PaymentRequiredErrorResponseObject
 * @version 1.0.0
 */
class PaymentRequiredErrorResponseObject {
    /**
     * Constructs a new <code>PaymentRequiredErrorResponseObject</code>.
     * @alias module:model/PaymentRequiredErrorResponseObject
     */
    constructor() { 
        
        PaymentRequiredErrorResponseObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentRequiredErrorResponseObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentRequiredErrorResponseObject} obj Optional instance to populate.
     * @return {module:model/PaymentRequiredErrorResponseObject} The populated <code>PaymentRequiredErrorResponseObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentRequiredErrorResponseObject();

            if (data.hasOwnProperty('errors')) {
                obj['errors'] = ApiClient.convertToType(data['errors'], [PaymentRequiredErrorResponseObjectErrorsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentRequiredErrorResponseObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentRequiredErrorResponseObject</code>.
     */
    static validateJSON(data) {
        if (data['errors']) { // data not null
            ...
            for (const item of data['errors']) {
                PaymentRequiredErrorResponseObjectErrorsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/PaymentRequiredErrorResponseObjectErrorsInner>} errors
 */
PaymentRequiredErrorResponseObject.prototype['errors'] = undefined;
...
export default PaymentRequiredErrorResponseObject;
