...
/**
 * The MediasPostRequestPayloadIncludedInnerOneOf1 model module.
 * @module model/MediasPostRequestPayloadIncludedInnerOneOf1
 * @version 1.0.0
 */
class MediasPostRequestPayloadIncludedInnerOneOf1 {
    /**
     * Constructs a new <code>MediasPostRequestPayloadIncludedInnerOneOf1</code>.
     * @alias module:model/MediasPostRequestPayloadIncludedInnerOneOf1
     */
    constructor() { 
        
        MediasPostRequestPayloadIncludedInnerOneOf1.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadIncludedInnerOneOf1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadIncludedInnerOneOf1} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadIncludedInnerOneOf1} The populated <code>MediasPostRequestPayloadIncludedInnerOneOf1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadIncludedInnerOneOf1();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = MediasPostRequestPayloadIncludedInnerOneOf1Attributes.constructFromObject(data['attributes']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadIncludedInnerOneOf1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadIncludedInnerOneOf1</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          MediasPostRequestPayloadIncludedInnerOneOf1Attributes.validateJSON(data['attributes']);
        }
 ...
 */
MediasPostRequestPayloadIncludedInnerOneOf1.prototype['attributes'] = undefined;

/**
 * @member {String} id
 */
MediasPostRequestPayloadIncludedInnerOneOf1.prototype['id'] = undefined;

/**
 * @member {Object} relationships
 */
MediasPostRequestPayloadIncludedInnerOneOf1.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
MediasPostRequestPayloadIncludedInnerOneOf1.prototype['type'] = undefined;
...
export default MediasPostRequestPayloadIncludedInnerOneOf1;
