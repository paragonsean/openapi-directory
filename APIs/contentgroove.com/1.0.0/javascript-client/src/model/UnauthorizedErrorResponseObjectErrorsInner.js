...
/**
 * The UnauthorizedErrorResponseObjectErrorsInner model module.
 * @module model/UnauthorizedErrorResponseObjectErrorsInner
 * @version 1.0.0
 */
class UnauthorizedErrorResponseObjectErrorsInner {
    /**
     * Constructs a new <code>UnauthorizedErrorResponseObjectErrorsInner</code>.
     * @alias module:model/UnauthorizedErrorResponseObjectErrorsInner
     */
    constructor() { 
        
        UnauthorizedErrorResponseObjectErrorsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UnauthorizedErrorResponseObjectErrorsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnauthorizedErrorResponseObjectErrorsInner} obj Optional instance to populate.
     * @return {module:model/UnauthorizedErrorResponseObjectErrorsInner} The populated <code>UnauthorizedErrorResponseObjectErrorsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UnauthorizedErrorResponseObjectErrorsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>UnauthorizedErrorResponseObjectErrorsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnauthorizedErrorResponseObjectErrorsInner</code>.
     */
 ...
 */
UnauthorizedErrorResponseObjectErrorsInner.prototype['message'] = undefined;
...
export default UnauthorizedErrorResponseObjectErrorsInner;
