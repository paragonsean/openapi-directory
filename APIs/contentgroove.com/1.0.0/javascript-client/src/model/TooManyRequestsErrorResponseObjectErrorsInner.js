...
/**
 * The TooManyRequestsErrorResponseObjectErrorsInner model module.
 * @module model/TooManyRequestsErrorResponseObjectErrorsInner
 * @version 1.0.0
 */
class TooManyRequestsErrorResponseObjectErrorsInner {
    /**
     * Constructs a new <code>TooManyRequestsErrorResponseObjectErrorsInner</code>.
     * @alias module:model/TooManyRequestsErrorResponseObjectErrorsInner
     */
    constructor() { 
        
        TooManyRequestsErrorResponseObjectErrorsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TooManyRequestsErrorResponseObjectErrorsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TooManyRequestsErrorResponseObjectErrorsInner} obj Optional instance to populate.
     * @return {module:model/TooManyRequestsErrorResponseObjectErrorsInner} The populated <code>TooManyRequestsErrorResponseObjectErrorsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TooManyRequestsErrorResponseObjectErrorsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>TooManyRequestsErrorResponseObjectErrorsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TooManyRequestsErrorResponseObjectErrorsInner</code>.
     */
 ...
 */
TooManyRequestsErrorResponseObjectErrorsInner.prototype['detail'] = undefined;

/**
 * @member {String} status
 */
TooManyRequestsErrorResponseObjectErrorsInner.prototype['status'] = undefined;

/**
 * @member {String} title
 */
TooManyRequestsErrorResponseObjectErrorsInner.prototype['title'] = undefined;
...
export default TooManyRequestsErrorResponseObjectErrorsInner;
