...
/**
 * The WebhookSubscriptionResponseObjectDataAttributes model module.
 * @module model/WebhookSubscriptionResponseObjectDataAttributes
 * @version 1.0.0
 */
class WebhookSubscriptionResponseObjectDataAttributes {
    /**
     * Constructs a new <code>WebhookSubscriptionResponseObjectDataAttributes</code>.
     * @alias module:model/WebhookSubscriptionResponseObjectDataAttributes
     */
    constructor() { 
        
        WebhookSubscriptionResponseObjectDataAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhookSubscriptionResponseObjectDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookSubscriptionResponseObjectDataAttributes} obj Optional instance to populate.
     * @return {module:model/WebhookSubscriptionResponseObjectDataAttributes} The populated <code>WebhookSubscriptionResponseObjectDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookSubscriptionResponseObjectDataAttributes();
            ...
            if (data.hasOwnProperty('subscribed_events')) {
                obj['subscribed_events'] = ApiClient.convertToType(data['subscribed_events'], ['String']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookSubscriptionResponseObjectDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookSubscriptionResponseObjectDataAttributes</code>.
     */
 ...
 */
WebhookSubscriptionResponseObjectDataAttributes.prototype['active'] = undefined;

/**
 * @member {String} created_at
 */
WebhookSubscriptionResponseObjectDataAttributes.prototype['created_at'] = undefined;

/**
 * @member {Array.<String>} subscribed_events
 */
WebhookSubscriptionResponseObjectDataAttributes.prototype['subscribed_events'] = undefined;

/**
 * @member {String} updated_at
 */
WebhookSubscriptionResponseObjectDataAttributes.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
WebhookSubscriptionResponseObjectDataAttributes.prototype['url'] = undefined;
...
export default WebhookSubscriptionResponseObjectDataAttributes;
