...
/**
 * The LinksObjectData model module.
 * @module model/LinksObjectData
 * @version 1.0.0
 */
class LinksObjectData {
    /**
     * Constructs a new <code>LinksObjectData</code>.
     * @alias module:model/LinksObjectData
     */
    constructor() { 
        
        LinksObjectData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LinksObjectData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LinksObjectData} obj Optional instance to populate.
     * @return {module:model/LinksObjectData} The populated <code>LinksObjectData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinksObjectData();
    ...
    /**
     * Validates the JSON data with respect to <code>LinksObjectData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinksObjectData</code>.
     */
 ...
 */
LinksObjectData.prototype['current'] = undefined;

/**
 * @member {String} first
 */
LinksObjectData.prototype['first'] = undefined;

/**
 * @member {String} last
 */
LinksObjectData.prototype['last'] = undefined;

/**
 * @member {String} next
 */
LinksObjectData.prototype['next'] = undefined;

/**
 * @member {String} prev
 */
LinksObjectData.prototype['prev'] = undefined;

/**
 * @member {String} self
 */
LinksObjectData.prototype['self'] = undefined;
...
export default LinksObjectData;
