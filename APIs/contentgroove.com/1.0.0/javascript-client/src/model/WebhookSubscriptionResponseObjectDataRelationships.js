...
import ClipResponseObjectDataRelationshipsMedia from './ClipResponseObjectDataRelationshipsMedia';
import MediaResponseObjectDataRelationshipsClips from './MediaResponseObjectDataRelationshipsClips';

/**
 * The WebhookSubscriptionResponseObjectDataRelationships model module.
 * @module model/WebhookSubscriptionResponseObjectDataRelationships
 * @version 1.0.0
 */
class WebhookSubscriptionResponseObjectDataRelationships {
    /**
     * Constructs a new <code>WebhookSubscriptionResponseObjectDataRelationships</code>.
     * @alias module:model/WebhookSubscriptionResponseObjectDataRelationships
     */
    constructor() { 
        
        WebhookSubscriptionResponseObjectDataRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhookSubscriptionResponseObjectDataRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookSubscriptionResponseObjectDataRelationships} obj Optional instance to populate.
     * @return {module:model/WebhookSubscriptionResponseObjectDataRelationships} The populated <code>WebhookSubscriptionResponseObjectDataRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookSubscriptionResponseObjectDataRelationships();

            if (data.hasOwnProperty('user')) {
                obj['user'] = ClipResponseObjectDataRelationshipsMedia.constructFromObject(data['user']);
            }
            if (data.hasOwnProperty('webhook_events')) {
                obj['webhook_events'] = MediaResponseObjectDataRelationshipsClips.constructFromObject(data['webhook_events']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookSubscriptionResponseObjectDataRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookSubscriptionResponseObjectDataRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `user`
        if (data['user']) { // data not null
          ClipResponseObjectDataRelationshipsMedia.validateJSON(data['user']);
        }
        // validate the optional field `webhook_events`
        if (data['webhook_events']) { // data not null
          MediaResponseObjectDataRelationshipsClips.validateJSON(data['webhook_events']);
        }
...
/**
 * @member {module:model/ClipResponseObjectDataRelationshipsMedia} user
 */
WebhookSubscriptionResponseObjectDataRelationships.prototype['user'] = undefined;

/**
 * @member {module:model/MediaResponseObjectDataRelationshipsClips} webhook_events
 */
WebhookSubscriptionResponseObjectDataRelationships.prototype['webhook_events'] = undefined;
...
export default WebhookSubscriptionResponseObjectDataRelationships;
