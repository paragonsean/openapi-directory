...
import MediasPostRequestPayloadDataTranscriptionData from './MediasPostRequestPayloadDataTranscriptionData';

/**
 * The MediasPostRequestPayloadDataTranscription model module.
 * @module model/MediasPostRequestPayloadDataTranscription
 * @version 1.0.0
 */
class MediasPostRequestPayloadDataTranscription {
    /**
     * Constructs a new <code>MediasPostRequestPayloadDataTranscription</code>.
     * @alias module:model/MediasPostRequestPayloadDataTranscription
     */
    constructor() { 
        
        MediasPostRequestPayloadDataTranscription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadDataTranscription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadDataTranscription} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadDataTranscription} The populated <code>MediasPostRequestPayloadDataTranscription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadDataTranscription();

            if (data.hasOwnProperty('data')) {
                obj['data'] = MediasPostRequestPayloadDataTranscriptionData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadDataTranscription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadDataTranscription</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          MediasPostRequestPayloadDataTranscriptionData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/MediasPostRequestPayloadDataTranscriptionData} data
 */
MediasPostRequestPayloadDataTranscription.prototype['data'] = undefined;
...
export default MediasPostRequestPayloadDataTranscription;
