...
import CreateWebhookSubscriptionRequestDataAttributes from './CreateWebhookSubscriptionRequestDataAttributes';

/**
 * The CreateWebhookSubscriptionRequestData model module.
 * @module model/CreateWebhookSubscriptionRequestData
 * @version 1.0.0
 */
class CreateWebhookSubscriptionRequestData {
    /**
     * Constructs a new <code>CreateWebhookSubscriptionRequestData</code>.
     * @alias module:model/CreateWebhookSubscriptionRequestData
     * @param attributes {module:model/CreateWebhookSubscriptionRequestDataAttributes} 
     */
    constructor(attributes) { 
        
        CreateWebhookSubscriptionRequestData.initialize(this, attributes);
    }
    ...
    /**
     * Constructs a <code>CreateWebhookSubscriptionRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateWebhookSubscriptionRequestData} obj Optional instance to populate.
     * @return {module:model/CreateWebhookSubscriptionRequestData} The populated <code>CreateWebhookSubscriptionRequestData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateWebhookSubscriptionRequestData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = CreateWebhookSubscriptionRequestDataAttributes.constructFromObject(data['attributes']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateWebhookSubscriptionRequestData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateWebhookSubscriptionRequestData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateWebhookSubscriptionRequestData.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          CreateWebhookSubscriptionRequestDataAttributes.validateJSON(data['attributes']);
        }
...
CreateWebhookSubscriptionRequestData.RequiredProperties = ["attributes"];

/**
 * @member {module:model/CreateWebhookSubscriptionRequestDataAttributes} attributes
 */
CreateWebhookSubscriptionRequestData.prototype['attributes'] = undefined;
...
export default CreateWebhookSubscriptionRequestData;
