...
import MediaResponseObjectDataAttributes from './MediaResponseObjectDataAttributes';
import MediaResponseObjectDataRelationships from './MediaResponseObjectDataRelationships';

/**
 * The MediaResponseObjectData model module.
 * @module model/MediaResponseObjectData
 * @version 1.0.0
 */
class MediaResponseObjectData {
    /**
     * Constructs a new <code>MediaResponseObjectData</code>.
     * @alias module:model/MediaResponseObjectData
     */
    constructor() { 
        
        MediaResponseObjectData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediaResponseObjectData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediaResponseObjectData} obj Optional instance to populate.
     * @return {module:model/MediaResponseObjectData} The populated <code>MediaResponseObjectData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediaResponseObjectData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = MediaResponseObjectDataAttributes.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = MediaResponseObjectDataRelationships.constructFromObject(data['relationships']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MediaResponseObjectData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediaResponseObjectData</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          MediaResponseObjectDataAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          MediaResponseObjectDataRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/MediaResponseObjectDataAttributes} attributes
 */
MediaResponseObjectData.prototype['attributes'] = undefined;

/**
 * @member {String} id
 */
MediaResponseObjectData.prototype['id'] = undefined;

/**
 * @member {module:model/MediaResponseObjectDataRelationships} relationships
 */
MediaResponseObjectData.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
MediaResponseObjectData.prototype['type'] = undefined;
...
export default MediaResponseObjectData;
