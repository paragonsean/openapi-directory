...
import ClipResponseObjectDataRelationshipsMediaData from './ClipResponseObjectDataRelationshipsMediaData';

/**
 * The MediaResponseObjectDataRelationshipsClips model module.
 * @module model/MediaResponseObjectDataRelationshipsClips
 * @version 1.0.0
 */
class MediaResponseObjectDataRelationshipsClips {
    /**
     * Constructs a new <code>MediaResponseObjectDataRelationshipsClips</code>.
     * @alias module:model/MediaResponseObjectDataRelationshipsClips
     */
    constructor() { 
        
        MediaResponseObjectDataRelationshipsClips.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediaResponseObjectDataRelationshipsClips</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediaResponseObjectDataRelationshipsClips} obj Optional instance to populate.
     * @return {module:model/MediaResponseObjectDataRelationshipsClips} The populated <code>MediaResponseObjectDataRelationshipsClips</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediaResponseObjectDataRelationshipsClips();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ClipResponseObjectDataRelationshipsMediaData]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MediaResponseObjectDataRelationshipsClips</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediaResponseObjectDataRelationshipsClips</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ClipResponseObjectDataRelationshipsMediaData.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/ClipResponseObjectDataRelationshipsMediaData>} data
 */
MediaResponseObjectDataRelationshipsClips.prototype['data'] = undefined;
...
export default MediaResponseObjectDataRelationshipsClips;
