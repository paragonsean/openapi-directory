...
import MediasPostRequestPayloadData from './MediasPostRequestPayloadData';
import MediasPostRequestPayloadIncludedInner from './MediasPostRequestPayloadIncludedInner';

/**
 * The MediasPostRequestPayload model module.
 * @module model/MediasPostRequestPayload
 * @version 1.0.0
 */
class MediasPostRequestPayload {
    /**
     * Constructs a new <code>MediasPostRequestPayload</code>.
     * @alias module:model/MediasPostRequestPayload
     */
    constructor() { 
        
        MediasPostRequestPayload.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayload} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayload} The populated <code>MediasPostRequestPayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayload();

            if (data.hasOwnProperty('data')) {
                obj['data'] = MediasPostRequestPayloadData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('included')) {
                obj['included'] = ApiClient.convertToType(data['included'], [MediasPostRequestPayloadIncludedInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayload</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          MediasPostRequestPayloadData.validateJSON(data['data']);
        }
        if (data['included']) { // data not null
            ...
            for (const item of data['included']) {
                MediasPostRequestPayloadIncludedInner.validateJSON(item);
            };
        }
...
/**
 * @member {module:model/MediasPostRequestPayloadData} data
 */
MediasPostRequestPayload.prototype['data'] = undefined;

/**
 * @member {Array.<module:model/MediasPostRequestPayloadIncludedInner>} included
 */
MediasPostRequestPayload.prototype['included'] = undefined;
...
export default MediasPostRequestPayload;
