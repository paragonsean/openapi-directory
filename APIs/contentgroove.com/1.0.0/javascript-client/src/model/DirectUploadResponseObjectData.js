...
import DirectUploadResponseObjectDataAttributes from './DirectUploadResponseObjectDataAttributes';

/**
 * The DirectUploadResponseObjectData model module.
 * @module model/DirectUploadResponseObjectData
 * @version 1.0.0
 */
class DirectUploadResponseObjectData {
    /**
     * Constructs a new <code>DirectUploadResponseObjectData</code>.
     * @alias module:model/DirectUploadResponseObjectData
     */
    constructor() { 
        
        DirectUploadResponseObjectData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DirectUploadResponseObjectData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DirectUploadResponseObjectData} obj Optional instance to populate.
     * @return {module:model/DirectUploadResponseObjectData} The populated <code>DirectUploadResponseObjectData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DirectUploadResponseObjectData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = DirectUploadResponseObjectDataAttributes.constructFromObject(data['attributes']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DirectUploadResponseObjectData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DirectUploadResponseObjectData</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          DirectUploadResponseObjectDataAttributes.validateJSON(data['attributes']);
        }
...
/**
 * @member {module:model/DirectUploadResponseObjectDataAttributes} attributes
 */
DirectUploadResponseObjectData.prototype['attributes'] = undefined;

/**
 * @member {String} id
 */
DirectUploadResponseObjectData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
DirectUploadResponseObjectData.prototype['type'] = undefined;
...
export default DirectUploadResponseObjectData;
