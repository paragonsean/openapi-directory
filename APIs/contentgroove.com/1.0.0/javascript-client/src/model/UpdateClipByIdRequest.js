...
import UpdateClipByIdRequestData from './UpdateClipByIdRequestData';

/**
 * The UpdateClipByIdRequest model module.
 * @module model/UpdateClipByIdRequest
 * @version 1.0.0
 */
class UpdateClipByIdRequest {
    /**
     * Constructs a new <code>UpdateClipByIdRequest</code>.
     * @alias module:model/UpdateClipByIdRequest
     * @param data {module:model/UpdateClipByIdRequestData} 
     */
    constructor(data) { 
        
        UpdateClipByIdRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>UpdateClipByIdRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateClipByIdRequest} obj Optional instance to populate.
     * @return {module:model/UpdateClipByIdRequest} The populated <code>UpdateClipByIdRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateClipByIdRequest();

            if (data.hasOwnProperty('data')) {
                obj['data'] = UpdateClipByIdRequestData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateClipByIdRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateClipByIdRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateClipByIdRequest.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          UpdateClipByIdRequestData.validateJSON(data['data']);
        }
...
UpdateClipByIdRequest.RequiredProperties = ["data"];

/**
 * @member {module:model/UpdateClipByIdRequestData} data
 */
UpdateClipByIdRequest.prototype['data'] = undefined;
...
export default UpdateClipByIdRequest;
