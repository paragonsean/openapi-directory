...
/**
 * The ClipResponseObjectDataRelationships model module.
 * @module model/ClipResponseObjectDataRelationships
 * @version 1.0.0
 */
class ClipResponseObjectDataRelationships {
    /**
     * Constructs a new <code>ClipResponseObjectDataRelationships</code>.
     * @alias module:model/ClipResponseObjectDataRelationships
     */
    constructor() { 
        
        ClipResponseObjectDataRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClipResponseObjectDataRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClipResponseObjectDataRelationships} obj Optional instance to populate.
     * @return {module:model/ClipResponseObjectDataRelationships} The populated <code>ClipResponseObjectDataRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClipResponseObjectDataRelationships();

            if (data.hasOwnProperty('media')) {
                obj['media'] = ClipResponseObjectDataRelationshipsMedia.constructFromObject(data['media']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ClipResponseObjectDataRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClipResponseObjectDataRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `media`
        if (data['media']) { // data not null
          ClipResponseObjectDataRelationshipsMedia.validateJSON(data['media']);
        }
...
/**
 * @member {module:model/ClipResponseObjectDataRelationshipsMedia} media
 */
ClipResponseObjectDataRelationships.prototype['media'] = undefined;
...
export default ClipResponseObjectDataRelationships;
