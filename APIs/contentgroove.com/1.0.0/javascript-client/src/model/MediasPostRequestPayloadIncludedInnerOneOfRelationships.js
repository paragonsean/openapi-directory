...
import MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia from './MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia';

/**
 * The MediasPostRequestPayloadIncludedInnerOneOfRelationships model module.
 * @module model/MediasPostRequestPayloadIncludedInnerOneOfRelationships
 * @version 1.0.0
 */
class MediasPostRequestPayloadIncludedInnerOneOfRelationships {
    /**
     * Constructs a new <code>MediasPostRequestPayloadIncludedInnerOneOfRelationships</code>.
     * @alias module:model/MediasPostRequestPayloadIncludedInnerOneOfRelationships
     */
    constructor() { 
        
        MediasPostRequestPayloadIncludedInnerOneOfRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadIncludedInnerOneOfRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadIncludedInnerOneOfRelationships} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadIncludedInnerOneOfRelationships} The populated <code>MediasPostRequestPayloadIncludedInnerOneOfRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadIncludedInnerOneOfRelationships();

            if (data.hasOwnProperty('media')) {
                obj['media'] = MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia.constructFromObject(data['media']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadIncludedInnerOneOfRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadIncludedInnerOneOfRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `media`
        if (data['media']) { // data not null
          MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia.validateJSON(data['media']);
        }
...
/**
 * @member {module:model/MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia} media
 */
MediasPostRequestPayloadIncludedInnerOneOfRelationships.prototype['media'] = undefined;
...
export default MediasPostRequestPayloadIncludedInnerOneOfRelationships;
