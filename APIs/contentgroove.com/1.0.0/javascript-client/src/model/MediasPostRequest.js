...
import MediasPostRequestPayload from './MediasPostRequestPayload';

/**
 * The MediasPostRequest model module.
 * @module model/MediasPostRequest
 * @version 1.0.0
 */
class MediasPostRequest {
    /**
     * Constructs a new <code>MediasPostRequest</code>.
     * @alias module:model/MediasPostRequest
     */
    constructor() { 
        
        MediasPostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequest} obj Optional instance to populate.
     * @return {module:model/MediasPostRequest} The populated <code>MediasPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequest();

            if (data.hasOwnProperty('event')) {
                obj['event'] = ApiClient.convertToType(data['event'], 'String');
            }
            if (data.hasOwnProperty('payload')) {
                obj['payload'] = MediasPostRequestPayload.constructFromObject(data['payload']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['payload']) { // data not null
          MediasPostRequestPayload.validateJSON(data['payload']);
        }
 ...
 * @member {String} event
 */
MediasPostRequest.prototype['event'] = undefined;

/**
 * @member {module:model/MediasPostRequestPayload} payload
 */
MediasPostRequest.prototype['payload'] = undefined;
...
export default MediasPostRequest;
