...
import UpdateClipByIdRequestDataAttributes from './UpdateClipByIdRequestDataAttributes';

/**
 * The UpdateClipByIdRequestData model module.
 * @module model/UpdateClipByIdRequestData
 * @version 1.0.0
 */
class UpdateClipByIdRequestData {
    /**
     * Constructs a new <code>UpdateClipByIdRequestData</code>.
     * @alias module:model/UpdateClipByIdRequestData
     * @param attributes {module:model/UpdateClipByIdRequestDataAttributes} 
     */
    constructor(attributes) { 
        
        UpdateClipByIdRequestData.initialize(this, attributes);
    }
    ...
    /**
     * Constructs a <code>UpdateClipByIdRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateClipByIdRequestData} obj Optional instance to populate.
     * @return {module:model/UpdateClipByIdRequestData} The populated <code>UpdateClipByIdRequestData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateClipByIdRequestData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = UpdateClipByIdRequestDataAttributes.constructFromObject(data['attributes']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateClipByIdRequestData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateClipByIdRequestData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateClipByIdRequestData.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          UpdateClipByIdRequestDataAttributes.validateJSON(data['attributes']);
        }
...
UpdateClipByIdRequestData.RequiredProperties = ["attributes"];

/**
 * @member {module:model/UpdateClipByIdRequestDataAttributes} attributes
 */
UpdateClipByIdRequestData.prototype['attributes'] = undefined;
...
export default UpdateClipByIdRequestData;
