...
/**
 * The MediasPostRequestPayloadDataRelationshipsClipsDataInner model module.
 * @module model/MediasPostRequestPayloadDataRelationshipsClipsDataInner
 * @version 1.0.0
 */
class MediasPostRequestPayloadDataRelationshipsClipsDataInner {
    /**
     * Constructs a new <code>MediasPostRequestPayloadDataRelationshipsClipsDataInner</code>.
     * @alias module:model/MediasPostRequestPayloadDataRelationshipsClipsDataInner
     */
    constructor() { 
        
        MediasPostRequestPayloadDataRelationshipsClipsDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadDataRelationshipsClipsDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadDataRelationshipsClipsDataInner} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadDataRelationshipsClipsDataInner} The populated <code>MediasPostRequestPayloadDataRelationshipsClipsDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadDataRelationshipsClipsDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadDataRelationshipsClipsDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadDataRelationshipsClipsDataInner</code>.
     */
 ...
 * @member {String} id
 */
MediasPostRequestPayloadDataRelationshipsClipsDataInner.prototype['id'] = undefined;

/**
 * @member {String} type
 */
MediasPostRequestPayloadDataRelationshipsClipsDataInner.prototype['type'] = undefined;
...
export default MediasPostRequestPayloadDataRelationshipsClipsDataInner;
