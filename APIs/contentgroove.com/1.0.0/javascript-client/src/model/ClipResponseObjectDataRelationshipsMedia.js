...
/**
 * The ClipResponseObjectDataRelationshipsMedia model module.
 * @module model/ClipResponseObjectDataRelationshipsMedia
 * @version 1.0.0
 */
class ClipResponseObjectDataRelationshipsMedia {
    /**
     * Constructs a new <code>ClipResponseObjectDataRelationshipsMedia</code>.
     * @alias module:model/ClipResponseObjectDataRelationshipsMedia
     */
    constructor() { 
        
        ClipResponseObjectDataRelationshipsMedia.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClipResponseObjectDataRelationshipsMedia</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClipResponseObjectDataRelationshipsMedia} obj Optional instance to populate.
     * @return {module:model/ClipResponseObjectDataRelationshipsMedia} The populated <code>ClipResponseObjectDataRelationshipsMedia</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClipResponseObjectDataRelationshipsMedia();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ClipResponseObjectDataRelationshipsMediaData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ClipResponseObjectDataRelationshipsMedia</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClipResponseObjectDataRelationshipsMedia</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          ClipResponseObjectDataRelationshipsMediaData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/ClipResponseObjectDataRelationshipsMediaData} data
 */
ClipResponseObjectDataRelationshipsMedia.prototype['data'] = undefined;
...
export default ClipResponseObjectDataRelationshipsMedia;
