...
import TooManyRequestsErrorResponseObjectErrorsInner from './TooManyRequestsErrorResponseObjectErrorsInner';

/**
 * The TooManyRequestsErrorResponseObject model module.
 * @module model/TooManyRequestsErrorResponseObject
 * @version 1.0.0
 */
class TooManyRequestsErrorResponseObject {
    /**
     * Constructs a new <code>TooManyRequestsErrorResponseObject</code>.
     * @alias module:model/TooManyRequestsErrorResponseObject
     */
    constructor() { 
        
        TooManyRequestsErrorResponseObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TooManyRequestsErrorResponseObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TooManyRequestsErrorResponseObject} obj Optional instance to populate.
     * @return {module:model/TooManyRequestsErrorResponseObject} The populated <code>TooManyRequestsErrorResponseObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TooManyRequestsErrorResponseObject();

            if (data.hasOwnProperty('errors')) {
                obj['errors'] = ApiClient.convertToType(data['errors'], [TooManyRequestsErrorResponseObjectErrorsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TooManyRequestsErrorResponseObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TooManyRequestsErrorResponseObject</code>.
     */
    static validateJSON(data) {
        if (data['errors']) { // data not null
            ...
            for (const item of data['errors']) {
                TooManyRequestsErrorResponseObjectErrorsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/TooManyRequestsErrorResponseObjectErrorsInner>} errors
 */
TooManyRequestsErrorResponseObject.prototype['errors'] = undefined;
...
export default TooManyRequestsErrorResponseObject;
