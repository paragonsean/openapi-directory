...
/**
 * The ClipsResponseObject model module.
 * @module model/ClipsResponseObject
 * @version 1.0.0
 */
class ClipsResponseObject {
    /**
     * Constructs a new <code>ClipsResponseObject</code>.
     * @alias module:model/ClipsResponseObject
     */
    constructor() { 
        
        ClipsResponseObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClipsResponseObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClipsResponseObject} obj Optional instance to populate.
     * @return {module:model/ClipsResponseObject} The populated <code>ClipsResponseObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClipsResponseObject();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ClipResponseObjectData]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ClipsResponseObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClipsResponseObject</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ClipResponseObjectData.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/ClipResponseObjectData>} data
 */
ClipsResponseObject.prototype['data'] = undefined;

/**
 * @member {module:model/LinksObjectData} links
 */
ClipsResponseObject.prototype['links'] = undefined;
...
export default ClipsResponseObject;
