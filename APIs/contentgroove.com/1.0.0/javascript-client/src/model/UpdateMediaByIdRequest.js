...
import UpdateMediaByIdRequestData from './UpdateMediaByIdRequestData';

/**
 * The UpdateMediaByIdRequest model module.
 * @module model/UpdateMediaByIdRequest
 * @version 1.0.0
 */
class UpdateMediaByIdRequest {
    /**
     * Constructs a new <code>UpdateMediaByIdRequest</code>.
     * @alias module:model/UpdateMediaByIdRequest
     * @param data {module:model/UpdateMediaByIdRequestData} 
     */
    constructor(data) { 
        
        UpdateMediaByIdRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>UpdateMediaByIdRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateMediaByIdRequest} obj Optional instance to populate.
     * @return {module:model/UpdateMediaByIdRequest} The populated <code>UpdateMediaByIdRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateMediaByIdRequest();

            if (data.hasOwnProperty('data')) {
                obj['data'] = UpdateMediaByIdRequestData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateMediaByIdRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateMediaByIdRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateMediaByIdRequest.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          UpdateMediaByIdRequestData.validateJSON(data['data']);
        }
...
UpdateMediaByIdRequest.RequiredProperties = ["data"];

/**
 * @member {module:model/UpdateMediaByIdRequestData} data
 */
UpdateMediaByIdRequest.prototype['data'] = undefined;
...
export default UpdateMediaByIdRequest;
