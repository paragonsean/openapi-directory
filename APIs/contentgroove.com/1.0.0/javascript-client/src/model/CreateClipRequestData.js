...
import CreateClipRequestDataAttributes from './CreateClipRequestDataAttributes';

/**
 * The CreateClipRequestData model module.
 * @module model/CreateClipRequestData
 * @version 1.0.0
 */
class CreateClipRequestData {
    /**
     * Constructs a new <code>CreateClipRequestData</code>.
     * @alias module:model/CreateClipRequestData
     * @param attributes {module:model/CreateClipRequestDataAttributes} 
     */
    constructor(attributes) { 
        
        CreateClipRequestData.initialize(this, attributes);
    }
    ...
    /**
     * Constructs a <code>CreateClipRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateClipRequestData} obj Optional instance to populate.
     * @return {module:model/CreateClipRequestData} The populated <code>CreateClipRequestData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateClipRequestData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = CreateClipRequestDataAttributes.constructFromObject(data['attributes']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateClipRequestData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateClipRequestData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateClipRequestData.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          CreateClipRequestDataAttributes.validateJSON(data['attributes']);
        }
...
CreateClipRequestData.RequiredProperties = ["attributes"];

/**
 * @member {module:model/CreateClipRequestDataAttributes} attributes
 */
CreateClipRequestData.prototype['attributes'] = undefined;
...
export default CreateClipRequestData;
