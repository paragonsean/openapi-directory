...
/**
 * The CreateWebhookSubscriptionRequestDataAttributes model module.
 * @module model/CreateWebhookSubscriptionRequestDataAttributes
 * @version 1.0.0
 */
class CreateWebhookSubscriptionRequestDataAttributes {
    /**
     * Constructs a new <code>CreateWebhookSubscriptionRequestDataAttributes</code>.
     * @alias module:model/CreateWebhookSubscriptionRequestDataAttributes
     * @param url {String} 
     */
    constructor(url) { 
        
        CreateWebhookSubscriptionRequestDataAttributes.initialize(this, url);
    }
    ...
    /**
     * Constructs a <code>CreateWebhookSubscriptionRequestDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateWebhookSubscriptionRequestDataAttributes} obj Optional instance to populate.
     * @return {module:model/CreateWebhookSubscriptionRequestDataAttributes} The populated <code>CreateWebhookSubscriptionRequestDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateWebhookSubscriptionRequestDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateWebhookSubscriptionRequestDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateWebhookSubscriptionRequestDataAttributes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateWebhookSubscriptionRequestDataAttributes.RequiredProperties) {
...
CreateWebhookSubscriptionRequestDataAttributes.RequiredProperties = ["url"];

/**
 * @member {Array.<String>} subscribed_events
 */
CreateWebhookSubscriptionRequestDataAttributes.prototype['subscribed_events'] = undefined;

/**
 * @member {String} url
 */
CreateWebhookSubscriptionRequestDataAttributes.prototype['url'] = undefined;
...
export default CreateWebhookSubscriptionRequestDataAttributes;
