...
import MediasPostRequestPayloadDataAttributes from './MediasPostRequestPayloadDataAttributes';
import MediasPostRequestPayloadDataRelationships from './MediasPostRequestPayloadDataRelationships';
import MediasPostRequestPayloadDataTranscription from './MediasPostRequestPayloadDataTranscription';

/**
 * The MediasPostRequestPayloadData model module.
 * @module model/MediasPostRequestPayloadData
 * @version 1.0.0
 */
class MediasPostRequestPayloadData {
    /**
     * Constructs a new <code>MediasPostRequestPayloadData</code>.
     * @alias module:model/MediasPostRequestPayloadData
     */
    constructor() { 
        
        MediasPostRequestPayloadData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadData} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadData} The populated <code>MediasPostRequestPayloadData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = MediasPostRequestPayloadDataAttributes.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = MediasPostRequestPayloadDataRelationships.constructFromObject(data['relationships']);
            }
            if (data.hasOwnProperty('transcription')) {
                obj['transcription'] = MediasPostRequestPayloadDataTranscription.constructFromObject(data['transcription']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadData</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          MediasPostRequestPayloadDataAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          MediasPostRequestPayloadDataRelationships.validateJSON(data['relationships']);
        }
        // validate the optional field `transcription`
        if (data['transcription']) { // data not null
          MediasPostRequestPayloadDataTranscription.validateJSON(data['transcription']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/MediasPostRequestPayloadDataAttributes} attributes
 */
MediasPostRequestPayloadData.prototype['attributes'] = undefined;

/**
 * @member {String} id
 */
MediasPostRequestPayloadData.prototype['id'] = undefined;

/**
 * @member {module:model/MediasPostRequestPayloadDataRelationships} relationships
 */
MediasPostRequestPayloadData.prototype['relationships'] = undefined;

/**
 * @member {module:model/MediasPostRequestPayloadDataTranscription} transcription
 */
MediasPostRequestPayloadData.prototype['transcription'] = undefined;

/**
 * @member {String} type
 */
MediasPostRequestPayloadData.prototype['type'] = undefined;
...
export default MediasPostRequestPayloadData;
