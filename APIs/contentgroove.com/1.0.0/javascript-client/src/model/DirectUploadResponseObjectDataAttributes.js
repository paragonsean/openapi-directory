...
/**
 * The DirectUploadResponseObjectDataAttributes model module.
 * @module model/DirectUploadResponseObjectDataAttributes
 * @version 1.0.0
 */
class DirectUploadResponseObjectDataAttributes {
    /**
     * Constructs a new <code>DirectUploadResponseObjectDataAttributes</code>.
     * @alias module:model/DirectUploadResponseObjectDataAttributes
     */
    constructor() { 
        
        DirectUploadResponseObjectDataAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DirectUploadResponseObjectDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DirectUploadResponseObjectDataAttributes} obj Optional instance to populate.
     * @return {module:model/DirectUploadResponseObjectDataAttributes} The populated <code>DirectUploadResponseObjectDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DirectUploadResponseObjectDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>DirectUploadResponseObjectDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DirectUploadResponseObjectDataAttributes</code>.
     */
 ...
 */
DirectUploadResponseObjectDataAttributes.prototype['upload_id'] = undefined;

/**
 * @member {String} upload_url
 */
DirectUploadResponseObjectDataAttributes.prototype['upload_url'] = undefined;
...
export default DirectUploadResponseObjectDataAttributes;
