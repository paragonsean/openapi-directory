...
/**
 * The MediasPostRequestPayloadIncludedInnerOneOf1Attributes model module.
 * @module model/MediasPostRequestPayloadIncludedInnerOneOf1Attributes
 * @version 1.0.0
 */
class MediasPostRequestPayloadIncludedInnerOneOf1Attributes {
    /**
     * Constructs a new <code>MediasPostRequestPayloadIncludedInnerOneOf1Attributes</code>.
     * @alias module:model/MediasPostRequestPayloadIncludedInnerOneOf1Attributes
     */
    constructor() { 
        
        MediasPostRequestPayloadIncludedInnerOneOf1Attributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadIncludedInnerOneOf1Attributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadIncludedInnerOneOf1Attributes} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadIncludedInnerOneOf1Attributes} The populated <code>MediasPostRequestPayloadIncludedInnerOneOf1Attributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadIncludedInnerOneOf1Attributes();
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadIncludedInnerOneOf1Attributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadIncludedInnerOneOf1Attributes</code>.
     */
 ...
 * @member {String} text
 */
MediasPostRequestPayloadIncludedInnerOneOf1Attributes.prototype['text'] = undefined;
...
export default MediasPostRequestPayloadIncludedInnerOneOf1Attributes;
