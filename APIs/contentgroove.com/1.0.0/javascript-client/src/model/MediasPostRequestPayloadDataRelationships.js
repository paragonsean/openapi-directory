...
import MediasPostRequestPayloadDataRelationshipsClips from './MediasPostRequestPayloadDataRelationshipsClips';

/**
 * The MediasPostRequestPayloadDataRelationships model module.
 * @module model/MediasPostRequestPayloadDataRelationships
 * @version 1.0.0
 */
class MediasPostRequestPayloadDataRelationships {
    /**
     * Constructs a new <code>MediasPostRequestPayloadDataRelationships</code>.
     * @alias module:model/MediasPostRequestPayloadDataRelationships
     */
    constructor() { 
        
        MediasPostRequestPayloadDataRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadDataRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadDataRelationships} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadDataRelationships} The populated <code>MediasPostRequestPayloadDataRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadDataRelationships();

            if (data.hasOwnProperty('clips')) {
                obj['clips'] = MediasPostRequestPayloadDataRelationshipsClips.constructFromObject(data['clips']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadDataRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadDataRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `clips`
        if (data['clips']) { // data not null
          MediasPostRequestPayloadDataRelationshipsClips.validateJSON(data['clips']);
        }
...
/**
 * @member {module:model/MediasPostRequestPayloadDataRelationshipsClips} clips
 */
MediasPostRequestPayloadDataRelationships.prototype['clips'] = undefined;
...
export default MediasPostRequestPayloadDataRelationships;
