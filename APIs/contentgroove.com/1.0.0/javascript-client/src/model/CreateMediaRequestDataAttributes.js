...
/**
 * The CreateMediaRequestDataAttributes model module.
 * @module model/CreateMediaRequestDataAttributes
 * @version 1.0.0
 */
class CreateMediaRequestDataAttributes {
    /**
     * Constructs a new <code>CreateMediaRequestDataAttributes</code>.
     * @alias module:model/CreateMediaRequestDataAttributes
     */
    constructor() { 
        
        CreateMediaRequestDataAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateMediaRequestDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMediaRequestDataAttributes} obj Optional instance to populate.
     * @return {module:model/CreateMediaRequestDataAttributes} The populated <code>CreateMediaRequestDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMediaRequestDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMediaRequestDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMediaRequestDataAttributes</code>.
     */
 ...
 */
CreateMediaRequestDataAttributes.prototype['description'] = undefined;

/**
 * @member {String} name
 */
CreateMediaRequestDataAttributes.prototype['name'] = undefined;

/**
 * @member {String} source_url
 */
CreateMediaRequestDataAttributes.prototype['source_url'] = undefined;

/**
 * @member {String} upload_id
 */
CreateMediaRequestDataAttributes.prototype['upload_id'] = undefined;
...
export default CreateMediaRequestDataAttributes;
