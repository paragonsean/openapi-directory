...
/**
 * The UpdateClipByIdRequestDataAttributes model module.
 * @module model/UpdateClipByIdRequestDataAttributes
 * @version 1.0.0
 */
class UpdateClipByIdRequestDataAttributes {
    /**
     * Constructs a new <code>UpdateClipByIdRequestDataAttributes</code>.
     * @alias module:model/UpdateClipByIdRequestDataAttributes
     */
    constructor() { 
        
        UpdateClipByIdRequestDataAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateClipByIdRequestDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateClipByIdRequestDataAttributes} obj Optional instance to populate.
     * @return {module:model/UpdateClipByIdRequestDataAttributes} The populated <code>UpdateClipByIdRequestDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateClipByIdRequestDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateClipByIdRequestDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateClipByIdRequestDataAttributes</code>.
     */
 ...
 */
UpdateClipByIdRequestDataAttributes.prototype['end_time'] = undefined;

/**
 * @member {String} name
 */
UpdateClipByIdRequestDataAttributes.prototype['name'] = undefined;

/**
 * @member {Number} start_time
 */
UpdateClipByIdRequestDataAttributes.prototype['start_time'] = undefined;
...
export default UpdateClipByIdRequestDataAttributes;
