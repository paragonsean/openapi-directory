...
import MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData from './MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData';

/**
 * The MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia model module.
 * @module model/MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia
 * @version 1.0.0
 */
class MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia {
    /**
     * Constructs a new <code>MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia</code>.
     * @alias module:model/MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia
     */
    constructor() { 
        
        MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia} The populated <code>MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia();

            if (data.hasOwnProperty('data')) {
                obj['data'] = MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData} data
 */
MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia.prototype['data'] = undefined;
...
export default MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia;
