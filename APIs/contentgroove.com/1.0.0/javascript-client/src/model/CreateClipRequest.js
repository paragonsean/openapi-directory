...
import CreateClipRequestData from './CreateClipRequestData';

/**
 * The CreateClipRequest model module.
 * @module model/CreateClipRequest
 * @version 1.0.0
 */
class CreateClipRequest {
    /**
     * Constructs a new <code>CreateClipRequest</code>.
     * @alias module:model/CreateClipRequest
     * @param data {module:model/CreateClipRequestData} 
     */
    constructor(data) { 
        
        CreateClipRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>CreateClipRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateClipRequest} obj Optional instance to populate.
     * @return {module:model/CreateClipRequest} The populated <code>CreateClipRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateClipRequest();

            if (data.hasOwnProperty('data')) {
                obj['data'] = CreateClipRequestData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateClipRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateClipRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateClipRequest.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          CreateClipRequestData.validateJSON(data['data']);
        }
...
CreateClipRequest.RequiredProperties = ["data"];

/**
 * @member {module:model/CreateClipRequestData} data
 */
CreateClipRequest.prototype['data'] = undefined;
...
export default CreateClipRequest;
