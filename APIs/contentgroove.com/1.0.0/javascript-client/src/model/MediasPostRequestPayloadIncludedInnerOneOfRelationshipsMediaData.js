...
/**
 * The MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData model module.
 * @module model/MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData
 * @version 1.0.0
 */
class MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData {
    /**
     * Constructs a new <code>MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData</code>.
     * @alias module:model/MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData
     */
    constructor() { 
        
        MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData} The populated <code>MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData();
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData</code>.
     */
 ...
 * @member {String} id
 */
MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData.prototype['type'] = undefined;
...
export default MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData;
