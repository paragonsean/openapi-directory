...
/**
 * The MediasPostRequestPayloadIncludedInnerOneOfAttributes model module.
 * @module model/MediasPostRequestPayloadIncludedInnerOneOfAttributes
 * @version 1.0.0
 */
class MediasPostRequestPayloadIncludedInnerOneOfAttributes {
    /**
     * Constructs a new <code>MediasPostRequestPayloadIncludedInnerOneOfAttributes</code>.
     * @alias module:model/MediasPostRequestPayloadIncludedInnerOneOfAttributes
     */
    constructor() { 
        
        MediasPostRequestPayloadIncludedInnerOneOfAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasPostRequestPayloadIncludedInnerOneOfAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasPostRequestPayloadIncludedInnerOneOfAttributes} obj Optional instance to populate.
     * @return {module:model/MediasPostRequestPayloadIncludedInnerOneOfAttributes} The populated <code>MediasPostRequestPayloadIncludedInnerOneOfAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasPostRequestPayloadIncludedInnerOneOfAttributes();

            if (data.hasOwnProperty('created_at')) {
                obj['created_at'] = ApiClient.convertToType(data['created_at'], 'String');
            }
            if (data.hasOwnProperty('end_char')) {
                obj['end_char'] = ApiClient.convertToType(data['end_char'], 'String');
            }
            ...
            if (data.hasOwnProperty('media_file_duration')) {
                obj['media_file_duration'] = ApiClient.convertToType(data['media_file_duration'], 'Number');
            }
            if (data.hasOwnProperty('media_file_height')) {
                obj['media_file_height'] = ApiClient.convertToType(data['media_file_height'], 'Number');
            }
            ...
            if (data.hasOwnProperty('media_file_width')) {
                obj['media_file_width'] = ApiClient.convertToType(data['media_file_width'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MediasPostRequestPayloadIncludedInnerOneOfAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasPostRequestPayloadIncludedInnerOneOfAttributes</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['end_char'] && !(typeof data['end_char'] === 'string' || data['end_char'] instanceof String)) {
            throw new Error("Expected the field `end_char` to be a primitive type in the JSON string but got " + data['end_char']);
        }
        // ensure the json data is a string
 ...
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['created_at'] = undefined;

/**
 * @member {String} end_char
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['end_char'] = undefined;

/**
 * @member {Number} end_time
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['end_time'] = undefined;

/**
 * @member {String} external_id
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['external_id'] = undefined;

/**
 * @member {String} media_file_content_type
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['media_file_content_type'] = undefined;

/**
 * @member {Number} media_file_duration
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['media_file_duration'] = undefined;

/**
 * @member {Number} media_file_height
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['media_file_height'] = undefined;

/**
 * @member {String} media_file_preview_image_url
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['media_file_preview_image_url'] = undefined;

/**
 * @member {String} media_file_url
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['media_file_url'] = undefined;

/**
 * @member {Number} media_file_width
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['media_file_width'] = undefined;

/**
 * @member {String} name
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['name'] = undefined;

/**
 * @member {Number} rank
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['rank'] = undefined;

/**
 * @member {Number} start_char
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['start_char'] = undefined;

/**
 * @member {Number} start_time
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['start_time'] = undefined;

/**
 * @member {String} text
 */
MediasPostRequestPayloadIncludedInnerOneOfAttributes.prototype['text'] = undefined;
...
export default MediasPostRequestPayloadIncludedInnerOneOfAttributes;
