...
import UpdateMediaByIdRequestDataAttributes from './UpdateMediaByIdRequestDataAttributes';

/**
 * The UpdateMediaByIdRequestData model module.
 * @module model/UpdateMediaByIdRequestData
 * @version 1.0.0
 */
class UpdateMediaByIdRequestData {
    /**
     * Constructs a new <code>UpdateMediaByIdRequestData</code>.
     * @alias module:model/UpdateMediaByIdRequestData
     * @param attributes {module:model/UpdateMediaByIdRequestDataAttributes} 
     */
    constructor(attributes) { 
        
        UpdateMediaByIdRequestData.initialize(this, attributes);
    }
    ...
    /**
     * Constructs a <code>UpdateMediaByIdRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateMediaByIdRequestData} obj Optional instance to populate.
     * @return {module:model/UpdateMediaByIdRequestData} The populated <code>UpdateMediaByIdRequestData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateMediaByIdRequestData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = UpdateMediaByIdRequestDataAttributes.constructFromObject(data['attributes']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateMediaByIdRequestData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateMediaByIdRequestData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateMediaByIdRequestData.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          UpdateMediaByIdRequestDataAttributes.validateJSON(data['attributes']);
        }
...
UpdateMediaByIdRequestData.RequiredProperties = ["attributes"];

/**
 * @member {module:model/UpdateMediaByIdRequestDataAttributes} attributes
 */
UpdateMediaByIdRequestData.prototype['attributes'] = undefined;
...
export default UpdateMediaByIdRequestData;
