...
import DirectUploadResponseObjectData from './DirectUploadResponseObjectData';

/**
 * The DirectUploadResponseObject model module.
 * @module model/DirectUploadResponseObject
 * @version 1.0.0
 */
class DirectUploadResponseObject {
    /**
     * Constructs a new <code>DirectUploadResponseObject</code>.
     * @alias module:model/DirectUploadResponseObject
     */
    constructor() { 
        
        DirectUploadResponseObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DirectUploadResponseObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DirectUploadResponseObject} obj Optional instance to populate.
     * @return {module:model/DirectUploadResponseObject} The populated <code>DirectUploadResponseObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DirectUploadResponseObject();

            if (data.hasOwnProperty('data')) {
                obj['data'] = DirectUploadResponseObjectData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DirectUploadResponseObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DirectUploadResponseObject</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          DirectUploadResponseObjectData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/DirectUploadResponseObjectData} data
 */
DirectUploadResponseObject.prototype['data'] = undefined;
...
export default DirectUploadResponseObject;
