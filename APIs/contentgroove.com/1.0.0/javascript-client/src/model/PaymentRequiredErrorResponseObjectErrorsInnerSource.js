...
/**
 * The PaymentRequiredErrorResponseObjectErrorsInnerSource model module.
 * @module model/PaymentRequiredErrorResponseObjectErrorsInnerSource
 * @version 1.0.0
 */
class PaymentRequiredErrorResponseObjectErrorsInnerSource {
    /**
     * Constructs a new <code>PaymentRequiredErrorResponseObjectErrorsInnerSource</code>.
     * @alias module:model/PaymentRequiredErrorResponseObjectErrorsInnerSource
     */
    constructor() { 
        
        PaymentRequiredErrorResponseObjectErrorsInnerSource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentRequiredErrorResponseObjectErrorsInnerSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentRequiredErrorResponseObjectErrorsInnerSource} obj Optional instance to populate.
     * @return {module:model/PaymentRequiredErrorResponseObjectErrorsInnerSource} The populated <code>PaymentRequiredErrorResponseObjectErrorsInnerSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentRequiredErrorResponseObjectErrorsInnerSource();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentRequiredErrorResponseObjectErrorsInnerSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentRequiredErrorResponseObjectErrorsInnerSource</code>.
     */
 ...
 */
PaymentRequiredErrorResponseObjectErrorsInnerSource.prototype['pointer'] = undefined;
...
export default PaymentRequiredErrorResponseObjectErrorsInnerSource;
