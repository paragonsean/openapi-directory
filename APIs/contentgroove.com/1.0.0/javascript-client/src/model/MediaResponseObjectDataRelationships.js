...
/**
 * The MediaResponseObjectDataRelationships model module.
 * @module model/MediaResponseObjectDataRelationships
 * @version 1.0.0
 */
class MediaResponseObjectDataRelationships {
    /**
     * Constructs a new <code>MediaResponseObjectDataRelationships</code>.
     * @alias module:model/MediaResponseObjectDataRelationships
     */
    constructor() { 
        
        MediaResponseObjectDataRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediaResponseObjectDataRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediaResponseObjectDataRelationships} obj Optional instance to populate.
     * @return {module:model/MediaResponseObjectDataRelationships} The populated <code>MediaResponseObjectDataRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediaResponseObjectDataRelationships();

            if (data.hasOwnProperty('clips')) {
                obj['clips'] = MediaResponseObjectDataRelationshipsClips.constructFromObject(data['clips']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MediaResponseObjectDataRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediaResponseObjectDataRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `clips`
        if (data['clips']) { // data not null
          MediaResponseObjectDataRelationshipsClips.validateJSON(data['clips']);
        }
...
/**
 * @member {module:model/MediaResponseObjectDataRelationshipsClips} clips
 */
MediaResponseObjectDataRelationships.prototype['clips'] = undefined;
...
export default MediaResponseObjectDataRelationships;
