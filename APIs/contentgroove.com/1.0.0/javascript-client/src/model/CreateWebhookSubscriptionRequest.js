...
import CreateWebhookSubscriptionRequestData from './CreateWebhookSubscriptionRequestData';

/**
 * The CreateWebhookSubscriptionRequest model module.
 * @module model/CreateWebhookSubscriptionRequest
 * @version 1.0.0
 */
class CreateWebhookSubscriptionRequest {
    /**
     * Constructs a new <code>CreateWebhookSubscriptionRequest</code>.
     * @alias module:model/CreateWebhookSubscriptionRequest
     * @param data {module:model/CreateWebhookSubscriptionRequestData} 
     */
    constructor(data) { 
        
        CreateWebhookSubscriptionRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>CreateWebhookSubscriptionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateWebhookSubscriptionRequest} obj Optional instance to populate.
     * @return {module:model/CreateWebhookSubscriptionRequest} The populated <code>CreateWebhookSubscriptionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateWebhookSubscriptionRequest();

            if (data.hasOwnProperty('data')) {
                obj['data'] = CreateWebhookSubscriptionRequestData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateWebhookSubscriptionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateWebhookSubscriptionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateWebhookSubscriptionRequest.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          CreateWebhookSubscriptionRequestData.validateJSON(data['data']);
        }
...
CreateWebhookSubscriptionRequest.RequiredProperties = ["data"];

/**
 * @member {module:model/CreateWebhookSubscriptionRequestData} data
 */
CreateWebhookSubscriptionRequest.prototype['data'] = undefined;
