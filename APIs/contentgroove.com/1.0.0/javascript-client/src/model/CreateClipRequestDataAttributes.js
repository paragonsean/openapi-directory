...
/**
 * The CreateClipRequestDataAttributes model module.
 * @module model/CreateClipRequestDataAttributes
 * @version 1.0.0
 */
class CreateClipRequestDataAttributes {
    /**
     * Constructs a new <code>CreateClipRequestDataAttributes</code>.
     * @alias module:model/CreateClipRequestDataAttributes
     * @param endTime {Number} 
     * @param mediaId {String} 
     * @param name {String} 
     * @param startTime {Number} 
     */
    constructor(endTime, mediaId, name, startTime) { 
        
        CreateClipRequestDataAttributes.initialize(this, endTime, mediaId, name, startTime);
    }
     ...
     */
    static initialize(obj, endTime, mediaId, name, startTime) { 
    ...
    /**
     * Constructs a <code>CreateClipRequestDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateClipRequestDataAttributes} obj Optional instance to populate.
     * @return {module:model/CreateClipRequestDataAttributes} The populated <code>CreateClipRequestDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateClipRequestDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateClipRequestDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateClipRequestDataAttributes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateClipRequestDataAttributes.RequiredProperties) {
...
CreateClipRequestDataAttributes.RequiredProperties = ["end_time", "media_id", "name", "start_time"];

/**
 * @member {Number} end_time
 */
CreateClipRequestDataAttributes.prototype['end_time'] = undefined;

/**
 * @member {String} media_id
 */
CreateClipRequestDataAttributes.prototype['media_id'] = undefined;

/**
 * @member {String} name
 */
CreateClipRequestDataAttributes.prototype['name'] = undefined;

/**
 * @member {Number} start_time
 */
CreateClipRequestDataAttributes.prototype['start_time'] = undefined;
...
export default CreateClipRequestDataAttributes;
