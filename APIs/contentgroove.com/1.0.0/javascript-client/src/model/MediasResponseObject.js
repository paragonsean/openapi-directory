...
/**
 * The MediasResponseObject model module.
 * @module model/MediasResponseObject
 * @version 1.0.0
 */
class MediasResponseObject {
    /**
     * Constructs a new <code>MediasResponseObject</code>.
     * @alias module:model/MediasResponseObject
     */
    constructor() { 
        
        MediasResponseObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediasResponseObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediasResponseObject} obj Optional instance to populate.
     * @return {module:model/MediasResponseObject} The populated <code>MediasResponseObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediasResponseObject();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [MediaResponseObjectData]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MediasResponseObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediasResponseObject</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                MediaResponseObjectData.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/MediaResponseObjectData>} data
 */
MediasResponseObject.prototype['data'] = undefined;

/**
 * @member {module:model/LinksObjectData} links
 */
MediasResponseObject.prototype['links'] = undefined;
...
export default MediasResponseObject;
