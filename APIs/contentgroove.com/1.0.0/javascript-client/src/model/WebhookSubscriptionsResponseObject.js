...
import WebhookSubscriptionResponseObjectData from './WebhookSubscriptionResponseObjectData';

/**
 * The WebhookSubscriptionsResponseObject model module.
 * @module model/WebhookSubscriptionsResponseObject
 * @version 1.0.0
 */
class WebhookSubscriptionsResponseObject {
    /**
     * Constructs a new <code>WebhookSubscriptionsResponseObject</code>.
     * @alias module:model/WebhookSubscriptionsResponseObject
     */
    constructor() { 
        
        WebhookSubscriptionsResponseObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhookSubscriptionsResponseObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookSubscriptionsResponseObject} obj Optional instance to populate.
     * @return {module:model/WebhookSubscriptionsResponseObject} The populated <code>WebhookSubscriptionsResponseObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookSubscriptionsResponseObject();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [WebhookSubscriptionResponseObjectData]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookSubscriptionsResponseObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookSubscriptionsResponseObject</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                WebhookSubscriptionResponseObjectData.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/WebhookSubscriptionResponseObjectData>} data
 */
WebhookSubscriptionsResponseObject.prototype['data'] = undefined;

/**
 * @member {module:model/LinksObjectData} links
 */
WebhookSubscriptionsResponseObject.prototype['links'] = undefined;
...
export default WebhookSubscriptionsResponseObject;
