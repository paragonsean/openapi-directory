...
import WebhookSubscriptionResponseObjectDataAttributes from './WebhookSubscriptionResponseObjectDataAttributes';
import WebhookSubscriptionResponseObjectDataRelationships from './WebhookSubscriptionResponseObjectDataRelationships';

/**
 * The WebhookSubscriptionResponseObjectData model module.
 * @module model/WebhookSubscriptionResponseObjectData
 * @version 1.0.0
 */
class WebhookSubscriptionResponseObjectData {
    /**
     * Constructs a new <code>WebhookSubscriptionResponseObjectData</code>.
     * @alias module:model/WebhookSubscriptionResponseObjectData
     */
    constructor() { 
        
        WebhookSubscriptionResponseObjectData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhookSubscriptionResponseObjectData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookSubscriptionResponseObjectData} obj Optional instance to populate.
     * @return {module:model/WebhookSubscriptionResponseObjectData} The populated <code>WebhookSubscriptionResponseObjectData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookSubscriptionResponseObjectData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = WebhookSubscriptionResponseObjectDataAttributes.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = WebhookSubscriptionResponseObjectDataRelationships.constructFromObject(data['relationships']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookSubscriptionResponseObjectData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookSubscriptionResponseObjectData</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          WebhookSubscriptionResponseObjectDataAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          WebhookSubscriptionResponseObjectDataRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/WebhookSubscriptionResponseObjectDataAttributes} attributes
 */
WebhookSubscriptionResponseObjectData.prototype['attributes'] = undefined;

/**
 * @member {String} id
 */
WebhookSubscriptionResponseObjectData.prototype['id'] = undefined;

/**
 * @member {module:model/WebhookSubscriptionResponseObjectDataRelationships} relationships
 */
WebhookSubscriptionResponseObjectData.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
WebhookSubscriptionResponseObjectData.prototype['type'] = undefined;
...
export default WebhookSubscriptionResponseObjectData;
