...
import ClipResponseObjectDataAttributes from './ClipResponseObjectDataAttributes';
import ClipResponseObjectDataRelationships from './ClipResponseObjectDataRelationships';

/**
 * The ClipResponseObjectData model module.
 * @module model/ClipResponseObjectData
 * @version 1.0.0
 */
class ClipResponseObjectData {
    /**
     * Constructs a new <code>ClipResponseObjectData</code>.
     * @alias module:model/ClipResponseObjectData
     */
    constructor() { 
        
        ClipResponseObjectData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClipResponseObjectData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClipResponseObjectData} obj Optional instance to populate.
     * @return {module:model/ClipResponseObjectData} The populated <code>ClipResponseObjectData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClipResponseObjectData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = ClipResponseObjectDataAttributes.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = ClipResponseObjectDataRelationships.constructFromObject(data['relationships']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ClipResponseObjectData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClipResponseObjectData</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          ClipResponseObjectDataAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          ClipResponseObjectDataRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/ClipResponseObjectDataAttributes} attributes
 */
ClipResponseObjectData.prototype['attributes'] = undefined;

/**
 * @member {String} id
 */
ClipResponseObjectData.prototype['id'] = undefined;

/**
 * @member {module:model/ClipResponseObjectDataRelationships} relationships
 */
ClipResponseObjectData.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
ClipResponseObjectData.prototype['type'] = undefined;
...
export default ClipResponseObjectData;
