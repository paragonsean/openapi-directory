...
import CreateMediaRequestDataAttributes from './CreateMediaRequestDataAttributes';

/**
 * The CreateMediaRequestData model module.
 * @module model/CreateMediaRequestData
 * @version 1.0.0
 */
class CreateMediaRequestData {
    /**
     * Constructs a new <code>CreateMediaRequestData</code>.
     * @alias module:model/CreateMediaRequestData
     * @param attributes {module:model/CreateMediaRequestDataAttributes} 
     */
    constructor(attributes) { 
        
        CreateMediaRequestData.initialize(this, attributes);
    }
    ...
    /**
     * Constructs a <code>CreateMediaRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMediaRequestData} obj Optional instance to populate.
     * @return {module:model/CreateMediaRequestData} The populated <code>CreateMediaRequestData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMediaRequestData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = CreateMediaRequestDataAttributes.constructFromObject(data['attributes']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMediaRequestData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMediaRequestData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateMediaRequestData.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          CreateMediaRequestDataAttributes.validateJSON(data['attributes']);
        }
...
CreateMediaRequestData.RequiredProperties = ["attributes"];

/**
 * @member {module:model/CreateMediaRequestDataAttributes} attributes
 */
CreateMediaRequestData.prototype['attributes'] = undefined;
...
export default CreateMediaRequestData;
