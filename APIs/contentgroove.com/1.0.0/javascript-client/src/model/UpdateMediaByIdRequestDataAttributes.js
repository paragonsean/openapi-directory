...
/**
 * The UpdateMediaByIdRequestDataAttributes model module.
 * @module model/UpdateMediaByIdRequestDataAttributes
 * @version 1.0.0
 */
class UpdateMediaByIdRequestDataAttributes {
    /**
     * Constructs a new <code>UpdateMediaByIdRequestDataAttributes</code>.
     * @alias module:model/UpdateMediaByIdRequestDataAttributes
     */
    constructor() { 
        
        UpdateMediaByIdRequestDataAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateMediaByIdRequestDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateMediaByIdRequestDataAttributes} obj Optional instance to populate.
     * @return {module:model/UpdateMediaByIdRequestDataAttributes} The populated <code>UpdateMediaByIdRequestDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateMediaByIdRequestDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateMediaByIdRequestDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateMediaByIdRequestDataAttributes</code>.
     */
 ...
 */
UpdateMediaByIdRequestDataAttributes.prototype['description'] = undefined;

/**
 * @member {String} name
 */
UpdateMediaByIdRequestDataAttributes.prototype['name'] = undefined;
...
export default UpdateMediaByIdRequestDataAttributes;
