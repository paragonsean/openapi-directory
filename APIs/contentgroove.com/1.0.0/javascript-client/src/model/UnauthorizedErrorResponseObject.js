...
import UnauthorizedErrorResponseObjectErrorsInner from './UnauthorizedErrorResponseObjectErrorsInner';

/**
 * The UnauthorizedErrorResponseObject model module.
 * @module model/UnauthorizedErrorResponseObject
 * @version 1.0.0
 */
class UnauthorizedErrorResponseObject {
    /**
     * Constructs a new <code>UnauthorizedErrorResponseObject</code>.
     * @alias module:model/UnauthorizedErrorResponseObject
     */
    constructor() { 
        
        UnauthorizedErrorResponseObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UnauthorizedErrorResponseObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnauthorizedErrorResponseObject} obj Optional instance to populate.
     * @return {module:model/UnauthorizedErrorResponseObject} The populated <code>UnauthorizedErrorResponseObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UnauthorizedErrorResponseObject();

            if (data.hasOwnProperty('errors')) {
                obj['errors'] = ApiClient.convertToType(data['errors'], [UnauthorizedErrorResponseObjectErrorsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UnauthorizedErrorResponseObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnauthorizedErrorResponseObject</code>.
     */
    static validateJSON(data) {
        if (data['errors']) { // data not null
            ...
            for (const item of data['errors']) {
                UnauthorizedErrorResponseObjectErrorsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/UnauthorizedErrorResponseObjectErrorsInner>} errors
 */
UnauthorizedErrorResponseObject.prototype['errors'] = undefined;
...
export default UnauthorizedErrorResponseObject;
