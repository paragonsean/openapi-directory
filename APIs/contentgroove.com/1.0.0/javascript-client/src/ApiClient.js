...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.contentgroove.com/api/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.contentgroove.com/api/v1
         */
        ...
        this.authentications = {
            'BearerHeader': {type: 'apiKey', 'in': 'header', name: 'Authorization'}
        }
