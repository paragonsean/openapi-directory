...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('createClip', function() {
      it('should call createClip successfully', function(done) {
        //uncomment below and update the code to test createClip
        //instance.createClip(function(error) {
    ...
    describe('deleteClipById', function() {
      it('should call deleteClipById successfully', function(done) {
        //uncomment below and update the code to test deleteClipById
        //instance.deleteClipById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteMediaById', function() {
      it('should call deleteMediaById successfully', function(done) {
        //uncomment below and update the code to test deleteMediaById
        //instance.deleteMediaById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteWebhookSubscriptionById', function() {
      it('should call deleteWebhookSubscriptionById successfully', function(done) {
        //uncomment below and update the code to test deleteWebhookSubscriptionById
        //instance.deleteWebhookSubscriptionById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getClipById', function() {
      it('should call getClipById successfully', function(done) {
        //uncomment below and update the code to test getClipById
        //instance.getClipById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getMediaById', function() {
      it('should call getMediaById successfully', function(done) {
        //uncomment below and update the code to test getMediaById
        //instance.getMediaById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getMedias', function() {
      it('should call getMedias successfully', function(done) {
        //uncomment below and update the code to test getMedias
        //instance.getMedias(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getUploadUrl', function() {
      it('should call getUploadUrl successfully', function(done) {
        //uncomment below and update the code to test getUploadUrl
        //instance.getUploadUrl(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateClipById', function() {
      it('should call updateClipById successfully', function(done) {
        //uncomment below and update the code to test updateClipById
        //instance.updateClipById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateMediaById', function() {
      it('should call updateMediaById successfully', function(done) {
        //uncomment below and update the code to test updateMediaById
        //instance.updateMediaById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
