...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOf();
  });
  ...
  describe('MediasPostRequestPayloadIncludedInnerOneOf', function() {
    it('should create an instance of MediasPostRequestPayloadIncludedInnerOneOf', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadIncludedInnerOneOf
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOf();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOf);
    });
