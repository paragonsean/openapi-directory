...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOf1Attributes();
  });
  ...
  describe('MediasPostRequestPayloadIncludedInnerOneOf1Attributes', function() {
    it('should create an instance of MediasPostRequestPayloadIncludedInnerOneOf1Attributes', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadIncludedInnerOneOf1Attributes
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOf1Attributes();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOf1Attributes);
    });
