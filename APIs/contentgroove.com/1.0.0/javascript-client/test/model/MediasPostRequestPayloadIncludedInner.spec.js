...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInner();
  });
  ...
  describe('MediasPostRequestPayloadIncludedInner', function() {
    it('should create an instance of MediasPostRequestPayloadIncludedInner', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadIncludedInner
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInner();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadIncludedInner);
    });
