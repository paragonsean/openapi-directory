...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.CreateMediaRequest();
  });
  ...
  describe('CreateMediaRequest', function() {
    it('should create an instance of CreateMediaRequest', function() {
      // uncomment below and update the code to test CreateMediaRequest
      //var instance = new ContentGrooveApi.CreateMediaRequest();
      //expect(instance).to.be.a(ContentGrooveApi.CreateMediaRequest);
    });
