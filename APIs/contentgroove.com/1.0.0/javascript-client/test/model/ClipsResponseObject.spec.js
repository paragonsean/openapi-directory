...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.ClipsResponseObject();
  });
  ...
  describe('ClipsResponseObject', function() {
    it('should create an instance of ClipsResponseObject', function() {
      // uncomment below and update the code to test ClipsResponseObject
      //var instance = new ContentGrooveApi.ClipsResponseObject();
      //expect(instance).to.be.a(ContentGrooveApi.ClipsResponseObject);
    });
