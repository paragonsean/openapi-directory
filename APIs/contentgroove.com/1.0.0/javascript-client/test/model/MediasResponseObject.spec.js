...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasResponseObject();
  });
  ...
  describe('MediasResponseObject', function() {
    it('should create an instance of MediasResponseObject', function() {
      // uncomment below and update the code to test MediasResponseObject
      //var instance = new ContentGrooveApi.MediasResponseObject();
      //expect(instance).to.be.a(ContentGrooveApi.MediasResponseObject);
    });
