...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.DirectUploadResponseObjectData();
  });
  ...
  describe('DirectUploadResponseObjectData', function() {
    it('should create an instance of DirectUploadResponseObjectData', function() {
      // uncomment below and update the code to test DirectUploadResponseObjectData
      //var instance = new ContentGrooveApi.DirectUploadResponseObjectData();
      //expect(instance).to.be.a(ContentGrooveApi.DirectUploadResponseObjectData);
    });
