...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.CreateClipRequestDataAttributes();
  });
  ...
  describe('CreateClipRequestDataAttributes', function() {
    it('should create an instance of CreateClipRequestDataAttributes', function() {
      // uncomment below and update the code to test CreateClipRequestDataAttributes
      //var instance = new ContentGrooveApi.CreateClipRequestDataAttributes();
      //expect(instance).to.be.a(ContentGrooveApi.CreateClipRequestDataAttributes);
    });
