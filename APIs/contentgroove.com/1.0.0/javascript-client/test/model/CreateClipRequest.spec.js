...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.CreateClipRequest();
  });
  ...
  describe('CreateClipRequest', function() {
    it('should create an instance of CreateClipRequest', function() {
      // uncomment below and update the code to test CreateClipRequest
      //var instance = new ContentGrooveApi.CreateClipRequest();
      //expect(instance).to.be.a(ContentGrooveApi.CreateClipRequest);
    });
