...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayload();
  });
  ...
  describe('MediasPostRequestPayload', function() {
    it('should create an instance of MediasPostRequestPayload', function() {
      // uncomment below and update the code to test MediasPostRequestPayload
      //var instance = new ContentGrooveApi.MediasPostRequestPayload();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayload);
    });
