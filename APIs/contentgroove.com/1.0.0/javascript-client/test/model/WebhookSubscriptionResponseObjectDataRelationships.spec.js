...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.WebhookSubscriptionResponseObjectDataRelationships();
  });
  ...
  describe('WebhookSubscriptionResponseObjectDataRelationships', function() {
    it('should create an instance of WebhookSubscriptionResponseObjectDataRelationships', function() {
      // uncomment below and update the code to test WebhookSubscriptionResponseObjectDataRelationships
      //var instance = new ContentGrooveApi.WebhookSubscriptionResponseObjectDataRelationships();
      //expect(instance).to.be.a(ContentGrooveApi.WebhookSubscriptionResponseObjectDataRelationships);
    });
