...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadDataRelationshipsClipsDataInner();
  });
  ...
  describe('MediasPostRequestPayloadDataRelationshipsClipsDataInner', function() {
    it('should create an instance of MediasPostRequestPayloadDataRelationshipsClipsDataInner', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadDataRelationshipsClipsDataInner
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadDataRelationshipsClipsDataInner();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadDataRelationshipsClipsDataInner);
    });
