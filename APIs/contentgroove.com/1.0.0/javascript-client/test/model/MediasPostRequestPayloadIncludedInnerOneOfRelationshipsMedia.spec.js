...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia();
  });
  ...
  describe('MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia', function() {
    it('should create an instance of MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMedia);
    });
