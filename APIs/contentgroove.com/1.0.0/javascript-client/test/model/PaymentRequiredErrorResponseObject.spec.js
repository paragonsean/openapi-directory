...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.PaymentRequiredErrorResponseObject();
  });
  ...
  describe('PaymentRequiredErrorResponseObject', function() {
    it('should create an instance of PaymentRequiredErrorResponseObject', function() {
      // uncomment below and update the code to test PaymentRequiredErrorResponseObject
      //var instance = new ContentGrooveApi.PaymentRequiredErrorResponseObject();
      //expect(instance).to.be.a(ContentGrooveApi.PaymentRequiredErrorResponseObject);
    });
