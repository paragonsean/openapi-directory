...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediaResponseObjectData();
  });
  ...
  describe('MediaResponseObjectData', function() {
    it('should create an instance of MediaResponseObjectData', function() {
      // uncomment below and update the code to test MediaResponseObjectData
      //var instance = new ContentGrooveApi.MediaResponseObjectData();
      //expect(instance).to.be.a(ContentGrooveApi.MediaResponseObjectData);
    });
