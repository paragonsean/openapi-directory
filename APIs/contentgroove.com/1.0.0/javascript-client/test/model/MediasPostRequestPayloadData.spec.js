...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadData();
  });
  ...
  describe('MediasPostRequestPayloadData', function() {
    it('should create an instance of MediasPostRequestPayloadData', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadData
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadData();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadData);
    });
