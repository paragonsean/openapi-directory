...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediaResponseObjectDataRelationshipsClips();
  });
  ...
  describe('MediaResponseObjectDataRelationshipsClips', function() {
    it('should create an instance of MediaResponseObjectDataRelationshipsClips', function() {
      // uncomment below and update the code to test MediaResponseObjectDataRelationshipsClips
      //var instance = new ContentGrooveApi.MediaResponseObjectDataRelationshipsClips();
      //expect(instance).to.be.a(ContentGrooveApi.MediaResponseObjectDataRelationshipsClips);
    });
