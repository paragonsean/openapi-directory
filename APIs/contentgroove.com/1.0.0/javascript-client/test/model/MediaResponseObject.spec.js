...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediaResponseObject();
  });
  ...
  describe('MediaResponseObject', function() {
    it('should create an instance of MediaResponseObject', function() {
      // uncomment below and update the code to test MediaResponseObject
      //var instance = new ContentGrooveApi.MediaResponseObject();
      //expect(instance).to.be.a(ContentGrooveApi.MediaResponseObject);
    });
