...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediaResponseObjectDataAttributes();
  });
  ...
  describe('MediaResponseObjectDataAttributes', function() {
    it('should create an instance of MediaResponseObjectDataAttributes', function() {
      // uncomment below and update the code to test MediaResponseObjectDataAttributes
      //var instance = new ContentGrooveApi.MediaResponseObjectDataAttributes();
      //expect(instance).to.be.a(ContentGrooveApi.MediaResponseObjectDataAttributes);
    });
