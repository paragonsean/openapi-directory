...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.ClipResponseObjectDataRelationships();
  });
  ...
  describe('ClipResponseObjectDataRelationships', function() {
    it('should create an instance of ClipResponseObjectDataRelationships', function() {
      // uncomment below and update the code to test ClipResponseObjectDataRelationships
      //var instance = new ContentGrooveApi.ClipResponseObjectDataRelationships();
      //expect(instance).to.be.a(ContentGrooveApi.ClipResponseObjectDataRelationships);
    });
