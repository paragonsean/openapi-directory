...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.CreateWebhookSubscriptionRequest();
  });
  ...
  describe('CreateWebhookSubscriptionRequest', function() {
    it('should create an instance of CreateWebhookSubscriptionRequest', function() {
      // uncomment below and update the code to test CreateWebhookSubscriptionRequest
      //var instance = new ContentGrooveApi.CreateWebhookSubscriptionRequest();
      //expect(instance).to.be.a(ContentGrooveApi.CreateWebhookSubscriptionRequest);
    });
