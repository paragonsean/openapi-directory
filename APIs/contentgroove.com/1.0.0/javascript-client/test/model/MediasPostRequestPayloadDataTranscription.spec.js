...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadDataTranscription();
  });
  ...
  describe('MediasPostRequestPayloadDataTranscription', function() {
    it('should create an instance of MediasPostRequestPayloadDataTranscription', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadDataTranscription
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadDataTranscription();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadDataTranscription);
    });
