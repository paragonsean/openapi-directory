...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.WebhookSubscriptionsResponseObject();
  });
  ...
  describe('WebhookSubscriptionsResponseObject', function() {
    it('should create an instance of WebhookSubscriptionsResponseObject', function() {
      // uncomment below and update the code to test WebhookSubscriptionsResponseObject
      //var instance = new ContentGrooveApi.WebhookSubscriptionsResponseObject();
      //expect(instance).to.be.a(ContentGrooveApi.WebhookSubscriptionsResponseObject);
    });
