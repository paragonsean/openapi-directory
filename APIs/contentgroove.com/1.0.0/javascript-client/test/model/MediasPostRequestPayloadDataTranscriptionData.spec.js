...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadDataTranscriptionData();
  });
  ...
  describe('MediasPostRequestPayloadDataTranscriptionData', function() {
    it('should create an instance of MediasPostRequestPayloadDataTranscriptionData', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadDataTranscriptionData
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadDataTranscriptionData();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadDataTranscriptionData);
    });
