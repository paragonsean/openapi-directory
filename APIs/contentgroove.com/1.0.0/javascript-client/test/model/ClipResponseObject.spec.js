...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.ClipResponseObject();
  });
  ...
  describe('ClipResponseObject', function() {
    it('should create an instance of ClipResponseObject', function() {
      // uncomment below and update the code to test ClipResponseObject
      //var instance = new ContentGrooveApi.ClipResponseObject();
      //expect(instance).to.be.a(ContentGrooveApi.ClipResponseObject);
    });
