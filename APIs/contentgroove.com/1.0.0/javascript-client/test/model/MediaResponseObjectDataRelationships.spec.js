...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediaResponseObjectDataRelationships();
  });
  ...
  describe('MediaResponseObjectDataRelationships', function() {
    it('should create an instance of MediaResponseObjectDataRelationships', function() {
      // uncomment below and update the code to test MediaResponseObjectDataRelationships
      //var instance = new ContentGrooveApi.MediaResponseObjectDataRelationships();
      //expect(instance).to.be.a(ContentGrooveApi.MediaResponseObjectDataRelationships);
    });
