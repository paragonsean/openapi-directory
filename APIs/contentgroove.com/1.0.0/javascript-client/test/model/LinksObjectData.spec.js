...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.LinksObjectData();
  });
  ...
  describe('LinksObjectData', function() {
    it('should create an instance of LinksObjectData', function() {
      // uncomment below and update the code to test LinksObjectData
      //var instance = new ContentGrooveApi.LinksObjectData();
      //expect(instance).to.be.a(ContentGrooveApi.LinksObjectData);
    });
