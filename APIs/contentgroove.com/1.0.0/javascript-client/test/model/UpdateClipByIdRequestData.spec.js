...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.UpdateClipByIdRequestData();
  });
  ...
  describe('UpdateClipByIdRequestData', function() {
    it('should create an instance of UpdateClipByIdRequestData', function() {
      // uncomment below and update the code to test UpdateClipByIdRequestData
      //var instance = new ContentGrooveApi.UpdateClipByIdRequestData();
      //expect(instance).to.be.a(ContentGrooveApi.UpdateClipByIdRequestData);
    });
