...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.UpdateMediaByIdRequestDataAttributes();
  });
  ...
  describe('UpdateMediaByIdRequestDataAttributes', function() {
    it('should create an instance of UpdateMediaByIdRequestDataAttributes', function() {
      // uncomment below and update the code to test UpdateMediaByIdRequestDataAttributes
      //var instance = new ContentGrooveApi.UpdateMediaByIdRequestDataAttributes();
      //expect(instance).to.be.a(ContentGrooveApi.UpdateMediaByIdRequestDataAttributes);
    });
