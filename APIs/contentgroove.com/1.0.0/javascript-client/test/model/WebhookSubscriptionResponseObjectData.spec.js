...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.WebhookSubscriptionResponseObjectData();
  });
  ...
  describe('WebhookSubscriptionResponseObjectData', function() {
    it('should create an instance of WebhookSubscriptionResponseObjectData', function() {
      // uncomment below and update the code to test WebhookSubscriptionResponseObjectData
      //var instance = new ContentGrooveApi.WebhookSubscriptionResponseObjectData();
      //expect(instance).to.be.a(ContentGrooveApi.WebhookSubscriptionResponseObjectData);
    });
