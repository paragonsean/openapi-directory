...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.WebhookSubscriptionResponseObjectDataAttributes();
  });
  ...
  describe('WebhookSubscriptionResponseObjectDataAttributes', function() {
    it('should create an instance of WebhookSubscriptionResponseObjectDataAttributes', function() {
      // uncomment below and update the code to test WebhookSubscriptionResponseObjectDataAttributes
      //var instance = new ContentGrooveApi.WebhookSubscriptionResponseObjectDataAttributes();
      //expect(instance).to.be.a(ContentGrooveApi.WebhookSubscriptionResponseObjectDataAttributes);
    });
