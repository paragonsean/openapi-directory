...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.UpdateMediaByIdRequest();
  });
  ...
  describe('UpdateMediaByIdRequest', function() {
    it('should create an instance of UpdateMediaByIdRequest', function() {
      // uncomment below and update the code to test UpdateMediaByIdRequest
      //var instance = new ContentGrooveApi.UpdateMediaByIdRequest();
      //expect(instance).to.be.a(ContentGrooveApi.UpdateMediaByIdRequest);
    });
