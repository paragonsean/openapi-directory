...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.ClipResponseObjectData();
  });
  ...
  describe('ClipResponseObjectData', function() {
    it('should create an instance of ClipResponseObjectData', function() {
      // uncomment below and update the code to test ClipResponseObjectData
      //var instance = new ContentGrooveApi.ClipResponseObjectData();
      //expect(instance).to.be.a(ContentGrooveApi.ClipResponseObjectData);
    });
