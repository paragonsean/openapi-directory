...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.WebhookSubscriptionResponseObject();
  });
  ...
  describe('WebhookSubscriptionResponseObject', function() {
    it('should create an instance of WebhookSubscriptionResponseObject', function() {
      // uncomment below and update the code to test WebhookSubscriptionResponseObject
      //var instance = new ContentGrooveApi.WebhookSubscriptionResponseObject();
      //expect(instance).to.be.a(ContentGrooveApi.WebhookSubscriptionResponseObject);
    });
