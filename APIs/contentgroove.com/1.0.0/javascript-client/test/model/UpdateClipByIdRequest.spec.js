...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.UpdateClipByIdRequest();
  });
  ...
  describe('UpdateClipByIdRequest', function() {
    it('should create an instance of UpdateClipByIdRequest', function() {
      // uncomment below and update the code to test UpdateClipByIdRequest
      //var instance = new ContentGrooveApi.UpdateClipByIdRequest();
      //expect(instance).to.be.a(ContentGrooveApi.UpdateClipByIdRequest);
    });
