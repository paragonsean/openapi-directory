...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfAttributes();
  });
  ...
  describe('MediasPostRequestPayloadIncludedInnerOneOfAttributes', function() {
    it('should create an instance of MediasPostRequestPayloadIncludedInnerOneOfAttributes', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadIncludedInnerOneOfAttributes
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfAttributes();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfAttributes);
    });
    ...
    it('should have the property mediaFileDuration (base name: "media_file_duration")', function() {
      // uncomment below and update the code to test the property mediaFileDuration
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfAttributes();
      //expect(instance).to.be();
    });
