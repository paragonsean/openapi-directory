...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequest();
  });
  ...
  describe('MediasPostRequest', function() {
    it('should create an instance of MediasPostRequest', function() {
      // uncomment below and update the code to test MediasPostRequest
      //var instance = new ContentGrooveApi.MediasPostRequest();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequest);
    });
