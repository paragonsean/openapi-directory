...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.CreateClipRequestData();
  });
  ...
  describe('CreateClipRequestData', function() {
    it('should create an instance of CreateClipRequestData', function() {
      // uncomment below and update the code to test CreateClipRequestData
      //var instance = new ContentGrooveApi.CreateClipRequestData();
      //expect(instance).to.be.a(ContentGrooveApi.CreateClipRequestData);
    });
