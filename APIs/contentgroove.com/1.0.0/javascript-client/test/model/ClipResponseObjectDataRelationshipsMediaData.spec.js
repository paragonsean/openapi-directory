...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.ClipResponseObjectDataRelationshipsMediaData();
  });
  ...
  describe('ClipResponseObjectDataRelationshipsMediaData', function() {
    it('should create an instance of ClipResponseObjectDataRelationshipsMediaData', function() {
      // uncomment below and update the code to test ClipResponseObjectDataRelationshipsMediaData
      //var instance = new ContentGrooveApi.ClipResponseObjectDataRelationshipsMediaData();
      //expect(instance).to.be.a(ContentGrooveApi.ClipResponseObjectDataRelationshipsMediaData);
    });
