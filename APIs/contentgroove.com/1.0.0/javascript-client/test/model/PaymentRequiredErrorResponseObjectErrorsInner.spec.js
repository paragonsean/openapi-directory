...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.PaymentRequiredErrorResponseObjectErrorsInner();
  });
  ...
  describe('PaymentRequiredErrorResponseObjectErrorsInner', function() {
    it('should create an instance of PaymentRequiredErrorResponseObjectErrorsInner', function() {
      // uncomment below and update the code to test PaymentRequiredErrorResponseObjectErrorsInner
      //var instance = new ContentGrooveApi.PaymentRequiredErrorResponseObjectErrorsInner();
      //expect(instance).to.be.a(ContentGrooveApi.PaymentRequiredErrorResponseObjectErrorsInner);
    });
