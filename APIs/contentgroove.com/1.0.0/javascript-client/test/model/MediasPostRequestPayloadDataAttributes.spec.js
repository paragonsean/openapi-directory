...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadDataAttributes();
  });
  ...
  describe('MediasPostRequestPayloadDataAttributes', function() {
    it('should create an instance of MediasPostRequestPayloadDataAttributes', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadDataAttributes
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadDataAttributes();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadDataAttributes);
    });
