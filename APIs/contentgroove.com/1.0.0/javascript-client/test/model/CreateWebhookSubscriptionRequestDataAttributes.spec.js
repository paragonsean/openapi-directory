...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.CreateWebhookSubscriptionRequestDataAttributes();
  });
  ...
  describe('CreateWebhookSubscriptionRequestDataAttributes', function() {
    it('should create an instance of CreateWebhookSubscriptionRequestDataAttributes', function() {
      // uncomment below and update the code to test CreateWebhookSubscriptionRequestDataAttributes
      //var instance = new ContentGrooveApi.CreateWebhookSubscriptionRequestDataAttributes();
      //expect(instance).to.be.a(ContentGrooveApi.CreateWebhookSubscriptionRequestDataAttributes);
    });
