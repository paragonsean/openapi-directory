...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.TooManyRequestsErrorResponseObjectErrorsInner();
  });
  ...
  describe('TooManyRequestsErrorResponseObjectErrorsInner', function() {
    it('should create an instance of TooManyRequestsErrorResponseObjectErrorsInner', function() {
      // uncomment below and update the code to test TooManyRequestsErrorResponseObjectErrorsInner
      //var instance = new ContentGrooveApi.TooManyRequestsErrorResponseObjectErrorsInner();
      //expect(instance).to.be.a(ContentGrooveApi.TooManyRequestsErrorResponseObjectErrorsInner);
    });
