...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadDataRelationships();
  });
  ...
  describe('MediasPostRequestPayloadDataRelationships', function() {
    it('should create an instance of MediasPostRequestPayloadDataRelationships', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadDataRelationships
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadDataRelationships();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadDataRelationships);
    });
