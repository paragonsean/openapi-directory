...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.UnauthorizedErrorResponseObject();
  });
  ...
  describe('UnauthorizedErrorResponseObject', function() {
    it('should create an instance of UnauthorizedErrorResponseObject', function() {
      // uncomment below and update the code to test UnauthorizedErrorResponseObject
      //var instance = new ContentGrooveApi.UnauthorizedErrorResponseObject();
      //expect(instance).to.be.a(ContentGrooveApi.UnauthorizedErrorResponseObject);
    });
