...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.TooManyRequestsErrorResponseObject();
  });
  ...
  describe('TooManyRequestsErrorResponseObject', function() {
    it('should create an instance of TooManyRequestsErrorResponseObject', function() {
      // uncomment below and update the code to test TooManyRequestsErrorResponseObject
      //var instance = new ContentGrooveApi.TooManyRequestsErrorResponseObject();
      //expect(instance).to.be.a(ContentGrooveApi.TooManyRequestsErrorResponseObject);
    });
