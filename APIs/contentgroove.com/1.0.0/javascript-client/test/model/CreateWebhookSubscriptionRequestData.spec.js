...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.CreateWebhookSubscriptionRequestData();
  });
  ...
  describe('CreateWebhookSubscriptionRequestData', function() {
    it('should create an instance of CreateWebhookSubscriptionRequestData', function() {
      // uncomment below and update the code to test CreateWebhookSubscriptionRequestData
      //var instance = new ContentGrooveApi.CreateWebhookSubscriptionRequestData();
      //expect(instance).to.be.a(ContentGrooveApi.CreateWebhookSubscriptionRequestData);
    });
