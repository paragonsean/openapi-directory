...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.CreateMediaRequestDataAttributes();
  });
  ...
  describe('CreateMediaRequestDataAttributes', function() {
    it('should create an instance of CreateMediaRequestDataAttributes', function() {
      // uncomment below and update the code to test CreateMediaRequestDataAttributes
      //var instance = new ContentGrooveApi.CreateMediaRequestDataAttributes();
      //expect(instance).to.be.a(ContentGrooveApi.CreateMediaRequestDataAttributes);
    });
