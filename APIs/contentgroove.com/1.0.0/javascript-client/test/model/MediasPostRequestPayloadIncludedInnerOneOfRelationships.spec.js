...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfRelationships();
  });
  ...
  describe('MediasPostRequestPayloadIncludedInnerOneOfRelationships', function() {
    it('should create an instance of MediasPostRequestPayloadIncludedInnerOneOfRelationships', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadIncludedInnerOneOfRelationships
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfRelationships();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfRelationships);
    });
