...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData();
  });
  ...
  describe('MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData', function() {
    it('should create an instance of MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOfRelationshipsMediaData);
    });
