...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadDataRelationshipsClips();
  });
  ...
  describe('MediasPostRequestPayloadDataRelationshipsClips', function() {
    it('should create an instance of MediasPostRequestPayloadDataRelationshipsClips', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadDataRelationshipsClips
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadDataRelationshipsClips();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadDataRelationshipsClips);
    });
