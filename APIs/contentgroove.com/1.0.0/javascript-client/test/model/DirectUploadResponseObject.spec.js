...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.DirectUploadResponseObject();
  });
  ...
  describe('DirectUploadResponseObject', function() {
    it('should create an instance of DirectUploadResponseObject', function() {
      // uncomment below and update the code to test DirectUploadResponseObject
      //var instance = new ContentGrooveApi.DirectUploadResponseObject();
      //expect(instance).to.be.a(ContentGrooveApi.DirectUploadResponseObject);
    });
