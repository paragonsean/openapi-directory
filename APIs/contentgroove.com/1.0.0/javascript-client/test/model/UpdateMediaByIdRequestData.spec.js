...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.UpdateMediaByIdRequestData();
  });
  ...
  describe('UpdateMediaByIdRequestData', function() {
    it('should create an instance of UpdateMediaByIdRequestData', function() {
      // uncomment below and update the code to test UpdateMediaByIdRequestData
      //var instance = new ContentGrooveApi.UpdateMediaByIdRequestData();
      //expect(instance).to.be.a(ContentGrooveApi.UpdateMediaByIdRequestData);
    });
