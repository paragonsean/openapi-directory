...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.ClipResponseObjectDataRelationshipsMedia();
  });
  ...
  describe('ClipResponseObjectDataRelationshipsMedia', function() {
    it('should create an instance of ClipResponseObjectDataRelationshipsMedia', function() {
      // uncomment below and update the code to test ClipResponseObjectDataRelationshipsMedia
      //var instance = new ContentGrooveApi.ClipResponseObjectDataRelationshipsMedia();
      //expect(instance).to.be.a(ContentGrooveApi.ClipResponseObjectDataRelationshipsMedia);
    });
