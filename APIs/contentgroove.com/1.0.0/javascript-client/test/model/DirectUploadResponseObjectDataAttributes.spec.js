...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.DirectUploadResponseObjectDataAttributes();
  });
  ...
  describe('DirectUploadResponseObjectDataAttributes', function() {
    it('should create an instance of DirectUploadResponseObjectDataAttributes', function() {
      // uncomment below and update the code to test DirectUploadResponseObjectDataAttributes
      //var instance = new ContentGrooveApi.DirectUploadResponseObjectDataAttributes();
      //expect(instance).to.be.a(ContentGrooveApi.DirectUploadResponseObjectDataAttributes);
    });
