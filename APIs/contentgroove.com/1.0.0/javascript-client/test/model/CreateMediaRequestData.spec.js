...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.CreateMediaRequestData();
  });
  ...
  describe('CreateMediaRequestData', function() {
    it('should create an instance of CreateMediaRequestData', function() {
      // uncomment below and update the code to test CreateMediaRequestData
      //var instance = new ContentGrooveApi.CreateMediaRequestData();
      //expect(instance).to.be.a(ContentGrooveApi.CreateMediaRequestData);
    });
