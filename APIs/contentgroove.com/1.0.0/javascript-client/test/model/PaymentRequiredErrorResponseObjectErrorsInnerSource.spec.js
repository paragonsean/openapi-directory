...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.PaymentRequiredErrorResponseObjectErrorsInnerSource();
  });
  ...
  describe('PaymentRequiredErrorResponseObjectErrorsInnerSource', function() {
    it('should create an instance of PaymentRequiredErrorResponseObjectErrorsInnerSource', function() {
      // uncomment below and update the code to test PaymentRequiredErrorResponseObjectErrorsInnerSource
      //var instance = new ContentGrooveApi.PaymentRequiredErrorResponseObjectErrorsInnerSource();
      //expect(instance).to.be.a(ContentGrooveApi.PaymentRequiredErrorResponseObjectErrorsInnerSource);
    });
