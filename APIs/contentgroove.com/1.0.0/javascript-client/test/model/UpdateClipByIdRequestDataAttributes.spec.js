...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.UpdateClipByIdRequestDataAttributes();
  });
  ...
  describe('UpdateClipByIdRequestDataAttributes', function() {
    it('should create an instance of UpdateClipByIdRequestDataAttributes', function() {
      // uncomment below and update the code to test UpdateClipByIdRequestDataAttributes
      //var instance = new ContentGrooveApi.UpdateClipByIdRequestDataAttributes();
      //expect(instance).to.be.a(ContentGrooveApi.UpdateClipByIdRequestDataAttributes);
    });
