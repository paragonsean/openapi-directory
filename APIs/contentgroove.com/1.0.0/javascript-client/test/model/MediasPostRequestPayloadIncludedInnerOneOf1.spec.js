...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOf1();
  });
  ...
  describe('MediasPostRequestPayloadIncludedInnerOneOf1', function() {
    it('should create an instance of MediasPostRequestPayloadIncludedInnerOneOf1', function() {
      // uncomment below and update the code to test MediasPostRequestPayloadIncludedInnerOneOf1
      //var instance = new ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOf1();
      //expect(instance).to.be.a(ContentGrooveApi.MediasPostRequestPayloadIncludedInnerOneOf1);
    });
