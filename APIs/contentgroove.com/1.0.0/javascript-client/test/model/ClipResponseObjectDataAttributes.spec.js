...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentGrooveApi.ClipResponseObjectDataAttributes();
  });
  ...
  describe('ClipResponseObjectDataAttributes', function() {
    it('should create an instance of ClipResponseObjectDataAttributes', function() {
      // uncomment below and update the code to test ClipResponseObjectDataAttributes
      //var instance = new ContentGrooveApi.ClipResponseObjectDataAttributes();
      //expect(instance).to.be.a(ContentGrooveApi.ClipResponseObjectDataAttributes);
    });
    ...
    it('should have the property endChar (base name: "end_char")', function() {
      // uncomment below and update the code to test the property endChar
      //var instance = new ContentGrooveApi.ClipResponseObjectDataAttributes();
      //expect(instance).to.be();
    });
    ...
    it('should have the property mediaFileContentDuration (base name: "media_file_content_duration")', function() {
      // uncomment below and update the code to test the property mediaFileContentDuration
      //var instance = new ContentGrooveApi.ClipResponseObjectDataAttributes();
      //expect(instance).to.be();
    });

    it('should have the property mediaFileContentType (base name: "media_file_content_type")', function() {
      // uncomment below and update the code to test the property mediaFileContentType
      //var instance = new ContentGrooveApi.ClipResponseObjectDataAttributes();
      //expect(instance).to.be();
    });

    it('should have the property mediaFileHeight (base name: "media_file_height")', function() {
      // uncomment below and update the code to test the property mediaFileHeight
      //var instance = new ContentGrooveApi.ClipResponseObjectDataAttributes();
      //expect(instance).to.be();
    });

    it('should have the property mediaFilePreviewImageUrl (base name: "media_file_preview_image_url")', function() {
      // uncomment below and update the code to test the property mediaFilePreviewImageUrl
      //var instance = new ContentGrooveApi.ClipResponseObjectDataAttributes();
      //expect(instance).to.be();
    });

    it('should have the property mediaFileUrl (base name: "media_file_url")', function() {
      // uncomment below and update the code to test the property mediaFileUrl
      //var instance = new ContentGrooveApi.ClipResponseObjectDataAttributes();
      //expect(instance).to.be();
    });

    it('should have the property mediaFileWidth (base name: "media_file_width")', function() {
      // uncomment below and update the code to test the property mediaFileWidth
      //var instance = new ContentGrooveApi.ClipResponseObjectDataAttributes();
      //expect(instance).to.be();
    });
    ...
    it('should have the property startChar (base name: "start_char")', function() {
      // uncomment below and update the code to test the property startChar
      //var instance = new ContentGrooveApi.ClipResponseObjectDataAttributes();
      //expect(instance).to.be();
    });
