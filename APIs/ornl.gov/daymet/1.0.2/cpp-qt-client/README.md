...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::apiDataGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::apiDataGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      double lat = create(); // double | Latitude component of location.
      ...
      double lon = create(); // double | Longitude component of location.
      ...
      QString format = create(); // QString | Specify a format for data retrieval.
      ...
      QList<QString> vars = create(); // QList<QString> | Daymet Daily weather estimates.
      ...
      QList<QString> years = create(); // QList<QString> | Subset on years [1980..2019].
      ...
      QDate start = create(); // QDate | Subset on dates (start date).
      ...
      QDate end = create(); // QDate | Subset on dates (end date).
      apiInstance.apiDataGet(latlonformatvarsyearsstartend);
