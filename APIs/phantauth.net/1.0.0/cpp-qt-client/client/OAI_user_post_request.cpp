...
#include "OAI_user_post_request.h"
...
OAI_user_post_request::OAI_user_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_user_post_request::OAI_user_post_request() {
    this->initializeModel();
}

OAI_user_post_request::~OAI_user_post_request() {}

void OAI_user_post_request::initializeModel() {
...
void OAI_user_post_request::fromJson(QString jsonString) {
...
void OAI_user_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_user_post_request::asJson() const {
...
QJsonObject OAI_user_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAI_user_post_request::getId() const {
    return m_id;
}
void OAI_user_post_request::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_user_post_request::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_user_post_request::is_id_Valid() const{
    return m_id_isValid;
}

OAI_user_post_request_address OAI_user_post_request::getAddress() const {
    return m_address;
}
void OAI_user_post_request::setAddress(const OAI_user_post_request_address &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAI_user_post_request::is_address_Set() const{
    return m_address_isSet;
}

bool OAI_user_post_request::is_address_Valid() const{
    return m_address_isValid;
}

QString OAI_user_post_request::getBirthdate() const {
    return m_birthdate;
}
void OAI_user_post_request::setBirthdate(const QString &birthdate) {
    m_birthdate = birthdate;
    m_birthdate_isSet = true;
}

bool OAI_user_post_request::is_birthdate_Set() const{
    return m_birthdate_isSet;
}

bool OAI_user_post_request::is_birthdate_Valid() const{
    return m_birthdate_isValid;
}

QString OAI_user_post_request::getEmail() const {
    return m_email;
}
void OAI_user_post_request::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAI_user_post_request::is_email_Set() const{
    return m_email_isSet;
}

bool OAI_user_post_request::is_email_Valid() const{
    return m_email_isValid;
}

bool OAI_user_post_request::isEmailVerified() const {
    return m_email_verified;
}
void OAI_user_post_request::setEmailVerified(const bool &email_verified) {
    m_email_verified = email_verified;
    m_email_verified_isSet = true;
}

bool OAI_user_post_request::is_email_verified_Set() const{
    return m_email_verified_isSet;
}

bool OAI_user_post_request::is_email_verified_Valid() const{
    return m_email_verified_isValid;
}

QString OAI_user_post_request::getFamilyName() const {
    return m_family_name;
}
void OAI_user_post_request::setFamilyName(const QString &family_name) {
    m_family_name = family_name;
    m_family_name_isSet = true;
}

bool OAI_user_post_request::is_family_name_Set() const{
    return m_family_name_isSet;
}

bool OAI_user_post_request::is_family_name_Valid() const{
    return m_family_name_isValid;
}

QString OAI_user_post_request::getGender() const {
    return m_gender;
}
void OAI_user_post_request::setGender(const QString &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}

bool OAI_user_post_request::is_gender_Set() const{
    return m_gender_isSet;
}

bool OAI_user_post_request::is_gender_Valid() const{
    return m_gender_isValid;
}

QString OAI_user_post_request::getGivenName() const {
    return m_given_name;
}
void OAI_user_post_request::setGivenName(const QString &given_name) {
    m_given_name = given_name;
    m_given_name_isSet = true;
}

bool OAI_user_post_request::is_given_name_Set() const{
    return m_given_name_isSet;
}

bool OAI_user_post_request::is_given_name_Valid() const{
    return m_given_name_isValid;
}

QString OAI_user_post_request::getLocale() const {
    return m_locale;
}
void OAI_user_post_request::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAI_user_post_request::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAI_user_post_request::is_locale_Valid() const{
    return m_locale_isValid;
}

QString OAI_user_post_request::getMe() const {
    return m_me;
}
void OAI_user_post_request::setMe(const QString &me) {
    m_me = me;
    m_me_isSet = true;
}

bool OAI_user_post_request::is_me_Set() const{
    return m_me_isSet;
}

bool OAI_user_post_request::is_me_Valid() const{
    return m_me_isValid;
}

QString OAI_user_post_request::getMiddleName() const {
    return m_middle_name;
}
void OAI_user_post_request::setMiddleName(const QString &middle_name) {
    m_middle_name = middle_name;
    m_middle_name_isSet = true;
}

bool OAI_user_post_request::is_middle_name_Set() const{
    return m_middle_name_isSet;
}

bool OAI_user_post_request::is_middle_name_Valid() const{
    return m_middle_name_isValid;
}

QString OAI_user_post_request::getName() const {
    return m_name;
}
void OAI_user_post_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAI_user_post_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAI_user_post_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAI_user_post_request::getNickname() const {
    return m_nickname;
}
void OAI_user_post_request::setNickname(const QString &nickname) {
    m_nickname = nickname;
    m_nickname_isSet = true;
}

bool OAI_user_post_request::is_nickname_Set() const{
    return m_nickname_isSet;
}

bool OAI_user_post_request::is_nickname_Valid() const{
    return m_nickname_isValid;
}

QString OAI_user_post_request::getPassword() const {
    return m_password;
}
void OAI_user_post_request::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAI_user_post_request::is_password_Set() const{
    return m_password_isSet;
}

bool OAI_user_post_request::is_password_Valid() const{
    return m_password_isValid;
}

QString OAI_user_post_request::getPhoneNumber() const {
    return m_phone_number;
}
void OAI_user_post_request::setPhoneNumber(const QString &phone_number) {
    m_phone_number = phone_number;
    m_phone_number_isSet = true;
}

bool OAI_user_post_request::is_phone_number_Set() const{
    return m_phone_number_isSet;
}

bool OAI_user_post_request::is_phone_number_Valid() const{
    return m_phone_number_isValid;
}

bool OAI_user_post_request::isPhoneNumberVerified() const {
    return m_phone_number_verified;
}
void OAI_user_post_request::setPhoneNumberVerified(const bool &phone_number_verified) {
    m_phone_number_verified = phone_number_verified;
    m_phone_number_verified_isSet = true;
}

bool OAI_user_post_request::is_phone_number_verified_Set() const{
    return m_phone_number_verified_isSet;
}

bool OAI_user_post_request::is_phone_number_verified_Valid() const{
    return m_phone_number_verified_isValid;
}

QString OAI_user_post_request::getPicture() const {
    return m_picture;
}
void OAI_user_post_request::setPicture(const QString &picture) {
    m_picture = picture;
    m_picture_isSet = true;
}

bool OAI_user_post_request::is_picture_Set() const{
    return m_picture_isSet;
}

bool OAI_user_post_request::is_picture_Valid() const{
    return m_picture_isValid;
}

QString OAI_user_post_request::getPreferredUsername() const {
    return m_preferred_username;
}
void OAI_user_post_request::setPreferredUsername(const QString &preferred_username) {
    m_preferred_username = preferred_username;
    m_preferred_username_isSet = true;
}

bool OAI_user_post_request::is_preferred_username_Set() const{
    return m_preferred_username_isSet;
}

bool OAI_user_post_request::is_preferred_username_Valid() const{
    return m_preferred_username_isValid;
}

QString OAI_user_post_request::getProfile() const {
    return m_profile;
}
void OAI_user_post_request::setProfile(const QString &profile) {
    m_profile = profile;
    m_profile_isSet = true;
}

bool OAI_user_post_request::is_profile_Set() const{
    return m_profile_isSet;
}

bool OAI_user_post_request::is_profile_Valid() const{
    return m_profile_isValid;
}

QString OAI_user_post_request::getSub() const {
    return m_sub;
}
void OAI_user_post_request::setSub(const QString &sub) {
    m_sub = sub;
    m_sub_isSet = true;
}

bool OAI_user_post_request::is_sub_Set() const{
    return m_sub_isSet;
}

bool OAI_user_post_request::is_sub_Valid() const{
    return m_sub_isValid;
}

QString OAI_user_post_request::getUid() const {
    return m_uid;
}
void OAI_user_post_request::setUid(const QString &uid) {
    m_uid = uid;
    m_uid_isSet = true;
}

bool OAI_user_post_request::is_uid_Set() const{
    return m_uid_isSet;
}

bool OAI_user_post_request::is_uid_Valid() const{
    return m_uid_isValid;
}

double OAI_user_post_request::getUpdatedAt() const {
    return m_updated_at;
}
void OAI_user_post_request::setUpdatedAt(const double &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAI_user_post_request::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAI_user_post_request::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAI_user_post_request::getWebmail() const {
    return m_webmail;
}
void OAI_user_post_request::setWebmail(const QString &webmail) {
    m_webmail = webmail;
    m_webmail_isSet = true;
}

bool OAI_user_post_request::is_webmail_Set() const{
    return m_webmail_isSet;
}

bool OAI_user_post_request::is_webmail_Valid() const{
    return m_webmail_isValid;
}

QString OAI_user_post_request::getWebsite() const {
    return m_website;
}
void OAI_user_post_request::setWebsite(const QString &website) {
    m_website = website;
    m_website_isSet = true;
}

bool OAI_user_post_request::is_website_Set() const{
    return m_website_isSet;
}

bool OAI_user_post_request::is_website_Valid() const{
    return m_website_isValid;
}

QString OAI_user_post_request::getZoneinfo() const {
    return m_zoneinfo;
}
void OAI_user_post_request::setZoneinfo(const QString &zoneinfo) {
    m_zoneinfo = zoneinfo;
    m_zoneinfo_isSet = true;
}

bool OAI_user_post_request::is_zoneinfo_Set() const{
    return m_zoneinfo_isSet;
}

bool OAI_user_post_request::is_zoneinfo_Valid() const{
    return m_zoneinfo_isValid;
}

bool OAI_user_post_request::isSet() const {
...
bool OAI_user_post_request::isValid() const {
