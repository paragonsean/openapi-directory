...
void OAIClientApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("clientClientIdGet", defaultConf);
    _serverIndices.insert("clientClientIdGet", 0);
    _serverConfigs.insert("clientClientIdTokenKindGet", defaultConf);
    _serverIndices.insert("clientClientIdTokenKindGet", 0);
    _serverConfigs.insert("clientPost", defaultConf);
    _serverIndices.insert("clientPost", 0);
}
...
void OAIClientApi::clientClientIdGet(const QString &client_id) {
    QString fullPath = QString(_serverConfigs["clientClientIdGet"][_serverIndices.value("clientClientIdGet")].URL()+"/client/{client_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIClientApi::clientClientIdGetCallback);
...
void OAIClientApi::clientClientIdGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_client__client_id__get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT clientClientIdGetSignal(output);
        Q_EMIT clientClientIdGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT clientClientIdGetSignalE(output, error_type, error_str);
        Q_EMIT clientClientIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT clientClientIdGetSignalError(output, error_type, error_str);
        Q_EMIT clientClientIdGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIClientApi::clientClientIdTokenKindGet(const QString &client_id, const QString &kind) {
    QString fullPath = QString(_serverConfigs["clientClientIdTokenKindGet"][_serverIndices.value("clientClientIdTokenKindGet")].URL()+"/client/{client_id}/token/{kind}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIClientApi::clientClientIdTokenKindGetCallback);
    connect(this, &OAIClientApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIClientApi::clientClientIdTokenKindGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT clientClientIdTokenKindGetSignal();
        Q_EMIT clientClientIdTokenKindGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT clientClientIdTokenKindGetSignalE(error_type, error_str);
        Q_EMIT clientClientIdTokenKindGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT clientClientIdTokenKindGetSignalError(error_type, error_str);
        Q_EMIT clientClientIdTokenKindGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIClientApi::clientPost(const ::OpenAPI::OptionalParam<OAI_client_post_request> &oai_client_post_request) {
    QString fullPath = QString(_serverConfigs["clientPost"][_serverIndices.value("clientPost")].URL()+"/client");
    ...
    if (oai_client_post_request.hasValue()){

        
        QByteArray output = oai_client_post_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIClientApi::clientPostCallback);
    connect(this, &OAIClientApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIClientApi::clientPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT clientPostSignal();
        Q_EMIT clientPostSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT clientPostSignalE(error_type, error_str);
        Q_EMIT clientPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT clientPostSignalError(error_type, error_str);
        Q_EMIT clientPostSignalErrorFull(worker, error_type, error_str);
    }
}
