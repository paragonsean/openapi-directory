...
/*
 * OAI_user__username__get_200_response.h
 *
 * 
 */

#ifndef OAI_user__username__get_200_response_H
#define OAI_user__username__get_200_response_H

#include <QJsonObject>

#include "OAI_user_post_request_address.h"
#include <QString>
...
namespace OpenAPI {
class OAI_user_post_request_address;

class OAI_user__username__get_200_response : public OAIObject {
public:
    OAI_user__username__get_200_response();
    OAI_user__username__get_200_response(QString json);
    ~OAI_user__username__get_200_response() override;
    ...
    OAI_user_post_request_address getAddress() const;
    void setAddress(const OAI_user_post_request_address &address);
    ...
    QString getWebmail() const;
    void setWebmail(const QString &webmail);
    bool is_webmail_Set() const;
    bool is_webmail_Valid() const;
...
private:
    ...
    OAI_user_post_request_address m_address;
    ...
    QString m_webmail;
    bool m_webmail_isSet;
    bool m_webmail_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_user__username__get_200_response)

#endif // OAI_user__username__get_200_response_H
