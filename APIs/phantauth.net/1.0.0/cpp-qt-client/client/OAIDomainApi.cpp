...
void OAIDomainApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("domainDomainnameGet", defaultConf);
    _serverIndices.insert("domainDomainnameGet", 0);
}
...
void OAIDomainApi::domainDomainnameGet(const QString &domainname) {
    QString fullPath = QString(_serverConfigs["domainDomainnameGet"][_serverIndices.value("domainDomainnameGet")].URL()+"/domain/{domainname}");
    
    
    {
        QString domainnamePathParam("{");
        domainnamePathParam.append("domainname").append("}");
        ...
        fullPath.replace(domainnamePathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(domainname)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainApi::domainDomainnameGetCallback);
...
void OAIDomainApi::domainDomainnameGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_domain__domainname__get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT domainDomainnameGetSignal(output);
        Q_EMIT domainDomainnameGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT domainDomainnameGetSignalE(output, error_type, error_str);
        Q_EMIT domainDomainnameGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT domainDomainnameGetSignalError(output, error_type, error_str);
        Q_EMIT domainDomainnameGetSignalErrorFull(worker, error_type, error_str);
    }
}
