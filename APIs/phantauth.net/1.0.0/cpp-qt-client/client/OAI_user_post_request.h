...
/*
 * OAI_user_post_request.h
 *
 * 
 */

#ifndef OAI_user_post_request_H
#define OAI_user_post_request_H
...
class OAI_user_post_request : public OAIObject {
public:
    OAI_user_post_request();
    OAI_user_post_request(QString json);
    ~OAI_user_post_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_user_post_request)

#endif // OAI_user_post_request_H
