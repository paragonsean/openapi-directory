...
QString OAITeam::getLogo() const {
    return m_logo;
}
void OAITeam::setLogo(const QString &logo) {
    m_logo = logo;
    m_logo_isSet = true;
}

bool OAITeam::is_logo_Set() const{
    return m_logo_isSet;
}

bool OAITeam::is_logo_Valid() const{
    return m_logo_isValid;
}

QString OAITeam::getLogoEmail() const {
    return m_logo_email;
}
void OAITeam::setLogoEmail(const QString &logo_email) {
    m_logo_email = logo_email;
    m_logo_email_isSet = true;
}

bool OAITeam::is_logo_email_Set() const{
    return m_logo_email_isSet;
}

bool OAITeam::is_logo_email_Valid() const{
    return m_logo_email_isValid;
}

QList<QJsonValue> OAITeam::getMembers() const {
    return m_members;
}
void OAITeam::setMembers(const QList<QJsonValue> &members) {
    m_members = members;
    m_members_isSet = true;
}

bool OAITeam::is_members_Set() const{
    return m_members_isSet;
}

bool OAITeam::is_members_Valid() const{
...
QString OAITeam::getProfile() const {
    return m_profile;
}
void OAITeam::setProfile(const QString &profile) {
    m_profile = profile;
    m_profile_isSet = true;
}

bool OAITeam::is_profile_Set() const{
    return m_profile_isSet;
}

bool OAITeam::is_profile_Valid() const{
    return m_profile_isValid;
}

QString OAITeam::getSub() const {
    return m_sub;
}
void OAITeam::setSub(const QString &sub) {
    m_sub = sub;
    m_sub_isSet = true;
}

bool OAITeam::is_sub_Set() const{
    return m_sub_isSet;
}

bool OAITeam::is_sub_Valid() const{
