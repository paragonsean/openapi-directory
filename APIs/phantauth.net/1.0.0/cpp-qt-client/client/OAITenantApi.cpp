...
OAITenantApi::OAITenantApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITenantApi::~OAITenantApi() {
}

void OAITenantApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("tenantTenantnameGet", defaultConf);
    _serverIndices.insert("tenantTenantnameGet", 0);
}
...
*/
int OAITenantApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITenantApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITenantApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITenantApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITenantApi::setUsername(const QString &username) {
    _username = username;
}

void OAITenantApi::setPassword(const QString &password) {
    _password = password;
}


void OAITenantApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITenantApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITenantApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITenantApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITenantApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITenantApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITenantApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITenantApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITenantApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITenantApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITenantApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITenantApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITenantApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITenantApi::tenantTenantnameGet(const QString &tenantname) {
    QString fullPath = QString(_serverConfigs["tenantTenantnameGet"][_serverIndices.value("tenantTenantnameGet")].URL()+"/tenant/{tenantname}");
    
    
    {
        QString tenantnamePathParam("{");
        tenantnamePathParam.append("tenantname").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "tenantname", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"tenantname"+pathSuffix : pathPrefix;
        fullPath.replace(tenantnamePathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(tenantname)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITenantApi::tenantTenantnameGetCallback);
    connect(this, &OAITenantApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITenantApi::tenantTenantnameGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_tenant__tenantname__get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT tenantTenantnameGetSignal(output);
        Q_EMIT tenantTenantnameGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT tenantTenantnameGetSignalE(output, error_type, error_str);
        Q_EMIT tenantTenantnameGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT tenantTenantnameGetSignalError(output, error_type, error_str);
        Q_EMIT tenantTenantnameGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITenantApi::tokenAvailable(){
