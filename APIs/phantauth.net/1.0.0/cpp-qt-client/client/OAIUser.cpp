...
OAIAddress OAIUser::getAddress() const {
    return m_address;
}
void OAIUser::setAddress(const OAIAddress &address) {
    m_address = address;
...
QString OAIUser::getBirthdate() const {
    return m_birthdate;
}
void OAIUser::setBirthdate(const QString &birthdate) {
    m_birthdate = birthdate;
    m_birthdate_isSet = true;
}

bool OAIUser::is_birthdate_Set() const{
    return m_birthdate_isSet;
}

bool OAIUser::is_birthdate_Valid() const{
...
QString OAIUser::getFamilyName() const {
    return m_family_name;
}
void OAIUser::setFamilyName(const QString &family_name) {
    m_family_name = family_name;
    m_family_name_isSet = true;
}

bool OAIUser::is_family_name_Set() const{
    return m_family_name_isSet;
}

bool OAIUser::is_family_name_Valid() const{
    return m_family_name_isValid;
}

QString OAIUser::getGender() const {
    return m_gender;
}
void OAIUser::setGender(const QString &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}

bool OAIUser::is_gender_Set() const{
    return m_gender_isSet;
}

bool OAIUser::is_gender_Valid() const{
...
QString OAIUser::getMe() const {
    return m_me;
}
void OAIUser::setMe(const QString &me) {
    m_me = me;
    m_me_isSet = true;
}
...
QString OAIUser::getPreferredUsername() const {
    return m_preferred_username;
}
void OAIUser::setPreferredUsername(const QString &preferred_username) {
    m_preferred_username = preferred_username;
    m_preferred_username_isSet = true;
}

bool OAIUser::is_preferred_username_Set() const{
    return m_preferred_username_isSet;
}

bool OAIUser::is_preferred_username_Valid() const{
    return m_preferred_username_isValid;
}

QString OAIUser::getProfile() const {
    return m_profile;
}
void OAIUser::setProfile(const QString &profile) {
    m_profile = profile;
...
QString OAIUser::getSub() const {
    return m_sub;
}
void OAIUser::setSub(const QString &sub) {
    m_sub = sub;
    m_sub_isSet = true;
}

bool OAIUser::is_sub_Set() const{
    return m_sub_isSet;
}

bool OAIUser::is_sub_Valid() const{
...
double OAIUser::getUpdatedAt() const {
    return m_updated_at;
}
void OAIUser::setUpdatedAt(const double &updated_at) {
...
QString OAIUser::getWebmail() const {
    return m_webmail;
}
void OAIUser::setWebmail(const QString &webmail) {
    m_webmail = webmail;
    m_webmail_isSet = true;
}

bool OAIUser::is_webmail_Set() const{
    return m_webmail_isSet;
}

bool OAIUser::is_webmail_Valid() const{
...
QString OAIUser::getZoneinfo() const {
    return m_zoneinfo;
}
void OAIUser::setZoneinfo(const QString &zoneinfo) {
    m_zoneinfo = zoneinfo;
    m_zoneinfo_isSet = true;
}

bool OAIUser::is_zoneinfo_Set() const{
    return m_zoneinfo_isSet;
}

bool OAIUser::is_zoneinfo_Valid() const{
