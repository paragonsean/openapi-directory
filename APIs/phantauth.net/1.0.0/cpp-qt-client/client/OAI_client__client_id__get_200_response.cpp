...
#include "OAI_client__client_id__get_200_response.h"
...
OAI_client__client_id__get_200_response::OAI_client__client_id__get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_client__client_id__get_200_response::OAI_client__client_id__get_200_response() {
    this->initializeModel();
}

OAI_client__client_id__get_200_response::~OAI_client__client_id__get_200_response() {}

void OAI_client__client_id__get_200_response::initializeModel() {
...
void OAI_client__client_id__get_200_response::fromJson(QString jsonString) {
...
void OAI_client__client_id__get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_client__client_id__get_200_response::asJson() const {
...
QJsonObject OAI_client__client_id__get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAI_client__client_id__get_200_response::getId() const {
    return m_id;
}
void OAI_client__client_id__get_200_response::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_client__client_id__get_200_response::is_id_Valid() const{
    return m_id_isValid;
}

QString OAI_client__client_id__get_200_response::getClientId() const {
    return m_client_id;
}
void OAI_client__client_id__get_200_response::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAI_client__client_id__get_200_response::is_client_id_Valid() const{
    return m_client_id_isValid;
}

QString OAI_client__client_id__get_200_response::getClientName() const {
    return m_client_name;
}
void OAI_client__client_id__get_200_response::setClientName(const QString &client_name) {
    m_client_name = client_name;
    m_client_name_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_client_name_Set() const{
    return m_client_name_isSet;
}

bool OAI_client__client_id__get_200_response::is_client_name_Valid() const{
    return m_client_name_isValid;
}

QString OAI_client__client_id__get_200_response::getClientSecret() const {
    return m_client_secret;
}
void OAI_client__client_id__get_200_response::setClientSecret(const QString &client_secret) {
    m_client_secret = client_secret;
    m_client_secret_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_client_secret_Set() const{
    return m_client_secret_isSet;
}

bool OAI_client__client_id__get_200_response::is_client_secret_Valid() const{
    return m_client_secret_isValid;
}

QString OAI_client__client_id__get_200_response::getClientUri() const {
    return m_client_uri;
}
void OAI_client__client_id__get_200_response::setClientUri(const QString &client_uri) {
    m_client_uri = client_uri;
    m_client_uri_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_client_uri_Set() const{
    return m_client_uri_isSet;
}

bool OAI_client__client_id__get_200_response::is_client_uri_Valid() const{
    return m_client_uri_isValid;
}

QList<QJsonValue> OAI_client__client_id__get_200_response::getContacts() const {
    return m_contacts;
}
void OAI_client__client_id__get_200_response::setContacts(const QList<QJsonValue> &contacts) {
    m_contacts = contacts;
    m_contacts_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_contacts_Set() const{
    return m_contacts_isSet;
}

bool OAI_client__client_id__get_200_response::is_contacts_Valid() const{
    return m_contacts_isValid;
}

QList<QJsonValue> OAI_client__client_id__get_200_response::getGrantTypes() const {
    return m_grant_types;
}
void OAI_client__client_id__get_200_response::setGrantTypes(const QList<QJsonValue> &grant_types) {
    m_grant_types = grant_types;
    m_grant_types_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_grant_types_Set() const{
    return m_grant_types_isSet;
}

bool OAI_client__client_id__get_200_response::is_grant_types_Valid() const{
    return m_grant_types_isValid;
}

QList<QJsonValue> OAI_client__client_id__get_200_response::getJwks() const {
    return m_jwks;
}
void OAI_client__client_id__get_200_response::setJwks(const QList<QJsonValue> &jwks) {
    m_jwks = jwks;
    m_jwks_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_jwks_Set() const{
    return m_jwks_isSet;
}

bool OAI_client__client_id__get_200_response::is_jwks_Valid() const{
    return m_jwks_isValid;
}

QString OAI_client__client_id__get_200_response::getJwksUri() const {
    return m_jwks_uri;
}
void OAI_client__client_id__get_200_response::setJwksUri(const QString &jwks_uri) {
    m_jwks_uri = jwks_uri;
    m_jwks_uri_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_jwks_uri_Set() const{
    return m_jwks_uri_isSet;
}

bool OAI_client__client_id__get_200_response::is_jwks_uri_Valid() const{
    return m_jwks_uri_isValid;
}

QString OAI_client__client_id__get_200_response::getLogoEmail() const {
    return m_logo_email;
}
void OAI_client__client_id__get_200_response::setLogoEmail(const QString &logo_email) {
    m_logo_email = logo_email;
    m_logo_email_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_logo_email_Set() const{
    return m_logo_email_isSet;
}

bool OAI_client__client_id__get_200_response::is_logo_email_Valid() const{
    return m_logo_email_isValid;
}

QString OAI_client__client_id__get_200_response::getLogoUri() const {
    return m_logo_uri;
}
void OAI_client__client_id__get_200_response::setLogoUri(const QString &logo_uri) {
    m_logo_uri = logo_uri;
    m_logo_uri_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_logo_uri_Set() const{
    return m_logo_uri_isSet;
}

bool OAI_client__client_id__get_200_response::is_logo_uri_Valid() const{
    return m_logo_uri_isValid;
}

QString OAI_client__client_id__get_200_response::getPolicyUri() const {
    return m_policy_uri;
}
void OAI_client__client_id__get_200_response::setPolicyUri(const QString &policy_uri) {
    m_policy_uri = policy_uri;
    m_policy_uri_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_policy_uri_Set() const{
    return m_policy_uri_isSet;
}

bool OAI_client__client_id__get_200_response::is_policy_uri_Valid() const{
    return m_policy_uri_isValid;
}

QList<QJsonValue> OAI_client__client_id__get_200_response::getRedirectUris() const {
    return m_redirect_uris;
}
void OAI_client__client_id__get_200_response::setRedirectUris(const QList<QJsonValue> &redirect_uris) {
    m_redirect_uris = redirect_uris;
    m_redirect_uris_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_redirect_uris_Set() const{
    return m_redirect_uris_isSet;
}

bool OAI_client__client_id__get_200_response::is_redirect_uris_Valid() const{
    return m_redirect_uris_isValid;
}

QList<QJsonValue> OAI_client__client_id__get_200_response::getResponseTypes() const {
    return m_response_types;
}
void OAI_client__client_id__get_200_response::setResponseTypes(const QList<QJsonValue> &response_types) {
    m_response_types = response_types;
    m_response_types_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_response_types_Set() const{
    return m_response_types_isSet;
}

bool OAI_client__client_id__get_200_response::is_response_types_Valid() const{
    return m_response_types_isValid;
}

QString OAI_client__client_id__get_200_response::getScope() const {
    return m_scope;
}
void OAI_client__client_id__get_200_response::setScope(const QString &scope) {
    m_scope = scope;
    m_scope_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_scope_Set() const{
    return m_scope_isSet;
}

bool OAI_client__client_id__get_200_response::is_scope_Valid() const{
    return m_scope_isValid;
}

QString OAI_client__client_id__get_200_response::getSoftwareId() const {
    return m_software_id;
}
void OAI_client__client_id__get_200_response::setSoftwareId(const QString &software_id) {
    m_software_id = software_id;
    m_software_id_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_software_id_Set() const{
    return m_software_id_isSet;
}

bool OAI_client__client_id__get_200_response::is_software_id_Valid() const{
    return m_software_id_isValid;
}

QString OAI_client__client_id__get_200_response::getSoftwareVersion() const {
    return m_software_version;
}
void OAI_client__client_id__get_200_response::setSoftwareVersion(const QString &software_version) {
    m_software_version = software_version;
    m_software_version_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_software_version_Set() const{
    return m_software_version_isSet;
}

bool OAI_client__client_id__get_200_response::is_software_version_Valid() const{
    return m_software_version_isValid;
}

QString OAI_client__client_id__get_200_response::getTokenEndpointAuthMethod() const {
    return m_token_endpoint_auth_method;
}
void OAI_client__client_id__get_200_response::setTokenEndpointAuthMethod(const QString &token_endpoint_auth_method) {
    m_token_endpoint_auth_method = token_endpoint_auth_method;
    m_token_endpoint_auth_method_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_token_endpoint_auth_method_Set() const{
    return m_token_endpoint_auth_method_isSet;
}

bool OAI_client__client_id__get_200_response::is_token_endpoint_auth_method_Valid() const{
    return m_token_endpoint_auth_method_isValid;
}

QString OAI_client__client_id__get_200_response::getTosUri() const {
    return m_tos_uri;
}
void OAI_client__client_id__get_200_response::setTosUri(const QString &tos_uri) {
    m_tos_uri = tos_uri;
    m_tos_uri_isSet = true;
}

bool OAI_client__client_id__get_200_response::is_tos_uri_Set() const{
    return m_tos_uri_isSet;
}

bool OAI_client__client_id__get_200_response::is_tos_uri_Valid() const{
    return m_tos_uri_isValid;
}

bool OAI_client__client_id__get_200_response::isSet() const {
...
bool OAI_client__client_id__get_200_response::isValid() const {
