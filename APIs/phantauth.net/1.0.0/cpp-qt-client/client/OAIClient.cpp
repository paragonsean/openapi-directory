...
QString OAIClient::getClientSecret() const {
    return m_client_secret;
}
void OAIClient::setClientSecret(const QString &client_secret) {
    m_client_secret = client_secret;
    m_client_secret_isSet = true;
}

bool OAIClient::is_client_secret_Set() const{
    return m_client_secret_isSet;
}

bool OAIClient::is_client_secret_Valid() const{
...
QList<QJsonValue> OAIClient::getContacts() const {
    return m_contacts;
}
void OAIClient::setContacts(const QList<QJsonValue> &contacts) {
    m_contacts = contacts;
...
QList<QJsonValue> OAIClient::getGrantTypes() const {
    return m_grant_types;
}
void OAIClient::setGrantTypes(const QList<QJsonValue> &grant_types) {
...
QList<QJsonValue> OAIClient::getJwks() const {
    return m_jwks;
}
void OAIClient::setJwks(const QList<QJsonValue> &jwks) {
    m_jwks = jwks;
    m_jwks_isSet = true;
}

bool OAIClient::is_jwks_Set() const{
    return m_jwks_isSet;
}

bool OAIClient::is_jwks_Valid() const{
    return m_jwks_isValid;
}

QString OAIClient::getJwksUri() const {
    return m_jwks_uri;
}
void OAIClient::setJwksUri(const QString &jwks_uri) {
    m_jwks_uri = jwks_uri;
    m_jwks_uri_isSet = true;
}

bool OAIClient::is_jwks_uri_Set() const{
    return m_jwks_uri_isSet;
}

bool OAIClient::is_jwks_uri_Valid() const{
    return m_jwks_uri_isValid;
}

QString OAIClient::getLogoEmail() const {
    return m_logo_email;
}
void OAIClient::setLogoEmail(const QString &logo_email) {
    m_logo_email = logo_email;
    m_logo_email_isSet = true;
}

bool OAIClient::is_logo_email_Set() const{
    return m_logo_email_isSet;
}

bool OAIClient::is_logo_email_Valid() const{
...
QList<QJsonValue> OAIClient::getRedirectUris() const {
    return m_redirect_uris;
}
void OAIClient::setRedirectUris(const QList<QJsonValue> &redirect_uris) {
...
QList<QJsonValue> OAIClient::getResponseTypes() const {
    return m_response_types;
}
void OAIClient::setResponseTypes(const QList<QJsonValue> &response_types) {
...
QString OAIClient::getScope() const {
    return m_scope;
}
void OAIClient::setScope(const QString &scope) {
    m_scope = scope;
    m_scope_isSet = true;
}

bool OAIClient::is_scope_Set() const{
    return m_scope_isSet;
}

bool OAIClient::is_scope_Valid() const{
    return m_scope_isValid;
}

QString OAIClient::getSoftwareId() const {
    return m_software_id;
}
void OAIClient::setSoftwareId(const QString &software_id) {
    m_software_id = software_id;
    m_software_id_isSet = true;
}

bool OAIClient::is_software_id_Set() const{
    return m_software_id_isSet;
}

bool OAIClient::is_software_id_Valid() const{
    return m_software_id_isValid;
}

QString OAIClient::getSoftwareVersion() const {
    return m_software_version;
}
void OAIClient::setSoftwareVersion(const QString &software_version) {
    m_software_version = software_version;
    m_software_version_isSet = true;
}

bool OAIClient::is_software_version_Set() const{
    return m_software_version_isSet;
}

bool OAIClient::is_software_version_Valid() const{
    return m_software_version_isValid;
}

QString OAIClient::getTokenEndpointAuthMethod() const {
    return m_token_endpoint_auth_method;
}
void OAIClient::setTokenEndpointAuthMethod(const QString &token_endpoint_auth_method) {
    m_token_endpoint_auth_method = token_endpoint_auth_method;
    m_token_endpoint_auth_method_isSet = true;
}

bool OAIClient::is_token_endpoint_auth_method_Set() const{
    return m_token_endpoint_auth_method_isSet;
}

bool OAIClient::is_token_endpoint_auth_method_Valid() const{
