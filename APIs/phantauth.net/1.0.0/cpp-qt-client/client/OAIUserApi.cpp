...
void OAIUserApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("userUsernameGet", defaultConf);
    _serverIndices.insert("userUsernameGet", 0);
    _serverConfigs.insert("userUsernameTokenKindGet", defaultConf);
    _serverIndices.insert("userUsernameTokenKindGet", 0);
}
...
void OAIUserApi::userPost(const ::OpenAPI::OptionalParam<OAI_user_post_request> &oai_user_post_request) {
    ...
    if (oai_user_post_request.hasValue()){

        
        QByteArray output = oai_user_post_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUserApi::userPostCallback);
...
void OAIUserApi::userPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT userPostSignal();
        Q_EMIT userPostSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT userPostSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT userPostSignalError(error_type, error_str);
        Q_EMIT userPostSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUserApi::userUsernameGet(const QString &username) {
    QString fullPath = QString(_serverConfigs["userUsernameGet"][_serverIndices.value("userUsernameGet")].URL()+"/user/{username}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUserApi::userUsernameGetCallback);
    connect(this, &OAIUserApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUserApi::userUsernameGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAI_user__username__get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT userUsernameGetSignal(output);
        Q_EMIT userUsernameGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT userUsernameGetSignalE(output, error_type, error_str);
        Q_EMIT userUsernameGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT userUsernameGetSignalError(output, error_type, error_str);
        Q_EMIT userUsernameGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUserApi::userUsernameTokenKindGet(const QString &username, const QString &kind, const ::OpenAPI::OptionalParam<QString> &scope) {
    QString fullPath = QString(_serverConfigs["userUsernameTokenKindGet"][_serverIndices.value("userUsernameTokenKindGet")].URL()+"/user/{username}/token/{kind}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUserApi::userUsernameTokenKindGetCallback);
    connect(this, &OAIUserApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUserApi::userUsernameTokenKindGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT userUsernameTokenKindGetSignal();
        Q_EMIT userUsernameTokenKindGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT userUsernameTokenKindGetSignalE(error_type, error_str);
        Q_EMIT userUsernameTokenKindGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT userUsernameTokenKindGetSignalError(error_type, error_str);
        Q_EMIT userUsernameTokenKindGetSignalErrorFull(worker, error_type, error_str);
    }
}
