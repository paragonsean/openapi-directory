...
#include "OAI_fleet__fleetname__get_200_response.h"
...
OAI_fleet__fleetname__get_200_response::OAI_fleet__fleetname__get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_fleet__fleetname__get_200_response::OAI_fleet__fleetname__get_200_response() {
    this->initializeModel();
}

OAI_fleet__fleetname__get_200_response::~OAI_fleet__fleetname__get_200_response() {}

void OAI_fleet__fleetname__get_200_response::initializeModel() {
...
void OAI_fleet__fleetname__get_200_response::fromJson(QString jsonString) {
...
void OAI_fleet__fleetname__get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_fleet__fleetname__get_200_response::asJson() const {
...
QJsonObject OAI_fleet__fleetname__get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAI_fleet__fleetname__get_200_response::getId() const {
    return m_id;
}
void OAI_fleet__fleetname__get_200_response::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_fleet__fleetname__get_200_response::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_fleet__fleetname__get_200_response::is_id_Valid() const{
    return m_id_isValid;
}

QString OAI_fleet__fleetname__get_200_response::getLogo() const {
    return m_logo;
}
void OAI_fleet__fleetname__get_200_response::setLogo(const QString &logo) {
    m_logo = logo;
    m_logo_isSet = true;
}

bool OAI_fleet__fleetname__get_200_response::is_logo_Set() const{
    return m_logo_isSet;
}

bool OAI_fleet__fleetname__get_200_response::is_logo_Valid() const{
    return m_logo_isValid;
}

QString OAI_fleet__fleetname__get_200_response::getLogoEmail() const {
    return m_logo_email;
}
void OAI_fleet__fleetname__get_200_response::setLogoEmail(const QString &logo_email) {
    m_logo_email = logo_email;
    m_logo_email_isSet = true;
}

bool OAI_fleet__fleetname__get_200_response::is_logo_email_Set() const{
    return m_logo_email_isSet;
}

bool OAI_fleet__fleetname__get_200_response::is_logo_email_Valid() const{
    return m_logo_email_isValid;
}

QList<QJsonValue> OAI_fleet__fleetname__get_200_response::getMembers() const {
    return m_members;
}
void OAI_fleet__fleetname__get_200_response::setMembers(const QList<QJsonValue> &members) {
    m_members = members;
    m_members_isSet = true;
}

bool OAI_fleet__fleetname__get_200_response::is_members_Set() const{
    return m_members_isSet;
}

bool OAI_fleet__fleetname__get_200_response::is_members_Valid() const{
    return m_members_isValid;
}

QString OAI_fleet__fleetname__get_200_response::getName() const {
    return m_name;
}
void OAI_fleet__fleetname__get_200_response::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAI_fleet__fleetname__get_200_response::is_name_Set() const{
    return m_name_isSet;
}

bool OAI_fleet__fleetname__get_200_response::is_name_Valid() const{
    return m_name_isValid;
}

QString OAI_fleet__fleetname__get_200_response::getProfile() const {
    return m_profile;
}
void OAI_fleet__fleetname__get_200_response::setProfile(const QString &profile) {
    m_profile = profile;
    m_profile_isSet = true;
}

bool OAI_fleet__fleetname__get_200_response::is_profile_Set() const{
    return m_profile_isSet;
}

bool OAI_fleet__fleetname__get_200_response::is_profile_Valid() const{
    return m_profile_isValid;
}

QString OAI_fleet__fleetname__get_200_response::getSub() const {
    return m_sub;
}
void OAI_fleet__fleetname__get_200_response::setSub(const QString &sub) {
    m_sub = sub;
    m_sub_isSet = true;
}

bool OAI_fleet__fleetname__get_200_response::is_sub_Set() const{
    return m_sub_isSet;
}

bool OAI_fleet__fleetname__get_200_response::is_sub_Valid() const{
    return m_sub_isValid;
}

bool OAI_fleet__fleetname__get_200_response::isSet() const {
...
bool OAI_fleet__fleetname__get_200_response::isValid() const {
