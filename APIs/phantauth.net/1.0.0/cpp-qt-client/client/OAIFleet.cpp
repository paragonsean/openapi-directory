...
QString OAIFleet::getId() const {
    return m_id;
}
void OAIFleet::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFleet::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFleet::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIFleet::getLogo() const {
    return m_logo;
}
void OAIFleet::setLogo(const QString &logo) {
    m_logo = logo;
    m_logo_isSet = true;
}

bool OAIFleet::is_logo_Set() const{
    return m_logo_isSet;
}

bool OAIFleet::is_logo_Valid() const{
    return m_logo_isValid;
}

QString OAIFleet::getLogoEmail() const {
    return m_logo_email;
}
void OAIFleet::setLogoEmail(const QString &logo_email) {
    m_logo_email = logo_email;
    m_logo_email_isSet = true;
}

bool OAIFleet::is_logo_email_Set() const{
    return m_logo_email_isSet;
}

bool OAIFleet::is_logo_email_Valid() const{
    return m_logo_email_isValid;
}

QList<QJsonValue> OAIFleet::getMembers() const {
    return m_members;
}
void OAIFleet::setMembers(const QList<QJsonValue> &members) {
    m_members = members;
    m_members_isSet = true;
}

bool OAIFleet::is_members_Set() const{
    return m_members_isSet;
}

bool OAIFleet::is_members_Valid() const{
...
QString OAIFleet::getProfile() const {
    return m_profile;
}
void OAIFleet::setProfile(const QString &profile) {
    m_profile = profile;
    m_profile_isSet = true;
}

bool OAIFleet::is_profile_Set() const{
    return m_profile_isSet;
}

bool OAIFleet::is_profile_Valid() const{
    return m_profile_isValid;
}

QString OAIFleet::getSub() const {
    return m_sub;
}
void OAIFleet::setSub(const QString &sub) {
    m_sub = sub;
    m_sub_isSet = true;
}

bool OAIFleet::is_sub_Set() const{
    return m_sub_isSet;
}

bool OAIFleet::is_sub_Valid() const{
