...
QString OAITenant::getAbout() const {
    return m_about;
}
void OAITenant::setAbout(const QString &about) {
    m_about = about;
    m_about_isSet = true;
}

bool OAITenant::is_about_Set() const{
    return m_about_isSet;
}

bool OAITenant::is_about_Valid() const{
    return m_about_isValid;
}

QString OAITenant::getAttribution() const {
    return m_attribution;
}
void OAITenant::setAttribution(const QString &attribution) {
    m_attribution = attribution;
    m_attribution_isSet = true;
}

bool OAITenant::is_attribution_Set() const{
    return m_attribution_isSet;
}

bool OAITenant::is_attribution_Valid() const{
    return m_attribution_isValid;
}

QString OAITenant::getDepot() const {
    return m_depot;
}
void OAITenant::setDepot(const QString &depot) {
    m_depot = depot;
    m_depot_isSet = true;
}

bool OAITenant::is_depot_Set() const{
    return m_depot_isSet;
}

bool OAITenant::is_depot_Valid() const{
    return m_depot_isValid;
}

QList<QJsonValue> OAITenant::getDepots() const {
    return m_depots;
}
void OAITenant::setDepots(const QList<QJsonValue> &depots) {
    m_depots = depots;
    m_depots_isSet = true;
}

bool OAITenant::is_depots_Set() const{
    return m_depots_isSet;
}

bool OAITenant::is_depots_Valid() const{
    return m_depots_isValid;
}

bool OAITenant::isDomain() const {
    return m_domain;
}
void OAITenant::setDomain(const bool &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAITenant::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAITenant::is_domain_Valid() const{
    return m_domain_isValid;
}

QList<QJsonValue> OAITenant::getFactories() const {
    return m_factories;
}
void OAITenant::setFactories(const QList<QJsonValue> &factories) {
    m_factories = factories;
    m_factories_isSet = true;
}

bool OAITenant::is_factories_Set() const{
    return m_factories_isSet;
}

bool OAITenant::is_factories_Valid() const{
    return m_factories_isValid;
}

QString OAITenant::getFactory() const {
    return m_factory;
}
void OAITenant::setFactory(const QString &factory) {
    m_factory = factory;
    m_factory_isSet = true;
}

bool OAITenant::is_factory_Set() const{
    return m_factory_isSet;
}

bool OAITenant::is_factory_Valid() const{
    return m_factory_isValid;
}

QString OAITenant::getFavicon() const {
    return m_favicon;
}
void OAITenant::setFavicon(const QString &favicon) {
    m_favicon = favicon;
    m_favicon_isSet = true;
}

bool OAITenant::is_favicon_Set() const{
    return m_favicon_isSet;
}

bool OAITenant::is_favicon_Valid() const{
    return m_favicon_isValid;
}

QString OAITenant::getIssuer() const {
    return m_issuer;
}
void OAITenant::setIssuer(const QString &issuer) {
    m_issuer = issuer;
    m_issuer_isSet = true;
}

bool OAITenant::is_issuer_Set() const{
    return m_issuer_isSet;
}

bool OAITenant::is_issuer_Valid() const{
    return m_issuer_isValid;
}

QString OAITenant::getLogo() const {
    return m_logo;
}
void OAITenant::setLogo(const QString &logo) {
    m_logo = logo;
    m_logo_isSet = true;
}

bool OAITenant::is_logo_Set() const{
    return m_logo_isSet;
}

bool OAITenant::is_logo_Valid() const{
...
QString OAITenant::getScript() const {
    return m_script;
}
void OAITenant::setScript(const QString &script) {
    m_script = script;
    m_script_isSet = true;
}

bool OAITenant::is_script_Set() const{
    return m_script_isSet;
}

bool OAITenant::is_script_Valid() const{
    return m_script_isValid;
}

QString OAITenant::getSheet() const {
    return m_sheet;
}
void OAITenant::setSheet(const QString &sheet) {
    m_sheet = sheet;
    m_sheet_isSet = true;
}

bool OAITenant::is_sheet_Set() const{
    return m_sheet_isSet;
}

bool OAITenant::is_sheet_Valid() const{
    return m_sheet_isValid;
}

QString OAITenant::getSub() const {
    return m_sub;
}
void OAITenant::setSub(const QString &sub) {
    m_sub = sub;
    m_sub_isSet = true;
}

bool OAITenant::is_sub_Set() const{
    return m_sub_isSet;
}

bool OAITenant::is_sub_Valid() const{
    return m_sub_isValid;
}

bool OAITenant::isSubtenant() const {
    return m_subtenant;
}
void OAITenant::setSubtenant(const bool &subtenant) {
    m_subtenant = subtenant;
    m_subtenant_isSet = true;
}

bool OAITenant::is_subtenant_Set() const{
    return m_subtenant_isSet;
}

bool OAITenant::is_subtenant_Valid() const{
    return m_subtenant_isValid;
}

QString OAITenant::getSummary() const {
    return m_summary;
}
void OAITenant::setSummary(const QString &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAITenant::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAITenant::is_summary_Valid() const{
    return m_summary_isValid;
}

QString OAITenant::getRTemplate() const {
    return m_r_template;
}
void OAITenant::setRTemplate(const QString &r_template) {
    m_r_template = r_template;
    m_r_template_isSet = true;
}

bool OAITenant::is_r_template_Set() const{
    return m_r_template_isSet;
}

bool OAITenant::is_r_template_Valid() const{
    return m_r_template_isValid;
}

QString OAITenant::getTheme() const {
    return m_theme;
}
void OAITenant::setTheme(const QString &theme) {
    m_theme = theme;
    m_theme_isSet = true;
}

bool OAITenant::is_theme_Set() const{
    return m_theme_isSet;
}

bool OAITenant::is_theme_Valid() const{
    return m_theme_isValid;
}

QString OAITenant::getUserinfo() const {
    return m_userinfo;
}
void OAITenant::setUserinfo(const QString &userinfo) {
    m_userinfo = userinfo;
    m_userinfo_isSet = true;
}

bool OAITenant::is_userinfo_Set() const{
    return m_userinfo_isSet;
}

bool OAITenant::is_userinfo_Valid() const{
    return m_userinfo_isValid;
}

QString OAITenant::getWebsite() const {
    return m_website;
}
void OAITenant::setWebsite(const QString &website) {
    m_website = website;
    m_website_isSet = true;
}

bool OAITenant::is_website_Set() const{
    return m_website_isSet;
}

bool OAITenant::is_website_Valid() const{
