...
#include "OAI_client_post_request.h"
...
OAI_client_post_request::OAI_client_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_client_post_request::OAI_client_post_request() {
    this->initializeModel();
}

OAI_client_post_request::~OAI_client_post_request() {}

void OAI_client_post_request::initializeModel() {
    ...
    m_jwks_isSet = false;
    m_jwks_isValid = false;

    m_jwks_uri_isSet = false;
    m_jwks_uri_isValid = false;

    m_logo_email_isSet = false;
    m_logo_email_isValid = false;
    ...
    m_software_id_isSet = false;
    m_software_id_isValid = false;
...
void OAI_client_post_request::fromJson(QString jsonString) {
...
void OAI_client_post_request::fromJsonObject(QJsonObject json) {
    ...
    m_jwks_isValid = ::OpenAPI::fromJsonValue(m_jwks, json[QString("jwks")]);
    m_jwks_isSet = !json[QString("jwks")].isNull() && m_jwks_isValid;
    ...
    m_logo_email_isValid = ::OpenAPI::fromJsonValue(m_logo_email, json[QString("logo_email")]);
    m_logo_email_isSet = !json[QString("logo_email")].isNull() && m_logo_email_isValid;
    ...
    m_software_id_isValid = ::OpenAPI::fromJsonValue(m_software_id, json[QString("software_id")]);
    m_software_id_isSet = !json[QString("software_id")].isNull() && m_software_id_isValid;

    m_software_version_isValid = ::OpenAPI::fromJsonValue(m_software_version, json[QString("software_version")]);
    m_software_version_isSet = !json[QString("software_version")].isNull() && m_software_version_isValid;

    m_token_endpoint_auth_method_isValid = ::OpenAPI::fromJsonValue(m_token_endpoint_auth_method, json[QString("token_endpoint_auth_method")]);
    m_token_endpoint_auth_method_isSet = !json[QString("token_endpoint_auth_method")].isNull() && m_token_endpoint_auth_method_isValid;
...
QString OAI_client_post_request::asJson() const {
...
QJsonObject OAI_client_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
    ...
    if (m_jwks.size() > 0) {
        obj.insert(QString("jwks"), ::OpenAPI::toJsonValue(m_jwks));
    }
    if (m_jwks_uri_isSet) {
        obj.insert(QString("jwks_uri"), ::OpenAPI::toJsonValue(m_jwks_uri));
    }
    if (m_logo_email_isSet) {
        obj.insert(QString("logo_email"), ::OpenAPI::toJsonValue(m_logo_email));
    }
    if (m_logo_uri_isSet) {
    ...
    if (m_software_id_isSet) {
        obj.insert(QString("software_id"), ::OpenAPI::toJsonValue(m_software_id));
    }
    if (m_software_version_isSet) {
        obj.insert(QString("software_version"), ::OpenAPI::toJsonValue(m_software_version));
    }
    if (m_token_endpoint_auth_method_isSet) {
        obj.insert(QString("token_endpoint_auth_method"), ::OpenAPI::toJsonValue(m_token_endpoint_auth_method));
    }
    if (m_tos_uri_isSet) {
...
QString OAI_client_post_request::getId() const {
    return m_id;
}
void OAI_client_post_request::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_client_post_request::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_client_post_request::is_id_Valid() const{
    return m_id_isValid;
}

QString OAI_client_post_request::getClientId() const {
    return m_client_id;
}
void OAI_client_post_request::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAI_client_post_request::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAI_client_post_request::is_client_id_Valid() const{
    return m_client_id_isValid;
}

QString OAI_client_post_request::getClientName() const {
    return m_client_name;
}
void OAI_client_post_request::setClientName(const QString &client_name) {
    m_client_name = client_name;
    m_client_name_isSet = true;
}

bool OAI_client_post_request::is_client_name_Set() const{
    return m_client_name_isSet;
}

bool OAI_client_post_request::is_client_name_Valid() const{
    return m_client_name_isValid;
}

QString OAI_client_post_request::getClientSecret() const {
    return m_client_secret;
}
void OAI_client_post_request::setClientSecret(const QString &client_secret) {
    m_client_secret = client_secret;
    m_client_secret_isSet = true;
}

bool OAI_client_post_request::is_client_secret_Set() const{
    return m_client_secret_isSet;
}

bool OAI_client_post_request::is_client_secret_Valid() const{
    return m_client_secret_isValid;
}

QString OAI_client_post_request::getClientUri() const {
    return m_client_uri;
}
void OAI_client_post_request::setClientUri(const QString &client_uri) {
    m_client_uri = client_uri;
    m_client_uri_isSet = true;
}

bool OAI_client_post_request::is_client_uri_Set() const{
    return m_client_uri_isSet;
}

bool OAI_client_post_request::is_client_uri_Valid() const{
    return m_client_uri_isValid;
}

QList<QJsonValue> OAI_client_post_request::getContacts() const {
    return m_contacts;
}
void OAI_client_post_request::setContacts(const QList<QJsonValue> &contacts) {
    m_contacts = contacts;
    m_contacts_isSet = true;
}

bool OAI_client_post_request::is_contacts_Set() const{
    return m_contacts_isSet;
}

bool OAI_client_post_request::is_contacts_Valid() const{
    return m_contacts_isValid;
}

QList<QJsonValue> OAI_client_post_request::getGrantTypes() const {
    return m_grant_types;
}
void OAI_client_post_request::setGrantTypes(const QList<QJsonValue> &grant_types) {
    m_grant_types = grant_types;
    m_grant_types_isSet = true;
}

bool OAI_client_post_request::is_grant_types_Set() const{
    return m_grant_types_isSet;
}

bool OAI_client_post_request::is_grant_types_Valid() const{
    return m_grant_types_isValid;
}

QList<QJsonValue> OAI_client_post_request::getJwks() const {
    return m_jwks;
}
void OAI_client_post_request::setJwks(const QList<QJsonValue> &jwks) {
    m_jwks = jwks;
    m_jwks_isSet = true;
}

bool OAI_client_post_request::is_jwks_Set() const{
    return m_jwks_isSet;
}

bool OAI_client_post_request::is_jwks_Valid() const{
    return m_jwks_isValid;
}

QString OAI_client_post_request::getJwksUri() const {
    return m_jwks_uri;
}
void OAI_client_post_request::setJwksUri(const QString &jwks_uri) {
    m_jwks_uri = jwks_uri;
    m_jwks_uri_isSet = true;
}

bool OAI_client_post_request::is_jwks_uri_Set() const{
    return m_jwks_uri_isSet;
}

bool OAI_client_post_request::is_jwks_uri_Valid() const{
    return m_jwks_uri_isValid;
}

QString OAI_client_post_request::getLogoEmail() const {
    return m_logo_email;
}
void OAI_client_post_request::setLogoEmail(const QString &logo_email) {
    m_logo_email = logo_email;
    m_logo_email_isSet = true;
}

bool OAI_client_post_request::is_logo_email_Set() const{
    return m_logo_email_isSet;
}

bool OAI_client_post_request::is_logo_email_Valid() const{
    return m_logo_email_isValid;
}

QString OAI_client_post_request::getLogoUri() const {
    return m_logo_uri;
}
void OAI_client_post_request::setLogoUri(const QString &logo_uri) {
    m_logo_uri = logo_uri;
    m_logo_uri_isSet = true;
}

bool OAI_client_post_request::is_logo_uri_Set() const{
    return m_logo_uri_isSet;
}

bool OAI_client_post_request::is_logo_uri_Valid() const{
    return m_logo_uri_isValid;
}

QString OAI_client_post_request::getPolicyUri() const {
    return m_policy_uri;
}
void OAI_client_post_request::setPolicyUri(const QString &policy_uri) {
    m_policy_uri = policy_uri;
    m_policy_uri_isSet = true;
}

bool OAI_client_post_request::is_policy_uri_Set() const{
    return m_policy_uri_isSet;
}

bool OAI_client_post_request::is_policy_uri_Valid() const{
    return m_policy_uri_isValid;
}

QList<QJsonValue> OAI_client_post_request::getRedirectUris() const {
    return m_redirect_uris;
}
void OAI_client_post_request::setRedirectUris(const QList<QJsonValue> &redirect_uris) {
    m_redirect_uris = redirect_uris;
    m_redirect_uris_isSet = true;
}

bool OAI_client_post_request::is_redirect_uris_Set() const{
    return m_redirect_uris_isSet;
}

bool OAI_client_post_request::is_redirect_uris_Valid() const{
    return m_redirect_uris_isValid;
}

QList<QJsonValue> OAI_client_post_request::getResponseTypes() const {
    return m_response_types;
}
void OAI_client_post_request::setResponseTypes(const QList<QJsonValue> &response_types) {
    m_response_types = response_types;
    m_response_types_isSet = true;
}

bool OAI_client_post_request::is_response_types_Set() const{
    return m_response_types_isSet;
}

bool OAI_client_post_request::is_response_types_Valid() const{
    return m_response_types_isValid;
}

QString OAI_client_post_request::getScope() const {
    return m_scope;
}
void OAI_client_post_request::setScope(const QString &scope) {
    m_scope = scope;
    m_scope_isSet = true;
}

bool OAI_client_post_request::is_scope_Set() const{
    return m_scope_isSet;
}

bool OAI_client_post_request::is_scope_Valid() const{
    return m_scope_isValid;
}

QString OAI_client_post_request::getSoftwareId() const {
    return m_software_id;
}
void OAI_client_post_request::setSoftwareId(const QString &software_id) {
    m_software_id = software_id;
    m_software_id_isSet = true;
}

bool OAI_client_post_request::is_software_id_Set() const{
    return m_software_id_isSet;
}

bool OAI_client_post_request::is_software_id_Valid() const{
    return m_software_id_isValid;
}

QString OAI_client_post_request::getSoftwareVersion() const {
    return m_software_version;
}
void OAI_client_post_request::setSoftwareVersion(const QString &software_version) {
    m_software_version = software_version;
    m_software_version_isSet = true;
}

bool OAI_client_post_request::is_software_version_Set() const{
    return m_software_version_isSet;
}

bool OAI_client_post_request::is_software_version_Valid() const{
    return m_software_version_isValid;
}

QString OAI_client_post_request::getTokenEndpointAuthMethod() const {
    return m_token_endpoint_auth_method;
}
void OAI_client_post_request::setTokenEndpointAuthMethod(const QString &token_endpoint_auth_method) {
    m_token_endpoint_auth_method = token_endpoint_auth_method;
    m_token_endpoint_auth_method_isSet = true;
}

bool OAI_client_post_request::is_token_endpoint_auth_method_Set() const{
    return m_token_endpoint_auth_method_isSet;
}

bool OAI_client_post_request::is_token_endpoint_auth_method_Valid() const{
    return m_token_endpoint_auth_method_isValid;
}

QString OAI_client_post_request::getTosUri() const {
    return m_tos_uri;
}
void OAI_client_post_request::setTosUri(const QString &tos_uri) {
    m_tos_uri = tos_uri;
    m_tos_uri_isSet = true;
}

bool OAI_client_post_request::is_tos_uri_Set() const{
    return m_tos_uri_isSet;
}

bool OAI_client_post_request::is_tos_uri_Valid() const{
    return m_tos_uri_isValid;
}

bool OAI_client_post_request::isSet() const {
...
bool OAI_client_post_request::isValid() const {
