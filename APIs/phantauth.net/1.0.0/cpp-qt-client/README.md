...
void Example::exampleFunction1(){
     OAIClientApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIClientApi::clientClientIdGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIClientApi::clientClientIdGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString client_id = create(); // QString | A client ID or email.
      apiInstance.clientClientIdGet(client_id);
