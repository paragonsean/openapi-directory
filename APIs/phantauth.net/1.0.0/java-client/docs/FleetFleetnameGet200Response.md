...
|------------ | ------------- | ------------- | -------------|
|**atId** | **String** | URL of the Fleet&#39;s JSON representation. |  [optional] |
...
|**members** | **List&lt;Object&gt;** | The client objects included in a fleet. |  [optional] |
