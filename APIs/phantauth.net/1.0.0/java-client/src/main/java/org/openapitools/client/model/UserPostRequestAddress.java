...
public class UserPostRequestAddress {
  ...
  public UserPostRequestAddress() {
  }

  public UserPostRequestAddress country(String country) {
  ...
  public UserPostRequestAddress formatted(String formatted) {
  ...
  public UserPostRequestAddress locality(String locality) {
  ...
  public UserPostRequestAddress postalCode(String postalCode) {
  ...
  public UserPostRequestAddress region(String region) {
    this.region = region;
    return this;
  }
  ...
  public UserPostRequestAddress streetAddress(String streetAddress) {
  ...
  public boolean equals(Object o) {
    ...
    UserPostRequestAddress userPostRequestAddress = (UserPostRequestAddress) o;
    return Objects.equals(this.country, userPostRequestAddress.country) &&
        Objects.equals(this.formatted, userPostRequestAddress.formatted) &&
        Objects.equals(this.locality, userPostRequestAddress.locality) &&
        Objects.equals(this.postalCode, userPostRequestAddress.postalCode) &&
        Objects.equals(this.region, userPostRequestAddress.region) &&
        Objects.equals(this.streetAddress, userPostRequestAddress.streetAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserPostRequestAddress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserPostRequestAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPostRequestAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserPostRequestAddress is not found in the empty JSON string", UserPostRequestAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserPostRequestAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserPostRequestAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserPostRequestAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserPostRequestAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserPostRequestAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserPostRequestAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<UserPostRequestAddress>() {
           @Override
           public void write(JsonWriter out, UserPostRequestAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserPostRequestAddress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserPostRequestAddress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserPostRequestAddress
   * @throws IOException if the JSON string is invalid with respect to UserPostRequestAddress
   */
  public static UserPostRequestAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserPostRequestAddress.class);
  }

  /**
   * Convert an instance of UserPostRequestAddress to an JSON string
   *
   * @return JSON string
   */
