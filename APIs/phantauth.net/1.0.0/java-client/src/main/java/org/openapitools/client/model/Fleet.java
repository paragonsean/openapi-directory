...
public class Fleet {
  ...
  public Fleet logoEmail(String logoEmail) {
  ...
  public Fleet members(List<Object> members) {
    this.members = members;
    return this;
  }

  public Fleet addMembersItem(Object membersItem) {
  ...
  public Fleet profile(String profile) {
  ...
  public boolean equals(Object o) {
    ...
    Fleet fleet = (Fleet) o;
    return Objects.equals(this.atId, fleet.atId) &&
        Objects.equals(this.logo, fleet.logo) &&
        Objects.equals(this.logoEmail, fleet.logoEmail) &&
        Objects.equals(this.members, fleet.members) &&
        Objects.equals(this.name, fleet.name) &&
        Objects.equals(this.profile, fleet.profile) &&
        Objects.equals(this.sub, fleet.sub);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atId, logo, logoEmail, members, name, profile, sub);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Fleet.openapiRequiredFields) {
