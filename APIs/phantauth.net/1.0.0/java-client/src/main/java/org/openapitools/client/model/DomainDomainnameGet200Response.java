...
public class DomainDomainnameGet200Response {
  ...
  public DomainDomainnameGet200Response() {
  }

  public DomainDomainnameGet200Response atId(String atId) {
    this.atId = atId;
    return this;
  }
  ...
  public DomainDomainnameGet200Response logo(String logo) {
    this.logo = logo;
    return this;
  }
  ...
  public DomainDomainnameGet200Response members(List<Object> members) {
    this.members = members;
    return this;
  }

  public DomainDomainnameGet200Response addMembersItem(Object membersItem) {
  ...
  public DomainDomainnameGet200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DomainDomainnameGet200Response profile(String profile) {
  ...
  public DomainDomainnameGet200Response sub(String sub) {
    this.sub = sub;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DomainDomainnameGet200Response domainDomainnameGet200Response = (DomainDomainnameGet200Response) o;
    return Objects.equals(this.atId, domainDomainnameGet200Response.atId) &&
        Objects.equals(this.logo, domainDomainnameGet200Response.logo) &&
        Objects.equals(this.members, domainDomainnameGet200Response.members) &&
        Objects.equals(this.name, domainDomainnameGet200Response.name) &&
        Objects.equals(this.profile, domainDomainnameGet200Response.profile) &&
        Objects.equals(this.sub, domainDomainnameGet200Response.sub);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainDomainnameGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainDomainnameGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainDomainnameGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainDomainnameGet200Response is not found in the empty JSON string", DomainDomainnameGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainDomainnameGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainDomainnameGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainDomainnameGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainDomainnameGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainDomainnameGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainDomainnameGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainDomainnameGet200Response>() {
           @Override
           public void write(JsonWriter out, DomainDomainnameGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainDomainnameGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainDomainnameGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainDomainnameGet200Response
   * @throws IOException if the JSON string is invalid with respect to DomainDomainnameGet200Response
   */
  public static DomainDomainnameGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainDomainnameGet200Response.class);
  }

  /**
   * Convert an instance of DomainDomainnameGet200Response to an JSON string
   *
   * @return JSON string
   */
