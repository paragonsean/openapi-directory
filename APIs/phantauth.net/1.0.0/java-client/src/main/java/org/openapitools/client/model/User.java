...
public class User {
  ...
  public User updatedAt(BigDecimal updatedAt) {
  ...
  public User webmail(String webmail) {
  ...
  public User zoneinfo(String zoneinfo) {
  ...
  public boolean equals(Object o) {
    ...
    User user = (User) o;
    return Objects.equals(this.atId, user.atId) &&
        ...
        Objects.equals(this.sub, user.sub) &&
        Objects.equals(this.uid, user.uid) &&
        Objects.equals(this.updatedAt, user.updatedAt) &&
        Objects.equals(this.webmail, user.webmail) &&
        Objects.equals(this.website, user.website) &&
        Objects.equals(this.zoneinfo, user.zoneinfo);
  }
