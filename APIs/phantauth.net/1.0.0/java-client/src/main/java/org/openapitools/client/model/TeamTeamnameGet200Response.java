...
public class TeamTeamnameGet200Response {
  ...
  public TeamTeamnameGet200Response() {
  }

  public TeamTeamnameGet200Response atId(String atId) {
    this.atId = atId;
    return this;
  }
  ...
  public TeamTeamnameGet200Response logo(String logo) {
    this.logo = logo;
    return this;
  }
  ...
  public TeamTeamnameGet200Response logoEmail(String logoEmail) {
  ...
  public TeamTeamnameGet200Response members(List<Object> members) {
    this.members = members;
    return this;
  }

  public TeamTeamnameGet200Response addMembersItem(Object membersItem) {
  ...
  public TeamTeamnameGet200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TeamTeamnameGet200Response profile(String profile) {
  ...
  public TeamTeamnameGet200Response sub(String sub) {
    this.sub = sub;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TeamTeamnameGet200Response teamTeamnameGet200Response = (TeamTeamnameGet200Response) o;
    return Objects.equals(this.atId, teamTeamnameGet200Response.atId) &&
        Objects.equals(this.logo, teamTeamnameGet200Response.logo) &&
        Objects.equals(this.logoEmail, teamTeamnameGet200Response.logoEmail) &&
        Objects.equals(this.members, teamTeamnameGet200Response.members) &&
        Objects.equals(this.name, teamTeamnameGet200Response.name) &&
        Objects.equals(this.profile, teamTeamnameGet200Response.profile) &&
        Objects.equals(this.sub, teamTeamnameGet200Response.sub);
  }
  ...
  public String toString() {
    ...
    sb.append("class TeamTeamnameGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamTeamnameGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamTeamnameGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamTeamnameGet200Response is not found in the empty JSON string", TeamTeamnameGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TeamTeamnameGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamTeamnameGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TeamTeamnameGet200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamTeamnameGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamTeamnameGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamTeamnameGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamTeamnameGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamTeamnameGet200Response>() {
           @Override
           public void write(JsonWriter out, TeamTeamnameGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TeamTeamnameGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TeamTeamnameGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TeamTeamnameGet200Response
   * @throws IOException if the JSON string is invalid with respect to TeamTeamnameGet200Response
   */
  public static TeamTeamnameGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamTeamnameGet200Response.class);
  }

  /**
   * Convert an instance of TeamTeamnameGet200Response to an JSON string
   *
   * @return JSON string
   */
