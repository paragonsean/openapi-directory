...
public class Client {
  ...
  public Client atId(String atId) {
    this.atId = atId;
    return this;
  }
  ...
  public Client contacts(List<Object> contacts) {
    this.contacts = contacts;
    return this;
  }

  public Client addContactsItem(Object contactsItem) {
  ...
  public Client grantTypes(List<Object> grantTypes) {
    this.grantTypes = grantTypes;
    return this;
  }

  public Client addGrantTypesItem(Object grantTypesItem) {
  ...
  public Client jwks(List<Object> jwks) {
    this.jwks = jwks;
    return this;
  }

  public Client addJwksItem(Object jwksItem) {
    if (this.jwks == null) {
      this.jwks = new ArrayList<>();
    }
    this.jwks.add(jwksItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<Object> getJwks() {
    return jwks;
  }

  public void setJwks(List<Object> jwks) {
    this.jwks = jwks;
  }
  ...
  public Client logoEmail(String logoEmail) {
  ...
  public Client redirectUris(List<Object> redirectUris) {
    this.redirectUris = redirectUris;
    return this;
  }

  public Client addRedirectUrisItem(Object redirectUrisItem) {
  ...
  public Client responseTypes(List<Object> responseTypes) {
    this.responseTypes = responseTypes;
    return this;
  }

  public Client addResponseTypesItem(Object responseTypesItem) {
  ...
  public Client softwareId(String softwareId) {
  ...
  public Client softwareVersion(String softwareVersion) {
  ...
  public Client tokenEndpointAuthMethod(String tokenEndpointAuthMethod) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atId, client.atId) &&
        ...
        Objects.equals(this.logoEmail, client.logoEmail) &&
        ...
        Objects.equals(this.softwareId, client.softwareId) &&
        Objects.equals(this.softwareVersion, client.softwareVersion) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atId, clientId, clientName, clientSecret, clientUri, contacts, grantTypes, jwks, jwksUri, logoEmail, logoUri, policyUri, redirectUris, responseTypes, scope, softwareId, softwareVersion, tokenEndpointAuthMethod, tosUri);
  }
  ...
  public String toString() {
    ...
    sb.append("    logoEmail: ").append(toIndentedString(logoEmail)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("jwks") != null && !jsonObj.get("jwks").isJsonNull() && !jsonObj.get("jwks").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `jwks` to be an array in the JSON string but got `%s`", jsonObj.get("jwks").toString()));
      }
      ...
      if ((jsonObj.get("logo_email") != null && !jsonObj.get("logo_email").isJsonNull()) && !jsonObj.get("logo_email").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `logo_email` to be a primitive type in the JSON string but got `%s`", jsonObj.get("logo_email").toString()));
      }
