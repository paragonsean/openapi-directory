...
public class TenantTenantnameGet200Response {
  ...
  public TenantTenantnameGet200Response() {
  }

  public TenantTenantnameGet200Response atId(String atId) {
    this.atId = atId;
    return this;
  }
  ...
  public TenantTenantnameGet200Response about(String about) {
    this.about = about;
    return this;
  }
  ...
  public TenantTenantnameGet200Response attribution(String attribution) {
  ...
  public TenantTenantnameGet200Response depot(String depot) {
    this.depot = depot;
    return this;
  }
  ...
  public TenantTenantnameGet200Response depots(List<Object> depots) {
    this.depots = depots;
    return this;
  }

  public TenantTenantnameGet200Response addDepotsItem(Object depotsItem) {
    if (this.depots == null) {
  ...
  public TenantTenantnameGet200Response domain(Boolean domain) {
    this.domain = domain;
    return this;
  }
  ...
  public TenantTenantnameGet200Response factories(List<Object> factories) {
    this.factories = factories;
    return this;
  }

  public TenantTenantnameGet200Response addFactoriesItem(Object factoriesItem) {
  ...
  public TenantTenantnameGet200Response factory(String factory) {
  ...
  public TenantTenantnameGet200Response favicon(String favicon) {
  ...
  public TenantTenantnameGet200Response issuer(String issuer) {
    this.issuer = issuer;
    return this;
  }
  ...
  public TenantTenantnameGet200Response logo(String logo) {
    this.logo = logo;
    return this;
  }
  ...
  public TenantTenantnameGet200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TenantTenantnameGet200Response script(String script) {
    this.script = script;
    return this;
  }
  ...
  public TenantTenantnameGet200Response sheet(String sheet) {
    this.sheet = sheet;
    return this;
  }
  ...
  public TenantTenantnameGet200Response sub(String sub) {
    this.sub = sub;
    return this;
  }
  ...
  public TenantTenantnameGet200Response subtenant(Boolean subtenant) {
  ...
  public TenantTenantnameGet200Response summary(String summary) {
  ...
  public TenantTenantnameGet200Response template(String template) {
  ...
  public TenantTenantnameGet200Response theme(String theme) {
    this.theme = theme;
    return this;
  }
  ...
  public TenantTenantnameGet200Response userinfo(String userinfo) {
  ...
  public TenantTenantnameGet200Response website(String website) {
  ...
  public boolean equals(Object o) {
    ...
    TenantTenantnameGet200Response tenantTenantnameGet200Response = (TenantTenantnameGet200Response) o;
    return Objects.equals(this.atId, tenantTenantnameGet200Response.atId) &&
        Objects.equals(this.about, tenantTenantnameGet200Response.about) &&
        Objects.equals(this.attribution, tenantTenantnameGet200Response.attribution) &&
        Objects.equals(this.depot, tenantTenantnameGet200Response.depot) &&
        Objects.equals(this.depots, tenantTenantnameGet200Response.depots) &&
        Objects.equals(this.domain, tenantTenantnameGet200Response.domain) &&
        Objects.equals(this.factories, tenantTenantnameGet200Response.factories) &&
        Objects.equals(this.factory, tenantTenantnameGet200Response.factory) &&
        Objects.equals(this.favicon, tenantTenantnameGet200Response.favicon) &&
        Objects.equals(this.issuer, tenantTenantnameGet200Response.issuer) &&
        Objects.equals(this.logo, tenantTenantnameGet200Response.logo) &&
        Objects.equals(this.name, tenantTenantnameGet200Response.name) &&
        Objects.equals(this.script, tenantTenantnameGet200Response.script) &&
        Objects.equals(this.sheet, tenantTenantnameGet200Response.sheet) &&
        Objects.equals(this.sub, tenantTenantnameGet200Response.sub) &&
        Objects.equals(this.subtenant, tenantTenantnameGet200Response.subtenant) &&
        Objects.equals(this.summary, tenantTenantnameGet200Response.summary) &&
        Objects.equals(this.template, tenantTenantnameGet200Response.template) &&
        Objects.equals(this.theme, tenantTenantnameGet200Response.theme) &&
        Objects.equals(this.userinfo, tenantTenantnameGet200Response.userinfo) &&
        Objects.equals(this.website, tenantTenantnameGet200Response.website);
  }
  ...
  public String toString() {
    ...
    sb.append("class TenantTenantnameGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TenantTenantnameGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TenantTenantnameGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TenantTenantnameGet200Response is not found in the empty JSON string", TenantTenantnameGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TenantTenantnameGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TenantTenantnameGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TenantTenantnameGet200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TenantTenantnameGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TenantTenantnameGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TenantTenantnameGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TenantTenantnameGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<TenantTenantnameGet200Response>() {
           @Override
           public void write(JsonWriter out, TenantTenantnameGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TenantTenantnameGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TenantTenantnameGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TenantTenantnameGet200Response
   * @throws IOException if the JSON string is invalid with respect to TenantTenantnameGet200Response
   */
  public static TenantTenantnameGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TenantTenantnameGet200Response.class);
  }

  /**
   * Convert an instance of TenantTenantnameGet200Response to an JSON string
   *
   * @return JSON string
   */
