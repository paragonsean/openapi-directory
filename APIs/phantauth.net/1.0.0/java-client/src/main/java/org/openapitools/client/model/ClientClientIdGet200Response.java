...
public class ClientClientIdGet200Response {
  ...
  public ClientClientIdGet200Response() {
  }

  public ClientClientIdGet200Response atId(String atId) {
    this.atId = atId;
    return this;
  }
  ...
  public ClientClientIdGet200Response clientId(String clientId) {
  ...
  public ClientClientIdGet200Response clientName(String clientName) {
  ...
  public ClientClientIdGet200Response clientSecret(String clientSecret) {
  ...
  public ClientClientIdGet200Response clientUri(String clientUri) {
  ...
  public ClientClientIdGet200Response contacts(List<Object> contacts) {
    this.contacts = contacts;
    return this;
  }

  public ClientClientIdGet200Response addContactsItem(Object contactsItem) {
  ...
  public ClientClientIdGet200Response grantTypes(List<Object> grantTypes) {
    this.grantTypes = grantTypes;
    return this;
  }

  public ClientClientIdGet200Response addGrantTypesItem(Object grantTypesItem) {
  ...
  public ClientClientIdGet200Response jwks(List<Object> jwks) {
    this.jwks = jwks;
    return this;
  }

  public ClientClientIdGet200Response addJwksItem(Object jwksItem) {
    if (this.jwks == null) {
  ...
  public ClientClientIdGet200Response jwksUri(String jwksUri) {
  ...
  public ClientClientIdGet200Response logoEmail(String logoEmail) {
  ...
  public ClientClientIdGet200Response logoUri(String logoUri) {
  ...
  public ClientClientIdGet200Response policyUri(String policyUri) {
  ...
  public ClientClientIdGet200Response redirectUris(List<Object> redirectUris) {
    this.redirectUris = redirectUris;
    return this;
  }

  public ClientClientIdGet200Response addRedirectUrisItem(Object redirectUrisItem) {
  ...
  public ClientClientIdGet200Response responseTypes(List<Object> responseTypes) {
    this.responseTypes = responseTypes;
    return this;
  }

  public ClientClientIdGet200Response addResponseTypesItem(Object responseTypesItem) {
  ...
  public ClientClientIdGet200Response scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public ClientClientIdGet200Response softwareId(String softwareId) {
  ...
  public ClientClientIdGet200Response softwareVersion(String softwareVersion) {
  ...
  public ClientClientIdGet200Response tokenEndpointAuthMethod(String tokenEndpointAuthMethod) {
  ...
  public ClientClientIdGet200Response tosUri(String tosUri) {
    this.tosUri = tosUri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClientClientIdGet200Response clientClientIdGet200Response = (ClientClientIdGet200Response) o;
    return Objects.equals(this.atId, clientClientIdGet200Response.atId) &&
        Objects.equals(this.clientId, clientClientIdGet200Response.clientId) &&
        Objects.equals(this.clientName, clientClientIdGet200Response.clientName) &&
        Objects.equals(this.clientSecret, clientClientIdGet200Response.clientSecret) &&
        Objects.equals(this.clientUri, clientClientIdGet200Response.clientUri) &&
        Objects.equals(this.contacts, clientClientIdGet200Response.contacts) &&
        Objects.equals(this.grantTypes, clientClientIdGet200Response.grantTypes) &&
        Objects.equals(this.jwks, clientClientIdGet200Response.jwks) &&
        Objects.equals(this.jwksUri, clientClientIdGet200Response.jwksUri) &&
        Objects.equals(this.logoEmail, clientClientIdGet200Response.logoEmail) &&
        Objects.equals(this.logoUri, clientClientIdGet200Response.logoUri) &&
        Objects.equals(this.policyUri, clientClientIdGet200Response.policyUri) &&
        Objects.equals(this.redirectUris, clientClientIdGet200Response.redirectUris) &&
        Objects.equals(this.responseTypes, clientClientIdGet200Response.responseTypes) &&
        Objects.equals(this.scope, clientClientIdGet200Response.scope) &&
        Objects.equals(this.softwareId, clientClientIdGet200Response.softwareId) &&
        Objects.equals(this.softwareVersion, clientClientIdGet200Response.softwareVersion) &&
        Objects.equals(this.tokenEndpointAuthMethod, clientClientIdGet200Response.tokenEndpointAuthMethod) &&
        Objects.equals(this.tosUri, clientClientIdGet200Response.tosUri);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClientClientIdGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClientClientIdGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClientClientIdGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClientClientIdGet200Response is not found in the empty JSON string", ClientClientIdGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClientClientIdGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClientClientIdGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ClientClientIdGet200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClientClientIdGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClientClientIdGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClientClientIdGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClientClientIdGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ClientClientIdGet200Response>() {
           @Override
           public void write(JsonWriter out, ClientClientIdGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClientClientIdGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClientClientIdGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClientClientIdGet200Response
   * @throws IOException if the JSON string is invalid with respect to ClientClientIdGet200Response
   */
  public static ClientClientIdGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClientClientIdGet200Response.class);
  }

  /**
   * Convert an instance of ClientClientIdGet200Response to an JSON string
   *
   * @return JSON string
   */
