...
public class FleetFleetnameGet200Response {
  ...
  public FleetFleetnameGet200Response() {
  }

  public FleetFleetnameGet200Response atId(String atId) {
    this.atId = atId;
    return this;
  }
  ...
  public FleetFleetnameGet200Response logo(String logo) {
    this.logo = logo;
    return this;
  }
  ...
  public FleetFleetnameGet200Response logoEmail(String logoEmail) {
  ...
  public FleetFleetnameGet200Response members(List<Object> members) {
    this.members = members;
    return this;
  }

  public FleetFleetnameGet200Response addMembersItem(Object membersItem) {
  ...
  public FleetFleetnameGet200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public FleetFleetnameGet200Response profile(String profile) {
  ...
  public FleetFleetnameGet200Response sub(String sub) {
    this.sub = sub;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FleetFleetnameGet200Response fleetFleetnameGet200Response = (FleetFleetnameGet200Response) o;
    return Objects.equals(this.atId, fleetFleetnameGet200Response.atId) &&
        Objects.equals(this.logo, fleetFleetnameGet200Response.logo) &&
        Objects.equals(this.logoEmail, fleetFleetnameGet200Response.logoEmail) &&
        Objects.equals(this.members, fleetFleetnameGet200Response.members) &&
        Objects.equals(this.name, fleetFleetnameGet200Response.name) &&
        Objects.equals(this.profile, fleetFleetnameGet200Response.profile) &&
        Objects.equals(this.sub, fleetFleetnameGet200Response.sub);
  }
  ...
  public String toString() {
    ...
    sb.append("class FleetFleetnameGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FleetFleetnameGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FleetFleetnameGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FleetFleetnameGet200Response is not found in the empty JSON string", FleetFleetnameGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FleetFleetnameGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FleetFleetnameGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FleetFleetnameGet200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FleetFleetnameGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FleetFleetnameGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FleetFleetnameGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FleetFleetnameGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<FleetFleetnameGet200Response>() {
           @Override
           public void write(JsonWriter out, FleetFleetnameGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FleetFleetnameGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FleetFleetnameGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FleetFleetnameGet200Response
   * @throws IOException if the JSON string is invalid with respect to FleetFleetnameGet200Response
   */
  public static FleetFleetnameGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FleetFleetnameGet200Response.class);
  }

  /**
   * Convert an instance of FleetFleetnameGet200Response to an JSON string
   *
   * @return JSON string
   */
