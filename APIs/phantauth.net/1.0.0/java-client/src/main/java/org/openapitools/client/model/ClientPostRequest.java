...
public class ClientPostRequest {
  ...
  public ClientPostRequest atId(String atId) {
    this.atId = atId;
    return this;
  }
  ...
  public ClientPostRequest clientId(String clientId) {
  ...
  public ClientPostRequest clientName(String clientName) {
  ...
  public ClientPostRequest clientSecret(String clientSecret) {
  ...
  public ClientPostRequest clientUri(String clientUri) {
  ...
  public ClientPostRequest contacts(List<Object> contacts) {
    this.contacts = contacts;
    return this;
  }

  public ClientPostRequest addContactsItem(Object contactsItem) {
  ...
  public ClientPostRequest grantTypes(List<Object> grantTypes) {
    this.grantTypes = grantTypes;
    return this;
  }

  public ClientPostRequest addGrantTypesItem(Object grantTypesItem) {
  ...
  public ClientPostRequest jwks(List<Object> jwks) {
    this.jwks = jwks;
    return this;
  }

  public ClientPostRequest addJwksItem(Object jwksItem) {
    if (this.jwks == null) {
  ...
  public ClientPostRequest jwksUri(String jwksUri) {
  ...
  public ClientPostRequest logoEmail(String logoEmail) {
  ...
  public ClientPostRequest logoUri(String logoUri) {
  ...
  public ClientPostRequest policyUri(String policyUri) {
  ...
  public ClientPostRequest redirectUris(List<Object> redirectUris) {
    this.redirectUris = redirectUris;
    return this;
  }

  public ClientPostRequest addRedirectUrisItem(Object redirectUrisItem) {
  ...
  public ClientPostRequest responseTypes(List<Object> responseTypes) {
    this.responseTypes = responseTypes;
    return this;
  }

  public ClientPostRequest addResponseTypesItem(Object responseTypesItem) {
  ...
  public ClientPostRequest scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public ClientPostRequest softwareId(String softwareId) {
  ...
  public ClientPostRequest softwareVersion(String softwareVersion) {
  ...
  public ClientPostRequest tokenEndpointAuthMethod(String tokenEndpointAuthMethod) {
  ...
  public ClientPostRequest tosUri(String tosUri) {
    this.tosUri = tosUri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClientPostRequest clientPostRequest = (ClientPostRequest) o;
    return Objects.equals(this.atId, clientPostRequest.atId) &&
        Objects.equals(this.clientId, clientPostRequest.clientId) &&
        Objects.equals(this.clientName, clientPostRequest.clientName) &&
        Objects.equals(this.clientSecret, clientPostRequest.clientSecret) &&
        Objects.equals(this.clientUri, clientPostRequest.clientUri) &&
        Objects.equals(this.contacts, clientPostRequest.contacts) &&
        Objects.equals(this.grantTypes, clientPostRequest.grantTypes) &&
        Objects.equals(this.jwks, clientPostRequest.jwks) &&
        Objects.equals(this.jwksUri, clientPostRequest.jwksUri) &&
        Objects.equals(this.logoEmail, clientPostRequest.logoEmail) &&
        Objects.equals(this.logoUri, clientPostRequest.logoUri) &&
        Objects.equals(this.policyUri, clientPostRequest.policyUri) &&
        Objects.equals(this.redirectUris, clientPostRequest.redirectUris) &&
        Objects.equals(this.responseTypes, clientPostRequest.responseTypes) &&
        Objects.equals(this.scope, clientPostRequest.scope) &&
        Objects.equals(this.softwareId, clientPostRequest.softwareId) &&
        Objects.equals(this.softwareVersion, clientPostRequest.softwareVersion) &&
        Objects.equals(this.tokenEndpointAuthMethod, clientPostRequest.tokenEndpointAuthMethod) &&
        Objects.equals(this.tosUri, clientPostRequest.tosUri);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClientPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClientPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClientPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClientPostRequest is not found in the empty JSON string", ClientPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClientPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClientPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ClientPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClientPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClientPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClientPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClientPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ClientPostRequest>() {
           @Override
           public void write(JsonWriter out, ClientPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClientPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClientPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClientPostRequest
   * @throws IOException if the JSON string is invalid with respect to ClientPostRequest
   */
  public static ClientPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClientPostRequest.class);
  }

  /**
   * Convert an instance of ClientPostRequest to an JSON string
   *
   * @return JSON string
   */
