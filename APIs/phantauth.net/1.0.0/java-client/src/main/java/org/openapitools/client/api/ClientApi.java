...
import org.openapitools.client.model.ClientClientIdGet200Response;
import org.openapitools.client.model.ClientPostRequest;
...
public class ClientApi {
     ...
     * @param clientId A client ID or email. (required)
    ...
    private okhttp3.Call clientClientIdGetValidateBeforeCall(String clientId, final ApiCallback _callback) throws ApiException {
        ...
        return clientClientIdGetCall(clientId, _callback);
     ...
     * @param clientId A client ID or email. (required)
     * @return ClientClientIdGet200Response
     ...
     */
    public ClientClientIdGet200Response clientClientIdGet(String clientId) throws ApiException {
        ApiResponse<ClientClientIdGet200Response> localVarResp = clientClientIdGetWithHttpInfo(clientId);
     ...
     * Use this endpoint to generate a random client. The client is generated in a deterministic way, on the bases of the client ID given as a path parameter. In the case of identical client IDs, the endpoint will generate the same client object. The properties of the generated client object are randomly generated on the basis of the client ID. In lack of a client ID, all calls generate a different client object to the randomly generated client ID.  By providing an email address as the &#x60;client_id&#x60; parameter, you can customize the client logo by the use of the gravatar associated with the email address.  If the &#x60;client_id&#x60; parameter contains minimum one dot (&#x60;.&#x60;) or space (&#x60; &#x60;) character, the client_name is produced from the parameter, rather than being generated.&#x60;  The result is always a client object. If you want to generate multiple clients in one single step, you can do it by the use of *Fleet* generation. The members of a fleet are clients randomly generated from the fleet name.
     * @param clientId A client ID or email. (required)
     * @return ApiResponse&lt;ClientClientIdGet200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ClientClientIdGet200Response> clientClientIdGetWithHttpInfo(String clientId) throws ApiException {
        okhttp3.Call localVarCall = clientClientIdGetValidateBeforeCall(clientId, null);
        Type localVarReturnType = new TypeToken<ClientClientIdGet200Response>(){}.getType();
     ...
     */
    public okhttp3.Call clientClientIdGetAsync(String clientId, final ApiCallback<ClientClientIdGet200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for clientClientIdTokenKindGet
     * @param clientId A client ID or email. (required)
     ...
     */
    public okhttp3.Call clientClientIdTokenKindGetCall(String clientId, String kind, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/client/{client_id}/token/{kind}"
            .replace("{" + "client_id" + "}", localVarApiClient.escapeString(clientId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call clientClientIdTokenKindGetValidateBeforeCall(String clientId, String kind, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'clientId' is set
        if (clientId == null) {
            throw new ApiException("Missing the required parameter 'clientId' when calling clientClientIdTokenKindGet(Async)");
        }

        // verify the required parameter 'kind' is set
        if (kind == null) {
            throw new ApiException("Missing the required parameter 'kind' when calling clientClientIdTokenKindGet(Async)");
        }

        return clientClientIdTokenKindGetCall(clientId, kind, _callback);
     ...
     */
    public void clientClientIdTokenKindGet(String clientId, String kind) throws ApiException {
        clientClientIdTokenKindGetWithHttpInfo(clientId, kind);
    }
     ...
     */
    public ApiResponse<Void> clientClientIdTokenKindGetWithHttpInfo(String clientId, String kind) throws ApiException {
        okhttp3.Call localVarCall = clientClientIdTokenKindGetValidateBeforeCall(clientId, kind, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get a Client Token (asynchronously)
     * It is used to generate a OpenID Connect token as a path parameter to a client of a given client ID.  It is primarily used for testing purposes, when, for example, the token from the standard authentication flow is not available to the test code.
     * @param clientId A client ID or email. (required)
     * @param kind Token type (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call clientClientIdTokenKindGetAsync(String clientId, String kind, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = clientClientIdTokenKindGetValidateBeforeCall(clientId, kind, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for clientPost
     * @param clientPostRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call clientPostCall(ClientPostRequest clientPostRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = clientPostRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call clientPostValidateBeforeCall(ClientPostRequest clientPostRequest, final ApiCallback _callback) throws ApiException {
        return clientPostCall(clientPostRequest, _callback);
     ...
     */
    public void clientPost(ClientPostRequest clientPostRequest) throws ApiException {
        clientPostWithHttpInfo(clientPostRequest);
    }
     ...
     */
    public ApiResponse<Void> clientPostWithHttpInfo(ClientPostRequest clientPostRequest) throws ApiException {
        okhttp3.Call localVarCall = clientPostValidateBeforeCall(clientPostRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Create a Client Selfie (asynchronously)
     * To create a selfie token from the client data, you need an opaqe string token, which contains the encoded client properties sent in the request. Later, the selfie token can be used as a client ID. In this case, the client data is included in the selfie token, that is, the client properties are taken from the token. By the use of a selfie token, you can use your own client objects in the authentication process.
     * @param clientPostRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call clientPostAsync(ClientPostRequest clientPostRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = clientPostValidateBeforeCall(clientPostRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
