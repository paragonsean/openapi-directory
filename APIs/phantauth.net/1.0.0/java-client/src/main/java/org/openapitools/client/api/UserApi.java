...
import org.openapitools.client.model.UserPostRequest;
import org.openapitools.client.model.UserUsernameGet200Response;
...
public class UserApi {
     ...
     * @param userPostRequest  (optional)
     ...
     */
    public okhttp3.Call userPostCall(UserPostRequest userPostRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = userPostRequest;
    ...
    private okhttp3.Call userPostValidateBeforeCall(UserPostRequest userPostRequest, final ApiCallback _callback) throws ApiException {
        return userPostCall(userPostRequest, _callback);
     ...
     */
    public void userPost(UserPostRequest userPostRequest) throws ApiException {
        userPostWithHttpInfo(userPostRequest);
    }
     ...
     */
    public ApiResponse<Void> userPostWithHttpInfo(UserPostRequest userPostRequest) throws ApiException {
        okhttp3.Call localVarCall = userPostValidateBeforeCall(userPostRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Create a User Selfie (asynchronously)
     * To create a selfie token from the user data, you need an opaqe string token, which contains the encoded user properties sent in the request. Later, the selfie token can be used as a login name. In this case, the user data is included in the selfie token, that is, the user properties are taken from the token. By the use of a selfie token, you can use your own user objects during the authentication process.  Its use, however, is limited by its relatively large size (more than 100 characters), which exceeds the maximum size of the user name in several systems.
     * @param userPostRequest  (optional)
     ...
     */
    public okhttp3.Call userPostAsync(UserPostRequest userPostRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = userPostValidateBeforeCall(userPostRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for userUsernameGet
     * @param username The username or email used for generation purposes. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call userUsernameGetCall(String username, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call userUsernameGetValidateBeforeCall(String username, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'username' is set
        if (username == null) {
            throw new ApiException("Missing the required parameter 'username' when calling userUsernameGet(Async)");
        }

        return userUsernameGetCall(username, _callback);
     ...
     * @param username The username or email used for generation purposes. (required)
     * @return UserUsernameGet200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UserUsernameGet200Response userUsernameGet(String username) throws ApiException {
        ApiResponse<UserUsernameGet200Response> localVarResp = userUsernameGetWithHttpInfo(username);
     ...
     * Use this endpoint to generate a random user. The user is generated in a deterministic way, on the bases of the user name given as a path parameter. In the case of identical user names, the endpoint will generate the same user object. The properties of the generated user object are randomly generated on the basis of the user name. In lack of a user name, all calls generate a different user object to the randomly generated user name.  By providing an email address as the &#x60;username&#x60; parameter, you can customize the user picture by the use of the gravatar associated with the email address.  If the &#x60;username&#x60; parameter contains at least one dot (&#x60;.&#x60;) or space (&#x60; &#x60;) character, the whole name is produced from the parameter, rather than being generated. In this case, these cahracters play the role of separator between the units of the full name (family name, given name).&#x60;  The result is always a user object. If you want to generate multiple users in one single step, you can do it by the use of *Team* generation. The members of a team are users randomly generated from the team name.
     * @param username The username or email used for generation purposes. (required)
     * @return ApiResponse&lt;UserUsernameGet200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<UserUsernameGet200Response> userUsernameGetWithHttpInfo(String username) throws ApiException {
        okhttp3.Call localVarCall = userUsernameGetValidateBeforeCall(username, null);
        Type localVarReturnType = new TypeToken<UserUsernameGet200Response>(){}.getType();
     ...
     */
    public okhttp3.Call userUsernameGetAsync(String username, final ApiCallback<UserUsernameGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = userUsernameGetValidateBeforeCall(username, _callback);
        Type localVarReturnType = new TypeToken<UserUsernameGet200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for userUsernameTokenKindGet
     * @param username A username or email. (required)
     * @param kind Token type (required)
     * @param scope OpenID Connect scope (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call userUsernameTokenKindGetCall(String username, String kind, String scope, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/user/{username}/token/{kind}"
            .replace("{" + "username" + "}", localVarApiClient.escapeString(username.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call userUsernameTokenKindGetValidateBeforeCall(String username, String kind, String scope, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'username' is set
        if (username == null) {
            throw new ApiException("Missing the required parameter 'username' when calling userUsernameTokenKindGet(Async)");
        }

        // verify the required parameter 'kind' is set
        if (kind == null) {
            throw new ApiException("Missing the required parameter 'kind' when calling userUsernameTokenKindGet(Async)");
        }

        return userUsernameTokenKindGetCall(username, kind, scope, _callback);
     ...
     */
    public void userUsernameTokenKindGet(String username, String kind, String scope) throws ApiException {
        userUsernameTokenKindGetWithHttpInfo(username, kind, scope);
    }
     ...
     */
    public ApiResponse<Void> userUsernameTokenKindGetWithHttpInfo(String username, String kind, String scope) throws ApiException {
        okhttp3.Call localVarCall = userUsernameTokenKindGetValidateBeforeCall(username, kind, scope, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get a User Token (asynchronously)
     * It is used to generate OpenID Connect tokens as path parameters to a user of a given name.  This method is mainly used in the testing process, when, for example, the token received from the normal authenticaton flow is not available to the test code. Generating an access token, for example, will let you avoid authentication, and immediately call an operation requiring the access token.
     * @param username A username or email. (required)
     * @param kind Token type (required)
     * @param scope OpenID Connect scope (optional)
     ...
     */
    public okhttp3.Call userUsernameTokenKindGetAsync(String username, String kind, String scope, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = userUsernameTokenKindGetValidateBeforeCall(username, kind, scope, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
