...
------------ | ------------- | ------------- | -------------
**id** | **String** | The URL of the tenant&#39;s JSON representation. | [optional] 
...
**depots** | **[Object]** | A list of resource types supported by the external CSV set in &#x60;depot&#x60;. | [optional] 
**domain** | **Boolean** | True in the case of a domain tenant collecting several tenants, otherwise false. | [optional] 
**factories** | **[Object]** | A list of resource types supported by the external generator set in &#x60;factory&#x60;. | [optional] 
