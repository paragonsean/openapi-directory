...
PhantAuth - JavaScript client for phant_auth
...
To use the link you just defined in your project, switch to the directory you want to use your phant_auth from, and run:
...
```javascript
var PhantAuth = require('phant_auth');


var api = new PhantAuth.ClientApi()
var clientId = "clientId_example"; // {String} A client ID or email.
...
api.clientClientIdGet(clientId, callback);
...
------------ | ------------- | ------------- | -------------
*PhantAuth.ClientApi* | [**clientClientIdGet**](docs/ClientApi.md#clientClientIdGet) | **GET** /client/{client_id} | Get a Client
*PhantAuth.ClientApi* | [**clientClientIdTokenKindGet**](docs/ClientApi.md#clientClientIdTokenKindGet) | **GET** /client/{client_id}/token/{kind} | Get a Client Token
*PhantAuth.ClientApi* | [**clientPost**](docs/ClientApi.md#clientPost) | **POST** /client | Create a Client Selfie
*PhantAuth.DomainApi* | [**domainDomainnameGet**](docs/DomainApi.md#domainDomainnameGet) | **GET** /domain/{domainname} | Get a Domain
*PhantAuth.FleetApi* | [**fleetFleetnameGet**](docs/FleetApi.md#fleetFleetnameGet) | **GET** /fleet/{fleetname} | Get a Fleet
*PhantAuth.TeamApi* | [**teamTeamnameGet**](docs/TeamApi.md#teamTeamnameGet) | **GET** /team/{teamname} | Get a Team
*PhantAuth.TenantApi* | [**tenantTenantnameGet**](docs/TenantApi.md#tenantTenantnameGet) | **GET** /tenant/{tenantname} | Get a Tenant
*PhantAuth.UserApi* | [**userPost**](docs/UserApi.md#userPost) | **POST** /user | Create a User Selfie
*PhantAuth.UserApi* | [**userUsernameGet**](docs/UserApi.md#userUsernameGet) | **GET** /user/{username} | Get a User
*PhantAuth.UserApi* | [**userUsernameTokenKindGet**](docs/UserApi.md#userUsernameTokenKindGet) | **GET** /user/{username}/token/{kind} | Get a User Token


## Documentation for Models

 - [PhantAuth.Address](docs/Address.md)
 - [PhantAuth.Client](docs/Client.md)
 - [PhantAuth.ClientClientIdGet200Response](docs/ClientClientIdGet200Response.md)
 - [PhantAuth.ClientPostRequest](docs/ClientPostRequest.md)
 - [PhantAuth.Domain](docs/Domain.md)
 - [PhantAuth.DomainDomainnameGet200Response](docs/DomainDomainnameGet200Response.md)
 - [PhantAuth.Fleet](docs/Fleet.md)
 - [PhantAuth.FleetFleetnameGet200Response](docs/FleetFleetnameGet200Response.md)
 - [PhantAuth.Team](docs/Team.md)
 - [PhantAuth.TeamTeamnameGet200Response](docs/TeamTeamnameGet200Response.md)
 - [PhantAuth.Tenant](docs/Tenant.md)
 - [PhantAuth.TenantTenantnameGet200Response](docs/TenantTenantnameGet200Response.md)
 - [PhantAuth.User](docs/User.md)
 - [PhantAuth.UserPostRequest](docs/UserPostRequest.md)
 - [PhantAuth.UserPostRequestAddress](docs/UserPostRequestAddress.md)
 - [PhantAuth.UserUsernameGet200Response](docs/UserUsernameGet200Response.md)
