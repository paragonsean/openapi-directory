...
/**
 * The UserUsernameGet200Response model module.
 * @module model/UserUsernameGet200Response
 * @version 1.0.0
 */
class UserUsernameGet200Response {
    /**
     * Constructs a new <code>UserUsernameGet200Response</code>.
     * @alias module:model/UserUsernameGet200Response
     * @param sub {String} Subject - User identifier at the issuer.
     */
    constructor(sub) { 
        
        UserUsernameGet200Response.initialize(this, sub);
    }
    ...
    /**
     * Constructs a <code>UserUsernameGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserUsernameGet200Response} obj Optional instance to populate.
     * @return {module:model/UserUsernameGet200Response} The populated <code>UserUsernameGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserUsernameGet200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>UserUsernameGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserUsernameGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserUsernameGet200Response.RequiredProperties) {
...
UserUsernameGet200Response.RequiredProperties = ["sub"];

/**
 * The URL of the user's JSON representation.
 * @member {String} @id
 */
UserUsernameGet200Response.prototype['@id'] = undefined;

/**
 * @member {module:model/UserPostRequestAddress} address
 */
UserUsernameGet200Response.prototype['address'] = undefined;

/**
 * The user's birthday, represented as an ISO 8601:2004 [ISO8601‑2004] YYYY-MM-DD format.
 * @member {String} birthdate
 */
UserUsernameGet200Response.prototype['birthdate'] = undefined;

/**
 * The user's preferred email address.
 * @member {String} email
 */
UserUsernameGet200Response.prototype['email'] = undefined;

/**
 * True if the user's e-mail address has been verified; otherwise false.
 * @member {Boolean} email_verified
 */
UserUsernameGet200Response.prototype['email_verified'] = undefined;

/**
 * The user's surname(s) or last name(s).
 * @member {String} family_name
 */
UserUsernameGet200Response.prototype['family_name'] = undefined;

/**
 * The enduser's gender. Possible values are: female, male, and unknown.
 * @member {String} gender
 */
UserUsernameGet200Response.prototype['gender'] = undefined;

/**
 * The user's given name(s) or first name(s).
 * @member {String} given_name
 */
UserUsernameGet200Response.prototype['given_name'] = undefined;
 ...
 */
UserUsernameGet200Response.prototype['locale'] = undefined;

/**
 * The simplified URL of the user's profile page.
 * @member {String} me
 */
UserUsernameGet200Response.prototype['me'] = undefined;

/**
 * The user's middle name(s).
 * @member {String} middle_name
 */
UserUsernameGet200Response.prototype['middle_name'] = undefined;
 ...
 * @member {String} name
 */
UserUsernameGet200Response.prototype['name'] = undefined;

/**
 * A casual name of the User that may or may not be the same as the given_name.
 * @member {String} nickname
 */
UserUsernameGet200Response.prototype['nickname'] = undefined;

/**
 * The user's generated password.
 * @member {String} password
 */
UserUsernameGet200Response.prototype['password'] = undefined;

/**
 * The user's preferred telephone number.
 * @member {String} phone_number
 */
UserUsernameGet200Response.prototype['phone_number'] = undefined;

/**
 * True if the enduser's phone number has been verified; otherwise false.
 * @member {Boolean} phone_number_verified
 */
UserUsernameGet200Response.prototype['phone_number_verified'] = undefined;

/**
 * The URL of the user's profile picture.
 * @member {String} picture
 */
UserUsernameGet200Response.prototype['picture'] = undefined;

/**
 * A shorthand name by which the user wishes to be referred to at the Relying Party.
 * @member {String} preferred_username
 */
UserUsernameGet200Response.prototype['preferred_username'] = undefined;

/**
 * The URL of the user's profile page.
 * @member {String} profile
 */
UserUsernameGet200Response.prototype['profile'] = undefined;

/**
 * Subject - User identifier at the issuer.
 * @member {String} sub
 */
UserUsernameGet200Response.prototype['sub'] = undefined;

/**
 * The user's simplified, shortened identifier at the Issuer.
 * @member {String} uid
 */
UserUsernameGet200Response.prototype['uid'] = undefined;
 ...
 */
UserUsernameGet200Response.prototype['updated_at'] = undefined;

/**
 * The URL of user's mailbox in a webmail application.
 * @member {String} webmail
 */
UserUsernameGet200Response.prototype['webmail'] = undefined;

/**
 * The URL of the user's webpage or blog.
 * @member {String} website
 */
UserUsernameGet200Response.prototype['website'] = undefined;
 ...
 */
UserUsernameGet200Response.prototype['zoneinfo'] = undefined;
...
export default UserUsernameGet200Response;
