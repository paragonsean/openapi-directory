...
/**
 * The ClientClientIdGet200Response model module.
 * @module model/ClientClientIdGet200Response
 * @version 1.0.0
 */
class ClientClientIdGet200Response {
    /**
     * Constructs a new <code>ClientClientIdGet200Response</code>.
     * @alias module:model/ClientClientIdGet200Response
     * @param clientId {String} OAuth 2.0 client identifier string.
     */
    constructor(clientId) { 
        
        ClientClientIdGet200Response.initialize(this, clientId);
    }
    ...
    /**
     * Constructs a <code>ClientClientIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClientClientIdGet200Response} obj Optional instance to populate.
     * @return {module:model/ClientClientIdGet200Response} The populated <code>ClientClientIdGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientClientIdGet200Response();
            ...
            if (data.hasOwnProperty('grant_types')) {
                obj['grant_types'] = ApiClient.convertToType(data['grant_types'], [Object]);
            }
            if (data.hasOwnProperty('jwks')) {
                obj['jwks'] = ApiClient.convertToType(data['jwks'], [Object]);
            }
            if (data.hasOwnProperty('jwks_uri')) {
                obj['jwks_uri'] = ApiClient.convertToType(data['jwks_uri'], 'String');
            }
            if (data.hasOwnProperty('logo_email')) {
                obj['logo_email'] = ApiClient.convertToType(data['logo_email'], 'String');
            }
            ...
            if (data.hasOwnProperty('redirect_uris')) {
                obj['redirect_uris'] = ApiClient.convertToType(data['redirect_uris'], [Object]);
            }
            if (data.hasOwnProperty('response_types')) {
                obj['response_types'] = ApiClient.convertToType(data['response_types'], [Object]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ClientClientIdGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientClientIdGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ClientClientIdGet200Response.RequiredProperties) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['jwks'])) {
            throw new Error("Expected the field `jwks` to be an array in the JSON data but got " + data['jwks']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['logo_email'] && !(typeof data['logo_email'] === 'string' || data['logo_email'] instanceof String)) {
            throw new Error("Expected the field `logo_email` to be a primitive type in the JSON string but got " + data['logo_email']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['software_id'] && !(typeof data['software_id'] === 'string' || data['software_id'] instanceof String)) {
            throw new Error("Expected the field `software_id` to be a primitive type in the JSON string but got " + data['software_id']);
        }
        // ensure the json data is a string
        if (data['software_version'] && !(typeof data['software_version'] === 'string' || data['software_version'] instanceof String)) {
            throw new Error("Expected the field `software_version` to be a primitive type in the JSON string but got " + data['software_version']);
        }
        // ensure the json data is a string
        if (data['token_endpoint_auth_method'] && !(typeof data['token_endpoint_auth_method'] === 'string' || data['token_endpoint_auth_method'] instanceof String)) {
            throw new Error("Expected the field `token_endpoint_auth_method` to be a primitive type in the JSON string but got " + data['token_endpoint_auth_method']);
        }
        // ensure the json data is a string
...
ClientClientIdGet200Response.RequiredProperties = ["client_id"];

/**
 * URL of the Client's JSON representation.
 * @member {String} @id
 */
ClientClientIdGet200Response.prototype['@id'] = undefined;

/**
 * OAuth 2.0 client identifier string.
 * @member {String} client_id
 */
ClientClientIdGet200Response.prototype['client_id'] = undefined;

/**
 * Human-readable string name of the client to be presented to the end-user during authorization.
 * @member {String} client_name
 */
ClientClientIdGet200Response.prototype['client_name'] = undefined;

/**
 * OAuth 2.0 client secret string. 
 * @member {String} client_secret
 */
ClientClientIdGet200Response.prototype['client_secret'] = undefined;

/**
 * URL string of a web page providing information about the client.
 * @member {String} client_uri
 */
ClientClientIdGet200Response.prototype['client_uri'] = undefined;

/**
 * Array of strings representing ways to contact people responsible for this client, typically email addresses.
 * @member {Array.<Object>} contacts
 */
ClientClientIdGet200Response.prototype['contacts'] = undefined;

/**
 * Array of OAuth 2.0 grant type strings that the client can use at the token endpoint.
 * @member {Array.<Object>} grant_types
 */
ClientClientIdGet200Response.prototype['grant_types'] = undefined;
 ...
 * @member {Array.<Object>} jwks
 */
ClientClientIdGet200Response.prototype['jwks'] = undefined;
 ...
 */
ClientClientIdGet200Response.prototype['jwks_uri'] = undefined;

/**
 * An email address used to generate a gravatar.com logo_uri.
 * @member {String} logo_email
 */
ClientClientIdGet200Response.prototype['logo_email'] = undefined;

/**
 * URL string that references a logo for the client.
 * @member {String} logo_uri
 */
ClientClientIdGet200Response.prototype['logo_uri'] = undefined;
 ...
 */
ClientClientIdGet200Response.prototype['policy_uri'] = undefined;

/**
 * Array of redirection URI strings for use in redirect-based flows such as the authorization code and implicit flows.
 * @member {Array.<Object>} redirect_uris
 */
ClientClientIdGet200Response.prototype['redirect_uris'] = undefined;

/**
 * Array of the OAuth 2.0 response type strings that the client can use at the authorization endpoint.
 * @member {Array.<Object>} response_types
 */
ClientClientIdGet200Response.prototype['response_types'] = undefined;
 ...
 * @member {String} scope
 */
ClientClientIdGet200Response.prototype['scope'] = undefined;
 ...
 */
ClientClientIdGet200Response.prototype['software_id'] = undefined;

/**
 * A version identifier string for the client software identified by software_id.
 * @member {String} software_version
 */
ClientClientIdGet200Response.prototype['software_version'] = undefined;

/**
 * String indicator of the requested authentication method for the token endpoint.
 * @member {String} token_endpoint_auth_method
 */
ClientClientIdGet200Response.prototype['token_endpoint_auth_method'] = undefined;
 ...
 */
ClientClientIdGet200Response.prototype['tos_uri'] = undefined;
...
export default ClientClientIdGet200Response;
