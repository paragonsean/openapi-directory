...
/**
 * The ClientPostRequest model module.
 * @module model/ClientPostRequest
 * @version 1.0.0
 */
class ClientPostRequest {
    /**
     * Constructs a new <code>ClientPostRequest</code>.
     * @alias module:model/ClientPostRequest
     * @param clientId {String} OAuth 2.0 client identifier string.
     */
    constructor(clientId) { 
        
        ClientPostRequest.initialize(this, clientId);
    }
    ...
    /**
     * Constructs a <code>ClientPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClientPostRequest} obj Optional instance to populate.
     * @return {module:model/ClientPostRequest} The populated <code>ClientPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ClientPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ClientPostRequest.RequiredProperties) {
...
ClientPostRequest.RequiredProperties = ["client_id"];

/**
 * URL of the Client's JSON representation.
 * @member {String} @id
 */
ClientPostRequest.prototype['@id'] = undefined;

/**
 * OAuth 2.0 client identifier string.
 * @member {String} client_id
 */
ClientPostRequest.prototype['client_id'] = undefined;

/**
 * Human-readable string name of the client to be presented to the end-user during authorization.
 * @member {String} client_name
 */
ClientPostRequest.prototype['client_name'] = undefined;

/**
 * OAuth 2.0 client secret string. 
 * @member {String} client_secret
 */
ClientPostRequest.prototype['client_secret'] = undefined;

/**
 * URL string of a web page providing information about the client.
 * @member {String} client_uri
 */
ClientPostRequest.prototype['client_uri'] = undefined;

/**
 * Array of strings representing ways to contact people responsible for this client, typically email addresses.
 * @member {Array.<Object>} contacts
 */
ClientPostRequest.prototype['contacts'] = undefined;

/**
 * Array of OAuth 2.0 grant type strings that the client can use at the token endpoint.
 * @member {Array.<Object>} grant_types
 */
ClientPostRequest.prototype['grant_types'] = undefined;
 ...
 */
ClientPostRequest.prototype['jwks'] = undefined;
 ...
 */
ClientPostRequest.prototype['jwks_uri'] = undefined;

/**
 * An email address used to generate a gravatar.com logo_uri.
 * @member {String} logo_email
 */
ClientPostRequest.prototype['logo_email'] = undefined;

/**
 * URL string that references a logo for the client.
 * @member {String} logo_uri
 */
ClientPostRequest.prototype['logo_uri'] = undefined;
 ...
 */
ClientPostRequest.prototype['policy_uri'] = undefined;
 ...
 */
ClientPostRequest.prototype['redirect_uris'] = undefined;

/**
 * Array of the OAuth 2.0 response type strings that the client can use at the authorization endpoint.
 * @member {Array.<Object>} response_types
 */
ClientPostRequest.prototype['response_types'] = undefined;
 ...
 * @member {String} scope
 */
ClientPostRequest.prototype['scope'] = undefined;
 ...
 */
ClientPostRequest.prototype['software_id'] = undefined;

/**
 * A version identifier string for the client software identified by software_id.
 * @member {String} software_version
 */
ClientPostRequest.prototype['software_version'] = undefined;

/**
 * String indicator of the requested authentication method for the token endpoint.
 * @member {String} token_endpoint_auth_method
 */
ClientPostRequest.prototype['token_endpoint_auth_method'] = undefined;
 ...
 */
ClientPostRequest.prototype['tos_uri'] = undefined;
