...
import UserPostRequestAddress from './UserPostRequestAddress';
...
class UserPostRequest {
     ...
     * @param sub {String} Subject - User identifier at the issuer.
     */
    constructor(sub) { 
        
        UserPostRequest.initialize(this, sub);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('address')) {
                obj['address'] = UserPostRequestAddress.constructFromObject(data['address']);
            }
            ...
            if (data.hasOwnProperty('webmail')) {
                obj['webmail'] = ApiClient.convertToType(data['webmail'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of UserPostRequest.RequiredProperties) {
        ...
        if (data['address']) { // data not null
          UserPostRequestAddress.validateJSON(data['address']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['webmail'] && !(typeof data['webmail'] === 'string' || data['webmail'] instanceof String)) {
            throw new Error("Expected the field `webmail` to be a primitive type in the JSON string but got " + data['webmail']);
        }
        // ensure the json data is a string
...
UserPostRequest.RequiredProperties = ["sub"];

/**
 * The URL of the user's JSON representation.
 * @member {String} @id
 */
UserPostRequest.prototype['@id'] = undefined;

/**
 * @member {module:model/UserPostRequestAddress} address
 */
UserPostRequest.prototype['address'] = undefined;

/**
 * The user's birthday, represented as an ISO 8601:2004 [ISO8601‑2004] YYYY-MM-DD format.
 * @member {String} birthdate
 */
UserPostRequest.prototype['birthdate'] = undefined;
 ...
 */
UserPostRequest.prototype['email_verified'] = undefined;

/**
 * The user's surname(s) or last name(s).
 * @member {String} family_name
 */
UserPostRequest.prototype['family_name'] = undefined;
 ...
 */
UserPostRequest.prototype['given_name'] = undefined;
 ...
 */
UserPostRequest.prototype['locale'] = undefined;

/**
 * The simplified URL of the user's profile page.
 * @member {String} me
 */
UserPostRequest.prototype['me'] = undefined;

/**
 * The user's middle name(s).
 * @member {String} middle_name
 */
UserPostRequest.prototype['middle_name'] = undefined;
 ...
 * @member {String} name
 */
UserPostRequest.prototype['name'] = undefined;

/**
 * A casual name of the User that may or may not be the same as the given_name.
 * @member {String} nickname
 */
UserPostRequest.prototype['nickname'] = undefined;
 ...
 */
UserPostRequest.prototype['updated_at'] = undefined;

/**
 * The URL of user's mailbox in a webmail application.
 * @member {String} webmail
 */
UserPostRequest.prototype['webmail'] = undefined;

/**
 * The URL of the user's webpage or blog.
 * @member {String} website
 */
UserPostRequest.prototype['website'] = undefined;
 ...
 */
UserPostRequest.prototype['zoneinfo'] = undefined;
