...
/**
 * The TenantTenantnameGet200Response model module.
 * @module model/TenantTenantnameGet200Response
 * @version 1.0.0
 */
class TenantTenantnameGet200Response {
    /**
     * Constructs a new <code>TenantTenantnameGet200Response</code>.
     * @alias module:model/TenantTenantnameGet200Response
     * @param issuer {String} The URL of the tenant OpenID Connect issuer. This value allows you to get, for example, the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata). As a webpage, it contains information on the use if the given tenant.
     * @param sub {String} The fully qualified DNS domain name of the tenant. In the case of official and shared tenants (phantauth.net and phantauth.cf DNS domain), the DNS domain can be omitted (e.g. *default* or *faker*).
     */
    constructor(issuer, sub) { 
        
        TenantTenantnameGet200Response.initialize(this, issuer, sub);
    }
     ...
     */
    static initialize(obj, issuer, sub) { 
        obj['issuer'] = issuer;
        obj['sub'] = sub;
    }

    /**
     * Constructs a <code>TenantTenantnameGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TenantTenantnameGet200Response} obj Optional instance to populate.
     * @return {module:model/TenantTenantnameGet200Response} The populated <code>TenantTenantnameGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TenantTenantnameGet200Response();
            ...
            if (data.hasOwnProperty('depot')) {
                obj['depot'] = ApiClient.convertToType(data['depot'], 'String');
            }
            if (data.hasOwnProperty('depots')) {
                obj['depots'] = ApiClient.convertToType(data['depots'], [Object]);
            }
            if (data.hasOwnProperty('domain')) {
                obj['domain'] = ApiClient.convertToType(data['domain'], 'Boolean');
            }
            if (data.hasOwnProperty('factories')) {
                obj['factories'] = ApiClient.convertToType(data['factories'], [Object]);
            }
            ...
            if (data.hasOwnProperty('sheet')) {
                obj['sheet'] = ApiClient.convertToType(data['sheet'], 'String');
            }
            if (data.hasOwnProperty('sub')) {
                obj['sub'] = ApiClient.convertToType(data['sub'], 'String');
            }
            if (data.hasOwnProperty('subtenant')) {
                obj['subtenant'] = ApiClient.convertToType(data['subtenant'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TenantTenantnameGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TenantTenantnameGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TenantTenantnameGet200Response.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['depot'] && !(typeof data['depot'] === 'string' || data['depot'] instanceof String)) {
            throw new Error("Expected the field `depot` to be a primitive type in the JSON string but got " + data['depot']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['depots'])) {
            throw new Error("Expected the field `depots` to be an array in the JSON data but got " + data['depots']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['factories'])) {
            throw new Error("Expected the field `factories` to be an array in the JSON data but got " + data['factories']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['sheet'] && !(typeof data['sheet'] === 'string' || data['sheet'] instanceof String)) {
            throw new Error("Expected the field `sheet` to be a primitive type in the JSON string but got " + data['sheet']);
        }
        // ensure the json data is a string
...
TenantTenantnameGet200Response.RequiredProperties = ["issuer", "sub"];

/**
 * The URL of the tenant's JSON representation.
 * @member {String} @id
 */
TenantTenantnameGet200Response.prototype['@id'] = undefined;
 ...
 * @member {String} about
 */
TenantTenantnameGet200Response.prototype['about'] = undefined;
 ...
 */
TenantTenantnameGet200Response.prototype['attribution'] = undefined;
 ...
 * @member {String} depot
 */
TenantTenantnameGet200Response.prototype['depot'] = undefined;

/**
 * A list of resource types supported by the external CSV set in `depot`.
 * @member {Array.<Object>} depots
 */
TenantTenantnameGet200Response.prototype['depots'] = undefined;

/**
 * True in the case of a domain tenant collecting several tenants, otherwise false.
 * @member {Boolean} domain
 */
TenantTenantnameGet200Response.prototype['domain'] = undefined;

/**
 * A list of resource types supported by the external generator set in `factory`.
 * @member {Array.<Object>} factories
 */
TenantTenantnameGet200Response.prototype['factories'] = undefined;
 ...
 */
TenantTenantnameGet200Response.prototype['factory'] = undefined;
 ...
 */
TenantTenantnameGet200Response.prototype['favicon'] = undefined;
 ...
 */
TenantTenantnameGet200Response.prototype['issuer'] = undefined;
 ...
 * @member {String} logo
 */
TenantTenantnameGet200Response.prototype['logo'] = undefined;
 ...
 * @member {String} sheet
 */
TenantTenantnameGet200Response.prototype['sheet'] = undefined;
 ...
 * @member {String} sub
 */
TenantTenantnameGet200Response.prototype['sub'] = undefined;

/**
 * True in the case of a tenant referred to in a domain tenant, otherwise false.
 * @member {Boolean} subtenant
 */
TenantTenantnameGet200Response.prototype['subtenant'] = undefined;
 ...
 */
TenantTenantnameGet200Response.prototype['summary'] = undefined;
 ...
 */
TenantTenantnameGet200Response.prototype['template'] = undefined;
 ...
 * @member {String} theme
 */
TenantTenantnameGet200Response.prototype['theme'] = undefined;

/**
 * @member {String} userinfo
 */
TenantTenantnameGet200Response.prototype['userinfo'] = undefined;
 ...
 */
TenantTenantnameGet200Response.prototype['website'] = undefined;
...
export default TenantTenantnameGet200Response;
