...
class Client {
    ...
    constructor(clientId) { 
        ...
        Client.initialize(this, clientId);
    }
...
Client.RequiredProperties = ["client_id"];
 ...
 * @member {String} scope
 */
Client.prototype['scope'] = undefined;
 ...
 */
Client.prototype['software_id'] = undefined;

/**
 * A version identifier string for the client software identified by software_id.
 * @member {String} software_version
 */
Client.prototype['software_version'] = undefined;

/**
 * String indicator of the requested authentication method for the token endpoint.
 * @member {String} token_endpoint_auth_method
 */
Client.prototype['token_endpoint_auth_method'] = undefined;
