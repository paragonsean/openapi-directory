...
public class ProcessesApi {
     ...
     */
    public okhttp3.Call processesListCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call processesListValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return processesListCall(_callback);
     ...
     */
    public Process processesList() throws ApiException {
        ApiResponse<Process> localVarResp = processesListWithHttpInfo();
     ...
     */
    public ApiResponse<Process> processesListWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = processesListValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call processesListAsync(final ApiCallback<Process> _callback) throws ApiException {

        okhttp3.Call localVarCall = processesListValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<Process>(){}.getType();
