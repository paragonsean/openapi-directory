...
void OAIProjectsApi::projectsCreate(const OAIProjectRequest &oai_project_request) {
    QString fullPath = QString(_serverConfigs["projectsCreate"][_serverIndices.value("projectsCreate")].URL()+"/projects/");
...

    {
        ...
        QByteArray output = oai_project_request.asJson().toUtf8();
...
void OAIProjectsApi::projectsCreateCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIProjectResponse output(QString(worker->response));
    worker->deleteLater();
...
void OAIProjectsApi::projectsList() {
...
void OAIProjectsApi::projectsRead(const QString &project_number) {
    QString fullPath = QString(_serverConfigs["projectsRead"][_serverIndices.value("projectsRead")].URL()+"/projects/{project_number}/");
    ...
    {
        QString project_numberPathParam("{");
        project_numberPathParam.append("project_number").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "project_number", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"project_number"+pathSuffix : pathPrefix;
        fullPath.replace(project_numberPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(project_number)));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
