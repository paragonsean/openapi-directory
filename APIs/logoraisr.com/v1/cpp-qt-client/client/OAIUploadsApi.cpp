...
void OAIUploadsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("uploadsCreate", defaultConf);
    _serverIndices.insert("uploadsCreate", 0);
}
...
void OAIUploadsApi::uploadsCreate(const OAIHttpFileElement &file) {
    QString fullPath = QString(_serverConfigs["uploadsCreate"][_serverIndices.value("uploadsCreate")].URL()+"/uploads/");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUploadsApi::uploadsCreateCallback);
...
void OAIUploadsApi::uploadsCreateCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT uploadsCreateSignal(output);
        Q_EMIT uploadsCreateSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT uploadsCreateSignalE(output, error_type, error_str);
        Q_EMIT uploadsCreateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT uploadsCreateSignalError(output, error_type, error_str);
        Q_EMIT uploadsCreateSignalErrorFull(worker, error_type, error_str);
    }
}
