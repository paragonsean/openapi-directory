...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocsLogoraisrCom.ReportRequest();
  });
  ...
  describe('ReportRequest', function() {
    it('should create an instance of ReportRequest', function() {
      ...
      //var instance = new ApiDocsLogoraisrCom.ReportRequest();
      //expect(instance).to.be.a(ApiDocsLogoraisrCom.ReportRequest);
    });
