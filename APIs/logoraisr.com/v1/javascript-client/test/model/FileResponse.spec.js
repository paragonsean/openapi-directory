...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocsLogoraisrCom.FileResponse();
  });
  ...
  describe('FileResponse', function() {
    it('should create an instance of FileResponse', function() {
      ...
      //var instance = new ApiDocsLogoraisrCom.FileResponse();
      //expect(instance).to.be.a(ApiDocsLogoraisrCom.FileResponse);
    });
