...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocsLogoraisrCom.PreviewsApi();
  });
  ...
  describe('PreviewsApi', function() {
    describe('previewsRead', function() {
      it('should call previewsRead successfully', function(done) {
        //uncomment below and update the code to test previewsRead
        //instance.previewsRead(function(error) {
