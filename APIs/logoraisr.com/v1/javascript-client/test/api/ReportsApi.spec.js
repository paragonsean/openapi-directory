...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocsLogoraisrCom.ReportsApi();
  });
  ...
  describe('ReportsApi', function() {
    ...
    describe('reportsRead', function() {
      it('should call reportsRead successfully', function(done) {
        //uncomment below and update the code to test reportsRead
        //instance.reportsRead(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
