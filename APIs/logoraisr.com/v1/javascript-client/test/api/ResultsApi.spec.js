...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocsLogoraisrCom.ResultsApi();
  });
  ...
  describe('ResultsApi', function() {
    describe('resultsRead', function() {
      it('should call resultsRead successfully', function(done) {
        //uncomment below and update the code to test resultsRead
        //instance.resultsRead(function(error) {
