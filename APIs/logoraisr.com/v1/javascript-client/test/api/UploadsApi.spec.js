...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocsLogoraisrCom.UploadsApi();
  });
  ...
  describe('UploadsApi', function() {
    describe('uploadsCreate', function() {
      it('should call uploadsCreate successfully', function(done) {
        //uncomment below and update the code to test uploadsCreate
        //instance.uploadsCreate(function(error) {
