...
public class User {
  ...
  public User personId(String personId) {
  ...
  public User profile(UserProfileRequest profile) {
  ...
  public User sendInvite(Boolean sendInvite) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, user.email) &&
        ...
        Objects.equals(this.sendInvite, user.sendInvite);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, firstName, lastName, metadata, personId, profile, sendInvite);
  }
