...
OAIUserMetadata OAIUser::getMetadata() const {
    return m_metadata;
}
void OAIUser::setMetadata(const OAIUserMetadata &metadata) {
    m_metadata = metadata;
...
QString OAIUser::getPersonId() const {
    return m_person_id;
}
void OAIUser::setPersonId(const QString &person_id) {
    m_person_id = person_id;
    m_person_id_isSet = true;
}

bool OAIUser::is_person_id_Set() const{
    return m_person_id_isSet;
}

bool OAIUser::is_person_id_Valid() const{
    return m_person_id_isValid;
}

OAIUserProfileRequest OAIUser::getProfile() const {
    return m_profile;
}
void OAIUser::setProfile(const OAIUserProfileRequest &profile) {
    m_profile = profile;
...
bool OAIUser::isSendInvite() const {
    return m_send_invite;
}
void OAIUser::setSendInvite(const bool &send_invite) {
    m_send_invite = send_invite;
    m_send_invite_isSet = true;
}

bool OAIUser::is_send_invite_Set() const{
    return m_send_invite_isSet;
}

bool OAIUser::is_send_invite_Valid() const{
