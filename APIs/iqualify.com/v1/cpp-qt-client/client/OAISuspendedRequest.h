...
/*
 * OAISuspendedRequest.h
 *
 * 
 */

#ifndef OAISuspendedRequest_H
#define OAISuspendedRequest_H
...
class OAISuspendedRequest : public OAIObject {
public:
    OAISuspendedRequest();
    OAISuspendedRequest(QString json);
    ~OAISuspendedRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuspendedRequest)

#endif // OAISuspendedRequest_H
