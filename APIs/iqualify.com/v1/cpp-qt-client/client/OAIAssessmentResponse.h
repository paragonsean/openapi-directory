...
/*
 * OAIAssessmentResponse.h
 *
 * 
 */

#ifndef OAIAssessmentResponse_H
#define OAIAssessmentResponse_H
...
class OAIAssessmentResponse : public OAIObject {
public:
    OAIAssessmentResponse();
    OAIAssessmentResponse(QString json);
    ~OAIAssessmentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssessmentResponse)

#endif // OAIAssessmentResponse_H
