...
/*
 * OAIOfferingRequired.h
 *
 * 
 */

#ifndef OAIOfferingRequired_H
#define OAIOfferingRequired_H
...
class OAIOfferingRequired : public OAIObject {
public:
    OAIOfferingRequired();
    OAIOfferingRequired(QString json);
    ~OAIOfferingRequired() override;
    ...
    bool isCreateDefaultChannels() const;
    void setCreateDefaultChannels(const bool &create_default_channels);
    bool is_create_default_channels_Set() const;
    bool is_create_default_channels_Valid() const;
...
private:
    ...
    bool m_create_default_channels;
    bool m_create_default_channels_isSet;
    bool m_create_default_channels_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferingRequired)

#endif // OAIOfferingRequired_H
