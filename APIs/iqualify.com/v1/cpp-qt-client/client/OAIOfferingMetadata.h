...
/*
 * OAIOfferingMetadata.h
 *
 * 
 */

#ifndef OAIOfferingMetadata_H
#define OAIOfferingMetadata_H
...
class OAIOfferingMetadata : public OAIObject {
public:
    OAIOfferingMetadata();
    OAIOfferingMetadata(QString json);
    ~OAIOfferingMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferingMetadata)

#endif // OAIOfferingMetadata_H
