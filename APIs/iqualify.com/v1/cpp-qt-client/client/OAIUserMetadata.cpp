...
QList<QString> OAIUserMetadata::getTags() const {
    return m_tags;
}
void OAIUserMetadata::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUserMetadata::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUserMetadata::is_tags_Valid() const{
