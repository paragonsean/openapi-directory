...
/*
 * OAIOfferingMetadataResponse.h
 *
 * 
 */

#ifndef OAIOfferingMetadataResponse_H
#define OAIOfferingMetadataResponse_H
...
namespace OpenAPI {
class OAIOfferingMetadata;

class OAIOfferingMetadataResponse : public OAIObject {
public:
    OAIOfferingMetadataResponse();
    OAIOfferingMetadataResponse(QString json);
    ~OAIOfferingMetadataResponse() override;
    ...
    OAIOfferingMetadata getMetadata() const;
    void setMetadata(const OAIOfferingMetadata &metadata);
...
private:
    ...
    OAIOfferingMetadata m_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferingMetadataResponse)

#endif // OAIOfferingMetadataResponse_H
