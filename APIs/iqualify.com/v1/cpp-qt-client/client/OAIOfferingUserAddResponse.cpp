...
OAIOfferingUserAddResponse::OAIOfferingUserAddResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOfferingUserAddResponse::OAIOfferingUserAddResponse() {
    this->initializeModel();
}

OAIOfferingUserAddResponse::~OAIOfferingUserAddResponse() {}

void OAIOfferingUserAddResponse::initializeModel() {
...
void OAIOfferingUserAddResponse::fromJson(QString jsonString) {
...
void OAIOfferingUserAddResponse::fromJsonObject(QJsonObject json) {
...
QString OAIOfferingUserAddResponse::asJson() const {
...
QJsonObject OAIOfferingUserAddResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_email_isSet) {
...
QString OAIOfferingUserAddResponse::getEmail() const {
    return m_email;
}
void OAIOfferingUserAddResponse::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIOfferingUserAddResponse::is_email_Set() const{
    return m_email_isSet;
}

bool OAIOfferingUserAddResponse::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIOfferingUserAddResponse::getFirstName() const {
    return m_first_name;
}
void OAIOfferingUserAddResponse::setFirstName(const QString &first_name) {
    m_first_name = first_name;
    m_first_name_isSet = true;
}

bool OAIOfferingUserAddResponse::is_first_name_Set() const{
    return m_first_name_isSet;
}

bool OAIOfferingUserAddResponse::is_first_name_Valid() const{
    return m_first_name_isValid;
}

OAIInvite OAIOfferingUserAddResponse::getInvite() const {
    return m_invite;
}
void OAIOfferingUserAddResponse::setInvite(const OAIInvite &invite) {
    m_invite = invite;
    m_invite_isSet = true;
}

bool OAIOfferingUserAddResponse::is_invite_Set() const{
    return m_invite_isSet;
}

bool OAIOfferingUserAddResponse::is_invite_Valid() const{
    return m_invite_isValid;
}

bool OAIOfferingUserAddResponse::isIsFacilitator() const {
    return m_is_facilitator;
}
void OAIOfferingUserAddResponse::setIsFacilitator(const bool &is_facilitator) {
    m_is_facilitator = is_facilitator;
    m_is_facilitator_isSet = true;
}

bool OAIOfferingUserAddResponse::is_is_facilitator_Set() const{
    return m_is_facilitator_isSet;
}

bool OAIOfferingUserAddResponse::is_is_facilitator_Valid() const{
    return m_is_facilitator_isValid;
}

bool OAIOfferingUserAddResponse::isIsMarker() const {
    return m_is_marker;
}
void OAIOfferingUserAddResponse::setIsMarker(const bool &is_marker) {
    m_is_marker = is_marker;
    m_is_marker_isSet = true;
}

bool OAIOfferingUserAddResponse::is_is_marker_Set() const{
    return m_is_marker_isSet;
}

bool OAIOfferingUserAddResponse::is_is_marker_Valid() const{
    return m_is_marker_isValid;
}

bool OAIOfferingUserAddResponse::isIsReadonly() const {
    return m_is_readonly;
}
void OAIOfferingUserAddResponse::setIsReadonly(const bool &is_readonly) {
    m_is_readonly = is_readonly;
    m_is_readonly_isSet = true;
}

bool OAIOfferingUserAddResponse::is_is_readonly_Set() const{
    return m_is_readonly_isSet;
}

bool OAIOfferingUserAddResponse::is_is_readonly_Valid() const{
    return m_is_readonly_isValid;
}

QString OAIOfferingUserAddResponse::getLastName() const {
    return m_last_name;
}
void OAIOfferingUserAddResponse::setLastName(const QString &last_name) {
    m_last_name = last_name;
    m_last_name_isSet = true;
}

bool OAIOfferingUserAddResponse::is_last_name_Set() const{
    return m_last_name_isSet;
}

bool OAIOfferingUserAddResponse::is_last_name_Valid() const{
    return m_last_name_isValid;
}

OAIUserMetadata OAIOfferingUserAddResponse::getMetadata() const {
    return m_metadata;
}
void OAIOfferingUserAddResponse::setMetadata(const OAIUserMetadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIOfferingUserAddResponse::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIOfferingUserAddResponse::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QString OAIOfferingUserAddResponse::getPersonId() const {
    return m_person_id;
}
void OAIOfferingUserAddResponse::setPersonId(const QString &person_id) {
    m_person_id = person_id;
    m_person_id_isSet = true;
}

bool OAIOfferingUserAddResponse::is_person_id_Set() const{
    return m_person_id_isSet;
}

bool OAIOfferingUserAddResponse::is_person_id_Valid() const{
    return m_person_id_isValid;
}

OAIUserProfileRequest OAIOfferingUserAddResponse::getProfile() const {
    return m_profile;
}
void OAIOfferingUserAddResponse::setProfile(const OAIUserProfileRequest &profile) {
    m_profile = profile;
    m_profile_isSet = true;
}

bool OAIOfferingUserAddResponse::is_profile_Set() const{
    return m_profile_isSet;
}

bool OAIOfferingUserAddResponse::is_profile_Valid() const{
    return m_profile_isValid;
}

bool OAIOfferingUserAddResponse::isSendInvite() const {
    return m_send_invite;
}
void OAIOfferingUserAddResponse::setSendInvite(const bool &send_invite) {
    m_send_invite = send_invite;
    m_send_invite_isSet = true;
}

bool OAIOfferingUserAddResponse::is_send_invite_Set() const{
    return m_send_invite_isSet;
}

bool OAIOfferingUserAddResponse::is_send_invite_Valid() const{
    return m_send_invite_isValid;
}

bool OAIOfferingUserAddResponse::isSendNotificationEmail() const {
    return m_send_notification_email;
}
void OAIOfferingUserAddResponse::setSendNotificationEmail(const bool &send_notification_email) {
    m_send_notification_email = send_notification_email;
    m_send_notification_email_isSet = true;
}

bool OAIOfferingUserAddResponse::is_send_notification_email_Set() const{
    return m_send_notification_email_isSet;
}

bool OAIOfferingUserAddResponse::is_send_notification_email_Valid() const{
    return m_send_notification_email_isValid;
}

bool OAIOfferingUserAddResponse::isSet() const {
...
bool OAIOfferingUserAddResponse::isValid() const {
