...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.Moderation();
  });
  ...
  describe('Moderation', function() {
    it('should create an instance of Moderation', function() {
      // uncomment below and update the code to test Moderation
      //var instance = new IQualifyManagementApi.Moderation();
      //expect(instance).to.be.a(IQualifyManagementApi.Moderation);
    });
