...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.LearnerProgressResponse();
  });
  ...
  describe('LearnerProgressResponse', function() {
    it('should create an instance of LearnerProgressResponse', function() {
      // uncomment below and update the code to test LearnerProgressResponse
      //var instance = new IQualifyManagementApi.LearnerProgressResponse();
      //expect(instance).to.be.a(IQualifyManagementApi.LearnerProgressResponse);
    });
    ...
    it('should have the property lastLoggedInAt (base name: "lastLoggedInAt")', function() {
