...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.Moderator();
  });
  ...
  describe('Moderator', function() {
    it('should create an instance of Moderator', function() {
      // uncomment below and update the code to test Moderator
      //var instance = new IQualifyManagementApi.Moderator();
      //expect(instance).to.be.a(IQualifyManagementApi.Moderator);
    });
