...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.ChannelResponse();
  });
  ...
  describe('ChannelResponse', function() {
    it('should create an instance of ChannelResponse', function() {
      ...
      //var instance = new IQualifyManagementApi.ChannelResponse();
      //expect(instance).to.be.a(IQualifyManagementApi.ChannelResponse);
    });
