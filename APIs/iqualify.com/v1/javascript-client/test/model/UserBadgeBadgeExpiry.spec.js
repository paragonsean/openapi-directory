...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.UserBadgeBadgeExpiry();
  });
  ...
  describe('UserBadgeBadgeExpiry', function() {
    it('should create an instance of UserBadgeBadgeExpiry', function() {
      // uncomment below and update the code to test UserBadgeBadgeExpiry
      //var instance = new IQualifyManagementApi.UserBadgeBadgeExpiry();
      //expect(instance).to.be.a(IQualifyManagementApi.UserBadgeBadgeExpiry);
    });
