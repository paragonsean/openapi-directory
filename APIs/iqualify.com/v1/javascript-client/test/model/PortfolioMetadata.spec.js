...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.PortfolioMetadata();
  });
  ...
  describe('PortfolioMetadata', function() {
    it('should create an instance of PortfolioMetadata', function() {
      ...
      //var instance = new IQualifyManagementApi.PortfolioMetadata();
      //expect(instance).to.be.a(IQualifyManagementApi.PortfolioMetadata);
    });
