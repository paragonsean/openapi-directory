...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.UserProfile();
  });
  ...
  describe('UserProfile', function() {
    it('should create an instance of UserProfile', function() {
      ...
      //var instance = new IQualifyManagementApi.UserProfile();
      //expect(instance).to.be.a(IQualifyManagementApi.UserProfile);
    });
