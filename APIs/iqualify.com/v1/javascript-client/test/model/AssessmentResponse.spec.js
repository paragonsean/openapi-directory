...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.AssessmentResponse();
  });
  ...
  describe('AssessmentResponse', function() {
    it('should create an instance of AssessmentResponse', function() {
      // uncomment below and update the code to test AssessmentResponse
      //var instance = new IQualifyManagementApi.AssessmentResponse();
      //expect(instance).to.be.a(IQualifyManagementApi.AssessmentResponse);
    });
