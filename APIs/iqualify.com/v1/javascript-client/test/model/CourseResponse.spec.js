...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.CourseResponse();
  });
  ...
  describe('CourseResponse', function() {
    it('should create an instance of CourseResponse', function() {
      // uncomment below and update the code to test CourseResponse
      //var instance = new IQualifyManagementApi.CourseResponse();
      //expect(instance).to.be.a(IQualifyManagementApi.CourseResponse);
    });
