...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.OfferingUserAddResponse();
  });
  ...
  describe('OfferingUserAddResponse', function() {
    it('should create an instance of OfferingUserAddResponse', function() {
      // uncomment below and update the code to test OfferingUserAddResponse
      //var instance = new IQualifyManagementApi.OfferingUserAddResponse();
      //expect(instance).to.be.a(IQualifyManagementApi.OfferingUserAddResponse);
    });
