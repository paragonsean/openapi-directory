...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.UnitReactionsAnalyticsResponse();
  });
  ...
  describe('UnitReactionsAnalyticsResponse', function() {
    it('should create an instance of UnitReactionsAnalyticsResponse', function() {
      // uncomment below and update the code to test UnitReactionsAnalyticsResponse
      //var instance = new IQualifyManagementApi.UnitReactionsAnalyticsResponse();
      //expect(instance).to.be.a(IQualifyManagementApi.UnitReactionsAnalyticsResponse);
    });
