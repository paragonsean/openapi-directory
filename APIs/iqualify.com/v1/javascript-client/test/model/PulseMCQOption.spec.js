...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.PulseMCQOption();
  });
  ...
  describe('PulseMCQOption', function() {
    it('should create an instance of PulseMCQOption', function() {
      // uncomment below and update the code to test PulseMCQOption
      //var instance = new IQualifyManagementApi.PulseMCQOption();
      //expect(instance).to.be.a(IQualifyManagementApi.PulseMCQOption);
    });
