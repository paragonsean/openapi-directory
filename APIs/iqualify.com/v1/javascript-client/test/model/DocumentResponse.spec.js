...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.DocumentResponse();
  });
  ...
  describe('DocumentResponse', function() {
    it('should create an instance of DocumentResponse', function() {
      ...
      //var instance = new IQualifyManagementApi.DocumentResponse();
      //expect(instance).to.be.a(IQualifyManagementApi.DocumentResponse);
    });
