...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.Assessment();
  });
  ...
  describe('Assessment', function() {
    it('should create an instance of Assessment', function() {
      ...
      //var instance = new IQualifyManagementApi.Assessment();
      //expect(instance).to.be.a(IQualifyManagementApi.Assessment);
    });
