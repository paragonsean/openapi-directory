...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.OpenBadgeClass();
  });
  ...
  describe('OpenBadgeClass', function() {
    it('should create an instance of OpenBadgeClass', function() {
      // uncomment below and update the code to test OpenBadgeClass
      //var instance = new IQualifyManagementApi.OpenBadgeClass();
      //expect(instance).to.be.a(IQualifyManagementApi.OpenBadgeClass);
    });
