...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.OfferingRequired();
  });
  ...
  describe('OfferingRequired', function() {
    it('should create an instance of OfferingRequired', function() {
      // uncomment below and update the code to test OfferingRequired
      //var instance = new IQualifyManagementApi.OfferingRequired();
      //expect(instance).to.be.a(IQualifyManagementApi.OfferingRequired);
    });
    ...
    it('should have the property createDefaultChannels (base name: "createDefaultChannels")', function() {
      // uncomment below and update the code to test the property createDefaultChannels
      //var instance = new IQualifyManagementApi.OfferingRequired();
      //expect(instance).to.be();
    });
