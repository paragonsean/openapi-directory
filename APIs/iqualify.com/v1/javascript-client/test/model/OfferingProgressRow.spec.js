...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.OfferingProgressRow();
  });
  ...
  describe('OfferingProgressRow', function() {
    it('should create an instance of OfferingProgressRow', function() {
      // uncomment below and update the code to test OfferingProgressRow
      //var instance = new IQualifyManagementApi.OfferingProgressRow();
      //expect(instance).to.be.a(IQualifyManagementApi.OfferingProgressRow);
    });
