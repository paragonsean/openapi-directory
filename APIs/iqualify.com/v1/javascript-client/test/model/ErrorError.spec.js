...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.ErrorError();
  });
  ...
  describe('ErrorError', function() {
    it('should create an instance of ErrorError', function() {
      ...
      //var instance = new IQualifyManagementApi.ErrorError();
      //expect(instance).to.be.a(IQualifyManagementApi.ErrorError);
    });
