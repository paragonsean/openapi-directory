...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.LearnerResponse();
  });
  ...
  describe('LearnerResponse', function() {
    it('should create an instance of LearnerResponse', function() {
      // uncomment below and update the code to test LearnerResponse
      //var instance = new IQualifyManagementApi.LearnerResponse();
      //expect(instance).to.be.a(IQualifyManagementApi.LearnerResponse);
    });
