...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.SuspendedRequest();
  });
  ...
  describe('SuspendedRequest', function() {
    it('should create an instance of SuspendedRequest', function() {
      // uncomment below and update the code to test SuspendedRequest
      //var instance = new IQualifyManagementApi.SuspendedRequest();
      //expect(instance).to.be.a(IQualifyManagementApi.SuspendedRequest);
    });
