...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.CourseMetaResponse();
  });
  ...
  describe('CourseMetaResponse', function() {
    it('should create an instance of CourseMetaResponse', function() {
      // uncomment below and update the code to test CourseMetaResponse
      //var instance = new IQualifyManagementApi.CourseMetaResponse();
      //expect(instance).to.be.a(IQualifyManagementApi.CourseMetaResponse);
    });
