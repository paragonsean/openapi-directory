...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IQualifyManagementApi.PulseSpatialOption();
  });
  ...
  describe('PulseSpatialOption', function() {
    it('should create an instance of PulseSpatialOption', function() {
      // uncomment below and update the code to test PulseSpatialOption
      //var instance = new IQualifyManagementApi.PulseSpatialOption();
      //expect(instance).to.be.a(IQualifyManagementApi.PulseSpatialOption);
    });
