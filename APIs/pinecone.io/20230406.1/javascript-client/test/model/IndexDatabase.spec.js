...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PineconeApi.IndexDatabase();
  });
  ...
  describe('IndexDatabase', function() {
    it('should create an instance of IndexDatabase', function() {
      // uncomment below and update the code to test IndexDatabase
      //var instance = new PineconeApi.IndexDatabase();
      //expect(instance).to.be.a(PineconeApi.IndexDatabase);
    });
