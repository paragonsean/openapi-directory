...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PineconeApi.UpsertRequest();
  });
  ...
  describe('UpsertRequest', function() {
    it('should create an instance of UpsertRequest', function() {
      // uncomment below and update the code to test UpsertRequest
      //var instance = new PineconeApi.UpsertRequest();
      //expect(instance).to.be.a(PineconeApi.UpsertRequest);
    });
