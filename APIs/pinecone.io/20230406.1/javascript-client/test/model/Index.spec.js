...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PineconeApi.Index();
  });
  ...
  describe('Index', function() {
    it('should create an instance of Index', function() {
      // uncomment below and update the code to test Index
      //var instance = new PineconeApi.Index();
      //expect(instance).to.be.a(PineconeApi.Index);
    });
