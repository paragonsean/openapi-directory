...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://controller.us-east1-gcp.pinecone.io') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://controller.us-east1-gcp.pinecone.io
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/20230406.1/Javascript'
        };
