...
public class ApiClient {
    ...
    private String basePath = "https://controller.us-east1-gcp.pinecone.io";
    ...
    new ServerConfiguration(
      ...
      new HashMap<String, ServerVariable>() {{
        put("environment", new ServerVariable(
          "The regional deployment to use. Must match API key.",
          "us-east1-gcp",
          new HashSet<String>(
            Arrays.asList(
              "us-west1-gcp",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/20230406.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://controller.us-east1-gcp.pinecone.io
