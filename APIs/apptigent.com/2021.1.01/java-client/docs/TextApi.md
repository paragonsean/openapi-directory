...
public class Example {
  public static void main(String[] args) {
    ...
    TextApi apiInstance = new TextApi(defaultClient);
    DecodeStringRequest stringInput = new DecodeStringRequest(); // DecodeStringRequest | 
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    TextApi apiInstance = new TextApi(defaultClient);
    ShortenLinkRequest stringInput = new ShortenLinkRequest(); // ShortenLinkRequest | 
    try {
...
<a id="speechToText"></a>
# **speechToText**
> OutputString speechToText(_file, language)
...
public class Example {
  public static void main(String[] args) {
    ...
    TextApi apiInstance = new TextApi(defaultClient);
    File _file = new File("/path/to/file"); // File | Source audio file (WAV, MP3, AAC, M4A)
    String language = "Arabic (Bahrain)"; // String | Language of audio input
    try {
      OutputString result = apiInstance.speechToText(_file, language);
      System.out.println(result);
    } catch (ApiException e) {
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **_file** | **File**| Source audio file (WAV, MP3, AAC, M4A) | |
...
public class Example {
  public static void main(String[] args) {
    ...
    TextApi apiInstance = new TextApi(defaultClient);
    UrlDecodeRequest stringInput = new UrlDecodeRequest(); // UrlDecodeRequest | 
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    TextApi apiInstance = new TextApi(defaultClient);
    ValidateEmailRequest stringInput = new ValidateEmailRequest(); // ValidateEmailRequest | 
    try {
