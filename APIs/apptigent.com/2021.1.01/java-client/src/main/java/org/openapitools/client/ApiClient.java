...
public class ApiClient {
    ...
    private String basePath = "https://connect.apptigent.com/api/utilities";
    ...
    public ApiClient() {
        ...
        authentications.put("apiKeyHeader", new ApiKeyAuth("header", "X-IBM-Client-Id"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2021.1.01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://connect.apptigent.com/api/utilities
