...
public class InputDateTimeConversion {
  ...
  public InputDateTimeConversion() {
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.format, inputDateTimeConversion.format) &&
        Objects.equals(this.input, inputDateTimeConversion.input) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(format, input, source, target);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InputDateTimeConversion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InputDateTimeConversion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InputDateTimeConversion is not found in the empty JSON string", InputDateTimeConversion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InputDateTimeConversion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InputDateTimeConversion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InputDateTimeConversion.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InputDateTimeConversion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InputDateTimeConversion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InputDateTimeConversion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InputDateTimeConversion.class));

       return (TypeAdapter<T>) new TypeAdapter<InputDateTimeConversion>() {
           @Override
           public void write(JsonWriter out, InputDateTimeConversion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InputDateTimeConversion read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InputDateTimeConversion given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InputDateTimeConversion
   * @throws IOException if the JSON string is invalid with respect to InputDateTimeConversion
   */
  public static InputDateTimeConversion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InputDateTimeConversion.class);
  }

  /**
   * Convert an instance of InputDateTimeConversion to an JSON string
   *
   * @return JSON string
   */
