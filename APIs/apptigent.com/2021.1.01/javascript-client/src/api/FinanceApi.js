...
export default class FinanceApi {
    ...
    */
     ...
     * @param {module:model/InputCurrencyConversion} [currencyConversion] 
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/InputCurrencyFormat} [currencyFormat] 
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/InputMarketIndex} [marketIndex] 
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/InputStockPrices} [stockPrices] 
