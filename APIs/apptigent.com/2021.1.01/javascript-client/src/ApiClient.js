...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://connect.apptigent.com/api/utilities') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://connect.apptigent.com/api/utilities
         */
        ...
        this.authentications = {
            'apiKeyHeader': {type: 'apiKey', 'in': 'header', name: 'X-IBM-Client-Id'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2021.1.01/Javascript'
        };
