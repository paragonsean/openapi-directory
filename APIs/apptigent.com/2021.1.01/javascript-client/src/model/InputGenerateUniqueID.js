...
class InputGenerateUniqueID {
    ...
    /**
     * Validates the JSON data with respect to <code>InputGenerateUniqueID</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InputGenerateUniqueID</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InputGenerateUniqueID.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['uppercase'] && !(typeof data['uppercase'] === 'string' || data['uppercase'] instanceof String)) {
            throw new Error("Expected the field `uppercase` to be a primitive type in the JSON string but got " + data['uppercase']);
        }
...
InputGenerateUniqueID.RequiredProperties = ["uppercase"];
