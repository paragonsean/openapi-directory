...
class OutputMultiCollection {
    ...
    /**
     * Validates the JSON data with respect to <code>OutputMultiCollection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OutputMultiCollection</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['result1'])) {
            throw new Error("Expected the field `result1` to be an array in the JSON data but got " + data['result1']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['result2'])) {
            throw new Error("Expected the field `result2` to be an array in the JSON data but got " + data['result2']);
        }
