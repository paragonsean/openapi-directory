...
let apiInstance = new PowerToolsDeveloper.TextApi();
let opts = {
  'stringInput': new PowerToolsDeveloper.DecodeStringRequest() // DecodeStringRequest | 
};
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **stringInput** | [**DecodeStringRequest**](DecodeStringRequest.md)|  | [optional] 
...
let apiInstance = new PowerToolsDeveloper.TextApi();
let opts = {
  'stringInput': new PowerToolsDeveloper.ShortenLinkRequest() // ShortenLinkRequest | 
};
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **stringInput** | [**ShortenLinkRequest**](ShortenLinkRequest.md)|  | [optional] 
...
> OutputString speechToText(file, language)
...
apiInstance.speechToText(file, language, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new PowerToolsDeveloper.TextApi();
let opts = {
  'stringInput': new PowerToolsDeveloper.UrlDecodeRequest() // UrlDecodeRequest | 
};
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **stringInput** | [**UrlDecodeRequest**](UrlDecodeRequest.md)|  | [optional] 
...
let apiInstance = new PowerToolsDeveloper.TextApi();
let opts = {
  'stringInput': new PowerToolsDeveloper.ValidateEmailRequest() // ValidateEmailRequest | 
};
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **stringInput** | [**ValidateEmailRequest**](ValidateEmailRequest.md)|  | [optional] 
