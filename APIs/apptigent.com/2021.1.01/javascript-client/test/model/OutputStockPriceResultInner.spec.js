...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerToolsDeveloper.OutputStockPriceResultInner();
  });
  ...
  describe('OutputStockPriceResultInner', function() {
    it('should create an instance of OutputStockPriceResultInner', function() {
      // uncomment below and update the code to test OutputStockPriceResultInner
      //var instance = new PowerToolsDeveloper.OutputStockPriceResultInner();
      //expect(instance).to.be.a(PowerToolsDeveloper.OutputStockPriceResultInner);
    });
