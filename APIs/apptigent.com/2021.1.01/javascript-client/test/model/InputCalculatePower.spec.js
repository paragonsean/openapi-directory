...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerToolsDeveloper.InputCalculatePower();
  });
  ...
  describe('InputCalculatePower', function() {
    it('should create an instance of InputCalculatePower', function() {
      // uncomment below and update the code to test InputCalculatePower
      //var instance = new PowerToolsDeveloper.InputCalculatePower();
      //expect(instance).to.be.a(PowerToolsDeveloper.InputCalculatePower);
    });
