...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerToolsDeveloper.InputSplitString();
  });
  ...
  describe('InputSplitString', function() {
    it('should create an instance of InputSplitString', function() {
      // uncomment below and update the code to test InputSplitString
      //var instance = new PowerToolsDeveloper.InputSplitString();
      //expect(instance).to.be.a(PowerToolsDeveloper.InputSplitString);
    });
