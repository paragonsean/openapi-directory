...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerToolsDeveloper.InputJoinStrings();
  });
  ...
  describe('InputJoinStrings', function() {
    it('should create an instance of InputJoinStrings', function() {
      // uncomment below and update the code to test InputJoinStrings
      //var instance = new PowerToolsDeveloper.InputJoinStrings();
      //expect(instance).to.be.a(PowerToolsDeveloper.InputJoinStrings);
    });
