...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerToolsDeveloper.InputVerifyHash();
  });
  ...
  describe('InputVerifyHash', function() {
    it('should create an instance of InputVerifyHash', function() {
      // uncomment below and update the code to test InputVerifyHash
      //var instance = new PowerToolsDeveloper.InputVerifyHash();
      //expect(instance).to.be.a(PowerToolsDeveloper.InputVerifyHash);
    });
