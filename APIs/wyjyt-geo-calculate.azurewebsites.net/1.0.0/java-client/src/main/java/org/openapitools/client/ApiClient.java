...
public class ApiClient {
    ...
    private String basePath = "https://wyjyt-geo-calculate.azurewebsites.net/api";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://wyjyt-geo-calculate.azurewebsites.net/api",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://wyjyt-geo-calculate.azurewebsites.net/api
