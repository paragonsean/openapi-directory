...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WyjytGeoCalculate.GeoConvertRequest();
  });
  ...
  describe('GeoConvertRequest', function() {
    it('should create an instance of GeoConvertRequest', function() {
      // uncomment below and update the code to test GeoConvertRequest
      //var instance = new WyjytGeoCalculate.GeoConvertRequest();
      //expect(instance).to.be.a(WyjytGeoCalculate.GeoConvertRequest);
    });
