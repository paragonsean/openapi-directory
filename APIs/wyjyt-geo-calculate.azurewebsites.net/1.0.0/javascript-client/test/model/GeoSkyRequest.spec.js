...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WyjytGeoCalculate.GeoSkyRequest();
  });
  ...
  describe('GeoSkyRequest', function() {
    it('should create an instance of GeoSkyRequest', function() {
      // uncomment below and update the code to test GeoSkyRequest
      //var instance = new WyjytGeoCalculate.GeoSkyRequest();
      //expect(instance).to.be.a(WyjytGeoCalculate.GeoSkyRequest);
    });
