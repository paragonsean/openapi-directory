...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://papinet.papinet.io"),
    "papiNet Mock Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("ordersGet", defaultConf);
    _serverIndices.insert("ordersGet", 0);
    _serverConfigs.insert("ordersOrderIdGet", defaultConf);
    _serverIndices.insert("ordersOrderIdGet", 0);
}
...
void OAIDefaultApi::ordersGet(const ::OpenAPI::OptionalParam<QString> &order_status, const ::OpenAPI::OptionalParam<QString> &offset, const ::OpenAPI::OptionalParam<QString> &limit) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::ordersGetCallback);
...
void OAIDefaultApi::ordersGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIListOfOrders output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::ordersOrderIdGet(const QString &order_id) {
    QString fullPath = QString(_serverConfigs["ordersOrderIdGet"][_serverIndices.value("ordersOrderIdGet")].URL()+"/orders/{orderId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::ordersOrderIdGetCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::ordersOrderIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ordersOrderIdGetSignal(output);
        Q_EMIT ordersOrderIdGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT ordersOrderIdGetSignalE(output, error_type, error_str);
        Q_EMIT ordersOrderIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT ordersOrderIdGetSignalError(output, error_type, error_str);
        Q_EMIT ordersOrderIdGetSignalErrorFull(worker, error_type, error_str);
    }
}
