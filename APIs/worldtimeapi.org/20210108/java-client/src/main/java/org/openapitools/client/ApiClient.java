...
public class ApiClient {
    ...
    private String basePath = "http://worldtimeapi.org/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/20210108/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://worldtimeapi.org/api
