...
#ifndef OAILicensee_H
#define OAILicensee_H
...
class OAILicensee : public OAIObject {
public:
    OAILicensee();
    OAILicensee(QString json);
    ~OAILicensee() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicensee)
