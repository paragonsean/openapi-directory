...
public class ApiClient {
    ...
    private String basePath = "https://go.netlicensing.io/core/v2/rest";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.x/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://go.netlicensing.io/core/v2/rest
