...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Labs64NetLicensingResTfulApiTestCenter.Product();
  });
  ...
  describe('Product', function() {
    it('should create an instance of Product', function() {
      ...
      //var instance = new Labs64NetLicensingResTfulApiTestCenter.Product();
      //expect(instance).to.be.a(Labs64NetLicensingResTfulApiTestCenter.Product);
    });
    ...
    it('should have the property licenseeAutoCreate (base name: "licenseeAutoCreate")', function() {
      // uncomment below and update the code to test the property licenseeAutoCreate
      //var instance = new Labs64NetLicensingResTfulApiTestCenter.Product();
      //expect(instance).to.be();
    });
