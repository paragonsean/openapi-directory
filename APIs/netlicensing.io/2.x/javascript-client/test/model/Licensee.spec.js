...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Labs64NetLicensingResTfulApiTestCenter.Licensee();
  });
  ...
  describe('Licensee', function() {
    it('should create an instance of Licensee', function() {
      // uncomment below and update the code to test Licensee
      //var instance = new Labs64NetLicensingResTfulApiTestCenter.Licensee();
      //expect(instance).to.be.a(Labs64NetLicensingResTfulApiTestCenter.Licensee);
    });
