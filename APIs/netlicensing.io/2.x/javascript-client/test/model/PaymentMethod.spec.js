...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Labs64NetLicensingResTfulApiTestCenter.PaymentMethod();
  });
  ...
  describe('PaymentMethod', function() {
    it('should create an instance of PaymentMethod', function() {
      ...
      //var instance = new Labs64NetLicensingResTfulApiTestCenter.PaymentMethod();
      //expect(instance).to.be.a(Labs64NetLicensingResTfulApiTestCenter.PaymentMethod);
    });
