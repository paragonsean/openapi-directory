...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Labs64NetLicensingResTfulApiTestCenter.LicenseTemplate();
  });
  ...
  describe('LicenseTemplate', function() {
    it('should create an instance of LicenseTemplate', function() {
      // uncomment below and update the code to test LicenseTemplate
      //var instance = new Labs64NetLicensingResTfulApiTestCenter.LicenseTemplate();
      //expect(instance).to.be.a(Labs64NetLicensingResTfulApiTestCenter.LicenseTemplate);
    });
    ...
    it('should have the property hiddenLicenses (base name: "hiddenLicenses")', function() {
      // uncomment below and update the code to test the property hiddenLicenses
      //var instance = new Labs64NetLicensingResTfulApiTestCenter.LicenseTemplate();
      //expect(instance).to.be();
    });
