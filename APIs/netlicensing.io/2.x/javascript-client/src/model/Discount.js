...
class Discount {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('amountPercent')) {
                obj['amountPercent'] = ApiClient.convertToType(data['amountPercent'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['amountPercent'] && !(typeof data['amountPercent'] === 'string' || data['amountPercent'] instanceof String)) {
            throw new Error("Expected the field `amountPercent` to be a primitive type in the JSON string but got " + data['amountPercent']);
        }
        // ensure the json data is a string
...
/**
 * @member {String} amountPercent
 */
Discount.prototype['amountPercent'] = undefined;

/**
 * @member {String} currency
 */
Discount.prototype['currency'] = undefined;

/**
 * @member {Number} totalPrice
 */
Discount.prototype['totalPrice'] = undefined;
