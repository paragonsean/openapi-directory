...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.exchangerate-api.com/v4"),
    "No authentication endpoint. Returns latest exchange rates and some metadata.",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("latestBaseCurrencyGet", defaultConf);
    _serverIndices.insert("latestBaseCurrencyGet", 0);
}
...
void OAIDefaultApi::latestBaseCurrencyGet(const QString &base_currency) {
    QString fullPath = QString(_serverConfigs["latestBaseCurrencyGet"][_serverIndices.value("latestBaseCurrencyGet")].URL()+"/latest/{base_currency}");
    
    
    {
        QString base_currencyPathParam("{");
        base_currencyPathParam.append("base_currency").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "base_currency", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"base_currency"+pathSuffix : pathPrefix;
        fullPath.replace(base_currencyPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(base_currency)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::latestBaseCurrencyGetCallback);
...
void OAIDefaultApi::latestBaseCurrencyGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_latest__base_currency__get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT latestBaseCurrencyGetSignal(output);
        Q_EMIT latestBaseCurrencyGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT latestBaseCurrencyGetSignalE(output, error_type, error_str);
        Q_EMIT latestBaseCurrencyGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT latestBaseCurrencyGetSignalError(output, error_type, error_str);
        Q_EMIT latestBaseCurrencyGetSignalErrorFull(worker, error_type, error_str);
    }
}
