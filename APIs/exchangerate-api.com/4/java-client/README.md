...
ExchangeRate-API
- API version: 4
  - Build date: 2024-10-12T11:25:20.496183-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**latestBaseCurrencyGet**](docs/DefaultApi.md#latestBaseCurrencyGet) | **GET** /latest/{base_currency} | Returns latest exchange rates in parameter-supplied base currency.
