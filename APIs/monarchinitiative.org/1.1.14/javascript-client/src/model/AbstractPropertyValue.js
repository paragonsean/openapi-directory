...
/**
 * The AbstractPropertyValue model module.
 * @module model/AbstractPropertyValue
 * @version 1.1.14
 */
class AbstractPropertyValue {
    /**
     * Constructs a new <code>AbstractPropertyValue</code>.
     * @alias module:model/AbstractPropertyValue
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AbstractPropertyValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AbstractPropertyValue} obj Optional instance to populate.
     * @return {module:model/AbstractPropertyValue} The populated <code>AbstractPropertyValue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AbstractPropertyValue();
    ...
    /**
     * Validates the JSON data with respect to <code>AbstractPropertyValue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AbstractPropertyValue</code>.
     */
...
export default AbstractPropertyValue;
