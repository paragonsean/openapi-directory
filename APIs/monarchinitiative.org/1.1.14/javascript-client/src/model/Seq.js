...
class Seq {
    ...
    /**
     * Validates the JSON data with respect to <code>Seq</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Seq</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Seq.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['residues'] && !(typeof data['residues'] === 'string' || data['residues'] instanceof String)) {
            throw new Error("Expected the field `residues` to be a primitive type in the JSON string but got " + data['residues']);
        }
        // ensure the json data is a string
        if (data['seqlen'] && !(typeof data['seqlen'] === 'string' || data['seqlen'] instanceof String)) {
            throw new Error("Expected the field `seqlen` to be a primitive type in the JSON string but got " + data['seqlen']);
        }
 ...
 */
Seq.prototype['xrefs'] = undefined;

/**
 * one of: DNA, RNA or AA
 * @member {String} alphabet
 */
Seq.prototype['alphabet'] = undefined;

/**
 * checksum
 * @member {String} md5checksum
 */
Seq.prototype['md5checksum'] = undefined;

/**
 * string representing sequence of residues
 * @member {String} residues
 */
Seq.prototype['residues'] = undefined;

/**
 * length of sequence
 * @member {String} seqlen
 */
Seq.prototype['seqlen'] = undefined;
