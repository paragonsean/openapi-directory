...
class SequenceLocation {
    ...
    constructor(id) { 
        ...
        SequenceLocation.initialize(this, id);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('start')) {
                obj['start'] = SequencePosition.constructFromObject(data['start']);
            }
            if (data.hasOwnProperty('strand')) {
                obj['strand'] = ApiClient.convertToType(data['strand'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SequenceLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SequenceLocation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SequenceLocation.RequiredProperties) {
        ...
        if (data['end']) { // data not null
          SequencePosition.validateJSON(data['end']);
        }
        // validate the optional field `start`
        if (data['start']) { // data not null
          SequencePosition.validateJSON(data['start']);
        }
...
SequenceLocation.RequiredProperties = ["id"];

/**
 * @member {Array.<String>} category
 */
SequenceLocation.prototype['category'] = undefined;

/**
 * ID or CURIE e.g. MGI:1201606
 * @member {String} id
 */
SequenceLocation.prototype['id'] = undefined;

/**
 * IRI
 * @member {String} iri
 */
SequenceLocation.prototype['iri'] = undefined;

/**
 * RDFS Label
 * @member {String} label
 */
SequenceLocation.prototype['label'] = undefined;

/**
 * @member {Array.<String>} consider
 */
SequenceLocation.prototype['consider'] = undefined;

/**
 * True if the node is deprecated/obsoleted.
 * @member {Boolean} deprecated
 */
SequenceLocation.prototype['deprecated'] = undefined;

/**
 * Descriptive text for the entity. For ontology classes, this will be a definition.
 * @member {String} description
 */
SequenceLocation.prototype['description'] = undefined;

/**
 * @member {Array.<String>} replaced_by
 */
SequenceLocation.prototype['replaced_by'] = undefined;

/**
 * list of synonyms or alternate labels
 * @member {Array.<module:model/SynonymPropertyValue>} synonyms
 */
SequenceLocation.prototype['synonyms'] = undefined;

/**
 * @member {Array.<String>} types
 */
SequenceLocation.prototype['types'] = undefined;

/**
 * association counts
 * @member {Object} association_counts
 */
SequenceLocation.prototype['association_counts'] = undefined;

/**
 * Taxon to which the object belongs
 * @member {module:model/Taxon} taxon
 */
SequenceLocation.prototype['taxon'] = undefined;
 ...
 */
SequenceLocation.prototype['xrefs'] = undefined;

/**
 * @member {module:model/SequencePosition} end
 */
SequenceLocation.prototype['end'] = undefined;

/**
 * @member {Number} phase
 */
SequenceLocation.prototype['phase'] = undefined;

/**
 * @member {Number} score
 */
SequenceLocation.prototype['score'] = undefined;

/**
 * @member {module:model/SequencePosition} start
 */
SequenceLocation.prototype['start'] = undefined;

/**
 * Strand direction: 1=='+', -1=='-', 0 or null infers unknown.
 * @member {Number} strand
 */
SequenceLocation.prototype['strand'] = undefined;
...
export default SequenceLocation;
