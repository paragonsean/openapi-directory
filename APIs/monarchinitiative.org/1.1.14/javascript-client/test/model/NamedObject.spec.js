...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BioLinkApi.NamedObject();
  });
  ...
  describe('NamedObject', function() {
    it('should create an instance of NamedObject', function() {
      // uncomment below and update the code to test NamedObject
      //var instance = new BioLinkApi.NamedObject();
