...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BioLinkApi.AbstractPropertyValue();
  });
  ...
  describe('AbstractPropertyValue', function() {
    it('should create an instance of AbstractPropertyValue', function() {
      // uncomment below and update the code to test AbstractPropertyValue
      //var instance = new BioLinkApi.AbstractPropertyValue();
