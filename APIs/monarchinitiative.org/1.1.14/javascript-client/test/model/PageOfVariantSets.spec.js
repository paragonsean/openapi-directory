...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BioLinkApi.PageOfVariantSets();
  });
  ...
  describe('PageOfVariantSets', function() {
    it('should create an instance of PageOfVariantSets', function() {
      // uncomment below and update the code to test PageOfVariantSets
      //var instance = new BioLinkApi.PageOfVariantSets();
      //expect(instance).to.be.a(BioLinkApi.PageOfVariantSets);
    });
