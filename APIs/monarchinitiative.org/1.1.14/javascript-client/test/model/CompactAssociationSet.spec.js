...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BioLinkApi.CompactAssociationSet();
  });
  ...
  describe('CompactAssociationSet', function() {
    it('should create an instance of CompactAssociationSet', function() {
      // uncomment below and update the code to test CompactAssociationSet
      //var instance = new BioLinkApi.CompactAssociationSet();
      //expect(instance).to.be.a(BioLinkApi.CompactAssociationSet);
    });
