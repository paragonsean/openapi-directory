...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BioLinkApi.SequenceFeature();
  });
  ...
  describe('SequenceFeature', function() {
    it('should create an instance of SequenceFeature', function() {
      // uncomment below and update the code to test SequenceFeature
      //var instance = new BioLinkApi.SequenceFeature();
