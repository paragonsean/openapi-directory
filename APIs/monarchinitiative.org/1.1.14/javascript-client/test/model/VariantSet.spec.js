...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BioLinkApi.VariantSet();
  });
  ...
  describe('VariantSet', function() {
    it('should create an instance of VariantSet', function() {
      // uncomment below and update the code to test VariantSet
      //var instance = new BioLinkApi.VariantSet();
      //expect(instance).to.be.a(BioLinkApi.VariantSet);
    });
