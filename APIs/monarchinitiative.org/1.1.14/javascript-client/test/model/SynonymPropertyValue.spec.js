...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BioLinkApi.SynonymPropertyValue();
  });
  ...
  describe('SynonymPropertyValue', function() {
    it('should create an instance of SynonymPropertyValue', function() {
      // uncomment below and update the code to test SynonymPropertyValue
      //var instance = new BioLinkApi.SynonymPropertyValue();
      //expect(instance).to.be.a(BioLinkApi.SynonymPropertyValue);
    });
