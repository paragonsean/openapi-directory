...
void OAIMetadataApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getMetadataForDatasets", defaultConf);
    _serverIndices.insert("getMetadataForDatasets", 0);
}
...
void OAIMetadataApi::getMetadataForDatasets() {
    QString fullPath = QString(_serverConfigs["getMetadataForDatasets"][_serverIndices.value("getMetadataForDatasets")].URL()+"/metadata/datasets");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::getMetadataForDatasetsCallback);
...
void OAIMetadataApi::getMetadataForDatasetsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getMetadataForDatasetsSignal();
        Q_EMIT getMetadataForDatasetsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getMetadataForDatasetsSignalE(error_type, error_str);
        Q_EMIT getMetadataForDatasetsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getMetadataForDatasetsSignalError(error_type, error_str);
        Q_EMIT getMetadataForDatasetsSignalErrorFull(worker, error_type, error_str);
    }
}
