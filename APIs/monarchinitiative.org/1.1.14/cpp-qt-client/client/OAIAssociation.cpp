...
OAIGraph OAIAssociation::getEvidenceGraph() const {
    return m_evidence_graph;
}
void OAIAssociation::setEvidenceGraph(const OAIGraph &evidence_graph) {
    m_evidence_graph = evidence_graph;
    m_evidence_graph_isSet = true;
}

bool OAIAssociation::is_evidence_graph_Set() const{
    return m_evidence_graph_isSet;
}

bool OAIAssociation::is_evidence_graph_Valid() const{
    return m_evidence_graph_isValid;
}

QList<OAIEntityReference> OAIAssociation::getEvidenceTypes() const {
    return m_evidence_types;
}
void OAIAssociation::setEvidenceTypes(const QList<OAIEntityReference> &evidence_types) {
    m_evidence_types = evidence_types;
    m_evidence_types_isSet = true;
}

bool OAIAssociation::is_evidence_types_Set() const{
    return m_evidence_types_isSet;
}

bool OAIAssociation::is_evidence_types_Valid() const{
...
bool OAIAssociation::isNegated() const {
    return m_negated;
}
void OAIAssociation::setNegated(const bool &negated) {
    m_negated = negated;
    m_negated_isSet = true;
}

bool OAIAssociation::is_negated_Set() const{
    return m_negated_isSet;
}

bool OAIAssociation::is_negated_Valid() const{
    return m_negated_isValid;
}

OAIBioObjectCore OAIAssociation::getObject() const {
    return m_object;
}
void OAIAssociation::setObject(const OAIBioObjectCore &object) {
    m_object = object;
    m_object_isSet = true;
}

bool OAIAssociation::is_object_Set() const{
    return m_object_isSet;
}

bool OAIAssociation::is_object_Valid() const{
    return m_object_isValid;
}

QList<QString> OAIAssociation::getObjectEq() const {
    return m_object_eq;
}
void OAIAssociation::setObjectEq(const QList<QString> &object_eq) {
    m_object_eq = object_eq;
    m_object_eq_isSet = true;
}

bool OAIAssociation::is_object_eq_Set() const{
    return m_object_eq_isSet;
}

bool OAIAssociation::is_object_eq_Valid() const{
    return m_object_eq_isValid;
}

QList<OAIAnnotationExtension> OAIAssociation::getObjectExtensions() const {
    return m_object_extensions;
}
void OAIAssociation::setObjectExtensions(const QList<OAIAnnotationExtension> &object_extensions) {
    m_object_extensions = object_extensions;
    m_object_extensions_isSet = true;
}

bool OAIAssociation::is_object_extensions_Set() const{
    return m_object_extensions_isSet;
}

bool OAIAssociation::is_object_extensions_Valid() const{
    return m_object_extensions_isValid;
}

QList<QString> OAIAssociation::getProvidedBy() const {
    return m_provided_by;
}
void OAIAssociation::setProvidedBy(const QList<QString> &provided_by) {
    m_provided_by = provided_by;
    m_provided_by_isSet = true;
}

bool OAIAssociation::is_provided_by_Set() const{
    return m_provided_by_isSet;
}

bool OAIAssociation::is_provided_by_Valid() const{
    return m_provided_by_isValid;
}

QList<OAIEntityReference> OAIAssociation::getPublications() const {
    return m_publications;
}
void OAIAssociation::setPublications(const QList<OAIEntityReference> &publications) {
    m_publications = publications;
    m_publications_isSet = true;
}

bool OAIAssociation::is_publications_Set() const{
    return m_publications_isSet;
}

bool OAIAssociation::is_publications_Valid() const{
    return m_publications_isValid;
}

QList<QString> OAIAssociation::getQualifiers() const {
    return m_qualifiers;
}
void OAIAssociation::setQualifiers(const QList<QString> &qualifiers) {
    m_qualifiers = qualifiers;
    m_qualifiers_isSet = true;
}

bool OAIAssociation::is_qualifiers_Set() const{
    return m_qualifiers_isSet;
}

bool OAIAssociation::is_qualifiers_Valid() const{
    return m_qualifiers_isValid;
}

OAIRelationRef OAIAssociation::getRelation() const {
    return m_relation;
}
void OAIAssociation::setRelation(const OAIRelationRef &relation) {
    m_relation = relation;
    m_relation_isSet = true;
}

bool OAIAssociation::is_relation_Set() const{
    return m_relation_isSet;
}

bool OAIAssociation::is_relation_Valid() const{
    return m_relation_isValid;
}

QList<QString> OAIAssociation::getSlim() const {
    return m_slim;
}
void OAIAssociation::setSlim(const QList<QString> &slim) {
    m_slim = slim;
    m_slim_isSet = true;
}

bool OAIAssociation::is_slim_Set() const{
    return m_slim_isSet;
}

bool OAIAssociation::is_slim_Valid() const{
    return m_slim_isValid;
}

OAIBioObjectCore OAIAssociation::getSubject() const {
    return m_subject;
}
void OAIAssociation::setSubject(const OAIBioObjectCore &subject) {
    m_subject = subject;
    m_subject_isSet = true;
}

bool OAIAssociation::is_subject_Set() const{
    return m_subject_isSet;
}

bool OAIAssociation::is_subject_Valid() const{
    return m_subject_isValid;
}

QList<QString> OAIAssociation::getSubjectEq() const {
    return m_subject_eq;
}
void OAIAssociation::setSubjectEq(const QList<QString> &subject_eq) {
    m_subject_eq = subject_eq;
    m_subject_eq_isSet = true;
}

bool OAIAssociation::is_subject_eq_Set() const{
    return m_subject_eq_isSet;
}

bool OAIAssociation::is_subject_eq_Valid() const{
    return m_subject_eq_isValid;
}

QList<OAIAnnotationExtension> OAIAssociation::getSubjectExtensions() const {
    return m_subject_extensions;
}
void OAIAssociation::setSubjectExtensions(const QList<OAIAnnotationExtension> &subject_extensions) {
    m_subject_extensions = subject_extensions;
    m_subject_extensions_isSet = true;
}

bool OAIAssociation::is_subject_extensions_Set() const{
    return m_subject_extensions_isSet;
}

bool OAIAssociation::is_subject_extensions_Valid() const{
