...
/*
 * OAIAssociationResults.h
 *
 * 
 */

#ifndef OAIAssociationResults_H
#define OAIAssociationResults_H
...
class OAIAssociationResults : public OAIObject {
public:
    OAIAssociationResults();
    OAIAssociationResults(QString json);
    ~OAIAssociationResults() override;
    ...
    QList<OAIAssociation> getAssociations() const;
    void setAssociations(const QList<OAIAssociation> &associations);
...
private:
    ...
    QList<OAIAssociation> m_associations;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociationResults)

#endif // OAIAssociationResults_H
