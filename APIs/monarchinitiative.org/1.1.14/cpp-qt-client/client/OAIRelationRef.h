...
#ifndef OAIRelationRef_H
#define OAIRelationRef_H
...
class OAIRelationRef : public OAIObject {
public:
    OAIRelationRef();
    OAIRelationRef(QString json);
    ~OAIRelationRef() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRelationRef)

#endif // OAIRelationRef_H
