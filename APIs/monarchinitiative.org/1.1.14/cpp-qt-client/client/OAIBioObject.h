...
#ifndef OAIBioObject_H
#define OAIBioObject_H
...
class OAIBioObject : public OAIObject {
public:
    OAIBioObject();
    OAIBioObject(QString json);
    ~OAIBioObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBioObject)

#endif // OAIBioObject_H
