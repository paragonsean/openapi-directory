...
public class D2PAssociationResults {
  ...
  private List<D2PAssociation> associations = new ArrayList<>();
  ...
  public D2PAssociationResults docs(List<Object> docs) {
    this.docs = docs;
    return this;
  }

  public D2PAssociationResults addDocsItem(Object docsItem) {
    if (this.docs == null) {
  ...
  public D2PAssociationResults facetCounts(Object facetCounts) {
  ...
  public D2PAssociationResults highlighting(Object highlighting) {
  ...
  public D2PAssociationResults numFound(Integer numFound) {
  ...
  public D2PAssociationResults associations(List<D2PAssociation> associations) {
    this.associations = associations;
    return this;
  }

  public D2PAssociationResults addAssociationsItem(D2PAssociation associationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<D2PAssociation> getAssociations() {
    return associations;
  }

  public void setAssociations(List<D2PAssociation> associations) {
    this.associations = associations;
  }


  public D2PAssociationResults compactAssociations(List<CompactAssociationSet> compactAssociations) {
    this.compactAssociations = compactAssociations;
    return this;
  }

  public D2PAssociationResults addCompactAssociationsItem(CompactAssociationSet compactAssociationsItem) {
  ...
  public D2PAssociationResults objects(List<String> objects) {
    this.objects = objects;
    return this;
  }

  public D2PAssociationResults addObjectsItem(String objectsItem) {
  ...
  public boolean equals(Object o) {
    ...
    D2PAssociationResults d2PAssociationResults = (D2PAssociationResults) o;
    return Objects.equals(this.docs, d2PAssociationResults.docs) &&
        Objects.equals(this.facetCounts, d2PAssociationResults.facetCounts) &&
        Objects.equals(this.highlighting, d2PAssociationResults.highlighting) &&
        Objects.equals(this.numFound, d2PAssociationResults.numFound) &&
        Objects.equals(this.associations, d2PAssociationResults.associations) &&
        Objects.equals(this.compactAssociations, d2PAssociationResults.compactAssociations) &&
        Objects.equals(this.objects, d2PAssociationResults.objects);
  }
  ...
  public String toString() {
    ...
    sb.append("class D2PAssociationResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to D2PAssociationResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!D2PAssociationResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in D2PAssociationResults is not found in the empty JSON string", D2PAssociationResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!D2PAssociationResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `D2PAssociationResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("associations") != null && !jsonObj.get("associations").isJsonNull()) {
        ...
        if (jsonArrayassociations != null) {
          ...
          for (int i = 0; i < jsonArrayassociations.size(); i++) {
            D2PAssociation.validateJsonElement(jsonArrayassociations.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!D2PAssociationResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'D2PAssociationResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<D2PAssociationResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(D2PAssociationResults.class));

       return (TypeAdapter<T>) new TypeAdapter<D2PAssociationResults>() {
           @Override
           public void write(JsonWriter out, D2PAssociationResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public D2PAssociationResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of D2PAssociationResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of D2PAssociationResults
   * @throws IOException if the JSON string is invalid with respect to D2PAssociationResults
   */
  public static D2PAssociationResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, D2PAssociationResults.class);
  }

  /**
   * Convert an instance of D2PAssociationResults to an JSON string
   *
   * @return JSON string
   */
