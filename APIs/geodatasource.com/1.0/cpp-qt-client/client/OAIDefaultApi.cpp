...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.geodatasource.com"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("cityGet", defaultConf);
    _serverIndices.insert("cityGet", 0);
}
...
void OAIDefaultApi::cityGet(const QString &key, const double &lng, const double &lat, const ::OpenAPI::OptionalParam<QString> &format) {
    QString fullPath = QString(_serverConfigs["cityGet"][_serverIndices.value("cityGet")].URL()+"/city");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::cityGetCallback);
...
void OAIDefaultApi::cityGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cityGetSignal(output);
        Q_EMIT cityGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cityGetSignalE(output, error_type, error_str);
        Q_EMIT cityGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cityGetSignalError(output, error_type, error_str);
        Q_EMIT cityGetSignalErrorFull(worker, error_type, error_str);
    }
}
