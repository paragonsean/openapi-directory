...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::cityGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::cityGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      apiInstance.cityGet(keylnglatformat);
