...
> AggregateDatasets200Response aggregateDatasets(source, opts)
...
let apiInstance = new Opendatasoft.CatalogApi();
...
apiInstance.aggregateDatasets(source, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetDatasets200Response getDatasets(source, opts)
...
apiInstance.getDatasets(source, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetRecordsFacets200Response getDatasetsFacets(source, opts)
...
apiInstance.getDatasetsFacets(source, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Opendatasoft.CatalogApi();
let source = "'catalog'"; // String | Each source represents a different catalog of datasets you'll be able to query.  There are 2 sources available:  * catalog: the catalog of datasets on your portal * opendatasoft: Opendatasoft's repository of public datasets, also available at   [data.opendatasoft.com](https://data.opendatasoft.com/page/home/) 
apiInstance.getSource(source, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
