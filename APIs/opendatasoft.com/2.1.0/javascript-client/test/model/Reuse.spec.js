...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Opendatasoft.Reuse();
  });
  ...
  describe('Reuse', function() {
    it('should create an instance of Reuse', function() {
      // uncomment below and update the code to test Reuse
      //var instance = new Opendatasoft.Reuse();
      //expect(instance).to.be.a(Opendatasoft.Reuse);
    });
