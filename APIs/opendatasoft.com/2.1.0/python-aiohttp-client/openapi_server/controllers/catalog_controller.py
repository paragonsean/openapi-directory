...
async def aggregate_datasets(request: web.Request, source, select=None, where=None, group_by=None, order_by=None, limit=None, offset=None, facet=None, refine=None, exclude=None) -> web.Response:
    """aggregate_datasets
...
async def get_datasets(request: web.Request, source, select=None, where=None, group_by=None, sort=None, order_by=None, limit=None, offset=None, search=None, facet=None, refine=None, exclude=None, pretty=None, timezone=None, include_app_metas=None) -> web.Response:
    """get_datasets
...
async def get_datasets_facets(request: web.Request, source, facet=None, refine=None, exclude=None, where=None, search=None, timezone=None) -> web.Response:
    """get_datasets_facets
...
async def get_source(request: web.Request, source) -> web.Response:
    """get_source
