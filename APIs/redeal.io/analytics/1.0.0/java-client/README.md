...
- API version: 1.0.0
  - Build date: 2024-10-12T09:59:34.338987-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*DevelopersApi* | [**getEvents**](docs/DevelopersApi.md#getEvents) | **GET** /events | get events for analytics


## Documentation for Models

 - [EventRecord](docs/EventRecord.md)
