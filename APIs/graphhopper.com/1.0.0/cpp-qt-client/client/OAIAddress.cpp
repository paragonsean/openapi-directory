...
void OAIAddress::initializeModel() {
    ...
    m_curbside_isSet = false;
    m_curbside_isValid = false;
...
void OAIAddress::fromJsonObject(QJsonObject json) {
    ...
    m_curbside_isValid = ::OpenAPI::fromJsonValue(m_curbside, json[QString("curbside")]);
    m_curbside_isSet = !json[QString("curbside")].isNull() && m_curbside_isValid;
...
QJsonObject OAIAddress::asJsonObject() const {
    QJsonObject obj;
    if (m_curbside_isSet) {
        obj.insert(QString("curbside"), ::OpenAPI::toJsonValue(m_curbside));
    }
    if (m_lat_isSet) {
...
QString OAIAddress::getCurbside() const {
    return m_curbside;
}
void OAIAddress::setCurbside(const QString &curbside) {
    m_curbside = curbside;
    m_curbside_isSet = true;
}

bool OAIAddress::is_curbside_Set() const{
    return m_curbside_isSet;
}

bool OAIAddress::is_curbside_Valid() const{
    return m_curbside_isValid;
}
...
QString OAIAddress::getLocationId() const {
    return m_location_id;
}
void OAIAddress::setLocationId(const QString &location_id) {
    m_location_id = location_id;
    m_location_id_isSet = true;
}

bool OAIAddress::is_location_id_Set() const{
    return m_location_id_isSet;
}

bool OAIAddress::is_location_id_Valid() const{
    return m_location_id_isValid;
}

double OAIAddress::getLon() const {
    return m_lon;
}
void OAIAddress::setLon(const double &lon) {
    m_lon = lon;
    m_lon_isSet = true;
}

bool OAIAddress::is_lon_Set() const{
    return m_lon_isSet;
}

bool OAIAddress::is_lon_Valid() const{
...
QString OAIAddress::getStreetHint() const {
    return m_street_hint;
}
void OAIAddress::setStreetHint(const QString &street_hint) {
    m_street_hint = street_hint;
    m_street_hint_isSet = true;
}

bool OAIAddress::is_street_hint_Set() const{
    return m_street_hint_isSet;
}

bool OAIAddress::is_street_hint_Valid() const{
...
bool OAIAddress::isValid() const {
    ...
    return m_lat_isValid && m_location_id_isValid && m_lon_isValid && true;
}
