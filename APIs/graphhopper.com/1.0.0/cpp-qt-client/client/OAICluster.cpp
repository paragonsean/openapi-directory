...
QList<QString> OAICluster::getIds() const {
    return m_ids;
}
void OAICluster::setIds(const QList<QString> &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAICluster::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAICluster::is_ids_Valid() const{
    return m_ids_isValid;
}

double OAICluster::getQuantity() const {
    return m_quantity;
}
void OAICluster::setQuantity(const double &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAICluster::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAICluster::is_quantity_Valid() const{
