...
/*
 * OAISolution_unassigned.h
 *
 * 
 */

#ifndef OAISolution_unassigned_H
#define OAISolution_unassigned_H
...
class OAISolution_unassigned : public OAIObject {
public:
    OAISolution_unassigned();
    OAISolution_unassigned(QString json);
    ~OAISolution_unassigned() override;
    ...
    QList<QString> getBreaks() const;
    void setBreaks(const QList<QString> &breaks);
    ...
    QList<QString> getShipments() const;
    void setShipments(const QList<QString> &shipments);
...
Q_DECLARE_METATYPE(OpenAPI::OAISolution_unassigned)

#endif // OAISolution_unassigned_H
