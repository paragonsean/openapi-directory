...
#include "OAIClusterConfigurationClustering.h"
#include "OAIClusterConfigurationRouting.h"
#include <QString>
...
namespace OpenAPI {
class OAIClusterConfigurationClustering;
class OAIClusterConfigurationRouting;
...
public:
    ...
    OAIClusterConfigurationClustering getClustering() const;
    void setClustering(const OAIClusterConfigurationClustering &clustering);
    ...
    OAIClusterConfigurationRouting getRouting() const;
    void setRouting(const OAIClusterConfigurationRouting &routing);
...
private:
    ...
    OAIClusterConfigurationClustering m_clustering;
    ...
    OAIClusterConfigurationRouting m_routing;
