...
/*
 * OAISymmetricalMatrixRequest.h
 *
 * 
 */

#ifndef OAISymmetricalMatrixRequest_H
#define OAISymmetricalMatrixRequest_H
...
class OAISymmetricalMatrixRequest : public OAIObject {
public:
    OAISymmetricalMatrixRequest();
    OAISymmetricalMatrixRequest(QString json);
    ~OAISymmetricalMatrixRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISymmetricalMatrixRequest)

#endif // OAISymmetricalMatrixRequest_H
