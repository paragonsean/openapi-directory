...
public:
    ...
    qint64 getProcessingTime() const;
    void setProcessingTime(const qint64 &processing_time);
    ...
    qint64 getWaitingTimeInQueue() const;
    void setWaitingTimeInQueue(const qint64 &waiting_time_in_queue);
...
private:
    ...
    qint64 m_waiting_time_in_queue;
