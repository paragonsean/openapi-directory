...
OAIRouting OAIConfiguration::getRouting() const {
    return m_routing;
}
void OAIConfiguration::setRouting(const OAIRouting &routing) {
    m_routing = routing;
    m_routing_isSet = true;
}

bool OAIConfiguration::is_routing_Set() const{
    return m_routing_isSet;
}

bool OAIConfiguration::is_routing_Valid() const{
