...
/*
 * OAIRequest_relations_inner.h
 *
 * 
 */

#ifndef OAIRequest_relations_inner_H
#define OAIRequest_relations_inner_H

#include <QJsonObject>

#include "OAIGroupRelation.h"
#include "OAIJobRelation.h"
#include <QList>
#include <QString>
...
class OAIRequest_relations_inner : public OAIObject {
public:
    OAIRequest_relations_inner();
    OAIRequest_relations_inner(QString json);
    ~OAIRequest_relations_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequest_relations_inner)

#endif // OAIRequest_relations_inner_H
