...
QString OAIInfoResponse::getBbox() const {
    return m_bbox;
}
void OAIInfoResponse::setBbox(const QString &bbox) {
    m_bbox = bbox;
    m_bbox_isSet = true;
}

bool OAIInfoResponse::is_bbox_Set() const{
    return m_bbox_isSet;
}

bool OAIInfoResponse::is_bbox_Valid() const{
    return m_bbox_isValid;
}

OAIObject OAIInfoResponse::getFeatures() const {
    return m_features;
}
void OAIInfoResponse::setFeatures(const OAIObject &features) {
    m_features = features;
    m_features_isSet = true;
}

bool OAIInfoResponse::is_features_Set() const{
    return m_features_isSet;
}

bool OAIInfoResponse::is_features_Valid() const{
    return m_features_isValid;
}

QString OAIInfoResponse::getVersion() const {
    return m_version;
}
void OAIInfoResponse::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIInfoResponse::is_version_Set() const{
    return m_version_isSet;
}

bool OAIInfoResponse::is_version_Valid() const{
