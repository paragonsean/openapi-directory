...
QList<QString> OAIResponse::getCopyrights() const {
    return m_copyrights;
}
void OAIResponse::setCopyrights(const QList<QString> &copyrights) {
    m_copyrights = copyrights;
    m_copyrights_isSet = true;
}

bool OAIResponse::is_copyrights_Set() const{
    return m_copyrights_isSet;
}

bool OAIResponse::is_copyrights_Valid() const{
    return m_copyrights_isValid;
}

qint64 OAIResponse::getProcessingTime() const {
    return m_processing_time;
}
void OAIResponse::setProcessingTime(const qint64 &processing_time) {
    m_processing_time = processing_time;
    m_processing_time_isSet = true;
}

bool OAIResponse::is_processing_time_Set() const{
    return m_processing_time_isSet;
}

bool OAIResponse::is_processing_time_Valid() const{
    return m_processing_time_isValid;
}

OAISolution OAIResponse::getSolution() const {
    return m_solution;
}
void OAIResponse::setSolution(const OAISolution &solution) {
    m_solution = solution;
    m_solution_isSet = true;
}

bool OAIResponse::is_solution_Set() const{
    return m_solution_isSet;
}

bool OAIResponse::is_solution_Valid() const{
    return m_solution_isValid;
}

QString OAIResponse::getStatus() const {
    return m_status;
}
void OAIResponse::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}
...
qint64 OAIResponse::getWaitingTimeInQueue() const {
    return m_waiting_time_in_queue;
}
void OAIResponse::setWaitingTimeInQueue(const qint64 &waiting_time_in_queue) {
    m_waiting_time_in_queue = waiting_time_in_queue;
    m_waiting_time_in_queue_isSet = true;
}

bool OAIResponse::is_waiting_time_in_queue_Set() const{
    return m_waiting_time_in_queue_isSet;
}

bool OAIResponse::is_waiting_time_in_queue_Valid() const{
