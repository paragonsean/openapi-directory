...
#ifndef OAIGeocodingLocation_H
#define OAIGeocodingLocation_H
...
public:
    ...
    QString getOsmKey() const;
    void setOsmKey(const QString &osm_key);
    bool is_osm_key_Set() const;
    bool is_osm_key_Valid() const;
    ...
    OAIGeocodingPoint getPoint() const;
    void setPoint(const OAIGeocodingPoint &point);
...
private:
    ...
    bool m_osm_key_isValid;

    QString m_osm_type;
    bool m_osm_type_isSet;
    bool m_osm_type_isValid;

    OAIGeocodingPoint m_point;
    bool m_point_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeocodingLocation)

#endif // OAIGeocodingLocation_H
