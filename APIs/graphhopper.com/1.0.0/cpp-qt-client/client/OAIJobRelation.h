...
#ifndef OAIJobRelation_H
#define OAIJobRelation_H
...
class OAIJobRelation : public OAIObject {
public:
    OAIJobRelation();
    OAIJobRelation(QString json);
    ~OAIJobRelation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobRelation)

#endif // OAIJobRelation_H
