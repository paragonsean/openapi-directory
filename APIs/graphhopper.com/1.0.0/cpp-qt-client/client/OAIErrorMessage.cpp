...
QString OAIErrorMessage::getDetails() const {
    return m_details;
}
void OAIErrorMessage::setDetails(const QString &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAIErrorMessage::is_details_Set() const{
    return m_details_isSet;
}

bool OAIErrorMessage::is_details_Valid() const{
