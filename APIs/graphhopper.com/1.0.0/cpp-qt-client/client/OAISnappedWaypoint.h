...
class OAISnappedWaypoint : public OAIObject {
public:
    OAISnappedWaypoint();
    OAISnappedWaypoint(QString json);
    ~OAISnappedWaypoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISnappedWaypoint)

#endif // OAISnappedWaypoint_H
