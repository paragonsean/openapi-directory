...
void OAIAlgorithm::fromJsonObject(QJsonObject json) {
    ...
    m_problem_type_isValid = ::OpenAPI::fromJsonValue(m_problem_type, json[QString("problem_type")]);
    m_problem_type_isSet = !json[QString("problem_type")].isNull() && m_problem_type_isValid;
}
...
QJsonObject OAIAlgorithm::asJsonObject() const {
    QJsonObject obj;
    if (m_objective_isSet) {
        obj.insert(QString("objective"), ::OpenAPI::toJsonValue(m_objective));
    }
    if (m_problem_type_isSet) {
        obj.insert(QString("problem_type"), ::OpenAPI::toJsonValue(m_problem_type));
    }
    return obj;
}

QString OAIAlgorithm::getObjective() const {
    return m_objective;
}
void OAIAlgorithm::setObjective(const QString &objective) {
    m_objective = objective;
    m_objective_isSet = true;
}

bool OAIAlgorithm::is_objective_Set() const{
    return m_objective_isSet;
}

bool OAIAlgorithm::is_objective_Valid() const{
    return m_objective_isValid;
}

QString OAIAlgorithm::getProblemType() const {
    return m_problem_type;
}
void OAIAlgorithm::setProblemType(const QString &problem_type) {
    m_problem_type = problem_type;
    m_problem_type_isSet = true;
}

bool OAIAlgorithm::is_problem_type_Set() const{
    return m_problem_type_isSet;
}

bool OAIAlgorithm::is_problem_type_Valid() const{
