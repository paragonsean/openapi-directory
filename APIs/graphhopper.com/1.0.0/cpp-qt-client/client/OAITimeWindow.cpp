...
qint64 OAITimeWindow::getEarliest() const {
    return m_earliest;
}
void OAITimeWindow::setEarliest(const qint64 &earliest) {
    m_earliest = earliest;
    m_earliest_isSet = true;
}

bool OAITimeWindow::is_earliest_Set() const{
    return m_earliest_isSet;
}

bool OAITimeWindow::is_earliest_Valid() const{
    return m_earliest_isValid;
}

qint64 OAITimeWindow::getLatest() const {
    return m_latest;
}
void OAITimeWindow::setLatest(const qint64 &latest) {
    m_latest = latest;
    m_latest_isSet = true;
}

bool OAITimeWindow::is_latest_Set() const{
    return m_latest_isSet;
}

bool OAITimeWindow::is_latest_Valid() const{
