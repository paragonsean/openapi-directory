...
#include "OAIRoute.h"
#include "OAISolution_unassigned.h"
#include <QList>
...
public:
    ...
    Q_DECL_DEPRECATED qint32 getCosts() const;
    Q_DECL_DEPRECATED void setCosts(const qint32 &costs);
    Q_DECL_DEPRECATED bool is_costs_Set() const;
    Q_DECL_DEPRECATED bool is_costs_Valid() const;
    ...
    qint64 getMaxOperationTime() const;
    void setMaxOperationTime(const qint64 &max_operation_time);
    bool is_max_operation_time_Set() const;
    bool is_max_operation_time_Valid() const;

    qint32 getNoUnassigned() const;
    void setNoUnassigned(const qint32 &no_unassigned);
    bool is_no_unassigned_Set() const;
    bool is_no_unassigned_Valid() const;

    qint32 getNoVehicles() const;
    void setNoVehicles(const qint32 &no_vehicles);
    bool is_no_vehicles_Set() const;
    bool is_no_vehicles_Valid() const;
    ...
    Q_DECL_DEPRECATED qint64 getTime() const;
    Q_DECL_DEPRECATED void setTime(const qint64 &time);
    Q_DECL_DEPRECATED bool is_time_Set() const;
    Q_DECL_DEPRECATED bool is_time_Valid() const;
    ...
    OAISolution_unassigned getUnassigned() const;
    void setUnassigned(const OAISolution_unassigned &unassigned);
...
private:
    ...
    qint64 m_max_operation_time;
    bool m_max_operation_time_isSet;
    bool m_max_operation_time_isValid;

    qint32 m_no_unassigned;
    bool m_no_unassigned_isSet;
    bool m_no_unassigned_isValid;

    qint32 m_no_vehicles;
    bool m_no_vehicles_isSet;
    bool m_no_vehicles_isValid;
    ...
    OAISolution_unassigned m_unassigned;
