...
public:
    ...
    QString getCurbside() const;
    void setCurbside(const QString &curbside);
    bool is_curbside_Set() const;
    bool is_curbside_Valid() const;
    ...
    QString getStreetHint() const;
    void setStreetHint(const QString &street_hint);
    bool is_street_hint_Set() const;
    bool is_street_hint_Valid() const;
...
private:
    ...
    QString m_curbside;
    bool m_curbside_isSet;
    bool m_curbside_isValid;
    ...
    QString m_street_hint;
    bool m_street_hint_isSet;
    bool m_street_hint_isValid;
};
