...
QList<QString> OAIResponseInfo::getCopyrights() const {
    return m_copyrights;
}
void OAIResponseInfo::setCopyrights(const QList<QString> &copyrights) {
    m_copyrights = copyrights;
    m_copyrights_isSet = true;
}

bool OAIResponseInfo::is_copyrights_Set() const{
    return m_copyrights_isSet;
}

bool OAIResponseInfo::is_copyrights_Valid() const{
    return m_copyrights_isValid;
}

double OAIResponseInfo::getTook() const {
    return m_took;
}
void OAIResponseInfo::setTook(const double &took) {
    m_took = took;
    m_took_isSet = true;
}

bool OAIResponseInfo::is_took_Set() const{
    return m_took_isSet;
}

bool OAIResponseInfo::is_took_Valid() const{
