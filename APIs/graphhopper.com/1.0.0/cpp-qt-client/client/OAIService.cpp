...
OAIAddress OAIService::getAddress() const {
    return m_address;
}
void OAIService::setAddress(const OAIAddress &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIService::is_address_Set() const{
    return m_address_isSet;
}

bool OAIService::is_address_Valid() const{
    return m_address_isValid;
}

QList<QString> OAIService::getAllowedVehicles() const {
    return m_allowed_vehicles;
}
void OAIService::setAllowedVehicles(const QList<QString> &allowed_vehicles) {
    m_allowed_vehicles = allowed_vehicles;
    m_allowed_vehicles_isSet = true;
}

bool OAIService::is_allowed_vehicles_Set() const{
    return m_allowed_vehicles_isSet;
}

bool OAIService::is_allowed_vehicles_Valid() const{
    return m_allowed_vehicles_isValid;
}

QList<QString> OAIService::getDisallowedVehicles() const {
    return m_disallowed_vehicles;
}
void OAIService::setDisallowedVehicles(const QList<QString> &disallowed_vehicles) {
    m_disallowed_vehicles = disallowed_vehicles;
    m_disallowed_vehicles_isSet = true;
}

bool OAIService::is_disallowed_vehicles_Set() const{
    return m_disallowed_vehicles_isSet;
}

bool OAIService::is_disallowed_vehicles_Valid() const{
    return m_disallowed_vehicles_isValid;
}

qint64 OAIService::getDuration() const {
    return m_duration;
}
void OAIService::setDuration(const qint64 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIService::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIService::is_duration_Valid() const{
    return m_duration_isValid;
}

QString OAIService::getGroup() const {
    return m_group;
}
void OAIService::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIService::is_group_Set() const{
    return m_group_isSet;
}

bool OAIService::is_group_Valid() const{
...
qint64 OAIService::getMaxTimeInVehicle() const {
    return m_max_time_in_vehicle;
}
void OAIService::setMaxTimeInVehicle(const qint64 &max_time_in_vehicle) {
    m_max_time_in_vehicle = max_time_in_vehicle;
    m_max_time_in_vehicle_isSet = true;
}

bool OAIService::is_max_time_in_vehicle_Set() const{
    return m_max_time_in_vehicle_isSet;
}

bool OAIService::is_max_time_in_vehicle_Valid() const{
...
qint64 OAIService::getPreparationTime() const {
    return m_preparation_time;
}
void OAIService::setPreparationTime(const qint64 &preparation_time) {
    m_preparation_time = preparation_time;
    m_preparation_time_isSet = true;
}

bool OAIService::is_preparation_time_Set() const{
    return m_preparation_time_isSet;
}

bool OAIService::is_preparation_time_Valid() const{
    return m_preparation_time_isValid;
}

qint32 OAIService::getPriority() const {
    return m_priority;
}
void OAIService::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIService::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIService::is_priority_Valid() const{
    return m_priority_isValid;
}

QList<QString> OAIService::getRequiredSkills() const {
    return m_required_skills;
}
void OAIService::setRequiredSkills(const QList<QString> &required_skills) {
    m_required_skills = required_skills;
    m_required_skills_isSet = true;
}

bool OAIService::is_required_skills_Set() const{
    return m_required_skills_isSet;
}

bool OAIService::is_required_skills_Valid() const{
    return m_required_skills_isValid;
}

QList<qint32> OAIService::getSize() const {
    return m_size;
}
void OAIService::setSize(const QList<qint32> &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIService::is_size_Set() const{
    return m_size_isSet;
}

bool OAIService::is_size_Valid() const{
    return m_size_isValid;
}

QList<OAITimeWindow> OAIService::getTimeWindows() const {
    return m_time_windows;
}
void OAIService::setTimeWindows(const QList<OAITimeWindow> &time_windows) {
    m_time_windows = time_windows;
    m_time_windows_isSet = true;
}

bool OAIService::is_time_windows_Set() const{
    return m_time_windows_isSet;
}

bool OAIService::is_time_windows_Valid() const{
