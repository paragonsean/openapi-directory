...
qint32 OAIDetail::getCode() const {
    return m_code;
}
void OAIDetail::setCode(const qint32 &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIDetail::is_code_Set() const{
    return m_code_isSet;
}

bool OAIDetail::is_code_Valid() const{
...
QString OAIDetail::getReason() const {
    return m_reason;
}
void OAIDetail::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIDetail::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIDetail::is_reason_Valid() const{
