...
public:
    ...
    QList<OAIRoutePoint> getPoints() const;
    void setPoints(const QList<OAIRoutePoint> &points);
    ...
    qint64 getTransportTime() const;
    void setTransportTime(const qint64 &transport_time);
    bool is_transport_time_Set() const;
    bool is_transport_time_Valid() const;
...
private:
    ...
    qint64 m_transport_time;
    bool m_transport_time_isSet;
    bool m_transport_time_isValid;
