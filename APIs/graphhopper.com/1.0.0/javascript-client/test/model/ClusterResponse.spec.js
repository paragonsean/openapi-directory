...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraphHopperDirectionsApi.ClusterResponse();
  });
  ...
  describe('ClusterResponse', function() {
    it('should create an instance of ClusterResponse', function() {
      ...
      //var instance = new GraphHopperDirectionsApi.ClusterResponse();
      //expect(instance).to.be.a(GraphHopperDirectionsApi.ClusterResponse);
    });
    ...
    it('should have the property waitingTimeInQueue (base name: "waiting_time_in_queue")', function() {
      // uncomment below and update the code to test the property waitingTimeInQueue
      //var instance = new GraphHopperDirectionsApi.ClusterResponse();
      //expect(instance).to.be();
    });
