...
class Response {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('waiting_time_in_queue')) {
                obj['waiting_time_in_queue'] = ApiClient.convertToType(data['waiting_time_in_queue'], 'Number');
            }
        }
        return obj;
    }
 ...
 */
Response.prototype['copyrights'] = undefined;

/**
 * Processing time in ms. If job is still waiting in queue, processing_time is 0
 * @member {Number} processing_time
 */
Response.prototype['processing_time'] = undefined;

/**
 * @member {module:model/Solution} solution
 */
Response.prototype['solution'] = undefined;

/**
 * Indicates the current status of the job
 * @member {module:model/Response.StatusEnum} status
 */
Response.prototype['status'] = undefined;

/**
 * Waiting time in ms
 * @member {Number} waiting_time_in_queue
 */
Response.prototype['waiting_time_in_queue'] = undefined;
