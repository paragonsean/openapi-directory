...
import SolutionUnassigned from './SolutionUnassigned';
...
class Solution {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('max_operation_time')) {
                obj['max_operation_time'] = ApiClient.convertToType(data['max_operation_time'], 'Number');
            }
            if (data.hasOwnProperty('no_unassigned')) {
                obj['no_unassigned'] = ApiClient.convertToType(data['no_unassigned'], 'Number');
            }
            if (data.hasOwnProperty('no_vehicles')) {
                obj['no_vehicles'] = ApiClient.convertToType(data['no_vehicles'], 'Number');
            }
            ...
            if (data.hasOwnProperty('unassigned')) {
                obj['unassigned'] = SolutionUnassigned.constructFromObject(data['unassigned']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['unassigned']) { // data not null
          SolutionUnassigned.validateJSON(data['unassigned']);
        }
 ...
 */
Solution.prototype['completion_time'] = undefined;

/**
 * @member {Number} costs
 */
Solution.prototype['costs'] = undefined;

/**
 * Overall distance travelled in meter, i.e. the sum of each route's transport distance
 * @member {Number} distance
 */
Solution.prototype['distance'] = undefined;

/**
 * Operation time of longest route in seconds.
 * @member {Number} max_operation_time
 */
Solution.prototype['max_operation_time'] = undefined;

/**
 * Number of jobs that could not be assigned to final solution.
 * @member {Number} no_unassigned
 */
Solution.prototype['no_unassigned'] = undefined;

/**
 * Number of employed vehicles.
 * @member {Number} no_vehicles
 */
Solution.prototype['no_vehicles'] = undefined;

/**
 * Overall preparation time in seconds.
 * @member {Number} preparation_time
 */
Solution.prototype['preparation_time'] = undefined;

/**
 * An array of routes
 * @member {Array.<module:model/Route>} routes
 */
Solution.prototype['routes'] = undefined;

/**
 * Overall service time in seconds.
 * @member {Number} service_duration
 */
Solution.prototype['service_duration'] = undefined;

/**
 * Use `transport_time` instead.
 * @member {Number} time
 */
Solution.prototype['time'] = undefined;

/**
 * Overall time travelled in seconds, i.e. the sum of each route's transport time.
 * @member {Number} transport_time
 */
Solution.prototype['transport_time'] = undefined;

/**
 * @member {module:model/SolutionUnassigned} unassigned
 */
Solution.prototype['unassigned'] = undefined;

/**
 * Overall waiting time in seconds.
 * @member {Number} waiting_time
 */
Solution.prototype['waiting_time'] = undefined;
