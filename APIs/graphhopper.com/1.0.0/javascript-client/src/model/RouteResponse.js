    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('paths')) {
                obj['paths'] = ApiClient.convertToType(data['paths'], [RouteResponsePath]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['paths']) { // data not null
            ...
            for (const item of data['paths']) {
                RouteResponsePath.validateJSON(item);
            };
        }
 ...
 */
RouteResponse.prototype['info'] = undefined;

/**
 * @member {Array.<module:model/RouteResponsePath>} paths
 */
RouteResponse.prototype['paths'] = undefined;
