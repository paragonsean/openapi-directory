...
class ClusterRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('configuration')) {
                obj['configuration'] = ClusterConfiguration.constructFromObject(data['configuration']);
            }
            if (data.hasOwnProperty('customers')) {
                obj['customers'] = ApiClient.convertToType(data['customers'], [ClusterCustomer]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['configuration']) { // data not null
          ClusterConfiguration.validateJSON(data['configuration']);
        }
        if (data['customers']) { // data not null
            ...
            for (const item of data['customers']) {
                ClusterCustomer.validateJSON(item);
            };
        }
...
/**
 * @member {module:model/ClusterConfiguration} configuration
 */
ClusterRequest.prototype['configuration'] = undefined;

/**
 * @member {Array.<module:model/ClusterCustomer>} customers
 */
ClusterRequest.prototype['customers'] = undefined;
