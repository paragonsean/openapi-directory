...
class InfoResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('bbox')) {
                obj['bbox'] = ApiClient.convertToType(data['bbox'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['bbox'] && !(typeof data['bbox'] === 'string' || data['bbox'] instanceof String)) {
            throw new Error("Expected the field `bbox` to be a primitive type in the JSON string but got " + data['bbox']);
        }
        // ensure the json data is a string
