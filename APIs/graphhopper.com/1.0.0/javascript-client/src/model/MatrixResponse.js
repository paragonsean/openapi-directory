...
import MatrixResponseHintsInner from './MatrixResponseHintsInner';
...
class MatrixResponse {
    ...
    constructor() { 
        ...
        MatrixResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MatrixResponse();

            if (data.hasOwnProperty('distances')) {
                obj['distances'] = ApiClient.convertToType(data['distances'], [['Number']]);
            }
            if (data.hasOwnProperty('hints')) {
                obj['hints'] = ApiClient.convertToType(data['hints'], [MatrixResponseHintsInner]);
            }
            if (data.hasOwnProperty('info')) {
                obj['info'] = ResponseInfo.constructFromObject(data['info']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MatrixResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatrixResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['hints']) { // data not null
            ...
            for (const item of data['hints']) {
                MatrixResponseHintsInner.validateJSON(item);
            };
        }
        // validate the optional field `info`
        if (data['info']) { // data not null
          ResponseInfo.validateJSON(data['info']);
        }
        // ensure the json data is an array
 ...
 */
MatrixResponse.prototype['distances'] = undefined;

/**
 * Optional. Additional response data.
 * @member {Array.<module:model/MatrixResponseHintsInner>} hints
 */
MatrixResponse.prototype['hints'] = undefined;

/**
 * @member {module:model/ResponseInfo} info
 */
MatrixResponse.prototype['info'] = undefined;
 ...
 */
MatrixResponse.prototype['times'] = undefined;
 ...
 * @member {Array.<Array.<Number>>} weights
 */
MatrixResponse.prototype['weights'] = undefined;
