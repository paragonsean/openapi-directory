...
class VehicleType {
     ...
     * @param typeId {String} Specifies the id of the vehicle type. If a vehicle needs to be of this type, it should refer to this with its type_id attribute.
     */
    constructor(typeId) { 
        
        VehicleType.initialize(this, typeId);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('cost_per_activation')) {
                obj['cost_per_activation'] = ApiClient.convertToType(data['cost_per_activation'], 'Number');
            }
            ...
            if (data.hasOwnProperty('service_time_factor')) {
                obj['service_time_factor'] = ApiClient.convertToType(data['service_time_factor'], 'Number');
            }
            if (data.hasOwnProperty('speed_factor')) {
                obj['speed_factor'] = ApiClient.convertToType(data['speed_factor'], 'Number');
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of VehicleType.RequiredProperties) {
        ...
        if (!Array.isArray(data['capacity'])) {
            throw new Error("Expected the field `capacity` to be an array in the JSON data but got " + data['capacity']);
        }
        ...
        if (data['profile']) { // data not null
          Object.validateJSON(data['profile']);
        }
        // ensure the json data is a string
...
VehicleType.RequiredProperties = ["type_id"];
 ...
 * @member {module:model/VehicleType.NetworkDataProviderEnum} network_data_provider
 * @default 'openstreetmap'
 */
VehicleType.prototype['network_data_provider'] = 'openstreetmap';

/**
 * @member {Object} profile
 */
VehicleType.prototype['profile'] = undefined;
 ...
 * @member {Number} service_time_factor
 * @default 1
 */
VehicleType.prototype['service_time_factor'] = 1;
 ...
 * @member {Number} speed_factor
 * @default 1
 */
VehicleType.prototype['speed_factor'] = 1;
 ...
 */
VehicleType.prototype['type_id'] = undefined;
 ...
 * @readonly
 */
VehicleType['NetworkDataProviderEnum'] = {
