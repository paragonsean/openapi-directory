    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hints')) {
                obj['hints'] = ApiClient.convertToType(data['hints'], [ErrorMessage]);
            }
 ...
 * @member {Array.<module:model/ErrorMessage>} hints
 */
BadRequest.prototype['hints'] = undefined;
 ...
 * @default 'finished'
 */
BadRequest.prototype['status'] = 'finished';
