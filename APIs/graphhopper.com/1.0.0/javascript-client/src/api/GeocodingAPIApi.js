...
/**
* GeocodingAPI service.
* @module api/GeocodingAPIApi
* @version 1.0.0
*/
export default class GeocodingAPIApi {

    /**
    * Constructs a new GeocodingAPIApi. 
    * @alias module:api/GeocodingAPIApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getGeocode operation.
     * @callback module:api/GeocodingAPIApi~getGeocodeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GeocodingResponse} data The data returned by the service call.
     ...
     * @param {String} [locale = 'en')] Display the search results for the specified locale. Currently French (fr), English (en), German (de) and Italian (it) are supported. If the locale wasn't found the default (en) is used.
     * @param {Number} [limit = 10)] Specify the maximum number of results to return
     * @param {Boolean} [reverse = false)] It is `required` to be `true` if you want to do a reverse geocoding request. If it is `true`, `point` must be defined as well, and `q` must not be used.
    ...
    getGeocode(opts, callback) {
      ...
      let returnType = GeocodingResponse;
