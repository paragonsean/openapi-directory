...
/**
* IsochroneAPI service.
* @module api/IsochroneAPIApi
* @version 1.0.0
*/
export default class IsochroneAPIApi {

    /**
    * Constructs a new IsochroneAPIApi. 
    * @alias module:api/IsochroneAPIApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getIsochrone operation.
     * @callback module:api/IsochroneAPIApi~getIsochroneCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IsochroneResponse} data The data returned by the service call.
     ...
     * @param {Number} [timeLimit = 600)] Specify which time the vehicle should travel. In seconds.
     ...
     * @param {Number} [buckets = 1)] Number by which to divide the given `time_limit` to create `buckets` nested isochrones of time intervals `time_limit-n*time_limit/buckets`. Applies analogously to `distance_limit`.
     * @param {Boolean} [reverseFlow = false)] If `false` the flow goes from point to the polygon, if `true` the flow goes from the polygon \"inside\" to the point. Example use case for `false`&#58; *How many potential customer can be reached within 30min travel time from your store* vs. `true`&#58; *How many customers can reach your store within 30min travel time.* 
     * @param {module:model/String} [weighting = 'fastest')] Use `\"shortest\"` to get an isodistance line instead of an isochrone.
     * @param {module:api/IsochroneAPIApi~getIsochroneCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IsochroneResponse}
     */
    getIsochrone(point, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'point' is set
      if (point === undefined || point === null) {
        throw new Error("Missing the required parameter 'point' when calling getIsochrone");
      }
      ...
      let queryParams = {
        ...
        'distance_limit': opts['distanceLimit'],
        'vehicle': opts['vehicle'],
        'buckets': opts['buckets'],
        'reverse_flow': opts['reverseFlow'],
      ...
      let returnType = IsochroneResponse;
