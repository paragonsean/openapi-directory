...
/**
* ClusterAPI service.
* @module api/ClusterAPIApi
* @version 1.0.0
*/
export default class ClusterAPIApi {

    /**
    * Constructs a new ClusterAPIApi. 
    * @alias module:api/ClusterAPIApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the asyncClusteringProblem operation.
     * @callback module:api/ClusterAPIApi~asyncClusteringProblemCallback
     ...
     * @param {module:model/ClusterRequest} clusterRequest Request object that contains the problem to be solved
     * @param {module:api/ClusterAPIApi~asyncClusteringProblemCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JobId}
     */
    asyncClusteringProblem(clusterRequest, callback) {
      ...
      if (clusterRequest === undefined || clusterRequest === null) {
        throw new Error("Missing the required parameter 'clusterRequest' when calling asyncClusteringProblem");
      }
    ...
    /**
     * Callback function to receive the result of the getClusterSolution operation.
     * @callback module:api/ClusterAPIApi~getClusterSolutionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ClusterAPIApi~getClusterSolutionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ClusterResponse}
     */
    getClusterSolution(jobId, callback) {
      let postBody = null;
      // verify the required parameter 'jobId' is set
      if (jobId === undefined || jobId === null) {
        throw new Error("Missing the required parameter 'jobId' when calling getClusterSolution");
      }
    ...
    /**
     * Callback function to receive the result of the solveClusteringProblem operation.
     * @callback module:api/ClusterAPIApi~solveClusteringProblemCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ClusterResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/ClusterRequest} clusterRequest Request object that contains the problem to be solved
     * @param {module:api/ClusterAPIApi~solveClusteringProblemCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ClusterResponse}
     */
    solveClusteringProblem(clusterRequest, callback) {
      let postBody = clusterRequest;
      // verify the required parameter 'clusterRequest' is set
      if (clusterRequest === undefined || clusterRequest === null) {
        throw new Error("Missing the required parameter 'clusterRequest' when calling solveClusteringProblem");
      }
