...
public class Address {
   ...
   */
  @JsonAdapter(CurbsideEnum.Adapter.class)
  public enum CurbsideEnum {
    RIGHT("right"),
    ...
    public static CurbsideEnum fromValue(String value) {
      for (CurbsideEnum b : CurbsideEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<CurbsideEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final CurbsideEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public CurbsideEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return CurbsideEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      CurbsideEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_CURBSIDE = "curbside";
  @SerializedName(SERIALIZED_NAME_CURBSIDE)
  private CurbsideEnum curbside = CurbsideEnum.ANY;
  ...
  public Address curbside(CurbsideEnum curbside) {
  ...
  public CurbsideEnum getCurbside() {
    return curbside;
  }

  public void setCurbside(CurbsideEnum curbside) {
    this.curbside = curbside;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.curbside, address.curbside) &&
        Objects.equals(this.lat, address.lat) &&
        Objects.equals(this.locationId, address.locationId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(curbside, lat, locationId, lon, name, streetHint);
  }
  ...
  public String toString() {
    ...
    sb.append("    curbside: ").append(toIndentedString(curbside)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("curbside") != null && !jsonObj.get("curbside").isJsonNull()) && !jsonObj.get("curbside").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `curbside` to be a primitive type in the JSON string but got `%s`", jsonObj.get("curbside").toString()));
      }
      // validate the optional field `curbside`
      if (jsonObj.get("curbside") != null && !jsonObj.get("curbside").isJsonNull()) {
        CurbsideEnum.validateJsonElement(jsonObj.get("curbside"));
      }
