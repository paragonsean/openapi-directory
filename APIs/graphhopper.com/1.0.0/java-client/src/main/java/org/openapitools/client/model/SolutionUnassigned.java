...
public class SolutionUnassigned {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.breaks, solutionUnassigned.breaks) &&
        Objects.equals(this.details, solutionUnassigned.details) &&
        Objects.equals(this.services, solutionUnassigned.services) &&
        Objects.equals(this.shipments, solutionUnassigned.shipments);
  }

  @Override
  public int hashCode() {
    return Objects.hash(breaks, details, services, shipments);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SolutionUnassigned
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SolutionUnassigned.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SolutionUnassigned is not found in the empty JSON string", SolutionUnassigned.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SolutionUnassigned.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SolutionUnassigned` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("breaks") != null && !jsonObj.get("breaks").isJsonNull() && !jsonObj.get("breaks").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("shipments") != null && !jsonObj.get("shipments").isJsonNull() && !jsonObj.get("shipments").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SolutionUnassigned.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SolutionUnassigned' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SolutionUnassigned> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SolutionUnassigned.class));

       return (TypeAdapter<T>) new TypeAdapter<SolutionUnassigned>() {
           @Override
           public void write(JsonWriter out, SolutionUnassigned value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SolutionUnassigned read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SolutionUnassigned given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SolutionUnassigned
   * @throws IOException if the JSON string is invalid with respect to SolutionUnassigned
   */
  public static SolutionUnassigned fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SolutionUnassigned.class);
  }

  /**
   * Convert an instance of SolutionUnassigned to an JSON string
   *
   * @return JSON string
   */
