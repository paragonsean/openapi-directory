...
public class RouteOptimizationApiApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public RouteOptimizationApiApi() {
        this(Configuration.getDefaultApiClient());
    }

    public RouteOptimizationApiApi(ApiClient apiClient) {
    ...
    /**
     * Build call for asyncVRP
     * @param request The request that contains the problem to be solved. (required)
     ...
     */
    public okhttp3.Call asyncVRPCall(Request request, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call asyncVRPValidateBeforeCall(Request request, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'request' is set
        if (request == null) {
            throw new ApiException("Missing the required parameter 'request' when calling asyncVRP(Async)");
        }

        return asyncVRPCall(request, _callback);
     ...
     */
    public JobId asyncVRP(Request request) throws ApiException {
        ApiResponse<JobId> localVarResp = asyncVRPWithHttpInfo(request);
     ...
     */
    public ApiResponse<JobId> asyncVRPWithHttpInfo(Request request) throws ApiException {
        okhttp3.Call localVarCall = asyncVRPValidateBeforeCall(request, null);
        Type localVarReturnType = new TypeToken<JobId>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * POST route optimization problem (batch mode) (asynchronously)
     *  To solve a vehicle routing problem, perform the following steps:  1.) Make a HTTP POST to this URL  &#x60;&#x60;&#x60; https://graphhopper.com/api/1/vrp/optimize?key&#x3D;&lt;your_key&gt; &#x60;&#x60;&#x60;  It returns a job id (job_id).  2.) Take the job id and fetch the solution for the vehicle routing problem from this URL:  &#x60;&#x60;&#x60; https://graphhopper.com/api/1/vrp/solution/&lt;job_id&gt;?key&#x3D;&lt;your_key&gt; &#x60;&#x60;&#x60;  We recommend to query the solution every 500ms until it returns &#39;status&#x3D;finished&#39;.  **Note**: Since the workflow is a bit more cumbersome and since you lose some time in fetching the solution, you should always prefer the [synchronous endpoint](#operation/solveVRP). You should use the batch mode only for long running problems. 
     * @param request The request that contains the problem to be solved. (required)
     ...
     */
    public okhttp3.Call asyncVRPAsync(Request request, final ApiCallback<JobId> _callback) throws ApiException {

        okhttp3.Call localVarCall = asyncVRPValidateBeforeCall(request, _callback);
        Type localVarReturnType = new TypeToken<JobId>(){}.getType();
     ...
     */
    public okhttp3.Call getSolutionCall(String jobId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSolutionValidateBeforeCall(String jobId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'jobId' is set
        if (jobId == null) {
            throw new ApiException("Missing the required parameter 'jobId' when calling getSolution(Async)");
        }

        return getSolutionCall(jobId, _callback);
    ...
    public Response getSolution(String jobId) throws ApiException {
        ApiResponse<Response> localVarResp = getSolutionWithHttpInfo(jobId);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Response> getSolutionWithHttpInfo(String jobId) throws ApiException {
        okhttp3.Call localVarCall = getSolutionValidateBeforeCall(jobId, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GET the solution (batch mode) (asynchronously)
     *  Take the job id and fetch the solution for the vehicle routing problem from this URL:  &#x60;&#x60;&#x60; https://graphhopper.com/api/1/vrp/solution/&lt;job_id&gt;?key&#x3D;&lt;your_key&gt; &#x60;&#x60;&#x60;  You get the job id by sending a vehicle routing problem to the [batch mode URL](#operation/asyncVRP). 
     * @param jobId Request solution with jobId (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getSolutionAsync(String jobId, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSolutionValidateBeforeCall(jobId, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param request The request that contains the vehicle routing problem to be solved. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call solveVRPCall(Request request, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call solveVRPValidateBeforeCall(Request request, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'request' is set
        if (request == null) {
            throw new ApiException("Missing the required parameter 'request' when calling solveVRP(Async)");
        }

        return solveVRPCall(request, _callback);
     ...
     */
    public Response solveVRP(Request request) throws ApiException {
        ApiResponse<Response> localVarResp = solveVRPWithHttpInfo(request);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Response> solveVRPWithHttpInfo(Request request) throws ApiException {
        okhttp3.Call localVarCall = solveVRPValidateBeforeCall(request, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * POST route optimization problem (asynchronously)
     *  To get started with the Route Optimization API, please read the [introduction](#tag/Route-Optimization-API).  To solve a new vehicle routing problem, make a HTTP POST to this URL  &#x60;&#x60;&#x60; https://graphhopper.com/api/1/vrp?key&#x3D;&lt;your_key&gt; &#x60;&#x60;&#x60;  It returns the solution to this problem in the JSON response.  Please note that this URL is very well suited to solve minor problems. Larger vehicle routing problems, which take longer than 10 seconds to solve, cannot be solved. To solve them, please use the [batch mode URL](#operation/asyncVRP) instead. 
     * @param request The request that contains the vehicle routing problem to be solved. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call solveVRPAsync(Request request, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = solveVRPValidateBeforeCall(request, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
