...
public class CostMatrixDataInfo {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CostMatrixDataInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CostMatrixDataInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CostMatrixDataInfo is not found in the empty JSON string", CostMatrixDataInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CostMatrixDataInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CostMatrixDataInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CostMatrixDataInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CostMatrixDataInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CostMatrixDataInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CostMatrixDataInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<CostMatrixDataInfo>() {
           @Override
           public void write(JsonWriter out, CostMatrixDataInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CostMatrixDataInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CostMatrixDataInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CostMatrixDataInfo
   * @throws IOException if the JSON string is invalid with respect to CostMatrixDataInfo
   */
  public static CostMatrixDataInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CostMatrixDataInfo.class);
  }

  /**
   * Convert an instance of CostMatrixDataInfo to an JSON string
   *
   * @return JSON string
   */
