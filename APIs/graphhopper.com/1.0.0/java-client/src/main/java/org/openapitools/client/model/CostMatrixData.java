...
public class CostMatrixData {
  ...
  private CostMatrixDataInfo info;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.distances, costMatrixData.distances) &&
        Objects.equals(this.info, costMatrixData.info) &&
        Objects.equals(this.times, costMatrixData.times);
  }

  @Override
  public int hashCode() {
    return Objects.hash(distances, info, times);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CostMatrixData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CostMatrixData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CostMatrixData is not found in the empty JSON string", CostMatrixData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CostMatrixData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CostMatrixData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("info") != null && !jsonObj.get("info").isJsonNull()) {
        CostMatrixDataInfo.validateJsonElement(jsonObj.get("info"));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CostMatrixData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CostMatrixData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CostMatrixData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CostMatrixData.class));

       return (TypeAdapter<T>) new TypeAdapter<CostMatrixData>() {
           @Override
           public void write(JsonWriter out, CostMatrixData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CostMatrixData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CostMatrixData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CostMatrixData
   * @throws IOException if the JSON string is invalid with respect to CostMatrixData
   */
  public static CostMatrixData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CostMatrixData.class);
  }

  /**
   * Convert an instance of CostMatrixData to an JSON string
   *
   * @return JSON string
   */
