...
public class Algorithm {
  ...
  public enum ProblemTypeEnum {
    ...
    public static ProblemTypeEnum fromValue(String value) {
    ...
    public static class Adapter extends TypeAdapter<ProblemTypeEnum> {
      ...
      public ProblemTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ProblemTypeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ProblemTypeEnum.fromValue(value);
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.objective, algorithm.objective) &&
        Objects.equals(this.problemType, algorithm.problemType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(objective, problemType);
  }
  ...
  static {
    ...
    openapiFields.add("problem_type");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("problem_type") != null && !jsonObj.get("problem_type").isJsonNull()) && !jsonObj.get("problem_type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `problem_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("problem_type").toString()));
      }
      // validate the optional field `problem_type`
      if (jsonObj.get("problem_type") != null && !jsonObj.get("problem_type").isJsonNull()) {
        ProblemTypeEnum.validateJsonElement(jsonObj.get("problem_type"));
      }
  }
