...
public class SymmetricalMatrixRequest {
  ...
  public SymmetricalMatrixRequest curbsides(List<String> curbsides) {
    this.curbsides = curbsides;
    return this;
  }

  public SymmetricalMatrixRequest addCurbsidesItem(String curbsidesItem) {
  ...
  public void setCurbsides(List<String> curbsides) {
    this.curbsides = curbsides;
  }
  ...
  public SymmetricalMatrixRequest turnCosts(Boolean turnCosts) {
  ...
  public SymmetricalMatrixRequest vehicle(VehicleProfileId vehicle) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.curbsides, symmetricalMatrixRequest.curbsides) &&
        ...
        Objects.equals(this.points, symmetricalMatrixRequest.points) &&
        Objects.equals(this.snapPreventions, symmetricalMatrixRequest.snapPreventions) &&
        Objects.equals(this.turnCosts, symmetricalMatrixRequest.turnCosts) &&
        Objects.equals(this.vehicle, symmetricalMatrixRequest.vehicle);
  }

  @Override
  public int hashCode() {
    return Objects.hash(curbsides, failFast, outArrays, pointHints, points, snapPreventions, turnCosts, vehicle);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SymmetricalMatrixRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SymmetricalMatrixRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SymmetricalMatrixRequest is not found in the empty JSON string", SymmetricalMatrixRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SymmetricalMatrixRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SymmetricalMatrixRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SymmetricalMatrixRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SymmetricalMatrixRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SymmetricalMatrixRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SymmetricalMatrixRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SymmetricalMatrixRequest>() {
           @Override
           public void write(JsonWriter out, SymmetricalMatrixRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SymmetricalMatrixRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SymmetricalMatrixRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SymmetricalMatrixRequest
   * @throws IOException if the JSON string is invalid with respect to SymmetricalMatrixRequest
   */
  public static SymmetricalMatrixRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SymmetricalMatrixRequest.class);
  }

  /**
   * Convert an instance of SymmetricalMatrixRequest to an JSON string
   *
   * @return JSON string
   */
