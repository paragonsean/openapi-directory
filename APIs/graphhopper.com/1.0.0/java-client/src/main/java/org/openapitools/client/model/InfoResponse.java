...
public class InfoResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bbox, infoResponse.bbox) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bbox, features, version);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("bbox") != null && !jsonObj.get("bbox").isJsonNull()) && !jsonObj.get("bbox").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `bbox` to be a primitive type in the JSON string but got `%s`", jsonObj.get("bbox").toString()));
      }
