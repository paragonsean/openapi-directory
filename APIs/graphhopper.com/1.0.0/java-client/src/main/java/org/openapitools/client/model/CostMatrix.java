...
import org.openapitools.client.model.CostMatrixData;
...
public class CostMatrix {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, costMatrix.data) &&
        Objects.equals(this.locationIds, costMatrix.locationIds) &&
        Objects.equals(this.profile, costMatrix.profile) &&
        Objects.equals(this.type, costMatrix.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, locationIds, profile, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CostMatrix
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CostMatrix.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CostMatrix is not found in the empty JSON string", CostMatrix.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CostMatrix.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CostMatrix` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        CostMatrixData.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CostMatrix.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CostMatrix' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CostMatrix> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CostMatrix.class));

       return (TypeAdapter<T>) new TypeAdapter<CostMatrix>() {
           @Override
           public void write(JsonWriter out, CostMatrix value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CostMatrix read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CostMatrix given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CostMatrix
   * @throws IOException if the JSON string is invalid with respect to CostMatrix
   */
  public static CostMatrix fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CostMatrix.class);
  }

  /**
   * Convert an instance of CostMatrix to an JSON string
   *
   * @return JSON string
   */
