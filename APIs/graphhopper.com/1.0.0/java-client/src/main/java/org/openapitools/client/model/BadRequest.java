...
public class BadRequest {
  ...
  private List<ErrorMessage> hints = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hints, badRequest.hints) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hints, message, status);
  }
      ...
      if (jsonObj.get("hints") != null && !jsonObj.get("hints").isJsonNull()) {
        ...
        if (jsonArrayhints != null) {
          ...
          for (int i = 0; i < jsonArrayhints.size(); i++) {
            ErrorMessage.validateJsonElement(jsonArrayhints.get(i));
          };
        }
      }
