...
/**
 * API tests for GeocodingApiApi
 */
@Disabled
public class GeocodingApiApiTest {

    private final GeocodingApiApi api = new GeocodingApiApi();
     ...
     */
    @Test
    public void getGeocodeTest() throws ApiException {
        String q = null;
        String locale = null;
        Integer limit = null;
        ...
        GeocodingResponse response = api.getGeocode(q, locale, limit, reverse, debug, point, provider);
