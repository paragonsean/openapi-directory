...
/**
 * API tests for ClusterApiApi
 */
@Disabled
public class ClusterApiApiTest {

    private final ClusterApiApi api = new ClusterApiApi();
     ...
     */
    @Test
    public void asyncClusteringProblemTest() throws ApiException {
        ClusterRequest clusterRequest = null;
        JobId response = api.asyncClusteringProblem(clusterRequest);
     ...
     */
    @Test
    public void getClusterSolutionTest() throws ApiException {
        String jobId = null;
        ClusterResponse response = api.getClusterSolution(jobId);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void solveClusteringProblemTest() throws ApiException {
        ClusterRequest clusterRequest = null;
        ClusterResponse response = api.solveClusteringProblem(clusterRequest);
        // TODO: test validations
    }
