...
/**
 * API tests for RouteOptimizationApiApi
 */
@Disabled
public class RouteOptimizationApiApiTest {

    private final RouteOptimizationApiApi api = new RouteOptimizationApiApi();
     ...
     */
    @Test
    public void asyncVRPTest() throws ApiException {
        Request request = null;
        JobId response = api.asyncVRP(request);
    ...
    public void solveVRPTest() throws ApiException {
        Request request = null;
        Response response = api.solveVRP(request);
        // TODO: test validations
    }
