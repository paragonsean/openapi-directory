...
class Segment {
     ...
     * @param episodeId {Number} The ID of the episode that owns the segment.
     * @param segmentNumber {Number} The number of the segment in the episode, starting with 1.
     */
    constructor(episodeId, segmentNumber) { 
        
        Segment.initialize(this, episodeId, segmentNumber);
    }
     ...
     */
    static initialize(obj, episodeId, segmentNumber) { 
        obj['episodeId'] = episodeId;
        obj['segmentNumber'] = segmentNumber;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('inCue')) {
                obj['inCue'] = ApiClient.convertToType(data['inCue'], 'String');
            }
            ...
            if (data.hasOwnProperty('outCue')) {
                obj['outCue'] = ApiClient.convertToType(data['outCue'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['inCue'] && !(typeof data['inCue'] === 'string' || data['inCue'] instanceof String)) {
            throw new Error("Expected the field `inCue` to be a primitive type in the JSON string but got " + data['inCue']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['outCue'] && !(typeof data['outCue'] === 'string' || data['outCue'] instanceof String)) {
            throw new Error("Expected the field `outCue` to be a primitive type in the JSON string but got " + data['outCue']);
        }
