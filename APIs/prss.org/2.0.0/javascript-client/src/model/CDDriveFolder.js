...
/**
 * The CDDriveFolder model module.
 * @module model/CDDriveFolder
 * @version 2.0.0
 */
class CDDriveFolder {
    /**
     * Constructs a new <code>CDDriveFolder</code>.
     * A folder in the CD Drive that can contain other items such as files or folders.
     * @alias module:model/CDDriveFolder
     * @param createdDate {String} The date and time the folder was created.
     * @param id {Number} The ID of the folder.
     * @param lastModifiedDate {String} The date and time the folder was last modified. This may only represent a modification to to the folder metadata itself, not to the contents of the folder.
    ...
    constructor(createdDate, id, lastModifiedDate, name, parentId) { 
        ...
        CDDriveFolder.initialize(this, createdDate, id, lastModifiedDate, name, parentId);
    }
    ...
    /**
     * Constructs a <code>CDDriveFolder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CDDriveFolder} obj Optional instance to populate.
     * @return {module:model/CDDriveFolder} The populated <code>CDDriveFolder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CDDriveFolder();
    ...
    /**
     * Validates the JSON data with respect to <code>CDDriveFolder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CDDriveFolder</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CDDriveFolder.RequiredProperties) {
...
CDDriveFolder.RequiredProperties = ["createdDate", "id", "lastModifiedDate", "name", "parentId"];

/**
 * The date and time the folder was created.
 * @member {String} createdDate
 */
CDDriveFolder.prototype['createdDate'] = undefined;

/**
 * The ID of the folder.
 * @member {Number} id
 */
CDDriveFolder.prototype['id'] = undefined;
 ...
 */
CDDriveFolder.prototype['lastModifiedDate'] = undefined;

/**
 * The name of the folder.
 * @member {String} name
 */
CDDriveFolder.prototype['name'] = undefined;

/**
 * The ID of the parent folder or 0 for the root folder.
 * @member {Number} parentId
 */
CDDriveFolder.prototype['parentId'] = undefined;
