...
class Episode {
     ...
     * @param beginAirDate {Date} The date the air window opens for the episode.
     * @param endAirDate {Date} The date the air window closes for the episode.
     * @param programId {Number} The ID of the program that owns this episode.
     * @param title {String} The title of the program.
     */
    constructor(beginAirDate, endAirDate, programId, title) { 
        
        Episode.initialize(this, beginAirDate, endAirDate, programId, title);
    }
     ...
     */
    static initialize(obj, beginAirDate, endAirDate, programId, title) { 
        obj['beginAirDate'] = beginAirDate;
        obj['endAirDate'] = endAirDate;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('beginAirDate')) {
                obj['beginAirDate'] = ApiClient.convertToType(data['beginAirDate'], 'Date');
            }
            if (data.hasOwnProperty('beginTransmissionDate')) {
                obj['beginTransmissionDate'] = ApiClient.convertToType(data['beginTransmissionDate'], 'Date');
            }
            ...
            if (data.hasOwnProperty('endAirDate')) {
                obj['endAirDate'] = ApiClient.convertToType(data['endAirDate'], 'Date');
            }
            if (data.hasOwnProperty('endTransmissionDate')) {
                obj['endTransmissionDate'] = ApiClient.convertToType(data['endTransmissionDate'], 'Date');
            }
...
Episode.RequiredProperties = ["beginAirDate", "endAirDate", "programId", "title"];

/**
 * The date the air window opens for the episode.
 * @member {Date} beginAirDate
 */
Episode.prototype['beginAirDate'] = undefined;

/**
 * The date the live stream begins for the episode. Only set for live and LWSF episodes.
 * @member {Date} beginTransmissionDate
 */
Episode.prototype['beginTransmissionDate'] = undefined;

/**
 * The date the segment was created. Generated at creation.
 * @member {Date} createdDate
 */
Episode.prototype['createdDate'] = undefined;

/**
 * The ID of the customer that owns this programs.
 * @member {Number} customerId
 */
Episode.prototype['customerId'] = undefined;

/**
 * The date the air window closes for the episode.
 * @member {Date} endAirDate
 */
Episode.prototype['endAirDate'] = undefined;

/**
 * The date the live stream ends for the episode. Only set for live and LWSF episodes.
 * @member {Date} endTransmissionDate
 */
Episode.prototype['endTransmissionDate'] = undefined;
 ...
 */
Episode.prototype['lastModifiedDate'] = undefined;

/**
 * The ID of the program that owns this episode.
 * @member {Number} programId
 */
Episode.prototype['programId'] = undefined;
