...
/**
 * The ApiV2MetapubProgramInformationBatchPostRequestProgram model module.
 * @module model/ApiV2MetapubProgramInformationBatchPostRequestProgram
 * @version 2.0.0
 */
class ApiV2MetapubProgramInformationBatchPostRequestProgram {
    /**
     * Constructs a new <code>ApiV2MetapubProgramInformationBatchPostRequestProgram</code>.
     ...
     * @alias module:model/ApiV2MetapubProgramInformationBatchPostRequestProgram
     * @param airDate {String} 
     * @param title {String} 
     */
    constructor(airDate, title) { 
        
        ApiV2MetapubProgramInformationBatchPostRequestProgram.initialize(this, airDate, title);
    }
    ...
    /**
     * Constructs a <code>ApiV2MetapubProgramInformationBatchPostRequestProgram</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2MetapubProgramInformationBatchPostRequestProgram} obj Optional instance to populate.
     * @return {module:model/ApiV2MetapubProgramInformationBatchPostRequestProgram} The populated <code>ApiV2MetapubProgramInformationBatchPostRequestProgram</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2MetapubProgramInformationBatchPostRequestProgram();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2MetapubProgramInformationBatchPostRequestProgram</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2MetapubProgramInformationBatchPostRequestProgram</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV2MetapubProgramInformationBatchPostRequestProgram.RequiredProperties) {
...
ApiV2MetapubProgramInformationBatchPostRequestProgram.RequiredProperties = ["airDate", "title"];

/**
 * @member {String} airDate
 */
ApiV2MetapubProgramInformationBatchPostRequestProgram.prototype['airDate'] = undefined;

/**
 * @member {String} title
 */
ApiV2MetapubProgramInformationBatchPostRequestProgram.prototype['title'] = undefined;
...
export default ApiV2MetapubProgramInformationBatchPostRequestProgram;
