...
/**
* RadioDNS service.
* @module api/RadioDNSApi
* @version 2.0.0
*/
export default class RadioDNSApi {

    /**
    * Constructs a new RadioDNSApi. 
    * @alias module:api/RadioDNSApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the radiodnsSpi31GIXmlGet operation.
     * @callback module:api/RadioDNSApi~radiodnsSpi31GIXmlGetCallback
     ...
     * @param {module:api/RadioDNSApi~radiodnsSpi31GIXmlGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link String}
     */
    radiodnsSpi31GIXmlGet(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the radiodnsSpi31IdFqdnSidDatePIXmlGet operation.
     * @callback module:api/RadioDNSApi~radiodnsSpi31IdFqdnSidDatePIXmlGetCallback
     * @param {String} error Error message, if any.
     * @param {String} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} fqdn The fully qualified domain name for the environment where the service is running. The fqdn is defined in the `radiodns` element in the SI document in each Content Depot environment.
     * @param {String} sid One of the valid service IDs defined in the SI document. For example, \"files\" or \"streams\".
     * @param {String} date The PI schedule date to retrieve in format yyyymmdd.
     * @param {Object} opts Optional parameters
     * @param {String} [xRadiodnsspiApiKey] The API client Id you received. This is required for National PI documents, but not Station PI documents. Contact help desk if you need one.
     * @param {module:api/RadioDNSApi~radiodnsSpi31IdFqdnSidDatePIXmlGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link String}
     */
    radiodnsSpi31IdFqdnSidDatePIXmlGet(fqdn, sid, date, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'fqdn' is set
      if (fqdn === undefined || fqdn === null) {
        throw new Error("Missing the required parameter 'fqdn' when calling radiodnsSpi31IdFqdnSidDatePIXmlGet");
      }
      // verify the required parameter 'sid' is set
      if (sid === undefined || sid === null) {
        throw new Error("Missing the required parameter 'sid' when calling radiodnsSpi31IdFqdnSidDatePIXmlGet");
      }
      // verify the required parameter 'date' is set
      if (date === undefined || date === null) {
        throw new Error("Missing the required parameter 'date' when calling radiodnsSpi31IdFqdnSidDatePIXmlGet");
      }
      ...
      let headerParams = {
        'x-radiodnsspi-api-key': opts['xRadiodnsspiApiKey']
      };
      let formParams = {
      };
      ...
      let accepts = ['application/xml'];
      let returnType = 'String';
      let basePaths = ['/', 'https://radiodns.prss.org', 'https://radiodnsstage.prss.org', 'https://radiodnsdev.mgmt.prss.org'];
      ...
      return this.apiClient.callApi(
        '/radiodns/spi/3.1/id/{fqdn}/{sid}/{date}_PI.xml', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
    ...
    /**
     * Callback function to receive the result of the radiodnsSpi31SIXmlGet operation.
     * @callback module:api/RadioDNSApi~radiodnsSpi31SIXmlGetCallback
     * @param {String} error Error message, if any.
     * @param {String} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/RadioDNSApi~radiodnsSpi31SIXmlGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link String}
     */
    radiodnsSpi31SIXmlGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
