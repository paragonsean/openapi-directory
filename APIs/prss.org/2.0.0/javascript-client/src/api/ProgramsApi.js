...
export default class ProgramsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apiV2ProgramsIdGet operation.
     * @callback module:api/ProgramsApi~apiV2ProgramsIdGetCallback
     ...
     * @param {Number} id The ID of the program to operate on.
     * @param {module:api/ProgramsApi~apiV2ProgramsIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Program}
     */
    apiV2ProgramsIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling apiV2ProgramsIdGet");
      }
    ...
    /**
     * Callback function to receive the result of the apiV2ProgramsSearchGet operation.
     * @callback module:api/ProgramsApi~apiV2ProgramsSearchGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ProgramsApi~apiV2ProgramsSearchGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Program>}
     */
    apiV2ProgramsSearchGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
