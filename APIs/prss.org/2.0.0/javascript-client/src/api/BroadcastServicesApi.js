...
/**
* BroadcastServices service.
* @module api/BroadcastServicesApi
* @version 2.0.0
*/
export default class BroadcastServicesApi {

    /**
    * Constructs a new BroadcastServicesApi. 
    * @alias module:api/BroadcastServicesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apiV2BroadcastservicesGet operation.
     * @callback module:api/BroadcastServicesApi~apiV2BroadcastservicesGetCallback
     ...
     * @param {module:model/String} [orderById] The sort order of the list of broadcast services, based on broadcast service ID. If unspecified, the broadcast services are returned in random order. If using paging to iterate through the results, sort order should be specified.
     * @param {module:api/BroadcastServicesApi~apiV2BroadcastservicesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Episode>}
     */
    apiV2BroadcastservicesGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the apiV2BroadcastservicesIdGet operation.
     * @callback module:api/BroadcastServicesApi~apiV2BroadcastservicesIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/BroadcastService} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Returns the broadcast service matching the given ID.
     * @param {Number} id The ID of the broadcast service to find.
     * @param {module:api/BroadcastServicesApi~apiV2BroadcastservicesIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BroadcastService}
     */
    apiV2BroadcastservicesIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling apiV2BroadcastservicesIdGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = BroadcastService;
      return this.apiClient.callApi(
        '/api/v2/broadcastservices/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
