...
export default class EpisodesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apiV2EpisodesGet operation.
     * @callback module:api/EpisodesApi~apiV2EpisodesGetCallback
     ...
     * @param {module:model/String} [orderById] The sort order of the list of episodes, based on episode ID. If unspecified, the episodes are returned in random order. If using paging to iterate through the results, sort order should be specified.
     * @param {module:api/EpisodesApi~apiV2EpisodesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Episode>}
     */
    apiV2EpisodesGet(programId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'programId' is set
      if (programId === undefined || programId === null) {
        throw new Error("Missing the required parameter 'programId' when calling apiV2EpisodesGet");
      }
      ...
      let queryParams = {
        'id': opts['id'],
        'beginAirDateAfter': opts['beginAirDateAfter'],
        'endAirDateBefore': opts['endAirDateBefore'],
        'programId': programId,
    ...
    /**
     * Callback function to receive the result of the apiV2EpisodesIdGet operation.
     * @callback module:api/EpisodesApi~apiV2EpisodesIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Episode} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Returns the episode matching the given ID.
     * @param {Number} id The ID of the episode to operate on.
     * @param {module:api/EpisodesApi~apiV2EpisodesIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Episode}
     */
    apiV2EpisodesIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling apiV2EpisodesIdGet");
      }
