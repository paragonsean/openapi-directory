...
/**
* SpotInsertions service.
* @module api/SpotInsertionsApi
* @version 2.0.0
*/
export default class SpotInsertionsApi {

    /**
    * Constructs a new SpotInsertionsApi. 
    * @alias module:api/SpotInsertionsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apiV2SpotinsertionsGet operation.
     * @callback module:api/SpotInsertionsApi~apiV2SpotinsertionsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/SpotInsertion>} data The data returned by the service call.
     ...
     * @param {module:model/String} [orderById] The sort order of the list of spot insertions, based on ID. If unspecified, the spot insertions are returned in random order. If using paging to iterate through the results, sort order should be specified.
     * @param {module:api/SpotInsertionsApi~apiV2SpotinsertionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/SpotInsertion>}
     */
    apiV2SpotinsertionsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = [SpotInsertion];
      return this.apiClient.callApi(
        '/api/v2/spotinsertions', 'GET',
    ...
    /**
     * Callback function to receive the result of the apiV2SpotinsertionsIdDelete operation.
     * @callback module:api/SpotInsertionsApi~apiV2SpotinsertionsIdDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} id 
     * @param {module:api/SpotInsertionsApi~apiV2SpotinsertionsIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    apiV2SpotinsertionsIdDelete(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling apiV2SpotinsertionsIdDelete");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/api/v2/spotinsertions/{id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the apiV2SpotinsertionsIdGet operation.
     * @callback module:api/SpotInsertionsApi~apiV2SpotinsertionsIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SpotInsertion} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id 
     * @param {module:api/SpotInsertionsApi~apiV2SpotinsertionsIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SpotInsertion}
     */
    apiV2SpotinsertionsIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling apiV2SpotinsertionsIdGet");
      }
    ...
    /**
     * Callback function to receive the result of the apiV2SpotinsertionsPost operation.
     * @callback module:api/SpotInsertionsApi~apiV2SpotinsertionsPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SpotInsertion} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/SpotInsertion} [spotInsertion] 
     * @param {module:api/SpotInsertionsApi~apiV2SpotinsertionsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SpotInsertion}
     */
    apiV2SpotinsertionsPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['spotInsertion'];
