...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.CDDriveItem();
  });
  ...
  describe('CDDriveItem', function() {
    it('should create an instance of CDDriveItem', function() {
      // uncomment below and update the code to test CDDriveItem
      //var instance = new ContentDepot.CDDriveItem();
      //expect(instance).to.be.a(ContentDepot.CDDriveItem);
    });
