...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.Spot();
  });
  ...
  describe('Spot', function() {
    it('should create an instance of Spot', function() {
      ...
      //var instance = new ContentDepot.Spot();
      //expect(instance).to.be.a(ContentDepot.Spot);
    });
    ...
    it('should have the property lastUploadedDate (base name: "lastUploadedDate")', function() {
      // uncomment below and update the code to test the property lastUploadedDate
      //var instance = new ContentDepot.Spot();
      //expect(instance).to.be();
    });
