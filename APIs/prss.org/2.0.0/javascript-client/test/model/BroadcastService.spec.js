...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.BroadcastService();
  });
  ...
  describe('BroadcastService', function() {
    it('should create an instance of BroadcastService', function() {
      // uncomment below and update the code to test BroadcastService
      //var instance = new ContentDepot.BroadcastService();
      //expect(instance).to.be.a(ContentDepot.BroadcastService);
    });
