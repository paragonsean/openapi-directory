...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.SpotInsertion();
  });
  ...
  describe('SpotInsertion', function() {
    it('should create an instance of SpotInsertion', function() {
      // uncomment below and update the code to test SpotInsertion
      //var instance = new ContentDepot.SpotInsertion();
      //expect(instance).to.be.a(ContentDepot.SpotInsertion);
    });

    it('should have the property broadcastServiceId (base name: "broadcastServiceId")', function() {
      // uncomment below and update the code to test the property broadcastServiceId
      //var instance = new ContentDepot.SpotInsertion();
    ...
    it('should have the property cue (base name: "cue")', function() {
      // uncomment below and update the code to test the property cue
      //var instance = new ContentDepot.SpotInsertion();
      //expect(instance).to.be();
    });
