...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.Episode();
  });
  ...
  describe('Episode', function() {
    it('should create an instance of Episode', function() {
      ...
      //var instance = new ContentDepot.Episode();
      //expect(instance).to.be.a(ContentDepot.Episode);
    });

    it('should have the property beginAirDate (base name: "beginAirDate")', function() {
      // uncomment below and update the code to test the property beginAirDate
      //var instance = new ContentDepot.Episode();
      //expect(instance).to.be();
    });

    it('should have the property beginTransmissionDate (base name: "beginTransmissionDate")', function() {
      // uncomment below and update the code to test the property beginTransmissionDate
      //var instance = new ContentDepot.Episode();
      //expect(instance).to.be();
    });
    ...
    it('should have the property endAirDate (base name: "endAirDate")', function() {
      // uncomment below and update the code to test the property endAirDate
      //var instance = new ContentDepot.Episode();
      //expect(instance).to.be();
    });

    it('should have the property endTransmissionDate (base name: "endTransmissionDate")', function() {
      // uncomment below and update the code to test the property endTransmissionDate
      //var instance = new ContentDepot.Episode();
      //expect(instance).to.be();
    });
