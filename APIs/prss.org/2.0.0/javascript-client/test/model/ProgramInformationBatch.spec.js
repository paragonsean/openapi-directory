...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.ProgramInformationBatch();
  });
  ...
  describe('ProgramInformationBatch', function() {
    it('should create an instance of ProgramInformationBatch', function() {
      // uncomment below and update the code to test ProgramInformationBatch
      //var instance = new ContentDepot.ProgramInformationBatch();
      //expect(instance).to.be.a(ContentDepot.ProgramInformationBatch);
    });
