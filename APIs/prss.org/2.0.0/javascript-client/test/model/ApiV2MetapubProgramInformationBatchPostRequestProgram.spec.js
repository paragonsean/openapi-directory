...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.ApiV2MetapubProgramInformationBatchPostRequestProgram();
  });
  ...
  describe('ApiV2MetapubProgramInformationBatchPostRequestProgram', function() {
    it('should create an instance of ApiV2MetapubProgramInformationBatchPostRequestProgram', function() {
      // uncomment below and update the code to test ApiV2MetapubProgramInformationBatchPostRequestProgram
      //var instance = new ContentDepot.ApiV2MetapubProgramInformationBatchPostRequestProgram();
      //expect(instance).to.be.a(ContentDepot.ApiV2MetapubProgramInformationBatchPostRequestProgram);
    });
