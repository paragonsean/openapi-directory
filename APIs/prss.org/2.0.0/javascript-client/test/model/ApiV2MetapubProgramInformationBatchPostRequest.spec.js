...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.ApiV2MetapubProgramInformationBatchPostRequest();
  });
  ...
  describe('ApiV2MetapubProgramInformationBatchPostRequest', function() {
    it('should create an instance of ApiV2MetapubProgramInformationBatchPostRequest', function() {
      // uncomment below and update the code to test ApiV2MetapubProgramInformationBatchPostRequest
      //var instance = new ContentDepot.ApiV2MetapubProgramInformationBatchPostRequest();
      //expect(instance).to.be.a(ContentDepot.ApiV2MetapubProgramInformationBatchPostRequest);
    });
