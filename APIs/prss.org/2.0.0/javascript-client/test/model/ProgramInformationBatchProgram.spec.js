...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.ProgramInformationBatchProgram();
  });
  ...
  describe('ProgramInformationBatchProgram', function() {
    it('should create an instance of ProgramInformationBatchProgram', function() {
      // uncomment below and update the code to test ProgramInformationBatchProgram
      //var instance = new ContentDepot.ProgramInformationBatchProgram();
      //expect(instance).to.be.a(ContentDepot.ProgramInformationBatchProgram);
    });
