...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.CDDriveFile();
  });
  ...
  describe('CDDriveFile', function() {
    it('should create an instance of CDDriveFile', function() {
      // uncomment below and update the code to test CDDriveFile
      //var instance = new ContentDepot.CDDriveFile();
      //expect(instance).to.be.a(ContentDepot.CDDriveFile);
    });
