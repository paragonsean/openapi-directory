...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.CDDriveFolder();
  });
  ...
  describe('CDDriveFolder', function() {
    it('should create an instance of CDDriveFolder', function() {
      // uncomment below and update the code to test CDDriveFolder
      //var instance = new ContentDepot.CDDriveFolder();
      //expect(instance).to.be.a(ContentDepot.CDDriveFolder);
    });
