...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.Piece();
  });
  ...
  describe('Piece', function() {
    it('should create an instance of Piece', function() {
      // uncomment below and update the code to test Piece
      //var instance = new ContentDepot.Piece();
      //expect(instance).to.be.a(ContentDepot.Piece);
    });
    ...
    it('should have the property imageCdDriveUri (base name: "imageCdDriveUri")', function() {
      // uncomment below and update the code to test the property imageCdDriveUri
      //var instance = new ContentDepot.Piece();
      //expect(instance).to.be();
    });
    ...
    it('should have the property imageFileSize (base name: "imageFileSize")', function() {
      // uncomment below and update the code to test the property imageFileSize
      //var instance = new ContentDepot.Piece();
      //expect(instance).to.be();
    });

    it('should have the property imageOriginalFileName (base name: "imageOriginalFileName")', function() {
      // uncomment below and update the code to test the property imageOriginalFileName
      //var instance = new ContentDepot.Piece();
      //expect(instance).to.be();
    });
    ...
    it('should have the property relativeEndTime (base name: "relativeEndTime")', function() {
      // uncomment below and update the code to test the property relativeEndTime
      //var instance = new ContentDepot.Piece();
      //expect(instance).to.be();
    });

    it('should have the property relativeStartTime (base name: "relativeStartTime")', function() {
      // uncomment below and update the code to test the property relativeStartTime
      //var instance = new ContentDepot.Piece();
      //expect(instance).to.be();
    });

    it('should have the property segmentNumber (base name: "segmentNumber")', function() {
      // uncomment below and update the code to test the property segmentNumber
      //var instance = new ContentDepot.Piece();
      //expect(instance).to.be();
    });
