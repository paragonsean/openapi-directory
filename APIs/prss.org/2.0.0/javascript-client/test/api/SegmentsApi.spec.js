...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.SegmentsApi();
  });
  ...
  describe('SegmentsApi', function() {
    describe('apiV2SegmentsGet', function() {
      it('should call apiV2SegmentsGet successfully', function(done) {
        //uncomment below and update the code to test apiV2SegmentsGet
        //instance.apiV2SegmentsGet(function(error) {
    ...
    describe('apiV2SegmentsIdContentGet', function() {
      it('should call apiV2SegmentsIdContentGet successfully', function(done) {
        //uncomment below and update the code to test apiV2SegmentsIdContentGet
        //instance.apiV2SegmentsIdContentGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2SegmentsIdDelete', function() {
      it('should call apiV2SegmentsIdDelete successfully', function(done) {
        //uncomment below and update the code to test apiV2SegmentsIdDelete
        //instance.apiV2SegmentsIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2SegmentsIdGet', function() {
      it('should call apiV2SegmentsIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV2SegmentsIdGet
        //instance.apiV2SegmentsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2SegmentsPost', function() {
      it('should call apiV2SegmentsPost successfully', function(done) {
        //uncomment below and update the code to test apiV2SegmentsPost
        //instance.apiV2SegmentsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
