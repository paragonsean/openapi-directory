...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.PiecesApi();
  });
  ...
  describe('PiecesApi', function() {
    describe('apiV2PiecesGet', function() {
      it('should call apiV2PiecesGet successfully', function(done) {
        //uncomment below and update the code to test apiV2PiecesGet
        //instance.apiV2PiecesGet(function(error) {
    ...
    describe('apiV2PiecesIdDelete', function() {
      it('should call apiV2PiecesIdDelete successfully', function(done) {
        //uncomment below and update the code to test apiV2PiecesIdDelete
        //instance.apiV2PiecesIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2PiecesIdGet', function() {
      it('should call apiV2PiecesIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV2PiecesIdGet
        //instance.apiV2PiecesIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2PiecesPost', function() {
      it('should call apiV2PiecesPost successfully', function(done) {
        //uncomment below and update the code to test apiV2PiecesPost
        //instance.apiV2PiecesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
