...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.SpotsApi();
  });
  ...
  describe('SpotsApi', function() {
    describe('apiV2SpotsGet', function() {
      it('should call apiV2SpotsGet successfully', function(done) {
        //uncomment below and update the code to test apiV2SpotsGet
        //instance.apiV2SpotsGet(function(error) {
    ...
    describe('apiV2SpotsIdDelete', function() {
      it('should call apiV2SpotsIdDelete successfully', function(done) {
        //uncomment below and update the code to test apiV2SpotsIdDelete
        //instance.apiV2SpotsIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2SpotsIdGet', function() {
      it('should call apiV2SpotsIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV2SpotsIdGet
        //instance.apiV2SpotsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2SpotsPost', function() {
      it('should call apiV2SpotsPost successfully', function(done) {
        //uncomment below and update the code to test apiV2SpotsPost
        //instance.apiV2SpotsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
