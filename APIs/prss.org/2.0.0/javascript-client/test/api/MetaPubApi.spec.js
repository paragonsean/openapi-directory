...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.MetaPubApi();
  });
  ...
  describe('MetaPubApi', function() {
    describe('apiV2MetapubProgramInformationBatchBatchIdGet', function() {
      it('should call apiV2MetapubProgramInformationBatchBatchIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV2MetapubProgramInformationBatchBatchIdGet
        //instance.apiV2MetapubProgramInformationBatchBatchIdGet(function(error) {
    ...
    describe('apiV2MetapubProgramInformationBatchPost', function() {
      it('should call apiV2MetapubProgramInformationBatchPost successfully', function(done) {
        //uncomment below and update the code to test apiV2MetapubProgramInformationBatchPost
        //instance.apiV2MetapubProgramInformationBatchPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
