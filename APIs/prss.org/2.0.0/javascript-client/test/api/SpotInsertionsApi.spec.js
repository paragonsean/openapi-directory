...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.SpotInsertionsApi();
  });
  ...
  describe('SpotInsertionsApi', function() {
    describe('apiV2SpotinsertionsGet', function() {
      it('should call apiV2SpotinsertionsGet successfully', function(done) {
        //uncomment below and update the code to test apiV2SpotinsertionsGet
        //instance.apiV2SpotinsertionsGet(function(error) {
    ...
    describe('apiV2SpotinsertionsIdDelete', function() {
      it('should call apiV2SpotinsertionsIdDelete successfully', function(done) {
        //uncomment below and update the code to test apiV2SpotinsertionsIdDelete
        //instance.apiV2SpotinsertionsIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2SpotinsertionsIdGet', function() {
      it('should call apiV2SpotinsertionsIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV2SpotinsertionsIdGet
        //instance.apiV2SpotinsertionsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2SpotinsertionsPost', function() {
      it('should call apiV2SpotinsertionsPost successfully', function(done) {
        //uncomment below and update the code to test apiV2SpotinsertionsPost
        //instance.apiV2SpotinsertionsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
