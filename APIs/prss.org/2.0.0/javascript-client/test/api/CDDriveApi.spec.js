...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.ContentDepot);
  }
}(this, function(expect, ContentDepot) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new ContentDepot.CDDriveApi();
  });
  ...
  describe('CDDriveApi', function() {
    describe('apiV2CddriveFilesContentPost', function() {
      it('should call apiV2CddriveFilesContentPost successfully', function(done) {
        //uncomment below and update the code to test apiV2CddriveFilesContentPost
        //instance.apiV2CddriveFilesContentPost(function(error) {
    ...
    describe('apiV2CddriveFilesFileIdContentGet', function() {
      it('should call apiV2CddriveFilesFileIdContentGet successfully', function(done) {
        //uncomment below and update the code to test apiV2CddriveFilesFileIdContentGet
        //instance.apiV2CddriveFilesFileIdContentGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2CddriveFilesFileIdDelete', function() {
      it('should call apiV2CddriveFilesFileIdDelete successfully', function(done) {
        //uncomment below and update the code to test apiV2CddriveFilesFileIdDelete
        //instance.apiV2CddriveFilesFileIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2CddriveFilesFileIdGet', function() {
      it('should call apiV2CddriveFilesFileIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV2CddriveFilesFileIdGet
        //instance.apiV2CddriveFilesFileIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2CddriveFoldersFolderIdDelete', function() {
      it('should call apiV2CddriveFoldersFolderIdDelete successfully', function(done) {
        //uncomment below and update the code to test apiV2CddriveFoldersFolderIdDelete
        //instance.apiV2CddriveFoldersFolderIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2CddriveFoldersFolderIdGet', function() {
      it('should call apiV2CddriveFoldersFolderIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV2CddriveFoldersFolderIdGet
        //instance.apiV2CddriveFoldersFolderIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2CddriveFoldersFolderIdItemsGet', function() {
      it('should call apiV2CddriveFoldersFolderIdItemsGet successfully', function(done) {
        //uncomment below and update the code to test apiV2CddriveFoldersFolderIdItemsGet
        //instance.apiV2CddriveFoldersFolderIdItemsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV2CddriveFoldersPost', function() {
      it('should call apiV2CddriveFoldersPost successfully', function(done) {
        //uncomment below and update the code to test apiV2CddriveFoldersPost
        //instance.apiV2CddriveFoldersPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
