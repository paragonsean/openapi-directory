...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.EpisodesApi();
  });
  ...
  describe('EpisodesApi', function() {
    describe('apiV2EpisodesGet', function() {
      it('should call apiV2EpisodesGet successfully', function(done) {
        //uncomment below and update the code to test apiV2EpisodesGet
        //instance.apiV2EpisodesGet(function(error) {
    ...
    describe('apiV2EpisodesIdGet', function() {
      it('should call apiV2EpisodesIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV2EpisodesIdGet
        //instance.apiV2EpisodesIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
