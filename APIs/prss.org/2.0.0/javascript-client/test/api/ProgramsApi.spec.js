...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.ProgramsApi();
  });
  ...
  describe('ProgramsApi', function() {
    describe('apiV2ProgramsIdGet', function() {
      it('should call apiV2ProgramsIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV2ProgramsIdGet
        //instance.apiV2ProgramsIdGet(function(error) {
    ...
    describe('apiV2ProgramsSearchGet', function() {
      it('should call apiV2ProgramsSearchGet successfully', function(done) {
        //uncomment below and update the code to test apiV2ProgramsSearchGet
        //instance.apiV2ProgramsSearchGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
