...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.BroadcastServicesApi();
  });
  ...
  describe('BroadcastServicesApi', function() {
    describe('apiV2BroadcastservicesGet', function() {
      it('should call apiV2BroadcastservicesGet successfully', function(done) {
        //uncomment below and update the code to test apiV2BroadcastservicesGet
        //instance.apiV2BroadcastservicesGet(function(error) {
    ...
    describe('apiV2BroadcastservicesIdGet', function() {
      it('should call apiV2BroadcastservicesIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV2BroadcastservicesIdGet
        //instance.apiV2BroadcastservicesIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
