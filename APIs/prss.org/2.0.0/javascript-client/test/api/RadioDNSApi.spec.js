...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentDepot.RadioDNSApi();
  });
  ...
  describe('RadioDNSApi', function() {
    describe('radiodnsSpi31GIXmlGet', function() {
      it('should call radiodnsSpi31GIXmlGet successfully', function(done) {
        //uncomment below and update the code to test radiodnsSpi31GIXmlGet
        //instance.radiodnsSpi31GIXmlGet(function(error) {
    ...
    describe('radiodnsSpi31IdFqdnSidDatePIXmlGet', function() {
      it('should call radiodnsSpi31IdFqdnSidDatePIXmlGet successfully', function(done) {
        //uncomment below and update the code to test radiodnsSpi31IdFqdnSidDatePIXmlGet
        //instance.radiodnsSpi31IdFqdnSidDatePIXmlGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('radiodnsSpi31SIXmlGet', function() {
      it('should call radiodnsSpi31SIXmlGet successfully', function(done) {
        //uncomment below and update the code to test radiodnsSpi31SIXmlGet
        //instance.radiodnsSpi31SIXmlGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
