# ContentDepot.RadioDNSApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**radiodnsSpi31GIXmlGet**](RadioDNSApi.md#radiodnsSpi31GIXmlGet) | **GET** /radiodns/spi/3.1/GI.xml | Get the group information document.
[**radiodnsSpi31IdFqdnSidDatePIXmlGet**](RadioDNSApi.md#radiodnsSpi31IdFqdnSidDatePIXmlGet) | **GET** /radiodns/spi/3.1/id/{fqdn}/{sid}/{date}_PI.xml | Get the program information document.
[**radiodnsSpi31SIXmlGet**](RadioDNSApi.md#radiodnsSpi31SIXmlGet) | **GET** /radiodns/spi/3.1/SI.xml | Get the service information document.



## radiodnsSpi31GIXmlGet

> String radiodnsSpi31GIXmlGet()
...
let apiInstance = new ContentDepot.RadioDNSApi();
apiInstance.radiodnsSpi31GIXmlGet((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
## radiodnsSpi31IdFqdnSidDatePIXmlGet

> String radiodnsSpi31IdFqdnSidDatePIXmlGet(fqdn, sid, date, opts)
...
let apiInstance = new ContentDepot.RadioDNSApi();
let fqdn = "fqdn_example"; // String | The fully qualified domain name for the environment where the service is running. The fqdn is defined in the `radiodns` element in the SI document in each Content Depot environment.
let sid = "sid_example"; // String | One of the valid service IDs defined in the SI document. For example, \"files\" or \"streams\".
let date = "date_example"; // String | The PI schedule date to retrieve in format yyyymmdd.
let opts = {
  'xRadiodnsspiApiKey': "xRadiodnsspiApiKey_example" // String | The API client Id you received. This is required for National PI documents, but not Station PI documents. Contact help desk if you need one.
};
apiInstance.radiodnsSpi31IdFqdnSidDatePIXmlGet(fqdn, sid, date, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
------------- | ------------- | ------------- | -------------
 **fqdn** | **String**| The fully qualified domain name for the environment where the service is running. The fqdn is defined in the &#x60;radiodns&#x60; element in the SI document in each Content Depot environment. | 
 **sid** | **String**| One of the valid service IDs defined in the SI document. For example, \&quot;files\&quot; or \&quot;streams\&quot;. | 
 **date** | **String**| The PI schedule date to retrieve in format yyyymmdd. | 
 **xRadiodnsspiApiKey** | **String**| The API client Id you received. This is required for National PI documents, but not Station PI documents. Contact help desk if you need one. | [optional] 
...
## radiodnsSpi31SIXmlGet

> String radiodnsSpi31SIXmlGet()
...
let apiInstance = new ContentDepot.RadioDNSApi();
apiInstance.radiodnsSpi31SIXmlGet((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
