...
public class ProgramInformationBatchProgram {
  ...
  public ProgramInformationBatchProgram() {
  }

  public ProgramInformationBatchProgram airDate(String airDate) {
  ...
  public ProgramInformationBatchProgram title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProgramInformationBatchProgram programInformationBatchProgram = (ProgramInformationBatchProgram) o;
    return Objects.equals(this.airDate, programInformationBatchProgram.airDate) &&
        Objects.equals(this.title, programInformationBatchProgram.title);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProgramInformationBatchProgram {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProgramInformationBatchProgram
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProgramInformationBatchProgram.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProgramInformationBatchProgram is not found in the empty JSON string", ProgramInformationBatchProgram.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProgramInformationBatchProgram.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProgramInformationBatchProgram` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProgramInformationBatchProgram.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProgramInformationBatchProgram.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProgramInformationBatchProgram' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProgramInformationBatchProgram> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProgramInformationBatchProgram.class));

       return (TypeAdapter<T>) new TypeAdapter<ProgramInformationBatchProgram>() {
           @Override
           public void write(JsonWriter out, ProgramInformationBatchProgram value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProgramInformationBatchProgram read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProgramInformationBatchProgram given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProgramInformationBatchProgram
   * @throws IOException if the JSON string is invalid with respect to ProgramInformationBatchProgram
   */
  public static ProgramInformationBatchProgram fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProgramInformationBatchProgram.class);
  }

  /**
   * Convert an instance of ProgramInformationBatchProgram to an JSON string
   *
   * @return JSON string
   */
