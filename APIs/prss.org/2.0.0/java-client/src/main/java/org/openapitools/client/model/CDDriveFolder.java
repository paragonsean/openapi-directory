...
public class CDDriveFolder {
  ...
  public CDDriveFolder() {
  }

  public CDDriveFolder createdDate(String createdDate) {
  ...
  public CDDriveFolder id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public CDDriveFolder lastModifiedDate(String lastModifiedDate) {
  ...
  public CDDriveFolder name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CDDriveFolder parentId(Long parentId) {
  ...
  public boolean equals(Object o) {
    ...
    CDDriveFolder cdDriveFolder = (CDDriveFolder) o;
    return Objects.equals(this.createdDate, cdDriveFolder.createdDate) &&
        Objects.equals(this.id, cdDriveFolder.id) &&
        Objects.equals(this.lastModifiedDate, cdDriveFolder.lastModifiedDate) &&
        Objects.equals(this.name, cdDriveFolder.name) &&
        Objects.equals(this.parentId, cdDriveFolder.parentId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdDate, id, lastModifiedDate, name, parentId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CDDriveFolder {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CDDriveFolder
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CDDriveFolder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CDDriveFolder is not found in the empty JSON string", CDDriveFolder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CDDriveFolder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CDDriveFolder` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CDDriveFolder.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CDDriveFolder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CDDriveFolder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CDDriveFolder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CDDriveFolder.class));

       return (TypeAdapter<T>) new TypeAdapter<CDDriveFolder>() {
           @Override
           public void write(JsonWriter out, CDDriveFolder value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CDDriveFolder read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CDDriveFolder given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CDDriveFolder
   * @throws IOException if the JSON string is invalid with respect to CDDriveFolder
   */
  public static CDDriveFolder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CDDriveFolder.class);
  }

  /**
   * Convert an instance of CDDriveFolder to an JSON string
   *
   * @return JSON string
   */
