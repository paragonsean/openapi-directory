...
public class ProgramsApi {
    ...
    /**
     * Build call for apiV2ProgramsIdGet
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> The matching program. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Authorization failed, or the user is not permitted to view this program. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> The program cannot be found. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call apiV2ProgramsIdGetCall(Long id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/programs/{id}"
    ...
    private okhttp3.Call apiV2ProgramsIdGetValidateBeforeCall(Long id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling apiV2ProgramsIdGet(Async)");
        }

        return apiV2ProgramsIdGetCall(id, _callback);
     ...
     */
    public Program apiV2ProgramsIdGet(Long id) throws ApiException {
        ApiResponse<Program> localVarResp = apiV2ProgramsIdGetWithHttpInfo(id);
     ...
     */
    public ApiResponse<Program> apiV2ProgramsIdGetWithHttpInfo(Long id) throws ApiException {
        okhttp3.Call localVarCall = apiV2ProgramsIdGetValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Program>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Returns the program matching the given ID. (asynchronously)
     * 
     * @param id The ID of the program to operate on. (required)
     ...
     */
    public okhttp3.Call apiV2ProgramsIdGetAsync(Long id, final ApiCallback<Program> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV2ProgramsIdGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Program>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiV2ProgramsSearchGet
     * @param keywords Free text search that matches against the program title or description. (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Programs matching the search request sorted by relevance. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Authorization failed, username or password not found or incorrect. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call apiV2ProgramsSearchGetCall(String keywords, Integer pageStart, Integer pageSize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/programs/search";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV2ProgramsSearchGetValidateBeforeCall(String keywords, Integer pageStart, Integer pageSize, final ApiCallback _callback) throws ApiException {
        return apiV2ProgramsSearchGetCall(keywords, pageStart, pageSize, _callback);
     ...
     */
    public List<Program> apiV2ProgramsSearchGet(String keywords, Integer pageStart, Integer pageSize) throws ApiException {
        ApiResponse<List<Program>> localVarResp = apiV2ProgramsSearchGetWithHttpInfo(keywords, pageStart, pageSize);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Program>> apiV2ProgramsSearchGetWithHttpInfo(String keywords, Integer pageStart, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = apiV2ProgramsSearchGetValidateBeforeCall(keywords, pageStart, pageSize, null);
        Type localVarReturnType = new TypeToken<List<Program>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Optimized free-text search for programs using various filters. (asynchronously)
     * 
     * @param keywords Free text search that matches against the program title or description. (optional)
     * @param pageStart The start page of the results to return. The first item is indexed at 0. (optional, default to 0)
     * @param pageSize The number of items to return. Must be between 0 and 500, inclusive. (optional, default to 500)
     ...
     */
    public okhttp3.Call apiV2ProgramsSearchGetAsync(String keywords, Integer pageStart, Integer pageSize, final ApiCallback<List<Program>> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV2ProgramsSearchGetValidateBeforeCall(keywords, pageStart, pageSize, _callback);
        Type localVarReturnType = new TypeToken<List<Program>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
