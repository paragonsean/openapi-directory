...
public class ProgramsApiTest {
     ...
     */
    @Test
    public void apiV2ProgramsIdGetTest() throws ApiException {
        Long id = null;
        Program response = api.apiV2ProgramsIdGet(id);
     ...
     */
    @Test
    public void apiV2ProgramsSearchGetTest() throws ApiException {
        String keywords = null;
        Integer pageStart = null;
        Integer pageSize = null;
        List<Program> response = api.apiV2ProgramsSearchGet(keywords, pageStart, pageSize);
        // TODO: test validations
    }
