...
/**
 * API tests for MetaPubApi
 */
@Disabled
public class MetaPubApiTest {

    private final MetaPubApi api = new MetaPubApi();
     ...
     */
    @Test
    public void apiV2MetapubProgramInformationBatchBatchIdGetTest() throws ApiException {
        Long batchId = null;
        ProgramInformationBatch response = api.apiV2MetapubProgramInformationBatchBatchIdGet(batchId);
     ...
     */
    @Test
    public void apiV2MetapubProgramInformationBatchPostTest() throws ApiException {
        ApiV2MetapubProgramInformationBatchPostRequest apiV2MetapubProgramInformationBatchPostRequest = null;
        ProgramInformationBatch response = api.apiV2MetapubProgramInformationBatchPost(apiV2MetapubProgramInformationBatchPostRequest);
        // TODO: test validations
    }
