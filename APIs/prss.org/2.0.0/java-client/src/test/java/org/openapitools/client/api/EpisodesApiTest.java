...
public class EpisodesApiTest {
     ...
     */
    @Test
    public void apiV2EpisodesGetTest() throws ApiException {
        Long programId = null;
        Long id = null;
        OffsetDateTime beginAirDateAfter = null;
        OffsetDateTime endAirDateBefore = null;
        Integer pageStart = null;
        Integer pageSize = null;
        String orderById = null;
        List<Episode> response = api.apiV2EpisodesGet(programId, id, beginAirDateAfter, endAirDateBefore, pageStart, pageSize, orderById);
     ...
     */
    @Test
    public void apiV2EpisodesIdGetTest() throws ApiException {
        Long id = null;
        Episode response = api.apiV2EpisodesIdGet(id);
        // TODO: test validations
    }
