...
import org.openapitools.client.api.RadioDnsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    RadioDnsApi apiInstance = new RadioDnsApi(defaultClient);
    try {
      String result = apiInstance.radiodnsSpi31GIXmlGet();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RadioDnsApi#radiodnsSpi31GIXmlGet");
...
<a id="radiodnsSpi31IdFqdnSidDatePIXmlGet"></a>
# **radiodnsSpi31IdFqdnSidDatePIXmlGet**
> String radiodnsSpi31IdFqdnSidDatePIXmlGet(fqdn, sid, date, xRadiodnsspiApiKey)
...
public class Example {
  public static void main(String[] args) {
    ...
    RadioDnsApi apiInstance = new RadioDnsApi(defaultClient);
    String fqdn = "fqdn_example"; // String | The fully qualified domain name for the environment where the service is running. The fqdn is defined in the `radiodns` element in the SI document in each Content Depot environment.
    String sid = "sid_example"; // String | One of the valid service IDs defined in the SI document. For example, \"files\" or \"streams\".
    String date = "date_example"; // String | The PI schedule date to retrieve in format yyyymmdd.
    String xRadiodnsspiApiKey = "xRadiodnsspiApiKey_example"; // String | The API client Id you received. This is required for National PI documents, but not Station PI documents. Contact help desk if you need one.
    try {
      String result = apiInstance.radiodnsSpi31IdFqdnSidDatePIXmlGet(fqdn, sid, date, xRadiodnsspiApiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RadioDnsApi#radiodnsSpi31IdFqdnSidDatePIXmlGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    RadioDnsApi apiInstance = new RadioDnsApi(defaultClient);
    try {
      String result = apiInstance.radiodnsSpi31SIXmlGet();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RadioDnsApi#radiodnsSpi31SIXmlGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
