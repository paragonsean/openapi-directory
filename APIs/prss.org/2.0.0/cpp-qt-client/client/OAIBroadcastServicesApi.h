...
#ifndef OAI_OAIBroadcastServicesApi_H
#define OAI_OAIBroadcastServicesApi_H
...
class OAIBroadcastServicesApi : public QObject {
    Q_OBJECT

public:
    OAIBroadcastServicesApi(const int timeOut = 0);
    ~OAIBroadcastServicesApi();
    ...
    */
    virtual void apiV2BroadcastservicesGet(const ::OpenAPI::OptionalParam<qint32> &page_start = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &order_by_id = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  id qint64 [required]
    */
    virtual void apiV2BroadcastservicesIdGet(const qint64 &id);
...
private:
    ...
    void apiV2BroadcastservicesGetCallback(OAIHttpRequestWorker *worker);
    void apiV2BroadcastservicesIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void apiV2BroadcastservicesGetSignal(QList<OAIEpisode> summary);
    void apiV2BroadcastservicesIdGetSignal(OAIBroadcastService summary);


    void apiV2BroadcastservicesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIEpisode> summary);
    void apiV2BroadcastservicesIdGetSignalFull(OAIHttpRequestWorker *worker, OAIBroadcastService summary);

    Q_DECL_DEPRECATED_X("Use apiV2BroadcastservicesGetSignalError() instead")
    void apiV2BroadcastservicesGetSignalE(QList<OAIEpisode> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2BroadcastservicesGetSignalError(QList<OAIEpisode> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV2BroadcastservicesIdGetSignalError() instead")
    void apiV2BroadcastservicesIdGetSignalE(OAIBroadcastService summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2BroadcastservicesIdGetSignalError(OAIBroadcastService summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use apiV2BroadcastservicesGetSignalErrorFull() instead")
    void apiV2BroadcastservicesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2BroadcastservicesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV2BroadcastservicesIdGetSignalErrorFull() instead")
    void apiV2BroadcastservicesIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2BroadcastservicesIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
