...
#ifndef OAI_OAIProgramsApi_H
#define OAI_OAIProgramsApi_H
...
class OAIProgramsApi : public QObject {
    Q_OBJECT

public:
    OAIProgramsApi(const int timeOut = 0);
    ~OAIProgramsApi();
    ...
    */
    virtual void apiV2ProgramsIdGet(const qint64 &id);

    /**
    * @param[in]  keywords QString [optional]
    * @param[in]  page_start qint32 [optional]
    * @param[in]  page_size qint32 [optional]
    */
    virtual void apiV2ProgramsSearchGet(const ::OpenAPI::OptionalParam<QString> &keywords = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_start = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void apiV2ProgramsIdGetCallback(OAIHttpRequestWorker *worker);
    void apiV2ProgramsSearchGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void apiV2ProgramsIdGetSignal(OAIProgram summary);
    void apiV2ProgramsSearchGetSignal(QList<OAIProgram> summary);


    void apiV2ProgramsIdGetSignalFull(OAIHttpRequestWorker *worker, OAIProgram summary);
    void apiV2ProgramsSearchGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIProgram> summary);

    Q_DECL_DEPRECATED_X("Use apiV2ProgramsIdGetSignalError() instead")
    void apiV2ProgramsIdGetSignalE(OAIProgram summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2ProgramsIdGetSignalError(OAIProgram summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV2ProgramsSearchGetSignalError() instead")
    void apiV2ProgramsSearchGetSignalE(QList<OAIProgram> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2ProgramsSearchGetSignalError(QList<OAIProgram> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use apiV2ProgramsIdGetSignalErrorFull() instead")
    void apiV2ProgramsIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2ProgramsIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV2ProgramsSearchGetSignalErrorFull() instead")
    void apiV2ProgramsSearchGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2ProgramsSearchGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
