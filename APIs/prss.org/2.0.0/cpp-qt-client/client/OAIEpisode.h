...
public:
    ...
    QDateTime getBeginAirDate() const;
    void setBeginAirDate(const QDateTime &begin_air_date);
    bool is_begin_air_date_Set() const;
    bool is_begin_air_date_Valid() const;

    QDateTime getBeginTransmissionDate() const;
    void setBeginTransmissionDate(const QDateTime &begin_transmission_date);
    bool is_begin_transmission_date_Set() const;
    bool is_begin_transmission_date_Valid() const;
    ...
    QDateTime getEndAirDate() const;
    void setEndAirDate(const QDateTime &end_air_date);
    bool is_end_air_date_Set() const;
    bool is_end_air_date_Valid() const;

    QDateTime getEndTransmissionDate() const;
    void setEndTransmissionDate(const QDateTime &end_transmission_date);
    bool is_end_transmission_date_Set() const;
    bool is_end_transmission_date_Valid() const;
...
private:
    ...
    QDateTime m_begin_air_date;
    bool m_begin_air_date_isSet;
    bool m_begin_air_date_isValid;

    QDateTime m_begin_transmission_date;
    bool m_begin_transmission_date_isSet;
    bool m_begin_transmission_date_isValid;
    ...
    QDateTime m_end_air_date;
    bool m_end_air_date_isSet;
    bool m_end_air_date_isValid;

    QDateTime m_end_transmission_date;
    bool m_end_transmission_date_isSet;
    bool m_end_transmission_date_isValid;
