...
OAICDDriveItem::OAICDDriveItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICDDriveItem::OAICDDriveItem() {
    this->initializeModel();
}

OAICDDriveItem::~OAICDDriveItem() {}

void OAICDDriveItem::initializeModel() {
...
void OAICDDriveItem::fromJson(QString jsonString) {
...
void OAICDDriveItem::fromJsonObject(QJsonObject json) {
...
QString OAICDDriveItem::asJson() const {
...
QJsonObject OAICDDriveItem::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint64 OAICDDriveItem::getId() const {
    return m_id;
}
void OAICDDriveItem::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICDDriveItem::is_id_Set() const{
    return m_id_isSet;
}

bool OAICDDriveItem::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICDDriveItem::getName() const {
    return m_name;
}
void OAICDDriveItem::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICDDriveItem::is_name_Set() const{
    return m_name_isSet;
}

bool OAICDDriveItem::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICDDriveItem::getType() const {
    return m_type;
}
void OAICDDriveItem::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICDDriveItem::is_type_Set() const{
    return m_type_isSet;
}

bool OAICDDriveItem::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICDDriveItem::isSet() const {
...
bool OAICDDriveItem::isValid() const {
