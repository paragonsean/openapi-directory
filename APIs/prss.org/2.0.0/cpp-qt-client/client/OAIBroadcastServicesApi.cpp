...
#include "OAIBroadcastServicesApi.h"
...
OAIBroadcastServicesApi::OAIBroadcastServicesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIBroadcastServicesApi::~OAIBroadcastServicesApi() {
}

void OAIBroadcastServicesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("apiV2BroadcastservicesGet", defaultConf);
    _serverIndices.insert("apiV2BroadcastservicesGet", 0);
    _serverConfigs.insert("apiV2BroadcastservicesIdGet", defaultConf);
    _serverIndices.insert("apiV2BroadcastservicesIdGet", 0);
}
...
*/
int OAIBroadcastServicesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIBroadcastServicesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIBroadcastServicesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIBroadcastServicesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIBroadcastServicesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIBroadcastServicesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIBroadcastServicesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIBroadcastServicesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIBroadcastServicesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIBroadcastServicesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBroadcastServicesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBroadcastServicesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIBroadcastServicesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIBroadcastServicesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIBroadcastServicesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIBroadcastServicesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIBroadcastServicesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIBroadcastServicesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIBroadcastServicesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIBroadcastServicesApi::apiV2BroadcastservicesGet(const ::OpenAPI::OptionalParam<qint32> &page_start, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &order_by_id) {
    QString fullPath = QString(_serverConfigs["apiV2BroadcastservicesGet"][_serverIndices.value("apiV2BroadcastservicesGet")].URL()+"/api/v2/broadcastservices");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBroadcastServicesApi::apiV2BroadcastservicesGetCallback);
    connect(this, &OAIBroadcastServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBroadcastServicesApi::apiV2BroadcastservicesGetCallback);
    connect(this, &OAIBroadcastServicesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIBroadcastServicesApi::apiV2BroadcastservicesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiV2BroadcastservicesGetSignal(output);
        Q_EMIT apiV2BroadcastservicesGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiV2BroadcastservicesGetSignalE(output, error_type, error_str);
        Q_EMIT apiV2BroadcastservicesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiV2BroadcastservicesGetSignalError(output, error_type, error_str);
        Q_EMIT apiV2BroadcastservicesGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBroadcastServicesApi::apiV2BroadcastservicesIdGet(const qint64 &id) {
    QString fullPath = QString(_serverConfigs["apiV2BroadcastservicesIdGet"][_serverIndices.value("apiV2BroadcastservicesIdGet")].URL()+"/api/v2/broadcastservices/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBroadcastServicesApi::apiV2BroadcastservicesIdGetCallback);
    connect(this, &OAIBroadcastServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBroadcastServicesApi::apiV2BroadcastservicesIdGetCallback);
    connect(this, &OAIBroadcastServicesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBroadcastServicesApi::apiV2BroadcastservicesIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBroadcastService output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiV2BroadcastservicesIdGetSignal(output);
        Q_EMIT apiV2BroadcastservicesIdGetSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("cd:full");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiV2BroadcastservicesIdGetSignalE(output, error_type, error_str);
        Q_EMIT apiV2BroadcastservicesIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiV2BroadcastservicesIdGetSignalError(output, error_type, error_str);
        Q_EMIT apiV2BroadcastservicesIdGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBroadcastServicesApi::tokenAvailable(){
