...
OAICDDriveFolder::OAICDDriveFolder(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICDDriveFolder::OAICDDriveFolder() {
    this->initializeModel();
}

OAICDDriveFolder::~OAICDDriveFolder() {}

void OAICDDriveFolder::initializeModel() {
...
void OAICDDriveFolder::fromJson(QString jsonString) {
...
void OAICDDriveFolder::fromJsonObject(QJsonObject json) {
...
QString OAICDDriveFolder::asJson() const {
...
QJsonObject OAICDDriveFolder::asJsonObject() const {
    QJsonObject obj;
...
QString OAICDDriveFolder::getCreatedDate() const {
    return m_created_date;
}
void OAICDDriveFolder::setCreatedDate(const QString &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAICDDriveFolder::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAICDDriveFolder::is_created_date_Valid() const{
    return m_created_date_isValid;
}

qint64 OAICDDriveFolder::getId() const {
    return m_id;
}
void OAICDDriveFolder::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICDDriveFolder::is_id_Set() const{
    return m_id_isSet;
}

bool OAICDDriveFolder::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICDDriveFolder::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAICDDriveFolder::setLastModifiedDate(const QString &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAICDDriveFolder::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAICDDriveFolder::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QString OAICDDriveFolder::getName() const {
    return m_name;
}
void OAICDDriveFolder::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICDDriveFolder::is_name_Set() const{
    return m_name_isSet;
}

bool OAICDDriveFolder::is_name_Valid() const{
    return m_name_isValid;
}

qint64 OAICDDriveFolder::getParentId() const {
    return m_parent_id;
}
void OAICDDriveFolder::setParentId(const qint64 &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAICDDriveFolder::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAICDDriveFolder::is_parent_id_Valid() const{
    return m_parent_id_isValid;
}

bool OAICDDriveFolder::isSet() const {
...
bool OAICDDriveFolder::isValid() const {
