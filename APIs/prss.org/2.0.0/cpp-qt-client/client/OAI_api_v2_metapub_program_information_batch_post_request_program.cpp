...
#include "OAI_api_v2_metapub_program_information_batch_post_request_program.h"
...
OAI_api_v2_metapub_program_information_batch_post_request_program::OAI_api_v2_metapub_program_information_batch_post_request_program(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_api_v2_metapub_program_information_batch_post_request_program::OAI_api_v2_metapub_program_information_batch_post_request_program() {
    this->initializeModel();
}

OAI_api_v2_metapub_program_information_batch_post_request_program::~OAI_api_v2_metapub_program_information_batch_post_request_program() {}

void OAI_api_v2_metapub_program_information_batch_post_request_program::initializeModel() {
...
void OAI_api_v2_metapub_program_information_batch_post_request_program::fromJson(QString jsonString) {
...
void OAI_api_v2_metapub_program_information_batch_post_request_program::fromJsonObject(QJsonObject json) {
...
QString OAI_api_v2_metapub_program_information_batch_post_request_program::asJson() const {
...
QJsonObject OAI_api_v2_metapub_program_information_batch_post_request_program::asJsonObject() const {
    QJsonObject obj;
    if (m_air_date_isSet) {
...
QString OAI_api_v2_metapub_program_information_batch_post_request_program::getAirDate() const {
    return m_air_date;
}
void OAI_api_v2_metapub_program_information_batch_post_request_program::setAirDate(const QString &air_date) {
    m_air_date = air_date;
    m_air_date_isSet = true;
}

bool OAI_api_v2_metapub_program_information_batch_post_request_program::is_air_date_Set() const{
    return m_air_date_isSet;
}

bool OAI_api_v2_metapub_program_information_batch_post_request_program::is_air_date_Valid() const{
    return m_air_date_isValid;
}

QString OAI_api_v2_metapub_program_information_batch_post_request_program::getTitle() const {
    return m_title;
}
void OAI_api_v2_metapub_program_information_batch_post_request_program::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAI_api_v2_metapub_program_information_batch_post_request_program::is_title_Set() const{
    return m_title_isSet;
}

bool OAI_api_v2_metapub_program_information_batch_post_request_program::is_title_Valid() const{
    return m_title_isValid;
}

bool OAI_api_v2_metapub_program_information_batch_post_request_program::isSet() const {
...
bool OAI_api_v2_metapub_program_information_batch_post_request_program::isValid() const {
