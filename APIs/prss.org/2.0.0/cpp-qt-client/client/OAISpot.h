...
public:
    ...
    QDateTime getLastUploadedDate() const;
    void setLastUploadedDate(const QDateTime &last_uploaded_date);
    bool is_last_uploaded_date_Set() const;
    bool is_last_uploaded_date_Valid() const;
...
private:
    ...
    QDateTime m_last_uploaded_date;
    bool m_last_uploaded_date_isSet;
    bool m_last_uploaded_date_isValid;
