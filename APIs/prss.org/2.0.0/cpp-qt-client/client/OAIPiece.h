...
class OAIPiece : public OAIObject {
public:
    OAIPiece();
    OAIPiece(QString json);
    ~OAIPiece() override;
    ...
    QString getImageCdDriveUri() const;
    void setImageCdDriveUri(const QString &image_cd_drive_uri);
    bool is_image_cd_drive_uri_Set() const;
    bool is_image_cd_drive_uri_Valid() const;
    ...
    qint64 getImageFileSize() const;
    void setImageFileSize(const qint64 &image_file_size);
    bool is_image_file_size_Set() const;
    bool is_image_file_size_Valid() const;

    QString getImageOriginalFileName() const;
    void setImageOriginalFileName(const QString &image_original_file_name);
    bool is_image_original_file_name_Set() const;
    bool is_image_original_file_name_Valid() const;
    ...
    qint32 getRelativeEndTime() const;
    void setRelativeEndTime(const qint32 &relative_end_time);
    bool is_relative_end_time_Set() const;
    bool is_relative_end_time_Valid() const;

    qint32 getRelativeStartTime() const;
    void setRelativeStartTime(const qint32 &relative_start_time);
    bool is_relative_start_time_Set() const;
    bool is_relative_start_time_Valid() const;
...
private:
    ...
    QString m_image_cd_drive_uri;
    bool m_image_cd_drive_uri_isSet;
    bool m_image_cd_drive_uri_isValid;

    QString m_image_file_name;
    bool m_image_file_name_isSet;
    bool m_image_file_name_isValid;

    qint64 m_image_file_size;
    bool m_image_file_size_isSet;
    bool m_image_file_size_isValid;

    QString m_image_original_file_name;
    bool m_image_original_file_name_isSet;
    bool m_image_original_file_name_isValid;

    QDateTime m_last_modified_date;
    bool m_last_modified_date_isSet;
    bool m_last_modified_date_isValid;

    qint32 m_relative_end_time;
    bool m_relative_end_time_isSet;
    bool m_relative_end_time_isValid;

    qint32 m_relative_start_time;
    bool m_relative_start_time_isSet;
    bool m_relative_start_time_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPiece)
