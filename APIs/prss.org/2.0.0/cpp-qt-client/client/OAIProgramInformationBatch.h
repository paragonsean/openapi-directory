...
namespace OpenAPI {
class OAIProgramInformationBatch_program;

class OAIProgramInformationBatch : public OAIObject {
public:
    OAIProgramInformationBatch();
    OAIProgramInformationBatch(QString json);
    ~OAIProgramInformationBatch() override;
    ...
    QString getFinishedDate() const;
    void setFinishedDate(const QString &finished_date);
    bool is_finished_date_Set() const;
    bool is_finished_date_Valid() const;
    ...
    OAIProgramInformationBatch_program getProgram() const;
    void setProgram(const OAIProgramInformationBatch_program &program);
...
private:
    ...
    QString m_finished_date;
    bool m_finished_date_isSet;
    bool m_finished_date_isValid;
    ...
    OAIProgramInformationBatch_program m_program;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProgramInformationBatch)

#endif // OAIProgramInformationBatch_H
