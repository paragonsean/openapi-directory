...
OAIProgramsApi::OAIProgramsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIProgramsApi::~OAIProgramsApi() {
}

void OAIProgramsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("apiV2ProgramsIdGet", defaultConf);
    _serverIndices.insert("apiV2ProgramsIdGet", 0);
    _serverConfigs.insert("apiV2ProgramsSearchGet", defaultConf);
    _serverIndices.insert("apiV2ProgramsSearchGet", 0);
}
...
*/
int OAIProgramsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIProgramsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIProgramsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIProgramsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIProgramsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIProgramsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIProgramsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIProgramsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIProgramsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIProgramsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProgramsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProgramsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIProgramsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIProgramsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIProgramsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIProgramsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIProgramsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIProgramsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIProgramsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIProgramsApi::apiV2ProgramsIdGet(const qint64 &id) {
    QString fullPath = QString(_serverConfigs["apiV2ProgramsIdGet"][_serverIndices.value("apiV2ProgramsIdGet")].URL()+"/api/v2/programs/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProgramsApi::apiV2ProgramsIdGetCallback);
    connect(this, &OAIProgramsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProgramsApi::apiV2ProgramsIdGetCallback);
    connect(this, &OAIProgramsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIProgramsApi::apiV2ProgramsIdGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiV2ProgramsIdGetSignal(output);
        Q_EMIT apiV2ProgramsIdGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiV2ProgramsIdGetSignalE(output, error_type, error_str);
        Q_EMIT apiV2ProgramsIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiV2ProgramsIdGetSignalError(output, error_type, error_str);
        Q_EMIT apiV2ProgramsIdGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProgramsApi::apiV2ProgramsSearchGet(const ::OpenAPI::OptionalParam<QString> &keywords, const ::OpenAPI::OptionalParam<qint32> &page_start, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["apiV2ProgramsSearchGet"][_serverIndices.value("apiV2ProgramsSearchGet")].URL()+"/api/v2/programs/search");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProgramsApi::apiV2ProgramsSearchGetCallback);
    connect(this, &OAIProgramsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProgramsApi::apiV2ProgramsSearchGetCallback);
    connect(this, &OAIProgramsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProgramsApi::apiV2ProgramsSearchGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiV2ProgramsSearchGetSignal(output);
        Q_EMIT apiV2ProgramsSearchGetSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("cd:full");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiV2ProgramsSearchGetSignalE(output, error_type, error_str);
        Q_EMIT apiV2ProgramsSearchGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiV2ProgramsSearchGetSignalError(output, error_type, error_str);
        Q_EMIT apiV2ProgramsSearchGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProgramsApi::tokenAvailable(){
