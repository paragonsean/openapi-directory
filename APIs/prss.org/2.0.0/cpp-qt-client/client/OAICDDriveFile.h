...
#ifndef OAICDDriveFile_H
#define OAICDDriveFile_H
...
class OAICDDriveFile : public OAIObject {
public:
    OAICDDriveFile();
    OAICDDriveFile(QString json);
    ~OAICDDriveFile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICDDriveFile)

#endif // OAICDDriveFile_H
