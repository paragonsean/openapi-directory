...
/*
 * OAIBroadcastService.h
 *
 * A broadcast service that can subscribe to content for multiple destinations.
 */

#ifndef OAIBroadcastService_H
#define OAIBroadcastService_H
...
class OAIBroadcastService : public OAIObject {
public:
    OAIBroadcastService();
    OAIBroadcastService(QString json);
    ~OAIBroadcastService() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBroadcastService)

#endif // OAIBroadcastService_H
