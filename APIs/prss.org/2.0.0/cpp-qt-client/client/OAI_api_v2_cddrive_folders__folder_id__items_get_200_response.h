...
/*
 * OAI_api_v2_cddrive_folders__folder_id__items_get_200_response.h
 *
 * 
 */

#ifndef OAI_api_v2_cddrive_folders__folder_id__items_get_200_response_H
#define OAI_api_v2_cddrive_folders__folder_id__items_get_200_response_H

#include <QJsonObject>

#include "OAICDDriveItem.h"
#include <QList>
...
namespace OpenAPI {
class OAICDDriveItem;

class OAI_api_v2_cddrive_folders__folder_id__items_get_200_response : public OAIObject {
public:
    OAI_api_v2_cddrive_folders__folder_id__items_get_200_response();
    OAI_api_v2_cddrive_folders__folder_id__items_get_200_response(QString json);
    ~OAI_api_v2_cddrive_folders__folder_id__items_get_200_response() override;
    ...
    QList<OAICDDriveItem> getEntries() const;
    void setEntries(const QList<OAICDDriveItem> &entries);
...
private:
    ...
    QList<OAICDDriveItem> m_entries;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_api_v2_cddrive_folders__folder_id__items_get_200_response)

#endif // OAI_api_v2_cddrive_folders__folder_id__items_get_200_response_H
