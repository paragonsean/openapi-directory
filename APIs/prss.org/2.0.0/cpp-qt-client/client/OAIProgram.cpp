...
QDateTime OAIProgram::getCreatedDate() const {
    return m_created_date;
}
void OAIProgram::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIProgram::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIProgram::is_created_date_Valid() const{
    return m_created_date_isValid;
}

qint64 OAIProgram::getCustomerId() const {
    return m_customer_id;
}
void OAIProgram::setCustomerId(const qint64 &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIProgram::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIProgram::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

qint64 OAIProgram::getId() const {
    return m_id;
}
void OAIProgram::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QDateTime OAIProgram::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIProgram::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIProgram::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIProgram::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QString OAIProgram::getTitle() const {
    return m_title;
}
void OAIProgram::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIProgram::is_title_Set() const{
    return m_title_isSet;
}

bool OAIProgram::is_title_Valid() const{
