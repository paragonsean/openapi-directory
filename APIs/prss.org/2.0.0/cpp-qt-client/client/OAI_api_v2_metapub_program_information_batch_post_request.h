...
/*
 * OAI_api_v2_metapub_program_information_batch_post_request.h
 *
 * The batch operation definition.
 */

#ifndef OAI_api_v2_metapub_program_information_batch_post_request_H
#define OAI_api_v2_metapub_program_information_batch_post_request_H
...
namespace OpenAPI {
class OAI_api_v2_metapub_program_information_batch_post_request_program;

class OAI_api_v2_metapub_program_information_batch_post_request : public OAIObject {
public:
    OAI_api_v2_metapub_program_information_batch_post_request();
    OAI_api_v2_metapub_program_information_batch_post_request(QString json);
    ~OAI_api_v2_metapub_program_information_batch_post_request() override;
    ...
    OAI_api_v2_metapub_program_information_batch_post_request_program getProgram() const;
    void setProgram(const OAI_api_v2_metapub_program_information_batch_post_request_program &program);
...
private:
    ...
    OAI_api_v2_metapub_program_information_batch_post_request_program m_program;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_api_v2_metapub_program_information_batch_post_request)

#endif // OAI_api_v2_metapub_program_information_batch_post_request_H
