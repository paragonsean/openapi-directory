...
/*
 * OAIProgramInformationBatch_program.h
 *
...
#ifndef OAIProgramInformationBatch_program_H
#define OAIProgramInformationBatch_program_H
...
class OAIProgramInformationBatch_program : public OAIObject {
public:
    OAIProgramInformationBatch_program();
    OAIProgramInformationBatch_program(QString json);
    ~OAIProgramInformationBatch_program() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProgramInformationBatch_program)

#endif // OAIProgramInformationBatch_program_H
