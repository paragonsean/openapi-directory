...
public:
    ...
    /**
    * @param[in]  program_id qint64 [required]
    * @param[in]  id qint64 [optional]
    * @param[in]  begin_air_date_after QDateTime [optional]
    * @param[in]  end_air_date_before QDateTime [optional]
    * @param[in]  page_start qint32 [optional]
    * @param[in]  page_size qint32 [optional]
    * @param[in]  order_by_id QString [optional]
    */
    virtual void apiV2EpisodesGet(const qint64 &program_id, const ::OpenAPI::OptionalParam<qint64> &id = ::OpenAPI::OptionalParam<qint64>(), const ::OpenAPI::OptionalParam<QDateTime> &begin_air_date_after = ::OpenAPI::OptionalParam<QDateTime>(), const ::OpenAPI::OptionalParam<QDateTime> &end_air_date_before = ::OpenAPI::OptionalParam<QDateTime>(), const ::OpenAPI::OptionalParam<qint32> &page_start = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &order_by_id = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  id qint64 [required]
    */
    virtual void apiV2EpisodesIdGet(const qint64 &id);
...
private:
    ...
    void apiV2EpisodesGetCallback(OAIHttpRequestWorker *worker);
    void apiV2EpisodesIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void apiV2EpisodesGetSignal(QList<OAIEpisode> summary);
    void apiV2EpisodesIdGetSignal(OAIEpisode summary);


    void apiV2EpisodesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIEpisode> summary);
    void apiV2EpisodesIdGetSignalFull(OAIHttpRequestWorker *worker, OAIEpisode summary);

    Q_DECL_DEPRECATED_X("Use apiV2EpisodesGetSignalError() instead")
    void apiV2EpisodesGetSignalE(QList<OAIEpisode> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2EpisodesGetSignalError(QList<OAIEpisode> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV2EpisodesIdGetSignalError() instead")
    void apiV2EpisodesIdGetSignalE(OAIEpisode summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2EpisodesIdGetSignalError(OAIEpisode summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use apiV2EpisodesGetSignalErrorFull() instead")
    void apiV2EpisodesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2EpisodesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV2EpisodesIdGetSignalErrorFull() instead")
    void apiV2EpisodesIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2EpisodesIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
