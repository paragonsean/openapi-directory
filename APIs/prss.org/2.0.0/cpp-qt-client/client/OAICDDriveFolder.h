...
#ifndef OAICDDriveFolder_H
#define OAICDDriveFolder_H
...
class OAICDDriveFolder : public OAIObject {
public:
    OAICDDriveFolder();
    OAICDDriveFolder(QString json);
    ~OAICDDriveFolder() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICDDriveFolder)

#endif // OAICDDriveFolder_H
