...
#ifndef OAICDDriveItem_H
#define OAICDDriveItem_H
...
class OAICDDriveItem : public OAIObject {
public:
    OAICDDriveItem();
    OAICDDriveItem(QString json);
    ~OAICDDriveItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICDDriveItem)

#endif // OAICDDriveItem_H
