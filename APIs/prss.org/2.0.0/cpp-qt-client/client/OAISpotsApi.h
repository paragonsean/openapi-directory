...
public:
    ...
    */
    virtual void apiV2SpotsGet(const ::OpenAPI::OptionalParam<qint32> &page_start = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &order_by_id = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  id qint64 [required]
    */
    virtual void apiV2SpotsIdDelete(const qint64 &id);

    /**
    * @param[in]  id qint64 [required]
    */
    virtual void apiV2SpotsIdGet(const qint64 &id);

    /**
    * @param[in]  cd_drive_uri QString [required]
    * @param[in]  name QString [required]
    * @param[in]  notes QString [required]
    */
    virtual void apiV2SpotsPost(const QString &cd_drive_uri, const QString &name, const QString &notes);
...
private:
    ...
    void apiV2SpotsGetCallback(OAIHttpRequestWorker *worker);
    void apiV2SpotsIdDeleteCallback(OAIHttpRequestWorker *worker);
    void apiV2SpotsIdGetCallback(OAIHttpRequestWorker *worker);
    void apiV2SpotsPostCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void apiV2SpotsGetSignal(QList<OAISpot> summary);
    void apiV2SpotsIdDeleteSignal();
    void apiV2SpotsIdGetSignal(OAISpot summary);
    void apiV2SpotsPostSignal(OAISpot summary);


    void apiV2SpotsGetSignalFull(OAIHttpRequestWorker *worker, QList<OAISpot> summary);
    void apiV2SpotsIdDeleteSignalFull(OAIHttpRequestWorker *worker);
    void apiV2SpotsIdGetSignalFull(OAIHttpRequestWorker *worker, OAISpot summary);
    void apiV2SpotsPostSignalFull(OAIHttpRequestWorker *worker, OAISpot summary);

    Q_DECL_DEPRECATED_X("Use apiV2SpotsGetSignalError() instead")
    void apiV2SpotsGetSignalE(QList<OAISpot> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2SpotsGetSignalError(QList<OAISpot> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV2SpotsIdDeleteSignalError() instead")
    void apiV2SpotsIdDeleteSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2SpotsIdDeleteSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV2SpotsIdGetSignalError() instead")
    void apiV2SpotsIdGetSignalE(OAISpot summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2SpotsIdGetSignalError(OAISpot summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV2SpotsPostSignalError() instead")
    void apiV2SpotsPostSignalE(OAISpot summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2SpotsPostSignalError(OAISpot summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use apiV2SpotsGetSignalErrorFull() instead")
    void apiV2SpotsGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2SpotsGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV2SpotsIdDeleteSignalErrorFull() instead")
    void apiV2SpotsIdDeleteSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2SpotsIdDeleteSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV2SpotsIdGetSignalErrorFull() instead")
    void apiV2SpotsIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2SpotsIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV2SpotsPostSignalErrorFull() instead")
    void apiV2SpotsPostSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV2SpotsPostSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
