...
/*
 * OAICompetitorBasicVO.h
 *
 * 
 */

#ifndef OAICompetitorBasicVO_H
#define OAICompetitorBasicVO_H
...
class OAICompetitorBasicVO : public OAIObject {
public:
    OAICompetitorBasicVO();
    OAICompetitorBasicVO(QString json);
    ~OAICompetitorBasicVO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompetitorBasicVO)

#endif // OAICompetitorBasicVO_H
