...
/*
 * OAICompanyBasicSearchVO.h
 *
 * 
 */

#ifndef OAICompanyBasicSearchVO_H
#define OAICompanyBasicSearchVO_H
...
class OAICompanyBasicSearchVO : public OAIObject {
public:
    OAICompanyBasicSearchVO();
    OAICompanyBasicSearchVO(QString json);
    ~OAICompanyBasicSearchVO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompanyBasicSearchVO)

#endif // OAICompanyBasicSearchVO_H
