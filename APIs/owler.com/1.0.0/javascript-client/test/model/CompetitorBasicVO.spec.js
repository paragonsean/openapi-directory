...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Owler.CompetitorBasicVO();
  });
  ...
  describe('CompetitorBasicVO', function() {
    it('should create an instance of CompetitorBasicVO', function() {
      // uncomment below and update the code to test CompetitorBasicVO
      //var instance = new Owler.CompetitorBasicVO();
      //expect(instance).to.be.a(Owler.CompetitorBasicVO);
    });
