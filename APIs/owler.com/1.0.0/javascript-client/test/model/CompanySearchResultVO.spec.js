...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Owler.CompanySearchResultVO();
  });
  ...
  describe('CompanySearchResultVO', function() {
    it('should create an instance of CompanySearchResultVO', function() {
      // uncomment below and update the code to test CompanySearchResultVO
      //var instance = new Owler.CompanySearchResultVO();
      //expect(instance).to.be.a(Owler.CompanySearchResultVO);
    });
