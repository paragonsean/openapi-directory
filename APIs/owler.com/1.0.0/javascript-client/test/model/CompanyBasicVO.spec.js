...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Owler.CompanyBasicVO();
  });
  ...
  describe('CompanyBasicVO', function() {
    it('should create an instance of CompanyBasicVO', function() {
      // uncomment below and update the code to test CompanyBasicVO
      //var instance = new Owler.CompanyBasicVO();
      //expect(instance).to.be.a(Owler.CompanyBasicVO);
    });
