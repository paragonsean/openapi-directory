...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://trips.furkot.com/pub/api') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://trips.furkot.com/pub/api
         */
        ...
        this.authentications = {
            'furkot_auth_access_code': {type: 'oauth2'},
            'furkot_auth_implicit': {type: 'oauth2'}
        }
