...
public class ApiClient {
    ...
    private String basePath = "https://trips.furkot.com/pub/api";
    ...
    public ApiClient() {
        ...
        authentications.put("furkot_auth_access_code", new OAuth());
        authentications.put("furkot_auth_implicit", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://trips.furkot.com/pub/api/access_token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://trips.furkot.com/pub/api
