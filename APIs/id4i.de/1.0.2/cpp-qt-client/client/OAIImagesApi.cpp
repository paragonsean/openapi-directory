...
void OAIImagesApi::resolveImageUsingGET(const QString &image_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImagesApi::resolveImageUsingGETCallback);
...
void OAIImagesApi::resolveImageUsingGETCallback(OAIHttpRequestWorker *worker) {
