...
(function(root, factory) {
  ...
  describe('BillingPosition', function() {
    it('should create an instance of BillingPosition', function() {
      ...
      //var instance = new Id4iApi.BillingPosition();
    ...
    it('should have the property singlePrice (base name: "singlePrice")', function() {
      // uncomment below and update the code to test the property singlePrice
      //var instance = new Id4iApi.BillingPosition();
      //expect(instance).to.be();
    });
