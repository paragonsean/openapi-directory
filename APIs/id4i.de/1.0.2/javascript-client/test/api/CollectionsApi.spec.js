...
(function(root, factory) {
  ...
  describe('CollectionsApi', function() {
    ...
    describe('getMultipleProperties', function() {
      it('should call getMultipleProperties successfully', function(done) {
        //uncomment below and update the code to test getMultipleProperties
        //instance.getMultipleProperties(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
