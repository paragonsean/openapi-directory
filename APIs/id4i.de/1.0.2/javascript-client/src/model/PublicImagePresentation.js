...
class PublicImagePresentation {
    ...
    constructor() { 
        ...
        PublicImagePresentation.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicImagePresentation();
    ...
    /**
     * Validates the JSON data with respect to <code>PublicImagePresentation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicImagePresentation</code>.
     */
 ...
 * @member {String} uri
 */
PublicImagePresentation.prototype['uri'] = undefined;
...
export default PublicImagePresentation;
