 ...
 * @version 1.0.2
 */
class PaginatedResponseOfUserRoles {
    /**
    ...
    constructor(elements, limit, offset) { 
        ...
        PaginatedResponseOfUserRoles.initialize(this, elements, limit, offset);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaginatedResponseOfUserRoles();
    ...
    /**
     * Validates the JSON data with respect to <code>PaginatedResponseOfUserRoles</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaginatedResponseOfUserRoles</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaginatedResponseOfUserRoles.RequiredProperties) {
...
PaginatedResponseOfUserRoles.RequiredProperties = ["elements", "limit", "offset"];

/**
 * @member {Array.<module:model/UserRoles>} elements
 */
PaginatedResponseOfUserRoles.prototype['elements'] = undefined;

/**
 * The number of returned elements
 * @member {Number} limit
 */
PaginatedResponseOfUserRoles.prototype['limit'] = undefined;

/**
 * Starting with the n-th element
 * @member {Number} offset
 */
PaginatedResponseOfUserRoles.prototype['offset'] = undefined;

/**
 * The total number of elements
 * @member {Number} total
 */
PaginatedResponseOfUserRoles.prototype['total'] = undefined;
...
export default PaginatedResponseOfUserRoles;
