...
class UserPresentation {
    ...
    constructor() { 
        ...
        UserPresentation.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserPresentation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserPresentation</code>.
     */
 ...
 * @member {String} id
 */
UserPresentation.prototype['id'] = undefined;

/**
 * @member {String} name
 */
UserPresentation.prototype['name'] = undefined;
