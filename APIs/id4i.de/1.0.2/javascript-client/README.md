...
To use the link you just defined in your project, switch to the directory you want to use your id4i_api from, and run:
...
*Id4iApi.CollectionsApi* | [**deleteProperties**](docs/CollectionsApi.md#deleteProperties) | **DELETE** /api/v1/id4ns/{id4n}/properties | Delete ID4n properties
...
*Id4iApi.CollectionsApi* | [**getMultipleProperties**](docs/CollectionsApi.md#getMultipleProperties) | **GET** /api/v1/multiple/id4ns/properties | Get multiple ID4n properties
*Id4iApi.CollectionsApi* | [**getProperties**](docs/CollectionsApi.md#getProperties) | **GET** /api/v1/id4ns/{id4n}/properties | Retrieve ID4n properties
...
*Id4iApi.CollectionsApi* | [**patchProperties**](docs/CollectionsApi.md#patchProperties) | **PATCH** /api/v1/id4ns/{id4n}/properties | Patch ID4n properties
...
*Id4iApi.GuidsApi* | [**addGuidAlias_0**](docs/GuidsApi.md#addGuidAlias_0) | **POST** /api/v1/id4ns/{id4n}/alias/{aliasType} | Add alias for GUID or Collection
*Id4iApi.GuidsApi* | [**createGuid**](docs/GuidsApi.md#createGuid) | **POST** /api/v1/guids | Create GUID(s)
*Id4iApi.GuidsApi* | [**deleteProperties_0**](docs/GuidsApi.md#deleteProperties_0) | **DELETE** /api/v1/id4ns/{id4n}/properties | Delete ID4n properties
...
*Id4iApi.GuidsApi* | [**getGuidAliases_0**](docs/GuidsApi.md#getGuidAliases_0) | **GET** /api/v1/id4ns/{id4n}/alias | Get all aliases for the given GUID or Collection.
...
*Id4iApi.GuidsApi* | [**getMultipleProperties_0**](docs/GuidsApi.md#getMultipleProperties_0) | **GET** /api/v1/multiple/id4ns/properties | Get multiple ID4n properties
*Id4iApi.GuidsApi* | [**getProperties_0**](docs/GuidsApi.md#getProperties_0) | **GET** /api/v1/id4ns/{id4n}/properties | Retrieve ID4n properties
*Id4iApi.GuidsApi* | [**importGS1Codes**](docs/GuidsApi.md#importGS1Codes) | **POST** /api/v1/import/gs1 | Import GS1/MAPP codes
*Id4iApi.GuidsApi* | [**patchProperties_0**](docs/GuidsApi.md#patchProperties_0) | **PATCH** /api/v1/id4ns/{id4n}/properties | Patch ID4n properties
*Id4iApi.GuidsApi* | [**removeGuidAlias_0**](docs/GuidsApi.md#removeGuidAlias_0) | **DELETE** /api/v1/id4ns/{id4n}/alias/{aliasType} | Remove aliases from GUID or Collection
...
*Id4iApi.OrganizationsApi* | [**addUserRoles_0**](docs/OrganizationsApi.md#addUserRoles_0) | **POST** /api/v1/organizations/{organizationId}/users/{username}/roles | Add role(s) to user
...
*Id4iApi.OrganizationsApi* | [**getAllCollectionsOfOrganization_0**](docs/OrganizationsApi.md#getAllCollectionsOfOrganization_0) | **GET** /api/v1/organizations/{organizationId}/collections | Get collections of organization
*Id4iApi.OrganizationsApi* | [**getAllOrganizationRoles_0**](docs/OrganizationsApi.md#getAllOrganizationRoles_0) | **GET** /api/v1/organizations/{organizationId}/roles | List users and their roles
...
*Id4iApi.OrganizationsApi* | [**getOrganizationsOfUser_0**](docs/OrganizationsApi.md#getOrganizationsOfUser_0) | **GET** /api/v1/user/organizations | Retrieve organizations of user
...
*Id4iApi.OrganizationsApi* | [**getUserRoles_0**](docs/OrganizationsApi.md#getUserRoles_0) | **GET** /api/v1/organizations/{organizationId}/users/{username}/roles | Get user roles by username
*Id4iApi.OrganizationsApi* | [**getUsersOfOrganization_0**](docs/OrganizationsApi.md#getUsersOfOrganization_0) | **GET** /api/v1/organizations/{organizationId}/users | Find users in organization
*Id4iApi.OrganizationsApi* | [**inviteUsers_0**](docs/OrganizationsApi.md#inviteUsers_0) | **POST** /api/v1/organizations/{organizationId}/users/invite | Invite Users
...
*Id4iApi.OrganizationsApi* | [**removeUserRoles_0**](docs/OrganizationsApi.md#removeUserRoles_0) | **DELETE** /api/v1/organizations/{organizationId}/users/{username}/roles | Remove role(s) from user
...
*Id4iApi.PublicServicesApi* | [**resolveImageUsingGET_0**](docs/PublicServicesApi.md#resolveImageUsingGET_0) | **GET** /api/v1/public/image/{imageID} | Resolve image
...
*Id4iApi.StorageApi* | [**createDocument**](docs/StorageApi.md#createDocument) | **POST** /api/v1/documents/{id4n}/{organizationId} | Create an document for an id4n
...
*Id4iApi.StorageApi* | [**getPublicDocument_0**](docs/StorageApi.md#getPublicDocument_0) | **GET** /api/v1/public/documents/{id4n}/{organizationId}/{fileName}/metadata | Retrieve a public document (meta-data only, no content)
*Id4iApi.StorageApi* | [**listAllDocuments**](docs/StorageApi.md#listAllDocuments) | **GET** /api/v1/documents/{id4n} | List documents
*Id4iApi.StorageApi* | [**listAllPublicDocuments_0**](docs/StorageApi.md#listAllPublicDocuments_0) | **GET** /api/v1/public/documents/{id4n} | List public documents
...
*Id4iApi.StorageApi* | [**putDocument**](docs/StorageApi.md#putDocument) | **PUT** /api/v1/documents/{id4n}/{organizationId} | Put an document for an id4n
...
*Id4iApi.StorageApi* | [**readPublicDocument_0**](docs/StorageApi.md#readPublicDocument_0) | **GET** /api/v1/public/documents/{id4n}/{organizationId}/{fileName} | Read public document contents
...
*Id4iApi.WhoIsApi* | [**resolveWhoIsEntry_0**](docs/WhoIsApi.md#resolveWhoIsEntry_0) | **GET** /whois/{id4n} | Resolve owner of id4n
...
## Documentation for Models
 ...
 - [Id4iApi.Id4nProperties](docs/Id4nProperties.md)
 - [Id4iApi.ImportGS1CodesRequest](docs/ImportGS1CodesRequest.md)
 - [Id4iApi.ListOfGS1s](docs/ListOfGS1s.md)
 - [Id4iApi.ListOfId4nProperties](docs/ListOfId4nProperties.md)
