...
**ownerOrganizationId** | **String** | Owner of the history item | [optional] [readonly] 
**sequenceId** | **Number** | Forms the primary key of the history item together with the GUID and the organizationId | [optional] [readonly] 
**timestamp** | **Number** | History item timestamp | [optional] [readonly] 
