...
|**sequenceId** | **Integer** | Forms the primary key of the history item together with the GUID and the organizationId |  [optional] [readonly] |
|**timestamp** | **Long** | History item timestamp |  [optional] [readonly] |
