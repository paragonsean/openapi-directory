...
import org.openapitools.client.api.PublicServicesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    PublicServicesApi apiInstance = new PublicServicesApi(defaultClient);
...
<a id="resolveImageUsingGET_0"></a>
# **resolveImageUsingGET_0**
> byte[] resolveImageUsingGET_0(imageID)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      byte[] result = apiInstance.resolveImageUsingGET_0(imageID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PublicServicesApi#resolveImageUsingGET_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
