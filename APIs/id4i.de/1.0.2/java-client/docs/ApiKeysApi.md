...
<a id="addApiKeyPrivilegeForId4ns"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    ListOfId4ns listOfId4ns = new ListOfId4ns(); // ListOfId4ns | id4ns
    try {
      apiInstance.addApiKeyPrivilegeForId4ns(key, privilege, listOfId4ns);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    ApiKeysApi apiInstance = new ApiKeysApi(defaultClient);
    ApiKeyCreationRequest apiKeyCreationRequest = new ApiKeyCreationRequest(); // ApiKeyCreationRequest | API key to be created.
    try {
      ApiKeyPresentation result = apiInstance.createNewApiKey(apiKeyCreationRequest);
...
<a id="listAllApiKeyPrivileges"></a>
...
<a id="listAllApiKeysOfOrganization"></a>
...
<a id="removeApiKeyPrivilegeForId4ns"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    ListOfId4ns listOfId4ns = new ListOfId4ns(); // ListOfId4ns | id4ns
    try {
      apiInstance.removeApiKeyPrivilegeForId4ns(key, privilege, listOfId4ns);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    ApiKeyChangeRequest apiKeyChangeRequest = new ApiKeyChangeRequest(); // ApiKeyChangeRequest | The new values to apply.
    try {
      apiInstance.updateApiKey(key, apiKeyChangeRequest);
    } catch (ApiException e) {
