...
public class ApiClient {
    ...
    private String basePath = "https://productapi.intel.com";
    ...
    public ApiClient() {
        ...
        authentications.put("ClientId", new ApiKeyAuth("header", "client_id"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://productapi.intel.com
