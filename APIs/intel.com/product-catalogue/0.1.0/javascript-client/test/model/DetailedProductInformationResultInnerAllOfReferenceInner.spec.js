...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelProductCatalogueService.DetailedProductInformationResultInnerAllOfReferenceInner();
  });
  ...
  describe('DetailedProductInformationResultInnerAllOfReferenceInner', function() {
    it('should create an instance of DetailedProductInformationResultInnerAllOfReferenceInner', function() {
      // uncomment below and update the code to test DetailedProductInformationResultInnerAllOfReferenceInner
      //var instance = new IntelProductCatalogueService.DetailedProductInformationResultInnerAllOfReferenceInner();
      //expect(instance).to.be.a(IntelProductCatalogueService.DetailedProductInformationResultInnerAllOfReferenceInner);
    });
    ...
    it('should have the property referenceType (base name: "reference_type")', function() {
