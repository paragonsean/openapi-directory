...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelProductCatalogueService.DetailedOrderingLevelInfo();
  });
  ...
  describe('DetailedOrderingLevelInfo', function() {
    it('should create an instance of DetailedOrderingLevelInfo', function() {
      // uncomment below and update the code to test DetailedOrderingLevelInfo
      //var instance = new IntelProductCatalogueService.DetailedOrderingLevelInfo();
      //expect(instance).to.be.a(IntelProductCatalogueService.DetailedOrderingLevelInfo);
    });
