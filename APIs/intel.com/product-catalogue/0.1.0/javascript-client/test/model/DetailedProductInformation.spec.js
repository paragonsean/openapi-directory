...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelProductCatalogueService.DetailedProductInformation();
  });
  ...
  describe('DetailedProductInformation', function() {
    it('should create an instance of DetailedProductInformation', function() {
      // uncomment below and update the code to test DetailedProductInformation
      //var instance = new IntelProductCatalogueService.DetailedProductInformation();
      //expect(instance).to.be.a(IntelProductCatalogueService.DetailedProductInformation);
    });
