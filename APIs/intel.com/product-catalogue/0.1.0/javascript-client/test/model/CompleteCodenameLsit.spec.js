...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelProductCatalogueService.CompleteCodenameLsit();
  });
  ...
  describe('CompleteCodenameLsit', function() {
    it('should create an instance of CompleteCodenameLsit', function() {
      // uncomment below and update the code to test CompleteCodenameLsit
      //var instance = new IntelProductCatalogueService.CompleteCodenameLsit();
      //expect(instance).to.be.a(IntelProductCatalogueService.CompleteCodenameLsit);
    });
