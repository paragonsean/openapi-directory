...
void Example::exampleFunction1(){
     OAIProductsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIProductsApi::getCodeNameSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIProductsApi::getCodeNameSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString locale_geo_id = create(); // QString | Locale and Geo code used to get localised data.<br/><br/>
      apiInstance.getCodeName(locale_geo_id);
