...
async def airtravel_multileg(request: web.Request, body) -> web.Response:
    """airtravelMultileg
    ...
    """
    body = AirtravelMultilegRequest.from_dict(body)
    return web.Response(status=200)


async def confirm_carbon_offset3(request: web.Request, carbon_offset, transaction_id, contact_email=None, contact_first_name=None, contact_last_name=None) -> web.Response:
    """confirmCarbonOffset
...
async def confirm_payment3(request: web.Request, api_key_l1, api_key_l2, confirm_payment, payment_id, transaction_id) -> web.Response:
    """confirmPayment
...
async def confirm_payment_of_transaction3(request: web.Request, confirm_transaction, transaction_id) -> web.Response:
    """confirmTransaction
...
async def confirms_planting3(request: web.Request, api_key_l1, api_key_l2, confirm_planting, transaction_id) -> web.Response:
    """confirmPlanting
