...
public class CreateSubmissionBatchSubmissionsResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, createSubmissionBatchSubmissionsResponse.errors) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSubmissionBatchSubmissionsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSubmissionBatchSubmissionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSubmissionBatchSubmissionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSubmissionBatchSubmissionsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
