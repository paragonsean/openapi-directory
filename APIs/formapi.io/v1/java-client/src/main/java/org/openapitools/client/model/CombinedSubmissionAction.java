...
public class CombinedSubmissionAction {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionCategory, combinedSubmissionAction.actionCategory) &&
        Objects.equals(this.actionType, combinedSubmissionAction.actionType) &&
        Objects.equals(this.id, combinedSubmissionAction.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to CombinedSubmissionAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CombinedSubmissionAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CombinedSubmissionAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CombinedSubmissionAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
