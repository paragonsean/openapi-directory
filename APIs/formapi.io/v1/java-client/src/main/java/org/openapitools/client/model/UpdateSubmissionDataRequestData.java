...
public class UpdateSubmissionDataRequestData {
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSubmissionDataRequestData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSubmissionDataRequestData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSubmissionDataRequestData is not found in the empty JSON string", UpdateSubmissionDataRequestData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSubmissionDataRequestData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSubmissionDataRequestData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSubmissionDataRequestData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSubmissionDataRequestData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSubmissionDataRequestData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSubmissionDataRequestData.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSubmissionDataRequestData>() {
           @Override
           public void write(JsonWriter out, UpdateSubmissionDataRequestData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSubmissionDataRequestData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSubmissionDataRequestData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSubmissionDataRequestData
   * @throws IOException if the JSON string is invalid with respect to UpdateSubmissionDataRequestData
   */
  public static UpdateSubmissionDataRequestData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSubmissionDataRequestData.class);
  }

  /**
   * Convert an instance of UpdateSubmissionDataRequestData to an JSON string
   *
   * @return JSON string
   */
