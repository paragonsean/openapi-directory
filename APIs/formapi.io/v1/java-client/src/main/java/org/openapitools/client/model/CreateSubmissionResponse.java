...
public class CreateSubmissionResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, createSubmissionResponse.errors) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSubmissionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSubmissionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSubmissionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSubmissionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
