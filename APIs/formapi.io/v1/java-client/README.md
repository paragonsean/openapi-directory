...
API v1
- API version: v1
  - Build date: 2024-10-12T12:42:11.973433-04:00[America/New_York]
...
*PdfApi* | [**templatesTemplateIdSubmissionsGet**](docs/PdfApi.md#templatesTemplateIdSubmissionsGet) | **GET** /templates/{template_id}/submissions | List all submissions for a given template
