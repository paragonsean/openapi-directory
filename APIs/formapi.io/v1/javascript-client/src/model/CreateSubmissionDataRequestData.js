...
class CreateSubmissionDataRequestData {
     ...
     * @param authType {module:model/CreateSubmissionDataRequestData.AuthTypeEnum} 
     * @param email {String} 
     */
    constructor(authType, email) { 
        
        CreateSubmissionDataRequestData.initialize(this, authType, email);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateSubmissionDataRequestData.RequiredProperties) {
...
CreateSubmissionDataRequestData.RequiredProperties = ["auth_type", "email"];
