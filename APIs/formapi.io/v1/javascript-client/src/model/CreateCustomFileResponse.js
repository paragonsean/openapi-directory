...
class CreateCustomFileResponse {
     ...
     */
    constructor(customFile, status) { 
        
        CreateCustomFileResponse.initialize(this, customFile, status);
    }
     ...
     */
    static initialize(obj, customFile, status) { 
...
CreateCustomFileResponse.RequiredProperties = ["custom_file", "status"];
