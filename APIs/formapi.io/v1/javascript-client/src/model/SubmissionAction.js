...
class SubmissionAction {
    ...
    constructor(actionCategory, actionType, id, integrationId, resultData, state) { 
        ...
        SubmissionAction.initialize(this, actionCategory, actionType, id, integrationId, resultData, state);
    }
...
SubmissionAction.RequiredProperties = ["action_category", "action_type", "id", "integration_id", "result_data", "state"];
