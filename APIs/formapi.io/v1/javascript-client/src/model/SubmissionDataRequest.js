...
class SubmissionDataRequest {
     ...
     */
    constructor(email, fields, id, metadata, name, order, sortOrder, state) { 
        
        SubmissionDataRequest.initialize(this, email, fields, id, metadata, name, order, sortOrder, state);
    }
     ...
     */
    static initialize(obj, email, fields, id, metadata, name, order, sortOrder, state) { 
        obj['email'] = email;
        obj['fields'] = fields;
        obj['id'] = id;
...
SubmissionDataRequest.RequiredProperties = ["email", "fields", "id", "metadata", "name", "order", "sort_order", "state"];
 ...
 */
SubmissionDataRequest.prototype['submission_id'] = undefined;
