...
class UpdateTemplateData {
    ...
    constructor(template) { 
        ...
        UpdateTemplateData.initialize(this, template);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateTemplateData();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateTemplateData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateTemplateData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateTemplateData.RequiredProperties) {
        ...
        if (data['template']) { // data not null
          TemplateData.validateJSON(data['template']);
        }
...
UpdateTemplateData.RequiredProperties = ["template"];

/**
 * @member {module:model/TemplateData} template
 */
UpdateTemplateData.prototype['template'] = undefined;
