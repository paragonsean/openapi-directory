...
class HtmlTemplateData {
    ...
    constructor(name) { 
        ...
        HtmlTemplateData.initialize(this, name);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>HtmlTemplateData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HtmlTemplateData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HtmlTemplateData.RequiredProperties) {
...
HtmlTemplateData.RequiredProperties = ["name"];

/**
 * @member {Boolean} allow_additional_properties
 */
HtmlTemplateData.prototype['allow_additional_properties'] = undefined;

/**
 * @member {String} description
 */
HtmlTemplateData.prototype['description'] = undefined;

/**
 * @member {Boolean} editable_submissions
 */
HtmlTemplateData.prototype['editable_submissions'] = undefined;

/**
 * @member {module:model/HtmlTemplateData.ExpirationIntervalEnum} expiration_interval
 */
HtmlTemplateData.prototype['expiration_interval'] = undefined;

/**
 * @member {Number} expire_after
 */
HtmlTemplateData.prototype['expire_after'] = undefined;

/**
 * @member {Boolean} expire_submissions
 */
HtmlTemplateData.prototype['expire_submissions'] = undefined;

/**
 * @member {String} footer_html
 */
HtmlTemplateData.prototype['footer_html'] = undefined;

/**
 * @member {String} header_html
 */
HtmlTemplateData.prototype['header_html'] = undefined;

/**
 * @member {String} html
 */
HtmlTemplateData.prototype['html'] = undefined;

/**
 * @member {String} name
 */
HtmlTemplateData.prototype['name'] = undefined;

/**
 * @member {Boolean} public_submissions
 */
HtmlTemplateData.prototype['public_submissions'] = undefined;

/**
 * @member {Boolean} public_web_form
 */
HtmlTemplateData.prototype['public_web_form'] = undefined;

/**
 * @member {String} redirect_url
 */
HtmlTemplateData.prototype['redirect_url'] = undefined;

/**
 * @member {String} scss
 */
HtmlTemplateData.prototype['scss'] = undefined;

/**
 * @member {String} slack_webhook_url
 */
HtmlTemplateData.prototype['slack_webhook_url'] = undefined;

/**
 * @member {module:model/HtmlTemplateData.TemplateTypeEnum} template_type
 */
HtmlTemplateData.prototype['template_type'] = undefined;

/**
 * @member {String} webhook_url
 */
HtmlTemplateData.prototype['webhook_url'] = undefined;
 ...
 * @readonly
 */
HtmlTemplateData['ExpirationIntervalEnum'] = {
 ...
 * @readonly
 */
HtmlTemplateData['TemplateTypeEnum'] = {
