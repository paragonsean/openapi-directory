...
class CreateCombinedSubmissionResponse {
     ...
     */
    constructor(combinedSubmission, status) { 
        
        CreateCombinedSubmissionResponse.initialize(this, combinedSubmission, status);
    }
     ...
     */
    static initialize(obj, combinedSubmission, status) { 
...
CreateCombinedSubmissionResponse.RequiredProperties = ["combined_submission", "status"];
