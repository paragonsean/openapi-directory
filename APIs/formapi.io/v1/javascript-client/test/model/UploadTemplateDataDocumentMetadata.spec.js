...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.UploadTemplateDataDocumentMetadata();
  });
  ...
  describe('UploadTemplateDataDocumentMetadata', function() {
    it('should create an instance of UploadTemplateDataDocumentMetadata', function() {
      ...
      //var instance = new ApiV1.UploadTemplateDataDocumentMetadata();
      //expect(instance).to.be.a(ApiV1.UploadTemplateDataDocumentMetadata);
    });
