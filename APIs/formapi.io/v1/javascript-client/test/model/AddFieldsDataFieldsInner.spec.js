...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.AddFieldsDataFieldsInner();
  });
  ...
  describe('AddFieldsDataFieldsInner', function() {
    it('should create an instance of AddFieldsDataFieldsInner', function() {
      // uncomment below and update the code to test AddFieldsDataFieldsInner
      //var instance = new ApiV1.AddFieldsDataFieldsInner();
      //expect(instance).to.be.a(ApiV1.AddFieldsDataFieldsInner);
    });
