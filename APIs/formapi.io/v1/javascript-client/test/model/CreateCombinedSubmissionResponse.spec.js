...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.CreateCombinedSubmissionResponse();
  });
  ...
  describe('CreateCombinedSubmissionResponse', function() {
    it('should create an instance of CreateCombinedSubmissionResponse', function() {
      ...
      //var instance = new ApiV1.CreateCombinedSubmissionResponse();
      //expect(instance).to.be.a(ApiV1.CreateCombinedSubmissionResponse);
    });
