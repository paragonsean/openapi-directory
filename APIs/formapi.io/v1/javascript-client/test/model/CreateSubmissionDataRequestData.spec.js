...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.CreateSubmissionDataRequestData();
  });
  ...
  describe('CreateSubmissionDataRequestData', function() {
    it('should create an instance of CreateSubmissionDataRequestData', function() {
      ...
      //var instance = new ApiV1.CreateSubmissionDataRequestData();
      //expect(instance).to.be.a(ApiV1.CreateSubmissionDataRequestData);
    });
