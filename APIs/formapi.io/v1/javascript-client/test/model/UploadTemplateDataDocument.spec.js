...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.UploadTemplateDataDocument();
  });
  ...
  describe('UploadTemplateDataDocument', function() {
    it('should create an instance of UploadTemplateDataDocument', function() {
      ...
      //var instance = new ApiV1.UploadTemplateDataDocument();
      //expect(instance).to.be.a(ApiV1.UploadTemplateDataDocument);
    });
