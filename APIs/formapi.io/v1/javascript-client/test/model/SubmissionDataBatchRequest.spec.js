...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.SubmissionDataBatchRequest();
  });
  ...
  describe('SubmissionDataBatchRequest', function() {
    it('should create an instance of SubmissionDataBatchRequest', function() {
      ...
      //var instance = new ApiV1.SubmissionDataBatchRequest();
      //expect(instance).to.be.a(ApiV1.SubmissionDataBatchRequest);
    });
