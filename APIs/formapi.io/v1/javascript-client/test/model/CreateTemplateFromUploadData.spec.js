...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.CreateTemplateFromUploadData();
  });
  ...
  describe('CreateTemplateFromUploadData', function() {
    it('should create an instance of CreateTemplateFromUploadData', function() {
      ...
      //var instance = new ApiV1.CreateTemplateFromUploadData();
      //expect(instance).to.be.a(ApiV1.CreateTemplateFromUploadData);
    });
