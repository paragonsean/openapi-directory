...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.CreateSubmissionDataRequestTokenResponseToken();
  });
  ...
  describe('CreateSubmissionDataRequestTokenResponseToken', function() {
    it('should create an instance of CreateSubmissionDataRequestTokenResponseToken', function() {
      ...
      //var instance = new ApiV1.CreateSubmissionDataRequestTokenResponseToken();
      //expect(instance).to.be.a(ApiV1.CreateSubmissionDataRequestTokenResponseToken);
    });
