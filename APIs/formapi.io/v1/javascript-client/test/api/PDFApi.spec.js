...
(function(root, factory) {
  ...
  describe('PDFApi', function() {
    ...
    describe('templatesTemplateIdSubmissionsGet', function() {
      it('should call templatesTemplateIdSubmissionsGet successfully', function(done) {
        //uncomment below and update the code to test templatesTemplateIdSubmissionsGet
        //instance.templatesTemplateIdSubmissionsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
