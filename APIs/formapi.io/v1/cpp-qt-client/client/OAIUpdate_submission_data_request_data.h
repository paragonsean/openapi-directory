...
/*
 * OAIUpdate_submission_data_request_data.h
 *
 * 
 */

#ifndef OAIUpdate_submission_data_request_data_H
#define OAIUpdate_submission_data_request_data_H
...
class OAIUpdate_submission_data_request_data : public OAIObject {
public:
    OAIUpdate_submission_data_request_data();
    OAIUpdate_submission_data_request_data(QString json);
    ~OAIUpdate_submission_data_request_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdate_submission_data_request_data)

#endif // OAIUpdate_submission_data_request_data_H
