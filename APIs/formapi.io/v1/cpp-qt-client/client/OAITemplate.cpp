...
bool OAITemplate::isAllowAdditionalProperties() const {
    return m_allow_additional_properties;
}
void OAITemplate::setAllowAdditionalProperties(const bool &allow_additional_properties) {
    m_allow_additional_properties = allow_additional_properties;
    m_allow_additional_properties_isSet = true;
}

bool OAITemplate::is_allow_additional_properties_Set() const{
    return m_allow_additional_properties_isSet;
}

bool OAITemplate::is_allow_additional_properties_Valid() const{
    return m_allow_additional_properties_isValid;
}

QString OAITemplate::getDescription() const {
    return m_description;
}
void OAITemplate::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAITemplate::is_description_Set() const{
    return m_description_isSet;
}

bool OAITemplate::is_description_Valid() const{
    return m_description_isValid;
}

QString OAITemplate::getDocumentUrl() const {
    return m_document_url;
}
void OAITemplate::setDocumentUrl(const QString &document_url) {
    m_document_url = document_url;
    m_document_url_isSet = true;
}

bool OAITemplate::is_document_url_Set() const{
    return m_document_url_isSet;
}

bool OAITemplate::is_document_url_Valid() const{
    return m_document_url_isValid;
}

bool OAITemplate::isEditableSubmissions() const {
    return m_editable_submissions;
}
void OAITemplate::setEditableSubmissions(const bool &editable_submissions) {
    m_editable_submissions = editable_submissions;
    m_editable_submissions_isSet = true;
}

bool OAITemplate::is_editable_submissions_Set() const{
    return m_editable_submissions_isSet;
}

bool OAITemplate::is_editable_submissions_Valid() const{
    return m_editable_submissions_isValid;
}

QString OAITemplate::getExpirationInterval() const {
    return m_expiration_interval;
}
void OAITemplate::setExpirationInterval(const QString &expiration_interval) {
    m_expiration_interval = expiration_interval;
    m_expiration_interval_isSet = true;
}

bool OAITemplate::is_expiration_interval_Set() const{
    return m_expiration_interval_isSet;
}

bool OAITemplate::is_expiration_interval_Valid() const{
    return m_expiration_interval_isValid;
}

double OAITemplate::getExpireAfter() const {
    return m_expire_after;
}
void OAITemplate::setExpireAfter(const double &expire_after) {
    m_expire_after = expire_after;
    m_expire_after_isSet = true;
}

bool OAITemplate::is_expire_after_Set() const{
    return m_expire_after_isSet;
}

bool OAITemplate::is_expire_after_Valid() const{
    return m_expire_after_isValid;
}

bool OAITemplate::isExpireSubmissions() const {
    return m_expire_submissions;
}
void OAITemplate::setExpireSubmissions(const bool &expire_submissions) {
    m_expire_submissions = expire_submissions;
    m_expire_submissions_isSet = true;
}

bool OAITemplate::is_expire_submissions_Set() const{
    return m_expire_submissions_isSet;
}

bool OAITemplate::is_expire_submissions_Valid() const{
...
bool OAITemplate::isLocked() const {
    return m_locked;
}
void OAITemplate::setLocked(const bool &locked) {
    m_locked = locked;
    m_locked_isSet = true;
}

bool OAITemplate::is_locked_Set() const{
    return m_locked_isSet;
}

bool OAITemplate::is_locked_Valid() const{
...
QList<QList<double>> OAITemplate::getPageDimensions() const {
    return m_page_dimensions;
}
void OAITemplate::setPageDimensions(const QList<QList<double>> &page_dimensions) {
    m_page_dimensions = page_dimensions;
    m_page_dimensions_isSet = true;
}

bool OAITemplate::is_page_dimensions_Set() const{
    return m_page_dimensions_isSet;
}

bool OAITemplate::is_page_dimensions_Valid() const{
    return m_page_dimensions_isValid;
}

QString OAITemplate::getParentFolderId() const {
    return m_parent_folder_id;
}
void OAITemplate::setParentFolderId(const QString &parent_folder_id) {
    m_parent_folder_id = parent_folder_id;
    m_parent_folder_id_isSet = true;
}

bool OAITemplate::is_parent_folder_id_Set() const{
    return m_parent_folder_id_isSet;
}

bool OAITemplate::is_parent_folder_id_Valid() const{
    return m_parent_folder_id_isValid;
}

QString OAITemplate::getPath() const {
    return m_path;
}
void OAITemplate::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAITemplate::is_path_Set() const{
    return m_path_isSet;
}

bool OAITemplate::is_path_Valid() const{
    return m_path_isValid;
}

QString OAITemplate::getPermanentDocumentUrl() const {
    return m_permanent_document_url;
}
void OAITemplate::setPermanentDocumentUrl(const QString &permanent_document_url) {
    m_permanent_document_url = permanent_document_url;
    m_permanent_document_url_isSet = true;
}

bool OAITemplate::is_permanent_document_url_Set() const{
    return m_permanent_document_url_isSet;
}

bool OAITemplate::is_permanent_document_url_Valid() const{
    return m_permanent_document_url_isValid;
}

bool OAITemplate::isPublicSubmissions() const {
    return m_public_submissions;
}
void OAITemplate::setPublicSubmissions(const bool &public_submissions) {
    m_public_submissions = public_submissions;
    m_public_submissions_isSet = true;
}

bool OAITemplate::is_public_submissions_Set() const{
    return m_public_submissions_isSet;
}

bool OAITemplate::is_public_submissions_Valid() const{
    return m_public_submissions_isValid;
}

bool OAITemplate::isPublicWebForm() const {
    return m_public_web_form;
}
void OAITemplate::setPublicWebForm(const bool &public_web_form) {
    m_public_web_form = public_web_form;
    m_public_web_form_isSet = true;
}

bool OAITemplate::is_public_web_form_Set() const{
    return m_public_web_form_isSet;
}

bool OAITemplate::is_public_web_form_Valid() const{
    return m_public_web_form_isValid;
}

QString OAITemplate::getRedirectUrl() const {
    return m_redirect_url;
}
void OAITemplate::setRedirectUrl(const QString &redirect_url) {
    m_redirect_url = redirect_url;
    m_redirect_url_isSet = true;
}

bool OAITemplate::is_redirect_url_Set() const{
    return m_redirect_url_isSet;
}

bool OAITemplate::is_redirect_url_Valid() const{
    return m_redirect_url_isValid;
}

QString OAITemplate::getSlackWebhookUrl() const {
    return m_slack_webhook_url;
}
void OAITemplate::setSlackWebhookUrl(const QString &slack_webhook_url) {
    m_slack_webhook_url = slack_webhook_url;
    m_slack_webhook_url_isSet = true;
}

bool OAITemplate::is_slack_webhook_url_Set() const{
    return m_slack_webhook_url_isSet;
}

bool OAITemplate::is_slack_webhook_url_Valid() const{
    return m_slack_webhook_url_isValid;
}

QString OAITemplate::getTemplateType() const {
    return m_template_type;
}
void OAITemplate::setTemplateType(const QString &template_type) {
    m_template_type = template_type;
    m_template_type_isSet = true;
}

bool OAITemplate::is_template_type_Set() const{
    return m_template_type_isSet;
}

bool OAITemplate::is_template_type_Valid() const{
    return m_template_type_isValid;
}

QString OAITemplate::getWebhookUrl() const {
    return m_webhook_url;
}
void OAITemplate::setWebhookUrl(const QString &webhook_url) {
    m_webhook_url = webhook_url;
    m_webhook_url_isSet = true;
}

bool OAITemplate::is_webhook_url_Set() const{
    return m_webhook_url_isSet;
}

bool OAITemplate::is_webhook_url_Valid() const{
...
bool OAITemplate::isValid() const {
    ...
    return m_allow_additional_properties_isValid && m_description_isValid && m_document_url_isValid && m_editable_submissions_isValid && m_expiration_interval_isValid && m_expire_after_isValid && m_expire_submissions_isValid && m_id_isValid && m_locked_isValid && m_name_isValid && m_page_dimensions_isValid && m_parent_folder_id_isValid && m_path_isValid && m_permanent_document_url_isValid && m_public_submissions_isValid && m_public_web_form_isValid && m_redirect_url_isValid && m_slack_webhook_url_isValid && m_template_type_isValid && m_webhook_url_isValid && true;
}
