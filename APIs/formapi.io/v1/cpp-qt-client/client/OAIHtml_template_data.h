...
/*
 * OAIHtml_template_data.h
 *
 * 
 */

#ifndef OAIHtml_template_data_H
#define OAIHtml_template_data_H
...
class OAIHtml_template_data : public OAIObject {
public:
    OAIHtml_template_data();
    OAIHtml_template_data(QString json);
    ~OAIHtml_template_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHtml_template_data)

#endif // OAIHtml_template_data_H
