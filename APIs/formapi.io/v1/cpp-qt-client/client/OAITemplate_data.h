...
#ifndef OAITemplate_data_H
#define OAITemplate_data_H
...
class OAITemplate_data : public OAIObject {
public:
    OAITemplate_data();
    OAITemplate_data(QString json);
    ~OAITemplate_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplate_data)

#endif // OAITemplate_data_H
