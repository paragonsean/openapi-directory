...
OAIUpload_template_data::OAIUpload_template_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpload_template_data::OAIUpload_template_data() {
    this->initializeModel();
}

OAIUpload_template_data::~OAIUpload_template_data() {}

void OAIUpload_template_data::initializeModel() {
...
void OAIUpload_template_data::fromJson(QString jsonString) {
...
void OAIUpload_template_data::fromJsonObject(QJsonObject json) {
...
QString OAIUpload_template_data::asJson() const {
...
QJsonObject OAIUpload_template_data::asJsonObject() const {
    QJsonObject obj;
...
bool OAIUpload_template_data::isAllowAdditionalProperties() const {
    return m_allow_additional_properties;
}
void OAIUpload_template_data::setAllowAdditionalProperties(const bool &allow_additional_properties) {
    m_allow_additional_properties = allow_additional_properties;
    m_allow_additional_properties_isSet = true;
}

bool OAIUpload_template_data::is_allow_additional_properties_Set() const{
    return m_allow_additional_properties_isSet;
}

bool OAIUpload_template_data::is_allow_additional_properties_Valid() const{
    return m_allow_additional_properties_isValid;
}

QString OAIUpload_template_data::getDescription() const {
    return m_description;
}
void OAIUpload_template_data::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpload_template_data::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpload_template_data::is_description_Valid() const{
    return m_description_isValid;
}

OAIUpload_template_data_document OAIUpload_template_data::getDocument() const {
    return m_document;
}
void OAIUpload_template_data::setDocument(const OAIUpload_template_data_document &document) {
    m_document = document;
    m_document_isSet = true;
}

bool OAIUpload_template_data::is_document_Set() const{
    return m_document_isSet;
}

bool OAIUpload_template_data::is_document_Valid() const{
    return m_document_isValid;
}

bool OAIUpload_template_data::isEditableSubmissions() const {
    return m_editable_submissions;
}
void OAIUpload_template_data::setEditableSubmissions(const bool &editable_submissions) {
    m_editable_submissions = editable_submissions;
    m_editable_submissions_isSet = true;
}

bool OAIUpload_template_data::is_editable_submissions_Set() const{
    return m_editable_submissions_isSet;
}

bool OAIUpload_template_data::is_editable_submissions_Valid() const{
    return m_editable_submissions_isValid;
}

QString OAIUpload_template_data::getExpirationInterval() const {
    return m_expiration_interval;
}
void OAIUpload_template_data::setExpirationInterval(const QString &expiration_interval) {
    m_expiration_interval = expiration_interval;
    m_expiration_interval_isSet = true;
}

bool OAIUpload_template_data::is_expiration_interval_Set() const{
    return m_expiration_interval_isSet;
}

bool OAIUpload_template_data::is_expiration_interval_Valid() const{
    return m_expiration_interval_isValid;
}

double OAIUpload_template_data::getExpireAfter() const {
    return m_expire_after;
}
void OAIUpload_template_data::setExpireAfter(const double &expire_after) {
    m_expire_after = expire_after;
    m_expire_after_isSet = true;
}

bool OAIUpload_template_data::is_expire_after_Set() const{
    return m_expire_after_isSet;
}

bool OAIUpload_template_data::is_expire_after_Valid() const{
    return m_expire_after_isValid;
}

bool OAIUpload_template_data::isExpireSubmissions() const {
    return m_expire_submissions;
}
void OAIUpload_template_data::setExpireSubmissions(const bool &expire_submissions) {
    m_expire_submissions = expire_submissions;
    m_expire_submissions_isSet = true;
}

bool OAIUpload_template_data::is_expire_submissions_Set() const{
    return m_expire_submissions_isSet;
}

bool OAIUpload_template_data::is_expire_submissions_Valid() const{
    return m_expire_submissions_isValid;
}

QString OAIUpload_template_data::getFooterHtml() const {
    return m_footer_html;
}
void OAIUpload_template_data::setFooterHtml(const QString &footer_html) {
    m_footer_html = footer_html;
    m_footer_html_isSet = true;
}

bool OAIUpload_template_data::is_footer_html_Set() const{
    return m_footer_html_isSet;
}

bool OAIUpload_template_data::is_footer_html_Valid() const{
    return m_footer_html_isValid;
}

QString OAIUpload_template_data::getHeaderHtml() const {
    return m_header_html;
}
void OAIUpload_template_data::setHeaderHtml(const QString &header_html) {
    m_header_html = header_html;
    m_header_html_isSet = true;
}

bool OAIUpload_template_data::is_header_html_Set() const{
    return m_header_html_isSet;
}

bool OAIUpload_template_data::is_header_html_Valid() const{
    return m_header_html_isValid;
}

QString OAIUpload_template_data::getHtml() const {
    return m_html;
}
void OAIUpload_template_data::setHtml(const QString &html) {
    m_html = html;
    m_html_isSet = true;
}

bool OAIUpload_template_data::is_html_Set() const{
    return m_html_isSet;
}

bool OAIUpload_template_data::is_html_Valid() const{
    return m_html_isValid;
}

QString OAIUpload_template_data::getName() const {
    return m_name;
}
void OAIUpload_template_data::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpload_template_data::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpload_template_data::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIUpload_template_data::isPublicSubmissions() const {
    return m_public_submissions;
}
void OAIUpload_template_data::setPublicSubmissions(const bool &public_submissions) {
    m_public_submissions = public_submissions;
    m_public_submissions_isSet = true;
}

bool OAIUpload_template_data::is_public_submissions_Set() const{
    return m_public_submissions_isSet;
}

bool OAIUpload_template_data::is_public_submissions_Valid() const{
    return m_public_submissions_isValid;
}

bool OAIUpload_template_data::isPublicWebForm() const {
    return m_public_web_form;
}
void OAIUpload_template_data::setPublicWebForm(const bool &public_web_form) {
    m_public_web_form = public_web_form;
    m_public_web_form_isSet = true;
}

bool OAIUpload_template_data::is_public_web_form_Set() const{
    return m_public_web_form_isSet;
}

bool OAIUpload_template_data::is_public_web_form_Valid() const{
    return m_public_web_form_isValid;
}

QString OAIUpload_template_data::getRedirectUrl() const {
    return m_redirect_url;
}
void OAIUpload_template_data::setRedirectUrl(const QString &redirect_url) {
    m_redirect_url = redirect_url;
    m_redirect_url_isSet = true;
}

bool OAIUpload_template_data::is_redirect_url_Set() const{
    return m_redirect_url_isSet;
}

bool OAIUpload_template_data::is_redirect_url_Valid() const{
    return m_redirect_url_isValid;
}

QString OAIUpload_template_data::getScss() const {
    return m_scss;
}
void OAIUpload_template_data::setScss(const QString &scss) {
    m_scss = scss;
    m_scss_isSet = true;
}

bool OAIUpload_template_data::is_scss_Set() const{
    return m_scss_isSet;
}

bool OAIUpload_template_data::is_scss_Valid() const{
    return m_scss_isValid;
}

QString OAIUpload_template_data::getSlackWebhookUrl() const {
    return m_slack_webhook_url;
}
void OAIUpload_template_data::setSlackWebhookUrl(const QString &slack_webhook_url) {
    m_slack_webhook_url = slack_webhook_url;
    m_slack_webhook_url_isSet = true;
}

bool OAIUpload_template_data::is_slack_webhook_url_Set() const{
    return m_slack_webhook_url_isSet;
}

bool OAIUpload_template_data::is_slack_webhook_url_Valid() const{
    return m_slack_webhook_url_isValid;
}

QString OAIUpload_template_data::getTemplateType() const {
    return m_template_type;
}
void OAIUpload_template_data::setTemplateType(const QString &template_type) {
    m_template_type = template_type;
    m_template_type_isSet = true;
}

bool OAIUpload_template_data::is_template_type_Set() const{
    return m_template_type_isSet;
}

bool OAIUpload_template_data::is_template_type_Valid() const{
    return m_template_type_isValid;
}

QString OAIUpload_template_data::getWebhookUrl() const {
    return m_webhook_url;
}
void OAIUpload_template_data::setWebhookUrl(const QString &webhook_url) {
    m_webhook_url = webhook_url;
    m_webhook_url_isSet = true;
}

bool OAIUpload_template_data::is_webhook_url_Set() const{
    return m_webhook_url_isSet;
}

bool OAIUpload_template_data::is_webhook_url_Valid() const{
    return m_webhook_url_isValid;
}

bool OAIUpload_template_data::isSet() const {
...
bool OAIUpload_template_data::isValid() const {
