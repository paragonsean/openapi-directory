...
#ifndef OAISearch_request_H
#define OAISearch_request_H
...
class OAISearch_request : public OAIObject {
public:
    OAISearch_request();
    OAISearch_request(QString json);
    ~OAISearch_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearch_request)

#endif // OAISearch_request_H
