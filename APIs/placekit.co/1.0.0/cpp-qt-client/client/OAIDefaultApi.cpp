...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.placekit.co"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("reverse", defaultConf);
    _serverIndices.insert("reverse", 0);
...
void OAIDefaultApi::reverse(const ::OpenAPI::OptionalParam<OAIReverse_request> &payload) {
    QString fullPath = QString(_serverConfigs["reverse"][_serverIndices.value("reverse")].URL()+"/reverse");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::reverseCallback);
...
void OAIDefaultApi::reverseCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT reverseSignal(output);
        Q_EMIT reverseSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT reverseSignalE(output, error_type, error_str);
        Q_EMIT reverseSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT reverseSignalError(output, error_type, error_str);
        Q_EMIT reverseSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::search(const ::OpenAPI::OptionalParam<OAISearch_request> &payload) {
