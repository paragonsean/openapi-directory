...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlaceKitApiReference.SearchRequest();
  });
  ...
  describe('SearchRequest', function() {
    it('should create an instance of SearchRequest', function() {
      ...
      //var instance = new PlaceKitApiReference.SearchRequest();
      //expect(instance).to.be.a(PlaceKitApiReference.SearchRequest);
    });
