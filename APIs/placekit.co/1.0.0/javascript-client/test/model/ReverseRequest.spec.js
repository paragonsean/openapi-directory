...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlaceKitApiReference.ReverseRequest();
  });
  ...
  describe('ReverseRequest', function() {
    it('should create an instance of ReverseRequest', function() {
      // uncomment below and update the code to test ReverseRequest
      //var instance = new PlaceKitApiReference.ReverseRequest();
      //expect(instance).to.be.a(PlaceKitApiReference.ReverseRequest);
    });
