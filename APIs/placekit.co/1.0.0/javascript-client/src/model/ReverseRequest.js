...
/**
 * The ReverseRequest model module.
 * @module model/ReverseRequest
 * @version 1.0.0
 */
class ReverseRequest {
    /**
     * Constructs a new <code>ReverseRequest</code>.
     * @alias module:model/ReverseRequest
     * @implements module:model/Parameters
     */
    constructor() { 
        Parameters.initialize(this);
        ReverseRequest.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['countryByIP'] = true;
        obj['maxResults'] = 5;
    }

    /**
     * Constructs a <code>ReverseRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReverseRequest} obj Optional instance to populate.
     * @return {module:model/ReverseRequest} The populated <code>ReverseRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReverseRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ReverseRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReverseRequest</code>.
     */
 ...
 */
ReverseRequest.prototype['coordinates'] = undefined;
 ...
 */
ReverseRequest.prototype['countries'] = undefined;
 ...
 * @default true
 */
ReverseRequest.prototype['countryByIP'] = true;
 ...
 * @member {module:model/ReverseRequest.LanguageEnum} language
 */
ReverseRequest.prototype['language'] = undefined;
 ...
 * @default 5
 */
ReverseRequest.prototype['maxResults'] = 5;
 ...
 */
ReverseRequest.prototype['types'] = undefined;
