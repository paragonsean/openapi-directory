...
public class ApiClient {
    ...
    private String basePath = "https://api.placekit.co";
    ...
    public ApiClient() {
        ...
        authentications.put("api_key", new ApiKeyAuth("header", "x-placekit-api-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.placekit.co
