...
public class ReverseRequest {
  ...
  private Boolean countryByIP = true;
  ...
  public ReverseRequest coordinates(String coordinates) {
  ...
  public ReverseRequest countries(List<String> countries) {
    this.countries = countries;
    return this;
  }

  public ReverseRequest addCountriesItem(String countriesItem) {
  ...
  public ReverseRequest countryByIP(Boolean countryByIP) {
  ...
  public ReverseRequest language(LanguageEnum language) {
  ...
  public ReverseRequest maxResults(Integer maxResults) {
  ...
  public ReverseRequest types(List<Types> types) {
    this.types = types;
    return this;
  }

  public ReverseRequest addTypesItem(Types typesItem) {
    if (this.types == null) {
  ...
  public boolean equals(Object o) {
    ...
    ReverseRequest reverseRequest = (ReverseRequest) o;
    return Objects.equals(this.coordinates, reverseRequest.coordinates) &&
        Objects.equals(this.countries, reverseRequest.countries) &&
        Objects.equals(this.countryByIP, reverseRequest.countryByIP) &&
        Objects.equals(this.language, reverseRequest.language) &&
        Objects.equals(this.maxResults, reverseRequest.maxResults) &&
        Objects.equals(this.types, reverseRequest.types);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReverseRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReverseRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReverseRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReverseRequest is not found in the empty JSON string", ReverseRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReverseRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReverseRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReverseRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReverseRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReverseRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReverseRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ReverseRequest>() {
           @Override
           public void write(JsonWriter out, ReverseRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReverseRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReverseRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReverseRequest
   * @throws IOException if the JSON string is invalid with respect to ReverseRequest
   */
  public static ReverseRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReverseRequest.class);
  }

  /**
   * Convert an instance of ReverseRequest to an JSON string
   *
   * @return JSON string
   */
