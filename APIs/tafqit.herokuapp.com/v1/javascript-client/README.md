...
Tafqit - JavaScript client for tafqit
...
To use the link you just defined in your project, switch to the directory you want to use your tafqit from, and run:
...
```javascript
var Tafqit = require('tafqit');


var api = new Tafqit.DefaultApi()
var opts = {
...
------------ | ------------- | ------------- | -------------
*Tafqit.DefaultApi* | [**convert**](docs/DefaultApi.md#convert) | **POST** /convert | 
