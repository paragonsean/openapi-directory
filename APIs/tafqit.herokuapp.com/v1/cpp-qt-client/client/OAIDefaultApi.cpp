...
void OAIDefaultApi::convert(const ::OpenAPI::OptionalParam<QString> &hundreds_form, const ::OpenAPI::OptionalParam<QString> &the_number, const ::OpenAPI::OptionalParam<QString> &unit) {
    ...
    if (hundreds_form.hasValue())
    {
        input.add_var("hundreds_form", ::OpenAPI::toStringValue(hundreds_form.value()));
    }
    if (the_number.hasValue())
    {
        input.add_var("the_number", ::OpenAPI::toStringValue(the_number.value()));
    }
    if (unit.hasValue())
    {
        input.add_var("unit", ::OpenAPI::toStringValue(unit.value()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::convertCallback);
...
void OAIDefaultApi::convertCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT convertSignal();
        Q_EMIT convertSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT convertSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT convertSignalError(error_type, error_str);
