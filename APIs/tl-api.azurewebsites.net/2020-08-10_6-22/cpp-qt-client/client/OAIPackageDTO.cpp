...
OAIPackageDTO::OAIPackageDTO(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageDTO::OAIPackageDTO() {
    this->initializeModel();
}

OAIPackageDTO::~OAIPackageDTO() {}

void OAIPackageDTO::initializeModel() {
...
void OAIPackageDTO::fromJson(QString jsonString) {
...
void OAIPackageDTO::fromJsonObject(QJsonObject json) {
...
QString OAIPackageDTO::asJson() const {
...
QJsonObject OAIPackageDTO::asJsonObject() const {
    QJsonObject obj;
    if (m_add_ons.size() > 0) {
...
QList<OAIPackageItemDTO> OAIPackageDTO::getAddOns() const {
    return m_add_ons;
}
void OAIPackageDTO::setAddOns(const QList<OAIPackageItemDTO> &add_ons) {
    m_add_ons = add_ons;
    m_add_ons_isSet = true;
}

bool OAIPackageDTO::is_add_ons_Set() const{
    return m_add_ons_isSet;
}

bool OAIPackageDTO::is_add_ons_Valid() const{
    return m_add_ons_isValid;
}

double OAIPackageDTO::getAddonFee() const {
    return m_addon_fee;
}
void OAIPackageDTO::setAddonFee(const double &addon_fee) {
    m_addon_fee = addon_fee;
    m_addon_fee_isSet = true;
}

bool OAIPackageDTO::is_addon_fee_Set() const{
    return m_addon_fee_isSet;
}

bool OAIPackageDTO::is_addon_fee_Valid() const{
    return m_addon_fee_isValid;
}

bool OAIPackageDTO::isApplyForAllGyms() const {
    return m_apply_for_all_gyms;
}
void OAIPackageDTO::setApplyForAllGyms(const bool &apply_for_all_gyms) {
    m_apply_for_all_gyms = apply_for_all_gyms;
    m_apply_for_all_gyms_isSet = true;
}

bool OAIPackageDTO::is_apply_for_all_gyms_Set() const{
    return m_apply_for_all_gyms_isSet;
}

bool OAIPackageDTO::is_apply_for_all_gyms_Valid() const{
    return m_apply_for_all_gyms_isValid;
}

QList<OAIGymDTO> OAIPackageDTO::getAvailableGyms() const {
    return m_available_gyms;
}
void OAIPackageDTO::setAvailableGyms(const QList<OAIGymDTO> &available_gyms) {
    m_available_gyms = available_gyms;
    m_available_gyms_isSet = true;
}

bool OAIPackageDTO::is_available_gyms_Set() const{
    return m_available_gyms_isSet;
}

bool OAIPackageDTO::is_available_gyms_Valid() const{
    return m_available_gyms_isValid;
}

qint32 OAIPackageDTO::getBindingPeriod() const {
    return m_binding_period;
}
void OAIPackageDTO::setBindingPeriod(const qint32 &binding_period) {
    m_binding_period = binding_period;
    m_binding_period_isSet = true;
}

bool OAIPackageDTO::is_binding_period_Set() const{
    return m_binding_period_isSet;
}

bool OAIPackageDTO::is_binding_period_Valid() const{
    return m_binding_period_isValid;
}

QDateTime OAIPackageDTO::getCreatedDate() const {
    return m_created_date;
}
void OAIPackageDTO::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIPackageDTO::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIPackageDTO::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QString OAIPackageDTO::getCreatedUser() const {
    return m_created_user;
}
void OAIPackageDTO::setCreatedUser(const QString &created_user) {
    m_created_user = created_user;
    m_created_user_isSet = true;
}

bool OAIPackageDTO::is_created_user_Set() const{
    return m_created_user_isSet;
}

bool OAIPackageDTO::is_created_user_Valid() const{
    return m_created_user_isValid;
}

QString OAIPackageDTO::getDescription() const {
    return m_description;
}
void OAIPackageDTO::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPackageDTO::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPackageDTO::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIPackageDTO::getEndDate() const {
    return m_end_date;
}
void OAIPackageDTO::setEndDate(const QDateTime &end_date) {
    m_end_date = end_date;
    m_end_date_isSet = true;
}

bool OAIPackageDTO::is_end_date_Set() const{
    return m_end_date_isSet;
}

bool OAIPackageDTO::is_end_date_Valid() const{
    return m_end_date_isValid;
}

qint32 OAIPackageDTO::getExpireInMonths() const {
    return m_expire_in_months;
}
void OAIPackageDTO::setExpireInMonths(const qint32 &expire_in_months) {
    m_expire_in_months = expire_in_months;
    m_expire_in_months_isSet = true;
}

bool OAIPackageDTO::is_expire_in_months_Set() const{
    return m_expire_in_months_isSet;
}

bool OAIPackageDTO::is_expire_in_months_Valid() const{
    return m_expire_in_months_isValid;
}

QString OAIPackageDTO::getFeatures() const {
    return m_features;
}
void OAIPackageDTO::setFeatures(const QString &features) {
    m_features = features;
    m_features_isSet = true;
}

bool OAIPackageDTO::is_features_Set() const{
    return m_features_isSet;
}

bool OAIPackageDTO::is_features_Valid() const{
    return m_features_isValid;
}

qint32 OAIPackageDTO::getFreeMonths() const {
    return m_free_months;
}
void OAIPackageDTO::setFreeMonths(const qint32 &free_months) {
    m_free_months = free_months;
    m_free_months_isSet = true;
}

bool OAIPackageDTO::is_free_months_Set() const{
    return m_free_months_isSet;
}

bool OAIPackageDTO::is_free_months_Valid() const{
    return m_free_months_isValid;
}

QString OAIPackageDTO::getInstructionsToGymUsers() const {
    return m_instructions_to_gym_users;
}
void OAIPackageDTO::setInstructionsToGymUsers(const QString &instructions_to_gym_users) {
    m_instructions_to_gym_users = instructions_to_gym_users;
    m_instructions_to_gym_users_isSet = true;
}

bool OAIPackageDTO::is_instructions_to_gym_users_Set() const{
    return m_instructions_to_gym_users_isSet;
}

bool OAIPackageDTO::is_instructions_to_gym_users_Valid() const{
    return m_instructions_to_gym_users_isValid;
}

QString OAIPackageDTO::getInstructionsToWebUsers() const {
    return m_instructions_to_web_users;
}
void OAIPackageDTO::setInstructionsToWebUsers(const QString &instructions_to_web_users) {
    m_instructions_to_web_users = instructions_to_web_users;
    m_instructions_to_web_users_isSet = true;
}

bool OAIPackageDTO::is_instructions_to_web_users_Set() const{
    return m_instructions_to_web_users_isSet;
}

bool OAIPackageDTO::is_instructions_to_web_users_Valid() const{
    return m_instructions_to_web_users_isValid;
}

bool OAIPackageDTO::isIsActive() const {
    return m_is_active;
}
void OAIPackageDTO::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAIPackageDTO::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIPackageDTO::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAIPackageDTO::isIsAtg() const {
    return m_is_atg;
}
void OAIPackageDTO::setIsAtg(const bool &is_atg) {
    m_is_atg = is_atg;
    m_is_atg_isSet = true;
}

bool OAIPackageDTO::is_is_atg_Set() const{
    return m_is_atg_isSet;
}

bool OAIPackageDTO::is_is_atg_Valid() const{
    return m_is_atg_isValid;
}

bool OAIPackageDTO::isIsAutoRenew() const {
    return m_is_auto_renew;
}
void OAIPackageDTO::setIsAutoRenew(const bool &is_auto_renew) {
    m_is_auto_renew = is_auto_renew;
    m_is_auto_renew_isSet = true;
}

bool OAIPackageDTO::is_is_auto_renew_Set() const{
    return m_is_auto_renew_isSet;
}

bool OAIPackageDTO::is_is_auto_renew_Valid() const{
    return m_is_auto_renew_isValid;
}

bool OAIPackageDTO::isIsFirstMonthFree() const {
    return m_is_first_month_free;
}
void OAIPackageDTO::setIsFirstMonthFree(const bool &is_first_month_free) {
    m_is_first_month_free = is_first_month_free;
    m_is_first_month_free_isSet = true;
}

bool OAIPackageDTO::is_is_first_month_free_Set() const{
    return m_is_first_month_free_isSet;
}

bool OAIPackageDTO::is_is_first_month_free_Valid() const{
    return m_is_first_month_free_isValid;
}

bool OAIPackageDTO::isIsRegistrationFee() const {
    return m_is_registration_fee;
}
void OAIPackageDTO::setIsRegistrationFee(const bool &is_registration_fee) {
    m_is_registration_fee = is_registration_fee;
    m_is_registration_fee_isSet = true;
}

bool OAIPackageDTO::is_is_registration_fee_Set() const{
    return m_is_registration_fee_isSet;
}

bool OAIPackageDTO::is_is_registration_fee_Valid() const{
    return m_is_registration_fee_isValid;
}

bool OAIPackageDTO::isIsRestAmount() const {
    return m_is_rest_amount;
}
void OAIPackageDTO::setIsRestAmount(const bool &is_rest_amount) {
    m_is_rest_amount = is_rest_amount;
    m_is_rest_amount_isSet = true;
}

bool OAIPackageDTO::is_is_rest_amount_Set() const{
    return m_is_rest_amount_isSet;
}

bool OAIPackageDTO::is_is_rest_amount_Valid() const{
    return m_is_rest_amount_isValid;
}

bool OAIPackageDTO::isIsShownInMobile() const {
    return m_is_shown_in_mobile;
}
void OAIPackageDTO::setIsShownInMobile(const bool &is_shown_in_mobile) {
    m_is_shown_in_mobile = is_shown_in_mobile;
    m_is_shown_in_mobile_isSet = true;
}

bool OAIPackageDTO::is_is_shown_in_mobile_Set() const{
    return m_is_shown_in_mobile_isSet;
}

bool OAIPackageDTO::is_is_shown_in_mobile_Valid() const{
    return m_is_shown_in_mobile_isValid;
}

bool OAIPackageDTO::isIsSponsorPackage() const {
    return m_is_sponsor_package;
}
void OAIPackageDTO::setIsSponsorPackage(const bool &is_sponsor_package) {
    m_is_sponsor_package = is_sponsor_package;
    m_is_sponsor_package_isSet = true;
}

bool OAIPackageDTO::is_is_sponsor_package_Set() const{
    return m_is_sponsor_package_isSet;
}

bool OAIPackageDTO::is_is_sponsor_package_Valid() const{
    return m_is_sponsor_package_isValid;
}

double OAIPackageDTO::getMaximumGiveAwayRestAmount() const {
    return m_maximum_give_away_rest_amount;
}
void OAIPackageDTO::setMaximumGiveAwayRestAmount(const double &maximum_give_away_rest_amount) {
    m_maximum_give_away_rest_amount = maximum_give_away_rest_amount;
    m_maximum_give_away_rest_amount_isSet = true;
}

bool OAIPackageDTO::is_maximum_give_away_rest_amount_Set() const{
    return m_maximum_give_away_rest_amount_isSet;
}

bool OAIPackageDTO::is_maximum_give_away_rest_amount_Valid() const{
    return m_maximum_give_away_rest_amount_isValid;
}

bool OAIPackageDTO::isMemberCanAddAddOns() const {
    return m_member_can_add_add_ons;
}
void OAIPackageDTO::setMemberCanAddAddOns(const bool &member_can_add_add_ons) {
    m_member_can_add_add_ons = member_can_add_add_ons;
    m_member_can_add_add_ons_isSet = true;
}

bool OAIPackageDTO::is_member_can_add_add_ons_Set() const{
    return m_member_can_add_add_ons_isSet;
}

bool OAIPackageDTO::is_member_can_add_add_ons_Valid() const{
    return m_member_can_add_add_ons_isValid;
}

bool OAIPackageDTO::isMemberCanLeaveWithinFreePeriod() const {
    return m_member_can_leave_within_free_period;
}
void OAIPackageDTO::setMemberCanLeaveWithinFreePeriod(const bool &member_can_leave_within_free_period) {
...
bool OAIPackageDTO::is_member_can_leave_within_free_period_Set() const{
    return m_member_can_leave_within_free_period_isSet;
}

bool OAIPackageDTO::is_member_can_leave_within_free_period_Valid() const{
    return m_member_can_leave_within_free_period_isValid;
}

bool OAIPackageDTO::isMemberCanRemoveAddOns() const {
    return m_member_can_remove_add_ons;
}
void OAIPackageDTO::setMemberCanRemoveAddOns(const bool &member_can_remove_add_ons) {
    m_member_can_remove_add_ons = member_can_remove_add_ons;
    m_member_can_remove_add_ons_isSet = true;
}

bool OAIPackageDTO::is_member_can_remove_add_ons_Set() const{
    return m_member_can_remove_add_ons_isSet;
}

bool OAIPackageDTO::is_member_can_remove_add_ons_Valid() const{
    return m_member_can_remove_add_ons_isValid;
}

QDateTime OAIPackageDTO::getModifiedDate() const {
    return m_modified_date;
}
void OAIPackageDTO::setModifiedDate(const QDateTime &modified_date) {
    m_modified_date = modified_date;
    m_modified_date_isSet = true;
}

bool OAIPackageDTO::is_modified_date_Set() const{
    return m_modified_date_isSet;
}

bool OAIPackageDTO::is_modified_date_Valid() const{
    return m_modified_date_isValid;
}

QString OAIPackageDTO::getModifiedUser() const {
    return m_modified_user;
}
void OAIPackageDTO::setModifiedUser(const QString &modified_user) {
    m_modified_user = modified_user;
    m_modified_user_isSet = true;
}

bool OAIPackageDTO::is_modified_user_Set() const{
    return m_modified_user_isSet;
}

bool OAIPackageDTO::is_modified_user_Valid() const{
    return m_modified_user_isValid;
}

double OAIPackageDTO::getMonthlyFee() const {
    return m_monthly_fee;
}
void OAIPackageDTO::setMonthlyFee(const double &monthly_fee) {
    m_monthly_fee = monthly_fee;
    m_monthly_fee_isSet = true;
}

bool OAIPackageDTO::is_monthly_fee_Set() const{
    return m_monthly_fee_isSet;
}

bool OAIPackageDTO::is_monthly_fee_Valid() const{
    return m_monthly_fee_isValid;
}

qint32 OAIPackageDTO::getNextPackageNumber() const {
    return m_next_package_number;
}
void OAIPackageDTO::setNextPackageNumber(const qint32 &next_package_number) {
    m_next_package_number = next_package_number;
    m_next_package_number_isSet = true;
}

bool OAIPackageDTO::is_next_package_number_Set() const{
    return m_next_package_number_isSet;
}

bool OAIPackageDTO::is_next_package_number_Valid() const{
    return m_next_package_number_isValid;
}

qint32 OAIPackageDTO::getNumberOfInstallments() const {
    return m_number_of_installments;
}
void OAIPackageDTO::setNumberOfInstallments(const qint32 &number_of_installments) {
    m_number_of_installments = number_of_installments;
    m_number_of_installments_isSet = true;
}

bool OAIPackageDTO::is_number_of_installments_Set() const{
    return m_number_of_installments_isSet;
}

bool OAIPackageDTO::is_number_of_installments_Valid() const{
    return m_number_of_installments_isValid;
}

qint32 OAIPackageDTO::getNumberOfVisits() const {
    return m_number_of_visits;
}
void OAIPackageDTO::setNumberOfVisits(const qint32 &number_of_visits) {
    m_number_of_visits = number_of_visits;
    m_number_of_visits_isSet = true;
}

bool OAIPackageDTO::is_number_of_visits_Set() const{
    return m_number_of_visits_isSet;
}

bool OAIPackageDTO::is_number_of_visits_Valid() const{
    return m_number_of_visits_isValid;
}

qint32 OAIPackageDTO::getPackageId() const {
    return m_package_id;
}
void OAIPackageDTO::setPackageId(const qint32 &package_id) {
    m_package_id = package_id;
    m_package_id_isSet = true;
}

bool OAIPackageDTO::is_package_id_Set() const{
    return m_package_id_isSet;
}

bool OAIPackageDTO::is_package_id_Valid() const{
    return m_package_id_isValid;
}

QString OAIPackageDTO::getPackageName() const {
    return m_package_name;
}
void OAIPackageDTO::setPackageName(const QString &package_name) {
    m_package_name = package_name;
    m_package_name_isSet = true;
}

bool OAIPackageDTO::is_package_name_Set() const{
    return m_package_name_isSet;
}

bool OAIPackageDTO::is_package_name_Valid() const{
    return m_package_name_isValid;
}

QString OAIPackageDTO::getPackageNumber() const {
    return m_package_number;
}
void OAIPackageDTO::setPackageNumber(const QString &package_number) {
    m_package_number = package_number;
    m_package_number_isSet = true;
}

bool OAIPackageDTO::is_package_number_Set() const{
    return m_package_number_isSet;
}

bool OAIPackageDTO::is_package_number_Valid() const{
    return m_package_number_isValid;
}

QString OAIPackageDTO::getPackageType() const {
    return m_package_type;
}
void OAIPackageDTO::setPackageType(const QString &package_type) {
    m_package_type = package_type;
    m_package_type_isSet = true;
}

bool OAIPackageDTO::is_package_type_Set() const{
    return m_package_type_isSet;
}

bool OAIPackageDTO::is_package_type_Valid() const{
    return m_package_type_isValid;
}

double OAIPackageDTO::getPerVisitPrice() const {
    return m_per_visit_price;
}
void OAIPackageDTO::setPerVisitPrice(const double &per_visit_price) {
    m_per_visit_price = per_visit_price;
    m_per_visit_price_isSet = true;
}

bool OAIPackageDTO::is_per_visit_price_Set() const{
    return m_per_visit_price_isSet;
}

bool OAIPackageDTO::is_per_visit_price_Valid() const{
    return m_per_visit_price_isValid;
}

double OAIPackageDTO::getRegistrationFee() const {
    return m_registration_fee;
}
void OAIPackageDTO::setRegistrationFee(const double &registration_fee) {
    m_registration_fee = registration_fee;
    m_registration_fee_isSet = true;
}

bool OAIPackageDTO::is_registration_fee_Set() const{
    return m_registration_fee_isSet;
}

bool OAIPackageDTO::is_registration_fee_Valid() const{
    return m_registration_fee_isValid;
}

double OAIPackageDTO::getServiceFee() const {
    return m_service_fee;
}
void OAIPackageDTO::setServiceFee(const double &service_fee) {
    m_service_fee = service_fee;
    m_service_fee_isSet = true;
}

bool OAIPackageDTO::is_service_fee_Set() const{
    return m_service_fee_isSet;
}

bool OAIPackageDTO::is_service_fee_Valid() const{
    return m_service_fee_isValid;
}

bool OAIPackageDTO::isShownInWeb() const {
    return m_shown_in_web;
}
void OAIPackageDTO::setShownInWeb(const bool &shown_in_web) {
    m_shown_in_web = shown_in_web;
    m_shown_in_web_isSet = true;
}

bool OAIPackageDTO::is_shown_in_web_Set() const{
    return m_shown_in_web_isSet;
}

bool OAIPackageDTO::is_shown_in_web_Valid() const{
    return m_shown_in_web_isValid;
}

QDateTime OAIPackageDTO::getStartDate() const {
    return m_start_date;
}
void OAIPackageDTO::setStartDate(const QDateTime &start_date) {
    m_start_date = start_date;
    m_start_date_isSet = true;
}

bool OAIPackageDTO::is_start_date_Set() const{
    return m_start_date_isSet;
}

bool OAIPackageDTO::is_start_date_Valid() const{
    return m_start_date_isValid;
}

QString OAIPackageDTO::getTags() const {
    return m_tags;
}
void OAIPackageDTO::setTags(const QString &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIPackageDTO::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIPackageDTO::is_tags_Valid() const{
    return m_tags_isValid;
}

double OAIPackageDTO::getTotalPrice() const {
    return m_total_price;
}
void OAIPackageDTO::setTotalPrice(const double &total_price) {
    m_total_price = total_price;
    m_total_price_isSet = true;
}

bool OAIPackageDTO::is_total_price_Set() const{
    return m_total_price_isSet;
}

bool OAIPackageDTO::is_total_price_Valid() const{
    return m_total_price_isValid;
}

bool OAIPackageDTO::isSet() const {
...
bool OAIPackageDTO::isValid() const {
