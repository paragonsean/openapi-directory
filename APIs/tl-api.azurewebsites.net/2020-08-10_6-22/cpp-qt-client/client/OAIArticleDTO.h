...
#ifndef OAIArticleDTO_H
#define OAIArticleDTO_H
...
class OAIArticleDTO : public OAIObject {
public:
    OAIArticleDTO();
    OAIArticleDTO(QString json);
    ~OAIArticleDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArticleDTO)

#endif // OAIArticleDTO_H
