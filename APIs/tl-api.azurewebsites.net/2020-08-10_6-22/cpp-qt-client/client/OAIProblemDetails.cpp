...
QMap<QString, QJsonValue> OAIProblemDetails::getExtensions() const {
    return m_extensions;
}
void OAIProblemDetails::setExtensions(const QMap<QString, QJsonValue> &extensions) {
    m_extensions = extensions;
    m_extensions_isSet = true;
}

bool OAIProblemDetails::is_extensions_Set() const{
    return m_extensions_isSet;
}

bool OAIProblemDetails::is_extensions_Valid() const{
