...
#ifndef OAIPackageSearchDTO_H
#define OAIPackageSearchDTO_H
...
class OAIPackageSearchDTO : public OAIObject {
public:
    OAIPackageSearchDTO();
    OAIPackageSearchDTO(QString json);
    ~OAIPackageSearchDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageSearchDTO)

#endif // OAIPackageSearchDTO_H
