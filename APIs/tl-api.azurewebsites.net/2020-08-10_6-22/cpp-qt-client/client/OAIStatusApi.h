...
public:
    ...
    */
    virtual void statusGet(const ::OpenAPI::OptionalParam<QString> &message_id = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void statusGetSignal(OAIMessageStatus summary);


    void statusGetSignalFull(OAIHttpRequestWorker *worker, OAIMessageStatus summary);

    Q_DECL_DEPRECATED_X("Use statusGetSignalError() instead")
    void statusGetSignalE(OAIMessageStatus summary, QNetworkReply::NetworkError error_type, QString error_str);
    void statusGetSignalError(OAIMessageStatus summary, QNetworkReply::NetworkError error_type, const QString &error_str);
