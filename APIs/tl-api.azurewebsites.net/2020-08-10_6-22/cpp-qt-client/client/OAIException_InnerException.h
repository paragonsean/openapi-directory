...
/*
 * OAIException_InnerException.h
 *
 * 
 */

#ifndef OAIException_InnerException_H
#define OAIException_InnerException_H
...
class OAIException_InnerException : public OAIObject {
public:
    OAIException_InnerException();
    OAIException_InnerException(QString json);
    ~OAIException_InnerException() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIException_InnerException)

#endif // OAIException_InnerException_H
