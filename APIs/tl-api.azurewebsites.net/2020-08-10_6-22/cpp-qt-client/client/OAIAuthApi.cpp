...
void OAIAuthApi::initializeServerConfigs() {
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("authLogin", defaultConf);
    _serverIndices.insert("authLogin", 0);
}
...
void OAIAuthApi::authLogin(const OAILoginDTO &oai_login_dto) {
    QString fullPath = QString(_serverConfigs["authLogin"][_serverIndices.value("authLogin")].URL()+"/api/Auth/login");
...

    {
        ...
        QByteArray output = oai_login_dto.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthApi::authLoginCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthApi::authLoginCallback);
...
void OAIAuthApi::authLoginCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT authLoginSignal(output);
        Q_EMIT authLoginSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT authLoginSignalE(output, error_type, error_str);
        Q_EMIT authLoginSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT authLoginSignalError(output, error_type, error_str);
        Q_EMIT authLoginSignalErrorFull(worker, error_type, error_str);
    }
}
