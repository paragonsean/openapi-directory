...
#ifndef OAIStatusDTO_H
#define OAIStatusDTO_H
...
class OAIStatusDTO : public OAIObject {
public:
    OAIStatusDTO();
    OAIStatusDTO(QString json);
    ~OAIStatusDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatusDTO)

#endif // OAIStatusDTO_H
