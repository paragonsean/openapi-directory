...
(function(root, factory) {
  ...
  describe('UserApi', function() {
    ...
    describe('userRegisterUser', function() {
      it('should call userRegisterUser successfully', function(done) {
        //uncomment below and update the code to test userRegisterUser
        //instance.userRegisterUser(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('userUpdateUser', function() {
      it('should call userUpdateUser successfully', function(done) {
        //uncomment below and update the code to test userUpdateUser
        //instance.userUpdateUser(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
