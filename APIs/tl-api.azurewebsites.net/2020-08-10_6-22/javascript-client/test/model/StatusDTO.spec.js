...
(function(root, factory) {
  ...
  describe('StatusDTO', function() {
    it('should create an instance of StatusDTO', function() {
      // uncomment below and update the code to test StatusDTO
      //var instance = new Api.StatusDTO();
      //expect(instance).to.be.a(Api.StatusDTO);
    });
