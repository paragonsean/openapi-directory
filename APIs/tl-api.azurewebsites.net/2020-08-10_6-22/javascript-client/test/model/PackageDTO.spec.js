...
(function(root, factory) {
  ...
  describe('PackageDTO', function() {
    it('should create an instance of PackageDTO', function() {
      // uncomment below and update the code to test PackageDTO
      //var instance = new Api.PackageDTO();
      //expect(instance).to.be.a(Api.PackageDTO);
    });
