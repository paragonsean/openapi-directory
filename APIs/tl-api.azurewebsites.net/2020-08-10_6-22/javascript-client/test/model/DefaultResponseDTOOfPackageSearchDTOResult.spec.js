...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.DefaultResponseDTOOfPackageSearchDTOResult();
  });
  ...
  describe('DefaultResponseDTOOfPackageSearchDTOResult', function() {
    it('should create an instance of DefaultResponseDTOOfPackageSearchDTOResult', function() {
      // uncomment below and update the code to test DefaultResponseDTOOfPackageSearchDTOResult
      //var instance = new Api.DefaultResponseDTOOfPackageSearchDTOResult();
      //expect(instance).to.be.a(Api.DefaultResponseDTOOfPackageSearchDTOResult);
    });
