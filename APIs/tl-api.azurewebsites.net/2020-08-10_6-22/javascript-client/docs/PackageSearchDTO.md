...
**monthlyFee** | **Number** | Monthly installment fee if package is not fixed visit. addition of the servicefee and addon fees divided by binding period.              | [optional] 
**numberOfVisits** | **Number** | No of visits for fixed package  | [optional] 
...
**registrationFee** | **Number** | Registartion fee for the package at a gym.              | [optional] 
**serviceFee** | **Number** | total Service charge of the package for entire period.              | [optional] 
...
**totalCount** | **Number** | total number of recode for particular search  | [optional] 
