...
class ProblemDetails(Model):
    ...
    def __init__(self, detail: str=None, extensions: Dict[str, object]=None, instance: str=None, status: int=None, title: str=None, type: str=None):
        """ProblemDetails - a model defined in OpenAPI

        :param detail: The detail of this ProblemDetails.
        :param extensions: The extensions of this ProblemDetails.
    ...
    @property
    def extensions(self):
        """Gets the extensions of this ProblemDetails.


        :return: The extensions of this ProblemDetails.
