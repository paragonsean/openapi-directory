...
public class ApiClient {
    ...
    private String basePath = "https://tl-api.azurewebsites.net";
    ...
    public ApiClient() {
        ...
        authentications.put("apikey", new ApiKeyAuth("header", "Ocp-Apim-Subscription-Key"));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://tldev.eu.auth0.com/oauth/token";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2020-08-10_6-22/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://tl-api.azurewebsites.net
