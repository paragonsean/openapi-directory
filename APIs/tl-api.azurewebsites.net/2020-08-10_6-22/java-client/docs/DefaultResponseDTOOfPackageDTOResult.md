...
|------------ | ------------- | ------------- | -------------|
|**addOns** | [**List&lt;PackageItemDTO&gt;**](PackageItemDTO.md) | Extra articles list added to the given package.              |  [optional] |
...
|**availableGyms** | [**List&lt;GymDTO&gt;**](GymDTO.md) | Gyms list where this package is available.              |  [optional] |
...
|**endDate** | **OffsetDateTime** | End date of the package.After that package is not valid for use.              |  [optional] |
|**expireInMonths** | **Integer** | No of months the fixed package is valid for sale              |  [optional] |
...
|**maximumGiveAwayRestAmount** | **BigDecimal** | If a member join the gym middle of a month via this package,               what is the maximum amount of price can be neglected from payment from the member.              |  [optional] |
...
|**monthlyFee** | **BigDecimal** | Monthly installment fee if package is not fixed visit. addition of the servicefee and addon fees divided by binding period.              read only              |  [optional] |
|**nextPackageNumber** | **Integer** | Next Package the contract continue after the binding period of this package.              |  [optional] |
|**numberOfInstallments** | **Integer** | Maximum Number of installment a member can divide the package price/cost to pay.              |  [optional] |
|**numberOfVisits** | **Integer** | If package is fixed visit type, then how many visits are available for this package.              |  [optional] |
...
|**perVisitPrice** | **BigDecimal** | Cost/Price of the single visit to gym.              |  [optional] |
|**registrationFee** | **BigDecimal** | Registartion fee for the package at a gym.              read only              |  |
|**serviceFee** | **BigDecimal** | total Service charge of the package for entire period.              |  |
|**shownInWeb** | **Boolean** | Boolean value to show this package in MRM system or not.              |  [optional] |
|**startDate** | **OffsetDateTime** | Start date of the package.              |  [optional] |
