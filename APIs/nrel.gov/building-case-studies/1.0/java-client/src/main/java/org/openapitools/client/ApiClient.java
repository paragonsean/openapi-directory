...
public class ApiClient {
    ...
    private String basePath = "http://localhost/api/building-case-studies";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "/api/building-case-studies",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost/api/building-case-studies
