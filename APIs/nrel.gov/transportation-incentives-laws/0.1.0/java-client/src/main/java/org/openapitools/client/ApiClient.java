...
public class ApiClient {
    ...
    private String basePath = "http://localhost/api/transportation-incentives-laws";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost/api/transportation-incentives-laws
