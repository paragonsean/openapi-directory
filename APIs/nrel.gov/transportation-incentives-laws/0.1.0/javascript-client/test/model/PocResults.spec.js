...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransportationLawsAndIncentives.PocResults();
  });
  ...
  describe('PocResults', function() {
    it('should create an instance of PocResults', function() {
      // uncomment below and update the code to test PocResults
      //var instance = new TransportationLawsAndIncentives.PocResults();
      //expect(instance).to.be.a(TransportationLawsAndIncentives.PocResults);
    });
