...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransportationLawsAndIncentives.FullCategory();
  });
  ...
  describe('FullCategory', function() {
    it('should create an instance of FullCategory', function() {
      // uncomment below and update the code to test FullCategory
      //var instance = new TransportationLawsAndIncentives.FullCategory();
      //expect(instance).to.be.a(TransportationLawsAndIncentives.FullCategory);
    });
