...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransportationLawsAndIncentives.LawResult();
  });
  ...
  describe('LawResult', function() {
    it('should create an instance of LawResult', function() {
      // uncomment below and update the code to test LawResult
      //var instance = new TransportationLawsAndIncentives.LawResult();
      //expect(instance).to.be.a(TransportationLawsAndIncentives.LawResult);
    });
