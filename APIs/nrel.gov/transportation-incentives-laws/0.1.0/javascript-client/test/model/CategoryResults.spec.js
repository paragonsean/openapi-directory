...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransportationLawsAndIncentives.CategoryResults();
  });
  ...
  describe('CategoryResults', function() {
    it('should create an instance of CategoryResults', function() {
      // uncomment below and update the code to test CategoryResults
      //var instance = new TransportationLawsAndIncentives.CategoryResults();
      //expect(instance).to.be.a(TransportationLawsAndIncentives.CategoryResults);
    });
