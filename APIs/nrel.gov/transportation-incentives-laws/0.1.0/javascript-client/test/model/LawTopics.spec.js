...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransportationLawsAndIncentives.LawTopics();
  });
  ...
  describe('LawTopics', function() {
    it('should create an instance of LawTopics', function() {
      // uncomment below and update the code to test LawTopics
      //var instance = new TransportationLawsAndIncentives.LawTopics();
      //expect(instance).to.be.a(TransportationLawsAndIncentives.LawTopics);
    });
