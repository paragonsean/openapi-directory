...
#ifndef OAILawResult_H
#define OAILawResult_H
...
class OAILawResult : public OAIObject {
public:
    OAILawResult();
    OAILawResult(QString json);
    ~OAILawResult() override;
    ...
    OAILaw getResult() const;
    void setResult(const OAILaw &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAILawResult)

#endif // OAILawResult_H
