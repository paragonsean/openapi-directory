...
public class ApiClient {
    ...
    private String basePath = "https://api.digital.tfl.gov.uk";
    ...
    public ApiClient() {
        ...
        authentications.put("apiKey", new ApiKeyAuth("query", "app_key"));
        authentications.put("appId", new ApiKeyAuth("query", "app_id"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.digital.tfl.gov.uk
