...
|**statusAggregationEndDate** | **OffsetDateTime** | The end of the period over which status has been aggregated, or null if this is the current corridor status. |  [optional] |
|**statusAggregationStartDate** | **OffsetDateTime** | The start of the period over which status has been aggregated, or null if this is the current corridor status. |  [optional] |
