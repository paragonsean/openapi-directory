...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.digital.tfl.gov.uk') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.digital.tfl.gov.uk
         */
        ...
        this.authentications = {
            'apiKey': {type: 'apiKey', 'in': 'query', name: 'app_key'},
            'appId': {type: 'apiKey', 'in': 'query', name: 'app_id'}
        }
