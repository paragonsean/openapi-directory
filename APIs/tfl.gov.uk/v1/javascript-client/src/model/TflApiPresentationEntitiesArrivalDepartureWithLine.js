...
/**
 * The TflApiPresentationEntitiesArrivalDepartureWithLine model module.
 * @module model/TflApiPresentationEntitiesArrivalDepartureWithLine
 * @version v1
 */
class TflApiPresentationEntitiesArrivalDepartureWithLine {
    /**
     * Constructs a new <code>TflApiPresentationEntitiesArrivalDepartureWithLine</code>.
     * DTO to capture the prediction details
     * @alias module:model/TflApiPresentationEntitiesArrivalDepartureWithLine
     */
    constructor() { 
        
        TflApiPresentationEntitiesArrivalDepartureWithLine.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TflApiPresentationEntitiesArrivalDepartureWithLine</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TflApiPresentationEntitiesArrivalDepartureWithLine} obj Optional instance to populate.
     * @return {module:model/TflApiPresentationEntitiesArrivalDepartureWithLine} The populated <code>TflApiPresentationEntitiesArrivalDepartureWithLine</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TflApiPresentationEntitiesArrivalDepartureWithLine();
    ...
    /**
     * Validates the JSON data with respect to <code>TflApiPresentationEntitiesArrivalDepartureWithLine</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TflApiPresentationEntitiesArrivalDepartureWithLine</code>.
     */
 ...
 * @member {String} cause
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['cause'] = undefined;

/**
 * Status of departure
 * @member {module:model/TflApiPresentationEntitiesArrivalDepartureWithLine.DepartureStatusEnum} departureStatus
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['departureStatus'] = undefined;

/**
 * Name of the destination
 * @member {String} destinationName
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['destinationName'] = undefined;

/**
 * Naptan Identifier for the prediction's destination
 * @member {String} destinationNaptanId
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['destinationNaptanId'] = undefined;

/**
 * Estimated time of arrival
 * @member {Date} estimatedTimeOfArrival
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['estimatedTimeOfArrival'] = undefined;

/**
 * Estimated time of arrival
 * @member {Date} estimatedTimeOfDeparture
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['estimatedTimeOfDeparture'] = undefined;

/**
 * Train operating company name
 * @member {String} lineId
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['lineId'] = undefined;

/**
 * Train operating company code
 * @member {String} lineName
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['lineName'] = undefined;

/**
 * Estimated time of arrival
 * @member {String} minutesAndSecondsToArrival
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['minutesAndSecondsToArrival'] = undefined;

/**
 * Estimated time of arrival
 * @member {String} minutesAndSecondsToDeparture
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['minutesAndSecondsToDeparture'] = undefined;

/**
 * Identifier for the prediction
 * @member {String} naptanId
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['naptanId'] = undefined;

/**
 * Platform name (for bus, this is the stop letter)
 * @member {String} platformName
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['platformName'] = undefined;

/**
 * Estimated time of arrival
 * @member {Date} scheduledTimeOfArrival
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['scheduledTimeOfArrival'] = undefined;

/**
 * Estimated time of arrival
 * @member {Date} scheduledTimeOfDeparture
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['scheduledTimeOfDeparture'] = undefined;

/**
 * Station name
 * @member {String} stationName
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['stationName'] = undefined;

/**
 * @member {module:model/TflApiPresentationEntitiesPredictionTiming} timing
 */
TflApiPresentationEntitiesArrivalDepartureWithLine.prototype['timing'] = undefined;
...
export default TflApiPresentationEntitiesArrivalDepartureWithLine;
