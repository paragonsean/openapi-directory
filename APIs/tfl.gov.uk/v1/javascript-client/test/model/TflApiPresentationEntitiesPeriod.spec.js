...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransportForLondonUnifiedApi.TflApiPresentationEntitiesPeriod();
  });
  ...
  describe('TflApiPresentationEntitiesPeriod', function() {
    it('should create an instance of TflApiPresentationEntitiesPeriod', function() {
      // uncomment below and update the code to test TflApiPresentationEntitiesPeriod
      //var instance = new TransportForLondonUnifiedApi.TflApiPresentationEntitiesPeriod();
      //expect(instance).to.be.a(TransportForLondonUnifiedApi.TflApiPresentationEntitiesPeriod);
    });
