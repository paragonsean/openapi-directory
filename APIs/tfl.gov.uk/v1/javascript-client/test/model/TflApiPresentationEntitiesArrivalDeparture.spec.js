...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransportForLondonUnifiedApi.TflApiPresentationEntitiesArrivalDeparture();
  });
  ...
  describe('TflApiPresentationEntitiesArrivalDeparture', function() {
    it('should create an instance of TflApiPresentationEntitiesArrivalDeparture', function() {
      // uncomment below and update the code to test TflApiPresentationEntitiesArrivalDeparture
      //var instance = new TransportForLondonUnifiedApi.TflApiPresentationEntitiesArrivalDeparture();
      //expect(instance).to.be.a(TransportForLondonUnifiedApi.TflApiPresentationEntitiesArrivalDeparture);
    });
