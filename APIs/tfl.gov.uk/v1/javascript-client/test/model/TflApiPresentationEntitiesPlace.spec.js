...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransportForLondonUnifiedApi.TflApiPresentationEntitiesPlace();
  });
  ...
  describe('TflApiPresentationEntitiesPlace', function() {
    it('should create an instance of TflApiPresentationEntitiesPlace', function() {
      // uncomment below and update the code to test TflApiPresentationEntitiesPlace
      //var instance = new TransportForLondonUnifiedApi.TflApiPresentationEntitiesPlace();
      //expect(instance).to.be.a(TransportForLondonUnifiedApi.TflApiPresentationEntitiesPlace);
    });
