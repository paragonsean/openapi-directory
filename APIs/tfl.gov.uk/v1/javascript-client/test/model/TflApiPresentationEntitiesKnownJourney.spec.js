...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransportForLondonUnifiedApi.TflApiPresentationEntitiesKnownJourney();
  });
  ...
  describe('TflApiPresentationEntitiesKnownJourney', function() {
    it('should create an instance of TflApiPresentationEntitiesKnownJourney', function() {
      // uncomment below and update the code to test TflApiPresentationEntitiesKnownJourney
      //var instance = new TransportForLondonUnifiedApi.TflApiPresentationEntitiesKnownJourney();
      //expect(instance).to.be.a(TransportForLondonUnifiedApi.TflApiPresentationEntitiesKnownJourney);
    });
