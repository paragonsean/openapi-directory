# TransportForLondonUnifiedApi.TflApiPresentationEntitiesStreet
...
**segments** | [**[TflApiPresentationEntitiesStreetSegment]**](TflApiPresentationEntitiesStreetSegment.md) | Geographic description of the sections of this street that are affected. | [optional] 
**sourceSystemId** | **Number** | The ID from the source system of the disruption that this street belongs to. | [optional] 
