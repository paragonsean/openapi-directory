# TransportForLondonUnifiedApi.TflApiPresentationEntitiesRoadCorridor
...
**statusAggregationEndDate** | **Date** | The end of the period over which status has been aggregated, or null if this is the current corridor status. | [optional] 
**statusAggregationStartDate** | **Date** | The start of the period over which status has been aggregated, or null if this is the current corridor status. | [optional] 
