...
(function(root, factory) {
  ...
  describe('WordSearchResults', function() {
    it('should create an instance of WordSearchResults', function() {
      // uncomment below and update the code to test WordSearchResults
      //var instance = new Wordnik.WordSearchResults();
      //expect(instance).to.be.a(Wordnik.WordSearchResults);
    });
