...
(function(root, factory) {
  ...
  describe('ExampleSearchResults', function() {
    it('should create an instance of ExampleSearchResults', function() {
      // uncomment below and update the code to test ExampleSearchResults
      //var instance = new Wordnik.ExampleSearchResults();
      //expect(instance).to.be.a(Wordnik.ExampleSearchResults);
    });
