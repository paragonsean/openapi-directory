...
(function(root, factory) {
  ...
  describe('Syllable', function() {
    it('should create an instance of Syllable', function() {
      // uncomment below and update the code to test Syllable
      //var instance = new Wordnik.Syllable();
      //expect(instance).to.be.a(Wordnik.Syllable);
    });
