...
async def test_search_project_dataformat(client):
    """Test case for search_project_dataformat
    ...
    params = [('text', 'text_example'),
                    ...
                    ('max', 56),
                    ('skip', 56),
                    ('search.project_dataformat.data_type', 'search_project_dataformat_data_type_example'),
                    ('search.project_dataformat.field', 'search_project_dataformat_field_example')]
    headers = { 
    }
    response = await client.request(
        method='GET',
        path='/repository/search/type/project_dataformat',
        headers=headers,
        params=params,
        )
