...
async def test_search_project_service(client):
    """Test case for search_project_service
    ...
    params = [('text', 'text_example'),
                    ...
                    ('max', 56),
                    ('skip', 56),
                    ('search.project_service.service_type', 'search_project_service_service_type_example'),
                    ('search.project_service.provider', 'search_project_service_provider_example')]
    headers = { 
    }
    response = await client.request(
        method='GET',
        path='/repository/search/type/project_service',
        headers=headers,
        params=params,
        )
