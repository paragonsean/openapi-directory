...
async def test_search_type_point_ocean_csv_sado_meteo(client):
    """Test case for search_type_point_ocean_csv_sado_meteo
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_point_ocean_csv_sado_meteo',
        headers=headers,
        params=params,
        )
