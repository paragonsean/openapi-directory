...
async def test_search_vote_yesno(client):
    """Test case for search_vote_yesno
    ...
    params = [('text', 'text_example'),
                    ...
                    ('max', 56),
                    ('skip', 56),
                    ('search.db_vote_yesno.vote', 'search_db_vote_yesno_vote_example')]
    headers = { 
    }
    response = await client.request(
        method='GET',
        path='/repository/search/type/vote_yesno',
        headers=headers,
        params=params,
        )
