...
async def test_search_project_term(client):
    """Test case for search_project_term
    ...
    params = [('text', 'text_example'),
                    ...
                    ('max', 56),
                    ('skip', 56),
                    ('search.project_term.value', 'search_project_term_value_example')]
    headers = { 
    }
    response = await client.request(
        method='GET',
        path='/repository/search/type/project_term',
        headers=headers,
        params=params,
        )
