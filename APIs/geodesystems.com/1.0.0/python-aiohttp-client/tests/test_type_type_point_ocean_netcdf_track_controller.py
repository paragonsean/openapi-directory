...
async def test_search_type_point_ocean_netcdf_track(client):
    """Test case for search_type_point_ocean_netcdf_track
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_point_ocean_netcdf_track',
        headers=headers,
        params=params,
        )
