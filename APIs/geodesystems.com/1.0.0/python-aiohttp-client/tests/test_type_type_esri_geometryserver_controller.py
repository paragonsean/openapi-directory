...
async def test_search_type_esri_geometryserver(client):
    """Test case for search_type_esri_geometryserver
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_esri_geometryserver',
        headers=headers,
        params=params,
        )
