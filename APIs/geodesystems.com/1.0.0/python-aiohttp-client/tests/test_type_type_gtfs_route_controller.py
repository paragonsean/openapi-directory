...
async def test_search_type_gtfs_route(client):
    """Test case for search_type_gtfs_route
    ...
    params = [('text', 'text_example'),
                    ...
                    ('max', 56),
                    ('skip', 56),
                    ('search.type_gtfs_route.route_id', 'search_type_gtfs_route_route_id_example'),
                    ('search.type_gtfs_route.stop_names', 'search_type_gtfs_route_stop_names_example')]
    headers = { 
    }
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_gtfs_route',
        headers=headers,
        params=params,
        )
