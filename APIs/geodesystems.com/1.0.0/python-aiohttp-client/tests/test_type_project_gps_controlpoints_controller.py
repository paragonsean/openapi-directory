...
async def test_search_project_gps_controlpoints(client):
    """Test case for search_project_gps_controlpoints
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/project_gps_controlpoints',
        headers=headers,
        params=params,
        )
