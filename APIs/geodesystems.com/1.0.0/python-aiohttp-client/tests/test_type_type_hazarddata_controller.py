...
async def test_search_type_hazarddata(client):
    """Test case for search_type_hazarddata
    ...
    params = [('text', 'text_example'),
                    ...
                    ('max', 56),
                    ('skip', 56),
                    ('search.type_hazarddata.source', 'search_type_hazarddata_source_example')]
    headers = { 
    }
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_hazarddata',
        headers=headers,
        params=params,
        )
