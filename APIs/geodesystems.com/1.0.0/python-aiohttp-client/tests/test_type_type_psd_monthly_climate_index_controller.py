...
async def test_search_type_psd_monthly_climate_index(client):
    """Test case for search_type_psd_monthly_climate_index
    ...
    params = [('text', 'text_example'),
                    ...
                    ('max', 56),
                    ('skip', 56),
                    ('search.type_psd_monthly_climate_index.units', 'search_type_psd_monthly_climate_index_units_example')]
    headers = { 
    }
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_psd_monthly_climate_index',
        headers=headers,
        params=params,
        )
