...
async def test_search_type_point_ocean_csv_sado_position(client):
    """Test case for search_type_point_ocean_csv_sado_position
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_point_ocean_csv_sado_position',
        headers=headers,
        params=params,
        )
