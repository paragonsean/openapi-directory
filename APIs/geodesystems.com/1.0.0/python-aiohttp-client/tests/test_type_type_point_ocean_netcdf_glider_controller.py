...
async def test_search_type_point_ocean_netcdf_glider(client):
    """Test case for search_type_point_ocean_netcdf_glider
    ...
    params = [('text', 'text_example'),
                    ...
                    ('max', 56),
                    ('skip', 56),
                    ('search.type_point_ocean_netcdf_track.platform', 'search_type_point_ocean_netcdf_track_platform_example')]
    headers = { 
    }
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_point_ocean_netcdf_glider',
        headers=headers,
        params=params,
        )
