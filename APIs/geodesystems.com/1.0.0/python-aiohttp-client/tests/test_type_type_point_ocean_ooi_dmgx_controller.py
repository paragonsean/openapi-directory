...
async def test_search_type_point_ocean_ooi_dmgx(client):
    """Test case for search_type_point_ocean_ooi_dmgx
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_point_ocean_ooi_dmgx',
        headers=headers,
        params=params,
        )
