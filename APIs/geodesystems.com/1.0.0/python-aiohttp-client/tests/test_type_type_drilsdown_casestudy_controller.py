...
async def test_search_type_drilsdown_casestudy(client):
    """Test case for search_type_drilsdown_casestudy
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_drilsdown_casestudy',
        headers=headers,
        params=params,
        )
