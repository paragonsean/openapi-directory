...
async def test_search_type_point_icebridge_paris(client):
    """Test case for search_type_point_icebridge_paris
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_point_icebridge_paris',
        headers=headers,
        params=params,
        )
