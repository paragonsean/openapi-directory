...
async def test_search_type_point_ocean_csv_sado_tts(client):
    """Test case for search_type_point_ocean_csv_sado_tts
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_point_ocean_csv_sado_TTS',
        headers=headers,
        params=params,
        )
