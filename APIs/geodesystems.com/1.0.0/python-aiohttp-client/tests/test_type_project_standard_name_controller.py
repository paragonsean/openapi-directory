...
async def test_search_project_standard_name(client):
    """Test case for search_project_standard_name
    ...
    params = [('text', 'text_example'),
                    ...
                    ('max', 56),
                    ('skip', 56),
                    ('search.project_standard_name.unit', 'search_project_standard_name_unit_example'),
                    ('search.project_standard_name.aliases', 'search_project_standard_name_aliases_example')]
    headers = { 
    }
    response = await client.request(
        method='GET',
        path='/repository/search/type/project_standard_name',
        headers=headers,
        params=params,
        )
