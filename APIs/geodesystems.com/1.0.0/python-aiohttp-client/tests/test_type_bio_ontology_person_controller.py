...
async def test_search_bio_ontology_person(client):
    """Test case for search_bio_ontology_person
    ...
    params = [('text', 'text_example'),
                    ...
                    ('max', 56),
                    ('skip', 56),
                    ('search.bio_ontology_person.gender', 'search_bio_ontology_person_gender_example')]
    headers = { 
    }
    response = await client.request(
        method='GET',
        path='/repository/search/type/bio_ontology_person',
        headers=headers,
        params=params,
        )
