...
async def test_search_type_point_icebridge_mccords_irmcr3(client):
    """Test case for search_type_point_icebridge_mccords_irmcr3
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_point_icebridge_mccords_irmcr3',
        headers=headers,
        params=params,
        )
