...
async def test_search_type_point_icebridge_atm_qfit(client):
    """Test case for search_type_point_icebridge_atm_qfit
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_point_icebridge_atm_qfit',
        headers=headers,
        params=params,
        )
