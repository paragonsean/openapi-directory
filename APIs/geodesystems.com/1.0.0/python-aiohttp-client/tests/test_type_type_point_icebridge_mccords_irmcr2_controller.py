...
async def test_search_type_point_icebridge_mccords_irmcr2(client):
    """Test case for search_type_point_icebridge_mccords_irmcr2
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_point_icebridge_mccords_irmcr2',
        headers=headers,
        params=params,
        )
