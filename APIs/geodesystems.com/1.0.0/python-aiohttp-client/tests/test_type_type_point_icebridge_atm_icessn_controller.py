...
async def test_search_type_point_icebridge_atm_icessn(client):
    """Test case for search_type_point_icebridge_atm_icessn
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_point_icebridge_atm_icessn',
        headers=headers,
        params=params,
        )
