...
async def test_search_type_point_simple_records(client):
    """Test case for search_type_point_simple_records
    ...
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_point_simple_records',
        headers=headers,
        params=params,
        )
