...
async def test_search_type_esri_layer(client):
    """Test case for search_type_esri_layer
    ...
    params = [('text', 'text_example'),
                    ...
                    ('max', 56),
                    ('skip', 56),
                    ('search.type_esri_layer.layer_type', 'search_type_esri_layer_layer_type_example')]
    headers = { 
    }
    response = await client.request(
        method='GET',
        path='/repository/search/type/type_esri_layer',
        headers=headers,
        params=params,
        )
