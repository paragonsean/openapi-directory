...
async def test_search_blogentry(client):
    """Test case for search_blogentry
    ...
    params = [('text', 'text_example'),
                    ...
                    ('max', 56),
                    ('skip', 56),
                    ('search.blogentry.blogtext', 'search_blogentry_blogtext_example')]
    headers = { 
    }
    response = await client.request(
        method='GET',
        path='/repository/search/type/blogentry',
        headers=headers,
        params=params,
        )
