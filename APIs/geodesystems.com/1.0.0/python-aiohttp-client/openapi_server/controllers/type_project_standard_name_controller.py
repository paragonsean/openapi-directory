...
async def search_project_standard_name(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_project_standard_name_unit=None, search_project_standard_name_aliases=None) -> web.Response:
    ...
    :type skip: int
    :param search_project_standard_name_unit: Canonical Unit
    :type search_project_standard_name_unit: str
    :param search_project_standard_name_aliases: Aliases
    :type search_project_standard_name_aliases: str
