...
async def search_locations(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_db_locations_name=None, search_db_locations_type=None, search_db_locations_location=None) -> web.Response:
    ...
    :type skip: int
    :param search_db_locations_name: Name
    :type search_db_locations_name: str
    :param search_db_locations_type: Type
    :type search_db_locations_type: str
    :param search_db_locations_location: Location
    :type search_db_locations_location: str
