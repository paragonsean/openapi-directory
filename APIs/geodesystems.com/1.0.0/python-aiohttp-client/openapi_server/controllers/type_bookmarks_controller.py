...
async def search_bookmarks(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_db_bookmarks_title=None, search_db_bookmarks_url=None, search_db_bookmarks_category=None, search_db_bookmarks_date=None) -> web.Response:
    ...
    :type skip: int
    :param search_db_bookmarks_title: Title
    :type search_db_bookmarks_title: str
    :param search_db_bookmarks_url: URL
    :type search_db_bookmarks_url: str
    :param search_db_bookmarks_category: Category
    :type search_db_bookmarks_category: str
    :param search_db_bookmarks_date: Date
    :type search_db_bookmarks_date: str
