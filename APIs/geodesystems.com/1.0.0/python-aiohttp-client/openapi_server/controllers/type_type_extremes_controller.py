...
async def search_type_extremes(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_type_extremes_region=None, search_type_extremes_variable=None) -> web.Response:
    ...
    :type skip: int
    :param search_type_extremes_region: US Climate Region
    :type search_type_extremes_region: str
    :param search_type_extremes_variable: Variable
    :type search_type_extremes_variable: str
