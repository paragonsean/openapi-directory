...
async def search_jeopardy(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_db_jeopardy_question=None, search_db_jeopardy_answer=None, search_db_jeopardy_round=None, search_db_jeopardy_category=None, search_db_jeopardy_air_date=None) -> web.Response:
    ...
    :type skip: int
    :param search_db_jeopardy_question: Question
    :type search_db_jeopardy_question: str
    :param search_db_jeopardy_answer: Answer
    :type search_db_jeopardy_answer: str
    :param search_db_jeopardy_round: Round
    :type search_db_jeopardy_round: str
    :param search_db_jeopardy_category: Category
    :type search_db_jeopardy_category: str
    :param search_db_jeopardy_air_date: Air Date
    :type search_db_jeopardy_air_date: str
