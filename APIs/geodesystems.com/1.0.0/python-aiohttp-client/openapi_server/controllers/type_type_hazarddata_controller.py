...
async def search_type_hazarddata(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_type_hazarddata_source=None) -> web.Response:
    ...
    :type skip: int
    :param search_type_hazarddata_source: Source Agency
    :type search_type_hazarddata_source: str
