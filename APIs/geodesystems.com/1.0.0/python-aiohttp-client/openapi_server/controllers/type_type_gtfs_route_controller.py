...
async def search_type_gtfs_route(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_type_gtfs_route_route_id=None, search_type_gtfs_route_stop_names=None) -> web.Response:
    ...
    :type skip: int
    :param search_type_gtfs_route_route_id: Route ID
    :type search_type_gtfs_route_route_id: str
    :param search_type_gtfs_route_stop_names: Stop Names
    :type search_type_gtfs_route_stop_names: str
