...
async def search_biblio(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_biblio_primary_author=None, search_biblio_type=None, search_biblio_institution=None, search_biblio_other_authors=None, search_biblio_publication=None) -> web.Response:
    ...
    :type skip: int
    :param search_biblio_primary_author: Primary Author
    :type search_biblio_primary_author: str
    :param search_biblio_type: Publication Type
    :type search_biblio_type: str
    :param search_biblio_institution: Institution
    :type search_biblio_institution: str
    :param search_biblio_other_authors: Other Authors
    :type search_biblio_other_authors: str
    :param search_biblio_publication: Publication
    :type search_biblio_publication: str
