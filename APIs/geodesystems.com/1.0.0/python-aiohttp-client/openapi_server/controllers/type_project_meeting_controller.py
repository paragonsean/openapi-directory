...
async def search_project_meeting(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_project_meeting_topic=None, search_project_meeting_location=None, search_project_meeting_participants=None) -> web.Response:
    ...
    :type skip: int
    :param search_project_meeting_topic: Topic
    :type search_project_meeting_topic: str
    :param search_project_meeting_location: Location
    :type search_project_meeting_location: str
    :param search_project_meeting_participants: Participants
    :type search_project_meeting_participants: str
