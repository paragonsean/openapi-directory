...
async def search_wikipage(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_wikipage_wikitext=None, search_wikipage_category=None) -> web.Response:
    ...
    :type skip: int
    :param search_wikipage_wikitext: Wiki Text
    :type search_wikipage_wikitext: str
    :param search_wikipage_category: Wiki Page Category
    :type search_wikipage_category: str
