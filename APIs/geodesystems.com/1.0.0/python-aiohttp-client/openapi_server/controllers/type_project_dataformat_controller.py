...
async def search_project_dataformat(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_project_dataformat_data_type=None, search_project_dataformat_field=None) -> web.Response:
    ...
    :type skip: int
    :param search_project_dataformat_data_type: Data Type
    :type search_project_dataformat_data_type: str
    :param search_project_dataformat_field: Field
    :type search_project_dataformat_field: str
