...
async def search_type_census_acs(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_type_census_acs_fields=None, search_type_census_acs_for_type=None, search_type_census_acs_in_type1=None, search_type_census_acs_in_type2=None) -> web.Response:
    ...
    :type skip: int
    :param search_type_census_acs_fields: Indicators
    :type search_type_census_acs_fields: str
    :param search_type_census_acs_for_type: For
    :type search_type_census_acs_for_type: str
    :param search_type_census_acs_in_type1: In
    :type search_type_census_acs_in_type1: str
    :param search_type_census_acs_in_type2: In #2
    :type search_type_census_acs_in_type2: str
