...
async def search_type_point_wsbb_ggp(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_type_point_wsbb_ggp_station=None, search_type_point_wsbb_ggp_instrument=None, search_type_point_wsbb_ggp_author=None) -> web.Response:
    ...
    :type skip: int
    :param search_type_point_wsbb_ggp_station: Station
    :type search_type_point_wsbb_ggp_station: str
    :param search_type_point_wsbb_ggp_instrument: Instrument
    :type search_type_point_wsbb_ggp_instrument: str
    :param search_type_point_wsbb_ggp_author: Author
    :type search_type_point_wsbb_ggp_author: str
