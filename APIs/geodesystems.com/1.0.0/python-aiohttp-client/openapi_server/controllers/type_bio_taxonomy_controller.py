...
async def search_bio_taxonomy(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_bio_taxonomy_rank=None, search_bio_taxonomy_embl_code=None, search_bio_taxonomy_division=None, search_bio_taxonomy_inherited_div=None, search_bio_taxonomy_aliases=None) -> web.Response:
    ...
    :type skip: int
    :param search_bio_taxonomy_rank: Rank
    :type search_bio_taxonomy_rank: str
    :param search_bio_taxonomy_embl_code: EMBL Code
    :type search_bio_taxonomy_embl_code: str
    :param search_bio_taxonomy_division: Divison
    :type search_bio_taxonomy_division: str
    :param search_bio_taxonomy_inherited_div: Inheritied division
    :type search_bio_taxonomy_inherited_div: bool
    :param search_bio_taxonomy_aliases: Also known
    :type search_bio_taxonomy_aliases: str
