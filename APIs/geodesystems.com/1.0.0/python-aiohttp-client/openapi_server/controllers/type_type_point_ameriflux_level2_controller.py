...
async def search_type_point_ameriflux_level2(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_type_point_ameriflux_level2_site_id=None, search_type_point_ameriflux_level2_contact=None, search_type_point_ameriflux_level2_ecosystem_type=None) -> web.Response:
    ...
    :type skip: int
    :param search_type_point_ameriflux_level2_site_id: Site ID
    :type search_type_point_ameriflux_level2_site_id: str
    :param search_type_point_ameriflux_level2_contact: Contact
    :type search_type_point_ameriflux_level2_contact: str
    :param search_type_point_ameriflux_level2_ecosystem_type: Ecosystem Type
    :type search_type_point_ameriflux_level2_ecosystem_type: str
