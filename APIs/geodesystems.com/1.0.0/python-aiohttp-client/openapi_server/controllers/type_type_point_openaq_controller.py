...
async def search_type_point_openaq(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_type_point_openaq_location=None, search_type_point_openaq_country=None, search_type_point_openaq_city=None, search_type_point_openaq_hours_offset=None) -> web.Response:
    ...
    :type skip: int
    :param search_type_point_openaq_location: Location
    :type search_type_point_openaq_location: str
    :param search_type_point_openaq_country: Country
    :type search_type_point_openaq_country: str
    :param search_type_point_openaq_city: City
    :type search_type_point_openaq_city: str
    :param search_type_point_openaq_hours_offset: Offset Hours
    :type search_type_point_openaq_hours_offset: int
