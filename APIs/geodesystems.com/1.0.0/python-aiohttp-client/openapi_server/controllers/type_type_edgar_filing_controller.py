...
async def search_type_edgar_filing(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_type_edgar_filing_form_type=None, search_type_edgar_filing_company_name=None, search_type_edgar_filing_cik_number=None, search_type_edgar_filing_standard_industrial_classification=None, search_type_edgar_filing_irs_number=None, search_type_edgar_filing_state=None) -> web.Response:
    ...
    :type skip: int
    :param search_type_edgar_filing_form_type: Form Type
    :type search_type_edgar_filing_form_type: str
    :param search_type_edgar_filing_company_name: Company Name
    :type search_type_edgar_filing_company_name: str
    :param search_type_edgar_filing_cik_number: CIK Number
    :type search_type_edgar_filing_cik_number: str
    :param search_type_edgar_filing_standard_industrial_classification: Standard Industrial Classification
    :type search_type_edgar_filing_standard_industrial_classification: str
    :param search_type_edgar_filing_irs_number: IRS Number
    :type search_type_edgar_filing_irs_number: str
    :param search_type_edgar_filing_state: State of Incorporation
    :type search_type_edgar_filing_state: str
