...
async def search_fits_data(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_fits_data_origin=None, search_fits_data_telescope=None, search_fits_data_instrument=None) -> web.Response:
    ...
    :type skip: int
    :param search_fits_data_origin: Origin
    :type search_fits_data_origin: str
    :param search_fits_data_telescope: Telescope
    :type search_fits_data_telescope: str
    :param search_fits_data_instrument: Instrument
    :type search_fits_data_instrument: str
