...
async def search_project_learning_resource(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_project_learning_resource_topic=None, search_project_learning_resource_grade_level=None) -> web.Response:
    ...
    :type skip: int
    :param search_project_learning_resource_topic: Topic
    :type search_project_learning_resource_topic: str
    :param search_project_learning_resource_grade_level: Grade Level
    :type search_project_learning_resource_grade_level: str
