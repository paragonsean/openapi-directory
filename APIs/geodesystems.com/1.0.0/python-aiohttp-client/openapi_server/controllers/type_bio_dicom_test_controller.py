...
async def search_bio_dicom_test(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_bio_dicom_test_patient_name=None, search_bio_dicom_test_patient_id=None) -> web.Response:
    ...
    :type skip: int
    :param search_bio_dicom_test_patient_name: Patient Name
    :type search_bio_dicom_test_patient_name: str
    :param search_bio_dicom_test_patient_id: Patient ID
    :type search_bio_dicom_test_patient_id: str
