...
async def search_type_point_hydro_waterml(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_type_point_hydro_waterml_site_code=None, search_type_point_hydro_waterml_site_name=None) -> web.Response:
    ...
    :type skip: int
    :param search_type_point_hydro_waterml_site_code: Site Code
    :type search_type_point_hydro_waterml_site_code: str
    :param search_type_point_hydro_waterml_site_name: Site Name
    :type search_type_point_hydro_waterml_site_name: str
