...
async def search_project_organization(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_project_organization_organization_type=None, search_project_organization_status=None) -> web.Response:
    ...
    :type skip: int
    :param search_project_organization_organization_type: Organization Type
    :type search_project_organization_organization_type: str
    :param search_project_organization_status: Status
    :type search_project_organization_status: str
