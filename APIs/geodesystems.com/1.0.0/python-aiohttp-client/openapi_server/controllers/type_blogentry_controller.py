...
async def search_blogentry(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_blogentry_blogtext=None) -> web.Response:
    ...
    :type skip: int
    :param search_blogentry_blogtext: Extra Text
    :type search_blogentry_blogtext: str
