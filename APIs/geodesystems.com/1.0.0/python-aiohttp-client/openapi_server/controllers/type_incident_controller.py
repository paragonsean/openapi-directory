...
async def search_incident(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_incident_incidenttype=None, search_incident_cause=None, search_incident_state=None) -> web.Response:
    ...
    :type skip: int
    :param search_incident_incidenttype: Incident Type
    :type search_incident_incidenttype: str
    :param search_incident_cause: Cause
    :type search_incident_cause: str
    :param search_incident_state: State
    :type search_incident_state: str
