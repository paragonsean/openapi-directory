...
async def search_contact(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_db_contact_name=None, search_db_contact_institution=None, search_db_contact_email=None) -> web.Response:
    ...
    :type skip: int
    :param search_db_contact_name: Name
    :type search_db_contact_name: str
    :param search_db_contact_institution: Institution
    :type search_db_contact_institution: str
    :param search_db_contact_email: Email
    :type search_db_contact_email: str
