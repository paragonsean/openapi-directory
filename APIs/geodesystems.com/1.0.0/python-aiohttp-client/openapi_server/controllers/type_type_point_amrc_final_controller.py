...
async def search_type_point_amrc_final(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_type_point_amrc_final_site_id=None, search_type_point_amrc_final_site_name=None, search_type_point_amrc_final_argos_id=None) -> web.Response:
    ...
    :type skip: int
    :param search_type_point_amrc_final_site_id: Site ID
    :type search_type_point_amrc_final_site_id: str
    :param search_type_point_amrc_final_site_name: Site Name
    :type search_type_point_amrc_final_site_name: str
    :param search_type_point_amrc_final_argos_id: Argos ID
    :type search_type_point_amrc_final_argos_id: str
