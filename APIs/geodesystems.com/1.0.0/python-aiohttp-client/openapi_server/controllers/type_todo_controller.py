...
async def search_todo(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_db_todo_checked=None, search_db_todo_title=None, search_db_todo_category=None) -> web.Response:
    ...
    :type skip: int
    :param search_db_todo_checked: Done
    :type search_db_todo_checked: bool
    :param search_db_todo_title: What
    :type search_db_todo_title: str
    :param search_db_todo_category: Category
    :type search_db_todo_category: str
