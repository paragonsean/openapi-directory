...
async def search_boulder_crimes(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_db_boulder_crimes_offense=None, search_db_boulder_crimes_reportdate=None, search_db_boulder_crimes_blockadd=None, search_db_boulder_crimes_location=None) -> web.Response:
    ...
    :type skip: int
    :param search_db_boulder_crimes_offense: Offense
    :type search_db_boulder_crimes_offense: str
    :param search_db_boulder_crimes_reportdate: Report Date
    :type search_db_boulder_crimes_reportdate: str
    :param search_db_boulder_crimes_blockadd: Address
    :type search_db_boulder_crimes_blockadd: str
    :param search_db_boulder_crimes_location: Location
    :type search_db_boulder_crimes_location: str
