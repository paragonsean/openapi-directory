...
async def search_project_dataset(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_project_dataset_dataset_id=None, search_project_dataset_data_type=None, search_project_dataset_data_level=None) -> web.Response:
    ...
    :type skip: int
    :param search_project_dataset_dataset_id: Dataset ID
    :type search_project_dataset_dataset_id: str
    :param search_project_dataset_data_type: Data Type
    :type search_project_dataset_data_type: str
    :param search_project_dataset_data_level: Data Level
    :type search_project_dataset_data_level: str
