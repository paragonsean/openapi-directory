...
async def search_bio_ontology_person(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_bio_ontology_person_gender=None) -> web.Response:
    ...
    :type skip: int
    :param search_bio_ontology_person_gender: Gender
    :type search_bio_ontology_person_gender: str
