...
async def search_project_casestudy(request: web.Request, text=None, name=None, description=None, fromdate=None, todate=None, createdate_from=None, createdate_to=None, changedate_from=None, changedate_to=None, group=None, filesuffix=None, maxlatitude=None, minlongitude=None, minlatitude=None, maxlongitude=None, max=None, skip=None, search_project_casestudy_intended_use=None, search_project_casestudy_location=None) -> web.Response:
    ...
    :type skip: int
    :param search_project_casestudy_intended_use: Intended Use
    :type search_project_casestudy_intended_use: str
    :param search_project_casestudy_location: Where
    :type search_project_casestudy_location: str
