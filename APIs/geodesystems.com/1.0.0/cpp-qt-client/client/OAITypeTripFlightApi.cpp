...
#include "OAITypeTripFlightApi.h"
...
OAITypeTripFlightApi::OAITypeTripFlightApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTripFlightApi::~OAITypeTripFlightApi() {
}

void OAITypeTripFlightApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTripFlight", defaultConf);
    _serverIndices.insert("searchTripFlight", 0);
}
...
*/
int OAITypeTripFlightApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTripFlightApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTripFlightApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTripFlightApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTripFlightApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTripFlightApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTripFlightApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTripFlightApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTripFlightApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTripFlightApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTripFlightApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTripFlightApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTripFlightApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTripFlightApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTripFlightApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTripFlightApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTripFlightApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTripFlightApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTripFlightApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTripFlightApi::searchTripFlight(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTripFlightApi::searchTripFlightCallback);
    connect(this, &OAITypeTripFlightApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTripFlightApi::searchTripFlightCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTripFlightSignal();
        Q_EMIT searchTripFlightSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTripFlightSignalE(error_type, error_str);
        Q_EMIT searchTripFlightSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTripFlightSignalError(error_type, error_str);
        Q_EMIT searchTripFlightSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTripFlightApi::tokenAvailable(){
