...
OAITypeNotesNoteApi::OAITypeNotesNoteApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeNotesNoteApi::~OAITypeNotesNoteApi() {
}

void OAITypeNotesNoteApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchNotesNote", defaultConf);
    _serverIndices.insert("searchNotesNote", 0);
}
...
*/
int OAITypeNotesNoteApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeNotesNoteApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeNotesNoteApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeNotesNoteApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeNotesNoteApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeNotesNoteApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeNotesNoteApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeNotesNoteApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeNotesNoteApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeNotesNoteApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeNotesNoteApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeNotesNoteApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeNotesNoteApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeNotesNoteApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeNotesNoteApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeNotesNoteApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeNotesNoteApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeNotesNoteApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeNotesNoteApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeNotesNoteApi::searchNotesNote(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeNotesNoteApi::searchNotesNoteCallback);
    connect(this, &OAITypeNotesNoteApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeNotesNoteApi::searchNotesNoteCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchNotesNoteSignal();
        Q_EMIT searchNotesNoteSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchNotesNoteSignalE(error_type, error_str);
        Q_EMIT searchNotesNoteSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchNotesNoteSignalError(error_type, error_str);
        Q_EMIT searchNotesNoteSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeNotesNoteApi::tokenAvailable(){
