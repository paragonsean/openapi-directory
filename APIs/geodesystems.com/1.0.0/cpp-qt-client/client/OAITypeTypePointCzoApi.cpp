...
#include "OAITypeTypePointCzoApi.h"
...
OAITypeTypePointCzoApi::OAITypeTypePointCzoApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointCzoApi::~OAITypeTypePointCzoApi() {
}

void OAITypeTypePointCzoApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointCzo", defaultConf);
    _serverIndices.insert("searchTypePointCzo", 0);
}
...
*/
int OAITypeTypePointCzoApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointCzoApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointCzoApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointCzoApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointCzoApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointCzoApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointCzoApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointCzoApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointCzoApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointCzoApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointCzoApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointCzoApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointCzoApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointCzoApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointCzoApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointCzoApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointCzoApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointCzoApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointCzoApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointCzoApi::searchTypePointCzo(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointCzoApi::searchTypePointCzoCallback);
    connect(this, &OAITypeTypePointCzoApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointCzoApi::searchTypePointCzoCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointCzoSignal();
        Q_EMIT searchTypePointCzoSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointCzoSignalE(error_type, error_str);
        Q_EMIT searchTypePointCzoSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointCzoSignalError(error_type, error_str);
        Q_EMIT searchTypePointCzoSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointCzoApi::tokenAvailable(){
