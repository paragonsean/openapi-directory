...
#include "OAITypeTypeExtremesApi.h"
...
OAITypeTypeExtremesApi::OAITypeTypeExtremesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeExtremesApi::~OAITypeTypeExtremesApi() {
}

void OAITypeTypeExtremesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeExtremes", defaultConf);
    _serverIndices.insert("searchTypeExtremes", 0);
}
...
*/
int OAITypeTypeExtremesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeExtremesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeExtremesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeExtremesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeExtremesApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeExtremesApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeExtremesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeExtremesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeExtremesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeExtremesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeExtremesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeExtremesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeExtremesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeExtremesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeExtremesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeExtremesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeExtremesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeExtremesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeExtremesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeExtremesApi::searchTypeExtremes(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_type_extremes_region, const ::OpenAPI::OptionalParam<QString> &search_type_extremes_variable) {
    QString fullPath = QString(_serverConfigs["searchTypeExtremes"][_serverIndices.value("searchTypeExtremes")].URL()+"/repository/search/type/type_extremes");
    ...
    if (search_type_extremes_region.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.type_extremes.region", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.type_extremes.region")).append(querySuffix).append(QUrl::toPercentEncoding(search_type_extremes_region.stringValue()));
    }
    if (search_type_extremes_variable.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.type_extremes.variable", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.type_extremes.variable")).append(querySuffix).append(QUrl::toPercentEncoding(search_type_extremes_variable.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeExtremesApi::searchTypeExtremesCallback);
    connect(this, &OAITypeTypeExtremesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeExtremesApi::searchTypeExtremesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeExtremesSignal();
        Q_EMIT searchTypeExtremesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeExtremesSignalE(error_type, error_str);
        Q_EMIT searchTypeExtremesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeExtremesSignalError(error_type, error_str);
        Q_EMIT searchTypeExtremesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeExtremesApi::tokenAvailable(){
