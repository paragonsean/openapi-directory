...
OAITypeBlogentryApi::OAITypeBlogentryApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeBlogentryApi::~OAITypeBlogentryApi() {
}

void OAITypeBlogentryApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchBlogentry", defaultConf);
    _serverIndices.insert("searchBlogentry", 0);
}
...
*/
int OAITypeBlogentryApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeBlogentryApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeBlogentryApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeBlogentryApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeBlogentryApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeBlogentryApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeBlogentryApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeBlogentryApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeBlogentryApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeBlogentryApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBlogentryApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBlogentryApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeBlogentryApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeBlogentryApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeBlogentryApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeBlogentryApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeBlogentryApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeBlogentryApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeBlogentryApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeBlogentryApi::searchBlogentry(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_blogentry_blogtext) {
    ...
    if (search_blogentry_blogtext.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.blogentry.blogtext", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.blogentry.blogtext")).append(querySuffix).append(QUrl::toPercentEncoding(search_blogentry_blogtext.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeBlogentryApi::searchBlogentryCallback);
    connect(this, &OAITypeBlogentryApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeBlogentryApi::searchBlogentryCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchBlogentrySignal();
        Q_EMIT searchBlogentrySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchBlogentrySignalE(error_type, error_str);
        Q_EMIT searchBlogentrySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchBlogentrySignalError(error_type, error_str);
        Q_EMIT searchBlogentrySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeBlogentryApi::tokenAvailable(){
