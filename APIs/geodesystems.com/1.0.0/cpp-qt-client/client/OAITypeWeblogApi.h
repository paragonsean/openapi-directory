...
#ifndef OAI_OAITypeWeblogApi_H
#define OAI_OAITypeWeblogApi_H
...
class OAITypeWeblogApi : public QObject {
    Q_OBJECT

public:
    OAITypeWeblogApi(const int timeOut = 0);
    ~OAITypeWeblogApi();
...
private:
    ...
    void searchWeblogCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void searchWeblogSignal();


    void searchWeblogSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchWeblogSignalError() instead")
    void searchWeblogSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchWeblogSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use searchWeblogSignalErrorFull() instead")
    void searchWeblogSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchWeblogSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
