...
#include "OAITypeTypeImageWebcamApi.h"
...
OAITypeTypeImageWebcamApi::OAITypeTypeImageWebcamApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeImageWebcamApi::~OAITypeTypeImageWebcamApi() {
}

void OAITypeTypeImageWebcamApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeImageWebcam", defaultConf);
    _serverIndices.insert("searchTypeImageWebcam", 0);
}
...
*/
int OAITypeTypeImageWebcamApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeImageWebcamApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeImageWebcamApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeImageWebcamApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeImageWebcamApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeImageWebcamApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeImageWebcamApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeImageWebcamApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeImageWebcamApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeImageWebcamApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeImageWebcamApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeImageWebcamApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeImageWebcamApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeImageWebcamApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeImageWebcamApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeImageWebcamApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeImageWebcamApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeImageWebcamApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeImageWebcamApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeImageWebcamApi::searchTypeImageWebcam(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeImageWebcamApi::searchTypeImageWebcamCallback);
    connect(this, &OAITypeTypeImageWebcamApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeImageWebcamApi::searchTypeImageWebcamCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeImageWebcamSignal();
        Q_EMIT searchTypeImageWebcamSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeImageWebcamSignalE(error_type, error_str);
        Q_EMIT searchTypeImageWebcamSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeImageWebcamSignalError(error_type, error_str);
        Q_EMIT searchTypeImageWebcamSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeImageWebcamApi::tokenAvailable(){
