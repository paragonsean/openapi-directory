...
OAITypeTripHotelApi::OAITypeTripHotelApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTripHotelApi::~OAITypeTripHotelApi() {
}

void OAITypeTripHotelApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTripHotel", defaultConf);
    _serverIndices.insert("searchTripHotel", 0);
}
...
*/
int OAITypeTripHotelApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTripHotelApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTripHotelApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTripHotelApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTripHotelApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTripHotelApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTripHotelApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTripHotelApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTripHotelApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTripHotelApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTripHotelApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTripHotelApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTripHotelApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTripHotelApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTripHotelApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTripHotelApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTripHotelApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTripHotelApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTripHotelApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTripHotelApi::searchTripHotel(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTripHotelApi::searchTripHotelCallback);
    connect(this, &OAITypeTripHotelApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTripHotelApi::searchTripHotelCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTripHotelSignal();
        Q_EMIT searchTripHotelSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTripHotelSignalE(error_type, error_str);
        Q_EMIT searchTripHotelSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTripHotelSignalError(error_type, error_str);
        Q_EMIT searchTripHotelSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTripHotelApi::tokenAvailable(){
