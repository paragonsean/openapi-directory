...
#ifndef OAI_OAITypeFtpApi_H
#define OAI_OAITypeFtpApi_H
...
class OAITypeFtpApi : public QObject {
    Q_OBJECT

public:
    OAITypeFtpApi(const int timeOut = 0);
    ~OAITypeFtpApi();
...
private:
    ...
    void searchFtpCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void searchFtpSignal();


    void searchFtpSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchFtpSignalError() instead")
    void searchFtpSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchFtpSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use searchFtpSignalErrorFull() instead")
    void searchFtpSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchFtpSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
