...
#include "OAITypeNotesNotebookApi.h"
...
OAITypeNotesNotebookApi::OAITypeNotesNotebookApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeNotesNotebookApi::~OAITypeNotesNotebookApi() {
}

void OAITypeNotesNotebookApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchNotesNotebook", defaultConf);
    _serverIndices.insert("searchNotesNotebook", 0);
}
...
*/
int OAITypeNotesNotebookApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeNotesNotebookApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeNotesNotebookApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeNotesNotebookApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeNotesNotebookApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeNotesNotebookApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeNotesNotebookApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeNotesNotebookApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeNotesNotebookApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeNotesNotebookApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeNotesNotebookApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeNotesNotebookApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeNotesNotebookApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeNotesNotebookApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeNotesNotebookApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeNotesNotebookApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeNotesNotebookApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeNotesNotebookApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeNotesNotebookApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeNotesNotebookApi::searchNotesNotebook(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeNotesNotebookApi::searchNotesNotebookCallback);
    connect(this, &OAITypeNotesNotebookApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeNotesNotebookApi::searchNotesNotebookCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchNotesNotebookSignal();
        Q_EMIT searchNotesNotebookSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchNotesNotebookSignalE(error_type, error_str);
        Q_EMIT searchNotesNotebookSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchNotesNotebookSignalError(error_type, error_str);
        Q_EMIT searchNotesNotebookSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeNotesNotebookApi::tokenAvailable(){
