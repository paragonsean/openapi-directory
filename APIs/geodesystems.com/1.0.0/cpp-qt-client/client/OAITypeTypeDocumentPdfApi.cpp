...
#include "OAITypeTypeDocumentPdfApi.h"
...
OAITypeTypeDocumentPdfApi::OAITypeTypeDocumentPdfApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeDocumentPdfApi::~OAITypeTypeDocumentPdfApi() {
}

void OAITypeTypeDocumentPdfApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeDocumentPdf", defaultConf);
    _serverIndices.insert("searchTypeDocumentPdf", 0);
}
...
*/
int OAITypeTypeDocumentPdfApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeDocumentPdfApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeDocumentPdfApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeDocumentPdfApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeDocumentPdfApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeDocumentPdfApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeDocumentPdfApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeDocumentPdfApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeDocumentPdfApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeDocumentPdfApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDocumentPdfApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDocumentPdfApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeDocumentPdfApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeDocumentPdfApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeDocumentPdfApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeDocumentPdfApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeDocumentPdfApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeDocumentPdfApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeDocumentPdfApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeDocumentPdfApi::searchTypeDocumentPdf(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeDocumentPdfApi::searchTypeDocumentPdfCallback);
    connect(this, &OAITypeTypeDocumentPdfApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeDocumentPdfApi::searchTypeDocumentPdfCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeDocumentPdfSignal();
        Q_EMIT searchTypeDocumentPdfSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeDocumentPdfSignalE(error_type, error_str);
        Q_EMIT searchTypeDocumentPdfSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeDocumentPdfSignalError(error_type, error_str);
        Q_EMIT searchTypeDocumentPdfSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeDocumentPdfApi::tokenAvailable(){
