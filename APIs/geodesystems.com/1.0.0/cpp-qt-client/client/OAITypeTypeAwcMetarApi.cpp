...
#include "OAITypeTypeAwcMetarApi.h"
...
OAITypeTypeAwcMetarApi::OAITypeTypeAwcMetarApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeAwcMetarApi::~OAITypeTypeAwcMetarApi() {
}

void OAITypeTypeAwcMetarApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeAwcMetar", defaultConf);
    _serverIndices.insert("searchTypeAwcMetar", 0);
}
...
*/
int OAITypeTypeAwcMetarApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeAwcMetarApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeAwcMetarApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeAwcMetarApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeAwcMetarApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeAwcMetarApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeAwcMetarApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeAwcMetarApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeAwcMetarApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeAwcMetarApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeAwcMetarApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeAwcMetarApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeAwcMetarApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeAwcMetarApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeAwcMetarApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeAwcMetarApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeAwcMetarApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeAwcMetarApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeAwcMetarApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeAwcMetarApi::searchTypeAwcMetar(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_type_awc_metar_site_id) {
    QString fullPath = QString(_serverConfigs["searchTypeAwcMetar"][_serverIndices.value("searchTypeAwcMetar")].URL()+"/repository/search/type/type_awc_metar");
    ...
    if (search_type_awc_metar_site_id.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.type_awc_metar.site_id", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.type_awc_metar.site_id")).append(querySuffix).append(QUrl::toPercentEncoding(search_type_awc_metar_site_id.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeAwcMetarApi::searchTypeAwcMetarCallback);
    connect(this, &OAITypeTypeAwcMetarApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeAwcMetarApi::searchTypeAwcMetarCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeAwcMetarSignal();
        Q_EMIT searchTypeAwcMetarSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeAwcMetarSignalE(error_type, error_str);
        Q_EMIT searchTypeAwcMetarSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeAwcMetarSignalError(error_type, error_str);
        Q_EMIT searchTypeAwcMetarSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeAwcMetarApi::tokenAvailable(){
