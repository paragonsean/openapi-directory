...
OAITypeLocationsApi::OAITypeLocationsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeLocationsApi::~OAITypeLocationsApi() {
}

void OAITypeLocationsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchLocations", defaultConf);
    _serverIndices.insert("searchLocations", 0);
}
...
*/
int OAITypeLocationsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeLocationsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeLocationsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeLocationsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeLocationsApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeLocationsApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeLocationsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeLocationsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeLocationsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeLocationsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLocationsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLocationsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeLocationsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeLocationsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeLocationsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeLocationsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeLocationsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeLocationsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeLocationsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeLocationsApi::searchLocations(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_db_locations_name, const ::OpenAPI::OptionalParam<QString> &search_db_locations_type, const ::OpenAPI::OptionalParam<QString> &search_db_locations_location) {
    QString fullPath = QString(_serverConfigs["searchLocations"][_serverIndices.value("searchLocations")].URL()+"/repository/search/type/locations");
    ...
    if (search_db_locations_name.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.db_locations.name", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.db_locations.name")).append(querySuffix).append(QUrl::toPercentEncoding(search_db_locations_name.stringValue()));
    }
    if (search_db_locations_type.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.db_locations.type", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.db_locations.type")).append(querySuffix).append(QUrl::toPercentEncoding(search_db_locations_type.stringValue()));
    }
    if (search_db_locations_location.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.db_locations.location", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.db_locations.location")).append(querySuffix).append(QUrl::toPercentEncoding(search_db_locations_location.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeLocationsApi::searchLocationsCallback);
    connect(this, &OAITypeLocationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeLocationsApi::searchLocationsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchLocationsSignal();
        Q_EMIT searchLocationsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchLocationsSignalE(error_type, error_str);
        Q_EMIT searchLocationsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchLocationsSignalError(error_type, error_str);
        Q_EMIT searchLocationsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeLocationsApi::tokenAvailable(){
