...
#include "OAITypeTypeDocumentCsvApi.h"
...
OAITypeTypeDocumentCsvApi::OAITypeTypeDocumentCsvApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeDocumentCsvApi::~OAITypeTypeDocumentCsvApi() {
}

void OAITypeTypeDocumentCsvApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeDocumentCsv", defaultConf);
    _serverIndices.insert("searchTypeDocumentCsv", 0);
}
...
*/
int OAITypeTypeDocumentCsvApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeDocumentCsvApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeDocumentCsvApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeDocumentCsvApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeDocumentCsvApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeDocumentCsvApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeDocumentCsvApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeDocumentCsvApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeDocumentCsvApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeDocumentCsvApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDocumentCsvApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDocumentCsvApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeDocumentCsvApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeDocumentCsvApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeDocumentCsvApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeDocumentCsvApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeDocumentCsvApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeDocumentCsvApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeDocumentCsvApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeDocumentCsvApi::searchTypeDocumentCsv(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeDocumentCsvApi::searchTypeDocumentCsvCallback);
    connect(this, &OAITypeTypeDocumentCsvApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeDocumentCsvApi::searchTypeDocumentCsvCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeDocumentCsvSignal();
        Q_EMIT searchTypeDocumentCsvSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeDocumentCsvSignalE(error_type, error_str);
        Q_EMIT searchTypeDocumentCsvSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeDocumentCsvSignalError(error_type, error_str);
        Q_EMIT searchTypeDocumentCsvSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeDocumentCsvApi::tokenAvailable(){
