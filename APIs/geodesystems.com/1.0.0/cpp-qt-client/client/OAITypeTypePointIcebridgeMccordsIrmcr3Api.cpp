...
#include "OAITypeTypePointIcebridgeMccordsIrmcr3Api.h"
...
OAITypeTypePointIcebridgeMccordsIrmcr3Api::OAITypeTypePointIcebridgeMccordsIrmcr3Api(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointIcebridgeMccordsIrmcr3Api::~OAITypeTypePointIcebridgeMccordsIrmcr3Api() {
}

void OAITypeTypePointIcebridgeMccordsIrmcr3Api::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointIcebridgeMccordsIrmcr3", defaultConf);
    _serverIndices.insert("searchTypePointIcebridgeMccordsIrmcr3", 0);
}
...
*/
int OAITypeTypePointIcebridgeMccordsIrmcr3Api::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointIcebridgeMccordsIrmcr3Api::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointIcebridgeMccordsIrmcr3Api::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointIcebridgeMccordsIrmcr3Api::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointIcebridgeMccordsIrmcr3Api::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointIcebridgeMccordsIrmcr3Api::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointIcebridgeMccordsIrmcr3Api::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointIcebridgeMccordsIrmcr3Api::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointIcebridgeMccordsIrmcr3Api::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointIcebridgeMccordsIrmcr3Api::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointIcebridgeMccordsIrmcr3Api::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointIcebridgeMccordsIrmcr3Api::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointIcebridgeMccordsIrmcr3Api::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointIcebridgeMccordsIrmcr3Api::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointIcebridgeMccordsIrmcr3Api::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointIcebridgeMccordsIrmcr3Api::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointIcebridgeMccordsIrmcr3Api::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointIcebridgeMccordsIrmcr3Api::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointIcebridgeMccordsIrmcr3Api::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointIcebridgeMccordsIrmcr3Api::searchTypePointIcebridgeMccordsIrmcr3(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    QString fullPath = QString(_serverConfigs["searchTypePointIcebridgeMccordsIrmcr3"][_serverIndices.value("searchTypePointIcebridgeMccordsIrmcr3")].URL()+"/repository/search/type/type_point_icebridge_mccords_irmcr3");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointIcebridgeMccordsIrmcr3Api::searchTypePointIcebridgeMccordsIrmcr3Callback);
    connect(this, &OAITypeTypePointIcebridgeMccordsIrmcr3Api::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointIcebridgeMccordsIrmcr3Api::searchTypePointIcebridgeMccordsIrmcr3Callback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointIcebridgeMccordsIrmcr3Signal();
        Q_EMIT searchTypePointIcebridgeMccordsIrmcr3SignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointIcebridgeMccordsIrmcr3SignalE(error_type, error_str);
        Q_EMIT searchTypePointIcebridgeMccordsIrmcr3SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointIcebridgeMccordsIrmcr3SignalError(error_type, error_str);
        Q_EMIT searchTypePointIcebridgeMccordsIrmcr3SignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointIcebridgeMccordsIrmcr3Api::tokenAvailable(){
