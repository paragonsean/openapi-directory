...
#include "OAITypeTypeDocumentXlsApi.h"
...
OAITypeTypeDocumentXlsApi::OAITypeTypeDocumentXlsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeDocumentXlsApi::~OAITypeTypeDocumentXlsApi() {
}

void OAITypeTypeDocumentXlsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeDocumentXls", defaultConf);
    _serverIndices.insert("searchTypeDocumentXls", 0);
}
...
*/
int OAITypeTypeDocumentXlsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeDocumentXlsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeDocumentXlsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeDocumentXlsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeDocumentXlsApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeDocumentXlsApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeDocumentXlsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeDocumentXlsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeDocumentXlsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeDocumentXlsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDocumentXlsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDocumentXlsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeDocumentXlsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeDocumentXlsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeDocumentXlsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeDocumentXlsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeDocumentXlsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeDocumentXlsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeDocumentXlsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeDocumentXlsApi::searchTypeDocumentXls(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeDocumentXlsApi::searchTypeDocumentXlsCallback);
    connect(this, &OAITypeTypeDocumentXlsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeDocumentXlsApi::searchTypeDocumentXlsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeDocumentXlsSignal();
        Q_EMIT searchTypeDocumentXlsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeDocumentXlsSignalE(error_type, error_str);
        Q_EMIT searchTypeDocumentXlsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeDocumentXlsSignalError(error_type, error_str);
        Q_EMIT searchTypeDocumentXlsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeDocumentXlsApi::tokenAvailable(){
