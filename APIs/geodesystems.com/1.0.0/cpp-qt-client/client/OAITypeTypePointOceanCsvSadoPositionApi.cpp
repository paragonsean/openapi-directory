...
#include "OAITypeTypePointOceanCsvSadoPositionApi.h"
...
OAITypeTypePointOceanCsvSadoPositionApi::OAITypeTypePointOceanCsvSadoPositionApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointOceanCsvSadoPositionApi::~OAITypeTypePointOceanCsvSadoPositionApi() {
}

void OAITypeTypePointOceanCsvSadoPositionApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointOceanCsvSadoPosition", defaultConf);
    _serverIndices.insert("searchTypePointOceanCsvSadoPosition", 0);
}
...
*/
int OAITypeTypePointOceanCsvSadoPositionApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointOceanCsvSadoPositionApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointOceanCsvSadoPositionApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointOceanCsvSadoPositionApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointOceanCsvSadoPositionApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointOceanCsvSadoPositionApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointOceanCsvSadoPositionApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointOceanCsvSadoPositionApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointOceanCsvSadoPositionApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointOceanCsvSadoPositionApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointOceanCsvSadoPositionApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointOceanCsvSadoPositionApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointOceanCsvSadoPositionApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointOceanCsvSadoPositionApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointOceanCsvSadoPositionApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointOceanCsvSadoPositionApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointOceanCsvSadoPositionApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointOceanCsvSadoPositionApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointOceanCsvSadoPositionApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointOceanCsvSadoPositionApi::searchTypePointOceanCsvSadoPosition(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointOceanCsvSadoPositionApi::searchTypePointOceanCsvSadoPositionCallback);
    connect(this, &OAITypeTypePointOceanCsvSadoPositionApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointOceanCsvSadoPositionApi::searchTypePointOceanCsvSadoPositionCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointOceanCsvSadoPositionSignal();
        Q_EMIT searchTypePointOceanCsvSadoPositionSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointOceanCsvSadoPositionSignalE(error_type, error_str);
        Q_EMIT searchTypePointOceanCsvSadoPositionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointOceanCsvSadoPositionSignalError(error_type, error_str);
        Q_EMIT searchTypePointOceanCsvSadoPositionSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointOceanCsvSadoPositionApi::tokenAvailable(){
