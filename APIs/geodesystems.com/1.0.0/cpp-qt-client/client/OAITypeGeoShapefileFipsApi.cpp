...
#include "OAITypeGeoShapefileFipsApi.h"
...
OAITypeGeoShapefileFipsApi::OAITypeGeoShapefileFipsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeGeoShapefileFipsApi::~OAITypeGeoShapefileFipsApi() {
}

void OAITypeGeoShapefileFipsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchGeoShapefileFips", defaultConf);
    _serverIndices.insert("searchGeoShapefileFips", 0);
}
...
*/
int OAITypeGeoShapefileFipsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeGeoShapefileFipsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeGeoShapefileFipsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeGeoShapefileFipsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeGeoShapefileFipsApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeGeoShapefileFipsApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeGeoShapefileFipsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeGeoShapefileFipsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeGeoShapefileFipsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeGeoShapefileFipsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGeoShapefileFipsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGeoShapefileFipsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeGeoShapefileFipsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeGeoShapefileFipsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeGeoShapefileFipsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeGeoShapefileFipsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeGeoShapefileFipsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeGeoShapefileFipsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeGeoShapefileFipsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeGeoShapefileFipsApi::searchGeoShapefileFips(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeGeoShapefileFipsApi::searchGeoShapefileFipsCallback);
    connect(this, &OAITypeGeoShapefileFipsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeGeoShapefileFipsApi::searchGeoShapefileFipsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchGeoShapefileFipsSignal();
        Q_EMIT searchGeoShapefileFipsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchGeoShapefileFipsSignalE(error_type, error_str);
        Q_EMIT searchGeoShapefileFipsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchGeoShapefileFipsSignalError(error_type, error_str);
        Q_EMIT searchGeoShapefileFipsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeGeoShapefileFipsApi::tokenAvailable(){
