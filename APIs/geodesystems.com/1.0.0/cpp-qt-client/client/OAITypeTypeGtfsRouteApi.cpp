...
#include "OAITypeTypeGtfsRouteApi.h"
...
OAITypeTypeGtfsRouteApi::OAITypeTypeGtfsRouteApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeGtfsRouteApi::~OAITypeTypeGtfsRouteApi() {
}

void OAITypeTypeGtfsRouteApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeGtfsRoute", defaultConf);
    _serverIndices.insert("searchTypeGtfsRoute", 0);
}
...
*/
int OAITypeTypeGtfsRouteApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeGtfsRouteApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeGtfsRouteApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeGtfsRouteApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeGtfsRouteApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeGtfsRouteApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeGtfsRouteApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeGtfsRouteApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeGtfsRouteApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeGtfsRouteApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeGtfsRouteApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeGtfsRouteApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeGtfsRouteApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeGtfsRouteApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeGtfsRouteApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeGtfsRouteApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeGtfsRouteApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeGtfsRouteApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeGtfsRouteApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeGtfsRouteApi::searchTypeGtfsRoute(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_type_gtfs_route_route_id, const ::OpenAPI::OptionalParam<QString> &search_type_gtfs_route_stop_names) {
    QString fullPath = QString(_serverConfigs["searchTypeGtfsRoute"][_serverIndices.value("searchTypeGtfsRoute")].URL()+"/repository/search/type/type_gtfs_route");
    ...
    if (search_type_gtfs_route_route_id.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.type_gtfs_route.route_id", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.type_gtfs_route.route_id")).append(querySuffix).append(QUrl::toPercentEncoding(search_type_gtfs_route_route_id.stringValue()));
    }
    if (search_type_gtfs_route_stop_names.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.type_gtfs_route.stop_names", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.type_gtfs_route.stop_names")).append(querySuffix).append(QUrl::toPercentEncoding(search_type_gtfs_route_stop_names.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeGtfsRouteApi::searchTypeGtfsRouteCallback);
    connect(this, &OAITypeTypeGtfsRouteApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeGtfsRouteApi::searchTypeGtfsRouteCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeGtfsRouteSignal();
        Q_EMIT searchTypeGtfsRouteSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeGtfsRouteSignalE(error_type, error_str);
        Q_EMIT searchTypeGtfsRouteSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeGtfsRouteSignalError(error_type, error_str);
        Q_EMIT searchTypeGtfsRouteSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeGtfsRouteApi::tokenAvailable(){
