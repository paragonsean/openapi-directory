...
OAITypeBioSamApi::OAITypeBioSamApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeBioSamApi::~OAITypeBioSamApi() {
}

void OAITypeBioSamApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchBioSam", defaultConf);
    _serverIndices.insert("searchBioSam", 0);
}
...
*/
int OAITypeBioSamApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeBioSamApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeBioSamApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeBioSamApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeBioSamApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeBioSamApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeBioSamApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeBioSamApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeBioSamApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeBioSamApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioSamApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioSamApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeBioSamApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeBioSamApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeBioSamApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeBioSamApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeBioSamApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeBioSamApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeBioSamApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeBioSamApi::searchBioSam(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeBioSamApi::searchBioSamCallback);
    connect(this, &OAITypeBioSamApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeBioSamApi::searchBioSamCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchBioSamSignal();
        Q_EMIT searchBioSamSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchBioSamSignalE(error_type, error_str);
        Q_EMIT searchBioSamSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchBioSamSignalError(error_type, error_str);
        Q_EMIT searchBioSamSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeBioSamApi::tokenAvailable(){
