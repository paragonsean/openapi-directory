...
OAITypePointTextApi::OAITypePointTextApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypePointTextApi::~OAITypePointTextApi() {
}

void OAITypePointTextApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchPointText", defaultConf);
    _serverIndices.insert("searchPointText", 0);
}
...
*/
int OAITypePointTextApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypePointTextApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypePointTextApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypePointTextApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypePointTextApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypePointTextApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypePointTextApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypePointTextApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypePointTextApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypePointTextApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypePointTextApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypePointTextApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypePointTextApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypePointTextApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypePointTextApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypePointTextApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypePointTextApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypePointTextApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypePointTextApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypePointTextApi::searchPointText(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypePointTextApi::searchPointTextCallback);
    connect(this, &OAITypePointTextApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypePointTextApi::searchPointTextCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchPointTextSignal();
        Q_EMIT searchPointTextSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchPointTextSignalE(error_type, error_str);
        Q_EMIT searchPointTextSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchPointTextSignalError(error_type, error_str);
        Q_EMIT searchPointTextSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypePointTextApi::tokenAvailable(){
