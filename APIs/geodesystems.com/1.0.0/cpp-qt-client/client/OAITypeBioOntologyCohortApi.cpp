...
#include "OAITypeBioOntologyCohortApi.h"
...
OAITypeBioOntologyCohortApi::OAITypeBioOntologyCohortApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeBioOntologyCohortApi::~OAITypeBioOntologyCohortApi() {
}

void OAITypeBioOntologyCohortApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchBioOntologyCohort", defaultConf);
    _serverIndices.insert("searchBioOntologyCohort", 0);
}
...
*/
int OAITypeBioOntologyCohortApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeBioOntologyCohortApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeBioOntologyCohortApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeBioOntologyCohortApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeBioOntologyCohortApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeBioOntologyCohortApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeBioOntologyCohortApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeBioOntologyCohortApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeBioOntologyCohortApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeBioOntologyCohortApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioOntologyCohortApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioOntologyCohortApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeBioOntologyCohortApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeBioOntologyCohortApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeBioOntologyCohortApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeBioOntologyCohortApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeBioOntologyCohortApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeBioOntologyCohortApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeBioOntologyCohortApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeBioOntologyCohortApi::searchBioOntologyCohort(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeBioOntologyCohortApi::searchBioOntologyCohortCallback);
    connect(this, &OAITypeBioOntologyCohortApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeBioOntologyCohortApi::searchBioOntologyCohortCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchBioOntologyCohortSignal();
        Q_EMIT searchBioOntologyCohortSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchBioOntologyCohortSignalE(error_type, error_str);
        Q_EMIT searchBioOntologyCohortSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchBioOntologyCohortSignalError(error_type, error_str);
        Q_EMIT searchBioOntologyCohortSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeBioOntologyCohortApi::tokenAvailable(){
