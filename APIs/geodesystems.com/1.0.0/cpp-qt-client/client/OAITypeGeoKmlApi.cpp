...
OAITypeGeoKmlApi::OAITypeGeoKmlApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeGeoKmlApi::~OAITypeGeoKmlApi() {
}

void OAITypeGeoKmlApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchGeoKml", defaultConf);
    _serverIndices.insert("searchGeoKml", 0);
}
...
*/
int OAITypeGeoKmlApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeGeoKmlApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeGeoKmlApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeGeoKmlApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeGeoKmlApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeGeoKmlApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeGeoKmlApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeGeoKmlApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeGeoKmlApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeGeoKmlApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGeoKmlApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGeoKmlApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeGeoKmlApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeGeoKmlApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeGeoKmlApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeGeoKmlApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeGeoKmlApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeGeoKmlApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeGeoKmlApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeGeoKmlApi::searchGeoKml(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeGeoKmlApi::searchGeoKmlCallback);
    connect(this, &OAITypeGeoKmlApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeGeoKmlApi::searchGeoKmlCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchGeoKmlSignal();
        Q_EMIT searchGeoKmlSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchGeoKmlSignalE(error_type, error_str);
        Q_EMIT searchGeoKmlSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchGeoKmlSignalError(error_type, error_str);
        Q_EMIT searchGeoKmlSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeGeoKmlApi::tokenAvailable(){
