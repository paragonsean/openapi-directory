...
#include "OAITypeNotesJsonfileApi.h"
...
OAITypeNotesJsonfileApi::OAITypeNotesJsonfileApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeNotesJsonfileApi::~OAITypeNotesJsonfileApi() {
}

void OAITypeNotesJsonfileApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchNotesJsonfile", defaultConf);
    _serverIndices.insert("searchNotesJsonfile", 0);
}
...
*/
int OAITypeNotesJsonfileApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeNotesJsonfileApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeNotesJsonfileApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeNotesJsonfileApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeNotesJsonfileApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeNotesJsonfileApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeNotesJsonfileApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeNotesJsonfileApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeNotesJsonfileApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeNotesJsonfileApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeNotesJsonfileApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeNotesJsonfileApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeNotesJsonfileApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeNotesJsonfileApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeNotesJsonfileApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeNotesJsonfileApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeNotesJsonfileApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeNotesJsonfileApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeNotesJsonfileApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeNotesJsonfileApi::searchNotesJsonfile(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeNotesJsonfileApi::searchNotesJsonfileCallback);
    connect(this, &OAITypeNotesJsonfileApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeNotesJsonfileApi::searchNotesJsonfileCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchNotesJsonfileSignal();
        Q_EMIT searchNotesJsonfileSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchNotesJsonfileSignalE(error_type, error_str);
        Q_EMIT searchNotesJsonfileSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchNotesJsonfileSignalError(error_type, error_str);
        Q_EMIT searchNotesJsonfileSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeNotesJsonfileApi::tokenAvailable(){
