...
#include "OAITypeBioOntologyAssayApi.h"
...
OAITypeBioOntologyAssayApi::OAITypeBioOntologyAssayApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeBioOntologyAssayApi::~OAITypeBioOntologyAssayApi() {
}

void OAITypeBioOntologyAssayApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchBioOntologyAssay", defaultConf);
    _serverIndices.insert("searchBioOntologyAssay", 0);
}
...
*/
int OAITypeBioOntologyAssayApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeBioOntologyAssayApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeBioOntologyAssayApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeBioOntologyAssayApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeBioOntologyAssayApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeBioOntologyAssayApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeBioOntologyAssayApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeBioOntologyAssayApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeBioOntologyAssayApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeBioOntologyAssayApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioOntologyAssayApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioOntologyAssayApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeBioOntologyAssayApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeBioOntologyAssayApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeBioOntologyAssayApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeBioOntologyAssayApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeBioOntologyAssayApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeBioOntologyAssayApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeBioOntologyAssayApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeBioOntologyAssayApi::searchBioOntologyAssay(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeBioOntologyAssayApi::searchBioOntologyAssayCallback);
    connect(this, &OAITypeBioOntologyAssayApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeBioOntologyAssayApi::searchBioOntologyAssayCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchBioOntologyAssaySignal();
        Q_EMIT searchBioOntologyAssaySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchBioOntologyAssaySignalE(error_type, error_str);
        Q_EMIT searchBioOntologyAssaySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchBioOntologyAssaySignalError(error_type, error_str);
        Q_EMIT searchBioOntologyAssaySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeBioOntologyAssayApi::tokenAvailable(){
