...
OAITypeCdmGridApi::OAITypeCdmGridApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeCdmGridApi::~OAITypeCdmGridApi() {
}

void OAITypeCdmGridApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchCdmGrid", defaultConf);
    _serverIndices.insert("searchCdmGrid", 0);
}
...
*/
int OAITypeCdmGridApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeCdmGridApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeCdmGridApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeCdmGridApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeCdmGridApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeCdmGridApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeCdmGridApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeCdmGridApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeCdmGridApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeCdmGridApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeCdmGridApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeCdmGridApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeCdmGridApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeCdmGridApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeCdmGridApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeCdmGridApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeCdmGridApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeCdmGridApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeCdmGridApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeCdmGridApi::searchCdmGrid(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeCdmGridApi::searchCdmGridCallback);
    connect(this, &OAITypeCdmGridApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeCdmGridApi::searchCdmGridCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchCdmGridSignal();
        Q_EMIT searchCdmGridSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchCdmGridSignalE(error_type, error_str);
        Q_EMIT searchCdmGridSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchCdmGridSignalError(error_type, error_str);
        Q_EMIT searchCdmGridSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeCdmGridApi::tokenAvailable(){
