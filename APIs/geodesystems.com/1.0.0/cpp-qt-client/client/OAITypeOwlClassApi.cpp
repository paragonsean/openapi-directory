...
OAITypeOwlClassApi::OAITypeOwlClassApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeOwlClassApi::~OAITypeOwlClassApi() {
}

void OAITypeOwlClassApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchOwl_class", defaultConf);
    _serverIndices.insert("searchOwl_class", 0);
}
...
*/
int OAITypeOwlClassApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeOwlClassApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeOwlClassApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeOwlClassApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeOwlClassApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeOwlClassApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeOwlClassApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeOwlClassApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeOwlClassApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeOwlClassApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeOwlClassApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeOwlClassApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeOwlClassApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeOwlClassApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeOwlClassApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeOwlClassApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeOwlClassApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeOwlClassApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeOwlClassApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeOwlClassApi::searchOwl_class(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeOwlClassApi::searchOwl_classCallback);
    connect(this, &OAITypeOwlClassApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeOwlClassApi::searchOwl_classCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchOwl_classSignal();
        Q_EMIT searchOwl_classSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchOwl_classSignalE(error_type, error_str);
        Q_EMIT searchOwl_classSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchOwl_classSignalError(error_type, error_str);
        Q_EMIT searchOwl_classSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeOwlClassApi::tokenAvailable(){
