...
#include "OAITypeTypePointTextApi.h"
...
OAITypeTypePointTextApi::OAITypeTypePointTextApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointTextApi::~OAITypeTypePointTextApi() {
}

void OAITypeTypePointTextApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointText", defaultConf);
    _serverIndices.insert("searchTypePointText", 0);
}
...
*/
int OAITypeTypePointTextApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointTextApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointTextApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointTextApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointTextApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointTextApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointTextApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointTextApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointTextApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointTextApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointTextApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointTextApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointTextApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointTextApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointTextApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointTextApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointTextApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointTextApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointTextApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointTextApi::searchTypePointText(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointTextApi::searchTypePointTextCallback);
    connect(this, &OAITypeTypePointTextApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointTextApi::searchTypePointTextCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointTextSignal();
        Q_EMIT searchTypePointTextSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointTextSignalE(error_type, error_str);
        Q_EMIT searchTypePointTextSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointTextSignalError(error_type, error_str);
        Q_EMIT searchTypePointTextSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointTextApi::tokenAvailable(){
