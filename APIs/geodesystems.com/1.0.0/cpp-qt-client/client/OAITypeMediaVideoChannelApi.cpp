...
#include "OAITypeMediaVideoChannelApi.h"
...
OAITypeMediaVideoChannelApi::OAITypeMediaVideoChannelApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeMediaVideoChannelApi::~OAITypeMediaVideoChannelApi() {
}

void OAITypeMediaVideoChannelApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchMediaVideoChannel", defaultConf);
    _serverIndices.insert("searchMediaVideoChannel", 0);
}
...
*/
int OAITypeMediaVideoChannelApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeMediaVideoChannelApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeMediaVideoChannelApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeMediaVideoChannelApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeMediaVideoChannelApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeMediaVideoChannelApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeMediaVideoChannelApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeMediaVideoChannelApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeMediaVideoChannelApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeMediaVideoChannelApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeMediaVideoChannelApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeMediaVideoChannelApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeMediaVideoChannelApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeMediaVideoChannelApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeMediaVideoChannelApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeMediaVideoChannelApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeMediaVideoChannelApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeMediaVideoChannelApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeMediaVideoChannelApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeMediaVideoChannelApi::searchMediaVideoChannel(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeMediaVideoChannelApi::searchMediaVideoChannelCallback);
    connect(this, &OAITypeMediaVideoChannelApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeMediaVideoChannelApi::searchMediaVideoChannelCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchMediaVideoChannelSignal();
        Q_EMIT searchMediaVideoChannelSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchMediaVideoChannelSignalE(error_type, error_str);
        Q_EMIT searchMediaVideoChannelSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchMediaVideoChannelSignalError(error_type, error_str);
        Q_EMIT searchMediaVideoChannelSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeMediaVideoChannelApi::tokenAvailable(){
