...
#include "OAITypeLatlonimageApi.h"
...
OAITypeLatlonimageApi::OAITypeLatlonimageApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeLatlonimageApi::~OAITypeLatlonimageApi() {
}

void OAITypeLatlonimageApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchLatlonimage", defaultConf);
    _serverIndices.insert("searchLatlonimage", 0);
}
...
*/
int OAITypeLatlonimageApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeLatlonimageApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeLatlonimageApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeLatlonimageApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeLatlonimageApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeLatlonimageApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeLatlonimageApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeLatlonimageApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeLatlonimageApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeLatlonimageApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLatlonimageApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLatlonimageApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeLatlonimageApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeLatlonimageApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeLatlonimageApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeLatlonimageApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeLatlonimageApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeLatlonimageApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeLatlonimageApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeLatlonimageApi::searchLatlonimage(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeLatlonimageApi::searchLatlonimageCallback);
    connect(this, &OAITypeLatlonimageApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeLatlonimageApi::searchLatlonimageCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchLatlonimageSignal();
        Q_EMIT searchLatlonimageSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchLatlonimageSignalE(error_type, error_str);
        Q_EMIT searchLatlonimageSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchLatlonimageSignalError(error_type, error_str);
        Q_EMIT searchLatlonimageSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeLatlonimageApi::tokenAvailable(){
