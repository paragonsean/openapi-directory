...
#include "OAITypeTypeEiaCategoryApi.h"
...
OAITypeTypeEiaCategoryApi::OAITypeTypeEiaCategoryApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeEiaCategoryApi::~OAITypeTypeEiaCategoryApi() {
}

void OAITypeTypeEiaCategoryApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeEiaCategory", defaultConf);
    _serverIndices.insert("searchTypeEiaCategory", 0);
}
...
*/
int OAITypeTypeEiaCategoryApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeEiaCategoryApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeEiaCategoryApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeEiaCategoryApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeEiaCategoryApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeEiaCategoryApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeEiaCategoryApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeEiaCategoryApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeEiaCategoryApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeEiaCategoryApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeEiaCategoryApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeEiaCategoryApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeEiaCategoryApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeEiaCategoryApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeEiaCategoryApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeEiaCategoryApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeEiaCategoryApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeEiaCategoryApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeEiaCategoryApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeEiaCategoryApi::searchTypeEiaCategory(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeEiaCategoryApi::searchTypeEiaCategoryCallback);
    connect(this, &OAITypeTypeEiaCategoryApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeEiaCategoryApi::searchTypeEiaCategoryCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeEiaCategorySignal();
        Q_EMIT searchTypeEiaCategorySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeEiaCategorySignalE(error_type, error_str);
        Q_EMIT searchTypeEiaCategorySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeEiaCategorySignalError(error_type, error_str);
        Q_EMIT searchTypeEiaCategorySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeEiaCategoryApi::tokenAvailable(){
