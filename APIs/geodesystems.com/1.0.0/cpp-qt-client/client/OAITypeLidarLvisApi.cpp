...
OAITypeLidarLvisApi::OAITypeLidarLvisApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeLidarLvisApi::~OAITypeLidarLvisApi() {
}

void OAITypeLidarLvisApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchLidarLvis", defaultConf);
    _serverIndices.insert("searchLidarLvis", 0);
}
...
*/
int OAITypeLidarLvisApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeLidarLvisApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeLidarLvisApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeLidarLvisApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeLidarLvisApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeLidarLvisApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeLidarLvisApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeLidarLvisApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeLidarLvisApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeLidarLvisApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLidarLvisApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLidarLvisApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeLidarLvisApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeLidarLvisApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeLidarLvisApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeLidarLvisApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeLidarLvisApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeLidarLvisApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeLidarLvisApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeLidarLvisApi::searchLidarLvis(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeLidarLvisApi::searchLidarLvisCallback);
    connect(this, &OAITypeLidarLvisApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeLidarLvisApi::searchLidarLvisCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchLidarLvisSignal();
        Q_EMIT searchLidarLvisSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchLidarLvisSignalE(error_type, error_str);
        Q_EMIT searchLidarLvisSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchLidarLvisSignalError(error_type, error_str);
        Q_EMIT searchLidarLvisSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeLidarLvisApi::tokenAvailable(){
