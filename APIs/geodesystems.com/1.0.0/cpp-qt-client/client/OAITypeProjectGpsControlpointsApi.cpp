...
#include "OAITypeProjectGpsControlpointsApi.h"
...
OAITypeProjectGpsControlpointsApi::OAITypeProjectGpsControlpointsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectGpsControlpointsApi::~OAITypeProjectGpsControlpointsApi() {
}

void OAITypeProjectGpsControlpointsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectGpsControlpoints", defaultConf);
    _serverIndices.insert("searchProjectGpsControlpoints", 0);
}
...
*/
int OAITypeProjectGpsControlpointsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectGpsControlpointsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectGpsControlpointsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectGpsControlpointsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectGpsControlpointsApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectGpsControlpointsApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectGpsControlpointsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectGpsControlpointsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectGpsControlpointsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectGpsControlpointsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectGpsControlpointsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectGpsControlpointsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectGpsControlpointsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectGpsControlpointsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectGpsControlpointsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectGpsControlpointsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectGpsControlpointsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectGpsControlpointsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectGpsControlpointsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectGpsControlpointsApi::searchProjectGpsControlpoints(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    QString fullPath = QString(_serverConfigs["searchProjectGpsControlpoints"][_serverIndices.value("searchProjectGpsControlpoints")].URL()+"/repository/search/type/project_gps_controlpoints");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectGpsControlpointsApi::searchProjectGpsControlpointsCallback);
    connect(this, &OAITypeProjectGpsControlpointsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectGpsControlpointsApi::searchProjectGpsControlpointsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectGpsControlpointsSignal();
        Q_EMIT searchProjectGpsControlpointsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectGpsControlpointsSignalE(error_type, error_str);
        Q_EMIT searchProjectGpsControlpointsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectGpsControlpointsSignalError(error_type, error_str);
        Q_EMIT searchProjectGpsControlpointsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectGpsControlpointsApi::tokenAvailable(){
