...
#include "OAITypeTypeFredCategoryApi.h"
...
OAITypeTypeFredCategoryApi::OAITypeTypeFredCategoryApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeFredCategoryApi::~OAITypeTypeFredCategoryApi() {
}

void OAITypeTypeFredCategoryApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeFredCategory", defaultConf);
    _serverIndices.insert("searchTypeFredCategory", 0);
}
...
*/
int OAITypeTypeFredCategoryApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeFredCategoryApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeFredCategoryApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeFredCategoryApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeFredCategoryApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeFredCategoryApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeFredCategoryApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeFredCategoryApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeFredCategoryApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeFredCategoryApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeFredCategoryApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeFredCategoryApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeFredCategoryApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeFredCategoryApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeFredCategoryApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeFredCategoryApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeFredCategoryApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeFredCategoryApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeFredCategoryApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeFredCategoryApi::searchTypeFredCategory(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeFredCategoryApi::searchTypeFredCategoryCallback);
    connect(this, &OAITypeTypeFredCategoryApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeFredCategoryApi::searchTypeFredCategoryCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeFredCategorySignal();
        Q_EMIT searchTypeFredCategorySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeFredCategorySignalE(error_type, error_str);
        Q_EMIT searchTypeFredCategorySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeFredCategorySignalError(error_type, error_str);
        Q_EMIT searchTypeFredCategorySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeFredCategoryApi::tokenAvailable(){
