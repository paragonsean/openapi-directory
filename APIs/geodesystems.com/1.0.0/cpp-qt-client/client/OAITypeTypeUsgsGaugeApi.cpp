...
#include "OAITypeTypeUsgsGaugeApi.h"
...
OAITypeTypeUsgsGaugeApi::OAITypeTypeUsgsGaugeApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeUsgsGaugeApi::~OAITypeTypeUsgsGaugeApi() {
}

void OAITypeTypeUsgsGaugeApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeUsgsGauge", defaultConf);
    _serverIndices.insert("searchTypeUsgsGauge", 0);
}
...
*/
int OAITypeTypeUsgsGaugeApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeUsgsGaugeApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeUsgsGaugeApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeUsgsGaugeApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeUsgsGaugeApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeUsgsGaugeApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeUsgsGaugeApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeUsgsGaugeApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeUsgsGaugeApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeUsgsGaugeApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeUsgsGaugeApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeUsgsGaugeApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeUsgsGaugeApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeUsgsGaugeApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeUsgsGaugeApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeUsgsGaugeApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeUsgsGaugeApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeUsgsGaugeApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeUsgsGaugeApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeUsgsGaugeApi::searchTypeUsgsGauge(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeUsgsGaugeApi::searchTypeUsgsGaugeCallback);
    connect(this, &OAITypeTypeUsgsGaugeApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeUsgsGaugeApi::searchTypeUsgsGaugeCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeUsgsGaugeSignal();
        Q_EMIT searchTypeUsgsGaugeSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeUsgsGaugeSignalE(error_type, error_str);
        Q_EMIT searchTypeUsgsGaugeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeUsgsGaugeSignalError(error_type, error_str);
        Q_EMIT searchTypeUsgsGaugeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeUsgsGaugeApi::tokenAvailable(){
