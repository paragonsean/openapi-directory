...
#include "OAITypeTypePointIcebridgeAtmQfitApi.h"
...
OAITypeTypePointIcebridgeAtmQfitApi::OAITypeTypePointIcebridgeAtmQfitApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointIcebridgeAtmQfitApi::~OAITypeTypePointIcebridgeAtmQfitApi() {
}

void OAITypeTypePointIcebridgeAtmQfitApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointIcebridgeAtmQfit", defaultConf);
    _serverIndices.insert("searchTypePointIcebridgeAtmQfit", 0);
}
...
*/
int OAITypeTypePointIcebridgeAtmQfitApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointIcebridgeAtmQfitApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointIcebridgeAtmQfitApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointIcebridgeAtmQfitApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointIcebridgeAtmQfitApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointIcebridgeAtmQfitApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointIcebridgeAtmQfitApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointIcebridgeAtmQfitApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointIcebridgeAtmQfitApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointIcebridgeAtmQfitApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointIcebridgeAtmQfitApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointIcebridgeAtmQfitApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointIcebridgeAtmQfitApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointIcebridgeAtmQfitApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointIcebridgeAtmQfitApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointIcebridgeAtmQfitApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointIcebridgeAtmQfitApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointIcebridgeAtmQfitApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointIcebridgeAtmQfitApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointIcebridgeAtmQfitApi::searchTypePointIcebridgeAtmQfit(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    QString fullPath = QString(_serverConfigs["searchTypePointIcebridgeAtmQfit"][_serverIndices.value("searchTypePointIcebridgeAtmQfit")].URL()+"/repository/search/type/type_point_icebridge_atm_qfit");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointIcebridgeAtmQfitApi::searchTypePointIcebridgeAtmQfitCallback);
    connect(this, &OAITypeTypePointIcebridgeAtmQfitApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointIcebridgeAtmQfitApi::searchTypePointIcebridgeAtmQfitCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointIcebridgeAtmQfitSignal();
        Q_EMIT searchTypePointIcebridgeAtmQfitSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointIcebridgeAtmQfitSignalE(error_type, error_str);
        Q_EMIT searchTypePointIcebridgeAtmQfitSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointIcebridgeAtmQfitSignalError(error_type, error_str);
        Q_EMIT searchTypePointIcebridgeAtmQfitSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointIcebridgeAtmQfitApi::tokenAvailable(){
