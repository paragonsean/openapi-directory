...
#include "OAITypeGadgetsStockApi.h"
...
OAITypeGadgetsStockApi::OAITypeGadgetsStockApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeGadgetsStockApi::~OAITypeGadgetsStockApi() {
}

void OAITypeGadgetsStockApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchGadgetsStock", defaultConf);
    _serverIndices.insert("searchGadgetsStock", 0);
}
...
*/
int OAITypeGadgetsStockApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeGadgetsStockApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeGadgetsStockApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeGadgetsStockApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeGadgetsStockApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeGadgetsStockApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeGadgetsStockApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeGadgetsStockApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeGadgetsStockApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeGadgetsStockApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGadgetsStockApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGadgetsStockApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeGadgetsStockApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeGadgetsStockApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeGadgetsStockApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeGadgetsStockApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeGadgetsStockApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeGadgetsStockApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeGadgetsStockApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeGadgetsStockApi::searchGadgetsStock(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeGadgetsStockApi::searchGadgetsStockCallback);
    connect(this, &OAITypeGadgetsStockApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeGadgetsStockApi::searchGadgetsStockCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchGadgetsStockSignal();
        Q_EMIT searchGadgetsStockSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchGadgetsStockSignalE(error_type, error_str);
        Q_EMIT searchGadgetsStockSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchGadgetsStockSignalError(error_type, error_str);
        Q_EMIT searchGadgetsStockSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeGadgetsStockApi::tokenAvailable(){
