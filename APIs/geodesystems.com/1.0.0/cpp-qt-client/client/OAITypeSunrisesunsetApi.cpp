...
#include "OAITypeSunrisesunsetApi.h"
...
OAITypeSunrisesunsetApi::OAITypeSunrisesunsetApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeSunrisesunsetApi::~OAITypeSunrisesunsetApi() {
}

void OAITypeSunrisesunsetApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchSunrisesunset", defaultConf);
    _serverIndices.insert("searchSunrisesunset", 0);
}
...
*/
int OAITypeSunrisesunsetApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeSunrisesunsetApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeSunrisesunsetApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeSunrisesunsetApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeSunrisesunsetApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeSunrisesunsetApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeSunrisesunsetApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeSunrisesunsetApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeSunrisesunsetApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeSunrisesunsetApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeSunrisesunsetApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeSunrisesunsetApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeSunrisesunsetApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeSunrisesunsetApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeSunrisesunsetApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeSunrisesunsetApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeSunrisesunsetApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeSunrisesunsetApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeSunrisesunsetApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeSunrisesunsetApi::searchSunrisesunset(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeSunrisesunsetApi::searchSunrisesunsetCallback);
    connect(this, &OAITypeSunrisesunsetApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeSunrisesunsetApi::searchSunrisesunsetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchSunrisesunsetSignal();
        Q_EMIT searchSunrisesunsetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchSunrisesunsetSignalE(error_type, error_str);
        Q_EMIT searchSunrisesunsetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchSunrisesunsetSignalError(error_type, error_str);
        Q_EMIT searchSunrisesunsetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeSunrisesunsetApi::tokenAvailable(){
