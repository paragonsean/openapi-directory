...
#ifndef OAI_OAITypeLinkApi_H
#define OAI_OAITypeLinkApi_H
...
class OAITypeLinkApi : public QObject {
    Q_OBJECT

public:
    OAITypeLinkApi(const int timeOut = 0);
    ~OAITypeLinkApi();
...
private:
    ...
    void searchLinkCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void searchLinkSignal();


    void searchLinkSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchLinkSignalError() instead")
    void searchLinkSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchLinkSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use searchLinkSignalErrorFull() instead")
    void searchLinkSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchLinkSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
