...
#include "OAITypeTypeImageAirportApi.h"
...
OAITypeTypeImageAirportApi::OAITypeTypeImageAirportApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeImageAirportApi::~OAITypeTypeImageAirportApi() {
}

void OAITypeTypeImageAirportApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeImageAirport", defaultConf);
    _serverIndices.insert("searchTypeImageAirport", 0);
}
...
*/
int OAITypeTypeImageAirportApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeImageAirportApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeImageAirportApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeImageAirportApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeImageAirportApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeImageAirportApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeImageAirportApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeImageAirportApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeImageAirportApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeImageAirportApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeImageAirportApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeImageAirportApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeImageAirportApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeImageAirportApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeImageAirportApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeImageAirportApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeImageAirportApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeImageAirportApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeImageAirportApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeImageAirportApi::searchTypeImageAirport(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeImageAirportApi::searchTypeImageAirportCallback);
    connect(this, &OAITypeTypeImageAirportApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeImageAirportApi::searchTypeImageAirportCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeImageAirportSignal();
        Q_EMIT searchTypeImageAirportSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeImageAirportSignalE(error_type, error_str);
        Q_EMIT searchTypeImageAirportSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeImageAirportSignalError(error_type, error_str);
        Q_EMIT searchTypeImageAirportSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeImageAirportApi::tokenAvailable(){
