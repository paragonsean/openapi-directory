...
OAITypeGlossaryApi::OAITypeGlossaryApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeGlossaryApi::~OAITypeGlossaryApi() {
}

void OAITypeGlossaryApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchGlossary", defaultConf);
    _serverIndices.insert("searchGlossary", 0);
}
...
*/
int OAITypeGlossaryApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeGlossaryApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeGlossaryApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeGlossaryApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeGlossaryApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeGlossaryApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeGlossaryApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeGlossaryApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeGlossaryApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeGlossaryApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGlossaryApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGlossaryApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeGlossaryApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeGlossaryApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeGlossaryApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeGlossaryApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeGlossaryApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeGlossaryApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeGlossaryApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeGlossaryApi::searchGlossary(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeGlossaryApi::searchGlossaryCallback);
    connect(this, &OAITypeGlossaryApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeGlossaryApi::searchGlossaryCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchGlossarySignal();
        Q_EMIT searchGlossarySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchGlossarySignalE(error_type, error_str);
        Q_EMIT searchGlossarySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchGlossarySignalError(error_type, error_str);
        Q_EMIT searchGlossarySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeGlossaryApi::tokenAvailable(){
