...
#include "OAITypeGeoGeotiffApi.h"
...
OAITypeGeoGeotiffApi::OAITypeGeoGeotiffApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeGeoGeotiffApi::~OAITypeGeoGeotiffApi() {
}

void OAITypeGeoGeotiffApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchGeoGeotiff", defaultConf);
    _serverIndices.insert("searchGeoGeotiff", 0);
}
...
*/
int OAITypeGeoGeotiffApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeGeoGeotiffApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeGeoGeotiffApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeGeoGeotiffApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeGeoGeotiffApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeGeoGeotiffApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeGeoGeotiffApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeGeoGeotiffApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeGeoGeotiffApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeGeoGeotiffApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGeoGeotiffApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGeoGeotiffApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeGeoGeotiffApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeGeoGeotiffApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeGeoGeotiffApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeGeoGeotiffApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeGeoGeotiffApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeGeoGeotiffApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeGeoGeotiffApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeGeoGeotiffApi::searchGeoGeotiff(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeGeoGeotiffApi::searchGeoGeotiffCallback);
    connect(this, &OAITypeGeoGeotiffApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeGeoGeotiffApi::searchGeoGeotiffCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchGeoGeotiffSignal();
        Q_EMIT searchGeoGeotiffSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchGeoGeotiffSignalE(error_type, error_str);
        Q_EMIT searchGeoGeotiffSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchGeoGeotiffSignalError(error_type, error_str);
        Q_EMIT searchGeoGeotiffSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeGeoGeotiffApi::tokenAvailable(){
