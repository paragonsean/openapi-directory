...
#include "OAITypeBeforeafterApi.h"
...
OAITypeBeforeafterApi::OAITypeBeforeafterApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeBeforeafterApi::~OAITypeBeforeafterApi() {
}

void OAITypeBeforeafterApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchBeforeafter", defaultConf);
    _serverIndices.insert("searchBeforeafter", 0);
}
...
*/
int OAITypeBeforeafterApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeBeforeafterApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeBeforeafterApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeBeforeafterApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeBeforeafterApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeBeforeafterApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeBeforeafterApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeBeforeafterApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeBeforeafterApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeBeforeafterApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBeforeafterApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBeforeafterApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeBeforeafterApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeBeforeafterApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeBeforeafterApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeBeforeafterApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeBeforeafterApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeBeforeafterApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeBeforeafterApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeBeforeafterApi::searchBeforeafter(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeBeforeafterApi::searchBeforeafterCallback);
    connect(this, &OAITypeBeforeafterApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeBeforeafterApi::searchBeforeafterCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchBeforeafterSignal();
        Q_EMIT searchBeforeafterSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchBeforeafterSignalE(error_type, error_str);
        Q_EMIT searchBeforeafterSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchBeforeafterSignalError(error_type, error_str);
        Q_EMIT searchBeforeafterSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeBeforeafterApi::tokenAvailable(){
