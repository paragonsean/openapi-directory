...
#include "OAITypeTypeDrilsdownCasestudyApi.h"
...
OAITypeTypeDrilsdownCasestudyApi::OAITypeTypeDrilsdownCasestudyApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeDrilsdownCasestudyApi::~OAITypeTypeDrilsdownCasestudyApi() {
}

void OAITypeTypeDrilsdownCasestudyApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeDrilsdownCasestudy", defaultConf);
    _serverIndices.insert("searchTypeDrilsdownCasestudy", 0);
}
...
*/
int OAITypeTypeDrilsdownCasestudyApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeDrilsdownCasestudyApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeDrilsdownCasestudyApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeDrilsdownCasestudyApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeDrilsdownCasestudyApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeDrilsdownCasestudyApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeDrilsdownCasestudyApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeDrilsdownCasestudyApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeDrilsdownCasestudyApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeDrilsdownCasestudyApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDrilsdownCasestudyApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDrilsdownCasestudyApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeDrilsdownCasestudyApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeDrilsdownCasestudyApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeDrilsdownCasestudyApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeDrilsdownCasestudyApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeDrilsdownCasestudyApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeDrilsdownCasestudyApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeDrilsdownCasestudyApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeDrilsdownCasestudyApi::searchTypeDrilsdownCasestudy(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    QString fullPath = QString(_serverConfigs["searchTypeDrilsdownCasestudy"][_serverIndices.value("searchTypeDrilsdownCasestudy")].URL()+"/repository/search/type/type_drilsdown_casestudy");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeDrilsdownCasestudyApi::searchTypeDrilsdownCasestudyCallback);
    connect(this, &OAITypeTypeDrilsdownCasestudyApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeDrilsdownCasestudyApi::searchTypeDrilsdownCasestudyCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeDrilsdownCasestudySignal();
        Q_EMIT searchTypeDrilsdownCasestudySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeDrilsdownCasestudySignalE(error_type, error_str);
        Q_EMIT searchTypeDrilsdownCasestudySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeDrilsdownCasestudySignalError(error_type, error_str);
        Q_EMIT searchTypeDrilsdownCasestudySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeDrilsdownCasestudyApi::tokenAvailable(){
