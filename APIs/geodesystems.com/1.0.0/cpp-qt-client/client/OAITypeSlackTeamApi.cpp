...
OAITypeSlackTeamApi::OAITypeSlackTeamApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeSlackTeamApi::~OAITypeSlackTeamApi() {
}

void OAITypeSlackTeamApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchSlackTeam", defaultConf);
    _serverIndices.insert("searchSlackTeam", 0);
}
...
*/
int OAITypeSlackTeamApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeSlackTeamApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeSlackTeamApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeSlackTeamApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeSlackTeamApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeSlackTeamApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeSlackTeamApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeSlackTeamApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeSlackTeamApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeSlackTeamApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeSlackTeamApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeSlackTeamApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeSlackTeamApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeSlackTeamApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeSlackTeamApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeSlackTeamApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeSlackTeamApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeSlackTeamApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeSlackTeamApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeSlackTeamApi::searchSlackTeam(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeSlackTeamApi::searchSlackTeamCallback);
    connect(this, &OAITypeSlackTeamApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeSlackTeamApi::searchSlackTeamCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchSlackTeamSignal();
        Q_EMIT searchSlackTeamSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchSlackTeamSignalE(error_type, error_str);
        Q_EMIT searchSlackTeamSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchSlackTeamSignalError(error_type, error_str);
        Q_EMIT searchSlackTeamSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeSlackTeamApi::tokenAvailable(){
