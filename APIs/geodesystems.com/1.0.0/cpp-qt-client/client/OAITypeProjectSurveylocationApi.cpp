...
#include "OAITypeProjectSurveylocationApi.h"
...
OAITypeProjectSurveylocationApi::OAITypeProjectSurveylocationApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectSurveylocationApi::~OAITypeProjectSurveylocationApi() {
}

void OAITypeProjectSurveylocationApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectSurveylocation", defaultConf);
    _serverIndices.insert("searchProjectSurveylocation", 0);
}
...
*/
int OAITypeProjectSurveylocationApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectSurveylocationApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectSurveylocationApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectSurveylocationApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectSurveylocationApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectSurveylocationApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectSurveylocationApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectSurveylocationApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectSurveylocationApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectSurveylocationApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectSurveylocationApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectSurveylocationApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectSurveylocationApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectSurveylocationApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectSurveylocationApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectSurveylocationApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectSurveylocationApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectSurveylocationApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectSurveylocationApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectSurveylocationApi::searchProjectSurveylocation(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectSurveylocationApi::searchProjectSurveylocationCallback);
    connect(this, &OAITypeProjectSurveylocationApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectSurveylocationApi::searchProjectSurveylocationCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectSurveylocationSignal();
        Q_EMIT searchProjectSurveylocationSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectSurveylocationSignalE(error_type, error_str);
        Q_EMIT searchProjectSurveylocationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectSurveylocationSignalError(error_type, error_str);
        Q_EMIT searchProjectSurveylocationSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectSurveylocationApi::tokenAvailable(){
