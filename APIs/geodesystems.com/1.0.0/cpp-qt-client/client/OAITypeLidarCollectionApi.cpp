...
#include "OAITypeLidarCollectionApi.h"
...
OAITypeLidarCollectionApi::OAITypeLidarCollectionApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeLidarCollectionApi::~OAITypeLidarCollectionApi() {
}

void OAITypeLidarCollectionApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchLidarCollection", defaultConf);
    _serverIndices.insert("searchLidarCollection", 0);
}
...
*/
int OAITypeLidarCollectionApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeLidarCollectionApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeLidarCollectionApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeLidarCollectionApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeLidarCollectionApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeLidarCollectionApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeLidarCollectionApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeLidarCollectionApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeLidarCollectionApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeLidarCollectionApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLidarCollectionApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLidarCollectionApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeLidarCollectionApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeLidarCollectionApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeLidarCollectionApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeLidarCollectionApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeLidarCollectionApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeLidarCollectionApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeLidarCollectionApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeLidarCollectionApi::searchLidarCollection(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeLidarCollectionApi::searchLidarCollectionCallback);
    connect(this, &OAITypeLidarCollectionApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeLidarCollectionApi::searchLidarCollectionCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchLidarCollectionSignal();
        Q_EMIT searchLidarCollectionSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchLidarCollectionSignalE(error_type, error_str);
        Q_EMIT searchLidarCollectionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchLidarCollectionSignalError(error_type, error_str);
        Q_EMIT searchLidarCollectionSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeLidarCollectionApi::tokenAvailable(){
