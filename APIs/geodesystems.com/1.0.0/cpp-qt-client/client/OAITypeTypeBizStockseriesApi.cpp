...
#include "OAITypeTypeBizStockseriesApi.h"
...
OAITypeTypeBizStockseriesApi::OAITypeTypeBizStockseriesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeBizStockseriesApi::~OAITypeTypeBizStockseriesApi() {
}

void OAITypeTypeBizStockseriesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeBizStockseries", defaultConf);
    _serverIndices.insert("searchTypeBizStockseries", 0);
}
...
*/
int OAITypeTypeBizStockseriesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeBizStockseriesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeBizStockseriesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeBizStockseriesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeBizStockseriesApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeBizStockseriesApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeBizStockseriesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeBizStockseriesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeBizStockseriesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeBizStockseriesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeBizStockseriesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeBizStockseriesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeBizStockseriesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeBizStockseriesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeBizStockseriesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeBizStockseriesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeBizStockseriesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeBizStockseriesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeBizStockseriesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeBizStockseriesApi::searchTypeBizStockseries(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeBizStockseriesApi::searchTypeBizStockseriesCallback);
    connect(this, &OAITypeTypeBizStockseriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeBizStockseriesApi::searchTypeBizStockseriesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeBizStockseriesSignal();
        Q_EMIT searchTypeBizStockseriesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeBizStockseriesSignalE(error_type, error_str);
        Q_EMIT searchTypeBizStockseriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeBizStockseriesSignalError(error_type, error_str);
        Q_EMIT searchTypeBizStockseriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeBizStockseriesApi::tokenAvailable(){
