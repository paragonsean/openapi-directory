...
#include "OAITypePasteitentryApi.h"
...
OAITypePasteitentryApi::OAITypePasteitentryApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypePasteitentryApi::~OAITypePasteitentryApi() {
}

void OAITypePasteitentryApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchPasteitentry", defaultConf);
    _serverIndices.insert("searchPasteitentry", 0);
}
...
*/
int OAITypePasteitentryApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypePasteitentryApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypePasteitentryApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypePasteitentryApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypePasteitentryApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypePasteitentryApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypePasteitentryApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypePasteitentryApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypePasteitentryApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypePasteitentryApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypePasteitentryApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypePasteitentryApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypePasteitentryApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypePasteitentryApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypePasteitentryApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypePasteitentryApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypePasteitentryApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypePasteitentryApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypePasteitentryApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypePasteitentryApi::searchPasteitentry(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypePasteitentryApi::searchPasteitentryCallback);
    connect(this, &OAITypePasteitentryApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypePasteitentryApi::searchPasteitentryCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchPasteitentrySignal();
        Q_EMIT searchPasteitentrySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchPasteitentrySignalE(error_type, error_str);
        Q_EMIT searchPasteitentrySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchPasteitentrySignalError(error_type, error_str);
        Q_EMIT searchPasteitentrySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypePasteitentryApi::tokenAvailable(){
