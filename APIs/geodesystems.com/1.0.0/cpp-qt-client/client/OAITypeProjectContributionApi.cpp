...
#include "OAITypeProjectContributionApi.h"
...
OAITypeProjectContributionApi::OAITypeProjectContributionApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectContributionApi::~OAITypeProjectContributionApi() {
}

void OAITypeProjectContributionApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectContribution", defaultConf);
    _serverIndices.insert("searchProjectContribution", 0);
}
...
*/
int OAITypeProjectContributionApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectContributionApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectContributionApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectContributionApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectContributionApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectContributionApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectContributionApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectContributionApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectContributionApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectContributionApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectContributionApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectContributionApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectContributionApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectContributionApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectContributionApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectContributionApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectContributionApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectContributionApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectContributionApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectContributionApi::searchProjectContribution(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectContributionApi::searchProjectContributionCallback);
    connect(this, &OAITypeProjectContributionApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectContributionApi::searchProjectContributionCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectContributionSignal();
        Q_EMIT searchProjectContributionSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectContributionSignalE(error_type, error_str);
        Q_EMIT searchProjectContributionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectContributionSignalError(error_type, error_str);
        Q_EMIT searchProjectContributionSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectContributionApi::tokenAvailable(){
