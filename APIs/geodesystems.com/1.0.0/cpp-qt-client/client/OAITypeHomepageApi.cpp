...
OAITypeHomepageApi::OAITypeHomepageApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeHomepageApi::~OAITypeHomepageApi() {
}

void OAITypeHomepageApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchHomepage", defaultConf);
    _serverIndices.insert("searchHomepage", 0);
}
...
*/
int OAITypeHomepageApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeHomepageApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeHomepageApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeHomepageApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeHomepageApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeHomepageApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeHomepageApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeHomepageApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeHomepageApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeHomepageApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeHomepageApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeHomepageApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeHomepageApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeHomepageApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeHomepageApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeHomepageApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeHomepageApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeHomepageApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeHomepageApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeHomepageApi::searchHomepage(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeHomepageApi::searchHomepageCallback);
    connect(this, &OAITypeHomepageApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeHomepageApi::searchHomepageCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchHomepageSignal();
        Q_EMIT searchHomepageSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchHomepageSignalE(error_type, error_str);
        Q_EMIT searchHomepageSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchHomepageSignalError(error_type, error_str);
        Q_EMIT searchHomepageSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeHomepageApi::tokenAvailable(){
