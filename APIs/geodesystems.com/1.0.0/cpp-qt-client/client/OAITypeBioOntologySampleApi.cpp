...
#include "OAITypeBioOntologySampleApi.h"
...
OAITypeBioOntologySampleApi::OAITypeBioOntologySampleApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeBioOntologySampleApi::~OAITypeBioOntologySampleApi() {
}

void OAITypeBioOntologySampleApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchBioOntologySample", defaultConf);
    _serverIndices.insert("searchBioOntologySample", 0);
}
...
*/
int OAITypeBioOntologySampleApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeBioOntologySampleApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeBioOntologySampleApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeBioOntologySampleApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeBioOntologySampleApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeBioOntologySampleApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeBioOntologySampleApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeBioOntologySampleApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeBioOntologySampleApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeBioOntologySampleApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioOntologySampleApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioOntologySampleApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeBioOntologySampleApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeBioOntologySampleApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeBioOntologySampleApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeBioOntologySampleApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeBioOntologySampleApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeBioOntologySampleApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeBioOntologySampleApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeBioOntologySampleApi::searchBioOntologySample(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeBioOntologySampleApi::searchBioOntologySampleCallback);
    connect(this, &OAITypeBioOntologySampleApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeBioOntologySampleApi::searchBioOntologySampleCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchBioOntologySampleSignal();
        Q_EMIT searchBioOntologySampleSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchBioOntologySampleSignalE(error_type, error_str);
        Q_EMIT searchBioOntologySampleSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchBioOntologySampleSignalError(error_type, error_str);
        Q_EMIT searchBioOntologySampleSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeBioOntologySampleApi::tokenAvailable(){
