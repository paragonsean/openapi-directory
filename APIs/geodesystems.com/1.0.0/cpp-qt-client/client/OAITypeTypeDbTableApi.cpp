...
#include "OAITypeTypeDbTableApi.h"
...
OAITypeTypeDbTableApi::OAITypeTypeDbTableApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeDbTableApi::~OAITypeTypeDbTableApi() {
}

void OAITypeTypeDbTableApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeDbTable", defaultConf);
    _serverIndices.insert("searchTypeDbTable", 0);
}
...
*/
int OAITypeTypeDbTableApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeDbTableApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeDbTableApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeDbTableApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeDbTableApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeDbTableApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeDbTableApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeDbTableApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeDbTableApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeDbTableApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDbTableApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDbTableApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeDbTableApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeDbTableApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeDbTableApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeDbTableApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeDbTableApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeDbTableApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeDbTableApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeDbTableApi::searchTypeDbTable(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeDbTableApi::searchTypeDbTableCallback);
    connect(this, &OAITypeTypeDbTableApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeDbTableApi::searchTypeDbTableCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeDbTableSignal();
        Q_EMIT searchTypeDbTableSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeDbTableSignalE(error_type, error_str);
        Q_EMIT searchTypeDbTableSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeDbTableSignalError(error_type, error_str);
        Q_EMIT searchTypeDbTableSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeDbTableApi::tokenAvailable(){
