...
#include "OAITypeCommunityDatahubApi.h"
...
OAITypeCommunityDatahubApi::OAITypeCommunityDatahubApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeCommunityDatahubApi::~OAITypeCommunityDatahubApi() {
}

void OAITypeCommunityDatahubApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchCommunityDatahub", defaultConf);
    _serverIndices.insert("searchCommunityDatahub", 0);
}
...
*/
int OAITypeCommunityDatahubApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeCommunityDatahubApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeCommunityDatahubApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeCommunityDatahubApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeCommunityDatahubApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeCommunityDatahubApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeCommunityDatahubApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeCommunityDatahubApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeCommunityDatahubApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeCommunityDatahubApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeCommunityDatahubApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeCommunityDatahubApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeCommunityDatahubApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeCommunityDatahubApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeCommunityDatahubApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeCommunityDatahubApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeCommunityDatahubApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeCommunityDatahubApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeCommunityDatahubApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeCommunityDatahubApi::searchCommunityDatahub(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeCommunityDatahubApi::searchCommunityDatahubCallback);
    connect(this, &OAITypeCommunityDatahubApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeCommunityDatahubApi::searchCommunityDatahubCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchCommunityDatahubSignal();
        Q_EMIT searchCommunityDatahubSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchCommunityDatahubSignalE(error_type, error_str);
        Q_EMIT searchCommunityDatahubSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchCommunityDatahubSignalError(error_type, error_str);
        Q_EMIT searchCommunityDatahubSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeCommunityDatahubApi::tokenAvailable(){
