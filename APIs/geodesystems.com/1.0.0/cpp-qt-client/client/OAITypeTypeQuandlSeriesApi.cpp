...
#include "OAITypeTypeQuandlSeriesApi.h"
...
OAITypeTypeQuandlSeriesApi::OAITypeTypeQuandlSeriesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeQuandlSeriesApi::~OAITypeTypeQuandlSeriesApi() {
}

void OAITypeTypeQuandlSeriesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeQuandlSeries", defaultConf);
    _serverIndices.insert("searchTypeQuandlSeries", 0);
}
...
*/
int OAITypeTypeQuandlSeriesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeQuandlSeriesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeQuandlSeriesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeQuandlSeriesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeQuandlSeriesApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeQuandlSeriesApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeQuandlSeriesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeQuandlSeriesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeQuandlSeriesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeQuandlSeriesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeQuandlSeriesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeQuandlSeriesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeQuandlSeriesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeQuandlSeriesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeQuandlSeriesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeQuandlSeriesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeQuandlSeriesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeQuandlSeriesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeQuandlSeriesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeQuandlSeriesApi::searchTypeQuandlSeries(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeQuandlSeriesApi::searchTypeQuandlSeriesCallback);
    connect(this, &OAITypeTypeQuandlSeriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeQuandlSeriesApi::searchTypeQuandlSeriesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeQuandlSeriesSignal();
        Q_EMIT searchTypeQuandlSeriesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeQuandlSeriesSignalE(error_type, error_str);
        Q_EMIT searchTypeQuandlSeriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeQuandlSeriesSignalError(error_type, error_str);
        Q_EMIT searchTypeQuandlSeriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeQuandlSeriesApi::tokenAvailable(){
