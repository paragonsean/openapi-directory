...
#include "OAITypeProjectTermApi.h"
...
OAITypeProjectTermApi::OAITypeProjectTermApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectTermApi::~OAITypeProjectTermApi() {
}

void OAITypeProjectTermApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectTerm", defaultConf);
    _serverIndices.insert("searchProjectTerm", 0);
}
...
*/
int OAITypeProjectTermApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectTermApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectTermApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectTermApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectTermApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectTermApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectTermApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectTermApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectTermApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectTermApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectTermApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectTermApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectTermApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectTermApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectTermApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectTermApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectTermApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectTermApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectTermApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectTermApi::searchProjectTerm(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_project_term_value) {
    QString fullPath = QString(_serverConfigs["searchProjectTerm"][_serverIndices.value("searchProjectTerm")].URL()+"/repository/search/type/project_term");
    ...
    if (search_project_term_value.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.project_term.value", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.project_term.value")).append(querySuffix).append(QUrl::toPercentEncoding(search_project_term_value.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectTermApi::searchProjectTermCallback);
    connect(this, &OAITypeProjectTermApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectTermApi::searchProjectTermCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectTermSignal();
        Q_EMIT searchProjectTermSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectTermSignalE(error_type, error_str);
        Q_EMIT searchProjectTermSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectTermSignalError(error_type, error_str);
        Q_EMIT searchProjectTermSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectTermApi::tokenAvailable(){
