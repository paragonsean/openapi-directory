...
#include "OAITypeProjectDeploymentApi.h"
...
OAITypeProjectDeploymentApi::OAITypeProjectDeploymentApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectDeploymentApi::~OAITypeProjectDeploymentApi() {
}

void OAITypeProjectDeploymentApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectDeployment", defaultConf);
    _serverIndices.insert("searchProjectDeployment", 0);
}
...
*/
int OAITypeProjectDeploymentApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectDeploymentApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectDeploymentApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectDeploymentApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectDeploymentApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectDeploymentApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectDeploymentApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectDeploymentApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectDeploymentApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectDeploymentApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectDeploymentApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectDeploymentApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectDeploymentApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectDeploymentApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectDeploymentApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectDeploymentApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectDeploymentApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectDeploymentApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectDeploymentApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectDeploymentApi::searchProjectDeployment(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectDeploymentApi::searchProjectDeploymentCallback);
    connect(this, &OAITypeProjectDeploymentApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectDeploymentApi::searchProjectDeploymentCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectDeploymentSignal();
        Q_EMIT searchProjectDeploymentSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectDeploymentSignalE(error_type, error_str);
        Q_EMIT searchProjectDeploymentSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectDeploymentSignalError(error_type, error_str);
        Q_EMIT searchProjectDeploymentSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectDeploymentApi::tokenAvailable(){
