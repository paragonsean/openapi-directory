...
#ifndef OAI_OAITypeFileApi_H
#define OAI_OAITypeFileApi_H
...
class OAITypeFileApi : public QObject {
    Q_OBJECT

public:
    OAITypeFileApi(const int timeOut = 0);
    ~OAITypeFileApi();
...
private:
    ...
    void searchFileCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void searchFileSignal();


    void searchFileSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchFileSignalError() instead")
    void searchFileSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchFileSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use searchFileSignalErrorFull() instead")
    void searchFileSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchFileSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
