...
#include "OAITypeMediaImageloopApi.h"
...
OAITypeMediaImageloopApi::OAITypeMediaImageloopApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeMediaImageloopApi::~OAITypeMediaImageloopApi() {
}

void OAITypeMediaImageloopApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchMediaImageloop", defaultConf);
    _serverIndices.insert("searchMediaImageloop", 0);
}
...
*/
int OAITypeMediaImageloopApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeMediaImageloopApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeMediaImageloopApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeMediaImageloopApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeMediaImageloopApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeMediaImageloopApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeMediaImageloopApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeMediaImageloopApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeMediaImageloopApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeMediaImageloopApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeMediaImageloopApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeMediaImageloopApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeMediaImageloopApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeMediaImageloopApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeMediaImageloopApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeMediaImageloopApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeMediaImageloopApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeMediaImageloopApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeMediaImageloopApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeMediaImageloopApi::searchMediaImageloop(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeMediaImageloopApi::searchMediaImageloopCallback);
    connect(this, &OAITypeMediaImageloopApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeMediaImageloopApi::searchMediaImageloopCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchMediaImageloopSignal();
        Q_EMIT searchMediaImageloopSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchMediaImageloopSignalE(error_type, error_str);
        Q_EMIT searchMediaImageloopSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchMediaImageloopSignalError(error_type, error_str);
        Q_EMIT searchMediaImageloopSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeMediaImageloopApi::tokenAvailable(){
