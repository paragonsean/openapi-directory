...
#include "OAITypePythonNotebookApi.h"
...
OAITypePythonNotebookApi::OAITypePythonNotebookApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypePythonNotebookApi::~OAITypePythonNotebookApi() {
}

void OAITypePythonNotebookApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchPythonNotebook", defaultConf);
    _serverIndices.insert("searchPythonNotebook", 0);
}
...
*/
int OAITypePythonNotebookApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypePythonNotebookApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypePythonNotebookApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypePythonNotebookApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypePythonNotebookApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypePythonNotebookApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypePythonNotebookApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypePythonNotebookApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypePythonNotebookApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypePythonNotebookApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypePythonNotebookApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypePythonNotebookApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypePythonNotebookApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypePythonNotebookApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypePythonNotebookApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypePythonNotebookApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypePythonNotebookApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypePythonNotebookApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypePythonNotebookApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypePythonNotebookApi::searchPythonNotebook(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypePythonNotebookApi::searchPythonNotebookCallback);
    connect(this, &OAITypePythonNotebookApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypePythonNotebookApi::searchPythonNotebookCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchPythonNotebookSignal();
        Q_EMIT searchPythonNotebookSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchPythonNotebookSignalE(error_type, error_str);
        Q_EMIT searchPythonNotebookSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchPythonNotebookSignalError(error_type, error_str);
        Q_EMIT searchPythonNotebookSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypePythonNotebookApi::tokenAvailable(){
