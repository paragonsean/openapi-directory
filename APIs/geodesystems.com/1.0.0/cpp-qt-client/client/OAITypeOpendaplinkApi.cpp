...
#include "OAITypeOpendaplinkApi.h"
...
OAITypeOpendaplinkApi::OAITypeOpendaplinkApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeOpendaplinkApi::~OAITypeOpendaplinkApi() {
}

void OAITypeOpendaplinkApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchOpendaplink", defaultConf);
    _serverIndices.insert("searchOpendaplink", 0);
}
...
*/
int OAITypeOpendaplinkApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeOpendaplinkApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeOpendaplinkApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeOpendaplinkApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeOpendaplinkApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeOpendaplinkApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeOpendaplinkApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeOpendaplinkApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeOpendaplinkApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeOpendaplinkApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeOpendaplinkApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeOpendaplinkApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeOpendaplinkApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeOpendaplinkApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeOpendaplinkApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeOpendaplinkApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeOpendaplinkApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeOpendaplinkApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeOpendaplinkApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeOpendaplinkApi::searchOpendaplink(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeOpendaplinkApi::searchOpendaplinkCallback);
    connect(this, &OAITypeOpendaplinkApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeOpendaplinkApi::searchOpendaplinkCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchOpendaplinkSignal();
        Q_EMIT searchOpendaplinkSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchOpendaplinkSignalE(error_type, error_str);
        Q_EMIT searchOpendaplinkSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchOpendaplinkSignalError(error_type, error_str);
        Q_EMIT searchOpendaplinkSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeOpendaplinkApi::tokenAvailable(){
