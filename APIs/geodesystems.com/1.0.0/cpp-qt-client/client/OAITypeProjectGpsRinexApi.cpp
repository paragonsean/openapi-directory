...
#include "OAITypeProjectGpsRinexApi.h"
...
OAITypeProjectGpsRinexApi::OAITypeProjectGpsRinexApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectGpsRinexApi::~OAITypeProjectGpsRinexApi() {
}

void OAITypeProjectGpsRinexApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectGpsRinex", defaultConf);
    _serverIndices.insert("searchProjectGpsRinex", 0);
}
...
*/
int OAITypeProjectGpsRinexApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectGpsRinexApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectGpsRinexApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectGpsRinexApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectGpsRinexApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectGpsRinexApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectGpsRinexApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectGpsRinexApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectGpsRinexApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectGpsRinexApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectGpsRinexApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectGpsRinexApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectGpsRinexApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectGpsRinexApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectGpsRinexApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectGpsRinexApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectGpsRinexApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectGpsRinexApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectGpsRinexApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectGpsRinexApi::searchProjectGpsRinex(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectGpsRinexApi::searchProjectGpsRinexCallback);
    connect(this, &OAITypeProjectGpsRinexApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectGpsRinexApi::searchProjectGpsRinexCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectGpsRinexSignal();
        Q_EMIT searchProjectGpsRinexSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectGpsRinexSignalE(error_type, error_str);
        Q_EMIT searchProjectGpsRinexSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectGpsRinexSignalError(error_type, error_str);
        Q_EMIT searchProjectGpsRinexSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectGpsRinexApi::tokenAvailable(){
