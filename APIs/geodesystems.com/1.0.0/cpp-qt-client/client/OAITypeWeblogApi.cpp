...
OAITypeWeblogApi::OAITypeWeblogApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeWeblogApi::~OAITypeWeblogApi() {
}

void OAITypeWeblogApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchWeblog", defaultConf);
    _serverIndices.insert("searchWeblog", 0);
}
...
*/
int OAITypeWeblogApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeWeblogApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeWeblogApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeWeblogApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeWeblogApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeWeblogApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeWeblogApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeWeblogApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeWeblogApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeWeblogApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeWeblogApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeWeblogApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeWeblogApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeWeblogApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeWeblogApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeWeblogApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeWeblogApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeWeblogApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeWeblogApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeWeblogApi::searchWeblog(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeWeblogApi::searchWeblogCallback);
    connect(this, &OAITypeWeblogApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeWeblogApi::searchWeblogCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchWeblogSignal();
        Q_EMIT searchWeblogSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchWeblogSignalE(error_type, error_str);
        Q_EMIT searchWeblogSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchWeblogSignalError(error_type, error_str);
        Q_EMIT searchWeblogSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeWeblogApi::tokenAvailable(){
