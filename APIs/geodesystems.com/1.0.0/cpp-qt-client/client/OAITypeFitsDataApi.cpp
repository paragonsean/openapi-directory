...
OAITypeFitsDataApi::OAITypeFitsDataApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeFitsDataApi::~OAITypeFitsDataApi() {
}

void OAITypeFitsDataApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchFitsData", defaultConf);
    _serverIndices.insert("searchFitsData", 0);
}
...
*/
int OAITypeFitsDataApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeFitsDataApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeFitsDataApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeFitsDataApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeFitsDataApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeFitsDataApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeFitsDataApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeFitsDataApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeFitsDataApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeFitsDataApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeFitsDataApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeFitsDataApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeFitsDataApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeFitsDataApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeFitsDataApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeFitsDataApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeFitsDataApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeFitsDataApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeFitsDataApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeFitsDataApi::searchFitsData(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_fits_data_origin, const ::OpenAPI::OptionalParam<QString> &search_fits_data_telescope, const ::OpenAPI::OptionalParam<QString> &search_fits_data_instrument) {
    QString fullPath = QString(_serverConfigs["searchFitsData"][_serverIndices.value("searchFitsData")].URL()+"/repository/search/type/fits_data");
    ...
    if (search_fits_data_origin.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.fits_data.origin", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.fits_data.origin")).append(querySuffix).append(QUrl::toPercentEncoding(search_fits_data_origin.stringValue()));
    }
    if (search_fits_data_telescope.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.fits_data.telescope", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.fits_data.telescope")).append(querySuffix).append(QUrl::toPercentEncoding(search_fits_data_telescope.stringValue()));
    }
    if (search_fits_data_instrument.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.fits_data.instrument", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.fits_data.instrument")).append(querySuffix).append(QUrl::toPercentEncoding(search_fits_data_instrument.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeFitsDataApi::searchFitsDataCallback);
    connect(this, &OAITypeFitsDataApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeFitsDataApi::searchFitsDataCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchFitsDataSignal();
        Q_EMIT searchFitsDataSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchFitsDataSignalE(error_type, error_str);
        Q_EMIT searchFitsDataSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchFitsDataSignalError(error_type, error_str);
        Q_EMIT searchFitsDataSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeFitsDataApi::tokenAvailable(){
