...
#include "OAITypeTypeEsriGeometryserverApi.h"
...
OAITypeTypeEsriGeometryserverApi::OAITypeTypeEsriGeometryserverApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeEsriGeometryserverApi::~OAITypeTypeEsriGeometryserverApi() {
}

void OAITypeTypeEsriGeometryserverApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeEsriGeometryserver", defaultConf);
    _serverIndices.insert("searchTypeEsriGeometryserver", 0);
}
...
*/
int OAITypeTypeEsriGeometryserverApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeEsriGeometryserverApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeEsriGeometryserverApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeEsriGeometryserverApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeEsriGeometryserverApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeEsriGeometryserverApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeEsriGeometryserverApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeEsriGeometryserverApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeEsriGeometryserverApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeEsriGeometryserverApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeEsriGeometryserverApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeEsriGeometryserverApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeEsriGeometryserverApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeEsriGeometryserverApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeEsriGeometryserverApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeEsriGeometryserverApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeEsriGeometryserverApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeEsriGeometryserverApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeEsriGeometryserverApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeEsriGeometryserverApi::searchTypeEsriGeometryserver(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    QString fullPath = QString(_serverConfigs["searchTypeEsriGeometryserver"][_serverIndices.value("searchTypeEsriGeometryserver")].URL()+"/repository/search/type/type_esri_geometryserver");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeEsriGeometryserverApi::searchTypeEsriGeometryserverCallback);
    connect(this, &OAITypeTypeEsriGeometryserverApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeEsriGeometryserverApi::searchTypeEsriGeometryserverCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeEsriGeometryserverSignal();
        Q_EMIT searchTypeEsriGeometryserverSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeEsriGeometryserverSignalE(error_type, error_str);
        Q_EMIT searchTypeEsriGeometryserverSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeEsriGeometryserverSignalError(error_type, error_str);
        Q_EMIT searchTypeEsriGeometryserverSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeEsriGeometryserverApi::tokenAvailable(){
