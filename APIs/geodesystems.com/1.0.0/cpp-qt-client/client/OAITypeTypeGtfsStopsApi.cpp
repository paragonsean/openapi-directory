...
#include "OAITypeTypeGtfsStopsApi.h"
...
OAITypeTypeGtfsStopsApi::OAITypeTypeGtfsStopsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeGtfsStopsApi::~OAITypeTypeGtfsStopsApi() {
}

void OAITypeTypeGtfsStopsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeGtfsStops", defaultConf);
    _serverIndices.insert("searchTypeGtfsStops", 0);
}
...
*/
int OAITypeTypeGtfsStopsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeGtfsStopsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeGtfsStopsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeGtfsStopsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeGtfsStopsApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeGtfsStopsApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeGtfsStopsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeGtfsStopsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeGtfsStopsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeGtfsStopsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeGtfsStopsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeGtfsStopsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeGtfsStopsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeGtfsStopsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeGtfsStopsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeGtfsStopsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeGtfsStopsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeGtfsStopsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeGtfsStopsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeGtfsStopsApi::searchTypeGtfsStops(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeGtfsStopsApi::searchTypeGtfsStopsCallback);
    connect(this, &OAITypeTypeGtfsStopsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeGtfsStopsApi::searchTypeGtfsStopsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeGtfsStopsSignal();
        Q_EMIT searchTypeGtfsStopsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeGtfsStopsSignalE(error_type, error_str);
        Q_EMIT searchTypeGtfsStopsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeGtfsStopsSignalError(error_type, error_str);
        Q_EMIT searchTypeGtfsStopsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeGtfsStopsApi::tokenAvailable(){
