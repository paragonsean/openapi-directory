...
#ifndef OAI_OAITypeBioSamApi_H
#define OAI_OAITypeBioSamApi_H
...
class OAITypeBioSamApi : public QObject {
    Q_OBJECT

public:
    OAITypeBioSamApi(const int timeOut = 0);
    ~OAITypeBioSamApi();
...
private:
    ...
    void searchBioSamCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void searchBioSamSignal();


    void searchBioSamSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchBioSamSignalError() instead")
    void searchBioSamSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchBioSamSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use searchBioSamSignalErrorFull() instead")
    void searchBioSamSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchBioSamSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
