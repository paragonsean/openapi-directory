...
#include "OAITypeTypeMbCollectionApi.h"
...
OAITypeTypeMbCollectionApi::OAITypeTypeMbCollectionApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeMbCollectionApi::~OAITypeTypeMbCollectionApi() {
}

void OAITypeTypeMbCollectionApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeMbCollection", defaultConf);
    _serverIndices.insert("searchTypeMbCollection", 0);
}
...
*/
int OAITypeTypeMbCollectionApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeMbCollectionApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeMbCollectionApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeMbCollectionApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeMbCollectionApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeMbCollectionApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeMbCollectionApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeMbCollectionApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeMbCollectionApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeMbCollectionApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeMbCollectionApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeMbCollectionApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeMbCollectionApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeMbCollectionApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeMbCollectionApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeMbCollectionApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeMbCollectionApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeMbCollectionApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeMbCollectionApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeMbCollectionApi::searchTypeMbCollection(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeMbCollectionApi::searchTypeMbCollectionCallback);
    connect(this, &OAITypeTypeMbCollectionApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeMbCollectionApi::searchTypeMbCollectionCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeMbCollectionSignal();
        Q_EMIT searchTypeMbCollectionSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeMbCollectionSignalE(error_type, error_str);
        Q_EMIT searchTypeMbCollectionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeMbCollectionSignalError(error_type, error_str);
        Q_EMIT searchTypeMbCollectionSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeMbCollectionApi::tokenAvailable(){
