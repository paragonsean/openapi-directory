...
#ifndef OAI_OAITypeAnyApi_H
#define OAI_OAITypeAnyApi_H
...
class OAITypeAnyApi : public QObject {
    Q_OBJECT

public:
    OAITypeAnyApi(const int timeOut = 0);
    ~OAITypeAnyApi();
...
private:
    ...
    void searchAnyCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void searchAnySignal();


    void searchAnySignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchAnySignalError() instead")
    void searchAnySignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchAnySignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use searchAnySignalErrorFull() instead")
    void searchAnySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchAnySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
