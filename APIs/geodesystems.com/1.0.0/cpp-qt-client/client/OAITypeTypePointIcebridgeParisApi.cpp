...
#include "OAITypeTypePointIcebridgeParisApi.h"
...
OAITypeTypePointIcebridgeParisApi::OAITypeTypePointIcebridgeParisApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointIcebridgeParisApi::~OAITypeTypePointIcebridgeParisApi() {
}

void OAITypeTypePointIcebridgeParisApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointIcebridgeParis", defaultConf);
    _serverIndices.insert("searchTypePointIcebridgeParis", 0);
}
...
*/
int OAITypeTypePointIcebridgeParisApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointIcebridgeParisApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointIcebridgeParisApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointIcebridgeParisApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointIcebridgeParisApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointIcebridgeParisApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointIcebridgeParisApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointIcebridgeParisApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointIcebridgeParisApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointIcebridgeParisApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointIcebridgeParisApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointIcebridgeParisApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointIcebridgeParisApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointIcebridgeParisApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointIcebridgeParisApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointIcebridgeParisApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointIcebridgeParisApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointIcebridgeParisApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointIcebridgeParisApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointIcebridgeParisApi::searchTypePointIcebridgeParis(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    QString fullPath = QString(_serverConfigs["searchTypePointIcebridgeParis"][_serverIndices.value("searchTypePointIcebridgeParis")].URL()+"/repository/search/type/type_point_icebridge_paris");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointIcebridgeParisApi::searchTypePointIcebridgeParisCallback);
    connect(this, &OAITypeTypePointIcebridgeParisApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointIcebridgeParisApi::searchTypePointIcebridgeParisCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointIcebridgeParisSignal();
        Q_EMIT searchTypePointIcebridgeParisSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointIcebridgeParisSignalE(error_type, error_str);
        Q_EMIT searchTypePointIcebridgeParisSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointIcebridgeParisSignalError(error_type, error_str);
        Q_EMIT searchTypePointIcebridgeParisSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointIcebridgeParisApi::tokenAvailable(){
