...
#include "OAITypeTypePointIcebridgeMccordsIrmcr2Api.h"
...
OAITypeTypePointIcebridgeMccordsIrmcr2Api::OAITypeTypePointIcebridgeMccordsIrmcr2Api(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointIcebridgeMccordsIrmcr2Api::~OAITypeTypePointIcebridgeMccordsIrmcr2Api() {
}

void OAITypeTypePointIcebridgeMccordsIrmcr2Api::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointIcebridgeMccordsIrmcr2", defaultConf);
    _serverIndices.insert("searchTypePointIcebridgeMccordsIrmcr2", 0);
}
...
*/
int OAITypeTypePointIcebridgeMccordsIrmcr2Api::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointIcebridgeMccordsIrmcr2Api::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointIcebridgeMccordsIrmcr2Api::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointIcebridgeMccordsIrmcr2Api::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointIcebridgeMccordsIrmcr2Api::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointIcebridgeMccordsIrmcr2Api::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointIcebridgeMccordsIrmcr2Api::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointIcebridgeMccordsIrmcr2Api::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointIcebridgeMccordsIrmcr2Api::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointIcebridgeMccordsIrmcr2Api::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointIcebridgeMccordsIrmcr2Api::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointIcebridgeMccordsIrmcr2Api::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointIcebridgeMccordsIrmcr2Api::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointIcebridgeMccordsIrmcr2Api::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointIcebridgeMccordsIrmcr2Api::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointIcebridgeMccordsIrmcr2Api::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointIcebridgeMccordsIrmcr2Api::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointIcebridgeMccordsIrmcr2Api::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointIcebridgeMccordsIrmcr2Api::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointIcebridgeMccordsIrmcr2Api::searchTypePointIcebridgeMccordsIrmcr2(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    QString fullPath = QString(_serverConfigs["searchTypePointIcebridgeMccordsIrmcr2"][_serverIndices.value("searchTypePointIcebridgeMccordsIrmcr2")].URL()+"/repository/search/type/type_point_icebridge_mccords_irmcr2");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointIcebridgeMccordsIrmcr2Api::searchTypePointIcebridgeMccordsIrmcr2Callback);
    connect(this, &OAITypeTypePointIcebridgeMccordsIrmcr2Api::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointIcebridgeMccordsIrmcr2Api::searchTypePointIcebridgeMccordsIrmcr2Callback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointIcebridgeMccordsIrmcr2Signal();
        Q_EMIT searchTypePointIcebridgeMccordsIrmcr2SignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointIcebridgeMccordsIrmcr2SignalE(error_type, error_str);
        Q_EMIT searchTypePointIcebridgeMccordsIrmcr2SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointIcebridgeMccordsIrmcr2SignalError(error_type, error_str);
        Q_EMIT searchTypePointIcebridgeMccordsIrmcr2SignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointIcebridgeMccordsIrmcr2Api::tokenAvailable(){
