...
#include "OAITypeTypePointOceanCsvSadoMeteoApi.h"
...
OAITypeTypePointOceanCsvSadoMeteoApi::OAITypeTypePointOceanCsvSadoMeteoApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointOceanCsvSadoMeteoApi::~OAITypeTypePointOceanCsvSadoMeteoApi() {
}

void OAITypeTypePointOceanCsvSadoMeteoApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointOceanCsvSadoMeteo", defaultConf);
    _serverIndices.insert("searchTypePointOceanCsvSadoMeteo", 0);
}
...
*/
int OAITypeTypePointOceanCsvSadoMeteoApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointOceanCsvSadoMeteoApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointOceanCsvSadoMeteoApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointOceanCsvSadoMeteoApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointOceanCsvSadoMeteoApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointOceanCsvSadoMeteoApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointOceanCsvSadoMeteoApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointOceanCsvSadoMeteoApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointOceanCsvSadoMeteoApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointOceanCsvSadoMeteoApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointOceanCsvSadoMeteoApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointOceanCsvSadoMeteoApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointOceanCsvSadoMeteoApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointOceanCsvSadoMeteoApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointOceanCsvSadoMeteoApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointOceanCsvSadoMeteoApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointOceanCsvSadoMeteoApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointOceanCsvSadoMeteoApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointOceanCsvSadoMeteoApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointOceanCsvSadoMeteoApi::searchTypePointOceanCsvSadoMeteo(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    QString fullPath = QString(_serverConfigs["searchTypePointOceanCsvSadoMeteo"][_serverIndices.value("searchTypePointOceanCsvSadoMeteo")].URL()+"/repository/search/type/type_point_ocean_csv_sado_meteo");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointOceanCsvSadoMeteoApi::searchTypePointOceanCsvSadoMeteoCallback);
    connect(this, &OAITypeTypePointOceanCsvSadoMeteoApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointOceanCsvSadoMeteoApi::searchTypePointOceanCsvSadoMeteoCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointOceanCsvSadoMeteoSignal();
        Q_EMIT searchTypePointOceanCsvSadoMeteoSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointOceanCsvSadoMeteoSignalE(error_type, error_str);
        Q_EMIT searchTypePointOceanCsvSadoMeteoSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointOceanCsvSadoMeteoSignalError(error_type, error_str);
        Q_EMIT searchTypePointOceanCsvSadoMeteoSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointOceanCsvSadoMeteoApi::tokenAvailable(){
