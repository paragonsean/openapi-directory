...
#include "OAITypeStatusboardApi.h"
...
OAITypeStatusboardApi::OAITypeStatusboardApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeStatusboardApi::~OAITypeStatusboardApi() {
}

void OAITypeStatusboardApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchStatusboard", defaultConf);
    _serverIndices.insert("searchStatusboard", 0);
}
...
*/
int OAITypeStatusboardApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeStatusboardApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeStatusboardApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeStatusboardApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeStatusboardApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeStatusboardApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeStatusboardApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeStatusboardApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeStatusboardApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeStatusboardApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeStatusboardApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeStatusboardApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeStatusboardApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeStatusboardApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeStatusboardApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeStatusboardApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeStatusboardApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeStatusboardApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeStatusboardApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeStatusboardApi::searchStatusboard(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_db_statusboard_what, const ::OpenAPI::OptionalParam<QString> &search_db_statusboard_status) {
    QString fullPath = QString(_serverConfigs["searchStatusboard"][_serverIndices.value("searchStatusboard")].URL()+"/repository/search/type/statusboard");
    ...
    if (search_db_statusboard_what.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.db_statusboard.what", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.db_statusboard.what")).append(querySuffix).append(QUrl::toPercentEncoding(search_db_statusboard_what.stringValue()));
    }
    if (search_db_statusboard_status.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.db_statusboard.status", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.db_statusboard.status")).append(querySuffix).append(QUrl::toPercentEncoding(search_db_statusboard_status.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeStatusboardApi::searchStatusboardCallback);
    connect(this, &OAITypeStatusboardApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeStatusboardApi::searchStatusboardCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchStatusboardSignal();
        Q_EMIT searchStatusboardSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchStatusboardSignalE(error_type, error_str);
        Q_EMIT searchStatusboardSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchStatusboardSignalError(error_type, error_str);
        Q_EMIT searchStatusboardSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeStatusboardApi::tokenAvailable(){
