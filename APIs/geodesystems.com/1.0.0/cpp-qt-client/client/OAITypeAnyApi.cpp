...
OAITypeAnyApi::OAITypeAnyApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeAnyApi::~OAITypeAnyApi() {
}

void OAITypeAnyApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchAny", defaultConf);
    _serverIndices.insert("searchAny", 0);
}
...
*/
int OAITypeAnyApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeAnyApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeAnyApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeAnyApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeAnyApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeAnyApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeAnyApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeAnyApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeAnyApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeAnyApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeAnyApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeAnyApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeAnyApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeAnyApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeAnyApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeAnyApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeAnyApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeAnyApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeAnyApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeAnyApi::searchAny(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeAnyApi::searchAnyCallback);
    connect(this, &OAITypeAnyApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeAnyApi::searchAnyCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchAnySignal();
        Q_EMIT searchAnySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchAnySignalE(error_type, error_str);
        Q_EMIT searchAnySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchAnySignalError(error_type, error_str);
        Q_EMIT searchAnySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeAnyApi::tokenAvailable(){
