...
#include "OAITypeTypeWmsCapabilitiesApi.h"
...
OAITypeTypeWmsCapabilitiesApi::OAITypeTypeWmsCapabilitiesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeWmsCapabilitiesApi::~OAITypeTypeWmsCapabilitiesApi() {
}

void OAITypeTypeWmsCapabilitiesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeWmsCapabilities", defaultConf);
    _serverIndices.insert("searchTypeWmsCapabilities", 0);
}
...
*/
int OAITypeTypeWmsCapabilitiesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeWmsCapabilitiesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeWmsCapabilitiesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeWmsCapabilitiesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeWmsCapabilitiesApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeWmsCapabilitiesApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeWmsCapabilitiesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeWmsCapabilitiesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeWmsCapabilitiesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeWmsCapabilitiesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeWmsCapabilitiesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeWmsCapabilitiesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeWmsCapabilitiesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeWmsCapabilitiesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeWmsCapabilitiesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeWmsCapabilitiesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeWmsCapabilitiesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeWmsCapabilitiesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeWmsCapabilitiesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeWmsCapabilitiesApi::searchTypeWmsCapabilities(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeWmsCapabilitiesApi::searchTypeWmsCapabilitiesCallback);
    connect(this, &OAITypeTypeWmsCapabilitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeWmsCapabilitiesApi::searchTypeWmsCapabilitiesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeWmsCapabilitiesSignal();
        Q_EMIT searchTypeWmsCapabilitiesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeWmsCapabilitiesSignalE(error_type, error_str);
        Q_EMIT searchTypeWmsCapabilitiesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeWmsCapabilitiesSignalError(error_type, error_str);
        Q_EMIT searchTypeWmsCapabilitiesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeWmsCapabilitiesApi::tokenAvailable(){
