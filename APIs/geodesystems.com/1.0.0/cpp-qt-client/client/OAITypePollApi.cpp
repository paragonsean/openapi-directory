...
OAITypePollApi::OAITypePollApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypePollApi::~OAITypePollApi() {
}

void OAITypePollApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchPoll", defaultConf);
    _serverIndices.insert("searchPoll", 0);
}
...
*/
int OAITypePollApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypePollApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypePollApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypePollApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypePollApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypePollApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypePollApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypePollApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypePollApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypePollApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypePollApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypePollApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypePollApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypePollApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypePollApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypePollApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypePollApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypePollApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypePollApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypePollApi::searchPoll(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypePollApi::searchPollCallback);
    connect(this, &OAITypePollApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypePollApi::searchPollCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchPollSignal();
        Q_EMIT searchPollSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchPollSignalE(error_type, error_str);
        Q_EMIT searchPollSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchPollSignalError(error_type, error_str);
        Q_EMIT searchPollSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypePollApi::tokenAvailable(){
