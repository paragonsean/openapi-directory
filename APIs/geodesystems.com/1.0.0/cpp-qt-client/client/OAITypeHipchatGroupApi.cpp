...
#include "OAITypeHipchatGroupApi.h"
...
OAITypeHipchatGroupApi::OAITypeHipchatGroupApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeHipchatGroupApi::~OAITypeHipchatGroupApi() {
}

void OAITypeHipchatGroupApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchHipchatGroup", defaultConf);
    _serverIndices.insert("searchHipchatGroup", 0);
}
...
*/
int OAITypeHipchatGroupApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeHipchatGroupApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeHipchatGroupApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeHipchatGroupApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeHipchatGroupApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeHipchatGroupApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeHipchatGroupApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeHipchatGroupApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeHipchatGroupApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeHipchatGroupApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeHipchatGroupApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeHipchatGroupApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeHipchatGroupApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeHipchatGroupApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeHipchatGroupApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeHipchatGroupApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeHipchatGroupApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeHipchatGroupApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeHipchatGroupApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeHipchatGroupApi::searchHipchatGroup(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeHipchatGroupApi::searchHipchatGroupCallback);
    connect(this, &OAITypeHipchatGroupApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeHipchatGroupApi::searchHipchatGroupCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchHipchatGroupSignal();
        Q_EMIT searchHipchatGroupSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchHipchatGroupSignalE(error_type, error_str);
        Q_EMIT searchHipchatGroupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchHipchatGroupSignalError(error_type, error_str);
        Q_EMIT searchHipchatGroupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeHipchatGroupApi::tokenAvailable(){
