...
OAITypeFaqApi::OAITypeFaqApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeFaqApi::~OAITypeFaqApi() {
}

void OAITypeFaqApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchFaq", defaultConf);
    _serverIndices.insert("searchFaq", 0);
}
...
*/
int OAITypeFaqApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeFaqApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeFaqApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeFaqApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeFaqApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeFaqApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeFaqApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeFaqApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeFaqApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeFaqApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeFaqApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeFaqApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeFaqApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeFaqApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeFaqApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeFaqApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeFaqApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeFaqApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeFaqApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeFaqApi::searchFaq(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeFaqApi::searchFaqCallback);
    connect(this, &OAITypeFaqApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeFaqApi::searchFaqCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchFaqSignal();
        Q_EMIT searchFaqSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchFaqSignalE(error_type, error_str);
        Q_EMIT searchFaqSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchFaqSignalError(error_type, error_str);
        Q_EMIT searchFaqSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeFaqApi::tokenAvailable(){
