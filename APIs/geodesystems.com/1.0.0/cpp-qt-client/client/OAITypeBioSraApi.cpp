...
OAITypeBioSraApi::OAITypeBioSraApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeBioSraApi::~OAITypeBioSraApi() {
}

void OAITypeBioSraApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchBioSra", defaultConf);
    _serverIndices.insert("searchBioSra", 0);
}
...
*/
int OAITypeBioSraApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeBioSraApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeBioSraApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeBioSraApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeBioSraApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeBioSraApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeBioSraApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeBioSraApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeBioSraApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeBioSraApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioSraApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioSraApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeBioSraApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeBioSraApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeBioSraApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeBioSraApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeBioSraApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeBioSraApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeBioSraApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeBioSraApi::searchBioSra(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeBioSraApi::searchBioSraCallback);
    connect(this, &OAITypeBioSraApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeBioSraApi::searchBioSraCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchBioSraSignal();
        Q_EMIT searchBioSraSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchBioSraSignalE(error_type, error_str);
        Q_EMIT searchBioSraSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchBioSraSignalError(error_type, error_str);
        Q_EMIT searchBioSraSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeBioSraApi::tokenAvailable(){
