...
#include "OAITypeProjectExperimentApi.h"
...
OAITypeProjectExperimentApi::OAITypeProjectExperimentApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectExperimentApi::~OAITypeProjectExperimentApi() {
}

void OAITypeProjectExperimentApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectExperiment", defaultConf);
    _serverIndices.insert("searchProjectExperiment", 0);
}
...
*/
int OAITypeProjectExperimentApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectExperimentApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectExperimentApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectExperimentApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectExperimentApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectExperimentApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectExperimentApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectExperimentApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectExperimentApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectExperimentApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectExperimentApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectExperimentApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectExperimentApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectExperimentApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectExperimentApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectExperimentApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectExperimentApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectExperimentApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectExperimentApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectExperimentApi::searchProjectExperiment(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectExperimentApi::searchProjectExperimentCallback);
    connect(this, &OAITypeProjectExperimentApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectExperimentApi::searchProjectExperimentCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectExperimentSignal();
        Q_EMIT searchProjectExperimentSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectExperimentSignalE(error_type, error_str);
        Q_EMIT searchProjectExperimentSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectExperimentSignalError(error_type, error_str);
        Q_EMIT searchProjectExperimentSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectExperimentApi::tokenAvailable(){
