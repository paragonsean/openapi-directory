...
#ifndef OAI_OAITypeGroupApi_H
#define OAI_OAITypeGroupApi_H
...
class OAITypeGroupApi : public QObject {
    Q_OBJECT

public:
    OAITypeGroupApi(const int timeOut = 0);
    ~OAITypeGroupApi();
...
private:
    ...
    void searchGroupCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void searchGroupSignal();


    void searchGroupSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchGroupSignalError() instead")
    void searchGroupSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchGroupSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use searchGroupSignalErrorFull() instead")
    void searchGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
