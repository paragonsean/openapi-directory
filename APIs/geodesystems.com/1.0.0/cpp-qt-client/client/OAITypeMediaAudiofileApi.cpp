...
#include "OAITypeMediaAudiofileApi.h"
...
OAITypeMediaAudiofileApi::OAITypeMediaAudiofileApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeMediaAudiofileApi::~OAITypeMediaAudiofileApi() {
}

void OAITypeMediaAudiofileApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchMediaAudiofile", defaultConf);
    _serverIndices.insert("searchMediaAudiofile", 0);
}
...
*/
int OAITypeMediaAudiofileApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeMediaAudiofileApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeMediaAudiofileApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeMediaAudiofileApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeMediaAudiofileApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeMediaAudiofileApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeMediaAudiofileApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeMediaAudiofileApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeMediaAudiofileApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeMediaAudiofileApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeMediaAudiofileApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeMediaAudiofileApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeMediaAudiofileApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeMediaAudiofileApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeMediaAudiofileApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeMediaAudiofileApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeMediaAudiofileApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeMediaAudiofileApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeMediaAudiofileApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeMediaAudiofileApi::searchMediaAudiofile(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeMediaAudiofileApi::searchMediaAudiofileCallback);
    connect(this, &OAITypeMediaAudiofileApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeMediaAudiofileApi::searchMediaAudiofileCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchMediaAudiofileSignal();
        Q_EMIT searchMediaAudiofileSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchMediaAudiofileSignalE(error_type, error_str);
        Q_EMIT searchMediaAudiofileSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchMediaAudiofileSignalError(error_type, error_str);
        Q_EMIT searchMediaAudiofileSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeMediaAudiofileApi::tokenAvailable(){
