...
#include "OAITypeLocalfilesApi.h"
...
OAITypeLocalfilesApi::OAITypeLocalfilesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeLocalfilesApi::~OAITypeLocalfilesApi() {
}

void OAITypeLocalfilesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchLocalfiles", defaultConf);
    _serverIndices.insert("searchLocalfiles", 0);
}
...
*/
int OAITypeLocalfilesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeLocalfilesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeLocalfilesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeLocalfilesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeLocalfilesApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeLocalfilesApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeLocalfilesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeLocalfilesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeLocalfilesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeLocalfilesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLocalfilesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLocalfilesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeLocalfilesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeLocalfilesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeLocalfilesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeLocalfilesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeLocalfilesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeLocalfilesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeLocalfilesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeLocalfilesApi::searchLocalfiles(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeLocalfilesApi::searchLocalfilesCallback);
    connect(this, &OAITypeLocalfilesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeLocalfilesApi::searchLocalfilesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchLocalfilesSignal();
        Q_EMIT searchLocalfilesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchLocalfilesSignalE(error_type, error_str);
        Q_EMIT searchLocalfilesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchLocalfilesSignalError(error_type, error_str);
        Q_EMIT searchLocalfilesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeLocalfilesApi::tokenAvailable(){
