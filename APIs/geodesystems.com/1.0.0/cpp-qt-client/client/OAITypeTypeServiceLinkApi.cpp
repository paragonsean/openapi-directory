...
#include "OAITypeTypeServiceLinkApi.h"
...
OAITypeTypeServiceLinkApi::OAITypeTypeServiceLinkApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeServiceLinkApi::~OAITypeTypeServiceLinkApi() {
}

void OAITypeTypeServiceLinkApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeServiceLink", defaultConf);
    _serverIndices.insert("searchTypeServiceLink", 0);
}
...
*/
int OAITypeTypeServiceLinkApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeServiceLinkApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeServiceLinkApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeServiceLinkApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeServiceLinkApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeServiceLinkApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeServiceLinkApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeServiceLinkApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeServiceLinkApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeServiceLinkApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeServiceLinkApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeServiceLinkApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeServiceLinkApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeServiceLinkApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeServiceLinkApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeServiceLinkApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeServiceLinkApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeServiceLinkApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeServiceLinkApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeServiceLinkApi::searchTypeServiceLink(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeServiceLinkApi::searchTypeServiceLinkCallback);
    connect(this, &OAITypeTypeServiceLinkApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeServiceLinkApi::searchTypeServiceLinkCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeServiceLinkSignal();
        Q_EMIT searchTypeServiceLinkSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeServiceLinkSignalE(error_type, error_str);
        Q_EMIT searchTypeServiceLinkSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeServiceLinkSignalError(error_type, error_str);
        Q_EMIT searchTypeServiceLinkSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeServiceLinkApi::tokenAvailable(){
