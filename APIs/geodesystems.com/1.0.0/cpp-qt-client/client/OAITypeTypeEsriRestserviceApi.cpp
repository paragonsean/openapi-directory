...
#include "OAITypeTypeEsriRestserviceApi.h"
...
OAITypeTypeEsriRestserviceApi::OAITypeTypeEsriRestserviceApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeEsriRestserviceApi::~OAITypeTypeEsriRestserviceApi() {
}

void OAITypeTypeEsriRestserviceApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeEsriRestservice", defaultConf);
    _serverIndices.insert("searchTypeEsriRestservice", 0);
}
...
*/
int OAITypeTypeEsriRestserviceApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeEsriRestserviceApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeEsriRestserviceApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeEsriRestserviceApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeEsriRestserviceApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeEsriRestserviceApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeEsriRestserviceApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeEsriRestserviceApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeEsriRestserviceApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeEsriRestserviceApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeEsriRestserviceApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeEsriRestserviceApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeEsriRestserviceApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeEsriRestserviceApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeEsriRestserviceApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeEsriRestserviceApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeEsriRestserviceApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeEsriRestserviceApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeEsriRestserviceApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeEsriRestserviceApi::searchTypeEsriRestservice(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeEsriRestserviceApi::searchTypeEsriRestserviceCallback);
    connect(this, &OAITypeTypeEsriRestserviceApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeEsriRestserviceApi::searchTypeEsriRestserviceCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeEsriRestserviceSignal();
        Q_EMIT searchTypeEsriRestserviceSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeEsriRestserviceSignalE(error_type, error_str);
        Q_EMIT searchTypeEsriRestserviceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeEsriRestserviceSignalError(error_type, error_str);
        Q_EMIT searchTypeEsriRestserviceSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeEsriRestserviceApi::tokenAvailable(){
