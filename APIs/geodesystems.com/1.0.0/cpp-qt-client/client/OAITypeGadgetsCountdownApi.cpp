...
#include "OAITypeGadgetsCountdownApi.h"
...
OAITypeGadgetsCountdownApi::OAITypeGadgetsCountdownApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeGadgetsCountdownApi::~OAITypeGadgetsCountdownApi() {
}

void OAITypeGadgetsCountdownApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchGadgetsCountdown", defaultConf);
    _serverIndices.insert("searchGadgetsCountdown", 0);
}
...
*/
int OAITypeGadgetsCountdownApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeGadgetsCountdownApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeGadgetsCountdownApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeGadgetsCountdownApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeGadgetsCountdownApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeGadgetsCountdownApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeGadgetsCountdownApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeGadgetsCountdownApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeGadgetsCountdownApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeGadgetsCountdownApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGadgetsCountdownApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGadgetsCountdownApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeGadgetsCountdownApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeGadgetsCountdownApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeGadgetsCountdownApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeGadgetsCountdownApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeGadgetsCountdownApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeGadgetsCountdownApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeGadgetsCountdownApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeGadgetsCountdownApi::searchGadgetsCountdown(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeGadgetsCountdownApi::searchGadgetsCountdownCallback);
    connect(this, &OAITypeGadgetsCountdownApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeGadgetsCountdownApi::searchGadgetsCountdownCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchGadgetsCountdownSignal();
        Q_EMIT searchGadgetsCountdownSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchGadgetsCountdownSignalE(error_type, error_str);
        Q_EMIT searchGadgetsCountdownSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchGadgetsCountdownSignalError(error_type, error_str);
        Q_EMIT searchGadgetsCountdownSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeGadgetsCountdownApi::tokenAvailable(){
