...
OAITypeContactApi::OAITypeContactApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeContactApi::~OAITypeContactApi() {
}

void OAITypeContactApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchContact", defaultConf);
    _serverIndices.insert("searchContact", 0);
}
...
*/
int OAITypeContactApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeContactApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeContactApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeContactApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeContactApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeContactApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeContactApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeContactApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeContactApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeContactApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeContactApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeContactApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeContactApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeContactApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeContactApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeContactApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeContactApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeContactApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeContactApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeContactApi::searchContact(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_db_contact_name, const ::OpenAPI::OptionalParam<QString> &search_db_contact_institution, const ::OpenAPI::OptionalParam<QString> &search_db_contact_email) {
    QString fullPath = QString(_serverConfigs["searchContact"][_serverIndices.value("searchContact")].URL()+"/repository/search/type/contact");
    ...
    if (search_db_contact_name.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.db_contact.name", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.db_contact.name")).append(querySuffix).append(QUrl::toPercentEncoding(search_db_contact_name.stringValue()));
    }
    if (search_db_contact_institution.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.db_contact.institution", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.db_contact.institution")).append(querySuffix).append(QUrl::toPercentEncoding(search_db_contact_institution.stringValue()));
    }
    if (search_db_contact_email.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.db_contact.email", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.db_contact.email")).append(querySuffix).append(QUrl::toPercentEncoding(search_db_contact_email.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeContactApi::searchContactCallback);
    connect(this, &OAITypeContactApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeContactApi::searchContactCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchContactSignal();
        Q_EMIT searchContactSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchContactSignalE(error_type, error_str);
        Q_EMIT searchContactSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchContactSignalError(error_type, error_str);
        Q_EMIT searchContactSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeContactApi::tokenAvailable(){
