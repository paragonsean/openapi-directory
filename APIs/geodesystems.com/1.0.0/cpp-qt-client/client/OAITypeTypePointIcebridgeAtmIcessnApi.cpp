...
#include "OAITypeTypePointIcebridgeAtmIcessnApi.h"
...
OAITypeTypePointIcebridgeAtmIcessnApi::OAITypeTypePointIcebridgeAtmIcessnApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointIcebridgeAtmIcessnApi::~OAITypeTypePointIcebridgeAtmIcessnApi() {
}

void OAITypeTypePointIcebridgeAtmIcessnApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointIcebridgeAtmIcessn", defaultConf);
    _serverIndices.insert("searchTypePointIcebridgeAtmIcessn", 0);
}
...
*/
int OAITypeTypePointIcebridgeAtmIcessnApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointIcebridgeAtmIcessnApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointIcebridgeAtmIcessnApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointIcebridgeAtmIcessnApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointIcebridgeAtmIcessnApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointIcebridgeAtmIcessnApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointIcebridgeAtmIcessnApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointIcebridgeAtmIcessnApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointIcebridgeAtmIcessnApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointIcebridgeAtmIcessnApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointIcebridgeAtmIcessnApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointIcebridgeAtmIcessnApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointIcebridgeAtmIcessnApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointIcebridgeAtmIcessnApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointIcebridgeAtmIcessnApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointIcebridgeAtmIcessnApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointIcebridgeAtmIcessnApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointIcebridgeAtmIcessnApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointIcebridgeAtmIcessnApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointIcebridgeAtmIcessnApi::searchTypePointIcebridgeAtmIcessn(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointIcebridgeAtmIcessnApi::searchTypePointIcebridgeAtmIcessnCallback);
    connect(this, &OAITypeTypePointIcebridgeAtmIcessnApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointIcebridgeAtmIcessnApi::searchTypePointIcebridgeAtmIcessnCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointIcebridgeAtmIcessnSignal();
        Q_EMIT searchTypePointIcebridgeAtmIcessnSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointIcebridgeAtmIcessnSignalE(error_type, error_str);
        Q_EMIT searchTypePointIcebridgeAtmIcessnSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointIcebridgeAtmIcessnSignalError(error_type, error_str);
        Q_EMIT searchTypePointIcebridgeAtmIcessnSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointIcebridgeAtmIcessnApi::tokenAvailable(){
