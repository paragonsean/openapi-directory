...
#include "OAITypeTypeSoundingCodApi.h"
...
OAITypeTypeSoundingCodApi::OAITypeTypeSoundingCodApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeSoundingCodApi::~OAITypeTypeSoundingCodApi() {
}

void OAITypeTypeSoundingCodApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeSoundingCod", defaultConf);
    _serverIndices.insert("searchTypeSoundingCod", 0);
}
...
*/
int OAITypeTypeSoundingCodApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeSoundingCodApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeSoundingCodApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeSoundingCodApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeSoundingCodApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeSoundingCodApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeSoundingCodApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeSoundingCodApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeSoundingCodApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeSoundingCodApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeSoundingCodApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeSoundingCodApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeSoundingCodApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeSoundingCodApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeSoundingCodApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeSoundingCodApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeSoundingCodApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeSoundingCodApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeSoundingCodApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeSoundingCodApi::searchTypeSoundingCod(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeSoundingCodApi::searchTypeSoundingCodCallback);
    connect(this, &OAITypeTypeSoundingCodApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeSoundingCodApi::searchTypeSoundingCodCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeSoundingCodSignal();
        Q_EMIT searchTypeSoundingCodSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeSoundingCodSignalE(error_type, error_str);
        Q_EMIT searchTypeSoundingCodSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeSoundingCodSignalError(error_type, error_str);
        Q_EMIT searchTypeSoundingCodSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeSoundingCodApi::tokenAvailable(){
