...
OAITypeTripTripApi::OAITypeTripTripApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTripTripApi::~OAITypeTripTripApi() {
}

void OAITypeTripTripApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTripTrip", defaultConf);
    _serverIndices.insert("searchTripTrip", 0);
}
...
*/
int OAITypeTripTripApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTripTripApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTripTripApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTripTripApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTripTripApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTripTripApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTripTripApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTripTripApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTripTripApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTripTripApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTripTripApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTripTripApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTripTripApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTripTripApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTripTripApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTripTripApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTripTripApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTripTripApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTripTripApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTripTripApi::searchTripTrip(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTripTripApi::searchTripTripCallback);
    connect(this, &OAITypeTripTripApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTripTripApi::searchTripTripCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTripTripSignal();
        Q_EMIT searchTripTripSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTripTripSignalE(error_type, error_str);
        Q_EMIT searchTripTripSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTripTripSignalError(error_type, error_str);
        Q_EMIT searchTripTripSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTripTripApi::tokenAvailable(){
