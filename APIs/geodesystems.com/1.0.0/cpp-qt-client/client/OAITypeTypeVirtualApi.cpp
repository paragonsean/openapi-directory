...
#include "OAITypeTypeVirtualApi.h"
...
OAITypeTypeVirtualApi::OAITypeTypeVirtualApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeVirtualApi::~OAITypeTypeVirtualApi() {
}

void OAITypeTypeVirtualApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeVirtual", defaultConf);
    _serverIndices.insert("searchTypeVirtual", 0);
}
...
*/
int OAITypeTypeVirtualApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeVirtualApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeVirtualApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeVirtualApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeVirtualApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeVirtualApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeVirtualApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeVirtualApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeVirtualApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeVirtualApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeVirtualApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeVirtualApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeVirtualApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeVirtualApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeVirtualApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeVirtualApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeVirtualApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeVirtualApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeVirtualApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeVirtualApi::searchTypeVirtual(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeVirtualApi::searchTypeVirtualCallback);
    connect(this, &OAITypeTypeVirtualApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeVirtualApi::searchTypeVirtualCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeVirtualSignal();
        Q_EMIT searchTypeVirtualSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeVirtualSignalE(error_type, error_str);
        Q_EMIT searchTypeVirtualSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeVirtualSignalError(error_type, error_str);
        Q_EMIT searchTypeVirtualSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeVirtualApi::tokenAvailable(){
