...
OAITypeIncidentApi::OAITypeIncidentApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeIncidentApi::~OAITypeIncidentApi() {
}

void OAITypeIncidentApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchIncident", defaultConf);
    _serverIndices.insert("searchIncident", 0);
}
...
*/
int OAITypeIncidentApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeIncidentApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeIncidentApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeIncidentApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeIncidentApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeIncidentApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeIncidentApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeIncidentApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeIncidentApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeIncidentApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeIncidentApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeIncidentApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeIncidentApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeIncidentApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeIncidentApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeIncidentApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeIncidentApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeIncidentApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeIncidentApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeIncidentApi::searchIncident(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_incident_incidenttype, const ::OpenAPI::OptionalParam<QString> &search_incident_cause, const ::OpenAPI::OptionalParam<QString> &search_incident_state) {
    QString fullPath = QString(_serverConfigs["searchIncident"][_serverIndices.value("searchIncident")].URL()+"/repository/search/type/incident");
    ...
    if (search_incident_incidenttype.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.incident.incidenttype", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.incident.incidenttype")).append(querySuffix).append(QUrl::toPercentEncoding(search_incident_incidenttype.stringValue()));
    }
    if (search_incident_cause.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.incident.cause", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.incident.cause")).append(querySuffix).append(QUrl::toPercentEncoding(search_incident_cause.stringValue()));
    }
    if (search_incident_state.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.incident.state", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.incident.state")).append(querySuffix).append(QUrl::toPercentEncoding(search_incident_state.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeIncidentApi::searchIncidentCallback);
    connect(this, &OAITypeIncidentApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeIncidentApi::searchIncidentCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchIncidentSignal();
        Q_EMIT searchIncidentSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchIncidentSignalE(error_type, error_str);
        Q_EMIT searchIncidentSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchIncidentSignalError(error_type, error_str);
        Q_EMIT searchIncidentSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeIncidentApi::tokenAvailable(){
