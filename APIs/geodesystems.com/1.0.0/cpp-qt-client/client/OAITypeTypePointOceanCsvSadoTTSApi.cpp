...
#include "OAITypeTypePointOceanCsvSadoTTSApi.h"
...
OAITypeTypePointOceanCsvSadoTTSApi::OAITypeTypePointOceanCsvSadoTTSApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointOceanCsvSadoTTSApi::~OAITypeTypePointOceanCsvSadoTTSApi() {
}

void OAITypeTypePointOceanCsvSadoTTSApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointOceanCsvSadoTTS", defaultConf);
    _serverIndices.insert("searchTypePointOceanCsvSadoTTS", 0);
}
...
*/
int OAITypeTypePointOceanCsvSadoTTSApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointOceanCsvSadoTTSApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointOceanCsvSadoTTSApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointOceanCsvSadoTTSApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointOceanCsvSadoTTSApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointOceanCsvSadoTTSApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointOceanCsvSadoTTSApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointOceanCsvSadoTTSApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointOceanCsvSadoTTSApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointOceanCsvSadoTTSApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointOceanCsvSadoTTSApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointOceanCsvSadoTTSApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointOceanCsvSadoTTSApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointOceanCsvSadoTTSApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointOceanCsvSadoTTSApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointOceanCsvSadoTTSApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointOceanCsvSadoTTSApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointOceanCsvSadoTTSApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointOceanCsvSadoTTSApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointOceanCsvSadoTTSApi::searchTypePointOceanCsvSadoTTS(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    QString fullPath = QString(_serverConfigs["searchTypePointOceanCsvSadoTTS"][_serverIndices.value("searchTypePointOceanCsvSadoTTS")].URL()+"/repository/search/type/type_point_ocean_csv_sado_TTS");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointOceanCsvSadoTTSApi::searchTypePointOceanCsvSadoTTSCallback);
    connect(this, &OAITypeTypePointOceanCsvSadoTTSApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointOceanCsvSadoTTSApi::searchTypePointOceanCsvSadoTTSCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointOceanCsvSadoTTSSignal();
        Q_EMIT searchTypePointOceanCsvSadoTTSSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointOceanCsvSadoTTSSignalE(error_type, error_str);
        Q_EMIT searchTypePointOceanCsvSadoTTSSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointOceanCsvSadoTTSSignalError(error_type, error_str);
        Q_EMIT searchTypePointOceanCsvSadoTTSSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointOceanCsvSadoTTSApi::tokenAvailable(){
