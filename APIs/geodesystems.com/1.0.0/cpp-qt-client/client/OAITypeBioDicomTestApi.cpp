...
#include "OAITypeBioDicomTestApi.h"
...
OAITypeBioDicomTestApi::OAITypeBioDicomTestApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeBioDicomTestApi::~OAITypeBioDicomTestApi() {
}

void OAITypeBioDicomTestApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchBioDicomTest", defaultConf);
    _serverIndices.insert("searchBioDicomTest", 0);
}
...
*/
int OAITypeBioDicomTestApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeBioDicomTestApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeBioDicomTestApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeBioDicomTestApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeBioDicomTestApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeBioDicomTestApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeBioDicomTestApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeBioDicomTestApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeBioDicomTestApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeBioDicomTestApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioDicomTestApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioDicomTestApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeBioDicomTestApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeBioDicomTestApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeBioDicomTestApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeBioDicomTestApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeBioDicomTestApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeBioDicomTestApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeBioDicomTestApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeBioDicomTestApi::searchBioDicomTest(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_bio_dicom_test_patient_name, const ::OpenAPI::OptionalParam<QString> &search_bio_dicom_test_patient_id) {
    QString fullPath = QString(_serverConfigs["searchBioDicomTest"][_serverIndices.value("searchBioDicomTest")].URL()+"/repository/search/type/bio_dicom_test");
    ...
    if (search_bio_dicom_test_patient_name.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.bio_dicom_test.PatientName", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.bio_dicom_test.PatientName")).append(querySuffix).append(QUrl::toPercentEncoding(search_bio_dicom_test_patient_name.stringValue()));
    }
    if (search_bio_dicom_test_patient_id.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.bio_dicom_test.PatientID", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.bio_dicom_test.PatientID")).append(querySuffix).append(QUrl::toPercentEncoding(search_bio_dicom_test_patient_id.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeBioDicomTestApi::searchBioDicomTestCallback);
    connect(this, &OAITypeBioDicomTestApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeBioDicomTestApi::searchBioDicomTestCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchBioDicomTestSignal();
        Q_EMIT searchBioDicomTestSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchBioDicomTestSignalE(error_type, error_str);
        Q_EMIT searchBioDicomTestSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchBioDicomTestSignalError(error_type, error_str);
        Q_EMIT searchBioDicomTestSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeBioDicomTestApi::tokenAvailable(){
