...
OAITypeFtpApi::OAITypeFtpApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeFtpApi::~OAITypeFtpApi() {
}

void OAITypeFtpApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchFtp", defaultConf);
    _serverIndices.insert("searchFtp", 0);
}
...
*/
int OAITypeFtpApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeFtpApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeFtpApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeFtpApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeFtpApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeFtpApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeFtpApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeFtpApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeFtpApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeFtpApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeFtpApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeFtpApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeFtpApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeFtpApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeFtpApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeFtpApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeFtpApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeFtpApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeFtpApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeFtpApi::searchFtp(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeFtpApi::searchFtpCallback);
    connect(this, &OAITypeFtpApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeFtpApi::searchFtpCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchFtpSignal();
        Q_EMIT searchFtpSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchFtpSignalE(error_type, error_str);
        Q_EMIT searchFtpSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchFtpSignalError(error_type, error_str);
        Q_EMIT searchFtpSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeFtpApi::tokenAvailable(){
