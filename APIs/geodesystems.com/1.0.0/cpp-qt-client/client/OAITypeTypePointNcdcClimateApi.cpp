...
#include "OAITypeTypePointNcdcClimateApi.h"
...
OAITypeTypePointNcdcClimateApi::OAITypeTypePointNcdcClimateApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointNcdcClimateApi::~OAITypeTypePointNcdcClimateApi() {
}

void OAITypeTypePointNcdcClimateApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointNcdcClimate", defaultConf);
    _serverIndices.insert("searchTypePointNcdcClimate", 0);
}
...
*/
int OAITypeTypePointNcdcClimateApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointNcdcClimateApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointNcdcClimateApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointNcdcClimateApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointNcdcClimateApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointNcdcClimateApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointNcdcClimateApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointNcdcClimateApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointNcdcClimateApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointNcdcClimateApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointNcdcClimateApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointNcdcClimateApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointNcdcClimateApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointNcdcClimateApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointNcdcClimateApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointNcdcClimateApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointNcdcClimateApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointNcdcClimateApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointNcdcClimateApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointNcdcClimateApi::searchTypePointNcdcClimate(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointNcdcClimateApi::searchTypePointNcdcClimateCallback);
    connect(this, &OAITypeTypePointNcdcClimateApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointNcdcClimateApi::searchTypePointNcdcClimateCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointNcdcClimateSignal();
        Q_EMIT searchTypePointNcdcClimateSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointNcdcClimateSignalE(error_type, error_str);
        Q_EMIT searchTypePointNcdcClimateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointNcdcClimateSignalError(error_type, error_str);
        Q_EMIT searchTypePointNcdcClimateSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointNcdcClimateApi::tokenAvailable(){
