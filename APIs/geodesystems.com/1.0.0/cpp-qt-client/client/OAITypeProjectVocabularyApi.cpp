...
#include "OAITypeProjectVocabularyApi.h"
...
OAITypeProjectVocabularyApi::OAITypeProjectVocabularyApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectVocabularyApi::~OAITypeProjectVocabularyApi() {
}

void OAITypeProjectVocabularyApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectVocabulary", defaultConf);
    _serverIndices.insert("searchProjectVocabulary", 0);
}
...
*/
int OAITypeProjectVocabularyApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectVocabularyApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectVocabularyApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectVocabularyApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectVocabularyApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectVocabularyApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectVocabularyApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectVocabularyApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectVocabularyApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectVocabularyApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectVocabularyApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectVocabularyApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectVocabularyApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectVocabularyApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectVocabularyApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectVocabularyApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectVocabularyApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectVocabularyApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectVocabularyApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectVocabularyApi::searchProjectVocabulary(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectVocabularyApi::searchProjectVocabularyCallback);
    connect(this, &OAITypeProjectVocabularyApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectVocabularyApi::searchProjectVocabularyCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectVocabularySignal();
        Q_EMIT searchProjectVocabularySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectVocabularySignalE(error_type, error_str);
        Q_EMIT searchProjectVocabularySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectVocabularySignalError(error_type, error_str);
        Q_EMIT searchProjectVocabularySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectVocabularyApi::tokenAvailable(){
