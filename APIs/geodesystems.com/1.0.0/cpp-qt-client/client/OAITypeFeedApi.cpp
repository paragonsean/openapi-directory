...
OAITypeFeedApi::OAITypeFeedApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeFeedApi::~OAITypeFeedApi() {
}

void OAITypeFeedApi::initializeServerConfigs() {
    //Default server
...
*/
int OAITypeFeedApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeFeedApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeFeedApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeFeedApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeFeedApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeFeedApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeFeedApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeFeedApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeFeedApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeFeedApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeFeedApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeFeedApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeFeedApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeFeedApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeFeedApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeFeedApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeFeedApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeFeedApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeFeedApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeFeedApi::searchFeed(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeFeedApi::searchFeedCallback);
    connect(this, &OAITypeFeedApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeFeedApi::searchFeedCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchFeedSignal();
        Q_EMIT searchFeedSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchFeedSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchFeedSignalError(error_type, error_str);
        Q_EMIT searchFeedSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeFeedApi::tokenAvailable(){
