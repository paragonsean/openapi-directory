...
#include "OAITypeProjectInstrumentApi.h"
...
OAITypeProjectInstrumentApi::OAITypeProjectInstrumentApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectInstrumentApi::~OAITypeProjectInstrumentApi() {
}

void OAITypeProjectInstrumentApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectInstrument", defaultConf);
    _serverIndices.insert("searchProjectInstrument", 0);
}
...
*/
int OAITypeProjectInstrumentApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectInstrumentApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectInstrumentApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectInstrumentApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectInstrumentApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectInstrumentApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectInstrumentApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectInstrumentApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectInstrumentApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectInstrumentApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectInstrumentApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectInstrumentApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectInstrumentApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectInstrumentApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectInstrumentApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectInstrumentApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectInstrumentApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectInstrumentApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectInstrumentApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectInstrumentApi::searchProjectInstrument(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectInstrumentApi::searchProjectInstrumentCallback);
    connect(this, &OAITypeProjectInstrumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectInstrumentApi::searchProjectInstrumentCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectInstrumentSignal();
        Q_EMIT searchProjectInstrumentSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectInstrumentSignalE(error_type, error_str);
        Q_EMIT searchProjectInstrumentSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectInstrumentSignalError(error_type, error_str);
        Q_EMIT searchProjectInstrumentSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectInstrumentApi::tokenAvailable(){
