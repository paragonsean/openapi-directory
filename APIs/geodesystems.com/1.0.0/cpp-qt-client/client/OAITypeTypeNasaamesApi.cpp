...
#include "OAITypeTypeNasaamesApi.h"
...
OAITypeTypeNasaamesApi::OAITypeTypeNasaamesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeNasaamesApi::~OAITypeTypeNasaamesApi() {
}

void OAITypeTypeNasaamesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeNasaames", defaultConf);
    _serverIndices.insert("searchTypeNasaames", 0);
}
...
*/
int OAITypeTypeNasaamesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeNasaamesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeNasaamesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeNasaamesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeNasaamesApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeNasaamesApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeNasaamesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeNasaamesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeNasaamesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeNasaamesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeNasaamesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeNasaamesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeNasaamesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeNasaamesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeNasaamesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeNasaamesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeNasaamesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeNasaamesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeNasaamesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeNasaamesApi::searchTypeNasaames(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeNasaamesApi::searchTypeNasaamesCallback);
    connect(this, &OAITypeTypeNasaamesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeNasaamesApi::searchTypeNasaamesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeNasaamesSignal();
        Q_EMIT searchTypeNasaamesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeNasaamesSignalE(error_type, error_str);
        Q_EMIT searchTypeNasaamesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeNasaamesSignalError(error_type, error_str);
        Q_EMIT searchTypeNasaamesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeNasaamesApi::tokenAvailable(){
