...
#include "OAITypeGridaggregationApi.h"
...
OAITypeGridaggregationApi::OAITypeGridaggregationApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeGridaggregationApi::~OAITypeGridaggregationApi() {
}

void OAITypeGridaggregationApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchGridaggregation", defaultConf);
    _serverIndices.insert("searchGridaggregation", 0);
}
...
*/
int OAITypeGridaggregationApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeGridaggregationApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeGridaggregationApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeGridaggregationApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeGridaggregationApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeGridaggregationApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeGridaggregationApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeGridaggregationApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeGridaggregationApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeGridaggregationApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGridaggregationApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGridaggregationApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeGridaggregationApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeGridaggregationApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeGridaggregationApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeGridaggregationApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeGridaggregationApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeGridaggregationApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeGridaggregationApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeGridaggregationApi::searchGridaggregation(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeGridaggregationApi::searchGridaggregationCallback);
    connect(this, &OAITypeGridaggregationApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeGridaggregationApi::searchGridaggregationCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchGridaggregationSignal();
        Q_EMIT searchGridaggregationSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchGridaggregationSignalE(error_type, error_str);
        Q_EMIT searchGridaggregationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchGridaggregationSignalError(error_type, error_str);
        Q_EMIT searchGridaggregationSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeGridaggregationApi::tokenAvailable(){
