...
#include "OAITypeBioOntologyStudyApi.h"
...
OAITypeBioOntologyStudyApi::OAITypeBioOntologyStudyApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeBioOntologyStudyApi::~OAITypeBioOntologyStudyApi() {
}

void OAITypeBioOntologyStudyApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchBioOntologyStudy", defaultConf);
    _serverIndices.insert("searchBioOntologyStudy", 0);
}
...
*/
int OAITypeBioOntologyStudyApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeBioOntologyStudyApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeBioOntologyStudyApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeBioOntologyStudyApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeBioOntologyStudyApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeBioOntologyStudyApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeBioOntologyStudyApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeBioOntologyStudyApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeBioOntologyStudyApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeBioOntologyStudyApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioOntologyStudyApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioOntologyStudyApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeBioOntologyStudyApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeBioOntologyStudyApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeBioOntologyStudyApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeBioOntologyStudyApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeBioOntologyStudyApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeBioOntologyStudyApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeBioOntologyStudyApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeBioOntologyStudyApi::searchBioOntologyStudy(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeBioOntologyStudyApi::searchBioOntologyStudyCallback);
    connect(this, &OAITypeBioOntologyStudyApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeBioOntologyStudyApi::searchBioOntologyStudyCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchBioOntologyStudySignal();
        Q_EMIT searchBioOntologyStudySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchBioOntologyStudySignalE(error_type, error_str);
        Q_EMIT searchBioOntologyStudySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchBioOntologyStudySignalError(error_type, error_str);
        Q_EMIT searchBioOntologyStudySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeBioOntologyStudyApi::tokenAvailable(){
