...
#include "OAITypeBioHmmerIndexApi.h"
...
OAITypeBioHmmerIndexApi::OAITypeBioHmmerIndexApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeBioHmmerIndexApi::~OAITypeBioHmmerIndexApi() {
}

void OAITypeBioHmmerIndexApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchBioHmmerIndex", defaultConf);
    _serverIndices.insert("searchBioHmmerIndex", 0);
}
...
*/
int OAITypeBioHmmerIndexApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeBioHmmerIndexApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeBioHmmerIndexApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeBioHmmerIndexApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeBioHmmerIndexApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeBioHmmerIndexApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeBioHmmerIndexApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeBioHmmerIndexApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeBioHmmerIndexApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeBioHmmerIndexApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioHmmerIndexApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioHmmerIndexApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeBioHmmerIndexApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeBioHmmerIndexApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeBioHmmerIndexApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeBioHmmerIndexApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeBioHmmerIndexApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeBioHmmerIndexApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeBioHmmerIndexApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeBioHmmerIndexApi::searchBioHmmerIndex(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeBioHmmerIndexApi::searchBioHmmerIndexCallback);
    connect(this, &OAITypeBioHmmerIndexApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeBioHmmerIndexApi::searchBioHmmerIndexCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchBioHmmerIndexSignal();
        Q_EMIT searchBioHmmerIndexSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchBioHmmerIndexSignalE(error_type, error_str);
        Q_EMIT searchBioHmmerIndexSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchBioHmmerIndexSignalError(error_type, error_str);
        Q_EMIT searchBioHmmerIndexSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeBioHmmerIndexApi::tokenAvailable(){
