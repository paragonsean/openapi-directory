...
#include "OAITypeTypeSocrataSeriesApi.h"
...
OAITypeTypeSocrataSeriesApi::OAITypeTypeSocrataSeriesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeSocrataSeriesApi::~OAITypeTypeSocrataSeriesApi() {
}

void OAITypeTypeSocrataSeriesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeSocrataSeries", defaultConf);
    _serverIndices.insert("searchTypeSocrataSeries", 0);
}
...
*/
int OAITypeTypeSocrataSeriesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeSocrataSeriesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeSocrataSeriesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeSocrataSeriesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeSocrataSeriesApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeSocrataSeriesApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeSocrataSeriesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeSocrataSeriesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeSocrataSeriesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeSocrataSeriesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeSocrataSeriesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeSocrataSeriesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeSocrataSeriesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeSocrataSeriesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeSocrataSeriesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeSocrataSeriesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeSocrataSeriesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeSocrataSeriesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeSocrataSeriesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeSocrataSeriesApi::searchTypeSocrataSeries(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeSocrataSeriesApi::searchTypeSocrataSeriesCallback);
    connect(this, &OAITypeTypeSocrataSeriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeSocrataSeriesApi::searchTypeSocrataSeriesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeSocrataSeriesSignal();
        Q_EMIT searchTypeSocrataSeriesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeSocrataSeriesSignalE(error_type, error_str);
        Q_EMIT searchTypeSocrataSeriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeSocrataSeriesSignalError(error_type, error_str);
        Q_EMIT searchTypeSocrataSeriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeSocrataSeriesApi::tokenAvailable(){
