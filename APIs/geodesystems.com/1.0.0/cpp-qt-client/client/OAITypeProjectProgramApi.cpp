...
#include "OAITypeProjectProgramApi.h"
...
OAITypeProjectProgramApi::OAITypeProjectProgramApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectProgramApi::~OAITypeProjectProgramApi() {
}

void OAITypeProjectProgramApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectProgram", defaultConf);
    _serverIndices.insert("searchProjectProgram", 0);
}
...
*/
int OAITypeProjectProgramApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectProgramApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectProgramApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectProgramApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectProgramApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectProgramApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectProgramApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectProgramApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectProgramApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectProgramApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectProgramApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectProgramApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectProgramApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectProgramApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectProgramApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectProgramApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectProgramApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectProgramApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectProgramApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectProgramApi::searchProjectProgram(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectProgramApi::searchProjectProgramCallback);
    connect(this, &OAITypeProjectProgramApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectProgramApi::searchProjectProgramCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectProgramSignal();
        Q_EMIT searchProjectProgramSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectProgramSignalE(error_type, error_str);
        Q_EMIT searchProjectProgramSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectProgramSignalError(error_type, error_str);
        Q_EMIT searchProjectProgramSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectProgramApi::tokenAvailable(){
