...
#include "OAITypeGeoShapefileApi.h"
...
OAITypeGeoShapefileApi::OAITypeGeoShapefileApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeGeoShapefileApi::~OAITypeGeoShapefileApi() {
}

void OAITypeGeoShapefileApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchGeoShapefile", defaultConf);
    _serverIndices.insert("searchGeoShapefile", 0);
}
...
*/
int OAITypeGeoShapefileApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeGeoShapefileApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeGeoShapefileApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeGeoShapefileApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeGeoShapefileApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeGeoShapefileApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeGeoShapefileApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeGeoShapefileApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeGeoShapefileApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeGeoShapefileApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGeoShapefileApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGeoShapefileApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeGeoShapefileApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeGeoShapefileApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeGeoShapefileApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeGeoShapefileApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeGeoShapefileApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeGeoShapefileApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeGeoShapefileApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeGeoShapefileApi::searchGeoShapefile(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeGeoShapefileApi::searchGeoShapefileCallback);
    connect(this, &OAITypeGeoShapefileApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeGeoShapefileApi::searchGeoShapefileCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchGeoShapefileSignal();
        Q_EMIT searchGeoShapefileSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchGeoShapefileSignalE(error_type, error_str);
        Q_EMIT searchGeoShapefileSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchGeoShapefileSignalError(error_type, error_str);
        Q_EMIT searchGeoShapefileSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeGeoShapefileApi::tokenAvailable(){
