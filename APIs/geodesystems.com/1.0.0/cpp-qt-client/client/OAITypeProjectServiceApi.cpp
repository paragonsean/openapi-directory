...
#include "OAITypeProjectServiceApi.h"
...
OAITypeProjectServiceApi::OAITypeProjectServiceApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectServiceApi::~OAITypeProjectServiceApi() {
}

void OAITypeProjectServiceApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectService", defaultConf);
    _serverIndices.insert("searchProjectService", 0);
}
...
*/
int OAITypeProjectServiceApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectServiceApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectServiceApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectServiceApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectServiceApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectServiceApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectServiceApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectServiceApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectServiceApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectServiceApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectServiceApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectServiceApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectServiceApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectServiceApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectServiceApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectServiceApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectServiceApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectServiceApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectServiceApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectServiceApi::searchProjectService(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_project_service_service_type, const ::OpenAPI::OptionalParam<QString> &search_project_service_provider) {
    QString fullPath = QString(_serverConfigs["searchProjectService"][_serverIndices.value("searchProjectService")].URL()+"/repository/search/type/project_service");
    ...
    if (search_project_service_service_type.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.project_service.service_type", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.project_service.service_type")).append(querySuffix).append(QUrl::toPercentEncoding(search_project_service_service_type.stringValue()));
    }
    if (search_project_service_provider.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.project_service.provider", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.project_service.provider")).append(querySuffix).append(QUrl::toPercentEncoding(search_project_service_provider.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectServiceApi::searchProjectServiceCallback);
    connect(this, &OAITypeProjectServiceApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectServiceApi::searchProjectServiceCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectServiceSignal();
        Q_EMIT searchProjectServiceSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectServiceSignalE(error_type, error_str);
        Q_EMIT searchProjectServiceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectServiceSignalError(error_type, error_str);
        Q_EMIT searchProjectServiceSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectServiceApi::tokenAvailable(){
