...
#include "OAITypeTypePointSimpleRecordsApi.h"
...
OAITypeTypePointSimpleRecordsApi::OAITypeTypePointSimpleRecordsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointSimpleRecordsApi::~OAITypeTypePointSimpleRecordsApi() {
}

void OAITypeTypePointSimpleRecordsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointSimpleRecords", defaultConf);
    _serverIndices.insert("searchTypePointSimpleRecords", 0);
}
...
*/
int OAITypeTypePointSimpleRecordsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointSimpleRecordsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointSimpleRecordsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointSimpleRecordsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointSimpleRecordsApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointSimpleRecordsApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointSimpleRecordsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointSimpleRecordsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointSimpleRecordsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointSimpleRecordsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointSimpleRecordsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointSimpleRecordsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointSimpleRecordsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointSimpleRecordsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointSimpleRecordsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointSimpleRecordsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointSimpleRecordsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointSimpleRecordsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointSimpleRecordsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointSimpleRecordsApi::searchTypePointSimpleRecords(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointSimpleRecordsApi::searchTypePointSimpleRecordsCallback);
    connect(this, &OAITypeTypePointSimpleRecordsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointSimpleRecordsApi::searchTypePointSimpleRecordsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointSimpleRecordsSignal();
        Q_EMIT searchTypePointSimpleRecordsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointSimpleRecordsSignalE(error_type, error_str);
        Q_EMIT searchTypePointSimpleRecordsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointSimpleRecordsSignalError(error_type, error_str);
        Q_EMIT searchTypePointSimpleRecordsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointSimpleRecordsApi::tokenAvailable(){
