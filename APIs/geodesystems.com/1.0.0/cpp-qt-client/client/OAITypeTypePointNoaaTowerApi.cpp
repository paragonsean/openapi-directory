...
#include "OAITypeTypePointNoaaTowerApi.h"
...
OAITypeTypePointNoaaTowerApi::OAITypeTypePointNoaaTowerApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypePointNoaaTowerApi::~OAITypeTypePointNoaaTowerApi() {
}

void OAITypeTypePointNoaaTowerApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypePointNoaaTower", defaultConf);
    _serverIndices.insert("searchTypePointNoaaTower", 0);
}
...
*/
int OAITypeTypePointNoaaTowerApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypePointNoaaTowerApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypePointNoaaTowerApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypePointNoaaTowerApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypePointNoaaTowerApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypePointNoaaTowerApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypePointNoaaTowerApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypePointNoaaTowerApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypePointNoaaTowerApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypePointNoaaTowerApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointNoaaTowerApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypePointNoaaTowerApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypePointNoaaTowerApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypePointNoaaTowerApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypePointNoaaTowerApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypePointNoaaTowerApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypePointNoaaTowerApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypePointNoaaTowerApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypePointNoaaTowerApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypePointNoaaTowerApi::searchTypePointNoaaTower(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_type_point_noaa_tower_site_id) {
    ...
    if (search_type_point_noaa_tower_site_id.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.type_point_noaa_tower.site_id", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.type_point_noaa_tower.site_id")).append(querySuffix).append(QUrl::toPercentEncoding(search_type_point_noaa_tower_site_id.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypePointNoaaTowerApi::searchTypePointNoaaTowerCallback);
    connect(this, &OAITypeTypePointNoaaTowerApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypePointNoaaTowerApi::searchTypePointNoaaTowerCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypePointNoaaTowerSignal();
        Q_EMIT searchTypePointNoaaTowerSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypePointNoaaTowerSignalE(error_type, error_str);
        Q_EMIT searchTypePointNoaaTowerSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypePointNoaaTowerSignalError(error_type, error_str);
        Q_EMIT searchTypePointNoaaTowerSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypePointNoaaTowerApi::tokenAvailable(){
