...
#ifndef OAI_OAITypeFeedApi_H
#define OAI_OAITypeFeedApi_H
...
class OAITypeFeedApi : public QObject {
    Q_OBJECT

public:
    OAITypeFeedApi(const int timeOut = 0);
    ~OAITypeFeedApi();
...
Q_SIGNALS:
    ...
    void searchFeedSignal();


    void searchFeedSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchFeedSignalError() instead")
    void searchFeedSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchFeedSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
