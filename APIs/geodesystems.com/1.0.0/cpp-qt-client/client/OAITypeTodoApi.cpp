...
OAITypeTodoApi::OAITypeTodoApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTodoApi::~OAITypeTodoApi() {
}

void OAITypeTodoApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTodo", defaultConf);
    _serverIndices.insert("searchTodo", 0);
}
...
*/
int OAITypeTodoApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTodoApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTodoApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTodoApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTodoApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTodoApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTodoApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTodoApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTodoApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTodoApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTodoApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTodoApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTodoApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTodoApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTodoApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTodoApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTodoApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTodoApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTodoApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTodoApi::searchTodo(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<bool> &search_db_todo_checked, const ::OpenAPI::OptionalParam<QString> &search_db_todo_title, const ::OpenAPI::OptionalParam<QString> &search_db_todo_category) {
    QString fullPath = QString(_serverConfigs["searchTodo"][_serverIndices.value("searchTodo")].URL()+"/repository/search/type/todo");
    ...
    if (search_db_todo_checked.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.db_todo.checked", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.db_todo.checked")).append(querySuffix).append(QUrl::toPercentEncoding(search_db_todo_checked.stringValue()));
    }
    if (search_db_todo_title.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.db_todo.title", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.db_todo.title")).append(querySuffix).append(QUrl::toPercentEncoding(search_db_todo_title.stringValue()));
    }
    if (search_db_todo_category.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.db_todo.category", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.db_todo.category")).append(querySuffix).append(QUrl::toPercentEncoding(search_db_todo_category.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTodoApi::searchTodoCallback);
    connect(this, &OAITypeTodoApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTodoApi::searchTodoCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTodoSignal();
        Q_EMIT searchTodoSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTodoSignalE(error_type, error_str);
        Q_EMIT searchTodoSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTodoSignalError(error_type, error_str);
        Q_EMIT searchTodoSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTodoApi::tokenAvailable(){
