...
#include "OAITypeTypeEsriFeatureserverApi.h"
...
OAITypeTypeEsriFeatureserverApi::OAITypeTypeEsriFeatureserverApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeEsriFeatureserverApi::~OAITypeTypeEsriFeatureserverApi() {
}

void OAITypeTypeEsriFeatureserverApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeEsriFeatureserver", defaultConf);
    _serverIndices.insert("searchTypeEsriFeatureserver", 0);
}
...
*/
int OAITypeTypeEsriFeatureserverApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeEsriFeatureserverApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeEsriFeatureserverApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeEsriFeatureserverApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeEsriFeatureserverApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeEsriFeatureserverApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeEsriFeatureserverApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeEsriFeatureserverApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeEsriFeatureserverApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeEsriFeatureserverApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeEsriFeatureserverApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeEsriFeatureserverApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeEsriFeatureserverApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeEsriFeatureserverApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeEsriFeatureserverApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeEsriFeatureserverApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeEsriFeatureserverApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeEsriFeatureserverApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeEsriFeatureserverApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeEsriFeatureserverApi::searchTypeEsriFeatureserver(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeEsriFeatureserverApi::searchTypeEsriFeatureserverCallback);
    connect(this, &OAITypeTypeEsriFeatureserverApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeEsriFeatureserverApi::searchTypeEsriFeatureserverCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeEsriFeatureserverSignal();
        Q_EMIT searchTypeEsriFeatureserverSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeEsriFeatureserverSignalE(error_type, error_str);
        Q_EMIT searchTypeEsriFeatureserverSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeEsriFeatureserverSignalError(error_type, error_str);
        Q_EMIT searchTypeEsriFeatureserverSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeEsriFeatureserverApi::tokenAvailable(){
