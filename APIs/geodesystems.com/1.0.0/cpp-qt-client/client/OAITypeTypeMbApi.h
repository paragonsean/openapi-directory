...
#ifndef OAI_OAITypeTypeMbApi_H
#define OAI_OAITypeTypeMbApi_H
...
class OAITypeTypeMbApi : public QObject {
    Q_OBJECT

public:
    OAITypeTypeMbApi(const int timeOut = 0);
    ~OAITypeTypeMbApi();
...
private:
    ...
    void searchTypeMbCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void searchTypeMbSignal();


    void searchTypeMbSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchTypeMbSignalError() instead")
    void searchTypeMbSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchTypeMbSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use searchTypeMbSignalErrorFull() instead")
    void searchTypeMbSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchTypeMbSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
