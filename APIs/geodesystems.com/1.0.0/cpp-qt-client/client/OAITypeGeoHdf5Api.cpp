...
OAITypeGeoHdf5Api::OAITypeGeoHdf5Api(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeGeoHdf5Api::~OAITypeGeoHdf5Api() {
}

void OAITypeGeoHdf5Api::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchGeoHdf5", defaultConf);
    _serverIndices.insert("searchGeoHdf5", 0);
}
...
*/
int OAITypeGeoHdf5Api::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeGeoHdf5Api::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeGeoHdf5Api::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeGeoHdf5Api::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeGeoHdf5Api::setUsername(const QString &username) {
    _username = username;
}

void OAITypeGeoHdf5Api::setPassword(const QString &password) {
    _password = password;
}


void OAITypeGeoHdf5Api::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeGeoHdf5Api::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeGeoHdf5Api::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeGeoHdf5Api::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGeoHdf5Api::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGeoHdf5Api::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeGeoHdf5Api::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeGeoHdf5Api::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeGeoHdf5Api::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeGeoHdf5Api::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeGeoHdf5Api::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeGeoHdf5Api::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeGeoHdf5Api::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeGeoHdf5Api::searchGeoHdf5(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeGeoHdf5Api::searchGeoHdf5Callback);
    connect(this, &OAITypeGeoHdf5Api::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeGeoHdf5Api::searchGeoHdf5Callback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchGeoHdf5Signal();
        Q_EMIT searchGeoHdf5SignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchGeoHdf5SignalE(error_type, error_str);
        Q_EMIT searchGeoHdf5SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchGeoHdf5SignalError(error_type, error_str);
        Q_EMIT searchGeoHdf5SignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeGeoHdf5Api::tokenAvailable(){
