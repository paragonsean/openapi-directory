...
#ifndef OAI_OAITypeFaqApi_H
#define OAI_OAITypeFaqApi_H
...
class OAITypeFaqApi : public QObject {
    Q_OBJECT

public:
    OAITypeFaqApi(const int timeOut = 0);
    ~OAITypeFaqApi();
...
private:
    ...
    void searchFaqCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void searchFaqSignal();


    void searchFaqSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchFaqSignalError() instead")
    void searchFaqSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchFaqSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use searchFaqSignalErrorFull() instead")
    void searchFaqSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchFaqSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
