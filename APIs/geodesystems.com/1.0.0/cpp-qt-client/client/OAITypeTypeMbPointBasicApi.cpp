...
#include "OAITypeTypeMbPointBasicApi.h"
...
OAITypeTypeMbPointBasicApi::OAITypeTypeMbPointBasicApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeMbPointBasicApi::~OAITypeTypeMbPointBasicApi() {
}

void OAITypeTypeMbPointBasicApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeMbPointBasic", defaultConf);
    _serverIndices.insert("searchTypeMbPointBasic", 0);
}
...
*/
int OAITypeTypeMbPointBasicApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeMbPointBasicApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeMbPointBasicApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeMbPointBasicApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeMbPointBasicApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeMbPointBasicApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeMbPointBasicApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeMbPointBasicApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeMbPointBasicApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeMbPointBasicApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeMbPointBasicApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeMbPointBasicApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeMbPointBasicApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeMbPointBasicApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeMbPointBasicApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeMbPointBasicApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeMbPointBasicApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeMbPointBasicApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeMbPointBasicApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeMbPointBasicApi::searchTypeMbPointBasic(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeMbPointBasicApi::searchTypeMbPointBasicCallback);
    connect(this, &OAITypeTypeMbPointBasicApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeMbPointBasicApi::searchTypeMbPointBasicCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeMbPointBasicSignal();
        Q_EMIT searchTypeMbPointBasicSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeMbPointBasicSignalE(error_type, error_str);
        Q_EMIT searchTypeMbPointBasicSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeMbPointBasicSignalError(error_type, error_str);
        Q_EMIT searchTypeMbPointBasicSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeMbPointBasicApi::tokenAvailable(){
