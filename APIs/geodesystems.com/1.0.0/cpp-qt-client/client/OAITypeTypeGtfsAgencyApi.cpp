...
#include "OAITypeTypeGtfsAgencyApi.h"
...
OAITypeTypeGtfsAgencyApi::OAITypeTypeGtfsAgencyApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeGtfsAgencyApi::~OAITypeTypeGtfsAgencyApi() {
}

void OAITypeTypeGtfsAgencyApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeGtfsAgency", defaultConf);
    _serverIndices.insert("searchTypeGtfsAgency", 0);
}
...
*/
int OAITypeTypeGtfsAgencyApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeGtfsAgencyApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeGtfsAgencyApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeGtfsAgencyApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeGtfsAgencyApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeGtfsAgencyApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeGtfsAgencyApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeGtfsAgencyApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeGtfsAgencyApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeGtfsAgencyApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeGtfsAgencyApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeGtfsAgencyApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeGtfsAgencyApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeGtfsAgencyApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeGtfsAgencyApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeGtfsAgencyApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeGtfsAgencyApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeGtfsAgencyApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeGtfsAgencyApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeGtfsAgencyApi::searchTypeGtfsAgency(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeGtfsAgencyApi::searchTypeGtfsAgencyCallback);
    connect(this, &OAITypeTypeGtfsAgencyApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeGtfsAgencyApi::searchTypeGtfsAgencyCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeGtfsAgencySignal();
        Q_EMIT searchTypeGtfsAgencySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeGtfsAgencySignalE(error_type, error_str);
        Q_EMIT searchTypeGtfsAgencySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeGtfsAgencySignalError(error_type, error_str);
        Q_EMIT searchTypeGtfsAgencySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeGtfsAgencyApi::tokenAvailable(){
