...
#include "OAITypeTypeHazarddataApi.h"
...
OAITypeTypeHazarddataApi::OAITypeTypeHazarddataApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeHazarddataApi::~OAITypeTypeHazarddataApi() {
}

void OAITypeTypeHazarddataApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeHazarddata", defaultConf);
    _serverIndices.insert("searchTypeHazarddata", 0);
}
...
*/
int OAITypeTypeHazarddataApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeHazarddataApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeHazarddataApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeHazarddataApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeHazarddataApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeHazarddataApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeHazarddataApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeHazarddataApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeHazarddataApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeHazarddataApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeHazarddataApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeHazarddataApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeHazarddataApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeHazarddataApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeHazarddataApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeHazarddataApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeHazarddataApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeHazarddataApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeHazarddataApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeHazarddataApi::searchTypeHazarddata(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_type_hazarddata_source) {
    QString fullPath = QString(_serverConfigs["searchTypeHazarddata"][_serverIndices.value("searchTypeHazarddata")].URL()+"/repository/search/type/type_hazarddata");
    ...
    if (search_type_hazarddata_source.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.type_hazarddata.source", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.type_hazarddata.source")).append(querySuffix).append(QUrl::toPercentEncoding(search_type_hazarddata_source.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeHazarddataApi::searchTypeHazarddataCallback);
    connect(this, &OAITypeTypeHazarddataApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeHazarddataApi::searchTypeHazarddataCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeHazarddataSignal();
        Q_EMIT searchTypeHazarddataSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeHazarddataSignalE(error_type, error_str);
        Q_EMIT searchTypeHazarddataSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeHazarddataSignalError(error_type, error_str);
        Q_EMIT searchTypeHazarddataSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeHazarddataApi::tokenAvailable(){
