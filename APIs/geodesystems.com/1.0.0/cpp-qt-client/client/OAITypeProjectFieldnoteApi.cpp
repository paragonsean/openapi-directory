...
#include "OAITypeProjectFieldnoteApi.h"
...
OAITypeProjectFieldnoteApi::OAITypeProjectFieldnoteApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectFieldnoteApi::~OAITypeProjectFieldnoteApi() {
}

void OAITypeProjectFieldnoteApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectFieldnote", defaultConf);
    _serverIndices.insert("searchProjectFieldnote", 0);
}
...
*/
int OAITypeProjectFieldnoteApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectFieldnoteApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectFieldnoteApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectFieldnoteApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectFieldnoteApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectFieldnoteApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectFieldnoteApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectFieldnoteApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectFieldnoteApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectFieldnoteApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectFieldnoteApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectFieldnoteApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectFieldnoteApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectFieldnoteApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectFieldnoteApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectFieldnoteApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectFieldnoteApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectFieldnoteApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectFieldnoteApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectFieldnoteApi::searchProjectFieldnote(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectFieldnoteApi::searchProjectFieldnoteCallback);
    connect(this, &OAITypeProjectFieldnoteApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectFieldnoteApi::searchProjectFieldnoteCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectFieldnoteSignal();
        Q_EMIT searchProjectFieldnoteSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectFieldnoteSignalE(error_type, error_str);
        Q_EMIT searchProjectFieldnoteSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectFieldnoteSignalError(error_type, error_str);
        Q_EMIT searchProjectFieldnoteSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectFieldnoteApi::tokenAvailable(){
