...
#include "OAITypeGadgetsWeatherApi.h"
...
OAITypeGadgetsWeatherApi::OAITypeGadgetsWeatherApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeGadgetsWeatherApi::~OAITypeGadgetsWeatherApi() {
}

void OAITypeGadgetsWeatherApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchGadgetsWeather", defaultConf);
    _serverIndices.insert("searchGadgetsWeather", 0);
}
...
*/
int OAITypeGadgetsWeatherApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeGadgetsWeatherApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeGadgetsWeatherApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeGadgetsWeatherApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeGadgetsWeatherApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeGadgetsWeatherApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeGadgetsWeatherApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeGadgetsWeatherApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeGadgetsWeatherApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeGadgetsWeatherApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGadgetsWeatherApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGadgetsWeatherApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeGadgetsWeatherApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeGadgetsWeatherApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeGadgetsWeatherApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeGadgetsWeatherApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeGadgetsWeatherApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeGadgetsWeatherApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeGadgetsWeatherApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeGadgetsWeatherApi::searchGadgetsWeather(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeGadgetsWeatherApi::searchGadgetsWeatherCallback);
    connect(this, &OAITypeGadgetsWeatherApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeGadgetsWeatherApi::searchGadgetsWeatherCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchGadgetsWeatherSignal();
        Q_EMIT searchGadgetsWeatherSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchGadgetsWeatherSignalE(error_type, error_str);
        Q_EMIT searchGadgetsWeatherSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchGadgetsWeatherSignalError(error_type, error_str);
        Q_EMIT searchGadgetsWeatherSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeGadgetsWeatherApi::tokenAvailable(){
