...
#include "OAITypeBioStockholmApi.h"
...
OAITypeBioStockholmApi::OAITypeBioStockholmApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeBioStockholmApi::~OAITypeBioStockholmApi() {
}

void OAITypeBioStockholmApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchBioStockholm", defaultConf);
    _serverIndices.insert("searchBioStockholm", 0);
}
...
*/
int OAITypeBioStockholmApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeBioStockholmApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeBioStockholmApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeBioStockholmApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeBioStockholmApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeBioStockholmApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeBioStockholmApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeBioStockholmApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeBioStockholmApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeBioStockholmApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioStockholmApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioStockholmApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeBioStockholmApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeBioStockholmApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeBioStockholmApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeBioStockholmApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeBioStockholmApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeBioStockholmApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeBioStockholmApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeBioStockholmApi::searchBioStockholm(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeBioStockholmApi::searchBioStockholmCallback);
    connect(this, &OAITypeBioStockholmApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeBioStockholmApi::searchBioStockholmCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchBioStockholmSignal();
        Q_EMIT searchBioStockholmSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchBioStockholmSignalE(error_type, error_str);
        Q_EMIT searchBioStockholmSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchBioStockholmSignalError(error_type, error_str);
        Q_EMIT searchBioStockholmSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeBioStockholmApi::tokenAvailable(){
