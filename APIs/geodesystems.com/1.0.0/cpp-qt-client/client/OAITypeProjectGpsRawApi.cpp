...
#include "OAITypeProjectGpsRawApi.h"
...
OAITypeProjectGpsRawApi::OAITypeProjectGpsRawApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectGpsRawApi::~OAITypeProjectGpsRawApi() {
}

void OAITypeProjectGpsRawApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectGpsRaw", defaultConf);
    _serverIndices.insert("searchProjectGpsRaw", 0);
}
...
*/
int OAITypeProjectGpsRawApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectGpsRawApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectGpsRawApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectGpsRawApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectGpsRawApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectGpsRawApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectGpsRawApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectGpsRawApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectGpsRawApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectGpsRawApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectGpsRawApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectGpsRawApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectGpsRawApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectGpsRawApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectGpsRawApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectGpsRawApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectGpsRawApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectGpsRawApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectGpsRawApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectGpsRawApi::searchProjectGpsRaw(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectGpsRawApi::searchProjectGpsRawCallback);
    connect(this, &OAITypeProjectGpsRawApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectGpsRawApi::searchProjectGpsRawCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectGpsRawSignal();
        Q_EMIT searchProjectGpsRawSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectGpsRawSignalE(error_type, error_str);
        Q_EMIT searchProjectGpsRawSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectGpsRawSignalError(error_type, error_str);
        Q_EMIT searchProjectGpsRawSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectGpsRawApi::tokenAvailable(){
