...
OAITypeChatroomApi::OAITypeChatroomApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeChatroomApi::~OAITypeChatroomApi() {
}

void OAITypeChatroomApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchChatroom", defaultConf);
    _serverIndices.insert("searchChatroom", 0);
}
...
*/
int OAITypeChatroomApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeChatroomApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeChatroomApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeChatroomApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeChatroomApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeChatroomApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeChatroomApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeChatroomApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeChatroomApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeChatroomApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeChatroomApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeChatroomApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeChatroomApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeChatroomApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeChatroomApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeChatroomApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeChatroomApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeChatroomApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeChatroomApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeChatroomApi::searchChatroom(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeChatroomApi::searchChatroomCallback);
    connect(this, &OAITypeChatroomApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeChatroomApi::searchChatroomCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchChatroomSignal();
        Q_EMIT searchChatroomSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchChatroomSignalE(error_type, error_str);
        Q_EMIT searchChatroomSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchChatroomSignalError(error_type, error_str);
        Q_EMIT searchChatroomSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeChatroomApi::tokenAvailable(){
