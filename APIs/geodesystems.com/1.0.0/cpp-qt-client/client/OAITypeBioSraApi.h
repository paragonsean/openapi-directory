...
#ifndef OAI_OAITypeBioSraApi_H
#define OAI_OAITypeBioSraApi_H
...
class OAITypeBioSraApi : public QObject {
    Q_OBJECT

public:
    OAITypeBioSraApi(const int timeOut = 0);
    ~OAITypeBioSraApi();
...
private:
    ...
    void searchBioSraCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void searchBioSraSignal();


    void searchBioSraSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchBioSraSignalError() instead")
    void searchBioSraSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchBioSraSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use searchBioSraSignalErrorFull() instead")
    void searchBioSraSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchBioSraSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
