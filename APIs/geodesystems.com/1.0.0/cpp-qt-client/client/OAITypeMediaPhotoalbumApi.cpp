...
#include "OAITypeMediaPhotoalbumApi.h"
...
OAITypeMediaPhotoalbumApi::OAITypeMediaPhotoalbumApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeMediaPhotoalbumApi::~OAITypeMediaPhotoalbumApi() {
}

void OAITypeMediaPhotoalbumApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchMediaPhotoalbum", defaultConf);
    _serverIndices.insert("searchMediaPhotoalbum", 0);
}
...
*/
int OAITypeMediaPhotoalbumApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeMediaPhotoalbumApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeMediaPhotoalbumApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeMediaPhotoalbumApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeMediaPhotoalbumApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeMediaPhotoalbumApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeMediaPhotoalbumApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeMediaPhotoalbumApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeMediaPhotoalbumApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeMediaPhotoalbumApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeMediaPhotoalbumApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeMediaPhotoalbumApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeMediaPhotoalbumApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeMediaPhotoalbumApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeMediaPhotoalbumApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeMediaPhotoalbumApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeMediaPhotoalbumApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeMediaPhotoalbumApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeMediaPhotoalbumApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeMediaPhotoalbumApi::searchMediaPhotoalbum(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeMediaPhotoalbumApi::searchMediaPhotoalbumCallback);
    connect(this, &OAITypeMediaPhotoalbumApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeMediaPhotoalbumApi::searchMediaPhotoalbumCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchMediaPhotoalbumSignal();
        Q_EMIT searchMediaPhotoalbumSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchMediaPhotoalbumSignalE(error_type, error_str);
        Q_EMIT searchMediaPhotoalbumSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchMediaPhotoalbumSignalError(error_type, error_str);
        Q_EMIT searchMediaPhotoalbumSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeMediaPhotoalbumApi::tokenAvailable(){
