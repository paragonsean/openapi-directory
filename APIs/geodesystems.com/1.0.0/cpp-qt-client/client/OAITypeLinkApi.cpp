...
OAITypeLinkApi::OAITypeLinkApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeLinkApi::~OAITypeLinkApi() {
}

void OAITypeLinkApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchLink", defaultConf);
    _serverIndices.insert("searchLink", 0);
}
...
*/
int OAITypeLinkApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeLinkApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeLinkApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeLinkApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeLinkApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeLinkApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeLinkApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeLinkApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeLinkApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeLinkApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLinkApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLinkApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeLinkApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeLinkApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeLinkApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeLinkApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeLinkApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeLinkApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeLinkApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeLinkApi::searchLink(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeLinkApi::searchLinkCallback);
    connect(this, &OAITypeLinkApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeLinkApi::searchLinkCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchLinkSignal();
        Q_EMIT searchLinkSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchLinkSignalE(error_type, error_str);
        Q_EMIT searchLinkSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchLinkSignalError(error_type, error_str);
        Q_EMIT searchLinkSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeLinkApi::tokenAvailable(){
