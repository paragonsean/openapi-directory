...
#include "OAITypeTypeSoundingFrdApi.h"
...
OAITypeTypeSoundingFrdApi::OAITypeTypeSoundingFrdApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeSoundingFrdApi::~OAITypeTypeSoundingFrdApi() {
}

void OAITypeTypeSoundingFrdApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeSoundingFrd", defaultConf);
    _serverIndices.insert("searchTypeSoundingFrd", 0);
}
...
*/
int OAITypeTypeSoundingFrdApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeSoundingFrdApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeSoundingFrdApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeSoundingFrdApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeSoundingFrdApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeSoundingFrdApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeSoundingFrdApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeSoundingFrdApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeSoundingFrdApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeSoundingFrdApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeSoundingFrdApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeSoundingFrdApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeSoundingFrdApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeSoundingFrdApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeSoundingFrdApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeSoundingFrdApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeSoundingFrdApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeSoundingFrdApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeSoundingFrdApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeSoundingFrdApi::searchTypeSoundingFrd(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeSoundingFrdApi::searchTypeSoundingFrdCallback);
    connect(this, &OAITypeTypeSoundingFrdApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeSoundingFrdApi::searchTypeSoundingFrdCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeSoundingFrdSignal();
        Q_EMIT searchTypeSoundingFrdSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeSoundingFrdSignalE(error_type, error_str);
        Q_EMIT searchTypeSoundingFrdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeSoundingFrdSignalError(error_type, error_str);
        Q_EMIT searchTypeSoundingFrdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeSoundingFrdApi::tokenAvailable(){
