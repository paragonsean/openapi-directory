...
#include "OAITypeOwlOntologyApi.h"
...
OAITypeOwlOntologyApi::OAITypeOwlOntologyApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeOwlOntologyApi::~OAITypeOwlOntologyApi() {
}

void OAITypeOwlOntologyApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchOwl_ontology", defaultConf);
    _serverIndices.insert("searchOwl_ontology", 0);
}
...
*/
int OAITypeOwlOntologyApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeOwlOntologyApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeOwlOntologyApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeOwlOntologyApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeOwlOntologyApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeOwlOntologyApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeOwlOntologyApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeOwlOntologyApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeOwlOntologyApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeOwlOntologyApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeOwlOntologyApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeOwlOntologyApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeOwlOntologyApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeOwlOntologyApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeOwlOntologyApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeOwlOntologyApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeOwlOntologyApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeOwlOntologyApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeOwlOntologyApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeOwlOntologyApi::searchOwl_ontology(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeOwlOntologyApi::searchOwl_ontologyCallback);
    connect(this, &OAITypeOwlOntologyApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeOwlOntologyApi::searchOwl_ontologyCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchOwl_ontologySignal();
        Q_EMIT searchOwl_ontologySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchOwl_ontologySignalE(error_type, error_str);
        Q_EMIT searchOwl_ontologySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchOwl_ontologySignalError(error_type, error_str);
        Q_EMIT searchOwl_ontologySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeOwlOntologyApi::tokenAvailable(){
