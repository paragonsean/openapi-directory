...
#include "OAITypeTypeServiceGroupApi.h"
...
OAITypeTypeServiceGroupApi::OAITypeTypeServiceGroupApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeServiceGroupApi::~OAITypeTypeServiceGroupApi() {
}

void OAITypeTypeServiceGroupApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeServiceGroup", defaultConf);
    _serverIndices.insert("searchTypeServiceGroup", 0);
}
...
*/
int OAITypeTypeServiceGroupApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeServiceGroupApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeServiceGroupApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeServiceGroupApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeServiceGroupApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeServiceGroupApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeServiceGroupApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeServiceGroupApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeServiceGroupApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeServiceGroupApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeServiceGroupApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeServiceGroupApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeServiceGroupApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeServiceGroupApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeServiceGroupApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeServiceGroupApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeServiceGroupApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeServiceGroupApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeServiceGroupApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeServiceGroupApi::searchTypeServiceGroup(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeServiceGroupApi::searchTypeServiceGroupCallback);
    connect(this, &OAITypeTypeServiceGroupApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeServiceGroupApi::searchTypeServiceGroupCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeServiceGroupSignal();
        Q_EMIT searchTypeServiceGroupSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeServiceGroupSignalE(error_type, error_str);
        Q_EMIT searchTypeServiceGroupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeServiceGroupSignalError(error_type, error_str);
        Q_EMIT searchTypeServiceGroupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeServiceGroupApi::tokenAvailable(){
