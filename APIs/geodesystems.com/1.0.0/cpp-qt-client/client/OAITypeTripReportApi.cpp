...
#include "OAITypeTripReportApi.h"
...
OAITypeTripReportApi::OAITypeTripReportApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTripReportApi::~OAITypeTripReportApi() {
}

void OAITypeTripReportApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTripReport", defaultConf);
    _serverIndices.insert("searchTripReport", 0);
}
...
*/
int OAITypeTripReportApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTripReportApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTripReportApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTripReportApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTripReportApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTripReportApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTripReportApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTripReportApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTripReportApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTripReportApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTripReportApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTripReportApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTripReportApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTripReportApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTripReportApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTripReportApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTripReportApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTripReportApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTripReportApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTripReportApi::searchTripReport(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTripReportApi::searchTripReportCallback);
    connect(this, &OAITypeTripReportApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTripReportApi::searchTripReportCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTripReportSignal();
        Q_EMIT searchTripReportSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTripReportSignalE(error_type, error_str);
        Q_EMIT searchTripReportSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTripReportSignalError(error_type, error_str);
        Q_EMIT searchTripReportSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTripReportApi::tokenAvailable(){
