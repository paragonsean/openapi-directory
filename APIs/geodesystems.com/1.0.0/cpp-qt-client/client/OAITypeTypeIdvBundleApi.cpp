...
#include "OAITypeTypeIdvBundleApi.h"
...
OAITypeTypeIdvBundleApi::OAITypeTypeIdvBundleApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeIdvBundleApi::~OAITypeTypeIdvBundleApi() {
}

void OAITypeTypeIdvBundleApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeIdvBundle", defaultConf);
    _serverIndices.insert("searchTypeIdvBundle", 0);
}
...
*/
int OAITypeTypeIdvBundleApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeIdvBundleApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeIdvBundleApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeIdvBundleApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeIdvBundleApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeIdvBundleApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeIdvBundleApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeIdvBundleApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeIdvBundleApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeIdvBundleApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeIdvBundleApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeIdvBundleApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeIdvBundleApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeIdvBundleApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeIdvBundleApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeIdvBundleApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeIdvBundleApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeIdvBundleApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeIdvBundleApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeIdvBundleApi::searchTypeIdvBundle(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeIdvBundleApi::searchTypeIdvBundleCallback);
    connect(this, &OAITypeTypeIdvBundleApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeIdvBundleApi::searchTypeIdvBundleCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeIdvBundleSignal();
        Q_EMIT searchTypeIdvBundleSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeIdvBundleSignalE(error_type, error_str);
        Q_EMIT searchTypeIdvBundleSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeIdvBundleSignalError(error_type, error_str);
        Q_EMIT searchTypeIdvBundleSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeIdvBundleApi::tokenAvailable(){
