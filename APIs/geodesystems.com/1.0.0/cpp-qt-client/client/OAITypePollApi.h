...
#ifndef OAI_OAITypePollApi_H
#define OAI_OAITypePollApi_H
...
class OAITypePollApi : public QObject {
    Q_OBJECT

public:
    OAITypePollApi(const int timeOut = 0);
    ~OAITypePollApi();
...
private:
    ...
    void searchPollCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void searchPollSignal();


    void searchPollSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchPollSignalError() instead")
    void searchPollSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchPollSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use searchPollSignalErrorFull() instead")
    void searchPollSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchPollSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
