...
OAITypeLidarLasApi::OAITypeLidarLasApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeLidarLasApi::~OAITypeLidarLasApi() {
}

void OAITypeLidarLasApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchLidarLas", defaultConf);
    _serverIndices.insert("searchLidarLas", 0);
}
...
*/
int OAITypeLidarLasApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeLidarLasApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeLidarLasApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeLidarLasApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeLidarLasApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeLidarLasApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeLidarLasApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeLidarLasApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeLidarLasApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeLidarLasApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLidarLasApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeLidarLasApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeLidarLasApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeLidarLasApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeLidarLasApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeLidarLasApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeLidarLasApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeLidarLasApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeLidarLasApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeLidarLasApi::searchLidarLas(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeLidarLasApi::searchLidarLasCallback);
    connect(this, &OAITypeLidarLasApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeLidarLasApi::searchLidarLasCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchLidarLasSignal();
        Q_EMIT searchLidarLasSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchLidarLasSignalE(error_type, error_str);
        Q_EMIT searchLidarLasSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchLidarLasSignalError(error_type, error_str);
        Q_EMIT searchLidarLasSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeLidarLasApi::tokenAvailable(){
