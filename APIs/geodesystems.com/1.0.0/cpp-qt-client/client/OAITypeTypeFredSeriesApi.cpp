...
#include "OAITypeTypeFredSeriesApi.h"
...
OAITypeTypeFredSeriesApi::OAITypeTypeFredSeriesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeFredSeriesApi::~OAITypeTypeFredSeriesApi() {
}

void OAITypeTypeFredSeriesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeFredSeries", defaultConf);
    _serverIndices.insert("searchTypeFredSeries", 0);
}
...
*/
int OAITypeTypeFredSeriesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeFredSeriesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeFredSeriesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeFredSeriesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeFredSeriesApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeFredSeriesApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeFredSeriesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeFredSeriesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeFredSeriesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeFredSeriesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeFredSeriesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeFredSeriesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeFredSeriesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeFredSeriesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeFredSeriesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeFredSeriesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeFredSeriesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeFredSeriesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeFredSeriesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeFredSeriesApi::searchTypeFredSeries(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeFredSeriesApi::searchTypeFredSeriesCallback);
    connect(this, &OAITypeTypeFredSeriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeFredSeriesApi::searchTypeFredSeriesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeFredSeriesSignal();
        Q_EMIT searchTypeFredSeriesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeFredSeriesSignalE(error_type, error_str);
        Q_EMIT searchTypeFredSeriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeFredSeriesSignalError(error_type, error_str);
        Q_EMIT searchTypeFredSeriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeFredSeriesApi::tokenAvailable(){
