...
#include "OAITypeMediaVideoQuicktimeApi.h"
...
OAITypeMediaVideoQuicktimeApi::OAITypeMediaVideoQuicktimeApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeMediaVideoQuicktimeApi::~OAITypeMediaVideoQuicktimeApi() {
}

void OAITypeMediaVideoQuicktimeApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchMediaVideoQuicktime", defaultConf);
    _serverIndices.insert("searchMediaVideoQuicktime", 0);
}
...
*/
int OAITypeMediaVideoQuicktimeApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeMediaVideoQuicktimeApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeMediaVideoQuicktimeApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeMediaVideoQuicktimeApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeMediaVideoQuicktimeApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeMediaVideoQuicktimeApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeMediaVideoQuicktimeApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeMediaVideoQuicktimeApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeMediaVideoQuicktimeApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeMediaVideoQuicktimeApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeMediaVideoQuicktimeApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeMediaVideoQuicktimeApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeMediaVideoQuicktimeApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeMediaVideoQuicktimeApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeMediaVideoQuicktimeApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeMediaVideoQuicktimeApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeMediaVideoQuicktimeApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeMediaVideoQuicktimeApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeMediaVideoQuicktimeApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeMediaVideoQuicktimeApi::searchMediaVideoQuicktime(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeMediaVideoQuicktimeApi::searchMediaVideoQuicktimeCallback);
    connect(this, &OAITypeMediaVideoQuicktimeApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeMediaVideoQuicktimeApi::searchMediaVideoQuicktimeCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchMediaVideoQuicktimeSignal();
        Q_EMIT searchMediaVideoQuicktimeSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchMediaVideoQuicktimeSignalE(error_type, error_str);
        Q_EMIT searchMediaVideoQuicktimeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchMediaVideoQuicktimeSignalError(error_type, error_str);
        Q_EMIT searchMediaVideoQuicktimeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeMediaVideoQuicktimeApi::tokenAvailable(){
