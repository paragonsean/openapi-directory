...
#ifndef OAI_OAITypeGeoKmlApi_H
#define OAI_OAITypeGeoKmlApi_H
...
class OAITypeGeoKmlApi : public QObject {
    Q_OBJECT

public:
    OAITypeGeoKmlApi(const int timeOut = 0);
    ~OAITypeGeoKmlApi();
...
private:
    ...
    void searchGeoKmlCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void searchGeoKmlSignal();


    void searchGeoKmlSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchGeoKmlSignalError() instead")
    void searchGeoKmlSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchGeoKmlSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use searchGeoKmlSignalErrorFull() instead")
    void searchGeoKmlSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchGeoKmlSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
