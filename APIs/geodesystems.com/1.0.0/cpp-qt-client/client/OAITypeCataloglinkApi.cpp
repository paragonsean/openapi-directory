...
#include "OAITypeCataloglinkApi.h"
...
OAITypeCataloglinkApi::OAITypeCataloglinkApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeCataloglinkApi::~OAITypeCataloglinkApi() {
}

void OAITypeCataloglinkApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchCataloglink", defaultConf);
    _serverIndices.insert("searchCataloglink", 0);
}
...
*/
int OAITypeCataloglinkApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeCataloglinkApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeCataloglinkApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeCataloglinkApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeCataloglinkApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeCataloglinkApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeCataloglinkApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeCataloglinkApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeCataloglinkApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeCataloglinkApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeCataloglinkApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeCataloglinkApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeCataloglinkApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeCataloglinkApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeCataloglinkApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeCataloglinkApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeCataloglinkApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeCataloglinkApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeCataloglinkApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeCataloglinkApi::searchCataloglink(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeCataloglinkApi::searchCataloglinkCallback);
    connect(this, &OAITypeCataloglinkApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeCataloglinkApi::searchCataloglinkCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchCataloglinkSignal();
        Q_EMIT searchCataloglinkSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchCataloglinkSignalE(error_type, error_str);
        Q_EMIT searchCataloglinkSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchCataloglinkSignalError(error_type, error_str);
        Q_EMIT searchCataloglinkSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeCataloglinkApi::tokenAvailable(){
