...
OAITypeGroupApi::OAITypeGroupApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeGroupApi::~OAITypeGroupApi() {
}

void OAITypeGroupApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchGroup", defaultConf);
    _serverIndices.insert("searchGroup", 0);
}
...
*/
int OAITypeGroupApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeGroupApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeGroupApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeGroupApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeGroupApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeGroupApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeGroupApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeGroupApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeGroupApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeGroupApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGroupApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeGroupApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeGroupApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeGroupApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeGroupApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeGroupApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeGroupApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeGroupApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeGroupApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeGroupApi::searchGroup(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeGroupApi::searchGroupCallback);
    connect(this, &OAITypeGroupApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeGroupApi::searchGroupCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchGroupSignal();
        Q_EMIT searchGroupSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchGroupSignalE(error_type, error_str);
        Q_EMIT searchGroupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchGroupSignalError(error_type, error_str);
        Q_EMIT searchGroupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeGroupApi::tokenAvailable(){
