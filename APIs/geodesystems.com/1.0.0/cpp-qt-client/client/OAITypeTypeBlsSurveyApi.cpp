...
#include "OAITypeTypeBlsSurveyApi.h"
...
OAITypeTypeBlsSurveyApi::OAITypeTypeBlsSurveyApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeBlsSurveyApi::~OAITypeTypeBlsSurveyApi() {
}

void OAITypeTypeBlsSurveyApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeBlsSurvey", defaultConf);
    _serverIndices.insert("searchTypeBlsSurvey", 0);
}
...
*/
int OAITypeTypeBlsSurveyApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeBlsSurveyApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeBlsSurveyApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeBlsSurveyApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeBlsSurveyApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeBlsSurveyApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeBlsSurveyApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeBlsSurveyApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeBlsSurveyApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeBlsSurveyApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeBlsSurveyApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeBlsSurveyApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeBlsSurveyApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeBlsSurveyApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeBlsSurveyApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeBlsSurveyApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeBlsSurveyApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeBlsSurveyApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeBlsSurveyApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeBlsSurveyApi::searchTypeBlsSurvey(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeBlsSurveyApi::searchTypeBlsSurveyCallback);
    connect(this, &OAITypeTypeBlsSurveyApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeBlsSurveyApi::searchTypeBlsSurveyCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeBlsSurveySignal();
        Q_EMIT searchTypeBlsSurveySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeBlsSurveySignalE(error_type, error_str);
        Q_EMIT searchTypeBlsSurveySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeBlsSurveySignalError(error_type, error_str);
        Q_EMIT searchTypeBlsSurveySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeBlsSurveyApi::tokenAvailable(){
