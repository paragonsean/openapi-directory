...
OAITypeNwsfeedApi::OAITypeNwsfeedApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeNwsfeedApi::~OAITypeNwsfeedApi() {
}

void OAITypeNwsfeedApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchNwsfeed", defaultConf);
    _serverIndices.insert("searchNwsfeed", 0);
}
...
*/
int OAITypeNwsfeedApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeNwsfeedApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeNwsfeedApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeNwsfeedApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeNwsfeedApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeNwsfeedApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeNwsfeedApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeNwsfeedApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeNwsfeedApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeNwsfeedApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeNwsfeedApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeNwsfeedApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeNwsfeedApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeNwsfeedApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeNwsfeedApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeNwsfeedApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeNwsfeedApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeNwsfeedApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeNwsfeedApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeNwsfeedApi::searchNwsfeed(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeNwsfeedApi::searchNwsfeedCallback);
    connect(this, &OAITypeNwsfeedApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeNwsfeedApi::searchNwsfeedCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchNwsfeedSignal();
        Q_EMIT searchNwsfeedSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchNwsfeedSignalE(error_type, error_str);
        Q_EMIT searchNwsfeedSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchNwsfeedSignalError(error_type, error_str);
        Q_EMIT searchNwsfeedSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeNwsfeedApi::tokenAvailable(){
