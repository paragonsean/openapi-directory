...
#include "OAITypeTypeDocumentDocApi.h"
...
OAITypeTypeDocumentDocApi::OAITypeTypeDocumentDocApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeDocumentDocApi::~OAITypeTypeDocumentDocApi() {
}

void OAITypeTypeDocumentDocApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeDocumentDoc", defaultConf);
    _serverIndices.insert("searchTypeDocumentDoc", 0);
}
...
*/
int OAITypeTypeDocumentDocApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeDocumentDocApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeDocumentDocApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeDocumentDocApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeDocumentDocApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeDocumentDocApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeDocumentDocApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeDocumentDocApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeDocumentDocApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeDocumentDocApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDocumentDocApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDocumentDocApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeDocumentDocApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeDocumentDocApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeDocumentDocApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeDocumentDocApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeDocumentDocApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeDocumentDocApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeDocumentDocApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeDocumentDocApi::searchTypeDocumentDoc(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeDocumentDocApi::searchTypeDocumentDocCallback);
    connect(this, &OAITypeTypeDocumentDocApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeDocumentDocApi::searchTypeDocumentDocCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeDocumentDocSignal();
        Q_EMIT searchTypeDocumentDocSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeDocumentDocSignalE(error_type, error_str);
        Q_EMIT searchTypeDocumentDocSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeDocumentDocSignalError(error_type, error_str);
        Q_EMIT searchTypeDocumentDocSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeDocumentDocApi::tokenAvailable(){
