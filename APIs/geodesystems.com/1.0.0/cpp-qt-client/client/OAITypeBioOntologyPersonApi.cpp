...
#include "OAITypeBioOntologyPersonApi.h"
...
OAITypeBioOntologyPersonApi::OAITypeBioOntologyPersonApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeBioOntologyPersonApi::~OAITypeBioOntologyPersonApi() {
}

void OAITypeBioOntologyPersonApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchBioOntologyPerson", defaultConf);
    _serverIndices.insert("searchBioOntologyPerson", 0);
}
...
*/
int OAITypeBioOntologyPersonApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeBioOntologyPersonApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeBioOntologyPersonApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeBioOntologyPersonApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeBioOntologyPersonApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeBioOntologyPersonApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeBioOntologyPersonApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeBioOntologyPersonApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeBioOntologyPersonApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeBioOntologyPersonApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioOntologyPersonApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeBioOntologyPersonApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeBioOntologyPersonApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeBioOntologyPersonApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeBioOntologyPersonApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeBioOntologyPersonApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeBioOntologyPersonApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeBioOntologyPersonApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeBioOntologyPersonApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeBioOntologyPersonApi::searchBioOntologyPerson(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_bio_ontology_person_gender) {
    QString fullPath = QString(_serverConfigs["searchBioOntologyPerson"][_serverIndices.value("searchBioOntologyPerson")].URL()+"/repository/search/type/bio_ontology_person");
    ...
    if (search_bio_ontology_person_gender.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.bio_ontology_person.gender", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.bio_ontology_person.gender")).append(querySuffix).append(QUrl::toPercentEncoding(search_bio_ontology_person_gender.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeBioOntologyPersonApi::searchBioOntologyPersonCallback);
    connect(this, &OAITypeBioOntologyPersonApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeBioOntologyPersonApi::searchBioOntologyPersonCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchBioOntologyPersonSignal();
        Q_EMIT searchBioOntologyPersonSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchBioOntologyPersonSignalE(error_type, error_str);
        Q_EMIT searchBioOntologyPersonSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchBioOntologyPersonSignalError(error_type, error_str);
        Q_EMIT searchBioOntologyPersonSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeBioOntologyPersonApi::tokenAvailable(){
