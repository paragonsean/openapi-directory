...
#include "OAITypeTypeEsriRestserverApi.h"
...
OAITypeTypeEsriRestserverApi::OAITypeTypeEsriRestserverApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeEsriRestserverApi::~OAITypeTypeEsriRestserverApi() {
}

void OAITypeTypeEsriRestserverApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeEsriRestserver", defaultConf);
    _serverIndices.insert("searchTypeEsriRestserver", 0);
}
...
*/
int OAITypeTypeEsriRestserverApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeEsriRestserverApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeEsriRestserverApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeEsriRestserverApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeEsriRestserverApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeEsriRestserverApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeEsriRestserverApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeEsriRestserverApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeEsriRestserverApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeEsriRestserverApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeEsriRestserverApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeEsriRestserverApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeEsriRestserverApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeEsriRestserverApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeEsriRestserverApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeEsriRestserverApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeEsriRestserverApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeEsriRestserverApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeEsriRestserverApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeEsriRestserverApi::searchTypeEsriRestserver(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeEsriRestserverApi::searchTypeEsriRestserverCallback);
    connect(this, &OAITypeTypeEsriRestserverApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeEsriRestserverApi::searchTypeEsriRestserverCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeEsriRestserverSignal();
        Q_EMIT searchTypeEsriRestserverSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeEsriRestserverSignalE(error_type, error_str);
        Q_EMIT searchTypeEsriRestserverSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeEsriRestserverSignalError(error_type, error_str);
        Q_EMIT searchTypeEsriRestserverSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeEsriRestserverApi::tokenAvailable(){
