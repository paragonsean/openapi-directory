...
#include "OAITypeProjectCampaignApi.h"
...
OAITypeProjectCampaignApi::OAITypeProjectCampaignApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeProjectCampaignApi::~OAITypeProjectCampaignApi() {
}

void OAITypeProjectCampaignApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchProjectCampaign", defaultConf);
    _serverIndices.insert("searchProjectCampaign", 0);
}
...
*/
int OAITypeProjectCampaignApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeProjectCampaignApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeProjectCampaignApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeProjectCampaignApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeProjectCampaignApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeProjectCampaignApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeProjectCampaignApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeProjectCampaignApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeProjectCampaignApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeProjectCampaignApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectCampaignApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeProjectCampaignApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeProjectCampaignApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeProjectCampaignApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeProjectCampaignApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeProjectCampaignApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeProjectCampaignApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeProjectCampaignApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeProjectCampaignApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeProjectCampaignApi::searchProjectCampaign(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeProjectCampaignApi::searchProjectCampaignCallback);
    connect(this, &OAITypeProjectCampaignApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeProjectCampaignApi::searchProjectCampaignCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchProjectCampaignSignal();
        Q_EMIT searchProjectCampaignSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchProjectCampaignSignalE(error_type, error_str);
        Q_EMIT searchProjectCampaignSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchProjectCampaignSignalError(error_type, error_str);
        Q_EMIT searchProjectCampaignSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeProjectCampaignApi::tokenAvailable(){
