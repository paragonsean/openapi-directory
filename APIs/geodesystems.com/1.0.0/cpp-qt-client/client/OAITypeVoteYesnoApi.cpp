...
OAITypeVoteYesnoApi::OAITypeVoteYesnoApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeVoteYesnoApi::~OAITypeVoteYesnoApi() {
}

void OAITypeVoteYesnoApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchVoteYesno", defaultConf);
    _serverIndices.insert("searchVoteYesno", 0);
}
...
*/
int OAITypeVoteYesnoApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeVoteYesnoApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeVoteYesnoApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeVoteYesnoApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeVoteYesnoApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeVoteYesnoApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeVoteYesnoApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeVoteYesnoApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeVoteYesnoApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeVoteYesnoApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeVoteYesnoApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeVoteYesnoApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeVoteYesnoApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeVoteYesnoApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeVoteYesnoApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeVoteYesnoApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeVoteYesnoApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeVoteYesnoApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeVoteYesnoApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeVoteYesnoApi::searchVoteYesno(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_db_vote_yesno_vote) {
    QString fullPath = QString(_serverConfigs["searchVoteYesno"][_serverIndices.value("searchVoteYesno")].URL()+"/repository/search/type/vote_yesno");
    ...
    if (search_db_vote_yesno_vote.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.db_vote_yesno.vote", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.db_vote_yesno.vote")).append(querySuffix).append(QUrl::toPercentEncoding(search_db_vote_yesno_vote.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeVoteYesnoApi::searchVoteYesnoCallback);
    connect(this, &OAITypeVoteYesnoApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeVoteYesnoApi::searchVoteYesnoCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchVoteYesnoSignal();
        Q_EMIT searchVoteYesnoSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchVoteYesnoSignalE(error_type, error_str);
        Q_EMIT searchVoteYesnoSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchVoteYesnoSignalError(error_type, error_str);
        Q_EMIT searchVoteYesnoSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeVoteYesnoApi::tokenAvailable(){
