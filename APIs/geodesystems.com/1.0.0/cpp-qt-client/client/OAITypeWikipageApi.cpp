...
OAITypeWikipageApi::OAITypeWikipageApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeWikipageApi::~OAITypeWikipageApi() {
}

void OAITypeWikipageApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchWikipage", defaultConf);
    _serverIndices.insert("searchWikipage", 0);
}
...
*/
int OAITypeWikipageApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeWikipageApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeWikipageApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeWikipageApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeWikipageApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeWikipageApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeWikipageApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeWikipageApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeWikipageApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeWikipageApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeWikipageApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeWikipageApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeWikipageApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeWikipageApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeWikipageApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeWikipageApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeWikipageApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeWikipageApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeWikipageApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeWikipageApi::searchWikipage(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_wikipage_wikitext, const ::OpenAPI::OptionalParam<QString> &search_wikipage_category) {
    QString fullPath = QString(_serverConfigs["searchWikipage"][_serverIndices.value("searchWikipage")].URL()+"/repository/search/type/wikipage");
    ...
    if (search_wikipage_wikitext.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.wikipage.wikitext", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.wikipage.wikitext")).append(querySuffix).append(QUrl::toPercentEncoding(search_wikipage_wikitext.stringValue()));
    }
    if (search_wikipage_category.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.wikipage.category", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.wikipage.category")).append(querySuffix).append(QUrl::toPercentEncoding(search_wikipage_category.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeWikipageApi::searchWikipageCallback);
    connect(this, &OAITypeWikipageApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeWikipageApi::searchWikipageCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchWikipageSignal();
        Q_EMIT searchWikipageSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchWikipageSignalE(error_type, error_str);
        Q_EMIT searchWikipageSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchWikipageSignalError(error_type, error_str);
        Q_EMIT searchWikipageSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeWikipageApi::tokenAvailable(){
