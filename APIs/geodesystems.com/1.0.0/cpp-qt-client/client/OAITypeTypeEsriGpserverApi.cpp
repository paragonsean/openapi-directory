...
#include "OAITypeTypeEsriGpserverApi.h"
...
OAITypeTypeEsriGpserverApi::OAITypeTypeEsriGpserverApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeEsriGpserverApi::~OAITypeTypeEsriGpserverApi() {
}

void OAITypeTypeEsriGpserverApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeEsriGpserver", defaultConf);
    _serverIndices.insert("searchTypeEsriGpserver", 0);
}
...
*/
int OAITypeTypeEsriGpserverApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeEsriGpserverApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeEsriGpserverApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeEsriGpserverApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeEsriGpserverApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeEsriGpserverApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeEsriGpserverApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeEsriGpserverApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeEsriGpserverApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeEsriGpserverApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeEsriGpserverApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeEsriGpserverApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeEsriGpserverApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeEsriGpserverApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeEsriGpserverApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeEsriGpserverApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeEsriGpserverApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeEsriGpserverApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeEsriGpserverApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeEsriGpserverApi::searchTypeEsriGpserver(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeEsriGpserverApi::searchTypeEsriGpserverCallback);
    connect(this, &OAITypeTypeEsriGpserverApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeEsriGpserverApi::searchTypeEsriGpserverCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeEsriGpserverSignal();
        Q_EMIT searchTypeEsriGpserverSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeEsriGpserverSignalE(error_type, error_str);
        Q_EMIT searchTypeEsriGpserverSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeEsriGpserverSignalError(error_type, error_str);
        Q_EMIT searchTypeEsriGpserverSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeEsriGpserverApi::tokenAvailable(){
