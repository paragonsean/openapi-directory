...
#include "OAITypeTypeHydroColoradoApi.h"
...
OAITypeTypeHydroColoradoApi::OAITypeTypeHydroColoradoApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeHydroColoradoApi::~OAITypeTypeHydroColoradoApi() {
}

void OAITypeTypeHydroColoradoApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeHydroColorado", defaultConf);
    _serverIndices.insert("searchTypeHydroColorado", 0);
}
...
*/
int OAITypeTypeHydroColoradoApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeHydroColoradoApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeHydroColoradoApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeHydroColoradoApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeHydroColoradoApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeHydroColoradoApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeHydroColoradoApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeHydroColoradoApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeHydroColoradoApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeHydroColoradoApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeHydroColoradoApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeHydroColoradoApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeHydroColoradoApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeHydroColoradoApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeHydroColoradoApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeHydroColoradoApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeHydroColoradoApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeHydroColoradoApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeHydroColoradoApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeHydroColoradoApi::searchTypeHydroColorado(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &search_type_hydro_colorado_site_id) {
    ...
    if (search_type_hydro_colorado_site_id.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "search.type_hydro_colorado.site_id", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("search.type_hydro_colorado.site_id")).append(querySuffix).append(QUrl::toPercentEncoding(search_type_hydro_colorado_site_id.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeHydroColoradoApi::searchTypeHydroColoradoCallback);
    connect(this, &OAITypeTypeHydroColoradoApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeHydroColoradoApi::searchTypeHydroColoradoCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeHydroColoradoSignal();
        Q_EMIT searchTypeHydroColoradoSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeHydroColoradoSignalE(error_type, error_str);
        Q_EMIT searchTypeHydroColoradoSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeHydroColoradoSignalError(error_type, error_str);
        Q_EMIT searchTypeHydroColoradoSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeHydroColoradoApi::tokenAvailable(){
