...
#include "OAITypeTypeSoundingWyomingApi.h"
...
OAITypeTypeSoundingWyomingApi::OAITypeTypeSoundingWyomingApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeSoundingWyomingApi::~OAITypeTypeSoundingWyomingApi() {
}

void OAITypeTypeSoundingWyomingApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeSoundingWyoming", defaultConf);
    _serverIndices.insert("searchTypeSoundingWyoming", 0);
}
...
*/
int OAITypeTypeSoundingWyomingApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeSoundingWyomingApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeSoundingWyomingApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeSoundingWyomingApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeSoundingWyomingApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeSoundingWyomingApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeSoundingWyomingApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeSoundingWyomingApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeSoundingWyomingApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeSoundingWyomingApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeSoundingWyomingApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeSoundingWyomingApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeSoundingWyomingApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeSoundingWyomingApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeSoundingWyomingApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeSoundingWyomingApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeSoundingWyomingApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeSoundingWyomingApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeSoundingWyomingApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeSoundingWyomingApi::searchTypeSoundingWyoming(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeSoundingWyomingApi::searchTypeSoundingWyomingCallback);
    connect(this, &OAITypeTypeSoundingWyomingApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeSoundingWyomingApi::searchTypeSoundingWyomingCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeSoundingWyomingSignal();
        Q_EMIT searchTypeSoundingWyomingSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeSoundingWyomingSignalE(error_type, error_str);
        Q_EMIT searchTypeSoundingWyomingSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeSoundingWyomingSignalError(error_type, error_str);
        Q_EMIT searchTypeSoundingWyomingSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeSoundingWyomingApi::tokenAvailable(){
