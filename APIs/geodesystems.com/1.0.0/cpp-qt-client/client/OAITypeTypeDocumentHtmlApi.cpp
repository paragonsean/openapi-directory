...
#include "OAITypeTypeDocumentHtmlApi.h"
...
OAITypeTypeDocumentHtmlApi::OAITypeTypeDocumentHtmlApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeTypeDocumentHtmlApi::~OAITypeTypeDocumentHtmlApi() {
}

void OAITypeTypeDocumentHtmlApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchTypeDocumentHtml", defaultConf);
    _serverIndices.insert("searchTypeDocumentHtml", 0);
}
...
*/
int OAITypeTypeDocumentHtmlApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeTypeDocumentHtmlApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeTypeDocumentHtmlApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeTypeDocumentHtmlApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeTypeDocumentHtmlApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeTypeDocumentHtmlApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeTypeDocumentHtmlApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeTypeDocumentHtmlApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeTypeDocumentHtmlApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeTypeDocumentHtmlApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDocumentHtmlApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeTypeDocumentHtmlApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeTypeDocumentHtmlApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeTypeDocumentHtmlApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeTypeDocumentHtmlApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeTypeDocumentHtmlApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeTypeDocumentHtmlApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeTypeDocumentHtmlApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeTypeDocumentHtmlApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeTypeDocumentHtmlApi::searchTypeDocumentHtml(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeTypeDocumentHtmlApi::searchTypeDocumentHtmlCallback);
    connect(this, &OAITypeTypeDocumentHtmlApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeTypeDocumentHtmlApi::searchTypeDocumentHtmlCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchTypeDocumentHtmlSignal();
        Q_EMIT searchTypeDocumentHtmlSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchTypeDocumentHtmlSignalE(error_type, error_str);
        Q_EMIT searchTypeDocumentHtmlSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchTypeDocumentHtmlSignalError(error_type, error_str);
        Q_EMIT searchTypeDocumentHtmlSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeTypeDocumentHtmlApi::tokenAvailable(){
