...
OAITypeCalendarApi::OAITypeCalendarApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITypeCalendarApi::~OAITypeCalendarApi() {
}

void OAITypeCalendarApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("searchCalendar", defaultConf);
    _serverIndices.insert("searchCalendar", 0);
}
...
*/
int OAITypeCalendarApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITypeCalendarApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITypeCalendarApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITypeCalendarApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITypeCalendarApi::setUsername(const QString &username) {
    _username = username;
}

void OAITypeCalendarApi::setPassword(const QString &password) {
    _password = password;
}


void OAITypeCalendarApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITypeCalendarApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITypeCalendarApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITypeCalendarApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeCalendarApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITypeCalendarApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITypeCalendarApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITypeCalendarApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITypeCalendarApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITypeCalendarApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITypeCalendarApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITypeCalendarApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITypeCalendarApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITypeCalendarApi::searchCalendar(const ::OpenAPI::OptionalParam<QString> &text, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QDateTime> &fromdate, const ::OpenAPI::OptionalParam<QDateTime> &todate, const ::OpenAPI::OptionalParam<QDateTime> &createdate_from, const ::OpenAPI::OptionalParam<QDateTime> &createdate_to, const ::OpenAPI::OptionalParam<QDateTime> &changedate_from, const ::OpenAPI::OptionalParam<QDateTime> &changedate_to, const ::OpenAPI::OptionalParam<QString> &group, const ::OpenAPI::OptionalParam<QString> &filesuffix, const ::OpenAPI::OptionalParam<float> &maxlatitude, const ::OpenAPI::OptionalParam<float> &minlongitude, const ::OpenAPI::OptionalParam<float> &minlatitude, const ::OpenAPI::OptionalParam<float> &maxlongitude, const ::OpenAPI::OptionalParam<qint32> &max, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITypeCalendarApi::searchCalendarCallback);
    connect(this, &OAITypeCalendarApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITypeCalendarApi::searchCalendarCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchCalendarSignal();
        Q_EMIT searchCalendarSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchCalendarSignalE(error_type, error_str);
        Q_EMIT searchCalendarSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchCalendarSignalError(error_type, error_str);
        Q_EMIT searchCalendarSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITypeCalendarApi::tokenAvailable(){
