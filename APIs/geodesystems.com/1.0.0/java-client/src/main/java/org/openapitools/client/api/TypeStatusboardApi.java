...
public class TypeStatusboardApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TypeStatusboardApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TypeStatusboardApi(ApiClient apiClient) {
    ...
    /**
     * Build call for searchStatusboard
     ...
     * @param searchDbStatusboardWhat What (optional)
     * @param searchDbStatusboardStatus Status (optional)
    ...
    public okhttp3.Call searchStatusboardCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchDbStatusboardWhat, String searchDbStatusboardStatus, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/repository/search/type/statusboard";
        ...
        if (searchDbStatusboardWhat != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("search.db_statusboard.what", searchDbStatusboardWhat));
        }

        if (searchDbStatusboardStatus != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("search.db_statusboard.status", searchDbStatusboardStatus));
        }
    ...
    private okhttp3.Call searchStatusboardValidateBeforeCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchDbStatusboardWhat, String searchDbStatusboardStatus, final ApiCallback _callback) throws ApiException {
        return searchStatusboardCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbStatusboardWhat, searchDbStatusboardStatus, _callback);
     ...
     */
    public void searchStatusboard(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchDbStatusboardWhat, String searchDbStatusboardStatus) throws ApiException {
        searchStatusboardWithHttpInfo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbStatusboardWhat, searchDbStatusboardStatus);
    }
     ...
     */
    public ApiResponse<Void> searchStatusboardWithHttpInfo(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchDbStatusboardWhat, String searchDbStatusboardStatus) throws ApiException {
        okhttp3.Call localVarCall = searchStatusboardValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbStatusboardWhat, searchDbStatusboardStatus, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Search API for &#39;Status Board&#39; entry type (asynchronously)
     * API to search for entries of type Status Board
     * @param text Search text (optional)
     * @param name Search name (optional)
     * @param description Search description (optional)
     ...
     */
    public okhttp3.Call searchStatusboardAsync(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchDbStatusboardWhat, String searchDbStatusboardStatus, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchStatusboardValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbStatusboardWhat, searchDbStatusboardStatus, _callback);
