...
public class TypeTypePsdMonthlyClimateIndexApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TypeTypePsdMonthlyClimateIndexApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TypeTypePsdMonthlyClimateIndexApi(ApiClient apiClient) {
    ...
    /**
     * Build call for searchTypePsdMonthlyClimateIndex
     ...
     * @param searchTypePsdMonthlyClimateIndexUnits Units (optional)
    ...
    public okhttp3.Call searchTypePsdMonthlyClimateIndexCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchTypePsdMonthlyClimateIndexUnits, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/repository/search/type/type_psd_monthly_climate_index";
        ...
        if (searchTypePsdMonthlyClimateIndexUnits != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("search.type_psd_monthly_climate_index.units", searchTypePsdMonthlyClimateIndexUnits));
        }
    ...
    private okhttp3.Call searchTypePsdMonthlyClimateIndexValidateBeforeCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchTypePsdMonthlyClimateIndexUnits, final ApiCallback _callback) throws ApiException {
        return searchTypePsdMonthlyClimateIndexCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePsdMonthlyClimateIndexUnits, _callback);
     ...
     */
    public void searchTypePsdMonthlyClimateIndex(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchTypePsdMonthlyClimateIndexUnits) throws ApiException {
        searchTypePsdMonthlyClimateIndexWithHttpInfo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePsdMonthlyClimateIndexUnits);
    }
     ...
     */
    public ApiResponse<Void> searchTypePsdMonthlyClimateIndexWithHttpInfo(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchTypePsdMonthlyClimateIndexUnits) throws ApiException {
        okhttp3.Call localVarCall = searchTypePsdMonthlyClimateIndexValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePsdMonthlyClimateIndexUnits, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Search API for &#39;NOAA-ESRL-PSD Monthly Climate Index&#39; entry type (asynchronously)
     * API to search for entries of type NOAA-ESRL-PSD Monthly Climate Index
     * @param text Search text (optional)
     * @param name Search name (optional)
     * @param description Search description (optional)
     ...
     */
    public okhttp3.Call searchTypePsdMonthlyClimateIndexAsync(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchTypePsdMonthlyClimateIndexUnits, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchTypePsdMonthlyClimateIndexValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePsdMonthlyClimateIndexUnits, _callback);
