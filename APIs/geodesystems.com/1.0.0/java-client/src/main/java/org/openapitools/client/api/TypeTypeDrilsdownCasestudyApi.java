...
public class TypeTypeDrilsdownCasestudyApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TypeTypeDrilsdownCasestudyApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TypeTypeDrilsdownCasestudyApi(ApiClient apiClient) {
    ...
    /**
     * Build call for searchTypeDrilsdownCasestudy
    ...
    public okhttp3.Call searchTypeDrilsdownCasestudyCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/repository/search/type/type_drilsdown_casestudy";
    ...
    private okhttp3.Call searchTypeDrilsdownCasestudyValidateBeforeCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, final ApiCallback _callback) throws ApiException {
        return searchTypeDrilsdownCasestudyCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, _callback);
     ...
     */
    public void searchTypeDrilsdownCasestudy(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip) throws ApiException {
        searchTypeDrilsdownCasestudyWithHttpInfo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    }
     ...
     */
    public ApiResponse<Void> searchTypeDrilsdownCasestudyWithHttpInfo(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip) throws ApiException {
        okhttp3.Call localVarCall = searchTypeDrilsdownCasestudyValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Search API for &#39;Drilsdown Case Study&#39; entry type (asynchronously)
     * API to search for entries of type Drilsdown Case Study
     * @param text Search text (optional)
     * @param name Search name (optional)
     * @param description Search description (optional)
     ...
     */
    public okhttp3.Call searchTypeDrilsdownCasestudyAsync(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchTypeDrilsdownCasestudyValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, _callback);
