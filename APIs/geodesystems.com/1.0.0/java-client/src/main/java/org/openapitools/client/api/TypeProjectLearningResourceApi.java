...
public class TypeProjectLearningResourceApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TypeProjectLearningResourceApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TypeProjectLearningResourceApi(ApiClient apiClient) {
    ...
    /**
     * Build call for searchProjectLearningResource
     ...
     * @param searchProjectLearningResourceTopic Topic (optional)
     * @param searchProjectLearningResourceGradeLevel Grade Level (optional)
    ...
    public okhttp3.Call searchProjectLearningResourceCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchProjectLearningResourceTopic, String searchProjectLearningResourceGradeLevel, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/repository/search/type/project_learning_resource";
        ...
        if (searchProjectLearningResourceTopic != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("search.project_learning_resource.topic", searchProjectLearningResourceTopic));
        }

        if (searchProjectLearningResourceGradeLevel != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("search.project_learning_resource.grade_level", searchProjectLearningResourceGradeLevel));
        }
    ...
    private okhttp3.Call searchProjectLearningResourceValidateBeforeCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchProjectLearningResourceTopic, String searchProjectLearningResourceGradeLevel, final ApiCallback _callback) throws ApiException {
        return searchProjectLearningResourceCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectLearningResourceTopic, searchProjectLearningResourceGradeLevel, _callback);
     ...
     */
    public void searchProjectLearningResource(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchProjectLearningResourceTopic, String searchProjectLearningResourceGradeLevel) throws ApiException {
        searchProjectLearningResourceWithHttpInfo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectLearningResourceTopic, searchProjectLearningResourceGradeLevel);
    }
     ...
     */
    public ApiResponse<Void> searchProjectLearningResourceWithHttpInfo(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchProjectLearningResourceTopic, String searchProjectLearningResourceGradeLevel) throws ApiException {
        okhttp3.Call localVarCall = searchProjectLearningResourceValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectLearningResourceTopic, searchProjectLearningResourceGradeLevel, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Search API for &#39;Teaching Resource&#39; entry type (asynchronously)
     * API to search for entries of type Teaching Resource
     * @param text Search text (optional)
     * @param name Search name (optional)
     * @param description Search description (optional)
     ...
     */
    public okhttp3.Call searchProjectLearningResourceAsync(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchProjectLearningResourceTopic, String searchProjectLearningResourceGradeLevel, final ApiCallback<Void> _callback) throws ApiException {
