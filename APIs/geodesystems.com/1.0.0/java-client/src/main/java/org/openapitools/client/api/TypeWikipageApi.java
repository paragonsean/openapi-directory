...
public class TypeWikipageApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TypeWikipageApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TypeWikipageApi(ApiClient apiClient) {
     ...
     * @param searchWikipageWikitext Wiki Text (optional)
     * @param searchWikipageCategory Wiki Page Category (optional)
    ...
    public okhttp3.Call searchWikipageCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchWikipageWikitext, String searchWikipageCategory, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/repository/search/type/wikipage";
        ...
        if (searchWikipageWikitext != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("search.wikipage.wikitext", searchWikipageWikitext));
        }

        if (searchWikipageCategory != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("search.wikipage.category", searchWikipageCategory));
        }
    ...
    private okhttp3.Call searchWikipageValidateBeforeCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchWikipageWikitext, String searchWikipageCategory, final ApiCallback _callback) throws ApiException {
        return searchWikipageCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchWikipageWikitext, searchWikipageCategory, _callback);
     ...
     */
    public void searchWikipage(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchWikipageWikitext, String searchWikipageCategory) throws ApiException {
        searchWikipageWithHttpInfo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchWikipageWikitext, searchWikipageCategory);
    }
     ...
     */
    public ApiResponse<Void> searchWikipageWithHttpInfo(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchWikipageWikitext, String searchWikipageCategory) throws ApiException {
        okhttp3.Call localVarCall = searchWikipageValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchWikipageWikitext, searchWikipageCategory, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Search API for &#39;Wiki Page&#39; entry type (asynchronously)
     * API to search for entries of type Wiki Page
     * @param text Search text (optional)
     * @param name Search name (optional)
     * @param description Search description (optional)
     ...
     */
    public okhttp3.Call searchWikipageAsync(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchWikipageWikitext, String searchWikipageCategory, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchWikipageValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchWikipageWikitext, searchWikipageCategory, _callback);
