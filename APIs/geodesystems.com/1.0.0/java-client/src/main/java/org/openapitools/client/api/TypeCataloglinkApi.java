...
public class TypeCataloglinkApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TypeCataloglinkApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TypeCataloglinkApi(ApiClient apiClient) {
    ...
    /**
     * Build call for searchCataloglink
    ...
    public okhttp3.Call searchCataloglinkCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/repository/search/type/cataloglink";
    ...
    private okhttp3.Call searchCataloglinkValidateBeforeCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, final ApiCallback _callback) throws ApiException {
        return searchCataloglinkCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, _callback);
     ...
     */
    public void searchCataloglink(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip) throws ApiException {
        searchCataloglinkWithHttpInfo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    }
     ...
     */
    public ApiResponse<Void> searchCataloglinkWithHttpInfo(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip) throws ApiException {
        okhttp3.Call localVarCall = searchCataloglinkValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Search API for &#39;Catalog Link&#39; entry type (asynchronously)
     * API to search for entries of type Catalog Link
     * @param text Search text (optional)
     * @param name Search name (optional)
     * @param description Search description (optional)
     ...
     */
    public okhttp3.Call searchCataloglinkAsync(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchCataloglinkValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, _callback);
