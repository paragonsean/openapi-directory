...
public class TypeBioOntologyPersonApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TypeBioOntologyPersonApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TypeBioOntologyPersonApi(ApiClient apiClient) {
    ...
    /**
     * Build call for searchBioOntologyPerson
     ...
     * @param searchBioOntologyPersonGender Gender (optional)
    ...
    public okhttp3.Call searchBioOntologyPersonCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchBioOntologyPersonGender, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/repository/search/type/bio_ontology_person";
        ...
        if (searchBioOntologyPersonGender != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("search.bio_ontology_person.gender", searchBioOntologyPersonGender));
        }
    ...
    private okhttp3.Call searchBioOntologyPersonValidateBeforeCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchBioOntologyPersonGender, final ApiCallback _callback) throws ApiException {
        return searchBioOntologyPersonCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioOntologyPersonGender, _callback);
     ...
     */
    public void searchBioOntologyPerson(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchBioOntologyPersonGender) throws ApiException {
        searchBioOntologyPersonWithHttpInfo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioOntologyPersonGender);
    }
     ...
     */
    public ApiResponse<Void> searchBioOntologyPersonWithHttpInfo(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchBioOntologyPersonGender) throws ApiException {
        okhttp3.Call localVarCall = searchBioOntologyPersonValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioOntologyPersonGender, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Search API for &#39;Person&#39; entry type (asynchronously)
     * API to search for entries of type Person
     * @param text Search text (optional)
     * @param name Search name (optional)
     * @param description Search description (optional)
     ...
     */
    public okhttp3.Call searchBioOntologyPersonAsync(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchBioOntologyPersonGender, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchBioOntologyPersonValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioOntologyPersonGender, _callback);
