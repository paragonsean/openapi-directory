...
public class TypeTypeHydroColoradoApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TypeTypeHydroColoradoApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TypeTypeHydroColoradoApi(ApiClient apiClient) {
    ...
    /**
     * Build call for searchTypeHydroColorado
     ...
     * @param searchTypeHydroColoradoSiteId Site ID (optional)
    ...
    public okhttp3.Call searchTypeHydroColoradoCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchTypeHydroColoradoSiteId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/repository/search/type/type_hydro_colorado";
        ...
        if (searchTypeHydroColoradoSiteId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("search.type_hydro_colorado.site_id", searchTypeHydroColoradoSiteId));
        }
    ...
    private okhttp3.Call searchTypeHydroColoradoValidateBeforeCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchTypeHydroColoradoSiteId, final ApiCallback _callback) throws ApiException {
        return searchTypeHydroColoradoCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeHydroColoradoSiteId, _callback);
     ...
     */
    public void searchTypeHydroColorado(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchTypeHydroColoradoSiteId) throws ApiException {
        searchTypeHydroColoradoWithHttpInfo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeHydroColoradoSiteId);
    }
     ...
     */
    public ApiResponse<Void> searchTypeHydroColoradoWithHttpInfo(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchTypeHydroColoradoSiteId) throws ApiException {
        okhttp3.Call localVarCall = searchTypeHydroColoradoValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeHydroColoradoSiteId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Search API for &#39;Colorado DNR Stream Gage&#39; entry type (asynchronously)
     * API to search for entries of type Colorado DNR Stream Gage
     * @param text Search text (optional)
     * @param name Search name (optional)
     * @param description Search description (optional)
     ...
     */
    public okhttp3.Call searchTypeHydroColoradoAsync(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchTypeHydroColoradoSiteId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchTypeHydroColoradoValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeHydroColoradoSiteId, _callback);
