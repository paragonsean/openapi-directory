...
public class TypeBioDicomTestApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TypeBioDicomTestApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TypeBioDicomTestApi(ApiClient apiClient) {
    ...
    /**
     * Build call for searchBioDicomTest
     ...
     * @param searchBioDicomTestPatientName Patient Name (optional)
     * @param searchBioDicomTestPatientID Patient ID (optional)
    ...
    public okhttp3.Call searchBioDicomTestCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchBioDicomTestPatientName, String searchBioDicomTestPatientID, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/repository/search/type/bio_dicom_test";
        ...
        if (searchBioDicomTestPatientName != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("search.bio_dicom_test.PatientName", searchBioDicomTestPatientName));
        }

        if (searchBioDicomTestPatientID != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("search.bio_dicom_test.PatientID", searchBioDicomTestPatientID));
        }
    ...
    private okhttp3.Call searchBioDicomTestValidateBeforeCall(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchBioDicomTestPatientName, String searchBioDicomTestPatientID, final ApiCallback _callback) throws ApiException {
        return searchBioDicomTestCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioDicomTestPatientName, searchBioDicomTestPatientID, _callback);
     ...
     */
    public void searchBioDicomTest(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchBioDicomTestPatientName, String searchBioDicomTestPatientID) throws ApiException {
        searchBioDicomTestWithHttpInfo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioDicomTestPatientName, searchBioDicomTestPatientID);
    }
     ...
     */
    public ApiResponse<Void> searchBioDicomTestWithHttpInfo(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchBioDicomTestPatientName, String searchBioDicomTestPatientID) throws ApiException {
        okhttp3.Call localVarCall = searchBioDicomTestValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioDicomTestPatientName, searchBioDicomTestPatientID, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Search API for &#39;DICOM Test File&#39; entry type (asynchronously)
     * API to search for entries of type DICOM Test File
     * @param text Search text (optional)
     * @param name Search name (optional)
     * @param description Search description (optional)
     ...
     */
    public okhttp3.Call searchBioDicomTestAsync(String text, String name, String description, OffsetDateTime fromdate, OffsetDateTime todate, OffsetDateTime createdateFrom, OffsetDateTime createdateTo, OffsetDateTime changedateFrom, OffsetDateTime changedateTo, String group, String filesuffix, Float maxlatitude, Float minlongitude, Float minlatitude, Float maxlongitude, Integer max, Integer skip, String searchBioDicomTestPatientName, String searchBioDicomTestPatientID, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchBioDicomTestValidateBeforeCall(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioDicomTestPatientName, searchBioDicomTestPatientID, _callback);
