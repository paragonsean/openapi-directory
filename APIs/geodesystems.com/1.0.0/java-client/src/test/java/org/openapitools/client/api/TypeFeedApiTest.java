...
/**
 * API tests for TypeFeedApi
 */
@Disabled
public class TypeFeedApiTest {

    private final TypeFeedApi api = new TypeFeedApi();
    ...
    public void searchFeedTest() throws ApiException {
        ...
        Integer max = null;
        Integer skip = null;
        api.searchFeed(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
