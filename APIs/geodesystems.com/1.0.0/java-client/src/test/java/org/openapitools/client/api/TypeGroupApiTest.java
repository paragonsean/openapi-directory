...
/**
 * API tests for TypeGroupApi
 */
@Disabled
public class TypeGroupApiTest {

    private final TypeGroupApi api = new TypeGroupApi();
    ...
    public void searchGroupTest() throws ApiException {
        ...
        Integer max = null;
        Integer skip = null;
        api.searchGroup(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
