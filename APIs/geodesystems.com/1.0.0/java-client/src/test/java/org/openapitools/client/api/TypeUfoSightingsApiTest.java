...
/**
 * API tests for TypeUfoSightingsApi
 */
@Disabled
public class TypeUfoSightingsApiTest {

    private final TypeUfoSightingsApi api = new TypeUfoSightingsApi();
     ...
     */
    @Test
    public void searchUfoSightingsTest() throws ApiException {
        String text = null;
        String name = null;
