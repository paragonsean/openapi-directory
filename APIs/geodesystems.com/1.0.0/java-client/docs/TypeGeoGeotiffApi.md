...
<a id="searchGeoGeotiff"></a>
# **searchGeoGeotiff**
> searchGeoGeotiff(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeGeoGeotiffApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGeoGeotiffApi apiInstance = new TypeGeoGeotiffApi(defaultClient);
    ...
    try {
      apiInstance.searchGeoGeotiff(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGeoGeotiffApi#searchGeoGeotiff");
