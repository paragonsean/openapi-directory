...
|------------- | ------------- | -------------|
| [**searchSunrisesunset**](TypeSunrisesunsetApi.md#searchSunrisesunset) | **GET** /repository/search/type/sunrisesunset | Search API for &#39;Sunrise/Sunset Display&#39; entry type |


<a id="searchSunrisesunset"></a>
# **searchSunrisesunset**
> searchSunrisesunset(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeSunrisesunsetApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeSunrisesunsetApi apiInstance = new TypeSunrisesunsetApi(defaultClient);
    ...
    try {
      apiInstance.searchSunrisesunset(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeSunrisesunsetApi#searchSunrisesunset");
