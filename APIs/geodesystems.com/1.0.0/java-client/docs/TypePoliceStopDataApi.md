...
|------------- | ------------- | -------------|
| [**searchPoliceStopData**](TypePoliceStopDataApi.md#searchPoliceStopData) | **GET** /repository/search/type/police_stop_data | Search API for &#39;Police Stop Data&#39; entry type |


<a id="searchPoliceStopData"></a>
# **searchPoliceStopData**
> searchPoliceStopData(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbPoliceStopDataRace, searchDbPoliceStopDataEthnicity, searchDbPoliceStopDataSex, searchDbPoliceStopDataMinutes, searchDbPoliceStopDataDate, searchDbPoliceStopDataAddress, searchDbPoliceStopDataResident)
...
import org.openapitools.client.api.TypePoliceStopDataApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypePoliceStopDataApi apiInstance = new TypePoliceStopDataApi(defaultClient);
    ...
    String searchDbPoliceStopDataRace = "searchDbPoliceStopDataRace_example"; // String | Race
    String searchDbPoliceStopDataEthnicity = "searchDbPoliceStopDataEthnicity_example"; // String | Ethnicity
    String searchDbPoliceStopDataSex = "searchDbPoliceStopDataSex_example"; // String | Sex
    Integer searchDbPoliceStopDataMinutes = 56; // Integer | Minutes
    String searchDbPoliceStopDataDate = "searchDbPoliceStopDataDate_example"; // String | Date
    String searchDbPoliceStopDataAddress = "searchDbPoliceStopDataAddress_example"; // String | Address
    String searchDbPoliceStopDataResident = "searchDbPoliceStopDataResident_example"; // String | Resident
    try {
      apiInstance.searchPoliceStopData(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbPoliceStopDataRace, searchDbPoliceStopDataEthnicity, searchDbPoliceStopDataSex, searchDbPoliceStopDataMinutes, searchDbPoliceStopDataDate, searchDbPoliceStopDataAddress, searchDbPoliceStopDataResident);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypePoliceStopDataApi#searchPoliceStopData");
...
| **searchDbPoliceStopDataRace** | **String**| Race | [optional] |
| **searchDbPoliceStopDataEthnicity** | **String**| Ethnicity | [optional] |
| **searchDbPoliceStopDataSex** | **String**| Sex | [optional] |
| **searchDbPoliceStopDataMinutes** | **Integer**| Minutes | [optional] |
| **searchDbPoliceStopDataDate** | **String**| Date | [optional] |
| **searchDbPoliceStopDataAddress** | **String**| Address | [optional] |
| **searchDbPoliceStopDataResident** | **String**| Resident | [optional] |
