...
<a id="searchTypeSoundingFrd"></a>
# **searchTypeSoundingFrd**
> searchTypeSoundingFrd(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeSoundingFrdApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeSoundingFrdApi apiInstance = new TypeTypeSoundingFrdApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeSoundingFrd(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeSoundingFrdApi#searchTypeSoundingFrd");
