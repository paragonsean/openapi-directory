...
|------------- | ------------- | -------------|
| [**searchTypeDocumentCsv**](TypeTypeDocumentCsvApi.md#searchTypeDocumentCsv) | **GET** /repository/search/type/type_document_csv | Search API for &#39;CSV File&#39; entry type |


<a id="searchTypeDocumentCsv"></a>
# **searchTypeDocumentCsv**
> searchTypeDocumentCsv(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeDocumentCsvApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeDocumentCsvApi apiInstance = new TypeTypeDocumentCsvApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeDocumentCsv(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeDocumentCsvApi#searchTypeDocumentCsv");
