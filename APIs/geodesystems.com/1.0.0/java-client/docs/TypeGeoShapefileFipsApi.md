...
<a id="searchGeoShapefileFips"></a>
# **searchGeoShapefileFips**
> searchGeoShapefileFips(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeGeoShapefileFipsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGeoShapefileFipsApi apiInstance = new TypeGeoShapefileFipsApi(defaultClient);
    ...
    try {
      apiInstance.searchGeoShapefileFips(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGeoShapefileFipsApi#searchGeoShapefileFips");
