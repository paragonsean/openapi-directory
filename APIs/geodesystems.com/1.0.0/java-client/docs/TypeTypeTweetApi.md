...
|------------- | ------------- | -------------|
| [**searchTypeTweet**](TypeTypeTweetApi.md#searchTypeTweet) | **GET** /repository/search/type/type_tweet | Search API for &#39;Tweet&#39; entry type |


<a id="searchTypeTweet"></a>
# **searchTypeTweet**
> searchTypeTweet(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeTweetApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeTweetApi apiInstance = new TypeTypeTweetApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeTweet(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeTweetApi#searchTypeTweet");
