...
|------------- | ------------- | -------------|
| [**searchTypePointNoaaTower**](TypeTypePointNoaaTowerApi.md#searchTypePointNoaaTower) | **GET** /repository/search/type/type_point_noaa_tower | Search API for &#39;NOAA Tower Network&#39; entry type |


<a id="searchTypePointNoaaTower"></a>
# **searchTypePointNoaaTower**
> searchTypePointNoaaTower(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointNoaaTowerSiteId)
...
import org.openapitools.client.api.TypeTypePointNoaaTowerApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointNoaaTowerApi apiInstance = new TypeTypePointNoaaTowerApi(defaultClient);
    ...
    String searchTypePointNoaaTowerSiteId = "searchTypePointNoaaTowerSiteId_example"; // String | Site ID
    try {
      apiInstance.searchTypePointNoaaTower(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointNoaaTowerSiteId);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointNoaaTowerApi#searchTypePointNoaaTower");
...
| **searchTypePointNoaaTowerSiteId** | **String**| Site ID | [optional] |
