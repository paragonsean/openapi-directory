...
|------------- | ------------- | -------------|
| [**searchVoteYesno**](TypeVoteYesnoApi.md#searchVoteYesno) | **GET** /repository/search/type/vote_yesno | Search API for &#39;Simple Yes-No Vote&#39; entry type |


<a id="searchVoteYesno"></a>
# **searchVoteYesno**
> searchVoteYesno(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbVoteYesnoVote)
...
import org.openapitools.client.api.TypeVoteYesnoApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeVoteYesnoApi apiInstance = new TypeVoteYesnoApi(defaultClient);
    ...
    String searchDbVoteYesnoVote = "searchDbVoteYesnoVote_example"; // String | My Vote
    try {
      apiInstance.searchVoteYesno(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbVoteYesnoVote);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeVoteYesnoApi#searchVoteYesno");
...
| **searchDbVoteYesnoVote** | **String**| My Vote | [optional] |
