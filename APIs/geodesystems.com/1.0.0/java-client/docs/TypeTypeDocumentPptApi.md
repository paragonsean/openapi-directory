...
|------------- | ------------- | -------------|
| [**searchTypeDocumentPpt**](TypeTypeDocumentPptApi.md#searchTypeDocumentPpt) | **GET** /repository/search/type/type_document_ppt | Search API for &#39;Powerpoint File&#39; entry type |


<a id="searchTypeDocumentPpt"></a>
# **searchTypeDocumentPpt**
> searchTypeDocumentPpt(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeDocumentPptApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeDocumentPptApi apiInstance = new TypeTypeDocumentPptApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeDocumentPpt(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeDocumentPptApi#searchTypeDocumentPpt");
