...
|------------- | ------------- | -------------|
| [**searchProjectExperiment**](TypeProjectExperimentApi.md#searchProjectExperiment) | **GET** /repository/search/type/project_experiment | Search API for &#39;Experiment&#39; entry type |


<a id="searchProjectExperiment"></a>
# **searchProjectExperiment**
> searchProjectExperiment(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectExperimentApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectExperimentApi apiInstance = new TypeProjectExperimentApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectExperiment(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectExperimentApi#searchProjectExperiment");
