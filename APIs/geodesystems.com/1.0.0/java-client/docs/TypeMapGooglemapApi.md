...
|------------- | ------------- | -------------|
| [**searchMapGooglemap**](TypeMapGooglemapApi.md#searchMapGooglemap) | **GET** /repository/search/type/map_googlemap | Search API for &#39;Google Map URL&#39; entry type |


<a id="searchMapGooglemap"></a>
# **searchMapGooglemap**
> searchMapGooglemap(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeMapGooglemapApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeMapGooglemapApi apiInstance = new TypeMapGooglemapApi(defaultClient);
    ...
    try {
      apiInstance.searchMapGooglemap(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeMapGooglemapApi#searchMapGooglemap");
