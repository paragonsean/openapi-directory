...
<a id="searchTypeEsriImageserver"></a>
# **searchTypeEsriImageserver**
> searchTypeEsriImageserver(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeEsriImageserverApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeEsriImageserverApi apiInstance = new TypeTypeEsriImageserverApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeEsriImageserver(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeEsriImageserverApi#searchTypeEsriImageserver");
