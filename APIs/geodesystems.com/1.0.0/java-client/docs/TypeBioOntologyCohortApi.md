...
|------------- | ------------- | -------------|
| [**searchBioOntologyCohort**](TypeBioOntologyCohortApi.md#searchBioOntologyCohort) | **GET** /repository/search/type/bio_ontology_cohort | Search API for &#39;Cohort&#39; entry type |


<a id="searchBioOntologyCohort"></a>
# **searchBioOntologyCohort**
> searchBioOntologyCohort(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioOntologyCohortApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioOntologyCohortApi apiInstance = new TypeBioOntologyCohortApi(defaultClient);
    ...
    try {
      apiInstance.searchBioOntologyCohort(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioOntologyCohortApi#searchBioOntologyCohort");
