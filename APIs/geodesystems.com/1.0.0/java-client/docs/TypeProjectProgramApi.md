...
<a id="searchProjectProgram"></a>
# **searchProjectProgram**
> searchProjectProgram(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectProgramApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectProgramApi apiInstance = new TypeProjectProgramApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectProgram(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectProgramApi#searchProjectProgram");
