...
|------------- | ------------- | -------------|
| [**searchProjectOrganization**](TypeProjectOrganizationApi.md#searchProjectOrganization) | **GET** /repository/search/type/project_organization | Search API for &#39;Organization&#39; entry type |


<a id="searchProjectOrganization"></a>
# **searchProjectOrganization**
> searchProjectOrganization(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectOrganizationOrganizationType, searchProjectOrganizationStatus)
...
import org.openapitools.client.api.TypeProjectOrganizationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectOrganizationApi apiInstance = new TypeProjectOrganizationApi(defaultClient);
    ...
    String searchProjectOrganizationOrganizationType = "searchProjectOrganizationOrganizationType_example"; // String | Organization Type
    String searchProjectOrganizationStatus = "searchProjectOrganizationStatus_example"; // String | Status
    try {
      apiInstance.searchProjectOrganization(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectOrganizationOrganizationType, searchProjectOrganizationStatus);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectOrganizationApi#searchProjectOrganization");
...
| **searchProjectOrganizationOrganizationType** | **String**| Organization Type | [optional] |
| **searchProjectOrganizationStatus** | **String**| Status | [optional] |
