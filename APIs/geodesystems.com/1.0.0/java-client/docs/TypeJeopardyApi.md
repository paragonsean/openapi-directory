...
|------------- | ------------- | -------------|
| [**searchJeopardy**](TypeJeopardyApi.md#searchJeopardy) | **GET** /repository/search/type/jeopardy | Search API for &#39;Jeopardy&#39; entry type |


<a id="searchJeopardy"></a>
# **searchJeopardy**
> searchJeopardy(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbJeopardyQuestion, searchDbJeopardyAnswer, searchDbJeopardyRound, searchDbJeopardyCategory, searchDbJeopardyAirDate)
...
import org.openapitools.client.api.TypeJeopardyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeJeopardyApi apiInstance = new TypeJeopardyApi(defaultClient);
    ...
    String searchDbJeopardyQuestion = "searchDbJeopardyQuestion_example"; // String | Question
    String searchDbJeopardyAnswer = "searchDbJeopardyAnswer_example"; // String | Answer
    String searchDbJeopardyRound = "searchDbJeopardyRound_example"; // String | Round
    String searchDbJeopardyCategory = "searchDbJeopardyCategory_example"; // String | Category
    String searchDbJeopardyAirDate = "searchDbJeopardyAirDate_example"; // String | Air Date
    try {
      apiInstance.searchJeopardy(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbJeopardyQuestion, searchDbJeopardyAnswer, searchDbJeopardyRound, searchDbJeopardyCategory, searchDbJeopardyAirDate);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeJeopardyApi#searchJeopardy");
...
| **searchDbJeopardyQuestion** | **String**| Question | [optional] |
| **searchDbJeopardyAnswer** | **String**| Answer | [optional] |
| **searchDbJeopardyRound** | **String**| Round | [optional] |
| **searchDbJeopardyCategory** | **String**| Category | [optional] |
| **searchDbJeopardyAirDate** | **String**| Air Date | [optional] |
