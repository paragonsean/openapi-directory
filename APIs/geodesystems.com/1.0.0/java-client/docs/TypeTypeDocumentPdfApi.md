...
|------------- | ------------- | -------------|
| [**searchTypeDocumentPdf**](TypeTypeDocumentPdfApi.md#searchTypeDocumentPdf) | **GET** /repository/search/type/type_document_pdf | Search API for &#39;PDF File&#39; entry type |


<a id="searchTypeDocumentPdf"></a>
# **searchTypeDocumentPdf**
> searchTypeDocumentPdf(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeDocumentPdfApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeDocumentPdfApi apiInstance = new TypeTypeDocumentPdfApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeDocumentPdf(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeDocumentPdfApi#searchTypeDocumentPdf");
