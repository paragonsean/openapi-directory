...
|------------- | ------------- | -------------|
| [**searchTripEvent**](TypeTripEventApi.md#searchTripEvent) | **GET** /repository/search/type/trip_event | Search API for &#39;Event&#39; entry type |


<a id="searchTripEvent"></a>
# **searchTripEvent**
> searchTripEvent(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTripEventApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTripEventApi apiInstance = new TypeTripEventApi(defaultClient);
    ...
    try {
      apiInstance.searchTripEvent(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTripEventApi#searchTripEvent");
