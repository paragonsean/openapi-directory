...
|------------- | ------------- | -------------|
| [**searchTypePointText**](TypeTypePointTextApi.md#searchTypePointText) | **GET** /repository/search/type/type_point_text | Search API for &#39;Record Text File&#39; entry type |


<a id="searchTypePointText"></a>
# **searchTypePointText**
> searchTypePointText(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointTextApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointTextApi apiInstance = new TypeTypePointTextApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointText(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointTextApi#searchTypePointText");
