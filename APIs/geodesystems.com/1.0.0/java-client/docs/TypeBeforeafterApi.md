...
<a id="searchBeforeafter"></a>
# **searchBeforeafter**
> searchBeforeafter(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBeforeafterApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBeforeafterApi apiInstance = new TypeBeforeafterApi(defaultClient);
    ...
    try {
      apiInstance.searchBeforeafter(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBeforeafterApi#searchBeforeafter");
