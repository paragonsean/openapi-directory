...
<a id="searchGeoShapefile"></a>
# **searchGeoShapefile**
> searchGeoShapefile(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeGeoShapefileApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGeoShapefileApi apiInstance = new TypeGeoShapefileApi(defaultClient);
    ...
    try {
      apiInstance.searchGeoShapefile(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGeoShapefileApi#searchGeoShapefile");
