...
<a id="searchTypePointOceanCnv"></a>
# **searchTypePointOceanCnv**
> searchTypePointOceanCnv(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointOceanCnvApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointOceanCnvApi apiInstance = new TypeTypePointOceanCnvApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointOceanCnv(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointOceanCnvApi#searchTypePointOceanCnv");
