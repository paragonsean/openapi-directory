...
|------------- | ------------- | -------------|
| [**searchTypeDocumentDoc**](TypeTypeDocumentDocApi.md#searchTypeDocumentDoc) | **GET** /repository/search/type/type_document_doc | Search API for &#39;Word File&#39; entry type |


<a id="searchTypeDocumentDoc"></a>
# **searchTypeDocumentDoc**
> searchTypeDocumentDoc(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeDocumentDocApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeDocumentDocApi apiInstance = new TypeTypeDocumentDocApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeDocumentDoc(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeDocumentDocApi#searchTypeDocumentDoc");
