...
|------------- | ------------- | -------------|
| [**searchTypeGtfsRoute**](TypeTypeGtfsRouteApi.md#searchTypeGtfsRoute) | **GET** /repository/search/type/type_gtfs_route | Search API for &#39;Transit Route&#39; entry type |


<a id="searchTypeGtfsRoute"></a>
# **searchTypeGtfsRoute**
> searchTypeGtfsRoute(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeGtfsRouteRouteId, searchTypeGtfsRouteStopNames)
...
import org.openapitools.client.api.TypeTypeGtfsRouteApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeGtfsRouteApi apiInstance = new TypeTypeGtfsRouteApi(defaultClient);
    ...
    String searchTypeGtfsRouteRouteId = "searchTypeGtfsRouteRouteId_example"; // String | Route ID
    String searchTypeGtfsRouteStopNames = "searchTypeGtfsRouteStopNames_example"; // String | Stop Names
    try {
      apiInstance.searchTypeGtfsRoute(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeGtfsRouteRouteId, searchTypeGtfsRouteStopNames);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeGtfsRouteApi#searchTypeGtfsRoute");
...
| **searchTypeGtfsRouteRouteId** | **String**| Route ID | [optional] |
| **searchTypeGtfsRouteStopNames** | **String**| Stop Names | [optional] |
