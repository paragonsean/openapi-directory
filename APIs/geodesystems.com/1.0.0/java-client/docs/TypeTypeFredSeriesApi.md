...
<a id="searchTypeFredSeries"></a>
# **searchTypeFredSeries**
> searchTypeFredSeries(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeFredSeriesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeFredSeriesApi apiInstance = new TypeTypeFredSeriesApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeFredSeries(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeFredSeriesApi#searchTypeFredSeries");
