...
|------------- | ------------- | -------------|
| [**searchProjectVocabulary**](TypeProjectVocabularyApi.md#searchProjectVocabulary) | **GET** /repository/search/type/project_vocabulary | Search API for &#39;Vocabulary&#39; entry type |


<a id="searchProjectVocabulary"></a>
# **searchProjectVocabulary**
> searchProjectVocabulary(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectVocabularyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectVocabularyApi apiInstance = new TypeProjectVocabularyApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectVocabulary(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectVocabularyApi#searchProjectVocabulary");
