...
<a id="searchBookmarks"></a>
# **searchBookmarks**
> searchBookmarks(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbBookmarksTitle, searchDbBookmarksUrl, searchDbBookmarksCategory, searchDbBookmarksDate)
...
import org.openapitools.client.api.TypeBookmarksApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBookmarksApi apiInstance = new TypeBookmarksApi(defaultClient);
    ...
    String searchDbBookmarksTitle = "searchDbBookmarksTitle_example"; // String | Title
    String searchDbBookmarksUrl = "searchDbBookmarksUrl_example"; // String | URL
    String searchDbBookmarksCategory = "searchDbBookmarksCategory_example"; // String | Category
    String searchDbBookmarksDate = "searchDbBookmarksDate_example"; // String | Date
    try {
      apiInstance.searchBookmarks(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbBookmarksTitle, searchDbBookmarksUrl, searchDbBookmarksCategory, searchDbBookmarksDate);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBookmarksApi#searchBookmarks");
