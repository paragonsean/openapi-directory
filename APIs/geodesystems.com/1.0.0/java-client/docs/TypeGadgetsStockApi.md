...
<a id="searchGadgetsStock"></a>
# **searchGadgetsStock**
> searchGadgetsStock(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeGadgetsStockApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGadgetsStockApi apiInstance = new TypeGadgetsStockApi(defaultClient);
    ...
    try {
      apiInstance.searchGadgetsStock(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGadgetsStockApi#searchGadgetsStock");
