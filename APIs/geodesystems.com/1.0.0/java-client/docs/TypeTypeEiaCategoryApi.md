...
|------------- | ------------- | -------------|
| [**searchTypeEiaCategory**](TypeTypeEiaCategoryApi.md#searchTypeEiaCategory) | **GET** /repository/search/type/type_eia_category | Search API for &#39;EIA Category&#39; entry type |


<a id="searchTypeEiaCategory"></a>
# **searchTypeEiaCategory**
> searchTypeEiaCategory(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeEiaCategoryApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeEiaCategoryApi apiInstance = new TypeTypeEiaCategoryApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeEiaCategory(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeEiaCategoryApi#searchTypeEiaCategory");
