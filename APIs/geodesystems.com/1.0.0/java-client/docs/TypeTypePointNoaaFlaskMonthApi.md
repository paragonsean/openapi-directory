...
|------------- | ------------- | -------------|
| [**searchTypePointNoaaFlaskMonth**](TypeTypePointNoaaFlaskMonthApi.md#searchTypePointNoaaFlaskMonth) | **GET** /repository/search/type/type_point_noaa_flask_month | Search API for &#39;NOAA Flask Month Measurements&#39; entry type |


<a id="searchTypePointNoaaFlaskMonth"></a>
# **searchTypePointNoaaFlaskMonth**
> searchTypePointNoaaFlaskMonth(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointNoaaFlaskMonthSiteId, searchTypePointNoaaFlaskMonthParameter, searchTypePointNoaaFlaskMonthProject, searchTypePointNoaaFlaskMonthLabIdNumber, searchTypePointNoaaFlaskMonthMeasurementGroup)
...
import org.openapitools.client.api.TypeTypePointNoaaFlaskMonthApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointNoaaFlaskMonthApi apiInstance = new TypeTypePointNoaaFlaskMonthApi(defaultClient);
    ...
    String searchTypePointNoaaFlaskMonthSiteId = "searchTypePointNoaaFlaskMonthSiteId_example"; // String | Site ID
    String searchTypePointNoaaFlaskMonthParameter = "searchTypePointNoaaFlaskMonthParameter_example"; // String | Parameter
    String searchTypePointNoaaFlaskMonthProject = "searchTypePointNoaaFlaskMonthProject_example"; // String | Project
    String searchTypePointNoaaFlaskMonthLabIdNumber = "searchTypePointNoaaFlaskMonthLabIdNumber_example"; // String | Lab ID Number
    String searchTypePointNoaaFlaskMonthMeasurementGroup = "searchTypePointNoaaFlaskMonthMeasurementGroup_example"; // String | Measurement Group
    try {
      apiInstance.searchTypePointNoaaFlaskMonth(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointNoaaFlaskMonthSiteId, searchTypePointNoaaFlaskMonthParameter, searchTypePointNoaaFlaskMonthProject, searchTypePointNoaaFlaskMonthLabIdNumber, searchTypePointNoaaFlaskMonthMeasurementGroup);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointNoaaFlaskMonthApi#searchTypePointNoaaFlaskMonth");
...
| **searchTypePointNoaaFlaskMonthSiteId** | **String**| Site ID | [optional] |
| **searchTypePointNoaaFlaskMonthParameter** | **String**| Parameter | [optional] |
| **searchTypePointNoaaFlaskMonthProject** | **String**| Project | [optional] |
| **searchTypePointNoaaFlaskMonthLabIdNumber** | **String**| Lab ID Number | [optional] |
| **searchTypePointNoaaFlaskMonthMeasurementGroup** | **String**| Measurement Group | [optional] |
