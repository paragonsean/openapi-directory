...
<a id="searchTypePointOceanCsvSadoMeteo"></a>
# **searchTypePointOceanCsvSadoMeteo**
> searchTypePointOceanCsvSadoMeteo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointOceanCsvSadoMeteoApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointOceanCsvSadoMeteoApi apiInstance = new TypeTypePointOceanCsvSadoMeteoApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointOceanCsvSadoMeteo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointOceanCsvSadoMeteoApi#searchTypePointOceanCsvSadoMeteo");
