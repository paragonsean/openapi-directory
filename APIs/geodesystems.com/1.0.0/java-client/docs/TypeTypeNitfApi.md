...
|------------- | ------------- | -------------|
| [**searchTypeNitf**](TypeTypeNitfApi.md#searchTypeNitf) | **GET** /repository/search/type/type_nitf | Search API for &#39;NITF File&#39; entry type |


<a id="searchTypeNitf"></a>
# **searchTypeNitf**
> searchTypeNitf(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeNitfApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeNitfApi apiInstance = new TypeTypeNitfApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeNitf(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeNitfApi#searchTypeNitf");
