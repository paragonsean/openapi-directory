...
<a id="searchOwlClass"></a>
# **searchOwlClass**
> searchOwlClass(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeOwlClassApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeOwlClassApi apiInstance = new TypeOwlClassApi(defaultClient);
    ...
    try {
      apiInstance.searchOwlClass(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeOwlClassApi#searchOwlClass");
