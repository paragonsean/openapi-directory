...
|------------- | ------------- | -------------|
| [**searchTripHotel**](TypeTripHotelApi.md#searchTripHotel) | **GET** /repository/search/type/trip_hotel | Search API for &#39;Lodging&#39; entry type |


<a id="searchTripHotel"></a>
# **searchTripHotel**
> searchTripHotel(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTripHotelApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTripHotelApi apiInstance = new TypeTripHotelApi(defaultClient);
    ...
    try {
      apiInstance.searchTripHotel(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTripHotelApi#searchTripHotel");
