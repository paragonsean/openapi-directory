...
|------------- | ------------- | -------------|
| [**searchTypePointGcnet**](TypeTypePointGcnetApi.md#searchTypePointGcnet) | **GET** /repository/search/type/type_point_gcnet | Search API for &#39;GC-Net Point Data&#39; entry type |


<a id="searchTypePointGcnet"></a>
# **searchTypePointGcnet**
> searchTypePointGcnet(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointGcnetApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointGcnetApi apiInstance = new TypeTypePointGcnetApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointGcnet(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointGcnetApi#searchTypePointGcnet");
