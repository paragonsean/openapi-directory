...
<a id="searchTypeImage"></a>
# **searchTypeImage**
> searchTypeImage(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeImageApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeImageApi apiInstance = new TypeTypeImageApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeImage(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeImageApi#searchTypeImage");
