...
<a id="searchTypeDbTable"></a>
# **searchTypeDbTable**
> searchTypeDbTable(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeDbTableApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeDbTableApi apiInstance = new TypeTypeDbTableApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeDbTable(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeDbTableApi#searchTypeDbTable");
