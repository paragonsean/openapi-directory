...
<a id="searchOpendaplink"></a>
# **searchOpendaplink**
> searchOpendaplink(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeOpendaplinkApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeOpendaplinkApi apiInstance = new TypeOpendaplinkApi(defaultClient);
    ...
    try {
      apiInstance.searchOpendaplink(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeOpendaplinkApi#searchOpendaplink");
