...
|------------- | ------------- | -------------|
| [**searchLidarLas**](TypeLidarLasApi.md#searchLidarLas) | **GET** /repository/search/type/lidar_las | Search API for &#39;LAS Lidar Data&#39; entry type |


<a id="searchLidarLas"></a>
# **searchLidarLas**
> searchLidarLas(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeLidarLasApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeLidarLasApi apiInstance = new TypeLidarLasApi(defaultClient);
    ...
    try {
      apiInstance.searchLidarLas(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeLidarLasApi#searchLidarLas");
