...
<a id="searchMediaImageloop"></a>
# **searchMediaImageloop**
> searchMediaImageloop(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeMediaImageloopApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeMediaImageloopApi apiInstance = new TypeMediaImageloopApi(defaultClient);
    ...
    try {
      apiInstance.searchMediaImageloop(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeMediaImageloopApi#searchMediaImageloop");
