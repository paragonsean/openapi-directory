...
|------------- | ------------- | -------------|
| [**searchBioStockholm**](TypeBioStockholmApi.md#searchBioStockholm) | **GET** /repository/search/type/bio_stockholm | Search API for &#39;Stockholm File&#39; entry type |


<a id="searchBioStockholm"></a>
# **searchBioStockholm**
> searchBioStockholm(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioStockholmApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioStockholmApi apiInstance = new TypeBioStockholmApi(defaultClient);
    ...
    try {
      apiInstance.searchBioStockholm(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioStockholmApi#searchBioStockholm");
