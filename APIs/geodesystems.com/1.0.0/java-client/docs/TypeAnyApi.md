...
|------------- | ------------- | -------------|
| [**searchAny**](TypeAnyApi.md#searchAny) | **GET** /repository/search/type/any | Search API for &#39;Any file type&#39; entry type |


<a id="searchAny"></a>
# **searchAny**
> searchAny(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeAnyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeAnyApi apiInstance = new TypeAnyApi(defaultClient);
    ...
    try {
      apiInstance.searchAny(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeAnyApi#searchAny");
