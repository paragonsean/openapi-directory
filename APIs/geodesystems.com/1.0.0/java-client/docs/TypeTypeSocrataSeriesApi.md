...
|------------- | ------------- | -------------|
| [**searchTypeSocrataSeries**](TypeTypeSocrataSeriesApi.md#searchTypeSocrataSeries) | **GET** /repository/search/type/type_socrata_series | Search API for &#39;SOCRATA Series&#39; entry type |


<a id="searchTypeSocrataSeries"></a>
# **searchTypeSocrataSeries**
> searchTypeSocrataSeries(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeSocrataSeriesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeSocrataSeriesApi apiInstance = new TypeTypeSocrataSeriesApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeSocrataSeries(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeSocrataSeriesApi#searchTypeSocrataSeries");
