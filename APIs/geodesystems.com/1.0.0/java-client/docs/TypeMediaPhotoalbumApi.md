...
|------------- | ------------- | -------------|
| [**searchMediaPhotoalbum**](TypeMediaPhotoalbumApi.md#searchMediaPhotoalbum) | **GET** /repository/search/type/media_photoalbum | Search API for &#39;Photo Album&#39; entry type |


<a id="searchMediaPhotoalbum"></a>
# **searchMediaPhotoalbum**
> searchMediaPhotoalbum(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeMediaPhotoalbumApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeMediaPhotoalbumApi apiInstance = new TypeMediaPhotoalbumApi(defaultClient);
    ...
    try {
      apiInstance.searchMediaPhotoalbum(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeMediaPhotoalbumApi#searchMediaPhotoalbum");
