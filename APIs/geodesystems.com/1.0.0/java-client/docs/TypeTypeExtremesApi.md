...
|------------- | ------------- | -------------|
| [**searchTypeExtremes**](TypeTypeExtremesApi.md#searchTypeExtremes) | **GET** /repository/search/type/type_extremes | Search API for &#39;NOAA Extremes Data&#39; entry type |


<a id="searchTypeExtremes"></a>
# **searchTypeExtremes**
> searchTypeExtremes(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeExtremesRegion, searchTypeExtremesVariable)
...
import org.openapitools.client.api.TypeTypeExtremesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeExtremesApi apiInstance = new TypeTypeExtremesApi(defaultClient);
    ...
    String searchTypeExtremesRegion = "searchTypeExtremesRegion_example"; // String | US Climate Region
    String searchTypeExtremesVariable = "searchTypeExtremesVariable_example"; // String | Variable
    try {
      apiInstance.searchTypeExtremes(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeExtremesRegion, searchTypeExtremesVariable);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeExtremesApi#searchTypeExtremes");
...
| **searchTypeExtremesRegion** | **String**| US Climate Region | [optional] |
| **searchTypeExtremesVariable** | **String**| Variable | [optional] |
