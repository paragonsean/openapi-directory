...
|------------- | ------------- | -------------|
| [**searchTypeUsgsGauge**](TypeTypeUsgsGaugeApi.md#searchTypeUsgsGauge) | **GET** /repository/search/type/type_usgs_gauge | Search API for &#39;USGS Stream Gauge&#39; entry type |


<a id="searchTypeUsgsGauge"></a>
# **searchTypeUsgsGauge**
> searchTypeUsgsGauge(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeUsgsGaugeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeUsgsGaugeApi apiInstance = new TypeTypeUsgsGaugeApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeUsgsGauge(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeUsgsGaugeApi#searchTypeUsgsGauge");
