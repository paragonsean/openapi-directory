...
<a id="searchLocalfiles"></a>
# **searchLocalfiles**
> searchLocalfiles(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeLocalfilesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeLocalfilesApi apiInstance = new TypeLocalfilesApi(defaultClient);
    ...
    try {
      apiInstance.searchLocalfiles(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeLocalfilesApi#searchLocalfiles");
