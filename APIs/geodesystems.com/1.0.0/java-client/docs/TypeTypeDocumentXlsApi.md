...
|------------- | ------------- | -------------|
| [**searchTypeDocumentXls**](TypeTypeDocumentXlsApi.md#searchTypeDocumentXls) | **GET** /repository/search/type/type_document_xls | Search API for &#39;Excel File&#39; entry type |


<a id="searchTypeDocumentXls"></a>
# **searchTypeDocumentXls**
> searchTypeDocumentXls(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeDocumentXlsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeDocumentXlsApi apiInstance = new TypeTypeDocumentXlsApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeDocumentXls(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeDocumentXlsApi#searchTypeDocumentXls");
