...
<a id="searchWikipage"></a>
# **searchWikipage**
> searchWikipage(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchWikipageWikitext, searchWikipageCategory)
...
import org.openapitools.client.api.TypeWikipageApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeWikipageApi apiInstance = new TypeWikipageApi(defaultClient);
    ...
    String searchWikipageWikitext = "searchWikipageWikitext_example"; // String | Wiki Text
    String searchWikipageCategory = "searchWikipageCategory_example"; // String | Wiki Page Category
    try {
      apiInstance.searchWikipage(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchWikipageWikitext, searchWikipageCategory);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeWikipageApi#searchWikipage");
