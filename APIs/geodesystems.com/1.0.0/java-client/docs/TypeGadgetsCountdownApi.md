...
|------------- | ------------- | -------------|
| [**searchGadgetsCountdown**](TypeGadgetsCountdownApi.md#searchGadgetsCountdown) | **GET** /repository/search/type/gadgets_countdown | Search API for &#39;Countdown&#39; entry type |


<a id="searchGadgetsCountdown"></a>
# **searchGadgetsCountdown**
> searchGadgetsCountdown(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeGadgetsCountdownApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGadgetsCountdownApi apiInstance = new TypeGadgetsCountdownApi(defaultClient);
    ...
    try {
      apiInstance.searchGadgetsCountdown(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGadgetsCountdownApi#searchGadgetsCountdown");
