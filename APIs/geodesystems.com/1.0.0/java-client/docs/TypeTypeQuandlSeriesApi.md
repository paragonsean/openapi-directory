...
<a id="searchTypeQuandlSeries"></a>
# **searchTypeQuandlSeries**
> searchTypeQuandlSeries(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeQuandlSeriesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeQuandlSeriesApi apiInstance = new TypeTypeQuandlSeriesApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeQuandlSeries(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeQuandlSeriesApi#searchTypeQuandlSeries");
