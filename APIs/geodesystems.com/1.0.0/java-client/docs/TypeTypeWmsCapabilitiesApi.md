...
|------------- | ------------- | -------------|
| [**searchTypeWmsCapabilities**](TypeTypeWmsCapabilitiesApi.md#searchTypeWmsCapabilities) | **GET** /repository/search/type/type_wms_capabilities | Search API for &#39;WMS Capabilities&#39; entry type |


<a id="searchTypeWmsCapabilities"></a>
# **searchTypeWmsCapabilities**
> searchTypeWmsCapabilities(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeWmsCapabilitiesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeWmsCapabilitiesApi apiInstance = new TypeTypeWmsCapabilitiesApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeWmsCapabilities(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeWmsCapabilitiesApi#searchTypeWmsCapabilities");
