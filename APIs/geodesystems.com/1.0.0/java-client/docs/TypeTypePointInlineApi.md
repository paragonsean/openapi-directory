...
|------------- | ------------- | -------------|
| [**searchTypePointInline**](TypeTypePointInlineApi.md#searchTypePointInline) | **GET** /repository/search/type/type_point_inline | Search API for &#39;Inline Point File&#39; entry type |


<a id="searchTypePointInline"></a>
# **searchTypePointInline**
> searchTypePointInline(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointInlineApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointInlineApi apiInstance = new TypeTypePointInlineApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointInline(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointInlineApi#searchTypePointInline");
