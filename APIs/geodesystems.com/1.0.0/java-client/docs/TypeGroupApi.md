...
|------------- | ------------- | -------------|
| [**searchGroup**](TypeGroupApi.md#searchGroup) | **GET** /repository/search/type/group | Search API for &#39;Folder&#39; entry type |


<a id="searchGroup"></a>
# **searchGroup**
> searchGroup(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeGroupApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGroupApi apiInstance = new TypeGroupApi(defaultClient);
    ...
    try {
      apiInstance.searchGroup(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGroupApi#searchGroup");
