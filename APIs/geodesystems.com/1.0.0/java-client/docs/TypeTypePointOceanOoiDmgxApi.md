...
<a id="searchTypePointOceanOoiDmgx"></a>
# **searchTypePointOceanOoiDmgx**
> searchTypePointOceanOoiDmgx(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointOceanOoiDmgxApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointOceanOoiDmgxApi apiInstance = new TypeTypePointOceanOoiDmgxApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointOceanOoiDmgx(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointOceanOoiDmgxApi#searchTypePointOceanOoiDmgx");
