...
|------------- | ------------- | -------------|
| [**searchCommunityResource**](TypeCommunityResourceApi.md#searchCommunityResource) | **GET** /repository/search/type/community_resource | Search API for &#39;Facility&#39; entry type |


<a id="searchCommunityResource"></a>
# **searchCommunityResource**
> searchCommunityResource(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchCommunityResourceResourceType, searchCommunityResourceAddress, searchCommunityResourceCity, searchCommunityResourceState, searchCommunityResourceZipcode)
...
import org.openapitools.client.api.TypeCommunityResourceApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeCommunityResourceApi apiInstance = new TypeCommunityResourceApi(defaultClient);
    ...
    String searchCommunityResourceResourceType = "searchCommunityResourceResourceType_example"; // String | Type
    String searchCommunityResourceAddress = "searchCommunityResourceAddress_example"; // String | Address
    String searchCommunityResourceCity = "searchCommunityResourceCity_example"; // String | City
    String searchCommunityResourceState = "searchCommunityResourceState_example"; // String | State or Province
    String searchCommunityResourceZipcode = "searchCommunityResourceZipcode_example"; // String | Zip Code
    try {
      apiInstance.searchCommunityResource(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchCommunityResourceResourceType, searchCommunityResourceAddress, searchCommunityResourceCity, searchCommunityResourceState, searchCommunityResourceZipcode);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeCommunityResourceApi#searchCommunityResource");
...
| **searchCommunityResourceResourceType** | **String**| Type | [optional] |
| **searchCommunityResourceAddress** | **String**| Address | [optional] |
| **searchCommunityResourceCity** | **String**| City | [optional] |
| **searchCommunityResourceState** | **String**| State or Province | [optional] |
| **searchCommunityResourceZipcode** | **String**| Zip Code | [optional] |
