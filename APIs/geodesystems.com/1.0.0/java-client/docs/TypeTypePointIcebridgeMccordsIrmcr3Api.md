...
|------------- | ------------- | -------------|
| [**searchTypePointIcebridgeMccordsIrmcr3**](TypeTypePointIcebridgeMccordsIrmcr3Api.md#searchTypePointIcebridgeMccordsIrmcr3) | **GET** /repository/search/type/type_point_icebridge_mccords_irmcr3 | Search API for &#39;McCords Irmcr3 Data&#39; entry type |


<a id="searchTypePointIcebridgeMccordsIrmcr3"></a>
# **searchTypePointIcebridgeMccordsIrmcr3**
> searchTypePointIcebridgeMccordsIrmcr3(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointIcebridgeMccordsIrmcr3Api;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointIcebridgeMccordsIrmcr3Api apiInstance = new TypeTypePointIcebridgeMccordsIrmcr3Api(defaultClient);
    ...
    try {
      apiInstance.searchTypePointIcebridgeMccordsIrmcr3(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointIcebridgeMccordsIrmcr3Api#searchTypePointIcebridgeMccordsIrmcr3");
