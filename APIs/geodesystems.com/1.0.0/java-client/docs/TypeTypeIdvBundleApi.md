...
<a id="searchTypeIdvBundle"></a>
# **searchTypeIdvBundle**
> searchTypeIdvBundle(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeIdvBundleApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeIdvBundleApi apiInstance = new TypeTypeIdvBundleApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeIdvBundle(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeIdvBundleApi#searchTypeIdvBundle");
