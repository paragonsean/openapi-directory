...
|------------- | ------------- | -------------|
| [**searchFitsData**](TypeFitsDataApi.md#searchFitsData) | **GET** /repository/search/type/fits_data | Search API for &#39;FITS Data File&#39; entry type |


<a id="searchFitsData"></a>
# **searchFitsData**
> searchFitsData(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchFitsDataOrigin, searchFitsDataTelescope, searchFitsDataInstrument)
...
import org.openapitools.client.api.TypeFitsDataApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeFitsDataApi apiInstance = new TypeFitsDataApi(defaultClient);
    ...
    String searchFitsDataOrigin = "searchFitsDataOrigin_example"; // String | Origin
    String searchFitsDataTelescope = "searchFitsDataTelescope_example"; // String | Telescope
    String searchFitsDataInstrument = "searchFitsDataInstrument_example"; // String | Instrument
    try {
      apiInstance.searchFitsData(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchFitsDataOrigin, searchFitsDataTelescope, searchFitsDataInstrument);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeFitsDataApi#searchFitsData");
...
| **searchFitsDataOrigin** | **String**| Origin | [optional] |
| **searchFitsDataTelescope** | **String**| Telescope | [optional] |
| **searchFitsDataInstrument** | **String**| Instrument | [optional] |
