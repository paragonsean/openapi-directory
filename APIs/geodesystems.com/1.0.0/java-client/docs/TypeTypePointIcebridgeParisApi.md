...
<a id="searchTypePointIcebridgeParis"></a>
# **searchTypePointIcebridgeParis**
> searchTypePointIcebridgeParis(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointIcebridgeParisApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointIcebridgeParisApi apiInstance = new TypeTypePointIcebridgeParisApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointIcebridgeParis(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointIcebridgeParisApi#searchTypePointIcebridgeParis");
