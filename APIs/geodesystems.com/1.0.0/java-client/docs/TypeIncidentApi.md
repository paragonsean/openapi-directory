...
|------------- | ------------- | -------------|
| [**searchIncident**](TypeIncidentApi.md#searchIncident) | **GET** /repository/search/type/incident | Search API for &#39;Incident&#39; entry type |


<a id="searchIncident"></a>
# **searchIncident**
> searchIncident(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchIncidentIncidenttype, searchIncidentCause, searchIncidentState)
...
import org.openapitools.client.api.TypeIncidentApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeIncidentApi apiInstance = new TypeIncidentApi(defaultClient);
    ...
    String searchIncidentIncidenttype = "searchIncidentIncidenttype_example"; // String | Incident Type
    String searchIncidentCause = "searchIncidentCause_example"; // String | Cause
    String searchIncidentState = "searchIncidentState_example"; // String | State
    try {
      apiInstance.searchIncident(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchIncidentIncidenttype, searchIncidentCause, searchIncidentState);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeIncidentApi#searchIncident");
...
| **searchIncidentIncidenttype** | **String**| Incident Type | [optional] |
| **searchIncidentCause** | **String**| Cause | [optional] |
| **searchIncidentState** | **String**| State | [optional] |
