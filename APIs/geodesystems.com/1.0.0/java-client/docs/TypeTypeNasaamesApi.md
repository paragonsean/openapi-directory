...
|------------- | ------------- | -------------|
| [**searchTypeNasaames**](TypeTypeNasaamesApi.md#searchTypeNasaames) | **GET** /repository/search/type/type_nasaames | Search API for &#39;NASA AMES File&#39; entry type |


<a id="searchTypeNasaames"></a>
# **searchTypeNasaames**
> searchTypeNasaames(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeNasaamesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeNasaamesApi apiInstance = new TypeTypeNasaamesApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeNasaames(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeNasaamesApi#searchTypeNasaames");
