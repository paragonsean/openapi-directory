...
<a id="searchBioFastq"></a>
# **searchBioFastq**
> searchBioFastq(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioFastqApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioFastqApi apiInstance = new TypeBioFastqApi(defaultClient);
    ...
    try {
      apiInstance.searchBioFastq(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioFastqApi#searchBioFastq");
