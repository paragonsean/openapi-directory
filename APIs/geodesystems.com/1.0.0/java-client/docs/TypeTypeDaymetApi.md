...
|------------- | ------------- | -------------|
| [**searchTypeDaymet**](TypeTypeDaymetApi.md#searchTypeDaymet) | **GET** /repository/search/type/type_daymet | Search API for &#39;Daymet Daily Weather&#39; entry type |


<a id="searchTypeDaymet"></a>
# **searchTypeDaymet**
> searchTypeDaymet(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeDaymetApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeDaymetApi apiInstance = new TypeTypeDaymetApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeDaymet(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeDaymetApi#searchTypeDaymet");
