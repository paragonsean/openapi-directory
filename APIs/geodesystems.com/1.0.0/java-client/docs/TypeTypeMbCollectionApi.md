...
<a id="searchTypeMbCollection"></a>
# **searchTypeMbCollection**
> searchTypeMbCollection(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeMbCollectionApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeMbCollectionApi apiInstance = new TypeTypeMbCollectionApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeMbCollection(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeMbCollectionApi#searchTypeMbCollection");
