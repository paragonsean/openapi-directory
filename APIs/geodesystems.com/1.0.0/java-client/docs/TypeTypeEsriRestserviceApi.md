...
|------------- | ------------- | -------------|
| [**searchTypeEsriRestservice**](TypeTypeEsriRestserviceApi.md#searchTypeEsriRestservice) | **GET** /repository/search/type/type_esri_restservice | Search API for &#39;ESRI Rest Service&#39; entry type |


<a id="searchTypeEsriRestservice"></a>
# **searchTypeEsriRestservice**
> searchTypeEsriRestservice(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeEsriRestserviceApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeEsriRestserviceApi apiInstance = new TypeTypeEsriRestserviceApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeEsriRestservice(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeEsriRestserviceApi#searchTypeEsriRestservice");
