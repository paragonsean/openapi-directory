...
<a id="searchTypeEsriLayer"></a>
# **searchTypeEsriLayer**
> searchTypeEsriLayer(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeEsriLayerLayerType)
...
import org.openapitools.client.api.TypeTypeEsriLayerApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeEsriLayerApi apiInstance = new TypeTypeEsriLayerApi(defaultClient);
    ...
    String searchTypeEsriLayerLayerType = "searchTypeEsriLayerLayerType_example"; // String | Layer Type
    try {
      apiInstance.searchTypeEsriLayer(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeEsriLayerLayerType);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeEsriLayerApi#searchTypeEsriLayer");
