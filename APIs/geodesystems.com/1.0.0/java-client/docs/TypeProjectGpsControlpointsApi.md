...
<a id="searchProjectGpsControlpoints"></a>
# **searchProjectGpsControlpoints**
> searchProjectGpsControlpoints(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectGpsControlpointsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectGpsControlpointsApi apiInstance = new TypeProjectGpsControlpointsApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectGpsControlpoints(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectGpsControlpointsApi#searchProjectGpsControlpoints");
