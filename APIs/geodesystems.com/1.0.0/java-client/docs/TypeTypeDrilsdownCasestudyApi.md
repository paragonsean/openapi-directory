...
<a id="searchTypeDrilsdownCasestudy"></a>
# **searchTypeDrilsdownCasestudy**
> searchTypeDrilsdownCasestudy(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeDrilsdownCasestudyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeDrilsdownCasestudyApi apiInstance = new TypeTypeDrilsdownCasestudyApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeDrilsdownCasestudy(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeDrilsdownCasestudyApi#searchTypeDrilsdownCasestudy");
