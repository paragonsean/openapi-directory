...
|------------- | ------------- | -------------|
| [**searchTypePointIcebridgeAtmQfit**](TypeTypePointIcebridgeAtmQfitApi.md#searchTypePointIcebridgeAtmQfit) | **GET** /repository/search/type/type_point_icebridge_atm_qfit | Search API for &#39;ATM QFIT Data&#39; entry type |


<a id="searchTypePointIcebridgeAtmQfit"></a>
# **searchTypePointIcebridgeAtmQfit**
> searchTypePointIcebridgeAtmQfit(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointIcebridgeAtmQfitApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointIcebridgeAtmQfitApi apiInstance = new TypeTypePointIcebridgeAtmQfitApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointIcebridgeAtmQfit(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointIcebridgeAtmQfitApi#searchTypePointIcebridgeAtmQfit");
