...
|------------- | ------------- | -------------|
| [**searchTypeSoundingWyoming**](TypeTypeSoundingWyomingApi.md#searchTypeSoundingWyoming) | **GET** /repository/search/type/type_sounding_wyoming | Search API for &#39;UW Sounding&#39; entry type |


<a id="searchTypeSoundingWyoming"></a>
# **searchTypeSoundingWyoming**
> searchTypeSoundingWyoming(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeSoundingWyomingApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeSoundingWyomingApi apiInstance = new TypeTypeSoundingWyomingApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeSoundingWyoming(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeSoundingWyomingApi#searchTypeSoundingWyoming");
