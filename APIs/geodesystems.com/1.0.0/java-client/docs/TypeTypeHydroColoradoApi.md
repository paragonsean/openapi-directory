...
|------------- | ------------- | -------------|
| [**searchTypeHydroColorado**](TypeTypeHydroColoradoApi.md#searchTypeHydroColorado) | **GET** /repository/search/type/type_hydro_colorado | Search API for &#39;Colorado DNR Stream Gage&#39; entry type |


<a id="searchTypeHydroColorado"></a>
# **searchTypeHydroColorado**
> searchTypeHydroColorado(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeHydroColoradoSiteId)
...
import org.openapitools.client.api.TypeTypeHydroColoradoApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeHydroColoradoApi apiInstance = new TypeTypeHydroColoradoApi(defaultClient);
    ...
    String searchTypeHydroColoradoSiteId = "searchTypeHydroColoradoSiteId_example"; // String | Site ID
    try {
      apiInstance.searchTypeHydroColorado(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeHydroColoradoSiteId);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeHydroColoradoApi#searchTypeHydroColorado");
...
| **searchTypeHydroColoradoSiteId** | **String**| Site ID | [optional] |
