...
|------------- | ------------- | -------------|
| [**searchWeblog**](TypeWeblogApi.md#searchWeblog) | **GET** /repository/search/type/weblog | Search API for &#39;Weblog&#39; entry type |


<a id="searchWeblog"></a>
# **searchWeblog**
> searchWeblog(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeWeblogApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeWeblogApi apiInstance = new TypeWeblogApi(defaultClient);
    ...
    try {
      apiInstance.searchWeblog(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeWeblogApi#searchWeblog");
