...
|------------- | ------------- | -------------|
| [**searchProjectCampaign**](TypeProjectCampaignApi.md#searchProjectCampaign) | **GET** /repository/search/type/project_campaign | Search API for &#39;Campaign&#39; entry type |


<a id="searchProjectCampaign"></a>
# **searchProjectCampaign**
> searchProjectCampaign(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectCampaignApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectCampaignApi apiInstance = new TypeProjectCampaignApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectCampaign(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectCampaignApi#searchProjectCampaign");
