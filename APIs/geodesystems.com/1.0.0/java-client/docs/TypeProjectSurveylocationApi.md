...
|------------- | ------------- | -------------|
| [**searchProjectSurveylocation**](TypeProjectSurveylocationApi.md#searchProjectSurveylocation) | **GET** /repository/search/type/project_surveylocation | Search API for &#39;Survey Location&#39; entry type |


<a id="searchProjectSurveylocation"></a>
# **searchProjectSurveylocation**
> searchProjectSurveylocation(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectSurveylocationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectSurveylocationApi apiInstance = new TypeProjectSurveylocationApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectSurveylocation(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectSurveylocationApi#searchProjectSurveylocation");
