...
|------------- | ------------- | -------------|
| [**searchTypeSoundingGsd**](TypeTypeSoundingGsdApi.md#searchTypeSoundingGsd) | **GET** /repository/search/type/type_sounding_gsd | Search API for &#39;GSD Sounding&#39; entry type |


<a id="searchTypeSoundingGsd"></a>
# **searchTypeSoundingGsd**
> searchTypeSoundingGsd(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeSoundingGsdApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeSoundingGsdApi apiInstance = new TypeTypeSoundingGsdApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeSoundingGsd(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeSoundingGsdApi#searchTypeSoundingGsd");
