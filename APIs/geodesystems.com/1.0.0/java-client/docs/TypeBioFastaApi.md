...
|------------- | ------------- | -------------|
| [**searchBioFasta**](TypeBioFastaApi.md#searchBioFasta) | **GET** /repository/search/type/bio_fasta | Search API for &#39;FASTA File&#39; entry type |


<a id="searchBioFasta"></a>
# **searchBioFasta**
> searchBioFasta(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioFastaApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioFastaApi apiInstance = new TypeBioFastaApi(defaultClient);
    ...
    try {
      apiInstance.searchBioFasta(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioFastaApi#searchBioFasta");
