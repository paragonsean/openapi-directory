...
|------------- | ------------- | -------------|
| [**searchTypeSoundingCod**](TypeTypeSoundingCodApi.md#searchTypeSoundingCod) | **GET** /repository/search/type/type_sounding_cod | Search API for &#39;COD Sounding&#39; entry type |


<a id="searchTypeSoundingCod"></a>
# **searchTypeSoundingCod**
> searchTypeSoundingCod(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeSoundingCodApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeSoundingCodApi apiInstance = new TypeTypeSoundingCodApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeSoundingCod(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeSoundingCodApi#searchTypeSoundingCod");
