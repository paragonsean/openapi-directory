...
|------------- | ------------- | -------------|
| [**searchNotes**](TypeNotesApi.md#searchNotes) | **GET** /repository/search/type/notes | Search API for &#39;Notes&#39; entry type |


<a id="searchNotes"></a>
# **searchNotes**
> searchNotes(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbNotesNote)
...
import org.openapitools.client.api.TypeNotesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeNotesApi apiInstance = new TypeNotesApi(defaultClient);
    ...
    String searchDbNotesNote = "searchDbNotesNote_example"; // String | Note
    try {
      apiInstance.searchNotes(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbNotesNote);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeNotesApi#searchNotes");
...
| **searchDbNotesNote** | **String**| Note | [optional] |
