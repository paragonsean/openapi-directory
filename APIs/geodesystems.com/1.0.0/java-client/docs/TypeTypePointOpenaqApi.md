...
|------------- | ------------- | -------------|
| [**searchTypePointOpenaq**](TypeTypePointOpenaqApi.md#searchTypePointOpenaq) | **GET** /repository/search/type/type_point_openaq | Search API for &#39;Open AQ Air Quality&#39; entry type |


<a id="searchTypePointOpenaq"></a>
# **searchTypePointOpenaq**
> searchTypePointOpenaq(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointOpenaqLocation, searchTypePointOpenaqCountry, searchTypePointOpenaqCity, searchTypePointOpenaqHoursOffset)
...
import org.openapitools.client.api.TypeTypePointOpenaqApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointOpenaqApi apiInstance = new TypeTypePointOpenaqApi(defaultClient);
    ...
    String searchTypePointOpenaqLocation = "searchTypePointOpenaqLocation_example"; // String | Location
    String searchTypePointOpenaqCountry = "searchTypePointOpenaqCountry_example"; // String | Country
    String searchTypePointOpenaqCity = "searchTypePointOpenaqCity_example"; // String | City
    Integer searchTypePointOpenaqHoursOffset = 56; // Integer | Offset Hours
    try {
      apiInstance.searchTypePointOpenaq(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointOpenaqLocation, searchTypePointOpenaqCountry, searchTypePointOpenaqCity, searchTypePointOpenaqHoursOffset);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointOpenaqApi#searchTypePointOpenaq");
...
| **searchTypePointOpenaqLocation** | **String**| Location | [optional] |
| **searchTypePointOpenaqCountry** | **String**| Country | [optional] |
| **searchTypePointOpenaqCity** | **String**| City | [optional] |
| **searchTypePointOpenaqHoursOffset** | **Integer**| Offset Hours | [optional] |
