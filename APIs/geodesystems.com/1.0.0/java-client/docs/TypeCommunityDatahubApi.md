...
|------------- | ------------- | -------------|
| [**searchCommunityDatahub**](TypeCommunityDatahubApi.md#searchCommunityDatahub) | **GET** /repository/search/type/community_datahub | Search API for &#39;Data Hub&#39; entry type |


<a id="searchCommunityDatahub"></a>
# **searchCommunityDatahub**
> searchCommunityDatahub(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeCommunityDatahubApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeCommunityDatahubApi apiInstance = new TypeCommunityDatahubApi(defaultClient);
    ...
    try {
      apiInstance.searchCommunityDatahub(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeCommunityDatahubApi#searchCommunityDatahub");
