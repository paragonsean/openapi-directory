...
|------------- | ------------- | -------------|
| [**searchTypePointOceanCsvSadoPosition**](TypeTypePointOceanCsvSadoPositionApi.md#searchTypePointOceanCsvSadoPosition) | **GET** /repository/search/type/type_point_ocean_csv_sado_position | Search API for &#39;SADO Position Data&#39; entry type |


<a id="searchTypePointOceanCsvSadoPosition"></a>
# **searchTypePointOceanCsvSadoPosition**
> searchTypePointOceanCsvSadoPosition(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointOceanCsvSadoPositionApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointOceanCsvSadoPositionApi apiInstance = new TypeTypePointOceanCsvSadoPositionApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointOceanCsvSadoPosition(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointOceanCsvSadoPositionApi#searchTypePointOceanCsvSadoPosition");
