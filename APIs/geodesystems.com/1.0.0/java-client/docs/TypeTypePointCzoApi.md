...
|------------- | ------------- | -------------|
| [**searchTypePointCzo**](TypeTypePointCzoApi.md#searchTypePointCzo) | **GET** /repository/search/type/type_point_czo | Search API for &#39;CZO Display File Format&#39; entry type |


<a id="searchTypePointCzo"></a>
# **searchTypePointCzo**
> searchTypePointCzo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointCzoApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointCzoApi apiInstance = new TypeTypePointCzoApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointCzo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointCzoApi#searchTypePointCzo");
