...
|------------- | ------------- | -------------|
| [**searchTypeGtfsRoutes**](TypeTypeGtfsRoutesApi.md#searchTypeGtfsRoutes) | **GET** /repository/search/type/type_gtfs_routes | Search API for &#39;Transit Route Collection&#39; entry type |


<a id="searchTypeGtfsRoutes"></a>
# **searchTypeGtfsRoutes**
> searchTypeGtfsRoutes(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeGtfsRoutesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeGtfsRoutesApi apiInstance = new TypeTypeGtfsRoutesApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeGtfsRoutes(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeGtfsRoutesApi#searchTypeGtfsRoutes");
