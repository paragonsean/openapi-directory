...
|------------- | ------------- | -------------|
| [**searchTypePointAmrcFinal**](TypeTypePointAmrcFinalApi.md#searchTypePointAmrcFinal) | **GET** /repository/search/type/type_point_amrc_final | Search API for &#39;AMRC Final QC Data&#39; entry type |


<a id="searchTypePointAmrcFinal"></a>
# **searchTypePointAmrcFinal**
> searchTypePointAmrcFinal(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointAmrcFinalSiteId, searchTypePointAmrcFinalSiteName, searchTypePointAmrcFinalArgosId)
...
import org.openapitools.client.api.TypeTypePointAmrcFinalApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointAmrcFinalApi apiInstance = new TypeTypePointAmrcFinalApi(defaultClient);
    ...
    String searchTypePointAmrcFinalSiteId = "searchTypePointAmrcFinalSiteId_example"; // String | Site ID
    String searchTypePointAmrcFinalSiteName = "searchTypePointAmrcFinalSiteName_example"; // String | Site Name
    String searchTypePointAmrcFinalArgosId = "searchTypePointAmrcFinalArgosId_example"; // String | Argos ID
    try {
      apiInstance.searchTypePointAmrcFinal(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointAmrcFinalSiteId, searchTypePointAmrcFinalSiteName, searchTypePointAmrcFinalArgosId);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointAmrcFinalApi#searchTypePointAmrcFinal");
...
| **searchTypePointAmrcFinalSiteId** | **String**| Site ID | [optional] |
| **searchTypePointAmrcFinalSiteName** | **String**| Site Name | [optional] |
| **searchTypePointAmrcFinalArgosId** | **String**| Argos ID | [optional] |
