...
<a id="searchFtp"></a>
# **searchFtp**
> searchFtp(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeFtpApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeFtpApi apiInstance = new TypeFtpApi(defaultClient);
    ...
    try {
      apiInstance.searchFtp(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeFtpApi#searchFtp");
