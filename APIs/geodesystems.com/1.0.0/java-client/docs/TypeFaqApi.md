...
|------------- | ------------- | -------------|
| [**searchFaq**](TypeFaqApi.md#searchFaq) | **GET** /repository/search/type/faq | Search API for &#39;FAQ&#39; entry type |


<a id="searchFaq"></a>
# **searchFaq**
> searchFaq(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeFaqApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeFaqApi apiInstance = new TypeFaqApi(defaultClient);
    ...
    try {
      apiInstance.searchFaq(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeFaqApi#searchFaq");
