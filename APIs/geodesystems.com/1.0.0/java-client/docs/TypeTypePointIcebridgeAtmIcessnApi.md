...
<a id="searchTypePointIcebridgeAtmIcessn"></a>
# **searchTypePointIcebridgeAtmIcessn**
> searchTypePointIcebridgeAtmIcessn(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointIcebridgeAtmIcessnApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointIcebridgeAtmIcessnApi apiInstance = new TypeTypePointIcebridgeAtmIcessnApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointIcebridgeAtmIcessn(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointIcebridgeAtmIcessnApi#searchTypePointIcebridgeAtmIcessn");
