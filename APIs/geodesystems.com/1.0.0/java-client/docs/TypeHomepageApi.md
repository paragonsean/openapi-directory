...
|------------- | ------------- | -------------|
| [**searchHomepage**](TypeHomepageApi.md#searchHomepage) | **GET** /repository/search/type/homepage | Search API for &#39;Home Page&#39; entry type |


<a id="searchHomepage"></a>
# **searchHomepage**
> searchHomepage(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeHomepageApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeHomepageApi apiInstance = new TypeHomepageApi(defaultClient);
    ...
    try {
      apiInstance.searchHomepage(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeHomepageApi#searchHomepage");
