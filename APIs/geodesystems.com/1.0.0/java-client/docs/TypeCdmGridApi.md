...
<a id="searchCdmGrid"></a>
# **searchCdmGrid**
> searchCdmGrid(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeCdmGridApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeCdmGridApi apiInstance = new TypeCdmGridApi(defaultClient);
    ...
    try {
      apiInstance.searchCdmGrid(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeCdmGridApi#searchCdmGrid");
