...
|------------- | ------------- | -------------|
| [**searchBioOmeTiff**](TypeBioOmeTiffApi.md#searchBioOmeTiff) | **GET** /repository/search/type/bio_ome_tiff | Search API for &#39;OME TIFF File&#39; entry type |


<a id="searchBioOmeTiff"></a>
# **searchBioOmeTiff**
> searchBioOmeTiff(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioOmeTiffApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioOmeTiffApi apiInstance = new TypeBioOmeTiffApi(defaultClient);
    ...
    try {
      apiInstance.searchBioOmeTiff(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioOmeTiffApi#searchBioOmeTiff");
