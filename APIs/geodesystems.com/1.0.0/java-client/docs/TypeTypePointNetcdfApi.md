...
<a id="searchTypePointNetcdf"></a>
# **searchTypePointNetcdf**
> searchTypePointNetcdf(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointNetcdfApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointNetcdfApi apiInstance = new TypeTypePointNetcdfApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointNetcdf(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointNetcdfApi#searchTypePointNetcdf");
