...
|------------- | ------------- | -------------|
| [**searchTypeBlsSurvey**](TypeTypeBlsSurveyApi.md#searchTypeBlsSurvey) | **GET** /repository/search/type/type_bls_survey | Search API for &#39;BLS Survey&#39; entry type |


<a id="searchTypeBlsSurvey"></a>
# **searchTypeBlsSurvey**
> searchTypeBlsSurvey(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeBlsSurveyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeBlsSurveyApi apiInstance = new TypeTypeBlsSurveyApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeBlsSurvey(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeBlsSurveyApi#searchTypeBlsSurvey");
