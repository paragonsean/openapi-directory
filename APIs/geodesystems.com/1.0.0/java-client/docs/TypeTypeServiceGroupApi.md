...
<a id="searchTypeServiceGroup"></a>
# **searchTypeServiceGroup**
> searchTypeServiceGroup(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeServiceGroupApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeServiceGroupApi apiInstance = new TypeTypeServiceGroupApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeServiceGroup(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeServiceGroupApi#searchTypeServiceGroup");
