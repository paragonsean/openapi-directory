...
|------------- | ------------- | -------------|
| [**searchTypeGtfsTrip**](TypeTypeGtfsTripApi.md#searchTypeGtfsTrip) | **GET** /repository/search/type/type_gtfs_trip | Search API for &#39;Transit Trip&#39; entry type |


<a id="searchTypeGtfsTrip"></a>
# **searchTypeGtfsTrip**
> searchTypeGtfsTrip(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeGtfsTripTripId, searchTypeGtfsTripStopIds, searchTypeGtfsTripWheelchairAccessible, searchTypeGtfsTripBikesAllowed)
...
import org.openapitools.client.api.TypeTypeGtfsTripApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeGtfsTripApi apiInstance = new TypeTypeGtfsTripApi(defaultClient);
    ...
    String searchTypeGtfsTripTripId = "searchTypeGtfsTripTripId_example"; // String | Trip ID
    String searchTypeGtfsTripStopIds = "searchTypeGtfsTripStopIds_example"; // String | Stop IDS
    String searchTypeGtfsTripWheelchairAccessible = "searchTypeGtfsTripWheelchairAccessible_example"; // String | Wheelchair Accessible
    String searchTypeGtfsTripBikesAllowed = "searchTypeGtfsTripBikesAllowed_example"; // String | Bikes Allowed
    try {
      apiInstance.searchTypeGtfsTrip(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeGtfsTripTripId, searchTypeGtfsTripStopIds, searchTypeGtfsTripWheelchairAccessible, searchTypeGtfsTripBikesAllowed);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeGtfsTripApi#searchTypeGtfsTrip");
...
| **searchTypeGtfsTripTripId** | **String**| Trip ID | [optional] |
| **searchTypeGtfsTripStopIds** | **String**| Stop IDS | [optional] |
| **searchTypeGtfsTripWheelchairAccessible** | **String**| Wheelchair Accessible | [optional] |
| **searchTypeGtfsTripBikesAllowed** | **String**| Bikes Allowed | [optional] |
