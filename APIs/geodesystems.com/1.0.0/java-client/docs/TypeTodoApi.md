...
|------------- | ------------- | -------------|
| [**searchTodo**](TypeTodoApi.md#searchTodo) | **GET** /repository/search/type/todo | Search API for &#39;Todo&#39; entry type |


<a id="searchTodo"></a>
# **searchTodo**
> searchTodo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbTodoChecked, searchDbTodoTitle, searchDbTodoCategory)
...
import org.openapitools.client.api.TypeTodoApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTodoApi apiInstance = new TypeTodoApi(defaultClient);
    ...
    Boolean searchDbTodoChecked = true; // Boolean | Done
    String searchDbTodoTitle = "searchDbTodoTitle_example"; // String | What
    String searchDbTodoCategory = "searchDbTodoCategory_example"; // String | Category
    try {
      apiInstance.searchTodo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbTodoChecked, searchDbTodoTitle, searchDbTodoCategory);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTodoApi#searchTodo");
...
| **searchDbTodoChecked** | **Boolean**| Done | [optional] |
| **searchDbTodoTitle** | **String**| What | [optional] |
| **searchDbTodoCategory** | **String**| Category | [optional] |
