...
|------------- | ------------- | -------------|
| [**searchTypePointSimpleRecords**](TypeTypePointSimpleRecordsApi.md#searchTypePointSimpleRecords) | **GET** /repository/search/type/type_point_simple_records | Search API for &#39;Simple Records&#39; entry type |


<a id="searchTypePointSimpleRecords"></a>
# **searchTypePointSimpleRecords**
> searchTypePointSimpleRecords(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointSimpleRecordsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointSimpleRecordsApi apiInstance = new TypeTypePointSimpleRecordsApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointSimpleRecords(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointSimpleRecordsApi#searchTypePointSimpleRecords");
