...
|------------- | ------------- | -------------|
| [**searchTypePsdMonthlyClimateIndex**](TypeTypePsdMonthlyClimateIndexApi.md#searchTypePsdMonthlyClimateIndex) | **GET** /repository/search/type/type_psd_monthly_climate_index | Search API for &#39;NOAA-ESRL-PSD Monthly Climate Index&#39; entry type |


<a id="searchTypePsdMonthlyClimateIndex"></a>
# **searchTypePsdMonthlyClimateIndex**
> searchTypePsdMonthlyClimateIndex(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePsdMonthlyClimateIndexUnits)
...
import org.openapitools.client.api.TypeTypePsdMonthlyClimateIndexApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePsdMonthlyClimateIndexApi apiInstance = new TypeTypePsdMonthlyClimateIndexApi(defaultClient);
    ...
    String searchTypePsdMonthlyClimateIndexUnits = "searchTypePsdMonthlyClimateIndexUnits_example"; // String | Units
    try {
      apiInstance.searchTypePsdMonthlyClimateIndex(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePsdMonthlyClimateIndexUnits);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePsdMonthlyClimateIndexApi#searchTypePsdMonthlyClimateIndex");
...
| **searchTypePsdMonthlyClimateIndexUnits** | **String**| Units | [optional] |
