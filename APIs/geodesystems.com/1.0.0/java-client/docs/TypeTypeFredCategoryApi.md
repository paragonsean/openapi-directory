...
<a id="searchTypeFredCategory"></a>
# **searchTypeFredCategory**
> searchTypeFredCategory(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeFredCategoryApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeFredCategoryApi apiInstance = new TypeTypeFredCategoryApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeFredCategory(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeFredCategoryApi#searchTypeFredCategory");
