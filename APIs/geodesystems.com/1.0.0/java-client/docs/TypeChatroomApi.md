...
<a id="searchChatroom"></a>
# **searchChatroom**
> searchChatroom(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeChatroomApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeChatroomApi apiInstance = new TypeChatroomApi(defaultClient);
    ...
    try {
      apiInstance.searchChatroom(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeChatroomApi#searchChatroom");
