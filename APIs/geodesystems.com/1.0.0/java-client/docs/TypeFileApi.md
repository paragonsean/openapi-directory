...
<a id="searchFile"></a>
# **searchFile**
> searchFile(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeFileApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeFileApi apiInstance = new TypeFileApi(defaultClient);
    ...
    try {
      apiInstance.searchFile(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeFileApi#searchFile");
