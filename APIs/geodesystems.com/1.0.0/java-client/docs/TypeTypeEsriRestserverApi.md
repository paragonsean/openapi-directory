...
<a id="searchTypeEsriRestserver"></a>
# **searchTypeEsriRestserver**
> searchTypeEsriRestserver(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeEsriRestserverApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeEsriRestserverApi apiInstance = new TypeTypeEsriRestserverApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeEsriRestserver(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeEsriRestserverApi#searchTypeEsriRestserver");
