...
<a id="searchLidarLvis"></a>
# **searchLidarLvis**
> searchLidarLvis(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeLidarLvisApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeLidarLvisApi apiInstance = new TypeLidarLvisApi(defaultClient);
    ...
    try {
      apiInstance.searchLidarLvis(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeLidarLvisApi#searchLidarLvis");
