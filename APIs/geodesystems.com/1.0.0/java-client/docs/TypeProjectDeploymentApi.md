...
<a id="searchProjectDeployment"></a>
# **searchProjectDeployment**
> searchProjectDeployment(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectDeploymentApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectDeploymentApi apiInstance = new TypeProjectDeploymentApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectDeployment(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectDeploymentApi#searchProjectDeployment");
