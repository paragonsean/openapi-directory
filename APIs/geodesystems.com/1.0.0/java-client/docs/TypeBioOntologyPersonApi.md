...
<a id="searchBioOntologyPerson"></a>
# **searchBioOntologyPerson**
> searchBioOntologyPerson(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioOntologyPersonGender)
...
import org.openapitools.client.api.TypeBioOntologyPersonApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioOntologyPersonApi apiInstance = new TypeBioOntologyPersonApi(defaultClient);
    ...
    String searchBioOntologyPersonGender = "searchBioOntologyPersonGender_example"; // String | Gender
    try {
      apiInstance.searchBioOntologyPerson(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioOntologyPersonGender);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioOntologyPersonApi#searchBioOntologyPerson");
