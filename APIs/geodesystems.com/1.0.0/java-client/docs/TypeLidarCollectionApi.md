...
|------------- | ------------- | -------------|
| [**searchLidarCollection**](TypeLidarCollectionApi.md#searchLidarCollection) | **GET** /repository/search/type/lidar_collection | Search API for &#39;LiDAR Collection&#39; entry type |


<a id="searchLidarCollection"></a>
# **searchLidarCollection**
> searchLidarCollection(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeLidarCollectionApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeLidarCollectionApi apiInstance = new TypeLidarCollectionApi(defaultClient);
    ...
    try {
      apiInstance.searchLidarCollection(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeLidarCollectionApi#searchLidarCollection");
