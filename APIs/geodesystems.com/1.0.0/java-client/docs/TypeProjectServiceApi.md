...
|------------- | ------------- | -------------|
| [**searchProjectService**](TypeProjectServiceApi.md#searchProjectService) | **GET** /repository/search/type/project_service | Search API for &#39;Data Access Service&#39; entry type |


<a id="searchProjectService"></a>
# **searchProjectService**
> searchProjectService(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectServiceServiceType, searchProjectServiceProvider)
...
import org.openapitools.client.api.TypeProjectServiceApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectServiceApi apiInstance = new TypeProjectServiceApi(defaultClient);
    ...
    String searchProjectServiceServiceType = "searchProjectServiceServiceType_example"; // String | Service Type
    String searchProjectServiceProvider = "searchProjectServiceProvider_example"; // String | Provider
    try {
      apiInstance.searchProjectService(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectServiceServiceType, searchProjectServiceProvider);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectServiceApi#searchProjectService");
...
| **searchProjectServiceServiceType** | **String**| Service Type | [optional] |
| **searchProjectServiceProvider** | **String**| Provider | [optional] |
