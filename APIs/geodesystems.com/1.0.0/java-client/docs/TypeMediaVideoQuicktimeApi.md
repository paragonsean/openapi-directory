...
<a id="searchMediaVideoQuicktime"></a>
# **searchMediaVideoQuicktime**
> searchMediaVideoQuicktime(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeMediaVideoQuicktimeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeMediaVideoQuicktimeApi apiInstance = new TypeMediaVideoQuicktimeApi(defaultClient);
    ...
    try {
      apiInstance.searchMediaVideoQuicktime(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeMediaVideoQuicktimeApi#searchMediaVideoQuicktime");
