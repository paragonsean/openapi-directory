...
|------------- | ------------- | -------------|
| [**searchTypeServiceLink**](TypeTypeServiceLinkApi.md#searchTypeServiceLink) | **GET** /repository/search/type/type_service_link | Search API for &#39;Service Link&#39; entry type |


<a id="searchTypeServiceLink"></a>
# **searchTypeServiceLink**
> searchTypeServiceLink(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeServiceLinkApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeServiceLinkApi apiInstance = new TypeTypeServiceLinkApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeServiceLink(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeServiceLinkApi#searchTypeServiceLink");
