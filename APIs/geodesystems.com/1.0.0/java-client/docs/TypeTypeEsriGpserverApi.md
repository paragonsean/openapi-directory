...
|------------- | ------------- | -------------|
| [**searchTypeEsriGpserver**](TypeTypeEsriGpserverApi.md#searchTypeEsriGpserver) | **GET** /repository/search/type/type_esri_gpserver | Search API for &#39;ESRI GP Server&#39; entry type |


<a id="searchTypeEsriGpserver"></a>
# **searchTypeEsriGpserver**
> searchTypeEsriGpserver(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeEsriGpserverApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeEsriGpserverApi apiInstance = new TypeTypeEsriGpserverApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeEsriGpserver(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeEsriGpserverApi#searchTypeEsriGpserver");
