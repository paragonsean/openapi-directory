...
<a id="searchProjectStandardName"></a>
# **searchProjectStandardName**
> searchProjectStandardName(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectStandardNameUnit, searchProjectStandardNameAliases)
...
import org.openapitools.client.api.TypeProjectStandardNameApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectStandardNameApi apiInstance = new TypeProjectStandardNameApi(defaultClient);
    ...
    String searchProjectStandardNameUnit = "searchProjectStandardNameUnit_example"; // String | Canonical Unit
    String searchProjectStandardNameAliases = "searchProjectStandardNameAliases_example"; // String | Aliases
    try {
      apiInstance.searchProjectStandardName(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectStandardNameUnit, searchProjectStandardNameAliases);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectStandardNameApi#searchProjectStandardName");
