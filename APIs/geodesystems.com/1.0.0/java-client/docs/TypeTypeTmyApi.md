...
<a id="searchTypeTmy"></a>
# **searchTypeTmy**
> searchTypeTmy(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeTmyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeTmyApi apiInstance = new TypeTypeTmyApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeTmy(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeTmyApi#searchTypeTmy");
