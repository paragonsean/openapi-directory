...
<a id="searchTypePointIdv"></a>
# **searchTypePointIdv**
> searchTypePointIdv(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointIdvApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointIdvApi apiInstance = new TypeTypePointIdvApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointIdv(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointIdvApi#searchTypePointIdv");
