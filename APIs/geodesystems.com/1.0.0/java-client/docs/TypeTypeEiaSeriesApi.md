...
<a id="searchTypeEiaSeries"></a>
# **searchTypeEiaSeries**
> searchTypeEiaSeries(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeEiaSeriesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeEiaSeriesApi apiInstance = new TypeTypeEiaSeriesApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeEiaSeries(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeEiaSeriesApi#searchTypeEiaSeries");
