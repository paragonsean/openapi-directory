...
|------------- | ------------- | -------------|
| [**searchProjectProject**](TypeProjectProjectApi.md#searchProjectProject) | **GET** /repository/search/type/project_project | Search API for &#39;Project&#39; entry type |


<a id="searchProjectProject"></a>
# **searchProjectProject**
> searchProjectProject(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectProjectApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectProjectApi apiInstance = new TypeProjectProjectApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectProject(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectProjectApi#searchProjectProject");
