...
|------------- | ------------- | -------------|
| [**searchTypeMb**](TypeTypeMbApi.md#searchTypeMb) | **GET** /repository/search/type/type_mb | Search API for &#39;MB Bathymetry&#39; entry type |


<a id="searchTypeMb"></a>
# **searchTypeMb**
> searchTypeMb(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeMbApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeMbApi apiInstance = new TypeTypeMbApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeMb(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeMbApi#searchTypeMb");
