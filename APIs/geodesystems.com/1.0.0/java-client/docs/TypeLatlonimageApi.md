...
<a id="searchLatlonimage"></a>
# **searchLatlonimage**
> searchLatlonimage(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeLatlonimageApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeLatlonimageApi apiInstance = new TypeLatlonimageApi(defaultClient);
    ...
    try {
      apiInstance.searchLatlonimage(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeLatlonimageApi#searchLatlonimage");
