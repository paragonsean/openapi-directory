...
|------------- | ------------- | -------------|
| [**searchGlossary**](TypeGlossaryApi.md#searchGlossary) | **GET** /repository/search/type/glossary | Search API for &#39;Glossary&#39; entry type |


<a id="searchGlossary"></a>
# **searchGlossary**
> searchGlossary(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeGlossaryApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGlossaryApi apiInstance = new TypeGlossaryApi(defaultClient);
    ...
    try {
      apiInstance.searchGlossary(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGlossaryApi#searchGlossary");
