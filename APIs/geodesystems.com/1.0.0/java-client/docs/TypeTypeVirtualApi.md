...
|------------- | ------------- | -------------|
| [**searchTypeVirtual**](TypeTypeVirtualApi.md#searchTypeVirtual) | **GET** /repository/search/type/type_virtual | Search API for &#39;Virtual Group&#39; entry type |


<a id="searchTypeVirtual"></a>
# **searchTypeVirtual**
> searchTypeVirtual(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeVirtualApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeVirtualApi apiInstance = new TypeTypeVirtualApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeVirtual(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeVirtualApi#searchTypeVirtual");
