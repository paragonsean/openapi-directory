...
|------------- | ------------- | -------------|
| [**searchTripFlight**](TypeTripFlightApi.md#searchTripFlight) | **GET** /repository/search/type/trip_flight | Search API for &#39;Flight Leg&#39; entry type |


<a id="searchTripFlight"></a>
# **searchTripFlight**
> searchTripFlight(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTripFlightApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTripFlightApi apiInstance = new TypeTripFlightApi(defaultClient);
    ...
    try {
      apiInstance.searchTripFlight(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTripFlightApi#searchTripFlight");
