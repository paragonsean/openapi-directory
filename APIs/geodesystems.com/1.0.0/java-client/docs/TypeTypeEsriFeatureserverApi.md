...
|------------- | ------------- | -------------|
| [**searchTypeEsriFeatureserver**](TypeTypeEsriFeatureserverApi.md#searchTypeEsriFeatureserver) | **GET** /repository/search/type/type_esri_featureserver | Search API for &#39;ESRI Feature Server&#39; entry type |


<a id="searchTypeEsriFeatureserver"></a>
# **searchTypeEsriFeatureserver**
> searchTypeEsriFeatureserver(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeEsriFeatureserverApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeEsriFeatureserverApi apiInstance = new TypeTypeEsriFeatureserverApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeEsriFeatureserver(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeEsriFeatureserverApi#searchTypeEsriFeatureserver");
