...
<a id="searchBioOntologyAssay"></a>
# **searchBioOntologyAssay**
> searchBioOntologyAssay(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioOntologyAssayApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioOntologyAssayApi apiInstance = new TypeBioOntologyAssayApi(defaultClient);
    ...
    try {
      apiInstance.searchBioOntologyAssay(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioOntologyAssayApi#searchBioOntologyAssay");
