...
<a id="searchUsPlaces"></a>
# **searchUsPlaces**
> searchUsPlaces(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbUsPlacesFeatureName, searchDbUsPlacesFeatureClass, searchDbUsPlacesStateAlpha, searchDbUsPlacesCountyName, searchDbUsPlacesLocation, searchDbUsPlacesElevInFt)
...
import org.openapitools.client.api.TypeUsPlacesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeUsPlacesApi apiInstance = new TypeUsPlacesApi(defaultClient);
    ...
    String searchDbUsPlacesFeatureName = "searchDbUsPlacesFeatureName_example"; // String | Place Name
    String searchDbUsPlacesFeatureClass = "searchDbUsPlacesFeatureClass_example"; // String | Place Type
    String searchDbUsPlacesStateAlpha = "searchDbUsPlacesStateAlpha_example"; // String | State
    String searchDbUsPlacesCountyName = "searchDbUsPlacesCountyName_example"; // String | County Name
    String searchDbUsPlacesLocation = "searchDbUsPlacesLocation_example"; // String | Location
    Double searchDbUsPlacesElevInFt = 3.4D; // Double | Elev In Ft
    try {
      apiInstance.searchUsPlaces(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbUsPlacesFeatureName, searchDbUsPlacesFeatureClass, searchDbUsPlacesStateAlpha, searchDbUsPlacesCountyName, searchDbUsPlacesLocation, searchDbUsPlacesElevInFt);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeUsPlacesApi#searchUsPlaces");
...
| **searchDbUsPlacesElevInFt** | **Double**| Elev In Ft | [optional] |
