...
<a id="searchTypeImageAirport"></a>
# **searchTypeImageAirport**
> searchTypeImageAirport(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeImageAirportApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeImageAirportApi apiInstance = new TypeTypeImageAirportApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeImageAirport(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeImageAirportApi#searchTypeImageAirport");
