...
<a id="searchCataloglink"></a>
# **searchCataloglink**
> searchCataloglink(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeCataloglinkApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeCataloglinkApi apiInstance = new TypeCataloglinkApi(defaultClient);
    ...
    try {
      apiInstance.searchCataloglink(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeCataloglinkApi#searchCataloglink");
