...
|------------- | ------------- | -------------|
| [**searchProjectFieldnote**](TypeProjectFieldnoteApi.md#searchProjectFieldnote) | **GET** /repository/search/type/project_fieldnote | Search API for &#39;Field Note&#39; entry type |


<a id="searchProjectFieldnote"></a>
# **searchProjectFieldnote**
> searchProjectFieldnote(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectFieldnoteApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectFieldnoteApi apiInstance = new TypeProjectFieldnoteApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectFieldnote(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectFieldnoteApi#searchProjectFieldnote");
