...
<a id="searchGadgetsWeather"></a>
# **searchGadgetsWeather**
> searchGadgetsWeather(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeGadgetsWeatherApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGadgetsWeatherApi apiInstance = new TypeGadgetsWeatherApi(defaultClient);
    ...
    try {
      apiInstance.searchGadgetsWeather(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGadgetsWeatherApi#searchGadgetsWeather");
