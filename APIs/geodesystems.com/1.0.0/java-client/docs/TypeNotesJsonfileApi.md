...
<a id="searchNotesJsonfile"></a>
# **searchNotesJsonfile**
> searchNotesJsonfile(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeNotesJsonfileApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeNotesJsonfileApi apiInstance = new TypeNotesJsonfileApi(defaultClient);
    ...
    try {
      apiInstance.searchNotesJsonfile(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeNotesJsonfileApi#searchNotesJsonfile");
