...
<a id="searchProjectContribution"></a>
# **searchProjectContribution**
> searchProjectContribution(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectContributionApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectContributionApi apiInstance = new TypeProjectContributionApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectContribution(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectContributionApi#searchProjectContribution");
