...
|------------- | ------------- | -------------|
| [**searchSlackTeam**](TypeSlackTeamApi.md#searchSlackTeam) | **GET** /repository/search/type/slack_team | Search API for &#39;Slack Team&#39; entry type |


<a id="searchSlackTeam"></a>
# **searchSlackTeam**
> searchSlackTeam(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeSlackTeamApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeSlackTeamApi apiInstance = new TypeSlackTeamApi(defaultClient);
    ...
    try {
      apiInstance.searchSlackTeam(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeSlackTeamApi#searchSlackTeam");
