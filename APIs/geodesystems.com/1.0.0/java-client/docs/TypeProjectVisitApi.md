...
<a id="searchProjectVisit"></a>
# **searchProjectVisit**
> searchProjectVisit(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectVisitApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectVisitApi apiInstance = new TypeProjectVisitApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectVisit(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectVisitApi#searchProjectVisit");
