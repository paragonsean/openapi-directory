...
<a id="searchBioDicom"></a>
# **searchBioDicom**
> searchBioDicom(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioDicomApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioDicomApi apiInstance = new TypeBioDicomApi(defaultClient);
    ...
    try {
      apiInstance.searchBioDicom(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioDicomApi#searchBioDicom");
