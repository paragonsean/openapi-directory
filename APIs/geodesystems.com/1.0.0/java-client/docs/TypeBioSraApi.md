...
<a id="searchBioSra"></a>
# **searchBioSra**
> searchBioSra(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioSraApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioSraApi apiInstance = new TypeBioSraApi(defaultClient);
    ...
    try {
      apiInstance.searchBioSra(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioSraApi#searchBioSra");
