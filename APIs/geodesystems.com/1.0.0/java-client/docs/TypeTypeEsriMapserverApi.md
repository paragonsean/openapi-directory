...
|------------- | ------------- | -------------|
| [**searchTypeEsriMapserver**](TypeTypeEsriMapserverApi.md#searchTypeEsriMapserver) | **GET** /repository/search/type/type_esri_mapserver | Search API for &#39;ESRI Map Server&#39; entry type |


<a id="searchTypeEsriMapserver"></a>
# **searchTypeEsriMapserver**
> searchTypeEsriMapserver(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeEsriMapserverApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeEsriMapserverApi apiInstance = new TypeTypeEsriMapserverApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeEsriMapserver(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeEsriMapserverApi#searchTypeEsriMapserver");
