...
|------------- | ------------- | -------------|
| [**searchNotesNote**](TypeNotesNoteApi.md#searchNotesNote) | **GET** /repository/search/type/notes_note | Search API for &#39;Note&#39; entry type |


<a id="searchNotesNote"></a>
# **searchNotesNote**
> searchNotesNote(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeNotesNoteApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeNotesNoteApi apiInstance = new TypeNotesNoteApi(defaultClient);
    ...
    try {
      apiInstance.searchNotesNote(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeNotesNoteApi#searchNotesNote");
