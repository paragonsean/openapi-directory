...
|------------- | ------------- | -------------|
| [**searchContact**](TypeContactApi.md#searchContact) | **GET** /repository/search/type/contact | Search API for &#39;Contact List&#39; entry type |


<a id="searchContact"></a>
# **searchContact**
> searchContact(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbContactName, searchDbContactInstitution, searchDbContactEmail)
...
import org.openapitools.client.api.TypeContactApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeContactApi apiInstance = new TypeContactApi(defaultClient);
    ...
    String searchDbContactName = "searchDbContactName_example"; // String | Name
    String searchDbContactInstitution = "searchDbContactInstitution_example"; // String | Institution
    String searchDbContactEmail = "searchDbContactEmail_example"; // String | Email
    try {
      apiInstance.searchContact(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbContactName, searchDbContactInstitution, searchDbContactEmail);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeContactApi#searchContact");
...
| **searchDbContactName** | **String**| Name | [optional] |
| **searchDbContactInstitution** | **String**| Institution | [optional] |
| **searchDbContactEmail** | **String**| Email | [optional] |
