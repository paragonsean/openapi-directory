...
<a id="searchTypeDocumentHtml"></a>
# **searchTypeDocumentHtml**
> searchTypeDocumentHtml(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeDocumentHtmlApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeDocumentHtmlApi apiInstance = new TypeTypeDocumentHtmlApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeDocumentHtml(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeDocumentHtmlApi#searchTypeDocumentHtml");
