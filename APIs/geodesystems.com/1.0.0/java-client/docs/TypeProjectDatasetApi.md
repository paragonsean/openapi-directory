...
<a id="searchProjectDataset"></a>
# **searchProjectDataset**
> searchProjectDataset(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectDatasetDatasetId, searchProjectDatasetDataType, searchProjectDatasetDataLevel)
...
import org.openapitools.client.api.TypeProjectDatasetApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectDatasetApi apiInstance = new TypeProjectDatasetApi(defaultClient);
    ...
    String searchProjectDatasetDatasetId = "searchProjectDatasetDatasetId_example"; // String | Dataset ID
    String searchProjectDatasetDataType = "searchProjectDatasetDataType_example"; // String | Data Type
    String searchProjectDatasetDataLevel = "searchProjectDatasetDataLevel_example"; // String | Data Level
    try {
      apiInstance.searchProjectDataset(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectDatasetDatasetId, searchProjectDatasetDataType, searchProjectDatasetDataLevel);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectDatasetApi#searchProjectDataset");
