...
<a id="searchBiblio"></a>
# **searchBiblio**
> searchBiblio(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBiblioPrimaryAuthor, searchBiblioType, searchBiblioInstitution, searchBiblioOtherAuthors, searchBiblioPublication)
...
import org.openapitools.client.api.TypeBiblioApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBiblioApi apiInstance = new TypeBiblioApi(defaultClient);
    ...
    String searchBiblioPrimaryAuthor = "searchBiblioPrimaryAuthor_example"; // String | Primary Author
    String searchBiblioType = "searchBiblioType_example"; // String | Publication Type
    String searchBiblioInstitution = "searchBiblioInstitution_example"; // String | Institution
    String searchBiblioOtherAuthors = "searchBiblioOtherAuthors_example"; // String | Other Authors
    String searchBiblioPublication = "searchBiblioPublication_example"; // String | Publication
    try {
      apiInstance.searchBiblio(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBiblioPrimaryAuthor, searchBiblioType, searchBiblioInstitution, searchBiblioOtherAuthors, searchBiblioPublication);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBiblioApi#searchBiblio");
