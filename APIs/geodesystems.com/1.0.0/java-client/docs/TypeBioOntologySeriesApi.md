...
|------------- | ------------- | -------------|
| [**searchBioOntologySeries**](TypeBioOntologySeriesApi.md#searchBioOntologySeries) | **GET** /repository/search/type/bio_ontology_series | Search API for &#39;Series&#39; entry type |


<a id="searchBioOntologySeries"></a>
# **searchBioOntologySeries**
> searchBioOntologySeries(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioOntologySeriesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioOntologySeriesApi apiInstance = new TypeBioOntologySeriesApi(defaultClient);
    ...
    try {
      apiInstance.searchBioOntologySeries(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioOntologySeriesApi#searchBioOntologySeries");
