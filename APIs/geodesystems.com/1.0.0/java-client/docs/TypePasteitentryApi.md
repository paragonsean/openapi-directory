...
|------------- | ------------- | -------------|
| [**searchPasteitentry**](TypePasteitentryApi.md#searchPasteitentry) | **GET** /repository/search/type/pasteitentry | Search API for &#39;Paste Text Entry&#39; entry type |


<a id="searchPasteitentry"></a>
# **searchPasteitentry**
> searchPasteitentry(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypePasteitentryApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypePasteitentryApi apiInstance = new TypePasteitentryApi(defaultClient);
    ...
    try {
      apiInstance.searchPasteitentry(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypePasteitentryApi#searchPasteitentry");
