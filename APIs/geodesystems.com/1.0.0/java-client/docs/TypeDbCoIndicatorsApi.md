...
<a id="searchDbCoIndicators"></a>
# **searchDbCoIndicators**
> searchDbCoIndicators(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbDbCoIndicatorsGeoName, searchDbDbCoIndicatorsDomain, searchDbDbCoIndicatorsSubdomain, searchDbDbCoIndicatorsIndicatorName, searchDbDbCoIndicatorsDescription, searchDbDbCoIndicatorsMeasure, searchDbDbCoIndicatorsLocation)
...
import org.openapitools.client.api.TypeDbCoIndicatorsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeDbCoIndicatorsApi apiInstance = new TypeDbCoIndicatorsApi(defaultClient);
    ...
    String searchDbDbCoIndicatorsGeoName = "searchDbDbCoIndicatorsGeoName_example"; // String | County
    String searchDbDbCoIndicatorsDomain = "searchDbDbCoIndicatorsDomain_example"; // String | Domain
    String searchDbDbCoIndicatorsSubdomain = "searchDbDbCoIndicatorsSubdomain_example"; // String | Subdomain
    String searchDbDbCoIndicatorsIndicatorName = "searchDbDbCoIndicatorsIndicatorName_example"; // String | Indicator
    String searchDbDbCoIndicatorsDescription = "searchDbDbCoIndicatorsDescription_example"; // String | Description
    Double searchDbDbCoIndicatorsMeasure = 3.4D; // Double | Measure
    String searchDbDbCoIndicatorsLocation = "searchDbDbCoIndicatorsLocation_example"; // String | Location
    try {
      apiInstance.searchDbCoIndicators(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbDbCoIndicatorsGeoName, searchDbDbCoIndicatorsDomain, searchDbDbCoIndicatorsSubdomain, searchDbDbCoIndicatorsIndicatorName, searchDbDbCoIndicatorsDescription, searchDbDbCoIndicatorsMeasure, searchDbDbCoIndicatorsLocation);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeDbCoIndicatorsApi#searchDbCoIndicators");
...
| **searchDbDbCoIndicatorsMeasure** | **Double**| Measure | [optional] |
