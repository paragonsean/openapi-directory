...
<a id="searchBioOntologyStudy"></a>
# **searchBioOntologyStudy**
> searchBioOntologyStudy(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioOntologyStudyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioOntologyStudyApi apiInstance = new TypeBioOntologyStudyApi(defaultClient);
    ...
    try {
      apiInstance.searchBioOntologyStudy(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioOntologyStudyApi#searchBioOntologyStudy");
