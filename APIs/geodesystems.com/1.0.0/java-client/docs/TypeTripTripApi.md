...
<a id="searchTripTrip"></a>
# **searchTripTrip**
> searchTripTrip(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTripTripApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTripTripApi apiInstance = new TypeTripTripApi(defaultClient);
    ...
    try {
      apiInstance.searchTripTrip(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTripTripApi#searchTripTrip");
