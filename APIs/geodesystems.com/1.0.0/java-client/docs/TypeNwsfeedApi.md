...
<a id="searchNwsfeed"></a>
# **searchNwsfeed**
> searchNwsfeed(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeNwsfeedApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeNwsfeedApi apiInstance = new TypeNwsfeedApi(defaultClient);
    ...
    try {
      apiInstance.searchNwsfeed(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeNwsfeedApi#searchNwsfeed");
