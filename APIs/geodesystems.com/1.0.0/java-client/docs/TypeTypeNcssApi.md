...
|------------- | ------------- | -------------|
| [**searchTypeNcss**](TypeTypeNcssApi.md#searchTypeNcss) | **GET** /repository/search/type/type_ncss | Search API for &#39;NetCDF Point Subset&#39; entry type |


<a id="searchTypeNcss"></a>
# **searchTypeNcss**
> searchTypeNcss(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeNcssApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeNcssApi apiInstance = new TypeTypeNcssApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeNcss(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeNcssApi#searchTypeNcss");
