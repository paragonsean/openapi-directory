...
|------------- | ------------- | -------------|
| [**searchProjectGpsRinex**](TypeProjectGpsRinexApi.md#searchProjectGpsRinex) | **GET** /repository/search/type/project_gps_rinex | Search API for &#39;RINEX File&#39; entry type |


<a id="searchProjectGpsRinex"></a>
# **searchProjectGpsRinex**
> searchProjectGpsRinex(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectGpsRinexApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectGpsRinexApi apiInstance = new TypeProjectGpsRinexApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectGpsRinex(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectGpsRinexApi#searchProjectGpsRinex");
