...
|------------- | ------------- | -------------|
| [**searchTypeWmsLayer**](TypeTypeWmsLayerApi.md#searchTypeWmsLayer) | **GET** /repository/search/type/type_wms_layer | Search API for &#39;WMS Layer&#39; entry type |


<a id="searchTypeWmsLayer"></a>
# **searchTypeWmsLayer**
> searchTypeWmsLayer(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeWmsLayerApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeWmsLayerApi apiInstance = new TypeTypeWmsLayerApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeWmsLayer(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeWmsLayerApi#searchTypeWmsLayer");
