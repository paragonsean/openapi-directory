...
|------------- | ------------- | -------------|
| [**searchTypeGtfsStops**](TypeTypeGtfsStopsApi.md#searchTypeGtfsStops) | **GET** /repository/search/type/type_gtfs_stops | Search API for &#39;Transit Stop Collection&#39; entry type |


<a id="searchTypeGtfsStops"></a>
# **searchTypeGtfsStops**
> searchTypeGtfsStops(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeGtfsStopsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeGtfsStopsApi apiInstance = new TypeTypeGtfsStopsApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeGtfsStops(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeGtfsStopsApi#searchTypeGtfsStops");
