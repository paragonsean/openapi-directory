...
|------------- | ------------- | -------------|
| [**searchTypePointOceanNetcdfTrack**](TypeTypePointOceanNetcdfTrackApi.md#searchTypePointOceanNetcdfTrack) | **GET** /repository/search/type/type_point_ocean_netcdf_track | Search API for &#39;NetCDF Track Data&#39; entry type |


<a id="searchTypePointOceanNetcdfTrack"></a>
# **searchTypePointOceanNetcdfTrack**
> searchTypePointOceanNetcdfTrack(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointOceanNetcdfTrackPlatform)
...
import org.openapitools.client.api.TypeTypePointOceanNetcdfTrackApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointOceanNetcdfTrackApi apiInstance = new TypeTypePointOceanNetcdfTrackApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointOceanNetcdfTrack(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointOceanNetcdfTrackPlatform);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointOceanNetcdfTrackApi#searchTypePointOceanNetcdfTrack");
