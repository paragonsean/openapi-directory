...
<a id="searchTypePointOceanNetcdfGlider"></a>
# **searchTypePointOceanNetcdfGlider**
> searchTypePointOceanNetcdfGlider(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointOceanNetcdfTrackPlatform)
...
import org.openapitools.client.api.TypeTypePointOceanNetcdfGliderApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointOceanNetcdfGliderApi apiInstance = new TypeTypePointOceanNetcdfGliderApi(defaultClient);
    ...
    String searchTypePointOceanNetcdfTrackPlatform = "searchTypePointOceanNetcdfTrackPlatform_example"; // String | Platform
    try {
      apiInstance.searchTypePointOceanNetcdfGlider(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointOceanNetcdfTrackPlatform);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointOceanNetcdfGliderApi#searchTypePointOceanNetcdfGlider");
