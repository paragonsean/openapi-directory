...
|------------- | ------------- | -------------|
| [**searchProjectLearningResource**](TypeProjectLearningResourceApi.md#searchProjectLearningResource) | **GET** /repository/search/type/project_learning_resource | Search API for &#39;Teaching Resource&#39; entry type |


<a id="searchProjectLearningResource"></a>
# **searchProjectLearningResource**
> searchProjectLearningResource(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectLearningResourceTopic, searchProjectLearningResourceGradeLevel)
...
import org.openapitools.client.api.TypeProjectLearningResourceApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectLearningResourceApi apiInstance = new TypeProjectLearningResourceApi(defaultClient);
    ...
    String searchProjectLearningResourceTopic = "searchProjectLearningResourceTopic_example"; // String | Topic
    String searchProjectLearningResourceGradeLevel = "searchProjectLearningResourceGradeLevel_example"; // String | Grade Level
    try {
      apiInstance.searchProjectLearningResource(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectLearningResourceTopic, searchProjectLearningResourceGradeLevel);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectLearningResourceApi#searchProjectLearningResource");
...
| **searchProjectLearningResourceTopic** | **String**| Topic | [optional] |
| **searchProjectLearningResourceGradeLevel** | **String**| Grade Level | [optional] |
