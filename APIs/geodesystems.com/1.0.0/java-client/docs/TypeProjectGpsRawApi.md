...
<a id="searchProjectGpsRaw"></a>
# **searchProjectGpsRaw**
> searchProjectGpsRaw(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectGpsRawApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectGpsRawApi apiInstance = new TypeProjectGpsRawApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectGpsRaw(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectGpsRawApi#searchProjectGpsRaw");
