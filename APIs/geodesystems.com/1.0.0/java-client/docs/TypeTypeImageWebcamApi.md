...
<a id="searchTypeImageWebcam"></a>
# **searchTypeImageWebcam**
> searchTypeImageWebcam(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeImageWebcamApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeImageWebcamApi apiInstance = new TypeTypeImageWebcamApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeImageWebcam(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeImageWebcamApi#searchTypeImageWebcam");
