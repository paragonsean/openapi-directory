...
<a id="searchTypePointOceanCsvSadoTTS"></a>
# **searchTypePointOceanCsvSadoTTS**
> searchTypePointOceanCsvSadoTTS(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointOceanCsvSadoTtsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointOceanCsvSadoTtsApi apiInstance = new TypeTypePointOceanCsvSadoTtsApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointOceanCsvSadoTTS(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointOceanCsvSadoTtsApi#searchTypePointOceanCsvSadoTTS");
