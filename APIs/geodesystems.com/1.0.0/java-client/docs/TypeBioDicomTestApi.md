...
|------------- | ------------- | -------------|
| [**searchBioDicomTest**](TypeBioDicomTestApi.md#searchBioDicomTest) | **GET** /repository/search/type/bio_dicom_test | Search API for &#39;DICOM Test File&#39; entry type |


<a id="searchBioDicomTest"></a>
# **searchBioDicomTest**
> searchBioDicomTest(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioDicomTestPatientName, searchBioDicomTestPatientID)
...
import org.openapitools.client.api.TypeBioDicomTestApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioDicomTestApi apiInstance = new TypeBioDicomTestApi(defaultClient);
    ...
    String searchBioDicomTestPatientName = "searchBioDicomTestPatientName_example"; // String | Patient Name
    String searchBioDicomTestPatientID = "searchBioDicomTestPatientID_example"; // String | Patient ID
    try {
      apiInstance.searchBioDicomTest(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioDicomTestPatientName, searchBioDicomTestPatientID);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioDicomTestApi#searchBioDicomTest");
...
| **searchBioDicomTestPatientName** | **String**| Patient Name | [optional] |
| **searchBioDicomTestPatientID** | **String**| Patient ID | [optional] |
