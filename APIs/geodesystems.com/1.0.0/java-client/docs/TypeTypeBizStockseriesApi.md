...
<a id="searchTypeBizStockseries"></a>
# **searchTypeBizStockseries**
> searchTypeBizStockseries(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeBizStockseriesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeBizStockseriesApi apiInstance = new TypeTypeBizStockseriesApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeBizStockseries(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeBizStockseriesApi#searchTypeBizStockseries");
