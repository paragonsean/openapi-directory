...
|------------- | ------------- | -------------|
| [**searchGeoGeojson**](TypeGeoGeApi.md#searchGeoGeojson) | **GET** /repository/search/type/geo_geojson | Search API for &#39;GeoJson File&#39; entry type |


<a id="searchGeoGeojson"></a>
# **searchGeoGeojson**
> searchGeoGeojson(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeGeoGeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGeoGeApi apiInstance = new TypeGeoGeApi(defaultClient);
    ...
    try {
      apiInstance.searchGeoGeojson(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGeoGeApi#searchGeoGeojson");
