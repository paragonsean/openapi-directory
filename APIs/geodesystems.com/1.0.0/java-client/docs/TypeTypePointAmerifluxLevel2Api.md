...
|------------- | ------------- | -------------|
| [**searchTypePointAmerifluxLevel2**](TypeTypePointAmerifluxLevel2Api.md#searchTypePointAmerifluxLevel2) | **GET** /repository/search/type/type_point_ameriflux_level2 | Search API for &#39;Ameriflux Level 2 CSV File&#39; entry type |


<a id="searchTypePointAmerifluxLevel2"></a>
# **searchTypePointAmerifluxLevel2**
> searchTypePointAmerifluxLevel2(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointAmerifluxLevel2SiteId, searchTypePointAmerifluxLevel2Contact, searchTypePointAmerifluxLevel2EcosystemType)
...
import org.openapitools.client.api.TypeTypePointAmerifluxLevel2Api;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointAmerifluxLevel2Api apiInstance = new TypeTypePointAmerifluxLevel2Api(defaultClient);
    ...
    String searchTypePointAmerifluxLevel2SiteId = "searchTypePointAmerifluxLevel2SiteId_example"; // String | Site ID
    String searchTypePointAmerifluxLevel2Contact = "searchTypePointAmerifluxLevel2Contact_example"; // String | Contact
    String searchTypePointAmerifluxLevel2EcosystemType = "searchTypePointAmerifluxLevel2EcosystemType_example"; // String | Ecosystem Type
    try {
      apiInstance.searchTypePointAmerifluxLevel2(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointAmerifluxLevel2SiteId, searchTypePointAmerifluxLevel2Contact, searchTypePointAmerifluxLevel2EcosystemType);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointAmerifluxLevel2Api#searchTypePointAmerifluxLevel2");
...
| **searchTypePointAmerifluxLevel2SiteId** | **String**| Site ID | [optional] |
| **searchTypePointAmerifluxLevel2Contact** | **String**| Contact | [optional] |
| **searchTypePointAmerifluxLevel2EcosystemType** | **String**| Ecosystem Type | [optional] |
