...
|------------- | ------------- | -------------|
| [**searchMediaYoutubevideo**](TypeMediaYoutubevideoApi.md#searchMediaYoutubevideo) | **GET** /repository/search/type/media_youtubevideo | Search API for &#39;YouTube Video&#39; entry type |


<a id="searchMediaYoutubevideo"></a>
# **searchMediaYoutubevideo**
> searchMediaYoutubevideo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeMediaYoutubevideoApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeMediaYoutubevideoApi apiInstance = new TypeMediaYoutubevideoApi(defaultClient);
    ...
    try {
      apiInstance.searchMediaYoutubevideo(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeMediaYoutubevideoApi#searchMediaYoutubevideo");
