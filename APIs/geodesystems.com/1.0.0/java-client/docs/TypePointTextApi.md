...
|------------- | ------------- | -------------|
| [**searchPointText**](TypePointTextApi.md#searchPointText) | **GET** /repository/search/type/point_text | Search API for &#39;Text Point Data&#39; entry type |


<a id="searchPointText"></a>
# **searchPointText**
> searchPointText(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypePointTextApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypePointTextApi apiInstance = new TypePointTextApi(defaultClient);
    ...
    try {
      apiInstance.searchPointText(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypePointTextApi#searchPointText");
