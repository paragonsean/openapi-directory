...
|------------- | ------------- | -------------|
| [**searchBioHmmerIndex**](TypeBioHmmerIndexApi.md#searchBioHmmerIndex) | **GET** /repository/search/type/bio_hmmer_index | Search API for &#39;HMMER Index File&#39; entry type |


<a id="searchBioHmmerIndex"></a>
# **searchBioHmmerIndex**
> searchBioHmmerIndex(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioHmmerIndexApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioHmmerIndexApi apiInstance = new TypeBioHmmerIndexApi(defaultClient);
    ...
    try {
      apiInstance.searchBioHmmerIndex(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioHmmerIndexApi#searchBioHmmerIndex");
