...
<a id="searchBoulderCrimes"></a>
# **searchBoulderCrimes**
> searchBoulderCrimes(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbBoulderCrimesOffense, searchDbBoulderCrimesReportdate, searchDbBoulderCrimesBlockadd, searchDbBoulderCrimesLocation)
...
import org.openapitools.client.api.TypeBoulderCrimesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBoulderCrimesApi apiInstance = new TypeBoulderCrimesApi(defaultClient);
    ...
    String searchDbBoulderCrimesOffense = "searchDbBoulderCrimesOffense_example"; // String | Offense
    String searchDbBoulderCrimesReportdate = "searchDbBoulderCrimesReportdate_example"; // String | Report Date
    String searchDbBoulderCrimesBlockadd = "searchDbBoulderCrimesBlockadd_example"; // String | Address
    String searchDbBoulderCrimesLocation = "searchDbBoulderCrimesLocation_example"; // String | Location
    try {
      apiInstance.searchBoulderCrimes(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbBoulderCrimesOffense, searchDbBoulderCrimesReportdate, searchDbBoulderCrimesBlockadd, searchDbBoulderCrimesLocation);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBoulderCrimesApi#searchBoulderCrimes");
