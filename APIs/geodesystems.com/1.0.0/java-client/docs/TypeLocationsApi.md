...
<a id="searchLocations"></a>
# **searchLocations**
> searchLocations(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbLocationsName, searchDbLocationsType, searchDbLocationsLocation)
...
import org.openapitools.client.api.TypeLocationsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeLocationsApi apiInstance = new TypeLocationsApi(defaultClient);
    ...
    String searchDbLocationsName = "searchDbLocationsName_example"; // String | Name
    String searchDbLocationsType = "searchDbLocationsType_example"; // String | Type
    String searchDbLocationsLocation = "searchDbLocationsLocation_example"; // String | Location
    try {
      apiInstance.searchLocations(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbLocationsName, searchDbLocationsType, searchDbLocationsLocation);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeLocationsApi#searchLocations");
