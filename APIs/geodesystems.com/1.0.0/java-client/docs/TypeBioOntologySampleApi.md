...
|------------- | ------------- | -------------|
| [**searchBioOntologySample**](TypeBioOntologySampleApi.md#searchBioOntologySample) | **GET** /repository/search/type/bio_ontology_sample | Search API for &#39;Sample&#39; entry type |


<a id="searchBioOntologySample"></a>
# **searchBioOntologySample**
> searchBioOntologySample(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioOntologySampleApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioOntologySampleApi apiInstance = new TypeBioOntologySampleApi(defaultClient);
    ...
    try {
      apiInstance.searchBioOntologySample(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioOntologySampleApi#searchBioOntologySample");
