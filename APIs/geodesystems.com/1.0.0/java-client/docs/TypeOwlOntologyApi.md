...
<a id="searchOwlOntology"></a>
# **searchOwlOntology**
> searchOwlOntology(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeOwlOntologyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeOwlOntologyApi apiInstance = new TypeOwlOntologyApi(defaultClient);
    ...
    try {
      apiInstance.searchOwlOntology(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeOwlOntologyApi#searchOwlOntology");
