...
|------------- | ------------- | -------------|
| [**searchFeed**](TypeFeedApi.md#searchFeed) | **GET** /repository/search/type/feed | Search API for &#39;RSS/ATOM Feed&#39; entry type |


<a id="searchFeed"></a>
# **searchFeed**
> searchFeed(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeFeedApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeFeedApi apiInstance = new TypeFeedApi(defaultClient);
    ...
    try {
      apiInstance.searchFeed(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeFeedApi#searchFeed");
