...
|------------- | ------------- | -------------|
| [**searchTypePointWsbbGgp**](TypeTypePointWsbbGgpApi.md#searchTypePointWsbbGgp) | **GET** /repository/search/type/type_point_wsbb_ggp | Search API for &#39;Global Geodynamics GGP Format&#39; entry type |


<a id="searchTypePointWsbbGgp"></a>
# **searchTypePointWsbbGgp**
> searchTypePointWsbbGgp(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointWsbbGgpStation, searchTypePointWsbbGgpInstrument, searchTypePointWsbbGgpAuthor)
...
import org.openapitools.client.api.TypeTypePointWsbbGgpApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointWsbbGgpApi apiInstance = new TypeTypePointWsbbGgpApi(defaultClient);
    ...
    String searchTypePointWsbbGgpStation = "searchTypePointWsbbGgpStation_example"; // String | Station
    String searchTypePointWsbbGgpInstrument = "searchTypePointWsbbGgpInstrument_example"; // String | Instrument
    String searchTypePointWsbbGgpAuthor = "searchTypePointWsbbGgpAuthor_example"; // String | Author
    try {
      apiInstance.searchTypePointWsbbGgp(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointWsbbGgpStation, searchTypePointWsbbGgpInstrument, searchTypePointWsbbGgpAuthor);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointWsbbGgpApi#searchTypePointWsbbGgp");
...
| **searchTypePointWsbbGgpStation** | **String**| Station | [optional] |
| **searchTypePointWsbbGgpInstrument** | **String**| Instrument | [optional] |
| **searchTypePointWsbbGgpAuthor** | **String**| Author | [optional] |
