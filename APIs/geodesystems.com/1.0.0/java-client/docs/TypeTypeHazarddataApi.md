...
<a id="searchTypeHazarddata"></a>
# **searchTypeHazarddata**
> searchTypeHazarddata(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeHazarddataSource)
...
import org.openapitools.client.api.TypeTypeHazarddataApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeHazarddataApi apiInstance = new TypeTypeHazarddataApi(defaultClient);
    ...
    String searchTypeHazarddataSource = "searchTypeHazarddataSource_example"; // String | Source Agency
    try {
      apiInstance.searchTypeHazarddata(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeHazarddataSource);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeHazarddataApi#searchTypeHazarddata");
