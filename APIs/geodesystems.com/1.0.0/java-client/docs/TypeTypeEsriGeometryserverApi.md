...
|------------- | ------------- | -------------|
| [**searchTypeEsriGeometryserver**](TypeTypeEsriGeometryserverApi.md#searchTypeEsriGeometryserver) | **GET** /repository/search/type/type_esri_geometryserver | Search API for &#39;ESRI Geometry Server&#39; entry type |


<a id="searchTypeEsriGeometryserver"></a>
# **searchTypeEsriGeometryserver**
> searchTypeEsriGeometryserver(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeEsriGeometryserverApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeEsriGeometryserverApi apiInstance = new TypeTypeEsriGeometryserverApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeEsriGeometryserver(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeEsriGeometryserverApi#searchTypeEsriGeometryserver");
