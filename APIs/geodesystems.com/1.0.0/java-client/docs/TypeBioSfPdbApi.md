...
<a id="searchBioSfPdb"></a>
# **searchBioSfPdb**
> searchBioSfPdb(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioSfPdbApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioSfPdbApi apiInstance = new TypeBioSfPdbApi(defaultClient);
    ...
    try {
      apiInstance.searchBioSfPdb(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioSfPdbApi#searchBioSfPdb");
