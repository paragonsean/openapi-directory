...
|------------- | ------------- | -------------|
| [**searchTypePointNoaaMadis**](TypeTypePointNoaaMadisApi.md#searchTypePointNoaaMadis) | **GET** /repository/search/type/type_point_noaa_madis | Search API for &#39;NOAA MADIS Point Data&#39; entry type |


<a id="searchTypePointNoaaMadis"></a>
# **searchTypePointNoaaMadis**
> searchTypePointNoaaMadis(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointNoaaMadisApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointNoaaMadisApi apiInstance = new TypeTypePointNoaaMadisApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointNoaaMadis(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointNoaaMadisApi#searchTypePointNoaaMadis");
