...
|------------- | ------------- | -------------|
| [**searchProjectTerm**](TypeProjectTermApi.md#searchProjectTerm) | **GET** /repository/search/type/project_term | Search API for &#39;Vocabulary Term&#39; entry type |


<a id="searchProjectTerm"></a>
# **searchProjectTerm**
> searchProjectTerm(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectTermValue)
...
import org.openapitools.client.api.TypeProjectTermApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectTermApi apiInstance = new TypeProjectTermApi(defaultClient);
    ...
    String searchProjectTermValue = "searchProjectTermValue_example"; // String | Term Value
    try {
      apiInstance.searchProjectTerm(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectTermValue);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectTermApi#searchProjectTerm");
...
| **searchProjectTermValue** | **String**| Term Value | [optional] |
