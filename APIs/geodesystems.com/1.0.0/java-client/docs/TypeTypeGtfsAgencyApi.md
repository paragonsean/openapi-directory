...
|------------- | ------------- | -------------|
| [**searchTypeGtfsAgency**](TypeTypeGtfsAgencyApi.md#searchTypeGtfsAgency) | **GET** /repository/search/type/type_gtfs_agency | Search API for &#39;Transit Agency&#39; entry type |


<a id="searchTypeGtfsAgency"></a>
# **searchTypeGtfsAgency**
> searchTypeGtfsAgency(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeGtfsAgencyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeGtfsAgencyApi apiInstance = new TypeTypeGtfsAgencyApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeGtfsAgency(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeGtfsAgencyApi#searchTypeGtfsAgency");
