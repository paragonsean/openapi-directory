...
<a id="searchGeoGpx"></a>
# **searchGeoGpx**
> searchGeoGpx(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchGeoGpxDistance, searchGeoGpxTotalTime, searchGeoGpxMovingTime, searchGeoGpxSpeed, searchGeoGpxElevationGain, searchGeoGpxElevationLoss)
...
import org.openapitools.client.api.TypeGeoGpxApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGeoGpxApi apiInstance = new TypeGeoGpxApi(defaultClient);
    ...
    Double searchGeoGpxDistance = 3.4D; // Double | Distance
    Double searchGeoGpxTotalTime = 3.4D; // Double | Total Time
    Double searchGeoGpxMovingTime = 3.4D; // Double | Moving Time
    Double searchGeoGpxSpeed = 3.4D; // Double | Average Speed
    Double searchGeoGpxElevationGain = 3.4D; // Double | Elevation Gain
    Double searchGeoGpxElevationLoss = 3.4D; // Double | Elevation Loss
    try {
      apiInstance.searchGeoGpx(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchGeoGpxDistance, searchGeoGpxTotalTime, searchGeoGpxMovingTime, searchGeoGpxSpeed, searchGeoGpxElevationGain, searchGeoGpxElevationLoss);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGeoGpxApi#searchGeoGpx");
...
| **searchGeoGpxDistance** | **Double**| Distance | [optional] |
| **searchGeoGpxTotalTime** | **Double**| Total Time | [optional] |
| **searchGeoGpxMovingTime** | **Double**| Moving Time | [optional] |
| **searchGeoGpxSpeed** | **Double**| Average Speed | [optional] |
| **searchGeoGpxElevationGain** | **Double**| Elevation Gain | [optional] |
| **searchGeoGpxElevationLoss** | **Double**| Elevation Loss | [optional] |
