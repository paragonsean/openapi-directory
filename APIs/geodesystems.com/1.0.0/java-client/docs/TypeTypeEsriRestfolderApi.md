...
<a id="searchTypeEsriRestfolder"></a>
# **searchTypeEsriRestfolder**
> searchTypeEsriRestfolder(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeEsriRestfolderApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeEsriRestfolderApi apiInstance = new TypeTypeEsriRestfolderApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeEsriRestfolder(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeEsriRestfolderApi#searchTypeEsriRestfolder");
