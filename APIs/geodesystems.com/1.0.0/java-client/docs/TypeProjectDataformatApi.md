...
|------------- | ------------- | -------------|
| [**searchProjectDataformat**](TypeProjectDataformatApi.md#searchProjectDataformat) | **GET** /repository/search/type/project_dataformat | Search API for &#39;Data Format&#39; entry type |


<a id="searchProjectDataformat"></a>
# **searchProjectDataformat**
> searchProjectDataformat(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectDataformatDataType, searchProjectDataformatField)
...
import org.openapitools.client.api.TypeProjectDataformatApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectDataformatApi apiInstance = new TypeProjectDataformatApi(defaultClient);
    ...
    String searchProjectDataformatDataType = "searchProjectDataformatDataType_example"; // String | Data Type
    String searchProjectDataformatField = "searchProjectDataformatField_example"; // String | Field
    try {
      apiInstance.searchProjectDataformat(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectDataformatDataType, searchProjectDataformatField);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectDataformatApi#searchProjectDataformat");
...
| **searchProjectDataformatDataType** | **String**| Data Type | [optional] |
| **searchProjectDataformatField** | **String**| Field | [optional] |
