...
|------------- | ------------- | -------------|
| [**searchNotesNotebook**](TypeNotesNotebookApi.md#searchNotesNotebook) | **GET** /repository/search/type/notes_notebook | Search API for &#39;Notebook&#39; entry type |


<a id="searchNotesNotebook"></a>
# **searchNotesNotebook**
> searchNotesNotebook(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeNotesNotebookApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeNotesNotebookApi apiInstance = new TypeNotesNotebookApi(defaultClient);
    ...
    try {
      apiInstance.searchNotesNotebook(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeNotesNotebookApi#searchNotesNotebook");
