...
|------------- | ------------- | -------------|
| [**searchTypePointHydroWaterml**](TypeTypePointHydroWatermlApi.md#searchTypePointHydroWaterml) | **GET** /repository/search/type/type_point_hydro_waterml | Search API for &#39;WaterML&#39; entry type |


<a id="searchTypePointHydroWaterml"></a>
# **searchTypePointHydroWaterml**
> searchTypePointHydroWaterml(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointHydroWatermlSiteCode, searchTypePointHydroWatermlSiteName)
...
import org.openapitools.client.api.TypeTypePointHydroWatermlApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointHydroWatermlApi apiInstance = new TypeTypePointHydroWatermlApi(defaultClient);
    ...
    String searchTypePointHydroWatermlSiteCode = "searchTypePointHydroWatermlSiteCode_example"; // String | Site Code
    String searchTypePointHydroWatermlSiteName = "searchTypePointHydroWatermlSiteName_example"; // String | Site Name
    try {
      apiInstance.searchTypePointHydroWaterml(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointHydroWatermlSiteCode, searchTypePointHydroWatermlSiteName);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointHydroWatermlApi#searchTypePointHydroWaterml");
...
| **searchTypePointHydroWatermlSiteCode** | **String**| Site Code | [optional] |
| **searchTypePointHydroWatermlSiteName** | **String**| Site Name | [optional] |
