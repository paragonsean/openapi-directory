...
<a id="searchPoll"></a>
# **searchPoll**
> searchPoll(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypePollApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypePollApi apiInstance = new TypePollApi(defaultClient);
    ...
    try {
      apiInstance.searchPoll(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypePollApi#searchPoll");
