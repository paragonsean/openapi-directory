...
<a id="searchGeoHdf5"></a>
# **searchGeoHdf5**
> searchGeoHdf5(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeGeoHdf5Api;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGeoHdf5Api apiInstance = new TypeGeoHdf5Api(defaultClient);
    ...
    try {
      apiInstance.searchGeoHdf5(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGeoHdf5Api#searchGeoHdf5");
