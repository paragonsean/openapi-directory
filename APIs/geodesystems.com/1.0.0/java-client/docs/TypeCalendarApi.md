...
|------------- | ------------- | -------------|
| [**searchCalendar**](TypeCalendarApi.md#searchCalendar) | **GET** /repository/search/type/calendar | Search API for &#39;Calendar&#39; entry type |


<a id="searchCalendar"></a>
# **searchCalendar**
> searchCalendar(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeCalendarApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeCalendarApi apiInstance = new TypeCalendarApi(defaultClient);
    ...
    try {
      apiInstance.searchCalendar(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeCalendarApi#searchCalendar");
