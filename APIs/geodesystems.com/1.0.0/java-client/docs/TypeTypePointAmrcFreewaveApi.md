...
|------------- | ------------- | -------------|
| [**searchTypePointAmrcFreewave**](TypeTypePointAmrcFreewaveApi.md#searchTypePointAmrcFreewave) | **GET** /repository/search/type/type_point_amrc_freewave | Search API for &#39;AMRC Freewave  Data&#39; entry type |


<a id="searchTypePointAmrcFreewave"></a>
# **searchTypePointAmrcFreewave**
> searchTypePointAmrcFreewave(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointAmrcFreewaveStationName, searchTypePointAmrcFreewaveFormat, searchTypePointAmrcFreewaveDataloggerModel, searchTypePointAmrcFreewaveDataloggerSerial)
...
import org.openapitools.client.api.TypeTypePointAmrcFreewaveApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointAmrcFreewaveApi apiInstance = new TypeTypePointAmrcFreewaveApi(defaultClient);
    ...
    String searchTypePointAmrcFreewaveStationName = "searchTypePointAmrcFreewaveStationName_example"; // String | Station Name
    String searchTypePointAmrcFreewaveFormat = "searchTypePointAmrcFreewaveFormat_example"; // String | File Format
    String searchTypePointAmrcFreewaveDataloggerModel = "searchTypePointAmrcFreewaveDataloggerModel_example"; // String | Data Logger Model
    String searchTypePointAmrcFreewaveDataloggerSerial = "searchTypePointAmrcFreewaveDataloggerSerial_example"; // String | Data Logger Serial
    try {
      apiInstance.searchTypePointAmrcFreewave(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypePointAmrcFreewaveStationName, searchTypePointAmrcFreewaveFormat, searchTypePointAmrcFreewaveDataloggerModel, searchTypePointAmrcFreewaveDataloggerSerial);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointAmrcFreewaveApi#searchTypePointAmrcFreewave");
...
| **searchTypePointAmrcFreewaveStationName** | **String**| Station Name | [optional] |
| **searchTypePointAmrcFreewaveFormat** | **String**| File Format | [optional] |
| **searchTypePointAmrcFreewaveDataloggerModel** | **String**| Data Logger Model | [optional] |
| **searchTypePointAmrcFreewaveDataloggerSerial** | **String**| Data Logger Serial | [optional] |
