...
|------------- | ------------- | -------------|
| [**searchGridaggregation**](TypeGridaggregationApi.md#searchGridaggregation) | **GET** /repository/search/type/gridaggregation | Search API for &#39;Grid Aggregation&#39; entry type |


<a id="searchGridaggregation"></a>
# **searchGridaggregation**
> searchGridaggregation(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeGridaggregationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGridaggregationApi apiInstance = new TypeGridaggregationApi(defaultClient);
    ...
    try {
      apiInstance.searchGridaggregation(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGridaggregationApi#searchGridaggregation");
