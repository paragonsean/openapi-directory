...
<a id="searchProjectInstrument"></a>
# **searchProjectInstrument**
> searchProjectInstrument(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeProjectInstrumentApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectInstrumentApi apiInstance = new TypeProjectInstrumentApi(defaultClient);
    ...
    try {
      apiInstance.searchProjectInstrument(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectInstrumentApi#searchProjectInstrument");
