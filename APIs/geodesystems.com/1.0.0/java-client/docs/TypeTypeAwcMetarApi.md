...
|------------- | ------------- | -------------|
| [**searchTypeAwcMetar**](TypeTypeAwcMetarApi.md#searchTypeAwcMetar) | **GET** /repository/search/type/type_awc_metar | Search API for &#39;AWC Weather Observations&#39; entry type |


<a id="searchTypeAwcMetar"></a>
# **searchTypeAwcMetar**
> searchTypeAwcMetar(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeAwcMetarSiteId)
...
import org.openapitools.client.api.TypeTypeAwcMetarApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeAwcMetarApi apiInstance = new TypeTypeAwcMetarApi(defaultClient);
    ...
    String searchTypeAwcMetarSiteId = "searchTypeAwcMetarSiteId_example"; // String | Site ID
    try {
      apiInstance.searchTypeAwcMetar(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchTypeAwcMetarSiteId);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeAwcMetarApi#searchTypeAwcMetar");
...
| **searchTypeAwcMetarSiteId** | **String**| Site ID | [optional] |
