...
import org.openapitools.client.api.TypeBoulderEmailsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBoulderEmailsApi apiInstance = new TypeBoulderEmailsApi(defaultClient);
    ...
    String searchDbBoulderEmailsSentFrom = "searchDbBoulderEmailsSentFrom_example"; // String | Sent From
    String searchDbBoulderEmailsSentTo = "searchDbBoulderEmailsSentTo_example"; // String | Sent To
    String searchDbBoulderEmailsSentCc = "searchDbBoulderEmailsSentCc_example"; // String | Sent Cc
    String searchDbBoulderEmailsReceivedDate = "searchDbBoulderEmailsReceivedDate_example"; // String | Received Date
    String searchDbBoulderEmailsEmailSubject = "searchDbBoulderEmailsEmailSubject_example"; // String | Email Subject
    String searchDbBoulderEmailsPlainTextBody = "searchDbBoulderEmailsPlainTextBody_example"; // String | Email Body
    try {
      apiInstance.searchBoulderEmails(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchDbBoulderEmailsSentFrom, searchDbBoulderEmailsSentTo, searchDbBoulderEmailsSentCc, searchDbBoulderEmailsReceivedDate, searchDbBoulderEmailsEmailSubject, searchDbBoulderEmailsPlainTextBody);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBoulderEmailsApi#searchBoulderEmails");
