...
<a id="searchTypeMbPointBasic"></a>
# **searchTypeMbPointBasic**
> searchTypeMbPointBasic(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypeMbPointBasicApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypeMbPointBasicApi apiInstance = new TypeTypeMbPointBasicApi(defaultClient);
    ...
    try {
      apiInstance.searchTypeMbPointBasic(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypeMbPointBasicApi#searchTypeMbPointBasic");
