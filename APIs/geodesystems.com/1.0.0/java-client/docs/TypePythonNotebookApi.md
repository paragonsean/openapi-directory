...
|------------- | ------------- | -------------|
| [**searchPythonNotebook**](TypePythonNotebookApi.md#searchPythonNotebook) | **GET** /repository/search/type/python_notebook | Search API for &#39;IPython Notebook file&#39; entry type |


<a id="searchPythonNotebook"></a>
# **searchPythonNotebook**
> searchPythonNotebook(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypePythonNotebookApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypePythonNotebookApi apiInstance = new TypePythonNotebookApi(defaultClient);
    ...
    try {
      apiInstance.searchPythonNotebook(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypePythonNotebookApi#searchPythonNotebook");
