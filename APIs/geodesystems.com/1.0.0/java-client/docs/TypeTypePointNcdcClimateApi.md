...
<a id="searchTypePointNcdcClimate"></a>
# **searchTypePointNcdcClimate**
> searchTypePointNcdcClimate(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTypePointNcdcClimateApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTypePointNcdcClimateApi apiInstance = new TypeTypePointNcdcClimateApi(defaultClient);
    ...
    try {
      apiInstance.searchTypePointNcdcClimate(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTypePointNcdcClimateApi#searchTypePointNcdcClimate");
