...
<a id="searchBlogentry"></a>
# **searchBlogentry**
> searchBlogentry(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBlogentryBlogtext)
...
import org.openapitools.client.api.TypeBlogentryApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBlogentryApi apiInstance = new TypeBlogentryApi(defaultClient);
    ...
    String searchBlogentryBlogtext = "searchBlogentryBlogtext_example"; // String | Extra Text
    try {
      apiInstance.searchBlogentry(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBlogentryBlogtext);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBlogentryApi#searchBlogentry");
