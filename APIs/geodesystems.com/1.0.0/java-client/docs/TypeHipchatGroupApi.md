...
|------------- | ------------- | -------------|
| [**searchHipchatGroup**](TypeHipchatGroupApi.md#searchHipchatGroup) | **GET** /repository/search/type/hipchat_group | Search API for &#39;HipChat Group&#39; entry type |


<a id="searchHipchatGroup"></a>
# **searchHipchatGroup**
> searchHipchatGroup(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeHipchatGroupApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeHipchatGroupApi apiInstance = new TypeHipchatGroupApi(defaultClient);
    ...
    try {
      apiInstance.searchHipchatGroup(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeHipchatGroupApi#searchHipchatGroup");
