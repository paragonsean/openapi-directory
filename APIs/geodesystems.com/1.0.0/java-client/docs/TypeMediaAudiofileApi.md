...
|------------- | ------------- | -------------|
| [**searchMediaAudiofile**](TypeMediaAudiofileApi.md#searchMediaAudiofile) | **GET** /repository/search/type/media_audiofile | Search API for &#39;Audio File&#39; entry type |


<a id="searchMediaAudiofile"></a>
# **searchMediaAudiofile**
> searchMediaAudiofile(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeMediaAudiofileApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeMediaAudiofileApi apiInstance = new TypeMediaAudiofileApi(defaultClient);
    ...
    try {
      apiInstance.searchMediaAudiofile(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeMediaAudiofileApi#searchMediaAudiofile");
