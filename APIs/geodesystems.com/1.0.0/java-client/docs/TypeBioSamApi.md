...
|------------- | ------------- | -------------|
| [**searchBioSam**](TypeBioSamApi.md#searchBioSam) | **GET** /repository/search/type/bio_sam | Search API for &#39;SAM Data&#39; entry type |


<a id="searchBioSam"></a>
# **searchBioSam**
> searchBioSam(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeBioSamApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioSamApi apiInstance = new TypeBioSamApi(defaultClient);
    ...
    try {
      apiInstance.searchBioSam(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioSamApi#searchBioSam");
