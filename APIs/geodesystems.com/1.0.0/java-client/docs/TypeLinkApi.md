...
<a id="searchLink"></a>
# **searchLink**
> searchLink(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeLinkApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeLinkApi apiInstance = new TypeLinkApi(defaultClient);
    ...
    try {
      apiInstance.searchLink(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeLinkApi#searchLink");
