...
|------------- | ------------- | -------------|
| [**searchMediaVideoChannel**](TypeMediaVideoChannelApi.md#searchMediaVideoChannel) | **GET** /repository/search/type/media_video_channel | Search API for &#39;Video Channel&#39; entry type |


<a id="searchMediaVideoChannel"></a>
# **searchMediaVideoChannel**
> searchMediaVideoChannel(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeMediaVideoChannelApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeMediaVideoChannelApi apiInstance = new TypeMediaVideoChannelApi(defaultClient);
    ...
    try {
      apiInstance.searchMediaVideoChannel(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeMediaVideoChannelApi#searchMediaVideoChannel");
