...
|------------- | ------------- | -------------|
| [**searchTripReport**](TypeTripReportApi.md#searchTripReport) | **GET** /repository/search/type/trip_report | Search API for &#39;Trip Report&#39; entry type |


<a id="searchTripReport"></a>
# **searchTripReport**
> searchTripReport(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeTripReportApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeTripReportApi apiInstance = new TypeTripReportApi(defaultClient);
    ...
    try {
      apiInstance.searchTripReport(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeTripReportApi#searchTripReport");
