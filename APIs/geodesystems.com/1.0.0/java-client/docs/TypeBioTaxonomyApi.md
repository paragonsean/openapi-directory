...
<a id="searchBioTaxonomy"></a>
# **searchBioTaxonomy**
> searchBioTaxonomy(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioTaxonomyRank, searchBioTaxonomyEmblCode, searchBioTaxonomyDivision, searchBioTaxonomyInheritedDiv, searchBioTaxonomyAliases)
...
import org.openapitools.client.api.TypeBioTaxonomyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeBioTaxonomyApi apiInstance = new TypeBioTaxonomyApi(defaultClient);
    ...
    String searchBioTaxonomyRank = "searchBioTaxonomyRank_example"; // String | Rank
    String searchBioTaxonomyEmblCode = "searchBioTaxonomyEmblCode_example"; // String | EMBL Code
    String searchBioTaxonomyDivision = "searchBioTaxonomyDivision_example"; // String | Divison
    Boolean searchBioTaxonomyInheritedDiv = true; // Boolean | Inheritied division
    String searchBioTaxonomyAliases = "searchBioTaxonomyAliases_example"; // String | Also known
    try {
      apiInstance.searchBioTaxonomy(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchBioTaxonomyRank, searchBioTaxonomyEmblCode, searchBioTaxonomyDivision, searchBioTaxonomyInheritedDiv, searchBioTaxonomyAliases);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeBioTaxonomyApi#searchBioTaxonomy");
