...
<a id="searchProjectCasestudy"></a>
# **searchProjectCasestudy**
> searchProjectCasestudy(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectCasestudyIntendedUse, searchProjectCasestudyLocation)
...
import org.openapitools.client.api.TypeProjectCasestudyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeProjectCasestudyApi apiInstance = new TypeProjectCasestudyApi(defaultClient);
    ...
    String searchProjectCasestudyIntendedUse = "searchProjectCasestudyIntendedUse_example"; // String | Intended Use
    String searchProjectCasestudyLocation = "searchProjectCasestudyLocation_example"; // String | Where
    try {
      apiInstance.searchProjectCasestudy(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip, searchProjectCasestudyIntendedUse, searchProjectCasestudyLocation);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeProjectCasestudyApi#searchProjectCasestudy");
