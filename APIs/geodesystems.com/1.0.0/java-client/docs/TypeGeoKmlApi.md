...
<a id="searchGeoKml"></a>
# **searchGeoKml**
> searchGeoKml(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip)
...
import org.openapitools.client.api.TypeGeoKmlApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TypeGeoKmlApi apiInstance = new TypeGeoKmlApi(defaultClient);
    ...
    try {
      apiInstance.searchGeoKml(text, name, description, fromdate, todate, createdateFrom, createdateTo, changedateFrom, changedateTo, group, filesuffix, maxlatitude, minlongitude, minlatitude, maxlongitude, max, skip);
    } catch (ApiException e) {
      System.err.println("Exception when calling TypeGeoKmlApi#searchGeoKml");
