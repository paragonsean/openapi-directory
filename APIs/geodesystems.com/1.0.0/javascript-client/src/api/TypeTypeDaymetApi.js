...
/**
* TypeTypeDaymet service.
* @module api/TypeTypeDaymetApi
* @version 1.0.0
*/
export default class TypeTypeDaymetApi {

    /**
    * Constructs a new TypeTypeDaymetApi. 
    * @alias module:api/TypeTypeDaymetApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchTypeDaymet operation.
     * @callback module:api/TypeTypeDaymetApi~searchTypeDaymetCallback
     ...
     * @param {module:api/TypeTypeDaymetApi~searchTypeDaymetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchTypeDaymet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/type_daymet', 'GET',
