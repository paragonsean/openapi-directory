...
/**
* TypeTypeTmy service.
* @module api/TypeTypeTmyApi
* @version 1.0.0
*/
export default class TypeTypeTmyApi {

    /**
    * Constructs a new TypeTypeTmyApi. 
    * @alias module:api/TypeTypeTmyApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchTypeTmy operation.
     * @callback module:api/TypeTypeTmyApi~searchTypeTmyCallback
     ...
     * @param {module:api/TypeTypeTmyApi~searchTypeTmyCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchTypeTmy(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/type_tmy', 'GET',
