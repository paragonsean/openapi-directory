...
/**
* TypeFaq service.
* @module api/TypeFaqApi
* @version 1.0.0
*/
export default class TypeFaqApi {

    /**
    * Constructs a new TypeFaqApi. 
    * @alias module:api/TypeFaqApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchFaq operation.
     * @callback module:api/TypeFaqApi~searchFaqCallback
     ...
     * @param {module:api/TypeFaqApi~searchFaqCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchFaq(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/faq', 'GET',
