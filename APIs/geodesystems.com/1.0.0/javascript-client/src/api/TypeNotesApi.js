...
/**
* TypeNotes service.
* @module api/TypeNotesApi
* @version 1.0.0
*/
export default class TypeNotesApi {

    /**
    * Constructs a new TypeNotesApi. 
    * @alias module:api/TypeNotesApi
    * @class
    ...
    */
     ...
     * @callback module:api/TypeNotesApi~searchNotesCallback
     ...
     * @param {String} [searchDbNotesNote] Note
     * @param {module:api/TypeNotesApi~searchNotesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchNotes(opts, callback) {
      ...
      let queryParams = {
        ...
        'max': opts['max'],
        'skip': opts['skip'],
        'search.db_notes.note': opts['searchDbNotesNote']
      };
      let headerParams = {
      };
      let formParams = {
      ...
      return this.apiClient.callApi(
        '/repository/search/type/notes', 'GET',
