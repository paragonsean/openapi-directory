...
/**
* TypeGlossary service.
* @module api/TypeGlossaryApi
* @version 1.0.0
*/
export default class TypeGlossaryApi {

    /**
    * Constructs a new TypeGlossaryApi. 
    * @alias module:api/TypeGlossaryApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchGlossary operation.
     * @callback module:api/TypeGlossaryApi~searchGlossaryCallback
     ...
     * @param {module:api/TypeGlossaryApi~searchGlossaryCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchGlossary(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/glossary', 'GET',
