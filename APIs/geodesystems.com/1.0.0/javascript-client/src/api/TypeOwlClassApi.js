...
/**
* TypeOwlClass service.
* @module api/TypeOwlClassApi
* @version 1.0.0
*/
export default class TypeOwlClassApi {

    /**
    * Constructs a new TypeOwlClassApi. 
    * @alias module:api/TypeOwlClassApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchOwlClass operation.
     * @callback module:api/TypeOwlClassApi~searchOwlClassCallback
     ...
     * @param {module:api/TypeOwlClassApi~searchOwlClassCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchOwlClass(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/owl.class', 'GET',
