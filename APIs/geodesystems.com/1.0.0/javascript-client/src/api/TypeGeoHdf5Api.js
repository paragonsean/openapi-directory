...
/**
* TypeGeoHdf5 service.
* @module api/TypeGeoHdf5Api
* @version 1.0.0
*/
export default class TypeGeoHdf5Api {

    /**
    * Constructs a new TypeGeoHdf5Api. 
    * @alias module:api/TypeGeoHdf5Api
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchGeoHdf5 operation.
     * @callback module:api/TypeGeoHdf5Api~searchGeoHdf5Callback
     ...
     * @param {module:api/TypeGeoHdf5Api~searchGeoHdf5Callback} callback The callback function, accepting three arguments: error, data, response
     */
    searchGeoHdf5(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/geo_hdf5', 'GET',
