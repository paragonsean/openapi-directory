...
/**
* TypePointText service.
* @module api/TypePointTextApi
* @version 1.0.0
*/
export default class TypePointTextApi {

    /**
    * Constructs a new TypePointTextApi. 
    * @alias module:api/TypePointTextApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchPointText operation.
     * @callback module:api/TypePointTextApi~searchPointTextCallback
     ...
     * @param {module:api/TypePointTextApi~searchPointTextCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchPointText(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/point_text', 'GET',
