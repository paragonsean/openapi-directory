...
/**
* TypeFtp service.
* @module api/TypeFtpApi
* @version 1.0.0
*/
export default class TypeFtpApi {

    /**
    * Constructs a new TypeFtpApi. 
    * @alias module:api/TypeFtpApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchFtp operation.
     * @callback module:api/TypeFtpApi~searchFtpCallback
     ...
     * @param {module:api/TypeFtpApi~searchFtpCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchFtp(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/ftp', 'GET',
