...
/**
* TypeTypeMb service.
* @module api/TypeTypeMbApi
* @version 1.0.0
*/
export default class TypeTypeMbApi {

    /**
    * Constructs a new TypeTypeMbApi. 
    * @alias module:api/TypeTypeMbApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchTypeMb operation.
     * @callback module:api/TypeTypeMbApi~searchTypeMbCallback
     ...
     * @param {module:api/TypeTypeMbApi~searchTypeMbCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchTypeMb(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/type_mb', 'GET',
