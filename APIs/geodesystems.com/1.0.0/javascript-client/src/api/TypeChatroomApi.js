...
/**
* TypeChatroom service.
* @module api/TypeChatroomApi
* @version 1.0.0
*/
export default class TypeChatroomApi {

    /**
    * Constructs a new TypeChatroomApi. 
    * @alias module:api/TypeChatroomApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchChatroom operation.
     * @callback module:api/TypeChatroomApi~searchChatroomCallback
     ...
     * @param {module:api/TypeChatroomApi~searchChatroomCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchChatroom(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/chatroom', 'GET',
