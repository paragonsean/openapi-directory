...
/**
* TypeBioSam service.
* @module api/TypeBioSamApi
* @version 1.0.0
*/
export default class TypeBioSamApi {

    /**
    * Constructs a new TypeBioSamApi. 
    * @alias module:api/TypeBioSamApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchBioSam operation.
     * @callback module:api/TypeBioSamApi~searchBioSamCallback
     ...
     * @param {module:api/TypeBioSamApi~searchBioSamCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchBioSam(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/bio_sam', 'GET',
