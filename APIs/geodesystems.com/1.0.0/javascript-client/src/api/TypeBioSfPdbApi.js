...
/**
* TypeBioSfPdb service.
* @module api/TypeBioSfPdbApi
* @version 1.0.0
*/
export default class TypeBioSfPdbApi {

    /**
    * Constructs a new TypeBioSfPdbApi. 
    * @alias module:api/TypeBioSfPdbApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchBioSfPdb operation.
     * @callback module:api/TypeBioSfPdbApi~searchBioSfPdbCallback
     ...
     * @param {module:api/TypeBioSfPdbApi~searchBioSfPdbCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchBioSfPdb(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/bio_sf_pdb', 'GET',
