...
/**
* TypeBioDicom service.
* @module api/TypeBioDicomApi
* @version 1.0.0
*/
export default class TypeBioDicomApi {

    /**
    * Constructs a new TypeBioDicomApi. 
    * @alias module:api/TypeBioDicomApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchBioDicom operation.
     * @callback module:api/TypeBioDicomApi~searchBioDicomCallback
     ...
     * @param {module:api/TypeBioDicomApi~searchBioDicomCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchBioDicom(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/bio_dicom', 'GET',
