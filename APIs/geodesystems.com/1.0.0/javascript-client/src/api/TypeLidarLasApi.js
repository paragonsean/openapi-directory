...
/**
* TypeLidarLas service.
* @module api/TypeLidarLasApi
* @version 1.0.0
*/
export default class TypeLidarLasApi {

    /**
    * Constructs a new TypeLidarLasApi. 
    * @alias module:api/TypeLidarLasApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchLidarLas operation.
     * @callback module:api/TypeLidarLasApi~searchLidarLasCallback
     ...
     * @param {module:api/TypeLidarLasApi~searchLidarLasCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchLidarLas(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/lidar_las', 'GET',
