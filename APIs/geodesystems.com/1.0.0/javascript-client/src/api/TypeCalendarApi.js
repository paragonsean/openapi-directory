...
/**
* TypeCalendar service.
* @module api/TypeCalendarApi
* @version 1.0.0
*/
export default class TypeCalendarApi {

    /**
    * Constructs a new TypeCalendarApi. 
    * @alias module:api/TypeCalendarApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchCalendar operation.
     * @callback module:api/TypeCalendarApi~searchCalendarCallback
     ...
     * @param {module:api/TypeCalendarApi~searchCalendarCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchCalendar(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/calendar', 'GET',
