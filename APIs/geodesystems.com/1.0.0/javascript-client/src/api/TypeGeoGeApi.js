...
/**
* TypeGeoGe service.
* @module api/TypeGeoGeApi
* @version 1.0.0
*/
export default class TypeGeoGeApi {

    /**
    * Constructs a new TypeGeoGeApi. 
    * @alias module:api/TypeGeoGeApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchGeoGeojson operation.
     * @callback module:api/TypeGeoGeApi~searchGeoGeojsonCallback
     ...
     * @param {module:api/TypeGeoGeApi~searchGeoGeojsonCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchGeoGeojson(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/geo_geojson', 'GET',
