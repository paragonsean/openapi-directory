...
/**
* TypePoll service.
* @module api/TypePollApi
* @version 1.0.0
*/
export default class TypePollApi {

    /**
    * Constructs a new TypePollApi. 
    * @alias module:api/TypePollApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchPoll operation.
     * @callback module:api/TypePollApi~searchPollCallback
     ...
     * @param {module:api/TypePollApi~searchPollCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchPoll(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/poll', 'GET',
