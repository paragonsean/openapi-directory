...
/**
* TypeBioSra service.
* @module api/TypeBioSraApi
* @version 1.0.0
*/
export default class TypeBioSraApi {

    /**
    * Constructs a new TypeBioSraApi. 
    * @alias module:api/TypeBioSraApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchBioSra operation.
     * @callback module:api/TypeBioSraApi~searchBioSraCallback
     ...
     * @param {module:api/TypeBioSraApi~searchBioSraCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchBioSra(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/bio_sra', 'GET',
