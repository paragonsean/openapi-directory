...
/**
* TypeTypeNitf service.
* @module api/TypeTypeNitfApi
* @version 1.0.0
*/
export default class TypeTypeNitfApi {

    /**
    * Constructs a new TypeTypeNitfApi. 
    * @alias module:api/TypeTypeNitfApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchTypeNitf operation.
     * @callback module:api/TypeTypeNitfApi~searchTypeNitfCallback
     ...
     * @param {module:api/TypeTypeNitfApi~searchTypeNitfCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchTypeNitf(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/type_nitf', 'GET',
