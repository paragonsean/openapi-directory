...
/**
* TypeHomepage service.
* @module api/TypeHomepageApi
* @version 1.0.0
*/
export default class TypeHomepageApi {

    /**
    * Constructs a new TypeHomepageApi. 
    * @alias module:api/TypeHomepageApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchHomepage operation.
     * @callback module:api/TypeHomepageApi~searchHomepageCallback
     ...
     * @param {module:api/TypeHomepageApi~searchHomepageCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchHomepage(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/homepage', 'GET',
