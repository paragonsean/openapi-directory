...
/**
* TypeNwsfeed service.
* @module api/TypeNwsfeedApi
* @version 1.0.0
*/
export default class TypeNwsfeedApi {

    /**
    * Constructs a new TypeNwsfeedApi. 
    * @alias module:api/TypeNwsfeedApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchNwsfeed operation.
     * @callback module:api/TypeNwsfeedApi~searchNwsfeedCallback
     ...
     * @param {module:api/TypeNwsfeedApi~searchNwsfeedCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchNwsfeed(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/nwsfeed', 'GET',
