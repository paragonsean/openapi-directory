...
/**
* TypeFile service.
* @module api/TypeFileApi
* @version 1.0.0
*/
export default class TypeFileApi {

    /**
    * Constructs a new TypeFileApi. 
    * @alias module:api/TypeFileApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchFile operation.
     * @callback module:api/TypeFileApi~searchFileCallback
     ...
     * @param {module:api/TypeFileApi~searchFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchFile(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/file', 'GET',
