...
/**
* TypeCdmGrid service.
* @module api/TypeCdmGridApi
* @version 1.0.0
*/
export default class TypeCdmGridApi {

    /**
    * Constructs a new TypeCdmGridApi. 
    * @alias module:api/TypeCdmGridApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchCdmGrid operation.
     * @callback module:api/TypeCdmGridApi~searchCdmGridCallback
     ...
     * @param {module:api/TypeCdmGridApi~searchCdmGridCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchCdmGrid(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/cdm_grid', 'GET',
