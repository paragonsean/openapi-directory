...
/**
* TypeBioFasta service.
* @module api/TypeBioFastaApi
* @version 1.0.0
*/
export default class TypeBioFastaApi {

    /**
    * Constructs a new TypeBioFastaApi. 
    * @alias module:api/TypeBioFastaApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchBioFasta operation.
     * @callback module:api/TypeBioFastaApi~searchBioFastaCallback
     ...
     * @param {module:api/TypeBioFastaApi~searchBioFastaCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchBioFasta(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/bio_fasta', 'GET',
