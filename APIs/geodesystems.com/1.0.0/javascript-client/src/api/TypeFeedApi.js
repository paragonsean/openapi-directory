...
/**
* TypeFeed service.
* @module api/TypeFeedApi
* @version 1.0.0
*/
export default class TypeFeedApi {

    /**
    * Constructs a new TypeFeedApi. 
    * @alias module:api/TypeFeedApi
    * @class
    ...
    */
     ...
     * @callback module:api/TypeFeedApi~searchFeedCallback
     ...
     * @param {module:api/TypeFeedApi~searchFeedCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchFeed(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/feed', 'GET',
