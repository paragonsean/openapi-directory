...
/**
* TypeWeblog service.
* @module api/TypeWeblogApi
* @version 1.0.0
*/
export default class TypeWeblogApi {

    /**
    * Constructs a new TypeWeblogApi. 
    * @alias module:api/TypeWeblogApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchWeblog operation.
     * @callback module:api/TypeWeblogApi~searchWeblogCallback
     ...
     * @param {module:api/TypeWeblogApi~searchWeblogCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchWeblog(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/weblog', 'GET',
