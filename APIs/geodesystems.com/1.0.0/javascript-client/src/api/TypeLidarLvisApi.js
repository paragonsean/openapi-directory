...
/**
* TypeLidarLvis service.
* @module api/TypeLidarLvisApi
* @version 1.0.0
*/
export default class TypeLidarLvisApi {

    /**
    * Constructs a new TypeLidarLvisApi. 
    * @alias module:api/TypeLidarLvisApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchLidarLvis operation.
     * @callback module:api/TypeLidarLvisApi~searchLidarLvisCallback
     ...
     * @param {module:api/TypeLidarLvisApi~searchLidarLvisCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchLidarLvis(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/lidar_lvis', 'GET',
