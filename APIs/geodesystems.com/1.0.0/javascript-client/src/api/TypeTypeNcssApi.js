...
/**
* TypeTypeNcss service.
* @module api/TypeTypeNcssApi
* @version 1.0.0
*/
export default class TypeTypeNcssApi {

    /**
    * Constructs a new TypeTypeNcssApi. 
    * @alias module:api/TypeTypeNcssApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchTypeNcss operation.
     * @callback module:api/TypeTypeNcssApi~searchTypeNcssCallback
     ...
     * @param {module:api/TypeTypeNcssApi~searchTypeNcssCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchTypeNcss(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/type_ncss', 'GET',
