...
/**
* TypeGroup service.
* @module api/TypeGroupApi
* @version 1.0.0
*/
export default class TypeGroupApi {

    /**
    * Constructs a new TypeGroupApi. 
    * @alias module:api/TypeGroupApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchGroup operation.
     * @callback module:api/TypeGroupApi~searchGroupCallback
     ...
     * @param {module:api/TypeGroupApi~searchGroupCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchGroup(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/group', 'GET',
