...
/**
* TypeLink service.
* @module api/TypeLinkApi
* @version 1.0.0
*/
export default class TypeLinkApi {

    /**
    * Constructs a new TypeLinkApi. 
    * @alias module:api/TypeLinkApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchLink operation.
     * @callback module:api/TypeLinkApi~searchLinkCallback
     ...
     * @param {module:api/TypeLinkApi~searchLinkCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchLink(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/link', 'GET',
