...
/**
* TypeAny service.
* @module api/TypeAnyApi
* @version 1.0.0
*/
export default class TypeAnyApi {

    /**
    * Constructs a new TypeAnyApi. 
    * @alias module:api/TypeAnyApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchAny operation.
     * @callback module:api/TypeAnyApi~searchAnyCallback
     ...
     * @param {module:api/TypeAnyApi~searchAnyCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchAny(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/any', 'GET',
