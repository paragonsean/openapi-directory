...
/**
* TypeGeoKml service.
* @module api/TypeGeoKmlApi
* @version 1.0.0
*/
export default class TypeGeoKmlApi {

    /**
    * Constructs a new TypeGeoKmlApi. 
    * @alias module:api/TypeGeoKmlApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchGeoKml operation.
     * @callback module:api/TypeGeoKmlApi~searchGeoKmlCallback
     ...
     * @param {module:api/TypeGeoKmlApi~searchGeoKmlCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchGeoKml(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/geo_kml', 'GET',
