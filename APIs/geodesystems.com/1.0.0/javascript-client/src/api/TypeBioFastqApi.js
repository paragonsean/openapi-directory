...
/**
* TypeBioFastq service.
* @module api/TypeBioFastqApi
* @version 1.0.0
*/
export default class TypeBioFastqApi {

    /**
    * Constructs a new TypeBioFastqApi. 
    * @alias module:api/TypeBioFastqApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchBioFastq operation.
     * @callback module:api/TypeBioFastqApi~searchBioFastqCallback
     ...
     * @param {module:api/TypeBioFastqApi~searchBioFastqCallback} callback The callback function, accepting three arguments: error, data, response
     */
    searchBioFastq(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/repository/search/type/bio_fastq', 'GET',
