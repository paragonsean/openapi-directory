# GeodesystemsCom443.TypeStatusboardApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchStatusboard**](TypeStatusboardApi.md#searchStatusboard) | **GET** /repository/search/type/statusboard | Search API for &#39;Status Board&#39; entry type



## searchStatusboard

> searchStatusboard(opts)
...
let apiInstance = new GeodesystemsCom443.TypeStatusboardApi();
let opts = {
  ...
  'searchDbStatusboardWhat': "searchDbStatusboardWhat_example", // String | What
  'searchDbStatusboardStatus': "searchDbStatusboardStatus_example" // String | Status
};
apiInstance.searchStatusboard(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchDbStatusboardWhat** | **String**| What | [optional] 
 **searchDbStatusboardStatus** | **String**| Status | [optional] 
