# GeodesystemsCom443.TypeProjectDatasetApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchProjectDataset**](TypeProjectDatasetApi.md#searchProjectDataset) | **GET** /repository/search/type/project_dataset | Search API for &#39;Dataset&#39; entry type



## searchProjectDataset

> searchProjectDataset(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectDatasetApi();
let opts = {
  ...
  'searchProjectDatasetDatasetId': "searchProjectDatasetDatasetId_example", // String | Dataset ID
  'searchProjectDatasetDataType': "searchProjectDatasetDataType_example", // String | Data Type
  'searchProjectDatasetDataLevel': "searchProjectDatasetDataLevel_example" // String | Data Level
};
apiInstance.searchProjectDataset(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchProjectDatasetDatasetId** | **String**| Dataset ID | [optional] 
 **searchProjectDatasetDataType** | **String**| Data Type | [optional] 
 **searchProjectDatasetDataLevel** | **String**| Data Level | [optional] 
