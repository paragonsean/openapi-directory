# GeodesystemsCom443.TypeProjectStandardNameApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchProjectStandardName**](TypeProjectStandardNameApi.md#searchProjectStandardName) | **GET** /repository/search/type/project_standard_name | Search API for &#39;Standard Parameter Name&#39; entry type



## searchProjectStandardName

> searchProjectStandardName(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectStandardNameApi();
let opts = {
  ...
  'searchProjectStandardNameUnit': "searchProjectStandardNameUnit_example", // String | Canonical Unit
  'searchProjectStandardNameAliases': "searchProjectStandardNameAliases_example" // String | Aliases
};
apiInstance.searchProjectStandardName(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchProjectStandardNameUnit** | **String**| Canonical Unit | [optional] 
 **searchProjectStandardNameAliases** | **String**| Aliases | [optional] 
