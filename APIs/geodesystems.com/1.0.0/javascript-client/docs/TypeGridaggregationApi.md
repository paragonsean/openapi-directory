# GeodesystemsCom443.TypeGridaggregationApi
...
let apiInstance = new GeodesystemsCom443.TypeGridaggregationApi();
let opts = {
...
apiInstance.searchGridaggregation(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
