# GeodesystemsCom443.TypeTypeCensusAcsApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeCensusAcsApi();
let opts = {
  ...
  'searchTypeCensusAcsFields': "searchTypeCensusAcsFields_example", // String | Indicators
  'searchTypeCensusAcsForType': "searchTypeCensusAcsForType_example", // String | For
  'searchTypeCensusAcsInType1': "searchTypeCensusAcsInType1_example", // String | In
  'searchTypeCensusAcsInType2': "searchTypeCensusAcsInType2_example" // String | In #2
};
apiInstance.searchTypeCensusAcs(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
