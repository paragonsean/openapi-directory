# GeodesystemsCom443.TypeCataloglinkApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchCataloglink**](TypeCataloglinkApi.md#searchCataloglink) | **GET** /repository/search/type/cataloglink | Search API for &#39;Catalog Link&#39; entry type



## searchCataloglink

> searchCataloglink(opts)
...
let apiInstance = new GeodesystemsCom443.TypeCataloglinkApi();
let opts = {
...
apiInstance.searchCataloglink(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
