# GeodesystemsCom443.TypeTypeTmyApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeTmy**](TypeTypeTmyApi.md#searchTypeTmy) | **GET** /repository/search/type/type_tmy | Search API for &#39;NREL TMY Data&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeTypeTmyApi();
let opts = {
...
apiInstance.searchTypeTmy(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
