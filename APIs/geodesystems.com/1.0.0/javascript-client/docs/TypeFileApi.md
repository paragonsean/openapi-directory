# GeodesystemsCom443.TypeFileApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchFile**](TypeFileApi.md#searchFile) | **GET** /repository/search/type/file | Search API for &#39;File&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeFileApi();
let opts = {
...
apiInstance.searchFile(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
