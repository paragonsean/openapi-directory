# GeodesystemsCom443.TypeTypePointNetcdfApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypePointNetcdf**](TypeTypePointNetcdfApi.md#searchTypePointNetcdf) | **GET** /repository/search/type/type_point_netcdf | Search API for &#39;NetCDF Point File&#39; entry type



## searchTypePointNetcdf

> searchTypePointNetcdf(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointNetcdfApi();
let opts = {
...
apiInstance.searchTypePointNetcdf(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
