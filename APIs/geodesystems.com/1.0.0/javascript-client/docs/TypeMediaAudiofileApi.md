# GeodesystemsCom443.TypeMediaAudiofileApi
...
let apiInstance = new GeodesystemsCom443.TypeMediaAudiofileApi();
let opts = {
...
apiInstance.searchMediaAudiofile(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
