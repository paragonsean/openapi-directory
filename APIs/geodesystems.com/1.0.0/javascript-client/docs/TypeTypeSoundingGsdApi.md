# GeodesystemsCom443.TypeTypeSoundingGsdApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeSoundingGsdApi();
let opts = {
...
apiInstance.searchTypeSoundingGsd(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
