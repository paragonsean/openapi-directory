# GeodesystemsCom443.TypeTypeDocumentHtmlApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeDocumentHtml**](TypeTypeDocumentHtmlApi.md#searchTypeDocumentHtml) | **GET** /repository/search/type/type_document_html | Search API for &#39;HTML File&#39; entry type



## searchTypeDocumentHtml

> searchTypeDocumentHtml(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeDocumentHtmlApi();
let opts = {
...
apiInstance.searchTypeDocumentHtml(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
