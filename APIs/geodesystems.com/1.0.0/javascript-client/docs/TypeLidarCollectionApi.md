# GeodesystemsCom443.TypeLidarCollectionApi
...
let apiInstance = new GeodesystemsCom443.TypeLidarCollectionApi();
let opts = {
...
apiInstance.searchLidarCollection(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
