# GeodesystemsCom443.TypeTypePointOceanCsvSadoMeteoApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypePointOceanCsvSadoMeteo**](TypeTypePointOceanCsvSadoMeteoApi.md#searchTypePointOceanCsvSadoMeteo) | **GET** /repository/search/type/type_point_ocean_csv_sado_meteo | Search API for &#39;SADO Meteo Data&#39; entry type



## searchTypePointOceanCsvSadoMeteo

> searchTypePointOceanCsvSadoMeteo(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointOceanCsvSadoMeteoApi();
let opts = {
...
apiInstance.searchTypePointOceanCsvSadoMeteo(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
