# GeodesystemsCom443.TypeBioTaxonomyApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchBioTaxonomy**](TypeBioTaxonomyApi.md#searchBioTaxonomy) | **GET** /repository/search/type/bio_taxonomy | Search API for &#39;Taxonomic Entry&#39; entry type



## searchBioTaxonomy

> searchBioTaxonomy(opts)
...
let apiInstance = new GeodesystemsCom443.TypeBioTaxonomyApi();
let opts = {
  ...
  'searchBioTaxonomyRank': "searchBioTaxonomyRank_example", // String | Rank
  'searchBioTaxonomyEmblCode': "searchBioTaxonomyEmblCode_example", // String | EMBL Code
  'searchBioTaxonomyDivision': "searchBioTaxonomyDivision_example", // String | Divison
  'searchBioTaxonomyInheritedDiv': true, // Boolean | Inheritied division
  'searchBioTaxonomyAliases': "searchBioTaxonomyAliases_example" // String | Also known
};
apiInstance.searchBioTaxonomy(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchBioTaxonomyRank** | **String**| Rank | [optional] 
 **searchBioTaxonomyEmblCode** | **String**| EMBL Code | [optional] 
 **searchBioTaxonomyDivision** | **String**| Divison | [optional] 
 **searchBioTaxonomyInheritedDiv** | **Boolean**| Inheritied division | [optional] 
 **searchBioTaxonomyAliases** | **String**| Also known | [optional] 
