# GeodesystemsCom443.TypeTypeNasaamesApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeNasaamesApi();
let opts = {
...
apiInstance.searchTypeNasaames(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
