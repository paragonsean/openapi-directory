# GeodesystemsCom443.TypeTypeGtfsTripApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeGtfsTripApi();
let opts = {
  ...
  'searchTypeGtfsTripTripId': "searchTypeGtfsTripTripId_example", // String | Trip ID
  'searchTypeGtfsTripStopIds': "searchTypeGtfsTripStopIds_example", // String | Stop IDS
  'searchTypeGtfsTripWheelchairAccessible': "searchTypeGtfsTripWheelchairAccessible_example", // String | Wheelchair Accessible
  'searchTypeGtfsTripBikesAllowed': "searchTypeGtfsTripBikesAllowed_example" // String | Bikes Allowed
};
apiInstance.searchTypeGtfsTrip(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
