# GeodesystemsCom443.TypeUsPlacesApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchUsPlaces**](TypeUsPlacesApi.md#searchUsPlaces) | **GET** /repository/search/type/us_places | Search API for &#39;US Places&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeUsPlacesApi();
let opts = {
  ...
  'searchDbUsPlacesFeatureName': "searchDbUsPlacesFeatureName_example", // String | Place Name
  'searchDbUsPlacesFeatureClass': "searchDbUsPlacesFeatureClass_example", // String | Place Type
  'searchDbUsPlacesStateAlpha': "searchDbUsPlacesStateAlpha_example", // String | State
  'searchDbUsPlacesCountyName': "searchDbUsPlacesCountyName_example", // String | County Name
  'searchDbUsPlacesLocation': "searchDbUsPlacesLocation_example", // String | Location
  'searchDbUsPlacesElevInFt': 3.4 // Number | Elev In Ft
};
apiInstance.searchUsPlaces(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchDbUsPlacesFeatureName** | **String**| Place Name | [optional] 
 **searchDbUsPlacesFeatureClass** | **String**| Place Type | [optional] 
 **searchDbUsPlacesStateAlpha** | **String**| State | [optional] 
 **searchDbUsPlacesCountyName** | **String**| County Name | [optional] 
 **searchDbUsPlacesLocation** | **String**| Location | [optional] 
 **searchDbUsPlacesElevInFt** | **Number**| Elev In Ft | [optional] 
