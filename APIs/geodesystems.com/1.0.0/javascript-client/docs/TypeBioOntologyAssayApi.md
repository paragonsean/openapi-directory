# GeodesystemsCom443.TypeBioOntologyAssayApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchBioOntologyAssay**](TypeBioOntologyAssayApi.md#searchBioOntologyAssay) | **GET** /repository/search/type/bio_ontology_assay | Search API for &#39;Assay&#39; entry type



## searchBioOntologyAssay

> searchBioOntologyAssay(opts)
...
let apiInstance = new GeodesystemsCom443.TypeBioOntologyAssayApi();
let opts = {
...
apiInstance.searchBioOntologyAssay(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
