# GeodesystemsCom443.TypeProjectGpsRawApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchProjectGpsRaw**](TypeProjectGpsRawApi.md#searchProjectGpsRaw) | **GET** /repository/search/type/project_gps_raw | Search API for &#39;Raw GPS File&#39; entry type



## searchProjectGpsRaw

> searchProjectGpsRaw(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectGpsRawApi();
let opts = {
...
apiInstance.searchProjectGpsRaw(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
