# GeodesystemsCom443.TypeGeoGeotiffApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchGeoGeotiff**](TypeGeoGeotiffApi.md#searchGeoGeotiff) | **GET** /repository/search/type/geo_geotiff | Search API for &#39;GeoTIFF&#39; entry type



## searchGeoGeotiff

> searchGeoGeotiff(opts)
...
let apiInstance = new GeodesystemsCom443.TypeGeoGeotiffApi();
let opts = {
...
apiInstance.searchGeoGeotiff(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
