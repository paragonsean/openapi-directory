# GeodesystemsCom443.TypeTypeEdgarFilingApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeEdgarFilingApi();
let opts = {
  ...
  'searchTypeEdgarFilingFormType': "searchTypeEdgarFilingFormType_example", // String | Form Type
  'searchTypeEdgarFilingCompanyName': "searchTypeEdgarFilingCompanyName_example", // String | Company Name
  'searchTypeEdgarFilingCikNumber': "searchTypeEdgarFilingCikNumber_example", // String | CIK Number
  'searchTypeEdgarFilingStandardIndustrialClassification': "searchTypeEdgarFilingStandardIndustrialClassification_example", // String | Standard Industrial Classification
  'searchTypeEdgarFilingIrsNumber': "searchTypeEdgarFilingIrsNumber_example", // String | IRS Number
  'searchTypeEdgarFilingState': "searchTypeEdgarFilingState_example" // String | State of Incorporation
};
apiInstance.searchTypeEdgarFiling(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
