# GeodesystemsCom443.TypeTypeServiceGroupApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeServiceGroup**](TypeTypeServiceGroupApi.md#searchTypeServiceGroup) | **GET** /repository/search/type/type_service_group | Search API for &#39;Service Group&#39; entry type



## searchTypeServiceGroup

> searchTypeServiceGroup(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeServiceGroupApi();
let opts = {
...
apiInstance.searchTypeServiceGroup(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
