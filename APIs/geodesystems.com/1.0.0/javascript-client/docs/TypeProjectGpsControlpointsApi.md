# GeodesystemsCom443.TypeProjectGpsControlpointsApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchProjectGpsControlpoints**](TypeProjectGpsControlpointsApi.md#searchProjectGpsControlpoints) | **GET** /repository/search/type/project_gps_controlpoints | Search API for &#39;Control Points File&#39; entry type



## searchProjectGpsControlpoints

> searchProjectGpsControlpoints(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectGpsControlpointsApi();
let opts = {
...
apiInstance.searchProjectGpsControlpoints(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
