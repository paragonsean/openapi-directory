# GeodesystemsCom443.TypeBioSraApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchBioSra**](TypeBioSraApi.md#searchBioSra) | **GET** /repository/search/type/bio_sra | Search API for &#39;Sequence Read Archive&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeBioSraApi();
let opts = {
...
apiInstance.searchBioSra(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
