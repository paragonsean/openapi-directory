# GeodesystemsCom443.TypeBioStockholmApi
...
let apiInstance = new GeodesystemsCom443.TypeBioStockholmApi();
let opts = {
...
apiInstance.searchBioStockholm(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
