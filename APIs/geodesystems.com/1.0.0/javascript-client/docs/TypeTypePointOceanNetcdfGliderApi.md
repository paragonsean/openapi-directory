# GeodesystemsCom443.TypeTypePointOceanNetcdfGliderApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypePointOceanNetcdfGlider**](TypeTypePointOceanNetcdfGliderApi.md#searchTypePointOceanNetcdfGlider) | **GET** /repository/search/type/type_point_ocean_netcdf_glider | Search API for &#39;NetCDF Glider Data&#39; entry type



## searchTypePointOceanNetcdfGlider

> searchTypePointOceanNetcdfGlider(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointOceanNetcdfGliderApi();
let opts = {
  ...
  'searchTypePointOceanNetcdfTrackPlatform': "searchTypePointOceanNetcdfTrackPlatform_example" // String | Platform
};
apiInstance.searchTypePointOceanNetcdfGlider(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchTypePointOceanNetcdfTrackPlatform** | **String**| Platform | [optional] 
