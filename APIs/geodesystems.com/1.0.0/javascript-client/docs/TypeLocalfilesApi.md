# GeodesystemsCom443.TypeLocalfilesApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchLocalfiles**](TypeLocalfilesApi.md#searchLocalfiles) | **GET** /repository/search/type/localfiles | Search API for &#39;Server Side Files&#39; entry type



## searchLocalfiles

> searchLocalfiles(opts)
...
let apiInstance = new GeodesystemsCom443.TypeLocalfilesApi();
let opts = {
...
apiInstance.searchLocalfiles(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
