# GeodesystemsCom443.TypeTypeAwcMetarApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeAwcMetarApi();
let opts = {
  ...
  'searchTypeAwcMetarSiteId': "searchTypeAwcMetarSiteId_example" // String | Site ID
};
apiInstance.searchTypeAwcMetar(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
