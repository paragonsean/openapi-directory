# GeodesystemsCom443.TypeTypeExtremesApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeExtremesApi();
let opts = {
  ...
  'searchTypeExtremesRegion': "searchTypeExtremesRegion_example", // String | US Climate Region
  'searchTypeExtremesVariable': "searchTypeExtremesVariable_example" // String | Variable
};
apiInstance.searchTypeExtremes(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
