# GeodesystemsCom443.TypeTypeFredSeriesApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeFredSeries**](TypeTypeFredSeriesApi.md#searchTypeFredSeries) | **GET** /repository/search/type/type_fred_series | Search API for &#39;FRED Series&#39; entry type



## searchTypeFredSeries

> searchTypeFredSeries(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeFredSeriesApi();
let opts = {
...
apiInstance.searchTypeFredSeries(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
