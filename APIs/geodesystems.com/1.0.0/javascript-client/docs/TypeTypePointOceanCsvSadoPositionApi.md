# GeodesystemsCom443.TypeTypePointOceanCsvSadoPositionApi
...
> searchTypePointOceanCsvSadoPosition(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointOceanCsvSadoPositionApi();
let opts = {
...
apiInstance.searchTypePointOceanCsvSadoPosition(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
