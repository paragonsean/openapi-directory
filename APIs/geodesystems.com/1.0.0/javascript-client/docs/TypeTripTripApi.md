# GeodesystemsCom443.TypeTripTripApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTripTrip**](TypeTripTripApi.md#searchTripTrip) | **GET** /repository/search/type/trip_trip | Search API for &#39;Trip&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeTripTripApi();
let opts = {
...
apiInstance.searchTripTrip(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
