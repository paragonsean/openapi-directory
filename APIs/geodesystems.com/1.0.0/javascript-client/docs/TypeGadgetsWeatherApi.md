# GeodesystemsCom443.TypeGadgetsWeatherApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchGadgetsWeather**](TypeGadgetsWeatherApi.md#searchGadgetsWeather) | **GET** /repository/search/type/gadgets_weather | Search API for &#39;Weather&#39; entry type



## searchGadgetsWeather

> searchGadgetsWeather(opts)
...
let apiInstance = new GeodesystemsCom443.TypeGadgetsWeatherApi();
let opts = {
...
apiInstance.searchGadgetsWeather(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
