# GeodesystemsCom443.TypeProjectGpsRinexApi
...
let apiInstance = new GeodesystemsCom443.TypeProjectGpsRinexApi();
let opts = {
...
apiInstance.searchProjectGpsRinex(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
