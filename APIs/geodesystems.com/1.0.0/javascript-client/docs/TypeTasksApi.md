# GeodesystemsCom443.TypeTasksApi
...
let apiInstance = new GeodesystemsCom443.TypeTasksApi();
let opts = {
  ...
  'searchDbTasksTitle': "searchDbTasksTitle_example", // String | Title
  'searchDbTasksPriority': "searchDbTasksPriority_example", // String | Priority
  'searchDbTasksStatus': "searchDbTasksStatus_example", // String | Status
  'searchDbTasksComplete': 3.4, // Number | % Complete
  'searchDbTasksAssignedto': "searchDbTasksAssignedto_example", // String | Assigned To
  'searchDbTasksStartdate': "searchDbTasksStartdate_example", // String | Start Date
  'searchDbTasksEnddate': "searchDbTasksEnddate_example" // String | End Date
};
apiInstance.searchTasks(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchDbTasksComplete** | **Number**| % Complete | [optional] 
