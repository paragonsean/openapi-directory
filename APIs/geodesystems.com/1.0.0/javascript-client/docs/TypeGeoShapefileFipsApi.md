# GeodesystemsCom443.TypeGeoShapefileFipsApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchGeoShapefileFips**](TypeGeoShapefileFipsApi.md#searchGeoShapefileFips) | **GET** /repository/search/type/geo_shapefile_fips | Search API for &#39;Shapefile with FIPS Code&#39; entry type



## searchGeoShapefileFips

> searchGeoShapefileFips(opts)
...
let apiInstance = new GeodesystemsCom443.TypeGeoShapefileFipsApi();
let opts = {
...
apiInstance.searchGeoShapefileFips(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
