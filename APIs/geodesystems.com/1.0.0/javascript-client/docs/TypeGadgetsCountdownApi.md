# GeodesystemsCom443.TypeGadgetsCountdownApi
...
let apiInstance = new GeodesystemsCom443.TypeGadgetsCountdownApi();
let opts = {
...
apiInstance.searchGadgetsCountdown(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
