# GeodesystemsCom443.TypeProjectProgramApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchProjectProgram**](TypeProjectProgramApi.md#searchProjectProgram) | **GET** /repository/search/type/project_program | Search API for &#39;Program&#39; entry type



## searchProjectProgram

> searchProjectProgram(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectProgramApi();
let opts = {
...
apiInstance.searchProjectProgram(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
