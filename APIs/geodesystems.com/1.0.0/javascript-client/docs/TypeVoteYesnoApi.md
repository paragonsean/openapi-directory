# GeodesystemsCom443.TypeVoteYesnoApi
...
let apiInstance = new GeodesystemsCom443.TypeVoteYesnoApi();
let opts = {
  ...
  'searchDbVoteYesnoVote': "searchDbVoteYesnoVote_example" // String | My Vote
};
apiInstance.searchVoteYesno(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
