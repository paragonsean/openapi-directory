# GeodesystemsCom443.TypeTypePointIcebridgeAtmIcessnApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypePointIcebridgeAtmIcessn**](TypeTypePointIcebridgeAtmIcessnApi.md#searchTypePointIcebridgeAtmIcessn) | **GET** /repository/search/type/type_point_icebridge_atm_icessn | Search API for &#39;ATM Ice SSN Data&#39; entry type



## searchTypePointIcebridgeAtmIcessn

> searchTypePointIcebridgeAtmIcessn(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointIcebridgeAtmIcessnApi();
let opts = {
...
apiInstance.searchTypePointIcebridgeAtmIcessn(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
