# GeodesystemsCom443.TypeSunrisesunsetApi
...
let apiInstance = new GeodesystemsCom443.TypeSunrisesunsetApi();
let opts = {
...
apiInstance.searchSunrisesunset(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
