# GeodesystemsCom443.TypeUfoSightingsApi
...
let apiInstance = new GeodesystemsCom443.TypeUfoSightingsApi();
let opts = {
  ...
  'searchDbUfoSightingsDatetime': "searchDbUfoSightingsDatetime_example", // String | Datetime
  'searchDbUfoSightingsCity': "searchDbUfoSightingsCity_example", // String | City
  'searchDbUfoSightingsState': "searchDbUfoSightingsState_example", // String | State
  'searchDbUfoSightingsCountry': "searchDbUfoSightingsCountry_example", // String | Country
  'searchDbUfoSightingsShape': "searchDbUfoSightingsShape_example", // String | Shape
  'searchDbUfoSightingsDurationSeconds': 3.4, // Number | Duration (seconds)
  'searchDbUfoSightingsDurationHoursMin': "searchDbUfoSightingsDurationHoursMin_example", // String | Duration (hours/min)
  'searchDbUfoSightingsComments': "searchDbUfoSightingsComments_example", // String | Comments
  'searchDbUfoSightingsDatePosted': "searchDbUfoSightingsDatePosted_example", // String | Date Posted
  'searchDbUfoSightingsLatitude': 3.4, // Number | Latitude
  'searchDbUfoSightingsLongitude': 3.4 // Number | Longitude
};
apiInstance.searchUfoSightings(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchDbUfoSightingsDurationSeconds** | **Number**| Duration (seconds) | [optional] 
 ...
 **searchDbUfoSightingsLatitude** | **Number**| Latitude | [optional] 
 **searchDbUfoSightingsLongitude** | **Number**| Longitude | [optional] 
