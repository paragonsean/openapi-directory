# GeodesystemsCom443.TypeTypePointSimpleRecordsApi
...
> searchTypePointSimpleRecords(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointSimpleRecordsApi();
let opts = {
...
apiInstance.searchTypePointSimpleRecords(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
