# GeodesystemsCom443.TypeNotesApi
...
let apiInstance = new GeodesystemsCom443.TypeNotesApi();
let opts = {
  ...
  'searchDbNotesNote': "searchDbNotesNote_example" // String | Note
};
apiInstance.searchNotes(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
