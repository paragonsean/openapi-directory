# GeodesystemsCom443.TypeJeopardyApi
...
let apiInstance = new GeodesystemsCom443.TypeJeopardyApi();
let opts = {
  ...
  'searchDbJeopardyQuestion': "searchDbJeopardyQuestion_example", // String | Question
  'searchDbJeopardyAnswer': "searchDbJeopardyAnswer_example", // String | Answer
  'searchDbJeopardyRound': "searchDbJeopardyRound_example", // String | Round
  'searchDbJeopardyCategory': "searchDbJeopardyCategory_example", // String | Category
  'searchDbJeopardyAirDate': "searchDbJeopardyAirDate_example" // String | Air Date
};
apiInstance.searchJeopardy(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
