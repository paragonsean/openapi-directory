# GeodesystemsCom443.TypeBoulderCrimesApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchBoulderCrimes**](TypeBoulderCrimesApi.md#searchBoulderCrimes) | **GET** /repository/search/type/boulder_crimes | Search API for &#39;Boulder Crime Reports&#39; entry type



## searchBoulderCrimes

> searchBoulderCrimes(opts)
...
let apiInstance = new GeodesystemsCom443.TypeBoulderCrimesApi();
let opts = {
  ...
  'searchDbBoulderCrimesOffense': "searchDbBoulderCrimesOffense_example", // String | Offense
  'searchDbBoulderCrimesReportdate': "searchDbBoulderCrimesReportdate_example", // String | Report Date
  'searchDbBoulderCrimesBlockadd': "searchDbBoulderCrimesBlockadd_example", // String | Address
  'searchDbBoulderCrimesLocation': "searchDbBoulderCrimesLocation_example" // String | Location
};
apiInstance.searchBoulderCrimes(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchDbBoulderCrimesOffense** | **String**| Offense | [optional] 
 **searchDbBoulderCrimesReportdate** | **String**| Report Date | [optional] 
 **searchDbBoulderCrimesBlockadd** | **String**| Address | [optional] 
 **searchDbBoulderCrimesLocation** | **String**| Location | [optional] 
