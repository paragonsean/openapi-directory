# GeodesystemsCom443.TypeMapGooglemapApi
...
let apiInstance = new GeodesystemsCom443.TypeMapGooglemapApi();
let opts = {
...
apiInstance.searchMapGooglemap(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
