# GeodesystemsCom443.TypeGeoShapefileApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchGeoShapefile**](TypeGeoShapefileApi.md#searchGeoShapefile) | **GET** /repository/search/type/geo_shapefile | Search API for &#39;Shapefile&#39; entry type



## searchGeoShapefile

> searchGeoShapefile(opts)
...
let apiInstance = new GeodesystemsCom443.TypeGeoShapefileApi();
let opts = {
...
apiInstance.searchGeoShapefile(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
