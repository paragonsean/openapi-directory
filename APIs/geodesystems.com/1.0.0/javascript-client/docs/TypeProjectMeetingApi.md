# GeodesystemsCom443.TypeProjectMeetingApi
...
let apiInstance = new GeodesystemsCom443.TypeProjectMeetingApi();
let opts = {
  ...
  'searchProjectMeetingTopic': "searchProjectMeetingTopic_example", // String | Topic
  'searchProjectMeetingLocation': "searchProjectMeetingLocation_example", // String | Location
  'searchProjectMeetingParticipants': "searchProjectMeetingParticipants_example" // String | Participants
};
apiInstance.searchProjectMeeting(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
