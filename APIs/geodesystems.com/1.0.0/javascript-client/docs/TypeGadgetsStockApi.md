# GeodesystemsCom443.TypeGadgetsStockApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchGadgetsStock**](TypeGadgetsStockApi.md#searchGadgetsStock) | **GET** /repository/search/type/gadgets_stock | Search API for &#39;Stock Ticker&#39; entry type



## searchGadgetsStock

> searchGadgetsStock(opts)
...
let apiInstance = new GeodesystemsCom443.TypeGadgetsStockApi();
let opts = {
...
apiInstance.searchGadgetsStock(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
