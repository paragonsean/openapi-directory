# GeodesystemsCom443.TypeBioOntologyCohortApi
...
let apiInstance = new GeodesystemsCom443.TypeBioOntologyCohortApi();
let opts = {
...
apiInstance.searchBioOntologyCohort(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
