# GeodesystemsCom443.TypeTypePointInlineApi
...
let apiInstance = new GeodesystemsCom443.TypeTypePointInlineApi();
let opts = {
...
apiInstance.searchTypePointInline(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
