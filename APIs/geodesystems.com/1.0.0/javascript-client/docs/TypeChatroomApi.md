# GeodesystemsCom443.TypeChatroomApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchChatroom**](TypeChatroomApi.md#searchChatroom) | **GET** /repository/search/type/chatroom | Search API for &#39;Chat Room&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeChatroomApi();
let opts = {
...
apiInstance.searchChatroom(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
