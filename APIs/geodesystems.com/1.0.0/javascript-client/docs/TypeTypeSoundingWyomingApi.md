# GeodesystemsCom443.TypeTypeSoundingWyomingApi
...
> searchTypeSoundingWyoming(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeSoundingWyomingApi();
let opts = {
...
apiInstance.searchTypeSoundingWyoming(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
