# GeodesystemsCom443.TypeTypePointIcebridgeParisApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypePointIcebridgeParis**](TypeTypePointIcebridgeParisApi.md#searchTypePointIcebridgeParis) | **GET** /repository/search/type/type_point_icebridge_paris | Search API for &#39;Paris Data&#39; entry type



## searchTypePointIcebridgeParis

> searchTypePointIcebridgeParis(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointIcebridgeParisApi();
let opts = {
...
apiInstance.searchTypePointIcebridgeParis(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
