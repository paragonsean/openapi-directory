# GeodesystemsCom443.TypeTypeEsriRestfolderApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeEsriRestfolder**](TypeTypeEsriRestfolderApi.md#searchTypeEsriRestfolder) | **GET** /repository/search/type/type_esri_restfolder | Search API for &#39;ESRI Services Folder&#39; entry type



## searchTypeEsriRestfolder

> searchTypeEsriRestfolder(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeEsriRestfolderApi();
let opts = {
...
apiInstance.searchTypeEsriRestfolder(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
