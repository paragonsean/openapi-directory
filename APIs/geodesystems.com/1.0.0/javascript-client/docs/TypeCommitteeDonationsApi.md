# GeodesystemsCom443.TypeCommitteeDonationsApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchCommitteeDonations**](TypeCommitteeDonationsApi.md#searchCommitteeDonations) | **GET** /repository/search/type/committee_donations | Search API for &#39;Committee Donations&#39; entry type



## searchCommitteeDonations

> searchCommitteeDonations(opts)
...
let apiInstance = new GeodesystemsCom443.TypeCommitteeDonationsApi();
let opts = {
  ...
  'searchDbCommitteeDonationsCommittee': "searchDbCommitteeDonationsCommittee_example", // String | Committee
  'searchDbCommitteeDonationsAmount': 3.4, // Number | Amount
  'searchDbCommitteeDonationsRecipient': "searchDbCommitteeDonationsRecipient_example", // String | Recipient
  'searchDbCommitteeDonationsDate': "searchDbCommitteeDonationsDate_example", // String | Date
  'searchDbCommitteeDonationsCity': "searchDbCommitteeDonationsCity_example", // String | City
  'searchDbCommitteeDonationsState': "searchDbCommitteeDonationsState_example", // String | State
  'searchDbCommitteeDonationsZipCode': "searchDbCommitteeDonationsZipCode_example", // String | Zip Code
  'searchDbCommitteeDonationsEmployer': "searchDbCommitteeDonationsEmployer_example", // String | Employer
  'searchDbCommitteeDonationsOccupation': "searchDbCommitteeDonationsOccupation_example", // String | Occupation
  'searchDbCommitteeDonationsLocation': "searchDbCommitteeDonationsLocation_example" // String | Location
};
apiInstance.searchCommitteeDonations(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchDbCommitteeDonationsCommittee** | **String**| Committee | [optional] 
 **searchDbCommitteeDonationsAmount** | **Number**| Amount | [optional] 
 **searchDbCommitteeDonationsRecipient** | **String**| Recipient | [optional] 
 **searchDbCommitteeDonationsDate** | **String**| Date | [optional] 
 **searchDbCommitteeDonationsCity** | **String**| City | [optional] 
 **searchDbCommitteeDonationsState** | **String**| State | [optional] 
 **searchDbCommitteeDonationsZipCode** | **String**| Zip Code | [optional] 
 **searchDbCommitteeDonationsEmployer** | **String**| Employer | [optional] 
 **searchDbCommitteeDonationsOccupation** | **String**| Occupation | [optional] 
 **searchDbCommitteeDonationsLocation** | **String**| Location | [optional] 
