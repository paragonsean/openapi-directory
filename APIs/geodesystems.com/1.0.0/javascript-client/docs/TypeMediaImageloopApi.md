# GeodesystemsCom443.TypeMediaImageloopApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchMediaImageloop**](TypeMediaImageloopApi.md#searchMediaImageloop) | **GET** /repository/search/type/media_imageloop | Search API for &#39;Image Loop&#39; entry type



## searchMediaImageloop

> searchMediaImageloop(opts)
...
let apiInstance = new GeodesystemsCom443.TypeMediaImageloopApi();
let opts = {
...
apiInstance.searchMediaImageloop(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
