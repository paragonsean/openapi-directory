# GeodesystemsCom443.TypeTypeHazarddataApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeHazarddata**](TypeTypeHazarddataApi.md#searchTypeHazarddata) | **GET** /repository/search/type/type_hazarddata | Search API for &#39;Hazard Data&#39; entry type



## searchTypeHazarddata

> searchTypeHazarddata(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeHazarddataApi();
let opts = {
  ...
  'searchTypeHazarddataSource': "searchTypeHazarddataSource_example" // String | Source Agency
};
apiInstance.searchTypeHazarddata(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchTypeHazarddataSource** | **String**| Source Agency | [optional] 
