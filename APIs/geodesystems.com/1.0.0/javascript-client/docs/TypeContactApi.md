# GeodesystemsCom443.TypeContactApi
...
let apiInstance = new GeodesystemsCom443.TypeContactApi();
let opts = {
  ...
  'searchDbContactName': "searchDbContactName_example", // String | Name
  'searchDbContactInstitution': "searchDbContactInstitution_example", // String | Institution
  'searchDbContactEmail': "searchDbContactEmail_example" // String | Email
};
apiInstance.searchContact(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
