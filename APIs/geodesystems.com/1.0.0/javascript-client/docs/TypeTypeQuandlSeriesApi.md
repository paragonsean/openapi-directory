# GeodesystemsCom443.TypeTypeQuandlSeriesApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeQuandlSeries**](TypeTypeQuandlSeriesApi.md#searchTypeQuandlSeries) | **GET** /repository/search/type/type_quandl_series | Search API for &#39;QUANDL Series&#39; entry type



## searchTypeQuandlSeries

> searchTypeQuandlSeries(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeQuandlSeriesApi();
let opts = {
...
apiInstance.searchTypeQuandlSeries(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
