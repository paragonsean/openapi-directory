# GeodesystemsCom443.TypeProjectServiceApi
...
let apiInstance = new GeodesystemsCom443.TypeProjectServiceApi();
let opts = {
  ...
  'searchProjectServiceServiceType': "searchProjectServiceServiceType_example", // String | Service Type
  'searchProjectServiceProvider': "searchProjectServiceProvider_example" // String | Provider
};
apiInstance.searchProjectService(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
