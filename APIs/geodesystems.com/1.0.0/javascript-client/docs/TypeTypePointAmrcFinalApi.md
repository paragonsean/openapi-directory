# GeodesystemsCom443.TypeTypePointAmrcFinalApi
...
let apiInstance = new GeodesystemsCom443.TypeTypePointAmrcFinalApi();
let opts = {
  ...
  'searchTypePointAmrcFinalSiteId': "searchTypePointAmrcFinalSiteId_example", // String | Site ID
  'searchTypePointAmrcFinalSiteName': "searchTypePointAmrcFinalSiteName_example", // String | Site Name
  'searchTypePointAmrcFinalArgosId': "searchTypePointAmrcFinalArgosId_example" // String | Argos ID
};
apiInstance.searchTypePointAmrcFinal(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
