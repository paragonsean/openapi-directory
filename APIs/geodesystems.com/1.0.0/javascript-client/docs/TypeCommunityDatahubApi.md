# GeodesystemsCom443.TypeCommunityDatahubApi
...
let apiInstance = new GeodesystemsCom443.TypeCommunityDatahubApi();
let opts = {
...
apiInstance.searchCommunityDatahub(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
