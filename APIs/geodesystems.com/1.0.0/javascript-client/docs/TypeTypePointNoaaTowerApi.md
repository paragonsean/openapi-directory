# GeodesystemsCom443.TypeTypePointNoaaTowerApi
...
let apiInstance = new GeodesystemsCom443.TypeTypePointNoaaTowerApi();
let opts = {
  ...
  'searchTypePointNoaaTowerSiteId': "searchTypePointNoaaTowerSiteId_example" // String | Site ID
};
apiInstance.searchTypePointNoaaTower(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
