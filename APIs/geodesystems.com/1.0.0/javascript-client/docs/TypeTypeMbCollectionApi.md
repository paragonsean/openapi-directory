# GeodesystemsCom443.TypeTypeMbCollectionApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeMbCollection**](TypeTypeMbCollectionApi.md#searchTypeMbCollection) | **GET** /repository/search/type/type_mb_collection | Search API for &#39;Bathymetry Collection&#39; entry type



## searchTypeMbCollection

> searchTypeMbCollection(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeMbCollectionApi();
let opts = {
...
apiInstance.searchTypeMbCollection(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
