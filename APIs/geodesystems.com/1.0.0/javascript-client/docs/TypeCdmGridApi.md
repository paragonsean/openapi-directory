# GeodesystemsCom443.TypeCdmGridApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchCdmGrid**](TypeCdmGridApi.md#searchCdmGrid) | **GET** /repository/search/type/cdm_grid | Search API for &#39;Gridded Data File&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeCdmGridApi();
let opts = {
...
apiInstance.searchCdmGrid(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
