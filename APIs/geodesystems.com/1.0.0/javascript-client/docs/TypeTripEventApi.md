# GeodesystemsCom443.TypeTripEventApi
...
let apiInstance = new GeodesystemsCom443.TypeTripEventApi();
let opts = {
...
apiInstance.searchTripEvent(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
