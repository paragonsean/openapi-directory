# GeodesystemsCom443.TypeBioHmmerIndexApi
...
let apiInstance = new GeodesystemsCom443.TypeBioHmmerIndexApi();
let opts = {
...
apiInstance.searchBioHmmerIndex(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
