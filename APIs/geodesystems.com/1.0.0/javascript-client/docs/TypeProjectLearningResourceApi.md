# GeodesystemsCom443.TypeProjectLearningResourceApi
...
> searchProjectLearningResource(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectLearningResourceApi();
let opts = {
  ...
  'searchProjectLearningResourceTopic': "searchProjectLearningResourceTopic_example", // String | Topic
  'searchProjectLearningResourceGradeLevel': "searchProjectLearningResourceGradeLevel_example" // String | Grade Level
};
apiInstance.searchProjectLearningResource(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
