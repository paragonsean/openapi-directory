# GeodesystemsCom443.TypeLatlonimageApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchLatlonimage**](TypeLatlonimageApi.md#searchLatlonimage) | **GET** /repository/search/type/latlonimage | Search API for &#39;Lat-Lon Image&#39; entry type



## searchLatlonimage

> searchLatlonimage(opts)
...
let apiInstance = new GeodesystemsCom443.TypeLatlonimageApi();
let opts = {
...
apiInstance.searchLatlonimage(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
