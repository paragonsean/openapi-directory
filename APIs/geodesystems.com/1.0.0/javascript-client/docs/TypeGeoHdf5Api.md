# GeodesystemsCom443.TypeGeoHdf5Api

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchGeoHdf5**](TypeGeoHdf5Api.md#searchGeoHdf5) | **GET** /repository/search/type/geo_hdf5 | Search API for &#39;HDF5 File&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeGeoHdf5Api();
let opts = {
...
apiInstance.searchGeoHdf5(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
