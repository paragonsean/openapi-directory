# GeodesystemsCom443.TypeTypePointOceanCsvSadoTTSApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypePointOceanCsvSadoTTS**](TypeTypePointOceanCsvSadoTTSApi.md#searchTypePointOceanCsvSadoTTS) | **GET** /repository/search/type/type_point_ocean_csv_sado_TTS | Search API for &#39;SADO TTS Data&#39; entry type



## searchTypePointOceanCsvSadoTTS

> searchTypePointOceanCsvSadoTTS(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointOceanCsvSadoTTSApi();
let opts = {
...
apiInstance.searchTypePointOceanCsvSadoTTS(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
