# GeodesystemsCom443.TypeProjectContributionApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchProjectContribution**](TypeProjectContributionApi.md#searchProjectContribution) | **GET** /repository/search/type/project_contribution | Search API for &#39;Research Contribution&#39; entry type



## searchProjectContribution

> searchProjectContribution(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectContributionApi();
let opts = {
...
apiInstance.searchProjectContribution(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
