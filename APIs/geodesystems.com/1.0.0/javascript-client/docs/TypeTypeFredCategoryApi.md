# GeodesystemsCom443.TypeTypeFredCategoryApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeFredCategory**](TypeTypeFredCategoryApi.md#searchTypeFredCategory) | **GET** /repository/search/type/type_fred_category | Search API for &#39;FRED Category&#39; entry type



## searchTypeFredCategory

> searchTypeFredCategory(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeFredCategoryApi();
let opts = {
...
apiInstance.searchTypeFredCategory(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
