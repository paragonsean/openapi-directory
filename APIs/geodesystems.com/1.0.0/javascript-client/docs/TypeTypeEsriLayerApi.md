# GeodesystemsCom443.TypeTypeEsriLayerApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeEsriLayer**](TypeTypeEsriLayerApi.md#searchTypeEsriLayer) | **GET** /repository/search/type/type_esri_layer | Search API for &#39;ESRI Layer&#39; entry type



## searchTypeEsriLayer

> searchTypeEsriLayer(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeEsriLayerApi();
let opts = {
  ...
  'searchTypeEsriLayerLayerType': "searchTypeEsriLayerLayerType_example" // String | Layer Type
};
apiInstance.searchTypeEsriLayer(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchTypeEsriLayerLayerType** | **String**| Layer Type | [optional] 
