# GeodesystemsCom443.TypePollApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchPoll**](TypePollApi.md#searchPoll) | **GET** /repository/search/type/poll | Search API for &#39;Poll&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypePollApi();
let opts = {
...
apiInstance.searchPoll(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
