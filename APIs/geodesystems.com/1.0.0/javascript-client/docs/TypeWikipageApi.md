# GeodesystemsCom443.TypeWikipageApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchWikipage**](TypeWikipageApi.md#searchWikipage) | **GET** /repository/search/type/wikipage | Search API for &#39;Wiki Page&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeWikipageApi();
let opts = {
  ...
  'searchWikipageWikitext': "searchWikipageWikitext_example", // String | Wiki Text
  'searchWikipageCategory': "searchWikipageCategory_example" // String | Wiki Page Category
};
apiInstance.searchWikipage(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchWikipageWikitext** | **String**| Wiki Text | [optional] 
 **searchWikipageCategory** | **String**| Wiki Page Category | [optional] 
