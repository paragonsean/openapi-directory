# GeodesystemsCom443.TypeGeoKmlApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchGeoKml**](TypeGeoKmlApi.md#searchGeoKml) | **GET** /repository/search/type/geo_kml | Search API for &#39;KML/KMZ File&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeGeoKmlApi();
let opts = {
...
apiInstance.searchGeoKml(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
