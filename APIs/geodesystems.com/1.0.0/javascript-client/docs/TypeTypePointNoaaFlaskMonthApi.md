# GeodesystemsCom443.TypeTypePointNoaaFlaskMonthApi
...
> searchTypePointNoaaFlaskMonth(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointNoaaFlaskMonthApi();
let opts = {
  ...
  'searchTypePointNoaaFlaskMonthSiteId': "searchTypePointNoaaFlaskMonthSiteId_example", // String | Site ID
  'searchTypePointNoaaFlaskMonthParameter': "searchTypePointNoaaFlaskMonthParameter_example", // String | Parameter
  'searchTypePointNoaaFlaskMonthProject': "searchTypePointNoaaFlaskMonthProject_example", // String | Project
  'searchTypePointNoaaFlaskMonthLabIdNumber': "searchTypePointNoaaFlaskMonthLabIdNumber_example", // String | Lab ID Number
  'searchTypePointNoaaFlaskMonthMeasurementGroup': "searchTypePointNoaaFlaskMonthMeasurementGroup_example" // String | Measurement Group
};
apiInstance.searchTypePointNoaaFlaskMonth(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
