# GeodesystemsCom443.TypeBioOntologySeriesApi
...
let apiInstance = new GeodesystemsCom443.TypeBioOntologySeriesApi();
let opts = {
...
apiInstance.searchBioOntologySeries(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
