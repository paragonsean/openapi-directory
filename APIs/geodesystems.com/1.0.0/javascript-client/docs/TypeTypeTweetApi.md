# GeodesystemsCom443.TypeTypeTweetApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeTweetApi();
let opts = {
...
apiInstance.searchTypeTweet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
