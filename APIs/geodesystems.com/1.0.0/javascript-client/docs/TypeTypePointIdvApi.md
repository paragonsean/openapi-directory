# GeodesystemsCom443.TypeTypePointIdvApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypePointIdv**](TypeTypePointIdvApi.md#searchTypePointIdv) | **GET** /repository/search/type/type_point_idv | Search API for &#39;IDV Point File&#39; entry type



## searchTypePointIdv

> searchTypePointIdv(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointIdvApi();
let opts = {
...
apiInstance.searchTypePointIdv(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
