# GeodesystemsCom443.TypeTypeEsriFeatureserverApi
...
> searchTypeEsriFeatureserver(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeEsriFeatureserverApi();
let opts = {
...
apiInstance.searchTypeEsriFeatureserver(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
