# GeodesystemsCom443.TypeProjectCampaignApi
...
let apiInstance = new GeodesystemsCom443.TypeProjectCampaignApi();
let opts = {
...
apiInstance.searchProjectCampaign(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
