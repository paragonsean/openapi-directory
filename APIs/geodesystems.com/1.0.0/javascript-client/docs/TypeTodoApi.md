# GeodesystemsCom443.TypeTodoApi
...
let apiInstance = new GeodesystemsCom443.TypeTodoApi();
let opts = {
  ...
  'searchDbTodoChecked': true, // Boolean | Done
  'searchDbTodoTitle': "searchDbTodoTitle_example", // String | What
  'searchDbTodoCategory': "searchDbTodoCategory_example" // String | Category
};
apiInstance.searchTodo(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
