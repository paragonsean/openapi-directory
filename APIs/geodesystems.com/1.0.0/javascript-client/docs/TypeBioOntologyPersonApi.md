# GeodesystemsCom443.TypeBioOntologyPersonApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchBioOntologyPerson**](TypeBioOntologyPersonApi.md#searchBioOntologyPerson) | **GET** /repository/search/type/bio_ontology_person | Search API for &#39;Person&#39; entry type



## searchBioOntologyPerson

> searchBioOntologyPerson(opts)
...
let apiInstance = new GeodesystemsCom443.TypeBioOntologyPersonApi();
let opts = {
  ...
  'searchBioOntologyPersonGender': "searchBioOntologyPersonGender_example" // String | Gender
};
apiInstance.searchBioOntologyPerson(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchBioOntologyPersonGender** | **String**| Gender | [optional] 
