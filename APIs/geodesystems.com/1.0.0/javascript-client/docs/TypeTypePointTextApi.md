# GeodesystemsCom443.TypeTypePointTextApi
...
let apiInstance = new GeodesystemsCom443.TypeTypePointTextApi();
let opts = {
...
apiInstance.searchTypePointText(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
