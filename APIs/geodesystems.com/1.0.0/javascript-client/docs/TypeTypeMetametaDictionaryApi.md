# GeodesystemsCom443.TypeTypeMetametaDictionaryApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeMetametaDictionary**](TypeTypeMetametaDictionaryApi.md#searchTypeMetametaDictionary) | **GET** /repository/search/type/type_metameta_dictionary | Search API for &#39;Metadata Dictionary&#39; entry type



## searchTypeMetametaDictionary

> searchTypeMetametaDictionary(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeMetametaDictionaryApi();
let opts = {
  ...
  'searchTypeMetametaDictionaryFieldIndex': 56, // Number | Index
  'searchTypeMetametaDictionaryDictionaryType': "searchTypeMetametaDictionaryDictionaryType_example", // String | Type
  'searchTypeMetametaDictionaryShortName': "searchTypeMetametaDictionaryShortName_example", // String | Short Name
  'searchTypeMetametaDictionarySuperType': "searchTypeMetametaDictionarySuperType_example", // String | Super Type
  'searchTypeMetametaDictionaryIsgroup': true, // Boolean | Is Group
  'searchTypeMetametaDictionaryHandlerClass': "searchTypeMetametaDictionaryHandlerClass_example", // String | Handler Class
  'searchTypeMetametaDictionaryProperties': "searchTypeMetametaDictionaryProperties_example", // String | Properties
  'searchTypeMetametaDictionaryWikiText': "searchTypeMetametaDictionaryWikiText_example" // String | Wiki Text
};
apiInstance.searchTypeMetametaDictionary(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchTypeMetametaDictionaryFieldIndex** | **Number**| Index | [optional] 
 **searchTypeMetametaDictionaryDictionaryType** | **String**| Type | [optional] 
 **searchTypeMetametaDictionaryShortName** | **String**| Short Name | [optional] 
 **searchTypeMetametaDictionarySuperType** | **String**| Super Type | [optional] 
 **searchTypeMetametaDictionaryIsgroup** | **Boolean**| Is Group | [optional] 
 **searchTypeMetametaDictionaryHandlerClass** | **String**| Handler Class | [optional] 
 **searchTypeMetametaDictionaryProperties** | **String**| Properties | [optional] 
 **searchTypeMetametaDictionaryWikiText** | **String**| Wiki Text | [optional] 
