# GeodesystemsCom443.TypeTypeDocumentDocApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeDocumentDocApi();
let opts = {
...
apiInstance.searchTypeDocumentDoc(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
