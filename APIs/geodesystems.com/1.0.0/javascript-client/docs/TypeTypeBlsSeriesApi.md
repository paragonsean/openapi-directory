# GeodesystemsCom443.TypeTypeBlsSeriesApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeBlsSeriesApi();
let opts = {
  ...
  'searchTypeBlsSeriesSurveyName': "searchTypeBlsSeriesSurveyName_example", // String | Survey Name
  'searchTypeBlsSeriesMeasureDataType': "searchTypeBlsSeriesMeasureDataType_example", // String | Measure Data Type
  'searchTypeBlsSeriesIndustry': "searchTypeBlsSeriesIndustry_example", // String | Industry
  'searchTypeBlsSeriesSector': "searchTypeBlsSeriesSector_example", // String | Sector
  'searchTypeBlsSeriesArea': "searchTypeBlsSeriesArea_example", // String | Area
  'searchTypeBlsSeriesItem': "searchTypeBlsSeriesItem_example", // String | Item
  'searchTypeBlsSeriesSeasonality': "searchTypeBlsSeriesSeasonality_example" // String | Seasonality
};
apiInstance.searchTypeBlsSeries(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
