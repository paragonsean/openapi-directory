# GeodesystemsCom443.TypeTypePointOceanCnvApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypePointOceanCnv**](TypeTypePointOceanCnvApi.md#searchTypePointOceanCnv) | **GET** /repository/search/type/type_point_ocean_cnv | Search API for &#39;SeaBird CNV Data&#39; entry type



## searchTypePointOceanCnv

> searchTypePointOceanCnv(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointOceanCnvApi();
let opts = {
...
apiInstance.searchTypePointOceanCnv(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
