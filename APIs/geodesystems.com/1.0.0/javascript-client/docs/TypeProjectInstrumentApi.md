# GeodesystemsCom443.TypeProjectInstrumentApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchProjectInstrument**](TypeProjectInstrumentApi.md#searchProjectInstrument) | **GET** /repository/search/type/project_instrument | Search API for &#39;Instrument Data Collection&#39; entry type



## searchProjectInstrument

> searchProjectInstrument(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectInstrumentApi();
let opts = {
...
apiInstance.searchProjectInstrument(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
