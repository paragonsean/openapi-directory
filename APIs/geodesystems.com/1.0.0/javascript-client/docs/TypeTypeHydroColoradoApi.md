# GeodesystemsCom443.TypeTypeHydroColoradoApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeHydroColoradoApi();
let opts = {
  ...
  'searchTypeHydroColoradoSiteId': "searchTypeHydroColoradoSiteId_example" // String | Site ID
};
apiInstance.searchTypeHydroColorado(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
