# GeodesystemsCom443.TypeTypeDocumentCsvApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeDocumentCsvApi();
let opts = {
...
apiInstance.searchTypeDocumentCsv(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
