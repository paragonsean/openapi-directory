# GeodesystemsCom443.TypeOwlOntologyApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchOwlOntology**](TypeOwlOntologyApi.md#searchOwlOntology) | **GET** /repository/search/type/owl.ontology | Search API for &#39;OWL Ontology&#39; entry type



## searchOwlOntology

> searchOwlOntology(opts)
...
let apiInstance = new GeodesystemsCom443.TypeOwlOntologyApi();
let opts = {
...
apiInstance.searchOwlOntology(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
