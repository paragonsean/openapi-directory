# GeodesystemsCom443.TypeMediaPhotoalbumApi
...
let apiInstance = new GeodesystemsCom443.TypeMediaPhotoalbumApi();
let opts = {
...
apiInstance.searchMediaPhotoalbum(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
