# GeodesystemsCom443.TypeTypePointNoaaCarbonApi
...
> searchTypePointNoaaCarbon(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointNoaaCarbonApi();
let opts = {
  ...
  'searchTypePointNoaaCarbonSiteId': "searchTypePointNoaaCarbonSiteId_example", // String | Site ID
  'searchTypePointNoaaCarbonParameter': "searchTypePointNoaaCarbonParameter_example", // String | Parameter
  'searchTypePointNoaaCarbonProject': "searchTypePointNoaaCarbonProject_example", // String | Project
  'searchTypePointNoaaCarbonLabIdNumber': "searchTypePointNoaaCarbonLabIdNumber_example", // String | Lab ID Number
  'searchTypePointNoaaCarbonMeasurementGroup': "searchTypePointNoaaCarbonMeasurementGroup_example" // String | Measurement Group
};
apiInstance.searchTypePointNoaaCarbon(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
