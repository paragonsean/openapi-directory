# GeodesystemsCom443.TypeTypePointWsbbGgpApi
...
let apiInstance = new GeodesystemsCom443.TypeTypePointWsbbGgpApi();
let opts = {
  ...
  'searchTypePointWsbbGgpStation': "searchTypePointWsbbGgpStation_example", // String | Station
  'searchTypePointWsbbGgpInstrument': "searchTypePointWsbbGgpInstrument_example", // String | Instrument
  'searchTypePointWsbbGgpAuthor': "searchTypePointWsbbGgpAuthor_example" // String | Author
};
apiInstance.searchTypePointWsbbGgp(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
