# GeodesystemsCom443.TypeProjectTermApi
...
let apiInstance = new GeodesystemsCom443.TypeProjectTermApi();
let opts = {
  ...
  'searchProjectTermValue': "searchProjectTermValue_example" // String | Term Value
};
apiInstance.searchProjectTerm(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
