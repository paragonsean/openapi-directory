# GeodesystemsCom443.TypeBioSfPdbApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchBioSfPdb**](TypeBioSfPdbApi.md#searchBioSfPdb) | **GET** /repository/search/type/bio_sf_pdb | Search API for &#39;PDB Protein File&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeBioSfPdbApi();
let opts = {
...
apiInstance.searchBioSfPdb(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
