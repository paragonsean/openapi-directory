# GeodesystemsCom443.TypeTypeImageApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeImage**](TypeTypeImageApi.md#searchTypeImage) | **GET** /repository/search/type/type_image | Search API for &#39;Image&#39; entry type



## searchTypeImage

> searchTypeImage(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeImageApi();
let opts = {
...
apiInstance.searchTypeImage(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
