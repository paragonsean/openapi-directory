# GeodesystemsCom443.TypeFitsDataApi
...
let apiInstance = new GeodesystemsCom443.TypeFitsDataApi();
let opts = {
  ...
  'searchFitsDataOrigin': "searchFitsDataOrigin_example", // String | Origin
  'searchFitsDataTelescope': "searchFitsDataTelescope_example", // String | Telescope
  'searchFitsDataInstrument': "searchFitsDataInstrument_example" // String | Instrument
};
apiInstance.searchFitsData(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
