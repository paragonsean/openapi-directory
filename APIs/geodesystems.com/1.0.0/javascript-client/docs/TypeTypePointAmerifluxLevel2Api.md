# GeodesystemsCom443.TypeTypePointAmerifluxLevel2Api
...
> searchTypePointAmerifluxLevel2(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointAmerifluxLevel2Api();
let opts = {
  ...
  'searchTypePointAmerifluxLevel2SiteId': "searchTypePointAmerifluxLevel2SiteId_example", // String | Site ID
  'searchTypePointAmerifluxLevel2Contact': "searchTypePointAmerifluxLevel2Contact_example", // String | Contact
  'searchTypePointAmerifluxLevel2EcosystemType': "searchTypePointAmerifluxLevel2EcosystemType_example" // String | Ecosystem Type
};
apiInstance.searchTypePointAmerifluxLevel2(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
