# GeodesystemsCom443.TypeMediaVideoQuicktimeApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchMediaVideoQuicktime**](TypeMediaVideoQuicktimeApi.md#searchMediaVideoQuicktime) | **GET** /repository/search/type/media_video_quicktime | Search API for &#39;Quicktime Video&#39; entry type



## searchMediaVideoQuicktime

> searchMediaVideoQuicktime(opts)
...
let apiInstance = new GeodesystemsCom443.TypeMediaVideoQuicktimeApi();
let opts = {
...
apiInstance.searchMediaVideoQuicktime(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
