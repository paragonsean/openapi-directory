# GeodesystemsCom443.TypeProjectProjectApi
...
let apiInstance = new GeodesystemsCom443.TypeProjectProjectApi();
let opts = {
...
apiInstance.searchProjectProject(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
