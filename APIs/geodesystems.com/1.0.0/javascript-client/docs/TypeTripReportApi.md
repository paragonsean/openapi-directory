# GeodesystemsCom443.TypeTripReportApi
...
let apiInstance = new GeodesystemsCom443.TypeTripReportApi();
let opts = {
...
apiInstance.searchTripReport(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
