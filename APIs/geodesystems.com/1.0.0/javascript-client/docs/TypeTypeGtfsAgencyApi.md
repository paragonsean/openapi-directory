# GeodesystemsCom443.TypeTypeGtfsAgencyApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeGtfsAgencyApi();
let opts = {
...
apiInstance.searchTypeGtfsAgency(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
