# GeodesystemsCom443.TypeMediaYoutubevideoApi
...
let apiInstance = new GeodesystemsCom443.TypeMediaYoutubevideoApi();
let opts = {
...
apiInstance.searchMediaYoutubevideo(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
