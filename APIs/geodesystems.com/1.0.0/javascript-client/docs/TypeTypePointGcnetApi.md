# GeodesystemsCom443.TypeTypePointGcnetApi
...
let apiInstance = new GeodesystemsCom443.TypeTypePointGcnetApi();
let opts = {
...
apiInstance.searchTypePointGcnet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
