# GeodesystemsCom443.TypePasteitentryApi
...
let apiInstance = new GeodesystemsCom443.TypePasteitentryApi();
let opts = {
...
apiInstance.searchPasteitentry(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
