# GeodesystemsCom443.TypeLidarLvisApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchLidarLvis**](TypeLidarLvisApi.md#searchLidarLvis) | **GET** /repository/search/type/lidar_lvis | Search API for &#39;LVIS Lidar Data&#39; entry type



## searchLidarLvis

> searchLidarLvis(opts)
...
let apiInstance = new GeodesystemsCom443.TypeLidarLvisApi();
let opts = {
...
apiInstance.searchLidarLvis(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
