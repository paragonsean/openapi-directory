# GeodesystemsCom443.TypeTypeSoundingFrdApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeSoundingFrd**](TypeTypeSoundingFrdApi.md#searchTypeSoundingFrd) | **GET** /repository/search/type/type_sounding_frd | Search API for &#39;FRD Sounding&#39; entry type



## searchTypeSoundingFrd

> searchTypeSoundingFrd(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeSoundingFrdApi();
let opts = {
...
apiInstance.searchTypeSoundingFrd(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
