# GeodesystemsCom443.TypeOwlClassApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchOwlClass**](TypeOwlClassApi.md#searchOwlClass) | **GET** /repository/search/type/owl.class | Search API for &#39;OWL Class&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeOwlClassApi();
let opts = {
...
apiInstance.searchOwlClass(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
