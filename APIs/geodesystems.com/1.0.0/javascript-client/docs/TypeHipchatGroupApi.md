# GeodesystemsCom443.TypeHipchatGroupApi
...
let apiInstance = new GeodesystemsCom443.TypeHipchatGroupApi();
let opts = {
...
apiInstance.searchHipchatGroup(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
