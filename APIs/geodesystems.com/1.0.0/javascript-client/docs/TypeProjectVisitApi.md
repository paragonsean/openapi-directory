# GeodesystemsCom443.TypeProjectVisitApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchProjectVisit**](TypeProjectVisitApi.md#searchProjectVisit) | **GET** /repository/search/type/project_visit | Search API for &#39;Site Visit&#39; entry type



## searchProjectVisit

> searchProjectVisit(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectVisitApi();
let opts = {
...
apiInstance.searchProjectVisit(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
