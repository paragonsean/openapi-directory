# GeodesystemsCom443.TypeProjectSurveylocationApi
...
> searchProjectSurveylocation(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectSurveylocationApi();
let opts = {
...
apiInstance.searchProjectSurveylocation(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
