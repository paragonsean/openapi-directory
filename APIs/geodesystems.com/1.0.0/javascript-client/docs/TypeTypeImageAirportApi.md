# GeodesystemsCom443.TypeTypeImageAirportApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeImageAirport**](TypeTypeImageAirportApi.md#searchTypeImageAirport) | **GET** /repository/search/type/type_image_airport | Search API for &#39;Airport Image&#39; entry type



## searchTypeImageAirport

> searchTypeImageAirport(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeImageAirportApi();
let opts = {
...
apiInstance.searchTypeImageAirport(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
