# GeodesystemsCom443.TypeTypeBlsSurveyApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeBlsSurveyApi();
let opts = {
...
apiInstance.searchTypeBlsSurvey(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
