# GeodesystemsCom443.TypeTypeServiceLinkApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeServiceLinkApi();
let opts = {
...
apiInstance.searchTypeServiceLink(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
