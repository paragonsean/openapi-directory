# GeodesystemsCom443.TypeProjectFieldnoteApi
...
let apiInstance = new GeodesystemsCom443.TypeProjectFieldnoteApi();
let opts = {
...
apiInstance.searchProjectFieldnote(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
