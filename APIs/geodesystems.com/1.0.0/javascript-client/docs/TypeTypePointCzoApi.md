# GeodesystemsCom443.TypeTypePointCzoApi
...
let apiInstance = new GeodesystemsCom443.TypeTypePointCzoApi();
let opts = {
...
apiInstance.searchTypePointCzo(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
