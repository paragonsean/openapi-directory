# GeodesystemsCom443.TypeTypeGtfsStopsApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeGtfsStopsApi();
let opts = {
...
apiInstance.searchTypeGtfsStops(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
