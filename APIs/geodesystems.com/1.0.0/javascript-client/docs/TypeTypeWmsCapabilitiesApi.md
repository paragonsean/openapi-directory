# GeodesystemsCom443.TypeTypeWmsCapabilitiesApi
...
> searchTypeWmsCapabilities(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeWmsCapabilitiesApi();
let opts = {
...
apiInstance.searchTypeWmsCapabilities(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
