# GeodesystemsCom443.TypeTripHotelApi
...
let apiInstance = new GeodesystemsCom443.TypeTripHotelApi();
let opts = {
...
apiInstance.searchTripHotel(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
