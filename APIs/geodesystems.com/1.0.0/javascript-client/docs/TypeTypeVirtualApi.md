# GeodesystemsCom443.TypeTypeVirtualApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeVirtualApi();
let opts = {
...
apiInstance.searchTypeVirtual(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
