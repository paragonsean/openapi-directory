# GeodesystemsCom443.TypeTripFlightApi
...
let apiInstance = new GeodesystemsCom443.TypeTripFlightApi();
let opts = {
...
apiInstance.searchTripFlight(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
