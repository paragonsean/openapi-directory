# GeodesystemsCom443.TypeTypeWmsLayerApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeWmsLayerApi();
let opts = {
...
apiInstance.searchTypeWmsLayer(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
