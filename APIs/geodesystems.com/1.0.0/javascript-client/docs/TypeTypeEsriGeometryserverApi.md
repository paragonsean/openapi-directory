# GeodesystemsCom443.TypeTypeEsriGeometryserverApi
...
> searchTypeEsriGeometryserver(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeEsriGeometryserverApi();
let opts = {
...
apiInstance.searchTypeEsriGeometryserver(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
