# GeodesystemsCom443.TypeMediaVideoChannelApi
...
let apiInstance = new GeodesystemsCom443.TypeMediaVideoChannelApi();
let opts = {
...
apiInstance.searchMediaVideoChannel(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
