# GeodesystemsCom443.TypeProjectExperimentApi
...
let apiInstance = new GeodesystemsCom443.TypeProjectExperimentApi();
let opts = {
...
apiInstance.searchProjectExperiment(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
