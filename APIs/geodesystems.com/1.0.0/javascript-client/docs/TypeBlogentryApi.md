# GeodesystemsCom443.TypeBlogentryApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchBlogentry**](TypeBlogentryApi.md#searchBlogentry) | **GET** /repository/search/type/blogentry | Search API for &#39;Weblog Entry&#39; entry type



## searchBlogentry

> searchBlogentry(opts)
...
let apiInstance = new GeodesystemsCom443.TypeBlogentryApi();
let opts = {
  ...
  'searchBlogentryBlogtext': "searchBlogentryBlogtext_example" // String | Extra Text
};
apiInstance.searchBlogentry(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchBlogentryBlogtext** | **String**| Extra Text | [optional] 
