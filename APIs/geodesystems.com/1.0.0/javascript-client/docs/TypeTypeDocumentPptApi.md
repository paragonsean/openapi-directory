# GeodesystemsCom443.TypeTypeDocumentPptApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeDocumentPptApi();
let opts = {
...
apiInstance.searchTypeDocumentPpt(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
