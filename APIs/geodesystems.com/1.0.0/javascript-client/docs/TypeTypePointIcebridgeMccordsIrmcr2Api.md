# GeodesystemsCom443.TypeTypePointIcebridgeMccordsIrmcr2Api
...
> searchTypePointIcebridgeMccordsIrmcr2(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointIcebridgeMccordsIrmcr2Api();
let opts = {
...
apiInstance.searchTypePointIcebridgeMccordsIrmcr2(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
