# GeodesystemsCom443.TypeCommunityResourceApi
...
let apiInstance = new GeodesystemsCom443.TypeCommunityResourceApi();
let opts = {
  ...
  'searchCommunityResourceResourceType': "searchCommunityResourceResourceType_example", // String | Type
  'searchCommunityResourceAddress': "searchCommunityResourceAddress_example", // String | Address
  'searchCommunityResourceCity': "searchCommunityResourceCity_example", // String | City
  'searchCommunityResourceState': "searchCommunityResourceState_example", // String | State or Province
  'searchCommunityResourceZipcode': "searchCommunityResourceZipcode_example" // String | Zip Code
};
apiInstance.searchCommunityResource(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
