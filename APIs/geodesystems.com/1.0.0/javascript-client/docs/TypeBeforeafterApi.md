# GeodesystemsCom443.TypeBeforeafterApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchBeforeafter**](TypeBeforeafterApi.md#searchBeforeafter) | **GET** /repository/search/type/beforeafter | Search API for &#39;Before and After Images&#39; entry type



## searchBeforeafter

> searchBeforeafter(opts)
...
let apiInstance = new GeodesystemsCom443.TypeBeforeafterApi();
let opts = {
...
apiInstance.searchBeforeafter(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
