# GeodesystemsCom443.TypeTypeIdvBundleApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeIdvBundle**](TypeTypeIdvBundleApi.md#searchTypeIdvBundle) | **GET** /repository/search/type/type_idv_bundle | Search API for &#39;IDV Bundle&#39; entry type



## searchTypeIdvBundle

> searchTypeIdvBundle(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeIdvBundleApi();
let opts = {
...
apiInstance.searchTypeIdvBundle(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
