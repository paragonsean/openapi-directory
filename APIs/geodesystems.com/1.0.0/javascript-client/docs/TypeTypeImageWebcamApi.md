# GeodesystemsCom443.TypeTypeImageWebcamApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeImageWebcam**](TypeTypeImageWebcamApi.md#searchTypeImageWebcam) | **GET** /repository/search/type/type_image_webcam | Search API for &#39;Webcam&#39; entry type



## searchTypeImageWebcam

> searchTypeImageWebcam(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeImageWebcamApi();
let opts = {
...
apiInstance.searchTypeImageWebcam(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
