# GeodesystemsCom443.TypeTypeEsriGpserverApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeEsriGpserverApi();
let opts = {
...
apiInstance.searchTypeEsriGpserver(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
