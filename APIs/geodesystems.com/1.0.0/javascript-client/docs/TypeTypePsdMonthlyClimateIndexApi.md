# GeodesystemsCom443.TypeTypePsdMonthlyClimateIndexApi
...
> searchTypePsdMonthlyClimateIndex(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePsdMonthlyClimateIndexApi();
let opts = {
  ...
  'searchTypePsdMonthlyClimateIndexUnits': "searchTypePsdMonthlyClimateIndexUnits_example" // String | Units
};
apiInstance.searchTypePsdMonthlyClimateIndex(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
