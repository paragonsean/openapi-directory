# GeodesystemsCom443.TypeNotesNotebookApi
...
let apiInstance = new GeodesystemsCom443.TypeNotesNotebookApi();
let opts = {
...
apiInstance.searchNotesNotebook(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
