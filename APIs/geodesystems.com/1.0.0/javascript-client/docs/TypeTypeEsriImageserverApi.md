# GeodesystemsCom443.TypeTypeEsriImageserverApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeEsriImageserver**](TypeTypeEsriImageserverApi.md#searchTypeEsriImageserver) | **GET** /repository/search/type/type_esri_imageserver | Search API for &#39;ESRI Image Server&#39; entry type



## searchTypeEsriImageserver

> searchTypeEsriImageserver(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeEsriImageserverApi();
let opts = {
...
apiInstance.searchTypeEsriImageserver(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
