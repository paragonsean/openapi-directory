# GeodesystemsCom443.TypeProjectOrganizationApi
...
> searchProjectOrganization(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectOrganizationApi();
let opts = {
  ...
  'searchProjectOrganizationOrganizationType': "searchProjectOrganizationOrganizationType_example", // String | Organization Type
  'searchProjectOrganizationStatus': "searchProjectOrganizationStatus_example" // String | Status
};
apiInstance.searchProjectOrganization(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
