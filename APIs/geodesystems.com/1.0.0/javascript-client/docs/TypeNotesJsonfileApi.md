# GeodesystemsCom443.TypeNotesJsonfileApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchNotesJsonfile**](TypeNotesJsonfileApi.md#searchNotesJsonfile) | **GET** /repository/search/type/notes_jsonfile | Search API for &#39;Json File&#39; entry type



## searchNotesJsonfile

> searchNotesJsonfile(opts)
...
let apiInstance = new GeodesystemsCom443.TypeNotesJsonfileApi();
let opts = {
...
apiInstance.searchNotesJsonfile(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
