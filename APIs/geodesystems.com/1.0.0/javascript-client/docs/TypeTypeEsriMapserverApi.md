# GeodesystemsCom443.TypeTypeEsriMapserverApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeEsriMapserverApi();
let opts = {
...
apiInstance.searchTypeEsriMapserver(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
