# GeodesystemsCom443.TypeTypePointNoaaMadisApi
...
let apiInstance = new GeodesystemsCom443.TypeTypePointNoaaMadisApi();
let opts = {
...
apiInstance.searchTypePointNoaaMadis(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
