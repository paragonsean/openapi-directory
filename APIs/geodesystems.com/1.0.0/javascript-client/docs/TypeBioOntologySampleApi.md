# GeodesystemsCom443.TypeBioOntologySampleApi
...
let apiInstance = new GeodesystemsCom443.TypeBioOntologySampleApi();
let opts = {
...
apiInstance.searchBioOntologySample(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
