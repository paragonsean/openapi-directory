# GeodesystemsCom443.TypePoliceStopDataApi
...
let apiInstance = new GeodesystemsCom443.TypePoliceStopDataApi();
let opts = {
  ...
  'searchDbPoliceStopDataRace': "searchDbPoliceStopDataRace_example", // String | Race
  'searchDbPoliceStopDataEthnicity': "searchDbPoliceStopDataEthnicity_example", // String | Ethnicity
  'searchDbPoliceStopDataSex': "searchDbPoliceStopDataSex_example", // String | Sex
  'searchDbPoliceStopDataMinutes': 56, // Number | Minutes
  'searchDbPoliceStopDataDate': "searchDbPoliceStopDataDate_example", // String | Date
  'searchDbPoliceStopDataAddress': "searchDbPoliceStopDataAddress_example", // String | Address
  'searchDbPoliceStopDataResident': "searchDbPoliceStopDataResident_example" // String | Resident
};
apiInstance.searchPoliceStopData(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchDbPoliceStopDataMinutes** | **Number**| Minutes | [optional] 
