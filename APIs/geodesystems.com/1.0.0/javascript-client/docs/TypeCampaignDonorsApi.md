# GeodesystemsCom443.TypeCampaignDonorsApi
...
let apiInstance = new GeodesystemsCom443.TypeCampaignDonorsApi();
let opts = {
  ...
  'searchDbCampaignDonorsCommittee': "searchDbCampaignDonorsCommittee_example", // String | Committee
  'searchDbCampaignDonorsAmount': 3.4, // Number | Amount
  'searchDbCampaignDonorsParty': "searchDbCampaignDonorsParty_example", // String | Party
  'searchDbCampaignDonorsDonor': "searchDbCampaignDonorsDonor_example", // String | Donor
  'searchDbCampaignDonorsGender': "searchDbCampaignDonorsGender_example", // String | Gender
  'searchDbCampaignDonorsCity': "searchDbCampaignDonorsCity_example", // String | City
  'searchDbCampaignDonorsState': "searchDbCampaignDonorsState_example", // String | State
  'searchDbCampaignDonorsZipCode': "searchDbCampaignDonorsZipCode_example", // String | Zip Code
  'searchDbCampaignDonorsEmployer': "searchDbCampaignDonorsEmployer_example", // String | Employer
  'searchDbCampaignDonorsOccupation': "searchDbCampaignDonorsOccupation_example", // String | Occupation
  'searchDbCampaignDonorsDate': "searchDbCampaignDonorsDate_example", // String | Date
  'searchDbCampaignDonorsLocation': "searchDbCampaignDonorsLocation_example" // String | Location
};
apiInstance.searchCampaignDonors(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchDbCampaignDonorsAmount** | **Number**| Amount | [optional] 
