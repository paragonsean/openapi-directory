# GeodesystemsCom443.TypeBioOmeTiffApi
...
let apiInstance = new GeodesystemsCom443.TypeBioOmeTiffApi();
let opts = {
...
apiInstance.searchBioOmeTiff(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
