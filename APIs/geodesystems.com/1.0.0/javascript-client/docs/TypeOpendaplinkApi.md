# GeodesystemsCom443.TypeOpendaplinkApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchOpendaplink**](TypeOpendaplinkApi.md#searchOpendaplink) | **GET** /repository/search/type/opendaplink | Search API for &#39;OPeNDAP Link&#39; entry type



## searchOpendaplink

> searchOpendaplink(opts)
...
let apiInstance = new GeodesystemsCom443.TypeOpendaplinkApi();
let opts = {
...
apiInstance.searchOpendaplink(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
