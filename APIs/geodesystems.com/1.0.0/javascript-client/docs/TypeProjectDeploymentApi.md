# GeodesystemsCom443.TypeProjectDeploymentApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchProjectDeployment**](TypeProjectDeploymentApi.md#searchProjectDeployment) | **GET** /repository/search/type/project_deployment | Search API for &#39;Deployment&#39; entry type



## searchProjectDeployment

> searchProjectDeployment(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectDeploymentApi();
let opts = {
...
apiInstance.searchProjectDeployment(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
