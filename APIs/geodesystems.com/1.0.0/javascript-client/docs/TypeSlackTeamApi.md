# GeodesystemsCom443.TypeSlackTeamApi
...
let apiInstance = new GeodesystemsCom443.TypeSlackTeamApi();
let opts = {
...
apiInstance.searchSlackTeam(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
