# GeodesystemsCom443.TypeTypeSocrataSeriesApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeSocrataSeriesApi();
let opts = {
...
apiInstance.searchTypeSocrataSeries(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
