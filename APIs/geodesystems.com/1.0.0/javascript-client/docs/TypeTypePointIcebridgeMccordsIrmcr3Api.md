# GeodesystemsCom443.TypeTypePointIcebridgeMccordsIrmcr3Api
...
> searchTypePointIcebridgeMccordsIrmcr3(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointIcebridgeMccordsIrmcr3Api();
let opts = {
...
apiInstance.searchTypePointIcebridgeMccordsIrmcr3(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
