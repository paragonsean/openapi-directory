# GeodesystemsCom443.TypeTypePointOpenaqApi
...
let apiInstance = new GeodesystemsCom443.TypeTypePointOpenaqApi();
let opts = {
  ...
  'searchTypePointOpenaqLocation': "searchTypePointOpenaqLocation_example", // String | Location
  'searchTypePointOpenaqCountry': "searchTypePointOpenaqCountry_example", // String | Country
  'searchTypePointOpenaqCity': "searchTypePointOpenaqCity_example", // String | City
  'searchTypePointOpenaqHoursOffset': 56 // Number | Offset Hours
};
apiInstance.searchTypePointOpenaq(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchTypePointOpenaqHoursOffset** | **Number**| Offset Hours | [optional] 
