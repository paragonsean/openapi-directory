# GeodesystemsCom443.TypeTypeGtfsRoutesApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeGtfsRoutesApi();
let opts = {
...
apiInstance.searchTypeGtfsRoutes(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
