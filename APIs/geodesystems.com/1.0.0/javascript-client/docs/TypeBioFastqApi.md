# GeodesystemsCom443.TypeBioFastqApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchBioFastq**](TypeBioFastqApi.md#searchBioFastq) | **GET** /repository/search/type/bio_fastq | Search API for &#39;FASTQ File&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeBioFastqApi();
let opts = {
...
apiInstance.searchBioFastq(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
