# GeodesystemsCom443.TypeTypeDaymetApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeDaymetApi();
let opts = {
...
apiInstance.searchTypeDaymet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
