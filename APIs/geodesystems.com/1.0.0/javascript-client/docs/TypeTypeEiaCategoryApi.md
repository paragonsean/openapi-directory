# GeodesystemsCom443.TypeTypeEiaCategoryApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeEiaCategoryApi();
let opts = {
...
apiInstance.searchTypeEiaCategory(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
