# GeodesystemsCom443.TypeTypeEsriRestserverApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeEsriRestserver**](TypeTypeEsriRestserverApi.md#searchTypeEsriRestserver) | **GET** /repository/search/type/type_esri_restserver | Search API for &#39;ESRI Web Server&#39; entry type



## searchTypeEsriRestserver

> searchTypeEsriRestserver(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeEsriRestserverApi();
let opts = {
...
apiInstance.searchTypeEsriRestserver(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
