# GeodesystemsCom443.TypeBioDicomTestApi
...
let apiInstance = new GeodesystemsCom443.TypeBioDicomTestApi();
let opts = {
  ...
  'searchBioDicomTestPatientName': "searchBioDicomTestPatientName_example", // String | Patient Name
  'searchBioDicomTestPatientID': "searchBioDicomTestPatientID_example" // String | Patient ID
};
apiInstance.searchBioDicomTest(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
