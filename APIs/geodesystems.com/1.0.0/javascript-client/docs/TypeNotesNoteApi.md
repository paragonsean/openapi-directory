# GeodesystemsCom443.TypeNotesNoteApi
...
let apiInstance = new GeodesystemsCom443.TypeNotesNoteApi();
let opts = {
...
apiInstance.searchNotesNote(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
