# GeodesystemsCom443.TypeTypeDocumentPdfApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeDocumentPdfApi();
let opts = {
...
apiInstance.searchTypeDocumentPdf(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
