# GeodesystemsCom443.TypePointTextApi
...
let apiInstance = new GeodesystemsCom443.TypePointTextApi();
let opts = {
...
apiInstance.searchPointText(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
