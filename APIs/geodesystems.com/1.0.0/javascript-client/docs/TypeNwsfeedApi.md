# GeodesystemsCom443.TypeNwsfeedApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchNwsfeed**](TypeNwsfeedApi.md#searchNwsfeed) | **GET** /repository/search/type/nwsfeed | Search API for &#39;NWS Forecast Feed&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeNwsfeedApi();
let opts = {
...
apiInstance.searchNwsfeed(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
