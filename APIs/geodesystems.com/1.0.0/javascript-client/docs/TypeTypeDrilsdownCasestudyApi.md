# GeodesystemsCom443.TypeTypeDrilsdownCasestudyApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeDrilsdownCasestudy**](TypeTypeDrilsdownCasestudyApi.md#searchTypeDrilsdownCasestudy) | **GET** /repository/search/type/type_drilsdown_casestudy | Search API for &#39;Drilsdown Case Study&#39; entry type



## searchTypeDrilsdownCasestudy

> searchTypeDrilsdownCasestudy(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeDrilsdownCasestudyApi();
let opts = {
...
apiInstance.searchTypeDrilsdownCasestudy(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
