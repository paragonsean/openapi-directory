# GeodesystemsCom443.TypeGazeteerCensusTractsApi
...
> searchGazeteerCensusTracts(opts)
...
let apiInstance = new GeodesystemsCom443.TypeGazeteerCensusTractsApi();
let opts = {
  ...
  'searchDbGazeteerCensusTractsState': "searchDbGazeteerCensusTractsState_example", // String | State
  'searchDbGazeteerCensusTractsStateFips': "searchDbGazeteerCensusTractsStateFips_example", // String | State Fips
  'searchDbGazeteerCensusTractsCountyName': "searchDbGazeteerCensusTractsCountyName_example", // String | County Name
  'searchDbGazeteerCensusTractsCountyFips': "searchDbGazeteerCensusTractsCountyFips_example", // String | County Fips
  'searchDbGazeteerCensusTractsCensusTractId': "searchDbGazeteerCensusTractsCensusTractId_example", // String | Census Tract Id
  'searchDbGazeteerCensusTractsFullCensusTractId': "searchDbGazeteerCensusTractsFullCensusTractId_example", // String | Full Census Tract Id
  'searchDbGazeteerCensusTractsLandArea': 3.4, // Number | Land Area
  'searchDbGazeteerCensusTractsWaterArea': 3.4, // Number | Water Area
  'searchDbGazeteerCensusTractsLocation': "searchDbGazeteerCensusTractsLocation_example" // String | Location
};
apiInstance.searchGazeteerCensusTracts(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchDbGazeteerCensusTractsLandArea** | **Number**| Land Area | [optional] 
 **searchDbGazeteerCensusTractsWaterArea** | **Number**| Water Area | [optional] 
