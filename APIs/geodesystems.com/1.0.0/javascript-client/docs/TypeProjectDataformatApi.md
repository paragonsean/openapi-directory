# GeodesystemsCom443.TypeProjectDataformatApi
...
let apiInstance = new GeodesystemsCom443.TypeProjectDataformatApi();
let opts = {
  ...
  'searchProjectDataformatDataType': "searchProjectDataformatDataType_example", // String | Data Type
  'searchProjectDataformatField': "searchProjectDataformatField_example" // String | Field
};
apiInstance.searchProjectDataformat(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
