# GeodesystemsCom443.TypePythonNotebookApi
...
let apiInstance = new GeodesystemsCom443.TypePythonNotebookApi();
let opts = {
...
apiInstance.searchPythonNotebook(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
