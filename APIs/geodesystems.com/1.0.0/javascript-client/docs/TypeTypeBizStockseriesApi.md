# GeodesystemsCom443.TypeTypeBizStockseriesApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeBizStockseries**](TypeTypeBizStockseriesApi.md#searchTypeBizStockseries) | **GET** /repository/search/type/type_biz_stockseries | Search API for &#39;Stock Ticker Data&#39; entry type



## searchTypeBizStockseries

> searchTypeBizStockseries(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeBizStockseriesApi();
let opts = {
...
apiInstance.searchTypeBizStockseries(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
