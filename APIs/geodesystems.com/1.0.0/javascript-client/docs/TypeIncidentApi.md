# GeodesystemsCom443.TypeIncidentApi
...
let apiInstance = new GeodesystemsCom443.TypeIncidentApi();
let opts = {
  ...
  'searchIncidentIncidenttype': "searchIncidentIncidenttype_example", // String | Incident Type
  'searchIncidentCause': "searchIncidentCause_example", // String | Cause
  'searchIncidentState': "searchIncidentState_example" // String | State
};
apiInstance.searchIncident(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
