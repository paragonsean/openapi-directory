# GeodesystemsCom443.TypeTypeUsgsGaugeApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeUsgsGaugeApi();
let opts = {
...
apiInstance.searchTypeUsgsGauge(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
