# GeodesystemsCom443.TypeProjectVocabularyApi
...
let apiInstance = new GeodesystemsCom443.TypeProjectVocabularyApi();
let opts = {
...
apiInstance.searchProjectVocabulary(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
