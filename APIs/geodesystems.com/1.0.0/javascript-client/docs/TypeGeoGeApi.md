# GeodesystemsCom443.TypeGeoGeApi
...
let apiInstance = new GeodesystemsCom443.TypeGeoGeApi();
let opts = {
...
apiInstance.searchGeoGeojson(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
