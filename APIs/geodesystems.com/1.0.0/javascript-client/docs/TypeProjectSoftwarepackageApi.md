# GeodesystemsCom443.TypeProjectSoftwarepackageApi
...
> searchProjectSoftwarepackage(opts)
...
let apiInstance = new GeodesystemsCom443.TypeProjectSoftwarepackageApi();
let opts = {
  ...
  'searchProjectSoftwarepackageSoftwareUse': "searchProjectSoftwarepackageSoftwareUse_example", // String | Software Use
  'searchProjectSoftwarepackageSoftwareType': "searchProjectSoftwarepackageSoftwareType_example", // String | Software Type
  'searchProjectSoftwarepackageDomain': "searchProjectSoftwarepackageDomain_example", // String | Science Domain
  'searchProjectSoftwarepackagePlatform': "searchProjectSoftwarepackagePlatform_example", // String | Platform
  'searchProjectSoftwarepackageLicense': "searchProjectSoftwarepackageLicense_example", // String | License
  'searchProjectSoftwarepackageStatus': "searchProjectSoftwarepackageStatus_example", // String | Development Status
  'searchProjectSoftwarepackageCapabilities': "searchProjectSoftwarepackageCapabilities_example" // String | Capabilities
};
apiInstance.searchProjectSoftwarepackage(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
