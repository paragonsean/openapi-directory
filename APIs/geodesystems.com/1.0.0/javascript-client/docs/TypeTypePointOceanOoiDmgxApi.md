# GeodesystemsCom443.TypeTypePointOceanOoiDmgxApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypePointOceanOoiDmgx**](TypeTypePointOceanOoiDmgxApi.md#searchTypePointOceanOoiDmgx) | **GET** /repository/search/type/type_point_ocean_ooi_dmgx | Search API for &#39;OOI Data&#39; entry type



## searchTypePointOceanOoiDmgx

> searchTypePointOceanOoiDmgx(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointOceanOoiDmgxApi();
let opts = {
...
apiInstance.searchTypePointOceanOoiDmgx(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
