# GeodesystemsCom443.TypeFtpApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchFtp**](TypeFtpApi.md#searchFtp) | **GET** /repository/search/type/ftp | Search API for &#39;Remote FTP File View&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeFtpApi();
let opts = {
...
apiInstance.searchFtp(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
