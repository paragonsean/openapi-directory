# GeodesystemsCom443.TypeTypeEiaSeriesApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeEiaSeries**](TypeTypeEiaSeriesApi.md#searchTypeEiaSeries) | **GET** /repository/search/type/type_eia_series | Search API for &#39;EIA Series&#39; entry type



## searchTypeEiaSeries

> searchTypeEiaSeries(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeEiaSeriesApi();
let opts = {
...
apiInstance.searchTypeEiaSeries(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
