# GeodesystemsCom443.TypeBioOntologyStudyApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchBioOntologyStudy**](TypeBioOntologyStudyApi.md#searchBioOntologyStudy) | **GET** /repository/search/type/bio_ontology_study | Search API for &#39;Study&#39; entry type



## searchBioOntologyStudy

> searchBioOntologyStudy(opts)
...
let apiInstance = new GeodesystemsCom443.TypeBioOntologyStudyApi();
let opts = {
...
apiInstance.searchBioOntologyStudy(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
