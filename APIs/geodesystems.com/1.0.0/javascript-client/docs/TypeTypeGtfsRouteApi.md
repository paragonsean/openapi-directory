# GeodesystemsCom443.TypeTypeGtfsRouteApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeGtfsRouteApi();
let opts = {
  ...
  'searchTypeGtfsRouteRouteId': "searchTypeGtfsRouteRouteId_example", // String | Route ID
  'searchTypeGtfsRouteStopNames': "searchTypeGtfsRouteStopNames_example" // String | Stop Names
};
apiInstance.searchTypeGtfsRoute(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
