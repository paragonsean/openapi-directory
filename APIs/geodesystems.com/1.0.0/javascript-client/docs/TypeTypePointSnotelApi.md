# GeodesystemsCom443.TypeTypePointSnotelApi
...
let apiInstance = new GeodesystemsCom443.TypeTypePointSnotelApi();
let opts = {
  ...
  'searchTypePointSnotelSiteId': "searchTypePointSnotelSiteId_example", // String | Site ID
  'searchTypePointSnotelSiteNumber': "searchTypePointSnotelSiteNumber_example", // String | Site Number
  'searchTypePointSnotelState': "searchTypePointSnotelState_example", // String | State
  'searchTypePointSnotelNetwork': "searchTypePointSnotelNetwork_example", // String | Network
  'searchTypePointSnotelHucName': "searchTypePointSnotelHucName_example", // String | HUC Name
  'searchTypePointSnotelHucId': "searchTypePointSnotelHucId_example" // String | HUC ID
};
apiInstance.searchTypePointSnotel(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
