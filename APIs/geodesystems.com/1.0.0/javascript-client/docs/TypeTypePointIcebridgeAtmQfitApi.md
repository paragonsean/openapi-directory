# GeodesystemsCom443.TypeTypePointIcebridgeAtmQfitApi
...
> searchTypePointIcebridgeAtmQfit(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointIcebridgeAtmQfitApi();
let opts = {
...
apiInstance.searchTypePointIcebridgeAtmQfit(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
