# GeodesystemsCom443.TypeTypePointOceanNetcdfTrackApi
...
> searchTypePointOceanNetcdfTrack(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointOceanNetcdfTrackApi();
let opts = {
...
apiInstance.searchTypePointOceanNetcdfTrack(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
