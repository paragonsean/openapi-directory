# GeodesystemsCom443.TypeTypePointAmrcFreewaveApi
...
> searchTypePointAmrcFreewave(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointAmrcFreewaveApi();
let opts = {
  ...
  'searchTypePointAmrcFreewaveStationName': "searchTypePointAmrcFreewaveStationName_example", // String | Station Name
  'searchTypePointAmrcFreewaveFormat': "searchTypePointAmrcFreewaveFormat_example", // String | File Format
  'searchTypePointAmrcFreewaveDataloggerModel': "searchTypePointAmrcFreewaveDataloggerModel_example", // String | Data Logger Model
  'searchTypePointAmrcFreewaveDataloggerSerial': "searchTypePointAmrcFreewaveDataloggerSerial_example" // String | Data Logger Serial
};
apiInstance.searchTypePointAmrcFreewave(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
