# GeodesystemsCom443.TypeTypePointHydroWatermlApi
...
> searchTypePointHydroWaterml(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointHydroWatermlApi();
let opts = {
  ...
  'searchTypePointHydroWatermlSiteCode': "searchTypePointHydroWatermlSiteCode_example", // String | Site Code
  'searchTypePointHydroWatermlSiteName': "searchTypePointHydroWatermlSiteName_example" // String | Site Name
};
apiInstance.searchTypePointHydroWaterml(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
