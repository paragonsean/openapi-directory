# GeodesystemsCom443.TypeTypePointNcdcClimateApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypePointNcdcClimate**](TypeTypePointNcdcClimateApi.md#searchTypePointNcdcClimate) | **GET** /repository/search/type/type_point_ncdc_climate | Search API for &#39;NC  DC Climate Data&#39; entry type



## searchTypePointNcdcClimate

> searchTypePointNcdcClimate(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypePointNcdcClimateApi();
let opts = {
...
apiInstance.searchTypePointNcdcClimate(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
