# GeodesystemsCom443.TypeTypeDocumentXlsApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeDocumentXlsApi();
let opts = {
...
apiInstance.searchTypeDocumentXls(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
