# GeodesystemsCom443.TypeBioDicomApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchBioDicom**](TypeBioDicomApi.md#searchBioDicom) | **GET** /repository/search/type/bio_dicom | Search API for &#39;DICOM File&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeBioDicomApi();
let opts = {
...
apiInstance.searchBioDicom(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
