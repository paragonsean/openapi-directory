# GeodesystemsCom443.TypeTypeSoundingCodApi
...
let apiInstance = new GeodesystemsCom443.TypeTypeSoundingCodApi();
let opts = {
...
apiInstance.searchTypeSoundingCod(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
