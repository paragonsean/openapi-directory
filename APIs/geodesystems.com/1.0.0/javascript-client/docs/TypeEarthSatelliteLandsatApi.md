# GeodesystemsCom443.TypeEarthSatelliteLandsatApi
...
> searchEarthSatelliteLandsat(opts)
...
let apiInstance = new GeodesystemsCom443.TypeEarthSatelliteLandsatApi();
let opts = {
  ...
  'searchEarthSatelliteLandsatSensor': "searchEarthSatelliteLandsatSensor_example", // String | Sensor
  'searchEarthSatelliteLandsatSatellite': "searchEarthSatelliteLandsatSatellite_example", // String | Satellite
  'searchEarthSatelliteLandsatWrsPathNumber': 56, // Number | WRS Path
  'searchEarthSatelliteLandsatWrsRowNumber': 56, // Number | WRS Row
  'searchEarthSatelliteLandsatGroundStation': "searchEarthSatelliteLandsatGroundStation_example", // String | Ground Station
  'searchEarthSatelliteLandsatArchiveVersionNumber': 56 // Number | Archive Version Number
};
apiInstance.searchEarthSatelliteLandsat(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **searchEarthSatelliteLandsatWrsPathNumber** | **Number**| WRS Path | [optional] 
 **searchEarthSatelliteLandsatWrsRowNumber** | **Number**| WRS Row | [optional] 
 **searchEarthSatelliteLandsatGroundStation** | **String**| Ground Station | [optional] 
 **searchEarthSatelliteLandsatArchiveVersionNumber** | **Number**| Archive Version Number | [optional] 
