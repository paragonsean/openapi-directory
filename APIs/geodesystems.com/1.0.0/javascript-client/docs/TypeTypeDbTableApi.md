# GeodesystemsCom443.TypeTypeDbTableApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchTypeDbTable**](TypeTypeDbTableApi.md#searchTypeDbTable) | **GET** /repository/search/type/type_db_table | Search API for &#39;Database Table&#39; entry type



## searchTypeDbTable

> searchTypeDbTable(opts)
...
let apiInstance = new GeodesystemsCom443.TypeTypeDbTableApi();
let opts = {
...
apiInstance.searchTypeDbTable(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
