# GeodesystemsCom443.TypeLinkApi

All URIs are relative to *https://geodesystems.com:443*

Method | HTTP request | Description
------------- | ------------- | -------------
[**searchLink**](TypeLinkApi.md#searchLink) | **GET** /repository/search/type/link | Search API for &#39;Link&#39; entry type
...
let apiInstance = new GeodesystemsCom443.TypeLinkApi();
let opts = {
...
apiInstance.searchLink(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
