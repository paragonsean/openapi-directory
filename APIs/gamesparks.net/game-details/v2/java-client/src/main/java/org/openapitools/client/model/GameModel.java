...
public class GameModel {
  ...
  public GameModel atId(String atId) {
    this.atId = atId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atId, gameModel.atId) &&
        Objects.equals(this.name, gameModel.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atId, name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GameModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GameModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GameModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GameModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
