...
public class ApiClient {
    ...
    private String basePath = "http://config2.gamesparks.net";
    ...
    public ApiClient() {
        ...
        authentications.put("accessToken", new ApiKeyAuth("header", "accessToken"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://config2.gamesparks.net
