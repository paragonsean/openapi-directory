...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://config2.gamesparks.net') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://config2.gamesparks.net
         */
        ...
        this.authentications = {
            'accessToken': {type: 'apiKey', 'in': 'header', name: 'accessToken'},
            'basic': {type: 'basic'},
            'jwt': {type: 'apiKey', 'in': 'header', name: 'jwt'}
        }
