...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackExchange.CreatedComment();
  });
  ...
  describe('CreatedComment', function() {
    it('should create an instance of CreatedComment', function() {
      // uncomment below and update the code to test CreatedComment
      //var instance = new StackExchange.CreatedComment();
      //expect(instance).to.be.a(StackExchange.CreatedComment);
    });
