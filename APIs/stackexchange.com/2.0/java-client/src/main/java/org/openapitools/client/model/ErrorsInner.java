...
public class ErrorsInner {
  ...
  public ErrorsInner errorId(Integer errorId) {
  ...
  public ErrorsInner errorName(String errorName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, errorsInner.description) &&
        Objects.equals(this.errorId, errorsInner.errorId) &&
        Objects.equals(this.errorName, errorsInner.errorName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, errorId, errorName);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ErrorsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ErrorsInner is not found in the empty JSON string", ErrorsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ErrorsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ErrorsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ErrorsInner>() {
           @Override
