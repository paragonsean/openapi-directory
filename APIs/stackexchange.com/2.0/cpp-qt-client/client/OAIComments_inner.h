...
#ifndef OAIComments_inner_H
#define OAIComments_inner_H
...
class OAIComments_inner : public OAIObject {
public:
    OAIComments_inner();
    OAIComments_inner(QString json);
    ~OAIComments_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComments_inner)

#endif // OAIComments_inner_H
