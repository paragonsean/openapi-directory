...
#ifndef OAIFilters_inner_H
#define OAIFilters_inner_H
...
class OAIFilters_inner : public OAIObject {
public:
    OAIFilters_inner();
    OAIFilters_inner(QString json);
    ~OAIFilters_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilters_inner)

#endif // OAIFilters_inner_H
