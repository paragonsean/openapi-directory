...
OAICreated_comment::OAICreated_comment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreated_comment::OAICreated_comment() {
    this->initializeModel();
}

OAICreated_comment::~OAICreated_comment() {}

void OAICreated_comment::initializeModel() {
...
void OAICreated_comment::fromJson(QString jsonString) {
...
void OAICreated_comment::fromJsonObject(QJsonObject json) {
...
QString OAICreated_comment::asJson() const {
...
QJsonObject OAICreated_comment::asJsonObject() const {
    QJsonObject obj;
    if (m_body_isSet) {
...
QString OAICreated_comment::getBody() const {
    return m_body;
}
void OAICreated_comment::setBody(const QString &body) {
    m_body = body;
    m_body_isSet = true;
}

bool OAICreated_comment::is_body_Set() const{
    return m_body_isSet;
}

bool OAICreated_comment::is_body_Valid() const{
    return m_body_isValid;
}

QString OAICreated_comment::getBodyMarkdown() const {
    return m_body_markdown;
}
void OAICreated_comment::setBodyMarkdown(const QString &body_markdown) {
    m_body_markdown = body_markdown;
    m_body_markdown_isSet = true;
}

bool OAICreated_comment::is_body_markdown_Set() const{
    return m_body_markdown_isSet;
}

bool OAICreated_comment::is_body_markdown_Valid() const{
    return m_body_markdown_isValid;
}

bool OAICreated_comment::isCanFlag() const {
    return m_can_flag;
}
void OAICreated_comment::setCanFlag(const bool &can_flag) {
    m_can_flag = can_flag;
    m_can_flag_isSet = true;
}

bool OAICreated_comment::is_can_flag_Set() const{
    return m_can_flag_isSet;
}

bool OAICreated_comment::is_can_flag_Valid() const{
    return m_can_flag_isValid;
}

qint32 OAICreated_comment::getCommentId() const {
    return m_comment_id;
}
void OAICreated_comment::setCommentId(const qint32 &comment_id) {
    m_comment_id = comment_id;
    m_comment_id_isSet = true;
}

bool OAICreated_comment::is_comment_id_Set() const{
    return m_comment_id_isSet;
}

bool OAICreated_comment::is_comment_id_Valid() const{
    return m_comment_id_isValid;
}

qint32 OAICreated_comment::getCreationDate() const {
    return m_creation_date;
}
void OAICreated_comment::setCreationDate(const qint32 &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAICreated_comment::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAICreated_comment::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

bool OAICreated_comment::isEdited() const {
    return m_edited;
}
void OAICreated_comment::setEdited(const bool &edited) {
    m_edited = edited;
    m_edited_isSet = true;
}

bool OAICreated_comment::is_edited_Set() const{
    return m_edited_isSet;
}

bool OAICreated_comment::is_edited_Valid() const{
    return m_edited_isValid;
}

QString OAICreated_comment::getLink() const {
    return m_link;
}
void OAICreated_comment::setLink(const QString &link) {
    m_link = link;
    m_link_isSet = true;
}

bool OAICreated_comment::is_link_Set() const{
    return m_link_isSet;
}

bool OAICreated_comment::is_link_Valid() const{
    return m_link_isValid;
}

OAIAnswers_inner_last_editor OAICreated_comment::getOwner() const {
    return m_owner;
}
void OAICreated_comment::setOwner(const OAIAnswers_inner_last_editor &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAICreated_comment::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAICreated_comment::is_owner_Valid() const{
    return m_owner_isValid;
}

qint32 OAICreated_comment::getPostId() const {
    return m_post_id;
}
void OAICreated_comment::setPostId(const qint32 &post_id) {
    m_post_id = post_id;
    m_post_id_isSet = true;
}

bool OAICreated_comment::is_post_id_Set() const{
    return m_post_id_isSet;
}

bool OAICreated_comment::is_post_id_Valid() const{
    return m_post_id_isValid;
}

QString OAICreated_comment::getPostType() const {
    return m_post_type;
}
void OAICreated_comment::setPostType(const QString &post_type) {
    m_post_type = post_type;
    m_post_type_isSet = true;
}

bool OAICreated_comment::is_post_type_Set() const{
    return m_post_type_isSet;
}

bool OAICreated_comment::is_post_type_Valid() const{
    return m_post_type_isValid;
}

OAIAnswers_inner_last_editor OAICreated_comment::getReplyToUser() const {
    return m_reply_to_user;
}
void OAICreated_comment::setReplyToUser(const OAIAnswers_inner_last_editor &reply_to_user) {
    m_reply_to_user = reply_to_user;
    m_reply_to_user_isSet = true;
}

bool OAICreated_comment::is_reply_to_user_Set() const{
    return m_reply_to_user_isSet;
}

bool OAICreated_comment::is_reply_to_user_Valid() const{
    return m_reply_to_user_isValid;
}

qint32 OAICreated_comment::getScore() const {
    return m_score;
}
void OAICreated_comment::setScore(const qint32 &score) {
    m_score = score;
    m_score_isSet = true;
}

bool OAICreated_comment::is_score_Set() const{
    return m_score_isSet;
}

bool OAICreated_comment::is_score_Valid() const{
    return m_score_isValid;
}

bool OAICreated_comment::isUpvoted() const {
    return m_upvoted;
}
void OAICreated_comment::setUpvoted(const bool &upvoted) {
    m_upvoted = upvoted;
    m_upvoted_isSet = true;
}

bool OAICreated_comment::is_upvoted_Set() const{
    return m_upvoted_isSet;
}

bool OAICreated_comment::is_upvoted_Valid() const{
    return m_upvoted_isValid;
}

bool OAICreated_comment::isSet() const {
...
bool OAICreated_comment::isValid() const {
