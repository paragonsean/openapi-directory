...
class NewInvoiceLineItem(Model):
    ...
    def __init__(self, description: str=None, discount: float=None, inventory_item_idfk: int=None, inventory_item_name: str=None, project_idfk: int=None, quantity: float=None, tax_idfk: int=None, tax_name: str=None, tax_percent: float=None, unit_price: float=None):
        """NewInvoiceLineItem - a model defined in OpenAPI

        :param description: The description of this NewInvoiceLineItem.
        :param discount: The discount of this NewInvoiceLineItem.
        :param inventory_item_idfk: The inventory_item_idfk of this NewInvoiceLineItem.
        :param inventory_item_name: The inventory_item_name of this NewInvoiceLineItem.
        :param project_idfk: The project_idfk of this NewInvoiceLineItem.
        :param quantity: The quantity of this NewInvoiceLineItem.
        :param tax_idfk: The tax_idfk of this NewInvoiceLineItem.
        :param tax_name: The tax_name of this NewInvoiceLineItem.
        :param tax_percent: The tax_percent of this NewInvoiceLineItem.
        :param unit_price: The unit_price of this NewInvoiceLineItem.
        """
        self.openapi_types = {
            'description': str,
            'discount': float,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'NewInvoiceLineItem':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The NewInvoiceLineItem of this NewInvoiceLineItem.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def description(self):
        """Gets the description of this NewInvoiceLineItem.

        Plain UTF8 text. (no HTML)

        :return: The description of this NewInvoiceLineItem.
        :rtype: str
        """
    ...
    @property
    def discount(self):
        """Gets the discount of this NewInvoiceLineItem.

        Enter 10.5 to give a 10.5% discount

        :return: The discount of this NewInvoiceLineItem.
        :rtype: float
        """
    ...
    def inventory_item_idfk(self):
        """Gets the inventory_item_idfk of this NewInvoiceLineItem.

        If not specified then Inventory Item Name must be specified.

        :return: The inventory_item_idfk of this NewInvoiceLineItem.
        :rtype: int
        """
    ...
    def inventory_item_name(self):
        """Gets the inventory_item_name of this NewInvoiceLineItem.
        ...
        :return: The inventory_item_name of this NewInvoiceLineItem.
        :rtype: str
        """
    ...
    def project_idfk(self):
        """Gets the project_idfk of this NewInvoiceLineItem.
        ...
        :return: The project_idfk of this NewInvoiceLineItem.
        :rtype: int
        """
    ...
    @property
    def quantity(self):
        """Gets the quantity of this NewInvoiceLineItem.

        The quantity for the line item

        :return: The quantity of this NewInvoiceLineItem.
        :rtype: float
        """
    ...
    @property
    def tax_name(self):
        """Gets the tax_name of this NewInvoiceLineItem.
        ...
        :return: The tax_name of this NewInvoiceLineItem.
        :rtype: str
        """
    ...
    def tax_percent(self):
        """Gets the tax_percent of this NewInvoiceLineItem.

        The Tax Percent will only be used if a new tax is being created.

        :return: The tax_percent of this NewInvoiceLineItem.
        :rtype: float
        """
    ...
    @property
    def unit_price(self):
        """Gets the unit_price of this NewInvoiceLineItem.

        The unit price for the lineitem.

        :return: The unit_price of this NewInvoiceLineItem.
        :rtype: float
        """
