...
async def inventory_get(request: web.Request, updated_after=None, page_size=None, page_number=None) -> web.Response:
...
async def inventory_get_by_id(request: web.Request, id) -> web.Response:
    """Gets InventoryItem by InventoryItem ID

    

    :param id: InventoryItem ID number
    :type id: int
