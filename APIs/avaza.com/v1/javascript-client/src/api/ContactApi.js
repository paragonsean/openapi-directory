...
export default class ContactApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the contactGetByID operation.
     * @callback module:api/ContactApi~contactGetByIDCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CompanyContact} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ContactApi~contactGetByIDCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CompanyContact}
     */
    contactGetByID(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling contactGetByID");
      }
    ...
    /**
     * Create a Contact
     * @param {module:model/NewCompanyContact} model 
     ...
     * data is of type: {@link module:model/CompanyContact}
     */
    contactPost(model, callback) {
      let postBody = model;
      // verify the required parameter 'model' is set
      if (model === undefined || model === null) {
        throw new Error("Missing the required parameter 'model' when calling contactPost");
      }
