    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Tasks')) {
                obj['Tasks'] = ApiClient.convertToType(data['Tasks'], [TaskDetails]);
            }
 ...
 */
TaskList.prototype['PageNumber'] = undefined;

/**
 * @member {Number} PageSize
 */
TaskList.prototype['PageSize'] = undefined;

/**
 * @member {Array.<module:model/TaskDetails>} Tasks
 */
TaskList.prototype['Tasks'] = undefined;

/**
 * @member {Number} TotalCount
 */
TaskList.prototype['TotalCount'] = undefined;
