...
class NewTag {
    ...
    /**
     * Validates the JSON data with respect to <code>NewTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewTag</code>.
     */
 ...
 * @member {String} Color
 */
NewTag.prototype['Color'] = undefined;

/**
 * @member {String} Name
 */
NewTag.prototype['Name'] = undefined;
