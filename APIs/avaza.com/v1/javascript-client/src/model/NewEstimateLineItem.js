...
/**
 * The NewEstimateLineItem model module.
 * @module model/NewEstimateLineItem
 * @version v1
 */
class NewEstimateLineItem {
    /**
     * Constructs a new <code>NewEstimateLineItem</code>.
     * Line item to be added to new Estimate
     * @alias module:model/NewEstimateLineItem
    ...
    constructor(quantity, unitPrice) { 
        ...
        NewEstimateLineItem.initialize(this, quantity, unitPrice);
    }
    ...
    /**
     * Constructs a <code>NewEstimateLineItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewEstimateLineItem} obj Optional instance to populate.
     * @return {module:model/NewEstimateLineItem} The populated <code>NewEstimateLineItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewEstimateLineItem();
    ...
    /**
     * Validates the JSON data with respect to <code>NewEstimateLineItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewEstimateLineItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewEstimateLineItem.RequiredProperties) {
...
NewEstimateLineItem.RequiredProperties = ["Quantity", "UnitPrice"];

/**
 * Plain UTF8 text. (no HTML)
 * @member {String} Description
 */
NewEstimateLineItem.prototype['Description'] = undefined;

/**
 * Enter 10.5 to give a 10.5% discount
 * @member {Number} Discount
 */
NewEstimateLineItem.prototype['Discount'] = undefined;

/**
 * If not specified then Inventory Item Name must be specified.
 * @member {Number} InventoryItemIDFK
 */
NewEstimateLineItem.prototype['InventoryItemIDFK'] = undefined;
 ...
 */
NewEstimateLineItem.prototype['InventoryItemName'] = undefined;

/**
 * The quantity for the line item
 * @member {Number} Quantity
 */
NewEstimateLineItem.prototype['Quantity'] = undefined;
 ...
 */
NewEstimateLineItem.prototype['TaxIDFK'] = undefined;
 ...
 */
NewEstimateLineItem.prototype['TaxName'] = undefined;

/**
 * The Tax Percent will only be used if a new tax is being created.
 * @member {Number} TaxPercent
 */
NewEstimateLineItem.prototype['TaxPercent'] = undefined;

/**
 * The unit price for the lineitem.
 * @member {Number} UnitPrice
 */
NewEstimateLineItem.prototype['UnitPrice'] = undefined;
...
export default NewEstimateLineItem;
