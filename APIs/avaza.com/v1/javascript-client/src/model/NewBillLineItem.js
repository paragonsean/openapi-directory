...
/**
 * The NewBillLineItem model module.
 * @module model/NewBillLineItem
 * @version v1
 */
class NewBillLineItem {
    /**
     * Constructs a new <code>NewBillLineItem</code>.
     * Line item to be added to new invoice
     * @alias module:model/NewBillLineItem
    ...
    constructor(quantity, unitPrice) { 
        ...
        NewBillLineItem.initialize(this, quantity, unitPrice);
    }
    ...
    /**
     * Constructs a <code>NewBillLineItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewBillLineItem} obj Optional instance to populate.
     * @return {module:model/NewBillLineItem} The populated <code>NewBillLineItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewBillLineItem();
    ...
    /**
     * Validates the JSON data with respect to <code>NewBillLineItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewBillLineItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewBillLineItem.RequiredProperties) {
...
NewBillLineItem.RequiredProperties = ["Quantity", "UnitPrice"];

/**
 * Plain UTF8 text. (no HTML)
 * @member {String} Description
 */
NewBillLineItem.prototype['Description'] = undefined;

/**
 * Enter 10.5 to give a 10.5% discount
 * @member {Number} Discount
 */
NewBillLineItem.prototype['Discount'] = undefined;

/**
 * If not specified then Inventory Item Name must be specified.
 * @member {Number} InventoryItemIDFK
 */
NewBillLineItem.prototype['InventoryItemIDFK'] = undefined;
 ...
 */
NewBillLineItem.prototype['InventoryItemName'] = undefined;
 ...
 */
NewBillLineItem.prototype['ProjectIDFK'] = undefined;

/**
 * The quantity for the line item
 * @member {Number} Quantity
 */
NewBillLineItem.prototype['Quantity'] = undefined;
 ...
 */
NewBillLineItem.prototype['TaxIDFK'] = undefined;
...
export default NewBillLineItem;
