...
class Currency {
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['Symbol2'] && !(typeof data['Symbol2'] === 'string' || data['Symbol2'] instanceof String)) {
            throw new Error("Expected the field `Symbol2` to be a primitive type in the JSON string but got " + data['Symbol2']);
        }
 ...
 */
Currency.prototype['DecimalPlaces'] = undefined;
 ...
 */
Currency.prototype['Symbol2'] = undefined;
