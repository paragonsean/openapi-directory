    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Projects')) {
                obj['Projects'] = ApiClient.convertToType(data['Projects'], [ProjectListDetails]);
            }
    ...
    static validateJSON(data) {
        if (data['Projects']) { // data not null
            ...
            for (const item of data['Projects']) {
                ProjectListDetails.validateJSON(item);
            };
        }
 ...
 */
ProjectList.prototype['PageNumber'] = undefined;

/**
 * @member {Number} PageSize
 */
ProjectList.prototype['PageSize'] = undefined;

/**
 * @member {Array.<module:model/ProjectListDetails>} Projects
 */
 ...
 */
ProjectList.prototype['TotalCount'] = undefined;
