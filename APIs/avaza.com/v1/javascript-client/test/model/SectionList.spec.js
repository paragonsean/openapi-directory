...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.SectionList();
  });
  ...
  describe('SectionList', function() {
    it('should create an instance of SectionList', function() {
      // uncomment below and update the code to test SectionList
      //var instance = new AvazaApiDocumentation.SectionList();
      //expect(instance).to.be.a(AvazaApiDocumentation.SectionList);
    });
