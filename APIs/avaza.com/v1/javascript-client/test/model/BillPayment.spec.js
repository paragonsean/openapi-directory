...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.BillPayment();
  });
  ...
  describe('BillPayment', function() {
    it('should create an instance of BillPayment', function() {
      // uncomment below and update the code to test BillPayment
      //var instance = new AvazaApiDocumentation.BillPayment();
      //expect(instance).to.be.a(AvazaApiDocumentation.BillPayment);
    });
    ...
    it('should have the property supplierIDFK (base name: "SupplierIDFK")', function() {
      // uncomment below and update the code to test the property supplierIDFK
      //var instance = new AvazaApiDocumentation.BillPayment();
      //expect(instance).to.be();
    });
