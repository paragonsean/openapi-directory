...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.ProjectList();
  });
  ...
  describe('ProjectList', function() {
    it('should create an instance of ProjectList', function() {
      ...
      //var instance = new AvazaApiDocumentation.ProjectList();
      //expect(instance).to.be.a(AvazaApiDocumentation.ProjectList);
    });
