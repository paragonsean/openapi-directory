...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.PaymentList();
  });
  ...
  describe('PaymentList', function() {
    it('should create an instance of PaymentList', function() {
      // uncomment below and update the code to test PaymentList
      //var instance = new AvazaApiDocumentation.PaymentList();
      //expect(instance).to.be.a(AvazaApiDocumentation.PaymentList);
    });
