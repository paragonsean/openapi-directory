...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.CreditNoteLineItem();
  });
  ...
  describe('CreditNoteLineItem', function() {
    it('should create an instance of CreditNoteLineItem', function() {
      // uncomment below and update the code to test CreditNoteLineItem
      //var instance = new AvazaApiDocumentation.CreditNoteLineItem();
      //expect(instance).to.be.a(AvazaApiDocumentation.CreditNoteLineItem);
    });
    ...
    it('should have the property transactionLineItemID (base name: "TransactionLineItemID")', function() {
      // uncomment below and update the code to test the property transactionLineItemID
      //var instance = new AvazaApiDocumentation.CreditNoteLineItem();
      //expect(instance).to.be();
    });
