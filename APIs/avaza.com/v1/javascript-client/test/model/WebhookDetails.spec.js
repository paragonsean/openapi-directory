...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.WebhookDetails();
  });
  ...
  describe('WebhookDetails', function() {
    it('should create an instance of WebhookDetails', function() {
      // uncomment below and update the code to test WebhookDetails
      //var instance = new AvazaApiDocumentation.WebhookDetails();
      //expect(instance).to.be.a(AvazaApiDocumentation.WebhookDetails);
    });
