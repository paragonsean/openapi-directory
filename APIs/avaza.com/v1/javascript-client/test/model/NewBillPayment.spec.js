...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.NewBillPayment();
  });
  ...
  describe('NewBillPayment', function() {
    it('should create an instance of NewBillPayment', function() {
      // uncomment below and update the code to test NewBillPayment
      //var instance = new AvazaApiDocumentation.NewBillPayment();
      //expect(instance).to.be.a(AvazaApiDocumentation.NewBillPayment);
    });
    ...
    it('should have the property paymentAllocations (base name: "PaymentAllocations")', function() {
      // uncomment below and update the code to test the property paymentAllocations
      //var instance = new AvazaApiDocumentation.NewBillPayment();
      //expect(instance).to.be();
    });
    ...
    it('should have the property paymentProviderCode (base name: "PaymentProviderCode")', function() {
      // uncomment below and update the code to test the property paymentProviderCode
      //var instance = new AvazaApiDocumentation.NewBillPayment();
      //expect(instance).to.be();
    });
