...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.NewBill();
  });
  ...
  describe('NewBill', function() {
    it('should create an instance of NewBill', function() {
      // uncomment below and update the code to test NewBill
      //var instance = new AvazaApiDocumentation.NewBill();
      //expect(instance).to.be.a(AvazaApiDocumentation.NewBill);
    });
    ...
    it('should have the property billTemplateIDFK (base name: "BillTemplateIDFK")', function() {
      // uncomment below and update the code to test the property billTemplateIDFK
      //var instance = new AvazaApiDocumentation.NewBill();
      //expect(instance).to.be();
    });
