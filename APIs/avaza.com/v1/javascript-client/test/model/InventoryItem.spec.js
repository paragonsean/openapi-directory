...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.InventoryItem();
  });
  ...
  describe('InventoryItem', function() {
    it('should create an instance of InventoryItem', function() {
      ...
      //var instance = new AvazaApiDocumentation.InventoryItem();
      //expect(instance).to.be.a(AvazaApiDocumentation.InventoryItem);
    });
    ...
    it('should have the property inventoryItemID (base name: "InventoryItemID")', function() {
      // uncomment below and update the code to test the property inventoryItemID
      //var instance = new AvazaApiDocumentation.InventoryItem();
      //expect(instance).to.be();
    });
    ...
    it('should have the property saleTaxIDFK (base name: "SaleTaxIDFK")', function() {
      // uncomment below and update the code to test the property saleTaxIDFK
      //var instance = new AvazaApiDocumentation.InventoryItem();
      //expect(instance).to.be();
    });
