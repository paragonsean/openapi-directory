...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.BillLinks();
  });
  ...
  describe('BillLinks', function() {
    it('should create an instance of BillLinks', function() {
      // uncomment below and update the code to test BillLinks
      //var instance = new AvazaApiDocumentation.BillLinks();
      //expect(instance).to.be.a(AvazaApiDocumentation.BillLinks);
    });
