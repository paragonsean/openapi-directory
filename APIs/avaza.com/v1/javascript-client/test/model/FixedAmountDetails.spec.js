...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.FixedAmountDetails();
  });
  ...
  describe('FixedAmountDetails', function() {
    it('should create an instance of FixedAmountDetails', function() {
      // uncomment below and update the code to test FixedAmountDetails
      //var instance = new AvazaApiDocumentation.FixedAmountDetails();
      //expect(instance).to.be.a(AvazaApiDocumentation.FixedAmountDetails);
    });
    ...
    it('should have the property fixedAmountID (base name: "FixedAmountID")', function() {
      // uncomment below and update the code to test the property fixedAmountID
      //var instance = new AvazaApiDocumentation.FixedAmountDetails();
      //expect(instance).to.be();
    });
