...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.ContactList();
  });
  ...
  describe('ContactList', function() {
    it('should create an instance of ContactList', function() {
      ...
      //var instance = new AvazaApiDocumentation.ContactList();
      //expect(instance).to.be.a(AvazaApiDocumentation.ContactList);
    });
