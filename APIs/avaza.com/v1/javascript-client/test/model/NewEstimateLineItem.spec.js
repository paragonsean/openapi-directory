...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.NewEstimateLineItem();
  });
  ...
  describe('NewEstimateLineItem', function() {
    it('should create an instance of NewEstimateLineItem', function() {
      // uncomment below and update the code to test NewEstimateLineItem
      //var instance = new AvazaApiDocumentation.NewEstimateLineItem();
      //expect(instance).to.be.a(AvazaApiDocumentation.NewEstimateLineItem);
    });
