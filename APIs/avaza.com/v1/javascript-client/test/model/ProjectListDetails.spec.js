...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.ProjectListDetails();
  });
  ...
  describe('ProjectListDetails', function() {
    it('should create an instance of ProjectListDetails', function() {
      // uncomment below and update the code to test ProjectListDetails
      //var instance = new AvazaApiDocumentation.ProjectListDetails();
      //expect(instance).to.be.a(AvazaApiDocumentation.ProjectListDetails);
    });
