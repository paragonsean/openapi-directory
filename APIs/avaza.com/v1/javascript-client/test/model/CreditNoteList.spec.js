...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.CreditNoteList();
  });
  ...
  describe('CreditNoteList', function() {
    it('should create an instance of CreditNoteList', function() {
      // uncomment below and update the code to test CreditNoteList
      //var instance = new AvazaApiDocumentation.CreditNoteList();
      //expect(instance).to.be.a(AvazaApiDocumentation.CreditNoteList);
    });
