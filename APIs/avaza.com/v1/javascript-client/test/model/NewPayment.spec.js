...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.NewPayment();
  });
  ...
  describe('NewPayment', function() {
    it('should create an instance of NewPayment', function() {
      // uncomment below and update the code to test NewPayment
      //var instance = new AvazaApiDocumentation.NewPayment();
      //expect(instance).to.be.a(AvazaApiDocumentation.NewPayment);
    });
