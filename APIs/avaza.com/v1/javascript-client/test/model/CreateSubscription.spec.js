...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.CreateSubscription();
  });
  ...
  describe('CreateSubscription', function() {
    it('should create an instance of CreateSubscription', function() {
      // uncomment below and update the code to test CreateSubscription
      //var instance = new AvazaApiDocumentation.CreateSubscription();
      //expect(instance).to.be.a(AvazaApiDocumentation.CreateSubscription);
    });
