...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.NewTimesheet();
  });
  ...
  describe('NewTimesheet', function() {
    it('should create an instance of NewTimesheet', function() {
      // uncomment below and update the code to test NewTimesheet
      //var instance = new AvazaApiDocumentation.NewTimesheet();
      //expect(instance).to.be.a(AvazaApiDocumentation.NewTimesheet);
    });
