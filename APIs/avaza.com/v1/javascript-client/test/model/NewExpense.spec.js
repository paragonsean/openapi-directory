...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.NewExpense();
  });
  ...
  describe('NewExpense', function() {
    it('should create an instance of NewExpense', function() {
      // uncomment below and update the code to test NewExpense
      //var instance = new AvazaApiDocumentation.NewExpense();
      //expect(instance).to.be.a(AvazaApiDocumentation.NewExpense);
    });
