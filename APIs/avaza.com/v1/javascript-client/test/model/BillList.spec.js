...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.BillList();
  });
  ...
  describe('BillList', function() {
    it('should create an instance of BillList', function() {
      // uncomment below and update the code to test BillList
      //var instance = new AvazaApiDocumentation.BillList();
      //expect(instance).to.be.a(AvazaApiDocumentation.BillList);
    });
