...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.CurrencyList();
  });
  ...
  describe('CurrencyList', function() {
    it('should create an instance of CurrencyList', function() {
      ...
      //var instance = new AvazaApiDocumentation.CurrencyList();
      //expect(instance).to.be.a(AvazaApiDocumentation.CurrencyList);
    });
