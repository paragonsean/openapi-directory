...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.TimesheetDetails();
  });
  ...
  describe('TimesheetDetails', function() {
    it('should create an instance of TimesheetDetails', function() {
      // uncomment below and update the code to test TimesheetDetails
      //var instance = new AvazaApiDocumentation.TimesheetDetails();
      //expect(instance).to.be.a(AvazaApiDocumentation.TimesheetDetails);
    });
