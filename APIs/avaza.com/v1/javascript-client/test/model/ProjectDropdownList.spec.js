...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.ProjectDropdownList();
  });
  ...
  describe('ProjectDropdownList', function() {
    it('should create an instance of ProjectDropdownList', function() {
      // uncomment below and update the code to test ProjectDropdownList
      //var instance = new AvazaApiDocumentation.ProjectDropdownList();
      //expect(instance).to.be.a(AvazaApiDocumentation.ProjectDropdownList);
    });
