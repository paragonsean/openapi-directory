...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.BillPaymentList();
  });
  ...
  describe('BillPaymentList', function() {
    it('should create an instance of BillPaymentList', function() {
      // uncomment below and update the code to test BillPaymentList
      //var instance = new AvazaApiDocumentation.BillPaymentList();
      //expect(instance).to.be.a(AvazaApiDocumentation.BillPaymentList);
    });
