...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.Currency();
  });
  ...
  describe('Currency', function() {
    it('should create an instance of Currency', function() {
      ...
      //var instance = new AvazaApiDocumentation.Currency();
      //expect(instance).to.be.a(AvazaApiDocumentation.Currency);
    });
    ...
    it('should have the property symbol2 (base name: "Symbol2")', function() {
      // uncomment below and update the code to test the property symbol2
      //var instance = new AvazaApiDocumentation.Currency();
      //expect(instance).to.be();
    });
