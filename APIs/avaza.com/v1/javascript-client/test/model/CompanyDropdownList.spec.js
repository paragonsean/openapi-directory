...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.CompanyDropdownList();
  });
  ...
  describe('CompanyDropdownList', function() {
    it('should create an instance of CompanyDropdownList', function() {
      // uncomment below and update the code to test CompanyDropdownList
      //var instance = new AvazaApiDocumentation.CompanyDropdownList();
      //expect(instance).to.be.a(AvazaApiDocumentation.CompanyDropdownList);
    });
