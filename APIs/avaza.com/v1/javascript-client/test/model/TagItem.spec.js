...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.TagItem();
  });
  ...
  describe('TagItem', function() {
    it('should create an instance of TagItem', function() {
      // uncomment below and update the code to test TagItem
      //var instance = new AvazaApiDocumentation.TagItem();
      //expect(instance).to.be.a(AvazaApiDocumentation.TagItem);
    });
