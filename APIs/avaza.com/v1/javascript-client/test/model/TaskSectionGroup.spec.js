...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.TaskSectionGroup();
  });
  ...
  describe('TaskSectionGroup', function() {
    it('should create an instance of TaskSectionGroup', function() {
      // uncomment below and update the code to test TaskSectionGroup
      //var instance = new AvazaApiDocumentation.TaskSectionGroup();
      //expect(instance).to.be.a(AvazaApiDocumentation.TaskSectionGroup);
    });
