...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.ProjectCompanyGroup();
  });
  ...
  describe('ProjectCompanyGroup', function() {
    it('should create an instance of ProjectCompanyGroup', function() {
      // uncomment below and update the code to test ProjectCompanyGroup
      //var instance = new AvazaApiDocumentation.ProjectCompanyGroup();
      //expect(instance).to.be.a(AvazaApiDocumentation.ProjectCompanyGroup);
    });
