...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.NewInvoice();
  });
  ...
  describe('NewInvoice', function() {
    it('should create an instance of NewInvoice', function() {
      // uncomment below and update the code to test NewInvoice
      //var instance = new AvazaApiDocumentation.NewInvoice();
      //expect(instance).to.be.a(AvazaApiDocumentation.NewInvoice);
    });
