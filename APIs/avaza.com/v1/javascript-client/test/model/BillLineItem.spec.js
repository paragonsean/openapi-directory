...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.BillLineItem();
  });
  ...
  describe('BillLineItem', function() {
    it('should create an instance of BillLineItem', function() {
      // uncomment below and update the code to test BillLineItem
      //var instance = new AvazaApiDocumentation.BillLineItem();
      //expect(instance).to.be.a(AvazaApiDocumentation.BillLineItem);
    });
