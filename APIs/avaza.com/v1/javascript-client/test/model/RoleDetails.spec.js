...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.RoleDetails();
  });
  ...
  describe('RoleDetails', function() {
    it('should create an instance of RoleDetails', function() {
      // uncomment below and update the code to test RoleDetails
      //var instance = new AvazaApiDocumentation.RoleDetails();
      //expect(instance).to.be.a(AvazaApiDocumentation.RoleDetails);
    });
