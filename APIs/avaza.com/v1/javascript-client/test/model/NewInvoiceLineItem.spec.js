...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.NewInvoiceLineItem();
  });
  ...
  describe('NewInvoiceLineItem', function() {
    it('should create an instance of NewInvoiceLineItem', function() {
      // uncomment below and update the code to test NewInvoiceLineItem
      //var instance = new AvazaApiDocumentation.NewInvoiceLineItem();
      //expect(instance).to.be.a(AvazaApiDocumentation.NewInvoiceLineItem);
    });
