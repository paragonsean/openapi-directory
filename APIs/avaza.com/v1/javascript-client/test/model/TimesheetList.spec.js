...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.TimesheetList();
  });
  ...
  describe('TimesheetList', function() {
    it('should create an instance of TimesheetList', function() {
      // uncomment below and update the code to test TimesheetList
      //var instance = new AvazaApiDocumentation.TimesheetList();
      //expect(instance).to.be.a(AvazaApiDocumentation.TimesheetList);
    });
