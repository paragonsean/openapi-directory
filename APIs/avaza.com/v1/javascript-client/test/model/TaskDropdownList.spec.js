...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.TaskDropdownList();
  });
  ...
  describe('TaskDropdownList', function() {
    it('should create an instance of TaskDropdownList', function() {
      // uncomment below and update the code to test TaskDropdownList
      //var instance = new AvazaApiDocumentation.TaskDropdownList();
      //expect(instance).to.be.a(AvazaApiDocumentation.TaskDropdownList);
    });
