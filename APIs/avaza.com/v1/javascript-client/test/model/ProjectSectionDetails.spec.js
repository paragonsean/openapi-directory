...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.ProjectSectionDetails();
  });
  ...
  describe('ProjectSectionDetails', function() {
    it('should create an instance of ProjectSectionDetails', function() {
      // uncomment below and update the code to test ProjectSectionDetails
      //var instance = new AvazaApiDocumentation.ProjectSectionDetails();
      //expect(instance).to.be.a(AvazaApiDocumentation.ProjectSectionDetails);
    });
