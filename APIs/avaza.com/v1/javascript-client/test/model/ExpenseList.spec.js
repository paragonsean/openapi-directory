...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.ExpenseList();
  });
  ...
  describe('ExpenseList', function() {
    it('should create an instance of ExpenseList', function() {
      // uncomment below and update the code to test ExpenseList
      //var instance = new AvazaApiDocumentation.ExpenseList();
      //expect(instance).to.be.a(AvazaApiDocumentation.ExpenseList);
    });
