...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.TaxItem();
  });
  ...
  describe('TaxItem', function() {
    it('should create an instance of TaxItem', function() {
      ...
      //var instance = new AvazaApiDocumentation.TaxItem();
      //expect(instance).to.be.a(AvazaApiDocumentation.TaxItem);
    });

    it('should have the property calculatedPercent (base name: "CalculatedPercent")', function() {
      // uncomment below and update the code to test the property calculatedPercent
      //var instance = new AvazaApiDocumentation.TaxItem();
