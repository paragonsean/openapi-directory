...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.InventoryList();
  });
  ...
  describe('InventoryList', function() {
    it('should create an instance of InventoryList', function() {
      ...
      //var instance = new AvazaApiDocumentation.InventoryList();
      //expect(instance).to.be.a(AvazaApiDocumentation.InventoryList);
    });
