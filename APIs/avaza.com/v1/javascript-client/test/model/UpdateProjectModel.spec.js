...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.UpdateProjectModel();
  });
  ...
  describe('UpdateProjectModel', function() {
    it('should create an instance of UpdateProjectModel', function() {
      // uncomment below and update the code to test UpdateProjectModel
      //var instance = new AvazaApiDocumentation.UpdateProjectModel();
      //expect(instance).to.be.a(AvazaApiDocumentation.UpdateProjectModel);
    });
