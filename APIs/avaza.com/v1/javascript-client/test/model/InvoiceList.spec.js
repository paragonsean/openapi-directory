...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.InvoiceList();
  });
  ...
  describe('InvoiceList', function() {
    it('should create an instance of InvoiceList', function() {
      ...
      //var instance = new AvazaApiDocumentation.InvoiceList();
      //expect(instance).to.be.a(AvazaApiDocumentation.InvoiceList);
    });
