...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.WebhookList();
  });
  ...
  describe('WebhookList', function() {
    it('should create an instance of WebhookList', function() {
      ...
      //var instance = new AvazaApiDocumentation.WebhookList();
      //expect(instance).to.be.a(AvazaApiDocumentation.WebhookList);
    });
