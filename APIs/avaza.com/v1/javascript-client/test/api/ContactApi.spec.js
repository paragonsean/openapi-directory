...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.ContactApi();
  });
  ...
  describe('ContactApi', function() {
    ...
    describe('contactGetByID', function() {
      it('should call contactGetByID successfully', function(done) {
        //uncomment below and update the code to test contactGetByID
        //instance.contactGetByID(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
