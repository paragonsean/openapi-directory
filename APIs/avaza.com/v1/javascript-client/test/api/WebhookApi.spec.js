...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.WebhookApi();
  });
  ...
  describe('WebhookApi', function() {
    ...
    describe('webhookDeleteByUrl', function() {
      it('should call webhookDeleteByUrl successfully', function(done) {
        //uncomment below and update the code to test webhookDeleteByUrl
        //instance.webhookDeleteByUrl(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('webhookGetByID', function() {
      it('should call webhookGetByID successfully', function(done) {
        //uncomment below and update the code to test webhookGetByID
        //instance.webhookGetByID(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
