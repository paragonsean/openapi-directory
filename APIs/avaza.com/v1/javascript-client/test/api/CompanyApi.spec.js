...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvazaApiDocumentation.CompanyApi();
  });
  ...
  describe('CompanyApi', function() {
    ...
    describe('companyGetByID', function() {
      it('should call companyGetByID successfully', function(done) {
        //uncomment below and update the code to test companyGetByID
        //instance.companyGetByID(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('companyLookup', function() {
      it('should call companyLookup successfully', function(done) {
        //uncomment below and update the code to test companyLookup
        //instance.companyLookup(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
