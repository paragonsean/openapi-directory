# AvazaApiDocumentation.NewProjectModel
...
**companyIDFK** | **Number** | An ID of a company in Avaza to create the Project under. You must provide either a CompanyID, or a CompanyName | [optional] 
