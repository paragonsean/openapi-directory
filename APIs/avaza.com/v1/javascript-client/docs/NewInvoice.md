# AvazaApiDocumentation.NewInvoice
...
**invoiceTemplateIDFK** | **Number** | If left blank the account default invoice template will be used. | [optional] 
...
**lineItems** | [**[NewInvoiceLineItem]**](NewInvoiceLineItem.md) |  | [optional] 
