# AvazaApiDocumentation.UpdateExpense
...
**customerIDFK** | **Number** | The Avaza Customer ID to associate the Expense with. | [optional] 
...
**expenseCategoryIDFK** | **Number** | The expense category to link the Expense to. | [optional] 
**expenseDate** | **Date** | The date of the expense entry | [optional] 
**expenseID** | **Number** |  | 
...
**taxIDFK** | **Number** | Avaza Tax ID the expense belongs to. | [optional] 
