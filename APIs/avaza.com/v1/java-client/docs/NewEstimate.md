...
|**exchangeRate** | **Double** | Exchange rate is only valid for Estimates in currency other than default account currency. If not specified it will get the market rate based on the Date Issued. |  [optional] |
...
|**invoiceTemplateIDFK** | **Integer** | If left blank the account default Estimate template will be used. |  [optional] |
...
|**lineItems** | [**List&lt;NewEstimateLineItem&gt;**](NewEstimateLineItem.md) |  |  [optional] |
