...
<a id="expenseGroupLookup"></a>
# **expenseGroupLookup**
> ExpenseGroupDropdownList expenseGroupLookup(pageSize, pageNumber, search)
...
import org.openapitools.client.api.ExpenseGroupApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ExpenseGroupApi apiInstance = new ExpenseGroupApi(defaultClient);
    ...
    try {
      ExpenseGroupDropdownList result = apiInstance.expenseGroupLookup(pageSize, pageNumber, search);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExpenseGroupApi#expenseGroupLookup");
