...
public class NewBillLineItem {
  ...
  public NewBillLineItem() {
  }

  public NewBillLineItem description(String description) {
  ...
  public NewBillLineItem discount(Double discount) {
  ...
  public NewBillLineItem inventoryItemIDFK(Integer inventoryItemIDFK) {
  ...
  public NewBillLineItem inventoryItemName(String inventoryItemName) {
  ...
  public NewBillLineItem projectIDFK(Integer projectIDFK) {
  ...
  public NewBillLineItem quantity(Double quantity) {
  ...
  public NewBillLineItem taxIDFK(Integer taxIDFK) {
  ...
  public NewBillLineItem taxName(String taxName) {
  ...
  public NewBillLineItem taxPercent(Double taxPercent) {
  ...
  public NewBillLineItem unitPrice(Double unitPrice) {
  ...
  public boolean equals(Object o) {
    ...
    NewBillLineItem newBillLineItem = (NewBillLineItem) o;
    return Objects.equals(this.description, newBillLineItem.description) &&
        Objects.equals(this.discount, newBillLineItem.discount) &&
        Objects.equals(this.inventoryItemIDFK, newBillLineItem.inventoryItemIDFK) &&
        Objects.equals(this.inventoryItemName, newBillLineItem.inventoryItemName) &&
        Objects.equals(this.projectIDFK, newBillLineItem.projectIDFK) &&
        Objects.equals(this.quantity, newBillLineItem.quantity) &&
        Objects.equals(this.taxIDFK, newBillLineItem.taxIDFK) &&
        Objects.equals(this.taxName, newBillLineItem.taxName) &&
        Objects.equals(this.taxPercent, newBillLineItem.taxPercent) &&
        Objects.equals(this.unitPrice, newBillLineItem.unitPrice);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewBillLineItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewBillLineItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewBillLineItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewBillLineItem is not found in the empty JSON string", NewBillLineItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewBillLineItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewBillLineItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewBillLineItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewBillLineItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewBillLineItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewBillLineItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewBillLineItem.class));

       return (TypeAdapter<T>) new TypeAdapter<NewBillLineItem>() {
           @Override
           public void write(JsonWriter out, NewBillLineItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewBillLineItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewBillLineItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewBillLineItem
   * @throws IOException if the JSON string is invalid with respect to NewBillLineItem
   */
  public static NewBillLineItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewBillLineItem.class);
  }

  /**
   * Convert an instance of NewBillLineItem to an JSON string
   *
   * @return JSON string
   */
