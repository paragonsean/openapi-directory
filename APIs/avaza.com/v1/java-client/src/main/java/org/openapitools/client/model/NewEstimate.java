...
import org.openapitools.client.model.NewEstimateLineItem;
...
public class NewEstimate {
  ...
  public static final String SERIALIZED_NAME_ESTIMATE_NUMBER = "EstimateNumber";
  ...
  private List<NewEstimateLineItem> lineItems = new ArrayList<>();
  ...
  public NewEstimate companyIDFK(Integer companyIDFK) {
  ...
  public NewEstimate companyName(String companyName) {
  ...
  public NewEstimate currencyCode(String currencyCode) {
  ...
  public NewEstimate customerPONumber(String customerPONumber) {
  ...
  public NewEstimate dateIssued(OffsetDateTime dateIssued) {
  ...
  public NewEstimate dueDate(OffsetDateTime dueDate) {
  ...
  public NewEstimate email(String email) {
    this.email = email;
    return this;
  }
  ...
  public NewEstimate estimateNumber(String estimateNumber) {
  ...
  public NewEstimate estimatePrefix(String estimatePrefix) {
  ...
  public NewEstimate estimateTaxConfigCode(String estimateTaxConfigCode) {
  ...
  public NewEstimate exchangeRate(Double exchangeRate) {
  ...
  public NewEstimate firstname(String firstname) {
  ...
  public NewEstimate invoiceTemplateIDFK(Integer invoiceTemplateIDFK) {
  ...
  public NewEstimate lastname(String lastname) {
  ...
  public NewEstimate lineItems(List<NewEstimateLineItem> lineItems) {
    this.lineItems = lineItems;
    return this;
  }

  public NewEstimate addLineItemsItem(NewEstimateLineItem lineItemsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<NewEstimateLineItem> getLineItems() {
    return lineItems;
  }

  public void setLineItems(List<NewEstimateLineItem> lineItems) {
    this.lineItems = lineItems;
  }


  public NewEstimate notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public NewEstimate subject(String subject) {
  ...
  public boolean equals(Object o) {
    ...
    NewEstimate newEstimate = (NewEstimate) o;
    return Objects.equals(this.companyIDFK, newEstimate.companyIDFK) &&
        Objects.equals(this.companyName, newEstimate.companyName) &&
        Objects.equals(this.currencyCode, newEstimate.currencyCode) &&
        Objects.equals(this.customerPONumber, newEstimate.customerPONumber) &&
        Objects.equals(this.dateIssued, newEstimate.dateIssued) &&
        Objects.equals(this.dueDate, newEstimate.dueDate) &&
        Objects.equals(this.email, newEstimate.email) &&
        Objects.equals(this.estimateNumber, newEstimate.estimateNumber) &&
        Objects.equals(this.estimatePrefix, newEstimate.estimatePrefix) &&
        Objects.equals(this.estimateTaxConfigCode, newEstimate.estimateTaxConfigCode) &&
        Objects.equals(this.exchangeRate, newEstimate.exchangeRate) &&
        Objects.equals(this.firstname, newEstimate.firstname) &&
        Objects.equals(this.invoiceTemplateIDFK, newEstimate.invoiceTemplateIDFK) &&
        Objects.equals(this.lastname, newEstimate.lastname) &&
        Objects.equals(this.lineItems, newEstimate.lineItems) &&
        Objects.equals(this.notes, newEstimate.notes) &&
        Objects.equals(this.subject, newEstimate.subject);
  }

  @Override
  public int hashCode() {
    return Objects.hash(companyIDFK, companyName, currencyCode, customerPONumber, dateIssued, dueDate, email, estimateNumber, estimatePrefix, estimateTaxConfigCode, exchangeRate, firstname, invoiceTemplateIDFK, lastname, lineItems, notes, subject);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NewEstimate {\n");
  ...
  static {
    ...
    openapiFields.add("EstimateNumber");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewEstimate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewEstimate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewEstimate is not found in the empty JSON string", NewEstimate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewEstimate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewEstimate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("EstimateNumber") != null && !jsonObj.get("EstimateNumber").isJsonNull()) && !jsonObj.get("EstimateNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `EstimateNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("EstimateNumber").toString()));
      }
      ...
      if (jsonObj.get("LineItems") != null && !jsonObj.get("LineItems").isJsonNull()) {
        ...
        if (jsonArraylineItems != null) {
          ...
          for (int i = 0; i < jsonArraylineItems.size(); i++) {
            NewEstimateLineItem.validateJsonElement(jsonArraylineItems.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewEstimate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewEstimate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewEstimate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewEstimate.class));

       return (TypeAdapter<T>) new TypeAdapter<NewEstimate>() {
           @Override
           public void write(JsonWriter out, NewEstimate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewEstimate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewEstimate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewEstimate
   * @throws IOException if the JSON string is invalid with respect to NewEstimate
   */
  public static NewEstimate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewEstimate.class);
  }

  /**
   * Convert an instance of NewEstimate to an JSON string
   *
   * @return JSON string
   */
