...
public class NewCompany {
  ...
  public NewCompany billingAddress(String billingAddress) {
  ...
  public NewCompany billingAddressCity(String billingAddressCity) {
  ...
  public NewCompany billingAddressLine(String billingAddressLine) {
  ...
  public NewCompany billingAddressPostCode(String billingAddressPostCode) {
  ...
  public NewCompany billingAddressState(String billingAddressState) {
  ...
  public NewCompany billingCountryCode(String billingCountryCode) {
  ...
  public NewCompany comments(String comments) {
  ...
  public NewCompany companyName(String companyName) {
  ...
  public NewCompany currencyCode(String currencyCode) {
  ...
  public NewCompany fax(String fax) {
    this.fax = fax;
    return this;
  }
  ...
  public NewCompany phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public NewCompany taxNumber(String taxNumber) {
  ...
  public NewCompany website(String website) {
  ...
  public boolean equals(Object o) {
    ...
    NewCompany newCompany = (NewCompany) o;
    return Objects.equals(this.billingAddress, newCompany.billingAddress) &&
        Objects.equals(this.billingAddressCity, newCompany.billingAddressCity) &&
        Objects.equals(this.billingAddressLine, newCompany.billingAddressLine) &&
        Objects.equals(this.billingAddressPostCode, newCompany.billingAddressPostCode) &&
        Objects.equals(this.billingAddressState, newCompany.billingAddressState) &&
        Objects.equals(this.billingCountryCode, newCompany.billingCountryCode) &&
        Objects.equals(this.comments, newCompany.comments) &&
        Objects.equals(this.companyName, newCompany.companyName) &&
        Objects.equals(this.currencyCode, newCompany.currencyCode) &&
        Objects.equals(this.fax, newCompany.fax) &&
        Objects.equals(this.phone, newCompany.phone) &&
        Objects.equals(this.taxNumber, newCompany.taxNumber) &&
        Objects.equals(this.website, newCompany.website);
  }

  @Override
  public int hashCode() {
    return Objects.hash(billingAddress, billingAddressCity, billingAddressLine, billingAddressPostCode, billingAddressState, billingCountryCode, comments, companyName, currencyCode, fax, phone, taxNumber, website);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NewCompany {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewCompany
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewCompany.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewCompany is not found in the empty JSON string", NewCompany.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewCompany.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewCompany` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewCompany.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewCompany.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewCompany' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewCompany> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewCompany.class));

       return (TypeAdapter<T>) new TypeAdapter<NewCompany>() {
           @Override
           public void write(JsonWriter out, NewCompany value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewCompany read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewCompany given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewCompany
   * @throws IOException if the JSON string is invalid with respect to NewCompany
   */
  public static NewCompany fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewCompany.class);
  }

  /**
   * Convert an instance of NewCompany to an JSON string
   *
   * @return JSON string
   */
