...
public class InvoiceList {
  ...
  public InvoiceList pageNumber(Integer pageNumber) {
  ...
  public InvoiceList pageSize(Integer pageSize) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.invoices, invoiceList.invoices) &&
        Objects.equals(this.pageNumber, invoiceList.pageNumber) &&
        Objects.equals(this.pageSize, invoiceList.pageSize) &&
        Objects.equals(this.totalCount, invoiceList.totalCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invoices, pageNumber, pageSize, totalCount);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InvoiceList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InvoiceList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
