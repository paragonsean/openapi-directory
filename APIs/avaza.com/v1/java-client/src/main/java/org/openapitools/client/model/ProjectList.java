...
public class ProjectList {
  ...
  private List<ProjectListDetails> projects = new ArrayList<>();
  ...
  public ProjectList pageNumber(Integer pageNumber) {
  ...
  public ProjectList projects(List<ProjectListDetails> projects) {
    this.projects = projects;
    return this;
  }

  public ProjectList addProjectsItem(ProjectListDetails projectsItem) {
  ...
  public void setProjects(List<ProjectListDetails> projects) {
    this.projects = projects;
  }


  public ProjectList totalCount(Integer totalCount) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pageNumber, projectList.pageNumber) &&
        Objects.equals(this.pageSize, projectList.pageSize) &&
      ...
      if (jsonObj.get("Projects") != null && !jsonObj.get("Projects").isJsonNull()) {
        ...
        if (jsonArrayprojects != null) {
          ...
          for (int i = 0; i < jsonArrayprojects.size(); i++) {
            ProjectListDetails.validateJsonElement(jsonArrayprojects.get(i));
          };
        }
      }
  }
