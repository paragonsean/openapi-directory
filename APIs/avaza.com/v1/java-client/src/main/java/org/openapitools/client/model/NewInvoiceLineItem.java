...
public class NewInvoiceLineItem {
  ...
  public NewInvoiceLineItem() {
  }

  public NewInvoiceLineItem description(String description) {
  ...
  public NewInvoiceLineItem discount(Double discount) {
  ...
  public NewInvoiceLineItem inventoryItemIDFK(Integer inventoryItemIDFK) {
  ...
  public NewInvoiceLineItem inventoryItemName(String inventoryItemName) {
  ...
  public NewInvoiceLineItem projectIDFK(Integer projectIDFK) {
  ...
  public NewInvoiceLineItem quantity(Double quantity) {
  ...
  public NewInvoiceLineItem taxIDFK(Integer taxIDFK) {
  ...
  public NewInvoiceLineItem taxName(String taxName) {
  ...
  public NewInvoiceLineItem taxPercent(Double taxPercent) {
  ...
  public NewInvoiceLineItem unitPrice(Double unitPrice) {
  ...
  public boolean equals(Object o) {
    ...
    NewInvoiceLineItem newInvoiceLineItem = (NewInvoiceLineItem) o;
    return Objects.equals(this.description, newInvoiceLineItem.description) &&
        Objects.equals(this.discount, newInvoiceLineItem.discount) &&
        Objects.equals(this.inventoryItemIDFK, newInvoiceLineItem.inventoryItemIDFK) &&
        Objects.equals(this.inventoryItemName, newInvoiceLineItem.inventoryItemName) &&
        Objects.equals(this.projectIDFK, newInvoiceLineItem.projectIDFK) &&
        Objects.equals(this.quantity, newInvoiceLineItem.quantity) &&
        Objects.equals(this.taxIDFK, newInvoiceLineItem.taxIDFK) &&
        Objects.equals(this.taxName, newInvoiceLineItem.taxName) &&
        Objects.equals(this.taxPercent, newInvoiceLineItem.taxPercent) &&
        Objects.equals(this.unitPrice, newInvoiceLineItem.unitPrice);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, discount, inventoryItemIDFK, inventoryItemName, projectIDFK, quantity, taxIDFK, taxName, taxPercent, unitPrice);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NewInvoiceLineItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewInvoiceLineItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewInvoiceLineItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewInvoiceLineItem is not found in the empty JSON string", NewInvoiceLineItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewInvoiceLineItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewInvoiceLineItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewInvoiceLineItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewInvoiceLineItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewInvoiceLineItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewInvoiceLineItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewInvoiceLineItem.class));

       return (TypeAdapter<T>) new TypeAdapter<NewInvoiceLineItem>() {
           @Override
           public void write(JsonWriter out, NewInvoiceLineItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewInvoiceLineItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewInvoiceLineItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewInvoiceLineItem
   * @throws IOException if the JSON string is invalid with respect to NewInvoiceLineItem
   */
  public static NewInvoiceLineItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewInvoiceLineItem.class);
  }

  /**
   * Convert an instance of NewInvoiceLineItem to an JSON string
   *
   * @return JSON string
   */
