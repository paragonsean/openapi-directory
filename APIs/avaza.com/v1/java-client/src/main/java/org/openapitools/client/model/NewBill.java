...
import org.openapitools.client.model.NewBillLineItem;
...
public class NewBill {
  ...
  public static final String SERIALIZED_NAME_BILL_TEMPLATE_I_D_F_K = "BillTemplateIDFK";
  @SerializedName(SERIALIZED_NAME_BILL_TEMPLATE_I_D_F_K)
  private Integer billTemplateIDFK;
  ...
  private List<NewBillLineItem> lineItems = new ArrayList<>();
  ...
  public NewBill billNumber(String billNumber) {
  ...
  public NewBill billTemplateIDFK(Integer billTemplateIDFK) {
    this.billTemplateIDFK = billTemplateIDFK;
    return this;
  }

  /**
   * If left blank the account default invoice template will be used.
   * @return billTemplateIDFK
   */
  @javax.annotation.Nullable
  public Integer getBillTemplateIDFK() {
    return billTemplateIDFK;
  }

  public void setBillTemplateIDFK(Integer billTemplateIDFK) {
    this.billTemplateIDFK = billTemplateIDFK;
  }


  public NewBill companyIDFK(Integer companyIDFK) {
  ...
  public NewBill companyName(String companyName) {
  ...
  public NewBill currencyCode(String currencyCode) {
  ...
  public NewBill dateIssued(OffsetDateTime dateIssued) {
  ...
  public NewBill dueDate(OffsetDateTime dueDate) {
  ...
  public NewBill email(String email) {
    this.email = email;
    return this;
  }
  ...
  public NewBill exchangeRate(Double exchangeRate) {
  ...
  public NewBill firstname(String firstname) {
  ...
  public NewBill lastname(String lastname) {
  ...
  public NewBill lineItems(List<NewBillLineItem> lineItems) {
    this.lineItems = lineItems;
    return this;
  }

  public NewBill addLineItemsItem(NewBillLineItem lineItemsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<NewBillLineItem> getLineItems() {
    return lineItems;
  }

  public void setLineItems(List<NewBillLineItem> lineItems) {
    this.lineItems = lineItems;
  }


  public NewBill notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public NewBill paymentTerms(Integer paymentTerms) {
  ...
  public NewBill subject(String subject) {
  ...
  public NewBill supplierPONumber(String supplierPONumber) {
  ...
  public NewBill transactionPrefix(String transactionPrefix) {
  ...
  public NewBill transactionTaxConfigCode(String transactionTaxConfigCode) {
  ...
  public boolean equals(Object o) {
    ...
    NewBill newBill = (NewBill) o;
    return Objects.equals(this.billNumber, newBill.billNumber) &&
        Objects.equals(this.billTemplateIDFK, newBill.billTemplateIDFK) &&
        Objects.equals(this.companyIDFK, newBill.companyIDFK) &&
        Objects.equals(this.companyName, newBill.companyName) &&
        Objects.equals(this.currencyCode, newBill.currencyCode) &&
        Objects.equals(this.dateIssued, newBill.dateIssued) &&
        Objects.equals(this.dueDate, newBill.dueDate) &&
        Objects.equals(this.email, newBill.email) &&
        Objects.equals(this.exchangeRate, newBill.exchangeRate) &&
        Objects.equals(this.firstname, newBill.firstname) &&
        Objects.equals(this.lastname, newBill.lastname) &&
        Objects.equals(this.lineItems, newBill.lineItems) &&
        Objects.equals(this.notes, newBill.notes) &&
        Objects.equals(this.paymentTerms, newBill.paymentTerms) &&
        Objects.equals(this.subject, newBill.subject) &&
        Objects.equals(this.supplierPONumber, newBill.supplierPONumber) &&
        Objects.equals(this.transactionPrefix, newBill.transactionPrefix) &&
        Objects.equals(this.transactionTaxConfigCode, newBill.transactionTaxConfigCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(billNumber, billTemplateIDFK, companyIDFK, companyName, currencyCode, dateIssued, dueDate, email, exchangeRate, firstname, lastname, lineItems, notes, paymentTerms, subject, supplierPONumber, transactionPrefix, transactionTaxConfigCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NewBill {\n");
    sb.append("    billNumber: ").append(toIndentedString(billNumber)).append("\n");
    sb.append("    billTemplateIDFK: ").append(toIndentedString(billTemplateIDFK)).append("\n");
  ...
  static {
    ...
    openapiFields.add("BillTemplateIDFK");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewBill
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewBill.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewBill is not found in the empty JSON string", NewBill.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewBill.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewBill` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("LineItems") != null && !jsonObj.get("LineItems").isJsonNull()) {
        ...
        if (jsonArraylineItems != null) {
          ...
          for (int i = 0; i < jsonArraylineItems.size(); i++) {
            NewBillLineItem.validateJsonElement(jsonArraylineItems.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewBill.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewBill' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewBill> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewBill.class));

       return (TypeAdapter<T>) new TypeAdapter<NewBill>() {
           @Override
           public void write(JsonWriter out, NewBill value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewBill read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewBill given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewBill
   * @throws IOException if the JSON string is invalid with respect to NewBill
   */
  public static NewBill fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewBill.class);
  }

  /**
   * Convert an instance of NewBill to an JSON string
   *
   * @return JSON string
   */
