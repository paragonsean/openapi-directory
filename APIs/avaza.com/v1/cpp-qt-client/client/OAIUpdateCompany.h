...
#ifndef OAIUpdateCompany_H
#define OAIUpdateCompany_H
...
class OAIUpdateCompany : public OAIObject {
public:
    OAIUpdateCompany();
    OAIUpdateCompany(QString json);
    ~OAIUpdateCompany() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCompany)

#endif // OAIUpdateCompany_H
