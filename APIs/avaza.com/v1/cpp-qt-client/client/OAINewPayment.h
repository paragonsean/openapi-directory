...
#ifndef OAINewPayment_H
#define OAINewPayment_H

#include <QJsonObject>

#include "OAINewPaymentAllocation.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAINewPaymentAllocation;

class OAINewPayment : public OAIObject {
public:
    OAINewPayment();
    OAINewPayment(QString json);
    ~OAINewPayment() override;
    ...
    QList<OAINewPaymentAllocation> getPaymentAllocations() const;
    void setPaymentAllocations(const QList<OAINewPaymentAllocation> &payment_allocations);
...
private:
    ...
    QList<OAINewPaymentAllocation> m_payment_allocations;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewPayment)

#endif // OAINewPayment_H
