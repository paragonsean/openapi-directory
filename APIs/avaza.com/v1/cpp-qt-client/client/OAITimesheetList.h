...
#ifndef OAITimesheetList_H
#define OAITimesheetList_H

#include <QJsonObject>

#include "OAITimesheetListDetails.h"
#include <QList>
...
namespace OpenAPI {
class OAITimesheetListDetails;

class OAITimesheetList : public OAIObject {
public:
    OAITimesheetList();
    OAITimesheetList(QString json);
    ~OAITimesheetList() override;
    ...
    QList<OAITimesheetListDetails> getTimesheets() const;
    void setTimesheets(const QList<OAITimesheetListDetails> &timesheets);
...
private:
    ...
    QList<OAITimesheetListDetails> m_timesheets;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimesheetList)

#endif // OAITimesheetList_H
