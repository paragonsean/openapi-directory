...
/*
 * OAIProjectListDetails.h
 *
 * 
 */

#ifndef OAIProjectListDetails_H
#define OAIProjectListDetails_H
...
class OAIProjectListDetails : public OAIObject {
public:
    OAIProjectListDetails();
    OAIProjectListDetails(QString json);
    ~OAIProjectListDetails() override;
    ...
    qint64 getProjectCategoryIdfk() const;
    void setProjectCategoryIdfk(const qint64 &project_category_idfk);
    ...
    qint64 getProjectOwnerUserIdfk() const;
    void setProjectOwnerUserIdfk(const qint64 &project_owner_user_idfk);
...
private:
    ...
    qint64 m_project_category_idfk;
    ...
    qint64 m_project_owner_user_idfk;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectListDetails)

#endif // OAIProjectListDetails_H
