...
/*
 * OAIFixedAmountList.h
 *
 * 
 */

#ifndef OAIFixedAmountList_H
#define OAIFixedAmountList_H
...
namespace OpenAPI {
class OAIFixedAmountDetails;

class OAIFixedAmountList : public OAIObject {
public:
    OAIFixedAmountList();
    OAIFixedAmountList(QString json);
    ~OAIFixedAmountList() override;
    ...
    QList<OAIFixedAmountDetails> getFixedAmounts() const;
    void setFixedAmounts(const QList<OAIFixedAmountDetails> &fixed_amounts);
    bool is_fixed_amounts_Set() const;
    bool is_fixed_amounts_Valid() const;
...
private:
    ...
    QList<OAIFixedAmountDetails> m_fixed_amounts;
    bool m_fixed_amounts_isSet;
    bool m_fixed_amounts_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFixedAmountList)

#endif // OAIFixedAmountList_H
