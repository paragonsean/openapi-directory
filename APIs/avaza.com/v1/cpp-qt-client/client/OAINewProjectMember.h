...
/*
 * OAINewProjectMember.h
 *
 * 
 */

#ifndef OAINewProjectMember_H
#define OAINewProjectMember_H
...
class OAINewProjectMember : public OAIObject {
public:
    OAINewProjectMember();
    OAINewProjectMember(QString json);
    ~OAINewProjectMember() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewProjectMember)

#endif // OAINewProjectMember_H
