...
/*
 * OAINewInvoiceLineItem.h
 *
 * Line item to be added to new invoice
 */

#ifndef OAINewInvoiceLineItem_H
#define OAINewInvoiceLineItem_H
...
class OAINewInvoiceLineItem : public OAIObject {
public:
    OAINewInvoiceLineItem();
    OAINewInvoiceLineItem(QString json);
    ~OAINewInvoiceLineItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewInvoiceLineItem)

#endif // OAINewInvoiceLineItem_H
