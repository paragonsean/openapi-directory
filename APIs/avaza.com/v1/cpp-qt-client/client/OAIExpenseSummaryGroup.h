...
/*
 * OAIExpenseSummaryGroup.h
 *
 * 
 */

#ifndef OAIExpenseSummaryGroup_H
#define OAIExpenseSummaryGroup_H
...
class OAIExpenseSummaryGroup : public OAIObject {
public:
    OAIExpenseSummaryGroup();
    OAIExpenseSummaryGroup(QString json);
    ~OAIExpenseSummaryGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExpenseSummaryGroup)

#endif // OAIExpenseSummaryGroup_H
