...
#ifndef OAICreateBooking_H
#define OAICreateBooking_H
...
class OAICreateBooking : public OAIObject {
public:
    OAICreateBooking();
    OAICreateBooking(QString json);
    ~OAICreateBooking() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBooking)

#endif // OAICreateBooking_H
