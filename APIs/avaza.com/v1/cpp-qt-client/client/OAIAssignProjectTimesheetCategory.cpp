...
OAIAssignProjectTimesheetCategory::OAIAssignProjectTimesheetCategory(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssignProjectTimesheetCategory::OAIAssignProjectTimesheetCategory() {
    this->initializeModel();
}

OAIAssignProjectTimesheetCategory::~OAIAssignProjectTimesheetCategory() {}

void OAIAssignProjectTimesheetCategory::initializeModel() {
...
void OAIAssignProjectTimesheetCategory::fromJson(QString jsonString) {
...
void OAIAssignProjectTimesheetCategory::fromJsonObject(QJsonObject json) {
...
QString OAIAssignProjectTimesheetCategory::asJson() const {
...
QJsonObject OAIAssignProjectTimesheetCategory::asJsonObject() const {
    QJsonObject obj;
...
double OAIAssignProjectTimesheetCategory::getBudgetHours() const {
    return m_budget_hours;
}
void OAIAssignProjectTimesheetCategory::setBudgetHours(const double &budget_hours) {
    m_budget_hours = budget_hours;
    m_budget_hours_isSet = true;
}

bool OAIAssignProjectTimesheetCategory::is_budget_hours_Set() const{
    return m_budget_hours_isSet;
}

bool OAIAssignProjectTimesheetCategory::is_budget_hours_Valid() const{
    return m_budget_hours_isValid;
}

double OAIAssignProjectTimesheetCategory::getCostAmount() const {
    return m_cost_amount;
}
void OAIAssignProjectTimesheetCategory::setCostAmount(const double &cost_amount) {
    m_cost_amount = cost_amount;
    m_cost_amount_isSet = true;
}

bool OAIAssignProjectTimesheetCategory::is_cost_amount_Set() const{
    return m_cost_amount_isSet;
}

bool OAIAssignProjectTimesheetCategory::is_cost_amount_Valid() const{
    return m_cost_amount_isValid;
}

qint32 OAIAssignProjectTimesheetCategory::getProjectIdfk() const {
    return m_project_idfk;
}
void OAIAssignProjectTimesheetCategory::setProjectIdfk(const qint32 &project_idfk) {
    m_project_idfk = project_idfk;
    m_project_idfk_isSet = true;
}

bool OAIAssignProjectTimesheetCategory::is_project_idfk_Set() const{
    return m_project_idfk_isSet;
}

bool OAIAssignProjectTimesheetCategory::is_project_idfk_Valid() const{
    return m_project_idfk_isValid;
}

double OAIAssignProjectTimesheetCategory::getRateAmount() const {
    return m_rate_amount;
}
void OAIAssignProjectTimesheetCategory::setRateAmount(const double &rate_amount) {
    m_rate_amount = rate_amount;
    m_rate_amount_isSet = true;
}

bool OAIAssignProjectTimesheetCategory::is_rate_amount_Set() const{
    return m_rate_amount_isSet;
}

bool OAIAssignProjectTimesheetCategory::is_rate_amount_Valid() const{
    return m_rate_amount_isValid;
}

qint32 OAIAssignProjectTimesheetCategory::getTimesheetCategoryIdfk() const {
    return m_timesheet_category_idfk;
}
void OAIAssignProjectTimesheetCategory::setTimesheetCategoryIdfk(const qint32 &timesheet_category_idfk) {
    m_timesheet_category_idfk = timesheet_category_idfk;
    m_timesheet_category_idfk_isSet = true;
}

bool OAIAssignProjectTimesheetCategory::is_timesheet_category_idfk_Set() const{
    return m_timesheet_category_idfk_isSet;
}

bool OAIAssignProjectTimesheetCategory::is_timesheet_category_idfk_Valid() const{
    return m_timesheet_category_idfk_isValid;
}

bool OAIAssignProjectTimesheetCategory::isIsBillable() const {
    return m_is_billable;
}
void OAIAssignProjectTimesheetCategory::setIsBillable(const bool &is_billable) {
    m_is_billable = is_billable;
    m_is_billable_isSet = true;
}

bool OAIAssignProjectTimesheetCategory::is_is_billable_Set() const{
    return m_is_billable_isSet;
}

bool OAIAssignProjectTimesheetCategory::is_is_billable_Valid() const{
    return m_is_billable_isValid;
}

bool OAIAssignProjectTimesheetCategory::isIsPayable() const {
    return m_is_payable;
}
void OAIAssignProjectTimesheetCategory::setIsPayable(const bool &is_payable) {
    m_is_payable = is_payable;
    m_is_payable_isSet = true;
}

bool OAIAssignProjectTimesheetCategory::is_is_payable_Set() const{
    return m_is_payable_isSet;
}

bool OAIAssignProjectTimesheetCategory::is_is_payable_Valid() const{
    return m_is_payable_isValid;
}

bool OAIAssignProjectTimesheetCategory::isSet() const {
...
bool OAIAssignProjectTimesheetCategory::isValid() const {
