...
/*
 * OAIProjectMemberDetails.h
 *
 * 
 */

#ifndef OAIProjectMemberDetails_H
#define OAIProjectMemberDetails_H
...
class OAIProjectMemberDetails : public OAIObject {
public:
    OAIProjectMemberDetails();
    OAIProjectMemberDetails(QString json);
    ~OAIProjectMemberDetails() override;
    ...
    bool isIsMemberDisabled() const;
    void setIsMemberDisabled(const bool &is_member_disabled);
    bool is_is_member_disabled_Set() const;
    bool is_is_member_disabled_Valid() const;
...
private:
    ...
    bool m_is_member_disabled;
    bool m_is_member_disabled_isSet;
    bool m_is_member_disabled_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectMemberDetails)

#endif // OAIProjectMemberDetails_H
