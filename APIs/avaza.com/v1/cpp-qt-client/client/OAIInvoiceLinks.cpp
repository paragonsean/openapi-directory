...
QString OAIInvoiceLinks::getClientView() const {
    return m_client_view;
}
void OAIInvoiceLinks::setClientView(const QString &client_view) {
    m_client_view = client_view;
    m_client_view_isSet = true;
}

bool OAIInvoiceLinks::is_client_view_Set() const{
    return m_client_view_isSet;
}

bool OAIInvoiceLinks::is_client_view_Valid() const{
    return m_client_view_isValid;
}

QString OAIInvoiceLinks::getEdit() const {
    return m_edit;
}
void OAIInvoiceLinks::setEdit(const QString &edit) {
    m_edit = edit;
    m_edit_isSet = true;
}

bool OAIInvoiceLinks::is_edit_Set() const{
    return m_edit_isSet;
}

bool OAIInvoiceLinks::is_edit_Valid() const{
    return m_edit_isValid;
}

QString OAIInvoiceLinks::getView() const {
    return m_view;
}
void OAIInvoiceLinks::setView(const QString &view) {
    m_view = view;
    m_view_isSet = true;
}
