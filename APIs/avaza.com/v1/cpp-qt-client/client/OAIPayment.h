...
#include "OAIPaymentAllocation.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
public:
    ...
    QList<OAIPaymentAllocation> getPaymentAllocations() const;
    void setPaymentAllocations(const QList<OAIPaymentAllocation> &payment_allocations);
...
private:
    ...
    QList<OAIPaymentAllocation> m_payment_allocations;
