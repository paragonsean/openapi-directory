...
Q_SIGNALS:
    ...
    void accountGetSignal(OAIAccountDetails summary);


    void accountGetSignalFull(OAIHttpRequestWorker *worker, OAIAccountDetails summary);

    Q_DECL_DEPRECATED_X("Use accountGetSignalError() instead")
    void accountGetSignalE(OAIAccountDetails summary, QNetworkReply::NetworkError error_type, QString error_str);
    void accountGetSignalError(OAIAccountDetails summary, QNetworkReply::NetworkError error_type, const QString &error_str);
