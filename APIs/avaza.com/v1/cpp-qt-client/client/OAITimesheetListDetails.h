...
/*
 * OAITimesheetListDetails.h
 *
 * 
 */

#ifndef OAITimesheetListDetails_H
#define OAITimesheetListDetails_H
...
class OAITimesheetListDetails : public OAIObject {
public:
    OAITimesheetListDetails();
    OAITimesheetListDetails(QString json);
    ~OAITimesheetListDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimesheetListDetails)

#endif // OAITimesheetListDetails_H
