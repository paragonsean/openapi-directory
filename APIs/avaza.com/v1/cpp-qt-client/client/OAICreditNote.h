...
namespace OpenAPI {
class OAICreditNoteAllocation;
class OAICreditNoteLineItem;
...
public:
    ...
    QList<OAICreditNoteAllocation> getCreditNoteAllocations() const;
    void setCreditNoteAllocations(const QList<OAICreditNoteAllocation> &credit_note_allocations);
    bool is_credit_note_allocations_Set() const;
    bool is_credit_note_allocations_Valid() const;

    QList<OAICreditNoteLineItem> getCreditNoteLineItems() const;
    void setCreditNoteLineItems(const QList<OAICreditNoteLineItem> &credit_note_line_items);
    bool is_credit_note_line_items_Set() const;
    bool is_credit_note_line_items_Valid() const;
...
private:
    ...
    QList<OAICreditNoteAllocation> m_credit_note_allocations;
    bool m_credit_note_allocations_isSet;
    bool m_credit_note_allocations_isValid;

    QList<OAICreditNoteLineItem> m_credit_note_line_items;
    bool m_credit_note_line_items_isSet;
    bool m_credit_note_line_items_isValid;
