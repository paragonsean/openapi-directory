...
#ifndef OAIEditLeave_H
#define OAIEditLeave_H
...
class OAIEditLeave : public OAIObject {
public:
    OAIEditLeave();
    OAIEditLeave(QString json);
    ~OAIEditLeave() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEditLeave)

#endif // OAIEditLeave_H
