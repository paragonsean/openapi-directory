...
#ifndef OAIExpenseList_H
#define OAIExpenseList_H
...
namespace OpenAPI {
class OAIExpenseDetails;

class OAIExpenseList : public OAIObject {
public:
    OAIExpenseList();
    OAIExpenseList(QString json);
    ~OAIExpenseList() override;
    ...
    QList<OAIExpenseDetails> getExpenses() const;
    void setExpenses(const QList<OAIExpenseDetails> &expenses);
...
private:
    ...
    QList<OAIExpenseDetails> m_expenses;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExpenseList)

#endif // OAIExpenseList_H
