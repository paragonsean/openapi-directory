...
OAINewExpense::OAINewExpense(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINewExpense::OAINewExpense() {
    this->initializeModel();
}

OAINewExpense::~OAINewExpense() {}

void OAINewExpense::initializeModel() {
...
void OAINewExpense::fromJson(QString jsonString) {
...
void OAINewExpense::fromJsonObject(QJsonObject json) {
...
QString OAINewExpense::asJson() const {
...
QJsonObject OAINewExpense::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
double OAINewExpense::getAmount() const {
    return m_amount;
}
void OAINewExpense::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAINewExpense::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAINewExpense::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAINewExpense::getCurrencyCode() const {
    return m_currency_code;
}
void OAINewExpense::setCurrencyCode(const QString &currency_code) {
    m_currency_code = currency_code;
    m_currency_code_isSet = true;
}

bool OAINewExpense::is_currency_code_Set() const{
    return m_currency_code_isSet;
}

bool OAINewExpense::is_currency_code_Valid() const{
    return m_currency_code_isValid;
}

qint32 OAINewExpense::getCustomerIdfk() const {
    return m_customer_idfk;
}
void OAINewExpense::setCustomerIdfk(const qint32 &customer_idfk) {
    m_customer_idfk = customer_idfk;
    m_customer_idfk_isSet = true;
}

bool OAINewExpense::is_customer_idfk_Set() const{
    return m_customer_idfk_isSet;
}

bool OAINewExpense::is_customer_idfk_Valid() const{
    return m_customer_idfk_isValid;
}

QString OAINewExpense::getCustomerName() const {
    return m_customer_name;
}
void OAINewExpense::setCustomerName(const QString &customer_name) {
    m_customer_name = customer_name;
    m_customer_name_isSet = true;
}

bool OAINewExpense::is_customer_name_Set() const{
    return m_customer_name_isSet;
}

bool OAINewExpense::is_customer_name_Valid() const{
    return m_customer_name_isValid;
}

double OAINewExpense::getExchangeRate() const {
    return m_exchange_rate;
}
void OAINewExpense::setExchangeRate(const double &exchange_rate) {
    m_exchange_rate = exchange_rate;
    m_exchange_rate_isSet = true;
}

bool OAINewExpense::is_exchange_rate_Set() const{
    return m_exchange_rate_isSet;
}

bool OAINewExpense::is_exchange_rate_Valid() const{
    return m_exchange_rate_isValid;
}

qint32 OAINewExpense::getExpenseCategoryIdfk() const {
    return m_expense_category_idfk;
}
void OAINewExpense::setExpenseCategoryIdfk(const qint32 &expense_category_idfk) {
    m_expense_category_idfk = expense_category_idfk;
    m_expense_category_idfk_isSet = true;
}

bool OAINewExpense::is_expense_category_idfk_Set() const{
    return m_expense_category_idfk_isSet;
}

bool OAINewExpense::is_expense_category_idfk_Valid() const{
    return m_expense_category_idfk_isValid;
}

QString OAINewExpense::getExpenseCategoryName() const {
    return m_expense_category_name;
}
void OAINewExpense::setExpenseCategoryName(const QString &expense_category_name) {
    m_expense_category_name = expense_category_name;
    m_expense_category_name_isSet = true;
}

bool OAINewExpense::is_expense_category_name_Set() const{
    return m_expense_category_name_isSet;
}

bool OAINewExpense::is_expense_category_name_Valid() const{
    return m_expense_category_name_isValid;
}

QDateTime OAINewExpense::getExpenseDate() const {
    return m_expense_date;
}
void OAINewExpense::setExpenseDate(const QDateTime &expense_date) {
    m_expense_date = expense_date;
    m_expense_date_isSet = true;
}

bool OAINewExpense::is_expense_date_Set() const{
    return m_expense_date_isSet;
}

bool OAINewExpense::is_expense_date_Valid() const{
    return m_expense_date_isValid;
}

qint32 OAINewExpense::getExpensePaymentMethodIdfk() const {
    return m_expense_payment_method_idfk;
}
void OAINewExpense::setExpensePaymentMethodIdfk(const qint32 &expense_payment_method_idfk) {
    m_expense_payment_method_idfk = expense_payment_method_idfk;
    m_expense_payment_method_idfk_isSet = true;
}

bool OAINewExpense::is_expense_payment_method_idfk_Set() const{
    return m_expense_payment_method_idfk_isSet;
}

bool OAINewExpense::is_expense_payment_method_idfk_Valid() const{
    return m_expense_payment_method_idfk_isValid;
}

QList<qint64> OAINewExpense::getFileAttachmentIds() const {
    return m_file_attachment_ids;
}
void OAINewExpense::setFileAttachmentIds(const QList<qint64> &file_attachment_ids) {
    m_file_attachment_ids = file_attachment_ids;
    m_file_attachment_ids_isSet = true;
}

bool OAINewExpense::is_file_attachment_ids_Set() const{
    return m_file_attachment_ids_isSet;
}

bool OAINewExpense::is_file_attachment_ids_Valid() const{
    return m_file_attachment_ids_isValid;
}

QString OAINewExpense::getGroupTripName() const {
    return m_group_trip_name;
}
void OAINewExpense::setGroupTripName(const QString &group_trip_name) {
    m_group_trip_name = group_trip_name;
    m_group_trip_name_isSet = true;
}

bool OAINewExpense::is_group_trip_name_Set() const{
    return m_group_trip_name_isSet;
}

bool OAINewExpense::is_group_trip_name_Valid() const{
    return m_group_trip_name_isValid;
}

QString OAINewExpense::getMerchant() const {
    return m_merchant;
}
void OAINewExpense::setMerchant(const QString &merchant) {
    m_merchant = merchant;
    m_merchant_isSet = true;
}

bool OAINewExpense::is_merchant_Set() const{
    return m_merchant_isSet;
}

bool OAINewExpense::is_merchant_Valid() const{
    return m_merchant_isValid;
}

QString OAINewExpense::getMerchantTaxNumber() const {
    return m_merchant_tax_number;
}
void OAINewExpense::setMerchantTaxNumber(const QString &merchant_tax_number) {
    m_merchant_tax_number = merchant_tax_number;
    m_merchant_tax_number_isSet = true;
}

bool OAINewExpense::is_merchant_tax_number_Set() const{
    return m_merchant_tax_number_isSet;
}

bool OAINewExpense::is_merchant_tax_number_Valid() const{
    return m_merchant_tax_number_isValid;
}

QString OAINewExpense::getNotes() const {
    return m_notes;
}
void OAINewExpense::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAINewExpense::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAINewExpense::is_notes_Valid() const{
    return m_notes_isValid;
}

qint32 OAINewExpense::getProjectIdfk() const {
    return m_project_idfk;
}
void OAINewExpense::setProjectIdfk(const qint32 &project_idfk) {
    m_project_idfk = project_idfk;
    m_project_idfk_isSet = true;
}

bool OAINewExpense::is_project_idfk_Set() const{
    return m_project_idfk_isSet;
}

bool OAINewExpense::is_project_idfk_Valid() const{
    return m_project_idfk_isValid;
}

QString OAINewExpense::getProjectName() const {
    return m_project_name;
}
void OAINewExpense::setProjectName(const QString &project_name) {
    m_project_name = project_name;
    m_project_name_isSet = true;
}

bool OAINewExpense::is_project_name_Set() const{
    return m_project_name_isSet;
}

bool OAINewExpense::is_project_name_Valid() const{
    return m_project_name_isValid;
}

double OAINewExpense::getQuantity() const {
    return m_quantity;
}
void OAINewExpense::setQuantity(const double &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAINewExpense::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAINewExpense::is_quantity_Valid() const{
    return m_quantity_isValid;
}

qint32 OAINewExpense::getTaskIdfk() const {
    return m_task_idfk;
}
void OAINewExpense::setTaskIdfk(const qint32 &task_idfk) {
    m_task_idfk = task_idfk;
    m_task_idfk_isSet = true;
}

bool OAINewExpense::is_task_idfk_Set() const{
    return m_task_idfk_isSet;
}

bool OAINewExpense::is_task_idfk_Valid() const{
    return m_task_idfk_isValid;
}

qint32 OAINewExpense::getTaxIdfk() const {
    return m_tax_idfk;
}
void OAINewExpense::setTaxIdfk(const qint32 &tax_idfk) {
    m_tax_idfk = tax_idfk;
    m_tax_idfk_isSet = true;
}

bool OAINewExpense::is_tax_idfk_Set() const{
    return m_tax_idfk_isSet;
}

bool OAINewExpense::is_tax_idfk_Valid() const{
    return m_tax_idfk_isValid;
}

QString OAINewExpense::getTaxName() const {
    return m_tax_name;
}
void OAINewExpense::setTaxName(const QString &tax_name) {
    m_tax_name = tax_name;
    m_tax_name_isSet = true;
}

bool OAINewExpense::is_tax_name_Set() const{
    return m_tax_name_isSet;
}

bool OAINewExpense::is_tax_name_Valid() const{
    return m_tax_name_isValid;
}

QString OAINewExpense::getTransactionTaxConfigCode() const {
    return m_transaction_tax_config_code;
}
void OAINewExpense::setTransactionTaxConfigCode(const QString &transaction_tax_config_code) {
    m_transaction_tax_config_code = transaction_tax_config_code;
    m_transaction_tax_config_code_isSet = true;
}

bool OAINewExpense::is_transaction_tax_config_code_Set() const{
    return m_transaction_tax_config_code_isSet;
}

bool OAINewExpense::is_transaction_tax_config_code_Valid() const{
    return m_transaction_tax_config_code_isValid;
}

QString OAINewExpense::getUserEmail() const {
    return m_user_email;
}
void OAINewExpense::setUserEmail(const QString &user_email) {
    m_user_email = user_email;
    m_user_email_isSet = true;
}

bool OAINewExpense::is_user_email_Set() const{
    return m_user_email_isSet;
}

bool OAINewExpense::is_user_email_Valid() const{
    return m_user_email_isValid;
}

qint32 OAINewExpense::getUserIdfk() const {
    return m_user_idfk;
}
void OAINewExpense::setUserIdfk(const qint32 &user_idfk) {
    m_user_idfk = user_idfk;
    m_user_idfk_isSet = true;
}

bool OAINewExpense::is_user_idfk_Set() const{
    return m_user_idfk_isSet;
}

bool OAINewExpense::is_user_idfk_Valid() const{
    return m_user_idfk_isValid;
}

bool OAINewExpense::isVerifyAndSave() const {
    return m_verify_and_save;
}
void OAINewExpense::setVerifyAndSave(const bool &verify_and_save) {
    m_verify_and_save = verify_and_save;
    m_verify_and_save_isSet = true;
}

bool OAINewExpense::is_verify_and_save_Set() const{
    return m_verify_and_save_isSet;
}

bool OAINewExpense::is_verify_and_save_Valid() const{
    return m_verify_and_save_isValid;
}

bool OAINewExpense::isIsChargeable() const {
    return m_is_chargeable;
}
void OAINewExpense::setIsChargeable(const bool &is_chargeable) {
    m_is_chargeable = is_chargeable;
    m_is_chargeable_isSet = true;
}

bool OAINewExpense::is_is_chargeable_Set() const{
    return m_is_chargeable_isSet;
}

bool OAINewExpense::is_is_chargeable_Valid() const{
    return m_is_chargeable_isValid;
}

bool OAINewExpense::isIsReimbursable() const {
    return m_is_reimbursable;
}
void OAINewExpense::setIsReimbursable(const bool &is_reimbursable) {
    m_is_reimbursable = is_reimbursable;
    m_is_reimbursable_isSet = true;
}

bool OAINewExpense::is_is_reimbursable_Set() const{
    return m_is_reimbursable_isSet;
}

bool OAINewExpense::is_is_reimbursable_Valid() const{
    return m_is_reimbursable_isValid;
}

bool OAINewExpense::isSet() const {
...
bool OAINewExpense::isValid() const {
