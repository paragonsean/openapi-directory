...
public:
    ...
    QList<OAIProjectListDetails> getProjects() const;
    void setProjects(const QList<OAIProjectListDetails> &projects);
...
private:
    ...
    QList<OAIProjectListDetails> m_projects;
