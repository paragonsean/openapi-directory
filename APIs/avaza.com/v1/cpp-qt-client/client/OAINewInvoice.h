...
#ifndef OAINewInvoice_H
#define OAINewInvoice_H

#include <QJsonObject>

#include "OAINewInvoiceLineItem.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAINewInvoiceLineItem;

class OAINewInvoice : public OAIObject {
public:
    OAINewInvoice();
    OAINewInvoice(QString json);
    ~OAINewInvoice() override;
    ...
    QList<OAINewInvoiceLineItem> getLineItems() const;
    void setLineItems(const QList<OAINewInvoiceLineItem> &line_items);
    ...
    qint32 getPaymentTerms() const;
    void setPaymentTerms(const qint32 &payment_terms);
...
private:
    ...
    QList<OAINewInvoiceLineItem> m_line_items;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewInvoice)

#endif // OAINewInvoice_H
