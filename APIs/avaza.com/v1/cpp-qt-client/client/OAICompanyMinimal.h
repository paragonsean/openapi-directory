...
#ifndef OAICompanyMinimal_H
#define OAICompanyMinimal_H
...
class OAICompanyMinimal : public OAIObject {
public:
    OAICompanyMinimal();
    OAICompanyMinimal(QString json);
    ~OAICompanyMinimal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompanyMinimal)

#endif // OAICompanyMinimal_H
