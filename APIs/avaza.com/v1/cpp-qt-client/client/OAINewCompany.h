...
#ifndef OAINewCompany_H
#define OAINewCompany_H
...
class OAINewCompany : public OAIObject {
public:
    OAINewCompany();
    OAINewCompany(QString json);
    ~OAINewCompany() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewCompany)

#endif // OAINewCompany_H
