...
#ifndef OAIEstimateList_H
#define OAIEstimateList_H
...
namespace OpenAPI {
class OAIEstimateDetails;

class OAIEstimateList : public OAIObject {
public:
    OAIEstimateList();
    OAIEstimateList(QString json);
    ~OAIEstimateList() override;
    ...
    QList<OAIEstimateDetails> getEstimates() const;
    void setEstimates(const QList<OAIEstimateDetails> &estimates);
    bool is_estimates_Set() const;
    bool is_estimates_Valid() const;
...
private:
    ...
    QList<OAIEstimateDetails> m_estimates;
    bool m_estimates_isSet;
    bool m_estimates_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEstimateList)

#endif // OAIEstimateList_H
