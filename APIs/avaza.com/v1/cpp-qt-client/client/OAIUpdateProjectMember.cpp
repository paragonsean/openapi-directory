...
OAIUpdateProjectMember::OAIUpdateProjectMember(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateProjectMember::OAIUpdateProjectMember() {
    this->initializeModel();
}

OAIUpdateProjectMember::~OAIUpdateProjectMember() {}

void OAIUpdateProjectMember::initializeModel() {
...
void OAIUpdateProjectMember::fromJson(QString jsonString) {
...
void OAIUpdateProjectMember::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateProjectMember::asJson() const {
...
QJsonObject OAIUpdateProjectMember::asJsonObject() const {
    QJsonObject obj;
...
double OAIUpdateProjectMember::getBudgetAmount() const {
    return m_budget_amount;
}
void OAIUpdateProjectMember::setBudgetAmount(const double &budget_amount) {
    m_budget_amount = budget_amount;
    m_budget_amount_isSet = true;
}

bool OAIUpdateProjectMember::is_budget_amount_Set() const{
    return m_budget_amount_isSet;
}

bool OAIUpdateProjectMember::is_budget_amount_Valid() const{
    return m_budget_amount_isValid;
}

double OAIUpdateProjectMember::getCostAmount() const {
    return m_cost_amount;
}
void OAIUpdateProjectMember::setCostAmount(const double &cost_amount) {
    m_cost_amount = cost_amount;
    m_cost_amount_isSet = true;
}

bool OAIUpdateProjectMember::is_cost_amount_Set() const{
    return m_cost_amount_isSet;
}

bool OAIUpdateProjectMember::is_cost_amount_Valid() const{
    return m_cost_amount_isValid;
}

QList<QString> OAIUpdateProjectMember::getFieldsToUpdate() const {
    return m_fields_to_update;
}
void OAIUpdateProjectMember::setFieldsToUpdate(const QList<QString> &fields_to_update) {
    m_fields_to_update = fields_to_update;
    m_fields_to_update_isSet = true;
}

bool OAIUpdateProjectMember::is_fields_to_update_Set() const{
    return m_fields_to_update_isSet;
}

bool OAIUpdateProjectMember::is_fields_to_update_Valid() const{
    return m_fields_to_update_isValid;
}

qint32 OAIUpdateProjectMember::getProjectIdfk() const {
    return m_project_idfk;
}
void OAIUpdateProjectMember::setProjectIdfk(const qint32 &project_idfk) {
    m_project_idfk = project_idfk;
    m_project_idfk_isSet = true;
}

bool OAIUpdateProjectMember::is_project_idfk_Set() const{
    return m_project_idfk_isSet;
}

bool OAIUpdateProjectMember::is_project_idfk_Valid() const{
    return m_project_idfk_isValid;
}

double OAIUpdateProjectMember::getRateAmount() const {
    return m_rate_amount;
}
void OAIUpdateProjectMember::setRateAmount(const double &rate_amount) {
    m_rate_amount = rate_amount;
    m_rate_amount_isSet = true;
}

bool OAIUpdateProjectMember::is_rate_amount_Set() const{
    return m_rate_amount_isSet;
}

bool OAIUpdateProjectMember::is_rate_amount_Valid() const{
    return m_rate_amount_isValid;
}

qint32 OAIUpdateProjectMember::getUserIdfk() const {
    return m_user_idfk;
}
void OAIUpdateProjectMember::setUserIdfk(const qint32 &user_idfk) {
    m_user_idfk = user_idfk;
    m_user_idfk_isSet = true;
}

bool OAIUpdateProjectMember::is_user_idfk_Set() const{
    return m_user_idfk_isSet;
}

bool OAIUpdateProjectMember::is_user_idfk_Valid() const{
    return m_user_idfk_isValid;
}

bool OAIUpdateProjectMember::isCanCommentOnTasks() const {
    return m_can_comment_on_tasks;
}
void OAIUpdateProjectMember::setCanCommentOnTasks(const bool &can_comment_on_tasks) {
    m_can_comment_on_tasks = can_comment_on_tasks;
    m_can_comment_on_tasks_isSet = true;
}

bool OAIUpdateProjectMember::is_can_comment_on_tasks_Set() const{
    return m_can_comment_on_tasks_isSet;
}

bool OAIUpdateProjectMember::is_can_comment_on_tasks_Valid() const{
    return m_can_comment_on_tasks_isValid;
}

bool OAIUpdateProjectMember::isCanCreateTasks() const {
    return m_can_create_tasks;
}
void OAIUpdateProjectMember::setCanCreateTasks(const bool &can_create_tasks) {
    m_can_create_tasks = can_create_tasks;
    m_can_create_tasks_isSet = true;
}

bool OAIUpdateProjectMember::is_can_create_tasks_Set() const{
    return m_can_create_tasks_isSet;
}

bool OAIUpdateProjectMember::is_can_create_tasks_Valid() const{
    return m_can_create_tasks_isValid;
}

bool OAIUpdateProjectMember::isCanDeleteTasks() const {
    return m_can_delete_tasks;
}
void OAIUpdateProjectMember::setCanDeleteTasks(const bool &can_delete_tasks) {
    m_can_delete_tasks = can_delete_tasks;
    m_can_delete_tasks_isSet = true;
}

bool OAIUpdateProjectMember::is_can_delete_tasks_Set() const{
    return m_can_delete_tasks_isSet;
}

bool OAIUpdateProjectMember::is_can_delete_tasks_Valid() const{
    return m_can_delete_tasks_isValid;
}

bool OAIUpdateProjectMember::isCanUpdateTasks() const {
    return m_can_update_tasks;
}
void OAIUpdateProjectMember::setCanUpdateTasks(const bool &can_update_tasks) {
    m_can_update_tasks = can_update_tasks;
    m_can_update_tasks_isSet = true;
}

bool OAIUpdateProjectMember::is_can_update_tasks_Set() const{
    return m_can_update_tasks_isSet;
}

bool OAIUpdateProjectMember::is_can_update_tasks_Valid() const{
    return m_can_update_tasks_isValid;
}

bool OAIUpdateProjectMember::isIsTimesheetAllowed() const {
    return m_is_timesheet_allowed;
}
void OAIUpdateProjectMember::setIsTimesheetAllowed(const bool &is_timesheet_allowed) {
    m_is_timesheet_allowed = is_timesheet_allowed;
    m_is_timesheet_allowed_isSet = true;
}

bool OAIUpdateProjectMember::is_is_timesheet_allowed_Set() const{
    return m_is_timesheet_allowed_isSet;
}

bool OAIUpdateProjectMember::is_is_timesheet_allowed_Valid() const{
    return m_is_timesheet_allowed_isValid;
}

bool OAIUpdateProjectMember::isIsTimesheetApprovalRequired() const {
    return m_is_timesheet_approval_required;
}
void OAIUpdateProjectMember::setIsTimesheetApprovalRequired(const bool &is_timesheet_approval_required) {
    m_is_timesheet_approval_required = is_timesheet_approval_required;
    m_is_timesheet_approval_required_isSet = true;
}

bool OAIUpdateProjectMember::is_is_timesheet_approval_required_Set() const{
    return m_is_timesheet_approval_required_isSet;
}

bool OAIUpdateProjectMember::is_is_timesheet_approval_required_Valid() const{
    return m_is_timesheet_approval_required_isValid;
}

bool OAIUpdateProjectMember::isIsTimesheetApprover() const {
    return m_is_timesheet_approver;
}
void OAIUpdateProjectMember::setIsTimesheetApprover(const bool &is_timesheet_approver) {
    m_is_timesheet_approver = is_timesheet_approver;
    m_is_timesheet_approver_isSet = true;
}

bool OAIUpdateProjectMember::is_is_timesheet_approver_Set() const{
    return m_is_timesheet_approver_isSet;
}

bool OAIUpdateProjectMember::is_is_timesheet_approver_Valid() const{
    return m_is_timesheet_approver_isValid;
}

bool OAIUpdateProjectMember::isSet() const {
...
bool OAIUpdateProjectMember::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_fields_to_update_isValid && m_project_idfk_isValid && m_user_idfk_isValid && true;
}
