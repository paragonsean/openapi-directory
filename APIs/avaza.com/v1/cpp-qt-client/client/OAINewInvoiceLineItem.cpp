...
OAINewInvoiceLineItem::OAINewInvoiceLineItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINewInvoiceLineItem::OAINewInvoiceLineItem() {
    this->initializeModel();
}

OAINewInvoiceLineItem::~OAINewInvoiceLineItem() {}

void OAINewInvoiceLineItem::initializeModel() {
...
void OAINewInvoiceLineItem::fromJson(QString jsonString) {
...
void OAINewInvoiceLineItem::fromJsonObject(QJsonObject json) {
...
QString OAINewInvoiceLineItem::asJson() const {
...
QJsonObject OAINewInvoiceLineItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAINewInvoiceLineItem::getDescription() const {
    return m_description;
}
void OAINewInvoiceLineItem::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAINewInvoiceLineItem::is_description_Set() const{
    return m_description_isSet;
}

bool OAINewInvoiceLineItem::is_description_Valid() const{
    return m_description_isValid;
}

double OAINewInvoiceLineItem::getDiscount() const {
    return m_discount;
}
void OAINewInvoiceLineItem::setDiscount(const double &discount) {
    m_discount = discount;
    m_discount_isSet = true;
}

bool OAINewInvoiceLineItem::is_discount_Set() const{
    return m_discount_isSet;
}

bool OAINewInvoiceLineItem::is_discount_Valid() const{
    return m_discount_isValid;
}

qint32 OAINewInvoiceLineItem::getInventoryItemIdfk() const {
    return m_inventory_item_idfk;
}
void OAINewInvoiceLineItem::setInventoryItemIdfk(const qint32 &inventory_item_idfk) {
    m_inventory_item_idfk = inventory_item_idfk;
    m_inventory_item_idfk_isSet = true;
}

bool OAINewInvoiceLineItem::is_inventory_item_idfk_Set() const{
    return m_inventory_item_idfk_isSet;
}

bool OAINewInvoiceLineItem::is_inventory_item_idfk_Valid() const{
    return m_inventory_item_idfk_isValid;
}

QString OAINewInvoiceLineItem::getInventoryItemName() const {
    return m_inventory_item_name;
}
void OAINewInvoiceLineItem::setInventoryItemName(const QString &inventory_item_name) {
    m_inventory_item_name = inventory_item_name;
    m_inventory_item_name_isSet = true;
}

bool OAINewInvoiceLineItem::is_inventory_item_name_Set() const{
    return m_inventory_item_name_isSet;
}

bool OAINewInvoiceLineItem::is_inventory_item_name_Valid() const{
    return m_inventory_item_name_isValid;
}

qint32 OAINewInvoiceLineItem::getProjectIdfk() const {
    return m_project_idfk;
}
void OAINewInvoiceLineItem::setProjectIdfk(const qint32 &project_idfk) {
    m_project_idfk = project_idfk;
    m_project_idfk_isSet = true;
}

bool OAINewInvoiceLineItem::is_project_idfk_Set() const{
    return m_project_idfk_isSet;
}

bool OAINewInvoiceLineItem::is_project_idfk_Valid() const{
    return m_project_idfk_isValid;
}

double OAINewInvoiceLineItem::getQuantity() const {
    return m_quantity;
}
void OAINewInvoiceLineItem::setQuantity(const double &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAINewInvoiceLineItem::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAINewInvoiceLineItem::is_quantity_Valid() const{
    return m_quantity_isValid;
}

qint32 OAINewInvoiceLineItem::getTaxIdfk() const {
    return m_tax_idfk;
}
void OAINewInvoiceLineItem::setTaxIdfk(const qint32 &tax_idfk) {
    m_tax_idfk = tax_idfk;
    m_tax_idfk_isSet = true;
}

bool OAINewInvoiceLineItem::is_tax_idfk_Set() const{
    return m_tax_idfk_isSet;
}

bool OAINewInvoiceLineItem::is_tax_idfk_Valid() const{
    return m_tax_idfk_isValid;
}

QString OAINewInvoiceLineItem::getTaxName() const {
    return m_tax_name;
}
void OAINewInvoiceLineItem::setTaxName(const QString &tax_name) {
    m_tax_name = tax_name;
    m_tax_name_isSet = true;
}

bool OAINewInvoiceLineItem::is_tax_name_Set() const{
    return m_tax_name_isSet;
}

bool OAINewInvoiceLineItem::is_tax_name_Valid() const{
    return m_tax_name_isValid;
}

double OAINewInvoiceLineItem::getTaxPercent() const {
    return m_tax_percent;
}
void OAINewInvoiceLineItem::setTaxPercent(const double &tax_percent) {
    m_tax_percent = tax_percent;
    m_tax_percent_isSet = true;
}

bool OAINewInvoiceLineItem::is_tax_percent_Set() const{
    return m_tax_percent_isSet;
}

bool OAINewInvoiceLineItem::is_tax_percent_Valid() const{
    return m_tax_percent_isValid;
}

double OAINewInvoiceLineItem::getUnitPrice() const {
    return m_unit_price;
}
void OAINewInvoiceLineItem::setUnitPrice(const double &unit_price) {
    m_unit_price = unit_price;
    m_unit_price_isSet = true;
}

bool OAINewInvoiceLineItem::is_unit_price_Set() const{
    return m_unit_price_isSet;
}

bool OAINewInvoiceLineItem::is_unit_price_Valid() const{
    return m_unit_price_isValid;
}

bool OAINewInvoiceLineItem::isSet() const {
...
bool OAINewInvoiceLineItem::isValid() const {
