...
/*
 * OAIProjectDropdownList.h
 *
 * 
 */

#ifndef OAIProjectDropdownList_H
#define OAIProjectDropdownList_H
...
namespace OpenAPI {
class OAIProjectCompanyGroup;

class OAIProjectDropdownList : public OAIObject {
public:
    OAIProjectDropdownList();
    OAIProjectDropdownList(QString json);
    ~OAIProjectDropdownList() override;
    ...
    QList<OAIProjectCompanyGroup> getCompanies() const;
    void setCompanies(const QList<OAIProjectCompanyGroup> &companies);
...
private:
    ...
    QList<OAIProjectCompanyGroup> m_companies;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectDropdownList)

#endif // OAIProjectDropdownList_H
