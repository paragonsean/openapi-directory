...
/*
 * OAIProjectDropdownSelection.h
 *
 * 
 */

#ifndef OAIProjectDropdownSelection_H
#define OAIProjectDropdownSelection_H
...
class OAIProjectDropdownSelection : public OAIObject {
public:
    OAIProjectDropdownSelection();
    OAIProjectDropdownSelection(QString json);
    ~OAIProjectDropdownSelection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectDropdownSelection)

#endif // OAIProjectDropdownSelection_H
