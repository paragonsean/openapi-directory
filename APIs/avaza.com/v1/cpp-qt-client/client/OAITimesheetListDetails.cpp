...
OAITimesheetListDetails::OAITimesheetListDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITimesheetListDetails::OAITimesheetListDetails() {
    this->initializeModel();
}

OAITimesheetListDetails::~OAITimesheetListDetails() {}

void OAITimesheetListDetails::initializeModel() {
...
void OAITimesheetListDetails::fromJson(QString jsonString) {
...
void OAITimesheetListDetails::fromJsonObject(QJsonObject json) {
...
QString OAITimesheetListDetails::asJson() const {
...
QJsonObject OAITimesheetListDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAITimesheetListDetails::getApprovedBy() const {
    return m_approved_by;
}
void OAITimesheetListDetails::setApprovedBy(const QString &approved_by) {
    m_approved_by = approved_by;
    m_approved_by_isSet = true;
}

bool OAITimesheetListDetails::is_approved_by_Set() const{
    return m_approved_by_isSet;
}

bool OAITimesheetListDetails::is_approved_by_Valid() const{
    return m_approved_by_isValid;
}

QString OAITimesheetListDetails::getCategoryName() const {
    return m_category_name;
}
void OAITimesheetListDetails::setCategoryName(const QString &category_name) {
    m_category_name = category_name;
    m_category_name_isSet = true;
}

bool OAITimesheetListDetails::is_category_name_Set() const{
    return m_category_name_isSet;
}

bool OAITimesheetListDetails::is_category_name_Valid() const{
    return m_category_name_isValid;
}

QString OAITimesheetListDetails::getCustomMetadata() const {
    return m_custom_metadata;
}
void OAITimesheetListDetails::setCustomMetadata(const QString &custom_metadata) {
    m_custom_metadata = custom_metadata;
    m_custom_metadata_isSet = true;
}

bool OAITimesheetListDetails::is_custom_metadata_Set() const{
    return m_custom_metadata_isSet;
}

bool OAITimesheetListDetails::is_custom_metadata_Valid() const{
    return m_custom_metadata_isValid;
}

qint32 OAITimesheetListDetails::getCustomerIdfk() const {
    return m_customer_idfk;
}
void OAITimesheetListDetails::setCustomerIdfk(const qint32 &customer_idfk) {
    m_customer_idfk = customer_idfk;
    m_customer_idfk_isSet = true;
}

bool OAITimesheetListDetails::is_customer_idfk_Set() const{
    return m_customer_idfk_isSet;
}

bool OAITimesheetListDetails::is_customer_idfk_Valid() const{
    return m_customer_idfk_isValid;
}

QString OAITimesheetListDetails::getCustomerName() const {
    return m_customer_name;
}
void OAITimesheetListDetails::setCustomerName(const QString &customer_name) {
    m_customer_name = customer_name;
    m_customer_name_isSet = true;
}

bool OAITimesheetListDetails::is_customer_name_Set() const{
    return m_customer_name_isSet;
}

bool OAITimesheetListDetails::is_customer_name_Valid() const{
    return m_customer_name_isValid;
}

QDateTime OAITimesheetListDetails::getDateApproved() const {
    return m_date_approved;
}
void OAITimesheetListDetails::setDateApproved(const QDateTime &date_approved) {
    m_date_approved = date_approved;
    m_date_approved_isSet = true;
}

bool OAITimesheetListDetails::is_date_approved_Set() const{
    return m_date_approved_isSet;
}

bool OAITimesheetListDetails::is_date_approved_Valid() const{
    return m_date_approved_isValid;
}

QDateTime OAITimesheetListDetails::getDateCreated() const {
    return m_date_created;
}
void OAITimesheetListDetails::setDateCreated(const QDateTime &date_created) {
    m_date_created = date_created;
    m_date_created_isSet = true;
}

bool OAITimesheetListDetails::is_date_created_Set() const{
    return m_date_created_isSet;
}

bool OAITimesheetListDetails::is_date_created_Valid() const{
    return m_date_created_isValid;
}

QDateTime OAITimesheetListDetails::getDateUpdated() const {
    return m_date_updated;
}
void OAITimesheetListDetails::setDateUpdated(const QDateTime &date_updated) {
    m_date_updated = date_updated;
    m_date_updated_isSet = true;
}

bool OAITimesheetListDetails::is_date_updated_Set() const{
    return m_date_updated_isSet;
}

bool OAITimesheetListDetails::is_date_updated_Valid() const{
    return m_date_updated_isValid;
}

double OAITimesheetListDetails::getDuration() const {
    return m_duration;
}
void OAITimesheetListDetails::setDuration(const double &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAITimesheetListDetails::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAITimesheetListDetails::is_duration_Valid() const{
    return m_duration_isValid;
}

QString OAITimesheetListDetails::getEmail() const {
    return m_email;
}
void OAITimesheetListDetails::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAITimesheetListDetails::is_email_Set() const{
    return m_email_isSet;
}

bool OAITimesheetListDetails::is_email_Valid() const{
    return m_email_isValid;
}

QDateTime OAITimesheetListDetails::getEndTimeLocal() const {
    return m_end_time_local;
}
void OAITimesheetListDetails::setEndTimeLocal(const QDateTime &end_time_local) {
    m_end_time_local = end_time_local;
    m_end_time_local_isSet = true;
}

bool OAITimesheetListDetails::is_end_time_local_Set() const{
    return m_end_time_local_isSet;
}

bool OAITimesheetListDetails::is_end_time_local_Valid() const{
    return m_end_time_local_isValid;
}

QDateTime OAITimesheetListDetails::getEndTimeUtc() const {
    return m_end_time_utc;
}
void OAITimesheetListDetails::setEndTimeUtc(const QDateTime &end_time_utc) {
    m_end_time_utc = end_time_utc;
    m_end_time_utc_isSet = true;
}

bool OAITimesheetListDetails::is_end_time_utc_Set() const{
    return m_end_time_utc_isSet;
}

bool OAITimesheetListDetails::is_end_time_utc_Valid() const{
    return m_end_time_utc_isValid;
}

QDateTime OAITimesheetListDetails::getEntryDate() const {
    return m_entry_date;
}
void OAITimesheetListDetails::setEntryDate(const QDateTime &entry_date) {
    m_entry_date = entry_date;
    m_entry_date_isSet = true;
}

bool OAITimesheetListDetails::is_entry_date_Set() const{
    return m_entry_date_isSet;
}

bool OAITimesheetListDetails::is_entry_date_Valid() const{
    return m_entry_date_isValid;
}

QString OAITimesheetListDetails::getFirstname() const {
    return m_firstname;
}
void OAITimesheetListDetails::setFirstname(const QString &firstname) {
    m_firstname = firstname;
    m_firstname_isSet = true;
}

bool OAITimesheetListDetails::is_firstname_Set() const{
    return m_firstname_isSet;
}

bool OAITimesheetListDetails::is_firstname_Valid() const{
    return m_firstname_isValid;
}

bool OAITimesheetListDetails::isHasTimer() const {
    return m_has_timer;
}
void OAITimesheetListDetails::setHasTimer(const bool &has_timer) {
    m_has_timer = has_timer;
    m_has_timer_isSet = true;
}

bool OAITimesheetListDetails::is_has_timer_Set() const{
    return m_has_timer_isSet;
}

bool OAITimesheetListDetails::is_has_timer_Valid() const{
    return m_has_timer_isValid;
}

qint64 OAITimesheetListDetails::getInvoiceIdfk() const {
    return m_invoice_idfk;
}
void OAITimesheetListDetails::setInvoiceIdfk(const qint64 &invoice_idfk) {
    m_invoice_idfk = invoice_idfk;
    m_invoice_idfk_isSet = true;
}

bool OAITimesheetListDetails::is_invoice_idfk_Set() const{
    return m_invoice_idfk_isSet;
}

bool OAITimesheetListDetails::is_invoice_idfk_Valid() const{
    return m_invoice_idfk_isValid;
}

qint64 OAITimesheetListDetails::getInvoiceLineItemIdfk() const {
    return m_invoice_line_item_idfk;
}
void OAITimesheetListDetails::setInvoiceLineItemIdfk(const qint64 &invoice_line_item_idfk) {
    m_invoice_line_item_idfk = invoice_line_item_idfk;
    m_invoice_line_item_idfk_isSet = true;
}

bool OAITimesheetListDetails::is_invoice_line_item_idfk_Set() const{
    return m_invoice_line_item_idfk_isSet;
}

bool OAITimesheetListDetails::is_invoice_line_item_idfk_Valid() const{
    return m_invoice_line_item_idfk_isValid;
}

QString OAITimesheetListDetails::getLastname() const {
    return m_lastname;
}
void OAITimesheetListDetails::setLastname(const QString &lastname) {
    m_lastname = lastname;
    m_lastname_isSet = true;
}

bool OAITimesheetListDetails::is_lastname_Set() const{
    return m_lastname_isSet;
}

bool OAITimesheetListDetails::is_lastname_Valid() const{
    return m_lastname_isValid;
}

QString OAITimesheetListDetails::getNotes() const {
    return m_notes;
}
void OAITimesheetListDetails::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAITimesheetListDetails::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAITimesheetListDetails::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAITimesheetListDetails::getProjectCode() const {
    return m_project_code;
}
void OAITimesheetListDetails::setProjectCode(const QString &project_code) {
    m_project_code = project_code;
    m_project_code_isSet = true;
}

bool OAITimesheetListDetails::is_project_code_Set() const{
    return m_project_code_isSet;
}

bool OAITimesheetListDetails::is_project_code_Valid() const{
    return m_project_code_isValid;
}

qint32 OAITimesheetListDetails::getProjectIdfk() const {
    return m_project_idfk;
}
void OAITimesheetListDetails::setProjectIdfk(const qint32 &project_idfk) {
    m_project_idfk = project_idfk;
    m_project_idfk_isSet = true;
}

bool OAITimesheetListDetails::is_project_idfk_Set() const{
    return m_project_idfk_isSet;
}

bool OAITimesheetListDetails::is_project_idfk_Valid() const{
    return m_project_idfk_isValid;
}

QString OAITimesheetListDetails::getProjectTitle() const {
    return m_project_title;
}
void OAITimesheetListDetails::setProjectTitle(const QString &project_title) {
    m_project_title = project_title;
    m_project_title_isSet = true;
}

bool OAITimesheetListDetails::is_project_title_Set() const{
    return m_project_title_isSet;
}

bool OAITimesheetListDetails::is_project_title_Valid() const{
    return m_project_title_isValid;
}

QDateTime OAITimesheetListDetails::getStartTimeLocal() const {
    return m_start_time_local;
}
void OAITimesheetListDetails::setStartTimeLocal(const QDateTime &start_time_local) {
    m_start_time_local = start_time_local;
    m_start_time_local_isSet = true;
}

bool OAITimesheetListDetails::is_start_time_local_Set() const{
    return m_start_time_local_isSet;
}

bool OAITimesheetListDetails::is_start_time_local_Valid() const{
    return m_start_time_local_isValid;
}

QDateTime OAITimesheetListDetails::getStartTimeUtc() const {
    return m_start_time_utc;
}
void OAITimesheetListDetails::setStartTimeUtc(const QDateTime &start_time_utc) {
    m_start_time_utc = start_time_utc;
    m_start_time_utc_isSet = true;
}

bool OAITimesheetListDetails::is_start_time_utc_Set() const{
    return m_start_time_utc_isSet;
}

bool OAITimesheetListDetails::is_start_time_utc_Valid() const{
    return m_start_time_utc_isValid;
}

qint32 OAITimesheetListDetails::getTaskIdfk() const {
    return m_task_idfk;
}
void OAITimesheetListDetails::setTaskIdfk(const qint32 &task_idfk) {
    m_task_idfk = task_idfk;
    m_task_idfk_isSet = true;
}

bool OAITimesheetListDetails::is_task_idfk_Set() const{
    return m_task_idfk_isSet;
}

bool OAITimesheetListDetails::is_task_idfk_Valid() const{
    return m_task_idfk_isValid;
}

QString OAITimesheetListDetails::getTaskTitle() const {
    return m_task_title;
}
void OAITimesheetListDetails::setTaskTitle(const QString &task_title) {
    m_task_title = task_title;
    m_task_title_isSet = true;
}

bool OAITimesheetListDetails::is_task_title_Set() const{
    return m_task_title_isSet;
}

bool OAITimesheetListDetails::is_task_title_Valid() const{
    return m_task_title_isValid;
}

QDateTime OAITimesheetListDetails::getTimerStartedAtUtc() const {
    return m_timer_started_at_utc;
}
void OAITimesheetListDetails::setTimerStartedAtUtc(const QDateTime &timer_started_at_utc) {
    m_timer_started_at_utc = timer_started_at_utc;
    m_timer_started_at_utc_isSet = true;
}

bool OAITimesheetListDetails::is_timer_started_at_utc_Set() const{
    return m_timer_started_at_utc_isSet;
}

bool OAITimesheetListDetails::is_timer_started_at_utc_Valid() const{
    return m_timer_started_at_utc_isValid;
}

qint32 OAITimesheetListDetails::getTimesheetCategoryIdfk() const {
    return m_timesheet_category_idfk;
}
void OAITimesheetListDetails::setTimesheetCategoryIdfk(const qint32 &timesheet_category_idfk) {
    m_timesheet_category_idfk = timesheet_category_idfk;
    m_timesheet_category_idfk_isSet = true;
}

bool OAITimesheetListDetails::is_timesheet_category_idfk_Set() const{
    return m_timesheet_category_idfk_isSet;
}

bool OAITimesheetListDetails::is_timesheet_category_idfk_Valid() const{
    return m_timesheet_category_idfk_isValid;
}

QString OAITimesheetListDetails::getTimesheetEntryApprovalStatusCode() const {
    return m_timesheet_entry_approval_status_code;
}
void OAITimesheetListDetails::setTimesheetEntryApprovalStatusCode(const QString &timesheet_entry_approval_status_code) {
...
bool OAITimesheetListDetails::is_timesheet_entry_approval_status_code_Set() const{
    return m_timesheet_entry_approval_status_code_isSet;
}

bool OAITimesheetListDetails::is_timesheet_entry_approval_status_code_Valid() const{
    return m_timesheet_entry_approval_status_code_isValid;
}

qint64 OAITimesheetListDetails::getTimesheetEntryId() const {
    return m_timesheet_entry_id;
}
void OAITimesheetListDetails::setTimesheetEntryId(const qint64 &timesheet_entry_id) {
    m_timesheet_entry_id = timesheet_entry_id;
    m_timesheet_entry_id_isSet = true;
}

bool OAITimesheetListDetails::is_timesheet_entry_id_Set() const{
    return m_timesheet_entry_id_isSet;
}

bool OAITimesheetListDetails::is_timesheet_entry_id_Valid() const{
    return m_timesheet_entry_id_isValid;
}

QString OAITimesheetListDetails::getTimesheetUserTimeZone() const {
    return m_timesheet_user_time_zone;
}
void OAITimesheetListDetails::setTimesheetUserTimeZone(const QString &timesheet_user_time_zone) {
    m_timesheet_user_time_zone = timesheet_user_time_zone;
    m_timesheet_user_time_zone_isSet = true;
}

bool OAITimesheetListDetails::is_timesheet_user_time_zone_Set() const{
    return m_timesheet_user_time_zone_isSet;
}

bool OAITimesheetListDetails::is_timesheet_user_time_zone_Valid() const{
    return m_timesheet_user_time_zone_isValid;
}

qint32 OAITimesheetListDetails::getUserIdfk() const {
    return m_user_idfk;
}
void OAITimesheetListDetails::setUserIdfk(const qint32 &user_idfk) {
    m_user_idfk = user_idfk;
    m_user_idfk_isSet = true;
}

bool OAITimesheetListDetails::is_user_idfk_Set() const{
    return m_user_idfk_isSet;
}

bool OAITimesheetListDetails::is_user_idfk_Valid() const{
    return m_user_idfk_isValid;
}

bool OAITimesheetListDetails::isIsBillable() const {
    return m_is_billable;
}
void OAITimesheetListDetails::setIsBillable(const bool &is_billable) {
    m_is_billable = is_billable;
    m_is_billable_isSet = true;
}

bool OAITimesheetListDetails::is_is_billable_Set() const{
    return m_is_billable_isSet;
}

bool OAITimesheetListDetails::is_is_billable_Valid() const{
    return m_is_billable_isValid;
}

bool OAITimesheetListDetails::isIsInvoiced() const {
    return m_is_invoiced;
}
void OAITimesheetListDetails::setIsInvoiced(const bool &is_invoiced) {
    m_is_invoiced = is_invoiced;
    m_is_invoiced_isSet = true;
}

bool OAITimesheetListDetails::is_is_invoiced_Set() const{
    return m_is_invoiced_isSet;
}

bool OAITimesheetListDetails::is_is_invoiced_Valid() const{
    return m_is_invoiced_isValid;
}

bool OAITimesheetListDetails::isSet() const {
...
bool OAITimesheetListDetails::isValid() const {
