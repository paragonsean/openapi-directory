...
/*
 * OAICompanyDropdownList.h
 *
 * 
 */

#ifndef OAICompanyDropdownList_H
#define OAICompanyDropdownList_H
...
namespace OpenAPI {
class OAICompanyMinimal;

class OAICompanyDropdownList : public OAIObject {
public:
    OAICompanyDropdownList();
    OAICompanyDropdownList(QString json);
    ~OAICompanyDropdownList() override;
    ...
    QList<OAICompanyMinimal> getCompanies() const;
    void setCompanies(const QList<OAICompanyMinimal> &companies);
...
private:
    ...
    QList<OAICompanyMinimal> m_companies;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompanyDropdownList)

#endif // OAICompanyDropdownList_H
