...
namespace OpenAPI {
class OAINewBillLineItem;

class OAINewBill : public OAIObject {
public:
    OAINewBill();
    OAINewBill(QString json);
    ~OAINewBill() override;
    ...
    qint32 getBillTemplateIdfk() const;
    void setBillTemplateIdfk(const qint32 &bill_template_idfk);
    bool is_bill_template_idfk_Set() const;
    bool is_bill_template_idfk_Valid() const;
    ...
    QList<OAINewBillLineItem> getLineItems() const;
    void setLineItems(const QList<OAINewBillLineItem> &line_items);
...
private:
    ...
    qint32 m_bill_template_idfk;
    bool m_bill_template_idfk_isSet;
    bool m_bill_template_idfk_isValid;
    ...
    QList<OAINewBillLineItem> m_line_items;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewBill)
