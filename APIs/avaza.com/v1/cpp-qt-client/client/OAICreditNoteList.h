...
#ifndef OAICreditNoteList_H
#define OAICreditNoteList_H
...
class OAICreditNoteList : public OAIObject {
public:
    OAICreditNoteList();
    OAICreditNoteList(QString json);
    ~OAICreditNoteList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreditNoteList)

#endif // OAICreditNoteList_H
