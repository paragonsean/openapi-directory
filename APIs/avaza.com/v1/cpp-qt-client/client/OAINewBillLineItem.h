...
/*
 * OAINewBillLineItem.h
 *
 * Line item to be added to new invoice
 */

#ifndef OAINewBillLineItem_H
#define OAINewBillLineItem_H
...
class OAINewBillLineItem : public OAIObject {
public:
    OAINewBillLineItem();
    OAINewBillLineItem(QString json);
    ~OAINewBillLineItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewBillLineItem)

#endif // OAINewBillLineItem_H
