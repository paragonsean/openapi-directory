...
OAIUpdateTask::OAIUpdateTask(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTask::OAIUpdateTask() {
    this->initializeModel();
}

OAIUpdateTask::~OAIUpdateTask() {}

void OAIUpdateTask::initializeModel() {
...
void OAIUpdateTask::fromJson(QString jsonString) {
...
void OAIUpdateTask::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateTask::asJson() const {
...
QJsonObject OAIUpdateTask::asJsonObject() const {
    QJsonObject obj;
    if (m_assigned_to_user_idfk.size() > 0) {
...
QList<qint32> OAIUpdateTask::getAssignedToUserIdfk() const {
    return m_assigned_to_user_idfk;
}
void OAIUpdateTask::setAssignedToUserIdfk(const QList<qint32> &assigned_to_user_idfk) {
    m_assigned_to_user_idfk = assigned_to_user_idfk;
    m_assigned_to_user_idfk_isSet = true;
}

bool OAIUpdateTask::is_assigned_to_user_idfk_Set() const{
    return m_assigned_to_user_idfk_isSet;
}

bool OAIUpdateTask::is_assigned_to_user_idfk_Valid() const{
    return m_assigned_to_user_idfk_isValid;
}

QDateTime OAIUpdateTask::getDateDue() const {
    return m_date_due;
}
void OAIUpdateTask::setDateDue(const QDateTime &date_due) {
    m_date_due = date_due;
    m_date_due_isSet = true;
}

bool OAIUpdateTask::is_date_due_Set() const{
    return m_date_due_isSet;
}

bool OAIUpdateTask::is_date_due_Valid() const{
    return m_date_due_isValid;
}

QDateTime OAIUpdateTask::getDateStart() const {
    return m_date_start;
}
void OAIUpdateTask::setDateStart(const QDateTime &date_start) {
    m_date_start = date_start;
    m_date_start_isSet = true;
}

bool OAIUpdateTask::is_date_start_Set() const{
    return m_date_start_isSet;
}

bool OAIUpdateTask::is_date_start_Valid() const{
    return m_date_start_isValid;
}

QString OAIUpdateTask::getDescription() const {
    return m_description;
}
void OAIUpdateTask::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateTask::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateTask::is_description_Valid() const{
    return m_description_isValid;
}

double OAIUpdateTask::getEstimatedEffort() const {
    return m_estimated_effort;
}
void OAIUpdateTask::setEstimatedEffort(const double &estimated_effort) {
    m_estimated_effort = estimated_effort;
    m_estimated_effort_isSet = true;
}

bool OAIUpdateTask::is_estimated_effort_Set() const{
    return m_estimated_effort_isSet;
}

bool OAIUpdateTask::is_estimated_effort_Valid() const{
    return m_estimated_effort_isValid;
}

QList<QString> OAIUpdateTask::getFieldsToUpdate() const {
    return m_fields_to_update;
}
void OAIUpdateTask::setFieldsToUpdate(const QList<QString> &fields_to_update) {
    m_fields_to_update = fields_to_update;
    m_fields_to_update_isSet = true;
}

bool OAIUpdateTask::is_fields_to_update_Set() const{
    return m_fields_to_update_isSet;
}

bool OAIUpdateTask::is_fields_to_update_Valid() const{
    return m_fields_to_update_isValid;
}

qint32 OAIUpdateTask::getPercentComplete() const {
    return m_percent_complete;
}
void OAIUpdateTask::setPercentComplete(const qint32 &percent_complete) {
    m_percent_complete = percent_complete;
    m_percent_complete_isSet = true;
}

bool OAIUpdateTask::is_percent_complete_Set() const{
    return m_percent_complete_isSet;
}

bool OAIUpdateTask::is_percent_complete_Valid() const{
    return m_percent_complete_isValid;
}

qint32 OAIUpdateTask::getSectionIdfk() const {
    return m_section_idfk;
}
void OAIUpdateTask::setSectionIdfk(const qint32 &section_idfk) {
    m_section_idfk = section_idfk;
    m_section_idfk_isSet = true;
}

bool OAIUpdateTask::is_section_idfk_Set() const{
    return m_section_idfk_isSet;
}

bool OAIUpdateTask::is_section_idfk_Valid() const{
    return m_section_idfk_isValid;
}

QList<OAINewTag> OAIUpdateTask::getTags() const {
    return m_tags;
}
void OAIUpdateTask::setTags(const QList<OAINewTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUpdateTask::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUpdateTask::is_tags_Valid() const{
    return m_tags_isValid;
}

qint32 OAIUpdateTask::getTaskId() const {
    return m_task_id;
}
void OAIUpdateTask::setTaskId(const qint32 &task_id) {
    m_task_id = task_id;
    m_task_id_isSet = true;
}

bool OAIUpdateTask::is_task_id_Set() const{
    return m_task_id_isSet;
}

bool OAIUpdateTask::is_task_id_Valid() const{
    return m_task_id_isValid;
}

QString OAIUpdateTask::getTaskPriorityCode() const {
    return m_task_priority_code;
}
void OAIUpdateTask::setTaskPriorityCode(const QString &task_priority_code) {
    m_task_priority_code = task_priority_code;
    m_task_priority_code_isSet = true;
}

bool OAIUpdateTask::is_task_priority_code_Set() const{
    return m_task_priority_code_isSet;
}

bool OAIUpdateTask::is_task_priority_code_Valid() const{
    return m_task_priority_code_isValid;
}

QString OAIUpdateTask::getTaskStatusCode() const {
    return m_task_status_code;
}
void OAIUpdateTask::setTaskStatusCode(const QString &task_status_code) {
    m_task_status_code = task_status_code;
    m_task_status_code_isSet = true;
}

bool OAIUpdateTask::is_task_status_code_Set() const{
    return m_task_status_code_isSet;
}

bool OAIUpdateTask::is_task_status_code_Valid() const{
    return m_task_status_code_isValid;
}

QString OAIUpdateTask::getTitle() const {
    return m_title;
}
void OAIUpdateTask::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIUpdateTask::is_title_Set() const{
    return m_title_isSet;
}

bool OAIUpdateTask::is_title_Valid() const{
    return m_title_isValid;
}

bool OAIUpdateTask::isSet() const {
...
bool OAIUpdateTask::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_fields_to_update_isValid && m_task_id_isValid && true;
}
