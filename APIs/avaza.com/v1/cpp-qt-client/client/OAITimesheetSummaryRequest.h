...
/*
 * OAITimesheetSummaryRequest.h
 *
 * 
 */

#ifndef OAITimesheetSummaryRequest_H
#define OAITimesheetSummaryRequest_H
...
class OAITimesheetSummaryRequest : public OAIObject {
public:
    OAITimesheetSummaryRequest();
    OAITimesheetSummaryRequest(QString json);
    ~OAITimesheetSummaryRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimesheetSummaryRequest)

#endif // OAITimesheetSummaryRequest_H
