...
#ifndef OAIPaymentList_H
#define OAIPaymentList_H
...
class OAIPaymentList : public OAIObject {
public:
    OAIPaymentList();
    OAIPaymentList(QString json);
    ~OAIPaymentList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentList)

#endif // OAIPaymentList_H
