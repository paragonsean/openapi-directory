...
#ifndef OAISectionDetails_H
#define OAISectionDetails_H
...
class OAISectionDetails : public OAIObject {
public:
    OAISectionDetails();
    OAISectionDetails(QString json);
    ~OAISectionDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISectionDetails)

#endif // OAISectionDetails_H
