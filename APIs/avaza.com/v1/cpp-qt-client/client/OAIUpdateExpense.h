...
#ifndef OAIUpdateExpense_H
#define OAIUpdateExpense_H
...
class OAIUpdateExpense : public OAIObject {
public:
    OAIUpdateExpense();
    OAIUpdateExpense(QString json);
    ~OAIUpdateExpense() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateExpense)

#endif // OAIUpdateExpense_H
