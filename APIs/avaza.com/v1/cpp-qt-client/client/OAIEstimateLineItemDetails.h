...
/*
 * OAIEstimateLineItemDetails.h
 *
 * 
 */

#ifndef OAIEstimateLineItemDetails_H
#define OAIEstimateLineItemDetails_H
...
class OAIEstimateLineItemDetails : public OAIObject {
public:
    OAIEstimateLineItemDetails();
    OAIEstimateLineItemDetails(QString json);
    ~OAIEstimateLineItemDetails() override;
    ...
    qint64 getEstimateLineItemId() const;
    void setEstimateLineItemId(const qint64 &estimate_line_item_id);
    bool is_estimate_line_item_id_Set() const;
    bool is_estimate_line_item_id_Valid() const;
...
private:
    ...
    qint64 m_estimate_line_item_id;
    bool m_estimate_line_item_id_isSet;
    bool m_estimate_line_item_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEstimateLineItemDetails)

#endif // OAIEstimateLineItemDetails_H
