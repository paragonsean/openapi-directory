...
#include "OAIBillRecipientDetails.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIBillIssuerDetails;
class OAIBillLineItem;
class OAIBillLinks;
class OAIBillRecipientDetails;
...
public:
    ...
    QDateTime getDateVerified() const;
    void setDateVerified(const QDateTime &date_verified);
    bool is_date_verified_Set() const;
    bool is_date_verified_Valid() const;
    ...
    OAIBillIssuerDetails getIssuer() const;
    void setIssuer(const OAIBillIssuerDetails &issuer);
    ...
    OAIBillLinks getLinks() const;
    void setLinks(const OAIBillLinks &links);
    ...
    OAIBillRecipientDetails getRecipient() const;
    void setRecipient(const OAIBillRecipientDetails &recipient);
    ...
    QString getSupplierPoNumber() const;
    void setSupplierPoNumber(const QString &supplier_po_number);
    bool is_supplier_po_number_Set() const;
    bool is_supplier_po_number_Valid() const;
...
private:
    ...
    QDateTime m_date_verified;
    bool m_date_verified_isSet;
    bool m_date_verified_isValid;
    ...
    OAIBillRecipientDetails m_recipient;
    ...
    QString m_supplier_po_number;
    bool m_supplier_po_number_isSet;
    bool m_supplier_po_number_isValid;
