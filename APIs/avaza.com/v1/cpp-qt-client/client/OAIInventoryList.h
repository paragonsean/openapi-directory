...
#ifndef OAIInventoryList_H
#define OAIInventoryList_H
...
class OAIInventoryList : public OAIObject {
public:
    OAIInventoryList();
    OAIInventoryList(QString json);
    ~OAIInventoryList() override;
    ...
    QList<OAIInventoryItem> getInventory() const;
    void setInventory(const QList<OAIInventoryItem> &inventory);
...
private:
    ...
    QList<OAIInventoryItem> m_inventory;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryList)

#endif // OAIInventoryList_H
