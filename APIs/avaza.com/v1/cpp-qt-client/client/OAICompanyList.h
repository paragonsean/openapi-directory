...
#ifndef OAICompanyList_H
#define OAICompanyList_H
...
class OAICompanyList : public OAIObject {
public:
    OAICompanyList();
    OAICompanyList(QString json);
    ~OAICompanyList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompanyList)

#endif // OAICompanyList_H
