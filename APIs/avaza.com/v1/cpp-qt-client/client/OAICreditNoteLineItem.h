...
/*
 * OAICreditNoteLineItem.h
 *
 * 
 */

#ifndef OAICreditNoteLineItem_H
#define OAICreditNoteLineItem_H
...
class OAICreditNoteLineItem : public OAIObject {
public:
    OAICreditNoteLineItem();
    OAICreditNoteLineItem(QString json);
    ~OAICreditNoteLineItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreditNoteLineItem)

#endif // OAICreditNoteLineItem_H
