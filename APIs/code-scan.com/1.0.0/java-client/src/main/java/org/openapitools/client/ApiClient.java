...
public class ApiClient {
    ...
    private String basePath = "https://app.code-scan.com/api";
    ...
    public ApiClient() {
        ...
        authentications.put("codescan_auth", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://app.code-scan.com/api
