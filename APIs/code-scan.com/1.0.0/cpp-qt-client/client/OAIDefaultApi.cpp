...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://app.code-scan.com/api"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("jobGet", defaultConf);
    _serverIndices.insert("jobGet", 0);
    _serverConfigs.insert("jobPost", defaultConf);
    _serverIndices.insert("jobPost", 0);
}
...
void OAIDefaultApi::jobGet(const QString &job_id) {
    QString fullPath = QString(_serverConfigs["jobGet"][_serverIndices.value("jobGet")].URL()+"/job");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::jobGetCallback);
...
void OAIDefaultApi::jobGetCallback(OAIHttpRequestWorker *worker) {
...
void OAIDefaultApi::jobPost(const OAINewJob &job) {
    QString fullPath = QString(_serverConfigs["jobPost"][_serverIndices.value("jobPost")].URL()+"/job");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::jobPostCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::jobPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT jobPostSignal(output);
        Q_EMIT jobPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT jobPostSignalE(output, error_type, error_str);
        Q_EMIT jobPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT jobPostSignalError(output, error_type, error_str);
        Q_EMIT jobPostSignalErrorFull(worker, error_type, error_str);
    }
}
