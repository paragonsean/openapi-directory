...
/*
 * OAIRelatedPartyExternalAccount_account.h
 *
 * 
 */

#ifndef OAIRelatedPartyExternalAccount_account_H
#define OAIRelatedPartyExternalAccount_account_H
...
class OAIRelatedPartyExternalAccount_account : public OAIObject {
public:
    OAIRelatedPartyExternalAccount_account();
    OAIRelatedPartyExternalAccount_account(QString json);
    ~OAIRelatedPartyExternalAccount_account() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRelatedPartyExternalAccount_account)

#endif // OAIRelatedPartyExternalAccount_account_H
