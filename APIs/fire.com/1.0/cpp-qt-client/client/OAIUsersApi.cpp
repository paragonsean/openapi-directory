...
void OAIUsersApi::getUser(const qint64 &user_id) {
    QString fullPath = QString(_serverConfigs["getUser"][_serverIndices.value("getUser")].URL()+"/v1/user/{userId}");
...
void OAIUsersApi::getUsers() {
    QString fullPath = QString(_serverConfigs["getUsers"][_serverIndices.value("getUsers")].URL()+"/v1/users");
