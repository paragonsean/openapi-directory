...
void OAIAuthenticationApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("authenticate", defaultConf);
    _serverIndices.insert("authenticate", 0);
}
...
void OAIAuthenticationApi::authenticate(const OAIAuthentication &oai_authentication) {
    QString fullPath = QString(_serverConfigs["authenticate"][_serverIndices.value("authenticate")].URL()+"/v1/apps/accesstokens");
...

    {
        ...
        QByteArray output = oai_authentication.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationApi::authenticateCallback);
...
void OAIAuthenticationApi::authenticateCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT authenticateSignal(output);
        Q_EMIT authenticateSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT authenticateSignalE(output, error_type, error_str);
        Q_EMIT authenticateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT authenticateSignalError(output, error_type, error_str);
        Q_EMIT authenticateSignalErrorFull(worker, error_type, error_str);
    }
}
