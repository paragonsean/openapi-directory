...
#ifndef OAINewAccount_H
#define OAINewAccount_H
...
class OAINewAccount : public OAIObject {
public:
    OAINewAccount();
    OAINewAccount(QString json);
    ~OAINewAccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewAccount)

#endif // OAINewAccount_H
