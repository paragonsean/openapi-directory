...
/*
 * OAIRelatedPartyFireAccount_account.h
 *
 * 
 */

#ifndef OAIRelatedPartyFireAccount_account_H
#define OAIRelatedPartyFireAccount_account_H
...
class OAIRelatedPartyFireAccount_account : public OAIObject {
public:
    OAIRelatedPartyFireAccount_account();
    OAIRelatedPartyFireAccount_account(QString json);
    ~OAIRelatedPartyFireAccount_account() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRelatedPartyFireAccount_account)

#endif // OAIRelatedPartyFireAccount_account_H
