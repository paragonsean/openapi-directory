...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FireFinancialServicesBusinessApi.Accounts();
  });
  ...
  describe('Accounts', function() {
    it('should create an instance of Accounts', function() {
      ...
      //var instance = new FireFinancialServicesBusinessApi.Accounts();
      //expect(instance).to.be.a(FireFinancialServicesBusinessApi.Accounts);
    });
