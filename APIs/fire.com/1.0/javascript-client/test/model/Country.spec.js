...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FireFinancialServicesBusinessApi.Country();
  });
  ...
  describe('Country', function() {
    it('should create an instance of Country', function() {
      ...
      //var instance = new FireFinancialServicesBusinessApi.Country();
      //expect(instance).to.be.a(FireFinancialServicesBusinessApi.Country);
    });
