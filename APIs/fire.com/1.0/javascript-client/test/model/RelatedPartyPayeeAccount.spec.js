...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FireFinancialServicesBusinessApi.RelatedPartyPayeeAccount();
  });
  ...
  describe('RelatedPartyPayeeAccount', function() {
    it('should create an instance of RelatedPartyPayeeAccount', function() {
      // uncomment below and update the code to test RelatedPartyPayeeAccount
      //var instance = new FireFinancialServicesBusinessApi.RelatedPartyPayeeAccount();
      //expect(instance).to.be.a(FireFinancialServicesBusinessApi.RelatedPartyPayeeAccount);
    });
