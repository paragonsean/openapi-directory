...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FireFinancialServicesBusinessApi.NewCardResponse();
  });
  ...
  describe('NewCardResponse', function() {
    it('should create an instance of NewCardResponse', function() {
      // uncomment below and update the code to test NewCardResponse
      //var instance = new FireFinancialServicesBusinessApi.NewCardResponse();
      //expect(instance).to.be.a(FireFinancialServicesBusinessApi.NewCardResponse);
    });
