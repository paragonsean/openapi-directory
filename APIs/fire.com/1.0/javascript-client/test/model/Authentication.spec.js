...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FireFinancialServicesBusinessApi.Authentication();
  });
  ...
  describe('Authentication', function() {
    it('should create an instance of Authentication', function() {
      ...
      //var instance = new FireFinancialServicesBusinessApi.Authentication();
      //expect(instance).to.be.a(FireFinancialServicesBusinessApi.Authentication);
    });
