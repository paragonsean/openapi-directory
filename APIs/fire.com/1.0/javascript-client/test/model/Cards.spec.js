...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FireFinancialServicesBusinessApi.Cards();
  });
  ...
  describe('Cards', function() {
    it('should create an instance of Cards', function() {
      ...
      //var instance = new FireFinancialServicesBusinessApi.Cards();
      //expect(instance).to.be.a(FireFinancialServicesBusinessApi.Cards);
    });
