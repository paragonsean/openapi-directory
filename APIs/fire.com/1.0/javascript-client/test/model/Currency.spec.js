...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FireFinancialServicesBusinessApi.Currency();
  });
  ...
  describe('Currency', function() {
    it('should create an instance of Currency', function() {
      ...
      //var instance = new FireFinancialServicesBusinessApi.Currency();
      //expect(instance).to.be.a(FireFinancialServicesBusinessApi.Currency);
    });
