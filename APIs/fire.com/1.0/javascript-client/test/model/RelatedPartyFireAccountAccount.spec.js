...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FireFinancialServicesBusinessApi.RelatedPartyFireAccountAccount();
  });
  ...
  describe('RelatedPartyFireAccountAccount', function() {
    it('should create an instance of RelatedPartyFireAccountAccount', function() {
      // uncomment below and update the code to test RelatedPartyFireAccountAccount
      //var instance = new FireFinancialServicesBusinessApi.RelatedPartyFireAccountAccount();
      //expect(instance).to.be.a(FireFinancialServicesBusinessApi.RelatedPartyFireAccountAccount);
    });
