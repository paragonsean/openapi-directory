...
/**
 * The RelatedPartyFireAccountAccount model module.
 * @module model/RelatedPartyFireAccountAccount
 * @version 1.0
 */
class RelatedPartyFireAccountAccount {
    /**
     * Constructs a new <code>RelatedPartyFireAccountAccount</code>.
     * @alias module:model/RelatedPartyFireAccountAccount
     */
    constructor() { 
        
        RelatedPartyFireAccountAccount.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RelatedPartyFireAccountAccount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RelatedPartyFireAccountAccount} obj Optional instance to populate.
     * @return {module:model/RelatedPartyFireAccountAccount} The populated <code>RelatedPartyFireAccountAccount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RelatedPartyFireAccountAccount();
    ...
    /**
     * Validates the JSON data with respect to <code>RelatedPartyFireAccountAccount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RelatedPartyFireAccountAccount</code>.
     */
 ...
 */
RelatedPartyFireAccountAccount.prototype['accountNumber'] = undefined;

/**
 * the name the user gives to the account to help them identify it.
 * @member {String} alias
 */
RelatedPartyFireAccountAccount.prototype['alias'] = undefined;

/**
 * the BIC of the account (provided if currency is EUR).
 * @member {String} bic
 */
RelatedPartyFireAccountAccount.prototype['bic'] = undefined;

/**
 * the IBAN of the account (provided if currency is EUR).
 * @member {String} iban
 */
RelatedPartyFireAccountAccount.prototype['iban'] = undefined;

/**
 * identifier for the fire.com account (assigned by fire.com)
 * @member {Number} id
 */
RelatedPartyFireAccountAccount.prototype['id'] = undefined;

/**
 * the Sort Code of the account.
 * @member {String} nsc
 */
RelatedPartyFireAccountAccount.prototype['nsc'] = undefined;
...
export default RelatedPartyFireAccountAccount;
