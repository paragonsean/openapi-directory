# FireFinancialServicesBusinessApi.DirectDebitDetails
...
**originatorLogoUrlLarge** | **String** | URL pointing to a large version of the Originator Logo (if available) | [optional] 
**originatorLogoUrlSmall** | **String** | URL pointing to a small version of the Originator Logo (if available) | [optional] 
