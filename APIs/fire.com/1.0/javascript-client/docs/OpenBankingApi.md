# FireFinancialServicesBusinessApi.OpenBankingApi

All URIs are relative to *https://api.fire.com/business*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getListOfAspsps**](OpenBankingApi.md#getListOfAspsps) | **GET** /v1/aspsps | Get list of ASPSPs / Banks
[**getPaymentDetails**](OpenBankingApi.md#getPaymentDetails) | **GET** /v1/payments/{paymentUuid} | Get Payment Details
[**newPaymentRequest**](OpenBankingApi.md#newPaymentRequest) | **POST** /v1/paymentrequests | Create a Fire Open Payment request



## getListOfAspsps

> Aspsps getListOfAspsps(opts)
...
let apiInstance = new FireFinancialServicesBusinessApi.OpenBankingApi();
let opts = {
  'currency': "EUR" // String | The three letter code for the currency - either `EUR` or `GBP`. Use this to filter the list for banks that can be used to pay in a certain currency.
};
apiInstance.getListOfAspsps(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
------------- | ------------- | ------------- | -------------
 **currency** | **String**| The three letter code for the currency - either &#x60;EUR&#x60; or &#x60;GBP&#x60;. Use this to filter the list for banks that can be used to pay in a certain currency. | [optional] 
...
> PaymentRequest getPaymentDetails(paymentUuid)
...
let apiInstance = new FireFinancialServicesBusinessApi.OpenBankingApi();
let paymentUuid = "4ADFB67A-0F5B-4A9A-9D74-34437250045C"; // String | 
apiInstance.getPaymentDetails(paymentUuid, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> NewPaymentRequestResponse newPaymentRequest(newPaymentRequest)
...
let apiInstance = new FireFinancialServicesBusinessApi.OpenBankingApi();
let newPaymentRequest = new FireFinancialServicesBusinessApi.NewPaymentRequest(); // NewPaymentRequest | Details of the new payment request
apiInstance.newPaymentRequest(newPaymentRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **newPaymentRequest** | [**NewPaymentRequest**](NewPaymentRequest.md)| Details of the new payment request | 

### Return type

[**NewPaymentRequestResponse**](NewPaymentRequestResponse.md)
