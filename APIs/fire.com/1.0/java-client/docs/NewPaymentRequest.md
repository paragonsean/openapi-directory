...
|**currency** | [**CurrencyEnum**](#CurrencyEnum) | Either &#x60;EUR&#x60; or &#x60;GBP&#x60;, and must correspond to the currency of the account the funds are being lodged into in the &#x60;icanTo&#x60;. |  |
...
|**icanTo** | **Long** | The ican of the account to collect the funds into. Must be one of your fire.com Accounts. |  |
...
|**type** | [**TypeEnum**](#TypeEnum) | The type of Fire Open Payment that was created |  |
