...
<a id="getListOfAspsps"></a>
# **getListOfAspsps**
> Aspsps getListOfAspsps(currency)
...
import org.openapitools.client.api.OpenBankingApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    OpenBankingApi apiInstance = new OpenBankingApi(defaultClient);
    String currency = "EUR"; // String | The three letter code for the currency - either `EUR` or `GBP`. Use this to filter the list for banks that can be used to pay in a certain currency.
    try {
      Aspsps result = apiInstance.getListOfAspsps(currency);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OpenBankingApi#getListOfAspsps");
...
|-------------|-------------|------------------|
| **200** | A list of ASPSPs the customers can use to pay a payment.  |  -  |

<a id="getPaymentDetails"></a>
# **getPaymentDetails**
...
public class Example {
  public static void main(String[] args) {
    ...
    OpenBankingApi apiInstance = new OpenBankingApi(defaultClient);
    String paymentUuid = "4ADFB67A-0F5B-4A9A-9D74-34437250045C"; // String | 
    try {
      PaymentRequest result = apiInstance.getPaymentDetails(paymentUuid);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OpenBankingApi#getPaymentDetails");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | The Payment Request details object |  -  |

<a id="newPaymentRequest"></a>
# **newPaymentRequest**
...
public class Example {
  public static void main(String[] args) {
    ...
    OpenBankingApi apiInstance = new OpenBankingApi(defaultClient);
    NewPaymentRequest newPaymentRequest = new NewPaymentRequest(); // NewPaymentRequest | Details of the new payment request
    try {
      NewPaymentRequestResponse result = apiInstance.newPaymentRequest(newPaymentRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OpenBankingApi#newPaymentRequest");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
