...
void OAIError::fromJsonObject(QJsonObject json) {
    ...
    m_detailed_message_isValid = ::OpenAPI::fromJsonValue(m_detailed_message, json[QString("detailedMessage")]);
    m_detailed_message_isSet = !json[QString("detailedMessage")].isNull() && m_detailed_message_isValid;
...
QJsonObject OAIError::asJsonObject() const {
    ...
    if (m_detailed_message_isSet) {
        obj.insert(QString("detailedMessage"), ::OpenAPI::toJsonValue(m_detailed_message));
    }
    if (m_field_isSet) {
...
QString OAIError::getDetailedMessage() const {
    return m_detailed_message;
}
void OAIError::setDetailedMessage(const QString &detailed_message) {
    m_detailed_message = detailed_message;
    m_detailed_message_isSet = true;
}

bool OAIError::is_detailed_message_Set() const{
    return m_detailed_message_isSet;
}

bool OAIError::is_detailed_message_Valid() const{
