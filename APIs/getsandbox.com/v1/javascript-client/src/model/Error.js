...
class Error {
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['detailedMessage'] && !(typeof data['detailedMessage'] === 'string' || data['detailedMessage'] instanceof String)) {
            throw new Error("Expected the field `detailedMessage` to be a primitive type in the JSON string but got " + data['detailedMessage']);
        }
        // ensure the json data is a string
 ...
 */
Error.prototype['detailedMessage'] = undefined;
