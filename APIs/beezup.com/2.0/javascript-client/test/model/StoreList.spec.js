...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.StoreList();
  });
  ...
  describe('StoreList', function() {
    it('should create an instance of StoreList', function() {
      // uncomment below and update the code to test StoreList
      //var instance = new BeezUpMerchantApi.StoreList();
      //expect(instance).to.be.a(BeezUpMerchantApi.StoreList);
    });
