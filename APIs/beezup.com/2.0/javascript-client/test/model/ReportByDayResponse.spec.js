...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ReportByDayResponse();
  });
  ...
  describe('ReportByDayResponse', function() {
    it('should create an instance of ReportByDayResponse', function() {
      ...
      //var instance = new BeezUpMerchantApi.ReportByDayResponse();
      //expect(instance).to.be.a(BeezUpMerchantApi.ReportByDayResponse);
    });
