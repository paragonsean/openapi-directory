...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.NextContractInfo();
  });
  ...
  describe('NextContractInfo', function() {
    it('should create an instance of NextContractInfo', function() {
      // uncomment below and update the code to test NextContractInfo
      //var instance = new BeezUpMerchantApi.NextContractInfo();
      //expect(instance).to.be.a(BeezUpMerchantApi.NextContractInfo);
    });
