...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.CopyOptimisationResponse();
  });
  ...
  describe('CopyOptimisationResponse', function() {
    it('should create an instance of CopyOptimisationResponse', function() {
      // uncomment below and update the code to test CopyOptimisationResponse
      //var instance = new BeezUpMerchantApi.CopyOptimisationResponse();
      //expect(instance).to.be.a(BeezUpMerchantApi.CopyOptimisationResponse);
    });
