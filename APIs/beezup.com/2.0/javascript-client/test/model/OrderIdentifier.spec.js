...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.OrderIdentifier();
  });
  ...
  describe('OrderIdentifier', function() {
    it('should create an instance of OrderIdentifier', function() {
      // uncomment below and update the code to test OrderIdentifier
      //var instance = new BeezUpMerchantApi.OrderIdentifier();
      //expect(instance).to.be.a(BeezUpMerchantApi.OrderIdentifier);
    });
