...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.TrackedOrderProduct();
  });
  ...
  describe('TrackedOrderProduct', function() {
    it('should create an instance of TrackedOrderProduct', function() {
      ...
      //var instance = new BeezUpMerchantApi.TrackedOrderProduct();
      //expect(instance).to.be.a(BeezUpMerchantApi.TrackedOrderProduct);
    });

    it('should have the property productExists (base name: "productExists")', function() {
      // uncomment below and update the code to test the property productExists
      //var instance = new BeezUpMerchantApi.TrackedOrderProduct();
