...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ImportationCustomColumn();
  });
  ...
  describe('ImportationCustomColumn', function() {
    it('should create an instance of ImportationCustomColumn', function() {
      // uncomment below and update the code to test ImportationCustomColumn
      //var instance = new BeezUpMerchantApi.ImportationCustomColumn();
      //expect(instance).to.be.a(BeezUpMerchantApi.ImportationCustomColumn);
    });
