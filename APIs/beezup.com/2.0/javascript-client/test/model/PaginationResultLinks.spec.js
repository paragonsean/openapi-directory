...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.PaginationResultLinks();
  });
  ...
  describe('PaginationResultLinks', function() {
    it('should create an instance of PaginationResultLinks', function() {
      // uncomment below and update the code to test PaginationResultLinks
      //var instance = new BeezUpMerchantApi.PaginationResultLinks();
      //expect(instance).to.be.a(BeezUpMerchantApi.PaginationResultLinks);
    });
