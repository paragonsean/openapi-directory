...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ContractClickInfo();
  });
  ...
  describe('ContractClickInfo', function() {
    it('should create an instance of ContractClickInfo', function() {
      ...
      //var instance = new BeezUpMerchantApi.ContractClickInfo();
      //expect(instance).to.be.a(BeezUpMerchantApi.ContractClickInfo);
    });
