...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.CustomColumnLinks();
  });
  ...
  describe('CustomColumnLinks', function() {
    it('should create an instance of CustomColumnLinks', function() {
      // uncomment below and update the code to test CustomColumnLinks
      //var instance = new BeezUpMerchantApi.CustomColumnLinks();
      //expect(instance).to.be.a(BeezUpMerchantApi.CustomColumnLinks);
    });
    ...
    it('should have the property saveExpression (base name: "saveExpression")', function() {
      // uncomment below and update the code to test the property saveExpression
      //var instance = new BeezUpMerchantApi.CustomColumnLinks();
      //expect(instance).to.be();
    });
