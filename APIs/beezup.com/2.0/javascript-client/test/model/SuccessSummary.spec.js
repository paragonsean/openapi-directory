...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.SuccessSummary();
  });
  ...
  describe('SuccessSummary', function() {
    it('should create an instance of SuccessSummary', function() {
      // uncomment below and update the code to test SuccessSummary
      //var instance = new BeezUpMerchantApi.SuccessSummary();
      //expect(instance).to.be.a(BeezUpMerchantApi.SuccessSummary);
    });
