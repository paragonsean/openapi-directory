...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.OrderIndexLovLinks();
  });
  ...
  describe('OrderIndexLovLinks', function() {
    it('should create an instance of OrderIndexLovLinks', function() {
      ...
      //var instance = new BeezUpMerchantApi.OrderIndexLovLinks();
      //expect(instance).to.be.a(BeezUpMerchantApi.OrderIndexLovLinks);
    });
