...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.CustomColumn();
  });
  ...
  describe('CustomColumn', function() {
    it('should create an instance of CustomColumn', function() {
      ...
      //var instance = new BeezUpMerchantApi.CustomColumn();
      //expect(instance).to.be.a(BeezUpMerchantApi.CustomColumn);
    });

    it('should have the property catalogColumnDependencies (base name: "catalogColumnDependencies")', function() {
      // uncomment below and update the code to test the property catalogColumnDependencies
      //var instance = new BeezUpMerchantApi.CustomColumn();
