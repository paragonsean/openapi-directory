...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.SubscriptionLinks();
  });
  ...
  describe('SubscriptionLinks', function() {
    it('should create an instance of SubscriptionLinks', function() {
      // uncomment below and update the code to test SubscriptionLinks
      //var instance = new BeezUpMerchantApi.SubscriptionLinks();
      //expect(instance).to.be.a(BeezUpMerchantApi.SubscriptionLinks);
    });
