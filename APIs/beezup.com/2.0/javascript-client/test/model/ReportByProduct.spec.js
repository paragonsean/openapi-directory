...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ReportByProduct();
  });
  ...
  describe('ReportByProduct', function() {
    it('should create an instance of ReportByProduct', function() {
      ...
      //var instance = new BeezUpMerchantApi.ReportByProduct();
      //expect(instance).to.be.a(BeezUpMerchantApi.ReportByProduct);
    });
