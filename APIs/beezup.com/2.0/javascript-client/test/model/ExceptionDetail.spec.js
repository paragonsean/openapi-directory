...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ExceptionDetail();
  });
  ...
  describe('ExceptionDetail', function() {
    it('should create an instance of ExceptionDetail', function() {
      // uncomment below and update the code to test ExceptionDetail
      //var instance = new BeezUpMerchantApi.ExceptionDetail();
      //expect(instance).to.be.a(BeezUpMerchantApi.ExceptionDetail);
    });
