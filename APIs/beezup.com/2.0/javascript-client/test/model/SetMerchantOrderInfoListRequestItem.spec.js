...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.SetMerchantOrderInfoListRequestItem();
  });
  ...
  describe('SetMerchantOrderInfoListRequestItem', function() {
    it('should create an instance of SetMerchantOrderInfoListRequestItem', function() {
      // uncomment below and update the code to test SetMerchantOrderInfoListRequestItem
      //var instance = new BeezUpMerchantApi.SetMerchantOrderInfoListRequestItem();
      //expect(instance).to.be.a(BeezUpMerchantApi.SetMerchantOrderInfoListRequestItem);
    });
