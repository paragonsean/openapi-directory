...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.GetImportationReportResponseImportationInfo();
  });
  ...
  describe('GetImportationReportResponseImportationInfo', function() {
    it('should create an instance of GetImportationReportResponseImportationInfo', function() {
      // uncomment below and update the code to test GetImportationReportResponseImportationInfo
      //var instance = new BeezUpMerchantApi.GetImportationReportResponseImportationInfo();
      //expect(instance).to.be.a(BeezUpMerchantApi.GetImportationReportResponseImportationInfo);
    });
