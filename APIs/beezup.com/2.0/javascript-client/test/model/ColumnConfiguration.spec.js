...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ColumnConfiguration();
  });
  ...
  describe('ColumnConfiguration', function() {
    it('should create an instance of ColumnConfiguration', function() {
      ...
      //var instance = new BeezUpMerchantApi.ColumnConfiguration();
      //expect(instance).to.be.a(BeezUpMerchantApi.ColumnConfiguration);
    });
