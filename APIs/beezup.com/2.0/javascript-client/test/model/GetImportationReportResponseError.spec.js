...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.GetImportationReportResponseError();
  });
  ...
  describe('GetImportationReportResponseError', function() {
    it('should create an instance of GetImportationReportResponseError', function() {
      // uncomment below and update the code to test GetImportationReportResponseError
      //var instance = new BeezUpMerchantApi.GetImportationReportResponseError();
      //expect(instance).to.be.a(BeezUpMerchantApi.GetImportationReportResponseError);
    });
