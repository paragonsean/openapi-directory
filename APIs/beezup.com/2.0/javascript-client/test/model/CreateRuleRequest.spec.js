...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.CreateRuleRequest();
  });
  ...
  describe('CreateRuleRequest', function() {
    it('should create an instance of CreateRuleRequest', function() {
      ...
      //var instance = new BeezUpMerchantApi.CreateRuleRequest();
      //expect(instance).to.be.a(BeezUpMerchantApi.CreateRuleRequest);
    });
