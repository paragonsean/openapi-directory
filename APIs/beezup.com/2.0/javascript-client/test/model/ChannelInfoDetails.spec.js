...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ChannelInfoDetails();
  });
  ...
  describe('ChannelInfoDetails', function() {
    it('should create an instance of ChannelInfoDetails', function() {
      // uncomment below and update the code to test ChannelInfoDetails
      //var instance = new BeezUpMerchantApi.ChannelInfoDetails();
      //expect(instance).to.be.a(BeezUpMerchantApi.ChannelInfoDetails);
    });
