...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ListOfValueItem();
  });
  ...
  describe('ListOfValueItem', function() {
    it('should create an instance of ListOfValueItem', function() {
      // uncomment below and update the code to test ListOfValueItem
      //var instance = new BeezUpMerchantApi.ListOfValueItem();
      //expect(instance).to.be.a(BeezUpMerchantApi.ListOfValueItem);
    });
