...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.UserFriendInfo();
  });
  ...
  describe('UserFriendInfo', function() {
    it('should create an instance of UserFriendInfo', function() {
      ...
      //var instance = new BeezUpMerchantApi.UserFriendInfo();
      //expect(instance).to.be.a(BeezUpMerchantApi.UserFriendInfo);
    });
