...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.PaginationResult();
  });
  ...
  describe('PaginationResult', function() {
    it('should create an instance of PaginationResult', function() {
      // uncomment below and update the code to test PaginationResult
      //var instance = new BeezUpMerchantApi.PaginationResult();
      //expect(instance).to.be.a(BeezUpMerchantApi.PaginationResult);
    });
