...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.CurrentContractInfo();
  });
  ...
  describe('CurrentContractInfo', function() {
    it('should create an instance of CurrentContractInfo', function() {
      // uncomment below and update the code to test CurrentContractInfo
      //var instance = new BeezUpMerchantApi.CurrentContractInfo();
      //expect(instance).to.be.a(BeezUpMerchantApi.CurrentContractInfo);
    });
