...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.PerformanceIndicatorFilter();
  });
  ...
  describe('PerformanceIndicatorFilter', function() {
    it('should create an instance of PerformanceIndicatorFilter', function() {
      // uncomment below and update the code to test PerformanceIndicatorFilter
      //var instance = new BeezUpMerchantApi.PerformanceIndicatorFilter();
      //expect(instance).to.be.a(BeezUpMerchantApi.PerformanceIndicatorFilter);
    });
