...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.TrackedExternalOrder();
  });
  ...
  describe('TrackedExternalOrder', function() {
    it('should create an instance of TrackedExternalOrder', function() {
      ...
      //var instance = new BeezUpMerchantApi.TrackedExternalOrder();
      //expect(instance).to.be.a(BeezUpMerchantApi.TrackedExternalOrder);
    });
