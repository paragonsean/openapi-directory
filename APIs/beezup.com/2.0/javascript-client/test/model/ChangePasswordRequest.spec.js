...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ChangePasswordRequest();
  });
  ...
  describe('ChangePasswordRequest', function() {
    it('should create an instance of ChangePasswordRequest', function() {
      ...
      //var instance = new BeezUpMerchantApi.ChangePasswordRequest();
      //expect(instance).to.be.a(BeezUpMerchantApi.ChangePasswordRequest);
    });
