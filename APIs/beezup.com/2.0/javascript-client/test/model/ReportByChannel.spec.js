...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ReportByChannel();
  });
  ...
  describe('ReportByChannel', function() {
    it('should create an instance of ReportByChannel', function() {
      ...
      //var instance = new BeezUpMerchantApi.ReportByChannel();
      //expect(instance).to.be.a(BeezUpMerchantApi.ReportByChannel);
    });
