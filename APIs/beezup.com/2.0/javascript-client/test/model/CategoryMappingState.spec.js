...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.CategoryMappingState();
  });
  ...
  describe('CategoryMappingState', function() {
    it('should create an instance of CategoryMappingState', function() {
      ...
      //var instance = new BeezUpMerchantApi.CategoryMappingState();
      //expect(instance).to.be.a(BeezUpMerchantApi.CategoryMappingState);
    });
    ...
    it('should have the property withoutCategoryCostProductCount (base name: "withoutCategoryCostProductCount")', function() {
      // uncomment below and update the code to test the property withoutCategoryCostProductCount
      //var instance = new BeezUpMerchantApi.CategoryMappingState();
      //expect(instance).to.be();
    });
