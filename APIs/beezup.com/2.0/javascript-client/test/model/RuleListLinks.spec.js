...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.RuleListLinks();
  });
  ...
  describe('RuleListLinks', function() {
    it('should create an instance of RuleListLinks', function() {
      // uncomment below and update the code to test RuleListLinks
      //var instance = new BeezUpMerchantApi.RuleListLinks();
      //expect(instance).to.be.a(BeezUpMerchantApi.RuleListLinks);
    });
