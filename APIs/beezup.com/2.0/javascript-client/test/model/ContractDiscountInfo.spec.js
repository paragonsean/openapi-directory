...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ContractDiscountInfo();
  });
  ...
  describe('ContractDiscountInfo', function() {
    it('should create an instance of ContractDiscountInfo', function() {
      ...
      //var instance = new BeezUpMerchantApi.ContractDiscountInfo();
      //expect(instance).to.be.a(BeezUpMerchantApi.ContractDiscountInfo);
    });
