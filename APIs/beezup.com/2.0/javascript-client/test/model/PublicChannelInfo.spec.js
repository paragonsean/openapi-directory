...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.PublicChannelInfo();
  });
  ...
  describe('PublicChannelInfo', function() {
    it('should create an instance of PublicChannelInfo', function() {
      // uncomment below and update the code to test PublicChannelInfo
      //var instance = new BeezUpMerchantApi.PublicChannelInfo();
      //expect(instance).to.be.a(BeezUpMerchantApi.PublicChannelInfo);
    });
