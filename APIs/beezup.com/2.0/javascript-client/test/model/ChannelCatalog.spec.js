...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ChannelCatalog();
  });
  ...
  describe('ChannelCatalog', function() {
    it('should create an instance of ChannelCatalog', function() {
      ...
      //var instance = new BeezUpMerchantApi.ChannelCatalog();
      //expect(instance).to.be.a(BeezUpMerchantApi.ChannelCatalog);
    });
    ...
    it('should have the property categoryMappingSettings (base name: "categoryMappingSettings")', function() {
      // uncomment below and update the code to test the property categoryMappingSettings
      //var instance = new BeezUpMerchantApi.ChannelCatalog();
      //expect(instance).to.be();
    });
    ...
    it('should have the property channelCategorySettings (base name: "channelCategorySettings")', function() {
      // uncomment below and update the code to test the property channelCategorySettings
      //var instance = new BeezUpMerchantApi.ChannelCatalog();
      //expect(instance).to.be();
    });

    it('should have the property channelCostSettings (base name: "channelCostSettings")', function() {
      // uncomment below and update the code to test the property channelCostSettings
      //var instance = new BeezUpMerchantApi.ChannelCatalog();
      //expect(instance).to.be();
    });
