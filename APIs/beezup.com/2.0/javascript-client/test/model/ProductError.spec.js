...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ProductError();
  });
  ...
  describe('ProductError', function() {
    it('should create an instance of ProductError', function() {
      // uncomment below and update the code to test ProductError
      //var instance = new BeezUpMerchantApi.ProductError();
      //expect(instance).to.be.a(BeezUpMerchantApi.ProductError);
    });
