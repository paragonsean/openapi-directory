...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ProductErrorCode();
  });
  ...
  describe('ProductErrorCode', function() {
    it('should create an instance of ProductErrorCode', function() {
      // uncomment below and update the code to test ProductErrorCode
      //var instance = new BeezUpMerchantApi.ProductErrorCode();
      //expect(instance).to.be.a(BeezUpMerchantApi.ProductErrorCode);
    });
