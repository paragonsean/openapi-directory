...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ContractCommitmentInfo();
  });
  ...
  describe('ContractCommitmentInfo', function() {
    it('should create an instance of ContractCommitmentInfo', function() {
      ...
      //var instance = new BeezUpMerchantApi.ContractCommitmentInfo();
      //expect(instance).to.be.a(BeezUpMerchantApi.ContractCommitmentInfo);
    });
