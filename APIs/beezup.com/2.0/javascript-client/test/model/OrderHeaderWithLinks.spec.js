...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.OrderHeaderWithLinks();
  });
  ...
  describe('OrderHeaderWithLinks', function() {
    it('should create an instance of OrderHeaderWithLinks', function() {
      // uncomment below and update the code to test OrderHeaderWithLinks
      //var instance = new BeezUpMerchantApi.OrderHeaderWithLinks();
      //expect(instance).to.be.a(BeezUpMerchantApi.OrderHeaderWithLinks);
    });
