...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ImportationReporting();
  });
  ...
  describe('ImportationReporting', function() {
    it('should create an instance of ImportationReporting', function() {
      ...
      //var instance = new BeezUpMerchantApi.ImportationReporting();
      //expect(instance).to.be.a(BeezUpMerchantApi.ImportationReporting);
    });
