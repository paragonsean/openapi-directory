...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpMerchantApi.ProfilePictureInfo();
  });
  ...
  describe('ProfilePictureInfo', function() {
    it('should create an instance of ProfilePictureInfo', function() {
      ...
      //var instance = new BeezUpMerchantApi.ProfilePictureInfo();
      //expect(instance).to.be.a(BeezUpMerchantApi.ProfilePictureInfo);
    });
