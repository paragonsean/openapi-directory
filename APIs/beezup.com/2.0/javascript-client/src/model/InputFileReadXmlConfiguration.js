...
class InputFileReadXmlConfiguration {
     ...
     */
    constructor(flattenXmlChildElements, useXmlAttributes) { 
        
        InputFileReadXmlConfiguration.initialize(this, flattenXmlChildElements, useXmlAttributes);
    }
     ...
     */
    static initialize(obj, flattenXmlChildElements, useXmlAttributes) { 
        obj['flattenXmlChildElements'] = flattenXmlChildElements;
        obj['useXmlAttributes'] = useXmlAttributes;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InputFileReadXmlConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>InputFileReadXmlConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InputFileReadXmlConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InputFileReadXmlConfiguration.RequiredProperties) {
...
InputFileReadXmlConfiguration.RequiredProperties = ["flattenXmlChildElements", "useXmlAttributes"];
 ...
 */
InputFileReadXmlConfiguration.prototype['flattenXmlChildElements'] = undefined;

/**
 * Indicate if the importation should take in account the attribute in the xml nodes.
 * @member {Boolean} useXmlAttributes
 */
InputFileReadXmlConfiguration.prototype['useXmlAttributes'] = undefined;
...
export default InputFileReadXmlConfiguration;
