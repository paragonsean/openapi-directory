...
/**
 * The LinksGetOrderListFullV3Link model module.
 * @module model/LinksGetOrderListFullV3Link
 * @version 2.0
 */
class LinksGetOrderListFullV3Link {
    /**
     * Constructs a new <code>LinksGetOrderListFullV3Link</code>.
     * @alias module:model/LinksGetOrderListFullV3Link
     * @implements module:model/Link3
     * @param href {String} Indicate the relative uri for this link
     */
    constructor(href) { 
        Link3.initialize(this, href);
        LinksGetOrderListFullV3Link.initialize(this, href);
    }
    ...
    /**
     * Constructs a <code>LinksGetOrderListFullV3Link</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LinksGetOrderListFullV3Link} obj Optional instance to populate.
     * @return {module:model/LinksGetOrderListFullV3Link} The populated <code>LinksGetOrderListFullV3Link</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinksGetOrderListFullV3Link();
    ...
    /**
     * Validates the JSON data with respect to <code>LinksGetOrderListFullV3Link</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinksGetOrderListFullV3Link</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LinksGetOrderListFullV3Link.RequiredProperties) {
...
LinksGetOrderListFullV3Link.RequiredProperties = ["href"];

/**
 * indicates whether all optionals params have been provided
 * @member {Boolean} allOptionalParamsProvided
 */
LinksGetOrderListFullV3Link.prototype['allOptionalParamsProvided'] = undefined;

/**
 * indicates whether all required params have been provided
 * @member {Boolean} allRequiredParamsProvided
 */
LinksGetOrderListFullV3Link.prototype['allRequiredParamsProvided'] = undefined;

/**
 * The description of the link
 * @member {String} description
 */
LinksGetOrderListFullV3Link.prototype['description'] = undefined;

/**
 * The documentation related to this operation.
 * @member {String} docUrl
 */
LinksGetOrderListFullV3Link.prototype['docUrl'] = undefined;

/**
 * Indicate the relative uri for this link
 * @member {String} href
 */
LinksGetOrderListFullV3Link.prototype['href'] = undefined;

/**
 * @member {module:model/InfoSummaries} info
 */
LinksGetOrderListFullV3Link.prototype['info'] = undefined;

/**
 * The label corresponding to the link. This label is automatically translated based on the Accept-Language http header.
 * @member {String} label
 */
LinksGetOrderListFullV3Link.prototype['label'] = undefined;

/**
 * @member {module:model/HttpMethod} method
 */
LinksGetOrderListFullV3Link.prototype['method'] = undefined;

/**
 * The operationId to call.
 * @member {String} operationId
 */
LinksGetOrderListFullV3Link.prototype['operationId'] = undefined;

/**
 * @member {Object.<String, module:model/LinkParameter3>} parameters
 */
LinksGetOrderListFullV3Link.prototype['parameters'] = undefined;

/**
 * Indicate the relation name related to the link
 * @member {String} rel
 */
LinksGetOrderListFullV3Link.prototype['rel'] = undefined;

/**
 * indicates whether the href is templated or not
 * @member {Boolean} urlTemplated
 */
LinksGetOrderListFullV3Link.prototype['urlTemplated'] = undefined;
...
export default LinksGetOrderListFullV3Link;
