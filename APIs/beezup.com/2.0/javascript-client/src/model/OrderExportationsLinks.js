...
class OrderExportationsLinks {
    ...
    constructor(self) { 
        ...
        OrderExportationsLinks.initialize(this, self);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderExportationsLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderExportationsLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderExportationsLinks</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderExportationsLinks.RequiredProperties) {
        ...
        if (data['self']) { // data not null
          LinksGetOrderExportationsLink.validateJSON(data['self']);
        }
...
OrderExportationsLinks.RequiredProperties = ["self"];

/**
 * @member {module:model/LinksGetOrderExportationsLink} self
 */
OrderExportationsLinks.prototype['self'] = undefined;
...
export default OrderExportationsLinks;
