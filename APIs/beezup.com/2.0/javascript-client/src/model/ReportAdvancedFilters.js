...
import LinkClickToOrderType from './LinkClickToOrderType';
...
class ReportAdvancedFilters {
     ...
     * @param marginType {module:model/MarginType} 
     ...
     */
    constructor(linkClickToOrderType, marginType, onlyDirectSales, onlyPaymentValidatedOrders, performanceIndicatorFormula) { 
        
        ReportAdvancedFilters.initialize(this, linkClickToOrderType, marginType, onlyDirectSales, onlyPaymentValidatedOrders, performanceIndicatorFormula);
    }
     ...
     */
    static initialize(obj, linkClickToOrderType, marginType, onlyDirectSales, onlyPaymentValidatedOrders, performanceIndicatorFormula) { 
        obj['linkClickToOrderType'] = linkClickToOrderType;
        obj['marginType'] = marginType;
        obj['onlyDirectSales'] = onlyDirectSales || false;
        obj['onlyPaymentValidatedOrders'] = onlyPaymentValidatedOrders || false;
        obj['performanceIndicatorFormula'] = performanceIndicatorFormula;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportAdvancedFilters();
            ...
            if (data.hasOwnProperty('marginType')) {
                obj['marginType'] = MarginType.constructFromObject(data['marginType']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ReportAdvancedFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReportAdvancedFilters</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReportAdvancedFilters.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `performanceIndicatorFormula`
        if (data['performanceIndicatorFormula']) { // data not null
          PerformanceIndicatorFormula.validateJSON(data['performanceIndicatorFormula']);
        }
...
ReportAdvancedFilters.RequiredProperties = ["linkClickToOrderType", "marginType", "onlyDirectSales", "onlyPaymentValidatedOrders", "performanceIndicatorFormula"];

/**
 * If the margin type is 'Global', indicate the percentage of sale price.
 * @member {Number} globalMarginPercent
 */
ReportAdvancedFilters.prototype['globalMarginPercent'] = undefined;
 ...
 */
ReportAdvancedFilters.prototype['linkClickToOrderMaxDay'] = undefined;

/**
 * @member {module:model/LinkClickToOrderType} linkClickToOrderType
 */
ReportAdvancedFilters.prototype['linkClickToOrderType'] = undefined;

/**
 * @member {module:model/MarginType} marginType
 */
ReportAdvancedFilters.prototype['marginType'] = undefined;
 ...
 * @default false
 */
ReportAdvancedFilters.prototype['onlyDirectSales'] = false;
 ...
 * @default false
 */
ReportAdvancedFilters.prototype['onlyPaymentValidatedOrders'] = false;

/**
 * @member {module:model/PerformanceIndicatorFormula} performanceIndicatorFormula
 */
ReportAdvancedFilters.prototype['performanceIndicatorFormula'] = undefined;
...
export default ReportAdvancedFilters;
