...
class ReportFilter {
     ...
     */
    constructor(parameters, reportFilterId, reportFilterName) { 
        
        ReportFilter.initialize(this, parameters, reportFilterId, reportFilterName);
    }
     ...
     */
    static initialize(obj, parameters, reportFilterId, reportFilterName) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of ReportFilter.RequiredProperties) {
        ...
        if (data['links']) { // data not null
          ReportFilterLinks.validateJSON(data['links']);
        }
        // validate the optional field `parameters`
        if (data['parameters']) { // data not null
          ReportFilterParameters.validateJSON(data['parameters']);
        }
...
ReportFilter.RequiredProperties = ["parameters", "reportFilterId", "reportFilterName"];

/**
 * @member {module:model/ReportFilterLinks} links
 */
ReportFilter.prototype['links'] = undefined;

/**
 * @member {module:model/ReportFilterParameters} parameters
 */
ReportFilter.prototype['parameters'] = undefined;

/**
 * Report filter identifier
 * @member {String} reportFilterId
 */
ReportFilter.prototype['reportFilterId'] = undefined;

/**
 * Report filter name
 * @member {String} reportFilterName
 */
ReportFilter.prototype['reportFilterName'] = undefined;
