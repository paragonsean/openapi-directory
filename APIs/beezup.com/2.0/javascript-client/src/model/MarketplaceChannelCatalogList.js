...
class MarketplaceChannelCatalogList {
     ...
     */
    constructor(links, marketplaceChannelCatalogs) { 
        
        MarketplaceChannelCatalogList.initialize(this, links, marketplaceChannelCatalogs);
    }
     ...
     */
    static initialize(obj, links, marketplaceChannelCatalogs) { 
        obj['links'] = links;
        obj['marketplaceChannelCatalogs'] = marketplaceChannelCatalogs;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MarketplaceChannelCatalogList();
    ...
    /**
     * Validates the JSON data with respect to <code>MarketplaceChannelCatalogList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MarketplaceChannelCatalogList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MarketplaceChannelCatalogList.RequiredProperties) {
        ...
        if (data['links']) { // data not null
          MarketplaceChannelCatalogListLinks.validateJSON(data['links']);
        }
        if (data['marketplaceChannelCatalogs']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['marketplaceChannelCatalogs'])) {
                throw new Error("Expected the field `marketplaceChannelCatalogs` to be an array in the JSON data but got " + data['marketplaceChannelCatalogs']);
            }
            // validate the optional field `marketplaceChannelCatalogs` (array)
            for (const item of data['marketplaceChannelCatalogs']) {
                MarketplaceChannelCatalog.validateJSON(item);
            };
        }
...
MarketplaceChannelCatalogList.RequiredProperties = ["links", "marketplaceChannelCatalogs"];

/**
 * @member {module:model/MarketplaceChannelCatalogListLinks} links
 */
MarketplaceChannelCatalogList.prototype['links'] = undefined;

/**
 * The list of marketplace channel catalog
 * @member {Array.<module:model/MarketplaceChannelCatalog>} marketplaceChannelCatalogs
 */
MarketplaceChannelCatalogList.prototype['marketplaceChannelCatalogs'] = undefined;
...
export default MarketplaceChannelCatalogList;
