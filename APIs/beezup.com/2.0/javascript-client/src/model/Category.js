...
class Category {
     ...
     * @param categoryPath {Array.<String>} The catalog category path
     * @param selfProductCount {Number} The product count related to this category
     * @param totalProductCount {Number} The total product count related to this category and his sub categories
     */
    constructor(categoryPath, selfProductCount, totalProductCount) { 
        
        Category.initialize(this, categoryPath, selfProductCount, totalProductCount);
    }
     ...
     */
    static initialize(obj, categoryPath, selfProductCount, totalProductCount) { 
        obj['categoryPath'] = categoryPath;
        obj['selfProductCount'] = selfProductCount;
        obj['totalProductCount'] = totalProductCount;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('selfProductCount')) {
                obj['selfProductCount'] = ApiClient.convertToType(data['selfProductCount'], 'Number');
            }
...
Category.RequiredProperties = ["categoryPath", "selfProductCount", "totalProductCount"];
 ...
 */
Category.prototype['categoryPath'] = undefined;

/**
 * The product count related to this category
 * @member {Number} selfProductCount
 */
Category.prototype['selfProductCount'] = undefined;

/**
 * The total product count related to this category and his sub categories
 * @member {Number} totalProductCount
 */
Category.prototype['totalProductCount'] = undefined;
