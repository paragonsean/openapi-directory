...
class BatchOrderOperationResponse {
     ...
     * @param operations {Array.<module:model/OrderOperationResponse>} 
     */
    constructor(operations) { 
        
        BatchOrderOperationResponse.initialize(this, operations);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchOrderOperationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchOrderOperationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchOrderOperationResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchOrderOperationResponse.RequiredProperties) {
        ...
        if (data['operations']) { // data not null
            ...
            for (const item of data['operations']) {
                OrderOperationResponse.validateJSON(item);
            };
        }
...
BatchOrderOperationResponse.RequiredProperties = ["operations"];

/**
 * @member {Array.<module:model/OrderOperationResponse>} operations
 */
BatchOrderOperationResponse.prototype['operations'] = undefined;
...
export default BatchOrderOperationResponse;
