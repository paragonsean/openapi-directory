...
class BeezUPCommonLOVLink3 {
    ...
    constructor(href) { 
        ...
        BeezUPCommonLOVLink3.initialize(this, href);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BeezUPCommonLOVLink3();
    ...
    /**
     * Validates the JSON data with respect to <code>BeezUPCommonLOVLink3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BeezUPCommonLOVLink3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BeezUPCommonLOVLink3.RequiredProperties) {
...
BeezUPCommonLOVLink3.RequiredProperties = ["href"];

/**
 * Indicate the uri to the list of value
 * @member {String} href
 */
BeezUPCommonLOVLink3.prototype['href'] = undefined;

/**
 * @member {module:model/BeezUPCommonHttpMethod} method
 */
BeezUPCommonLOVLink3.prototype['method'] = undefined;
...
export default BeezUPCommonLOVLink3;
