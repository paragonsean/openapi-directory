...
class Product {
     ...
     * @param categoryId {String} The catalog category identifier
     * @param exists {Boolean} Indicates if the product exists in the current catalog
     * @param productId {String} The product identifier
     * @param values {Object.<String, String>} The key is the column identifier
     */
    constructor(categoryId, exists, productId, values) { 
        
        Product.initialize(this, categoryId, exists, productId, values);
    }
     ...
     */
    static initialize(obj, categoryId, exists, productId, values) { 
...
Product.RequiredProperties = ["categoryId", "exists", "productId", "values"];
 ...
 */
Product.prototype['exists'] = undefined;
