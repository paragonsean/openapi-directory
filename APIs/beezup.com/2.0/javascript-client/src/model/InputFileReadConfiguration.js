...
import FileFormatStrategy from './FileFormatStrategy';
...
class InputFileReadConfiguration {
    ...
    constructor(format) { 
        ...
        InputFileReadConfiguration.initialize(this, format);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InputFileReadConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>InputFileReadConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InputFileReadConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InputFileReadConfiguration.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `csvFileReadProperties`
        if (data['csvFileReadProperties']) { // data not null
          InputFileReadCsvConfiguration.validateJSON(data['csvFileReadProperties']);
        }
        ...
        // ensure the json data is a string
        if (data['encodingTypeName'] && !(typeof data['encodingTypeName'] === 'string' || data['encodingTypeName'] instanceof String)) {
            throw new Error("Expected the field `encodingTypeName` to be a primitive type in the JSON string but got " + data['encodingTypeName']);
        }
        // validate the optional field `xmlFileReadProperties`
        if (data['xmlFileReadProperties']) { // data not null
          InputFileReadXmlConfiguration.validateJSON(data['xmlFileReadProperties']);
        }
...
InputFileReadConfiguration.RequiredProperties = ["format"];

/**
 * @member {module:model/InputFileReadCsvConfiguration} csvFileReadProperties
 */
InputFileReadConfiguration.prototype['csvFileReadProperties'] = undefined;
 ...
 * @default ''
 */
InputFileReadConfiguration.prototype['cultureName'] = '';
 ...
 * @default 'UTF-8'
 */
InputFileReadConfiguration.prototype['encodingTypeName'] = 'UTF-8';

/**
 * @member {module:model/FileFormatStrategy} format
 */
InputFileReadConfiguration.prototype['format'] = undefined;

/**
 * @member {module:model/InputFileReadXmlConfiguration} xmlFileReadProperties
 */
InputFileReadConfiguration.prototype['xmlFileReadProperties'] = undefined;
...
export default InputFileReadConfiguration;
