...
class LinksUpdateRuleLink {
    ...
    constructor(href) { 
        ...
        LinksUpdateRuleLink.initialize(this, href);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinksUpdateRuleLink();
    ...
    /**
     * Validates the JSON data with respect to <code>LinksUpdateRuleLink</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinksUpdateRuleLink</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LinksUpdateRuleLink.RequiredProperties) {
...
export default LinksUpdateRuleLink;
