...
class PublicLovIndexLinks {
    ...
    constructor() { 
        ...
        PublicLovIndexLinks.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicLovIndexLinks();

            if (data.hasOwnProperty('lists')) {
                obj['lists'] = ApiClient.convertToType(data['lists'], {'String': LinksGetPublicListOfValuesLink});
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PublicLovIndexLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicLovIndexLinks</code>.
     */
    static validateJSON(data) {
        // validate the optional field `self`
        if (data['self']) { // data not null
          LinksGetPublicLovIndexLink.validateJSON(data['self']);
        }
 ...
 * @member {Object.<String, module:model/LinksGetPublicListOfValuesLink>} lists
 */
PublicLovIndexLinks.prototype['lists'] = undefined;

/**
 * @member {module:model/LinksGetPublicLovIndexLink} self
 */
PublicLovIndexLinks.prototype['self'] = undefined;
...
export default PublicLovIndexLinks;
