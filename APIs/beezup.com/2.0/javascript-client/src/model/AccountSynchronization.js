...
class AccountSynchronization {
     ...
     */
    constructor(accountId, marketplaceBusinessCode, marketplaceTechnicalCode) { 
        
        AccountSynchronization.initialize(this, accountId, marketplaceBusinessCode, marketplaceTechnicalCode);
    }
     ...
     */
    static initialize(obj, accountId, marketplaceBusinessCode, marketplaceTechnicalCode) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountSynchronization();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountSynchronization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountSynchronization</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountSynchronization.RequiredProperties) {
...
AccountSynchronization.RequiredProperties = ["accountId", "marketplaceBusinessCode", "marketplaceTechnicalCode"];

/**
 * The marketplace account identifier in BeezUP. This account identifier is based on your api settings.
 * @member {Number} accountId
 */
AccountSynchronization.prototype['accountId'] = undefined;

/**
 * @member {Date} completedHarvestSynchroUtcDate
 */
AccountSynchronization.prototype['completedHarvestSynchroUtcDate'] = undefined;
 ...
 */
AccountSynchronization.prototype['marketplaceBusinessCode'] = undefined;

/**
 * The technical code of the marketplace.
 * @member {String} marketplaceTechnicalCode
 */
AccountSynchronization.prototype['marketplaceTechnicalCode'] = undefined;
