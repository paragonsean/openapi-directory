...
class ChannelCatalogExportCacheInfo {
     ...
     */
    constructor(cacheStatus) { 
        
        ChannelCatalogExportCacheInfo.initialize(this, cacheStatus);
    }
     ...
     */
    static initialize(obj, cacheStatus) { 
        obj['cacheStatus'] = cacheStatus;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChannelCatalogExportCacheInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>ChannelCatalogExportCacheInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChannelCatalogExportCacheInfo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChannelCatalogExportCacheInfo.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['feedUrl'] && !(typeof data['feedUrl'] === 'string' || data['feedUrl'] instanceof String)) {
            throw new Error("Expected the field `feedUrl` to be a primitive type in the JSON string but got " + data['feedUrl']);
        }
...
ChannelCatalogExportCacheInfo.RequiredProperties = ["cacheStatus"];

/**
 * The cache status
 * @member {String} cacheStatus
 */
ChannelCatalogExportCacheInfo.prototype['cacheStatus'] = undefined;

/**
 * The expiration UTC date of the cache
 * @member {Date} expirationUtcDate
 */
ChannelCatalogExportCacheInfo.prototype['expirationUtcDate'] = undefined;

/**
 * The feed url
 * @member {String} feedUrl
 */
ChannelCatalogExportCacheInfo.prototype['feedUrl'] = undefined;

/**
 * The last content change UTC date
 * @member {Date} lastContentChangeUtcDate
 */
ChannelCatalogExportCacheInfo.prototype['lastContentChangeUtcDate'] = undefined;

/**
 * The last update UTC date of the cache
 * @member {Date} lastUpdateUtcDate
 */
ChannelCatalogExportCacheInfo.prototype['lastUpdateUtcDate'] = undefined;
...
export default ChannelCatalogExportCacheInfo;
