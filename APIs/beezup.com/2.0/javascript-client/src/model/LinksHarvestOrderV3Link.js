...
/**
 * The LinksHarvestOrderV3Link model module.
 * @module model/LinksHarvestOrderV3Link
 * @version 2.0
 */
class LinksHarvestOrderV3Link {
    /**
     * Constructs a new <code>LinksHarvestOrderV3Link</code>.
     * @alias module:model/LinksHarvestOrderV3Link
     * @implements module:model/Link3
     * @param href {String} Indicate the relative uri for this link
     */
    constructor(href) { 
        Link3.initialize(this, href);
        LinksHarvestOrderV3Link.initialize(this, href);
    }
    ...
    /**
     * Constructs a <code>LinksHarvestOrderV3Link</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LinksHarvestOrderV3Link} obj Optional instance to populate.
     * @return {module:model/LinksHarvestOrderV3Link} The populated <code>LinksHarvestOrderV3Link</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinksHarvestOrderV3Link();
    ...
    /**
     * Validates the JSON data with respect to <code>LinksHarvestOrderV3Link</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinksHarvestOrderV3Link</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LinksHarvestOrderV3Link.RequiredProperties) {
...
export default LinksHarvestOrderV3Link;
