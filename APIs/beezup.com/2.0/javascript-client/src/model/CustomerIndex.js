...
class CustomerIndex {
    ...
    constructor(links, lovLinks) { 
        ...
        CustomerIndex.initialize(this, links, lovLinks);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CustomerIndex</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomerIndex</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomerIndex.RequiredProperties) {
        ...
        if (data['links']) { // data not null
          CustomerIndexLinks.validateJSON(data['links']);
        }
        // validate the optional field `lovLinks`
        if (data['lovLinks']) { // data not null
          CustomerIndexLovLinks.validateJSON(data['lovLinks']);
        }
...
CustomerIndex.RequiredProperties = ["links", "lovLinks"];

/**
 * @member {module:model/CustomerIndexLinks} links
 */
CustomerIndex.prototype['links'] = undefined;

/**
 * @member {module:model/CustomerIndexLovLinks} lovLinks
 */
CustomerIndex.prototype['lovLinks'] = undefined;
