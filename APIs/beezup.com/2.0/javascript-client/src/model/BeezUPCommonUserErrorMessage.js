...
import BeezUPCommonUserErrorMessageArgumentsInner from './BeezUPCommonUserErrorMessageArgumentsInner';
...
class BeezUPCommonUserErrorMessage {
    ...
    constructor(code, message) { 
        ...
        BeezUPCommonUserErrorMessage.initialize(this, code, message);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BeezUPCommonUserErrorMessage();

            if (data.hasOwnProperty('arguments')) {
                obj['arguments'] = ApiClient.convertToType(data['arguments'], [BeezUPCommonUserErrorMessageArgumentsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BeezUPCommonUserErrorMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BeezUPCommonUserErrorMessage</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BeezUPCommonUserErrorMessage.RequiredProperties) {
        ...
        if (data['arguments']) { // data not null
            ...
            for (const item of data['arguments']) {
                BeezUPCommonUserErrorMessageArgumentsInner.validateJSON(item);
            };
        }
...
BeezUPCommonUserErrorMessage.RequiredProperties = ["code", "message"];

/**
 * a dictionary string/object
 * @member {Array.<module:model/BeezUPCommonUserErrorMessageArgumentsInner>} arguments
 */
BeezUPCommonUserErrorMessage.prototype['arguments'] = undefined;

/**
 * the error code. The error code can be a pattern containing the argument's name
 * @member {String} code
 */
BeezUPCommonUserErrorMessage.prototype['code'] = undefined;

/**
 * If the error is translated, the culture name will be indicated
 * @member {String} cultureName
 */
BeezUPCommonUserErrorMessage.prototype['cultureName'] = undefined;

/**
 * The documentation related to this operation.
 * @member {String} docUrl
 */
BeezUPCommonUserErrorMessage.prototype['docUrl'] = undefined;

/**
 * The error message
 * @member {String} message
 */
BeezUPCommonUserErrorMessage.prototype['message'] = undefined;
...
export default BeezUPCommonUserErrorMessage;
