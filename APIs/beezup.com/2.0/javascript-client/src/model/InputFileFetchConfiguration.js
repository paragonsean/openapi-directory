...
import CompressionFormatStrategy from './CompressionFormatStrategy';
import Credential from './Credential';
import DownloadCatalogStrategy from './DownloadCatalogStrategy';
...
class InputFileFetchConfiguration {
     ...
     */
    constructor(downloadCatalogStrategy, uri) { 
        
        InputFileFetchConfiguration.initialize(this, downloadCatalogStrategy, uri);
    }
     ...
     */
    static initialize(obj, downloadCatalogStrategy, uri) { 
        obj['downloadCatalogStrategy'] = downloadCatalogStrategy;
        obj['uri'] = uri;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InputFileFetchConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>InputFileFetchConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InputFileFetchConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InputFileFetchConfiguration.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['compressedRelativePath'] && !(typeof data['compressedRelativePath'] === 'string' || data['compressedRelativePath'] instanceof String)) {
            throw new Error("Expected the field `compressedRelativePath` to be a primitive type in the JSON string but got " + data['compressedRelativePath']);
        }
        // validate the optional field `credential`
        if (data['credential']) { // data not null
          Credential.validateJSON(data['credential']);
        }
        // ensure the json data is a string
...
InputFileFetchConfiguration.RequiredProperties = ["downloadCatalogStrategy", "uri"];

/**
 * Indicate the relative path in the compressed file
 * @member {String} compressedRelativePath
 */
InputFileFetchConfiguration.prototype['compressedRelativePath'] = undefined;

/**
 * @member {module:model/CompressionFormatStrategy} compressionFormatStrategy
 */
InputFileFetchConfiguration.prototype['compressionFormatStrategy'] = undefined;

/**
 * @member {module:model/Credential} credential
 */
InputFileFetchConfiguration.prototype['credential'] = undefined;

/**
 * @member {module:model/DownloadCatalogStrategy} downloadCatalogStrategy
 */
InputFileFetchConfiguration.prototype['downloadCatalogStrategy'] = undefined;

/**
 * Indicate the download time out in second
 * @member {Number} downloadTimeout
 */
InputFileFetchConfiguration.prototype['downloadTimeout'] = undefined;

/**
 * Indicate the Uri of the file. (http, https, ftp, ftps, sftp are allowed)
 * @member {String} uri
 */
InputFileFetchConfiguration.prototype['uri'] = undefined;
...
export default InputFileFetchConfiguration;
