...
class AutomaticTransition {
     ...
     */
    constructor(accountId, enabled, marketplaceTechnicalCode, orderStatusTransitionId) { 
     ...
     */
    static initialize(obj, accountId, enabled, marketplaceTechnicalCode, orderStatusTransitionId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutomaticTransition();
    ...
    /**
     * Validates the JSON data with respect to <code>AutomaticTransition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutomaticTransition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AutomaticTransition.RequiredProperties) {
...
AutomaticTransition.RequiredProperties = ["accountId", "enabled", "marketplaceTechnicalCode", "orderStatusTransitionId"];
...
export default AutomaticTransition;
