...
class UpdateStoreRequest {
     ...
     */
    constructor(name, sectors, url) { 
        
        UpdateStoreRequest.initialize(this, name, sectors, url);
    }
     ...
     */
    static initialize(obj, name, sectors, url) { 
        obj['name'] = name;
        obj['sectors'] = sectors;
        obj['url'] = url;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of UpdateStoreRequest.RequiredProperties) {
...
UpdateStoreRequest.RequiredProperties = ["name", "sectors", "url"];

/**
 * The store name. Must be unique.
 * @member {String} name
 */
UpdateStoreRequest.prototype['name'] = undefined;

/**
 * The store's sectors based on the list of values /user/lov/ParamSector
 * @member {Array.<String>} sectors
 */
UpdateStoreRequest.prototype['sectors'] = undefined;

/**
 * The url of your store
 * @member {String} url
 */
UpdateStoreRequest.prototype['url'] = undefined;
