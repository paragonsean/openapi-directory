...
class ProductList {
     ...
     */
    constructor(paginationResult, products) { 
        
        ProductList.initialize(this, paginationResult, products);
    }
     ...
     */
    static initialize(obj, paginationResult, products) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of ProductList.RequiredProperties) {
...
ProductList.RequiredProperties = ["paginationResult", "products"];

/**
 * @member {module:model/BeezUPCommonPaginationResult} paginationResult
 */
ProductList.prototype['paginationResult'] = undefined;
