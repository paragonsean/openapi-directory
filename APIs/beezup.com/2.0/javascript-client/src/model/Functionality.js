...
class Functionality {
     ...
     * @param code {String} The functionality code
     * @param order {Number} UI purpose: Indicate the position of the functionality
     */
    constructor(code, order) { 
        
        Functionality.initialize(this, code, order);
    }
     ...
     */
    static initialize(obj, code, order) { 
        obj['code'] = code;
        obj['order'] = order;
    }
...
Functionality.RequiredProperties = ["code", "order"];

/**
 * The functionality code
 * @member {String} code
 */
Functionality.prototype['code'] = undefined;

/**
 * UI purpose: Indicate the position of the functionality
 * @member {Number} order
 */
Functionality.prototype['order'] = undefined;
