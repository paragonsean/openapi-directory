...
class ReportByDayRequest {
     ...
     * @param beginPeriodUtcDate {Date} The begin date of the period for the report
     * @param endPeriodUtcDate {Date} The end date of the period for the report
     */
    constructor(beginPeriodUtcDate, endPeriodUtcDate) { 
        
        ReportByDayRequest.initialize(this, beginPeriodUtcDate, endPeriodUtcDate);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportByDayRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ReportByDayRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReportByDayRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReportByDayRequest.RequiredProperties) {
...
ReportByDayRequest.RequiredProperties = ["beginPeriodUtcDate", "endPeriodUtcDate"];

/**
 * @member {module:model/ReportAdvancedFilters} advancedFilters
 */
ReportByDayRequest.prototype['advancedFilters'] = undefined;

/**
 * The begin date of the period for the report
 * @member {Date} beginPeriodUtcDate
 */
ReportByDayRequest.prototype['beginPeriodUtcDate'] = undefined;

/**
 * The catalog category identifier
 * @member {String} catalogCategoryId
 */
ReportByDayRequest.prototype['catalogCategoryId'] = undefined;

/**
 * Indicate the channel identifier list
 * @member {Array.<String>} channelIds
 */
ReportByDayRequest.prototype['channelIds'] = undefined;

/**
 * The end date of the period for the report
 * @member {Date} endPeriodUtcDate
 */
ReportByDayRequest.prototype['endPeriodUtcDate'] = undefined;

/**
 * The product identifier
 * @member {String} productId
 */
ReportByDayRequest.prototype['productId'] = undefined;
...
export default ReportByDayRequest;
