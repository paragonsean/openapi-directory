...
class ProfilePictureInfo {
     ...
     */
    constructor(profilePictureSelected) { 
        
        ProfilePictureInfo.initialize(this, profilePictureSelected);
    }
     ...
     */
    static initialize(obj, profilePictureSelected) { 
        obj['profilePictureSelected'] = profilePictureSelected;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProfilePictureInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>ProfilePictureInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProfilePictureInfo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProfilePictureInfo.RequiredProperties) {
...
ProfilePictureInfo.RequiredProperties = ["profilePictureSelected"];

/**
 * @member {module:model/ProfilePictureSelected} profilePictureSelected
 */
ProfilePictureInfo.prototype['profilePictureSelected'] = undefined;

/**
 * Indicate the url of your picture profil
 * @member {String} profilePictureUrl
 */
ProfilePictureInfo.prototype['profilePictureUrl'] = undefined;
