...
class PublicationReporting {
     ...
     */
    constructor(feeds, publicationType) { 
        
        PublicationReporting.initialize(this, feeds, publicationType);
    }
     ...
     */
    static initialize(obj, feeds, publicationType) { 
        obj['feeds'] = feeds;
        obj['publicationType'] = publicationType;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicationReporting();
    ...
    /**
     * Validates the JSON data with respect to <code>PublicationReporting</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicationReporting</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PublicationReporting.RequiredProperties) {
        ...
        if (data['feeds']) { // data not null
            ...
            for (const item of data['feeds']) {
                PublicationFeedReporting.validateJSON(item);
            };
        }
...
PublicationReporting.RequiredProperties = ["feeds", "publicationType"];

/**
 * The feeds that were published
 * @member {Array.<module:model/PublicationFeedReporting>} feeds
 */
PublicationReporting.prototype['feeds'] = undefined;

/**
 * @member {module:model/PublicationType} publicationType
 */
PublicationReporting.prototype['publicationType'] = undefined;
