...
class ChannelCatalogMarketplaceSettingsLinks {
     ...
     */
    constructor(save, self) { 
        
        ChannelCatalogMarketplaceSettingsLinks.initialize(this, save, self);
    }
     ...
     */
    static initialize(obj, save, self) { 
        obj['save'] = save;
        obj['self'] = self;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChannelCatalogMarketplaceSettingsLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>ChannelCatalogMarketplaceSettingsLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChannelCatalogMarketplaceSettingsLinks</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChannelCatalogMarketplaceSettingsLinks.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `save`
        if (data['save']) { // data not null
          LinksSetChannelCatalogMarketplaceSettingsLink.validateJSON(data['save']);
        }
        // validate the optional field `self`
        if (data['self']) { // data not null
          LinksGetChannelCatalogMarketplaceSettingsLink.validateJSON(data['self']);
        }
...
ChannelCatalogMarketplaceSettingsLinks.RequiredProperties = ["save", "self"];

/**
 * @member {module:model/LinksSetChannelCatalogMarketplaceSettingsLink} save
 */
ChannelCatalogMarketplaceSettingsLinks.prototype['save'] = undefined;

/**
 * @member {module:model/LinksGetChannelCatalogMarketplaceSettingsLink} self
 */
ChannelCatalogMarketplaceSettingsLinks.prototype['self'] = undefined;
...
export default ChannelCatalogMarketplaceSettingsLinks;
