...
class StoreAlert {
     ...
     * @param alertId {Number} Alert identifier
     * @param alertName {String} The alert name
     * @param enabled {Boolean} Is the alert enable ?
     * @param links {module:model/StoreAlertLinks} 
     */
    constructor(alertId, alertName, enabled, links) { 
        
        StoreAlert.initialize(this, alertId, alertName, enabled, links);
    }
     ...
     */
    static initialize(obj, alertId, alertName, enabled, links) { 
        obj['alertId'] = alertId;
    ...
    /**
     * Validates the JSON data with respect to <code>StoreAlert</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoreAlert</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StoreAlert.RequiredProperties) {
        ...
        if (data['links']) { // data not null
          StoreAlertLinks.validateJSON(data['links']);
        }
        if (data['properties']) { // data not null
            ...
            for (const item of data['properties']) {
                StoreAlertPropertyInfo.validateJSON(item);
            };
        }
...
StoreAlert.RequiredProperties = ["alertId", "alertName", "enabled", "links"];

/**
 * Alert identifier
 * @member {Number} alertId
 */
StoreAlert.prototype['alertId'] = undefined;

/**
 * The alert name
 * @member {String} alertName
 */
StoreAlert.prototype['alertName'] = undefined;

/**
 * Is the alert enable ?
 * @member {Boolean} enabled
 */
StoreAlert.prototype['enabled'] = undefined;

/**
 * @member {module:model/StoreAlertLinks} links
 */
StoreAlert.prototype['links'] = undefined;

/**
 * The current configuration properties of the alert
 * @member {Array.<module:model/StoreAlertPropertyInfo>} properties
 */
StoreAlert.prototype['properties'] = undefined;
