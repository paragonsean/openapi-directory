...
/**
 * The OrderWithLinks model module.
 * @module model/OrderWithLinks
 * @version 2.0
 */
class OrderWithLinks {
    /**
     * Constructs a new <code>OrderWithLinks</code>.
     * @alias module:model/OrderWithLinks
    ...
    constructor(accountId, beezUPOrderId, etag, links, marketplaceBusinessCode, marketplaceTechnicalCode, orderLastModificationUtcDate, orderMarketplaceLastModificationUtcDate, orderMarketplaceOrderId, orderPurchaseUtcDate, orderStatusBeezUPOrderStatus, processing, orderItems, transitionLinks) { 
        ...
        OrderWithLinks.initialize(this, accountId, beezUPOrderId, etag, links, marketplaceBusinessCode, marketplaceTechnicalCode, orderLastModificationUtcDate, orderMarketplaceLastModificationUtcDate, orderMarketplaceOrderId, orderPurchaseUtcDate, orderStatusBeezUPOrderStatus, processing, orderItems, transitionLinks);
    }
    ...
    /**
     * Constructs a <code>OrderWithLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderWithLinks} obj Optional instance to populate.
     * @return {module:model/OrderWithLinks} The populated <code>OrderWithLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderWithLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderWithLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderWithLinks</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderWithLinks.RequiredProperties) {
...
OrderWithLinks.RequiredProperties = ["accountId", "beezUPOrderId", "etag", "links", "marketplaceBusinessCode", "marketplaceTechnicalCode", "order_LastModificationUtcDate", "order_MarketplaceLastModificationUtcDate", "order_MarketplaceOrderId", "order_PurchaseUtcDate", "order_Status_BeezUPOrderStatus", "processing", "orderItems", "transitionLinks"];

/**
 * The marketplace account identifier in BeezUP. This account identifier is based on your api settings.
 * @member {Number} accountId
 */
OrderWithLinks.prototype['accountId'] = undefined;

/**
 * The BeezUP Order identifier
 * @member {String} beezUPOrderId
 */
OrderWithLinks.prototype['beezUPOrderId'] = undefined;

/**
 * The URL <a href=\"https://en.wikipedia.org/wiki/URL\">https://en.wikipedia.org/wiki/URL</a>
 * @member {String} beezUPOrderUrl
 */
OrderWithLinks.prototype['beezUPOrderUrl'] = undefined;
 ...
 * @member {String} etag
 */
OrderWithLinks.prototype['etag'] = undefined;

/**
 * @member {module:model/OrderLinks} links
 */
OrderWithLinks.prototype['links'] = undefined;
 ...
 */
OrderWithLinks.prototype['order_OrderItemsSourceUri'] = undefined;
 ...
 */
OrderWithLinks.prototype['order_OrderSourceUri'] = undefined;

/**
 * The UTC date of the payment of this order
 * @member {Date} order_PayingUtcDate
 */
OrderWithLinks.prototype['order_PayingUtcDate'] = undefined;

/**
 * The payment method of this order
 * @member {String} order_PaymentMethod
 */
OrderWithLinks.prototype['order_PaymentMethod'] = undefined;

/**
 * The shipping address city of this order
 * @member {String} order_Shipping_AddressCity
 */
OrderWithLinks.prototype['order_Shipping_AddressCity'] = undefined;
