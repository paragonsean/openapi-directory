...
class BeezUPCommonErrorResponseMessage {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BeezUPCommonErrorResponseMessage();
    ...
    /**
     * Validates the JSON data with respect to <code>BeezUPCommonErrorResponseMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BeezUPCommonErrorResponseMessage</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BeezUPCommonErrorResponseMessage.RequiredProperties) {
...
BeezUPCommonErrorResponseMessage.RequiredProperties = ["errors"];
...
export default BeezUPCommonErrorResponseMessage;
