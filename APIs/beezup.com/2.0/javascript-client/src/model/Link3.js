...
/**
 * The Link3 model module.
 * @module model/Link3
 * @version 2.0
 */
class Link3 {
    /**
     * Constructs a new <code>Link3</code>.
     * @alias module:model/Link3
    ...
    /**
     * Constructs a <code>Link3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Link3} obj Optional instance to populate.
     * @return {module:model/Link3} The populated <code>Link3</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Link3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Link3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Link3.RequiredProperties) {
