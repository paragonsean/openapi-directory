...
/**
 * The LinksGetOrderV3Link model module.
 * @module model/LinksGetOrderV3Link
 * @version 2.0
 */
class LinksGetOrderV3Link {
    /**
     * Constructs a new <code>LinksGetOrderV3Link</code>.
     * @alias module:model/LinksGetOrderV3Link
     * @implements module:model/Link3
     * @param href {String} Indicate the relative uri for this link
     */
    constructor(href) { 
        Link3.initialize(this, href);
        LinksGetOrderV3Link.initialize(this, href);
    }
    ...
    /**
     * Constructs a <code>LinksGetOrderV3Link</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LinksGetOrderV3Link} obj Optional instance to populate.
     * @return {module:model/LinksGetOrderV3Link} The populated <code>LinksGetOrderV3Link</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinksGetOrderV3Link();
    ...
    /**
     * Validates the JSON data with respect to <code>LinksGetOrderV3Link</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinksGetOrderV3Link</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LinksGetOrderV3Link.RequiredProperties) {
...
export default LinksGetOrderV3Link;
