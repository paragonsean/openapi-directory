...
class RuleList {
     ...
     */
    constructor(links, rules) { 
        
        RuleList.initialize(this, links, rules);
    }
     ...
     */
    static initialize(obj, links, rules) { 
        obj['links'] = links;
        obj['rules'] = rules;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of RuleList.RequiredProperties) {
        ...
        if (data['links']) { // data not null
          RuleListLinks.validateJSON(data['links']);
        }
...
RuleList.RequiredProperties = ["links", "rules"];

/**
 * @member {module:model/RuleListLinks} links
 */
RuleList.prototype['links'] = undefined;

/**
 * Rule list
 * @member {Array.<module:model/Rule>} rules
 */
RuleList.prototype['rules'] = undefined;
