...
class StoreAlertPropertyInfo {
     ...
     * @param propertyId {Number} The property identifier of the alert
     * @param propertyValue {String} The property value
     * @param propertyName {String} The property name of the alert
     */
    constructor(propertyId, propertyValue, propertyName) { 
        StoreAlertProperty.initialize(this, propertyId, propertyValue);
        StoreAlertPropertyInfo.initialize(this, propertyId, propertyValue, propertyName);
    }
     ...
     */
    static initialize(obj, propertyId, propertyValue, propertyName) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoreAlertPropertyInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>StoreAlertPropertyInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoreAlertPropertyInfo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StoreAlertPropertyInfo.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['propertyValidationExpression'] && !(typeof data['propertyValidationExpression'] === 'string' || data['propertyValidationExpression'] instanceof String)) {
            throw new Error("Expected the field `propertyValidationExpression` to be a primitive type in the JSON string but got " + data['propertyValidationExpression']);
        }
...
StoreAlertPropertyInfo.RequiredProperties = ["propertyId", "propertyValue", "propertyName"];

/**
 * The property identifier of the alert
 * @member {Number} propertyId
 */
StoreAlertPropertyInfo.prototype['propertyId'] = undefined;

/**
 * The property value
 * @member {String} propertyValue
 */
StoreAlertPropertyInfo.prototype['propertyValue'] = undefined;

/**
 * The property name of the alert
 * @member {String} propertyName
 */
StoreAlertPropertyInfo.prototype['propertyName'] = undefined;

/**
 * The regular expression related to the alert property
 * @member {String} propertyValidationExpression
 */
StoreAlertPropertyInfo.prototype['propertyValidationExpression'] = undefined;
 ...
 * @member {Number} propertyId
 */
StoreAlertProperty.prototype['propertyId'] = undefined;
/**
 * The property value
 * @member {String} propertyValue
 */
StoreAlertProperty.prototype['propertyValue'] = undefined;




export default StoreAlertPropertyInfo;
