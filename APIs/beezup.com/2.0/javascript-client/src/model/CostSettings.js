...
class CostSettings {
    ...
    constructor(costType) { 
        ...
        CostSettings.initialize(this, costType);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CostSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CostSettings</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CostSettings.RequiredProperties) {
...
CostSettings.RequiredProperties = ["costType"];

/**
 * @member {module:model/CostType} costType
 */
CostSettings.prototype['costType'] = undefined;

/**
 * In case of global cost type, you have to indicate the cost value.
 * @member {Number} globalCostValue
 */
CostSettings.prototype['globalCostValue'] = undefined;
