...
import ReportByProductResponseLinks from './ReportByProductResponseLinks';
...
class ReportByProductResponse {
     ...
     */
    constructor(currencyCode, links, paginationResult, products) { 
        
        ReportByProductResponse.initialize(this, currencyCode, links, paginationResult, products);
    }
     ...
     */
    static initialize(obj, currencyCode, links, paginationResult, products) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportByProductResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ReportByProductResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReportByProductResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReportByProductResponse.RequiredProperties) {
        ...
        if (data['links']) { // data not null
          ReportByProductResponseLinks.validateJSON(data['links']);
        }
        ...
        if (data['products']) { // data not null
            ...
            for (const item of data['products']) {
                ReportByProduct.validateJSON(item);
            };
        }
...
ReportByProductResponse.RequiredProperties = ["currencyCode", "links", "paginationResult", "products"];

/**
 * The currency code <a href=\"https://en.wikipedia.org/wiki/ISO_4217\">(ISO 4217)</a> 
 * @member {String} currencyCode
 */
ReportByProductResponse.prototype['currencyCode'] = undefined;

/**
 * @member {module:model/ReportByProductResponseLinks} links
 */
ReportByProductResponse.prototype['links'] = undefined;

/**
 * @member {module:model/BeezUPCommonPaginationResult} paginationResult
 */
ReportByProductResponse.prototype['paginationResult'] = undefined;

/**
 * @member {Array.<module:model/ReportByProduct>} products
 */
ReportByProductResponse.prototype['products'] = undefined;
...
export default ReportByProductResponse;
