...
class LinksChangeOrderLink {
    ...
    constructor(href) { 
        ...
        LinksChangeOrderLink.initialize(this, href);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinksChangeOrderLink();
    ...
    /**
     * Validates the JSON data with respect to <code>LinksChangeOrderLink</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinksChangeOrderLink</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LinksChangeOrderLink.RequiredProperties) {
...
export default LinksChangeOrderLink;
