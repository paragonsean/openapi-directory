...
class BillingPeriod {
     ...
     */
    constructor(billingPeriodInMonth, discountPercentage) { 
        
        BillingPeriod.initialize(this, billingPeriodInMonth, discountPercentage);
    }
     ...
     */
    static initialize(obj, billingPeriodInMonth, discountPercentage) { 
        obj['billingPeriodInMonth'] = billingPeriodInMonth;
    ...
    static validateJSON(data) {
        ...
        for (const property of BillingPeriod.RequiredProperties) {
...
BillingPeriod.RequiredProperties = ["billingPeriodInMonth", "discountPercentage"];

/**
 * The billing period in month
 * @member {Number} billingPeriodInMonth
 */
BillingPeriod.prototype['billingPeriodInMonth'] = undefined;

/**
 * The discount percentage related to this billing period
 * @member {Number} discountPercentage
 */
BillingPeriod.prototype['discountPercentage'] = undefined;
