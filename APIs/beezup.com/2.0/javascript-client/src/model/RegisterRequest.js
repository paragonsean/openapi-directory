...
class RegisterRequest {
    ...
    constructor(email, password) { 
        ...
        RegisterRequest.initialize(this, email, password);
    }
    ...
    static validateJSON(data) {
        ...
        if (data['commercialOwnerUserId'] && !(typeof data['commercialOwnerUserId'] === 'string' || data['commercialOwnerUserId'] instanceof String)) {
            throw new Error("Expected the field `commercialOwnerUserId` to be a primitive type in the JSON string but got " + data['commercialOwnerUserId']);
        }
        // ensure the json data is a string
...
RegisterRequest.RequiredProperties = ["email", "password"];

/**
 * The user id of your commercial in BeezUP.
 * @member {String} commercialOwnerUserId
 */
RegisterRequest.prototype['commercialOwnerUserId'] = undefined;
 ...
 */
RegisterRequest.prototype['cultureName'] = undefined;
