...
import PublicChannelIndexLinks from './PublicChannelIndexLinks';
...
class PublicChannelIndex {
    ...
    constructor() { 
        ...
        PublicChannelIndex.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicChannelIndex();
    ...
    /**
     * Validates the JSON data with respect to <code>PublicChannelIndex</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicChannelIndex</code>.
     */
    static validateJSON(data) {
        // validate the optional field `links`
        if (data['links']) { // data not null
          PublicChannelIndexLinks.validateJSON(data['links']);
        }
 ...
 */
PublicChannelIndex.prototype['channels'] = undefined;

/**
 * @member {module:model/PublicChannelIndexLinks} links
 */
PublicChannelIndex.prototype['links'] = undefined;
