...
class ChannelCatalogExportationHistory {
     ...
     */
    constructor(exportations, links) { 
        
        ChannelCatalogExportationHistory.initialize(this, exportations, links);
    }
     ...
     */
    static initialize(obj, exportations, links) { 
        obj['exportations'] = exportations;
        obj['links'] = links;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChannelCatalogExportationHistory();
    ...
    /**
     * Validates the JSON data with respect to <code>ChannelCatalogExportationHistory</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChannelCatalogExportationHistory</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChannelCatalogExportationHistory.RequiredProperties) {
        ...
        if (data['exportations']) { // data not null
            ...
            if (!Array.isArray(data['exportations'])) {
                throw new Error("Expected the field `exportations` to be an array in the JSON data but got " + data['exportations']);
            }
            // validate the optional field `exportations` (array)
            for (const item of data['exportations']) {
                ChannelCatalogExportationReporting.validateJSON(item);
            };
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          ChannelCatalogExportationHistoryLinks.validateJSON(data['links']);
        }
...
ChannelCatalogExportationHistory.RequiredProperties = ["exportations", "links"];

/**
 * @member {Array.<module:model/ChannelCatalogExportationReporting>} exportations
 */
ChannelCatalogExportationHistory.prototype['exportations'] = undefined;

/**
 * @member {module:model/ChannelCatalogExportationHistoryLinks} links
 */
ChannelCatalogExportationHistory.prototype['links'] = undefined;

/**
 * @member {module:model/BeezUPCommonPaginationResult} paginationResult
 */
ChannelCatalogExportationHistory.prototype['paginationResult'] = undefined;
...
export default ChannelCatalogExportationHistory;
