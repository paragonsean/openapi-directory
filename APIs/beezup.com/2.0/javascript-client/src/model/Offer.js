...
class Offer {
    ...
    static validateJSON(data) {
        ...
        if (data['content']) { // data not null
          OfferContent.validateJSON(data['content']);
        }
        ...
        if (data['links']) { // data not null
          OfferLinks.validateJSON(data['links']);
        }
 ...
 */
Offer.prototype['content'] = undefined;

/**
 * @member {module:model/BeezUPCommonInfoSummaries} info
 */
Offer.prototype['info'] = undefined;

/**
 * @member {module:model/OfferLinks} links
 */
Offer.prototype['links'] = undefined;
