...
class PublicationFeedReporting {
     ...
     */
    constructor(feedType, processingStatus, startUtcDate) { 
        
        PublicationFeedReporting.initialize(this, feedType, processingStatus, startUtcDate);
    }
     ...
     */
    static initialize(obj, feedType, processingStatus, startUtcDate) { 
        obj['feedType'] = feedType;
        obj['processingStatus'] = processingStatus;
        obj['startUtcDate'] = startUtcDate;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicationFeedReporting();
    ...
    /**
     * Validates the JSON data with respect to <code>PublicationFeedReporting</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicationFeedReporting</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PublicationFeedReporting.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['htmlReportGenerationErrorMessage'] && !(typeof data['htmlReportGenerationErrorMessage'] === 'string' || data['htmlReportGenerationErrorMessage'] instanceof String)) {
            throw new Error("Expected the field `htmlReportGenerationErrorMessage` to be a primitive type in the JSON string but got " + data['htmlReportGenerationErrorMessage']);
        }
        // ensure the json data is a string
        if (data['htmlReportUrl'] && !(typeof data['htmlReportUrl'] === 'string' || data['htmlReportUrl'] instanceof String)) {
            throw new Error("Expected the field `htmlReportUrl` to be a primitive type in the JSON string but got " + data['htmlReportUrl']);
        }
        // ensure the json data is a string
...
PublicationFeedReporting.RequiredProperties = ["feedType", "processingStatus", "startUtcDate"];

/**
 * Indicates if the publication is completed or not
 * @member {Boolean} completed
 */
PublicationFeedReporting.prototype['completed'] = undefined;

/**
 * The feed publication end time (UTC timezone)
 * @member {Date} endUtcDate
 */
PublicationFeedReporting.prototype['endUtcDate'] = undefined;

/**
 * The error message
 * @member {String} errorMessage
 */
PublicationFeedReporting.prototype['errorMessage'] = undefined;

/**
 * The product count downloaded from BeezUP Export
 * @member {Number} exportedProducts
 */
PublicationFeedReporting.prototype['exportedProducts'] = undefined;

/**
 * The item count (products or offers) the marketplace flagged as failed
 * @member {Number} failedItems
 */
PublicationFeedReporting.prototype['failedItems'] = undefined;

/**
 * @member {module:model/FeedType} feedType
 */
PublicationFeedReporting.prototype['feedType'] = undefined;

/**
 * The error message if the Html Report generation failed
 * @member {String} htmlReportGenerationErrorMessage
 */
PublicationFeedReporting.prototype['htmlReportGenerationErrorMessage'] = undefined;

/**
 * The Url for the Html Report generated
 * @member {String} htmlReportUrl
 */
PublicationFeedReporting.prototype['htmlReportUrl'] = undefined;

/**
 * The processing status
 * @member {String} processingStatus
 */
PublicationFeedReporting.prototype['processingStatus'] = undefined;

/**
 * The item count (products or offers) the marketplace flagged as successful
 * @member {Number} publishedItems
 */
PublicationFeedReporting.prototype['publishedItems'] = undefined;
 ...
 */
PublicationFeedReporting.prototype['publishedItemsWithWarning'] = undefined;

/**
 * The feed publication start time (UTC timezone)
 * @member {Date} startUtcDate
 */
PublicationFeedReporting.prototype['startUtcDate'] = undefined;

/**
 * The item count (products or offers) sent to the marketplace
 * @member {Number} transmittedItems
 */
PublicationFeedReporting.prototype['transmittedItems'] = undefined;
...
export default PublicationFeedReporting;
