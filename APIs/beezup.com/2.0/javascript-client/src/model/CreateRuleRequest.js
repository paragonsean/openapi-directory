...
class CreateRuleRequest {
     ...
     */
    constructor(optimisationActionName, reportFilterId, ruleName) { 
        
        CreateRuleRequest.initialize(this, optimisationActionName, reportFilterId, ruleName);
    }
     ...
     */
    static initialize(obj, optimisationActionName, reportFilterId, ruleName) { 
        obj['optimisationActionName'] = optimisationActionName;
...
CreateRuleRequest.RequiredProperties = ["optimisationActionName", "reportFilterId", "ruleName"];

/**
 * The end validity utc date of the rule
 * @member {Date} endUtcDate
 */
CreateRuleRequest.prototype['endUtcDate'] = undefined;

/**
 * @member {module:model/OptimisationActionName} optimisationActionName
 */
CreateRuleRequest.prototype['optimisationActionName'] = undefined;

/**
 * The report filter to use for the rule
 * @member {String} reportFilterId
 */
CreateRuleRequest.prototype['reportFilterId'] = undefined;

/**
 * The name of the rule
 * @member {String} ruleName
 */
CreateRuleRequest.prototype['ruleName'] = undefined;

/**
 * The start validity utc date of the rule
 * @member {Date} startUtcDate
 */
CreateRuleRequest.prototype['startUtcDate'] = undefined;
