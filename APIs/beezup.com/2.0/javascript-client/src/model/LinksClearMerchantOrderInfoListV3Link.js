...
/**
 * The LinksClearMerchantOrderInfoListV3Link model module.
 * @module model/LinksClearMerchantOrderInfoListV3Link
 * @version 2.0
 */
class LinksClearMerchantOrderInfoListV3Link {
    /**
     * Constructs a new <code>LinksClearMerchantOrderInfoListV3Link</code>.
     * @alias module:model/LinksClearMerchantOrderInfoListV3Link
     * @implements module:model/Link3
     * @param href {String} Indicate the relative uri for this link
     */
    constructor(href) { 
        Link3.initialize(this, href);
        LinksClearMerchantOrderInfoListV3Link.initialize(this, href);
    }
    ...
    /**
     * Constructs a <code>LinksClearMerchantOrderInfoListV3Link</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LinksClearMerchantOrderInfoListV3Link} obj Optional instance to populate.
     * @return {module:model/LinksClearMerchantOrderInfoListV3Link} The populated <code>LinksClearMerchantOrderInfoListV3Link</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinksClearMerchantOrderInfoListV3Link();
    ...
    /**
     * Validates the JSON data with respect to <code>LinksClearMerchantOrderInfoListV3Link</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinksClearMerchantOrderInfoListV3Link</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LinksClearMerchantOrderInfoListV3Link.RequiredProperties) {
...
LinksClearMerchantOrderInfoListV3Link.RequiredProperties = ["href"];

/**
 * indicates whether all optionals params have been provided
 * @member {Boolean} allOptionalParamsProvided
 */
LinksClearMerchantOrderInfoListV3Link.prototype['allOptionalParamsProvided'] = undefined;

/**
 * indicates whether all required params have been provided
 * @member {Boolean} allRequiredParamsProvided
 */
LinksClearMerchantOrderInfoListV3Link.prototype['allRequiredParamsProvided'] = undefined;

/**
 * The description of the link
 * @member {String} description
 */
LinksClearMerchantOrderInfoListV3Link.prototype['description'] = undefined;

/**
 * The documentation related to this operation.
 * @member {String} docUrl
 */
LinksClearMerchantOrderInfoListV3Link.prototype['docUrl'] = undefined;

/**
 * Indicate the relative uri for this link
 * @member {String} href
 */
LinksClearMerchantOrderInfoListV3Link.prototype['href'] = undefined;

/**
 * @member {module:model/InfoSummaries} info
 */
LinksClearMerchantOrderInfoListV3Link.prototype['info'] = undefined;

/**
 * The label corresponding to the link. This label is automatically translated based on the Accept-Language http header.
 * @member {String} label
 */
LinksClearMerchantOrderInfoListV3Link.prototype['label'] = undefined;

/**
 * @member {module:model/HttpMethod} method
 */
LinksClearMerchantOrderInfoListV3Link.prototype['method'] = undefined;

/**
 * The operationId to call.
 * @member {String} operationId
 */
LinksClearMerchantOrderInfoListV3Link.prototype['operationId'] = undefined;

/**
 * @member {Object.<String, module:model/LinkParameter3>} parameters
 */
LinksClearMerchantOrderInfoListV3Link.prototype['parameters'] = undefined;

/**
 * Indicate the relation name related to the link
 * @member {String} rel
 */
LinksClearMerchantOrderInfoListV3Link.prototype['rel'] = undefined;

/**
 * indicates whether the href is templated or not
 * @member {Boolean} urlTemplated
 */
LinksClearMerchantOrderInfoListV3Link.prototype['urlTemplated'] = undefined;
...
export default LinksClearMerchantOrderInfoListV3Link;
