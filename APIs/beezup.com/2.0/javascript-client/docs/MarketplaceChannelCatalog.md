# BeezUpMerchantApi.MarketplaceChannelCatalog

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**apiSettingsStatus** | [**BeezUPCommonApiSettingsStatus**](BeezUPCommonApiSettingsStatus.md) |  | 
...
**marketplaceAccountId** | **Number** | The marketplace account identifier in BeezUP. This account identifier is based on your api settings. | [optional] 
