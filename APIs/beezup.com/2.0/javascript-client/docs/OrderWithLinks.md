# BeezUpMerchantApi.OrderWithLinks

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accountId** | **Number** | The marketplace account identifier in BeezUP. This account identifier is based on your api settings. | 
...
**transitionLinks** | [**[LinksChangeOrderLink]**](LinksChangeOrderLink.md) | Contains the authorized change actions for an order | 
