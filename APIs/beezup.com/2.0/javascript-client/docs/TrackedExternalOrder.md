# BeezUpMerchantApi.TrackedExternalOrder
...
**products** | [**[TrackedExternalOrderProduct]**](TrackedExternalOrderProduct.md) | Can be null. The product list included in the external order | [optional] 
**totalAmount** | **Number** | The total amount of the external order | 
