...
|**invoiceStartingSequenceNumber** | **Integer** | Invoice Sequence Number |  |
|**productVATPercent** | **BigDecimal** | Product VAT in percent |  |
|**shippingVATPercent** | **BigDecimal** | Shipping cost VAT in percent |  |
