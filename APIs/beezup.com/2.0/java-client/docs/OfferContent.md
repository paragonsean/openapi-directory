...
|**contractTerminationReason** | **String** | The termination reason, if your current contract is scheduled to be terminated. |  [optional] |
|**contractTerminationReasonType** | **Integer** | The contract termination reason type identifier, if your current contract is scheduled to be terminated. The value is based on the list of values /user/lov/ContractTerminationReason |  [optional] |
