...
<a id="getInvoices"></a>
# **getInvoices**
> InvoiceList getInvoices(ifNoneMatch)
...
import org.openapitools.client.api.CustomerInvoicesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomerInvoicesApi apiInstance = new CustomerInvoicesApi(defaultClient);
    ...
    try {
      InvoiceList result = apiInstance.getInvoices(ifNoneMatch);
...
|-------------|-------------|------------------|
| **200** | Get all invoices of a customer |  -  |
