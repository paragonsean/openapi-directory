...
|**properties** | [**Map&lt;String, LinkParameterProperty3&gt;**](LinkParameterProperty3.md) | If the parameter is an object with flexible properties (additionProperties/dictionary), we will describe the properties of the object. |  [optional] |
