...
|**commitmentCalculatedFinishUtcDate** | **OffsetDateTime** | The calculated end date of commitment |  [optional] |
...
|**discountEndUtcDate** | **OffsetDateTime** | The end of your discount |  [optional] |
...
|**startUtcDate** | **OffsetDateTime** | The start date of your contract |  [optional] |
|**storeCount** | **Integer** | The store count you want to have in your contract. |  [optional] |
