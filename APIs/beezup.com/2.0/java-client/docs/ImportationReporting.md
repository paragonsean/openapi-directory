...
|**beginUtcDate** | **OffsetDateTime** | Indicate the begin UTC date of this importation. |  |
|**endUtcDate** | **OffsetDateTime** | Indicate the end UTC date of this importation. |  [optional] |
...
|**inputConfigurationUrl** | **URI** | Indicate the input url of this importation. |  [optional] |
|**lastUpdateUtcDate** | **OffsetDateTime** | Indicate the last update UTC date of the reporting. |  |
