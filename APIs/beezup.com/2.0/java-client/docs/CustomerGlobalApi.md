...
<a id="getCustomerIndex"></a>
# **getCustomerIndex**
> CustomerIndex getCustomerIndex(ifNoneMatch)
...
import org.openapitools.client.api.CustomerGlobalApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomerGlobalApi apiInstance = new CustomerGlobalApi(defaultClient);
    ...
    try {
      CustomerIndex result = apiInstance.getCustomerIndex(ifNoneMatch);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerGlobalApi#getCustomerIndex");
