...
public class LinksSaveStoreAlertsLink {
  ...
  public LinksSaveStoreAlertsLink() {
  }

  public LinksSaveStoreAlertsLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksSaveStoreAlertsLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksSaveStoreAlertsLink description(String description) {
  ...
  public LinksSaveStoreAlertsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksSaveStoreAlertsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksSaveStoreAlertsLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksSaveStoreAlertsLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksSaveStoreAlertsLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksSaveStoreAlertsLink operationId(String operationId) {
  ...
  public LinksSaveStoreAlertsLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksSaveStoreAlertsLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksSaveStoreAlertsLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksSaveStoreAlertsLink linksSaveStoreAlertsLink = (LinksSaveStoreAlertsLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksSaveStoreAlertsLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksSaveStoreAlertsLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksSaveStoreAlertsLink.description) &&
        Objects.equals(this.docUrl, linksSaveStoreAlertsLink.docUrl) &&
        Objects.equals(this.href, linksSaveStoreAlertsLink.href) &&
        Objects.equals(this.info, linksSaveStoreAlertsLink.info) &&
        Objects.equals(this.label, linksSaveStoreAlertsLink.label) &&
        Objects.equals(this.method, linksSaveStoreAlertsLink.method) &&
        Objects.equals(this.operationId, linksSaveStoreAlertsLink.operationId) &&
        Objects.equals(this.parameters, linksSaveStoreAlertsLink.parameters) &&
        Objects.equals(this.urlTemplated, linksSaveStoreAlertsLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksSaveStoreAlertsLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksSaveStoreAlertsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksSaveStoreAlertsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksSaveStoreAlertsLink is not found in the empty JSON string", LinksSaveStoreAlertsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksSaveStoreAlertsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksSaveStoreAlertsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksSaveStoreAlertsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksSaveStoreAlertsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksSaveStoreAlertsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksSaveStoreAlertsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksSaveStoreAlertsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksSaveStoreAlertsLink>() {
           @Override
           public void write(JsonWriter out, LinksSaveStoreAlertsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksSaveStoreAlertsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksSaveStoreAlertsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksSaveStoreAlertsLink
   * @throws IOException if the JSON string is invalid with respect to LinksSaveStoreAlertsLink
   */
  public static LinksSaveStoreAlertsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksSaveStoreAlertsLink.class);
  }

  /**
   * Convert an instance of LinksSaveStoreAlertsLink to an JSON string
   *
   * @return JSON string
   */
