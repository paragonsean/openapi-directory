...
public class LinksCreateContractLink {
  ...
  public LinksCreateContractLink() {
  }
  ...
  public LinksCreateContractLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCreateContractLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCreateContractLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksCreateContractLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksCreateContractLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCreateContractLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCreateContractLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCreateContractLink is not found in the empty JSON string", LinksCreateContractLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCreateContractLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCreateContractLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCreateContractLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCreateContractLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCreateContractLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCreateContractLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCreateContractLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCreateContractLink>() {
           @Override
           public void write(JsonWriter out, LinksCreateContractLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCreateContractLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCreateContractLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCreateContractLink
   * @throws IOException if the JSON string is invalid with respect to LinksCreateContractLink
   */
  public static LinksCreateContractLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCreateContractLink.class);
  }

  /**
   * Convert an instance of LinksCreateContractLink to an JSON string
   *
   * @return JSON string
   */
