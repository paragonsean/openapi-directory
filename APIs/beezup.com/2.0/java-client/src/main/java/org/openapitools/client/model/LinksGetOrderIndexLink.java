...
public class LinksGetOrderIndexLink {
  ...
  public LinksGetOrderIndexLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetOrderIndexLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetOrderIndexLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetOrderIndexLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetOrderIndexLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetOrderIndexLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetOrderIndexLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetOrderIndexLink is not found in the empty JSON string", LinksGetOrderIndexLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetOrderIndexLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetOrderIndexLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetOrderIndexLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetOrderIndexLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetOrderIndexLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetOrderIndexLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetOrderIndexLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetOrderIndexLink>() {
           @Override
           public void write(JsonWriter out, LinksGetOrderIndexLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetOrderIndexLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetOrderIndexLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetOrderIndexLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetOrderIndexLink
   */
  public static LinksGetOrderIndexLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetOrderIndexLink.class);
  }

  /**
   * Convert an instance of LinksGetOrderIndexLink to an JSON string
   *
   * @return JSON string
   */
