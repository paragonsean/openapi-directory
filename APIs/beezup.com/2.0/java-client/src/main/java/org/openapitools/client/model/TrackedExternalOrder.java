...
import org.openapitools.client.model.TrackedExternalOrderProduct;
...
public class TrackedExternalOrder {
  ...
  private List<TrackedExternalOrderProduct> products = new ArrayList<>();
  ...
  public TrackedExternalOrder() {
  }

  public TrackedExternalOrder currencyCode(String currencyCode) {
  ...
  public TrackedExternalOrder utcDate(OffsetDateTime utcDate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currencyCode, trackedExternalOrder.currencyCode) &&
        ...
        Objects.equals(this.utcDate, trackedExternalOrder.utcDate) &&
        Objects.equals(this.visitorId, trackedExternalOrder.visitorId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currencyCode, merchantOrderId, paymentValidated, products, totalAmount, utcDate, visitorId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrackedExternalOrder
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackedExternalOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackedExternalOrder is not found in the empty JSON string", TrackedExternalOrder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackedExternalOrder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackedExternalOrder` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrackedExternalOrder.openapiRequiredFields) {
      ...
      if (jsonObj.get("products") != null && !jsonObj.get("products").isJsonNull()) {
        ...
        if (jsonArrayproducts != null) {
          ...
          for (int i = 0; i < jsonArrayproducts.size(); i++) {
            TrackedExternalOrderProduct.validateJsonElement(jsonArrayproducts.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackedExternalOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackedExternalOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackedExternalOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackedExternalOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackedExternalOrder>() {
           @Override
           public void write(JsonWriter out, TrackedExternalOrder value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackedExternalOrder read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrackedExternalOrder given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrackedExternalOrder
   * @throws IOException if the JSON string is invalid with respect to TrackedExternalOrder
   */
  public static TrackedExternalOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackedExternalOrder.class);
  }

  /**
   * Convert an instance of TrackedExternalOrder to an JSON string
   *
   * @return JSON string
   */
