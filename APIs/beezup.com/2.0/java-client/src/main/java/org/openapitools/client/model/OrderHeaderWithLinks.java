...
public class OrderHeaderWithLinks {
  ...
  public OrderHeaderWithLinks() {
  }

  public OrderHeaderWithLinks accountId(Integer accountId) {
  ...
  public OrderHeaderWithLinks beezUPOrderId(UUID beezUPOrderId) {
  ...
  public OrderHeaderWithLinks beezUPOrderUrl(String beezUPOrderUrl) {
  ...
  public OrderHeaderWithLinks etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public OrderHeaderWithLinks links(OrderHeaderLinks links) {
    this.links = links;
    return this;
  }
  ...
  public OrderHeaderWithLinks marketplaceBusinessCode(String marketplaceBusinessCode) {
  ...
  public OrderHeaderWithLinks marketplaceTechnicalCode(String marketplaceTechnicalCode) {
  ...
  public OrderHeaderWithLinks orderBuyerName(String orderBuyerName) {
  ...
  public OrderHeaderWithLinks orderCurrencyCode(String orderCurrencyCode) {
  ...
  public OrderHeaderWithLinks orderInvoiceNumber(String orderInvoiceNumber) {
  ...
  public OrderHeaderWithLinks orderInvoiceUri(String orderInvoiceUri) {
  ...
  public OrderHeaderWithLinks orderLastModificationUtcDate(OffsetDateTime orderLastModificationUtcDate) {
  ...
  public OrderHeaderWithLinks orderMarketplaceLastModificationUtcDate(OffsetDateTime orderMarketplaceLastModificationUtcDate) {
  ...
  public OrderHeaderWithLinks orderMarketplaceOrderId(String orderMarketplaceOrderId) {
  ...
  public OrderHeaderWithLinks orderMerchantECommerceSoftwareName(String orderMerchantECommerceSoftwareName) {
  ...
  public OrderHeaderWithLinks orderMerchantECommerceSoftwareVersion(String orderMerchantECommerceSoftwareVersion) {
  ...
  public OrderHeaderWithLinks orderMerchantOrderId(String orderMerchantOrderId) {
  ...
  public OrderHeaderWithLinks orderPurchaseUtcDate(OffsetDateTime orderPurchaseUtcDate) {
  ...
  public OrderHeaderWithLinks orderStatusBeezUPOrderStatus(String orderStatusBeezUPOrderStatus) {
  ...
  public OrderHeaderWithLinks orderStatusMarketplaceOrderStatus(String orderStatusMarketplaceOrderStatus) {
  ...
  public OrderHeaderWithLinks orderTotalPrice(BigDecimal orderTotalPrice) {
  ...
  public OrderHeaderWithLinks processing(Boolean processing) {
  ...
  public boolean equals(Object o) {
    ...
    OrderHeaderWithLinks orderHeaderWithLinks = (OrderHeaderWithLinks) o;
    return Objects.equals(this.accountId, orderHeaderWithLinks.accountId) &&
        Objects.equals(this.beezUPOrderId, orderHeaderWithLinks.beezUPOrderId) &&
        Objects.equals(this.beezUPOrderUrl, orderHeaderWithLinks.beezUPOrderUrl) &&
        Objects.equals(this.etag, orderHeaderWithLinks.etag) &&
        Objects.equals(this.links, orderHeaderWithLinks.links) &&
        Objects.equals(this.marketplaceBusinessCode, orderHeaderWithLinks.marketplaceBusinessCode) &&
        Objects.equals(this.marketplaceTechnicalCode, orderHeaderWithLinks.marketplaceTechnicalCode) &&
        Objects.equals(this.orderBuyerName, orderHeaderWithLinks.orderBuyerName) &&
        Objects.equals(this.orderCurrencyCode, orderHeaderWithLinks.orderCurrencyCode) &&
        Objects.equals(this.orderInvoiceNumber, orderHeaderWithLinks.orderInvoiceNumber) &&
        Objects.equals(this.orderInvoiceUri, orderHeaderWithLinks.orderInvoiceUri) &&
        Objects.equals(this.orderLastModificationUtcDate, orderHeaderWithLinks.orderLastModificationUtcDate) &&
        Objects.equals(this.orderMarketplaceLastModificationUtcDate, orderHeaderWithLinks.orderMarketplaceLastModificationUtcDate) &&
        Objects.equals(this.orderMarketplaceOrderId, orderHeaderWithLinks.orderMarketplaceOrderId) &&
        Objects.equals(this.orderMerchantECommerceSoftwareName, orderHeaderWithLinks.orderMerchantECommerceSoftwareName) &&
        Objects.equals(this.orderMerchantECommerceSoftwareVersion, orderHeaderWithLinks.orderMerchantECommerceSoftwareVersion) &&
        Objects.equals(this.orderMerchantOrderId, orderHeaderWithLinks.orderMerchantOrderId) &&
        Objects.equals(this.orderPurchaseUtcDate, orderHeaderWithLinks.orderPurchaseUtcDate) &&
        Objects.equals(this.orderStatusBeezUPOrderStatus, orderHeaderWithLinks.orderStatusBeezUPOrderStatus) &&
        Objects.equals(this.orderStatusMarketplaceOrderStatus, orderHeaderWithLinks.orderStatusMarketplaceOrderStatus) &&
        Objects.equals(this.orderTotalPrice, orderHeaderWithLinks.orderTotalPrice) &&
        Objects.equals(this.processing, orderHeaderWithLinks.processing);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderHeaderWithLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderHeaderWithLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderHeaderWithLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderHeaderWithLinks is not found in the empty JSON string", OrderHeaderWithLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderHeaderWithLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderHeaderWithLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderHeaderWithLinks.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderHeaderWithLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderHeaderWithLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderHeaderWithLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderHeaderWithLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderHeaderWithLinks>() {
           @Override
           public void write(JsonWriter out, OrderHeaderWithLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderHeaderWithLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderHeaderWithLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderHeaderWithLinks
   * @throws IOException if the JSON string is invalid with respect to OrderHeaderWithLinks
   */
  public static OrderHeaderWithLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderHeaderWithLinks.class);
  }

  /**
   * Convert an instance of OrderHeaderWithLinks to an JSON string
   *
   * @return JSON string
   */
