...
public class TerminateContract {
  ...
  public TerminateContract contractTerminationReason(String contractTerminationReason) {
  ...
  public TerminateContract contractTerminationReasonType(Integer contractTerminationReasonType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contractTerminationReason, terminateContract.contractTerminationReason) &&
        Objects.equals(this.contractTerminationReasonType, terminateContract.contractTerminationReasonType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contractTerminationReason, contractTerminationReasonType);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("contractTerminationReasonType");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TerminateContract
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TerminateContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TerminateContract is not found in the empty JSON string", TerminateContract.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TerminateContract.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TerminateContract` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TerminateContract.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TerminateContract.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TerminateContract' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TerminateContract> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TerminateContract.class));

       return (TypeAdapter<T>) new TypeAdapter<TerminateContract>() {
           @Override
           public void write(JsonWriter out, TerminateContract value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TerminateContract read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TerminateContract given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TerminateContract
   * @throws IOException if the JSON string is invalid with respect to TerminateContract
   */
  public static TerminateContract fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TerminateContract.class);
  }

  /**
   * Convert an instance of TerminateContract to an JSON string
   *
   * @return JSON string
   */
