...
public class LinksRunRuleLink {
  ...
  public LinksRunRuleLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksRunRuleLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksRunRuleLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksRunRuleLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksRunRuleLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksRunRuleLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksRunRuleLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksRunRuleLink is not found in the empty JSON string", LinksRunRuleLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksRunRuleLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksRunRuleLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksRunRuleLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksRunRuleLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksRunRuleLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksRunRuleLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksRunRuleLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksRunRuleLink>() {
           @Override
           public void write(JsonWriter out, LinksRunRuleLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksRunRuleLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksRunRuleLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksRunRuleLink
   * @throws IOException if the JSON string is invalid with respect to LinksRunRuleLink
   */
  public static LinksRunRuleLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksRunRuleLink.class);
  }

  /**
   * Convert an instance of LinksRunRuleLink to an JSON string
   *
   * @return JSON string
   */
