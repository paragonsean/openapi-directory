...
public class BeezUPColumnConfiguration {
  ...
  public BeezUPColumnConfiguration() {
  }

  public BeezUPColumnConfiguration beezUPColumnName(String beezUPColumnName) {
  ...
  public BeezUPColumnConfiguration canBeTruncated(Boolean canBeTruncated) {
  ...
  public BeezUPColumnConfiguration displayGroupName(String displayGroupName) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(beezUPColumnName, canBeTruncated, columnDataType, columnImportance, description, displayGroupName, unique);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("displayGroupName");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BeezUPColumnConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BeezUPColumnConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BeezUPColumnConfiguration is not found in the empty JSON string", BeezUPColumnConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BeezUPColumnConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BeezUPColumnConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BeezUPColumnConfiguration.openapiRequiredFields) {
      ...
      // validate the optional field `columnDataType`
      if (jsonObj.get("columnDataType") != null && !jsonObj.get("columnDataType").isJsonNull()) {
      ...
      if (!jsonObj.get("displayGroupName").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BeezUPColumnConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BeezUPColumnConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BeezUPColumnConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BeezUPColumnConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<BeezUPColumnConfiguration>() {
           @Override
           public void write(JsonWriter out, BeezUPColumnConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BeezUPColumnConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BeezUPColumnConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BeezUPColumnConfiguration
   * @throws IOException if the JSON string is invalid with respect to BeezUPColumnConfiguration
   */
  public static BeezUPColumnConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BeezUPColumnConfiguration.class);
  }

  /**
   * Convert an instance of BeezUPColumnConfiguration to an JSON string
   *
   * @return JSON string
   */
