...
public class ReportFilterCommonParameters {
  ...
  public ReportFilterCommonParameters() {
  }
  ...
  public ReportFilterCommonParameters beginPeriodUtcDate(OffsetDateTime beginPeriodUtcDate) {
  ...
  public ReportFilterCommonParameters categoryFilter(BeezUPCommonCatalogCategoryFilter categoryFilter) {
  ...
  public ReportFilterCommonParameters channelId(String channelId) {
  ...
  public ReportFilterCommonParameters endPeriodUtcDate(OffsetDateTime endPeriodUtcDate) {
  ...
  public ReportFilterCommonParameters performanceIndicatorFilters(List<PerformanceIndicatorFilter> performanceIndicatorFilters) {
    this.performanceIndicatorFilters = performanceIndicatorFilters;
    return this;
  }

  public ReportFilterCommonParameters addPerformanceIndicatorFiltersItem(PerformanceIndicatorFilter performanceIndicatorFiltersItem) {
  ...
  public ReportFilterCommonParameters periodType(ReportFilterPeriodType periodType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.advancedFilters, reportFilterCommonParameters.advancedFilters) &&
        ...
        Objects.equals(this.channelId, reportFilterCommonParameters.channelId) &&
        Objects.equals(this.endPeriodUtcDate, reportFilterCommonParameters.endPeriodUtcDate) &&
        Objects.equals(this.performanceIndicatorFilters, reportFilterCommonParameters.performanceIndicatorFilters) &&
        Objects.equals(this.periodType, reportFilterCommonParameters.periodType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(advancedFilters, beginPeriodUtcDate, categoryFilter, channelId, endPeriodUtcDate, performanceIndicatorFilters, periodType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReportFilterCommonParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportFilterCommonParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportFilterCommonParameters is not found in the empty JSON string", ReportFilterCommonParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportFilterCommonParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportFilterCommonParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReportFilterCommonParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportFilterCommonParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportFilterCommonParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportFilterCommonParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportFilterCommonParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportFilterCommonParameters>() {
           @Override
           public void write(JsonWriter out, ReportFilterCommonParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportFilterCommonParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReportFilterCommonParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReportFilterCommonParameters
   * @throws IOException if the JSON string is invalid with respect to ReportFilterCommonParameters
   */
  public static ReportFilterCommonParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportFilterCommonParameters.class);
  }

  /**
   * Convert an instance of ReportFilterCommonParameters to an JSON string
   *
   * @return JSON string
   */
