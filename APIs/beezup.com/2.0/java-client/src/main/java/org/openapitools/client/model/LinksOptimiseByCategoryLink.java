...
public class LinksOptimiseByCategoryLink {
  ...
  public LinksOptimiseByCategoryLink() {
  }

  public LinksOptimiseByCategoryLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksOptimiseByCategoryLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksOptimiseByCategoryLink description(String description) {
  ...
  public LinksOptimiseByCategoryLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksOptimiseByCategoryLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksOptimiseByCategoryLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksOptimiseByCategoryLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksOptimiseByCategoryLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksOptimiseByCategoryLink operationId(String operationId) {
  ...
  public LinksOptimiseByCategoryLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksOptimiseByCategoryLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksOptimiseByCategoryLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksOptimiseByCategoryLink linksOptimiseByCategoryLink = (LinksOptimiseByCategoryLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksOptimiseByCategoryLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksOptimiseByCategoryLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksOptimiseByCategoryLink.description) &&
        Objects.equals(this.docUrl, linksOptimiseByCategoryLink.docUrl) &&
        Objects.equals(this.href, linksOptimiseByCategoryLink.href) &&
        Objects.equals(this.info, linksOptimiseByCategoryLink.info) &&
        Objects.equals(this.label, linksOptimiseByCategoryLink.label) &&
        Objects.equals(this.method, linksOptimiseByCategoryLink.method) &&
        Objects.equals(this.operationId, linksOptimiseByCategoryLink.operationId) &&
        Objects.equals(this.parameters, linksOptimiseByCategoryLink.parameters) &&
        Objects.equals(this.urlTemplated, linksOptimiseByCategoryLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksOptimiseByCategoryLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksOptimiseByCategoryLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksOptimiseByCategoryLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksOptimiseByCategoryLink is not found in the empty JSON string", LinksOptimiseByCategoryLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksOptimiseByCategoryLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksOptimiseByCategoryLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksOptimiseByCategoryLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksOptimiseByCategoryLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksOptimiseByCategoryLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksOptimiseByCategoryLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksOptimiseByCategoryLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksOptimiseByCategoryLink>() {
           @Override
           public void write(JsonWriter out, LinksOptimiseByCategoryLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksOptimiseByCategoryLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksOptimiseByCategoryLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksOptimiseByCategoryLink
   * @throws IOException if the JSON string is invalid with respect to LinksOptimiseByCategoryLink
   */
  public static LinksOptimiseByCategoryLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksOptimiseByCategoryLink.class);
  }

  /**
   * Convert an instance of LinksOptimiseByCategoryLink to an JSON string
   *
   * @return JSON string
   */
