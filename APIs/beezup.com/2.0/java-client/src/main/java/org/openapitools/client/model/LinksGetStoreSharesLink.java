...
public class LinksGetStoreSharesLink {
  ...
  public LinksGetStoreSharesLink() {
  }

  public LinksGetStoreSharesLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetStoreSharesLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetStoreSharesLink description(String description) {
  ...
  public LinksGetStoreSharesLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetStoreSharesLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetStoreSharesLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetStoreSharesLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetStoreSharesLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetStoreSharesLink operationId(String operationId) {
  ...
  public LinksGetStoreSharesLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetStoreSharesLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetStoreSharesLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetStoreSharesLink linksGetStoreSharesLink = (LinksGetStoreSharesLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetStoreSharesLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetStoreSharesLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetStoreSharesLink.description) &&
        Objects.equals(this.docUrl, linksGetStoreSharesLink.docUrl) &&
        Objects.equals(this.href, linksGetStoreSharesLink.href) &&
        Objects.equals(this.info, linksGetStoreSharesLink.info) &&
        Objects.equals(this.label, linksGetStoreSharesLink.label) &&
        Objects.equals(this.method, linksGetStoreSharesLink.method) &&
        Objects.equals(this.operationId, linksGetStoreSharesLink.operationId) &&
        Objects.equals(this.parameters, linksGetStoreSharesLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetStoreSharesLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetStoreSharesLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetStoreSharesLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetStoreSharesLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetStoreSharesLink is not found in the empty JSON string", LinksGetStoreSharesLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetStoreSharesLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetStoreSharesLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetStoreSharesLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetStoreSharesLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetStoreSharesLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetStoreSharesLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetStoreSharesLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetStoreSharesLink>() {
           @Override
           public void write(JsonWriter out, LinksGetStoreSharesLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetStoreSharesLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetStoreSharesLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetStoreSharesLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetStoreSharesLink
   */
  public static LinksGetStoreSharesLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetStoreSharesLink.class);
  }

  /**
   * Convert an instance of LinksGetStoreSharesLink to an JSON string
   *
   * @return JSON string
   */
