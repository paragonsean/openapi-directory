...
public class LinksAnalyticsIndexLink {
  ...
  public LinksAnalyticsIndexLink() {
  }

  public LinksAnalyticsIndexLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksAnalyticsIndexLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksAnalyticsIndexLink description(String description) {
  ...
  public LinksAnalyticsIndexLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksAnalyticsIndexLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksAnalyticsIndexLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksAnalyticsIndexLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksAnalyticsIndexLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksAnalyticsIndexLink operationId(String operationId) {
  ...
  public LinksAnalyticsIndexLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksAnalyticsIndexLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksAnalyticsIndexLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksAnalyticsIndexLink linksAnalyticsIndexLink = (LinksAnalyticsIndexLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksAnalyticsIndexLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksAnalyticsIndexLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksAnalyticsIndexLink.description) &&
        Objects.equals(this.docUrl, linksAnalyticsIndexLink.docUrl) &&
        Objects.equals(this.href, linksAnalyticsIndexLink.href) &&
        Objects.equals(this.info, linksAnalyticsIndexLink.info) &&
        Objects.equals(this.label, linksAnalyticsIndexLink.label) &&
        Objects.equals(this.method, linksAnalyticsIndexLink.method) &&
        Objects.equals(this.operationId, linksAnalyticsIndexLink.operationId) &&
        Objects.equals(this.parameters, linksAnalyticsIndexLink.parameters) &&
        Objects.equals(this.urlTemplated, linksAnalyticsIndexLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksAnalyticsIndexLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksAnalyticsIndexLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksAnalyticsIndexLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksAnalyticsIndexLink is not found in the empty JSON string", LinksAnalyticsIndexLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksAnalyticsIndexLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksAnalyticsIndexLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksAnalyticsIndexLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksAnalyticsIndexLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksAnalyticsIndexLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksAnalyticsIndexLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksAnalyticsIndexLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksAnalyticsIndexLink>() {
           @Override
           public void write(JsonWriter out, LinksAnalyticsIndexLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksAnalyticsIndexLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksAnalyticsIndexLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksAnalyticsIndexLink
   * @throws IOException if the JSON string is invalid with respect to LinksAnalyticsIndexLink
   */
  public static LinksAnalyticsIndexLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksAnalyticsIndexLink.class);
  }

  /**
   * Convert an instance of LinksAnalyticsIndexLink to an JSON string
   *
   * @return JSON string
   */
