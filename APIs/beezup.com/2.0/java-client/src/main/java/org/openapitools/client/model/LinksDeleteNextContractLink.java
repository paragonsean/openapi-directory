...
public class LinksDeleteNextContractLink {
  ...
  public LinksDeleteNextContractLink() {
  }
  ...
  public LinksDeleteNextContractLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksDeleteNextContractLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksDeleteNextContractLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksDeleteNextContractLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksDeleteNextContractLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksDeleteNextContractLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksDeleteNextContractLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksDeleteNextContractLink is not found in the empty JSON string", LinksDeleteNextContractLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksDeleteNextContractLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksDeleteNextContractLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksDeleteNextContractLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksDeleteNextContractLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksDeleteNextContractLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksDeleteNextContractLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksDeleteNextContractLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksDeleteNextContractLink>() {
           @Override
           public void write(JsonWriter out, LinksDeleteNextContractLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksDeleteNextContractLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksDeleteNextContractLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksDeleteNextContractLink
   * @throws IOException if the JSON string is invalid with respect to LinksDeleteNextContractLink
   */
  public static LinksDeleteNextContractLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksDeleteNextContractLink.class);
  }

  /**
   * Convert an instance of LinksDeleteNextContractLink to an JSON string
   *
   * @return JSON string
   */
