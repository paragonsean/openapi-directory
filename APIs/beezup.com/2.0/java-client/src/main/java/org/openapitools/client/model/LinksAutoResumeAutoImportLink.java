...
public class LinksAutoResumeAutoImportLink {
  ...
  public LinksAutoResumeAutoImportLink() {
  }

  public LinksAutoResumeAutoImportLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksAutoResumeAutoImportLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksAutoResumeAutoImportLink description(String description) {
  ...
  public LinksAutoResumeAutoImportLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksAutoResumeAutoImportLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksAutoResumeAutoImportLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksAutoResumeAutoImportLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksAutoResumeAutoImportLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksAutoResumeAutoImportLink operationId(String operationId) {
  ...
  public LinksAutoResumeAutoImportLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksAutoResumeAutoImportLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksAutoResumeAutoImportLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksAutoResumeAutoImportLink linksAutoResumeAutoImportLink = (LinksAutoResumeAutoImportLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksAutoResumeAutoImportLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksAutoResumeAutoImportLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksAutoResumeAutoImportLink.description) &&
        Objects.equals(this.docUrl, linksAutoResumeAutoImportLink.docUrl) &&
        Objects.equals(this.href, linksAutoResumeAutoImportLink.href) &&
        Objects.equals(this.info, linksAutoResumeAutoImportLink.info) &&
        Objects.equals(this.label, linksAutoResumeAutoImportLink.label) &&
        Objects.equals(this.method, linksAutoResumeAutoImportLink.method) &&
        Objects.equals(this.operationId, linksAutoResumeAutoImportLink.operationId) &&
        Objects.equals(this.parameters, linksAutoResumeAutoImportLink.parameters) &&
        Objects.equals(this.urlTemplated, linksAutoResumeAutoImportLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksAutoResumeAutoImportLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksAutoResumeAutoImportLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksAutoResumeAutoImportLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksAutoResumeAutoImportLink is not found in the empty JSON string", LinksAutoResumeAutoImportLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksAutoResumeAutoImportLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksAutoResumeAutoImportLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksAutoResumeAutoImportLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksAutoResumeAutoImportLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksAutoResumeAutoImportLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksAutoResumeAutoImportLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksAutoResumeAutoImportLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksAutoResumeAutoImportLink>() {
           @Override
           public void write(JsonWriter out, LinksAutoResumeAutoImportLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksAutoResumeAutoImportLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksAutoResumeAutoImportLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksAutoResumeAutoImportLink
   * @throws IOException if the JSON string is invalid with respect to LinksAutoResumeAutoImportLink
   */
  public static LinksAutoResumeAutoImportLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksAutoResumeAutoImportLink.class);
  }

  /**
   * Convert an instance of LinksAutoResumeAutoImportLink to an JSON string
   *
   * @return JSON string
   */
