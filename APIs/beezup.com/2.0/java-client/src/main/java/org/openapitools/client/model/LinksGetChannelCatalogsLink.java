...
public class LinksGetChannelCatalogsLink {
  ...
  public LinksGetChannelCatalogsLink() {
  }

  public LinksGetChannelCatalogsLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetChannelCatalogsLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetChannelCatalogsLink description(String description) {
  ...
  public LinksGetChannelCatalogsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetChannelCatalogsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetChannelCatalogsLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetChannelCatalogsLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetChannelCatalogsLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetChannelCatalogsLink operationId(String operationId) {
  ...
  public LinksGetChannelCatalogsLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetChannelCatalogsLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetChannelCatalogsLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetChannelCatalogsLink linksGetChannelCatalogsLink = (LinksGetChannelCatalogsLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetChannelCatalogsLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetChannelCatalogsLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetChannelCatalogsLink.description) &&
        Objects.equals(this.docUrl, linksGetChannelCatalogsLink.docUrl) &&
        Objects.equals(this.href, linksGetChannelCatalogsLink.href) &&
        Objects.equals(this.info, linksGetChannelCatalogsLink.info) &&
        Objects.equals(this.label, linksGetChannelCatalogsLink.label) &&
        Objects.equals(this.method, linksGetChannelCatalogsLink.method) &&
        Objects.equals(this.operationId, linksGetChannelCatalogsLink.operationId) &&
        Objects.equals(this.parameters, linksGetChannelCatalogsLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetChannelCatalogsLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetChannelCatalogsLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetChannelCatalogsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetChannelCatalogsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetChannelCatalogsLink is not found in the empty JSON string", LinksGetChannelCatalogsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetChannelCatalogsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetChannelCatalogsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetChannelCatalogsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetChannelCatalogsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetChannelCatalogsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetChannelCatalogsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetChannelCatalogsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetChannelCatalogsLink>() {
           @Override
           public void write(JsonWriter out, LinksGetChannelCatalogsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetChannelCatalogsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetChannelCatalogsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetChannelCatalogsLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetChannelCatalogsLink
   */
  public static LinksGetChannelCatalogsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetChannelCatalogsLink.class);
  }

  /**
   * Convert an instance of LinksGetChannelCatalogsLink to an JSON string
   *
   * @return JSON string
   */
