...
public class LinksAutoPauseAutoImportLink {
  ...
  public LinksAutoPauseAutoImportLink() {
  }

  public LinksAutoPauseAutoImportLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksAutoPauseAutoImportLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksAutoPauseAutoImportLink description(String description) {
  ...
  public LinksAutoPauseAutoImportLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksAutoPauseAutoImportLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksAutoPauseAutoImportLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksAutoPauseAutoImportLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksAutoPauseAutoImportLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksAutoPauseAutoImportLink operationId(String operationId) {
  ...
  public LinksAutoPauseAutoImportLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksAutoPauseAutoImportLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksAutoPauseAutoImportLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksAutoPauseAutoImportLink linksAutoPauseAutoImportLink = (LinksAutoPauseAutoImportLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksAutoPauseAutoImportLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksAutoPauseAutoImportLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksAutoPauseAutoImportLink.description) &&
        Objects.equals(this.docUrl, linksAutoPauseAutoImportLink.docUrl) &&
        Objects.equals(this.href, linksAutoPauseAutoImportLink.href) &&
        Objects.equals(this.info, linksAutoPauseAutoImportLink.info) &&
        Objects.equals(this.label, linksAutoPauseAutoImportLink.label) &&
        Objects.equals(this.method, linksAutoPauseAutoImportLink.method) &&
        Objects.equals(this.operationId, linksAutoPauseAutoImportLink.operationId) &&
        Objects.equals(this.parameters, linksAutoPauseAutoImportLink.parameters) &&
        Objects.equals(this.urlTemplated, linksAutoPauseAutoImportLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksAutoPauseAutoImportLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksAutoPauseAutoImportLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksAutoPauseAutoImportLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksAutoPauseAutoImportLink is not found in the empty JSON string", LinksAutoPauseAutoImportLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksAutoPauseAutoImportLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksAutoPauseAutoImportLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksAutoPauseAutoImportLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksAutoPauseAutoImportLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksAutoPauseAutoImportLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksAutoPauseAutoImportLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksAutoPauseAutoImportLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksAutoPauseAutoImportLink>() {
           @Override
           public void write(JsonWriter out, LinksAutoPauseAutoImportLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksAutoPauseAutoImportLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksAutoPauseAutoImportLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksAutoPauseAutoImportLink
   * @throws IOException if the JSON string is invalid with respect to LinksAutoPauseAutoImportLink
   */
  public static LinksAutoPauseAutoImportLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksAutoPauseAutoImportLink.class);
  }

  /**
   * Convert an instance of LinksAutoPauseAutoImportLink to an JSON string
   *
   * @return JSON string
   */
