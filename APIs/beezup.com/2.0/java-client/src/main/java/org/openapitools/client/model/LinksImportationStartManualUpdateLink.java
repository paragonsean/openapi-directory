...
public class LinksImportationStartManualUpdateLink {
  ...
  public LinksImportationStartManualUpdateLink() {
  }

  public LinksImportationStartManualUpdateLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationStartManualUpdateLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationStartManualUpdateLink description(String description) {
  ...
  public LinksImportationStartManualUpdateLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationStartManualUpdateLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationStartManualUpdateLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationStartManualUpdateLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationStartManualUpdateLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationStartManualUpdateLink operationId(String operationId) {
  ...
  public LinksImportationStartManualUpdateLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationStartManualUpdateLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationStartManualUpdateLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationStartManualUpdateLink linksImportationStartManualUpdateLink = (LinksImportationStartManualUpdateLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationStartManualUpdateLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationStartManualUpdateLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationStartManualUpdateLink.description) &&
        Objects.equals(this.docUrl, linksImportationStartManualUpdateLink.docUrl) &&
        Objects.equals(this.href, linksImportationStartManualUpdateLink.href) &&
        Objects.equals(this.info, linksImportationStartManualUpdateLink.info) &&
        Objects.equals(this.label, linksImportationStartManualUpdateLink.label) &&
        Objects.equals(this.method, linksImportationStartManualUpdateLink.method) &&
        Objects.equals(this.operationId, linksImportationStartManualUpdateLink.operationId) &&
        Objects.equals(this.parameters, linksImportationStartManualUpdateLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationStartManualUpdateLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationStartManualUpdateLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationStartManualUpdateLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationStartManualUpdateLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationStartManualUpdateLink is not found in the empty JSON string", LinksImportationStartManualUpdateLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationStartManualUpdateLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationStartManualUpdateLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationStartManualUpdateLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationStartManualUpdateLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationStartManualUpdateLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationStartManualUpdateLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationStartManualUpdateLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationStartManualUpdateLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationStartManualUpdateLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationStartManualUpdateLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationStartManualUpdateLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationStartManualUpdateLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationStartManualUpdateLink
   */
  public static LinksImportationStartManualUpdateLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationStartManualUpdateLink.class);
  }

  /**
   * Convert an instance of LinksImportationStartManualUpdateLink to an JSON string
   *
   * @return JSON string
   */
