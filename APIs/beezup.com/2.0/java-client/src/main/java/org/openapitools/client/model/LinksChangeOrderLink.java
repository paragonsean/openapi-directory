...
public class LinksChangeOrderLink {
  ...
  public LinksChangeOrderLink() {
  }

  public LinksChangeOrderLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksChangeOrderLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksChangeOrderLink description(String description) {
  ...
  public LinksChangeOrderLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksChangeOrderLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksChangeOrderLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksChangeOrderLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksChangeOrderLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksChangeOrderLink operationId(String operationId) {
  ...
  public LinksChangeOrderLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksChangeOrderLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksChangeOrderLink urlTemplated(Boolean urlTemplated) {
  ...
  public LinksChangeOrderLink rel(String rel) {
    this.rel = rel;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LinksChangeOrderLink linksChangeOrderLink = (LinksChangeOrderLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksChangeOrderLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksChangeOrderLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksChangeOrderLink.description) &&
        Objects.equals(this.docUrl, linksChangeOrderLink.docUrl) &&
        Objects.equals(this.href, linksChangeOrderLink.href) &&
        Objects.equals(this.info, linksChangeOrderLink.info) &&
        Objects.equals(this.label, linksChangeOrderLink.label) &&
        Objects.equals(this.method, linksChangeOrderLink.method) &&
        Objects.equals(this.operationId, linksChangeOrderLink.operationId) &&
        Objects.equals(this.parameters, linksChangeOrderLink.parameters) &&
        Objects.equals(this.urlTemplated, linksChangeOrderLink.urlTemplated) &&
        Objects.equals(this.rel, linksChangeOrderLink.rel);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allOptionalParamsProvided, allRequiredParamsProvided, description, docUrl, href, info, label, method, operationId, parameters, urlTemplated, rel);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LinksChangeOrderLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksChangeOrderLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksChangeOrderLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksChangeOrderLink is not found in the empty JSON string", LinksChangeOrderLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksChangeOrderLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksChangeOrderLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksChangeOrderLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksChangeOrderLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksChangeOrderLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksChangeOrderLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksChangeOrderLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksChangeOrderLink>() {
           @Override
           public void write(JsonWriter out, LinksChangeOrderLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksChangeOrderLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksChangeOrderLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksChangeOrderLink
   * @throws IOException if the JSON string is invalid with respect to LinksChangeOrderLink
   */
  public static LinksChangeOrderLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksChangeOrderLink.class);
  }

  /**
   * Convert an instance of LinksChangeOrderLink to an JSON string
   *
   * @return JSON string
   */
