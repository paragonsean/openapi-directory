...
public class LinksSaveCreditCardInfoLink {
  ...
  public LinksSaveCreditCardInfoLink() {
  }
  ...
  public LinksSaveCreditCardInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksSaveCreditCardInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksSaveCreditCardInfoLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksSaveCreditCardInfoLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksSaveCreditCardInfoLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksSaveCreditCardInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksSaveCreditCardInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksSaveCreditCardInfoLink is not found in the empty JSON string", LinksSaveCreditCardInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksSaveCreditCardInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksSaveCreditCardInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksSaveCreditCardInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksSaveCreditCardInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksSaveCreditCardInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksSaveCreditCardInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksSaveCreditCardInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksSaveCreditCardInfoLink>() {
           @Override
           public void write(JsonWriter out, LinksSaveCreditCardInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksSaveCreditCardInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksSaveCreditCardInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksSaveCreditCardInfoLink
   * @throws IOException if the JSON string is invalid with respect to LinksSaveCreditCardInfoLink
   */
  public static LinksSaveCreditCardInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksSaveCreditCardInfoLink.class);
  }

  /**
   * Convert an instance of LinksSaveCreditCardInfoLink to an JSON string
   *
   * @return JSON string
   */
