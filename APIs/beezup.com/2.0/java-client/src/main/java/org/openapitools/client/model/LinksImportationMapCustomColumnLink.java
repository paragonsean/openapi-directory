...
public class LinksImportationMapCustomColumnLink {
  ...
  public LinksImportationMapCustomColumnLink() {
  }

  public LinksImportationMapCustomColumnLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationMapCustomColumnLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationMapCustomColumnLink description(String description) {
  ...
  public LinksImportationMapCustomColumnLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationMapCustomColumnLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationMapCustomColumnLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationMapCustomColumnLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationMapCustomColumnLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationMapCustomColumnLink operationId(String operationId) {
  ...
  public LinksImportationMapCustomColumnLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationMapCustomColumnLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationMapCustomColumnLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationMapCustomColumnLink linksImportationMapCustomColumnLink = (LinksImportationMapCustomColumnLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationMapCustomColumnLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationMapCustomColumnLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationMapCustomColumnLink.description) &&
        Objects.equals(this.docUrl, linksImportationMapCustomColumnLink.docUrl) &&
        Objects.equals(this.href, linksImportationMapCustomColumnLink.href) &&
        Objects.equals(this.info, linksImportationMapCustomColumnLink.info) &&
        Objects.equals(this.label, linksImportationMapCustomColumnLink.label) &&
        Objects.equals(this.method, linksImportationMapCustomColumnLink.method) &&
        Objects.equals(this.operationId, linksImportationMapCustomColumnLink.operationId) &&
        Objects.equals(this.parameters, linksImportationMapCustomColumnLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationMapCustomColumnLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationMapCustomColumnLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationMapCustomColumnLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationMapCustomColumnLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationMapCustomColumnLink is not found in the empty JSON string", LinksImportationMapCustomColumnLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationMapCustomColumnLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationMapCustomColumnLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationMapCustomColumnLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationMapCustomColumnLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationMapCustomColumnLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationMapCustomColumnLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationMapCustomColumnLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationMapCustomColumnLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationMapCustomColumnLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationMapCustomColumnLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationMapCustomColumnLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationMapCustomColumnLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationMapCustomColumnLink
   */
  public static LinksImportationMapCustomColumnLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationMapCustomColumnLink.class);
  }

  /**
   * Convert an instance of LinksImportationMapCustomColumnLink to an JSON string
   *
   * @return JSON string
   */
