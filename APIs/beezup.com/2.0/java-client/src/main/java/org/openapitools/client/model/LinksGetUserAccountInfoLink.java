...
public class LinksGetUserAccountInfoLink {
  ...
  public LinksGetUserAccountInfoLink() {
  }

  public LinksGetUserAccountInfoLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetUserAccountInfoLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetUserAccountInfoLink description(String description) {
  ...
  public LinksGetUserAccountInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetUserAccountInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetUserAccountInfoLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetUserAccountInfoLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetUserAccountInfoLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetUserAccountInfoLink operationId(String operationId) {
  ...
  public LinksGetUserAccountInfoLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetUserAccountInfoLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetUserAccountInfoLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetUserAccountInfoLink linksGetUserAccountInfoLink = (LinksGetUserAccountInfoLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetUserAccountInfoLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetUserAccountInfoLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetUserAccountInfoLink.description) &&
        Objects.equals(this.docUrl, linksGetUserAccountInfoLink.docUrl) &&
        Objects.equals(this.href, linksGetUserAccountInfoLink.href) &&
        Objects.equals(this.info, linksGetUserAccountInfoLink.info) &&
        Objects.equals(this.label, linksGetUserAccountInfoLink.label) &&
        Objects.equals(this.method, linksGetUserAccountInfoLink.method) &&
        Objects.equals(this.operationId, linksGetUserAccountInfoLink.operationId) &&
        Objects.equals(this.parameters, linksGetUserAccountInfoLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetUserAccountInfoLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetUserAccountInfoLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetUserAccountInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetUserAccountInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetUserAccountInfoLink is not found in the empty JSON string", LinksGetUserAccountInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetUserAccountInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetUserAccountInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetUserAccountInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetUserAccountInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetUserAccountInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetUserAccountInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetUserAccountInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetUserAccountInfoLink>() {
           @Override
           public void write(JsonWriter out, LinksGetUserAccountInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetUserAccountInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetUserAccountInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetUserAccountInfoLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetUserAccountInfoLink
   */
  public static LinksGetUserAccountInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetUserAccountInfoLink.class);
  }

  /**
   * Convert an instance of LinksGetUserAccountInfoLink to an JSON string
   *
   * @return JSON string
   */
