...
public class LinksGetChannelCatalogLink {
  ...
  public LinksGetChannelCatalogLink() {
  }

  public LinksGetChannelCatalogLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetChannelCatalogLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetChannelCatalogLink description(String description) {
  ...
  public LinksGetChannelCatalogLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetChannelCatalogLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetChannelCatalogLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetChannelCatalogLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetChannelCatalogLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetChannelCatalogLink operationId(String operationId) {
  ...
  public LinksGetChannelCatalogLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetChannelCatalogLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetChannelCatalogLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetChannelCatalogLink linksGetChannelCatalogLink = (LinksGetChannelCatalogLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetChannelCatalogLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetChannelCatalogLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetChannelCatalogLink.description) &&
        Objects.equals(this.docUrl, linksGetChannelCatalogLink.docUrl) &&
        Objects.equals(this.href, linksGetChannelCatalogLink.href) &&
        Objects.equals(this.info, linksGetChannelCatalogLink.info) &&
        Objects.equals(this.label, linksGetChannelCatalogLink.label) &&
        Objects.equals(this.method, linksGetChannelCatalogLink.method) &&
        Objects.equals(this.operationId, linksGetChannelCatalogLink.operationId) &&
        Objects.equals(this.parameters, linksGetChannelCatalogLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetChannelCatalogLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetChannelCatalogLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetChannelCatalogLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetChannelCatalogLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetChannelCatalogLink is not found in the empty JSON string", LinksGetChannelCatalogLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetChannelCatalogLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetChannelCatalogLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetChannelCatalogLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetChannelCatalogLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetChannelCatalogLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetChannelCatalogLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetChannelCatalogLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetChannelCatalogLink>() {
           @Override
           public void write(JsonWriter out, LinksGetChannelCatalogLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetChannelCatalogLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetChannelCatalogLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetChannelCatalogLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetChannelCatalogLink
   */
  public static LinksGetChannelCatalogLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetChannelCatalogLink.class);
  }

  /**
   * Convert an instance of LinksGetChannelCatalogLink to an JSON string
   *
   * @return JSON string
   */
