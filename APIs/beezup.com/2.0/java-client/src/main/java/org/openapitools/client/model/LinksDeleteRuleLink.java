...
public class LinksDeleteRuleLink {
  ...
  public LinksDeleteRuleLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksDeleteRuleLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksDeleteRuleLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksDeleteRuleLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksDeleteRuleLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksDeleteRuleLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksDeleteRuleLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksDeleteRuleLink is not found in the empty JSON string", LinksDeleteRuleLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksDeleteRuleLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksDeleteRuleLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksDeleteRuleLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksDeleteRuleLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksDeleteRuleLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksDeleteRuleLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksDeleteRuleLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksDeleteRuleLink>() {
           @Override
           public void write(JsonWriter out, LinksDeleteRuleLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksDeleteRuleLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksDeleteRuleLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksDeleteRuleLink
   * @throws IOException if the JSON string is invalid with respect to LinksDeleteRuleLink
   */
  public static LinksDeleteRuleLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksDeleteRuleLink.class);
  }

  /**
   * Convert an instance of LinksDeleteRuleLink to an JSON string
   *
   * @return JSON string
   */
