...
public class LinksGetAutomaticTransitionsLink {
  ...
  public LinksGetAutomaticTransitionsLink() {
  }
  ...
  public LinksGetAutomaticTransitionsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetAutomaticTransitionsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetAutomaticTransitionsLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetAutomaticTransitionsLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetAutomaticTransitionsLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetAutomaticTransitionsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetAutomaticTransitionsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetAutomaticTransitionsLink is not found in the empty JSON string", LinksGetAutomaticTransitionsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetAutomaticTransitionsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetAutomaticTransitionsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetAutomaticTransitionsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetAutomaticTransitionsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetAutomaticTransitionsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetAutomaticTransitionsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetAutomaticTransitionsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetAutomaticTransitionsLink>() {
           @Override
           public void write(JsonWriter out, LinksGetAutomaticTransitionsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetAutomaticTransitionsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetAutomaticTransitionsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetAutomaticTransitionsLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetAutomaticTransitionsLink
   */
  public static LinksGetAutomaticTransitionsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetAutomaticTransitionsLink.class);
  }

  /**
   * Convert an instance of LinksGetAutomaticTransitionsLink to an JSON string
   *
   * @return JSON string
   */
