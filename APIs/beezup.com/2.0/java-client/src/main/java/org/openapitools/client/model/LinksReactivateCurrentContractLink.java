...
public class LinksReactivateCurrentContractLink {
  ...
  public LinksReactivateCurrentContractLink() {
  }

  public LinksReactivateCurrentContractLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksReactivateCurrentContractLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksReactivateCurrentContractLink description(String description) {
  ...
  public LinksReactivateCurrentContractLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksReactivateCurrentContractLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksReactivateCurrentContractLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksReactivateCurrentContractLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksReactivateCurrentContractLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksReactivateCurrentContractLink operationId(String operationId) {
  ...
  public LinksReactivateCurrentContractLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksReactivateCurrentContractLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksReactivateCurrentContractLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksReactivateCurrentContractLink linksReactivateCurrentContractLink = (LinksReactivateCurrentContractLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksReactivateCurrentContractLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksReactivateCurrentContractLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksReactivateCurrentContractLink.description) &&
        Objects.equals(this.docUrl, linksReactivateCurrentContractLink.docUrl) &&
        Objects.equals(this.href, linksReactivateCurrentContractLink.href) &&
        Objects.equals(this.info, linksReactivateCurrentContractLink.info) &&
        Objects.equals(this.label, linksReactivateCurrentContractLink.label) &&
        Objects.equals(this.method, linksReactivateCurrentContractLink.method) &&
        Objects.equals(this.operationId, linksReactivateCurrentContractLink.operationId) &&
        Objects.equals(this.parameters, linksReactivateCurrentContractLink.parameters) &&
        Objects.equals(this.urlTemplated, linksReactivateCurrentContractLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksReactivateCurrentContractLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksReactivateCurrentContractLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksReactivateCurrentContractLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksReactivateCurrentContractLink is not found in the empty JSON string", LinksReactivateCurrentContractLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksReactivateCurrentContractLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksReactivateCurrentContractLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksReactivateCurrentContractLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksReactivateCurrentContractLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksReactivateCurrentContractLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksReactivateCurrentContractLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksReactivateCurrentContractLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksReactivateCurrentContractLink>() {
           @Override
           public void write(JsonWriter out, LinksReactivateCurrentContractLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksReactivateCurrentContractLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksReactivateCurrentContractLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksReactivateCurrentContractLink
   * @throws IOException if the JSON string is invalid with respect to LinksReactivateCurrentContractLink
   */
  public static LinksReactivateCurrentContractLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksReactivateCurrentContractLink.class);
  }

  /**
   * Convert an instance of LinksReactivateCurrentContractLink to an JSON string
   *
   * @return JSON string
   */
