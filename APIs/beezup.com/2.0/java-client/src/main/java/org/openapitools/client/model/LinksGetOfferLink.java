...
public class LinksGetOfferLink {
  ...
  public LinksGetOfferLink() {
  }

  public LinksGetOfferLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetOfferLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetOfferLink description(String description) {
  ...
  public LinksGetOfferLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetOfferLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetOfferLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetOfferLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetOfferLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetOfferLink operationId(String operationId) {
  ...
  public LinksGetOfferLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetOfferLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetOfferLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetOfferLink linksGetOfferLink = (LinksGetOfferLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetOfferLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetOfferLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetOfferLink.description) &&
        Objects.equals(this.docUrl, linksGetOfferLink.docUrl) &&
        Objects.equals(this.href, linksGetOfferLink.href) &&
        Objects.equals(this.info, linksGetOfferLink.info) &&
        Objects.equals(this.label, linksGetOfferLink.label) &&
        Objects.equals(this.method, linksGetOfferLink.method) &&
        Objects.equals(this.operationId, linksGetOfferLink.operationId) &&
        Objects.equals(this.parameters, linksGetOfferLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetOfferLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetOfferLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetOfferLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetOfferLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetOfferLink is not found in the empty JSON string", LinksGetOfferLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetOfferLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetOfferLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetOfferLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetOfferLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetOfferLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetOfferLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetOfferLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetOfferLink>() {
           @Override
           public void write(JsonWriter out, LinksGetOfferLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetOfferLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetOfferLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetOfferLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetOfferLink
   */
  public static LinksGetOfferLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetOfferLink.class);
  }

  /**
   * Convert an instance of LinksGetOfferLink to an JSON string
   *
   * @return JSON string
   */
