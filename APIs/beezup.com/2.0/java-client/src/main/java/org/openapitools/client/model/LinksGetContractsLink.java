...
public class LinksGetContractsLink {
  ...
  public LinksGetContractsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetContractsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetContractsLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetContractsLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetContractsLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetContractsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetContractsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetContractsLink is not found in the empty JSON string", LinksGetContractsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetContractsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetContractsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetContractsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetContractsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetContractsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetContractsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetContractsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetContractsLink>() {
           @Override
           public void write(JsonWriter out, LinksGetContractsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetContractsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetContractsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetContractsLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetContractsLink
   */
  public static LinksGetContractsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetContractsLink.class);
  }

  /**
   * Convert an instance of LinksGetContractsLink to an JSON string
   *
   * @return JSON string
   */
