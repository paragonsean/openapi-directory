...
public class LinksGetRulesLink {
  ...
  public LinksGetRulesLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetRulesLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetRulesLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetRulesLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetRulesLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetRulesLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetRulesLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetRulesLink is not found in the empty JSON string", LinksGetRulesLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetRulesLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetRulesLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetRulesLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetRulesLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetRulesLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetRulesLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetRulesLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetRulesLink>() {
           @Override
           public void write(JsonWriter out, LinksGetRulesLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetRulesLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetRulesLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetRulesLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetRulesLink
   */
  public static LinksGetRulesLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetRulesLink.class);
  }

  /**
   * Convert an instance of LinksGetRulesLink to an JSON string
   *
   * @return JSON string
   */
