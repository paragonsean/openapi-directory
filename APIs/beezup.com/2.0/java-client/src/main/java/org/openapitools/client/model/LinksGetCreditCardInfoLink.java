...
public class LinksGetCreditCardInfoLink {
  ...
  public LinksGetCreditCardInfoLink() {
  }
  ...
  public LinksGetCreditCardInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetCreditCardInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetCreditCardInfoLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetCreditCardInfoLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetCreditCardInfoLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetCreditCardInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetCreditCardInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetCreditCardInfoLink is not found in the empty JSON string", LinksGetCreditCardInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetCreditCardInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetCreditCardInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetCreditCardInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetCreditCardInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetCreditCardInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetCreditCardInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetCreditCardInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetCreditCardInfoLink>() {
           @Override
           public void write(JsonWriter out, LinksGetCreditCardInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetCreditCardInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetCreditCardInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetCreditCardInfoLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetCreditCardInfoLink
   */
  public static LinksGetCreditCardInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetCreditCardInfoLink.class);
  }

  /**
   * Convert an instance of LinksGetCreditCardInfoLink to an JSON string
   *
   * @return JSON string
   */
