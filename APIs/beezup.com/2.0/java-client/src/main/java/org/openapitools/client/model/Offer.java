...
import org.openapitools.client.model.OfferContent;
import org.openapitools.client.model.OfferLinks;
...
public class Offer {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        OfferContent.validateJsonElement(jsonObj.get("content"));
      }
      ...
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        OfferLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
