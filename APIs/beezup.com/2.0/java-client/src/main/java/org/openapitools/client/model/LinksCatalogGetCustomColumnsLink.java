...
public class LinksCatalogGetCustomColumnsLink {
  ...
  public LinksCatalogGetCustomColumnsLink() {
  }

  public LinksCatalogGetCustomColumnsLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksCatalogGetCustomColumnsLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksCatalogGetCustomColumnsLink description(String description) {
  ...
  public LinksCatalogGetCustomColumnsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCatalogGetCustomColumnsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCatalogGetCustomColumnsLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksCatalogGetCustomColumnsLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksCatalogGetCustomColumnsLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksCatalogGetCustomColumnsLink operationId(String operationId) {
  ...
  public LinksCatalogGetCustomColumnsLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksCatalogGetCustomColumnsLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksCatalogGetCustomColumnsLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksCatalogGetCustomColumnsLink linksCatalogGetCustomColumnsLink = (LinksCatalogGetCustomColumnsLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksCatalogGetCustomColumnsLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksCatalogGetCustomColumnsLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksCatalogGetCustomColumnsLink.description) &&
        Objects.equals(this.docUrl, linksCatalogGetCustomColumnsLink.docUrl) &&
        Objects.equals(this.href, linksCatalogGetCustomColumnsLink.href) &&
        Objects.equals(this.info, linksCatalogGetCustomColumnsLink.info) &&
        Objects.equals(this.label, linksCatalogGetCustomColumnsLink.label) &&
        Objects.equals(this.method, linksCatalogGetCustomColumnsLink.method) &&
        Objects.equals(this.operationId, linksCatalogGetCustomColumnsLink.operationId) &&
        Objects.equals(this.parameters, linksCatalogGetCustomColumnsLink.parameters) &&
        Objects.equals(this.urlTemplated, linksCatalogGetCustomColumnsLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksCatalogGetCustomColumnsLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCatalogGetCustomColumnsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCatalogGetCustomColumnsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCatalogGetCustomColumnsLink is not found in the empty JSON string", LinksCatalogGetCustomColumnsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCatalogGetCustomColumnsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCatalogGetCustomColumnsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCatalogGetCustomColumnsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCatalogGetCustomColumnsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCatalogGetCustomColumnsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCatalogGetCustomColumnsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCatalogGetCustomColumnsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCatalogGetCustomColumnsLink>() {
           @Override
           public void write(JsonWriter out, LinksCatalogGetCustomColumnsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCatalogGetCustomColumnsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCatalogGetCustomColumnsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCatalogGetCustomColumnsLink
   * @throws IOException if the JSON string is invalid with respect to LinksCatalogGetCustomColumnsLink
   */
  public static LinksCatalogGetCustomColumnsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCatalogGetCustomColumnsLink.class);
  }

  /**
   * Convert an instance of LinksCatalogGetCustomColumnsLink to an JSON string
   *
   * @return JSON string
   */
