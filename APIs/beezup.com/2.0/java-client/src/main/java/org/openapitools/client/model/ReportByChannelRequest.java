...
public class ReportByChannelRequest {
  ...
  public ReportByChannelRequest beginPeriodUtcDate(OffsetDateTime beginPeriodUtcDate) {
  ...
  public ReportByChannelRequest categoryFilter(BeezUPCommonCatalogCategoryFilter categoryFilter) {
  ...
  public ReportByChannelRequest channelId(String channelId) {
  ...
  public ReportByChannelRequest endPeriodUtcDate(OffsetDateTime endPeriodUtcDate) {
  ...
  public ReportByChannelRequest performanceIndicatorFilters(List<PerformanceIndicatorFilter> performanceIndicatorFilters) {
    this.performanceIndicatorFilters = performanceIndicatorFilters;
    return this;
  }

  public ReportByChannelRequest addPerformanceIndicatorFiltersItem(PerformanceIndicatorFilter performanceIndicatorFiltersItem) {
  ...
  public ReportByChannelRequest periodType(ReportFilterPeriodType periodType) {
  ...
  public ReportByChannelRequest orderBy(PerformanceIndicatorType orderBy) {
  ...
  public ReportByChannelRequest orderByDirection(OrderByDirection orderByDirection) {
  ...
  public ReportByChannelRequest pageNumber(Integer pageNumber) {
  ...
  public ReportByChannelRequest pageSize(Integer pageSize) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.advancedFilters, reportByChannelRequest.advancedFilters) &&
        ...
        Objects.equals(this.channelId, reportByChannelRequest.channelId) &&
        Objects.equals(this.endPeriodUtcDate, reportByChannelRequest.endPeriodUtcDate) &&
        Objects.equals(this.performanceIndicatorFilters, reportByChannelRequest.performanceIndicatorFilters) &&
        Objects.equals(this.periodType, reportByChannelRequest.periodType) &&
        Objects.equals(this.orderBy, reportByChannelRequest.orderBy) &&
        Objects.equals(this.orderByDirection, reportByChannelRequest.orderByDirection) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReportByChannelRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportByChannelRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportByChannelRequest is not found in the empty JSON string", ReportByChannelRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportByChannelRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportByChannelRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReportByChannelRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportByChannelRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportByChannelRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportByChannelRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportByChannelRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportByChannelRequest>() {
           @Override
           public void write(JsonWriter out, ReportByChannelRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportByChannelRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReportByChannelRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReportByChannelRequest
   * @throws IOException if the JSON string is invalid with respect to ReportByChannelRequest
   */
  public static ReportByChannelRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportByChannelRequest.class);
  }

  /**
   * Convert an instance of ReportByChannelRequest to an JSON string
   *
   * @return JSON string
   */
