...
public class LinksRunRulesLink {
  ...
  public LinksRunRulesLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksRunRulesLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksRunRulesLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksRunRulesLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksRunRulesLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksRunRulesLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksRunRulesLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksRunRulesLink is not found in the empty JSON string", LinksRunRulesLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksRunRulesLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksRunRulesLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksRunRulesLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksRunRulesLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksRunRulesLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksRunRulesLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksRunRulesLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksRunRulesLink>() {
           @Override
           public void write(JsonWriter out, LinksRunRulesLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksRunRulesLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksRunRulesLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksRunRulesLink
   * @throws IOException if the JSON string is invalid with respect to LinksRunRulesLink
   */
  public static LinksRunRulesLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksRunRulesLink.class);
  }

  /**
   * Convert an instance of LinksRunRulesLink to an JSON string
   *
   * @return JSON string
   */
