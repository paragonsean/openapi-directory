...
public class BeezUPCommonSuccessSummary {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.objectName, beezUPCommonSuccessSummary.objectName) &&
        ...
        Objects.equals(this.successCode, beezUPCommonSuccessSummary.successCode) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to BeezUPCommonSuccessSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BeezUPCommonSuccessSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BeezUPCommonSuccessSummary is not found in the empty JSON string", BeezUPCommonSuccessSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BeezUPCommonSuccessSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BeezUPCommonSuccessSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BeezUPCommonSuccessSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BeezUPCommonSuccessSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BeezUPCommonSuccessSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BeezUPCommonSuccessSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<BeezUPCommonSuccessSummary>() {
           @Override
           public void write(JsonWriter out, BeezUPCommonSuccessSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BeezUPCommonSuccessSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BeezUPCommonSuccessSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BeezUPCommonSuccessSummary
   * @throws IOException if the JSON string is invalid with respect to BeezUPCommonSuccessSummary
   */
  public static BeezUPCommonSuccessSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BeezUPCommonSuccessSummary.class);
  }

  /**
   * Convert an instance of BeezUPCommonSuccessSummary to an JSON string
   *
   * @return JSON string
   */
