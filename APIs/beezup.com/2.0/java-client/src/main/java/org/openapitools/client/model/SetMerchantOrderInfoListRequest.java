...
public class SetMerchantOrderInfoListRequest {
  ...
  private Set<SetMerchantOrderInfoListRequestItem> orders = new LinkedHashSet<>();

  public SetMerchantOrderInfoListRequest() {
  }

  public SetMerchantOrderInfoListRequest orderMerchantECommerceSoftwareName(String orderMerchantECommerceSoftwareName) {
  ...
  public SetMerchantOrderInfoListRequest orderMerchantECommerceSoftwareVersion(String orderMerchantECommerceSoftwareVersion) {
  ...
  public SetMerchantOrderInfoListRequest orders(Set<SetMerchantOrderInfoListRequestItem> orders) {
    this.orders = orders;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public Set<SetMerchantOrderInfoListRequestItem> getOrders() {
    return orders;
  }

  public void setOrders(Set<SetMerchantOrderInfoListRequestItem> orders) {
    this.orders = orders;
  }
  ...
  static {
    ...
    openapiRequiredFields.add("order_MerchantECommerceSoftwareName");
    openapiRequiredFields.add("order_MerchantECommerceSoftwareVersion");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetMerchantOrderInfoListRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetMerchantOrderInfoListRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetMerchantOrderInfoListRequest is not found in the empty JSON string", SetMerchantOrderInfoListRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetMerchantOrderInfoListRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetMerchantOrderInfoListRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetMerchantOrderInfoListRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("order_MerchantECommerceSoftwareName").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("order_MerchantECommerceSoftwareVersion").isJsonPrimitive()) {
      ...
      for (int i = 0; i < jsonArrayorders.size(); i++) {
        SetMerchantOrderInfoListRequestItem.validateJsonElement(jsonArrayorders.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetMerchantOrderInfoListRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetMerchantOrderInfoListRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetMerchantOrderInfoListRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetMerchantOrderInfoListRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SetMerchantOrderInfoListRequest>() {
           @Override
           public void write(JsonWriter out, SetMerchantOrderInfoListRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetMerchantOrderInfoListRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetMerchantOrderInfoListRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetMerchantOrderInfoListRequest
   * @throws IOException if the JSON string is invalid with respect to SetMerchantOrderInfoListRequest
   */
  public static SetMerchantOrderInfoListRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetMerchantOrderInfoListRequest.class);
  }

  /**
   * Convert an instance of SetMerchantOrderInfoListRequest to an JSON string
   *
   * @return JSON string
   */
