...
public class LinksPublishCatalogToMarketplaceLink {
  ...
  public LinksPublishCatalogToMarketplaceLink() {
  }

  public LinksPublishCatalogToMarketplaceLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksPublishCatalogToMarketplaceLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksPublishCatalogToMarketplaceLink description(String description) {
  ...
  public LinksPublishCatalogToMarketplaceLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksPublishCatalogToMarketplaceLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksPublishCatalogToMarketplaceLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksPublishCatalogToMarketplaceLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksPublishCatalogToMarketplaceLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksPublishCatalogToMarketplaceLink operationId(String operationId) {
  ...
  public LinksPublishCatalogToMarketplaceLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksPublishCatalogToMarketplaceLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksPublishCatalogToMarketplaceLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksPublishCatalogToMarketplaceLink linksPublishCatalogToMarketplaceLink = (LinksPublishCatalogToMarketplaceLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksPublishCatalogToMarketplaceLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksPublishCatalogToMarketplaceLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksPublishCatalogToMarketplaceLink.description) &&
        Objects.equals(this.docUrl, linksPublishCatalogToMarketplaceLink.docUrl) &&
        Objects.equals(this.href, linksPublishCatalogToMarketplaceLink.href) &&
        Objects.equals(this.info, linksPublishCatalogToMarketplaceLink.info) &&
        Objects.equals(this.label, linksPublishCatalogToMarketplaceLink.label) &&
        Objects.equals(this.method, linksPublishCatalogToMarketplaceLink.method) &&
        Objects.equals(this.operationId, linksPublishCatalogToMarketplaceLink.operationId) &&
        Objects.equals(this.parameters, linksPublishCatalogToMarketplaceLink.parameters) &&
        Objects.equals(this.urlTemplated, linksPublishCatalogToMarketplaceLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksPublishCatalogToMarketplaceLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksPublishCatalogToMarketplaceLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksPublishCatalogToMarketplaceLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksPublishCatalogToMarketplaceLink is not found in the empty JSON string", LinksPublishCatalogToMarketplaceLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksPublishCatalogToMarketplaceLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksPublishCatalogToMarketplaceLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksPublishCatalogToMarketplaceLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksPublishCatalogToMarketplaceLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksPublishCatalogToMarketplaceLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksPublishCatalogToMarketplaceLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksPublishCatalogToMarketplaceLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksPublishCatalogToMarketplaceLink>() {
           @Override
           public void write(JsonWriter out, LinksPublishCatalogToMarketplaceLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksPublishCatalogToMarketplaceLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksPublishCatalogToMarketplaceLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksPublishCatalogToMarketplaceLink
   * @throws IOException if the JSON string is invalid with respect to LinksPublishCatalogToMarketplaceLink
   */
  public static LinksPublishCatalogToMarketplaceLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksPublishCatalogToMarketplaceLink.class);
  }

  /**
   * Convert an instance of LinksPublishCatalogToMarketplaceLink to an JSON string
   *
   * @return JSON string
   */
