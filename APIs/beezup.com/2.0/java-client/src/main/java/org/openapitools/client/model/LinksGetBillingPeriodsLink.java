...
public class LinksGetBillingPeriodsLink {
  ...
  public LinksGetBillingPeriodsLink() {
  }

  public LinksGetBillingPeriodsLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetBillingPeriodsLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetBillingPeriodsLink description(String description) {
  ...
  public LinksGetBillingPeriodsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetBillingPeriodsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetBillingPeriodsLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetBillingPeriodsLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetBillingPeriodsLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetBillingPeriodsLink operationId(String operationId) {
  ...
  public LinksGetBillingPeriodsLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetBillingPeriodsLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetBillingPeriodsLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetBillingPeriodsLink linksGetBillingPeriodsLink = (LinksGetBillingPeriodsLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetBillingPeriodsLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetBillingPeriodsLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetBillingPeriodsLink.description) &&
        Objects.equals(this.docUrl, linksGetBillingPeriodsLink.docUrl) &&
        Objects.equals(this.href, linksGetBillingPeriodsLink.href) &&
        Objects.equals(this.info, linksGetBillingPeriodsLink.info) &&
        Objects.equals(this.label, linksGetBillingPeriodsLink.label) &&
        Objects.equals(this.method, linksGetBillingPeriodsLink.method) &&
        Objects.equals(this.operationId, linksGetBillingPeriodsLink.operationId) &&
        Objects.equals(this.parameters, linksGetBillingPeriodsLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetBillingPeriodsLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetBillingPeriodsLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetBillingPeriodsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetBillingPeriodsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetBillingPeriodsLink is not found in the empty JSON string", LinksGetBillingPeriodsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetBillingPeriodsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetBillingPeriodsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetBillingPeriodsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetBillingPeriodsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetBillingPeriodsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetBillingPeriodsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetBillingPeriodsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetBillingPeriodsLink>() {
           @Override
           public void write(JsonWriter out, LinksGetBillingPeriodsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetBillingPeriodsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetBillingPeriodsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetBillingPeriodsLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetBillingPeriodsLink
   */
  public static LinksGetBillingPeriodsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetBillingPeriodsLink.class);
  }

  /**
   * Convert an instance of LinksGetBillingPeriodsLink to an JSON string
   *
   * @return JSON string
   */
