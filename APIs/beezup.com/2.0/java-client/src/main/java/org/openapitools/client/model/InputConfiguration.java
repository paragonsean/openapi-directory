...
public class InputConfiguration {
  ...
  private List<InputFileConfiguration> files = new ArrayList<>();

  public static final String SERIALIZED_NAME_TRANSFORM_FILE_URL = "transformFileUrl";
  @SerializedName(SERIALIZED_NAME_TRANSFORM_FILE_URL)
  private URI transformFileUrl;
  ...
  public InputConfiguration transformFileUrl(URI transformFileUrl) {
  ...
  public URI getTransformFileUrl() {
    return transformFileUrl;
  }

  public void setTransformFileUrl(URI transformFileUrl) {
    this.transformFileUrl = transformFileUrl;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.files, inputConfiguration.files) &&
        Objects.equals(this.transformFileUrl, inputConfiguration.transformFileUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(files, transformFileUrl);
  }
  ...
  static {
    ...
    openapiFields.add("transformFileUrl");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayfiles.size(); i++) {
        InputFileConfiguration.validateJsonElement(jsonArrayfiles.get(i));
      };
      if ((jsonObj.get("transformFileUrl") != null && !jsonObj.get("transformFileUrl").isJsonNull()) && !jsonObj.get("transformFileUrl").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `transformFileUrl` to be a primitive type in the JSON string but got `%s`", jsonObj.get("transformFileUrl").toString()));
      }
  }
