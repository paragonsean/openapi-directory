...
public class LinksImportationGetCustomColumnsLink {
  ...
  public LinksImportationGetCustomColumnsLink() {
  }

  public LinksImportationGetCustomColumnsLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationGetCustomColumnsLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationGetCustomColumnsLink description(String description) {
  ...
  public LinksImportationGetCustomColumnsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationGetCustomColumnsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationGetCustomColumnsLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationGetCustomColumnsLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationGetCustomColumnsLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationGetCustomColumnsLink operationId(String operationId) {
  ...
  public LinksImportationGetCustomColumnsLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationGetCustomColumnsLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationGetCustomColumnsLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationGetCustomColumnsLink linksImportationGetCustomColumnsLink = (LinksImportationGetCustomColumnsLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationGetCustomColumnsLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationGetCustomColumnsLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationGetCustomColumnsLink.description) &&
        Objects.equals(this.docUrl, linksImportationGetCustomColumnsLink.docUrl) &&
        Objects.equals(this.href, linksImportationGetCustomColumnsLink.href) &&
        Objects.equals(this.info, linksImportationGetCustomColumnsLink.info) &&
        Objects.equals(this.label, linksImportationGetCustomColumnsLink.label) &&
        Objects.equals(this.method, linksImportationGetCustomColumnsLink.method) &&
        Objects.equals(this.operationId, linksImportationGetCustomColumnsLink.operationId) &&
        Objects.equals(this.parameters, linksImportationGetCustomColumnsLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationGetCustomColumnsLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationGetCustomColumnsLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationGetCustomColumnsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationGetCustomColumnsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationGetCustomColumnsLink is not found in the empty JSON string", LinksImportationGetCustomColumnsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationGetCustomColumnsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationGetCustomColumnsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationGetCustomColumnsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationGetCustomColumnsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationGetCustomColumnsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationGetCustomColumnsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationGetCustomColumnsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationGetCustomColumnsLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationGetCustomColumnsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationGetCustomColumnsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationGetCustomColumnsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationGetCustomColumnsLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationGetCustomColumnsLink
   */
  public static LinksImportationGetCustomColumnsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationGetCustomColumnsLink.class);
  }

  /**
   * Convert an instance of LinksImportationGetCustomColumnsLink to an JSON string
   *
   * @return JSON string
   */
