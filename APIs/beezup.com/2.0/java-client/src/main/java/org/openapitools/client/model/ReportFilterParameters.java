...
public class ReportFilterParameters {
  ...
  public ReportFilterParameters beginPeriodUtcDate(OffsetDateTime beginPeriodUtcDate) {
  ...
  public ReportFilterParameters categoryFilter(BeezUPCommonCatalogCategoryFilter categoryFilter) {
  ...
  public ReportFilterParameters channelId(String channelId) {
  ...
  public ReportFilterParameters endPeriodUtcDate(OffsetDateTime endPeriodUtcDate) {
  ...
  public ReportFilterParameters performanceIndicatorFilters(List<PerformanceIndicatorFilter> performanceIndicatorFilters) {
    this.performanceIndicatorFilters = performanceIndicatorFilters;
    return this;
  }

  public ReportFilterParameters addPerformanceIndicatorFiltersItem(PerformanceIndicatorFilter performanceIndicatorFiltersItem) {
  ...
  public ReportFilterParameters periodType(ReportFilterPeriodType periodType) {
  ...
  public ReportFilterParameters analyticsProductColumnFilters(AnalyticsProductColumnFilters analyticsProductColumnFilters) {
  ...
  public ReportFilterParameters productColumnsToDisplay(List<String> productColumnsToDisplay) {
    this.productColumnsToDisplay = productColumnsToDisplay;
    return this;
  }

  public ReportFilterParameters addProductColumnsToDisplayItem(String productColumnsToDisplayItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.advancedFilters, reportFilterParameters.advancedFilters) &&
        ...
        Objects.equals(this.channelId, reportFilterParameters.channelId) &&
        Objects.equals(this.endPeriodUtcDate, reportFilterParameters.endPeriodUtcDate) &&
        Objects.equals(this.performanceIndicatorFilters, reportFilterParameters.performanceIndicatorFilters) &&
        Objects.equals(this.periodType, reportFilterParameters.periodType) &&
        Objects.equals(this.analyticsProductColumnFilters, reportFilterParameters.analyticsProductColumnFilters) &&
        Objects.equals(this.productColumnsToDisplay, reportFilterParameters.productColumnsToDisplay) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advancedFilters, beginPeriodUtcDate, categoryFilter, channelId, endPeriodUtcDate, performanceIndicatorFilters, periodType, analyticsProductColumnFilters, productColumnsToDisplay, productState, reportType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReportFilterParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportFilterParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportFilterParameters is not found in the empty JSON string", ReportFilterParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportFilterParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportFilterParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReportFilterParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportFilterParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportFilterParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportFilterParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportFilterParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportFilterParameters>() {
           @Override
           public void write(JsonWriter out, ReportFilterParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportFilterParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReportFilterParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReportFilterParameters
   * @throws IOException if the JSON string is invalid with respect to ReportFilterParameters
   */
  public static ReportFilterParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportFilterParameters.class);
  }

  /**
   * Convert an instance of ReportFilterParameters to an JSON string
   *
   * @return JSON string
   */
