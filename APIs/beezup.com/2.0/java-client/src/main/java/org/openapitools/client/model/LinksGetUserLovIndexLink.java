...
public class LinksGetUserLovIndexLink {
  ...
  public LinksGetUserLovIndexLink() {
  }
  ...
  public LinksGetUserLovIndexLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetUserLovIndexLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetUserLovIndexLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetUserLovIndexLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetUserLovIndexLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetUserLovIndexLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetUserLovIndexLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetUserLovIndexLink is not found in the empty JSON string", LinksGetUserLovIndexLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetUserLovIndexLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetUserLovIndexLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetUserLovIndexLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetUserLovIndexLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetUserLovIndexLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetUserLovIndexLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetUserLovIndexLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetUserLovIndexLink>() {
           @Override
           public void write(JsonWriter out, LinksGetUserLovIndexLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetUserLovIndexLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetUserLovIndexLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetUserLovIndexLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetUserLovIndexLink
   */
  public static LinksGetUserLovIndexLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetUserLovIndexLink.class);
  }

  /**
   * Convert an instance of LinksGetUserLovIndexLink to an JSON string
   *
   * @return JSON string
   */
