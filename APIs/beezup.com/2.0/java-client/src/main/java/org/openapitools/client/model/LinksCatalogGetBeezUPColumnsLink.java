...
public class LinksCatalogGetBeezUPColumnsLink {
  ...
  public LinksCatalogGetBeezUPColumnsLink() {
  }

  public LinksCatalogGetBeezUPColumnsLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksCatalogGetBeezUPColumnsLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksCatalogGetBeezUPColumnsLink description(String description) {
  ...
  public LinksCatalogGetBeezUPColumnsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCatalogGetBeezUPColumnsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCatalogGetBeezUPColumnsLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksCatalogGetBeezUPColumnsLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksCatalogGetBeezUPColumnsLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksCatalogGetBeezUPColumnsLink operationId(String operationId) {
  ...
  public LinksCatalogGetBeezUPColumnsLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksCatalogGetBeezUPColumnsLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksCatalogGetBeezUPColumnsLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksCatalogGetBeezUPColumnsLink linksCatalogGetBeezUPColumnsLink = (LinksCatalogGetBeezUPColumnsLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksCatalogGetBeezUPColumnsLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksCatalogGetBeezUPColumnsLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksCatalogGetBeezUPColumnsLink.description) &&
        Objects.equals(this.docUrl, linksCatalogGetBeezUPColumnsLink.docUrl) &&
        Objects.equals(this.href, linksCatalogGetBeezUPColumnsLink.href) &&
        Objects.equals(this.info, linksCatalogGetBeezUPColumnsLink.info) &&
        Objects.equals(this.label, linksCatalogGetBeezUPColumnsLink.label) &&
        Objects.equals(this.method, linksCatalogGetBeezUPColumnsLink.method) &&
        Objects.equals(this.operationId, linksCatalogGetBeezUPColumnsLink.operationId) &&
        Objects.equals(this.parameters, linksCatalogGetBeezUPColumnsLink.parameters) &&
        Objects.equals(this.urlTemplated, linksCatalogGetBeezUPColumnsLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksCatalogGetBeezUPColumnsLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCatalogGetBeezUPColumnsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCatalogGetBeezUPColumnsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCatalogGetBeezUPColumnsLink is not found in the empty JSON string", LinksCatalogGetBeezUPColumnsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCatalogGetBeezUPColumnsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCatalogGetBeezUPColumnsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCatalogGetBeezUPColumnsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCatalogGetBeezUPColumnsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCatalogGetBeezUPColumnsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCatalogGetBeezUPColumnsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCatalogGetBeezUPColumnsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCatalogGetBeezUPColumnsLink>() {
           @Override
           public void write(JsonWriter out, LinksCatalogGetBeezUPColumnsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCatalogGetBeezUPColumnsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCatalogGetBeezUPColumnsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCatalogGetBeezUPColumnsLink
   * @throws IOException if the JSON string is invalid with respect to LinksCatalogGetBeezUPColumnsLink
   */
  public static LinksCatalogGetBeezUPColumnsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCatalogGetBeezUPColumnsLink.class);
  }

  /**
   * Convert an instance of LinksCatalogGetBeezUPColumnsLink to an JSON string
   *
   * @return JSON string
   */
