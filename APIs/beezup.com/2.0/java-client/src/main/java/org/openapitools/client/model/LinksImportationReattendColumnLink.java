...
public class LinksImportationReattendColumnLink {
  ...
  public LinksImportationReattendColumnLink() {
  }

  public LinksImportationReattendColumnLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationReattendColumnLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationReattendColumnLink description(String description) {
  ...
  public LinksImportationReattendColumnLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationReattendColumnLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationReattendColumnLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationReattendColumnLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationReattendColumnLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationReattendColumnLink operationId(String operationId) {
  ...
  public LinksImportationReattendColumnLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationReattendColumnLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationReattendColumnLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationReattendColumnLink linksImportationReattendColumnLink = (LinksImportationReattendColumnLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationReattendColumnLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationReattendColumnLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationReattendColumnLink.description) &&
        Objects.equals(this.docUrl, linksImportationReattendColumnLink.docUrl) &&
        Objects.equals(this.href, linksImportationReattendColumnLink.href) &&
        Objects.equals(this.info, linksImportationReattendColumnLink.info) &&
        Objects.equals(this.label, linksImportationReattendColumnLink.label) &&
        Objects.equals(this.method, linksImportationReattendColumnLink.method) &&
        Objects.equals(this.operationId, linksImportationReattendColumnLink.operationId) &&
        Objects.equals(this.parameters, linksImportationReattendColumnLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationReattendColumnLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationReattendColumnLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationReattendColumnLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationReattendColumnLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationReattendColumnLink is not found in the empty JSON string", LinksImportationReattendColumnLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationReattendColumnLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationReattendColumnLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationReattendColumnLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationReattendColumnLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationReattendColumnLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationReattendColumnLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationReattendColumnLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationReattendColumnLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationReattendColumnLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationReattendColumnLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationReattendColumnLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationReattendColumnLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationReattendColumnLink
   */
  public static LinksImportationReattendColumnLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationReattendColumnLink.class);
  }

  /**
   * Convert an instance of LinksImportationReattendColumnLink to an JSON string
   *
   * @return JSON string
   */
