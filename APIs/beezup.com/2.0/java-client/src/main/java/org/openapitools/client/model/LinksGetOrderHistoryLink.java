...
public class LinksGetOrderHistoryLink {
  ...
  public LinksGetOrderHistoryLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetOrderHistoryLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetOrderHistoryLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetOrderHistoryLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetOrderHistoryLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetOrderHistoryLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetOrderHistoryLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetOrderHistoryLink is not found in the empty JSON string", LinksGetOrderHistoryLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetOrderHistoryLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetOrderHistoryLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetOrderHistoryLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetOrderHistoryLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetOrderHistoryLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetOrderHistoryLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetOrderHistoryLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetOrderHistoryLink>() {
           @Override
           public void write(JsonWriter out, LinksGetOrderHistoryLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetOrderHistoryLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetOrderHistoryLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetOrderHistoryLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetOrderHistoryLink
   */
  public static LinksGetOrderHistoryLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetOrderHistoryLink.class);
  }

  /**
   * Convert an instance of LinksGetOrderHistoryLink to an JSON string
   *
   * @return JSON string
   */
