...
public class LinksHarvestAllLink {
  ...
  public LinksHarvestAllLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksHarvestAllLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksHarvestAllLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksHarvestAllLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksHarvestAllLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksHarvestAllLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksHarvestAllLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksHarvestAllLink is not found in the empty JSON string", LinksHarvestAllLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksHarvestAllLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksHarvestAllLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksHarvestAllLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksHarvestAllLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksHarvestAllLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksHarvestAllLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksHarvestAllLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksHarvestAllLink>() {
           @Override
           public void write(JsonWriter out, LinksHarvestAllLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksHarvestAllLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksHarvestAllLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksHarvestAllLink
   * @throws IOException if the JSON string is invalid with respect to LinksHarvestAllLink
   */
  public static LinksHarvestAllLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksHarvestAllLink.class);
  }

  /**
   * Convert an instance of LinksHarvestAllLink to an JSON string
   *
   * @return JSON string
   */
