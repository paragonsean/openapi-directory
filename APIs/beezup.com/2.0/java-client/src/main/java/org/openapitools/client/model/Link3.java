...
public class Link3 {
  ...
  public Link3 allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public Link3 allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public Link3 description(String description) {
  ...
  public Link3 docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public Link3 info(InfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public Link3 label(String label) {
    this.label = label;
    return this;
  }
  ...
  public Link3 method(HttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public Link3 operationId(String operationId) {
  ...
  public Link3 parameters(Map<String, LinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public Link3 putParametersItem(String key, LinkParameter3 parametersItem) {
  ...
  public Link3 urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    Link3 link3 = (Link3) o;
    return Objects.equals(this.allOptionalParamsProvided, link3.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, link3.allRequiredParamsProvided) &&
        Objects.equals(this.description, link3.description) &&
        Objects.equals(this.docUrl, link3.docUrl) &&
        Objects.equals(this.href, link3.href) &&
        Objects.equals(this.info, link3.info) &&
        Objects.equals(this.label, link3.label) &&
        Objects.equals(this.method, link3.method) &&
        Objects.equals(this.operationId, link3.operationId) &&
        Objects.equals(this.parameters, link3.parameters) &&
        Objects.equals(this.rel, link3.rel) &&
        Objects.equals(this.urlTemplated, link3.urlTemplated);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Link3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Link3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Link3 is not found in the empty JSON string", Link3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Link3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Link3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Link3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Link3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Link3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Link3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Link3.class));

       return (TypeAdapter<T>) new TypeAdapter<Link3>() {
           @Override
           public void write(JsonWriter out, Link3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Link3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Link3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Link3
   * @throws IOException if the JSON string is invalid with respect to Link3
   */
  public static Link3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Link3.class);
  }

  /**
   * Convert an instance of Link3 to an JSON string
   *
   * @return JSON string
   */
