...
public class LinksImportationSaveCustomColumnLink {
  ...
  public LinksImportationSaveCustomColumnLink() {
  }

  public LinksImportationSaveCustomColumnLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationSaveCustomColumnLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationSaveCustomColumnLink description(String description) {
  ...
  public LinksImportationSaveCustomColumnLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationSaveCustomColumnLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationSaveCustomColumnLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationSaveCustomColumnLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationSaveCustomColumnLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationSaveCustomColumnLink operationId(String operationId) {
  ...
  public LinksImportationSaveCustomColumnLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationSaveCustomColumnLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationSaveCustomColumnLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationSaveCustomColumnLink linksImportationSaveCustomColumnLink = (LinksImportationSaveCustomColumnLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationSaveCustomColumnLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationSaveCustomColumnLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationSaveCustomColumnLink.description) &&
        Objects.equals(this.docUrl, linksImportationSaveCustomColumnLink.docUrl) &&
        Objects.equals(this.href, linksImportationSaveCustomColumnLink.href) &&
        Objects.equals(this.info, linksImportationSaveCustomColumnLink.info) &&
        Objects.equals(this.label, linksImportationSaveCustomColumnLink.label) &&
        Objects.equals(this.method, linksImportationSaveCustomColumnLink.method) &&
        Objects.equals(this.operationId, linksImportationSaveCustomColumnLink.operationId) &&
        Objects.equals(this.parameters, linksImportationSaveCustomColumnLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationSaveCustomColumnLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationSaveCustomColumnLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationSaveCustomColumnLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationSaveCustomColumnLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationSaveCustomColumnLink is not found in the empty JSON string", LinksImportationSaveCustomColumnLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationSaveCustomColumnLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationSaveCustomColumnLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationSaveCustomColumnLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationSaveCustomColumnLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationSaveCustomColumnLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationSaveCustomColumnLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationSaveCustomColumnLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationSaveCustomColumnLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationSaveCustomColumnLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationSaveCustomColumnLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationSaveCustomColumnLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationSaveCustomColumnLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationSaveCustomColumnLink
   */
  public static LinksImportationSaveCustomColumnLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationSaveCustomColumnLink.class);
  }

  /**
   * Convert an instance of LinksImportationSaveCustomColumnLink to an JSON string
   *
   * @return JSON string
   */
