...
public class OrderedReportFilterCommonParameters {
  ...
  public OrderedReportFilterCommonParameters() {
  }

  public OrderedReportFilterCommonParameters advancedFilters(ReportAdvancedFilters advancedFilters) {
  ...
  public OrderedReportFilterCommonParameters beginPeriodUtcDate(OffsetDateTime beginPeriodUtcDate) {
  ...
  public OrderedReportFilterCommonParameters categoryFilter(BeezUPCommonCatalogCategoryFilter categoryFilter) {
  ...
  public OrderedReportFilterCommonParameters channelId(String channelId) {
  ...
  public OrderedReportFilterCommonParameters endPeriodUtcDate(OffsetDateTime endPeriodUtcDate) {
  ...
  public OrderedReportFilterCommonParameters performanceIndicatorFilters(List<PerformanceIndicatorFilter> performanceIndicatorFilters) {
    this.performanceIndicatorFilters = performanceIndicatorFilters;
    return this;
  }

  public OrderedReportFilterCommonParameters addPerformanceIndicatorFiltersItem(PerformanceIndicatorFilter performanceIndicatorFiltersItem) {
  ...
  public OrderedReportFilterCommonParameters periodType(ReportFilterPeriodType periodType) {
  ...
  public OrderedReportFilterCommonParameters orderBy(PerformanceIndicatorType orderBy) {
  ...
  public OrderedReportFilterCommonParameters orderByDirection(OrderByDirection orderByDirection) {
  ...
  public boolean equals(Object o) {
    ...
    OrderedReportFilterCommonParameters orderedReportFilterCommonParameters = (OrderedReportFilterCommonParameters) o;
    return Objects.equals(this.advancedFilters, orderedReportFilterCommonParameters.advancedFilters) &&
        Objects.equals(this.beginPeriodUtcDate, orderedReportFilterCommonParameters.beginPeriodUtcDate) &&
        Objects.equals(this.categoryFilter, orderedReportFilterCommonParameters.categoryFilter) &&
        Objects.equals(this.channelId, orderedReportFilterCommonParameters.channelId) &&
        Objects.equals(this.endPeriodUtcDate, orderedReportFilterCommonParameters.endPeriodUtcDate) &&
        Objects.equals(this.performanceIndicatorFilters, orderedReportFilterCommonParameters.performanceIndicatorFilters) &&
        Objects.equals(this.periodType, orderedReportFilterCommonParameters.periodType) &&
        Objects.equals(this.orderBy, orderedReportFilterCommonParameters.orderBy) &&
        Objects.equals(this.orderByDirection, orderedReportFilterCommonParameters.orderByDirection);
  }

  @Override
  public int hashCode() {
    return Objects.hash(advancedFilters, beginPeriodUtcDate, categoryFilter, channelId, endPeriodUtcDate, performanceIndicatorFilters, periodType, orderBy, orderByDirection);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderedReportFilterCommonParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderedReportFilterCommonParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderedReportFilterCommonParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderedReportFilterCommonParameters is not found in the empty JSON string", OrderedReportFilterCommonParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderedReportFilterCommonParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderedReportFilterCommonParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderedReportFilterCommonParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderedReportFilterCommonParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderedReportFilterCommonParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderedReportFilterCommonParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderedReportFilterCommonParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderedReportFilterCommonParameters>() {
           @Override
           public void write(JsonWriter out, OrderedReportFilterCommonParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderedReportFilterCommonParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderedReportFilterCommonParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderedReportFilterCommonParameters
   * @throws IOException if the JSON string is invalid with respect to OrderedReportFilterCommonParameters
   */
  public static OrderedReportFilterCommonParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderedReportFilterCommonParameters.class);
  }

  /**
   * Convert an instance of OrderedReportFilterCommonParameters to an JSON string
   *
   * @return JSON string
   */
