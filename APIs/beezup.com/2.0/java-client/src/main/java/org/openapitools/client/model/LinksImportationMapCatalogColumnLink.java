...
public class LinksImportationMapCatalogColumnLink {
  ...
  public LinksImportationMapCatalogColumnLink() {
  }

  public LinksImportationMapCatalogColumnLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationMapCatalogColumnLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationMapCatalogColumnLink description(String description) {
  ...
  public LinksImportationMapCatalogColumnLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationMapCatalogColumnLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationMapCatalogColumnLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationMapCatalogColumnLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationMapCatalogColumnLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationMapCatalogColumnLink operationId(String operationId) {
  ...
  public LinksImportationMapCatalogColumnLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationMapCatalogColumnLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationMapCatalogColumnLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationMapCatalogColumnLink linksImportationMapCatalogColumnLink = (LinksImportationMapCatalogColumnLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationMapCatalogColumnLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationMapCatalogColumnLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationMapCatalogColumnLink.description) &&
        Objects.equals(this.docUrl, linksImportationMapCatalogColumnLink.docUrl) &&
        Objects.equals(this.href, linksImportationMapCatalogColumnLink.href) &&
        Objects.equals(this.info, linksImportationMapCatalogColumnLink.info) &&
        Objects.equals(this.label, linksImportationMapCatalogColumnLink.label) &&
        Objects.equals(this.method, linksImportationMapCatalogColumnLink.method) &&
        Objects.equals(this.operationId, linksImportationMapCatalogColumnLink.operationId) &&
        Objects.equals(this.parameters, linksImportationMapCatalogColumnLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationMapCatalogColumnLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationMapCatalogColumnLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationMapCatalogColumnLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationMapCatalogColumnLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationMapCatalogColumnLink is not found in the empty JSON string", LinksImportationMapCatalogColumnLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationMapCatalogColumnLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationMapCatalogColumnLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationMapCatalogColumnLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationMapCatalogColumnLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationMapCatalogColumnLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationMapCatalogColumnLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationMapCatalogColumnLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationMapCatalogColumnLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationMapCatalogColumnLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationMapCatalogColumnLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationMapCatalogColumnLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationMapCatalogColumnLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationMapCatalogColumnLink
   */
  public static LinksImportationMapCatalogColumnLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationMapCatalogColumnLink.class);
  }

  /**
   * Convert an instance of LinksImportationMapCatalogColumnLink to an JSON string
   *
   * @return JSON string
   */
