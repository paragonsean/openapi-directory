...
public class LinksCatalogDeleteCustomColumnLink {
  ...
  public LinksCatalogDeleteCustomColumnLink() {
  }

  public LinksCatalogDeleteCustomColumnLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksCatalogDeleteCustomColumnLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksCatalogDeleteCustomColumnLink description(String description) {
  ...
  public LinksCatalogDeleteCustomColumnLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCatalogDeleteCustomColumnLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCatalogDeleteCustomColumnLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksCatalogDeleteCustomColumnLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksCatalogDeleteCustomColumnLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksCatalogDeleteCustomColumnLink operationId(String operationId) {
  ...
  public LinksCatalogDeleteCustomColumnLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksCatalogDeleteCustomColumnLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksCatalogDeleteCustomColumnLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksCatalogDeleteCustomColumnLink linksCatalogDeleteCustomColumnLink = (LinksCatalogDeleteCustomColumnLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksCatalogDeleteCustomColumnLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksCatalogDeleteCustomColumnLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksCatalogDeleteCustomColumnLink.description) &&
        Objects.equals(this.docUrl, linksCatalogDeleteCustomColumnLink.docUrl) &&
        Objects.equals(this.href, linksCatalogDeleteCustomColumnLink.href) &&
        Objects.equals(this.info, linksCatalogDeleteCustomColumnLink.info) &&
        Objects.equals(this.label, linksCatalogDeleteCustomColumnLink.label) &&
        Objects.equals(this.method, linksCatalogDeleteCustomColumnLink.method) &&
        Objects.equals(this.operationId, linksCatalogDeleteCustomColumnLink.operationId) &&
        Objects.equals(this.parameters, linksCatalogDeleteCustomColumnLink.parameters) &&
        Objects.equals(this.urlTemplated, linksCatalogDeleteCustomColumnLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksCatalogDeleteCustomColumnLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCatalogDeleteCustomColumnLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCatalogDeleteCustomColumnLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCatalogDeleteCustomColumnLink is not found in the empty JSON string", LinksCatalogDeleteCustomColumnLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCatalogDeleteCustomColumnLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCatalogDeleteCustomColumnLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCatalogDeleteCustomColumnLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCatalogDeleteCustomColumnLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCatalogDeleteCustomColumnLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCatalogDeleteCustomColumnLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCatalogDeleteCustomColumnLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCatalogDeleteCustomColumnLink>() {
           @Override
           public void write(JsonWriter out, LinksCatalogDeleteCustomColumnLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCatalogDeleteCustomColumnLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCatalogDeleteCustomColumnLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCatalogDeleteCustomColumnLink
   * @throws IOException if the JSON string is invalid with respect to LinksCatalogDeleteCustomColumnLink
   */
  public static LinksCatalogDeleteCustomColumnLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCatalogDeleteCustomColumnLink.class);
  }

  /**
   * Convert an instance of LinksCatalogDeleteCustomColumnLink to an JSON string
   *
   * @return JSON string
   */
