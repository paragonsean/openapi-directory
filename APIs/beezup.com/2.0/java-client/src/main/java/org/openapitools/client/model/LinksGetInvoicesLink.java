...
public class LinksGetInvoicesLink {
  ...
  public LinksGetInvoicesLink() {
  }

  public LinksGetInvoicesLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetInvoicesLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetInvoicesLink description(String description) {
  ...
  public LinksGetInvoicesLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetInvoicesLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetInvoicesLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetInvoicesLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetInvoicesLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetInvoicesLink operationId(String operationId) {
  ...
  public LinksGetInvoicesLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetInvoicesLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetInvoicesLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetInvoicesLink linksGetInvoicesLink = (LinksGetInvoicesLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetInvoicesLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetInvoicesLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetInvoicesLink.description) &&
        Objects.equals(this.docUrl, linksGetInvoicesLink.docUrl) &&
        Objects.equals(this.href, linksGetInvoicesLink.href) &&
        Objects.equals(this.info, linksGetInvoicesLink.info) &&
        Objects.equals(this.label, linksGetInvoicesLink.label) &&
        Objects.equals(this.method, linksGetInvoicesLink.method) &&
        Objects.equals(this.operationId, linksGetInvoicesLink.operationId) &&
        Objects.equals(this.parameters, linksGetInvoicesLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetInvoicesLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetInvoicesLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetInvoicesLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetInvoicesLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetInvoicesLink is not found in the empty JSON string", LinksGetInvoicesLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetInvoicesLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetInvoicesLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetInvoicesLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetInvoicesLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetInvoicesLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetInvoicesLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetInvoicesLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetInvoicesLink>() {
           @Override
           public void write(JsonWriter out, LinksGetInvoicesLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetInvoicesLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetInvoicesLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetInvoicesLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetInvoicesLink
   */
  public static LinksGetInvoicesLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetInvoicesLink.class);
  }

  /**
   * Convert an instance of LinksGetInvoicesLink to an JSON string
   *
   * @return JSON string
   */
