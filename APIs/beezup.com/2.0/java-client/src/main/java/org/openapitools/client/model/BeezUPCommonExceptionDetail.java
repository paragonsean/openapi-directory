...
public class BeezUPCommonExceptionDetail {
   ...
   * @throws IOException if the JSON Element is invalid with respect to BeezUPCommonExceptionDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BeezUPCommonExceptionDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BeezUPCommonExceptionDetail is not found in the empty JSON string", BeezUPCommonExceptionDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BeezUPCommonExceptionDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BeezUPCommonExceptionDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BeezUPCommonExceptionDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BeezUPCommonExceptionDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BeezUPCommonExceptionDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BeezUPCommonExceptionDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<BeezUPCommonExceptionDetail>() {
           @Override
           public void write(JsonWriter out, BeezUPCommonExceptionDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BeezUPCommonExceptionDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BeezUPCommonExceptionDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BeezUPCommonExceptionDetail
   * @throws IOException if the JSON string is invalid with respect to BeezUPCommonExceptionDetail
   */
  public static BeezUPCommonExceptionDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BeezUPCommonExceptionDetail.class);
  }

  /**
   * Convert an instance of BeezUPCommonExceptionDetail to an JSON string
   *
   * @return JSON string
   */
