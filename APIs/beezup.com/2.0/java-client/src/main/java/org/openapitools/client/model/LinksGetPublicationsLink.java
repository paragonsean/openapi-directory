...
public class LinksGetPublicationsLink {
  ...
  public LinksGetPublicationsLink() {
  }

  public LinksGetPublicationsLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetPublicationsLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetPublicationsLink description(String description) {
  ...
  public LinksGetPublicationsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetPublicationsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetPublicationsLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetPublicationsLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetPublicationsLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetPublicationsLink operationId(String operationId) {
  ...
  public LinksGetPublicationsLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetPublicationsLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetPublicationsLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetPublicationsLink linksGetPublicationsLink = (LinksGetPublicationsLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetPublicationsLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetPublicationsLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetPublicationsLink.description) &&
        Objects.equals(this.docUrl, linksGetPublicationsLink.docUrl) &&
        Objects.equals(this.href, linksGetPublicationsLink.href) &&
        Objects.equals(this.info, linksGetPublicationsLink.info) &&
        Objects.equals(this.label, linksGetPublicationsLink.label) &&
        Objects.equals(this.method, linksGetPublicationsLink.method) &&
        Objects.equals(this.operationId, linksGetPublicationsLink.operationId) &&
        Objects.equals(this.parameters, linksGetPublicationsLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetPublicationsLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetPublicationsLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetPublicationsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetPublicationsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetPublicationsLink is not found in the empty JSON string", LinksGetPublicationsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetPublicationsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetPublicationsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetPublicationsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetPublicationsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetPublicationsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetPublicationsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetPublicationsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetPublicationsLink>() {
           @Override
           public void write(JsonWriter out, LinksGetPublicationsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetPublicationsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetPublicationsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetPublicationsLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetPublicationsLink
   */
  public static LinksGetPublicationsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetPublicationsLink.class);
  }

  /**
   * Convert an instance of LinksGetPublicationsLink to an JSON string
   *
   * @return JSON string
   */
