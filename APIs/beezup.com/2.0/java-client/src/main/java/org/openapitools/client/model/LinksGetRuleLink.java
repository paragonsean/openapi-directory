...
public class LinksGetRuleLink {
  ...
  public LinksGetRuleLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetRuleLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetRuleLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetRuleLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetRuleLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetRuleLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetRuleLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetRuleLink is not found in the empty JSON string", LinksGetRuleLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetRuleLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetRuleLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetRuleLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetRuleLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetRuleLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetRuleLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetRuleLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetRuleLink>() {
           @Override
           public void write(JsonWriter out, LinksGetRuleLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetRuleLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetRuleLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetRuleLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetRuleLink
   */
  public static LinksGetRuleLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetRuleLink.class);
  }

  /**
   * Convert an instance of LinksGetRuleLink to an JSON string
   *
   * @return JSON string
   */
