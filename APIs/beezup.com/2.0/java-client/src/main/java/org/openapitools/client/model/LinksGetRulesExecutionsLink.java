...
public class LinksGetRulesExecutionsLink {
  ...
  public LinksGetRulesExecutionsLink() {
  }
  ...
  public LinksGetRulesExecutionsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetRulesExecutionsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetRulesExecutionsLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetRulesExecutionsLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetRulesExecutionsLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetRulesExecutionsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetRulesExecutionsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetRulesExecutionsLink is not found in the empty JSON string", LinksGetRulesExecutionsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetRulesExecutionsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetRulesExecutionsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetRulesExecutionsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetRulesExecutionsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetRulesExecutionsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetRulesExecutionsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetRulesExecutionsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetRulesExecutionsLink>() {
           @Override
           public void write(JsonWriter out, LinksGetRulesExecutionsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetRulesExecutionsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetRulesExecutionsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetRulesExecutionsLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetRulesExecutionsLink
   */
  public static LinksGetRulesExecutionsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetRulesExecutionsLink.class);
  }

  /**
   * Convert an instance of LinksGetRulesExecutionsLink to an JSON string
   *
   * @return JSON string
   */
