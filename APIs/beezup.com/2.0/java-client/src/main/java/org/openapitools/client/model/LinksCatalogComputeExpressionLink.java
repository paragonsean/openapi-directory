...
public class LinksCatalogComputeExpressionLink {
  ...
  public LinksCatalogComputeExpressionLink() {
  }

  public LinksCatalogComputeExpressionLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksCatalogComputeExpressionLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksCatalogComputeExpressionLink description(String description) {
  ...
  public LinksCatalogComputeExpressionLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCatalogComputeExpressionLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCatalogComputeExpressionLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksCatalogComputeExpressionLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksCatalogComputeExpressionLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksCatalogComputeExpressionLink operationId(String operationId) {
  ...
  public LinksCatalogComputeExpressionLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksCatalogComputeExpressionLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksCatalogComputeExpressionLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksCatalogComputeExpressionLink linksCatalogComputeExpressionLink = (LinksCatalogComputeExpressionLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksCatalogComputeExpressionLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksCatalogComputeExpressionLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksCatalogComputeExpressionLink.description) &&
        Objects.equals(this.docUrl, linksCatalogComputeExpressionLink.docUrl) &&
        Objects.equals(this.href, linksCatalogComputeExpressionLink.href) &&
        Objects.equals(this.info, linksCatalogComputeExpressionLink.info) &&
        Objects.equals(this.label, linksCatalogComputeExpressionLink.label) &&
        Objects.equals(this.method, linksCatalogComputeExpressionLink.method) &&
        Objects.equals(this.operationId, linksCatalogComputeExpressionLink.operationId) &&
        Objects.equals(this.parameters, linksCatalogComputeExpressionLink.parameters) &&
        Objects.equals(this.urlTemplated, linksCatalogComputeExpressionLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksCatalogComputeExpressionLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCatalogComputeExpressionLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCatalogComputeExpressionLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCatalogComputeExpressionLink is not found in the empty JSON string", LinksCatalogComputeExpressionLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCatalogComputeExpressionLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCatalogComputeExpressionLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCatalogComputeExpressionLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCatalogComputeExpressionLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCatalogComputeExpressionLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCatalogComputeExpressionLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCatalogComputeExpressionLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCatalogComputeExpressionLink>() {
           @Override
           public void write(JsonWriter out, LinksCatalogComputeExpressionLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCatalogComputeExpressionLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCatalogComputeExpressionLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCatalogComputeExpressionLink
   * @throws IOException if the JSON string is invalid with respect to LinksCatalogComputeExpressionLink
   */
  public static LinksCatalogComputeExpressionLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCatalogComputeExpressionLink.class);
  }

  /**
   * Convert an instance of LinksCatalogComputeExpressionLink to an JSON string
   *
   * @return JSON string
   */
