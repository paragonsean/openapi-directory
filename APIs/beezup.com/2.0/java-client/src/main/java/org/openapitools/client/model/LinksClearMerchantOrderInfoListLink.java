...
public class LinksClearMerchantOrderInfoListLink {
  ...
  public LinksClearMerchantOrderInfoListLink() {
  }
  ...
  public LinksClearMerchantOrderInfoListLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksClearMerchantOrderInfoListLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksClearMerchantOrderInfoListLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksClearMerchantOrderInfoListLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksClearMerchantOrderInfoListLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksClearMerchantOrderInfoListLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksClearMerchantOrderInfoListLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksClearMerchantOrderInfoListLink is not found in the empty JSON string", LinksClearMerchantOrderInfoListLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksClearMerchantOrderInfoListLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksClearMerchantOrderInfoListLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksClearMerchantOrderInfoListLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksClearMerchantOrderInfoListLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksClearMerchantOrderInfoListLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksClearMerchantOrderInfoListLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksClearMerchantOrderInfoListLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksClearMerchantOrderInfoListLink>() {
           @Override
           public void write(JsonWriter out, LinksClearMerchantOrderInfoListLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksClearMerchantOrderInfoListLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksClearMerchantOrderInfoListLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksClearMerchantOrderInfoListLink
   * @throws IOException if the JSON string is invalid with respect to LinksClearMerchantOrderInfoListLink
   */
  public static LinksClearMerchantOrderInfoListLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksClearMerchantOrderInfoListLink.class);
  }

  /**
   * Convert an instance of LinksClearMerchantOrderInfoListLink to an JSON string
   *
   * @return JSON string
   */
