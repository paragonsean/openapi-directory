...
public class ReportByCategoryRequest {
  ...
  public ReportByCategoryRequest() {
  }
  ...
  public ReportByCategoryRequest beginPeriodUtcDate(OffsetDateTime beginPeriodUtcDate) {
  ...
  public ReportByCategoryRequest categoryFilter(BeezUPCommonCatalogCategoryFilter categoryFilter) {
  ...
  public ReportByCategoryRequest channelId(String channelId) {
  ...
  public ReportByCategoryRequest endPeriodUtcDate(OffsetDateTime endPeriodUtcDate) {
  ...
  public ReportByCategoryRequest performanceIndicatorFilters(List<PerformanceIndicatorFilter> performanceIndicatorFilters) {
    this.performanceIndicatorFilters = performanceIndicatorFilters;
    return this;
  }

  public ReportByCategoryRequest addPerformanceIndicatorFiltersItem(PerformanceIndicatorFilter performanceIndicatorFiltersItem) {
  ...
  public ReportByCategoryRequest periodType(ReportFilterPeriodType periodType) {
  ...
  public ReportByCategoryRequest orderBy(PerformanceIndicatorType orderBy) {
  ...
  public ReportByCategoryRequest orderByDirection(OrderByDirection orderByDirection) {
  ...
  public ReportByCategoryRequest pageNumber(Integer pageNumber) {
  ...
  public ReportByCategoryRequest pageSize(Integer pageSize) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.advancedFilters, reportByCategoryRequest.advancedFilters) &&
        ...
        Objects.equals(this.channelId, reportByCategoryRequest.channelId) &&
        Objects.equals(this.endPeriodUtcDate, reportByCategoryRequest.endPeriodUtcDate) &&
        Objects.equals(this.performanceIndicatorFilters, reportByCategoryRequest.performanceIndicatorFilters) &&
        Objects.equals(this.periodType, reportByCategoryRequest.periodType) &&
        Objects.equals(this.orderBy, reportByCategoryRequest.orderBy) &&
        Objects.equals(this.orderByDirection, reportByCategoryRequest.orderByDirection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advancedFilters, beginPeriodUtcDate, categoryFilter, channelId, endPeriodUtcDate, performanceIndicatorFilters, periodType, orderBy, orderByDirection, pageNumber, pageSize);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReportByCategoryRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportByCategoryRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportByCategoryRequest is not found in the empty JSON string", ReportByCategoryRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportByCategoryRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportByCategoryRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReportByCategoryRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportByCategoryRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportByCategoryRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportByCategoryRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportByCategoryRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportByCategoryRequest>() {
           @Override
           public void write(JsonWriter out, ReportByCategoryRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportByCategoryRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReportByCategoryRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReportByCategoryRequest
   * @throws IOException if the JSON string is invalid with respect to ReportByCategoryRequest
   */
  public static ReportByCategoryRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportByCategoryRequest.class);
  }

  /**
   * Convert an instance of ReportByCategoryRequest to an JSON string
   *
   * @return JSON string
   */
