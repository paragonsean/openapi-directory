...
public class BeezUPCommonLink3 {
  ...
  public BeezUPCommonLink3 docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public BeezUPCommonLink3 href(String href) {
    this.href = href;
    return this;
  }
  ...
  public BeezUPCommonLink3 operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, beezUPCommonLink3.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, beezUPCommonLink3.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to BeezUPCommonLink3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BeezUPCommonLink3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BeezUPCommonLink3 is not found in the empty JSON string", BeezUPCommonLink3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BeezUPCommonLink3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BeezUPCommonLink3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BeezUPCommonLink3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BeezUPCommonLink3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BeezUPCommonLink3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BeezUPCommonLink3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BeezUPCommonLink3.class));

       return (TypeAdapter<T>) new TypeAdapter<BeezUPCommonLink3>() {
           @Override
           public void write(JsonWriter out, BeezUPCommonLink3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BeezUPCommonLink3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BeezUPCommonLink3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BeezUPCommonLink3
   * @throws IOException if the JSON string is invalid with respect to BeezUPCommonLink3
   */
  public static BeezUPCommonLink3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BeezUPCommonLink3.class);
  }

  /**
   * Convert an instance of BeezUPCommonLink3 to an JSON string
   *
   * @return JSON string
   */
