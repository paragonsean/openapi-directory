...
public class LinksDisableChannelCatalogLink {
  ...
  public LinksDisableChannelCatalogLink() {
  }

  public LinksDisableChannelCatalogLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksDisableChannelCatalogLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksDisableChannelCatalogLink description(String description) {
  ...
  public LinksDisableChannelCatalogLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksDisableChannelCatalogLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksDisableChannelCatalogLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksDisableChannelCatalogLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksDisableChannelCatalogLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksDisableChannelCatalogLink operationId(String operationId) {
  ...
  public LinksDisableChannelCatalogLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksDisableChannelCatalogLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksDisableChannelCatalogLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksDisableChannelCatalogLink linksDisableChannelCatalogLink = (LinksDisableChannelCatalogLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksDisableChannelCatalogLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksDisableChannelCatalogLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksDisableChannelCatalogLink.description) &&
        Objects.equals(this.docUrl, linksDisableChannelCatalogLink.docUrl) &&
        Objects.equals(this.href, linksDisableChannelCatalogLink.href) &&
        Objects.equals(this.info, linksDisableChannelCatalogLink.info) &&
        Objects.equals(this.label, linksDisableChannelCatalogLink.label) &&
        Objects.equals(this.method, linksDisableChannelCatalogLink.method) &&
        Objects.equals(this.operationId, linksDisableChannelCatalogLink.operationId) &&
        Objects.equals(this.parameters, linksDisableChannelCatalogLink.parameters) &&
        Objects.equals(this.urlTemplated, linksDisableChannelCatalogLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksDisableChannelCatalogLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksDisableChannelCatalogLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksDisableChannelCatalogLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksDisableChannelCatalogLink is not found in the empty JSON string", LinksDisableChannelCatalogLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksDisableChannelCatalogLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksDisableChannelCatalogLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksDisableChannelCatalogLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksDisableChannelCatalogLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksDisableChannelCatalogLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksDisableChannelCatalogLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksDisableChannelCatalogLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksDisableChannelCatalogLink>() {
           @Override
           public void write(JsonWriter out, LinksDisableChannelCatalogLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksDisableChannelCatalogLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksDisableChannelCatalogLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksDisableChannelCatalogLink
   * @throws IOException if the JSON string is invalid with respect to LinksDisableChannelCatalogLink
   */
  public static LinksDisableChannelCatalogLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksDisableChannelCatalogLink.class);
  }

  /**
   * Convert an instance of LinksDisableChannelCatalogLink to an JSON string
   *
   * @return JSON string
   */
