...
public class LinksGetStoreTrackedClicksLink {
  ...
  public LinksGetStoreTrackedClicksLink() {
  }

  public LinksGetStoreTrackedClicksLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetStoreTrackedClicksLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetStoreTrackedClicksLink description(String description) {
  ...
  public LinksGetStoreTrackedClicksLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetStoreTrackedClicksLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetStoreTrackedClicksLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetStoreTrackedClicksLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetStoreTrackedClicksLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetStoreTrackedClicksLink operationId(String operationId) {
  ...
  public LinksGetStoreTrackedClicksLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetStoreTrackedClicksLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetStoreTrackedClicksLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetStoreTrackedClicksLink linksGetStoreTrackedClicksLink = (LinksGetStoreTrackedClicksLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetStoreTrackedClicksLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetStoreTrackedClicksLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetStoreTrackedClicksLink.description) &&
        Objects.equals(this.docUrl, linksGetStoreTrackedClicksLink.docUrl) &&
        Objects.equals(this.href, linksGetStoreTrackedClicksLink.href) &&
        Objects.equals(this.info, linksGetStoreTrackedClicksLink.info) &&
        Objects.equals(this.label, linksGetStoreTrackedClicksLink.label) &&
        Objects.equals(this.method, linksGetStoreTrackedClicksLink.method) &&
        Objects.equals(this.operationId, linksGetStoreTrackedClicksLink.operationId) &&
        Objects.equals(this.parameters, linksGetStoreTrackedClicksLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetStoreTrackedClicksLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetStoreTrackedClicksLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetStoreTrackedClicksLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetStoreTrackedClicksLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetStoreTrackedClicksLink is not found in the empty JSON string", LinksGetStoreTrackedClicksLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetStoreTrackedClicksLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetStoreTrackedClicksLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetStoreTrackedClicksLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetStoreTrackedClicksLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetStoreTrackedClicksLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetStoreTrackedClicksLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetStoreTrackedClicksLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetStoreTrackedClicksLink>() {
           @Override
           public void write(JsonWriter out, LinksGetStoreTrackedClicksLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetStoreTrackedClicksLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetStoreTrackedClicksLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetStoreTrackedClicksLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetStoreTrackedClicksLink
   */
  public static LinksGetStoreTrackedClicksLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetStoreTrackedClicksLink.class);
  }

  /**
   * Convert an instance of LinksGetStoreTrackedClicksLink to an JSON string
   *
   * @return JSON string
   */
