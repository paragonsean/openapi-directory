...
public class LinksDeleteChannelCatalogLink {
  ...
  public LinksDeleteChannelCatalogLink() {
  }

  public LinksDeleteChannelCatalogLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksDeleteChannelCatalogLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksDeleteChannelCatalogLink description(String description) {
  ...
  public LinksDeleteChannelCatalogLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksDeleteChannelCatalogLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksDeleteChannelCatalogLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksDeleteChannelCatalogLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksDeleteChannelCatalogLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksDeleteChannelCatalogLink operationId(String operationId) {
  ...
  public LinksDeleteChannelCatalogLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksDeleteChannelCatalogLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksDeleteChannelCatalogLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksDeleteChannelCatalogLink linksDeleteChannelCatalogLink = (LinksDeleteChannelCatalogLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksDeleteChannelCatalogLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksDeleteChannelCatalogLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksDeleteChannelCatalogLink.description) &&
        Objects.equals(this.docUrl, linksDeleteChannelCatalogLink.docUrl) &&
        Objects.equals(this.href, linksDeleteChannelCatalogLink.href) &&
        Objects.equals(this.info, linksDeleteChannelCatalogLink.info) &&
        Objects.equals(this.label, linksDeleteChannelCatalogLink.label) &&
        Objects.equals(this.method, linksDeleteChannelCatalogLink.method) &&
        Objects.equals(this.operationId, linksDeleteChannelCatalogLink.operationId) &&
        Objects.equals(this.parameters, linksDeleteChannelCatalogLink.parameters) &&
        Objects.equals(this.urlTemplated, linksDeleteChannelCatalogLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksDeleteChannelCatalogLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksDeleteChannelCatalogLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksDeleteChannelCatalogLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksDeleteChannelCatalogLink is not found in the empty JSON string", LinksDeleteChannelCatalogLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksDeleteChannelCatalogLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksDeleteChannelCatalogLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksDeleteChannelCatalogLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksDeleteChannelCatalogLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksDeleteChannelCatalogLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksDeleteChannelCatalogLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksDeleteChannelCatalogLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksDeleteChannelCatalogLink>() {
           @Override
           public void write(JsonWriter out, LinksDeleteChannelCatalogLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksDeleteChannelCatalogLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksDeleteChannelCatalogLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksDeleteChannelCatalogLink
   * @throws IOException if the JSON string is invalid with respect to LinksDeleteChannelCatalogLink
   */
  public static LinksDeleteChannelCatalogLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksDeleteChannelCatalogLink.class);
  }

  /**
   * Convert an instance of LinksDeleteChannelCatalogLink to an JSON string
   *
   * @return JSON string
   */
