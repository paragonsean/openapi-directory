...
public class LinksImportationGetReportingsLink {
  ...
  public LinksImportationGetReportingsLink() {
  }

  public LinksImportationGetReportingsLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationGetReportingsLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationGetReportingsLink description(String description) {
  ...
  public LinksImportationGetReportingsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationGetReportingsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationGetReportingsLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationGetReportingsLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationGetReportingsLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationGetReportingsLink operationId(String operationId) {
  ...
  public LinksImportationGetReportingsLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationGetReportingsLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationGetReportingsLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationGetReportingsLink linksImportationGetReportingsLink = (LinksImportationGetReportingsLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationGetReportingsLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationGetReportingsLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationGetReportingsLink.description) &&
        Objects.equals(this.docUrl, linksImportationGetReportingsLink.docUrl) &&
        Objects.equals(this.href, linksImportationGetReportingsLink.href) &&
        Objects.equals(this.info, linksImportationGetReportingsLink.info) &&
        Objects.equals(this.label, linksImportationGetReportingsLink.label) &&
        Objects.equals(this.method, linksImportationGetReportingsLink.method) &&
        Objects.equals(this.operationId, linksImportationGetReportingsLink.operationId) &&
        Objects.equals(this.parameters, linksImportationGetReportingsLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationGetReportingsLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationGetReportingsLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationGetReportingsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationGetReportingsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationGetReportingsLink is not found in the empty JSON string", LinksImportationGetReportingsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationGetReportingsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationGetReportingsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationGetReportingsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationGetReportingsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationGetReportingsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationGetReportingsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationGetReportingsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationGetReportingsLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationGetReportingsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationGetReportingsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationGetReportingsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationGetReportingsLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationGetReportingsLink
   */
  public static LinksImportationGetReportingsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationGetReportingsLink.class);
  }

  /**
   * Convert an instance of LinksImportationGetReportingsLink to an JSON string
   *
   * @return JSON string
   */
