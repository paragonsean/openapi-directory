...
public class LinksGetOrderExportationsLink {
  ...
  public LinksGetOrderExportationsLink() {
  }
  ...
  public LinksGetOrderExportationsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetOrderExportationsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetOrderExportationsLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetOrderExportationsLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetOrderExportationsLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetOrderExportationsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetOrderExportationsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetOrderExportationsLink is not found in the empty JSON string", LinksGetOrderExportationsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetOrderExportationsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetOrderExportationsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetOrderExportationsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetOrderExportationsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetOrderExportationsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetOrderExportationsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetOrderExportationsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetOrderExportationsLink>() {
           @Override
           public void write(JsonWriter out, LinksGetOrderExportationsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetOrderExportationsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetOrderExportationsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetOrderExportationsLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetOrderExportationsLink
   */
  public static LinksGetOrderExportationsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetOrderExportationsLink.class);
  }

  /**
   * Convert an instance of LinksGetOrderExportationsLink to an JSON string
   *
   * @return JSON string
   */
