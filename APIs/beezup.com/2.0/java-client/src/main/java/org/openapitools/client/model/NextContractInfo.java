...
import org.openapitools.client.model.NextContractInfoLinks;
...
public class NextContractInfo {
  ...
  private NextContractInfoLinks links;

  public NextContractInfo() {
  }
  ...
  public NextContractInfo commitmentCalculatedFinishUtcDate(OffsetDateTime commitmentCalculatedFinishUtcDate) {
  ...
  public NextContractInfo contractId(String contractId) {
  ...
  public NextContractInfo currencyCode(String currencyCode) {
  ...
  public NextContractInfo discountEndUtcDate(OffsetDateTime discountEndUtcDate) {
  ...
  public NextContractInfo offerId(Integer offerId) {
  ...
  public NextContractInfo startUtcDate(OffsetDateTime startUtcDate) {
  ...
  public NextContractInfo storeCount(Integer storeCount) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.additionalClickPrice, nextContractInfo.additionalClickPrice) &&
        ...
        Objects.equals(this.trialPeriodInMonth, nextContractInfo.trialPeriodInMonth) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to NextContractInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NextContractInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NextContractInfo is not found in the empty JSON string", NextContractInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NextContractInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NextContractInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NextContractInfo.openapiRequiredFields) {
      ...
      NextContractInfoLinks.validateJsonElement(jsonObj.get("links"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NextContractInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NextContractInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NextContractInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NextContractInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<NextContractInfo>() {
           @Override
           public void write(JsonWriter out, NextContractInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NextContractInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NextContractInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NextContractInfo
   * @throws IOException if the JSON string is invalid with respect to NextContractInfo
   */
  public static NextContractInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NextContractInfo.class);
  }

  /**
   * Convert an instance of NextContractInfo to an JSON string
   *
   * @return JSON string
   */
