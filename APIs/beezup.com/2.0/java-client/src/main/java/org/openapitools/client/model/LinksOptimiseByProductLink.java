...
public class LinksOptimiseByProductLink {
  ...
  public LinksOptimiseByProductLink() {
  }
  ...
  public LinksOptimiseByProductLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksOptimiseByProductLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksOptimiseByProductLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksOptimiseByProductLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksOptimiseByProductLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksOptimiseByProductLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksOptimiseByProductLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksOptimiseByProductLink is not found in the empty JSON string", LinksOptimiseByProductLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksOptimiseByProductLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksOptimiseByProductLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksOptimiseByProductLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksOptimiseByProductLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksOptimiseByProductLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksOptimiseByProductLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksOptimiseByProductLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksOptimiseByProductLink>() {
           @Override
           public void write(JsonWriter out, LinksOptimiseByProductLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksOptimiseByProductLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksOptimiseByProductLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksOptimiseByProductLink
   * @throws IOException if the JSON string is invalid with respect to LinksOptimiseByProductLink
   */
  public static LinksOptimiseByProductLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksOptimiseByProductLink.class);
  }

  /**
   * Convert an instance of LinksOptimiseByProductLink to an JSON string
   *
   * @return JSON string
   */
