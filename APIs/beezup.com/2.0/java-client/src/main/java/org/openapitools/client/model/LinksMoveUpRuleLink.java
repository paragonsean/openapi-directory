...
public class LinksMoveUpRuleLink {
  ...
  public LinksMoveUpRuleLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksMoveUpRuleLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksMoveUpRuleLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksMoveUpRuleLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksMoveUpRuleLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksMoveUpRuleLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksMoveUpRuleLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksMoveUpRuleLink is not found in the empty JSON string", LinksMoveUpRuleLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksMoveUpRuleLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksMoveUpRuleLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksMoveUpRuleLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksMoveUpRuleLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksMoveUpRuleLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksMoveUpRuleLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksMoveUpRuleLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksMoveUpRuleLink>() {
           @Override
           public void write(JsonWriter out, LinksMoveUpRuleLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksMoveUpRuleLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksMoveUpRuleLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksMoveUpRuleLink
   * @throws IOException if the JSON string is invalid with respect to LinksMoveUpRuleLink
   */
  public static LinksMoveUpRuleLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksMoveUpRuleLink.class);
  }

  /**
   * Convert an instance of LinksMoveUpRuleLink to an JSON string
   *
   * @return JSON string
   */
