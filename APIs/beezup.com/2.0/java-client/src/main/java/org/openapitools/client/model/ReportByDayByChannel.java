...
public class ReportByDayByChannel {
  ...
  public ReportByDayByChannel roi(BigDecimal roi) {
    this.roi = roi;
    return this;
  }
  ...
  public ReportByDayByChannel soldProductCount(Integer soldProductCount) {
  ...
  public ReportByDayByChannel totalSales(BigDecimal totalSales) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clickCount, reportByDayByChannel.clickCount) &&
        ...
        Objects.equals(this.roi, reportByDayByChannel.roi) &&
        Objects.equals(this.soldProductCount, reportByDayByChannel.soldProductCount) &&
        Objects.equals(this.totalSales, reportByDayByChannel.totalSales) &&
        Objects.equals(this.channel, reportByDayByChannel.channel);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clickCount, cost, margin, orderCount, performanceIndicator, roi, soldProductCount, totalSales, channel);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReportByDayByChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportByDayByChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportByDayByChannel is not found in the empty JSON string", ReportByDayByChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportByDayByChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportByDayByChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReportByDayByChannel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportByDayByChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportByDayByChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportByDayByChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportByDayByChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportByDayByChannel>() {
           @Override
           public void write(JsonWriter out, ReportByDayByChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportByDayByChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReportByDayByChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReportByDayByChannel
   * @throws IOException if the JSON string is invalid with respect to ReportByDayByChannel
   */
  public static ReportByDayByChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportByDayByChannel.class);
  }

  /**
   * Convert an instance of ReportByDayByChannel to an JSON string
   *
   * @return JSON string
   */
