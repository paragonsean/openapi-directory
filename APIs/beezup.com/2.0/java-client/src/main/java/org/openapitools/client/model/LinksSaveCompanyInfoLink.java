...
public class LinksSaveCompanyInfoLink {
  ...
  public LinksSaveCompanyInfoLink() {
  }
  ...
  public LinksSaveCompanyInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksSaveCompanyInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksSaveCompanyInfoLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksSaveCompanyInfoLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksSaveCompanyInfoLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksSaveCompanyInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksSaveCompanyInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksSaveCompanyInfoLink is not found in the empty JSON string", LinksSaveCompanyInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksSaveCompanyInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksSaveCompanyInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksSaveCompanyInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksSaveCompanyInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksSaveCompanyInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksSaveCompanyInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksSaveCompanyInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksSaveCompanyInfoLink>() {
           @Override
           public void write(JsonWriter out, LinksSaveCompanyInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksSaveCompanyInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksSaveCompanyInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksSaveCompanyInfoLink
   * @throws IOException if the JSON string is invalid with respect to LinksSaveCompanyInfoLink
   */
  public static LinksSaveCompanyInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksSaveCompanyInfoLink.class);
  }

  /**
   * Convert an instance of LinksSaveCompanyInfoLink to an JSON string
   *
   * @return JSON string
   */
