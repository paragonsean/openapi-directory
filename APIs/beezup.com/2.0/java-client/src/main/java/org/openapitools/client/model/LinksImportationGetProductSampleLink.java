...
public class LinksImportationGetProductSampleLink {
  ...
  public LinksImportationGetProductSampleLink() {
  }

  public LinksImportationGetProductSampleLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationGetProductSampleLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationGetProductSampleLink description(String description) {
  ...
  public LinksImportationGetProductSampleLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationGetProductSampleLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationGetProductSampleLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationGetProductSampleLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationGetProductSampleLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationGetProductSampleLink operationId(String operationId) {
  ...
  public LinksImportationGetProductSampleLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationGetProductSampleLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationGetProductSampleLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationGetProductSampleLink linksImportationGetProductSampleLink = (LinksImportationGetProductSampleLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationGetProductSampleLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationGetProductSampleLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationGetProductSampleLink.description) &&
        Objects.equals(this.docUrl, linksImportationGetProductSampleLink.docUrl) &&
        Objects.equals(this.href, linksImportationGetProductSampleLink.href) &&
        Objects.equals(this.info, linksImportationGetProductSampleLink.info) &&
        Objects.equals(this.label, linksImportationGetProductSampleLink.label) &&
        Objects.equals(this.method, linksImportationGetProductSampleLink.method) &&
        Objects.equals(this.operationId, linksImportationGetProductSampleLink.operationId) &&
        Objects.equals(this.parameters, linksImportationGetProductSampleLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationGetProductSampleLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationGetProductSampleLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationGetProductSampleLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationGetProductSampleLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationGetProductSampleLink is not found in the empty JSON string", LinksImportationGetProductSampleLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationGetProductSampleLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationGetProductSampleLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationGetProductSampleLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationGetProductSampleLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationGetProductSampleLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationGetProductSampleLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationGetProductSampleLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationGetProductSampleLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationGetProductSampleLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationGetProductSampleLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationGetProductSampleLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationGetProductSampleLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationGetProductSampleLink
   */
  public static LinksImportationGetProductSampleLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationGetProductSampleLink.class);
  }

  /**
   * Convert an instance of LinksImportationGetProductSampleLink to an JSON string
   *
   * @return JSON string
   */
