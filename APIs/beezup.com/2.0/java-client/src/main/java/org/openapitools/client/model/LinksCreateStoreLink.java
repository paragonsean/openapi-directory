...
public class LinksCreateStoreLink {
  ...
  public LinksCreateStoreLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCreateStoreLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCreateStoreLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksCreateStoreLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksCreateStoreLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCreateStoreLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCreateStoreLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCreateStoreLink is not found in the empty JSON string", LinksCreateStoreLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCreateStoreLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCreateStoreLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCreateStoreLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCreateStoreLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCreateStoreLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCreateStoreLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCreateStoreLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCreateStoreLink>() {
           @Override
           public void write(JsonWriter out, LinksCreateStoreLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCreateStoreLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCreateStoreLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCreateStoreLink
   * @throws IOException if the JSON string is invalid with respect to LinksCreateStoreLink
   */
  public static LinksCreateStoreLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCreateStoreLink.class);
  }

  /**
   * Convert an instance of LinksCreateStoreLink to an JSON string
   *
   * @return JSON string
   */
