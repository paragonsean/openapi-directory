...
public class LinksImportationCommitLink {
  ...
  public LinksImportationCommitLink() {
  }

  public LinksImportationCommitLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationCommitLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationCommitLink description(String description) {
  ...
  public LinksImportationCommitLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationCommitLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationCommitLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationCommitLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationCommitLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationCommitLink operationId(String operationId) {
  ...
  public LinksImportationCommitLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationCommitLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationCommitLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationCommitLink linksImportationCommitLink = (LinksImportationCommitLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationCommitLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationCommitLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationCommitLink.description) &&
        Objects.equals(this.docUrl, linksImportationCommitLink.docUrl) &&
        Objects.equals(this.href, linksImportationCommitLink.href) &&
        Objects.equals(this.info, linksImportationCommitLink.info) &&
        Objects.equals(this.label, linksImportationCommitLink.label) &&
        Objects.equals(this.method, linksImportationCommitLink.method) &&
        Objects.equals(this.operationId, linksImportationCommitLink.operationId) &&
        Objects.equals(this.parameters, linksImportationCommitLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationCommitLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationCommitLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationCommitLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationCommitLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationCommitLink is not found in the empty JSON string", LinksImportationCommitLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationCommitLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationCommitLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationCommitLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationCommitLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationCommitLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationCommitLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationCommitLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationCommitLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationCommitLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationCommitLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationCommitLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationCommitLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationCommitLink
   */
  public static LinksImportationCommitLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationCommitLink.class);
  }

  /**
   * Convert an instance of LinksImportationCommitLink to an JSON string
   *
   * @return JSON string
   */
