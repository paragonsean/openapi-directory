...
public class LinksGetPublicLovIndexLink {
  ...
  public LinksGetPublicLovIndexLink() {
  }
  ...
  public LinksGetPublicLovIndexLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetPublicLovIndexLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetPublicLovIndexLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetPublicLovIndexLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetPublicLovIndexLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetPublicLovIndexLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetPublicLovIndexLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetPublicLovIndexLink is not found in the empty JSON string", LinksGetPublicLovIndexLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetPublicLovIndexLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetPublicLovIndexLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetPublicLovIndexLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetPublicLovIndexLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetPublicLovIndexLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetPublicLovIndexLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetPublicLovIndexLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetPublicLovIndexLink>() {
           @Override
           public void write(JsonWriter out, LinksGetPublicLovIndexLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetPublicLovIndexLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetPublicLovIndexLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetPublicLovIndexLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetPublicLovIndexLink
   */
  public static LinksGetPublicLovIndexLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetPublicLovIndexLink.class);
  }

  /**
   * Convert an instance of LinksGetPublicLovIndexLink to an JSON string
   *
   * @return JSON string
   */
