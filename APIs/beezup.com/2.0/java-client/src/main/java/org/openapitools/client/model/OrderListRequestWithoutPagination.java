...
public class OrderListRequestWithoutPagination {
  ...
  public OrderListRequestWithoutPagination() {
  }

  public OrderListRequestWithoutPagination accountIds(List<Integer> accountIds) {
    this.accountIds = accountIds;
    return this;
  }

  public OrderListRequestWithoutPagination addAccountIdsItem(Integer accountIdsItem) {
  ...
  public OrderListRequestWithoutPagination beezUPOrderStatuses(List<String> beezUPOrderStatuses) {
    this.beezUPOrderStatuses = beezUPOrderStatuses;
    return this;
  }

  public OrderListRequestWithoutPagination addBeezUPOrderStatusesItem(String beezUPOrderStatusesItem) {
  ...
  public OrderListRequestWithoutPagination beginPeriodUtcDate(OffsetDateTime beginPeriodUtcDate) {
  ...
  public OrderListRequestWithoutPagination dateSearchType(DateSearchType dateSearchType) {
  ...
  public OrderListRequestWithoutPagination endPeriodUtcDate(OffsetDateTime endPeriodUtcDate) {
  ...
  public OrderListRequestWithoutPagination invoiceAvailabilityType(String invoiceAvailabilityType) {
  ...
  public OrderListRequestWithoutPagination marketplaceBusinessCodes(List<String> marketplaceBusinessCodes) {
    this.marketplaceBusinessCodes = marketplaceBusinessCodes;
    return this;
  }

  public OrderListRequestWithoutPagination addMarketplaceBusinessCodesItem(String marketplaceBusinessCodesItem) {
  ...
  public OrderListRequestWithoutPagination marketplaceOrderIds(List<String> marketplaceOrderIds) {
    this.marketplaceOrderIds = marketplaceOrderIds;
    return this;
  }

  public OrderListRequestWithoutPagination addMarketplaceOrderIdsItem(String marketplaceOrderIdsItem) {
  ...
  public OrderListRequestWithoutPagination marketplaceTechnicalCodes(List<String> marketplaceTechnicalCodes) {
    this.marketplaceTechnicalCodes = marketplaceTechnicalCodes;
    return this;
  }

  public OrderListRequestWithoutPagination addMarketplaceTechnicalCodesItem(String marketplaceTechnicalCodesItem) {
  ...
  public OrderListRequestWithoutPagination orderMerchantInfoSynchronizationStatus(String orderMerchantInfoSynchronizationStatus) {
  ...
  public OrderListRequestWithoutPagination orderBuyerName(String orderBuyerName) {
  ...
  public OrderListRequestWithoutPagination orderMerchantOrderIds(List<String> orderMerchantOrderIds) {
    this.orderMerchantOrderIds = orderMerchantOrderIds;
    return this;
  }

  public OrderListRequestWithoutPagination addOrderMerchantOrderIdsItem(String orderMerchantOrderIdsItem) {
  ...
  public OrderListRequestWithoutPagination storeIds(List<String> storeIds) {
    this.storeIds = storeIds;
    return this;
  }

  public OrderListRequestWithoutPagination addStoreIdsItem(String storeIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    OrderListRequestWithoutPagination orderListRequestWithoutPagination = (OrderListRequestWithoutPagination) o;
    return Objects.equals(this.accountIds, orderListRequestWithoutPagination.accountIds) &&
        Objects.equals(this.beezUPOrderStatuses, orderListRequestWithoutPagination.beezUPOrderStatuses) &&
        Objects.equals(this.beginPeriodUtcDate, orderListRequestWithoutPagination.beginPeriodUtcDate) &&
        Objects.equals(this.dateSearchType, orderListRequestWithoutPagination.dateSearchType) &&
        Objects.equals(this.endPeriodUtcDate, orderListRequestWithoutPagination.endPeriodUtcDate) &&
        Objects.equals(this.invoiceAvailabilityType, orderListRequestWithoutPagination.invoiceAvailabilityType) &&
        Objects.equals(this.marketplaceBusinessCodes, orderListRequestWithoutPagination.marketplaceBusinessCodes) &&
        Objects.equals(this.marketplaceOrderIds, orderListRequestWithoutPagination.marketplaceOrderIds) &&
        Objects.equals(this.marketplaceTechnicalCodes, orderListRequestWithoutPagination.marketplaceTechnicalCodes) &&
        Objects.equals(this.orderMerchantInfoSynchronizationStatus, orderListRequestWithoutPagination.orderMerchantInfoSynchronizationStatus) &&
        Objects.equals(this.orderBuyerName, orderListRequestWithoutPagination.orderBuyerName) &&
        Objects.equals(this.orderMerchantOrderIds, orderListRequestWithoutPagination.orderMerchantOrderIds) &&
        Objects.equals(this.storeIds, orderListRequestWithoutPagination.storeIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountIds, beezUPOrderStatuses, beginPeriodUtcDate, dateSearchType, endPeriodUtcDate, invoiceAvailabilityType, marketplaceBusinessCodes, marketplaceOrderIds, marketplaceTechnicalCodes, orderMerchantInfoSynchronizationStatus, orderBuyerName, orderMerchantOrderIds, storeIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderListRequestWithoutPagination {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderListRequestWithoutPagination
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderListRequestWithoutPagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderListRequestWithoutPagination is not found in the empty JSON string", OrderListRequestWithoutPagination.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderListRequestWithoutPagination.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderListRequestWithoutPagination` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderListRequestWithoutPagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderListRequestWithoutPagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderListRequestWithoutPagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderListRequestWithoutPagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderListRequestWithoutPagination.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderListRequestWithoutPagination>() {
           @Override
           public void write(JsonWriter out, OrderListRequestWithoutPagination value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderListRequestWithoutPagination read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderListRequestWithoutPagination given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderListRequestWithoutPagination
   * @throws IOException if the JSON string is invalid with respect to OrderListRequestWithoutPagination
   */
  public static OrderListRequestWithoutPagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderListRequestWithoutPagination.class);
  }

  /**
   * Convert an instance of OrderListRequestWithoutPagination to an JSON string
   *
   * @return JSON string
   */
