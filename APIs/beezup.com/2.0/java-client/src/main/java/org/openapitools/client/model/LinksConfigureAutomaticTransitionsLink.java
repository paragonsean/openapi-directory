...
public class LinksConfigureAutomaticTransitionsLink {
  ...
  public LinksConfigureAutomaticTransitionsLink() {
  }
  ...
  public LinksConfigureAutomaticTransitionsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksConfigureAutomaticTransitionsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksConfigureAutomaticTransitionsLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksConfigureAutomaticTransitionsLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksConfigureAutomaticTransitionsLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksConfigureAutomaticTransitionsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksConfigureAutomaticTransitionsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksConfigureAutomaticTransitionsLink is not found in the empty JSON string", LinksConfigureAutomaticTransitionsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksConfigureAutomaticTransitionsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksConfigureAutomaticTransitionsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksConfigureAutomaticTransitionsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksConfigureAutomaticTransitionsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksConfigureAutomaticTransitionsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksConfigureAutomaticTransitionsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksConfigureAutomaticTransitionsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksConfigureAutomaticTransitionsLink>() {
           @Override
           public void write(JsonWriter out, LinksConfigureAutomaticTransitionsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksConfigureAutomaticTransitionsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksConfigureAutomaticTransitionsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksConfigureAutomaticTransitionsLink
   * @throws IOException if the JSON string is invalid with respect to LinksConfigureAutomaticTransitionsLink
   */
  public static LinksConfigureAutomaticTransitionsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksConfigureAutomaticTransitionsLink.class);
  }

  /**
   * Convert an instance of LinksConfigureAutomaticTransitionsLink to an JSON string
   *
   * @return JSON string
   */
