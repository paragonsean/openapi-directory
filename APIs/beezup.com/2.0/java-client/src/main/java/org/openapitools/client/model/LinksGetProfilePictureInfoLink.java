...
public class LinksGetProfilePictureInfoLink {
  ...
  public LinksGetProfilePictureInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetProfilePictureInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetProfilePictureInfoLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetProfilePictureInfoLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetProfilePictureInfoLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetProfilePictureInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetProfilePictureInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetProfilePictureInfoLink is not found in the empty JSON string", LinksGetProfilePictureInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetProfilePictureInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetProfilePictureInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetProfilePictureInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetProfilePictureInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetProfilePictureInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetProfilePictureInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetProfilePictureInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetProfilePictureInfoLink>() {
           @Override
           public void write(JsonWriter out, LinksGetProfilePictureInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetProfilePictureInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetProfilePictureInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetProfilePictureInfoLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetProfilePictureInfoLink
   */
  public static LinksGetProfilePictureInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetProfilePictureInfoLink.class);
  }

  /**
   * Convert an instance of LinksGetProfilePictureInfoLink to an JSON string
   *
   * @return JSON string
   */
