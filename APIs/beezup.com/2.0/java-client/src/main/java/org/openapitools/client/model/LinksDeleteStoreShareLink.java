...
public class LinksDeleteStoreShareLink {
  ...
  public LinksDeleteStoreShareLink() {
  }

  public LinksDeleteStoreShareLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksDeleteStoreShareLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksDeleteStoreShareLink description(String description) {
  ...
  public LinksDeleteStoreShareLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksDeleteStoreShareLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksDeleteStoreShareLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksDeleteStoreShareLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksDeleteStoreShareLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksDeleteStoreShareLink operationId(String operationId) {
  ...
  public LinksDeleteStoreShareLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksDeleteStoreShareLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksDeleteStoreShareLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksDeleteStoreShareLink linksDeleteStoreShareLink = (LinksDeleteStoreShareLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksDeleteStoreShareLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksDeleteStoreShareLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksDeleteStoreShareLink.description) &&
        Objects.equals(this.docUrl, linksDeleteStoreShareLink.docUrl) &&
        Objects.equals(this.href, linksDeleteStoreShareLink.href) &&
        Objects.equals(this.info, linksDeleteStoreShareLink.info) &&
        Objects.equals(this.label, linksDeleteStoreShareLink.label) &&
        Objects.equals(this.method, linksDeleteStoreShareLink.method) &&
        Objects.equals(this.operationId, linksDeleteStoreShareLink.operationId) &&
        Objects.equals(this.parameters, linksDeleteStoreShareLink.parameters) &&
        Objects.equals(this.urlTemplated, linksDeleteStoreShareLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksDeleteStoreShareLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksDeleteStoreShareLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksDeleteStoreShareLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksDeleteStoreShareLink is not found in the empty JSON string", LinksDeleteStoreShareLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksDeleteStoreShareLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksDeleteStoreShareLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksDeleteStoreShareLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksDeleteStoreShareLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksDeleteStoreShareLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksDeleteStoreShareLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksDeleteStoreShareLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksDeleteStoreShareLink>() {
           @Override
           public void write(JsonWriter out, LinksDeleteStoreShareLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksDeleteStoreShareLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksDeleteStoreShareLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksDeleteStoreShareLink
   * @throws IOException if the JSON string is invalid with respect to LinksDeleteStoreShareLink
   */
  public static LinksDeleteStoreShareLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksDeleteStoreShareLink.class);
  }

  /**
   * Convert an instance of LinksDeleteStoreShareLink to an JSON string
   *
   * @return JSON string
   */
