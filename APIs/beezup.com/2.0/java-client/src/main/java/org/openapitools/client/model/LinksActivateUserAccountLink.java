...
public class LinksActivateUserAccountLink {
  ...
  public LinksActivateUserAccountLink() {
  }

  public LinksActivateUserAccountLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksActivateUserAccountLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksActivateUserAccountLink description(String description) {
  ...
  public LinksActivateUserAccountLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksActivateUserAccountLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksActivateUserAccountLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksActivateUserAccountLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksActivateUserAccountLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksActivateUserAccountLink operationId(String operationId) {
  ...
  public LinksActivateUserAccountLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksActivateUserAccountLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksActivateUserAccountLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksActivateUserAccountLink linksActivateUserAccountLink = (LinksActivateUserAccountLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksActivateUserAccountLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksActivateUserAccountLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksActivateUserAccountLink.description) &&
        Objects.equals(this.docUrl, linksActivateUserAccountLink.docUrl) &&
        Objects.equals(this.href, linksActivateUserAccountLink.href) &&
        Objects.equals(this.info, linksActivateUserAccountLink.info) &&
        Objects.equals(this.label, linksActivateUserAccountLink.label) &&
        Objects.equals(this.method, linksActivateUserAccountLink.method) &&
        Objects.equals(this.operationId, linksActivateUserAccountLink.operationId) &&
        Objects.equals(this.parameters, linksActivateUserAccountLink.parameters) &&
        Objects.equals(this.urlTemplated, linksActivateUserAccountLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksActivateUserAccountLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksActivateUserAccountLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksActivateUserAccountLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksActivateUserAccountLink is not found in the empty JSON string", LinksActivateUserAccountLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksActivateUserAccountLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksActivateUserAccountLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksActivateUserAccountLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksActivateUserAccountLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksActivateUserAccountLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksActivateUserAccountLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksActivateUserAccountLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksActivateUserAccountLink>() {
           @Override
           public void write(JsonWriter out, LinksActivateUserAccountLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksActivateUserAccountLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksActivateUserAccountLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksActivateUserAccountLink
   * @throws IOException if the JSON string is invalid with respect to LinksActivateUserAccountLink
   */
  public static LinksActivateUserAccountLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksActivateUserAccountLink.class);
  }

  /**
   * Convert an instance of LinksActivateUserAccountLink to an JSON string
   *
   * @return JSON string
   */
