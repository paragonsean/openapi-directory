...
public class LinksCatalogGetCategoriesLink {
  ...
  public LinksCatalogGetCategoriesLink() {
  }

  public LinksCatalogGetCategoriesLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksCatalogGetCategoriesLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksCatalogGetCategoriesLink description(String description) {
  ...
  public LinksCatalogGetCategoriesLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCatalogGetCategoriesLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCatalogGetCategoriesLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksCatalogGetCategoriesLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksCatalogGetCategoriesLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksCatalogGetCategoriesLink operationId(String operationId) {
  ...
  public LinksCatalogGetCategoriesLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksCatalogGetCategoriesLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksCatalogGetCategoriesLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksCatalogGetCategoriesLink linksCatalogGetCategoriesLink = (LinksCatalogGetCategoriesLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksCatalogGetCategoriesLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksCatalogGetCategoriesLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksCatalogGetCategoriesLink.description) &&
        Objects.equals(this.docUrl, linksCatalogGetCategoriesLink.docUrl) &&
        Objects.equals(this.href, linksCatalogGetCategoriesLink.href) &&
        Objects.equals(this.info, linksCatalogGetCategoriesLink.info) &&
        Objects.equals(this.label, linksCatalogGetCategoriesLink.label) &&
        Objects.equals(this.method, linksCatalogGetCategoriesLink.method) &&
        Objects.equals(this.operationId, linksCatalogGetCategoriesLink.operationId) &&
        Objects.equals(this.parameters, linksCatalogGetCategoriesLink.parameters) &&
        Objects.equals(this.urlTemplated, linksCatalogGetCategoriesLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksCatalogGetCategoriesLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCatalogGetCategoriesLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCatalogGetCategoriesLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCatalogGetCategoriesLink is not found in the empty JSON string", LinksCatalogGetCategoriesLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCatalogGetCategoriesLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCatalogGetCategoriesLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCatalogGetCategoriesLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCatalogGetCategoriesLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCatalogGetCategoriesLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCatalogGetCategoriesLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCatalogGetCategoriesLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCatalogGetCategoriesLink>() {
           @Override
           public void write(JsonWriter out, LinksCatalogGetCategoriesLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCatalogGetCategoriesLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCatalogGetCategoriesLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCatalogGetCategoriesLink
   * @throws IOException if the JSON string is invalid with respect to LinksCatalogGetCategoriesLink
   */
  public static LinksCatalogGetCategoriesLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCatalogGetCategoriesLink.class);
  }

  /**
   * Convert an instance of LinksCatalogGetCategoriesLink to an JSON string
   *
   * @return JSON string
   */
