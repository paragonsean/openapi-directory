...
public class LinksHarvestOrderLink {
  ...
  public LinksHarvestOrderLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksHarvestOrderLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksHarvestOrderLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksHarvestOrderLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksHarvestOrderLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksHarvestOrderLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksHarvestOrderLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksHarvestOrderLink is not found in the empty JSON string", LinksHarvestOrderLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksHarvestOrderLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksHarvestOrderLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksHarvestOrderLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksHarvestOrderLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksHarvestOrderLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksHarvestOrderLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksHarvestOrderLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksHarvestOrderLink>() {
           @Override
           public void write(JsonWriter out, LinksHarvestOrderLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksHarvestOrderLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksHarvestOrderLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksHarvestOrderLink
   * @throws IOException if the JSON string is invalid with respect to LinksHarvestOrderLink
   */
  public static LinksHarvestOrderLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksHarvestOrderLink.class);
  }

  /**
   * Convert an instance of LinksHarvestOrderLink to an JSON string
   *
   * @return JSON string
   */
