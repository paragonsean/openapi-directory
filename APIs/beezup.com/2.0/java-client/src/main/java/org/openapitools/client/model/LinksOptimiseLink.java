...
public class LinksOptimiseLink {
  ...
  public LinksOptimiseLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksOptimiseLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksOptimiseLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksOptimiseLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksOptimiseLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksOptimiseLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksOptimiseLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksOptimiseLink is not found in the empty JSON string", LinksOptimiseLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksOptimiseLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksOptimiseLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksOptimiseLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksOptimiseLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksOptimiseLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksOptimiseLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksOptimiseLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksOptimiseLink>() {
           @Override
           public void write(JsonWriter out, LinksOptimiseLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksOptimiseLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksOptimiseLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksOptimiseLink
   * @throws IOException if the JSON string is invalid with respect to LinksOptimiseLink
   */
  public static LinksOptimiseLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksOptimiseLink.class);
  }

  /**
   * Convert an instance of LinksOptimiseLink to an JSON string
   *
   * @return JSON string
   */
