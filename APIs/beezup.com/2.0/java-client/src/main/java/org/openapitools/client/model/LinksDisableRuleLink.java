...
public class LinksDisableRuleLink {
  ...
  public LinksDisableRuleLink() {
  }

  public LinksDisableRuleLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksDisableRuleLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksDisableRuleLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksDisableRuleLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksDisableRuleLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksDisableRuleLink operationId(String operationId) {
  ...
  public LinksDisableRuleLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksDisableRuleLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksDisableRuleLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksDisableRuleLink.description) &&
        Objects.equals(this.docUrl, linksDisableRuleLink.docUrl) &&
        Objects.equals(this.href, linksDisableRuleLink.href) &&
        Objects.equals(this.info, linksDisableRuleLink.info) &&
        Objects.equals(this.label, linksDisableRuleLink.label) &&
        ...
        Objects.equals(this.urlTemplated, linksDisableRuleLink.urlTemplated);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksDisableRuleLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksDisableRuleLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksDisableRuleLink is not found in the empty JSON string", LinksDisableRuleLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksDisableRuleLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksDisableRuleLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksDisableRuleLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksDisableRuleLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksDisableRuleLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksDisableRuleLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksDisableRuleLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksDisableRuleLink>() {
           @Override
           public void write(JsonWriter out, LinksDisableRuleLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksDisableRuleLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksDisableRuleLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksDisableRuleLink
   * @throws IOException if the JSON string is invalid with respect to LinksDisableRuleLink
   */
  public static LinksDisableRuleLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksDisableRuleLink.class);
  }

  /**
   * Convert an instance of LinksDisableRuleLink to an JSON string
   *
   * @return JSON string
   */
