...
public class AccountSynchronization {
  ...
  public static final String SERIALIZED_NAME_COMPLETED_HARVEST_SYNCHRO_UTC_DATE = "completedHarvestSynchroUtcDate";
  @SerializedName(SERIALIZED_NAME_COMPLETED_HARVEST_SYNCHRO_UTC_DATE)
  private OffsetDateTime completedHarvestSynchroUtcDate;
  ...
  public AccountSynchronization() {
  }

  public AccountSynchronization accountId(Integer accountId) {
  ...
  public AccountSynchronization completedHarvestSynchroUtcDate(OffsetDateTime completedHarvestSynchroUtcDate) {
  ...
  public OffsetDateTime getCompletedHarvestSynchroUtcDate() {
    return completedHarvestSynchroUtcDate;
  }

  public void setCompletedHarvestSynchroUtcDate(OffsetDateTime completedHarvestSynchroUtcDate) {
    this.completedHarvestSynchroUtcDate = completedHarvestSynchroUtcDate;
  }


  public AccountSynchronization marketplaceBusinessCode(String marketplaceBusinessCode) {
  ...
  public AccountSynchronization marketplaceTechnicalCode(String marketplaceTechnicalCode) {
  ...
  static {
    ...
    openapiFields.add("completedHarvestSynchroUtcDate");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountSynchronization
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountSynchronization.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountSynchronization is not found in the empty JSON string", AccountSynchronization.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountSynchronization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountSynchronization` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountSynchronization.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountSynchronization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountSynchronization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountSynchronization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountSynchronization.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountSynchronization>() {
           @Override
           public void write(JsonWriter out, AccountSynchronization value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountSynchronization read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountSynchronization given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountSynchronization
   * @throws IOException if the JSON string is invalid with respect to AccountSynchronization
   */
  public static AccountSynchronization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountSynchronization.class);
  }

  /**
   * Convert an instance of AccountSynchronization to an JSON string
   *
   * @return JSON string
   */
