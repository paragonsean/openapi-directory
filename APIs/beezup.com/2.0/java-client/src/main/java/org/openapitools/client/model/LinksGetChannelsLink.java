...
public class LinksGetChannelsLink {
  ...
  public LinksGetChannelsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetChannelsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetChannelsLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetChannelsLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetChannelsLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetChannelsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetChannelsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetChannelsLink is not found in the empty JSON string", LinksGetChannelsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetChannelsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetChannelsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetChannelsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetChannelsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetChannelsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetChannelsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetChannelsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetChannelsLink>() {
           @Override
           public void write(JsonWriter out, LinksGetChannelsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetChannelsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetChannelsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetChannelsLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetChannelsLink
   */
  public static LinksGetChannelsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetChannelsLink.class);
  }

  /**
   * Convert an instance of LinksGetChannelsLink to an JSON string
   *
   * @return JSON string
   */
