...
public class LinksSaveProfilePictureInfoLink {
  ...
  public LinksSaveProfilePictureInfoLink() {
  }

  public LinksSaveProfilePictureInfoLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksSaveProfilePictureInfoLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksSaveProfilePictureInfoLink description(String description) {
  ...
  public LinksSaveProfilePictureInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksSaveProfilePictureInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksSaveProfilePictureInfoLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksSaveProfilePictureInfoLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksSaveProfilePictureInfoLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksSaveProfilePictureInfoLink operationId(String operationId) {
  ...
  public LinksSaveProfilePictureInfoLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksSaveProfilePictureInfoLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksSaveProfilePictureInfoLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksSaveProfilePictureInfoLink linksSaveProfilePictureInfoLink = (LinksSaveProfilePictureInfoLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksSaveProfilePictureInfoLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksSaveProfilePictureInfoLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksSaveProfilePictureInfoLink.description) &&
        Objects.equals(this.docUrl, linksSaveProfilePictureInfoLink.docUrl) &&
        Objects.equals(this.href, linksSaveProfilePictureInfoLink.href) &&
        Objects.equals(this.info, linksSaveProfilePictureInfoLink.info) &&
        Objects.equals(this.label, linksSaveProfilePictureInfoLink.label) &&
        Objects.equals(this.method, linksSaveProfilePictureInfoLink.method) &&
        Objects.equals(this.operationId, linksSaveProfilePictureInfoLink.operationId) &&
        Objects.equals(this.parameters, linksSaveProfilePictureInfoLink.parameters) &&
        Objects.equals(this.urlTemplated, linksSaveProfilePictureInfoLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksSaveProfilePictureInfoLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksSaveProfilePictureInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksSaveProfilePictureInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksSaveProfilePictureInfoLink is not found in the empty JSON string", LinksSaveProfilePictureInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksSaveProfilePictureInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksSaveProfilePictureInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksSaveProfilePictureInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksSaveProfilePictureInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksSaveProfilePictureInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksSaveProfilePictureInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksSaveProfilePictureInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksSaveProfilePictureInfoLink>() {
           @Override
           public void write(JsonWriter out, LinksSaveProfilePictureInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksSaveProfilePictureInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksSaveProfilePictureInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksSaveProfilePictureInfoLink
   * @throws IOException if the JSON string is invalid with respect to LinksSaveProfilePictureInfoLink
   */
  public static LinksSaveProfilePictureInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksSaveProfilePictureInfoLink.class);
  }

  /**
   * Convert an instance of LinksSaveProfilePictureInfoLink to an JSON string
   *
   * @return JSON string
   */
