...
public class LinksUpdateRuleLink {
  ...
  public LinksUpdateRuleLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksUpdateRuleLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksUpdateRuleLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksUpdateRuleLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksUpdateRuleLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksUpdateRuleLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksUpdateRuleLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksUpdateRuleLink is not found in the empty JSON string", LinksUpdateRuleLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksUpdateRuleLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksUpdateRuleLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksUpdateRuleLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksUpdateRuleLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksUpdateRuleLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksUpdateRuleLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksUpdateRuleLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksUpdateRuleLink>() {
           @Override
           public void write(JsonWriter out, LinksUpdateRuleLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksUpdateRuleLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksUpdateRuleLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksUpdateRuleLink
   * @throws IOException if the JSON string is invalid with respect to LinksUpdateRuleLink
   */
  public static LinksUpdateRuleLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksUpdateRuleLink.class);
  }

  /**
   * Convert an instance of LinksUpdateRuleLink to an JSON string
   *
   * @return JSON string
   */
