...
public class LinksAutoStartAutoImportLink {
  ...
  public LinksAutoStartAutoImportLink() {
  }

  public LinksAutoStartAutoImportLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksAutoStartAutoImportLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksAutoStartAutoImportLink description(String description) {
  ...
  public LinksAutoStartAutoImportLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksAutoStartAutoImportLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksAutoStartAutoImportLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksAutoStartAutoImportLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksAutoStartAutoImportLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksAutoStartAutoImportLink operationId(String operationId) {
  ...
  public LinksAutoStartAutoImportLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksAutoStartAutoImportLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksAutoStartAutoImportLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksAutoStartAutoImportLink linksAutoStartAutoImportLink = (LinksAutoStartAutoImportLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksAutoStartAutoImportLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksAutoStartAutoImportLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksAutoStartAutoImportLink.description) &&
        Objects.equals(this.docUrl, linksAutoStartAutoImportLink.docUrl) &&
        Objects.equals(this.href, linksAutoStartAutoImportLink.href) &&
        Objects.equals(this.info, linksAutoStartAutoImportLink.info) &&
        Objects.equals(this.label, linksAutoStartAutoImportLink.label) &&
        Objects.equals(this.method, linksAutoStartAutoImportLink.method) &&
        Objects.equals(this.operationId, linksAutoStartAutoImportLink.operationId) &&
        Objects.equals(this.parameters, linksAutoStartAutoImportLink.parameters) &&
        Objects.equals(this.urlTemplated, linksAutoStartAutoImportLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksAutoStartAutoImportLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksAutoStartAutoImportLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksAutoStartAutoImportLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksAutoStartAutoImportLink is not found in the empty JSON string", LinksAutoStartAutoImportLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksAutoStartAutoImportLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksAutoStartAutoImportLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksAutoStartAutoImportLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksAutoStartAutoImportLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksAutoStartAutoImportLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksAutoStartAutoImportLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksAutoStartAutoImportLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksAutoStartAutoImportLink>() {
           @Override
           public void write(JsonWriter out, LinksAutoStartAutoImportLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksAutoStartAutoImportLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksAutoStartAutoImportLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksAutoStartAutoImportLink
   * @throws IOException if the JSON string is invalid with respect to LinksAutoStartAutoImportLink
   */
  public static LinksAutoStartAutoImportLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksAutoStartAutoImportLink.class);
  }

  /**
   * Convert an instance of LinksAutoStartAutoImportLink to an JSON string
   *
   * @return JSON string
   */
