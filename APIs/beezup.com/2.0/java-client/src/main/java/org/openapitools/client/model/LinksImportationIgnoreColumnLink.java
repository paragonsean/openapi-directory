...
public class LinksImportationIgnoreColumnLink {
  ...
  public LinksImportationIgnoreColumnLink() {
  }

  public LinksImportationIgnoreColumnLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationIgnoreColumnLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationIgnoreColumnLink description(String description) {
  ...
  public LinksImportationIgnoreColumnLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationIgnoreColumnLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationIgnoreColumnLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationIgnoreColumnLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationIgnoreColumnLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationIgnoreColumnLink operationId(String operationId) {
  ...
  public LinksImportationIgnoreColumnLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationIgnoreColumnLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationIgnoreColumnLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationIgnoreColumnLink linksImportationIgnoreColumnLink = (LinksImportationIgnoreColumnLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationIgnoreColumnLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationIgnoreColumnLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationIgnoreColumnLink.description) &&
        Objects.equals(this.docUrl, linksImportationIgnoreColumnLink.docUrl) &&
        Objects.equals(this.href, linksImportationIgnoreColumnLink.href) &&
        Objects.equals(this.info, linksImportationIgnoreColumnLink.info) &&
        Objects.equals(this.label, linksImportationIgnoreColumnLink.label) &&
        Objects.equals(this.method, linksImportationIgnoreColumnLink.method) &&
        Objects.equals(this.operationId, linksImportationIgnoreColumnLink.operationId) &&
        Objects.equals(this.parameters, linksImportationIgnoreColumnLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationIgnoreColumnLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationIgnoreColumnLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationIgnoreColumnLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationIgnoreColumnLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationIgnoreColumnLink is not found in the empty JSON string", LinksImportationIgnoreColumnLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationIgnoreColumnLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationIgnoreColumnLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationIgnoreColumnLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationIgnoreColumnLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationIgnoreColumnLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationIgnoreColumnLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationIgnoreColumnLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationIgnoreColumnLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationIgnoreColumnLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationIgnoreColumnLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationIgnoreColumnLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationIgnoreColumnLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationIgnoreColumnLink
   */
  public static LinksImportationIgnoreColumnLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationIgnoreColumnLink.class);
  }

  /**
   * Convert an instance of LinksImportationIgnoreColumnLink to an JSON string
   *
   * @return JSON string
   */
