...
public class OptimiseRequest {
  ...
  public OptimiseRequest beginPeriodUtcDate(OffsetDateTime beginPeriodUtcDate) {
  ...
  public OptimiseRequest categoryFilter(BeezUPCommonCatalogCategoryFilter categoryFilter) {
  ...
  public OptimiseRequest channelId(String channelId) {
  ...
  public OptimiseRequest endPeriodUtcDate(OffsetDateTime endPeriodUtcDate) {
  ...
  public OptimiseRequest performanceIndicatorFilters(List<PerformanceIndicatorFilter> performanceIndicatorFilters) {
    this.performanceIndicatorFilters = performanceIndicatorFilters;
    return this;
  }

  public OptimiseRequest addPerformanceIndicatorFiltersItem(PerformanceIndicatorFilter performanceIndicatorFiltersItem) {
  ...
  public OptimiseRequest periodType(ReportFilterPeriodType periodType) {
  ...
  public OptimiseRequest orderBy(PerformanceIndicatorType orderBy) {
  ...
  public OptimiseRequest orderByDirection(OrderByDirection orderByDirection) {
  ...
  public OptimiseRequest analyticsProductColumnFilters(AnalyticsProductColumnFilters analyticsProductColumnFilters) {
  ...
  public OptimiseRequest productColumnsToDisplay(List<String> productColumnsToDisplay) {
    this.productColumnsToDisplay = productColumnsToDisplay;
    return this;
  }

  public OptimiseRequest addProductColumnsToDisplayItem(String productColumnsToDisplayItem) {
  ...
  public OptimiseRequest reportType(ReportType reportType) {
  ...
  public OptimiseRequest pageNumber(Integer pageNumber) {
  ...
  public OptimiseRequest pageSize(Integer pageSize) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.advancedFilters, optimiseRequest.advancedFilters) &&
        ...
        Objects.equals(this.channelId, optimiseRequest.channelId) &&
        Objects.equals(this.endPeriodUtcDate, optimiseRequest.endPeriodUtcDate) &&
        Objects.equals(this.performanceIndicatorFilters, optimiseRequest.performanceIndicatorFilters) &&
        Objects.equals(this.periodType, optimiseRequest.periodType) &&
        Objects.equals(this.orderBy, optimiseRequest.orderBy) &&
        Objects.equals(this.orderByDirection, optimiseRequest.orderByDirection) &&
        Objects.equals(this.analyticsProductColumnFilters, optimiseRequest.analyticsProductColumnFilters) &&
        Objects.equals(this.productColumnsToDisplay, optimiseRequest.productColumnsToDisplay) &&
        Objects.equals(this.productState, optimiseRequest.productState) &&
        Objects.equals(this.reportType, optimiseRequest.reportType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advancedFilters, beginPeriodUtcDate, categoryFilter, channelId, endPeriodUtcDate, performanceIndicatorFilters, periodType, orderBy, orderByDirection, analyticsProductColumnFilters, productColumnsToDisplay, productState, reportType, pageNumber, pageSize);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OptimiseRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OptimiseRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OptimiseRequest is not found in the empty JSON string", OptimiseRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OptimiseRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OptimiseRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OptimiseRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OptimiseRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OptimiseRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OptimiseRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OptimiseRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OptimiseRequest>() {
           @Override
           public void write(JsonWriter out, OptimiseRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OptimiseRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OptimiseRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OptimiseRequest
   * @throws IOException if the JSON string is invalid with respect to OptimiseRequest
   */
  public static OptimiseRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OptimiseRequest.class);
  }

  /**
   * Convert an instance of OptimiseRequest to an JSON string
   *
   * @return JSON string
   */
