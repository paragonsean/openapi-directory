...
public class LinksCatalogGetCatalogColumnsLink {
  ...
  public LinksCatalogGetCatalogColumnsLink() {
  }

  public LinksCatalogGetCatalogColumnsLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksCatalogGetCatalogColumnsLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksCatalogGetCatalogColumnsLink description(String description) {
  ...
  public LinksCatalogGetCatalogColumnsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCatalogGetCatalogColumnsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCatalogGetCatalogColumnsLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksCatalogGetCatalogColumnsLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksCatalogGetCatalogColumnsLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksCatalogGetCatalogColumnsLink operationId(String operationId) {
  ...
  public LinksCatalogGetCatalogColumnsLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksCatalogGetCatalogColumnsLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksCatalogGetCatalogColumnsLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksCatalogGetCatalogColumnsLink linksCatalogGetCatalogColumnsLink = (LinksCatalogGetCatalogColumnsLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksCatalogGetCatalogColumnsLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksCatalogGetCatalogColumnsLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksCatalogGetCatalogColumnsLink.description) &&
        Objects.equals(this.docUrl, linksCatalogGetCatalogColumnsLink.docUrl) &&
        Objects.equals(this.href, linksCatalogGetCatalogColumnsLink.href) &&
        Objects.equals(this.info, linksCatalogGetCatalogColumnsLink.info) &&
        Objects.equals(this.label, linksCatalogGetCatalogColumnsLink.label) &&
        Objects.equals(this.method, linksCatalogGetCatalogColumnsLink.method) &&
        Objects.equals(this.operationId, linksCatalogGetCatalogColumnsLink.operationId) &&
        Objects.equals(this.parameters, linksCatalogGetCatalogColumnsLink.parameters) &&
        Objects.equals(this.urlTemplated, linksCatalogGetCatalogColumnsLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksCatalogGetCatalogColumnsLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCatalogGetCatalogColumnsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCatalogGetCatalogColumnsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCatalogGetCatalogColumnsLink is not found in the empty JSON string", LinksCatalogGetCatalogColumnsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCatalogGetCatalogColumnsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCatalogGetCatalogColumnsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCatalogGetCatalogColumnsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCatalogGetCatalogColumnsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCatalogGetCatalogColumnsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCatalogGetCatalogColumnsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCatalogGetCatalogColumnsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCatalogGetCatalogColumnsLink>() {
           @Override
           public void write(JsonWriter out, LinksCatalogGetCatalogColumnsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCatalogGetCatalogColumnsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCatalogGetCatalogColumnsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCatalogGetCatalogColumnsLink
   * @throws IOException if the JSON string is invalid with respect to LinksCatalogGetCatalogColumnsLink
   */
  public static LinksCatalogGetCatalogColumnsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCatalogGetCatalogColumnsLink.class);
  }

  /**
   * Convert an instance of LinksCatalogGetCatalogColumnsLink to an JSON string
   *
   * @return JSON string
   */
