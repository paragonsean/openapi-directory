...
public class LinksChangeEmailLink {
  ...
  public LinksChangeEmailLink() {
  }

  public LinksChangeEmailLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksChangeEmailLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksChangeEmailLink description(String description) {
  ...
  public LinksChangeEmailLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksChangeEmailLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksChangeEmailLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksChangeEmailLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksChangeEmailLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksChangeEmailLink operationId(String operationId) {
  ...
  public LinksChangeEmailLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksChangeEmailLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksChangeEmailLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksChangeEmailLink linksChangeEmailLink = (LinksChangeEmailLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksChangeEmailLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksChangeEmailLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksChangeEmailLink.description) &&
        Objects.equals(this.docUrl, linksChangeEmailLink.docUrl) &&
        Objects.equals(this.href, linksChangeEmailLink.href) &&
        Objects.equals(this.info, linksChangeEmailLink.info) &&
        Objects.equals(this.label, linksChangeEmailLink.label) &&
        Objects.equals(this.method, linksChangeEmailLink.method) &&
        Objects.equals(this.operationId, linksChangeEmailLink.operationId) &&
        Objects.equals(this.parameters, linksChangeEmailLink.parameters) &&
        Objects.equals(this.urlTemplated, linksChangeEmailLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksChangeEmailLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksChangeEmailLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksChangeEmailLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksChangeEmailLink is not found in the empty JSON string", LinksChangeEmailLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksChangeEmailLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksChangeEmailLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksChangeEmailLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksChangeEmailLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksChangeEmailLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksChangeEmailLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksChangeEmailLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksChangeEmailLink>() {
           @Override
           public void write(JsonWriter out, LinksChangeEmailLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksChangeEmailLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksChangeEmailLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksChangeEmailLink
   * @throws IOException if the JSON string is invalid with respect to LinksChangeEmailLink
   */
  public static LinksChangeEmailLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksChangeEmailLink.class);
  }

  /**
   * Convert an instance of LinksChangeEmailLink to an JSON string
   *
   * @return JSON string
   */
