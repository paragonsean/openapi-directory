...
public class LinksGetStoreReportByDayLink {
  ...
  public LinksGetStoreReportByDayLink() {
  }

  public LinksGetStoreReportByDayLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetStoreReportByDayLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetStoreReportByDayLink description(String description) {
  ...
  public LinksGetStoreReportByDayLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetStoreReportByDayLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetStoreReportByDayLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetStoreReportByDayLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetStoreReportByDayLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetStoreReportByDayLink operationId(String operationId) {
  ...
  public LinksGetStoreReportByDayLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetStoreReportByDayLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetStoreReportByDayLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetStoreReportByDayLink linksGetStoreReportByDayLink = (LinksGetStoreReportByDayLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetStoreReportByDayLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetStoreReportByDayLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetStoreReportByDayLink.description) &&
        Objects.equals(this.docUrl, linksGetStoreReportByDayLink.docUrl) &&
        Objects.equals(this.href, linksGetStoreReportByDayLink.href) &&
        Objects.equals(this.info, linksGetStoreReportByDayLink.info) &&
        Objects.equals(this.label, linksGetStoreReportByDayLink.label) &&
        Objects.equals(this.method, linksGetStoreReportByDayLink.method) &&
        Objects.equals(this.operationId, linksGetStoreReportByDayLink.operationId) &&
        Objects.equals(this.parameters, linksGetStoreReportByDayLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetStoreReportByDayLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetStoreReportByDayLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetStoreReportByDayLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetStoreReportByDayLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetStoreReportByDayLink is not found in the empty JSON string", LinksGetStoreReportByDayLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetStoreReportByDayLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetStoreReportByDayLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetStoreReportByDayLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetStoreReportByDayLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetStoreReportByDayLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetStoreReportByDayLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetStoreReportByDayLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetStoreReportByDayLink>() {
           @Override
           public void write(JsonWriter out, LinksGetStoreReportByDayLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetStoreReportByDayLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetStoreReportByDayLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetStoreReportByDayLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetStoreReportByDayLink
   */
  public static LinksGetStoreReportByDayLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetStoreReportByDayLink.class);
  }

  /**
   * Convert an instance of LinksGetStoreReportByDayLink to an JSON string
   *
   * @return JSON string
   */
