...
public class LinksSetMerchantOrderInfoLink {
  ...
  public LinksSetMerchantOrderInfoLink() {
  }
  ...
  public LinksSetMerchantOrderInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksSetMerchantOrderInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksSetMerchantOrderInfoLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksSetMerchantOrderInfoLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksSetMerchantOrderInfoLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksSetMerchantOrderInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksSetMerchantOrderInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksSetMerchantOrderInfoLink is not found in the empty JSON string", LinksSetMerchantOrderInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksSetMerchantOrderInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksSetMerchantOrderInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksSetMerchantOrderInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksSetMerchantOrderInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksSetMerchantOrderInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksSetMerchantOrderInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksSetMerchantOrderInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksSetMerchantOrderInfoLink>() {
           @Override
           public void write(JsonWriter out, LinksSetMerchantOrderInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksSetMerchantOrderInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksSetMerchantOrderInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksSetMerchantOrderInfoLink
   * @throws IOException if the JSON string is invalid with respect to LinksSetMerchantOrderInfoLink
   */
  public static LinksSetMerchantOrderInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksSetMerchantOrderInfoLink.class);
  }

  /**
   * Convert an instance of LinksSetMerchantOrderInfoLink to an JSON string
   *
   * @return JSON string
   */
