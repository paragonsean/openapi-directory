...
public class LinksAddChannelCatalogLink {
  ...
  public LinksAddChannelCatalogLink() {
  }

  public LinksAddChannelCatalogLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksAddChannelCatalogLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksAddChannelCatalogLink description(String description) {
  ...
  public LinksAddChannelCatalogLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksAddChannelCatalogLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksAddChannelCatalogLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksAddChannelCatalogLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksAddChannelCatalogLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksAddChannelCatalogLink operationId(String operationId) {
  ...
  public LinksAddChannelCatalogLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksAddChannelCatalogLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksAddChannelCatalogLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksAddChannelCatalogLink linksAddChannelCatalogLink = (LinksAddChannelCatalogLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksAddChannelCatalogLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksAddChannelCatalogLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksAddChannelCatalogLink.description) &&
        Objects.equals(this.docUrl, linksAddChannelCatalogLink.docUrl) &&
        Objects.equals(this.href, linksAddChannelCatalogLink.href) &&
        Objects.equals(this.info, linksAddChannelCatalogLink.info) &&
        Objects.equals(this.label, linksAddChannelCatalogLink.label) &&
        Objects.equals(this.method, linksAddChannelCatalogLink.method) &&
        Objects.equals(this.operationId, linksAddChannelCatalogLink.operationId) &&
        Objects.equals(this.parameters, linksAddChannelCatalogLink.parameters) &&
        Objects.equals(this.urlTemplated, linksAddChannelCatalogLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksAddChannelCatalogLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksAddChannelCatalogLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksAddChannelCatalogLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksAddChannelCatalogLink is not found in the empty JSON string", LinksAddChannelCatalogLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksAddChannelCatalogLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksAddChannelCatalogLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksAddChannelCatalogLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksAddChannelCatalogLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksAddChannelCatalogLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksAddChannelCatalogLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksAddChannelCatalogLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksAddChannelCatalogLink>() {
           @Override
           public void write(JsonWriter out, LinksAddChannelCatalogLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksAddChannelCatalogLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksAddChannelCatalogLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksAddChannelCatalogLink
   * @throws IOException if the JSON string is invalid with respect to LinksAddChannelCatalogLink
   */
  public static LinksAddChannelCatalogLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksAddChannelCatalogLink.class);
  }

  /**
   * Convert an instance of LinksAddChannelCatalogLink to an JSON string
   *
   * @return JSON string
   */
