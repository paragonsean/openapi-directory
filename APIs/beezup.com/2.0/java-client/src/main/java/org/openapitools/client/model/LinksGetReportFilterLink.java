...
public class LinksGetReportFilterLink {
  ...
  public LinksGetReportFilterLink() {
  }

  public LinksGetReportFilterLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetReportFilterLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetReportFilterLink description(String description) {
  ...
  public LinksGetReportFilterLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetReportFilterLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetReportFilterLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetReportFilterLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetReportFilterLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetReportFilterLink operationId(String operationId) {
  ...
  public LinksGetReportFilterLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetReportFilterLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetReportFilterLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetReportFilterLink linksGetReportFilterLink = (LinksGetReportFilterLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetReportFilterLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetReportFilterLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetReportFilterLink.description) &&
        Objects.equals(this.docUrl, linksGetReportFilterLink.docUrl) &&
        Objects.equals(this.href, linksGetReportFilterLink.href) &&
        Objects.equals(this.info, linksGetReportFilterLink.info) &&
        Objects.equals(this.label, linksGetReportFilterLink.label) &&
        Objects.equals(this.method, linksGetReportFilterLink.method) &&
        Objects.equals(this.operationId, linksGetReportFilterLink.operationId) &&
        Objects.equals(this.parameters, linksGetReportFilterLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetReportFilterLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetReportFilterLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetReportFilterLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetReportFilterLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetReportFilterLink is not found in the empty JSON string", LinksGetReportFilterLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetReportFilterLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetReportFilterLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetReportFilterLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetReportFilterLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetReportFilterLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetReportFilterLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetReportFilterLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetReportFilterLink>() {
           @Override
           public void write(JsonWriter out, LinksGetReportFilterLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetReportFilterLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetReportFilterLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetReportFilterLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetReportFilterLink
   */
  public static LinksGetReportFilterLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetReportFilterLink.class);
  }

  /**
   * Convert an instance of LinksGetReportFilterLink to an JSON string
   *
   * @return JSON string
   */
