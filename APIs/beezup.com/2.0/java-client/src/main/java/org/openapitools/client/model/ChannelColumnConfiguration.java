...
public class ChannelColumnConfiguration {
  ...
  public ChannelColumnConfiguration() {
  }

  public ChannelColumnConfiguration beezUPColumnName(String beezUPColumnName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.beezUPColumnName, channelColumnConfiguration.beezUPColumnName) &&
        Objects.equals(this.columnDataType, channelColumnConfiguration.columnDataType) &&
        Objects.equals(this.columnImportance, channelColumnConfiguration.columnImportance);
  }

  @Override
  public int hashCode() {
    return Objects.hash(beezUPColumnName, columnDataType, columnImportance);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChannelColumnConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelColumnConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelColumnConfiguration is not found in the empty JSON string", ChannelColumnConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChannelColumnConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChannelColumnConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChannelColumnConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelColumnConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelColumnConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChannelColumnConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChannelColumnConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ChannelColumnConfiguration>() {
           @Override
           public void write(JsonWriter out, ChannelColumnConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChannelColumnConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChannelColumnConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChannelColumnConfiguration
   * @throws IOException if the JSON string is invalid with respect to ChannelColumnConfiguration
   */
  public static ChannelColumnConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChannelColumnConfiguration.class);
  }

  /**
   * Convert an instance of ChannelColumnConfiguration to an JSON string
   *
   * @return JSON string
   */
