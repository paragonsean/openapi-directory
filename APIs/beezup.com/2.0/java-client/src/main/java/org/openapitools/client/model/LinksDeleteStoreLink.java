...
public class LinksDeleteStoreLink {
  ...
  public LinksDeleteStoreLink() {
  }

  public LinksDeleteStoreLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksDeleteStoreLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksDeleteStoreLink description(String description) {
  ...
  public LinksDeleteStoreLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksDeleteStoreLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksDeleteStoreLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksDeleteStoreLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksDeleteStoreLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksDeleteStoreLink operationId(String operationId) {
  ...
  public LinksDeleteStoreLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksDeleteStoreLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksDeleteStoreLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksDeleteStoreLink linksDeleteStoreLink = (LinksDeleteStoreLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksDeleteStoreLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksDeleteStoreLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksDeleteStoreLink.description) &&
        Objects.equals(this.docUrl, linksDeleteStoreLink.docUrl) &&
        Objects.equals(this.href, linksDeleteStoreLink.href) &&
        Objects.equals(this.info, linksDeleteStoreLink.info) &&
        Objects.equals(this.label, linksDeleteStoreLink.label) &&
        Objects.equals(this.method, linksDeleteStoreLink.method) &&
        Objects.equals(this.operationId, linksDeleteStoreLink.operationId) &&
        Objects.equals(this.parameters, linksDeleteStoreLink.parameters) &&
        Objects.equals(this.urlTemplated, linksDeleteStoreLink.urlTemplated);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksDeleteStoreLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksDeleteStoreLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksDeleteStoreLink is not found in the empty JSON string", LinksDeleteStoreLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksDeleteStoreLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksDeleteStoreLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksDeleteStoreLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksDeleteStoreLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksDeleteStoreLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksDeleteStoreLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksDeleteStoreLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksDeleteStoreLink>() {
           @Override
           public void write(JsonWriter out, LinksDeleteStoreLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksDeleteStoreLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksDeleteStoreLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksDeleteStoreLink
   * @throws IOException if the JSON string is invalid with respect to LinksDeleteStoreLink
   */
  public static LinksDeleteStoreLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksDeleteStoreLink.class);
  }

  /**
   * Convert an instance of LinksDeleteStoreLink to an JSON string
   *
   * @return JSON string
   */
