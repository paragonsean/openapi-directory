...
public class LinksGetOrderLink {
  ...
  public LinksGetOrderLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetOrderLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetOrderLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetOrderLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetOrderLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetOrderLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetOrderLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetOrderLink is not found in the empty JSON string", LinksGetOrderLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetOrderLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetOrderLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetOrderLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetOrderLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetOrderLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetOrderLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetOrderLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetOrderLink>() {
           @Override
           public void write(JsonWriter out, LinksGetOrderLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetOrderLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetOrderLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetOrderLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetOrderLink
   */
  public static LinksGetOrderLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetOrderLink.class);
  }

  /**
   * Convert an instance of LinksGetOrderLink to an JSON string
   *
   * @return JSON string
   */
