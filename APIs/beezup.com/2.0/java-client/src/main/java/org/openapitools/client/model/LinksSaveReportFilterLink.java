...
public class LinksSaveReportFilterLink {
  ...
  public LinksSaveReportFilterLink() {
  }
  ...
  public LinksSaveReportFilterLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksSaveReportFilterLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksSaveReportFilterLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksSaveReportFilterLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksSaveReportFilterLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksSaveReportFilterLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksSaveReportFilterLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksSaveReportFilterLink is not found in the empty JSON string", LinksSaveReportFilterLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksSaveReportFilterLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksSaveReportFilterLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksSaveReportFilterLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksSaveReportFilterLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksSaveReportFilterLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksSaveReportFilterLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksSaveReportFilterLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksSaveReportFilterLink>() {
           @Override
           public void write(JsonWriter out, LinksSaveReportFilterLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksSaveReportFilterLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksSaveReportFilterLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksSaveReportFilterLink
   * @throws IOException if the JSON string is invalid with respect to LinksSaveReportFilterLink
   */
  public static LinksSaveReportFilterLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksSaveReportFilterLink.class);
  }

  /**
   * Convert an instance of LinksSaveReportFilterLink to an JSON string
   *
   * @return JSON string
   */
