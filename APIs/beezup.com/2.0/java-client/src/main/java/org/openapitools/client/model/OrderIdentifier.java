...
public class OrderIdentifier {
  ...
  public OrderIdentifier accountId(Integer accountId) {
  ...
  public OrderIdentifier beezUPOrderId(UUID beezUPOrderId) {
  ...
  public OrderIdentifier marketplaceTechnicalCode(String marketplaceTechnicalCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, orderIdentifier.accountId) &&
        Objects.equals(this.beezUPOrderId, orderIdentifier.beezUPOrderId) &&
        Objects.equals(this.marketplaceTechnicalCode, orderIdentifier.marketplaceTechnicalCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, beezUPOrderId, marketplaceTechnicalCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderIdentifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderIdentifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderIdentifier is not found in the empty JSON string", OrderIdentifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderIdentifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderIdentifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderIdentifier.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderIdentifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderIdentifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderIdentifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderIdentifier.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderIdentifier>() {
           @Override
           public void write(JsonWriter out, OrderIdentifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderIdentifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderIdentifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderIdentifier
   * @throws IOException if the JSON string is invalid with respect to OrderIdentifier
   */
  public static OrderIdentifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderIdentifier.class);
  }

  /**
   * Convert an instance of OrderIdentifier to an JSON string
   *
   * @return JSON string
   */
