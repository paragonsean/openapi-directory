...
public class LinksGetStoresLink {
  ...
  public LinksGetStoresLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetStoresLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetStoresLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetStoresLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetStoresLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetStoresLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetStoresLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetStoresLink is not found in the empty JSON string", LinksGetStoresLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetStoresLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetStoresLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetStoresLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetStoresLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetStoresLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetStoresLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetStoresLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetStoresLink>() {
           @Override
           public void write(JsonWriter out, LinksGetStoresLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetStoresLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetStoresLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetStoresLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetStoresLink
   */
  public static LinksGetStoresLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetStoresLink.class);
  }

  /**
   * Convert an instance of LinksGetStoresLink to an JSON string
   *
   * @return JSON string
   */
