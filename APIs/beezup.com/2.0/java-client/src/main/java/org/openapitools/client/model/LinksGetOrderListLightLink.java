...
public class LinksGetOrderListLightLink {
  ...
  public LinksGetOrderListLightLink() {
  }
  ...
  public LinksGetOrderListLightLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetOrderListLightLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetOrderListLightLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetOrderListLightLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetOrderListLightLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetOrderListLightLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetOrderListLightLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetOrderListLightLink is not found in the empty JSON string", LinksGetOrderListLightLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetOrderListLightLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetOrderListLightLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetOrderListLightLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetOrderListLightLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetOrderListLightLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetOrderListLightLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetOrderListLightLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetOrderListLightLink>() {
           @Override
           public void write(JsonWriter out, LinksGetOrderListLightLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetOrderListLightLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetOrderListLightLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetOrderListLightLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetOrderListLightLink
   */
  public static LinksGetOrderListLightLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetOrderListLightLink.class);
  }

  /**
   * Convert an instance of LinksGetOrderListLightLink to an JSON string
   *
   * @return JSON string
   */
