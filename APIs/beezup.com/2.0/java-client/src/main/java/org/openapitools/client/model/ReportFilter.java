...
import org.openapitools.client.model.ReportFilterLinks;
import org.openapitools.client.model.ReportFilterParameters;
...
public class ReportFilter {
  ...
  private ReportFilterLinks links;

  public static final String SERIALIZED_NAME_PARAMETERS = "parameters";
  @SerializedName(SERIALIZED_NAME_PARAMETERS)
  private ReportFilterParameters parameters;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, reportFilter.links) &&
        Objects.equals(this.parameters, reportFilter.parameters) &&
        Objects.equals(this.reportFilterId, reportFilter.reportFilterId) &&
        Objects.equals(this.reportFilterName, reportFilter.reportFilterName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, parameters, reportFilterId, reportFilterName);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ReportFilter.openapiRequiredFields) {
      ...
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        ReportFilterLinks.validateJsonElement(jsonObj.get("links"));
      }
      // validate the required field `parameters`
      ReportFilterParameters.validateJsonElement(jsonObj.get("parameters"));
