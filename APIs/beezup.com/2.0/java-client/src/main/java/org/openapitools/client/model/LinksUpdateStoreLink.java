...
public class LinksUpdateStoreLink {
  ...
  public LinksUpdateStoreLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksUpdateStoreLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksUpdateStoreLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksUpdateStoreLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksUpdateStoreLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksUpdateStoreLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksUpdateStoreLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksUpdateStoreLink is not found in the empty JSON string", LinksUpdateStoreLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksUpdateStoreLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksUpdateStoreLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksUpdateStoreLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksUpdateStoreLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksUpdateStoreLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksUpdateStoreLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksUpdateStoreLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksUpdateStoreLink>() {
           @Override
           public void write(JsonWriter out, LinksUpdateStoreLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksUpdateStoreLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksUpdateStoreLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksUpdateStoreLink
   * @throws IOException if the JSON string is invalid with respect to LinksUpdateStoreLink
   */
  public static LinksUpdateStoreLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksUpdateStoreLink.class);
  }

  /**
   * Convert an instance of LinksUpdateStoreLink to an JSON string
   *
   * @return JSON string
   */
