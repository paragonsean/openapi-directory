...
public class LinksImportationCancelLink {
  ...
  public LinksImportationCancelLink() {
  }

  public LinksImportationCancelLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationCancelLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationCancelLink description(String description) {
  ...
  public LinksImportationCancelLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationCancelLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationCancelLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationCancelLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationCancelLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationCancelLink operationId(String operationId) {
  ...
  public LinksImportationCancelLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationCancelLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationCancelLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationCancelLink linksImportationCancelLink = (LinksImportationCancelLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationCancelLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationCancelLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationCancelLink.description) &&
        Objects.equals(this.docUrl, linksImportationCancelLink.docUrl) &&
        Objects.equals(this.href, linksImportationCancelLink.href) &&
        Objects.equals(this.info, linksImportationCancelLink.info) &&
        Objects.equals(this.label, linksImportationCancelLink.label) &&
        Objects.equals(this.method, linksImportationCancelLink.method) &&
        Objects.equals(this.operationId, linksImportationCancelLink.operationId) &&
        Objects.equals(this.parameters, linksImportationCancelLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationCancelLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationCancelLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationCancelLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationCancelLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationCancelLink is not found in the empty JSON string", LinksImportationCancelLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationCancelLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationCancelLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationCancelLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationCancelLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationCancelLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationCancelLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationCancelLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationCancelLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationCancelLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationCancelLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationCancelLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationCancelLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationCancelLink
   */
  public static LinksImportationCancelLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationCancelLink.class);
  }

  /**
   * Convert an instance of LinksImportationCancelLink to an JSON string
   *
   * @return JSON string
   */
