...
public class LinksShareStoreLink {
  ...
  public LinksShareStoreLink() {
  }

  public LinksShareStoreLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksShareStoreLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksShareStoreLink description(String description) {
  ...
  public LinksShareStoreLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksShareStoreLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksShareStoreLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksShareStoreLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksShareStoreLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksShareStoreLink operationId(String operationId) {
  ...
  public LinksShareStoreLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksShareStoreLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksShareStoreLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksShareStoreLink linksShareStoreLink = (LinksShareStoreLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksShareStoreLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksShareStoreLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksShareStoreLink.description) &&
        Objects.equals(this.docUrl, linksShareStoreLink.docUrl) &&
        Objects.equals(this.href, linksShareStoreLink.href) &&
        Objects.equals(this.info, linksShareStoreLink.info) &&
        Objects.equals(this.label, linksShareStoreLink.label) &&
        Objects.equals(this.method, linksShareStoreLink.method) &&
        Objects.equals(this.operationId, linksShareStoreLink.operationId) &&
        Objects.equals(this.parameters, linksShareStoreLink.parameters) &&
        Objects.equals(this.urlTemplated, linksShareStoreLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksShareStoreLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksShareStoreLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksShareStoreLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksShareStoreLink is not found in the empty JSON string", LinksShareStoreLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksShareStoreLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksShareStoreLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksShareStoreLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksShareStoreLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksShareStoreLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksShareStoreLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksShareStoreLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksShareStoreLink>() {
           @Override
           public void write(JsonWriter out, LinksShareStoreLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksShareStoreLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksShareStoreLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksShareStoreLink
   * @throws IOException if the JSON string is invalid with respect to LinksShareStoreLink
   */
  public static LinksShareStoreLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksShareStoreLink.class);
  }

  /**
   * Convert an instance of LinksShareStoreLink to an JSON string
   *
   * @return JSON string
   */
