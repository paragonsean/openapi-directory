...
public class LinksGetStoreLink {
  ...
  public LinksGetStoreLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetStoreLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetStoreLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetStoreLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetStoreLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetStoreLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetStoreLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetStoreLink is not found in the empty JSON string", LinksGetStoreLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetStoreLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetStoreLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetStoreLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetStoreLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetStoreLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetStoreLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetStoreLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetStoreLink>() {
           @Override
           public void write(JsonWriter out, LinksGetStoreLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetStoreLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetStoreLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetStoreLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetStoreLink
   */
  public static LinksGetStoreLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetStoreLink.class);
  }

  /**
   * Convert an instance of LinksGetStoreLink to an JSON string
   *
   * @return JSON string
   */
