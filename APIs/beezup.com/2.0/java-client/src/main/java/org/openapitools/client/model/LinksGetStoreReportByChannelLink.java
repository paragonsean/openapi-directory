...
public class LinksGetStoreReportByChannelLink {
  ...
  public LinksGetStoreReportByChannelLink() {
  }

  public LinksGetStoreReportByChannelLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetStoreReportByChannelLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetStoreReportByChannelLink description(String description) {
  ...
  public LinksGetStoreReportByChannelLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetStoreReportByChannelLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetStoreReportByChannelLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetStoreReportByChannelLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetStoreReportByChannelLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetStoreReportByChannelLink operationId(String operationId) {
  ...
  public LinksGetStoreReportByChannelLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetStoreReportByChannelLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetStoreReportByChannelLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetStoreReportByChannelLink linksGetStoreReportByChannelLink = (LinksGetStoreReportByChannelLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetStoreReportByChannelLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetStoreReportByChannelLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetStoreReportByChannelLink.description) &&
        Objects.equals(this.docUrl, linksGetStoreReportByChannelLink.docUrl) &&
        Objects.equals(this.href, linksGetStoreReportByChannelLink.href) &&
        Objects.equals(this.info, linksGetStoreReportByChannelLink.info) &&
        Objects.equals(this.label, linksGetStoreReportByChannelLink.label) &&
        Objects.equals(this.method, linksGetStoreReportByChannelLink.method) &&
        Objects.equals(this.operationId, linksGetStoreReportByChannelLink.operationId) &&
        Objects.equals(this.parameters, linksGetStoreReportByChannelLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetStoreReportByChannelLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetStoreReportByChannelLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetStoreReportByChannelLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetStoreReportByChannelLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetStoreReportByChannelLink is not found in the empty JSON string", LinksGetStoreReportByChannelLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetStoreReportByChannelLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetStoreReportByChannelLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetStoreReportByChannelLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetStoreReportByChannelLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetStoreReportByChannelLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetStoreReportByChannelLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetStoreReportByChannelLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetStoreReportByChannelLink>() {
           @Override
           public void write(JsonWriter out, LinksGetStoreReportByChannelLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetStoreReportByChannelLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetStoreReportByChannelLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetStoreReportByChannelLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetStoreReportByChannelLink
   */
  public static LinksGetStoreReportByChannelLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetStoreReportByChannelLink.class);
  }

  /**
   * Convert an instance of LinksGetStoreReportByChannelLink to an JSON string
   *
   * @return JSON string
   */
