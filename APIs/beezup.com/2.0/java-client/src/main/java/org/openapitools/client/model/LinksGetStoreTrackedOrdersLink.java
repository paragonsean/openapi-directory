...
public class LinksGetStoreTrackedOrdersLink {
  ...
  public LinksGetStoreTrackedOrdersLink() {
  }

  public LinksGetStoreTrackedOrdersLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetStoreTrackedOrdersLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetStoreTrackedOrdersLink description(String description) {
  ...
  public LinksGetStoreTrackedOrdersLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetStoreTrackedOrdersLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetStoreTrackedOrdersLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetStoreTrackedOrdersLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetStoreTrackedOrdersLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetStoreTrackedOrdersLink operationId(String operationId) {
  ...
  public LinksGetStoreTrackedOrdersLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetStoreTrackedOrdersLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetStoreTrackedOrdersLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetStoreTrackedOrdersLink linksGetStoreTrackedOrdersLink = (LinksGetStoreTrackedOrdersLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetStoreTrackedOrdersLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetStoreTrackedOrdersLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetStoreTrackedOrdersLink.description) &&
        Objects.equals(this.docUrl, linksGetStoreTrackedOrdersLink.docUrl) &&
        Objects.equals(this.href, linksGetStoreTrackedOrdersLink.href) &&
        Objects.equals(this.info, linksGetStoreTrackedOrdersLink.info) &&
        Objects.equals(this.label, linksGetStoreTrackedOrdersLink.label) &&
        Objects.equals(this.method, linksGetStoreTrackedOrdersLink.method) &&
        Objects.equals(this.operationId, linksGetStoreTrackedOrdersLink.operationId) &&
        Objects.equals(this.parameters, linksGetStoreTrackedOrdersLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetStoreTrackedOrdersLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetStoreTrackedOrdersLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetStoreTrackedOrdersLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetStoreTrackedOrdersLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetStoreTrackedOrdersLink is not found in the empty JSON string", LinksGetStoreTrackedOrdersLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetStoreTrackedOrdersLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetStoreTrackedOrdersLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetStoreTrackedOrdersLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetStoreTrackedOrdersLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetStoreTrackedOrdersLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetStoreTrackedOrdersLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetStoreTrackedOrdersLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetStoreTrackedOrdersLink>() {
           @Override
           public void write(JsonWriter out, LinksGetStoreTrackedOrdersLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetStoreTrackedOrdersLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetStoreTrackedOrdersLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetStoreTrackedOrdersLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetStoreTrackedOrdersLink
   */
  public static LinksGetStoreTrackedOrdersLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetStoreTrackedOrdersLink.class);
  }

  /**
   * Convert an instance of LinksGetStoreTrackedOrdersLink to an JSON string
   *
   * @return JSON string
   */
