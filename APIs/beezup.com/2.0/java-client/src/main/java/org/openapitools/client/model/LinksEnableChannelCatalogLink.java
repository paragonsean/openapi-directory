...
public class LinksEnableChannelCatalogLink {
  ...
  public LinksEnableChannelCatalogLink() {
  }

  public LinksEnableChannelCatalogLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksEnableChannelCatalogLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksEnableChannelCatalogLink description(String description) {
  ...
  public LinksEnableChannelCatalogLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksEnableChannelCatalogLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksEnableChannelCatalogLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksEnableChannelCatalogLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksEnableChannelCatalogLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksEnableChannelCatalogLink operationId(String operationId) {
  ...
  public LinksEnableChannelCatalogLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksEnableChannelCatalogLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksEnableChannelCatalogLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksEnableChannelCatalogLink linksEnableChannelCatalogLink = (LinksEnableChannelCatalogLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksEnableChannelCatalogLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksEnableChannelCatalogLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksEnableChannelCatalogLink.description) &&
        Objects.equals(this.docUrl, linksEnableChannelCatalogLink.docUrl) &&
        Objects.equals(this.href, linksEnableChannelCatalogLink.href) &&
        Objects.equals(this.info, linksEnableChannelCatalogLink.info) &&
        Objects.equals(this.label, linksEnableChannelCatalogLink.label) &&
        Objects.equals(this.method, linksEnableChannelCatalogLink.method) &&
        Objects.equals(this.operationId, linksEnableChannelCatalogLink.operationId) &&
        Objects.equals(this.parameters, linksEnableChannelCatalogLink.parameters) &&
        Objects.equals(this.urlTemplated, linksEnableChannelCatalogLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksEnableChannelCatalogLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksEnableChannelCatalogLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksEnableChannelCatalogLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksEnableChannelCatalogLink is not found in the empty JSON string", LinksEnableChannelCatalogLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksEnableChannelCatalogLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksEnableChannelCatalogLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksEnableChannelCatalogLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksEnableChannelCatalogLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksEnableChannelCatalogLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksEnableChannelCatalogLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksEnableChannelCatalogLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksEnableChannelCatalogLink>() {
           @Override
           public void write(JsonWriter out, LinksEnableChannelCatalogLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksEnableChannelCatalogLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksEnableChannelCatalogLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksEnableChannelCatalogLink
   * @throws IOException if the JSON string is invalid with respect to LinksEnableChannelCatalogLink
   */
  public static LinksEnableChannelCatalogLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksEnableChannelCatalogLink.class);
  }

  /**
   * Convert an instance of LinksEnableChannelCatalogLink to an JSON string
   *
   * @return JSON string
   */
