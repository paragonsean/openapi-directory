...
public class LinksSetMerchantOrderInfoListLink {
  ...
  public LinksSetMerchantOrderInfoListLink() {
  }
  ...
  public LinksSetMerchantOrderInfoListLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksSetMerchantOrderInfoListLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksSetMerchantOrderInfoListLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksSetMerchantOrderInfoListLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksSetMerchantOrderInfoListLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksSetMerchantOrderInfoListLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksSetMerchantOrderInfoListLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksSetMerchantOrderInfoListLink is not found in the empty JSON string", LinksSetMerchantOrderInfoListLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksSetMerchantOrderInfoListLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksSetMerchantOrderInfoListLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksSetMerchantOrderInfoListLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksSetMerchantOrderInfoListLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksSetMerchantOrderInfoListLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksSetMerchantOrderInfoListLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksSetMerchantOrderInfoListLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksSetMerchantOrderInfoListLink>() {
           @Override
           public void write(JsonWriter out, LinksSetMerchantOrderInfoListLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksSetMerchantOrderInfoListLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksSetMerchantOrderInfoListLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksSetMerchantOrderInfoListLink
   * @throws IOException if the JSON string is invalid with respect to LinksSetMerchantOrderInfoListLink
   */
  public static LinksSetMerchantOrderInfoListLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksSetMerchantOrderInfoListLink.class);
  }

  /**
   * Convert an instance of LinksSetMerchantOrderInfoListLink to an JSON string
   *
   * @return JSON string
   */
