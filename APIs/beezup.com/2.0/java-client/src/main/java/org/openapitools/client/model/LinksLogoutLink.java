...
public class LinksLogoutLink {
  ...
  public LinksLogoutLink() {
  }

  public LinksLogoutLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksLogoutLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksLogoutLink description(String description) {
  ...
  public LinksLogoutLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksLogoutLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksLogoutLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksLogoutLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksLogoutLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksLogoutLink operationId(String operationId) {
  ...
  public LinksLogoutLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksLogoutLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksLogoutLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksLogoutLink linksLogoutLink = (LinksLogoutLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksLogoutLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksLogoutLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksLogoutLink.description) &&
        Objects.equals(this.docUrl, linksLogoutLink.docUrl) &&
        Objects.equals(this.href, linksLogoutLink.href) &&
        Objects.equals(this.info, linksLogoutLink.info) &&
        Objects.equals(this.label, linksLogoutLink.label) &&
        Objects.equals(this.method, linksLogoutLink.method) &&
        Objects.equals(this.operationId, linksLogoutLink.operationId) &&
        Objects.equals(this.parameters, linksLogoutLink.parameters) &&
        Objects.equals(this.urlTemplated, linksLogoutLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksLogoutLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksLogoutLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksLogoutLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksLogoutLink is not found in the empty JSON string", LinksLogoutLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksLogoutLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksLogoutLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksLogoutLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksLogoutLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksLogoutLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksLogoutLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksLogoutLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksLogoutLink>() {
           @Override
           public void write(JsonWriter out, LinksLogoutLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksLogoutLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksLogoutLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksLogoutLink
   * @throws IOException if the JSON string is invalid with respect to LinksLogoutLink
   */
  public static LinksLogoutLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksLogoutLink.class);
  }

  /**
   * Convert an instance of LinksLogoutLink to an JSON string
   *
   * @return JSON string
   */
