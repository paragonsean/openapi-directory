...
public class LinksImportationCommitColumnsLink {
  ...
  public LinksImportationCommitColumnsLink() {
  }

  public LinksImportationCommitColumnsLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationCommitColumnsLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationCommitColumnsLink description(String description) {
  ...
  public LinksImportationCommitColumnsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationCommitColumnsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationCommitColumnsLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationCommitColumnsLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationCommitColumnsLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationCommitColumnsLink operationId(String operationId) {
  ...
  public LinksImportationCommitColumnsLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationCommitColumnsLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationCommitColumnsLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationCommitColumnsLink linksImportationCommitColumnsLink = (LinksImportationCommitColumnsLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationCommitColumnsLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationCommitColumnsLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationCommitColumnsLink.description) &&
        Objects.equals(this.docUrl, linksImportationCommitColumnsLink.docUrl) &&
        Objects.equals(this.href, linksImportationCommitColumnsLink.href) &&
        Objects.equals(this.info, linksImportationCommitColumnsLink.info) &&
        Objects.equals(this.label, linksImportationCommitColumnsLink.label) &&
        Objects.equals(this.method, linksImportationCommitColumnsLink.method) &&
        Objects.equals(this.operationId, linksImportationCommitColumnsLink.operationId) &&
        Objects.equals(this.parameters, linksImportationCommitColumnsLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationCommitColumnsLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationCommitColumnsLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationCommitColumnsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationCommitColumnsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationCommitColumnsLink is not found in the empty JSON string", LinksImportationCommitColumnsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationCommitColumnsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationCommitColumnsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationCommitColumnsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationCommitColumnsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationCommitColumnsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationCommitColumnsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationCommitColumnsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationCommitColumnsLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationCommitColumnsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationCommitColumnsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationCommitColumnsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationCommitColumnsLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationCommitColumnsLink
   */
  public static LinksImportationCommitColumnsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationCommitColumnsLink.class);
  }

  /**
   * Convert an instance of LinksImportationCommitColumnsLink to an JSON string
   *
   * @return JSON string
   */
