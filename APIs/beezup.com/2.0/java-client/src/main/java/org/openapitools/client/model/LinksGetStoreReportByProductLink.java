...
public class LinksGetStoreReportByProductLink {
  ...
  public LinksGetStoreReportByProductLink() {
  }

  public LinksGetStoreReportByProductLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetStoreReportByProductLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetStoreReportByProductLink description(String description) {
  ...
  public LinksGetStoreReportByProductLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetStoreReportByProductLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetStoreReportByProductLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetStoreReportByProductLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetStoreReportByProductLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetStoreReportByProductLink operationId(String operationId) {
  ...
  public LinksGetStoreReportByProductLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetStoreReportByProductLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetStoreReportByProductLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetStoreReportByProductLink linksGetStoreReportByProductLink = (LinksGetStoreReportByProductLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetStoreReportByProductLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetStoreReportByProductLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetStoreReportByProductLink.description) &&
        Objects.equals(this.docUrl, linksGetStoreReportByProductLink.docUrl) &&
        Objects.equals(this.href, linksGetStoreReportByProductLink.href) &&
        Objects.equals(this.info, linksGetStoreReportByProductLink.info) &&
        Objects.equals(this.label, linksGetStoreReportByProductLink.label) &&
        Objects.equals(this.method, linksGetStoreReportByProductLink.method) &&
        Objects.equals(this.operationId, linksGetStoreReportByProductLink.operationId) &&
        Objects.equals(this.parameters, linksGetStoreReportByProductLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetStoreReportByProductLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetStoreReportByProductLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetStoreReportByProductLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetStoreReportByProductLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetStoreReportByProductLink is not found in the empty JSON string", LinksGetStoreReportByProductLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetStoreReportByProductLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetStoreReportByProductLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetStoreReportByProductLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetStoreReportByProductLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetStoreReportByProductLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetStoreReportByProductLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetStoreReportByProductLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetStoreReportByProductLink>() {
           @Override
           public void write(JsonWriter out, LinksGetStoreReportByProductLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetStoreReportByProductLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetStoreReportByProductLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetStoreReportByProductLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetStoreReportByProductLink
   */
  public static LinksGetStoreReportByProductLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetStoreReportByProductLink.class);
  }

  /**
   * Convert an instance of LinksGetStoreReportByProductLink to an JSON string
   *
   * @return JSON string
   */
