...
public class LinksGetChannelCatalogCategoriesLink {
  ...
  public LinksGetChannelCatalogCategoriesLink() {
  }

  public LinksGetChannelCatalogCategoriesLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetChannelCatalogCategoriesLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetChannelCatalogCategoriesLink description(String description) {
  ...
  public LinksGetChannelCatalogCategoriesLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetChannelCatalogCategoriesLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetChannelCatalogCategoriesLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetChannelCatalogCategoriesLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetChannelCatalogCategoriesLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetChannelCatalogCategoriesLink operationId(String operationId) {
  ...
  public LinksGetChannelCatalogCategoriesLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetChannelCatalogCategoriesLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetChannelCatalogCategoriesLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetChannelCatalogCategoriesLink linksGetChannelCatalogCategoriesLink = (LinksGetChannelCatalogCategoriesLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetChannelCatalogCategoriesLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetChannelCatalogCategoriesLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetChannelCatalogCategoriesLink.description) &&
        Objects.equals(this.docUrl, linksGetChannelCatalogCategoriesLink.docUrl) &&
        Objects.equals(this.href, linksGetChannelCatalogCategoriesLink.href) &&
        Objects.equals(this.info, linksGetChannelCatalogCategoriesLink.info) &&
        Objects.equals(this.label, linksGetChannelCatalogCategoriesLink.label) &&
        Objects.equals(this.method, linksGetChannelCatalogCategoriesLink.method) &&
        Objects.equals(this.operationId, linksGetChannelCatalogCategoriesLink.operationId) &&
        Objects.equals(this.parameters, linksGetChannelCatalogCategoriesLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetChannelCatalogCategoriesLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetChannelCatalogCategoriesLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetChannelCatalogCategoriesLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetChannelCatalogCategoriesLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetChannelCatalogCategoriesLink is not found in the empty JSON string", LinksGetChannelCatalogCategoriesLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetChannelCatalogCategoriesLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetChannelCatalogCategoriesLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetChannelCatalogCategoriesLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetChannelCatalogCategoriesLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetChannelCatalogCategoriesLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetChannelCatalogCategoriesLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetChannelCatalogCategoriesLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetChannelCatalogCategoriesLink>() {
           @Override
           public void write(JsonWriter out, LinksGetChannelCatalogCategoriesLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetChannelCatalogCategoriesLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetChannelCatalogCategoriesLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetChannelCatalogCategoriesLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetChannelCatalogCategoriesLink
   */
  public static LinksGetChannelCatalogCategoriesLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetChannelCatalogCategoriesLink.class);
  }

  /**
   * Convert an instance of LinksGetChannelCatalogCategoriesLink to an JSON string
   *
   * @return JSON string
   */
