...
public class LinksGetStandardOffersLink {
  ...
  public LinksGetStandardOffersLink() {
  }

  public LinksGetStandardOffersLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetStandardOffersLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetStandardOffersLink description(String description) {
  ...
  public LinksGetStandardOffersLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetStandardOffersLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetStandardOffersLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetStandardOffersLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetStandardOffersLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetStandardOffersLink operationId(String operationId) {
  ...
  public LinksGetStandardOffersLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetStandardOffersLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetStandardOffersLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetStandardOffersLink linksGetStandardOffersLink = (LinksGetStandardOffersLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetStandardOffersLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetStandardOffersLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetStandardOffersLink.description) &&
        Objects.equals(this.docUrl, linksGetStandardOffersLink.docUrl) &&
        Objects.equals(this.href, linksGetStandardOffersLink.href) &&
        Objects.equals(this.info, linksGetStandardOffersLink.info) &&
        Objects.equals(this.label, linksGetStandardOffersLink.label) &&
        Objects.equals(this.method, linksGetStandardOffersLink.method) &&
        Objects.equals(this.operationId, linksGetStandardOffersLink.operationId) &&
        Objects.equals(this.parameters, linksGetStandardOffersLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetStandardOffersLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetStandardOffersLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetStandardOffersLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetStandardOffersLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetStandardOffersLink is not found in the empty JSON string", LinksGetStandardOffersLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetStandardOffersLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetStandardOffersLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetStandardOffersLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetStandardOffersLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetStandardOffersLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetStandardOffersLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetStandardOffersLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetStandardOffersLink>() {
           @Override
           public void write(JsonWriter out, LinksGetStandardOffersLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetStandardOffersLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetStandardOffersLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetStandardOffersLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetStandardOffersLink
   */
  public static LinksGetStandardOffersLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetStandardOffersLink.class);
  }

  /**
   * Convert an instance of LinksGetStandardOffersLink to an JSON string
   *
   * @return JSON string
   */
