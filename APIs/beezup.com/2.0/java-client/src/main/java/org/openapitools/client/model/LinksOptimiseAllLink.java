...
public class LinksOptimiseAllLink {
  ...
  public LinksOptimiseAllLink() {
  }

  public LinksOptimiseAllLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksOptimiseAllLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksOptimiseAllLink description(String description) {
  ...
  public LinksOptimiseAllLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksOptimiseAllLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksOptimiseAllLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksOptimiseAllLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksOptimiseAllLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksOptimiseAllLink operationId(String operationId) {
  ...
  public LinksOptimiseAllLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksOptimiseAllLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksOptimiseAllLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksOptimiseAllLink linksOptimiseAllLink = (LinksOptimiseAllLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksOptimiseAllLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksOptimiseAllLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksOptimiseAllLink.description) &&
        Objects.equals(this.docUrl, linksOptimiseAllLink.docUrl) &&
        Objects.equals(this.href, linksOptimiseAllLink.href) &&
        Objects.equals(this.info, linksOptimiseAllLink.info) &&
        Objects.equals(this.label, linksOptimiseAllLink.label) &&
        Objects.equals(this.method, linksOptimiseAllLink.method) &&
        Objects.equals(this.operationId, linksOptimiseAllLink.operationId) &&
        Objects.equals(this.parameters, linksOptimiseAllLink.parameters) &&
        Objects.equals(this.urlTemplated, linksOptimiseAllLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksOptimiseAllLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksOptimiseAllLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksOptimiseAllLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksOptimiseAllLink is not found in the empty JSON string", LinksOptimiseAllLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksOptimiseAllLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksOptimiseAllLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksOptimiseAllLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksOptimiseAllLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksOptimiseAllLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksOptimiseAllLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksOptimiseAllLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksOptimiseAllLink>() {
           @Override
           public void write(JsonWriter out, LinksOptimiseAllLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksOptimiseAllLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksOptimiseAllLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksOptimiseAllLink
   * @throws IOException if the JSON string is invalid with respect to LinksOptimiseAllLink
   */
  public static LinksOptimiseAllLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksOptimiseAllLink.class);
  }

  /**
   * Convert an instance of LinksOptimiseAllLink to an JSON string
   *
   * @return JSON string
   */
