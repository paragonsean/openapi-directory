...
public class LinksGetOrderListFullLink {
  ...
  public LinksGetOrderListFullLink() {
  }

  public LinksGetOrderListFullLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetOrderListFullLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetOrderListFullLink description(String description) {
  ...
  public LinksGetOrderListFullLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetOrderListFullLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetOrderListFullLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetOrderListFullLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetOrderListFullLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetOrderListFullLink operationId(String operationId) {
  ...
  public LinksGetOrderListFullLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetOrderListFullLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetOrderListFullLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetOrderListFullLink linksGetOrderListFullLink = (LinksGetOrderListFullLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetOrderListFullLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetOrderListFullLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetOrderListFullLink.description) &&
        Objects.equals(this.docUrl, linksGetOrderListFullLink.docUrl) &&
        Objects.equals(this.href, linksGetOrderListFullLink.href) &&
        Objects.equals(this.info, linksGetOrderListFullLink.info) &&
        Objects.equals(this.label, linksGetOrderListFullLink.label) &&
        Objects.equals(this.method, linksGetOrderListFullLink.method) &&
        Objects.equals(this.operationId, linksGetOrderListFullLink.operationId) &&
        Objects.equals(this.parameters, linksGetOrderListFullLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetOrderListFullLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetOrderListFullLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetOrderListFullLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetOrderListFullLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetOrderListFullLink is not found in the empty JSON string", LinksGetOrderListFullLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetOrderListFullLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetOrderListFullLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetOrderListFullLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetOrderListFullLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetOrderListFullLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetOrderListFullLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetOrderListFullLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetOrderListFullLink>() {
           @Override
           public void write(JsonWriter out, LinksGetOrderListFullLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetOrderListFullLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetOrderListFullLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetOrderListFullLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetOrderListFullLink
   */
  public static LinksGetOrderListFullLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetOrderListFullLink.class);
  }

  /**
   * Convert an instance of LinksGetOrderListFullLink to an JSON string
   *
   * @return JSON string
   */
