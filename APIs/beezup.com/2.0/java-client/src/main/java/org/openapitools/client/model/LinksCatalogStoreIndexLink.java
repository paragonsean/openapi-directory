...
public class LinksCatalogStoreIndexLink {
  ...
  public LinksCatalogStoreIndexLink() {
  }

  public LinksCatalogStoreIndexLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksCatalogStoreIndexLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksCatalogStoreIndexLink description(String description) {
  ...
  public LinksCatalogStoreIndexLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCatalogStoreIndexLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCatalogStoreIndexLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksCatalogStoreIndexLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksCatalogStoreIndexLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksCatalogStoreIndexLink operationId(String operationId) {
  ...
  public LinksCatalogStoreIndexLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksCatalogStoreIndexLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksCatalogStoreIndexLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksCatalogStoreIndexLink linksCatalogStoreIndexLink = (LinksCatalogStoreIndexLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksCatalogStoreIndexLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksCatalogStoreIndexLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksCatalogStoreIndexLink.description) &&
        Objects.equals(this.docUrl, linksCatalogStoreIndexLink.docUrl) &&
        Objects.equals(this.href, linksCatalogStoreIndexLink.href) &&
        Objects.equals(this.info, linksCatalogStoreIndexLink.info) &&
        Objects.equals(this.label, linksCatalogStoreIndexLink.label) &&
        Objects.equals(this.method, linksCatalogStoreIndexLink.method) &&
        Objects.equals(this.operationId, linksCatalogStoreIndexLink.operationId) &&
        Objects.equals(this.parameters, linksCatalogStoreIndexLink.parameters) &&
        Objects.equals(this.urlTemplated, linksCatalogStoreIndexLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksCatalogStoreIndexLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCatalogStoreIndexLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCatalogStoreIndexLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCatalogStoreIndexLink is not found in the empty JSON string", LinksCatalogStoreIndexLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCatalogStoreIndexLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCatalogStoreIndexLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCatalogStoreIndexLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCatalogStoreIndexLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCatalogStoreIndexLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCatalogStoreIndexLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCatalogStoreIndexLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCatalogStoreIndexLink>() {
           @Override
           public void write(JsonWriter out, LinksCatalogStoreIndexLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCatalogStoreIndexLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCatalogStoreIndexLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCatalogStoreIndexLink
   * @throws IOException if the JSON string is invalid with respect to LinksCatalogStoreIndexLink
   */
  public static LinksCatalogStoreIndexLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCatalogStoreIndexLink.class);
  }

  /**
   * Convert an instance of LinksCatalogStoreIndexLink to an JSON string
   *
   * @return JSON string
   */
