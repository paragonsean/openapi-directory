...
public class LinksGetStoreReportByCategoryLink {
  ...
  public LinksGetStoreReportByCategoryLink() {
  }

  public LinksGetStoreReportByCategoryLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetStoreReportByCategoryLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetStoreReportByCategoryLink description(String description) {
  ...
  public LinksGetStoreReportByCategoryLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetStoreReportByCategoryLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetStoreReportByCategoryLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetStoreReportByCategoryLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetStoreReportByCategoryLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetStoreReportByCategoryLink operationId(String operationId) {
  ...
  public LinksGetStoreReportByCategoryLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetStoreReportByCategoryLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetStoreReportByCategoryLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetStoreReportByCategoryLink linksGetStoreReportByCategoryLink = (LinksGetStoreReportByCategoryLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetStoreReportByCategoryLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetStoreReportByCategoryLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetStoreReportByCategoryLink.description) &&
        Objects.equals(this.docUrl, linksGetStoreReportByCategoryLink.docUrl) &&
        Objects.equals(this.href, linksGetStoreReportByCategoryLink.href) &&
        Objects.equals(this.info, linksGetStoreReportByCategoryLink.info) &&
        Objects.equals(this.label, linksGetStoreReportByCategoryLink.label) &&
        Objects.equals(this.method, linksGetStoreReportByCategoryLink.method) &&
        Objects.equals(this.operationId, linksGetStoreReportByCategoryLink.operationId) &&
        Objects.equals(this.parameters, linksGetStoreReportByCategoryLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetStoreReportByCategoryLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetStoreReportByCategoryLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetStoreReportByCategoryLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetStoreReportByCategoryLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetStoreReportByCategoryLink is not found in the empty JSON string", LinksGetStoreReportByCategoryLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetStoreReportByCategoryLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetStoreReportByCategoryLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetStoreReportByCategoryLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetStoreReportByCategoryLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetStoreReportByCategoryLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetStoreReportByCategoryLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetStoreReportByCategoryLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetStoreReportByCategoryLink>() {
           @Override
           public void write(JsonWriter out, LinksGetStoreReportByCategoryLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetStoreReportByCategoryLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetStoreReportByCategoryLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetStoreReportByCategoryLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetStoreReportByCategoryLink
   */
  public static LinksGetStoreReportByCategoryLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetStoreReportByCategoryLink.class);
  }

  /**
   * Convert an instance of LinksGetStoreReportByCategoryLink to an JSON string
   *
   * @return JSON string
   */
