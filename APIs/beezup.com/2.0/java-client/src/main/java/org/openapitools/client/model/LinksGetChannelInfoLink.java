...
public class LinksGetChannelInfoLink {
  ...
  public LinksGetChannelInfoLink() {
  }

  public LinksGetChannelInfoLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetChannelInfoLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetChannelInfoLink description(String description) {
  ...
  public LinksGetChannelInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetChannelInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetChannelInfoLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetChannelInfoLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetChannelInfoLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetChannelInfoLink operationId(String operationId) {
  ...
  public LinksGetChannelInfoLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetChannelInfoLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetChannelInfoLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetChannelInfoLink linksGetChannelInfoLink = (LinksGetChannelInfoLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetChannelInfoLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetChannelInfoLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetChannelInfoLink.description) &&
        Objects.equals(this.docUrl, linksGetChannelInfoLink.docUrl) &&
        Objects.equals(this.href, linksGetChannelInfoLink.href) &&
        Objects.equals(this.info, linksGetChannelInfoLink.info) &&
        Objects.equals(this.label, linksGetChannelInfoLink.label) &&
        Objects.equals(this.method, linksGetChannelInfoLink.method) &&
        Objects.equals(this.operationId, linksGetChannelInfoLink.operationId) &&
        Objects.equals(this.parameters, linksGetChannelInfoLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetChannelInfoLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetChannelInfoLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetChannelInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetChannelInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetChannelInfoLink is not found in the empty JSON string", LinksGetChannelInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetChannelInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetChannelInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetChannelInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetChannelInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetChannelInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetChannelInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetChannelInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetChannelInfoLink>() {
           @Override
           public void write(JsonWriter out, LinksGetChannelInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetChannelInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetChannelInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetChannelInfoLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetChannelInfoLink
   */
  public static LinksGetChannelInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetChannelInfoLink.class);
  }

  /**
   * Convert an instance of LinksGetChannelInfoLink to an JSON string
   *
   * @return JSON string
   */
