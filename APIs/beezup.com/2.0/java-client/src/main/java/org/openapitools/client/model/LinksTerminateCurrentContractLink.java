...
public class LinksTerminateCurrentContractLink {
  ...
  public LinksTerminateCurrentContractLink() {
  }
  ...
  public LinksTerminateCurrentContractLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksTerminateCurrentContractLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksTerminateCurrentContractLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksTerminateCurrentContractLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksTerminateCurrentContractLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksTerminateCurrentContractLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksTerminateCurrentContractLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksTerminateCurrentContractLink is not found in the empty JSON string", LinksTerminateCurrentContractLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksTerminateCurrentContractLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksTerminateCurrentContractLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksTerminateCurrentContractLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksTerminateCurrentContractLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksTerminateCurrentContractLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksTerminateCurrentContractLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksTerminateCurrentContractLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksTerminateCurrentContractLink>() {
           @Override
           public void write(JsonWriter out, LinksTerminateCurrentContractLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksTerminateCurrentContractLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksTerminateCurrentContractLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksTerminateCurrentContractLink
   * @throws IOException if the JSON string is invalid with respect to LinksTerminateCurrentContractLink
   */
  public static LinksTerminateCurrentContractLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksTerminateCurrentContractLink.class);
  }

  /**
   * Convert an instance of LinksTerminateCurrentContractLink to an JSON string
   *
   * @return JSON string
   */
