...
public class LinksGetTrackingStatusLink {
  ...
  public LinksGetTrackingStatusLink() {
  }

  public LinksGetTrackingStatusLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetTrackingStatusLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetTrackingStatusLink description(String description) {
  ...
  public LinksGetTrackingStatusLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetTrackingStatusLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetTrackingStatusLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetTrackingStatusLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetTrackingStatusLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetTrackingStatusLink operationId(String operationId) {
  ...
  public LinksGetTrackingStatusLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetTrackingStatusLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetTrackingStatusLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetTrackingStatusLink linksGetTrackingStatusLink = (LinksGetTrackingStatusLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetTrackingStatusLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetTrackingStatusLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetTrackingStatusLink.description) &&
        Objects.equals(this.docUrl, linksGetTrackingStatusLink.docUrl) &&
        Objects.equals(this.href, linksGetTrackingStatusLink.href) &&
        Objects.equals(this.info, linksGetTrackingStatusLink.info) &&
        Objects.equals(this.label, linksGetTrackingStatusLink.label) &&
        Objects.equals(this.method, linksGetTrackingStatusLink.method) &&
        Objects.equals(this.operationId, linksGetTrackingStatusLink.operationId) &&
        Objects.equals(this.parameters, linksGetTrackingStatusLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetTrackingStatusLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetTrackingStatusLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetTrackingStatusLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetTrackingStatusLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetTrackingStatusLink is not found in the empty JSON string", LinksGetTrackingStatusLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetTrackingStatusLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetTrackingStatusLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetTrackingStatusLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetTrackingStatusLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetTrackingStatusLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetTrackingStatusLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetTrackingStatusLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetTrackingStatusLink>() {
           @Override
           public void write(JsonWriter out, LinksGetTrackingStatusLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetTrackingStatusLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetTrackingStatusLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetTrackingStatusLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetTrackingStatusLink
   */
  public static LinksGetTrackingStatusLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetTrackingStatusLink.class);
  }

  /**
   * Convert an instance of LinksGetTrackingStatusLink to an JSON string
   *
   * @return JSON string
   */
