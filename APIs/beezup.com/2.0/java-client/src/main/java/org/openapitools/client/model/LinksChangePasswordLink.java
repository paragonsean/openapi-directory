...
public class LinksChangePasswordLink {
  ...
  public LinksChangePasswordLink() {
  }
  ...
  public LinksChangePasswordLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksChangePasswordLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksChangePasswordLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksChangePasswordLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksChangePasswordLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksChangePasswordLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksChangePasswordLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksChangePasswordLink is not found in the empty JSON string", LinksChangePasswordLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksChangePasswordLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksChangePasswordLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksChangePasswordLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksChangePasswordLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksChangePasswordLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksChangePasswordLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksChangePasswordLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksChangePasswordLink>() {
           @Override
           public void write(JsonWriter out, LinksChangePasswordLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksChangePasswordLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksChangePasswordLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksChangePasswordLink
   * @throws IOException if the JSON string is invalid with respect to LinksChangePasswordLink
   */
  public static LinksChangePasswordLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksChangePasswordLink.class);
  }

  /**
   * Convert an instance of LinksChangePasswordLink to an JSON string
   *
   * @return JSON string
   */
