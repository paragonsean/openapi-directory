...
public class LinksCreateRuleLink {
  ...
  public LinksCreateRuleLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCreateRuleLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCreateRuleLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksCreateRuleLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksCreateRuleLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCreateRuleLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCreateRuleLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCreateRuleLink is not found in the empty JSON string", LinksCreateRuleLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCreateRuleLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCreateRuleLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCreateRuleLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCreateRuleLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCreateRuleLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCreateRuleLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCreateRuleLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCreateRuleLink>() {
           @Override
           public void write(JsonWriter out, LinksCreateRuleLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCreateRuleLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCreateRuleLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCreateRuleLink
   * @throws IOException if the JSON string is invalid with respect to LinksCreateRuleLink
   */
  public static LinksCreateRuleLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCreateRuleLink.class);
  }

  /**
   * Convert an instance of LinksCreateRuleLink to an JSON string
   *
   * @return JSON string
   */
