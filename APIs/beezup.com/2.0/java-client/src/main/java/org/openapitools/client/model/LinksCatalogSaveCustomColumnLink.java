...
public class LinksCatalogSaveCustomColumnLink {
  ...
  public LinksCatalogSaveCustomColumnLink() {
  }

  public LinksCatalogSaveCustomColumnLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksCatalogSaveCustomColumnLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksCatalogSaveCustomColumnLink description(String description) {
  ...
  public LinksCatalogSaveCustomColumnLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCatalogSaveCustomColumnLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCatalogSaveCustomColumnLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksCatalogSaveCustomColumnLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksCatalogSaveCustomColumnLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksCatalogSaveCustomColumnLink operationId(String operationId) {
  ...
  public LinksCatalogSaveCustomColumnLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksCatalogSaveCustomColumnLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksCatalogSaveCustomColumnLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksCatalogSaveCustomColumnLink linksCatalogSaveCustomColumnLink = (LinksCatalogSaveCustomColumnLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksCatalogSaveCustomColumnLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksCatalogSaveCustomColumnLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksCatalogSaveCustomColumnLink.description) &&
        Objects.equals(this.docUrl, linksCatalogSaveCustomColumnLink.docUrl) &&
        Objects.equals(this.href, linksCatalogSaveCustomColumnLink.href) &&
        Objects.equals(this.info, linksCatalogSaveCustomColumnLink.info) &&
        Objects.equals(this.label, linksCatalogSaveCustomColumnLink.label) &&
        Objects.equals(this.method, linksCatalogSaveCustomColumnLink.method) &&
        Objects.equals(this.operationId, linksCatalogSaveCustomColumnLink.operationId) &&
        Objects.equals(this.parameters, linksCatalogSaveCustomColumnLink.parameters) &&
        Objects.equals(this.urlTemplated, linksCatalogSaveCustomColumnLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksCatalogSaveCustomColumnLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCatalogSaveCustomColumnLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCatalogSaveCustomColumnLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCatalogSaveCustomColumnLink is not found in the empty JSON string", LinksCatalogSaveCustomColumnLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCatalogSaveCustomColumnLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCatalogSaveCustomColumnLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCatalogSaveCustomColumnLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCatalogSaveCustomColumnLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCatalogSaveCustomColumnLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCatalogSaveCustomColumnLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCatalogSaveCustomColumnLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCatalogSaveCustomColumnLink>() {
           @Override
           public void write(JsonWriter out, LinksCatalogSaveCustomColumnLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCatalogSaveCustomColumnLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCatalogSaveCustomColumnLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCatalogSaveCustomColumnLink
   * @throws IOException if the JSON string is invalid with respect to LinksCatalogSaveCustomColumnLink
   */
  public static LinksCatalogSaveCustomColumnLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCatalogSaveCustomColumnLink.class);
  }

  /**
   * Convert an instance of LinksCatalogSaveCustomColumnLink to an JSON string
   *
   * @return JSON string
   */
