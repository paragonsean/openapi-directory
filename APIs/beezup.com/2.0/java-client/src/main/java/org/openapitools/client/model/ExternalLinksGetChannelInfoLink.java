...
public class ExternalLinksGetChannelInfoLink {
  ...
  public ExternalLinksGetChannelInfoLink() {
  }

  public ExternalLinksGetChannelInfoLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public ExternalLinksGetChannelInfoLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public ExternalLinksGetChannelInfoLink description(String description) {
  ...
  public ExternalLinksGetChannelInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public ExternalLinksGetChannelInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public ExternalLinksGetChannelInfoLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public ExternalLinksGetChannelInfoLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public ExternalLinksGetChannelInfoLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public ExternalLinksGetChannelInfoLink operationId(String operationId) {
  ...
  public ExternalLinksGetChannelInfoLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public ExternalLinksGetChannelInfoLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public ExternalLinksGetChannelInfoLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    ExternalLinksGetChannelInfoLink externalLinksGetChannelInfoLink = (ExternalLinksGetChannelInfoLink) o;
    return Objects.equals(this.allOptionalParamsProvided, externalLinksGetChannelInfoLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, externalLinksGetChannelInfoLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, externalLinksGetChannelInfoLink.description) &&
        Objects.equals(this.docUrl, externalLinksGetChannelInfoLink.docUrl) &&
        Objects.equals(this.href, externalLinksGetChannelInfoLink.href) &&
        Objects.equals(this.info, externalLinksGetChannelInfoLink.info) &&
        Objects.equals(this.label, externalLinksGetChannelInfoLink.label) &&
        Objects.equals(this.method, externalLinksGetChannelInfoLink.method) &&
        Objects.equals(this.operationId, externalLinksGetChannelInfoLink.operationId) &&
        Objects.equals(this.parameters, externalLinksGetChannelInfoLink.parameters) &&
        Objects.equals(this.urlTemplated, externalLinksGetChannelInfoLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExternalLinksGetChannelInfoLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExternalLinksGetChannelInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExternalLinksGetChannelInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExternalLinksGetChannelInfoLink is not found in the empty JSON string", ExternalLinksGetChannelInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExternalLinksGetChannelInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExternalLinksGetChannelInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExternalLinksGetChannelInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExternalLinksGetChannelInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExternalLinksGetChannelInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExternalLinksGetChannelInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExternalLinksGetChannelInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<ExternalLinksGetChannelInfoLink>() {
           @Override
           public void write(JsonWriter out, ExternalLinksGetChannelInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExternalLinksGetChannelInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExternalLinksGetChannelInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExternalLinksGetChannelInfoLink
   * @throws IOException if the JSON string is invalid with respect to ExternalLinksGetChannelInfoLink
   */
  public static ExternalLinksGetChannelInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExternalLinksGetChannelInfoLink.class);
  }

  /**
   * Convert an instance of ExternalLinksGetChannelInfoLink to an JSON string
   *
   * @return JSON string
   */
