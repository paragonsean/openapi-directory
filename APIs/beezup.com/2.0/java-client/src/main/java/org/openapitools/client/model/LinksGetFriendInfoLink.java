...
public class LinksGetFriendInfoLink {
  ...
  public LinksGetFriendInfoLink() {
  }

  public LinksGetFriendInfoLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetFriendInfoLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetFriendInfoLink description(String description) {
  ...
  public LinksGetFriendInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetFriendInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetFriendInfoLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetFriendInfoLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetFriendInfoLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetFriendInfoLink operationId(String operationId) {
  ...
  public LinksGetFriendInfoLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetFriendInfoLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetFriendInfoLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetFriendInfoLink linksGetFriendInfoLink = (LinksGetFriendInfoLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetFriendInfoLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetFriendInfoLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetFriendInfoLink.description) &&
        Objects.equals(this.docUrl, linksGetFriendInfoLink.docUrl) &&
        Objects.equals(this.href, linksGetFriendInfoLink.href) &&
        Objects.equals(this.info, linksGetFriendInfoLink.info) &&
        Objects.equals(this.label, linksGetFriendInfoLink.label) &&
        Objects.equals(this.method, linksGetFriendInfoLink.method) &&
        Objects.equals(this.operationId, linksGetFriendInfoLink.operationId) &&
        Objects.equals(this.parameters, linksGetFriendInfoLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetFriendInfoLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetFriendInfoLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetFriendInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetFriendInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetFriendInfoLink is not found in the empty JSON string", LinksGetFriendInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetFriendInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetFriendInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetFriendInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetFriendInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetFriendInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetFriendInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetFriendInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetFriendInfoLink>() {
           @Override
           public void write(JsonWriter out, LinksGetFriendInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetFriendInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetFriendInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetFriendInfoLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetFriendInfoLink
   */
  public static LinksGetFriendInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetFriendInfoLink.class);
  }

  /**
   * Convert an instance of LinksGetFriendInfoLink to an JSON string
   *
   * @return JSON string
   */
