...
public class LinksGetStoreTrackingStatusLink {
  ...
  public LinksGetStoreTrackingStatusLink() {
  }

  public LinksGetStoreTrackingStatusLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetStoreTrackingStatusLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetStoreTrackingStatusLink description(String description) {
  ...
  public LinksGetStoreTrackingStatusLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetStoreTrackingStatusLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetStoreTrackingStatusLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetStoreTrackingStatusLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetStoreTrackingStatusLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetStoreTrackingStatusLink operationId(String operationId) {
  ...
  public LinksGetStoreTrackingStatusLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetStoreTrackingStatusLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetStoreTrackingStatusLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetStoreTrackingStatusLink linksGetStoreTrackingStatusLink = (LinksGetStoreTrackingStatusLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetStoreTrackingStatusLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetStoreTrackingStatusLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetStoreTrackingStatusLink.description) &&
        Objects.equals(this.docUrl, linksGetStoreTrackingStatusLink.docUrl) &&
        Objects.equals(this.href, linksGetStoreTrackingStatusLink.href) &&
        Objects.equals(this.info, linksGetStoreTrackingStatusLink.info) &&
        Objects.equals(this.label, linksGetStoreTrackingStatusLink.label) &&
        Objects.equals(this.method, linksGetStoreTrackingStatusLink.method) &&
        Objects.equals(this.operationId, linksGetStoreTrackingStatusLink.operationId) &&
        Objects.equals(this.parameters, linksGetStoreTrackingStatusLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetStoreTrackingStatusLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetStoreTrackingStatusLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetStoreTrackingStatusLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetStoreTrackingStatusLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetStoreTrackingStatusLink is not found in the empty JSON string", LinksGetStoreTrackingStatusLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetStoreTrackingStatusLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetStoreTrackingStatusLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetStoreTrackingStatusLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetStoreTrackingStatusLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetStoreTrackingStatusLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetStoreTrackingStatusLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetStoreTrackingStatusLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetStoreTrackingStatusLink>() {
           @Override
           public void write(JsonWriter out, LinksGetStoreTrackingStatusLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetStoreTrackingStatusLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetStoreTrackingStatusLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetStoreTrackingStatusLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetStoreTrackingStatusLink
   */
  public static LinksGetStoreTrackingStatusLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetStoreTrackingStatusLink.class);
  }

  /**
   * Convert an instance of LinksGetStoreTrackingStatusLink to an JSON string
   *
   * @return JSON string
   */
