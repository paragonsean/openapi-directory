...
public class LinksAutoScheduleAutoImportLink {
  ...
  public LinksAutoScheduleAutoImportLink() {
  }

  public LinksAutoScheduleAutoImportLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksAutoScheduleAutoImportLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksAutoScheduleAutoImportLink description(String description) {
  ...
  public LinksAutoScheduleAutoImportLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksAutoScheduleAutoImportLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksAutoScheduleAutoImportLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksAutoScheduleAutoImportLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksAutoScheduleAutoImportLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksAutoScheduleAutoImportLink operationId(String operationId) {
  ...
  public LinksAutoScheduleAutoImportLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksAutoScheduleAutoImportLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksAutoScheduleAutoImportLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksAutoScheduleAutoImportLink linksAutoScheduleAutoImportLink = (LinksAutoScheduleAutoImportLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksAutoScheduleAutoImportLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksAutoScheduleAutoImportLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksAutoScheduleAutoImportLink.description) &&
        Objects.equals(this.docUrl, linksAutoScheduleAutoImportLink.docUrl) &&
        Objects.equals(this.href, linksAutoScheduleAutoImportLink.href) &&
        Objects.equals(this.info, linksAutoScheduleAutoImportLink.info) &&
        Objects.equals(this.label, linksAutoScheduleAutoImportLink.label) &&
        Objects.equals(this.method, linksAutoScheduleAutoImportLink.method) &&
        Objects.equals(this.operationId, linksAutoScheduleAutoImportLink.operationId) &&
        Objects.equals(this.parameters, linksAutoScheduleAutoImportLink.parameters) &&
        Objects.equals(this.urlTemplated, linksAutoScheduleAutoImportLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksAutoScheduleAutoImportLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksAutoScheduleAutoImportLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksAutoScheduleAutoImportLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksAutoScheduleAutoImportLink is not found in the empty JSON string", LinksAutoScheduleAutoImportLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksAutoScheduleAutoImportLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksAutoScheduleAutoImportLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksAutoScheduleAutoImportLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksAutoScheduleAutoImportLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksAutoScheduleAutoImportLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksAutoScheduleAutoImportLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksAutoScheduleAutoImportLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksAutoScheduleAutoImportLink>() {
           @Override
           public void write(JsonWriter out, LinksAutoScheduleAutoImportLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksAutoScheduleAutoImportLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksAutoScheduleAutoImportLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksAutoScheduleAutoImportLink
   * @throws IOException if the JSON string is invalid with respect to LinksAutoScheduleAutoImportLink
   */
  public static LinksAutoScheduleAutoImportLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksAutoScheduleAutoImportLink.class);
  }

  /**
   * Convert an instance of LinksAutoScheduleAutoImportLink to an JSON string
   *
   * @return JSON string
   */
