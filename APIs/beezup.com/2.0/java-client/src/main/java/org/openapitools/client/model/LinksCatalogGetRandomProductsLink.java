...
public class LinksCatalogGetRandomProductsLink {
  ...
  public LinksCatalogGetRandomProductsLink() {
  }

  public LinksCatalogGetRandomProductsLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksCatalogGetRandomProductsLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksCatalogGetRandomProductsLink description(String description) {
  ...
  public LinksCatalogGetRandomProductsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCatalogGetRandomProductsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCatalogGetRandomProductsLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksCatalogGetRandomProductsLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksCatalogGetRandomProductsLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksCatalogGetRandomProductsLink operationId(String operationId) {
  ...
  public LinksCatalogGetRandomProductsLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksCatalogGetRandomProductsLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksCatalogGetRandomProductsLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksCatalogGetRandomProductsLink linksCatalogGetRandomProductsLink = (LinksCatalogGetRandomProductsLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksCatalogGetRandomProductsLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksCatalogGetRandomProductsLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksCatalogGetRandomProductsLink.description) &&
        Objects.equals(this.docUrl, linksCatalogGetRandomProductsLink.docUrl) &&
        Objects.equals(this.href, linksCatalogGetRandomProductsLink.href) &&
        Objects.equals(this.info, linksCatalogGetRandomProductsLink.info) &&
        Objects.equals(this.label, linksCatalogGetRandomProductsLink.label) &&
        Objects.equals(this.method, linksCatalogGetRandomProductsLink.method) &&
        Objects.equals(this.operationId, linksCatalogGetRandomProductsLink.operationId) &&
        Objects.equals(this.parameters, linksCatalogGetRandomProductsLink.parameters) &&
        Objects.equals(this.urlTemplated, linksCatalogGetRandomProductsLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksCatalogGetRandomProductsLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCatalogGetRandomProductsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCatalogGetRandomProductsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCatalogGetRandomProductsLink is not found in the empty JSON string", LinksCatalogGetRandomProductsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCatalogGetRandomProductsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCatalogGetRandomProductsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCatalogGetRandomProductsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCatalogGetRandomProductsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCatalogGetRandomProductsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCatalogGetRandomProductsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCatalogGetRandomProductsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCatalogGetRandomProductsLink>() {
           @Override
           public void write(JsonWriter out, LinksCatalogGetRandomProductsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCatalogGetRandomProductsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCatalogGetRandomProductsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCatalogGetRandomProductsLink
   * @throws IOException if the JSON string is invalid with respect to LinksCatalogGetRandomProductsLink
   */
  public static LinksCatalogGetRandomProductsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCatalogGetRandomProductsLink.class);
  }

  /**
   * Convert an instance of LinksCatalogGetRandomProductsLink to an JSON string
   *
   * @return JSON string
   */
