...
public class LinksCatalogGetProductsLink {
  ...
  public LinksCatalogGetProductsLink() {
  }

  public LinksCatalogGetProductsLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksCatalogGetProductsLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksCatalogGetProductsLink description(String description) {
  ...
  public LinksCatalogGetProductsLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCatalogGetProductsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCatalogGetProductsLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksCatalogGetProductsLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksCatalogGetProductsLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksCatalogGetProductsLink operationId(String operationId) {
  ...
  public LinksCatalogGetProductsLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksCatalogGetProductsLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksCatalogGetProductsLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksCatalogGetProductsLink linksCatalogGetProductsLink = (LinksCatalogGetProductsLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksCatalogGetProductsLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksCatalogGetProductsLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksCatalogGetProductsLink.description) &&
        Objects.equals(this.docUrl, linksCatalogGetProductsLink.docUrl) &&
        Objects.equals(this.href, linksCatalogGetProductsLink.href) &&
        Objects.equals(this.info, linksCatalogGetProductsLink.info) &&
        Objects.equals(this.label, linksCatalogGetProductsLink.label) &&
        Objects.equals(this.method, linksCatalogGetProductsLink.method) &&
        Objects.equals(this.operationId, linksCatalogGetProductsLink.operationId) &&
        Objects.equals(this.parameters, linksCatalogGetProductsLink.parameters) &&
        Objects.equals(this.urlTemplated, linksCatalogGetProductsLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksCatalogGetProductsLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCatalogGetProductsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCatalogGetProductsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCatalogGetProductsLink is not found in the empty JSON string", LinksCatalogGetProductsLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCatalogGetProductsLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCatalogGetProductsLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCatalogGetProductsLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCatalogGetProductsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCatalogGetProductsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCatalogGetProductsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCatalogGetProductsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCatalogGetProductsLink>() {
           @Override
           public void write(JsonWriter out, LinksCatalogGetProductsLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCatalogGetProductsLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCatalogGetProductsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCatalogGetProductsLink
   * @throws IOException if the JSON string is invalid with respect to LinksCatalogGetProductsLink
   */
  public static LinksCatalogGetProductsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCatalogGetProductsLink.class);
  }

  /**
   * Convert an instance of LinksCatalogGetProductsLink to an JSON string
   *
   * @return JSON string
   */
