...
public class LinksDisableChannelCatalogProductLink {
  ...
  public LinksDisableChannelCatalogProductLink() {
  }

  public LinksDisableChannelCatalogProductLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksDisableChannelCatalogProductLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksDisableChannelCatalogProductLink description(String description) {
  ...
  public LinksDisableChannelCatalogProductLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksDisableChannelCatalogProductLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksDisableChannelCatalogProductLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksDisableChannelCatalogProductLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksDisableChannelCatalogProductLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksDisableChannelCatalogProductLink operationId(String operationId) {
  ...
  public LinksDisableChannelCatalogProductLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksDisableChannelCatalogProductLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksDisableChannelCatalogProductLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksDisableChannelCatalogProductLink linksDisableChannelCatalogProductLink = (LinksDisableChannelCatalogProductLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksDisableChannelCatalogProductLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksDisableChannelCatalogProductLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksDisableChannelCatalogProductLink.description) &&
        Objects.equals(this.docUrl, linksDisableChannelCatalogProductLink.docUrl) &&
        Objects.equals(this.href, linksDisableChannelCatalogProductLink.href) &&
        Objects.equals(this.info, linksDisableChannelCatalogProductLink.info) &&
        Objects.equals(this.label, linksDisableChannelCatalogProductLink.label) &&
        Objects.equals(this.method, linksDisableChannelCatalogProductLink.method) &&
        Objects.equals(this.operationId, linksDisableChannelCatalogProductLink.operationId) &&
        Objects.equals(this.parameters, linksDisableChannelCatalogProductLink.parameters) &&
        Objects.equals(this.urlTemplated, linksDisableChannelCatalogProductLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksDisableChannelCatalogProductLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksDisableChannelCatalogProductLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksDisableChannelCatalogProductLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksDisableChannelCatalogProductLink is not found in the empty JSON string", LinksDisableChannelCatalogProductLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksDisableChannelCatalogProductLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksDisableChannelCatalogProductLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksDisableChannelCatalogProductLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksDisableChannelCatalogProductLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksDisableChannelCatalogProductLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksDisableChannelCatalogProductLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksDisableChannelCatalogProductLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksDisableChannelCatalogProductLink>() {
           @Override
           public void write(JsonWriter out, LinksDisableChannelCatalogProductLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksDisableChannelCatalogProductLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksDisableChannelCatalogProductLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksDisableChannelCatalogProductLink
   * @throws IOException if the JSON string is invalid with respect to LinksDisableChannelCatalogProductLink
   */
  public static LinksDisableChannelCatalogProductLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksDisableChannelCatalogProductLink.class);
  }

  /**
   * Convert an instance of LinksDisableChannelCatalogProductLink to an JSON string
   *
   * @return JSON string
   */
