...
public class LinksOptimiseByChannelLink {
  ...
  public LinksOptimiseByChannelLink() {
  }
  ...
  public LinksOptimiseByChannelLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksOptimiseByChannelLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksOptimiseByChannelLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksOptimiseByChannelLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksOptimiseByChannelLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksOptimiseByChannelLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksOptimiseByChannelLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksOptimiseByChannelLink is not found in the empty JSON string", LinksOptimiseByChannelLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksOptimiseByChannelLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksOptimiseByChannelLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksOptimiseByChannelLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksOptimiseByChannelLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksOptimiseByChannelLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksOptimiseByChannelLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksOptimiseByChannelLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksOptimiseByChannelLink>() {
           @Override
           public void write(JsonWriter out, LinksOptimiseByChannelLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksOptimiseByChannelLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksOptimiseByChannelLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksOptimiseByChannelLink
   * @throws IOException if the JSON string is invalid with respect to LinksOptimiseByChannelLink
   */
  public static LinksOptimiseByChannelLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksOptimiseByChannelLink.class);
  }

  /**
   * Convert an instance of LinksOptimiseByChannelLink to an JSON string
   *
   * @return JSON string
   */
