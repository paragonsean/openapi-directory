...
public class ContractClickInfo {
  ...
  public static final String SERIALIZED_NAME_INITIAL_OFFER_CLICK_INCLUDED = "initialOfferClickIncluded";
  @SerializedName(SERIALIZED_NAME_INITIAL_OFFER_CLICK_INCLUDED)
  private Integer initialOfferClickIncluded;
  ...
  static {
    ...
    openapiFields.add("initialOfferClickIncluded");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContractClickInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContractClickInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContractClickInfo is not found in the empty JSON string", ContractClickInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContractClickInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContractClickInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContractClickInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContractClickInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContractClickInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContractClickInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<ContractClickInfo>() {
           @Override
           public void write(JsonWriter out, ContractClickInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContractClickInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContractClickInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContractClickInfo
   * @throws IOException if the JSON string is invalid with respect to ContractClickInfo
   */
  public static ContractClickInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContractClickInfo.class);
  }

  /**
   * Convert an instance of ContractClickInfo to an JSON string
   *
   * @return JSON string
   */
