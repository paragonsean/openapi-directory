...
public class LinksGetChannelCatalogProductInfoLink {
  ...
  public LinksGetChannelCatalogProductInfoLink() {
  }
  ...
  public LinksGetChannelCatalogProductInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetChannelCatalogProductInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetChannelCatalogProductInfoLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetChannelCatalogProductInfoLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetChannelCatalogProductInfoLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetChannelCatalogProductInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetChannelCatalogProductInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetChannelCatalogProductInfoLink is not found in the empty JSON string", LinksGetChannelCatalogProductInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetChannelCatalogProductInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetChannelCatalogProductInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetChannelCatalogProductInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetChannelCatalogProductInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetChannelCatalogProductInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetChannelCatalogProductInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetChannelCatalogProductInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetChannelCatalogProductInfoLink>() {
           @Override
           public void write(JsonWriter out, LinksGetChannelCatalogProductInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetChannelCatalogProductInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetChannelCatalogProductInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetChannelCatalogProductInfoLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetChannelCatalogProductInfoLink
   */
  public static LinksGetChannelCatalogProductInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetChannelCatalogProductInfoLink.class);
  }

  /**
   * Convert an instance of LinksGetChannelCatalogProductInfoLink to an JSON string
   *
   * @return JSON string
   */
