...
public class LinksClearMerchantOrderInfoLink {
  ...
  public LinksClearMerchantOrderInfoLink() {
  }
  ...
  public LinksClearMerchantOrderInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksClearMerchantOrderInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksClearMerchantOrderInfoLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksClearMerchantOrderInfoLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksClearMerchantOrderInfoLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksClearMerchantOrderInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksClearMerchantOrderInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksClearMerchantOrderInfoLink is not found in the empty JSON string", LinksClearMerchantOrderInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksClearMerchantOrderInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksClearMerchantOrderInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksClearMerchantOrderInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksClearMerchantOrderInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksClearMerchantOrderInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksClearMerchantOrderInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksClearMerchantOrderInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksClearMerchantOrderInfoLink>() {
           @Override
           public void write(JsonWriter out, LinksClearMerchantOrderInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksClearMerchantOrderInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksClearMerchantOrderInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksClearMerchantOrderInfoLink
   * @throws IOException if the JSON string is invalid with respect to LinksClearMerchantOrderInfoLink
   */
  public static LinksClearMerchantOrderInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksClearMerchantOrderInfoLink.class);
  }

  /**
   * Convert an instance of LinksClearMerchantOrderInfoLink to an JSON string
   *
   * @return JSON string
   */
