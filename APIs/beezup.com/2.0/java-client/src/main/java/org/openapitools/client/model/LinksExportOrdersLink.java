...
public class LinksExportOrdersLink {
  ...
  public LinksExportOrdersLink() {
  }

  public LinksExportOrdersLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksExportOrdersLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksExportOrdersLink description(String description) {
  ...
  public LinksExportOrdersLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksExportOrdersLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksExportOrdersLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksExportOrdersLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksExportOrdersLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksExportOrdersLink operationId(String operationId) {
  ...
  public LinksExportOrdersLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksExportOrdersLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksExportOrdersLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksExportOrdersLink linksExportOrdersLink = (LinksExportOrdersLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksExportOrdersLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksExportOrdersLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksExportOrdersLink.description) &&
        Objects.equals(this.docUrl, linksExportOrdersLink.docUrl) &&
        Objects.equals(this.href, linksExportOrdersLink.href) &&
        Objects.equals(this.info, linksExportOrdersLink.info) &&
        Objects.equals(this.label, linksExportOrdersLink.label) &&
        Objects.equals(this.method, linksExportOrdersLink.method) &&
        Objects.equals(this.operationId, linksExportOrdersLink.operationId) &&
        Objects.equals(this.parameters, linksExportOrdersLink.parameters) &&
        Objects.equals(this.urlTemplated, linksExportOrdersLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksExportOrdersLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksExportOrdersLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksExportOrdersLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksExportOrdersLink is not found in the empty JSON string", LinksExportOrdersLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksExportOrdersLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksExportOrdersLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksExportOrdersLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksExportOrdersLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksExportOrdersLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksExportOrdersLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksExportOrdersLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksExportOrdersLink>() {
           @Override
           public void write(JsonWriter out, LinksExportOrdersLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksExportOrdersLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksExportOrdersLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksExportOrdersLink
   * @throws IOException if the JSON string is invalid with respect to LinksExportOrdersLink
   */
  public static LinksExportOrdersLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksExportOrdersLink.class);
  }

  /**
   * Convert an instance of LinksExportOrdersLink to an JSON string
   *
   * @return JSON string
   */
