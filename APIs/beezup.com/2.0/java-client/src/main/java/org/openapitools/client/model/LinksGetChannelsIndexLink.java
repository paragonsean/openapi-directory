...
public class LinksGetChannelsIndexLink {
  ...
  public LinksGetChannelsIndexLink() {
  }
  ...
  public LinksGetChannelsIndexLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetChannelsIndexLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetChannelsIndexLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetChannelsIndexLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetChannelsIndexLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetChannelsIndexLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetChannelsIndexLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetChannelsIndexLink is not found in the empty JSON string", LinksGetChannelsIndexLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetChannelsIndexLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetChannelsIndexLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetChannelsIndexLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetChannelsIndexLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetChannelsIndexLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetChannelsIndexLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetChannelsIndexLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetChannelsIndexLink>() {
           @Override
           public void write(JsonWriter out, LinksGetChannelsIndexLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetChannelsIndexLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetChannelsIndexLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetChannelsIndexLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetChannelsIndexLink
   */
  public static LinksGetChannelsIndexLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetChannelsIndexLink.class);
  }

  /**
   * Convert an instance of LinksGetChannelsIndexLink to an JSON string
   *
   * @return JSON string
   */
