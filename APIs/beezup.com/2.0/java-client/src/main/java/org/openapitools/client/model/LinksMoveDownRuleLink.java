...
public class LinksMoveDownRuleLink {
  ...
  public LinksMoveDownRuleLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksMoveDownRuleLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksMoveDownRuleLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksMoveDownRuleLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksMoveDownRuleLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksMoveDownRuleLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksMoveDownRuleLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksMoveDownRuleLink is not found in the empty JSON string", LinksMoveDownRuleLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksMoveDownRuleLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksMoveDownRuleLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksMoveDownRuleLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksMoveDownRuleLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksMoveDownRuleLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksMoveDownRuleLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksMoveDownRuleLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksMoveDownRuleLink>() {
           @Override
           public void write(JsonWriter out, LinksMoveDownRuleLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksMoveDownRuleLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksMoveDownRuleLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksMoveDownRuleLink
   * @throws IOException if the JSON string is invalid with respect to LinksMoveDownRuleLink
   */
  public static LinksMoveDownRuleLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksMoveDownRuleLink.class);
  }

  /**
   * Convert an instance of LinksMoveDownRuleLink to an JSON string
   *
   * @return JSON string
   */
