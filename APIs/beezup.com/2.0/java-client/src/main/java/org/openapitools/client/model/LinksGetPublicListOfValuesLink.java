...
public class LinksGetPublicListOfValuesLink {
  ...
  public LinksGetPublicListOfValuesLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetPublicListOfValuesLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetPublicListOfValuesLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetPublicListOfValuesLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetPublicListOfValuesLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetPublicListOfValuesLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetPublicListOfValuesLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetPublicListOfValuesLink is not found in the empty JSON string", LinksGetPublicListOfValuesLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetPublicListOfValuesLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetPublicListOfValuesLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetPublicListOfValuesLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetPublicListOfValuesLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetPublicListOfValuesLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetPublicListOfValuesLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetPublicListOfValuesLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetPublicListOfValuesLink>() {
           @Override
           public void write(JsonWriter out, LinksGetPublicListOfValuesLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetPublicListOfValuesLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetPublicListOfValuesLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetPublicListOfValuesLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetPublicListOfValuesLink
   */
  public static LinksGetPublicListOfValuesLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetPublicListOfValuesLink.class);
  }

  /**
   * Convert an instance of LinksGetPublicListOfValuesLink to an JSON string
   *
   * @return JSON string
   */
