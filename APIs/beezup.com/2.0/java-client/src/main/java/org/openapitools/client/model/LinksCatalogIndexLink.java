...
public class LinksCatalogIndexLink {
  ...
  public LinksCatalogIndexLink() {
  }

  public LinksCatalogIndexLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksCatalogIndexLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksCatalogIndexLink description(String description) {
  ...
  public LinksCatalogIndexLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksCatalogIndexLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksCatalogIndexLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksCatalogIndexLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksCatalogIndexLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksCatalogIndexLink operationId(String operationId) {
  ...
  public LinksCatalogIndexLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksCatalogIndexLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksCatalogIndexLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksCatalogIndexLink linksCatalogIndexLink = (LinksCatalogIndexLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksCatalogIndexLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksCatalogIndexLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksCatalogIndexLink.description) &&
        Objects.equals(this.docUrl, linksCatalogIndexLink.docUrl) &&
        Objects.equals(this.href, linksCatalogIndexLink.href) &&
        Objects.equals(this.info, linksCatalogIndexLink.info) &&
        Objects.equals(this.label, linksCatalogIndexLink.label) &&
        Objects.equals(this.method, linksCatalogIndexLink.method) &&
        Objects.equals(this.operationId, linksCatalogIndexLink.operationId) &&
        Objects.equals(this.parameters, linksCatalogIndexLink.parameters) &&
        Objects.equals(this.urlTemplated, linksCatalogIndexLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksCatalogIndexLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksCatalogIndexLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksCatalogIndexLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksCatalogIndexLink is not found in the empty JSON string", LinksCatalogIndexLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksCatalogIndexLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksCatalogIndexLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksCatalogIndexLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksCatalogIndexLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksCatalogIndexLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksCatalogIndexLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksCatalogIndexLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksCatalogIndexLink>() {
           @Override
           public void write(JsonWriter out, LinksCatalogIndexLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksCatalogIndexLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksCatalogIndexLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksCatalogIndexLink
   * @throws IOException if the JSON string is invalid with respect to LinksCatalogIndexLink
   */
  public static LinksCatalogIndexLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksCatalogIndexLink.class);
  }

  /**
   * Convert an instance of LinksCatalogIndexLink to an JSON string
   *
   * @return JSON string
   */
