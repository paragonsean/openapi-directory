...
public class LinksDeleteReportFilterLink {
  ...
  public LinksDeleteReportFilterLink() {
  }
  ...
  public LinksDeleteReportFilterLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksDeleteReportFilterLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksDeleteReportFilterLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksDeleteReportFilterLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksDeleteReportFilterLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksDeleteReportFilterLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksDeleteReportFilterLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksDeleteReportFilterLink is not found in the empty JSON string", LinksDeleteReportFilterLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksDeleteReportFilterLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksDeleteReportFilterLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksDeleteReportFilterLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksDeleteReportFilterLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksDeleteReportFilterLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksDeleteReportFilterLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksDeleteReportFilterLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksDeleteReportFilterLink>() {
           @Override
           public void write(JsonWriter out, LinksDeleteReportFilterLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksDeleteReportFilterLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksDeleteReportFilterLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksDeleteReportFilterLink
   * @throws IOException if the JSON string is invalid with respect to LinksDeleteReportFilterLink
   */
  public static LinksDeleteReportFilterLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksDeleteReportFilterLink.class);
  }

  /**
   * Convert an instance of LinksDeleteReportFilterLink to an JSON string
   *
   * @return JSON string
   */
