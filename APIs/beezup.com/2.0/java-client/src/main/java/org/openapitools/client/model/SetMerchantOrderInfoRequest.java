...
public class SetMerchantOrderInfoRequest {
  ...
  public SetMerchantOrderInfoRequest() {
  }

  public SetMerchantOrderInfoRequest orderMerchantECommerceSoftwareName(String orderMerchantECommerceSoftwareName) {
  ...
  public SetMerchantOrderInfoRequest orderMerchantECommerceSoftwareVersion(String orderMerchantECommerceSoftwareVersion) {
  ...
  public SetMerchantOrderInfoRequest orderMerchantOrderId(String orderMerchantOrderId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.orderMerchantECommerceSoftwareName, setMerchantOrderInfoRequest.orderMerchantECommerceSoftwareName) &&
        ...
        Objects.equals(this.orderMerchantOrderId, setMerchantOrderInfoRequest.orderMerchantOrderId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(orderMerchantECommerceSoftwareName, orderMerchantECommerceSoftwareVersion, orderMerchantOrderId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetMerchantOrderInfoRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetMerchantOrderInfoRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetMerchantOrderInfoRequest is not found in the empty JSON string", SetMerchantOrderInfoRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetMerchantOrderInfoRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetMerchantOrderInfoRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetMerchantOrderInfoRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetMerchantOrderInfoRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetMerchantOrderInfoRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetMerchantOrderInfoRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetMerchantOrderInfoRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SetMerchantOrderInfoRequest>() {
           @Override
           public void write(JsonWriter out, SetMerchantOrderInfoRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetMerchantOrderInfoRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetMerchantOrderInfoRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetMerchantOrderInfoRequest
   * @throws IOException if the JSON string is invalid with respect to SetMerchantOrderInfoRequest
   */
  public static SetMerchantOrderInfoRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetMerchantOrderInfoRequest.class);
  }

  /**
   * Convert an instance of SetMerchantOrderInfoRequest to an JSON string
   *
   * @return JSON string
   */
