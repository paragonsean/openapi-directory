...
public class LinksEnableRuleLink {
  ...
  public LinksEnableRuleLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksEnableRuleLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksEnableRuleLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksEnableRuleLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksEnableRuleLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksEnableRuleLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksEnableRuleLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksEnableRuleLink is not found in the empty JSON string", LinksEnableRuleLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksEnableRuleLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksEnableRuleLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksEnableRuleLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksEnableRuleLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksEnableRuleLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksEnableRuleLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksEnableRuleLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksEnableRuleLink>() {
           @Override
           public void write(JsonWriter out, LinksEnableRuleLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksEnableRuleLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksEnableRuleLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksEnableRuleLink
   * @throws IOException if the JSON string is invalid with respect to LinksEnableRuleLink
   */
  public static LinksEnableRuleLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksEnableRuleLink.class);
  }

  /**
   * Convert an instance of LinksEnableRuleLink to an JSON string
   *
   * @return JSON string
   */
