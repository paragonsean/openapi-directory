...
public class LinksGetReportFiltersLink {
  ...
  public LinksGetReportFiltersLink() {
  }
  ...
  public LinksGetReportFiltersLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetReportFiltersLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetReportFiltersLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetReportFiltersLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetReportFiltersLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetReportFiltersLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetReportFiltersLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetReportFiltersLink is not found in the empty JSON string", LinksGetReportFiltersLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetReportFiltersLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetReportFiltersLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetReportFiltersLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetReportFiltersLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetReportFiltersLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetReportFiltersLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetReportFiltersLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetReportFiltersLink>() {
           @Override
           public void write(JsonWriter out, LinksGetReportFiltersLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetReportFiltersLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetReportFiltersLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetReportFiltersLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetReportFiltersLink
   */
  public static LinksGetReportFiltersLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetReportFiltersLink.class);
  }

  /**
   * Convert an instance of LinksGetReportFiltersLink to an JSON string
   *
   * @return JSON string
   */
