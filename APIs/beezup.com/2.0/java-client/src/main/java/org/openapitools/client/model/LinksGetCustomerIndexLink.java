...
public class LinksGetCustomerIndexLink {
  ...
  public LinksGetCustomerIndexLink() {
  }

  public LinksGetCustomerIndexLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksGetCustomerIndexLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksGetCustomerIndexLink description(String description) {
  ...
  public LinksGetCustomerIndexLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetCustomerIndexLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetCustomerIndexLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksGetCustomerIndexLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksGetCustomerIndexLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksGetCustomerIndexLink operationId(String operationId) {
  ...
  public LinksGetCustomerIndexLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksGetCustomerIndexLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksGetCustomerIndexLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksGetCustomerIndexLink linksGetCustomerIndexLink = (LinksGetCustomerIndexLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksGetCustomerIndexLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksGetCustomerIndexLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksGetCustomerIndexLink.description) &&
        Objects.equals(this.docUrl, linksGetCustomerIndexLink.docUrl) &&
        Objects.equals(this.href, linksGetCustomerIndexLink.href) &&
        Objects.equals(this.info, linksGetCustomerIndexLink.info) &&
        Objects.equals(this.label, linksGetCustomerIndexLink.label) &&
        Objects.equals(this.method, linksGetCustomerIndexLink.method) &&
        Objects.equals(this.operationId, linksGetCustomerIndexLink.operationId) &&
        Objects.equals(this.parameters, linksGetCustomerIndexLink.parameters) &&
        Objects.equals(this.urlTemplated, linksGetCustomerIndexLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksGetCustomerIndexLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetCustomerIndexLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetCustomerIndexLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetCustomerIndexLink is not found in the empty JSON string", LinksGetCustomerIndexLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetCustomerIndexLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetCustomerIndexLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetCustomerIndexLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetCustomerIndexLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetCustomerIndexLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetCustomerIndexLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetCustomerIndexLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetCustomerIndexLink>() {
           @Override
           public void write(JsonWriter out, LinksGetCustomerIndexLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetCustomerIndexLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetCustomerIndexLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetCustomerIndexLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetCustomerIndexLink
   */
  public static LinksGetCustomerIndexLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetCustomerIndexLink.class);
  }

  /**
   * Convert an instance of LinksGetCustomerIndexLink to an JSON string
   *
   * @return JSON string
   */
