...
public class LinksGetUserListOfValuesLink {
  ...
  public LinksGetUserListOfValuesLink() {
  }
  ...
  public LinksGetUserListOfValuesLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksGetUserListOfValuesLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksGetUserListOfValuesLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksGetUserListOfValuesLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksGetUserListOfValuesLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksGetUserListOfValuesLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksGetUserListOfValuesLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksGetUserListOfValuesLink is not found in the empty JSON string", LinksGetUserListOfValuesLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksGetUserListOfValuesLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksGetUserListOfValuesLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksGetUserListOfValuesLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksGetUserListOfValuesLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksGetUserListOfValuesLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksGetUserListOfValuesLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksGetUserListOfValuesLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksGetUserListOfValuesLink>() {
           @Override
           public void write(JsonWriter out, LinksGetUserListOfValuesLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksGetUserListOfValuesLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksGetUserListOfValuesLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksGetUserListOfValuesLink
   * @throws IOException if the JSON string is invalid with respect to LinksGetUserListOfValuesLink
   */
  public static LinksGetUserListOfValuesLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksGetUserListOfValuesLink.class);
  }

  /**
   * Convert an instance of LinksGetUserListOfValuesLink to an JSON string
   *
   * @return JSON string
   */
