...
public class LinksSavePersonalInfoLink {
  ...
  public LinksSavePersonalInfoLink() {
  }
  ...
  public LinksSavePersonalInfoLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksSavePersonalInfoLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksSavePersonalInfoLink operationId(String operationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allOptionalParamsProvided, linksSavePersonalInfoLink.allOptionalParamsProvided) &&
        ...
        Objects.equals(this.label, linksSavePersonalInfoLink.label) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksSavePersonalInfoLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksSavePersonalInfoLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksSavePersonalInfoLink is not found in the empty JSON string", LinksSavePersonalInfoLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksSavePersonalInfoLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksSavePersonalInfoLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksSavePersonalInfoLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksSavePersonalInfoLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksSavePersonalInfoLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksSavePersonalInfoLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksSavePersonalInfoLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksSavePersonalInfoLink>() {
           @Override
           public void write(JsonWriter out, LinksSavePersonalInfoLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksSavePersonalInfoLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksSavePersonalInfoLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksSavePersonalInfoLink
   * @throws IOException if the JSON string is invalid with respect to LinksSavePersonalInfoLink
   */
  public static LinksSavePersonalInfoLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksSavePersonalInfoLink.class);
  }

  /**
   * Convert an instance of LinksSavePersonalInfoLink to an JSON string
   *
   * @return JSON string
   */
