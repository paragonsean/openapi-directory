...
public class LinksImportationGetReportLink {
  ...
  public LinksImportationGetReportLink() {
  }

  public LinksImportationGetReportLink allOptionalParamsProvided(Boolean allOptionalParamsProvided) {
  ...
  public LinksImportationGetReportLink allRequiredParamsProvided(Boolean allRequiredParamsProvided) {
  ...
  public LinksImportationGetReportLink description(String description) {
  ...
  public LinksImportationGetReportLink docUrl(URI docUrl) {
    this.docUrl = docUrl;
    return this;
  }
  ...
  public LinksImportationGetReportLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LinksImportationGetReportLink info(BeezUPCommonInfoSummaries info) {
    this.info = info;
    return this;
  }
  ...
  public LinksImportationGetReportLink label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LinksImportationGetReportLink method(BeezUPCommonHttpMethod method) {
    this.method = method;
    return this;
  }
  ...
  public LinksImportationGetReportLink operationId(String operationId) {
  ...
  public LinksImportationGetReportLink parameters(Map<String, BeezUPCommonLinkParameter3> parameters) {
    this.parameters = parameters;
    return this;
  }

  public LinksImportationGetReportLink putParametersItem(String key, BeezUPCommonLinkParameter3 parametersItem) {
  ...
  public LinksImportationGetReportLink urlTemplated(Boolean urlTemplated) {
  ...
  public boolean equals(Object o) {
    ...
    LinksImportationGetReportLink linksImportationGetReportLink = (LinksImportationGetReportLink) o;
    return Objects.equals(this.allOptionalParamsProvided, linksImportationGetReportLink.allOptionalParamsProvided) &&
        Objects.equals(this.allRequiredParamsProvided, linksImportationGetReportLink.allRequiredParamsProvided) &&
        Objects.equals(this.description, linksImportationGetReportLink.description) &&
        Objects.equals(this.docUrl, linksImportationGetReportLink.docUrl) &&
        Objects.equals(this.href, linksImportationGetReportLink.href) &&
        Objects.equals(this.info, linksImportationGetReportLink.info) &&
        Objects.equals(this.label, linksImportationGetReportLink.label) &&
        Objects.equals(this.method, linksImportationGetReportLink.method) &&
        Objects.equals(this.operationId, linksImportationGetReportLink.operationId) &&
        Objects.equals(this.parameters, linksImportationGetReportLink.parameters) &&
        Objects.equals(this.urlTemplated, linksImportationGetReportLink.urlTemplated);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinksImportationGetReportLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinksImportationGetReportLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinksImportationGetReportLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksImportationGetReportLink is not found in the empty JSON string", LinksImportationGetReportLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinksImportationGetReportLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinksImportationGetReportLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksImportationGetReportLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksImportationGetReportLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksImportationGetReportLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksImportationGetReportLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksImportationGetReportLink.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksImportationGetReportLink>() {
           @Override
           public void write(JsonWriter out, LinksImportationGetReportLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinksImportationGetReportLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinksImportationGetReportLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinksImportationGetReportLink
   * @throws IOException if the JSON string is invalid with respect to LinksImportationGetReportLink
   */
  public static LinksImportationGetReportLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksImportationGetReportLink.class);
  }

  /**
   * Convert an instance of LinksImportationGetReportLink to an JSON string
   *
   * @return JSON string
   */
