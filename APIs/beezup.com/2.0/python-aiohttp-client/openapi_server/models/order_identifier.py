...
class OrderIdentifier(Model):
    ...
    def __init__(self, account_id: int=None, beez_up_order_id: str=None, marketplace_technical_code: str=None):
        """OrderIdentifier - a model defined in OpenAPI

        :param account_id: The account_id of this OrderIdentifier.
        :param beez_up_order_id: The beez_up_order_id of this OrderIdentifier.
        :param marketplace_technical_code: The marketplace_technical_code of this OrderIdentifier.
        """
        self.openapi_types = {
            'account_id': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'OrderIdentifier':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The orderIdentifier of this OrderIdentifier.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_id(self):
        """Gets the account_id of this OrderIdentifier.

        The marketplace account identifier in BeezUP. This account identifier is based on your api settings.

        :return: The account_id of this OrderIdentifier.
        :rtype: int
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this OrderIdentifier.
    ...
    def beez_up_order_id(self):
        """Gets the beez_up_order_id of this OrderIdentifier.

        The BeezUP Order identifier

        :return: The beez_up_order_id of this OrderIdentifier.
        :rtype: str
        """
    ...
    def beez_up_order_id(self, beez_up_order_id):
        """Sets the beez_up_order_id of this OrderIdentifier.
    ...
    def marketplace_technical_code(self):
        """Gets the marketplace_technical_code of this OrderIdentifier.

        The technical code of the marketplace.

        :return: The marketplace_technical_code of this OrderIdentifier.
        :rtype: str
        """
    ...
    def marketplace_technical_code(self, marketplace_technical_code):
        """Sets the marketplace_technical_code of this OrderIdentifier.
