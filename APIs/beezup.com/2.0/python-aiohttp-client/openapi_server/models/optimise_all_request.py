...
class OptimiseAllRequest(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, advanced_filters: ReportAdvancedFilters=None, begin_period_utc_date: datetime=None, category_filter: BeezUPCommonCatalogCategoryFilter=None, channel_id: str=None, end_period_utc_date: datetime=None, performance_indicator_filters: List[PerformanceIndicatorFilter]=None, period_type: ReportFilterPeriodType=None, order_by: PerformanceIndicatorType=None, order_by_direction: OrderByDirection=None, analytics_product_column_filters: AnalyticsProductColumnFilters=None, product_columns_to_display: List[str]=None, product_state: ProductStateFilter=ProductStateFilter.ALL, report_type: ReportType=None):
        """OptimiseAllRequest - a model defined in OpenAPI

        :param advanced_filters: The advanced_filters of this OptimiseAllRequest.
        :param begin_period_utc_date: The begin_period_utc_date of this OptimiseAllRequest.
        :param category_filter: The category_filter of this OptimiseAllRequest.
        :param channel_id: The channel_id of this OptimiseAllRequest.
        :param end_period_utc_date: The end_period_utc_date of this OptimiseAllRequest.
        :param performance_indicator_filters: The performance_indicator_filters of this OptimiseAllRequest.
        :param period_type: The period_type of this OptimiseAllRequest.
        :param order_by: The order_by of this OptimiseAllRequest.
        :param order_by_direction: The order_by_direction of this OptimiseAllRequest.
        :param analytics_product_column_filters: The analytics_product_column_filters of this OptimiseAllRequest.
        :param product_columns_to_display: The product_columns_to_display of this OptimiseAllRequest.
        :param product_state: The product_state of this OptimiseAllRequest.
        :param report_type: The report_type of this OptimiseAllRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'OptimiseAllRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The optimiseAllRequest of this OptimiseAllRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def advanced_filters(self):
        """Gets the advanced_filters of this OptimiseAllRequest.


        :return: The advanced_filters of this OptimiseAllRequest.
    ...
    def advanced_filters(self, advanced_filters):
        """Sets the advanced_filters of this OptimiseAllRequest.
    ...
    def begin_period_utc_date(self):
        """Gets the begin_period_utc_date of this OptimiseAllRequest.

        The begin date period you want to get the report. It's required only in case of custom period type !

        :return: The begin_period_utc_date of this OptimiseAllRequest.
        :rtype: datetime
        """
    ...
    def begin_period_utc_date(self, begin_period_utc_date):
        """Sets the begin_period_utc_date of this OptimiseAllRequest.
    ...
    def category_filter(self):
        """Gets the category_filter of this OptimiseAllRequest.


        :return: The category_filter of this OptimiseAllRequest.
    ...
    def category_filter(self, category_filter):
        """Sets the category_filter of this OptimiseAllRequest.
    ...
    @property
    def channel_id(self):
        """Gets the channel_id of this OptimiseAllRequest.

        The channel identifier

        :return: The channel_id of this OptimiseAllRequest.
        :rtype: str
        """
    ...
    def channel_id(self, channel_id):
        """Sets the channel_id of this OptimiseAllRequest.
    ...
    def end_period_utc_date(self):
        """Gets the end_period_utc_date of this OptimiseAllRequest.

        The end date period you want to get the report. It's required only in case of custom period type !

        :return: The end_period_utc_date of this OptimiseAllRequest.
        :rtype: datetime
        """
    ...
    def end_period_utc_date(self, end_period_utc_date):
        """Sets the end_period_utc_date of this OptimiseAllRequest.
    ...
    def performance_indicator_filters(self):
        """Gets the performance_indicator_filters of this OptimiseAllRequest.


        :return: The performance_indicator_filters of this OptimiseAllRequest.
    ...
    def performance_indicator_filters(self, performance_indicator_filters):
        """Sets the performance_indicator_filters of this OptimiseAllRequest.
    ...
    def period_type(self):
        """Gets the period_type of this OptimiseAllRequest.


        :return: The period_type of this OptimiseAllRequest.
    ...
    def period_type(self, period_type):
        """Sets the period_type of this OptimiseAllRequest.
    ...
    @property
    def order_by(self):
        """Gets the order_by of this OptimiseAllRequest.


        :return: The order_by of this OptimiseAllRequest.
    ...
    def order_by(self, order_by):
        """Sets the order_by of this OptimiseAllRequest.
    ...
    def order_by_direction(self):
        """Gets the order_by_direction of this OptimiseAllRequest.


        :return: The order_by_direction of this OptimiseAllRequest.
    ...
    def order_by_direction(self, order_by_direction):
        """Sets the order_by_direction of this OptimiseAllRequest.
    ...
    def analytics_product_column_filters(self):
        """Gets the analytics_product_column_filters of this OptimiseAllRequest.


        :return: The analytics_product_column_filters of this OptimiseAllRequest.
    ...
    def analytics_product_column_filters(self, analytics_product_column_filters):
        """Sets the analytics_product_column_filters of this OptimiseAllRequest.
    ...
    def product_columns_to_display(self):
        """Gets the product_columns_to_display of this OptimiseAllRequest.


        :return: The product_columns_to_display of this OptimiseAllRequest.
        :rtype: List[str]
        """
    ...
    def product_columns_to_display(self, product_columns_to_display):
        """Sets the product_columns_to_display of this OptimiseAllRequest.
    ...
    def product_state(self):
        """Gets the product_state of this OptimiseAllRequest.


        :return: The product_state of this OptimiseAllRequest.
    ...
    def product_state(self, product_state):
        """Sets the product_state of this OptimiseAllRequest.
    ...
    def report_type(self):
        """Gets the report_type of this OptimiseAllRequest.


        :return: The report_type of this OptimiseAllRequest.
        :rtype: ReportType
        """
    ...
    def report_type(self, report_type):
        """Sets the report_type of this OptimiseAllRequest.
