...
class SubscriptionIndex(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, consumer_health_status: ConsumptionAvailabilityStatus=None, consumer_last_request_sent_uri: str=None, consumer_unvailable_since_utc_date: datetime=None, id: str=None, last_error_message: ErrorResponseMessage=None, last_order_pushed_modification_utc_date: datetime=None, last_retry_utc_date: datetime=None, last_successful_order_pushed_utc_date: datetime=None, max_retry_count: int=None, merchant_application_name: str=None, merchant_application_version: str='1.0', merchant_email_alert: str=None, name: str=None, next_scheduled_retry_utc_date: datetime=None, recover_begin_period_order_last_modification_utc_date: datetime=None, recover_end_period_order_last_modification_utc_date: datetime=None, retry_count: int=None, status: SubscriptionStatus=None, target_url: str=None, links: SubscriptionLinks=None):
        """SubscriptionIndex - a model defined in OpenAPI

        :param consumer_health_status: The consumer_health_status of this SubscriptionIndex.
        :param consumer_last_request_sent_uri: The consumer_last_request_sent_uri of this SubscriptionIndex.
        :param consumer_unvailable_since_utc_date: The consumer_unvailable_since_utc_date of this SubscriptionIndex.
        :param id: The id of this SubscriptionIndex.
        :param last_error_message: The last_error_message of this SubscriptionIndex.
        :param last_order_pushed_modification_utc_date: The last_order_pushed_modification_utc_date of this SubscriptionIndex.
        :param last_retry_utc_date: The last_retry_utc_date of this SubscriptionIndex.
        :param last_successful_order_pushed_utc_date: The last_successful_order_pushed_utc_date of this SubscriptionIndex.
        :param max_retry_count: The max_retry_count of this SubscriptionIndex.
        :param merchant_application_name: The merchant_application_name of this SubscriptionIndex.
        :param merchant_application_version: The merchant_application_version of this SubscriptionIndex.
        :param merchant_email_alert: The merchant_email_alert of this SubscriptionIndex.
        :param name: The name of this SubscriptionIndex.
        :param next_scheduled_retry_utc_date: The next_scheduled_retry_utc_date of this SubscriptionIndex.
        :param recover_begin_period_order_last_modification_utc_date: The recover_begin_period_order_last_modification_utc_date of this SubscriptionIndex.
        :param recover_end_period_order_last_modification_utc_date: The recover_end_period_order_last_modification_utc_date of this SubscriptionIndex.
        :param retry_count: The retry_count of this SubscriptionIndex.
        :param status: The status of this SubscriptionIndex.
        :param target_url: The target_url of this SubscriptionIndex.
        :param links: The links of this SubscriptionIndex.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SubscriptionIndex':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The subscriptionIndex of this SubscriptionIndex.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def consumer_health_status(self):
        """Gets the consumer_health_status of this SubscriptionIndex.


        :return: The consumer_health_status of this SubscriptionIndex.
    ...
    def consumer_health_status(self, consumer_health_status):
        """Sets the consumer_health_status of this SubscriptionIndex.
    ...
    def consumer_last_request_sent_uri(self):
        """Gets the consumer_last_request_sent_uri of this SubscriptionIndex.

        The URL <a href=\"https://en.wikipedia.org/wiki/URL\">https://en.wikipedia.org/wiki/URL</a>

        :return: The consumer_last_request_sent_uri of this SubscriptionIndex.
        :rtype: str
        """
    ...
    def consumer_last_request_sent_uri(self, consumer_last_request_sent_uri):
        """Sets the consumer_last_request_sent_uri of this SubscriptionIndex.
    ...
    def consumer_unvailable_since_utc_date(self):
        """Gets the consumer_unvailable_since_utc_date of this SubscriptionIndex.

        This date indicates since when the subscription consumer is unavailable

        :return: The consumer_unvailable_since_utc_date of this SubscriptionIndex.
        :rtype: datetime
        """
    ...
    def consumer_unvailable_since_utc_date(self, consumer_unvailable_since_utc_date):
        """Sets the consumer_unvailable_since_utc_date of this SubscriptionIndex.
    ...
    @property
    def id(self):
        """Gets the id of this SubscriptionIndex.

        The identifier of the subscription to the orders for a merchant

        :return: The id of this SubscriptionIndex.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this SubscriptionIndex.
    ...
    def last_error_message(self):
        """Gets the last_error_message of this SubscriptionIndex.


        :return: The last_error_message of this SubscriptionIndex.
    ...
    def last_error_message(self, last_error_message):
        """Sets the last_error_message of this SubscriptionIndex.
    ...
    def last_order_pushed_modification_utc_date(self):
        """Gets the last_order_pushed_modification_utc_date of this SubscriptionIndex.

        This modification date correspond to the last order pushed by your subscription consumer

        :return: The last_order_pushed_modification_utc_date of this SubscriptionIndex.
        :rtype: datetime
        """
    ...
    def last_order_pushed_modification_utc_date(self, last_order_pushed_modification_utc_date):
        """Sets the last_order_pushed_modification_utc_date of this SubscriptionIndex.
    ...
    def last_retry_utc_date(self):
        """Gets the last_retry_utc_date of this SubscriptionIndex.

        The last date we retry to send orders

        :return: The last_retry_utc_date of this SubscriptionIndex.
        :rtype: datetime
        """
    ...
    def last_retry_utc_date(self, last_retry_utc_date):
        """Sets the last_retry_utc_date of this SubscriptionIndex.
    ...
    def last_successful_order_pushed_utc_date(self):
        """Gets the last_successful_order_pushed_utc_date of this SubscriptionIndex.

        The date of the last pushed order successfully received by your subscription consumer

        :return: The last_successful_order_pushed_utc_date of this SubscriptionIndex.
        :rtype: datetime
        """
    ...
    def last_successful_order_pushed_utc_date(self, last_successful_order_pushed_utc_date):
        """Sets the last_successful_order_pushed_utc_date of this SubscriptionIndex.
    ...
    def max_retry_count(self):
        """Gets the max_retry_count of this SubscriptionIndex.
        ...
        :return: The max_retry_count of this SubscriptionIndex.
        :rtype: int
        """
    ...
    def max_retry_count(self, max_retry_count):
        """Sets the max_retry_count of this SubscriptionIndex.
    ...
    def merchant_application_name(self):
        """Gets the merchant_application_name of this SubscriptionIndex.

        The name of your application

        :return: The merchant_application_name of this SubscriptionIndex.
        :rtype: str
        """
    ...
    def merchant_application_name(self, merchant_application_name):
        """Sets the merchant_application_name of this SubscriptionIndex.
    ...
    def merchant_application_version(self):
        """Gets the merchant_application_version of this SubscriptionIndex.

        The version of your application

        :return: The merchant_application_version of this SubscriptionIndex.
        :rtype: str
        """
    ...
    def merchant_application_version(self, merchant_application_version):
        """Sets the merchant_application_version of this SubscriptionIndex.
    ...
    def merchant_email_alert(self):
        """Gets the merchant_email_alert of this SubscriptionIndex.

        The email

        :return: The merchant_email_alert of this SubscriptionIndex.
        :rtype: str
        """
    ...
    def merchant_email_alert(self, merchant_email_alert):
        """Sets the merchant_email_alert of this SubscriptionIndex.
    ...
    @property
    def name(self):
        """Gets the name of this SubscriptionIndex.

        The subscription name you want to use

        :return: The name of this SubscriptionIndex.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SubscriptionIndex.
    ...
    def next_scheduled_retry_utc_date(self):
        """Gets the next_scheduled_retry_utc_date of this SubscriptionIndex.

        The next scheduled  date we retry to send orders

        :return: The next_scheduled_retry_utc_date of this SubscriptionIndex.
        :rtype: datetime
        """
    ...
    def next_scheduled_retry_utc_date(self, next_scheduled_retry_utc_date):
        """Sets the next_scheduled_retry_utc_date of this SubscriptionIndex.
    ...
    def recover_begin_period_order_last_modification_utc_date(self):
        """Gets the recover_begin_period_order_last_modification_utc_date of this SubscriptionIndex.
        ...
        :return: The recover_begin_period_order_last_modification_utc_date of this SubscriptionIndex.
        :rtype: datetime
        """
    ...
    def recover_begin_period_order_last_modification_utc_date(self, recover_begin_period_order_last_modification_utc_date):
        """Sets the recover_begin_period_order_last_modification_utc_date of this SubscriptionIndex.
    ...
    def recover_end_period_order_last_modification_utc_date(self):
        """Gets the recover_end_period_order_last_modification_utc_date of this SubscriptionIndex.
        ...
        :return: The recover_end_period_order_last_modification_utc_date of this SubscriptionIndex.
        :rtype: datetime
        """
    ...
    def recover_end_period_order_last_modification_utc_date(self, recover_end_period_order_last_modification_utc_date):
        """Sets the recover_end_period_order_last_modification_utc_date of this SubscriptionIndex.
    ...
    def retry_count(self, retry_count):
        """Sets the retry_count of this SubscriptionIndex.
    ...
    @property
    def status(self):
        """Gets the status of this SubscriptionIndex.


        :return: The status of this SubscriptionIndex.
    ...
    def status(self, status):
        """Sets the status of this SubscriptionIndex.
    ...
    @property
    def target_url(self):
        """Gets the target_url of this SubscriptionIndex.

        The URL <a href=\"https://en.wikipedia.org/wiki/URL\">https://en.wikipedia.org/wiki/URL</a>

        :return: The target_url of this SubscriptionIndex.
        :rtype: str
        """
    ...
    def target_url(self, target_url):
        """Sets the target_url of this SubscriptionIndex.
    ...
    @property
    def links(self):
        """Gets the links of this SubscriptionIndex.


        :return: The links of this SubscriptionIndex.
    ...
    def links(self, links):
        """Sets the links of this SubscriptionIndex.


        :param links: The links of this SubscriptionIndex.
        :type links: SubscriptionLinks
        """
