...
class OfferRequest(Model):
    ...
    def __init__(self, billing_period_in_month: int=None, coupon_discount_code: str=None, coupon_offer_code: str=None, offer_id: int=None, store_count: int=None):
        """OfferRequest - a model defined in OpenAPI

        :param billing_period_in_month: The billing_period_in_month of this OfferRequest.
        :param coupon_discount_code: The coupon_discount_code of this OfferRequest.
        :param coupon_offer_code: The coupon_offer_code of this OfferRequest.
        :param offer_id: The offer_id of this OfferRequest.
        :param store_count: The store_count of this OfferRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'OfferRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The offerRequest of this OfferRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def billing_period_in_month(self):
        """Gets the billing_period_in_month of this OfferRequest.

        Can be null. The billing period in month based on /billingPeriods

        :return: The billing_period_in_month of this OfferRequest.
        :rtype: int
        """
    ...
    def billing_period_in_month(self, billing_period_in_month):
        """Sets the billing_period_in_month of this OfferRequest.
    ...
    def coupon_discount_code(self):
        """Gets the coupon_discount_code of this OfferRequest.

        The coupon discount code

        :return: The coupon_discount_code of this OfferRequest.
        :rtype: str
        """
    ...
    def coupon_discount_code(self, coupon_discount_code):
        """Sets the coupon_discount_code of this OfferRequest.
    ...
    def coupon_offer_code(self):
        """Gets the coupon_offer_code of this OfferRequest.

        Your special coupon offer identifier

        :return: The coupon_offer_code of this OfferRequest.
        :rtype: str
        """
    ...
    def coupon_offer_code(self, coupon_offer_code):
        """Sets the coupon_offer_code of this OfferRequest.
    ...
    @property
    def offer_id(self):
        """Gets the offer_id of this OfferRequest.

        The offer id based on /offers. Not a free offer of course.

        :return: The offer_id of this OfferRequest.
        :rtype: int
        """
    ...
    def offer_id(self, offer_id):
        """Sets the offer_id of this OfferRequest.
    ...
    def store_count(self):
        """Gets the store_count of this OfferRequest.

        The store count you want to have in your contract.

        :return: The store_count of this OfferRequest.
        :rtype: int
        """
    ...
    def store_count(self, store_count):
        """Sets the store_count of this OfferRequest.
