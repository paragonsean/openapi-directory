...
class ReportByCategoryRequest(Model):
    ...
    def __init__(self, advanced_filters: ReportAdvancedFilters=None, begin_period_utc_date: datetime=None, category_filter: BeezUPCommonCatalogCategoryFilter=None, channel_id: str=None, end_period_utc_date: datetime=None, performance_indicator_filters: List[PerformanceIndicatorFilter]=None, period_type: ReportFilterPeriodType=None, order_by: PerformanceIndicatorType=None, order_by_direction: OrderByDirection=None, page_number: int=None, page_size: int=None):
        """ReportByCategoryRequest - a model defined in OpenAPI

        :param advanced_filters: The advanced_filters of this ReportByCategoryRequest.
        :param begin_period_utc_date: The begin_period_utc_date of this ReportByCategoryRequest.
        :param category_filter: The category_filter of this ReportByCategoryRequest.
        :param channel_id: The channel_id of this ReportByCategoryRequest.
        :param end_period_utc_date: The end_period_utc_date of this ReportByCategoryRequest.
        :param performance_indicator_filters: The performance_indicator_filters of this ReportByCategoryRequest.
        :param period_type: The period_type of this ReportByCategoryRequest.
        :param order_by: The order_by of this ReportByCategoryRequest.
        :param order_by_direction: The order_by_direction of this ReportByCategoryRequest.
        :param page_number: The page_number of this ReportByCategoryRequest.
        :param page_size: The page_size of this ReportByCategoryRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ReportByCategoryRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The reportByCategoryRequest of this ReportByCategoryRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def advanced_filters(self):
        """Gets the advanced_filters of this ReportByCategoryRequest.


        :return: The advanced_filters of this ReportByCategoryRequest.
    ...
    def advanced_filters(self, advanced_filters):
        """Sets the advanced_filters of this ReportByCategoryRequest.
    ...
    def begin_period_utc_date(self):
        """Gets the begin_period_utc_date of this ReportByCategoryRequest.

        The begin date period you want to get the report. It's required only in case of custom period type !

        :return: The begin_period_utc_date of this ReportByCategoryRequest.
        :rtype: datetime
        """
    ...
    def begin_period_utc_date(self, begin_period_utc_date):
        """Sets the begin_period_utc_date of this ReportByCategoryRequest.
    ...
    def category_filter(self):
        """Gets the category_filter of this ReportByCategoryRequest.


        :return: The category_filter of this ReportByCategoryRequest.
    ...
    def category_filter(self, category_filter):
        """Sets the category_filter of this ReportByCategoryRequest.
    ...
    @property
    def channel_id(self):
        """Gets the channel_id of this ReportByCategoryRequest.

        The channel identifier

        :return: The channel_id of this ReportByCategoryRequest.
        :rtype: str
        """
    ...
    def channel_id(self, channel_id):
        """Sets the channel_id of this ReportByCategoryRequest.
    ...
    def end_period_utc_date(self):
        """Gets the end_period_utc_date of this ReportByCategoryRequest.

        The end date period you want to get the report. It's required only in case of custom period type !

        :return: The end_period_utc_date of this ReportByCategoryRequest.
        :rtype: datetime
        """
    ...
    def end_period_utc_date(self, end_period_utc_date):
        """Sets the end_period_utc_date of this ReportByCategoryRequest.
    ...
    def performance_indicator_filters(self):
        """Gets the performance_indicator_filters of this ReportByCategoryRequest.


        :return: The performance_indicator_filters of this ReportByCategoryRequest.
    ...
    def performance_indicator_filters(self, performance_indicator_filters):
        """Sets the performance_indicator_filters of this ReportByCategoryRequest.
    ...
    def period_type(self):
        """Gets the period_type of this ReportByCategoryRequest.


        :return: The period_type of this ReportByCategoryRequest.
    ...
    def period_type(self, period_type):
        """Sets the period_type of this ReportByCategoryRequest.
    ...
    @property
    def order_by(self):
        """Gets the order_by of this ReportByCategoryRequest.


        :return: The order_by of this ReportByCategoryRequest.
    ...
    def order_by(self, order_by):
        """Sets the order_by of this ReportByCategoryRequest.
    ...
    def order_by_direction(self):
        """Gets the order_by_direction of this ReportByCategoryRequest.


        :return: The order_by_direction of this ReportByCategoryRequest.
    ...
    def order_by_direction(self, order_by_direction):
        """Sets the order_by_direction of this ReportByCategoryRequest.
    ...
    def page_number(self):
        """Gets the page_number of this ReportByCategoryRequest.

        Indicates the page number

        :return: The page_number of this ReportByCategoryRequest.
        :rtype: int
        """
    ...
    def page_number(self, page_number):
        """Sets the page_number of this ReportByCategoryRequest.
    ...
    @property
    def page_size(self):
        """Gets the page_size of this ReportByCategoryRequest.

        Indicate the item count per page

        :return: The page_size of this ReportByCategoryRequest.
        :rtype: int
        """
    ...
    def page_size(self, page_size):
        """Sets the page_size of this ReportByCategoryRequest.
