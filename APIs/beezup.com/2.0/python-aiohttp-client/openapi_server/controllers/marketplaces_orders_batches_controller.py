...
async def change_order_list(request: web.Request, change_order_type, user_name, body, test_mode=None) -> web.Response:
...
async def clear_merchant_order_info_list(request: web.Request, body) -> web.Response:
...
async def set_merchant_order_info_list(request: web.Request, body) -> web.Response:
