...
async def get_user_list_of_values(request: web.Request, list_name, accept_language=None, if_none_match=None) -> web.Response:
...
async def get_user_lov_index(request: web.Request, ) -> web.Response:
    """Get all list names
