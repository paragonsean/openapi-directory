...
/*
 * OAILinks_GetOrderIndexLink.h
 *
 * 
 */

#ifndef OAILinks_GetOrderIndexLink_H
#define OAILinks_GetOrderIndexLink_H
...
class OAILinks_GetOrderIndexLink : public OAIObject {
public:
    OAILinks_GetOrderIndexLink();
    OAILinks_GetOrderIndexLink(QString json);
    ~OAILinks_GetOrderIndexLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetOrderIndexLink)

#endif // OAILinks_GetOrderIndexLink_H
