...
/*
 * OAILinks_Catalog_SaveCustomColumnLink.h
 *
 * 
 */

#ifndef OAILinks_Catalog_SaveCustomColumnLink_H
#define OAILinks_Catalog_SaveCustomColumnLink_H
...
class OAILinks_Catalog_SaveCustomColumnLink : public OAIObject {
public:
    OAILinks_Catalog_SaveCustomColumnLink();
    OAILinks_Catalog_SaveCustomColumnLink(QString json);
    ~OAILinks_Catalog_SaveCustomColumnLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Catalog_SaveCustomColumnLink)

#endif // OAILinks_Catalog_SaveCustomColumnLink_H
