...
/*
 * OAILinks_GetStoreReportByChannelLink.h
 *
 * 
 */

#ifndef OAILinks_GetStoreReportByChannelLink_H
#define OAILinks_GetStoreReportByChannelLink_H
...
class OAILinks_GetStoreReportByChannelLink : public OAIObject {
public:
    OAILinks_GetStoreReportByChannelLink();
    OAILinks_GetStoreReportByChannelLink(QString json);
    ~OAILinks_GetStoreReportByChannelLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetStoreReportByChannelLink)

#endif // OAILinks_GetStoreReportByChannelLink_H
