...
/*
 * OAIChannelCatalogMarketplaceStringProperty.h
 *
 * 
 */

#ifndef OAIChannelCatalogMarketplaceStringProperty_H
#define OAIChannelCatalogMarketplaceStringProperty_H
...
class OAIChannelCatalogMarketplaceStringProperty : public OAIObject {
public:
    OAIChannelCatalogMarketplaceStringProperty();
    OAIChannelCatalogMarketplaceStringProperty(QString json);
    ~OAIChannelCatalogMarketplaceStringProperty() override;
    ...
    QList<QString> getRDefault() const;
    void setRDefault(const QList<QString> &r_default);
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelCatalogMarketplaceStringProperty)

#endif // OAIChannelCatalogMarketplaceStringProperty_H
