...
/*
 * OAILinks_SetMerchantOrderInfoV3Link.h
 *
 * 
 */

#ifndef OAILinks_SetMerchantOrderInfoV3Link_H
#define OAILinks_SetMerchantOrderInfoV3Link_H
...
class OAILinks_SetMerchantOrderInfoV3Link : public OAIObject {
public:
    OAILinks_SetMerchantOrderInfoV3Link();
    OAILinks_SetMerchantOrderInfoV3Link(QString json);
    ~OAILinks_SetMerchantOrderInfoV3Link() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_SetMerchantOrderInfoV3Link)

#endif // OAILinks_SetMerchantOrderInfoV3Link_H
