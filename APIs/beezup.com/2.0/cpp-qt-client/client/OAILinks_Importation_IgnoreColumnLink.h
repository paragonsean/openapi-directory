...
/*
 * OAILinks_Importation_IgnoreColumnLink.h
 *
 * 
 */

#ifndef OAILinks_Importation_IgnoreColumnLink_H
#define OAILinks_Importation_IgnoreColumnLink_H
...
class OAILinks_Importation_IgnoreColumnLink : public OAIObject {
public:
    OAILinks_Importation_IgnoreColumnLink();
    OAILinks_Importation_IgnoreColumnLink(QString json);
    ~OAILinks_Importation_IgnoreColumnLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Importation_IgnoreColumnLink)

#endif // OAILinks_Importation_IgnoreColumnLink_H
