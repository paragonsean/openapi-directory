...
/*
 * OAILinks_EnableChannelCatalogLink.h
 *
 * 
 */

#ifndef OAILinks_EnableChannelCatalogLink_H
#define OAILinks_EnableChannelCatalogLink_H
...
class OAILinks_EnableChannelCatalogLink : public OAIObject {
public:
    OAILinks_EnableChannelCatalogLink();
    OAILinks_EnableChannelCatalogLink(QString json);
    ~OAILinks_EnableChannelCatalogLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_EnableChannelCatalogLink)

#endif // OAILinks_EnableChannelCatalogLink_H
