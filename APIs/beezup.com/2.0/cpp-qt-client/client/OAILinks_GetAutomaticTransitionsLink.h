...
/*
 * OAILinks_GetAutomaticTransitionsLink.h
 *
 * 
 */

#ifndef OAILinks_GetAutomaticTransitionsLink_H
#define OAILinks_GetAutomaticTransitionsLink_H
...
class OAILinks_GetAutomaticTransitionsLink : public OAIObject {
public:
    OAILinks_GetAutomaticTransitionsLink();
    OAILinks_GetAutomaticTransitionsLink(QString json);
    ~OAILinks_GetAutomaticTransitionsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetAutomaticTransitionsLink)

#endif // OAILinks_GetAutomaticTransitionsLink_H
