...
/*
 * OAIExternalLinks_Catalog_GetBeezUPColumnsLink.h
 *
 * 
 */

#ifndef OAIExternalLinks_Catalog_GetBeezUPColumnsLink_H
#define OAIExternalLinks_Catalog_GetBeezUPColumnsLink_H
...
class OAIExternalLinks_Catalog_GetBeezUPColumnsLink : public OAIObject {
public:
    OAIExternalLinks_Catalog_GetBeezUPColumnsLink();
    OAIExternalLinks_Catalog_GetBeezUPColumnsLink(QString json);
    ~OAIExternalLinks_Catalog_GetBeezUPColumnsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExternalLinks_Catalog_GetBeezUPColumnsLink)

#endif // OAIExternalLinks_Catalog_GetBeezUPColumnsLink_H
