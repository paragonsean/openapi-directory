...
#ifndef OAIProductError_H
#define OAIProductError_H
...
namespace OpenAPI {
class OAIProductErrorCode;

class OAIProductError : public OAIObject {
public:
    OAIProductError();
    OAIProductError(QString json);
    ~OAIProductError() override;
    ...
    QList<OAIProductErrorCode> getErrors() const;
    void setErrors(const QList<OAIProductErrorCode> &errors);
...
private:
    ...
    QList<OAIProductErrorCode> m_errors;
    bool m_errors_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductError)

#endif // OAIProductError_H
