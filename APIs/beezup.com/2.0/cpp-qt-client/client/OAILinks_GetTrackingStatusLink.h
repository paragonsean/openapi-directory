...
/*
 * OAILinks_GetTrackingStatusLink.h
 *
 * 
 */

#ifndef OAILinks_GetTrackingStatusLink_H
#define OAILinks_GetTrackingStatusLink_H
...
class OAILinks_GetTrackingStatusLink : public OAIObject {
public:
    OAILinks_GetTrackingStatusLink();
    OAILinks_GetTrackingStatusLink(QString json);
    ~OAILinks_GetTrackingStatusLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetTrackingStatusLink)

#endif // OAILinks_GetTrackingStatusLink_H
