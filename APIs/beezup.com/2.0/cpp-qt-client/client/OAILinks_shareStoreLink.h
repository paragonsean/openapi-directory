...
/*
 * OAILinks_shareStoreLink.h
 *
 * 
 */

#ifndef OAILinks_shareStoreLink_H
#define OAILinks_shareStoreLink_H
...
class OAILinks_shareStoreLink : public OAIObject {
public:
    OAILinks_shareStoreLink();
    OAILinks_shareStoreLink(QString json);
    ~OAILinks_shareStoreLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_shareStoreLink)

#endif // OAILinks_shareStoreLink_H
