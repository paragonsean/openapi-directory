...
/*
 * OAITrackedExternalOrderProduct.h
 *
 * 
 */

#ifndef OAITrackedExternalOrderProduct_H
#define OAITrackedExternalOrderProduct_H
...
class OAITrackedExternalOrderProduct : public OAIObject {
public:
    OAITrackedExternalOrderProduct();
    OAITrackedExternalOrderProduct(QString json);
    ~OAITrackedExternalOrderProduct() override;
    ...
    void setProductActive(const bool &product_active);
    bool is_product_active_Set() const;
    bool is_product_active_Valid() const;
...
private:
    ...
    bool m_product_active;
    bool m_product_active_isSet;
    bool m_product_active_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrackedExternalOrderProduct)

#endif // OAITrackedExternalOrderProduct_H
