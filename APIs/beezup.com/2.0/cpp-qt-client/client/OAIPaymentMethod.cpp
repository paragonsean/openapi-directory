...
void OAIPaymentMethod::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("Transfer", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPaymentMethod::TRANSFER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Debit", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPaymentMethod::DEBIT;
        m_value_isSet = m_value_isValid = true;
    }
        ...
        m_value = eOAIPaymentMethod::CREDITNOTE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Loss", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPaymentMethod::LOSS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("OnlinePayment", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPaymentMethod::ONLINEPAYMENT;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIPaymentMethod::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIPaymentMethod::TRANSFER:
            val = "Transfer";
            break;
        case eOAIPaymentMethod::DEBIT:
            val = "Debit";
            break;
        ...
        case eOAIPaymentMethod::CHECK:
            val = "Check";
            break;
        case eOAIPaymentMethod::CREDITNOTE:
            val = "CreditNote";
            break;
        case eOAIPaymentMethod::LOSS:
            val = "Loss";
            break;
        case eOAIPaymentMethod::ONLINEPAYMENT:
            val = "OnlinePayment";
            break;
        default:
            break;
