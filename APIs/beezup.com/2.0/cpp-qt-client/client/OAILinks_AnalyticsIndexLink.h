...
/*
 * OAILinks_AnalyticsIndexLink.h
 *
 * 
 */

#ifndef OAILinks_AnalyticsIndexLink_H
#define OAILinks_AnalyticsIndexLink_H
...
class OAILinks_AnalyticsIndexLink : public OAIObject {
public:
    OAILinks_AnalyticsIndexLink();
    OAILinks_AnalyticsIndexLink(QString json);
    ~OAILinks_AnalyticsIndexLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_AnalyticsIndexLink)

#endif // OAILinks_AnalyticsIndexLink_H
