...
/*
 * OAIPublicChannelInfo.h
 *
 * 
 */

#ifndef OAIPublicChannelInfo_H
#define OAIPublicChannelInfo_H
...
class OAIPublicChannelInfo : public OAIObject {
public:
    OAIPublicChannelInfo();
    OAIPublicChannelInfo(QString json);
    ~OAIPublicChannelInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublicChannelInfo)

#endif // OAIPublicChannelInfo_H
