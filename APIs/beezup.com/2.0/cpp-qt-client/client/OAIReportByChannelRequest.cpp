...
OAIReportByChannelRequest::OAIReportByChannelRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReportByChannelRequest::OAIReportByChannelRequest() {
    this->initializeModel();
}

OAIReportByChannelRequest::~OAIReportByChannelRequest() {}

void OAIReportByChannelRequest::initializeModel() {
...
void OAIReportByChannelRequest::fromJson(QString jsonString) {
...
void OAIReportByChannelRequest::fromJsonObject(QJsonObject json) {
...
QString OAIReportByChannelRequest::asJson() const {
...
QJsonObject OAIReportByChannelRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIReportAdvancedFilters OAIReportByChannelRequest::getAdvancedFilters() const {
    return m_advanced_filters;
}
void OAIReportByChannelRequest::setAdvancedFilters(const OAIReportAdvancedFilters &advanced_filters) {
    m_advanced_filters = advanced_filters;
    m_advanced_filters_isSet = true;
}

bool OAIReportByChannelRequest::is_advanced_filters_Set() const{
    return m_advanced_filters_isSet;
}

bool OAIReportByChannelRequest::is_advanced_filters_Valid() const{
    return m_advanced_filters_isValid;
}

QDateTime OAIReportByChannelRequest::getBeginPeriodUtcDate() const {
    return m_begin_period_utc_date;
}
void OAIReportByChannelRequest::setBeginPeriodUtcDate(const QDateTime &begin_period_utc_date) {
    m_begin_period_utc_date = begin_period_utc_date;
    m_begin_period_utc_date_isSet = true;
}

bool OAIReportByChannelRequest::is_begin_period_utc_date_Set() const{
    return m_begin_period_utc_date_isSet;
}

bool OAIReportByChannelRequest::is_begin_period_utc_date_Valid() const{
    return m_begin_period_utc_date_isValid;
}

OAIBeezUP_Common_CatalogCategoryFilter OAIReportByChannelRequest::getCategoryFilter() const {
    return m_category_filter;
}
void OAIReportByChannelRequest::setCategoryFilter(const OAIBeezUP_Common_CatalogCategoryFilter &category_filter) {
    m_category_filter = category_filter;
    m_category_filter_isSet = true;
}

bool OAIReportByChannelRequest::is_category_filter_Set() const{
    return m_category_filter_isSet;
}

bool OAIReportByChannelRequest::is_category_filter_Valid() const{
    return m_category_filter_isValid;
}

QString OAIReportByChannelRequest::getChannelId() const {
    return m_channel_id;
}
void OAIReportByChannelRequest::setChannelId(const QString &channel_id) {
    m_channel_id = channel_id;
    m_channel_id_isSet = true;
}

bool OAIReportByChannelRequest::is_channel_id_Set() const{
    return m_channel_id_isSet;
}

bool OAIReportByChannelRequest::is_channel_id_Valid() const{
    return m_channel_id_isValid;
}

QDateTime OAIReportByChannelRequest::getEndPeriodUtcDate() const {
    return m_end_period_utc_date;
}
void OAIReportByChannelRequest::setEndPeriodUtcDate(const QDateTime &end_period_utc_date) {
    m_end_period_utc_date = end_period_utc_date;
    m_end_period_utc_date_isSet = true;
}

bool OAIReportByChannelRequest::is_end_period_utc_date_Set() const{
    return m_end_period_utc_date_isSet;
}

bool OAIReportByChannelRequest::is_end_period_utc_date_Valid() const{
    return m_end_period_utc_date_isValid;
}

QList<OAIPerformanceIndicatorFilter> OAIReportByChannelRequest::getPerformanceIndicatorFilters() const {
    return m_performance_indicator_filters;
}
void OAIReportByChannelRequest::setPerformanceIndicatorFilters(const QList<OAIPerformanceIndicatorFilter> &performance_indicator_filters) {
    m_performance_indicator_filters = performance_indicator_filters;
    m_performance_indicator_filters_isSet = true;
}

bool OAIReportByChannelRequest::is_performance_indicator_filters_Set() const{
    return m_performance_indicator_filters_isSet;
}

bool OAIReportByChannelRequest::is_performance_indicator_filters_Valid() const{
    return m_performance_indicator_filters_isValid;
}

OAIReportFilterPeriodType OAIReportByChannelRequest::getPeriodType() const {
    return m_period_type;
}
void OAIReportByChannelRequest::setPeriodType(const OAIReportFilterPeriodType &period_type) {
    m_period_type = period_type;
    m_period_type_isSet = true;
}

bool OAIReportByChannelRequest::is_period_type_Set() const{
    return m_period_type_isSet;
}

bool OAIReportByChannelRequest::is_period_type_Valid() const{
    return m_period_type_isValid;
}

OAIPerformanceIndicatorType OAIReportByChannelRequest::getOrderBy() const {
    return m_order_by;
}
void OAIReportByChannelRequest::setOrderBy(const OAIPerformanceIndicatorType &order_by) {
    m_order_by = order_by;
    m_order_by_isSet = true;
}

bool OAIReportByChannelRequest::is_order_by_Set() const{
    return m_order_by_isSet;
}

bool OAIReportByChannelRequest::is_order_by_Valid() const{
    return m_order_by_isValid;
}

OAIOrderByDirection OAIReportByChannelRequest::getOrderByDirection() const {
    return m_order_by_direction;
}
void OAIReportByChannelRequest::setOrderByDirection(const OAIOrderByDirection &order_by_direction) {
    m_order_by_direction = order_by_direction;
    m_order_by_direction_isSet = true;
}

bool OAIReportByChannelRequest::is_order_by_direction_Set() const{
    return m_order_by_direction_isSet;
}

bool OAIReportByChannelRequest::is_order_by_direction_Valid() const{
    return m_order_by_direction_isValid;
}

qint32 OAIReportByChannelRequest::getPageNumber() const {
    return m_page_number;
}
void OAIReportByChannelRequest::setPageNumber(const qint32 &page_number) {
    m_page_number = page_number;
    m_page_number_isSet = true;
}

bool OAIReportByChannelRequest::is_page_number_Set() const{
    return m_page_number_isSet;
}

bool OAIReportByChannelRequest::is_page_number_Valid() const{
    return m_page_number_isValid;
}

qint32 OAIReportByChannelRequest::getPageSize() const {
    return m_page_size;
}
void OAIReportByChannelRequest::setPageSize(const qint32 &page_size) {
    m_page_size = page_size;
    m_page_size_isSet = true;
}

bool OAIReportByChannelRequest::is_page_size_Set() const{
    return m_page_size_isSet;
}

bool OAIReportByChannelRequest::is_page_size_Valid() const{
    return m_page_size_isValid;
}

bool OAIReportByChannelRequest::isSet() const {
...
bool OAIReportByChannelRequest::isValid() const {
