...
/*
 * OAILinks_savePersonalInfoLink.h
 *
 * 
 */

#ifndef OAILinks_savePersonalInfoLink_H
#define OAILinks_savePersonalInfoLink_H
...
class OAILinks_savePersonalInfoLink : public OAIObject {
public:
    OAILinks_savePersonalInfoLink();
    OAILinks_savePersonalInfoLink(QString json);
    ~OAILinks_savePersonalInfoLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_savePersonalInfoLink)

#endif // OAILinks_savePersonalInfoLink_H
