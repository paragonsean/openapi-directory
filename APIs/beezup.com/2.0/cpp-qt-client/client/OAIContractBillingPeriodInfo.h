...
/*
 * OAIContractBillingPeriodInfo.h
 *
 * Describe the billing period information related to the offer.
 */

#ifndef OAIContractBillingPeriodInfo_H
#define OAIContractBillingPeriodInfo_H
...
class OAIContractBillingPeriodInfo : public OAIObject {
public:
    OAIContractBillingPeriodInfo();
    OAIContractBillingPeriodInfo(QString json);
    ~OAIContractBillingPeriodInfo() override;
    ...
    double getAmountBillingPeriodDiscount() const;
    void setAmountBillingPeriodDiscount(const double &amount_billing_period_discount);
    bool is_amount_billing_period_discount_Set() const;
    bool is_amount_billing_period_discount_Valid() const;
...
private:
    ...
    double m_amount_billing_period_discount;
    bool m_amount_billing_period_discount_isSet;
    bool m_amount_billing_period_discount_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContractBillingPeriodInfo)

#endif // OAIContractBillingPeriodInfo_H
