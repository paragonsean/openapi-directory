...
/*
 * OAILinks_deleteStoreShareLink.h
 *
 * 
 */

#ifndef OAILinks_deleteStoreShareLink_H
#define OAILinks_deleteStoreShareLink_H
...
class OAILinks_deleteStoreShareLink : public OAIObject {
public:
    OAILinks_deleteStoreShareLink();
    OAILinks_deleteStoreShareLink(QString json);
    ~OAILinks_deleteStoreShareLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_deleteStoreShareLink)

#endif // OAILinks_deleteStoreShareLink_H
