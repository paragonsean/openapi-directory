...
/*
 * OAIChannelCatalogMarketplaceProperty.h
 *
 * Model for fetching a channel catalog marketplace property
 */

#ifndef OAIChannelCatalogMarketplaceProperty_H
#define OAIChannelCatalogMarketplaceProperty_H
...
class OAIChannelCatalogMarketplaceProperty : public OAIObject {
public:
    OAIChannelCatalogMarketplaceProperty();
    OAIChannelCatalogMarketplaceProperty(QString json);
    ~OAIChannelCatalogMarketplaceProperty() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelCatalogMarketplaceProperty)

#endif // OAIChannelCatalogMarketplaceProperty_H
