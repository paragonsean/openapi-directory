...
/*
 * OAILinks_OptimiseByProductLink.h
 *
 * 
 */

#ifndef OAILinks_OptimiseByProductLink_H
#define OAILinks_OptimiseByProductLink_H
...
class OAILinks_OptimiseByProductLink : public OAIObject {
public:
    OAILinks_OptimiseByProductLink();
    OAILinks_OptimiseByProductLink(QString json);
    ~OAILinks_OptimiseByProductLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_OptimiseByProductLink)

#endif // OAILinks_OptimiseByProductLink_H
