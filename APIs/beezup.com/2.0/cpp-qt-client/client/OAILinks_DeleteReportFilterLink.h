...
/*
 * OAILinks_DeleteReportFilterLink.h
 *
 * 
 */

#ifndef OAILinks_DeleteReportFilterLink_H
#define OAILinks_DeleteReportFilterLink_H
...
class OAILinks_DeleteReportFilterLink : public OAIObject {
public:
    OAILinks_DeleteReportFilterLink();
    OAILinks_DeleteReportFilterLink(QString json);
    ~OAILinks_DeleteReportFilterLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_DeleteReportFilterLink)

#endif // OAILinks_DeleteReportFilterLink_H
