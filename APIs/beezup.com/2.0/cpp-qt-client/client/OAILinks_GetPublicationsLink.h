...
/*
 * OAILinks_GetPublicationsLink.h
 *
 * 
 */

#ifndef OAILinks_GetPublicationsLink_H
#define OAILinks_GetPublicationsLink_H
...
class OAILinks_GetPublicationsLink : public OAIObject {
public:
    OAILinks_GetPublicationsLink();
    OAILinks_GetPublicationsLink(QString json);
    ~OAILinks_GetPublicationsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetPublicationsLink)

#endif // OAILinks_GetPublicationsLink_H
