...
/*
 * OAILinks_getInvoicesLink.h
 *
 * 
 */

#ifndef OAILinks_getInvoicesLink_H
#define OAILinks_getInvoicesLink_H
...
class OAILinks_getInvoicesLink : public OAIObject {
public:
    OAILinks_getInvoicesLink();
    OAILinks_getInvoicesLink(QString json);
    ~OAILinks_getInvoicesLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_getInvoicesLink)

#endif // OAILinks_getInvoicesLink_H
