...
/*
 * OAIReportFilterParameters.h
 *
 * 
 */

#ifndef OAIReportFilterParameters_H
#define OAIReportFilterParameters_H
...
class OAIAnalyticsProductColumnFilters;

class OAIReportFilterParameters : public OAIObject {
public:
    OAIReportFilterParameters();
    OAIReportFilterParameters(QString json);
    ~OAIReportFilterParameters() override;
    ...
    OAIAnalyticsProductColumnFilters getAnalyticsProductColumnFilters() const;
    void setAnalyticsProductColumnFilters(const OAIAnalyticsProductColumnFilters &analytics_product_column_filters);
    bool is_analytics_product_column_filters_Set() const;
    bool is_analytics_product_column_filters_Valid() const;

    QList<QString> getProductColumnsToDisplay() const;
    void setProductColumnsToDisplay(const QList<QString> &product_columns_to_display);
    bool is_product_columns_to_display_Set() const;
    bool is_product_columns_to_display_Valid() const;

    OAIProductStateFilter getProductState() const;
    void setProductState(const OAIProductStateFilter &product_state);
    bool is_product_state_Set() const;
    bool is_product_state_Valid() const;
...
private:
    ...
    OAIAnalyticsProductColumnFilters m_analytics_product_column_filters;
    bool m_analytics_product_column_filters_isSet;
    bool m_analytics_product_column_filters_isValid;

    QList<QString> m_product_columns_to_display;
    bool m_product_columns_to_display_isSet;
    bool m_product_columns_to_display_isValid;

    OAIProductStateFilter m_product_state;
    bool m_product_state_isSet;
    bool m_product_state_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportFilterParameters)

#endif // OAIReportFilterParameters_H
