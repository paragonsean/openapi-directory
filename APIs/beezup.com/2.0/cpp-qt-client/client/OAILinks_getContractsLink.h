...
/*
 * OAILinks_getContractsLink.h
 *
 * 
 */

#ifndef OAILinks_getContractsLink_H
#define OAILinks_getContractsLink_H
...
class OAILinks_getContractsLink : public OAIObject {
public:
    OAILinks_getContractsLink();
    OAILinks_getContractsLink(QString json);
    ~OAILinks_getContractsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_getContractsLink)

#endif // OAILinks_getContractsLink_H
