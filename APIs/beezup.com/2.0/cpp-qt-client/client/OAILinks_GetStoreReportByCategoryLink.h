...
/*
 * OAILinks_GetStoreReportByCategoryLink.h
 *
 * 
 */

#ifndef OAILinks_GetStoreReportByCategoryLink_H
#define OAILinks_GetStoreReportByCategoryLink_H
...
class OAILinks_GetStoreReportByCategoryLink : public OAIObject {
public:
    OAILinks_GetStoreReportByCategoryLink();
    OAILinks_GetStoreReportByCategoryLink(QString json);
    ~OAILinks_GetStoreReportByCategoryLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetStoreReportByCategoryLink)

#endif // OAILinks_GetStoreReportByCategoryLink_H
