...
/*
 * OAILinks_HarvestOrderV3Link.h
 *
 * 
 */

#ifndef OAILinks_HarvestOrderV3Link_H
#define OAILinks_HarvestOrderV3Link_H
...
class OAILinks_HarvestOrderV3Link : public OAIObject {
public:
    OAILinks_HarvestOrderV3Link();
    OAILinks_HarvestOrderV3Link(QString json);
    ~OAILinks_HarvestOrderV3Link() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_HarvestOrderV3Link)

#endif // OAILinks_HarvestOrderV3Link_H
