...
/*
 * OAIReportFilterCommonParameters.h
 *
 * Contains common filter parameters
 */

#ifndef OAIReportFilterCommonParameters_H
#define OAIReportFilterCommonParameters_H
...
class OAIReportFilterCommonParameters : public OAIObject {
public:
    OAIReportFilterCommonParameters();
    OAIReportFilterCommonParameters(QString json);
    ~OAIReportFilterCommonParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportFilterCommonParameters)

#endif // OAIReportFilterCommonParameters_H
