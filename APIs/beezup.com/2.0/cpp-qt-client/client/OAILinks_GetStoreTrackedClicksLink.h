...
/*
 * OAILinks_GetStoreTrackedClicksLink.h
 *
 * 
 */

#ifndef OAILinks_GetStoreTrackedClicksLink_H
#define OAILinks_GetStoreTrackedClicksLink_H
...
class OAILinks_GetStoreTrackedClicksLink : public OAIObject {
public:
    OAILinks_GetStoreTrackedClicksLink();
    OAILinks_GetStoreTrackedClicksLink(QString json);
    ~OAILinks_GetStoreTrackedClicksLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetStoreTrackedClicksLink)

#endif // OAILinks_GetStoreTrackedClicksLink_H
