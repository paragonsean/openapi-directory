...
#ifndef OAICatalogColumn_H
#define OAICatalogColumn_H
...
class OAICatalogColumnLinks;

class OAICatalogColumn : public OAIObject {
public:
    OAICatalogColumn();
    OAICatalogColumn(QString json);
    ~OAICatalogColumn() override;
    ...
    OAICatalogColumnLinks getLinks() const;
    void setLinks(const OAICatalogColumnLinks &links);
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogColumn)

#endif // OAICatalogColumn_H
