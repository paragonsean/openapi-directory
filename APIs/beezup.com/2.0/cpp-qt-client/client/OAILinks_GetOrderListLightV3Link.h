...
/*
 * OAILinks_GetOrderListLightV3Link.h
 *
 * 
 */

#ifndef OAILinks_GetOrderListLightV3Link_H
#define OAILinks_GetOrderListLightV3Link_H
...
class OAILinks_GetOrderListLightV3Link : public OAIObject {
public:
    OAILinks_GetOrderListLightV3Link();
    OAILinks_GetOrderListLightV3Link(QString json);
    ~OAILinks_GetOrderListLightV3Link() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetOrderListLightV3Link)

#endif // OAILinks_GetOrderListLightV3Link_H
