...
/*
 * OAIReportByProductRequest.h
 *
 * 
 */

#ifndef OAIReportByProductRequest_H
#define OAIReportByProductRequest_H
...
class OAIReportByProductRequest : public OAIObject {
public:
    OAIReportByProductRequest();
    OAIReportByProductRequest(QString json);
    ~OAIReportByProductRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportByProductRequest)

#endif // OAIReportByProductRequest_H
