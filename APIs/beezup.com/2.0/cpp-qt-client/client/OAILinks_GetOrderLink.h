...
/*
 * OAILinks_GetOrderLink.h
 *
 * 
 */

#ifndef OAILinks_GetOrderLink_H
#define OAILinks_GetOrderLink_H
...
class OAILinks_GetOrderLink : public OAIObject {
public:
    OAILinks_GetOrderLink();
    OAILinks_GetOrderLink(QString json);
    ~OAILinks_GetOrderLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetOrderLink)

#endif // OAILinks_GetOrderLink_H
