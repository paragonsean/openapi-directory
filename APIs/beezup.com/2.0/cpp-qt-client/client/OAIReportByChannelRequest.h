...
/*
 * OAIReportByChannelRequest.h
 *
 * 
 */

#ifndef OAIReportByChannelRequest_H
#define OAIReportByChannelRequest_H
...
class OAIReportByChannelRequest : public OAIObject {
public:
    OAIReportByChannelRequest();
    OAIReportByChannelRequest(QString json);
    ~OAIReportByChannelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportByChannelRequest)

#endif // OAIReportByChannelRequest_H
