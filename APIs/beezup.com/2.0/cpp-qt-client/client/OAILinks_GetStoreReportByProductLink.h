...
/*
 * OAILinks_GetStoreReportByProductLink.h
 *
 * 
 */

#ifndef OAILinks_GetStoreReportByProductLink_H
#define OAILinks_GetStoreReportByProductLink_H
...
class OAILinks_GetStoreReportByProductLink : public OAIObject {
public:
    OAILinks_GetStoreReportByProductLink();
    OAILinks_GetStoreReportByProductLink(QString json);
    ~OAILinks_GetStoreReportByProductLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetStoreReportByProductLink)

#endif // OAILinks_GetStoreReportByProductLink_H
