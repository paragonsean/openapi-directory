...
public:
    ...
    OAIInvoicePaymentStatus getPaymentStatus() const;
    void setPaymentStatus(const OAIInvoicePaymentStatus &payment_status);
...
private:
    ...
    OAIInvoicePaymentStatus m_payment_status;
