...
/*
 * OAILinks_Importation_MapCustomColumnLink.h
 *
 * 
 */

#ifndef OAILinks_Importation_MapCustomColumnLink_H
#define OAILinks_Importation_MapCustomColumnLink_H
...
class OAILinks_Importation_MapCustomColumnLink : public OAIObject {
public:
    OAILinks_Importation_MapCustomColumnLink();
    OAILinks_Importation_MapCustomColumnLink(QString json);
    ~OAILinks_Importation_MapCustomColumnLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Importation_MapCustomColumnLink)

#endif // OAILinks_Importation_MapCustomColumnLink_H
