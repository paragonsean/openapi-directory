...
/*
 * OAILinks_GetStoreReportByDayLink.h
 *
 * 
 */

#ifndef OAILinks_GetStoreReportByDayLink_H
#define OAILinks_GetStoreReportByDayLink_H
...
class OAILinks_GetStoreReportByDayLink : public OAIObject {
public:
    OAILinks_GetStoreReportByDayLink();
    OAILinks_GetStoreReportByDayLink(QString json);
    ~OAILinks_GetStoreReportByDayLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetStoreReportByDayLink)

#endif // OAILinks_GetStoreReportByDayLink_H
