...
/*
 * OAILinks_GetStoreTrackingStatusLink.h
 *
 * 
 */

#ifndef OAILinks_GetStoreTrackingStatusLink_H
#define OAILinks_GetStoreTrackingStatusLink_H
...
class OAILinks_GetStoreTrackingStatusLink : public OAIObject {
public:
    OAILinks_GetStoreTrackingStatusLink();
    OAILinks_GetStoreTrackingStatusLink(QString json);
    ~OAILinks_GetStoreTrackingStatusLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetStoreTrackingStatusLink)

#endif // OAILinks_GetStoreTrackingStatusLink_H
