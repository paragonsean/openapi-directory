...
#include "OAIOrderedReportFilterCommonParameters.h"
...
OAIOrderedReportFilterCommonParameters::OAIOrderedReportFilterCommonParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderedReportFilterCommonParameters::OAIOrderedReportFilterCommonParameters() {
    this->initializeModel();
}

OAIOrderedReportFilterCommonParameters::~OAIOrderedReportFilterCommonParameters() {}

void OAIOrderedReportFilterCommonParameters::initializeModel() {
...
void OAIOrderedReportFilterCommonParameters::fromJson(QString jsonString) {
...
void OAIOrderedReportFilterCommonParameters::fromJsonObject(QJsonObject json) {
...
QString OAIOrderedReportFilterCommonParameters::asJson() const {
...
QJsonObject OAIOrderedReportFilterCommonParameters::asJsonObject() const {
    QJsonObject obj;
...
OAIReportAdvancedFilters OAIOrderedReportFilterCommonParameters::getAdvancedFilters() const {
    return m_advanced_filters;
}
void OAIOrderedReportFilterCommonParameters::setAdvancedFilters(const OAIReportAdvancedFilters &advanced_filters) {
    m_advanced_filters = advanced_filters;
    m_advanced_filters_isSet = true;
}

bool OAIOrderedReportFilterCommonParameters::is_advanced_filters_Set() const{
    return m_advanced_filters_isSet;
}

bool OAIOrderedReportFilterCommonParameters::is_advanced_filters_Valid() const{
    return m_advanced_filters_isValid;
}

QDateTime OAIOrderedReportFilterCommonParameters::getBeginPeriodUtcDate() const {
    return m_begin_period_utc_date;
}
void OAIOrderedReportFilterCommonParameters::setBeginPeriodUtcDate(const QDateTime &begin_period_utc_date) {
    m_begin_period_utc_date = begin_period_utc_date;
    m_begin_period_utc_date_isSet = true;
}

bool OAIOrderedReportFilterCommonParameters::is_begin_period_utc_date_Set() const{
    return m_begin_period_utc_date_isSet;
}

bool OAIOrderedReportFilterCommonParameters::is_begin_period_utc_date_Valid() const{
    return m_begin_period_utc_date_isValid;
}

OAIBeezUP_Common_CatalogCategoryFilter OAIOrderedReportFilterCommonParameters::getCategoryFilter() const {
    return m_category_filter;
}
void OAIOrderedReportFilterCommonParameters::setCategoryFilter(const OAIBeezUP_Common_CatalogCategoryFilter &category_filter) {
    m_category_filter = category_filter;
    m_category_filter_isSet = true;
}

bool OAIOrderedReportFilterCommonParameters::is_category_filter_Set() const{
    return m_category_filter_isSet;
}

bool OAIOrderedReportFilterCommonParameters::is_category_filter_Valid() const{
    return m_category_filter_isValid;
}

QString OAIOrderedReportFilterCommonParameters::getChannelId() const {
    return m_channel_id;
}
void OAIOrderedReportFilterCommonParameters::setChannelId(const QString &channel_id) {
    m_channel_id = channel_id;
    m_channel_id_isSet = true;
}

bool OAIOrderedReportFilterCommonParameters::is_channel_id_Set() const{
    return m_channel_id_isSet;
}

bool OAIOrderedReportFilterCommonParameters::is_channel_id_Valid() const{
    return m_channel_id_isValid;
}

QDateTime OAIOrderedReportFilterCommonParameters::getEndPeriodUtcDate() const {
    return m_end_period_utc_date;
}
void OAIOrderedReportFilterCommonParameters::setEndPeriodUtcDate(const QDateTime &end_period_utc_date) {
    m_end_period_utc_date = end_period_utc_date;
    m_end_period_utc_date_isSet = true;
}

bool OAIOrderedReportFilterCommonParameters::is_end_period_utc_date_Set() const{
    return m_end_period_utc_date_isSet;
}

bool OAIOrderedReportFilterCommonParameters::is_end_period_utc_date_Valid() const{
    return m_end_period_utc_date_isValid;
}

QList<OAIPerformanceIndicatorFilter> OAIOrderedReportFilterCommonParameters::getPerformanceIndicatorFilters() const {
    return m_performance_indicator_filters;
}
void OAIOrderedReportFilterCommonParameters::setPerformanceIndicatorFilters(const QList<OAIPerformanceIndicatorFilter> &performance_indicator_filters) {
    m_performance_indicator_filters = performance_indicator_filters;
    m_performance_indicator_filters_isSet = true;
}

bool OAIOrderedReportFilterCommonParameters::is_performance_indicator_filters_Set() const{
    return m_performance_indicator_filters_isSet;
}

bool OAIOrderedReportFilterCommonParameters::is_performance_indicator_filters_Valid() const{
    return m_performance_indicator_filters_isValid;
}

OAIReportFilterPeriodType OAIOrderedReportFilterCommonParameters::getPeriodType() const {
    return m_period_type;
}
void OAIOrderedReportFilterCommonParameters::setPeriodType(const OAIReportFilterPeriodType &period_type) {
    m_period_type = period_type;
    m_period_type_isSet = true;
}

bool OAIOrderedReportFilterCommonParameters::is_period_type_Set() const{
    return m_period_type_isSet;
}

bool OAIOrderedReportFilterCommonParameters::is_period_type_Valid() const{
    return m_period_type_isValid;
}

OAIPerformanceIndicatorType OAIOrderedReportFilterCommonParameters::getOrderBy() const {
    return m_order_by;
}
void OAIOrderedReportFilterCommonParameters::setOrderBy(const OAIPerformanceIndicatorType &order_by) {
    m_order_by = order_by;
    m_order_by_isSet = true;
}

bool OAIOrderedReportFilterCommonParameters::is_order_by_Set() const{
    return m_order_by_isSet;
}

bool OAIOrderedReportFilterCommonParameters::is_order_by_Valid() const{
    return m_order_by_isValid;
}

OAIOrderByDirection OAIOrderedReportFilterCommonParameters::getOrderByDirection() const {
    return m_order_by_direction;
}
void OAIOrderedReportFilterCommonParameters::setOrderByDirection(const OAIOrderByDirection &order_by_direction) {
    m_order_by_direction = order_by_direction;
    m_order_by_direction_isSet = true;
}

bool OAIOrderedReportFilterCommonParameters::is_order_by_direction_Set() const{
    return m_order_by_direction_isSet;
}

bool OAIOrderedReportFilterCommonParameters::is_order_by_direction_Valid() const{
    return m_order_by_direction_isValid;
}

bool OAIOrderedReportFilterCommonParameters::isSet() const {
...
bool OAIOrderedReportFilterCommonParameters::isValid() const {
