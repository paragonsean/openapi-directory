...
/*
 * OAILinks_GetChannelsLink.h
 *
 * 
 */

#ifndef OAILinks_GetChannelsLink_H
#define OAILinks_GetChannelsLink_H
...
class OAILinks_GetChannelsLink : public OAIObject {
public:
    OAILinks_GetChannelsLink();
    OAILinks_GetChannelsLink(QString json);
    ~OAILinks_GetChannelsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetChannelsLink)

#endif // OAILinks_GetChannelsLink_H
