...
/*
 * OAIOrderIdentifier.h
 *
 * 
 */

#ifndef OAIOrderIdentifier_H
#define OAIOrderIdentifier_H
...
class OAIOrderIdentifier : public OAIObject {
public:
    OAIOrderIdentifier();
    OAIOrderIdentifier(QString json);
    ~OAIOrderIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderIdentifier)

#endif // OAIOrderIdentifier_H
