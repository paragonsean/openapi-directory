...
/*
 * OAIOrderInvoiceGeneralSettings.h
 *
 * Order Invoice General Settings
 */

#ifndef OAIOrderInvoiceGeneralSettings_H
#define OAIOrderInvoiceGeneralSettings_H
...
class OAIOrderInvoiceGeneralSettings : public OAIObject {
public:
    OAIOrderInvoiceGeneralSettings();
    OAIOrderInvoiceGeneralSettings(QString json);
    ~OAIOrderInvoiceGeneralSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderInvoiceGeneralSettings)

#endif // OAIOrderInvoiceGeneralSettings_H
