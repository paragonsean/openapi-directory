...
/*
 * OAILinks_Catalog_GetCatalogColumnsLink.h
 *
 * 
 */

#ifndef OAILinks_Catalog_GetCatalogColumnsLink_H
#define OAILinks_Catalog_GetCatalogColumnsLink_H
...
class OAILinks_Catalog_GetCatalogColumnsLink : public OAIObject {
public:
    OAILinks_Catalog_GetCatalogColumnsLink();
    OAILinks_Catalog_GetCatalogColumnsLink(QString json);
    ~OAILinks_Catalog_GetCatalogColumnsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Catalog_GetCatalogColumnsLink)

#endif // OAILinks_Catalog_GetCatalogColumnsLink_H
