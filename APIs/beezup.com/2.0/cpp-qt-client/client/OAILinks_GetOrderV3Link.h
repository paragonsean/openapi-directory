...
/*
 * OAILinks_GetOrderV3Link.h
 *
 * 
 */

#ifndef OAILinks_GetOrderV3Link_H
#define OAILinks_GetOrderV3Link_H
...
class OAILinks_GetOrderV3Link : public OAIObject {
public:
    OAILinks_GetOrderV3Link();
    OAILinks_GetOrderV3Link(QString json);
    ~OAILinks_GetOrderV3Link() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetOrderV3Link)

#endif // OAILinks_GetOrderV3Link_H
