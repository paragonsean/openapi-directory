...
/*
 * OAILinks_SetMerchantOrderInfoListLink.h
 *
 * 
 */

#ifndef OAILinks_SetMerchantOrderInfoListLink_H
#define OAILinks_SetMerchantOrderInfoListLink_H
...
class OAILinks_SetMerchantOrderInfoListLink : public OAIObject {
public:
    OAILinks_SetMerchantOrderInfoListLink();
    OAILinks_SetMerchantOrderInfoListLink(QString json);
    ~OAILinks_SetMerchantOrderInfoListLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_SetMerchantOrderInfoListLink)

#endif // OAILinks_SetMerchantOrderInfoListLink_H
