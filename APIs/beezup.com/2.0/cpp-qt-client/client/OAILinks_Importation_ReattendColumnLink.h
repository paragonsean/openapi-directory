...
/*
 * OAILinks_Importation_ReattendColumnLink.h
 *
 * 
 */

#ifndef OAILinks_Importation_ReattendColumnLink_H
#define OAILinks_Importation_ReattendColumnLink_H
...
class OAILinks_Importation_ReattendColumnLink : public OAIObject {
public:
    OAILinks_Importation_ReattendColumnLink();
    OAILinks_Importation_ReattendColumnLink(QString json);
    ~OAILinks_Importation_ReattendColumnLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Importation_ReattendColumnLink)

#endif // OAILinks_Importation_ReattendColumnLink_H
