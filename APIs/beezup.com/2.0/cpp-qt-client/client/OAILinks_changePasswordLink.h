...
/*
 * OAILinks_changePasswordLink.h
 *
 * 
 */

#ifndef OAILinks_changePasswordLink_H
#define OAILinks_changePasswordLink_H
...
class OAILinks_changePasswordLink : public OAIObject {
public:
    OAILinks_changePasswordLink();
    OAILinks_changePasswordLink(QString json);
    ~OAILinks_changePasswordLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_changePasswordLink)

#endif // OAILinks_changePasswordLink_H
