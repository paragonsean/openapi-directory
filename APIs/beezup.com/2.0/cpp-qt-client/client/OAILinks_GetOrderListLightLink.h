...
/*
 * OAILinks_GetOrderListLightLink.h
 *
 * 
 */

#ifndef OAILinks_GetOrderListLightLink_H
#define OAILinks_GetOrderListLightLink_H
...
class OAILinks_GetOrderListLightLink : public OAIObject {
public:
    OAILinks_GetOrderListLightLink();
    OAILinks_GetOrderListLightLink(QString json);
    ~OAILinks_GetOrderListLightLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetOrderListLightLink)

#endif // OAILinks_GetOrderListLightLink_H
