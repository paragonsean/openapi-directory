...
/*
 * OAILinks_GetReportFilterLink.h
 *
 * 
 */

#ifndef OAILinks_GetReportFilterLink_H
#define OAILinks_GetReportFilterLink_H
...
class OAILinks_GetReportFilterLink : public OAIObject {
public:
    OAILinks_GetReportFilterLink();
    OAILinks_GetReportFilterLink(QString json);
    ~OAILinks_GetReportFilterLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetReportFilterLink)

#endif // OAILinks_GetReportFilterLink_H
