...
/*
 * OAILinks_UpdateRuleLink.h
 *
 * 
 */

#ifndef OAILinks_UpdateRuleLink_H
#define OAILinks_UpdateRuleLink_H
...
class OAILinks_UpdateRuleLink : public OAIObject {
public:
    OAILinks_UpdateRuleLink();
    OAILinks_UpdateRuleLink(QString json);
    ~OAILinks_UpdateRuleLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_UpdateRuleLink)

#endif // OAILinks_UpdateRuleLink_H
