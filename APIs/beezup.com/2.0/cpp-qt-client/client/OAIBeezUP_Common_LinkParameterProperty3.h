...
/*
 * OAIBeezUP_Common_LinkParameterProperty3.h
 *
 * 
 */

#ifndef OAIBeezUP_Common_LinkParameterProperty3_H
#define OAIBeezUP_Common_LinkParameterProperty3_H
...
class OAIBeezUP_Common_LinkParameterProperty3 : public OAIObject {
public:
    OAIBeezUP_Common_LinkParameterProperty3();
    OAIBeezUP_Common_LinkParameterProperty3(QString json);
    ~OAIBeezUP_Common_LinkParameterProperty3() override;
    ...
    OAIBeezUP_Common_ParameterType getType() const;
    void setType(const OAIBeezUP_Common_ParameterType &type);
...
private:
    ...
    OAIBeezUP_Common_ParameterType m_type;
    bool m_type_isSet;
    bool m_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBeezUP_Common_LinkParameterProperty3)

#endif // OAIBeezUP_Common_LinkParameterProperty3_H
