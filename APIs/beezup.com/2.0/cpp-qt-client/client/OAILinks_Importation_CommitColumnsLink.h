...
/*
 * OAILinks_Importation_CommitColumnsLink.h
 *
 * 
 */

#ifndef OAILinks_Importation_CommitColumnsLink_H
#define OAILinks_Importation_CommitColumnsLink_H
...
class OAILinks_Importation_CommitColumnsLink : public OAIObject {
public:
    OAILinks_Importation_CommitColumnsLink();
    OAILinks_Importation_CommitColumnsLink(QString json);
    ~OAILinks_Importation_CommitColumnsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Importation_CommitColumnsLink)

#endif // OAILinks_Importation_CommitColumnsLink_H
