...
/*
 * OAILinks_GetRuleLink.h
 *
 * 
 */

#ifndef OAILinks_GetRuleLink_H
#define OAILinks_GetRuleLink_H
...
class OAILinks_GetRuleLink : public OAIObject {
public:
    OAILinks_GetRuleLink();
    OAILinks_GetRuleLink(QString json);
    ~OAILinks_GetRuleLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetRuleLink)

#endif // OAILinks_GetRuleLink_H
