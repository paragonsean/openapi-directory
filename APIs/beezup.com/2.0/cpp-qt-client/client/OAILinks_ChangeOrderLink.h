...
/*
 * OAILinks_ChangeOrderLink.h
 *
 * 
 */

#ifndef OAILinks_ChangeOrderLink_H
#define OAILinks_ChangeOrderLink_H
...
class OAILinks_ChangeOrderLink : public OAIObject {
public:
    OAILinks_ChangeOrderLink();
    OAILinks_ChangeOrderLink(QString json);
    ~OAILinks_ChangeOrderLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_ChangeOrderLink)

#endif // OAILinks_ChangeOrderLink_H
