...
/*
 * OAILinks_GetChannelInfoLink.h
 *
 * 
 */

#ifndef OAILinks_GetChannelInfoLink_H
#define OAILinks_GetChannelInfoLink_H
...
class OAILinks_GetChannelInfoLink : public OAIObject {
public:
    OAILinks_GetChannelInfoLink();
    OAILinks_GetChannelInfoLink(QString json);
    ~OAILinks_GetChannelInfoLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetChannelInfoLink)

#endif // OAILinks_GetChannelInfoLink_H
