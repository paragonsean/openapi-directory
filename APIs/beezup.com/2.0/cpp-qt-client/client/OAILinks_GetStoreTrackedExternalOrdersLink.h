...
/*
 * OAILinks_GetStoreTrackedExternalOrdersLink.h
 *
 * 
 */

#ifndef OAILinks_GetStoreTrackedExternalOrdersLink_H
#define OAILinks_GetStoreTrackedExternalOrdersLink_H
...
class OAILinks_GetStoreTrackedExternalOrdersLink : public OAIObject {
public:
    OAILinks_GetStoreTrackedExternalOrdersLink();
    OAILinks_GetStoreTrackedExternalOrdersLink(QString json);
    ~OAILinks_GetStoreTrackedExternalOrdersLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetStoreTrackedExternalOrdersLink)

#endif // OAILinks_GetStoreTrackedExternalOrdersLink_H
