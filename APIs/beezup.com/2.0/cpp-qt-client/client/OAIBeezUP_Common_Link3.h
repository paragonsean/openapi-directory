...
/*
 * OAIBeezUP_Common_Link3.h
 *
 * 
 */

#ifndef OAIBeezUP_Common_Link3_H
#define OAIBeezUP_Common_Link3_H
...
class OAIBeezUP_Common_Link3 : public OAIObject {
public:
    OAIBeezUP_Common_Link3();
    OAIBeezUP_Common_Link3(QString json);
    ~OAIBeezUP_Common_Link3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBeezUP_Common_Link3)

#endif // OAIBeezUP_Common_Link3_H
