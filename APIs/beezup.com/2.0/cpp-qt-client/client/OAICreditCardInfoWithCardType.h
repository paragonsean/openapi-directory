...
/*
 * OAICreditCardInfoWithCardType.h
 *
 * 
 */

#ifndef OAICreditCardInfoWithCardType_H
#define OAICreditCardInfoWithCardType_H
...
class OAICreditCardInfoWithCardType : public OAIObject {
public:
    OAICreditCardInfoWithCardType();
    OAICreditCardInfoWithCardType(QString json);
    ~OAICreditCardInfoWithCardType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreditCardInfoWithCardType)

#endif // OAICreditCardInfoWithCardType_H
