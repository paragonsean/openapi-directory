...
/*
 * OAILinks_Importation_StartManualUpdateLink.h
 *
 * 
 */

#ifndef OAILinks_Importation_StartManualUpdateLink_H
#define OAILinks_Importation_StartManualUpdateLink_H
...
class OAILinks_Importation_StartManualUpdateLink : public OAIObject {
public:
    OAILinks_Importation_StartManualUpdateLink();
    OAILinks_Importation_StartManualUpdateLink(QString json);
    ~OAILinks_Importation_StartManualUpdateLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Importation_StartManualUpdateLink)

#endif // OAILinks_Importation_StartManualUpdateLink_H
