...
/*
 * OAIProductErrorCode.h
 *
 * 
 */

#ifndef OAIProductErrorCode_H
#define OAIProductErrorCode_H
...
class OAIProductErrorCode : public OAIObject {
public:
    OAIProductErrorCode();
    OAIProductErrorCode(QString json);
    ~OAIProductErrorCode() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductErrorCode)

#endif // OAIProductErrorCode_H
