...
/*
 * OAILinks_GetCustomerIndexLink.h
 *
 * 
 */

#ifndef OAILinks_GetCustomerIndexLink_H
#define OAILinks_GetCustomerIndexLink_H
...
class OAILinks_GetCustomerIndexLink : public OAIObject {
public:
    OAILinks_GetCustomerIndexLink();
    OAILinks_GetCustomerIndexLink(QString json);
    ~OAILinks_GetCustomerIndexLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetCustomerIndexLink)

#endif // OAILinks_GetCustomerIndexLink_H
