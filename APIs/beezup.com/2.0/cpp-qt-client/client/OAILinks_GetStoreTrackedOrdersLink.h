...
/*
 * OAILinks_GetStoreTrackedOrdersLink.h
 *
 * 
 */

#ifndef OAILinks_GetStoreTrackedOrdersLink_H
#define OAILinks_GetStoreTrackedOrdersLink_H
...
class OAILinks_GetStoreTrackedOrdersLink : public OAIObject {
public:
    OAILinks_GetStoreTrackedOrdersLink();
    OAILinks_GetStoreTrackedOrdersLink(QString json);
    ~OAILinks_GetStoreTrackedOrdersLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetStoreTrackedOrdersLink)

#endif // OAILinks_GetStoreTrackedOrdersLink_H
