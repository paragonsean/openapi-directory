...
/*
 * OAILinks_Importation_GetDetectedCatalogColumnsLink.h
 *
 * 
 */

#ifndef OAILinks_Importation_GetDetectedCatalogColumnsLink_H
#define OAILinks_Importation_GetDetectedCatalogColumnsLink_H
...
class OAILinks_Importation_GetDetectedCatalogColumnsLink : public OAIObject {
public:
    OAILinks_Importation_GetDetectedCatalogColumnsLink();
    OAILinks_Importation_GetDetectedCatalogColumnsLink(QString json);
    ~OAILinks_Importation_GetDetectedCatalogColumnsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Importation_GetDetectedCatalogColumnsLink)

#endif // OAILinks_Importation_GetDetectedCatalogColumnsLink_H
