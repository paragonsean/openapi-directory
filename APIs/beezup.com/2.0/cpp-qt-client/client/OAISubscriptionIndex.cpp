...
OAISubscriptionIndex::OAISubscriptionIndex(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISubscriptionIndex::OAISubscriptionIndex() {
    this->initializeModel();
}

OAISubscriptionIndex::~OAISubscriptionIndex() {}

void OAISubscriptionIndex::initializeModel() {
...
void OAISubscriptionIndex::fromJson(QString jsonString) {
...
void OAISubscriptionIndex::fromJsonObject(QJsonObject json) {
...
QString OAISubscriptionIndex::asJson() const {
...
QJsonObject OAISubscriptionIndex::asJsonObject() const {
    QJsonObject obj;
...
OAIConsumptionAvailabilityStatus OAISubscriptionIndex::getConsumerHealthStatus() const {
    return m_consumer_health_status;
}
void OAISubscriptionIndex::setConsumerHealthStatus(const OAIConsumptionAvailabilityStatus &consumer_health_status) {
    m_consumer_health_status = consumer_health_status;
    m_consumer_health_status_isSet = true;
}

bool OAISubscriptionIndex::is_consumer_health_status_Set() const{
    return m_consumer_health_status_isSet;
}

bool OAISubscriptionIndex::is_consumer_health_status_Valid() const{
    return m_consumer_health_status_isValid;
}

QString OAISubscriptionIndex::getConsumerLastRequestSentUri() const {
    return m_consumer_last_request_sent_uri;
}
void OAISubscriptionIndex::setConsumerLastRequestSentUri(const QString &consumer_last_request_sent_uri) {
    m_consumer_last_request_sent_uri = consumer_last_request_sent_uri;
    m_consumer_last_request_sent_uri_isSet = true;
}

bool OAISubscriptionIndex::is_consumer_last_request_sent_uri_Set() const{
    return m_consumer_last_request_sent_uri_isSet;
}

bool OAISubscriptionIndex::is_consumer_last_request_sent_uri_Valid() const{
    return m_consumer_last_request_sent_uri_isValid;
}

QDateTime OAISubscriptionIndex::getConsumerUnvailableSinceUtcDate() const {
    return m_consumer_unvailable_since_utc_date;
}
void OAISubscriptionIndex::setConsumerUnvailableSinceUtcDate(const QDateTime &consumer_unvailable_since_utc_date) {
    m_consumer_unvailable_since_utc_date = consumer_unvailable_since_utc_date;
    m_consumer_unvailable_since_utc_date_isSet = true;
}

bool OAISubscriptionIndex::is_consumer_unvailable_since_utc_date_Set() const{
    return m_consumer_unvailable_since_utc_date_isSet;
}

bool OAISubscriptionIndex::is_consumer_unvailable_since_utc_date_Valid() const{
    return m_consumer_unvailable_since_utc_date_isValid;
}

QString OAISubscriptionIndex::getId() const {
    return m_id;
}
void OAISubscriptionIndex::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISubscriptionIndex::is_id_Set() const{
    return m_id_isSet;
}

bool OAISubscriptionIndex::is_id_Valid() const{
    return m_id_isValid;
}

OAIErrorResponseMessage OAISubscriptionIndex::getLastErrorMessage() const {
    return m_last_error_message;
}
void OAISubscriptionIndex::setLastErrorMessage(const OAIErrorResponseMessage &last_error_message) {
    m_last_error_message = last_error_message;
    m_last_error_message_isSet = true;
}

bool OAISubscriptionIndex::is_last_error_message_Set() const{
    return m_last_error_message_isSet;
}

bool OAISubscriptionIndex::is_last_error_message_Valid() const{
    return m_last_error_message_isValid;
}

QDateTime OAISubscriptionIndex::getLastOrderPushedModificationUtcDate() const {
    return m_last_order_pushed_modification_utc_date;
}
void OAISubscriptionIndex::setLastOrderPushedModificationUtcDate(const QDateTime &last_order_pushed_modification_utc_date) {
...
bool OAISubscriptionIndex::is_last_order_pushed_modification_utc_date_Set() const{
    return m_last_order_pushed_modification_utc_date_isSet;
}

bool OAISubscriptionIndex::is_last_order_pushed_modification_utc_date_Valid() const{
    return m_last_order_pushed_modification_utc_date_isValid;
}

QDateTime OAISubscriptionIndex::getLastRetryUtcDate() const {
    return m_last_retry_utc_date;
}
void OAISubscriptionIndex::setLastRetryUtcDate(const QDateTime &last_retry_utc_date) {
    m_last_retry_utc_date = last_retry_utc_date;
    m_last_retry_utc_date_isSet = true;
}

bool OAISubscriptionIndex::is_last_retry_utc_date_Set() const{
    return m_last_retry_utc_date_isSet;
}

bool OAISubscriptionIndex::is_last_retry_utc_date_Valid() const{
    return m_last_retry_utc_date_isValid;
}

QDateTime OAISubscriptionIndex::getLastSuccessfulOrderPushedUtcDate() const {
    return m_last_successful_order_pushed_utc_date;
}
void OAISubscriptionIndex::setLastSuccessfulOrderPushedUtcDate(const QDateTime &last_successful_order_pushed_utc_date) {
...
bool OAISubscriptionIndex::is_last_successful_order_pushed_utc_date_Set() const{
    return m_last_successful_order_pushed_utc_date_isSet;
}

bool OAISubscriptionIndex::is_last_successful_order_pushed_utc_date_Valid() const{
    return m_last_successful_order_pushed_utc_date_isValid;
}

qint32 OAISubscriptionIndex::getMaxRetryCount() const {
    return m_max_retry_count;
}
void OAISubscriptionIndex::setMaxRetryCount(const qint32 &max_retry_count) {
    m_max_retry_count = max_retry_count;
    m_max_retry_count_isSet = true;
}

bool OAISubscriptionIndex::is_max_retry_count_Set() const{
    return m_max_retry_count_isSet;
}

bool OAISubscriptionIndex::is_max_retry_count_Valid() const{
    return m_max_retry_count_isValid;
}

QString OAISubscriptionIndex::getMerchantApplicationName() const {
    return m_merchant_application_name;
}
void OAISubscriptionIndex::setMerchantApplicationName(const QString &merchant_application_name) {
    m_merchant_application_name = merchant_application_name;
    m_merchant_application_name_isSet = true;
}

bool OAISubscriptionIndex::is_merchant_application_name_Set() const{
    return m_merchant_application_name_isSet;
}

bool OAISubscriptionIndex::is_merchant_application_name_Valid() const{
    return m_merchant_application_name_isValid;
}

QString OAISubscriptionIndex::getMerchantApplicationVersion() const {
    return m_merchant_application_version;
}
void OAISubscriptionIndex::setMerchantApplicationVersion(const QString &merchant_application_version) {
    m_merchant_application_version = merchant_application_version;
    m_merchant_application_version_isSet = true;
}

bool OAISubscriptionIndex::is_merchant_application_version_Set() const{
    return m_merchant_application_version_isSet;
}

bool OAISubscriptionIndex::is_merchant_application_version_Valid() const{
    return m_merchant_application_version_isValid;
}

QString OAISubscriptionIndex::getMerchantEmailAlert() const {
    return m_merchant_email_alert;
}
void OAISubscriptionIndex::setMerchantEmailAlert(const QString &merchant_email_alert) {
    m_merchant_email_alert = merchant_email_alert;
    m_merchant_email_alert_isSet = true;
}

bool OAISubscriptionIndex::is_merchant_email_alert_Set() const{
    return m_merchant_email_alert_isSet;
}

bool OAISubscriptionIndex::is_merchant_email_alert_Valid() const{
    return m_merchant_email_alert_isValid;
}

QString OAISubscriptionIndex::getName() const {
    return m_name;
}
void OAISubscriptionIndex::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISubscriptionIndex::is_name_Set() const{
    return m_name_isSet;
}

bool OAISubscriptionIndex::is_name_Valid() const{
    return m_name_isValid;
}

QDateTime OAISubscriptionIndex::getNextScheduledRetryUtcDate() const {
    return m_next_scheduled_retry_utc_date;
}
void OAISubscriptionIndex::setNextScheduledRetryUtcDate(const QDateTime &next_scheduled_retry_utc_date) {
    m_next_scheduled_retry_utc_date = next_scheduled_retry_utc_date;
    m_next_scheduled_retry_utc_date_isSet = true;
}

bool OAISubscriptionIndex::is_next_scheduled_retry_utc_date_Set() const{
    return m_next_scheduled_retry_utc_date_isSet;
}

bool OAISubscriptionIndex::is_next_scheduled_retry_utc_date_Valid() const{
    return m_next_scheduled_retry_utc_date_isValid;
}

QDateTime OAISubscriptionIndex::getRecoverBeginPeriodOrderLastModificationUtcDate() const {
    return m_recover_begin_period_order_last_modification_utc_date;
}
void OAISubscriptionIndex::setRecoverBeginPeriodOrderLastModificationUtcDate(const QDateTime &recover_begin_period_order_last_modification_utc_date) {
...
bool OAISubscriptionIndex::is_recover_begin_period_order_last_modification_utc_date_Set() const{
    return m_recover_begin_period_order_last_modification_utc_date_isSet;
}

bool OAISubscriptionIndex::is_recover_begin_period_order_last_modification_utc_date_Valid() const{
    return m_recover_begin_period_order_last_modification_utc_date_isValid;
}

QDateTime OAISubscriptionIndex::getRecoverEndPeriodOrderLastModificationUtcDate() const {
    return m_recover_end_period_order_last_modification_utc_date;
}
void OAISubscriptionIndex::setRecoverEndPeriodOrderLastModificationUtcDate(const QDateTime &recover_end_period_order_last_modification_utc_date) {
...
bool OAISubscriptionIndex::is_recover_end_period_order_last_modification_utc_date_Set() const{
    return m_recover_end_period_order_last_modification_utc_date_isSet;
}

bool OAISubscriptionIndex::is_recover_end_period_order_last_modification_utc_date_Valid() const{
    return m_recover_end_period_order_last_modification_utc_date_isValid;
}

qint32 OAISubscriptionIndex::getRetryCount() const {
    return m_retry_count;
}
void OAISubscriptionIndex::setRetryCount(const qint32 &retry_count) {
    m_retry_count = retry_count;
    m_retry_count_isSet = true;
}

bool OAISubscriptionIndex::is_retry_count_Set() const{
    return m_retry_count_isSet;
}

bool OAISubscriptionIndex::is_retry_count_Valid() const{
    return m_retry_count_isValid;
}

OAISubscriptionStatus OAISubscriptionIndex::getStatus() const {
    return m_status;
}
void OAISubscriptionIndex::setStatus(const OAISubscriptionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISubscriptionIndex::is_status_Set() const{
    return m_status_isSet;
}

bool OAISubscriptionIndex::is_status_Valid() const{
    return m_status_isValid;
}

QString OAISubscriptionIndex::getTargetUrl() const {
    return m_target_url;
}
void OAISubscriptionIndex::setTargetUrl(const QString &target_url) {
    m_target_url = target_url;
    m_target_url_isSet = true;
}

bool OAISubscriptionIndex::is_target_url_Set() const{
    return m_target_url_isSet;
}

bool OAISubscriptionIndex::is_target_url_Valid() const{
    return m_target_url_isValid;
}

OAISubscriptionLinks OAISubscriptionIndex::getLinks() const {
    return m_links;
}
void OAISubscriptionIndex::setLinks(const OAISubscriptionLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAISubscriptionIndex::is_links_Set() const{
    return m_links_isSet;
}

bool OAISubscriptionIndex::is_links_Valid() const{
    return m_links_isValid;
}

bool OAISubscriptionIndex::isSet() const {
...
bool OAISubscriptionIndex::isValid() const {
