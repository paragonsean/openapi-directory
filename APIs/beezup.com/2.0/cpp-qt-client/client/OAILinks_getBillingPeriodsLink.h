...
/*
 * OAILinks_getBillingPeriodsLink.h
 *
 * 
 */

#ifndef OAILinks_getBillingPeriodsLink_H
#define OAILinks_getBillingPeriodsLink_H
...
class OAILinks_getBillingPeriodsLink : public OAIObject {
public:
    OAILinks_getBillingPeriodsLink();
    OAILinks_getBillingPeriodsLink(QString json);
    ~OAILinks_getBillingPeriodsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_getBillingPeriodsLink)

#endif // OAILinks_getBillingPeriodsLink_H
