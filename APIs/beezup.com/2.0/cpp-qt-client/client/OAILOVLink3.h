...
#ifndef OAILOVLink3_H
#define OAILOVLink3_H
...
class OAILOVLink3 : public OAIObject {
public:
    OAILOVLink3();
    OAILOVLink3(QString json);
    ~OAILOVLink3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILOVLink3)
