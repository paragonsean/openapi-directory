...
/*
 * OAILinks_createStoreLink.h
 *
 * 
 */

#ifndef OAILinks_createStoreLink_H
#define OAILinks_createStoreLink_H
...
class OAILinks_createStoreLink : public OAIObject {
public:
    OAILinks_createStoreLink();
    OAILinks_createStoreLink(QString json);
    ~OAILinks_createStoreLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_createStoreLink)

#endif // OAILinks_createStoreLink_H
