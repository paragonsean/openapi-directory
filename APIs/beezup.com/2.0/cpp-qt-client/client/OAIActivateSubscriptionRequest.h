...
/*
 * OAIActivateSubscriptionRequest.h
 *
 * 
 */

#ifndef OAIActivateSubscriptionRequest_H
#define OAIActivateSubscriptionRequest_H
...
class OAIActivateSubscriptionRequest : public OAIObject {
public:
    OAIActivateSubscriptionRequest();
    OAIActivateSubscriptionRequest(QString json);
    ~OAIActivateSubscriptionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivateSubscriptionRequest)

#endif // OAIActivateSubscriptionRequest_H
