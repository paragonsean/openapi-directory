...
/*
 * OAILinks_RunRulesLink.h
 *
 * 
 */

#ifndef OAILinks_RunRulesLink_H
#define OAILinks_RunRulesLink_H
...
class OAILinks_RunRulesLink : public OAIObject {
public:
    OAILinks_RunRulesLink();
    OAILinks_RunRulesLink(QString json);
    ~OAILinks_RunRulesLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_RunRulesLink)

#endif // OAILinks_RunRulesLink_H
