...
/*
 * OAILinks_GetUserListOfValuesLink.h
 *
 * 
 */

#ifndef OAILinks_GetUserListOfValuesLink_H
#define OAILinks_GetUserListOfValuesLink_H
...
class OAILinks_GetUserListOfValuesLink : public OAIObject {
public:
    OAILinks_GetUserListOfValuesLink();
    OAILinks_GetUserListOfValuesLink(QString json);
    ~OAILinks_GetUserListOfValuesLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetUserListOfValuesLink)

#endif // OAILinks_GetUserListOfValuesLink_H
