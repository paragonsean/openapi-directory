...
/*
 * OAIOrderIdentifierWithETag.h
 *
 * 
 */

#ifndef OAIOrderIdentifierWithETag_H
#define OAIOrderIdentifierWithETag_H
...
class OAIOrderIdentifierWithETag : public OAIObject {
public:
    OAIOrderIdentifierWithETag();
    OAIOrderIdentifierWithETag(QString json);
    ~OAIOrderIdentifierWithETag() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderIdentifierWithETag)

#endif // OAIOrderIdentifierWithETag_H
