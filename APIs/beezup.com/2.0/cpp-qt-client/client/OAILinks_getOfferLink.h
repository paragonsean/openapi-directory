...
/*
 * OAILinks_getOfferLink.h
 *
 * 
 */

#ifndef OAILinks_getOfferLink_H
#define OAILinks_getOfferLink_H
...
class OAILinks_getOfferLink : public OAIObject {
public:
    OAILinks_getOfferLink();
    OAILinks_getOfferLink(QString json);
    ~OAILinks_getOfferLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_getOfferLink)

#endif // OAILinks_getOfferLink_H
