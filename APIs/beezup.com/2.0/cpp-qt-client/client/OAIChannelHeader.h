...
#ifndef OAIChannelHeader_H
#define OAIChannelHeader_H
...
namespace OpenAPI {
class OAIChannelHeaderLinks;

class OAIChannelHeader : public OAIObject {
public:
    OAIChannelHeader();
    OAIChannelHeader(QString json);
    ~OAIChannelHeader() override;
    ...
    OAIChannelHeaderLinks getLinks() const;
    void setLinks(const OAIChannelHeaderLinks &links);
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelHeader)

#endif // OAIChannelHeader_H
