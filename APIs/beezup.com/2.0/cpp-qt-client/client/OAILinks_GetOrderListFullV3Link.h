...
/*
 * OAILinks_GetOrderListFullV3Link.h
 *
 * 
 */

#ifndef OAILinks_GetOrderListFullV3Link_H
#define OAILinks_GetOrderListFullV3Link_H
...
class OAILinks_GetOrderListFullV3Link : public OAIObject {
public:
    OAILinks_GetOrderListFullV3Link();
    OAILinks_GetOrderListFullV3Link(QString json);
    ~OAILinks_GetOrderListFullV3Link() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetOrderListFullV3Link)

#endif // OAILinks_GetOrderListFullV3Link_H
