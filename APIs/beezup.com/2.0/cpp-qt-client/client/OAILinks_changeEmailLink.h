...
/*
 * OAILinks_changeEmailLink.h
 *
 * 
 */

#ifndef OAILinks_changeEmailLink_H
#define OAILinks_changeEmailLink_H
...
class OAILinks_changeEmailLink : public OAIObject {
public:
    OAILinks_changeEmailLink();
    OAILinks_changeEmailLink(QString json);
    ~OAILinks_changeEmailLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_changeEmailLink)

#endif // OAILinks_changeEmailLink_H
