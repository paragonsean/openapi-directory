...
/*
 * OAIOptimiseRequest.h
 *
 * 
 */

#ifndef OAIOptimiseRequest_H
#define OAIOptimiseRequest_H
...
class OAIOptimiseRequest : public OAIObject {
public:
    OAIOptimiseRequest();
    OAIOptimiseRequest(QString json);
    ~OAIOptimiseRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOptimiseRequest)

#endif // OAIOptimiseRequest_H
