...
/*
 * OAILinks_GetOrderHistoryLink.h
 *
 * 
 */

#ifndef OAILinks_GetOrderHistoryLink_H
#define OAILinks_GetOrderHistoryLink_H
...
class OAILinks_GetOrderHistoryLink : public OAIObject {
public:
    OAILinks_GetOrderHistoryLink();
    OAILinks_GetOrderHistoryLink(QString json);
    ~OAILinks_GetOrderHistoryLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetOrderHistoryLink)

#endif // OAILinks_GetOrderHistoryLink_H
