...
/*
 * OAILinks_Importation_UnmapCustomColumnLink.h
 *
 * 
 */

#ifndef OAILinks_Importation_UnmapCustomColumnLink_H
#define OAILinks_Importation_UnmapCustomColumnLink_H
...
class OAILinks_Importation_UnmapCustomColumnLink : public OAIObject {
public:
    OAILinks_Importation_UnmapCustomColumnLink();
    OAILinks_Importation_UnmapCustomColumnLink(QString json);
    ~OAILinks_Importation_UnmapCustomColumnLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Importation_UnmapCustomColumnLink)

#endif // OAILinks_Importation_UnmapCustomColumnLink_H
