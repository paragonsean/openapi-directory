...
/*
 * OAIChangeOrderReporting.h
 *
 * The reporting related to a change order operation
 */

#ifndef OAIChangeOrderReporting_H
#define OAIChangeOrderReporting_H
...
class OAIChangeOrderReporting : public OAIObject {
public:
    OAIChangeOrderReporting();
    OAIChangeOrderReporting(QString json);
    ~OAIChangeOrderReporting() override;
    ...
    QString getChangeOrderType() const;
    void setChangeOrderType(const QString &change_order_type);
    bool is_change_order_type_Set() const;
    bool is_change_order_type_Valid() const;
...
private:
    ...
    QString m_change_order_type;
    bool m_change_order_type_isSet;
    bool m_change_order_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChangeOrderReporting)

#endif // OAIChangeOrderReporting_H
