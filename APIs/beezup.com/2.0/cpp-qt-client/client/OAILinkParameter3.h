...
#ifndef OAILinkParameter3_H
#define OAILinkParameter3_H

#include <QJsonObject>

#include "OAILOVLink3.h"
#include "OAILinkParameterProperty3.h"
#include "OAIObject.h"
#include "OAIParameterIn.h"
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAILOVLink3;
class OAILinkParameterProperty3;

class OAILinkParameter3 : public OAIObject {
public:
    OAILinkParameter3();
    OAILinkParameter3(QString json);
    ~OAILinkParameter3() override;
    ...
    OAIParameterIn getIn() const;
    void setIn(const OAIParameterIn &in);
    ...
    QMap<QString, OAILinkParameterProperty3> getProperties() const;
    void setProperties(const QMap<QString, OAILinkParameterProperty3> &properties);
...
private:
    ...
    QMap<QString, OAILinkParameterProperty3> m_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinkParameter3)

#endif // OAILinkParameter3_H
