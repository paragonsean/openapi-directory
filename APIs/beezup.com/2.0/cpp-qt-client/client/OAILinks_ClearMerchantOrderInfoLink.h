...
/*
 * OAILinks_ClearMerchantOrderInfoLink.h
 *
 * 
 */

#ifndef OAILinks_ClearMerchantOrderInfoLink_H
#define OAILinks_ClearMerchantOrderInfoLink_H
...
class OAILinks_ClearMerchantOrderInfoLink : public OAIObject {
public:
    OAILinks_ClearMerchantOrderInfoLink();
    OAILinks_ClearMerchantOrderInfoLink(QString json);
    ~OAILinks_ClearMerchantOrderInfoLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_ClearMerchantOrderInfoLink)

#endif // OAILinks_ClearMerchantOrderInfoLink_H
