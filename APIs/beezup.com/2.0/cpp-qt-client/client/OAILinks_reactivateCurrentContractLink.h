...
/*
 * OAILinks_reactivateCurrentContractLink.h
 *
 * 
 */

#ifndef OAILinks_reactivateCurrentContractLink_H
#define OAILinks_reactivateCurrentContractLink_H
...
class OAILinks_reactivateCurrentContractLink : public OAIObject {
public:
    OAILinks_reactivateCurrentContractLink();
    OAILinks_reactivateCurrentContractLink(QString json);
    ~OAILinks_reactivateCurrentContractLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_reactivateCurrentContractLink)

#endif // OAILinks_reactivateCurrentContractLink_H
