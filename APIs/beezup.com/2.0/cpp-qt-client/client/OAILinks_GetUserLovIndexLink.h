...
/*
 * OAILinks_GetUserLovIndexLink.h
 *
 * 
 */

#ifndef OAILinks_GetUserLovIndexLink_H
#define OAILinks_GetUserLovIndexLink_H
...
class OAILinks_GetUserLovIndexLink : public OAIObject {
public:
    OAILinks_GetUserLovIndexLink();
    OAILinks_GetUserLovIndexLink(QString json);
    ~OAILinks_GetUserLovIndexLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetUserLovIndexLink)

#endif // OAILinks_GetUserLovIndexLink_H
