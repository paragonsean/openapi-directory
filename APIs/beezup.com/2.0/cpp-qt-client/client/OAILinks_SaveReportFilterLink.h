...
/*
 * OAILinks_SaveReportFilterLink.h
 *
 * 
 */

#ifndef OAILinks_SaveReportFilterLink_H
#define OAILinks_SaveReportFilterLink_H
...
class OAILinks_SaveReportFilterLink : public OAIObject {
public:
    OAILinks_SaveReportFilterLink();
    OAILinks_SaveReportFilterLink(QString json);
    ~OAILinks_SaveReportFilterLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_SaveReportFilterLink)

#endif // OAILinks_SaveReportFilterLink_H
