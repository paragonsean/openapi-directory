...
/*
 * OAILinks_getFriendInfoLink.h
 *
 * 
 */

#ifndef OAILinks_getFriendInfoLink_H
#define OAILinks_getFriendInfoLink_H
...
class OAILinks_getFriendInfoLink : public OAIObject {
public:
    OAILinks_getFriendInfoLink();
    OAILinks_getFriendInfoLink(QString json);
    ~OAILinks_getFriendInfoLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_getFriendInfoLink)

#endif // OAILinks_getFriendInfoLink_H
