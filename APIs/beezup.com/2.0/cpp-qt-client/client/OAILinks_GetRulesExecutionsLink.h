...
/*
 * OAILinks_GetRulesExecutionsLink.h
 *
 * 
 */

#ifndef OAILinks_GetRulesExecutionsLink_H
#define OAILinks_GetRulesExecutionsLink_H
...
class OAILinks_GetRulesExecutionsLink : public OAIObject {
public:
    OAILinks_GetRulesExecutionsLink();
    OAILinks_GetRulesExecutionsLink(QString json);
    ~OAILinks_GetRulesExecutionsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetRulesExecutionsLink)

#endif // OAILinks_GetRulesExecutionsLink_H
