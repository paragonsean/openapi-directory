...
/*
 * OAILinks_getUserAccountInfoLink.h
 *
 * 
 */

#ifndef OAILinks_getUserAccountInfoLink_H
#define OAILinks_getUserAccountInfoLink_H
...
class OAILinks_getUserAccountInfoLink : public OAIObject {
public:
    OAILinks_getUserAccountInfoLink();
    OAILinks_getUserAccountInfoLink(QString json);
    ~OAILinks_getUserAccountInfoLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_getUserAccountInfoLink)

#endif // OAILinks_getUserAccountInfoLink_H
