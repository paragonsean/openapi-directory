...
/*
 * OAILinks_saveCompanyInfoLink.h
 *
 * 
 */

#ifndef OAILinks_saveCompanyInfoLink_H
#define OAILinks_saveCompanyInfoLink_H
...
class OAILinks_saveCompanyInfoLink : public OAIObject {
public:
    OAILinks_saveCompanyInfoLink();
    OAILinks_saveCompanyInfoLink(QString json);
    ~OAILinks_saveCompanyInfoLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_saveCompanyInfoLink)

#endif // OAILinks_saveCompanyInfoLink_H
