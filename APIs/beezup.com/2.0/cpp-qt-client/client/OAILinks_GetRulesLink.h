...
/*
 * OAILinks_GetRulesLink.h
 *
 * 
 */

#ifndef OAILinks_GetRulesLink_H
#define OAILinks_GetRulesLink_H
...
class OAILinks_GetRulesLink : public OAIObject {
public:
    OAILinks_GetRulesLink();
    OAILinks_GetRulesLink(QString json);
    ~OAILinks_GetRulesLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetRulesLink)

#endif // OAILinks_GetRulesLink_H
