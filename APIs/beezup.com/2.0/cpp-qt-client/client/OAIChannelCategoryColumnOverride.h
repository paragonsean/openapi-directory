...
/*
 * OAIChannelCategoryColumnOverride.h
 *
 * 
 */

#ifndef OAIChannelCategoryColumnOverride_H
#define OAIChannelCategoryColumnOverride_H
...
class OAIChannelCategoryColumnOverride : public OAIObject {
public:
    OAIChannelCategoryColumnOverride();
    OAIChannelCategoryColumnOverride(QString json);
    ~OAIChannelCategoryColumnOverride() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelCategoryColumnOverride)

#endif // OAIChannelCategoryColumnOverride_H
