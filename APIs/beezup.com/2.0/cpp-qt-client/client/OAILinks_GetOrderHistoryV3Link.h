...
/*
 * OAILinks_GetOrderHistoryV3Link.h
 *
 * 
 */

#ifndef OAILinks_GetOrderHistoryV3Link_H
#define OAILinks_GetOrderHistoryV3Link_H
...
class OAILinks_GetOrderHistoryV3Link : public OAIObject {
public:
    OAILinks_GetOrderHistoryV3Link();
    OAILinks_GetOrderHistoryV3Link(QString json);
    ~OAILinks_GetOrderHistoryV3Link() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetOrderHistoryV3Link)

#endif // OAILinks_GetOrderHistoryV3Link_H
