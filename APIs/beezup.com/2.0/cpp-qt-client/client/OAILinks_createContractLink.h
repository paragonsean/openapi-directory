...
/*
 * OAILinks_createContractLink.h
 *
 * 
 */

#ifndef OAILinks_createContractLink_H
#define OAILinks_createContractLink_H
...
class OAILinks_createContractLink : public OAIObject {
public:
    OAILinks_createContractLink();
    OAILinks_createContractLink(QString json);
    ~OAILinks_createContractLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_createContractLink)

#endif // OAILinks_createContractLink_H
