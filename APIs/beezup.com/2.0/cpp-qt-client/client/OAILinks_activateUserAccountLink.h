...
/*
 * OAILinks_activateUserAccountLink.h
 *
 * 
 */

#ifndef OAILinks_activateUserAccountLink_H
#define OAILinks_activateUserAccountLink_H
...
class OAILinks_activateUserAccountLink : public OAIObject {
public:
    OAILinks_activateUserAccountLink();
    OAILinks_activateUserAccountLink(QString json);
    ~OAILinks_activateUserAccountLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_activateUserAccountLink)

#endif // OAILinks_activateUserAccountLink_H
