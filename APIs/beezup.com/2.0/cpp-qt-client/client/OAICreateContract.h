...
#ifndef OAICreateContract_H
#define OAICreateContract_H
...
class OAICreateContract : public OAIObject {
public:
    OAICreateContract();
    OAICreateContract(QString json);
    ~OAICreateContract() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateContract)

#endif // OAICreateContract_H
