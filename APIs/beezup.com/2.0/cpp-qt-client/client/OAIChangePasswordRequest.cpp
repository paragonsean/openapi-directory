...
QString OAIChangePasswordRequest::getNewPassword() const {
    return m_new_password;
}
void OAIChangePasswordRequest::setNewPassword(const QString &new_password) {
    m_new_password = new_password;
    m_new_password_isSet = true;
}

bool OAIChangePasswordRequest::is_new_password_Set() const{
    return m_new_password_isSet;
}

bool OAIChangePasswordRequest::is_new_password_Valid() const{
    return m_new_password_isValid;
}

QString OAIChangePasswordRequest::getOldPassword() const {
    return m_old_password;
}
void OAIChangePasswordRequest::setOldPassword(const QString &old_password) {
    m_old_password = old_password;
    m_old_password_isSet = true;
}

bool OAIChangePasswordRequest::is_old_password_Set() const{
    return m_old_password_isSet;
}

bool OAIChangePasswordRequest::is_old_password_Valid() const{
