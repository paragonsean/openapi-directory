...
/*
 * OAILinks_HarvestAllLink.h
 *
 * 
 */

#ifndef OAILinks_HarvestAllLink_H
#define OAILinks_HarvestAllLink_H
...
class OAILinks_HarvestAllLink : public OAIObject {
public:
    OAILinks_HarvestAllLink();
    OAILinks_HarvestAllLink(QString json);
    ~OAILinks_HarvestAllLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_HarvestAllLink)

#endif // OAILinks_HarvestAllLink_H
