...
/*
 * OAILinks_OptimiseAllLink.h
 *
 * 
 */

#ifndef OAILinks_OptimiseAllLink_H
#define OAILinks_OptimiseAllLink_H
...
class OAILinks_OptimiseAllLink : public OAIObject {
public:
    OAILinks_OptimiseAllLink();
    OAILinks_OptimiseAllLink(QString json);
    ~OAILinks_OptimiseAllLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_OptimiseAllLink)

#endif // OAILinks_OptimiseAllLink_H
