...
/*
 * OAILinks_GetChannelCatalogFilterOperatorsLink.h
 *
 * 
 */

#ifndef OAILinks_GetChannelCatalogFilterOperatorsLink_H
#define OAILinks_GetChannelCatalogFilterOperatorsLink_H
...
class OAILinks_GetChannelCatalogFilterOperatorsLink : public OAIObject {
public:
    OAILinks_GetChannelCatalogFilterOperatorsLink();
    OAILinks_GetChannelCatalogFilterOperatorsLink(QString json);
    ~OAILinks_GetChannelCatalogFilterOperatorsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetChannelCatalogFilterOperatorsLink)

#endif // OAILinks_GetChannelCatalogFilterOperatorsLink_H
