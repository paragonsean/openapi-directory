...
/*
 * OAICurrentContractInfo.h
 *
 * 
 */

#ifndef OAICurrentContractInfo_H
#define OAICurrentContractInfo_H
...
class OAICurrentContractInfoLinks;

class OAICurrentContractInfo : public OAIObject {
public:
    OAICurrentContractInfo();
    OAICurrentContractInfo(QString json);
    ~OAICurrentContractInfo() override;
    ...
    OAICurrentContractInfoLinks getLinks() const;
    void setLinks(const OAICurrentContractInfoLinks &links);
...
private:
    ...
    OAICurrentContractInfoLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrentContractInfo)

#endif // OAICurrentContractInfo_H
