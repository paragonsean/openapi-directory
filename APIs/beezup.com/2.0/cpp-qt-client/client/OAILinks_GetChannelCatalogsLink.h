...
/*
 * OAILinks_GetChannelCatalogsLink.h
 *
 * 
 */

#ifndef OAILinks_GetChannelCatalogsLink_H
#define OAILinks_GetChannelCatalogsLink_H
...
class OAILinks_GetChannelCatalogsLink : public OAIObject {
public:
    OAILinks_GetChannelCatalogsLink();
    OAILinks_GetChannelCatalogsLink(QString json);
    ~OAILinks_GetChannelCatalogsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetChannelCatalogsLink)

#endif // OAILinks_GetChannelCatalogsLink_H
