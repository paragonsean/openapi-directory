...
/*
 * OAIBeezUP_Common_LOVLink3.h
 *
 * Describe the way you have to follow to get access to the LOV
 */

#ifndef OAIBeezUP_Common_LOVLink3_H
#define OAIBeezUP_Common_LOVLink3_H
...
class OAIBeezUP_Common_LOVLink3 : public OAIObject {
public:
    OAIBeezUP_Common_LOVLink3();
    OAIBeezUP_Common_LOVLink3(QString json);
    ~OAIBeezUP_Common_LOVLink3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBeezUP_Common_LOVLink3)

#endif // OAIBeezUP_Common_LOVLink3_H
