...
/*
 * OAILinks_MoveUpRuleLink.h
 *
 * 
 */

#ifndef OAILinks_MoveUpRuleLink_H
#define OAILinks_MoveUpRuleLink_H
...
class OAILinks_MoveUpRuleLink : public OAIObject {
public:
    OAILinks_MoveUpRuleLink();
    OAILinks_MoveUpRuleLink(QString json);
    ~OAILinks_MoveUpRuleLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_MoveUpRuleLink)

#endif // OAILinks_MoveUpRuleLink_H
