...
/*
 * OAILinks_DeleteRuleLink.h
 *
 * 
 */

#ifndef OAILinks_DeleteRuleLink_H
#define OAILinks_DeleteRuleLink_H
...
class OAILinks_DeleteRuleLink : public OAIObject {
public:
    OAILinks_DeleteRuleLink();
    OAILinks_DeleteRuleLink(QString json);
    ~OAILinks_DeleteRuleLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_DeleteRuleLink)

#endif // OAILinks_DeleteRuleLink_H
