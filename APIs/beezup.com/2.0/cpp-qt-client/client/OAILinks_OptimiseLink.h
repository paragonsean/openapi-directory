...
/*
 * OAILinks_OptimiseLink.h
 *
 * 
 */

#ifndef OAILinks_OptimiseLink_H
#define OAILinks_OptimiseLink_H
...
class OAILinks_OptimiseLink : public OAIObject {
public:
    OAILinks_OptimiseLink();
    OAILinks_OptimiseLink(QString json);
    ~OAILinks_OptimiseLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_OptimiseLink)

#endif // OAILinks_OptimiseLink_H
