...
/*
 * OAIBeezUP_Common_ChannelBasicInfo.h
 *
 * The basic info related to a channel
 */

#ifndef OAIBeezUP_Common_ChannelBasicInfo_H
#define OAIBeezUP_Common_ChannelBasicInfo_H
...
class OAIBeezUP_Common_ChannelBasicInfo : public OAIObject {
public:
    OAIBeezUP_Common_ChannelBasicInfo();
    OAIBeezUP_Common_ChannelBasicInfo(QString json);
    ~OAIBeezUP_Common_ChannelBasicInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBeezUP_Common_ChannelBasicInfo)

#endif // OAIBeezUP_Common_ChannelBasicInfo_H
