...
/*
 * OAILinks_GetPublicListOfValuesLink.h
 *
 * 
 */

#ifndef OAILinks_GetPublicListOfValuesLink_H
#define OAILinks_GetPublicListOfValuesLink_H
...
class OAILinks_GetPublicListOfValuesLink : public OAIObject {
public:
    OAILinks_GetPublicListOfValuesLink();
    OAILinks_GetPublicListOfValuesLink(QString json);
    ~OAILinks_GetPublicListOfValuesLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetPublicListOfValuesLink)

#endif // OAILinks_GetPublicListOfValuesLink_H
