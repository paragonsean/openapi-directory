...
/*
 * OAIOptimiseAllRequest.h
 *
 * 
 */

#ifndef OAIOptimiseAllRequest_H
#define OAIOptimiseAllRequest_H
...
class OAIOptimiseAllRequest : public OAIObject {
public:
    OAIOptimiseAllRequest();
    OAIOptimiseAllRequest(QString json);
    ~OAIOptimiseAllRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOptimiseAllRequest)

#endif // OAIOptimiseAllRequest_H
