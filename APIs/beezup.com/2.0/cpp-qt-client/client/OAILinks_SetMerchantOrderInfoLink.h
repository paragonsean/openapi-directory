...
/*
 * OAILinks_SetMerchantOrderInfoLink.h
 *
 * 
 */

#ifndef OAILinks_SetMerchantOrderInfoLink_H
#define OAILinks_SetMerchantOrderInfoLink_H
...
class OAILinks_SetMerchantOrderInfoLink : public OAIObject {
public:
    OAILinks_SetMerchantOrderInfoLink();
    OAILinks_SetMerchantOrderInfoLink(QString json);
    ~OAILinks_SetMerchantOrderInfoLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_SetMerchantOrderInfoLink)

#endif // OAILinks_SetMerchantOrderInfoLink_H
