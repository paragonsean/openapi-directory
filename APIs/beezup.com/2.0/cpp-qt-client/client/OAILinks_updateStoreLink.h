...
/*
 * OAILinks_updateStoreLink.h
 *
 * 
 */

#ifndef OAILinks_updateStoreLink_H
#define OAILinks_updateStoreLink_H
...
class OAILinks_updateStoreLink : public OAIObject {
public:
    OAILinks_updateStoreLink();
    OAILinks_updateStoreLink(QString json);
    ~OAILinks_updateStoreLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_updateStoreLink)

#endif // OAILinks_updateStoreLink_H
