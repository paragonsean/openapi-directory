...
/*
 * OAILinks_getStoreLink.h
 *
 * 
 */

#ifndef OAILinks_getStoreLink_H
#define OAILinks_getStoreLink_H
...
class OAILinks_getStoreLink : public OAIObject {
public:
    OAILinks_getStoreLink();
    OAILinks_getStoreLink(QString json);
    ~OAILinks_getStoreLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_getStoreLink)

#endif // OAILinks_getStoreLink_H
