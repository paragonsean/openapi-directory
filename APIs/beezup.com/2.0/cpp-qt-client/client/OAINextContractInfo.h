...
/*
 * OAINextContractInfo.h
 *
 * 
 */

#ifndef OAINextContractInfo_H
#define OAINextContractInfo_H

#include <QJsonObject>

#include "OAIFixedAndVariableClickModelInfo.h"
#include "OAINextContractInfoLinks.h"
...
class OAINextContractInfoLinks;

class OAINextContractInfo : public OAIObject {
public:
    OAINextContractInfo();
    OAINextContractInfo(QString json);
    ~OAINextContractInfo() override;
    ...
    OAINextContractInfoLinks getLinks() const;
    void setLinks(const OAINextContractInfoLinks &links);
...
private:
    ...
    OAINextContractInfoLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINextContractInfo)

#endif // OAINextContractInfo_H
