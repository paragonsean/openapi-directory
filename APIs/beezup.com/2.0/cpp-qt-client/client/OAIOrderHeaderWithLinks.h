...
/*
 * OAIOrderHeaderWithLinks.h
 *
 * 
 */

#ifndef OAIOrderHeaderWithLinks_H
#define OAIOrderHeaderWithLinks_H
...
class OAIOrderHeaderWithLinks : public OAIObject {
public:
    OAIOrderHeaderWithLinks();
    OAIOrderHeaderWithLinks(QString json);
    ~OAIOrderHeaderWithLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderHeaderWithLinks)

#endif // OAIOrderHeaderWithLinks_H
