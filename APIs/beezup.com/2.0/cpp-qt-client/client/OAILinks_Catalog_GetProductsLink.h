...
/*
 * OAILinks_Catalog_GetProductsLink.h
 *
 * 
 */

#ifndef OAILinks_Catalog_GetProductsLink_H
#define OAILinks_Catalog_GetProductsLink_H
...
class OAILinks_Catalog_GetProductsLink : public OAIObject {
public:
    OAILinks_Catalog_GetProductsLink();
    OAILinks_Catalog_GetProductsLink(QString json);
    ~OAILinks_Catalog_GetProductsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Catalog_GetProductsLink)

#endif // OAILinks_Catalog_GetProductsLink_H
