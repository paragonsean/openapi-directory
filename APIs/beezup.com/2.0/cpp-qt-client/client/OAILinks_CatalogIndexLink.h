...
/*
 * OAILinks_CatalogIndexLink.h
 *
 * 
 */

#ifndef OAILinks_CatalogIndexLink_H
#define OAILinks_CatalogIndexLink_H
...
class OAILinks_CatalogIndexLink : public OAIObject {
public:
    OAILinks_CatalogIndexLink();
    OAILinks_CatalogIndexLink(QString json);
    ~OAILinks_CatalogIndexLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_CatalogIndexLink)

#endif // OAILinks_CatalogIndexLink_H
