...
/*
 * OAILinks_HarvestOrderLink.h
 *
 * 
 */

#ifndef OAILinks_HarvestOrderLink_H
#define OAILinks_HarvestOrderLink_H
...
class OAILinks_HarvestOrderLink : public OAIObject {
public:
    OAILinks_HarvestOrderLink();
    OAILinks_HarvestOrderLink(QString json);
    ~OAILinks_HarvestOrderLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_HarvestOrderLink)

#endif // OAILinks_HarvestOrderLink_H
