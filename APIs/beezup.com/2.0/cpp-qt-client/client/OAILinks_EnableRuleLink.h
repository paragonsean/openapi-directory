...
/*
 * OAILinks_EnableRuleLink.h
 *
 * 
 */

#ifndef OAILinks_EnableRuleLink_H
#define OAILinks_EnableRuleLink_H
...
class OAILinks_EnableRuleLink : public OAIObject {
public:
    OAILinks_EnableRuleLink();
    OAILinks_EnableRuleLink(QString json);
    ~OAILinks_EnableRuleLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_EnableRuleLink)

#endif // OAILinks_EnableRuleLink_H
