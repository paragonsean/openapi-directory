...
/*
 * OAILinks_GetPublicLovIndexLink.h
 *
 * 
 */

#ifndef OAILinks_GetPublicLovIndexLink_H
#define OAILinks_GetPublicLovIndexLink_H
...
class OAILinks_GetPublicLovIndexLink : public OAIObject {
public:
    OAILinks_GetPublicLovIndexLink();
    OAILinks_GetPublicLovIndexLink(QString json);
    ~OAILinks_GetPublicLovIndexLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetPublicLovIndexLink)

#endif // OAILinks_GetPublicLovIndexLink_H
