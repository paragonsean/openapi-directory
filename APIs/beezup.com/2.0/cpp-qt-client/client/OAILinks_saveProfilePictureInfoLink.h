...
/*
 * OAILinks_saveProfilePictureInfoLink.h
 *
 * 
 */

#ifndef OAILinks_saveProfilePictureInfoLink_H
#define OAILinks_saveProfilePictureInfoLink_H
...
class OAILinks_saveProfilePictureInfoLink : public OAIObject {
public:
    OAILinks_saveProfilePictureInfoLink();
    OAILinks_saveProfilePictureInfoLink(QString json);
    ~OAILinks_saveProfilePictureInfoLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_saveProfilePictureInfoLink)

#endif // OAILinks_saveProfilePictureInfoLink_H
