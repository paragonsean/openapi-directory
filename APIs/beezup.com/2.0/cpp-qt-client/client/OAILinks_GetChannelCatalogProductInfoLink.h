...
/*
 * OAILinks_GetChannelCatalogProductInfoLink.h
 *
 * 
 */

#ifndef OAILinks_GetChannelCatalogProductInfoLink_H
#define OAILinks_GetChannelCatalogProductInfoLink_H
...
class OAILinks_GetChannelCatalogProductInfoLink : public OAIObject {
public:
    OAILinks_GetChannelCatalogProductInfoLink();
    OAILinks_GetChannelCatalogProductInfoLink(QString json);
    ~OAILinks_GetChannelCatalogProductInfoLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetChannelCatalogProductInfoLink)

#endif // OAILinks_GetChannelCatalogProductInfoLink_H
