...
/*
 * OAILinks_Catalog_GetRandomProductsLink.h
 *
 * 
 */

#ifndef OAILinks_Catalog_GetRandomProductsLink_H
#define OAILinks_Catalog_GetRandomProductsLink_H
...
class OAILinks_Catalog_GetRandomProductsLink : public OAIObject {
public:
    OAILinks_Catalog_GetRandomProductsLink();
    OAILinks_Catalog_GetRandomProductsLink(QString json);
    ~OAILinks_Catalog_GetRandomProductsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Catalog_GetRandomProductsLink)

#endif // OAILinks_Catalog_GetRandomProductsLink_H
