...
/*
 * OAIChannelCatalogMarketplaceNumberProperty.h
 *
 * 
 */

#ifndef OAIChannelCatalogMarketplaceNumberProperty_H
#define OAIChannelCatalogMarketplaceNumberProperty_H
...
class OAIChannelCatalogMarketplaceNumberProperty : public OAIObject {
public:
    OAIChannelCatalogMarketplaceNumberProperty();
    OAIChannelCatalogMarketplaceNumberProperty(QString json);
    ~OAIChannelCatalogMarketplaceNumberProperty() override;
    ...
    QList<double> getRDefault() const;
    void setRDefault(const QList<double> &r_default);
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelCatalogMarketplaceNumberProperty)

#endif // OAIChannelCatalogMarketplaceNumberProperty_H
