...
/*
 * OAILinks_getCreditCardInfoLink.h
 *
 * 
 */

#ifndef OAILinks_getCreditCardInfoLink_H
#define OAILinks_getCreditCardInfoLink_H
...
class OAILinks_getCreditCardInfoLink : public OAIObject {
public:
    OAILinks_getCreditCardInfoLink();
    OAILinks_getCreditCardInfoLink(QString json);
    ~OAILinks_getCreditCardInfoLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_getCreditCardInfoLink)

#endif // OAILinks_getCreditCardInfoLink_H
