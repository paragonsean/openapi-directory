...
/*
 * OAILinks_PublishCatalogToMarketplaceLink.h
 *
 * 
 */

#ifndef OAILinks_PublishCatalogToMarketplaceLink_H
#define OAILinks_PublishCatalogToMarketplaceLink_H
...
class OAILinks_PublishCatalogToMarketplaceLink : public OAIObject {
public:
    OAILinks_PublishCatalogToMarketplaceLink();
    OAILinks_PublishCatalogToMarketplaceLink(QString json);
    ~OAILinks_PublishCatalogToMarketplaceLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_PublishCatalogToMarketplaceLink)

#endif // OAILinks_PublishCatalogToMarketplaceLink_H
