...
/*
 * OAILinks_deleteNextContractLink.h
 *
 * 
 */

#ifndef OAILinks_deleteNextContractLink_H
#define OAILinks_deleteNextContractLink_H
...
class OAILinks_deleteNextContractLink : public OAIObject {
public:
    OAILinks_deleteNextContractLink();
    OAILinks_deleteNextContractLink(QString json);
    ~OAILinks_deleteNextContractLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_deleteNextContractLink)

#endif // OAILinks_deleteNextContractLink_H
