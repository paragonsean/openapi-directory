...
/*
 * OAILinks_GetMarketplaceAccountsSynchronizationV3Link.h
 *
 * 
 */

#ifndef OAILinks_GetMarketplaceAccountsSynchronizationV3Link_H
#define OAILinks_GetMarketplaceAccountsSynchronizationV3Link_H

#include <QJsonObject>

#include "OAIHttpMethod.h"
#include "OAIInfoSummaries.h"
...
namespace OpenAPI {
class OAIInfoSummaries;
class OAILinkParameter3;

class OAILinks_GetMarketplaceAccountsSynchronizationV3Link : public OAIObject {
public:
    OAILinks_GetMarketplaceAccountsSynchronizationV3Link();
    OAILinks_GetMarketplaceAccountsSynchronizationV3Link(QString json);
    ~OAILinks_GetMarketplaceAccountsSynchronizationV3Link() override;
    ...
    OAIInfoSummaries getInfo() const;
    void setInfo(const OAIInfoSummaries &info);
    ...
    QMap<QString, OAILinkParameter3> getParameters() const;
    void setParameters(const QMap<QString, OAILinkParameter3> &parameters);
...
private:
    ...
    QMap<QString, OAILinkParameter3> m_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetMarketplaceAccountsSynchronizationV3Link)

#endif // OAILinks_GetMarketplaceAccountsSynchronizationV3Link_H
