...
/*
 * OAIUserErrorMessage.h
 *
 * 
 */

#ifndef OAIUserErrorMessage_H
#define OAIUserErrorMessage_H
...
class OAIUserErrorMessage : public OAIObject {
public:
    OAIUserErrorMessage();
    OAIUserErrorMessage(QString json);
    ~OAIUserErrorMessage() override;
    ...
    QMap<QString, OAIObject> getArguments() const;
    void setArguments(const QMap<QString, OAIObject> &arguments);
...
private:
    ...
    QMap<QString, OAIObject> m_arguments;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserErrorMessage)

#endif // OAIUserErrorMessage_H
