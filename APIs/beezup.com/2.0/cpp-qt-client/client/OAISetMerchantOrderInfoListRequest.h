...
/*
 * OAISetMerchantOrderInfoListRequest.h
 *
 * 
 */

#ifndef OAISetMerchantOrderInfoListRequest_H
#define OAISetMerchantOrderInfoListRequest_H
...
namespace OpenAPI {
class OAISetMerchantOrderInfoListRequestItem;

class OAISetMerchantOrderInfoListRequest : public OAIObject {
public:
    OAISetMerchantOrderInfoListRequest();
    OAISetMerchantOrderInfoListRequest(QString json);
    ~OAISetMerchantOrderInfoListRequest() override;
    ...
    QSet<OAISetMerchantOrderInfoListRequestItem> getOrders() const;
    void setOrders(const QSet<OAISetMerchantOrderInfoListRequestItem> &orders);
...
private:
    ...
    QSet<OAISetMerchantOrderInfoListRequestItem> m_orders;
    bool m_orders_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetMerchantOrderInfoListRequest)

#endif // OAISetMerchantOrderInfoListRequest_H
