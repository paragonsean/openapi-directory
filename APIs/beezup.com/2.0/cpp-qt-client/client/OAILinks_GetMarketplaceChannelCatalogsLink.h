...
/*
 * OAILinks_GetMarketplaceChannelCatalogsLink.h
 *
 * 
 */

#ifndef OAILinks_GetMarketplaceChannelCatalogsLink_H
#define OAILinks_GetMarketplaceChannelCatalogsLink_H
...
class OAILinks_GetMarketplaceChannelCatalogsLink : public OAIObject {
public:
    OAILinks_GetMarketplaceChannelCatalogsLink();
    OAILinks_GetMarketplaceChannelCatalogsLink(QString json);
    ~OAILinks_GetMarketplaceChannelCatalogsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetMarketplaceChannelCatalogsLink)

#endif // OAILinks_GetMarketplaceChannelCatalogsLink_H
