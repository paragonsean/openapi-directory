...
/*
 * OAILinks_saveStoreAlertsLink.h
 *
 * 
 */

#ifndef OAILinks_saveStoreAlertsLink_H
#define OAILinks_saveStoreAlertsLink_H
...
class OAILinks_saveStoreAlertsLink : public OAIObject {
public:
    OAILinks_saveStoreAlertsLink();
    OAILinks_saveStoreAlertsLink(QString json);
    ~OAILinks_saveStoreAlertsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_saveStoreAlertsLink)

#endif // OAILinks_saveStoreAlertsLink_H
