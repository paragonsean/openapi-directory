...
/*
 * OAIImportationMonitoring.h
 *
 * Describe the reporting of the catalog importation
 */

#ifndef OAIImportationMonitoring_H
#define OAIImportationMonitoring_H
...
class OAIImportationMonitoringLinks;

class OAIImportationMonitoring : public OAIObject {
public:
    OAIImportationMonitoring();
    OAIImportationMonitoring(QString json);
    ~OAIImportationMonitoring() override;
    ...
    OAIImportationMonitoringLinks getLinks() const;
    void setLinks(const OAIImportationMonitoringLinks &links);
...
private:
    ...
    OAIImportationMonitoringLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportationMonitoring)

#endif // OAIImportationMonitoring_H
