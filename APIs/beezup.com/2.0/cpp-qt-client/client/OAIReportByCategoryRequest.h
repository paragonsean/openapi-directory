...
/*
 * OAIReportByCategoryRequest.h
 *
 * 
 */

#ifndef OAIReportByCategoryRequest_H
#define OAIReportByCategoryRequest_H
...
class OAIReportByCategoryRequest : public OAIObject {
public:
    OAIReportByCategoryRequest();
    OAIReportByCategoryRequest(QString json);
    ~OAIReportByCategoryRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportByCategoryRequest)

#endif // OAIReportByCategoryRequest_H
