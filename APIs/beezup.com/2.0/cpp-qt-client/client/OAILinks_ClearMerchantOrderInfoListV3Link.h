...
/*
 * OAILinks_ClearMerchantOrderInfoListV3Link.h
 *
 * 
 */

#ifndef OAILinks_ClearMerchantOrderInfoListV3Link_H
#define OAILinks_ClearMerchantOrderInfoListV3Link_H
...
class OAILinks_ClearMerchantOrderInfoListV3Link : public OAIObject {
public:
    OAILinks_ClearMerchantOrderInfoListV3Link();
    OAILinks_ClearMerchantOrderInfoListV3Link(QString json);
    ~OAILinks_ClearMerchantOrderInfoListV3Link() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_ClearMerchantOrderInfoListV3Link)

#endif // OAILinks_ClearMerchantOrderInfoListV3Link_H
