...
/*
 * OAILinks_CreateRuleLink.h
 *
 * 
 */

#ifndef OAILinks_CreateRuleLink_H
#define OAILinks_CreateRuleLink_H
...
class OAILinks_CreateRuleLink : public OAIObject {
public:
    OAILinks_CreateRuleLink();
    OAILinks_CreateRuleLink(QString json);
    ~OAILinks_CreateRuleLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_CreateRuleLink)

#endif // OAILinks_CreateRuleLink_H
