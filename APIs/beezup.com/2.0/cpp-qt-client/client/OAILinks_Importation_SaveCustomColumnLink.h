...
/*
 * OAILinks_Importation_SaveCustomColumnLink.h
 *
 * 
 */

#ifndef OAILinks_Importation_SaveCustomColumnLink_H
#define OAILinks_Importation_SaveCustomColumnLink_H
...
class OAILinks_Importation_SaveCustomColumnLink : public OAIObject {
public:
    OAILinks_Importation_SaveCustomColumnLink();
    OAILinks_Importation_SaveCustomColumnLink(QString json);
    ~OAILinks_Importation_SaveCustomColumnLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Importation_SaveCustomColumnLink)

#endif // OAILinks_Importation_SaveCustomColumnLink_H
