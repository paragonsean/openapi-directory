...
/*
 * OAILinks_GetChannelsIndexLink.h
 *
 * 
 */

#ifndef OAILinks_GetChannelsIndexLink_H
#define OAILinks_GetChannelsIndexLink_H
...
class OAILinks_GetChannelsIndexLink : public OAIObject {
public:
    OAILinks_GetChannelsIndexLink();
    OAILinks_GetChannelsIndexLink(QString json);
    ~OAILinks_GetChannelsIndexLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetChannelsIndexLink)

#endif // OAILinks_GetChannelsIndexLink_H
