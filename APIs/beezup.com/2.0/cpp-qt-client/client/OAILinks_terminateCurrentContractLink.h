...
/*
 * OAILinks_terminateCurrentContractLink.h
 *
 * 
 */

#ifndef OAILinks_terminateCurrentContractLink_H
#define OAILinks_terminateCurrentContractLink_H
...
class OAILinks_terminateCurrentContractLink : public OAIObject {
public:
    OAILinks_terminateCurrentContractLink();
    OAILinks_terminateCurrentContractLink(QString json);
    ~OAILinks_terminateCurrentContractLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_terminateCurrentContractLink)

#endif // OAILinks_terminateCurrentContractLink_H
