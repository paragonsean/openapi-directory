...
/*
 * OAISetMerchantOrderInfoRequest.h
 *
 * 
 */

#ifndef OAISetMerchantOrderInfoRequest_H
#define OAISetMerchantOrderInfoRequest_H
...
class OAISetMerchantOrderInfoRequest : public OAIObject {
public:
    OAISetMerchantOrderInfoRequest();
    OAISetMerchantOrderInfoRequest(QString json);
    ~OAISetMerchantOrderInfoRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetMerchantOrderInfoRequest)

#endif // OAISetMerchantOrderInfoRequest_H
