...
/*
 * OAILinks_GetReportFiltersLink.h
 *
 * 
 */

#ifndef OAILinks_GetReportFiltersLink_H
#define OAILinks_GetReportFiltersLink_H
...
class OAILinks_GetReportFiltersLink : public OAIObject {
public:
    OAILinks_GetReportFiltersLink();
    OAILinks_GetReportFiltersLink(QString json);
    ~OAILinks_GetReportFiltersLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetReportFiltersLink)

#endif // OAILinks_GetReportFiltersLink_H
