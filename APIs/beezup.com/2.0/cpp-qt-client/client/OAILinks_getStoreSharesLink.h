...
/*
 * OAILinks_getStoreSharesLink.h
 *
 * 
 */

#ifndef OAILinks_getStoreSharesLink_H
#define OAILinks_getStoreSharesLink_H
...
class OAILinks_getStoreSharesLink : public OAIObject {
public:
    OAILinks_getStoreSharesLink();
    OAILinks_getStoreSharesLink(QString json);
    ~OAILinks_getStoreSharesLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_getStoreSharesLink)

#endif // OAILinks_getStoreSharesLink_H
