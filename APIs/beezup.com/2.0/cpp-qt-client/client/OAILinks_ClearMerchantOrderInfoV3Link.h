...
/*
 * OAILinks_ClearMerchantOrderInfoV3Link.h
 *
 * 
 */

#ifndef OAILinks_ClearMerchantOrderInfoV3Link_H
#define OAILinks_ClearMerchantOrderInfoV3Link_H
...
class OAILinks_ClearMerchantOrderInfoV3Link : public OAIObject {
public:
    OAILinks_ClearMerchantOrderInfoV3Link();
    OAILinks_ClearMerchantOrderInfoV3Link(QString json);
    ~OAILinks_ClearMerchantOrderInfoV3Link() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_ClearMerchantOrderInfoV3Link)

#endif // OAILinks_ClearMerchantOrderInfoV3Link_H
