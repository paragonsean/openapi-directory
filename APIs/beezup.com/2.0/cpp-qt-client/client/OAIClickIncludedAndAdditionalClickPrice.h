...
/*
 * OAIClickIncludedAndAdditionalClickPrice.h
 *
 * 
 */

#ifndef OAIClickIncludedAndAdditionalClickPrice_H
#define OAIClickIncludedAndAdditionalClickPrice_H
...
class OAIClickIncludedAndAdditionalClickPrice : public OAIObject {
public:
    OAIClickIncludedAndAdditionalClickPrice();
    OAIClickIncludedAndAdditionalClickPrice(QString json);
    ~OAIClickIncludedAndAdditionalClickPrice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClickIncludedAndAdditionalClickPrice)

#endif // OAIClickIncludedAndAdditionalClickPrice_H
