...
/*
 * OAILinks_Catalog_GetBeezUPColumnsLink.h
 *
 * 
 */

#ifndef OAILinks_Catalog_GetBeezUPColumnsLink_H
#define OAILinks_Catalog_GetBeezUPColumnsLink_H
...
class OAILinks_Catalog_GetBeezUPColumnsLink : public OAIObject {
public:
    OAILinks_Catalog_GetBeezUPColumnsLink();
    OAILinks_Catalog_GetBeezUPColumnsLink(QString json);
    ~OAILinks_Catalog_GetBeezUPColumnsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Catalog_GetBeezUPColumnsLink)

#endif // OAILinks_Catalog_GetBeezUPColumnsLink_H
