...
/*
 * OAILinks_getProfilePictureInfoLink.h
 *
 * 
 */

#ifndef OAILinks_getProfilePictureInfoLink_H
#define OAILinks_getProfilePictureInfoLink_H
...
class OAILinks_getProfilePictureInfoLink : public OAIObject {
public:
    OAILinks_getProfilePictureInfoLink();
    OAILinks_getProfilePictureInfoLink(QString json);
    ~OAILinks_getProfilePictureInfoLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_getProfilePictureInfoLink)

#endif // OAILinks_getProfilePictureInfoLink_H
