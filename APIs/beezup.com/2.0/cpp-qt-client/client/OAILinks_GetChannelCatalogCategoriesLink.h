...
/*
 * OAILinks_GetChannelCatalogCategoriesLink.h
 *
 * 
 */

#ifndef OAILinks_GetChannelCatalogCategoriesLink_H
#define OAILinks_GetChannelCatalogCategoriesLink_H
...
class OAILinks_GetChannelCatalogCategoriesLink : public OAIObject {
public:
    OAILinks_GetChannelCatalogCategoriesLink();
    OAILinks_GetChannelCatalogCategoriesLink(QString json);
    ~OAILinks_GetChannelCatalogCategoriesLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetChannelCatalogCategoriesLink)

#endif // OAILinks_GetChannelCatalogCategoriesLink_H
