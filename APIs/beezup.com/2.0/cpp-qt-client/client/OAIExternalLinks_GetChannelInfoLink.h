...
/*
 * OAIExternalLinks_GetChannelInfoLink.h
 *
 * 
 */

#ifndef OAIExternalLinks_GetChannelInfoLink_H
#define OAIExternalLinks_GetChannelInfoLink_H
...
class OAIExternalLinks_GetChannelInfoLink : public OAIObject {
public:
    OAIExternalLinks_GetChannelInfoLink();
    OAIExternalLinks_GetChannelInfoLink(QString json);
    ~OAIExternalLinks_GetChannelInfoLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExternalLinks_GetChannelInfoLink)

#endif // OAIExternalLinks_GetChannelInfoLink_H
