...
/*
 * OAILinks_ExportOrdersLink.h
 *
 * 
 */

#ifndef OAILinks_ExportOrdersLink_H
#define OAILinks_ExportOrdersLink_H
...
class OAILinks_ExportOrdersLink : public OAIObject {
public:
    OAILinks_ExportOrdersLink();
    OAILinks_ExportOrdersLink(QString json);
    ~OAILinks_ExportOrdersLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_ExportOrdersLink)

#endif // OAILinks_ExportOrdersLink_H
