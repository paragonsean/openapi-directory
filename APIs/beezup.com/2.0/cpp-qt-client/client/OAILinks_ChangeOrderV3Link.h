...
/*
 * OAILinks_ChangeOrderV3Link.h
 *
 * 
 */

#ifndef OAILinks_ChangeOrderV3Link_H
#define OAILinks_ChangeOrderV3Link_H
...
class OAILinks_ChangeOrderV3Link : public OAIObject {
public:
    OAILinks_ChangeOrderV3Link();
    OAILinks_ChangeOrderV3Link(QString json);
    ~OAILinks_ChangeOrderV3Link() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_ChangeOrderV3Link)

#endif // OAILinks_ChangeOrderV3Link_H
