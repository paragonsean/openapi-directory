...
/*
 * OAILinks_HarvestAllV3Link.h
 *
 * 
 */

#ifndef OAILinks_HarvestAllV3Link_H
#define OAILinks_HarvestAllV3Link_H
...
class OAILinks_HarvestAllV3Link : public OAIObject {
public:
    OAILinks_HarvestAllV3Link();
    OAILinks_HarvestAllV3Link(QString json);
    ~OAILinks_HarvestAllV3Link() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_HarvestAllV3Link)

#endif // OAILinks_HarvestAllV3Link_H
