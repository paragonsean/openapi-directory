...
#ifndef OAICreditCardInfo_H
#define OAICreditCardInfo_H
...
class OAICreditCardInfo : public OAIObject {
public:
    OAICreditCardInfo();
    OAICreditCardInfo(QString json);
    ~OAICreditCardInfo() override;
    ...
    QString getCardVerificationCode() const;
    void setCardVerificationCode(const QString &card_verification_code);
    bool is_card_verification_code_Set() const;
    bool is_card_verification_code_Valid() const;
...
private:
    ...
    QString m_card_verification_code;
    bool m_card_verification_code_isSet;
    bool m_card_verification_code_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreditCardInfo)

#endif // OAICreditCardInfo_H
