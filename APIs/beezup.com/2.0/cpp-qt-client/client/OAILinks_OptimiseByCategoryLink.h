...
/*
 * OAILinks_OptimiseByCategoryLink.h
 *
 * 
 */

#ifndef OAILinks_OptimiseByCategoryLink_H
#define OAILinks_OptimiseByCategoryLink_H
...
class OAILinks_OptimiseByCategoryLink : public OAIObject {
public:
    OAILinks_OptimiseByCategoryLink();
    OAILinks_OptimiseByCategoryLink(QString json);
    ~OAILinks_OptimiseByCategoryLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_OptimiseByCategoryLink)

#endif // OAILinks_OptimiseByCategoryLink_H
