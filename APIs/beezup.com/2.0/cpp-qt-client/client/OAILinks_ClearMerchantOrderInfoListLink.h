...
/*
 * OAILinks_ClearMerchantOrderInfoListLink.h
 *
 * 
 */

#ifndef OAILinks_ClearMerchantOrderInfoListLink_H
#define OAILinks_ClearMerchantOrderInfoListLink_H
...
class OAILinks_ClearMerchantOrderInfoListLink : public OAIObject {
public:
    OAILinks_ClearMerchantOrderInfoListLink();
    OAILinks_ClearMerchantOrderInfoListLink(QString json);
    ~OAILinks_ClearMerchantOrderInfoListLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_ClearMerchantOrderInfoListLink)

#endif // OAILinks_ClearMerchantOrderInfoListLink_H
