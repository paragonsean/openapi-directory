...
#ifndef OAIOfferRequest_H
#define OAIOfferRequest_H
...
class OAIOfferRequest : public OAIObject {
public:
    OAIOfferRequest();
    OAIOfferRequest(QString json);
    ~OAIOfferRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferRequest)

#endif // OAIOfferRequest_H
