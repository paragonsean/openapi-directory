...
/*
 * OAILinks_RunRuleLink.h
 *
 * 
 */

#ifndef OAILinks_RunRuleLink_H
#define OAILinks_RunRuleLink_H
...
class OAILinks_RunRuleLink : public OAIObject {
public:
    OAILinks_RunRuleLink();
    OAILinks_RunRuleLink(QString json);
    ~OAILinks_RunRuleLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_RunRuleLink)

#endif // OAILinks_RunRuleLink_H
