...
/*
 * OAILinks_GetOrderExportationsLink.h
 *
 * 
 */

#ifndef OAILinks_GetOrderExportationsLink_H
#define OAILinks_GetOrderExportationsLink_H
...
class OAILinks_GetOrderExportationsLink : public OAIObject {
public:
    OAILinks_GetOrderExportationsLink();
    OAILinks_GetOrderExportationsLink(QString json);
    ~OAILinks_GetOrderExportationsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetOrderExportationsLink)

#endif // OAILinks_GetOrderExportationsLink_H
