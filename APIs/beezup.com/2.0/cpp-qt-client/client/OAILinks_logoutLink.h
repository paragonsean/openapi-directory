...
/*
 * OAILinks_logoutLink.h
 *
 * 
 */

#ifndef OAILinks_logoutLink_H
#define OAILinks_logoutLink_H
...
class OAILinks_logoutLink : public OAIObject {
public:
    OAILinks_logoutLink();
    OAILinks_logoutLink(QString json);
    ~OAILinks_logoutLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_logoutLink)

#endif // OAILinks_logoutLink_H
