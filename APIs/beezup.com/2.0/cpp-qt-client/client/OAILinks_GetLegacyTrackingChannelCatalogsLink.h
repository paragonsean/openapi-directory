...
/*
 * OAILinks_GetLegacyTrackingChannelCatalogsLink.h
 *
 * 
 */

#ifndef OAILinks_GetLegacyTrackingChannelCatalogsLink_H
#define OAILinks_GetLegacyTrackingChannelCatalogsLink_H
...
class OAILinks_GetLegacyTrackingChannelCatalogsLink : public OAIObject {
public:
    OAILinks_GetLegacyTrackingChannelCatalogsLink();
    OAILinks_GetLegacyTrackingChannelCatalogsLink(QString json);
    ~OAILinks_GetLegacyTrackingChannelCatalogsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetLegacyTrackingChannelCatalogsLink)

#endif // OAILinks_GetLegacyTrackingChannelCatalogsLink_H
