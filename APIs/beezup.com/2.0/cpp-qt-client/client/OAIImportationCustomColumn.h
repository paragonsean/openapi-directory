...
/*
 * OAIImportationCustomColumn.h
 *
 * The custom column configuration
 */

#ifndef OAIImportationCustomColumn_H
#define OAIImportationCustomColumn_H
...
class OAIImportationCustomColumnLinks;

class OAIImportationCustomColumn : public OAIObject {
public:
    OAIImportationCustomColumn();
    OAIImportationCustomColumn(QString json);
    ~OAIImportationCustomColumn() override;
    ...
    OAIImportationCustomColumnLinks getLinks() const;
    void setLinks(const OAIImportationCustomColumnLinks &links);
...
private:
    ...
    OAIImportationCustomColumnLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportationCustomColumn)

#endif // OAIImportationCustomColumn_H
