...
/*
 * OAILinks_MoveDownRuleLink.h
 *
 * 
 */

#ifndef OAILinks_MoveDownRuleLink_H
#define OAILinks_MoveDownRuleLink_H
...
class OAILinks_MoveDownRuleLink : public OAIObject {
public:
    OAILinks_MoveDownRuleLink();
    OAILinks_MoveDownRuleLink(QString json);
    ~OAILinks_MoveDownRuleLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_MoveDownRuleLink)

#endif // OAILinks_MoveDownRuleLink_H
