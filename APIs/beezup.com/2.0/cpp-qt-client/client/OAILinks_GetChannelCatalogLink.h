...
/*
 * OAILinks_GetChannelCatalogLink.h
 *
 * 
 */

#ifndef OAILinks_GetChannelCatalogLink_H
#define OAILinks_GetChannelCatalogLink_H
...
class OAILinks_GetChannelCatalogLink : public OAIObject {
public:
    OAILinks_GetChannelCatalogLink();
    OAILinks_GetChannelCatalogLink(QString json);
    ~OAILinks_GetChannelCatalogLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetChannelCatalogLink)

#endif // OAILinks_GetChannelCatalogLink_H
