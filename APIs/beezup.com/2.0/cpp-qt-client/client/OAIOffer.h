...
public:
    ...
    OAIOfferContent getContent() const;
    void setContent(const OAIOfferContent &content);
    ...
    OAIOfferLinks getLinks() const;
    void setLinks(const OAIOfferLinks &links);
