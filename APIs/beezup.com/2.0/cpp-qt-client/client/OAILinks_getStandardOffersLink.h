...
/*
 * OAILinks_getStandardOffersLink.h
 *
 * 
 */

#ifndef OAILinks_getStandardOffersLink_H
#define OAILinks_getStandardOffersLink_H
...
class OAILinks_getStandardOffersLink : public OAIObject {
public:
    OAILinks_getStandardOffersLink();
    OAILinks_getStandardOffersLink(QString json);
    ~OAILinks_getStandardOffersLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_getStandardOffersLink)

#endif // OAILinks_getStandardOffersLink_H
