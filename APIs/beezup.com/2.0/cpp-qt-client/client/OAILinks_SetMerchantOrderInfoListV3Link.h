...
/*
 * OAILinks_SetMerchantOrderInfoListV3Link.h
 *
 * 
 */

#ifndef OAILinks_SetMerchantOrderInfoListV3Link_H
#define OAILinks_SetMerchantOrderInfoListV3Link_H
...
class OAILinks_SetMerchantOrderInfoListV3Link : public OAIObject {
public:
    OAILinks_SetMerchantOrderInfoListV3Link();
    OAILinks_SetMerchantOrderInfoListV3Link(QString json);
    ~OAILinks_SetMerchantOrderInfoListV3Link() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_SetMerchantOrderInfoListV3Link)

#endif // OAILinks_SetMerchantOrderInfoListV3Link_H
