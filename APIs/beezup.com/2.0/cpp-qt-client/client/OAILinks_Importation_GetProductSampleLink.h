...
/*
 * OAILinks_Importation_GetProductSampleLink.h
 *
 * 
 */

#ifndef OAILinks_Importation_GetProductSampleLink_H
#define OAILinks_Importation_GetProductSampleLink_H
...
class OAILinks_Importation_GetProductSampleLink : public OAIObject {
public:
    OAILinks_Importation_GetProductSampleLink();
    OAILinks_Importation_GetProductSampleLink(QString json);
    ~OAILinks_Importation_GetProductSampleLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_Importation_GetProductSampleLink)

#endif // OAILinks_Importation_GetProductSampleLink_H
