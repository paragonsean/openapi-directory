...
/*
 * OAISetMerchantOrderInfoListRequestItem.h
 *
 * 
 */

#ifndef OAISetMerchantOrderInfoListRequestItem_H
#define OAISetMerchantOrderInfoListRequestItem_H
...
class OAISetMerchantOrderInfoListRequestItem : public OAIObject {
public:
    OAISetMerchantOrderInfoListRequestItem();
    OAISetMerchantOrderInfoListRequestItem(QString json);
    ~OAISetMerchantOrderInfoListRequestItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetMerchantOrderInfoListRequestItem)

#endif // OAISetMerchantOrderInfoListRequestItem_H
