...
/*
 * OAILinks_getStoresLink.h
 *
 * 
 */

#ifndef OAILinks_getStoresLink_H
#define OAILinks_getStoresLink_H
...
class OAILinks_getStoresLink : public OAIObject {
public:
    OAILinks_getStoresLink();
    OAILinks_getStoresLink(QString json);
    ~OAILinks_getStoresLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_getStoresLink)

#endif // OAILinks_getStoresLink_H
