...
/*
 * OAILinks_DisableRuleLink.h
 *
 * 
 */

#ifndef OAILinks_DisableRuleLink_H
#define OAILinks_DisableRuleLink_H
...
class OAILinks_DisableRuleLink : public OAIObject {
public:
    OAILinks_DisableRuleLink();
    OAILinks_DisableRuleLink(QString json);
    ~OAILinks_DisableRuleLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_DisableRuleLink)

#endif // OAILinks_DisableRuleLink_H
