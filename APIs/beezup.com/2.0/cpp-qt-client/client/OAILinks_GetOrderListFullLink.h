...
/*
 * OAILinks_GetOrderListFullLink.h
 *
 * 
 */

#ifndef OAILinks_GetOrderListFullLink_H
#define OAILinks_GetOrderListFullLink_H
...
class OAILinks_GetOrderListFullLink : public OAIObject {
public:
    OAILinks_GetOrderListFullLink();
    OAILinks_GetOrderListFullLink(QString json);
    ~OAILinks_GetOrderListFullLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_GetOrderListFullLink)

#endif // OAILinks_GetOrderListFullLink_H
