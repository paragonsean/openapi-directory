...
/*
 * OAIReportByDayRequest.h
 *
 * 
 */

#ifndef OAIReportByDayRequest_H
#define OAIReportByDayRequest_H
...
class OAIReportByDayRequest : public OAIObject {
public:
    OAIReportByDayRequest();
    OAIReportByDayRequest(QString json);
    ~OAIReportByDayRequest() override;
    ...
    QDate getBeginPeriodUtcDate() const;
    void setBeginPeriodUtcDate(const QDate &begin_period_utc_date);
    bool is_begin_period_utc_date_Set() const;
    bool is_begin_period_utc_date_Valid() const;

    QString getCatalogCategoryId() const;
    void setCatalogCategoryId(const QString &catalog_category_id);
    bool is_catalog_category_id_Set() const;
    bool is_catalog_category_id_Valid() const;
    ...
    QDate getEndPeriodUtcDate() const;
    void setEndPeriodUtcDate(const QDate &end_period_utc_date);
...
private:
    ...
    QDate m_begin_period_utc_date;
    bool m_begin_period_utc_date_isSet;
    bool m_begin_period_utc_date_isValid;

    QString m_catalog_category_id;
    bool m_catalog_category_id_isSet;
    bool m_catalog_category_id_isValid;

    QList<QString> m_channel_ids;
    bool m_channel_ids_isSet;
    bool m_channel_ids_isValid;

    QDate m_end_period_utc_date;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportByDayRequest)

#endif // OAIReportByDayRequest_H
