...
/*
 * OAILinks_deleteStoreLink.h
 *
 * 
 */

#ifndef OAILinks_deleteStoreLink_H
#define OAILinks_deleteStoreLink_H
...
class OAILinks_deleteStoreLink : public OAIObject {
public:
    OAILinks_deleteStoreLink();
    OAILinks_deleteStoreLink(QString json);
    ~OAILinks_deleteStoreLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_deleteStoreLink)

#endif // OAILinks_deleteStoreLink_H
