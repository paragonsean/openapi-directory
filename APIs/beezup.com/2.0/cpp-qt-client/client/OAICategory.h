...
public:
    ...
    qint32 getSelfProductCount() const;
    void setSelfProductCount(const qint32 &self_product_count);
    bool is_self_product_count_Set() const;
    bool is_self_product_count_Valid() const;
...
private:
    ...
    qint32 m_self_product_count;
    bool m_self_product_count_isSet;
    bool m_self_product_count_isValid;
