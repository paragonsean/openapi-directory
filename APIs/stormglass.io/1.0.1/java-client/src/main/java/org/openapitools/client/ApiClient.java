...
public class ApiClient {
    ...
    private String basePath = "https://api.stormglass.io";
    ...
    public ApiClient() {
        ...
        authentications.put("authenticationToken", new ApiKeyAuth("header", "Authentication-Token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.stormglass.io
