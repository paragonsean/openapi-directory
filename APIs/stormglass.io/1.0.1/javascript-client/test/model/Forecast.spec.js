...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StormGlassMarineWeather.Forecast();
  });
  ...
  describe('Forecast', function() {
    it('should create an instance of Forecast', function() {
      ...
      //var instance = new StormGlassMarineWeather.Forecast();
      //expect(instance).to.be.a(StormGlassMarineWeather.Forecast);
    });
