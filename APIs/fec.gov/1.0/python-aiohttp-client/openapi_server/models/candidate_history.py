...
class CandidateHistory(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, active_through: int=None, address_city: str=None, address_state: str=None, address_street_1: str=None, address_street_2: str=None, address_zip: str=None, candidate_election_year: int=None, candidate_id: str=None, candidate_inactive: bool=None, candidate_status: str=None, cycles: List[int]=None, district: str=None, district_number: int=None, election_districts: List[str]=None, election_years: List[int]=None, fec_cycles_in_election: List[int]=None, first_file_date: date=None, flags: str=None, incumbent_challenge: str=None, incumbent_challenge_full: str=None, last_f2_date: date=None, last_file_date: date=None, load_date: datetime=None, name: str=None, office: str=None, office_full: str=None, party: str=None, party_full: str=None, rounded_election_years: List[int]=None, state: str=None, two_year_period: int=None):
        """CandidateHistory - a model defined in OpenAPI

        :param active_through: The active_through of this CandidateHistory.
        :param address_city: The address_city of this CandidateHistory.
        :param address_state: The address_state of this CandidateHistory.
        :param address_street_1: The address_street_1 of this CandidateHistory.
        :param address_street_2: The address_street_2 of this CandidateHistory.
        :param address_zip: The address_zip of this CandidateHistory.
        :param candidate_election_year: The candidate_election_year of this CandidateHistory.
        :param candidate_id: The candidate_id of this CandidateHistory.
        :param candidate_inactive: The candidate_inactive of this CandidateHistory.
        :param candidate_status: The candidate_status of this CandidateHistory.
        :param cycles: The cycles of this CandidateHistory.
        :param district: The district of this CandidateHistory.
        :param district_number: The district_number of this CandidateHistory.
        :param election_districts: The election_districts of this CandidateHistory.
        :param election_years: The election_years of this CandidateHistory.
        :param fec_cycles_in_election: The fec_cycles_in_election of this CandidateHistory.
        :param first_file_date: The first_file_date of this CandidateHistory.
        :param flags: The flags of this CandidateHistory.
        :param incumbent_challenge: The incumbent_challenge of this CandidateHistory.
        :param incumbent_challenge_full: The incumbent_challenge_full of this CandidateHistory.
        :param last_f2_date: The last_f2_date of this CandidateHistory.
        :param last_file_date: The last_file_date of this CandidateHistory.
        :param load_date: The load_date of this CandidateHistory.
        :param name: The name of this CandidateHistory.
        :param office: The office of this CandidateHistory.
        :param office_full: The office_full of this CandidateHistory.
        :param party: The party of this CandidateHistory.
        :param party_full: The party_full of this CandidateHistory.
        :param rounded_election_years: The rounded_election_years of this CandidateHistory.
        :param state: The state of this CandidateHistory.
        :param two_year_period: The two_year_period of this CandidateHistory.
        """
        self.openapi_types = {
            'active_through': int,
            'address_city': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CandidateHistory':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CandidateHistory of this CandidateHistory.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def active_through(self):
        """Gets the active_through of this CandidateHistory.
        ...
        :return: The active_through of this CandidateHistory.
        :rtype: int
        """
    ...
    def address_city(self):
        """Gets the address_city of this CandidateHistory.

        City of candidate's address, as reported on their Form 2.

        :return: The address_city of this CandidateHistory.
        :rtype: str
        """
    ...
    def address_state(self):
        """Gets the address_state of this CandidateHistory.

        State of candidate's address, as reported on their Form 2.

        :return: The address_state of this CandidateHistory.
        :rtype: str
        """
    ...
    def address_street_1(self):
        """Gets the address_street_1 of this CandidateHistory.

        Street of candidate's address, as reported on their Form 2.

        :return: The address_street_1 of this CandidateHistory.
        :rtype: str
        """
    ...
    def address_street_2(self):
        """Gets the address_street_2 of this CandidateHistory.

        Additional street information of candidate's address, as reported on their Form 2.

        :return: The address_street_2 of this CandidateHistory.
        :rtype: str
        """
    ...
    def address_zip(self):
        """Gets the address_zip of this CandidateHistory.

        Zip code of candidate's address, as reported on their Form 2.

        :return: The address_zip of this CandidateHistory.
        :rtype: str
        """
    ...
    def candidate_election_year(self):
        """Gets the candidate_election_year of this CandidateHistory.

        The last year of the cycle for this election.

        :return: The candidate_election_year of this CandidateHistory.
        :rtype: int
        """
    ...
    def candidate_inactive(self):
        """Gets the candidate_inactive of this CandidateHistory.

         True indicates that a candidate is inactive. 

        :return: The candidate_inactive of this CandidateHistory.
        :rtype: bool
        """
    ...
    def candidate_status(self):
        """Gets the candidate_status of this CandidateHistory.
        ...
        :return: The candidate_status of this CandidateHistory.
        :rtype: str
        """
    ...
    @property
    def cycles(self):
        """Gets the cycles of this CandidateHistory.
        ...
        :return: The cycles of this CandidateHistory.
        :rtype: List[int]
        """
        return self._cycles
    ...
    @property
    def district(self):
        """Gets the district of this CandidateHistory.

        Two-digit US House distirict of the office the candidate is running for. Presidential, Senate and House at-large candidates will have District 00.

        :return: The district of this CandidateHistory.
        :rtype: str
        """
    ...
    def district_number(self):
        """Gets the district_number of this CandidateHistory.

        One-letter code explaining if the candidate is:         - C present candidate         - F future candidate         - N not yet a candidate         - P prior candidate 

        :return: The district_number of this CandidateHistory.
        :rtype: int
        """
    ...
    def election_districts(self):
        """Gets the election_districts of this CandidateHistory.

        Two-digit US House distirict of the office the candidate is running for. Presidential, Senate and House at-large candidates will have District 00.

        :return: The election_districts of this CandidateHistory.
        :rtype: List[str]
        """
    ...
    def election_years(self):
        """Gets the election_years of this CandidateHistory.

        Years in which a candidate ran for office.

        :return: The election_years of this CandidateHistory.
        :rtype: List[int]
        """
    ...
    def fec_cycles_in_election(self):
        """Gets the fec_cycles_in_election of this CandidateHistory.

        FEC cycles are included in candidate election years.

        :return: The fec_cycles_in_election of this CandidateHistory.
        :rtype: List[int]
        """
    ...
    def first_file_date(self):
        """Gets the first_file_date of this CandidateHistory.

        The day the FEC received the candidate's first filing. This is a F2 candidate registration.

        :return: The first_file_date of this CandidateHistory.
        :rtype: date
        """
    ...
    @property
    def flags(self):
        """Gets the flags of this CandidateHistory.


        :return: The flags of this CandidateHistory.
        :rtype: str
        """
        return self._flags
    ...
    def incumbent_challenge(self):
        """Gets the incumbent_challenge of this CandidateHistory.

        One-letter code ('I', 'C', 'O') explaining if the candidate is an incumbent, a challenger, or if the seat is open.

        :return: The incumbent_challenge of this CandidateHistory.
        :rtype: str
        """
    ...
    def incumbent_challenge_full(self):
        """Gets the incumbent_challenge_full of this CandidateHistory.

        Explains if the candidate is an incumbent, a challenger, or if the seat is open.

        :return: The incumbent_challenge_full of this CandidateHistory.
        :rtype: str
        """
    ...
    def last_f2_date(self):
        """Gets the last_f2_date of this CandidateHistory.

        The day the FEC received the candidate's most recent Form 2

        :return: The last_f2_date of this CandidateHistory.
        :rtype: date
        """
    ...
    def last_file_date(self):
        """Gets the last_file_date of this CandidateHistory.

        The day the FEC received the candidate's most recent filing

        :return: The last_file_date of this CandidateHistory.
        :rtype: date
        """
    ...
    @property
    def load_date(self):
        """Gets the load_date of this CandidateHistory.
        ...
        :return: The load_date of this CandidateHistory.
        :rtype: datetime
        """
    ...
    @property
    def name(self):
        """Gets the name of this CandidateHistory.

        Name of candidate running for office

        :return: The name of this CandidateHistory.
        :rtype: str
        """
        return self._name
    ...
    @property
    def office(self):
        """Gets the office of this CandidateHistory.

        Federal office candidate runs for: H, S or P

        :return: The office of this CandidateHistory.
        :rtype: str
        """
        return self._office
    ...
    def office_full(self):
        """Gets the office_full of this CandidateHistory.

        Federal office candidate runs for: House, Senate or presidential

        :return: The office_full of this CandidateHistory.
        :rtype: str
        """
    ...
    @property
    def party(self):
        """Gets the party of this CandidateHistory.

        Three-letter code for the party affiliated with a candidate or committee. For example, DEM for Democratic Party and REP for Republican Party.

        :return: The party of this CandidateHistory.
        :rtype: str
        """
        return self._party
    ...
    @property
    def party_full(self):
        """Gets the party_full of this CandidateHistory.

        Party affiliated with a candidate or committee

        :return: The party_full of this CandidateHistory.
        :rtype: str
        """
    ...
    def rounded_election_years(self):
        """Gets the rounded_election_years of this CandidateHistory.

        Rounded election years in which a candidate ran for office

        :return: The rounded_election_years of this CandidateHistory.
        :rtype: List[int]
        """
    ...
    @property
    def state(self):
        """Gets the state of this CandidateHistory.

        US state or territory where a candidate runs for office

        :return: The state of this CandidateHistory.
        :rtype: str
        """
        return self._state
    ...
    def two_year_period(self):
        """Gets the two_year_period of this CandidateHistory.

         Two-year election cycle in which a candidate runs for office. Calculated from Form 2. The cycle begins with an odd year and is named for its ending, even year. This cycle follows the traditional house election cycle and subdivides the presidential and Senate elections into comparable two-year blocks. To retrieve data for the entire four years of a presidential term or six years of a senatorial term, you will need the `election_full` flag. 

        :return: The two_year_period of this CandidateHistory.
        :rtype: int
        """
