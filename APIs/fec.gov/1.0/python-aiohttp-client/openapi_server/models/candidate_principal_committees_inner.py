...
class CandidatePrincipalCommitteesInner(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, affiliated_committee_name: str=None, candidate_ids: List[str]=None, committee_id: str=None, committee_type: str=None, committee_type_full: str=None, cycles: List[int]=None, designation: str=None, designation_full: str=None, filing_frequency: str=None, first_f1_date: date=None, first_file_date: date=None, last_f1_date: date=None, last_file_date: date=None, name: str=None, organization_type: str=None, organization_type_full: str=None, party: str=None, party_full: str=None, state: str=None, treasurer_name: str=None):
        """CandidatePrincipalCommitteesInner - a model defined in OpenAPI

        :param affiliated_committee_name: The affiliated_committee_name of this CandidatePrincipalCommitteesInner.
        :param candidate_ids: The candidate_ids of this CandidatePrincipalCommitteesInner.
        :param committee_id: The committee_id of this CandidatePrincipalCommitteesInner.
        :param committee_type: The committee_type of this CandidatePrincipalCommitteesInner.
        :param committee_type_full: The committee_type_full of this CandidatePrincipalCommitteesInner.
        :param cycles: The cycles of this CandidatePrincipalCommitteesInner.
        :param designation: The designation of this CandidatePrincipalCommitteesInner.
        :param designation_full: The designation_full of this CandidatePrincipalCommitteesInner.
        :param filing_frequency: The filing_frequency of this CandidatePrincipalCommitteesInner.
        :param first_f1_date: The first_f1_date of this CandidatePrincipalCommitteesInner.
        :param first_file_date: The first_file_date of this CandidatePrincipalCommitteesInner.
        :param last_f1_date: The last_f1_date of this CandidatePrincipalCommitteesInner.
        :param last_file_date: The last_file_date of this CandidatePrincipalCommitteesInner.
        :param name: The name of this CandidatePrincipalCommitteesInner.
        :param organization_type: The organization_type of this CandidatePrincipalCommitteesInner.
        :param organization_type_full: The organization_type_full of this CandidatePrincipalCommitteesInner.
        :param party: The party of this CandidatePrincipalCommitteesInner.
        :param party_full: The party_full of this CandidatePrincipalCommitteesInner.
        :param state: The state of this CandidatePrincipalCommitteesInner.
        :param treasurer_name: The treasurer_name of this CandidatePrincipalCommitteesInner.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CandidatePrincipalCommitteesInner':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Candidate_principal_committees_inner of this CandidatePrincipalCommitteesInner.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def affiliated_committee_name(self):
        """Gets the affiliated_committee_name of this CandidatePrincipalCommitteesInner.

         Affiliated committee or connected organization 

        :return: The affiliated_committee_name of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
    ...
    def affiliated_committee_name(self, affiliated_committee_name):
        """Sets the affiliated_committee_name of this CandidatePrincipalCommitteesInner.
    ...
    def candidate_ids(self):
        """Gets the candidate_ids of this CandidatePrincipalCommitteesInner.

         A unique identifier assigned to each candidate registered with the FEC. If a person runs for several offices, that person will have separate candidate IDs for each office. First character indicates office - [P]residential, [H]ouse, [S]enate]. Second character is the last digit of the two-year period the ID was created. Third and fourth is the candidate state. Presidential IDs don't have state. Fifth and sixth is the district when the candidate first ran. This does not change if the candidate/member's district changes during re-districting. Presidential IDs don't have districts. The rest is sequence. 

        :return: The candidate_ids of this CandidatePrincipalCommitteesInner.
        :rtype: List[str]
        """
    ...
    def candidate_ids(self, candidate_ids):
        """Sets the candidate_ids of this CandidatePrincipalCommitteesInner.
    ...
    def committee_id(self):
        """Gets the committee_id of this CandidatePrincipalCommitteesInner.

         A unique identifier assigned to each committee or filer registered with the FEC. In general committee id's begin with the letter C which is followed by eight digits. 

        :return: The committee_id of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
    ...
    def committee_id(self, committee_id):
        """Sets the committee_id of this CandidatePrincipalCommitteesInner.
    ...
    def committee_type(self):
        """Gets the committee_type of this CandidatePrincipalCommitteesInner.

        The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account 

        :return: The committee_type of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
    ...
    def committee_type(self, committee_type):
        """Sets the committee_type of this CandidatePrincipalCommitteesInner.
    ...
    def committee_type_full(self):
        """Gets the committee_type_full of this CandidatePrincipalCommitteesInner.

        The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account 

        :return: The committee_type_full of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
    ...
    def committee_type_full(self, committee_type_full):
        """Sets the committee_type_full of this CandidatePrincipalCommitteesInner.
    ...
    @property
    def cycles(self):
        """Gets the cycles of this CandidatePrincipalCommitteesInner.
        ...
        :return: The cycles of this CandidatePrincipalCommitteesInner.
        :rtype: List[int]
        """
        return self._cycles
    ...
    def cycles(self, cycles):
        """Sets the cycles of this CandidatePrincipalCommitteesInner.
    ...
    def designation(self):
        """Gets the designation of this CandidatePrincipalCommitteesInner.
        ...
        :return: The designation of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
    ...
    def designation(self, designation):
        """Sets the designation of this CandidatePrincipalCommitteesInner.
    ...
    def designation_full(self):
        """Gets the designation_full of this CandidatePrincipalCommitteesInner.

        The one-letter designation code of the organization:          - A authorized by a candidate          - J joint fundraising committee          - P principal campaign committee of a candidate          - U unauthorized          - B lobbyist/registrant PAC          - D leadership PAC 

        :return: The designation_full of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
    ...
    def designation_full(self, designation_full):
        """Sets the designation_full of this CandidatePrincipalCommitteesInner.
    ...
    def filing_frequency(self):
        """Gets the filing_frequency of this CandidatePrincipalCommitteesInner.
        ...
        :return: The filing_frequency of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
    ...
    def filing_frequency(self, filing_frequency):
        """Sets the filing_frequency of this CandidatePrincipalCommitteesInner.
    ...
    def first_f1_date(self):
        """Gets the first_f1_date of this CandidatePrincipalCommitteesInner.

        The day the FEC received the committee's first Form 1

        :return: The first_f1_date of this CandidatePrincipalCommitteesInner.
        :rtype: date
        """
    ...
    def first_f1_date(self, first_f1_date):
        """Sets the first_f1_date of this CandidatePrincipalCommitteesInner.
    ...
    def first_file_date(self):
        """Gets the first_file_date of this CandidatePrincipalCommitteesInner.

        The day the FEC received the committee's first filing. This is usually a Form 1 committee registration.

        :return: The first_file_date of this CandidatePrincipalCommitteesInner.
        :rtype: date
        """
    ...
    def first_file_date(self, first_file_date):
        """Sets the first_file_date of this CandidatePrincipalCommitteesInner.
    ...
    def last_f1_date(self):
        """Gets the last_f1_date of this CandidatePrincipalCommitteesInner.

        The day the FEC received the committee's most recent Form 1

        :return: The last_f1_date of this CandidatePrincipalCommitteesInner.
        :rtype: date
        """
    ...
    def last_f1_date(self, last_f1_date):
        """Sets the last_f1_date of this CandidatePrincipalCommitteesInner.
    ...
    def last_file_date(self):
        """Gets the last_file_date of this CandidatePrincipalCommitteesInner.

        The day the FEC received the committee's most recent filing

        :return: The last_file_date of this CandidatePrincipalCommitteesInner.
        :rtype: date
        """
    ...
    def last_file_date(self, last_file_date):
        """Sets the last_file_date of this CandidatePrincipalCommitteesInner.
    ...
    @property
    def name(self):
        """Gets the name of this CandidatePrincipalCommitteesInner.

        The name of the committee. If a committee changes its name,     the most recent name will be shown. Committee names are not unique. Use committee_id     for looking up records.

        :return: The name of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CandidatePrincipalCommitteesInner.
    ...
    def organization_type(self):
        """Gets the organization_type of this CandidatePrincipalCommitteesInner.
        ...
        :return: The organization_type of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
    ...
    def organization_type(self, organization_type):
        """Sets the organization_type of this CandidatePrincipalCommitteesInner.
    ...
    def organization_type_full(self):
        """Gets the organization_type_full of this CandidatePrincipalCommitteesInner.

        The one-letter code for the kind for organization:         - C corporation         - L labor organization         - M membership organization         - T trade association         - V cooperative         - W corporation without capital stock 

        :return: The organization_type_full of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
    ...
    def organization_type_full(self, organization_type_full):
        """Sets the organization_type_full of this CandidatePrincipalCommitteesInner.
    ...
    @property
    def party(self):
        """Gets the party of this CandidatePrincipalCommitteesInner.

        Three-letter code for the party affiliated with a candidate or committee. For example, DEM for Democratic Party and REP for Republican Party.

        :return: The party of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
        return self._party
    ...
    def party(self, party):
        """Sets the party of this CandidatePrincipalCommitteesInner.
    ...
    @property
    def party_full(self):
        """Gets the party_full of this CandidatePrincipalCommitteesInner.

        Three-letter code for the party affiliated with a candidate or committee. For example, DEM for Democratic Party and REP for Republican Party.

        :return: The party_full of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
    ...
    def party_full(self, party_full):
        """Sets the party_full of this CandidatePrincipalCommitteesInner.
    ...
    @property
    def state(self):
        """Gets the state of this CandidatePrincipalCommitteesInner.

         State of the committee's address as filed on the Form 1 

        :return: The state of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this CandidatePrincipalCommitteesInner.
    ...
    def treasurer_name(self):
        """Gets the treasurer_name of this CandidatePrincipalCommitteesInner.

        Name of the Committee's treasurer. If multiple treasurers for the committee, the most recent treasurer will be shown.

        :return: The treasurer_name of this CandidatePrincipalCommitteesInner.
        :rtype: str
        """
    ...
    def treasurer_name(self, treasurer_name):
        """Sets the treasurer_name of this CandidatePrincipalCommitteesInner.
