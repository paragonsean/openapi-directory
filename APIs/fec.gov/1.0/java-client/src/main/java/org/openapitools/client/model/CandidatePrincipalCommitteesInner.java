...
public class CandidatePrincipalCommitteesInner {
  ...
  public CandidatePrincipalCommitteesInner() {
  }

  public CandidatePrincipalCommitteesInner affiliatedCommitteeName(String affiliatedCommitteeName) {
  ...
  public CandidatePrincipalCommitteesInner candidateIds(List<String> candidateIds) {
    this.candidateIds = candidateIds;
    return this;
  }

  public CandidatePrincipalCommitteesInner addCandidateIdsItem(String candidateIdsItem) {
  ...
  public CandidatePrincipalCommitteesInner committeeId(String committeeId) {
  ...
  public CandidatePrincipalCommitteesInner committeeType(String committeeType) {
  ...
  public CandidatePrincipalCommitteesInner committeeTypeFull(String committeeTypeFull) {
  ...
  public CandidatePrincipalCommitteesInner cycles(List<Integer> cycles) {
    this.cycles = cycles;
    return this;
  }

  public CandidatePrincipalCommitteesInner addCyclesItem(Integer cyclesItem) {
    if (this.cycles == null) {
  ...
  public CandidatePrincipalCommitteesInner designation(String designation) {
  ...
  public CandidatePrincipalCommitteesInner designationFull(String designationFull) {
  ...
  public CandidatePrincipalCommitteesInner filingFrequency(String filingFrequency) {
  ...
  public CandidatePrincipalCommitteesInner firstF1Date(LocalDate firstF1Date) {
  ...
  public CandidatePrincipalCommitteesInner firstFileDate(LocalDate firstFileDate) {
  ...
  public CandidatePrincipalCommitteesInner lastF1Date(LocalDate lastF1Date) {
  ...
  public CandidatePrincipalCommitteesInner lastFileDate(LocalDate lastFileDate) {
  ...
  public CandidatePrincipalCommitteesInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CandidatePrincipalCommitteesInner organizationType(String organizationType) {
  ...
  public CandidatePrincipalCommitteesInner organizationTypeFull(String organizationTypeFull) {
  ...
  public CandidatePrincipalCommitteesInner party(String party) {
    this.party = party;
    return this;
  }
  ...
  public CandidatePrincipalCommitteesInner partyFull(String partyFull) {
  ...
  public CandidatePrincipalCommitteesInner state(String state) {
    this.state = state;
    return this;
  }
  ...
  public CandidatePrincipalCommitteesInner treasurerName(String treasurerName) {
  ...
  public boolean equals(Object o) {
    ...
    CandidatePrincipalCommitteesInner candidatePrincipalCommitteesInner = (CandidatePrincipalCommitteesInner) o;
    return Objects.equals(this.affiliatedCommitteeName, candidatePrincipalCommitteesInner.affiliatedCommitteeName) &&
        Objects.equals(this.candidateIds, candidatePrincipalCommitteesInner.candidateIds) &&
        Objects.equals(this.committeeId, candidatePrincipalCommitteesInner.committeeId) &&
        Objects.equals(this.committeeType, candidatePrincipalCommitteesInner.committeeType) &&
        Objects.equals(this.committeeTypeFull, candidatePrincipalCommitteesInner.committeeTypeFull) &&
        Objects.equals(this.cycles, candidatePrincipalCommitteesInner.cycles) &&
        Objects.equals(this.designation, candidatePrincipalCommitteesInner.designation) &&
        Objects.equals(this.designationFull, candidatePrincipalCommitteesInner.designationFull) &&
        Objects.equals(this.filingFrequency, candidatePrincipalCommitteesInner.filingFrequency) &&
        Objects.equals(this.firstF1Date, candidatePrincipalCommitteesInner.firstF1Date) &&
        Objects.equals(this.firstFileDate, candidatePrincipalCommitteesInner.firstFileDate) &&
        Objects.equals(this.lastF1Date, candidatePrincipalCommitteesInner.lastF1Date) &&
        Objects.equals(this.lastFileDate, candidatePrincipalCommitteesInner.lastFileDate) &&
        Objects.equals(this.name, candidatePrincipalCommitteesInner.name) &&
        Objects.equals(this.organizationType, candidatePrincipalCommitteesInner.organizationType) &&
        Objects.equals(this.organizationTypeFull, candidatePrincipalCommitteesInner.organizationTypeFull) &&
        Objects.equals(this.party, candidatePrincipalCommitteesInner.party) &&
        Objects.equals(this.partyFull, candidatePrincipalCommitteesInner.partyFull) &&
        Objects.equals(this.state, candidatePrincipalCommitteesInner.state) &&
        Objects.equals(this.treasurerName, candidatePrincipalCommitteesInner.treasurerName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affiliatedCommitteeName, candidateIds, committeeId, committeeType, committeeTypeFull, cycles, designation, designationFull, filingFrequency, firstF1Date, firstFileDate, lastF1Date, lastFileDate, name, organizationType, organizationTypeFull, party, partyFull, state, treasurerName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CandidatePrincipalCommitteesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CandidatePrincipalCommitteesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CandidatePrincipalCommitteesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CandidatePrincipalCommitteesInner is not found in the empty JSON string", CandidatePrincipalCommitteesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CandidatePrincipalCommitteesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CandidatePrincipalCommitteesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CandidatePrincipalCommitteesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CandidatePrincipalCommitteesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CandidatePrincipalCommitteesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CandidatePrincipalCommitteesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CandidatePrincipalCommitteesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CandidatePrincipalCommitteesInner>() {
           @Override
           public void write(JsonWriter out, CandidatePrincipalCommitteesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CandidatePrincipalCommitteesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CandidatePrincipalCommitteesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CandidatePrincipalCommitteesInner
   * @throws IOException if the JSON string is invalid with respect to CandidatePrincipalCommitteesInner
   */
  public static CandidatePrincipalCommitteesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CandidatePrincipalCommitteesInner.class);
  }

  /**
   * Convert an instance of CandidatePrincipalCommitteesInner to an JSON string
   *
   * @return JSON string
   */
