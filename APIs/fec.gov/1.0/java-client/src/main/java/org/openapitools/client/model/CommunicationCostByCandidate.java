...
public class CommunicationCostByCandidate {
  ...
  public CommunicationCostByCandidate() {
  }

  public CommunicationCostByCandidate candidate(String candidate) {
  ...
  public CommunicationCostByCandidate candidateId(String candidateId) {
  ...
  public CommunicationCostByCandidate candidateName(String candidateName) {
  ...
  public CommunicationCostByCandidate committee(String committee) {
  ...
  public CommunicationCostByCandidate committeeId(String committeeId) {
  ...
  public CommunicationCostByCandidate committeeName(String committeeName) {
  ...
  public CommunicationCostByCandidate count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public CommunicationCostByCandidate cycle(Integer cycle) {
    this.cycle = cycle;
    return this;
  }
  ...
  public CommunicationCostByCandidate supportOpposeIndicator(String supportOpposeIndicator) {
  ...
  public CommunicationCostByCandidate total(BigDecimal total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CommunicationCostByCandidate communicationCostByCandidate = (CommunicationCostByCandidate) o;
    return Objects.equals(this.candidate, communicationCostByCandidate.candidate) &&
        Objects.equals(this.candidateId, communicationCostByCandidate.candidateId) &&
        Objects.equals(this.candidateName, communicationCostByCandidate.candidateName) &&
        Objects.equals(this.committee, communicationCostByCandidate.committee) &&
        Objects.equals(this.committeeId, communicationCostByCandidate.committeeId) &&
        Objects.equals(this.committeeName, communicationCostByCandidate.committeeName) &&
        Objects.equals(this.count, communicationCostByCandidate.count) &&
        Objects.equals(this.cycle, communicationCostByCandidate.cycle) &&
        Objects.equals(this.supportOpposeIndicator, communicationCostByCandidate.supportOpposeIndicator) &&
        Objects.equals(this.total, communicationCostByCandidate.total);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(candidate, candidateId, candidateName, committee, committeeId, committeeName, count, cycle, supportOpposeIndicator, total);
  }
  ...
  public String toString() {
    ...
    sb.append("class CommunicationCostByCandidate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommunicationCostByCandidate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommunicationCostByCandidate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommunicationCostByCandidate is not found in the empty JSON string", CommunicationCostByCandidate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommunicationCostByCandidate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommunicationCostByCandidate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CommunicationCostByCandidate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommunicationCostByCandidate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommunicationCostByCandidate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommunicationCostByCandidate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommunicationCostByCandidate.class));

       return (TypeAdapter<T>) new TypeAdapter<CommunicationCostByCandidate>() {
           @Override
           public void write(JsonWriter out, CommunicationCostByCandidate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommunicationCostByCandidate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommunicationCostByCandidate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommunicationCostByCandidate
   * @throws IOException if the JSON string is invalid with respect to CommunicationCostByCandidate
   */
  public static CommunicationCostByCandidate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommunicationCostByCandidate.class);
  }

  /**
   * Convert an instance of CommunicationCostByCandidate to an JSON string
   *
   * @return JSON string
   */
