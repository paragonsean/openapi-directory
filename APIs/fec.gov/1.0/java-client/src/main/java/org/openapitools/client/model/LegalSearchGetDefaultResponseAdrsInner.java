...
public class LegalSearchGetDefaultResponseAdrsInner {
  ...
  public LegalSearchGetDefaultResponseAdrsInner() {
  }

  public LegalSearchGetDefaultResponseAdrsInner closeDate(LocalDate closeDate) {
  ...
  public LegalSearchGetDefaultResponseAdrsInner commissionVotes(List<LegalSearchGetDefaultResponseAdminFinesInnerCommissionVotesInner> commissionVotes) {
    this.commissionVotes = commissionVotes;
    return this;
  }

  public LegalSearchGetDefaultResponseAdrsInner addCommissionVotesItem(LegalSearchGetDefaultResponseAdminFinesInnerCommissionVotesInner commissionVotesItem) {
  ...
  public LegalSearchGetDefaultResponseAdrsInner dispositions(List<LegalSearchGetDefaultResponseAdrsInnerDispositionsInner> dispositions) {
    this.dispositions = dispositions;
    return this;
  }

  public LegalSearchGetDefaultResponseAdrsInner addDispositionsItem(LegalSearchGetDefaultResponseAdrsInnerDispositionsInner dispositionsItem) {
  ...
  public LegalSearchGetDefaultResponseAdrsInner docId(String docId) {
    this.docId = docId;
    return this;
  }
  ...
  public LegalSearchGetDefaultResponseAdrsInner documentHighlights(Object documentHighlights) {
  ...
  public LegalSearchGetDefaultResponseAdrsInner documents(List<LegalSearchGetDefaultResponseAdminFinesInnerDocumentsInner> documents) {
    this.documents = documents;
    return this;
  }

  public LegalSearchGetDefaultResponseAdrsInner addDocumentsItem(LegalSearchGetDefaultResponseAdminFinesInnerDocumentsInner documentsItem) {
  ...
  public LegalSearchGetDefaultResponseAdrsInner electionCycles(Integer electionCycles) {
  ...
  public LegalSearchGetDefaultResponseAdrsInner highlights(List<String> highlights) {
    this.highlights = highlights;
    return this;
  }

  public LegalSearchGetDefaultResponseAdrsInner addHighlightsItem(String highlightsItem) {
  ...
  public LegalSearchGetDefaultResponseAdrsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public LegalSearchGetDefaultResponseAdrsInner false(String false) {
    this.false = false;
    return this;
  }
  ...
  public LegalSearchGetDefaultResponseAdrsInner openDate(LocalDate openDate) {
  ...
  public LegalSearchGetDefaultResponseAdrsInner participants(List<LegalSearchGetDefaultResponseAdrsInnerParticipantsInner> participants) {
    this.participants = participants;
    return this;
  }

  public LegalSearchGetDefaultResponseAdrsInner addParticipantsItem(LegalSearchGetDefaultResponseAdrsInnerParticipantsInner participantsItem) {
  ...
  public LegalSearchGetDefaultResponseAdrsInner respondents(List<String> respondents) {
    this.respondents = respondents;
    return this;
  }

  public LegalSearchGetDefaultResponseAdrsInner addRespondentsItem(String respondentsItem) {
  ...
  public LegalSearchGetDefaultResponseAdrsInner subjects(List<String> subjects) {
    this.subjects = subjects;
    return this;
  }

  public LegalSearchGetDefaultResponseAdrsInner addSubjectsItem(String subjectsItem) {
  ...
  public LegalSearchGetDefaultResponseAdrsInner url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LegalSearchGetDefaultResponseAdrsInner legalSearchGetDefaultResponseAdrsInner = (LegalSearchGetDefaultResponseAdrsInner) o;
    return Objects.equals(this.closeDate, legalSearchGetDefaultResponseAdrsInner.closeDate) &&
        Objects.equals(this.commissionVotes, legalSearchGetDefaultResponseAdrsInner.commissionVotes) &&
        Objects.equals(this.dispositions, legalSearchGetDefaultResponseAdrsInner.dispositions) &&
        Objects.equals(this.docId, legalSearchGetDefaultResponseAdrsInner.docId) &&
        Objects.equals(this.documentHighlights, legalSearchGetDefaultResponseAdrsInner.documentHighlights) &&
        Objects.equals(this.documents, legalSearchGetDefaultResponseAdrsInner.documents) &&
        Objects.equals(this.electionCycles, legalSearchGetDefaultResponseAdrsInner.electionCycles) &&
        Objects.equals(this.highlights, legalSearchGetDefaultResponseAdrsInner.highlights) &&
        Objects.equals(this.name, legalSearchGetDefaultResponseAdrsInner.name) &&
        Objects.equals(this.false, legalSearchGetDefaultResponseAdrsInner.false) &&
        Objects.equals(this.openDate, legalSearchGetDefaultResponseAdrsInner.openDate) &&
        Objects.equals(this.participants, legalSearchGetDefaultResponseAdrsInner.participants) &&
        Objects.equals(this.respondents, legalSearchGetDefaultResponseAdrsInner.respondents) &&
        Objects.equals(this.subjects, legalSearchGetDefaultResponseAdrsInner.subjects) &&
        Objects.equals(this.url, legalSearchGetDefaultResponseAdrsInner.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(closeDate, commissionVotes, dispositions, docId, documentHighlights, documents, electionCycles, highlights, name, false, openDate, participants, respondents, subjects, url);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LegalSearchGetDefaultResponseAdrsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LegalSearchGetDefaultResponseAdrsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LegalSearchGetDefaultResponseAdrsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalSearchGetDefaultResponseAdrsInner is not found in the empty JSON string", LegalSearchGetDefaultResponseAdrsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LegalSearchGetDefaultResponseAdrsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LegalSearchGetDefaultResponseAdrsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegalSearchGetDefaultResponseAdrsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegalSearchGetDefaultResponseAdrsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegalSearchGetDefaultResponseAdrsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegalSearchGetDefaultResponseAdrsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<LegalSearchGetDefaultResponseAdrsInner>() {
           @Override
           public void write(JsonWriter out, LegalSearchGetDefaultResponseAdrsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LegalSearchGetDefaultResponseAdrsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LegalSearchGetDefaultResponseAdrsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LegalSearchGetDefaultResponseAdrsInner
   * @throws IOException if the JSON string is invalid with respect to LegalSearchGetDefaultResponseAdrsInner
   */
  public static LegalSearchGetDefaultResponseAdrsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegalSearchGetDefaultResponseAdrsInner.class);
  }

  /**
   * Convert an instance of LegalSearchGetDefaultResponseAdrsInner to an JSON string
   *
   * @return JSON string
   */
