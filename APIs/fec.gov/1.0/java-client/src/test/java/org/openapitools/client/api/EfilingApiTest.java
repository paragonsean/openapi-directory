...
/**
 * API tests for EfilingApi
 */
@Disabled
public class EfilingApiTest {

    private final EfilingApi api = new EfilingApi();
     ...
     */
    @Test
    public void efileFilingsGetTest() throws ApiException {
        String apiKey = null;
        ...
        EFilingsPage response = api.efileFilingsGet(apiKey, minReceiptDate, sortNullsLast, page, committeeId, sortNullOnly, maxReceiptDate, sortHideNull, fileNumber, perPage, sort, qFiler);
     ...
     */
    @Test
    public void efileReportsHouseSenateGetTest() throws ApiException {
        String apiKey = null;
        LocalDate minReceiptDate = null;
        Boolean sortNullsLast = null;
        Integer page = null;
        ...
        String sort = null;
        List<String> qFiler = null;
        BaseF3FilingPage response = api.efileReportsHouseSenateGet(apiKey, minReceiptDate, sortNullsLast, page, committeeId, sortNullOnly, maxReceiptDate, sortHideNull, fileNumber, perPage, sort, qFiler);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void efileReportsPacPartyGetTest() throws ApiException {
        String apiKey = null;
        LocalDate minReceiptDate = null;
        Boolean sortNullsLast = null;
        Integer page = null;
        ...
        String sort = null;
        List<String> qFiler = null;
        BaseF3XFilingPage response = api.efileReportsPacPartyGet(apiKey, minReceiptDate, sortNullsLast, page, committeeId, sortNullOnly, maxReceiptDate, sortHideNull, fileNumber, perPage, sort, qFiler);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void efileReportsPresidentialGetTest() throws ApiException {
        String apiKey = null;
        LocalDate minReceiptDate = null;
        Boolean sortNullsLast = null;
        Integer page = null;
        ...
        String sort = null;
        List<String> qFiler = null;
        BaseF3PFilingPage response = api.efileReportsPresidentialGet(apiKey, minReceiptDate, sortNullsLast, page, committeeId, sortNullOnly, maxReceiptDate, sortHideNull, fileNumber, perPage, sort, qFiler);
        // TODO: test validations
    }
