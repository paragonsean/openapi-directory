...
import org.openapitools.client.api.FinancialApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    String minPartyCoordinatedExpenditures = "minPartyCoordinatedExpenditures_example"; // String |  Filter for all amounts greater than a value. 
    Boolean isAmended = true; // Boolean |  False indicates that a report is the most recent. True indicates that the report has been superseded by an amendment. 
    String maxPartyCoordinatedExpenditures = "maxPartyCoordinatedExpenditures_example"; // String |  Filter for all amounts less than a value. 
    String maxCashOnHandEndPeriodAmount = "maxCashOnHandEndPeriodAmount_example"; // String |  Filter for all amounts less than a value. 
    String maxDisbursementsAmount = "maxDisbursementsAmount_example"; // String |  Filter for all amounts less than a value. 
    String maxDebtsOwedExpenditures = "maxDebtsOwedExpenditures_example"; // String |  Filter for all amounts less than a value. 
    String minReceiptsAmount = "minReceiptsAmount_example"; // String |  Filter for all amounts greater than a value. 
    ...
    String minDebtsOwedAmount = "minDebtsOwedAmount_example"; // String |  Filter for all amounts greater than a value. 
    ...
    String minIndependentExpenditures = "minIndependentExpenditures_example"; // String |  Filter for all amounts greater than a value. 
    ...
    String maxReceiptsAmount = "maxReceiptsAmount_example"; // String |  Filter for all amounts less than a value. 
    List<String> reportType = Arrays.asList(); // List<String> | Report type; prefix with \"-\" to exclude. Name of report where the underlying data comes from:     - 10D Pre-Election     - 10G Pre-General     - 10P Pre-Primary     - 10R Pre-Run-Off     - 10S Pre-Special     - 12C Pre-Convention     - 12G Pre-General     - 12P Pre-Primary     - 12R Pre-Run-Off     - 12S Pre-Special     - 30D Post-Election     - 30G Post-General     - 30P Post-Primary     - 30R Post-Run-Off     - 30S Post-Special     - 60D Post-Convention     - M1  January Monthly     - M10 October Monthly     - M11 November Monthly     - M12 December Monthly     - M2  February Monthly     - M3  March Monthly     - M4  April Monthly     - M5  May Monthly     - M6  June Monthly     - M7  July Monthly     - M8  August Monthly     - M9  September Monthly     - MY  Mid-Year Report     - Q1  April Quarterly     - Q2  July Quarterly     - Q3  October Quarterly     - TER Termination Report     - YE  Year-End     - ADJ COMP ADJUST AMEND     - CA  COMPREHENSIVE AMEND 
    String maxTotalContributions = "maxTotalContributions_example"; // String |  Filter for all amounts less than a value. 
    ...
    List<Integer> year = Arrays.asList(); // List<Integer> |  Forms with coverage date -      year from the coverage ending date. Forms without coverage date -      year from the receipt date. 
    String maxIndependentExpenditures = "maxIndependentExpenditures_example"; // String |  Filter for all amounts less than a value. 
    List<String> type = Arrays.asList(); // List<String> | The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account 
    String minCashOnHandEndPeriodAmount = "minCashOnHandEndPeriodAmount_example"; // String |  Filter for all amounts greater than a value. 
    String minDisbursementsAmount = "minDisbursementsAmount_example"; // String |  Filter for all amounts greater than a value. 
    String minTotalContributions = "minTotalContributions_example"; // String |  Filter for all amounts greater than a value. 
    List<String> beginningImageNumber = Arrays.asList(); // List<String> |  Unique identifier for the electronic or paper report. This number is used to construct PDF URLs to the original document. 
    try {
      CommitteeReportsPage result = apiInstance.committeeCommitteeIdReportsGet(apiKey, committeeId, minPartyCoordinatedExpenditures, isAmended, maxPartyCoordinatedExpenditures, maxCashOnHandEndPeriodAmount, maxDisbursementsAmount, maxDebtsOwedExpenditures, minReceiptsAmount, cycle, sortNullOnly, minDebtsOwedAmount, sortHideNull, candidateId, minIndependentExpenditures, perPage, sort, maxReceiptsAmount, reportType, maxTotalContributions, sortNullsLast, page, year, maxIndependentExpenditures, type, minCashOnHandEndPeriodAmount, minDisbursementsAmount, minTotalContributions, beginningImageNumber);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FinancialApi#committeeCommitteeIdReportsGet");
...
| **reportType** | [**List&lt;String&gt;**](String.md)| Report type; prefix with \&quot;-\&quot; to exclude. Name of report where the underlying data comes from:     - 10D Pre-Election     - 10G Pre-General     - 10P Pre-Primary     - 10R Pre-Run-Off     - 10S Pre-Special     - 12C Pre-Convention     - 12G Pre-General     - 12P Pre-Primary     - 12R Pre-Run-Off     - 12S Pre-Special     - 30D Post-Election     - 30G Post-General     - 30P Post-Primary     - 30R Post-Run-Off     - 30S Post-Special     - 60D Post-Convention     - M1  January Monthly     - M10 October Monthly     - M11 November Monthly     - M12 December Monthly     - M2  February Monthly     - M3  March Monthly     - M4  April Monthly     - M5  May Monthly     - M6  June Monthly     - M7  July Monthly     - M8  August Monthly     - M9  September Monthly     - MY  Mid-Year Report     - Q1  April Quarterly     - Q2  July Quarterly     - Q3  October Quarterly     - TER Termination Report     - YE  Year-End     - ADJ COMP ADJUST AMEND     - CA  COMPREHENSIVE AMEND  | [optional] |
...
| **year** | [**List&lt;Integer&gt;**](Integer.md)|  Forms with coverage date -      year from the coverage ending date. Forms without coverage date -      year from the receipt date.  | [optional] |
| **maxIndependentExpenditures** | **String**|  Filter for all amounts less than a value.  | [optional] |
| **type** | [**List&lt;String&gt;**](String.md)| The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account  | [optional] |
...
| **beginningImageNumber** | [**List&lt;String&gt;**](String.md)|  Unique identifier for the electronic or paper report. This number is used to construct PDF URLs to the original document.  | [optional] |
...
<a id="committeeCommitteeIdTotalsGet"></a>
# **committeeCommitteeIdTotalsGet**
> CommitteeTotalsPage committeeCommitteeIdTotalsGet(apiKey, committeeId, page, sortHideNull, perPage, sortNullsLast, sort, cycle, sortNullOnly)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean sortNullOnly = false; // Boolean | Toggle that filters out all rows having sort column that is non-null
    try {
      CommitteeTotalsPage result = apiInstance.committeeCommitteeIdTotalsGet(apiKey, committeeId, page, sortHideNull, perPage, sortNullsLast, sort, cycle, sortNullOnly);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FinancialApi#committeeCommitteeIdTotalsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="electionsGet"></a>
# **electionsGet**
> ElectionPage electionsGet(apiKey, cycle, office, district, electionFull, sortNullOnly, page, state, sortNullsLast, sortHideNull, perPage, sort)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean sortHideNull = false; // Boolean | Hide null values on sorted column(s).
    Integer perPage = 20; // Integer | The number of results returned per page. Defaults to 20.
    String sort = "-total_receipts"; // String | Provide a field to sort by. Use `-` for descending order. 
    try {
      ElectionPage result = apiInstance.electionsGet(apiKey, cycle, office, district, electionFull, sortNullOnly, page, state, sortNullsLast, sortHideNull, perPage, sort);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FinancialApi#electionsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **office** | **String**| Federal office candidate runs for: H, S or P | [enum: house, senate, president] |
...
<a id="electionsSearchGet"></a>
# **electionsSearchGet**
> ElectionsListPage electionsSearchGet(apiKey, zip, district, cycle, sortNullOnly, sortNullsLast, page, state, sortHideNull, perPage, office, sort)
...
public class Example {
  public static void main(String[] args) {
    ...
    FinancialApi apiInstance = new FinancialApi(defaultClient);
    String apiKey = "DEMO_KEY"; // String |  API key for https://api.data.gov. Get one at https://api.data.gov/signup. 
    List<Integer> zip = Arrays.asList(); // List<Integer> | Zip code
    ...
    Boolean sortHideNull = false; // Boolean | Hide null values on sorted column(s).
    Integer perPage = 20; // Integer | The number of results returned per page. Defaults to 20.
    List<String> office = Arrays.asList(); // List<String> | 
    List<String> sort = Arrays.asList(); // List<String> |  Provide a field to sort by. Use `-` for descending order. ex: `-case_no` 
    try {
      ElectionsListPage result = apiInstance.electionsSearchGet(apiKey, zip, district, cycle, sortNullOnly, sortNullsLast, page, state, sortHideNull, perPage, office, sort);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FinancialApi#electionsSearchGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
|------------- | ------------- | ------------- | -------------|
| **apiKey** | **String**|  API key for https://api.data.gov. Get one at https://api.data.gov/signup.  | [default to DEMO_KEY] |
| **zip** | [**List&lt;Integer&gt;**](Integer.md)| Zip code | [optional] |
...
| **sortHideNull** | **Boolean**| Hide null values on sorted column(s). | [optional] [default to false] |
| **perPage** | **Integer**| The number of results returned per page. Defaults to 20. | [optional] [default to 20] |
| **office** | [**List&lt;String&gt;**](String.md)|  | [optional] [enum: house, senate, president] |
| **sort** | [**List&lt;String&gt;**](String.md)|  Provide a field to sort by. Use &#x60;-&#x60; for descending order. ex: &#x60;-case_no&#x60;  | [optional] |
...
<a id="electionsSummaryGet"></a>
# **electionsSummaryGet**
> ElectionSummary electionsSummaryGet(apiKey, office, cycle, state, district, electionFull)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean electionFull = true; // Boolean | `True` indicates that full election period of a candidate. `False` indicates that two year election cycle.
    try {
      ElectionSummary result = apiInstance.electionsSummaryGet(apiKey, office, cycle, state, district, electionFull);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FinancialApi#electionsSummaryGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    FinancialApi apiInstance = new FinancialApi(defaultClient);
    String apiKey = "DEMO_KEY"; // String |  API key for https://api.data.gov. Get one at https://api.data.gov/signup. 
    String entityType = "presidential"; // String | Committee groupings based on FEC filing form.                 Choose one of: `presidential`, `pac-party`, `house-senate`, or `ie-only`
    String maxPartyCoordinatedExpenditures = "maxPartyCoordinatedExpenditures_example"; // String |  Filter for all amounts less than a value. 
    String maxDebtsOwedExpenditures = "maxDebtsOwedExpenditures_example"; // String |  Filter for all amounts less than a value. 
    String minReceiptsAmount = "minReceiptsAmount_example"; // String |  Filter for all amounts greater than a value. 
    String minDebtsOwedAmount = "minDebtsOwedAmount_example"; // String |  Filter for all amounts greater than a value. 
    LocalDate maxReceiptDate = LocalDate.now(); // LocalDate |  Selects all items received by FEC before this date(MM/DD/YYYY or YYYY-MM-DD) 
    Boolean sortHideNull = false; // Boolean | Hide null values on sorted column(s).
    String candidateId = "candidateId_example"; // String |  A unique identifier assigned to each candidate registered with the FEC. If a person runs for several offices, that person will have separate candidate IDs for each office. First character indicates office - [P]residential, [H]ouse, [S]enate]. Second character is the last digit of the two-year period the ID was created. Third and fourth is the candidate state. Presidential IDs don't have state. Fifth and sixth is the district when the candidate first ran. This does not change if the candidate/member's district changes during re-districting. Presidential IDs don't have districts. The rest is sequence. 
    List<String> sort = Arrays.asList(); // List<String> |  Provide a field to sort by. Use `-` for descending order. ex: `-case_no` 
    List<String> qSpender = Arrays.asList(); // List<String> |  Keyword search for spender name or ID 
    String maxReceiptsAmount = "maxReceiptsAmount_example"; // String |  Filter for all amounts less than a value. 
    String filerType = "e-file"; // String | The method used to file with the FEC, either electronic or on paper.
    List<String> reportType = Arrays.asList(); // List<String> | Report type; prefix with \"-\" to exclude. Name of report where the underlying data comes from:     - 10D Pre-Election     - 10G Pre-General     - 10P Pre-Primary     - 10R Pre-Run-Off     - 10S Pre-Special     - 12C Pre-Convention     - 12G Pre-General     - 12P Pre-Primary     - 12R Pre-Run-Off     - 12S Pre-Special     - 30D Post-Election     - 30G Post-General     - 30P Post-Primary     - 30R Post-Run-Off     - 30S Post-Special     - 60D Post-Convention     - M1  January Monthly     - M10 October Monthly     - M11 November Monthly     - M12 December Monthly     - M2  February Monthly     - M3  March Monthly     - M4  April Monthly     - M5  May Monthly     - M6  June Monthly     - M7  July Monthly     - M8  August Monthly     - M9  September Monthly     - MY  Mid-Year Report     - Q1  April Quarterly     - Q2  July Quarterly     - Q3  October Quarterly     - TER Termination Report     - YE  Year-End     - ADJ COMP ADJUST AMEND     - CA  COMPREHENSIVE AMEND 
    String maxTotalContributions = "maxTotalContributions_example"; // String |  Filter for all amounts less than a value. 
    Boolean sortNullsLast = false; // Boolean | Toggle that sorts null values last
    String maxIndependentExpenditures = "maxIndependentExpenditures_example"; // String |  Filter for all amounts less than a value. 
    ...
    String minPartyCoordinatedExpenditures = "minPartyCoordinatedExpenditures_example"; // String |  Filter for all amounts greater than a value. 
    List<String> beginningImageNumber = Arrays.asList(); // List<String> |  Unique identifier for the electronic or paper report. This number is used to construct PDF URLs to the original document. 
    LocalDate minReceiptDate = LocalDate.now(); // LocalDate |  Selects all items received by FEC after this date(MM/DD/YYYY or YYYY-MM-DD) 
    Boolean isAmended = true; // Boolean |  False indicates that a report is the most recent. True indicates that the report has been superseded by an amendment. 
    String maxDisbursementsAmount = "maxDisbursementsAmount_example"; // String |  Filter for all amounts less than a value. 
    String maxCashOnHandEndPeriodAmount = "maxCashOnHandEndPeriodAmount_example"; // String |  Filter for all amounts less than a value. 
    List<String> amendmentIndicator = Arrays.asList(); // List<String> | Amendent types:     -N   new     -A   amendment     -T   terminated     -C   consolidated     -M   multi-candidate     -S   secondary  NULL might be new or amendment. If amendment indicator is null and the filings is the first or first in a chain treat it as if it was a new. If it is not the first or first in a chain then treat the filing as an amendment. 
    List<Integer> cycle = Arrays.asList(); // List<Integer> |  Filter records to only those that were applicable to a given two-year period.The cycle begins with an odd year and is named for its ending, even year. 
    Boolean sortNullOnly = false; // Boolean | Toggle that filters out all rows having sort column that is non-null
    String minIndependentExpenditures = "minIndependentExpenditures_example"; // String |  Filter for all amounts greater than a value. 
    Integer perPage = 20; // Integer | The number of results returned per page. Defaults to 20.
    ...
    String minCashOnHandEndPeriodAmount = "minCashOnHandEndPeriodAmount_example"; // String |  Filter for all amounts greater than a value. 
    String minDisbursementsAmount = "minDisbursementsAmount_example"; // String |  Filter for all amounts greater than a value. 
    Boolean mostRecent = true; // Boolean |  Report is either new or is the most-recently filed amendment 
    try {
      CommitteeReportsPage result = apiInstance.reportsEntityTypeGet(apiKey, entityType, maxPartyCoordinatedExpenditures, maxDebtsOwedExpenditures, minReceiptsAmount, minDebtsOwedAmount, maxReceiptDate, sortHideNull, candidateId, sort, qSpender, maxReceiptsAmount, filerType, reportType, maxTotalContributions, sortNullsLast, maxIndependentExpenditures, minTotalContributions, minPartyCoordinatedExpenditures, beginningImageNumber, minReceiptDate, isAmended, maxDisbursementsAmount, maxCashOnHandEndPeriodAmount, amendmentIndicator, cycle, sortNullOnly, minIndependentExpenditures, perPage, qFiler, committeeType, page, year, committeeId, minCashOnHandEndPeriodAmount, minDisbursementsAmount, mostRecent);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FinancialApi#reportsEntityTypeGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
|------------- | ------------- | ------------- | -------------|
| **apiKey** | **String**|  API key for https://api.data.gov. Get one at https://api.data.gov/signup.  | [default to DEMO_KEY] |
| **entityType** | **String**| Committee groupings based on FEC filing form.                 Choose one of: &#x60;presidential&#x60;, &#x60;pac-party&#x60;, &#x60;house-senate&#x60;, or &#x60;ie-only&#x60; | [enum: presidential, pac-party, house-senate, ie-only] |
| **maxPartyCoordinatedExpenditures** | **String**|  Filter for all amounts less than a value.  | [optional] |
| **maxDebtsOwedExpenditures** | **String**|  Filter for all amounts less than a value.  | [optional] |
| **minReceiptsAmount** | **String**|  Filter for all amounts greater than a value.  | [optional] |
| **minDebtsOwedAmount** | **String**|  Filter for all amounts greater than a value.  | [optional] |
| **maxReceiptDate** | **LocalDate**|  Selects all items received by FEC before this date(MM/DD/YYYY or YYYY-MM-DD)  | [optional] |
| **sortHideNull** | **Boolean**| Hide null values on sorted column(s). | [optional] [default to false] |
| **candidateId** | **String**|  A unique identifier assigned to each candidate registered with the FEC. If a person runs for several offices, that person will have separate candidate IDs for each office. First character indicates office - [P]residential, [H]ouse, [S]enate]. Second character is the last digit of the two-year period the ID was created. Third and fourth is the candidate state. Presidential IDs don&#39;t have state. Fifth and sixth is the district when the candidate first ran. This does not change if the candidate/member&#39;s district changes during re-districting. Presidential IDs don&#39;t have districts. The rest is sequence.  | [optional] |
| **sort** | [**List&lt;String&gt;**](String.md)|  Provide a field to sort by. Use &#x60;-&#x60; for descending order. ex: &#x60;-case_no&#x60;  | [optional] |
| **qSpender** | [**List&lt;String&gt;**](String.md)|  Keyword search for spender name or ID  | [optional] |
| **maxReceiptsAmount** | **String**|  Filter for all amounts less than a value.  | [optional] |
| **filerType** | **String**| The method used to file with the FEC, either electronic or on paper. | [optional] [enum: e-file, paper] |
| **reportType** | [**List&lt;String&gt;**](String.md)| Report type; prefix with \&quot;-\&quot; to exclude. Name of report where the underlying data comes from:     - 10D Pre-Election     - 10G Pre-General     - 10P Pre-Primary     - 10R Pre-Run-Off     - 10S Pre-Special     - 12C Pre-Convention     - 12G Pre-General     - 12P Pre-Primary     - 12R Pre-Run-Off     - 12S Pre-Special     - 30D Post-Election     - 30G Post-General     - 30P Post-Primary     - 30R Post-Run-Off     - 30S Post-Special     - 60D Post-Convention     - M1  January Monthly     - M10 October Monthly     - M11 November Monthly     - M12 December Monthly     - M2  February Monthly     - M3  March Monthly     - M4  April Monthly     - M5  May Monthly     - M6  June Monthly     - M7  July Monthly     - M8  August Monthly     - M9  September Monthly     - MY  Mid-Year Report     - Q1  April Quarterly     - Q2  July Quarterly     - Q3  October Quarterly     - TER Termination Report     - YE  Year-End     - ADJ COMP ADJUST AMEND     - CA  COMPREHENSIVE AMEND  | [optional] |
| **maxTotalContributions** | **String**|  Filter for all amounts less than a value.  | [optional] |
| **sortNullsLast** | **Boolean**| Toggle that sorts null values last | [optional] [default to false] |
| **maxIndependentExpenditures** | **String**|  Filter for all amounts less than a value.  | [optional] |
...
| **minPartyCoordinatedExpenditures** | **String**|  Filter for all amounts greater than a value.  | [optional] |
| **beginningImageNumber** | [**List&lt;String&gt;**](String.md)|  Unique identifier for the electronic or paper report. This number is used to construct PDF URLs to the original document.  | [optional] |
| **minReceiptDate** | **LocalDate**|  Selects all items received by FEC after this date(MM/DD/YYYY or YYYY-MM-DD)  | [optional] |
| **isAmended** | **Boolean**|  False indicates that a report is the most recent. True indicates that the report has been superseded by an amendment.  | [optional] |
| **maxDisbursementsAmount** | **String**|  Filter for all amounts less than a value.  | [optional] |
| **maxCashOnHandEndPeriodAmount** | **String**|  Filter for all amounts less than a value.  | [optional] |
| **amendmentIndicator** | [**List&lt;String&gt;**](String.md)| Amendent types:     -N   new     -A   amendment     -T   terminated     -C   consolidated     -M   multi-candidate     -S   secondary  NULL might be new or amendment. If amendment indicator is null and the filings is the first or first in a chain treat it as if it was a new. If it is not the first or first in a chain then treat the filing as an amendment.  | [optional] [enum: , N, A, T, C, M, S] |
| **cycle** | [**List&lt;Integer&gt;**](Integer.md)|  Filter records to only those that were applicable to a given two-year period.The cycle begins with an odd year and is named for its ending, even year.  | [optional] |
| **sortNullOnly** | **Boolean**| Toggle that filters out all rows having sort column that is non-null | [optional] [default to false] |
| **minIndependentExpenditures** | **String**|  Filter for all amounts greater than a value.  | [optional] |
| **perPage** | **Integer**| The number of results returned per page. Defaults to 20. | [optional] [default to 20] |
...
<a id="totalsByEntityGet"></a>
# **totalsByEntityGet**
> EntityReceiptDisbursementTotalsPage totalsByEntityGet(apiKey, cycle, page, sortHideNull, perPage, sortNullOnly, sort, sortNullsLast)
...
public class Example {
  public static void main(String[] args) {
    ...
    FinancialApi apiInstance = new FinancialApi(defaultClient);
    String apiKey = "DEMO_KEY"; // String |  API key for https://api.data.gov. Get one at https://api.data.gov/signup. 
    Integer cycle = 56; // Integer |  Filter records to only those that were applicable to a given two-year period.The cycle begins with an odd year and is named for its ending, even year. 
    Integer page = 1; // Integer | For paginating through results, starting at page 1
    Boolean sortHideNull = false; // Boolean | Hide null values on sorted column(s).
    Integer perPage = 20; // Integer | The number of results returned per page. Defaults to 20.
    Boolean sortNullOnly = false; // Boolean | Toggle that filters out all rows having sort column that is non-null
    String sort = "end_date"; // String | Provide a field to sort by. Use `-` for descending order. 
    Boolean sortNullsLast = false; // Boolean | Toggle that sorts null values last
    try {
      EntityReceiptDisbursementTotalsPage result = apiInstance.totalsByEntityGet(apiKey, cycle, page, sortHideNull, perPage, sortNullOnly, sort, sortNullsLast);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FinancialApi#totalsByEntityGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    FinancialApi apiInstance = new FinancialApi(defaultClient);
    String apiKey = "DEMO_KEY"; // String |  API key for https://api.data.gov. Get one at https://api.data.gov/signup. 
    String entityType = "presidential"; // String | Committee groupings based on FEC filing form.                 Choose one of: `presidential`, `pac`, `party`, `pac-party`,                 `house-senate`, or `ie-only`
    ...
    String maxDisbursements = "maxDisbursements_example"; // String |  Filter for all amounts less than a value. 
    List<String> committeeState = Arrays.asList(); // List<String> | US state or territory
    List<Integer> cycle = Arrays.asList(); // List<Integer> |  Filter records to only those that were applicable to a given two-year period.The cycle begins with an odd year and is named for its ending, even year. 
    Boolean sortNullOnly = false; // Boolean | Toggle that filters out all rows having sort column that is non-null
    ...
    String minDisbursements = "minDisbursements_example"; // String |  Filter for all amounts greater than a value. 
    String minLastCashOnHandEndPeriod = "minLastCashOnHandEndPeriod_example"; // String |  Filter for all amounts greater than a value. 
    String maxLastCashOnHandEndPeriod = "maxLastCashOnHandEndPeriod_example"; // String |  Filter for all amounts less than a value. 
    Boolean sortHideNull = false; // Boolean | Hide null values on sorted column(s).
    Integer perPage = 20; // Integer | The number of results returned per page. Defaults to 20.
    ...
    String sort = "-cycle"; // String | Provide a field to sort by. Use `-` for descending order. 
    String maxLastDebtsOwedByCommittee = "maxLastDebtsOwedByCommittee_example"; // String |  Filter for all amounts less than a value. 
    ...
    List<String> committeeDesignation = Arrays.asList(); // List<String> | The one-letter designation code of the organization:          - A authorized by a candidate          - J joint fundraising committee          - P principal campaign committee of a candidate          - U unauthorized          - B lobbyist/registrant PAC          - D leadership PAC 
    String maxReceipts = "maxReceipts_example"; // String |  Filter for all amounts less than a value. 
    List<String> committeeType = Arrays.asList(); // List<String> | The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account 
    Boolean sortNullsLast = false; // Boolean | Toggle that sorts null values last
    Integer page = 1; // Integer | For paginating through results, starting at page 1
    List<String> committeeId = Arrays.asList(); // List<String> |  A unique identifier assigned to each committee or filer registered with the FEC. In general committee id's begin with the letter C which is followed by eight digits. 
    String minLastDebtsOwedByCommittee = "minLastDebtsOwedByCommittee_example"; // String |  Filter for all amounts greater than a value. 
    ...
    String minReceipts = "minReceipts_example"; // String |  Filter for all amounts greater than a value. 
    try {
      CommitteeTotalsPage result = apiInstance.totalsEntityTypeGet(apiKey, entityType, treasurerName, maxDisbursements, committeeState, cycle, sortNullOnly, sponsorCandidateId, minDisbursements, minLastCashOnHandEndPeriod, maxLastCashOnHandEndPeriod, sortHideNull, perPage, filingFrequency, sort, maxLastDebtsOwedByCommittee, minFirstF1Date, committeeDesignation, maxReceipts, committeeType, sortNullsLast, page, committeeId, minLastDebtsOwedByCommittee, maxFirstF1Date, organizationType, minReceipts);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FinancialApi#totalsEntityTypeGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
|------------- | ------------- | ------------- | -------------|
| **apiKey** | **String**|  API key for https://api.data.gov. Get one at https://api.data.gov/signup.  | [default to DEMO_KEY] |
| **entityType** | **String**| Committee groupings based on FEC filing form.                 Choose one of: &#x60;presidential&#x60;, &#x60;pac&#x60;, &#x60;party&#x60;, &#x60;pac-party&#x60;,                 &#x60;house-senate&#x60;, or &#x60;ie-only&#x60; | [enum: presidential, pac, party, pac-party, house-senate, ie-only] |
...
| **committeeState** | [**List&lt;String&gt;**](String.md)| US state or territory | [optional] |
| **cycle** | [**List&lt;Integer&gt;**](Integer.md)|  Filter records to only those that were applicable to a given two-year period.The cycle begins with an odd year and is named for its ending, even year.  | [optional] |
| **sortNullOnly** | **Boolean**| Toggle that filters out all rows having sort column that is non-null | [optional] [default to false] |
...
| **committeeDesignation** | [**List&lt;String&gt;**](String.md)| The one-letter designation code of the organization:          - A authorized by a candidate          - J joint fundraising committee          - P principal campaign committee of a candidate          - U unauthorized          - B lobbyist/registrant PAC          - D leadership PAC  | [optional] |
...
<a id="totalsInauguralCommitteesByContributorGet"></a>
# **totalsInauguralCommitteesByContributorGet**
> InauguralDonationsPage totalsInauguralCommitteesByContributorGet(apiKey, cycle, sortNullsLast, page, committeeId, sortNullOnly, contributorName, sortHideNull, perPage, sort)
...
public class Example {
  public static void main(String[] args) {
    ...
    List<String> sort = Arrays.asList(); // List<String> |  Provide a field to sort by. Use `-` for descending order. ex: `-case_no` 
    try {
      InauguralDonationsPage result = apiInstance.totalsInauguralCommitteesByContributorGet(apiKey, cycle, sortNullsLast, page, committeeId, sortNullOnly, contributorName, sortHideNull, perPage, sort);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FinancialApi#totalsInauguralCommitteesByContributorGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
