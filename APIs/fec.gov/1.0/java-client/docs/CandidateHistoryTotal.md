...
|**candidateElectionYear** | **Integer** | The last year of the cycle for this election. |  [optional] |
...
|**fecCyclesInElection** | **List&lt;Integer&gt;** | FEC cycles are included in candidate election years. |  [optional] |
...
|**roundedElectionYears** | **List&lt;Integer&gt;** | Rounded election years in which a candidate ran for office |  [optional] |
...
|**twoYearPeriod** | **Integer** |  Two-year election cycle in which a candidate runs for office. Calculated from Form 2. The cycle begins with an odd year and is named for its ending, even year. This cycle follows the traditional house election cycle and subdivides the presidential and Senate elections into comparable two-year blocks. To retrieve data for the entire four years of a presidential term or six years of a senatorial term, you will need the &#x60;election_full&#x60; flag.  |  |
