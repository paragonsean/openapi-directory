...
|------------ | ------------- | ------------- | -------------|
|**aggregateAmountPersonalContributionsGeneral** | **BigDecimal** |  |  [optional] |
|**aggregateContributionsPersonalFundsPrimary** | **BigDecimal** |  |  [optional] |
|**allLoansReceivedPeriod** | **BigDecimal** |  |  [optional] |
|**allLoansReceivedYtd** | **BigDecimal** |  |  [optional] |
|**allOtherLoansPeriod** | **BigDecimal** |  |  [optional] |
|**allOtherLoansYtd** | **BigDecimal** |  |  [optional] |
...
|**candidateContributionPeriod** | **BigDecimal** |  |  [optional] |
|**candidateContributionYtd** | **BigDecimal** |  |  [optional] |
...
|**exemptLegalAccountingDisbursementPeriod** | **BigDecimal** |  |  [optional] |
|**exemptLegalAccountingDisbursementYtd** | **BigDecimal** |  |  [optional] |
|**expenditureSubjectToLimits** | **BigDecimal** |  |  [optional] |
...
|**federalFundsPeriod** | **BigDecimal** |  |  [optional] |
|**federalFundsYtd** | **BigDecimal** |  |  [optional] |
|**fileNumber** | **Integer** |  |  [optional] |
|**fundraisingDisbursementsPeriod** | **BigDecimal** |  |  [optional] |
|**fundraisingDisbursementsYtd** | **BigDecimal** |  |  [optional] |
|**grossReceiptAuthorizedCommitteeGeneral** | **BigDecimal** |  |  [optional] |
|**grossReceiptAuthorizedCommitteePrimary** | **BigDecimal** |  |  [optional] |
|**grossReceiptMinusPersonalContributionGeneral** | **BigDecimal** |  |  [optional] |
|**grossReceiptMinusPersonalContributionsPrimary** | **BigDecimal** |  |  [optional] |
|**htmlUrl** | **String** |  HTML link to the filing.  |  [optional] |
|**independentContributionsPeriod** | **BigDecimal** |  |  [optional] |
...
|**itemsOnHandLiquidated** | **BigDecimal** |  |  [optional] |
|**loanRepaymentsCandidateLoansPeriod** | **BigDecimal** |  |  [optional] |
|**loanRepaymentsCandidateLoansYtd** | **BigDecimal** |  |  [optional] |
|**loanRepaymentsMadePeriod** | **BigDecimal** |  |  [optional] |
|**loanRepaymentsMadeYtd** | **BigDecimal** |  |  [optional] |
|**loanRepaymentsOtherLoansPeriod** | **BigDecimal** |  |  [optional] |
|**loanRepaymentsOtherLoansYtd** | **BigDecimal** |  |  [optional] |
|**loanRepaymentsReceivedPeriod** | **BigDecimal** |  |  [optional] |
|**loanRepaymentsReceivedYtd** | **BigDecimal** |  |  [optional] |
|**loansMadeByCandidatePeriod** | **BigDecimal** |  |  [optional] |
|**loansMadeByCandidateYtd** | **BigDecimal** |  |  [optional] |
|**loansMadePeriod** | **BigDecimal** |  |  [optional] |
|**loansMadeYtd** | **BigDecimal** |  |  [optional] |
|**loansReceivedFromCandidatePeriod** | **BigDecimal** |  |  [optional] |
|**loansReceivedFromCandidateYtd** | **BigDecimal** |  |  [optional] |
...
|**netContributionsCycleToDate** | **BigDecimal** |  |  [optional] |
|**netContributionsPeriod** | **BigDecimal** |  |  [optional] |
|**netContributionsYtd** | **BigDecimal** |  |  [optional] |
|**netOperatingExpendituresCycleToDate** | **BigDecimal** |  |  [optional] |
...
|**offsetsToFundraisingExpendituresPeriod** | **BigDecimal** |  |  [optional] |
|**offsetsToFundraisingExpendituresYtd** | **BigDecimal** |  |  [optional] |
|**offsetsToLegalAccountingPeriod** | **BigDecimal** |  |  [optional] |
|**offsetsToLegalAccountingYtd** | **BigDecimal** |  |  [optional] |
...
|**operatingExpendituresPeriod** | **BigDecimal** |  |  [optional] |
|**operatingExpendituresYtd** | **BigDecimal** |  |  [optional] |
...
|**otherLoansReceivedPeriod** | **BigDecimal** |  |  [optional] |
|**otherLoansReceivedYtd** | **BigDecimal** |  |  [optional] |
...
|**otherReceiptsPeriod** | **BigDecimal** |  |  [optional] |
|**otherReceiptsYtd** | **BigDecimal** |  |  [optional] |
...
|**refundsTotalContributionsColTotalYtd** | **BigDecimal** |  |  [optional] |
|**repaymentsLoansMadeByCandidatePeriod** | **BigDecimal** |  |  [optional] |
|**repaymentsLoansMadeCandidateYtd** | **BigDecimal** |  |  [optional] |
|**repaymentsOtherLoansPeriod** | **BigDecimal** |  |  [optional] |
|**repaymentsOtherLoansYtd** | **BigDecimal** |  |  [optional] |
...
|**subtotalPeriod** | **BigDecimal** |  |  [optional] |
|**subtotalSummaryPagePeriod** | **BigDecimal** |  |  [optional] |
|**subtotalSummaryPeriod** | **BigDecimal** |  |  [optional] |
|**subtotalSummaryYtd** | **BigDecimal** |  |  [optional] |
|**totalContributionRefundsColTotalPeriod** | **BigDecimal** |  |  [optional] |
...
|**totalContributionsColumnTotalPeriod** | **BigDecimal** |  |  [optional] |
...
|**totalLoanRepaymentsMadePeriod** | **BigDecimal** |  |  [optional] |
|**totalLoanRepaymentsMadeYtd** | **BigDecimal** |  |  [optional] |
|**totalLoansReceivedPeriod** | **BigDecimal** |  |  [optional] |
|**totalLoansReceivedYtd** | **BigDecimal** |  |  [optional] |
|**totalNonfedTransfersPeriod** | **BigDecimal** |  |  [optional] |
|**totalNonfedTransfersYtd** | **BigDecimal** |  |  [optional] |
|**totalOffsetsToOperatingExpendituresPeriod** | **BigDecimal** |  |  [optional] |
|**totalOffsetsToOperatingExpendituresYtd** | **BigDecimal** |  |  [optional] |
|**totalOperatingExpendituresPeriod** | **BigDecimal** |  |  [optional] |
|**totalOperatingExpendituresYtd** | **BigDecimal** |  |  [optional] |
|**totalPeriod** | **BigDecimal** |  |  [optional] |
...
|**totalYtd** | **BigDecimal** |  |  [optional] |
|**transfersFromAffiliatedCommitteePeriod** | **BigDecimal** |  |  [optional] |
|**transfersFromAffiliatedCommitteeYtd** | **BigDecimal** |  |  [optional] |
...
|**transfersFromOtherAuthorizedCommitteePeriod** | **BigDecimal** |  |  [optional] |
|**transfersFromOtherAuthorizedCommitteeYtd** | **BigDecimal** |  |  [optional] |
|**transfersToAffiliatedCommitteePeriod** | **BigDecimal** |  |  [optional] |
|**transfersToAffilitatedCommitteesYtd** | **BigDecimal** |  |  [optional] |
|**transfersToOtherAuthorizedCommitteePeriod** | **BigDecimal** |  |  [optional] |
|**transfersToOtherAuthorizedCommitteeYtd** | **BigDecimal** |  |  [optional] |
