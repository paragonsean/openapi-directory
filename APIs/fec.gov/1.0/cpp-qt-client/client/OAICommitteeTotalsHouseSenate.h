...
/*
 * OAICommitteeTotalsHouseSenate.h
 *
 * 
 */

#ifndef OAICommitteeTotalsHouseSenate_H
#define OAICommitteeTotalsHouseSenate_H
...
class OAICommitteeTotalsHouseSenate : public OAIObject {
public:
    OAICommitteeTotalsHouseSenate();
    OAICommitteeTotalsHouseSenate(QString json);
    ~OAICommitteeTotalsHouseSenate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommitteeTotalsHouseSenate)

#endif // OAICommitteeTotalsHouseSenate_H
