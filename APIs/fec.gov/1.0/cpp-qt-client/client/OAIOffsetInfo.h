...
#ifndef OAIOffsetInfo_H
#define OAIOffsetInfo_H
...
class OAIOffsetInfo : public OAIObject {
public:
    OAIOffsetInfo();
    OAIOffsetInfo(QString json);
    ~OAIOffsetInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOffsetInfo)

#endif // OAIOffsetInfo_H
