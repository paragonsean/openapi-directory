...
/*
 * OAICandidateHistoryTotal.h
 *
 * 
 */

#ifndef OAICandidateHistoryTotal_H
#define OAICandidateHistoryTotal_H
...
class OAICandidateHistoryTotal : public OAIObject {
public:
    OAICandidateHistoryTotal();
    OAICandidateHistoryTotal(QString json);
    ~OAICandidateHistoryTotal() override;
    ...
    bool isIsElection() const;
    void setIsElection(const bool &is_election);
    bool is_is_election_Set() const;
    bool is_is_election_Valid() const;
...
private:
    ...
    bool m_is_election;
    bool m_is_election_isSet;
    bool m_is_election_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICandidateHistoryTotal)

#endif // OAICandidateHistoryTotal_H
