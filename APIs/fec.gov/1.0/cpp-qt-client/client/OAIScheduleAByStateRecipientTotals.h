...
/*
 * OAIScheduleAByStateRecipientTotals.h
 *
 * 
 */

#ifndef OAIScheduleAByStateRecipientTotals_H
#define OAIScheduleAByStateRecipientTotals_H
...
class OAIScheduleAByStateRecipientTotals : public OAIObject {
public:
    OAIScheduleAByStateRecipientTotals();
    OAIScheduleAByStateRecipientTotals(QString json);
    ~OAIScheduleAByStateRecipientTotals() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleAByStateRecipientTotals)

#endif // OAIScheduleAByStateRecipientTotals_H
