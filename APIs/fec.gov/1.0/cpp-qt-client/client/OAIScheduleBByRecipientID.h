...
/*
 * OAIScheduleBByRecipientID.h
 *
 * 
 */

#ifndef OAIScheduleBByRecipientID_H
#define OAIScheduleBByRecipientID_H
...
class OAIScheduleBByRecipientID : public OAIObject {
public:
    OAIScheduleBByRecipientID();
    OAIScheduleBByRecipientID(QString json);
    ~OAIScheduleBByRecipientID() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleBByRecipientID)

#endif // OAIScheduleBByRecipientID_H
