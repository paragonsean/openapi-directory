...
/*
 * OAIScheduleAByOccupation.h
 *
 * 
 */

#ifndef OAIScheduleAByOccupation_H
#define OAIScheduleAByOccupation_H
...
class OAIScheduleAByOccupation : public OAIObject {
public:
    OAIScheduleAByOccupation();
    OAIScheduleAByOccupation(QString json);
    ~OAIScheduleAByOccupation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleAByOccupation)

#endif // OAIScheduleAByOccupation_H
