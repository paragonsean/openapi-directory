...
#include "OAIPresidentialCoverage.h"
...
OAIPresidentialCoverage::OAIPresidentialCoverage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPresidentialCoverage::OAIPresidentialCoverage() {
    this->initializeModel();
}

OAIPresidentialCoverage::~OAIPresidentialCoverage() {}

void OAIPresidentialCoverage::initializeModel() {
...
void OAIPresidentialCoverage::fromJson(QString jsonString) {
...
void OAIPresidentialCoverage::fromJsonObject(QJsonObject json) {
...
QString OAIPresidentialCoverage::asJson() const {
...
QJsonObject OAIPresidentialCoverage::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPresidentialCoverage::getCandidateId() const {
    return m_candidate_id;
}
void OAIPresidentialCoverage::setCandidateId(const QString &candidate_id) {
    m_candidate_id = candidate_id;
    m_candidate_id_isSet = true;
}

bool OAIPresidentialCoverage::is_candidate_id_Set() const{
    return m_candidate_id_isSet;
}

bool OAIPresidentialCoverage::is_candidate_id_Valid() const{
    return m_candidate_id_isValid;
}

QDateTime OAIPresidentialCoverage::getCoverageEndDate() const {
    return m_coverage_end_date;
}
void OAIPresidentialCoverage::setCoverageEndDate(const QDateTime &coverage_end_date) {
    m_coverage_end_date = coverage_end_date;
    m_coverage_end_date_isSet = true;
}

bool OAIPresidentialCoverage::is_coverage_end_date_Set() const{
    return m_coverage_end_date_isSet;
}

bool OAIPresidentialCoverage::is_coverage_end_date_Valid() const{
    return m_coverage_end_date_isValid;
}

qint32 OAIPresidentialCoverage::getElectionYear() const {
    return m_election_year;
}
void OAIPresidentialCoverage::setElectionYear(const qint32 &election_year) {
    m_election_year = election_year;
    m_election_year_isSet = true;
}

bool OAIPresidentialCoverage::is_election_year_Set() const{
    return m_election_year_isSet;
}

bool OAIPresidentialCoverage::is_election_year_Valid() const{
    return m_election_year_isValid;
}

bool OAIPresidentialCoverage::isSet() const {
...
bool OAIPresidentialCoverage::isValid() const {
