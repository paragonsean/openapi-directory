...
/*
 * OAIPresidentialCoverage.h
 *
 * 
 */

#ifndef OAIPresidentialCoverage_H
#define OAIPresidentialCoverage_H
...
class OAIPresidentialCoverage : public OAIObject {
public:
    OAIPresidentialCoverage();
    OAIPresidentialCoverage(QString json);
    ~OAIPresidentialCoverage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPresidentialCoverage)

#endif // OAIPresidentialCoverage_H
