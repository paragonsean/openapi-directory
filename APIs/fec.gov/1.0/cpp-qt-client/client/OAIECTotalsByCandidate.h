...
/*
 * OAIECTotalsByCandidate.h
 *
 * 
 */

#ifndef OAIECTotalsByCandidate_H
#define OAIECTotalsByCandidate_H
...
class OAIECTotalsByCandidate : public OAIObject {
public:
    OAIECTotalsByCandidate();
    OAIECTotalsByCandidate(QString json);
    ~OAIECTotalsByCandidate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIECTotalsByCandidate)

#endif // OAIECTotalsByCandidate_H
