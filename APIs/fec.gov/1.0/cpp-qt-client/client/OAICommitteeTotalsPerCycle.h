...
/*
 * OAICommitteeTotalsPerCycle.h
 *
 * 
 */

#ifndef OAICommitteeTotalsPerCycle_H
#define OAICommitteeTotalsPerCycle_H
...
class OAICommitteeTotalsPerCycle : public OAIObject {
public:
    OAICommitteeTotalsPerCycle();
    OAICommitteeTotalsPerCycle(QString json);
    ~OAICommitteeTotalsPerCycle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommitteeTotalsPerCycle)

#endif // OAICommitteeTotalsPerCycle_H
