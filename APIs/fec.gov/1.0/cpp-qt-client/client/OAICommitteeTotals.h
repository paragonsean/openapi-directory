...
/*
 * OAICommitteeTotals.h
 *
 * 
 */

#ifndef OAICommitteeTotals_H
#define OAICommitteeTotals_H
...
class OAICommitteeTotals : public OAIObject {
public:
    OAICommitteeTotals();
    OAICommitteeTotals(QString json);
    ~OAICommitteeTotals() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommitteeTotals)

#endif // OAICommitteeTotals_H
