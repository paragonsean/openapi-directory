...
/*
 * OAIPresidentialBySize.h
 *
 * 
 */

#ifndef OAIPresidentialBySize_H
#define OAIPresidentialBySize_H
...
class OAIPresidentialBySize : public OAIObject {
public:
    OAIPresidentialBySize();
    OAIPresidentialBySize(QString json);
    ~OAIPresidentialBySize() override;
    ...
    qint32 getSizeRangeId() const;
    void setSizeRangeId(const qint32 &size_range_id);
    bool is_size_range_id_Set() const;
    bool is_size_range_id_Valid() const;
...
private:
    ...
    qint32 m_size_range_id;
    bool m_size_range_id_isSet;
    bool m_size_range_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPresidentialBySize)

#endif // OAIPresidentialBySize_H
