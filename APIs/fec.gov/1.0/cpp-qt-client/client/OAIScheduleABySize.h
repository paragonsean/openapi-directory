...
/*
 * OAIScheduleABySize.h
 *
 * 
 */

#ifndef OAIScheduleABySize_H
#define OAIScheduleABySize_H
...
class OAIScheduleABySize : public OAIObject {
public:
    OAIScheduleABySize();
    OAIScheduleABySize(QString json);
    ~OAIScheduleABySize() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleABySize)

#endif // OAIScheduleABySize_H
