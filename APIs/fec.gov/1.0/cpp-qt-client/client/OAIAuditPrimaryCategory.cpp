...
OAIAuditPrimaryCategory::OAIAuditPrimaryCategory(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAuditPrimaryCategory::OAIAuditPrimaryCategory() {
    this->initializeModel();
}

OAIAuditPrimaryCategory::~OAIAuditPrimaryCategory() {}

void OAIAuditPrimaryCategory::initializeModel() {
...
void OAIAuditPrimaryCategory::fromJson(QString jsonString) {
...
void OAIAuditPrimaryCategory::fromJsonObject(QJsonObject json) {
...
QString OAIAuditPrimaryCategory::asJson() const {
...
QJsonObject OAIAuditPrimaryCategory::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAuditPrimaryCategory::getPrimaryCategoryId() const {
    return m_primary_category_id;
}
void OAIAuditPrimaryCategory::setPrimaryCategoryId(const QString &primary_category_id) {
    m_primary_category_id = primary_category_id;
    m_primary_category_id_isSet = true;
}

bool OAIAuditPrimaryCategory::is_primary_category_id_Set() const{
    return m_primary_category_id_isSet;
}

bool OAIAuditPrimaryCategory::is_primary_category_id_Valid() const{
    return m_primary_category_id_isValid;
}

QString OAIAuditPrimaryCategory::getPrimaryCategoryName() const {
    return m_primary_category_name;
}
void OAIAuditPrimaryCategory::setPrimaryCategoryName(const QString &primary_category_name) {
    m_primary_category_name = primary_category_name;
    m_primary_category_name_isSet = true;
}

bool OAIAuditPrimaryCategory::is_primary_category_name_Set() const{
    return m_primary_category_name_isSet;
}

bool OAIAuditPrimaryCategory::is_primary_category_name_Valid() const{
    return m_primary_category_name_isValid;
}

bool OAIAuditPrimaryCategory::isSet() const {
...
bool OAIAuditPrimaryCategory::isValid() const {
