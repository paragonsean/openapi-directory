...
OAIBaseF3PFiling::OAIBaseF3PFiling(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBaseF3PFiling::OAIBaseF3PFiling() {
    this->initializeModel();
}

OAIBaseF3PFiling::~OAIBaseF3PFiling() {}

void OAIBaseF3PFiling::initializeModel() {
...
void OAIBaseF3PFiling::fromJson(QString jsonString) {
...
void OAIBaseF3PFiling::fromJsonObject(QJsonObject json) {
...
QString OAIBaseF3PFiling::asJson() const {
...
QJsonObject OAIBaseF3PFiling::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIBaseF3PFiling::getAmendedBy() const {
    return m_amended_by;
}
void OAIBaseF3PFiling::setAmendedBy(const qint32 &amended_by) {
    m_amended_by = amended_by;
    m_amended_by_isSet = true;
}

bool OAIBaseF3PFiling::is_amended_by_Set() const{
    return m_amended_by_isSet;
}

bool OAIBaseF3PFiling::is_amended_by_Valid() const{
    return m_amended_by_isValid;
}

QString OAIBaseF3PFiling::getAmendment() const {
    return m_amendment;
}
void OAIBaseF3PFiling::setAmendment(const QString &amendment) {
    m_amendment = amendment;
    m_amendment_isSet = true;
}

bool OAIBaseF3PFiling::is_amendment_Set() const{
    return m_amendment_isSet;
}

bool OAIBaseF3PFiling::is_amendment_Valid() const{
    return m_amendment_isValid;
}

QList<qint32> OAIBaseF3PFiling::getAmendmentChain() const {
    return m_amendment_chain;
}
void OAIBaseF3PFiling::setAmendmentChain(const QList<qint32> &amendment_chain) {
    m_amendment_chain = amendment_chain;
    m_amendment_chain_isSet = true;
}

bool OAIBaseF3PFiling::is_amendment_chain_Set() const{
    return m_amendment_chain_isSet;
}

bool OAIBaseF3PFiling::is_amendment_chain_Valid() const{
    return m_amendment_chain_isValid;
}

QString OAIBaseF3PFiling::getBeginningImageNumber() const {
    return m_beginning_image_number;
}
void OAIBaseF3PFiling::setBeginningImageNumber(const QString &beginning_image_number) {
    m_beginning_image_number = beginning_image_number;
    m_beginning_image_number_isSet = true;
}

bool OAIBaseF3PFiling::is_beginning_image_number_Set() const{
    return m_beginning_image_number_isSet;
}

bool OAIBaseF3PFiling::is_beginning_image_number_Valid() const{
    return m_beginning_image_number_isValid;
}

float OAIBaseF3PFiling::getCashOnHandBeginningPeriod() const {
    return m_cash_on_hand_beginning_period;
}
void OAIBaseF3PFiling::setCashOnHandBeginningPeriod(const float &cash_on_hand_beginning_period) {
    m_cash_on_hand_beginning_period = cash_on_hand_beginning_period;
    m_cash_on_hand_beginning_period_isSet = true;
}

bool OAIBaseF3PFiling::is_cash_on_hand_beginning_period_Set() const{
    return m_cash_on_hand_beginning_period_isSet;
}

bool OAIBaseF3PFiling::is_cash_on_hand_beginning_period_Valid() const{
    return m_cash_on_hand_beginning_period_isValid;
}

float OAIBaseF3PFiling::getCashOnHandEndPeriod() const {
    return m_cash_on_hand_end_period;
}
void OAIBaseF3PFiling::setCashOnHandEndPeriod(const float &cash_on_hand_end_period) {
    m_cash_on_hand_end_period = cash_on_hand_end_period;
    m_cash_on_hand_end_period_isSet = true;
}

bool OAIBaseF3PFiling::is_cash_on_hand_end_period_Set() const{
    return m_cash_on_hand_end_period_isSet;
}

bool OAIBaseF3PFiling::is_cash_on_hand_end_period_Valid() const{
    return m_cash_on_hand_end_period_isValid;
}

QString OAIBaseF3PFiling::getCity() const {
    return m_city;
}
void OAIBaseF3PFiling::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIBaseF3PFiling::is_city_Set() const{
    return m_city_isSet;
}

bool OAIBaseF3PFiling::is_city_Valid() const{
    return m_city_isValid;
}

QString OAIBaseF3PFiling::getCommitteeId() const {
    return m_committee_id;
}
void OAIBaseF3PFiling::setCommitteeId(const QString &committee_id) {
    m_committee_id = committee_id;
    m_committee_id_isSet = true;
}

bool OAIBaseF3PFiling::is_committee_id_Set() const{
    return m_committee_id_isSet;
}

bool OAIBaseF3PFiling::is_committee_id_Valid() const{
    return m_committee_id_isValid;
}

QString OAIBaseF3PFiling::getCommitteeName() const {
    return m_committee_name;
}
void OAIBaseF3PFiling::setCommitteeName(const QString &committee_name) {
    m_committee_name = committee_name;
    m_committee_name_isSet = true;
}

bool OAIBaseF3PFiling::is_committee_name_Set() const{
    return m_committee_name_isSet;
}

bool OAIBaseF3PFiling::is_committee_name_Valid() const{
    return m_committee_name_isValid;
}

QDate OAIBaseF3PFiling::getCoverageEndDate() const {
    return m_coverage_end_date;
}
void OAIBaseF3PFiling::setCoverageEndDate(const QDate &coverage_end_date) {
    m_coverage_end_date = coverage_end_date;
    m_coverage_end_date_isSet = true;
}

bool OAIBaseF3PFiling::is_coverage_end_date_Set() const{
    return m_coverage_end_date_isSet;
}

bool OAIBaseF3PFiling::is_coverage_end_date_Valid() const{
    return m_coverage_end_date_isValid;
}

QDate OAIBaseF3PFiling::getCoverageStartDate() const {
    return m_coverage_start_date;
}
void OAIBaseF3PFiling::setCoverageStartDate(const QDate &coverage_start_date) {
    m_coverage_start_date = coverage_start_date;
    m_coverage_start_date_isSet = true;
}

bool OAIBaseF3PFiling::is_coverage_start_date_Set() const{
    return m_coverage_start_date_isSet;
}

bool OAIBaseF3PFiling::is_coverage_start_date_Valid() const{
    return m_coverage_start_date_isValid;
}

QString OAIBaseF3PFiling::getCsvUrl() const {
    return m_csv_url;
}
void OAIBaseF3PFiling::setCsvUrl(const QString &csv_url) {
    m_csv_url = csv_url;
    m_csv_url_isSet = true;
}

bool OAIBaseF3PFiling::is_csv_url_Set() const{
    return m_csv_url_isSet;
}

bool OAIBaseF3PFiling::is_csv_url_Valid() const{
    return m_csv_url_isValid;
}

float OAIBaseF3PFiling::getDebtsOwedByCommittee() const {
    return m_debts_owed_by_committee;
}
void OAIBaseF3PFiling::setDebtsOwedByCommittee(const float &debts_owed_by_committee) {
    m_debts_owed_by_committee = debts_owed_by_committee;
    m_debts_owed_by_committee_isSet = true;
}

bool OAIBaseF3PFiling::is_debts_owed_by_committee_Set() const{
    return m_debts_owed_by_committee_isSet;
}

bool OAIBaseF3PFiling::is_debts_owed_by_committee_Valid() const{
    return m_debts_owed_by_committee_isValid;
}

float OAIBaseF3PFiling::getDebtsOwedToCommittee() const {
    return m_debts_owed_to_committee;
}
void OAIBaseF3PFiling::setDebtsOwedToCommittee(const float &debts_owed_to_committee) {
    m_debts_owed_to_committee = debts_owed_to_committee;
    m_debts_owed_to_committee_isSet = true;
}

bool OAIBaseF3PFiling::is_debts_owed_to_committee_Set() const{
    return m_debts_owed_to_committee_isSet;
}

bool OAIBaseF3PFiling::is_debts_owed_to_committee_Valid() const{
    return m_debts_owed_to_committee_isValid;
}

QString OAIBaseF3PFiling::getDocumentDescription() const {
    return m_document_description;
}
void OAIBaseF3PFiling::setDocumentDescription(const QString &document_description) {
    m_document_description = document_description;
    m_document_description_isSet = true;
}

bool OAIBaseF3PFiling::is_document_description_Set() const{
    return m_document_description_isSet;
}

bool OAIBaseF3PFiling::is_document_description_Valid() const{
    return m_document_description_isValid;
}

QDate OAIBaseF3PFiling::getElectionDate() const {
    return m_election_date;
}
void OAIBaseF3PFiling::setElectionDate(const QDate &election_date) {
    m_election_date = election_date;
    m_election_date_isSet = true;
}

bool OAIBaseF3PFiling::is_election_date_Set() const{
    return m_election_date_isSet;
}

bool OAIBaseF3PFiling::is_election_date_Valid() const{
    return m_election_date_isValid;
}

QString OAIBaseF3PFiling::getElectionState() const {
    return m_election_state;
}
void OAIBaseF3PFiling::setElectionState(const QString &election_state) {
    m_election_state = election_state;
    m_election_state_isSet = true;
}

bool OAIBaseF3PFiling::is_election_state_Set() const{
    return m_election_state_isSet;
}

bool OAIBaseF3PFiling::is_election_state_Valid() const{
    return m_election_state_isValid;
}

float OAIBaseF3PFiling::getExpenditureSubjectToLimits() const {
    return m_expenditure_subject_to_limits;
}
void OAIBaseF3PFiling::setExpenditureSubjectToLimits(const float &expenditure_subject_to_limits) {
    m_expenditure_subject_to_limits = expenditure_subject_to_limits;
    m_expenditure_subject_to_limits_isSet = true;
}

bool OAIBaseF3PFiling::is_expenditure_subject_to_limits_Set() const{
    return m_expenditure_subject_to_limits_isSet;
}

bool OAIBaseF3PFiling::is_expenditure_subject_to_limits_Valid() const{
    return m_expenditure_subject_to_limits_isValid;
}

QString OAIBaseF3PFiling::getFecFileId() const {
    return m_fec_file_id;
}
void OAIBaseF3PFiling::setFecFileId(const QString &fec_file_id) {
    m_fec_file_id = fec_file_id;
    m_fec_file_id_isSet = true;
}

bool OAIBaseF3PFiling::is_fec_file_id_Set() const{
    return m_fec_file_id_isSet;
}

bool OAIBaseF3PFiling::is_fec_file_id_Valid() const{
    return m_fec_file_id_isValid;
}

QString OAIBaseF3PFiling::getFecUrl() const {
    return m_fec_url;
}
void OAIBaseF3PFiling::setFecUrl(const QString &fec_url) {
    m_fec_url = fec_url;
    m_fec_url_isSet = true;
}

bool OAIBaseF3PFiling::is_fec_url_Set() const{
    return m_fec_url_isSet;
}

bool OAIBaseF3PFiling::is_fec_url_Valid() const{
    return m_fec_url_isValid;
}

qint32 OAIBaseF3PFiling::getFileNumber() const {
    return m_file_number;
}
void OAIBaseF3PFiling::setFileNumber(const qint32 &file_number) {
    m_file_number = file_number;
    m_file_number_isSet = true;
}

bool OAIBaseF3PFiling::is_file_number_Set() const{
    return m_file_number_isSet;
}

bool OAIBaseF3PFiling::is_file_number_Valid() const{
    return m_file_number_isValid;
}

QString OAIBaseF3PFiling::getGeneralElection() const {
    return m_general_election;
}
void OAIBaseF3PFiling::setGeneralElection(const QString &general_election) {
    m_general_election = general_election;
    m_general_election_isSet = true;
}

bool OAIBaseF3PFiling::is_general_election_Set() const{
    return m_general_election_isSet;
}

bool OAIBaseF3PFiling::is_general_election_Valid() const{
    return m_general_election_isValid;
}

bool OAIBaseF3PFiling::isIsAmended() const {
    return m_is_amended;
}
void OAIBaseF3PFiling::setIsAmended(const bool &is_amended) {
    m_is_amended = is_amended;
    m_is_amended_isSet = true;
}

bool OAIBaseF3PFiling::is_is_amended_Set() const{
    return m_is_amended_isSet;
}

bool OAIBaseF3PFiling::is_is_amended_Valid() const{
    return m_is_amended_isValid;
}

bool OAIBaseF3PFiling::isMostRecent() const {
    return m_most_recent;
}
void OAIBaseF3PFiling::setMostRecent(const bool &most_recent) {
    m_most_recent = most_recent;
    m_most_recent_isSet = true;
}

bool OAIBaseF3PFiling::is_most_recent_Set() const{
    return m_most_recent_isSet;
}

bool OAIBaseF3PFiling::is_most_recent_Valid() const{
    return m_most_recent_isValid;
}

qint32 OAIBaseF3PFiling::getMostRecentFiling() const {
    return m_most_recent_filing;
}
void OAIBaseF3PFiling::setMostRecentFiling(const qint32 &most_recent_filing) {
    m_most_recent_filing = most_recent_filing;
    m_most_recent_filing_isSet = true;
}

bool OAIBaseF3PFiling::is_most_recent_filing_Set() const{
    return m_most_recent_filing_isSet;
}

bool OAIBaseF3PFiling::is_most_recent_filing_Valid() const{
    return m_most_recent_filing_isValid;
}

float OAIBaseF3PFiling::getNetContributionsCycleToDate() const {
    return m_net_contributions_cycle_to_date;
}
void OAIBaseF3PFiling::setNetContributionsCycleToDate(const float &net_contributions_cycle_to_date) {
    m_net_contributions_cycle_to_date = net_contributions_cycle_to_date;
    m_net_contributions_cycle_to_date_isSet = true;
}

bool OAIBaseF3PFiling::is_net_contributions_cycle_to_date_Set() const{
    return m_net_contributions_cycle_to_date_isSet;
}

bool OAIBaseF3PFiling::is_net_contributions_cycle_to_date_Valid() const{
    return m_net_contributions_cycle_to_date_isValid;
}

float OAIBaseF3PFiling::getNetOperatingExpendituresCycleToDate() const {
    return m_net_operating_expenditures_cycle_to_date;
}
void OAIBaseF3PFiling::setNetOperatingExpendituresCycleToDate(const float &net_operating_expenditures_cycle_to_date) {
...
bool OAIBaseF3PFiling::is_net_operating_expenditures_cycle_to_date_Set() const{
    return m_net_operating_expenditures_cycle_to_date_isSet;
}

bool OAIBaseF3PFiling::is_net_operating_expenditures_cycle_to_date_Valid() const{
    return m_net_operating_expenditures_cycle_to_date_isValid;
}

QString OAIBaseF3PFiling::getPdfUrl() const {
    return m_pdf_url;
}
void OAIBaseF3PFiling::setPdfUrl(const QString &pdf_url) {
    m_pdf_url = pdf_url;
    m_pdf_url_isSet = true;
}

bool OAIBaseF3PFiling::is_pdf_url_Set() const{
    return m_pdf_url_isSet;
}

bool OAIBaseF3PFiling::is_pdf_url_Valid() const{
    return m_pdf_url_isValid;
}

QString OAIBaseF3PFiling::getPrefix() const {
    return m_prefix;
}
void OAIBaseF3PFiling::setPrefix(const QString &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAIBaseF3PFiling::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAIBaseF3PFiling::is_prefix_Valid() const{
    return m_prefix_isValid;
}

QString OAIBaseF3PFiling::getPrimaryElection() const {
    return m_primary_election;
}
void OAIBaseF3PFiling::setPrimaryElection(const QString &primary_election) {
    m_primary_election = primary_election;
    m_primary_election_isSet = true;
}

bool OAIBaseF3PFiling::is_primary_election_Set() const{
    return m_primary_election_isSet;
}

bool OAIBaseF3PFiling::is_primary_election_Valid() const{
    return m_primary_election_isValid;
}

QDate OAIBaseF3PFiling::getReceiptDate() const {
    return m_receipt_date;
}
void OAIBaseF3PFiling::setReceiptDate(const QDate &receipt_date) {
    m_receipt_date = receipt_date;
    m_receipt_date_isSet = true;
}

bool OAIBaseF3PFiling::is_receipt_date_Set() const{
    return m_receipt_date_isSet;
}

bool OAIBaseF3PFiling::is_receipt_date_Valid() const{
    return m_receipt_date_isValid;
}

QString OAIBaseF3PFiling::getReport() const {
    return m_report;
}
void OAIBaseF3PFiling::setReport(const QString &report) {
    m_report = report;
    m_report_isSet = true;
}

bool OAIBaseF3PFiling::is_report_Set() const{
    return m_report_isSet;
}

bool OAIBaseF3PFiling::is_report_Valid() const{
    return m_report_isValid;
}

QString OAIBaseF3PFiling::getReportType() const {
    return m_report_type;
}
void OAIBaseF3PFiling::setReportType(const QString &report_type) {
    m_report_type = report_type;
    m_report_type_isSet = true;
}

bool OAIBaseF3PFiling::is_report_type_Set() const{
    return m_report_type_isSet;
}

bool OAIBaseF3PFiling::is_report_type_Valid() const{
    return m_report_type_isValid;
}

qint32 OAIBaseF3PFiling::getReportYear() const {
    return m_report_year;
}
void OAIBaseF3PFiling::setReportYear(const qint32 &report_year) {
    m_report_year = report_year;
    m_report_year_isSet = true;
}

bool OAIBaseF3PFiling::is_report_year_Set() const{
    return m_report_year_isSet;
}

bool OAIBaseF3PFiling::is_report_year_Valid() const{
    return m_report_year_isValid;
}

QString OAIBaseF3PFiling::getRptPgi() const {
    return m_rpt_pgi;
}
void OAIBaseF3PFiling::setRptPgi(const QString &rpt_pgi) {
    m_rpt_pgi = rpt_pgi;
    m_rpt_pgi_isSet = true;
}

bool OAIBaseF3PFiling::is_rpt_pgi_Set() const{
    return m_rpt_pgi_isSet;
}

bool OAIBaseF3PFiling::is_rpt_pgi_Valid() const{
    return m_rpt_pgi_isValid;
}

QDate OAIBaseF3PFiling::getSignDate() const {
    return m_sign_date;
}
void OAIBaseF3PFiling::setSignDate(const QDate &sign_date) {
    m_sign_date = sign_date;
    m_sign_date_isSet = true;
}

bool OAIBaseF3PFiling::is_sign_date_Set() const{
    return m_sign_date_isSet;
}

bool OAIBaseF3PFiling::is_sign_date_Valid() const{
    return m_sign_date_isValid;
}

QString OAIBaseF3PFiling::getState() const {
    return m_state;
}
void OAIBaseF3PFiling::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIBaseF3PFiling::is_state_Set() const{
    return m_state_isSet;
}

bool OAIBaseF3PFiling::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIBaseF3PFiling::getStreet1() const {
    return m_street_1;
}
void OAIBaseF3PFiling::setStreet1(const QString &street_1) {
    m_street_1 = street_1;
    m_street_1_isSet = true;
}

bool OAIBaseF3PFiling::is_street_1_Set() const{
    return m_street_1_isSet;
}

bool OAIBaseF3PFiling::is_street_1_Valid() const{
    return m_street_1_isValid;
}

QString OAIBaseF3PFiling::getStreet2() const {
    return m_street_2;
}
void OAIBaseF3PFiling::setStreet2(const QString &street_2) {
    m_street_2 = street_2;
    m_street_2_isSet = true;
}

bool OAIBaseF3PFiling::is_street_2_Set() const{
    return m_street_2_isSet;
}

bool OAIBaseF3PFiling::is_street_2_Valid() const{
    return m_street_2_isValid;
}

QString OAIBaseF3PFiling::getSubtotalSummaryPeriod() const {
    return m_subtotal_summary_period;
}
void OAIBaseF3PFiling::setSubtotalSummaryPeriod(const QString &subtotal_summary_period) {
    m_subtotal_summary_period = subtotal_summary_period;
    m_subtotal_summary_period_isSet = true;
}

bool OAIBaseF3PFiling::is_subtotal_summary_period_Set() const{
    return m_subtotal_summary_period_isSet;
}

bool OAIBaseF3PFiling::is_subtotal_summary_period_Valid() const{
    return m_subtotal_summary_period_isValid;
}

QString OAIBaseF3PFiling::getSuffix() const {
    return m_suffix;
}
void OAIBaseF3PFiling::setSuffix(const QString &suffix) {
    m_suffix = suffix;
    m_suffix_isSet = true;
}

bool OAIBaseF3PFiling::is_suffix_Set() const{
    return m_suffix_isSet;
}

bool OAIBaseF3PFiling::is_suffix_Valid() const{
    return m_suffix_isValid;
}

QString OAIBaseF3PFiling::getSummaryLines() const {
    return m_summary_lines;
}
void OAIBaseF3PFiling::setSummaryLines(const QString &summary_lines) {
    m_summary_lines = summary_lines;
    m_summary_lines_isSet = true;
}

bool OAIBaseF3PFiling::is_summary_lines_Set() const{
    return m_summary_lines_isSet;
}

bool OAIBaseF3PFiling::is_summary_lines_Valid() const{
    return m_summary_lines_isValid;
}

QString OAIBaseF3PFiling::getTreasurerFirstName() const {
    return m_treasurer_first_name;
}
void OAIBaseF3PFiling::setTreasurerFirstName(const QString &treasurer_first_name) {
    m_treasurer_first_name = treasurer_first_name;
    m_treasurer_first_name_isSet = true;
}

bool OAIBaseF3PFiling::is_treasurer_first_name_Set() const{
    return m_treasurer_first_name_isSet;
}

bool OAIBaseF3PFiling::is_treasurer_first_name_Valid() const{
    return m_treasurer_first_name_isValid;
}

QString OAIBaseF3PFiling::getTreasurerLastName() const {
    return m_treasurer_last_name;
}
void OAIBaseF3PFiling::setTreasurerLastName(const QString &treasurer_last_name) {
    m_treasurer_last_name = treasurer_last_name;
    m_treasurer_last_name_isSet = true;
}

bool OAIBaseF3PFiling::is_treasurer_last_name_Set() const{
    return m_treasurer_last_name_isSet;
}

bool OAIBaseF3PFiling::is_treasurer_last_name_Valid() const{
    return m_treasurer_last_name_isValid;
}

QString OAIBaseF3PFiling::getTreasurerMiddleName() const {
    return m_treasurer_middle_name;
}
void OAIBaseF3PFiling::setTreasurerMiddleName(const QString &treasurer_middle_name) {
    m_treasurer_middle_name = treasurer_middle_name;
    m_treasurer_middle_name_isSet = true;
}

bool OAIBaseF3PFiling::is_treasurer_middle_name_Set() const{
    return m_treasurer_middle_name_isSet;
}

bool OAIBaseF3PFiling::is_treasurer_middle_name_Valid() const{
    return m_treasurer_middle_name_isValid;
}

QString OAIBaseF3PFiling::getTreasurerName() const {
    return m_treasurer_name;
}
void OAIBaseF3PFiling::setTreasurerName(const QString &treasurer_name) {
    m_treasurer_name = treasurer_name;
    m_treasurer_name_isSet = true;
}

bool OAIBaseF3PFiling::is_treasurer_name_Set() const{
    return m_treasurer_name_isSet;
}

bool OAIBaseF3PFiling::is_treasurer_name_Valid() const{
    return m_treasurer_name_isValid;
}

QString OAIBaseF3PFiling::getZip() const {
    return m_zip;
}
void OAIBaseF3PFiling::setZip(const QString &zip) {
    m_zip = zip;
    m_zip_isSet = true;
}

bool OAIBaseF3PFiling::is_zip_Set() const{
    return m_zip_isSet;
}

bool OAIBaseF3PFiling::is_zip_Valid() const{
    return m_zip_isValid;
}

bool OAIBaseF3PFiling::isSet() const {
...
bool OAIBaseF3PFiling::isValid() const {
