...
#ifndef OAITotalByOffice_H
#define OAITotalByOffice_H
...
class OAITotalByOffice : public OAIObject {
public:
    OAITotalByOffice();
    OAITotalByOffice(QString json);
    ~OAITotalByOffice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITotalByOffice)

#endif // OAITotalByOffice_H
