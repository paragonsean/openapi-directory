...
#ifndef OAIFilingsPage_H
#define OAIFilingsPage_H
...
class OAIFilingsPage : public OAIObject {
public:
    OAIFilingsPage();
    OAIFilingsPage(QString json);
    ~OAIFilingsPage() override;
    ...
    QList<OAIFilings> getResults() const;
    void setResults(const QList<OAIFilings> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilingsPage)

#endif // OAIFilingsPage_H
