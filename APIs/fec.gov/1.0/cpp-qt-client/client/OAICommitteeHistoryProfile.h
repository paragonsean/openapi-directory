...
/*
 * OAICommitteeHistoryProfile.h
 *
 * 
 */

#ifndef OAICommitteeHistoryProfile_H
#define OAICommitteeHistoryProfile_H
...
class OAICommitteeHistoryProfile : public OAIObject {
public:
    OAICommitteeHistoryProfile();
    OAICommitteeHistoryProfile(QString json);
    ~OAICommitteeHistoryProfile() override;
    ...
    QString getCommitteeLabel() const;
    void setCommitteeLabel(const QString &committee_label);
    bool is_committee_label_Set() const;
    bool is_committee_label_Valid() const;
    ...
    bool isConvertToPacFlag() const;
    void setConvertToPacFlag(const bool &convert_to_pac_flag);
    bool is_convert_to_pac_flag_Set() const;
    bool is_convert_to_pac_flag_Valid() const;
    ...
    qint32 getFormerCandidateElectionYear() const;
    void setFormerCandidateElectionYear(const qint32 &former_candidate_election_year);
    bool is_former_candidate_election_year_Set() const;
    bool is_former_candidate_election_year_Valid() const;

    QString getFormerCandidateId() const;
    void setFormerCandidateId(const QString &former_candidate_id);
    bool is_former_candidate_id_Set() const;
    bool is_former_candidate_id_Valid() const;

    QString getFormerCandidateName() const;
    void setFormerCandidateName(const QString &former_candidate_name);
    bool is_former_candidate_name_Set() const;
    bool is_former_candidate_name_Valid() const;

    QString getFormerCommitteeName() const;
    void setFormerCommitteeName(const QString &former_committee_name);
    bool is_former_committee_name_Set() const;
    bool is_former_committee_name_Valid() const;
...
private:
    ...
    QString m_committee_label;
    bool m_committee_label_isSet;
    bool m_committee_label_isValid;
    ...
    bool m_convert_to_pac_flag;
    bool m_convert_to_pac_flag_isSet;
    bool m_convert_to_pac_flag_isValid;
    ...
    qint32 m_former_candidate_election_year;
    bool m_former_candidate_election_year_isSet;
    bool m_former_candidate_election_year_isValid;

    QString m_former_candidate_id;
    bool m_former_candidate_id_isSet;
    bool m_former_candidate_id_isValid;

    QString m_former_candidate_name;
    bool m_former_candidate_name_isSet;
    bool m_former_candidate_name_isValid;

    QString m_former_committee_name;
    bool m_former_committee_name_isSet;
    bool m_former_committee_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommitteeHistoryProfile)

#endif // OAICommitteeHistoryProfile_H
