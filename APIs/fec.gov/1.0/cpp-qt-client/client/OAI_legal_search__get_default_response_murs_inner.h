...
/*
 * OAI_legal_search__get_default_response_murs_inner.h
 *
 * 
 */

#ifndef OAI_legal_search__get_default_response_murs_inner_H
#define OAI_legal_search__get_default_response_murs_inner_H
...
class OAI_legal_search__get_default_response_murs_inner : public OAIObject {
public:
    OAI_legal_search__get_default_response_murs_inner();
    OAI_legal_search__get_default_response_murs_inner(QString json);
    ~OAI_legal_search__get_default_response_murs_inner() override;
    ...
    QString getMurType() const;
    void setMurType(const QString &mur_type);
    bool is_mur_type_Set() const;
    bool is_mur_type_Valid() const;
...
private:
    ...
    QString m_mur_type;
    bool m_mur_type_isSet;
    bool m_mur_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_legal_search__get_default_response_murs_inner)

#endif // OAI_legal_search__get_default_response_murs_inner_H
