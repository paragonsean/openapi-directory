...
/*
 * OAIScheduleAByState.h
 *
 * 
 */

#ifndef OAIScheduleAByState_H
#define OAIScheduleAByState_H
...
class OAIScheduleAByState : public OAIObject {
public:
    OAIScheduleAByState();
    OAIScheduleAByState(QString json);
    ~OAIScheduleAByState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleAByState)

#endif // OAIScheduleAByState_H
