...
/*
 * OAIElectioneeringByCandidate.h
 *
 * 
 */

#ifndef OAIElectioneeringByCandidate_H
#define OAIElectioneeringByCandidate_H
...
class OAIElectioneeringByCandidate : public OAIObject {
public:
    OAIElectioneeringByCandidate();
    OAIElectioneeringByCandidate(QString json);
    ~OAIElectioneeringByCandidate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElectioneeringByCandidate)

#endif // OAIElectioneeringByCandidate_H
