...
/*
 * OAI_legal_search__get_default_response_statutes_inner.h
 *
 * 
 */

#ifndef OAI_legal_search__get_default_response_statutes_inner_H
#define OAI_legal_search__get_default_response_statutes_inner_H
...
class OAI_legal_search__get_default_response_statutes_inner : public OAIObject {
public:
    OAI_legal_search__get_default_response_statutes_inner();
    OAI_legal_search__get_default_response_statutes_inner(QString json);
    ~OAI_legal_search__get_default_response_statutes_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_legal_search__get_default_response_statutes_inner)

#endif // OAI_legal_search__get_default_response_statutes_inner_H
