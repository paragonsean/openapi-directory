...
#ifndef OAICandidatePage_H
#define OAICandidatePage_H
...
class OAICandidatePage : public OAIObject {
public:
    OAICandidatePage();
    OAICandidatePage(QString json);
    ~OAICandidatePage() override;
    ...
    QList<OAICandidate> getResults() const;
    void setResults(const QList<OAICandidate> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAICandidatePage)

#endif // OAICandidatePage_H
