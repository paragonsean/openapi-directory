...
#ifndef OAIBaseF3XFiling_H
#define OAIBaseF3XFiling_H
...
class OAIBaseF3XFiling : public OAIObject {
public:
    OAIBaseF3XFiling();
    OAIBaseF3XFiling(QString json);
    ~OAIBaseF3XFiling() override;
    ...
    QString getAmendAddress() const;
    void setAmendAddress(const QString &amend_address);
    bool is_amend_address_Set() const;
    bool is_amend_address_Valid() const;
    ...
    QString getQualifiedMulticandidateCommittee() const;
    void setQualifiedMulticandidateCommittee(const QString &qualified_multicandidate_committee);
    bool is_qualified_multicandidate_committee_Set() const;
    bool is_qualified_multicandidate_committee_Valid() const;
...
private:
    ...
    QString m_amend_address;
    bool m_amend_address_isSet;
    bool m_amend_address_isValid;
    ...
    QString m_qualified_multicandidate_committee;
    bool m_qualified_multicandidate_committee_isSet;
    bool m_qualified_multicandidate_committee_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseF3XFiling)

#endif // OAIBaseF3XFiling_H
