...
/*
 * OAIScheduleAByStateCandidate.h
 *
 * 
 */

#ifndef OAIScheduleAByStateCandidate_H
#define OAIScheduleAByStateCandidate_H
...
class OAIScheduleAByStateCandidate : public OAIObject {
public:
    OAIScheduleAByStateCandidate();
    OAIScheduleAByStateCandidate(QString json);
    ~OAIScheduleAByStateCandidate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleAByStateCandidate)

#endif // OAIScheduleAByStateCandidate_H
