...
#ifndef OAIEFilingsPage_H
#define OAIEFilingsPage_H
...
class OAIEFilingsPage : public OAIObject {
public:
    OAIEFilingsPage();
    OAIEFilingsPage(QString json);
    ~OAIEFilingsPage() override;
    ...
    QList<OAIEFilings> getResults() const;
    void setResults(const QList<OAIEFilings> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEFilingsPage)

#endif // OAIEFilingsPage_H
