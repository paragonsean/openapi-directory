...
/*
 * OAICommitteeHistory.h
 *
 * 
 */

#ifndef OAICommitteeHistory_H
#define OAICommitteeHistory_H
...
class OAICommitteeHistory : public OAIObject {
public:
    OAICommitteeHistory();
    OAICommitteeHistory(QString json);
    ~OAICommitteeHistory() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommitteeHistory)

#endif // OAICommitteeHistory_H
