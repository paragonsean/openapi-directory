...
OAIScheduleEByCandidate::OAIScheduleEByCandidate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScheduleEByCandidate::OAIScheduleEByCandidate() {
    this->initializeModel();
}

OAIScheduleEByCandidate::~OAIScheduleEByCandidate() {}

void OAIScheduleEByCandidate::initializeModel() {
...
void OAIScheduleEByCandidate::fromJson(QString jsonString) {
...
void OAIScheduleEByCandidate::fromJsonObject(QJsonObject json) {
...
QString OAIScheduleEByCandidate::asJson() const {
...
QJsonObject OAIScheduleEByCandidate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIScheduleEByCandidate::getCandidateId() const {
    return m_candidate_id;
}
void OAIScheduleEByCandidate::setCandidateId(const QString &candidate_id) {
    m_candidate_id = candidate_id;
    m_candidate_id_isSet = true;
}

bool OAIScheduleEByCandidate::is_candidate_id_Set() const{
    return m_candidate_id_isSet;
}

bool OAIScheduleEByCandidate::is_candidate_id_Valid() const{
    return m_candidate_id_isValid;
}

QString OAIScheduleEByCandidate::getCandidateName() const {
    return m_candidate_name;
}
void OAIScheduleEByCandidate::setCandidateName(const QString &candidate_name) {
    m_candidate_name = candidate_name;
    m_candidate_name_isSet = true;
}

bool OAIScheduleEByCandidate::is_candidate_name_Set() const{
    return m_candidate_name_isSet;
}

bool OAIScheduleEByCandidate::is_candidate_name_Valid() const{
    return m_candidate_name_isValid;
}

QString OAIScheduleEByCandidate::getCommitteeId() const {
    return m_committee_id;
}
void OAIScheduleEByCandidate::setCommitteeId(const QString &committee_id) {
    m_committee_id = committee_id;
    m_committee_id_isSet = true;
}

bool OAIScheduleEByCandidate::is_committee_id_Set() const{
    return m_committee_id_isSet;
}

bool OAIScheduleEByCandidate::is_committee_id_Valid() const{
    return m_committee_id_isValid;
}

QString OAIScheduleEByCandidate::getCommitteeName() const {
    return m_committee_name;
}
void OAIScheduleEByCandidate::setCommitteeName(const QString &committee_name) {
    m_committee_name = committee_name;
    m_committee_name_isSet = true;
}

bool OAIScheduleEByCandidate::is_committee_name_Set() const{
    return m_committee_name_isSet;
}

bool OAIScheduleEByCandidate::is_committee_name_Valid() const{
    return m_committee_name_isValid;
}

qint32 OAIScheduleEByCandidate::getCount() const {
    return m_count;
}
void OAIScheduleEByCandidate::setCount(const qint32 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIScheduleEByCandidate::is_count_Set() const{
    return m_count_isSet;
}

bool OAIScheduleEByCandidate::is_count_Valid() const{
    return m_count_isValid;
}

qint32 OAIScheduleEByCandidate::getCycle() const {
    return m_cycle;
}
void OAIScheduleEByCandidate::setCycle(const qint32 &cycle) {
    m_cycle = cycle;
    m_cycle_isSet = true;
}

bool OAIScheduleEByCandidate::is_cycle_Set() const{
    return m_cycle_isSet;
}

bool OAIScheduleEByCandidate::is_cycle_Valid() const{
    return m_cycle_isValid;
}

QString OAIScheduleEByCandidate::getSupportOpposeIndicator() const {
    return m_support_oppose_indicator;
}
void OAIScheduleEByCandidate::setSupportOpposeIndicator(const QString &support_oppose_indicator) {
    m_support_oppose_indicator = support_oppose_indicator;
    m_support_oppose_indicator_isSet = true;
}

bool OAIScheduleEByCandidate::is_support_oppose_indicator_Set() const{
    return m_support_oppose_indicator_isSet;
}

bool OAIScheduleEByCandidate::is_support_oppose_indicator_Valid() const{
    return m_support_oppose_indicator_isValid;
}

double OAIScheduleEByCandidate::getTotal() const {
    return m_total;
}
void OAIScheduleEByCandidate::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIScheduleEByCandidate::is_total_Set() const{
    return m_total_isSet;
}

bool OAIScheduleEByCandidate::is_total_Valid() const{
    return m_total_isValid;
}

bool OAIScheduleEByCandidate::isSet() const {
...
bool OAIScheduleEByCandidate::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_cycle_isValid && m_support_oppose_indicator_isValid && true;
}
