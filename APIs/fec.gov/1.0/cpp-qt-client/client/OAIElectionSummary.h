...
/*
 * OAIElectionSummary.h
 *
 * 
 */

#ifndef OAIElectionSummary_H
#define OAIElectionSummary_H
...
class OAIElectionSummary : public OAIObject {
public:
    OAIElectionSummary();
    OAIElectionSummary(QString json);
    ~OAIElectionSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElectionSummary)

#endif // OAIElectionSummary_H
