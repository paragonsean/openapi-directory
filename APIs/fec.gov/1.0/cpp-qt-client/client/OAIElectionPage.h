...
#ifndef OAIElectionPage_H
#define OAIElectionPage_H
...
class OAIElectionPage : public OAIObject {
public:
    OAIElectionPage();
    OAIElectionPage(QString json);
    ~OAIElectionPage() override;
    ...
    QList<OAIElection> getResults() const;
    void setResults(const QList<OAIElection> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIElectionPage)

#endif // OAIElectionPage_H
