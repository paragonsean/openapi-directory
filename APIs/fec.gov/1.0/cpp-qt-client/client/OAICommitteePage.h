...
#ifndef OAICommitteePage_H
#define OAICommitteePage_H
...
class OAICommitteePage : public OAIObject {
public:
    OAICommitteePage();
    OAICommitteePage(QString json);
    ~OAICommitteePage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommitteePage)

#endif // OAICommitteePage_H
