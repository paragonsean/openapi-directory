...
#ifndef OAICandidateTotal_H
#define OAICandidateTotal_H
...
class OAICandidateTotal : public OAIObject {
public:
    OAICandidateTotal();
    OAICandidateTotal(QString json);
    ~OAICandidateTotal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICandidateTotal)

#endif // OAICandidateTotal_H
