...
#ifndef OAIBaseF3Filing_H
#define OAIBaseF3Filing_H
...
class OAIBaseF3Filing : public OAIObject {
public:
    OAIBaseF3Filing();
    OAIBaseF3Filing(QString json);
    ~OAIBaseF3Filing() override;
    ...
    QString getAmendedAddress() const;
    void setAmendedAddress(const QString &amended_address);
    bool is_amended_address_Set() const;
    bool is_amended_address_Valid() const;
    ...
    qint32 getCashOnHandBeginningPeriod() const;
    void setCashOnHandBeginningPeriod(const qint32 &cash_on_hand_beginning_period);
    ...
    qint32 getDistrict() const;
    void setDistrict(const qint32 &district);
    ...
    qint32 getF3z1() const;
    void setF3z1(const qint32 &f3z1);
    bool is_f3z1_Set() const;
    bool is_f3z1_Valid() const;
    ...
    QString getRunoffElection() const;
    void setRunoffElection(const QString &runoff_election);
    bool is_runoff_election_Set() const;
    bool is_runoff_election_Valid() const;
    ...
    QString getSpecialElection() const;
    void setSpecialElection(const QString &special_election);
    bool is_special_election_Set() const;
    bool is_special_election_Valid() const;
...
private:
    ...
    QString m_amended_address;
    bool m_amended_address_isSet;
    bool m_amended_address_isValid;
    ...
    qint32 m_cash_on_hand_beginning_period;
    ...
    QString m_runoff_election;
    bool m_runoff_election_isSet;
    bool m_runoff_election_isValid;

    QDate m_sign_date;
    bool m_sign_date_isSet;
    bool m_sign_date_isValid;

    QString m_special_election;
    bool m_special_election_isSet;
    bool m_special_election_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseF3Filing)

#endif // OAIBaseF3Filing_H
