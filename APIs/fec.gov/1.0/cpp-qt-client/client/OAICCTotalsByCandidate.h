...
/*
 * OAICCTotalsByCandidate.h
 *
 * 
 */

#ifndef OAICCTotalsByCandidate_H
#define OAICCTotalsByCandidate_H
...
class OAICCTotalsByCandidate : public OAIObject {
public:
    OAICCTotalsByCandidate();
    OAICCTotalsByCandidate(QString json);
    ~OAICCTotalsByCandidate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICCTotalsByCandidate)

#endif // OAICCTotalsByCandidate_H
