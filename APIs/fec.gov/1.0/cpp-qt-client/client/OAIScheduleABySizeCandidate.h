...
/*
 * OAIScheduleABySizeCandidate.h
 *
 * 
 */

#ifndef OAIScheduleABySizeCandidate_H
#define OAIScheduleABySizeCandidate_H
...
class OAIScheduleABySizeCandidate : public OAIObject {
public:
    OAIScheduleABySizeCandidate();
    OAIScheduleABySizeCandidate(QString json);
    ~OAIScheduleABySizeCandidate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleABySizeCandidate)

#endif // OAIScheduleABySizeCandidate_H
