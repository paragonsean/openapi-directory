...
/*
 * OAIScheduleEByCandidate.h
 *
 * 
 */

#ifndef OAIScheduleEByCandidate_H
#define OAIScheduleEByCandidate_H
...
class OAIScheduleEByCandidate : public OAIObject {
public:
    OAIScheduleEByCandidate();
    OAIScheduleEByCandidate(QString json);
    ~OAIScheduleEByCandidate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleEByCandidate)

#endif // OAIScheduleEByCandidate_H
