...
/*
 * OAICandidateDetail.h
 *
 * 
 */

#ifndef OAICandidateDetail_H
#define OAICandidateDetail_H
...
class OAICandidateDetail : public OAIObject {
public:
    OAICandidateDetail();
    OAICandidateDetail(QString json);
    ~OAICandidateDetail() override;
    ...
    QString getAddressStreet1() const;
    void setAddressStreet1(const QString &address_street_1);
    bool is_address_street_1_Set() const;
    bool is_address_street_1_Valid() const;

    QString getAddressStreet2() const;
    void setAddressStreet2(const QString &address_street_2);
    bool is_address_street_2_Set() const;
    bool is_address_street_2_Valid() const;
...
private:
    ...
    QString m_address_street_1;
    bool m_address_street_1_isSet;
    bool m_address_street_1_isValid;

    QString m_address_street_2;
    bool m_address_street_2_isSet;
    bool m_address_street_2_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICandidateDetail)

#endif // OAICandidateDetail_H
