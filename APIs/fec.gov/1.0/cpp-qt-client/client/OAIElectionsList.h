...
#ifndef OAIElectionsList_H
#define OAIElectionsList_H
...
class OAIElectionsList : public OAIObject {
public:
    OAIElectionsList();
    OAIElectionsList(QString json);
    ~OAIElectionsList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElectionsList)

#endif // OAIElectionsList_H
