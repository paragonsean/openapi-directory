...
/*
 * OAICommunicationCostByCandidate.h
 *
 * 
 */

#ifndef OAICommunicationCostByCandidate_H
#define OAICommunicationCostByCandidate_H
...
class OAICommunicationCostByCandidate : public OAIObject {
public:
    OAICommunicationCostByCandidate();
    OAICommunicationCostByCandidate(QString json);
    ~OAICommunicationCostByCandidate() override;
    ...
    QString getCommittee() const;
    void setCommittee(const QString &committee);
...
Q_DECLARE_METATYPE(OpenAPI::OAICommunicationCostByCandidate)

#endif // OAICommunicationCostByCandidate_H
