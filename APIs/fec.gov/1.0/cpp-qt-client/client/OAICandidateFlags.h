...
#ifndef OAICandidateFlags_H
#define OAICandidateFlags_H
...
class OAICandidateFlags : public OAIObject {
public:
    OAICandidateFlags();
    OAICandidateFlags(QString json);
    ~OAICandidateFlags() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICandidateFlags)

#endif // OAICandidateFlags_H
