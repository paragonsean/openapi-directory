...
/*
 * OAICandidateCommitteeTotalsHouseSenate.h
 *
 * 
 */

#ifndef OAICandidateCommitteeTotalsHouseSenate_H
#define OAICandidateCommitteeTotalsHouseSenate_H
...
class OAICandidateCommitteeTotalsHouseSenate : public OAIObject {
public:
    OAICandidateCommitteeTotalsHouseSenate();
    OAICandidateCommitteeTotalsHouseSenate(QString json);
    ~OAICandidateCommitteeTotalsHouseSenate() override;
    ...
    double getAllOtherLoans() const;
    void setAllOtherLoans(const double &all_other_loans);
    bool is_all_other_loans_Set() const;
    bool is_all_other_loans_Valid() const;
    ...
    double getLastNetContributions() const;
    void setLastNetContributions(const double &last_net_contributions);
    bool is_last_net_contributions_Set() const;
    bool is_last_net_contributions_Valid() const;

    double getLastNetOperatingExpenditures() const;
    void setLastNetOperatingExpenditures(const double &last_net_operating_expenditures);
    bool is_last_net_operating_expenditures_Set() const;
    bool is_last_net_operating_expenditures_Valid() const;
    ...
    double getLoanRepayments() const;
    void setLoanRepayments(const double &loan_repayments);
    bool is_loan_repayments_Set() const;
    bool is_loan_repayments_Valid() const;

    double getLoanRepaymentsCandidateLoans() const;
    void setLoanRepaymentsCandidateLoans(const double &loan_repayments_candidate_loans);
    bool is_loan_repayments_candidate_loans_Set() const;
    bool is_loan_repayments_candidate_loans_Valid() const;

    double getLoanRepaymentsOtherLoans() const;
    void setLoanRepaymentsOtherLoans(const double &loan_repayments_other_loans);
    bool is_loan_repayments_other_loans_Set() const;
    bool is_loan_repayments_other_loans_Valid() const;

    double getLoans() const;
    void setLoans(const double &loans);
    bool is_loans_Set() const;
    bool is_loans_Valid() const;

    double getLoansMadeByCandidate() const;
    void setLoansMadeByCandidate(const double &loans_made_by_candidate);
    bool is_loans_made_by_candidate_Set() const;
    bool is_loans_made_by_candidate_Valid() const;
    ...
    double getTransfersFromOtherAuthorizedCommittee() const;
    void setTransfersFromOtherAuthorizedCommittee(const double &transfers_from_other_authorized_committee);
    bool is_transfers_from_other_authorized_committee_Set() const;
    bool is_transfers_from_other_authorized_committee_Valid() const;
...
private:
    ...
    double m_all_other_loans;
    bool m_all_other_loans_isSet;
    bool m_all_other_loans_isValid;
    ...
    double m_last_net_contributions;
    bool m_last_net_contributions_isSet;
    bool m_last_net_contributions_isValid;

    double m_last_net_operating_expenditures;
    bool m_last_net_operating_expenditures_isSet;
    bool m_last_net_operating_expenditures_isValid;
    ...
    double m_loan_repayments;
    bool m_loan_repayments_isSet;
    bool m_loan_repayments_isValid;

    double m_loan_repayments_candidate_loans;
    bool m_loan_repayments_candidate_loans_isSet;
    bool m_loan_repayments_candidate_loans_isValid;

    double m_loan_repayments_other_loans;
    bool m_loan_repayments_other_loans_isSet;
    bool m_loan_repayments_other_loans_isValid;

    double m_loans;
    bool m_loans_isSet;
    bool m_loans_isValid;

    double m_loans_made_by_candidate;
    bool m_loans_made_by_candidate_isSet;
    bool m_loans_made_by_candidate_isValid;
    ...
    double m_transfers_from_other_authorized_committee;
    bool m_transfers_from_other_authorized_committee_isSet;
    bool m_transfers_from_other_authorized_committee_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICandidateCommitteeTotalsHouseSenate)

#endif // OAICandidateCommitteeTotalsHouseSenate_H
