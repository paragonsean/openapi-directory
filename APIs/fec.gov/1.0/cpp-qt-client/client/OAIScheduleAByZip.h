...
#ifndef OAIScheduleAByZip_H
#define OAIScheduleAByZip_H
...
class OAIScheduleAByZip : public OAIObject {
public:
    OAIScheduleAByZip();
    OAIScheduleAByZip(QString json);
    ~OAIScheduleAByZip() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleAByZip)

#endif // OAIScheduleAByZip_H
