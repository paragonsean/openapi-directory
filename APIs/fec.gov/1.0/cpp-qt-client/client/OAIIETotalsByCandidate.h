...
/*
 * OAIIETotalsByCandidate.h
 *
 * 
 */

#ifndef OAIIETotalsByCandidate_H
#define OAIIETotalsByCandidate_H
...
class OAIIETotalsByCandidate : public OAIObject {
public:
    OAIIETotalsByCandidate();
    OAIIETotalsByCandidate(QString json);
    ~OAIIETotalsByCandidate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIETotalsByCandidate)

#endif // OAIIETotalsByCandidate_H
