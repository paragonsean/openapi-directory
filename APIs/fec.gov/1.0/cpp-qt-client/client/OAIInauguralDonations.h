...
/*
 * OAIInauguralDonations.h
 *
 * 
 */

#ifndef OAIInauguralDonations_H
#define OAIInauguralDonations_H
...
class OAIInauguralDonations : public OAIObject {
public:
    OAIInauguralDonations();
    OAIInauguralDonations(QString json);
    ~OAIInauguralDonations() override;
    ...
    void setTotalDonation(const double &total_donation);
    bool is_total_donation_Set() const;
    bool is_total_donation_Valid() const;
...
private:
    ...
    double m_total_donation;
    bool m_total_donation_isSet;
    bool m_total_donation_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIInauguralDonations)

#endif // OAIInauguralDonations_H
