...
/*
 * OAIPresidentialByState.h
 *
 * 
 */

#ifndef OAIPresidentialByState_H
#define OAIPresidentialByState_H
...
class OAIPresidentialByState : public OAIObject {
public:
    OAIPresidentialByState();
    OAIPresidentialByState(QString json);
    ~OAIPresidentialByState() override;
    ...
    QString getContributionState() const;
    void setContributionState(const QString &contribution_state);
    bool is_contribution_state_Set() const;
    bool is_contribution_state_Valid() const;
...
private:
    ...
    QString m_contribution_state;
    bool m_contribution_state_isSet;
    bool m_contribution_state_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPresidentialByState)

#endif // OAIPresidentialByState_H
