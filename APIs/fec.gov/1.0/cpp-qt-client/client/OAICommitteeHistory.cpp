...
OAICommitteeHistory::OAICommitteeHistory(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommitteeHistory::OAICommitteeHistory() {
    this->initializeModel();
}

OAICommitteeHistory::~OAICommitteeHistory() {}

void OAICommitteeHistory::initializeModel() {
...
void OAICommitteeHistory::fromJson(QString jsonString) {
...
void OAICommitteeHistory::fromJsonObject(QJsonObject json) {
...
QString OAICommitteeHistory::asJson() const {
...
QJsonObject OAICommitteeHistory::asJsonObject() const {
    QJsonObject obj;
...
QString OAICommitteeHistory::getAffiliatedCommitteeName() const {
    return m_affiliated_committee_name;
}
void OAICommitteeHistory::setAffiliatedCommitteeName(const QString &affiliated_committee_name) {
    m_affiliated_committee_name = affiliated_committee_name;
    m_affiliated_committee_name_isSet = true;
}

bool OAICommitteeHistory::is_affiliated_committee_name_Set() const{
    return m_affiliated_committee_name_isSet;
}

bool OAICommitteeHistory::is_affiliated_committee_name_Valid() const{
    return m_affiliated_committee_name_isValid;
}

QList<QString> OAICommitteeHistory::getCandidateIds() const {
    return m_candidate_ids;
}
void OAICommitteeHistory::setCandidateIds(const QList<QString> &candidate_ids) {
    m_candidate_ids = candidate_ids;
    m_candidate_ids_isSet = true;
}

bool OAICommitteeHistory::is_candidate_ids_Set() const{
    return m_candidate_ids_isSet;
}

bool OAICommitteeHistory::is_candidate_ids_Valid() const{
    return m_candidate_ids_isValid;
}

QString OAICommitteeHistory::getCity() const {
    return m_city;
}
void OAICommitteeHistory::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAICommitteeHistory::is_city_Set() const{
    return m_city_isSet;
}

bool OAICommitteeHistory::is_city_Valid() const{
    return m_city_isValid;
}

QString OAICommitteeHistory::getCommitteeId() const {
    return m_committee_id;
}
void OAICommitteeHistory::setCommitteeId(const QString &committee_id) {
    m_committee_id = committee_id;
    m_committee_id_isSet = true;
}

bool OAICommitteeHistory::is_committee_id_Set() const{
    return m_committee_id_isSet;
}

bool OAICommitteeHistory::is_committee_id_Valid() const{
    return m_committee_id_isValid;
}

QString OAICommitteeHistory::getCommitteeType() const {
    return m_committee_type;
}
void OAICommitteeHistory::setCommitteeType(const QString &committee_type) {
    m_committee_type = committee_type;
    m_committee_type_isSet = true;
}

bool OAICommitteeHistory::is_committee_type_Set() const{
    return m_committee_type_isSet;
}

bool OAICommitteeHistory::is_committee_type_Valid() const{
    return m_committee_type_isValid;
}

QString OAICommitteeHistory::getCommitteeTypeFull() const {
    return m_committee_type_full;
}
void OAICommitteeHistory::setCommitteeTypeFull(const QString &committee_type_full) {
    m_committee_type_full = committee_type_full;
    m_committee_type_full_isSet = true;
}

bool OAICommitteeHistory::is_committee_type_full_Set() const{
    return m_committee_type_full_isSet;
}

bool OAICommitteeHistory::is_committee_type_full_Valid() const{
    return m_committee_type_full_isValid;
}

qint32 OAICommitteeHistory::getCycle() const {
    return m_cycle;
}
void OAICommitteeHistory::setCycle(const qint32 &cycle) {
    m_cycle = cycle;
    m_cycle_isSet = true;
}

bool OAICommitteeHistory::is_cycle_Set() const{
    return m_cycle_isSet;
}

bool OAICommitteeHistory::is_cycle_Valid() const{
    return m_cycle_isValid;
}

QList<qint32> OAICommitteeHistory::getCycles() const {
    return m_cycles;
}
void OAICommitteeHistory::setCycles(const QList<qint32> &cycles) {
    m_cycles = cycles;
    m_cycles_isSet = true;
}

bool OAICommitteeHistory::is_cycles_Set() const{
    return m_cycles_isSet;
}

bool OAICommitteeHistory::is_cycles_Valid() const{
    return m_cycles_isValid;
}

QList<qint32> OAICommitteeHistory::getCyclesHasActivity() const {
    return m_cycles_has_activity;
}
void OAICommitteeHistory::setCyclesHasActivity(const QList<qint32> &cycles_has_activity) {
    m_cycles_has_activity = cycles_has_activity;
    m_cycles_has_activity_isSet = true;
}

bool OAICommitteeHistory::is_cycles_has_activity_Set() const{
    return m_cycles_has_activity_isSet;
}

bool OAICommitteeHistory::is_cycles_has_activity_Valid() const{
    return m_cycles_has_activity_isValid;
}

QList<qint32> OAICommitteeHistory::getCyclesHasFinancial() const {
    return m_cycles_has_financial;
}
void OAICommitteeHistory::setCyclesHasFinancial(const QList<qint32> &cycles_has_financial) {
    m_cycles_has_financial = cycles_has_financial;
    m_cycles_has_financial_isSet = true;
}

bool OAICommitteeHistory::is_cycles_has_financial_Set() const{
    return m_cycles_has_financial_isSet;
}

bool OAICommitteeHistory::is_cycles_has_financial_Valid() const{
    return m_cycles_has_financial_isValid;
}

QString OAICommitteeHistory::getDesignation() const {
    return m_designation;
}
void OAICommitteeHistory::setDesignation(const QString &designation) {
    m_designation = designation;
    m_designation_isSet = true;
}

bool OAICommitteeHistory::is_designation_Set() const{
    return m_designation_isSet;
}

bool OAICommitteeHistory::is_designation_Valid() const{
    return m_designation_isValid;
}

QString OAICommitteeHistory::getDesignationFull() const {
    return m_designation_full;
}
void OAICommitteeHistory::setDesignationFull(const QString &designation_full) {
    m_designation_full = designation_full;
    m_designation_full_isSet = true;
}

bool OAICommitteeHistory::is_designation_full_Set() const{
    return m_designation_full_isSet;
}

bool OAICommitteeHistory::is_designation_full_Valid() const{
    return m_designation_full_isValid;
}

QString OAICommitteeHistory::getFilingFrequency() const {
    return m_filing_frequency;
}
void OAICommitteeHistory::setFilingFrequency(const QString &filing_frequency) {
    m_filing_frequency = filing_frequency;
    m_filing_frequency_isSet = true;
}

bool OAICommitteeHistory::is_filing_frequency_Set() const{
    return m_filing_frequency_isSet;
}

bool OAICommitteeHistory::is_filing_frequency_Valid() const{
    return m_filing_frequency_isValid;
}

QDate OAICommitteeHistory::getFirstF1Date() const {
    return m_first_f1_date;
}
void OAICommitteeHistory::setFirstF1Date(const QDate &first_f1_date) {
    m_first_f1_date = first_f1_date;
    m_first_f1_date_isSet = true;
}

bool OAICommitteeHistory::is_first_f1_date_Set() const{
    return m_first_f1_date_isSet;
}

bool OAICommitteeHistory::is_first_f1_date_Valid() const{
    return m_first_f1_date_isValid;
}

QDate OAICommitteeHistory::getFirstFileDate() const {
    return m_first_file_date;
}
void OAICommitteeHistory::setFirstFileDate(const QDate &first_file_date) {
    m_first_file_date = first_file_date;
    m_first_file_date_isSet = true;
}

bool OAICommitteeHistory::is_first_file_date_Set() const{
    return m_first_file_date_isSet;
}

bool OAICommitteeHistory::is_first_file_date_Valid() const{
    return m_first_file_date_isValid;
}

bool OAICommitteeHistory::isIsActive() const {
    return m_is_active;
}
void OAICommitteeHistory::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAICommitteeHistory::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAICommitteeHistory::is_is_active_Valid() const{
    return m_is_active_isValid;
}

QList<OAICommitteeDetail_jfc_committee_inner> OAICommitteeHistory::getJfcCommittee() const {
    return m_jfc_committee;
}
void OAICommitteeHistory::setJfcCommittee(const QList<OAICommitteeDetail_jfc_committee_inner> &jfc_committee) {
    m_jfc_committee = jfc_committee;
    m_jfc_committee_isSet = true;
}

bool OAICommitteeHistory::is_jfc_committee_Set() const{
    return m_jfc_committee_isSet;
}

bool OAICommitteeHistory::is_jfc_committee_Valid() const{
    return m_jfc_committee_isValid;
}

qint32 OAICommitteeHistory::getLastCycleHasActivity() const {
    return m_last_cycle_has_activity;
}
void OAICommitteeHistory::setLastCycleHasActivity(const qint32 &last_cycle_has_activity) {
    m_last_cycle_has_activity = last_cycle_has_activity;
    m_last_cycle_has_activity_isSet = true;
}

bool OAICommitteeHistory::is_last_cycle_has_activity_Set() const{
    return m_last_cycle_has_activity_isSet;
}

bool OAICommitteeHistory::is_last_cycle_has_activity_Valid() const{
    return m_last_cycle_has_activity_isValid;
}

qint32 OAICommitteeHistory::getLastCycleHasFinancial() const {
    return m_last_cycle_has_financial;
}
void OAICommitteeHistory::setLastCycleHasFinancial(const qint32 &last_cycle_has_financial) {
    m_last_cycle_has_financial = last_cycle_has_financial;
    m_last_cycle_has_financial_isSet = true;
}

bool OAICommitteeHistory::is_last_cycle_has_financial_Set() const{
    return m_last_cycle_has_financial_isSet;
}

bool OAICommitteeHistory::is_last_cycle_has_financial_Valid() const{
    return m_last_cycle_has_financial_isValid;
}

QDate OAICommitteeHistory::getLastF1Date() const {
    return m_last_f1_date;
}
void OAICommitteeHistory::setLastF1Date(const QDate &last_f1_date) {
    m_last_f1_date = last_f1_date;
    m_last_f1_date_isSet = true;
}

bool OAICommitteeHistory::is_last_f1_date_Set() const{
    return m_last_f1_date_isSet;
}

bool OAICommitteeHistory::is_last_f1_date_Valid() const{
    return m_last_f1_date_isValid;
}

QDate OAICommitteeHistory::getLastFileDate() const {
    return m_last_file_date;
}
void OAICommitteeHistory::setLastFileDate(const QDate &last_file_date) {
    m_last_file_date = last_file_date;
    m_last_file_date_isSet = true;
}

bool OAICommitteeHistory::is_last_file_date_Set() const{
    return m_last_file_date_isSet;
}

bool OAICommitteeHistory::is_last_file_date_Valid() const{
    return m_last_file_date_isValid;
}

QString OAICommitteeHistory::getName() const {
    return m_name;
}
void OAICommitteeHistory::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICommitteeHistory::is_name_Set() const{
    return m_name_isSet;
}

bool OAICommitteeHistory::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICommitteeHistory::getOrganizationType() const {
    return m_organization_type;
}
void OAICommitteeHistory::setOrganizationType(const QString &organization_type) {
    m_organization_type = organization_type;
    m_organization_type_isSet = true;
}

bool OAICommitteeHistory::is_organization_type_Set() const{
    return m_organization_type_isSet;
}

bool OAICommitteeHistory::is_organization_type_Valid() const{
    return m_organization_type_isValid;
}

QString OAICommitteeHistory::getOrganizationTypeFull() const {
    return m_organization_type_full;
}
void OAICommitteeHistory::setOrganizationTypeFull(const QString &organization_type_full) {
    m_organization_type_full = organization_type_full;
    m_organization_type_full_isSet = true;
}

bool OAICommitteeHistory::is_organization_type_full_Set() const{
    return m_organization_type_full_isSet;
}

bool OAICommitteeHistory::is_organization_type_full_Valid() const{
    return m_organization_type_full_isValid;
}

QString OAICommitteeHistory::getParty() const {
    return m_party;
}
void OAICommitteeHistory::setParty(const QString &party) {
    m_party = party;
    m_party_isSet = true;
}

bool OAICommitteeHistory::is_party_Set() const{
    return m_party_isSet;
}

bool OAICommitteeHistory::is_party_Valid() const{
    return m_party_isValid;
}

QString OAICommitteeHistory::getPartyFull() const {
    return m_party_full;
}
void OAICommitteeHistory::setPartyFull(const QString &party_full) {
    m_party_full = party_full;
    m_party_full_isSet = true;
}

bool OAICommitteeHistory::is_party_full_Set() const{
    return m_party_full_isSet;
}

bool OAICommitteeHistory::is_party_full_Valid() const{
    return m_party_full_isValid;
}

QString OAICommitteeHistory::getState() const {
    return m_state;
}
void OAICommitteeHistory::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAICommitteeHistory::is_state_Set() const{
    return m_state_isSet;
}

bool OAICommitteeHistory::is_state_Valid() const{
    return m_state_isValid;
}

QString OAICommitteeHistory::getStateFull() const {
    return m_state_full;
}
void OAICommitteeHistory::setStateFull(const QString &state_full) {
    m_state_full = state_full;
    m_state_full_isSet = true;
}

bool OAICommitteeHistory::is_state_full_Set() const{
    return m_state_full_isSet;
}

bool OAICommitteeHistory::is_state_full_Valid() const{
    return m_state_full_isValid;
}

QString OAICommitteeHistory::getStreet1() const {
    return m_street_1;
}
void OAICommitteeHistory::setStreet1(const QString &street_1) {
    m_street_1 = street_1;
    m_street_1_isSet = true;
}

bool OAICommitteeHistory::is_street_1_Set() const{
    return m_street_1_isSet;
}

bool OAICommitteeHistory::is_street_1_Valid() const{
    return m_street_1_isValid;
}

QString OAICommitteeHistory::getStreet2() const {
    return m_street_2;
}
void OAICommitteeHistory::setStreet2(const QString &street_2) {
    m_street_2 = street_2;
    m_street_2_isSet = true;
}

bool OAICommitteeHistory::is_street_2_Set() const{
    return m_street_2_isSet;
}

bool OAICommitteeHistory::is_street_2_Valid() const{
    return m_street_2_isValid;
}

QString OAICommitteeHistory::getTreasurerName() const {
    return m_treasurer_name;
}
void OAICommitteeHistory::setTreasurerName(const QString &treasurer_name) {
    m_treasurer_name = treasurer_name;
    m_treasurer_name_isSet = true;
}

bool OAICommitteeHistory::is_treasurer_name_Set() const{
    return m_treasurer_name_isSet;
}

bool OAICommitteeHistory::is_treasurer_name_Valid() const{
    return m_treasurer_name_isValid;
}

QString OAICommitteeHistory::getZip() const {
    return m_zip;
}
void OAICommitteeHistory::setZip(const QString &zip) {
    m_zip = zip;
    m_zip_isSet = true;
}

bool OAICommitteeHistory::is_zip_Set() const{
    return m_zip_isSet;
}

bool OAICommitteeHistory::is_zip_Valid() const{
    return m_zip_isValid;
}

bool OAICommitteeHistory::isSet() const {
...
bool OAICommitteeHistory::isValid() const {
