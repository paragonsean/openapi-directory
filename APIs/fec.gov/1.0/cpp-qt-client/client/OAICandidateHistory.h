...
/*
 * OAICandidateHistory.h
 *
 * 
 */

#ifndef OAICandidateHistory_H
#define OAICandidateHistory_H
...
class OAICandidateHistory : public OAIObject {
public:
    OAICandidateHistory();
    OAICandidateHistory(QString json);
    ~OAICandidateHistory() override;
    ...
    QList<qint32> getFecCyclesInElection() const;
    void setFecCyclesInElection(const QList<qint32> &fec_cycles_in_election);
    bool is_fec_cycles_in_election_Set() const;
    bool is_fec_cycles_in_election_Valid() const;
    ...
    QList<qint32> getRoundedElectionYears() const;
    void setRoundedElectionYears(const QList<qint32> &rounded_election_years);
    bool is_rounded_election_years_Set() const;
    bool is_rounded_election_years_Valid() const;
    ...
    qint32 getTwoYearPeriod() const;
    void setTwoYearPeriod(const qint32 &two_year_period);
    bool is_two_year_period_Set() const;
    bool is_two_year_period_Valid() const;
...
private:
    ...
    QList<qint32> m_fec_cycles_in_election;
    bool m_fec_cycles_in_election_isSet;
    bool m_fec_cycles_in_election_isValid;
    ...
    QList<qint32> m_rounded_election_years;
    bool m_rounded_election_years_isSet;
    bool m_rounded_election_years_isValid;

    QString m_state;
    bool m_state_isSet;
    bool m_state_isValid;

    qint32 m_two_year_period;
    bool m_two_year_period_isSet;
    bool m_two_year_period_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICandidateHistory)

#endif // OAICandidateHistory_H
