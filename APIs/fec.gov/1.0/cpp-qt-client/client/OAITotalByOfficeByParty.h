...
/*
 * OAITotalByOfficeByParty.h
 *
 * 
 */

#ifndef OAITotalByOfficeByParty_H
#define OAITotalByOfficeByParty_H
...
class OAITotalByOfficeByParty : public OAIObject {
public:
    OAITotalByOfficeByParty();
    OAITotalByOfficeByParty(QString json);
    ~OAITotalByOfficeByParty() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITotalByOfficeByParty)

#endif // OAITotalByOfficeByParty_H
