...
------------ | ------------- | ------------- | -------------
**additionalBankNames** | **[String]** |  Additional banks or depositories in which the committee deposits funds, holds accounts, rents safety deposit boxes or maintains funds.  | [optional] 
...
**amendmentVersion** | **Number** |  Amendment version  | [optional] 
...
**fileNumber** | **Number** | Filing ID number | [optional] 
...
**housePersonalFunds** | **Number** | House personal funds | [optional] 
...
**netDonations** | **Number** | Net donations | [optional] 
**office** | **String** | Federal office candidate runs for: H, S or P | [optional] 
**oppositionPersonalFunds** | **Number** | Opposition personal funds | [optional] 
...
**previousFileNumber** | **Number** |  Previous filing ID number  | [optional] 
...
**senatePersonalFunds** | **Number** | Senate personal funds | [optional] 
**state** | **String** | US state or territory where a candidate runs for office | [optional] 
**subId** | **String** |  | [optional] 
**totalCommunicationCost** | **Number** | Total communications cost | [optional] 
**totalDisbursements** | **Number** | Total disbursements | [optional] 
**totalIndependentExpenditures** | **Number** | Total independent expenditures | [optional] 
**totalIndividualContributions** | **Number** | Total individual contributions | [optional] 
**totalReceipts** | **Number** | Total receipts | [optional] 
...
**updateDate** | **Date** | Date the record was updated | [optional] 
