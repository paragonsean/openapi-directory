...
**amendsFile** | **Number** |  For amendments, this file_number is the file_number of the previous report that is being amended. Refer to the amended_by for the most recent version of the report.  | [optional] 
...
**filedDate** | **Date** | Timestamp of electronic or paper record that FEC received | [optional] 
