...
> CommunicationCostByCandidatePage communicationCostsAggregatesGet(apiKey, opts)
...
let apiInstance = new OpenFec.CommunicationCostApi();
let apiKey = "'DEMO_KEY'"; // String |  API key for https://api.data.gov. Get one at https://api.data.gov/signup. 
let opts = {
  'supportOpposeIndicator': "supportOpposeIndicator_example", // String | Support or opposition
...
apiInstance.communicationCostsAggregatesGet(apiKey, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **supportOpposeIndicator** | **String**| Support or opposition | [optional] 
...
> CommunicationCostByCandidatePage communicationCostsByCandidateGet(apiKey, opts)
...
apiInstance.communicationCostsByCandidateGet(apiKey, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CommunicationCostPage communicationCostsGet(apiKey, opts)
...
let opts = {
  ...
  'supportOpposeIndicator': ["null"], // [String] | Support or opposition
...
apiInstance.communicationCostsGet(apiKey, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **supportOpposeIndicator** | [**[String]**](String.md)| Support or opposition | [optional] 
...
> CCTotalsByCandidatePage communicationCostsTotalsByCandidateGet(apiKey, opts)
...
apiInstance.communicationCostsTotalsByCandidateGet(apiKey, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
