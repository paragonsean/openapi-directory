...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ScheduleAByStateRecipientTotals();
  });
  ...
  describe('ScheduleAByStateRecipientTotals', function() {
    it('should create an instance of ScheduleAByStateRecipientTotals', function() {
      // uncomment below and update the code to test ScheduleAByStateRecipientTotals
      //var instance = new OpenFec.ScheduleAByStateRecipientTotals();
      //expect(instance).to.be.a(OpenFec.ScheduleAByStateRecipientTotals);
    });
