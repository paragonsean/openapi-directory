...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ScheduleA();
  });
  ...
  describe('ScheduleA', function() {
    it('should create an instance of ScheduleA', function() {
      // uncomment below and update the code to test ScheduleA
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be.a(OpenFec.ScheduleA);
    });
    ...
    it('should have the property contributorStreet1 (base name: "contributor_street_1")', function() {
      // uncomment below and update the code to test the property contributorStreet1
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be();
    });

    it('should have the property contributorStreet2 (base name: "contributor_street_2")', function() {
      // uncomment below and update the code to test the property contributorStreet2
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be();
    });
    ...
    it('should have the property donorCommitteeName (base name: "donor_committee_name")', function() {
      // uncomment below and update the code to test the property donorCommitteeName
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be();
    });
    ...
    it('should have the property increasedLimit (base name: "increased_limit")', function() {
      // uncomment below and update the code to test the property increasedLimit
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be();
    });

    it('should have the property isIndividual (base name: "is_individual")', function() {
      // uncomment below and update the code to test the property isIndividual
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be();
    });
    ...
    it('should have the property receiptType (base name: "receipt_type")', function() {
      // uncomment below and update the code to test the property receiptType
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be();
    });

    it('should have the property receiptTypeDesc (base name: "receipt_type_desc")', function() {
      // uncomment below and update the code to test the property receiptTypeDesc
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be();
    });

    it('should have the property receiptTypeFull (base name: "receipt_type_full")', function() {
      // uncomment below and update the code to test the property receiptTypeFull
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be();
    });

    it('should have the property recipientCommitteeDesignation (base name: "recipient_committee_designation")', function() {
      // uncomment below and update the code to test the property recipientCommitteeDesignation
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be();
    });

    it('should have the property recipientCommitteeOrgType (base name: "recipient_committee_org_type")', function() {
      // uncomment below and update the code to test the property recipientCommitteeOrgType
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be();
    });

    it('should have the property recipientCommitteeType (base name: "recipient_committee_type")', function() {
      // uncomment below and update the code to test the property recipientCommitteeType
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be();
    });
    ...
    it('should have the property unusedContbrId (base name: "unused_contbr_id")', function() {
      // uncomment below and update the code to test the property unusedContbrId
      //var instance = new OpenFec.ScheduleA();
      //expect(instance).to.be();
    });
