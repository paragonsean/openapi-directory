...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.IETotalsByCandidate();
  });
  ...
  describe('IETotalsByCandidate', function() {
    it('should create an instance of IETotalsByCandidate', function() {
      // uncomment below and update the code to test IETotalsByCandidate
      //var instance = new OpenFec.IETotalsByCandidate();
      //expect(instance).to.be.a(OpenFec.IETotalsByCandidate);
    });
