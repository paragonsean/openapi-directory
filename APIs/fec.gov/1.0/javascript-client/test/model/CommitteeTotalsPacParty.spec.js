...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CommitteeTotalsPacParty();
  });
  ...
  describe('CommitteeTotalsPacParty', function() {
    it('should create an instance of CommitteeTotalsPacParty', function() {
      // uncomment below and update the code to test CommitteeTotalsPacParty
      //var instance = new OpenFec.CommitteeTotalsPacParty();
      //expect(instance).to.be.a(OpenFec.CommitteeTotalsPacParty);
    });
