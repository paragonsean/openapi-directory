...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ScheduleAByOccupation();
  });
  ...
  describe('ScheduleAByOccupation', function() {
    it('should create an instance of ScheduleAByOccupation', function() {
      // uncomment below and update the code to test ScheduleAByOccupation
      //var instance = new OpenFec.ScheduleAByOccupation();
      //expect(instance).to.be.a(OpenFec.ScheduleAByOccupation);
    });
