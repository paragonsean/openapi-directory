...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ScheduleAByEmployer();
  });
  ...
  describe('ScheduleAByEmployer', function() {
    it('should create an instance of ScheduleAByEmployer', function() {
      // uncomment below and update the code to test ScheduleAByEmployer
      //var instance = new OpenFec.ScheduleAByEmployer();
      //expect(instance).to.be.a(OpenFec.ScheduleAByEmployer);
    });
