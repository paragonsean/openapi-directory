...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ElectionSearch();
  });
  ...
  describe('ElectionSearch', function() {
    it('should create an instance of ElectionSearch', function() {
      // uncomment below and update the code to test ElectionSearch
      //var instance = new OpenFec.ElectionSearch();
      //expect(instance).to.be.a(OpenFec.ElectionSearch);
    });
    ...
    it('should have the property incumbentId (base name: "incumbent_id")', function() {
      // uncomment below and update the code to test the property incumbentId
      //var instance = new OpenFec.ElectionSearch();
      //expect(instance).to.be();
    });

    it('should have the property incumbentName (base name: "incumbent_name")', function() {
      // uncomment below and update the code to test the property incumbentName
      //var instance = new OpenFec.ElectionSearch();
      //expect(instance).to.be();
    });
