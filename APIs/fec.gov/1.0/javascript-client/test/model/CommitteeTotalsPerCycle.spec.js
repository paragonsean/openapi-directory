...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CommitteeTotalsPerCycle();
  });
  ...
  describe('CommitteeTotalsPerCycle', function() {
    it('should create an instance of CommitteeTotalsPerCycle', function() {
      // uncomment below and update the code to test CommitteeTotalsPerCycle
      //var instance = new OpenFec.CommitteeTotalsPerCycle();
      //expect(instance).to.be.a(OpenFec.CommitteeTotalsPerCycle);
    });
