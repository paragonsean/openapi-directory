...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.BaseF3XFiling();
  });
  ...
  describe('BaseF3XFiling', function() {
    it('should create an instance of BaseF3XFiling', function() {
      // uncomment below and update the code to test BaseF3XFiling
      //var instance = new OpenFec.BaseF3XFiling();
      //expect(instance).to.be.a(OpenFec.BaseF3XFiling);
    });

    it('should have the property amendAddress (base name: "amend_address")', function() {
      // uncomment below and update the code to test the property amendAddress
      //var instance = new OpenFec.BaseF3XFiling();
    ...
    it('should have the property qualifiedMulticandidateCommittee (base name: "qualified_multicandidate_committee")', function() {
      // uncomment below and update the code to test the property qualifiedMulticandidateCommittee
      //var instance = new OpenFec.BaseF3XFiling();
      //expect(instance).to.be();
    });
