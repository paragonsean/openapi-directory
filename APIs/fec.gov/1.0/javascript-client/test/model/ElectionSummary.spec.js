...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ElectionSummary();
  });
  ...
  describe('ElectionSummary', function() {
    it('should create an instance of ElectionSummary', function() {
      // uncomment below and update the code to test ElectionSummary
      //var instance = new OpenFec.ElectionSummary();
      //expect(instance).to.be.a(OpenFec.ElectionSummary);
    });
