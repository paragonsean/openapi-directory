...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ScheduleBByRecipientID();
  });
  ...
  describe('ScheduleBByRecipientID', function() {
    it('should create an instance of ScheduleBByRecipientID', function() {
      // uncomment below and update the code to test ScheduleBByRecipientID
      //var instance = new OpenFec.ScheduleBByRecipientID();
      //expect(instance).to.be.a(OpenFec.ScheduleBByRecipientID);
    });
