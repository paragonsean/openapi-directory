...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CommitteeTotalsHouseSenate();
  });
  ...
  describe('CommitteeTotalsHouseSenate', function() {
    it('should create an instance of CommitteeTotalsHouseSenate', function() {
      // uncomment below and update the code to test CommitteeTotalsHouseSenate
      //var instance = new OpenFec.CommitteeTotalsHouseSenate();
      //expect(instance).to.be.a(OpenFec.CommitteeTotalsHouseSenate);
    });
