...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.PresidentialCoverage();
  });
  ...
  describe('PresidentialCoverage', function() {
    it('should create an instance of PresidentialCoverage', function() {
      // uncomment below and update the code to test PresidentialCoverage
      //var instance = new OpenFec.PresidentialCoverage();
      //expect(instance).to.be.a(OpenFec.PresidentialCoverage);
    });
