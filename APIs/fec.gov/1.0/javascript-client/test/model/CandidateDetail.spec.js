...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CandidateDetail();
  });
  ...
  describe('CandidateDetail', function() {
    it('should create an instance of CandidateDetail', function() {
      // uncomment below and update the code to test CandidateDetail
      //var instance = new OpenFec.CandidateDetail();
      //expect(instance).to.be.a(OpenFec.CandidateDetail);
    });
