...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CCTotalsByCandidate();
  });
  ...
  describe('CCTotalsByCandidate', function() {
    it('should create an instance of CCTotalsByCandidate', function() {
      // uncomment below and update the code to test CCTotalsByCandidate
      //var instance = new OpenFec.CCTotalsByCandidate();
      //expect(instance).to.be.a(OpenFec.CCTotalsByCandidate);
    });
