...
(function(root, factory) {
  ...
  describe('Election', function() {
    it('should create an instance of Election', function() {
      ...
      //var instance = new OpenFec.Election();
      //expect(instance).to.be.a(OpenFec.Election);
    });
    ...
    it('should have the property candidatePccId (base name: "candidate_pcc_id")', function() {
      // uncomment below and update the code to test the property candidatePccId
      //var instance = new OpenFec.Election();
      //expect(instance).to.be();
    });

    it('should have the property candidatePccName (base name: "candidate_pcc_name")', function() {
      // uncomment below and update the code to test the property candidatePccName
      //var instance = new OpenFec.Election();
      //expect(instance).to.be();
    });
    ...
    it('should have the property committeeIds (base name: "committee_ids")', function() {
      // uncomment below and update the code to test the property committeeIds
      //var instance = new OpenFec.Election();
      //expect(instance).to.be();
    });
