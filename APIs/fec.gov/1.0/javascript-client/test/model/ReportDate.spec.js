...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ReportDate();
  });
  ...
  describe('ReportDate', function() {
    it('should create an instance of ReportDate', function() {
      // uncomment below and update the code to test ReportDate
      //var instance = new OpenFec.ReportDate();
      //expect(instance).to.be.a(OpenFec.ReportDate);
    });
