...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CandidateCommitteeTotalsPresidential();
  });
  ...
  describe('CandidateCommitteeTotalsPresidential', function() {
    it('should create an instance of CandidateCommitteeTotalsPresidential', function() {
      // uncomment below and update the code to test CandidateCommitteeTotalsPresidential
      //var instance = new OpenFec.CandidateCommitteeTotalsPresidential();
      //expect(instance).to.be.a(OpenFec.CandidateCommitteeTotalsPresidential);
    });
