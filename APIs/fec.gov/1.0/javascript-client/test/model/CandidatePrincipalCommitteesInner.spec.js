...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CandidatePrincipalCommitteesInner();
  });
  ...
  describe('CandidatePrincipalCommitteesInner', function() {
    it('should create an instance of CandidatePrincipalCommitteesInner', function() {
      // uncomment below and update the code to test CandidatePrincipalCommitteesInner
      //var instance = new OpenFec.CandidatePrincipalCommitteesInner();
      //expect(instance).to.be.a(OpenFec.CandidatePrincipalCommitteesInner);
    });
