...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ECTotalsByCandidate();
  });
  ...
  describe('ECTotalsByCandidate', function() {
    it('should create an instance of ECTotalsByCandidate', function() {
      // uncomment below and update the code to test ECTotalsByCandidate
      //var instance = new OpenFec.ECTotalsByCandidate();
      //expect(instance).to.be.a(OpenFec.ECTotalsByCandidate);
    });
