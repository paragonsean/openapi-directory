...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.OffsetInfo();
  });
  ...
  describe('OffsetInfo', function() {
    it('should create an instance of OffsetInfo', function() {
      // uncomment below and update the code to test OffsetInfo
      //var instance = new OpenFec.OffsetInfo();
      //expect(instance).to.be.a(OpenFec.OffsetInfo);
    });
