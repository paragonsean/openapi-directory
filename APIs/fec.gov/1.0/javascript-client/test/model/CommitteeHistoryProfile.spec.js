...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CommitteeHistoryProfile();
  });
  ...
  describe('CommitteeHistoryProfile', function() {
    it('should create an instance of CommitteeHistoryProfile', function() {
      // uncomment below and update the code to test CommitteeHistoryProfile
      //var instance = new OpenFec.CommitteeHistoryProfile();
      //expect(instance).to.be.a(OpenFec.CommitteeHistoryProfile);
    });
    ...
    it('should have the property committeeLabel (base name: "committee_label")', function() {
      // uncomment below and update the code to test the property committeeLabel
      //var instance = new OpenFec.CommitteeHistoryProfile();
      //expect(instance).to.be();
    });
    ...
    it('should have the property convertToPacFlag (base name: "convert_to_pac_flag")', function() {
      // uncomment below and update the code to test the property convertToPacFlag
      //var instance = new OpenFec.CommitteeHistoryProfile();
      //expect(instance).to.be();
    });
    ...
    it('should have the property formerCandidateElectionYear (base name: "former_candidate_election_year")', function() {
      // uncomment below and update the code to test the property formerCandidateElectionYear
      //var instance = new OpenFec.CommitteeHistoryProfile();
      //expect(instance).to.be();
    });

    it('should have the property formerCandidateId (base name: "former_candidate_id")', function() {
      // uncomment below and update the code to test the property formerCandidateId
      //var instance = new OpenFec.CommitteeHistoryProfile();
      //expect(instance).to.be();
    });

    it('should have the property formerCandidateName (base name: "former_candidate_name")', function() {
      // uncomment below and update the code to test the property formerCandidateName
      //var instance = new OpenFec.CommitteeHistoryProfile();
      //expect(instance).to.be();
    });

    it('should have the property formerCommitteeName (base name: "former_committee_name")', function() {
      // uncomment below and update the code to test the property formerCommitteeName
      //var instance = new OpenFec.CommitteeHistoryProfile();
      //expect(instance).to.be();
    });
