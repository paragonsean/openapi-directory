...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.EfilingsAmendments();
  });
  ...
  describe('EfilingsAmendments', function() {
    it('should create an instance of EfilingsAmendments', function() {
      // uncomment below and update the code to test EfilingsAmendments
      //var instance = new OpenFec.EfilingsAmendments();
      //expect(instance).to.be.a(OpenFec.EfilingsAmendments);
    });
    ...
    it('should have the property longestChain (base name: "longest_chain")', function() {
      // uncomment below and update the code to test the property longestChain
      //var instance = new OpenFec.EfilingsAmendments();
      //expect(instance).to.be();
    });
