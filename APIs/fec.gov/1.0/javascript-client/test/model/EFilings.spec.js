...
(function(root, factory) {
  ...
  describe('EFilings', function() {
    it('should create an instance of EFilings', function() {
      // uncomment below and update the code to test EFilings
      //var instance = new OpenFec.EFilings();
      //expect(instance).to.be.a(OpenFec.EFilings);
    });
    ...
    it('should have the property amendsFile (base name: "amends_file")', function() {
      // uncomment below and update the code to test the property amendsFile
      //var instance = new OpenFec.EFilings();
      //expect(instance).to.be();
    });
    ...
    it('should have the property filedDate (base name: "filed_date")', function() {
