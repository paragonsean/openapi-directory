...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CommitteeTotalsIEOnly();
  });
  ...
  describe('CommitteeTotalsIEOnly', function() {
    it('should create an instance of CommitteeTotalsIEOnly', function() {
      // uncomment below and update the code to test CommitteeTotalsIEOnly
      //var instance = new OpenFec.CommitteeTotalsIEOnly();
      //expect(instance).to.be.a(OpenFec.CommitteeTotalsIEOnly);
    });
