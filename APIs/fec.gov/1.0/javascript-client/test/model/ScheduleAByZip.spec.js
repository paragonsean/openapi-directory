...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ScheduleAByZip();
  });
  ...
  describe('ScheduleAByZip', function() {
    it('should create an instance of ScheduleAByZip', function() {
      // uncomment below and update the code to test ScheduleAByZip
      //var instance = new OpenFec.ScheduleAByZip();
      //expect(instance).to.be.a(OpenFec.ScheduleAByZip);
    });
