...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.TotalByOfficeByParty();
  });
  ...
  describe('TotalByOfficeByParty', function() {
    it('should create an instance of TotalByOfficeByParty', function() {
      // uncomment below and update the code to test TotalByOfficeByParty
      //var instance = new OpenFec.TotalByOfficeByParty();
      //expect(instance).to.be.a(OpenFec.TotalByOfficeByParty);
    });
