...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CandidateFlags();
  });
  ...
  describe('CandidateFlags', function() {
    it('should create an instance of CandidateFlags', function() {
      // uncomment below and update the code to test CandidateFlags
      //var instance = new OpenFec.CandidateFlags();
      //expect(instance).to.be.a(OpenFec.CandidateFlags);
    });
