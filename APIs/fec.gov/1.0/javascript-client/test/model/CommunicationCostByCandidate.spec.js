...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CommunicationCostByCandidate();
  });
  ...
  describe('CommunicationCostByCandidate', function() {
    it('should create an instance of CommunicationCostByCandidate', function() {
      // uncomment below and update the code to test CommunicationCostByCandidate
      //var instance = new OpenFec.CommunicationCostByCandidate();
      //expect(instance).to.be.a(OpenFec.CommunicationCostByCandidate);
    });
