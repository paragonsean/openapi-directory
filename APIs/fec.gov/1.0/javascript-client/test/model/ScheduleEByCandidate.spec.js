...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ScheduleEByCandidate();
  });
  ...
  describe('ScheduleEByCandidate', function() {
    it('should create an instance of ScheduleEByCandidate', function() {
      // uncomment below and update the code to test ScheduleEByCandidate
      //var instance = new OpenFec.ScheduleEByCandidate();
      //expect(instance).to.be.a(OpenFec.ScheduleEByCandidate);
    });
