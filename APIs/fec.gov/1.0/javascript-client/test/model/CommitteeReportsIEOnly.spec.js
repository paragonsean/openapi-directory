...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CommitteeReportsIEOnly();
  });
  ...
  describe('CommitteeReportsIEOnly', function() {
    it('should create an instance of CommitteeReportsIEOnly', function() {
      // uncomment below and update the code to test CommitteeReportsIEOnly
      //var instance = new OpenFec.CommitteeReportsIEOnly();
      //expect(instance).to.be.a(OpenFec.CommitteeReportsIEOnly);
    });
