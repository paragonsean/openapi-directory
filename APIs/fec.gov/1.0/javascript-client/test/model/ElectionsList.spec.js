...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ElectionsList();
  });
  ...
  describe('ElectionsList', function() {
    it('should create an instance of ElectionsList', function() {
      // uncomment below and update the code to test ElectionsList
      //var instance = new OpenFec.ElectionsList();
      //expect(instance).to.be.a(OpenFec.ElectionsList);
    });
