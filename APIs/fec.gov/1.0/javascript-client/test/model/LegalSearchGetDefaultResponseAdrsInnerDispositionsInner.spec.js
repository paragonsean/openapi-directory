...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.LegalSearchGetDefaultResponseAdrsInnerDispositionsInner();
  });
  ...
  describe('LegalSearchGetDefaultResponseAdrsInnerDispositionsInner', function() {
    it('should create an instance of LegalSearchGetDefaultResponseAdrsInnerDispositionsInner', function() {
      // uncomment below and update the code to test LegalSearchGetDefaultResponseAdrsInnerDispositionsInner
      //var instance = new OpenFec.LegalSearchGetDefaultResponseAdrsInnerDispositionsInner();
      //expect(instance).to.be.a(OpenFec.LegalSearchGetDefaultResponseAdrsInnerDispositionsInner);
    });
