...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.PresidentialByCandidate();
  });
  ...
  describe('PresidentialByCandidate', function() {
    it('should create an instance of PresidentialByCandidate', function() {
      // uncomment below and update the code to test PresidentialByCandidate
      //var instance = new OpenFec.PresidentialByCandidate();
      //expect(instance).to.be.a(OpenFec.PresidentialByCandidate);
    });
