...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.CandidateHistory();
  });
  ...
  describe('CandidateHistory', function() {
    it('should create an instance of CandidateHistory', function() {
      // uncomment below and update the code to test CandidateHistory
      //var instance = new OpenFec.CandidateHistory();
      //expect(instance).to.be.a(OpenFec.CandidateHistory);
    });
