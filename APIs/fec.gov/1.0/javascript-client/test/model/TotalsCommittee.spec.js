...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.TotalsCommittee();
  });
  ...
  describe('TotalsCommittee', function() {
    it('should create an instance of TotalsCommittee', function() {
      // uncomment below and update the code to test TotalsCommittee
      //var instance = new OpenFec.TotalsCommittee();
      //expect(instance).to.be.a(OpenFec.TotalsCommittee);
    });
