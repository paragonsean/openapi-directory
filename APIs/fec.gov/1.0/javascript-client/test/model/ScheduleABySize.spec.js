...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ScheduleABySize();
  });
  ...
  describe('ScheduleABySize', function() {
    it('should create an instance of ScheduleABySize', function() {
      // uncomment below and update the code to test ScheduleABySize
      //var instance = new OpenFec.ScheduleABySize();
      //expect(instance).to.be.a(OpenFec.ScheduleABySize);
    });
