...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.Electioneering();
  });
  ...
  describe('Electioneering', function() {
    it('should create an instance of Electioneering', function() {
      // uncomment below and update the code to test Electioneering
      //var instance = new OpenFec.Electioneering();
      //expect(instance).to.be.a(OpenFec.Electioneering);
    });
    ...
    it('should have the property calculatedCandidateShare (base name: "calculated_candidate_share")', function() {
      // uncomment below and update the code to test the property calculatedCandidateShare
      //var instance = new OpenFec.Electioneering();
      //expect(instance).to.be();
    });

    it('should have the property candidateDistrict (base name: "candidate_district")', function() {
      // uncomment below and update the code to test the property candidateDistrict
      //var instance = new OpenFec.Electioneering();
      //expect(instance).to.be();
    });
    ...
    it('should have the property candidateState (base name: "candidate_state")', function() {
      // uncomment below and update the code to test the property candidateState
      //var instance = new OpenFec.Electioneering();
      //expect(instance).to.be();
    });
    ...
    it('should have the property communicationDate (base name: "communication_date")', function() {
      // uncomment below and update the code to test the property communicationDate
      //var instance = new OpenFec.Electioneering();
      //expect(instance).to.be();
    });
    ...
    it('should have the property numberOfCandidates (base name: "number_of_candidates")', function() {
      // uncomment below and update the code to test the property numberOfCandidates
      //var instance = new OpenFec.Electioneering();
      //expect(instance).to.be();
    });
    ...
    it('should have the property publicDistributionDate (base name: "public_distribution_date")', function() {
      // uncomment below and update the code to test the property publicDistributionDate
      //var instance = new OpenFec.Electioneering();
      //expect(instance).to.be();
    });

    it('should have the property purposeDescription (base name: "purpose_description")', function() {
      // uncomment below and update the code to test the property purposeDescription
      //var instance = new OpenFec.Electioneering();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sbImageNum (base name: "sb_image_num")', function() {
      // uncomment below and update the code to test the property sbImageNum
      //var instance = new OpenFec.Electioneering();
      //expect(instance).to.be();
    });

    it('should have the property sbLinkId (base name: "sb_link_id")', function() {
      // uncomment below and update the code to test the property sbLinkId
      //var instance = new OpenFec.Electioneering();
      //expect(instance).to.be();
    });
