...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.Committee();
  });
  ...
  describe('Committee', function() {
    it('should create an instance of Committee', function() {
      // uncomment below and update the code to test Committee
      //var instance = new OpenFec.Committee();
      //expect(instance).to.be.a(OpenFec.Committee);
    });
    ...
    it('should have the property sponsorCandidateIds (base name: "sponsor_candidate_ids")', function() {
      // uncomment below and update the code to test the property sponsorCandidateIds
      //var instance = new OpenFec.Committee();
      //expect(instance).to.be();
    });

    it('should have the property sponsorCandidateList (base name: "sponsor_candidate_list")', function() {
      // uncomment below and update the code to test the property sponsorCandidateList
      //var instance = new OpenFec.Committee();
      //expect(instance).to.be();
    });
