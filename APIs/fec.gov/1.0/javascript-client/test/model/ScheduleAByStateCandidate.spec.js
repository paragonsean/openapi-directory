...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ScheduleAByStateCandidate();
  });
  ...
  describe('ScheduleAByStateCandidate', function() {
    it('should create an instance of ScheduleAByStateCandidate', function() {
      // uncomment below and update the code to test ScheduleAByStateCandidate
      //var instance = new OpenFec.ScheduleAByStateCandidate();
      //expect(instance).to.be.a(OpenFec.ScheduleAByStateCandidate);
    });
