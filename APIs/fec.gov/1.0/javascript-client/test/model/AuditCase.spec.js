...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.AuditCase();
  });
  ...
  describe('AuditCase', function() {
    it('should create an instance of AuditCase', function() {
      // uncomment below and update the code to test AuditCase
      //var instance = new OpenFec.AuditCase();
      //expect(instance).to.be.a(OpenFec.AuditCase);
    });

    it('should have the property auditCaseId (base name: "audit_case_id")', function() {
      // uncomment below and update the code to test the property auditCaseId
      //var instance = new OpenFec.AuditCase();
      //expect(instance).to.be();
    });

    it('should have the property auditId (base name: "audit_id")', function() {
    ...
    it('should have the property committeeDescription (base name: "committee_description")', function() {
      // uncomment below and update the code to test the property committeeDescription
      //var instance = new OpenFec.AuditCase();
      //expect(instance).to.be();
    });
    ...
    it('should have the property farReleaseDate (base name: "far_release_date")', function() {
      // uncomment below and update the code to test the property farReleaseDate
      //var instance = new OpenFec.AuditCase();
      //expect(instance).to.be();
    });

    it('should have the property linkToReport (base name: "link_to_report")', function() {
      // uncomment below and update the code to test the property linkToReport
      //var instance = new OpenFec.AuditCase();
      //expect(instance).to.be();
    });

    it('should have the property primaryCategoryList (base name: "primary_category_list")', function() {
      // uncomment below and update the code to test the property primaryCategoryList
      //var instance = new OpenFec.AuditCase();
      //expect(instance).to.be();
    });
