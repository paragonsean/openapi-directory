...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ScheduleAByState();
  });
  ...
  describe('ScheduleAByState', function() {
    it('should create an instance of ScheduleAByState', function() {
      // uncomment below and update the code to test ScheduleAByState
      //var instance = new OpenFec.ScheduleAByState();
      //expect(instance).to.be.a(OpenFec.ScheduleAByState);
    });
