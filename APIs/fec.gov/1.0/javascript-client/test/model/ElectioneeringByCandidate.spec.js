...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFec.ElectioneeringByCandidate();
  });
  ...
  describe('ElectioneeringByCandidate', function() {
    it('should create an instance of ElectioneeringByCandidate', function() {
      // uncomment below and update the code to test ElectioneeringByCandidate
      //var instance = new OpenFec.ElectioneeringByCandidate();
      //expect(instance).to.be.a(OpenFec.ElectioneeringByCandidate);
    });
