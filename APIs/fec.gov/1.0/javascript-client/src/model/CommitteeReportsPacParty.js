...
/**
 * The CommitteeReportsPacParty model module.
 * @module model/CommitteeReportsPacParty
 * @version 1.0
 */
class CommitteeReportsPacParty {
    /**
     * Constructs a new <code>CommitteeReportsPacParty</code>.
     * @alias module:model/CommitteeReportsPacParty
     */
    constructor() { 
        
        CommitteeReportsPacParty.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CommitteeReportsPacParty</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommitteeReportsPacParty} obj Optional instance to populate.
     * @return {module:model/CommitteeReportsPacParty} The populated <code>CommitteeReportsPacParty</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommitteeReportsPacParty();
    ...
    /**
     * Validates the JSON data with respect to <code>CommitteeReportsPacParty</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommitteeReportsPacParty</code>.
     */
 ...
 */
CommitteeReportsPacParty.prototype['all_loans_received_period'] = undefined;

/**
 * @member {Number} all_loans_received_ytd
 */
CommitteeReportsPacParty.prototype['all_loans_received_ytd'] = undefined;

/**
 * @member {Number} allocated_federal_election_levin_share_period
 */
CommitteeReportsPacParty.prototype['allocated_federal_election_levin_share_period'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['amendment_chain'] = undefined;

/**
 * @member {String} amendment_indicator
 */
CommitteeReportsPacParty.prototype['amendment_indicator'] = undefined;

/**
 * @member {String} amendment_indicator_full
 */
CommitteeReportsPacParty.prototype['amendment_indicator_full'] = undefined;

/**
 * @member {String} beginning_image_number
 */
CommitteeReportsPacParty.prototype['beginning_image_number'] = undefined;

/**
 * @member {Number} calendar_ytd
 */
CommitteeReportsPacParty.prototype['calendar_ytd'] = undefined;

/**
 * @member {Number} cash_on_hand_beginning_calendar_ytd
 */
CommitteeReportsPacParty.prototype['cash_on_hand_beginning_calendar_ytd'] = undefined;

/**
 * Balance for the committee at the start of the two-year period
 * @member {Number} cash_on_hand_beginning_period
 */
CommitteeReportsPacParty.prototype['cash_on_hand_beginning_period'] = undefined;

/**
 * @member {Number} cash_on_hand_close_ytd
 */
CommitteeReportsPacParty.prototype['cash_on_hand_close_ytd'] = undefined;

/**
 * Ending cash balance on the most recent filing
 * @member {Number} cash_on_hand_end_period
 */
CommitteeReportsPacParty.prototype['cash_on_hand_end_period'] = undefined;

/**
 *  A unique identifier assigned to each committee or filer registered with the FEC. In general committee id's begin with the letter C which is followed by eight digits. 
 * @member {String} committee_id
 */
CommitteeReportsPacParty.prototype['committee_id'] = undefined;

/**
 * The name of the committee. If a committee changes its name,     the most recent name will be shown. Committee names are not unique. Use committee_id     for looking up records.
 * @member {String} committee_name
 */
CommitteeReportsPacParty.prototype['committee_name'] = undefined;

/**
 * @member {String} committee_type
 */
CommitteeReportsPacParty.prototype['committee_type'] = undefined;

/**
 * @member {Number} coordinated_expenditures_by_party_committee_period
 */
CommitteeReportsPacParty.prototype['coordinated_expenditures_by_party_committee_period'] = undefined;

/**
 * @member {Number} coordinated_expenditures_by_party_committee_ytd
 */
CommitteeReportsPacParty.prototype['coordinated_expenditures_by_party_committee_ytd'] = undefined;

/**
 * Ending date of the reporting period
 * @member {Date} coverage_end_date
 */
CommitteeReportsPacParty.prototype['coverage_end_date'] = undefined;

/**
 * Beginning date of the reporting period
 * @member {Date} coverage_start_date
 */
CommitteeReportsPacParty.prototype['coverage_start_date'] = undefined;

/**
 * @member {String} csv_url
 */
CommitteeReportsPacParty.prototype['csv_url'] = undefined;
 ...
 * @member {Number} cycle
 */
CommitteeReportsPacParty.prototype['cycle'] = undefined;

/**
 * Debts owed by the committee
 * @member {Number} debts_owed_by_committee
 */
CommitteeReportsPacParty.prototype['debts_owed_by_committee'] = undefined;

/**
 * Debts owed to the committee
 * @member {Number} debts_owed_to_committee
 */
CommitteeReportsPacParty.prototype['debts_owed_to_committee'] = undefined;

/**
 * @member {String} document_description
 */
CommitteeReportsPacParty.prototype['document_description'] = undefined;

/**
 * @member {String} end_image_number
 */
CommitteeReportsPacParty.prototype['end_image_number'] = undefined;

/**
 * @member {String} fec_file_id
 */
CommitteeReportsPacParty.prototype['fec_file_id'] = undefined;

/**
 * @member {String} fec_url
 */
CommitteeReportsPacParty.prototype['fec_url'] = undefined;

/**
 * @member {Number} fed_candidate_committee_contribution_refunds_ytd
 */
CommitteeReportsPacParty.prototype['fed_candidate_committee_contribution_refunds_ytd'] = undefined;

/**
 * @member {Number} fed_candidate_committee_contributions_period
 */
CommitteeReportsPacParty.prototype['fed_candidate_committee_contributions_period'] = undefined;

/**
 * @member {Number} fed_candidate_committee_contributions_ytd
 */
CommitteeReportsPacParty.prototype['fed_candidate_committee_contributions_ytd'] = undefined;

/**
 * @member {Number} fed_candidate_contribution_refunds_period
 */
CommitteeReportsPacParty.prototype['fed_candidate_contribution_refunds_period'] = undefined;

/**
 * @member {Number} file_number
 */
CommitteeReportsPacParty.prototype['file_number'] = undefined;

/**
 *  HTML link to the filing. 
 * @member {String} html_url
 */
CommitteeReportsPacParty.prototype['html_url'] = undefined;

/**
 * @member {Number} independent_expenditures_period
 */
CommitteeReportsPacParty.prototype['independent_expenditures_period'] = undefined;

/**
 * @member {Number} independent_expenditures_ytd
 */
CommitteeReportsPacParty.prototype['independent_expenditures_ytd'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['individual_itemized_contributions_period'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['individual_itemized_contributions_ytd'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['individual_unitemized_contributions_period'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['individual_unitemized_contributions_ytd'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['is_amended'] = undefined;

/**
 * @member {Number} loan_repayments_made_period
 */
CommitteeReportsPacParty.prototype['loan_repayments_made_period'] = undefined;

/**
 * @member {Number} loan_repayments_made_ytd
 */
CommitteeReportsPacParty.prototype['loan_repayments_made_ytd'] = undefined;

/**
 * @member {Number} loan_repayments_received_period
 */
CommitteeReportsPacParty.prototype['loan_repayments_received_period'] = undefined;

/**
 * @member {Number} loan_repayments_received_ytd
 */
CommitteeReportsPacParty.prototype['loan_repayments_received_ytd'] = undefined;

/**
 * @member {Number} loans_made_period
 */
CommitteeReportsPacParty.prototype['loans_made_period'] = undefined;

/**
 * @member {Number} loans_made_ytd
 */
CommitteeReportsPacParty.prototype['loans_made_ytd'] = undefined;

/**
 * The method used to file with the FEC, either electronic or on paper.
 * @member {String} means_filed
 */
CommitteeReportsPacParty.prototype['means_filed'] = undefined;

/**
 *  Report is either new or is the most-recently filed amendment 
 * @member {Boolean} most_recent
 */
CommitteeReportsPacParty.prototype['most_recent'] = undefined;

/**
 * @member {Number} most_recent_file_number
 */
CommitteeReportsPacParty.prototype['most_recent_file_number'] = undefined;

/**
 * @member {Number} net_contributions_period
 */
CommitteeReportsPacParty.prototype['net_contributions_period'] = undefined;

/**
 * @member {Number} net_contributions_ytd
 */
CommitteeReportsPacParty.prototype['net_contributions_ytd'] = undefined;

/**
 * @member {Number} net_operating_expenditures_period
 */
CommitteeReportsPacParty.prototype['net_operating_expenditures_period'] = undefined;

/**
 * @member {Number} net_operating_expenditures_ytd
 */
CommitteeReportsPacParty.prototype['net_operating_expenditures_ytd'] = undefined;

/**
 * @member {Number} non_allocated_fed_election_activity_period
 */
CommitteeReportsPacParty.prototype['non_allocated_fed_election_activity_period'] = undefined;

/**
 * @member {Number} non_allocated_fed_election_activity_ytd
 */
CommitteeReportsPacParty.prototype['non_allocated_fed_election_activity_ytd'] = undefined;

/**
 * @member {Number} nonfed_share_allocated_disbursements_period
 */
CommitteeReportsPacParty.prototype['nonfed_share_allocated_disbursements_period'] = undefined;

/**
 * Offsets to operating expenditures total for the reporting period
 * @member {Number} offsets_to_operating_expenditures_period
 */
CommitteeReportsPacParty.prototype['offsets_to_operating_expenditures_period'] = undefined;

/**
 * Offsets to operating expenditures total for the year to date
 * @member {Number} offsets_to_operating_expenditures_ytd
 */
CommitteeReportsPacParty.prototype['offsets_to_operating_expenditures_ytd'] = undefined;

/**
 * Other disbursements total for the reporting period
 * @member {Number} other_disbursements_period
 */
CommitteeReportsPacParty.prototype['other_disbursements_period'] = undefined;

/**
 * Other disbursements total for the year to date
 * @member {Number} other_disbursements_ytd
 */
CommitteeReportsPacParty.prototype['other_disbursements_ytd'] = undefined;

/**
 * @member {Number} other_fed_operating_expenditures_period
 */
CommitteeReportsPacParty.prototype['other_fed_operating_expenditures_period'] = undefined;

/**
 * @member {Number} other_fed_operating_expenditures_ytd
 */
CommitteeReportsPacParty.prototype['other_fed_operating_expenditures_ytd'] = undefined;

/**
 * @member {Number} other_fed_receipts_period
 */
CommitteeReportsPacParty.prototype['other_fed_receipts_period'] = undefined;

/**
 * @member {Number} other_fed_receipts_ytd
 */
CommitteeReportsPacParty.prototype['other_fed_receipts_ytd'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['other_political_committee_contributions_period'] = undefined;

/**
 * Other committees contributions total for the year to date
 * @member {Number} other_political_committee_contributions_ytd
 */
CommitteeReportsPacParty.prototype['other_political_committee_contributions_ytd'] = undefined;

/**
 * @member {String} pdf_url
 */
CommitteeReportsPacParty.prototype['pdf_url'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['political_party_committee_contributions_period'] = undefined;

/**
 * Party committees contributions total for the year to date
 * @member {Number} political_party_committee_contributions_ytd
 */
CommitteeReportsPacParty.prototype['political_party_committee_contributions_ytd'] = undefined;

/**
 * @member {Number} previous_file_number
 */
CommitteeReportsPacParty.prototype['previous_file_number'] = undefined;

/**
 * Date the FEC received the electronic or paper record
 * @member {Date} receipt_date
 */
CommitteeReportsPacParty.prototype['receipt_date'] = undefined;

/**
 * Individual refunds total for the reporting period
 * @member {Number} refunded_individual_contributions_period
 */
CommitteeReportsPacParty.prototype['refunded_individual_contributions_period'] = undefined;

/**
 * Individual refunds total for the year to date
 * @member {Number} refunded_individual_contributions_ytd
 */
CommitteeReportsPacParty.prototype['refunded_individual_contributions_ytd'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['refunded_other_political_committee_contributions_period'] = undefined;

/**
 * Other committee refunds total for the year to date
 * @member {Number} refunded_other_political_committee_contributions_ytd
 */
CommitteeReportsPacParty.prototype['refunded_other_political_committee_contributions_ytd'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['refunded_political_party_committee_contributions_period'] = undefined;

/**
 * Political party refunds total for the year to date
 * @member {Number} refunded_political_party_committee_contributions_ytd
 */
CommitteeReportsPacParty.prototype['refunded_political_party_committee_contributions_ytd'] = undefined;

/**
 * @member {String} report_form
 */
CommitteeReportsPacParty.prototype['report_form'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['report_type'] = undefined;

/**
 * Name of report where the underlying data comes from:     - 10D Pre-Election     - 10G Pre-General     - 10P Pre-Primary     - 10R Pre-Run-Off     - 10S Pre-Special     - 12C Pre-Convention     - 12G Pre-General     - 12P Pre-Primary     - 12R Pre-Run-Off     - 12S Pre-Special     - 30D Post-Election     - 30G Post-General     - 30P Post-Primary     - 30R Post-Run-Off     - 30S Post-Special     - 60D Post-Convention     - M1  January Monthly     - M10 October Monthly     - M11 November Monthly     - M12 December Monthly     - M2  February Monthly     - M3  March Monthly     - M4  April Monthly     - M5  May Monthly     - M6  June Monthly     - M7  July Monthly     - M8  August Monthly     - M9  September Monthly     - MY  Mid-Year Report     - Q1  April Quarterly     - Q2  July Quarterly     - Q3  October Quarterly     - TER Termination Report     - YE  Year-End     - ADJ COMP ADJUST AMEND     - CA  COMPREHENSIVE AMEND     - 90S Post Inaugural Supplement     - 90D Post Inaugural     - 48  48 Hour Notification     - 24  24 Hour Notification     - M7S July Monthly/Semi-Annual     - MSA Monthly Semi-Annual (MY)     - MYS Monthly Year End/Semi-Annual     - Q2S July Quarterly/Semi-Annual     - QSA Quarterly Semi-Annual (MY)     - QYS Quarterly Year End/Semi-Annual     - QYE Quarterly Semi-Annual (YE)     - QMS Quarterly Mid-Year/ Semi-Annual     - MSY Monthly Semi-Annual (YE) 
 * @member {String} report_type_full
 */
CommitteeReportsPacParty.prototype['report_type_full'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['report_year'] = undefined;

/**
 * @member {Number} shared_fed_activity_nonfed_ytd
 */
CommitteeReportsPacParty.prototype['shared_fed_activity_nonfed_ytd'] = undefined;

/**
 * @member {Number} shared_fed_activity_period
 */
CommitteeReportsPacParty.prototype['shared_fed_activity_period'] = undefined;

/**
 * @member {Number} shared_fed_activity_ytd
 */
CommitteeReportsPacParty.prototype['shared_fed_activity_ytd'] = undefined;

/**
 * @member {Number} shared_fed_operating_expenditures_period
 */
CommitteeReportsPacParty.prototype['shared_fed_operating_expenditures_period'] = undefined;

/**
 * @member {Number} shared_fed_operating_expenditures_ytd
 */
CommitteeReportsPacParty.prototype['shared_fed_operating_expenditures_ytd'] = undefined;

/**
 * @member {Number} shared_nonfed_operating_expenditures_period
 */
CommitteeReportsPacParty.prototype['shared_nonfed_operating_expenditures_period'] = undefined;

/**
 * @member {Number} shared_nonfed_operating_expenditures_ytd
 */
CommitteeReportsPacParty.prototype['shared_nonfed_operating_expenditures_ytd'] = undefined;

/**
 * @member {Number} subtotal_summary_page_period
 */
CommitteeReportsPacParty.prototype['subtotal_summary_page_period'] = undefined;

/**
 * @member {Number} subtotal_summary_ytd
 */
CommitteeReportsPacParty.prototype['subtotal_summary_ytd'] = undefined;

/**
 * Total contribution refunds total for the reporting period
 * @member {Number} total_contribution_refunds_period
 */
CommitteeReportsPacParty.prototype['total_contribution_refunds_period'] = undefined;

/**
 * Total contribution refunds total for the year to date
 * @member {Number} total_contribution_refunds_ytd
 */
CommitteeReportsPacParty.prototype['total_contribution_refunds_ytd'] = undefined;

/**
 * Contribution total for the reporting period
 * @member {Number} total_contributions_period
 */
CommitteeReportsPacParty.prototype['total_contributions_period'] = undefined;

/**
 * Contribution total for the year to date
 * @member {Number} total_contributions_ytd
 */
CommitteeReportsPacParty.prototype['total_contributions_ytd'] = undefined;

/**
 * Disbursements total for the reporting period
 * @member {Number} total_disbursements_period
 */
CommitteeReportsPacParty.prototype['total_disbursements_period'] = undefined;

/**
 * Disbursements total for the year to date
 * @member {Number} total_disbursements_ytd
 */
CommitteeReportsPacParty.prototype['total_disbursements_ytd'] = undefined;

/**
 * @member {Number} total_fed_disbursements_period
 */
CommitteeReportsPacParty.prototype['total_fed_disbursements_period'] = undefined;

/**
 * @member {Number} total_fed_disbursements_ytd
 */
CommitteeReportsPacParty.prototype['total_fed_disbursements_ytd'] = undefined;

/**
 * @member {Number} total_fed_election_activity_period
 */
CommitteeReportsPacParty.prototype['total_fed_election_activity_period'] = undefined;

/**
 * @member {Number} total_fed_election_activity_ytd
 */
CommitteeReportsPacParty.prototype['total_fed_election_activity_ytd'] = undefined;

/**
 * @member {Number} total_fed_operating_expenditures_period
 */
CommitteeReportsPacParty.prototype['total_fed_operating_expenditures_period'] = undefined;

/**
 * @member {Number} total_fed_operating_expenditures_ytd
 */
CommitteeReportsPacParty.prototype['total_fed_operating_expenditures_ytd'] = undefined;

/**
 * @member {Number} total_fed_receipts_period
 */
CommitteeReportsPacParty.prototype['total_fed_receipts_period'] = undefined;

/**
 * @member {Number} total_fed_receipts_ytd
 */
CommitteeReportsPacParty.prototype['total_fed_receipts_ytd'] = undefined;

/**
 * Individual contributions total for the reporting period
 * @member {Number} total_individual_contributions_period
 */
CommitteeReportsPacParty.prototype['total_individual_contributions_period'] = undefined;

/**
 * Individual contributions total for the year to date
 * @member {Number} total_individual_contributions_ytd
 */
CommitteeReportsPacParty.prototype['total_individual_contributions_ytd'] = undefined;

/**
 * @member {Number} total_nonfed_transfers_period
 */
CommitteeReportsPacParty.prototype['total_nonfed_transfers_period'] = undefined;

/**
 * @member {Number} total_nonfed_transfers_ytd
 */
CommitteeReportsPacParty.prototype['total_nonfed_transfers_ytd'] = undefined;

/**
 * @member {Number} total_operating_expenditures_period
 */
CommitteeReportsPacParty.prototype['total_operating_expenditures_period'] = undefined;

/**
 * @member {Number} total_operating_expenditures_ytd
 */
CommitteeReportsPacParty.prototype['total_operating_expenditures_ytd'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['total_receipts_period'] = undefined;
 ...
 */
CommitteeReportsPacParty.prototype['total_receipts_ytd'] = undefined;

/**
 * @member {Number} transfers_from_affiliated_party_period
 */
CommitteeReportsPacParty.prototype['transfers_from_affiliated_party_period'] = undefined;

/**
 * @member {Number} transfers_from_affiliated_party_ytd
 */
CommitteeReportsPacParty.prototype['transfers_from_affiliated_party_ytd'] = undefined;

/**
 * @member {Number} transfers_from_nonfed_account_period
 */
CommitteeReportsPacParty.prototype['transfers_from_nonfed_account_period'] = undefined;

/**
 * @member {Number} transfers_from_nonfed_account_ytd
 */
CommitteeReportsPacParty.prototype['transfers_from_nonfed_account_ytd'] = undefined;

/**
 * @member {Number} transfers_from_nonfed_levin_period
 */
CommitteeReportsPacParty.prototype['transfers_from_nonfed_levin_period'] = undefined;

/**
 * @member {Number} transfers_from_nonfed_levin_ytd
 */
CommitteeReportsPacParty.prototype['transfers_from_nonfed_levin_ytd'] = undefined;

/**
 * @member {Number} transfers_to_affiliated_committee_period
 */
CommitteeReportsPacParty.prototype['transfers_to_affiliated_committee_period'] = undefined;

/**
 * @member {Number} transfers_to_affilitated_committees_ytd
 */
CommitteeReportsPacParty.prototype['transfers_to_affilitated_committees_ytd'] = undefined;
...
export default CommitteeReportsPacParty;
