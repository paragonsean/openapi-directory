...
/**
 * The ScheduleAByEmployer model module.
 * @module model/ScheduleAByEmployer
 * @version 1.0
 */
class ScheduleAByEmployer {
    /**
     * Constructs a new <code>ScheduleAByEmployer</code>.
     * @alias module:model/ScheduleAByEmployer
     ...
     * @param employer {String} Employer of contributor as reported on the committee's filing
     */
    constructor(committeeId, cycle, employer) { 
        
        ScheduleAByEmployer.initialize(this, committeeId, cycle, employer);
    }
     ...
     */
    static initialize(obj, committeeId, cycle, employer) { 
    ...
    /**
     * Constructs a <code>ScheduleAByEmployer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduleAByEmployer} obj Optional instance to populate.
     * @return {module:model/ScheduleAByEmployer} The populated <code>ScheduleAByEmployer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduleAByEmployer();
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduleAByEmployer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleAByEmployer</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScheduleAByEmployer.RequiredProperties) {
...
ScheduleAByEmployer.RequiredProperties = ["committee_id", "cycle", "employer"];

/**
 *  A unique identifier assigned to each committee or filer registered with the FEC. In general committee id's begin with the letter C which is followed by eight digits. 
 * @member {String} committee_id
 */
ScheduleAByEmployer.prototype['committee_id'] = undefined;

/**
 *  Number of records making up the total. 
 * @member {Number} count
 */
ScheduleAByEmployer.prototype['count'] = undefined;
 ...
 * @member {Number} cycle
 */
ScheduleAByEmployer.prototype['cycle'] = undefined;

/**
 * Employer of contributor as reported on the committee's filing
 * @member {String} employer
 */
ScheduleAByEmployer.prototype['employer'] = undefined;

/**
 * Sum of transactions
 * @member {Number} total
 */
ScheduleAByEmployer.prototype['total'] = undefined;
...
export default ScheduleAByEmployer;
