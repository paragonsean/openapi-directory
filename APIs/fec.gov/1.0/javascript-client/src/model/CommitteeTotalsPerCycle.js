...
/**
 * The CommitteeTotalsPerCycle model module.
 * @module model/CommitteeTotalsPerCycle
 * @version 1.0
 */
class CommitteeTotalsPerCycle {
    /**
     * Constructs a new <code>CommitteeTotalsPerCycle</code>.
     * @alias module:model/CommitteeTotalsPerCycle
    ...
    constructor(cycle) { 
        ...
        CommitteeTotalsPerCycle.initialize(this, cycle);
    }
    ...
    /**
     * Constructs a <code>CommitteeTotalsPerCycle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommitteeTotalsPerCycle} obj Optional instance to populate.
     * @return {module:model/CommitteeTotalsPerCycle} The populated <code>CommitteeTotalsPerCycle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommitteeTotalsPerCycle();
    ...
    /**
     * Validates the JSON data with respect to <code>CommitteeTotalsPerCycle</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommitteeTotalsPerCycle</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CommitteeTotalsPerCycle.RequiredProperties) {
...
CommitteeTotalsPerCycle.RequiredProperties = ["cycle"];

/**
 * @member {Number} candidate_contribution
 */
CommitteeTotalsPerCycle.prototype['candidate_contribution'] = undefined;

/**
 * @member {Number} cash_on_hand_beginning_period
 */
CommitteeTotalsPerCycle.prototype['cash_on_hand_beginning_period'] = undefined;
 ...
 */
CommitteeTotalsPerCycle.prototype['committee_designation'] = undefined;

/**
 * The one-letter designation code of the organization:          - A authorized by a candidate          - J joint fundraising committee          - P principal campaign committee of a candidate          - U unauthorized          - B lobbyist/registrant PAC          - D leadership PAC 
 * @member {String} committee_designation_full
 */
CommitteeTotalsPerCycle.prototype['committee_designation_full'] = undefined;

/**
 *  A unique identifier assigned to each committee or filer registered with the FEC. In general committee id's begin with the letter C which is followed by eight digits. 
 * @member {String} committee_id
 */
CommitteeTotalsPerCycle.prototype['committee_id'] = undefined;

/**
 * The name of the committee. If a committee changes its name,     the most recent name will be shown. Committee names are not unique. Use committee_id     for looking up records.
 * @member {String} committee_name
 */
CommitteeTotalsPerCycle.prototype['committee_name'] = undefined;

/**
 *  State of the committee's address as filed on the Form 1 
 * @member {String} committee_state
 */
CommitteeTotalsPerCycle.prototype['committee_state'] = undefined;

/**
 * The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account 
 * @member {String} committee_type
 */
CommitteeTotalsPerCycle.prototype['committee_type'] = undefined;

/**
 * The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account 
 * @member {String} committee_type_full
 */
CommitteeTotalsPerCycle.prototype['committee_type_full'] = undefined;

/**
 * @member {Number} contribution_refunds
 */
CommitteeTotalsPerCycle.prototype['contribution_refunds'] = undefined;

/**
 * Contribution
 * @member {Number} contributions
 */
CommitteeTotalsPerCycle.prototype['contributions'] = undefined;

/**
 * @member {Number} contributions_ie_and_party_expenditures_made_percent
 */
CommitteeTotalsPerCycle.prototype['contributions_ie_and_party_expenditures_made_percent'] = undefined;

/**
 * @member {Date} coverage_end_date
 */
CommitteeTotalsPerCycle.prototype['coverage_end_date'] = undefined;

/**
 * @member {Date} coverage_start_date
 */
CommitteeTotalsPerCycle.prototype['coverage_start_date'] = undefined;
 ...
 * @member {Number} cycle
 */
CommitteeTotalsPerCycle.prototype['cycle'] = undefined;

/**
 * Disbursements
 * @member {Number} disbursements
 */
CommitteeTotalsPerCycle.prototype['disbursements'] = undefined;

/**
 * @member {Number} exempt_legal_accounting_disbursement
 */
CommitteeTotalsPerCycle.prototype['exempt_legal_accounting_disbursement'] = undefined;

/**
 * @member {Number} federal_funds
 */
CommitteeTotalsPerCycle.prototype['federal_funds'] = undefined;
 ...
 */
CommitteeTotalsPerCycle.prototype['filing_frequency'] = undefined;

/**
 * The one-letter      code of the filing frequency:          - A Administratively terminated          - D Debt          - M Monthly filer          - Q Quarterly filer          - T Terminated          - W Waived 
 * @member {String} filing_frequency_full
 */
CommitteeTotalsPerCycle.prototype['filing_frequency_full'] = undefined;

/**
 * The day the FEC received the committee's first Form 1
 * @member {Date} first_f1_date
 */
CommitteeTotalsPerCycle.prototype['first_f1_date'] = undefined;
 ...
 */
CommitteeTotalsPerCycle.prototype['first_file_date'] = undefined;

/**
 * @member {Number} fundraising_disbursements
 */
CommitteeTotalsPerCycle.prototype['fundraising_disbursements'] = undefined;

/**
 * @member {Number} individual_contributions
 */
CommitteeTotalsPerCycle.prototype['individual_contributions'] = undefined;

/**
 * @member {Number} individual_contributions_percent
 */
CommitteeTotalsPerCycle.prototype['individual_contributions_percent'] = undefined;
 ...
 */
CommitteeTotalsPerCycle.prototype['individual_itemized_contributions'] = undefined;
 ...
 */
CommitteeTotalsPerCycle.prototype['individual_unitemized_contributions'] = undefined;

/**
 * @member {String} last_beginning_image_number
 */
CommitteeTotalsPerCycle.prototype['last_beginning_image_number'] = undefined;

/**
 * @member {Number} last_cash_on_hand_end_period
 */
CommitteeTotalsPerCycle.prototype['last_cash_on_hand_end_period'] = undefined;

/**
 * @member {Number} last_debts_owed_by_committee
 */
CommitteeTotalsPerCycle.prototype['last_debts_owed_by_committee'] = undefined;

/**
 * @member {Number} last_debts_owed_to_committee
 */
CommitteeTotalsPerCycle.prototype['last_debts_owed_to_committee'] = undefined;

/**
 * @member {String} last_report_type_full
 */
CommitteeTotalsPerCycle.prototype['last_report_type_full'] = undefined;

/**
 * @member {Number} last_report_year
 */
CommitteeTotalsPerCycle.prototype['last_report_year'] = undefined;

/**
 * @member {Number} loan_repayments_made
 */
CommitteeTotalsPerCycle.prototype['loan_repayments_made'] = undefined;

/**
 * @member {Number} loans_received
 */
CommitteeTotalsPerCycle.prototype['loans_received'] = undefined;

/**
 * @member {Number} loans_received_from_candidate
 */
CommitteeTotalsPerCycle.prototype['loans_received_from_candidate'] = undefined;

/**
 * @member {Number} net_contributions
 */
CommitteeTotalsPerCycle.prototype['net_contributions'] = undefined;

/**
 * @member {Number} net_operating_expenditures
 */
CommitteeTotalsPerCycle.prototype['net_operating_expenditures'] = undefined;

/**
 * @member {Number} offsets_to_fundraising_expenditures
 */
CommitteeTotalsPerCycle.prototype['offsets_to_fundraising_expenditures'] = undefined;

/**
 * @member {Number} offsets_to_legal_accounting
 */
CommitteeTotalsPerCycle.prototype['offsets_to_legal_accounting'] = undefined;

/**
 * @member {Number} offsets_to_operating_expenditures
 */
CommitteeTotalsPerCycle.prototype['offsets_to_operating_expenditures'] = undefined;

/**
 * @member {Number} operating_expenditures
 */
CommitteeTotalsPerCycle.prototype['operating_expenditures'] = undefined;

/**
 * @member {Number} operating_expenditures_percent
 */
CommitteeTotalsPerCycle.prototype['operating_expenditures_percent'] = undefined;
 ...
 */
CommitteeTotalsPerCycle.prototype['organization_type'] = undefined;

/**
 * The one-letter code for the kind for organization:         - C corporation         - L labor organization         - M membership organization         - T trade association         - V cooperative         - W corporation without capital stock 
 * @member {String} organization_type_full
 */
CommitteeTotalsPerCycle.prototype['organization_type_full'] = undefined;

/**
 * @member {Number} other_disbursements
 */
CommitteeTotalsPerCycle.prototype['other_disbursements'] = undefined;

/**
 * @member {Number} other_loans_received
 */
CommitteeTotalsPerCycle.prototype['other_loans_received'] = undefined;

/**
 * @member {Number} other_political_committee_contributions
 */
CommitteeTotalsPerCycle.prototype['other_political_committee_contributions'] = undefined;

/**
 * @member {Number} other_receipts
 */
CommitteeTotalsPerCycle.prototype['other_receipts'] = undefined;

/**
 * @member {Number} party_and_other_committee_contributions_percent
 */
CommitteeTotalsPerCycle.prototype['party_and_other_committee_contributions_percent'] = undefined;

/**
 * Party affiliated with a candidate or committee
 * @member {String} party_full
 */
CommitteeTotalsPerCycle.prototype['party_full'] = undefined;

/**
 * @member {String} pdf_url
 */
CommitteeTotalsPerCycle.prototype['pdf_url'] = undefined;

/**
 * @member {Number} political_party_committee_contributions
 */
CommitteeTotalsPerCycle.prototype['political_party_committee_contributions'] = undefined;

/**
 * @member {Number} receipts
 */
CommitteeTotalsPerCycle.prototype['receipts'] = undefined;

/**
 * @member {Number} refunded_individual_contributions
 */
CommitteeTotalsPerCycle.prototype['refunded_individual_contributions'] = undefined;

/**
 * @member {Number} refunded_other_political_committee_contributions
 */
CommitteeTotalsPerCycle.prototype['refunded_other_political_committee_contributions'] = undefined;

/**
 * @member {Number} refunded_political_party_committee_contributions
 */
CommitteeTotalsPerCycle.prototype['refunded_political_party_committee_contributions'] = undefined;

/**
 * @member {Number} repayments_loans_made_by_candidate
 */
CommitteeTotalsPerCycle.prototype['repayments_loans_made_by_candidate'] = undefined;

/**
 * @member {Number} repayments_other_loans
 */
CommitteeTotalsPerCycle.prototype['repayments_other_loans'] = undefined;

/**
 * @member {String} report_form
 */
CommitteeTotalsPerCycle.prototype['report_form'] = undefined;

/**
 * @member {Number} total_offsets_to_operating_expenditures
 */
CommitteeTotalsPerCycle.prototype['total_offsets_to_operating_expenditures'] = undefined;

/**
 * @member {Date} transaction_coverage_date
 */
CommitteeTotalsPerCycle.prototype['transaction_coverage_date'] = undefined;

/**
 * @member {Number} transfers_from_affiliated_committee
 */
CommitteeTotalsPerCycle.prototype['transfers_from_affiliated_committee'] = undefined;

/**
 * @member {Number} transfers_to_other_authorized_committee
 */
CommitteeTotalsPerCycle.prototype['transfers_to_other_authorized_committee'] = undefined;
 ...
 */
CommitteeTotalsPerCycle.prototype['treasurer_name'] = undefined;
...
export default CommitteeTotalsPerCycle;
