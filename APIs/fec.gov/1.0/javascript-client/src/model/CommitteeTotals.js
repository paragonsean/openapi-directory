...
/**
 * The CommitteeTotals model module.
 * @module model/CommitteeTotals
 * @version 1.0
 */
class CommitteeTotals {
    /**
     * Constructs a new <code>CommitteeTotals</code>.
     * @alias module:model/CommitteeTotals
    ...
    constructor(cycle) { 
        ...
        CommitteeTotals.initialize(this, cycle);
    }
    ...
    /**
     * Constructs a <code>CommitteeTotals</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommitteeTotals} obj Optional instance to populate.
     * @return {module:model/CommitteeTotals} The populated <code>CommitteeTotals</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommitteeTotals();
    ...
    /**
     * Validates the JSON data with respect to <code>CommitteeTotals</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommitteeTotals</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CommitteeTotals.RequiredProperties) {
...
CommitteeTotals.RequiredProperties = ["cycle"];

/**
 * @member {Number} all_loans_received
 */
CommitteeTotals.prototype['all_loans_received'] = undefined;

/**
 * @member {Number} all_other_loans
 */
CommitteeTotals.prototype['all_other_loans'] = undefined;

/**
 * @member {Number} allocated_federal_election_levin_share
 */
CommitteeTotals.prototype['allocated_federal_election_levin_share'] = undefined;

/**
 * @member {Number} candidate_contribution
 */
CommitteeTotals.prototype['candidate_contribution'] = undefined;

/**
 * @member {Number} cash_on_hand_beginning_period
 */
CommitteeTotals.prototype['cash_on_hand_beginning_period'] = undefined;
 ...
 */
CommitteeTotals.prototype['committee_designation'] = undefined;

/**
 * The one-letter designation code of the organization:          - A authorized by a candidate          - J joint fundraising committee          - P principal campaign committee of a candidate          - U unauthorized          - B lobbyist/registrant PAC          - D leadership PAC 
 * @member {String} committee_designation_full
 */
CommitteeTotals.prototype['committee_designation_full'] = undefined;

/**
 *  A unique identifier assigned to each committee or filer registered with the FEC. In general committee id's begin with the letter C which is followed by eight digits. 
 * @member {String} committee_id
 */
CommitteeTotals.prototype['committee_id'] = undefined;

/**
 * The name of the committee. If a committee changes its name,     the most recent name will be shown. Committee names are not unique. Use committee_id     for looking up records.
 * @member {String} committee_name
 */
CommitteeTotals.prototype['committee_name'] = undefined;

/**
 *  State of the committee's address as filed on the Form 1 
 * @member {String} committee_state
 */
CommitteeTotals.prototype['committee_state'] = undefined;

/**
 * The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account 
 * @member {String} committee_type
 */
CommitteeTotals.prototype['committee_type'] = undefined;

/**
 * The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account 
 * @member {String} committee_type_full
 */
CommitteeTotals.prototype['committee_type_full'] = undefined;

/**
 * @member {Number} contribution_refunds
 */
CommitteeTotals.prototype['contribution_refunds'] = undefined;

/**
 * Contribution
 * @member {Number} contributions
 */
CommitteeTotals.prototype['contributions'] = undefined;

/**
 * @member {Number} contributions_ie_and_party_expenditures_made_percent
 */
CommitteeTotals.prototype['contributions_ie_and_party_expenditures_made_percent'] = undefined;

/**
 * @member {Number} convention_exp
 */
CommitteeTotals.prototype['convention_exp'] = undefined;

/**
 * @member {Number} coordinated_expenditures_by_party_committee
 */
CommitteeTotals.prototype['coordinated_expenditures_by_party_committee'] = undefined;

/**
 * @member {Date} coverage_end_date
 */
CommitteeTotals.prototype['coverage_end_date'] = undefined;

/**
 * @member {Date} coverage_start_date
 */
CommitteeTotals.prototype['coverage_start_date'] = undefined;
 ...
 * @member {Number} cycle
 */
CommitteeTotals.prototype['cycle'] = undefined;

/**
 * Disbursements
 * @member {Number} disbursements
 */
CommitteeTotals.prototype['disbursements'] = undefined;

/**
 * @member {Number} exempt_legal_accounting_disbursement
 */
CommitteeTotals.prototype['exempt_legal_accounting_disbursement'] = undefined;

/**
 * @member {Number} exp_prior_years_subject_limits
 */
CommitteeTotals.prototype['exp_prior_years_subject_limits'] = undefined;

/**
 * @member {Number} exp_subject_limits
 */
CommitteeTotals.prototype['exp_subject_limits'] = undefined;

/**
 * @member {Number} fed_candidate_committee_contributions
 */
CommitteeTotals.prototype['fed_candidate_committee_contributions'] = undefined;

/**
 * @member {Number} fed_candidate_contribution_refunds
 */
CommitteeTotals.prototype['fed_candidate_contribution_refunds'] = undefined;

/**
 * @member {Number} fed_disbursements
 */
CommitteeTotals.prototype['fed_disbursements'] = undefined;

/**
 * @member {Number} fed_election_activity
 */
CommitteeTotals.prototype['fed_election_activity'] = undefined;

/**
 * @member {Number} fed_operating_expenditures
 */
CommitteeTotals.prototype['fed_operating_expenditures'] = undefined;

/**
 * @member {Number} fed_receipts
 */
CommitteeTotals.prototype['fed_receipts'] = undefined;

/**
 * @member {Number} federal_funds
 */
CommitteeTotals.prototype['federal_funds'] = undefined;
 ...
 */
CommitteeTotals.prototype['filing_frequency'] = undefined;

/**
 * The one-letter      code of the filing frequency:          - A Administratively terminated          - D Debt          - M Monthly filer          - Q Quarterly filer          - T Terminated          - W Waived 
 * @member {String} filing_frequency_full
 */
CommitteeTotals.prototype['filing_frequency_full'] = undefined;

/**
 * The day the FEC received the committee's first Form 1
 * @member {Date} first_f1_date
 */
CommitteeTotals.prototype['first_f1_date'] = undefined;
 ...
 */
CommitteeTotals.prototype['first_file_date'] = undefined;

/**
 * @member {Number} fundraising_disbursements
 */
CommitteeTotals.prototype['fundraising_disbursements'] = undefined;

/**
 * @member {Number} independent_expenditures
 */
CommitteeTotals.prototype['independent_expenditures'] = undefined;

/**
 * @member {Number} individual_contributions
 */
CommitteeTotals.prototype['individual_contributions'] = undefined;

/**
 * @member {Number} individual_contributions_percent
 */
CommitteeTotals.prototype['individual_contributions_percent'] = undefined;
 ...
 */
CommitteeTotals.prototype['individual_itemized_contributions'] = undefined;
 ...
 */
CommitteeTotals.prototype['individual_unitemized_contributions'] = undefined;

/**
 * @member {Number} itemized_convention_exp
 */
CommitteeTotals.prototype['itemized_convention_exp'] = undefined;

/**
 * @member {Number} itemized_other_disb
 */
CommitteeTotals.prototype['itemized_other_disb'] = undefined;

/**
 * @member {Number} itemized_other_income
 */
CommitteeTotals.prototype['itemized_other_income'] = undefined;

/**
 * @member {Number} itemized_other_refunds
 */
CommitteeTotals.prototype['itemized_other_refunds'] = undefined;

/**
 * @member {Number} itemized_refunds_relating_convention_exp
 */
CommitteeTotals.prototype['itemized_refunds_relating_convention_exp'] = undefined;

/**
 * @member {String} last_beginning_image_number
 */
CommitteeTotals.prototype['last_beginning_image_number'] = undefined;

/**
 * @member {Number} last_cash_on_hand_end_period
 */
CommitteeTotals.prototype['last_cash_on_hand_end_period'] = undefined;

/**
 * @member {Number} last_debts_owed_by_committee
 */
CommitteeTotals.prototype['last_debts_owed_by_committee'] = undefined;

/**
 * @member {Number} last_debts_owed_to_committee
 */
CommitteeTotals.prototype['last_debts_owed_to_committee'] = undefined;

/**
 * @member {String} last_report_type_full
 */
CommitteeTotals.prototype['last_report_type_full'] = undefined;

/**
 * @member {Number} last_report_year
 */
CommitteeTotals.prototype['last_report_year'] = undefined;

/**
 * @member {Number} loan_repayments
 */
CommitteeTotals.prototype['loan_repayments'] = undefined;

/**
 * @member {Number} loan_repayments_candidate_loans
 */
CommitteeTotals.prototype['loan_repayments_candidate_loans'] = undefined;

/**
 * @member {Number} loan_repayments_made
 */
CommitteeTotals.prototype['loan_repayments_made'] = undefined;

/**
 * @member {Number} loan_repayments_other_loans
 */
CommitteeTotals.prototype['loan_repayments_other_loans'] = undefined;

/**
 * @member {Number} loan_repayments_received
 */
CommitteeTotals.prototype['loan_repayments_received'] = undefined;

/**
 * @member {Number} loans
 */
CommitteeTotals.prototype['loans'] = undefined;

/**
 * @member {Number} loans_and_loan_repayments_made
 */
CommitteeTotals.prototype['loans_and_loan_repayments_made'] = undefined;

/**
 * @member {Number} loans_and_loan_repayments_received
 */
CommitteeTotals.prototype['loans_and_loan_repayments_received'] = undefined;

/**
 * @member {Number} loans_made
 */
CommitteeTotals.prototype['loans_made'] = undefined;

/**
 * @member {Number} loans_made_by_candidate
 */
CommitteeTotals.prototype['loans_made_by_candidate'] = undefined;

/**
 * @member {Number} loans_received
 */
CommitteeTotals.prototype['loans_received'] = undefined;

/**
 * @member {Number} loans_received_from_candidate
 */
CommitteeTotals.prototype['loans_received_from_candidate'] = undefined;

/**
 * @member {Number} net_contributions
 */
CommitteeTotals.prototype['net_contributions'] = undefined;

/**
 * @member {Number} net_operating_expenditures
 */
CommitteeTotals.prototype['net_operating_expenditures'] = undefined;

/**
 * @member {Number} non_allocated_fed_election_activity
 */
CommitteeTotals.prototype['non_allocated_fed_election_activity'] = undefined;

/**
 * @member {Number} offsets_to_fundraising_expenditures
 */
CommitteeTotals.prototype['offsets_to_fundraising_expenditures'] = undefined;

/**
 * @member {Number} offsets_to_legal_accounting
 */
CommitteeTotals.prototype['offsets_to_legal_accounting'] = undefined;

/**
 * @member {Number} offsets_to_operating_expenditures
 */
CommitteeTotals.prototype['offsets_to_operating_expenditures'] = undefined;

/**
 * @member {Number} operating_expenditures
 */
CommitteeTotals.prototype['operating_expenditures'] = undefined;

/**
 * @member {Number} operating_expenditures_percent
 */
CommitteeTotals.prototype['operating_expenditures_percent'] = undefined;
 ...
 */
CommitteeTotals.prototype['organization_type'] = undefined;

/**
 * The one-letter code for the kind for organization:         - C corporation         - L labor organization         - M membership organization         - T trade association         - V cooperative         - W corporation without capital stock 
 * @member {String} organization_type_full
 */
CommitteeTotals.prototype['organization_type_full'] = undefined;

/**
 * @member {Number} other_disbursements
 */
CommitteeTotals.prototype['other_disbursements'] = undefined;

/**
 * @member {Number} other_fed_operating_expenditures
 */
CommitteeTotals.prototype['other_fed_operating_expenditures'] = undefined;

/**
 * @member {Number} other_fed_receipts
 */
CommitteeTotals.prototype['other_fed_receipts'] = undefined;

/**
 * @member {Number} other_loans_received
 */
CommitteeTotals.prototype['other_loans_received'] = undefined;

/**
 * @member {Number} other_political_committee_contributions
 */
CommitteeTotals.prototype['other_political_committee_contributions'] = undefined;

/**
 * @member {Number} other_receipts
 */
CommitteeTotals.prototype['other_receipts'] = undefined;

/**
 * @member {Number} other_refunds
 */
CommitteeTotals.prototype['other_refunds'] = undefined;

/**
 * @member {Number} party_and_other_committee_contributions_percent
 */
CommitteeTotals.prototype['party_and_other_committee_contributions_percent'] = undefined;

/**
 * Party affiliated with a candidate or committee
 * @member {String} party_full
 */
CommitteeTotals.prototype['party_full'] = undefined;

/**
 * @member {String} pdf_url
 */
CommitteeTotals.prototype['pdf_url'] = undefined;

/**
 * @member {Number} political_party_committee_contributions
 */
CommitteeTotals.prototype['political_party_committee_contributions'] = undefined;

/**
 * @member {Number} receipts
 */
CommitteeTotals.prototype['receipts'] = undefined;

/**
 * @member {Number} refunded_individual_contributions
 */
CommitteeTotals.prototype['refunded_individual_contributions'] = undefined;

/**
 * @member {Number} refunded_other_political_committee_contributions
 */
CommitteeTotals.prototype['refunded_other_political_committee_contributions'] = undefined;

/**
 * @member {Number} refunded_political_party_committee_contributions
 */
CommitteeTotals.prototype['refunded_political_party_committee_contributions'] = undefined;

/**
 * @member {Number} refunds_relating_convention_exp
 */
CommitteeTotals.prototype['refunds_relating_convention_exp'] = undefined;

/**
 * @member {Number} repayments_loans_made_by_candidate
 */
CommitteeTotals.prototype['repayments_loans_made_by_candidate'] = undefined;

/**
 * @member {Number} repayments_other_loans
 */
CommitteeTotals.prototype['repayments_other_loans'] = undefined;

/**
 * @member {String} report_form
 */
CommitteeTotals.prototype['report_form'] = undefined;

/**
 * @member {Number} shared_fed_activity
 */
CommitteeTotals.prototype['shared_fed_activity'] = undefined;

/**
 * @member {Number} shared_fed_activity_nonfed
 */
CommitteeTotals.prototype['shared_fed_activity_nonfed'] = undefined;

/**
 * @member {Number} shared_fed_operating_expenditures
 */
CommitteeTotals.prototype['shared_fed_operating_expenditures'] = undefined;

/**
 * @member {Number} shared_nonfed_operating_expenditures
 */
CommitteeTotals.prototype['shared_nonfed_operating_expenditures'] = undefined;

/**
 * @member {Number} total_exp_subject_limits
 */
CommitteeTotals.prototype['total_exp_subject_limits'] = undefined;

/**
 * @member {Number} total_independent_contributions
 */
CommitteeTotals.prototype['total_independent_contributions'] = undefined;

/**
 * @member {Number} total_independent_expenditures
 */
CommitteeTotals.prototype['total_independent_expenditures'] = undefined;

/**
 * @member {Number} total_offsets_to_operating_expenditures
 */
CommitteeTotals.prototype['total_offsets_to_operating_expenditures'] = undefined;

/**
 * @member {Number} total_transfers
 */
CommitteeTotals.prototype['total_transfers'] = undefined;

/**
 * @member {Date} transaction_coverage_date
 */
CommitteeTotals.prototype['transaction_coverage_date'] = undefined;

/**
 * @member {Number} transfers_from_affiliated_committee
 */
CommitteeTotals.prototype['transfers_from_affiliated_committee'] = undefined;

/**
 * @member {Number} transfers_from_affiliated_party
 */
CommitteeTotals.prototype['transfers_from_affiliated_party'] = undefined;

/**
 * @member {Number} transfers_from_nonfed_account
 */
CommitteeTotals.prototype['transfers_from_nonfed_account'] = undefined;

/**
 * @member {Number} transfers_from_nonfed_levin
 */
CommitteeTotals.prototype['transfers_from_nonfed_levin'] = undefined;

/**
 * @member {Number} transfers_from_other_authorized_committee
 */
CommitteeTotals.prototype['transfers_from_other_authorized_committee'] = undefined;

/**
 * @member {Number} transfers_to_affiliated_committee
 */
CommitteeTotals.prototype['transfers_to_affiliated_committee'] = undefined;

/**
 * @member {Number} transfers_to_other_authorized_committee
 */
CommitteeTotals.prototype['transfers_to_other_authorized_committee'] = undefined;
 ...
 */
CommitteeTotals.prototype['treasurer_name'] = undefined;

/**
 * @member {Number} unitemized_convention_exp
 */
CommitteeTotals.prototype['unitemized_convention_exp'] = undefined;

/**
 * @member {Number} unitemized_other_disb
 */
CommitteeTotals.prototype['unitemized_other_disb'] = undefined;

/**
 * @member {Number} unitemized_other_income
 */
CommitteeTotals.prototype['unitemized_other_income'] = undefined;

/**
 * @member {Number} unitemized_other_refunds
 */
CommitteeTotals.prototype['unitemized_other_refunds'] = undefined;

/**
 * @member {Number} unitemized_refunds_relating_convention_exp
 */
CommitteeTotals.prototype['unitemized_refunds_relating_convention_exp'] = undefined;
...
export default CommitteeTotals;
