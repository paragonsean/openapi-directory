...
/**
 * The ScheduleAByOccupation model module.
 * @module model/ScheduleAByOccupation
 * @version 1.0
 */
class ScheduleAByOccupation {
    /**
     * Constructs a new <code>ScheduleAByOccupation</code>.
     * @alias module:model/ScheduleAByOccupation
     ...
     * @param occupation {String} Occupation of contributor as reported on the committee's filing
     */
    constructor(committeeId, cycle, occupation) { 
        
        ScheduleAByOccupation.initialize(this, committeeId, cycle, occupation);
    }
     ...
     */
    static initialize(obj, committeeId, cycle, occupation) { 
    ...
    /**
     * Constructs a <code>ScheduleAByOccupation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduleAByOccupation} obj Optional instance to populate.
     * @return {module:model/ScheduleAByOccupation} The populated <code>ScheduleAByOccupation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduleAByOccupation();
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduleAByOccupation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleAByOccupation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScheduleAByOccupation.RequiredProperties) {
...
ScheduleAByOccupation.RequiredProperties = ["committee_id", "cycle", "occupation"];

/**
 *  A unique identifier assigned to each committee or filer registered with the FEC. In general committee id's begin with the letter C which is followed by eight digits. 
 * @member {String} committee_id
 */
ScheduleAByOccupation.prototype['committee_id'] = undefined;

/**
 *  Number of records making up the total. 
 * @member {Number} count
 */
ScheduleAByOccupation.prototype['count'] = undefined;
 ...
 * @member {Number} cycle
 */
ScheduleAByOccupation.prototype['cycle'] = undefined;

/**
 * Occupation of contributor as reported on the committee's filing
 * @member {String} occupation
 */
ScheduleAByOccupation.prototype['occupation'] = undefined;

/**
 * Sum of transactions
 * @member {Number} total
 */
ScheduleAByOccupation.prototype['total'] = undefined;
...
export default ScheduleAByOccupation;
