...
/**
 * The ScheduleAByZip model module.
 * @module model/ScheduleAByZip
 * @version 1.0
 */
class ScheduleAByZip {
    /**
     * Constructs a new <code>ScheduleAByZip</code>.
     * @alias module:model/ScheduleAByZip
     ...
     * @param zip {String} 
     */
    constructor(committeeId, cycle, zip) { 
        
        ScheduleAByZip.initialize(this, committeeId, cycle, zip);
    }
     ...
     */
    static initialize(obj, committeeId, cycle, zip) { 
    ...
    /**
     * Constructs a <code>ScheduleAByZip</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduleAByZip} obj Optional instance to populate.
     * @return {module:model/ScheduleAByZip} The populated <code>ScheduleAByZip</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduleAByZip();
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduleAByZip</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleAByZip</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScheduleAByZip.RequiredProperties) {
...
ScheduleAByZip.RequiredProperties = ["committee_id", "cycle", "zip"];

/**
 *  A unique identifier assigned to each committee or filer registered with the FEC. In general committee id's begin with the letter C which is followed by eight digits. 
 * @member {String} committee_id
 */
ScheduleAByZip.prototype['committee_id'] = undefined;

/**
 *  Number of records making up the total. 
 * @member {Number} count
 */
ScheduleAByZip.prototype['count'] = undefined;
 ...
 * @member {Number} cycle
 */
ScheduleAByZip.prototype['cycle'] = undefined;

/**
 * US state or territory
 * @member {String} state
 */
ScheduleAByZip.prototype['state'] = undefined;

/**
 * US state or territory
 * @member {String} state_full
 */
ScheduleAByZip.prototype['state_full'] = undefined;

/**
 * Sum of transactions
 * @member {Number} total
 */
ScheduleAByZip.prototype['total'] = undefined;

/**
 * @member {String} zip
 */
ScheduleAByZip.prototype['zip'] = undefined;
