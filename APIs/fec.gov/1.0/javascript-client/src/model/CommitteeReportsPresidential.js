...
/**
 * The CommitteeReportsPresidential model module.
 * @module model/CommitteeReportsPresidential
 * @version 1.0
 */
class CommitteeReportsPresidential {
    /**
     * Constructs a new <code>CommitteeReportsPresidential</code>.
     * @alias module:model/CommitteeReportsPresidential
     */
    constructor() { 
        
        CommitteeReportsPresidential.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CommitteeReportsPresidential</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommitteeReportsPresidential} obj Optional instance to populate.
     * @return {module:model/CommitteeReportsPresidential} The populated <code>CommitteeReportsPresidential</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommitteeReportsPresidential();
    ...
    /**
     * Validates the JSON data with respect to <code>CommitteeReportsPresidential</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommitteeReportsPresidential</code>.
     */
 ...
 */
CommitteeReportsPresidential.prototype['amendment_chain'] = undefined;

/**
 * @member {String} amendment_indicator
 */
CommitteeReportsPresidential.prototype['amendment_indicator'] = undefined;

/**
 * @member {String} amendment_indicator_full
 */
CommitteeReportsPresidential.prototype['amendment_indicator_full'] = undefined;

/**
 * @member {String} beginning_image_number
 */
CommitteeReportsPresidential.prototype['beginning_image_number'] = undefined;

/**
 * @member {Number} candidate_contribution_period
 */
CommitteeReportsPresidential.prototype['candidate_contribution_period'] = undefined;

/**
 * @member {Number} candidate_contribution_ytd
 */
CommitteeReportsPresidential.prototype['candidate_contribution_ytd'] = undefined;

/**
 * Balance for the committee at the start of the two-year period
 * @member {Number} cash_on_hand_beginning_period
 */
CommitteeReportsPresidential.prototype['cash_on_hand_beginning_period'] = undefined;

/**
 * Ending cash balance on the most recent filing
 * @member {Number} cash_on_hand_end_period
 */
CommitteeReportsPresidential.prototype['cash_on_hand_end_period'] = undefined;

/**
 *  A unique identifier assigned to each committee or filer registered with the FEC. In general committee id's begin with the letter C which is followed by eight digits. 
 * @member {String} committee_id
 */
CommitteeReportsPresidential.prototype['committee_id'] = undefined;

/**
 * The name of the committee. If a committee changes its name,     the most recent name will be shown. Committee names are not unique. Use committee_id     for looking up records.
 * @member {String} committee_name
 */
CommitteeReportsPresidential.prototype['committee_name'] = undefined;

/**
 * @member {String} committee_type
 */
CommitteeReportsPresidential.prototype['committee_type'] = undefined;

/**
 * Ending date of the reporting period
 * @member {Date} coverage_end_date
 */
CommitteeReportsPresidential.prototype['coverage_end_date'] = undefined;

/**
 * Beginning date of the reporting period
 * @member {Date} coverage_start_date
 */
CommitteeReportsPresidential.prototype['coverage_start_date'] = undefined;

/**
 * @member {String} csv_url
 */
CommitteeReportsPresidential.prototype['csv_url'] = undefined;
 ...
 * @member {Number} cycle
 */
CommitteeReportsPresidential.prototype['cycle'] = undefined;

/**
 * Debts owed by the committee
 * @member {Number} debts_owed_by_committee
 */
CommitteeReportsPresidential.prototype['debts_owed_by_committee'] = undefined;

/**
 * Debts owed to the committee
 * @member {Number} debts_owed_to_committee
 */
CommitteeReportsPresidential.prototype['debts_owed_to_committee'] = undefined;

/**
 * @member {String} document_description
 */
CommitteeReportsPresidential.prototype['document_description'] = undefined;

/**
 * @member {String} end_image_number
 */
CommitteeReportsPresidential.prototype['end_image_number'] = undefined;

/**
 * @member {Number} exempt_legal_accounting_disbursement_period
 */
CommitteeReportsPresidential.prototype['exempt_legal_accounting_disbursement_period'] = undefined;

/**
 * @member {Number} exempt_legal_accounting_disbursement_ytd
 */
CommitteeReportsPresidential.prototype['exempt_legal_accounting_disbursement_ytd'] = undefined;

/**
 * @member {Number} expenditure_subject_to_limits
 */
CommitteeReportsPresidential.prototype['expenditure_subject_to_limits'] = undefined;

/**
 * @member {String} fec_file_id
 */
CommitteeReportsPresidential.prototype['fec_file_id'] = undefined;

/**
 * @member {String} fec_url
 */
CommitteeReportsPresidential.prototype['fec_url'] = undefined;

/**
 * @member {Number} federal_funds_period
 */
CommitteeReportsPresidential.prototype['federal_funds_period'] = undefined;

/**
 * @member {Number} federal_funds_ytd
 */
CommitteeReportsPresidential.prototype['federal_funds_ytd'] = undefined;

/**
 * @member {Number} file_number
 */
CommitteeReportsPresidential.prototype['file_number'] = undefined;

/**
 * @member {Number} fundraising_disbursements_period
 */
CommitteeReportsPresidential.prototype['fundraising_disbursements_period'] = undefined;

/**
 * @member {Number} fundraising_disbursements_ytd
 */
CommitteeReportsPresidential.prototype['fundraising_disbursements_ytd'] = undefined;

/**
 *  HTML link to the filing. 
 * @member {String} html_url
 */
CommitteeReportsPresidential.prototype['html_url'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['individual_itemized_contributions_period'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['individual_itemized_contributions_ytd'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['individual_unitemized_contributions_period'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['individual_unitemized_contributions_ytd'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['is_amended'] = undefined;

/**
 * @member {Number} items_on_hand_liquidated
 */
CommitteeReportsPresidential.prototype['items_on_hand_liquidated'] = undefined;

/**
 * @member {Number} loans_received_from_candidate_period
 */
CommitteeReportsPresidential.prototype['loans_received_from_candidate_period'] = undefined;

/**
 * @member {Number} loans_received_from_candidate_ytd
 */
CommitteeReportsPresidential.prototype['loans_received_from_candidate_ytd'] = undefined;

/**
 * The method used to file with the FEC, either electronic or on paper.
 * @member {String} means_filed
 */
CommitteeReportsPresidential.prototype['means_filed'] = undefined;

/**
 *  Report is either new or is the most-recently filed amendment 
 * @member {Boolean} most_recent
 */
CommitteeReportsPresidential.prototype['most_recent'] = undefined;

/**
 * @member {Number} most_recent_file_number
 */
CommitteeReportsPresidential.prototype['most_recent_file_number'] = undefined;

/**
 * @member {Number} net_contributions_cycle_to_date
 */
CommitteeReportsPresidential.prototype['net_contributions_cycle_to_date'] = undefined;

/**
 * @member {Number} net_operating_expenditures_cycle_to_date
 */
CommitteeReportsPresidential.prototype['net_operating_expenditures_cycle_to_date'] = undefined;

/**
 * @member {Number} offsets_to_fundraising_expenditures_period
 */
CommitteeReportsPresidential.prototype['offsets_to_fundraising_expenditures_period'] = undefined;

/**
 * @member {Number} offsets_to_fundraising_expenditures_ytd
 */
CommitteeReportsPresidential.prototype['offsets_to_fundraising_expenditures_ytd'] = undefined;

/**
 * @member {Number} offsets_to_legal_accounting_period
 */
CommitteeReportsPresidential.prototype['offsets_to_legal_accounting_period'] = undefined;

/**
 * @member {Number} offsets_to_legal_accounting_ytd
 */
CommitteeReportsPresidential.prototype['offsets_to_legal_accounting_ytd'] = undefined;

/**
 * Offsets to operating expenditures total for the reporting period
 * @member {Number} offsets_to_operating_expenditures_period
 */
CommitteeReportsPresidential.prototype['offsets_to_operating_expenditures_period'] = undefined;

/**
 * Offsets to operating expenditures total for the year to date
 * @member {Number} offsets_to_operating_expenditures_ytd
 */
CommitteeReportsPresidential.prototype['offsets_to_operating_expenditures_ytd'] = undefined;

/**
 * @member {Number} operating_expenditures_period
 */
CommitteeReportsPresidential.prototype['operating_expenditures_period'] = undefined;

/**
 * @member {Number} operating_expenditures_ytd
 */
CommitteeReportsPresidential.prototype['operating_expenditures_ytd'] = undefined;

/**
 * Other disbursements total for the reporting period
 * @member {Number} other_disbursements_period
 */
CommitteeReportsPresidential.prototype['other_disbursements_period'] = undefined;

/**
 * Other disbursements total for the year to date
 * @member {Number} other_disbursements_ytd
 */
CommitteeReportsPresidential.prototype['other_disbursements_ytd'] = undefined;

/**
 * @member {Number} other_loans_received_period
 */
CommitteeReportsPresidential.prototype['other_loans_received_period'] = undefined;

/**
 * @member {Number} other_loans_received_ytd
 */
CommitteeReportsPresidential.prototype['other_loans_received_ytd'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['other_political_committee_contributions_period'] = undefined;

/**
 * Other committees contributions total for the year to date
 * @member {Number} other_political_committee_contributions_ytd
 */
CommitteeReportsPresidential.prototype['other_political_committee_contributions_ytd'] = undefined;

/**
 * @member {Number} other_receipts_period
 */
CommitteeReportsPresidential.prototype['other_receipts_period'] = undefined;

/**
 * @member {Number} other_receipts_ytd
 */
CommitteeReportsPresidential.prototype['other_receipts_ytd'] = undefined;

/**
 * @member {String} pdf_url
 */
CommitteeReportsPresidential.prototype['pdf_url'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['political_party_committee_contributions_period'] = undefined;

/**
 * Party committees contributions total for the year to date
 * @member {Number} political_party_committee_contributions_ytd
 */
CommitteeReportsPresidential.prototype['political_party_committee_contributions_ytd'] = undefined;

/**
 * @member {Number} previous_file_number
 */
CommitteeReportsPresidential.prototype['previous_file_number'] = undefined;

/**
 * Date the FEC received the electronic or paper record
 * @member {Date} receipt_date
 */
CommitteeReportsPresidential.prototype['receipt_date'] = undefined;

/**
 * Individual refunds total for the reporting period
 * @member {Number} refunded_individual_contributions_period
 */
CommitteeReportsPresidential.prototype['refunded_individual_contributions_period'] = undefined;

/**
 * Individual refunds total for the year to date
 * @member {Number} refunded_individual_contributions_ytd
 */
CommitteeReportsPresidential.prototype['refunded_individual_contributions_ytd'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['refunded_other_political_committee_contributions_period'] = undefined;

/**
 * Other committee refunds total for the year to date
 * @member {Number} refunded_other_political_committee_contributions_ytd
 */
CommitteeReportsPresidential.prototype['refunded_other_political_committee_contributions_ytd'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['refunded_political_party_committee_contributions_period'] = undefined;

/**
 * Political party refunds total for the year to date
 * @member {Number} refunded_political_party_committee_contributions_ytd
 */
CommitteeReportsPresidential.prototype['refunded_political_party_committee_contributions_ytd'] = undefined;

/**
 * @member {Number} repayments_loans_made_by_candidate_period
 */
CommitteeReportsPresidential.prototype['repayments_loans_made_by_candidate_period'] = undefined;

/**
 * @member {Number} repayments_loans_made_candidate_ytd
 */
CommitteeReportsPresidential.prototype['repayments_loans_made_candidate_ytd'] = undefined;

/**
 * @member {Number} repayments_other_loans_period
 */
CommitteeReportsPresidential.prototype['repayments_other_loans_period'] = undefined;

/**
 * @member {Number} repayments_other_loans_ytd
 */
CommitteeReportsPresidential.prototype['repayments_other_loans_ytd'] = undefined;

/**
 * @member {String} report_form
 */
CommitteeReportsPresidential.prototype['report_form'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['report_type'] = undefined;

/**
 * Name of report where the underlying data comes from:     - 10D Pre-Election     - 10G Pre-General     - 10P Pre-Primary     - 10R Pre-Run-Off     - 10S Pre-Special     - 12C Pre-Convention     - 12G Pre-General     - 12P Pre-Primary     - 12R Pre-Run-Off     - 12S Pre-Special     - 30D Post-Election     - 30G Post-General     - 30P Post-Primary     - 30R Post-Run-Off     - 30S Post-Special     - 60D Post-Convention     - M1  January Monthly     - M10 October Monthly     - M11 November Monthly     - M12 December Monthly     - M2  February Monthly     - M3  March Monthly     - M4  April Monthly     - M5  May Monthly     - M6  June Monthly     - M7  July Monthly     - M8  August Monthly     - M9  September Monthly     - MY  Mid-Year Report     - Q1  April Quarterly     - Q2  July Quarterly     - Q3  October Quarterly     - TER Termination Report     - YE  Year-End     - ADJ COMP ADJUST AMEND     - CA  COMPREHENSIVE AMEND     - 90S Post Inaugural Supplement     - 90D Post Inaugural     - 48  48 Hour Notification     - 24  24 Hour Notification     - M7S July Monthly/Semi-Annual     - MSA Monthly Semi-Annual (MY)     - MYS Monthly Year End/Semi-Annual     - Q2S July Quarterly/Semi-Annual     - QSA Quarterly Semi-Annual (MY)     - QYS Quarterly Year End/Semi-Annual     - QYE Quarterly Semi-Annual (YE)     - QMS Quarterly Mid-Year/ Semi-Annual     - MSY Monthly Semi-Annual (YE) 
 * @member {String} report_type_full
 */
CommitteeReportsPresidential.prototype['report_type_full'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['report_year'] = undefined;

/**
 * @member {Number} subtotal_summary_period
 */
CommitteeReportsPresidential.prototype['subtotal_summary_period'] = undefined;

/**
 * Total contribution refunds total for the reporting period
 * @member {Number} total_contribution_refunds_period
 */
CommitteeReportsPresidential.prototype['total_contribution_refunds_period'] = undefined;

/**
 * Total contribution refunds total for the year to date
 * @member {Number} total_contribution_refunds_ytd
 */
CommitteeReportsPresidential.prototype['total_contribution_refunds_ytd'] = undefined;

/**
 * Contribution total for the reporting period
 * @member {Number} total_contributions_period
 */
CommitteeReportsPresidential.prototype['total_contributions_period'] = undefined;

/**
 * Contribution total for the year to date
 * @member {Number} total_contributions_ytd
 */
CommitteeReportsPresidential.prototype['total_contributions_ytd'] = undefined;

/**
 * Disbursements total for the reporting period
 * @member {Number} total_disbursements_period
 */
CommitteeReportsPresidential.prototype['total_disbursements_period'] = undefined;

/**
 * Disbursements total for the year to date
 * @member {Number} total_disbursements_ytd
 */
CommitteeReportsPresidential.prototype['total_disbursements_ytd'] = undefined;

/**
 * Individual contributions total for the reporting period
 * @member {Number} total_individual_contributions_period
 */
CommitteeReportsPresidential.prototype['total_individual_contributions_period'] = undefined;

/**
 * Individual contributions total for the year to date
 * @member {Number} total_individual_contributions_ytd
 */
CommitteeReportsPresidential.prototype['total_individual_contributions_ytd'] = undefined;

/**
 * @member {Number} total_loan_repayments_made_period
 */
CommitteeReportsPresidential.prototype['total_loan_repayments_made_period'] = undefined;

/**
 * @member {Number} total_loan_repayments_made_ytd
 */
CommitteeReportsPresidential.prototype['total_loan_repayments_made_ytd'] = undefined;

/**
 * @member {Number} total_loans_received_period
 */
CommitteeReportsPresidential.prototype['total_loans_received_period'] = undefined;

/**
 * @member {Number} total_loans_received_ytd
 */
CommitteeReportsPresidential.prototype['total_loans_received_ytd'] = undefined;

/**
 * @member {Number} total_offsets_to_operating_expenditures_period
 */
CommitteeReportsPresidential.prototype['total_offsets_to_operating_expenditures_period'] = undefined;

/**
 * @member {Number} total_offsets_to_operating_expenditures_ytd
 */
CommitteeReportsPresidential.prototype['total_offsets_to_operating_expenditures_ytd'] = undefined;

/**
 * @member {Number} total_period
 */
CommitteeReportsPresidential.prototype['total_period'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['total_receipts_period'] = undefined;
 ...
 */
CommitteeReportsPresidential.prototype['total_receipts_ytd'] = undefined;

/**
 * @member {Number} total_ytd
 */
CommitteeReportsPresidential.prototype['total_ytd'] = undefined;

/**
 * @member {Number} transfers_from_affiliated_committee_period
 */
CommitteeReportsPresidential.prototype['transfers_from_affiliated_committee_period'] = undefined;

/**
 * @member {Number} transfers_from_affiliated_committee_ytd
 */
CommitteeReportsPresidential.prototype['transfers_from_affiliated_committee_ytd'] = undefined;

/**
 * @member {Number} transfers_to_other_authorized_committee_period
 */
CommitteeReportsPresidential.prototype['transfers_to_other_authorized_committee_period'] = undefined;

/**
 * @member {Number} transfers_to_other_authorized_committee_ytd
 */
CommitteeReportsPresidential.prototype['transfers_to_other_authorized_committee_ytd'] = undefined;
...
export default CommitteeReportsPresidential;
