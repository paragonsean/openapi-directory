...
/**
 * The CandidateHistory model module.
 * @module model/CandidateHistory
 * @version 1.0
 */
class CandidateHistory {
    /**
     * Constructs a new <code>CandidateHistory</code>.
     * @alias module:model/CandidateHistory
     ...
     */
    constructor(candidateId, twoYearPeriod) { 
        
        CandidateHistory.initialize(this, candidateId, twoYearPeriod);
    }
     ...
     */
    static initialize(obj, candidateId, twoYearPeriod) { 
        obj['candidate_id'] = candidateId;
        obj['two_year_period'] = twoYearPeriod;
    }

    /**
     * Constructs a <code>CandidateHistory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CandidateHistory} obj Optional instance to populate.
     * @return {module:model/CandidateHistory} The populated <code>CandidateHistory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CandidateHistory();
    ...
    /**
     * Validates the JSON data with respect to <code>CandidateHistory</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CandidateHistory</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CandidateHistory.RequiredProperties) {
...
CandidateHistory.RequiredProperties = ["candidate_id", "two_year_period"];
 ...
 */
CandidateHistory.prototype['candidate_status'] = undefined;
 ...
 */
CandidateHistory.prototype['cycles'] = undefined;

/**
 * Two-digit US House distirict of the office the candidate is running for. Presidential, Senate and House at-large candidates will have District 00.
 * @member {String} district
 */
CandidateHistory.prototype['district'] = undefined;

/**
 * One-letter code explaining if the candidate is:         - C present candidate         - F future candidate         - N not yet a candidate         - P prior candidate 
 * @member {Number} district_number
 */
CandidateHistory.prototype['district_number'] = undefined;

/**
 * Two-digit US House distirict of the office the candidate is running for. Presidential, Senate and House at-large candidates will have District 00.
 * @member {Array.<String>} election_districts
 */
CandidateHistory.prototype['election_districts'] = undefined;

/**
 * Years in which a candidate ran for office.
 * @member {Array.<Number>} election_years
 */
CandidateHistory.prototype['election_years'] = undefined;

/**
 * FEC cycles are included in candidate election years.
 * @member {Array.<Number>} fec_cycles_in_election
 */
CandidateHistory.prototype['fec_cycles_in_election'] = undefined;

/**
 * The day the FEC received the candidate's first filing. This is a F2 candidate registration.
 * @member {Date} first_file_date
 */
CandidateHistory.prototype['first_file_date'] = undefined;

/**
 * @member {String} flags
 */
CandidateHistory.prototype['flags'] = undefined;
 ...
 */
CandidateHistory.prototype['load_date'] = undefined;

/**
 * Name of candidate running for office
 * @member {String} name
 */
CandidateHistory.prototype['name'] = undefined;

/**
 * Federal office candidate runs for: H, S or P
 * @member {String} office
 */
CandidateHistory.prototype['office'] = undefined;

/**
 * Federal office candidate runs for: House, Senate or presidential
 * @member {String} office_full
 */
CandidateHistory.prototype['office_full'] = undefined;

/**
 * Three-letter code for the party affiliated with a candidate or committee. For example, DEM for Democratic Party and REP for Republican Party.
 * @member {String} party
 */
CandidateHistory.prototype['party'] = undefined;

/**
 * Party affiliated with a candidate or committee
 * @member {String} party_full
 */
CandidateHistory.prototype['party_full'] = undefined;

/**
 * Rounded election years in which a candidate ran for office
 * @member {Array.<Number>} rounded_election_years
 */
CandidateHistory.prototype['rounded_election_years'] = undefined;

/**
 * US state or territory where a candidate runs for office
 * @member {String} state
 */
CandidateHistory.prototype['state'] = undefined;

/**
 *  Two-year election cycle in which a candidate runs for office. Calculated from Form 2. The cycle begins with an odd year and is named for its ending, even year. This cycle follows the traditional house election cycle and subdivides the presidential and Senate elections into comparable two-year blocks. To retrieve data for the entire four years of a presidential term or six years of a senatorial term, you will need the `election_full` flag. 
 * @member {Number} two_year_period
 */
CandidateHistory.prototype['two_year_period'] = undefined;
