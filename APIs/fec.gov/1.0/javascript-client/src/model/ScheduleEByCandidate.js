...
/**
 * The ScheduleEByCandidate model module.
 * @module model/ScheduleEByCandidate
 * @version 1.0
 */
class ScheduleEByCandidate {
    /**
     * Constructs a new <code>ScheduleEByCandidate</code>.
     * @alias module:model/ScheduleEByCandidate
     ...
     */
    constructor(cycle, supportOpposeIndicator) { 
        
        ScheduleEByCandidate.initialize(this, cycle, supportOpposeIndicator);
    }
     ...
     */
    static initialize(obj, cycle, supportOpposeIndicator) { 
        obj['cycle'] = cycle;
        obj['support_oppose_indicator'] = supportOpposeIndicator;
    }

    /**
     * Constructs a <code>ScheduleEByCandidate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduleEByCandidate} obj Optional instance to populate.
     * @return {module:model/ScheduleEByCandidate} The populated <code>ScheduleEByCandidate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduleEByCandidate();
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduleEByCandidate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleEByCandidate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScheduleEByCandidate.RequiredProperties) {
...
ScheduleEByCandidate.RequiredProperties = ["cycle", "support_oppose_indicator"];

/**
 * @member {String} candidate_id
 */
ScheduleEByCandidate.prototype['candidate_id'] = undefined;

/**
 * @member {String} candidate_name
 */
ScheduleEByCandidate.prototype['candidate_name'] = undefined;

/**
 * @member {String} committee_id
 */
ScheduleEByCandidate.prototype['committee_id'] = undefined;

/**
 * @member {String} committee_name
 */
ScheduleEByCandidate.prototype['committee_name'] = undefined;

/**
 *  Number of records making up the total. 
 * @member {Number} count
 */
ScheduleEByCandidate.prototype['count'] = undefined;
 ...
 * @member {Number} cycle
 */
ScheduleEByCandidate.prototype['cycle'] = undefined;
 ...
 */
ScheduleEByCandidate.prototype['support_oppose_indicator'] = undefined;

/**
 * Sum of transactions
 * @member {Number} total
 */
ScheduleEByCandidate.prototype['total'] = undefined;
...
export default ScheduleEByCandidate;
