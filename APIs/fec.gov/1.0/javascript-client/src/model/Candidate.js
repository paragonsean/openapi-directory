...
import CandidatePrincipalCommitteesInner from './CandidatePrincipalCommitteesInner';
...
class Candidate {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('inactive_election_years')) {
                obj['inactive_election_years'] = ApiClient.convertToType(data['inactive_election_years'], ['Number']);
            }
            ...
            if (data.hasOwnProperty('principal_committees')) {
                obj['principal_committees'] = ApiClient.convertToType(data['principal_committees'], [CandidatePrincipalCommitteesInner]);
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['inactive_election_years'])) {
            throw new Error("Expected the field `inactive_election_years` to be an array in the JSON data but got " + data['inactive_election_years']);
        }
        // ensure the json data is a string
        ...
        if (data['principal_committees']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['principal_committees'])) {
                throw new Error("Expected the field `principal_committees` to be an array in the JSON data but got " + data['principal_committees']);
            }
            // validate the optional field `principal_committees` (array)
            for (const item of data['principal_committees']) {
                CandidatePrincipalCommitteesInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
Candidate.prototype['active_through'] = undefined;
 ...
 */
Candidate.prototype['candidate_id'] = undefined;
 ...
 */
Candidate.prototype['candidate_inactive'] = undefined;
 ...
 */
Candidate.prototype['candidate_status'] = undefined;
 ...
 */
Candidate.prototype['cycles'] = undefined;

/**
 * Two-digit US House distirict of the office the candidate is running for. Presidential, Senate and House at-large candidates will have District 00.
 * @member {String} district
 */
Candidate.prototype['district'] = undefined;

/**
 * One-letter code explaining if the candidate is:         - C present candidate         - F future candidate         - N not yet a candidate         - P prior candidate 
 * @member {Number} district_number
 */
Candidate.prototype['district_number'] = undefined;

/**
 * Two-digit US House distirict of the office the candidate is running for. Presidential, Senate and House at-large candidates will have District 00.
 * @member {Array.<String>} election_districts
 */
Candidate.prototype['election_districts'] = undefined;

/**
 * Years in which a candidate ran for office.
 * @member {Array.<Number>} election_years
 */
Candidate.prototype['election_years'] = undefined;

/**
 * @member {Boolean} federal_funds_flag
 */
Candidate.prototype['federal_funds_flag'] = undefined;

/**
 * The day the FEC received the candidate's first filing. This is a F2 candidate registration.
 * @member {Date} first_file_date
 */
Candidate.prototype['first_file_date'] = undefined;

/**
 * @member {Boolean} has_raised_funds
 */
Candidate.prototype['has_raised_funds'] = undefined;

/**
 * inactive years
 * @member {Array.<Number>} inactive_election_years
 */
Candidate.prototype['inactive_election_years'] = undefined;
 ...
 */
Candidate.prototype['load_date'] = undefined;
 ...
 */
Candidate.prototype['party_full'] = undefined;

/**
 * @member {Array.<module:model/CandidatePrincipalCommitteesInner>} principal_committees
 */
Candidate.prototype['principal_committees'] = undefined;

/**
 * US state or territory where a candidate runs for office
 * @member {String} state
 */
Candidate.prototype['state'] = undefined;
