...
/**
 * The CommitteeHistory model module.
 * @module model/CommitteeHistory
 * @version 1.0
 */
class CommitteeHistory {
    /**
     * Constructs a new <code>CommitteeHistory</code>.
     * @alias module:model/CommitteeHistory
    ...
    constructor(committeeId, cycle) { 
        ...
        CommitteeHistory.initialize(this, committeeId, cycle);
    }
    ...
    /**
     * Constructs a <code>CommitteeHistory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommitteeHistory} obj Optional instance to populate.
     * @return {module:model/CommitteeHistory} The populated <code>CommitteeHistory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommitteeHistory();
    ...
    /**
     * Validates the JSON data with respect to <code>CommitteeHistory</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommitteeHistory</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CommitteeHistory.RequiredProperties) {
...
CommitteeHistory.RequiredProperties = ["committee_id", "cycle"];

/**
 *  Affiliated committee or connected organization 
 * @member {String} affiliated_committee_name
 */
CommitteeHistory.prototype['affiliated_committee_name'] = undefined;
 ...
 * @member {Number} cycle
 */
CommitteeHistory.prototype['cycle'] = undefined;

/**
 *  A two year election cycle that the committee was active- (after original registration date but before expiration date in Form 1s) The cycle begins with an odd year and is named for its ending, even year. 
 * @member {Array.<Number>} cycles
 */
CommitteeHistory.prototype['cycles'] = undefined;
 ...
 */
CommitteeHistory.prototype['cycles_has_activity'] = undefined;
 ...
 */
CommitteeHistory.prototype['cycles_has_financial'] = undefined;
 ...
 */
CommitteeHistory.prototype['designation'] = undefined;

/**
 * The one-letter designation code of the organization:          - A authorized by a candidate          - J joint fundraising committee          - P principal campaign committee of a candidate          - U unauthorized          - B lobbyist/registrant PAC          - D leadership PAC 
 * @member {String} designation_full
 */
CommitteeHistory.prototype['designation_full'] = undefined;
 ...
 */
CommitteeHistory.prototype['filing_frequency'] = undefined;

/**
 * The day the FEC received the committee's first Form 1
 * @member {Date} first_f1_date
 */
CommitteeHistory.prototype['first_f1_date'] = undefined;
 ...
 */
CommitteeHistory.prototype['last_cycle_has_financial'] = undefined;

/**
 * The day the FEC received the committee's most recent Form 1
 * @member {Date} last_f1_date
 */
CommitteeHistory.prototype['last_f1_date'] = undefined;

/**
 * The day the FEC received the committee's most recent filing
 * @member {Date} last_file_date
 */
CommitteeHistory.prototype['last_file_date'] = undefined;

/**
 * The name of the committee. If a committee changes its name,     the most recent name will be shown. Committee names are not unique. Use committee_id     for looking up records.
 * @member {String} name
 */
CommitteeHistory.prototype['name'] = undefined;
 ...
 */
CommitteeHistory.prototype['organization_type'] = undefined;

/**
 * The one-letter code for the kind for organization:         - C corporation         - L labor organization         - M membership organization         - T trade association         - V cooperative         - W corporation without capital stock 
 * @member {String} organization_type_full
 */
CommitteeHistory.prototype['organization_type_full'] = undefined;

/**
 * Three-letter code for the party affiliated with a candidate or committee. For example, DEM for Democratic Party and REP for Republican Party.
 * @member {String} party
 */
CommitteeHistory.prototype['party'] = undefined;

/**
 * Three-letter code for the party affiliated with a candidate or committee. For example, DEM for Democratic Party and REP for Republican Party.
 * @member {String} party_full
 */
CommitteeHistory.prototype['party_full'] = undefined;

/**
 *  State of the committee's address as filed on the Form 1 
 * @member {String} state
 */
CommitteeHistory.prototype['state'] = undefined;

/**
 *  State of committee as reported on the Form 1 
 * @member {String} state_full
 */
CommitteeHistory.prototype['state_full'] = undefined;

/**
 *  Street address of committee as reported on the Form 1 
 * @member {String} street_1
 */
CommitteeHistory.prototype['street_1'] = undefined;

/**
 *  Second line of street address of committee as reported on the Form 1 
 * @member {String} street_2
 */
CommitteeHistory.prototype['street_2'] = undefined;
 ...
 */
CommitteeHistory.prototype['treasurer_name'] = undefined;

/**
 *  Zip code of committee as reported on the Form 1 
 * @member {String} zip
 */
CommitteeHistory.prototype['zip'] = undefined;
