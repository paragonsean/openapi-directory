...
/**
 * The ElectioneeringByCandidate model module.
 * @module model/ElectioneeringByCandidate
 * @version 1.0
 */
class ElectioneeringByCandidate {
    /**
     * Constructs a new <code>ElectioneeringByCandidate</code>.
     * @alias module:model/ElectioneeringByCandidate
     */
    constructor() { 
        
        ElectioneeringByCandidate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ElectioneeringByCandidate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ElectioneeringByCandidate} obj Optional instance to populate.
     * @return {module:model/ElectioneeringByCandidate} The populated <code>ElectioneeringByCandidate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ElectioneeringByCandidate();
    ...
    /**
     * Validates the JSON data with respect to <code>ElectioneeringByCandidate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ElectioneeringByCandidate</code>.
     */
 ...
 */
ElectioneeringByCandidate.prototype['candidate'] = undefined;

/**
 * @member {String} candidate_id
 */
ElectioneeringByCandidate.prototype['candidate_id'] = undefined;

/**
 * @member {String} candidate_name
 */
ElectioneeringByCandidate.prototype['candidate_name'] = undefined;

/**
 * @member {String} committee
 */
ElectioneeringByCandidate.prototype['committee'] = undefined;

/**
 * @member {String} committee_id
 */
ElectioneeringByCandidate.prototype['committee_id'] = undefined;

/**
 * @member {String} committee_name
 */
ElectioneeringByCandidate.prototype['committee_name'] = undefined;

/**
 * @member {Number} count
 */
ElectioneeringByCandidate.prototype['count'] = undefined;

/**
 * @member {Number} cycle
 */
ElectioneeringByCandidate.prototype['cycle'] = undefined;

/**
 * @member {Number} total
 */
ElectioneeringByCandidate.prototype['total'] = undefined;
...
export default ElectioneeringByCandidate;
