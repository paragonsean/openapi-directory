...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PocketSmith.CurrencySeparators();
  });
  ...
  describe('CurrencySeparators', function() {
    it('should create an instance of CurrencySeparators', function() {
      // uncomment below and update the code to test CurrencySeparators
      //var instance = new PocketSmith.CurrencySeparators();
      //expect(instance).to.be.a(PocketSmith.CurrencySeparators);
    });
