...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PocketSmith.ScenariosIdEventsPostRequest();
  });
  ...
  describe('ScenariosIdEventsPostRequest', function() {
    it('should create an instance of ScenariosIdEventsPostRequest', function() {
      // uncomment below and update the code to test ScenariosIdEventsPostRequest
      //var instance = new PocketSmith.ScenariosIdEventsPostRequest();
      //expect(instance).to.be.a(PocketSmith.ScenariosIdEventsPostRequest);
    });
