...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PocketSmith.TransactionsIdPutRequest();
  });
  ...
  describe('TransactionsIdPutRequest', function() {
    it('should create an instance of TransactionsIdPutRequest', function() {
      // uncomment below and update the code to test TransactionsIdPutRequest
      //var instance = new PocketSmith.TransactionsIdPutRequest();
      //expect(instance).to.be.a(PocketSmith.TransactionsIdPutRequest);
    });
