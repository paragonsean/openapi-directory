...
public class UsersApi {
    ...
    /**
     * Get the authorised user (asynchronously)
     * Gets the user that corresponds to the access token used in the request.
     ...
     * @param id The unique identifier of the user. (required)
     * @param usersIdPutRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call usersIdPutCall(Integer id, UsersIdPutRequest usersIdPutRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call usersIdPutValidateBeforeCall(Integer id, UsersIdPutRequest usersIdPutRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling usersIdPut(Async)");
        }

        return usersIdPutCall(id, usersIdPutRequest, _callback);
     ...
     */
    public User usersIdPut(Integer id, UsersIdPutRequest usersIdPutRequest) throws ApiException {
        ApiResponse<User> localVarResp = usersIdPutWithHttpInfo(id, usersIdPutRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<User> usersIdPutWithHttpInfo(Integer id, UsersIdPutRequest usersIdPutRequest) throws ApiException {
        okhttp3.Call localVarCall = usersIdPutValidateBeforeCall(id, usersIdPutRequest, null);
        Type localVarReturnType = new TypeToken<User>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call usersIdPutAsync(Integer id, UsersIdPutRequest usersIdPutRequest, final ApiCallback<User> _callback) throws ApiException {

        okhttp3.Call localVarCall = usersIdPutValidateBeforeCall(id, usersIdPutRequest, _callback);
        Type localVarReturnType = new TypeToken<User>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
