...
public class ApiClient {
    ...
    private String basePath = "https://api.pocketsmith.com/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("developerKey", new ApiKeyAuth("header", "X-Developer-Key"));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.pocketsmith.com/v2/oauth/access_token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.pocketsmith.com/v2
