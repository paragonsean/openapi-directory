...
void Example::exampleFunction1(){
     OAIAccountsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAccountsApi::accountsIdDeleteSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAccountsApi::accountsIdDeleteSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      qint32 id = create(); // qint32 | The unique identifier of the account.
