...
OAIStoredValueStatusChangeResponse::OAIStoredValueStatusChangeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStoredValueStatusChangeResponse::OAIStoredValueStatusChangeResponse() {
    this->initializeModel();
}

OAIStoredValueStatusChangeResponse::~OAIStoredValueStatusChangeResponse() {}

void OAIStoredValueStatusChangeResponse::initializeModel() {
...
void OAIStoredValueStatusChangeResponse::fromJson(QString jsonString) {
...
void OAIStoredValueStatusChangeResponse::fromJsonObject(QJsonObject json) {
...
QString OAIStoredValueStatusChangeResponse::asJson() const {
...
QJsonObject OAIStoredValueStatusChangeResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStoredValueStatusChangeResponse::getAuthCode() const {
    return m_auth_code;
}
void OAIStoredValueStatusChangeResponse::setAuthCode(const QString &auth_code) {
    m_auth_code = auth_code;
    m_auth_code_isSet = true;
}

bool OAIStoredValueStatusChangeResponse::is_auth_code_Set() const{
    return m_auth_code_isSet;
}

bool OAIStoredValueStatusChangeResponse::is_auth_code_Valid() const{
    return m_auth_code_isValid;
}

OAIAmount OAIStoredValueStatusChangeResponse::getCurrentBalance() const {
    return m_current_balance;
}
void OAIStoredValueStatusChangeResponse::setCurrentBalance(const OAIAmount &current_balance) {
    m_current_balance = current_balance;
    m_current_balance_isSet = true;
}

bool OAIStoredValueStatusChangeResponse::is_current_balance_Set() const{
    return m_current_balance_isSet;
}

bool OAIStoredValueStatusChangeResponse::is_current_balance_Valid() const{
    return m_current_balance_isValid;
}

QString OAIStoredValueStatusChangeResponse::getPspReference() const {
    return m_psp_reference;
}
void OAIStoredValueStatusChangeResponse::setPspReference(const QString &psp_reference) {
    m_psp_reference = psp_reference;
    m_psp_reference_isSet = true;
}

bool OAIStoredValueStatusChangeResponse::is_psp_reference_Set() const{
    return m_psp_reference_isSet;
}

bool OAIStoredValueStatusChangeResponse::is_psp_reference_Valid() const{
    return m_psp_reference_isValid;
}

QString OAIStoredValueStatusChangeResponse::getRefusalReason() const {
    return m_refusal_reason;
}
void OAIStoredValueStatusChangeResponse::setRefusalReason(const QString &refusal_reason) {
    m_refusal_reason = refusal_reason;
    m_refusal_reason_isSet = true;
}

bool OAIStoredValueStatusChangeResponse::is_refusal_reason_Set() const{
    return m_refusal_reason_isSet;
}

bool OAIStoredValueStatusChangeResponse::is_refusal_reason_Valid() const{
    return m_refusal_reason_isValid;
}

QString OAIStoredValueStatusChangeResponse::getResultCode() const {
    return m_result_code;
}
void OAIStoredValueStatusChangeResponse::setResultCode(const QString &result_code) {
    m_result_code = result_code;
    m_result_code_isSet = true;
}

bool OAIStoredValueStatusChangeResponse::is_result_code_Set() const{
    return m_result_code_isSet;
}

bool OAIStoredValueStatusChangeResponse::is_result_code_Valid() const{
    return m_result_code_isValid;
}

QString OAIStoredValueStatusChangeResponse::getThirdPartyRefusalReason() const {
    return m_third_party_refusal_reason;
}
void OAIStoredValueStatusChangeResponse::setThirdPartyRefusalReason(const QString &third_party_refusal_reason) {
    m_third_party_refusal_reason = third_party_refusal_reason;
    m_third_party_refusal_reason_isSet = true;
}

bool OAIStoredValueStatusChangeResponse::is_third_party_refusal_reason_Set() const{
    return m_third_party_refusal_reason_isSet;
}

bool OAIStoredValueStatusChangeResponse::is_third_party_refusal_reason_Valid() const{
    return m_third_party_refusal_reason_isValid;
}

bool OAIStoredValueStatusChangeResponse::isSet() const {
...
bool OAIStoredValueStatusChangeResponse::isValid() const {
