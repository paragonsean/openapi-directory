...
/*
 * OAIStoredValueBalanceCheckRequest.h
 *
 * 
 */

#ifndef OAIStoredValueBalanceCheckRequest_H
#define OAIStoredValueBalanceCheckRequest_H
...
class OAIStoredValueBalanceCheckRequest : public OAIObject {
public:
    OAIStoredValueBalanceCheckRequest();
    OAIStoredValueBalanceCheckRequest(QString json);
    ~OAIStoredValueBalanceCheckRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoredValueBalanceCheckRequest)

#endif // OAIStoredValueBalanceCheckRequest_H
