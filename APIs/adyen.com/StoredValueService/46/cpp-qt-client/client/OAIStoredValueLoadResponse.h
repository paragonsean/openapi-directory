...
/*
 * OAIStoredValueLoadResponse.h
 *
 * 
 */

#ifndef OAIStoredValueLoadResponse_H
#define OAIStoredValueLoadResponse_H
...
class OAIStoredValueLoadResponse : public OAIObject {
public:
    OAIStoredValueLoadResponse();
    OAIStoredValueLoadResponse(QString json);
    ~OAIStoredValueLoadResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoredValueLoadResponse)

#endif // OAIStoredValueLoadResponse_H
