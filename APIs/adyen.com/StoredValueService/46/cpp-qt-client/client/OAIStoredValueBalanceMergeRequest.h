...
/*
 * OAIStoredValueBalanceMergeRequest.h
 *
 * 
 */

#ifndef OAIStoredValueBalanceMergeRequest_H
#define OAIStoredValueBalanceMergeRequest_H
...
class OAIStoredValueBalanceMergeRequest : public OAIObject {
public:
    OAIStoredValueBalanceMergeRequest();
    OAIStoredValueBalanceMergeRequest(QString json);
    ~OAIStoredValueBalanceMergeRequest() override;
    ...
    QMap<QString, QString> getSourcePaymentMethod() const;
    void setSourcePaymentMethod(const QMap<QString, QString> &source_payment_method);
    bool is_source_payment_method_Set() const;
    bool is_source_payment_method_Valid() const;
...
private:
    ...
    QMap<QString, QString> m_source_payment_method;
    bool m_source_payment_method_isSet;
    bool m_source_payment_method_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoredValueBalanceMergeRequest)

#endif // OAIStoredValueBalanceMergeRequest_H
