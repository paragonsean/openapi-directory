...
/*
 * OAIStoredValueLoadRequest.h
 *
 * 
 */

#ifndef OAIStoredValueLoadRequest_H
#define OAIStoredValueLoadRequest_H
...
class OAIStoredValueLoadRequest : public OAIObject {
public:
    OAIStoredValueLoadRequest();
    OAIStoredValueLoadRequest(QString json);
    ~OAIStoredValueLoadRequest() override;
    ...
    void setLoadType(const QString &load_type);
    bool is_load_type_Set() const;
    bool is_load_type_Valid() const;
...
private:
    ...
    QString m_load_type;
    bool m_load_type_isSet;
    bool m_load_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoredValueLoadRequest)

#endif // OAIStoredValueLoadRequest_H
