...
/*
 * OAIStoredValueStatusChangeRequest.h
 *
 * 
 */

#ifndef OAIStoredValueStatusChangeRequest_H
#define OAIStoredValueStatusChangeRequest_H
...
class OAIStoredValueStatusChangeRequest : public OAIObject {
public:
    OAIStoredValueStatusChangeRequest();
    OAIStoredValueStatusChangeRequest(QString json);
    ~OAIStoredValueStatusChangeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoredValueStatusChangeRequest)

#endif // OAIStoredValueStatusChangeRequest_H
