...
/*
 * OAIStoredValueStatusChangeResponse.h
 *
 * 
 */

#ifndef OAIStoredValueStatusChangeResponse_H
#define OAIStoredValueStatusChangeResponse_H
...
class OAIStoredValueStatusChangeResponse : public OAIObject {
public:
    OAIStoredValueStatusChangeResponse();
    OAIStoredValueStatusChangeResponse(QString json);
    ~OAIStoredValueStatusChangeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoredValueStatusChangeResponse)

#endif // OAIStoredValueStatusChangeResponse_H
