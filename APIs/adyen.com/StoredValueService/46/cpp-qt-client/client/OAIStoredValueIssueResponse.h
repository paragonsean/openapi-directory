...
/*
 * OAIStoredValueIssueResponse.h
 *
 * 
 */

#ifndef OAIStoredValueIssueResponse_H
#define OAIStoredValueIssueResponse_H
...
class OAIStoredValueIssueResponse : public OAIObject {
public:
    OAIStoredValueIssueResponse();
    OAIStoredValueIssueResponse(QString json);
    ~OAIStoredValueIssueResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoredValueIssueResponse)

#endif // OAIStoredValueIssueResponse_H
