# AdyenStoredValueApi.StoredValueLoadRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**amount** | [**Amount**](Amount.md) | The amount information for the transaction. | 
**loadType** | **String** | The type of load you are trying to do, when absent we default to &#39;Load&#39; | [optional] 
...
* `merchandiseReturn` (value: `"merchandiseReturn"`)
