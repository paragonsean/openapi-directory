...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenStoredValueApi.StoredValueStatusChangeResponse();
  });
  ...
  describe('StoredValueStatusChangeResponse', function() {
    it('should create an instance of StoredValueStatusChangeResponse', function() {
      // uncomment below and update the code to test StoredValueStatusChangeResponse
      //var instance = new AdyenStoredValueApi.StoredValueStatusChangeResponse();
      //expect(instance).to.be.a(AdyenStoredValueApi.StoredValueStatusChangeResponse);
    });
