...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenStoredValueApi.StoredValueIssueRequest();
  });
  ...
  describe('StoredValueIssueRequest', function() {
    it('should create an instance of StoredValueIssueRequest', function() {
      // uncomment below and update the code to test StoredValueIssueRequest
      //var instance = new AdyenStoredValueApi.StoredValueIssueRequest();
      //expect(instance).to.be.a(AdyenStoredValueApi.StoredValueIssueRequest);
    });
