...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenStoredValueApi.StoredValueBalanceMergeResponse();
  });
  ...
  describe('StoredValueBalanceMergeResponse', function() {
    it('should create an instance of StoredValueBalanceMergeResponse', function() {
      // uncomment below and update the code to test StoredValueBalanceMergeResponse
      //var instance = new AdyenStoredValueApi.StoredValueBalanceMergeResponse();
      //expect(instance).to.be.a(AdyenStoredValueApi.StoredValueBalanceMergeResponse);
    });
