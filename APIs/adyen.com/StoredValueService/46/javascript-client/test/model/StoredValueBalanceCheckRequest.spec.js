...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenStoredValueApi.StoredValueBalanceCheckRequest();
  });
  ...
  describe('StoredValueBalanceCheckRequest', function() {
    it('should create an instance of StoredValueBalanceCheckRequest', function() {
      // uncomment below and update the code to test StoredValueBalanceCheckRequest
      //var instance = new AdyenStoredValueApi.StoredValueBalanceCheckRequest();
      //expect(instance).to.be.a(AdyenStoredValueApi.StoredValueBalanceCheckRequest);
    });
