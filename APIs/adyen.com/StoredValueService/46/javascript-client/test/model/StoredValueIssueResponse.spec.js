...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenStoredValueApi.StoredValueIssueResponse();
  });
  ...
  describe('StoredValueIssueResponse', function() {
    it('should create an instance of StoredValueIssueResponse', function() {
      // uncomment below and update the code to test StoredValueIssueResponse
      //var instance = new AdyenStoredValueApi.StoredValueIssueResponse();
      //expect(instance).to.be.a(AdyenStoredValueApi.StoredValueIssueResponse);
    });
