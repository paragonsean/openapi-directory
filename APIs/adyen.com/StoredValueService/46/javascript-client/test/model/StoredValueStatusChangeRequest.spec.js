...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenStoredValueApi.StoredValueStatusChangeRequest();
  });
  ...
  describe('StoredValueStatusChangeRequest', function() {
    it('should create an instance of StoredValueStatusChangeRequest', function() {
      // uncomment below and update the code to test StoredValueStatusChangeRequest
      //var instance = new AdyenStoredValueApi.StoredValueStatusChangeRequest();
      //expect(instance).to.be.a(AdyenStoredValueApi.StoredValueStatusChangeRequest);
    });
