...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenStoredValueApi.StoredValueLoadResponse();
  });
  ...
  describe('StoredValueLoadResponse', function() {
    it('should create an instance of StoredValueLoadResponse', function() {
      // uncomment below and update the code to test StoredValueLoadResponse
      //var instance = new AdyenStoredValueApi.StoredValueLoadResponse();
      //expect(instance).to.be.a(AdyenStoredValueApi.StoredValueLoadResponse);
    });
