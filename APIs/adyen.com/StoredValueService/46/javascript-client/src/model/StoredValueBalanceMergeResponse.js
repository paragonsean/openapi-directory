...
/**
 * The StoredValueBalanceMergeResponse model module.
 * @module model/StoredValueBalanceMergeResponse
 * @version 46
 */
class StoredValueBalanceMergeResponse {
    /**
     * Constructs a new <code>StoredValueBalanceMergeResponse</code>.
     * @alias module:model/StoredValueBalanceMergeResponse
     */
    constructor() { 
        
        StoredValueBalanceMergeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StoredValueBalanceMergeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoredValueBalanceMergeResponse} obj Optional instance to populate.
     * @return {module:model/StoredValueBalanceMergeResponse} The populated <code>StoredValueBalanceMergeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoredValueBalanceMergeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StoredValueBalanceMergeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoredValueBalanceMergeResponse</code>.
     */
 ...
 */
StoredValueBalanceMergeResponse.prototype['authCode'] = undefined;

/**
 * The balance currently on the payment method.
 * @member {module:model/Amount} currentBalance
 */
StoredValueBalanceMergeResponse.prototype['currentBalance'] = undefined;

/**
 * Adyen's 16-character string reference associated with the transaction/request. This value is globally unique; quote it when communicating with us about this request.
 * @member {String} pspReference
 */
StoredValueBalanceMergeResponse.prototype['pspReference'] = undefined;
 ...
 */
StoredValueBalanceMergeResponse.prototype['refusalReason'] = undefined;
 ...
 * @member {module:model/StoredValueBalanceMergeResponse.ResultCodeEnum} resultCode
 */
StoredValueBalanceMergeResponse.prototype['resultCode'] = undefined;

/**
 * Raw refusal reason received from the third party, where available
 * @member {String} thirdPartyRefusalReason
 */
StoredValueBalanceMergeResponse.prototype['thirdPartyRefusalReason'] = undefined;
...
export default StoredValueBalanceMergeResponse;
