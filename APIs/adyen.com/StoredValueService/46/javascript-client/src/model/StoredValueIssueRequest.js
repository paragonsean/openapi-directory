...
/**
 * The StoredValueIssueRequest model module.
 * @module model/StoredValueIssueRequest
 * @version 46
 */
class StoredValueIssueRequest {
    /**
     * Constructs a new <code>StoredValueIssueRequest</code>.
     * @alias module:model/StoredValueIssueRequest
    ...
    constructor(merchantAccount, paymentMethod, reference) { 
        ...
        StoredValueIssueRequest.initialize(this, merchantAccount, paymentMethod, reference);
    }
    ...
    /**
     * Constructs a <code>StoredValueIssueRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoredValueIssueRequest} obj Optional instance to populate.
     * @return {module:model/StoredValueIssueRequest} The populated <code>StoredValueIssueRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoredValueIssueRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StoredValueIssueRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoredValueIssueRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StoredValueIssueRequest.RequiredProperties) {
...
StoredValueIssueRequest.RequiredProperties = ["merchantAccount", "paymentMethod", "reference"];

/**
 * The amount information for the transaction.
 * @member {module:model/Amount} amount
 */
StoredValueIssueRequest.prototype['amount'] = undefined;

/**
 * The merchant account identifier, with which you want to process the transaction.
 * @member {String} merchantAccount
 */
StoredValueIssueRequest.prototype['merchantAccount'] = undefined;

/**
 * The collection that contains the type of the payment method and its specific information if available
 * @member {Object.<String, String>} paymentMethod
 */
StoredValueIssueRequest.prototype['paymentMethod'] = undefined;

/**
 * @member {String} recurringDetailReference
 */
StoredValueIssueRequest.prototype['recurringDetailReference'] = undefined;

/**
 * The reference to uniquely identify a payment. This reference is used in all communication with you about the payment status. We recommend using a unique value per payment; however, it is not a requirement. If you need to provide multiple references for a transaction, separate them with hyphens (\"-\"). Maximum length: 80 characters.
 * @member {String} reference
 */
StoredValueIssueRequest.prototype['reference'] = undefined;
 ...
 * @member {module:model/StoredValueIssueRequest.ShopperInteractionEnum} shopperInteraction
 */
StoredValueIssueRequest.prototype['shopperInteraction'] = undefined;

/**
 * @member {String} shopperReference
 */
StoredValueIssueRequest.prototype['shopperReference'] = undefined;

/**
 * The physical store, for which this payment is processed.
 * @member {String} store
 */
StoredValueIssueRequest.prototype['store'] = undefined;
...
export default StoredValueIssueRequest;
