...
/**
 * The StoredValueBalanceCheckResponse model module.
 * @module model/StoredValueBalanceCheckResponse
 * @version 46
 */
class StoredValueBalanceCheckResponse {
    /**
     * Constructs a new <code>StoredValueBalanceCheckResponse</code>.
     * @alias module:model/StoredValueBalanceCheckResponse
     */
    constructor() { 
        
        StoredValueBalanceCheckResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StoredValueBalanceCheckResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoredValueBalanceCheckResponse} obj Optional instance to populate.
     * @return {module:model/StoredValueBalanceCheckResponse} The populated <code>StoredValueBalanceCheckResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoredValueBalanceCheckResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StoredValueBalanceCheckResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoredValueBalanceCheckResponse</code>.
     */
 ...
 */
StoredValueBalanceCheckResponse.prototype['currentBalance'] = undefined;

/**
 * Adyen's 16-character string reference associated with the transaction/request. This value is globally unique; quote it when communicating with us about this request.
 * @member {String} pspReference
 */
StoredValueBalanceCheckResponse.prototype['pspReference'] = undefined;
 ...
 */
StoredValueBalanceCheckResponse.prototype['refusalReason'] = undefined;
 ...
 * @member {module:model/StoredValueBalanceCheckResponse.ResultCodeEnum} resultCode
 */
StoredValueBalanceCheckResponse.prototype['resultCode'] = undefined;

/**
 * Raw refusal reason received from the third party, where available
 * @member {String} thirdPartyRefusalReason
 */
StoredValueBalanceCheckResponse.prototype['thirdPartyRefusalReason'] = undefined;
...
export default StoredValueBalanceCheckResponse;
