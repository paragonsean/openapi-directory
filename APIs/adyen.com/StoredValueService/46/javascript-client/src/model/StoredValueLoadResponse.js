...
/**
 * The StoredValueLoadResponse model module.
 * @module model/StoredValueLoadResponse
 * @version 46
 */
class StoredValueLoadResponse {
    /**
     * Constructs a new <code>StoredValueLoadResponse</code>.
     * @alias module:model/StoredValueLoadResponse
     */
    constructor() { 
        
        StoredValueLoadResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StoredValueLoadResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoredValueLoadResponse} obj Optional instance to populate.
     * @return {module:model/StoredValueLoadResponse} The populated <code>StoredValueLoadResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoredValueLoadResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StoredValueLoadResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoredValueLoadResponse</code>.
     */
 ...
 */
StoredValueLoadResponse.prototype['authCode'] = undefined;

/**
 * The balance currently on the payment method.
 * @member {module:model/Amount} currentBalance
 */
StoredValueLoadResponse.prototype['currentBalance'] = undefined;

/**
 * Adyen's 16-character string reference associated with the transaction/request. This value is globally unique; quote it when communicating with us about this request.
 * @member {String} pspReference
 */
StoredValueLoadResponse.prototype['pspReference'] = undefined;
 ...
 */
StoredValueLoadResponse.prototype['refusalReason'] = undefined;
 ...
 * @member {module:model/StoredValueLoadResponse.ResultCodeEnum} resultCode
 */
StoredValueLoadResponse.prototype['resultCode'] = undefined;

/**
 * Raw refusal reason received from the third party, where available
 * @member {String} thirdPartyRefusalReason
 */
StoredValueLoadResponse.prototype['thirdPartyRefusalReason'] = undefined;
...
export default StoredValueLoadResponse;
