...
class StoredValueBalanceMergeResponse(Model):
    ...
    def __init__(self, auth_code: str=None, current_balance: Amount=None, psp_reference: str=None, refusal_reason: str=None, result_code: str=None, third_party_refusal_reason: str=None):
        """StoredValueBalanceMergeResponse - a model defined in OpenAPI

        :param auth_code: The auth_code of this StoredValueBalanceMergeResponse.
        :param current_balance: The current_balance of this StoredValueBalanceMergeResponse.
        :param psp_reference: The psp_reference of this StoredValueBalanceMergeResponse.
        :param refusal_reason: The refusal_reason of this StoredValueBalanceMergeResponse.
        :param result_code: The result_code of this StoredValueBalanceMergeResponse.
        :param third_party_refusal_reason: The third_party_refusal_reason of this StoredValueBalanceMergeResponse.
        """
        self.openapi_types = {
            'auth_code': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StoredValueBalanceMergeResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StoredValueBalanceMergeResponse of this StoredValueBalanceMergeResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def auth_code(self):
        """Gets the auth_code of this StoredValueBalanceMergeResponse.
        ...
        :return: The auth_code of this StoredValueBalanceMergeResponse.
        :rtype: str
        """
    ...
    def auth_code(self, auth_code):
        """Sets the auth_code of this StoredValueBalanceMergeResponse.
    ...
    def current_balance(self):
        """Gets the current_balance of this StoredValueBalanceMergeResponse.

        The balance currently on the payment method.

        :return: The current_balance of this StoredValueBalanceMergeResponse.
        :rtype: Amount
        """
    ...
    def current_balance(self, current_balance):
        """Sets the current_balance of this StoredValueBalanceMergeResponse.
    ...
    def psp_reference(self):
        """Gets the psp_reference of this StoredValueBalanceMergeResponse.

        Adyen's 16-character string reference associated with the transaction/request. This value is globally unique; quote it when communicating with us about this request.

        :return: The psp_reference of this StoredValueBalanceMergeResponse.
        :rtype: str
        """
    ...
    def psp_reference(self, psp_reference):
        """Sets the psp_reference of this StoredValueBalanceMergeResponse.
    ...
    def refusal_reason(self):
        """Gets the refusal_reason of this StoredValueBalanceMergeResponse.
        ...
        :return: The refusal_reason of this StoredValueBalanceMergeResponse.
        :rtype: str
        """
    ...
    def refusal_reason(self, refusal_reason):
        """Sets the refusal_reason of this StoredValueBalanceMergeResponse.
    ...
    def result_code(self):
        """Gets the result_code of this StoredValueBalanceMergeResponse.
        ...
        :return: The result_code of this StoredValueBalanceMergeResponse.
        :rtype: str
        """
    ...
    def result_code(self, result_code):
        """Sets the result_code of this StoredValueBalanceMergeResponse.
    ...
    def third_party_refusal_reason(self):
        """Gets the third_party_refusal_reason of this StoredValueBalanceMergeResponse.

        Raw refusal reason received from the third party, where available

        :return: The third_party_refusal_reason of this StoredValueBalanceMergeResponse.
        :rtype: str
        """
    ...
    def third_party_refusal_reason(self, third_party_refusal_reason):
        """Sets the third_party_refusal_reason of this StoredValueBalanceMergeResponse.
