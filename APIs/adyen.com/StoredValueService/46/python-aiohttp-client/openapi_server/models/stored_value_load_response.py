...
class StoredValueLoadResponse(Model):
    ...
    def __init__(self, auth_code: str=None, current_balance: Amount=None, psp_reference: str=None, refusal_reason: str=None, result_code: str=None, third_party_refusal_reason: str=None):
        """StoredValueLoadResponse - a model defined in OpenAPI

        :param auth_code: The auth_code of this StoredValueLoadResponse.
        :param current_balance: The current_balance of this StoredValueLoadResponse.
        :param psp_reference: The psp_reference of this StoredValueLoadResponse.
        :param refusal_reason: The refusal_reason of this StoredValueLoadResponse.
        :param result_code: The result_code of this StoredValueLoadResponse.
        :param third_party_refusal_reason: The third_party_refusal_reason of this StoredValueLoadResponse.
        """
        self.openapi_types = {
            'auth_code': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StoredValueLoadResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StoredValueLoadResponse of this StoredValueLoadResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def auth_code(self):
        """Gets the auth_code of this StoredValueLoadResponse.
        ...
        :return: The auth_code of this StoredValueLoadResponse.
        :rtype: str
        """
    ...
    def auth_code(self, auth_code):
        """Sets the auth_code of this StoredValueLoadResponse.
    ...
    def current_balance(self):
        """Gets the current_balance of this StoredValueLoadResponse.

        The balance currently on the payment method.

        :return: The current_balance of this StoredValueLoadResponse.
        :rtype: Amount
        """
    ...
    def current_balance(self, current_balance):
        """Sets the current_balance of this StoredValueLoadResponse.
    ...
    def psp_reference(self):
        """Gets the psp_reference of this StoredValueLoadResponse.

        Adyen's 16-character string reference associated with the transaction/request. This value is globally unique; quote it when communicating with us about this request.

        :return: The psp_reference of this StoredValueLoadResponse.
        :rtype: str
        """
    ...
    def psp_reference(self, psp_reference):
        """Sets the psp_reference of this StoredValueLoadResponse.
    ...
    def refusal_reason(self):
        """Gets the refusal_reason of this StoredValueLoadResponse.
        ...
        :return: The refusal_reason of this StoredValueLoadResponse.
        :rtype: str
        """
    ...
    def refusal_reason(self, refusal_reason):
        """Sets the refusal_reason of this StoredValueLoadResponse.
    ...
    def result_code(self):
        """Gets the result_code of this StoredValueLoadResponse.
        ...
        :return: The result_code of this StoredValueLoadResponse.
        :rtype: str
        """
    ...
    def result_code(self, result_code):
        """Sets the result_code of this StoredValueLoadResponse.
    ...
    def third_party_refusal_reason(self):
        """Gets the third_party_refusal_reason of this StoredValueLoadResponse.

        Raw refusal reason received from the third party, where available

        :return: The third_party_refusal_reason of this StoredValueLoadResponse.
        :rtype: str
        """
    ...
    def third_party_refusal_reason(self, third_party_refusal_reason):
        """Sets the third_party_refusal_reason of this StoredValueLoadResponse.
