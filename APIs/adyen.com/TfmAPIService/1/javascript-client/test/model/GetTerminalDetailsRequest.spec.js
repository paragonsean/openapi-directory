...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PosTerminalManagementApi.GetTerminalDetailsRequest();
  });
  ...
  describe('GetTerminalDetailsRequest', function() {
    it('should create an instance of GetTerminalDetailsRequest', function() {
      // uncomment below and update the code to test GetTerminalDetailsRequest
      //var instance = new PosTerminalManagementApi.GetTerminalDetailsRequest();
      //expect(instance).to.be.a(PosTerminalManagementApi.GetTerminalDetailsRequest);
    });
