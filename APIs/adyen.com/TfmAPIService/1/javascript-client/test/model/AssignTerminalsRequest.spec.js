...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PosTerminalManagementApi.AssignTerminalsRequest();
  });
  ...
  describe('AssignTerminalsRequest', function() {
    it('should create an instance of AssignTerminalsRequest', function() {
      // uncomment below and update the code to test AssignTerminalsRequest
      //var instance = new PosTerminalManagementApi.AssignTerminalsRequest();
      //expect(instance).to.be.a(PosTerminalManagementApi.AssignTerminalsRequest);
    });
    ...
    it('should have the property terminals (base name: "terminals")', function() {
      // uncomment below and update the code to test the property terminals
      //var instance = new PosTerminalManagementApi.AssignTerminalsRequest();
      //expect(instance).to.be();
    });
