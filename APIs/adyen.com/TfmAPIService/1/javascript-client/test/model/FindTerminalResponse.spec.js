...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PosTerminalManagementApi.FindTerminalResponse();
  });
  ...
  describe('FindTerminalResponse', function() {
    it('should create an instance of FindTerminalResponse', function() {
      // uncomment below and update the code to test FindTerminalResponse
      //var instance = new PosTerminalManagementApi.FindTerminalResponse();
      //expect(instance).to.be.a(PosTerminalManagementApi.FindTerminalResponse);
    });
