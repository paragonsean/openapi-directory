...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PosTerminalManagementApi.AssignTerminalsResponse();
  });
  ...
  describe('AssignTerminalsResponse', function() {
    it('should create an instance of AssignTerminalsResponse', function() {
      // uncomment below and update the code to test AssignTerminalsResponse
      //var instance = new PosTerminalManagementApi.AssignTerminalsResponse();
      //expect(instance).to.be.a(PosTerminalManagementApi.AssignTerminalsResponse);
    });
