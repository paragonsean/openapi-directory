...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PosTerminalManagementApi.GetStoresUnderAccountResponse();
  });
  ...
  describe('GetStoresUnderAccountResponse', function() {
    it('should create an instance of GetStoresUnderAccountResponse', function() {
      // uncomment below and update the code to test GetStoresUnderAccountResponse
      //var instance = new PosTerminalManagementApi.GetStoresUnderAccountResponse();
      //expect(instance).to.be.a(PosTerminalManagementApi.GetStoresUnderAccountResponse);
    });
