...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PosTerminalManagementApi.ServiceError();
  });
  ...
  describe('ServiceError', function() {
    it('should create an instance of ServiceError', function() {
      ...
      //var instance = new PosTerminalManagementApi.ServiceError();
      //expect(instance).to.be.a(PosTerminalManagementApi.ServiceError);
    });
