...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PosTerminalManagementApi.GetStoresUnderAccountRequest();
  });
  ...
  describe('GetStoresUnderAccountRequest', function() {
    it('should create an instance of GetStoresUnderAccountRequest', function() {
      // uncomment below and update the code to test GetStoresUnderAccountRequest
      //var instance = new PosTerminalManagementApi.GetStoresUnderAccountRequest();
      //expect(instance).to.be.a(PosTerminalManagementApi.GetStoresUnderAccountRequest);
    });
