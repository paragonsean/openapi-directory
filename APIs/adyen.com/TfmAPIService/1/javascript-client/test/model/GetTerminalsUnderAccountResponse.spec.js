...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PosTerminalManagementApi.GetTerminalsUnderAccountResponse();
  });
  ...
  describe('GetTerminalsUnderAccountResponse', function() {
    it('should create an instance of GetTerminalsUnderAccountResponse', function() {
      // uncomment below and update the code to test GetTerminalsUnderAccountResponse
      //var instance = new PosTerminalManagementApi.GetTerminalsUnderAccountResponse();
      //expect(instance).to.be.a(PosTerminalManagementApi.GetTerminalsUnderAccountResponse);
    });
    ...
    it('should have the property merchantAccounts (base name: "merchantAccounts")', function() {
      // uncomment below and update the code to test the property merchantAccounts
      //var instance = new PosTerminalManagementApi.GetTerminalsUnderAccountResponse();
      //expect(instance).to.be();
    });
