...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PosTerminalManagementApi.MerchantAccount();
  });
  ...
  describe('MerchantAccount', function() {
    it('should create an instance of MerchantAccount', function() {
      // uncomment below and update the code to test MerchantAccount
      //var instance = new PosTerminalManagementApi.MerchantAccount();
      //expect(instance).to.be.a(PosTerminalManagementApi.MerchantAccount);
    });

    it('should have the property inStoreTerminals (base name: "inStoreTerminals")', function() {
      // uncomment below and update the code to test the property inStoreTerminals
      //var instance = new PosTerminalManagementApi.MerchantAccount();
      //expect(instance).to.be();
    });

    it('should have the property inventoryTerminals (base name: "inventoryTerminals")', function() {
      // uncomment below and update the code to test the property inventoryTerminals
      //var instance = new PosTerminalManagementApi.MerchantAccount();
      //expect(instance).to.be();
    });
