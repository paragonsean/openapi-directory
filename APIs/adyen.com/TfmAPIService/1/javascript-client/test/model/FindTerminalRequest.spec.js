...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PosTerminalManagementApi.FindTerminalRequest();
  });
  ...
  describe('FindTerminalRequest', function() {
    it('should create an instance of FindTerminalRequest', function() {
      // uncomment below and update the code to test FindTerminalRequest
      //var instance = new PosTerminalManagementApi.FindTerminalRequest();
      //expect(instance).to.be.a(PosTerminalManagementApi.FindTerminalRequest);
    });
