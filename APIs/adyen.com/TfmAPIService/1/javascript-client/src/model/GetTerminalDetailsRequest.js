...
/**
 * The GetTerminalDetailsRequest model module.
 * @module model/GetTerminalDetailsRequest
 * @version 1
 */
class GetTerminalDetailsRequest {
    /**
     * Constructs a new <code>GetTerminalDetailsRequest</code>.
     * @alias module:model/GetTerminalDetailsRequest
     * @param terminal {String} The unique terminal ID in the format `[Device model]-[Serial number]`.   For example, **V400m-324689776**.
     */
    constructor(terminal) { 
        
        GetTerminalDetailsRequest.initialize(this, terminal);
    }
    ...
    /**
     * Constructs a <code>GetTerminalDetailsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTerminalDetailsRequest} obj Optional instance to populate.
     * @return {module:model/GetTerminalDetailsRequest} The populated <code>GetTerminalDetailsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTerminalDetailsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTerminalDetailsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTerminalDetailsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetTerminalDetailsRequest.RequiredProperties) {
...
export default GetTerminalDetailsRequest;
