...
OAIGetTerminalsUnderAccountRequest::OAIGetTerminalsUnderAccountRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTerminalsUnderAccountRequest::OAIGetTerminalsUnderAccountRequest() {
    this->initializeModel();
}

OAIGetTerminalsUnderAccountRequest::~OAIGetTerminalsUnderAccountRequest() {}

void OAIGetTerminalsUnderAccountRequest::initializeModel() {
...
void OAIGetTerminalsUnderAccountRequest::fromJson(QString jsonString) {
...
void OAIGetTerminalsUnderAccountRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetTerminalsUnderAccountRequest::asJson() const {
...
QJsonObject OAIGetTerminalsUnderAccountRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetTerminalsUnderAccountRequest::getCompanyAccount() const {
    return m_company_account;
}
void OAIGetTerminalsUnderAccountRequest::setCompanyAccount(const QString &company_account) {
    m_company_account = company_account;
    m_company_account_isSet = true;
}

bool OAIGetTerminalsUnderAccountRequest::is_company_account_Set() const{
    return m_company_account_isSet;
}

bool OAIGetTerminalsUnderAccountRequest::is_company_account_Valid() const{
    return m_company_account_isValid;
}

QString OAIGetTerminalsUnderAccountRequest::getMerchantAccount() const {
    return m_merchant_account;
}
void OAIGetTerminalsUnderAccountRequest::setMerchantAccount(const QString &merchant_account) {
    m_merchant_account = merchant_account;
    m_merchant_account_isSet = true;
}

bool OAIGetTerminalsUnderAccountRequest::is_merchant_account_Set() const{
    return m_merchant_account_isSet;
}

bool OAIGetTerminalsUnderAccountRequest::is_merchant_account_Valid() const{
    return m_merchant_account_isValid;
}

QString OAIGetTerminalsUnderAccountRequest::getStore() const {
    return m_store;
}
void OAIGetTerminalsUnderAccountRequest::setStore(const QString &store) {
    m_store = store;
    m_store_isSet = true;
}

bool OAIGetTerminalsUnderAccountRequest::is_store_Set() const{
    return m_store_isSet;
}

bool OAIGetTerminalsUnderAccountRequest::is_store_Valid() const{
    return m_store_isValid;
}

bool OAIGetTerminalsUnderAccountRequest::isSet() const {
...
bool OAIGetTerminalsUnderAccountRequest::isValid() const {
