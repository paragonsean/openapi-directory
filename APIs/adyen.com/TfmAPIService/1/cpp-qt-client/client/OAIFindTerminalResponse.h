...
/*
 * OAIFindTerminalResponse.h
 *
 * 
 */

#ifndef OAIFindTerminalResponse_H
#define OAIFindTerminalResponse_H
...
class OAIFindTerminalResponse : public OAIObject {
public:
    OAIFindTerminalResponse();
    OAIFindTerminalResponse(QString json);
    ~OAIFindTerminalResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFindTerminalResponse)

#endif // OAIFindTerminalResponse_H
