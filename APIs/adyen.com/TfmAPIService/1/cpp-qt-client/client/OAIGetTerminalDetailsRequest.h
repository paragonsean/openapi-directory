...
/*
 * OAIGetTerminalDetailsRequest.h
 *
 * 
 */

#ifndef OAIGetTerminalDetailsRequest_H
#define OAIGetTerminalDetailsRequest_H
...
class OAIGetTerminalDetailsRequest : public OAIObject {
public:
    OAIGetTerminalDetailsRequest();
    OAIGetTerminalDetailsRequest(QString json);
    ~OAIGetTerminalDetailsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTerminalDetailsRequest)

#endif // OAIGetTerminalDetailsRequest_H
