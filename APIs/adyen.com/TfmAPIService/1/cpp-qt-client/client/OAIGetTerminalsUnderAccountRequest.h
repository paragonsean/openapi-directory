...
/*
 * OAIGetTerminalsUnderAccountRequest.h
 *
 * 
 */

#ifndef OAIGetTerminalsUnderAccountRequest_H
#define OAIGetTerminalsUnderAccountRequest_H
...
class OAIGetTerminalsUnderAccountRequest : public OAIObject {
public:
    OAIGetTerminalsUnderAccountRequest();
    OAIGetTerminalsUnderAccountRequest(QString json);
    ~OAIGetTerminalsUnderAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTerminalsUnderAccountRequest)

#endif // OAIGetTerminalsUnderAccountRequest_H
