...
OAIAssignTerminalsResponse::OAIAssignTerminalsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssignTerminalsResponse::OAIAssignTerminalsResponse() {
    this->initializeModel();
}

OAIAssignTerminalsResponse::~OAIAssignTerminalsResponse() {}

void OAIAssignTerminalsResponse::initializeModel() {

    m_results_isSet = false;
    m_results_isValid = false;
}

void OAIAssignTerminalsResponse::fromJson(QString jsonString) {
...
void OAIAssignTerminalsResponse::fromJsonObject(QJsonObject json) {

    m_results_isValid = ::OpenAPI::fromJsonValue(m_results, json[QString("results")]);
    m_results_isSet = !json[QString("results")].isNull() && m_results_isValid;
}

QString OAIAssignTerminalsResponse::asJson() const {
...
QJsonObject OAIAssignTerminalsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_results.size() > 0) {
...
QMap<QString, QString> OAIAssignTerminalsResponse::getResults() const {
    return m_results;
}
void OAIAssignTerminalsResponse::setResults(const QMap<QString, QString> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIAssignTerminalsResponse::is_results_Set() const{
    return m_results_isSet;
}

bool OAIAssignTerminalsResponse::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIAssignTerminalsResponse::isSet() const {
...
bool OAIAssignTerminalsResponse::isValid() const {
