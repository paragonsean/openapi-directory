...
/*
 * OAIGetStoresUnderAccountRequest.h
 *
 * 
 */

#ifndef OAIGetStoresUnderAccountRequest_H
#define OAIGetStoresUnderAccountRequest_H
...
class OAIGetStoresUnderAccountRequest : public OAIObject {
public:
    OAIGetStoresUnderAccountRequest();
    OAIGetStoresUnderAccountRequest(QString json);
    ~OAIGetStoresUnderAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStoresUnderAccountRequest)

#endif // OAIGetStoresUnderAccountRequest_H
