...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenBinLookupApi.BinDetail();
  });
  ...
  describe('BinDetail', function() {
    it('should create an instance of BinDetail', function() {
      // uncomment below and update the code to test BinDetail
      //var instance = new AdyenBinLookupApi.BinDetail();
      //expect(instance).to.be.a(AdyenBinLookupApi.BinDetail);
    });
