...
class ThreeDS2CardRangeDetail(Model):
    ...
    def __init__(self, acs_info_ind: List[str]=None, brand_code: str=None, end_range: str=None, start_range: str=None, three_ds2_version: str=None, three_ds_method_url: str=None):
