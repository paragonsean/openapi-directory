...
class CardBin(Model):
    ...
    def __init__(self, bin: str=None, commercial: bool=None, funding_source: str=None, funds_availability: str=None, issuing_bank: str=None, issuing_country: str=None, issuing_currency: str=None, payment_method: str=None, payout_eligible: str=None, summary: str=None):
