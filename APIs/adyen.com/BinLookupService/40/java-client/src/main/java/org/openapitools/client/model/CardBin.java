...
public class CardBin {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CardBin
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CardBin.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CardBin.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CardBin` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("issuingBank") != null && !jsonObj.get("issuingBank").isJsonNull()) && !jsonObj.get("issuingBank").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("issuingCurrency") != null && !jsonObj.get("issuingCurrency").isJsonNull()) && !jsonObj.get("issuingCurrency").isJsonPrimitive()) {
