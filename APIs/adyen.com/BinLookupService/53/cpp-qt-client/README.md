...
class Example : public QObject {
    Q_OBJECT
    OAIThreeDSAvailabilityRequest create();
public Q_SLOTS:
...
OAIThreeDSAvailabilityRequest Example::create(){
    OAIThreeDSAvailabilityRequest obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIGeneralApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIGeneralApi::postGet3dsAvailabilitySignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIGeneralApi::postGet3dsAvailabilitySignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIThreeDSAvailabilityRequest oai_three_ds_availability_request = create(); // OAIThreeDSAvailabilityRequest | 
      apiInstance.postGet3dsAvailability(oai_three_ds_availability_request);
