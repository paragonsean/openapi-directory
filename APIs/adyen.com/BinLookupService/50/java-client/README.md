...
Adyen BinLookup API
- API version: 50
  - Build date: 2024-10-12T11:14:56.294175-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:50"
  }
```
...
* `target/openapi-java-client-50.jar`
* `target/lib/*.jar`
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://pal-test.adyen.com/pal/servlet/BinLookup/v50");
