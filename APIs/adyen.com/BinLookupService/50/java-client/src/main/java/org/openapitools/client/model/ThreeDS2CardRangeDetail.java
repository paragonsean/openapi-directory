...
public class ThreeDS2CardRangeDetail {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ThreeDS2CardRangeDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ThreeDS2CardRangeDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ThreeDS2CardRangeDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ThreeDS2CardRangeDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("endRange") != null && !jsonObj.get("endRange").isJsonNull()) && !jsonObj.get("endRange").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("startRange") != null && !jsonObj.get("startRange").isJsonNull()) && !jsonObj.get("startRange").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("threeDS2Version") != null && !jsonObj.get("threeDS2Version").isJsonNull()) && !jsonObj.get("threeDS2Version").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("threeDSMethodURL") != null && !jsonObj.get("threeDSMethodURL").isJsonNull()) && !jsonObj.get("threeDSMethodURL").isJsonPrimitive()) {
