...
class ThreeDSAvailabilityResponse(Model):
    ...
    def __init__(self, bin_details: BinDetail=None, ds_public_keys: List[DSPublicKeyDetail]=None, three_ds1_supported: bool=None, three_ds2_card_range_details: List[ThreeDS2CardRangeDetail]=None, three_ds2supported: bool=None):
        """ThreeDSAvailabilityResponse - a model defined in OpenAPI

        :param bin_details: The bin_details of this ThreeDSAvailabilityResponse.
    ...
    @property
    def bin_details(self):
        """Gets the bin_details of this ThreeDSAvailabilityResponse.

        Bin Group Details

        :return: The bin_details of this ThreeDSAvailabilityResponse.
        :rtype: BinDetail
        """
        return self._bin_details

    @bin_details.setter
    def bin_details(self, bin_details):
        """Sets the bin_details of this ThreeDSAvailabilityResponse.

        Bin Group Details

        :param bin_details: The bin_details of this ThreeDSAvailabilityResponse.
        :type bin_details: BinDetail
        """
