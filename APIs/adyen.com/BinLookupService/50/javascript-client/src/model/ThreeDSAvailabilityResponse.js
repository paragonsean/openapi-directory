...
class ThreeDSAvailabilityResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('binDetails')) {
                obj['binDetails'] = BinDetail.constructFromObject(data['binDetails']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['binDetails']) { // data not null
          BinDetail.validateJSON(data['binDetails']);
        }
...
/**
 * Bin Group Details
 * @member {module:model/BinDetail} binDetails
 */
ThreeDSAvailabilityResponse.prototype['binDetails'] = undefined;
