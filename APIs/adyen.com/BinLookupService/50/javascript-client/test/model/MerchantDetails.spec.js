...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenBinLookupApi.MerchantDetails();
  });
  ...
  describe('MerchantDetails', function() {
    it('should create an instance of MerchantDetails', function() {
      // uncomment below and update the code to test MerchantDetails
      //var instance = new AdyenBinLookupApi.MerchantDetails();
      //expect(instance).to.be.a(AdyenBinLookupApi.MerchantDetails);
    });
    ...
    it('should have the property enrolledIn3DSecure (base name: "enrolledIn3DSecure")', function() {
      // uncomment below and update the code to test the property enrolledIn3DSecure
      //var instance = new AdyenBinLookupApi.MerchantDetails();
      //expect(instance).to.be();
    });
