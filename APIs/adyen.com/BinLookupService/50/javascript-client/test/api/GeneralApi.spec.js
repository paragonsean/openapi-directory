...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenBinLookupApi.GeneralApi();
  });
  ...
  describe('GeneralApi', function() {
    describe('postGet3dsAvailability', function() {
      it('should call postGet3dsAvailability successfully', function(done) {
        //uncomment below and update the code to test postGet3dsAvailability
        //instance.postGet3dsAvailability(function(error) {
    ...
    describe('postGetCostEstimate', function() {
      it('should call postGetCostEstimate successfully', function(done) {
        //uncomment below and update the code to test postGetCostEstimate
        //instance.postGetCostEstimate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
