...
Adyen BinLookup API
- API version: 54
  - Build date: 2024-10-12T11:15:15.354258-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:54"
  }
```
...
* `target/openapi-java-client-54.jar`
* `target/lib/*.jar`
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://pal-test.adyen.com/pal/servlet/BinLookup/v54");
