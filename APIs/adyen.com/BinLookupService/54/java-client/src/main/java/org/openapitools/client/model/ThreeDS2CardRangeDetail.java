...
public class ThreeDS2CardRangeDetail {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("acsInfoInd") != null && !jsonObj.get("acsInfoInd").isJsonNull() && !jsonObj.get("acsInfoInd").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("threeDS2Versions") != null && !jsonObj.get("threeDS2Versions").isJsonNull() && !jsonObj.get("threeDS2Versions").isJsonArray()) {
