...
class CostEstimateResponse(Model):
    ...
    def __init__(self, card_bin: CardBin=None, cost_estimate_amount: Amount=None, cost_estimate_reference: str=None, result_code: str=None, surcharge_type: str=None):
        ...
        :param cost_estimate_reference: The cost_estimate_reference of this CostEstimateResponse.
        ...
        self._cost_estimate_reference = cost_estimate_reference
    ...
    @property
    def cost_estimate_reference(self):
        """Gets the cost_estimate_reference of this CostEstimateResponse.

        Adyen's 16-character reference associated with the request.

        :return: The cost_estimate_reference of this CostEstimateResponse.
        :rtype: str
        """
        return self._cost_estimate_reference

    @cost_estimate_reference.setter
    def cost_estimate_reference(self, cost_estimate_reference):
        """Sets the cost_estimate_reference of this CostEstimateResponse.

        Adyen's 16-character reference associated with the request.

        :param cost_estimate_reference: The cost_estimate_reference of this CostEstimateResponse.
        :type cost_estimate_reference: str
        """
