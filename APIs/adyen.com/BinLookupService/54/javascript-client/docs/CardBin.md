...
**commercial** | **Boolean** | If true, it indicates a commercial card. Enable this field via merchant account settings. | [optional] 
...
**issuerBin** | **String** | The first 8 digit of the card number. Enable this field via merchant account settings. | [optional] 
