...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenBinLookupApi.ThreeDSAvailabilityRequest();
  });
  ...
  describe('ThreeDSAvailabilityRequest', function() {
    it('should create an instance of ThreeDSAvailabilityRequest', function() {
      // uncomment below and update the code to test ThreeDSAvailabilityRequest
      //var instance = new AdyenBinLookupApi.ThreeDSAvailabilityRequest();
      //expect(instance).to.be.a(AdyenBinLookupApi.ThreeDSAvailabilityRequest);
    });
