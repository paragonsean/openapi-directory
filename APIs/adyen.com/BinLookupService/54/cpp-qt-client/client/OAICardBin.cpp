...
QString OAICardBin::getIssuerBin() const {
    return m_issuer_bin;
}
void OAICardBin::setIssuerBin(const QString &issuer_bin) {
    m_issuer_bin = issuer_bin;
    m_issuer_bin_isSet = true;
}

bool OAICardBin::is_issuer_bin_Set() const{
    return m_issuer_bin_isSet;
}

bool OAICardBin::is_issuer_bin_Valid() const{
