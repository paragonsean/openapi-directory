...
/*
 * OAIUpdatableAddress.h
 *
 * 
 */

#ifndef OAIUpdatableAddress_H
#define OAIUpdatableAddress_H
...
class OAIUpdatableAddress : public OAIObject {
public:
    OAIUpdatableAddress();
    OAIUpdatableAddress(QString json);
    ~OAIUpdatableAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatableAddress)

#endif // OAIUpdatableAddress_H
