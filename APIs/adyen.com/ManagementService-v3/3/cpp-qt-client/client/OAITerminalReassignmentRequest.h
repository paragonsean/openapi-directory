...
/*
 * OAITerminalReassignmentRequest.h
 *
 * 
 */

#ifndef OAITerminalReassignmentRequest_H
#define OAITerminalReassignmentRequest_H
...
class OAITerminalReassignmentRequest : public OAIObject {
public:
    OAITerminalReassignmentRequest();
    OAITerminalReassignmentRequest(QString json);
    ~OAITerminalReassignmentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITerminalReassignmentRequest)

#endif // OAITerminalReassignmentRequest_H
