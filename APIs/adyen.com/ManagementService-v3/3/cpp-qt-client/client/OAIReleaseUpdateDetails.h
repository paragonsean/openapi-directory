...
/*
 * OAIReleaseUpdateDetails.h
 *
 * 
 */

#ifndef OAIReleaseUpdateDetails_H
#define OAIReleaseUpdateDetails_H
...
class OAIReleaseUpdateDetails : public OAIObject {
public:
    OAIReleaseUpdateDetails();
    OAIReleaseUpdateDetails(QString json);
    ~OAIReleaseUpdateDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReleaseUpdateDetails)

#endif // OAIReleaseUpdateDetails_H
