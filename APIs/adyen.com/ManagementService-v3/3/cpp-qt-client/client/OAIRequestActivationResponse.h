...
/*
 * OAIRequestActivationResponse.h
 *
 * 
 */

#ifndef OAIRequestActivationResponse_H
#define OAIRequestActivationResponse_H
...
class OAIRequestActivationResponse : public OAIObject {
public:
    OAIRequestActivationResponse();
    OAIRequestActivationResponse(QString json);
    ~OAIRequestActivationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequestActivationResponse)

#endif // OAIRequestActivationResponse_H
