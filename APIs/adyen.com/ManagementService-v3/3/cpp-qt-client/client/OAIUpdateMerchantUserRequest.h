...
/*
 * OAIUpdateMerchantUserRequest.h
 *
 * 
 */

#ifndef OAIUpdateMerchantUserRequest_H
#define OAIUpdateMerchantUserRequest_H
...
class OAIUpdateMerchantUserRequest : public OAIObject {
public:
    OAIUpdateMerchantUserRequest();
    OAIUpdateMerchantUserRequest(QString json);
    ~OAIUpdateMerchantUserRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMerchantUserRequest)

#endif // OAIUpdateMerchantUserRequest_H
