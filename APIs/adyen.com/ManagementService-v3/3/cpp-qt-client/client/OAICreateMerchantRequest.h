...
/*
 * OAICreateMerchantRequest.h
 *
 * 
 */

#ifndef OAICreateMerchantRequest_H
#define OAICreateMerchantRequest_H
...
class OAICreateMerchantRequest : public OAIObject {
public:
    OAICreateMerchantRequest();
    OAICreateMerchantRequest(QString json);
    ~OAICreateMerchantRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMerchantRequest)

#endif // OAICreateMerchantRequest_H
