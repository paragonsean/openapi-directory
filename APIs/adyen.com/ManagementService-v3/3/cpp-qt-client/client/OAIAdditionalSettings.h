...
/*
 * OAIAdditionalSettings.h
 *
 * 
 */

#ifndef OAIAdditionalSettings_H
#define OAIAdditionalSettings_H
...
class OAIAdditionalSettings : public OAIObject {
public:
    OAIAdditionalSettings();
    OAIAdditionalSettings(QString json);
    ~OAIAdditionalSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdditionalSettings)

#endif // OAIAdditionalSettings_H
