...
/*
 * OAISplitConfigurationRule.h
 *
 * 
 */

#ifndef OAISplitConfigurationRule_H
#define OAISplitConfigurationRule_H

#include <QJsonObject>

#include "OAISplitConfigurationLogic.h"
#include <QString>
...
namespace OpenAPI {
class OAISplitConfigurationLogic;

class OAISplitConfigurationRule : public OAIObject {
public:
    OAISplitConfigurationRule();
    OAISplitConfigurationRule(QString json);
    ~OAISplitConfigurationRule() override;
    ...
    OAISplitConfigurationLogic getSplitLogic() const;
    void setSplitLogic(const OAISplitConfigurationLogic &split_logic);
    bool is_split_logic_Set() const;
    bool is_split_logic_Valid() const;
...
private:
    ...
    OAISplitConfigurationLogic m_split_logic;
    bool m_split_logic_isSet;
    bool m_split_logic_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISplitConfigurationRule)

#endif // OAISplitConfigurationRule_H
