...
/*
 * OAIUpdateCompanyApiCredentialRequest.h
 *
 * 
 */

#ifndef OAIUpdateCompanyApiCredentialRequest_H
#define OAIUpdateCompanyApiCredentialRequest_H
...
class OAIUpdateCompanyApiCredentialRequest : public OAIObject {
public:
    OAIUpdateCompanyApiCredentialRequest();
    OAIUpdateCompanyApiCredentialRequest(QString json);
    ~OAIUpdateCompanyApiCredentialRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCompanyApiCredentialRequest)

#endif // OAIUpdateCompanyApiCredentialRequest_H
