...
/*
 * OAIUpdateSplitConfigurationLogicRequest.h
 *
 * 
 */

#ifndef OAIUpdateSplitConfigurationLogicRequest_H
#define OAIUpdateSplitConfigurationLogicRequest_H
...
class OAIUpdateSplitConfigurationLogicRequest : public OAIObject {
public:
    OAIUpdateSplitConfigurationLogicRequest();
    OAIUpdateSplitConfigurationLogicRequest(QString json);
    ~OAIUpdateSplitConfigurationLogicRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSplitConfigurationLogicRequest)

#endif // OAIUpdateSplitConfigurationLogicRequest_H
