...
/*
 * OAIUpdateCompanyWebhookRequest.h
 *
 * 
 */

#ifndef OAIUpdateCompanyWebhookRequest_H
#define OAIUpdateCompanyWebhookRequest_H
...
class OAIUpdateCompanyWebhookRequest : public OAIObject {
public:
    OAIUpdateCompanyWebhookRequest();
    OAIUpdateCompanyWebhookRequest(QString json);
    ~OAIUpdateCompanyWebhookRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCompanyWebhookRequest)

#endif // OAIUpdateCompanyWebhookRequest_H
