...
#ifndef OAICompanyUser_H
#define OAICompanyUser_H
...
class OAICompanyUser : public OAIObject {
public:
    OAICompanyUser();
    OAICompanyUser(QString json);
    ~OAICompanyUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompanyUser)

#endif // OAICompanyUser_H
