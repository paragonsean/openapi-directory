...
/*
 * OAICreateCompanyWebhookRequest.h
 *
 * 
 */

#ifndef OAICreateCompanyWebhookRequest_H
#define OAICreateCompanyWebhookRequest_H
...
class OAICreateCompanyWebhookRequest : public OAIObject {
public:
    OAICreateCompanyWebhookRequest();
    OAICreateCompanyWebhookRequest(QString json);
    ~OAICreateCompanyWebhookRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCompanyWebhookRequest)

#endif // OAICreateCompanyWebhookRequest_H
