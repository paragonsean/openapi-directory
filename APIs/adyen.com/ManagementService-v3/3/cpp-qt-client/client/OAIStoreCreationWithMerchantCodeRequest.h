...
/*
 * OAIStoreCreationWithMerchantCodeRequest.h
 *
 * 
 */

#ifndef OAIStoreCreationWithMerchantCodeRequest_H
#define OAIStoreCreationWithMerchantCodeRequest_H
...
class OAIStoreCreationWithMerchantCodeRequest : public OAIObject {
public:
    OAIStoreCreationWithMerchantCodeRequest();
    OAIStoreCreationWithMerchantCodeRequest(QString json);
    ~OAIStoreCreationWithMerchantCodeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoreCreationWithMerchantCodeRequest)

#endif // OAIStoreCreationWithMerchantCodeRequest_H
