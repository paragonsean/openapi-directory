...
/*
 * OAIStoreCreationRequest.h
 *
 * 
 */

#ifndef OAIStoreCreationRequest_H
#define OAIStoreCreationRequest_H
...
class OAIStoreCreationRequest : public OAIObject {
public:
    OAIStoreCreationRequest();
    OAIStoreCreationRequest(QString json);
    ~OAIStoreCreationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoreCreationRequest)

#endif // OAIStoreCreationRequest_H
