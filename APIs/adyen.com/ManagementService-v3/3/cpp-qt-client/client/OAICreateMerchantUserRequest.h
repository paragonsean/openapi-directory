...
/*
 * OAICreateMerchantUserRequest.h
 *
 * 
 */

#ifndef OAICreateMerchantUserRequest_H
#define OAICreateMerchantUserRequest_H
...
class OAICreateMerchantUserRequest : public OAIObject {
public:
    OAICreateMerchantUserRequest();
    OAICreateMerchantUserRequest(QString json);
    ~OAICreateMerchantUserRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMerchantUserRequest)

#endif // OAICreateMerchantUserRequest_H
