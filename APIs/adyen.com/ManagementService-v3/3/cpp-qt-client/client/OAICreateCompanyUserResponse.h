...
/*
 * OAICreateCompanyUserResponse.h
 *
 * 
 */

#ifndef OAICreateCompanyUserResponse_H
#define OAICreateCompanyUserResponse_H
...
class OAICreateCompanyUserResponse : public OAIObject {
public:
    OAICreateCompanyUserResponse();
    OAICreateCompanyUserResponse(QString json);
    ~OAICreateCompanyUserResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCompanyUserResponse)

#endif // OAICreateCompanyUserResponse_H
