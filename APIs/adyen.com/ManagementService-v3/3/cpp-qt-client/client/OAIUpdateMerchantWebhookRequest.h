...
/*
 * OAIUpdateMerchantWebhookRequest.h
 *
 * 
 */

#ifndef OAIUpdateMerchantWebhookRequest_H
#define OAIUpdateMerchantWebhookRequest_H
...
class OAIUpdateMerchantWebhookRequest : public OAIObject {
public:
    OAIUpdateMerchantWebhookRequest();
    OAIUpdateMerchantWebhookRequest(QString json);
    ~OAIUpdateMerchantWebhookRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMerchantWebhookRequest)

#endif // OAIUpdateMerchantWebhookRequest_H
