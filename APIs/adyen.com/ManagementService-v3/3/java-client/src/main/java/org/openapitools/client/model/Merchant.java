...
public class Merchant {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("_links") != null && !jsonObj.get("_links").isJsonNull()) {
        MerchantLinks.validateJsonElement(jsonObj.get("_links"));
      }
      if ((jsonObj.get("captureDelay") != null && !jsonObj.get("captureDelay").isJsonNull()) && !jsonObj.get("captureDelay").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("defaultShopperInteraction") != null && !jsonObj.get("defaultShopperInteraction").isJsonNull()) && !jsonObj.get("defaultShopperInteraction").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("primarySettlementCurrency") != null && !jsonObj.get("primarySettlementCurrency").isJsonNull()) && !jsonObj.get("primarySettlementCurrency").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("shopWebAddress") != null && !jsonObj.get("shopWebAddress").isJsonNull()) && !jsonObj.get("shopWebAddress").isJsonPrimitive()) {
