...
public class UpdateSplitConfigurationLogicRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSplitConfigurationLogicRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSplitConfigurationLogicRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSplitConfigurationLogicRequest is not found in the empty JSON string", UpdateSplitConfigurationLogicRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSplitConfigurationLogicRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSplitConfigurationLogicRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateSplitConfigurationLogicRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSplitConfigurationLogicRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSplitConfigurationLogicRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSplitConfigurationLogicRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSplitConfigurationLogicRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSplitConfigurationLogicRequest>() {
           @Override
           public void write(JsonWriter out, UpdateSplitConfigurationLogicRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSplitConfigurationLogicRequest read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to UpdateSplitConfigurationLogicRequest
   */
  public static UpdateSplitConfigurationLogicRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSplitConfigurationLogicRequest.class);
  }
