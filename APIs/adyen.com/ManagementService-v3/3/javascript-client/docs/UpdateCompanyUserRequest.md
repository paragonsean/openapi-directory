# ManagementApi.UpdateCompanyUserRequest
...
**associatedMerchantAccounts** | **[String]** | The list of [merchant accounts](https://docs.adyen.com/account/account-structure#merchant-accounts) to associate the user with. | [optional] 
