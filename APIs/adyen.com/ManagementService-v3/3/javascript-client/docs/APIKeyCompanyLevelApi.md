# ManagementApi.APIKeyCompanyLevelApi
...
let apiInstance = new ManagementApi.APIKeyCompanyLevelApi();
...
apiInstance.postCompaniesCompanyIdApiCredentialsApiCredentialIdGenerateApiKey(companyId, apiCredentialId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
