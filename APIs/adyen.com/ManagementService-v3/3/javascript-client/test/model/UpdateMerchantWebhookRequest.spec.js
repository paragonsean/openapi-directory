...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.UpdateMerchantWebhookRequest();
  });
  ...
  describe('UpdateMerchantWebhookRequest', function() {
    it('should create an instance of UpdateMerchantWebhookRequest', function() {
      // uncomment below and update the code to test UpdateMerchantWebhookRequest
      //var instance = new ManagementApi.UpdateMerchantWebhookRequest();
      //expect(instance).to.be.a(ManagementApi.UpdateMerchantWebhookRequest);
    });
