...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.AndroidApp();
  });
  ...
  describe('AndroidApp', function() {
    it('should create an instance of AndroidApp', function() {
      // uncomment below and update the code to test AndroidApp
      //var instance = new ManagementApi.AndroidApp();
      //expect(instance).to.be.a(ManagementApi.AndroidApp);
    });
