...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.UpdatePaymentMethodInfo();
  });
  ...
  describe('UpdatePaymentMethodInfo', function() {
    it('should create an instance of UpdatePaymentMethodInfo', function() {
      // uncomment below and update the code to test UpdatePaymentMethodInfo
      //var instance = new ManagementApi.UpdatePaymentMethodInfo();
      //expect(instance).to.be.a(ManagementApi.UpdatePaymentMethodInfo);
    });
