...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.TestWebhookRequest();
  });
  ...
  describe('TestWebhookRequest', function() {
    it('should create an instance of TestWebhookRequest', function() {
      // uncomment below and update the code to test TestWebhookRequest
      //var instance = new ManagementApi.TestWebhookRequest();
      //expect(instance).to.be.a(ManagementApi.TestWebhookRequest);
    });
