...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.TerminalReassignmentRequest();
  });
  ...
  describe('TerminalReassignmentRequest', function() {
    it('should create an instance of TerminalReassignmentRequest', function() {
      // uncomment below and update the code to test TerminalReassignmentRequest
      //var instance = new ManagementApi.TerminalReassignmentRequest();
      //expect(instance).to.be.a(ManagementApi.TerminalReassignmentRequest);
    });
