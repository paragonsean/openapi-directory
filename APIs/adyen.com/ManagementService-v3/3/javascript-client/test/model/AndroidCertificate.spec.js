...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.AndroidCertificate();
  });
  ...
  describe('AndroidCertificate', function() {
    it('should create an instance of AndroidCertificate', function() {
      // uncomment below and update the code to test AndroidCertificate
      //var instance = new ManagementApi.AndroidCertificate();
      //expect(instance).to.be.a(ManagementApi.AndroidCertificate);
    });
