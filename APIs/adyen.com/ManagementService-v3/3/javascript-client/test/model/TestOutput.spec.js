...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.TestOutput();
  });
  ...
  describe('TestOutput', function() {
    it('should create an instance of TestOutput', function() {
      // uncomment below and update the code to test TestOutput
      //var instance = new ManagementApi.TestOutput();
      //expect(instance).to.be.a(ManagementApi.TestOutput);
    });
    ...
    it('should have the property requestSent (base name: "requestSent")', function() {
      // uncomment below and update the code to test the property requestSent
      //var instance = new ManagementApi.TestOutput();
      //expect(instance).to.be();
    });
