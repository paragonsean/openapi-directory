...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.CreateMerchantRequest();
  });
  ...
  describe('CreateMerchantRequest', function() {
    it('should create an instance of CreateMerchantRequest', function() {
      // uncomment below and update the code to test CreateMerchantRequest
      //var instance = new ManagementApi.CreateMerchantRequest();
      //expect(instance).to.be.a(ManagementApi.CreateMerchantRequest);
    });
