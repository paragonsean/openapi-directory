...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.CreateMerchantResponse();
  });
  ...
  describe('CreateMerchantResponse', function() {
    it('should create an instance of CreateMerchantResponse', function() {
      // uncomment below and update the code to test CreateMerchantResponse
      //var instance = new ManagementApi.CreateMerchantResponse();
      //expect(instance).to.be.a(ManagementApi.CreateMerchantResponse);
    });
