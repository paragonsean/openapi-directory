...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.PayAtTable();
  });
  ...
  describe('PayAtTable', function() {
    it('should create an instance of PayAtTable', function() {
      // uncomment below and update the code to test PayAtTable
      //var instance = new ManagementApi.PayAtTable();
      //expect(instance).to.be.a(ManagementApi.PayAtTable);
    });
