...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.PaymentMethodResponse();
  });
  ...
  describe('PaymentMethodResponse', function() {
    it('should create an instance of PaymentMethodResponse', function() {
      ...
      //var instance = new ManagementApi.PaymentMethodResponse();
      //expect(instance).to.be.a(ManagementApi.PaymentMethodResponse);
    });
    ...
    it('should have the property typesWithErrors (base name: "typesWithErrors")', function() {
      // uncomment below and update the code to test the property typesWithErrors
      //var instance = new ManagementApi.PaymentMethodResponse();
      //expect(instance).to.be();
    });
