...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.CreateCompanyWebhookRequest();
  });
  ...
  describe('CreateCompanyWebhookRequest', function() {
    it('should create an instance of CreateCompanyWebhookRequest', function() {
      // uncomment below and update the code to test CreateCompanyWebhookRequest
      //var instance = new ManagementApi.CreateCompanyWebhookRequest();
      //expect(instance).to.be.a(ManagementApi.CreateCompanyWebhookRequest);
    });
