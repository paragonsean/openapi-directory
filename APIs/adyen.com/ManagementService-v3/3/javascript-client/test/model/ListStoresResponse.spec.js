...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.ListStoresResponse();
  });
  ...
  describe('ListStoresResponse', function() {
    it('should create an instance of ListStoresResponse', function() {
      // uncomment below and update the code to test ListStoresResponse
      //var instance = new ManagementApi.ListStoresResponse();
      //expect(instance).to.be.a(ManagementApi.ListStoresResponse);
    });
