...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.CartesBancairesInfo();
  });
  ...
  describe('CartesBancairesInfo', function() {
    it('should create an instance of CartesBancairesInfo', function() {
      // uncomment below and update the code to test CartesBancairesInfo
      //var instance = new ManagementApi.CartesBancairesInfo();
      //expect(instance).to.be.a(ManagementApi.CartesBancairesInfo);
    });
