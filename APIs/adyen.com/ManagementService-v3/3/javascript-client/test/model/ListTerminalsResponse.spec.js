...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.ListTerminalsResponse();
  });
  ...
  describe('ListTerminalsResponse', function() {
    it('should create an instance of ListTerminalsResponse', function() {
      // uncomment below and update the code to test ListTerminalsResponse
      //var instance = new ManagementApi.ListTerminalsResponse();
      //expect(instance).to.be.a(ManagementApi.ListTerminalsResponse);
    });
