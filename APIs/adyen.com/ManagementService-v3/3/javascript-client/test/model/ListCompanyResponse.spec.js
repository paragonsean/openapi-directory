...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.ListCompanyResponse();
  });
  ...
  describe('ListCompanyResponse', function() {
    it('should create an instance of ListCompanyResponse', function() {
      // uncomment below and update the code to test ListCompanyResponse
      //var instance = new ManagementApi.ListCompanyResponse();
      //expect(instance).to.be.a(ManagementApi.ListCompanyResponse);
    });
