...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.StoreLocation();
  });
  ...
  describe('StoreLocation', function() {
    it('should create an instance of StoreLocation', function() {
      // uncomment below and update the code to test StoreLocation
      //var instance = new ManagementApi.StoreLocation();
      //expect(instance).to.be.a(ManagementApi.StoreLocation);
    });
