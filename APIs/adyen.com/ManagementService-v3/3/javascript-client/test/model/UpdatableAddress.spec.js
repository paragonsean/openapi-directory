...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.UpdatableAddress();
  });
  ...
  describe('UpdatableAddress', function() {
    it('should create an instance of UpdatableAddress', function() {
      // uncomment below and update the code to test UpdatableAddress
      //var instance = new ManagementApi.UpdatableAddress();
      //expect(instance).to.be.a(ManagementApi.UpdatableAddress);
    });
