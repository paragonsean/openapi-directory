...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.UpdateSplitConfigurationRuleRequest();
  });
  ...
  describe('UpdateSplitConfigurationRuleRequest', function() {
    it('should create an instance of UpdateSplitConfigurationRuleRequest', function() {
      // uncomment below and update the code to test UpdateSplitConfigurationRuleRequest
      //var instance = new ManagementApi.UpdateSplitConfigurationRuleRequest();
      //expect(instance).to.be.a(ManagementApi.UpdateSplitConfigurationRuleRequest);
    });
