...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.UpdateCompanyWebhookRequest();
  });
  ...
  describe('UpdateCompanyWebhookRequest', function() {
    it('should create an instance of UpdateCompanyWebhookRequest', function() {
      // uncomment below and update the code to test UpdateCompanyWebhookRequest
      //var instance = new ManagementApi.UpdateCompanyWebhookRequest();
      //expect(instance).to.be.a(ManagementApi.UpdateCompanyWebhookRequest);
    });
