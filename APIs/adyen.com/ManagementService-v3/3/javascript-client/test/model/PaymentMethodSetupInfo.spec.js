...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.PaymentMethodSetupInfo();
  });
  ...
  describe('PaymentMethodSetupInfo', function() {
    it('should create an instance of PaymentMethodSetupInfo', function() {
      // uncomment below and update the code to test PaymentMethodSetupInfo
      //var instance = new ManagementApi.PaymentMethodSetupInfo();
      //expect(instance).to.be.a(ManagementApi.PaymentMethodSetupInfo);
    });
