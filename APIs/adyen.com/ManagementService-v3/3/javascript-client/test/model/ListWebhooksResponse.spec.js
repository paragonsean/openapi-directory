...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.ListWebhooksResponse();
  });
  ...
  describe('ListWebhooksResponse', function() {
    it('should create an instance of ListWebhooksResponse', function() {
      // uncomment below and update the code to test ListWebhooksResponse
      //var instance = new ManagementApi.ListWebhooksResponse();
      //expect(instance).to.be.a(ManagementApi.ListWebhooksResponse);
    });
