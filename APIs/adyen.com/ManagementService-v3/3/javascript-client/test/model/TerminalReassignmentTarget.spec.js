...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.TerminalReassignmentTarget();
  });
  ...
  describe('TerminalReassignmentTarget', function() {
    it('should create an instance of TerminalReassignmentTarget', function() {
      // uncomment below and update the code to test TerminalReassignmentTarget
      //var instance = new ManagementApi.TerminalReassignmentTarget();
      //expect(instance).to.be.a(ManagementApi.TerminalReassignmentTarget);
    });
