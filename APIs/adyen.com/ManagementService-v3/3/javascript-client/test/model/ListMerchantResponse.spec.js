...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementApi.ListMerchantResponse();
  });
  ...
  describe('ListMerchantResponse', function() {
    it('should create an instance of ListMerchantResponse', function() {
      // uncomment below and update the code to test ListMerchantResponse
      //var instance = new ManagementApi.ListMerchantResponse();
      //expect(instance).to.be.a(ManagementApi.ListMerchantResponse);
    });
