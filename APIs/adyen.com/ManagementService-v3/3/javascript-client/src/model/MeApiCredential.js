...
/**
 * The MeApiCredential model module.
 * @module model/MeApiCredential
 * @version 3
 */
class MeApiCredential {
    /**
     * Constructs a new <code>MeApiCredential</code>.
     * @alias module:model/MeApiCredential
    ...
    constructor(active, allowedIpAddresses, clientKey, id, roles, username) { 
        ...
        MeApiCredential.initialize(this, active, allowedIpAddresses, clientKey, id, roles, username);
    }
    ...
    /**
     * Constructs a <code>MeApiCredential</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MeApiCredential} obj Optional instance to populate.
     * @return {module:model/MeApiCredential} The populated <code>MeApiCredential</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MeApiCredential();
    ...
    /**
     * Validates the JSON data with respect to <code>MeApiCredential</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MeApiCredential</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MeApiCredential.RequiredProperties) {
 ...
 */
MeApiCredential.prototype['allowedIpAddresses'] = undefined;
 ...
 */
MeApiCredential.prototype['allowedOrigins'] = undefined;
 ...
 */
MeApiCredential.prototype['associatedMerchantAccounts'] = undefined;
 ...
 */
MeApiCredential.prototype['clientKey'] = undefined;

/**
 * Name of the company linked to the API credential.
 * @member {String} companyName
 */
MeApiCredential.prototype['companyName'] = undefined;

/**
 * Description of the API credential.
 * @member {String} description
 */
MeApiCredential.prototype['description'] = undefined;

/**
 * Unique identifier of the API credential.
 * @member {String} id
 */
MeApiCredential.prototype['id'] = undefined;

/**
 * List of [roles](https://docs.adyen.com/development-resources/api-credentials#roles-1) for the API credential.
 * @member {Array.<String>} roles
 */
MeApiCredential.prototype['roles'] = undefined;
 ...
 */
MeApiCredential.prototype['username'] = undefined;
...
export default MeApiCredential;
