...
/**
 * The CreateCompanyApiCredentialResponse model module.
 * @module model/CreateCompanyApiCredentialResponse
 * @version 3
 */
class CreateCompanyApiCredentialResponse {
    /**
     * Constructs a new <code>CreateCompanyApiCredentialResponse</code>.
     * @alias module:model/CreateCompanyApiCredentialResponse
     ...
     * @param associatedMerchantAccounts {Array.<String>} List of merchant accounts that the API credential has access to.
     ...
     */
    constructor(active, allowedIpAddresses, apiKey, associatedMerchantAccounts, clientKey, id, password, roles, username) { 
        
        CreateCompanyApiCredentialResponse.initialize(this, active, allowedIpAddresses, apiKey, associatedMerchantAccounts, clientKey, id, password, roles, username);
    }
     ...
     */
    static initialize(obj, active, allowedIpAddresses, apiKey, associatedMerchantAccounts, clientKey, id, password, roles, username) { 
        obj['active'] = active;
        obj['allowedIpAddresses'] = allowedIpAddresses;
        obj['apiKey'] = apiKey;
        obj['associatedMerchantAccounts'] = associatedMerchantAccounts;
    ...
    /**
     * Constructs a <code>CreateCompanyApiCredentialResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCompanyApiCredentialResponse} obj Optional instance to populate.
     * @return {module:model/CreateCompanyApiCredentialResponse} The populated <code>CreateCompanyApiCredentialResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCompanyApiCredentialResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCompanyApiCredentialResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCompanyApiCredentialResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCompanyApiCredentialResponse.RequiredProperties) {
...
CreateCompanyApiCredentialResponse.RequiredProperties = ["active", "allowedIpAddresses", "apiKey", "associatedMerchantAccounts", "clientKey", "id", "password", "roles", "username"];

/**
 * References to resources linked to the API credential.
 * @member {module:model/ApiCredentialLinks} _links
 */
CreateCompanyApiCredentialResponse.prototype['_links'] = undefined;

/**
 * Indicates if the API credential is enabled. Must be set to **true** to use the credential in your integration.
 * @member {Boolean} active
 */
CreateCompanyApiCredentialResponse.prototype['active'] = undefined;
 ...
 */
CreateCompanyApiCredentialResponse.prototype['allowedIpAddresses'] = undefined;
 ...
 */
CreateCompanyApiCredentialResponse.prototype['allowedOrigins'] = undefined;

/**
 * The API key for the API credential that was created.
 * @member {String} apiKey
 */
CreateCompanyApiCredentialResponse.prototype['apiKey'] = undefined;

/**
 * List of merchant accounts that the API credential has access to.
 * @member {Array.<String>} associatedMerchantAccounts
 */
CreateCompanyApiCredentialResponse.prototype['associatedMerchantAccounts'] = undefined;
 ...
 */
CreateCompanyApiCredentialResponse.prototype['clientKey'] = undefined;

/**
 * Description of the API credential.
 * @member {String} description
 */
CreateCompanyApiCredentialResponse.prototype['description'] = undefined;

/**
 * Unique identifier of the API credential.
 * @member {String} id
 */
CreateCompanyApiCredentialResponse.prototype['id'] = undefined;

/**
 * The password for the API credential that was created.
 * @member {String} password
 */
CreateCompanyApiCredentialResponse.prototype['password'] = undefined;

/**
 * List of [roles](https://docs.adyen.com/development-resources/api-credentials#roles-1) for the API credential.
 * @member {Array.<String>} roles
 */
CreateCompanyApiCredentialResponse.prototype['roles'] = undefined;
 ...
 */
CreateCompanyApiCredentialResponse.prototype['username'] = undefined;
...
export default CreateCompanyApiCredentialResponse;
