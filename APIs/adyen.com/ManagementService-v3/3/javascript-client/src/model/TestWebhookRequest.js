...
/**
 * The TestWebhookRequest model module.
 * @module model/TestWebhookRequest
 * @version 3
 */
class TestWebhookRequest {
    /**
     * Constructs a new <code>TestWebhookRequest</code>.
     * @alias module:model/TestWebhookRequest
     */
    constructor() { 
        
        TestWebhookRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TestWebhookRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestWebhookRequest} obj Optional instance to populate.
     * @return {module:model/TestWebhookRequest} The populated <code>TestWebhookRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestWebhookRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>TestWebhookRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestWebhookRequest</code>.
     */
 ...
 */
TestWebhookRequest.prototype['notification'] = undefined;
 ...
 */
TestWebhookRequest.prototype['types'] = undefined;
...
export default TestWebhookRequest;
