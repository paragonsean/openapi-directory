...
/**
 * The CreateApiCredentialResponse model module.
 * @module model/CreateApiCredentialResponse
 * @version 3
 */
class CreateApiCredentialResponse {
    /**
     * Constructs a new <code>CreateApiCredentialResponse</code>.
     * @alias module:model/CreateApiCredentialResponse
     ...
     * @param apiKey {String} The API key for the API credential that was created.
     ...
     * @param password {String} The password for the API credential that was created.
     ...
     */
    constructor(active, allowedIpAddresses, apiKey, clientKey, id, password, roles, username) { 
        
        CreateApiCredentialResponse.initialize(this, active, allowedIpAddresses, apiKey, clientKey, id, password, roles, username);
    }
     ...
     */
    static initialize(obj, active, allowedIpAddresses, apiKey, clientKey, id, password, roles, username) { 
        obj['active'] = active;
    ...
    /**
     * Constructs a <code>CreateApiCredentialResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateApiCredentialResponse} obj Optional instance to populate.
     * @return {module:model/CreateApiCredentialResponse} The populated <code>CreateApiCredentialResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateApiCredentialResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateApiCredentialResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateApiCredentialResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateApiCredentialResponse.RequiredProperties) {
...
CreateApiCredentialResponse.RequiredProperties = ["active", "allowedIpAddresses", "apiKey", "clientKey", "id", "password", "roles", "username"];

/**
 * References to resources linked to the API credential.
 * @member {module:model/ApiCredentialLinks} _links
 */
CreateApiCredentialResponse.prototype['_links'] = undefined;

/**
 * Indicates if the API credential is enabled. Must be set to **true** to use the credential in your integration.
 * @member {Boolean} active
 */
CreateApiCredentialResponse.prototype['active'] = undefined;
 ...
 */
CreateApiCredentialResponse.prototype['allowedIpAddresses'] = undefined;
 ...
 */
CreateApiCredentialResponse.prototype['allowedOrigins'] = undefined;

/**
 * The API key for the API credential that was created.
 * @member {String} apiKey
 */
CreateApiCredentialResponse.prototype['apiKey'] = undefined;
 ...
 */
CreateApiCredentialResponse.prototype['clientKey'] = undefined;

/**
 * Description of the API credential.
 * @member {String} description
 */
CreateApiCredentialResponse.prototype['description'] = undefined;

/**
 * Unique identifier of the API credential.
 * @member {String} id
 */
CreateApiCredentialResponse.prototype['id'] = undefined;

/**
 * The password for the API credential that was created.
 * @member {String} password
 */
CreateApiCredentialResponse.prototype['password'] = undefined;

/**
 * List of [roles](https://docs.adyen.com/development-resources/api-credentials#roles-1) for the API credential.
 * @member {Array.<String>} roles
 */
CreateApiCredentialResponse.prototype['roles'] = undefined;
 ...
 */
CreateApiCredentialResponse.prototype['username'] = undefined;
...
export default CreateApiCredentialResponse;
