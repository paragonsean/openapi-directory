...
/**
 * The StoreSplitConfiguration model module.
 * @module model/StoreSplitConfiguration
 * @version 3
 */
class StoreSplitConfiguration {
    /**
     * Constructs a new <code>StoreSplitConfiguration</code>.
     * @alias module:model/StoreSplitConfiguration
     */
    constructor() { 
        
        StoreSplitConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StoreSplitConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoreSplitConfiguration} obj Optional instance to populate.
     * @return {module:model/StoreSplitConfiguration} The populated <code>StoreSplitConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoreSplitConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>StoreSplitConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoreSplitConfiguration</code>.
     */
 ...
 */
StoreSplitConfiguration.prototype['balanceAccountId'] = undefined;
 ...
 */
StoreSplitConfiguration.prototype['splitConfigurationId'] = undefined;
...
export default StoreSplitConfiguration;
