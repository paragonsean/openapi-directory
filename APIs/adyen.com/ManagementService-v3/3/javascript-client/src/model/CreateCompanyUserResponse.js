...
/**
 * The CreateCompanyUserResponse model module.
 * @module model/CreateCompanyUserResponse
 * @version 3
 */
class CreateCompanyUserResponse {
    /**
     * Constructs a new <code>CreateCompanyUserResponse</code>.
     * @alias module:model/CreateCompanyUserResponse
    ...
    constructor(email, id, roles, timeZoneCode, username) { 
        ...
        CreateCompanyUserResponse.initialize(this, email, id, roles, timeZoneCode, username);
    }
    ...
    /**
     * Constructs a <code>CreateCompanyUserResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCompanyUserResponse} obj Optional instance to populate.
     * @return {module:model/CreateCompanyUserResponse} The populated <code>CreateCompanyUserResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCompanyUserResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCompanyUserResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCompanyUserResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCompanyUserResponse.RequiredProperties) {
...
CreateCompanyUserResponse.RequiredProperties = ["email", "id", "roles", "timeZoneCode", "username"];

/**
 * References to resources connected with this user.
 * @member {module:model/Links} _links
 */
CreateCompanyUserResponse.prototype['_links'] = undefined;

/**
 * The list of [account groups](https://docs.adyen.com/account/account-structure#account-groups) associated with this user.
 * @member {Array.<String>} accountGroups
 */
CreateCompanyUserResponse.prototype['accountGroups'] = undefined;

/**
 * Indicates whether this user is active.
 * @member {Boolean} active
 */
CreateCompanyUserResponse.prototype['active'] = undefined;

/**
 * Set of apps available to this user
 * @member {Array.<String>} apps
 */
CreateCompanyUserResponse.prototype['apps'] = undefined;
 ...
 */
CreateCompanyUserResponse.prototype['associatedMerchantAccounts'] = undefined;

/**
 * The email address of the user.
 * @member {String} email
 */
CreateCompanyUserResponse.prototype['email'] = undefined;

/**
 * The unique identifier of the user.
 * @member {String} id
 */
CreateCompanyUserResponse.prototype['id'] = undefined;

/**
 * The user's full name.
 * @member {module:model/Name} name
 */
CreateCompanyUserResponse.prototype['name'] = undefined;

/**
 * The list of [roles](https://docs.adyen.com/account/user-roles) for this user.
 * @member {Array.<String>} roles
 */
CreateCompanyUserResponse.prototype['roles'] = undefined;

/**
 * The [tz database name](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) of the time zone of the user. For example, **Europe/Amsterdam**.
 * @member {String} timeZoneCode
 */
CreateCompanyUserResponse.prototype['timeZoneCode'] = undefined;

/**
 * The username for this user.
 * @member {String} username
 */
CreateCompanyUserResponse.prototype['username'] = undefined;
...
export default CreateCompanyUserResponse;
