...
class User {
    ...
    constructor(email, id, roles, timeZoneCode, username) { 
        ...
        User.initialize(this, email, id, roles, timeZoneCode, username);
    }
...
User.RequiredProperties = ["email", "id", "roles", "timeZoneCode", "username"];
 ...
 */
User.prototype['accountGroups'] = undefined;
 ...
 */
User.prototype['timeZoneCode'] = undefined;
