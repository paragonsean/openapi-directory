...
async def get_merchants_merchant_id_api_credentials(request: web.Request, merchant_id, page_number=None, page_size=None) -> web.Response:
...
async def get_merchants_merchant_id_api_credentials_api_credential_id(request: web.Request, merchant_id, api_credential_id) -> web.Response:
...
async def patch_merchants_merchant_id_api_credentials_api_credential_id(request: web.Request, merchant_id, api_credential_id, body=None) -> web.Response:
    ...
    """
    body = UpdateMerchantApiCredentialRequest.from_dict(body)
    return web.Response(status=200)


async def post_merchants_merchant_id_api_credentials(request: web.Request, merchant_id, body=None) -> web.Response:
    ...
    """
    body = CreateMerchantApiCredentialRequest.from_dict(body)
    return web.Response(status=200)
