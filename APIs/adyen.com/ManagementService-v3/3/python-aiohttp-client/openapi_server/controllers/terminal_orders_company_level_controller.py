...
async def get_companies_company_id_billing_entities(request: web.Request, company_id, name=None) -> web.Response:
...
async def get_companies_company_id_shipping_locations(request: web.Request, company_id, name=None, offset=None, limit=None) -> web.Response:
...
async def get_companies_company_id_terminal_models(request: web.Request, company_id) -> web.Response:
...
async def get_companies_company_id_terminal_orders(request: web.Request, company_id, customer_order_reference=None, status=None, offset=None, limit=None) -> web.Response:
...
async def get_companies_company_id_terminal_orders_order_id(request: web.Request, company_id, order_id) -> web.Response:
    """Get an order
...
async def get_companies_company_id_terminal_products(request: web.Request, company_id, country, terminal_model_id=None, offset=None, limit=None) -> web.Response:
    ...
    :type country: str
    :param terminal_model_id: The terminal model to return products for. Use the ID returned in the [GET &#x60;/terminalModels&#x60;](https://docs.adyen.com/api-explorer/#/ManagementService/latest/get/companies/{companyId}/terminalModels) response. For example, **Verifone.M400**
...
async def patch_companies_company_id_terminal_orders_order_id(request: web.Request, company_id, order_id, body=None) -> web.Response:
    """Update an order
...
async def post_companies_company_id_shipping_locations(request: web.Request, company_id, body=None) -> web.Response:
...
async def post_companies_company_id_terminal_orders(request: web.Request, company_id, body=None) -> web.Response:
    """Create an order
...
async def post_companies_company_id_terminal_orders_order_id_cancel(request: web.Request, company_id, order_id) -> web.Response:
    """Cancel an order
