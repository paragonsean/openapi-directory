...
async def delete_companies_company_id_api_credentials_api_credential_id_allowed_origins_origin_id(request: web.Request, company_id, api_credential_id, origin_id) -> web.Response:
...
async def get_companies_company_id_api_credentials_api_credential_id_allowed_origins(request: web.Request, company_id, api_credential_id) -> web.Response:
...
async def get_companies_company_id_api_credentials_api_credential_id_allowed_origins_origin_id(request: web.Request, company_id, api_credential_id, origin_id) -> web.Response:
...
async def post_companies_company_id_api_credentials_api_credential_id_allowed_origins(request: web.Request, company_id, api_credential_id, body=None) -> web.Response:
