...
async def post_merchants_merchant_id_api_credentials_api_credential_id_generate_client_key(request: web.Request, merchant_id, api_credential_id) -> web.Response:
