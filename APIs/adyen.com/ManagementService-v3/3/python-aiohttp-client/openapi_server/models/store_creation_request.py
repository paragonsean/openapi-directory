...
class StoreCreationRequest(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, address: StoreLocation=None, business_line_ids: List[str]=None, description: str=None, external_reference_id: str=None, phone_number: str=None, reference: str=None, shopper_statement: str=None, split_configuration: StoreSplitConfiguration=None):
        """StoreCreationRequest - a model defined in OpenAPI

        :param address: The address of this StoreCreationRequest.
        :param business_line_ids: The business_line_ids of this StoreCreationRequest.
        :param description: The description of this StoreCreationRequest.
        :param external_reference_id: The external_reference_id of this StoreCreationRequest.
        :param phone_number: The phone_number of this StoreCreationRequest.
        :param reference: The reference of this StoreCreationRequest.
        :param shopper_statement: The shopper_statement of this StoreCreationRequest.
        :param split_configuration: The split_configuration of this StoreCreationRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StoreCreationRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StoreCreationRequest of this StoreCreationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def address(self):
        """Gets the address of this StoreCreationRequest.

        The address of the store.

        :return: The address of this StoreCreationRequest.
        :rtype: StoreLocation
        """
    ...
    def address(self, address):
        """Sets the address of this StoreCreationRequest.
    ...
    def business_line_ids(self):
        """Gets the business_line_ids of this StoreCreationRequest.

        The unique identifiers of the [business lines](https://docs.adyen.com/api-explorer/legalentity/latest/post/businessLines#responses-200-id) that the store is associated with. If not specified, the business line of the merchant account is used. Required when there are multiple business lines under the merchant account.

        :return: The business_line_ids of this StoreCreationRequest.
        :rtype: List[str]
        """
    ...
    def business_line_ids(self, business_line_ids):
        """Sets the business_line_ids of this StoreCreationRequest.
    ...
    def description(self):
        """Gets the description of this StoreCreationRequest.

        Your description of the store.

        :return: The description of this StoreCreationRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this StoreCreationRequest.
    ...
    def external_reference_id(self):
        """Gets the external_reference_id of this StoreCreationRequest.
        ...
        :return: The external_reference_id of this StoreCreationRequest.
        :rtype: str
        """
    ...
    def external_reference_id(self, external_reference_id):
        """Sets the external_reference_id of this StoreCreationRequest.
    ...
    def phone_number(self):
        """Gets the phone_number of this StoreCreationRequest.
        ...
        :return: The phone_number of this StoreCreationRequest.
        :rtype: str
        """
    ...
    def phone_number(self, phone_number):
        """Sets the phone_number of this StoreCreationRequest.
    ...
    @property
    def reference(self):
        """Gets the reference of this StoreCreationRequest.
        ...
        :return: The reference of this StoreCreationRequest.
        :rtype: str
        """
    ...
    def reference(self, reference):
        """Sets the reference of this StoreCreationRequest.
    ...
    def shopper_statement(self):
        """Gets the shopper_statement of this StoreCreationRequest.
        ...
        :return: The shopper_statement of this StoreCreationRequest.
        :rtype: str
        """
    ...
    def shopper_statement(self, shopper_statement):
        """Sets the shopper_statement of this StoreCreationRequest.
    ...
    def split_configuration(self):
        """Gets the split_configuration of this StoreCreationRequest.

        Rules for Adyen for Platforms merchants to split the transaction amount and fees.

        :return: The split_configuration of this StoreCreationRequest.
    ...
    def split_configuration(self, split_configuration):
        """Sets the split_configuration of this StoreCreationRequest.
