...
class User(Model):
    ...
    def __init__(self, links: Links=None, account_groups: List[str]=None, active: bool=None, apps: List[str]=None, email: str=None, id: str=None, name: Name=None, roles: List[str]=None, time_zone_code: str=None, username: str=None):
        ...
        :param account_groups: The account_groups of this User.
        :param active: The active of this User.
        :param apps: The apps of this User.
        :param email: The email of this User.
        :param id: The id of this User.
        :param name: The name of this User.
        :param roles: The roles of this User.
        :param time_zone_code: The time_zone_code of this User.
    ...
    def account_groups(self):
        """Gets the account_groups of this User.

        The list of [account groups](https://docs.adyen.com/account/account-structure#account-groups) associated with this user.

        :return: The account_groups of this User.
        :rtype: List[str]
        """
    ...
    def account_groups(self, account_groups):
        """Sets the account_groups of this User.
    ...
    def time_zone_code(self):
        """Gets the time_zone_code of this User.

        The [tz database name](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) of the time zone of the user. For example, **Europe/Amsterdam**.

        :return: The time_zone_code of this User.
        :rtype: str
        """
    ...
    def time_zone_code(self, time_zone_code):
        """Sets the time_zone_code of this User.
