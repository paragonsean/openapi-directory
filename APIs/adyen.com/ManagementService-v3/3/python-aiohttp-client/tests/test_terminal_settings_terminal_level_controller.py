...
async def test_get_terminals_terminal_id_terminal_logos(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/terminals/{terminal_id}/terminalLogos'.format(terminal_id='terminal_id_example'),
        headers=headers,
        )
...
async def test_get_terminals_terminal_id_terminal_settings(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/terminals/{terminal_id}/terminalSettings'.format(terminal_id='terminal_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_patch_terminals_terminal_id_terminal_logos(client):
...
async def test_patch_terminals_terminal_id_terminal_settings(client):
