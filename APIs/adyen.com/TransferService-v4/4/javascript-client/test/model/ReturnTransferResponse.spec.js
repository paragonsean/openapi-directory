...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.ReturnTransferResponse();
  });
  ...
  describe('ReturnTransferResponse', function() {
    it('should create an instance of ReturnTransferResponse', function() {
      // uncomment below and update the code to test ReturnTransferResponse
      //var instance = new TransfersApi.ReturnTransferResponse();
      //expect(instance).to.be.a(TransfersApi.ReturnTransferResponse);
    });
