...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.BankAccountV3();
  });
  ...
  describe('BankAccountV3', function() {
    it('should create an instance of BankAccountV3', function() {
      // uncomment below and update the code to test BankAccountV3
      //var instance = new TransfersApi.BankAccountV3();
      //expect(instance).to.be.a(TransfersApi.BankAccountV3);
    });
