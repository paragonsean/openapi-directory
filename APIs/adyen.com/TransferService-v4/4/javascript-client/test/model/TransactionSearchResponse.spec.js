...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.TransactionSearchResponse();
  });
  ...
  describe('TransactionSearchResponse', function() {
    it('should create an instance of TransactionSearchResponse', function() {
      // uncomment below and update the code to test TransactionSearchResponse
      //var instance = new TransfersApi.TransactionSearchResponse();
      //expect(instance).to.be.a(TransfersApi.TransactionSearchResponse);
    });
