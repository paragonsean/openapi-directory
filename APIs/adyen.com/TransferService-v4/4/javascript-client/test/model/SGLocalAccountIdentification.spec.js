...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.SGLocalAccountIdentification();
  });
  ...
  describe('SGLocalAccountIdentification', function() {
    it('should create an instance of SGLocalAccountIdentification', function() {
      // uncomment below and update the code to test SGLocalAccountIdentification
      //var instance = new TransfersApi.SGLocalAccountIdentification();
      //expect(instance).to.be.a(TransfersApi.SGLocalAccountIdentification);
    });
