...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.InternalCategoryData();
  });
  ...
  describe('InternalCategoryData', function() {
    it('should create an instance of InternalCategoryData', function() {
      // uncomment below and update the code to test InternalCategoryData
      //var instance = new TransfersApi.InternalCategoryData();
      //expect(instance).to.be.a(TransfersApi.InternalCategoryData);
    });
