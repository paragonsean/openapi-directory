...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.TransferNotificationValidationFact();
  });
  ...
  describe('TransferNotificationValidationFact', function() {
    it('should create an instance of TransferNotificationValidationFact', function() {
      // uncomment below and update the code to test TransferNotificationValidationFact
      //var instance = new TransfersApi.TransferNotificationValidationFact();
      //expect(instance).to.be.a(TransfersApi.TransferNotificationValidationFact);
    });
