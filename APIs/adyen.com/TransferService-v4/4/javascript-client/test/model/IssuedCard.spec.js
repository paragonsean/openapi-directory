...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.IssuedCard();
  });
  ...
  describe('IssuedCard', function() {
    it('should create an instance of IssuedCard', function() {
      // uncomment below and update the code to test IssuedCard
      //var instance = new TransfersApi.IssuedCard();
      //expect(instance).to.be.a(TransfersApi.IssuedCard);
    });
    ...
    it('should have the property panEntryMode (base name: "panEntryMode")', function() {
      // uncomment below and update the code to test the property panEntryMode
      //var instance = new TransfersApi.IssuedCard();
      //expect(instance).to.be();
    });
    ...
    it('should have the property schemeTraceId (base name: "schemeTraceId")', function() {
      // uncomment below and update the code to test the property schemeTraceId
      //var instance = new TransfersApi.IssuedCard();
      //expect(instance).to.be();
    });

    it('should have the property schemeUniqueTransactionId (base name: "schemeUniqueTransactionId")', function() {
      // uncomment below and update the code to test the property schemeUniqueTransactionId
      //var instance = new TransfersApi.IssuedCard();
      //expect(instance).to.be();
    });
    ...
    it('should have the property validationFacts (base name: "validationFacts")', function() {
      // uncomment below and update the code to test the property validationFacts
      //var instance = new TransfersApi.IssuedCard();
      //expect(instance).to.be();
    });
