...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.BankCategoryData();
  });
  ...
  describe('BankCategoryData', function() {
    it('should create an instance of BankCategoryData', function() {
      // uncomment below and update the code to test BankCategoryData
      //var instance = new TransfersApi.BankCategoryData();
      //expect(instance).to.be.a(TransfersApi.BankCategoryData);
    });
