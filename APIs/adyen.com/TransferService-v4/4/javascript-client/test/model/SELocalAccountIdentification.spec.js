...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.SELocalAccountIdentification();
  });
  ...
  describe('SELocalAccountIdentification', function() {
    it('should create an instance of SELocalAccountIdentification', function() {
      // uncomment below and update the code to test SELocalAccountIdentification
      //var instance = new TransfersApi.SELocalAccountIdentification();
      //expect(instance).to.be.a(TransfersApi.SELocalAccountIdentification);
    });
