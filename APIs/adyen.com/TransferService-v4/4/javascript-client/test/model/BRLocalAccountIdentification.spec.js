...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.BRLocalAccountIdentification();
  });
  ...
  describe('BRLocalAccountIdentification', function() {
    it('should create an instance of BRLocalAccountIdentification', function() {
      // uncomment below and update the code to test BRLocalAccountIdentification
      //var instance = new TransfersApi.BRLocalAccountIdentification();
      //expect(instance).to.be.a(TransfersApi.BRLocalAccountIdentification);
    });
