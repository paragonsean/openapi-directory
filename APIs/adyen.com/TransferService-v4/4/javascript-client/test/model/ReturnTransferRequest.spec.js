...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.ReturnTransferRequest();
  });
  ...
  describe('ReturnTransferRequest', function() {
    it('should create an instance of ReturnTransferRequest', function() {
      // uncomment below and update the code to test ReturnTransferRequest
      //var instance = new TransfersApi.ReturnTransferRequest();
      //expect(instance).to.be.a(TransfersApi.ReturnTransferRequest);
    });
