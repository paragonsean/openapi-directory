...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.NZLocalAccountIdentification();
  });
  ...
  describe('NZLocalAccountIdentification', function() {
    it('should create an instance of NZLocalAccountIdentification', function() {
      // uncomment below and update the code to test NZLocalAccountIdentification
      //var instance = new TransfersApi.NZLocalAccountIdentification();
      //expect(instance).to.be.a(TransfersApi.NZLocalAccountIdentification);
    });
