...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.TransferInfo();
  });
  ...
  describe('TransferInfo', function() {
    it('should create an instance of TransferInfo', function() {
      // uncomment below and update the code to test TransferInfo
      //var instance = new TransfersApi.TransferInfo();
      //expect(instance).to.be.a(TransfersApi.TransferInfo);
    });
    ...
    it('should have the property ultimateParty (base name: "ultimateParty")', function() {
      // uncomment below and update the code to test the property ultimateParty
      //var instance = new TransfersApi.TransferInfo();
      //expect(instance).to.be();
    });
