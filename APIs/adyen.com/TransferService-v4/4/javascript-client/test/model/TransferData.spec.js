...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.TransferData();
  });
  ...
  describe('TransferData', function() {
    it('should create an instance of TransferData', function() {
      // uncomment below and update the code to test TransferData
      //var instance = new TransfersApi.TransferData();
      //expect(instance).to.be.a(TransfersApi.TransferData);
    });
