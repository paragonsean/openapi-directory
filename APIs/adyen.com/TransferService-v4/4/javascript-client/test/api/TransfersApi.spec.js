...
(function(root, factory) {
  ...
  describe('TransfersApi', function() {
    ...
    describe('postTransfersTransferIdReturns', function() {
      it('should call postTransfersTransferIdReturns successfully', function(done) {
        //uncomment below and update the code to test postTransfersTransferIdReturns
        //instance.postTransfersTransferIdReturns(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
