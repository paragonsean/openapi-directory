...
/**
 * The InternalCategoryData model module.
 * @module model/InternalCategoryData
 * @version 4
 */
class InternalCategoryData {
    /**
     * Constructs a new <code>InternalCategoryData</code>.
     * @alias module:model/InternalCategoryData
     */
    constructor() { 
        
        InternalCategoryData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InternalCategoryData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InternalCategoryData} obj Optional instance to populate.
     * @return {module:model/InternalCategoryData} The populated <code>InternalCategoryData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InternalCategoryData();
    ...
    /**
     * Validates the JSON data with respect to <code>InternalCategoryData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InternalCategoryData</code>.
     */
 ...
 */
InternalCategoryData.prototype['modificationMerchantReference'] = undefined;

/**
 * The capture reference included in the transfer.
 * @member {String} modificationPspReference
 */
InternalCategoryData.prototype['modificationPspReference'] = undefined;

/**
 * **internal**
 * @member {module:model/InternalCategoryData.TypeEnum} type
 * @default 'internal'
 */
InternalCategoryData.prototype['type'] = 'internal';
...
export default InternalCategoryData;
