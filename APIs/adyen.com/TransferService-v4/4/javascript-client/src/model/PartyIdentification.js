...
class PartyIdentification {
    ...
    constructor(fullName) { 
        ...
        PartyIdentification.initialize(this, fullName);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of PartyIdentification.RequiredProperties) {
...
PartyIdentification.RequiredProperties = ["fullName"];
 ...
 */
PartyIdentification.prototype['dateOfBirth'] = undefined;

/**
 * First name of the individual.  Allowed only when `type` is **individual**.
 * @member {String} firstName
 */
PartyIdentification.prototype['firstName'] = undefined;

/**
 * The name of the entity.
 * @member {String} fullName
 */
PartyIdentification.prototype['fullName'] = undefined;

/**
 * Last name of the individual.  Allowed only when `type` is **individual**.
 * @member {String} lastName
 */
PartyIdentification.prototype['lastName'] = undefined;
 ...
 */
PartyIdentification.prototype['reference'] = undefined;

/**
 * The type of entity that owns the bank account.   Possible values: **individual**, **organization**, or **unknown**.
 * @member {module:model/PartyIdentification.TypeEnum} type
 * @default 'unknown'
 */
PartyIdentification.prototype['type'] = 'unknown';
