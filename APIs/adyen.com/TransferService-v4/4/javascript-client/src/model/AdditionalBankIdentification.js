...
/**
 * The AdditionalBankIdentification model module.
 * @module model/AdditionalBankIdentification
 * @version 4
 */
class AdditionalBankIdentification {
    /**
     * Constructs a new <code>AdditionalBankIdentification</code>.
     * @alias module:model/AdditionalBankIdentification
     */
    constructor() { 
        
        AdditionalBankIdentification.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdditionalBankIdentification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdditionalBankIdentification} obj Optional instance to populate.
     * @return {module:model/AdditionalBankIdentification} The populated <code>AdditionalBankIdentification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdditionalBankIdentification();
    ...
    /**
     * Validates the JSON data with respect to <code>AdditionalBankIdentification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdditionalBankIdentification</code>.
     */
 ...
 * @member {String} code
 */
AdditionalBankIdentification.prototype['code'] = undefined;
 ...
 * @member {module:model/AdditionalBankIdentification.TypeEnum} type
 */
AdditionalBankIdentification.prototype['type'] = undefined;
...
export default AdditionalBankIdentification;
