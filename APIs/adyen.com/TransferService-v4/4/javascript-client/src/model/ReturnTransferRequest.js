...
/**
 * The ReturnTransferRequest model module.
 * @module model/ReturnTransferRequest
 * @version 4
 */
class ReturnTransferRequest {
    /**
     * Constructs a new <code>ReturnTransferRequest</code>.
     * @alias module:model/ReturnTransferRequest
     * @param amount {module:model/Amount} Contains information about the amount to be returned.
     */
    constructor(amount) { 
        
        ReturnTransferRequest.initialize(this, amount);
    }
    ...
    /**
     * Constructs a <code>ReturnTransferRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReturnTransferRequest} obj Optional instance to populate.
     * @return {module:model/ReturnTransferRequest} The populated <code>ReturnTransferRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReturnTransferRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ReturnTransferRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReturnTransferRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReturnTransferRequest.RequiredProperties) {
...
ReturnTransferRequest.RequiredProperties = ["amount"];

/**
 * Contains information about the amount to be returned.
 * @member {module:model/Amount} amount
 */
ReturnTransferRequest.prototype['amount'] = undefined;
 ...
 */
ReturnTransferRequest.prototype['reference'] = undefined;
...
export default ReturnTransferRequest;
