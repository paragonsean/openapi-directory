...
class TransferData {
    ...
    constructor(reference) { 
        ...
        TransferData.initialize(this, reference);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TransferData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransferData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransferData.RequiredProperties) {
...
TransferData.RequiredProperties = ["reference"];

/**
 * The ID of the resource.
 * @member {String} id
 */
TransferData.prototype['id'] = undefined;
 ...
 */
TransferData.prototype['reference'] = undefined;
