...
/*
 * OAIBankCategoryData.h
 *
 * 
 */

#ifndef OAIBankCategoryData_H
#define OAIBankCategoryData_H
...
class OAIBankCategoryData : public OAIObject {
public:
    OAIBankCategoryData();
    OAIBankCategoryData(QString json);
    ~OAIBankCategoryData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankCategoryData)

#endif // OAIBankCategoryData_H
