...
/*
 * OAISGLocalAccountIdentification.h
 *
 * 
 */

#ifndef OAISGLocalAccountIdentification_H
#define OAISGLocalAccountIdentification_H
...
class OAISGLocalAccountIdentification : public OAIObject {
public:
    OAISGLocalAccountIdentification();
    OAISGLocalAccountIdentification(QString json);
    ~OAISGLocalAccountIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISGLocalAccountIdentification)

#endif // OAISGLocalAccountIdentification_H
