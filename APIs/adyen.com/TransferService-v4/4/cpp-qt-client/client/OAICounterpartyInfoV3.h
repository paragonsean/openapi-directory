...
/*
 * OAICounterpartyInfoV3.h
 *
 * 
 */

#ifndef OAICounterpartyInfoV3_H
#define OAICounterpartyInfoV3_H
...
namespace OpenAPI {
class OAIBankAccountV3;

class OAICounterpartyInfoV3 : public OAIObject {
public:
    OAICounterpartyInfoV3();
    OAICounterpartyInfoV3(QString json);
    ~OAICounterpartyInfoV3() override;
    ...
    OAIBankAccountV3 getBankAccount() const;
    void setBankAccount(const OAIBankAccountV3 &bank_account);
...
private:
    ...
    OAIBankAccountV3 m_bank_account;
...
Q_DECLARE_METATYPE(OpenAPI::OAICounterpartyInfoV3)

#endif // OAICounterpartyInfoV3_H
