...
/*
 * OAITransferNotificationValidationFact.h
 *
 * 
 */

#ifndef OAITransferNotificationValidationFact_H
#define OAITransferNotificationValidationFact_H
...
class OAITransferNotificationValidationFact : public OAIObject {
public:
    OAITransferNotificationValidationFact();
    OAITransferNotificationValidationFact(QString json);
    ~OAITransferNotificationValidationFact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferNotificationValidationFact)

#endif // OAITransferNotificationValidationFact_H
