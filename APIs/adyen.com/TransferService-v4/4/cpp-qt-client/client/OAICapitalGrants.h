...
#ifndef OAICapitalGrants_H
#define OAICapitalGrants_H
...
namespace OpenAPI {
class OAICapitalGrant;

class OAICapitalGrants : public OAIObject {
public:
    OAICapitalGrants();
    OAICapitalGrants(QString json);
    ~OAICapitalGrants() override;
    ...
    QList<OAICapitalGrant> getGrants() const;
    void setGrants(const QList<OAICapitalGrant> &grants);
...
private:
    ...
    QList<OAICapitalGrant> m_grants;
    bool m_grants_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICapitalGrants)

#endif // OAICapitalGrants_H
