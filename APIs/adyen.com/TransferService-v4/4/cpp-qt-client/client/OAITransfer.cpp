...
void OAITransfer::fromJsonObject(QJsonObject json) {
    ...
    m_category_data_isValid = ::OpenAPI::fromJsonValue(m_category_data, json[QString("categoryData")]);
    m_category_data_isSet = !json[QString("categoryData")].isNull() && m_category_data_isValid;
...
QJsonObject OAITransfer::asJsonObject() const {
    ...
    if (m_category_data.isSet()) {
        obj.insert(QString("categoryData"), ::OpenAPI::toJsonValue(m_category_data));
    }
...
OAITransfer_categoryData OAITransfer::getCategoryData() const {
    return m_category_data;
}
void OAITransfer::setCategoryData(const OAITransfer_categoryData &category_data) {
    m_category_data = category_data;
    m_category_data_isSet = true;
}

bool OAITransfer::is_category_data_Set() const{
    return m_category_data_isSet;
}

bool OAITransfer::is_category_data_Valid() const{
