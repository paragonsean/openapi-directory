...
/*
 * OAIInternalCategoryData.h
 *
 * 
 */

#ifndef OAIInternalCategoryData_H
#define OAIInternalCategoryData_H
...
class OAIInternalCategoryData : public OAIObject {
public:
    OAIInternalCategoryData();
    OAIInternalCategoryData(QString json);
    ~OAIInternalCategoryData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInternalCategoryData)

#endif // OAIInternalCategoryData_H
