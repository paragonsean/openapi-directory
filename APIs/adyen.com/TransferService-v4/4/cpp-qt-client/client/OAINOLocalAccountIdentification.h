...
/*
 * OAINOLocalAccountIdentification.h
 *
 * 
 */

#ifndef OAINOLocalAccountIdentification_H
#define OAINOLocalAccountIdentification_H
...
class OAINOLocalAccountIdentification : public OAIObject {
public:
    OAINOLocalAccountIdentification();
    OAINOLocalAccountIdentification(QString json);
    ~OAINOLocalAccountIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINOLocalAccountIdentification)

#endif // OAINOLocalAccountIdentification_H
