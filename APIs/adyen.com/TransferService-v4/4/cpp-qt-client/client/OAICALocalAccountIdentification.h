...
/*
 * OAICALocalAccountIdentification.h
 *
 * 
 */

#ifndef OAICALocalAccountIdentification_H
#define OAICALocalAccountIdentification_H
...
class OAICALocalAccountIdentification : public OAIObject {
public:
    OAICALocalAccountIdentification();
    OAICALocalAccountIdentification(QString json);
    ~OAICALocalAccountIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICALocalAccountIdentification)

#endif // OAICALocalAccountIdentification_H
