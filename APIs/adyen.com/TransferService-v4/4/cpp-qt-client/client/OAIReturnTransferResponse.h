...
/*
 * OAIReturnTransferResponse.h
 *
 * 
 */

#ifndef OAIReturnTransferResponse_H
#define OAIReturnTransferResponse_H
...
class OAIReturnTransferResponse : public OAIObject {
public:
    OAIReturnTransferResponse();
    OAIReturnTransferResponse(QString json);
    ~OAIReturnTransferResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturnTransferResponse)

#endif // OAIReturnTransferResponse_H
