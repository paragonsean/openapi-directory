...
#ifndef OAIIssuedCard_H
#define OAIIssuedCard_H
...
class OAIIssuedCard : public OAIObject {
public:
    OAIIssuedCard();
    OAIIssuedCard(QString json);
    ~OAIIssuedCard() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssuedCard)

#endif // OAIIssuedCard_H
