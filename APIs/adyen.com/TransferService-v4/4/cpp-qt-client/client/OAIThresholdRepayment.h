...
/*
 * OAIThresholdRepayment.h
 *
 * 
 */

#ifndef OAIThresholdRepayment_H
#define OAIThresholdRepayment_H
...
class OAIThresholdRepayment : public OAIObject {
public:
    OAIThresholdRepayment();
    OAIThresholdRepayment(QString json);
    ~OAIThresholdRepayment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThresholdRepayment)

#endif // OAIThresholdRepayment_H
