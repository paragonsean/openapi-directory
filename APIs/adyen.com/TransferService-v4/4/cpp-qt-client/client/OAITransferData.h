...
#ifndef OAITransferData_H
#define OAITransferData_H
...
class OAITransferData : public OAIObject {
public:
    OAITransferData();
    OAITransferData(QString json);
    ~OAITransferData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferData)

#endif // OAITransferData_H
