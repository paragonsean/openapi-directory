...
public class Transfer {
  ...
  static {
    ...
    openapiFields.add("categoryData");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("categoryData") != null && !jsonObj.get("categoryData").isJsonNull()) {
        TransferCategoryData.validateJsonElement(jsonObj.get("categoryData"));
      }
