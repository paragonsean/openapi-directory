...
from openapi_server.models.transfer_category_data import TransferCategoryData
...
class Transfer(Model):
    ...
    def __init__(self, account_holder: ResourceReference=None, amount: Amount=None, balance_account: ResourceReference=None, category: str=None, category_data: TransferCategoryData=None, counterparty: CounterpartyV3=None, creation_date: datetime=None, description: str=None, direction: str=None, id: str=None, payment_instrument: PaymentInstrument=None, reason: str=None, reference: str=None, reference_for_beneficiary: str=None, status: str=None):
        ...
        :param category_data: The category_data of this Transfer.
        ...
        self.openapi_types = {
            ...
            'category': str,
            'category_data': TransferCategoryData,
    ...
    def category_data(self):
        """Gets the category_data of this Transfer.


        :return: The category_data of this Transfer.
        :rtype: TransferCategoryData
        """
        return self._category_data

    @category_data.setter
    def category_data(self, category_data):
        """Sets the category_data of this Transfer.


        :param category_data: The category_data of this Transfer.
        :type category_data: TransferCategoryData
        """
