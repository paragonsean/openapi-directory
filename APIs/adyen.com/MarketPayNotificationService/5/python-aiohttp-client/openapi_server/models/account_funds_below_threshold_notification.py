...
class AccountFundsBelowThresholdNotification(Model):
    ...
    def __init__(self, content: AccountFundsBelowThresholdNotificationContent=None, error: NotificationErrorContainer=None, event_date: datetime=None, event_type: str=None, executing_user_key: str=None, live: bool=None, psp_reference: str=None):
        ...
        :param error: The error of this AccountFundsBelowThresholdNotification.
    ...
    @property
    def error(self):
        """Gets the error of this AccountFundsBelowThresholdNotification.

        Error information of failed request. No value provided here if no error occurred on processing.

        :return: The error of this AccountFundsBelowThresholdNotification.
    ...
    def error(self, error):
        """Sets the error of this AccountFundsBelowThresholdNotification.
