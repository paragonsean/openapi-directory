...
class AccountUpdateNotification(Model):
    ...
    def __init__(self, content: UpdateAccountResponse=None, error: NotificationErrorContainer=None, event_date: datetime=None, event_type: str=None, executing_user_key: str=None, live: bool=None, psp_reference: str=None):
        """AccountUpdateNotification - a model defined in OpenAPI

        :param content: The content of this AccountUpdateNotification.
        :param error: The error of this AccountUpdateNotification.
        :param event_date: The event_date of this AccountUpdateNotification.
    ...
    @property
    def error(self):
        """Gets the error of this AccountUpdateNotification.

        Error information of failed request. No value provided here if no error occurred on processing.

        :return: The error of this AccountUpdateNotification.
    ...
    def error(self, error):
        """Sets the error of this AccountUpdateNotification.
    ...
    @property
    def event_date(self):
        """Gets the event_date of this AccountUpdateNotification.

        The date and time when an event has been completed.

        :return: The event_date of this AccountUpdateNotification.
        :rtype: datetime
        """
    ...
    def event_date(self, event_date):
        """Sets the event_date of this AccountUpdateNotification.
