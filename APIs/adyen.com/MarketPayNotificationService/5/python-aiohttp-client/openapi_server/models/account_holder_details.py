...
class AccountHolderDetails(Model):
    ...
    def __init__(self, address: ViasAddress=None, bank_account_details: List[BankAccountDetail]=None, bank_aggregator_data_reference: str=None, business_details: BusinessDetails=None, email: str=None, full_phone_number: str=None, individual_details: IndividualDetails=None, last_review_date: str=None, merchant_category_code: str=None, metadata: Dict[str, str]=None, payout_methods: List[PayoutMethod]=None, principal_business_address: ViasAddress=None, store_details: List[StoreDetail]=None, web_address: str=None):
        ...
        :param bank_aggregator_data_reference: The bank_aggregator_data_reference of this AccountHolderDetails.
        ...
        :param payout_methods: The payout_methods of this AccountHolderDetails.
        :param principal_business_address: The principal_business_address of this AccountHolderDetails.
        :param store_details: The store_details of this AccountHolderDetails.
        :param web_address: The web_address of this AccountHolderDetails.
        """
        self.openapi_types = {
            'address': ViasAddress,
            'bank_account_details': List[BankAccountDetail],
            'bank_aggregator_data_reference': str,
            ...
            'store_details': List[StoreDetail],
            'web_address': str
        }
        ...
        self._bank_aggregator_data_reference = bank_aggregator_data_reference
    ...
    def bank_account_details(self, bank_account_details):
        ...
        :param bank_account_details: The bank_account_details of this AccountHolderDetails.
        :type bank_account_details: List[BankAccountDetail]
        """

        self._bank_account_details = bank_account_details

    @property
    def bank_aggregator_data_reference(self):
        """Gets the bank_aggregator_data_reference of this AccountHolderDetails.

        The opaque reference value returned by the Adyen API during bank account login.

        :return: The bank_aggregator_data_reference of this AccountHolderDetails.
        :rtype: str
        """
        return self._bank_aggregator_data_reference

    @bank_aggregator_data_reference.setter
    def bank_aggregator_data_reference(self, bank_aggregator_data_reference):
        """Sets the bank_aggregator_data_reference of this AccountHolderDetails.

        The opaque reference value returned by the Adyen API during bank account login.

        :param bank_aggregator_data_reference: The bank_aggregator_data_reference of this AccountHolderDetails.
        :type bank_aggregator_data_reference: str
        """
    ...
    def payout_methods(self):
        """Gets the payout_methods of this AccountHolderDetails.
        ...
        :return: The payout_methods of this AccountHolderDetails.
        :rtype: List[PayoutMethod]
        """
        return self._payout_methods

    @payout_methods.setter
    def payout_methods(self, payout_methods):
        """Sets the payout_methods of this AccountHolderDetails.

        Array of tokenized card details associated with the account holder. For details about how you can use the tokens to pay out, refer to [Pay out to cards](https://docs.adyen.com/marketplaces-and-platforms/classic/payout-to-cards).

        :param payout_methods: The payout_methods of this AccountHolderDetails.
        :type payout_methods: List[PayoutMethod]
        """
    ...
    def store_details(self):
        """Gets the store_details of this AccountHolderDetails.
        ...
        :return: The store_details of this AccountHolderDetails.
        :rtype: List[StoreDetail]
        """
        return self._store_details

    @store_details.setter
    def store_details(self, store_details):
        """Sets the store_details of this AccountHolderDetails.

        Array of stores associated with the account holder. Required when onboarding account holders that have an Adyen [point of sale](https://docs.adyen.com/marketplaces-and-platforms/classic/platforms-for-pos).

        :param store_details: The store_details of this AccountHolderDetails.
        :type store_details: List[StoreDetail]
        """
