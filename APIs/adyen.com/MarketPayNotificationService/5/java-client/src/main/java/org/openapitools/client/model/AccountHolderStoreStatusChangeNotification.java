...
import org.openapitools.client.model.AccountHolderStoreStatusChangeNotificationContent;
...
public class AccountHolderStoreStatusChangeNotification {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountHolderStoreStatusChangeNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountHolderStoreStatusChangeNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountHolderStoreStatusChangeNotification is not found in the empty JSON string", AccountHolderStoreStatusChangeNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountHolderStoreStatusChangeNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountHolderStoreStatusChangeNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountHolderStoreStatusChangeNotification.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        AccountHolderStoreStatusChangeNotificationContent.validateJsonElement(jsonObj.get("content"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountHolderStoreStatusChangeNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountHolderStoreStatusChangeNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountHolderStoreStatusChangeNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountHolderStoreStatusChangeNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountHolderStoreStatusChangeNotification>() {
           @Override
           public void write(JsonWriter out, AccountHolderStoreStatusChangeNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountHolderStoreStatusChangeNotification read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to AccountHolderStoreStatusChangeNotification
   */
  public static AccountHolderStoreStatusChangeNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountHolderStoreStatusChangeNotification.class);
  }
