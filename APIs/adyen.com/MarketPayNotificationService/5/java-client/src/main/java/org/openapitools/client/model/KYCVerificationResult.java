...
public class KYCVerificationResult {
  ...
  private List<KYCCardCheckResult> cards = new ArrayList<>();
  ...
  public KYCVerificationResult cards(List<KYCCardCheckResult> cards) {
    this.cards = cards;
    return this;
  }

  public KYCVerificationResult addCardsItem(KYCCardCheckResult cardsItem) {
    if (this.cards == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<KYCCardCheckResult> getCards() {
    return cards;
  }

  public void setCards(List<KYCCardCheckResult> cards) {
    this.cards = cards;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountHolder, kyCVerificationResult.accountHolder) &&
        ...
        Objects.equals(this.cards, kyCVerificationResult.cards) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountHolder, bankAccounts, cards, shareholders, signatories);
  }
      ...
      if (jsonObj.get("cards") != null && !jsonObj.get("cards").isJsonNull()) {
        ...
        if (jsonArraycards != null) {
          ...
          for (int i = 0; i < jsonArraycards.size(); i++) {
            KYCCardCheckResult.validateJsonElement(jsonArraycards.get(i));
          };
        }
      }
