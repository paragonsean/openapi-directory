...
/*
 * OAIAccountHolderStoreStatusChangeNotificationContent.h
 *
 * 
 */

#ifndef OAIAccountHolderStoreStatusChangeNotificationContent_H
#define OAIAccountHolderStoreStatusChangeNotificationContent_H
...
class OAIAccountHolderStoreStatusChangeNotificationContent : public OAIObject {
public:
    OAIAccountHolderStoreStatusChangeNotificationContent();
    OAIAccountHolderStoreStatusChangeNotificationContent(QString json);
    ~OAIAccountHolderStoreStatusChangeNotificationContent() override;
    ...
    void setNewStatus(const QString &new_status);
    bool is_new_status_Set() const;
    bool is_new_status_Valid() const;

    QString getOldStatus() const;
    void setOldStatus(const QString &old_status);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountHolderStoreStatusChangeNotificationContent)

#endif // OAIAccountHolderStoreStatusChangeNotificationContent_H
