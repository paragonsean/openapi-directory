...
QList<OAIErrorFieldType> OAIPaymentFailureNotificationContent::getErrorFields() const {
    return m_error_fields;
}
void OAIPaymentFailureNotificationContent::setErrorFields(const QList<OAIErrorFieldType> &error_fields) {
