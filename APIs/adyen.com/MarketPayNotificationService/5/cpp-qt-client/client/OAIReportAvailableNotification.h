...
/*
 * OAIReportAvailableNotification.h
 *
 * 
 */

#ifndef OAIReportAvailableNotification_H
#define OAIReportAvailableNotification_H
...
namespace OpenAPI {
class OAIReportAvailableNotificationContent;
class OAINotificationErrorContainer;

class OAIReportAvailableNotification : public OAIObject {
public:
    OAIReportAvailableNotification();
    OAIReportAvailableNotification(QString json);
    ~OAIReportAvailableNotification() override;
    ...
    OAIReportAvailableNotificationContent getContent() const;
    void setContent(const OAIReportAvailableNotificationContent &content);
...
private:
    ...
    OAIReportAvailableNotificationContent m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportAvailableNotification)

#endif // OAIReportAvailableNotification_H
