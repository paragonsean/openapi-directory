...
/*
 * OAIAccountCreateNotification.h
 *
 * 
 */

#ifndef OAIAccountCreateNotification_H
#define OAIAccountCreateNotification_H
...
namespace OpenAPI {
class OAICreateAccountResponse;
class OAINotificationErrorContainer;

class OAIAccountCreateNotification : public OAIObject {
public:
    OAIAccountCreateNotification();
    OAIAccountCreateNotification(QString json);
    ~OAIAccountCreateNotification() override;
    ...
    OAICreateAccountResponse getContent() const;
    void setContent(const OAICreateAccountResponse &content);
...
private:
    ...
    OAICreateAccountResponse m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountCreateNotification)

#endif // OAIAccountCreateNotification_H
