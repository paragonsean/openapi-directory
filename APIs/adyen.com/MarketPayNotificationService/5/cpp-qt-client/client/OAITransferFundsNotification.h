...
/*
 * OAITransferFundsNotification.h
 *
 * 
 */

#ifndef OAITransferFundsNotification_H
#define OAITransferFundsNotification_H
...
namespace OpenAPI {
class OAITransferFundsNotificationContent;
class OAINotificationErrorContainer;

class OAITransferFundsNotification : public OAIObject {
public:
    OAITransferFundsNotification();
    OAITransferFundsNotification(QString json);
    ~OAITransferFundsNotification() override;
    ...
    OAITransferFundsNotificationContent getContent() const;
    void setContent(const OAITransferFundsNotificationContent &content);
...
private:
    ...
    OAITransferFundsNotificationContent m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferFundsNotification)

#endif // OAITransferFundsNotification_H
