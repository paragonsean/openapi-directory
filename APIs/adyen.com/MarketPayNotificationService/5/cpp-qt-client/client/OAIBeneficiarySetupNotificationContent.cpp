...
QList<OAIErrorFieldType> OAIBeneficiarySetupNotificationContent::getInvalidFields() const {
    return m_invalid_fields;
}
void OAIBeneficiarySetupNotificationContent::setInvalidFields(const QList<OAIErrorFieldType> &invalid_fields) {
    m_invalid_fields = invalid_fields;
    m_invalid_fields_isSet = true;
}

bool OAIBeneficiarySetupNotificationContent::is_invalid_fields_Set() const{
    return m_invalid_fields_isSet;
}

bool OAIBeneficiarySetupNotificationContent::is_invalid_fields_Valid() const{
