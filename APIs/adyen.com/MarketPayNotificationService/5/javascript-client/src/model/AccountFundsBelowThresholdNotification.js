...
/**
 * The AccountFundsBelowThresholdNotification model module.
 * @module model/AccountFundsBelowThresholdNotification
 * @version 5
 */
class AccountFundsBelowThresholdNotification {
    /**
     * Constructs a new <code>AccountFundsBelowThresholdNotification</code>.
     * @alias module:model/AccountFundsBelowThresholdNotification
    ...
    constructor(eventDate, eventType, executingUserKey, live, pspReference) { 
        ...
        AccountFundsBelowThresholdNotification.initialize(this, eventDate, eventType, executingUserKey, live, pspReference);
    }
    ...
    /**
     * Constructs a <code>AccountFundsBelowThresholdNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountFundsBelowThresholdNotification} obj Optional instance to populate.
     * @return {module:model/AccountFundsBelowThresholdNotification} The populated <code>AccountFundsBelowThresholdNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountFundsBelowThresholdNotification();

            if (data.hasOwnProperty('content')) {
                obj['content'] = AccountFundsBelowThresholdNotificationContent.constructFromObject(data['content']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountFundsBelowThresholdNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountFundsBelowThresholdNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountFundsBelowThresholdNotification.RequiredProperties) {
        ...
        if (data['content']) { // data not null
          AccountFundsBelowThresholdNotificationContent.validateJSON(data['content']);
        }
...
AccountFundsBelowThresholdNotification.RequiredProperties = ["eventDate", "eventType", "executingUserKey", "live", "pspReference"];

/**
 * Details of the liable account with funds under threshold.
 * @member {module:model/AccountFundsBelowThresholdNotificationContent} content
 */
AccountFundsBelowThresholdNotification.prototype['content'] = undefined;
 ...
 */
AccountFundsBelowThresholdNotification.prototype['error'] = undefined;

/**
 * The date and time when an event has been completed.
 * @member {Date} eventDate
 */
AccountFundsBelowThresholdNotification.prototype['eventDate'] = undefined;

/**
 * The event type of the notification.
 * @member {String} eventType
 */
AccountFundsBelowThresholdNotification.prototype['eventType'] = undefined;

/**
 * The user or process that has triggered the notification.
 * @member {String} executingUserKey
 */
AccountFundsBelowThresholdNotification.prototype['executingUserKey'] = undefined;

/**
 * Indicates whether the notification originated from the live environment or the test environment. If true, the notification originated from the live environment. If false, the notification originated from the test environment.
 * @member {Boolean} live
 */
AccountFundsBelowThresholdNotification.prototype['live'] = undefined;

/**
 * The PSP reference of the request from which the notification originates.
 * @member {String} pspReference
 */
AccountFundsBelowThresholdNotification.prototype['pspReference'] = undefined;
...
export default AccountFundsBelowThresholdNotification;
