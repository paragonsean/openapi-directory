...
/**
 * The PaymentFailureNotification model module.
 * @module model/PaymentFailureNotification
 * @version 5
 */
class PaymentFailureNotification {
    /**
     * Constructs a new <code>PaymentFailureNotification</code>.
     * @alias module:model/PaymentFailureNotification
    ...
    constructor(eventDate, eventType, executingUserKey, live, pspReference) { 
        ...
        PaymentFailureNotification.initialize(this, eventDate, eventType, executingUserKey, live, pspReference);
    }
    ...
    /**
     * Constructs a <code>PaymentFailureNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentFailureNotification} obj Optional instance to populate.
     * @return {module:model/PaymentFailureNotification} The populated <code>PaymentFailureNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentFailureNotification();

            if (data.hasOwnProperty('content')) {
                obj['content'] = PaymentFailureNotificationContent.constructFromObject(data['content']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentFailureNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentFailureNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentFailureNotification.RequiredProperties) {
        ...
        if (data['content']) { // data not null
          PaymentFailureNotificationContent.validateJSON(data['content']);
        }
...
PaymentFailureNotification.RequiredProperties = ["eventDate", "eventType", "executingUserKey", "live", "pspReference"];

/**
 * The details of the payment failure.
 * @member {module:model/PaymentFailureNotificationContent} content
 */
PaymentFailureNotification.prototype['content'] = undefined;
 ...
 */
PaymentFailureNotification.prototype['error'] = undefined;

/**
 * The date and time when an event has been completed.
 * @member {Date} eventDate
 */
PaymentFailureNotification.prototype['eventDate'] = undefined;

/**
 * The event type of the notification.
 * @member {String} eventType
 */
PaymentFailureNotification.prototype['eventType'] = undefined;

/**
 * The user or process that has triggered the notification.
 * @member {String} executingUserKey
 */
PaymentFailureNotification.prototype['executingUserKey'] = undefined;

/**
 * Indicates whether the notification originated from the live environment or the test environment. If true, the notification originated from the live environment. If false, the notification originated from the test environment.
 * @member {Boolean} live
 */
PaymentFailureNotification.prototype['live'] = undefined;

/**
 * The PSP reference of the request from which the notification originates.
 * @member {String} pspReference
 */
PaymentFailureNotification.prototype['pspReference'] = undefined;
...
export default PaymentFailureNotification;
