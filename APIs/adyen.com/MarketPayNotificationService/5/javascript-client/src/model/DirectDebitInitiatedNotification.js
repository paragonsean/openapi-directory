...
/**
 * The DirectDebitInitiatedNotification model module.
 * @module model/DirectDebitInitiatedNotification
 * @version 5
 */
class DirectDebitInitiatedNotification {
    /**
     * Constructs a new <code>DirectDebitInitiatedNotification</code>.
     * @alias module:model/DirectDebitInitiatedNotification
    ...
    constructor(eventDate, eventType, executingUserKey, live, pspReference) { 
        ...
        DirectDebitInitiatedNotification.initialize(this, eventDate, eventType, executingUserKey, live, pspReference);
    }
    ...
    /**
     * Constructs a <code>DirectDebitInitiatedNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DirectDebitInitiatedNotification} obj Optional instance to populate.
     * @return {module:model/DirectDebitInitiatedNotification} The populated <code>DirectDebitInitiatedNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DirectDebitInitiatedNotification();

            if (data.hasOwnProperty('content')) {
                obj['content'] = DirectDebitInitiatedNotificationContent.constructFromObject(data['content']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DirectDebitInitiatedNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DirectDebitInitiatedNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DirectDebitInitiatedNotification.RequiredProperties) {
        ...
        if (data['content']) { // data not null
          DirectDebitInitiatedNotificationContent.validateJSON(data['content']);
        }
...
DirectDebitInitiatedNotification.RequiredProperties = ["eventDate", "eventType", "executingUserKey", "live", "pspReference"];

/**
 * Details of the direct debit.
 * @member {module:model/DirectDebitInitiatedNotificationContent} content
 */
DirectDebitInitiatedNotification.prototype['content'] = undefined;
 ...
 */
DirectDebitInitiatedNotification.prototype['error'] = undefined;

/**
 * The date and time when an event has been completed.
 * @member {Date} eventDate
 */
DirectDebitInitiatedNotification.prototype['eventDate'] = undefined;

/**
 * The event type of the notification.
 * @member {String} eventType
 */
DirectDebitInitiatedNotification.prototype['eventType'] = undefined;

/**
 * The user or process that has triggered the notification.
 * @member {String} executingUserKey
 */
DirectDebitInitiatedNotification.prototype['executingUserKey'] = undefined;

/**
 * Indicates whether the notification originated from the live environment or the test environment. If true, the notification originated from the live environment. If false, the notification originated from the test environment.
 * @member {Boolean} live
 */
DirectDebitInitiatedNotification.prototype['live'] = undefined;

/**
 * The PSP reference of the request from which the notification originates.
 * @member {String} pspReference
 */
DirectDebitInitiatedNotification.prototype['pspReference'] = undefined;
...
export default DirectDebitInitiatedNotification;
