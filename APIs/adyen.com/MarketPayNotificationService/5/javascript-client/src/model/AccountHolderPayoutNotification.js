...
/**
 * The AccountHolderPayoutNotification model module.
 * @module model/AccountHolderPayoutNotification
 * @version 5
 */
class AccountHolderPayoutNotification {
    /**
     * Constructs a new <code>AccountHolderPayoutNotification</code>.
     * @alias module:model/AccountHolderPayoutNotification
    ...
    constructor(eventDate, eventType, executingUserKey, live, pspReference) { 
        ...
        AccountHolderPayoutNotification.initialize(this, eventDate, eventType, executingUserKey, live, pspReference);
    }
    ...
    /**
     * Constructs a <code>AccountHolderPayoutNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountHolderPayoutNotification} obj Optional instance to populate.
     * @return {module:model/AccountHolderPayoutNotification} The populated <code>AccountHolderPayoutNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountHolderPayoutNotification();

            if (data.hasOwnProperty('content')) {
                obj['content'] = AccountHolderPayoutNotificationContent.constructFromObject(data['content']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountHolderPayoutNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountHolderPayoutNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountHolderPayoutNotification.RequiredProperties) {
        ...
        if (data['content']) { // data not null
          AccountHolderPayoutNotificationContent.validateJSON(data['content']);
        }
...
AccountHolderPayoutNotification.RequiredProperties = ["eventDate", "eventType", "executingUserKey", "live", "pspReference"];

/**
 * Details of the payout to the Account Holder.
 * @member {module:model/AccountHolderPayoutNotificationContent} content
 */
AccountHolderPayoutNotification.prototype['content'] = undefined;
 ...
 */
AccountHolderPayoutNotification.prototype['error'] = undefined;

/**
 * The date and time when an event has been completed.
 * @member {Date} eventDate
 */
AccountHolderPayoutNotification.prototype['eventDate'] = undefined;

/**
 * The event type of the notification.
 * @member {String} eventType
 */
AccountHolderPayoutNotification.prototype['eventType'] = undefined;

/**
 * The user or process that has triggered the notification.
 * @member {String} executingUserKey
 */
AccountHolderPayoutNotification.prototype['executingUserKey'] = undefined;

/**
 * Indicates whether the notification originated from the live environment or the test environment. If true, the notification originated from the live environment. If false, the notification originated from the test environment.
 * @member {Boolean} live
 */
AccountHolderPayoutNotification.prototype['live'] = undefined;

/**
 * The PSP reference of the request from which the notification originates.
 * @member {String} pspReference
 */
AccountHolderPayoutNotification.prototype['pspReference'] = undefined;
...
export default AccountHolderPayoutNotification;
