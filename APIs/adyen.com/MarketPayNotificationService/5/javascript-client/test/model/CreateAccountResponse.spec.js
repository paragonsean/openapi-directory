...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.CreateAccountResponse();
  });
  ...
  describe('CreateAccountResponse', function() {
    it('should create an instance of CreateAccountResponse', function() {
      // uncomment below and update the code to test CreateAccountResponse
      //var instance = new ClassicPlatformsNotifications.CreateAccountResponse();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.CreateAccountResponse);
    });
