...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.RefundFundsTransferNotification();
  });
  ...
  describe('RefundFundsTransferNotification', function() {
    it('should create an instance of RefundFundsTransferNotification', function() {
      // uncomment below and update the code to test RefundFundsTransferNotification
      //var instance = new ClassicPlatformsNotifications.RefundFundsTransferNotification();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.RefundFundsTransferNotification);
    });
