...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.ScheduledRefundsNotification();
  });
  ...
  describe('ScheduledRefundsNotification', function() {
    it('should create an instance of ScheduledRefundsNotification', function() {
      // uncomment below and update the code to test ScheduledRefundsNotification
      //var instance = new ClassicPlatformsNotifications.ScheduledRefundsNotification();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.ScheduledRefundsNotification);
    });
