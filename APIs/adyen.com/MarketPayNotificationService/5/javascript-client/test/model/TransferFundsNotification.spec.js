...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.TransferFundsNotification();
  });
  ...
  describe('TransferFundsNotification', function() {
    it('should create an instance of TransferFundsNotification', function() {
      // uncomment below and update the code to test TransferFundsNotification
      //var instance = new ClassicPlatformsNotifications.TransferFundsNotification();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.TransferFundsNotification);
    });
