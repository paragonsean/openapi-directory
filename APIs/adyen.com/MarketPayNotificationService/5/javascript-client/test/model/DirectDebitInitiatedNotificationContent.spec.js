...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.DirectDebitInitiatedNotificationContent();
  });
  ...
  describe('DirectDebitInitiatedNotificationContent', function() {
    it('should create an instance of DirectDebitInitiatedNotificationContent', function() {
      // uncomment below and update the code to test DirectDebitInitiatedNotificationContent
      //var instance = new ClassicPlatformsNotifications.DirectDebitInitiatedNotificationContent();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.DirectDebitInitiatedNotificationContent);
    });
    ...
    it('should have the property debitInitiationDate (base name: "debitInitiationDate")', function() {
      // uncomment below and update the code to test the property debitInitiationDate
      //var instance = new ClassicPlatformsNotifications.DirectDebitInitiatedNotificationContent();
      //expect(instance).to.be();
    });
