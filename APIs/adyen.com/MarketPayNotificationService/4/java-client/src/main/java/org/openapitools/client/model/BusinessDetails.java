...
public class BusinessDetails {
  ...
  private List<UltimateParentCompanyWrapper> listedUltimateParentCompany = new ArrayList<>();
  ...
  private List<ShareholderContactWrapper> shareholders = new ArrayList<>();

  public static final String SERIALIZED_NAME_SIGNATORIES = "signatories";
  @SerializedName(SERIALIZED_NAME_SIGNATORIES)
  private List<SignatoryContactWrapper> signatories = new ArrayList<>();
  ...
  public BusinessDetails listedUltimateParentCompany(List<UltimateParentCompanyWrapper> listedUltimateParentCompany) {
    this.listedUltimateParentCompany = listedUltimateParentCompany;
    return this;
  }

  public BusinessDetails addListedUltimateParentCompanyItem(UltimateParentCompanyWrapper listedUltimateParentCompanyItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<UltimateParentCompanyWrapper> getListedUltimateParentCompany() {
    return listedUltimateParentCompany;
  }

  public void setListedUltimateParentCompany(List<UltimateParentCompanyWrapper> listedUltimateParentCompany) {
    this.listedUltimateParentCompany = listedUltimateParentCompany;
  }
  ...
  public BusinessDetails shareholders(List<ShareholderContactWrapper> shareholders) {
    this.shareholders = shareholders;
    return this;
  }

  public BusinessDetails addShareholdersItem(ShareholderContactWrapper shareholdersItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ShareholderContactWrapper> getShareholders() {
    return shareholders;
  }

  public void setShareholders(List<ShareholderContactWrapper> shareholders) {
    this.shareholders = shareholders;
  }


  public BusinessDetails signatories(List<SignatoryContactWrapper> signatories) {
    this.signatories = signatories;
    return this;
  }

  public BusinessDetails addSignatoriesItem(SignatoryContactWrapper signatoriesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<SignatoryContactWrapper> getSignatories() {
    return signatories;
  }

  public void setSignatories(List<SignatoryContactWrapper> signatories) {
    this.signatories = signatories;
  }
      ...
      if (jsonObj.get("listedUltimateParentCompany") != null && !jsonObj.get("listedUltimateParentCompany").isJsonNull()) {
        ...
        if (jsonArraylistedUltimateParentCompany != null) {
          ...
          for (int i = 0; i < jsonArraylistedUltimateParentCompany.size(); i++) {
            UltimateParentCompanyWrapper.validateJsonElement(jsonArraylistedUltimateParentCompany.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("shareholders") != null && !jsonObj.get("shareholders").isJsonNull()) {
        ...
        if (jsonArrayshareholders != null) {
          ...
          for (int i = 0; i < jsonArrayshareholders.size(); i++) {
            ShareholderContactWrapper.validateJsonElement(jsonArrayshareholders.get(i));
          };
        }
      }
      if (jsonObj.get("signatories") != null && !jsonObj.get("signatories").isJsonNull()) {
        ...
        if (jsonArraysignatories != null) {
          ...
          for (int i = 0; i < jsonArraysignatories.size(); i++) {
            SignatoryContactWrapper.validateJsonElement(jsonArraysignatories.get(i));
          };
        }
      }
