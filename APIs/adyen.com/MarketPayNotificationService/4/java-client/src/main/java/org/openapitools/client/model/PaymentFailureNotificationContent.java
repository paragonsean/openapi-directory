...
public class PaymentFailureNotificationContent {
  ...
  private List<ErrorFieldTypeWrapper> errorFields = new ArrayList<>();
  ...
  public PaymentFailureNotificationContent errorFields(List<ErrorFieldTypeWrapper> errorFields) {
    this.errorFields = errorFields;
    return this;
  }

  public PaymentFailureNotificationContent addErrorFieldsItem(ErrorFieldTypeWrapper errorFieldsItem) {
  ...
  public List<ErrorFieldTypeWrapper> getErrorFields() {
    return errorFields;
  }

  public void setErrorFields(List<ErrorFieldTypeWrapper> errorFields) {
    this.errorFields = errorFields;
  }
      ...
      if (jsonObj.get("errorFields") != null && !jsonObj.get("errorFields").isJsonNull()) {
        ...
        if (jsonArrayerrorFields != null) {
          ...
          for (int i = 0; i < jsonArrayerrorFields.size(); i++) {
            ErrorFieldTypeWrapper.validateJsonElement(jsonArrayerrorFields.get(i));
          };
        }
      }
