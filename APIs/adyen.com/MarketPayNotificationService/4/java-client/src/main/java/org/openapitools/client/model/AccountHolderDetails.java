...
import org.openapitools.client.model.BankAccountDetailWrapper;
...
public class AccountHolderDetails {
  ...
  private List<BankAccountDetailWrapper> bankAccountDetails = new ArrayList<>();
  ...
  public AccountHolderDetails bankAccountDetails(List<BankAccountDetailWrapper> bankAccountDetails) {
    this.bankAccountDetails = bankAccountDetails;
    return this;
  }

  public AccountHolderDetails addBankAccountDetailsItem(BankAccountDetailWrapper bankAccountDetailsItem) {
  ...
  public List<BankAccountDetailWrapper> getBankAccountDetails() {
    return bankAccountDetails;
  }

  public void setBankAccountDetails(List<BankAccountDetailWrapper> bankAccountDetails) {
    this.bankAccountDetails = bankAccountDetails;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, bankAccountDetails, businessDetails, email, fullPhoneNumber, individualDetails, lastReviewDate, merchantCategoryCode, metadata, principalBusinessAddress, webAddress);
  }
      ...
      if (jsonObj.get("bankAccountDetails") != null && !jsonObj.get("bankAccountDetails").isJsonNull()) {
        ...
        if (jsonArraybankAccountDetails != null) {
          ...
          for (int i = 0; i < jsonArraybankAccountDetails.size(); i++) {
            BankAccountDetailWrapper.validateJsonElement(jsonArraybankAccountDetails.get(i));
          };
        }
      }
