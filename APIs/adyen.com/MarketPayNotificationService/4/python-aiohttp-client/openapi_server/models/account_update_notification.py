...
class AccountUpdateNotification(Model):
    ...
    def __init__(self, content: UpdateAccountResponse=None, event_date: datetime=None, event_type: str=None, executing_user_key: str=None, live: bool=None, psp_reference: str=None):
