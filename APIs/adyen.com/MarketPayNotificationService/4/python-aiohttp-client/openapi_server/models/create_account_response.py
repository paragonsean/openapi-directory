...
class CreateAccountResponse(Model):
    ...
    def __init__(self, account_code: str=None, account_holder_code: str=None, description: str=None, payout_schedule: PayoutScheduleResponse=None, psp_reference: str=None, result_code: str=None, status: str=None, submitted_async: bool=None):
