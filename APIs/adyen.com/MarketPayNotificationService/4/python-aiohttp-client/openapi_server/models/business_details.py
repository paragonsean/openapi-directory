...
class BusinessDetails(Model):
    ...
    def __init__(self, doing_business_as: str=None, legal_business_name: str=None, listed_ultimate_parent_company: List[UltimateParentCompanyWrapper]=None, registration_number: str=None, shareholders: List[ShareholderContactWrapper]=None, signatories: List[SignatoryContactWrapper]=None, tax_id: str=None):
