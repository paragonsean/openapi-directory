...
class ViasPersonalData(Model):
    ...
    def __init__(self, date_of_birth: str=None, document_data: List[PersonalDocumentDataWrapper]=None, id_number: str=None, nationality: str=None):
        ...
        :param id_number: The id_number of this ViasPersonalData.
        :param nationality: The nationality of this ViasPersonalData.
        """
        self.openapi_types = {
            'date_of_birth': str,
            'document_data': List[PersonalDocumentDataWrapper],
            'id_number': str,
            'nationality': str
        }
    ...
    def document_data(self):
        ...
        :rtype: List[PersonalDocumentDataWrapper]
        """
    ...
    def document_data(self, document_data):
        ...
        :param document_data: The document_data of this ViasPersonalData.
        :type document_data: List[PersonalDocumentDataWrapper]
        """
    ...
    @property
    def id_number(self):
        """Gets the id_number of this ViasPersonalData.

        An ID number of the person.

        :return: The id_number of this ViasPersonalData.
        :rtype: str
        """
    ...
    def id_number(self, id_number):
        """Sets the id_number of this ViasPersonalData.
