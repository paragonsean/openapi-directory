...
class KYCVerificationResult(Model):
    ...
    def __init__(self, account_holder: KYCCheckResult=None, bank_accounts: List[KYCBankAccountCheckResult]=None, shareholders: List[KYCShareholderCheckResult]=None, signatories: List[KYCSignatoryCheckResult]=None):
