...
QList<OAIRefundResultWrapper> OAIScheduledRefundsNotificationContent::getRefundResults() const {
    return m_refund_results;
}
void OAIScheduledRefundsNotificationContent::setRefundResults(const QList<OAIRefundResultWrapper> &refund_results) {
