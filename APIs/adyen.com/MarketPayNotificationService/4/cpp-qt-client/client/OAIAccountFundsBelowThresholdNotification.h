...
/*
 * OAIAccountFundsBelowThresholdNotification.h
 *
 * 
 */

#ifndef OAIAccountFundsBelowThresholdNotification_H
#define OAIAccountFundsBelowThresholdNotification_H
...
namespace OpenAPI {
class OAIAccountFundsBelowThresholdNotificationContent;

class OAIAccountFundsBelowThresholdNotification : public OAIObject {
public:
    OAIAccountFundsBelowThresholdNotification();
    OAIAccountFundsBelowThresholdNotification(QString json);
    ~OAIAccountFundsBelowThresholdNotification() override;
    ...
    OAIAccountFundsBelowThresholdNotificationContent getContent() const;
    void setContent(const OAIAccountFundsBelowThresholdNotificationContent &content);
...
private:
    ...
    OAIAccountFundsBelowThresholdNotificationContent m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountFundsBelowThresholdNotification)

#endif // OAIAccountFundsBelowThresholdNotification_H
