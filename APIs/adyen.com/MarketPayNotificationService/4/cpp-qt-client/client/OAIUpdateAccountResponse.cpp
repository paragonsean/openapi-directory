...
bool OAIUpdateAccountResponse::isSubmittedAsync() const {
    return m_submitted_async;
}
void OAIUpdateAccountResponse::setSubmittedAsync(const bool &submitted_async) {
    m_submitted_async = submitted_async;
    m_submitted_async_isSet = true;
}

bool OAIUpdateAccountResponse::is_submitted_async_Set() const{
    return m_submitted_async_isSet;
}

bool OAIUpdateAccountResponse::is_submitted_async_Valid() const{
