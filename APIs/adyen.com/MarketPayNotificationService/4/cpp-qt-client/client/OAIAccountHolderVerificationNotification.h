...
/*
 * OAIAccountHolderVerificationNotification.h
 *
 * 
 */

#ifndef OAIAccountHolderVerificationNotification_H
#define OAIAccountHolderVerificationNotification_H
...
namespace OpenAPI {
class OAIAccountHolderVerificationNotificationContent;

class OAIAccountHolderVerificationNotification : public OAIObject {
public:
    OAIAccountHolderVerificationNotification();
    OAIAccountHolderVerificationNotification(QString json);
    ~OAIAccountHolderVerificationNotification() override;
    ...
    OAIAccountHolderVerificationNotificationContent getContent() const;
    void setContent(const OAIAccountHolderVerificationNotificationContent &content);
...
private:
    ...
    OAIAccountHolderVerificationNotificationContent m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountHolderVerificationNotification)

#endif // OAIAccountHolderVerificationNotification_H
