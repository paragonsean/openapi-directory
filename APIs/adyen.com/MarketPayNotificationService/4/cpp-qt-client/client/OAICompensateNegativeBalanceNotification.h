...
/*
 * OAICompensateNegativeBalanceNotification.h
 *
 * 
 */

#ifndef OAICompensateNegativeBalanceNotification_H
#define OAICompensateNegativeBalanceNotification_H
...
namespace OpenAPI {
class OAICompensateNegativeBalanceNotificationContent;

class OAICompensateNegativeBalanceNotification : public OAIObject {
public:
    OAICompensateNegativeBalanceNotification();
    OAICompensateNegativeBalanceNotification(QString json);
    ~OAICompensateNegativeBalanceNotification() override;
    ...
    OAICompensateNegativeBalanceNotificationContent getContent() const;
    void setContent(const OAICompensateNegativeBalanceNotificationContent &content);
...
private:
    ...
    OAICompensateNegativeBalanceNotificationContent m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompensateNegativeBalanceNotification)

#endif // OAICompensateNegativeBalanceNotification_H
