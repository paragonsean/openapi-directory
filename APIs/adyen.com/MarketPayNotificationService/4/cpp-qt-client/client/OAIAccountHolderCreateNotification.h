...
/*
 * OAIAccountHolderCreateNotification.h
 *
 * 
 */

#ifndef OAIAccountHolderCreateNotification_H
#define OAIAccountHolderCreateNotification_H
...
namespace OpenAPI {
class OAICreateAccountHolderResponse;

class OAIAccountHolderCreateNotification : public OAIObject {
public:
    OAIAccountHolderCreateNotification();
    OAIAccountHolderCreateNotification(QString json);
    ~OAIAccountHolderCreateNotification() override;
    ...
    OAICreateAccountHolderResponse getContent() const;
    void setContent(const OAICreateAccountHolderResponse &content);
...
private:
    ...
    OAICreateAccountHolderResponse m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountHolderCreateNotification)

#endif // OAIAccountHolderCreateNotification_H
