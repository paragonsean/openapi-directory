...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.LocalDate();
  });
  ...
  describe('LocalDate', function() {
    it('should create an instance of LocalDate', function() {
      // uncomment below and update the code to test LocalDate
      //var instance = new ClassicPlatformsNotifications.LocalDate();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.LocalDate);
    });
