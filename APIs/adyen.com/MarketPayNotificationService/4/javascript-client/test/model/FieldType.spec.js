...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.FieldType();
  });
  ...
  describe('FieldType', function() {
    it('should create an instance of FieldType', function() {
      ...
      //var instance = new ClassicPlatformsNotifications.FieldType();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.FieldType);
    });
