...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.TransferFundsNotificationContent();
  });
  ...
  describe('TransferFundsNotificationContent', function() {
    it('should create an instance of TransferFundsNotificationContent', function() {
      // uncomment below and update the code to test TransferFundsNotificationContent
      //var instance = new ClassicPlatformsNotifications.TransferFundsNotificationContent();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.TransferFundsNotificationContent);
    });
