...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.AccountHolderStatusChangeNotification();
  });
  ...
  describe('AccountHolderStatusChangeNotification', function() {
    it('should create an instance of AccountHolderStatusChangeNotification', function() {
      // uncomment below and update the code to test AccountHolderStatusChangeNotification
      //var instance = new ClassicPlatformsNotifications.AccountHolderStatusChangeNotification();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.AccountHolderStatusChangeNotification);
    });
