...
class AccountHolderStoreStatusChangeNotification {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = AccountHolderStoreStatusChangeNotificationContent.constructFromObject(data['content']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['content']) { // data not null
          AccountHolderStoreStatusChangeNotificationContent.validateJSON(data['content']);
        }
 ...
 * @member {module:model/AccountHolderStoreStatusChangeNotificationContent} content
 */
 ...
 */
AccountHolderStoreStatusChangeNotification.prototype['error'] = undefined;
