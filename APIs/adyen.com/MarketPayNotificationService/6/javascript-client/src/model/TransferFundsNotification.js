...
/**
 * The TransferFundsNotification model module.
 * @module model/TransferFundsNotification
 * @version 6
 */
class TransferFundsNotification {
    /**
     * Constructs a new <code>TransferFundsNotification</code>.
     * @alias module:model/TransferFundsNotification
    ...
    constructor(eventDate, eventType, executingUserKey, live, pspReference) { 
        ...
        TransferFundsNotification.initialize(this, eventDate, eventType, executingUserKey, live, pspReference);
    }
    ...
    /**
     * Constructs a <code>TransferFundsNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransferFundsNotification} obj Optional instance to populate.
     * @return {module:model/TransferFundsNotification} The populated <code>TransferFundsNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransferFundsNotification();

            if (data.hasOwnProperty('content')) {
                obj['content'] = TransferFundsNotificationContent.constructFromObject(data['content']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TransferFundsNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransferFundsNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransferFundsNotification.RequiredProperties) {
        ...
        if (data['content']) { // data not null
          TransferFundsNotificationContent.validateJSON(data['content']);
        }
...
TransferFundsNotification.RequiredProperties = ["eventDate", "eventType", "executingUserKey", "live", "pspReference"];

/**
 * Details of the fund transfer.
 * @member {module:model/TransferFundsNotificationContent} content
 */
TransferFundsNotification.prototype['content'] = undefined;
 ...
 */
TransferFundsNotification.prototype['error'] = undefined;

/**
 * The date and time when an event has been completed.
 * @member {Date} eventDate
 */
TransferFundsNotification.prototype['eventDate'] = undefined;

/**
 * The event type of the notification.
 * @member {String} eventType
 */
TransferFundsNotification.prototype['eventType'] = undefined;

/**
 * The user or process that has triggered the notification.
 * @member {String} executingUserKey
 */
TransferFundsNotification.prototype['executingUserKey'] = undefined;

/**
 * Indicates whether the notification originated from the live environment or the test environment. If true, the notification originated from the live environment. If false, the notification originated from the test environment.
 * @member {Boolean} live
 */
TransferFundsNotification.prototype['live'] = undefined;

/**
 * The PSP reference of the request from which the notification originates.
 * @member {String} pspReference
 */
TransferFundsNotification.prototype['pspReference'] = undefined;
...
export default TransferFundsNotification;
