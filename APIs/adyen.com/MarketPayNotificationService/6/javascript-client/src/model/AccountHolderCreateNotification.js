...
/**
 * The AccountHolderCreateNotification model module.
 * @module model/AccountHolderCreateNotification
 * @version 6
 */
class AccountHolderCreateNotification {
    /**
     * Constructs a new <code>AccountHolderCreateNotification</code>.
     * @alias module:model/AccountHolderCreateNotification
    ...
    constructor(eventDate, eventType, executingUserKey, live, pspReference) { 
        ...
        AccountHolderCreateNotification.initialize(this, eventDate, eventType, executingUserKey, live, pspReference);
    }
    ...
    /**
     * Constructs a <code>AccountHolderCreateNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountHolderCreateNotification} obj Optional instance to populate.
     * @return {module:model/AccountHolderCreateNotification} The populated <code>AccountHolderCreateNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountHolderCreateNotification();

            if (data.hasOwnProperty('content')) {
                obj['content'] = CreateAccountHolderResponse.constructFromObject(data['content']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountHolderCreateNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountHolderCreateNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountHolderCreateNotification.RequiredProperties) {
        ...
        if (data['content']) { // data not null
          CreateAccountHolderResponse.validateJSON(data['content']);
        }
...
AccountHolderCreateNotification.RequiredProperties = ["eventDate", "eventType", "executingUserKey", "live", "pspReference"];

/**
 * The details of the account holder creation.
 * @member {module:model/CreateAccountHolderResponse} content
 */
AccountHolderCreateNotification.prototype['content'] = undefined;
 ...
 */
AccountHolderCreateNotification.prototype['error'] = undefined;

/**
 * The date and time when an event has been completed.
 * @member {Date} eventDate
 */
AccountHolderCreateNotification.prototype['eventDate'] = undefined;

/**
 * The event type of the notification.
 * @member {String} eventType
 */
AccountHolderCreateNotification.prototype['eventType'] = undefined;

/**
 * The user or process that has triggered the notification.
 * @member {String} executingUserKey
 */
AccountHolderCreateNotification.prototype['executingUserKey'] = undefined;

/**
 * Indicates whether the notification originated from the live environment or the test environment. If true, the notification originated from the live environment. If false, the notification originated from the test environment.
 * @member {Boolean} live
 */
AccountHolderCreateNotification.prototype['live'] = undefined;

/**
 * The PSP reference of the request from which the notification originates.
 * @member {String} pspReference
 */
AccountHolderCreateNotification.prototype['pspReference'] = undefined;
...
export default AccountHolderCreateNotification;
