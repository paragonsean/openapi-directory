...
/**
 * The ScheduledRefundsNotification model module.
 * @module model/ScheduledRefundsNotification
 * @version 6
 */
class ScheduledRefundsNotification {
    /**
     * Constructs a new <code>ScheduledRefundsNotification</code>.
     * @alias module:model/ScheduledRefundsNotification
    ...
    constructor(eventDate, eventType, executingUserKey, live, pspReference) { 
        ...
        ScheduledRefundsNotification.initialize(this, eventDate, eventType, executingUserKey, live, pspReference);
    }
    ...
    /**
     * Constructs a <code>ScheduledRefundsNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduledRefundsNotification} obj Optional instance to populate.
     * @return {module:model/ScheduledRefundsNotification} The populated <code>ScheduledRefundsNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduledRefundsNotification();

            if (data.hasOwnProperty('content')) {
                obj['content'] = ScheduledRefundsNotificationContent.constructFromObject(data['content']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduledRefundsNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduledRefundsNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScheduledRefundsNotification.RequiredProperties) {
        ...
        if (data['content']) { // data not null
          ScheduledRefundsNotificationContent.validateJSON(data['content']);
        }
...
ScheduledRefundsNotification.RequiredProperties = ["eventDate", "eventType", "executingUserKey", "live", "pspReference"];

/**
 * Details of the scheduling of the refunds.
 * @member {module:model/ScheduledRefundsNotificationContent} content
 */
ScheduledRefundsNotification.prototype['content'] = undefined;
 ...
 */
ScheduledRefundsNotification.prototype['error'] = undefined;

/**
 * The date and time when an event has been completed.
 * @member {Date} eventDate
 */
ScheduledRefundsNotification.prototype['eventDate'] = undefined;

/**
 * The event type of the notification.
 * @member {String} eventType
 */
ScheduledRefundsNotification.prototype['eventType'] = undefined;

/**
 * The user or process that has triggered the notification.
 * @member {String} executingUserKey
 */
ScheduledRefundsNotification.prototype['executingUserKey'] = undefined;

/**
 * Indicates whether the notification originated from the live environment or the test environment. If true, the notification originated from the live environment. If false, the notification originated from the test environment.
 * @member {Boolean} live
 */
ScheduledRefundsNotification.prototype['live'] = undefined;

/**
 * The PSP reference of the request from which the notification originates.
 * @member {String} pspReference
 */
ScheduledRefundsNotification.prototype['pspReference'] = undefined;
...
export default ScheduledRefundsNotification;
