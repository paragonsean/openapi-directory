...
/**
 * The ReportAvailableNotification model module.
 * @module model/ReportAvailableNotification
 * @version 6
 */
class ReportAvailableNotification {
    /**
     * Constructs a new <code>ReportAvailableNotification</code>.
     * @alias module:model/ReportAvailableNotification
    ...
    constructor(eventDate, eventType, executingUserKey, live, pspReference) { 
        ...
        ReportAvailableNotification.initialize(this, eventDate, eventType, executingUserKey, live, pspReference);
    }
    ...
    /**
     * Constructs a <code>ReportAvailableNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReportAvailableNotification} obj Optional instance to populate.
     * @return {module:model/ReportAvailableNotification} The populated <code>ReportAvailableNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportAvailableNotification();

            if (data.hasOwnProperty('content')) {
                obj['content'] = ReportAvailableNotificationContent.constructFromObject(data['content']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ReportAvailableNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReportAvailableNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReportAvailableNotification.RequiredProperties) {
        ...
        if (data['content']) { // data not null
          ReportAvailableNotificationContent.validateJSON(data['content']);
        }
...
ReportAvailableNotification.RequiredProperties = ["eventDate", "eventType", "executingUserKey", "live", "pspReference"];

/**
 * Details of the report.
 * @member {module:model/ReportAvailableNotificationContent} content
 */
ReportAvailableNotification.prototype['content'] = undefined;
 ...
 */
ReportAvailableNotification.prototype['error'] = undefined;

/**
 * The date and time when an event has been completed.
 * @member {Date} eventDate
 */
ReportAvailableNotification.prototype['eventDate'] = undefined;

/**
 * The event type of the notification.
 * @member {String} eventType
 */
ReportAvailableNotification.prototype['eventType'] = undefined;

/**
 * The user or process that has triggered the notification.
 * @member {String} executingUserKey
 */
ReportAvailableNotification.prototype['executingUserKey'] = undefined;

/**
 * Indicates whether the notification originated from the live environment or the test environment. If true, the notification originated from the live environment. If false, the notification originated from the test environment.
 * @member {Boolean} live
 */
ReportAvailableNotification.prototype['live'] = undefined;

/**
 * The PSP reference of the request from which the notification originates.
 * @member {String} pspReference
 */
ReportAvailableNotification.prototype['pspReference'] = undefined;
...
export default ReportAvailableNotification;
