    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('refundResults')) {
                obj['refundResults'] = ApiClient.convertToType(data['refundResults'], [RefundResult]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['refundResults']) { // data not null
            ...
            for (const item of data['refundResults']) {
                RefundResult.validateJSON(item);
            };
        }
 ...
 */
ScheduledRefundsNotificationContent.prototype['invalidFields'] = undefined;
 ...
 * @member {Array.<module:model/RefundResult>} refundResults
 */
