...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.AccountCloseNotification();
  });
  ...
  describe('AccountCloseNotification', function() {
    it('should create an instance of AccountCloseNotification', function() {
      // uncomment below and update the code to test AccountCloseNotification
      //var instance = new ClassicPlatformsNotifications.AccountCloseNotification();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.AccountCloseNotification);
    });
