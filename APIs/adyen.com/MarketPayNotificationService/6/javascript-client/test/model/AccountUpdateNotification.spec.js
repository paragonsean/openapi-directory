...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.AccountUpdateNotification();
  });
  ...
  describe('AccountUpdateNotification', function() {
    it('should create an instance of AccountUpdateNotification', function() {
      // uncomment below and update the code to test AccountUpdateNotification
      //var instance = new ClassicPlatformsNotifications.AccountUpdateNotification();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.AccountUpdateNotification);
    });
