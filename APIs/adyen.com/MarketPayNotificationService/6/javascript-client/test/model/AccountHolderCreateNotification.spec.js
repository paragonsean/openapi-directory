...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.AccountHolderCreateNotification();
  });
  ...
  describe('AccountHolderCreateNotification', function() {
    it('should create an instance of AccountHolderCreateNotification', function() {
      // uncomment below and update the code to test AccountHolderCreateNotification
      //var instance = new ClassicPlatformsNotifications.AccountHolderCreateNotification();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.AccountHolderCreateNotification);
    });
