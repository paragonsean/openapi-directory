...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.Amount();
  });
  ...
  describe('Amount', function() {
    it('should create an instance of Amount', function() {
      ...
      //var instance = new ClassicPlatformsNotifications.Amount();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.Amount);
    });
