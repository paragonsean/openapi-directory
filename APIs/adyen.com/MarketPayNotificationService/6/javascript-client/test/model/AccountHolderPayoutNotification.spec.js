...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.AccountHolderPayoutNotification();
  });
  ...
  describe('AccountHolderPayoutNotification', function() {
    it('should create an instance of AccountHolderPayoutNotification', function() {
      // uncomment below and update the code to test AccountHolderPayoutNotification
      //var instance = new ClassicPlatformsNotifications.AccountHolderPayoutNotification();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.AccountHolderPayoutNotification);
    });
