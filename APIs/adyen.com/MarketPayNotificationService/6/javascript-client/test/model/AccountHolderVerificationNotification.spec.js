...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.AccountHolderVerificationNotification();
  });
  ...
  describe('AccountHolderVerificationNotification', function() {
    it('should create an instance of AccountHolderVerificationNotification', function() {
      // uncomment below and update the code to test AccountHolderVerificationNotification
      //var instance = new ClassicPlatformsNotifications.AccountHolderVerificationNotification();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.AccountHolderVerificationNotification);
    });
