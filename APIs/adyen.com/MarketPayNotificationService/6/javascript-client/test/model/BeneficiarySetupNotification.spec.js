...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.BeneficiarySetupNotification();
  });
  ...
  describe('BeneficiarySetupNotification', function() {
    it('should create an instance of BeneficiarySetupNotification', function() {
      // uncomment below and update the code to test BeneficiarySetupNotification
      //var instance = new ClassicPlatformsNotifications.BeneficiarySetupNotification();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.BeneficiarySetupNotification);
    });
