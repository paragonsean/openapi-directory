...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.ReportAvailableNotification();
  });
  ...
  describe('ReportAvailableNotification', function() {
    it('should create an instance of ReportAvailableNotification', function() {
      // uncomment below and update the code to test ReportAvailableNotification
      //var instance = new ClassicPlatformsNotifications.ReportAvailableNotification();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.ReportAvailableNotification);
    });
