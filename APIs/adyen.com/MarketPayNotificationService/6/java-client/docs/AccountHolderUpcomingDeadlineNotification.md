...
|------------ | ------------- | ------------- | -------------|
|**content** | [**AccountHolderUpcomingDeadlineNotificationContent**](AccountHolderUpcomingDeadlineNotificationContent.md) | The details of the upcoming event. |  [optional] |
