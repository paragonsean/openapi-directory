...
|------------ | ------------- | ------------- | -------------|
|**content** | [**AccountHolderStoreStatusChangeNotificationContent**](AccountHolderStoreStatusChangeNotificationContent.md) | The details of the Account Holder Store status change. |  [optional] |
