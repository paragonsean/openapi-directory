...
public class AccountCloseNotification {
  ...
  private CloseAccountResponse content;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, accountCloseNotification.content) &&
        ...
        Objects.equals(this.eventDate, accountCloseNotification.eventDate) &&
        Objects.equals(this.eventType, accountCloseNotification.eventType) &&
        Objects.equals(this.executingUserKey, accountCloseNotification.executingUserKey) &&
        Objects.equals(this.live, accountCloseNotification.live) &&
        Objects.equals(this.pspReference, accountCloseNotification.pspReference);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountCloseNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountCloseNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountCloseNotification is not found in the empty JSON string", AccountCloseNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountCloseNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountCloseNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountCloseNotification.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        CloseAccountResponse.validateJsonElement(jsonObj.get("content"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountCloseNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountCloseNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountCloseNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountCloseNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountCloseNotification>() {
           @Override
           public void write(JsonWriter out, AccountCloseNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountCloseNotification read(JsonReader in) throws IOException {
   ...
   * @return An instance of AccountCloseNotification
   * @throws IOException if the JSON string is invalid with respect to AccountCloseNotification
   */
  public static AccountCloseNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountCloseNotification.class);
  }
