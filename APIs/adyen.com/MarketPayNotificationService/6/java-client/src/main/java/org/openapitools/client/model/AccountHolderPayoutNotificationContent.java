...
public class AccountHolderPayoutNotificationContent {
  ...
  public static final String SERIALIZED_NAME_PAYOUT_ACCOUNT_COUNTRY = "payoutAccountCountry";
  @SerializedName(SERIALIZED_NAME_PAYOUT_ACCOUNT_COUNTRY)
  private String payoutAccountCountry;

  public static final String SERIALIZED_NAME_PAYOUT_ACCOUNT_NUMBER = "payoutAccountNumber";
  @SerializedName(SERIALIZED_NAME_PAYOUT_ACCOUNT_NUMBER)
  private String payoutAccountNumber;

  public static final String SERIALIZED_NAME_PAYOUT_BALANCE_ACCOUNT_ID = "payoutBalanceAccountId";
  @SerializedName(SERIALIZED_NAME_PAYOUT_BALANCE_ACCOUNT_ID)
  private String payoutBalanceAccountId;

  public static final String SERIALIZED_NAME_PAYOUT_BANK_NAME = "payoutBankName";
  @SerializedName(SERIALIZED_NAME_PAYOUT_BANK_NAME)
  private String payoutBankName;

  public static final String SERIALIZED_NAME_PAYOUT_BRANCH_CODE = "payoutBranchCode";
  @SerializedName(SERIALIZED_NAME_PAYOUT_BRANCH_CODE)
  private String payoutBranchCode;

  public static final String SERIALIZED_NAME_PAYOUT_REFERENCE = "payoutReference";
  @SerializedName(SERIALIZED_NAME_PAYOUT_REFERENCE)
  ...
  static {
    ...
    openapiFields.add("payoutAccountCountry");
    openapiFields.add("payoutAccountNumber");
    openapiFields.add("payoutBalanceAccountId");
    openapiFields.add("payoutBankName");
    openapiFields.add("payoutBranchCode");
    openapiFields.add("payoutReference");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("payoutAccountCountry") != null && !jsonObj.get("payoutAccountCountry").isJsonNull()) && !jsonObj.get("payoutAccountCountry").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `payoutAccountCountry` to be a primitive type in the JSON string but got `%s`", jsonObj.get("payoutAccountCountry").toString()));
      }
      if ((jsonObj.get("payoutAccountNumber") != null && !jsonObj.get("payoutAccountNumber").isJsonNull()) && !jsonObj.get("payoutAccountNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `payoutAccountNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("payoutAccountNumber").toString()));
      }
      if ((jsonObj.get("payoutBalanceAccountId") != null && !jsonObj.get("payoutBalanceAccountId").isJsonNull()) && !jsonObj.get("payoutBalanceAccountId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `payoutBalanceAccountId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("payoutBalanceAccountId").toString()));
      }
      if ((jsonObj.get("payoutBankName") != null && !jsonObj.get("payoutBankName").isJsonNull()) && !jsonObj.get("payoutBankName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `payoutBankName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("payoutBankName").toString()));
      }
      if ((jsonObj.get("payoutBranchCode") != null && !jsonObj.get("payoutBranchCode").isJsonNull()) && !jsonObj.get("payoutBranchCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `payoutBranchCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("payoutBranchCode").toString()));
      }
