...
QString OAIKYCShareholderCheckResult::getLegalArrangementCode() const {
    return m_legal_arrangement_code;
}
void OAIKYCShareholderCheckResult::setLegalArrangementCode(const QString &legal_arrangement_code) {
    m_legal_arrangement_code = legal_arrangement_code;
    m_legal_arrangement_code_isSet = true;
}

bool OAIKYCShareholderCheckResult::is_legal_arrangement_code_Set() const{
    return m_legal_arrangement_code_isSet;
}

bool OAIKYCShareholderCheckResult::is_legal_arrangement_code_Valid() const{
    return m_legal_arrangement_code_isValid;
}

QString OAIKYCShareholderCheckResult::getLegalArrangementEntityCode() const {
    return m_legal_arrangement_entity_code;
}
void OAIKYCShareholderCheckResult::setLegalArrangementEntityCode(const QString &legal_arrangement_entity_code) {
    m_legal_arrangement_entity_code = legal_arrangement_entity_code;
    m_legal_arrangement_entity_code_isSet = true;
}

bool OAIKYCShareholderCheckResult::is_legal_arrangement_entity_code_Set() const{
    return m_legal_arrangement_entity_code_isSet;
}

bool OAIKYCShareholderCheckResult::is_legal_arrangement_entity_code_Valid() const{
