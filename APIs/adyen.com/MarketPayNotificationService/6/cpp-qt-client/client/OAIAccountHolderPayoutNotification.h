...
/*
 * OAIAccountHolderPayoutNotification.h
 *
 * 
 */

#ifndef OAIAccountHolderPayoutNotification_H
#define OAIAccountHolderPayoutNotification_H
...
namespace OpenAPI {
class OAIAccountHolderPayoutNotificationContent;
class OAINotificationErrorContainer;

class OAIAccountHolderPayoutNotification : public OAIObject {
public:
    OAIAccountHolderPayoutNotification();
    OAIAccountHolderPayoutNotification(QString json);
    ~OAIAccountHolderPayoutNotification() override;
    ...
    OAIAccountHolderPayoutNotificationContent getContent() const;
    void setContent(const OAIAccountHolderPayoutNotificationContent &content);
...
private:
    ...
    OAIAccountHolderPayoutNotificationContent m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountHolderPayoutNotification)

#endif // OAIAccountHolderPayoutNotification_H
