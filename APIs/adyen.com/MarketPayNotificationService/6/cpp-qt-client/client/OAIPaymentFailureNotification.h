...
/*
 * OAIPaymentFailureNotification.h
 *
 * 
 */

#ifndef OAIPaymentFailureNotification_H
#define OAIPaymentFailureNotification_H
...
namespace OpenAPI {
class OAIPaymentFailureNotificationContent;
class OAINotificationErrorContainer;

class OAIPaymentFailureNotification : public OAIObject {
public:
    OAIPaymentFailureNotification();
    OAIPaymentFailureNotification(QString json);
    ~OAIPaymentFailureNotification() override;
    ...
    OAIPaymentFailureNotificationContent getContent() const;
    void setContent(const OAIPaymentFailureNotificationContent &content);
...
private:
    ...
    OAIPaymentFailureNotificationContent m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentFailureNotification)

#endif // OAIPaymentFailureNotification_H
