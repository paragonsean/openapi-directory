...
/*
 * OAIAccountCloseNotification.h
 *
 * 
 */

#ifndef OAIAccountCloseNotification_H
#define OAIAccountCloseNotification_H
...
namespace OpenAPI {
class OAICloseAccountResponse;
class OAINotificationErrorContainer;

class OAIAccountCloseNotification : public OAIObject {
public:
    OAIAccountCloseNotification();
    OAIAccountCloseNotification(QString json);
    ~OAIAccountCloseNotification() override;
    ...
    OAICloseAccountResponse getContent() const;
    void setContent(const OAICloseAccountResponse &content);
...
private:
    ...
    OAICloseAccountResponse m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountCloseNotification)

#endif // OAIAccountCloseNotification_H
