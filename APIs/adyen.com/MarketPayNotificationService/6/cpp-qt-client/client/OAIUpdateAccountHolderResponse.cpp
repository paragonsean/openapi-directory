...
QString OAIUpdateAccountHolderResponse::getVerificationProfile() const {
    return m_verification_profile;
}
void OAIUpdateAccountHolderResponse::setVerificationProfile(const QString &verification_profile) {
    m_verification_profile = verification_profile;
    m_verification_profile_isSet = true;
}

bool OAIUpdateAccountHolderResponse::is_verification_profile_Set() const{
    return m_verification_profile_isSet;
}

bool OAIUpdateAccountHolderResponse::is_verification_profile_Valid() const{
