...
/*
 * OAIRefundFundsTransferNotification.h
 *
 * 
 */

#ifndef OAIRefundFundsTransferNotification_H
#define OAIRefundFundsTransferNotification_H
...
namespace OpenAPI {
class OAIRefundFundsTransferNotificationContent;
class OAINotificationErrorContainer;

class OAIRefundFundsTransferNotification : public OAIObject {
public:
    OAIRefundFundsTransferNotification();
    OAIRefundFundsTransferNotification(QString json);
    ~OAIRefundFundsTransferNotification() override;
    ...
    OAIRefundFundsTransferNotificationContent getContent() const;
    void setContent(const OAIRefundFundsTransferNotificationContent &content);
...
private:
    ...
    OAIRefundFundsTransferNotificationContent m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefundFundsTransferNotification)

#endif // OAIRefundFundsTransferNotification_H
