...
/*
 * OAIAccountHolderUpdateNotification.h
 *
 * 
 */

#ifndef OAIAccountHolderUpdateNotification_H
#define OAIAccountHolderUpdateNotification_H
...
namespace OpenAPI {
class OAIUpdateAccountHolderResponse;
class OAINotificationErrorContainer;

class OAIAccountHolderUpdateNotification : public OAIObject {
public:
    OAIAccountHolderUpdateNotification();
    OAIAccountHolderUpdateNotification(QString json);
    ~OAIAccountHolderUpdateNotification() override;
    ...
    OAIUpdateAccountHolderResponse getContent() const;
    void setContent(const OAIUpdateAccountHolderResponse &content);
...
private:
    ...
    OAIUpdateAccountHolderResponse m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountHolderUpdateNotification)

#endif // OAIAccountHolderUpdateNotification_H
