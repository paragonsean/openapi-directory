...
QList<OAILegalArrangementDetail> OAIAccountHolderDetails::getLegalArrangements() const {
    return m_legal_arrangements;
}
void OAIAccountHolderDetails::setLegalArrangements(const QList<OAILegalArrangementDetail> &legal_arrangements) {
    m_legal_arrangements = legal_arrangements;
    m_legal_arrangements_isSet = true;
}

bool OAIAccountHolderDetails::is_legal_arrangements_Set() const{
    return m_legal_arrangements_isSet;
}

bool OAIAccountHolderDetails::is_legal_arrangements_Valid() const{
