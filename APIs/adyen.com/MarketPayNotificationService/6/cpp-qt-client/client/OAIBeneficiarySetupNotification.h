...
/*
 * OAIBeneficiarySetupNotification.h
 *
 * 
 */

#ifndef OAIBeneficiarySetupNotification_H
#define OAIBeneficiarySetupNotification_H
...
namespace OpenAPI {
class OAIBeneficiarySetupNotificationContent;
class OAINotificationErrorContainer;

class OAIBeneficiarySetupNotification : public OAIObject {
public:
    OAIBeneficiarySetupNotification();
    OAIBeneficiarySetupNotification(QString json);
    ~OAIBeneficiarySetupNotification() override;
    ...
    OAIBeneficiarySetupNotificationContent getContent() const;
    void setContent(const OAIBeneficiarySetupNotificationContent &content);
...
private:
    ...
    OAIBeneficiarySetupNotificationContent m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBeneficiarySetupNotification)

#endif // OAIBeneficiarySetupNotification_H
