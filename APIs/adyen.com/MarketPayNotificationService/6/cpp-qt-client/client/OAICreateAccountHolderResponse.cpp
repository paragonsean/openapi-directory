...
QString OAICreateAccountHolderResponse::getVerificationProfile() const {
    return m_verification_profile;
}
void OAICreateAccountHolderResponse::setVerificationProfile(const QString &verification_profile) {
    m_verification_profile = verification_profile;
    m_verification_profile_isSet = true;
}

bool OAICreateAccountHolderResponse::is_verification_profile_Set() const{
    return m_verification_profile_isSet;
}

bool OAICreateAccountHolderResponse::is_verification_profile_Valid() const{
