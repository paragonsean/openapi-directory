...
/*
 * OAIShareholderContact.h
 *
 * 
 */

#ifndef OAIShareholderContact_H
#define OAIShareholderContact_H
...
class OAIShareholderContact : public OAIObject {
public:
    OAIShareholderContact();
    OAIShareholderContact(QString json);
    ~OAIShareholderContact() override;
    ...
    QString getShareholderReference() const;
    void setShareholderReference(const QString &shareholder_reference);
    bool is_shareholder_reference_Set() const;
    bool is_shareholder_reference_Valid() const;
...
private:
    ...
    QString m_shareholder_reference;
    bool m_shareholder_reference_isSet;
    bool m_shareholder_reference_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShareholderContact)

#endif // OAIShareholderContact_H
