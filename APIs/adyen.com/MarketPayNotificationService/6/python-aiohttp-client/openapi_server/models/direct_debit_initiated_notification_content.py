...
class DirectDebitInitiatedNotificationContent(Model):
    ...
    def __init__(self, account_code: str=None, amount: Amount=None, debit_initiation_date: LocalDate=None, invalid_fields: List[ErrorFieldType]=None, merchant_account_code: str=None, splits: List[Split]=None, status: OperationStatus=None):
