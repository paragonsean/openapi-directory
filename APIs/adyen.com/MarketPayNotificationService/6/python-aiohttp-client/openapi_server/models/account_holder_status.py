...
class AccountHolderStatus(Model):
    ...
    def __init__(self, events: List[AccountEvent]=None, payout_state: AccountPayoutState=None, processing_state: AccountProcessingState=None, status: str=None, status_reason: str=None):
