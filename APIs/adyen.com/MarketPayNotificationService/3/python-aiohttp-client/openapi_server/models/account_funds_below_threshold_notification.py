...
class AccountFundsBelowThresholdNotification(Model):
    ...
    def __init__(self, content: AccountFundsBelowThresholdNotificationContent=None, event_type: str=None, executing_user_key: str=None, live: bool=None, psp_reference: str=None):
