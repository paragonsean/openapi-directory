...
public class RefundFundsTransferNotification {
   ...
   * @throws IOException if the JSON Element is invalid with respect to RefundFundsTransferNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RefundFundsTransferNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RefundFundsTransferNotification is not found in the empty JSON string", RefundFundsTransferNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RefundFundsTransferNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RefundFundsTransferNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RefundFundsTransferNotification.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        RefundFundsTransferNotificationContent.validateJsonElement(jsonObj.get("content"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RefundFundsTransferNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RefundFundsTransferNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RefundFundsTransferNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RefundFundsTransferNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<RefundFundsTransferNotification>() {
           @Override
           public void write(JsonWriter out, RefundFundsTransferNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RefundFundsTransferNotification read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to RefundFundsTransferNotification
   */
  public static RefundFundsTransferNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RefundFundsTransferNotification.class);
  }
