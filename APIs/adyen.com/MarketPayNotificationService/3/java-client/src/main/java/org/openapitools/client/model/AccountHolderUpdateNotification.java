...
public class AccountHolderUpdateNotification {
  ...
  public AccountHolderUpdateNotification() {
  }
  ...
  public AccountHolderUpdateNotification eventType(String eventType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, accountHolderUpdateNotification.content) &&
        Objects.equals(this.eventType, accountHolderUpdateNotification.eventType) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountHolderUpdateNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountHolderUpdateNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountHolderUpdateNotification is not found in the empty JSON string", AccountHolderUpdateNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountHolderUpdateNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountHolderUpdateNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountHolderUpdateNotification.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        UpdateAccountHolderResponse.validateJsonElement(jsonObj.get("content"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountHolderUpdateNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountHolderUpdateNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountHolderUpdateNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountHolderUpdateNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountHolderUpdateNotification>() {
           @Override
           public void write(JsonWriter out, AccountHolderUpdateNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountHolderUpdateNotification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountHolderUpdateNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountHolderUpdateNotification
   * @throws IOException if the JSON string is invalid with respect to AccountHolderUpdateNotification
   */
  public static AccountHolderUpdateNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountHolderUpdateNotification.class);
  }

  /**
   * Convert an instance of AccountHolderUpdateNotification to an JSON string
   *
   * @return JSON string
   */
