...
public class AccountHolderUpcomingDeadlineNotification {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountHolderUpcomingDeadlineNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountHolderUpcomingDeadlineNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountHolderUpcomingDeadlineNotification is not found in the empty JSON string", AccountHolderUpcomingDeadlineNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountHolderUpcomingDeadlineNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountHolderUpcomingDeadlineNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountHolderUpcomingDeadlineNotification.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        AccountHolderUpcomingDeadlineNotificationContent.validateJsonElement(jsonObj.get("content"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountHolderUpcomingDeadlineNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountHolderUpcomingDeadlineNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountHolderUpcomingDeadlineNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountHolderUpcomingDeadlineNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountHolderUpcomingDeadlineNotification>() {
           @Override
           public void write(JsonWriter out, AccountHolderUpcomingDeadlineNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountHolderUpcomingDeadlineNotification read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to AccountHolderUpcomingDeadlineNotification
   */
  public static AccountHolderUpcomingDeadlineNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountHolderUpcomingDeadlineNotification.class);
  }
