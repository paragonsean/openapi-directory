...
import org.openapitools.client.model.KYCCheckDataSummaryItemWrapper;
...
public class AccountHolderVerificationNotificationContent {
  ...
  public static final String SERIALIZED_NAME_STATUS_SUMMARY_ITEMS = "statusSummaryItems";
  @SerializedName(SERIALIZED_NAME_STATUS_SUMMARY_ITEMS)
  private List<KYCCheckDataSummaryItemWrapper> statusSummaryItems = new ArrayList<>();
  ...
  public AccountHolderVerificationNotificationContent statusSummaryItems(List<KYCCheckDataSummaryItemWrapper> statusSummaryItems) {
    this.statusSummaryItems = statusSummaryItems;
    return this;
  }

  public AccountHolderVerificationNotificationContent addStatusSummaryItemsItem(KYCCheckDataSummaryItemWrapper statusSummaryItemsItem) {
    if (this.statusSummaryItems == null) {
      this.statusSummaryItems = new ArrayList<>();
    }
    this.statusSummaryItems.add(statusSummaryItemsItem);
    return this;
  }

  /**
   * A summary of the verification status.
   * @return statusSummaryItems
   */
  @javax.annotation.Nullable
  public List<KYCCheckDataSummaryItemWrapper> getStatusSummaryItems() {
    return statusSummaryItems;
  }

  public void setStatusSummaryItems(List<KYCCheckDataSummaryItemWrapper> statusSummaryItems) {
    this.statusSummaryItems = statusSummaryItems;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountHolderCode, accountHolderVerificationNotificationContent.accountHolderCode) &&
        ...
        Objects.equals(this.statusSummaryItems, accountHolderVerificationNotificationContent.statusSummaryItems) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountHolderCode, bankAccountUUID, shareholderCode, signatoryCode, statusSummaryItems, verificationStatus, verificationType);
  }
  ...
  public String toString() {
    ...
    sb.append("    statusSummaryItems: ").append(toIndentedString(statusSummaryItems)).append("\n");
  ...
  static {
    ...
    openapiFields.add("statusSummaryItems");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("statusSummaryItems") != null && !jsonObj.get("statusSummaryItems").isJsonNull()) {
        JsonArray jsonArraystatusSummaryItems = jsonObj.getAsJsonArray("statusSummaryItems");
        if (jsonArraystatusSummaryItems != null) {
          // ensure the json data is an array
          if (!jsonObj.get("statusSummaryItems").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `statusSummaryItems` to be an array in the JSON string but got `%s`", jsonObj.get("statusSummaryItems").toString()));
          }

          // validate the optional field `statusSummaryItems` (array)
          for (int i = 0; i < jsonArraystatusSummaryItems.size(); i++) {
            KYCCheckDataSummaryItemWrapper.validateJsonElement(jsonArraystatusSummaryItems.get(i));
          };
        }
      }
