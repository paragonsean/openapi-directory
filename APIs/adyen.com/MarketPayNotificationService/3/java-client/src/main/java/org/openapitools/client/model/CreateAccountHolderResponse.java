...
public class CreateAccountHolderResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountCode, accountHolderCode, accountHolderDetails, accountHolderStatus, invalidFields, pspReference, resultCode, submittedAsync, verification);
  }
