...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.ViasPhoneNumber();
  });
  ...
  describe('ViasPhoneNumber', function() {
    it('should create an instance of ViasPhoneNumber', function() {
      // uncomment below and update the code to test ViasPhoneNumber
      //var instance = new ClassicPlatformsNotifications.ViasPhoneNumber();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.ViasPhoneNumber);
    });
