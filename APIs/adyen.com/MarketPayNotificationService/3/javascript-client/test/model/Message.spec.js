...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.Message();
  });
  ...
  describe('Message', function() {
    it('should create an instance of Message', function() {
      ...
      //var instance = new ClassicPlatformsNotifications.Message();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.Message);
    });
