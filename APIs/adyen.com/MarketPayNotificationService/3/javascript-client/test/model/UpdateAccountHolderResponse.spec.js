...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClassicPlatformsNotifications.UpdateAccountHolderResponse();
  });
  ...
  describe('UpdateAccountHolderResponse', function() {
    it('should create an instance of UpdateAccountHolderResponse', function() {
      // uncomment below and update the code to test UpdateAccountHolderResponse
      //var instance = new ClassicPlatformsNotifications.UpdateAccountHolderResponse();
      //expect(instance).to.be.a(ClassicPlatformsNotifications.UpdateAccountHolderResponse);
    });
    ...
    it('should have the property updatedFields (base name: "updatedFields")', function() {
