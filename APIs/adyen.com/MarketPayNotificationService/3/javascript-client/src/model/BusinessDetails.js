...
import ShareholderContactWrapper from './ShareholderContactWrapper';
import SignatoryContactWrapper from './SignatoryContactWrapper';
import UltimateParentCompanyWrapper from './UltimateParentCompanyWrapper';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('listedUltimateParentCompany')) {
                obj['listedUltimateParentCompany'] = ApiClient.convertToType(data['listedUltimateParentCompany'], [UltimateParentCompanyWrapper]);
            }
            if (data.hasOwnProperty('shareholders')) {
                obj['shareholders'] = ApiClient.convertToType(data['shareholders'], [ShareholderContactWrapper]);
            }
            if (data.hasOwnProperty('signatories')) {
                obj['signatories'] = ApiClient.convertToType(data['signatories'], [SignatoryContactWrapper]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['listedUltimateParentCompany']) { // data not null
            ...
            for (const item of data['listedUltimateParentCompany']) {
                UltimateParentCompanyWrapper.validateJSON(item);
            };
        }
        if (data['shareholders']) { // data not null
            ...
            for (const item of data['shareholders']) {
                ShareholderContactWrapper.validateJSON(item);
            };
        }
        if (data['signatories']) { // data not null
            ...
            for (const item of data['signatories']) {
                SignatoryContactWrapper.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/UltimateParentCompanyWrapper>} listedUltimateParentCompany
 */
 ...
 * @member {Array.<module:model/ShareholderContactWrapper>} shareholders
 */
 ...
 * @member {Array.<module:model/SignatoryContactWrapper>} signatories
 */
