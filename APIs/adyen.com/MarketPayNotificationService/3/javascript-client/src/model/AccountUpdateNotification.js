...
class AccountUpdateNotification {
    ...
    constructor(eventType, executingUserKey, live, pspReference) { 
        ...
        AccountUpdateNotification.initialize(this, eventType, executingUserKey, live, pspReference);
    }
...
AccountUpdateNotification.RequiredProperties = ["eventType", "executingUserKey", "live", "pspReference"];
