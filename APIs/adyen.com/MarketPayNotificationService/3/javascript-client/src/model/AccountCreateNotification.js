...
/**
 * The AccountCreateNotification model module.
 * @module model/AccountCreateNotification
 * @version 3
 */
class AccountCreateNotification {
    /**
     * Constructs a new <code>AccountCreateNotification</code>.
     * @alias module:model/AccountCreateNotification
    ...
    constructor(eventType, executingUserKey, live, pspReference) { 
        ...
        AccountCreateNotification.initialize(this, eventType, executingUserKey, live, pspReference);
    }
    ...
    /**
     * Constructs a <code>AccountCreateNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountCreateNotification} obj Optional instance to populate.
     * @return {module:model/AccountCreateNotification} The populated <code>AccountCreateNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountCreateNotification();

            if (data.hasOwnProperty('content')) {
                obj['content'] = CreateAccountResponse.constructFromObject(data['content']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountCreateNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountCreateNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountCreateNotification.RequiredProperties) {
        ...
        if (data['content']) { // data not null
          CreateAccountResponse.validateJSON(data['content']);
        }
...
AccountCreateNotification.RequiredProperties = ["eventType", "executingUserKey", "live", "pspReference"];

/**
 * The details of the account creation.
 * @member {module:model/CreateAccountResponse} content
 */
AccountCreateNotification.prototype['content'] = undefined;

/**
 * The event type of the notification.
 * @member {String} eventType
 */
AccountCreateNotification.prototype['eventType'] = undefined;

/**
 * The user or process that has triggered the notification.
 * @member {String} executingUserKey
 */
AccountCreateNotification.prototype['executingUserKey'] = undefined;

/**
 * Indicates whether the notification originated from the live environment or the test environment. If true, the notification originated from the live environment. If false, the notification originated from the test environment.
 * @member {Boolean} live
 */
AccountCreateNotification.prototype['live'] = undefined;

/**
 * The PSP reference of the request from which the notification originates.
 * @member {String} pspReference
 */
AccountCreateNotification.prototype['pspReference'] = undefined;
...
export default AccountCreateNotification;
