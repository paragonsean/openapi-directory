...
class AccountHolderStoreStatusChangeNotification {
    ...
    constructor(eventType, executingUserKey, live, pspReference) { 
        ...
        AccountHolderStoreStatusChangeNotification.initialize(this, eventType, executingUserKey, live, pspReference);
    }
...
AccountHolderStoreStatusChangeNotification.RequiredProperties = ["eventType", "executingUserKey", "live", "pspReference"];
