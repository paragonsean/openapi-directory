...
import KYCCheckDataSummaryItemWrapper from './KYCCheckDataSummaryItemWrapper';
...
class AccountHolderVerificationNotificationContent {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('statusSummaryItems')) {
                obj['statusSummaryItems'] = ApiClient.convertToType(data['statusSummaryItems'], [KYCCheckDataSummaryItemWrapper]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['statusSummaryItems']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['statusSummaryItems'])) {
                throw new Error("Expected the field `statusSummaryItems` to be an array in the JSON data but got " + data['statusSummaryItems']);
            }
            // validate the optional field `statusSummaryItems` (array)
            for (const item of data['statusSummaryItems']) {
                KYCCheckDataSummaryItemWrapper.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/KYCCheckDataSummaryItemWrapper>} statusSummaryItems
 */
AccountHolderVerificationNotificationContent.prototype['statusSummaryItems'] = undefined;
