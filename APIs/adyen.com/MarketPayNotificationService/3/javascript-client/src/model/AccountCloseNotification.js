...
class AccountCloseNotification {
    ...
    constructor(eventType, executingUserKey, live, pspReference) { 
        ...
        AccountCloseNotification.initialize(this, eventType, executingUserKey, live, pspReference);
    }
...
AccountCloseNotification.RequiredProperties = ["eventType", "executingUserKey", "live", "pspReference"];
