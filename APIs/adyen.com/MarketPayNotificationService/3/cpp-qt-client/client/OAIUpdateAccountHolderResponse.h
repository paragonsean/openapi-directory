...
public:
    ...
    QList<OAIFieldTypeWrapper> getUpdatedFields() const;
    void setUpdatedFields(const QList<OAIFieldTypeWrapper> &updated_fields);
...
private:
    ...
    QList<OAIFieldTypeWrapper> m_updated_fields;
