...
void OAIAccountHolderVerificationNotificationContent::initializeModel() {
    ...
    m_status_summary_items_isSet = false;
    m_status_summary_items_isValid = false;
...
void OAIAccountHolderVerificationNotificationContent::fromJsonObject(QJsonObject json) {
    ...
    m_status_summary_items_isValid = ::OpenAPI::fromJsonValue(m_status_summary_items, json[QString("statusSummaryItems")]);
    m_status_summary_items_isSet = !json[QString("statusSummaryItems")].isNull() && m_status_summary_items_isValid;
...
QJsonObject OAIAccountHolderVerificationNotificationContent::asJsonObject() const {
    ...
    if (m_status_summary_items.size() > 0) {
        obj.insert(QString("statusSummaryItems"), ::OpenAPI::toJsonValue(m_status_summary_items));
    }
...
QList<OAIKYCCheckDataSummaryItemWrapper> OAIAccountHolderVerificationNotificationContent::getStatusSummaryItems() const {
    return m_status_summary_items;
}
void OAIAccountHolderVerificationNotificationContent::setStatusSummaryItems(const QList<OAIKYCCheckDataSummaryItemWrapper> &status_summary_items) {
    m_status_summary_items = status_summary_items;
    m_status_summary_items_isSet = true;
}

bool OAIAccountHolderVerificationNotificationContent::is_status_summary_items_Set() const{
    return m_status_summary_items_isSet;
}

bool OAIAccountHolderVerificationNotificationContent::is_status_summary_items_Valid() const{
    return m_status_summary_items_isValid;
}
