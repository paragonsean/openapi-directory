...
/*
 * OAIDirectDebitInitiatedNotification.h
 *
 * 
 */

#ifndef OAIDirectDebitInitiatedNotification_H
#define OAIDirectDebitInitiatedNotification_H
...
namespace OpenAPI {
class OAIDirectDebitInitiatedNotificationContent;

class OAIDirectDebitInitiatedNotification : public OAIObject {
public:
    OAIDirectDebitInitiatedNotification();
    OAIDirectDebitInitiatedNotification(QString json);
    ~OAIDirectDebitInitiatedNotification() override;
    ...
    OAIDirectDebitInitiatedNotificationContent getContent() const;
    void setContent(const OAIDirectDebitInitiatedNotificationContent &content);
...
private:
    ...
    OAIDirectDebitInitiatedNotificationContent m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDirectDebitInitiatedNotification)

#endif // OAIDirectDebitInitiatedNotification_H
