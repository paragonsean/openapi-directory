...
/*
 * OAIScheduledRefundsNotification.h
 *
 * 
 */

#ifndef OAIScheduledRefundsNotification_H
#define OAIScheduledRefundsNotification_H
...
namespace OpenAPI {
class OAIScheduledRefundsNotificationContent;

class OAIScheduledRefundsNotification : public OAIObject {
public:
    OAIScheduledRefundsNotification();
    OAIScheduledRefundsNotification(QString json);
    ~OAIScheduledRefundsNotification() override;
    ...
    OAIScheduledRefundsNotificationContent getContent() const;
    void setContent(const OAIScheduledRefundsNotificationContent &content);
...
private:
    ...
    OAIScheduledRefundsNotificationContent m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduledRefundsNotification)

#endif // OAIScheduledRefundsNotification_H
