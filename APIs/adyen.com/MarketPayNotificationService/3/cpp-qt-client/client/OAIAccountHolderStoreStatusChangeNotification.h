...
/*
 * OAIAccountHolderStoreStatusChangeNotification.h
 *
 * 
 */

#ifndef OAIAccountHolderStoreStatusChangeNotification_H
#define OAIAccountHolderStoreStatusChangeNotification_H
...
class OAIAccountHolderStoreStatusChangeNotification : public OAIObject {
public:
    OAIAccountHolderStoreStatusChangeNotification();
    OAIAccountHolderStoreStatusChangeNotification(QString json);
    ~OAIAccountHolderStoreStatusChangeNotification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountHolderStoreStatusChangeNotification)

#endif // OAIAccountHolderStoreStatusChangeNotification_H
