...
/**
 * The TransactionNotificationData model module.
 * @module model/TransactionNotificationData
 * @version 1
 */
class TransactionNotificationData {
    /**
     * Constructs a new <code>TransactionNotificationData</code>.
     * @alias module:model/TransactionNotificationData
    ...
    constructor(counterparty) { 
        ...
        TransactionNotificationData.initialize(this, counterparty);
    }
    ...
    /**
     * Constructs a <code>TransactionNotificationData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransactionNotificationData} obj Optional instance to populate.
     * @return {module:model/TransactionNotificationData} The populated <code>TransactionNotificationData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransactionNotificationData();
            ...
            if (data.hasOwnProperty('validationResult')) {
                obj['validationResult'] = ApiClient.convertToType(data['validationResult'], [ValidationResult]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TransactionNotificationData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransactionNotificationData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransactionNotificationData.RequiredProperties) {
        ...
        if (data['validationResult']) { // data not null
            ...
            if (!Array.isArray(data['validationResult'])) {
                throw new Error("Expected the field `validationResult` to be an array in the JSON data but got " + data['validationResult']);
            }
            // validate the optional field `validationResult` (array)
            for (const item of data['validationResult']) {
...
TransactionNotificationData.RequiredProperties = ["counterparty"];

/**
 * Contains information about the account holder.
 * @member {module:model/ResourceReference} accountHolder
 */
TransactionNotificationData.prototype['accountHolder'] = undefined;
 ...
 */
TransactionNotificationData.prototype['amount'] = undefined;

/**
 * The authorisation code for the payment.
 * @member {String} authCode
 */
TransactionNotificationData.prototype['authCode'] = undefined;

/**
 * Contains information about the balance account.
 * @member {module:model/ResourceReference} balanceAccount
 */
TransactionNotificationData.prototype['balanceAccount'] = undefined;

/**
 * The unique identifier of the balance platform.
 * @member {String} balancePlatform
 */
TransactionNotificationData.prototype['balancePlatform'] = undefined;

/**
 * Contains information about the other party in the transaction.
 * @member {module:model/Counterparty} counterparty
 */
TransactionNotificationData.prototype['counterparty'] = undefined;

/**
 * The date and time when the event was triggered, in ISO 8601 extended format. For example, **2020-12-18T10:15:30+01:00**.
 * @member {Date} creationDate
 */
TransactionNotificationData.prototype['creationDate'] = undefined;

/**
 * Your description for the transfer. If you send a description longer than 140 characters, the text is truncated.
 * @member {String} description
 */
TransactionNotificationData.prototype['description'] = undefined;

/**
 * The ID of the resource.
 * @member {String} id
 */
TransactionNotificationData.prototype['id'] = undefined;
 ...
 */
TransactionNotificationData.prototype['merchantData'] = undefined;
 ...
 */
TransactionNotificationData.prototype['modification'] = undefined;
 ...
 */
TransactionNotificationData.prototype['originalAmount'] = undefined;
 ...
 * @member {module:model/TransactionNotificationData.ProcessingTypeEnum} processingType
 */
TransactionNotificationData.prototype['processingType'] = undefined;
 ...
 */
TransactionNotificationData.prototype['purposeCode'] = undefined;
 ...
 */
TransactionNotificationData.prototype['reference'] = undefined;
 ...
 */
TransactionNotificationData.prototype['referenceForBeneficiary'] = undefined;
 ...
 */
TransactionNotificationData.prototype['relayedAuthorisationData'] = undefined;
 ...
 */
TransactionNotificationData.prototype['status'] = undefined;
 ...
 */
TransactionNotificationData.prototype['transactionRulesResult'] = undefined;

/**
 * Array of checks that Adyen performed to validate the payment and the result of each.
 * @member {Array.<module:model/ValidationResult>} validationResult
 */
TransactionNotificationData.prototype['validationResult'] = undefined;
 ...
 */
TransactionNotificationData.prototype['valueDate'] = undefined;
 ...
 * @readonly
 */
TransactionNotificationData['ProcessingTypeEnum'] = {
...
export default TransactionNotificationData;
