...
/**
 * The PaymentNotificationData model module.
 * @module model/PaymentNotificationData
 * @version 1
 */
class PaymentNotificationData {
    /**
     * Constructs a new <code>PaymentNotificationData</code>.
     * @alias module:model/PaymentNotificationData
     */
    constructor() { 
        
        PaymentNotificationData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentNotificationData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentNotificationData} obj Optional instance to populate.
     * @return {module:model/PaymentNotificationData} The populated <code>PaymentNotificationData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentNotificationData();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentNotificationData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentNotificationData</code>.
     */
 ...
 */
PaymentNotificationData.prototype['accountHolder'] = undefined;
 ...
 */
PaymentNotificationData.prototype['amount'] = undefined;

/**
 * The authorisation code for the payment.
 * @member {String} authCode
 */
PaymentNotificationData.prototype['authCode'] = undefined;

/**
 * Contains information about the balance account.
 * @member {module:model/ResourceReference} balanceAccount
 */
PaymentNotificationData.prototype['balanceAccount'] = undefined;

/**
 * The unique identifier of the balance platform.
 * @member {String} balancePlatform
 */
PaymentNotificationData.prototype['balancePlatform'] = undefined;

/**
 * The date and time when the event was triggered, in ISO 8601 extended format. For example, **2020-12-18T10:15:30+01:00**.
 * @member {Date} creationDate
 */
PaymentNotificationData.prototype['creationDate'] = undefined;

/**
 * Your description for the transfer. If you send a description longer than 140 characters, the text is truncated.
 * @member {String} description
 */
PaymentNotificationData.prototype['description'] = undefined;

/**
 * The ID of the resource.
 * @member {String} id
 */
PaymentNotificationData.prototype['id'] = undefined;
 ...
 */
PaymentNotificationData.prototype['merchantData'] = undefined;
 ...
 */
PaymentNotificationData.prototype['modification'] = undefined;
 ...
 * @member {module:model/PaymentNotificationData.ProcessingTypeEnum} processingType
 */
PaymentNotificationData.prototype['processingType'] = undefined;
 ...
 */
PaymentNotificationData.prototype['reference'] = undefined;
 ...
 */
PaymentNotificationData.prototype['referenceForBeneficiary'] = undefined;
 ...
 */
PaymentNotificationData.prototype['relayedAuthorisationData'] = undefined;
 ...
 */
PaymentNotificationData.prototype['status'] = undefined;
 ...
 */
PaymentNotificationData.prototype['transactionRulesResult'] = undefined;
 ...
 */
PaymentNotificationData.prototype['validationResult'] = undefined;
 ...
 * @readonly
 */
PaymentNotificationData['ProcessingTypeEnum'] = {
...
export default PaymentNotificationData;
