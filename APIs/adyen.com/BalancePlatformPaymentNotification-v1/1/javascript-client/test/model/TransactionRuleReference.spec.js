...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentWebhooksDeprecated.TransactionRuleReference();
  });
  ...
  describe('TransactionRuleReference', function() {
    it('should create an instance of TransactionRuleReference', function() {
      // uncomment below and update the code to test TransactionRuleReference
      //var instance = new PaymentWebhooksDeprecated.TransactionRuleReference();
      //expect(instance).to.be.a(PaymentWebhooksDeprecated.TransactionRuleReference);
    });
