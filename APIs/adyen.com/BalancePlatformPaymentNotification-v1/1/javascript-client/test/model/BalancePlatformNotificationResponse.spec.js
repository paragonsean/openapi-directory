...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentWebhooksDeprecated.BalancePlatformNotificationResponse();
  });
  ...
  describe('BalancePlatformNotificationResponse', function() {
    it('should create an instance of BalancePlatformNotificationResponse', function() {
      ...
      //var instance = new PaymentWebhooksDeprecated.BalancePlatformNotificationResponse();
      //expect(instance).to.be.a(PaymentWebhooksDeprecated.BalancePlatformNotificationResponse);
    });
