...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentWebhooksDeprecated.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new PaymentWebhooksDeprecated.Resource();
      //expect(instance).to.be.a(PaymentWebhooksDeprecated.Resource);
    });
