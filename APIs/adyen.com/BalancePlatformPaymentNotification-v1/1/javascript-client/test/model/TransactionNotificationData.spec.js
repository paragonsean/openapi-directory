...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentWebhooksDeprecated.TransactionNotificationData();
  });
  ...
  describe('TransactionNotificationData', function() {
    it('should create an instance of TransactionNotificationData', function() {
      // uncomment below and update the code to test TransactionNotificationData
      //var instance = new PaymentWebhooksDeprecated.TransactionNotificationData();
      //expect(instance).to.be.a(PaymentWebhooksDeprecated.TransactionNotificationData);
    });
    ...
    it('should have the property purposeCode (base name: "purposeCode")', function() {
      // uncomment below and update the code to test the property purposeCode
      //var instance = new PaymentWebhooksDeprecated.TransactionNotificationData();
      //expect(instance).to.be();
    });
