...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentWebhooksDeprecated.IncomingTransferNotificationData();
  });
  ...
  describe('IncomingTransferNotificationData', function() {
    it('should create an instance of IncomingTransferNotificationData', function() {
      // uncomment below and update the code to test IncomingTransferNotificationData
      //var instance = new PaymentWebhooksDeprecated.IncomingTransferNotificationData();
      //expect(instance).to.be.a(PaymentWebhooksDeprecated.IncomingTransferNotificationData);
    });
