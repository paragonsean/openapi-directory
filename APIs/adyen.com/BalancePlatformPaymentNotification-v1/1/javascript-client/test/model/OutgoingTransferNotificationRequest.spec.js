...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentWebhooksDeprecated.OutgoingTransferNotificationRequest();
  });
  ...
  describe('OutgoingTransferNotificationRequest', function() {
    it('should create an instance of OutgoingTransferNotificationRequest', function() {
      // uncomment below and update the code to test OutgoingTransferNotificationRequest
      //var instance = new PaymentWebhooksDeprecated.OutgoingTransferNotificationRequest();
      //expect(instance).to.be.a(PaymentWebhooksDeprecated.OutgoingTransferNotificationRequest);
    });
