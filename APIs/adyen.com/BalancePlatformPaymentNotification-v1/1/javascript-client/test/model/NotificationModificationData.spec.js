...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentWebhooksDeprecated.NotificationModificationData();
  });
  ...
  describe('NotificationModificationData', function() {
    it('should create an instance of NotificationModificationData', function() {
      // uncomment below and update the code to test NotificationModificationData
      //var instance = new PaymentWebhooksDeprecated.NotificationModificationData();
      //expect(instance).to.be.a(PaymentWebhooksDeprecated.NotificationModificationData);
    });
