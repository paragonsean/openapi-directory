...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentWebhooksDeprecated.PaymentNotificationRequest();
  });
  ...
  describe('PaymentNotificationRequest', function() {
    it('should create an instance of PaymentNotificationRequest', function() {
      // uncomment below and update the code to test PaymentNotificationRequest
      //var instance = new PaymentWebhooksDeprecated.PaymentNotificationRequest();
      //expect(instance).to.be.a(PaymentWebhooksDeprecated.PaymentNotificationRequest);
    });
