...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentWebhooksDeprecated.Amount();
  });
  ...
  describe('Amount', function() {
    it('should create an instance of Amount', function() {
      ...
      //var instance = new PaymentWebhooksDeprecated.Amount();
      //expect(instance).to.be.a(PaymentWebhooksDeprecated.Amount);
    });
