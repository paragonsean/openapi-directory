...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentWebhooksDeprecated.OutgoingTransferNotificationData();
  });
  ...
  describe('OutgoingTransferNotificationData', function() {
    it('should create an instance of OutgoingTransferNotificationData', function() {
      // uncomment below and update the code to test OutgoingTransferNotificationData
      //var instance = new PaymentWebhooksDeprecated.OutgoingTransferNotificationData();
      //expect(instance).to.be.a(PaymentWebhooksDeprecated.OutgoingTransferNotificationData);
    });
