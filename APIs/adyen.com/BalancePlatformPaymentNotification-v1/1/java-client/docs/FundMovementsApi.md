...
<a id="postBalancePlatformIncomingTransferCreated"></a>
# **postBalancePlatformIncomingTransferCreated**
> BalancePlatformNotificationResponse postBalancePlatformIncomingTransferCreated(incomingTransferNotificationRequest)
...
import org.openapitools.client.api.FundMovementsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    FundMovementsApi apiInstance = new FundMovementsApi(defaultClient);
    IncomingTransferNotificationRequest incomingTransferNotificationRequest = new IncomingTransferNotificationRequest(); // IncomingTransferNotificationRequest | 
    try {
      BalancePlatformNotificationResponse result = apiInstance.postBalancePlatformIncomingTransferCreated(incomingTransferNotificationRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FundMovementsApi#postBalancePlatformIncomingTransferCreated");
...
<a id="postBalancePlatformIncomingTransferUpdated"></a>
# **postBalancePlatformIncomingTransferUpdated**
> BalancePlatformNotificationResponse postBalancePlatformIncomingTransferUpdated(incomingTransferNotificationRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    IncomingTransferNotificationRequest incomingTransferNotificationRequest = new IncomingTransferNotificationRequest(); // IncomingTransferNotificationRequest | 
    try {
      BalancePlatformNotificationResponse result = apiInstance.postBalancePlatformIncomingTransferUpdated(incomingTransferNotificationRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FundMovementsApi#postBalancePlatformIncomingTransferUpdated");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="postBalancePlatformOutgoingTransferCreated"></a>
# **postBalancePlatformOutgoingTransferCreated**
> BalancePlatformNotificationResponse postBalancePlatformOutgoingTransferCreated(outgoingTransferNotificationRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    FundMovementsApi apiInstance = new FundMovementsApi(defaultClient);
    OutgoingTransferNotificationRequest outgoingTransferNotificationRequest = new OutgoingTransferNotificationRequest(); // OutgoingTransferNotificationRequest | 
    try {
      BalancePlatformNotificationResponse result = apiInstance.postBalancePlatformOutgoingTransferCreated(outgoingTransferNotificationRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FundMovementsApi#postBalancePlatformOutgoingTransferCreated");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="postBalancePlatformOutgoingTransferUpdated"></a>
# **postBalancePlatformOutgoingTransferUpdated**
> BalancePlatformNotificationResponse postBalancePlatformOutgoingTransferUpdated(outgoingTransferNotificationRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    OutgoingTransferNotificationRequest outgoingTransferNotificationRequest = new OutgoingTransferNotificationRequest(); // OutgoingTransferNotificationRequest | 
    try {
      BalancePlatformNotificationResponse result = apiInstance.postBalancePlatformOutgoingTransferUpdated(outgoingTransferNotificationRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FundMovementsApi#postBalancePlatformOutgoingTransferUpdated");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
