...
public class TransactionNotificationData {
  ...
  public TransactionNotificationData() {
  }

  public TransactionNotificationData accountHolder(ResourceReference accountHolder) {
  ...
  public TransactionNotificationData amount(Amount amount) {
    this.amount = amount;
    return this;
  }
  ...
  public TransactionNotificationData authCode(String authCode) {
  ...
  public TransactionNotificationData balanceAccount(ResourceReference balanceAccount) {
  ...
  public TransactionNotificationData balancePlatform(String balancePlatform) {
  ...
  public TransactionNotificationData counterparty(Counterparty counterparty) {
  ...
  public TransactionNotificationData creationDate(OffsetDateTime creationDate) {
  ...
  public TransactionNotificationData description(String description) {
  ...
  public TransactionNotificationData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public TransactionNotificationData merchantData(MerchantData merchantData) {
  ...
  public TransactionNotificationData modification(NotificationModificationData modification) {
  ...
  public TransactionNotificationData originalAmount(Amount originalAmount) {
  ...
  public TransactionNotificationData paymentId(String paymentId) {
  ...
  public TransactionNotificationData paymentInstrument(ResourceReference paymentInstrument) {
  ...
  public TransactionNotificationData platformPayment(PlatformPayment platformPayment) {
  ...
  public TransactionNotificationData processingType(ProcessingTypeEnum processingType) {
  ...
  public TransactionNotificationData purposeCode(String purposeCode) {
  ...
  public TransactionNotificationData reference(String reference) {
  ...
  public TransactionNotificationData referenceForBeneficiary(String referenceForBeneficiary) {
  ...
  public TransactionNotificationData relayedAuthorisationData(RelayedAuthorisationData relayedAuthorisationData) {
  ...
  public TransactionNotificationData status(String status) {
    this.status = status;
    return this;
  }
  ...
  public TransactionNotificationData transactionRulesResult(TransactionRulesResult transactionRulesResult) {
  ...
  public TransactionNotificationData validationResult(List<ValidationResult> validationResult) {
    this.validationResult = validationResult;
    return this;
  }

  public TransactionNotificationData addValidationResultItem(ValidationResult validationResultItem) {
  ...
  public TransactionNotificationData valueDate(OffsetDateTime valueDate) {
  ...
  public boolean equals(Object o) {
    ...
    TransactionNotificationData transactionNotificationData = (TransactionNotificationData) o;
    return Objects.equals(this.accountHolder, transactionNotificationData.accountHolder) &&
        Objects.equals(this.amount, transactionNotificationData.amount) &&
        Objects.equals(this.authCode, transactionNotificationData.authCode) &&
        Objects.equals(this.balanceAccount, transactionNotificationData.balanceAccount) &&
        Objects.equals(this.balancePlatform, transactionNotificationData.balancePlatform) &&
        Objects.equals(this.counterparty, transactionNotificationData.counterparty) &&
        Objects.equals(this.creationDate, transactionNotificationData.creationDate) &&
        Objects.equals(this.description, transactionNotificationData.description) &&
        Objects.equals(this.id, transactionNotificationData.id) &&
        Objects.equals(this.merchantData, transactionNotificationData.merchantData) &&
        Objects.equals(this.modification, transactionNotificationData.modification) &&
        Objects.equals(this.originalAmount, transactionNotificationData.originalAmount) &&
        Objects.equals(this.paymentId, transactionNotificationData.paymentId) &&
        Objects.equals(this.paymentInstrument, transactionNotificationData.paymentInstrument) &&
        Objects.equals(this.platformPayment, transactionNotificationData.platformPayment) &&
        Objects.equals(this.processingType, transactionNotificationData.processingType) &&
        Objects.equals(this.purposeCode, transactionNotificationData.purposeCode) &&
        Objects.equals(this.reference, transactionNotificationData.reference) &&
        Objects.equals(this.referenceForBeneficiary, transactionNotificationData.referenceForBeneficiary) &&
        Objects.equals(this.relayedAuthorisationData, transactionNotificationData.relayedAuthorisationData) &&
        Objects.equals(this.status, transactionNotificationData.status) &&
        Objects.equals(this.transactionRulesResult, transactionNotificationData.transactionRulesResult) &&
        Objects.equals(this.validationResult, transactionNotificationData.validationResult) &&
        Objects.equals(this.valueDate, transactionNotificationData.valueDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountHolder, amount, authCode, balanceAccount, balancePlatform, counterparty, creationDate, description, id, merchantData, modification, originalAmount, paymentId, paymentInstrument, platformPayment, processingType, purposeCode, reference, referenceForBeneficiary, relayedAuthorisationData, status, transactionRulesResult, validationResult, valueDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TransactionNotificationData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransactionNotificationData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionNotificationData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionNotificationData is not found in the empty JSON string", TransactionNotificationData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransactionNotificationData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactionNotificationData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionNotificationData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionNotificationData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionNotificationData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionNotificationData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionNotificationData.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionNotificationData>() {
           @Override
           public void write(JsonWriter out, TransactionNotificationData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransactionNotificationData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransactionNotificationData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransactionNotificationData
   * @throws IOException if the JSON string is invalid with respect to TransactionNotificationData
   */
  public static TransactionNotificationData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionNotificationData.class);
  }

  /**
   * Convert an instance of TransactionNotificationData to an JSON string
   *
   * @return JSON string
   */
