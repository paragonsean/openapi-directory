...
/*
 * OAIOutgoingTransferNotificationData.h
 *
 * 
 */

#ifndef OAIOutgoingTransferNotificationData_H
#define OAIOutgoingTransferNotificationData_H
...
class OAIOutgoingTransferNotificationData : public OAIObject {
public:
    OAIOutgoingTransferNotificationData();
    OAIOutgoingTransferNotificationData(QString json);
    ~OAIOutgoingTransferNotificationData() override;
    ...
    QString getPurposeCode() const;
    void setPurposeCode(const QString &purpose_code);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutgoingTransferNotificationData)

#endif // OAIOutgoingTransferNotificationData_H
