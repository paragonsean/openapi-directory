...
/*
 * OAITransactionRuleReference.h
 *
 * 
 */

#ifndef OAITransactionRuleReference_H
#define OAITransactionRuleReference_H
...
class OAITransactionRuleReference : public OAIObject {
public:
    OAITransactionRuleReference();
    OAITransactionRuleReference(QString json);
    ~OAITransactionRuleReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactionRuleReference)

#endif // OAITransactionRuleReference_H
