...
/*
 * OAITransactionNotificationData.h
 *
 * 
 */

#ifndef OAITransactionNotificationData_H
#define OAITransactionNotificationData_H
...
class OAITransactionNotificationData : public OAIObject {
public:
    OAITransactionNotificationData();
    OAITransactionNotificationData(QString json);
    ~OAITransactionNotificationData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactionNotificationData)

#endif // OAITransactionNotificationData_H
