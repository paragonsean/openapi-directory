...
/*
 * OAIUnincorporatedPartnership.h
 *
 * 
 */

#ifndef OAIUnincorporatedPartnership_H
#define OAIUnincorporatedPartnership_H
...
class OAIUnincorporatedPartnership : public OAIObject {
public:
    OAIUnincorporatedPartnership();
    OAIUnincorporatedPartnership(QString json);
    ~OAIUnincorporatedPartnership() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnincorporatedPartnership)

#endif // OAIUnincorporatedPartnership_H
