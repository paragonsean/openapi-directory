...
public:
    ...
    QString getTaxIdAbsenceReason() const;
    void setTaxIdAbsenceReason(const QString &tax_id_absence_reason);
    bool is_tax_id_absence_reason_Set() const;
    bool is_tax_id_absence_reason_Valid() const;
...
private:
    ...
    QString m_tax_id_absence_reason;
    bool m_tax_id_absence_reason_isSet;
    bool m_tax_id_absence_reason_isValid;
