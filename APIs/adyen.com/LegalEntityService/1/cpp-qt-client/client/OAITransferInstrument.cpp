...
QList<OAIEntityReference> OAITransferInstrument::getDocuments() const {
    return m_documents;
}
void OAITransferInstrument::setDocuments(const QList<OAIEntityReference> &documents) {
    m_documents = documents;
    m_documents_isSet = true;
}

bool OAITransferInstrument::is_documents_Set() const{
    return m_documents_isSet;
}

bool OAITransferInstrument::is_documents_Valid() const{
