...
void OAIOrganization::initializeModel() {
    ...
    m_tax_id_absence_reason_isSet = false;
    m_tax_id_absence_reason_isValid = false;
...
void OAIOrganization::fromJsonObject(QJsonObject json) {
    ...
    m_tax_id_absence_reason_isValid = ::OpenAPI::fromJsonValue(m_tax_id_absence_reason, json[QString("taxIdAbsenceReason")]);
    m_tax_id_absence_reason_isSet = !json[QString("taxIdAbsenceReason")].isNull() && m_tax_id_absence_reason_isValid;
...
QJsonObject OAIOrganization::asJsonObject() const {
    ...
    if (m_tax_id_absence_reason_isSet) {
        obj.insert(QString("taxIdAbsenceReason"), ::OpenAPI::toJsonValue(m_tax_id_absence_reason));
    }
    if (m_type_isSet) {
...
bool OAIOrganization::isTaxExempt() const {
    return m_tax_exempt;
}
void OAIOrganization::setTaxExempt(const bool &tax_exempt) {
    m_tax_exempt = tax_exempt;
    m_tax_exempt_isSet = true;
}

bool OAIOrganization::is_tax_exempt_Set() const{
    return m_tax_exempt_isSet;
}

bool OAIOrganization::is_tax_exempt_Valid() const{
    return m_tax_exempt_isValid;
}

QString OAIOrganization::getTaxId() const {
    return m_tax_id;
}
void OAIOrganization::setTaxId(const QString &tax_id) {
    m_tax_id = tax_id;
    m_tax_id_isSet = true;
}

bool OAIOrganization::is_tax_id_Set() const{
    return m_tax_id_isSet;
}

bool OAIOrganization::is_tax_id_Valid() const{
    return m_tax_id_isValid;
}

QString OAIOrganization::getTaxIdAbsenceReason() const {
    return m_tax_id_absence_reason;
}
void OAIOrganization::setTaxIdAbsenceReason(const QString &tax_id_absence_reason) {
    m_tax_id_absence_reason = tax_id_absence_reason;
    m_tax_id_absence_reason_isSet = true;
}

bool OAIOrganization::is_tax_id_absence_reason_Set() const{
    return m_tax_id_absence_reason_isSet;
}

bool OAIOrganization::is_tax_id_absence_reason_Valid() const{
    return m_tax_id_absence_reason_isValid;
}
