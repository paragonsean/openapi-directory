...
#ifndef OAIOnboardingLink_H
#define OAIOnboardingLink_H
...
class OAIOnboardingLink : public OAIObject {
public:
    OAIOnboardingLink();
    OAIOnboardingLink(QString json);
    ~OAIOnboardingLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOnboardingLink)

#endif // OAIOnboardingLink_H
