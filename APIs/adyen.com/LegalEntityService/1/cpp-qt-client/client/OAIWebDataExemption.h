...
/*
 * OAIWebDataExemption.h
 *
 * 
 */

#ifndef OAIWebDataExemption_H
#define OAIWebDataExemption_H
...
class OAIWebDataExemption : public OAIObject {
public:
    OAIWebDataExemption();
    OAIWebDataExemption(QString json);
    ~OAIWebDataExemption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebDataExemption)

#endif // OAIWebDataExemption_H
