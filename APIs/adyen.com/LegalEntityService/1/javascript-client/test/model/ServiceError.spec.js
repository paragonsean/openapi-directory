...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.ServiceError();
  });
  ...
  describe('ServiceError', function() {
    it('should create an instance of ServiceError', function() {
      ...
      //var instance = new LegalEntityManagementApi.ServiceError();
      //expect(instance).to.be.a(LegalEntityManagementApi.ServiceError);
    });
