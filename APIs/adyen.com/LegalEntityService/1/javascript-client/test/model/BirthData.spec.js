...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.BirthData();
  });
  ...
  describe('BirthData', function() {
    it('should create an instance of BirthData', function() {
      // uncomment below and update the code to test BirthData
      //var instance = new LegalEntityManagementApi.BirthData();
      //expect(instance).to.be.a(LegalEntityManagementApi.BirthData);
    });
