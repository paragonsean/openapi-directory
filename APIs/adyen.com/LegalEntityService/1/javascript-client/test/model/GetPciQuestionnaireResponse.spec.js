...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.GetPciQuestionnaireResponse();
  });
  ...
  describe('GetPciQuestionnaireResponse', function() {
    it('should create an instance of GetPciQuestionnaireResponse', function() {
      // uncomment below and update the code to test GetPciQuestionnaireResponse
      //var instance = new LegalEntityManagementApi.GetPciQuestionnaireResponse();
      //expect(instance).to.be.a(LegalEntityManagementApi.GetPciQuestionnaireResponse);
    });
