...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.OnboardingLinkInfo();
  });
  ...
  describe('OnboardingLinkInfo', function() {
    it('should create an instance of OnboardingLinkInfo', function() {
      // uncomment below and update the code to test OnboardingLinkInfo
      //var instance = new LegalEntityManagementApi.OnboardingLinkInfo();
      //expect(instance).to.be.a(LegalEntityManagementApi.OnboardingLinkInfo);
    });
