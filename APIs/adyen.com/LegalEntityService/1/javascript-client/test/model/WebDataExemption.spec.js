...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.WebDataExemption();
  });
  ...
  describe('WebDataExemption', function() {
    it('should create an instance of WebDataExemption', function() {
      // uncomment below and update the code to test WebDataExemption
      //var instance = new LegalEntityManagementApi.WebDataExemption();
      //expect(instance).to.be.a(LegalEntityManagementApi.WebDataExemption);
    });
