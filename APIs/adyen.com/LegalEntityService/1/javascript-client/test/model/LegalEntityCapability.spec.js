...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.LegalEntityCapability();
  });
  ...
  describe('LegalEntityCapability', function() {
    it('should create an instance of LegalEntityCapability', function() {
      // uncomment below and update the code to test LegalEntityCapability
      //var instance = new LegalEntityManagementApi.LegalEntityCapability();
      //expect(instance).to.be.a(LegalEntityManagementApi.LegalEntityCapability);
    });
