...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.TransferInstrumentInfo();
  });
  ...
  describe('TransferInstrumentInfo', function() {
    it('should create an instance of TransferInstrumentInfo', function() {
      // uncomment below and update the code to test TransferInstrumentInfo
      //var instance = new LegalEntityManagementApi.TransferInstrumentInfo();
      //expect(instance).to.be.a(LegalEntityManagementApi.TransferInstrumentInfo);
    });
