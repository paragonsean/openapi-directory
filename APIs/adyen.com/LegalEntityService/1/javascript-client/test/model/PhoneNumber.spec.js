...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.PhoneNumber();
  });
  ...
  describe('PhoneNumber', function() {
    it('should create an instance of PhoneNumber', function() {
      ...
      //var instance = new LegalEntityManagementApi.PhoneNumber();
      //expect(instance).to.be.a(LegalEntityManagementApi.PhoneNumber);
    });
