...
(function(root, factory) {
  ...
  describe('Organization', function() {
    ...
    it('should have the property taxIdAbsenceReason (base name: "taxIdAbsenceReason")', function() {
      // uncomment below and update the code to test the property taxIdAbsenceReason
      //var instance = new LegalEntityManagementApi.Organization();
      //expect(instance).to.be();
    });
