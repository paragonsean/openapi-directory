...
class StockData {
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['tickerSymbol'] && !(typeof data['tickerSymbol'] === 'string' || data['tickerSymbol'] instanceof String)) {
            throw new Error("Expected the field `tickerSymbol` to be a primitive type in the JSON string but got " + data['tickerSymbol']);
        }
