...
class Trust {
     ...
     * @param type {module:model/Trust.TypeEnum} Type of trust.  Possible values for Australian trusts: **cashManagementTrust**, **corporateUnitTrust**, **deceasedEstate**, **discretionaryInvestmentTrust**, **discretionaryServicesManagementTrust**, **discretionaryTradingTrust**, **firstHomeSaverAccountsTrust**, **fixedTrust**, **fixedUnitTrust**, **hybridTrust**, **listedPublicUnitTrust**, **otherTrust**, **pooledSuperannuationTrust**, **publicTradingTrust**, **unlistedPublicUnitTrust**.
     */
    constructor(countryOfGoverningLaw, name, registeredAddress, type) { 
        
        Trust.initialize(this, countryOfGoverningLaw, name, registeredAddress, type);
    }
...
Trust.RequiredProperties = ["countryOfGoverningLaw", "name", "registeredAddress", "type"];

/**
 * The two-character [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code of the governing country.
 * @member {String} countryOfGoverningLaw
 */
Trust.prototype['countryOfGoverningLaw'] = undefined;

/**
 * The registered name, if different from the `name`.
 * @member {String} doingBusinessAs
 */
Trust.prototype['doingBusinessAs'] = undefined;
 ...
 */
Trust.prototype['principalPlaceOfBusiness'] = undefined;

/**
 * The address registered at the registrar, such as the Chamber of Commerce.
 * @member {module:model/Address} registeredAddress
 */
Trust.prototype['registeredAddress'] = undefined;

/**
 * The registration number.
 * @member {String} registrationNumber
 */
Trust.prototype['registrationNumber'] = undefined;

/**
 * Type of trust.  Possible values for Australian trusts: **cashManagementTrust**, **corporateUnitTrust**, **deceasedEstate**, **discretionaryInvestmentTrust**, **discretionaryServicesManagementTrust**, **discretionaryTradingTrust**, **firstHomeSaverAccountsTrust**, **fixedTrust**, **fixedUnitTrust**, **hybridTrust**, **listedPublicUnitTrust**, **otherTrust**, **pooledSuperannuationTrust**, **publicTradingTrust**, **unlistedPublicUnitTrust**.
 * @member {module:model/Trust.TypeEnum} type
 */
Trust.prototype['type'] = undefined;

/**
 * The reason for not providing a VAT number.  Possible values: **industryExemption**, **belowTaxThreshold**.
 * @member {module:model/Trust.VatAbsenceReasonEnum} vatAbsenceReason
 */
Trust.prototype['vatAbsenceReason'] = undefined;

/**
 * The VAT number.
 * @member {String} vatNumber
 */
Trust.prototype['vatNumber'] = undefined;
