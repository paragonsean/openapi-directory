...
class PhoneNumber {
     ...
     * @param type {String} The type of phone number.  Possible values: **mobile**, **landline**, **sip**, **fax.** 
     */
    constructor(number, type) { 
        
        PhoneNumber.initialize(this, number, type);
    }
...
PhoneNumber.RequiredProperties = ["number", "type"];
