...
class LegalEntityAssociation(Model):
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["definedBeneficiary", "director", "protector", "secondaryTrustee", "settlor", "signatory", "trust", "uboThroughControl", "uboThroughOwnership", "undefinedBeneficiary"]  # noqa: E501
