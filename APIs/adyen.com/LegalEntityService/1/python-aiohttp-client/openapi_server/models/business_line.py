...
class BusinessLine(Model):
    ...
    def __init__(self, capability: str=None, id: str=None, industry_code: str=None, legal_entity_id: str=None, sales_channels: List[str]=None, source_of_funds: SourceOfFunds=None, web_data: List[WebData]=None, web_data_exemption: WebDataExemption=None):
