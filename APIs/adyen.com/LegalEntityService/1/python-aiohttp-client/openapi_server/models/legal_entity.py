...
class LegalEntity(Model):
    ...
    def __init__(self, capabilities: Dict[str, LegalEntityCapability]=None, documents: List[EntityReference]=None, entity_associations: List[LegalEntityAssociation]=None, id: str=None, individual: Individual=None, organization: Organization=None, reference: str=None, transfer_instruments: List[TransferInstrumentReference]=None, trust: Trust=None, type: str=None, unincorporated_partnership: UnincorporatedPartnership=None, verification_plan: str=None):
