...
public class LegalEntity {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(capabilities, documents, entityAssociations, id, individual, organization, reference, transferInstruments, trust, type, unincorporatedPartnership, verificationPlan);
  }
