...
public class GetPciQuestionnaireResponse {
  ...
  public GetPciQuestionnaireResponse content(String content) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, getPciQuestionnaireResponse.content) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(content, createdAt, id, validUntil);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPciQuestionnaireResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPciQuestionnaireResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPciQuestionnaireResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPciQuestionnaireResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
