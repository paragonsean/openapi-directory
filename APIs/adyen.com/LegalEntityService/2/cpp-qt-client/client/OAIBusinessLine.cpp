...
OAIBusinessLine::OAIBusinessLine(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBusinessLine::OAIBusinessLine() {
    this->initializeModel();
}

OAIBusinessLine::~OAIBusinessLine() {}

void OAIBusinessLine::initializeModel() {
...
void OAIBusinessLine::fromJson(QString jsonString) {
...
void OAIBusinessLine::fromJsonObject(QJsonObject json) {
...
QString OAIBusinessLine::asJson() const {
...
QJsonObject OAIBusinessLine::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBusinessLine::getCapability() const {
    return m_capability;
}
void OAIBusinessLine::setCapability(const QString &capability) {
    m_capability = capability;
    m_capability_isSet = true;
}

bool OAIBusinessLine::is_capability_Set() const{
    return m_capability_isSet;
}

bool OAIBusinessLine::is_capability_Valid() const{
    return m_capability_isValid;
}

QString OAIBusinessLine::getId() const {
    return m_id;
}
void OAIBusinessLine::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBusinessLine::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBusinessLine::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIBusinessLine::getIndustryCode() const {
    return m_industry_code;
}
void OAIBusinessLine::setIndustryCode(const QString &industry_code) {
    m_industry_code = industry_code;
    m_industry_code_isSet = true;
}

bool OAIBusinessLine::is_industry_code_Set() const{
    return m_industry_code_isSet;
}

bool OAIBusinessLine::is_industry_code_Valid() const{
    return m_industry_code_isValid;
}

QString OAIBusinessLine::getLegalEntityId() const {
    return m_legal_entity_id;
}
void OAIBusinessLine::setLegalEntityId(const QString &legal_entity_id) {
    m_legal_entity_id = legal_entity_id;
    m_legal_entity_id_isSet = true;
}

bool OAIBusinessLine::is_legal_entity_id_Set() const{
    return m_legal_entity_id_isSet;
}

bool OAIBusinessLine::is_legal_entity_id_Valid() const{
    return m_legal_entity_id_isValid;
}

QList<QString> OAIBusinessLine::getSalesChannels() const {
    return m_sales_channels;
}
void OAIBusinessLine::setSalesChannels(const QList<QString> &sales_channels) {
    m_sales_channels = sales_channels;
    m_sales_channels_isSet = true;
}

bool OAIBusinessLine::is_sales_channels_Set() const{
    return m_sales_channels_isSet;
}

bool OAIBusinessLine::is_sales_channels_Valid() const{
    return m_sales_channels_isValid;
}

OAISourceOfFunds OAIBusinessLine::getSourceOfFunds() const {
    return m_source_of_funds;
}
void OAIBusinessLine::setSourceOfFunds(const OAISourceOfFunds &source_of_funds) {
    m_source_of_funds = source_of_funds;
    m_source_of_funds_isSet = true;
}

bool OAIBusinessLine::is_source_of_funds_Set() const{
    return m_source_of_funds_isSet;
}

bool OAIBusinessLine::is_source_of_funds_Valid() const{
    return m_source_of_funds_isValid;
}

QList<OAIWebData> OAIBusinessLine::getWebData() const {
    return m_web_data;
}
void OAIBusinessLine::setWebData(const QList<OAIWebData> &web_data) {
    m_web_data = web_data;
    m_web_data_isSet = true;
}

bool OAIBusinessLine::is_web_data_Set() const{
    return m_web_data_isSet;
}

bool OAIBusinessLine::is_web_data_Valid() const{
    return m_web_data_isValid;
}

OAIWebDataExemption OAIBusinessLine::getWebDataExemption() const {
    return m_web_data_exemption;
}
void OAIBusinessLine::setWebDataExemption(const OAIWebDataExemption &web_data_exemption) {
    m_web_data_exemption = web_data_exemption;
    m_web_data_exemption_isSet = true;
}

bool OAIBusinessLine::is_web_data_exemption_Set() const{
    return m_web_data_exemption_isSet;
}

bool OAIBusinessLine::is_web_data_exemption_Valid() const{
    return m_web_data_exemption_isValid;
}

bool OAIBusinessLine::isSet() const {
...
bool OAIBusinessLine::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_capability_isValid && m_id_isValid && m_industry_code_isValid && m_legal_entity_id_isValid && true;
}
