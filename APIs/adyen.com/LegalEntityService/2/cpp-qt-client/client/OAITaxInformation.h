...
#ifndef OAITaxInformation_H
#define OAITaxInformation_H
...
class OAITaxInformation : public OAIObject {
public:
    OAITaxInformation();
    OAITaxInformation(QString json);
    ~OAITaxInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaxInformation)

#endif // OAITaxInformation_H
