...
QList<OAISupportingEntityCapability> OAILegalEntityCapability::getTransferInstruments() const {
    return m_transfer_instruments;
}
void OAILegalEntityCapability::setTransferInstruments(const QList<OAISupportingEntityCapability> &transfer_instruments) {
    m_transfer_instruments = transfer_instruments;
    m_transfer_instruments_isSet = true;
}

bool OAILegalEntityCapability::is_transfer_instruments_Set() const{
    return m_transfer_instruments_isSet;
}

bool OAILegalEntityCapability::is_transfer_instruments_Valid() const{
