...
/*
 * OAIUndefinedBeneficiary.h
 *
 * 
 */

#ifndef OAIUndefinedBeneficiary_H
#define OAIUndefinedBeneficiary_H
...
class OAIUndefinedBeneficiary : public OAIObject {
public:
    OAIUndefinedBeneficiary();
    OAIUndefinedBeneficiary(QString json);
    ~OAIUndefinedBeneficiary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUndefinedBeneficiary)

#endif // OAIUndefinedBeneficiary_H
