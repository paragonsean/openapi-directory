...
public:
    ...
    QString getCountryOfGoverningLaw() const;
    void setCountryOfGoverningLaw(const QString &country_of_governing_law);
    bool is_country_of_governing_law_Set() const;
    bool is_country_of_governing_law_Valid() const;
    ...
    QList<OAIUndefinedBeneficiary> getUndefinedBeneficiaryInfo() const;
    void setUndefinedBeneficiaryInfo(const QList<OAIUndefinedBeneficiary> &undefined_beneficiary_info);
    bool is_undefined_beneficiary_info_Set() const;
    bool is_undefined_beneficiary_info_Valid() const;
...
private:
    ...
    QString m_country_of_governing_law;
    bool m_country_of_governing_law_isSet;
    bool m_country_of_governing_law_isValid;
    ...
    QList<OAIUndefinedBeneficiary> m_undefined_beneficiary_info;
    bool m_undefined_beneficiary_info_isSet;
    bool m_undefined_beneficiary_info_isValid;
