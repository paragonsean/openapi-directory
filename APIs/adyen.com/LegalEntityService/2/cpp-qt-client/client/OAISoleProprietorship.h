...
/*
 * OAISoleProprietorship.h
 *
 * 
 */

#ifndef OAISoleProprietorship_H
#define OAISoleProprietorship_H
...
class OAISoleProprietorship : public OAIObject {
public:
    OAISoleProprietorship();
    OAISoleProprietorship(QString json);
    ~OAISoleProprietorship() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISoleProprietorship)

#endif // OAISoleProprietorship_H
