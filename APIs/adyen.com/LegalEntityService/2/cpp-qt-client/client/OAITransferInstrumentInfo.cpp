...
OAITransferInstrumentInfo::OAITransferInstrumentInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransferInstrumentInfo::OAITransferInstrumentInfo() {
    this->initializeModel();
}

OAITransferInstrumentInfo::~OAITransferInstrumentInfo() {}

void OAITransferInstrumentInfo::initializeModel() {
...
void OAITransferInstrumentInfo::fromJson(QString jsonString) {
...
void OAITransferInstrumentInfo::fromJsonObject(QJsonObject json) {
...
QString OAITransferInstrumentInfo::asJson() const {
...
QJsonObject OAITransferInstrumentInfo::asJsonObject() const {
    QJsonObject obj;
...
OAIBankAccountInfo OAITransferInstrumentInfo::getBankAccount() const {
    return m_bank_account;
}
void OAITransferInstrumentInfo::setBankAccount(const OAIBankAccountInfo &bank_account) {
    m_bank_account = bank_account;
    m_bank_account_isSet = true;
}

bool OAITransferInstrumentInfo::is_bank_account_Set() const{
    return m_bank_account_isSet;
}

bool OAITransferInstrumentInfo::is_bank_account_Valid() const{
    return m_bank_account_isValid;
}

QString OAITransferInstrumentInfo::getLegalEntityId() const {
    return m_legal_entity_id;
}
void OAITransferInstrumentInfo::setLegalEntityId(const QString &legal_entity_id) {
    m_legal_entity_id = legal_entity_id;
    m_legal_entity_id_isSet = true;
}

bool OAITransferInstrumentInfo::is_legal_entity_id_Set() const{
    return m_legal_entity_id_isSet;
}

bool OAITransferInstrumentInfo::is_legal_entity_id_Valid() const{
    return m_legal_entity_id_isValid;
}

QString OAITransferInstrumentInfo::getType() const {
    return m_type;
}
void OAITransferInstrumentInfo::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAITransferInstrumentInfo::is_type_Set() const{
    return m_type_isSet;
}

bool OAITransferInstrumentInfo::is_type_Valid() const{
    return m_type_isValid;
}

bool OAITransferInstrumentInfo::isSet() const {
...
bool OAITransferInstrumentInfo::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_bank_account_isValid && m_legal_entity_id_isValid && m_type_isValid && true;
}
