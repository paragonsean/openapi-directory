...
/*
 * OAIBusinessLineInfo.h
 *
 * 
 */

#ifndef OAIBusinessLineInfo_H
#define OAIBusinessLineInfo_H
...
class OAIBusinessLineInfo : public OAIObject {
public:
    OAIBusinessLineInfo();
    OAIBusinessLineInfo(QString json);
    ~OAIBusinessLineInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBusinessLineInfo)

#endif // OAIBusinessLineInfo_H
