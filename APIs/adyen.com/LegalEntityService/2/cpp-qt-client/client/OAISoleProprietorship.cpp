...
OAISoleProprietorship::OAISoleProprietorship(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISoleProprietorship::OAISoleProprietorship() {
    this->initializeModel();
}

OAISoleProprietorship::~OAISoleProprietorship() {}

void OAISoleProprietorship::initializeModel() {
...
void OAISoleProprietorship::fromJson(QString jsonString) {
...
void OAISoleProprietorship::fromJsonObject(QJsonObject json) {
...
QString OAISoleProprietorship::asJson() const {
...
QJsonObject OAISoleProprietorship::asJsonObject() const {
    QJsonObject obj;
...
QString OAISoleProprietorship::getCountryOfGoverningLaw() const {
    return m_country_of_governing_law;
}
void OAISoleProprietorship::setCountryOfGoverningLaw(const QString &country_of_governing_law) {
    m_country_of_governing_law = country_of_governing_law;
    m_country_of_governing_law_isSet = true;
}

bool OAISoleProprietorship::is_country_of_governing_law_Set() const{
    return m_country_of_governing_law_isSet;
}

bool OAISoleProprietorship::is_country_of_governing_law_Valid() const{
    return m_country_of_governing_law_isValid;
}

QString OAISoleProprietorship::getDateOfIncorporation() const {
    return m_date_of_incorporation;
}
void OAISoleProprietorship::setDateOfIncorporation(const QString &date_of_incorporation) {
    m_date_of_incorporation = date_of_incorporation;
    m_date_of_incorporation_isSet = true;
}

bool OAISoleProprietorship::is_date_of_incorporation_Set() const{
    return m_date_of_incorporation_isSet;
}

bool OAISoleProprietorship::is_date_of_incorporation_Valid() const{
    return m_date_of_incorporation_isValid;
}

QString OAISoleProprietorship::getDoingBusinessAs() const {
    return m_doing_business_as;
}
void OAISoleProprietorship::setDoingBusinessAs(const QString &doing_business_as) {
    m_doing_business_as = doing_business_as;
    m_doing_business_as_isSet = true;
}

bool OAISoleProprietorship::is_doing_business_as_Set() const{
    return m_doing_business_as_isSet;
}

bool OAISoleProprietorship::is_doing_business_as_Valid() const{
    return m_doing_business_as_isValid;
}

QString OAISoleProprietorship::getName() const {
    return m_name;
}
void OAISoleProprietorship::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISoleProprietorship::is_name_Set() const{
    return m_name_isSet;
}

bool OAISoleProprietorship::is_name_Valid() const{
    return m_name_isValid;
}

OAIAddress OAISoleProprietorship::getPrincipalPlaceOfBusiness() const {
    return m_principal_place_of_business;
}
void OAISoleProprietorship::setPrincipalPlaceOfBusiness(const OAIAddress &principal_place_of_business) {
    m_principal_place_of_business = principal_place_of_business;
    m_principal_place_of_business_isSet = true;
}

bool OAISoleProprietorship::is_principal_place_of_business_Set() const{
    return m_principal_place_of_business_isSet;
}

bool OAISoleProprietorship::is_principal_place_of_business_Valid() const{
    return m_principal_place_of_business_isValid;
}

OAIAddress OAISoleProprietorship::getRegisteredAddress() const {
    return m_registered_address;
}
void OAISoleProprietorship::setRegisteredAddress(const OAIAddress &registered_address) {
    m_registered_address = registered_address;
    m_registered_address_isSet = true;
}

bool OAISoleProprietorship::is_registered_address_Set() const{
    return m_registered_address_isSet;
}

bool OAISoleProprietorship::is_registered_address_Valid() const{
    return m_registered_address_isValid;
}

QString OAISoleProprietorship::getRegistrationNumber() const {
    return m_registration_number;
}
void OAISoleProprietorship::setRegistrationNumber(const QString &registration_number) {
    m_registration_number = registration_number;
    m_registration_number_isSet = true;
}

bool OAISoleProprietorship::is_registration_number_Set() const{
    return m_registration_number_isSet;
}

bool OAISoleProprietorship::is_registration_number_Valid() const{
    return m_registration_number_isValid;
}

QList<OAITaxInformation> OAISoleProprietorship::getTaxInformation() const {
    return m_tax_information;
}
void OAISoleProprietorship::setTaxInformation(const QList<OAITaxInformation> &tax_information) {
    m_tax_information = tax_information;
    m_tax_information_isSet = true;
}

bool OAISoleProprietorship::is_tax_information_Set() const{
    return m_tax_information_isSet;
}

bool OAISoleProprietorship::is_tax_information_Valid() const{
    return m_tax_information_isValid;
}

QString OAISoleProprietorship::getVatAbsenceReason() const {
    return m_vat_absence_reason;
}
void OAISoleProprietorship::setVatAbsenceReason(const QString &vat_absence_reason) {
    m_vat_absence_reason = vat_absence_reason;
    m_vat_absence_reason_isSet = true;
}

bool OAISoleProprietorship::is_vat_absence_reason_Set() const{
    return m_vat_absence_reason_isSet;
}

bool OAISoleProprietorship::is_vat_absence_reason_Valid() const{
    return m_vat_absence_reason_isValid;
}

QString OAISoleProprietorship::getVatNumber() const {
    return m_vat_number;
}
void OAISoleProprietorship::setVatNumber(const QString &vat_number) {
    m_vat_number = vat_number;
    m_vat_number_isSet = true;
}

bool OAISoleProprietorship::is_vat_number_Set() const{
    return m_vat_number_isSet;
}

bool OAISoleProprietorship::is_vat_number_Valid() const{
    return m_vat_number_isValid;
}

bool OAISoleProprietorship::isSet() const {
...
bool OAISoleProprietorship::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_country_of_governing_law_isValid && m_name_isValid && m_registered_address_isValid && true;
}
