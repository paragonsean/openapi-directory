...
/*
 * OAIGetPciQuestionnaireResponse.h
 *
 * 
 */

#ifndef OAIGetPciQuestionnaireResponse_H
#define OAIGetPciQuestionnaireResponse_H
...
class OAIGetPciQuestionnaireResponse : public OAIObject {
public:
    OAIGetPciQuestionnaireResponse();
    OAIGetPciQuestionnaireResponse(QString json);
    ~OAIGetPciQuestionnaireResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPciQuestionnaireResponse)

#endif // OAIGetPciQuestionnaireResponse_H
