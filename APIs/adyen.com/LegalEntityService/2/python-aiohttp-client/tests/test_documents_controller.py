...
async def test_delete_documents_id(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/lem/v2/documents/{id}'.format(id='id_example'),
        headers=headers,
        )
...
async def test_patch_documents_id(client):
    ...
    Update a document
    """
    body = {"issuerState":"issuerState","owner":{"id":"id","type":"type"},"fileName":"fileName","attachments":[{"filename":"filename","pageType":"pageType","contentType":"contentType","pageName":"pageName","content":"content"},{"filename":"filename","pageType":"pageType","contentType":"contentType","pageName":"pageName","content":"content"}],"description":"description","creationDate":"2000-01-23T04:56:07.000+00:00","type":"bankStatement","expiryDate":"expiryDate","issuerCountry":"issuerCountry","number":"number","modificationDate":"2000-01-23T04:56:07.000+00:00","attachment":{"filename":"filename","pageType":"pageType","contentType":"contentType","pageName":"pageName","content":"content"},"id":"id"}
    headers = { 
        'Accept': 'application/json',
