...
class Attachment(Model):
    ...
    def __init__(self, content: str=None, content_type: str=None, filename: str=None, page_name: str=None, page_type: str=None):
        ...
        :param page_name: The page_name of this Attachment.
    ...
    @property
    def page_name(self):
        """Gets the page_name of this Attachment.

        The name of the file including the file extension.

        :return: The page_name of this Attachment.
        :rtype: str
        """
    ...
    def page_name(self, page_name):
        """Sets the page_name of this Attachment.
