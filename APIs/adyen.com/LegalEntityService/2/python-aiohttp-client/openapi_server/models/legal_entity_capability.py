...
class LegalEntityCapability(Model):
    ...
    def __init__(self, allowed: bool=None, allowed_level: str=None, allowed_settings: CapabilitySettings=None, problems: List[CapabilityProblem]=None, requested: bool=None, requested_level: str=None, requested_settings: CapabilitySettings=None, transfer_instruments: List[SupportingEntityCapability]=None, verification_status: str=None):
