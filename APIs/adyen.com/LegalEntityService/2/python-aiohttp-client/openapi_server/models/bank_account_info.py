...
class BankAccountInfo(Model):
    ...
    def __init__(self, account_number: str=None, account_type: str=None, bank_bic_swift: str=None, bank_city: str=None, bank_code: str=None, bank_name: str=None, branch_code: str=None, check_code: str=None, country_code: str=None, currency_code: str=None, iban: str=None, trusted_source: bool=None):
