...
import org.openapitools.client.model.UndefinedBeneficiary;
...
public class Trust {
  ...
  public static final String SERIALIZED_NAME_UNDEFINED_BENEFICIARY_INFO = "undefinedBeneficiaryInfo";
  @SerializedName(SERIALIZED_NAME_UNDEFINED_BENEFICIARY_INFO)
  ...
  static {
    ...
    openapiFields.add("undefinedBeneficiaryInfo");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("undefinedBeneficiaryInfo") != null && !jsonObj.get("undefinedBeneficiaryInfo").isJsonNull()) {
        JsonArray jsonArrayundefinedBeneficiaryInfo = jsonObj.getAsJsonArray("undefinedBeneficiaryInfo");
        if (jsonArrayundefinedBeneficiaryInfo != null) {
          // ensure the json data is an array
          if (!jsonObj.get("undefinedBeneficiaryInfo").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `undefinedBeneficiaryInfo` to be an array in the JSON string but got `%s`", jsonObj.get("undefinedBeneficiaryInfo").toString()));
          }

          // validate the optional field `undefinedBeneficiaryInfo` (array)
          for (int i = 0; i < jsonArrayundefinedBeneficiaryInfo.size(); i++) {
            UndefinedBeneficiary.validateJsonElement(jsonArrayundefinedBeneficiaryInfo.get(i));
          };
        }
      }
