...
public class CalculateTermsOfServiceStatusResponse {
  ...
  public enum TermsOfServiceTypesEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      TermsOfServiceTypesEnum.fromValue(value);
    }
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CalculateTermsOfServiceStatusResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CalculateTermsOfServiceStatusResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CalculateTermsOfServiceStatusResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CalculateTermsOfServiceStatusResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("termsOfServiceTypes") != null && !jsonObj.get("termsOfServiceTypes").isJsonNull() && !jsonObj.get("termsOfServiceTypes").isJsonArray()) {
