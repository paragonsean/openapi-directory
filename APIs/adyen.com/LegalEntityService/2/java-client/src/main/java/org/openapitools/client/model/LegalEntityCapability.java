...
public class LegalEntityCapability {
  ...
  private List<SupportingEntityCapability> transferInstruments = new ArrayList<>();
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowed, allowedLevel, allowedSettings, problems, requested, requestedLevel, requestedSettings, transferInstruments, verificationStatus);
  }
      ...
      if (jsonObj.get("transferInstruments") != null && !jsonObj.get("transferInstruments").isJsonNull()) {
        ...
        if (jsonArraytransferInstruments != null) {
          ...
          for (int i = 0; i < jsonArraytransferInstruments.size(); i++) {
            SupportingEntityCapability.validateJsonElement(jsonArraytransferInstruments.get(i));
          };
        }
      }
