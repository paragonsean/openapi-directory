...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.Attachment();
  });
  ...
  describe('Attachment', function() {
    it('should create an instance of Attachment', function() {
      ...
      //var instance = new LegalEntityManagementApi.Attachment();
      //expect(instance).to.be.a(LegalEntityManagementApi.Attachment);
    });
