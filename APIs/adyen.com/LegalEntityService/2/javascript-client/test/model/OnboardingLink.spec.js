...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.OnboardingLink();
  });
  ...
  describe('OnboardingLink', function() {
    it('should create an instance of OnboardingLink', function() {
      // uncomment below and update the code to test OnboardingLink
      //var instance = new LegalEntityManagementApi.OnboardingLink();
      //expect(instance).to.be.a(LegalEntityManagementApi.OnboardingLink);
    });
