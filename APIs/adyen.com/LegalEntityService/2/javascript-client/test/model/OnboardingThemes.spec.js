...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.OnboardingThemes();
  });
  ...
  describe('OnboardingThemes', function() {
    it('should create an instance of OnboardingThemes', function() {
      // uncomment below and update the code to test OnboardingThemes
      //var instance = new LegalEntityManagementApi.OnboardingThemes();
      //expect(instance).to.be.a(LegalEntityManagementApi.OnboardingThemes);
    });
