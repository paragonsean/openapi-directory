...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.PciSigningRequest();
  });
  ...
  describe('PciSigningRequest', function() {
    it('should create an instance of PciSigningRequest', function() {
      // uncomment below and update the code to test PciSigningRequest
      //var instance = new LegalEntityManagementApi.PciSigningRequest();
      //expect(instance).to.be.a(LegalEntityManagementApi.PciSigningRequest);
    });

    it('should have the property pciTemplateReferences (base name: "pciTemplateReferences")', function() {
      // uncomment below and update the code to test the property pciTemplateReferences
      //var instance = new LegalEntityManagementApi.PciSigningRequest();
