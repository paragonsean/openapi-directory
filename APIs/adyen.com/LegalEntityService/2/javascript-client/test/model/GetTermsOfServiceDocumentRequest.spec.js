...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.GetTermsOfServiceDocumentRequest();
  });
  ...
  describe('GetTermsOfServiceDocumentRequest', function() {
    it('should create an instance of GetTermsOfServiceDocumentRequest', function() {
      // uncomment below and update the code to test GetTermsOfServiceDocumentRequest
      //var instance = new LegalEntityManagementApi.GetTermsOfServiceDocumentRequest();
      //expect(instance).to.be.a(LegalEntityManagementApi.GetTermsOfServiceDocumentRequest);
    });
