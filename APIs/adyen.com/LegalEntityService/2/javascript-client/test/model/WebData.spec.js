...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.WebData();
  });
  ...
  describe('WebData', function() {
    it('should create an instance of WebData', function() {
      // uncomment below and update the code to test WebData
      //var instance = new LegalEntityManagementApi.WebData();
      //expect(instance).to.be.a(LegalEntityManagementApi.WebData);
    });
    ...
    it('should have the property webAddressId (base name: "webAddressId")', function() {
      // uncomment below and update the code to test the property webAddressId
      //var instance = new LegalEntityManagementApi.WebData();
      //expect(instance).to.be();
    });
