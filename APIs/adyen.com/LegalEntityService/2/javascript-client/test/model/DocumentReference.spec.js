...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.DocumentReference();
  });
  ...
  describe('DocumentReference', function() {
    it('should create an instance of DocumentReference', function() {
      ...
      //var instance = new LegalEntityManagementApi.DocumentReference();
      //expect(instance).to.be.a(LegalEntityManagementApi.DocumentReference);
    });
