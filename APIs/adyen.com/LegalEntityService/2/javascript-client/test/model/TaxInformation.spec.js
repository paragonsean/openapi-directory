...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.TaxInformation();
  });
  ...
  describe('TaxInformation', function() {
    it('should create an instance of TaxInformation', function() {
      // uncomment below and update the code to test TaxInformation
      //var instance = new LegalEntityManagementApi.TaxInformation();
      //expect(instance).to.be.a(LegalEntityManagementApi.TaxInformation);
    });
