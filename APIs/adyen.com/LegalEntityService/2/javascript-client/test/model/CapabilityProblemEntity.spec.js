...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.CapabilityProblemEntity();
  });
  ...
  describe('CapabilityProblemEntity', function() {
    it('should create an instance of CapabilityProblemEntity', function() {
      // uncomment below and update the code to test CapabilityProblemEntity
      //var instance = new LegalEntityManagementApi.CapabilityProblemEntity();
      //expect(instance).to.be.a(LegalEntityManagementApi.CapabilityProblemEntity);
    });
