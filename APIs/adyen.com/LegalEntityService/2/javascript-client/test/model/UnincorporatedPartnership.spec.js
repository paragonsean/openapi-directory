...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.UnincorporatedPartnership();
  });
  ...
  describe('UnincorporatedPartnership', function() {
    it('should create an instance of UnincorporatedPartnership', function() {
      // uncomment below and update the code to test UnincorporatedPartnership
      //var instance = new LegalEntityManagementApi.UnincorporatedPartnership();
      //expect(instance).to.be.a(LegalEntityManagementApi.UnincorporatedPartnership);
    });
