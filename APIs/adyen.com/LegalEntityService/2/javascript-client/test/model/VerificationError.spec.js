...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.VerificationError();
  });
  ...
  describe('VerificationError', function() {
    it('should create an instance of VerificationError', function() {
      // uncomment below and update the code to test VerificationError
      //var instance = new LegalEntityManagementApi.VerificationError();
      //expect(instance).to.be.a(LegalEntityManagementApi.VerificationError);
    });
    ...
    it('should have the property subErrors (base name: "subErrors")', function() {
      // uncomment below and update the code to test the property subErrors
      //var instance = new LegalEntityManagementApi.VerificationError();
      //expect(instance).to.be();
    });
