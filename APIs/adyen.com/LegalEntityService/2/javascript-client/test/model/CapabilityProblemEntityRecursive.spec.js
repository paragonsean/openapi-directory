...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.CapabilityProblemEntityRecursive();
  });
  ...
  describe('CapabilityProblemEntityRecursive', function() {
    it('should create an instance of CapabilityProblemEntityRecursive', function() {
      // uncomment below and update the code to test CapabilityProblemEntityRecursive
      //var instance = new LegalEntityManagementApi.CapabilityProblemEntityRecursive();
      //expect(instance).to.be.a(LegalEntityManagementApi.CapabilityProblemEntityRecursive);
    });
