...
class Trust {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('undefinedBeneficiaryInfo')) {
                obj['undefinedBeneficiaryInfo'] = ApiClient.convertToType(data['undefinedBeneficiaryInfo'], [UndefinedBeneficiary]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['undefinedBeneficiaryInfo']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['undefinedBeneficiaryInfo'])) {
                throw new Error("Expected the field `undefinedBeneficiaryInfo` to be an array in the JSON data but got " + data['undefinedBeneficiaryInfo']);
            }
            // validate the optional field `undefinedBeneficiaryInfo` (array)
            for (const item of data['undefinedBeneficiaryInfo']) {
                UndefinedBeneficiary.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
Trust.prototype['dateOfIncorporation'] = undefined;
 ...
 */
Trust.prototype['taxInformation'] = undefined;
 ...
 * @member {Array.<module:model/UndefinedBeneficiary>} undefinedBeneficiaryInfo
 */
Trust.prototype['undefinedBeneficiaryInfo'] = undefined;
