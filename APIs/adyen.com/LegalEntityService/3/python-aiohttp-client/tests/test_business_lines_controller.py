...
async def test_delete_business_lines_id(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/lem/v3/businessLines/{id}'.format(id='id_example'),
        headers=headers,
        )
