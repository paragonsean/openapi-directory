...
class BankAccountInfoAccountIdentification(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, account_number: str=None, bsb_code: str=None, form_factor: str='physical', type: str='auLocal', account_type: str='checking', institution_number: str=None, transit_number: str=None, bank_code: str=None, clearing_code: str=None, iban: str=None, additional_bank_identification: AdditionalBankIdentification=None, bic: str=None, clearing_number: str=None, sort_code: str=None, routing_number: str=None):
        """BankAccountInfoAccountIdentification - a model defined in OpenAPI

        :param account_number: The account_number of this BankAccountInfoAccountIdentification.
        :param bsb_code: The bsb_code of this BankAccountInfoAccountIdentification.
        :param form_factor: The form_factor of this BankAccountInfoAccountIdentification.
        :param type: The type of this BankAccountInfoAccountIdentification.
        :param account_type: The account_type of this BankAccountInfoAccountIdentification.
        :param institution_number: The institution_number of this BankAccountInfoAccountIdentification.
        :param transit_number: The transit_number of this BankAccountInfoAccountIdentification.
        :param bank_code: The bank_code of this BankAccountInfoAccountIdentification.
        :param clearing_code: The clearing_code of this BankAccountInfoAccountIdentification.
        :param iban: The iban of this BankAccountInfoAccountIdentification.
        :param additional_bank_identification: The additional_bank_identification of this BankAccountInfoAccountIdentification.
        :param bic: The bic of this BankAccountInfoAccountIdentification.
        :param clearing_number: The clearing_number of this BankAccountInfoAccountIdentification.
        :param sort_code: The sort_code of this BankAccountInfoAccountIdentification.
        :param routing_number: The routing_number of this BankAccountInfoAccountIdentification.
        """
        self.openapi_types = {
            'account_number': str,
            'bsb_code': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BankAccountInfoAccountIdentification':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BankAccountInfo_accountIdentification of this BankAccountInfoAccountIdentification.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_number(self):
        """Gets the account_number of this BankAccountInfoAccountIdentification.

        The bank account number, without separators or whitespace.

        :return: The account_number of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
    ...
    def account_number(self, account_number):
        """Sets the account_number of this BankAccountInfoAccountIdentification.
    ...
    @property
    def bsb_code(self):
        """Gets the bsb_code of this BankAccountInfoAccountIdentification.

        The 6-digit [Bank State Branch (BSB) code](https://en.wikipedia.org/wiki/Bank_state_branch), without separators or whitespace.

        :return: The bsb_code of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
    ...
    def bsb_code(self, bsb_code):
        """Sets the bsb_code of this BankAccountInfoAccountIdentification.
    ...
    def form_factor(self):
        """Gets the form_factor of this BankAccountInfoAccountIdentification.

        The form factor of the account.  Possible values: **physical**, **virtual**. Default value: **physical**.

        :return: The form_factor of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
    ...
    def form_factor(self, form_factor):
        """Sets the form_factor of this BankAccountInfoAccountIdentification.
    ...
    @property
    def type(self):
        """Gets the type of this BankAccountInfoAccountIdentification.

        **auLocal**

        :return: The type of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this BankAccountInfoAccountIdentification.
        ...
        **auLocal**
        ...
        :type type: str
        """
        allowed_values = ["auLocal", "caLocal", "czLocal", "dkLocal", "hkLocal", "huLocal", "iban", "noLocal", "nzLocal", "numberAndBic", "plLocal", "seLocal", "sgLocal", "ukLocal", "usLocal"]  # noqa: E501
    ...
    def account_type(self):
        """Gets the account_type of this BankAccountInfoAccountIdentification.

        The bank account type.  Possible values: **checking** or **savings**. Defaults to **checking**.

        :return: The account_type of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
    ...
    def account_type(self, account_type):
        """Sets the account_type of this BankAccountInfoAccountIdentification.
    ...
    def institution_number(self):
        """Gets the institution_number of this BankAccountInfoAccountIdentification.

        The 3-digit institution number, without separators or whitespace.

        :return: The institution_number of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
    ...
    def institution_number(self, institution_number):
        """Sets the institution_number of this BankAccountInfoAccountIdentification.
    ...
    def transit_number(self):
        """Gets the transit_number of this BankAccountInfoAccountIdentification.

        The 5-digit transit number, without separators or whitespace.

        :return: The transit_number of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
    ...
    def transit_number(self, transit_number):
        """Sets the transit_number of this BankAccountInfoAccountIdentification.
    ...
    @property
    def bank_code(self):
        """Gets the bank_code of this BankAccountInfoAccountIdentification.

        The 4-digit bank code (Registreringsnummer) (without separators or whitespace).

        :return: The bank_code of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
    ...
    def bank_code(self, bank_code):
        """Sets the bank_code of this BankAccountInfoAccountIdentification.
    ...
    def clearing_code(self):
        """Gets the clearing_code of this BankAccountInfoAccountIdentification.

        The 3-digit clearing code, without separators or whitespace.

        :return: The clearing_code of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
    ...
    def clearing_code(self, clearing_code):
        """Sets the clearing_code of this BankAccountInfoAccountIdentification.
    ...
    @property
    def iban(self):
        """Gets the iban of this BankAccountInfoAccountIdentification.

        The international bank account number as defined in the [ISO-13616](https://www.iso.org/standard/81090.html) standard.

        :return: The iban of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
        return self._iban
    ...
    @iban.setter
    def iban(self, iban):
        """Sets the iban of this BankAccountInfoAccountIdentification.
    ...
    def additional_bank_identification(self):
        """Gets the additional_bank_identification of this BankAccountInfoAccountIdentification.

        Additional identification codes of the bank. Some banks may require these identifiers for cross-border transfers.

        :return: The additional_bank_identification of this BankAccountInfoAccountIdentification.
    ...
    def additional_bank_identification(self, additional_bank_identification):
        """Sets the additional_bank_identification of this BankAccountInfoAccountIdentification.
    ...
    @property
    def bic(self):
        """Gets the bic of this BankAccountInfoAccountIdentification.

        The bank's 8- or 11-character BIC or SWIFT code.

        :return: The bic of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
        return self._bic
    ...
    @bic.setter
    def bic(self, bic):
        """Sets the bic of this BankAccountInfoAccountIdentification.
    ...
    def clearing_number(self):
        """Gets the clearing_number of this BankAccountInfoAccountIdentification.
        ...
        :return: The clearing_number of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
    ...
    def clearing_number(self, clearing_number):
        """Sets the clearing_number of this BankAccountInfoAccountIdentification.
    ...
    @property
    def sort_code(self):
        """Gets the sort_code of this BankAccountInfoAccountIdentification.

        The 6-digit [sort code](https://en.wikipedia.org/wiki/Sort_code), without separators or whitespace.

        :return: The sort_code of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
    ...
    def sort_code(self, sort_code):
        """Sets the sort_code of this BankAccountInfoAccountIdentification.
    ...
    def routing_number(self):
        """Gets the routing_number of this BankAccountInfoAccountIdentification.

        The 9-digit [routing number](https://en.wikipedia.org/wiki/ABA_routing_transit_number), without separators or whitespace.

        :return: The routing_number of this BankAccountInfoAccountIdentification.
        :rtype: str
        """
    ...
    def routing_number(self, routing_number):
        """Sets the routing_number of this BankAccountInfoAccountIdentification.
