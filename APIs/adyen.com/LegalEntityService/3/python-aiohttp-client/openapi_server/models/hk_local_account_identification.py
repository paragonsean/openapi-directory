...
class HKLocalAccountIdentification(Model):
    ...
    def __init__(self, account_number: str=None, clearing_code: str=None, form_factor: str='physical', type: str='hkLocal'):
        ...
        :param form_factor: The form_factor of this HKLocalAccountIdentification.
    ...
    def form_factor(self):
        """Gets the form_factor of this HKLocalAccountIdentification.

        The form factor of the account.  Possible values: **physical**, **virtual**. Default value: **physical**.

        :return: The form_factor of this HKLocalAccountIdentification.
        :rtype: str
        """
    ...
    def form_factor(self, form_factor):
        """Sets the form_factor of this HKLocalAccountIdentification.
