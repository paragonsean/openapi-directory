...
class Individual(Model):
    ...
    def __init__(self, birth_data: BirthData=None, email: str=None, identification_data: IdentificationData=None, name: Name=None, nationality: str=None, phone: PhoneNumber=None, residential_address: Address=None, tax_information: List[TaxInformation]=None, web_data: WebData=None):
        ...
        :param tax_information: The tax_information of this Individual.
    ...
    def tax_information(self):
        """Gets the tax_information of this Individual.

        The tax information of the individual.

        :return: The tax_information of this Individual.
    ...
    def tax_information(self, tax_information):
        """Sets the tax_information of this Individual.
