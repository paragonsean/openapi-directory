...
/**
 * Model tests for VerificationError
 */
public class VerificationErrorTest {
    private final VerificationError model = new VerificationError();
