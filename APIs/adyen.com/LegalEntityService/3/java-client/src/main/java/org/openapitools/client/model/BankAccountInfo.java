...
import org.openapitools.client.model.BankAccountInfoAccountIdentification;
...
public class BankAccountInfo {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("accountIdentification") != null && !jsonObj.get("accountIdentification").isJsonNull()) {
        BankAccountInfoAccountIdentification.validateJsonElement(jsonObj.get("accountIdentification"));
      }
