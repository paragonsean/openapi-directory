...
|------------ | ------------- | ------------- | -------------|
|**capability** | [**CapabilityEnum**](#CapabilityEnum) | The capability for which you are creating the business line.  Possible values: **receivePayments**, **receiveFromPlatformPayments**, **issueBankAccount** |  [optional] |
...
|**service** | [**ServiceEnum**](#ServiceEnum) | The service for which you are creating the business line.    Possible values: *  **paymentProcessing** *  **banking**   |  |
