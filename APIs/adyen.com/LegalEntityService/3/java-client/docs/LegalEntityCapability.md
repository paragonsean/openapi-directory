...
|**transferInstruments** | [**List&lt;SupportingEntityCapability&gt;**](SupportingEntityCapability.md) | The capability status of transfer instruments associated with the legal entity. |  [optional] |
