...
#include <iostream>
#include "../client/OAIBusinessLinesApi.h"
...
void Example::exampleFunction1(){
     OAIBusinessLinesApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIBusinessLinesApi::deleteBusinessLinesIdSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIBusinessLinesApi::deleteBusinessLinesIdSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString id = create(); // QString | The unique identifier of the business line to be deleted.
