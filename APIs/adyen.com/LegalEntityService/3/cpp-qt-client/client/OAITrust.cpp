...
QString OAITrust::getDescription() const {
    return m_description;
}
void OAITrust::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAITrust::is_description_Set() const{
    return m_description_isSet;
}

bool OAITrust::is_description_Valid() const{
