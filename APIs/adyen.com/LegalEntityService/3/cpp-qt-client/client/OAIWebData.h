...
class OAIWebData : public OAIObject {
public:
    OAIWebData();
    OAIWebData(QString json);
    ~OAIWebData() override;
    ...
    QString getWebAddressId() const;
    void setWebAddressId(const QString &web_address_id);
    bool is_web_address_id_Set() const;
    bool is_web_address_id_Valid() const;
...
private:
    ...
    QString m_web_address_id;
    bool m_web_address_id_isSet;
    bool m_web_address_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIWebData)
