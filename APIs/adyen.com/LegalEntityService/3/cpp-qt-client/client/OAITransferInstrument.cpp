...
QMap<QString, OAISupportingEntityCapability> OAITransferInstrument::getCapabilities() const {
    return m_capabilities;
}
void OAITransferInstrument::setCapabilities(const QMap<QString, OAISupportingEntityCapability> &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAITransferInstrument::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAITransferInstrument::is_capabilities_Valid() const{
...
QList<OAICapabilityProblem> OAITransferInstrument::getProblems() const {
    return m_problems;
}
void OAITransferInstrument::setProblems(const QList<OAICapabilityProblem> &problems) {
    m_problems = problems;
    m_problems_isSet = true;
}

bool OAITransferInstrument::is_problems_Set() const{
    return m_problems_isSet;
}

bool OAITransferInstrument::is_problems_Valid() const{
