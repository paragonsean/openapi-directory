...
/*
 * OAILegalEntityInfoRequiredType.h
 *
 * 
 */

#ifndef OAILegalEntityInfoRequiredType_H
#define OAILegalEntityInfoRequiredType_H
...
class OAILegalEntityInfoRequiredType : public OAIObject {
public:
    OAILegalEntityInfoRequiredType();
    OAILegalEntityInfoRequiredType(QString json);
    ~OAILegalEntityInfoRequiredType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILegalEntityInfoRequiredType)

#endif // OAILegalEntityInfoRequiredType_H
