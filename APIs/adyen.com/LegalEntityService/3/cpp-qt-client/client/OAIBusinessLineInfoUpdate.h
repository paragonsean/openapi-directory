...
/*
 * OAIBusinessLineInfoUpdate.h
 *
 * 
 */

#ifndef OAIBusinessLineInfoUpdate_H
#define OAIBusinessLineInfoUpdate_H
...
class OAIBusinessLineInfoUpdate : public OAIObject {
public:
    OAIBusinessLineInfoUpdate();
    OAIBusinessLineInfoUpdate(QString json);
    ~OAIBusinessLineInfoUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBusinessLineInfoUpdate)

#endif // OAIBusinessLineInfoUpdate_H
