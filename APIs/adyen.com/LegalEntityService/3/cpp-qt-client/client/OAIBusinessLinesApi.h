...
#include "OAIBusinessLineInfoUpdate.h"
...
public:
    ...
    */
    ...
    /**
    * @param[in]  id QString [required]
    * @param[in]  oai_business_line_info_update OAIBusinessLineInfoUpdate [optional]
    */
    virtual void patchBusinessLinesId(const QString &id, const ::OpenAPI::OptionalParam<OAIBusinessLineInfoUpdate> &oai_business_line_info_update = ::OpenAPI::OptionalParam<OAIBusinessLineInfoUpdate>());
...
private:
    ...
    void patchBusinessLinesIdCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void patchBusinessLinesIdSignal(OAIBusinessLine summary);
    ...
    void patchBusinessLinesIdSignalFull(OAIHttpRequestWorker *worker, OAIBusinessLine summary);
    ...
    Q_DECL_DEPRECATED_X("Use patchBusinessLinesIdSignalError() instead")
    void patchBusinessLinesIdSignalE(OAIBusinessLine summary, QNetworkReply::NetworkError error_type, QString error_str);
    void patchBusinessLinesIdSignalError(OAIBusinessLine summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use patchBusinessLinesIdSignalErrorFull() instead")
    void patchBusinessLinesIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void patchBusinessLinesIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
