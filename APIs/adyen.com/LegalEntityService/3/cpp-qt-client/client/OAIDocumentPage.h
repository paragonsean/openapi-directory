...
#ifndef OAIDocumentPage_H
#define OAIDocumentPage_H
...
class OAIDocumentPage : public OAIObject {
public:
    OAIDocumentPage();
    OAIDocumentPage(QString json);
    ~OAIDocumentPage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentPage)

#endif // OAIDocumentPage_H
