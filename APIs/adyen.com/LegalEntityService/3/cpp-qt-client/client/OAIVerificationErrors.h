...
/*
 * OAIVerificationErrors.h
 *
 * 
 */

#ifndef OAIVerificationErrors_H
#define OAIVerificationErrors_H
...
class OAIVerificationErrors : public OAIObject {
public:
    OAIVerificationErrors();
    OAIVerificationErrors(QString json);
    ~OAIVerificationErrors() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerificationErrors)

#endif // OAIVerificationErrors_H
