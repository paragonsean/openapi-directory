...
/*
 * OAILegalEntityInfo.h
 *
 * 
 */

#ifndef OAILegalEntityInfo_H
#define OAILegalEntityInfo_H
...
class OAILegalEntityInfo : public OAIObject {
public:
    OAILegalEntityInfo();
    OAILegalEntityInfo(QString json);
    ~OAILegalEntityInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILegalEntityInfo)

#endif // OAILegalEntityInfo_H
