...
QList<OAICapabilityProblem> OAIBusinessLine::getProblems() const {
    return m_problems;
}
void OAIBusinessLine::setProblems(const QList<OAICapabilityProblem> &problems) {
    m_problems = problems;
    m_problems_isSet = true;
}

bool OAIBusinessLine::is_problems_Set() const{
    return m_problems_isSet;
}

bool OAIBusinessLine::is_problems_Valid() const{
...
QString OAIBusinessLine::getService() const {
    return m_service;
}
void OAIBusinessLine::setService(const QString &service) {
    m_service = service;
    m_service_isSet = true;
}

bool OAIBusinessLine::is_service_Set() const{
    return m_service_isSet;
}

bool OAIBusinessLine::is_service_Valid() const{
...
bool OAIBusinessLine::isValid() const {
    ...
    return m_id_isValid && m_industry_code_isValid && m_legal_entity_id_isValid && m_service_isValid && true;
}
