...
/*
 * OAITransferInstrumentInfo.h
 *
 * 
 */

#ifndef OAITransferInstrumentInfo_H
#define OAITransferInstrumentInfo_H
...
class OAITransferInstrumentInfo : public OAIObject {
public:
    OAITransferInstrumentInfo();
    OAITransferInstrumentInfo(QString json);
    ~OAITransferInstrumentInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferInstrumentInfo)

#endif // OAITransferInstrumentInfo_H
