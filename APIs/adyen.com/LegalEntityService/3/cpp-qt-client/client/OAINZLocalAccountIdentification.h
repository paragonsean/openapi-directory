...
/*
 * OAINZLocalAccountIdentification.h
 *
 * 
 */

#ifndef OAINZLocalAccountIdentification_H
#define OAINZLocalAccountIdentification_H
...
class OAINZLocalAccountIdentification : public OAIObject {
public:
    OAINZLocalAccountIdentification();
    OAINZLocalAccountIdentification(QString json);
    ~OAINZLocalAccountIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINZLocalAccountIdentification)

#endif // OAINZLocalAccountIdentification_H
