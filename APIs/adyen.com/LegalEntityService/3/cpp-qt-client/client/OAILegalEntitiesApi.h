...
public:
    ...
    * @param[in]  id QString [required]
    */
    virtual void postLegalEntitiesIdCheckVerificationErrors(const QString &id);

    /**
    * @param[in]  id QString [required]
    */
    virtual void postLegalEntitiesIdConfirmDataReview(const QString &id);
...
private:
    ...
    void postLegalEntitiesIdCheckVerificationErrorsCallback(OAIHttpRequestWorker *worker);
    void postLegalEntitiesIdConfirmDataReviewCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void postLegalEntitiesIdCheckVerificationErrorsSignal(OAIVerificationErrors summary);
    void postLegalEntitiesIdConfirmDataReviewSignal(OAIDataReviewConfirmationResponse summary);
    ...
    void postLegalEntitiesIdCheckVerificationErrorsSignalFull(OAIHttpRequestWorker *worker, OAIVerificationErrors summary);
    void postLegalEntitiesIdConfirmDataReviewSignalFull(OAIHttpRequestWorker *worker, OAIDataReviewConfirmationResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use postLegalEntitiesIdCheckVerificationErrorsSignalError() instead")
    void postLegalEntitiesIdCheckVerificationErrorsSignalE(OAIVerificationErrors summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postLegalEntitiesIdCheckVerificationErrorsSignalError(OAIVerificationErrors summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postLegalEntitiesIdConfirmDataReviewSignalError() instead")
    void postLegalEntitiesIdConfirmDataReviewSignalE(OAIDataReviewConfirmationResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postLegalEntitiesIdConfirmDataReviewSignalError(OAIDataReviewConfirmationResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use postLegalEntitiesIdCheckVerificationErrorsSignalErrorFull() instead")
    void postLegalEntitiesIdCheckVerificationErrorsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postLegalEntitiesIdCheckVerificationErrorsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postLegalEntitiesIdConfirmDataReviewSignalErrorFull() instead")
    void postLegalEntitiesIdConfirmDataReviewSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postLegalEntitiesIdConfirmDataReviewSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
