...
OAIBusinessLineInfoUpdate::OAIBusinessLineInfoUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBusinessLineInfoUpdate::OAIBusinessLineInfoUpdate() {
    this->initializeModel();
}

OAIBusinessLineInfoUpdate::~OAIBusinessLineInfoUpdate() {}

void OAIBusinessLineInfoUpdate::initializeModel() {
...
void OAIBusinessLineInfoUpdate::fromJson(QString jsonString) {
...
void OAIBusinessLineInfoUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIBusinessLineInfoUpdate::asJson() const {
...
QJsonObject OAIBusinessLineInfoUpdate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBusinessLineInfoUpdate::getCapability() const {
    return m_capability;
}
void OAIBusinessLineInfoUpdate::setCapability(const QString &capability) {
    m_capability = capability;
    m_capability_isSet = true;
}

bool OAIBusinessLineInfoUpdate::is_capability_Set() const{
    return m_capability_isSet;
}

bool OAIBusinessLineInfoUpdate::is_capability_Valid() const{
    return m_capability_isValid;
}

QString OAIBusinessLineInfoUpdate::getIndustryCode() const {
    return m_industry_code;
}
void OAIBusinessLineInfoUpdate::setIndustryCode(const QString &industry_code) {
    m_industry_code = industry_code;
    m_industry_code_isSet = true;
}

bool OAIBusinessLineInfoUpdate::is_industry_code_Set() const{
    return m_industry_code_isSet;
}

bool OAIBusinessLineInfoUpdate::is_industry_code_Valid() const{
    return m_industry_code_isValid;
}

QString OAIBusinessLineInfoUpdate::getLegalEntityId() const {
    return m_legal_entity_id;
}
void OAIBusinessLineInfoUpdate::setLegalEntityId(const QString &legal_entity_id) {
    m_legal_entity_id = legal_entity_id;
    m_legal_entity_id_isSet = true;
}

bool OAIBusinessLineInfoUpdate::is_legal_entity_id_Set() const{
    return m_legal_entity_id_isSet;
}

bool OAIBusinessLineInfoUpdate::is_legal_entity_id_Valid() const{
    return m_legal_entity_id_isValid;
}

QList<QString> OAIBusinessLineInfoUpdate::getSalesChannels() const {
    return m_sales_channels;
}
void OAIBusinessLineInfoUpdate::setSalesChannels(const QList<QString> &sales_channels) {
    m_sales_channels = sales_channels;
    m_sales_channels_isSet = true;
}

bool OAIBusinessLineInfoUpdate::is_sales_channels_Set() const{
    return m_sales_channels_isSet;
}

bool OAIBusinessLineInfoUpdate::is_sales_channels_Valid() const{
    return m_sales_channels_isValid;
}

QString OAIBusinessLineInfoUpdate::getService() const {
    return m_service;
}
void OAIBusinessLineInfoUpdate::setService(const QString &service) {
    m_service = service;
    m_service_isSet = true;
}

bool OAIBusinessLineInfoUpdate::is_service_Set() const{
    return m_service_isSet;
}

bool OAIBusinessLineInfoUpdate::is_service_Valid() const{
    return m_service_isValid;
}

OAISourceOfFunds OAIBusinessLineInfoUpdate::getSourceOfFunds() const {
    return m_source_of_funds;
}
void OAIBusinessLineInfoUpdate::setSourceOfFunds(const OAISourceOfFunds &source_of_funds) {
    m_source_of_funds = source_of_funds;
    m_source_of_funds_isSet = true;
}

bool OAIBusinessLineInfoUpdate::is_source_of_funds_Set() const{
    return m_source_of_funds_isSet;
}

bool OAIBusinessLineInfoUpdate::is_source_of_funds_Valid() const{
    return m_source_of_funds_isValid;
}

QList<OAIWebData> OAIBusinessLineInfoUpdate::getWebData() const {
    return m_web_data;
}
void OAIBusinessLineInfoUpdate::setWebData(const QList<OAIWebData> &web_data) {
    m_web_data = web_data;
    m_web_data_isSet = true;
}

bool OAIBusinessLineInfoUpdate::is_web_data_Set() const{
    return m_web_data_isSet;
}

bool OAIBusinessLineInfoUpdate::is_web_data_Valid() const{
    return m_web_data_isValid;
}

OAIWebDataExemption OAIBusinessLineInfoUpdate::getWebDataExemption() const {
    return m_web_data_exemption;
}
void OAIBusinessLineInfoUpdate::setWebDataExemption(const OAIWebDataExemption &web_data_exemption) {
    m_web_data_exemption = web_data_exemption;
    m_web_data_exemption_isSet = true;
}

bool OAIBusinessLineInfoUpdate::is_web_data_exemption_Set() const{
    return m_web_data_exemption_isSet;
}

bool OAIBusinessLineInfoUpdate::is_web_data_exemption_Valid() const{
    return m_web_data_exemption_isValid;
}

bool OAIBusinessLineInfoUpdate::isSet() const {
...
bool OAIBusinessLineInfoUpdate::isValid() const {
