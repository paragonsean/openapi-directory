...
QString OAIBusinessLineInfo::getService() const {
    return m_service;
}
void OAIBusinessLineInfo::setService(const QString &service) {
    m_service = service;
    m_service_isSet = true;
}

bool OAIBusinessLineInfo::is_service_Set() const{
    return m_service_isSet;
}

bool OAIBusinessLineInfo::is_service_Valid() const{
...
bool OAIBusinessLineInfo::isValid() const {
    ...
    return m_industry_code_isValid && m_legal_entity_id_isValid && m_service_isValid && true;
}
