...
/*
 * OAISELocalAccountIdentification.h
 *
 * 
 */

#ifndef OAISELocalAccountIdentification_H
#define OAISELocalAccountIdentification_H
...
class OAISELocalAccountIdentification : public OAIObject {
public:
    OAISELocalAccountIdentification();
    OAISELocalAccountIdentification(QString json);
    ~OAISELocalAccountIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISELocalAccountIdentification)

#endif // OAISELocalAccountIdentification_H
