...
/*
 * OAIHULocalAccountIdentification.h
 *
 * 
 */

#ifndef OAIHULocalAccountIdentification_H
#define OAIHULocalAccountIdentification_H
...
class OAIHULocalAccountIdentification : public OAIObject {
public:
    OAIHULocalAccountIdentification();
    OAIHULocalAccountIdentification(QString json);
    ~OAIHULocalAccountIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHULocalAccountIdentification)

#endif // OAIHULocalAccountIdentification_H
