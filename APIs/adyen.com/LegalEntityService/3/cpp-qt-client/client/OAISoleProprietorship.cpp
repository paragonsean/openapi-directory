...
QString OAISoleProprietorship::getDescription() const {
    return m_description;
}
void OAISoleProprietorship::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISoleProprietorship::is_description_Set() const{
    return m_description_isSet;
}

bool OAISoleProprietorship::is_description_Valid() const{
