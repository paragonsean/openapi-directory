...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.StockData();
  });
  ...
  describe('StockData', function() {
    it('should create an instance of StockData', function() {
      ...
      //var instance = new LegalEntityManagementApi.StockData();
      //expect(instance).to.be.a(LegalEntityManagementApi.StockData);
    });

    it('should have the property marketIdentifier (base name: "marketIdentifier")', function() {
      // uncomment below and update the code to test the property marketIdentifier
      //var instance = new LegalEntityManagementApi.StockData();
