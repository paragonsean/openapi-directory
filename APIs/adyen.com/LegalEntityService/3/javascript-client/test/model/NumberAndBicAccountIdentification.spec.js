...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.NumberAndBicAccountIdentification();
  });
  ...
  describe('NumberAndBicAccountIdentification', function() {
    it('should create an instance of NumberAndBicAccountIdentification', function() {
      ...
      //var instance = new LegalEntityManagementApi.NumberAndBicAccountIdentification();
      //expect(instance).to.be.a(LegalEntityManagementApi.NumberAndBicAccountIdentification);
    });
