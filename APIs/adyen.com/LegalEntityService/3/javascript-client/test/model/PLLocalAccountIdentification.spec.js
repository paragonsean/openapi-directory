...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.PLLocalAccountIdentification();
  });
  ...
  describe('PLLocalAccountIdentification', function() {
    it('should create an instance of PLLocalAccountIdentification', function() {
      // uncomment below and update the code to test PLLocalAccountIdentification
      //var instance = new LegalEntityManagementApi.PLLocalAccountIdentification();
      //expect(instance).to.be.a(LegalEntityManagementApi.PLLocalAccountIdentification);
    });
