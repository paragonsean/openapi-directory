...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.SoleProprietorship();
  });
  ...
  describe('SoleProprietorship', function() {
    it('should create an instance of SoleProprietorship', function() {
      // uncomment below and update the code to test SoleProprietorship
      //var instance = new LegalEntityManagementApi.SoleProprietorship();
      //expect(instance).to.be.a(LegalEntityManagementApi.SoleProprietorship);
    });
