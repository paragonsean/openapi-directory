...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.HKLocalAccountIdentification();
  });
  ...
  describe('HKLocalAccountIdentification', function() {
    it('should create an instance of HKLocalAccountIdentification', function() {
      // uncomment below and update the code to test HKLocalAccountIdentification
      //var instance = new LegalEntityManagementApi.HKLocalAccountIdentification();
      //expect(instance).to.be.a(LegalEntityManagementApi.HKLocalAccountIdentification);
    });
