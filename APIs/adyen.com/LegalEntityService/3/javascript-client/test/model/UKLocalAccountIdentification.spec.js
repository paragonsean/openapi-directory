...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.UKLocalAccountIdentification();
  });
  ...
  describe('UKLocalAccountIdentification', function() {
    it('should create an instance of UKLocalAccountIdentification', function() {
      ...
      //var instance = new LegalEntityManagementApi.UKLocalAccountIdentification();
      //expect(instance).to.be.a(LegalEntityManagementApi.UKLocalAccountIdentification);
    });
