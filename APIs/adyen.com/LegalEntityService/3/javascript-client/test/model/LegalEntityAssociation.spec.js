...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.LegalEntityAssociation();
  });
  ...
  describe('LegalEntityAssociation', function() {
    it('should create an instance of LegalEntityAssociation', function() {
      // uncomment below and update the code to test LegalEntityAssociation
      //var instance = new LegalEntityManagementApi.LegalEntityAssociation();
      //expect(instance).to.be.a(LegalEntityManagementApi.LegalEntityAssociation);
    });

    it('should have the property associatorId (base name: "associatorId")', function() {
      // uncomment below and update the code to test the property associatorId
      //var instance = new LegalEntityManagementApi.LegalEntityAssociation();
    ...
    it('should have the property settlorExemptionReason (base name: "settlorExemptionReason")', function() {
      // uncomment below and update the code to test the property settlorExemptionReason
      //var instance = new LegalEntityManagementApi.LegalEntityAssociation();
      //expect(instance).to.be();
    });
