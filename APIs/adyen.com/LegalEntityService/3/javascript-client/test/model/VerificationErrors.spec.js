...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.VerificationErrors();
  });
  ...
  describe('VerificationErrors', function() {
    it('should create an instance of VerificationErrors', function() {
      // uncomment below and update the code to test VerificationErrors
      //var instance = new LegalEntityManagementApi.VerificationErrors();
      //expect(instance).to.be.a(LegalEntityManagementApi.VerificationErrors);
    });
