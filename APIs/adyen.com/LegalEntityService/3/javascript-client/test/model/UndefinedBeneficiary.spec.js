...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.UndefinedBeneficiary();
  });
  ...
  describe('UndefinedBeneficiary', function() {
    it('should create an instance of UndefinedBeneficiary', function() {
      // uncomment below and update the code to test UndefinedBeneficiary
      //var instance = new LegalEntityManagementApi.UndefinedBeneficiary();
      //expect(instance).to.be.a(LegalEntityManagementApi.UndefinedBeneficiary);
    });
