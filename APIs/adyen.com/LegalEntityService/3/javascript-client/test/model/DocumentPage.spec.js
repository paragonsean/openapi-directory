...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.DocumentPage();
  });
  ...
  describe('DocumentPage', function() {
    it('should create an instance of DocumentPage', function() {
      ...
      //var instance = new LegalEntityManagementApi.DocumentPage();
      //expect(instance).to.be.a(LegalEntityManagementApi.DocumentPage);
    });
