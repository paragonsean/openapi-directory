...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.IdentificationData();
  });
  ...
  describe('IdentificationData', function() {
    it('should create an instance of IdentificationData', function() {
      // uncomment below and update the code to test IdentificationData
      //var instance = new LegalEntityManagementApi.IdentificationData();
      //expect(instance).to.be.a(LegalEntityManagementApi.IdentificationData);
    });
    ...
    it('should have the property nationalIdExempt (base name: "nationalIdExempt")', function() {
      // uncomment below and update the code to test the property nationalIdExempt
      //var instance = new LegalEntityManagementApi.IdentificationData();
      //expect(instance).to.be();
    });
