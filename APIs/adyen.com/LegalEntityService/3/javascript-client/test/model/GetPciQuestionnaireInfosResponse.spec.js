...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.GetPciQuestionnaireInfosResponse();
  });
  ...
  describe('GetPciQuestionnaireInfosResponse', function() {
    it('should create an instance of GetPciQuestionnaireInfosResponse', function() {
      // uncomment below and update the code to test GetPciQuestionnaireInfosResponse
      //var instance = new LegalEntityManagementApi.GetPciQuestionnaireInfosResponse();
      //expect(instance).to.be.a(LegalEntityManagementApi.GetPciQuestionnaireInfosResponse);
    });
