...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.CALocalAccountIdentification();
  });
  ...
  describe('CALocalAccountIdentification', function() {
    it('should create an instance of CALocalAccountIdentification', function() {
      // uncomment below and update the code to test CALocalAccountIdentification
      //var instance = new LegalEntityManagementApi.CALocalAccountIdentification();
      //expect(instance).to.be.a(LegalEntityManagementApi.CALocalAccountIdentification);
    });
