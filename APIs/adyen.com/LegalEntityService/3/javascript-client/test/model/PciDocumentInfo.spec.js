...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.PciDocumentInfo();
  });
  ...
  describe('PciDocumentInfo', function() {
    it('should create an instance of PciDocumentInfo', function() {
      // uncomment below and update the code to test PciDocumentInfo
      //var instance = new LegalEntityManagementApi.PciDocumentInfo();
      //expect(instance).to.be.a(LegalEntityManagementApi.PciDocumentInfo);
    });
