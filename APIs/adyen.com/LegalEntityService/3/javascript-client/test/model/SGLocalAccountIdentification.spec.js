...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.SGLocalAccountIdentification();
  });
  ...
  describe('SGLocalAccountIdentification', function() {
    it('should create an instance of SGLocalAccountIdentification', function() {
      ...
      //var instance = new LegalEntityManagementApi.SGLocalAccountIdentification();
      //expect(instance).to.be.a(LegalEntityManagementApi.SGLocalAccountIdentification);
    });
