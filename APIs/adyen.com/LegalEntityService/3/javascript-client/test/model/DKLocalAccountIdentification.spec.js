...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.DKLocalAccountIdentification();
  });
  ...
  describe('DKLocalAccountIdentification', function() {
    it('should create an instance of DKLocalAccountIdentification', function() {
      ...
      //var instance = new LegalEntityManagementApi.DKLocalAccountIdentification();
      //expect(instance).to.be.a(LegalEntityManagementApi.DKLocalAccountIdentification);
    });
