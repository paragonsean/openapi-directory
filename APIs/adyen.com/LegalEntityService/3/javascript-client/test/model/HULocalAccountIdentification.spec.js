...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.HULocalAccountIdentification();
  });
  ...
  describe('HULocalAccountIdentification', function() {
    it('should create an instance of HULocalAccountIdentification', function() {
      // uncomment below and update the code to test HULocalAccountIdentification
      //var instance = new LegalEntityManagementApi.HULocalAccountIdentification();
      //expect(instance).to.be.a(LegalEntityManagementApi.HULocalAccountIdentification);
    });
