...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.IbanAccountIdentification();
  });
  ...
  describe('IbanAccountIdentification', function() {
    it('should create an instance of IbanAccountIdentification', function() {
      // uncomment below and update the code to test IbanAccountIdentification
      //var instance = new LegalEntityManagementApi.IbanAccountIdentification();
      //expect(instance).to.be.a(LegalEntityManagementApi.IbanAccountIdentification);
    });
