...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.AcceptTermsOfServiceRequest();
  });
  ...
  describe('AcceptTermsOfServiceRequest', function() {
    it('should create an instance of AcceptTermsOfServiceRequest', function() {
      // uncomment below and update the code to test AcceptTermsOfServiceRequest
      //var instance = new LegalEntityManagementApi.AcceptTermsOfServiceRequest();
      //expect(instance).to.be.a(LegalEntityManagementApi.AcceptTermsOfServiceRequest);
    });
