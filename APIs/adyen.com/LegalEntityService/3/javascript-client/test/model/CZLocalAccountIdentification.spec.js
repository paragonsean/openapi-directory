...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.CZLocalAccountIdentification();
  });
  ...
  describe('CZLocalAccountIdentification', function() {
    it('should create an instance of CZLocalAccountIdentification', function() {
      // uncomment below and update the code to test CZLocalAccountIdentification
      //var instance = new LegalEntityManagementApi.CZLocalAccountIdentification();
      //expect(instance).to.be.a(LegalEntityManagementApi.CZLocalAccountIdentification);
    });
