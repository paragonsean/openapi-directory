...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.OwnerEntity();
  });
  ...
  describe('OwnerEntity', function() {
    it('should create an instance of OwnerEntity', function() {
      // uncomment below and update the code to test OwnerEntity
      //var instance = new LegalEntityManagementApi.OwnerEntity();
      //expect(instance).to.be.a(LegalEntityManagementApi.OwnerEntity);
    });
