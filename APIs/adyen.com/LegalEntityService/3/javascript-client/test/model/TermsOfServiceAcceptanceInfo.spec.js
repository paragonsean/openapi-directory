...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.TermsOfServiceAcceptanceInfo();
  });
  ...
  describe('TermsOfServiceAcceptanceInfo', function() {
    it('should create an instance of TermsOfServiceAcceptanceInfo', function() {
      // uncomment below and update the code to test TermsOfServiceAcceptanceInfo
      //var instance = new LegalEntityManagementApi.TermsOfServiceAcceptanceInfo();
      //expect(instance).to.be.a(LegalEntityManagementApi.TermsOfServiceAcceptanceInfo);
    });
