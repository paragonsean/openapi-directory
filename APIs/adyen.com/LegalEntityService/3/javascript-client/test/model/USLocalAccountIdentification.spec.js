...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegalEntityManagementApi.USLocalAccountIdentification();
  });
  ...
  describe('USLocalAccountIdentification', function() {
    it('should create an instance of USLocalAccountIdentification', function() {
      // uncomment below and update the code to test USLocalAccountIdentification
      //var instance = new LegalEntityManagementApi.USLocalAccountIdentification();
      //expect(instance).to.be.a(LegalEntityManagementApi.USLocalAccountIdentification);
    });
