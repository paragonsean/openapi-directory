...
class Organization {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('taxReportingClassification')) {
                obj['taxReportingClassification'] = TaxReportingClassification.constructFromObject(data['taxReportingClassification']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['taxReportingClassification']) { // data not null
          TaxReportingClassification.validateJSON(data['taxReportingClassification']);
        }
        // ensure the json data is a string
 ...
 */
Organization.prototype['dateOfIncorporation'] = undefined;
 ...
 */
Organization.prototype['taxInformation'] = undefined;

/**
 * The tax reporting classification (FATCA/CRS self-certification) of the organization.
 * @member {module:model/TaxReportingClassification} taxReportingClassification
 */
Organization.prototype['taxReportingClassification'] = undefined;
 ...
 * @member {module:model/Organization.VatAbsenceReasonEnum} vatAbsenceReason
 */
Organization.prototype['vatAbsenceReason'] = undefined;

/**
 * The organization's VAT number.
 * @member {String} vatNumber
 */
Organization.prototype['vatNumber'] = undefined;
