...
class BusinessLineInfo {
     ...
     * @param service {module:model/BusinessLineInfo.ServiceEnum} The service for which you are creating the business line.    Possible values: *  **paymentProcessing** *  **banking**  
     */
    constructor(industryCode, legalEntityId, service) { 
        
        BusinessLineInfo.initialize(this, industryCode, legalEntityId, service);
    }
     ...
     */
    static initialize(obj, industryCode, legalEntityId, service) { 
...
BusinessLineInfo.RequiredProperties = ["industryCode", "legalEntityId", "service"];
 ...
 * @member {module:model/BusinessLineInfo.ServiceEnum} service
 */
BusinessLineInfo.prototype['service'] = undefined;
