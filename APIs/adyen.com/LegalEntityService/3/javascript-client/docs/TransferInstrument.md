...
**capabilities** | [**{String: SupportingEntityCapability}**](SupportingEntityCapability.md) | List of capabilities for this transfer instrument. | [optional] 
**documentDetails** | [**[DocumentReference]**](DocumentReference.md) | List of documents uploaded for the transfer instrument. | [optional] 
...
**problems** | [**[CapabilityProblem]**](CapabilityProblem.md) | The verification errors related to capabilities for this transfer instrument. | [optional] 
