...
OAICreatePermitRequest Example::create(){
    OAICreatePermitRequest obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIGeneralApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIGeneralApi::postCreatePermitSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIGeneralApi::postCreatePermitSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreatePermitRequest oai_create_permit_request = create(); // OAICreatePermitRequest | 
      apiInstance.postCreatePermit(oai_create_permit_request);
