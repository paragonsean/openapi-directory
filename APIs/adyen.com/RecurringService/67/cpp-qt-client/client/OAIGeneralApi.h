...
public:
    ...
    /**
    * @param[in]  oai_create_permit_request OAICreatePermitRequest [optional]
    */
    virtual void postCreatePermit(const ::OpenAPI::OptionalParam<OAICreatePermitRequest> &oai_create_permit_request = ::OpenAPI::OptionalParam<OAICreatePermitRequest>());
    ...
    */
    ...
    /**
    * @param[in]  oai_disable_permit_request OAIDisablePermitRequest [optional]
    */
    virtual void postDisablePermit(const ::OpenAPI::OptionalParam<OAIDisablePermitRequest> &oai_disable_permit_request = ::OpenAPI::OptionalParam<OAIDisablePermitRequest>());
...
private:
    ...
    void postCreatePermitCallback(OAIHttpRequestWorker *worker);
    void postDisableCallback(OAIHttpRequestWorker *worker);
    void postDisablePermitCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void postCreatePermitSignal(OAICreatePermitResult summary);
    void postDisableSignal(OAIDisableResult summary);
    void postDisablePermitSignal(OAIDisablePermitResult summary);
    ...
    void postCreatePermitSignalFull(OAIHttpRequestWorker *worker, OAICreatePermitResult summary);
    void postDisableSignalFull(OAIHttpRequestWorker *worker, OAIDisableResult summary);
    void postDisablePermitSignalFull(OAIHttpRequestWorker *worker, OAIDisablePermitResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use postCreatePermitSignalError() instead")
    void postCreatePermitSignalE(OAICreatePermitResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postCreatePermitSignalError(OAICreatePermitResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use postDisablePermitSignalError() instead")
    void postDisablePermitSignalE(OAIDisablePermitResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postDisablePermitSignalError(OAIDisablePermitResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use postCreatePermitSignalErrorFull() instead")
    void postCreatePermitSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postCreatePermitSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use postDisablePermitSignalErrorFull() instead")
    void postDisablePermitSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postDisablePermitSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
