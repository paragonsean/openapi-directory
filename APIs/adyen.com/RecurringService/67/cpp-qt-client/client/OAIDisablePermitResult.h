...
/*
 * OAIDisablePermitResult.h
 *
 * 
 */

#ifndef OAIDisablePermitResult_H
#define OAIDisablePermitResult_H
...
class OAIDisablePermitResult : public OAIObject {
public:
    OAIDisablePermitResult();
    OAIDisablePermitResult(QString json);
    ~OAIDisablePermitResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisablePermitResult)

#endif // OAIDisablePermitResult_H
