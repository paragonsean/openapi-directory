...
/*
 * OAIDisablePermitRequest.h
 *
 * 
 */

#ifndef OAIDisablePermitRequest_H
#define OAIDisablePermitRequest_H
...
class OAIDisablePermitRequest : public OAIObject {
public:
    OAIDisablePermitRequest();
    OAIDisablePermitRequest(QString json);
    ~OAIDisablePermitRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisablePermitRequest)

#endif // OAIDisablePermitRequest_H
