...
async def post_create_permit(request: web.Request, body=None) -> web.Response:
    ...
    """
    body = CreatePermitRequest.from_dict(body)
...
async def post_disable_permit(request: web.Request, body=None) -> web.Response:
    ...
    """
    body = DisablePermitRequest.from_dict(body)
    return web.Response(status=200)
