...
export default class GeneralApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the postDisablePermit operation.
     * @callback module:api/GeneralApi~postDisablePermitCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DisablePermitResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/DisablePermitRequest} [disablePermitRequest] 
     * @param {module:api/GeneralApi~postDisablePermitCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DisablePermitResult}
     */
    postDisablePermit(opts, callback) {
      opts = opts || {};
      let postBody = opts['disablePermitRequest'];
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = DisablePermitResult;
      return this.apiClient.callApi(
        '/disablePermit', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
