...
/**
 * The DisablePermitResult model module.
 * @module model/DisablePermitResult
 * @version 67
 */
class DisablePermitResult {
    /**
     * Constructs a new <code>DisablePermitResult</code>.
     * @alias module:model/DisablePermitResult
     */
    constructor() { 
        
        DisablePermitResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisablePermitResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisablePermitResult} obj Optional instance to populate.
     * @return {module:model/DisablePermitResult} The populated <code>DisablePermitResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisablePermitResult();
    ...
    /**
     * Validates the JSON data with respect to <code>DisablePermitResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisablePermitResult</code>.
     */
 ...
 */
DisablePermitResult.prototype['pspReference'] = undefined;

/**
 * Status of the disable request.
 * @member {String} status
 */
DisablePermitResult.prototype['status'] = undefined;
...
export default DisablePermitResult;
