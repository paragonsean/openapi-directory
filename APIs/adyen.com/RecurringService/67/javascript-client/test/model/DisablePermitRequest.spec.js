...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenRecurringApi.DisablePermitRequest();
  });
  ...
  describe('DisablePermitRequest', function() {
    it('should create an instance of DisablePermitRequest', function() {
      // uncomment below and update the code to test DisablePermitRequest
      //var instance = new AdyenRecurringApi.DisablePermitRequest();
      //expect(instance).to.be.a(AdyenRecurringApi.DisablePermitRequest);
    });
