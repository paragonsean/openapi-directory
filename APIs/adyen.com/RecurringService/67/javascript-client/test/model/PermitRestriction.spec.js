...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenRecurringApi.PermitRestriction();
  });
  ...
  describe('PermitRestriction', function() {
    it('should create an instance of PermitRestriction', function() {
      // uncomment below and update the code to test PermitRestriction
      //var instance = new AdyenRecurringApi.PermitRestriction();
      //expect(instance).to.be.a(AdyenRecurringApi.PermitRestriction);
    });
    ...
    it('should have the property singleTransactionLimit (base name: "singleTransactionLimit")', function() {
      // uncomment below and update the code to test the property singleTransactionLimit
      //var instance = new AdyenRecurringApi.PermitRestriction();
      //expect(instance).to.be();
    });
