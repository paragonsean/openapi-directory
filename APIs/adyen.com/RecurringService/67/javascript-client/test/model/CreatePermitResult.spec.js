...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenRecurringApi.CreatePermitResult();
  });
  ...
  describe('CreatePermitResult', function() {
    it('should create an instance of CreatePermitResult', function() {
      // uncomment below and update the code to test CreatePermitResult
      //var instance = new AdyenRecurringApi.CreatePermitResult();
      //expect(instance).to.be.a(AdyenRecurringApi.CreatePermitResult);
    });

    it('should have the property permitResultList (base name: "permitResultList")', function() {
      // uncomment below and update the code to test the property permitResultList
      //var instance = new AdyenRecurringApi.CreatePermitResult();
