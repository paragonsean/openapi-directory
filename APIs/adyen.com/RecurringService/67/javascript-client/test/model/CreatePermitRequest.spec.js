...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenRecurringApi.CreatePermitRequest();
  });
  ...
  describe('CreatePermitRequest', function() {
    it('should create an instance of CreatePermitRequest', function() {
      // uncomment below and update the code to test CreatePermitRequest
      //var instance = new AdyenRecurringApi.CreatePermitRequest();
      //expect(instance).to.be.a(AdyenRecurringApi.CreatePermitRequest);
    });
