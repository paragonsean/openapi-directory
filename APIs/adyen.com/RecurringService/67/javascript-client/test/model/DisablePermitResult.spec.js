...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenRecurringApi.DisablePermitResult();
  });
  ...
  describe('DisablePermitResult', function() {
    it('should create an instance of DisablePermitResult', function() {
      // uncomment below and update the code to test DisablePermitResult
      //var instance = new AdyenRecurringApi.DisablePermitResult();
      //expect(instance).to.be.a(AdyenRecurringApi.DisablePermitResult);
    });
