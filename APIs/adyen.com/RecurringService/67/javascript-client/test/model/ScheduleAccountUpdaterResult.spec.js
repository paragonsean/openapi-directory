...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenRecurringApi.ScheduleAccountUpdaterResult();
  });
  ...
  describe('ScheduleAccountUpdaterResult', function() {
    it('should create an instance of ScheduleAccountUpdaterResult', function() {
      // uncomment below and update the code to test ScheduleAccountUpdaterResult
      //var instance = new AdyenRecurringApi.ScheduleAccountUpdaterResult();
      //expect(instance).to.be.a(AdyenRecurringApi.ScheduleAccountUpdaterResult);
    });
