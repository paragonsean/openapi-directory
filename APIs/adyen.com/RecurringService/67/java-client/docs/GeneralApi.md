...
| [**postDisablePermit**](GeneralApi.md#postDisablePermit) | **POST** /disablePermit | Disable an existing permit. |
...
<a id="postCreatePermit"></a>
# **postCreatePermit**
> CreatePermitResult postCreatePermit(createPermitRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://pal-test.adyen.com/pal/servlet/Recurring/v67");
...
<a id="postDisablePermit"></a>
# **postDisablePermit**
> DisablePermitResult postDisablePermit(disablePermitRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    GeneralApi apiInstance = new GeneralApi(defaultClient);
    DisablePermitRequest disablePermitRequest = new DisablePermitRequest(); // DisablePermitRequest | 
    try {
      DisablePermitResult result = apiInstance.postDisablePermit(disablePermitRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling GeneralApi#postDisablePermit");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **disablePermitRequest** | [**DisablePermitRequest**](DisablePermitRequest.md)|  | [optional] |
