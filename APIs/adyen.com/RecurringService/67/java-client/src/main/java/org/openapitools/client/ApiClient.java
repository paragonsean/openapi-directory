...
public class ApiClient {
    ...
    private String basePath = "https://pal-test.adyen.com/pal/servlet/Recurring/v67";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://pal-test.adyen.com/pal/servlet/Recurring/v67",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/67/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://pal-test.adyen.com/pal/servlet/Recurring/v67
