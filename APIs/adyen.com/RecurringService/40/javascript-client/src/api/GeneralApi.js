...
export default class GeneralApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the postCreatePermit operation.
     * @callback module:api/GeneralApi~postCreatePermitCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreatePermitResult} data The data returned by the service call.
     ...
     * @param {module:model/CreatePermitRequest} [createPermitRequest] 
     * @param {module:api/GeneralApi~postCreatePermitCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreatePermitResult}
     */
    postCreatePermit(opts, callback) {
      opts = opts || {};
      let postBody = opts['createPermitRequest'];
      ...
      let returnType = CreatePermitResult;
