...
Adyen Recurring API
- API version: 40
  - Build date: 2024-10-12T11:13:09.111504-04:00[America/New_York]
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://pal-test.adyen.com/pal/servlet/Recurring/v40");
    ...
    CreatePermitRequest createPermitRequest = new CreatePermitRequest(); // CreatePermitRequest | 
    try {
      CreatePermitResult result = apiInstance.postCreatePermit(createPermitRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling GeneralApi#postCreatePermit");
...
## Documentation for Models
 ...
 - [Card](docs/Card.md)
 - [CreatePermitRequest](docs/CreatePermitRequest.md)
 - [CreatePermitResult](docs/CreatePermitResult.md)
 ...
 - [PermitRestriction](docs/PermitRestriction.md)
 - [PermitResult](docs/PermitResult.md)
