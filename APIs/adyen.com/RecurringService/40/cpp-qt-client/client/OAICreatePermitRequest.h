...
/*
 * OAICreatePermitRequest.h
 *
 * 
 */

#ifndef OAICreatePermitRequest_H
#define OAICreatePermitRequest_H
...
class OAICreatePermitRequest : public OAIObject {
public:
    OAICreatePermitRequest();
    OAICreatePermitRequest(QString json);
    ~OAICreatePermitRequest() override;
    ...
    QList<OAIPermit> getPermits() const;
    void setPermits(const QList<OAIPermit> &permits);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePermitRequest)

#endif // OAICreatePermitRequest_H
