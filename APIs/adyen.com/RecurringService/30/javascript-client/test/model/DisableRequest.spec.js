...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenRecurringApi.DisableRequest();
  });
  ...
  describe('DisableRequest', function() {
    it('should create an instance of DisableRequest', function() {
      ...
      //var instance = new AdyenRecurringApi.DisableRequest();
      //expect(instance).to.be.a(AdyenRecurringApi.DisableRequest);
    });
