...
All URIs are relative to *https://pal-test.adyen.com/pal/servlet/Recurring/v30*
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://pal-test.adyen.com/pal/servlet/Recurring/v30");
