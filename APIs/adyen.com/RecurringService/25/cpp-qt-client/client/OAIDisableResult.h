...
#ifndef OAIDisableResult_H
#define OAIDisableResult_H
...
class OAIDisableResult : public OAIObject {
public:
    OAIDisableResult();
    OAIDisableResult(QString json);
    ~OAIDisableResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisableResult)

#endif // OAIDisableResult_H
