...
void OAIGeneralApi::initializeServerConfigs() {
    ...
    QUrl("https://pal-test.adyen.com/pal/services/TestCard/v1"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("postCreateTestCardRanges", defaultConf);
    _serverIndices.insert("postCreateTestCardRanges", 0);
}
...
void OAIGeneralApi::postCreateTestCardRanges(const ::OpenAPI::OptionalParam<OAICreateTestCardRangesRequest> &oai_create_test_card_ranges_request) {
    QString fullPath = QString(_serverConfigs["postCreateTestCardRanges"][_serverIndices.value("postCreateTestCardRanges")].URL()+"/createTestCardRanges");
    ...
    if (oai_create_test_card_ranges_request.hasValue()){

        
        QByteArray output = oai_create_test_card_ranges_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGeneralApi::postCreateTestCardRangesCallback);
...
void OAIGeneralApi::postCreateTestCardRangesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICreateTestCardRangesResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT postCreateTestCardRangesSignal(output);
        Q_EMIT postCreateTestCardRangesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT postCreateTestCardRangesSignalE(output, error_type, error_str);
        Q_EMIT postCreateTestCardRangesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT postCreateTestCardRangesSignalError(output, error_type, error_str);
        Q_EMIT postCreateTestCardRangesSignalErrorFull(worker, error_type, error_str);
    }
}
