...
public class ApiClient {
    ...
    private String basePath = "https://pal-test.adyen.com/pal/services/TestCard/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://pal-test.adyen.com/pal/services/TestCard/v1
