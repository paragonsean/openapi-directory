...
#include "OAIGetOnboardingUrlResponse.h"
...
OAIGetOnboardingUrlResponse::OAIGetOnboardingUrlResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetOnboardingUrlResponse::OAIGetOnboardingUrlResponse() {
    this->initializeModel();
}

OAIGetOnboardingUrlResponse::~OAIGetOnboardingUrlResponse() {}

void OAIGetOnboardingUrlResponse::initializeModel() {
...
void OAIGetOnboardingUrlResponse::fromJson(QString jsonString) {
...
void OAIGetOnboardingUrlResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetOnboardingUrlResponse::asJson() const {
...
QJsonObject OAIGetOnboardingUrlResponse::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIErrorFieldType> OAIGetOnboardingUrlResponse::getInvalidFields() const {
    return m_invalid_fields;
}
void OAIGetOnboardingUrlResponse::setInvalidFields(const QList<OAIErrorFieldType> &invalid_fields) {
    m_invalid_fields = invalid_fields;
    m_invalid_fields_isSet = true;
}

bool OAIGetOnboardingUrlResponse::is_invalid_fields_Set() const{
    return m_invalid_fields_isSet;
}

bool OAIGetOnboardingUrlResponse::is_invalid_fields_Valid() const{
    return m_invalid_fields_isValid;
}

QString OAIGetOnboardingUrlResponse::getPspReference() const {
    return m_psp_reference;
}
void OAIGetOnboardingUrlResponse::setPspReference(const QString &psp_reference) {
    m_psp_reference = psp_reference;
    m_psp_reference_isSet = true;
}

bool OAIGetOnboardingUrlResponse::is_psp_reference_Set() const{
    return m_psp_reference_isSet;
}

bool OAIGetOnboardingUrlResponse::is_psp_reference_Valid() const{
    return m_psp_reference_isValid;
}

QString OAIGetOnboardingUrlResponse::getRedirectUrl() const {
    return m_redirect_url;
}
void OAIGetOnboardingUrlResponse::setRedirectUrl(const QString &redirect_url) {
    m_redirect_url = redirect_url;
    m_redirect_url_isSet = true;
}

bool OAIGetOnboardingUrlResponse::is_redirect_url_Set() const{
    return m_redirect_url_isSet;
}

bool OAIGetOnboardingUrlResponse::is_redirect_url_Valid() const{
    return m_redirect_url_isValid;
}

QString OAIGetOnboardingUrlResponse::getResultCode() const {
    return m_result_code;
}
void OAIGetOnboardingUrlResponse::setResultCode(const QString &result_code) {
    m_result_code = result_code;
    m_result_code_isSet = true;
}

bool OAIGetOnboardingUrlResponse::is_result_code_Set() const{
    return m_result_code_isSet;
}

bool OAIGetOnboardingUrlResponse::is_result_code_Valid() const{
    return m_result_code_isValid;
}

bool OAIGetOnboardingUrlResponse::isSet() const {
...
bool OAIGetOnboardingUrlResponse::isValid() const {
