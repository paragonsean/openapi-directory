...
/*
 * OAIGetPciUrlRequest.h
 *
 * 
 */

#ifndef OAIGetPciUrlRequest_H
#define OAIGetPciUrlRequest_H
...
class OAIGetPciUrlRequest : public OAIObject {
public:
    OAIGetPciUrlRequest();
    OAIGetPciUrlRequest(QString json);
    ~OAIGetPciUrlRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPciUrlRequest)

#endif // OAIGetPciUrlRequest_H
