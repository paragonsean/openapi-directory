...
QList<OAIErrorFieldTypeWrapper> OAIGetOnboardingUrlResponse::getInvalidFields() const {
    return m_invalid_fields;
}
void OAIGetOnboardingUrlResponse::setInvalidFields(const QList<OAIErrorFieldTypeWrapper> &invalid_fields) {
...
bool OAIGetOnboardingUrlResponse::isSubmittedAsync() const {
    return m_submitted_async;
}
void OAIGetOnboardingUrlResponse::setSubmittedAsync(const bool &submitted_async) {
    m_submitted_async = submitted_async;
    m_submitted_async_isSet = true;
}

bool OAIGetOnboardingUrlResponse::is_submitted_async_Set() const{
    return m_submitted_async_isSet;
}

bool OAIGetOnboardingUrlResponse::is_submitted_async_Valid() const{
