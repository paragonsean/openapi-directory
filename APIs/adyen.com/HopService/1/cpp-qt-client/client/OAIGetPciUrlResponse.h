...
/*
 * OAIGetPciUrlResponse.h
 *
 * 
 */

#ifndef OAIGetPciUrlResponse_H
#define OAIGetPciUrlResponse_H
...
class OAIGetPciUrlResponse : public OAIObject {
public:
    OAIGetPciUrlResponse();
    OAIGetPciUrlResponse(QString json);
    ~OAIGetPciUrlResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPciUrlResponse)

#endif // OAIGetPciUrlResponse_H
