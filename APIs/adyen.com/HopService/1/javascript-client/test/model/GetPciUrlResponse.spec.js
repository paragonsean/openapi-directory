...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HostedOnboardingApi.GetPciUrlResponse();
  });
  ...
  describe('GetPciUrlResponse', function() {
    it('should create an instance of GetPciUrlResponse', function() {
      // uncomment below and update the code to test GetPciUrlResponse
      //var instance = new HostedOnboardingApi.GetPciUrlResponse();
      //expect(instance).to.be.a(HostedOnboardingApi.GetPciUrlResponse);
    });
