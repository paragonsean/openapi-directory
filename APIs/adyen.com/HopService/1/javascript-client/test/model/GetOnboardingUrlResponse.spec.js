...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HostedOnboardingApi.GetOnboardingUrlResponse();
  });
  ...
  describe('GetOnboardingUrlResponse', function() {
    it('should create an instance of GetOnboardingUrlResponse', function() {
      // uncomment below and update the code to test GetOnboardingUrlResponse
      //var instance = new HostedOnboardingApi.GetOnboardingUrlResponse();
      //expect(instance).to.be.a(HostedOnboardingApi.GetOnboardingUrlResponse);
    });
