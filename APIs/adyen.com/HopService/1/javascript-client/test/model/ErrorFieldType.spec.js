...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HostedOnboardingApi.ErrorFieldType();
  });
  ...
  describe('ErrorFieldType', function() {
    it('should create an instance of ErrorFieldType', function() {
      ...
      //var instance = new HostedOnboardingApi.ErrorFieldType();
      //expect(instance).to.be.a(HostedOnboardingApi.ErrorFieldType);
    });
