...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HostedOnboardingApi.HostedOnboardingPageApi();
  });
  ...
  describe('HostedOnboardingPageApi', function() {
    describe('postGetOnboardingUrl', function() {
      it('should call postGetOnboardingUrl successfully', function(done) {
        //uncomment below and update the code to test postGetOnboardingUrl
        //instance.postGetOnboardingUrl(function(error) {
