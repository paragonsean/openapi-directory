...
public class GetOnboardingUrlResponse {
  ...
  public GetOnboardingUrlResponse invalidFields(List<ErrorFieldTypeWrapper> invalidFields) {
    this.invalidFields = invalidFields;
    return this;
  }

  public GetOnboardingUrlResponse addInvalidFieldsItem(ErrorFieldTypeWrapper invalidFieldsItem) {
  ...
  public GetOnboardingUrlResponse submittedAsync(Boolean submittedAsync) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.invalidFields, getOnboardingUrlResponse.invalidFields) &&
        ...
        Objects.equals(this.submittedAsync, getOnboardingUrlResponse.submittedAsync);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invalidFields, pspReference, redirectUrl, resultCode, submittedAsync);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOnboardingUrlResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOnboardingUrlResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOnboardingUrlResponse is not found in the empty JSON string", GetOnboardingUrlResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOnboardingUrlResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOnboardingUrlResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOnboardingUrlResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOnboardingUrlResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOnboardingUrlResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOnboardingUrlResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOnboardingUrlResponse>() {
           @Override
           public void write(JsonWriter out, GetOnboardingUrlResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOnboardingUrlResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOnboardingUrlResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOnboardingUrlResponse
   * @throws IOException if the JSON string is invalid with respect to GetOnboardingUrlResponse
   */
  public static GetOnboardingUrlResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOnboardingUrlResponse.class);
  }

  /**
   * Convert an instance of GetOnboardingUrlResponse to an JSON string
   *
   * @return JSON string
   */
