...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HostedOnboardingApi.PCIComplianceQuestionnairePageApi();
  });
  ...
  describe('PCIComplianceQuestionnairePageApi', function() {
    describe('postGetPciQuestionnaireUrl', function() {
      it('should call postGetPciQuestionnaireUrl successfully', function(done) {
        //uncomment below and update the code to test postGetPciQuestionnaireUrl
        //instance.postGetPciQuestionnaireUrl(function(error) {
