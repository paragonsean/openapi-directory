...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HostedOnboardingApi.ServiceError();
  });
  ...
  describe('ServiceError', function() {
    it('should create an instance of ServiceError', function() {
      ...
      //var instance = new HostedOnboardingApi.ServiceError();
      //expect(instance).to.be.a(HostedOnboardingApi.ServiceError);
    });
