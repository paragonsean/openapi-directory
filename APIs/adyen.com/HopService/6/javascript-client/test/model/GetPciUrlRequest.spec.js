...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HostedOnboardingApi.GetPciUrlRequest();
  });
  ...
  describe('GetPciUrlRequest', function() {
    it('should create an instance of GetPciUrlRequest', function() {
      // uncomment below and update the code to test GetPciUrlRequest
      //var instance = new HostedOnboardingApi.GetPciUrlRequest();
      //expect(instance).to.be.a(HostedOnboardingApi.GetPciUrlRequest);
    });
