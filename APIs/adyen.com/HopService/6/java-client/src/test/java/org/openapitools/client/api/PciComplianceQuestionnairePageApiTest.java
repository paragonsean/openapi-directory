...
/**
 * API tests for PciComplianceQuestionnairePageApi
 */
@Disabled
public class PciComplianceQuestionnairePageApiTest {

    private final PciComplianceQuestionnairePageApi api = new PciComplianceQuestionnairePageApi();
     ...
     */
    @Test
    public void postGetPciQuestionnaireUrlTest() throws ApiException {
        GetPciUrlRequest getPciUrlRequest = null;
        GetPciUrlResponse response = api.postGetPciQuestionnaireUrl(getPciUrlRequest);
