...
QList<OAIErrorFieldType> OAIGetPciUrlResponse::getInvalidFields() const {
    return m_invalid_fields;
}
void OAIGetPciUrlResponse::setInvalidFields(const QList<OAIErrorFieldType> &invalid_fields) {
