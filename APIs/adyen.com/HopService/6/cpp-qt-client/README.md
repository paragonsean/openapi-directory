...
#include <iostream>
#include "../client/OAIHostedOnboardingPageApi.h"

using namespace test_namespace;

class Example : public QObject {
    Q_OBJECT
    OAIGetOnboardingUrlRequest create();
public Q_SLOTS:
...
OAIGetOnboardingUrlRequest Example::create(){
    OAIGetOnboardingUrlRequest obj;
 return obj;
}

void Example::exampleFunction1(){
     OAIHostedOnboardingPageApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIHostedOnboardingPageApi::postGetOnboardingUrlSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIHostedOnboardingPageApi::postGetOnboardingUrlSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIGetOnboardingUrlRequest oai_get_onboarding_url_request = create(); // OAIGetOnboardingUrlRequest | 
      apiInstance.postGetOnboardingUrl(oai_get_onboarding_url_request);
