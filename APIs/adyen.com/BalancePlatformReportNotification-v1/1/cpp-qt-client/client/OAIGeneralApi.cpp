...
void OAIGeneralApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("postBalancePlatform_report_created", defaultConf);
    _serverIndices.insert("postBalancePlatform_report_created", 0);
}
...
void OAIGeneralApi::postBalancePlatform_report_created(const ::OpenAPI::OptionalParam<OAIReportNotificationRequest> &oai_report_notification_request) {
    QString fullPath = QString(_serverConfigs["postBalancePlatform_report_created"][_serverIndices.value("postBalancePlatform_report_created")].URL()+"/balancePlatform.report.created");
    ...
    if (oai_report_notification_request.hasValue()){

        
        QByteArray output = oai_report_notification_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGeneralApi::postBalancePlatform_report_createdCallback);
...
void OAIGeneralApi::postBalancePlatform_report_createdCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT postBalancePlatform_report_createdSignal(output);
        Q_EMIT postBalancePlatform_report_createdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT postBalancePlatform_report_createdSignalE(output, error_type, error_str);
        Q_EMIT postBalancePlatform_report_createdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT postBalancePlatform_report_createdSignalError(output, error_type, error_str);
        Q_EMIT postBalancePlatform_report_createdSignalErrorFull(worker, error_type, error_str);
    }
}
