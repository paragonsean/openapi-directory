...
async def test_post_account_holder_balance(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v6/accountHolderBalance',
        headers=headers,
        json=body,
        )
...
async def test_post_account_holder_transaction_list(client):
    ...
    """
    body = {"transactionListsPerAccount":[{"accountCode":"accountCode","page":0},{"accountCode":"accountCode","page":0}],"accountHolderCode":"accountHolderCode","transactionStatuses":["BalanceNotPaidOutTransfer","BalanceNotPaidOutTransfer"]}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'Authorization': 'BasicZm9vOmJhcg==',
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v6/accountHolderTransactionList',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_debit_account_holder(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v6/debitAccountHolder',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_payout_account_holder(client):
    ...
    """
    body = {"accountCode":"accountCode","accountHolderCode":"accountHolderCode","amount":{"currency":"currency","value":0},"bankAccountUUID":"bankAccountUUID","payoutMethodCode":"payoutMethodCode","description":"description","merchantReference":"merchantReference","payoutSpeed":"STANDARD"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'Authorization': 'BasicZm9vOmJhcg==',
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v6/payoutAccountHolder',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_refund_funds_transfer(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v6/refundFundsTransfer',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_refund_not_paid_out_transfers(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v6/refundNotPaidOutTransfers',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_setup_beneficiary(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v6/setupBeneficiary',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_transfer_funds(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v6/transferFunds',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
