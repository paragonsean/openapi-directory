...
class BankAccountDetail {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('bankAccountReference')) {
                obj['bankAccountReference'] = ApiClient.convertToType(data['bankAccountReference'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['bankAccountReference'] && !(typeof data['bankAccountReference'] === 'string' || data['bankAccountReference'] instanceof String)) {
            throw new Error("Expected the field `bankAccountReference` to be a primitive type in the JSON string but got " + data['bankAccountReference']);
        }
        // ensure the json data is a string
 ...
 * @member {String} bankAccountReference
 */
BankAccountDetail.prototype['bankAccountReference'] = undefined;
