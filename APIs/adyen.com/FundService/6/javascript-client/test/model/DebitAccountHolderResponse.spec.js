...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.DebitAccountHolderResponse();
  });
  ...
  describe('DebitAccountHolderResponse', function() {
    it('should create an instance of DebitAccountHolderResponse', function() {
      // uncomment below and update the code to test DebitAccountHolderResponse
      //var instance = new FundApi.DebitAccountHolderResponse();
      //expect(instance).to.be.a(FundApi.DebitAccountHolderResponse);
    });
    ...
    it('should have the property merchantReferences (base name: "merchantReferences")', function() {
      // uncomment below and update the code to test the property merchantReferences
      //var instance = new FundApi.DebitAccountHolderResponse();
      //expect(instance).to.be();
    });
