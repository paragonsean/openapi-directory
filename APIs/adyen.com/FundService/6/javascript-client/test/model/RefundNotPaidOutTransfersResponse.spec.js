...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.RefundNotPaidOutTransfersResponse();
  });
  ...
  describe('RefundNotPaidOutTransfersResponse', function() {
    it('should create an instance of RefundNotPaidOutTransfersResponse', function() {
      // uncomment below and update the code to test RefundNotPaidOutTransfersResponse
      //var instance = new FundApi.RefundNotPaidOutTransfersResponse();
      //expect(instance).to.be.a(FundApi.RefundNotPaidOutTransfersResponse);
    });
