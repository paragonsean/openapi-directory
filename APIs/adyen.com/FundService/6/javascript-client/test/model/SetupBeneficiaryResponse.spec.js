...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.SetupBeneficiaryResponse();
  });
  ...
  describe('SetupBeneficiaryResponse', function() {
    it('should create an instance of SetupBeneficiaryResponse', function() {
      // uncomment below and update the code to test SetupBeneficiaryResponse
      //var instance = new FundApi.SetupBeneficiaryResponse();
      //expect(instance).to.be.a(FundApi.SetupBeneficiaryResponse);
    });
