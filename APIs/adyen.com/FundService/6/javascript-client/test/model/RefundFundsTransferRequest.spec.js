...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.RefundFundsTransferRequest();
  });
  ...
  describe('RefundFundsTransferRequest', function() {
    it('should create an instance of RefundFundsTransferRequest', function() {
      // uncomment below and update the code to test RefundFundsTransferRequest
      //var instance = new FundApi.RefundFundsTransferRequest();
      //expect(instance).to.be.a(FundApi.RefundFundsTransferRequest);
    });
