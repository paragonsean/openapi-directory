...
QList<OAIErrorFieldType> OAITransferFundsResponse::getInvalidFields() const {
    return m_invalid_fields;
}
void OAITransferFundsResponse::setInvalidFields(const QList<OAIErrorFieldType> &invalid_fields) {
    m_invalid_fields = invalid_fields;
    m_invalid_fields_isSet = true;
}

bool OAITransferFundsResponse::is_invalid_fields_Set() const{
    return m_invalid_fields_isSet;
}

bool OAITransferFundsResponse::is_invalid_fields_Valid() const{
