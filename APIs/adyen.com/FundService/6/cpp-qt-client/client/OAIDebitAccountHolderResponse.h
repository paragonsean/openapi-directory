...
/*
 * OAIDebitAccountHolderResponse.h
 *
 * 
 */

#ifndef OAIDebitAccountHolderResponse_H
#define OAIDebitAccountHolderResponse_H
...
class OAIDebitAccountHolderResponse : public OAIObject {
public:
    OAIDebitAccountHolderResponse();
    OAIDebitAccountHolderResponse(QString json);
    ~OAIDebitAccountHolderResponse() override;
    ...
    QList<QString> getMerchantReferences() const;
    void setMerchantReferences(const QList<QString> &merchant_references);
    bool is_merchant_references_Set() const;
    bool is_merchant_references_Valid() const;
...
private:
    ...
    QList<QString> m_merchant_references;
    bool m_merchant_references_isSet;
    bool m_merchant_references_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDebitAccountHolderResponse)

#endif // OAIDebitAccountHolderResponse_H
