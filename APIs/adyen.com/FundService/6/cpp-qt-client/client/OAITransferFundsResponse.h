...
/*
 * OAITransferFundsResponse.h
 *
 * 
 */

#ifndef OAITransferFundsResponse_H
#define OAITransferFundsResponse_H
...
class OAITransferFundsResponse : public OAIObject {
public:
    OAITransferFundsResponse();
    OAITransferFundsResponse(QString json);
    ~OAITransferFundsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferFundsResponse)

#endif // OAITransferFundsResponse_H
