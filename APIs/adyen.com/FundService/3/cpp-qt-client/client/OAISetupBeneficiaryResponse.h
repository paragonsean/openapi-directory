...
/*
 * OAISetupBeneficiaryResponse.h
 *
 * 
 */

#ifndef OAISetupBeneficiaryResponse_H
#define OAISetupBeneficiaryResponse_H
...
class OAISetupBeneficiaryResponse : public OAIObject {
public:
    OAISetupBeneficiaryResponse();
    OAISetupBeneficiaryResponse(QString json);
    ~OAISetupBeneficiaryResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetupBeneficiaryResponse)

#endif // OAISetupBeneficiaryResponse_H
