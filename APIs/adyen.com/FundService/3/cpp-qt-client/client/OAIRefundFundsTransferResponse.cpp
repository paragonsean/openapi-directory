...
bool OAIRefundFundsTransferResponse::isSubmittedAsync() const {
    return m_submitted_async;
}
void OAIRefundFundsTransferResponse::setSubmittedAsync(const bool &submitted_async) {
    m_submitted_async = submitted_async;
    m_submitted_async_isSet = true;
}

bool OAIRefundFundsTransferResponse::is_submitted_async_Set() const{
    return m_submitted_async_isSet;
}

bool OAIRefundFundsTransferResponse::is_submitted_async_Valid() const{
