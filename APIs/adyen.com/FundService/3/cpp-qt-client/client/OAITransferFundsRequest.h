...
/*
 * OAITransferFundsRequest.h
 *
 * 
 */

#ifndef OAITransferFundsRequest_H
#define OAITransferFundsRequest_H
...
class OAITransferFundsRequest : public OAIObject {
public:
    OAITransferFundsRequest();
    OAITransferFundsRequest(QString json);
    ~OAITransferFundsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferFundsRequest)

#endif // OAITransferFundsRequest_H
