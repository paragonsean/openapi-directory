...
QList<OAIAccountDetailBalanceWrapper> OAIAccountHolderBalanceResponse::getBalancePerAccount() const {
    return m_balance_per_account;
}
void OAIAccountHolderBalanceResponse::setBalancePerAccount(const QList<OAIAccountDetailBalanceWrapper> &balance_per_account) {
...
bool OAIAccountHolderBalanceResponse::isSubmittedAsync() const {
    return m_submitted_async;
}
void OAIAccountHolderBalanceResponse::setSubmittedAsync(const bool &submitted_async) {
    m_submitted_async = submitted_async;
    m_submitted_async_isSet = true;
}

bool OAIAccountHolderBalanceResponse::is_submitted_async_Set() const{
    return m_submitted_async_isSet;
}

bool OAIAccountHolderBalanceResponse::is_submitted_async_Valid() const{
