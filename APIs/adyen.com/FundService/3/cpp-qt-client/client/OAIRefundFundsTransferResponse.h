...
/*
 * OAIRefundFundsTransferResponse.h
 *
 * 
 */

#ifndef OAIRefundFundsTransferResponse_H
#define OAIRefundFundsTransferResponse_H
...
class OAIRefundFundsTransferResponse : public OAIObject {
public:
    OAIRefundFundsTransferResponse();
    OAIRefundFundsTransferResponse(QString json);
    ~OAIRefundFundsTransferResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefundFundsTransferResponse)

#endif // OAIRefundFundsTransferResponse_H
