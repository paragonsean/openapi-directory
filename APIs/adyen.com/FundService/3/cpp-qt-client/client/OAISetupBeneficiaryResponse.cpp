...
bool OAISetupBeneficiaryResponse::isSubmittedAsync() const {
    return m_submitted_async;
}
void OAISetupBeneficiaryResponse::setSubmittedAsync(const bool &submitted_async) {
    m_submitted_async = submitted_async;
    m_submitted_async_isSet = true;
}

bool OAISetupBeneficiaryResponse::is_submitted_async_Set() const{
    return m_submitted_async_isSet;
}

bool OAISetupBeneficiaryResponse::is_submitted_async_Valid() const{
