...
/*
 * OAITransactionWrapper.h
 *
 * 
 */

#ifndef OAITransactionWrapper_H
#define OAITransactionWrapper_H
...
class OAITransactionWrapper : public OAIObject {
public:
    OAITransactionWrapper();
    OAITransactionWrapper(QString json);
    ~OAITransactionWrapper() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactionWrapper)

#endif // OAITransactionWrapper_H
