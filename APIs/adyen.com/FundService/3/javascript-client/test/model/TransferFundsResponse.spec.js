...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.TransferFundsResponse();
  });
  ...
  describe('TransferFundsResponse', function() {
    it('should create an instance of TransferFundsResponse', function() {
      // uncomment below and update the code to test TransferFundsResponse
      //var instance = new FundApi.TransferFundsResponse();
      //expect(instance).to.be.a(FundApi.TransferFundsResponse);
    });
