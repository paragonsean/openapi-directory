...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.TransferFundsRequest();
  });
  ...
  describe('TransferFundsRequest', function() {
    it('should create an instance of TransferFundsRequest', function() {
      // uncomment below and update the code to test TransferFundsRequest
      //var instance = new FundApi.TransferFundsRequest();
      //expect(instance).to.be.a(FundApi.TransferFundsRequest);
    });
