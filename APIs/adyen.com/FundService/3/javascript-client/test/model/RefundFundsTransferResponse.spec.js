...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.RefundFundsTransferResponse();
  });
  ...
  describe('RefundFundsTransferResponse', function() {
    it('should create an instance of RefundFundsTransferResponse', function() {
      // uncomment below and update the code to test RefundFundsTransferResponse
      //var instance = new FundApi.RefundFundsTransferResponse();
      //expect(instance).to.be.a(FundApi.RefundFundsTransferResponse);
    });
