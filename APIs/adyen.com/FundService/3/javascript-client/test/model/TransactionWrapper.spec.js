...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.TransactionWrapper();
  });
  ...
  describe('TransactionWrapper', function() {
    it('should create an instance of TransactionWrapper', function() {
      // uncomment below and update the code to test TransactionWrapper
      //var instance = new FundApi.TransactionWrapper();
      //expect(instance).to.be.a(FundApi.TransactionWrapper);
    });
