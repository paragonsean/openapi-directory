...
import TransactionListForAccountWrapper from './TransactionListForAccountWrapper';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('transactionListsPerAccount')) {
                obj['transactionListsPerAccount'] = ApiClient.convertToType(data['transactionListsPerAccount'], [TransactionListForAccountWrapper]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['transactionListsPerAccount']) { // data not null
            ...
            for (const item of data['transactionListsPerAccount']) {
                TransactionListForAccountWrapper.validateJSON(item);
            };
        }
        // ensure the json data is an array
 ...
 * @member {Array.<module:model/TransactionListForAccountWrapper>} transactionListsPerAccount
 */
