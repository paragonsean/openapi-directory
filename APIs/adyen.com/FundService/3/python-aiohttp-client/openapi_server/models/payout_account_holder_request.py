...
class PayoutAccountHolderRequest(Model):
    ...
    def __init__(self, account_code: str=None, account_holder_code: str=None, amount: Amount=None, bank_account_uuid: str=None, description: str=None, merchant_reference: str=None):
