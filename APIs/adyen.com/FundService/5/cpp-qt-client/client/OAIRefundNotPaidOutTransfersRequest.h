...
/*
 * OAIRefundNotPaidOutTransfersRequest.h
 *
 * 
 */

#ifndef OAIRefundNotPaidOutTransfersRequest_H
#define OAIRefundNotPaidOutTransfersRequest_H
...
class OAIRefundNotPaidOutTransfersRequest : public OAIObject {
public:
    OAIRefundNotPaidOutTransfersRequest();
    OAIRefundNotPaidOutTransfersRequest(QString json);
    ~OAIRefundNotPaidOutTransfersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefundNotPaidOutTransfersRequest)

#endif // OAIRefundNotPaidOutTransfersRequest_H
