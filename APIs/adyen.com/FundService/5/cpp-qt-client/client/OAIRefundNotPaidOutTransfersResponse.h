...
/*
 * OAIRefundNotPaidOutTransfersResponse.h
 *
 * 
 */

#ifndef OAIRefundNotPaidOutTransfersResponse_H
#define OAIRefundNotPaidOutTransfersResponse_H
...
class OAIRefundNotPaidOutTransfersResponse : public OAIObject {
public:
    OAIRefundNotPaidOutTransfersResponse();
    OAIRefundNotPaidOutTransfersResponse(QString json);
    ~OAIRefundNotPaidOutTransfersResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefundNotPaidOutTransfersResponse)

#endif // OAIRefundNotPaidOutTransfersResponse_H
