...
/*
 * OAIPayoutAccountHolderRequest.h
 *
 * 
 */

#ifndef OAIPayoutAccountHolderRequest_H
#define OAIPayoutAccountHolderRequest_H
...
class OAIPayoutAccountHolderRequest : public OAIObject {
public:
    OAIPayoutAccountHolderRequest();
    OAIPayoutAccountHolderRequest(QString json);
    ~OAIPayoutAccountHolderRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayoutAccountHolderRequest)

#endif // OAIPayoutAccountHolderRequest_H
