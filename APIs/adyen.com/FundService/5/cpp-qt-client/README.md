...
class Example : public QObject {
    Q_OBJECT
    OAIAccountHolderBalanceRequest create();
public Q_SLOTS:
...
OAIAccountHolderBalanceRequest Example::create(){
    OAIAccountHolderBalanceRequest obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIGeneralApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIGeneralApi::postAccountHolderBalanceSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIGeneralApi::postAccountHolderBalanceSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIAccountHolderBalanceRequest oai_account_holder_balance_request = create(); // OAIAccountHolderBalanceRequest | 
      apiInstance.postAccountHolderBalance(oai_account_holder_balance_request);
