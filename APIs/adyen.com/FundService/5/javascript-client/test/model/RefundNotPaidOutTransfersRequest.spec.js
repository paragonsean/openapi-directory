...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.RefundNotPaidOutTransfersRequest();
  });
  ...
  describe('RefundNotPaidOutTransfersRequest', function() {
    it('should create an instance of RefundNotPaidOutTransfersRequest', function() {
      // uncomment below and update the code to test RefundNotPaidOutTransfersRequest
      //var instance = new FundApi.RefundNotPaidOutTransfersRequest();
      //expect(instance).to.be.a(FundApi.RefundNotPaidOutTransfersRequest);
    });
