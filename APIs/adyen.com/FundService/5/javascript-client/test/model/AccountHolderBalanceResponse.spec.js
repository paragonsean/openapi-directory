...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.AccountHolderBalanceResponse();
  });
  ...
  describe('AccountHolderBalanceResponse', function() {
    it('should create an instance of AccountHolderBalanceResponse', function() {
      // uncomment below and update the code to test AccountHolderBalanceResponse
      //var instance = new FundApi.AccountHolderBalanceResponse();
      //expect(instance).to.be.a(FundApi.AccountHolderBalanceResponse);
    });

    it('should have the property balancePerAccount (base name: "balancePerAccount")', function() {
      // uncomment below and update the code to test the property balancePerAccount
      //var instance = new FundApi.AccountHolderBalanceResponse();
