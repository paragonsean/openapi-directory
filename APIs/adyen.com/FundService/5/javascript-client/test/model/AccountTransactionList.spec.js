...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.AccountTransactionList();
  });
  ...
  describe('AccountTransactionList', function() {
    it('should create an instance of AccountTransactionList', function() {
      // uncomment below and update the code to test AccountTransactionList
      //var instance = new FundApi.AccountTransactionList();
      //expect(instance).to.be.a(FundApi.AccountTransactionList);
    });
