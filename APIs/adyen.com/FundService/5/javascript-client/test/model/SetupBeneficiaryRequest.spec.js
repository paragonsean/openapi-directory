...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.SetupBeneficiaryRequest();
  });
  ...
  describe('SetupBeneficiaryRequest', function() {
    it('should create an instance of SetupBeneficiaryRequest', function() {
      // uncomment below and update the code to test SetupBeneficiaryRequest
      //var instance = new FundApi.SetupBeneficiaryRequest();
      //expect(instance).to.be.a(FundApi.SetupBeneficiaryRequest);
    });
