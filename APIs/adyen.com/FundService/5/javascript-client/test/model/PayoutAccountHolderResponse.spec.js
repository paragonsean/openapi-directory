...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.PayoutAccountHolderResponse();
  });
  ...
  describe('PayoutAccountHolderResponse', function() {
    it('should create an instance of PayoutAccountHolderResponse', function() {
      // uncomment below and update the code to test PayoutAccountHolderResponse
      //var instance = new FundApi.PayoutAccountHolderResponse();
      //expect(instance).to.be.a(FundApi.PayoutAccountHolderResponse);
    });
