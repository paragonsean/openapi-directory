...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FundApi.PayoutAccountHolderRequest();
  });
  ...
  describe('PayoutAccountHolderRequest', function() {
    it('should create an instance of PayoutAccountHolderRequest', function() {
      // uncomment below and update the code to test PayoutAccountHolderRequest
      //var instance = new FundApi.PayoutAccountHolderRequest();
      //expect(instance).to.be.a(FundApi.PayoutAccountHolderRequest);
    });
