...
/**
 * The TransferFundsResponse model module.
 * @module model/TransferFundsResponse
 * @version 5
 */
class TransferFundsResponse {
    /**
     * Constructs a new <code>TransferFundsResponse</code>.
     * @alias module:model/TransferFundsResponse
     */
    constructor() { 
        
        TransferFundsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TransferFundsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransferFundsResponse} obj Optional instance to populate.
     * @return {module:model/TransferFundsResponse} The populated <code>TransferFundsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransferFundsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>TransferFundsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransferFundsResponse</code>.
     */
 ...
 */
TransferFundsResponse.prototype['invalidFields'] = undefined;
 ...
 */
TransferFundsResponse.prototype['merchantReference'] = undefined;

/**
 * The reference of a request. Can be used to uniquely identify the request.
 * @member {String} pspReference
 */
TransferFundsResponse.prototype['pspReference'] = undefined;

/**
 * The result code.
 * @member {String} resultCode
 */
TransferFundsResponse.prototype['resultCode'] = undefined;
...
export default TransferFundsResponse;
