    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('balancePerAccount')) {
                obj['balancePerAccount'] = ApiClient.convertToType(data['balancePerAccount'], [AccountDetailBalance]);
            }
    ...
    static validateJSON(data) {
        if (data['balancePerAccount']) { // data not null
            ...
            for (const item of data['balancePerAccount']) {
                AccountDetailBalance.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/AccountDetailBalance>} balancePerAccount
 */
 ...
 */
AccountHolderBalanceResponse.prototype['invalidFields'] = undefined;
