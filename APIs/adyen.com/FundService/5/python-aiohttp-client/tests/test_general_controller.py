...
async def test_post_account_holder_balance(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v5/accountHolderBalance',
        headers=headers,
        json=body,
        )
...
async def test_post_account_holder_transaction_list(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v5/accountHolderTransactionList',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_debit_account_holder(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v5/debitAccountHolder',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_payout_account_holder(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v5/payoutAccountHolder',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_refund_funds_transfer(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v5/refundFundsTransfer',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_refund_not_paid_out_transfers(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v5/refundNotPaidOutTransfers',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_setup_beneficiary(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v5/setupBeneficiary',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_transfer_funds(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Fund/v5/transferFunds',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
