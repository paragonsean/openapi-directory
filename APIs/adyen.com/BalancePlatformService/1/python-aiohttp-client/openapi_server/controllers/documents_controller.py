...
async def get_documents_id(request: web.Request, id) -> web.Response:
    """Get a document
...
async def patch_documents_id(request: web.Request, id, body=None) -> web.Response:
    """Update a document
...
async def post_documents(request: web.Request, body=None) -> web.Response:
