...
class LegalEntityCapability(Model):
    ...
    def __init__(self, allowed: bool=None, allowed_level: str=None, allowed_settings: CapabilitySettings=None, problems: List[object]=None, requested: bool=None, requested_level: str=None, requested_settings: CapabilitySettings=None, transfer_instruments: List[SupportingEntityCapability]=None, verification_status: str=None):
        ...
        :param transfer_instruments: The transfer_instruments of this LegalEntityCapability.
        ...
        self.openapi_types = {
            ...
            'transfer_instruments': List[SupportingEntityCapability],
    ...
    def transfer_instruments(self):
        """Gets the transfer_instruments of this LegalEntityCapability.

        Capability status for transfer instruments associated with legal entity

        :return: The transfer_instruments of this LegalEntityCapability.
        :rtype: List[SupportingEntityCapability]
        """
        return self._transfer_instruments

    @transfer_instruments.setter
    def transfer_instruments(self, transfer_instruments):
        """Sets the transfer_instruments of this LegalEntityCapability.

        Capability status for transfer instruments associated with legal entity

        :param transfer_instruments: The transfer_instruments of this LegalEntityCapability.
        :type transfer_instruments: List[SupportingEntityCapability]
        """
