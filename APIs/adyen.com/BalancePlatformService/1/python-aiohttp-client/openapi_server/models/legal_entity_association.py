...
class LegalEntityAssociation(Model):
    ...
    def __init__(self, associator_id: str=None, entity_type: str=None, job_title: str=None, legal_entity_id: str=None, name: str=None, type: str=None):
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["signatory", "uboThroughControl", "uboThroughOwnership"]  # noqa: E501
