...
class Individual(Model):
    ...
    def __init__(self, birth_data: BirthData=None, email: str=None, identification_data: IdentificationData=None, name: Name3=None, nationality: str=None, phone: PhoneNumber2=None, residential_address: Address3=None, web_data: WebData=None):
    ...
    def residential_address(self, residential_address):
        ...
        :param residential_address: The residential_address of this Individual.
        :type residential_address: Address3
        """
