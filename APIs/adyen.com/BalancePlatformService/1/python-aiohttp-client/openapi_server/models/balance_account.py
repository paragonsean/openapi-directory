...
class BalanceAccount(Model):
    ...
    def __init__(self, account_holder_id: str=None, balances: List[Balance]=None, default_currency_code: str=None, description: str=None, id: str=None, payment_instruments: List[PaymentInstrumentReference]=None, reference: str=None, status: str=None, sweep_configurations: Dict[str, SweepConfiguration]=None, time_zone: str=None):
        ...
        :param sweep_configurations: The sweep_configurations of this BalanceAccount.
    ...
    def sweep_configurations(self):
        """Gets the sweep_configurations of this BalanceAccount.
        ...
        :return: The sweep_configurations of this BalanceAccount.
    ...
    def sweep_configurations(self, sweep_configurations):
        """Sets the sweep_configurations of this BalanceAccount.
