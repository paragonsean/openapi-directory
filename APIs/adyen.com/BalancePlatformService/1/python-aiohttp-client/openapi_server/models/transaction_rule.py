...
class TransactionRule(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, amount: Amount=None, balance_platform_id: str=None, countries: List[str]=None, description: str=None, end_date: str=None, entry_modes: List[str]=None, id: str=None, interval: TransactionRuleInterval=None, max_transactions: int=None, mccs: List[str]=None, payment_instrument_group_id: str=None, payment_instrument_id: str=None, processing_types: List[str]=None, reference: str=None, start_date: str=None, status: str=None, type: str=None):
        """TransactionRule - a model defined in OpenAPI

        :param amount: The amount of this TransactionRule.
        :param balance_platform_id: The balance_platform_id of this TransactionRule.
        :param countries: The countries of this TransactionRule.
        :param description: The description of this TransactionRule.
        :param end_date: The end_date of this TransactionRule.
        :param entry_modes: The entry_modes of this TransactionRule.
        :param id: The id of this TransactionRule.
        :param interval: The interval of this TransactionRule.
        :param max_transactions: The max_transactions of this TransactionRule.
        :param mccs: The mccs of this TransactionRule.
        :param payment_instrument_group_id: The payment_instrument_group_id of this TransactionRule.
        :param payment_instrument_id: The payment_instrument_id of this TransactionRule.
        :param processing_types: The processing_types of this TransactionRule.
        :param reference: The reference of this TransactionRule.
        :param start_date: The start_date of this TransactionRule.
        :param status: The status of this TransactionRule.
        :param type: The type of this TransactionRule.
        """
        self.openapi_types = {
            'amount': Amount,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransactionRule':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransactionRule of this TransactionRule.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def amount(self):
        """Gets the amount of this TransactionRule.

        The maximum amount that a payment instrument can be used for in the period specified in the `interval.type`.

        :return: The amount of this TransactionRule.
        :rtype: Amount
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this TransactionRule.
    ...
    def balance_platform_id(self):
        """Gets the balance_platform_id of this TransactionRule.
        ...
        :return: The balance_platform_id of this TransactionRule.
        :rtype: str
        """
    ...
    def balance_platform_id(self, balance_platform_id):
        """Sets the balance_platform_id of this TransactionRule.
    ...
    @property
    def countries(self):
        """Gets the countries of this TransactionRule.

        List of countries to which the rule applies. For example: **[\"NL\",\"US\"]**.

        :return: The countries of this TransactionRule.
        :rtype: List[str]
        """
    ...
    def countries(self, countries):
        """Sets the countries of this TransactionRule.
    ...
    def description(self):
        """Gets the description of this TransactionRule.

        Your description for the transaction rule, maximum 300 characters.

        :return: The description of this TransactionRule.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this TransactionRule.
    ...
    @property
    def end_date(self):
        """Gets the end_date of this TransactionRule.
        ...
        :return: The end_date of this TransactionRule.
        :rtype: str
        """
    ...
    def end_date(self, end_date):
        """Sets the end_date of this TransactionRule.
    ...
    def entry_modes(self):
        """Gets the entry_modes of this TransactionRule.
        ...
        :return: The entry_modes of this TransactionRule.
        :rtype: List[str]
        """
    ...
    def entry_modes(self, entry_modes):
        """Sets the entry_modes of this TransactionRule.
    ...
    @property
    def id(self):
        """Gets the id of this TransactionRule.

        The unique identifier of the transaction rule.

        :return: The id of this TransactionRule.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TransactionRule.
    ...
    def interval(self, interval):
        """Sets the interval of this TransactionRule.
    ...
    def max_transactions(self):
        """Gets the max_transactions of this TransactionRule.
        ...
        :return: The max_transactions of this TransactionRule.
        :rtype: int
        """
    ...
    def max_transactions(self, max_transactions):
        """Sets the max_transactions of this TransactionRule.
    ...
    @property
    def mccs(self):
        """Gets the mccs of this TransactionRule.

        List of Merchant Category Codes (MCCs) to which the rule applies.

        :return: The mccs of this TransactionRule.
        :rtype: List[str]
        """
        return self._mccs
    ...
    @mccs.setter
    def mccs(self, mccs):
        """Sets the mccs of this TransactionRule.
    ...
    def payment_instrument_group_id(self):
        """Gets the payment_instrument_group_id of this TransactionRule.
        ...
        :return: The payment_instrument_group_id of this TransactionRule.
        :rtype: str
        """
    ...
    def payment_instrument_group_id(self, payment_instrument_group_id):
        """Sets the payment_instrument_group_id of this TransactionRule.
    ...
    def payment_instrument_id(self):
        """Gets the payment_instrument_id of this TransactionRule.
        ...
        :return: The payment_instrument_id of this TransactionRule.
        :rtype: str
        """
    ...
    def payment_instrument_id(self, payment_instrument_id):
        """Sets the payment_instrument_id of this TransactionRule.
    ...
    def processing_types(self):
        """Gets the processing_types of this TransactionRule.
        ...
        :return: The processing_types of this TransactionRule.
        :rtype: List[str]
        """
    ...
    def processing_types(self, processing_types):
        """Sets the processing_types of this TransactionRule.
    ...
    @property
    def reference(self):
        """Gets the reference of this TransactionRule.

        Your reference for the transaction rule, maximum 150 characters.

        :return: The reference of this TransactionRule.
        :rtype: str
        """
    ...
    def reference(self, reference):
        """Sets the reference of this TransactionRule.
    ...
    @property
    def start_date(self):
        """Gets the start_date of this TransactionRule.
        ...
        :return: The start_date of this TransactionRule.
        :rtype: str
        """
    ...
    def start_date(self, start_date):
        """Sets the start_date of this TransactionRule.
    ...
    @property
    def status(self):
        """Gets the status of this TransactionRule.
        ...
        :return: The status of this TransactionRule.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this TransactionRule.
    ...
    @property
    def type(self):
        """Gets the type of this TransactionRule.
        ...
        :return: The type of this TransactionRule.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TransactionRule.
