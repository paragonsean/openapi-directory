...
class AccountHolderCapability(Model):
    ...
    def __init__(self, allowed: bool=None, allowed_level: str=None, allowed_settings: JSONObject=None, enabled: bool=None, problems: List[object]=None, requested: bool=None, requested_level: str=None, requested_settings: JSONObject=None, transfer_instruments: List[AccountSupportingEntityCapability]=None, verification_status: str=None):
    ...
    def allowed_settings(self, allowed_settings):
        ...
        :param allowed_settings: The allowed_settings of this AccountHolderCapability.
        :type allowed_settings: JSONObject
        """
    ...
    def requested_settings(self, requested_settings):
        ...
        :param requested_settings: The requested_settings of this AccountHolderCapability.
        :type requested_settings: JSONObject
        """
