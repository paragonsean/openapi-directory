...
class RestServiceError(Model):
    ...
    def __init__(self, detail: str=None, error_code: str=None, instance: str=None, invalid_fields: List[InvalidField]=None, request_id: str=None, response: JSONObject=None, status: int=None, title: str=None, type: str=None):
