...
class VerificationErrorRecursive(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, capabilities: List[str]=None, code: str=None, message: str=None, remediating_actions: List[RemediatingAction]=None, type: str=None):
        """VerificationErrorRecursive - a model defined in OpenAPI

        :param capabilities: The capabilities of this VerificationErrorRecursive.
        :param code: The code of this VerificationErrorRecursive.
        :param message: The message of this VerificationErrorRecursive.
        :param remediating_actions: The remediating_actions of this VerificationErrorRecursive.
        :param type: The type of this VerificationErrorRecursive.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'VerificationErrorRecursive':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The VerificationError-recursive of this VerificationErrorRecursive.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def capabilities(self):
        """Gets the capabilities of this VerificationErrorRecursive.

        Contains key-value pairs that specify the actions that the legal entity can do in your platform. The key is a capability required for your integration. For example, **issueCard** for Issuing.The value is an object containing the settings for the capability.

        :return: The capabilities of this VerificationErrorRecursive.
        :rtype: List[str]
        """
    ...
    def capabilities(self, capabilities):
        """Sets the capabilities of this VerificationErrorRecursive.
    ...
    @property
    def code(self):
        """Gets the code of this VerificationErrorRecursive.

        The general error code.

        :return: The code of this VerificationErrorRecursive.
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this VerificationErrorRecursive.
    ...
    @property
    def message(self):
        """Gets the message of this VerificationErrorRecursive.

        The general error message.

        :return: The message of this VerificationErrorRecursive.
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this VerificationErrorRecursive.
    ...
    def remediating_actions(self):
        """Gets the remediating_actions of this VerificationErrorRecursive.

        An object containing possible solutions to fix a verification error.

        :return: The remediating_actions of this VerificationErrorRecursive.
    ...
    def remediating_actions(self, remediating_actions):
        """Sets the remediating_actions of this VerificationErrorRecursive.
    ...
    @property
    def type(self):
        """Gets the type of this VerificationErrorRecursive.

        The type of error.

        :return: The type of this VerificationErrorRecursive.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this VerificationErrorRecursive.
        ...
        :type type: str
        """
        allowed_values = ["dataMissing", "invalidInput", "pendingStatus"]  # noqa: E501
