...
class ThreeDS2Result(Model):
    ...
    def __init__(self, authentication_value: str=None, ds_trans_id: str=None, eci: str=None, three_ds_server_trans_id: str=None, timestamp: str=None, trans_status: str=None, trans_status_reason: str=None):
