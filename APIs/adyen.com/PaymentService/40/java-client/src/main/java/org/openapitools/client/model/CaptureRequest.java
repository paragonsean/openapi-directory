...
public class CaptureRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalData, merchantAccount, modificationAmount, originalMerchantReference, originalReference, reference, splits, tenderReference, uniqueTerminalId);
  }
