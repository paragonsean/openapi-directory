...
public class ResponseAdditionalDataCommon {
  ...
  public enum FraudResultTypeEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      FraudResultTypeEnum.fromValue(value);
    }
  }
  ...
  public static final String SERIALIZED_NAME_NON_SCHEME_TRANSACTION_LIMIT = "nonScheme.transactionLimit";
  @SerializedName(SERIALIZED_NAME_NON_SCHEME_TRANSACTION_LIMIT)
  private String nonSchemeTransactionLimit;

  public static final String SERIALIZED_NAME_NON_SCHEME_TRANSACTION_LIMIT_CCY = "nonScheme.transactionLimitCcy";
  @SerializedName(SERIALIZED_NAME_NON_SCHEME_TRANSACTION_LIMIT_CCY)
  private String nonSchemeTransactionLimitCcy;
  ...
  public ResponseAdditionalDataCommon nonSchemeTransactionLimit(String nonSchemeTransactionLimit) {
    this.nonSchemeTransactionLimit = nonSchemeTransactionLimit;
    return this;
  }

  /**
   * The maximum spendable value for a single transaction. Applicable to some gift cards.
   * @return nonSchemeTransactionLimit
   */
  @javax.annotation.Nullable
  public String getNonSchemeTransactionLimit() {
    return nonSchemeTransactionLimit;
  }

  public void setNonSchemeTransactionLimit(String nonSchemeTransactionLimit) {
    this.nonSchemeTransactionLimit = nonSchemeTransactionLimit;
  }


  public ResponseAdditionalDataCommon nonSchemeTransactionLimitCcy(String nonSchemeTransactionLimitCcy) {
    this.nonSchemeTransactionLimitCcy = nonSchemeTransactionLimitCcy;
    return this;
  }

  /**
   * The currency of the transaction limit.
   * @return nonSchemeTransactionLimitCcy
   */
  @javax.annotation.Nullable
  public String getNonSchemeTransactionLimitCcy() {
    return nonSchemeTransactionLimitCcy;
  }

  public void setNonSchemeTransactionLimitCcy(String nonSchemeTransactionLimitCcy) {
    this.nonSchemeTransactionLimitCcy = nonSchemeTransactionLimitCcy;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acquirerAccountCode, responseAdditionalDataCommon.acquirerAccountCode) &&
        ...
        Objects.equals(this.nonSchemeTransactionLimit, responseAdditionalDataCommon.nonSchemeTransactionLimit) &&
        Objects.equals(this.nonSchemeTransactionLimitCcy, responseAdditionalDataCommon.nonSchemeTransactionLimitCcy) &&
  ...
  public String toString() {
    ...
    sb.append("    nonSchemeTransactionLimit: ").append(toIndentedString(nonSchemeTransactionLimit)).append("\n");
    sb.append("    nonSchemeTransactionLimitCcy: ").append(toIndentedString(nonSchemeTransactionLimitCcy)).append("\n");
  ...
  static {
    ...
    openapiFields.add("nonScheme.transactionLimit");
    openapiFields.add("nonScheme.transactionLimitCcy");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResponseAdditionalDataCommon
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseAdditionalDataCommon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResponseAdditionalDataCommon.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseAdditionalDataCommon` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("acquirerAccountCode") != null && !jsonObj.get("acquirerAccountCode").isJsonNull()) && !jsonObj.get("acquirerAccountCode").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("acquirerCode") != null && !jsonObj.get("acquirerCode").isJsonNull()) && !jsonObj.get("acquirerCode").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("acquirerReference") != null && !jsonObj.get("acquirerReference").isJsonNull()) && !jsonObj.get("acquirerReference").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("authorisationMid") != null && !jsonObj.get("authorisationMid").isJsonNull()) && !jsonObj.get("authorisationMid").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("authorisedAmountCurrency") != null && !jsonObj.get("authorisedAmountCurrency").isJsonNull()) && !jsonObj.get("authorisedAmountCurrency").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("authorisedAmountValue") != null && !jsonObj.get("authorisedAmountValue").isJsonNull()) && !jsonObj.get("authorisedAmountValue").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("coBrandedWith") != null && !jsonObj.get("coBrandedWith").isJsonNull()) && !jsonObj.get("coBrandedWith").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("cvcResult") != null && !jsonObj.get("cvcResult").isJsonNull()) && !jsonObj.get("cvcResult").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("extraCostsCurrency") != null && !jsonObj.get("extraCostsCurrency").isJsonNull()) && !jsonObj.get("extraCostsCurrency").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("extraCostsValue") != null && !jsonObj.get("extraCostsValue").isJsonNull()) && !jsonObj.get("extraCostsValue").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("fraudCheck-[itemNr]-[FraudCheckname]") != null && !jsonObj.get("fraudCheck-[itemNr]-[FraudCheckname]").isJsonNull()) && !jsonObj.get("fraudCheck-[itemNr]-[FraudCheckname]").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("fraudManualReview") != null && !jsonObj.get("fraudManualReview").isJsonNull()) && !jsonObj.get("fraudManualReview").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("fraudResultType") != null && !jsonObj.get("fraudResultType").isJsonNull()) && !jsonObj.get("fraudResultType").isJsonPrimitive()) {
      ...
      // validate the optional field `fraudResultType`
      if (jsonObj.get("fraudResultType") != null && !jsonObj.get("fraudResultType").isJsonNull()) {
        FraudResultTypeEnum.validateJsonElement(jsonObj.get("fraudResultType"));
      }
      ...
      if ((jsonObj.get("fundsAvailability") != null && !jsonObj.get("fundsAvailability").isJsonNull()) && !jsonObj.get("fundsAvailability").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("inferredRefusalReason") != null && !jsonObj.get("inferredRefusalReason").isJsonNull()) && !jsonObj.get("inferredRefusalReason").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("isCardCommercial") != null && !jsonObj.get("isCardCommercial").isJsonNull()) && !jsonObj.get("isCardCommercial").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("liabilityShift") != null && !jsonObj.get("liabilityShift").isJsonNull()) && !jsonObj.get("liabilityShift").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("mcBankNetReferenceNumber") != null && !jsonObj.get("mcBankNetReferenceNumber").isJsonNull()) && !jsonObj.get("mcBankNetReferenceNumber").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("nonScheme.transactionLimit") != null && !jsonObj.get("nonScheme.transactionLimit").isJsonNull()) && !jsonObj.get("nonScheme.transactionLimit").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `nonScheme.transactionLimit` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nonScheme.transactionLimit").toString()));
      }
      if ((jsonObj.get("nonScheme.transactionLimitCcy") != null && !jsonObj.get("nonScheme.transactionLimitCcy").isJsonNull()) && !jsonObj.get("nonScheme.transactionLimitCcy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `nonScheme.transactionLimitCcy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nonScheme.transactionLimitCcy").toString()));
      }
      ...
      if ((jsonObj.get("payoutEligible") != null && !jsonObj.get("payoutEligible").isJsonNull()) && !jsonObj.get("payoutEligible").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("realtimeAccountUpdaterStatus") != null && !jsonObj.get("realtimeAccountUpdaterStatus").isJsonNull()) && !jsonObj.get("realtimeAccountUpdaterStatus").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("receiptFreeText") != null && !jsonObj.get("receiptFreeText").isJsonNull()) && !jsonObj.get("receiptFreeText").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("recurring.contractTypes") != null && !jsonObj.get("recurring.contractTypes").isJsonNull()) && !jsonObj.get("recurring.contractTypes").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("recurring.firstPspReference") != null && !jsonObj.get("recurring.firstPspReference").isJsonNull()) && !jsonObj.get("recurring.firstPspReference").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("recurring.recurringDetailReference") != null && !jsonObj.get("recurring.recurringDetailReference").isJsonNull()) && !jsonObj.get("recurring.recurringDetailReference").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("recurring.shopperReference") != null && !jsonObj.get("recurring.shopperReference").isJsonNull()) && !jsonObj.get("recurring.shopperReference").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("referred") != null && !jsonObj.get("referred").isJsonNull()) && !jsonObj.get("referred").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("refusalReasonRaw") != null && !jsonObj.get("refusalReasonRaw").isJsonNull()) && !jsonObj.get("refusalReasonRaw").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("requestAmount") != null && !jsonObj.get("requestAmount").isJsonNull()) && !jsonObj.get("requestAmount").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("requestCurrencyCode") != null && !jsonObj.get("requestCurrencyCode").isJsonNull()) && !jsonObj.get("requestCurrencyCode").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("threeDAuthenticatedResponse") != null && !jsonObj.get("threeDAuthenticatedResponse").isJsonNull()) && !jsonObj.get("threeDAuthenticatedResponse").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("threeDOfferedResponse") != null && !jsonObj.get("threeDOfferedResponse").isJsonNull()) && !jsonObj.get("threeDOfferedResponse").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("visaTransactionId") != null && !jsonObj.get("visaTransactionId").isJsonNull()) && !jsonObj.get("visaTransactionId").isJsonPrimitive()) {
