...
public class CancelRequest {
  ...
  public CancelRequest additionalData(AdjustAuthorisationRequestAdditionalData additionalData) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalData, merchantAccount, originalMerchantReference, originalReference, reference, splits, tenderReference, uniqueTerminalId);
  }
