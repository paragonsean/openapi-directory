...
|**modificationAmount** | [**Amount**](Amount.md) | The amount that needs to be adjusted. The &#x60;currency&#x60; must match the currency used in authorisation, the &#x60;value&#x60; must be smaller than or equal to the authorised amount. |  |
