...
class AccountInfo(Model):
    ...
    def account_type(self, account_type):
        ...
        """
        allowed_values = ["notApplicable", "credit", "debit"]  # noqa: E501
