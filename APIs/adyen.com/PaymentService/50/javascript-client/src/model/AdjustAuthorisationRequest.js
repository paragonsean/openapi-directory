...
/**
 * The AdjustAuthorisationRequest model module.
 * @module model/AdjustAuthorisationRequest
 * @version 50
 */
class AdjustAuthorisationRequest {
    /**
     * Constructs a new <code>AdjustAuthorisationRequest</code>.
     * @alias module:model/AdjustAuthorisationRequest
     * @param merchantAccount {String} The merchant account that is used to process the payment.
     * @param modificationAmount {module:model/Amount} The amount that needs to be adjusted. The `currency` must match the currency used in authorisation, the `value` must be smaller than or equal to the authorised amount.
     ...
     */
    constructor(merchantAccount, modificationAmount, originalReference) { 
        
        AdjustAuthorisationRequest.initialize(this, merchantAccount, modificationAmount, originalReference);
    }
     ...
     */
    static initialize(obj, merchantAccount, modificationAmount, originalReference) { 
    ...
    /**
     * Constructs a <code>AdjustAuthorisationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdjustAuthorisationRequest} obj Optional instance to populate.
     * @return {module:model/AdjustAuthorisationRequest} The populated <code>AdjustAuthorisationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdjustAuthorisationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdjustAuthorisationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdjustAuthorisationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdjustAuthorisationRequest.RequiredProperties) {
...
AdjustAuthorisationRequest.RequiredProperties = ["merchantAccount", "modificationAmount", "originalReference"];

/**
 * @member {module:model/AdjustAuthorisationRequestAdditionalData} additionalData
 */
AdjustAuthorisationRequest.prototype['additionalData'] = undefined;

/**
 * The merchant account that is used to process the payment.
 * @member {String} merchantAccount
 */
AdjustAuthorisationRequest.prototype['merchantAccount'] = undefined;
 ...
 */
AdjustAuthorisationRequest.prototype['modificationAmount'] = undefined;

/**
 * Authentication data produced by an MPI (Mastercard SecureCode, Visa Secure, or Cartes Bancaires).
 * @member {module:model/ThreeDSecureData} mpiData
 */
AdjustAuthorisationRequest.prototype['mpiData'] = undefined;

/**
 * The original merchant reference to cancel.
 * @member {String} originalMerchantReference
 */
AdjustAuthorisationRequest.prototype['originalMerchantReference'] = undefined;

/**
 * The original pspReference of the payment to modify. This reference is returned in: * authorisation response * authorisation notification  
 * @member {String} originalReference
 */
AdjustAuthorisationRequest.prototype['originalReference'] = undefined;

/**
 * Your reference for the payment modification. This reference is visible in Customer Area and in reports. Maximum length: 80 characters.
 * @member {String} reference
 */
AdjustAuthorisationRequest.prototype['reference'] = undefined;

/**
 * An array of objects specifying how the amount should be split between accounts when using Adyen for Platforms. For details, refer to [Providing split information](https://docs.adyen.com/marketplaces-and-platforms/processing-payments#providing-split-information).
 * @member {Array.<module:model/Split>} splits
 */
AdjustAuthorisationRequest.prototype['splits'] = undefined;

/**
 * The transaction reference provided by the PED. For point-of-sale integrations only.
 * @member {String} tenderReference
 */
AdjustAuthorisationRequest.prototype['tenderReference'] = undefined;

/**
 * Unique terminal ID for the PED that originally processed the request. For point-of-sale integrations only.
 * @member {String} uniqueTerminalId
 */
AdjustAuthorisationRequest.prototype['uniqueTerminalId'] = undefined;
...
export default AdjustAuthorisationRequest;
