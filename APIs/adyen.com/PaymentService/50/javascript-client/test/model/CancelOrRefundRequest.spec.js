...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPaymentApi.CancelOrRefundRequest();
  });
  ...
  describe('CancelOrRefundRequest', function() {
    it('should create an instance of CancelOrRefundRequest', function() {
      // uncomment below and update the code to test CancelOrRefundRequest
      //var instance = new AdyenPaymentApi.CancelOrRefundRequest();
      //expect(instance).to.be.a(AdyenPaymentApi.CancelOrRefundRequest);
    });
