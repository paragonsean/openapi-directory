...
class PaymentRequest(Model):
    ...
    def __init__(self, account_info: AccountInfo=None, additional_amount: Amount=None, additional_data: PaymentRequestAdditionalData=None, amount: Amount=None, application_info: ApplicationInfo=None, bank_account: BankAccount=None, billing_address: Address=None, browser_info: BrowserInfo=None, capture_delay_hours: int=None, card: Card=None, date_of_birth: date=None, dcc_quote: ForexQuote=None, delivery_address: Address=None, delivery_date: datetime=None, device_fingerprint: str=None, enable_real_time_update: bool=None, entity_type: str=None, fraud_offset: int=None, funding_source: str=None, installments: Installments=None, mandate: Mandate=None, mcc: str=None, merchant_account: str=None, merchant_order_reference: str=None, merchant_risk_indicator: MerchantRiskIndicator=None, metadata: Dict[str, str]=None, mpi_data: ThreeDSecureData=None, nationality: str=None, order_reference: str=None, recurring: Recurring=None, recurring_processing_model: str=None, reference: str=None, selected_brand: str=None, selected_recurring_detail_reference: str=None, session_id: str=None, shopper_email: str=None, shopper_ip: str=None, shopper_interaction: str=None, shopper_locale: str=None, shopper_name: Name=None, shopper_reference: str=None, shopper_statement: str=None, social_security_number: str=None, splits: List[Split]=None, store: str=None, telephone_number: str=None, three_ds2_request_data: ThreeDS2RequestData=None, three_ds_authentication_only: bool=False, totals_group: str=None, trusted_shopper: bool=None):
        ...
        :param enable_real_time_update: The enable_real_time_update of this PaymentRequest.
    ...
    def enable_real_time_update(self):
        """Gets the enable_real_time_update of this PaymentRequest.

        Choose if a specific transaction should use the Real-time Account Updater, regardless of other settings.

        :return: The enable_real_time_update of this PaymentRequest.
        :rtype: bool
        """
    ...
    def enable_real_time_update(self, enable_real_time_update):
        """Sets the enable_real_time_update of this PaymentRequest.
