...
#include <iostream>
#include "../client/OAIModificationsApi.h"

using namespace test_namespace;

class Example : public QObject {
    Q_OBJECT
    OAIAdjustAuthorisationRequest create();
public Q_SLOTS:
...
OAIAdjustAuthorisationRequest Example::create(){
    OAIAdjustAuthorisationRequest obj;
 return obj;
}

void Example::exampleFunction1(){
     OAIModificationsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIModificationsApi::postAdjustAuthorisationSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIModificationsApi::postAdjustAuthorisationSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIAdjustAuthorisationRequest oai_adjust_authorisation_request = create(); // OAIAdjustAuthorisationRequest | 
      apiInstance.postAdjustAuthorisation(oai_adjust_authorisation_request);
