...
/*
 * OAIPaymentRequest3ds2.h
 *
 * 
 */

#ifndef OAIPaymentRequest3ds2_H
#define OAIPaymentRequest3ds2_H
...
class OAIPaymentRequest3ds2 : public OAIObject {
public:
    OAIPaymentRequest3ds2();
    OAIPaymentRequest3ds2(QString json);
    ~OAIPaymentRequest3ds2() override;
    ...
    QString getThreeDs2Token() const;
    void setThreeDs2Token(const QString &three_ds2_token);
    bool is_three_ds2_token_Set() const;
    bool is_three_ds2_token_Valid() const;
...
private:
    ...
    QString m_three_ds2_token;
    bool m_three_ds2_token_isSet;
    bool m_three_ds2_token_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentRequest3ds2)

#endif // OAIPaymentRequest3ds2_H
