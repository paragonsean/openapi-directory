...
/*
 * OAIPaymentRequest3d.h
 *
 * 
 */

#ifndef OAIPaymentRequest3d_H
#define OAIPaymentRequest3d_H
...
class OAIPaymentRequest3d : public OAIObject {
public:
    OAIPaymentRequest3d();
    OAIPaymentRequest3d(QString json);
    ~OAIPaymentRequest3d() override;
    ...
    QString getPaResponse() const;
    void setPaResponse(const QString &pa_response);
    bool is_pa_response_Set() const;
    bool is_pa_response_Valid() const;
...
private:
    ...
    QString m_pa_response;
    bool m_pa_response_isSet;
    bool m_pa_response_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentRequest3d)

#endif // OAIPaymentRequest3d_H
