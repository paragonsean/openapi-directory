...
class CaptureRequest(Model):
    ...
    def __init__(self, additional_data: AdjustAuthorisationRequestAdditionalData=None, merchant_account: str=None, modification_amount: Amount=None, mpi_data: ThreeDSecureData=None, original_merchant_reference: str=None, original_reference: str=None, platform_chargeback_logic: PlatformChargebackLogic=None, reference: str=None, splits: List[Split]=None, tender_reference: str=None, unique_terminal_id: str=None):
        """CaptureRequest - a model defined in OpenAPI

        :param additional_data: The additional_data of this CaptureRequest.
        :param merchant_account: The merchant_account of this CaptureRequest.
        :param modification_amount: The modification_amount of this CaptureRequest.
        :param mpi_data: The mpi_data of this CaptureRequest.
        :param original_merchant_reference: The original_merchant_reference of this CaptureRequest.
        :param original_reference: The original_reference of this CaptureRequest.
        :param platform_chargeback_logic: The platform_chargeback_logic of this CaptureRequest.
        :param reference: The reference of this CaptureRequest.
        :param splits: The splits of this CaptureRequest.
        :param tender_reference: The tender_reference of this CaptureRequest.
        :param unique_terminal_id: The unique_terminal_id of this CaptureRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CaptureRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CaptureRequest of this CaptureRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def additional_data(self):
        """Gets the additional_data of this CaptureRequest.


        :return: The additional_data of this CaptureRequest.
    ...
    def additional_data(self, additional_data):
        """Sets the additional_data of this CaptureRequest.
    ...
    def merchant_account(self):
        """Gets the merchant_account of this CaptureRequest.

        The merchant account that is used to process the payment.

        :return: The merchant_account of this CaptureRequest.
        :rtype: str
        """
    ...
    def merchant_account(self, merchant_account):
        """Sets the merchant_account of this CaptureRequest.
    ...
    def modification_amount(self):
        """Gets the modification_amount of this CaptureRequest.
        ...
        :return: The modification_amount of this CaptureRequest.
        :rtype: Amount
        """
    ...
    def modification_amount(self, modification_amount):
        """Sets the modification_amount of this CaptureRequest.
    ...
    @property
    def mpi_data(self):
        """Gets the mpi_data of this CaptureRequest.

        Authentication data produced by an MPI (Mastercard SecureCode, Visa Secure, or Cartes Bancaires).

        :return: The mpi_data of this CaptureRequest.
    ...
    def mpi_data(self, mpi_data):
        """Sets the mpi_data of this CaptureRequest.
    ...
    def original_merchant_reference(self):
        """Gets the original_merchant_reference of this CaptureRequest.

        The original merchant reference to cancel.

        :return: The original_merchant_reference of this CaptureRequest.
        :rtype: str
        """
    ...
    def original_merchant_reference(self, original_merchant_reference):
        """Sets the original_merchant_reference of this CaptureRequest.
    ...
    def original_reference(self):
        """Gets the original_reference of this CaptureRequest.

        The original pspReference of the payment to modify. This reference is returned in: * authorisation response * authorisation notification  

        :return: The original_reference of this CaptureRequest.
        :rtype: str
        """
    ...
    def original_reference(self, original_reference):
        """Sets the original_reference of this CaptureRequest.
    ...
    def platform_chargeback_logic(self):
        """Gets the platform_chargeback_logic of this CaptureRequest.
        ...
        :return: The platform_chargeback_logic of this CaptureRequest.
    ...
    def platform_chargeback_logic(self, platform_chargeback_logic):
        """Sets the platform_chargeback_logic of this CaptureRequest.
    ...
    @property
    def reference(self):
        """Gets the reference of this CaptureRequest.

        Your reference for the payment modification. This reference is visible in Customer Area and in reports. Maximum length: 80 characters.

        :return: The reference of this CaptureRequest.
        :rtype: str
        """
    ...
    def reference(self, reference):
        """Sets the reference of this CaptureRequest.
    ...
    @property
    def splits(self):
        """Gets the splits of this CaptureRequest.

        An array of objects specifying how the amount should be split between accounts when using Adyen for Platforms. For details, refer to [Providing split information](https://docs.adyen.com/marketplaces-and-platforms/processing-payments#providing-split-information).

        :return: The splits of this CaptureRequest.
        :rtype: List[Split]
        """
        return self._splits
    ...
    def splits(self, splits):
        """Sets the splits of this CaptureRequest.
    ...
    def tender_reference(self):
        """Gets the tender_reference of this CaptureRequest.

        The transaction reference provided by the PED. For point-of-sale integrations only.

        :return: The tender_reference of this CaptureRequest.
        :rtype: str
        """
    ...
    def tender_reference(self, tender_reference):
        """Sets the tender_reference of this CaptureRequest.
    ...
    def unique_terminal_id(self):
        """Gets the unique_terminal_id of this CaptureRequest.

        Unique terminal ID for the PED that originally processed the request. For point-of-sale integrations only.

        :return: The unique_terminal_id of this CaptureRequest.
        :rtype: str
        """
    ...
    def unique_terminal_id(self, unique_terminal_id):
        """Sets the unique_terminal_id of this CaptureRequest.
