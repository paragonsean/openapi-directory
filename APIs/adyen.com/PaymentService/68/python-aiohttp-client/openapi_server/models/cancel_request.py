...
class CancelRequest(Model):
    ...
    def __init__(self, additional_data: AdjustAuthorisationRequestAdditionalData=None, merchant_account: str=None, mpi_data: ThreeDSecureData=None, original_merchant_reference: str=None, original_reference: str=None, platform_chargeback_logic: PlatformChargebackLogic=None, reference: str=None, splits: List[Split]=None, tender_reference: str=None, unique_terminal_id: str=None):
        ...
        :param platform_chargeback_logic: The platform_chargeback_logic of this CancelRequest.
    ...
    def platform_chargeback_logic(self):
        """Gets the platform_chargeback_logic of this CancelRequest.
        ...
        :return: The platform_chargeback_logic of this CancelRequest.
    ...
    def platform_chargeback_logic(self, platform_chargeback_logic):
        """Sets the platform_chargeback_logic of this CancelRequest.
