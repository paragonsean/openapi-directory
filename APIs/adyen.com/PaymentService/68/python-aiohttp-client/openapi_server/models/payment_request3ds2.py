...
class PaymentRequest3ds2(Model):
    ...
    def __init__(self, account_info: AccountInfo=None, additional_amount: Amount=None, additional_data: PaymentRequestAdditionalData=None, amount: Amount=None, application_info: ApplicationInfo=None, billing_address: Address=None, browser_info: BrowserInfo=None, capture_delay_hours: int=None, date_of_birth: date=None, dcc_quote: ForexQuote=None, delivery_address: Address=None, delivery_date: datetime=None, device_fingerprint: str=None, fraud_offset: int=None, installments: Installments=None, localized_shopper_statement: Dict[str, str]=None, mcc: str=None, merchant_account: str=None, merchant_order_reference: str=None, merchant_risk_indicator: MerchantRiskIndicator=None, metadata: Dict[str, str]=None, order_reference: str=None, recurring: Recurring=None, recurring_processing_model: str=None, reference: str=None, selected_brand: str=None, selected_recurring_detail_reference: str=None, session_id: str=None, shopper_email: str=None, shopper_ip: str=None, shopper_interaction: str=None, shopper_locale: str=None, shopper_name: Name=None, shopper_reference: str=None, shopper_statement: str=None, social_security_number: str=None, splits: List[Split]=None, store: str=None, telephone_number: str=None, three_ds2_request_data: ThreeDS2RequestData=None, three_ds2_result: ThreeDS2Result=None, three_ds2_token: str=None, three_ds_authentication_only: bool=False, totals_group: str=None, trusted_shopper: bool=None):
        ...
        :param localized_shopper_statement: The localized_shopper_statement of this PaymentRequest3ds2.
    ...
    def localized_shopper_statement(self):
        """Gets the localized_shopper_statement of this PaymentRequest3ds2.
        ...
        :return: The localized_shopper_statement of this PaymentRequest3ds2.
        :rtype: Dict[str, str]
        """
    ...
    def localized_shopper_statement(self, localized_shopper_statement):
        """Sets the localized_shopper_statement of this PaymentRequest3ds2.
