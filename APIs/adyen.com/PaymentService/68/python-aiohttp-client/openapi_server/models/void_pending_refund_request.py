...
class VoidPendingRefundRequest(Model):
    ...
    def __init__(self, additional_data: AdjustAuthorisationRequestAdditionalData=None, merchant_account: str=None, modification_amount: Amount=None, mpi_data: ThreeDSecureData=None, original_merchant_reference: str=None, original_reference: str=None, platform_chargeback_logic: PlatformChargebackLogic=None, reference: str=None, splits: List[Split]=None, tender_reference: str=None, unique_terminal_id: str=None):
        ...
        :param mpi_data: The mpi_data of this VoidPendingRefundRequest.
        ...
        :param platform_chargeback_logic: The platform_chargeback_logic of this VoidPendingRefundRequest.
        :param reference: The reference of this VoidPendingRefundRequest.
        :param splits: The splits of this VoidPendingRefundRequest.
    ...
    @property
    def mpi_data(self):
        """Gets the mpi_data of this VoidPendingRefundRequest.

        Authentication data produced by an MPI (Mastercard SecureCode, Visa Secure, or Cartes Bancaires).

        :return: The mpi_data of this VoidPendingRefundRequest.
    ...
    def mpi_data(self, mpi_data):
        """Sets the mpi_data of this VoidPendingRefundRequest.
    ...
    def platform_chargeback_logic(self):
        """Gets the platform_chargeback_logic of this VoidPendingRefundRequest.
        ...
        :return: The platform_chargeback_logic of this VoidPendingRefundRequest.
    ...
    def platform_chargeback_logic(self, platform_chargeback_logic):
        """Sets the platform_chargeback_logic of this VoidPendingRefundRequest.
    ...
    @property
    def splits(self):
        """Gets the splits of this VoidPendingRefundRequest.

        An array of objects specifying how the amount should be split between accounts when using Adyen for Platforms. For details, refer to [Providing split information](https://docs.adyen.com/marketplaces-and-platforms/processing-payments#providing-split-information).

        :return: The splits of this VoidPendingRefundRequest.
        :rtype: List[Split]
        """
        return self._splits
    ...
    def splits(self, splits):
        """Sets the splits of this VoidPendingRefundRequest.
