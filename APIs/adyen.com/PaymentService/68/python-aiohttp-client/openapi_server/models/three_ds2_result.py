...
class ThreeDS2Result(Model):
    ...
    def __init__(self, authentication_value: str=None, cavv_algorithm: str=None, challenge_cancel: str=None, ds_trans_id: str=None, eci: str=None, exemption_indicator: str=None, message_version: str=None, risk_score: str=None, three_ds_requestor_challenge_ind: str=None, three_ds_server_trans_id: str=None, timestamp: str=None, trans_status: str=None, trans_status_reason: str=None, white_list_status: str=None):
        ...
        :param three_ds_requestor_challenge_ind: The three_ds_requestor_challenge_ind of this ThreeDS2Result.
    ...
    def three_ds_requestor_challenge_ind(self):
        """Gets the three_ds_requestor_challenge_ind of this ThreeDS2Result.

        Indicates whether a challenge is requested for this transaction. Possible values: * **01** — No preference * **02** — No challenge requested * **03** — Challenge requested (3DS Requestor preference) * **04** — Challenge requested (Mandate) * **05** — No challenge (transactional risk analysis is already performed) * **06** — Data Only

        :return: The three_ds_requestor_challenge_ind of this ThreeDS2Result.
        :rtype: str
        """
    ...
    def three_ds_requestor_challenge_ind(self, three_ds_requestor_challenge_ind):
        """Sets the three_ds_requestor_challenge_ind of this ThreeDS2Result.
