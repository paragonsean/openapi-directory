...
async def test_post_adjust_authorisation(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v68/adjustAuthorisation',
        headers=headers,
        json=body,
        )
...
async def test_post_cancel(client):
    ...
    """
    body = {"originalReference":"originalReference","reference":"reference","uniqueTerminalId":"uniqueTerminalId","splits":[{"reference":"reference","amount":{"currency":"currency","value":6},"description":"description","type":"BalanceAccount","account":"account"},{"reference":"reference","amount":{"currency":"currency","value":6},"description":"description","type":"BalanceAccount","account":"account"}],"merchantAccount":"merchantAccount","platformChargebackLogic":{"costAllocationAccount":"costAllocationAccount","targetAccount":"targetAccount","behavior":"deductAccordingToSplitRatio"},"additionalData":{"challengeWindowSize":"01","mpiImplementationType":"mpiImplementationType","allow3DS2":"allow3DS2","executeThreeD":"executeThreeD","threeDSVersion":"threeDSVersion","scaExemption":"scaExemption"},"tenderReference":"tenderReference","mpiData":{"cavv":"cavv","authenticationResponse":"Y","xid":"xid","cavvAlgorithm":"cavvAlgorithm","dsTransID":"dsTransID","tokenAuthenticationVerificationValue":"tokenAuthenticationVerificationValue","transStatusReason":"transStatusReason","challengeCancel":"01","directoryResponse":"A","eci":"eci","riskScore":"riskScore","threeDSVersion":"threeDSVersion"},"originalMerchantReference":"originalMerchantReference"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'Authorization': 'BasicZm9vOmJhcg==',
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v68/cancel',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_cancel_or_refund(client):
    ...
    """
    body = {"originalReference":"originalReference","reference":"reference","uniqueTerminalId":"uniqueTerminalId","merchantAccount":"merchantAccount","platformChargebackLogic":{"costAllocationAccount":"costAllocationAccount","targetAccount":"targetAccount","behavior":"deductAccordingToSplitRatio"},"additionalData":{"challengeWindowSize":"01","mpiImplementationType":"mpiImplementationType","allow3DS2":"allow3DS2","executeThreeD":"executeThreeD","threeDSVersion":"threeDSVersion","scaExemption":"scaExemption"},"tenderReference":"tenderReference","mpiData":{"cavv":"cavv","authenticationResponse":"Y","xid":"xid","cavvAlgorithm":"cavvAlgorithm","dsTransID":"dsTransID","tokenAuthenticationVerificationValue":"tokenAuthenticationVerificationValue","transStatusReason":"transStatusReason","challengeCancel":"01","directoryResponse":"A","eci":"eci","riskScore":"riskScore","threeDSVersion":"threeDSVersion"},"originalMerchantReference":"originalMerchantReference"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'Authorization': 'BasicZm9vOmJhcg==',
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v68/cancelOrRefund',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_capture(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v68/capture',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_donate(client):
    ...
    Create a donation
    """
    body = {"originalReference":"originalReference","reference":"reference","merchantAccount":"merchantAccount","modificationAmount":{"currency":"currency","value":0},"platformChargebackLogic":{"costAllocationAccount":"costAllocationAccount","targetAccount":"targetAccount","behavior":"deductAccordingToSplitRatio"},"donationAccount":"donationAccount"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'Authorization': 'BasicZm9vOmJhcg==',
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v68/donate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_refund(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v68/refund',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_technical_cancel(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v68/technicalCancel',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_void_pending_refund(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v68/voidPendingRefund',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
