...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPaymentApi.FundDestination();
  });
  ...
  describe('FundDestination', function() {
    it('should create an instance of FundDestination', function() {
      // uncomment below and update the code to test FundDestination
      //var instance = new AdyenPaymentApi.FundDestination();
      //expect(instance).to.be.a(AdyenPaymentApi.FundDestination);
    });
