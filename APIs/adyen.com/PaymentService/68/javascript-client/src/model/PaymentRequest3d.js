...
class PaymentRequest3d {
    /**
     * Constructs a new <code>PaymentRequest3d</code>.
     * @alias module:model/PaymentRequest3d
     * @param md {String} The payment session identifier returned by the card issuer.
     * @param merchantAccount {String} The merchant account identifier, with which you want to process the transaction.
     * @param paResponse {String} Payment authorisation response returned by the card issuer. The `paResponse` field holds the PaRes value received from the card issuer.
     */
    constructor(md, merchantAccount, paResponse) { 
        
        PaymentRequest3d.initialize(this, md, merchantAccount, paResponse);
    }
     ...
     */
    static initialize(obj, md, merchantAccount, paResponse) { 
        obj['md'] = md;
        obj['merchantAccount'] = merchantAccount;
        obj['paResponse'] = paResponse;
        obj['threeDSAuthenticationOnly'] = false;
    }

    /**
     * Constructs a <code>PaymentRequest3d</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentRequest3d} obj Optional instance to populate.
     * @return {module:model/PaymentRequest3d} The populated <code>PaymentRequest3d</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentRequest3d();
            ...
            if (data.hasOwnProperty('paResponse')) {
                obj['paResponse'] = ApiClient.convertToType(data['paResponse'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentRequest3d</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentRequest3d</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentRequest3d.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['paResponse'] && !(typeof data['paResponse'] === 'string' || data['paResponse'] instanceof String)) {
            throw new Error("Expected the field `paResponse` to be a primitive type in the JSON string but got " + data['paResponse']);
        }
...
PaymentRequest3d.RequiredProperties = ["md", "merchantAccount", "paResponse"];
 ...
 */
PaymentRequest3d.prototype['accountInfo'] = undefined;
 ...
 */
PaymentRequest3d.prototype['additionalAmount'] = undefined;

/**
 * @member {module:model/PaymentRequestAdditionalData} additionalData
 */
PaymentRequest3d.prototype['additionalData'] = undefined;
 ...
 */
PaymentRequest3d.prototype['amount'] = undefined;

/**
 * Information about your application. For more details, see [Building Adyen solutions](https://docs.adyen.com/development-resources/building-adyen-solutions).
 * @member {module:model/ApplicationInfo} applicationInfo
 */
PaymentRequest3d.prototype['applicationInfo'] = undefined;
 ...
 */
PaymentRequest3d.prototype['billingAddress'] = undefined;
 ...
 */
PaymentRequest3d.prototype['browserInfo'] = undefined;

/**
 * The delay between the authorisation and scheduled auto-capture, specified in hours.
 * @member {Number} captureDelayHours
 */
PaymentRequest3d.prototype['captureDelayHours'] = undefined;

/**
 * The shopper's date of birth.  Format [ISO-8601](https://www.w3.org/TR/NOTE-datetime): YYYY-MM-DD
 * @member {Date} dateOfBirth
 */
PaymentRequest3d.prototype['dateOfBirth'] = undefined;

/**
 * The forex quote as returned in the response of the forex service.
 * @member {module:model/ForexQuote} dccQuote
 */
PaymentRequest3d.prototype['dccQuote'] = undefined;

/**
 * The address where the purchased goods should be delivered.
 * @member {module:model/Address} deliveryAddress
 */
PaymentRequest3d.prototype['deliveryAddress'] = undefined;

/**
 * The date and time the purchased goods should be delivered.  Format [ISO 8601](https://www.w3.org/TR/NOTE-datetime): YYYY-MM-DDThh:mm:ss.sssTZD  Example: 2017-07-17T13:42:40.428+01:00
 * @member {Date} deliveryDate
 */
PaymentRequest3d.prototype['deliveryDate'] = undefined;

/**
 * A string containing the shopper's device fingerprint. For more information, refer to [Device fingerprinting](https://docs.adyen.com/risk-management/device-fingerprinting).
 * @member {String} deviceFingerprint
 */
PaymentRequest3d.prototype['deviceFingerprint'] = undefined;

/**
 * An integer value that is added to the normal fraud score. The value can be either positive or negative.
 * @member {Number} fraudOffset
 */
PaymentRequest3d.prototype['fraudOffset'] = undefined;
 ...
 */
PaymentRequest3d.prototype['installments'] = undefined;
 ...
 */
PaymentRequest3d.prototype['localizedShopperStatement'] = undefined;

/**
 * The [merchant category code](https://en.wikipedia.org/wiki/Merchant_category_code) (MCC) is a four-digit number, which relates to a particular market segment. This code reflects the predominant activity that is conducted by the merchant.
 * @member {String} mcc
 */
PaymentRequest3d.prototype['mcc'] = undefined;

/**
 * The payment session identifier returned by the card issuer.
 * @member {String} md
 */
PaymentRequest3d.prototype['md'] = undefined;

/**
 * The merchant account identifier, with which you want to process the transaction.
 * @member {String} merchantAccount
 */
PaymentRequest3d.prototype['merchantAccount'] = undefined;
 ...
 */
PaymentRequest3d.prototype['merchantOrderReference'] = undefined;
 ...
 */
PaymentRequest3d.prototype['merchantRiskIndicator'] = undefined;

/**
 * Metadata consists of entries, each of which includes a key and a value. Limits: * Maximum 20 key-value pairs per request. When exceeding, the \"177\" error occurs: \"Metadata size exceeds limit\". * Maximum 20 characters per key. * Maximum 80 characters per value. 
 * @member {Object.<String, String>} metadata
 */
PaymentRequest3d.prototype['metadata'] = undefined;

/**
 * When you are doing multiple partial (gift card) payments, this is the `pspReference` of the first payment. We use this to link the multiple payments to each other. As your own reference for linking multiple payments, use the `merchantOrderReference`instead.
 * @member {String} orderReference
 */
PaymentRequest3d.prototype['orderReference'] = undefined;
 ...
 * @member {String} paResponse
 */
PaymentRequest3d.prototype['paResponse'] = undefined;
 ...
 */
PaymentRequest3d.prototype['recurring'] = undefined;
 ...
 * @member {module:model/PaymentRequest3d.RecurringProcessingModelEnum} recurringProcessingModel
 */
PaymentRequest3d.prototype['recurringProcessingModel'] = undefined;

/**
 * The reference to uniquely identify a payment. This reference is used in all communication with you about the payment status. We recommend using a unique value per payment; however, it is not a requirement. If you need to provide multiple references for a transaction, separate them with hyphens (\"-\"). Maximum length: 80 characters.
 * @member {String} reference
 */
PaymentRequest3d.prototype['reference'] = undefined;
 ...
 * @member {module:model/PaymentRequest3d.ShopperInteractionEnum} shopperInteraction
 */
PaymentRequest3d.prototype['shopperInteraction'] = undefined;

/**
 * The combination of a language code and a country code to specify the language to be used in the payment.
 * @member {String} shopperLocale
 */
PaymentRequest3d.prototype['shopperLocale'] = undefined;

/**
 * The shopper's full name.
 * @member {module:model/Name} shopperName
 */
PaymentRequest3d.prototype['shopperName'] = undefined;

/**
 * Required for recurring payments.  Your reference to uniquely identify this shopper, for example user ID or account ID. Minimum length: 3 characters. > Your reference must not include personally identifiable information (PII), for example name or email address.
 * @member {String} shopperReference
 */
PaymentRequest3d.prototype['shopperReference'] = undefined;

/**
 * The text to be shown on the shopper's bank statement.  We recommend sending a maximum of 22 characters, otherwise banks might truncate the string.  Allowed characters: **a-z**, **A-Z**, **0-9**, spaces, and special characters **. , ' _ - ? + * /_**.
 * @member {String} shopperStatement
 */
PaymentRequest3d.prototype['shopperStatement'] = undefined;

/**
 * The shopper's social security number.
 * @member {String} socialSecurityNumber
 */
PaymentRequest3d.prototype['socialSecurityNumber'] = undefined;
 ...
 */
PaymentRequest3d.prototype['splits'] = undefined;
 ...
 * @member {String} store
 */
PaymentRequest3d.prototype['store'] = undefined;

/**
 * The shopper's telephone number.
 * @member {String} telephoneNumber
 */
PaymentRequest3d.prototype['telephoneNumber'] = undefined;
 ...
 */
PaymentRequest3d.prototype['threeDS2RequestData'] = undefined;
 ...
 * @default false
 */
PaymentRequest3d.prototype['threeDSAuthenticationOnly'] = false;

/**
 * The reference value to aggregate sales totals in reporting. When not specified, the store field is used (if available).
 * @member {String} totalsGroup
 */
PaymentRequest3d.prototype['totalsGroup'] = undefined;

/**
 * Set to true if the payment should be routed to a trusted MID.
 * @member {Boolean} trustedShopper
 */
PaymentRequest3d.prototype['trustedShopper'] = undefined;
...
export default PaymentRequest3d;
