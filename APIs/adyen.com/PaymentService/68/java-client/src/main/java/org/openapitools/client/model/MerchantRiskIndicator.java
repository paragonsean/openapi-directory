...
public class MerchantRiskIndicator {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("deliveryEmailAddress") != null && !jsonObj.get("deliveryEmailAddress").isJsonNull()) && !jsonObj.get("deliveryEmailAddress").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("giftCardCurr") != null && !jsonObj.get("giftCardCurr").isJsonNull()) && !jsonObj.get("giftCardCurr").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("preOrderPurchaseInd") != null && !jsonObj.get("preOrderPurchaseInd").isJsonNull()) && !jsonObj.get("preOrderPurchaseInd").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("reorderItemsInd") != null && !jsonObj.get("reorderItemsInd").isJsonNull()) && !jsonObj.get("reorderItemsInd").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("shipIndicator") != null && !jsonObj.get("shipIndicator").isJsonNull()) && !jsonObj.get("shipIndicator").isJsonPrimitive()) {
