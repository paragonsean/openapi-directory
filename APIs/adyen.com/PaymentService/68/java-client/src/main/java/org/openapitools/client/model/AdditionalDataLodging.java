...
public class AdditionalDataLodging {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdditionalDataLodging
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdditionalDataLodging.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdditionalDataLodging.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdditionalDataLodging` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("lodging.checkInDate") != null && !jsonObj.get("lodging.checkInDate").isJsonNull()) && !jsonObj.get("lodging.checkInDate").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.checkOutDate") != null && !jsonObj.get("lodging.checkOutDate").isJsonNull()) && !jsonObj.get("lodging.checkOutDate").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.customerServiceTollFreeNumber") != null && !jsonObj.get("lodging.customerServiceTollFreeNumber").isJsonNull()) && !jsonObj.get("lodging.customerServiceTollFreeNumber").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.fireSafetyActIndicator") != null && !jsonObj.get("lodging.fireSafetyActIndicator").isJsonNull()) && !jsonObj.get("lodging.fireSafetyActIndicator").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.folioCashAdvances") != null && !jsonObj.get("lodging.folioCashAdvances").isJsonNull()) && !jsonObj.get("lodging.folioCashAdvances").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.folioNumber") != null && !jsonObj.get("lodging.folioNumber").isJsonNull()) && !jsonObj.get("lodging.folioNumber").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.foodBeverageCharges") != null && !jsonObj.get("lodging.foodBeverageCharges").isJsonNull()) && !jsonObj.get("lodging.foodBeverageCharges").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.noShowIndicator") != null && !jsonObj.get("lodging.noShowIndicator").isJsonNull()) && !jsonObj.get("lodging.noShowIndicator").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.prepaidExpenses") != null && !jsonObj.get("lodging.prepaidExpenses").isJsonNull()) && !jsonObj.get("lodging.prepaidExpenses").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.propertyPhoneNumber") != null && !jsonObj.get("lodging.propertyPhoneNumber").isJsonNull()) && !jsonObj.get("lodging.propertyPhoneNumber").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.room1.numberOfNights") != null && !jsonObj.get("lodging.room1.numberOfNights").isJsonNull()) && !jsonObj.get("lodging.room1.numberOfNights").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.room1.rate") != null && !jsonObj.get("lodging.room1.rate").isJsonNull()) && !jsonObj.get("lodging.room1.rate").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.totalRoomTax") != null && !jsonObj.get("lodging.totalRoomTax").isJsonNull()) && !jsonObj.get("lodging.totalRoomTax").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("lodging.totalTax") != null && !jsonObj.get("lodging.totalTax").isJsonNull()) && !jsonObj.get("lodging.totalTax").isJsonPrimitive()) {
