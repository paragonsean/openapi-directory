...
OAIPlatformChargebackLogic OAICancelRequest::getPlatformChargebackLogic() const {
    return m_platform_chargeback_logic;
}
void OAICancelRequest::setPlatformChargebackLogic(const OAIPlatformChargebackLogic &platform_chargeback_logic) {
    m_platform_chargeback_logic = platform_chargeback_logic;
    m_platform_chargeback_logic_isSet = true;
}

bool OAICancelRequest::is_platform_chargeback_logic_Set() const{
    return m_platform_chargeback_logic_isSet;
}

bool OAICancelRequest::is_platform_chargeback_logic_Valid() const{
