...
/*
 * OAIPaymentResult_additionalData.h
 *
 * Contains additional information about the payment. Some data fields are included only if you select them first: Go to **Customer Area** &gt; **Developers** &gt; **Additional data**.
 */

#ifndef OAIPaymentResult_additionalData_H
#define OAIPaymentResult_additionalData_H
...
class OAIPaymentResult_additionalData : public OAIObject {
public:
    OAIPaymentResult_additionalData();
    OAIPaymentResult_additionalData(QString json);
    ~OAIPaymentResult_additionalData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentResult_additionalData)

#endif // OAIPaymentResult_additionalData_H
