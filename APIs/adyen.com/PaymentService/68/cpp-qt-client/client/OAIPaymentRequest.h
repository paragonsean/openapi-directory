...
public:
    ...
    OAIFundDestination getFundDestination() const;
    void setFundDestination(const OAIFundDestination &fund_destination);
    bool is_fund_destination_Set() const;
    bool is_fund_destination_Valid() const;

    OAIFundSource getFundSource() const;
    void setFundSource(const OAIFundSource &fund_source);
    bool is_fund_source_Set() const;
    bool is_fund_source_Valid() const;
...
private:
    ...
    OAIFundDestination m_fund_destination;
    bool m_fund_destination_isSet;
    bool m_fund_destination_isValid;

    OAIFundSource m_fund_source;
    bool m_fund_source_isSet;
    bool m_fund_source_isValid;
