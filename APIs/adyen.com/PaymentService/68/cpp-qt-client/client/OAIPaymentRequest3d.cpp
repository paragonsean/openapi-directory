...
OAIPaymentRequest3d::OAIPaymentRequest3d(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentRequest3d::OAIPaymentRequest3d() {
    this->initializeModel();
}

OAIPaymentRequest3d::~OAIPaymentRequest3d() {}

void OAIPaymentRequest3d::initializeModel() {
    ...
    m_pa_response_isSet = false;
    m_pa_response_isValid = false;
...
void OAIPaymentRequest3d::fromJson(QString jsonString) {
...
void OAIPaymentRequest3d::fromJsonObject(QJsonObject json) {
    ...
    m_pa_response_isValid = ::OpenAPI::fromJsonValue(m_pa_response, json[QString("paResponse")]);
    m_pa_response_isSet = !json[QString("paResponse")].isNull() && m_pa_response_isValid;
...
QString OAIPaymentRequest3d::asJson() const {
...
QJsonObject OAIPaymentRequest3d::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_pa_response_isSet) {
        obj.insert(QString("paResponse"), ::OpenAPI::toJsonValue(m_pa_response));
    }
...
OAIAccountInfo OAIPaymentRequest3d::getAccountInfo() const {
    return m_account_info;
}
void OAIPaymentRequest3d::setAccountInfo(const OAIAccountInfo &account_info) {
    m_account_info = account_info;
    m_account_info_isSet = true;
}

bool OAIPaymentRequest3d::is_account_info_Set() const{
    return m_account_info_isSet;
}

bool OAIPaymentRequest3d::is_account_info_Valid() const{
    return m_account_info_isValid;
}

OAIAmount OAIPaymentRequest3d::getAdditionalAmount() const {
    return m_additional_amount;
}
void OAIPaymentRequest3d::setAdditionalAmount(const OAIAmount &additional_amount) {
    m_additional_amount = additional_amount;
    m_additional_amount_isSet = true;
}

bool OAIPaymentRequest3d::is_additional_amount_Set() const{
    return m_additional_amount_isSet;
}

bool OAIPaymentRequest3d::is_additional_amount_Valid() const{
    return m_additional_amount_isValid;
}

OAIPaymentRequest_additionalData OAIPaymentRequest3d::getAdditionalData() const {
    return m_additional_data;
}
void OAIPaymentRequest3d::setAdditionalData(const OAIPaymentRequest_additionalData &additional_data) {
    m_additional_data = additional_data;
    m_additional_data_isSet = true;
}

bool OAIPaymentRequest3d::is_additional_data_Set() const{
    return m_additional_data_isSet;
}

bool OAIPaymentRequest3d::is_additional_data_Valid() const{
    return m_additional_data_isValid;
}

OAIAmount OAIPaymentRequest3d::getAmount() const {
    return m_amount;
}
void OAIPaymentRequest3d::setAmount(const OAIAmount &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIPaymentRequest3d::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIPaymentRequest3d::is_amount_Valid() const{
    return m_amount_isValid;
}

OAIApplicationInfo OAIPaymentRequest3d::getApplicationInfo() const {
    return m_application_info;
}
void OAIPaymentRequest3d::setApplicationInfo(const OAIApplicationInfo &application_info) {
    m_application_info = application_info;
    m_application_info_isSet = true;
}

bool OAIPaymentRequest3d::is_application_info_Set() const{
    return m_application_info_isSet;
}

bool OAIPaymentRequest3d::is_application_info_Valid() const{
    return m_application_info_isValid;
}

OAIAddress OAIPaymentRequest3d::getBillingAddress() const {
    return m_billing_address;
}
void OAIPaymentRequest3d::setBillingAddress(const OAIAddress &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIPaymentRequest3d::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIPaymentRequest3d::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

OAIBrowserInfo OAIPaymentRequest3d::getBrowserInfo() const {
    return m_browser_info;
}
void OAIPaymentRequest3d::setBrowserInfo(const OAIBrowserInfo &browser_info) {
    m_browser_info = browser_info;
    m_browser_info_isSet = true;
}

bool OAIPaymentRequest3d::is_browser_info_Set() const{
    return m_browser_info_isSet;
}

bool OAIPaymentRequest3d::is_browser_info_Valid() const{
    return m_browser_info_isValid;
}

qint32 OAIPaymentRequest3d::getCaptureDelayHours() const {
    return m_capture_delay_hours;
}
void OAIPaymentRequest3d::setCaptureDelayHours(const qint32 &capture_delay_hours) {
    m_capture_delay_hours = capture_delay_hours;
    m_capture_delay_hours_isSet = true;
}

bool OAIPaymentRequest3d::is_capture_delay_hours_Set() const{
    return m_capture_delay_hours_isSet;
}

bool OAIPaymentRequest3d::is_capture_delay_hours_Valid() const{
    return m_capture_delay_hours_isValid;
}

QDate OAIPaymentRequest3d::getDateOfBirth() const {
    return m_date_of_birth;
}
void OAIPaymentRequest3d::setDateOfBirth(const QDate &date_of_birth) {
    m_date_of_birth = date_of_birth;
    m_date_of_birth_isSet = true;
}

bool OAIPaymentRequest3d::is_date_of_birth_Set() const{
    return m_date_of_birth_isSet;
}

bool OAIPaymentRequest3d::is_date_of_birth_Valid() const{
    return m_date_of_birth_isValid;
}

OAIForexQuote OAIPaymentRequest3d::getDccQuote() const {
    return m_dcc_quote;
}
void OAIPaymentRequest3d::setDccQuote(const OAIForexQuote &dcc_quote) {
    m_dcc_quote = dcc_quote;
    m_dcc_quote_isSet = true;
}

bool OAIPaymentRequest3d::is_dcc_quote_Set() const{
    return m_dcc_quote_isSet;
}

bool OAIPaymentRequest3d::is_dcc_quote_Valid() const{
    return m_dcc_quote_isValid;
}

OAIAddress OAIPaymentRequest3d::getDeliveryAddress() const {
    return m_delivery_address;
}
void OAIPaymentRequest3d::setDeliveryAddress(const OAIAddress &delivery_address) {
    m_delivery_address = delivery_address;
    m_delivery_address_isSet = true;
}

bool OAIPaymentRequest3d::is_delivery_address_Set() const{
    return m_delivery_address_isSet;
}

bool OAIPaymentRequest3d::is_delivery_address_Valid() const{
    return m_delivery_address_isValid;
}

QDateTime OAIPaymentRequest3d::getDeliveryDate() const {
    return m_delivery_date;
}
void OAIPaymentRequest3d::setDeliveryDate(const QDateTime &delivery_date) {
    m_delivery_date = delivery_date;
    m_delivery_date_isSet = true;
}

bool OAIPaymentRequest3d::is_delivery_date_Set() const{
    return m_delivery_date_isSet;
}

bool OAIPaymentRequest3d::is_delivery_date_Valid() const{
    return m_delivery_date_isValid;
}

QString OAIPaymentRequest3d::getDeviceFingerprint() const {
    return m_device_fingerprint;
}
void OAIPaymentRequest3d::setDeviceFingerprint(const QString &device_fingerprint) {
    m_device_fingerprint = device_fingerprint;
    m_device_fingerprint_isSet = true;
}

bool OAIPaymentRequest3d::is_device_fingerprint_Set() const{
    return m_device_fingerprint_isSet;
}

bool OAIPaymentRequest3d::is_device_fingerprint_Valid() const{
    return m_device_fingerprint_isValid;
}

qint32 OAIPaymentRequest3d::getFraudOffset() const {
    return m_fraud_offset;
}
void OAIPaymentRequest3d::setFraudOffset(const qint32 &fraud_offset) {
    m_fraud_offset = fraud_offset;
    m_fraud_offset_isSet = true;
}

bool OAIPaymentRequest3d::is_fraud_offset_Set() const{
    return m_fraud_offset_isSet;
}

bool OAIPaymentRequest3d::is_fraud_offset_Valid() const{
    return m_fraud_offset_isValid;
}

OAIInstallments OAIPaymentRequest3d::getInstallments() const {
    return m_installments;
}
void OAIPaymentRequest3d::setInstallments(const OAIInstallments &installments) {
    m_installments = installments;
    m_installments_isSet = true;
}

bool OAIPaymentRequest3d::is_installments_Set() const{
    return m_installments_isSet;
}

bool OAIPaymentRequest3d::is_installments_Valid() const{
    return m_installments_isValid;
}

QMap<QString, QString> OAIPaymentRequest3d::getLocalizedShopperStatement() const {
    return m_localized_shopper_statement;
}
void OAIPaymentRequest3d::setLocalizedShopperStatement(const QMap<QString, QString> &localized_shopper_statement) {
    m_localized_shopper_statement = localized_shopper_statement;
    m_localized_shopper_statement_isSet = true;
}

bool OAIPaymentRequest3d::is_localized_shopper_statement_Set() const{
    return m_localized_shopper_statement_isSet;
}

bool OAIPaymentRequest3d::is_localized_shopper_statement_Valid() const{
    return m_localized_shopper_statement_isValid;
}

QString OAIPaymentRequest3d::getMcc() const {
    return m_mcc;
}
void OAIPaymentRequest3d::setMcc(const QString &mcc) {
    m_mcc = mcc;
    m_mcc_isSet = true;
}

bool OAIPaymentRequest3d::is_mcc_Set() const{
    return m_mcc_isSet;
}

bool OAIPaymentRequest3d::is_mcc_Valid() const{
    return m_mcc_isValid;
}

QString OAIPaymentRequest3d::getMd() const {
    return m_md;
}
void OAIPaymentRequest3d::setMd(const QString &md) {
    m_md = md;
    m_md_isSet = true;
}

bool OAIPaymentRequest3d::is_md_Set() const{
    return m_md_isSet;
}

bool OAIPaymentRequest3d::is_md_Valid() const{
    return m_md_isValid;
}

QString OAIPaymentRequest3d::getMerchantAccount() const {
    return m_merchant_account;
}
void OAIPaymentRequest3d::setMerchantAccount(const QString &merchant_account) {
    m_merchant_account = merchant_account;
    m_merchant_account_isSet = true;
}

bool OAIPaymentRequest3d::is_merchant_account_Set() const{
    return m_merchant_account_isSet;
}

bool OAIPaymentRequest3d::is_merchant_account_Valid() const{
    return m_merchant_account_isValid;
}

QString OAIPaymentRequest3d::getMerchantOrderReference() const {
    return m_merchant_order_reference;
}
void OAIPaymentRequest3d::setMerchantOrderReference(const QString &merchant_order_reference) {
    m_merchant_order_reference = merchant_order_reference;
    m_merchant_order_reference_isSet = true;
}

bool OAIPaymentRequest3d::is_merchant_order_reference_Set() const{
    return m_merchant_order_reference_isSet;
}

bool OAIPaymentRequest3d::is_merchant_order_reference_Valid() const{
    return m_merchant_order_reference_isValid;
}

OAIMerchantRiskIndicator OAIPaymentRequest3d::getMerchantRiskIndicator() const {
    return m_merchant_risk_indicator;
}
void OAIPaymentRequest3d::setMerchantRiskIndicator(const OAIMerchantRiskIndicator &merchant_risk_indicator) {
    m_merchant_risk_indicator = merchant_risk_indicator;
    m_merchant_risk_indicator_isSet = true;
}

bool OAIPaymentRequest3d::is_merchant_risk_indicator_Set() const{
    return m_merchant_risk_indicator_isSet;
}

bool OAIPaymentRequest3d::is_merchant_risk_indicator_Valid() const{
    return m_merchant_risk_indicator_isValid;
}

QMap<QString, QString> OAIPaymentRequest3d::getMetadata() const {
    return m_metadata;
}
void OAIPaymentRequest3d::setMetadata(const QMap<QString, QString> &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIPaymentRequest3d::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIPaymentRequest3d::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QString OAIPaymentRequest3d::getOrderReference() const {
    return m_order_reference;
}
void OAIPaymentRequest3d::setOrderReference(const QString &order_reference) {
    m_order_reference = order_reference;
    m_order_reference_isSet = true;
}

bool OAIPaymentRequest3d::is_order_reference_Set() const{
    return m_order_reference_isSet;
}

bool OAIPaymentRequest3d::is_order_reference_Valid() const{
    return m_order_reference_isValid;
}

QString OAIPaymentRequest3d::getPaResponse() const {
    return m_pa_response;
}
void OAIPaymentRequest3d::setPaResponse(const QString &pa_response) {
    m_pa_response = pa_response;
    m_pa_response_isSet = true;
}

bool OAIPaymentRequest3d::is_pa_response_Set() const{
    return m_pa_response_isSet;
}

bool OAIPaymentRequest3d::is_pa_response_Valid() const{
    return m_pa_response_isValid;
}

OAIRecurring OAIPaymentRequest3d::getRecurring() const {
    return m_recurring;
}
void OAIPaymentRequest3d::setRecurring(const OAIRecurring &recurring) {
    m_recurring = recurring;
    m_recurring_isSet = true;
}

bool OAIPaymentRequest3d::is_recurring_Set() const{
    return m_recurring_isSet;
}

bool OAIPaymentRequest3d::is_recurring_Valid() const{
    return m_recurring_isValid;
}

QString OAIPaymentRequest3d::getRecurringProcessingModel() const {
    return m_recurring_processing_model;
}
void OAIPaymentRequest3d::setRecurringProcessingModel(const QString &recurring_processing_model) {
    m_recurring_processing_model = recurring_processing_model;
    m_recurring_processing_model_isSet = true;
}

bool OAIPaymentRequest3d::is_recurring_processing_model_Set() const{
    return m_recurring_processing_model_isSet;
}

bool OAIPaymentRequest3d::is_recurring_processing_model_Valid() const{
    return m_recurring_processing_model_isValid;
}

QString OAIPaymentRequest3d::getReference() const {
    return m_reference;
}
void OAIPaymentRequest3d::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAIPaymentRequest3d::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAIPaymentRequest3d::is_reference_Valid() const{
    return m_reference_isValid;
}

QString OAIPaymentRequest3d::getSelectedBrand() const {
    return m_selected_brand;
}
void OAIPaymentRequest3d::setSelectedBrand(const QString &selected_brand) {
    m_selected_brand = selected_brand;
    m_selected_brand_isSet = true;
}

bool OAIPaymentRequest3d::is_selected_brand_Set() const{
    return m_selected_brand_isSet;
}

bool OAIPaymentRequest3d::is_selected_brand_Valid() const{
    return m_selected_brand_isValid;
}

QString OAIPaymentRequest3d::getSelectedRecurringDetailReference() const {
    return m_selected_recurring_detail_reference;
}
void OAIPaymentRequest3d::setSelectedRecurringDetailReference(const QString &selected_recurring_detail_reference) {
...
bool OAIPaymentRequest3d::is_selected_recurring_detail_reference_Set() const{
    return m_selected_recurring_detail_reference_isSet;
}

bool OAIPaymentRequest3d::is_selected_recurring_detail_reference_Valid() const{
    return m_selected_recurring_detail_reference_isValid;
}

QString OAIPaymentRequest3d::getSessionId() const {
    return m_session_id;
}
void OAIPaymentRequest3d::setSessionId(const QString &session_id) {
    m_session_id = session_id;
    m_session_id_isSet = true;
}

bool OAIPaymentRequest3d::is_session_id_Set() const{
    return m_session_id_isSet;
}

bool OAIPaymentRequest3d::is_session_id_Valid() const{
    return m_session_id_isValid;
}

QString OAIPaymentRequest3d::getShopperEmail() const {
    return m_shopper_email;
}
void OAIPaymentRequest3d::setShopperEmail(const QString &shopper_email) {
    m_shopper_email = shopper_email;
    m_shopper_email_isSet = true;
}

bool OAIPaymentRequest3d::is_shopper_email_Set() const{
    return m_shopper_email_isSet;
}

bool OAIPaymentRequest3d::is_shopper_email_Valid() const{
    return m_shopper_email_isValid;
}

QString OAIPaymentRequest3d::getShopperIp() const {
    return m_shopper_ip;
}
void OAIPaymentRequest3d::setShopperIp(const QString &shopper_ip) {
    m_shopper_ip = shopper_ip;
    m_shopper_ip_isSet = true;
}

bool OAIPaymentRequest3d::is_shopper_ip_Set() const{
    return m_shopper_ip_isSet;
}

bool OAIPaymentRequest3d::is_shopper_ip_Valid() const{
    return m_shopper_ip_isValid;
}

QString OAIPaymentRequest3d::getShopperInteraction() const {
    return m_shopper_interaction;
}
void OAIPaymentRequest3d::setShopperInteraction(const QString &shopper_interaction) {
    m_shopper_interaction = shopper_interaction;
    m_shopper_interaction_isSet = true;
}

bool OAIPaymentRequest3d::is_shopper_interaction_Set() const{
    return m_shopper_interaction_isSet;
}

bool OAIPaymentRequest3d::is_shopper_interaction_Valid() const{
    return m_shopper_interaction_isValid;
}

QString OAIPaymentRequest3d::getShopperLocale() const {
    return m_shopper_locale;
}
void OAIPaymentRequest3d::setShopperLocale(const QString &shopper_locale) {
    m_shopper_locale = shopper_locale;
    m_shopper_locale_isSet = true;
}

bool OAIPaymentRequest3d::is_shopper_locale_Set() const{
    return m_shopper_locale_isSet;
}

bool OAIPaymentRequest3d::is_shopper_locale_Valid() const{
    return m_shopper_locale_isValid;
}

OAIName OAIPaymentRequest3d::getShopperName() const {
    return m_shopper_name;
}
void OAIPaymentRequest3d::setShopperName(const OAIName &shopper_name) {
    m_shopper_name = shopper_name;
    m_shopper_name_isSet = true;
}

bool OAIPaymentRequest3d::is_shopper_name_Set() const{
    return m_shopper_name_isSet;
}

bool OAIPaymentRequest3d::is_shopper_name_Valid() const{
    return m_shopper_name_isValid;
}

QString OAIPaymentRequest3d::getShopperReference() const {
    return m_shopper_reference;
}
void OAIPaymentRequest3d::setShopperReference(const QString &shopper_reference) {
    m_shopper_reference = shopper_reference;
    m_shopper_reference_isSet = true;
}

bool OAIPaymentRequest3d::is_shopper_reference_Set() const{
    return m_shopper_reference_isSet;
}

bool OAIPaymentRequest3d::is_shopper_reference_Valid() const{
    return m_shopper_reference_isValid;
}

QString OAIPaymentRequest3d::getShopperStatement() const {
    return m_shopper_statement;
}
void OAIPaymentRequest3d::setShopperStatement(const QString &shopper_statement) {
    m_shopper_statement = shopper_statement;
    m_shopper_statement_isSet = true;
}

bool OAIPaymentRequest3d::is_shopper_statement_Set() const{
    return m_shopper_statement_isSet;
}

bool OAIPaymentRequest3d::is_shopper_statement_Valid() const{
    return m_shopper_statement_isValid;
}

QString OAIPaymentRequest3d::getSocialSecurityNumber() const {
    return m_social_security_number;
}
void OAIPaymentRequest3d::setSocialSecurityNumber(const QString &social_security_number) {
    m_social_security_number = social_security_number;
    m_social_security_number_isSet = true;
}

bool OAIPaymentRequest3d::is_social_security_number_Set() const{
    return m_social_security_number_isSet;
}

bool OAIPaymentRequest3d::is_social_security_number_Valid() const{
    return m_social_security_number_isValid;
}

QList<OAISplit> OAIPaymentRequest3d::getSplits() const {
    return m_splits;
}
void OAIPaymentRequest3d::setSplits(const QList<OAISplit> &splits) {
    m_splits = splits;
    m_splits_isSet = true;
}

bool OAIPaymentRequest3d::is_splits_Set() const{
    return m_splits_isSet;
}

bool OAIPaymentRequest3d::is_splits_Valid() const{
    return m_splits_isValid;
}

QString OAIPaymentRequest3d::getStore() const {
    return m_store;
}
void OAIPaymentRequest3d::setStore(const QString &store) {
    m_store = store;
    m_store_isSet = true;
}

bool OAIPaymentRequest3d::is_store_Set() const{
    return m_store_isSet;
}

bool OAIPaymentRequest3d::is_store_Valid() const{
    return m_store_isValid;
}

QString OAIPaymentRequest3d::getTelephoneNumber() const {
    return m_telephone_number;
}
void OAIPaymentRequest3d::setTelephoneNumber(const QString &telephone_number) {
    m_telephone_number = telephone_number;
    m_telephone_number_isSet = true;
}

bool OAIPaymentRequest3d::is_telephone_number_Set() const{
    return m_telephone_number_isSet;
}

bool OAIPaymentRequest3d::is_telephone_number_Valid() const{
    return m_telephone_number_isValid;
}

OAIThreeDS2RequestData OAIPaymentRequest3d::getThreeDs2RequestData() const {
    return m_three_ds2_request_data;
}
void OAIPaymentRequest3d::setThreeDs2RequestData(const OAIThreeDS2RequestData &three_ds2_request_data) {
    m_three_ds2_request_data = three_ds2_request_data;
    m_three_ds2_request_data_isSet = true;
}

bool OAIPaymentRequest3d::is_three_ds2_request_data_Set() const{
    return m_three_ds2_request_data_isSet;
}

bool OAIPaymentRequest3d::is_three_ds2_request_data_Valid() const{
    return m_three_ds2_request_data_isValid;
}

bool OAIPaymentRequest3d::isThreeDsAuthenticationOnly() const {
    return m_three_ds_authentication_only;
}
void OAIPaymentRequest3d::setThreeDsAuthenticationOnly(const bool &three_ds_authentication_only) {
    m_three_ds_authentication_only = three_ds_authentication_only;
    m_three_ds_authentication_only_isSet = true;
}

bool OAIPaymentRequest3d::is_three_ds_authentication_only_Set() const{
    return m_three_ds_authentication_only_isSet;
}

bool OAIPaymentRequest3d::is_three_ds_authentication_only_Valid() const{
    return m_three_ds_authentication_only_isValid;
}

QString OAIPaymentRequest3d::getTotalsGroup() const {
    return m_totals_group;
}
void OAIPaymentRequest3d::setTotalsGroup(const QString &totals_group) {
    m_totals_group = totals_group;
    m_totals_group_isSet = true;
}

bool OAIPaymentRequest3d::is_totals_group_Set() const{
    return m_totals_group_isSet;
}

bool OAIPaymentRequest3d::is_totals_group_Valid() const{
    return m_totals_group_isValid;
}

bool OAIPaymentRequest3d::isTrustedShopper() const {
    return m_trusted_shopper;
}
void OAIPaymentRequest3d::setTrustedShopper(const bool &trusted_shopper) {
    m_trusted_shopper = trusted_shopper;
    m_trusted_shopper_isSet = true;
}

bool OAIPaymentRequest3d::is_trusted_shopper_Set() const{
    return m_trusted_shopper_isSet;
}

bool OAIPaymentRequest3d::is_trusted_shopper_Valid() const{
    return m_trusted_shopper_isValid;
}

bool OAIPaymentRequest3d::isSet() const {
...
bool OAIPaymentRequest3d::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_md_isValid && m_merchant_account_isValid && m_pa_response_isValid && true;
}
