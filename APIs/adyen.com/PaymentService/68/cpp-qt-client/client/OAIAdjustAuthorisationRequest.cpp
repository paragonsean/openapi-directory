...
OAIPlatformChargebackLogic OAIAdjustAuthorisationRequest::getPlatformChargebackLogic() const {
    return m_platform_chargeback_logic;
}
void OAIAdjustAuthorisationRequest::setPlatformChargebackLogic(const OAIPlatformChargebackLogic &platform_chargeback_logic) {
    m_platform_chargeback_logic = platform_chargeback_logic;
    m_platform_chargeback_logic_isSet = true;
}

bool OAIAdjustAuthorisationRequest::is_platform_chargeback_logic_Set() const{
    return m_platform_chargeback_logic_isSet;
}

bool OAIAdjustAuthorisationRequest::is_platform_chargeback_logic_Valid() const{
