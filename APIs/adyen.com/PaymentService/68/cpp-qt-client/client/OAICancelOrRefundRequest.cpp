...
OAIAdjustAuthorisationRequest_additionalData OAICancelOrRefundRequest::getAdditionalData() const {
    return m_additional_data;
}
void OAICancelOrRefundRequest::setAdditionalData(const OAIAdjustAuthorisationRequest_additionalData &additional_data) {
...
OAIThreeDSecureData OAICancelOrRefundRequest::getMpiData() const {
    return m_mpi_data;
}
void OAICancelOrRefundRequest::setMpiData(const OAIThreeDSecureData &mpi_data) {
    m_mpi_data = mpi_data;
    m_mpi_data_isSet = true;
}

bool OAICancelOrRefundRequest::is_mpi_data_Set() const{
    return m_mpi_data_isSet;
}

bool OAICancelOrRefundRequest::is_mpi_data_Valid() const{
    return m_mpi_data_isValid;
}

QString OAICancelOrRefundRequest::getOriginalMerchantReference() const {
    return m_original_merchant_reference;
}
void OAICancelOrRefundRequest::setOriginalMerchantReference(const QString &original_merchant_reference) {
    m_original_merchant_reference = original_merchant_reference;
    m_original_merchant_reference_isSet = true;
}

bool OAICancelOrRefundRequest::is_original_merchant_reference_Set() const{
    return m_original_merchant_reference_isSet;
}

bool OAICancelOrRefundRequest::is_original_merchant_reference_Valid() const{
...
OAIPlatformChargebackLogic OAICancelOrRefundRequest::getPlatformChargebackLogic() const {
    return m_platform_chargeback_logic;
}
void OAICancelOrRefundRequest::setPlatformChargebackLogic(const OAIPlatformChargebackLogic &platform_chargeback_logic) {
    m_platform_chargeback_logic = platform_chargeback_logic;
    m_platform_chargeback_logic_isSet = true;
}

bool OAICancelOrRefundRequest::is_platform_chargeback_logic_Set() const{
    return m_platform_chargeback_logic_isSet;
}

bool OAICancelOrRefundRequest::is_platform_chargeback_logic_Valid() const{
