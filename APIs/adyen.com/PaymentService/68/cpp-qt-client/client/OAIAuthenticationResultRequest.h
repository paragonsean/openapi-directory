...
/*
 * OAIAuthenticationResultRequest.h
 *
 * 
 */

#ifndef OAIAuthenticationResultRequest_H
#define OAIAuthenticationResultRequest_H
...
class OAIAuthenticationResultRequest : public OAIObject {
public:
    OAIAuthenticationResultRequest();
    OAIAuthenticationResultRequest(QString json);
    ~OAIAuthenticationResultRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthenticationResultRequest)

#endif // OAIAuthenticationResultRequest_H
