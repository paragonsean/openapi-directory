...
QMap<QString, QString> OAIPaymentRequest3ds2::getLocalizedShopperStatement() const {
    return m_localized_shopper_statement;
}
void OAIPaymentRequest3ds2::setLocalizedShopperStatement(const QMap<QString, QString> &localized_shopper_statement) {
    m_localized_shopper_statement = localized_shopper_statement;
    m_localized_shopper_statement_isSet = true;
}

bool OAIPaymentRequest3ds2::is_localized_shopper_statement_Set() const{
    return m_localized_shopper_statement_isSet;
}

bool OAIPaymentRequest3ds2::is_localized_shopper_statement_Valid() const{
