...
All URIs are relative to *https://pal-test.adyen.com/pal/servlet/Payment/v46*
...
> ModificationResult postAdjustAuthorisation(opts)
...
let opts = {
  'adjustAuthorisationRequest': new AdyenPaymentApi.AdjustAuthorisationRequest() // AdjustAuthorisationRequest | 
};
apiInstance.postAdjustAuthorisation(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ModificationResult postDonate(opts)
...
let apiInstance = new AdyenPaymentApi.ModificationsApi();
let opts = {
  'donationRequest': new AdyenPaymentApi.DonationRequest() // DonationRequest | 
};
apiInstance.postDonate(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ModificationResult postTechnicalCancel(opts)
...
let apiInstance = new AdyenPaymentApi.ModificationsApi();
let opts = {
  'technicalCancelRequest': new AdyenPaymentApi.TechnicalCancelRequest() // TechnicalCancelRequest | 
};
apiInstance.postTechnicalCancel(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
