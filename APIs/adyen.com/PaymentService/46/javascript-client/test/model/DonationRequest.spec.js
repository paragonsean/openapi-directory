...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPaymentApi.DonationRequest();
  });
  ...
  describe('DonationRequest', function() {
    it('should create an instance of DonationRequest', function() {
      // uncomment below and update the code to test DonationRequest
      //var instance = new AdyenPaymentApi.DonationRequest();
      //expect(instance).to.be.a(AdyenPaymentApi.DonationRequest);
    });
