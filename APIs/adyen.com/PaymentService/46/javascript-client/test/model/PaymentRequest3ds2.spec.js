...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPaymentApi.PaymentRequest3ds2();
  });
  ...
  describe('PaymentRequest3ds2', function() {
    it('should create an instance of PaymentRequest3ds2', function() {
      // uncomment below and update the code to test PaymentRequest3ds2
      //var instance = new AdyenPaymentApi.PaymentRequest3ds2();
      //expect(instance).to.be.a(AdyenPaymentApi.PaymentRequest3ds2);
    });
    ...
    it('should have the property threeDS2Token (base name: "threeDS2Token")', function() {
      // uncomment below and update the code to test the property threeDS2Token
      //var instance = new AdyenPaymentApi.PaymentRequest3ds2();
      //expect(instance).to.be();
    });
