...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPaymentApi.ThreeDS2ResultResponse();
  });
  ...
  describe('ThreeDS2ResultResponse', function() {
    it('should create an instance of ThreeDS2ResultResponse', function() {
      // uncomment below and update the code to test ThreeDS2ResultResponse
      //var instance = new AdyenPaymentApi.ThreeDS2ResultResponse();
      //expect(instance).to.be.a(AdyenPaymentApi.ThreeDS2ResultResponse);
    });
