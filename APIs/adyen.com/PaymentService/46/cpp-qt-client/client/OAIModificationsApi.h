...
public:
    ...
    */
    ...
    /**
    * @param[in]  oai_donation_request OAIDonationRequest [optional]
    */
    virtual void postDonate(const ::OpenAPI::OptionalParam<OAIDonationRequest> &oai_donation_request = ::OpenAPI::OptionalParam<OAIDonationRequest>());
...
private:
    ...
    void postDonateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void postDonateSignal(OAIModificationResult summary);
    ...
    void postDonateSignalFull(OAIHttpRequestWorker *worker, OAIModificationResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use postDonateSignalError() instead")
    void postDonateSignalE(OAIModificationResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postDonateSignalError(OAIModificationResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use postDonateSignalErrorFull() instead")
    void postDonateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postDonateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
