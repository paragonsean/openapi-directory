...
async def test_post_adjust_authorisation(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v46/adjustAuthorisation',
        headers=headers,
        json=body,
        )
...
async def test_post_cancel(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v46/cancel',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_cancel_or_refund(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v46/cancelOrRefund',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_capture(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v46/capture',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_donate(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v46/donate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_refund(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v46/refund',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_technical_cancel(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v46/technicalCancel',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_void_pending_refund(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v46/voidPendingRefund',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
