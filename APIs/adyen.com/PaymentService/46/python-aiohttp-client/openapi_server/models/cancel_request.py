...
class CancelRequest(Model):
    ...
    def __init__(self, additional_data: AdjustAuthorisationRequestAdditionalData=None, merchant_account: str=None, mpi_data: ThreeDSecureData=None, original_merchant_reference: str=None, original_reference: str=None, reference: str=None, splits: List[Split]=None, tender_reference: str=None, unique_terminal_id: str=None):
        ...
        :param mpi_data: The mpi_data of this CancelRequest.
        :param original_merchant_reference: The original_merchant_reference of this CancelRequest.
        :param original_reference: The original_reference of this CancelRequest.
        :param reference: The reference of this CancelRequest.
        :param splits: The splits of this CancelRequest.
    ...
    @property
    def mpi_data(self):
        """Gets the mpi_data of this CancelRequest.

        Authentication data produced by an MPI (Mastercard SecureCode, Visa Secure, or Cartes Bancaires).

        :return: The mpi_data of this CancelRequest.
    ...
    def mpi_data(self, mpi_data):
        """Sets the mpi_data of this CancelRequest.
    ...
    def original_merchant_reference(self):
        """Gets the original_merchant_reference of this CancelRequest.

        The original merchant reference to cancel.

        :return: The original_merchant_reference of this CancelRequest.
        :rtype: str
        """
    ...
    def original_merchant_reference(self, original_merchant_reference):
        """Sets the original_merchant_reference of this CancelRequest.
    ...
    @property
    def splits(self):
        """Gets the splits of this CancelRequest.

        An array of objects specifying how the amount should be split between accounts when using Adyen for Platforms. For details, refer to [Providing split information](https://docs.adyen.com/marketplaces-and-platforms/processing-payments#providing-split-information).

        :return: The splits of this CancelRequest.
        :rtype: List[Split]
        """
        return self._splits
    ...
    def splits(self, splits):
        """Sets the splits of this CancelRequest.
