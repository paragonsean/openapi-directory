...
class ThreeDS2RequestData(Model):
    ...
    def __init__(self, authentication_only: bool=False, challenge_indicator: str=None, device_channel: str=None, device_render_options: DeviceRenderOptions=None, message_version: str=None, notification_url: str=None, sdk_app_id: str=None, sdk_enc_data: str=None, sdk_ephem_pub_key: SDKEphemPubKey=None, sdk_max_timeout: int=60, sdk_reference_number: str=None, sdk_trans_id: str=None, sdk_version: str=None, three_ds_comp_ind: str=None, three_ds_requestor_id: str=None, three_ds_requestor_name: str=None, three_ds_requestor_url: str=None):
