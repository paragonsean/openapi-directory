...
public class AdjustAuthorisationRequestAdditionalData extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AdjustAuthorisationRequestAdditionalData.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AdjustAuthorisationRequestAdditionalData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AdjustAuthorisationRequestAdditionalData' and its subtypes
            }
            ...
            final TypeAdapter<AdditionalDataModifications> adapterAdditionalDataModifications = gson.getDelegateAdapter(this, TypeToken.get(AdditionalDataModifications.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<AdjustAuthorisationRequestAdditionalData>() {
                @Override
                public void write(JsonWriter out, AdjustAuthorisationRequestAdditionalData value) throws IOException {
                    ...
                    // check if the actual instance is of the type `AdditionalDataModifications`
                    if (value.getActualInstance() instanceof AdditionalDataModifications) {
                        JsonElement element = adapterAdditionalDataModifications.toJsonTree((AdditionalDataModifications)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                ...
                @Override
                public AdjustAuthorisationRequestAdditionalData read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        AdjustAuthorisationRequestAdditionalData ret = new AdjustAuthorisationRequestAdditionalData();
                    ...
                    // deserialize AdditionalDataModifications
                    try {
                        // validate the JSON object to see if any exception is thrown
                        AdditionalDataModifications.validateJsonElement(jsonElement);
                        actualAdapter = adapterAdditionalDataModifications;
                        AdjustAuthorisationRequestAdditionalData ret = new AdjustAuthorisationRequestAdditionalData();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for AdditionalDataModifications failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'AdditionalDataModifications'", e);
                    }
                    ...
                    throw new IOException(String.format("Failed deserialization for AdjustAuthorisationRequestAdditionalData: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AdjustAuthorisationRequestAdditionalData() {
        super("anyOf", Boolean.FALSE);
    }

    public AdjustAuthorisationRequestAdditionalData(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("AdditionalDataModifications", AdditionalDataModifications.class);
    ...
    public Map<String, Class<?>> getSchemas() {
        return AdjustAuthorisationRequestAdditionalData.schemas;
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof AdditionalDataModifications) {
            super.setActualInstance(instance);
            return;
        }
    ...
    /**
     * Get the actual instance of `AdditionalDataModifications`. If the actual instance is not `AdditionalDataModifications`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AdditionalDataModifications`
     * @throws ClassCastException if the instance is not `AdditionalDataModifications`
     */
    public AdditionalDataModifications getAdditionalDataModifications() throws ClassCastException {
        return (AdditionalDataModifications)super.getActualInstance();
    }
    /**
     ...
     * @throws IOException if the JSON Element is invalid with respect to AdjustAuthorisationRequestAdditionalData
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with AdditionalDataModifications
        try {
            AdditionalDataModifications.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        throw new IOException(String.format("The JSON string is invalid for AdjustAuthorisationRequestAdditionalData with anyOf schemas: AdditionalData3DSecure, AdditionalDataAirline, AdditionalDataCarRental, AdditionalDataCommon, AdditionalDataLevel23, AdditionalDataLodging, AdditionalDataModifications, AdditionalDataOpenInvoice, AdditionalDataOpi, AdditionalDataRatepay, AdditionalDataRetry, AdditionalDataRisk, AdditionalDataRiskStandalone, AdditionalDataSubMerchant, AdditionalDataTemporaryServices, AdditionalDataWallets. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of AdjustAuthorisationRequestAdditionalData given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AdjustAuthorisationRequestAdditionalData
     * @throws IOException if the JSON string is invalid with respect to AdjustAuthorisationRequestAdditionalData
     */
    public static AdjustAuthorisationRequestAdditionalData fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AdjustAuthorisationRequestAdditionalData.class);
    }

    /**
     * Convert an instance of AdjustAuthorisationRequestAdditionalData to an JSON string
     *
     * @return JSON string
     */
