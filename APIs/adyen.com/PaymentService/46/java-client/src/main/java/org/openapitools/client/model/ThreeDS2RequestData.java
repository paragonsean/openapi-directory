...
public class ThreeDS2RequestData {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authenticationOnly, challengeIndicator, deviceChannel, deviceRenderOptions, messageVersion, notificationURL, sdkAppID, sdkEncData, sdkEphemPubKey, sdkMaxTimeout, sdkReferenceNumber, sdkTransID, sdkVersion, threeDSCompInd, threeDSRequestorID, threeDSRequestorName, threeDSRequestorURL);
  }
