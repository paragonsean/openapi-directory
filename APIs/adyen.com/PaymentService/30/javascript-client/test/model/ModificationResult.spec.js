...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPaymentApi.ModificationResult();
  });
  ...
  describe('ModificationResult', function() {
    it('should create an instance of ModificationResult', function() {
      ...
      //var instance = new AdyenPaymentApi.ModificationResult();
      //expect(instance).to.be.a(AdyenPaymentApi.ModificationResult);
    });
