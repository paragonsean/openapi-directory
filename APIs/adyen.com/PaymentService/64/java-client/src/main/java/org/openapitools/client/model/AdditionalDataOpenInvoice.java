...
public class AdditionalDataOpenInvoice {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdditionalDataOpenInvoice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdditionalDataOpenInvoice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdditionalDataOpenInvoice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdditionalDataOpenInvoice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("openinvoicedata.merchantData") != null && !jsonObj.get("openinvoicedata.merchantData").isJsonNull()) && !jsonObj.get("openinvoicedata.merchantData").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedata.numberOfLines") != null && !jsonObj.get("openinvoicedata.numberOfLines").isJsonNull()) && !jsonObj.get("openinvoicedata.numberOfLines").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedata.recipientFirstName") != null && !jsonObj.get("openinvoicedata.recipientFirstName").isJsonNull()) && !jsonObj.get("openinvoicedata.recipientFirstName").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedata.recipientLastName") != null && !jsonObj.get("openinvoicedata.recipientLastName").isJsonNull()) && !jsonObj.get("openinvoicedata.recipientLastName").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].currencyCode") != null && !jsonObj.get("openinvoicedataLine[itemNr].currencyCode").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].currencyCode").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].description") != null && !jsonObj.get("openinvoicedataLine[itemNr].description").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].description").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].itemAmount") != null && !jsonObj.get("openinvoicedataLine[itemNr].itemAmount").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].itemAmount").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].itemId") != null && !jsonObj.get("openinvoicedataLine[itemNr].itemId").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].itemId").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].itemVatAmount") != null && !jsonObj.get("openinvoicedataLine[itemNr].itemVatAmount").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].itemVatAmount").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].itemVatPercentage") != null && !jsonObj.get("openinvoicedataLine[itemNr].itemVatPercentage").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].itemVatPercentage").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].numberOfItems") != null && !jsonObj.get("openinvoicedataLine[itemNr].numberOfItems").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].numberOfItems").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].returnShippingCompany") != null && !jsonObj.get("openinvoicedataLine[itemNr].returnShippingCompany").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].returnShippingCompany").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].returnTrackingNumber") != null && !jsonObj.get("openinvoicedataLine[itemNr].returnTrackingNumber").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].returnTrackingNumber").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].returnTrackingUri") != null && !jsonObj.get("openinvoicedataLine[itemNr].returnTrackingUri").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].returnTrackingUri").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].shippingCompany") != null && !jsonObj.get("openinvoicedataLine[itemNr].shippingCompany").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].shippingCompany").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].shippingMethod") != null && !jsonObj.get("openinvoicedataLine[itemNr].shippingMethod").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].shippingMethod").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].trackingNumber") != null && !jsonObj.get("openinvoicedataLine[itemNr].trackingNumber").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].trackingNumber").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("openinvoicedataLine[itemNr].trackingUri") != null && !jsonObj.get("openinvoicedataLine[itemNr].trackingUri").isJsonNull()) && !jsonObj.get("openinvoicedataLine[itemNr].trackingUri").isJsonPrimitive()) {
