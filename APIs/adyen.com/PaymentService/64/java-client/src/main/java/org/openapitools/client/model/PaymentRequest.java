...
import org.openapitools.client.model.FundDestination;
...
public class PaymentRequest {
  ...
  public PaymentRequest additionalData(PaymentRequestAdditionalData additionalData) {
  ...
  @Deprecated
  public PaymentRequest enableRealTimeUpdate(Boolean enableRealTimeUpdate) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("fundDestination") != null && !jsonObj.get("fundDestination").isJsonNull()) {
        FundDestination.validateJsonElement(jsonObj.get("fundDestination"));
      }
