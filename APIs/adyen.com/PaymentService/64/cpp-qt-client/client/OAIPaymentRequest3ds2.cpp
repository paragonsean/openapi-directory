...
bool OAIPaymentRequest3ds2::isEnableRealTimeUpdate() const {
    return m_enable_real_time_update;
}
void OAIPaymentRequest3ds2::setEnableRealTimeUpdate(const bool &enable_real_time_update) {
    m_enable_real_time_update = enable_real_time_update;
    m_enable_real_time_update_isSet = true;
}

bool OAIPaymentRequest3ds2::is_enable_real_time_update_Set() const{
    return m_enable_real_time_update_isSet;
}

bool OAIPaymentRequest3ds2::is_enable_real_time_update_Valid() const{
