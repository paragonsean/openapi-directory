...
class PaymentRequest(Model):
    ...
    def __init__(self, additional_amount: Amount=None, additional_data: PaymentRequestAdditionalData=None, amount: Amount=None, bank_account: BankAccount=None, billing_address: Address=None, browser_info: BrowserInfo=None, capture_delay_hours: int=None, card: Card=None, date_of_birth: date=None, dcc_quote: ForexQuote=None, delivery_address: Address=None, delivery_date: datetime=None, device_fingerprint: str=None, entity_type: str=None, fraud_offset: int=None, installments: Installments=None, mandate: Mandate=None, mcc: str=None, merchant_account: str=None, merchant_order_reference: str=None, metadata: Dict[str, str]=None, mpi_data: ThreeDSecureData=None, nationality: str=None, order_reference: str=None, recurring: Recurring=None, reference: str=None, selected_brand: str=None, selected_recurring_detail_reference: str=None, session_id: str=None, shopper_email: str=None, shopper_ip: str=None, shopper_interaction: str=None, shopper_locale: str=None, shopper_name: Name=None, shopper_reference: str=None, shopper_statement: str=None, social_security_number: str=None, store: str=None, telephone_number: str=None, totals_group: str=None):
