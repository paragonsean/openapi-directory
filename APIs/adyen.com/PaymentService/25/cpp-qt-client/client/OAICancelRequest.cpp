...
OAICancelOrRefundRequest_additionalData OAICancelRequest::getAdditionalData() const {
    return m_additional_data;
}
void OAICancelRequest::setAdditionalData(const OAICancelOrRefundRequest_additionalData &additional_data) {
