...
OAICancelOrRefundRequest_additionalData OAICaptureRequest::getAdditionalData() const {
    return m_additional_data;
}
void OAICaptureRequest::setAdditionalData(const OAICancelOrRefundRequest_additionalData &additional_data) {
