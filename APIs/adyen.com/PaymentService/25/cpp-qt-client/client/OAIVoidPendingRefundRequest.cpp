...
OAICancelOrRefundRequest_additionalData OAIVoidPendingRefundRequest::getAdditionalData() const {
    return m_additional_data;
}
void OAIVoidPendingRefundRequest::setAdditionalData(const OAICancelOrRefundRequest_additionalData &additional_data) {
