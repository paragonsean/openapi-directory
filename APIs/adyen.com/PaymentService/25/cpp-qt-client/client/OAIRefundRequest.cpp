...
OAICancelOrRefundRequest_additionalData OAIRefundRequest::getAdditionalData() const {
    return m_additional_data;
}
void OAIRefundRequest::setAdditionalData(const OAICancelOrRefundRequest_additionalData &additional_data) {
