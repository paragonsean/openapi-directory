...
OAICancelRequest Example::create(){
    OAICancelRequest obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIModificationsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIModificationsApi::postCancelSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIModificationsApi::postCancelSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICancelRequest oai_cancel_request = create(); // OAICancelRequest | 
      apiInstance.postCancel(oai_cancel_request);
