...
public class RefundRequest {
  ...
  public RefundRequest additionalData(CancelOrRefundRequestAdditionalData additionalData) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalData, merchantAccount, modificationAmount, originalReference, reference, tenderReference, uniqueTerminalId);
  }
