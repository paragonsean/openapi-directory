...
import org.openapitools.client.model.CancelOrRefundRequestAdditionalData;
...
public class CancelRequest {
  ...
  private CancelOrRefundRequestAdditionalData additionalData;
  ...
  public CancelRequest additionalData(CancelOrRefundRequestAdditionalData additionalData) {
  ...
  public CancelOrRefundRequestAdditionalData getAdditionalData() {
    return additionalData;
  }

  public void setAdditionalData(CancelOrRefundRequestAdditionalData additionalData) {
    this.additionalData = additionalData;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalData, merchantAccount, originalReference, reference, tenderReference, uniqueTerminalId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("additionalData") != null && !jsonObj.get("additionalData").isJsonNull()) {
        CancelOrRefundRequestAdditionalData.validateJsonElement(jsonObj.get("additionalData"));
      }
