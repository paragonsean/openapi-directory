...
public class PaymentRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalAmount, additionalData, amount, bankAccount, billingAddress, browserInfo, captureDelayHours, card, dateOfBirth, dccQuote, deliveryAddress, deliveryDate, deviceFingerprint, entityType, fraudOffset, installments, mandate, mcc, merchantAccount, merchantOrderReference, metadata, mpiData, nationality, orderReference, recurring, reference, selectedBrand, selectedRecurringDetailReference, sessionId, shopperEmail, shopperIP, shopperInteraction, shopperLocale, shopperName, shopperReference, shopperStatement, socialSecurityNumber, store, telephoneNumber, totalsGroup);
  }
