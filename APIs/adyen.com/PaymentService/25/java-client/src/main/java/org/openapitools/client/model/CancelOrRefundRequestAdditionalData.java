...
public class CancelOrRefundRequestAdditionalData extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CancelOrRefundRequestAdditionalData.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CancelOrRefundRequestAdditionalData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CancelOrRefundRequestAdditionalData' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CancelOrRefundRequestAdditionalData>() {
                @Override
                public void write(JsonWriter out, CancelOrRefundRequestAdditionalData value) throws IOException {
                ...
                @Override
                public CancelOrRefundRequestAdditionalData read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        CancelOrRefundRequestAdditionalData ret = new CancelOrRefundRequestAdditionalData();
                    ...
                    throw new IOException(String.format("Failed deserialization for CancelOrRefundRequestAdditionalData: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CancelOrRefundRequestAdditionalData() {
        super("anyOf", Boolean.FALSE);
    }

    public CancelOrRefundRequestAdditionalData(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CancelOrRefundRequestAdditionalData.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CancelOrRefundRequestAdditionalData
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for CancelOrRefundRequestAdditionalData with anyOf schemas: AdditionalData3DSecure, AdditionalDataAirline, AdditionalDataCarRental, AdditionalDataCommon, AdditionalDataLevel23, AdditionalDataLodging, AdditionalDataModifications, AdditionalDataOpenInvoice, AdditionalDataOpi, AdditionalDataRatepay, AdditionalDataRetry, AdditionalDataRisk, AdditionalDataRiskStandalone, AdditionalDataSubMerchant, AdditionalDataTemporaryServices, AdditionalDataWallets. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of CancelOrRefundRequestAdditionalData given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CancelOrRefundRequestAdditionalData
     * @throws IOException if the JSON string is invalid with respect to CancelOrRefundRequestAdditionalData
     */
    public static CancelOrRefundRequestAdditionalData fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CancelOrRefundRequestAdditionalData.class);
    }

    /**
     * Convert an instance of CancelOrRefundRequestAdditionalData to an JSON string
     *
     * @return JSON string
     */
