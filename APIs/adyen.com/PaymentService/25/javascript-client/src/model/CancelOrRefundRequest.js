...
import CancelOrRefundRequestAdditionalData from './CancelOrRefundRequestAdditionalData';
...
class CancelOrRefundRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('additionalData')) {
                obj['additionalData'] = CancelOrRefundRequestAdditionalData.constructFromObject(data['additionalData']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['additionalData']) { // data not null
          CancelOrRefundRequestAdditionalData.validateJSON(data['additionalData']);
        }
...
/**
 * @member {module:model/CancelOrRefundRequestAdditionalData} additionalData
 */
