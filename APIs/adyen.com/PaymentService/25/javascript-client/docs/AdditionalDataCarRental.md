# AdyenPaymentApi.AdditionalDataCarRental
...
**travelEntertainmentAuthDataDuration** | **String** | Number of days the car is rented for. This should be included in the auth message. * Format: Numeric * maxLength: 4 | [optional] 
