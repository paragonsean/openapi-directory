...
void OAIPaymentRequest::initializeModel() {
    ...
    m_fund_destination_isSet = false;
    m_fund_destination_isValid = false;
...
void OAIPaymentRequest::fromJsonObject(QJsonObject json) {
    ...
    m_fund_destination_isValid = ::OpenAPI::fromJsonValue(m_fund_destination, json[QString("fundDestination")]);
    m_fund_destination_isSet = !json[QString("fundDestination")].isNull() && m_fund_destination_isValid;
...
QJsonObject OAIPaymentRequest::asJsonObject() const {
    ...
    if (m_fund_destination.isSet()) {
        obj.insert(QString("fundDestination"), ::OpenAPI::toJsonValue(m_fund_destination));
    }
...
OAIFundDestination OAIPaymentRequest::getFundDestination() const {
    return m_fund_destination;
}
void OAIPaymentRequest::setFundDestination(const OAIFundDestination &fund_destination) {
    m_fund_destination = fund_destination;
    m_fund_destination_isSet = true;
}

bool OAIPaymentRequest::is_fund_destination_Set() const{
    return m_fund_destination_isSet;
}

bool OAIPaymentRequest::is_fund_destination_Valid() const{
    return m_fund_destination_isValid;
}

OAIFundSource OAIPaymentRequest::getFundSource() const {
    return m_fund_source;
}
void OAIPaymentRequest::setFundSource(const OAIFundSource &fund_source) {
    m_fund_source = fund_source;
    m_fund_source_isSet = true;
}

bool OAIPaymentRequest::is_fund_source_Set() const{
    return m_fund_source_isSet;
}

bool OAIPaymentRequest::is_fund_source_Valid() const{
