...
OAIThreeDSecureData OAIRefundRequest::getMpiData() const {
    return m_mpi_data;
}
void OAIRefundRequest::setMpiData(const OAIThreeDSecureData &mpi_data) {
    m_mpi_data = mpi_data;
    m_mpi_data_isSet = true;
}

bool OAIRefundRequest::is_mpi_data_Set() const{
    return m_mpi_data_isSet;
}

bool OAIRefundRequest::is_mpi_data_Valid() const{
