...
public class PaymentRequestAdditionalData extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PaymentRequestAdditionalData.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PaymentRequestAdditionalData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PaymentRequestAdditionalData' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PaymentRequestAdditionalData>() {
                @Override
                public void write(JsonWriter out, PaymentRequestAdditionalData value) throws IOException {
                ...
                @Override
                public PaymentRequestAdditionalData read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        PaymentRequestAdditionalData ret = new PaymentRequestAdditionalData();
                    ...
                    throw new IOException(String.format("Failed deserialization for PaymentRequestAdditionalData: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PaymentRequestAdditionalData() {
        super("anyOf", Boolean.FALSE);
    }

    public PaymentRequestAdditionalData(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PaymentRequestAdditionalData.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PaymentRequestAdditionalData
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for PaymentRequestAdditionalData with anyOf schemas: AdditionalData3DSecure, AdditionalDataAirline, AdditionalDataCarRental, AdditionalDataCommon, AdditionalDataLevel23, AdditionalDataLodging, AdditionalDataOpenInvoice, AdditionalDataOpi, AdditionalDataRatepay, AdditionalDataRetry, AdditionalDataRisk, AdditionalDataRiskStandalone, AdditionalDataSubMerchant, AdditionalDataTemporaryServices, AdditionalDataWallets. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of PaymentRequestAdditionalData given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PaymentRequestAdditionalData
     * @throws IOException if the JSON string is invalid with respect to PaymentRequestAdditionalData
     */
    public static PaymentRequestAdditionalData fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PaymentRequestAdditionalData.class);
    }

    /**
     * Convert an instance of PaymentRequestAdditionalData to an JSON string
     *
     * @return JSON string
     */
