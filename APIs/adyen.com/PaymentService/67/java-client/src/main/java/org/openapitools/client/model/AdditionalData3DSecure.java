...
public class AdditionalData3DSecure {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdditionalData3DSecure
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdditionalData3DSecure.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdditionalData3DSecure.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdditionalData3DSecure` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("allow3DS2") != null && !jsonObj.get("allow3DS2").isJsonNull()) && !jsonObj.get("allow3DS2").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("executeThreeD") != null && !jsonObj.get("executeThreeD").isJsonNull()) && !jsonObj.get("executeThreeD").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("mpiImplementationType") != null && !jsonObj.get("mpiImplementationType").isJsonNull()) && !jsonObj.get("mpiImplementationType").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("scaExemption") != null && !jsonObj.get("scaExemption").isJsonNull()) && !jsonObj.get("scaExemption").isJsonPrimitive()) {
