...
Adyen Payment API
- API version: 67
  - Build date: 2024-10-12T11:14:19.352190-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:67"
  }
```
...
* `target/openapi-java-client-67.jar`
* `target/lib/*.jar`
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://pal-test.adyen.com/pal/servlet/Payment/v67");
