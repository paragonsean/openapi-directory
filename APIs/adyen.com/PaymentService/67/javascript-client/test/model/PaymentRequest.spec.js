...
(function(root, factory) {
  ...
  describe('PaymentRequest', function() {
    ...
    it('should have the property fundDestination (base name: "fundDestination")', function() {
      // uncomment below and update the code to test the property fundDestination
      //var instance = new AdyenPaymentApi.PaymentRequest();
      //expect(instance).to.be();
    });
