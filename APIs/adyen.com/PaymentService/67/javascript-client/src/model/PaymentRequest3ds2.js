...
/**
 * The PaymentRequest3ds2 model module.
 * @module model/PaymentRequest3ds2
 * @version 67
 */
class PaymentRequest3ds2 {
    /**
     * Constructs a new <code>PaymentRequest3ds2</code>.
     * @alias module:model/PaymentRequest3ds2
    ...
    constructor(amount, merchantAccount, reference) { 
        ...
        PaymentRequest3ds2.initialize(this, amount, merchantAccount, reference);
    }
    ...
    /**
     * Constructs a <code>PaymentRequest3ds2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentRequest3ds2} obj Optional instance to populate.
     * @return {module:model/PaymentRequest3ds2} The populated <code>PaymentRequest3ds2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentRequest3ds2();
            ...
            if (data.hasOwnProperty('threeDS2Token')) {
                obj['threeDS2Token'] = ApiClient.convertToType(data['threeDS2Token'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentRequest3ds2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentRequest3ds2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentRequest3ds2.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['threeDS2Token'] && !(typeof data['threeDS2Token'] === 'string' || data['threeDS2Token'] instanceof String)) {
            throw new Error("Expected the field `threeDS2Token` to be a primitive type in the JSON string but got " + data['threeDS2Token']);
        }
        // ensure the json data is a string
...
PaymentRequest3ds2.RequiredProperties = ["amount", "merchantAccount", "reference"];
 ...
 */
PaymentRequest3ds2.prototype['accountInfo'] = undefined;
 ...
 */
PaymentRequest3ds2.prototype['additionalAmount'] = undefined;

/**
 * @member {module:model/PaymentRequestAdditionalData} additionalData
 */
PaymentRequest3ds2.prototype['additionalData'] = undefined;
 ...
 */
PaymentRequest3ds2.prototype['amount'] = undefined;

/**
 * Information about your application. For more details, see [Building Adyen solutions](https://docs.adyen.com/development-resources/building-adyen-solutions).
 * @member {module:model/ApplicationInfo} applicationInfo
 */
PaymentRequest3ds2.prototype['applicationInfo'] = undefined;
 ...
 */
PaymentRequest3ds2.prototype['billingAddress'] = undefined;
 ...
 */
PaymentRequest3ds2.prototype['browserInfo'] = undefined;

/**
 * The delay between the authorisation and scheduled auto-capture, specified in hours.
 * @member {Number} captureDelayHours
 */
PaymentRequest3ds2.prototype['captureDelayHours'] = undefined;

/**
 * The shopper's date of birth.  Format [ISO-8601](https://www.w3.org/TR/NOTE-datetime): YYYY-MM-DD
 * @member {Date} dateOfBirth
 */
PaymentRequest3ds2.prototype['dateOfBirth'] = undefined;

/**
 * The forex quote as returned in the response of the forex service.
 * @member {module:model/ForexQuote} dccQuote
 */
PaymentRequest3ds2.prototype['dccQuote'] = undefined;

/**
 * The address where the purchased goods should be delivered.
 * @member {module:model/Address} deliveryAddress
 */
PaymentRequest3ds2.prototype['deliveryAddress'] = undefined;

/**
 * The date and time the purchased goods should be delivered.  Format [ISO 8601](https://www.w3.org/TR/NOTE-datetime): YYYY-MM-DDThh:mm:ss.sssTZD  Example: 2017-07-17T13:42:40.428+01:00
 * @member {Date} deliveryDate
 */
PaymentRequest3ds2.prototype['deliveryDate'] = undefined;

/**
 * A string containing the shopper's device fingerprint. For more information, refer to [Device fingerprinting](https://docs.adyen.com/risk-management/device-fingerprinting).
 * @member {String} deviceFingerprint
 */
PaymentRequest3ds2.prototype['deviceFingerprint'] = undefined;

/**
 * An integer value that is added to the normal fraud score. The value can be either positive or negative.
 * @member {Number} fraudOffset
 */
PaymentRequest3ds2.prototype['fraudOffset'] = undefined;
 ...
 */
PaymentRequest3ds2.prototype['installments'] = undefined;

/**
 * The [merchant category code](https://en.wikipedia.org/wiki/Merchant_category_code) (MCC) is a four-digit number, which relates to a particular market segment. This code reflects the predominant activity that is conducted by the merchant.
 * @member {String} mcc
 */
PaymentRequest3ds2.prototype['mcc'] = undefined;

/**
 * The merchant account identifier, with which you want to process the transaction.
 * @member {String} merchantAccount
 */
PaymentRequest3ds2.prototype['merchantAccount'] = undefined;
 ...
 */
PaymentRequest3ds2.prototype['merchantOrderReference'] = undefined;
 ...
 */
PaymentRequest3ds2.prototype['merchantRiskIndicator'] = undefined;

/**
 * Metadata consists of entries, each of which includes a key and a value. Limits: * Maximum 20 key-value pairs per request. When exceeding, the \"177\" error occurs: \"Metadata size exceeds limit\". * Maximum 20 characters per key. * Maximum 80 characters per value. 
 * @member {Object.<String, String>} metadata
 */
PaymentRequest3ds2.prototype['metadata'] = undefined;

/**
 * When you are doing multiple partial (gift card) payments, this is the `pspReference` of the first payment. We use this to link the multiple payments to each other. As your own reference for linking multiple payments, use the `merchantOrderReference`instead.
 * @member {String} orderReference
 */
PaymentRequest3ds2.prototype['orderReference'] = undefined;
 ...
 */
PaymentRequest3ds2.prototype['recurring'] = undefined;
 ...
 * @member {module:model/PaymentRequest3ds2.RecurringProcessingModelEnum} recurringProcessingModel
 */
PaymentRequest3ds2.prototype['recurringProcessingModel'] = undefined;

/**
 * The reference to uniquely identify a payment. This reference is used in all communication with you about the payment status. We recommend using a unique value per payment; however, it is not a requirement. If you need to provide multiple references for a transaction, separate them with hyphens (\"-\"). Maximum length: 80 characters.
 * @member {String} reference
 */
PaymentRequest3ds2.prototype['reference'] = undefined;
 ...
 */
PaymentRequest3ds2.prototype['selectedBrand'] = undefined;

/**
 * The `recurringDetailReference` you want to use for this payment. The value `LATEST` can be used to select the most recently stored recurring detail.
 * @member {String} selectedRecurringDetailReference
 */
PaymentRequest3ds2.prototype['selectedRecurringDetailReference'] = undefined;

/**
 * A session ID used to identify a payment session.
 * @member {String} sessionId
 */
PaymentRequest3ds2.prototype['sessionId'] = undefined;

/**
 * The shopper's email address. We recommend that you provide this data, as it is used in velocity fraud checks. > For 3D Secure 2 transactions, schemes require `shopperEmail` for all browser-based and mobile implementations.
 * @member {String} shopperEmail
 */
PaymentRequest3ds2.prototype['shopperEmail'] = undefined;

/**
 * The shopper's IP address. In general, we recommend that you provide this data, as it is used in a number of risk checks (for instance, number of payment attempts or location-based checks). > For 3D Secure 2 transactions, schemes require `shopperIP` for all browser-based implementations. This field is also mandatory for some merchants depending on your business model. For more information, [contact Support](https://www.adyen.help/hc/en-us/requests/new).
 * @member {String} shopperIP
 */
PaymentRequest3ds2.prototype['shopperIP'] = undefined;
 ...
 * @member {module:model/PaymentRequest3ds2.ShopperInteractionEnum} shopperInteraction
 */
PaymentRequest3ds2.prototype['shopperInteraction'] = undefined;

/**
 * The combination of a language code and a country code to specify the language to be used in the payment.
 * @member {String} shopperLocale
 */
PaymentRequest3ds2.prototype['shopperLocale'] = undefined;

/**
 * The shopper's full name.
 * @member {module:model/Name} shopperName
 */
PaymentRequest3ds2.prototype['shopperName'] = undefined;

/**
 * Required for recurring payments.  Your reference to uniquely identify this shopper, for example user ID or account ID. Minimum length: 3 characters. > Your reference must not include personally identifiable information (PII), for example name or email address.
 * @member {String} shopperReference
 */
PaymentRequest3ds2.prototype['shopperReference'] = undefined;

/**
 * The text to be shown on the shopper's bank statement.  We recommend sending a maximum of 22 characters, otherwise banks might truncate the string.  Allowed characters: **a-z**, **A-Z**, **0-9**, spaces, and special characters **. , ' _ - ? + * /_**.
 * @member {String} shopperStatement
 */
PaymentRequest3ds2.prototype['shopperStatement'] = undefined;

/**
 * The shopper's social security number.
 * @member {String} socialSecurityNumber
 */
PaymentRequest3ds2.prototype['socialSecurityNumber'] = undefined;
 ...
 */
PaymentRequest3ds2.prototype['splits'] = undefined;
 ...
 * @member {String} store
 */
PaymentRequest3ds2.prototype['store'] = undefined;

/**
 * The shopper's telephone number.
 * @member {String} telephoneNumber
 */
PaymentRequest3ds2.prototype['telephoneNumber'] = undefined;
 ...
 */
PaymentRequest3ds2.prototype['threeDS2RequestData'] = undefined;

/**
 * Thre ThreeDS2Result that was returned in the final CRes.
 * @member {module:model/ThreeDS2Result} threeDS2Result
 */
PaymentRequest3ds2.prototype['threeDS2Result'] = undefined;

/**
 * The ThreeDS2Token that was returned in the /authorise call.
 * @member {String} threeDS2Token
 */
PaymentRequest3ds2.prototype['threeDS2Token'] = undefined;
 ...
 * @default false
 */
PaymentRequest3ds2.prototype['threeDSAuthenticationOnly'] = false;

/**
 * The reference value to aggregate sales totals in reporting. When not specified, the store field is used (if available).
 * @member {String} totalsGroup
 */
PaymentRequest3ds2.prototype['totalsGroup'] = undefined;

/**
 * Set to true if the payment should be routed to a trusted MID.
 * @member {Boolean} trustedShopper
 */
PaymentRequest3ds2.prototype['trustedShopper'] = undefined;
...
export default PaymentRequest3ds2;
