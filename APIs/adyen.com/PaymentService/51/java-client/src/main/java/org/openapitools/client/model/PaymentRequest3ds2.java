...
public class PaymentRequest3ds2 {
  ...
  public PaymentRequest3ds2 additionalData(PaymentRequestAdditionalData additionalData) {
  ...
  @Deprecated
  public PaymentRequest3ds2 enableRealTimeUpdate(Boolean enableRealTimeUpdate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountInfo, paymentRequest3ds2.accountInfo) &&
        ...
        Objects.equals(this.enableRealTimeUpdate, paymentRequest3ds2.enableRealTimeUpdate) &&
  ...
  static {
    ...
    openapiFields.add("threeDS2Token");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentRequest3ds2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentRequest3ds2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentRequest3ds2 is not found in the empty JSON string", PaymentRequest3ds2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentRequest3ds2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentRequest3ds2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentRequest3ds2.openapiRequiredFields) {
      ...
      if ((jsonObj.get("threeDS2Token") != null && !jsonObj.get("threeDS2Token").isJsonNull()) && !jsonObj.get("threeDS2Token").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `threeDS2Token` to be a primitive type in the JSON string but got `%s`", jsonObj.get("threeDS2Token").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentRequest3ds2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentRequest3ds2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentRequest3ds2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentRequest3ds2.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentRequest3ds2>() {
           @Override
           public void write(JsonWriter out, PaymentRequest3ds2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentRequest3ds2 read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to PaymentRequest3ds2
   */
  public static PaymentRequest3ds2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentRequest3ds2.class);
  }
