...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPaymentApi.AuthenticationResultRequest();
  });
  ...
  describe('AuthenticationResultRequest', function() {
    it('should create an instance of AuthenticationResultRequest', function() {
      // uncomment below and update the code to test AuthenticationResultRequest
      //var instance = new AdyenPaymentApi.AuthenticationResultRequest();
      //expect(instance).to.be.a(AdyenPaymentApi.AuthenticationResultRequest);
    });
