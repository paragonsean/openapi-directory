...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPaymentApi.ThreeDS2ResultRequest();
  });
  ...
  describe('ThreeDS2ResultRequest', function() {
    it('should create an instance of ThreeDS2ResultRequest', function() {
      // uncomment below and update the code to test ThreeDS2ResultRequest
      //var instance = new AdyenPaymentApi.ThreeDS2ResultRequest();
      //expect(instance).to.be.a(AdyenPaymentApi.ThreeDS2ResultRequest);
    });
