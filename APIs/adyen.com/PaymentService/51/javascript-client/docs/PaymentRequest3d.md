# AdyenPaymentApi.PaymentRequest3d
...
**enableRealTimeUpdate** | **Boolean** | Choose if a specific transaction should use the Real-time Account Updater, regardless of other settings. | [optional] 
