...
async def test_post_authorise(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v49/authorise',
        headers=headers,
        json=body,
        )
...
async def test_post_authorise3d(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v49/authorise3d',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_authorise3ds2(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v49/authorise3ds2',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_retrieve3ds2_result(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payment/v49/retrieve3ds2Result',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
