...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPaymentApi.ShopperInteractionDevice();
  });
  ...
  describe('ShopperInteractionDevice', function() {
    it('should create an instance of ShopperInteractionDevice', function() {
      ...
      //var instance = new AdyenPaymentApi.ShopperInteractionDevice();
      //expect(instance).to.be.a(AdyenPaymentApi.ShopperInteractionDevice);
    });
