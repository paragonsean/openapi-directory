...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPaymentApi.CaptureRequest();
  });
  ...
  describe('CaptureRequest', function() {
    it('should create an instance of CaptureRequest', function() {
      // uncomment below and update the code to test CaptureRequest
      //var instance = new AdyenPaymentApi.CaptureRequest();
      //expect(instance).to.be.a(AdyenPaymentApi.CaptureRequest);
    });
