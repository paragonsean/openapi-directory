...
/**
 * The DefendDisputeResponse model module.
 * @module model/DefendDisputeResponse
 * @version 30
 */
class DefendDisputeResponse {
    /**
     * Constructs a new <code>DefendDisputeResponse</code>.
     * @alias module:model/DefendDisputeResponse
    ...
    constructor(disputeServiceResult) { 
        ...
        DefendDisputeResponse.initialize(this, disputeServiceResult);
    }
    ...
    /**
     * Constructs a <code>DefendDisputeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DefendDisputeResponse} obj Optional instance to populate.
     * @return {module:model/DefendDisputeResponse} The populated <code>DefendDisputeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DefendDisputeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DefendDisputeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DefendDisputeResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DefendDisputeResponse.RequiredProperties) {
...
DefendDisputeResponse.RequiredProperties = ["disputeServiceResult"];

/**
 * The result of the dispute service.
 * @member {module:model/DisputeServiceResult} disputeServiceResult
 */
DefendDisputeResponse.prototype['disputeServiceResult'] = undefined;
...
export default DefendDisputeResponse;
