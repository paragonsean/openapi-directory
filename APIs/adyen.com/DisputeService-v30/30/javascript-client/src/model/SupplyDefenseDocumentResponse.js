...
/**
 * The SupplyDefenseDocumentResponse model module.
 * @module model/SupplyDefenseDocumentResponse
 * @version 30
 */
class SupplyDefenseDocumentResponse {
    /**
     * Constructs a new <code>SupplyDefenseDocumentResponse</code>.
     * @alias module:model/SupplyDefenseDocumentResponse
    ...
    constructor(disputeServiceResult) { 
        ...
        SupplyDefenseDocumentResponse.initialize(this, disputeServiceResult);
    }
    ...
    /**
     * Constructs a <code>SupplyDefenseDocumentResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SupplyDefenseDocumentResponse} obj Optional instance to populate.
     * @return {module:model/SupplyDefenseDocumentResponse} The populated <code>SupplyDefenseDocumentResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SupplyDefenseDocumentResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>SupplyDefenseDocumentResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SupplyDefenseDocumentResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SupplyDefenseDocumentResponse.RequiredProperties) {
...
SupplyDefenseDocumentResponse.RequiredProperties = ["disputeServiceResult"];

/**
 * The result of the dispute service.
 * @member {module:model/DisputeServiceResult} disputeServiceResult
 */
SupplyDefenseDocumentResponse.prototype['disputeServiceResult'] = undefined;
...
export default SupplyDefenseDocumentResponse;
