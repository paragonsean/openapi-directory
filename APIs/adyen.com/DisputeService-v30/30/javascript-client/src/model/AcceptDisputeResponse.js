...
class AcceptDisputeResponse {
    ...
    constructor(disputeServiceResult) { 
        ...
        AcceptDisputeResponse.initialize(this, disputeServiceResult);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of AcceptDisputeResponse.RequiredProperties) {
...
AcceptDisputeResponse.RequiredProperties = ["disputeServiceResult"];

/**
 * The result of the dispute service.
 * @member {module:model/DisputeServiceResult} disputeServiceResult
 */
AcceptDisputeResponse.prototype['disputeServiceResult'] = undefined;
