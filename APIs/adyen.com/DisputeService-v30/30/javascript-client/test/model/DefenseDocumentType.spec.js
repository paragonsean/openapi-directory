...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisputesApi.DefenseDocumentType();
  });
  ...
  describe('DefenseDocumentType', function() {
    it('should create an instance of DefenseDocumentType', function() {
      // uncomment below and update the code to test DefenseDocumentType
      //var instance = new DisputesApi.DefenseDocumentType();
      //expect(instance).to.be.a(DisputesApi.DefenseDocumentType);
    });
    ...
    it('should have the property requirementLevel (base name: "requirementLevel")', function() {
      // uncomment below and update the code to test the property requirementLevel
      //var instance = new DisputesApi.DefenseDocumentType();
      //expect(instance).to.be();
    });
