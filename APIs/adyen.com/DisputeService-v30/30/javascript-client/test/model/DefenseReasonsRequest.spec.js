...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisputesApi.DefenseReasonsRequest();
  });
  ...
  describe('DefenseReasonsRequest', function() {
    it('should create an instance of DefenseReasonsRequest', function() {
      // uncomment below and update the code to test DefenseReasonsRequest
      //var instance = new DisputesApi.DefenseReasonsRequest();
      //expect(instance).to.be.a(DisputesApi.DefenseReasonsRequest);
    });
