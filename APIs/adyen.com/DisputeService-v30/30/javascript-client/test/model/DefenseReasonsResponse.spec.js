...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisputesApi.DefenseReasonsResponse();
  });
  ...
  describe('DefenseReasonsResponse', function() {
    it('should create an instance of DefenseReasonsResponse', function() {
      // uncomment below and update the code to test DefenseReasonsResponse
      //var instance = new DisputesApi.DefenseReasonsResponse();
      //expect(instance).to.be.a(DisputesApi.DefenseReasonsResponse);
    });

    it('should have the property defenseReasons (base name: "defenseReasons")', function() {
      // uncomment below and update the code to test the property defenseReasons
      //var instance = new DisputesApi.DefenseReasonsResponse();
