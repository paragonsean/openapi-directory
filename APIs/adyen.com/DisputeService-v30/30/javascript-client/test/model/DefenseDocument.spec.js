...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisputesApi.DefenseDocument();
  });
  ...
  describe('DefenseDocument', function() {
    it('should create an instance of DefenseDocument', function() {
      // uncomment below and update the code to test DefenseDocument
      //var instance = new DisputesApi.DefenseDocument();
      //expect(instance).to.be.a(DisputesApi.DefenseDocument);
    });
    ...
    it('should have the property defenseDocumentTypeCode (base name: "defenseDocumentTypeCode")', function() {
      // uncomment below and update the code to test the property defenseDocumentTypeCode
      //var instance = new DisputesApi.DefenseDocument();
      //expect(instance).to.be();
    });
