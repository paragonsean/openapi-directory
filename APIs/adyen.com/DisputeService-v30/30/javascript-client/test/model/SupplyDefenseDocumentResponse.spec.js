...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisputesApi.SupplyDefenseDocumentResponse();
  });
  ...
  describe('SupplyDefenseDocumentResponse', function() {
    it('should create an instance of SupplyDefenseDocumentResponse', function() {
      // uncomment below and update the code to test SupplyDefenseDocumentResponse
      //var instance = new DisputesApi.SupplyDefenseDocumentResponse();
      //expect(instance).to.be.a(DisputesApi.SupplyDefenseDocumentResponse);
    });

    it('should have the property disputeServiceResult (base name: "disputeServiceResult")', function() {
      // uncomment below and update the code to test the property disputeServiceResult
      //var instance = new DisputesApi.SupplyDefenseDocumentResponse();
