...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisputesApi.DisputeServiceResult();
  });
  ...
  describe('DisputeServiceResult', function() {
    it('should create an instance of DisputeServiceResult', function() {
      // uncomment below and update the code to test DisputeServiceResult
      //var instance = new DisputesApi.DisputeServiceResult();
      //expect(instance).to.be.a(DisputesApi.DisputeServiceResult);
    });
