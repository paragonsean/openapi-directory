...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisputesApi.DeleteDefenseDocumentResponse();
  });
  ...
  describe('DeleteDefenseDocumentResponse', function() {
    it('should create an instance of DeleteDefenseDocumentResponse', function() {
      // uncomment below and update the code to test DeleteDefenseDocumentResponse
      //var instance = new DisputesApi.DeleteDefenseDocumentResponse();
      //expect(instance).to.be.a(DisputesApi.DeleteDefenseDocumentResponse);
    });
