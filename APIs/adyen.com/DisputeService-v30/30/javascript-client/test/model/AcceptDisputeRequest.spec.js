...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisputesApi.AcceptDisputeRequest();
  });
  ...
  describe('AcceptDisputeRequest', function() {
    it('should create an instance of AcceptDisputeRequest', function() {
      ...
      //var instance = new DisputesApi.AcceptDisputeRequest();
      //expect(instance).to.be.a(DisputesApi.AcceptDisputeRequest);
    });
