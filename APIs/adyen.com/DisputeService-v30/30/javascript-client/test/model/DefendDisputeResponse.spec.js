...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisputesApi.DefendDisputeResponse();
  });
  ...
  describe('DefendDisputeResponse', function() {
    it('should create an instance of DefendDisputeResponse', function() {
      // uncomment below and update the code to test DefendDisputeResponse
      //var instance = new DisputesApi.DefendDisputeResponse();
      //expect(instance).to.be.a(DisputesApi.DefendDisputeResponse);
    });
