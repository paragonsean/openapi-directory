...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisputesApi.SupplyDefenseDocumentRequest();
  });
  ...
  describe('SupplyDefenseDocumentRequest', function() {
    it('should create an instance of SupplyDefenseDocumentRequest', function() {
      // uncomment below and update the code to test SupplyDefenseDocumentRequest
      //var instance = new DisputesApi.SupplyDefenseDocumentRequest();
      //expect(instance).to.be.a(DisputesApi.SupplyDefenseDocumentRequest);
    });

    it('should have the property defenseDocuments (base name: "defenseDocuments")', function() {
      // uncomment below and update the code to test the property defenseDocuments
      //var instance = new DisputesApi.SupplyDefenseDocumentRequest();
