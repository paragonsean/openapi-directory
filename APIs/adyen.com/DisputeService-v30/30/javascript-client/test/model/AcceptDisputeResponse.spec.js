...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisputesApi.AcceptDisputeResponse();
  });
  ...
  describe('AcceptDisputeResponse', function() {
    it('should create an instance of AcceptDisputeResponse', function() {
      ...
      //var instance = new DisputesApi.AcceptDisputeResponse();
      //expect(instance).to.be.a(DisputesApi.AcceptDisputeResponse);
    });
