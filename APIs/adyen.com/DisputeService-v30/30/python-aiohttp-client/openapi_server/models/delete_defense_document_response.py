...
class DeleteDefenseDocumentResponse(Model):
    ...
    def __init__(self, dispute_service_result: DisputeServiceResult=None):
        """DeleteDefenseDocumentResponse - a model defined in OpenAPI

        :param dispute_service_result: The dispute_service_result of this DeleteDefenseDocumentResponse.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteDefenseDocumentResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteDefenseDocumentResponse of this DeleteDefenseDocumentResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def dispute_service_result(self):
        """Gets the dispute_service_result of this DeleteDefenseDocumentResponse.

        The result of the dispute service.

        :return: The dispute_service_result of this DeleteDefenseDocumentResponse.
    ...
    def dispute_service_result(self, dispute_service_result):
        """Sets the dispute_service_result of this DeleteDefenseDocumentResponse.
