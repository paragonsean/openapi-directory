...
OAIAcceptDisputeRequest::OAIAcceptDisputeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAcceptDisputeRequest::OAIAcceptDisputeRequest() {
    this->initializeModel();
}

OAIAcceptDisputeRequest::~OAIAcceptDisputeRequest() {}

void OAIAcceptDisputeRequest::initializeModel() {
...
void OAIAcceptDisputeRequest::fromJson(QString jsonString) {
...
void OAIAcceptDisputeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAcceptDisputeRequest::asJson() const {
...
QJsonObject OAIAcceptDisputeRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAcceptDisputeRequest::getDisputePspReference() const {
    return m_dispute_psp_reference;
}
void OAIAcceptDisputeRequest::setDisputePspReference(const QString &dispute_psp_reference) {
    m_dispute_psp_reference = dispute_psp_reference;
    m_dispute_psp_reference_isSet = true;
}

bool OAIAcceptDisputeRequest::is_dispute_psp_reference_Set() const{
    return m_dispute_psp_reference_isSet;
}

bool OAIAcceptDisputeRequest::is_dispute_psp_reference_Valid() const{
    return m_dispute_psp_reference_isValid;
}

QString OAIAcceptDisputeRequest::getMerchantAccountCode() const {
    return m_merchant_account_code;
}
void OAIAcceptDisputeRequest::setMerchantAccountCode(const QString &merchant_account_code) {
    m_merchant_account_code = merchant_account_code;
    m_merchant_account_code_isSet = true;
}

bool OAIAcceptDisputeRequest::is_merchant_account_code_Set() const{
    return m_merchant_account_code_isSet;
}

bool OAIAcceptDisputeRequest::is_merchant_account_code_Valid() const{
    return m_merchant_account_code_isValid;
}

bool OAIAcceptDisputeRequest::isSet() const {
...
bool OAIAcceptDisputeRequest::isValid() const {
