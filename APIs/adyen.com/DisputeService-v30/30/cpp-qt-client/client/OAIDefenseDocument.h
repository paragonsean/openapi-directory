...
/*
 * OAIDefenseDocument.h
 *
 * 
 */

#ifndef OAIDefenseDocument_H
#define OAIDefenseDocument_H
...
class OAIDefenseDocument : public OAIObject {
public:
    OAIDefenseDocument();
    OAIDefenseDocument(QString json);
    ~OAIDefenseDocument() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDefenseDocument)

#endif // OAIDefenseDocument_H
