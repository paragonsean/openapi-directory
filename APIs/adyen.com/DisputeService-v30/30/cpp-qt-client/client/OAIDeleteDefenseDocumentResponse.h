...
/*
 * OAIDeleteDefenseDocumentResponse.h
 *
 * 
 */

#ifndef OAIDeleteDefenseDocumentResponse_H
#define OAIDeleteDefenseDocumentResponse_H
...
class OAIDeleteDefenseDocumentResponse : public OAIObject {
public:
    OAIDeleteDefenseDocumentResponse();
    OAIDeleteDefenseDocumentResponse(QString json);
    ~OAIDeleteDefenseDocumentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDefenseDocumentResponse)

#endif // OAIDeleteDefenseDocumentResponse_H
