...
OAIDisputeServiceResult OAIAcceptDisputeResponse::getDisputeServiceResult() const {
    return m_dispute_service_result;
}
void OAIAcceptDisputeResponse::setDisputeServiceResult(const OAIDisputeServiceResult &dispute_service_result) {
    m_dispute_service_result = dispute_service_result;
    m_dispute_service_result_isSet = true;
}

bool OAIAcceptDisputeResponse::is_dispute_service_result_Set() const{
    return m_dispute_service_result_isSet;
}

bool OAIAcceptDisputeResponse::is_dispute_service_result_Valid() const{
