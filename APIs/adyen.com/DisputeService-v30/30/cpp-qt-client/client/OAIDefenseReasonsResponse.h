...
/*
 * OAIDefenseReasonsResponse.h
 *
 * 
 */

#ifndef OAIDefenseReasonsResponse_H
#define OAIDefenseReasonsResponse_H
...
namespace OpenAPI {
class OAIDefenseReason;
class OAIDisputeServiceResult;

class OAIDefenseReasonsResponse : public OAIObject {
public:
    OAIDefenseReasonsResponse();
    OAIDefenseReasonsResponse(QString json);
    ~OAIDefenseReasonsResponse() override;
    ...
    QList<OAIDefenseReason> getDefenseReasons() const;
    void setDefenseReasons(const QList<OAIDefenseReason> &defense_reasons);
    bool is_defense_reasons_Set() const;
    bool is_defense_reasons_Valid() const;
...
private:
    ...
    QList<OAIDefenseReason> m_defense_reasons;
    bool m_defense_reasons_isSet;
    bool m_defense_reasons_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDefenseReasonsResponse)

#endif // OAIDefenseReasonsResponse_H
