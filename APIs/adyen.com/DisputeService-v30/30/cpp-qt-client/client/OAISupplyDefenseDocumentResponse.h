...
/*
 * OAISupplyDefenseDocumentResponse.h
 *
 * 
 */

#ifndef OAISupplyDefenseDocumentResponse_H
#define OAISupplyDefenseDocumentResponse_H
...
class OAISupplyDefenseDocumentResponse : public OAIObject {
public:
    OAISupplyDefenseDocumentResponse();
    OAISupplyDefenseDocumentResponse(QString json);
    ~OAISupplyDefenseDocumentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupplyDefenseDocumentResponse)

#endif // OAISupplyDefenseDocumentResponse_H
