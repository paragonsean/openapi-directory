...
OAISupplyDefenseDocumentResponse::OAISupplyDefenseDocumentResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISupplyDefenseDocumentResponse::OAISupplyDefenseDocumentResponse() {
    this->initializeModel();
}

OAISupplyDefenseDocumentResponse::~OAISupplyDefenseDocumentResponse() {}

void OAISupplyDefenseDocumentResponse::initializeModel() {

    m_dispute_service_result_isSet = false;
    m_dispute_service_result_isValid = false;
}

void OAISupplyDefenseDocumentResponse::fromJson(QString jsonString) {
...
void OAISupplyDefenseDocumentResponse::fromJsonObject(QJsonObject json) {
...
QString OAISupplyDefenseDocumentResponse::asJson() const {
...
QJsonObject OAISupplyDefenseDocumentResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDisputeServiceResult OAISupplyDefenseDocumentResponse::getDisputeServiceResult() const {
    return m_dispute_service_result;
}
void OAISupplyDefenseDocumentResponse::setDisputeServiceResult(const OAIDisputeServiceResult &dispute_service_result) {
    m_dispute_service_result = dispute_service_result;
    m_dispute_service_result_isSet = true;
}

bool OAISupplyDefenseDocumentResponse::is_dispute_service_result_Set() const{
    return m_dispute_service_result_isSet;
}

bool OAISupplyDefenseDocumentResponse::is_dispute_service_result_Valid() const{
    return m_dispute_service_result_isValid;
}

bool OAISupplyDefenseDocumentResponse::isSet() const {
...
bool OAISupplyDefenseDocumentResponse::isValid() const {
