...
/*
 * OAIDefendDisputeRequest.h
 *
 * 
 */

#ifndef OAIDefendDisputeRequest_H
#define OAIDefendDisputeRequest_H
...
class OAIDefendDisputeRequest : public OAIObject {
public:
    OAIDefendDisputeRequest();
    OAIDefendDisputeRequest(QString json);
    ~OAIDefendDisputeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDefendDisputeRequest)

#endif // OAIDefendDisputeRequest_H
