...
OAIDefenseReasonsRequest::OAIDefenseReasonsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDefenseReasonsRequest::OAIDefenseReasonsRequest() {
    this->initializeModel();
}

OAIDefenseReasonsRequest::~OAIDefenseReasonsRequest() {}

void OAIDefenseReasonsRequest::initializeModel() {
...
void OAIDefenseReasonsRequest::fromJson(QString jsonString) {
...
void OAIDefenseReasonsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDefenseReasonsRequest::asJson() const {
...
QJsonObject OAIDefenseReasonsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDefenseReasonsRequest::getDisputePspReference() const {
    return m_dispute_psp_reference;
}
void OAIDefenseReasonsRequest::setDisputePspReference(const QString &dispute_psp_reference) {
    m_dispute_psp_reference = dispute_psp_reference;
    m_dispute_psp_reference_isSet = true;
}

bool OAIDefenseReasonsRequest::is_dispute_psp_reference_Set() const{
    return m_dispute_psp_reference_isSet;
}

bool OAIDefenseReasonsRequest::is_dispute_psp_reference_Valid() const{
    return m_dispute_psp_reference_isValid;
}

QString OAIDefenseReasonsRequest::getMerchantAccountCode() const {
    return m_merchant_account_code;
}
void OAIDefenseReasonsRequest::setMerchantAccountCode(const QString &merchant_account_code) {
    m_merchant_account_code = merchant_account_code;
    m_merchant_account_code_isSet = true;
}

bool OAIDefenseReasonsRequest::is_merchant_account_code_Set() const{
    return m_merchant_account_code_isSet;
}

bool OAIDefenseReasonsRequest::is_merchant_account_code_Valid() const{
    return m_merchant_account_code_isValid;
}

bool OAIDefenseReasonsRequest::isSet() const {
...
bool OAIDefenseReasonsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_dispute_psp_reference_isValid && m_merchant_account_code_isValid && true;
}
