...
/*
 * OAIDefenseReasonsRequest.h
 *
 * 
 */

#ifndef OAIDefenseReasonsRequest_H
#define OAIDefenseReasonsRequest_H
...
class OAIDefenseReasonsRequest : public OAIObject {
public:
    OAIDefenseReasonsRequest();
    OAIDefenseReasonsRequest(QString json);
    ~OAIDefenseReasonsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDefenseReasonsRequest)

#endif // OAIDefenseReasonsRequest_H
