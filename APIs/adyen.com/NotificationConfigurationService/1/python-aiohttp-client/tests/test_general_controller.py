...
async def test_post_create_notification_configuration(client):
    ...
    """
    body = {"configurationDetails":{"apiVersion":0,"eventConfigs":[{"NotificationEventConfiguration":{"includeMode":"EXCLUDE","eventType":"ACCOUNT_CLOSED"}},{"NotificationEventConfiguration":{"includeMode":"EXCLUDE","eventType":"ACCOUNT_CLOSED"}}],"messageFormat":"JSON","notifyUsername":"notifyUsername","active":True,"description":"description","notifyURL":"notifyURL","sslProtocol":"TLSv12","notificationId":6,"sendActionHeader":True,"notifyPassword":"notifyPassword"}}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Notification/v1/createNotificationConfiguration',
        headers=headers,
        json=body,
        )
...
async def test_post_delete_notification_configurations(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Notification/v1/deleteNotificationConfigurations',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_get_notification_configuration(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Notification/v1/getNotificationConfiguration',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_get_notification_configuration_list(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Notification/v1/getNotificationConfigurationList',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_test_notification_configuration(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Notification/v1/testNotificationConfiguration',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_update_notification_configuration(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Notification/v1/updateNotificationConfiguration',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
