...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotificationConfigurationApi.GetNotificationConfigurationListResponse();
  });
  ...
  describe('GetNotificationConfigurationListResponse', function() {
    it('should create an instance of GetNotificationConfigurationListResponse', function() {
      // uncomment below and update the code to test GetNotificationConfigurationListResponse
      //var instance = new NotificationConfigurationApi.GetNotificationConfigurationListResponse();
      //expect(instance).to.be.a(NotificationConfigurationApi.GetNotificationConfigurationListResponse);
    });
