    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('eventConfigs')) {
                obj['eventConfigs'] = ApiClient.convertToType(data['eventConfigs'], [NotificationEventConfiguration]);
            }
            if (data.hasOwnProperty('hmacSignatureKey')) {
                obj['hmacSignatureKey'] = ApiClient.convertToType(data['hmacSignatureKey'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['eventConfigs']) { // data not null
            ...
            for (const item of data['eventConfigs']) {
                NotificationEventConfiguration.validateJSON(item);
            };
        }
        // ensure the json data is a string
        if (data['hmacSignatureKey'] && !(typeof data['hmacSignatureKey'] === 'string' || data['hmacSignatureKey'] instanceof String)) {
            throw new Error("Expected the field `hmacSignatureKey` to be a primitive type in the JSON string but got " + data['hmacSignatureKey']);
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/NotificationEventConfiguration>} eventConfigs
 */
 ...
 * @member {String} hmacSignatureKey
 */
NotificationConfigurationDetails.prototype['hmacSignatureKey'] = undefined;
