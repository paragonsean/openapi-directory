...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotificationConfigurationApi.GetNotificationConfigurationResponse();
  });
  ...
  describe('GetNotificationConfigurationResponse', function() {
    it('should create an instance of GetNotificationConfigurationResponse', function() {
      ...
      //var instance = new NotificationConfigurationApi.GetNotificationConfigurationResponse();
      //expect(instance).to.be.a(NotificationConfigurationApi.GetNotificationConfigurationResponse);
    });
