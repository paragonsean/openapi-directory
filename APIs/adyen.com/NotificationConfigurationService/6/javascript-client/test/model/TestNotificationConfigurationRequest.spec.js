...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotificationConfigurationApi.TestNotificationConfigurationRequest();
  });
  ...
  describe('TestNotificationConfigurationRequest', function() {
    it('should create an instance of TestNotificationConfigurationRequest', function() {
      // uncomment below and update the code to test TestNotificationConfigurationRequest
      //var instance = new NotificationConfigurationApi.TestNotificationConfigurationRequest();
      //expect(instance).to.be.a(NotificationConfigurationApi.TestNotificationConfigurationRequest);
    });
