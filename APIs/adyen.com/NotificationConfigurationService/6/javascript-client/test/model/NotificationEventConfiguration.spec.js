...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotificationConfigurationApi.NotificationEventConfiguration();
  });
  ...
  describe('NotificationEventConfiguration', function() {
    it('should create an instance of NotificationEventConfiguration', function() {
      // uncomment below and update the code to test NotificationEventConfiguration
      //var instance = new NotificationConfigurationApi.NotificationEventConfiguration();
      //expect(instance).to.be.a(NotificationConfigurationApi.NotificationEventConfiguration);
    });
