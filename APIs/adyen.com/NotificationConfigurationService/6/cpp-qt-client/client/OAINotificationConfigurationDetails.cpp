...
void OAINotificationConfigurationDetails::initializeModel() {
    ...
    m_hmac_signature_key_isSet = false;
    m_hmac_signature_key_isValid = false;
...
void OAINotificationConfigurationDetails::fromJsonObject(QJsonObject json) {
    ...
    m_hmac_signature_key_isValid = ::OpenAPI::fromJsonValue(m_hmac_signature_key, json[QString("hmacSignatureKey")]);
    m_hmac_signature_key_isSet = !json[QString("hmacSignatureKey")].isNull() && m_hmac_signature_key_isValid;
...
QJsonObject OAINotificationConfigurationDetails::asJsonObject() const {
    ...
    if (m_hmac_signature_key_isSet) {
        obj.insert(QString("hmacSignatureKey"), ::OpenAPI::toJsonValue(m_hmac_signature_key));
    }
...
QList<OAINotificationEventConfiguration> OAINotificationConfigurationDetails::getEventConfigs() const {
    return m_event_configs;
}
void OAINotificationConfigurationDetails::setEventConfigs(const QList<OAINotificationEventConfiguration> &event_configs) {
...
QString OAINotificationConfigurationDetails::getHmacSignatureKey() const {
    return m_hmac_signature_key;
}
void OAINotificationConfigurationDetails::setHmacSignatureKey(const QString &hmac_signature_key) {
    m_hmac_signature_key = hmac_signature_key;
    m_hmac_signature_key_isSet = true;
}

bool OAINotificationConfigurationDetails::is_hmac_signature_key_Set() const{
    return m_hmac_signature_key_isSet;
}

bool OAINotificationConfigurationDetails::is_hmac_signature_key_Valid() const{
    return m_hmac_signature_key_isValid;
}
