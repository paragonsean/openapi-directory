...
/*
 * OAINotificationEventConfiguration.h
 *
 * 
 */

#ifndef OAINotificationEventConfiguration_H
#define OAINotificationEventConfiguration_H
...
class OAINotificationEventConfiguration : public OAIObject {
public:
    OAINotificationEventConfiguration();
    OAINotificationEventConfiguration(QString json);
    ~OAINotificationEventConfiguration() override;
    ...
    QString getIncludeMode() const;
    void setIncludeMode(const QString &include_mode);
    bool is_include_mode_Set() const;
    bool is_include_mode_Valid() const;
...
private:
    ...
    QString m_include_mode;
    bool m_include_mode_isSet;
    bool m_include_mode_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAINotificationEventConfiguration)

#endif // OAINotificationEventConfiguration_H
