...
public:
    ...
    QList<OAIExchangeMessage> getExchangeMessages() const;
    void setExchangeMessages(const QList<OAIExchangeMessage> &exchange_messages);
...
private:
    ...
    QList<OAIExchangeMessage> m_exchange_messages;
