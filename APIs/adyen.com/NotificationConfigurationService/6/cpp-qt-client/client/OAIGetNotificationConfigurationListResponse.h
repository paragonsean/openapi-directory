...
public:
    ...
    QList<OAINotificationConfigurationDetails> getConfigurations() const;
    void setConfigurations(const QList<OAINotificationConfigurationDetails> &configurations);
...
private:
    ...
    QList<OAINotificationConfigurationDetails> m_configurations;
