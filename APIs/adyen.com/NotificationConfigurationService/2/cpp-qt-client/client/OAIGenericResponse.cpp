...
bool OAIGenericResponse::isSubmittedAsync() const {
    return m_submitted_async;
}
void OAIGenericResponse::setSubmittedAsync(const bool &submitted_async) {
    m_submitted_async = submitted_async;
    m_submitted_async_isSet = true;
}

bool OAIGenericResponse::is_submitted_async_Set() const{
    return m_submitted_async_isSet;
}

bool OAIGenericResponse::is_submitted_async_Valid() const{
