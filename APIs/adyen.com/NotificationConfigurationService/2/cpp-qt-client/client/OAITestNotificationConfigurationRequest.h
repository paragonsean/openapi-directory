...
/*
 * OAITestNotificationConfigurationRequest.h
 *
 * 
 */

#ifndef OAITestNotificationConfigurationRequest_H
#define OAITestNotificationConfigurationRequest_H
...
class OAITestNotificationConfigurationRequest : public OAIObject {
public:
    OAITestNotificationConfigurationRequest();
    OAITestNotificationConfigurationRequest(QString json);
    ~OAITestNotificationConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestNotificationConfigurationRequest)

#endif // OAITestNotificationConfigurationRequest_H
