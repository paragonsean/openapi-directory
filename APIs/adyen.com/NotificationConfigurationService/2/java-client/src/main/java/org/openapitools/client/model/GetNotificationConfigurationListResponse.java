...
import org.openapitools.client.model.NotificationConfigurationDetailsWrapper;
...
public class GetNotificationConfigurationListResponse {
  ...
  private List<NotificationConfigurationDetailsWrapper> configurations = new ArrayList<>();
  ...
  public GetNotificationConfigurationListResponse configurations(List<NotificationConfigurationDetailsWrapper> configurations) {
    this.configurations = configurations;
    return this;
  }

  public GetNotificationConfigurationListResponse addConfigurationsItem(NotificationConfigurationDetailsWrapper configurationsItem) {
  ...
  public List<NotificationConfigurationDetailsWrapper> getConfigurations() {
    return configurations;
  }

  public void setConfigurations(List<NotificationConfigurationDetailsWrapper> configurations) {
    this.configurations = configurations;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.configurations, getNotificationConfigurationListResponse.configurations) &&
        ...
        Objects.equals(this.submittedAsync, getNotificationConfigurationListResponse.submittedAsync);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configurations, pspReference, resultCode, submittedAsync);
  }
      ...
      if (jsonObj.get("configurations") != null && !jsonObj.get("configurations").isJsonNull()) {
        ...
        if (jsonArrayconfigurations != null) {
          ...
          for (int i = 0; i < jsonArrayconfigurations.size(); i++) {
            NotificationConfigurationDetailsWrapper.validateJsonElement(jsonArrayconfigurations.get(i));
          };
        }
      }
