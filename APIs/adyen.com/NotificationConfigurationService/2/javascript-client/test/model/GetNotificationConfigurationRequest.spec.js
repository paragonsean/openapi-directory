...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotificationConfigurationApi.GetNotificationConfigurationRequest();
  });
  ...
  describe('GetNotificationConfigurationRequest', function() {
    it('should create an instance of GetNotificationConfigurationRequest', function() {
      // uncomment below and update the code to test GetNotificationConfigurationRequest
      //var instance = new NotificationConfigurationApi.GetNotificationConfigurationRequest();
      //expect(instance).to.be.a(NotificationConfigurationApi.GetNotificationConfigurationRequest);
    });
