...
import NotificationConfigurationDetailsWrapper from './NotificationConfigurationDetailsWrapper';

/**
 * The GetNotificationConfigurationListResponse model module.
 * @module model/GetNotificationConfigurationListResponse
 * @version 2
 */
class GetNotificationConfigurationListResponse {
    /**
     * Constructs a new <code>GetNotificationConfigurationListResponse</code>.
     * @alias module:model/GetNotificationConfigurationListResponse
     */
    constructor() { 
        
        GetNotificationConfigurationListResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetNotificationConfigurationListResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetNotificationConfigurationListResponse} obj Optional instance to populate.
     * @return {module:model/GetNotificationConfigurationListResponse} The populated <code>GetNotificationConfigurationListResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetNotificationConfigurationListResponse();

            if (data.hasOwnProperty('configurations')) {
                obj['configurations'] = ApiClient.convertToType(data['configurations'], [NotificationConfigurationDetailsWrapper]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetNotificationConfigurationListResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetNotificationConfigurationListResponse</code>.
     */
    static validateJSON(data) {
        if (data['configurations']) { // data not null
            ...
            for (const item of data['configurations']) {
                NotificationConfigurationDetailsWrapper.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/NotificationConfigurationDetailsWrapper>} configurations
 */
GetNotificationConfigurationListResponse.prototype['configurations'] = undefined;

/**
 * The reference of a request. Can be used to uniquely identify the request.
 * @member {String} pspReference
 */
GetNotificationConfigurationListResponse.prototype['pspReference'] = undefined;

/**
 * The result code.
 * @member {String} resultCode
 */
GetNotificationConfigurationListResponse.prototype['resultCode'] = undefined;
 ...
 */
GetNotificationConfigurationListResponse.prototype['submittedAsync'] = undefined;
...
export default GetNotificationConfigurationListResponse;
