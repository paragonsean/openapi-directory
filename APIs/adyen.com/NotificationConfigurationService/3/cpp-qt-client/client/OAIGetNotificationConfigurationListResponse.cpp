...
QList<OAINotificationConfigurationDetailsWrapper> OAIGetNotificationConfigurationListResponse::getConfigurations() const {
    return m_configurations;
}
void OAIGetNotificationConfigurationListResponse::setConfigurations(const QList<OAINotificationConfigurationDetailsWrapper> &configurations) {
...
bool OAIGetNotificationConfigurationListResponse::isSubmittedAsync() const {
    return m_submitted_async;
}
void OAIGetNotificationConfigurationListResponse::setSubmittedAsync(const bool &submitted_async) {
    m_submitted_async = submitted_async;
    m_submitted_async_isSet = true;
}

bool OAIGetNotificationConfigurationListResponse::is_submitted_async_Set() const{
    return m_submitted_async_isSet;
}

bool OAIGetNotificationConfigurationListResponse::is_submitted_async_Valid() const{
