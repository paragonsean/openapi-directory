...
|------------ | ------------- | ------------- | -------------|
|**configurations** | [**List&lt;NotificationConfigurationDetailsWrapper&gt;**](NotificationConfigurationDetailsWrapper.md) | Details of the notification subscription configurations. |  [optional] |
