...
public class NotificationConfigurationDetails {
  ...
  private List<NotificationEventConfigurationWrapper> eventConfigs = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_SEND_ACTION_HEADER = "sendActionHeader";
  @Deprecated
  @SerializedName(SERIALIZED_NAME_SEND_ACTION_HEADER)
  private Boolean sendActionHeader;
  ...
  public NotificationConfigurationDetails eventConfigs(List<NotificationEventConfigurationWrapper> eventConfigs) {
    this.eventConfigs = eventConfigs;
    return this;
  }

  public NotificationConfigurationDetails addEventConfigsItem(NotificationEventConfigurationWrapper eventConfigsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<NotificationEventConfigurationWrapper> getEventConfigs() {
    return eventConfigs;
  }

  public void setEventConfigs(List<NotificationEventConfigurationWrapper> eventConfigs) {
    this.eventConfigs = eventConfigs;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, apiVersion, description, eventConfigs, messageFormat, notificationId, notifyPassword, notifyURL, notifyUsername, sendActionHeader, sslProtocol);
  }
  ...
  static {
    ...
    openapiFields.add("sendActionHeader");
      ...
      if (jsonObj.get("eventConfigs") != null && !jsonObj.get("eventConfigs").isJsonNull()) {
        ...
        if (jsonArrayeventConfigs != null) {
          ...
          for (int i = 0; i < jsonArrayeventConfigs.size(); i++) {
            NotificationEventConfigurationWrapper.validateJsonElement(jsonArrayeventConfigs.get(i));
          };
        }
      }
