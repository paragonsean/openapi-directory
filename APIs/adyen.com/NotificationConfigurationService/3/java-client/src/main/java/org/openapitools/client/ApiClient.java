...
public class ApiClient {
    ...
    private String basePath = "https://cal-test.adyen.com/cal/services/Notification/v3";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://cal-test.adyen.com/cal/services/Notification/v3",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cal-test.adyen.com/cal/services/Notification/v3
