...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://cal-test.adyen.com/cal/services/Notification/v3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://cal-test.adyen.com/cal/services/Notification/v3
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/3/Javascript'
        };
