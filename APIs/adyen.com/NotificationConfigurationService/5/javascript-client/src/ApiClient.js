...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://cal-test.adyen.com/cal/services/Notification/v5') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://cal-test.adyen.com/cal/services/Notification/v5
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/5/Javascript'
        };
