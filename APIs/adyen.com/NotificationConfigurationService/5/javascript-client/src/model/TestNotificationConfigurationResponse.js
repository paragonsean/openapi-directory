    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('exchangeMessages')) {
                obj['exchangeMessages'] = ApiClient.convertToType(data['exchangeMessages'], [ExchangeMessage]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['exchangeMessages']) { // data not null
            ...
            for (const item of data['exchangeMessages']) {
                ExchangeMessage.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/ExchangeMessage>} exchangeMessages
 */
 ...
 */
TestNotificationConfigurationResponse.prototype['invalidFields'] = undefined;
