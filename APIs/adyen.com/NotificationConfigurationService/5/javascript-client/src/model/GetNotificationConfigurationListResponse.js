    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('configurations')) {
                obj['configurations'] = ApiClient.convertToType(data['configurations'], [NotificationConfigurationDetails]);
            }
    ...
    static validateJSON(data) {
        if (data['configurations']) { // data not null
            ...
            for (const item of data['configurations']) {
                NotificationConfigurationDetails.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/NotificationConfigurationDetails>} configurations
 */
 ...
 */
GetNotificationConfigurationListResponse.prototype['invalidFields'] = undefined;
