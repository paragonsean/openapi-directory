...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotificationConfigurationApi.FieldType();
  });
  ...
  describe('FieldType', function() {
    it('should create an instance of FieldType', function() {
      ...
      //var instance = new NotificationConfigurationApi.FieldType();
      //expect(instance).to.be.a(NotificationConfigurationApi.FieldType);
    });
