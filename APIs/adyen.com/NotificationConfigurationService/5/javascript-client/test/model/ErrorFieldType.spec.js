...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotificationConfigurationApi.ErrorFieldType();
  });
  ...
  describe('ErrorFieldType', function() {
    it('should create an instance of ErrorFieldType', function() {
      ...
      //var instance = new NotificationConfigurationApi.ErrorFieldType();
      //expect(instance).to.be.a(NotificationConfigurationApi.ErrorFieldType);
    });
