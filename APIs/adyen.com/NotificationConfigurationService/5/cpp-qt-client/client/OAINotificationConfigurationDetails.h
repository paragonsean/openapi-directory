...
public:
    ...
    QList<OAINotificationEventConfiguration> getEventConfigs() const;
    void setEventConfigs(const QList<OAINotificationEventConfiguration> &event_configs);
    bool is_event_configs_Set() const;
    bool is_event_configs_Valid() const;

    QString getHmacSignatureKey() const;
    void setHmacSignatureKey(const QString &hmac_signature_key);
    bool is_hmac_signature_key_Set() const;
    bool is_hmac_signature_key_Valid() const;
...
private:
    ...
    QList<OAINotificationEventConfiguration> m_event_configs;
    bool m_event_configs_isSet;
    bool m_event_configs_isValid;

    QString m_hmac_signature_key;
    bool m_hmac_signature_key_isSet;
    bool m_hmac_signature_key_isValid;
