...
/*
 * OAIGetTaxFormResponse.h
 *
 * 
 */

#ifndef OAIGetTaxFormResponse_H
#define OAIGetTaxFormResponse_H
...
class OAIGetTaxFormResponse : public OAIObject {
public:
    OAIGetTaxFormResponse();
    OAIGetTaxFormResponse(QString json);
    ~OAIGetTaxFormResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTaxFormResponse)

#endif // OAIGetTaxFormResponse_H
