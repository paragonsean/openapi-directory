...
QList<OAIUltimateParentCompany> OAIBusinessDetails::getListedUltimateParentCompany() const {
    return m_listed_ultimate_parent_company;
}
void OAIBusinessDetails::setListedUltimateParentCompany(const QList<OAIUltimateParentCompany> &listed_ultimate_parent_company) {
...
QList<OAIShareholderContact> OAIBusinessDetails::getShareholders() const {
    return m_shareholders;
}
void OAIBusinessDetails::setShareholders(const QList<OAIShareholderContact> &shareholders) {
...
QList<OAISignatoryContact> OAIBusinessDetails::getSignatories() const {
    return m_signatories;
}
void OAIBusinessDetails::setSignatories(const QList<OAISignatoryContact> &signatories) {
...
QString OAIBusinessDetails::getStockExchange() const {
    return m_stock_exchange;
}
void OAIBusinessDetails::setStockExchange(const QString &stock_exchange) {
    m_stock_exchange = stock_exchange;
    m_stock_exchange_isSet = true;
}

bool OAIBusinessDetails::is_stock_exchange_Set() const{
    return m_stock_exchange_isSet;
}

bool OAIBusinessDetails::is_stock_exchange_Valid() const{
    return m_stock_exchange_isValid;
}

QString OAIBusinessDetails::getStockNumber() const {
    return m_stock_number;
}
void OAIBusinessDetails::setStockNumber(const QString &stock_number) {
    m_stock_number = stock_number;
    m_stock_number_isSet = true;
}

bool OAIBusinessDetails::is_stock_number_Set() const{
    return m_stock_number_isSet;
}

bool OAIBusinessDetails::is_stock_number_Valid() const{
    return m_stock_number_isValid;
}

QString OAIBusinessDetails::getStockTicker() const {
    return m_stock_ticker;
}
void OAIBusinessDetails::setStockTicker(const QString &stock_ticker) {
    m_stock_ticker = stock_ticker;
    m_stock_ticker_isSet = true;
}

bool OAIBusinessDetails::is_stock_ticker_Set() const{
    return m_stock_ticker_isSet;
}

bool OAIBusinessDetails::is_stock_ticker_Valid() const{
