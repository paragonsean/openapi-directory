...
public:
    ...
    QString getBeneficiaryAccount() const;
    void setBeneficiaryAccount(const QString &beneficiary_account);
    bool is_beneficiary_account_Set() const;
    bool is_beneficiary_account_Valid() const;

    QString getBeneficiaryMerchantReference() const;
    void setBeneficiaryMerchantReference(const QString &beneficiary_merchant_reference);
    bool is_beneficiary_merchant_reference_Set() const;
    bool is_beneficiary_merchant_reference_Valid() const;
...
private:
    ...
    QString m_beneficiary_account;
    bool m_beneficiary_account_isSet;
    bool m_beneficiary_account_isValid;

    QString m_beneficiary_merchant_reference;
    bool m_beneficiary_merchant_reference_isSet;
    bool m_beneficiary_merchant_reference_isValid;
