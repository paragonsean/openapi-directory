...
public:
    ...
    */
    ...
    /**
    * @param[in]  oai_close_stores_request OAICloseStoresRequest [optional]
    */
    virtual void postCloseStores(const ::OpenAPI::OptionalParam<OAICloseStoresRequest> &oai_close_stores_request = ::OpenAPI::OptionalParam<OAICloseStoresRequest>());
...
private:
    ...
    void postCloseStoresCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void postCloseStoresSignal(OAIGenericResponse summary);
    ...
    void postCloseStoresSignalFull(OAIHttpRequestWorker *worker, OAIGenericResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use postCloseStoresSignalError() instead")
    void postCloseStoresSignalE(OAIGenericResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postCloseStoresSignalError(OAIGenericResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use postCloseStoresSignalErrorFull() instead")
    void postCloseStoresSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postCloseStoresSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
