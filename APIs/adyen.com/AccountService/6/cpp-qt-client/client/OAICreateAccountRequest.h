...
public:
    ...
    QString getPayoutSchedule() const;
    void setPayoutSchedule(const QString &payout_schedule);
    bool is_payout_schedule_Set() const;
    bool is_payout_schedule_Valid() const;

    QString getPayoutScheduleReason() const;
    void setPayoutScheduleReason(const QString &payout_schedule_reason);
    bool is_payout_schedule_reason_Set() const;
    bool is_payout_schedule_reason_Valid() const;
...
private:
    ...
    QString m_payout_schedule;
    bool m_payout_schedule_isSet;
    bool m_payout_schedule_isValid;

    QString m_payout_schedule_reason;
    bool m_payout_schedule_reason_isSet;
    bool m_payout_schedule_reason_isValid;
