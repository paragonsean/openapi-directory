...
public:
    ...
    QList<OAIDocumentDetail> getDocumentDetails() const;
    void setDocumentDetails(const QList<OAIDocumentDetail> &document_details);
...
private:
    ...
    QList<OAIDocumentDetail> m_document_details;
