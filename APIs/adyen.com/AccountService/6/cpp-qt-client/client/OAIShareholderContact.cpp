...
void OAIShareholderContact::initializeModel() {
    ...
    m_shareholder_reference_isSet = false;
    m_shareholder_reference_isValid = false;
...
void OAIShareholderContact::fromJsonObject(QJsonObject json) {
    ...
    m_shareholder_reference_isValid = ::OpenAPI::fromJsonValue(m_shareholder_reference, json[QString("shareholderReference")]);
    m_shareholder_reference_isSet = !json[QString("shareholderReference")].isNull() && m_shareholder_reference_isValid;
...
QJsonObject OAIShareholderContact::asJsonObject() const {
    ...
    if (m_shareholder_reference_isSet) {
        obj.insert(QString("shareholderReference"), ::OpenAPI::toJsonValue(m_shareholder_reference));
    }
...
QString OAIShareholderContact::getShareholderReference() const {
    return m_shareholder_reference;
}
void OAIShareholderContact::setShareholderReference(const QString &shareholder_reference) {
    m_shareholder_reference = shareholder_reference;
    m_shareholder_reference_isSet = true;
}

bool OAIShareholderContact::is_shareholder_reference_Set() const{
    return m_shareholder_reference_isSet;
}

bool OAIShareholderContact::is_shareholder_reference_Valid() const{
    return m_shareholder_reference_isValid;
}
