...
QList<OAIErrorFieldType> OAIGetAccountHolderStatusResponse::getInvalidFields() const {
    return m_invalid_fields;
}
void OAIGetAccountHolderStatusResponse::setInvalidFields(const QList<OAIErrorFieldType> &invalid_fields) {
    m_invalid_fields = invalid_fields;
    m_invalid_fields_isSet = true;
}

bool OAIGetAccountHolderStatusResponse::is_invalid_fields_Set() const{
    return m_invalid_fields_isSet;
}

bool OAIGetAccountHolderStatusResponse::is_invalid_fields_Valid() const{
