...
QString OAIGetAccountHolderResponse::getVerificationProfile() const {
    return m_verification_profile;
}
void OAIGetAccountHolderResponse::setVerificationProfile(const QString &verification_profile) {
    m_verification_profile = verification_profile;
    m_verification_profile_isSet = true;
}

bool OAIGetAccountHolderResponse::is_verification_profile_Set() const{
    return m_verification_profile_isSet;
}

bool OAIGetAccountHolderResponse::is_verification_profile_Valid() const{
