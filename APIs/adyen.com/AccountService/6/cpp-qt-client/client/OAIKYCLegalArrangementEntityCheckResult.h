...
/*
 * OAIKYCLegalArrangementEntityCheckResult.h
 *
 * 
 */

#ifndef OAIKYCLegalArrangementEntityCheckResult_H
#define OAIKYCLegalArrangementEntityCheckResult_H
...
class OAIKYCLegalArrangementEntityCheckResult : public OAIObject {
public:
    OAIKYCLegalArrangementEntityCheckResult();
    OAIKYCLegalArrangementEntityCheckResult(QString json);
    ~OAIKYCLegalArrangementEntityCheckResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKYCLegalArrangementEntityCheckResult)

#endif // OAIKYCLegalArrangementEntityCheckResult_H
