...
class OAILegalArrangementDetail;
...
public:
    ...
    QList<OAILegalArrangementDetail> getLegalArrangements() const;
    void setLegalArrangements(const QList<OAILegalArrangementDetail> &legal_arrangements);
...
private:
    ...
    QList<OAILegalArrangementDetail> m_legal_arrangements;
