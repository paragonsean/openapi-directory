...
async def test_post_check_account_holder(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v6/checkAccountHolder',
        headers=headers,
        json=body,
        )
...
async def test_post_delete_bank_accounts(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v6/deleteBankAccounts',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_delete_legal_arrangements(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v6/deleteLegalArrangements',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_delete_payout_methods(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v6/deletePayoutMethods',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_delete_shareholders(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v6/deleteShareholders',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_delete_signatories(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v6/deleteSignatories',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_get_uploaded_documents(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v6/getUploadedDocuments',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_upload_document(client):
    ...
    Upload a document
    """
    body = {"documentContent":"documentContent","documentDetail":{"accountHolderCode":"accountHolderCode","bankAccountUUID":"bankAccountUUID","filename":"filename","signatoryCode":"signatoryCode","documentType":"BANK_STATEMENT","legalArrangementCode":"legalArrangementCode","description":"description","legalArrangementEntityCode":"legalArrangementEntityCode","shareholderCode":"shareholderCode"}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'Authorization': 'BasicZm9vOmJhcg==',
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v6/uploadDocument',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
