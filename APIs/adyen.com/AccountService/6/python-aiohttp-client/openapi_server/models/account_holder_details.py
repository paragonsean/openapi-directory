...
class AccountHolderDetails(Model):
    ...
    def __init__(self, address: ViasAddress=None, bank_account_details: List[BankAccountDetail]=None, bank_aggregator_data_reference: str=None, business_details: BusinessDetails=None, email: str=None, full_phone_number: str=None, individual_details: IndividualDetails=None, last_review_date: str=None, legal_arrangements: List[LegalArrangementDetail]=None, merchant_category_code: str=None, metadata: Dict[str, str]=None, payout_methods: List[PayoutMethod]=None, principal_business_address: ViasAddress=None, store_details: List[StoreDetail]=None, web_address: str=None):
        ...
        :param legal_arrangements: The legal_arrangements of this AccountHolderDetails.
        ...
        self.openapi_types = {
            ...
            'legal_arrangements': List[LegalArrangementDetail],
    ...
    def legal_arrangements(self):
        """Gets the legal_arrangements of this AccountHolderDetails.
        ...
        :return: The legal_arrangements of this AccountHolderDetails.
        :rtype: List[LegalArrangementDetail]
        """
        return self._legal_arrangements

    @legal_arrangements.setter
    def legal_arrangements(self, legal_arrangements):
        """Sets the legal_arrangements of this AccountHolderDetails.

        An array containing information about the account holder's [legal arrangements](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/legal-arrangements).

        :param legal_arrangements: The legal_arrangements of this AccountHolderDetails.
        :type legal_arrangements: List[LegalArrangementDetail]
        """
