...
class CreateAccountHolderResponse(Model):
    ...
    def __init__(self, account_code: str=None, account_holder_code: str=None, account_holder_details: AccountHolderDetails=None, account_holder_status: AccountHolderStatus=None, description: str=None, invalid_fields: List[ErrorFieldType]=None, legal_entity: str=None, primary_currency: str=None, psp_reference: str=None, result_code: str=None, verification: KYCVerificationResult=None, verification_profile: str=None):
        ...
        :param verification_profile: The verification_profile of this CreateAccountHolderResponse.
        """
        self.openapi_types = {
            'account_code': str,
    ...
    def verification_profile(self):
        """Gets the verification_profile of this CreateAccountHolderResponse.

        The identifier of the profile that applies to this entity.

        :return: The verification_profile of this CreateAccountHolderResponse.
        :rtype: str
        """
    ...
    def verification_profile(self, verification_profile):
        """Sets the verification_profile of this CreateAccountHolderResponse.
