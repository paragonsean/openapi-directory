...
class GetAccountHolderResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('migrationData')) {
                obj['migrationData'] = MigrationData.constructFromObject(data['migrationData']);
            }
            ...
            if (data.hasOwnProperty('systemUpToDateTime')) {
                obj['systemUpToDateTime'] = ApiClient.convertToType(data['systemUpToDateTime'], 'Date');
            }
            if (data.hasOwnProperty('verification')) {
                obj['verification'] = KYCVerificationResult.constructFromObject(data['verification']);
            }
            if (data.hasOwnProperty('verificationProfile')) {
                obj['verificationProfile'] = ApiClient.convertToType(data['verificationProfile'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['migrationData']) { // data not null
          MigrationData.validateJSON(data['migrationData']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['verificationProfile'] && !(typeof data['verificationProfile'] === 'string' || data['verificationProfile'] instanceof String)) {
            throw new Error("Expected the field `verificationProfile` to be a primitive type in the JSON string but got " + data['verificationProfile']);
        }
 ...
 */
GetAccountHolderResponse.prototype['invalidFields'] = undefined;
 ...
 * @member {module:model/MigrationData} migrationData
 */
GetAccountHolderResponse.prototype['migrationData'] = undefined;
 ...
 * @member {Date} systemUpToDateTime
 */
GetAccountHolderResponse.prototype['systemUpToDateTime'] = undefined;
 ...
 * @member {String} verificationProfile
 */
GetAccountHolderResponse.prototype['verificationProfile'] = undefined;
