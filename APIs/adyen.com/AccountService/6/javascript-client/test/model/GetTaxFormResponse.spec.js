...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.GetTaxFormResponse();
  });
  ...
  describe('GetTaxFormResponse', function() {
    it('should create an instance of GetTaxFormResponse', function() {
      // uncomment below and update the code to test GetTaxFormResponse
      //var instance = new AccountApi.GetTaxFormResponse();
      //expect(instance).to.be.a(AccountApi.GetTaxFormResponse);
    });
