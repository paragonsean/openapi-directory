...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.CloseStoresRequest();
  });
  ...
  describe('CloseStoresRequest', function() {
    it('should create an instance of CloseStoresRequest', function() {
      // uncomment below and update the code to test CloseStoresRequest
      //var instance = new AccountApi.CloseStoresRequest();
      //expect(instance).to.be.a(AccountApi.CloseStoresRequest);
    });
