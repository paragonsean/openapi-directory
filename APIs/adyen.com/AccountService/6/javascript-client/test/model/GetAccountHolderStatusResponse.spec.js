...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.GetAccountHolderStatusResponse();
  });
  ...
  describe('GetAccountHolderStatusResponse', function() {
    it('should create an instance of GetAccountHolderStatusResponse', function() {
      // uncomment below and update the code to test GetAccountHolderStatusResponse
      //var instance = new AccountApi.GetAccountHolderStatusResponse();
      //expect(instance).to.be.a(AccountApi.GetAccountHolderStatusResponse);
    });
