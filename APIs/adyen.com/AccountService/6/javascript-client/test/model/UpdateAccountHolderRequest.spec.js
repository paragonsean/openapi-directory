...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.UpdateAccountHolderRequest();
  });
  ...
  describe('UpdateAccountHolderRequest', function() {
    it('should create an instance of UpdateAccountHolderRequest', function() {
      // uncomment below and update the code to test UpdateAccountHolderRequest
      //var instance = new AccountApi.UpdateAccountHolderRequest();
      //expect(instance).to.be.a(AccountApi.UpdateAccountHolderRequest);
    });
