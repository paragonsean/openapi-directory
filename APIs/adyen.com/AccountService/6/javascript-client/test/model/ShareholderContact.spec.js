...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.ShareholderContact();
  });
  ...
  describe('ShareholderContact', function() {
    it('should create an instance of ShareholderContact', function() {
      ...
      //var instance = new AccountApi.ShareholderContact();
      //expect(instance).to.be.a(AccountApi.ShareholderContact);
    });
    ...
    it('should have the property shareholderReference (base name: "shareholderReference")', function() {
      // uncomment below and update the code to test the property shareholderReference
      //var instance = new AccountApi.ShareholderContact();
      //expect(instance).to.be();
    });
