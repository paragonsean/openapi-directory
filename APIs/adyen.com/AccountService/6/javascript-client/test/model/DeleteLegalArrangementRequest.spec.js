...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.DeleteLegalArrangementRequest();
  });
  ...
  describe('DeleteLegalArrangementRequest', function() {
    it('should create an instance of DeleteLegalArrangementRequest', function() {
      // uncomment below and update the code to test DeleteLegalArrangementRequest
      //var instance = new AccountApi.DeleteLegalArrangementRequest();
      //expect(instance).to.be.a(AccountApi.DeleteLegalArrangementRequest);
    });
