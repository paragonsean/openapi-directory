...
public class GetAccountHolderResponse {
  ...
  public static final String SERIALIZED_NAME_SYSTEM_UP_TO_DATE_TIME = "systemUpToDateTime";
  @SerializedName(SERIALIZED_NAME_SYSTEM_UP_TO_DATE_TIME)
  ...
  static {
    ...
    openapiFields.add("systemUpToDateTime");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `migrationData`
      if (jsonObj.get("migrationData") != null && !jsonObj.get("migrationData").isJsonNull()) {
        MigrationData.validateJsonElement(jsonObj.get("migrationData"));
      }
