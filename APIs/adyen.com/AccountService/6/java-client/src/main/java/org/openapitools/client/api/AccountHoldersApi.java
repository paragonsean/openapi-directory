...
public class AccountHoldersApi {
    ...
    /**
     * Build call for postCloseStores
     * @param closeStoresRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call postCloseStoresCall(CloseStoresRequest closeStoresRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = closeStoresRequest;

        // create path and map variables
        String localVarPath = "/closeStores";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postCloseStoresValidateBeforeCall(CloseStoresRequest closeStoresRequest, final ApiCallback _callback) throws ApiException {
        return postCloseStoresCall(closeStoresRequest, _callback);
     ...
     */
    public GenericResponse postCloseStores(CloseStoresRequest closeStoresRequest) throws ApiException {
        ApiResponse<GenericResponse> localVarResp = postCloseStoresWithHttpInfo(closeStoresRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GenericResponse> postCloseStoresWithHttpInfo(CloseStoresRequest closeStoresRequest) throws ApiException {
        okhttp3.Call localVarCall = postCloseStoresValidateBeforeCall(closeStoresRequest, null);
        Type localVarReturnType = new TypeToken<GenericResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Close stores (asynchronously)
     * Closes stores associated with an account holder.
     * @param closeStoresRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call postCloseStoresAsync(CloseStoresRequest closeStoresRequest, final ApiCallback<GenericResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = postCloseStoresValidateBeforeCall(closeStoresRequest, _callback);
        Type localVarReturnType = new TypeToken<GenericResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
