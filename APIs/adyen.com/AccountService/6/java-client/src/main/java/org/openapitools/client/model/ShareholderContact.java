...
public class ShareholderContact {
  ...
  public static final String SERIALIZED_NAME_SHAREHOLDER_REFERENCE = "shareholderReference";
  @SerializedName(SERIALIZED_NAME_SHAREHOLDER_REFERENCE)
  ...
  static {
    ...
    openapiFields.add("shareholderReference");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("shareholderReference") != null && !jsonObj.get("shareholderReference").isJsonNull()) && !jsonObj.get("shareholderReference").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `shareholderReference` to be a primitive type in the JSON string but got `%s`", jsonObj.get("shareholderReference").toString()));
      }
