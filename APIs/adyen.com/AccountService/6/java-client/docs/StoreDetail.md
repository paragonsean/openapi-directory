...
|**shopperInteraction** | [**ShopperInteractionEnum**](#ShopperInteractionEnum) | The sales channel. Possible values: **Ecommerce**, **POS**. |  [optional] |
...
|**status** | [**StatusEnum**](#StatusEnum) | The status of the store. Possible values: **Pending**, **Active**, **Inactive**, **InactiveWithModifications**, **Closed**. |  [optional] |
