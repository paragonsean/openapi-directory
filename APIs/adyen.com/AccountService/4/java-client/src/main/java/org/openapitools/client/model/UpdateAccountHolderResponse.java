...
public class UpdateAccountHolderResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountHolderCode, accountHolderDetails, accountHolderStatus, description, invalidFields, legalEntity, pspReference, resultCode, submittedAsync, updatedFields, verification);
  }
