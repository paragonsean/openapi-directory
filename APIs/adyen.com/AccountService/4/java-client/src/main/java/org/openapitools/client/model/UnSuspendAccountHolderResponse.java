...
public class UnSuspendAccountHolderResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountHolderStatus, unSuspendAccountHolderResponse.accountHolderStatus) &&
        ...
        Objects.equals(this.submittedAsync, unSuspendAccountHolderResponse.submittedAsync);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnSuspendAccountHolderResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnSuspendAccountHolderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnSuspendAccountHolderResponse is not found in the empty JSON string", UnSuspendAccountHolderResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnSuspendAccountHolderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnSuspendAccountHolderResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnSuspendAccountHolderResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnSuspendAccountHolderResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnSuspendAccountHolderResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnSuspendAccountHolderResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UnSuspendAccountHolderResponse>() {
           @Override
           public void write(JsonWriter out, UnSuspendAccountHolderResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnSuspendAccountHolderResponse read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to UnSuspendAccountHolderResponse
   */
  public static UnSuspendAccountHolderResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnSuspendAccountHolderResponse.class);
  }
