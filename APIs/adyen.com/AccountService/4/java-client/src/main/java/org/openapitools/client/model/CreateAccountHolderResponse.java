...
public class CreateAccountHolderResponse {
  ...
  public CreateAccountHolderResponse invalidFields(List<ErrorFieldTypeWrapper> invalidFields) {
    this.invalidFields = invalidFields;
    return this;
  }

  public CreateAccountHolderResponse addInvalidFieldsItem(ErrorFieldTypeWrapper invalidFieldsItem) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountCode, accountHolderCode, accountHolderDetails, accountHolderStatus, description, invalidFields, legalEntity, pspReference, resultCode, submittedAsync, verification);
  }
