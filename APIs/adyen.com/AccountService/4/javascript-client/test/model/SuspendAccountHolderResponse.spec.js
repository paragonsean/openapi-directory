...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.SuspendAccountHolderResponse();
  });
  ...
  describe('SuspendAccountHolderResponse', function() {
    it('should create an instance of SuspendAccountHolderResponse', function() {
      // uncomment below and update the code to test SuspendAccountHolderResponse
      //var instance = new AccountApi.SuspendAccountHolderResponse();
      //expect(instance).to.be.a(AccountApi.SuspendAccountHolderResponse);
    });
