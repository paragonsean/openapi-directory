...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.ViasPersonalData();
  });
  ...
  describe('ViasPersonalData', function() {
    it('should create an instance of ViasPersonalData', function() {
      // uncomment below and update the code to test ViasPersonalData
      //var instance = new AccountApi.ViasPersonalData();
      //expect(instance).to.be.a(AccountApi.ViasPersonalData);
    });
    ...
    it('should have the property documentData (base name: "documentData")', function() {
      // uncomment below and update the code to test the property documentData
      //var instance = new AccountApi.ViasPersonalData();
      //expect(instance).to.be();
    });
