...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://cal-test.adyen.com/cal/services/Account/v4') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://cal-test.adyen.com/cal/services/Account/v4
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/4/Javascript'
        };
