...
/**
 * The SuspendAccountHolderResponse model module.
 * @module model/SuspendAccountHolderResponse
 * @version 4
 */
class SuspendAccountHolderResponse {
    /**
     * Constructs a new <code>SuspendAccountHolderResponse</code>.
     * @alias module:model/SuspendAccountHolderResponse
     */
    constructor() { 
        
        SuspendAccountHolderResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SuspendAccountHolderResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SuspendAccountHolderResponse} obj Optional instance to populate.
     * @return {module:model/SuspendAccountHolderResponse} The populated <code>SuspendAccountHolderResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SuspendAccountHolderResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>SuspendAccountHolderResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SuspendAccountHolderResponse</code>.
     */
 ...
 */
SuspendAccountHolderResponse.prototype['accountHolderStatus'] = undefined;

/**
 * The reference of a request. Can be used to uniquely identify the request.
 * @member {String} pspReference
 */
SuspendAccountHolderResponse.prototype['pspReference'] = undefined;

/**
 * The result code.
 * @member {String} resultCode
 */
SuspendAccountHolderResponse.prototype['resultCode'] = undefined;
 ...
 */
SuspendAccountHolderResponse.prototype['submittedAsync'] = undefined;
...
export default SuspendAccountHolderResponse;
