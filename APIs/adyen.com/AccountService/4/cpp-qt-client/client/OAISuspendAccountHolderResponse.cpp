...
bool OAISuspendAccountHolderResponse::isSubmittedAsync() const {
    return m_submitted_async;
}
void OAISuspendAccountHolderResponse::setSubmittedAsync(const bool &submitted_async) {
    m_submitted_async = submitted_async;
    m_submitted_async_isSet = true;
}

bool OAISuspendAccountHolderResponse::is_submitted_async_Set() const{
    return m_submitted_async_isSet;
}

bool OAISuspendAccountHolderResponse::is_submitted_async_Valid() const{
