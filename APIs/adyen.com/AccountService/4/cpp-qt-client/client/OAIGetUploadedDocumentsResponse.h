...
/*
 * OAIGetUploadedDocumentsResponse.h
 *
 * 
 */

#ifndef OAIGetUploadedDocumentsResponse_H
#define OAIGetUploadedDocumentsResponse_H
...
namespace OpenAPI {
class OAIDocumentDetailWrapper;

class OAIGetUploadedDocumentsResponse : public OAIObject {
public:
    OAIGetUploadedDocumentsResponse();
    OAIGetUploadedDocumentsResponse(QString json);
    ~OAIGetUploadedDocumentsResponse() override;
    ...
    QList<OAIDocumentDetailWrapper> getDocumentDetails() const;
    void setDocumentDetails(const QList<OAIDocumentDetailWrapper> &document_details);
...
private:
    ...
    QList<OAIDocumentDetailWrapper> m_document_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUploadedDocumentsResponse)

#endif // OAIGetUploadedDocumentsResponse_H
