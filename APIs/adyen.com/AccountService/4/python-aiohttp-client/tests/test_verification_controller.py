...
async def test_post_delete_bank_accounts(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v4/deleteBankAccounts',
        headers=headers,
        json=body,
        )
...
async def test_post_delete_legal_arrangements(client):
    ...
    """
    body = {"accountHolderCode":"accountHolderCode","legalArrangements":[{"LegalArrangementRequest":{"legalArrangementCode":"legalArrangementCode","legalArrangementEntityCodes":["legalArrangementEntityCodes","legalArrangementEntityCodes"]}},{"LegalArrangementRequest":{"legalArrangementCode":"legalArrangementCode","legalArrangementEntityCodes":["legalArrangementEntityCodes","legalArrangementEntityCodes"]}}]}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'Authorization': 'BasicZm9vOmJhcg==',
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v4/deleteLegalArrangements',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_delete_shareholders(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v4/deleteShareholders',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_delete_signatories(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v4/deleteSignatories',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_get_uploaded_documents(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v4/getUploadedDocuments',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_upload_document(client):
    ...
    Upload a document
    """
    body = {"accountHolderCode":"accountHolderCode","bankAccountUUID":"bankAccountUUID","documentContent":"documentContent","shareholderCode":"shareholderCode","documentDetail":{"accountHolderCode":"accountHolderCode","bankAccountUUID":"bankAccountUUID","filename":"filename","signatoryCode":"signatoryCode","documentType":"BANK_STATEMENT","description":"description","shareholderCode":"shareholderCode"}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'Authorization': 'BasicZm9vOmJhcg==',
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v4/uploadDocument',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
