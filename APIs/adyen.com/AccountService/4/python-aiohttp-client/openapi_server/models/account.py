...
class Account(Model):
    ...
    def __init__(self, account_code: str=None, beneficiary_account: str=None, beneficiary_merchant_reference: str=None, description: str=None, payout_schedule: PayoutScheduleResponse=None, status: str=None):
