...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.UnSuspendAccountHolderResponse();
  });
  ...
  describe('UnSuspendAccountHolderResponse', function() {
    it('should create an instance of UnSuspendAccountHolderResponse', function() {
      // uncomment below and update the code to test UnSuspendAccountHolderResponse
      //var instance = new AccountApi.UnSuspendAccountHolderResponse();
      //expect(instance).to.be.a(AccountApi.UnSuspendAccountHolderResponse);
    });
