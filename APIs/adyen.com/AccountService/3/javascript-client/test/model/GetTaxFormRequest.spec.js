...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.GetTaxFormRequest();
  });
  ...
  describe('GetTaxFormRequest', function() {
    it('should create an instance of GetTaxFormRequest', function() {
      // uncomment below and update the code to test GetTaxFormRequest
      //var instance = new AccountApi.GetTaxFormRequest();
      //expect(instance).to.be.a(AccountApi.GetTaxFormRequest);
    });
