...
import BankAccountDetailWrapper from './BankAccountDetailWrapper';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('bankAccountDetails')) {
                obj['bankAccountDetails'] = ApiClient.convertToType(data['bankAccountDetails'], [BankAccountDetailWrapper]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['bankAccountDetails']) { // data not null
            ...
            for (const item of data['bankAccountDetails']) {
                BankAccountDetailWrapper.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/BankAccountDetailWrapper>} bankAccountDetails
 */
