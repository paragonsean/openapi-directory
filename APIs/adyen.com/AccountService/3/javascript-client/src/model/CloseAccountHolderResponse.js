...
/**
 * The CloseAccountHolderResponse model module.
 * @module model/CloseAccountHolderResponse
 * @version 3
 */
class CloseAccountHolderResponse {
    /**
     * Constructs a new <code>CloseAccountHolderResponse</code>.
     * @alias module:model/CloseAccountHolderResponse
     */
    constructor() { 
        
        CloseAccountHolderResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CloseAccountHolderResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CloseAccountHolderResponse} obj Optional instance to populate.
     * @return {module:model/CloseAccountHolderResponse} The populated <code>CloseAccountHolderResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CloseAccountHolderResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CloseAccountHolderResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CloseAccountHolderResponse</code>.
     */
 ...
 */
CloseAccountHolderResponse.prototype['accountHolderStatus'] = undefined;

/**
 * The reference of a request. Can be used to uniquely identify the request.
 * @member {String} pspReference
 */
CloseAccountHolderResponse.prototype['pspReference'] = undefined;

/**
 * The result code.
 * @member {String} resultCode
 */
CloseAccountHolderResponse.prototype['resultCode'] = undefined;
 ...
 */
CloseAccountHolderResponse.prototype['submittedAsync'] = undefined;
...
export default CloseAccountHolderResponse;
