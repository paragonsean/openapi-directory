...
import AccountEventWrapper from './AccountEventWrapper';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('events')) {
                obj['events'] = ApiClient.convertToType(data['events'], [AccountEventWrapper]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['events']) { // data not null
            ...
            for (const item of data['events']) {
                AccountEventWrapper.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/AccountEventWrapper>} events
 */
