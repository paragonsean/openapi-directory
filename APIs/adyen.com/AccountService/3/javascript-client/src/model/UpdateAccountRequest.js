...
class UpdateAccountRequest {
     ...
     * @param payoutSchedule {module:model/UpdatePayoutScheduleRequest} The details of the payout schedule, to which the account should be updated.
     */
    constructor(accountCode, payoutSchedule) { 
        
        UpdateAccountRequest.initialize(this, accountCode, payoutSchedule);
    }
     ...
     */
    static initialize(obj, accountCode, payoutSchedule) { 
        obj['accountCode'] = accountCode;
        obj['payoutSchedule'] = payoutSchedule;
    }
...
UpdateAccountRequest.RequiredProperties = ["accountCode", "payoutSchedule"];
