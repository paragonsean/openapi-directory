...
class DeleteLegalArrangementRequest(Model):
    ...
    def __init__(self, account_holder_code: str=None, legal_arrangements: List[LegalArrangementRequestWrapper]=None):
        ...
        self.openapi_types = {
            ...
            'legal_arrangements': List[LegalArrangementRequestWrapper]
        }
    ...
    def legal_arrangements(self):
        ...
        :rtype: List[LegalArrangementRequestWrapper]
        """
    ...
    def legal_arrangements(self, legal_arrangements):
        ...
        :param legal_arrangements: The legal_arrangements of this DeleteLegalArrangementRequest.
        :type legal_arrangements: List[LegalArrangementRequestWrapper]
        """
