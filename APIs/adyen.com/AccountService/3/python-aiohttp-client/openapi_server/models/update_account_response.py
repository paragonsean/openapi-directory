...
class UpdateAccountResponse(Model):
    ...
    def __init__(self, account_code: str=None, payout_schedule: PayoutScheduleResponse=None, psp_reference: str=None, result_code: str=None, submitted_async: bool=None):
