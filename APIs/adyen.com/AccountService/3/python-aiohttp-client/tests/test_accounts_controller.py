...
async def test_post_close_account(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/closeAccount',
        headers=headers,
        json=body,
        )
...
async def test_post_create_account(client):
    ...
    Create an account
    """
    body = {"accountHolderCode":"accountHolderCode","payoutScheduleReason":"payoutScheduleReason","payoutSchedule":"BIWEEKLY_ON_1ST_AND_15TH_AT_MIDNIGHT"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'Authorization': 'BasicZm9vOmJhcg==',
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/createAccount',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_update_account(client):
    ...
    Update an account
    """
    body = {"accountCode":"accountCode","payoutSchedule":{"reason":"reason","schedule":"BIWEEKLY_ON_1ST_AND_15TH_AT_MIDNIGHT","action":"CLOSE"}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'Authorization': 'BasicZm9vOmJhcg==',
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/updateAccount',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
