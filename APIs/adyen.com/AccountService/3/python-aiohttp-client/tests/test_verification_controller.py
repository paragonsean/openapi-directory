...
async def test_post_delete_bank_accounts(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/deleteBankAccounts',
        headers=headers,
        json=body,
        )
...
async def test_post_delete_legal_arrangements(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/deleteLegalArrangements',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_delete_shareholders(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/deleteShareholders',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_delete_signatories(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/deleteSignatories',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_get_uploaded_documents(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/getUploadedDocuments',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_upload_document(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/uploadDocument',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
