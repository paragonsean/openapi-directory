...
async def test_post_close_account_holder(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/closeAccountHolder',
        headers=headers,
        json=body,
        )
...
async def test_post_create_account_holder(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/createAccountHolder',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_get_account_holder(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/getAccountHolder',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_get_tax_form(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/getTaxForm',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_suspend_account_holder(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/suspendAccountHolder',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_un_suspend_account_holder(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/unSuspendAccountHolder',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_update_account_holder(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/updateAccountHolder',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_update_account_holder_state(client):
    ...
    response = await client.request(
        method='POST',
        path='/cal/services/Account/v3/updateAccountHolderState',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
