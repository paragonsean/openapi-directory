...
|**invalidFields** | [**List&lt;ErrorFieldTypeWrapper&gt;**](ErrorFieldTypeWrapper.md) | in case the account holder has not been updated, contains account holder fields, that did not pass the validation. |  [optional] |
...
|**updatedFields** | [**List&lt;FieldTypeWrapper&gt;**](FieldTypeWrapper.md) | A list of the fields updated through the request. |  [optional] |
