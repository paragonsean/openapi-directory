...
public class GetUploadedDocumentsResponse {
  ...
  private List<DocumentDetailWrapper> documentDetails = new ArrayList<>();
  ...
  public GetUploadedDocumentsResponse documentDetails(List<DocumentDetailWrapper> documentDetails) {
    this.documentDetails = documentDetails;
    return this;
  }

  public GetUploadedDocumentsResponse addDocumentDetailsItem(DocumentDetailWrapper documentDetailsItem) {
  ...
  public List<DocumentDetailWrapper> getDocumentDetails() {
    return documentDetails;
  }

  public void setDocumentDetails(List<DocumentDetailWrapper> documentDetails) {
    this.documentDetails = documentDetails;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(documentDetails, pspReference, resultCode, submittedAsync);
  }
      ...
      if (jsonObj.get("documentDetails") != null && !jsonObj.get("documentDetails").isJsonNull()) {
        ...
        if (jsonArraydocumentDetails != null) {
          ...
          for (int i = 0; i < jsonArraydocumentDetails.size(); i++) {
            DocumentDetailWrapper.validateJsonElement(jsonArraydocumentDetails.get(i));
          };
        }
      }
