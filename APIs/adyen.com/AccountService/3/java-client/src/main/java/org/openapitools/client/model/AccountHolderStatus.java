...
import org.openapitools.client.model.AccountEventWrapper;
...
public class AccountHolderStatus {
  ...
  private List<AccountEventWrapper> events = new ArrayList<>();
  ...
  public AccountHolderStatus events(List<AccountEventWrapper> events) {
    this.events = events;
    return this;
  }

  public AccountHolderStatus addEventsItem(AccountEventWrapper eventsItem) {
    if (this.events == null) {
  ...
  public List<AccountEventWrapper> getEvents() {
    return events;
  }

  public void setEvents(List<AccountEventWrapper> events) {
    this.events = events;
  }
      ...
      if (jsonObj.get("events") != null && !jsonObj.get("events").isJsonNull()) {
        ...
        if (jsonArrayevents != null) {
          ...
          for (int i = 0; i < jsonArrayevents.size(); i++) {
            AccountEventWrapper.validateJsonElement(jsonArrayevents.get(i));
          };
        }
      }
