...
public class GetAccountHolderResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountHolderCode, accountHolderDetails, accountHolderStatus, accounts, legalEntity, pspReference, resultCode, submittedAsync, verification);
  }
