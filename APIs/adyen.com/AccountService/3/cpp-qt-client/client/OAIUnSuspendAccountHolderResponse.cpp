...
bool OAIUnSuspendAccountHolderResponse::isSubmittedAsync() const {
    return m_submitted_async;
}
void OAIUnSuspendAccountHolderResponse::setSubmittedAsync(const bool &submitted_async) {
    m_submitted_async = submitted_async;
    m_submitted_async_isSet = true;
}

bool OAIUnSuspendAccountHolderResponse::is_submitted_async_Set() const{
    return m_submitted_async_isSet;
}

bool OAIUnSuspendAccountHolderResponse::is_submitted_async_Valid() const{
