...
/*
 * OAICloseAccountHolderResponse.h
 *
 * 
 */

#ifndef OAICloseAccountHolderResponse_H
#define OAICloseAccountHolderResponse_H
...
class OAICloseAccountHolderResponse : public OAIObject {
public:
    OAICloseAccountHolderResponse();
    OAICloseAccountHolderResponse(QString json);
    ~OAICloseAccountHolderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloseAccountHolderResponse)

#endif // OAICloseAccountHolderResponse_H
