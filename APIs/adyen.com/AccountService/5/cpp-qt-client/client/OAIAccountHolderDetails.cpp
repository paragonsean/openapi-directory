...
void OAIAccountHolderDetails::initializeModel() {
    ...
    m_bank_aggregator_data_reference_isSet = false;
    m_bank_aggregator_data_reference_isValid = false;
...
void OAIAccountHolderDetails::fromJsonObject(QJsonObject json) {
    ...
    m_bank_aggregator_data_reference_isValid = ::OpenAPI::fromJsonValue(m_bank_aggregator_data_reference, json[QString("bankAggregatorDataReference")]);
    m_bank_aggregator_data_reference_isSet = !json[QString("bankAggregatorDataReference")].isNull() && m_bank_aggregator_data_reference_isValid;
...
QJsonObject OAIAccountHolderDetails::asJsonObject() const {
    ...
    if (m_bank_aggregator_data_reference_isSet) {
        obj.insert(QString("bankAggregatorDataReference"), ::OpenAPI::toJsonValue(m_bank_aggregator_data_reference));
    }
...
QList<OAIBankAccountDetail> OAIAccountHolderDetails::getBankAccountDetails() const {
    return m_bank_account_details;
}
void OAIAccountHolderDetails::setBankAccountDetails(const QList<OAIBankAccountDetail> &bank_account_details) {
...
QString OAIAccountHolderDetails::getBankAggregatorDataReference() const {
    return m_bank_aggregator_data_reference;
}
void OAIAccountHolderDetails::setBankAggregatorDataReference(const QString &bank_aggregator_data_reference) {
    m_bank_aggregator_data_reference = bank_aggregator_data_reference;
    m_bank_aggregator_data_reference_isSet = true;
}

bool OAIAccountHolderDetails::is_bank_aggregator_data_reference_Set() const{
    return m_bank_aggregator_data_reference_isSet;
}

bool OAIAccountHolderDetails::is_bank_aggregator_data_reference_Valid() const{
    return m_bank_aggregator_data_reference_isValid;
}
...
QList<OAIPayoutMethod> OAIAccountHolderDetails::getPayoutMethods() const {
    return m_payout_methods;
}
void OAIAccountHolderDetails::setPayoutMethods(const QList<OAIPayoutMethod> &payout_methods) {
    m_payout_methods = payout_methods;
    m_payout_methods_isSet = true;
}

bool OAIAccountHolderDetails::is_payout_methods_Set() const{
    return m_payout_methods_isSet;
}

bool OAIAccountHolderDetails::is_payout_methods_Valid() const{
...
QList<OAIStoreDetail> OAIAccountHolderDetails::getStoreDetails() const {
    return m_store_details;
}
void OAIAccountHolderDetails::setStoreDetails(const QList<OAIStoreDetail> &store_details) {
    m_store_details = store_details;
    m_store_details_isSet = true;
}

bool OAIAccountHolderDetails::is_store_details_Set() const{
    return m_store_details_isSet;
}

bool OAIAccountHolderDetails::is_store_details_Valid() const{
