...
OAISuspendAccountHolderResponse::OAISuspendAccountHolderResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISuspendAccountHolderResponse::OAISuspendAccountHolderResponse() {
    this->initializeModel();
}

OAISuspendAccountHolderResponse::~OAISuspendAccountHolderResponse() {}

void OAISuspendAccountHolderResponse::initializeModel() {
...
void OAISuspendAccountHolderResponse::fromJson(QString jsonString) {
...
void OAISuspendAccountHolderResponse::fromJsonObject(QJsonObject json) {
...
QString OAISuspendAccountHolderResponse::asJson() const {
...
QJsonObject OAISuspendAccountHolderResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIAccountHolderStatus OAISuspendAccountHolderResponse::getAccountHolderStatus() const {
    return m_account_holder_status;
}
void OAISuspendAccountHolderResponse::setAccountHolderStatus(const OAIAccountHolderStatus &account_holder_status) {
    m_account_holder_status = account_holder_status;
    m_account_holder_status_isSet = true;
}

bool OAISuspendAccountHolderResponse::is_account_holder_status_Set() const{
    return m_account_holder_status_isSet;
}

bool OAISuspendAccountHolderResponse::is_account_holder_status_Valid() const{
    return m_account_holder_status_isValid;
}

QList<OAIErrorFieldType> OAISuspendAccountHolderResponse::getInvalidFields() const {
    return m_invalid_fields;
}
void OAISuspendAccountHolderResponse::setInvalidFields(const QList<OAIErrorFieldType> &invalid_fields) {
    m_invalid_fields = invalid_fields;
    m_invalid_fields_isSet = true;
}

bool OAISuspendAccountHolderResponse::is_invalid_fields_Set() const{
    return m_invalid_fields_isSet;
}

bool OAISuspendAccountHolderResponse::is_invalid_fields_Valid() const{
    return m_invalid_fields_isValid;
}

QString OAISuspendAccountHolderResponse::getPspReference() const {
    return m_psp_reference;
}
void OAISuspendAccountHolderResponse::setPspReference(const QString &psp_reference) {
    m_psp_reference = psp_reference;
    m_psp_reference_isSet = true;
}

bool OAISuspendAccountHolderResponse::is_psp_reference_Set() const{
    return m_psp_reference_isSet;
}

bool OAISuspendAccountHolderResponse::is_psp_reference_Valid() const{
    return m_psp_reference_isValid;
}

QString OAISuspendAccountHolderResponse::getResultCode() const {
    return m_result_code;
}
void OAISuspendAccountHolderResponse::setResultCode(const QString &result_code) {
    m_result_code = result_code;
    m_result_code_isSet = true;
}

bool OAISuspendAccountHolderResponse::is_result_code_Set() const{
    return m_result_code_isSet;
}

bool OAISuspendAccountHolderResponse::is_result_code_Valid() const{
    return m_result_code_isValid;
}

bool OAISuspendAccountHolderResponse::isSet() const {
...
bool OAISuspendAccountHolderResponse::isValid() const {
