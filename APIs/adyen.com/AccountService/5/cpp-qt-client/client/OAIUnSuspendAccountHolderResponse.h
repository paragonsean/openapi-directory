...
/*
 * OAIUnSuspendAccountHolderResponse.h
 *
 * 
 */

#ifndef OAIUnSuspendAccountHolderResponse_H
#define OAIUnSuspendAccountHolderResponse_H
...
class OAIUnSuspendAccountHolderResponse : public OAIObject {
public:
    OAIUnSuspendAccountHolderResponse();
    OAIUnSuspendAccountHolderResponse(QString json);
    ~OAIUnSuspendAccountHolderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnSuspendAccountHolderResponse)

#endif // OAIUnSuspendAccountHolderResponse_H
