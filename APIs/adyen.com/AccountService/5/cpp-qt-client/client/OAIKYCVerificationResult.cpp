...
QList<OAIKYCCardCheckResult> OAIKYCVerificationResult::getCards() const {
    return m_cards;
}
void OAIKYCVerificationResult::setCards(const QList<OAIKYCCardCheckResult> &cards) {
    m_cards = cards;
    m_cards_isSet = true;
}

bool OAIKYCVerificationResult::is_cards_Set() const{
    return m_cards_isSet;
}

bool OAIKYCVerificationResult::is_cards_Valid() const{
