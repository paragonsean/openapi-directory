...
void OAIGetAccountHolderResponse::initializeModel() {
    ...
    m_system_up_to_date_time_isSet = false;
    m_system_up_to_date_time_isValid = false;
...
void OAIGetAccountHolderResponse::fromJsonObject(QJsonObject json) {
    ...
    m_system_up_to_date_time_isValid = ::OpenAPI::fromJsonValue(m_system_up_to_date_time, json[QString("systemUpToDateTime")]);
    m_system_up_to_date_time_isSet = !json[QString("systemUpToDateTime")].isNull() && m_system_up_to_date_time_isValid;
...
QJsonObject OAIGetAccountHolderResponse::asJsonObject() const {
    ...
    if (m_system_up_to_date_time_isSet) {
        obj.insert(QString("systemUpToDateTime"), ::OpenAPI::toJsonValue(m_system_up_to_date_time));
    }
...
QList<OAIAccount> OAIGetAccountHolderResponse::getAccounts() const {
    return m_accounts;
}
void OAIGetAccountHolderResponse::setAccounts(const QList<OAIAccount> &accounts) {
    m_accounts = accounts;
...
QList<OAIErrorFieldType> OAIGetAccountHolderResponse::getInvalidFields() const {
    return m_invalid_fields;
}
void OAIGetAccountHolderResponse::setInvalidFields(const QList<OAIErrorFieldType> &invalid_fields) {
    m_invalid_fields = invalid_fields;
    m_invalid_fields_isSet = true;
}

bool OAIGetAccountHolderResponse::is_invalid_fields_Set() const{
    return m_invalid_fields_isSet;
}

bool OAIGetAccountHolderResponse::is_invalid_fields_Valid() const{
...
OAIMigrationData OAIGetAccountHolderResponse::getMigrationData() const {
    return m_migration_data;
}
void OAIGetAccountHolderResponse::setMigrationData(const OAIMigrationData &migration_data) {
    m_migration_data = migration_data;
    m_migration_data_isSet = true;
}

bool OAIGetAccountHolderResponse::is_migration_data_Set() const{
    return m_migration_data_isSet;
}

bool OAIGetAccountHolderResponse::is_migration_data_Valid() const{
...
QDateTime OAIGetAccountHolderResponse::getSystemUpToDateTime() const {
    return m_system_up_to_date_time;
}
void OAIGetAccountHolderResponse::setSystemUpToDateTime(const QDateTime &system_up_to_date_time) {
    m_system_up_to_date_time = system_up_to_date_time;
    m_system_up_to_date_time_isSet = true;
}

bool OAIGetAccountHolderResponse::is_system_up_to_date_time_Set() const{
    return m_system_up_to_date_time_isSet;
}

bool OAIGetAccountHolderResponse::is_system_up_to_date_time_Valid() const{
    return m_system_up_to_date_time_isValid;
}
