...
OAIUnSuspendAccountHolderResponse::OAIUnSuspendAccountHolderResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnSuspendAccountHolderResponse::OAIUnSuspendAccountHolderResponse() {
    this->initializeModel();
}

OAIUnSuspendAccountHolderResponse::~OAIUnSuspendAccountHolderResponse() {}

void OAIUnSuspendAccountHolderResponse::initializeModel() {
...
void OAIUnSuspendAccountHolderResponse::fromJson(QString jsonString) {
...
void OAIUnSuspendAccountHolderResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUnSuspendAccountHolderResponse::asJson() const {
...
QJsonObject OAIUnSuspendAccountHolderResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIAccountHolderStatus OAIUnSuspendAccountHolderResponse::getAccountHolderStatus() const {
    return m_account_holder_status;
}
void OAIUnSuspendAccountHolderResponse::setAccountHolderStatus(const OAIAccountHolderStatus &account_holder_status) {
    m_account_holder_status = account_holder_status;
    m_account_holder_status_isSet = true;
}

bool OAIUnSuspendAccountHolderResponse::is_account_holder_status_Set() const{
    return m_account_holder_status_isSet;
}

bool OAIUnSuspendAccountHolderResponse::is_account_holder_status_Valid() const{
    return m_account_holder_status_isValid;
}

QList<OAIErrorFieldType> OAIUnSuspendAccountHolderResponse::getInvalidFields() const {
    return m_invalid_fields;
}
void OAIUnSuspendAccountHolderResponse::setInvalidFields(const QList<OAIErrorFieldType> &invalid_fields) {
    m_invalid_fields = invalid_fields;
    m_invalid_fields_isSet = true;
}

bool OAIUnSuspendAccountHolderResponse::is_invalid_fields_Set() const{
    return m_invalid_fields_isSet;
}

bool OAIUnSuspendAccountHolderResponse::is_invalid_fields_Valid() const{
    return m_invalid_fields_isValid;
}

QString OAIUnSuspendAccountHolderResponse::getPspReference() const {
    return m_psp_reference;
}
void OAIUnSuspendAccountHolderResponse::setPspReference(const QString &psp_reference) {
    m_psp_reference = psp_reference;
    m_psp_reference_isSet = true;
}

bool OAIUnSuspendAccountHolderResponse::is_psp_reference_Set() const{
    return m_psp_reference_isSet;
}

bool OAIUnSuspendAccountHolderResponse::is_psp_reference_Valid() const{
    return m_psp_reference_isValid;
}

QString OAIUnSuspendAccountHolderResponse::getResultCode() const {
    return m_result_code;
}
void OAIUnSuspendAccountHolderResponse::setResultCode(const QString &result_code) {
    m_result_code = result_code;
    m_result_code_isSet = true;
}

bool OAIUnSuspendAccountHolderResponse::is_result_code_Set() const{
    return m_result_code_isSet;
}

bool OAIUnSuspendAccountHolderResponse::is_result_code_Valid() const{
    return m_result_code_isValid;
}

bool OAIUnSuspendAccountHolderResponse::isSet() const {
...
bool OAIUnSuspendAccountHolderResponse::isValid() const {
