...
/*
 * OAISuspendAccountHolderResponse.h
 *
 * 
 */

#ifndef OAISuspendAccountHolderResponse_H
#define OAISuspendAccountHolderResponse_H
...
class OAISuspendAccountHolderResponse : public OAIObject {
public:
    OAISuspendAccountHolderResponse();
    OAISuspendAccountHolderResponse(QString json);
    ~OAISuspendAccountHolderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuspendAccountHolderResponse)

#endif // OAISuspendAccountHolderResponse_H
