...
async def post_check_account_holder(request: web.Request, body=None) -> web.Response:
    ...
    """
    body = PerformVerificationRequest.from_dict(body)
...
async def post_delete_payout_methods(request: web.Request, body=None) -> web.Response:
    ...
    """
    body = DeletePayoutMethodRequest.from_dict(body)
    return web.Response(status=200)
