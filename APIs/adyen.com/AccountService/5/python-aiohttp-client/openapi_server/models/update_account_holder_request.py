...
class UpdateAccountHolderRequest(Model):
    ...
    def __init__(self, account_holder_code: str=None, account_holder_details: AccountHolderDetails=None, description: str=None, legal_entity: str=None, primary_currency: str=None, processing_tier: int=None):
