...
public class CreateAccountHolderRequest {
  ...
  public static final String SERIALIZED_NAME_CREATE_DEFAULT_ACCOUNT = "createDefaultAccount";
  @SerializedName(SERIALIZED_NAME_CREATE_DEFAULT_ACCOUNT)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountHolderCode, accountHolderDetails, createDefaultAccount, description, legalEntity, primaryCurrency, processingTier);
  }
  ...
  static {
    ...
    openapiFields.add("createDefaultAccount");
    ...
    openapiRequiredFields.add("accountHolderDetails");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAccountHolderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAccountHolderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAccountHolderRequest is not found in the empty JSON string", CreateAccountHolderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAccountHolderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAccountHolderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAccountHolderRequest.openapiRequiredFields) {
      ...
      // validate the required field `accountHolderDetails`
      ...
      if (!jsonObj.get("legalEntity").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAccountHolderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAccountHolderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAccountHolderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAccountHolderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAccountHolderRequest>() {
           @Override
           public void write(JsonWriter out, CreateAccountHolderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAccountHolderRequest read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to CreateAccountHolderRequest
   */
  public static CreateAccountHolderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAccountHolderRequest.class);
  }
