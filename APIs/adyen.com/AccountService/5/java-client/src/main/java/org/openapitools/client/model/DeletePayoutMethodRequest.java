...
public class DeletePayoutMethodRequest {
  ...
  public static final String SERIALIZED_NAME_PAYOUT_METHOD_CODES = "payoutMethodCodes";
  @SerializedName(SERIALIZED_NAME_PAYOUT_METHOD_CODES)
  ...
  public DeletePayoutMethodRequest addPayoutMethodCodesItem(String payoutMethodCodesItem) {
    if (this.payoutMethodCodes == null) {
      this.payoutMethodCodes = new ArrayList<>();
    }
  ...
  static {
    ...
    openapiFields.add("payoutMethodCodes");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("accountHolderCode");
    openapiRequiredFields.add("payoutMethodCodes");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePayoutMethodRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePayoutMethodRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePayoutMethodRequest is not found in the empty JSON string", DeletePayoutMethodRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePayoutMethodRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePayoutMethodRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeletePayoutMethodRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("payoutMethodCodes") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("payoutMethodCodes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `payoutMethodCodes` to be an array in the JSON string but got `%s`", jsonObj.get("payoutMethodCodes").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePayoutMethodRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePayoutMethodRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePayoutMethodRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePayoutMethodRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePayoutMethodRequest>() {
           @Override
           public void write(JsonWriter out, DeletePayoutMethodRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePayoutMethodRequest read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to DeletePayoutMethodRequest
   */
  public static DeletePayoutMethodRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePayoutMethodRequest.class);
  }
