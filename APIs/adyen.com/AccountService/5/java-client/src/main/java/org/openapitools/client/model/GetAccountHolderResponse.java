...
public class GetAccountHolderResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountHolderCode, accountHolderDetails, accountHolderStatus, accounts, description, invalidFields, legalEntity, migrationData, primaryCurrency, pspReference, resultCode, systemUpToDateTime, verification);
  }
