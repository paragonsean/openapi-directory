    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('cards')) {
                obj['cards'] = ApiClient.convertToType(data['cards'], [KYCCardCheckResult]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['cards']) { // data not null
            ...
            for (const item of data['cards']) {
                KYCCardCheckResult.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/KYCCardCheckResult>} cards
 */
KYCVerificationResult.prototype['cards'] = undefined;
