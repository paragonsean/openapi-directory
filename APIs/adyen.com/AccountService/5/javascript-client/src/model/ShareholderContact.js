...
class ShareholderContact {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('shareholderReference')) {
                obj['shareholderReference'] = ApiClient.convertToType(data['shareholderReference'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['shareholderReference'] && !(typeof data['shareholderReference'] === 'string' || data['shareholderReference'] instanceof String)) {
            throw new Error("Expected the field `shareholderReference` to be a primitive type in the JSON string but got " + data['shareholderReference']);
        }
        // ensure the json data is a string
 ...
 * @member {String} shareholderReference
 */
ShareholderContact.prototype['shareholderReference'] = undefined;
