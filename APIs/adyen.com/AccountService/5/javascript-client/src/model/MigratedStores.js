...
/**
 * The MigratedStores model module.
 * @module model/MigratedStores
 * @version 5
 */
class MigratedStores {
    /**
     * Constructs a new <code>MigratedStores</code>.
     * @alias module:model/MigratedStores
     */
    constructor() { 
        
        MigratedStores.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MigratedStores</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MigratedStores} obj Optional instance to populate.
     * @return {module:model/MigratedStores} The populated <code>MigratedStores</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MigratedStores();
    ...
    /**
     * Validates the JSON data with respect to <code>MigratedStores</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MigratedStores</code>.
     */
 ...
 */
MigratedStores.prototype['businessLineId'] = undefined;
 ...
 */
MigratedStores.prototype['storeCode'] = undefined;
 ...
 */
MigratedStores.prototype['storeId'] = undefined;
 ...
 */
MigratedStores.prototype['storeReference'] = undefined;
