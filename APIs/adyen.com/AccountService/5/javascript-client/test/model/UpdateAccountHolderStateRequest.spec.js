...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.UpdateAccountHolderStateRequest();
  });
  ...
  describe('UpdateAccountHolderStateRequest', function() {
    it('should create an instance of UpdateAccountHolderStateRequest', function() {
      // uncomment below and update the code to test UpdateAccountHolderStateRequest
      //var instance = new AccountApi.UpdateAccountHolderStateRequest();
      //expect(instance).to.be.a(AccountApi.UpdateAccountHolderStateRequest);
    });
