...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.CloseAccountHolderResponse();
  });
  ...
  describe('CloseAccountHolderResponse', function() {
    it('should create an instance of CloseAccountHolderResponse', function() {
      // uncomment below and update the code to test CloseAccountHolderResponse
      //var instance = new AccountApi.CloseAccountHolderResponse();
      //expect(instance).to.be.a(AccountApi.CloseAccountHolderResponse);
    });
