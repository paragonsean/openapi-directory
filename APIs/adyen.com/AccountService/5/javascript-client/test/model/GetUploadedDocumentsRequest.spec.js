...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.GetUploadedDocumentsRequest();
  });
  ...
  describe('GetUploadedDocumentsRequest', function() {
    it('should create an instance of GetUploadedDocumentsRequest', function() {
      // uncomment below and update the code to test GetUploadedDocumentsRequest
      //var instance = new AccountApi.GetUploadedDocumentsRequest();
      //expect(instance).to.be.a(AccountApi.GetUploadedDocumentsRequest);
    });
