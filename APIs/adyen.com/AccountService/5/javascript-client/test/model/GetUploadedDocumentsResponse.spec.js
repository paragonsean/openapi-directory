...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.GetUploadedDocumentsResponse();
  });
  ...
  describe('GetUploadedDocumentsResponse', function() {
    it('should create an instance of GetUploadedDocumentsResponse', function() {
      // uncomment below and update the code to test GetUploadedDocumentsResponse
      //var instance = new AccountApi.GetUploadedDocumentsResponse();
      //expect(instance).to.be.a(AccountApi.GetUploadedDocumentsResponse);
    });
