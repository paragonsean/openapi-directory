...
> GenericResponse postCheckAccountHolder(opts)
...
let opts = {
  'performVerificationRequest': new AccountApi.PerformVerificationRequest() // PerformVerificationRequest | 
};
apiInstance.postCheckAccountHolder(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GenericResponse postDeletePayoutMethods(opts)
...
let apiInstance = new AccountApi.VerificationApi();
let opts = {
  'deletePayoutMethodRequest': new AccountApi.DeletePayoutMethodRequest() // DeletePayoutMethodRequest | 
};
apiInstance.postDeletePayoutMethods(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
