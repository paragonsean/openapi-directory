...
class Example : public QObject {
    Q_OBJECT
    OAISubjectErasureByPspReferenceRequest create();
public Q_SLOTS:
...
OAISubjectErasureByPspReferenceRequest Example::create(){
    OAISubjectErasureByPspReferenceRequest obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIGeneralApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIGeneralApi::postRequestSubjectErasureSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIGeneralApi::postRequestSubjectErasureSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAISubjectErasureByPspReferenceRequest oai_subject_erasure_by_psp_reference_request = create(); // OAISubjectErasureByPspReferenceRequest | 
      apiInstance.postRequestSubjectErasure(oai_subject_erasure_by_psp_reference_request);
