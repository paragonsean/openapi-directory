# adyen_data_protection_api

AdyenDataProtectionApi - JavaScript client for adyen_data_protection_api
...
```shell
npm install adyen_data_protection_api --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your adyen_data_protection_api from, and run:
...
```javascript
var AdyenDataProtectionApi = require('adyen_data_protection_api');

var defaultClient = AdyenDataProtectionApi.ApiClient.instance;
...
var api = new AdyenDataProtectionApi.GeneralApi()
var opts = {
...
api.postRequestSubjectErasure(opts, callback);
...
------------ | ------------- | ------------- | -------------
*AdyenDataProtectionApi.GeneralApi* | [**postRequestSubjectErasure**](docs/GeneralApi.md#postRequestSubjectErasure) | **POST** /requestSubjectErasure | Submit a Subject Erasure Request.


## Documentation for Models

 - [AdyenDataProtectionApi.ServiceError](docs/ServiceError.md)
 - [AdyenDataProtectionApi.SubjectErasureByPspReferenceRequest](docs/SubjectErasureByPspReferenceRequest.md)
 - [AdyenDataProtectionApi.SubjectErasureResponse](docs/SubjectErasureResponse.md)
