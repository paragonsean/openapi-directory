...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenDataProtectionApi.GeneralApi();
  });
  ...
  describe('GeneralApi', function() {
    describe('postRequestSubjectErasure', function() {
      it('should call postRequestSubjectErasure successfully', function(done) {
        //uncomment below and update the code to test postRequestSubjectErasure
        //instance.postRequestSubjectErasure(function(error) {
