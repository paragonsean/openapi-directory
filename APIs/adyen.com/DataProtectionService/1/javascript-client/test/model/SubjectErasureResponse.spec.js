...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenDataProtectionApi.SubjectErasureResponse();
  });
  ...
  describe('SubjectErasureResponse', function() {
    it('should create an instance of SubjectErasureResponse', function() {
      // uncomment below and update the code to test SubjectErasureResponse
      //var instance = new AdyenDataProtectionApi.SubjectErasureResponse();
      //expect(instance).to.be.a(AdyenDataProtectionApi.SubjectErasureResponse);
    });
