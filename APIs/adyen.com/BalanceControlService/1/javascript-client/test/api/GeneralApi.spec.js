...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenBalanceControlApi.GeneralApi();
  });
  ...
  describe('GeneralApi', function() {
    describe('postBalanceTransfer', function() {
      it('should call postBalanceTransfer successfully', function(done) {
        //uncomment below and update the code to test postBalanceTransfer
        //instance.postBalanceTransfer(function(error) {
