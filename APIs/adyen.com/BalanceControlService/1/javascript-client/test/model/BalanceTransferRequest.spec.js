...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenBalanceControlApi.BalanceTransferRequest();
  });
  ...
  describe('BalanceTransferRequest', function() {
    it('should create an instance of BalanceTransferRequest', function() {
      // uncomment below and update the code to test BalanceTransferRequest
      //var instance = new AdyenBalanceControlApi.BalanceTransferRequest();
      //expect(instance).to.be.a(AdyenBalanceControlApi.BalanceTransferRequest);
    });
