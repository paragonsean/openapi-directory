...
/**
 * The BalanceTransferResponse model module.
 * @module model/BalanceTransferResponse
 * @version 1
 */
class BalanceTransferResponse {
    /**
     * Constructs a new <code>BalanceTransferResponse</code>.
     * @alias module:model/BalanceTransferResponse
     ...
     * @param createdAt {Date} The date when the balance transfer was requested.
     * @param fromMerchant {String} The unique identifier of the source merchant account from which funds are deducted.
     * @param pspReference {String} Adyen's 16-character string reference associated with the balance transfer.
     * @param status {module:model/BalanceTransferResponse.StatusEnum} The status of the balance transfer. Possible values: **transferred**, **failed**, **error**, and **notEnoughBalance**.
     * @param toMerchant {String} The unique identifier of the destination merchant account from which funds are transferred.
     * @param type {module:model/BalanceTransferResponse.TypeEnum} The type of balance transfer. Possible values: **tax**, **fee**, **terminalSale**, **credit**, **debit**, and **adjustment**.
     */
    constructor(amount, createdAt, fromMerchant, pspReference, status, toMerchant, type) { 
        
        BalanceTransferResponse.initialize(this, amount, createdAt, fromMerchant, pspReference, status, toMerchant, type);
    }
     ...
     */
    static initialize(obj, amount, createdAt, fromMerchant, pspReference, status, toMerchant, type) { 
        obj['amount'] = amount;
    ...
    /**
     * Constructs a <code>BalanceTransferResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BalanceTransferResponse} obj Optional instance to populate.
     * @return {module:model/BalanceTransferResponse} The populated <code>BalanceTransferResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BalanceTransferResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BalanceTransferResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BalanceTransferResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BalanceTransferResponse.RequiredProperties) {
...
BalanceTransferResponse.RequiredProperties = ["amount", "createdAt", "fromMerchant", "pspReference", "status", "toMerchant", "type"];
 ...
 */
BalanceTransferResponse.prototype['reference'] = undefined;

/**
 * The status of the balance transfer. Possible values: **transferred**, **failed**, **error**, and **notEnoughBalance**.
 * @member {module:model/BalanceTransferResponse.StatusEnum} status
 */
BalanceTransferResponse.prototype['status'] = undefined;

/**
 * The unique identifier of the destination merchant account from which funds are transferred.
 * @member {String} toMerchant
 */
BalanceTransferResponse.prototype['toMerchant'] = undefined;

/**
 * The type of balance transfer. Possible values: **tax**, **fee**, **terminalSale**, **credit**, **debit**, and **adjustment**.
 * @member {module:model/BalanceTransferResponse.TypeEnum} type
 */
BalanceTransferResponse.prototype['type'] = undefined;
...
export default BalanceTransferResponse;
