...
/*
 * OAIBalanceTransferResponse.h
 *
 * 
 */

#ifndef OAIBalanceTransferResponse_H
#define OAIBalanceTransferResponse_H
...
class OAIBalanceTransferResponse : public OAIObject {
public:
    OAIBalanceTransferResponse();
    OAIBalanceTransferResponse(QString json);
    ~OAIBalanceTransferResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBalanceTransferResponse)

#endif // OAIBalanceTransferResponse_H
