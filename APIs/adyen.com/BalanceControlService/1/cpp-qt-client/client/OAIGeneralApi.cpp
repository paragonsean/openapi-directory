...
void OAIGeneralApi::initializeServerConfigs() {
    ...
    QUrl("https://pal-test.adyen.com/pal/servlet/BalanceControl/v1"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("postBalanceTransfer", defaultConf);
    _serverIndices.insert("postBalanceTransfer", 0);
}
...
void OAIGeneralApi::postBalanceTransfer(const ::OpenAPI::OptionalParam<OAIBalanceTransferRequest> &oai_balance_transfer_request) {
    QString fullPath = QString(_serverConfigs["postBalanceTransfer"][_serverIndices.value("postBalanceTransfer")].URL()+"/balanceTransfer");
    ...
    if (oai_balance_transfer_request.hasValue()){

        
        QByteArray output = oai_balance_transfer_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGeneralApi::postBalanceTransferCallback);
...
void OAIGeneralApi::postBalanceTransferCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIBalanceTransferResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT postBalanceTransferSignal(output);
        Q_EMIT postBalanceTransferSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT postBalanceTransferSignalE(output, error_type, error_str);
        Q_EMIT postBalanceTransferSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT postBalanceTransferSignalError(output, error_type, error_str);
        Q_EMIT postBalanceTransferSignalErrorFull(worker, error_type, error_str);
    }
}
