...
class Example : public QObject {
    Q_OBJECT
    OAIBalanceTransferRequest create();
public Q_SLOTS:
...
OAIBalanceTransferRequest Example::create(){
    OAIBalanceTransferRequest obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIGeneralApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIGeneralApi::postBalanceTransferSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIGeneralApi::postBalanceTransferSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIBalanceTransferRequest oai_balance_transfer_request = create(); // OAIBalanceTransferRequest | 
      apiInstance.postBalanceTransfer(oai_balance_transfer_request);
