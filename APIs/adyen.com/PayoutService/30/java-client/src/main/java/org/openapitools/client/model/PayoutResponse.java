...
import org.openapitools.client.model.PayoutResponseAdditionalData;
...
public class PayoutResponse {
  ...
  private PayoutResponseAdditionalData additionalData;
  ...
  public PayoutResponse additionalData(PayoutResponseAdditionalData additionalData) {
  ...
  public PayoutResponseAdditionalData getAdditionalData() {
    return additionalData;
  }

  public void setAdditionalData(PayoutResponseAdditionalData additionalData) {
    this.additionalData = additionalData;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PayoutResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PayoutResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PayoutResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PayoutResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("additionalData") != null && !jsonObj.get("additionalData").isJsonNull()) {
        PayoutResponseAdditionalData.validateJsonElement(jsonObj.get("additionalData"));
      }
