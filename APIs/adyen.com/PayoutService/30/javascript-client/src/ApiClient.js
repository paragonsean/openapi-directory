...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://pal-test.adyen.com/pal/servlet/Payout/v30') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://pal-test.adyen.com/pal/servlet/Payout/v30
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/30/Javascript'
        };
