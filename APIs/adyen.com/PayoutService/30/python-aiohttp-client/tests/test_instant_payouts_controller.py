...
async def test_post_payout(client):
    ...
    response = await client.request(
        method='POST',
        path='/pal/servlet/Payout/v30/payout',
        headers=headers,
        json=body,
        )
