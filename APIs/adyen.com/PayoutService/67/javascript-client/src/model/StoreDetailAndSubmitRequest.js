...
class StoreDetailAndSubmitRequest {
     ...
     * @param entityType {module:model/StoreDetailAndSubmitRequest.EntityTypeEnum} The type of the entity the payout is processed for.
     ...
     * @param reference {String} The merchant reference for this payment. This reference will be used in all communication to the merchant about the status of the payout. Although it is a good idea to make sure it is unique, this is not a requirement.
     ...
     */
    constructor(amount, dateOfBirth, entityType, merchantAccount, nationality, recurring, reference, shopperEmail, shopperReference) { 
        
        StoreDetailAndSubmitRequest.initialize(this, amount, dateOfBirth, entityType, merchantAccount, nationality, recurring, reference, shopperEmail, shopperReference);
    }
     ...
     */
    static initialize(obj, amount, dateOfBirth, entityType, merchantAccount, nationality, recurring, reference, shopperEmail, shopperReference) { 
        obj['amount'] = amount;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoreDetailAndSubmitRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StoreDetailAndSubmitRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoreDetailAndSubmitRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StoreDetailAndSubmitRequest.RequiredProperties) {
...
StoreDetailAndSubmitRequest.RequiredProperties = ["amount", "dateOfBirth", "entityType", "merchantAccount", "nationality", "recurring", "reference", "shopperEmail", "shopperReference"];

/**
 * This field contains additional data, which may be required for a particular request.
 * @member {Object.<String, String>} additionalData
 */
StoreDetailAndSubmitRequest.prototype['additionalData'] = undefined;

/**
 * A container object for the payable amount information of the transaction.
 * @member {module:model/Amount} amount
 */
StoreDetailAndSubmitRequest.prototype['amount'] = undefined;

/**
 * A container for bank account data. > This field is mandatory if `card` is not provided.
 * @member {module:model/BankAccount} bank
 */
StoreDetailAndSubmitRequest.prototype['bank'] = undefined;
 ...
 */
StoreDetailAndSubmitRequest.prototype['billingAddress'] = undefined;

/**
 * A container for card data. > This field is mandatory if `bank` is not provided.
 * @member {module:model/Card} card
 */
StoreDetailAndSubmitRequest.prototype['card'] = undefined;
 ...
 */
StoreDetailAndSubmitRequest.prototype['dateOfBirth'] = undefined;

/**
 * The type of the entity the payout is processed for.
 * @member {module:model/StoreDetailAndSubmitRequest.EntityTypeEnum} entityType
 */
StoreDetailAndSubmitRequest.prototype['entityType'] = undefined;

/**
 * An integer value that is added to the normal fraud score. The value can be either positive or negative.
 * @member {Number} fraudOffset
 */
StoreDetailAndSubmitRequest.prototype['fraudOffset'] = undefined;

/**
 * The merchant account identifier, with which you want to process the transaction.
 * @member {String} merchantAccount
 */
StoreDetailAndSubmitRequest.prototype['merchantAccount'] = undefined;

/**
 * The shopper's nationality.  A valid value is an ISO 2-character country code (e.g. 'NL').
 * @member {String} nationality
 */
StoreDetailAndSubmitRequest.prototype['nationality'] = undefined;
 ...
 */
StoreDetailAndSubmitRequest.prototype['recurring'] = undefined;
 ...
 */
StoreDetailAndSubmitRequest.prototype['reference'] = undefined;

/**
 * The name of the brand to make a payout to.  For Paysafecard it must be set to `paysafecard`.
 * @member {String} selectedBrand
 */
StoreDetailAndSubmitRequest.prototype['selectedBrand'] = undefined;

/**
 * The shopper's email address.
 * @member {String} shopperEmail
 */
StoreDetailAndSubmitRequest.prototype['shopperEmail'] = undefined;
 ...
 */
StoreDetailAndSubmitRequest.prototype['shopperName'] = undefined;

/**
 * The shopper's reference for the payment transaction.
 * @member {String} shopperReference
 */
StoreDetailAndSubmitRequest.prototype['shopperReference'] = undefined;

/**
 * The description of this payout. This description is shown on the bank statement of the shopper (if this is supported by the chosen payment method).
 * @member {String} shopperStatement
 */
StoreDetailAndSubmitRequest.prototype['shopperStatement'] = undefined;

/**
 * The shopper's social security number.
 * @member {String} socialSecurityNumber
 */
StoreDetailAndSubmitRequest.prototype['socialSecurityNumber'] = undefined;

/**
 * The shopper's phone number.
 * @member {String} telephoneNumber
 */
StoreDetailAndSubmitRequest.prototype['telephoneNumber'] = undefined;
...
export default StoreDetailAndSubmitRequest;
