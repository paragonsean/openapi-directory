...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.Recurring();
  });
  ...
  describe('Recurring', function() {
    it('should create an instance of Recurring', function() {
      // uncomment below and update the code to test Recurring
      //var instance = new AdyenPayoutApi.Recurring();
      //expect(instance).to.be.a(AdyenPayoutApi.Recurring);
    });
    ...
    it('should have the property recurringDetailName (base name: "recurringDetailName")', function() {
      // uncomment below and update the code to test the property recurringDetailName
      //var instance = new AdyenPayoutApi.Recurring();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tokenService (base name: "tokenService")', function() {
      // uncomment below and update the code to test the property tokenService
      //var instance = new AdyenPayoutApi.Recurring();
      //expect(instance).to.be();
    });
