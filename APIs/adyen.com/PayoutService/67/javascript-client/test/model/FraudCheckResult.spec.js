...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.FraudCheckResult();
  });
  ...
  describe('FraudCheckResult', function() {
    it('should create an instance of FraudCheckResult', function() {
      // uncomment below and update the code to test FraudCheckResult
      //var instance = new AdyenPayoutApi.FraudCheckResult();
      //expect(instance).to.be.a(AdyenPayoutApi.FraudCheckResult);
    });
