...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.ModifyRequest();
  });
  ...
  describe('ModifyRequest', function() {
    it('should create an instance of ModifyRequest', function() {
      // uncomment below and update the code to test ModifyRequest
      //var instance = new AdyenPayoutApi.ModifyRequest();
      //expect(instance).to.be.a(AdyenPayoutApi.ModifyRequest);
    });
