...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.ResponseAdditionalDataDomesticError();
  });
  ...
  describe('ResponseAdditionalDataDomesticError', function() {
    it('should create an instance of ResponseAdditionalDataDomesticError', function() {
      // uncomment below and update the code to test ResponseAdditionalDataDomesticError
      //var instance = new AdyenPayoutApi.ResponseAdditionalDataDomesticError();
      //expect(instance).to.be.a(AdyenPayoutApi.ResponseAdditionalDataDomesticError);
    });
