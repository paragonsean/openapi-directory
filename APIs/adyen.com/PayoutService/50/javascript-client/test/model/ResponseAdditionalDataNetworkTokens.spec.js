...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.ResponseAdditionalDataNetworkTokens();
  });
  ...
  describe('ResponseAdditionalDataNetworkTokens', function() {
    it('should create an instance of ResponseAdditionalDataNetworkTokens', function() {
      // uncomment below and update the code to test ResponseAdditionalDataNetworkTokens
      //var instance = new AdyenPayoutApi.ResponseAdditionalDataNetworkTokens();
      //expect(instance).to.be.a(AdyenPayoutApi.ResponseAdditionalDataNetworkTokens);
    });
