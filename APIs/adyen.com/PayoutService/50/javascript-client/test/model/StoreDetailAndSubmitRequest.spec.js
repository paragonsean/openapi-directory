...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.StoreDetailAndSubmitRequest();
  });
  ...
  describe('StoreDetailAndSubmitRequest', function() {
    it('should create an instance of StoreDetailAndSubmitRequest', function() {
      ...
      //var instance = new AdyenPayoutApi.StoreDetailAndSubmitRequest();
      //expect(instance).to.be.a(AdyenPayoutApi.StoreDetailAndSubmitRequest);
    });
