...
/*
 * OAIStoreDetailAndSubmitResponse.h
 *
 * 
 */

#ifndef OAIStoreDetailAndSubmitResponse_H
#define OAIStoreDetailAndSubmitResponse_H
...
class OAIStoreDetailAndSubmitResponse : public OAIObject {
public:
    OAIStoreDetailAndSubmitResponse();
    OAIStoreDetailAndSubmitResponse(QString json);
    ~OAIStoreDetailAndSubmitResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoreDetailAndSubmitResponse)

#endif // OAIStoreDetailAndSubmitResponse_H
