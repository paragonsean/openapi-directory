...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.SubmitResponse();
  });
  ...
  describe('SubmitResponse', function() {
    it('should create an instance of SubmitResponse', function() {
      // uncomment below and update the code to test SubmitResponse
      //var instance = new AdyenPayoutApi.SubmitResponse();
      //expect(instance).to.be.a(AdyenPayoutApi.SubmitResponse);
    });
