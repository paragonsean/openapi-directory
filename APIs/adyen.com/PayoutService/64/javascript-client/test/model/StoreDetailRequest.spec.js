...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.StoreDetailRequest();
  });
  ...
  describe('StoreDetailRequest', function() {
    it('should create an instance of StoreDetailRequest', function() {
      // uncomment below and update the code to test StoreDetailRequest
      //var instance = new AdyenPayoutApi.StoreDetailRequest();
      //expect(instance).to.be.a(AdyenPayoutApi.StoreDetailRequest);
    });
