...
OAISubmitResponse::OAISubmitResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISubmitResponse::OAISubmitResponse() {
    this->initializeModel();
}

OAISubmitResponse::~OAISubmitResponse() {}

void OAISubmitResponse::initializeModel() {
...
void OAISubmitResponse::fromJson(QString jsonString) {
...
void OAISubmitResponse::fromJsonObject(QJsonObject json) {
...
QString OAISubmitResponse::asJson() const {
...
QJsonObject OAISubmitResponse::asJsonObject() const {
    QJsonObject obj;
...
QMap<QString, QString> OAISubmitResponse::getAdditionalData() const {
    return m_additional_data;
}
void OAISubmitResponse::setAdditionalData(const QMap<QString, QString> &additional_data) {
    m_additional_data = additional_data;
    m_additional_data_isSet = true;
}

bool OAISubmitResponse::is_additional_data_Set() const{
    return m_additional_data_isSet;
}

bool OAISubmitResponse::is_additional_data_Valid() const{
    return m_additional_data_isValid;
}

QString OAISubmitResponse::getPspReference() const {
    return m_psp_reference;
}
void OAISubmitResponse::setPspReference(const QString &psp_reference) {
    m_psp_reference = psp_reference;
    m_psp_reference_isSet = true;
}

bool OAISubmitResponse::is_psp_reference_Set() const{
    return m_psp_reference_isSet;
}

bool OAISubmitResponse::is_psp_reference_Valid() const{
    return m_psp_reference_isValid;
}

QString OAISubmitResponse::getRefusalReason() const {
    return m_refusal_reason;
}
void OAISubmitResponse::setRefusalReason(const QString &refusal_reason) {
    m_refusal_reason = refusal_reason;
    m_refusal_reason_isSet = true;
}

bool OAISubmitResponse::is_refusal_reason_Set() const{
    return m_refusal_reason_isSet;
}

bool OAISubmitResponse::is_refusal_reason_Valid() const{
    return m_refusal_reason_isValid;
}

QString OAISubmitResponse::getResultCode() const {
    return m_result_code;
}
void OAISubmitResponse::setResultCode(const QString &result_code) {
    m_result_code = result_code;
    m_result_code_isSet = true;
}

bool OAISubmitResponse::is_result_code_Set() const{
    return m_result_code_isSet;
}

bool OAISubmitResponse::is_result_code_Valid() const{
    return m_result_code_isValid;
}

bool OAISubmitResponse::isSet() const {
...
bool OAISubmitResponse::isValid() const {
