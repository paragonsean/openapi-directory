...
/**
 * The StoreDetailAndSubmitResponse model module.
 * @module model/StoreDetailAndSubmitResponse
 * @version 51
 */
class StoreDetailAndSubmitResponse {
    /**
     * Constructs a new <code>StoreDetailAndSubmitResponse</code>.
     * @alias module:model/StoreDetailAndSubmitResponse
     * @param pspReference {String} A new reference to uniquely identify this request.
     * @param resultCode {String} The response:  * In case of success is payout-submit-received. * In case of an error, an informational message is returned.
     */
    constructor(pspReference, resultCode) { 
        
        StoreDetailAndSubmitResponse.initialize(this, pspReference, resultCode);
    }
    ...
    /**
     * Constructs a <code>StoreDetailAndSubmitResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoreDetailAndSubmitResponse} obj Optional instance to populate.
     * @return {module:model/StoreDetailAndSubmitResponse} The populated <code>StoreDetailAndSubmitResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoreDetailAndSubmitResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StoreDetailAndSubmitResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoreDetailAndSubmitResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StoreDetailAndSubmitResponse.RequiredProperties) {
...
StoreDetailAndSubmitResponse.RequiredProperties = ["pspReference", "resultCode"];

/**
 * This field contains additional data, which may be returned in a particular response.
 * @member {Object.<String, String>} additionalData
 */
StoreDetailAndSubmitResponse.prototype['additionalData'] = undefined;

/**
 * A new reference to uniquely identify this request.
 * @member {String} pspReference
 */
StoreDetailAndSubmitResponse.prototype['pspReference'] = undefined;

/**
 * In case of refusal, an informational message for the reason.
 * @member {String} refusalReason
 */
StoreDetailAndSubmitResponse.prototype['refusalReason'] = undefined;
 ...
 */
StoreDetailAndSubmitResponse.prototype['resultCode'] = undefined;
...
export default StoreDetailAndSubmitResponse;
