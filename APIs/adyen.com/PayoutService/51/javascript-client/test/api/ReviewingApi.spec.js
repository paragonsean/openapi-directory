...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.ReviewingApi();
  });
  ...
  describe('ReviewingApi', function() {
    describe('postConfirmThirdParty', function() {
      it('should call postConfirmThirdParty successfully', function(done) {
        //uncomment below and update the code to test postConfirmThirdParty
        //instance.postConfirmThirdParty(function(error) {
    ...
    describe('postDeclineThirdParty', function() {
      it('should call postDeclineThirdParty successfully', function(done) {
        //uncomment below and update the code to test postDeclineThirdParty
        //instance.postDeclineThirdParty(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
