...
#include <iostream>
#include "../client/OAIInitializationApi.h"

using namespace test_namespace;

class Example : public QObject {
    Q_OBJECT
    OAIStoreDetailRequest create();
public Q_SLOTS:
...
OAIStoreDetailRequest Example::create(){
    OAIStoreDetailRequest obj;
 return obj;
}

void Example::exampleFunction1(){
     OAIInitializationApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIInitializationApi::postStoreDetailSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIInitializationApi::postStoreDetailSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIStoreDetailRequest oai_store_detail_request = create(); // OAIStoreDetailRequest | 
      apiInstance.postStoreDetail(oai_store_detail_request);
