...
/*
 * OAIStoreDetailAndSubmitRequest.h
 *
 * 
 */

#ifndef OAIStoreDetailAndSubmitRequest_H
#define OAIStoreDetailAndSubmitRequest_H
...
class OAIStoreDetailAndSubmitRequest : public OAIObject {
public:
    OAIStoreDetailAndSubmitRequest();
    OAIStoreDetailAndSubmitRequest(QString json);
    ~OAIStoreDetailAndSubmitRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoreDetailAndSubmitRequest)

#endif // OAIStoreDetailAndSubmitRequest_H
