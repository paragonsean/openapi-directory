...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.FraudCheckResultWrapper();
  });
  ...
  describe('FraudCheckResultWrapper', function() {
    it('should create an instance of FraudCheckResultWrapper', function() {
      // uncomment below and update the code to test FraudCheckResultWrapper
      //var instance = new AdyenPayoutApi.FraudCheckResultWrapper();
      //expect(instance).to.be.a(AdyenPayoutApi.FraudCheckResultWrapper);
    });
