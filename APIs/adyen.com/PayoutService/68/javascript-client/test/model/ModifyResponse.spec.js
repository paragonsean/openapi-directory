...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.ModifyResponse();
  });
  ...
  describe('ModifyResponse', function() {
    it('should create an instance of ModifyResponse', function() {
      // uncomment below and update the code to test ModifyResponse
      //var instance = new AdyenPayoutApi.ModifyResponse();
      //expect(instance).to.be.a(AdyenPayoutApi.ModifyResponse);
    });
