...
#ifndef OAISubmitResponse_H
#define OAISubmitResponse_H
...
class OAISubmitResponse : public OAIObject {
public:
    OAISubmitResponse();
    OAISubmitResponse(QString json);
    ~OAISubmitResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubmitResponse)

#endif // OAISubmitResponse_H
