...
class StoreDetailAndSubmitRequest(Model):
    ...
    def __init__(self, additional_data: Dict[str, str]=None, amount: Amount=None, bank: BankAccount=None, billing_address: Address=None, card: Card=None, date_of_birth: date=None, entity_type: str=None, fraud_offset: int=None, merchant_account: str=None, nationality: str=None, recurring: Recurring=None, reference: str=None, selected_brand: str=None, shopper_email: str=None, shopper_name: Name=None, shopper_reference: str=None, shopper_statement: str=None, social_security_number: str=None, telephone_number: str=None):
        ...
        :param telephone_number: The telephone_number of this StoreDetailAndSubmitRequest.
        """
        self.openapi_types = {
    ...
    def telephone_number(self):
        """Gets the telephone_number of this StoreDetailAndSubmitRequest.

        The shopper's phone number.

        :return: The telephone_number of this StoreDetailAndSubmitRequest.
        :rtype: str
        """
    ...
    def telephone_number(self, telephone_number):
        """Sets the telephone_number of this StoreDetailAndSubmitRequest.
