...
#ifndef OAIPayoutRequest_H
#define OAIPayoutRequest_H
...
class OAIPayoutRequest : public OAIObject {
public:
    OAIPayoutRequest();
    OAIPayoutRequest(QString json);
    ~OAIPayoutRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayoutRequest)

#endif // OAIPayoutRequest_H
