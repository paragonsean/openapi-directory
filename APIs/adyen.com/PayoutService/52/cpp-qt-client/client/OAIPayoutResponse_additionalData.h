...
/*
 * OAIPayoutResponse_additionalData.h
 *
 * Contains additional information about the payment. Some data fields are included only if you select them first: Go to **Customer Area** &gt; **Developers** &gt; **Additional data**.
 */

#ifndef OAIPayoutResponse_additionalData_H
#define OAIPayoutResponse_additionalData_H
...
class OAIPayoutResponse_additionalData : public OAIObject {
public:
    OAIPayoutResponse_additionalData();
    OAIPayoutResponse_additionalData(QString json);
    ~OAIPayoutResponse_additionalData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayoutResponse_additionalData)

#endif // OAIPayoutResponse_additionalData_H
