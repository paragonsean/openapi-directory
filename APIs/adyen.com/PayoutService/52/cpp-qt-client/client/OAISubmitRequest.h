...
#ifndef OAISubmitRequest_H
#define OAISubmitRequest_H
...
class OAISubmitRequest : public OAIObject {
public:
    OAISubmitRequest();
    OAISubmitRequest(QString json);
    ~OAISubmitRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubmitRequest)

#endif // OAISubmitRequest_H
