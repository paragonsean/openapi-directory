...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.InitializationApi();
  });
  ...
  describe('InitializationApi', function() {
    describe('postStoreDetail', function() {
      it('should call postStoreDetail successfully', function(done) {
        //uncomment below and update the code to test postStoreDetail
        //instance.postStoreDetail(function(error) {
    ...
    describe('postStoreDetailAndSubmitThirdParty', function() {
      it('should call postStoreDetailAndSubmitThirdParty successfully', function(done) {
        //uncomment below and update the code to test postStoreDetailAndSubmitThirdParty
        //instance.postStoreDetailAndSubmitThirdParty(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postSubmitThirdParty', function() {
      it('should call postSubmitThirdParty successfully', function(done) {
        //uncomment below and update the code to test postSubmitThirdParty
        //instance.postSubmitThirdParty(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
