...
public class Recurring {
  ...
  public enum TokenServiceEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      TokenServiceEnum.fromValue(value);
    }
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Recurring
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Recurring.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Recurring.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Recurring` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("contract") != null && !jsonObj.get("contract").isJsonNull()) {
        ContractEnum.validateJsonElement(jsonObj.get("contract"));
      }
      if ((jsonObj.get("recurringDetailName") != null && !jsonObj.get("recurringDetailName").isJsonNull()) && !jsonObj.get("recurringDetailName").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("tokenService") != null && !jsonObj.get("tokenService").isJsonNull()) && !jsonObj.get("tokenService").isJsonPrimitive()) {
      ...
      // validate the optional field `tokenService`
      if (jsonObj.get("tokenService") != null && !jsonObj.get("tokenService").isJsonNull()) {
        TokenServiceEnum.validateJsonElement(jsonObj.get("tokenService"));
      }
  }
