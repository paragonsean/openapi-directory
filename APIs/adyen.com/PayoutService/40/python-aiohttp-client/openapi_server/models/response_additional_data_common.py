...
class ResponseAdditionalDataCommon(Model):
    ...
    def __init__(self, acquirer_account_code: str=None, acquirer_code: str=None, acquirer_reference: str=None, alias: str=None, alias_type: str=None, auth_code: str=None, authorisation_mid: str=None, authorised_amount_currency: str=None, authorised_amount_value: str=None, avs_result: str=None, avs_result_raw: str=None, bic: str=None, co_branded_with: str=None, cvc_result: str=None, cvc_result_raw: str=None, ds_trans_id: str=None, eci: str=None, expiry_date: str=None, extra_costs_currency: str=None, extra_costs_value: str=None, fraud_check__item_nr__fraud_checkname: str=None, fraud_manual_review: str=None, fraud_result_type: str=None, funding_source: str=None, funds_availability: str=None, inferred_refusal_reason: str=None, is_card_commercial: str=None, issuer_country: str=None, liability_shift: str=None, mc_bank_net_reference_number: str=None, merchant_advice_code: str=None, merchant_reference: str=None, network_tx_reference: str=None, non_scheme_transaction_limit: str=None, non_scheme_transaction_limit_ccy: str=None, owner_name: str=None, payment_account_reference: str=None, payment_method: str=None, payment_method_variant: str=None, payout_eligible: str=None, realtime_account_updater_status: str=None, receipt_free_text: str=None, recurring_contract_types: str=None, recurring_first_psp_reference: str=None, recurring_recurring_detail_reference: str=None, recurring_shopper_reference: str=None, recurring_processing_model: str=None, referred: str=None, refusal_reason_raw: str=None, request_amount: str=None, request_currency_code: str=None, shopper_interaction: str=None, shopper_reference: str=None, terminal_id: str=None, three_d_authenticated: str=None, three_d_authenticated_response: str=None, three_d_offered: str=None, three_d_offered_response: str=None, three_ds_version: str=None, visa_transaction_id: str=None, xid: str=None):
        ...
        :param recurring_contract_types: The recurring_contract_types of this ResponseAdditionalDataCommon.
        ...
        :param recurring_shopper_reference: The recurring_shopper_reference of this ResponseAdditionalDataCommon.
        :param recurring_processing_model: The recurring_processing_model of this ResponseAdditionalDataCommon.
        ...
        self._recurring_contract_types = recurring_contract_types
        ...
        self._recurring_shopper_reference = recurring_shopper_reference
    ...
    @property
    def recurring_contract_types(self):
        """Gets the recurring_contract_types of this ResponseAdditionalDataCommon.

        The recurring contract types applicable to the transaction.

        :return: The recurring_contract_types of this ResponseAdditionalDataCommon.
        :rtype: str
        """
        return self._recurring_contract_types

    @recurring_contract_types.setter
    def recurring_contract_types(self, recurring_contract_types):
        """Sets the recurring_contract_types of this ResponseAdditionalDataCommon.

        The recurring contract types applicable to the transaction.

        :param recurring_contract_types: The recurring_contract_types of this ResponseAdditionalDataCommon.
        :type recurring_contract_types: str
        """
    ...
    @property
    def recurring_shopper_reference(self):
        """Gets the recurring_shopper_reference of this ResponseAdditionalDataCommon.

        The provided reference of the shopper for a recurring transaction.

        :return: The recurring_shopper_reference of this ResponseAdditionalDataCommon.
        :rtype: str
        """
        return self._recurring_shopper_reference

    @recurring_shopper_reference.setter
    def recurring_shopper_reference(self, recurring_shopper_reference):
        """Sets the recurring_shopper_reference of this ResponseAdditionalDataCommon.

        The provided reference of the shopper for a recurring transaction.

        :param recurring_shopper_reference: The recurring_shopper_reference of this ResponseAdditionalDataCommon.
        :type recurring_shopper_reference: str
        """
    ...
    def recurring_processing_model(self):
        """Gets the recurring_processing_model of this ResponseAdditionalDataCommon.

        The processing model used for the recurring transaction.

        :return: The recurring_processing_model of this ResponseAdditionalDataCommon.
        :rtype: str
        """
    ...
    def recurring_processing_model(self, recurring_processing_model):
        """Sets the recurring_processing_model of this ResponseAdditionalDataCommon.
