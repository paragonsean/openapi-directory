...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.StoreDetailResponse();
  });
  ...
  describe('StoreDetailResponse', function() {
    it('should create an instance of StoreDetailResponse', function() {
      // uncomment below and update the code to test StoreDetailResponse
      //var instance = new AdyenPayoutApi.StoreDetailResponse();
      //expect(instance).to.be.a(AdyenPayoutApi.StoreDetailResponse);
    });
