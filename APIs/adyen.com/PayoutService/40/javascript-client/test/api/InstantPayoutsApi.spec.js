...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenPayoutApi.InstantPayoutsApi();
  });
  ...
  describe('InstantPayoutsApi', function() {
    describe('postPayout', function() {
      it('should call postPayout successfully', function(done) {
        //uncomment below and update the code to test postPayout
        //instance.postPayout(function(error) {
