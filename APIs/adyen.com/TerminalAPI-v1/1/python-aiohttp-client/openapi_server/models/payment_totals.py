...
class PaymentTotals(Model):
    ...
    def __init__(self, transaction_amount: float=None, transaction_count: int=None, transaction_type: TransactionType=None):
        """PaymentTotals - a model defined in OpenAPI

        :param transaction_amount: The transaction_amount of this PaymentTotals.
        :param transaction_count: The transaction_count of this PaymentTotals.
        :param transaction_type: The transaction_type of this PaymentTotals.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PaymentTotals':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PaymentTotals of this PaymentTotals.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def transaction_amount(self):
        """Gets the transaction_amount of this PaymentTotals.

        Sum of amount of processed transaction during the period.

        :return: The transaction_amount of this PaymentTotals.
        :rtype: float
        """
    ...
    def transaction_amount(self, transaction_amount):
        """Sets the transaction_amount of this PaymentTotals.
    ...
    def transaction_count(self):
        """Gets the transaction_count of this PaymentTotals.

        Number of processed transaction during the period.

        :return: The transaction_count of this PaymentTotals.
        :rtype: int
        """
    ...
    def transaction_count(self, transaction_count):
        """Sets the transaction_count of this PaymentTotals.
    ...
    def transaction_type(self):
        """Gets the transaction_type of this PaymentTotals.


        :return: The transaction_type of this PaymentTotals.
    ...
    def transaction_type(self, transaction_type):
        """Sets the transaction_type of this PaymentTotals.
