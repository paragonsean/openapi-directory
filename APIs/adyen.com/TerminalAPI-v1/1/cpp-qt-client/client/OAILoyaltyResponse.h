...
#ifndef OAILoyaltyResponse_H
#define OAILoyaltyResponse_H
...
class OAILoyaltyResponse : public OAIObject {
public:
    OAILoyaltyResponse();
    OAILoyaltyResponse(QString json);
    ~OAILoyaltyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoyaltyResponse)

#endif // OAILoyaltyResponse_H
