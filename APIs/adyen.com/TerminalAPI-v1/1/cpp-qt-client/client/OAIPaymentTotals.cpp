...
OAIPaymentTotals::OAIPaymentTotals(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentTotals::OAIPaymentTotals() {
    this->initializeModel();
}

OAIPaymentTotals::~OAIPaymentTotals() {}

void OAIPaymentTotals::initializeModel() {
...
void OAIPaymentTotals::fromJson(QString jsonString) {
...
void OAIPaymentTotals::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentTotals::asJson() const {
...
QJsonObject OAIPaymentTotals::asJsonObject() const {
    QJsonObject obj;
...
double OAIPaymentTotals::getTransactionAmount() const {
    return m_transaction_amount;
}
void OAIPaymentTotals::setTransactionAmount(const double &transaction_amount) {
    m_transaction_amount = transaction_amount;
    m_transaction_amount_isSet = true;
}

bool OAIPaymentTotals::is_transaction_amount_Set() const{
    return m_transaction_amount_isSet;
}

bool OAIPaymentTotals::is_transaction_amount_Valid() const{
    return m_transaction_amount_isValid;
}

qint32 OAIPaymentTotals::getTransactionCount() const {
    return m_transaction_count;
}
void OAIPaymentTotals::setTransactionCount(const qint32 &transaction_count) {
    m_transaction_count = transaction_count;
    m_transaction_count_isSet = true;
}

bool OAIPaymentTotals::is_transaction_count_Set() const{
    return m_transaction_count_isSet;
}

bool OAIPaymentTotals::is_transaction_count_Valid() const{
    return m_transaction_count_isValid;
}

OAITransactionType OAIPaymentTotals::getTransactionType() const {
    return m_transaction_type;
}
void OAIPaymentTotals::setTransactionType(const OAITransactionType &transaction_type) {
    m_transaction_type = transaction_type;
    m_transaction_type_isSet = true;
}

bool OAIPaymentTotals::is_transaction_type_Set() const{
    return m_transaction_type_isSet;
}

bool OAIPaymentTotals::is_transaction_type_Valid() const{
    return m_transaction_type_isValid;
}

bool OAIPaymentTotals::isSet() const {
...
bool OAIPaymentTotals::isValid() const {
