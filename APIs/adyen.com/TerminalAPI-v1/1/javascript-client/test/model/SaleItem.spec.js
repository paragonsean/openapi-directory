...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenTerminalApi.SaleItem();
  });
  ...
  describe('SaleItem', function() {
    it('should create an instance of SaleItem', function() {
      // uncomment below and update the code to test SaleItem
      //var instance = new AdyenTerminalApi.SaleItem();
      //expect(instance).to.be.a(AdyenTerminalApi.SaleItem);
    });
