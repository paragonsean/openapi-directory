...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenTerminalApi.LoyaltyTotals();
  });
  ...
  describe('LoyaltyTotals', function() {
    it('should create an instance of LoyaltyTotals', function() {
      // uncomment below and update the code to test LoyaltyTotals
      //var instance = new AdyenTerminalApi.LoyaltyTotals();
      //expect(instance).to.be.a(AdyenTerminalApi.LoyaltyTotals);
    });
