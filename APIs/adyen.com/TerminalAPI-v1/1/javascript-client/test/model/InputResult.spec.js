...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenTerminalApi.InputResult();
  });
  ...
  describe('InputResult', function() {
    it('should create an instance of InputResult', function() {
      // uncomment below and update the code to test InputResult
      //var instance = new AdyenTerminalApi.InputResult();
      //expect(instance).to.be.a(AdyenTerminalApi.InputResult);
    });
