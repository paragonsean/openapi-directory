...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenTerminalApi.POISoftware();
  });
  ...
  describe('POISoftware', function() {
    it('should create an instance of POISoftware', function() {
      // uncomment below and update the code to test POISoftware
      //var instance = new AdyenTerminalApi.POISoftware();
      //expect(instance).to.be.a(AdyenTerminalApi.POISoftware);
    });
