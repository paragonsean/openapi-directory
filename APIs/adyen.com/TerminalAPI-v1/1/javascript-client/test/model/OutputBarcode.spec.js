...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenTerminalApi.OutputBarcode();
  });
  ...
  describe('OutputBarcode', function() {
    it('should create an instance of OutputBarcode', function() {
      // uncomment below and update the code to test OutputBarcode
      //var instance = new AdyenTerminalApi.OutputBarcode();
      //expect(instance).to.be.a(AdyenTerminalApi.OutputBarcode);
    });
