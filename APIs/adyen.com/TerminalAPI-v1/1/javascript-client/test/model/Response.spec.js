...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenTerminalApi.Response();
  });
  ...
  describe('Response', function() {
    it('should create an instance of Response', function() {
      ...
      //var instance = new AdyenTerminalApi.Response();
      //expect(instance).to.be.a(AdyenTerminalApi.Response);
    });
    ...
    it('should have the property errorCondition (base name: "ErrorCondition")', function() {
      // uncomment below and update the code to test the property errorCondition
      //var instance = new AdyenTerminalApi.Response();
      //expect(instance).to.be();
    });
