...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenTerminalApi.SensitiveCardData();
  });
  ...
  describe('SensitiveCardData', function() {
    it('should create an instance of SensitiveCardData', function() {
      // uncomment below and update the code to test SensitiveCardData
      //var instance = new AdyenTerminalApi.SensitiveCardData();
      //expect(instance).to.be.a(AdyenTerminalApi.SensitiveCardData);
    });

    it('should have the property cardSeqNumb (base name: "CardSeqNumb")', function() {
      // uncomment below and update the code to test the property cardSeqNumb
      //var instance = new AdyenTerminalApi.SensitiveCardData();
