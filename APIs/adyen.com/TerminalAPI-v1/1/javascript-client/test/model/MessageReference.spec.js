...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenTerminalApi.MessageReference();
  });
  ...
  describe('MessageReference', function() {
    it('should create an instance of MessageReference', function() {
      // uncomment below and update the code to test MessageReference
      //var instance = new AdyenTerminalApi.MessageReference();
      //expect(instance).to.be.a(AdyenTerminalApi.MessageReference);
    });
