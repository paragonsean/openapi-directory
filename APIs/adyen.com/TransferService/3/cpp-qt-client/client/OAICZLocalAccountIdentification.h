...
/*
 * OAICZLocalAccountIdentification.h
 *
 * 
 */

#ifndef OAICZLocalAccountIdentification_H
#define OAICZLocalAccountIdentification_H
...
class OAICZLocalAccountIdentification : public OAIObject {
public:
    OAICZLocalAccountIdentification();
    OAICZLocalAccountIdentification(QString json);
    ~OAICZLocalAccountIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICZLocalAccountIdentification)

#endif // OAICZLocalAccountIdentification_H
