...
#ifndef OAIBankAccountV3_H
#define OAIBankAccountV3_H

#include <QJsonObject>

#include "OAIBankAccountV3_accountIdentification.h"
#include "OAIPartyIdentification.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPartyIdentification;
class OAIBankAccountV3_accountIdentification;

class OAIBankAccountV3 : public OAIObject {
public:
    OAIBankAccountV3();
    OAIBankAccountV3(QString json);
    ~OAIBankAccountV3() override;
    ...
    OAIPartyIdentification getAccountHolder() const;
    void setAccountHolder(const OAIPartyIdentification &account_holder);
    bool is_account_holder_Set() const;
    bool is_account_holder_Valid() const;

    OAIBankAccountV3_accountIdentification getAccountIdentification() const;
    void setAccountIdentification(const OAIBankAccountV3_accountIdentification &account_identification);
...
private:
    ...
    OAIPartyIdentification m_account_holder;
    bool m_account_holder_isSet;
    bool m_account_holder_isValid;

    OAIBankAccountV3_accountIdentification m_account_identification;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankAccountV3)

#endif // OAIBankAccountV3_H
