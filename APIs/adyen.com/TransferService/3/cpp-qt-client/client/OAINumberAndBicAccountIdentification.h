...
/*
 * OAINumberAndBicAccountIdentification.h
 *
 * 
 */

#ifndef OAINumberAndBicAccountIdentification_H
#define OAINumberAndBicAccountIdentification_H
...
class OAINumberAndBicAccountIdentification : public OAIObject {
public:
    OAINumberAndBicAccountIdentification();
    OAINumberAndBicAccountIdentification(QString json);
    ~OAINumberAndBicAccountIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINumberAndBicAccountIdentification)

#endif // OAINumberAndBicAccountIdentification_H
