...
public:
    ...
    Q_DECL_DEPRECATED QString getBalanceAccountId() const;
    Q_DECL_DEPRECATED void setBalanceAccountId(const QString &balance_account_id);
    Q_DECL_DEPRECATED bool is_balance_account_id_Set() const;
    Q_DECL_DEPRECATED bool is_balance_account_id_Valid() const;
    ...
    Q_DECL_DEPRECATED QString getPaymentInstrumentId() const;
    Q_DECL_DEPRECATED void setPaymentInstrumentId(const QString &payment_instrument_id);
    Q_DECL_DEPRECATED bool is_payment_instrument_id_Set() const;
    Q_DECL_DEPRECATED bool is_payment_instrument_id_Valid() const;
