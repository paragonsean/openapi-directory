...
OAIBRLocalAccountIdentification::OAIBRLocalAccountIdentification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBRLocalAccountIdentification::OAIBRLocalAccountIdentification() {
    this->initializeModel();
}

OAIBRLocalAccountIdentification::~OAIBRLocalAccountIdentification() {}

void OAIBRLocalAccountIdentification::initializeModel() {
...
void OAIBRLocalAccountIdentification::fromJson(QString jsonString) {
...
void OAIBRLocalAccountIdentification::fromJsonObject(QJsonObject json) {
...
QString OAIBRLocalAccountIdentification::asJson() const {
...
QJsonObject OAIBRLocalAccountIdentification::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBRLocalAccountIdentification::getAccountNumber() const {
    return m_account_number;
}
void OAIBRLocalAccountIdentification::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIBRLocalAccountIdentification::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIBRLocalAccountIdentification::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QString OAIBRLocalAccountIdentification::getBankCode() const {
    return m_bank_code;
}
void OAIBRLocalAccountIdentification::setBankCode(const QString &bank_code) {
    m_bank_code = bank_code;
    m_bank_code_isSet = true;
}

bool OAIBRLocalAccountIdentification::is_bank_code_Set() const{
    return m_bank_code_isSet;
}

bool OAIBRLocalAccountIdentification::is_bank_code_Valid() const{
    return m_bank_code_isValid;
}

QString OAIBRLocalAccountIdentification::getBranchNumber() const {
    return m_branch_number;
}
void OAIBRLocalAccountIdentification::setBranchNumber(const QString &branch_number) {
    m_branch_number = branch_number;
    m_branch_number_isSet = true;
}

bool OAIBRLocalAccountIdentification::is_branch_number_Set() const{
    return m_branch_number_isSet;
}

bool OAIBRLocalAccountIdentification::is_branch_number_Valid() const{
    return m_branch_number_isValid;
}

QString OAIBRLocalAccountIdentification::getType() const {
    return m_type;
}
void OAIBRLocalAccountIdentification::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIBRLocalAccountIdentification::is_type_Set() const{
    return m_type_isSet;
}

bool OAIBRLocalAccountIdentification::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIBRLocalAccountIdentification::isSet() const {
...
bool OAIBRLocalAccountIdentification::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_account_number_isValid && m_bank_code_isValid && m_branch_number_isValid && m_type_isValid && true;
}
