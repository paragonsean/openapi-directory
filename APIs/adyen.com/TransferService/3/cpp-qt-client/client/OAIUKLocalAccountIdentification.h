...
/*
 * OAIUKLocalAccountIdentification.h
 *
 * 
 */

#ifndef OAIUKLocalAccountIdentification_H
#define OAIUKLocalAccountIdentification_H
...
class OAIUKLocalAccountIdentification : public OAIObject {
public:
    OAIUKLocalAccountIdentification();
    OAIUKLocalAccountIdentification(QString json);
    ~OAIUKLocalAccountIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUKLocalAccountIdentification)

#endif // OAIUKLocalAccountIdentification_H
