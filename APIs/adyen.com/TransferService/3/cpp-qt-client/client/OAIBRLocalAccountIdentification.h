...
/*
 * OAIBRLocalAccountIdentification.h
 *
 * 
 */

#ifndef OAIBRLocalAccountIdentification_H
#define OAIBRLocalAccountIdentification_H
...
class OAIBRLocalAccountIdentification : public OAIObject {
public:
    OAIBRLocalAccountIdentification();
    OAIBRLocalAccountIdentification(QString json);
    ~OAIBRLocalAccountIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBRLocalAccountIdentification)

#endif // OAIBRLocalAccountIdentification_H
