...
#ifndef OAICounterpartyV3_H
#define OAICounterpartyV3_H
...
class OAICounterpartyV3 : public OAIObject {
public:
    OAICounterpartyV3();
    OAICounterpartyV3(QString json);
    ~OAICounterpartyV3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICounterpartyV3)

#endif // OAICounterpartyV3_H
