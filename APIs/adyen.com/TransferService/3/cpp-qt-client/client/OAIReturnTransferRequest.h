...
/*
 * OAIReturnTransferRequest.h
 *
 * 
 */

#ifndef OAIReturnTransferRequest_H
#define OAIReturnTransferRequest_H
...
class OAIReturnTransferRequest : public OAIObject {
public:
    OAIReturnTransferRequest();
    OAIReturnTransferRequest(QString json);
    ~OAIReturnTransferRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturnTransferRequest)

#endif // OAIReturnTransferRequest_H
