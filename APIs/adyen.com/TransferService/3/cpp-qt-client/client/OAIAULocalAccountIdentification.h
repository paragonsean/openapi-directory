...
/*
 * OAIAULocalAccountIdentification.h
 *
 * 
 */

#ifndef OAIAULocalAccountIdentification_H
#define OAIAULocalAccountIdentification_H
...
class OAIAULocalAccountIdentification : public OAIObject {
public:
    OAIAULocalAccountIdentification();
    OAIAULocalAccountIdentification(QString json);
    ~OAIAULocalAccountIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAULocalAccountIdentification)

#endif // OAIAULocalAccountIdentification_H
