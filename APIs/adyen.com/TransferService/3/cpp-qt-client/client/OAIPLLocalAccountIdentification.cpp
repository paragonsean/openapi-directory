...
OAIPLLocalAccountIdentification::OAIPLLocalAccountIdentification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPLLocalAccountIdentification::OAIPLLocalAccountIdentification() {
    this->initializeModel();
}

OAIPLLocalAccountIdentification::~OAIPLLocalAccountIdentification() {}

void OAIPLLocalAccountIdentification::initializeModel() {
...
void OAIPLLocalAccountIdentification::fromJson(QString jsonString) {
...
void OAIPLLocalAccountIdentification::fromJsonObject(QJsonObject json) {
...
QString OAIPLLocalAccountIdentification::asJson() const {
...
QJsonObject OAIPLLocalAccountIdentification::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPLLocalAccountIdentification::getAccountNumber() const {
    return m_account_number;
}
void OAIPLLocalAccountIdentification::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIPLLocalAccountIdentification::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIPLLocalAccountIdentification::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QString OAIPLLocalAccountIdentification::getType() const {
    return m_type;
}
void OAIPLLocalAccountIdentification::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPLLocalAccountIdentification::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPLLocalAccountIdentification::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIPLLocalAccountIdentification::isSet() const {
...
bool OAIPLLocalAccountIdentification::isValid() const {
