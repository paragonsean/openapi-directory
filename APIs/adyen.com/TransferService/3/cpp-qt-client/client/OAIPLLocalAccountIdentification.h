...
/*
 * OAIPLLocalAccountIdentification.h
 *
 * 
 */

#ifndef OAIPLLocalAccountIdentification_H
#define OAIPLLocalAccountIdentification_H
...
class OAIPLLocalAccountIdentification : public OAIObject {
public:
    OAIPLLocalAccountIdentification();
    OAIPLLocalAccountIdentification(QString json);
    ~OAIPLLocalAccountIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPLLocalAccountIdentification)

#endif // OAIPLLocalAccountIdentification_H
