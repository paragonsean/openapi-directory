...
OAINOLocalAccountIdentification::OAINOLocalAccountIdentification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINOLocalAccountIdentification::OAINOLocalAccountIdentification() {
    this->initializeModel();
}

OAINOLocalAccountIdentification::~OAINOLocalAccountIdentification() {}

void OAINOLocalAccountIdentification::initializeModel() {
...
void OAINOLocalAccountIdentification::fromJson(QString jsonString) {
...
void OAINOLocalAccountIdentification::fromJsonObject(QJsonObject json) {
...
QString OAINOLocalAccountIdentification::asJson() const {
...
QJsonObject OAINOLocalAccountIdentification::asJsonObject() const {
    QJsonObject obj;
...
QString OAINOLocalAccountIdentification::getAccountNumber() const {
    return m_account_number;
}
void OAINOLocalAccountIdentification::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAINOLocalAccountIdentification::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAINOLocalAccountIdentification::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QString OAINOLocalAccountIdentification::getType() const {
    return m_type;
}
void OAINOLocalAccountIdentification::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAINOLocalAccountIdentification::is_type_Set() const{
    return m_type_isSet;
}

bool OAINOLocalAccountIdentification::is_type_Valid() const{
    return m_type_isValid;
}

bool OAINOLocalAccountIdentification::isSet() const {
...
bool OAINOLocalAccountIdentification::isValid() const {
