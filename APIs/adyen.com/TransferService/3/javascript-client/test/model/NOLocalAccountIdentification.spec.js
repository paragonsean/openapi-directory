...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.NOLocalAccountIdentification();
  });
  ...
  describe('NOLocalAccountIdentification', function() {
    it('should create an instance of NOLocalAccountIdentification', function() {
      // uncomment below and update the code to test NOLocalAccountIdentification
      //var instance = new TransfersApi.NOLocalAccountIdentification();
      //expect(instance).to.be.a(TransfersApi.NOLocalAccountIdentification);
    });
