...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.AULocalAccountIdentification();
  });
  ...
  describe('AULocalAccountIdentification', function() {
    it('should create an instance of AULocalAccountIdentification', function() {
      // uncomment below and update the code to test AULocalAccountIdentification
      //var instance = new TransfersApi.AULocalAccountIdentification();
      //expect(instance).to.be.a(TransfersApi.AULocalAccountIdentification);
    });
