...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.CounterpartyInfoV3();
  });
  ...
  describe('CounterpartyInfoV3', function() {
    it('should create an instance of CounterpartyInfoV3', function() {
      // uncomment below and update the code to test CounterpartyInfoV3
      //var instance = new TransfersApi.CounterpartyInfoV3();
      //expect(instance).to.be.a(TransfersApi.CounterpartyInfoV3);
    });
