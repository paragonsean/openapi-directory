...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.DKLocalAccountIdentification();
  });
  ...
  describe('DKLocalAccountIdentification', function() {
    it('should create an instance of DKLocalAccountIdentification', function() {
      // uncomment below and update the code to test DKLocalAccountIdentification
      //var instance = new TransfersApi.DKLocalAccountIdentification();
      //expect(instance).to.be.a(TransfersApi.DKLocalAccountIdentification);
    });
