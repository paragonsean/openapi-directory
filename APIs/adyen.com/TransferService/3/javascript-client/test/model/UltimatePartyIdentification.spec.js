...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.UltimatePartyIdentification();
  });
  ...
  describe('UltimatePartyIdentification', function() {
    it('should create an instance of UltimatePartyIdentification', function() {
      // uncomment below and update the code to test UltimatePartyIdentification
      //var instance = new TransfersApi.UltimatePartyIdentification();
      //expect(instance).to.be.a(TransfersApi.UltimatePartyIdentification);
    });
