...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.AdditionalBankIdentification();
  });
  ...
  describe('AdditionalBankIdentification', function() {
    it('should create an instance of AdditionalBankIdentification', function() {
      // uncomment below and update the code to test AdditionalBankIdentification
      //var instance = new TransfersApi.AdditionalBankIdentification();
      //expect(instance).to.be.a(TransfersApi.AdditionalBankIdentification);
    });
