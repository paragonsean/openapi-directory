...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.CounterpartyV3();
  });
  ...
  describe('CounterpartyV3', function() {
    it('should create an instance of CounterpartyV3', function() {
      // uncomment below and update the code to test CounterpartyV3
      //var instance = new TransfersApi.CounterpartyV3();
      //expect(instance).to.be.a(TransfersApi.CounterpartyV3);
    });
