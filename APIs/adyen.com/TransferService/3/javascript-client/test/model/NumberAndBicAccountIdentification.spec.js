...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.NumberAndBicAccountIdentification();
  });
  ...
  describe('NumberAndBicAccountIdentification', function() {
    it('should create an instance of NumberAndBicAccountIdentification', function() {
      // uncomment below and update the code to test NumberAndBicAccountIdentification
      //var instance = new TransfersApi.NumberAndBicAccountIdentification();
      //expect(instance).to.be.a(TransfersApi.NumberAndBicAccountIdentification);
    });
