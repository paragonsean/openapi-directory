...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.UKLocalAccountIdentification();
  });
  ...
  describe('UKLocalAccountIdentification', function() {
    it('should create an instance of UKLocalAccountIdentification', function() {
      // uncomment below and update the code to test UKLocalAccountIdentification
      //var instance = new TransfersApi.UKLocalAccountIdentification();
      //expect(instance).to.be.a(TransfersApi.UKLocalAccountIdentification);
    });
