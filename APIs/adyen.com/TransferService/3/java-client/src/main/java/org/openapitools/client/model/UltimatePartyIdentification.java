...
public class UltimatePartyIdentification {
   ...
   * @throws IOException if the JSON Element is invalid with respect to UltimatePartyIdentification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UltimatePartyIdentification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UltimatePartyIdentification is not found in the empty JSON string", UltimatePartyIdentification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UltimatePartyIdentification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UltimatePartyIdentification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UltimatePartyIdentification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UltimatePartyIdentification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UltimatePartyIdentification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UltimatePartyIdentification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UltimatePartyIdentification.class));

       return (TypeAdapter<T>) new TypeAdapter<UltimatePartyIdentification>() {
           @Override
   ...
   * @throws IOException if the JSON string is invalid with respect to UltimatePartyIdentification
   */
  public static UltimatePartyIdentification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UltimatePartyIdentification.class);
  }
