...
import org.openapitools.client.model.BRLocalAccountIdentification;
...
public class BankAccountV3AccountIdentification extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<BankAccountV3AccountIdentification>() {
                ...
                public void write(JsonWriter out, BankAccountV3AccountIdentification value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof BRLocalAccountIdentification) {
                        JsonElement element = adapterBRLocalAccountIdentification.toJsonTree((BRLocalAccountIdentification)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: AULocalAccountIdentification, BRLocalAccountIdentification, CALocalAccountIdentification, CZLocalAccountIdentification, DKLocalAccountIdentification, HKLocalAccountIdentification, HULocalAccountIdentification, IbanAccountIdentification, NOLocalAccountIdentification, NZLocalAccountIdentification, NumberAndBicAccountIdentification, PLLocalAccountIdentification, SELocalAccountIdentification, SGLocalAccountIdentification, UKLocalAccountIdentification, USLocalAccountIdentification");
                }
                ...
                public BankAccountV3AccountIdentification read(JsonReader in) throws IOException {
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        BRLocalAccountIdentification.validateJsonElement(jsonElement);
                    ...
                    throw new IOException(String.format("Failed deserialization for BankAccountV3AccountIdentification: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BankAccountV3AccountIdentification(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("BRLocalAccountIdentification", BRLocalAccountIdentification.class);
     ...
     * @throws IOException if the JSON Element is invalid with respect to BankAccountV3AccountIdentification
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for BankAccountV3AccountIdentification with oneOf schemas: AULocalAccountIdentification, BRLocalAccountIdentification, CALocalAccountIdentification, CZLocalAccountIdentification, DKLocalAccountIdentification, HKLocalAccountIdentification, HULocalAccountIdentification, IbanAccountIdentification, NOLocalAccountIdentification, NZLocalAccountIdentification, NumberAndBicAccountIdentification, PLLocalAccountIdentification, SELocalAccountIdentification, SGLocalAccountIdentification, UKLocalAccountIdentification, USLocalAccountIdentification. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
