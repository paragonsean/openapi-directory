...
# **postTransfers**
> TransferOld postTransfers(wwWAuthenticate, transferInfoOld)
...
public class Example {
  public static void main(String[] args) {
    ...
    TransferInfoOld transferInfoOld = new TransferInfoOld(); // TransferInfoOld | 
    try {
      TransferOld result = apiInstance.postTransfers(wwWAuthenticate, transferInfoOld);
