...
public class TransfersApi {
     ...
     * @param transferInfoOld  (optional)
     ...
     */
    public okhttp3.Call postTransfersCall(String wwWAuthenticate, TransferInfoOld transferInfoOld, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = transferInfoOld;
    ...
    private okhttp3.Call postTransfersValidateBeforeCall(String wwWAuthenticate, TransferInfoOld transferInfoOld, final ApiCallback _callback) throws ApiException {
        return postTransfersCall(wwWAuthenticate, transferInfoOld, _callback);
     ...
     */
    public TransferOld postTransfers(String wwWAuthenticate, TransferInfoOld transferInfoOld) throws ApiException {
        ApiResponse<TransferOld> localVarResp = postTransfersWithHttpInfo(wwWAuthenticate, transferInfoOld);
     ...
     * @param wwWAuthenticate Header for authenticating through SCA (optional)
     * @param transferInfoOld  (optional)
     * @return ApiResponse&lt;TransferOld&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TransferOld> postTransfersWithHttpInfo(String wwWAuthenticate, TransferInfoOld transferInfoOld) throws ApiException {
        okhttp3.Call localVarCall = postTransfersValidateBeforeCall(wwWAuthenticate, transferInfoOld, null);
        Type localVarReturnType = new TypeToken<TransferOld>(){}.getType();
     ...
     */
    public okhttp3.Call postTransfersAsync(String wwWAuthenticate, TransferInfoOld transferInfoOld, final ApiCallback<TransferOld> _callback) throws ApiException {

        okhttp3.Call localVarCall = postTransfersValidateBeforeCall(wwWAuthenticate, transferInfoOld, _callback);
        Type localVarReturnType = new TypeToken<TransferOld>(){}.getType();
