...
/*
 * OAIPartyIdentification.h
 *
 * 
 */

#ifndef OAIPartyIdentification_H
#define OAIPartyIdentification_H
...
class OAIPartyIdentification : public OAIObject {
public:
    OAIPartyIdentification();
    OAIPartyIdentification(QString json);
    ~OAIPartyIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartyIdentification)

#endif // OAIPartyIdentification_H
