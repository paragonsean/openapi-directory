...
/*
 * OAIInternalPartyIdentification.h
 *
 * 
 */

#ifndef OAIInternalPartyIdentification_H
#define OAIInternalPartyIdentification_H
...
class OAIInternalPartyIdentification : public OAIObject {
public:
    OAIInternalPartyIdentification();
    OAIInternalPartyIdentification(QString json);
    ~OAIInternalPartyIdentification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInternalPartyIdentification)

#endif // OAIInternalPartyIdentification_H
