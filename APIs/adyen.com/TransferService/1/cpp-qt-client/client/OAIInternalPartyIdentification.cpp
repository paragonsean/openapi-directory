...
#include "OAIInternalPartyIdentification.h"
...
OAIInternalPartyIdentification::OAIInternalPartyIdentification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInternalPartyIdentification::OAIInternalPartyIdentification() {
    this->initializeModel();
}

OAIInternalPartyIdentification::~OAIInternalPartyIdentification() {}

void OAIInternalPartyIdentification::initializeModel() {
...
void OAIInternalPartyIdentification::fromJson(QString jsonString) {
...
void OAIInternalPartyIdentification::fromJsonObject(QJsonObject json) {
...
QString OAIInternalPartyIdentification::asJson() const {
...
QJsonObject OAIInternalPartyIdentification::asJsonObject() const {
    QJsonObject obj;
...
QString OAIInternalPartyIdentification::getBalanceAccountId() const {
    return m_balance_account_id;
}
void OAIInternalPartyIdentification::setBalanceAccountId(const QString &balance_account_id) {
    m_balance_account_id = balance_account_id;
    m_balance_account_id_isSet = true;
}

bool OAIInternalPartyIdentification::is_balance_account_id_Set() const{
    return m_balance_account_id_isSet;
}

bool OAIInternalPartyIdentification::is_balance_account_id_Valid() const{
    return m_balance_account_id_isValid;
}

QString OAIInternalPartyIdentification::getPaymentInstrumentId() const {
    return m_payment_instrument_id;
}
void OAIInternalPartyIdentification::setPaymentInstrumentId(const QString &payment_instrument_id) {
    m_payment_instrument_id = payment_instrument_id;
    m_payment_instrument_id_isSet = true;
}

bool OAIInternalPartyIdentification::is_payment_instrument_id_Set() const{
    return m_payment_instrument_id_isSet;
}

bool OAIInternalPartyIdentification::is_payment_instrument_id_Valid() const{
    return m_payment_instrument_id_isValid;
}

bool OAIInternalPartyIdentification::isSet() const {
...
bool OAIInternalPartyIdentification::isValid() const {
