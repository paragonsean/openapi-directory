...
#ifndef OAITransferOld_H
#define OAITransferOld_H
...
class OAITransferOld : public OAIObject {
public:
    OAITransferOld();
    OAITransferOld(QString json);
    ~OAITransferOld() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferOld)

#endif // OAITransferOld_H
