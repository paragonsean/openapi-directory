...
void OAITransfersApi::postTransfers(const ::OpenAPI::OptionalParam<QString> &www_authenticate, const ::OpenAPI::OptionalParam<OAITransferInfoOld> &oai_transfer_info_old) {
    ...
    if (oai_transfer_info_old.hasValue()){

        
        QByteArray output = oai_transfer_info_old.value().asJson().toUtf8();
...
void OAITransfersApi::postTransfersCallback(OAIHttpRequestWorker *worker) {
    ...
    OAITransferOld output(QString(worker->response));
    worker->deleteLater();
