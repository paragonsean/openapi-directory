...
/*
 * OAITransferInfoOld.h
 *
 * 
 */

#ifndef OAITransferInfoOld_H
#define OAITransferInfoOld_H
...
class OAIInternalPartyIdentification;

class OAITransferInfoOld : public OAIObject {
public:
    OAITransferInfoOld();
    OAITransferInfoOld(QString json);
    ~OAITransferInfoOld() override;
    ...
    OAIPartyIdentification getDestination() const;
    void setDestination(const OAIPartyIdentification &destination);
    ...
    OAIInternalPartyIdentification getSource() const;
    void setSource(const OAIInternalPartyIdentification &source);
...
private:
    ...
    OAIPartyIdentification m_destination;
    ...
    OAIInternalPartyIdentification m_source;
    bool m_source_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferInfoOld)

#endif // OAITransferInfoOld_H
