...
/**
 * The InternalPartyIdentification model module.
 * @module model/InternalPartyIdentification
 * @version 1
 */
class InternalPartyIdentification {
    /**
     * Constructs a new <code>InternalPartyIdentification</code>.
     * @alias module:model/InternalPartyIdentification
     */
    constructor() { 
        
        InternalPartyIdentification.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InternalPartyIdentification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InternalPartyIdentification} obj Optional instance to populate.
     * @return {module:model/InternalPartyIdentification} The populated <code>InternalPartyIdentification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InternalPartyIdentification();
    ...
    /**
     * Validates the JSON data with respect to <code>InternalPartyIdentification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InternalPartyIdentification</code>.
     */
 ...
 */
InternalPartyIdentification.prototype['balanceAccountId'] = undefined;
 ...
 */
InternalPartyIdentification.prototype['paymentInstrumentId'] = undefined;
...
export default InternalPartyIdentification;
