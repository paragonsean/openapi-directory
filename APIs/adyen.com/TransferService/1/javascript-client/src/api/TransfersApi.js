...
export default class TransfersApi {
    ...
    */
     ...
     * @param {module:model/TransferOld} data The data returned by the service call.
     ...
     * @param {module:model/TransferInfoOld} [transferInfoOld] 
     ...
     * data is of type: {@link module:model/TransferOld}
     */
    postTransfers(opts, callback) {
      opts = opts || {};
      let postBody = opts['transferInfoOld'];
