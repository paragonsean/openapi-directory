...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.PartyIdentification();
  });
  ...
  describe('PartyIdentification', function() {
    it('should create an instance of PartyIdentification', function() {
      ...
      //var instance = new TransfersApi.PartyIdentification();
      //expect(instance).to.be.a(TransfersApi.PartyIdentification);
    });
