...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.InternalPartyIdentification();
  });
  ...
  describe('InternalPartyIdentification', function() {
    it('should create an instance of InternalPartyIdentification', function() {
      // uncomment below and update the code to test InternalPartyIdentification
      //var instance = new TransfersApi.InternalPartyIdentification();
      //expect(instance).to.be.a(TransfersApi.InternalPartyIdentification);
    });
