...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.TransferInfoOld();
  });
  ...
  describe('TransferInfoOld', function() {
    it('should create an instance of TransferInfoOld', function() {
      // uncomment below and update the code to test TransferInfoOld
      //var instance = new TransfersApi.TransferInfoOld();
      //expect(instance).to.be.a(TransfersApi.TransferInfoOld);
    });
