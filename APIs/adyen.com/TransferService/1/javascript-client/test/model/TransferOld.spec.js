...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.TransferOld();
  });
  ...
  describe('TransferOld', function() {
    it('should create an instance of TransferOld', function() {
      // uncomment below and update the code to test TransferOld
      //var instance = new TransfersApi.TransferOld();
      //expect(instance).to.be.a(TransfersApi.TransferOld);
    });
