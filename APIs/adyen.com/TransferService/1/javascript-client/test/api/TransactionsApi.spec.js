...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.TransactionsApi();
  });
  ...
  describe('TransactionsApi', function() {
    ...
    describe('getTransactionsId', function() {
      it('should call getTransactionsId successfully', function(done) {
        //uncomment below and update the code to test getTransactionsId
        //instance.getTransactionsId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
