...
OAICounterpartyInfo::OAICounterpartyInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICounterpartyInfo::OAICounterpartyInfo() {
    this->initializeModel();
}

OAICounterpartyInfo::~OAICounterpartyInfo() {}

void OAICounterpartyInfo::initializeModel() {
...
void OAICounterpartyInfo::fromJson(QString jsonString) {
...
void OAICounterpartyInfo::fromJsonObject(QJsonObject json) {
...
QString OAICounterpartyInfo::asJson() const {
...
QJsonObject OAICounterpartyInfo::asJsonObject() const {
    QJsonObject obj;
...
QString OAICounterpartyInfo::getBalanceAccountId() const {
    return m_balance_account_id;
}
void OAICounterpartyInfo::setBalanceAccountId(const QString &balance_account_id) {
    m_balance_account_id = balance_account_id;
    m_balance_account_id_isSet = true;
}

bool OAICounterpartyInfo::is_balance_account_id_Set() const{
    return m_balance_account_id_isSet;
}

bool OAICounterpartyInfo::is_balance_account_id_Valid() const{
    return m_balance_account_id_isValid;
}

OAIBankAccountInfo OAICounterpartyInfo::getBankAccount() const {
    return m_bank_account;
}
void OAICounterpartyInfo::setBankAccount(const OAIBankAccountInfo &bank_account) {
    m_bank_account = bank_account;
    m_bank_account_isSet = true;
}

bool OAICounterpartyInfo::is_bank_account_Set() const{
    return m_bank_account_isSet;
}

bool OAICounterpartyInfo::is_bank_account_Valid() const{
    return m_bank_account_isValid;
}

QString OAICounterpartyInfo::getTransferInstrumentId() const {
    return m_transfer_instrument_id;
}
void OAICounterpartyInfo::setTransferInstrumentId(const QString &transfer_instrument_id) {
    m_transfer_instrument_id = transfer_instrument_id;
    m_transfer_instrument_id_isSet = true;
}

bool OAICounterpartyInfo::is_transfer_instrument_id_Set() const{
    return m_transfer_instrument_id_isSet;
}

bool OAICounterpartyInfo::is_transfer_instrument_id_Valid() const{
    return m_transfer_instrument_id_isValid;
}

bool OAICounterpartyInfo::isSet() const {
...
bool OAICounterpartyInfo::isValid() const {
