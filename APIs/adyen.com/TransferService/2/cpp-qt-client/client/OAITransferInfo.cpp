...
OAIBank OAITransferInfo::getBank() const {
    return m_bank;
}
void OAITransferInfo::setBank(const OAIBank &bank) {
    m_bank = bank;
    m_bank_isSet = true;
}

bool OAITransferInfo::is_bank_Set() const{
    return m_bank_isSet;
}

bool OAITransferInfo::is_bank_Valid() const{
    return m_bank_isValid;
}

OAICounterpartyInfo OAITransferInfo::getCounterparty() const {
    return m_counterparty;
}
void OAITransferInfo::setCounterparty(const OAICounterpartyInfo &counterparty) {
...
bool OAITransferInfo::isValid() const {
    ...
    return m_amount_isValid && m_counterparty_isValid && true;
}
