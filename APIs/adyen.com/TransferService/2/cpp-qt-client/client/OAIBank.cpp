...
QString OAIBank::getPriority() const {
    return m_priority;
}
void OAIBank::setPriority(const QString &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIBank::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIBank::is_priority_Valid() const{
