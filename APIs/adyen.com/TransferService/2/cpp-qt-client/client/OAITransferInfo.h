...
public:
    ...
    OAICounterpartyInfo getCounterparty() const;
    void setCounterparty(const OAICounterpartyInfo &counterparty);
...
private:
    ...
    OAICounterpartyInfo m_counterparty;
