...
/*
 * OAITransactionSearchResponse.h
 *
 * 
 */

#ifndef OAITransactionSearchResponse_H
#define OAITransactionSearchResponse_H
...
class OAITransactionSearchResponse : public OAIObject {
public:
    OAITransactionSearchResponse();
    OAITransactionSearchResponse(QString json);
    ~OAITransactionSearchResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactionSearchResponse)

#endif // OAITransactionSearchResponse_H
