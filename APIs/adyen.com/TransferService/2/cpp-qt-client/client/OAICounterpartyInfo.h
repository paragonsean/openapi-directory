...
/*
 * OAICounterpartyInfo.h
 *
 * 
 */

#ifndef OAICounterpartyInfo_H
#define OAICounterpartyInfo_H
...
class OAICounterpartyInfo : public OAIObject {
public:
    OAICounterpartyInfo();
    OAICounterpartyInfo(QString json);
    ~OAICounterpartyInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICounterpartyInfo)

#endif // OAICounterpartyInfo_H
