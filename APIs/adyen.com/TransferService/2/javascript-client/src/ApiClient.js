...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://balanceplatform-api-test.adyen.com/btl/v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://balanceplatform-api-test.adyen.com/btl/v2
         */
        ...
        this.authentications = {
            ...
            'clientKey': {type: 'apiKey', 'in': 'query', name: 'clientKey'}
        }
