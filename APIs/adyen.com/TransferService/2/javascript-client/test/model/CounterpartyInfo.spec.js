...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransfersApi.CounterpartyInfo();
  });
  ...
  describe('CounterpartyInfo', function() {
    it('should create an instance of CounterpartyInfo', function() {
      // uncomment below and update the code to test CounterpartyInfo
      //var instance = new TransfersApi.CounterpartyInfo();
      //expect(instance).to.be.a(TransfersApi.CounterpartyInfo);
    });
