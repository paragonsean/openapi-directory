...
public class CounterpartyInfo {
  ...
  public CounterpartyInfo balanceAccountId(String balanceAccountId) {
  ...
  public CounterpartyInfo bankAccount(BankAccountInfo bankAccount) {
  ...
  public CounterpartyInfo transferInstrumentId(String transferInstrumentId) {
  ...
  public boolean equals(Object o) {
    ...
    CounterpartyInfo counterpartyInfo = (CounterpartyInfo) o;
    return Objects.equals(this.balanceAccountId, counterpartyInfo.balanceAccountId) &&
        Objects.equals(this.bankAccount, counterpartyInfo.bankAccount) &&
        Objects.equals(this.transferInstrumentId, counterpartyInfo.transferInstrumentId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CounterpartyInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CounterpartyInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CounterpartyInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CounterpartyInfo is not found in the empty JSON string", CounterpartyInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CounterpartyInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CounterpartyInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CounterpartyInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CounterpartyInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CounterpartyInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CounterpartyInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<CounterpartyInfo>() {
           @Override
           public void write(JsonWriter out, CounterpartyInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CounterpartyInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CounterpartyInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CounterpartyInfo
   * @throws IOException if the JSON string is invalid with respect to CounterpartyInfo
   */
  public static CounterpartyInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CounterpartyInfo.class);
  }

  /**
   * Convert an instance of CounterpartyInfo to an JSON string
   *
   * @return JSON string
   */
