...
#ifndef OAIIdealDetails_H
#define OAIIdealDetails_H
...
class OAIIdealDetails : public OAIObject {
public:
    OAIIdealDetails();
    OAIIdealDetails(QString json);
    ~OAIIdealDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdealDetails)

#endif // OAIIdealDetails_H
