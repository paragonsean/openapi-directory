...
/*
 * OAICardBrandDetails.h
 *
 * 
 */

#ifndef OAICardBrandDetails_H
#define OAICardBrandDetails_H
...
class OAICardBrandDetails : public OAIObject {
public:
    OAICardBrandDetails();
    OAICardBrandDetails(QString json);
    ~OAICardBrandDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICardBrandDetails)

#endif // OAICardBrandDetails_H
