...
void OAIPaymentVerificationResponse::initializeModel() {
    ...
    m_auth_response_isSet = false;
    m_auth_response_isValid = false;
...
void OAIPaymentVerificationResponse::fromJsonObject(QJsonObject json) {
    ...
    m_auth_response_isValid = ::OpenAPI::fromJsonValue(m_auth_response, json[QString("authResponse")]);
    m_auth_response_isSet = !json[QString("authResponse")].isNull() && m_auth_response_isValid;
...
QJsonObject OAIPaymentVerificationResponse::asJsonObject() const {
    ...
    if (m_auth_response_isSet) {
        obj.insert(QString("authResponse"), ::OpenAPI::toJsonValue(m_auth_response));
    }
...
QString OAIPaymentVerificationResponse::getAuthResponse() const {
    return m_auth_response;
}
void OAIPaymentVerificationResponse::setAuthResponse(const QString &auth_response) {
    m_auth_response = auth_response;
    m_auth_response_isSet = true;
}

bool OAIPaymentVerificationResponse::is_auth_response_Set() const{
    return m_auth_response_isSet;
}

bool OAIPaymentVerificationResponse::is_auth_response_Valid() const{
    return m_auth_response_isValid;
}
...
bool OAIPaymentVerificationResponse::isValid() const {
    ...
    return m_auth_response_isValid && m_merchant_reference_isValid && m_payment_method_isValid && m_shopper_locale_isValid && true;
}
