...
OAIUtilityRequest::OAIUtilityRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUtilityRequest::OAIUtilityRequest() {
    this->initializeModel();
}

OAIUtilityRequest::~OAIUtilityRequest() {}

void OAIUtilityRequest::initializeModel() {

    m_origin_domains_isSet = false;
    m_origin_domains_isValid = false;
}

void OAIUtilityRequest::fromJson(QString jsonString) {
...
void OAIUtilityRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUtilityRequest::asJson() const {
...
QJsonObject OAIUtilityRequest::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIUtilityRequest::getOriginDomains() const {
    return m_origin_domains;
}
void OAIUtilityRequest::setOriginDomains(const QList<QString> &origin_domains) {
    m_origin_domains = origin_domains;
    m_origin_domains_isSet = true;
}

bool OAIUtilityRequest::is_origin_domains_Set() const{
    return m_origin_domains_isSet;
}

bool OAIUtilityRequest::is_origin_domains_Valid() const{
    return m_origin_domains_isValid;
}

bool OAIUtilityRequest::isSet() const {
...
bool OAIUtilityRequest::isValid() const {
