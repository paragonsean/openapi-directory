...
QString OAIPaymentDetailsResponse::getAuthResponse() const {
    return m_auth_response;
}
void OAIPaymentDetailsResponse::setAuthResponse(const QString &auth_response) {
    m_auth_response = auth_response;
    m_auth_response_isSet = true;
}

bool OAIPaymentDetailsResponse::is_auth_response_Set() const{
    return m_auth_response_isSet;
}

bool OAIPaymentDetailsResponse::is_auth_response_Valid() const{
