...
class PaymentVerificationResponse {
     ...
     * @param authResponse {String} The authorisation code representing the authentication result.  Possible values: * Received * Authorised * Error * Refused * Cancelled * Unknown
     ...
     */
    constructor(authResponse, merchantReference, paymentMethod, shopperLocale) { 
        
        PaymentVerificationResponse.initialize(this, authResponse, merchantReference, paymentMethod, shopperLocale);
    }
     ...
     */
    static initialize(obj, authResponse, merchantReference, paymentMethod, shopperLocale) { 
        obj['authResponse'] = authResponse;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('authResponse')) {
                obj['authResponse'] = ApiClient.convertToType(data['authResponse'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['authResponse'] && !(typeof data['authResponse'] === 'string' || data['authResponse'] instanceof String)) {
            throw new Error("Expected the field `authResponse` to be a primitive type in the JSON string but got " + data['authResponse']);
        }
...
PaymentVerificationResponse.RequiredProperties = ["authResponse", "merchantReference", "paymentMethod", "shopperLocale"];
 ...
 * @member {String} authResponse
 */
PaymentVerificationResponse.prototype['authResponse'] = undefined;
