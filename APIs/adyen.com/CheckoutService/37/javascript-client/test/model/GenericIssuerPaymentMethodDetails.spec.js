...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.GenericIssuerPaymentMethodDetails();
  });
  ...
  describe('GenericIssuerPaymentMethodDetails', function() {
    it('should create an instance of GenericIssuerPaymentMethodDetails', function() {
      // uncomment below and update the code to test GenericIssuerPaymentMethodDetails
      //var instance = new AdyenCheckoutApi.GenericIssuerPaymentMethodDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.GenericIssuerPaymentMethodDetails);
    });
