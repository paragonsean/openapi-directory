...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.Configuration();
  });
  ...
  describe('Configuration', function() {
    it('should create an instance of Configuration', function() {
      ...
      //var instance = new AdyenCheckoutApi.Configuration();
      //expect(instance).to.be.a(AdyenCheckoutApi.Configuration);
    });
    ...
    it('should have the property shopperInput (base name: "shopperInput")', function() {
      // uncomment below and update the code to test the property shopperInput
      //var instance = new AdyenCheckoutApi.Configuration();
      //expect(instance).to.be();
    });
