...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.UpdatePaymentLinkRequest();
  });
  ...
  describe('UpdatePaymentLinkRequest', function() {
    it('should create an instance of UpdatePaymentLinkRequest', function() {
      // uncomment below and update the code to test UpdatePaymentLinkRequest
      //var instance = new AdyenCheckoutApi.UpdatePaymentLinkRequest();
      //expect(instance).to.be.a(AdyenCheckoutApi.UpdatePaymentLinkRequest);
    });
