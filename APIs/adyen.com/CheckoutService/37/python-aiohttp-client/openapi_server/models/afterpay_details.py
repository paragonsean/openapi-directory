...
class AfterpayDetails(Model):
    ...
    def __init__(self, billing_address: str=None, delivery_address: str=None, personal_details: str=None, recurring_detail_reference: str=None, type: str='afterpay_default'):
