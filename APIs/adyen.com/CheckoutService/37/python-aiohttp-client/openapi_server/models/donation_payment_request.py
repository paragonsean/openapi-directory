...
class DonationPaymentRequest(Model):
    ...
    def __init__(self, additional_amount: Amount=None, additional_data: BalanceCheckRequestAdditionalData=None, allowed_payment_methods: List[str]=None, amount: Amount=None, billing_address: BillingAddress=None, blocked_payment_methods: List[str]=None, browser_info: BrowserInfo=None, capture_delay_hours: int=None, channel: str=None, company: Company=None, country_code: str=None, date_of_birth: datetime=None, dcc_quote: ForexQuote=None, delivery_address: DeliveryAddress=None, delivery_date: datetime=None, device_fingerprint: str=None, donation_account: str=None, donation_original_psp_reference: str=None, donation_token: str=None, enable_one_click: bool=None, enable_pay_out: bool=None, enable_recurring: bool=None, entity_type: str=None, fraud_offset: int=None, fund_origin: FundOrigin=None, fund_recipient: FundRecipient=None, installments: Installments=None, line_items: List[LineItem]=None, mandate: Mandate=None, mcc: str=None, merchant_account: str=None, merchant_order_reference: str=None, metadata: Dict[str, str]=None, mpi_data: ThreeDSecureData=None, order: EncryptedOrderData=None, order_reference: str=None, payment_method: DonationPaymentRequestPaymentMethod=None, recurring_expiry: str=None, recurring_frequency: str=None, recurring_processing_model: str=None, redirect_from_issuer_method: str=None, redirect_to_issuer_method: str=None, reference: str=None, return_url: str=None, risk_data: RiskData=None, selected_recurring_detail_reference: str=None, session_validity: str=None, shopper_email: str=None, shopper_ip: str=None, shopper_interaction: str=None, shopper_locale: str=None, shopper_name: Name=None, shopper_reference: str=None, shopper_statement: str=None, social_security_number: str=None, splits: List[Split]=None, store: str=None, telephone_number: str=None, trusted_shopper: bool=None):
