...
class PayPalDetails(Model):
    ...
    def __init__(self, order_id: str=None, payee_preferred: str=None, payer_id: str=None, payer_selected: str=None, recurring_detail_reference: str=None, subtype: str=None, type: str='paypal'):
