...
class PaymentDetailsResponse(Model):
    ...
    def __init__(self, additional_data: BalanceCheckResponseAdditionalData=None, auth_response: str=None, details: List[InputDetail]=None, fraud_result: FraudResult=None, merchant_reference: str=None, order: CheckoutOrderResponse=None, output_details: Dict[str, str]=None, payment_data: str=None, psp_reference: str=None, redirect: Redirect=None, refusal_reason: str=None, refusal_reason_code: str=None, result_code: str=None, shopper_locale: str=None):
        ...
        :param auth_response: The auth_response of this PaymentDetailsResponse.
    ...
    def auth_response(self):
        """Gets the auth_response of this PaymentDetailsResponse.

        The authorisation code representing the authentication result.

        :return: The auth_response of this PaymentDetailsResponse.
        :rtype: str
        """
    ...
    def auth_response(self, auth_response):
        """Sets the auth_response of this PaymentDetailsResponse.
