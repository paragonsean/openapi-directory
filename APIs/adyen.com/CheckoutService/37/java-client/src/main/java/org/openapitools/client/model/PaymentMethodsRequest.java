...
public class PaymentMethodsRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalData, allowedPaymentMethods, amount, blockedPaymentMethods, channel, countryCode, merchantAccount, shopperLocale, shopperReference, store);
  }
