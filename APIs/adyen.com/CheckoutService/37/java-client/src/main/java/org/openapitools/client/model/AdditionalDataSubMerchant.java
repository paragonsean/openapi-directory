...
public class AdditionalDataSubMerchant {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdditionalDataSubMerchant
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdditionalDataSubMerchant.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdditionalDataSubMerchant.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdditionalDataSubMerchant` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("subMerchant.numberOfSubSellers") != null && !jsonObj.get("subMerchant.numberOfSubSellers").isJsonNull()) && !jsonObj.get("subMerchant.numberOfSubSellers").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchant.subSeller[subSellerNr].city") != null && !jsonObj.get("subMerchant.subSeller[subSellerNr].city").isJsonNull()) && !jsonObj.get("subMerchant.subSeller[subSellerNr].city").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchant.subSeller[subSellerNr].country") != null && !jsonObj.get("subMerchant.subSeller[subSellerNr].country").isJsonNull()) && !jsonObj.get("subMerchant.subSeller[subSellerNr].country").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchant.subSeller[subSellerNr].id") != null && !jsonObj.get("subMerchant.subSeller[subSellerNr].id").isJsonNull()) && !jsonObj.get("subMerchant.subSeller[subSellerNr].id").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchant.subSeller[subSellerNr].mcc") != null && !jsonObj.get("subMerchant.subSeller[subSellerNr].mcc").isJsonNull()) && !jsonObj.get("subMerchant.subSeller[subSellerNr].mcc").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchant.subSeller[subSellerNr].name") != null && !jsonObj.get("subMerchant.subSeller[subSellerNr].name").isJsonNull()) && !jsonObj.get("subMerchant.subSeller[subSellerNr].name").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchant.subSeller[subSellerNr].postalCode") != null && !jsonObj.get("subMerchant.subSeller[subSellerNr].postalCode").isJsonNull()) && !jsonObj.get("subMerchant.subSeller[subSellerNr].postalCode").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchant.subSeller[subSellerNr].state") != null && !jsonObj.get("subMerchant.subSeller[subSellerNr].state").isJsonNull()) && !jsonObj.get("subMerchant.subSeller[subSellerNr].state").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchant.subSeller[subSellerNr].street") != null && !jsonObj.get("subMerchant.subSeller[subSellerNr].street").isJsonNull()) && !jsonObj.get("subMerchant.subSeller[subSellerNr].street").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchant.subSeller[subSellerNr].taxId") != null && !jsonObj.get("subMerchant.subSeller[subSellerNr].taxId").isJsonNull()) && !jsonObj.get("subMerchant.subSeller[subSellerNr].taxId").isJsonPrimitive()) {
