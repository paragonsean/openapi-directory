...
public class PaymentVerificationResponse {
  ...
  public PaymentVerificationResponse authResponse(String authResponse) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalData, authResponse, fraudResult, merchantReference, order, paymentMethod, pspReference, refusalReason, refusalReasonCode, resultCode, serviceError, shopperLocale);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("authResponse");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("authResponse").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `authResponse` to be a primitive type in the JSON string but got `%s`", jsonObj.get("authResponse").toString()));
      }
