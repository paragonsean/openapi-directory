...
public class PaymentRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalAmount, additionalData, amount, billingAddress, browserInfo, captureDelayHours, channel, company, countryCode, dateOfBirth, dccQuote, deliveryAddress, deliveryDate, deviceFingerprint, enableOneClick, enablePayOut, enableRecurring, entityType, fraudOffset, fundOrigin, fundRecipient, installments, lineItems, mandate, mcc, merchantAccount, merchantOrderReference, metadata, mpiData, order, orderReference, paymentMethod, recurringExpiry, recurringFrequency, recurringProcessingModel, redirectFromIssuerMethod, redirectToIssuerMethod, reference, returnUrl, riskData, sessionValidity, shopperEmail, shopperIP, shopperInteraction, shopperLocale, shopperName, shopperReference, shopperStatement, socialSecurityNumber, splits, store, telephoneNumber, trustedShopper);
  }
