...
public class PaymentDetailsResponse {
  ...
  public PaymentDetailsResponse authResponse(String authResponse) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.additionalData, paymentDetailsResponse.additionalData) &&
        Objects.equals(this.authResponse, paymentDetailsResponse.authResponse) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalData, authResponse, details, fraudResult, merchantReference, order, outputDetails, paymentData, pspReference, redirect, refusalReason, refusalReasonCode, resultCode, shopperLocale);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("authResponse") != null && !jsonObj.get("authResponse").isJsonNull()) && !jsonObj.get("authResponse").isJsonPrimitive()) {
