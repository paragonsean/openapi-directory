...
public class ApiClient {
    ...
    private String basePath = "https://checkout-test.adyen.com/v37";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://checkout-test.adyen.com/v37",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/37/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://checkout-test.adyen.com/v37
