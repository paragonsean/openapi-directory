...
public class BalanceCheckRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.additionalAmount, balanceCheckRequest.additionalAmount) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalAmount, additionalData, amount, billingAddress, browserInfo, captureDelayHours, dateOfBirth, dccQuote, deliveryAddress, deliveryDate, deviceFingerprint, fraudOffset, installments, mcc, merchantAccount, merchantOrderReference, metadata, orderReference, paymentMethod, recurring, recurringProcessingModel, reference, selectedBrand, selectedRecurringDetailReference, sessionId, shopperEmail, shopperIP, shopperInteraction, shopperLocale, shopperName, shopperReference, shopperStatement, socialSecurityNumber, splits, store, telephoneNumber, totalsGroup, trustedShopper);
  }
