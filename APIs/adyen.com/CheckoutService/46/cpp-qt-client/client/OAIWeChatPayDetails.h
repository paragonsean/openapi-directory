...
/*
 * OAIWeChatPayDetails.h
 *
 * 
 */

#ifndef OAIWeChatPayDetails_H
#define OAIWeChatPayDetails_H
...
class OAIWeChatPayDetails : public OAIObject {
public:
    OAIWeChatPayDetails();
    OAIWeChatPayDetails(QString json);
    ~OAIWeChatPayDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWeChatPayDetails)

#endif // OAIWeChatPayDetails_H
