...
#ifndef OAISubInputDetail_H
#define OAISubInputDetail_H
...
class OAISubInputDetail : public OAIObject {
public:
    OAISubInputDetail();
    OAISubInputDetail(QString json);
    ~OAISubInputDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubInputDetail)

#endif // OAISubInputDetail_H
