...
/*
 * OAIThreeDS2RequestFields.h
 *
 * 
 */

#ifndef OAIThreeDS2RequestFields_H
#define OAIThreeDS2RequestFields_H
...
class OAIThreeDS2RequestFields : public OAIObject {
public:
    OAIThreeDS2RequestFields();
    OAIThreeDS2RequestFields(QString json);
    ~OAIThreeDS2RequestFields() override;
    ...
    bool isAuthenticationOnly() const;
    void setAuthenticationOnly(const bool &authentication_only);
    bool is_authentication_only_Set() const;
    bool is_authentication_only_Valid() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThreeDS2RequestFields)

#endif // OAIThreeDS2RequestFields_H
