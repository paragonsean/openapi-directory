...
/*
 * OAISamsungPayDetails.h
 *
 * 
 */

#ifndef OAISamsungPayDetails_H
#define OAISamsungPayDetails_H
...
class OAISamsungPayDetails : public OAIObject {
public:
    OAISamsungPayDetails();
    OAISamsungPayDetails(QString json);
    ~OAISamsungPayDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISamsungPayDetails)

#endif // OAISamsungPayDetails_H
