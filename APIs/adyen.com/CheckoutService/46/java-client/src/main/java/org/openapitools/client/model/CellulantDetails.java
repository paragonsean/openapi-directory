...
public class CellulantDetails {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issuer, cellulantDetails.issuer) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to CellulantDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CellulantDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CellulantDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CellulantDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
