...
public class WeChatPayMiniProgramDetails {
  ...
  private TypeEnum type = TypeEnum.WECHATPAY_MINI_PROGRAM;
   ...
   * @throws IOException if the JSON Element is invalid with respect to WeChatPayMiniProgramDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WeChatPayMiniProgramDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WeChatPayMiniProgramDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WeChatPayMiniProgramDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("openid") != null && !jsonObj.get("openid").isJsonNull()) && !jsonObj.get("openid").isJsonPrimitive()) {
