...
|**status** | [**StatusEnum**](#StatusEnum) | Status of the payment link. Possible values: * **active**: The link can be used to make payments. * **expired**: The expiry date for the payment link has passed. Shoppers can no longer use the link to make payments. * **paid**: The shopper completed the payment. |  |
