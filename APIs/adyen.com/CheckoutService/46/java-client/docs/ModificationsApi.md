...
All URIs are relative to *https://checkout-test.adyen.com/v46*
...
<a id="postCancels"></a>
# **postCancels**
> StandalonePaymentCancelResponse postCancels(idempotencyKey, standalonePaymentCancelRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://checkout-test.adyen.com/v46");
    ...
    StandalonePaymentCancelRequest standalonePaymentCancelRequest = new StandalonePaymentCancelRequest(); // StandalonePaymentCancelRequest | 
    try {
      StandalonePaymentCancelResponse result = apiInstance.postCancels(idempotencyKey, standalonePaymentCancelRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ModificationsApi#postCancels");
...
<a id="postPaymentsPaymentPspReferenceAmountUpdates"></a>
# **postPaymentsPaymentPspReferenceAmountUpdates**
> PaymentAmountUpdateResponse postPaymentsPaymentPspReferenceAmountUpdates(paymentPspReference, idempotencyKey, paymentAmountUpdateRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ModificationsApi apiInstance = new ModificationsApi(defaultClient);
    String paymentPspReference = "paymentPspReference_example"; // String | The [`pspReference`](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the payment.
    String idempotencyKey = "37ca9c97-d1d1-4c62-89e8-706891a563ed"; // String | A unique identifier for the message with a maximum of 64 characters (we recommend a UUID).
    PaymentAmountUpdateRequest paymentAmountUpdateRequest = new PaymentAmountUpdateRequest(); // PaymentAmountUpdateRequest | 
    try {
      PaymentAmountUpdateResponse result = apiInstance.postPaymentsPaymentPspReferenceAmountUpdates(paymentPspReference, idempotencyKey, paymentAmountUpdateRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ModificationsApi#postPaymentsPaymentPspReferenceAmountUpdates");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="postPaymentsPaymentPspReferenceCancels"></a>
# **postPaymentsPaymentPspReferenceCancels**
> PaymentCancelResponse postPaymentsPaymentPspReferenceCancels(paymentPspReference, idempotencyKey, paymentCancelRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ModificationsApi apiInstance = new ModificationsApi(defaultClient);
    String paymentPspReference = "paymentPspReference_example"; // String | The [`pspReference`](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the payment that you want to cancel. 
    String idempotencyKey = "37ca9c97-d1d1-4c62-89e8-706891a563ed"; // String | A unique identifier for the message with a maximum of 64 characters (we recommend a UUID).
    PaymentCancelRequest paymentCancelRequest = new PaymentCancelRequest(); // PaymentCancelRequest | 
    try {
      PaymentCancelResponse result = apiInstance.postPaymentsPaymentPspReferenceCancels(paymentPspReference, idempotencyKey, paymentCancelRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ModificationsApi#postPaymentsPaymentPspReferenceCancels");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="postPaymentsPaymentPspReferenceCaptures"></a>
# **postPaymentsPaymentPspReferenceCaptures**
> PaymentCaptureResponse postPaymentsPaymentPspReferenceCaptures(paymentPspReference, idempotencyKey, paymentCaptureRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ModificationsApi apiInstance = new ModificationsApi(defaultClient);
    String paymentPspReference = "paymentPspReference_example"; // String | The [`pspReference`](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the payment that you want to capture.
    String idempotencyKey = "37ca9c97-d1d1-4c62-89e8-706891a563ed"; // String | A unique identifier for the message with a maximum of 64 characters (we recommend a UUID).
    PaymentCaptureRequest paymentCaptureRequest = new PaymentCaptureRequest(); // PaymentCaptureRequest | 
    try {
      PaymentCaptureResponse result = apiInstance.postPaymentsPaymentPspReferenceCaptures(paymentPspReference, idempotencyKey, paymentCaptureRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ModificationsApi#postPaymentsPaymentPspReferenceCaptures");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="postPaymentsPaymentPspReferenceRefunds"></a>
# **postPaymentsPaymentPspReferenceRefunds**
> PaymentRefundResponse postPaymentsPaymentPspReferenceRefunds(paymentPspReference, idempotencyKey, paymentRefundRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ModificationsApi apiInstance = new ModificationsApi(defaultClient);
    String paymentPspReference = "paymentPspReference_example"; // String | The [`pspReference`](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the payment that you want to refund.
    String idempotencyKey = "37ca9c97-d1d1-4c62-89e8-706891a563ed"; // String | A unique identifier for the message with a maximum of 64 characters (we recommend a UUID).
    PaymentRefundRequest paymentRefundRequest = new PaymentRefundRequest(); // PaymentRefundRequest | 
    try {
      PaymentRefundResponse result = apiInstance.postPaymentsPaymentPspReferenceRefunds(paymentPspReference, idempotencyKey, paymentRefundRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ModificationsApi#postPaymentsPaymentPspReferenceRefunds");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="postPaymentsPaymentPspReferenceReversals"></a>
# **postPaymentsPaymentPspReferenceReversals**
> PaymentReversalResponse postPaymentsPaymentPspReferenceReversals(paymentPspReference, idempotencyKey, paymentReversalRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ModificationsApi apiInstance = new ModificationsApi(defaultClient);
    String paymentPspReference = "paymentPspReference_example"; // String | The [`pspReference`](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the payment that you want to reverse. 
    String idempotencyKey = "37ca9c97-d1d1-4c62-89e8-706891a563ed"; // String | A unique identifier for the message with a maximum of 64 characters (we recommend a UUID).
    PaymentReversalRequest paymentReversalRequest = new PaymentReversalRequest(); // PaymentReversalRequest | 
    try {
      PaymentReversalResponse result = apiInstance.postPaymentsPaymentPspReferenceReversals(paymentPspReference, idempotencyKey, paymentReversalRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ModificationsApi#postPaymentsPaymentPspReferenceReversals");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
