...
/**
 * The PaymentCancelRequest model module.
 * @module model/PaymentCancelRequest
 * @version 46
 */
class PaymentCancelRequest {
    /**
     * Constructs a new <code>PaymentCancelRequest</code>.
     * @alias module:model/PaymentCancelRequest
     * @param merchantAccount {String} The merchant account that is used to process the payment.
     */
    constructor(merchantAccount) { 
        
        PaymentCancelRequest.initialize(this, merchantAccount);
    }
    ...
    /**
     * Constructs a <code>PaymentCancelRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentCancelRequest} obj Optional instance to populate.
     * @return {module:model/PaymentCancelRequest} The populated <code>PaymentCancelRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentCancelRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentCancelRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentCancelRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentCancelRequest.RequiredProperties) {
...
PaymentCancelRequest.RequiredProperties = ["merchantAccount"];

/**
 * Information about your application. For more details, see [Building Adyen solutions](https://docs.adyen.com/development-resources/building-adyen-solutions).
 * @member {module:model/ApplicationInfo} applicationInfo
 */
PaymentCancelRequest.prototype['applicationInfo'] = undefined;

/**
 * The merchant account that is used to process the payment.
 * @member {String} merchantAccount
 */
PaymentCancelRequest.prototype['merchantAccount'] = undefined;

/**
 * Your reference for the cancel request. Maximum length: 80 characters.
 * @member {String} reference
 */
PaymentCancelRequest.prototype['reference'] = undefined;
...
export default PaymentCancelRequest;
