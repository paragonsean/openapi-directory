...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.AdditionalDataOpi();
  });
  ...
  describe('AdditionalDataOpi', function() {
    it('should create an instance of AdditionalDataOpi', function() {
      // uncomment below and update the code to test AdditionalDataOpi
      //var instance = new AdyenCheckoutApi.AdditionalDataOpi();
      //expect(instance).to.be.a(AdyenCheckoutApi.AdditionalDataOpi);
    });
