...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CancelOrderResponse();
  });
  ...
  describe('CancelOrderResponse', function() {
    it('should create an instance of CancelOrderResponse', function() {
      // uncomment below and update the code to test CancelOrderResponse
      //var instance = new AdyenCheckoutApi.CancelOrderResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.CancelOrderResponse);
    });
