...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.Company();
  });
  ...
  describe('Company', function() {
    it('should create an instance of Company', function() {
      ...
      //var instance = new AdyenCheckoutApi.Company();
      //expect(instance).to.be.a(AdyenCheckoutApi.Company);
    });
    ...
    it('should have the property registryLocation (base name: "registryLocation")', function() {
      // uncomment below and update the code to test the property registryLocation
      //var instance = new AdyenCheckoutApi.Company();
      //expect(instance).to.be();
    });
