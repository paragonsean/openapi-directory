...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.SplitAmount();
  });
  ...
  describe('SplitAmount', function() {
    it('should create an instance of SplitAmount', function() {
      // uncomment below and update the code to test SplitAmount
      //var instance = new AdyenCheckoutApi.SplitAmount();
      //expect(instance).to.be.a(AdyenCheckoutApi.SplitAmount);
    });
