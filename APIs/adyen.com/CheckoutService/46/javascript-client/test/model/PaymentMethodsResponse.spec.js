...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentMethodsResponse();
  });
  ...
  describe('PaymentMethodsResponse', function() {
    it('should create an instance of PaymentMethodsResponse', function() {
      ...
      //var instance = new AdyenCheckoutApi.PaymentMethodsResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentMethodsResponse);
    });
    ...
    it('should have the property oneClickPaymentMethods (base name: "oneClickPaymentMethods")', function() {
      // uncomment below and update the code to test the property oneClickPaymentMethods
      //var instance = new AdyenCheckoutApi.PaymentMethodsResponse();
      //expect(instance).to.be();
    });
