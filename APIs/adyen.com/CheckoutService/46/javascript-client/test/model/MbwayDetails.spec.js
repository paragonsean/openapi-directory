...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.MbwayDetails();
  });
  ...
  describe('MbwayDetails', function() {
    it('should create an instance of MbwayDetails', function() {
      // uncomment below and update the code to test MbwayDetails
      //var instance = new AdyenCheckoutApi.MbwayDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.MbwayDetails);
    });
