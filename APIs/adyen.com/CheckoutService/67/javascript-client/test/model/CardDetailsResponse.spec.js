...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CardDetailsResponse();
  });
  ...
  describe('CardDetailsResponse', function() {
    it('should create an instance of CardDetailsResponse', function() {
      // uncomment below and update the code to test CardDetailsResponse
      //var instance = new AdyenCheckoutApi.CardDetailsResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.CardDetailsResponse);
    });
