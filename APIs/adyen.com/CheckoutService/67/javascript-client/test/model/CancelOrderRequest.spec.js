...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CancelOrderRequest();
  });
  ...
  describe('CancelOrderRequest', function() {
    it('should create an instance of CancelOrderRequest', function() {
      ...
      //var instance = new AdyenCheckoutApi.CancelOrderRequest();
      //expect(instance).to.be.a(AdyenCheckoutApi.CancelOrderRequest);
    });
