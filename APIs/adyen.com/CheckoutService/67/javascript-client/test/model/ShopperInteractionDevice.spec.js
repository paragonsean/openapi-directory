...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.ShopperInteractionDevice();
  });
  ...
  describe('ShopperInteractionDevice', function() {
    it('should create an instance of ShopperInteractionDevice', function() {
      // uncomment below and update the code to test ShopperInteractionDevice
      //var instance = new AdyenCheckoutApi.ShopperInteractionDevice();
      //expect(instance).to.be.a(AdyenCheckoutApi.ShopperInteractionDevice);
    });
