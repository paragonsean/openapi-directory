...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentRefundResponse();
  });
  ...
  describe('PaymentRefundResponse', function() {
    it('should create an instance of PaymentRefundResponse', function() {
      // uncomment below and update the code to test PaymentRefundResponse
      //var instance = new AdyenCheckoutApi.PaymentRefundResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentRefundResponse);
    });
    ...
    it('should have the property merchantRefundReason (base name: "merchantRefundReason")', function() {
      // uncomment below and update the code to test the property merchantRefundReason
      //var instance = new AdyenCheckoutApi.PaymentRefundResponse();
      //expect(instance).to.be();
    });
