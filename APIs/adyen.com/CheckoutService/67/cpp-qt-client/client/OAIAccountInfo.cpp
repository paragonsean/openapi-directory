...
QString OAIAccountInfo::getAccountType() const {
    return m_account_type;
}
void OAIAccountInfo::setAccountType(const QString &account_type) {
    m_account_type = account_type;
    m_account_type_isSet = true;
}

bool OAIAccountInfo::is_account_type_Set() const{
    return m_account_type_isSet;
}

bool OAIAccountInfo::is_account_type_Valid() const{
