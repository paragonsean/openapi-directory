...
/*
 * OAIPaymentLinkRequest.h
 *
 * 
 */

#ifndef OAIPaymentLinkRequest_H
#define OAIPaymentLinkRequest_H
...
class OAIPaymentLinkRequest : public OAIObject {
public:
    OAIPaymentLinkRequest();
    OAIPaymentLinkRequest(QString json);
    ~OAIPaymentLinkRequest() override;
    ...
    QList<QString> getRequiredShopperFields() const;
    void setRequiredShopperFields(const QList<QString> &required_shopper_fields);
    bool is_required_shopper_fields_Set() const;
    bool is_required_shopper_fields_Valid() const;
...
private:
    ...
    QList<QString> m_required_shopper_fields;
    bool m_required_shopper_fields_isSet;
    bool m_required_shopper_fields_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentLinkRequest)

#endif // OAIPaymentLinkRequest_H
