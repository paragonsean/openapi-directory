...
/*
 * OAIAndroidPayDetails.h
 *
 * 
 */

#ifndef OAIAndroidPayDetails_H
#define OAIAndroidPayDetails_H
...
class OAIAndroidPayDetails : public OAIObject {
public:
    OAIAndroidPayDetails();
    OAIAndroidPayDetails(QString json);
    ~OAIAndroidPayDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAndroidPayDetails)

#endif // OAIAndroidPayDetails_H
