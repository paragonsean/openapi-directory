...
OAIBalanceCheckRequest_additionalData OAIPaymentRequest::getAdditionalData() const {
    return m_additional_data;
}
void OAIPaymentRequest::setAdditionalData(const OAIBalanceCheckRequest_additionalData &additional_data) {
...
OAIBillingAddress OAIPaymentRequest::getBillingAddress() const {
    return m_billing_address;
}
void OAIPaymentRequest::setBillingAddress(const OAIBillingAddress &billing_address) {
...
QString OAIPaymentRequest::getChannel() const {
    return m_channel;
}
void OAIPaymentRequest::setChannel(const QString &channel) {
    m_channel = channel;
    m_channel_isSet = true;
}

bool OAIPaymentRequest::is_channel_Set() const{
    return m_channel_isSet;
}

bool OAIPaymentRequest::is_channel_Valid() const{
    return m_channel_isValid;
}

OAICompany OAIPaymentRequest::getCompany() const {
    return m_company;
}
void OAIPaymentRequest::setCompany(const OAICompany &company) {
    m_company = company;
    m_company_isSet = true;
}

bool OAIPaymentRequest::is_company_Set() const{
    return m_company_isSet;
}

bool OAIPaymentRequest::is_company_Valid() const{
    return m_company_isValid;
}

QString OAIPaymentRequest::getConversionId() const {
    return m_conversion_id;
}
void OAIPaymentRequest::setConversionId(const QString &conversion_id) {
    m_conversion_id = conversion_id;
    m_conversion_id_isSet = true;
}

bool OAIPaymentRequest::is_conversion_id_Set() const{
    return m_conversion_id_isSet;
}

bool OAIPaymentRequest::is_conversion_id_Valid() const{
    return m_conversion_id_isValid;
}

QString OAIPaymentRequest::getCountryCode() const {
    return m_country_code;
}
void OAIPaymentRequest::setCountryCode(const QString &country_code) {
    m_country_code = country_code;
    m_country_code_isSet = true;
}

bool OAIPaymentRequest::is_country_code_Set() const{
    return m_country_code_isSet;
}

bool OAIPaymentRequest::is_country_code_Valid() const{
    return m_country_code_isValid;
}

QDateTime OAIPaymentRequest::getDateOfBirth() const {
    return m_date_of_birth;
}
void OAIPaymentRequest::setDateOfBirth(const QDateTime &date_of_birth) {
...
OAIDeliveryAddress OAIPaymentRequest::getDeliveryAddress() const {
    return m_delivery_address;
}
void OAIPaymentRequest::setDeliveryAddress(const OAIDeliveryAddress &delivery_address) {
...
bool OAIPaymentRequest::isEnableOneClick() const {
    return m_enable_one_click;
}
void OAIPaymentRequest::setEnableOneClick(const bool &enable_one_click) {
    m_enable_one_click = enable_one_click;
    m_enable_one_click_isSet = true;
}

bool OAIPaymentRequest::is_enable_one_click_Set() const{
    return m_enable_one_click_isSet;
}

bool OAIPaymentRequest::is_enable_one_click_Valid() const{
    return m_enable_one_click_isValid;
}

bool OAIPaymentRequest::isEnablePayOut() const {
    return m_enable_pay_out;
}
void OAIPaymentRequest::setEnablePayOut(const bool &enable_pay_out) {
    m_enable_pay_out = enable_pay_out;
    m_enable_pay_out_isSet = true;
}

bool OAIPaymentRequest::is_enable_pay_out_Set() const{
    return m_enable_pay_out_isSet;
}

bool OAIPaymentRequest::is_enable_pay_out_Valid() const{
    return m_enable_pay_out_isValid;
}

bool OAIPaymentRequest::isEnableRecurring() const {
    return m_enable_recurring;
}
void OAIPaymentRequest::setEnableRecurring(const bool &enable_recurring) {
    m_enable_recurring = enable_recurring;
    m_enable_recurring_isSet = true;
}

bool OAIPaymentRequest::is_enable_recurring_Set() const{
    return m_enable_recurring_isSet;
}

bool OAIPaymentRequest::is_enable_recurring_Valid() const{
...
OAIFundOrigin OAIPaymentRequest::getFundOrigin() const {
    return m_fund_origin;
}
void OAIPaymentRequest::setFundOrigin(const OAIFundOrigin &fund_origin) {
    m_fund_origin = fund_origin;
    m_fund_origin_isSet = true;
}

bool OAIPaymentRequest::is_fund_origin_Set() const{
    return m_fund_origin_isSet;
}

bool OAIPaymentRequest::is_fund_origin_Valid() const{
    return m_fund_origin_isValid;
}

OAIFundRecipient OAIPaymentRequest::getFundRecipient() const {
    return m_fund_recipient;
}
void OAIPaymentRequest::setFundRecipient(const OAIFundRecipient &fund_recipient) {
    m_fund_recipient = fund_recipient;
    m_fund_recipient_isSet = true;
}

bool OAIPaymentRequest::is_fund_recipient_Set() const{
    return m_fund_recipient_isSet;
}

bool OAIPaymentRequest::is_fund_recipient_Valid() const{
...
QList<OAILineItem> OAIPaymentRequest::getLineItems() const {
    return m_line_items;
}
void OAIPaymentRequest::setLineItems(const QList<OAILineItem> &line_items) {
    m_line_items = line_items;
    m_line_items_isSet = true;
}

bool OAIPaymentRequest::is_line_items_Set() const{
    return m_line_items_isSet;
}

bool OAIPaymentRequest::is_line_items_Valid() const{
...
OAIEncryptedOrderData OAIPaymentRequest::getOrder() const {
    return m_order;
}
void OAIPaymentRequest::setOrder(const OAIEncryptedOrderData &order) {
    m_order = order;
    m_order_isSet = true;
}

bool OAIPaymentRequest::is_order_Set() const{
    return m_order_isSet;
}

bool OAIPaymentRequest::is_order_Valid() const{
...
QString OAIPaymentRequest::getOrigin() const {
    return m_origin;
}
void OAIPaymentRequest::setOrigin(const QString &origin) {
    m_origin = origin;
    m_origin_isSet = true;
}

bool OAIPaymentRequest::is_origin_Set() const{
    return m_origin_isSet;
}

bool OAIPaymentRequest::is_origin_Valid() const{
    return m_origin_isValid;
}

OAIPaymentRequest_paymentMethod OAIPaymentRequest::getPaymentMethod() const {
    return m_payment_method;
}
void OAIPaymentRequest::setPaymentMethod(const OAIPaymentRequest_paymentMethod &payment_method) {
...
QString OAIPaymentRequest::getRecurringExpiry() const {
    return m_recurring_expiry;
}
void OAIPaymentRequest::setRecurringExpiry(const QString &recurring_expiry) {
    m_recurring_expiry = recurring_expiry;
    m_recurring_expiry_isSet = true;
}

bool OAIPaymentRequest::is_recurring_expiry_Set() const{
    return m_recurring_expiry_isSet;
}

bool OAIPaymentRequest::is_recurring_expiry_Valid() const{
    return m_recurring_expiry_isValid;
}

QString OAIPaymentRequest::getRecurringFrequency() const {
    return m_recurring_frequency;
}
void OAIPaymentRequest::setRecurringFrequency(const QString &recurring_frequency) {
    m_recurring_frequency = recurring_frequency;
    m_recurring_frequency_isSet = true;
}

bool OAIPaymentRequest::is_recurring_frequency_Set() const{
    return m_recurring_frequency_isSet;
}

bool OAIPaymentRequest::is_recurring_frequency_Valid() const{
...
QString OAIPaymentRequest::getRedirectFromIssuerMethod() const {
    return m_redirect_from_issuer_method;
}
void OAIPaymentRequest::setRedirectFromIssuerMethod(const QString &redirect_from_issuer_method) {
    m_redirect_from_issuer_method = redirect_from_issuer_method;
    m_redirect_from_issuer_method_isSet = true;
}

bool OAIPaymentRequest::is_redirect_from_issuer_method_Set() const{
    return m_redirect_from_issuer_method_isSet;
}

bool OAIPaymentRequest::is_redirect_from_issuer_method_Valid() const{
    return m_redirect_from_issuer_method_isValid;
}

QString OAIPaymentRequest::getRedirectToIssuerMethod() const {
    return m_redirect_to_issuer_method;
}
void OAIPaymentRequest::setRedirectToIssuerMethod(const QString &redirect_to_issuer_method) {
    m_redirect_to_issuer_method = redirect_to_issuer_method;
    m_redirect_to_issuer_method_isSet = true;
}

bool OAIPaymentRequest::is_redirect_to_issuer_method_Set() const{
    return m_redirect_to_issuer_method_isSet;
}

bool OAIPaymentRequest::is_redirect_to_issuer_method_Valid() const{
...
OAIRiskData OAIPaymentRequest::getRiskData() const {
    return m_risk_data;
}
void OAIPaymentRequest::setRiskData(const OAIRiskData &risk_data) {
    m_risk_data = risk_data;
    m_risk_data_isSet = true;
}

bool OAIPaymentRequest::is_risk_data_Set() const{
    return m_risk_data_isSet;
}

bool OAIPaymentRequest::is_risk_data_Valid() const{
    return m_risk_data_isValid;
}

QString OAIPaymentRequest::getSessionValidity() const {
    return m_session_validity;
}
void OAIPaymentRequest::setSessionValidity(const QString &session_validity) {
    m_session_validity = session_validity;
    m_session_validity_isSet = true;
}

bool OAIPaymentRequest::is_session_validity_Set() const{
    return m_session_validity_isSet;
}

bool OAIPaymentRequest::is_session_validity_Valid() const{
...
bool OAIPaymentRequest::isStorePaymentMethod() const {
    return m_store_payment_method;
}
void OAIPaymentRequest::setStorePaymentMethod(const bool &store_payment_method) {
    m_store_payment_method = store_payment_method;
    m_store_payment_method_isSet = true;
}

bool OAIPaymentRequest::is_store_payment_method_Set() const{
    return m_store_payment_method_isSet;
}

bool OAIPaymentRequest::is_store_payment_method_Valid() const{
...
OAIThreeDS2RequestFields OAIPaymentRequest::getThreeDs2RequestData() const {
    return m_three_ds2_request_data;
}
void OAIPaymentRequest::setThreeDs2RequestData(const OAIThreeDS2RequestFields &three_ds2_request_data) {
