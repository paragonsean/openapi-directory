...
/*
 * OAIShopperInteractionDevice.h
 *
 * 
 */

#ifndef OAIShopperInteractionDevice_H
#define OAIShopperInteractionDevice_H
...
class OAIShopperInteractionDevice : public OAIObject {
public:
    OAIShopperInteractionDevice();
    OAIShopperInteractionDevice(QString json);
    ~OAIShopperInteractionDevice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShopperInteractionDevice)

#endif // OAIShopperInteractionDevice_H
