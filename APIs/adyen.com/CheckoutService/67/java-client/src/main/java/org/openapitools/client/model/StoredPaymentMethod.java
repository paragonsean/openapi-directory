...
public class StoredPaymentMethod {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bankAccountNumber, bankLocationId, brand, expiryMonth, expiryYear, holderName, iban, id, lastFour, name, ownerName, shopperEmail, supportedShopperInteractions, type);
  }
