...
public class AdditionalDataRisk {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdditionalDataRisk
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdditionalDataRisk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdditionalDataRisk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdditionalDataRisk` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("riskdata.[customFieldName]") != null && !jsonObj.get("riskdata.[customFieldName]").isJsonNull()) && !jsonObj.get("riskdata.[customFieldName]").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].amountPerItem") != null && !jsonObj.get("riskdata.basket.item[itemNr].amountPerItem").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].amountPerItem").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].brand") != null && !jsonObj.get("riskdata.basket.item[itemNr].brand").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].brand").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].category") != null && !jsonObj.get("riskdata.basket.item[itemNr].category").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].category").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].color") != null && !jsonObj.get("riskdata.basket.item[itemNr].color").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].color").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].currency") != null && !jsonObj.get("riskdata.basket.item[itemNr].currency").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].currency").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].itemID") != null && !jsonObj.get("riskdata.basket.item[itemNr].itemID").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].itemID").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].manufacturer") != null && !jsonObj.get("riskdata.basket.item[itemNr].manufacturer").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].manufacturer").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].productTitle") != null && !jsonObj.get("riskdata.basket.item[itemNr].productTitle").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].productTitle").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].quantity") != null && !jsonObj.get("riskdata.basket.item[itemNr].quantity").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].quantity").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].receiverEmail") != null && !jsonObj.get("riskdata.basket.item[itemNr].receiverEmail").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].receiverEmail").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].size") != null && !jsonObj.get("riskdata.basket.item[itemNr].size").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].size").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].sku") != null && !jsonObj.get("riskdata.basket.item[itemNr].sku").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].sku").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.basket.item[itemNr].upc") != null && !jsonObj.get("riskdata.basket.item[itemNr].upc").isJsonNull()) && !jsonObj.get("riskdata.basket.item[itemNr].upc").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.promotions.promotion[itemNr].promotionCode") != null && !jsonObj.get("riskdata.promotions.promotion[itemNr].promotionCode").isJsonNull()) && !jsonObj.get("riskdata.promotions.promotion[itemNr].promotionCode").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.promotions.promotion[itemNr].promotionDiscountAmount") != null && !jsonObj.get("riskdata.promotions.promotion[itemNr].promotionDiscountAmount").isJsonNull()) && !jsonObj.get("riskdata.promotions.promotion[itemNr].promotionDiscountAmount").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.promotions.promotion[itemNr].promotionDiscountCurrency") != null && !jsonObj.get("riskdata.promotions.promotion[itemNr].promotionDiscountCurrency").isJsonNull()) && !jsonObj.get("riskdata.promotions.promotion[itemNr].promotionDiscountCurrency").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.promotions.promotion[itemNr].promotionDiscountPercentage") != null && !jsonObj.get("riskdata.promotions.promotion[itemNr].promotionDiscountPercentage").isJsonNull()) && !jsonObj.get("riskdata.promotions.promotion[itemNr].promotionDiscountPercentage").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.promotions.promotion[itemNr].promotionName") != null && !jsonObj.get("riskdata.promotions.promotion[itemNr].promotionName").isJsonNull()) && !jsonObj.get("riskdata.promotions.promotion[itemNr].promotionName").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.riskProfileReference") != null && !jsonObj.get("riskdata.riskProfileReference").isJsonNull()) && !jsonObj.get("riskdata.riskProfileReference").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskdata.skipRisk") != null && !jsonObj.get("riskdata.skipRisk").isJsonNull()) && !jsonObj.get("riskdata.skipRisk").isJsonPrimitive()) {
