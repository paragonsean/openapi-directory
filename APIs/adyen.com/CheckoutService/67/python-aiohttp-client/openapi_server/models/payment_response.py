...
class PaymentResponse(Model):
    ...
    def __init__(self, action: PaymentResponseAction=None, additional_data: BalanceCheckResponseAdditionalData=None, amount: Amount=None, donation_token: str=None, fraud_result: FraudResult=None, merchant_reference: str=None, order: CheckoutOrderResponse=None, psp_reference: str=None, refusal_reason: str=None, refusal_reason_code: str=None, result_code: str=None, three_ds2_response_data: ThreeDS2ResponseData=None, three_ds2_result: ThreeDS2Result=None, three_ds_payment_data: str=None):
