...
class AchDetails(Model):
    ...
    def __init__(self, bank_account_number: str=None, bank_account_type: str=None, bank_location_id: str=None, encrypted_bank_account_number: str=None, encrypted_bank_location_id: str=None, owner_name: str=None, recurring_detail_reference: str=None, stored_payment_method_id: str=None, type: str='ach'):
