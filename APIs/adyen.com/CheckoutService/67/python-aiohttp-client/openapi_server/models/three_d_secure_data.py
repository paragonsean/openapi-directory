...
class ThreeDSecureData(Model):
    ...
    def __init__(self, authentication_response: str=None, cavv: str=None, cavv_algorithm: str=None, challenge_cancel: str=None, directory_response: str=None, ds_trans_id: str=None, eci: str=None, risk_score: str=None, three_ds_version: str=None, trans_status_reason: str=None, xid: str=None):
