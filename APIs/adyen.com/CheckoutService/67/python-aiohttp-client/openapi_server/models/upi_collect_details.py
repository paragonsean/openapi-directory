...
class UpiCollectDetails(Model):
    ...
    def __init__(self, billing_sequence_number: str=None, recurring_detail_reference: str=None, shopper_notification_reference: str=None, stored_payment_method_id: str=None, type: str='upi_collect', virtual_payment_address: str=None):
