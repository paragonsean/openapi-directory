...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.UtilityRequest();
  });
  ...
  describe('UtilityRequest', function() {
    it('should create an instance of UtilityRequest', function() {
      // uncomment below and update the code to test UtilityRequest
      //var instance = new AdyenCheckoutApi.UtilityRequest();
      //expect(instance).to.be.a(AdyenCheckoutApi.UtilityRequest);
    });
