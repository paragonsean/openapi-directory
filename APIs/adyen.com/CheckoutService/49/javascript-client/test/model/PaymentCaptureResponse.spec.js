...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentCaptureResponse();
  });
  ...
  describe('PaymentCaptureResponse', function() {
    it('should create an instance of PaymentCaptureResponse', function() {
      // uncomment below and update the code to test PaymentCaptureResponse
      //var instance = new AdyenCheckoutApi.PaymentCaptureResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentCaptureResponse);
    });
