...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.InstallmentsNumber();
  });
  ...
  describe('InstallmentsNumber', function() {
    it('should create an instance of InstallmentsNumber', function() {
      // uncomment below and update the code to test InstallmentsNumber
      //var instance = new AdyenCheckoutApi.InstallmentsNumber();
      //expect(instance).to.be.a(AdyenCheckoutApi.InstallmentsNumber);
    });

    it('should have the property maxNumberOfInstallments (base name: "maxNumberOfInstallments")', function() {
      // uncomment below and update the code to test the property maxNumberOfInstallments
      //var instance = new AdyenCheckoutApi.InstallmentsNumber();
