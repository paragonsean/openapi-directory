...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.WeChatPayDetails();
  });
  ...
  describe('WeChatPayDetails', function() {
    it('should create an instance of WeChatPayDetails', function() {
      // uncomment below and update the code to test WeChatPayDetails
      //var instance = new AdyenCheckoutApi.WeChatPayDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.WeChatPayDetails);
    });
