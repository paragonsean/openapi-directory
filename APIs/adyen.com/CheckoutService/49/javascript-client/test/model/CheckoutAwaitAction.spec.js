...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CheckoutAwaitAction();
  });
  ...
  describe('CheckoutAwaitAction', function() {
    it('should create an instance of CheckoutAwaitAction', function() {
      // uncomment below and update the code to test CheckoutAwaitAction
      //var instance = new AdyenCheckoutApi.CheckoutAwaitAction();
      //expect(instance).to.be.a(AdyenCheckoutApi.CheckoutAwaitAction);
    });
