...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentCancelRequest();
  });
  ...
  describe('PaymentCancelRequest', function() {
    it('should create an instance of PaymentCancelRequest', function() {
      // uncomment below and update the code to test PaymentCancelRequest
      //var instance = new AdyenCheckoutApi.PaymentCancelRequest();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentCancelRequest);
    });
