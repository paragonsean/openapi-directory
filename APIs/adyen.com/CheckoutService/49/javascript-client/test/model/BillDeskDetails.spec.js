...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.BillDeskDetails();
  });
  ...
  describe('BillDeskDetails', function() {
    it('should create an instance of BillDeskDetails', function() {
      // uncomment below and update the code to test BillDeskDetails
      //var instance = new AdyenCheckoutApi.BillDeskDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.BillDeskDetails);
    });
