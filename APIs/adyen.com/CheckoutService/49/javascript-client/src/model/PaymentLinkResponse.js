...
class PaymentLinkResponse {
     ...
     * @param status {module:model/PaymentLinkResponse.StatusEnum} Status of the payment link. Possible values: * **active**: The link can be used to make payments. * **expired**: The expiry date for the payment link has passed. Shoppers can no longer use the link to make payments. * **paid**: The shopper completed the payment.
     * @param url {String} The URL at which the shopper can complete the payment.
     */
    constructor(amount, merchantAccount, reference, status, url) { 
        
        PaymentLinkResponse.initialize(this, amount, merchantAccount, reference, status, url);
    }
     ...
     */
    static initialize(obj, amount, merchantAccount, reference, status, url) { 
        obj['amount'] = amount;
...
PaymentLinkResponse.RequiredProperties = ["amount", "merchantAccount", "reference", "status", "url"];
