...
class DonationPaymentRequestPaymentMethod(Model):
    ...
    def __init__(self, apple_pay_token: str=None, funding_source: str=None, recurring_detail_reference: str=None, stored_payment_method_id: str=None, type: str='applepay', brand: str=None, cupsecureplus_smscode: str=None, cvc: str=None, encrypted_card_number: str=None, encrypted_expiry_month: str=None, encrypted_expiry_year: str=None, encrypted_security_code: str=None, expiry_month: str=None, expiry_year: str=None, holder_name: str=None, network_payment_reference: str=None, number: str=None, shopper_notification_reference: str=None, three_ds2_sdk_version: str=None, google_pay_card_network: str=None, google_pay_token: str=None, issuer: str=None):
        ...
        :param stored_payment_method_id: The stored_payment_method_id of this DonationPaymentRequestPaymentMethod.
    ...
    def stored_payment_method_id(self):
        """Gets the stored_payment_method_id of this DonationPaymentRequestPaymentMethod.

        This is the `recurringDetailReference` returned in the response when you created the token.

        :return: The stored_payment_method_id of this DonationPaymentRequestPaymentMethod.
        :rtype: str
        """
    ...
    def stored_payment_method_id(self, stored_payment_method_id):
        """Sets the stored_payment_method_id of this DonationPaymentRequestPaymentMethod.
