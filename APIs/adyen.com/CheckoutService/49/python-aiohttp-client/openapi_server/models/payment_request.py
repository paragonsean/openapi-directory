...
class PaymentRequest(Model):
    ...
    def __init__(self, account_info: AccountInfo=None, additional_amount: Amount=None, additional_data: BalanceCheckRequestAdditionalData=None, amount: Amount=None, application_info: ApplicationInfo=None, billing_address: BillingAddress=None, browser_info: BrowserInfo=None, capture_delay_hours: int=None, channel: str=None, company: Company=None, conversion_id: str=None, country_code: str=None, date_of_birth: datetime=None, dcc_quote: ForexQuote=None, delivery_address: DeliveryAddress=None, delivery_date: datetime=None, device_fingerprint: str=None, enable_one_click: bool=None, enable_pay_out: bool=None, enable_recurring: bool=None, entity_type: str=None, fraud_offset: int=None, fund_origin: FundOrigin=None, fund_recipient: FundRecipient=None, installments: Installments=None, line_items: List[LineItem]=None, mandate: Mandate=None, mcc: str=None, merchant_account: str=None, merchant_order_reference: str=None, merchant_risk_indicator: MerchantRiskIndicator=None, metadata: Dict[str, str]=None, mpi_data: ThreeDSecureData=None, order: EncryptedOrderData=None, order_reference: str=None, origin: str=None, payment_method: PaymentRequestPaymentMethod=None, recurring_expiry: str=None, recurring_frequency: str=None, recurring_processing_model: str=None, redirect_from_issuer_method: str=None, redirect_to_issuer_method: str=None, reference: str=None, return_url: str=None, risk_data: RiskData=None, session_validity: str=None, shopper_email: str=None, shopper_ip: str=None, shopper_interaction: str=None, shopper_locale: str=None, shopper_name: Name=None, shopper_reference: str=None, shopper_statement: str=None, social_security_number: str=None, splits: List[Split]=None, store: str=None, store_payment_method: bool=None, telephone_number: str=None, three_ds2_request_data: ThreeDS2RequestFields=None, trusted_shopper: bool=None):
        ...
        :param channel: The channel of this PaymentRequest.
        :param company: The company of this PaymentRequest.
        :param conversion_id: The conversion_id of this PaymentRequest.
        ...
        :param enable_one_click: The enable_one_click of this PaymentRequest.
        :param enable_pay_out: The enable_pay_out of this PaymentRequest.
        :param enable_recurring: The enable_recurring of this PaymentRequest.
        :param entity_type: The entity_type of this PaymentRequest.
        :param fraud_offset: The fraud_offset of this PaymentRequest.
        :param fund_origin: The fund_origin of this PaymentRequest.
        :param fund_recipient: The fund_recipient of this PaymentRequest.
        ...
        :param order: The order of this PaymentRequest.
        :param order_reference: The order_reference of this PaymentRequest.
        :param origin: The origin of this PaymentRequest.
        :param payment_method: The payment_method of this PaymentRequest.
        :param recurring_expiry: The recurring_expiry of this PaymentRequest.
        :param recurring_frequency: The recurring_frequency of this PaymentRequest.
        :param recurring_processing_model: The recurring_processing_model of this PaymentRequest.
        :param redirect_from_issuer_method: The redirect_from_issuer_method of this PaymentRequest.
        :param redirect_to_issuer_method: The redirect_to_issuer_method of this PaymentRequest.
        :param reference: The reference of this PaymentRequest.
        :param return_url: The return_url of this PaymentRequest.
        :param risk_data: The risk_data of this PaymentRequest.
        :param session_validity: The session_validity of this PaymentRequest.
        ...
        :param store_payment_method: The store_payment_method of this PaymentRequest.
    ...
    @property
    def channel(self):
        """Gets the channel of this PaymentRequest.

        The platform where a payment transaction takes place. This field is optional for filtering out payment methods that are only available on specific platforms. If this value is not set, then we will try to infer it from the `sdkVersion` or `token`.  Possible values: * iOS * Android * Web

        :return: The channel of this PaymentRequest.
        :rtype: str
        """
    ...
    @property
    def company(self):
        """Gets the company of this PaymentRequest.

        Information regarding the company.

        :return: The company of this PaymentRequest.
        :rtype: Company
        """
    ...
    def company(self, company):
        """Sets the company of this PaymentRequest.
    ...
    def conversion_id(self, conversion_id):
        """Sets the conversion_id of this PaymentRequest.
    ...
    def enable_one_click(self):
        """Gets the enable_one_click of this PaymentRequest.

        When true and `shopperReference` is provided, the shopper will be asked if the payment details should be stored for future one-click payments.

        :return: The enable_one_click of this PaymentRequest.
        :rtype: bool
        """
    ...
    def enable_one_click(self, enable_one_click):
        """Sets the enable_one_click of this PaymentRequest.
    ...
    def enable_pay_out(self):
        """Gets the enable_pay_out of this PaymentRequest.

        When true and `shopperReference` is provided, the payment details will be tokenized for payouts.

        :return: The enable_pay_out of this PaymentRequest.
        :rtype: bool
        """
    ...
    def enable_pay_out(self, enable_pay_out):
        """Sets the enable_pay_out of this PaymentRequest.
    ...
    def enable_recurring(self):
        """Gets the enable_recurring of this PaymentRequest.

        When true and `shopperReference` is provided, the payment details will be tokenized for recurring payments.

        :return: The enable_recurring of this PaymentRequest.
        :rtype: bool
        """
    ...
    def enable_recurring(self, enable_recurring):
        """Sets the enable_recurring of this PaymentRequest.
    ...
    def fund_origin(self):
        """Gets the fund_origin of this PaymentRequest.

        The person or entity funding the money.

        :return: The fund_origin of this PaymentRequest.
        :rtype: FundOrigin
        """
    ...
    def fund_origin(self, fund_origin):
        """Sets the fund_origin of this PaymentRequest.
    ...
    def fund_recipient(self):
        """Gets the fund_recipient of this PaymentRequest.

        the person or entity receiving the money

        :return: The fund_recipient of this PaymentRequest.
        :rtype: FundRecipient
        """
    ...
    def fund_recipient(self, fund_recipient):
        """Sets the fund_recipient of this PaymentRequest.
    ...
    @property
    def order(self):
        """Gets the order of this PaymentRequest.

        The order information required for partial payments.

        :return: The order of this PaymentRequest.
    ...
    @property
    def origin(self):
        """Gets the origin of this PaymentRequest.
        ...
        :return: The origin of this PaymentRequest.
        :rtype: str
        """
        return self._origin
    ...
    def origin(self, origin):
        """Sets the origin of this PaymentRequest.
    ...
    def payment_method(self):
        ...
        :rtype: PaymentRequestPaymentMethod
        """
    ...
    def payment_method(self, payment_method):
        ...
        :param payment_method: The payment_method of this PaymentRequest.
        :type payment_method: PaymentRequestPaymentMethod
        """
    ...
    def recurring_expiry(self):
        """Gets the recurring_expiry of this PaymentRequest.

        Date after which no further authorisations shall be performed. Only for 3D Secure 2.

        :return: The recurring_expiry of this PaymentRequest.
        :rtype: str
        """
    ...
    def recurring_expiry(self, recurring_expiry):
        """Sets the recurring_expiry of this PaymentRequest.
    ...
    def recurring_frequency(self):
        """Gets the recurring_frequency of this PaymentRequest.

        Minimum number of days between authorisations. Only for 3D Secure 2.

        :return: The recurring_frequency of this PaymentRequest.
        :rtype: str
        """
    ...
    def recurring_frequency(self, recurring_frequency):
        """Sets the recurring_frequency of this PaymentRequest.
    ...
    def redirect_from_issuer_method(self):
        """Gets the redirect_from_issuer_method of this PaymentRequest.

        Specifies the redirect method (GET or POST) when redirecting back from the issuer.

        :return: The redirect_from_issuer_method of this PaymentRequest.
        :rtype: str
        """
    ...
    def redirect_from_issuer_method(self, redirect_from_issuer_method):
        """Sets the redirect_from_issuer_method of this PaymentRequest.
    ...
    def redirect_to_issuer_method(self):
        """Gets the redirect_to_issuer_method of this PaymentRequest.

        Specifies the redirect method (GET or POST) when redirecting to the issuer.

        :return: The redirect_to_issuer_method of this PaymentRequest.
        :rtype: str
        """
    ...
    def redirect_to_issuer_method(self, redirect_to_issuer_method):
        """Sets the redirect_to_issuer_method of this PaymentRequest.
    ...
    @property
    def risk_data(self):
        """Gets the risk_data of this PaymentRequest.

        Contains risk data, such as client-side data, used to identify risk for a transaction.

        :return: The risk_data of this PaymentRequest.
        :rtype: RiskData
        """
    ...
    def risk_data(self, risk_data):
        """Sets the risk_data of this PaymentRequest.
    ...
    def session_validity(self):
        """Gets the session_validity of this PaymentRequest.
        ...
        :return: The session_validity of this PaymentRequest.
        :rtype: str
        """
    ...
    def session_validity(self, session_validity):
        """Sets the session_validity of this PaymentRequest.
    ...
    def store(self, store):
        ...
        :type store: str
        """
        if store is not None and len(store) > 64:
            raise ValueError("Invalid value for `store`, length must be less than or equal to `64`")
    ...
    def store_payment_method(self):
        """Gets the store_payment_method of this PaymentRequest.

        When true and `shopperReference` is provided, the payment details will be stored.

        :return: The store_payment_method of this PaymentRequest.
        :rtype: bool
        """
    ...
    def store_payment_method(self, store_payment_method):
        """Sets the store_payment_method of this PaymentRequest.
