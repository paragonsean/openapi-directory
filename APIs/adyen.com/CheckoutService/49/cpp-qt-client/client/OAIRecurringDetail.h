...
public:
    ...
    OAIStoredDetails getStoredDetails() const;
    void setStoredDetails(const OAIStoredDetails &stored_details);
    bool is_stored_details_Set() const;
    bool is_stored_details_Valid() const;
...
private:
    ...
    OAIStoredDetails m_stored_details;
    bool m_stored_details_isSet;
    bool m_stored_details_isValid;
