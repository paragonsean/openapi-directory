...
/*
 * OAIStoredPaymentMethodDetails.h
 *
 * 
 */

#ifndef OAIStoredPaymentMethodDetails_H
#define OAIStoredPaymentMethodDetails_H
...
class OAIStoredPaymentMethodDetails : public OAIObject {
public:
    OAIStoredPaymentMethodDetails();
    OAIStoredPaymentMethodDetails(QString json);
    ~OAIStoredPaymentMethodDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoredPaymentMethodDetails)

#endif // OAIStoredPaymentMethodDetails_H
