...
#ifndef OAIDotpayDetails_H
#define OAIDotpayDetails_H
...
class OAIDotpayDetails : public OAIObject {
public:
    OAIDotpayDetails();
    OAIDotpayDetails(QString json);
    ~OAIDotpayDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDotpayDetails)

#endif // OAIDotpayDetails_H
