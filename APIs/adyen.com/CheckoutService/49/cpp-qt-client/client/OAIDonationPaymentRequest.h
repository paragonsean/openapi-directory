...
/*
 * OAIDonationPaymentRequest.h
 *
 * 
 */

#ifndef OAIDonationPaymentRequest_H
#define OAIDonationPaymentRequest_H
...
class OAIDonationPaymentRequest_paymentMethod;
class OAIRiskData;
class OAIName;
class OAISplit;
class OAIThreeDS2RequestFields;

class OAIDonationPaymentRequest : public OAIObject {
public:
    OAIDonationPaymentRequest();
    OAIDonationPaymentRequest(QString json);
    ~OAIDonationPaymentRequest() override;
    ...
    QString getDonationOriginalPspReference() const;
    void setDonationOriginalPspReference(const QString &donation_original_psp_reference);
    bool is_donation_original_psp_reference_Set() const;
    bool is_donation_original_psp_reference_Valid() const;
    ...
    OAIDonationPaymentRequest_paymentMethod getPaymentMethod() const;
    void setPaymentMethod(const OAIDonationPaymentRequest_paymentMethod &payment_method);
...
private:
    ...
    QString m_donation_original_psp_reference;
    bool m_donation_original_psp_reference_isSet;
    bool m_donation_original_psp_reference_isValid;
    ...
    OAIDonationPaymentRequest_paymentMethod m_payment_method;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDonationPaymentRequest)

#endif // OAIDonationPaymentRequest_H
