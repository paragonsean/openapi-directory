...
/*
 * OAIPaymentReversalRequest.h
 *
 * 
 */

#ifndef OAIPaymentReversalRequest_H
#define OAIPaymentReversalRequest_H
...
class OAIPaymentReversalRequest : public OAIObject {
public:
    OAIPaymentReversalRequest();
    OAIPaymentReversalRequest(QString json);
    ~OAIPaymentReversalRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentReversalRequest)

#endif // OAIPaymentReversalRequest_H
