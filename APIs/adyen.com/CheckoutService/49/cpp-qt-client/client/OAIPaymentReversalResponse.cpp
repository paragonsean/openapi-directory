...
OAIPaymentReversalResponse::OAIPaymentReversalResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentReversalResponse::OAIPaymentReversalResponse() {
    this->initializeModel();
}

OAIPaymentReversalResponse::~OAIPaymentReversalResponse() {}

void OAIPaymentReversalResponse::initializeModel() {
...
void OAIPaymentReversalResponse::fromJson(QString jsonString) {
...
void OAIPaymentReversalResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentReversalResponse::asJson() const {
...
QJsonObject OAIPaymentReversalResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPaymentReversalResponse::getMerchantAccount() const {
    return m_merchant_account;
}
void OAIPaymentReversalResponse::setMerchantAccount(const QString &merchant_account) {
    m_merchant_account = merchant_account;
    m_merchant_account_isSet = true;
}

bool OAIPaymentReversalResponse::is_merchant_account_Set() const{
    return m_merchant_account_isSet;
}

bool OAIPaymentReversalResponse::is_merchant_account_Valid() const{
    return m_merchant_account_isValid;
}

QString OAIPaymentReversalResponse::getPaymentPspReference() const {
    return m_payment_psp_reference;
}
void OAIPaymentReversalResponse::setPaymentPspReference(const QString &payment_psp_reference) {
    m_payment_psp_reference = payment_psp_reference;
    m_payment_psp_reference_isSet = true;
}

bool OAIPaymentReversalResponse::is_payment_psp_reference_Set() const{
    return m_payment_psp_reference_isSet;
}

bool OAIPaymentReversalResponse::is_payment_psp_reference_Valid() const{
    return m_payment_psp_reference_isValid;
}

QString OAIPaymentReversalResponse::getPspReference() const {
    return m_psp_reference;
}
void OAIPaymentReversalResponse::setPspReference(const QString &psp_reference) {
    m_psp_reference = psp_reference;
    m_psp_reference_isSet = true;
}

bool OAIPaymentReversalResponse::is_psp_reference_Set() const{
    return m_psp_reference_isSet;
}

bool OAIPaymentReversalResponse::is_psp_reference_Valid() const{
    return m_psp_reference_isValid;
}

QString OAIPaymentReversalResponse::getReference() const {
    return m_reference;
}
void OAIPaymentReversalResponse::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAIPaymentReversalResponse::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAIPaymentReversalResponse::is_reference_Valid() const{
    return m_reference_isValid;
}

QString OAIPaymentReversalResponse::getStatus() const {
    return m_status;
}
void OAIPaymentReversalResponse::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPaymentReversalResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPaymentReversalResponse::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPaymentReversalResponse::isSet() const {
...
bool OAIPaymentReversalResponse::isValid() const {
