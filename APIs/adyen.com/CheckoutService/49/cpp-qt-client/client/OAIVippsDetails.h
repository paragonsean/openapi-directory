...
#ifndef OAIVippsDetails_H
#define OAIVippsDetails_H
...
class OAIVippsDetails : public OAIObject {
public:
    OAIVippsDetails();
    OAIVippsDetails(QString json);
    ~OAIVippsDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVippsDetails)

#endif // OAIVippsDetails_H
