...
/**
 * Model tests for VisaCheckoutDetails
 */
public class VisaCheckoutDetailsTest {
    private final VisaCheckoutDetails model = new VisaCheckoutDetails();
