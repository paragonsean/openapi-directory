...
public class PaymentResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(action, additionalData, amount, authentication, details, fraudResult, merchantReference, order, outputDetails, paymentData, pspReference, redirect, refusalReason, refusalReasonCode, resultCode, threeDS2Result);
  }
