...
public class ApiClient {
    ...
    private String basePath = "https://checkout-test.adyen.com/v64";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://checkout-test.adyen.com/v64",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/64/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://checkout-test.adyen.com/v64
