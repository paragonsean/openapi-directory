...
class PaymentVerificationResponse(Model):
    ...
    def __init__(self, additional_data: BalanceCheckResponseAdditionalData=None, fraud_result: FraudResult=None, merchant_reference: str=None, order: CheckoutOrderResponse=None, payment_method: str=None, psp_reference: str=None, refusal_reason: str=None, refusal_reason_code: str=None, result_code: str=None, service_error: ServiceErrorDetails=None, shopper_locale: str=None):
