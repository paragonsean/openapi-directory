...
class PaymentResponse(Model):
    ...
    def __init__(self, action: PaymentResponseAction=None, additional_data: BalanceCheckResponseAdditionalData=None, amount: Amount=None, authentication: Dict[str, str]=None, details: List[InputDetail]=None, fraud_result: FraudResult=None, merchant_reference: str=None, order: CheckoutOrderResponse=None, output_details: Dict[str, str]=None, payment_data: str=None, psp_reference: str=None, redirect: Redirect=None, refusal_reason: str=None, refusal_reason_code: str=None, result_code: str=None, three_ds2_result: ThreeDS2Result=None):
