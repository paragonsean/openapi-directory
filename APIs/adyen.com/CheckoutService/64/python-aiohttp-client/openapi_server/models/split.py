...
class Split(Model):
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["AcquiringFees", "AdyenCommission", "AdyenFees", "AdyenMarkup", "BalanceAccount", "Commission", "Default", "Interchange", "MarketPlace", "PaymentFee", "Remainder", "SchemeFee", "Surcharge", "Tip", "VAT"]  # noqa: E501
