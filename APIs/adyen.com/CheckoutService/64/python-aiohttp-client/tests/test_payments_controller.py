...
async def test_post_payment_methods(client):
    ...
    """
    body = {"amount":{"currency":"currency","value":0},"splitCardFundingSources":False,"channel":"iOS","store":"store","allowedPaymentMethods":["allowedPaymentMethods","allowedPaymentMethods"],"enableRealTimeUpdate":True,"merchantAccount":"merchantAccount","countryCode":"countryCode","additionalData":{"challengeWindowSize":"01","mpiImplementationType":"mpiImplementationType","allow3DS2":"allow3DS2","executeThreeD":"executeThreeD","threeDSVersion":"threeDSVersion","scaExemption":"scaExemption"},"blockedPaymentMethods":["blockedPaymentMethods","blockedPaymentMethods"],"shopperLocale":"shopperLocale","order":{"orderData":"orderData","pspReference":"pspReference"},"shopperReference":"shopperReference"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'idempotency_key': '37ca9c97-d1d1-4c62-89e8-706891a563ed',
