...
class DeliveryAddress {
    ...
    constructor(city, country, houseNumberOrName, postalCode, street) { 
        ...
        DeliveryAddress.initialize(this, city, country, houseNumberOrName, postalCode, street);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeliveryAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeliveryAddress</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeliveryAddress.RequiredProperties) {
...
DeliveryAddress.RequiredProperties = ["city", "country", "houseNumberOrName", "postalCode", "street"];

/**
 * The name of the city. Maximum length: 3000 characters.
 * @member {String} city
 */
DeliveryAddress.prototype['city'] = undefined;

/**
 * The two-character ISO-3166-1 alpha-2 country code. For example, **US**. > If you don't know the country or are not collecting the country from the shopper, provide `country` as `ZZ`.
 * @member {String} country
 */
DeliveryAddress.prototype['country'] = undefined;

/**
 * @member {String} firstName
 */
DeliveryAddress.prototype['firstName'] = undefined;

/**
 * The number or name of the house. Maximum length: 3000 characters.
 * @member {String} houseNumberOrName
 */
DeliveryAddress.prototype['houseNumberOrName'] = undefined;

/**
 * @member {String} lastName
 */
DeliveryAddress.prototype['lastName'] = undefined;

/**
 * A maximum of five digits for an address in the US, or a maximum of ten characters for an address in all other countries.
 * @member {String} postalCode
 */
DeliveryAddress.prototype['postalCode'] = undefined;
 ...
 */
DeliveryAddress.prototype['stateOrProvince'] = undefined;

/**
 * The name of the street. Maximum length: 3000 characters. > The house number should not be included in this field; it should be separately provided via `houseNumberOrName`.
 * @member {String} street
 */
DeliveryAddress.prototype['street'] = undefined;
