...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://checkout-test.adyen.com/v64') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://checkout-test.adyen.com/v64
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/64/Javascript'
        };
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://checkout-test.adyen.com/v64",
