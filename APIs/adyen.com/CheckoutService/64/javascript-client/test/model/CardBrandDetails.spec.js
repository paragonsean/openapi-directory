...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CardBrandDetails();
  });
  ...
  describe('CardBrandDetails', function() {
    it('should create an instance of CardBrandDetails', function() {
      // uncomment below and update the code to test CardBrandDetails
      //var instance = new AdyenCheckoutApi.CardBrandDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.CardBrandDetails);
    });
