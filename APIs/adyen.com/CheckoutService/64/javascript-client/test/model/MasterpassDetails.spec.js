...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.MasterpassDetails();
  });
  ...
  describe('MasterpassDetails', function() {
    it('should create an instance of MasterpassDetails', function() {
      // uncomment below and update the code to test MasterpassDetails
      //var instance = new AdyenCheckoutApi.MasterpassDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.MasterpassDetails);
    });
