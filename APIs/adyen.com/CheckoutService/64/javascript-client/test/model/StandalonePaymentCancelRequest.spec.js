...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.StandalonePaymentCancelRequest();
  });
  ...
  describe('StandalonePaymentCancelRequest', function() {
    it('should create an instance of StandalonePaymentCancelRequest', function() {
      // uncomment below and update the code to test StandalonePaymentCancelRequest
      //var instance = new AdyenCheckoutApi.StandalonePaymentCancelRequest();
      //expect(instance).to.be.a(AdyenCheckoutApi.StandalonePaymentCancelRequest);
    });
