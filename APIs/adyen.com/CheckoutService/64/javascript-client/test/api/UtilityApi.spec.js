...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.UtilityApi();
  });
  ...
  describe('UtilityApi', function() {
    describe('postApplePaySessions', function() {
      it('should call postApplePaySessions successfully', function(done) {
        //uncomment below and update the code to test postApplePaySessions
        //instance.postApplePaySessions(function(error) {
    ...
    describe('postOriginKeys', function() {
      it('should call postOriginKeys successfully', function(done) {
        //uncomment below and update the code to test postOriginKeys
        //instance.postOriginKeys(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
