...
/*
 * OAIBillDeskDetails.h
 *
 * 
 */

#ifndef OAIBillDeskDetails_H
#define OAIBillDeskDetails_H
...
class OAIBillDeskDetails : public OAIObject {
public:
    OAIBillDeskDetails();
    OAIBillDeskDetails(QString json);
    ~OAIBillDeskDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBillDeskDetails)

#endif // OAIBillDeskDetails_H
