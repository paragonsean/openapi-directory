...
/*
 * OAIPaymentMethodsGroup.h
 *
 * 
 */

#ifndef OAIPaymentMethodsGroup_H
#define OAIPaymentMethodsGroup_H
...
class OAIPaymentMethodsGroup : public OAIObject {
public:
    OAIPaymentMethodsGroup();
    OAIPaymentMethodsGroup(QString json);
    ~OAIPaymentMethodsGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentMethodsGroup)

#endif // OAIPaymentMethodsGroup_H
