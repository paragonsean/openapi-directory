...
#ifndef OAIGiropayDetails_H
#define OAIGiropayDetails_H
...
class OAIGiropayDetails : public OAIObject {
public:
    OAIGiropayDetails();
    OAIGiropayDetails(QString json);
    ~OAIGiropayDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGiropayDetails)

#endif // OAIGiropayDetails_H
