...
QString OAIKlarnaDetails::getStoredPaymentMethodId() const {
    return m_stored_payment_method_id;
}
void OAIKlarnaDetails::setStoredPaymentMethodId(const QString &stored_payment_method_id) {
    m_stored_payment_method_id = stored_payment_method_id;
    m_stored_payment_method_id_isSet = true;
}

bool OAIKlarnaDetails::is_stored_payment_method_id_Set() const{
    return m_stored_payment_method_id_isSet;
}

bool OAIKlarnaDetails::is_stored_payment_method_id_Valid() const{
