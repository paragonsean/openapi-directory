...
/*
 * OAIStandalonePaymentCancelRequest.h
 *
 * 
 */

#ifndef OAIStandalonePaymentCancelRequest_H
#define OAIStandalonePaymentCancelRequest_H
...
class OAIStandalonePaymentCancelRequest : public OAIObject {
public:
    OAIStandalonePaymentCancelRequest();
    OAIStandalonePaymentCancelRequest(QString json);
    ~OAIStandalonePaymentCancelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStandalonePaymentCancelRequest)

#endif // OAIStandalonePaymentCancelRequest_H
