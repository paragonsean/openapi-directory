...
#ifndef OAIMerchantDevice_H
#define OAIMerchantDevice_H
...
class OAIMerchantDevice : public OAIObject {
public:
    OAIMerchantDevice();
    OAIMerchantDevice(QString json);
    ~OAIMerchantDevice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchantDevice)

#endif // OAIMerchantDevice_H
