...
public:
    ...
    Q_DECL_DEPRECATED QMap<QString, QString> getAuthentication() const;
    Q_DECL_DEPRECATED void setAuthentication(const QMap<QString, QString> &authentication);
    Q_DECL_DEPRECATED bool is_authentication_Set() const;
    Q_DECL_DEPRECATED bool is_authentication_Valid() const;
    ...
    Q_DECL_DEPRECATED QMap<QString, QString> getOutputDetails() const;
    Q_DECL_DEPRECATED void setOutputDetails(const QMap<QString, QString> &output_details);
    Q_DECL_DEPRECATED bool is_output_details_Set() const;
    Q_DECL_DEPRECATED bool is_output_details_Valid() const;

    Q_DECL_DEPRECATED QString getPaymentData() const;
    Q_DECL_DEPRECATED void setPaymentData(const QString &payment_data);
    Q_DECL_DEPRECATED bool is_payment_data_Set() const;
    Q_DECL_DEPRECATED bool is_payment_data_Valid() const;
    ...
    Q_DECL_DEPRECATED OAIRedirect getRedirect() const;
    Q_DECL_DEPRECATED void setRedirect(const OAIRedirect &redirect);
    Q_DECL_DEPRECATED bool is_redirect_Set() const;
    Q_DECL_DEPRECATED bool is_redirect_Valid() const;
