...
public:
    ...
    void setAddressEditable(const bool &address_editable);
    bool is_address_editable_Set() const;
    bool is_address_editable_Valid() const;
...
private:
    ...
    bool m_address_editable;
    bool m_address_editable_isSet;
    bool m_address_editable_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAvs)
