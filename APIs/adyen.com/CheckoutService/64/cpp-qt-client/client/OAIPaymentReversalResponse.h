...
/*
 * OAIPaymentReversalResponse.h
 *
 * 
 */

#ifndef OAIPaymentReversalResponse_H
#define OAIPaymentReversalResponse_H
...
class OAIPaymentReversalResponse : public OAIObject {
public:
    OAIPaymentReversalResponse();
    OAIPaymentReversalResponse(QString json);
    ~OAIPaymentReversalResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentReversalResponse)

#endif // OAIPaymentReversalResponse_H
