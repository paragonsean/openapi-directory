...
/*
 * OAIUpiCollectDetails.h
 *
 * 
 */

#ifndef OAIUpiCollectDetails_H
#define OAIUpiCollectDetails_H
...
class OAIUpiCollectDetails : public OAIObject {
public:
    OAIUpiCollectDetails();
    OAIUpiCollectDetails(QString json);
    ~OAIUpiCollectDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpiCollectDetails)

#endif // OAIUpiCollectDetails_H
