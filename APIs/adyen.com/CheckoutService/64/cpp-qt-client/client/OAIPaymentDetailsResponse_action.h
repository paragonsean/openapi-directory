...
/*
 * OAIPaymentDetailsResponse_action.h
 *
 * Action to be taken for completing the payment. When returned, only the 3D Secure action is needed in most cases.
 */

#ifndef OAIPaymentDetailsResponse_action_H
#define OAIPaymentDetailsResponse_action_H
...
class OAIPaymentDetailsResponse_action : public OAIObject {
public:
    OAIPaymentDetailsResponse_action();
    OAIPaymentDetailsResponse_action(QString json);
    ~OAIPaymentDetailsResponse_action() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentDetailsResponse_action)

#endif // OAIPaymentDetailsResponse_action_H
