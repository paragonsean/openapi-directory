...
QString OAICardDetails::getBrand() const {
    return m_brand;
}
void OAICardDetails::setBrand(const QString &brand) {
    m_brand = brand;
    m_brand_isSet = true;
}

bool OAICardDetails::is_brand_Set() const{
    return m_brand_isSet;
}

bool OAICardDetails::is_brand_Valid() const{
    return m_brand_isValid;
}

QString OAICardDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAICardDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAICardDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAICardDetails::is_checkout_attempt_id_Valid() const{
    return m_checkout_attempt_id_isValid;
}

QString OAICardDetails::getCupsecureplusSmscode() const {
    return m_cupsecureplus_smscode;
}
void OAICardDetails::setCupsecureplusSmscode(const QString &cupsecureplus_smscode) {
    m_cupsecureplus_smscode = cupsecureplus_smscode;
    m_cupsecureplus_smscode_isSet = true;
}

bool OAICardDetails::is_cupsecureplus_smscode_Set() const{
    return m_cupsecureplus_smscode_isSet;
}

bool OAICardDetails::is_cupsecureplus_smscode_Valid() const{
    return m_cupsecureplus_smscode_isValid;
}

QString OAICardDetails::getCvc() const {
    return m_cvc;
}
void OAICardDetails::setCvc(const QString &cvc) {
    m_cvc = cvc;
    m_cvc_isSet = true;
}

bool OAICardDetails::is_cvc_Set() const{
    return m_cvc_isSet;
}

bool OAICardDetails::is_cvc_Valid() const{
    return m_cvc_isValid;
}

QString OAICardDetails::getEncryptedCardNumber() const {
    return m_encrypted_card_number;
}
void OAICardDetails::setEncryptedCardNumber(const QString &encrypted_card_number) {
    m_encrypted_card_number = encrypted_card_number;
    m_encrypted_card_number_isSet = true;
}

bool OAICardDetails::is_encrypted_card_number_Set() const{
    return m_encrypted_card_number_isSet;
}

bool OAICardDetails::is_encrypted_card_number_Valid() const{
    return m_encrypted_card_number_isValid;
}

QString OAICardDetails::getEncryptedExpiryMonth() const {
    return m_encrypted_expiry_month;
}
void OAICardDetails::setEncryptedExpiryMonth(const QString &encrypted_expiry_month) {
    m_encrypted_expiry_month = encrypted_expiry_month;
    m_encrypted_expiry_month_isSet = true;
}

bool OAICardDetails::is_encrypted_expiry_month_Set() const{
    return m_encrypted_expiry_month_isSet;
}

bool OAICardDetails::is_encrypted_expiry_month_Valid() const{
    return m_encrypted_expiry_month_isValid;
}

QString OAICardDetails::getEncryptedExpiryYear() const {
    return m_encrypted_expiry_year;
}
void OAICardDetails::setEncryptedExpiryYear(const QString &encrypted_expiry_year) {
    m_encrypted_expiry_year = encrypted_expiry_year;
    m_encrypted_expiry_year_isSet = true;
}

bool OAICardDetails::is_encrypted_expiry_year_Set() const{
    return m_encrypted_expiry_year_isSet;
}

bool OAICardDetails::is_encrypted_expiry_year_Valid() const{
    return m_encrypted_expiry_year_isValid;
}

QString OAICardDetails::getEncryptedSecurityCode() const {
    return m_encrypted_security_code;
}
void OAICardDetails::setEncryptedSecurityCode(const QString &encrypted_security_code) {
    m_encrypted_security_code = encrypted_security_code;
    m_encrypted_security_code_isSet = true;
}

bool OAICardDetails::is_encrypted_security_code_Set() const{
    return m_encrypted_security_code_isSet;
}

bool OAICardDetails::is_encrypted_security_code_Valid() const{
    return m_encrypted_security_code_isValid;
}

QString OAICardDetails::getExpiryMonth() const {
    return m_expiry_month;
}
void OAICardDetails::setExpiryMonth(const QString &expiry_month) {
    m_expiry_month = expiry_month;
    m_expiry_month_isSet = true;
}

bool OAICardDetails::is_expiry_month_Set() const{
    return m_expiry_month_isSet;
}

bool OAICardDetails::is_expiry_month_Valid() const{
    return m_expiry_month_isValid;
}

QString OAICardDetails::getExpiryYear() const {
    return m_expiry_year;
}
void OAICardDetails::setExpiryYear(const QString &expiry_year) {
    m_expiry_year = expiry_year;
    m_expiry_year_isSet = true;
}

bool OAICardDetails::is_expiry_year_Set() const{
    return m_expiry_year_isSet;
}

bool OAICardDetails::is_expiry_year_Valid() const{
    return m_expiry_year_isValid;
}

QString OAICardDetails::getFundingSource() const {
    return m_funding_source;
}
void OAICardDetails::setFundingSource(const QString &funding_source) {
    m_funding_source = funding_source;
    m_funding_source_isSet = true;
}

bool OAICardDetails::is_funding_source_Set() const{
    return m_funding_source_isSet;
}

bool OAICardDetails::is_funding_source_Valid() const{
    return m_funding_source_isValid;
}

QString OAICardDetails::getHolderName() const {
    return m_holder_name;
}
void OAICardDetails::setHolderName(const QString &holder_name) {
    m_holder_name = holder_name;
    m_holder_name_isSet = true;
}

bool OAICardDetails::is_holder_name_Set() const{
    return m_holder_name_isSet;
}

bool OAICardDetails::is_holder_name_Valid() const{
    return m_holder_name_isValid;
}

QString OAICardDetails::getNetworkPaymentReference() const {
    return m_network_payment_reference;
}
void OAICardDetails::setNetworkPaymentReference(const QString &network_payment_reference) {
    m_network_payment_reference = network_payment_reference;
    m_network_payment_reference_isSet = true;
}

bool OAICardDetails::is_network_payment_reference_Set() const{
    return m_network_payment_reference_isSet;
}

bool OAICardDetails::is_network_payment_reference_Valid() const{
    return m_network_payment_reference_isValid;
}

QString OAICardDetails::getNumber() const {
    return m_number;
}
void OAICardDetails::setNumber(const QString &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAICardDetails::is_number_Set() const{
    return m_number_isSet;
}

bool OAICardDetails::is_number_Valid() const{
    return m_number_isValid;
}

QString OAICardDetails::getRecurringDetailReference() const {
    return m_recurring_detail_reference;
}
void OAICardDetails::setRecurringDetailReference(const QString &recurring_detail_reference) {
    m_recurring_detail_reference = recurring_detail_reference;
    m_recurring_detail_reference_isSet = true;
}

bool OAICardDetails::is_recurring_detail_reference_Set() const{
    return m_recurring_detail_reference_isSet;
}

bool OAICardDetails::is_recurring_detail_reference_Valid() const{
    return m_recurring_detail_reference_isValid;
}

QString OAICardDetails::getShopperNotificationReference() const {
    return m_shopper_notification_reference;
}
void OAICardDetails::setShopperNotificationReference(const QString &shopper_notification_reference) {
    m_shopper_notification_reference = shopper_notification_reference;
    m_shopper_notification_reference_isSet = true;
}

bool OAICardDetails::is_shopper_notification_reference_Set() const{
    return m_shopper_notification_reference_isSet;
}

bool OAICardDetails::is_shopper_notification_reference_Valid() const{
    return m_shopper_notification_reference_isValid;
}

QString OAICardDetails::getStoredPaymentMethodId() const {
    return m_stored_payment_method_id;
}
void OAICardDetails::setStoredPaymentMethodId(const QString &stored_payment_method_id) {
    m_stored_payment_method_id = stored_payment_method_id;
    m_stored_payment_method_id_isSet = true;
}

bool OAICardDetails::is_stored_payment_method_id_Set() const{
    return m_stored_payment_method_id_isSet;
}

bool OAICardDetails::is_stored_payment_method_id_Valid() const{
    return m_stored_payment_method_id_isValid;
}

QString OAICardDetails::getThreeDs2SdkVersion() const {
    return m_three_ds2_sdk_version;
}
void OAICardDetails::setThreeDs2SdkVersion(const QString &three_ds2_sdk_version) {
    m_three_ds2_sdk_version = three_ds2_sdk_version;
    m_three_ds2_sdk_version_isSet = true;
}

bool OAICardDetails::is_three_ds2_sdk_version_Set() const{
    return m_three_ds2_sdk_version_isSet;
}

bool OAICardDetails::is_three_ds2_sdk_version_Valid() const{
    return m_three_ds2_sdk_version_isValid;
}

QString OAICardDetails::getType() const {
    return m_type;
}
void OAICardDetails::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICardDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAICardDetails::is_type_Valid() const{
