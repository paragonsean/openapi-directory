...
/*
 * OAIPaymentCaptureResponse.h
 *
 * 
 */

#ifndef OAIPaymentCaptureResponse_H
#define OAIPaymentCaptureResponse_H
...
class OAIPaymentCaptureResponse : public OAIObject {
public:
    OAIPaymentCaptureResponse();
    OAIPaymentCaptureResponse(QString json);
    ~OAIPaymentCaptureResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentCaptureResponse)

#endif // OAIPaymentCaptureResponse_H
