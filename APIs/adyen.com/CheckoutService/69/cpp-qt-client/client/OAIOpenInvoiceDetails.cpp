...
QString OAIOpenInvoiceDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIOpenInvoiceDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIOpenInvoiceDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIOpenInvoiceDetails::is_checkout_attempt_id_Valid() const{
