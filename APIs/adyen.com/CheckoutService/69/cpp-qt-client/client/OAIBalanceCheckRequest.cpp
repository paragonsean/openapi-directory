...
OAIBalanceCheckRequest::OAIBalanceCheckRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBalanceCheckRequest::OAIBalanceCheckRequest() {
    this->initializeModel();
}

OAIBalanceCheckRequest::~OAIBalanceCheckRequest() {}

void OAIBalanceCheckRequest::initializeModel() {
    ...
    m_localized_shopper_statement_isSet = false;
    m_localized_shopper_statement_isValid = false;
...
void OAIBalanceCheckRequest::fromJson(QString jsonString) {
...
void OAIBalanceCheckRequest::fromJsonObject(QJsonObject json) {
    ...
    m_localized_shopper_statement_isValid = ::OpenAPI::fromJsonValue(m_localized_shopper_statement, json[QString("localizedShopperStatement")]);
    m_localized_shopper_statement_isSet = !json[QString("localizedShopperStatement")].isNull() && m_localized_shopper_statement_isValid;
...
QString OAIBalanceCheckRequest::asJson() const {
...
QJsonObject OAIBalanceCheckRequest::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_localized_shopper_statement.size() > 0) {
        obj.insert(QString("localizedShopperStatement"), ::OpenAPI::toJsonValue(m_localized_shopper_statement));
    }
    if (m_mcc_isSet) {
...
OAIAccountInfo OAIBalanceCheckRequest::getAccountInfo() const {
    return m_account_info;
}
void OAIBalanceCheckRequest::setAccountInfo(const OAIAccountInfo &account_info) {
    m_account_info = account_info;
    m_account_info_isSet = true;
}

bool OAIBalanceCheckRequest::is_account_info_Set() const{
    return m_account_info_isSet;
}

bool OAIBalanceCheckRequest::is_account_info_Valid() const{
    return m_account_info_isValid;
}

OAIAmount OAIBalanceCheckRequest::getAdditionalAmount() const {
    return m_additional_amount;
}
void OAIBalanceCheckRequest::setAdditionalAmount(const OAIAmount &additional_amount) {
    m_additional_amount = additional_amount;
    m_additional_amount_isSet = true;
}

bool OAIBalanceCheckRequest::is_additional_amount_Set() const{
    return m_additional_amount_isSet;
}

bool OAIBalanceCheckRequest::is_additional_amount_Valid() const{
    return m_additional_amount_isValid;
}

OAIBalanceCheckRequest_additionalData OAIBalanceCheckRequest::getAdditionalData() const {
    return m_additional_data;
}
void OAIBalanceCheckRequest::setAdditionalData(const OAIBalanceCheckRequest_additionalData &additional_data) {
    m_additional_data = additional_data;
    m_additional_data_isSet = true;
}

bool OAIBalanceCheckRequest::is_additional_data_Set() const{
    return m_additional_data_isSet;
}

bool OAIBalanceCheckRequest::is_additional_data_Valid() const{
    return m_additional_data_isValid;
}

OAIAmount OAIBalanceCheckRequest::getAmount() const {
    return m_amount;
}
void OAIBalanceCheckRequest::setAmount(const OAIAmount &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIBalanceCheckRequest::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIBalanceCheckRequest::is_amount_Valid() const{
    return m_amount_isValid;
}

OAIApplicationInfo OAIBalanceCheckRequest::getApplicationInfo() const {
    return m_application_info;
}
void OAIBalanceCheckRequest::setApplicationInfo(const OAIApplicationInfo &application_info) {
    m_application_info = application_info;
    m_application_info_isSet = true;
}

bool OAIBalanceCheckRequest::is_application_info_Set() const{
    return m_application_info_isSet;
}

bool OAIBalanceCheckRequest::is_application_info_Valid() const{
    return m_application_info_isValid;
}

OAIAddress OAIBalanceCheckRequest::getBillingAddress() const {
    return m_billing_address;
}
void OAIBalanceCheckRequest::setBillingAddress(const OAIAddress &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIBalanceCheckRequest::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIBalanceCheckRequest::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

OAIBrowserInfo OAIBalanceCheckRequest::getBrowserInfo() const {
    return m_browser_info;
}
void OAIBalanceCheckRequest::setBrowserInfo(const OAIBrowserInfo &browser_info) {
    m_browser_info = browser_info;
    m_browser_info_isSet = true;
}

bool OAIBalanceCheckRequest::is_browser_info_Set() const{
    return m_browser_info_isSet;
}

bool OAIBalanceCheckRequest::is_browser_info_Valid() const{
    return m_browser_info_isValid;
}

qint32 OAIBalanceCheckRequest::getCaptureDelayHours() const {
    return m_capture_delay_hours;
}
void OAIBalanceCheckRequest::setCaptureDelayHours(const qint32 &capture_delay_hours) {
    m_capture_delay_hours = capture_delay_hours;
    m_capture_delay_hours_isSet = true;
}

bool OAIBalanceCheckRequest::is_capture_delay_hours_Set() const{
    return m_capture_delay_hours_isSet;
}

bool OAIBalanceCheckRequest::is_capture_delay_hours_Valid() const{
    return m_capture_delay_hours_isValid;
}

QDate OAIBalanceCheckRequest::getDateOfBirth() const {
    return m_date_of_birth;
}
void OAIBalanceCheckRequest::setDateOfBirth(const QDate &date_of_birth) {
    m_date_of_birth = date_of_birth;
    m_date_of_birth_isSet = true;
}

bool OAIBalanceCheckRequest::is_date_of_birth_Set() const{
    return m_date_of_birth_isSet;
}

bool OAIBalanceCheckRequest::is_date_of_birth_Valid() const{
    return m_date_of_birth_isValid;
}

OAIForexQuote OAIBalanceCheckRequest::getDccQuote() const {
    return m_dcc_quote;
}
void OAIBalanceCheckRequest::setDccQuote(const OAIForexQuote &dcc_quote) {
    m_dcc_quote = dcc_quote;
    m_dcc_quote_isSet = true;
}

bool OAIBalanceCheckRequest::is_dcc_quote_Set() const{
    return m_dcc_quote_isSet;
}

bool OAIBalanceCheckRequest::is_dcc_quote_Valid() const{
    return m_dcc_quote_isValid;
}

OAIAddress OAIBalanceCheckRequest::getDeliveryAddress() const {
    return m_delivery_address;
}
void OAIBalanceCheckRequest::setDeliveryAddress(const OAIAddress &delivery_address) {
    m_delivery_address = delivery_address;
    m_delivery_address_isSet = true;
}

bool OAIBalanceCheckRequest::is_delivery_address_Set() const{
    return m_delivery_address_isSet;
}

bool OAIBalanceCheckRequest::is_delivery_address_Valid() const{
    return m_delivery_address_isValid;
}

QDateTime OAIBalanceCheckRequest::getDeliveryDate() const {
    return m_delivery_date;
}
void OAIBalanceCheckRequest::setDeliveryDate(const QDateTime &delivery_date) {
    m_delivery_date = delivery_date;
    m_delivery_date_isSet = true;
}

bool OAIBalanceCheckRequest::is_delivery_date_Set() const{
    return m_delivery_date_isSet;
}

bool OAIBalanceCheckRequest::is_delivery_date_Valid() const{
    return m_delivery_date_isValid;
}

QString OAIBalanceCheckRequest::getDeviceFingerprint() const {
    return m_device_fingerprint;
}
void OAIBalanceCheckRequest::setDeviceFingerprint(const QString &device_fingerprint) {
    m_device_fingerprint = device_fingerprint;
    m_device_fingerprint_isSet = true;
}

bool OAIBalanceCheckRequest::is_device_fingerprint_Set() const{
    return m_device_fingerprint_isSet;
}

bool OAIBalanceCheckRequest::is_device_fingerprint_Valid() const{
    return m_device_fingerprint_isValid;
}

qint32 OAIBalanceCheckRequest::getFraudOffset() const {
    return m_fraud_offset;
}
void OAIBalanceCheckRequest::setFraudOffset(const qint32 &fraud_offset) {
    m_fraud_offset = fraud_offset;
    m_fraud_offset_isSet = true;
}

bool OAIBalanceCheckRequest::is_fraud_offset_Set() const{
    return m_fraud_offset_isSet;
}

bool OAIBalanceCheckRequest::is_fraud_offset_Valid() const{
    return m_fraud_offset_isValid;
}

OAIInstallments OAIBalanceCheckRequest::getInstallments() const {
    return m_installments;
}
void OAIBalanceCheckRequest::setInstallments(const OAIInstallments &installments) {
    m_installments = installments;
    m_installments_isSet = true;
}

bool OAIBalanceCheckRequest::is_installments_Set() const{
    return m_installments_isSet;
}

bool OAIBalanceCheckRequest::is_installments_Valid() const{
    return m_installments_isValid;
}

QMap<QString, QString> OAIBalanceCheckRequest::getLocalizedShopperStatement() const {
    return m_localized_shopper_statement;
}
void OAIBalanceCheckRequest::setLocalizedShopperStatement(const QMap<QString, QString> &localized_shopper_statement) {
    m_localized_shopper_statement = localized_shopper_statement;
    m_localized_shopper_statement_isSet = true;
}

bool OAIBalanceCheckRequest::is_localized_shopper_statement_Set() const{
    return m_localized_shopper_statement_isSet;
}

bool OAIBalanceCheckRequest::is_localized_shopper_statement_Valid() const{
    return m_localized_shopper_statement_isValid;
}

QString OAIBalanceCheckRequest::getMcc() const {
    return m_mcc;
}
void OAIBalanceCheckRequest::setMcc(const QString &mcc) {
    m_mcc = mcc;
    m_mcc_isSet = true;
}

bool OAIBalanceCheckRequest::is_mcc_Set() const{
    return m_mcc_isSet;
}

bool OAIBalanceCheckRequest::is_mcc_Valid() const{
    return m_mcc_isValid;
}

QString OAIBalanceCheckRequest::getMerchantAccount() const {
    return m_merchant_account;
}
void OAIBalanceCheckRequest::setMerchantAccount(const QString &merchant_account) {
    m_merchant_account = merchant_account;
    m_merchant_account_isSet = true;
}

bool OAIBalanceCheckRequest::is_merchant_account_Set() const{
    return m_merchant_account_isSet;
}

bool OAIBalanceCheckRequest::is_merchant_account_Valid() const{
    return m_merchant_account_isValid;
}

QString OAIBalanceCheckRequest::getMerchantOrderReference() const {
    return m_merchant_order_reference;
}
void OAIBalanceCheckRequest::setMerchantOrderReference(const QString &merchant_order_reference) {
    m_merchant_order_reference = merchant_order_reference;
    m_merchant_order_reference_isSet = true;
}

bool OAIBalanceCheckRequest::is_merchant_order_reference_Set() const{
    return m_merchant_order_reference_isSet;
}

bool OAIBalanceCheckRequest::is_merchant_order_reference_Valid() const{
    return m_merchant_order_reference_isValid;
}

OAIMerchantRiskIndicator OAIBalanceCheckRequest::getMerchantRiskIndicator() const {
    return m_merchant_risk_indicator;
}
void OAIBalanceCheckRequest::setMerchantRiskIndicator(const OAIMerchantRiskIndicator &merchant_risk_indicator) {
    m_merchant_risk_indicator = merchant_risk_indicator;
    m_merchant_risk_indicator_isSet = true;
}

bool OAIBalanceCheckRequest::is_merchant_risk_indicator_Set() const{
    return m_merchant_risk_indicator_isSet;
}

bool OAIBalanceCheckRequest::is_merchant_risk_indicator_Valid() const{
    return m_merchant_risk_indicator_isValid;
}

QMap<QString, QString> OAIBalanceCheckRequest::getMetadata() const {
    return m_metadata;
}
void OAIBalanceCheckRequest::setMetadata(const QMap<QString, QString> &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIBalanceCheckRequest::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIBalanceCheckRequest::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QString OAIBalanceCheckRequest::getOrderReference() const {
    return m_order_reference;
}
void OAIBalanceCheckRequest::setOrderReference(const QString &order_reference) {
    m_order_reference = order_reference;
    m_order_reference_isSet = true;
}

bool OAIBalanceCheckRequest::is_order_reference_Set() const{
    return m_order_reference_isSet;
}

bool OAIBalanceCheckRequest::is_order_reference_Valid() const{
    return m_order_reference_isValid;
}

QMap<QString, QString> OAIBalanceCheckRequest::getPaymentMethod() const {
    return m_payment_method;
}
void OAIBalanceCheckRequest::setPaymentMethod(const QMap<QString, QString> &payment_method) {
    m_payment_method = payment_method;
    m_payment_method_isSet = true;
}

bool OAIBalanceCheckRequest::is_payment_method_Set() const{
    return m_payment_method_isSet;
}

bool OAIBalanceCheckRequest::is_payment_method_Valid() const{
    return m_payment_method_isValid;
}

OAIRecurring OAIBalanceCheckRequest::getRecurring() const {
    return m_recurring;
}
void OAIBalanceCheckRequest::setRecurring(const OAIRecurring &recurring) {
    m_recurring = recurring;
    m_recurring_isSet = true;
}

bool OAIBalanceCheckRequest::is_recurring_Set() const{
    return m_recurring_isSet;
}

bool OAIBalanceCheckRequest::is_recurring_Valid() const{
    return m_recurring_isValid;
}

QString OAIBalanceCheckRequest::getRecurringProcessingModel() const {
    return m_recurring_processing_model;
}
void OAIBalanceCheckRequest::setRecurringProcessingModel(const QString &recurring_processing_model) {
    m_recurring_processing_model = recurring_processing_model;
    m_recurring_processing_model_isSet = true;
}

bool OAIBalanceCheckRequest::is_recurring_processing_model_Set() const{
    return m_recurring_processing_model_isSet;
}

bool OAIBalanceCheckRequest::is_recurring_processing_model_Valid() const{
    return m_recurring_processing_model_isValid;
}

QString OAIBalanceCheckRequest::getReference() const {
    return m_reference;
}
void OAIBalanceCheckRequest::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAIBalanceCheckRequest::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAIBalanceCheckRequest::is_reference_Valid() const{
    return m_reference_isValid;
}

QString OAIBalanceCheckRequest::getSelectedBrand() const {
    return m_selected_brand;
}
void OAIBalanceCheckRequest::setSelectedBrand(const QString &selected_brand) {
    m_selected_brand = selected_brand;
    m_selected_brand_isSet = true;
}

bool OAIBalanceCheckRequest::is_selected_brand_Set() const{
    return m_selected_brand_isSet;
}

bool OAIBalanceCheckRequest::is_selected_brand_Valid() const{
    return m_selected_brand_isValid;
}

QString OAIBalanceCheckRequest::getSelectedRecurringDetailReference() const {
    return m_selected_recurring_detail_reference;
}
void OAIBalanceCheckRequest::setSelectedRecurringDetailReference(const QString &selected_recurring_detail_reference) {
...
bool OAIBalanceCheckRequest::is_selected_recurring_detail_reference_Set() const{
    return m_selected_recurring_detail_reference_isSet;
}

bool OAIBalanceCheckRequest::is_selected_recurring_detail_reference_Valid() const{
    return m_selected_recurring_detail_reference_isValid;
}

QString OAIBalanceCheckRequest::getSessionId() const {
    return m_session_id;
}
void OAIBalanceCheckRequest::setSessionId(const QString &session_id) {
    m_session_id = session_id;
    m_session_id_isSet = true;
}

bool OAIBalanceCheckRequest::is_session_id_Set() const{
    return m_session_id_isSet;
}

bool OAIBalanceCheckRequest::is_session_id_Valid() const{
    return m_session_id_isValid;
}

QString OAIBalanceCheckRequest::getShopperEmail() const {
    return m_shopper_email;
}
void OAIBalanceCheckRequest::setShopperEmail(const QString &shopper_email) {
    m_shopper_email = shopper_email;
    m_shopper_email_isSet = true;
}

bool OAIBalanceCheckRequest::is_shopper_email_Set() const{
    return m_shopper_email_isSet;
}

bool OAIBalanceCheckRequest::is_shopper_email_Valid() const{
    return m_shopper_email_isValid;
}

QString OAIBalanceCheckRequest::getShopperIp() const {
    return m_shopper_ip;
}
void OAIBalanceCheckRequest::setShopperIp(const QString &shopper_ip) {
    m_shopper_ip = shopper_ip;
    m_shopper_ip_isSet = true;
}

bool OAIBalanceCheckRequest::is_shopper_ip_Set() const{
    return m_shopper_ip_isSet;
}

bool OAIBalanceCheckRequest::is_shopper_ip_Valid() const{
    return m_shopper_ip_isValid;
}

QString OAIBalanceCheckRequest::getShopperInteraction() const {
    return m_shopper_interaction;
}
void OAIBalanceCheckRequest::setShopperInteraction(const QString &shopper_interaction) {
    m_shopper_interaction = shopper_interaction;
    m_shopper_interaction_isSet = true;
}

bool OAIBalanceCheckRequest::is_shopper_interaction_Set() const{
    return m_shopper_interaction_isSet;
}

bool OAIBalanceCheckRequest::is_shopper_interaction_Valid() const{
    return m_shopper_interaction_isValid;
}

QString OAIBalanceCheckRequest::getShopperLocale() const {
    return m_shopper_locale;
}
void OAIBalanceCheckRequest::setShopperLocale(const QString &shopper_locale) {
    m_shopper_locale = shopper_locale;
    m_shopper_locale_isSet = true;
}

bool OAIBalanceCheckRequest::is_shopper_locale_Set() const{
    return m_shopper_locale_isSet;
}

bool OAIBalanceCheckRequest::is_shopper_locale_Valid() const{
    return m_shopper_locale_isValid;
}

OAIName OAIBalanceCheckRequest::getShopperName() const {
    return m_shopper_name;
}
void OAIBalanceCheckRequest::setShopperName(const OAIName &shopper_name) {
    m_shopper_name = shopper_name;
    m_shopper_name_isSet = true;
}

bool OAIBalanceCheckRequest::is_shopper_name_Set() const{
    return m_shopper_name_isSet;
}

bool OAIBalanceCheckRequest::is_shopper_name_Valid() const{
    return m_shopper_name_isValid;
}

QString OAIBalanceCheckRequest::getShopperReference() const {
    return m_shopper_reference;
}
void OAIBalanceCheckRequest::setShopperReference(const QString &shopper_reference) {
    m_shopper_reference = shopper_reference;
    m_shopper_reference_isSet = true;
}

bool OAIBalanceCheckRequest::is_shopper_reference_Set() const{
    return m_shopper_reference_isSet;
}

bool OAIBalanceCheckRequest::is_shopper_reference_Valid() const{
    return m_shopper_reference_isValid;
}

QString OAIBalanceCheckRequest::getShopperStatement() const {
    return m_shopper_statement;
}
void OAIBalanceCheckRequest::setShopperStatement(const QString &shopper_statement) {
    m_shopper_statement = shopper_statement;
    m_shopper_statement_isSet = true;
}

bool OAIBalanceCheckRequest::is_shopper_statement_Set() const{
    return m_shopper_statement_isSet;
}

bool OAIBalanceCheckRequest::is_shopper_statement_Valid() const{
    return m_shopper_statement_isValid;
}

QString OAIBalanceCheckRequest::getSocialSecurityNumber() const {
    return m_social_security_number;
}
void OAIBalanceCheckRequest::setSocialSecurityNumber(const QString &social_security_number) {
    m_social_security_number = social_security_number;
    m_social_security_number_isSet = true;
}

bool OAIBalanceCheckRequest::is_social_security_number_Set() const{
    return m_social_security_number_isSet;
}

bool OAIBalanceCheckRequest::is_social_security_number_Valid() const{
    return m_social_security_number_isValid;
}

QList<OAISplit> OAIBalanceCheckRequest::getSplits() const {
    return m_splits;
}
void OAIBalanceCheckRequest::setSplits(const QList<OAISplit> &splits) {
    m_splits = splits;
    m_splits_isSet = true;
}

bool OAIBalanceCheckRequest::is_splits_Set() const{
    return m_splits_isSet;
}

bool OAIBalanceCheckRequest::is_splits_Valid() const{
    return m_splits_isValid;
}

QString OAIBalanceCheckRequest::getStore() const {
    return m_store;
}
void OAIBalanceCheckRequest::setStore(const QString &store) {
    m_store = store;
    m_store_isSet = true;
}

bool OAIBalanceCheckRequest::is_store_Set() const{
    return m_store_isSet;
}

bool OAIBalanceCheckRequest::is_store_Valid() const{
    return m_store_isValid;
}

QString OAIBalanceCheckRequest::getTelephoneNumber() const {
    return m_telephone_number;
}
void OAIBalanceCheckRequest::setTelephoneNumber(const QString &telephone_number) {
    m_telephone_number = telephone_number;
    m_telephone_number_isSet = true;
}

bool OAIBalanceCheckRequest::is_telephone_number_Set() const{
    return m_telephone_number_isSet;
}

bool OAIBalanceCheckRequest::is_telephone_number_Valid() const{
    return m_telephone_number_isValid;
}

OAIThreeDS2RequestData OAIBalanceCheckRequest::getThreeDs2RequestData() const {
    return m_three_ds2_request_data;
}
void OAIBalanceCheckRequest::setThreeDs2RequestData(const OAIThreeDS2RequestData &three_ds2_request_data) {
    m_three_ds2_request_data = three_ds2_request_data;
    m_three_ds2_request_data_isSet = true;
}

bool OAIBalanceCheckRequest::is_three_ds2_request_data_Set() const{
    return m_three_ds2_request_data_isSet;
}

bool OAIBalanceCheckRequest::is_three_ds2_request_data_Valid() const{
    return m_three_ds2_request_data_isValid;
}

bool OAIBalanceCheckRequest::isThreeDsAuthenticationOnly() const {
    return m_three_ds_authentication_only;
}
void OAIBalanceCheckRequest::setThreeDsAuthenticationOnly(const bool &three_ds_authentication_only) {
    m_three_ds_authentication_only = three_ds_authentication_only;
    m_three_ds_authentication_only_isSet = true;
}

bool OAIBalanceCheckRequest::is_three_ds_authentication_only_Set() const{
    return m_three_ds_authentication_only_isSet;
}

bool OAIBalanceCheckRequest::is_three_ds_authentication_only_Valid() const{
    return m_three_ds_authentication_only_isValid;
}

QString OAIBalanceCheckRequest::getTotalsGroup() const {
    return m_totals_group;
}
void OAIBalanceCheckRequest::setTotalsGroup(const QString &totals_group) {
    m_totals_group = totals_group;
    m_totals_group_isSet = true;
}

bool OAIBalanceCheckRequest::is_totals_group_Set() const{
    return m_totals_group_isSet;
}

bool OAIBalanceCheckRequest::is_totals_group_Valid() const{
    return m_totals_group_isValid;
}

bool OAIBalanceCheckRequest::isTrustedShopper() const {
    return m_trusted_shopper;
}
void OAIBalanceCheckRequest::setTrustedShopper(const bool &trusted_shopper) {
    m_trusted_shopper = trusted_shopper;
    m_trusted_shopper_isSet = true;
}

bool OAIBalanceCheckRequest::is_trusted_shopper_Set() const{
    return m_trusted_shopper_isSet;
}

bool OAIBalanceCheckRequest::is_trusted_shopper_Valid() const{
    return m_trusted_shopper_isValid;
}

bool OAIBalanceCheckRequest::isSet() const {
...
bool OAIBalanceCheckRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_amount_isValid && m_merchant_account_isValid && m_payment_method_isValid && true;
}
