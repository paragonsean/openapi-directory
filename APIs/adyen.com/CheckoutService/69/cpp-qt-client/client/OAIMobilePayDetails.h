...
/*
 * OAIMobilePayDetails.h
 *
 * 
 */

#ifndef OAIMobilePayDetails_H
#define OAIMobilePayDetails_H
...
class OAIMobilePayDetails : public OAIObject {
public:
    OAIMobilePayDetails();
    OAIMobilePayDetails(QString json);
    ~OAIMobilePayDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMobilePayDetails)

#endif // OAIMobilePayDetails_H
