...
QString OAIPaymentSetupRequest::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIPaymentSetupRequest::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIPaymentSetupRequest::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIPaymentSetupRequest::is_checkout_attempt_id_Valid() const{
...
QMap<QString, QString> OAIPaymentSetupRequest::getLocalizedShopperStatement() const {
    return m_localized_shopper_statement;
}
void OAIPaymentSetupRequest::setLocalizedShopperStatement(const QMap<QString, QString> &localized_shopper_statement) {
    m_localized_shopper_statement = localized_shopper_statement;
    m_localized_shopper_statement_isSet = true;
}

bool OAIPaymentSetupRequest::is_localized_shopper_statement_Set() const{
    return m_localized_shopper_statement_isSet;
}

bool OAIPaymentSetupRequest::is_localized_shopper_statement_Valid() const{
...
OAIPlatformChargebackLogic OAIPaymentSetupRequest::getPlatformChargebackLogic() const {
    return m_platform_chargeback_logic;
}
void OAIPaymentSetupRequest::setPlatformChargebackLogic(const OAIPlatformChargebackLogic &platform_chargeback_logic) {
    m_platform_chargeback_logic = platform_chargeback_logic;
    m_platform_chargeback_logic_isSet = true;
}

bool OAIPaymentSetupRequest::is_platform_chargeback_logic_Set() const{
    return m_platform_chargeback_logic_isSet;
}

bool OAIPaymentSetupRequest::is_platform_chargeback_logic_Valid() const{
