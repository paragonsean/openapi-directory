...
namespace OpenAPI {
class OAIDetailsRequestAuthenticationData;
...
public:
    ...
    OAIDetailsRequestAuthenticationData getAuthenticationData() const;
    void setAuthenticationData(const OAIDetailsRequestAuthenticationData &authentication_data);
...
private:
    ...
    OAIDetailsRequestAuthenticationData m_authentication_data;
