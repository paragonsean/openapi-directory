...
QString OAIResponseAdditionalDataCommon::getRecurringContractTypes() const {
    return m_recurring_contract_types;
}
void OAIResponseAdditionalDataCommon::setRecurringContractTypes(const QString &recurring_contract_types) {
    m_recurring_contract_types = recurring_contract_types;
    m_recurring_contract_types_isSet = true;
}

bool OAIResponseAdditionalDataCommon::is_recurring_contract_types_Set() const{
    return m_recurring_contract_types_isSet;
}

bool OAIResponseAdditionalDataCommon::is_recurring_contract_types_Valid() const{
...
QString OAIResponseAdditionalDataCommon::getRecurringShopperReference() const {
    return m_recurring_shopper_reference;
}
void OAIResponseAdditionalDataCommon::setRecurringShopperReference(const QString &recurring_shopper_reference) {
    m_recurring_shopper_reference = recurring_shopper_reference;
    m_recurring_shopper_reference_isSet = true;
}

bool OAIResponseAdditionalDataCommon::is_recurring_shopper_reference_Set() const{
    return m_recurring_shopper_reference_isSet;
}

bool OAIResponseAdditionalDataCommon::is_recurring_shopper_reference_Valid() const{
    return m_recurring_shopper_reference_isValid;
}

QString OAIResponseAdditionalDataCommon::getRecurringProcessingModel() const {
    return m_recurring_processing_model;
}
void OAIResponseAdditionalDataCommon::setRecurringProcessingModel(const QString &recurring_processing_model) {
    m_recurring_processing_model = recurring_processing_model;
    m_recurring_processing_model_isSet = true;
}

bool OAIResponseAdditionalDataCommon::is_recurring_processing_model_Set() const{
    return m_recurring_processing_model_isSet;
}

bool OAIResponseAdditionalDataCommon::is_recurring_processing_model_Valid() const{
