...
public:
    ...
    Q_DECL_DEPRECATED QString getAllow3Ds2() const;
    Q_DECL_DEPRECATED void setAllow3Ds2(const QString &allow3_ds2);
    Q_DECL_DEPRECATED bool is_allow3_ds2_Set() const;
    Q_DECL_DEPRECATED bool is_allow3_ds2_Valid() const;
    ...
    Q_DECL_DEPRECATED QString getExecuteThreeD() const;
    Q_DECL_DEPRECATED void setExecuteThreeD(const QString &execute_three_d);
    Q_DECL_DEPRECATED bool is_execute_three_d_Set() const;
    Q_DECL_DEPRECATED bool is_execute_three_d_Valid() const;
