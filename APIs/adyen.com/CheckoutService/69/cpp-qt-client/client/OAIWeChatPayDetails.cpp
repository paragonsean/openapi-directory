...
OAIWeChatPayDetails::OAIWeChatPayDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWeChatPayDetails::OAIWeChatPayDetails() {
    this->initializeModel();
}

OAIWeChatPayDetails::~OAIWeChatPayDetails() {}

void OAIWeChatPayDetails::initializeModel() {
...
void OAIWeChatPayDetails::fromJson(QString jsonString) {
...
void OAIWeChatPayDetails::fromJsonObject(QJsonObject json) {
...
QString OAIWeChatPayDetails::asJson() const {
...
QJsonObject OAIWeChatPayDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIWeChatPayDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIWeChatPayDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIWeChatPayDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIWeChatPayDetails::is_checkout_attempt_id_Valid() const{
    return m_checkout_attempt_id_isValid;
}

QString OAIWeChatPayDetails::getType() const {
    return m_type;
}
void OAIWeChatPayDetails::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIWeChatPayDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAIWeChatPayDetails::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIWeChatPayDetails::isSet() const {
...
bool OAIWeChatPayDetails::isValid() const {
