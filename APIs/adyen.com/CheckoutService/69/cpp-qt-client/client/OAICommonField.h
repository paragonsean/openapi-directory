...
#ifndef OAICommonField_H
#define OAICommonField_H
...
class OAICommonField : public OAIObject {
public:
    OAICommonField();
    OAICommonField(QString json);
    ~OAICommonField() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommonField)

#endif // OAICommonField_H
