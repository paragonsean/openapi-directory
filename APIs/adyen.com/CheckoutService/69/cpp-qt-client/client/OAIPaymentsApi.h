...
#include "OAICreateCheckoutSessionRequest.h"
...
public:
    ...
    * @param[in]  session_result QString [required]
    */
    virtual void getSessionsSessionId(const QString &session_id, const QString &session_result);
    ...
    */
    ...
    /**
    * @param[in]  idempotency_key QString [optional]
    * @param[in]  oai_create_checkout_session_request OAICreateCheckoutSessionRequest [optional]
    */
    virtual void postSessions(const ::OpenAPI::OptionalParam<QString> &idempotency_key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAICreateCheckoutSessionRequest> &oai_create_checkout_session_request = ::OpenAPI::OptionalParam<OAICreateCheckoutSessionRequest>());
...
private:
    ...
    void getSessionsSessionIdCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void getSessionsSessionIdSignal(OAISessionResultResponse summary);
    ...
    void postSessionsSignal(OAICreateCheckoutSessionResponse summary);


    void getSessionsSessionIdSignalFull(OAIHttpRequestWorker *worker, OAISessionResultResponse summary);
    ...
    void postSessionsSignalFull(OAIHttpRequestWorker *worker, OAICreateCheckoutSessionResponse summary);

    Q_DECL_DEPRECATED_X("Use getSessionsSessionIdSignalError() instead")
    void getSessionsSessionIdSignalE(OAISessionResultResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getSessionsSessionIdSignalError(OAISessionResultResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void postSessionsSignalE(OAICreateCheckoutSessionResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postSessionsSignalError(OAICreateCheckoutSessionResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getSessionsSessionIdSignalErrorFull() instead")
    void getSessionsSessionIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getSessionsSessionIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
