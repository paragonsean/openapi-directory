...
void OAIThreeDSecureData::initializeModel() {
    ...
    m_token_authentication_verification_value_isSet = false;
    m_token_authentication_verification_value_isValid = false;
...
void OAIThreeDSecureData::fromJsonObject(QJsonObject json) {
    ...
    m_token_authentication_verification_value_isValid = ::OpenAPI::fromJsonValue(m_token_authentication_verification_value, json[QString("tokenAuthenticationVerificationValue")]);
    m_token_authentication_verification_value_isSet = !json[QString("tokenAuthenticationVerificationValue")].isNull() && m_token_authentication_verification_value_isValid;
...
QJsonObject OAIThreeDSecureData::asJsonObject() const {
    ...
    if (m_token_authentication_verification_value_isSet) {
        obj.insert(QString("tokenAuthenticationVerificationValue"), ::OpenAPI::toJsonValue(m_token_authentication_verification_value));
    }
...
QString OAIThreeDSecureData::getChallengeCancel() const {
    return m_challenge_cancel;
}
void OAIThreeDSecureData::setChallengeCancel(const QString &challenge_cancel) {
    m_challenge_cancel = challenge_cancel;
    m_challenge_cancel_isSet = true;
}

bool OAIThreeDSecureData::is_challenge_cancel_Set() const{
    return m_challenge_cancel_isSet;
}

bool OAIThreeDSecureData::is_challenge_cancel_Valid() const{
...
QString OAIThreeDSecureData::getRiskScore() const {
    return m_risk_score;
}
void OAIThreeDSecureData::setRiskScore(const QString &risk_score) {
    m_risk_score = risk_score;
    m_risk_score_isSet = true;
}

bool OAIThreeDSecureData::is_risk_score_Set() const{
    return m_risk_score_isSet;
}

bool OAIThreeDSecureData::is_risk_score_Valid() const{
...
QString OAIThreeDSecureData::getTokenAuthenticationVerificationValue() const {
    return m_token_authentication_verification_value;
}
void OAIThreeDSecureData::setTokenAuthenticationVerificationValue(const QString &token_authentication_verification_value) {
    m_token_authentication_verification_value = token_authentication_verification_value;
    m_token_authentication_verification_value_isSet = true;
}

bool OAIThreeDSecureData::is_token_authentication_verification_value_Set() const{
    return m_token_authentication_verification_value_isSet;
}

bool OAIThreeDSecureData::is_token_authentication_verification_value_Valid() const{
    return m_token_authentication_verification_value_isValid;
}

QString OAIThreeDSecureData::getTransStatusReason() const {
    return m_trans_status_reason;
}
void OAIThreeDSecureData::setTransStatusReason(const QString &trans_status_reason) {
    m_trans_status_reason = trans_status_reason;
    m_trans_status_reason_isSet = true;
}

bool OAIThreeDSecureData::is_trans_status_reason_Set() const{
    return m_trans_status_reason_isSet;
}

bool OAIThreeDSecureData::is_trans_status_reason_Valid() const{
