...
QString OAIStoredPaymentMethod::getIban() const {
    return m_iban;
}
void OAIStoredPaymentMethod::setIban(const QString &iban) {
    m_iban = iban;
    m_iban_isSet = true;
}

bool OAIStoredPaymentMethod::is_iban_Set() const{
    return m_iban_isSet;
}

bool OAIStoredPaymentMethod::is_iban_Valid() const{
...
QString OAIStoredPaymentMethod::getNetworkTxReference() const {
    return m_network_tx_reference;
}
void OAIStoredPaymentMethod::setNetworkTxReference(const QString &network_tx_reference) {
    m_network_tx_reference = network_tx_reference;
    m_network_tx_reference_isSet = true;
}

bool OAIStoredPaymentMethod::is_network_tx_reference_Set() const{
    return m_network_tx_reference_isSet;
}

bool OAIStoredPaymentMethod::is_network_tx_reference_Valid() const{
    return m_network_tx_reference_isValid;
}

QString OAIStoredPaymentMethod::getOwnerName() const {
    return m_owner_name;
}
void OAIStoredPaymentMethod::setOwnerName(const QString &owner_name) {
    m_owner_name = owner_name;
    m_owner_name_isSet = true;
}

bool OAIStoredPaymentMethod::is_owner_name_Set() const{
    return m_owner_name_isSet;
}

bool OAIStoredPaymentMethod::is_owner_name_Valid() const{
