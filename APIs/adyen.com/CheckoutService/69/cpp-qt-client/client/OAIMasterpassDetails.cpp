...
QString OAIMasterpassDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIMasterpassDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIMasterpassDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIMasterpassDetails::is_checkout_attempt_id_Valid() const{
