...
QString OAIAmazonPayDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIAmazonPayDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIAmazonPayDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIAmazonPayDetails::is_checkout_attempt_id_Valid() const{
