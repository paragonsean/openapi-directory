...
OAIDotpayDetails::OAIDotpayDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDotpayDetails::OAIDotpayDetails() {
    this->initializeModel();
}

OAIDotpayDetails::~OAIDotpayDetails() {}

void OAIDotpayDetails::initializeModel() {
...
void OAIDotpayDetails::fromJson(QString jsonString) {
...
void OAIDotpayDetails::fromJsonObject(QJsonObject json) {
...
QString OAIDotpayDetails::asJson() const {
...
QJsonObject OAIDotpayDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDotpayDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIDotpayDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIDotpayDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIDotpayDetails::is_checkout_attempt_id_Valid() const{
    return m_checkout_attempt_id_isValid;
}

QString OAIDotpayDetails::getIssuer() const {
    return m_issuer;
}
void OAIDotpayDetails::setIssuer(const QString &issuer) {
    m_issuer = issuer;
    m_issuer_isSet = true;
}

bool OAIDotpayDetails::is_issuer_Set() const{
    return m_issuer_isSet;
}

bool OAIDotpayDetails::is_issuer_Valid() const{
    return m_issuer_isValid;
}

QString OAIDotpayDetails::getType() const {
    return m_type;
}
void OAIDotpayDetails::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDotpayDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDotpayDetails::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDotpayDetails::isSet() const {
...
bool OAIDotpayDetails::isValid() const {
