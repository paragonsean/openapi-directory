...
#include "OAIResponsePaymentMethod.h"
...
class OAIResponsePaymentMethod;
...
public:
    ...
    OAIResponsePaymentMethod getPaymentMethod() const;
    void setPaymentMethod(const OAIResponsePaymentMethod &payment_method);
...
private:
    ...
    OAIResponsePaymentMethod m_payment_method;
