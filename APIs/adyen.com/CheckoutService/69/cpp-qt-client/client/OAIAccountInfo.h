...
public:
    ...
    Q_DECL_DEPRECATED QString getHomePhone() const;
    Q_DECL_DEPRECATED void setHomePhone(const QString &home_phone);
    Q_DECL_DEPRECATED bool is_home_phone_Set() const;
    Q_DECL_DEPRECATED bool is_home_phone_Valid() const;

    Q_DECL_DEPRECATED QString getMobilePhone() const;
    Q_DECL_DEPRECATED void setMobilePhone(const QString &mobile_phone);
    Q_DECL_DEPRECATED bool is_mobile_phone_Set() const;
    Q_DECL_DEPRECATED bool is_mobile_phone_Valid() const;
    ...
    Q_DECL_DEPRECATED QString getWorkPhone() const;
    Q_DECL_DEPRECATED void setWorkPhone(const QString &work_phone);
    Q_DECL_DEPRECATED bool is_work_phone_Set() const;
    Q_DECL_DEPRECATED bool is_work_phone_Valid() const;
