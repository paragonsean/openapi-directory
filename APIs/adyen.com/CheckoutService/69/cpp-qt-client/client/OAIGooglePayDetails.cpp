...
OAIGooglePayDetails::OAIGooglePayDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGooglePayDetails::OAIGooglePayDetails() {
    this->initializeModel();
}

OAIGooglePayDetails::~OAIGooglePayDetails() {}

void OAIGooglePayDetails::initializeModel() {
...
void OAIGooglePayDetails::fromJson(QString jsonString) {
...
void OAIGooglePayDetails::fromJsonObject(QJsonObject json) {
...
QString OAIGooglePayDetails::asJson() const {
...
QJsonObject OAIGooglePayDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGooglePayDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIGooglePayDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIGooglePayDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIGooglePayDetails::is_checkout_attempt_id_Valid() const{
    return m_checkout_attempt_id_isValid;
}

QString OAIGooglePayDetails::getFundingSource() const {
    return m_funding_source;
}
void OAIGooglePayDetails::setFundingSource(const QString &funding_source) {
    m_funding_source = funding_source;
    m_funding_source_isSet = true;
}

bool OAIGooglePayDetails::is_funding_source_Set() const{
    return m_funding_source_isSet;
}

bool OAIGooglePayDetails::is_funding_source_Valid() const{
    return m_funding_source_isValid;
}

QString OAIGooglePayDetails::getGooglePayCardNetwork() const {
    return m_google_pay_card_network;
}
void OAIGooglePayDetails::setGooglePayCardNetwork(const QString &google_pay_card_network) {
    m_google_pay_card_network = google_pay_card_network;
    m_google_pay_card_network_isSet = true;
}

bool OAIGooglePayDetails::is_google_pay_card_network_Set() const{
    return m_google_pay_card_network_isSet;
}

bool OAIGooglePayDetails::is_google_pay_card_network_Valid() const{
    return m_google_pay_card_network_isValid;
}

QString OAIGooglePayDetails::getGooglePayToken() const {
    return m_google_pay_token;
}
void OAIGooglePayDetails::setGooglePayToken(const QString &google_pay_token) {
    m_google_pay_token = google_pay_token;
    m_google_pay_token_isSet = true;
}

bool OAIGooglePayDetails::is_google_pay_token_Set() const{
    return m_google_pay_token_isSet;
}

bool OAIGooglePayDetails::is_google_pay_token_Valid() const{
    return m_google_pay_token_isValid;
}

QString OAIGooglePayDetails::getRecurringDetailReference() const {
    return m_recurring_detail_reference;
}
void OAIGooglePayDetails::setRecurringDetailReference(const QString &recurring_detail_reference) {
    m_recurring_detail_reference = recurring_detail_reference;
    m_recurring_detail_reference_isSet = true;
}

bool OAIGooglePayDetails::is_recurring_detail_reference_Set() const{
    return m_recurring_detail_reference_isSet;
}

bool OAIGooglePayDetails::is_recurring_detail_reference_Valid() const{
    return m_recurring_detail_reference_isValid;
}

QString OAIGooglePayDetails::getStoredPaymentMethodId() const {
    return m_stored_payment_method_id;
}
void OAIGooglePayDetails::setStoredPaymentMethodId(const QString &stored_payment_method_id) {
    m_stored_payment_method_id = stored_payment_method_id;
    m_stored_payment_method_id_isSet = true;
}

bool OAIGooglePayDetails::is_stored_payment_method_id_Set() const{
    return m_stored_payment_method_id_isSet;
}

bool OAIGooglePayDetails::is_stored_payment_method_id_Valid() const{
    return m_stored_payment_method_id_isValid;
}

QString OAIGooglePayDetails::getType() const {
    return m_type;
}
void OAIGooglePayDetails::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIGooglePayDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAIGooglePayDetails::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIGooglePayDetails::isSet() const {
...
bool OAIGooglePayDetails::isValid() const {
