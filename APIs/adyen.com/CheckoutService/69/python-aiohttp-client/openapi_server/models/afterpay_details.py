...
class AfterpayDetails(Model):
    ...
    def __init__(self, billing_address: str=None, checkout_attempt_id: str=None, delivery_address: str=None, personal_details: str=None, recurring_detail_reference: str=None, stored_payment_method_id: str=None, type: str='afterpay_default'):
        """AfterpayDetails - a model defined in OpenAPI

        :param billing_address: The billing_address of this AfterpayDetails.
        :param checkout_attempt_id: The checkout_attempt_id of this AfterpayDetails.
    ...
    def checkout_attempt_id(self):
        """Gets the checkout_attempt_id of this AfterpayDetails.

        The checkout attempt identifier.

        :return: The checkout_attempt_id of this AfterpayDetails.
        :rtype: str
        """
    ...
    def checkout_attempt_id(self, checkout_attempt_id):
        """Sets the checkout_attempt_id of this AfterpayDetails.
