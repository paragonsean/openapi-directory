...
from openapi_server.models.authentication_data import AuthenticationData
...
class DonationPaymentRequest(Model):
    ...
    def __init__(self, account_info: AccountInfo=None, additional_amount: Amount=None, additional_data: BalanceCheckRequestAdditionalData=None, allowed_payment_methods: List[str]=None, amount: Amount=None, application_info: ApplicationInfo=None, authentication_data: AuthenticationData=None, billing_address: BillingAddress=None, blocked_payment_methods: List[str]=None, browser_info: BrowserInfo=None, capture_delay_hours: int=None, channel: str=None, checkout_attempt_id: str=None, company: Company=None, conversion_id: str=None, country_code: str=None, date_of_birth: datetime=None, dcc_quote: ForexQuote=None, delivery_address: DeliveryAddress=None, delivery_date: datetime=None, device_fingerprint: str=None, donation_account: str=None, donation_original_psp_reference: str=None, donation_token: str=None, enable_one_click: bool=None, enable_pay_out: bool=None, enable_recurring: bool=None, entity_type: str=None, fraud_offset: int=None, fund_origin: FundOrigin=None, fund_recipient: FundRecipient=None, funding_source: str=None, installments: Installments=None, line_items: List[LineItem]=None, localized_shopper_statement: Dict[str, str]=None, mandate: Mandate=None, mcc: str=None, merchant_account: str=None, merchant_order_reference: str=None, merchant_risk_indicator: MerchantRiskIndicator=None, metadata: Dict[str, str]=None, mpi_data: ThreeDSecureData=None, order: EncryptedOrderData=None, order_reference: str=None, origin: str=None, payment_method: DonationPaymentRequestPaymentMethod=None, platform_chargeback_logic: PlatformChargebackLogic=None, recurring_expiry: str=None, recurring_frequency: str=None, recurring_processing_model: str=None, redirect_from_issuer_method: str=None, redirect_to_issuer_method: str=None, reference: str=None, return_url: str=None, risk_data: RiskData=None, selected_recurring_detail_reference: str=None, session_validity: str=None, shopper_email: str=None, shopper_ip: str=None, shopper_interaction: str=None, shopper_locale: str=None, shopper_name: Name=None, shopper_reference: str=None, shopper_statement: str=None, social_security_number: str=None, splits: List[Split]=None, store: str=None, store_payment_method: bool=None, telephone_number: str=None, three_ds2_request_data: ThreeDS2RequestFields=None, three_ds_authentication_only: bool=False, trusted_shopper: bool=None):
        ...
        :param authentication_data: The authentication_data of this DonationPaymentRequest.
        ...
        :param checkout_attempt_id: The checkout_attempt_id of this DonationPaymentRequest.
        ...
        :param localized_shopper_statement: The localized_shopper_statement of this DonationPaymentRequest.
        ...
        :param platform_chargeback_logic: The platform_chargeback_logic of this DonationPaymentRequest.
    ...
    def authentication_data(self):
        """Gets the authentication_data of this DonationPaymentRequest.

        Data for 3DS authentication.

        :return: The authentication_data of this DonationPaymentRequest.
    ...
    def authentication_data(self, authentication_data):
        """Sets the authentication_data of this DonationPaymentRequest.

        Data for 3DS authentication.

        :param authentication_data: The authentication_data of this DonationPaymentRequest.
        :type authentication_data: AuthenticationData
        """
    ...
    def checkout_attempt_id(self):
        """Gets the checkout_attempt_id of this DonationPaymentRequest.

        Checkout attempt ID that corresponds to the Id generated by the client SDK for tracking user payment journey.

        :return: The checkout_attempt_id of this DonationPaymentRequest.
        :rtype: str
        """
    ...
    def checkout_attempt_id(self, checkout_attempt_id):
        """Sets the checkout_attempt_id of this DonationPaymentRequest.
    ...
    def localized_shopper_statement(self):
        """Gets the localized_shopper_statement of this DonationPaymentRequest.
        ...
        :return: The localized_shopper_statement of this DonationPaymentRequest.
        :rtype: Dict[str, str]
        """
    ...
    def localized_shopper_statement(self, localized_shopper_statement):
        """Sets the localized_shopper_statement of this DonationPaymentRequest.
    ...
    def platform_chargeback_logic(self):
        """Gets the platform_chargeback_logic of this DonationPaymentRequest.
        ...
        :return: The platform_chargeback_logic of this DonationPaymentRequest.
    ...
    def platform_chargeback_logic(self, platform_chargeback_logic):
        """Sets the platform_chargeback_logic of this DonationPaymentRequest.
