...
class CreateCheckoutSessionRequest(Model):
    ...
    def __init__(self, account_info: AccountInfo=None, additional_amount: Amount=None, additional_data: BalanceCheckRequestAdditionalData=None, allowed_payment_methods: List[str]=None, amount: Amount=None, application_info: ApplicationInfo=None, authentication_data: AuthenticationData=None, billing_address: BillingAddress=None, blocked_payment_methods: List[str]=None, capture_delay_hours: int=None, channel: str=None, company: Company=None, country_code: str=None, date_of_birth: date=None, deliver_at: datetime=None, delivery_address: DeliveryAddress=None, enable_one_click: bool=None, enable_pay_out: bool=None, enable_recurring: bool=None, expires_at: datetime=None, fund_origin: FundOrigin=None, fund_recipient: FundRecipient=None, installment_options: Dict[str, CheckoutSessionInstallmentOption]=None, line_items: List[LineItem]=None, mandate: Mandate=None, mcc: str=None, merchant_account: str=None, merchant_order_reference: str=None, metadata: Dict[str, str]=None, mode: str='embedded', mpi_data: ThreeDSecureData=None, recurring_expiry: str=None, recurring_frequency: str=None, recurring_processing_model: str=None, redirect_from_issuer_method: str=None, redirect_to_issuer_method: str=None, reference: str=None, return_url: str=None, risk_data: RiskData=None, shopper_email: str=None, shopper_ip: str=None, shopper_interaction: str=None, shopper_locale: str=None, shopper_name: Name=None, shopper_reference: str=None, shopper_statement: str=None, show_installment_amount: bool=None, show_remove_payment_method_button: bool=None, social_security_number: str=None, split_card_funding_sources: bool=False, splits: List[Split]=None, store: str=None, store_payment_method: bool=None, telephone_number: str=None, theme_id: str=None, three_ds_authentication_only: bool=False, trusted_shopper: bool=None):
        ...
        :param authentication_data: The authentication_data of this CreateCheckoutSessionRequest.
        ...
        :param mode: The mode of this CreateCheckoutSessionRequest.
        ...
        :param theme_id: The theme_id of this CreateCheckoutSessionRequest.
    ...
    def authentication_data(self):
        """Gets the authentication_data of this CreateCheckoutSessionRequest.

        Configuration data for 3DS payments.

        :return: The authentication_data of this CreateCheckoutSessionRequest.
    ...
    def authentication_data(self, authentication_data):
        """Sets the authentication_data of this CreateCheckoutSessionRequest.
    ...
    @property
    def mode(self):
        """Gets the mode of this CreateCheckoutSessionRequest.
        ...
        :return: The mode of this CreateCheckoutSessionRequest.
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this CreateCheckoutSessionRequest.
        ...
        :type mode: str
        """
        allowed_values = ["embedded", "hosted"]  # noqa: E501
    ...
    @property
    def theme_id(self):
        """Gets the theme_id of this CreateCheckoutSessionRequest.
        ...
        :return: The theme_id of this CreateCheckoutSessionRequest.
        :rtype: str
        """
    ...
    def theme_id(self, theme_id):
        """Sets the theme_id of this CreateCheckoutSessionRequest.
