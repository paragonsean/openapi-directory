...
class PayPalDetails(Model):
    ...
    def __init__(self, checkout_attempt_id: str=None, order_id: str=None, payee_preferred: str=None, payer_id: str=None, payer_selected: str=None, recurring_detail_reference: str=None, stored_payment_method_id: str=None, subtype: str=None, type: str='paypal'):
        """PayPalDetails - a model defined in OpenAPI

        :param checkout_attempt_id: The checkout_attempt_id of this PayPalDetails.
    ...
    def checkout_attempt_id(self):
        """Gets the checkout_attempt_id of this PayPalDetails.

        The checkout attempt identifier.

        :return: The checkout_attempt_id of this PayPalDetails.
        :rtype: str
        """
    ...
    def checkout_attempt_id(self, checkout_attempt_id):
        """Sets the checkout_attempt_id of this PayPalDetails.
