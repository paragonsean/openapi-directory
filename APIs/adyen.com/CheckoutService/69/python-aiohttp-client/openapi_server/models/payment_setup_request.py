...
class PaymentSetupRequest(Model):
    ...
    def __init__(self, additional_amount: Amount=None, additional_data: BalanceCheckRequestAdditionalData=None, allowed_payment_methods: List[str]=None, amount: Amount=None, application_info: ApplicationInfo=None, billing_address: Address=None, blocked_payment_methods: List[str]=None, capture_delay_hours: int=None, channel: str=None, checkout_attempt_id: str=None, company: Company=None, configuration: Configuration=None, conversion_id: str=None, country_code: str=None, date_of_birth: date=None, dcc_quote: ForexQuote=None, delivery_address: Address=None, delivery_date: datetime=None, enable_one_click: bool=None, enable_pay_out: bool=None, enable_recurring: bool=None, entity_type: str=None, fraud_offset: int=None, installments: Installments=None, line_items: List[LineItem]=None, localized_shopper_statement: Dict[str, str]=None, mandate: Mandate=None, mcc: str=None, merchant_account: str=None, merchant_order_reference: str=None, metadata: Dict[str, str]=None, order_reference: str=None, origin: str=None, platform_chargeback_logic: PlatformChargebackLogic=None, recurring_expiry: str=None, recurring_frequency: str=None, reference: str=None, return_url: str=None, risk_data: RiskData=None, sdk_version: str=None, session_validity: str=None, shopper_email: str=None, shopper_ip: str=None, shopper_interaction: str=None, shopper_locale: str=None, shopper_name: Name=None, shopper_reference: str=None, shopper_statement: str=None, social_security_number: str=None, splits: List[Split]=None, store: str=None, store_payment_method: bool=None, telephone_number: str=None, three_ds_authentication_only: bool=False, token: str=None, trusted_shopper: bool=None):
        ...
        :param checkout_attempt_id: The checkout_attempt_id of this PaymentSetupRequest.
        ...
        :param localized_shopper_statement: The localized_shopper_statement of this PaymentSetupRequest.
        ...
        :param platform_chargeback_logic: The platform_chargeback_logic of this PaymentSetupRequest.
    ...
    def checkout_attempt_id(self):
        """Gets the checkout_attempt_id of this PaymentSetupRequest.

        Checkout attempt ID that corresponds to the Id generated by the client SDK for tracking user payment journey.

        :return: The checkout_attempt_id of this PaymentSetupRequest.
        :rtype: str
        """
    ...
    def checkout_attempt_id(self, checkout_attempt_id):
        """Sets the checkout_attempt_id of this PaymentSetupRequest.
    ...
    def localized_shopper_statement(self):
        """Gets the localized_shopper_statement of this PaymentSetupRequest.
        ...
        :return: The localized_shopper_statement of this PaymentSetupRequest.
        :rtype: Dict[str, str]
        """
    ...
    def localized_shopper_statement(self, localized_shopper_statement):
        """Sets the localized_shopper_statement of this PaymentSetupRequest.
    ...
    def platform_chargeback_logic(self):
        """Gets the platform_chargeback_logic of this PaymentSetupRequest.
        ...
        :return: The platform_chargeback_logic of this PaymentSetupRequest.
    ...
    def platform_chargeback_logic(self, platform_chargeback_logic):
        """Sets the platform_chargeback_logic of this PaymentSetupRequest.
