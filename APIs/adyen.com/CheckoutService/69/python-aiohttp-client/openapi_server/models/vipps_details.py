...
class VippsDetails(Model):
    ...
    def __init__(self, checkout_attempt_id: str=None, recurring_detail_reference: str=None, stored_payment_method_id: str=None, telephone_number: str=None, type: str='vipps'):
        """VippsDetails - a model defined in OpenAPI

        :param checkout_attempt_id: The checkout_attempt_id of this VippsDetails.
    ...
    def checkout_attempt_id(self):
        """Gets the checkout_attempt_id of this VippsDetails.

        The checkout attempt identifier.

        :return: The checkout_attempt_id of this VippsDetails.
        :rtype: str
        """
    ...
    def checkout_attempt_id(self, checkout_attempt_id):
        """Sets the checkout_attempt_id of this VippsDetails.
