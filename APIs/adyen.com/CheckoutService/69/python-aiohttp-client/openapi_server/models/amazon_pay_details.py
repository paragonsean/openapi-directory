...
class AmazonPayDetails(Model):
    ...
    def __init__(self, amazon_pay_token: str=None, checkout_attempt_id: str=None, checkout_session_id: str=None, type: str='amazonpay'):
        """AmazonPayDetails - a model defined in OpenAPI

        :param amazon_pay_token: The amazon_pay_token of this AmazonPayDetails.
        :param checkout_attempt_id: The checkout_attempt_id of this AmazonPayDetails.
    ...
    def checkout_attempt_id(self):
        """Gets the checkout_attempt_id of this AmazonPayDetails.

        The checkout attempt identifier.

        :return: The checkout_attempt_id of this AmazonPayDetails.
        :rtype: str
        """
    ...
    def checkout_attempt_id(self, checkout_attempt_id):
        """Sets the checkout_attempt_id of this AmazonPayDetails.
