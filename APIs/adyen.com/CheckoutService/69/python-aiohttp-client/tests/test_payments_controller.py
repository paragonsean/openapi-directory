...
async def test_get_sessions_session_id(client):
    ...
    response = await client.request(
        method='GET',
        path='/v69/sessions/{session_id}'.format(session_id='session_id_example'),
        headers=headers,
        params=params,
        )
