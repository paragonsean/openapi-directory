...
/**
 * The GiropayDetails model module.
 * @module model/GiropayDetails
 * @version 69
 */
class GiropayDetails {
    /**
     * Constructs a new <code>GiropayDetails</code>.
     * @alias module:model/GiropayDetails
     */
    constructor() { 
        
        GiropayDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GiropayDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GiropayDetails} obj Optional instance to populate.
     * @return {module:model/GiropayDetails} The populated <code>GiropayDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GiropayDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>GiropayDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GiropayDetails</code>.
     */
 ...
 */
GiropayDetails.prototype['checkoutAttemptId'] = undefined;

/**
 * This is the `recurringDetailReference` returned in the response when you created the token.
 * @member {String} recurringDetailReference
 */
GiropayDetails.prototype['recurringDetailReference'] = undefined;

/**
 * This is the `recurringDetailReference` returned in the response when you created the token.
 * @member {String} storedPaymentMethodId
 */
GiropayDetails.prototype['storedPaymentMethodId'] = undefined;

/**
 * **giropay**
 * @member {module:model/GiropayDetails.TypeEnum} type
 * @default 'giropay'
 */
GiropayDetails.prototype['type'] = 'giropay';
