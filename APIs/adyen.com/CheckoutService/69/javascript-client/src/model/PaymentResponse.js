...
class PaymentResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('action')) {
                obj['action'] = PaymentResponseAction.constructFromObject(data['action']);
            }
            ...
            if (data.hasOwnProperty('paymentMethod')) {
                obj['paymentMethod'] = ResponsePaymentMethod.constructFromObject(data['paymentMethod']);
            }
            ...
            if (data.hasOwnProperty('threeDS2ResponseData')) {
                obj['threeDS2ResponseData'] = ThreeDS2ResponseData.constructFromObject(data['threeDS2ResponseData']);
            }
            if (data.hasOwnProperty('threeDS2Result')) {
                obj['threeDS2Result'] = ThreeDS2Result.constructFromObject(data['threeDS2Result']);
            }
            if (data.hasOwnProperty('threeDSPaymentData')) {
                obj['threeDSPaymentData'] = ApiClient.convertToType(data['threeDSPaymentData'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['action']) { // data not null
          PaymentResponseAction.validateJSON(data['action']);
        }
        ...
        if (data['paymentMethod']) { // data not null
          ResponsePaymentMethod.validateJSON(data['paymentMethod']);
        }
        // ensure the json data is a string
        ...
        if (data['threeDS2ResponseData']) { // data not null
          ThreeDS2ResponseData.validateJSON(data['threeDS2ResponseData']);
        }
        ...
        // ensure the json data is a string
        if (data['threeDSPaymentData'] && !(typeof data['threeDSPaymentData'] === 'string' || data['threeDSPaymentData'] instanceof String)) {
            throw new Error("Expected the field `threeDSPaymentData` to be a primitive type in the JSON string but got " + data['threeDSPaymentData']);
        }
...
/**
 * @member {module:model/PaymentResponseAction} action
 */
PaymentResponse.prototype['action'] = undefined;

/**
 * @member {module:model/BalanceCheckResponseAdditionalData} additionalData
 */
PaymentResponse.prototype['additionalData'] = undefined;
 ...
 */
PaymentResponse.prototype['donationToken'] = undefined;

/**
 * The fraud result properties of the payment.
 * @member {module:model/FraudResult} fraudResult
 */
PaymentResponse.prototype['fraudResult'] = undefined;

/**
 * The reference to uniquely identify a payment. This reference is used in all communication with you about the payment status. We recommend using a unique value per payment; however, it is not a requirement. If you need to provide multiple references for a transaction, separate them with hyphens (\"-\"). Maximum length: 80 characters.
 * @member {String} merchantReference
 */
PaymentResponse.prototype['merchantReference'] = undefined;
 ...
 */
PaymentResponse.prototype['order'] = undefined;

/**
 * Details about the payment method used in the transaction.  Only returned if `resultCode` is **Authorised**.
 * @member {module:model/ResponsePaymentMethod} paymentMethod
 */
PaymentResponse.prototype['paymentMethod'] = undefined;
 ...
 */
PaymentResponse.prototype['refusalReasonCode'] = undefined;
 ...
 * @member {module:model/PaymentResponse.ResultCodeEnum} resultCode
 */
PaymentResponse.prototype['resultCode'] = undefined;

/**
 * Response of the 3D Secure 2 authentication.
 * @member {module:model/ThreeDS2ResponseData} threeDS2ResponseData
 */
PaymentResponse.prototype['threeDS2ResponseData'] = undefined;

/**
 * Result of the 3D Secure 2 authentication.
 * @member {module:model/ThreeDS2Result} threeDS2Result
 */
PaymentResponse.prototype['threeDS2Result'] = undefined;

/**
 * When non-empty, contains a value that you must submit to the `/payments/details` endpoint as `paymentData`.
 * @member {String} threeDSPaymentData
 */
PaymentResponse.prototype['threeDSPaymentData'] = undefined;
