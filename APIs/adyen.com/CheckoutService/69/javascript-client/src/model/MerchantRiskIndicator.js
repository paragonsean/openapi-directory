...
class MerchantRiskIndicator {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('deliveryEmailAddress')) {
                obj['deliveryEmailAddress'] = ApiClient.convertToType(data['deliveryEmailAddress'], 'String');
            }
            ...
            if (data.hasOwnProperty('giftCardCurr')) {
                obj['giftCardCurr'] = ApiClient.convertToType(data['giftCardCurr'], 'String');
            }
            ...
            if (data.hasOwnProperty('preOrderPurchaseInd')) {
                obj['preOrderPurchaseInd'] = ApiClient.convertToType(data['preOrderPurchaseInd'], 'String');
            }
            if (data.hasOwnProperty('reorderItems')) {
                obj['reorderItems'] = ApiClient.convertToType(data['reorderItems'], 'Boolean');
            }
            if (data.hasOwnProperty('reorderItemsInd')) {
                obj['reorderItemsInd'] = ApiClient.convertToType(data['reorderItemsInd'], 'String');
            }
            if (data.hasOwnProperty('shipIndicator')) {
                obj['shipIndicator'] = ApiClient.convertToType(data['shipIndicator'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['deliveryEmailAddress'] && !(typeof data['deliveryEmailAddress'] === 'string' || data['deliveryEmailAddress'] instanceof String)) {
            throw new Error("Expected the field `deliveryEmailAddress` to be a primitive type in the JSON string but got " + data['deliveryEmailAddress']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['giftCardCurr'] && !(typeof data['giftCardCurr'] === 'string' || data['giftCardCurr'] instanceof String)) {
            throw new Error("Expected the field `giftCardCurr` to be a primitive type in the JSON string but got " + data['giftCardCurr']);
        }
        // ensure the json data is a string
        if (data['preOrderPurchaseInd'] && !(typeof data['preOrderPurchaseInd'] === 'string' || data['preOrderPurchaseInd'] instanceof String)) {
            throw new Error("Expected the field `preOrderPurchaseInd` to be a primitive type in the JSON string but got " + data['preOrderPurchaseInd']);
        }
        // ensure the json data is a string
        if (data['reorderItemsInd'] && !(typeof data['reorderItemsInd'] === 'string' || data['reorderItemsInd'] instanceof String)) {
            throw new Error("Expected the field `reorderItemsInd` to be a primitive type in the JSON string but got " + data['reorderItemsInd']);
        }
        // ensure the json data is a string
        if (data['shipIndicator'] && !(typeof data['shipIndicator'] === 'string' || data['shipIndicator'] instanceof String)) {
            throw new Error("Expected the field `shipIndicator` to be a primitive type in the JSON string but got " + data['shipIndicator']);
        }
 ...
 * @member {String} deliveryEmailAddress
 */
MerchantRiskIndicator.prototype['deliveryEmailAddress'] = undefined;
 ...
 * @member {String} giftCardCurr
 */
MerchantRiskIndicator.prototype['giftCardCurr'] = undefined;
 ...
 * @member {String} preOrderPurchaseInd
 */
MerchantRiskIndicator.prototype['preOrderPurchaseInd'] = undefined;
 ...
 * @member {String} reorderItemsInd
 */
MerchantRiskIndicator.prototype['reorderItemsInd'] = undefined;

/**
 * Indicates shipping method chosen for the transaction.
 * @member {String} shipIndicator
 */
MerchantRiskIndicator.prototype['shipIndicator'] = undefined;
