...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.StoredDetails();
  });
  ...
  describe('StoredDetails', function() {
    it('should create an instance of StoredDetails', function() {
      // uncomment below and update the code to test StoredDetails
      //var instance = new AdyenCheckoutApi.StoredDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.StoredDetails);
    });
