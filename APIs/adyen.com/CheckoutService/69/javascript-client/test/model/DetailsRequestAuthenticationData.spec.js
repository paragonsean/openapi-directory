...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.DetailsRequestAuthenticationData();
  });
  ...
  describe('DetailsRequestAuthenticationData', function() {
    it('should create an instance of DetailsRequestAuthenticationData', function() {
      // uncomment below and update the code to test DetailsRequestAuthenticationData
      //var instance = new AdyenCheckoutApi.DetailsRequestAuthenticationData();
      //expect(instance).to.be.a(AdyenCheckoutApi.DetailsRequestAuthenticationData);
    });
