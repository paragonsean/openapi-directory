...
(function(root, factory) {
  ...
  describe('PaymentMethodsResponse', function() {
    ...
    it('should have the property storedPaymentMethods (base name: "storedPaymentMethods")', function() {
      // uncomment below and update the code to test the property storedPaymentMethods
      //var instance = new AdyenCheckoutApi.PaymentMethodsResponse();
      //expect(instance).to.be();
    });
