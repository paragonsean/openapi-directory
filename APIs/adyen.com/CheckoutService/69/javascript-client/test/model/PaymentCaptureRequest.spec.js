...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentCaptureRequest();
  });
  ...
  describe('PaymentCaptureRequest', function() {
    it('should create an instance of PaymentCaptureRequest', function() {
      // uncomment below and update the code to test PaymentCaptureRequest
      //var instance = new AdyenCheckoutApi.PaymentCaptureRequest();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentCaptureRequest);
    });
