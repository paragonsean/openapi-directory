...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentCancelResponse();
  });
  ...
  describe('PaymentCancelResponse', function() {
    it('should create an instance of PaymentCancelResponse', function() {
      // uncomment below and update the code to test PaymentCancelResponse
      //var instance = new AdyenCheckoutApi.PaymentCancelResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentCancelResponse);
    });
