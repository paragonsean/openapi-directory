...
(function(root, factory) {
  ...
  describe('CheckoutVoucherAction', function() {
    ...
    it('should have the property passCreationToken (base name: "passCreationToken")', function() {
      // uncomment below and update the code to test the property passCreationToken
      //var instance = new AdyenCheckoutApi.CheckoutVoucherAction();
      //expect(instance).to.be();
    });
