...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.ResponsePaymentMethod();
  });
  ...
  describe('ResponsePaymentMethod', function() {
    it('should create an instance of ResponsePaymentMethod', function() {
      // uncomment below and update the code to test ResponsePaymentMethod
      //var instance = new AdyenCheckoutApi.ResponsePaymentMethod();
      //expect(instance).to.be.a(AdyenCheckoutApi.ResponsePaymentMethod);
    });
