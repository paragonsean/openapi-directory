...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.StoredPaymentMethod();
  });
  ...
  describe('StoredPaymentMethod', function() {
    it('should create an instance of StoredPaymentMethod', function() {
      // uncomment below and update the code to test StoredPaymentMethod
      //var instance = new AdyenCheckoutApi.StoredPaymentMethod();
      //expect(instance).to.be.a(AdyenCheckoutApi.StoredPaymentMethod);
    });
    ...
    it('should have the property supportedShopperInteractions (base name: "supportedShopperInteractions")', function() {
      // uncomment below and update the code to test the property supportedShopperInteractions
      //var instance = new AdyenCheckoutApi.StoredPaymentMethod();
      //expect(instance).to.be();
    });
