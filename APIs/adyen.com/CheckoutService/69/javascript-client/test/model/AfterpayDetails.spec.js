...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.AfterpayDetails();
  });
  ...
  describe('AfterpayDetails', function() {
    it('should create an instance of AfterpayDetails', function() {
      // uncomment below and update the code to test AfterpayDetails
      //var instance = new AdyenCheckoutApi.AfterpayDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.AfterpayDetails);
    });
