...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.VisaCheckoutDetails();
  });
  ...
  describe('VisaCheckoutDetails', function() {
    it('should create an instance of VisaCheckoutDetails', function() {
      // uncomment below and update the code to test VisaCheckoutDetails
      //var instance = new AdyenCheckoutApi.VisaCheckoutDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.VisaCheckoutDetails);
    });
