...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CheckoutSessionInstallmentOption();
  });
  ...
  describe('CheckoutSessionInstallmentOption', function() {
    it('should create an instance of CheckoutSessionInstallmentOption', function() {
      // uncomment below and update the code to test CheckoutSessionInstallmentOption
      //var instance = new AdyenCheckoutApi.CheckoutSessionInstallmentOption();
      //expect(instance).to.be.a(AdyenCheckoutApi.CheckoutSessionInstallmentOption);
    });
