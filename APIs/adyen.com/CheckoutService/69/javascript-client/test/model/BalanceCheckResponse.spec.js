...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.BalanceCheckResponse();
  });
  ...
  describe('BalanceCheckResponse', function() {
    it('should create an instance of BalanceCheckResponse', function() {
      // uncomment below and update the code to test BalanceCheckResponse
      //var instance = new AdyenCheckoutApi.BalanceCheckResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.BalanceCheckResponse);
    });
    ...
    it('should have the property transactionLimit (base name: "transactionLimit")', function() {
      // uncomment below and update the code to test the property transactionLimit
      //var instance = new AdyenCheckoutApi.BalanceCheckResponse();
      //expect(instance).to.be();
    });
