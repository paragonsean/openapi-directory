...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.MobilePayDetails();
  });
  ...
  describe('MobilePayDetails', function() {
    it('should create an instance of MobilePayDetails', function() {
      // uncomment below and update the code to test MobilePayDetails
      //var instance = new AdyenCheckoutApi.MobilePayDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.MobilePayDetails);
    });
