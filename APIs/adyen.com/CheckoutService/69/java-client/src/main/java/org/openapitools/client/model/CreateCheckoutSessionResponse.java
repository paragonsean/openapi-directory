...
public class CreateCheckoutSessionResponse {
  ...
  public CreateCheckoutSessionResponse additionalData(BalanceCheckRequestAdditionalData additionalData) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCheckoutSessionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCheckoutSessionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCheckoutSessionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCheckoutSessionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("sessionData") != null && !jsonObj.get("sessionData").isJsonNull()) && !jsonObj.get("sessionData").isJsonPrimitive()) {
