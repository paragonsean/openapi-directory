...
public class ThreeDSecureData {
  ...
  public ThreeDSecureData tokenAuthenticationVerificationValue(String tokenAuthenticationVerificationValue) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authenticationResponse, cavv, cavvAlgorithm, challengeCancel, directoryResponse, dsTransID, eci, riskScore, threeDSVersion, tokenAuthenticationVerificationValue, transStatusReason, xid);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("tokenAuthenticationVerificationValue") != null && !jsonObj.get("tokenAuthenticationVerificationValue").isJsonNull()) && !jsonObj.get("tokenAuthenticationVerificationValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `tokenAuthenticationVerificationValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tokenAuthenticationVerificationValue").toString()));
      }
