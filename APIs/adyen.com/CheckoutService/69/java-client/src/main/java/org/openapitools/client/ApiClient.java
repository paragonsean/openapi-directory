...
public class ApiClient {
    ...
    private String basePath = "https://checkout-test.adyen.com/v69";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/69/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://checkout-test.adyen.com/v69
