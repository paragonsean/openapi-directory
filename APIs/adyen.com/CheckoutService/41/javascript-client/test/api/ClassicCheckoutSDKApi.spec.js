...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.ClassicCheckoutSDKApi();
  });
  ...
  describe('ClassicCheckoutSDKApi', function() {
    describe('postPaymentSession', function() {
      it('should call postPaymentSession successfully', function(done) {
        //uncomment below and update the code to test postPaymentSession
        //instance.postPaymentSession(function(error) {
    ...
    describe('postPaymentsResult', function() {
      it('should call postPaymentsResult successfully', function(done) {
        //uncomment below and update the code to test postPaymentsResult
        //instance.postPaymentsResult(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
