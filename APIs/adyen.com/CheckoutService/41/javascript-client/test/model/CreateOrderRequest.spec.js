...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CreateOrderRequest();
  });
  ...
  describe('CreateOrderRequest', function() {
    it('should create an instance of CreateOrderRequest', function() {
      ...
      //var instance = new AdyenCheckoutApi.CreateOrderRequest();
      //expect(instance).to.be.a(AdyenCheckoutApi.CreateOrderRequest);
    });
