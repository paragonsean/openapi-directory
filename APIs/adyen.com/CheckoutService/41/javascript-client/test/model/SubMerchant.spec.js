...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.SubMerchant();
  });
  ...
  describe('SubMerchant', function() {
    it('should create an instance of SubMerchant', function() {
      // uncomment below and update the code to test SubMerchant
      //var instance = new AdyenCheckoutApi.SubMerchant();
      //expect(instance).to.be.a(AdyenCheckoutApi.SubMerchant);
    });
