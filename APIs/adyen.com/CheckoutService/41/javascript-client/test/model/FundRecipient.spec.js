...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.FundRecipient();
  });
  ...
  describe('FundRecipient', function() {
    it('should create an instance of FundRecipient', function() {
      // uncomment below and update the code to test FundRecipient
      //var instance = new AdyenCheckoutApi.FundRecipient();
      //expect(instance).to.be.a(AdyenCheckoutApi.FundRecipient);
    });
    ...
    it('should have the property walletOwnerTaxId (base name: "walletOwnerTaxId")', function() {
      // uncomment below and update the code to test the property walletOwnerTaxId
      //var instance = new AdyenCheckoutApi.FundRecipient();
      //expect(instance).to.be();
    });
