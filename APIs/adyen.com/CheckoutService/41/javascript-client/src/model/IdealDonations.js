...
/**
 * The IdealDonations model module.
 * @module model/IdealDonations
 * @version 41
 */
class IdealDonations {
    /**
     * Constructs a new <code>IdealDonations</code>.
     * @alias module:model/IdealDonations
    ...
    constructor(issuer) { 
        ...
        IdealDonations.initialize(this, issuer);
    }
    ...
    /**
     * Constructs a <code>IdealDonations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IdealDonations} obj Optional instance to populate.
     * @return {module:model/IdealDonations} The populated <code>IdealDonations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IdealDonations();
    ...
    /**
     * Validates the JSON data with respect to <code>IdealDonations</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IdealDonations</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IdealDonations.RequiredProperties) {
...
IdealDonations.RequiredProperties = ["issuer"];

/**
 * The iDEAL issuer value of the shopper's selected bank. Set this to an **id** of an iDEAL issuer to preselect it.
 * @member {String} issuer
 */
IdealDonations.prototype['issuer'] = undefined;

/**
 * This is the `recurringDetailReference` returned in the response when you created the token.
 * @member {String} recurringDetailReference
 */
IdealDonations.prototype['recurringDetailReference'] = undefined;

/**
 * **ideal**
 * @member {module:model/IdealDonations.TypeEnum} type
 * @default 'ideal'
 */
IdealDonations.prototype['type'] = 'ideal';
