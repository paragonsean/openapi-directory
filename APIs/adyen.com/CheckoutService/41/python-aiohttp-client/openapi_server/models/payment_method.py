...
class PaymentMethod(Model):
    ...
    def __init__(self, configuration: Dict[str, str]=None, details: List[InputDetail]=None, group: PaymentMethodGroup=None, input_details: List[InputDetail]=None, name: str=None, supports_recurring: bool=None, type: str=None):
