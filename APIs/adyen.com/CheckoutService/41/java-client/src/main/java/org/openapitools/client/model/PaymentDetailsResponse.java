...
public class PaymentDetailsResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalData, authentication, details, fraudResult, merchantReference, order, outputDetails, paymentData, pspReference, redirect, refusalReason, refusalReasonCode, resultCode, shopperLocale, threeDS2Result);
  }
