...
/*
 * OAIPayWithGoogleDonations.h
 *
 * 
 */

#ifndef OAIPayWithGoogleDonations_H
#define OAIPayWithGoogleDonations_H
...
class OAIPayWithGoogleDonations : public OAIObject {
public:
    OAIPayWithGoogleDonations();
    OAIPayWithGoogleDonations(QString json);
    ~OAIPayWithGoogleDonations() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayWithGoogleDonations)

#endif // OAIPayWithGoogleDonations_H
