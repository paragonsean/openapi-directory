...
/*
 * OAIPaymentCaptureRequest.h
 *
 * 
 */

#ifndef OAIPaymentCaptureRequest_H
#define OAIPaymentCaptureRequest_H
...
class OAIPaymentCaptureRequest : public OAIObject {
public:
    OAIPaymentCaptureRequest();
    OAIPaymentCaptureRequest(QString json);
    ~OAIPaymentCaptureRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentCaptureRequest)

#endif // OAIPaymentCaptureRequest_H
