...
#ifndef OAIInputDetail_H
#define OAIInputDetail_H
...
namespace OpenAPI {
class OAISubInputDetail;
class OAIItem;

class OAIInputDetail : public OAIObject {
public:
    OAIInputDetail();
    OAIInputDetail(QString json);
    ~OAIInputDetail() override;
    ...
    QList<OAISubInputDetail> getDetails() const;
    void setDetails(const QList<OAISubInputDetail> &details);
    bool is_details_Set() const;
    bool is_details_Valid() const;

    QList<OAISubInputDetail> getInputDetails() const;
    void setInputDetails(const QList<OAISubInputDetail> &input_details);
    bool is_input_details_Set() const;
    bool is_input_details_Valid() const;

    QString getItemSearchUrl() const;
    void setItemSearchUrl(const QString &item_search_url);
    bool is_item_search_url_Set() const;
    bool is_item_search_url_Valid() const;
...
private:
    ...
    QList<OAISubInputDetail> m_details;
    bool m_details_isSet;
    bool m_details_isValid;

    QList<OAISubInputDetail> m_input_details;
    bool m_input_details_isSet;
    bool m_input_details_isValid;

    QString m_item_search_url;
    bool m_item_search_url_isSet;
    bool m_item_search_url_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputDetail)

#endif // OAIInputDetail_H
