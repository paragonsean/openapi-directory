...
/*
 * OAIInstallmentOption.h
 *
 * 
 */

#ifndef OAIInstallmentOption_H
#define OAIInstallmentOption_H
...
class OAIInstallmentOption : public OAIObject {
public:
    OAIInstallmentOption();
    OAIInstallmentOption(QString json);
    ~OAIInstallmentOption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstallmentOption)

#endif // OAIInstallmentOption_H
