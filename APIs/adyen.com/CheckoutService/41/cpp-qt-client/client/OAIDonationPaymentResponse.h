...
/*
 * OAIDonationPaymentResponse.h
 *
 * 
 */

#ifndef OAIDonationPaymentResponse_H
#define OAIDonationPaymentResponse_H
...
class OAIDonationPaymentResponse : public OAIObject {
public:
    OAIDonationPaymentResponse();
    OAIDonationPaymentResponse(QString json);
    ~OAIDonationPaymentResponse() override;
    ...
    OAIPaymentResponse getPayment() const;
    void setPayment(const OAIPaymentResponse &payment);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDonationPaymentResponse)

#endif // OAIDonationPaymentResponse_H
