...
/*
 * OAICardDetailsRequest.h
 *
 * 
 */

#ifndef OAICardDetailsRequest_H
#define OAICardDetailsRequest_H
...
class OAICardDetailsRequest : public OAIObject {
public:
    OAICardDetailsRequest();
    OAICardDetailsRequest(QString json);
    ~OAICardDetailsRequest() override;
    ...
    QList<QString> getSupportedBrands() const;
    void setSupportedBrands(const QList<QString> &supported_brands);
    bool is_supported_brands_Set() const;
    bool is_supported_brands_Valid() const;
...
private:
    ...
    QList<QString> m_supported_brands;
    bool m_supported_brands_isSet;
    bool m_supported_brands_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICardDetailsRequest)

#endif // OAICardDetailsRequest_H
