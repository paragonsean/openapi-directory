...
|------------ | ------------- | ------------- | -------------|
|**action** | [**PaymentDetailsResponseAction**](PaymentDetailsResponseAction.md) |  |  [optional] |
...
|**authentication** | **Map&lt;String, String&gt;** | Contains &#x60;threeds2.fingerprint&#x60; or &#x60;threeds2.challengeToken&#x60; values to be used in further calls to &#x60;/payments/details&#x60; endpoint.  |  [optional] |
|**details** | [**List&lt;InputDetail&gt;**](InputDetail.md) | When non-empty, contains all the fields that you must submit to the &#x60;/payments/details&#x60; endpoint. |  [optional] |
|**donationToken** | **String** | Donation Token containing payment details for Adyen Giving. |  [optional] |
|**fraudResult** | [**FraudResult**](FraudResult.md) | The fraud result properties of the payment. |  [optional] |
|**merchantReference** | **String** | The reference used during the /payments request. |  [optional] |
...
|**outputDetails** | **Map&lt;String, String&gt;** | Contains the details that will be presented to the shopper. |  [optional] |
