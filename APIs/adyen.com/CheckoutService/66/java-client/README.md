...
Adyen Checkout API
- API version: 66
  - Build date: 2024-10-12T11:15:32.352884-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:66"
  }
```
...
* `target/openapi-java-client-66.jar`
* `target/lib/*.jar`
...
## Documentation for Models
 ...
 - [CheckoutThreeDS2ChallengeAction](docs/CheckoutThreeDS2ChallengeAction.md)
 - [CheckoutThreeDS2FingerPrintAction](docs/CheckoutThreeDS2FingerPrintAction.md)
 ...
 - [PaymentDetailsResponseAction](docs/PaymentDetailsResponseAction.md)
