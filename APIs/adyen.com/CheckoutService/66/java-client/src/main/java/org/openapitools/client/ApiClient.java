...
public class ApiClient {
    ...
    private String basePath = "https://checkout-test.adyen.com/v66";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/66/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://checkout-test.adyen.com/v66
