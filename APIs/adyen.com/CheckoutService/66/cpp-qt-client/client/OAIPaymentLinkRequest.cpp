...
bool OAIPaymentLinkRequest::isStorePaymentMethod() const {
    return m_store_payment_method;
}
void OAIPaymentLinkRequest::setStorePaymentMethod(const bool &store_payment_method) {
    m_store_payment_method = store_payment_method;
    m_store_payment_method_isSet = true;
}

bool OAIPaymentLinkRequest::is_store_payment_method_Set() const{
    return m_store_payment_method_isSet;
}

bool OAIPaymentLinkRequest::is_store_payment_method_Valid() const{
