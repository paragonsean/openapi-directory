...
/*
 * OAIPaymentCancelRequest.h
 *
 * 
 */

#ifndef OAIPaymentCancelRequest_H
#define OAIPaymentCancelRequest_H
...
class OAIPaymentCancelRequest : public OAIObject {
public:
    OAIPaymentCancelRequest();
    OAIPaymentCancelRequest(QString json);
    ~OAIPaymentCancelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentCancelRequest)

#endif // OAIPaymentCancelRequest_H
