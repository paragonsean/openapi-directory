...
/*
 * OAICheckoutSDKAction.h
 *
 * 
 */

#ifndef OAICheckoutSDKAction_H
#define OAICheckoutSDKAction_H
...
class OAICheckoutSDKAction : public OAIObject {
public:
    OAICheckoutSDKAction();
    OAICheckoutSDKAction(QString json);
    ~OAICheckoutSDKAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckoutSDKAction)

#endif // OAICheckoutSDKAction_H
