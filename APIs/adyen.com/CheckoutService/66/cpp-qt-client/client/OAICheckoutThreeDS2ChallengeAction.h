...
/*
 * OAICheckoutThreeDS2ChallengeAction.h
 *
 * 
 */

#ifndef OAICheckoutThreeDS2ChallengeAction_H
#define OAICheckoutThreeDS2ChallengeAction_H
...
class OAICheckoutThreeDS2ChallengeAction : public OAIObject {
public:
    OAICheckoutThreeDS2ChallengeAction();
    OAICheckoutThreeDS2ChallengeAction(QString json);
    ~OAICheckoutThreeDS2ChallengeAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckoutThreeDS2ChallengeAction)

#endif // OAICheckoutThreeDS2ChallengeAction_H
