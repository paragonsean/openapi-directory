...
/*
 * OAIEcontextVoucherDetails.h
 *
 * 
 */

#ifndef OAIEcontextVoucherDetails_H
#define OAIEcontextVoucherDetails_H
...
class OAIEcontextVoucherDetails : public OAIObject {
public:
    OAIEcontextVoucherDetails();
    OAIEcontextVoucherDetails(QString json);
    ~OAIEcontextVoucherDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEcontextVoucherDetails)

#endif // OAIEcontextVoucherDetails_H
