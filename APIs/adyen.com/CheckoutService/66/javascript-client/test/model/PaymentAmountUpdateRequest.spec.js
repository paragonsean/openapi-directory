...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentAmountUpdateRequest();
  });
  ...
  describe('PaymentAmountUpdateRequest', function() {
    it('should create an instance of PaymentAmountUpdateRequest', function() {
      // uncomment below and update the code to test PaymentAmountUpdateRequest
      //var instance = new AdyenCheckoutApi.PaymentAmountUpdateRequest();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentAmountUpdateRequest);
    });
