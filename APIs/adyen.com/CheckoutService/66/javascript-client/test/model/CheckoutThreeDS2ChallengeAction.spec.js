...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CheckoutThreeDS2ChallengeAction();
  });
  ...
  describe('CheckoutThreeDS2ChallengeAction', function() {
    it('should create an instance of CheckoutThreeDS2ChallengeAction', function() {
      // uncomment below and update the code to test CheckoutThreeDS2ChallengeAction
      //var instance = new AdyenCheckoutApi.CheckoutThreeDS2ChallengeAction();
      //expect(instance).to.be.a(AdyenCheckoutApi.CheckoutThreeDS2ChallengeAction);
    });
