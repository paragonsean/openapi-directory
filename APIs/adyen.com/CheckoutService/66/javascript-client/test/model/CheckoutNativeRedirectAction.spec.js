...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CheckoutNativeRedirectAction();
  });
  ...
  describe('CheckoutNativeRedirectAction', function() {
    it('should create an instance of CheckoutNativeRedirectAction', function() {
      // uncomment below and update the code to test CheckoutNativeRedirectAction
      //var instance = new AdyenCheckoutApi.CheckoutNativeRedirectAction();
      //expect(instance).to.be.a(AdyenCheckoutApi.CheckoutNativeRedirectAction);
    });
