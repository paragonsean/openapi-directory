...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.KlarnaDetails();
  });
  ...
  describe('KlarnaDetails', function() {
    it('should create an instance of KlarnaDetails', function() {
      // uncomment below and update the code to test KlarnaDetails
      //var instance = new AdyenCheckoutApi.KlarnaDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.KlarnaDetails);
    });
