...
from openapi_server.models.payment_details_response_action import PaymentDetailsResponseAction
...
class PaymentDetailsResponse(Model):
    ...
    def __init__(self, action: PaymentDetailsResponseAction=None, additional_data: BalanceCheckResponseAdditionalData=None, amount: Amount=None, authentication: Dict[str, str]=None, details: List[InputDetail]=None, donation_token: str=None, fraud_result: FraudResult=None, merchant_reference: str=None, order: CheckoutOrderResponse=None, output_details: Dict[str, str]=None, payment_data: str=None, psp_reference: str=None, redirect: Redirect=None, refusal_reason: str=None, refusal_reason_code: str=None, result_code: str=None, shopper_locale: str=None, three_ds2_result: ThreeDS2Result=None):
        """PaymentDetailsResponse - a model defined in OpenAPI

        :param action: The action of this PaymentDetailsResponse.
        ...
        """
        self.openapi_types = {
            'action': PaymentDetailsResponseAction,
    ...
    @property
    def action(self):
        """Gets the action of this PaymentDetailsResponse.


        :return: The action of this PaymentDetailsResponse.
        :rtype: PaymentDetailsResponseAction
        """
        return self._action

    @action.setter
    def action(self, action):
        """Sets the action of this PaymentDetailsResponse.


        :param action: The action of this PaymentDetailsResponse.
        :type action: PaymentDetailsResponseAction
        """
