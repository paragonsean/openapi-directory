...
class UpdatePaymentLinkRequest(Model):
    ...
    def __init__(self, status: str=None):
        """UpdatePaymentLinkRequest - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdatePaymentLinkRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdatePaymentLinkRequest of this UpdatePaymentLinkRequest.
        """
