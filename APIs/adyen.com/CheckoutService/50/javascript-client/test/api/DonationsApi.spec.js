...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.DonationsApi();
  });
  ...
  describe('DonationsApi', function() {
    describe('postDonations', function() {
      it('should call postDonations successfully', function(done) {
        //uncomment below and update the code to test postDonations
        //instance.postDonations(function(error) {
