...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.Avs();
  });
  ...
  describe('Avs', function() {
    it('should create an instance of Avs', function() {
      // uncomment below and update the code to test Avs
      //var instance = new AdyenCheckoutApi.Avs();
      //expect(instance).to.be.a(AdyenCheckoutApi.Avs);
    });

    it('should have the property addressEditable (base name: "addressEditable")', function() {
      // uncomment below and update the code to test the property addressEditable
      //var instance = new AdyenCheckoutApi.Avs();
