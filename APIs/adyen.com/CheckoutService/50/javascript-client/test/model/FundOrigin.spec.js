...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.FundOrigin();
  });
  ...
  describe('FundOrigin', function() {
    it('should create an instance of FundOrigin', function() {
      // uncomment below and update the code to test FundOrigin
      //var instance = new AdyenCheckoutApi.FundOrigin();
      //expect(instance).to.be.a(AdyenCheckoutApi.FundOrigin);
    });
