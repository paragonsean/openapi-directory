...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentDetailsResponseAction();
  });
  ...
  describe('PaymentDetailsResponseAction', function() {
    it('should create an instance of PaymentDetailsResponseAction', function() {
      // uncomment below and update the code to test PaymentDetailsResponseAction
      //var instance = new AdyenCheckoutApi.PaymentDetailsResponseAction();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentDetailsResponseAction);
    });
