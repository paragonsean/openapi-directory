...
public class AdditionalDataCommon {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdditionalDataCommon
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdditionalDataCommon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdditionalDataCommon.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdditionalDataCommon` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("RequestedTestErrorResponseCode") != null && !jsonObj.get("RequestedTestErrorResponseCode").isJsonNull()) && !jsonObj.get("RequestedTestErrorResponseCode").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("allowPartialAuth") != null && !jsonObj.get("allowPartialAuth").isJsonNull()) && !jsonObj.get("allowPartialAuth").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("customRoutingFlag") != null && !jsonObj.get("customRoutingFlag").isJsonNull()) && !jsonObj.get("customRoutingFlag").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("manualCapture") != null && !jsonObj.get("manualCapture").isJsonNull()) && !jsonObj.get("manualCapture").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("overwriteBrand") != null && !jsonObj.get("overwriteBrand").isJsonNull()) && !jsonObj.get("overwriteBrand").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchantCity") != null && !jsonObj.get("subMerchantCity").isJsonNull()) && !jsonObj.get("subMerchantCity").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchantCountry") != null && !jsonObj.get("subMerchantCountry").isJsonNull()) && !jsonObj.get("subMerchantCountry").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchantName") != null && !jsonObj.get("subMerchantName").isJsonNull()) && !jsonObj.get("subMerchantName").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchantPostalCode") != null && !jsonObj.get("subMerchantPostalCode").isJsonNull()) && !jsonObj.get("subMerchantPostalCode").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchantState") != null && !jsonObj.get("subMerchantState").isJsonNull()) && !jsonObj.get("subMerchantState").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchantStreet") != null && !jsonObj.get("subMerchantStreet").isJsonNull()) && !jsonObj.get("subMerchantStreet").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("subMerchantTaxId") != null && !jsonObj.get("subMerchantTaxId").isJsonNull()) && !jsonObj.get("subMerchantTaxId").isJsonPrimitive()) {
