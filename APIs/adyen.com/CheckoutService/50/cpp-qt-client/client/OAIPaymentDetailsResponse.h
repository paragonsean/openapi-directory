...
namespace OpenAPI {
class OAIPaymentDetailsResponse_action;
...
public:
    ...
    OAIPaymentDetailsResponse_action getAction() const;
    void setAction(const OAIPaymentDetailsResponse_action &action);
    ...
    QMap<QString, QString> getAuthentication() const;
    void setAuthentication(const QMap<QString, QString> &authentication);
...
private:
    ...
    OAIPaymentDetailsResponse_action m_action;
    bool m_action_isSet;
    ...
    QMap<QString, QString> m_authentication;
