...
OAIPaymentCaptureResponse::OAIPaymentCaptureResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentCaptureResponse::OAIPaymentCaptureResponse() {
    this->initializeModel();
}

OAIPaymentCaptureResponse::~OAIPaymentCaptureResponse() {}

void OAIPaymentCaptureResponse::initializeModel() {
...
void OAIPaymentCaptureResponse::fromJson(QString jsonString) {
...
void OAIPaymentCaptureResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentCaptureResponse::asJson() const {
...
QJsonObject OAIPaymentCaptureResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_amount.isSet()) {
...
OAIAmount OAIPaymentCaptureResponse::getAmount() const {
    return m_amount;
}
void OAIPaymentCaptureResponse::setAmount(const OAIAmount &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIPaymentCaptureResponse::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIPaymentCaptureResponse::is_amount_Valid() const{
    return m_amount_isValid;
}

QList<OAILineItem> OAIPaymentCaptureResponse::getLineItems() const {
    return m_line_items;
}
void OAIPaymentCaptureResponse::setLineItems(const QList<OAILineItem> &line_items) {
    m_line_items = line_items;
    m_line_items_isSet = true;
}

bool OAIPaymentCaptureResponse::is_line_items_Set() const{
    return m_line_items_isSet;
}

bool OAIPaymentCaptureResponse::is_line_items_Valid() const{
    return m_line_items_isValid;
}

QString OAIPaymentCaptureResponse::getMerchantAccount() const {
    return m_merchant_account;
}
void OAIPaymentCaptureResponse::setMerchantAccount(const QString &merchant_account) {
    m_merchant_account = merchant_account;
    m_merchant_account_isSet = true;
}

bool OAIPaymentCaptureResponse::is_merchant_account_Set() const{
    return m_merchant_account_isSet;
}

bool OAIPaymentCaptureResponse::is_merchant_account_Valid() const{
    return m_merchant_account_isValid;
}

QString OAIPaymentCaptureResponse::getPaymentPspReference() const {
    return m_payment_psp_reference;
}
void OAIPaymentCaptureResponse::setPaymentPspReference(const QString &payment_psp_reference) {
    m_payment_psp_reference = payment_psp_reference;
    m_payment_psp_reference_isSet = true;
}

bool OAIPaymentCaptureResponse::is_payment_psp_reference_Set() const{
    return m_payment_psp_reference_isSet;
}

bool OAIPaymentCaptureResponse::is_payment_psp_reference_Valid() const{
    return m_payment_psp_reference_isValid;
}

QString OAIPaymentCaptureResponse::getPspReference() const {
    return m_psp_reference;
}
void OAIPaymentCaptureResponse::setPspReference(const QString &psp_reference) {
    m_psp_reference = psp_reference;
    m_psp_reference_isSet = true;
}

bool OAIPaymentCaptureResponse::is_psp_reference_Set() const{
    return m_psp_reference_isSet;
}

bool OAIPaymentCaptureResponse::is_psp_reference_Valid() const{
    return m_psp_reference_isValid;
}

QString OAIPaymentCaptureResponse::getReference() const {
    return m_reference;
}
void OAIPaymentCaptureResponse::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAIPaymentCaptureResponse::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAIPaymentCaptureResponse::is_reference_Valid() const{
    return m_reference_isValid;
}

QList<OAISplit> OAIPaymentCaptureResponse::getSplits() const {
    return m_splits;
}
void OAIPaymentCaptureResponse::setSplits(const QList<OAISplit> &splits) {
    m_splits = splits;
    m_splits_isSet = true;
}

bool OAIPaymentCaptureResponse::is_splits_Set() const{
    return m_splits_isSet;
}

bool OAIPaymentCaptureResponse::is_splits_Valid() const{
    return m_splits_isValid;
}

QString OAIPaymentCaptureResponse::getStatus() const {
    return m_status;
}
void OAIPaymentCaptureResponse::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPaymentCaptureResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPaymentCaptureResponse::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPaymentCaptureResponse::isSet() const {
...
bool OAIPaymentCaptureResponse::isValid() const {
