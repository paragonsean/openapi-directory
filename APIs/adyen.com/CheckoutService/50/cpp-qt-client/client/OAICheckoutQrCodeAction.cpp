...
OAICheckoutQrCodeAction::OAICheckoutQrCodeAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICheckoutQrCodeAction::OAICheckoutQrCodeAction() {
    this->initializeModel();
}

OAICheckoutQrCodeAction::~OAICheckoutQrCodeAction() {}

void OAICheckoutQrCodeAction::initializeModel() {
...
void OAICheckoutQrCodeAction::fromJson(QString jsonString) {
...
void OAICheckoutQrCodeAction::fromJsonObject(QJsonObject json) {
...
QString OAICheckoutQrCodeAction::asJson() const {
...
QJsonObject OAICheckoutQrCodeAction::asJsonObject() const {
    QJsonObject obj;
...
QString OAICheckoutQrCodeAction::getExpiresAt() const {
    return m_expires_at;
}
void OAICheckoutQrCodeAction::setExpiresAt(const QString &expires_at) {
    m_expires_at = expires_at;
    m_expires_at_isSet = true;
}

bool OAICheckoutQrCodeAction::is_expires_at_Set() const{
    return m_expires_at_isSet;
}

bool OAICheckoutQrCodeAction::is_expires_at_Valid() const{
    return m_expires_at_isValid;
}

QString OAICheckoutQrCodeAction::getPaymentData() const {
    return m_payment_data;
}
void OAICheckoutQrCodeAction::setPaymentData(const QString &payment_data) {
    m_payment_data = payment_data;
    m_payment_data_isSet = true;
}

bool OAICheckoutQrCodeAction::is_payment_data_Set() const{
    return m_payment_data_isSet;
}

bool OAICheckoutQrCodeAction::is_payment_data_Valid() const{
    return m_payment_data_isValid;
}

QString OAICheckoutQrCodeAction::getPaymentMethodType() const {
    return m_payment_method_type;
}
void OAICheckoutQrCodeAction::setPaymentMethodType(const QString &payment_method_type) {
    m_payment_method_type = payment_method_type;
    m_payment_method_type_isSet = true;
}

bool OAICheckoutQrCodeAction::is_payment_method_type_Set() const{
    return m_payment_method_type_isSet;
}

bool OAICheckoutQrCodeAction::is_payment_method_type_Valid() const{
    return m_payment_method_type_isValid;
}

QString OAICheckoutQrCodeAction::getQrCodeData() const {
    return m_qr_code_data;
}
void OAICheckoutQrCodeAction::setQrCodeData(const QString &qr_code_data) {
    m_qr_code_data = qr_code_data;
    m_qr_code_data_isSet = true;
}

bool OAICheckoutQrCodeAction::is_qr_code_data_Set() const{
    return m_qr_code_data_isSet;
}

bool OAICheckoutQrCodeAction::is_qr_code_data_Valid() const{
    return m_qr_code_data_isValid;
}

QString OAICheckoutQrCodeAction::getType() const {
    return m_type;
}
void OAICheckoutQrCodeAction::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICheckoutQrCodeAction::is_type_Set() const{
    return m_type_isSet;
}

bool OAICheckoutQrCodeAction::is_type_Valid() const{
    return m_type_isValid;
}

QString OAICheckoutQrCodeAction::getUrl() const {
    return m_url;
}
void OAICheckoutQrCodeAction::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAICheckoutQrCodeAction::is_url_Set() const{
    return m_url_isSet;
}

bool OAICheckoutQrCodeAction::is_url_Valid() const{
    return m_url_isValid;
}

bool OAICheckoutQrCodeAction::isSet() const {
...
bool OAICheckoutQrCodeAction::isValid() const {
