...
/*
 * OAIOpenInvoiceDetails.h
 *
 * 
 */

#ifndef OAIOpenInvoiceDetails_H
#define OAIOpenInvoiceDetails_H
...
class OAIOpenInvoiceDetails : public OAIObject {
public:
    OAIOpenInvoiceDetails();
    OAIOpenInvoiceDetails(QString json);
    ~OAIOpenInvoiceDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOpenInvoiceDetails)

#endif // OAIOpenInvoiceDetails_H
