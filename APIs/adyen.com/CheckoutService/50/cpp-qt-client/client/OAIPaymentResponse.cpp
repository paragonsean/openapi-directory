...
QMap<QString, QString> OAIPaymentResponse::getAuthentication() const {
    return m_authentication;
}
void OAIPaymentResponse::setAuthentication(const QMap<QString, QString> &authentication) {
    m_authentication = authentication;
    m_authentication_isSet = true;
}

bool OAIPaymentResponse::is_authentication_Set() const{
    return m_authentication_isSet;
}

bool OAIPaymentResponse::is_authentication_Valid() const{
    return m_authentication_isValid;
}

QList<OAIInputDetail> OAIPaymentResponse::getDetails() const {
    return m_details;
}
void OAIPaymentResponse::setDetails(const QList<OAIInputDetail> &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAIPaymentResponse::is_details_Set() const{
    return m_details_isSet;
}

bool OAIPaymentResponse::is_details_Valid() const{
...
QMap<QString, QString> OAIPaymentResponse::getOutputDetails() const {
    return m_output_details;
}
void OAIPaymentResponse::setOutputDetails(const QMap<QString, QString> &output_details) {
    m_output_details = output_details;
    m_output_details_isSet = true;
}

bool OAIPaymentResponse::is_output_details_Set() const{
    return m_output_details_isSet;
}

bool OAIPaymentResponse::is_output_details_Valid() const{
    return m_output_details_isValid;
}

QString OAIPaymentResponse::getPaymentData() const {
    return m_payment_data;
}
void OAIPaymentResponse::setPaymentData(const QString &payment_data) {
    m_payment_data = payment_data;
    m_payment_data_isSet = true;
}

bool OAIPaymentResponse::is_payment_data_Set() const{
    return m_payment_data_isSet;
}

bool OAIPaymentResponse::is_payment_data_Valid() const{
...
OAIRedirect OAIPaymentResponse::getRedirect() const {
    return m_redirect;
}
void OAIPaymentResponse::setRedirect(const OAIRedirect &redirect) {
    m_redirect = redirect;
    m_redirect_isSet = true;
}

bool OAIPaymentResponse::is_redirect_Set() const{
    return m_redirect_isSet;
}

bool OAIPaymentResponse::is_redirect_Valid() const{
