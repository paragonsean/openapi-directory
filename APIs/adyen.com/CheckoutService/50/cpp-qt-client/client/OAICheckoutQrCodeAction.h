...
/*
 * OAICheckoutQrCodeAction.h
 *
 * 
 */

#ifndef OAICheckoutQrCodeAction_H
#define OAICheckoutQrCodeAction_H
...
class OAICheckoutQrCodeAction : public OAIObject {
public:
    OAICheckoutQrCodeAction();
    OAICheckoutQrCodeAction(QString json);
    ~OAICheckoutQrCodeAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckoutQrCodeAction)

#endif // OAICheckoutQrCodeAction_H
