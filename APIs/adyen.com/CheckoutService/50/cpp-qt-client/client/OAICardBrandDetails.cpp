...
OAICardBrandDetails::OAICardBrandDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICardBrandDetails::OAICardBrandDetails() {
    this->initializeModel();
}

OAICardBrandDetails::~OAICardBrandDetails() {}

void OAICardBrandDetails::initializeModel() {
...
void OAICardBrandDetails::fromJson(QString jsonString) {
...
void OAICardBrandDetails::fromJsonObject(QJsonObject json) {
...
QString OAICardBrandDetails::asJson() const {
...
QJsonObject OAICardBrandDetails::asJsonObject() const {
    QJsonObject obj;
...
bool OAICardBrandDetails::isSupported() const {
    return m_supported;
}
void OAICardBrandDetails::setSupported(const bool &supported) {
    m_supported = supported;
    m_supported_isSet = true;
}

bool OAICardBrandDetails::is_supported_Set() const{
    return m_supported_isSet;
}

bool OAICardBrandDetails::is_supported_Valid() const{
    return m_supported_isValid;
}

QString OAICardBrandDetails::getType() const {
    return m_type;
}
void OAICardBrandDetails::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICardBrandDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAICardBrandDetails::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICardBrandDetails::isSet() const {
...
bool OAICardBrandDetails::isValid() const {
