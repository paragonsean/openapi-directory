...
/*
 * OAIGooglePayDonations.h
 *
 * 
 */

#ifndef OAIGooglePayDonations_H
#define OAIGooglePayDonations_H
...
class OAIGooglePayDonations : public OAIObject {
public:
    OAIGooglePayDonations();
    OAIGooglePayDonations(QString json);
    ~OAIGooglePayDonations() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGooglePayDonations)

#endif // OAIGooglePayDonations_H
