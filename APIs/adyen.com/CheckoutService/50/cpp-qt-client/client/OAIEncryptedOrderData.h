...
/*
 * OAIEncryptedOrderData.h
 *
 * 
 */

#ifndef OAIEncryptedOrderData_H
#define OAIEncryptedOrderData_H
...
class OAIEncryptedOrderData : public OAIObject {
public:
    OAIEncryptedOrderData();
    OAIEncryptedOrderData(QString json);
    ~OAIEncryptedOrderData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEncryptedOrderData)

#endif // OAIEncryptedOrderData_H
