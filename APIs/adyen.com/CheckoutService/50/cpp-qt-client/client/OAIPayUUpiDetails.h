...
#ifndef OAIPayUUpiDetails_H
#define OAIPayUUpiDetails_H
...
class OAIPayUUpiDetails : public OAIObject {
public:
    OAIPayUUpiDetails();
    OAIPayUUpiDetails(QString json);
    ~OAIPayUUpiDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayUUpiDetails)

#endif // OAIPayUUpiDetails_H
