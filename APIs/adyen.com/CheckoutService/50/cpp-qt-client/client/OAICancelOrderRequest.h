...
/*
 * OAICancelOrderRequest.h
 *
 * 
 */

#ifndef OAICancelOrderRequest_H
#define OAICancelOrderRequest_H
...
class OAICancelOrderRequest : public OAIObject {
public:
    OAICancelOrderRequest();
    OAICancelOrderRequest(QString json);
    ~OAICancelOrderRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelOrderRequest)

#endif // OAICancelOrderRequest_H
