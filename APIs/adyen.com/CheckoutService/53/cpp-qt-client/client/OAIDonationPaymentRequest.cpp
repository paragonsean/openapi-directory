...
bool OAIDonationPaymentRequest::isEnableRealTimeUpdate() const {
    return m_enable_real_time_update;
}
void OAIDonationPaymentRequest::setEnableRealTimeUpdate(const bool &enable_real_time_update) {
    m_enable_real_time_update = enable_real_time_update;
    m_enable_real_time_update_isSet = true;
}

bool OAIDonationPaymentRequest::is_enable_real_time_update_Set() const{
    return m_enable_real_time_update_isSet;
}

bool OAIDonationPaymentRequest::is_enable_real_time_update_Valid() const{
