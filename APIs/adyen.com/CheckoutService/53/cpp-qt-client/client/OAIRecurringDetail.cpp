...
bool OAIRecurringDetail::isSupportsRecurring() const {
    return m_supports_recurring;
}
void OAIRecurringDetail::setSupportsRecurring(const bool &supports_recurring) {
    m_supports_recurring = supports_recurring;
    m_supports_recurring_isSet = true;
}

bool OAIRecurringDetail::is_supports_recurring_Set() const{
    return m_supports_recurring_isSet;
}

bool OAIRecurringDetail::is_supports_recurring_Valid() const{
