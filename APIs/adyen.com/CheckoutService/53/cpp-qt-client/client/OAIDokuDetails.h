...
#ifndef OAIDokuDetails_H
#define OAIDokuDetails_H
...
class OAIDokuDetails : public OAIObject {
public:
    OAIDokuDetails();
    OAIDokuDetails(QString json);
    ~OAIDokuDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDokuDetails)

#endif // OAIDokuDetails_H
