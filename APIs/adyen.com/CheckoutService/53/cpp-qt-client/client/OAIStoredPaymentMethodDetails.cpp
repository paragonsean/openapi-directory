...
QString OAIStoredPaymentMethodDetails::getStoredPaymentMethodId() const {
    return m_stored_payment_method_id;
}
void OAIStoredPaymentMethodDetails::setStoredPaymentMethodId(const QString &stored_payment_method_id) {
    m_stored_payment_method_id = stored_payment_method_id;
    m_stored_payment_method_id_isSet = true;
}

bool OAIStoredPaymentMethodDetails::is_stored_payment_method_id_Set() const{
    return m_stored_payment_method_id_isSet;
}

bool OAIStoredPaymentMethodDetails::is_stored_payment_method_id_Valid() const{
