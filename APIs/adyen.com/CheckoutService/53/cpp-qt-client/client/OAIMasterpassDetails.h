...
/*
 * OAIMasterpassDetails.h
 *
 * 
 */

#ifndef OAIMasterpassDetails_H
#define OAIMasterpassDetails_H
...
class OAIMasterpassDetails : public OAIObject {
public:
    OAIMasterpassDetails();
    OAIMasterpassDetails(QString json);
    ~OAIMasterpassDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMasterpassDetails)

#endif // OAIMasterpassDetails_H
