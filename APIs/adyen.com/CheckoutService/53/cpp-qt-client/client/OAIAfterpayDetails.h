...
/*
 * OAIAfterpayDetails.h
 *
 * 
 */

#ifndef OAIAfterpayDetails_H
#define OAIAfterpayDetails_H
...
class OAIAfterpayDetails : public OAIObject {
public:
    OAIAfterpayDetails();
    OAIAfterpayDetails(QString json);
    ~OAIAfterpayDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAfterpayDetails)

#endif // OAIAfterpayDetails_H
