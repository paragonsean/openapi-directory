...
/*
 * OAIUtilityResponse.h
 *
 * 
 */

#ifndef OAIUtilityResponse_H
#define OAIUtilityResponse_H
...
class OAIUtilityResponse : public OAIObject {
public:
    OAIUtilityResponse();
    OAIUtilityResponse(QString json);
    ~OAIUtilityResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUtilityResponse)

#endif // OAIUtilityResponse_H
