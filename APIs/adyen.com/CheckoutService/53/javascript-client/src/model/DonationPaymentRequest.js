...
class DonationPaymentRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('enableRealTimeUpdate')) {
                obj['enableRealTimeUpdate'] = ApiClient.convertToType(data['enableRealTimeUpdate'], 'Boolean');
            }
 ...
 * @member {Boolean} enableRealTimeUpdate
 */
DonationPaymentRequest.prototype['enableRealTimeUpdate'] = undefined;
