...
/**
 * The PaymentVerificationResponse model module.
 * @module model/PaymentVerificationResponse
 * @version 53
 */
class PaymentVerificationResponse {
    /**
     * Constructs a new <code>PaymentVerificationResponse</code>.
     * @alias module:model/PaymentVerificationResponse
     * @param merchantReference {String} A unique value that you provided in the initial `/paymentSession` request as a `reference` field.
     * @param paymentMethod {String} The payment method used in the transaction.
     * @param shopperLocale {String} The shopperLocale value provided in the payment request.
     */
    constructor(merchantReference, paymentMethod, shopperLocale) { 
        
        PaymentVerificationResponse.initialize(this, merchantReference, paymentMethod, shopperLocale);
    }
     ...
     */
    static initialize(obj, merchantReference, paymentMethod, shopperLocale) { 
    ...
    /**
     * Constructs a <code>PaymentVerificationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentVerificationResponse} obj Optional instance to populate.
     * @return {module:model/PaymentVerificationResponse} The populated <code>PaymentVerificationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentVerificationResponse();
            ...
            if (data.hasOwnProperty('serviceError')) {
                obj['serviceError'] = ServiceErrorDetails.constructFromObject(data['serviceError']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentVerificationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentVerificationResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentVerificationResponse.RequiredProperties) {
        ...
        if (data['serviceError']) { // data not null
          ServiceErrorDetails.validateJSON(data['serviceError']);
        }
        // ensure the json data is a string
...
PaymentVerificationResponse.RequiredProperties = ["merchantReference", "paymentMethod", "shopperLocale"];

/**
 * @member {module:model/BalanceCheckResponseAdditionalData} additionalData
 */
PaymentVerificationResponse.prototype['additionalData'] = undefined;

/**
 * The fraud result properties of the payment.
 * @member {module:model/FraudResult} fraudResult
 */
PaymentVerificationResponse.prototype['fraudResult'] = undefined;
 ...
 */
PaymentVerificationResponse.prototype['merchantReference'] = undefined;
 ...
 */
PaymentVerificationResponse.prototype['order'] = undefined;

/**
 * The payment method used in the transaction.
 * @member {String} paymentMethod
 */
PaymentVerificationResponse.prototype['paymentMethod'] = undefined;

/**
 * Adyen's 16-character reference associated with the transaction/request. This value is globally unique; quote it when communicating with us about this request.
 * @member {String} pspReference
 */
PaymentVerificationResponse.prototype['pspReference'] = undefined;

/**
 * If the payment's authorisation is refused or an error occurs during authorisation, this field holds Adyen's mapped reason for the refusal or a description of the error. When a transaction fails, the authorisation response includes `resultCode` and `refusalReason` values.  For more information, see [Refusal reasons](https://docs.adyen.com/development-resources/refusal-reasons).
 * @member {String} refusalReason
 */
PaymentVerificationResponse.prototype['refusalReason'] = undefined;
 ...
 */
PaymentVerificationResponse.prototype['refusalReasonCode'] = undefined;
 ...
 * @member {module:model/PaymentVerificationResponse.ResultCodeEnum} resultCode
 */
PaymentVerificationResponse.prototype['resultCode'] = undefined;

/**
 * The type of the error.
 * @member {module:model/ServiceErrorDetails} serviceError
 */
PaymentVerificationResponse.prototype['serviceError'] = undefined;

/**
 * The shopperLocale value provided in the payment request.
 * @member {String} shopperLocale
 */
PaymentVerificationResponse.prototype['shopperLocale'] = undefined;
...
export default PaymentVerificationResponse;
