...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.DokuDetails();
  });
  ...
  describe('DokuDetails', function() {
    it('should create an instance of DokuDetails', function() {
      // uncomment below and update the code to test DokuDetails
      //var instance = new AdyenCheckoutApi.DokuDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.DokuDetails);
    });
