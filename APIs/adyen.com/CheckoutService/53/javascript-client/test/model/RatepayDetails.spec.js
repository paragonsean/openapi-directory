...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.RatepayDetails();
  });
  ...
  describe('RatepayDetails', function() {
    it('should create an instance of RatepayDetails', function() {
      // uncomment below and update the code to test RatepayDetails
      //var instance = new AdyenCheckoutApi.RatepayDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.RatepayDetails);
    });
