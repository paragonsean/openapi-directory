...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentMethodsRequest();
  });
  ...
  describe('PaymentMethodsRequest', function() {
    it('should create an instance of PaymentMethodsRequest', function() {
      // uncomment below and update the code to test PaymentMethodsRequest
      //var instance = new AdyenCheckoutApi.PaymentMethodsRequest();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentMethodsRequest);
    });
