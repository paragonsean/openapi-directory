...
public class StoredPaymentMethod {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bankAccountNumber, bankLocationId, brand, expiryMonth, expiryYear, holderName, id, lastFour, name, shopperEmail, supportedShopperInteractions, type);
  }
