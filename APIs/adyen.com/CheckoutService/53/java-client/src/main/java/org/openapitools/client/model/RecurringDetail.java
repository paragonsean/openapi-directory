...
import org.openapitools.client.model.StoredDetails;
...
public class RecurringDetail {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(brands, _configuration, details, fundingSource, group, inputDetails, name, recurringDetailReference, storedDetails, supportsRecurring, type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("storedDetails") != null && !jsonObj.get("storedDetails").isJsonNull()) {
        StoredDetails.validateJsonElement(jsonObj.get("storedDetails"));
      }
