...
public:
    ...
    QString getReceiverEmail() const;
    void setReceiverEmail(const QString &receiver_email);
    bool is_receiver_email_Set() const;
    bool is_receiver_email_Valid() const;
...
private:
    ...
    QString m_receiver_email;
    bool m_receiver_email_isSet;
    bool m_receiver_email_isValid;
