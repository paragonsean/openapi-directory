...
public:
    ...
    QList<OAISubMerchantInfo> getSubMerchants() const;
    void setSubMerchants(const QList<OAISubMerchantInfo> &sub_merchants);
    bool is_sub_merchants_Set() const;
    bool is_sub_merchants_Valid() const;
...
private:
    ...
    QList<OAISubMerchantInfo> m_sub_merchants;
    bool m_sub_merchants_isSet;
    bool m_sub_merchants_isValid;
};
