...
#ifndef OAICardDonations_H
#define OAICardDonations_H
...
class OAICardDonations : public OAIObject {
public:
    OAICardDonations();
    OAICardDonations(QString json);
    ~OAICardDonations() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICardDonations)

#endif // OAICardDonations_H
