...
QDateTime OAIDonationPaymentRequest::getDeliverAt() const {
    return m_deliver_at;
}
void OAIDonationPaymentRequest::setDeliverAt(const QDateTime &deliver_at) {
    m_deliver_at = deliver_at;
    m_deliver_at_isSet = true;
}

bool OAIDonationPaymentRequest::is_deliver_at_Set() const{
    return m_deliver_at_isSet;
}

bool OAIDonationPaymentRequest::is_deliver_at_Valid() const{
...
QString OAIDonationPaymentRequest::getIndustryUsage() const {
    return m_industry_usage;
}
void OAIDonationPaymentRequest::setIndustryUsage(const QString &industry_usage) {
    m_industry_usage = industry_usage;
    m_industry_usage_isSet = true;
}

bool OAIDonationPaymentRequest::is_industry_usage_Set() const{
    return m_industry_usage_isSet;
}

bool OAIDonationPaymentRequest::is_industry_usage_Valid() const{
