...
OAIApplePayDonations::OAIApplePayDonations(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApplePayDonations::OAIApplePayDonations() {
    this->initializeModel();
}

OAIApplePayDonations::~OAIApplePayDonations() {}

void OAIApplePayDonations::initializeModel() {
...
void OAIApplePayDonations::fromJson(QString jsonString) {
...
void OAIApplePayDonations::fromJsonObject(QJsonObject json) {
...
QString OAIApplePayDonations::asJson() const {
...
QJsonObject OAIApplePayDonations::asJsonObject() const {
    QJsonObject obj;
...
QString OAIApplePayDonations::getApplePayToken() const {
    return m_apple_pay_token;
}
void OAIApplePayDonations::setApplePayToken(const QString &apple_pay_token) {
    m_apple_pay_token = apple_pay_token;
    m_apple_pay_token_isSet = true;
}

bool OAIApplePayDonations::is_apple_pay_token_Set() const{
    return m_apple_pay_token_isSet;
}

bool OAIApplePayDonations::is_apple_pay_token_Valid() const{
    return m_apple_pay_token_isValid;
}

QString OAIApplePayDonations::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIApplePayDonations::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIApplePayDonations::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIApplePayDonations::is_checkout_attempt_id_Valid() const{
    return m_checkout_attempt_id_isValid;
}

QString OAIApplePayDonations::getFundingSource() const {
    return m_funding_source;
}
void OAIApplePayDonations::setFundingSource(const QString &funding_source) {
    m_funding_source = funding_source;
    m_funding_source_isSet = true;
}

bool OAIApplePayDonations::is_funding_source_Set() const{
    return m_funding_source_isSet;
}

bool OAIApplePayDonations::is_funding_source_Valid() const{
    return m_funding_source_isValid;
}

QString OAIApplePayDonations::getRecurringDetailReference() const {
    return m_recurring_detail_reference;
}
void OAIApplePayDonations::setRecurringDetailReference(const QString &recurring_detail_reference) {
    m_recurring_detail_reference = recurring_detail_reference;
    m_recurring_detail_reference_isSet = true;
}

bool OAIApplePayDonations::is_recurring_detail_reference_Set() const{
    return m_recurring_detail_reference_isSet;
}

bool OAIApplePayDonations::is_recurring_detail_reference_Valid() const{
    return m_recurring_detail_reference_isValid;
}

QString OAIApplePayDonations::getStoredPaymentMethodId() const {
    return m_stored_payment_method_id;
}
void OAIApplePayDonations::setStoredPaymentMethodId(const QString &stored_payment_method_id) {
    m_stored_payment_method_id = stored_payment_method_id;
    m_stored_payment_method_id_isSet = true;
}

bool OAIApplePayDonations::is_stored_payment_method_id_Set() const{
    return m_stored_payment_method_id_isSet;
}

bool OAIApplePayDonations::is_stored_payment_method_id_Valid() const{
    return m_stored_payment_method_id_isValid;
}

QString OAIApplePayDonations::getType() const {
    return m_type;
}
void OAIApplePayDonations::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIApplePayDonations::is_type_Set() const{
    return m_type_isSet;
}

bool OAIApplePayDonations::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIApplePayDonations::isSet() const {
...
bool OAIApplePayDonations::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_apple_pay_token_isValid && true;
}
