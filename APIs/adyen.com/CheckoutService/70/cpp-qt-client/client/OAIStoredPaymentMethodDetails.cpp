...
QString OAIStoredPaymentMethodDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIStoredPaymentMethodDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIStoredPaymentMethodDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIStoredPaymentMethodDetails::is_checkout_attempt_id_Valid() const{
