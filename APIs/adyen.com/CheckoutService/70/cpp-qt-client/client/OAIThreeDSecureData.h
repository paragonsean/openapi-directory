...
public:
    ...
    QString getTokenAuthenticationVerificationValue() const;
    void setTokenAuthenticationVerificationValue(const QString &token_authentication_verification_value);
    bool is_token_authentication_verification_value_Set() const;
    bool is_token_authentication_verification_value_Valid() const;
...
private:
    ...
    QString m_token_authentication_verification_value;
    bool m_token_authentication_verification_value_isSet;
    bool m_token_authentication_verification_value_isValid;
