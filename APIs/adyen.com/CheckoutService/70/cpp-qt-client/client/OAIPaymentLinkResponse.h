...
public:
    ...
    QString getStorePaymentMethodMode() const;
    void setStorePaymentMethodMode(const QString &store_payment_method_mode);
    bool is_store_payment_method_mode_Set() const;
    bool is_store_payment_method_mode_Valid() const;
...
private:
    ...
    QString m_store_payment_method_mode;
    bool m_store_payment_method_mode_isSet;
    bool m_store_payment_method_mode_isValid;
