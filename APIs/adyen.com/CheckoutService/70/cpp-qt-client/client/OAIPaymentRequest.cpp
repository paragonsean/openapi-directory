...
OAIAuthenticationData OAIPaymentRequest::getAuthenticationData() const {
    return m_authentication_data;
}
void OAIPaymentRequest::setAuthenticationData(const OAIAuthenticationData &authentication_data) {
    m_authentication_data = authentication_data;
    m_authentication_data_isSet = true;
}

bool OAIPaymentRequest::is_authentication_data_Set() const{
    return m_authentication_data_isSet;
}

bool OAIPaymentRequest::is_authentication_data_Valid() const{
...
QDateTime OAIPaymentRequest::getDeliverAt() const {
    return m_deliver_at;
}
void OAIPaymentRequest::setDeliverAt(const QDateTime &deliver_at) {
    m_deliver_at = deliver_at;
    m_deliver_at_isSet = true;
}

bool OAIPaymentRequest::is_deliver_at_Set() const{
    return m_deliver_at_isSet;
}

bool OAIPaymentRequest::is_deliver_at_Valid() const{
...
QString OAIPaymentRequest::getIndustryUsage() const {
    return m_industry_usage;
}
void OAIPaymentRequest::setIndustryUsage(const QString &industry_usage) {
    m_industry_usage = industry_usage;
    m_industry_usage_isSet = true;
}

bool OAIPaymentRequest::is_industry_usage_Set() const{
    return m_industry_usage_isSet;
}

bool OAIPaymentRequest::is_industry_usage_Valid() const{
