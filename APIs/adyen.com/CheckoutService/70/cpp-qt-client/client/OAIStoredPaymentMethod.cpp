...
QString OAIStoredPaymentMethod::getLabel() const {
    return m_label;
}
void OAIStoredPaymentMethod::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIStoredPaymentMethod::is_label_Set() const{
    return m_label_isSet;
}

bool OAIStoredPaymentMethod::is_label_Valid() const{
...
QList<QString> OAIStoredPaymentMethod::getSupportedRecurringProcessingModels() const {
    return m_supported_recurring_processing_models;
}
void OAIStoredPaymentMethod::setSupportedRecurringProcessingModels(const QList<QString> &supported_recurring_processing_models) {
...
bool OAIStoredPaymentMethod::is_supported_recurring_processing_models_Set() const{
    return m_supported_recurring_processing_models_isSet;
}

bool OAIStoredPaymentMethod::is_supported_recurring_processing_models_Valid() const{
