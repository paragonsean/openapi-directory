...
OAIRatepayDetails::OAIRatepayDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRatepayDetails::OAIRatepayDetails() {
    this->initializeModel();
}

OAIRatepayDetails::~OAIRatepayDetails() {}

void OAIRatepayDetails::initializeModel() {
...
void OAIRatepayDetails::fromJson(QString jsonString) {
...
void OAIRatepayDetails::fromJsonObject(QJsonObject json) {
...
QString OAIRatepayDetails::asJson() const {
...
QJsonObject OAIRatepayDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRatepayDetails::getBillingAddress() const {
    return m_billing_address;
}
void OAIRatepayDetails::setBillingAddress(const QString &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIRatepayDetails::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIRatepayDetails::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAIRatepayDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIRatepayDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIRatepayDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIRatepayDetails::is_checkout_attempt_id_Valid() const{
    return m_checkout_attempt_id_isValid;
}

QString OAIRatepayDetails::getDeliveryAddress() const {
    return m_delivery_address;
}
void OAIRatepayDetails::setDeliveryAddress(const QString &delivery_address) {
    m_delivery_address = delivery_address;
    m_delivery_address_isSet = true;
}

bool OAIRatepayDetails::is_delivery_address_Set() const{
    return m_delivery_address_isSet;
}

bool OAIRatepayDetails::is_delivery_address_Valid() const{
    return m_delivery_address_isValid;
}

QString OAIRatepayDetails::getPersonalDetails() const {
    return m_personal_details;
}
void OAIRatepayDetails::setPersonalDetails(const QString &personal_details) {
    m_personal_details = personal_details;
    m_personal_details_isSet = true;
}

bool OAIRatepayDetails::is_personal_details_Set() const{
    return m_personal_details_isSet;
}

bool OAIRatepayDetails::is_personal_details_Valid() const{
    return m_personal_details_isValid;
}

QString OAIRatepayDetails::getRecurringDetailReference() const {
    return m_recurring_detail_reference;
}
void OAIRatepayDetails::setRecurringDetailReference(const QString &recurring_detail_reference) {
    m_recurring_detail_reference = recurring_detail_reference;
    m_recurring_detail_reference_isSet = true;
}

bool OAIRatepayDetails::is_recurring_detail_reference_Set() const{
    return m_recurring_detail_reference_isSet;
}

bool OAIRatepayDetails::is_recurring_detail_reference_Valid() const{
    return m_recurring_detail_reference_isValid;
}

QString OAIRatepayDetails::getStoredPaymentMethodId() const {
    return m_stored_payment_method_id;
}
void OAIRatepayDetails::setStoredPaymentMethodId(const QString &stored_payment_method_id) {
    m_stored_payment_method_id = stored_payment_method_id;
    m_stored_payment_method_id_isSet = true;
}

bool OAIRatepayDetails::is_stored_payment_method_id_Set() const{
    return m_stored_payment_method_id_isSet;
}

bool OAIRatepayDetails::is_stored_payment_method_id_Valid() const{
    return m_stored_payment_method_id_isValid;
}

QString OAIRatepayDetails::getType() const {
    return m_type;
}
void OAIRatepayDetails::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIRatepayDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAIRatepayDetails::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIRatepayDetails::isSet() const {
...
bool OAIRatepayDetails::isValid() const {
