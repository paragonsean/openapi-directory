...
OAIDetailsRequestAuthenticationData OAIPaymentDetailsRequest::getAuthenticationData() const {
    return m_authentication_data;
}
void OAIPaymentDetailsRequest::setAuthenticationData(const OAIDetailsRequestAuthenticationData &authentication_data) {
    m_authentication_data = authentication_data;
    m_authentication_data_isSet = true;
}

bool OAIPaymentDetailsRequest::is_authentication_data_Set() const{
    return m_authentication_data_isSet;
}

bool OAIPaymentDetailsRequest::is_authentication_data_Valid() const{
