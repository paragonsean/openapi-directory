...
qint32 OAIPaymentLinkRequest::getCaptureDelayHours() const {
    return m_capture_delay_hours;
}
void OAIPaymentLinkRequest::setCaptureDelayHours(const qint32 &capture_delay_hours) {
    m_capture_delay_hours = capture_delay_hours;
    m_capture_delay_hours_isSet = true;
}

bool OAIPaymentLinkRequest::is_capture_delay_hours_Set() const{
    return m_capture_delay_hours_isSet;
}

bool OAIPaymentLinkRequest::is_capture_delay_hours_Valid() const{
...
QDate OAIPaymentLinkRequest::getDateOfBirth() const {
    return m_date_of_birth;
}
void OAIPaymentLinkRequest::setDateOfBirth(const QDate &date_of_birth) {
    m_date_of_birth = date_of_birth;
    m_date_of_birth_isSet = true;
}

bool OAIPaymentLinkRequest::is_date_of_birth_Set() const{
    return m_date_of_birth_isSet;
}

bool OAIPaymentLinkRequest::is_date_of_birth_Valid() const{
...
QString OAIPaymentLinkRequest::getMcc() const {
    return m_mcc;
}
void OAIPaymentLinkRequest::setMcc(const QString &mcc) {
    m_mcc = mcc;
    m_mcc_isSet = true;
}

bool OAIPaymentLinkRequest::is_mcc_Set() const{
    return m_mcc_isSet;
}

bool OAIPaymentLinkRequest::is_mcc_Valid() const{
...
QString OAIPaymentLinkRequest::getShopperStatement() const {
    return m_shopper_statement;
}
void OAIPaymentLinkRequest::setShopperStatement(const QString &shopper_statement) {
    m_shopper_statement = shopper_statement;
    m_shopper_statement_isSet = true;
}

bool OAIPaymentLinkRequest::is_shopper_statement_Set() const{
    return m_shopper_statement_isSet;
}

bool OAIPaymentLinkRequest::is_shopper_statement_Valid() const{
...
QString OAIPaymentLinkRequest::getSocialSecurityNumber() const {
    return m_social_security_number;
}
void OAIPaymentLinkRequest::setSocialSecurityNumber(const QString &social_security_number) {
    m_social_security_number = social_security_number;
    m_social_security_number_isSet = true;
}

bool OAIPaymentLinkRequest::is_social_security_number_Set() const{
    return m_social_security_number_isSet;
}

bool OAIPaymentLinkRequest::is_social_security_number_Valid() const{
    return m_social_security_number_isValid;
}

bool OAIPaymentLinkRequest::isSplitCardFundingSources() const {
    return m_split_card_funding_sources;
}
void OAIPaymentLinkRequest::setSplitCardFundingSources(const bool &split_card_funding_sources) {
    m_split_card_funding_sources = split_card_funding_sources;
    m_split_card_funding_sources_isSet = true;
}

bool OAIPaymentLinkRequest::is_split_card_funding_sources_Set() const{
    return m_split_card_funding_sources_isSet;
}

bool OAIPaymentLinkRequest::is_split_card_funding_sources_Valid() const{
