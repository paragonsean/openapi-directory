...
/*
 * OAIBalanceCheckResponse.h
 *
 * 
 */

#ifndef OAIBalanceCheckResponse_H
#define OAIBalanceCheckResponse_H
...
class OAIBalanceCheckResponse : public OAIObject {
public:
    OAIBalanceCheckResponse();
    OAIBalanceCheckResponse(QString json);
    ~OAIBalanceCheckResponse() override;
    ...
    OAIAmount getBalance() const;
    void setBalance(const OAIAmount &balance);
    ...
    OAIAmount getTransactionLimit() const;
    void setTransactionLimit(const OAIAmount &transaction_limit);
    bool is_transaction_limit_Set() const;
    bool is_transaction_limit_Valid() const;
...
private:
    ...
    OAIAmount m_transaction_limit;
    bool m_transaction_limit_isSet;
    bool m_transaction_limit_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBalanceCheckResponse)

#endif // OAIBalanceCheckResponse_H
