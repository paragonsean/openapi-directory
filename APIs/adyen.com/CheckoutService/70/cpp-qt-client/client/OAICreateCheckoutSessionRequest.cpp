...
OAIPlatformChargebackLogic OAICreateCheckoutSessionRequest::getPlatformChargebackLogic() const {
    return m_platform_chargeback_logic;
}
void OAICreateCheckoutSessionRequest::setPlatformChargebackLogic(const OAIPlatformChargebackLogic &platform_chargeback_logic) {
    m_platform_chargeback_logic = platform_chargeback_logic;
    m_platform_chargeback_logic_isSet = true;
}

bool OAICreateCheckoutSessionRequest::is_platform_chargeback_logic_Set() const{
    return m_platform_chargeback_logic_isSet;
}

bool OAICreateCheckoutSessionRequest::is_platform_chargeback_logic_Valid() const{
...
QString OAICreateCheckoutSessionRequest::getStorePaymentMethodMode() const {
    return m_store_payment_method_mode;
}
void OAICreateCheckoutSessionRequest::setStorePaymentMethodMode(const QString &store_payment_method_mode) {
    m_store_payment_method_mode = store_payment_method_mode;
    m_store_payment_method_mode_isSet = true;
}

bool OAICreateCheckoutSessionRequest::is_store_payment_method_mode_Set() const{
    return m_store_payment_method_mode_isSet;
}

bool OAICreateCheckoutSessionRequest::is_store_payment_method_mode_Valid() const{
