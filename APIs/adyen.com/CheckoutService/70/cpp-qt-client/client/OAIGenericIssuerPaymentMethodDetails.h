...
/*
 * OAIGenericIssuerPaymentMethodDetails.h
 *
 * 
 */

#ifndef OAIGenericIssuerPaymentMethodDetails_H
#define OAIGenericIssuerPaymentMethodDetails_H
...
class OAIGenericIssuerPaymentMethodDetails : public OAIObject {
public:
    OAIGenericIssuerPaymentMethodDetails();
    OAIGenericIssuerPaymentMethodDetails(QString json);
    ~OAIGenericIssuerPaymentMethodDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenericIssuerPaymentMethodDetails)

#endif // OAIGenericIssuerPaymentMethodDetails_H
