...
#include "OAICheckoutDelegatedAuthenticationAction.h"
...
#include "OAICheckoutThreeDS2Action.h"
...
public:
    ...
    QString getAuthorisationToken() const;
    void setAuthorisationToken(const QString &authorisation_token);
    bool is_authorisation_token_Set() const;
    bool is_authorisation_token_Valid() const;
    ...
    QString getPassCreationToken() const;
    void setPassCreationToken(const QString &pass_creation_token);
    bool is_pass_creation_token_Set() const;
    bool is_pass_creation_token_Valid() const;
...
private:
    ...
    QString m_authorisation_token;
    bool m_authorisation_token_isSet;
    bool m_authorisation_token_isValid;
    ...
    QString m_pass_creation_token;
    bool m_pass_creation_token_isSet;
    bool m_pass_creation_token_isValid;
