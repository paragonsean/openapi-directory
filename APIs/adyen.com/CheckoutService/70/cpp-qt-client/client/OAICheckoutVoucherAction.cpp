...
void OAICheckoutVoucherAction::initializeModel() {
    ...
    m_pass_creation_token_isSet = false;
    m_pass_creation_token_isValid = false;
...
void OAICheckoutVoucherAction::fromJsonObject(QJsonObject json) {
    ...
    m_pass_creation_token_isValid = ::OpenAPI::fromJsonValue(m_pass_creation_token, json[QString("passCreationToken")]);
    m_pass_creation_token_isSet = !json[QString("passCreationToken")].isNull() && m_pass_creation_token_isValid;
...
QJsonObject OAICheckoutVoucherAction::asJsonObject() const {
    ...
    if (m_pass_creation_token_isSet) {
        obj.insert(QString("passCreationToken"), ::OpenAPI::toJsonValue(m_pass_creation_token));
    }
...
QString OAICheckoutVoucherAction::getPassCreationToken() const {
    return m_pass_creation_token;
}
void OAICheckoutVoucherAction::setPassCreationToken(const QString &pass_creation_token) {
    m_pass_creation_token = pass_creation_token;
    m_pass_creation_token_isSet = true;
}

bool OAICheckoutVoucherAction::is_pass_creation_token_Set() const{
    return m_pass_creation_token_isSet;
}

bool OAICheckoutVoucherAction::is_pass_creation_token_Valid() const{
    return m_pass_creation_token_isValid;
}
