...
OAISamsungPayDetails::OAISamsungPayDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISamsungPayDetails::OAISamsungPayDetails() {
    this->initializeModel();
}

OAISamsungPayDetails::~OAISamsungPayDetails() {}

void OAISamsungPayDetails::initializeModel() {
...
void OAISamsungPayDetails::fromJson(QString jsonString) {
...
void OAISamsungPayDetails::fromJsonObject(QJsonObject json) {
...
QString OAISamsungPayDetails::asJson() const {
...
QJsonObject OAISamsungPayDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAISamsungPayDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAISamsungPayDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAISamsungPayDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAISamsungPayDetails::is_checkout_attempt_id_Valid() const{
    return m_checkout_attempt_id_isValid;
}

QString OAISamsungPayDetails::getFundingSource() const {
    return m_funding_source;
}
void OAISamsungPayDetails::setFundingSource(const QString &funding_source) {
    m_funding_source = funding_source;
    m_funding_source_isSet = true;
}

bool OAISamsungPayDetails::is_funding_source_Set() const{
    return m_funding_source_isSet;
}

bool OAISamsungPayDetails::is_funding_source_Valid() const{
    return m_funding_source_isValid;
}

QString OAISamsungPayDetails::getRecurringDetailReference() const {
    return m_recurring_detail_reference;
}
void OAISamsungPayDetails::setRecurringDetailReference(const QString &recurring_detail_reference) {
    m_recurring_detail_reference = recurring_detail_reference;
    m_recurring_detail_reference_isSet = true;
}

bool OAISamsungPayDetails::is_recurring_detail_reference_Set() const{
    return m_recurring_detail_reference_isSet;
}

bool OAISamsungPayDetails::is_recurring_detail_reference_Valid() const{
    return m_recurring_detail_reference_isValid;
}

QString OAISamsungPayDetails::getSamsungPayToken() const {
    return m_samsung_pay_token;
}
void OAISamsungPayDetails::setSamsungPayToken(const QString &samsung_pay_token) {
    m_samsung_pay_token = samsung_pay_token;
    m_samsung_pay_token_isSet = true;
}

bool OAISamsungPayDetails::is_samsung_pay_token_Set() const{
    return m_samsung_pay_token_isSet;
}

bool OAISamsungPayDetails::is_samsung_pay_token_Valid() const{
    return m_samsung_pay_token_isValid;
}

QString OAISamsungPayDetails::getStoredPaymentMethodId() const {
    return m_stored_payment_method_id;
}
void OAISamsungPayDetails::setStoredPaymentMethodId(const QString &stored_payment_method_id) {
    m_stored_payment_method_id = stored_payment_method_id;
    m_stored_payment_method_id_isSet = true;
}

bool OAISamsungPayDetails::is_stored_payment_method_id_Set() const{
    return m_stored_payment_method_id_isSet;
}

bool OAISamsungPayDetails::is_stored_payment_method_id_Valid() const{
    return m_stored_payment_method_id_isValid;
}

QString OAISamsungPayDetails::getType() const {
    return m_type;
}
void OAISamsungPayDetails::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISamsungPayDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAISamsungPayDetails::is_type_Valid() const{
    return m_type_isValid;
}

bool OAISamsungPayDetails::isSet() const {
...
bool OAISamsungPayDetails::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_samsung_pay_token_isValid && true;
}
