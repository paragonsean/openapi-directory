...
public:
    ...
    Q_DECL_DEPRECATED QString getDeliveryEmail() const;
    Q_DECL_DEPRECATED void setDeliveryEmail(const QString &delivery_email);
    Q_DECL_DEPRECATED bool is_delivery_email_Set() const;
    Q_DECL_DEPRECATED bool is_delivery_email_Valid() const;

    QString getDeliveryEmailAddress() const;
    void setDeliveryEmailAddress(const QString &delivery_email_address);
    bool is_delivery_email_address_Set() const;
    bool is_delivery_email_address_Valid() const;
    ...
    QString getGiftCardCurr() const;
    void setGiftCardCurr(const QString &gift_card_curr);
    bool is_gift_card_curr_Set() const;
    bool is_gift_card_curr_Valid() const;
    ...
    QString getPreOrderPurchaseInd() const;
    void setPreOrderPurchaseInd(const QString &pre_order_purchase_ind);
    bool is_pre_order_purchase_ind_Set() const;
    bool is_pre_order_purchase_ind_Valid() const;
    ...
    QString getReorderItemsInd() const;
    void setReorderItemsInd(const QString &reorder_items_ind);
    bool is_reorder_items_ind_Set() const;
    bool is_reorder_items_ind_Valid() const;

    QString getShipIndicator() const;
    void setShipIndicator(const QString &ship_indicator);
    bool is_ship_indicator_Set() const;
    bool is_ship_indicator_Valid() const;
...
private:
    ...
    QString m_delivery_email_address;
    bool m_delivery_email_address_isSet;
    bool m_delivery_email_address_isValid;
    ...
    QString m_gift_card_curr;
    bool m_gift_card_curr_isSet;
    bool m_gift_card_curr_isValid;
    ...
    QString m_pre_order_purchase_ind;
    bool m_pre_order_purchase_ind_isSet;
    bool m_pre_order_purchase_ind_isValid;

    bool m_reorder_items;
    bool m_reorder_items_isSet;
    bool m_reorder_items_isValid;

    QString m_reorder_items_ind;
    bool m_reorder_items_ind_isSet;
    bool m_reorder_items_ind_isValid;

    QString m_ship_indicator;
    bool m_ship_indicator_isSet;
    bool m_ship_indicator_isValid;
};
