...
#ifndef OAIPaymentDetails_H
#define OAIPaymentDetails_H
...
class OAIPaymentDetails : public OAIObject {
public:
    OAIPaymentDetails();
    OAIPaymentDetails(QString json);
    ~OAIPaymentDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentDetails)

#endif // OAIPaymentDetails_H
