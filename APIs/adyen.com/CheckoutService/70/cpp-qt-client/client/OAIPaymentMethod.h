...
public:
    ...
    QList<OAIPaymentMethodIssuer> getIssuers() const;
    void setIssuers(const QList<OAIPaymentMethodIssuer> &issuers);
...
private:
    ...
    QList<OAIPaymentMethodIssuer> m_issuers;
