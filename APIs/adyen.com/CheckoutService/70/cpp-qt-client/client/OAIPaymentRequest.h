...
class OAIEncryptedOrderData;
class OAIPaymentRequest_paymentMethod;
class OAIPlatformChargebackLogic;
class OAIRiskData;
class OAIName;
class OAISplit;
class OAIThreeDS2RequestFields;
...
public:
    ...
    OAIAuthenticationData getAuthenticationData() const;
    void setAuthenticationData(const OAIAuthenticationData &authentication_data);
    bool is_authentication_data_Set() const;
    bool is_authentication_data_Valid() const;
    ...
    Q_DECL_DEPRECATED QString getConversionId() const;
    Q_DECL_DEPRECATED void setConversionId(const QString &conversion_id);
    Q_DECL_DEPRECATED bool is_conversion_id_Set() const;
    Q_DECL_DEPRECATED bool is_conversion_id_Valid() const;
    ...
    Q_DECL_DEPRECATED QDateTime getDeliveryDate() const;
    Q_DECL_DEPRECATED void setDeliveryDate(const QDateTime &delivery_date);
    Q_DECL_DEPRECATED bool is_delivery_date_Set() const;
    Q_DECL_DEPRECATED bool is_delivery_date_Valid() const;
    ...
    OAIEncryptedOrderData getOrder() const;
    void setOrder(const OAIEncryptedOrderData &order);
    ...
    OAIPaymentRequest_paymentMethod getPaymentMethod() const;
    void setPaymentMethod(const OAIPaymentRequest_paymentMethod &payment_method);
    bool is_payment_method_Set() const;
    bool is_payment_method_Valid() const;

    OAIPlatformChargebackLogic getPlatformChargebackLogic() const;
    void setPlatformChargebackLogic(const OAIPlatformChargebackLogic &platform_chargeback_logic);
    bool is_platform_chargeback_logic_Set() const;
    bool is_platform_chargeback_logic_Valid() const;
    ...
    OAIThreeDS2RequestFields getThreeDs2RequestData() const;
    void setThreeDs2RequestData(const OAIThreeDS2RequestFields &three_ds2_request_data);
    bool is_three_ds2_request_data_Set() const;
    bool is_three_ds2_request_data_Valid() const;

    Q_DECL_DEPRECATED bool isThreeDsAuthenticationOnly() const;
    Q_DECL_DEPRECATED void setThreeDsAuthenticationOnly(const bool &three_ds_authentication_only);
    Q_DECL_DEPRECATED bool is_three_ds_authentication_only_Set() const;
    Q_DECL_DEPRECATED bool is_three_ds_authentication_only_Valid() const;
...
private:
    ...
    OAIAuthenticationData m_authentication_data;
    bool m_authentication_data_isSet;
    bool m_authentication_data_isValid;
    ...
    OAIPaymentRequest_paymentMethod m_payment_method;
    bool m_payment_method_isSet;
    bool m_payment_method_isValid;

    OAIPlatformChargebackLogic m_platform_chargeback_logic;
    bool m_platform_chargeback_logic_isSet;
    bool m_platform_chargeback_logic_isValid;
    ...
    OAIThreeDS2RequestFields m_three_ds2_request_data;
