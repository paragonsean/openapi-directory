...
OAIResponsePaymentMethod OAIPaymentResponse::getPaymentMethod() const {
    return m_payment_method;
}
void OAIPaymentResponse::setPaymentMethod(const OAIResponsePaymentMethod &payment_method) {
