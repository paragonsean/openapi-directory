...
class PaymentDetailsResponse(Model):
    ...
    def __init__(self, additional_data: BalanceCheckResponseAdditionalData=None, amount: Amount=None, donation_token: str=None, fraud_result: FraudResult=None, merchant_reference: str=None, order: CheckoutOrderResponse=None, payment_method: ResponsePaymentMethod=None, psp_reference: str=None, refusal_reason: str=None, refusal_reason_code: str=None, result_code: str=None, shopper_locale: str=None, three_ds2_response_data: ThreeDS2ResponseData=None, three_ds2_result: ThreeDS2Result=None, three_ds_payment_data: str=None):
        ...
        :param payment_method: The payment_method of this PaymentDetailsResponse.
    ...
    def payment_method(self):
        """Gets the payment_method of this PaymentDetailsResponse.

        Details about the payment method used in the transaction.  Only returned if `resultCode` is **Authorised**.

        :return: The payment_method of this PaymentDetailsResponse.
    ...
    def payment_method(self, payment_method):
        """Sets the payment_method of this PaymentDetailsResponse.
