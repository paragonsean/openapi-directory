...
class MasterpassDetails(Model):
    ...
    def __init__(self, checkout_attempt_id: str=None, funding_source: str=None, masterpass_transaction_id: str=None, type: str='masterpass'):
        """MasterpassDetails - a model defined in OpenAPI

        :param checkout_attempt_id: The checkout_attempt_id of this MasterpassDetails.
    ...
    def checkout_attempt_id(self):
        """Gets the checkout_attempt_id of this MasterpassDetails.

        The checkout attempt identifier.

        :return: The checkout_attempt_id of this MasterpassDetails.
        :rtype: str
        """
    ...
    def checkout_attempt_id(self, checkout_attempt_id):
        """Sets the checkout_attempt_id of this MasterpassDetails.
