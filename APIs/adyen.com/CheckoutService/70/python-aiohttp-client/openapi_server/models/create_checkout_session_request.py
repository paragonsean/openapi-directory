...
class CreateCheckoutSessionRequest(Model):
    ...
    def __init__(self, account_info: AccountInfo=None, additional_amount: Amount=None, additional_data: BalanceCheckRequestAdditionalData=None, allowed_payment_methods: List[str]=None, amount: Amount=None, application_info: ApplicationInfo=None, authentication_data: AuthenticationData=None, billing_address: BillingAddress=None, blocked_payment_methods: List[str]=None, capture_delay_hours: int=None, channel: str=None, company: Company=None, country_code: str=None, date_of_birth: date=None, deliver_at: datetime=None, delivery_address: DeliveryAddress=None, enable_one_click: bool=None, enable_pay_out: bool=None, enable_recurring: bool=None, expires_at: datetime=None, fund_origin: FundOrigin=None, fund_recipient: FundRecipient=None, installment_options: Dict[str, CheckoutSessionInstallmentOption]=None, line_items: List[LineItem]=None, mandate: Mandate=None, mcc: str=None, merchant_account: str=None, merchant_order_reference: str=None, metadata: Dict[str, str]=None, mode: str='embedded', mpi_data: ThreeDSecureData=None, platform_chargeback_logic: PlatformChargebackLogic=None, recurring_expiry: str=None, recurring_frequency: str=None, recurring_processing_model: str=None, redirect_from_issuer_method: str=None, redirect_to_issuer_method: str=None, reference: str=None, return_url: str=None, risk_data: RiskData=None, shopper_email: str=None, shopper_ip: str=None, shopper_interaction: str=None, shopper_locale: str=None, shopper_name: Name=None, shopper_reference: str=None, shopper_statement: str=None, show_installment_amount: bool=None, show_remove_payment_method_button: bool=None, social_security_number: str=None, split_card_funding_sources: bool=False, splits: List[Split]=None, store: str=None, store_payment_method: bool=None, store_payment_method_mode: str=None, telephone_number: str=None, theme_id: str=None, three_ds_authentication_only: bool=False, trusted_shopper: bool=None):
        ...
        :param platform_chargeback_logic: The platform_chargeback_logic of this CreateCheckoutSessionRequest.
        ...
        :param store_payment_method_mode: The store_payment_method_mode of this CreateCheckoutSessionRequest.
    ...
    def platform_chargeback_logic(self):
        """Gets the platform_chargeback_logic of this CreateCheckoutSessionRequest.
        ...
        :return: The platform_chargeback_logic of this CreateCheckoutSessionRequest.
    ...
    def platform_chargeback_logic(self, platform_chargeback_logic):
        """Sets the platform_chargeback_logic of this CreateCheckoutSessionRequest.
    ...
    def store_payment_method_mode(self):
        """Gets the store_payment_method_mode of this CreateCheckoutSessionRequest.
        ...
        :return: The store_payment_method_mode of this CreateCheckoutSessionRequest.
        :rtype: str
        """
    ...
    def store_payment_method_mode(self, store_payment_method_mode):
        """Sets the store_payment_method_mode of this CreateCheckoutSessionRequest.
