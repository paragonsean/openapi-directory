...
class PaymentRequest(Model):
    ...
    def __init__(self, account_info: AccountInfo=None, additional_amount: Amount=None, additional_data: BalanceCheckRequestAdditionalData=None, amount: Amount=None, application_info: ApplicationInfo=None, authentication_data: AuthenticationData=None, billing_address: BillingAddress=None, browser_info: BrowserInfo=None, capture_delay_hours: int=None, channel: str=None, checkout_attempt_id: str=None, company: Company=None, conversion_id: str=None, country_code: str=None, date_of_birth: datetime=None, dcc_quote: ForexQuote=None, deliver_at: datetime=None, delivery_address: DeliveryAddress=None, delivery_date: datetime=None, device_fingerprint: str=None, enable_one_click: bool=None, enable_pay_out: bool=None, enable_recurring: bool=None, entity_type: str=None, fraud_offset: int=None, fund_origin: FundOrigin=None, fund_recipient: FundRecipient=None, industry_usage: str=None, installments: Installments=None, line_items: List[LineItem]=None, localized_shopper_statement: Dict[str, str]=None, mandate: Mandate=None, mcc: str=None, merchant_account: str=None, merchant_order_reference: str=None, merchant_risk_indicator: MerchantRiskIndicator=None, metadata: Dict[str, str]=None, mpi_data: ThreeDSecureData=None, order: EncryptedOrderData=None, order_reference: str=None, origin: str=None, payment_method: PaymentRequestPaymentMethod=None, platform_chargeback_logic: PlatformChargebackLogic=None, recurring_expiry: str=None, recurring_frequency: str=None, recurring_processing_model: str=None, redirect_from_issuer_method: str=None, redirect_to_issuer_method: str=None, reference: str=None, return_url: str=None, risk_data: RiskData=None, session_validity: str=None, shopper_email: str=None, shopper_ip: str=None, shopper_interaction: str=None, shopper_locale: str=None, shopper_name: Name=None, shopper_reference: str=None, shopper_statement: str=None, social_security_number: str=None, splits: List[Split]=None, store: str=None, store_payment_method: bool=None, telephone_number: str=None, three_ds2_request_data: ThreeDS2RequestFields=None, three_ds_authentication_only: bool=False, trusted_shopper: bool=None):
        ...
        :param authentication_data: The authentication_data of this PaymentRequest.
        ...
        :param checkout_attempt_id: The checkout_attempt_id of this PaymentRequest.
        ...
        :param deliver_at: The deliver_at of this PaymentRequest.
        ...
        :param industry_usage: The industry_usage of this PaymentRequest.
    ...
    def authentication_data(self):
        """Gets the authentication_data of this PaymentRequest.

        Data for 3DS authentication.

        :return: The authentication_data of this PaymentRequest.
    ...
    def checkout_attempt_id(self, checkout_attempt_id):
        """Sets the checkout_attempt_id of this PaymentRequest.
    ...
    @property
    def deliver_at(self):
        """Gets the deliver_at of this PaymentRequest.

        The date and time the purchased goods should be delivered.  Format [ISO 8601](https://www.w3.org/TR/NOTE-datetime): YYYY-MM-DDThh:mm:ss.sssTZD  Example: 2017-07-17T13:42:40.428+01:00

        :return: The deliver_at of this PaymentRequest.
        :rtype: datetime
        """
    ...
    def deliver_at(self, deliver_at):
        """Sets the deliver_at of this PaymentRequest.
    ...
    def industry_usage(self):
        """Gets the industry_usage of this PaymentRequest.

        The reason for the amount update. Possible values:  * **delayedCharge**  * **noShow**  * **installment**

        :return: The industry_usage of this PaymentRequest.
        :rtype: str
        """
    ...
    def industry_usage(self, industry_usage):
        """Sets the industry_usage of this PaymentRequest.
