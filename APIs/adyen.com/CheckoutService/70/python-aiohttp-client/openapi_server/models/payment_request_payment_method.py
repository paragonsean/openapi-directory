...
class PaymentRequestPaymentMethod(Model):
    ...
    def __init__(self, bank_account_number: str=None, bank_account_type: str=None, bank_location_id: str=None, checkout_attempt_id: str=None, encrypted_bank_account_number: str=None, encrypted_bank_location_id: str=None, owner_name: str=None, recurring_detail_reference: str=None, stored_payment_method_id: str=None, type: str='ach', billing_address: str=None, delivery_address: str=None, personal_details: str=None, amazon_pay_token: str=None, checkout_session_id: str=None, apple_pay_token: str=None, funding_source: str=None, holder_name: str=None, issuer: str=None, blik_code: str=None, brand: str=None, cupsecureplus_smscode: str=None, cvc: str=None, encrypted_card_number: str=None, encrypted_expiry_month: str=None, encrypted_expiry_year: str=None, encrypted_security_code: str=None, expiry_month: str=None, expiry_year: str=None, network_payment_reference: str=None, number: str=None, shopper_notification_reference: str=None, three_ds2_sdk_version: str=None, first_name: str=None, last_name: str=None, shopper_email: str=None, telephone_number: str=None, google_pay_card_network: str=None, google_pay_token: str=None, subtype: str=None, masterpass_transaction_id: str=None, order_id: str=None, payee_preferred: str=None, payer_id: str=None, payer_selected: str=None, virtual_payment_address: str=None, samsung_pay_token: str=None, iban: str=None, billing_sequence_number: str=None, visa_checkout_call_id: str=None, app_id: str=None, openid: str=None, click_and_collect: str=None):
        ...
        :param checkout_attempt_id: The checkout_attempt_id of this PaymentRequestPaymentMethod.
    ...
    def checkout_attempt_id(self):
        """Gets the checkout_attempt_id of this PaymentRequestPaymentMethod.

        The checkout attempt identifier.

        :return: The checkout_attempt_id of this PaymentRequestPaymentMethod.
        :rtype: str
        """
    ...
    def checkout_attempt_id(self, checkout_attempt_id):
        """Sets the checkout_attempt_id of this PaymentRequestPaymentMethod.
