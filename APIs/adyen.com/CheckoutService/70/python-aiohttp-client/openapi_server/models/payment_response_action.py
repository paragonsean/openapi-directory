...
from openapi_server.models.checkout_delegated_authentication_action import CheckoutDelegatedAuthenticationAction
...
class PaymentResponseAction(Model):
    ...
    def __init__(self, payment_data: str=None, payment_method_type: str=None, type: str=None, url: str=None, authorisation_token: str=None, token: str=None, data: Dict[str, str]=None, method: str=None, native_redirect_data: str=None, expires_at: str=None, qr_code_data: str=None, sdk_data: Dict[str, str]=None, subtype: str=None, alternative_reference: str=None, collection_institution_number: str=None, download_url: str=None, entity: str=None, initial_amount: Amount=None, instructions_url: str=None, issuer: str=None, masked_telephone_number: str=None, merchant_name: str=None, merchant_reference: str=None, pass_creation_token: str=None, reference: str=None, shopper_email: str=None, shopper_name: str=None, surcharge: Amount=None, total_amount: Amount=None):
    ...
    def type(self, type):
        ...
        **await**
        ...
        :type type: str
        """
        allowed_values = ["await", "delegatedAuthentication", "nativeRedirect", "qrCode", "redirect", "sdk", "wechatpaySDK", "threeDS2", "voucher"]  # noqa: E501
