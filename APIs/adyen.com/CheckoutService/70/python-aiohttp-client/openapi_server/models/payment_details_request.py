...
from openapi_server.models.details_request_authentication_data import DetailsRequestAuthenticationData
...
class PaymentDetailsRequest(Model):
    ...
    def __init__(self, authentication_data: DetailsRequestAuthenticationData=None, details: PaymentCompletionDetails=None, payment_data: str=None, three_ds_authentication_only: bool=None):
        """PaymentDetailsRequest - a model defined in OpenAPI

        :param authentication_data: The authentication_data of this PaymentDetailsRequest.
    ...
    def authentication_data(self):
        """Gets the authentication_data of this PaymentDetailsRequest.

        Data for 3DS authentication.

        :return: The authentication_data of this PaymentDetailsRequest.
        :rtype: DetailsRequestAuthenticationData
        """
        return self._authentication_data

    @authentication_data.setter
    def authentication_data(self, authentication_data):
        """Sets the authentication_data of this PaymentDetailsRequest.

        Data for 3DS authentication.

        :param authentication_data: The authentication_data of this PaymentDetailsRequest.
        :type authentication_data: DetailsRequestAuthenticationData
        """
