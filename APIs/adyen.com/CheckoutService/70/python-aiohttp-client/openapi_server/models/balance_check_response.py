...
class BalanceCheckResponse(Model):
    ...
    def __init__(self, additional_data: BalanceCheckResponseAdditionalData=None, balance: Amount=None, fraud_result: FraudResult=None, psp_reference: str=None, refusal_reason: str=None, result_code: str=None, transaction_limit: Amount=None):
        ...
        :param transaction_limit: The transaction_limit of this BalanceCheckResponse.
        """
        self.openapi_types = {
    ...
    def transaction_limit(self):
        """Gets the transaction_limit of this BalanceCheckResponse.

        The maximum spendable balance for a single transaction. Applicable to some gift cards.

        :return: The transaction_limit of this BalanceCheckResponse.
        :rtype: Amount
        """
    ...
    def transaction_limit(self, transaction_limit):
        """Sets the transaction_limit of this BalanceCheckResponse.

        The maximum spendable balance for a single transaction. Applicable to some gift cards.

        :param transaction_limit: The transaction_limit of this BalanceCheckResponse.
        :type transaction_limit: Amount
        """
