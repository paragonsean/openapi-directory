...
class ZipDetails(Model):
    ...
    def __init__(self, checkout_attempt_id: str=None, click_and_collect: str=None, recurring_detail_reference: str=None, stored_payment_method_id: str=None, type: str='zip'):
        """ZipDetails - a model defined in OpenAPI

        :param checkout_attempt_id: The checkout_attempt_id of this ZipDetails.
    ...
    def checkout_attempt_id(self):
        """Gets the checkout_attempt_id of this ZipDetails.

        The checkout attempt identifier.

        :return: The checkout_attempt_id of this ZipDetails.
        :rtype: str
        """
    ...
    def checkout_attempt_id(self, checkout_attempt_id):
        """Sets the checkout_attempt_id of this ZipDetails.
