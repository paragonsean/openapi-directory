...
async def test_post_payments_payment_psp_reference_amount_updates(client):
    ...
    response = await client.request(
        method='POST',
        path='/v70/payments/{payment_psp_reference}/amountUpdates'.format(payment_psp_reference='payment_psp_reference_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_payments_payment_psp_reference_cancels(client):
    ...
    response = await client.request(
        method='POST',
        path='/v70/payments/{payment_psp_reference}/cancels'.format(payment_psp_reference='payment_psp_reference_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_payments_payment_psp_reference_captures(client):
    ...
    """
    body = {"lineItems":[{"quantity":1,"color":"color","itemCategory":"itemCategory","amountExcludingTax":1,"taxPercentage":7,"description":"description","upc":"upc","manufacturer":"manufacturer","size":"size","imageUrl":"imageUrl","id":"id","amountIncludingTax":1,"productUrl":"productUrl","sku":"sku","taxAmount":6,"brand":"brand","receiverEmail":"receiverEmail"},{"quantity":1,"color":"color","itemCategory":"itemCategory","amountExcludingTax":1,"taxPercentage":7,"description":"description","upc":"upc","manufacturer":"manufacturer","size":"size","imageUrl":"imageUrl","id":"id","amountIncludingTax":1,"productUrl":"productUrl","sku":"sku","taxAmount":6,"brand":"brand","receiverEmail":"receiverEmail"}],"reference":"reference","amount":{"currency":"currency","value":0},"subMerchants":[{"address":{"country":"country","stateOrProvince":"stateOrProvince","city":"city","houseNumberOrName":"houseNumberOrName","street":"street","postalCode":"postalCode"},"taxId":"taxId","name":"name","id":"id","mcc":"mcc"},{"address":{"country":"country","stateOrProvince":"stateOrProvince","city":"city","houseNumberOrName":"houseNumberOrName","street":"street","postalCode":"postalCode"},"taxId":"taxId","name":"name","id":"id","mcc":"mcc"}],"splits":[{"reference":"reference","amount":{"currency":"currency","value":5},"description":"description","type":"AcquiringFees","account":"account"},{"reference":"reference","amount":{"currency":"currency","value":5},"description":"description","type":"AcquiringFees","account":"account"}],"merchantAccount":"merchantAccount","platformChargebackLogic":{"costAllocationAccount":"costAllocationAccount","targetAccount":"targetAccount","behavior":"deductAccordingToSplitRatio"},"applicationInfo":{"adyenLibrary":{"name":"name","version":"version"},"merchantApplication":{"name":"name","version":"version"},"adyenPaymentSource":{"name":"name","version":"version"},"merchantDevice":{"reference":"reference","os":"os","osVersion":"osVersion"},"shopperInteractionDevice":{"os":"os","osVersion":"osVersion","locale":"locale"},"externalPlatform":{"name":"name","integrator":"integrator","version":"version"}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'idempotency_key': '37ca9c97-d1d1-4c62-89e8-706891a563ed',
    ...
    response = await client.request(
        method='POST',
        path='/v70/payments/{payment_psp_reference}/captures'.format(payment_psp_reference='payment_psp_reference_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_payments_payment_psp_reference_refunds(client):
    ...
    response = await client.request(
        method='POST',
        path='/v70/payments/{payment_psp_reference}/refunds'.format(payment_psp_reference='payment_psp_reference_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_payments_payment_psp_reference_reversals(client):
    ...
    response = await client.request(
        method='POST',
        path='/v70/payments/{payment_psp_reference}/reversals'.format(payment_psp_reference='payment_psp_reference_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
