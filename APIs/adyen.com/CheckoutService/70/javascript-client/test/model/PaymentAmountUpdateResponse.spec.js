...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentAmountUpdateResponse();
  });
  ...
  describe('PaymentAmountUpdateResponse', function() {
    it('should create an instance of PaymentAmountUpdateResponse', function() {
      // uncomment below and update the code to test PaymentAmountUpdateResponse
      //var instance = new AdyenCheckoutApi.PaymentAmountUpdateResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentAmountUpdateResponse);
    });
