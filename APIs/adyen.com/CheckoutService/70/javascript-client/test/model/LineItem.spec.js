...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.LineItem();
  });
  ...
  describe('LineItem', function() {
    it('should create an instance of LineItem', function() {
      ...
      //var instance = new AdyenCheckoutApi.LineItem();
      //expect(instance).to.be.a(AdyenCheckoutApi.LineItem);
    });
    ...
    it('should have the property itemCategory (base name: "itemCategory")', function() {
      // uncomment below and update the code to test the property itemCategory
      //var instance = new AdyenCheckoutApi.LineItem();
      //expect(instance).to.be();
    });
    ...
    it('should have the property receiverEmail (base name: "receiverEmail")', function() {
      // uncomment below and update the code to test the property receiverEmail
      //var instance = new AdyenCheckoutApi.LineItem();
      //expect(instance).to.be();
    });
