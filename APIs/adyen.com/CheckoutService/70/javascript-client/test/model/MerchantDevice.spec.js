...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.MerchantDevice();
  });
  ...
  describe('MerchantDevice', function() {
    it('should create an instance of MerchantDevice', function() {
      // uncomment below and update the code to test MerchantDevice
      //var instance = new AdyenCheckoutApi.MerchantDevice();
      //expect(instance).to.be.a(AdyenCheckoutApi.MerchantDevice);
    });
