...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.SDKEphemPubKey();
  });
  ...
  describe('SDKEphemPubKey', function() {
    it('should create an instance of SDKEphemPubKey', function() {
      // uncomment below and update the code to test SDKEphemPubKey
      //var instance = new AdyenCheckoutApi.SDKEphemPubKey();
      //expect(instance).to.be.a(AdyenCheckoutApi.SDKEphemPubKey);
    });
