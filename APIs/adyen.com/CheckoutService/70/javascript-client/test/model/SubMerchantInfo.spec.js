...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.SubMerchantInfo();
  });
  ...
  describe('SubMerchantInfo', function() {
    it('should create an instance of SubMerchantInfo', function() {
      // uncomment below and update the code to test SubMerchantInfo
      //var instance = new AdyenCheckoutApi.SubMerchantInfo();
      //expect(instance).to.be.a(AdyenCheckoutApi.SubMerchantInfo);
    });
