...
class CreateOrderResponse {
     ...
     * @param amount {module:model/Amount} The initial amount of the order.
     ...
     */
    constructor(amount, expiresAt, orderData, remainingAmount, resultCode) { 
        
        CreateOrderResponse.initialize(this, amount, expiresAt, orderData, remainingAmount, resultCode);
    }
     ...
     */
    static initialize(obj, amount, expiresAt, orderData, remainingAmount, resultCode) { 
        obj['amount'] = amount;
...
CreateOrderResponse.RequiredProperties = ["amount", "expiresAt", "orderData", "remainingAmount", "resultCode"];
 ...
 */
CreateOrderResponse.prototype['amount'] = undefined;
