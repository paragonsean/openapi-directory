...
class PaymentResponseAction {
     ...
     * @param {(module:model/CheckoutAwaitAction|module:model/CheckoutDelegatedAuthenticationAction|module:model/CheckoutNativeRedirectAction|module:model/CheckoutQrCodeAction|module:model/CheckoutRedirectAction|module:model/CheckoutSDKAction|module:model/CheckoutThreeDS2Action|module:model/CheckoutVoucherAction)} instance The actual instance to initialize PaymentResponseAction.
     */
    constructor(instance = null) {
        ...
        try {
            if (typeof instance === "CheckoutDelegatedAuthenticationAction") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                CheckoutDelegatedAuthenticationAction.validateJSON(instance); // throw an exception if no match
                // create CheckoutDelegatedAuthenticationAction from JS object
                this.actualInstance = CheckoutDelegatedAuthenticationAction.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into CheckoutDelegatedAuthenticationAction
            errorMessages.push("Failed to construct CheckoutDelegatedAuthenticationAction: " + err)
        }
        ...
        try {
            if (typeof instance === "CheckoutThreeDS2Action") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                CheckoutThreeDS2Action.validateJSON(instance); // throw an exception if no match
                // create CheckoutThreeDS2Action from JS object
                this.actualInstance = CheckoutThreeDS2Action.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into CheckoutThreeDS2Action
            errorMessages.push("Failed to construct CheckoutThreeDS2Action: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `PaymentResponseAction` with oneOf schemas CheckoutAwaitAction, CheckoutDelegatedAuthenticationAction, CheckoutNativeRedirectAction, CheckoutQrCodeAction, CheckoutRedirectAction, CheckoutSDKAction, CheckoutThreeDS2Action, CheckoutVoucherAction. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `PaymentResponseAction` with oneOf schemas CheckoutAwaitAction, CheckoutDelegatedAuthenticationAction, CheckoutNativeRedirectAction, CheckoutQrCodeAction, CheckoutRedirectAction, CheckoutSDKAction, CheckoutThreeDS2Action, CheckoutVoucherAction. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Gets the actual instance, which can be <code>CheckoutAwaitAction</code>, <code>CheckoutDelegatedAuthenticationAction</code>, <code>CheckoutNativeRedirectAction</code>, <code>CheckoutQrCodeAction</code>, <code>CheckoutRedirectAction</code>, <code>CheckoutSDKAction</code>, <code>CheckoutThreeDS2Action</code>, <code>CheckoutVoucherAction</code>.
     * @return {(module:model/CheckoutAwaitAction|module:model/CheckoutDelegatedAuthenticationAction|module:model/CheckoutNativeRedirectAction|module:model/CheckoutQrCodeAction|module:model/CheckoutRedirectAction|module:model/CheckoutSDKAction|module:model/CheckoutThreeDS2Action|module:model/CheckoutVoucherAction)} The actual instance.
     */
    getActualInstance() {
     ...
     * @param {(module:model/CheckoutAwaitAction|module:model/CheckoutDelegatedAuthenticationAction|module:model/CheckoutNativeRedirectAction|module:model/CheckoutQrCodeAction|module:model/CheckoutRedirectAction|module:model/CheckoutSDKAction|module:model/CheckoutThreeDS2Action|module:model/CheckoutVoucherAction)} obj The actual instance.
     */
 ...
 * @member {String} authorisationToken
 */
PaymentResponseAction.prototype['authorisationToken'] = undefined;
 ...
 */
PaymentResponseAction.prototype['subtype'] = undefined;
 ...
 * @member {String} passCreationToken
 */
PaymentResponseAction.prototype['passCreationToken'] = undefined;
...
PaymentResponseAction.OneOf = ["CheckoutAwaitAction", "CheckoutDelegatedAuthenticationAction", "CheckoutNativeRedirectAction", "CheckoutQrCodeAction", "CheckoutRedirectAction", "CheckoutSDKAction", "CheckoutThreeDS2Action", "CheckoutVoucherAction"];
