    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('issuers')) {
                obj['issuers'] = ApiClient.convertToType(data['issuers'], [PaymentMethodIssuer]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['issuers']) { // data not null
            ...
            for (const item of data['issuers']) {
                PaymentMethodIssuer.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/PaymentMethodIssuer>} issuers
 */
PaymentMethod.prototype['issuers'] = undefined;
