...
class LineItem {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('receiverEmail')) {
                obj['receiverEmail'] = ApiClient.convertToType(data['receiverEmail'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['receiverEmail'] && !(typeof data['receiverEmail'] === 'string' || data['receiverEmail'] instanceof String)) {
            throw new Error("Expected the field `receiverEmail` to be a primitive type in the JSON string but got " + data['receiverEmail']);
        }
        // ensure the json data is a string
 ...
 * @member {String} brand
 */
LineItem.prototype['brand'] = undefined;

/**
 * Color of the item.
 * @member {String} color
 */
LineItem.prototype['color'] = undefined;
 ...
 */
LineItem.prototype['manufacturer'] = undefined;
 ...
 * @member {String} receiverEmail
 */
LineItem.prototype['receiverEmail'] = undefined;

/**
 * Size of the item.
 * @member {String} size
 */
LineItem.prototype['size'] = undefined;
 ...
 * @member {String} upc
 */
LineItem.prototype['upc'] = undefined;
