...
/**
 * The CreateCheckoutSessionRequest model module.
 * @module model/CreateCheckoutSessionRequest
 * @version 70
 */
class CreateCheckoutSessionRequest {
    /**
     * Constructs a new <code>CreateCheckoutSessionRequest</code>.
     * @alias module:model/CreateCheckoutSessionRequest
     ...
     */
    constructor(amount, merchantAccount, reference, returnUrl) { 
        
        CreateCheckoutSessionRequest.initialize(this, amount, merchantAccount, reference, returnUrl);
    }
     ...
     */
    static initialize(obj, amount, merchantAccount, reference, returnUrl) { 
        obj['amount'] = amount;
    ...
    /**
     * Constructs a <code>CreateCheckoutSessionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCheckoutSessionRequest} obj Optional instance to populate.
     * @return {module:model/CreateCheckoutSessionRequest} The populated <code>CreateCheckoutSessionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCheckoutSessionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCheckoutSessionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCheckoutSessionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCheckoutSessionRequest.RequiredProperties) {
...
CreateCheckoutSessionRequest.RequiredProperties = ["amount", "merchantAccount", "reference", "returnUrl"];
 ...
 */
CreateCheckoutSessionRequest.prototype['accountInfo'] = undefined;
 ...
 */
CreateCheckoutSessionRequest.prototype['additionalAmount'] = undefined;

/**
 * @member {module:model/BalanceCheckRequestAdditionalData} additionalData
 */
CreateCheckoutSessionRequest.prototype['additionalData'] = undefined;

/**
 * List of payment methods to be presented to the shopper. To refer to payment methods, use their [payment method type](https://docs.adyen.com/payment-methods/payment-method-types).  Example: `\"allowedPaymentMethods\":[\"ideal\",\"giropay\"]`
 * @member {Array.<String>} allowedPaymentMethods
 */
CreateCheckoutSessionRequest.prototype['allowedPaymentMethods'] = undefined;

/**
 * The amount of the payment.
 * @member {module:model/Amount} amount
 */
CreateCheckoutSessionRequest.prototype['amount'] = undefined;

/**
 * Information about your application. For more details, see [Building Adyen solutions](https://docs.adyen.com/development-resources/building-adyen-solutions).
 * @member {module:model/ApplicationInfo} applicationInfo
 */
CreateCheckoutSessionRequest.prototype['applicationInfo'] = undefined;

/**
 * Configuration data for 3DS payments.
 * @member {module:model/AuthenticationData} authenticationData
 */
CreateCheckoutSessionRequest.prototype['authenticationData'] = undefined;

/**
 * The address where to send the invoice.
 * @member {module:model/BillingAddress} billingAddress
 */
CreateCheckoutSessionRequest.prototype['billingAddress'] = undefined;

/**
 * List of payment methods to be hidden from the shopper. To refer to payment methods, use their [payment method type](https://docs.adyen.com/payment-methods/payment-method-types).  Example: `\"blockedPaymentMethods\":[\"ideal\",\"giropay\"]`
 * @member {Array.<String>} blockedPaymentMethods
 */
CreateCheckoutSessionRequest.prototype['blockedPaymentMethods'] = undefined;

/**
 * The delay between the authorisation and scheduled auto-capture, specified in hours.
 * @member {Number} captureDelayHours
 */
CreateCheckoutSessionRequest.prototype['captureDelayHours'] = undefined;

/**
 * The platform where a payment transaction takes place. This field is optional for filtering out payment methods that are only available on specific platforms. If this value is not set, then we will try to infer it from the `sdkVersion` or `token`.  Possible values: * **iOS** * **Android** * **Web**
 * @member {module:model/CreateCheckoutSessionRequest.ChannelEnum} channel
 */
CreateCheckoutSessionRequest.prototype['channel'] = undefined;

/**
 * Information regarding the company.
 * @member {module:model/Company} company
 */
CreateCheckoutSessionRequest.prototype['company'] = undefined;

/**
 * The shopper's two-letter country code.
 * @member {String} countryCode
 */
CreateCheckoutSessionRequest.prototype['countryCode'] = undefined;

/**
 * The shopper's date of birth.  Format [ISO-8601](https://www.w3.org/TR/NOTE-datetime): YYYY-MM-DD
 * @member {Date} dateOfBirth
 */
CreateCheckoutSessionRequest.prototype['dateOfBirth'] = undefined;

/**
 * The date and time when the purchased goods should be delivered.  [ISO 8601](https://www.w3.org/TR/NOTE-datetime) format: YYYY-MM-DDThh:mm:ss+TZD, for example, **2020-12-18T10:15:30+01:00**.
 * @member {Date} deliverAt
 */
CreateCheckoutSessionRequest.prototype['deliverAt'] = undefined;

/**
 * The address where the purchased goods should be delivered.
 * @member {module:model/DeliveryAddress} deliveryAddress
 */
CreateCheckoutSessionRequest.prototype['deliveryAddress'] = undefined;

/**
 * When true and `shopperReference` is provided, the shopper will be asked if the payment details should be stored for future one-click payments.
 * @member {Boolean} enableOneClick
 */
CreateCheckoutSessionRequest.prototype['enableOneClick'] = undefined;

/**
 * When true and `shopperReference` is provided, the payment details will be tokenized for payouts.
 * @member {Boolean} enablePayOut
 */
CreateCheckoutSessionRequest.prototype['enablePayOut'] = undefined;

/**
 * When true and `shopperReference` is provided, the payment details will be tokenized for recurring payments.
 * @member {Boolean} enableRecurring
 */
CreateCheckoutSessionRequest.prototype['enableRecurring'] = undefined;
 ...
 */
CreateCheckoutSessionRequest.prototype['expiresAt'] = undefined;

/**
 * The person or entity funding the money.
 * @member {module:model/FundOrigin} fundOrigin
 */
CreateCheckoutSessionRequest.prototype['fundOrigin'] = undefined;

/**
 * the person or entity receiving the money
 * @member {module:model/FundRecipient} fundRecipient
 */
CreateCheckoutSessionRequest.prototype['fundRecipient'] = undefined;
 ...
 */
CreateCheckoutSessionRequest.prototype['installmentOptions'] = undefined;
 ...
 */
CreateCheckoutSessionRequest.prototype['lineItems'] = undefined;

/**
 * The mandate details to initiate recurring transaction.
 * @member {module:model/Mandate} mandate
 */
CreateCheckoutSessionRequest.prototype['mandate'] = undefined;

/**
 * The [merchant category code](https://en.wikipedia.org/wiki/Merchant_category_code) (MCC) is a four-digit number, which relates to a particular market segment. This code reflects the predominant activity that is conducted by the merchant.
 * @member {String} mcc
 */
CreateCheckoutSessionRequest.prototype['mcc'] = undefined;

/**
 * The merchant account identifier, with which you want to process the transaction.
 * @member {String} merchantAccount
 */
CreateCheckoutSessionRequest.prototype['merchantAccount'] = undefined;
 ...
 */
CreateCheckoutSessionRequest.prototype['merchantOrderReference'] = undefined;
 ...
 */
CreateCheckoutSessionRequest.prototype['metadata'] = undefined;
 ...
 * @member {module:model/CreateCheckoutSessionRequest.ModeEnum} mode
 * @default 'embedded'
 */
CreateCheckoutSessionRequest.prototype['mode'] = 'embedded';

/**
 * Authentication data produced by an MPI (Mastercard SecureCode, Visa Secure, or Cartes Bancaires).
 * @member {module:model/ThreeDSecureData} mpiData
 */
CreateCheckoutSessionRequest.prototype['mpiData'] = undefined;
 ...
 */
CreateCheckoutSessionRequest.prototype['platformChargebackLogic'] = undefined;

/**
 * Date after which no further authorisations shall be performed. Only for 3D Secure 2.
 * @member {String} recurringExpiry
 */
CreateCheckoutSessionRequest.prototype['recurringExpiry'] = undefined;

/**
 * Minimum number of days between authorisations. Only for 3D Secure 2.
 * @member {String} recurringFrequency
 */
CreateCheckoutSessionRequest.prototype['recurringFrequency'] = undefined;
 ...
 * @member {module:model/CreateCheckoutSessionRequest.RecurringProcessingModelEnum} recurringProcessingModel
 */
CreateCheckoutSessionRequest.prototype['recurringProcessingModel'] = undefined;

/**
 * Specifies the redirect method (GET or POST) when redirecting back from the issuer.
 * @member {String} redirectFromIssuerMethod
 */
CreateCheckoutSessionRequest.prototype['redirectFromIssuerMethod'] = undefined;

/**
 * Specifies the redirect method (GET or POST) when redirecting to the issuer.
 * @member {String} redirectToIssuerMethod
 */
CreateCheckoutSessionRequest.prototype['redirectToIssuerMethod'] = undefined;

/**
 * The reference to uniquely identify a payment.
 * @member {String} reference
 */
CreateCheckoutSessionRequest.prototype['reference'] = undefined;

/**
 * The URL to return to when a redirect payment is completed.
 * @member {String} returnUrl
 */
CreateCheckoutSessionRequest.prototype['returnUrl'] = undefined;

/**
 * Any risk-related settings to apply to the payment.
 * @member {module:model/RiskData} riskData
 */
CreateCheckoutSessionRequest.prototype['riskData'] = undefined;

/**
 * The shopper's email address.
 * @member {String} shopperEmail
 */
CreateCheckoutSessionRequest.prototype['shopperEmail'] = undefined;

/**
 * The shopper's IP address. In general, we recommend that you provide this data, as it is used in a number of risk checks (for instance, number of payment attempts or location-based checks). > For 3D Secure 2 transactions, schemes require `shopperIP` for all browser-based implementations. This field is also mandatory for some merchants depending on your business model. For more information, [contact Support](https://www.adyen.help/hc/en-us/requests/new).
 * @member {String} shopperIP
 */
CreateCheckoutSessionRequest.prototype['shopperIP'] = undefined;
 ...
 * @member {module:model/CreateCheckoutSessionRequest.ShopperInteractionEnum} shopperInteraction
 */
CreateCheckoutSessionRequest.prototype['shopperInteraction'] = undefined;

/**
 * The combination of a language code and a country code to specify the language to be used in the payment.
 * @member {String} shopperLocale
 */
CreateCheckoutSessionRequest.prototype['shopperLocale'] = undefined;
 ...
 */
CreateCheckoutSessionRequest.prototype['shopperName'] = undefined;

/**
 * Your reference to uniquely identify this shopper, for example user ID or account ID. Minimum length: 3 characters. > Your reference must not include personally identifiable information (PII), for example name or email address.
 * @member {String} shopperReference
 */
CreateCheckoutSessionRequest.prototype['shopperReference'] = undefined;

/**
 * The text to be shown on the shopper's bank statement.  We recommend sending a maximum of 22 characters, otherwise banks might truncate the string.  Allowed characters: **a-z**, **A-Z**, **0-9**, spaces, and special characters **. , ' _ - ? + * /_**.
 * @member {String} shopperStatement
 */
CreateCheckoutSessionRequest.prototype['shopperStatement'] = undefined;

/**
 * Set to true to show the payment amount per installment.
 * @member {Boolean} showInstallmentAmount
 */
CreateCheckoutSessionRequest.prototype['showInstallmentAmount'] = undefined;
 ...
 */
CreateCheckoutSessionRequest.prototype['showRemovePaymentMethodButton'] = undefined;

/**
 * The shopper's social security number.
 * @member {String} socialSecurityNumber
 */
CreateCheckoutSessionRequest.prototype['socialSecurityNumber'] = undefined;
 ...
 * @default false
 */
CreateCheckoutSessionRequest.prototype['splitCardFundingSources'] = false;

/**
 * An array of objects specifying how to split a payment when using [Adyen for Platforms](https://docs.adyen.com/marketplaces-and-platforms/processing-payments#providing-split-information), [Classic Platforms integration](https://docs.adyen.com/marketplaces-and-platforms/classic/processing-payments#providing-split-information), or [Issuing](https://docs.adyen.com/issuing/manage-funds#split).
 * @member {Array.<module:model/Split>} splits
 */
CreateCheckoutSessionRequest.prototype['splits'] = undefined;
 ...
 * @member {String} store
 */
CreateCheckoutSessionRequest.prototype['store'] = undefined;
 ...
 */
CreateCheckoutSessionRequest.prototype['storePaymentMethod'] = undefined;
 ...
 * @member {module:model/CreateCheckoutSessionRequest.StorePaymentMethodModeEnum} storePaymentMethodMode
 */
CreateCheckoutSessionRequest.prototype['storePaymentMethodMode'] = undefined;

/**
 * The shopper's telephone number.
 * @member {String} telephoneNumber
 */
CreateCheckoutSessionRequest.prototype['telephoneNumber'] = undefined;
 ...
 */
CreateCheckoutSessionRequest.prototype['themeId'] = undefined;
 ...
 * @default false
 */
CreateCheckoutSessionRequest.prototype['threeDSAuthenticationOnly'] = false;

/**
 * Set to true if the payment should be routed to a trusted MID.
 * @member {Boolean} trustedShopper
 */
CreateCheckoutSessionRequest.prototype['trustedShopper'] = undefined;
...
export default CreateCheckoutSessionRequest;
