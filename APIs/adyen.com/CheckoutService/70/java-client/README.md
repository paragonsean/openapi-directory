...
Adyen Checkout API
- API version: 70
  - Build date: 2024-10-12T11:16:55.217248-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:70"
  }
```
...
* `target/openapi-java-client-70.jar`
* `target/lib/*.jar`
...
## Documentation for Models
 ...
 - [CheckoutDelegatedAuthenticationAction](docs/CheckoutDelegatedAuthenticationAction.md)
 ...
 - [SessionResultResponse](docs/SessionResultResponse.md)
 ...
 - [SubMerchantInfo](docs/SubMerchantInfo.md)
