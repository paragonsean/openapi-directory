...
|**externalResponseCode** | **String** | The response code returned by an external system (for example after a provisioning operation). |  [optional] |
|**externalTokenReference** | **String** | The token reference of a linked token in an external system (for example a network token reference). |  [optional] |
...
|**issuerName** | **String** | The name of the issuer of token or card. |  [optional] |
