...
public class PaymentCaptureResponse {
  ...
  public static final String SERIALIZED_NAME_SUB_MERCHANTS = "subMerchants";
  @SerializedName(SERIALIZED_NAME_SUB_MERCHANTS)
  ...
  static {
    ...
    openapiFields.add("subMerchants");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("subMerchants") != null && !jsonObj.get("subMerchants").isJsonNull()) {
        JsonArray jsonArraysubMerchants = jsonObj.getAsJsonArray("subMerchants");
        if (jsonArraysubMerchants != null) {
          // ensure the json data is an array
          if (!jsonObj.get("subMerchants").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `subMerchants` to be an array in the JSON string but got `%s`", jsonObj.get("subMerchants").toString()));
          }

          // validate the optional field `subMerchants` (array)
          for (int i = 0; i < jsonArraysubMerchants.size(); i++) {
            SubMerchantInfo.validateJsonElement(jsonArraysubMerchants.get(i));
          };
        }
      }
  }
