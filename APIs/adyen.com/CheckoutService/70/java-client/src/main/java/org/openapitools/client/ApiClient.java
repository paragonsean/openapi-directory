...
public class ApiClient {
    ...
    private String basePath = "https://checkout-test.adyen.com/v70";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/70/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://checkout-test.adyen.com/v70
