...
public class StoredPaymentMethodResource {
   ...
   * @throws IOException if the JSON Element is invalid with respect to StoredPaymentMethodResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StoredPaymentMethodResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StoredPaymentMethodResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StoredPaymentMethodResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("externalResponseCode") != null && !jsonObj.get("externalResponseCode").isJsonNull()) && !jsonObj.get("externalResponseCode").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("externalTokenReference") != null && !jsonObj.get("externalTokenReference").isJsonNull()) && !jsonObj.get("externalTokenReference").isJsonPrimitive()) {
      ...
      if (jsonObj.get("supportedRecurringProcessingModels") != null && !jsonObj.get("supportedRecurringProcessingModels").isJsonNull() && !jsonObj.get("supportedRecurringProcessingModels").isJsonArray()) {
