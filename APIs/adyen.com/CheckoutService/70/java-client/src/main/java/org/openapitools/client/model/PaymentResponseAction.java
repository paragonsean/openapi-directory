...
public class PaymentResponseAction extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<CheckoutDelegatedAuthenticationAction> adapterCheckoutDelegatedAuthenticationAction = gson.getDelegateAdapter(this, TypeToken.get(CheckoutDelegatedAuthenticationAction.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<PaymentResponseAction>() {
                ...
                public void write(JsonWriter out, PaymentResponseAction value) throws IOException {
                    ...
                    // check if the actual instance is of the type `CheckoutDelegatedAuthenticationAction`
                    if (value.getActualInstance() instanceof CheckoutDelegatedAuthenticationAction) {
                        JsonElement element = adapterCheckoutDelegatedAuthenticationAction.toJsonTree((CheckoutDelegatedAuthenticationAction)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    ...
                    if (value.getActualInstance() instanceof CheckoutThreeDS2Action) {
                        JsonElement element = adapterCheckoutThreeDS2Action.toJsonTree((CheckoutThreeDS2Action)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: CheckoutAwaitAction, CheckoutDelegatedAuthenticationAction, CheckoutNativeRedirectAction, CheckoutQrCodeAction, CheckoutRedirectAction, CheckoutSDKAction, CheckoutThreeDS2Action, CheckoutVoucherAction");
                }
                ...
                public PaymentResponseAction read(JsonReader in) throws IOException {
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CheckoutDelegatedAuthenticationAction.validateJsonElement(jsonElement);
                        actualAdapter = adapterCheckoutDelegatedAuthenticationAction;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'CheckoutDelegatedAuthenticationAction'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for CheckoutDelegatedAuthenticationAction failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CheckoutThreeDS2Action.validateJsonElement(jsonElement);
    ...
    static {
        ...
        schemas.put("CheckoutDelegatedAuthenticationAction", CheckoutDelegatedAuthenticationAction.class);
        ...
        schemas.put("CheckoutThreeDS2Action", CheckoutThreeDS2Action.class);
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof CheckoutDelegatedAuthenticationAction) {
            super.setActualInstance(instance);
            return;
        }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with CheckoutDelegatedAuthenticationAction
        try {
            CheckoutDelegatedAuthenticationAction.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for PaymentResponseAction with oneOf schemas: CheckoutAwaitAction, CheckoutDelegatedAuthenticationAction, CheckoutNativeRedirectAction, CheckoutQrCodeAction, CheckoutRedirectAction, CheckoutSDKAction, CheckoutThreeDS2Action, CheckoutVoucherAction. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
