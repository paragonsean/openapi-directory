...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentDetailsResponse();
  });
  ...
  describe('PaymentDetailsResponse', function() {
    it('should create an instance of PaymentDetailsResponse', function() {
      // uncomment below and update the code to test PaymentDetailsResponse
      //var instance = new AdyenCheckoutApi.PaymentDetailsResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentDetailsResponse);
    });
