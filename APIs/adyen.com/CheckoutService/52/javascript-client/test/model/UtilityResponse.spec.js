...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.UtilityResponse();
  });
  ...
  describe('UtilityResponse', function() {
    it('should create an instance of UtilityResponse', function() {
      // uncomment below and update the code to test UtilityResponse
      //var instance = new AdyenCheckoutApi.UtilityResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.UtilityResponse);
    });

    it('should have the property originKeys (base name: "originKeys")', function() {
      // uncomment below and update the code to test the property originKeys
      //var instance = new AdyenCheckoutApi.UtilityResponse();
