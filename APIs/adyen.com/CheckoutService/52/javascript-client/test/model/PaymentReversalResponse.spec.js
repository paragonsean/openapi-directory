...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentReversalResponse();
  });
  ...
  describe('PaymentReversalResponse', function() {
    it('should create an instance of PaymentReversalResponse', function() {
      // uncomment below and update the code to test PaymentReversalResponse
      //var instance = new AdyenCheckoutApi.PaymentReversalResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentReversalResponse);
    });
