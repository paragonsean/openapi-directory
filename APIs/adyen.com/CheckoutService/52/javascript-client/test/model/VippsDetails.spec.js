...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.VippsDetails();
  });
  ...
  describe('VippsDetails', function() {
    it('should create an instance of VippsDetails', function() {
      // uncomment below and update the code to test VippsDetails
      //var instance = new AdyenCheckoutApi.VippsDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.VippsDetails);
    });
