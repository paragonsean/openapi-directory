...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.DonationPaymentResponse();
  });
  ...
  describe('DonationPaymentResponse', function() {
    it('should create an instance of DonationPaymentResponse', function() {
      // uncomment below and update the code to test DonationPaymentResponse
      //var instance = new AdyenCheckoutApi.DonationPaymentResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.DonationPaymentResponse);
    });
