...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentMethodGroup();
  });
  ...
  describe('PaymentMethodGroup', function() {
    it('should create an instance of PaymentMethodGroup', function() {
      // uncomment below and update the code to test PaymentMethodGroup
      //var instance = new AdyenCheckoutApi.PaymentMethodGroup();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentMethodGroup);
    });
    ...
    it('should have the property paymentMethodData (base name: "paymentMethodData")', function() {
      // uncomment below and update the code to test the property paymentMethodData
      //var instance = new AdyenCheckoutApi.PaymentMethodGroup();
      //expect(instance).to.be();
    });
