...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentVerificationRequest();
  });
  ...
  describe('PaymentVerificationRequest', function() {
    it('should create an instance of PaymentVerificationRequest', function() {
      // uncomment below and update the code to test PaymentVerificationRequest
      //var instance = new AdyenCheckoutApi.PaymentVerificationRequest();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentVerificationRequest);
    });
