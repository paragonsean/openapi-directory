...
/*
 * OAIApplePayDetails.h
 *
 * 
 */

#ifndef OAIApplePayDetails_H
#define OAIApplePayDetails_H
...
class OAIApplePayDetails : public OAIObject {
public:
    OAIApplePayDetails();
    OAIApplePayDetails(QString json);
    ~OAIApplePayDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplePayDetails)

#endif // OAIApplePayDetails_H
