...
#ifndef OAIUtilityRequest_H
#define OAIUtilityRequest_H
...
class OAIUtilityRequest : public OAIObject {
public:
    OAIUtilityRequest();
    OAIUtilityRequest(QString json);
    ~OAIUtilityRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUtilityRequest)

#endif // OAIUtilityRequest_H
