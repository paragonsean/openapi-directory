...
#ifndef OAIIdealDonations_H
#define OAIIdealDonations_H
...
class OAIIdealDonations : public OAIObject {
public:
    OAIIdealDonations();
    OAIIdealDonations(QString json);
    ~OAIIdealDonations() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdealDonations)

#endif // OAIIdealDonations_H
