...
/*
 * OAIPaymentVerificationRequest.h
 *
 * 
 */

#ifndef OAIPaymentVerificationRequest_H
#define OAIPaymentVerificationRequest_H
...
class OAIPaymentVerificationRequest : public OAIObject {
public:
    OAIPaymentVerificationRequest();
    OAIPaymentVerificationRequest(QString json);
    ~OAIPaymentVerificationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentVerificationRequest)

#endif // OAIPaymentVerificationRequest_H
