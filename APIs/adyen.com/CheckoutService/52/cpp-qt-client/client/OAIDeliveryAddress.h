...
/*
 * OAIDeliveryAddress.h
 *
 * 
 */

#ifndef OAIDeliveryAddress_H
#define OAIDeliveryAddress_H
...
class OAIDeliveryAddress : public OAIObject {
public:
    OAIDeliveryAddress();
    OAIDeliveryAddress(QString json);
    ~OAIDeliveryAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeliveryAddress)

#endif // OAIDeliveryAddress_H
