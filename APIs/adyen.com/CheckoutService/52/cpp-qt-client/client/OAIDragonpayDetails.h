...
/*
 * OAIDragonpayDetails.h
 *
 * 
 */

#ifndef OAIDragonpayDetails_H
#define OAIDragonpayDetails_H
...
class OAIDragonpayDetails : public OAIObject {
public:
    OAIDragonpayDetails();
    OAIDragonpayDetails(QString json);
    ~OAIDragonpayDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDragonpayDetails)

#endif // OAIDragonpayDetails_H
