...
/**
 * Model tests for SamsungPayDetails
 */
public class SamsungPayDetailsTest {
    private final SamsungPayDetails model = new SamsungPayDetails();
