...
/**
 * Model tests for MasterpassDetails
 */
public class MasterpassDetailsTest {
    private final MasterpassDetails model = new MasterpassDetails();
