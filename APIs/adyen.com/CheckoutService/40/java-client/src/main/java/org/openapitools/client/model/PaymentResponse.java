...
public class PaymentResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalData, authentication, details, fraudResult, order, outputDetails, paymentData, pspReference, redirect, refusalReason, refusalReasonCode, resultCode);
  }
