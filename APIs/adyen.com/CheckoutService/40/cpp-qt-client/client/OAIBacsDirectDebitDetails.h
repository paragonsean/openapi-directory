...
/*
 * OAIBacsDirectDebitDetails.h
 *
 * 
 */

#ifndef OAIBacsDirectDebitDetails_H
#define OAIBacsDirectDebitDetails_H
...
class OAIBacsDirectDebitDetails : public OAIObject {
public:
    OAIBacsDirectDebitDetails();
    OAIBacsDirectDebitDetails(QString json);
    ~OAIBacsDirectDebitDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBacsDirectDebitDetails)

#endif // OAIBacsDirectDebitDetails_H
