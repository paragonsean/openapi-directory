...
/*
 * OAISepaDirectDebitDetails.h
 *
 * 
 */

#ifndef OAISepaDirectDebitDetails_H
#define OAISepaDirectDebitDetails_H
...
class OAISepaDirectDebitDetails : public OAIObject {
public:
    OAISepaDirectDebitDetails();
    OAISepaDirectDebitDetails(QString json);
    ~OAISepaDirectDebitDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISepaDirectDebitDetails)

#endif // OAISepaDirectDebitDetails_H
