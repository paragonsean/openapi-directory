...
#ifndef OAIMbwayDetails_H
#define OAIMbwayDetails_H
...
class OAIMbwayDetails : public OAIObject {
public:
    OAIMbwayDetails();
    OAIMbwayDetails(QString json);
    ~OAIMbwayDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMbwayDetails)

#endif // OAIMbwayDetails_H
