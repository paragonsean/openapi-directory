...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.EcontextVoucherDetails();
  });
  ...
  describe('EcontextVoucherDetails', function() {
    it('should create an instance of EcontextVoucherDetails', function() {
      // uncomment below and update the code to test EcontextVoucherDetails
      //var instance = new AdyenCheckoutApi.EcontextVoucherDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.EcontextVoucherDetails);
    });
