...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.InputDetail();
  });
  ...
  describe('InputDetail', function() {
    it('should create an instance of InputDetail', function() {
      // uncomment below and update the code to test InputDetail
      //var instance = new AdyenCheckoutApi.InputDetail();
      //expect(instance).to.be.a(AdyenCheckoutApi.InputDetail);
    });
    ...
    it('should have the property itemSearchUrl (base name: "itemSearchUrl")', function() {
      // uncomment below and update the code to test the property itemSearchUrl
      //var instance = new AdyenCheckoutApi.InputDetail();
      //expect(instance).to.be();
    });
