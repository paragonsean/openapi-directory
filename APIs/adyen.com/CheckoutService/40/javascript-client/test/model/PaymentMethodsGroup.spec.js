...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentMethodsGroup();
  });
  ...
  describe('PaymentMethodsGroup', function() {
    it('should create an instance of PaymentMethodsGroup', function() {
      // uncomment below and update the code to test PaymentMethodsGroup
      //var instance = new AdyenCheckoutApi.PaymentMethodsGroup();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentMethodsGroup);
    });
