...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentReversalRequest();
  });
  ...
  describe('PaymentReversalRequest', function() {
    it('should create an instance of PaymentReversalRequest', function() {
      // uncomment below and update the code to test PaymentReversalRequest
      //var instance = new AdyenCheckoutApi.PaymentReversalRequest();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentReversalRequest);
    });
