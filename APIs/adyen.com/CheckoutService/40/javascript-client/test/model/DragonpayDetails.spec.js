...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.DragonpayDetails();
  });
  ...
  describe('DragonpayDetails', function() {
    it('should create an instance of DragonpayDetails', function() {
      // uncomment below and update the code to test DragonpayDetails
      //var instance = new AdyenCheckoutApi.DragonpayDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.DragonpayDetails);
    });
