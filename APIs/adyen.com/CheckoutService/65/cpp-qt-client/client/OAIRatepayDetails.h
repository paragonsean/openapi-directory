...
#ifndef OAIRatepayDetails_H
#define OAIRatepayDetails_H
...
class OAIRatepayDetails : public OAIObject {
public:
    OAIRatepayDetails();
    OAIRatepayDetails(QString json);
    ~OAIRatepayDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRatepayDetails)

#endif // OAIRatepayDetails_H
