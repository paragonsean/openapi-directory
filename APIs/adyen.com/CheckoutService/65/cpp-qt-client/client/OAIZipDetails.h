...
#ifndef OAIZipDetails_H
#define OAIZipDetails_H
...
class OAIZipDetails : public OAIObject {
public:
    OAIZipDetails();
    OAIZipDetails(QString json);
    ~OAIZipDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIZipDetails)

#endif // OAIZipDetails_H
