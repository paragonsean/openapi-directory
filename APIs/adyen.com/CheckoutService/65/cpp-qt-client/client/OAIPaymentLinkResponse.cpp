...
bool OAIPaymentLinkResponse::isStorePaymentMethod() const {
    return m_store_payment_method;
}
void OAIPaymentLinkResponse::setStorePaymentMethod(const bool &store_payment_method) {
    m_store_payment_method = store_payment_method;
    m_store_payment_method_isSet = true;
}

bool OAIPaymentLinkResponse::is_store_payment_method_Set() const{
    return m_store_payment_method_isSet;
}

bool OAIPaymentLinkResponse::is_store_payment_method_Valid() const{
