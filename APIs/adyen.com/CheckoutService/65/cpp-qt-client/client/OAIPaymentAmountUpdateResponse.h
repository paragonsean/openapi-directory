...
/*
 * OAIPaymentAmountUpdateResponse.h
 *
 * 
 */

#ifndef OAIPaymentAmountUpdateResponse_H
#define OAIPaymentAmountUpdateResponse_H
...
class OAIPaymentAmountUpdateResponse : public OAIObject {
public:
    OAIPaymentAmountUpdateResponse();
    OAIPaymentAmountUpdateResponse(QString json);
    ~OAIPaymentAmountUpdateResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentAmountUpdateResponse)

#endif // OAIPaymentAmountUpdateResponse_H
