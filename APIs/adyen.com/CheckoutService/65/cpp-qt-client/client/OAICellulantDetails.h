...
/*
 * OAICellulantDetails.h
 *
 * 
 */

#ifndef OAICellulantDetails_H
#define OAICellulantDetails_H
...
class OAICellulantDetails : public OAIObject {
public:
    OAICellulantDetails();
    OAICellulantDetails(QString json);
    ~OAICellulantDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICellulantDetails)

#endif // OAICellulantDetails_H
