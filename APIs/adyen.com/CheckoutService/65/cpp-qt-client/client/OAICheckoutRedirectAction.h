...
/*
 * OAICheckoutRedirectAction.h
 *
 * 
 */

#ifndef OAICheckoutRedirectAction_H
#define OAICheckoutRedirectAction_H
...
class OAICheckoutRedirectAction : public OAIObject {
public:
    OAICheckoutRedirectAction();
    OAICheckoutRedirectAction(QString json);
    ~OAICheckoutRedirectAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckoutRedirectAction)

#endif // OAICheckoutRedirectAction_H
