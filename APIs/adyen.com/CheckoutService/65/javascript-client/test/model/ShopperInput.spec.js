...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.ShopperInput();
  });
  ...
  describe('ShopperInput', function() {
    it('should create an instance of ShopperInput', function() {
      // uncomment below and update the code to test ShopperInput
      //var instance = new AdyenCheckoutApi.ShopperInput();
      //expect(instance).to.be.a(AdyenCheckoutApi.ShopperInput);
    });
