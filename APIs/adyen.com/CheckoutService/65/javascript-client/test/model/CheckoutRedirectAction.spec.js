...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CheckoutRedirectAction();
  });
  ...
  describe('CheckoutRedirectAction', function() {
    it('should create an instance of CheckoutRedirectAction', function() {
      // uncomment below and update the code to test CheckoutRedirectAction
      //var instance = new AdyenCheckoutApi.CheckoutRedirectAction();
      //expect(instance).to.be.a(AdyenCheckoutApi.CheckoutRedirectAction);
    });
