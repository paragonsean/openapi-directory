...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.IdealDonations();
  });
  ...
  describe('IdealDonations', function() {
    it('should create an instance of IdealDonations', function() {
      // uncomment below and update the code to test IdealDonations
      //var instance = new AdyenCheckoutApi.IdealDonations();
      //expect(instance).to.be.a(AdyenCheckoutApi.IdealDonations);
    });
