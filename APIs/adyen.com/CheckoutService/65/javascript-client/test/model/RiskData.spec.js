...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.RiskData();
  });
  ...
  describe('RiskData', function() {
    it('should create an instance of RiskData', function() {
      // uncomment below and update the code to test RiskData
      //var instance = new AdyenCheckoutApi.RiskData();
      //expect(instance).to.be.a(AdyenCheckoutApi.RiskData);
    });
