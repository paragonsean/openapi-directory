...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CheckoutQrCodeAction();
  });
  ...
  describe('CheckoutQrCodeAction', function() {
    it('should create an instance of CheckoutQrCodeAction', function() {
      // uncomment below and update the code to test CheckoutQrCodeAction
      //var instance = new AdyenCheckoutApi.CheckoutQrCodeAction();
      //expect(instance).to.be.a(AdyenCheckoutApi.CheckoutQrCodeAction);
    });
