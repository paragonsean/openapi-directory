...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CommonField();
  });
  ...
  describe('CommonField', function() {
    it('should create an instance of CommonField', function() {
      // uncomment below and update the code to test CommonField
      //var instance = new AdyenCheckoutApi.CommonField();
      //expect(instance).to.be.a(AdyenCheckoutApi.CommonField);
    });
