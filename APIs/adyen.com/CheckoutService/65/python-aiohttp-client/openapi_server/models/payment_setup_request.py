...
class PaymentSetupRequest(Model):
    ...
    def __init__(self, additional_amount: Amount=None, additional_data: BalanceCheckRequestAdditionalData=None, allowed_payment_methods: List[str]=None, amount: Amount=None, application_info: ApplicationInfo=None, billing_address: Address=None, blocked_payment_methods: List[str]=None, capture_delay_hours: int=None, channel: str=None, company: Company=None, configuration: Configuration=None, conversion_id: str=None, country_code: str=None, date_of_birth: date=None, dcc_quote: ForexQuote=None, delivery_address: Address=None, delivery_date: datetime=None, enable_one_click: bool=None, enable_pay_out: bool=None, enable_recurring: bool=None, entity_type: str=None, fraud_offset: int=None, installments: Installments=None, line_items: List[LineItem]=None, mandate: Mandate=None, mcc: str=None, merchant_account: str=None, merchant_order_reference: str=None, metadata: Dict[str, str]=None, order_reference: str=None, origin: str=None, recurring_expiry: str=None, recurring_frequency: str=None, reference: str=None, return_url: str=None, risk_data: RiskData=None, sdk_version: str=None, session_validity: str=None, shopper_email: str=None, shopper_ip: str=None, shopper_interaction: str=None, shopper_locale: str=None, shopper_name: Name=None, shopper_reference: str=None, shopper_statement: str=None, social_security_number: str=None, splits: List[Split]=None, store: str=None, store_payment_method: bool=None, telephone_number: str=None, three_ds_authentication_only: bool=False, token: str=None, trusted_shopper: bool=None):
        ...
        :param application_info: The application_info of this PaymentSetupRequest.
        ...
        :param conversion_id: The conversion_id of this PaymentSetupRequest.
        ...
        :param store_payment_method: The store_payment_method of this PaymentSetupRequest.
        :param telephone_number: The telephone_number of this PaymentSetupRequest.
        :param three_ds_authentication_only: The three_ds_authentication_only of this PaymentSetupRequest.
    ...
    def application_info(self):
        """Gets the application_info of this PaymentSetupRequest.

        Information about your application. For more details, see [Building Adyen solutions](https://docs.adyen.com/development-resources/building-adyen-solutions).

        :return: The application_info of this PaymentSetupRequest.
    ...
    def application_info(self, application_info):
        """Sets the application_info of this PaymentSetupRequest.
    ...
    def conversion_id(self):
        """Gets the conversion_id of this PaymentSetupRequest.

        Conversion ID that corresponds to the Id generated by the client SDK for tracking user payment journey.

        :return: The conversion_id of this PaymentSetupRequest.
        :rtype: str
        """
    ...
    def conversion_id(self, conversion_id):
        """Sets the conversion_id of this PaymentSetupRequest.
    ...
    def store_payment_method(self):
        """Gets the store_payment_method of this PaymentSetupRequest.

        When true and `shopperReference` is provided, the payment details will be stored.

        :return: The store_payment_method of this PaymentSetupRequest.
        :rtype: bool
        """
    ...
    def store_payment_method(self, store_payment_method):
        """Sets the store_payment_method of this PaymentSetupRequest.
    ...
    def three_ds_authentication_only(self):
        """Gets the three_ds_authentication_only of this PaymentSetupRequest.

        If set to true, you will only perform the [3D Secure 2 authentication](https://docs.adyen.com/online-payments/3d-secure/other-3ds-flows/authentication-only), and not the payment authorisation.

        :return: The three_ds_authentication_only of this PaymentSetupRequest.
        :rtype: bool
        """
    ...
    def three_ds_authentication_only(self, three_ds_authentication_only):
        """Sets the three_ds_authentication_only of this PaymentSetupRequest.
