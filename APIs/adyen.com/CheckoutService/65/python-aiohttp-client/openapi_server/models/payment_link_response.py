...
class PaymentLinkResponse(Model):
    ...
    def __init__(self, allowed_payment_methods: List[str]=None, amount: Amount=None, application_info: ApplicationInfo=None, billing_address: Address=None, blocked_payment_methods: List[str]=None, country_code: str=None, deliver_at: datetime=None, delivery_address: Address=None, description: str=None, expires_at: str=None, id: str=None, installment_options: Dict[str, InstallmentOption]=None, line_items: List[LineItem]=None, manual_capture: bool=None, merchant_account: str=None, merchant_order_reference: str=None, metadata: Dict[str, str]=None, recurring_processing_model: str=None, reference: str=None, return_url: str=None, reusable: bool=None, risk_data: RiskData=None, shopper_email: str=None, shopper_locale: str=None, shopper_name: Name=None, shopper_reference: str=None, show_remove_payment_method_button: bool=True, splits: List[Split]=None, status: str=None, store: str=None, store_payment_method: bool=None, updated_at: datetime=None, url: str=None):
        ...
        :param store_payment_method: The store_payment_method of this PaymentLinkResponse.
    ...
    def status(self):
        ...
        Status of the payment link. Possible values: * **active**: The link can be used to make payments. * **expired**: The expiry date for the payment link has passed. Shoppers can no longer use the link to make payments. * **paid**: The shopper completed the payment.
    ...
    def store_payment_method(self):
        """Gets the store_payment_method of this PaymentLinkResponse.

        When this is set to **true** and the `shopperReference` is provided, the payment details will be stored.

        :return: The store_payment_method of this PaymentLinkResponse.
        :rtype: bool
        """
    ...
    def store_payment_method(self, store_payment_method):
        """Sets the store_payment_method of this PaymentLinkResponse.
