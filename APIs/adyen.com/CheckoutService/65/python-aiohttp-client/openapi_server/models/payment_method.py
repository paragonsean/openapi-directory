...
class PaymentMethod(Model):
    ...
    def __init__(self, brand: str=None, brands: List[str]=None, configuration: Dict[str, str]=None, details: List[InputDetail]=None, funding_source: str=None, group: PaymentMethodGroup=None, input_details: List[InputDetail]=None, name: str=None, type: str=None):
