...
public class PaymentAmountUpdateRequest {
  ...
  public PaymentAmountUpdateRequest reason(ReasonEnum reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, paymentAmountUpdateRequest.amount) &&
        ...
        Objects.equals(this.reason, paymentAmountUpdateRequest.reason) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, applicationInfo, merchantAccount, reason, reference, splits);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentAmountUpdateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentAmountUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentAmountUpdateRequest is not found in the empty JSON string", PaymentAmountUpdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentAmountUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentAmountUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentAmountUpdateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentAmountUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentAmountUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentAmountUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentAmountUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentAmountUpdateRequest>() {
           @Override
           public void write(JsonWriter out, PaymentAmountUpdateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentAmountUpdateRequest read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to PaymentAmountUpdateRequest
   */
  public static PaymentAmountUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentAmountUpdateRequest.class);
  }
