...
import org.openapitools.client.model.PaymentDetailsResponseAction;
...
public class PaymentDetailsResponse {
  ...
  public PaymentDetailsResponse additionalData(BalanceCheckResponseAdditionalData additionalData) {
  ...
  @Deprecated
  public PaymentDetailsResponse authentication(Map<String, String> authentication) {
    this.authentication = authentication;
    return this;
  }

  public PaymentDetailsResponse putAuthenticationItem(String key, String authenticationItem) {
    if (this.authentication == null) {
      this.authentication = new HashMap<>();
    }
    this.authentication.put(key, authenticationItem);
    return this;
  }
  ...
  public PaymentDetailsResponse details(List<InputDetail> details) {
    this.details = details;
    return this;
  }

  public PaymentDetailsResponse addDetailsItem(InputDetail detailsItem) {
  ...
  @Deprecated
  public PaymentDetailsResponse outputDetails(Map<String, String> outputDetails) {
    this.outputDetails = outputDetails;
    return this;
  }

  public PaymentDetailsResponse putOutputDetailsItem(String key, String outputDetailsItem) {
  ...
  @Deprecated
  public PaymentDetailsResponse paymentData(String paymentData) {
  ...
  @Deprecated
  public PaymentDetailsResponse redirect(Redirect redirect) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, paymentDetailsResponse.action) &&
        ...
        Objects.equals(this.authentication, paymentDetailsResponse.authentication) &&
        Objects.equals(this.details, paymentDetailsResponse.details) &&
        ...
        Objects.equals(this.outputDetails, paymentDetailsResponse.outputDetails) &&
        Objects.equals(this.paymentData, paymentDetailsResponse.paymentData) &&
        Objects.equals(this.pspReference, paymentDetailsResponse.pspReference) &&
        Objects.equals(this.redirect, paymentDetailsResponse.redirect) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(action, additionalData, amount, authentication, details, fraudResult, merchantReference, order, outputDetails, paymentData, pspReference, redirect, refusalReason, refusalReasonCode, resultCode, shopperLocale, threeDS2Result);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("action") != null && !jsonObj.get("action").isJsonNull()) {
        PaymentDetailsResponseAction.validateJsonElement(jsonObj.get("action"));
      }
