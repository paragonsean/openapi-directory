...
public class PaymentLinkResponse {
  ...
  public PaymentLinkResponse storePaymentMethod(Boolean storePaymentMethod) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowedPaymentMethods, paymentLinkResponse.allowedPaymentMethods) &&
        ...
        Objects.equals(this.storePaymentMethod, paymentLinkResponse.storePaymentMethod) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowedPaymentMethods, amount, applicationInfo, billingAddress, blockedPaymentMethods, countryCode, deliverAt, deliveryAddress, description, expiresAt, id, installmentOptions, lineItems, manualCapture, merchantAccount, merchantOrderReference, metadata, recurringProcessingModel, reference, returnUrl, reusable, riskData, shopperEmail, shopperLocale, shopperName, shopperReference, showRemovePaymentMethodButton, splits, status, store, storePaymentMethod, updatedAt, url);
  }
