...
class PaymentResponseAction {
     ...
     * @param {(module:model/CheckoutAwaitAction|module:model/CheckoutNativeRedirectAction|module:model/CheckoutQrCodeAction|module:model/CheckoutRedirectAction|module:model/CheckoutSDKAction|module:model/CheckoutThreeDS2Action|module:model/CheckoutVoucherAction)} instance The actual instance to initialize PaymentResponseAction.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `PaymentResponseAction` with oneOf schemas CheckoutAwaitAction, CheckoutNativeRedirectAction, CheckoutQrCodeAction, CheckoutRedirectAction, CheckoutSDKAction, CheckoutThreeDS2Action, CheckoutVoucherAction. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `PaymentResponseAction` with oneOf schemas CheckoutAwaitAction, CheckoutNativeRedirectAction, CheckoutQrCodeAction, CheckoutRedirectAction, CheckoutSDKAction, CheckoutThreeDS2Action, CheckoutVoucherAction. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Gets the actual instance, which can be <code>CheckoutAwaitAction</code>, <code>CheckoutNativeRedirectAction</code>, <code>CheckoutQrCodeAction</code>, <code>CheckoutRedirectAction</code>, <code>CheckoutSDKAction</code>, <code>CheckoutThreeDS2Action</code>, <code>CheckoutVoucherAction</code>.
     * @return {(module:model/CheckoutAwaitAction|module:model/CheckoutNativeRedirectAction|module:model/CheckoutQrCodeAction|module:model/CheckoutRedirectAction|module:model/CheckoutSDKAction|module:model/CheckoutThreeDS2Action|module:model/CheckoutVoucherAction)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>CheckoutAwaitAction</code>, <code>CheckoutNativeRedirectAction</code>, <code>CheckoutQrCodeAction</code>, <code>CheckoutRedirectAction</code>, <code>CheckoutSDKAction</code>, <code>CheckoutThreeDS2Action</code>, <code>CheckoutVoucherAction</code>.
     * @param {(module:model/CheckoutAwaitAction|module:model/CheckoutNativeRedirectAction|module:model/CheckoutQrCodeAction|module:model/CheckoutRedirectAction|module:model/CheckoutSDKAction|module:model/CheckoutThreeDS2Action|module:model/CheckoutVoucherAction)} obj The actual instance.
     */
...
PaymentResponseAction.OneOf = ["CheckoutAwaitAction", "CheckoutNativeRedirectAction", "CheckoutQrCodeAction", "CheckoutRedirectAction", "CheckoutSDKAction", "CheckoutThreeDS2Action", "CheckoutVoucherAction"];
