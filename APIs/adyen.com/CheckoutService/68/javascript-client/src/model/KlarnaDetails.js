...
/**
 * The KlarnaDetails model module.
 * @module model/KlarnaDetails
 * @version 68
 */
class KlarnaDetails {
    /**
     * Constructs a new <code>KlarnaDetails</code>.
     * @alias module:model/KlarnaDetails
     * @param type {module:model/KlarnaDetails.TypeEnum} **klarna**
     */
    constructor(type) { 
        
        KlarnaDetails.initialize(this, type);
    }
    ...
    static initialize(obj, type) { 
        obj['type'] = type || 'klarna';
    }

    /**
     * Constructs a <code>KlarnaDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KlarnaDetails} obj Optional instance to populate.
     * @return {module:model/KlarnaDetails} The populated <code>KlarnaDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KlarnaDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>KlarnaDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KlarnaDetails</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of KlarnaDetails.RequiredProperties) {
...
KlarnaDetails.RequiredProperties = ["type"];

/**
 * The address where to send the invoice.
 * @member {String} billingAddress
 */
KlarnaDetails.prototype['billingAddress'] = undefined;

/**
 * The checkout attempt identifier.
 * @member {String} checkoutAttemptId
 */
KlarnaDetails.prototype['checkoutAttemptId'] = undefined;

/**
 * The address where the goods should be delivered.
 * @member {String} deliveryAddress
 */
KlarnaDetails.prototype['deliveryAddress'] = undefined;

/**
 * Shopper name, date of birth, phone number, and email address.
 * @member {String} personalDetails
 */
KlarnaDetails.prototype['personalDetails'] = undefined;

/**
 * This is the `recurringDetailReference` returned in the response when you created the token.
 * @member {String} recurringDetailReference
 */
KlarnaDetails.prototype['recurringDetailReference'] = undefined;

/**
 * This is the `recurringDetailReference` returned in the response when you created the token.
 * @member {String} storedPaymentMethodId
 */
KlarnaDetails.prototype['storedPaymentMethodId'] = undefined;

/**
 * The type of flow to initiate.
 * @member {String} subtype
 */
KlarnaDetails.prototype['subtype'] = undefined;

/**
 * **klarna**
 * @member {module:model/KlarnaDetails.TypeEnum} type
 * @default 'klarna'
 */
KlarnaDetails.prototype['type'] = 'klarna';
