...
class ThreeDSecureData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('challengeCancel')) {
                obj['challengeCancel'] = ApiClient.convertToType(data['challengeCancel'], 'String');
            }
            ...
            if (data.hasOwnProperty('tokenAuthenticationVerificationValue')) {
                obj['tokenAuthenticationVerificationValue'] = ApiClient.convertToType(data['tokenAuthenticationVerificationValue'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['challengeCancel'] && !(typeof data['challengeCancel'] === 'string' || data['challengeCancel'] instanceof String)) {
            throw new Error("Expected the field `challengeCancel` to be a primitive type in the JSON string but got " + data['challengeCancel']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['tokenAuthenticationVerificationValue'] && !(typeof data['tokenAuthenticationVerificationValue'] === 'string' || data['tokenAuthenticationVerificationValue'] instanceof String)) {
            throw new Error("Expected the field `tokenAuthenticationVerificationValue` to be a primitive type in the JSON string but got " + data['tokenAuthenticationVerificationValue']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/ThreeDSecureData.ChallengeCancelEnum} challengeCancel
 */
ThreeDSecureData.prototype['challengeCancel'] = undefined;
 ...
 */
ThreeDSecureData.prototype['riskScore'] = undefined;
 ...
 * @member {String} tokenAuthenticationVerificationValue
 */
ThreeDSecureData.prototype['tokenAuthenticationVerificationValue'] = undefined;

/**
 * Provides information on why the `transStatus` field has the specified value. For possible values, refer to [our docs](https://docs.adyen.com/online-payments/3d-secure/api-reference#possible-transstatusreason-values).
 * @member {String} transStatusReason
 */
ThreeDSecureData.prototype['transStatusReason'] = undefined;
...
/**
 * Allowed values for the <code>challengeCancel</code> property.
 * @enum {String}
 * @readonly
 */
