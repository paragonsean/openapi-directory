...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.OpenInvoiceDetails();
  });
  ...
  describe('OpenInvoiceDetails', function() {
    it('should create an instance of OpenInvoiceDetails', function() {
      // uncomment below and update the code to test OpenInvoiceDetails
      //var instance = new AdyenCheckoutApi.OpenInvoiceDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.OpenInvoiceDetails);
    });
