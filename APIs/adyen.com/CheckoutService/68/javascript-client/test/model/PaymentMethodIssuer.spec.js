...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentMethodIssuer();
  });
  ...
  describe('PaymentMethodIssuer', function() {
    it('should create an instance of PaymentMethodIssuer', function() {
      // uncomment below and update the code to test PaymentMethodIssuer
      //var instance = new AdyenCheckoutApi.PaymentMethodIssuer();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentMethodIssuer);
    });
