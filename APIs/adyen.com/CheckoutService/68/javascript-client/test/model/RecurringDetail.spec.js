...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.RecurringDetail();
  });
  ...
  describe('RecurringDetail', function() {
    it('should create an instance of RecurringDetail', function() {
      ...
      //var instance = new AdyenCheckoutApi.RecurringDetail();
      //expect(instance).to.be.a(AdyenCheckoutApi.RecurringDetail);
    });
    ...
    it('should have the property storedDetails (base name: "storedDetails")', function() {
      // uncomment below and update the code to test the property storedDetails
      //var instance = new AdyenCheckoutApi.RecurringDetail();
      //expect(instance).to.be();
    });
