...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.ApplePaySessionRequest();
  });
  ...
  describe('ApplePaySessionRequest', function() {
    it('should create an instance of ApplePaySessionRequest', function() {
      // uncomment below and update the code to test ApplePaySessionRequest
      //var instance = new AdyenCheckoutApi.ApplePaySessionRequest();
      //expect(instance).to.be.a(AdyenCheckoutApi.ApplePaySessionRequest);
    });
    ...
    it('should have the property merchantIdentifier (base name: "merchantIdentifier")', function() {
      // uncomment below and update the code to test the property merchantIdentifier
      //var instance = new AdyenCheckoutApi.ApplePaySessionRequest();
      //expect(instance).to.be();
    });
