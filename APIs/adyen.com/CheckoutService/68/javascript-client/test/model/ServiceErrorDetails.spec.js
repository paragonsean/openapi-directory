...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.ServiceErrorDetails();
  });
  ...
  describe('ServiceErrorDetails', function() {
    it('should create an instance of ServiceErrorDetails', function() {
      // uncomment below and update the code to test ServiceErrorDetails
      //var instance = new AdyenCheckoutApi.ServiceErrorDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.ServiceErrorDetails);
    });
