...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CheckoutThreeDS2Action();
  });
  ...
  describe('CheckoutThreeDS2Action', function() {
    it('should create an instance of CheckoutThreeDS2Action', function() {
      // uncomment below and update the code to test CheckoutThreeDS2Action
      //var instance = new AdyenCheckoutApi.CheckoutThreeDS2Action();
      //expect(instance).to.be.a(AdyenCheckoutApi.CheckoutThreeDS2Action);
    });
