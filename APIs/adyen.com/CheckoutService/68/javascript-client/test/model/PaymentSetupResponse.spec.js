...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.PaymentSetupResponse();
  });
  ...
  describe('PaymentSetupResponse', function() {
    it('should create an instance of PaymentSetupResponse', function() {
      // uncomment below and update the code to test PaymentSetupResponse
      //var instance = new AdyenCheckoutApi.PaymentSetupResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.PaymentSetupResponse);
    });
