...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.AndroidPayDetails();
  });
  ...
  describe('AndroidPayDetails', function() {
    it('should create an instance of AndroidPayDetails', function() {
      // uncomment below and update the code to test AndroidPayDetails
      //var instance = new AdyenCheckoutApi.AndroidPayDetails();
      //expect(instance).to.be.a(AdyenCheckoutApi.AndroidPayDetails);
    });
