...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.ApplePaySessionResponse();
  });
  ...
  describe('ApplePaySessionResponse', function() {
    it('should create an instance of ApplePaySessionResponse', function() {
      // uncomment below and update the code to test ApplePaySessionResponse
      //var instance = new AdyenCheckoutApi.ApplePaySessionResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.ApplePaySessionResponse);
    });
