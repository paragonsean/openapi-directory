...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.StandalonePaymentCancelResponse();
  });
  ...
  describe('StandalonePaymentCancelResponse', function() {
    it('should create an instance of StandalonePaymentCancelResponse', function() {
      // uncomment below and update the code to test StandalonePaymentCancelResponse
      //var instance = new AdyenCheckoutApi.StandalonePaymentCancelResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.StandalonePaymentCancelResponse);
    });
