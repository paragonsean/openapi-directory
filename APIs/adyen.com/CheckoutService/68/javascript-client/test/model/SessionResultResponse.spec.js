...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.SessionResultResponse();
  });
  ...
  describe('SessionResultResponse', function() {
    it('should create an instance of SessionResultResponse', function() {
      // uncomment below and update the code to test SessionResultResponse
      //var instance = new AdyenCheckoutApi.SessionResultResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.SessionResultResponse);
    });
