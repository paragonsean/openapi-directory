...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.SubInputDetail();
  });
  ...
  describe('SubInputDetail', function() {
    it('should create an instance of SubInputDetail', function() {
      // uncomment below and update the code to test SubInputDetail
      //var instance = new AdyenCheckoutApi.SubInputDetail();
      //expect(instance).to.be.a(AdyenCheckoutApi.SubInputDetail);
    });
