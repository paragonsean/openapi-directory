...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.EncryptedOrderData();
  });
  ...
  describe('EncryptedOrderData', function() {
    it('should create an instance of EncryptedOrderData', function() {
      // uncomment below and update the code to test EncryptedOrderData
      //var instance = new AdyenCheckoutApi.EncryptedOrderData();
      //expect(instance).to.be.a(AdyenCheckoutApi.EncryptedOrderData);
    });
