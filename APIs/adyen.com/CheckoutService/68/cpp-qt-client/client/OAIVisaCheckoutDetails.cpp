...
OAIVisaCheckoutDetails::OAIVisaCheckoutDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVisaCheckoutDetails::OAIVisaCheckoutDetails() {
    this->initializeModel();
}

OAIVisaCheckoutDetails::~OAIVisaCheckoutDetails() {}

void OAIVisaCheckoutDetails::initializeModel() {
...
void OAIVisaCheckoutDetails::fromJson(QString jsonString) {
...
void OAIVisaCheckoutDetails::fromJsonObject(QJsonObject json) {
...
QString OAIVisaCheckoutDetails::asJson() const {
...
QJsonObject OAIVisaCheckoutDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVisaCheckoutDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIVisaCheckoutDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIVisaCheckoutDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIVisaCheckoutDetails::is_checkout_attempt_id_Valid() const{
    return m_checkout_attempt_id_isValid;
}

QString OAIVisaCheckoutDetails::getFundingSource() const {
    return m_funding_source;
}
void OAIVisaCheckoutDetails::setFundingSource(const QString &funding_source) {
    m_funding_source = funding_source;
    m_funding_source_isSet = true;
}

bool OAIVisaCheckoutDetails::is_funding_source_Set() const{
    return m_funding_source_isSet;
}

bool OAIVisaCheckoutDetails::is_funding_source_Valid() const{
    return m_funding_source_isValid;
}

QString OAIVisaCheckoutDetails::getType() const {
    return m_type;
}
void OAIVisaCheckoutDetails::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIVisaCheckoutDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAIVisaCheckoutDetails::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIVisaCheckoutDetails::getVisaCheckoutCallId() const {
    return m_visa_checkout_call_id;
}
void OAIVisaCheckoutDetails::setVisaCheckoutCallId(const QString &visa_checkout_call_id) {
    m_visa_checkout_call_id = visa_checkout_call_id;
    m_visa_checkout_call_id_isSet = true;
}

bool OAIVisaCheckoutDetails::is_visa_checkout_call_id_Set() const{
    return m_visa_checkout_call_id_isSet;
}

bool OAIVisaCheckoutDetails::is_visa_checkout_call_id_Valid() const{
    return m_visa_checkout_call_id_isValid;
}

bool OAIVisaCheckoutDetails::isSet() const {
...
bool OAIVisaCheckoutDetails::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_visa_checkout_call_id_isValid && true;
}
