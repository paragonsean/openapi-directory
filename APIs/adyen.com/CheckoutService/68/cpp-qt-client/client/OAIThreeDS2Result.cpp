...
void OAIThreeDS2Result::initializeModel() {
    ...
    m_challenge_cancel_isSet = false;
    m_challenge_cancel_isValid = false;
...
void OAIThreeDS2Result::fromJsonObject(QJsonObject json) {
    ...
    m_challenge_cancel_isValid = ::OpenAPI::fromJsonValue(m_challenge_cancel, json[QString("challengeCancel")]);
    m_challenge_cancel_isSet = !json[QString("challengeCancel")].isNull() && m_challenge_cancel_isValid;
...
QJsonObject OAIThreeDS2Result::asJsonObject() const {
    ...
    if (m_challenge_cancel_isSet) {
        obj.insert(QString("challengeCancel"), ::OpenAPI::toJsonValue(m_challenge_cancel));
    }
...
QString OAIThreeDS2Result::getChallengeCancel() const {
    return m_challenge_cancel;
}
void OAIThreeDS2Result::setChallengeCancel(const QString &challenge_cancel) {
    m_challenge_cancel = challenge_cancel;
    m_challenge_cancel_isSet = true;
}

bool OAIThreeDS2Result::is_challenge_cancel_Set() const{
    return m_challenge_cancel_isSet;
}

bool OAIThreeDS2Result::is_challenge_cancel_Valid() const{
    return m_challenge_cancel_isValid;
}
...
QString OAIThreeDS2Result::getExemptionIndicator() const {
    return m_exemption_indicator;
}
void OAIThreeDS2Result::setExemptionIndicator(const QString &exemption_indicator) {
    m_exemption_indicator = exemption_indicator;
    m_exemption_indicator_isSet = true;
}

bool OAIThreeDS2Result::is_exemption_indicator_Set() const{
    return m_exemption_indicator_isSet;
}

bool OAIThreeDS2Result::is_exemption_indicator_Valid() const{
...
QString OAIThreeDS2Result::getRiskScore() const {
    return m_risk_score;
}
void OAIThreeDS2Result::setRiskScore(const QString &risk_score) {
    m_risk_score = risk_score;
    m_risk_score_isSet = true;
}

bool OAIThreeDS2Result::is_risk_score_Set() const{
    return m_risk_score_isSet;
}

bool OAIThreeDS2Result::is_risk_score_Valid() const{
    return m_risk_score_isValid;
}

QString OAIThreeDS2Result::getThreeDsRequestorChallengeInd() const {
    return m_three_ds_requestor_challenge_ind;
}
void OAIThreeDS2Result::setThreeDsRequestorChallengeInd(const QString &three_ds_requestor_challenge_ind) {
    m_three_ds_requestor_challenge_ind = three_ds_requestor_challenge_ind;
    m_three_ds_requestor_challenge_ind_isSet = true;
}

bool OAIThreeDS2Result::is_three_ds_requestor_challenge_ind_Set() const{
    return m_three_ds_requestor_challenge_ind_isSet;
}

bool OAIThreeDS2Result::is_three_ds_requestor_challenge_ind_Valid() const{
