...
/*
 * OAICreateCheckoutSessionResponse.h
 *
 * 
 */

#ifndef OAICreateCheckoutSessionResponse_H
#define OAICreateCheckoutSessionResponse_H
...
class OAICreateCheckoutSessionResponse : public OAIObject {
public:
    OAICreateCheckoutSessionResponse();
    OAICreateCheckoutSessionResponse(QString json);
    ~OAICreateCheckoutSessionResponse() override;
    ...
    void setSessionData(const QString &session_data);
    bool is_session_data_Set() const;
    bool is_session_data_Valid() const;
...
private:
    ...
    QString m_session_data;
    bool m_session_data_isSet;
    bool m_session_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCheckoutSessionResponse)

#endif // OAICreateCheckoutSessionResponse_H
