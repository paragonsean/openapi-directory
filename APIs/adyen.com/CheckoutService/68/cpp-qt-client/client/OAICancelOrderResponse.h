...
/*
 * OAICancelOrderResponse.h
 *
 * 
 */

#ifndef OAICancelOrderResponse_H
#define OAICancelOrderResponse_H
...
class OAICancelOrderResponse : public OAIObject {
public:
    OAICancelOrderResponse();
    OAICancelOrderResponse(QString json);
    ~OAICancelOrderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelOrderResponse)

#endif // OAICancelOrderResponse_H
