...
OAIAmount OAICreateOrderResponse::getAmount() const {
    return m_amount;
}
void OAICreateOrderResponse::setAmount(const OAIAmount &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAICreateOrderResponse::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAICreateOrderResponse::is_amount_Valid() const{
...
bool OAICreateOrderResponse::isValid() const {
    ...
    return m_amount_isValid && m_expires_at_isValid && m_order_data_isValid && m_remaining_amount_isValid && m_result_code_isValid && true;
}
