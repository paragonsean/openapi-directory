...
#ifndef OAIBlikDetails_H
#define OAIBlikDetails_H
...
class OAIBlikDetails : public OAIObject {
public:
    OAIBlikDetails();
    OAIBlikDetails(QString json);
    ~OAIBlikDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlikDetails)

#endif // OAIBlikDetails_H
