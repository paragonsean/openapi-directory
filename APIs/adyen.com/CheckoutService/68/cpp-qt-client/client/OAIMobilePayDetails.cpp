...
OAIMobilePayDetails::OAIMobilePayDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMobilePayDetails::OAIMobilePayDetails() {
    this->initializeModel();
}

OAIMobilePayDetails::~OAIMobilePayDetails() {}

void OAIMobilePayDetails::initializeModel() {
...
void OAIMobilePayDetails::fromJson(QString jsonString) {
...
void OAIMobilePayDetails::fromJsonObject(QJsonObject json) {
...
QString OAIMobilePayDetails::asJson() const {
...
QJsonObject OAIMobilePayDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMobilePayDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIMobilePayDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIMobilePayDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIMobilePayDetails::is_checkout_attempt_id_Valid() const{
    return m_checkout_attempt_id_isValid;
}

QString OAIMobilePayDetails::getType() const {
    return m_type;
}
void OAIMobilePayDetails::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIMobilePayDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAIMobilePayDetails::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIMobilePayDetails::isSet() const {
...
bool OAIMobilePayDetails::isValid() const {
