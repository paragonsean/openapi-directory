...
/*
 * OAIPaymentAmountUpdateRequest.h
 *
 * 
 */

#ifndef OAIPaymentAmountUpdateRequest_H
#define OAIPaymentAmountUpdateRequest_H
...
class OAIPaymentAmountUpdateRequest : public OAIObject {
public:
    OAIPaymentAmountUpdateRequest();
    OAIPaymentAmountUpdateRequest(QString json);
    ~OAIPaymentAmountUpdateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentAmountUpdateRequest)

#endif // OAIPaymentAmountUpdateRequest_H
