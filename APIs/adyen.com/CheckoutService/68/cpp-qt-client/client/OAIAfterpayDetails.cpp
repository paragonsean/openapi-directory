...
OAIAfterpayDetails::OAIAfterpayDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAfterpayDetails::OAIAfterpayDetails() {
    this->initializeModel();
}

OAIAfterpayDetails::~OAIAfterpayDetails() {}

void OAIAfterpayDetails::initializeModel() {
...
void OAIAfterpayDetails::fromJson(QString jsonString) {
...
void OAIAfterpayDetails::fromJsonObject(QJsonObject json) {
...
QString OAIAfterpayDetails::asJson() const {
...
QJsonObject OAIAfterpayDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAfterpayDetails::getBillingAddress() const {
    return m_billing_address;
}
void OAIAfterpayDetails::setBillingAddress(const QString &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIAfterpayDetails::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIAfterpayDetails::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAIAfterpayDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIAfterpayDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIAfterpayDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIAfterpayDetails::is_checkout_attempt_id_Valid() const{
    return m_checkout_attempt_id_isValid;
}

QString OAIAfterpayDetails::getDeliveryAddress() const {
    return m_delivery_address;
}
void OAIAfterpayDetails::setDeliveryAddress(const QString &delivery_address) {
    m_delivery_address = delivery_address;
    m_delivery_address_isSet = true;
}

bool OAIAfterpayDetails::is_delivery_address_Set() const{
    return m_delivery_address_isSet;
}

bool OAIAfterpayDetails::is_delivery_address_Valid() const{
    return m_delivery_address_isValid;
}

QString OAIAfterpayDetails::getPersonalDetails() const {
    return m_personal_details;
}
void OAIAfterpayDetails::setPersonalDetails(const QString &personal_details) {
    m_personal_details = personal_details;
    m_personal_details_isSet = true;
}

bool OAIAfterpayDetails::is_personal_details_Set() const{
    return m_personal_details_isSet;
}

bool OAIAfterpayDetails::is_personal_details_Valid() const{
    return m_personal_details_isValid;
}

QString OAIAfterpayDetails::getRecurringDetailReference() const {
    return m_recurring_detail_reference;
}
void OAIAfterpayDetails::setRecurringDetailReference(const QString &recurring_detail_reference) {
    m_recurring_detail_reference = recurring_detail_reference;
    m_recurring_detail_reference_isSet = true;
}

bool OAIAfterpayDetails::is_recurring_detail_reference_Set() const{
    return m_recurring_detail_reference_isSet;
}

bool OAIAfterpayDetails::is_recurring_detail_reference_Valid() const{
    return m_recurring_detail_reference_isValid;
}

QString OAIAfterpayDetails::getStoredPaymentMethodId() const {
    return m_stored_payment_method_id;
}
void OAIAfterpayDetails::setStoredPaymentMethodId(const QString &stored_payment_method_id) {
    m_stored_payment_method_id = stored_payment_method_id;
    m_stored_payment_method_id_isSet = true;
}

bool OAIAfterpayDetails::is_stored_payment_method_id_Set() const{
    return m_stored_payment_method_id_isSet;
}

bool OAIAfterpayDetails::is_stored_payment_method_id_Valid() const{
    return m_stored_payment_method_id_isValid;
}

QString OAIAfterpayDetails::getType() const {
    return m_type;
}
void OAIAfterpayDetails::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAfterpayDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAfterpayDetails::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIAfterpayDetails::isSet() const {
...
bool OAIAfterpayDetails::isValid() const {
