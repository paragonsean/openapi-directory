...
#include "OAIPaymentLinkResponse.h"
...
OAIPaymentLinkResponse::OAIPaymentLinkResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentLinkResponse::OAIPaymentLinkResponse() {
    this->initializeModel();
}

OAIPaymentLinkResponse::~OAIPaymentLinkResponse() {}

void OAIPaymentLinkResponse::initializeModel() {
    ...
    m_required_shopper_fields_isSet = false;
    m_required_shopper_fields_isValid = false;
...
void OAIPaymentLinkResponse::fromJson(QString jsonString) {
...
void OAIPaymentLinkResponse::fromJsonObject(QJsonObject json) {
    ...
    m_required_shopper_fields_isValid = ::OpenAPI::fromJsonValue(m_required_shopper_fields, json[QString("requiredShopperFields")]);
    m_required_shopper_fields_isSet = !json[QString("requiredShopperFields")].isNull() && m_required_shopper_fields_isValid;
...
QString OAIPaymentLinkResponse::asJson() const {
...
QJsonObject OAIPaymentLinkResponse::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_required_shopper_fields.size() > 0) {
        obj.insert(QString("requiredShopperFields"), ::OpenAPI::toJsonValue(m_required_shopper_fields));
    }
...
QList<QString> OAIPaymentLinkResponse::getAllowedPaymentMethods() const {
    return m_allowed_payment_methods;
}
void OAIPaymentLinkResponse::setAllowedPaymentMethods(const QList<QString> &allowed_payment_methods) {
    m_allowed_payment_methods = allowed_payment_methods;
    m_allowed_payment_methods_isSet = true;
}

bool OAIPaymentLinkResponse::is_allowed_payment_methods_Set() const{
    return m_allowed_payment_methods_isSet;
}

bool OAIPaymentLinkResponse::is_allowed_payment_methods_Valid() const{
    return m_allowed_payment_methods_isValid;
}

OAIAmount OAIPaymentLinkResponse::getAmount() const {
    return m_amount;
}
void OAIPaymentLinkResponse::setAmount(const OAIAmount &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIPaymentLinkResponse::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIPaymentLinkResponse::is_amount_Valid() const{
    return m_amount_isValid;
}

OAIApplicationInfo OAIPaymentLinkResponse::getApplicationInfo() const {
    return m_application_info;
}
void OAIPaymentLinkResponse::setApplicationInfo(const OAIApplicationInfo &application_info) {
    m_application_info = application_info;
    m_application_info_isSet = true;
}

bool OAIPaymentLinkResponse::is_application_info_Set() const{
    return m_application_info_isSet;
}

bool OAIPaymentLinkResponse::is_application_info_Valid() const{
    return m_application_info_isValid;
}

OAIAddress OAIPaymentLinkResponse::getBillingAddress() const {
    return m_billing_address;
}
void OAIPaymentLinkResponse::setBillingAddress(const OAIAddress &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIPaymentLinkResponse::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIPaymentLinkResponse::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QList<QString> OAIPaymentLinkResponse::getBlockedPaymentMethods() const {
    return m_blocked_payment_methods;
}
void OAIPaymentLinkResponse::setBlockedPaymentMethods(const QList<QString> &blocked_payment_methods) {
    m_blocked_payment_methods = blocked_payment_methods;
    m_blocked_payment_methods_isSet = true;
}

bool OAIPaymentLinkResponse::is_blocked_payment_methods_Set() const{
    return m_blocked_payment_methods_isSet;
}

bool OAIPaymentLinkResponse::is_blocked_payment_methods_Valid() const{
    return m_blocked_payment_methods_isValid;
}

QString OAIPaymentLinkResponse::getCountryCode() const {
    return m_country_code;
}
void OAIPaymentLinkResponse::setCountryCode(const QString &country_code) {
    m_country_code = country_code;
    m_country_code_isSet = true;
}

bool OAIPaymentLinkResponse::is_country_code_Set() const{
    return m_country_code_isSet;
}

bool OAIPaymentLinkResponse::is_country_code_Valid() const{
    return m_country_code_isValid;
}

QDateTime OAIPaymentLinkResponse::getDeliverAt() const {
    return m_deliver_at;
}
void OAIPaymentLinkResponse::setDeliverAt(const QDateTime &deliver_at) {
    m_deliver_at = deliver_at;
    m_deliver_at_isSet = true;
}

bool OAIPaymentLinkResponse::is_deliver_at_Set() const{
    return m_deliver_at_isSet;
}

bool OAIPaymentLinkResponse::is_deliver_at_Valid() const{
    return m_deliver_at_isValid;
}

OAIAddress OAIPaymentLinkResponse::getDeliveryAddress() const {
    return m_delivery_address;
}
void OAIPaymentLinkResponse::setDeliveryAddress(const OAIAddress &delivery_address) {
    m_delivery_address = delivery_address;
    m_delivery_address_isSet = true;
}

bool OAIPaymentLinkResponse::is_delivery_address_Set() const{
    return m_delivery_address_isSet;
}

bool OAIPaymentLinkResponse::is_delivery_address_Valid() const{
    return m_delivery_address_isValid;
}

QString OAIPaymentLinkResponse::getDescription() const {
    return m_description;
}
void OAIPaymentLinkResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPaymentLinkResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPaymentLinkResponse::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIPaymentLinkResponse::getExpiresAt() const {
    return m_expires_at;
}
void OAIPaymentLinkResponse::setExpiresAt(const QString &expires_at) {
    m_expires_at = expires_at;
    m_expires_at_isSet = true;
}

bool OAIPaymentLinkResponse::is_expires_at_Set() const{
    return m_expires_at_isSet;
}

bool OAIPaymentLinkResponse::is_expires_at_Valid() const{
    return m_expires_at_isValid;
}

QString OAIPaymentLinkResponse::getId() const {
    return m_id;
}
void OAIPaymentLinkResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPaymentLinkResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPaymentLinkResponse::is_id_Valid() const{
    return m_id_isValid;
}

QMap<QString, OAIInstallmentOption> OAIPaymentLinkResponse::getInstallmentOptions() const {
    return m_installment_options;
}
void OAIPaymentLinkResponse::setInstallmentOptions(const QMap<QString, OAIInstallmentOption> &installment_options) {
    m_installment_options = installment_options;
    m_installment_options_isSet = true;
}

bool OAIPaymentLinkResponse::is_installment_options_Set() const{
    return m_installment_options_isSet;
}

bool OAIPaymentLinkResponse::is_installment_options_Valid() const{
    return m_installment_options_isValid;
}

QList<OAILineItem> OAIPaymentLinkResponse::getLineItems() const {
    return m_line_items;
}
void OAIPaymentLinkResponse::setLineItems(const QList<OAILineItem> &line_items) {
    m_line_items = line_items;
    m_line_items_isSet = true;
}

bool OAIPaymentLinkResponse::is_line_items_Set() const{
    return m_line_items_isSet;
}

bool OAIPaymentLinkResponse::is_line_items_Valid() const{
    return m_line_items_isValid;
}

bool OAIPaymentLinkResponse::isManualCapture() const {
    return m_manual_capture;
}
void OAIPaymentLinkResponse::setManualCapture(const bool &manual_capture) {
    m_manual_capture = manual_capture;
    m_manual_capture_isSet = true;
}

bool OAIPaymentLinkResponse::is_manual_capture_Set() const{
    return m_manual_capture_isSet;
}

bool OAIPaymentLinkResponse::is_manual_capture_Valid() const{
    return m_manual_capture_isValid;
}

QString OAIPaymentLinkResponse::getMerchantAccount() const {
    return m_merchant_account;
}
void OAIPaymentLinkResponse::setMerchantAccount(const QString &merchant_account) {
    m_merchant_account = merchant_account;
    m_merchant_account_isSet = true;
}

bool OAIPaymentLinkResponse::is_merchant_account_Set() const{
    return m_merchant_account_isSet;
}

bool OAIPaymentLinkResponse::is_merchant_account_Valid() const{
    return m_merchant_account_isValid;
}

QString OAIPaymentLinkResponse::getMerchantOrderReference() const {
    return m_merchant_order_reference;
}
void OAIPaymentLinkResponse::setMerchantOrderReference(const QString &merchant_order_reference) {
    m_merchant_order_reference = merchant_order_reference;
    m_merchant_order_reference_isSet = true;
}

bool OAIPaymentLinkResponse::is_merchant_order_reference_Set() const{
    return m_merchant_order_reference_isSet;
}

bool OAIPaymentLinkResponse::is_merchant_order_reference_Valid() const{
    return m_merchant_order_reference_isValid;
}

QMap<QString, QString> OAIPaymentLinkResponse::getMetadata() const {
    return m_metadata;
}
void OAIPaymentLinkResponse::setMetadata(const QMap<QString, QString> &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIPaymentLinkResponse::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIPaymentLinkResponse::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QString OAIPaymentLinkResponse::getRecurringProcessingModel() const {
    return m_recurring_processing_model;
}
void OAIPaymentLinkResponse::setRecurringProcessingModel(const QString &recurring_processing_model) {
    m_recurring_processing_model = recurring_processing_model;
    m_recurring_processing_model_isSet = true;
}

bool OAIPaymentLinkResponse::is_recurring_processing_model_Set() const{
    return m_recurring_processing_model_isSet;
}

bool OAIPaymentLinkResponse::is_recurring_processing_model_Valid() const{
    return m_recurring_processing_model_isValid;
}

QString OAIPaymentLinkResponse::getReference() const {
    return m_reference;
}
void OAIPaymentLinkResponse::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAIPaymentLinkResponse::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAIPaymentLinkResponse::is_reference_Valid() const{
    return m_reference_isValid;
}

QList<QString> OAIPaymentLinkResponse::getRequiredShopperFields() const {
    return m_required_shopper_fields;
}
void OAIPaymentLinkResponse::setRequiredShopperFields(const QList<QString> &required_shopper_fields) {
    m_required_shopper_fields = required_shopper_fields;
    m_required_shopper_fields_isSet = true;
}

bool OAIPaymentLinkResponse::is_required_shopper_fields_Set() const{
    return m_required_shopper_fields_isSet;
}

bool OAIPaymentLinkResponse::is_required_shopper_fields_Valid() const{
    return m_required_shopper_fields_isValid;
}

QString OAIPaymentLinkResponse::getReturnUrl() const {
    return m_return_url;
}
void OAIPaymentLinkResponse::setReturnUrl(const QString &return_url) {
    m_return_url = return_url;
    m_return_url_isSet = true;
}

bool OAIPaymentLinkResponse::is_return_url_Set() const{
    return m_return_url_isSet;
}

bool OAIPaymentLinkResponse::is_return_url_Valid() const{
    return m_return_url_isValid;
}

bool OAIPaymentLinkResponse::isReusable() const {
    return m_reusable;
}
void OAIPaymentLinkResponse::setReusable(const bool &reusable) {
    m_reusable = reusable;
    m_reusable_isSet = true;
}

bool OAIPaymentLinkResponse::is_reusable_Set() const{
    return m_reusable_isSet;
}

bool OAIPaymentLinkResponse::is_reusable_Valid() const{
    return m_reusable_isValid;
}

OAIRiskData OAIPaymentLinkResponse::getRiskData() const {
    return m_risk_data;
}
void OAIPaymentLinkResponse::setRiskData(const OAIRiskData &risk_data) {
    m_risk_data = risk_data;
    m_risk_data_isSet = true;
}

bool OAIPaymentLinkResponse::is_risk_data_Set() const{
    return m_risk_data_isSet;
}

bool OAIPaymentLinkResponse::is_risk_data_Valid() const{
    return m_risk_data_isValid;
}

QString OAIPaymentLinkResponse::getShopperEmail() const {
    return m_shopper_email;
}
void OAIPaymentLinkResponse::setShopperEmail(const QString &shopper_email) {
    m_shopper_email = shopper_email;
    m_shopper_email_isSet = true;
}

bool OAIPaymentLinkResponse::is_shopper_email_Set() const{
    return m_shopper_email_isSet;
}

bool OAIPaymentLinkResponse::is_shopper_email_Valid() const{
    return m_shopper_email_isValid;
}

QString OAIPaymentLinkResponse::getShopperLocale() const {
    return m_shopper_locale;
}
void OAIPaymentLinkResponse::setShopperLocale(const QString &shopper_locale) {
    m_shopper_locale = shopper_locale;
    m_shopper_locale_isSet = true;
}

bool OAIPaymentLinkResponse::is_shopper_locale_Set() const{
    return m_shopper_locale_isSet;
}

bool OAIPaymentLinkResponse::is_shopper_locale_Valid() const{
    return m_shopper_locale_isValid;
}

OAIName OAIPaymentLinkResponse::getShopperName() const {
    return m_shopper_name;
}
void OAIPaymentLinkResponse::setShopperName(const OAIName &shopper_name) {
    m_shopper_name = shopper_name;
    m_shopper_name_isSet = true;
}

bool OAIPaymentLinkResponse::is_shopper_name_Set() const{
    return m_shopper_name_isSet;
}

bool OAIPaymentLinkResponse::is_shopper_name_Valid() const{
    return m_shopper_name_isValid;
}

QString OAIPaymentLinkResponse::getShopperReference() const {
    return m_shopper_reference;
}
void OAIPaymentLinkResponse::setShopperReference(const QString &shopper_reference) {
    m_shopper_reference = shopper_reference;
    m_shopper_reference_isSet = true;
}

bool OAIPaymentLinkResponse::is_shopper_reference_Set() const{
    return m_shopper_reference_isSet;
}

bool OAIPaymentLinkResponse::is_shopper_reference_Valid() const{
    return m_shopper_reference_isValid;
}

bool OAIPaymentLinkResponse::isShowRemovePaymentMethodButton() const {
    return m_show_remove_payment_method_button;
}
void OAIPaymentLinkResponse::setShowRemovePaymentMethodButton(const bool &show_remove_payment_method_button) {
    m_show_remove_payment_method_button = show_remove_payment_method_button;
    m_show_remove_payment_method_button_isSet = true;
}

bool OAIPaymentLinkResponse::is_show_remove_payment_method_button_Set() const{
    return m_show_remove_payment_method_button_isSet;
}

bool OAIPaymentLinkResponse::is_show_remove_payment_method_button_Valid() const{
    return m_show_remove_payment_method_button_isValid;
}

QList<OAISplit> OAIPaymentLinkResponse::getSplits() const {
    return m_splits;
}
void OAIPaymentLinkResponse::setSplits(const QList<OAISplit> &splits) {
    m_splits = splits;
    m_splits_isSet = true;
}

bool OAIPaymentLinkResponse::is_splits_Set() const{
    return m_splits_isSet;
}

bool OAIPaymentLinkResponse::is_splits_Valid() const{
    return m_splits_isValid;
}

QString OAIPaymentLinkResponse::getStatus() const {
    return m_status;
}
void OAIPaymentLinkResponse::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPaymentLinkResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPaymentLinkResponse::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIPaymentLinkResponse::getStore() const {
    return m_store;
}
void OAIPaymentLinkResponse::setStore(const QString &store) {
    m_store = store;
    m_store_isSet = true;
}

bool OAIPaymentLinkResponse::is_store_Set() const{
    return m_store_isSet;
}

bool OAIPaymentLinkResponse::is_store_Valid() const{
    return m_store_isValid;
}

QString OAIPaymentLinkResponse::getStorePaymentMethodMode() const {
    return m_store_payment_method_mode;
}
void OAIPaymentLinkResponse::setStorePaymentMethodMode(const QString &store_payment_method_mode) {
    m_store_payment_method_mode = store_payment_method_mode;
    m_store_payment_method_mode_isSet = true;
}

bool OAIPaymentLinkResponse::is_store_payment_method_mode_Set() const{
    return m_store_payment_method_mode_isSet;
}

bool OAIPaymentLinkResponse::is_store_payment_method_mode_Valid() const{
    return m_store_payment_method_mode_isValid;
}

QString OAIPaymentLinkResponse::getTelephoneNumber() const {
    return m_telephone_number;
}
void OAIPaymentLinkResponse::setTelephoneNumber(const QString &telephone_number) {
    m_telephone_number = telephone_number;
    m_telephone_number_isSet = true;
}

bool OAIPaymentLinkResponse::is_telephone_number_Set() const{
    return m_telephone_number_isSet;
}

bool OAIPaymentLinkResponse::is_telephone_number_Valid() const{
    return m_telephone_number_isValid;
}

QString OAIPaymentLinkResponse::getThemeId() const {
    return m_theme_id;
}
void OAIPaymentLinkResponse::setThemeId(const QString &theme_id) {
    m_theme_id = theme_id;
    m_theme_id_isSet = true;
}

bool OAIPaymentLinkResponse::is_theme_id_Set() const{
    return m_theme_id_isSet;
}

bool OAIPaymentLinkResponse::is_theme_id_Valid() const{
    return m_theme_id_isValid;
}

QDateTime OAIPaymentLinkResponse::getUpdatedAt() const {
    return m_updated_at;
}
void OAIPaymentLinkResponse::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIPaymentLinkResponse::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIPaymentLinkResponse::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAIPaymentLinkResponse::getUrl() const {
    return m_url;
}
void OAIPaymentLinkResponse::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIPaymentLinkResponse::is_url_Set() const{
    return m_url_isSet;
}

bool OAIPaymentLinkResponse::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIPaymentLinkResponse::isSet() const {
...
bool OAIPaymentLinkResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_amount_isValid && m_id_isValid && m_merchant_account_isValid && m_reference_isValid && m_status_isValid && m_url_isValid && true;
}
