...
QString OAIPaymentRequest::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIPaymentRequest::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIPaymentRequest::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIPaymentRequest::is_checkout_attempt_id_Valid() const{
...
QMap<QString, QString> OAIPaymentRequest::getLocalizedShopperStatement() const {
    return m_localized_shopper_statement;
}
void OAIPaymentRequest::setLocalizedShopperStatement(const QMap<QString, QString> &localized_shopper_statement) {
    m_localized_shopper_statement = localized_shopper_statement;
    m_localized_shopper_statement_isSet = true;
}

bool OAIPaymentRequest::is_localized_shopper_statement_Set() const{
    return m_localized_shopper_statement_isSet;
}

bool OAIPaymentRequest::is_localized_shopper_statement_Valid() const{
...
OAIPlatformChargebackLogic OAIPaymentRequest::getPlatformChargebackLogic() const {
    return m_platform_chargeback_logic;
}
void OAIPaymentRequest::setPlatformChargebackLogic(const OAIPlatformChargebackLogic &platform_chargeback_logic) {
    m_platform_chargeback_logic = platform_chargeback_logic;
    m_platform_chargeback_logic_isSet = true;
}

bool OAIPaymentRequest::is_platform_chargeback_logic_Set() const{
    return m_platform_chargeback_logic_isSet;
}

bool OAIPaymentRequest::is_platform_chargeback_logic_Valid() const{
