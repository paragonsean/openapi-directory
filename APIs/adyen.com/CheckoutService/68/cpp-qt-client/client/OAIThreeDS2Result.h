...
public:
    ...
    QString getChallengeCancel() const;
    void setChallengeCancel(const QString &challenge_cancel);
    bool is_challenge_cancel_Set() const;
    bool is_challenge_cancel_Valid() const;
...
private:
    ...
    QString m_challenge_cancel;
    bool m_challenge_cancel_isSet;
    bool m_challenge_cancel_isValid;
