...
/*
 * OAICheckoutThreeDS2Action.h
 *
 * 
 */

#ifndef OAICheckoutThreeDS2Action_H
#define OAICheckoutThreeDS2Action_H
...
class OAICheckoutThreeDS2Action : public OAIObject {
public:
    OAICheckoutThreeDS2Action();
    OAICheckoutThreeDS2Action(QString json);
    ~OAICheckoutThreeDS2Action() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckoutThreeDS2Action)

#endif // OAICheckoutThreeDS2Action_H
