...
QList<OAIPaymentMethodIssuer> OAIRecurringDetail::getIssuers() const {
    return m_issuers;
}
void OAIRecurringDetail::setIssuers(const QList<OAIPaymentMethodIssuer> &issuers) {
    m_issuers = issuers;
    m_issuers_isSet = true;
}

bool OAIRecurringDetail::is_issuers_Set() const{
    return m_issuers_isSet;
}

bool OAIRecurringDetail::is_issuers_Valid() const{
