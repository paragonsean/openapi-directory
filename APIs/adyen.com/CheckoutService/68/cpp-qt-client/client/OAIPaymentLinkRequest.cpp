...
QList<QString> OAIPaymentLinkRequest::getRequiredShopperFields() const {
    return m_required_shopper_fields;
}
void OAIPaymentLinkRequest::setRequiredShopperFields(const QList<QString> &required_shopper_fields) {
    m_required_shopper_fields = required_shopper_fields;
    m_required_shopper_fields_isSet = true;
}

bool OAIPaymentLinkRequest::is_required_shopper_fields_Set() const{
    return m_required_shopper_fields_isSet;
}

bool OAIPaymentLinkRequest::is_required_shopper_fields_Valid() const{
...
OAIRiskData OAIPaymentLinkRequest::getRiskData() const {
    return m_risk_data;
}
void OAIPaymentLinkRequest::setRiskData(const OAIRiskData &risk_data) {
    m_risk_data = risk_data;
    m_risk_data_isSet = true;
}

bool OAIPaymentLinkRequest::is_risk_data_Set() const{
    return m_risk_data_isSet;
}

bool OAIPaymentLinkRequest::is_risk_data_Valid() const{
...
QString OAIPaymentLinkRequest::getStorePaymentMethodMode() const {
    return m_store_payment_method_mode;
}
void OAIPaymentLinkRequest::setStorePaymentMethodMode(const QString &store_payment_method_mode) {
    m_store_payment_method_mode = store_payment_method_mode;
    m_store_payment_method_mode_isSet = true;
}

bool OAIPaymentLinkRequest::is_store_payment_method_mode_Set() const{
    return m_store_payment_method_mode_isSet;
}

bool OAIPaymentLinkRequest::is_store_payment_method_mode_Valid() const{
    return m_store_payment_method_mode_isValid;
}

QString OAIPaymentLinkRequest::getTelephoneNumber() const {
    return m_telephone_number;
}
void OAIPaymentLinkRequest::setTelephoneNumber(const QString &telephone_number) {
    m_telephone_number = telephone_number;
    m_telephone_number_isSet = true;
}

bool OAIPaymentLinkRequest::is_telephone_number_Set() const{
    return m_telephone_number_isSet;
}

bool OAIPaymentLinkRequest::is_telephone_number_Valid() const{
    return m_telephone_number_isValid;
}

QString OAIPaymentLinkRequest::getThemeId() const {
    return m_theme_id;
}
void OAIPaymentLinkRequest::setThemeId(const QString &theme_id) {
    m_theme_id = theme_id;
    m_theme_id_isSet = true;
}

bool OAIPaymentLinkRequest::is_theme_id_Set() const{
    return m_theme_id_isSet;
}

bool OAIPaymentLinkRequest::is_theme_id_Valid() const{
