...
/*
 * OAICheckoutVoucherAction.h
 *
 * 
 */

#ifndef OAICheckoutVoucherAction_H
#define OAICheckoutVoucherAction_H
...
class OAICheckoutVoucherAction : public OAIObject {
public:
    OAICheckoutVoucherAction();
    OAICheckoutVoucherAction(QString json);
    ~OAICheckoutVoucherAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckoutVoucherAction)

#endif // OAICheckoutVoucherAction_H
