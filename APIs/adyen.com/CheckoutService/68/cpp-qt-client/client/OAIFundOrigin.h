...
#ifndef OAIFundOrigin_H
#define OAIFundOrigin_H
...
class OAIFundOrigin : public OAIObject {
public:
    OAIFundOrigin();
    OAIFundOrigin(QString json);
    ~OAIFundOrigin() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFundOrigin)

#endif // OAIFundOrigin_H
