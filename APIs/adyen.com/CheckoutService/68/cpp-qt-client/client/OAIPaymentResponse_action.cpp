...
void OAIPaymentResponse_action::initializeModel() {
    ...
    m_authorisation_token_isSet = false;
    m_authorisation_token_isValid = false;
...
void OAIPaymentResponse_action::fromJsonObject(QJsonObject json) {
    ...
    m_authorisation_token_isValid = ::OpenAPI::fromJsonValue(m_authorisation_token, json[QString("authorisationToken")]);
    m_authorisation_token_isSet = !json[QString("authorisationToken")].isNull() && m_authorisation_token_isValid;
...
QJsonObject OAIPaymentResponse_action::asJsonObject() const {
    ...
    if (m_authorisation_token_isSet) {
        obj.insert(QString("authorisationToken"), ::OpenAPI::toJsonValue(m_authorisation_token));
    }
    if (m_subtype_isSet) {
...
QString OAIPaymentResponse_action::getAuthorisationToken() const {
    return m_authorisation_token;
}
void OAIPaymentResponse_action::setAuthorisationToken(const QString &authorisation_token) {
    m_authorisation_token = authorisation_token;
    m_authorisation_token_isSet = true;
}

bool OAIPaymentResponse_action::is_authorisation_token_Set() const{
    return m_authorisation_token_isSet;
}

bool OAIPaymentResponse_action::is_authorisation_token_Valid() const{
    return m_authorisation_token_isValid;
}

QString OAIPaymentResponse_action::getSubtype() const {
    return m_subtype;
}
void OAIPaymentResponse_action::setSubtype(const QString &subtype) {
    m_subtype = subtype;
    m_subtype_isSet = true;
}

bool OAIPaymentResponse_action::is_subtype_Set() const{
    return m_subtype_isSet;
}

bool OAIPaymentResponse_action::is_subtype_Valid() const{
...
QString OAIPaymentResponse_action::getPassCreationToken() const {
    return m_pass_creation_token;
}
void OAIPaymentResponse_action::setPassCreationToken(const QString &pass_creation_token) {
    m_pass_creation_token = pass_creation_token;
    m_pass_creation_token_isSet = true;
}

bool OAIPaymentResponse_action::is_pass_creation_token_Set() const{
    return m_pass_creation_token_isSet;
}

bool OAIPaymentResponse_action::is_pass_creation_token_Valid() const{
