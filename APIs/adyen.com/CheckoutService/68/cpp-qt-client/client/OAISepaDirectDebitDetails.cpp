...
QString OAISepaDirectDebitDetails::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAISepaDirectDebitDetails::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAISepaDirectDebitDetails::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAISepaDirectDebitDetails::is_checkout_attempt_id_Valid() const{
...
QString OAISepaDirectDebitDetails::getStoredPaymentMethodId() const {
    return m_stored_payment_method_id;
}
void OAISepaDirectDebitDetails::setStoredPaymentMethodId(const QString &stored_payment_method_id) {
    m_stored_payment_method_id = stored_payment_method_id;
    m_stored_payment_method_id_isSet = true;
}

bool OAISepaDirectDebitDetails::is_stored_payment_method_id_Set() const{
    return m_stored_payment_method_id_isSet;
}

bool OAISepaDirectDebitDetails::is_stored_payment_method_id_Valid() const{
