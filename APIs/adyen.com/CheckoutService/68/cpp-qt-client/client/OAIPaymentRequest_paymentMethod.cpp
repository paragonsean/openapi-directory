...
QString OAIPaymentRequest_paymentMethod::getCheckoutAttemptId() const {
    return m_checkout_attempt_id;
}
void OAIPaymentRequest_paymentMethod::setCheckoutAttemptId(const QString &checkout_attempt_id) {
    m_checkout_attempt_id = checkout_attempt_id;
    m_checkout_attempt_id_isSet = true;
}

bool OAIPaymentRequest_paymentMethod::is_checkout_attempt_id_Set() const{
    return m_checkout_attempt_id_isSet;
}

bool OAIPaymentRequest_paymentMethod::is_checkout_attempt_id_Valid() const{
