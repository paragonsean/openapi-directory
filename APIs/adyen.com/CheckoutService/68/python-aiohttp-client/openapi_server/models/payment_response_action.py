...
from openapi_server.models.checkout_three_ds2_action import CheckoutThreeDS2Action
...
class PaymentResponseAction(Model):
    ...
    def __init__(self, payment_data: str=None, payment_method_type: str=None, type: str=None, url: str=None, data: Dict[str, str]=None, method: str=None, native_redirect_data: str=None, expires_at: str=None, qr_code_data: str=None, sdk_data: Dict[str, str]=None, authorisation_token: str=None, subtype: str=None, token: str=None, alternative_reference: str=None, collection_institution_number: str=None, download_url: str=None, entity: str=None, initial_amount: Amount=None, instructions_url: str=None, issuer: str=None, masked_telephone_number: str=None, merchant_name: str=None, merchant_reference: str=None, pass_creation_token: str=None, reference: str=None, shopper_email: str=None, shopper_name: str=None, surcharge: Amount=None, total_amount: Amount=None):
        ...
        :param authorisation_token: The authorisation_token of this PaymentResponseAction.
        :param subtype: The subtype of this PaymentResponseAction.
        ...
        :param pass_creation_token: The pass_creation_token of this PaymentResponseAction.
        ...
        self._pass_creation_token = pass_creation_token
    ...
    def type(self, type):
        ...
        **await**
        ...
        :type type: str
        """
        allowed_values = ["await", "nativeRedirect", "qrCode", "redirect", "sdk", "wechatpaySDK", "threeDS2", "voucher"]  # noqa: E501
    ...
    def authorisation_token(self):
        """Gets the authorisation_token of this PaymentResponseAction.

        A token needed to authorise a payment.

        :return: The authorisation_token of this PaymentResponseAction.
        :rtype: str
        """
    ...
    def authorisation_token(self, authorisation_token):
        """Sets the authorisation_token of this PaymentResponseAction.
    ...
    @property
    def subtype(self):
        """Gets the subtype of this PaymentResponseAction.

        A subtype of the token.

        :return: The subtype of this PaymentResponseAction.
        :rtype: str
        """
    ...
    def subtype(self, subtype):
        """Sets the subtype of this PaymentResponseAction.
    ...
    @property
    def pass_creation_token(self):
        """Gets the pass_creation_token of this PaymentResponseAction.

        A base64 encoded signature of all properties

        :return: The pass_creation_token of this PaymentResponseAction.
        :rtype: str
        """
        return self._pass_creation_token

    @pass_creation_token.setter
    def pass_creation_token(self, pass_creation_token):
        """Sets the pass_creation_token of this PaymentResponseAction.

        A base64 encoded signature of all properties

        :param pass_creation_token: The pass_creation_token of this PaymentResponseAction.
        :type pass_creation_token: str
        """
