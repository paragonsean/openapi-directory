...
class DragonpayDetails(Model):
    ...
    def __init__(self, checkout_attempt_id: str=None, issuer: str=None, shopper_email: str=None, type: str=None):
        """DragonpayDetails - a model defined in OpenAPI

        :param checkout_attempt_id: The checkout_attempt_id of this DragonpayDetails.
    ...
    def checkout_attempt_id(self):
        """Gets the checkout_attempt_id of this DragonpayDetails.

        The checkout attempt identifier.

        :return: The checkout_attempt_id of this DragonpayDetails.
        :rtype: str
        """
    ...
    def checkout_attempt_id(self, checkout_attempt_id):
        """Sets the checkout_attempt_id of this DragonpayDetails.
