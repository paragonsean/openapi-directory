...
class VisaCheckoutDetails(Model):
    ...
    def __init__(self, checkout_attempt_id: str=None, funding_source: str=None, type: str='visacheckout', visa_checkout_call_id: str=None):
        """VisaCheckoutDetails - a model defined in OpenAPI

        :param checkout_attempt_id: The checkout_attempt_id of this VisaCheckoutDetails.
    ...
    def checkout_attempt_id(self):
        """Gets the checkout_attempt_id of this VisaCheckoutDetails.

        The checkout attempt identifier.

        :return: The checkout_attempt_id of this VisaCheckoutDetails.
        :rtype: str
        """
    ...
    def checkout_attempt_id(self, checkout_attempt_id):
        """Sets the checkout_attempt_id of this VisaCheckoutDetails.
