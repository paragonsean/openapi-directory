...
class CheckoutVoucherAction(Model):
    ...
    def __init__(self, alternative_reference: str=None, collection_institution_number: str=None, download_url: str=None, entity: str=None, expires_at: str=None, initial_amount: Amount=None, instructions_url: str=None, issuer: str=None, masked_telephone_number: str=None, merchant_name: str=None, merchant_reference: str=None, pass_creation_token: str=None, payment_data: str=None, payment_method_type: str=None, reference: str=None, shopper_email: str=None, shopper_name: str=None, surcharge: Amount=None, total_amount: Amount=None, type: str=None, url: str=None):
        ...
        :param pass_creation_token: The pass_creation_token of this CheckoutVoucherAction.
    ...
    def pass_creation_token(self):
        """Gets the pass_creation_token of this CheckoutVoucherAction.

        A base64 encoded signature of all properties

        :return: The pass_creation_token of this CheckoutVoucherAction.
        :rtype: str
        """
    ...
    def pass_creation_token(self, pass_creation_token):
        """Sets the pass_creation_token of this CheckoutVoucherAction.
