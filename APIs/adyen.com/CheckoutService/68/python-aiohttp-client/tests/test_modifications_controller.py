...
async def test_post_payments_payment_psp_reference_amount_updates(client):
    ...
    response = await client.request(
        method='POST',
        path='/v68/payments/{payment_psp_reference}/amountUpdates'.format(payment_psp_reference='payment_psp_reference_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_payments_payment_psp_reference_cancels(client):
    ...
    response = await client.request(
        method='POST',
        path='/v68/payments/{payment_psp_reference}/cancels'.format(payment_psp_reference='payment_psp_reference_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_payments_payment_psp_reference_captures(client):
    ...
    response = await client.request(
        method='POST',
        path='/v68/payments/{payment_psp_reference}/captures'.format(payment_psp_reference='payment_psp_reference_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_payments_payment_psp_reference_refunds(client):
    ...
    response = await client.request(
        method='POST',
        path='/v68/payments/{payment_psp_reference}/refunds'.format(payment_psp_reference='payment_psp_reference_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_post_payments_payment_psp_reference_reversals(client):
    ...
    response = await client.request(
        method='POST',
        path='/v68/payments/{payment_psp_reference}/reversals'.format(payment_psp_reference='payment_psp_reference_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
