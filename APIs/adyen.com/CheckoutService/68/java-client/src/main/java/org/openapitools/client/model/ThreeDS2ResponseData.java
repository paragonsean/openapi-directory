...
public class ThreeDS2ResponseData {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ThreeDS2ResponseData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ThreeDS2ResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ThreeDS2ResponseData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ThreeDS2ResponseData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("acsChallengeMandated") != null && !jsonObj.get("acsChallengeMandated").isJsonNull()) && !jsonObj.get("acsChallengeMandated").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("acsOperatorID") != null && !jsonObj.get("acsOperatorID").isJsonNull()) && !jsonObj.get("acsOperatorID").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("acsReferenceNumber") != null && !jsonObj.get("acsReferenceNumber").isJsonNull()) && !jsonObj.get("acsReferenceNumber").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("acsSignedContent") != null && !jsonObj.get("acsSignedContent").isJsonNull()) && !jsonObj.get("acsSignedContent").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("acsTransID") != null && !jsonObj.get("acsTransID").isJsonNull()) && !jsonObj.get("acsTransID").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("cardHolderInfo") != null && !jsonObj.get("cardHolderInfo").isJsonNull()) && !jsonObj.get("cardHolderInfo").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("dsReferenceNumber") != null && !jsonObj.get("dsReferenceNumber").isJsonNull()) && !jsonObj.get("dsReferenceNumber").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("exemptionIndicator") != null && !jsonObj.get("exemptionIndicator").isJsonNull()) && !jsonObj.get("exemptionIndicator").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("riskScore") != null && !jsonObj.get("riskScore").isJsonNull()) && !jsonObj.get("riskScore").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("sdkEphemPubKey") != null && !jsonObj.get("sdkEphemPubKey").isJsonNull()) && !jsonObj.get("sdkEphemPubKey").isJsonPrimitive()) {
