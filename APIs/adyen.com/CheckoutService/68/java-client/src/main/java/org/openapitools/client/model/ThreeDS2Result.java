...
public class ThreeDS2Result {
  ...
  public enum ChallengeCancelEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      ChallengeCancelEnum.fromValue(value);
    }
  }
  ...
  public enum ExemptionIndicatorEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ExemptionIndicatorEnum.fromValue(value);
    }
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("challengeCancel") != null && !jsonObj.get("challengeCancel").isJsonNull()) && !jsonObj.get("challengeCancel").isJsonPrimitive()) {
      ...
      // validate the optional field `challengeCancel`
      if (jsonObj.get("challengeCancel") != null && !jsonObj.get("challengeCancel").isJsonNull()) {
        ChallengeCancelEnum.validateJsonElement(jsonObj.get("challengeCancel"));
      }
      ...
      if (jsonObj.get("exemptionIndicator") != null && !jsonObj.get("exemptionIndicator").isJsonNull()) {
        ExemptionIndicatorEnum.validateJsonElement(jsonObj.get("exemptionIndicator"));
      }
