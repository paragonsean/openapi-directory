# AdyenCheckoutApi.BalanceCheckRequest
...
**paymentMethod** | **{String: String}** | The collection that contains the type of the payment method and its specific information. | 
