...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CheckoutThreeDS2FingerPrintAction();
  });
  ...
  describe('CheckoutThreeDS2FingerPrintAction', function() {
    it('should create an instance of CheckoutThreeDS2FingerPrintAction', function() {
      // uncomment below and update the code to test CheckoutThreeDS2FingerPrintAction
      //var instance = new AdyenCheckoutApi.CheckoutThreeDS2FingerPrintAction();
      //expect(instance).to.be.a(AdyenCheckoutApi.CheckoutThreeDS2FingerPrintAction);
    });
