...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.ExternalPlatform();
  });
  ...
  describe('ExternalPlatform', function() {
    it('should create an instance of ExternalPlatform', function() {
      // uncomment below and update the code to test ExternalPlatform
      //var instance = new AdyenCheckoutApi.ExternalPlatform();
      //expect(instance).to.be.a(AdyenCheckoutApi.ExternalPlatform);
    });
