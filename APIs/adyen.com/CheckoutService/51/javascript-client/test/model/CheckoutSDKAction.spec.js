...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CheckoutSDKAction();
  });
  ...
  describe('CheckoutSDKAction', function() {
    it('should create an instance of CheckoutSDKAction', function() {
      // uncomment below and update the code to test CheckoutSDKAction
      //var instance = new AdyenCheckoutApi.CheckoutSDKAction();
      //expect(instance).to.be.a(AdyenCheckoutApi.CheckoutSDKAction);
    });
