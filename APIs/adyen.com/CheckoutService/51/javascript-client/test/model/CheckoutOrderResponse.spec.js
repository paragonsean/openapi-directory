...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutApi.CheckoutOrderResponse();
  });
  ...
  describe('CheckoutOrderResponse', function() {
    it('should create an instance of CheckoutOrderResponse', function() {
      // uncomment below and update the code to test CheckoutOrderResponse
      //var instance = new AdyenCheckoutApi.CheckoutOrderResponse();
      //expect(instance).to.be.a(AdyenCheckoutApi.CheckoutOrderResponse);
    });
