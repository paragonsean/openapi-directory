...
async def test_get_payment_links_link_id(client):
    ...
    response = await client.request(
        method='GET',
        path='/v51/paymentLinks/{link_id}'.format(link_id='link_id_example'),
        headers=headers,
        )
