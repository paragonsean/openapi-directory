...
class CreateOrderResponse(Model):
    ...
    def __init__(self, additional_data: BalanceCheckResponseAdditionalData=None, expires_at: str=None, fraud_result: FraudResult=None, order_data: str=None, psp_reference: str=None, reference: str=None, refusal_reason: str=None, remaining_amount: Amount=None, result_code: str=None):
