...
public class PaymentMethodsResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(groups, oneClickPaymentMethods, paymentMethods, storedPaymentMethods);
  }
      ...
      if (jsonObj.get("storedPaymentMethods") != null && !jsonObj.get("storedPaymentMethods").isJsonNull()) {
        ...
        if (jsonArraystoredPaymentMethods != null) {
          ...
          for (int i = 0; i < jsonArraystoredPaymentMethods.size(); i++) {
            StoredPaymentMethod.validateJsonElement(jsonArraystoredPaymentMethods.get(i));
          };
        }
      }
  }
