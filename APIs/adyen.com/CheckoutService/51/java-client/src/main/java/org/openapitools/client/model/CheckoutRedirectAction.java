...
public class CheckoutRedirectAction {
  ...
  public CheckoutRedirectAction paymentData(String paymentData) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, checkoutRedirectAction.data) &&
        ...
        Objects.equals(this.paymentData, checkoutRedirectAction.paymentData) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(data, method, paymentData, paymentMethodType, type, url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CheckoutRedirectAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckoutRedirectAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CheckoutRedirectAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckoutRedirectAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
