...
/*
 * OAICheckoutAwaitAction.h
 *
 * 
 */

#ifndef OAICheckoutAwaitAction_H
#define OAICheckoutAwaitAction_H
...
class OAICheckoutAwaitAction : public OAIObject {
public:
    OAICheckoutAwaitAction();
    OAICheckoutAwaitAction(QString json);
    ~OAICheckoutAwaitAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckoutAwaitAction)

#endif // OAICheckoutAwaitAction_H
