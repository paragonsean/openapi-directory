...
bool OAIBalanceCheckRequest::isEnableRealTimeUpdate() const {
    return m_enable_real_time_update;
}
void OAIBalanceCheckRequest::setEnableRealTimeUpdate(const bool &enable_real_time_update) {
    m_enable_real_time_update = enable_real_time_update;
    m_enable_real_time_update_isSet = true;
}

bool OAIBalanceCheckRequest::is_enable_real_time_update_Set() const{
    return m_enable_real_time_update_isSet;
}

bool OAIBalanceCheckRequest::is_enable_real_time_update_Valid() const{
