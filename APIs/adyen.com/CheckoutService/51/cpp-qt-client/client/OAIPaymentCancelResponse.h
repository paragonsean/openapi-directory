...
/*
 * OAIPaymentCancelResponse.h
 *
 * 
 */

#ifndef OAIPaymentCancelResponse_H
#define OAIPaymentCancelResponse_H
...
class OAIPaymentCancelResponse : public OAIObject {
public:
    OAIPaymentCancelResponse();
    OAIPaymentCancelResponse(QString json);
    ~OAIPaymentCancelResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentCancelResponse)

#endif // OAIPaymentCancelResponse_H
