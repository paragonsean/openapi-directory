...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutUtilityService.CheckoutUtilityResponse();
  });
  ...
  describe('CheckoutUtilityResponse', function() {
    it('should create an instance of CheckoutUtilityResponse', function() {
      // uncomment below and update the code to test CheckoutUtilityResponse
      //var instance = new AdyenCheckoutUtilityService.CheckoutUtilityResponse();
      //expect(instance).to.be.a(AdyenCheckoutUtilityService.CheckoutUtilityResponse);
    });
