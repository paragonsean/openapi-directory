...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenCheckoutUtilityService.CheckoutUtilityRequest();
  });
  ...
  describe('CheckoutUtilityRequest', function() {
    it('should create an instance of CheckoutUtilityRequest', function() {
      // uncomment below and update the code to test CheckoutUtilityRequest
      //var instance = new AdyenCheckoutUtilityService.CheckoutUtilityRequest();
      //expect(instance).to.be.a(AdyenCheckoutUtilityService.CheckoutUtilityRequest);
    });

    it('should have the property originDomains (base name: "originDomains")', function() {
      // uncomment below and update the code to test the property originDomains
      //var instance = new AdyenCheckoutUtilityService.CheckoutUtilityRequest();
