# adyen_checkout_utility_service

AdyenCheckoutUtilityService - JavaScript client for adyen_checkout_utility_service
...
```shell
npm install adyen_checkout_utility_service --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your adyen_checkout_utility_service from, and run:
...
```javascript
var AdyenCheckoutUtilityService = require('adyen_checkout_utility_service');


var api = new AdyenCheckoutUtilityService.DefaultApi()
var opts = {
...
api.originKeysPost(opts, callback);
...
------------ | ------------- | ------------- | -------------
*AdyenCheckoutUtilityService.DefaultApi* | [**originKeysPost**](docs/DefaultApi.md#originKeysPost) | **POST** /originKeys | Create originKey values for one or more merchant domains.


## Documentation for Models

 - [AdyenCheckoutUtilityService.CheckoutUtilityRequest](docs/CheckoutUtilityRequest.md)
 - [AdyenCheckoutUtilityService.CheckoutUtilityResponse](docs/CheckoutUtilityResponse.md)
