...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://checkout-test.adyen.com/v1"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("originKeysPost", defaultConf);
    _serverIndices.insert("originKeysPost", 0);
}
...
void OAIDefaultApi::originKeysPost(const ::OpenAPI::OptionalParam<OAICheckoutUtilityRequest> &oai_checkout_utility_request) {
    QString fullPath = QString(_serverConfigs["originKeysPost"][_serverIndices.value("originKeysPost")].URL()+"/originKeys");
    ...
    if (oai_checkout_utility_request.hasValue()){

        
        QByteArray output = oai_checkout_utility_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::originKeysPostCallback);
...
void OAIDefaultApi::originKeysPostCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICheckoutUtilityResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT originKeysPostSignal(output);
        Q_EMIT originKeysPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT originKeysPostSignalE(output, error_type, error_str);
        Q_EMIT originKeysPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT originKeysPostSignalError(output, error_type, error_str);
        Q_EMIT originKeysPostSignalErrorFull(worker, error_type, error_str);
    }
}
