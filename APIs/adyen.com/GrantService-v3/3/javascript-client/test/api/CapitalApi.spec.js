...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CapitalApi.CapitalApi();
  });
  ...
  describe('CapitalApi', function() {
    describe('getGrants', function() {
      it('should call getGrants successfully', function(done) {
        //uncomment below and update the code to test getGrants
        //instance.getGrants(function(error) {
    ...
    describe('getGrantsId', function() {
      it('should call getGrantsId successfully', function(done) {
        //uncomment below and update the code to test getGrantsId
        //instance.getGrantsId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postGrants', function() {
      it('should call postGrants successfully', function(done) {
        //uncomment below and update the code to test postGrants
        //instance.postGrants(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
