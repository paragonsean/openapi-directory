...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CapitalApi.CapitalGrants();
  });
  ...
  describe('CapitalGrants', function() {
    it('should create an instance of CapitalGrants', function() {
      // uncomment below and update the code to test CapitalGrants
      //var instance = new CapitalApi.CapitalGrants();
      //expect(instance).to.be.a(CapitalApi.CapitalGrants);
    });
