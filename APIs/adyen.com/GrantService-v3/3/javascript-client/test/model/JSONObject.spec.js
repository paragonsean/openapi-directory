...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CapitalApi.JSONObject();
  });
  ...
  describe('JSONObject', function() {
    it('should create an instance of JSONObject', function() {
      // uncomment below and update the code to test JSONObject
      //var instance = new CapitalApi.JSONObject();
      //expect(instance).to.be.a(CapitalApi.JSONObject);
    });
