...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CapitalApi.CapitalBalance();
  });
  ...
  describe('CapitalBalance', function() {
    it('should create an instance of CapitalBalance', function() {
      // uncomment below and update the code to test CapitalBalance
      //var instance = new CapitalApi.CapitalBalance();
      //expect(instance).to.be.a(CapitalApi.CapitalBalance);
    });
