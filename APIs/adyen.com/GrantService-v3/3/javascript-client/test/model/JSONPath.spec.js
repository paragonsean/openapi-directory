...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CapitalApi.JSONPath();
  });
  ...
  describe('JSONPath', function() {
    it('should create an instance of JSONPath', function() {
      // uncomment below and update the code to test JSONPath
      //var instance = new CapitalApi.JSONPath();
      //expect(instance).to.be.a(CapitalApi.JSONPath);
    });
