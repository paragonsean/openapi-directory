...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CapitalApi.CapitalGrantInfo();
  });
  ...
  describe('CapitalGrantInfo', function() {
    it('should create an instance of CapitalGrantInfo', function() {
      // uncomment below and update the code to test CapitalGrantInfo
      //var instance = new CapitalApi.CapitalGrantInfo();
      //expect(instance).to.be.a(CapitalApi.CapitalGrantInfo);
    });
