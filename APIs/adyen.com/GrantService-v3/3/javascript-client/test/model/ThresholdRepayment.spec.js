...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CapitalApi.ThresholdRepayment();
  });
  ...
  describe('ThresholdRepayment', function() {
    it('should create an instance of ThresholdRepayment', function() {
      // uncomment below and update the code to test ThresholdRepayment
      //var instance = new CapitalApi.ThresholdRepayment();
      //expect(instance).to.be.a(CapitalApi.ThresholdRepayment);
    });
