...
```javascript
import CapitalApi from 'capital_api';
let defaultClient = CapitalApi.ApiClient.instance;
...
let apiInstance = new CapitalApi.CapitalApi();
let opts = {
...
let apiInstance = new CapitalApi.CapitalApi();
let opts = {
  'capitalGrantInfo': new CapitalApi.CapitalGrantInfo() // CapitalGrantInfo | 
};
