...
public class PaymentInstrumentNotificationData {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentInstrumentNotificationData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentInstrumentNotificationData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentInstrumentNotificationData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentInstrumentNotificationData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
