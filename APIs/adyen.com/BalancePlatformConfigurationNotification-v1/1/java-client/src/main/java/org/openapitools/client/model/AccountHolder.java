...
public class AccountHolder {
  ...
  public static final String SERIALIZED_NAME_MIGRATED_ACCOUNT_HOLDER_CODE = "migratedAccountHolderCode";
  @SerializedName(SERIALIZED_NAME_MIGRATED_ACCOUNT_HOLDER_CODE)
  ...
  static {
    ...
    openapiFields.add("migratedAccountHolderCode");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("migratedAccountHolderCode") != null && !jsonObj.get("migratedAccountHolderCode").isJsonNull()) && !jsonObj.get("migratedAccountHolderCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `migratedAccountHolderCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("migratedAccountHolderCode").toString()));
      }
