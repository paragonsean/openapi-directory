...
import org.openapitools.client.model.AccountHolderNotificationData;
...
public class AccountHolderNotificationRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountHolderNotificationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountHolderNotificationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountHolderNotificationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountHolderNotificationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      AccountHolderNotificationData.validateJsonElement(jsonObj.get("data"));
