...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigurationWebhooks.PhoneNumber();
  });
  ...
  describe('PhoneNumber', function() {
    it('should create an instance of PhoneNumber', function() {
      ...
      //var instance = new ConfigurationWebhooks.PhoneNumber();
      //expect(instance).to.be.a(ConfigurationWebhooks.PhoneNumber);
    });
