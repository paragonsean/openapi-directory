...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigurationWebhooks.CardOrderItem();
  });
  ...
  describe('CardOrderItem', function() {
    it('should create an instance of CardOrderItem', function() {
      // uncomment below and update the code to test CardOrderItem
      //var instance = new ConfigurationWebhooks.CardOrderItem();
      //expect(instance).to.be.a(ConfigurationWebhooks.CardOrderItem);
    });
    ...
    it('should have the property cardOrderItemId (base name: "cardOrderItemId")', function() {
      // uncomment below and update the code to test the property cardOrderItemId
      //var instance = new ConfigurationWebhooks.CardOrderItem();
      //expect(instance).to.be();
    });
