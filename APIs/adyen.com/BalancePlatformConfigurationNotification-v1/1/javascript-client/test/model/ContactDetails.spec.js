...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigurationWebhooks.ContactDetails();
  });
  ...
  describe('ContactDetails', function() {
    it('should create an instance of ContactDetails', function() {
      ...
      //var instance = new ConfigurationWebhooks.ContactDetails();
      //expect(instance).to.be.a(ConfigurationWebhooks.ContactDetails);
    });
