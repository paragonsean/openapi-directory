...
class AccountHolder(Model):
    ...
    def __init__(self, balance_platform: str=None, capabilities: Dict[str, AccountHolderCapability]=None, contact_details: ContactDetails=None, description: str=None, id: str=None, legal_entity_id: str=None, metadata: Dict[str, str]=None, migrated_account_holder_code: str=None, primary_balance_account: str=None, reference: str=None, status: str=None, time_zone: str=None, verification_deadlines: List[VerificationDeadline]=None):
        ...
        :param metadata: The metadata of this AccountHolder.
        :param migrated_account_holder_code: The migrated_account_holder_code of this AccountHolder.
        ...
        :param verification_deadlines: The verification_deadlines of this AccountHolder.
        """
        self.openapi_types = {
            ...
            'migrated_account_holder_code': str,
        ...
        self._migrated_account_holder_code = migrated_account_holder_code
    ...
    @property
    def metadata(self):
        """Gets the metadata of this AccountHolder.

        A set of key and value pairs for general use. The keys do not have specific names and may be used for storing miscellaneous data as desired. > Note that during an update of metadata, the omission of existing key-value pairs will result in the deletion of those key-value pairs.

        :return: The metadata of this AccountHolder.
        :rtype: Dict[str, str]
        """
    ...
    def metadata(self, metadata):
        """Sets the metadata of this AccountHolder.
    ...
    @property
    def migrated_account_holder_code(self):
        """Gets the migrated_account_holder_code of this AccountHolder.

        The unique identifier of the migrated account holder in the classic integration.

        :return: The migrated_account_holder_code of this AccountHolder.
        :rtype: str
        """
        return self._migrated_account_holder_code

    @migrated_account_holder_code.setter
    def migrated_account_holder_code(self, migrated_account_holder_code):
        """Sets the migrated_account_holder_code of this AccountHolder.

        The unique identifier of the migrated account holder in the classic integration.

        :param migrated_account_holder_code: The migrated_account_holder_code of this AccountHolder.
        :type migrated_account_holder_code: str
        """
    ...
    def verification_deadlines(self):
        """Gets the verification_deadlines of this AccountHolder.

        List of verification deadlines and the capabilities that will be disallowed if verification errors are not resolved.

        :return: The verification_deadlines of this AccountHolder.
    ...
    def verification_deadlines(self, verification_deadlines):
        """Sets the verification_deadlines of this AccountHolder.
