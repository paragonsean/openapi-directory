...
OAIPaymentInstrumentNotificationData OAIPaymentNotificationRequest::getData() const {
    return m_data;
}
void OAIPaymentNotificationRequest::setData(const OAIPaymentInstrumentNotificationData &data) {
    m_data = data;
    m_data_isSet = true;
}
