...
public class ServiceInstanceNode {
  ...
  public ServiceInstanceNode extra(Object extra) {
    this.extra = extra;
    return this;
  }
  ...
  public ServiceInstanceNode name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ServiceInstanceNode sourceCreatedAt(OffsetDateTime sourceCreatedAt) {
  ...
  public ServiceInstanceNode sourceRef(String sourceRef) {
  ...
  public ServiceInstanceNode sourceUpdatedAt(OffsetDateTime sourceUpdatedAt) {
