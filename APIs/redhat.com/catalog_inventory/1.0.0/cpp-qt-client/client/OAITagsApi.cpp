...
void OAITagsApi::listTags(const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<qint32> &offset, const ::OpenAPI::OptionalParam<OAIObject> &filter, const ::OpenAPI::OptionalParam<OAIObject> &sort_by) {
    QString fullPath = QString(_serverConfigs["listTags"][_serverIndices.value("listTags")].URL()+"/tags");
