...
void OAITaskApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("showTask", defaultConf);
    _serverIndices.insert("showTask", 0);
...
void OAITaskApi::listTasks(const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<qint32> &offset, const ::OpenAPI::OptionalParam<OAIObject> &filter, const ::OpenAPI::OptionalParam<OAIObject> &sort_by) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITaskApi::listTasksCallback);
...
void OAITaskApi::listTasksCallback(OAIHttpRequestWorker *worker) {
...
void OAITaskApi::showTask(const QString &id) {
    QString fullPath = QString(_serverConfigs["showTask"][_serverIndices.value("showTask")].URL()+"/tasks/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITaskApi::showTaskCallback);
    connect(this, &OAITaskApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITaskApi::showTaskCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT showTaskSignal(output);
        Q_EMIT showTaskSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT showTaskSignalE(output, error_type, error_str);
        Q_EMIT showTaskSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT showTaskSignalError(output, error_type, error_str);
        Q_EMIT showTaskSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITaskApi::updateTask(const QString &id, const OAITask &oai_task) {
    QString fullPath = QString(_serverConfigs["updateTask"][_serverIndices.value("updateTask")].URL()+"/tasks/{id}");
...

    {
        ...
        QByteArray output = oai_task.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITaskApi::updateTaskCallback);
    connect(this, &OAITaskApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITaskApi::updateTaskCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
