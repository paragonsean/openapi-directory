...
class Tenant {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('external_tenant')) {
                obj['external_tenant'] = ApiClient.convertToType(data['external_tenant'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['external_tenant'] && !(typeof data['external_tenant'] === 'string' || data['external_tenant'] instanceof String)) {
            throw new Error("Expected the field `external_tenant` to be a primitive type in the JSON string but got " + data['external_tenant']);
        }
        // ensure the json data is a string
...
/**
 * @member {String} external_tenant
 */
Tenant.prototype['external_tenant'] = undefined;
