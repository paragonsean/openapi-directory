...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://cloud.redhat.com//api/catalog-inventory/v1.0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://cloud.redhat.com//api/catalog-inventory/v1.0
         */
        ...
        return [
            {
              ...
              'variables': {
                basePath: {
                    ...
                    'default_value': "/api/catalog-inventory/v1.0",
                  }
                }
            },
            {
