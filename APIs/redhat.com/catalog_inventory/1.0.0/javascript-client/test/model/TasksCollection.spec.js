...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogInventory.TasksCollection();
  });
  ...
  describe('TasksCollection', function() {
    it('should create an instance of TasksCollection', function() {
      ...
      //var instance = new CatalogInventory.TasksCollection();
      //expect(instance).to.be.a(CatalogInventory.TasksCollection);
    });
