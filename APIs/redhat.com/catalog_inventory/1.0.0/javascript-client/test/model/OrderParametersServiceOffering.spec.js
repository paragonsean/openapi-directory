...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogInventory.OrderParametersServiceOffering();
  });
  ...
  describe('OrderParametersServiceOffering', function() {
    it('should create an instance of OrderParametersServiceOffering', function() {
      // uncomment below and update the code to test OrderParametersServiceOffering
      //var instance = new CatalogInventory.OrderParametersServiceOffering();
      //expect(instance).to.be.a(CatalogInventory.OrderParametersServiceOffering);
    });
