...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogInventory.ServiceCredential();
  });
  ...
  describe('ServiceCredential', function() {
    it('should create an instance of ServiceCredential', function() {
      // uncomment below and update the code to test ServiceCredential
      //var instance = new CatalogInventory.ServiceCredential();
      //expect(instance).to.be.a(CatalogInventory.ServiceCredential);
    });
    ...
    it('should have the property serviceCredentialTypeId (base name: "service_credential_type_id")', function() {
      // uncomment below and update the code to test the property serviceCredentialTypeId
      //var instance = new CatalogInventory.ServiceCredential();
      //expect(instance).to.be();
    });
