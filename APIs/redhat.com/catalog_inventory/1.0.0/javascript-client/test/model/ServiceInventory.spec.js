...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogInventory.ServiceInventory();
  });
  ...
  describe('ServiceInventory', function() {
    it('should create an instance of ServiceInventory', function() {
      // uncomment below and update the code to test ServiceInventory
      //var instance = new CatalogInventory.ServiceInventory();
      //expect(instance).to.be.a(CatalogInventory.ServiceInventory);
    });
    ...
    it('should have the property sourceUpdatedAt (base name: "source_updated_at")', function() {
      // uncomment below and update the code to test the property sourceUpdatedAt
      //var instance = new CatalogInventory.ServiceInventory();
      //expect(instance).to.be();
    });
