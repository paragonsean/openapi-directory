# CatalogInventory.ServiceCredentialTypeApi
...
> ServiceCredentialTypesCollection listServiceCredentialTypes(opts)
...
let apiInstance = new CatalogInventory.ServiceCredentialTypeApi();
let opts = {
...
apiInstance.listServiceCredentialTypes(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.showServiceCredentialType(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
