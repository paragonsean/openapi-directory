...
void OAIUserApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getUserCollections", defaultConf);
    _serverIndices.insert("getUserCollections", 0);
    _serverConfigs.insert("getUserUploadsWithUser", defaultConf);
    _serverIndices.insert("getUserUploadsWithUser", 0);
}
...
void OAIUserApi::getUserCollection(const qint32 &user_id, const QString &slug) {
    QString fullPath = QString(_serverConfigs["getUserCollection"][_serverIndices.value("getUserCollection")].URL()+"/user/{user_id}/collections/{slug}");
...
void OAIUserApi::getUserCollectionCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getUserCollectionSignal();
        Q_EMIT getUserCollectionSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getUserCollectionSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getUserCollectionSignalError(error_type, error_str);
        Q_EMIT getUserCollectionSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUserApi::getUserCollections(const qint32 &user_id) {
    QString fullPath = QString(_serverConfigs["getUserCollections"][_serverIndices.value("getUserCollections")].URL()+"/user/{user_id}/collections");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUserApi::getUserCollectionsCallback);
    connect(this, &OAIUserApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUserApi::getUserCollectionsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getUserCollectionsSignal();
        Q_EMIT getUserCollectionsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getUserCollectionsSignalE(error_type, error_str);
        Q_EMIT getUserCollectionsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getUserCollectionsSignalError(error_type, error_str);
        Q_EMIT getUserCollectionsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUserApi::getUserUploadsWithUser(const QString &username, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<qint32> &offset, const ::OpenAPI::OptionalParam<qint32> &page) {
    QString fullPath = QString(_serverConfigs["getUserUploadsWithUser"][_serverIndices.value("getUserUploadsWithUser")].URL()+"/user/{username}/uploads");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUserApi::getUserUploadsWithUserCallback);
    connect(this, &OAIUserApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUserApi::getUserUploadsWithUserCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getUserUploadsWithUserSignal();
        Q_EMIT getUserUploadsWithUserSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getUserUploadsWithUserSignalE(error_type, error_str);
        Q_EMIT getUserUploadsWithUserSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getUserUploadsWithUserSignalError(error_type, error_str);
        Q_EMIT getUserUploadsWithUserSignalErrorFull(worker, error_type, error_str);
    }
}
