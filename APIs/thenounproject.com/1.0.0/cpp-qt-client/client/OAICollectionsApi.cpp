...
void OAICollectionsApi::getAllCollections(const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<qint32> &offset, const ::OpenAPI::OptionalParam<qint32> &page) {
    QString fullPath = QString(_serverConfigs["getAllCollections"][_serverIndices.value("getAllCollections")].URL()+"/collections");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionsApi::getAllCollectionsCallback);
...
void OAICollectionsApi::getAllCollectionsCallback(OAIHttpRequestWorker *worker) {
