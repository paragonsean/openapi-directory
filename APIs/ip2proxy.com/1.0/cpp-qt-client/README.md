...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QString ip = create(); // QString | IP address (IPv4) for lookup purpose. If not present, the server IP address will be used for the lookup.
      ...
      QString key = create(); // QString | API key. Please sign up free trial license key at ip2location.com
      ...
      QString package = create(); // QString | Package name from PX1 to PX11. If not present, the web service will assume the PX1 package query.
      ...
      QString format = create(); // QString | If not present, json format will be returned as the search result.
      apiInstance.rootGet(ipkeypackageformat);
