...
void OAIDefaultApi::rootGet(const QString &ip, const QString &key, const ::OpenAPI::OptionalParam<QString> &package, const ::OpenAPI::OptionalParam<QString> &format) {
