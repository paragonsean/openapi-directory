...
public:
    ...
    */
    virtual void rootGet(const QString &ip, const QString &key, const ::OpenAPI::OptionalParam<QString> &package = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &format = ::OpenAPI::OptionalParam<QString>());
