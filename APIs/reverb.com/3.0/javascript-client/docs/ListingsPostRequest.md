# Reverb.ListingsPostRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**categories** | [**[ListingsPostRequestCategoriesInner]**](ListingsPostRequestCategoriesInner.md) |  | [optional] 
...
**exclusiveChannel** | **String** | Currently for users of seller sites only, this allows you to have a listing available only to your seller site by setting this to &#39;seller_site&#39; | [optional] 
**finish** | **String** | Finish, e.g. &#39;Sunburst&#39; | [optional] 
**hasInventory** | **Boolean** | Set true if selling more than one | [optional] 
**inventory** | **Number** | Number of items available for sale. Reverb will increment and decrement automatically. | [optional] 
...
**photos** | **[String]** | An array of image URLs. Ex: [&#39;http://my.site.com/image.jpg&#39;] | [optional] 
...
**videos** | [**[ListingsPostRequestVideosInner]**](ListingsPostRequestVideosInner.md) | List of YouTube video urls. Note: ONLY ONE ALLOWED | [optional] 
