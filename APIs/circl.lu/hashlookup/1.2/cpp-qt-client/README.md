...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::getChildrenSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::getChildrenSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString sha1 = create(); // QString | 
      ...
      apiInstance.getChildren(sha1countcursor);
