...
OAIUserModel3::OAIUserModel3(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserModel3::OAIUserModel3() {
    this->initializeModel();
}

OAIUserModel3::~OAIUserModel3() {}

void OAIUserModel3::initializeModel() {
...
void OAIUserModel3::fromJson(QString jsonString) {
...
void OAIUserModel3::fromJsonObject(QJsonObject json) {
...
QString OAIUserModel3::asJson() const {
...
QJsonObject OAIUserModel3::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUserModel3::getCurrentPassword() const {
    return m_current_password;
}
void OAIUserModel3::setCurrentPassword(const QString &current_password) {
    m_current_password = current_password;
    m_current_password_isSet = true;
}

bool OAIUserModel3::is_current_password_Set() const{
    return m_current_password_isSet;
}

bool OAIUserModel3::is_current_password_Valid() const{
    return m_current_password_isValid;
}

QString OAIUserModel3::getNewPassword() const {
    return m_new_password;
}
void OAIUserModel3::setNewPassword(const QString &new_password) {
    m_new_password = new_password;
    m_new_password_isSet = true;
}

bool OAIUserModel3::is_new_password_Set() const{
    return m_new_password_isSet;
}

bool OAIUserModel3::is_new_password_Valid() const{
    return m_new_password_isValid;
}

bool OAIUserModel3::isSet() const {
...
bool OAIUserModel3::isValid() const {
