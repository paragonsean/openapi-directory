...
#ifndef OAIUserModel2_H
#define OAIUserModel2_H
...
class OAIUserModel2 : public OAIObject {
public:
    OAIUserModel2();
    OAIUserModel2(QString json);
    ~OAIUserModel2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserModel2)

#endif // OAIUserModel2_H
