...
OAIUserModel2::OAIUserModel2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserModel2::OAIUserModel2() {
    this->initializeModel();
}

OAIUserModel2::~OAIUserModel2() {}

void OAIUserModel2::initializeModel() {
...
void OAIUserModel2::fromJson(QString jsonString) {
...
void OAIUserModel2::fromJsonObject(QJsonObject json) {
...
QString OAIUserModel2::asJson() const {
...
QJsonObject OAIUserModel2::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUserModel2::getCurrentPassword() const {
    return m_current_password;
}
void OAIUserModel2::setCurrentPassword(const QString &current_password) {
    m_current_password = current_password;
    m_current_password_isSet = true;
}

bool OAIUserModel2::is_current_password_Set() const{
    return m_current_password_isSet;
}

bool OAIUserModel2::is_current_password_Valid() const{
    return m_current_password_isValid;
}

QString OAIUserModel2::getNewPassword() const {
    return m_new_password;
}
void OAIUserModel2::setNewPassword(const QString &new_password) {
    m_new_password = new_password;
    m_new_password_isSet = true;
}

bool OAIUserModel2::is_new_password_Set() const{
    return m_new_password_isSet;
}

bool OAIUserModel2::is_new_password_Valid() const{
    return m_new_password_isValid;
}

bool OAIUserModel2::isSet() const {
...
bool OAIUserModel2::isValid() const {
