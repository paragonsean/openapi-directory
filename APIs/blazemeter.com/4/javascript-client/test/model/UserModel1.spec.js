...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlazemeterApiExplorer.UserModel1();
  });
  ...
  describe('UserModel1', function() {
    it('should create an instance of UserModel1', function() {
      // uncomment below and update the code to test UserModel1
      //var instance = new BlazemeterApiExplorer.UserModel1();
      //expect(instance).to.be.a(BlazemeterApiExplorer.UserModel1);
    });
