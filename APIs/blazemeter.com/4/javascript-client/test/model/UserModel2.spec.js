...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlazemeterApiExplorer.UserModel2();
  });
  ...
  describe('UserModel2', function() {
    it('should create an instance of UserModel2', function() {
      // uncomment below and update the code to test UserModel2
      //var instance = new BlazemeterApiExplorer.UserModel2();
      //expect(instance).to.be.a(BlazemeterApiExplorer.UserModel2);
    });
