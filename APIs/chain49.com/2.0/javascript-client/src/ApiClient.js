...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.chain49.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.chain49.com
         */
        ...
        this.authentications = {
            ...
            'X-RapidAPI-Host': {type: 'apiKey', 'in': 'header', name: 'X-RapidAPI-Host'},
            'X-RapidAPI-Key': {type: 'apiKey', 'in': 'header', name: 'X-RapidAPI-Key'}
        }
