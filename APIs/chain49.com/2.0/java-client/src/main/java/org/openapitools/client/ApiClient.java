...
public class ApiClient {
    ...
    private String basePath = "https://api.chain49.com";
    ...
    public ApiClient() {
        ...
        authentications.put("X-RapidAPI-Host", new ApiKeyAuth("header", "X-RapidAPI-Host"));
        authentications.put("X-RapidAPI-Key", new ApiKeyAuth("header", "X-RapidAPI-Key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.chain49.com
