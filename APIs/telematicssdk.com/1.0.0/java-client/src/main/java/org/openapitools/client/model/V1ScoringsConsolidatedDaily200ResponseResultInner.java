...
public class V1ScoringsConsolidatedDaily200ResponseResultInner {
  ...
  public V1ScoringsConsolidatedDaily200ResponseResultInner() {
  }

  public V1ScoringsConsolidatedDaily200ResponseResultInner accelerationScore(BigDecimal accelerationScore) {
  ...
  public V1ScoringsConsolidatedDaily200ResponseResultInner appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public V1ScoringsConsolidatedDaily200ResponseResultInner brakingScore(BigDecimal brakingScore) {
  ...
  public V1ScoringsConsolidatedDaily200ResponseResultInner companyId(String companyId) {
  ...
  public V1ScoringsConsolidatedDaily200ResponseResultInner corneringScore(BigDecimal corneringScore) {
  ...
  public V1ScoringsConsolidatedDaily200ResponseResultInner deviceToken(String deviceToken) {
  ...
  public V1ScoringsConsolidatedDaily200ResponseResultInner distractedScore(BigDecimal distractedScore) {
  ...
  public V1ScoringsConsolidatedDaily200ResponseResultInner instanceId(String instanceId) {
  ...
  public V1ScoringsConsolidatedDaily200ResponseResultInner overallScore(BigDecimal overallScore) {
  ...
  public V1ScoringsConsolidatedDaily200ResponseResultInner reportDate(String reportDate) {
  ...
  public V1ScoringsConsolidatedDaily200ResponseResultInner speedingScore(BigDecimal speedingScore) {
  ...
  public boolean equals(Object o) {
    ...
    V1ScoringsConsolidatedDaily200ResponseResultInner v1ScoringsConsolidatedDaily200ResponseResultInner = (V1ScoringsConsolidatedDaily200ResponseResultInner) o;
    return Objects.equals(this.accelerationScore, v1ScoringsConsolidatedDaily200ResponseResultInner.accelerationScore) &&
        Objects.equals(this.appId, v1ScoringsConsolidatedDaily200ResponseResultInner.appId) &&
        Objects.equals(this.brakingScore, v1ScoringsConsolidatedDaily200ResponseResultInner.brakingScore) &&
        Objects.equals(this.companyId, v1ScoringsConsolidatedDaily200ResponseResultInner.companyId) &&
        Objects.equals(this.corneringScore, v1ScoringsConsolidatedDaily200ResponseResultInner.corneringScore) &&
        Objects.equals(this.deviceToken, v1ScoringsConsolidatedDaily200ResponseResultInner.deviceToken) &&
        Objects.equals(this.distractedScore, v1ScoringsConsolidatedDaily200ResponseResultInner.distractedScore) &&
        Objects.equals(this.instanceId, v1ScoringsConsolidatedDaily200ResponseResultInner.instanceId) &&
        Objects.equals(this.overallScore, v1ScoringsConsolidatedDaily200ResponseResultInner.overallScore) &&
        Objects.equals(this.reportDate, v1ScoringsConsolidatedDaily200ResponseResultInner.reportDate) &&
        Objects.equals(this.speedingScore, v1ScoringsConsolidatedDaily200ResponseResultInner.speedingScore);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accelerationScore, appId, brakingScore, companyId, corneringScore, deviceToken, distractedScore, instanceId, overallScore, reportDate, speedingScore);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1ScoringsConsolidatedDaily200ResponseResultInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1ScoringsConsolidatedDaily200ResponseResultInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1ScoringsConsolidatedDaily200ResponseResultInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1ScoringsConsolidatedDaily200ResponseResultInner is not found in the empty JSON string", V1ScoringsConsolidatedDaily200ResponseResultInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1ScoringsConsolidatedDaily200ResponseResultInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1ScoringsConsolidatedDaily200ResponseResultInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1ScoringsConsolidatedDaily200ResponseResultInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1ScoringsConsolidatedDaily200ResponseResultInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1ScoringsConsolidatedDaily200ResponseResultInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1ScoringsConsolidatedDaily200ResponseResultInner.class));

       return (TypeAdapter<T>) new TypeAdapter<V1ScoringsConsolidatedDaily200ResponseResultInner>() {
           @Override
           public void write(JsonWriter out, V1ScoringsConsolidatedDaily200ResponseResultInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1ScoringsConsolidatedDaily200ResponseResultInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1ScoringsConsolidatedDaily200ResponseResultInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1ScoringsConsolidatedDaily200ResponseResultInner
   * @throws IOException if the JSON string is invalid with respect to V1ScoringsConsolidatedDaily200ResponseResultInner
   */
  public static V1ScoringsConsolidatedDaily200ResponseResultInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1ScoringsConsolidatedDaily200ResponseResultInner.class);
  }

  /**
   * Convert an instance of V1ScoringsConsolidatedDaily200ResponseResultInner to an JSON string
   *
   * @return JSON string
   */
