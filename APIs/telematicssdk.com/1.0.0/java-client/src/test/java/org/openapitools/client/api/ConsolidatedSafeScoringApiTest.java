...
/**
 * API tests for ConsolidatedSafeScoringApi
 */
@Disabled
public class ConsolidatedSafeScoringApiTest {

    private final ConsolidatedSafeScoringApi api = new ConsolidatedSafeScoringApi();
     ...
     */
    @Test
    public void v1ScoringsConsolidatedDaily_0Test() throws ApiException {
        ...
        V1ScoringsConsolidatedDaily200Response response = api.v1ScoringsConsolidatedDaily_0(deviceToken, startDate, endDate, tag, instanceId, appId, companyId);
     ...
     */
    @Test
    public void v1ScoringsConsolidated_0Test() throws ApiException {
        String deviceToken = null;
        String startDate = null;
        String endDate = null;
        String tag = null;
        ...
        String appId = null;
        String companyId = null;
        api.v1ScoringsConsolidated_0(deviceToken, startDate, endDate, tag, instanceId, appId, companyId);
        // TODO: test validations
    }
