...
/**
 * API tests for ConsolidatedStatisticsApi
 */
@Disabled
public class ConsolidatedStatisticsApiTest {

    private final ConsolidatedStatisticsApi api = new ConsolidatedStatisticsApi();
     ...
     */
    @Test
    public void v1StatisticsConsolidatedDaily_0Test() throws ApiException {
        ...
        api.v1StatisticsConsolidatedDaily_0(deviceToken, startDate, endDate, tag, instanceId, appId, companyId);
     ...
     */
    @Test
    public void v1StatisticsConsolidated_0Test() throws ApiException {
        String deviceToken = null;
        String startDate = null;
        String endDate = null;
        String tag = null;
        ...
        String appId = null;
        String companyId = null;
        api.v1StatisticsConsolidated_0(deviceToken, startDate, endDate, tag, instanceId, appId, companyId);
        // TODO: test validations
    }
