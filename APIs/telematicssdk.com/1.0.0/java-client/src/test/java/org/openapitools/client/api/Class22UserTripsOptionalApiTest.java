...
/**
 * API tests for Class22UserTripsOptionalApi
 */
@Disabled
public class Class22UserTripsOptionalApiTest {

    private final Class22UserTripsOptionalApi api = new Class22UserTripsOptionalApi();
     ...
     */
    @Test
    public void tripsTripDetails_0Test() throws ApiException {
        String trackToken = null;
        TripsTripDetails200Response response = api.tripsTripDetails_0(trackToken);
