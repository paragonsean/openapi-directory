...
/**
 * The UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner model module.
 * @module model/UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner
 * @version 1.0.0
 */
class UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner {
    /**
     * Constructs a new <code>UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner</code>.
     * @alias module:model/UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner
     */
    constructor() { 
        
        UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner} obj Optional instance to populate.
     * @return {module:model/UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner} The populated <code>UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner();
            ...
            if (data.hasOwnProperty('CalcDate')) {
                obj['CalcDate'] = ApiClient.convertToType(data['CalcDate'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['CalcDate'] && !(typeof data['CalcDate'] === 'string' || data['CalcDate'] instanceof String)) {
            throw new Error("Expected the field `CalcDate` to be a primitive type in the JSON string but got " + data['CalcDate']);
        }
        // ensure the json data is a string
 ...
 */
UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.prototype['AccelerationScore'] = undefined;

/**
 * @member {String} AppId
 */
UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.prototype['AppId'] = undefined;

/**
 * @member {Number} BrakingScore
 */
UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.prototype['BrakingScore'] = undefined;

/**
 * @member {String} CalcDate
 */
UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.prototype['CalcDate'] = undefined;

/**
 * @member {String} CompanyId
 */
UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.prototype['CompanyId'] = undefined;

/**
 * @member {Number} CorneringScore
 */
UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.prototype['CorneringScore'] = undefined;

/**
 * @member {String} DeviceToken
 */
UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.prototype['DeviceToken'] = undefined;

/**
 * @member {Number} DistractedScore
 */
UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.prototype['DistractedScore'] = undefined;

/**
 * @member {String} InstanceId
 */
UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.prototype['InstanceId'] = undefined;

/**
 * @member {Number} OverallScore
 */
UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.prototype['OverallScore'] = undefined;

/**
 * @member {Number} SpeedingScore
 */
UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.prototype['SpeedingScore'] = undefined;
...
export default UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner;
