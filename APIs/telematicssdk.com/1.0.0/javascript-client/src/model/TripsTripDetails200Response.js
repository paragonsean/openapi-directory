...
import TripsTripDetails200ResponseResult from './TripsTripDetails200ResponseResult';

/**
 * The TripsTripDetails200Response model module.
 * @module model/TripsTripDetails200Response
 * @version 1.0.0
 */
class TripsTripDetails200Response {
    /**
     * Constructs a new <code>TripsTripDetails200Response</code>.
     * @alias module:model/TripsTripDetails200Response
     */
    constructor() { 
        
        TripsTripDetails200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TripsTripDetails200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TripsTripDetails200Response} obj Optional instance to populate.
     * @return {module:model/TripsTripDetails200Response} The populated <code>TripsTripDetails200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TripsTripDetails200Response();

            if (data.hasOwnProperty('Result')) {
                obj['Result'] = TripsTripDetails200ResponseResult.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TripsTripDetails200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TripsTripDetails200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Result`
        if (data['Result']) { // data not null
          TripsTripDetails200ResponseResult.validateJSON(data['Result']);
        }
...
/**
 * @member {module:model/TripsTripDetails200ResponseResult} Result
 */
TripsTripDetails200Response.prototype['Result'] = undefined;
...
export default TripsTripDetails200Response;
