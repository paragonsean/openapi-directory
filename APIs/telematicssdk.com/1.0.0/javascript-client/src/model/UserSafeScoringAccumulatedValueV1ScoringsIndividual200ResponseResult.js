...
/**
 * The UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult model module.
 * @module model/UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult
 * @version 1.0.0
 */
class UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult {
    /**
     * Constructs a new <code>UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult</code>.
     * @alias module:model/UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult
     */
    constructor() { 
        
        UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult} obj Optional instance to populate.
     * @return {module:model/UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult} The populated <code>UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult();
    ...
    /**
     * Validates the JSON data with respect to <code>UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult</code>.
     */
 ...
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.prototype['AccelerationScore'] = undefined;

/**
 * @member {String} AppId
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.prototype['AppId'] = undefined;

/**
 * @member {Number} BrakingScore
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.prototype['BrakingScore'] = undefined;

/**
 * @member {String} CompanyId
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.prototype['CompanyId'] = undefined;

/**
 * @member {Number} CorneringScore
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.prototype['CorneringScore'] = undefined;

/**
 * @member {String} DeviceToken
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.prototype['DeviceToken'] = undefined;

/**
 * @member {Number} DistractedScore
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.prototype['DistractedScore'] = undefined;

/**
 * @member {String} InstanceId
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.prototype['InstanceId'] = undefined;

/**
 * @member {Number} OverallScore
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.prototype['OverallScore'] = undefined;

/**
 * @member {Number} SpeedingScore
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.prototype['SpeedingScore'] = undefined;
...
export default UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult;
