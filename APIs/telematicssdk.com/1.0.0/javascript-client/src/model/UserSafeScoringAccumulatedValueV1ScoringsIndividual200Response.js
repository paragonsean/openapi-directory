...
import UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult from './UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult';

/**
 * The UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response model module.
 * @module model/UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response
 * @version 1.0.0
 */
class UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response {
    /**
     * Constructs a new <code>UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response</code>.
     * @alias module:model/UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response
     */
    constructor() { 
        
        UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response} obj Optional instance to populate.
     * @return {module:model/UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response} The populated <code>UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response();

            if (data.hasOwnProperty('Errors')) {
                obj['Errors'] = ApiClient.convertToType(data['Errors'], [Object]);
            }
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.constructFromObject(data['Result']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult.validateJSON(data['Result']);
        }
 ...
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response.prototype['Errors'] = undefined;

/**
 * @member {module:model/UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult} Result
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response.prototype['Result'] = undefined;

/**
 * @member {Number} Status
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response.prototype['Status'] = undefined;

/**
 * @member {String} Title
 */
UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response.prototype['Title'] = undefined;
...
export default UserSafeScoringAccumulatedValueV1ScoringsIndividual200Response;
