...
import UserStatisticeDailyValueV1StatisticsIndividualDaily200ResponseResultInner from './UserStatisticeDailyValueV1StatisticsIndividualDaily200ResponseResultInner';

/**
 * The UserStatisticeDailyValueV1StatisticsIndividualDaily200Response model module.
 * @module model/UserStatisticeDailyValueV1StatisticsIndividualDaily200Response
 * @version 1.0.0
 */
class UserStatisticeDailyValueV1StatisticsIndividualDaily200Response {
    /**
     * Constructs a new <code>UserStatisticeDailyValueV1StatisticsIndividualDaily200Response</code>.
     * @alias module:model/UserStatisticeDailyValueV1StatisticsIndividualDaily200Response
     */
    constructor() { 
        
        UserStatisticeDailyValueV1StatisticsIndividualDaily200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserStatisticeDailyValueV1StatisticsIndividualDaily200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserStatisticeDailyValueV1StatisticsIndividualDaily200Response} obj Optional instance to populate.
     * @return {module:model/UserStatisticeDailyValueV1StatisticsIndividualDaily200Response} The populated <code>UserStatisticeDailyValueV1StatisticsIndividualDaily200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserStatisticeDailyValueV1StatisticsIndividualDaily200Response();

            if (data.hasOwnProperty('Errors')) {
                obj['Errors'] = ApiClient.convertToType(data['Errors'], [Object]);
            }
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [UserStatisticeDailyValueV1StatisticsIndividualDaily200ResponseResultInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UserStatisticeDailyValueV1StatisticsIndividualDaily200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserStatisticeDailyValueV1StatisticsIndividualDaily200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                UserStatisticeDailyValueV1StatisticsIndividualDaily200ResponseResultInner.validateJSON(item);
            };
        }
 ...
 */
UserStatisticeDailyValueV1StatisticsIndividualDaily200Response.prototype['Errors'] = undefined;

/**
 * @member {Array.<module:model/UserStatisticeDailyValueV1StatisticsIndividualDaily200ResponseResultInner>} Result
 */
UserStatisticeDailyValueV1StatisticsIndividualDaily200Response.prototype['Result'] = undefined;

/**
 * @member {Number} Status
 */
UserStatisticeDailyValueV1StatisticsIndividualDaily200Response.prototype['Status'] = undefined;

/**
 * @member {String} Title
 */
UserStatisticeDailyValueV1StatisticsIndividualDaily200Response.prototype['Title'] = undefined;
...
export default UserStatisticeDailyValueV1StatisticsIndividualDaily200Response;
