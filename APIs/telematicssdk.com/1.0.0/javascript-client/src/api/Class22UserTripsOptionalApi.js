...
/**
* Class22UserTripsOptional service.
* @module api/Class22UserTripsOptionalApi
* @version 1.0.0
*/
export default class Class22UserTripsOptionalApi {

    /**
    * Constructs a new Class22UserTripsOptionalApi. 
    * @alias module:api/Class22UserTripsOptionalApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the tripsTripDetails_0 operation.
     * @callback module:api/Class22UserTripsOptionalApi~tripsTripDetails_0Callback
     ...
     * @param {module:api/Class22UserTripsOptionalApi~tripsTripDetails_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TripsTripDetails200Response}
     */
    tripsTripDetails_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
