...
/**
* ConsolidatedSafeScoring service.
* @module api/ConsolidatedSafeScoringApi
* @version 1.0.0
*/
export default class ConsolidatedSafeScoringApi {

    /**
    * Constructs a new ConsolidatedSafeScoringApi. 
    * @alias module:api/ConsolidatedSafeScoringApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the v1ScoringsConsolidatedDaily_0 operation.
     * @callback module:api/ConsolidatedSafeScoringApi~v1ScoringsConsolidatedDaily_0Callback
     ...
     * @param {module:api/ConsolidatedSafeScoringApi~v1ScoringsConsolidatedDaily_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1ScoringsConsolidatedDaily200Response}
     */
    v1ScoringsConsolidatedDaily_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the v1ScoringsConsolidated_0 operation.
     * @callback module:api/ConsolidatedSafeScoringApi~v1ScoringsConsolidated_0Callback
     * @param {String} error Error message, if any.
     ...
     * @param {String} [appId] 
     * @param {String} [companyId] 
     * @param {module:api/ConsolidatedSafeScoringApi~v1ScoringsConsolidated_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    v1ScoringsConsolidated_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
