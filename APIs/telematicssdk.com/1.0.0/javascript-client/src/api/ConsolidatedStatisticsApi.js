...
/**
* ConsolidatedStatistics service.
* @module api/ConsolidatedStatisticsApi
* @version 1.0.0
*/
export default class ConsolidatedStatisticsApi {

    /**
    * Constructs a new ConsolidatedStatisticsApi. 
    * @alias module:api/ConsolidatedStatisticsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the v1StatisticsConsolidatedDaily_0 operation.
     * @callback module:api/ConsolidatedStatisticsApi~v1StatisticsConsolidatedDaily_0Callback
     ...
     * @param {module:api/ConsolidatedStatisticsApi~v1StatisticsConsolidatedDaily_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    v1StatisticsConsolidatedDaily_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the v1StatisticsConsolidated_0 operation.
     * @callback module:api/ConsolidatedStatisticsApi~v1StatisticsConsolidated_0Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [appId] 
     * @param {String} [companyId] 
     * @param {module:api/ConsolidatedStatisticsApi~v1StatisticsConsolidated_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    v1StatisticsConsolidated_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
