...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackPointsInner();
  });
  ...
  describe('TripsTripDetails200ResponseResultTrackPointsInner', function() {
    it('should create an instance of TripsTripDetails200ResponseResultTrackPointsInner', function() {
      // uncomment below and update the code to test TripsTripDetails200ResponseResultTrackPointsInner
      //var instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackPointsInner();
      //expect(instance).to.be.a(QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackPointsInner);
    });
    ...
    it('should have the property alertValue (base name: "AlertValue")', function() {
      // uncomment below and update the code to test the property alertValue
      //var instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackPointsInner();
      //expect(instance).to.be();
    });

    it('should have the property cornering (base name: "Cornering")', function() {
      // uncomment below and update the code to test the property cornering
      //var instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackPointsInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property lateral (base name: "Lateral")', function() {
      // uncomment below and update the code to test the property lateral
      //var instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackPointsInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property midSpeed (base name: "MidSpeed")', function() {
      // uncomment below and update the code to test the property midSpeed
      //var instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackPointsInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pointDate (base name: "PointDate")', function() {
      // uncomment below and update the code to test the property pointDate
      //var instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackPointsInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property speedLimit (base name: "SpeedLimit")', function() {
      // uncomment below and update the code to test the property speedLimit
      //var instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackPointsInner();
      //expect(instance).to.be();
    });

    it('should have the property speedType (base name: "SpeedType")', function() {
      // uncomment below and update the code to test the property speedType
      //var instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackPointsInner();
      //expect(instance).to.be();
    });

    it('should have the property totalMeters (base name: "TotalMeters")', function() {
      // uncomment below and update the code to test the property totalMeters
      //var instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackPointsInner();
      //expect(instance).to.be();
    });
