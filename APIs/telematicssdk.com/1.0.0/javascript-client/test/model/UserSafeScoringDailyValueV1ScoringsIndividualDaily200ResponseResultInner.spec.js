...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner();
  });
  ...
  describe('UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner', function() {
    it('should create an instance of UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner', function() {
      // uncomment below and update the code to test UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner
      //var instance = new QuickStartTelematicsSdk.UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner();
      //expect(instance).to.be.a(QuickStartTelematicsSdk.UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner);
    });
    ...
    it('should have the property calcDate (base name: "CalcDate")', function() {
      // uncomment below and update the code to test the property calcDate
      //var instance = new QuickStartTelematicsSdk.UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner();
      //expect(instance).to.be();
    });
