...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.TripsTripDetails200Response();
  });
  ...
  describe('TripsTripDetails200Response', function() {
    it('should create an instance of TripsTripDetails200Response', function() {
      // uncomment below and update the code to test TripsTripDetails200Response
      //var instance = new QuickStartTelematicsSdk.TripsTripDetails200Response();
      //expect(instance).to.be.a(QuickStartTelematicsSdk.TripsTripDetails200Response);
    });
