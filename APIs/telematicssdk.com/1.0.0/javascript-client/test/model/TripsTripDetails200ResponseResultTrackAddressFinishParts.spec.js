...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackAddressFinishParts();
  });
  ...
  describe('TripsTripDetails200ResponseResultTrackAddressFinishParts', function() {
    it('should create an instance of TripsTripDetails200ResponseResultTrackAddressFinishParts', function() {
      // uncomment below and update the code to test TripsTripDetails200ResponseResultTrackAddressFinishParts
      //var instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackAddressFinishParts();
      //expect(instance).to.be.a(QuickStartTelematicsSdk.TripsTripDetails200ResponseResultTrackAddressFinishParts);
    });
