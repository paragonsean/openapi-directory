...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult();
  });
  ...
  describe('UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult', function() {
    it('should create an instance of UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult', function() {
      // uncomment below and update the code to test UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult
      //var instance = new QuickStartTelematicsSdk.UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult();
      //expect(instance).to.be.a(QuickStartTelematicsSdk.UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult);
    });
