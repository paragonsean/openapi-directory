...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.UserStatisticsAccumulatedValueV1StatisticsIndividual200ResponseResult();
  });
  ...
  describe('UserStatisticsAccumulatedValueV1StatisticsIndividual200ResponseResult', function() {
    it('should create an instance of UserStatisticsAccumulatedValueV1StatisticsIndividual200ResponseResult', function() {
      // uncomment below and update the code to test UserStatisticsAccumulatedValueV1StatisticsIndividual200ResponseResult
      //var instance = new QuickStartTelematicsSdk.UserStatisticsAccumulatedValueV1StatisticsIndividual200ResponseResult();
      //expect(instance).to.be.a(QuickStartTelematicsSdk.UserStatisticsAccumulatedValueV1StatisticsIndividual200ResponseResult);
    });
