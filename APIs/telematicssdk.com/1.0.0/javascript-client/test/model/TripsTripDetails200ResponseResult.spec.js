...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResult();
  });
  ...
  describe('TripsTripDetails200ResponseResult', function() {
    it('should create an instance of TripsTripDetails200ResponseResult', function() {
      // uncomment below and update the code to test TripsTripDetails200ResponseResult
      //var instance = new QuickStartTelematicsSdk.TripsTripDetails200ResponseResult();
      //expect(instance).to.be.a(QuickStartTelematicsSdk.TripsTripDetails200ResponseResult);
    });
