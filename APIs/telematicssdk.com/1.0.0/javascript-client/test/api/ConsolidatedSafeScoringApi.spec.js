...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.ConsolidatedSafeScoringApi();
  });
  ...
  describe('ConsolidatedSafeScoringApi', function() {
    describe('v1ScoringsConsolidatedDaily_0', function() {
      it('should call v1ScoringsConsolidatedDaily_0 successfully', function(done) {
        //uncomment below and update the code to test v1ScoringsConsolidatedDaily_0
        //instance.v1ScoringsConsolidatedDaily_0(function(error) {
    ...
    describe('v1ScoringsConsolidated_0', function() {
      it('should call v1ScoringsConsolidated_0 successfully', function(done) {
        //uncomment below and update the code to test v1ScoringsConsolidated_0
        //instance.v1ScoringsConsolidated_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
