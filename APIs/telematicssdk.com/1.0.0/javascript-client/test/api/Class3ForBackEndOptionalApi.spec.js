...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.Class3ForBackEndOptionalApi();
  });
  ...
  describe('Class3ForBackEndOptionalApi', function() {
    describe('v1ScoringsConsolidated', function() {
      it('should call v1ScoringsConsolidated successfully', function(done) {
        //uncomment below and update the code to test v1ScoringsConsolidated
        //instance.v1ScoringsConsolidated(function(error) {
    ...
    describe('v1ScoringsConsolidatedDaily', function() {
      it('should call v1ScoringsConsolidatedDaily successfully', function(done) {
        //uncomment below and update the code to test v1ScoringsConsolidatedDaily
        //instance.v1ScoringsConsolidatedDaily(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('v1StatisticsConsolidated', function() {
      it('should call v1StatisticsConsolidated successfully', function(done) {
        //uncomment below and update the code to test v1StatisticsConsolidated
        //instance.v1StatisticsConsolidated(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('v1StatisticsConsolidatedDaily', function() {
      it('should call v1StatisticsConsolidatedDaily successfully', function(done) {
        //uncomment below and update the code to test v1StatisticsConsolidatedDaily
        //instance.v1StatisticsConsolidatedDaily(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
