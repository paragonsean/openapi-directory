...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.Class24UserSafeScoringOptionalApi();
  });
  ...
  describe('Class24UserSafeScoringOptionalApi', function() {
    describe('userSafeScoringAccumulatedValueV1ScoringsIndividual_0', function() {
      it('should call userSafeScoringAccumulatedValueV1ScoringsIndividual_0 successfully', function(done) {
        //uncomment below and update the code to test userSafeScoringAccumulatedValueV1ScoringsIndividual_0
        //instance.userSafeScoringAccumulatedValueV1ScoringsIndividual_0(function(error) {
    ...
    describe('userSafeScoringDailyValueV1ScoringsIndividualDaily_0', function() {
      it('should call userSafeScoringDailyValueV1ScoringsIndividualDaily_0 successfully', function(done) {
        //uncomment below and update the code to test userSafeScoringDailyValueV1ScoringsIndividualDaily_0
        //instance.userSafeScoringDailyValueV1ScoringsIndividualDaily_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
