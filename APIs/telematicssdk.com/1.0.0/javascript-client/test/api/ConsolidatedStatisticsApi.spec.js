...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.ConsolidatedStatisticsApi();
  });
  ...
  describe('ConsolidatedStatisticsApi', function() {
    describe('v1StatisticsConsolidatedDaily_0', function() {
      it('should call v1StatisticsConsolidatedDaily_0 successfully', function(done) {
        //uncomment below and update the code to test v1StatisticsConsolidatedDaily_0
        //instance.v1StatisticsConsolidatedDaily_0(function(error) {
    ...
    describe('v1StatisticsConsolidated_0', function() {
      it('should call v1StatisticsConsolidated_0 successfully', function(done) {
        //uncomment below and update the code to test v1StatisticsConsolidated_0
        //instance.v1StatisticsConsolidated_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
