...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.Class2ForMobileAppOptionalApi();
  });
  ...
  describe('Class2ForMobileAppOptionalApi', function() {
    describe('tripsTripDetails', function() {
      it('should call tripsTripDetails successfully', function(done) {
        //uncomment below and update the code to test tripsTripDetails
        //instance.tripsTripDetails(function(error) {
    ...
    describe('userSafeScoringAccumulatedValueV1ScoringsIndividual', function() {
      it('should call userSafeScoringAccumulatedValueV1ScoringsIndividual successfully', function(done) {
        //uncomment below and update the code to test userSafeScoringAccumulatedValueV1ScoringsIndividual
        //instance.userSafeScoringAccumulatedValueV1ScoringsIndividual(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('userSafeScoringDailyValueV1ScoringsIndividualDaily', function() {
      it('should call userSafeScoringDailyValueV1ScoringsIndividualDaily successfully', function(done) {
        //uncomment below and update the code to test userSafeScoringDailyValueV1ScoringsIndividualDaily
        //instance.userSafeScoringDailyValueV1ScoringsIndividualDaily(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('userStatisticeDailyValueV1StatisticsIndividualDaily', function() {
      it('should call userStatisticeDailyValueV1StatisticsIndividualDaily successfully', function(done) {
        //uncomment below and update the code to test userStatisticeDailyValueV1StatisticsIndividualDaily
        //instance.userStatisticeDailyValueV1StatisticsIndividualDaily(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('userStatisticsAccumulatedValueV1StatisticsIndividual', function() {
      it('should call userStatisticsAccumulatedValueV1StatisticsIndividual successfully', function(done) {
        //uncomment below and update the code to test userStatisticsAccumulatedValueV1StatisticsIndividual
        //instance.userStatisticsAccumulatedValueV1StatisticsIndividual(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
