...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickStartTelematicsSdk.Class22UserTripsOptionalApi();
  });
  ...
  describe('Class22UserTripsOptionalApi', function() {
    describe('tripsTripDetails_0', function() {
      it('should call tripsTripDetails_0 successfully', function(done) {
        //uncomment below and update the code to test tripsTripDetails_0
        //instance.tripsTripDetails_0(function(error) {
