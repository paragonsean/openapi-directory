...
#include "OAIClass24UserSafeScoringOptionalApi.h"
...
OAIClass24UserSafeScoringOptionalApi::OAIClass24UserSafeScoringOptionalApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIClass24UserSafeScoringOptionalApi::~OAIClass24UserSafeScoringOptionalApi() {
}

void OAIClass24UserSafeScoringOptionalApi::initializeServerConfigs() {
    //Default server
...
*/
int OAIClass24UserSafeScoringOptionalApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIClass24UserSafeScoringOptionalApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIClass24UserSafeScoringOptionalApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIClass24UserSafeScoringOptionalApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIClass24UserSafeScoringOptionalApi::setUsername(const QString &username) {
    _username = username;
}

void OAIClass24UserSafeScoringOptionalApi::setPassword(const QString &password) {
    _password = password;
}


void OAIClass24UserSafeScoringOptionalApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIClass24UserSafeScoringOptionalApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIClass24UserSafeScoringOptionalApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIClass24UserSafeScoringOptionalApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIClass24UserSafeScoringOptionalApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIClass24UserSafeScoringOptionalApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIClass24UserSafeScoringOptionalApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIClass24UserSafeScoringOptionalApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIClass24UserSafeScoringOptionalApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIClass24UserSafeScoringOptionalApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIClass24UserSafeScoringOptionalApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIClass24UserSafeScoringOptionalApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIClass24UserSafeScoringOptionalApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIClass24UserSafeScoringOptionalApi::userSafeScoringAccumulatedValueV1_scorings_individual(const ::OpenAPI::OptionalParam<QString> &start_date, const ::OpenAPI::OptionalParam<QString> &end_date) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIClass24UserSafeScoringOptionalApi::userSafeScoringAccumulatedValueV1_scorings_individualCallback);
    connect(this, &OAIClass24UserSafeScoringOptionalApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIClass24UserSafeScoringOptionalApi::userSafeScoringAccumulatedValueV1_scorings_individualCallback(OAIHttpRequestWorker *worker) {
...
void OAIClass24UserSafeScoringOptionalApi::userSafeScoringDailyValue_v1_scorings_individual_daily(const ::OpenAPI::OptionalParam<QString> &tag, const ::OpenAPI::OptionalParam<QString> &start_date, const ::OpenAPI::OptionalParam<QString> &end_date) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIClass24UserSafeScoringOptionalApi::userSafeScoringDailyValue_v1_scorings_individual_dailyCallback);
    connect(this, &OAIClass24UserSafeScoringOptionalApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIClass24UserSafeScoringOptionalApi::userSafeScoringDailyValue_v1_scorings_individual_dailyCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIClass24UserSafeScoringOptionalApi::tokenAvailable(){
