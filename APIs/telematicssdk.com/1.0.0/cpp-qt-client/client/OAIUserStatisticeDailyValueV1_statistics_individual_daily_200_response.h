...
/*
 * OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response.h
 *
 * 
 */

#ifndef OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response_H
#define OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response_H
...
namespace OpenAPI {
class OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response_Result_inner;

class OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response : public OAIObject {
public:
    OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response();
    OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response(QString json);
    ~OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response() override;
    ...
    QList<OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response_Result_inner> getResult() const;
    void setResult(const QList<OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response_Result_inner> &result);
...
private:
    ...
    QList<OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response_Result_inner> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response)

#endif // OAIUserStatisticeDailyValueV1_statistics_individual_daily_200_response_H
