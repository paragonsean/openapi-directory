...
#include "OAIClass22UserTripsOptionalApi.h"
...
OAIClass22UserTripsOptionalApi::OAIClass22UserTripsOptionalApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIClass22UserTripsOptionalApi::~OAIClass22UserTripsOptionalApi() {
}

void OAIClass22UserTripsOptionalApi::initializeServerConfigs() {
    //Default server
...
*/
int OAIClass22UserTripsOptionalApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIClass22UserTripsOptionalApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIClass22UserTripsOptionalApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIClass22UserTripsOptionalApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIClass22UserTripsOptionalApi::setUsername(const QString &username) {
    _username = username;
}

void OAIClass22UserTripsOptionalApi::setPassword(const QString &password) {
    _password = password;
}


void OAIClass22UserTripsOptionalApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIClass22UserTripsOptionalApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIClass22UserTripsOptionalApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIClass22UserTripsOptionalApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIClass22UserTripsOptionalApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIClass22UserTripsOptionalApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIClass22UserTripsOptionalApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIClass22UserTripsOptionalApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIClass22UserTripsOptionalApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIClass22UserTripsOptionalApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIClass22UserTripsOptionalApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIClass22UserTripsOptionalApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIClass22UserTripsOptionalApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIClass22UserTripsOptionalApi::tripsTripDetails(const ::OpenAPI::OptionalParam<QString> &track_token) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIClass22UserTripsOptionalApi::tripsTripDetailsCallback);
    connect(this, &OAIClass22UserTripsOptionalApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIClass22UserTripsOptionalApi::tripsTripDetailsCallback(OAIHttpRequestWorker *worker) {
...
void OAIClass22UserTripsOptionalApi::tokenAvailable(){
