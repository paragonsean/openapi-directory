...
#ifndef OAI_OAIClass3ForBackEndOptionalApi_H
#define OAI_OAIClass3ForBackEndOptionalApi_H
...
class OAIClass3ForBackEndOptionalApi : public QObject {
    Q_OBJECT

public:
    OAIClass3ForBackEndOptionalApi(const int timeOut = 0);
    ~OAIClass3ForBackEndOptionalApi();
    ...
    * @param[in]  company_id QString [optional]
    */
    virtual void _v1_statistics_consolidated(const ::OpenAPI::OptionalParam<QString> &device_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &start_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &end_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &tag = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &instance_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &app_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &company_id = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  company_id QString [optional]
    */
    virtual void _v1_statistics_consolidated_daily(const ::OpenAPI::OptionalParam<QString> &device_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &start_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &end_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &tag = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &instance_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &app_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &company_id = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void _v1_statistics_consolidatedCallback(OAIHttpRequestWorker *worker);
    void _v1_statistics_consolidated_dailyCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void _v1_statistics_consolidatedSignal();
    void _v1_statistics_consolidated_dailySignal();
    ...
    void _v1_statistics_consolidatedSignalFull(OAIHttpRequestWorker *worker);
    void _v1_statistics_consolidated_dailySignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use _v1_statistics_consolidatedSignalError() instead")
    void _v1_statistics_consolidatedSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void _v1_statistics_consolidatedSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use _v1_statistics_consolidated_dailySignalError() instead")
    void _v1_statistics_consolidated_dailySignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void _v1_statistics_consolidated_dailySignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use _v1_statistics_consolidatedSignalErrorFull() instead")
    void _v1_statistics_consolidatedSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void _v1_statistics_consolidatedSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use _v1_statistics_consolidated_dailySignalErrorFull() instead")
    void _v1_statistics_consolidated_dailySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void _v1_statistics_consolidated_dailySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
