...
/*
 * OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response.h
 *
 * 
 */

#ifndef OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response_H
#define OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response_H
...
namespace OpenAPI {
class OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response_Result;

class OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response : public OAIObject {
public:
    OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response();
    OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response(QString json);
    ~OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response() override;
    ...
    OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response_Result getResult() const;
    void setResult(const OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response_Result &result);
...
private:
    ...
    OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response)

#endif // OAIUserStatisticsAccumulatedValue_v1_statistics_individual_200_response_H
