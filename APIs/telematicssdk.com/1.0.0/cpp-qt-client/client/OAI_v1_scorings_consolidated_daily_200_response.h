...
/*
 * OAI_v1_scorings_consolidated_daily_200_response.h
 *
 * 
 */

#ifndef OAI_v1_scorings_consolidated_daily_200_response_H
#define OAI_v1_scorings_consolidated_daily_200_response_H
...
namespace OpenAPI {
class OAI_v1_scorings_consolidated_daily_200_response_Result_inner;

class OAI_v1_scorings_consolidated_daily_200_response : public OAIObject {
public:
    OAI_v1_scorings_consolidated_daily_200_response();
    OAI_v1_scorings_consolidated_daily_200_response(QString json);
    ~OAI_v1_scorings_consolidated_daily_200_response() override;
    ...
    QList<OAI_v1_scorings_consolidated_daily_200_response_Result_inner> getResult() const;
    void setResult(const QList<OAI_v1_scorings_consolidated_daily_200_response_Result_inner> &result);
...
private:
    ...
    QList<OAI_v1_scorings_consolidated_daily_200_response_Result_inner> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_v1_scorings_consolidated_daily_200_response)

#endif // OAI_v1_scorings_consolidated_daily_200_response_H
