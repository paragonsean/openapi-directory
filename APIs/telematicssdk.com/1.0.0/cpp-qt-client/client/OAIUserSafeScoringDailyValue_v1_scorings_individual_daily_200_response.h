...
/*
 * OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response.h
 *
 * 
 */

#ifndef OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_H
#define OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_H
...
namespace OpenAPI {
class OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner;

class OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response : public OAIObject {
public:
    OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response();
    OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response(QString json);
    ~OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response() override;
    ...
    QList<OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner> getResult() const;
    void setResult(const QList<OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner> &result);
...
private:
    ...
    QList<OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response)

#endif // OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_H
