...
/*
 * OAITripsTripDetails_200_response.h
 *
 * 
 */

#ifndef OAITripsTripDetails_200_response_H
#define OAITripsTripDetails_200_response_H
...
namespace OpenAPI {
class OAITripsTripDetails_200_response_Result;

class OAITripsTripDetails_200_response : public OAIObject {
public:
    OAITripsTripDetails_200_response();
    OAITripsTripDetails_200_response(QString json);
    ~OAITripsTripDetails_200_response() override;
    ...
    OAITripsTripDetails_200_response_Result getResult() const;
    void setResult(const OAITripsTripDetails_200_response_Result &result);
...
private:
    ...
    OAITripsTripDetails_200_response_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITripsTripDetails_200_response)

#endif // OAITripsTripDetails_200_response_H
