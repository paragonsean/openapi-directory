...
/*
 * OAITripsTripDetails_200_response_Result.h
 *
 * 
 */

#ifndef OAITripsTripDetails_200_response_Result_H
#define OAITripsTripDetails_200_response_Result_H
...
namespace OpenAPI {
class OAITripsTripDetails_200_response_Result_Track;

class OAITripsTripDetails_200_response_Result : public OAIObject {
public:
    OAITripsTripDetails_200_response_Result();
    OAITripsTripDetails_200_response_Result(QString json);
    ~OAITripsTripDetails_200_response_Result() override;
    ...
    OAITripsTripDetails_200_response_Result_Track getTrack() const;
    void setTrack(const OAITripsTripDetails_200_response_Result_Track &track);
...
private:
    ...
    OAITripsTripDetails_200_response_Result_Track m_track;
    bool m_track_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITripsTripDetails_200_response_Result)

#endif // OAITripsTripDetails_200_response_Result_H
