...
#ifndef OAI_OAIConsolidatedStatisticsApi_H
#define OAI_OAIConsolidatedStatisticsApi_H
...
class OAIConsolidatedStatisticsApi : public QObject {
    Q_OBJECT

public:
    OAIConsolidatedStatisticsApi(const int timeOut = 0);
    ~OAIConsolidatedStatisticsApi();
