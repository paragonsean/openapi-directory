...
/*
 * OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner.h
 *
 * 
 */

#ifndef OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner_H
#define OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner_H
...
class OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner : public OAIObject {
public:
    OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner();
    OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner(QString json);
    ~OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner() override;
    ...
    QString getCalcDate() const;
    void setCalcDate(const QString &calc_date);
    bool is_calc_date_Set() const;
    bool is_calc_date_Valid() const;
...
private:
    ...
    QString m_calc_date;
    bool m_calc_date_isSet;
    bool m_calc_date_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner)

#endif // OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response_Result_inner_H
