...
OAI_v1_scorings_consolidated_daily_200_response::OAI_v1_scorings_consolidated_daily_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_v1_scorings_consolidated_daily_200_response::OAI_v1_scorings_consolidated_daily_200_response() {
    this->initializeModel();
}

OAI_v1_scorings_consolidated_daily_200_response::~OAI_v1_scorings_consolidated_daily_200_response() {}

void OAI_v1_scorings_consolidated_daily_200_response::initializeModel() {
...
void OAI_v1_scorings_consolidated_daily_200_response::fromJson(QString jsonString) {
...
void OAI_v1_scorings_consolidated_daily_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_v1_scorings_consolidated_daily_200_response::asJson() const {
...
QJsonObject OAI_v1_scorings_consolidated_daily_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<QJsonValue> OAI_v1_scorings_consolidated_daily_200_response::getErrors() const {
    return m_errors;
}
void OAI_v1_scorings_consolidated_daily_200_response::setErrors(const QList<QJsonValue> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAI_v1_scorings_consolidated_daily_200_response::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAI_v1_scorings_consolidated_daily_200_response::is_errors_Valid() const{
    return m_errors_isValid;
}

QList<OAI_v1_scorings_consolidated_daily_200_response_Result_inner> OAI_v1_scorings_consolidated_daily_200_response::getResult() const {
    return m_result;
}
void OAI_v1_scorings_consolidated_daily_200_response::setResult(const QList<OAI_v1_scorings_consolidated_daily_200_response_Result_inner> &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAI_v1_scorings_consolidated_daily_200_response::is_result_Set() const{
    return m_result_isSet;
}

bool OAI_v1_scorings_consolidated_daily_200_response::is_result_Valid() const{
    return m_result_isValid;
}

double OAI_v1_scorings_consolidated_daily_200_response::getStatus() const {
    return m_status;
}
void OAI_v1_scorings_consolidated_daily_200_response::setStatus(const double &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAI_v1_scorings_consolidated_daily_200_response::is_status_Set() const{
    return m_status_isSet;
}

bool OAI_v1_scorings_consolidated_daily_200_response::is_status_Valid() const{
    return m_status_isValid;
}

QString OAI_v1_scorings_consolidated_daily_200_response::getTitle() const {
    return m_title;
}
void OAI_v1_scorings_consolidated_daily_200_response::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAI_v1_scorings_consolidated_daily_200_response::is_title_Set() const{
    return m_title_isSet;
}

bool OAI_v1_scorings_consolidated_daily_200_response::is_title_Valid() const{
    return m_title_isValid;
}

bool OAI_v1_scorings_consolidated_daily_200_response::isSet() const {
...
bool OAI_v1_scorings_consolidated_daily_200_response::isValid() const {
