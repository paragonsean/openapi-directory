...
#ifndef OAI_OAIClass2ForMobileAppOptionalApi_H
#define OAI_OAIClass2ForMobileAppOptionalApi_H
...
#include "OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response.h"
...
class OAIClass2ForMobileAppOptionalApi : public QObject {
    Q_OBJECT

public:
    OAIClass2ForMobileAppOptionalApi(const int timeOut = 0);
    ~OAIClass2ForMobileAppOptionalApi();
    ...
    */
    virtual void userSafeScoringAccumulatedValueV1_scorings_individual(const ::OpenAPI::OptionalParam<QString> &start_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &end_date = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  end_date QString [optional]
    */
    virtual void userSafeScoringDailyValue_v1_scorings_individual_daily(const ::OpenAPI::OptionalParam<QString> &tag = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &start_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &end_date = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void userSafeScoringAccumulatedValueV1_scorings_individualCallback(OAIHttpRequestWorker *worker);
    void userSafeScoringDailyValue_v1_scorings_individual_dailyCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void userSafeScoringAccumulatedValueV1_scorings_individualSignal(OAIUserSafeScoringAccumulatedValueV1_scorings_individual_200_response summary);
    void userSafeScoringDailyValue_v1_scorings_individual_dailySignal(OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response summary);
    ...
    void userSafeScoringAccumulatedValueV1_scorings_individualSignalFull(OAIHttpRequestWorker *worker, OAIUserSafeScoringAccumulatedValueV1_scorings_individual_200_response summary);
    void userSafeScoringDailyValue_v1_scorings_individual_dailySignalFull(OAIHttpRequestWorker *worker, OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response summary);
    ...
    Q_DECL_DEPRECATED_X("Use userSafeScoringAccumulatedValueV1_scorings_individualSignalError() instead")
    void userSafeScoringAccumulatedValueV1_scorings_individualSignalE(OAIUserSafeScoringAccumulatedValueV1_scorings_individual_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void userSafeScoringAccumulatedValueV1_scorings_individualSignalError(OAIUserSafeScoringAccumulatedValueV1_scorings_individual_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use userSafeScoringDailyValue_v1_scorings_individual_dailySignalError() instead")
    void userSafeScoringDailyValue_v1_scorings_individual_dailySignalE(OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void userSafeScoringDailyValue_v1_scorings_individual_dailySignalError(OAIUserSafeScoringDailyValue_v1_scorings_individual_daily_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use userSafeScoringAccumulatedValueV1_scorings_individualSignalErrorFull() instead")
    void userSafeScoringAccumulatedValueV1_scorings_individualSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void userSafeScoringAccumulatedValueV1_scorings_individualSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use userSafeScoringDailyValue_v1_scorings_individual_dailySignalErrorFull() instead")
    void userSafeScoringDailyValue_v1_scorings_individual_dailySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void userSafeScoringDailyValue_v1_scorings_individual_dailySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
