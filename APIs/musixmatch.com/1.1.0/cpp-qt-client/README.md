...
void Example::exampleFunction1(){
     OAIAlbumApi apiInstance;
     
      // Configure API key authorization: key
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAIAlbumApi::albumGetGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAlbumApi::albumGetGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString album_id = create(); // QString | The musiXmatch album id
      ...
      QString format = create(); // QString | output format: json, jsonp, xml.
      ...
      QString callback = create(); // QString | jsonp callback
      apiInstance.albumGetGet(album_idformatcallback);
