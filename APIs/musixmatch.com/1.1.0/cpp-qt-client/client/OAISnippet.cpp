...
void OAISnippet::initializeModel() {
    ...
    m_snippet_body_isSet = false;
    m_snippet_body_isValid = false;

    m_snippet_id_isSet = false;
    m_snippet_id_isValid = false;

    m_snippet_language_isSet = false;
    m_snippet_language_isValid = false;
...
void OAISnippet::fromJsonObject(QJsonObject json) {
    ...
    m_snippet_body_isValid = ::OpenAPI::fromJsonValue(m_snippet_body, json[QString("snippet_body")]);
    m_snippet_body_isSet = !json[QString("snippet_body")].isNull() && m_snippet_body_isValid;

    m_snippet_id_isValid = ::OpenAPI::fromJsonValue(m_snippet_id, json[QString("snippet_id")]);
    m_snippet_id_isSet = !json[QString("snippet_id")].isNull() && m_snippet_id_isValid;

    m_snippet_language_isValid = ::OpenAPI::fromJsonValue(m_snippet_language, json[QString("snippet_language")]);
    m_snippet_language_isSet = !json[QString("snippet_language")].isNull() && m_snippet_language_isValid;
...
QJsonObject OAISnippet::asJsonObject() const {
    ...
    if (m_snippet_body_isSet) {
        obj.insert(QString("snippet_body"), ::OpenAPI::toJsonValue(m_snippet_body));
    }
    if (m_snippet_id_isSet) {
        obj.insert(QString("snippet_id"), ::OpenAPI::toJsonValue(m_snippet_id));
    }
    if (m_snippet_language_isSet) {
        obj.insert(QString("snippet_language"), ::OpenAPI::toJsonValue(m_snippet_language));
    }
...
QString OAISnippet::getHtmlTrackingUrl() const {
    return m_html_tracking_url;
}
void OAISnippet::setHtmlTrackingUrl(const QString &html_tracking_url) {
    m_html_tracking_url = html_tracking_url;
    m_html_tracking_url_isSet = true;
}

bool OAISnippet::is_html_tracking_url_Set() const{
    return m_html_tracking_url_isSet;
}

bool OAISnippet::is_html_tracking_url_Valid() const{
    return m_html_tracking_url_isValid;
}

double OAISnippet::getInstrumental() const {
    return m_instrumental;
}
void OAISnippet::setInstrumental(const double &instrumental) {
    m_instrumental = instrumental;
    m_instrumental_isSet = true;
}

bool OAISnippet::is_instrumental_Set() const{
    return m_instrumental_isSet;
}

bool OAISnippet::is_instrumental_Valid() const{
    return m_instrumental_isValid;
}

QString OAISnippet::getPixelTrackingUrl() const {
    return m_pixel_tracking_url;
}
void OAISnippet::setPixelTrackingUrl(const QString &pixel_tracking_url) {
    m_pixel_tracking_url = pixel_tracking_url;
    m_pixel_tracking_url_isSet = true;
}

bool OAISnippet::is_pixel_tracking_url_Set() const{
    return m_pixel_tracking_url_isSet;
}

bool OAISnippet::is_pixel_tracking_url_Valid() const{
    return m_pixel_tracking_url_isValid;
}

double OAISnippet::getRestricted() const {
    return m_restricted;
}
void OAISnippet::setRestricted(const double &restricted) {
    m_restricted = restricted;
    m_restricted_isSet = true;
}

bool OAISnippet::is_restricted_Set() const{
    return m_restricted_isSet;
}

bool OAISnippet::is_restricted_Valid() const{
    return m_restricted_isValid;
}

QString OAISnippet::getScriptTrackingUrl() const {
    return m_script_tracking_url;
}
void OAISnippet::setScriptTrackingUrl(const QString &script_tracking_url) {
    m_script_tracking_url = script_tracking_url;
    m_script_tracking_url_isSet = true;
}

bool OAISnippet::is_script_tracking_url_Set() const{
    return m_script_tracking_url_isSet;
}

bool OAISnippet::is_script_tracking_url_Valid() const{
    return m_script_tracking_url_isValid;
}

QString OAISnippet::getSnippetBody() const {
    return m_snippet_body;
}
void OAISnippet::setSnippetBody(const QString &snippet_body) {
    m_snippet_body = snippet_body;
    m_snippet_body_isSet = true;
}

bool OAISnippet::is_snippet_body_Set() const{
    return m_snippet_body_isSet;
}

bool OAISnippet::is_snippet_body_Valid() const{
    return m_snippet_body_isValid;
}

double OAISnippet::getSnippetId() const {
    return m_snippet_id;
}
void OAISnippet::setSnippetId(const double &snippet_id) {
    m_snippet_id = snippet_id;
    m_snippet_id_isSet = true;
}

bool OAISnippet::is_snippet_id_Set() const{
    return m_snippet_id_isSet;
}

bool OAISnippet::is_snippet_id_Valid() const{
    return m_snippet_id_isValid;
}

QString OAISnippet::getSnippetLanguage() const {
    return m_snippet_language;
}
void OAISnippet::setSnippetLanguage(const QString &snippet_language) {
    m_snippet_language = snippet_language;
    m_snippet_language_isSet = true;
}

bool OAISnippet::is_snippet_language_Set() const{
    return m_snippet_language_isSet;
}

bool OAISnippet::is_snippet_language_Valid() const{
    return m_snippet_language_isValid;
}

QString OAISnippet::getUpdatedTime() const {
    return m_updated_time;
}
void OAISnippet::setUpdatedTime(const QString &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAISnippet::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAISnippet::is_updated_time_Valid() const{
