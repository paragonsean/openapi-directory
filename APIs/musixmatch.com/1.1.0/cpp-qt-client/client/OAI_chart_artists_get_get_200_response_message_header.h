...
/*
 * OAI_chart_artists_get_get_200_response_message_header.h
 *
 * 
 */

#ifndef OAI_chart_artists_get_get_200_response_message_header_H
#define OAI_chart_artists_get_get_200_response_message_header_H
...
class OAI_chart_artists_get_get_200_response_message_header : public OAIObject {
public:
    OAI_chart_artists_get_get_200_response_message_header();
    OAI_chart_artists_get_get_200_response_message_header(QString json);
    ~OAI_chart_artists_get_get_200_response_message_header() override;
    ...
    void setExecuteTime(const double &execute_time);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_chart_artists_get_get_200_response_message_header)

#endif // OAI_chart_artists_get_get_200_response_message_header_H
