...
public:
    ...
    QString getSubtitleBody() const;
    void setSubtitleBody(const QString &subtitle_body);
    bool is_subtitle_body_Set() const;
    bool is_subtitle_body_Valid() const;
    ...
    QString getSubtitleLanguage() const;
    void setSubtitleLanguage(const QString &subtitle_language);
    bool is_subtitle_language_Set() const;
    bool is_subtitle_language_Valid() const;

    QString getSubtitleLanguageDescription() const;
    void setSubtitleLanguageDescription(const QString &subtitle_language_description);
    bool is_subtitle_language_description_Set() const;
    bool is_subtitle_language_description_Valid() const;

    double getSubtitleLength() const;
    void setSubtitleLength(const double &subtitle_length);
    bool is_subtitle_length_Set() const;
    bool is_subtitle_length_Valid() const;
...
private:
    ...
    QString m_subtitle_body;
    bool m_subtitle_body_isSet;
    bool m_subtitle_body_isValid;

    double m_subtitle_id;
    bool m_subtitle_id_isSet;
    bool m_subtitle_id_isValid;

    QString m_subtitle_language;
    bool m_subtitle_language_isSet;
    bool m_subtitle_language_isValid;

    QString m_subtitle_language_description;
    bool m_subtitle_language_description_isSet;
    bool m_subtitle_language_description_isValid;

    double m_subtitle_length;
    bool m_subtitle_length_isSet;
    bool m_subtitle_length_isValid;
