...
public:
    ...
    QString getSnippetBody() const;
    void setSnippetBody(const QString &snippet_body);
    bool is_snippet_body_Set() const;
    bool is_snippet_body_Valid() const;

    double getSnippetId() const;
    void setSnippetId(const double &snippet_id);
    bool is_snippet_id_Set() const;
    bool is_snippet_id_Valid() const;

    QString getSnippetLanguage() const;
    void setSnippetLanguage(const QString &snippet_language);
    bool is_snippet_language_Set() const;
    bool is_snippet_language_Valid() const;
...
private:
    ...
    QString m_snippet_body;
    bool m_snippet_body_isSet;
    bool m_snippet_body_isValid;

    double m_snippet_id;
    bool m_snippet_id_isSet;
    bool m_snippet_id_isValid;

    QString m_snippet_language;
    bool m_snippet_language_isSet;
    bool m_snippet_language_isValid;
