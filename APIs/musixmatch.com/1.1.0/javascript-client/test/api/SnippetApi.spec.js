...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.SnippetApi();
  });
  ...
  describe('SnippetApi', function() {
    describe('trackSnippetGetGet', function() {
      it('should call trackSnippetGetGet successfully', function(done) {
        //uncomment below and update the code to test trackSnippetGetGet
        //instance.trackSnippetGetGet(function(error) {
