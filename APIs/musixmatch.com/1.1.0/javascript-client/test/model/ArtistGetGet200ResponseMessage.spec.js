...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.ArtistGetGet200ResponseMessage();
  });
  ...
  describe('ArtistGetGet200ResponseMessage', function() {
    it('should create an instance of ArtistGetGet200ResponseMessage', function() {
      // uncomment below and update the code to test ArtistGetGet200ResponseMessage
      //var instance = new MusixmatchApi.ArtistGetGet200ResponseMessage();
      //expect(instance).to.be.a(MusixmatchApi.ArtistGetGet200ResponseMessage);
    });
