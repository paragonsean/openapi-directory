...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.AlbumTracksGetGet200ResponseMessage();
  });
  ...
  describe('AlbumTracksGetGet200ResponseMessage', function() {
    it('should create an instance of AlbumTracksGetGet200ResponseMessage', function() {
      // uncomment below and update the code to test AlbumTracksGetGet200ResponseMessage
      //var instance = new MusixmatchApi.AlbumTracksGetGet200ResponseMessage();
      //expect(instance).to.be.a(MusixmatchApi.AlbumTracksGetGet200ResponseMessage);
    });
