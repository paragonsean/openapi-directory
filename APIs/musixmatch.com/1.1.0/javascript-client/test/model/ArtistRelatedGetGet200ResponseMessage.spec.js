...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.ArtistRelatedGetGet200ResponseMessage();
  });
  ...
  describe('ArtistRelatedGetGet200ResponseMessage', function() {
    it('should create an instance of ArtistRelatedGetGet200ResponseMessage', function() {
      // uncomment below and update the code to test ArtistRelatedGetGet200ResponseMessage
      //var instance = new MusixmatchApi.ArtistRelatedGetGet200ResponseMessage();
      //expect(instance).to.be.a(MusixmatchApi.ArtistRelatedGetGet200ResponseMessage);
    });
