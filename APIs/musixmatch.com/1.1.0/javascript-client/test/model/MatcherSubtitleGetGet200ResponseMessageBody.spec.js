...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.MatcherSubtitleGetGet200ResponseMessageBody();
  });
  ...
  describe('MatcherSubtitleGetGet200ResponseMessageBody', function() {
    it('should create an instance of MatcherSubtitleGetGet200ResponseMessageBody', function() {
      // uncomment below and update the code to test MatcherSubtitleGetGet200ResponseMessageBody
      //var instance = new MusixmatchApi.MatcherSubtitleGetGet200ResponseMessageBody();
      //expect(instance).to.be.a(MusixmatchApi.MatcherSubtitleGetGet200ResponseMessageBody);
    });
