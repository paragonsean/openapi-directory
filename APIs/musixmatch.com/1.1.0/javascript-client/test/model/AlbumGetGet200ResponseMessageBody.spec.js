...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.AlbumGetGet200ResponseMessageBody();
  });
  ...
  describe('AlbumGetGet200ResponseMessageBody', function() {
    it('should create an instance of AlbumGetGet200ResponseMessageBody', function() {
      // uncomment below and update the code to test AlbumGetGet200ResponseMessageBody
      //var instance = new MusixmatchApi.AlbumGetGet200ResponseMessageBody();
      //expect(instance).to.be.a(MusixmatchApi.AlbumGetGet200ResponseMessageBody);
    });
