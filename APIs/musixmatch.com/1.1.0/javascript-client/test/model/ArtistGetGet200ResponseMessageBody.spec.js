...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.ArtistGetGet200ResponseMessageBody();
  });
  ...
  describe('ArtistGetGet200ResponseMessageBody', function() {
    it('should create an instance of ArtistGetGet200ResponseMessageBody', function() {
      // uncomment below and update the code to test ArtistGetGet200ResponseMessageBody
      //var instance = new MusixmatchApi.ArtistGetGet200ResponseMessageBody();
      //expect(instance).to.be.a(MusixmatchApi.ArtistGetGet200ResponseMessageBody);
    });
