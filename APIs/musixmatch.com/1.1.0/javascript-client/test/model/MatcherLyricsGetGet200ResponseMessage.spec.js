...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.MatcherLyricsGetGet200ResponseMessage();
  });
  ...
  describe('MatcherLyricsGetGet200ResponseMessage', function() {
    it('should create an instance of MatcherLyricsGetGet200ResponseMessage', function() {
      // uncomment below and update the code to test MatcherLyricsGetGet200ResponseMessage
      //var instance = new MusixmatchApi.MatcherLyricsGetGet200ResponseMessage();
      //expect(instance).to.be.a(MusixmatchApi.MatcherLyricsGetGet200ResponseMessage);
    });
