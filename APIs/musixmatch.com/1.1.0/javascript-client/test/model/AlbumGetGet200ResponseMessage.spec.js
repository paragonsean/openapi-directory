...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.AlbumGetGet200ResponseMessage();
  });
  ...
  describe('AlbumGetGet200ResponseMessage', function() {
    it('should create an instance of AlbumGetGet200ResponseMessage', function() {
      // uncomment below and update the code to test AlbumGetGet200ResponseMessage
      //var instance = new MusixmatchApi.AlbumGetGet200ResponseMessage();
      //expect(instance).to.be.a(MusixmatchApi.AlbumGetGet200ResponseMessage);
    });
