...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusixmatchApi.AlbumTracksGetGet200ResponseMessageHeader();
  });
  ...
  describe('AlbumTracksGetGet200ResponseMessageHeader', function() {
    it('should create an instance of AlbumTracksGetGet200ResponseMessageHeader', function() {
      // uncomment below and update the code to test AlbumTracksGetGet200ResponseMessageHeader
      //var instance = new MusixmatchApi.AlbumTracksGetGet200ResponseMessageHeader();
      //expect(instance).to.be.a(MusixmatchApi.AlbumTracksGetGet200ResponseMessageHeader);
    });
