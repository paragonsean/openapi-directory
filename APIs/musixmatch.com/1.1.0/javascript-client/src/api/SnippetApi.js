...
export default class SnippetApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the trackSnippetGetGet operation.
     * @callback module:api/SnippetApi~trackSnippetGetGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TrackSnippetGetGet200Response} data The data returned by the service call.
     ...
     * @param {module:api/SnippetApi~trackSnippetGetGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TrackSnippetGetGet200Response}
     */
    trackSnippetGetGet(trackId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'trackId' is set
      if (trackId === undefined || trackId === null) {
        throw new Error("Missing the required parameter 'trackId' when calling trackSnippetGetGet");
      }
      ...
      let returnType = TrackSnippetGetGet200Response;
