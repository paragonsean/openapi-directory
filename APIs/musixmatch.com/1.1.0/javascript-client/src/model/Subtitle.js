...
class Subtitle {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('subtitle_body')) {
                obj['subtitle_body'] = ApiClient.convertToType(data['subtitle_body'], 'String');
            }
            if (data.hasOwnProperty('subtitle_id')) {
                obj['subtitle_id'] = ApiClient.convertToType(data['subtitle_id'], 'Number');
            }
            if (data.hasOwnProperty('subtitle_language')) {
                obj['subtitle_language'] = ApiClient.convertToType(data['subtitle_language'], 'String');
            }
            if (data.hasOwnProperty('subtitle_language_description')) {
                obj['subtitle_language_description'] = ApiClient.convertToType(data['subtitle_language_description'], 'String');
            }
            if (data.hasOwnProperty('subtitle_length')) {
                obj['subtitle_length'] = ApiClient.convertToType(data['subtitle_length'], 'Number');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['subtitle_body'] && !(typeof data['subtitle_body'] === 'string' || data['subtitle_body'] instanceof String)) {
            throw new Error("Expected the field `subtitle_body` to be a primitive type in the JSON string but got " + data['subtitle_body']);
        }
        // ensure the json data is a string
        if (data['subtitle_language'] && !(typeof data['subtitle_language'] === 'string' || data['subtitle_language'] instanceof String)) {
            throw new Error("Expected the field `subtitle_language` to be a primitive type in the JSON string but got " + data['subtitle_language']);
        }
        // ensure the json data is a string
        if (data['subtitle_language_description'] && !(typeof data['subtitle_language_description'] === 'string' || data['subtitle_language_description'] instanceof String)) {
            throw new Error("Expected the field `subtitle_language_description` to be a primitive type in the JSON string but got " + data['subtitle_language_description']);
        }
        // ensure the json data is a string
 ...
 */
Subtitle.prototype['html_tracking_url'] = undefined;

/**
 * 
 * @member {String} lyrics_copyright
 */
Subtitle.prototype['lyrics_copyright'] = undefined;

/**
 * 
 * @member {String} pixel_tracking_url
 */
Subtitle.prototype['pixel_tracking_url'] = undefined;

/**
 * @member {Array.<String>} publisher_list
 */
Subtitle.prototype['publisher_list'] = undefined;

/**
 * 
 * @member {Number} restricted
 */
Subtitle.prototype['restricted'] = undefined;

/**
 * 
 * @member {String} script_tracking_url
 */
Subtitle.prototype['script_tracking_url'] = undefined;

/**
 * 
 * @member {String} subtitle_body
 */
Subtitle.prototype['subtitle_body'] = undefined;

/**
 * 
 * @member {Number} subtitle_id
 */
Subtitle.prototype['subtitle_id'] = undefined;

/**
 * 
 * @member {String} subtitle_language
 */
Subtitle.prototype['subtitle_language'] = undefined;

/**
 * 
 * @member {String} subtitle_language_description
 */
Subtitle.prototype['subtitle_language_description'] = undefined;

/**
 * 
 * @member {Number} subtitle_length
 */
Subtitle.prototype['subtitle_length'] = undefined;

/**
 * 
 * @member {String} updated_time
 */
Subtitle.prototype['updated_time'] = undefined;

/**
 * @member {Array.<String>} writer_list
 */
Subtitle.prototype['writer_list'] = undefined;
