...
class Track {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('secondary_genres')) {
                obj['secondary_genres'] = AlbumPrimaryGenres.constructFromObject(data['secondary_genres']);
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['commontrack_vanity_id'] && !(typeof data['commontrack_vanity_id'] === 'string' || data['commontrack_vanity_id'] instanceof String)) {
            throw new Error("Expected the field `commontrack_vanity_id` to be a primitive type in the JSON string but got " + data['commontrack_vanity_id']);
        }
        // ensure the json data is a string
        if (data['first_release_date'] && !(typeof data['first_release_date'] === 'string' || data['first_release_date'] instanceof String)) {
            throw new Error("Expected the field `first_release_date` to be a primitive type in the JSON string but got " + data['first_release_date']);
        }
        ...
        if (data['secondary_genres']) { // data not null
          AlbumPrimaryGenres.validateJSON(data['secondary_genres']);
        }
        // ensure the json data is a string
        if (data['track_edit_url'] && !(typeof data['track_edit_url'] === 'string' || data['track_edit_url'] instanceof String)) {
            throw new Error("Expected the field `track_edit_url` to be a primitive type in the JSON string but got " + data['track_edit_url']);
        }
        // ensure the json data is a string
        if (data['track_isrc'] && !(typeof data['track_isrc'] === 'string' || data['track_isrc'] instanceof String)) {
            throw new Error("Expected the field `track_isrc` to be a primitive type in the JSON string but got " + data['track_isrc']);
        }
        // ensure the json data is a string
        if (data['track_mbid'] && !(typeof data['track_mbid'] === 'string' || data['track_mbid'] instanceof String)) {
            throw new Error("Expected the field `track_mbid` to be a primitive type in the JSON string but got " + data['track_mbid']);
        }
        // ensure the json data is a string
        ...
        if (!Array.isArray(data['track_name_translation_list'])) {
            throw new Error("Expected the field `track_name_translation_list` to be an array in the JSON data but got " + data['track_name_translation_list']);
        }
        // ensure the json data is a string
        if (data['track_share_url'] && !(typeof data['track_share_url'] === 'string' || data['track_share_url'] instanceof String)) {
            throw new Error("Expected the field `track_share_url` to be a primitive type in the JSON string but got " + data['track_share_url']);
        }
        // ensure the json data is a string
        if (data['track_spotify_id'] && !(typeof data['track_spotify_id'] === 'string' || data['track_spotify_id'] instanceof String)) {
            throw new Error("Expected the field `track_spotify_id` to be a primitive type in the JSON string but got " + data['track_spotify_id']);
        }
        // ensure the json data is a string
        if (data['track_xboxmusic_id'] && !(typeof data['track_xboxmusic_id'] === 'string' || data['track_xboxmusic_id'] instanceof String)) {
            throw new Error("Expected the field `track_xboxmusic_id` to be a primitive type in the JSON string but got " + data['track_xboxmusic_id']);
        }
        // ensure the json data is a string
 ...
 */
Track.prototype['album_coverart_100x100'] = undefined;

/**
 * 
 * @member {String} album_coverart_350x350
 */
Track.prototype['album_coverart_350x350'] = undefined;

/**
 * 
 * @member {String} album_coverart_500x500
 */
Track.prototype['album_coverart_500x500'] = undefined;

/**
 * 
 * @member {String} album_coverart_800x800
 */
Track.prototype['album_coverart_800x800'] = undefined;

/**
 * 
 * @member {Number} album_id
 */
Track.prototype['album_id'] = undefined;

/**
 * 
 * @member {String} album_name
 */
Track.prototype['album_name'] = undefined;

/**
 * 
 * @member {Number} artist_id
 */
Track.prototype['artist_id'] = undefined;

/**
 * 
 * @member {String} artist_mbid
 */
Track.prototype['artist_mbid'] = undefined;

/**
 * 
 * @member {String} artist_name
 */
Track.prototype['artist_name'] = undefined;

/**
 * 
 * @member {Number} commontrack_id
 */
Track.prototype['commontrack_id'] = undefined;

/**
 * 
 * @member {String} commontrack_vanity_id
 */
Track.prototype['commontrack_vanity_id'] = undefined;

/**
 * 
 * @member {Number} explicit
 */
Track.prototype['explicit'] = undefined;

/**
 * 
 * @member {String} first_release_date
 */
Track.prototype['first_release_date'] = undefined;

/**
 * 
 * @member {Number} has_lyrics
 */
Track.prototype['has_lyrics'] = undefined;

/**
 * 
 * @member {Number} has_subtitles
 */
Track.prototype['has_subtitles'] = undefined;

/**
 * 
 * @member {Number} instrumental
 */
Track.prototype['instrumental'] = undefined;

/**
 * 
 * @member {Number} lyrics_id
 */
Track.prototype['lyrics_id'] = undefined;

/**
 * 
 * @member {Number} num_favourite
 */
Track.prototype['num_favourite'] = undefined;

/**
 * @member {module:model/AlbumPrimaryGenres} primary_genres
 */
Track.prototype['primary_genres'] = undefined;

/**
 * 
 * @member {Number} restricted
 */
Track.prototype['restricted'] = undefined;

/**
 * @member {module:model/AlbumPrimaryGenres} secondary_genres
 */
Track.prototype['secondary_genres'] = undefined;

/**
 * 
 * @member {Number} subtitle_id
 */
Track.prototype['subtitle_id'] = undefined;

/**
 * 
 * @member {String} track_edit_url
 */
Track.prototype['track_edit_url'] = undefined;

/**
 * 
 * @member {Number} track_id
 */
Track.prototype['track_id'] = undefined;

/**
 * 
 * @member {String} track_isrc
 */
Track.prototype['track_isrc'] = undefined;

/**
 * 
 * @member {Number} track_length
 */
Track.prototype['track_length'] = undefined;

/**
 * 
 * @member {String} track_mbid
 */
Track.prototype['track_mbid'] = undefined;

/**
 * 
 * @member {String} track_name
 */
Track.prototype['track_name'] = undefined;

/**
 * @member {Array.<String>} track_name_translation_list
 */
Track.prototype['track_name_translation_list'] = undefined;

/**
 * 
 * @member {Number} track_rating
 */
Track.prototype['track_rating'] = undefined;

/**
 * 
 * @member {String} track_share_url
 */
Track.prototype['track_share_url'] = undefined;

/**
 * 
 * @member {Number} track_soundcloud_id
 */
Track.prototype['track_soundcloud_id'] = undefined;

/**
 * 
 * @member {String} track_spotify_id
 */
Track.prototype['track_spotify_id'] = undefined;

/**
 * 
 * @member {String} track_xboxmusic_id
 */
Track.prototype['track_xboxmusic_id'] = undefined;

/**
 * 
 * @member {String} updated_time
 */
Track.prototype['updated_time'] = undefined;
