...
/**
 * API tests for LyricsApi
 */
@Disabled
public class LyricsApiTest {

    private final LyricsApi api = new LyricsApi();

    /**
     * @throws ApiException if the Api call fails
     */
    @Test
    public void matcherLyricsGetGetTest() throws ApiException {
        String format = null;
        String paramCallback = null;
        String qTrack = null;
        String qArtist = null;
        MatcherLyricsGetGet200Response response = api.matcherLyricsGetGet(format, paramCallback, qTrack, qArtist);
     ...
     */
    @Test
    public void trackLyricsGetGetTest() throws ApiException {
        String trackId = null;
        String format = null;
        String paramCallback = null;
        MatcherLyricsGetGet200Response response = api.trackLyricsGetGet(trackId, format, paramCallback);
        // TODO: test validations
    }
