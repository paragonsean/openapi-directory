...
public class AlbumApiTest {
     ...
     */
    @Test
    public void albumGetGetTest() throws ApiException {
        String albumId = null;
        String format = null;
        String paramCallback = null;
        AlbumGetGet200Response response = api.albumGetGet(albumId, format, paramCallback);
     ...
     */
    @Test
    public void artistAlbumsGetGetTest() throws ApiException {
        String artistId = null;
        String format = null;
        String paramCallback = null;
        String sReleaseDate = null;
        String gAlbumName = null;
        BigDecimal pageSize = null;
        BigDecimal page = null;
        ArtistAlbumsGetGet200Response response = api.artistAlbumsGetGet(artistId, format, paramCallback, sReleaseDate, gAlbumName, pageSize, page);
        // TODO: test validations
    }
