...
public class SubtitleApiTest {
     ...
     */
    @Test
    public void matcherSubtitleGetGetTest() throws ApiException {
        String format = null;
        String paramCallback = null;
        String qTrack = null;
        String qArtist = null;
        BigDecimal fSubtitleLength = null;
        BigDecimal fSubtitleLengthMaxDeviation = null;
        MatcherSubtitleGetGet200Response response = api.matcherSubtitleGetGet(format, paramCallback, qTrack, qArtist, fSubtitleLength, fSubtitleLengthMaxDeviation);
     ...
     */
    @Test
    public void trackSubtitleGetGetTest() throws ApiException {
        String trackId = null;
        String format = null;
        String paramCallback = null;
        MatcherSubtitleGetGet200Response response = api.trackSubtitleGetGet(trackId, format, paramCallback);
        // TODO: test validations
    }
