...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PatientView.FhirContact();
  });
  ...
  describe('FhirContact', function() {
    it('should create an instance of FhirContact', function() {
      // uncomment below and update the code to test FhirContact
      //var instance = new PatientView.FhirContact();
      //expect(instance).to.be.a(PatientView.FhirContact);
    });
