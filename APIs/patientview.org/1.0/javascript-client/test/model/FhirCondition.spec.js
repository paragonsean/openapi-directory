...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PatientView.FhirCondition();
  });
  ...
  describe('FhirCondition', function() {
    it('should create an instance of FhirCondition', function() {
      // uncomment below and update the code to test FhirCondition
      //var instance = new PatientView.FhirCondition();
      //expect(instance).to.be.a(PatientView.FhirCondition);
    });

    it('should have the property asserter (base name: "asserter")', function() {
      // uncomment below and update the code to test the property asserter
      //var instance = new PatientView.FhirCondition();
