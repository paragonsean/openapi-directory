...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PatientView.FhirObservationPage();
  });
  ...
  describe('FhirObservationPage', function() {
    it('should create an instance of FhirObservationPage', function() {
      // uncomment below and update the code to test FhirObservationPage
      //var instance = new PatientView.FhirObservationPage();
      //expect(instance).to.be.a(PatientView.FhirObservationPage);
    });
