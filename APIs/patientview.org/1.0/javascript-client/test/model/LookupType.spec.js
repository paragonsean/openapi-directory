...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PatientView.LookupType();
  });
  ...
  describe('LookupType', function() {
    it('should create an instance of LookupType', function() {
      // uncomment below and update the code to test LookupType
      //var instance = new PatientView.LookupType();
      //expect(instance).to.be.a(PatientView.LookupType);
    });
