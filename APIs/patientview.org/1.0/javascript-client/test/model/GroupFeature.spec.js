...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PatientView.GroupFeature();
  });
  ...
  describe('GroupFeature', function() {
    it('should create an instance of GroupFeature', function() {
      // uncomment below and update the code to test GroupFeature
      //var instance = new PatientView.GroupFeature();
      //expect(instance).to.be.a(PatientView.GroupFeature);
    });
