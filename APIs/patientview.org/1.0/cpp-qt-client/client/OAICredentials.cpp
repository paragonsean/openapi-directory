...
QString OAICredentials::getApiKey() const {
    return m_api_key;
}
void OAICredentials::setApiKey(const QString &api_key) {
    m_api_key = api_key;
    m_api_key_isSet = true;
}

bool OAICredentials::is_api_key_Set() const{
    return m_api_key_isSet;
}

bool OAICredentials::is_api_key_Valid() const{
