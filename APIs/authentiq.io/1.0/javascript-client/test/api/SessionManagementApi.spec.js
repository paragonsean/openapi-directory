...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthentiqConnectApi.SessionManagementApi();
  });
  ...
  describe('SessionManagementApi', function() {
    describe('authorizeIframe', function() {
      it('should call authorizeIframe successfully', function(done) {
        //uncomment below and update the code to test authorizeIframe
        //instance.authorizeIframe(function(error) {
