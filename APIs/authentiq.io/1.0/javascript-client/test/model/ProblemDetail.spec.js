...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthentiqConnectApi.ProblemDetail();
  });
  ...
  describe('ProblemDetail', function() {
    it('should create an instance of ProblemDetail', function() {
      // uncomment below and update the code to test ProblemDetail
      //var instance = new AuthentiqConnectApi.ProblemDetail();
      //expect(instance).to.be.a(AuthentiqConnectApi.ProblemDetail);
    });
