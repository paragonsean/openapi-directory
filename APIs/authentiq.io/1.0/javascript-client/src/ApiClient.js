...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://connect.authentiq.io') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://connect.authentiq.io
         */
        ...
        this.authentications = {
            'client_registration_token': {type: 'apiKey', 'in': 'header', name: 'Authorization'},
            'client_secret': {type: 'oauth2'},
            'oauth_code': {type: 'oauth2'},
            'oauth_implicit': {type: 'oauth2'},
            'user_jwt': {type: 'oauth2'}
        }
