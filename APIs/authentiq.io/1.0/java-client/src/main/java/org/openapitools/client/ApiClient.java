...
public class ApiClient {
    ...
    private String basePath = "https://connect.authentiq.io";
    ...
    public ApiClient() {
        ...
        authentications.put("client_registration_token", new ApiKeyAuth("header", "Authorization"));
        authentications.put("client_secret", new OAuth());
        authentications.put("oauth_code", new OAuth());
        authentications.put("oauth_implicit", new OAuth());
        authentications.put("user_jwt", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://connect.authentiq.io/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://connect.authentiq.io
