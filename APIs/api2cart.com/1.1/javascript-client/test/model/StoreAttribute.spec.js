...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.StoreAttribute();
  });
  ...
  describe('StoreAttribute', function() {
    it('should create an instance of StoreAttribute', function() {
      // uncomment below and update the code to test StoreAttribute
      //var instance = new SwaggerApi2Cart.StoreAttribute();
      //expect(instance).to.be.a(SwaggerApi2Cart.StoreAttribute);
    });
