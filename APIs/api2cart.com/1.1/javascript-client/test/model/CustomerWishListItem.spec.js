...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.CustomerWishListItem();
  });
  ...
  describe('CustomerWishListItem', function() {
    it('should create an instance of CustomerWishListItem', function() {
      // uncomment below and update the code to test CustomerWishListItem
      //var instance = new SwaggerApi2Cart.CustomerWishListItem();
      //expect(instance).to.be.a(SwaggerApi2Cart.CustomerWishListItem);
    });
    ...
    it('should have the property childId (base name: "child_id")', function() {
