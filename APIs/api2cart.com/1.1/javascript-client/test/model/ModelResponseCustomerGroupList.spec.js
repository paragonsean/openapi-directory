...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseCustomerGroupList();
  });
  ...
  describe('ModelResponseCustomerGroupList', function() {
    it('should create an instance of ModelResponseCustomerGroupList', function() {
      // uncomment below and update the code to test ModelResponseCustomerGroupList
      //var instance = new SwaggerApi2Cart.ModelResponseCustomerGroupList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseCustomerGroupList);
    });
