...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ResponseCartMetaDataListResult();
  });
  ...
  describe('ResponseCartMetaDataListResult', function() {
    it('should create an instance of ResponseCartMetaDataListResult', function() {
      // uncomment below and update the code to test ResponseCartMetaDataListResult
      //var instance = new SwaggerApi2Cart.ResponseCartMetaDataListResult();
      //expect(instance).to.be.a(SwaggerApi2Cart.ResponseCartMetaDataListResult);
    });
