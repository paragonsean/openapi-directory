...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseCartScriptList();
  });
  ...
  describe('ModelResponseCartScriptList', function() {
    it('should create an instance of ModelResponseCartScriptList', function() {
      // uncomment below and update the code to test ModelResponseCartScriptList
      //var instance = new SwaggerApi2Cart.ModelResponseCartScriptList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseCartScriptList);
    });
