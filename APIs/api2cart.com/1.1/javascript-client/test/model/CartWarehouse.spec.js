...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.CartWarehouse();
  });
  ...
  describe('CartWarehouse', function() {
    it('should create an instance of CartWarehouse', function() {
      // uncomment below and update the code to test CartWarehouse
      //var instance = new SwaggerApi2Cart.CartWarehouse();
      //expect(instance).to.be.a(SwaggerApi2Cart.CartWarehouse);
    });
    ...
    it('should have the property carriersIds (base name: "carriers_ids")', function() {
      // uncomment below and update the code to test the property carriersIds
      //var instance = new SwaggerApi2Cart.CartWarehouse();
      //expect(instance).to.be();
    });
