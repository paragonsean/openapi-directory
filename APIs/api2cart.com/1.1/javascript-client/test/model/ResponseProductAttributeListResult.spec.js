...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ResponseProductAttributeListResult();
  });
  ...
  describe('ResponseProductAttributeListResult', function() {
    it('should create an instance of ResponseProductAttributeListResult', function() {
      // uncomment below and update the code to test ResponseProductAttributeListResult
      //var instance = new SwaggerApi2Cart.ResponseProductAttributeListResult();
      //expect(instance).to.be.a(SwaggerApi2Cart.ResponseProductAttributeListResult);
    });
