...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseAttributeList();
  });
  ...
  describe('ModelResponseAttributeList', function() {
    it('should create an instance of ModelResponseAttributeList', function() {
      // uncomment below and update the code to test ModelResponseAttributeList
      //var instance = new SwaggerApi2Cart.ModelResponseAttributeList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseAttributeList);
    });
