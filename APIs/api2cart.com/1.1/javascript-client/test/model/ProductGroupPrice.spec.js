...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ProductGroupPrice();
  });
  ...
  describe('ProductGroupPrice', function() {
    it('should create an instance of ProductGroupPrice', function() {
      // uncomment below and update the code to test ProductGroupPrice
      //var instance = new SwaggerApi2Cart.ProductGroupPrice();
      //expect(instance).to.be.a(SwaggerApi2Cart.ProductGroupPrice);
    });
