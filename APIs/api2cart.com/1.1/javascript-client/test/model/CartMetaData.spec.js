...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.CartMetaData();
  });
  ...
  describe('CartMetaData', function() {
    it('should create an instance of CartMetaData', function() {
      // uncomment below and update the code to test CartMetaData
      //var instance = new SwaggerApi2Cart.CartMetaData();
      //expect(instance).to.be.a(SwaggerApi2Cart.CartMetaData);
    });
