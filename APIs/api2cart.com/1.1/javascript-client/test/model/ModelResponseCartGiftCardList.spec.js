...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseCartGiftCardList();
  });
  ...
  describe('ModelResponseCartGiftCardList', function() {
    it('should create an instance of ModelResponseCartGiftCardList', function() {
      // uncomment below and update the code to test ModelResponseCartGiftCardList
      //var instance = new SwaggerApi2Cart.ModelResponseCartGiftCardList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseCartGiftCardList);
    });
