...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ProductPriceUpdate();
  });
  ...
  describe('ProductPriceUpdate', function() {
    it('should create an instance of ProductPriceUpdate', function() {
      // uncomment below and update the code to test ProductPriceUpdate
      //var instance = new SwaggerApi2Cart.ProductPriceUpdate();
      //expect(instance).to.be.a(SwaggerApi2Cart.ProductPriceUpdate);
    });
