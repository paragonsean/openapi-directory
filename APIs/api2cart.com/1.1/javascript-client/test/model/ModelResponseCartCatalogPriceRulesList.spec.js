...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseCartCatalogPriceRulesList();
  });
  ...
  describe('ModelResponseCartCatalogPriceRulesList', function() {
    it('should create an instance of ModelResponseCartCatalogPriceRulesList', function() {
      // uncomment below and update the code to test ModelResponseCartCatalogPriceRulesList
      //var instance = new SwaggerApi2Cart.ModelResponseCartCatalogPriceRulesList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseCartCatalogPriceRulesList);
    });
