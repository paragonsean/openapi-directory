...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ResponseCartGiftcardListResult();
  });
  ...
  describe('ResponseCartGiftcardListResult', function() {
    it('should create an instance of ResponseCartGiftcardListResult', function() {
      // uncomment below and update the code to test ResponseCartGiftcardListResult
      //var instance = new SwaggerApi2Cart.ResponseCartGiftcardListResult();
      //expect(instance).to.be.a(SwaggerApi2Cart.ResponseCartGiftcardListResult);
    });
