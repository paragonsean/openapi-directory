...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ProductVariantPriceUpdate();
  });
  ...
  describe('ProductVariantPriceUpdate', function() {
    it('should create an instance of ProductVariantPriceUpdate', function() {
      // uncomment below and update the code to test ProductVariantPriceUpdate
      //var instance = new SwaggerApi2Cart.ProductVariantPriceUpdate();
      //expect(instance).to.be.a(SwaggerApi2Cart.ProductVariantPriceUpdate);
    });
