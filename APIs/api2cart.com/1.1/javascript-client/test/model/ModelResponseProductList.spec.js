...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseProductList();
  });
  ...
  describe('ModelResponseProductList', function() {
    it('should create an instance of ModelResponseProductList', function() {
      // uncomment below and update the code to test ModelResponseProductList
      //var instance = new SwaggerApi2Cart.ModelResponseProductList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseProductList);
    });
