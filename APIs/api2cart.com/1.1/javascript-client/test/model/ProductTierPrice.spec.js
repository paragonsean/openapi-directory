...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ProductTierPrice();
  });
  ...
  describe('ProductTierPrice', function() {
    it('should create an instance of ProductTierPrice', function() {
      ...
      //var instance = new SwaggerApi2Cart.ProductTierPrice();
      //expect(instance).to.be.a(SwaggerApi2Cart.ProductTierPrice);
    });
