...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.CartChannel();
  });
  ...
  describe('CartChannel', function() {
    it('should create an instance of CartChannel', function() {
      // uncomment below and update the code to test CartChannel
      //var instance = new SwaggerApi2Cart.CartChannel();
      //expect(instance).to.be.a(SwaggerApi2Cart.CartChannel);
    });
