...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseCartMetaDataList();
  });
  ...
  describe('ModelResponseCartMetaDataList', function() {
    it('should create an instance of ModelResponseCartMetaDataList', function() {
      // uncomment below and update the code to test ModelResponseCartMetaDataList
      //var instance = new SwaggerApi2Cart.ModelResponseCartMetaDataList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseCartMetaDataList);
    });
