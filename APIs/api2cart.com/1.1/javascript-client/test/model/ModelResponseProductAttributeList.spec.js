...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseProductAttributeList();
  });
  ...
  describe('ModelResponseProductAttributeList', function() {
    it('should create an instance of ModelResponseProductAttributeList', function() {
      // uncomment below and update the code to test ModelResponseProductAttributeList
      //var instance = new SwaggerApi2Cart.ModelResponseProductAttributeList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseProductAttributeList);
    });
