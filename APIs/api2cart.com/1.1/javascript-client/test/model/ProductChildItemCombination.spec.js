...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ProductChildItemCombination();
  });
  ...
  describe('ProductChildItemCombination', function() {
    it('should create an instance of ProductChildItemCombination', function() {
      // uncomment below and update the code to test ProductChildItemCombination
      //var instance = new SwaggerApi2Cart.ProductChildItemCombination();
      //expect(instance).to.be.a(SwaggerApi2Cart.ProductChildItemCombination);
    });
