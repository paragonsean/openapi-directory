...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ProductTaxAdd();
  });
  ...
  describe('ProductTaxAdd', function() {
    it('should create an instance of ProductTaxAdd', function() {
      // uncomment below and update the code to test ProductTaxAdd
      //var instance = new SwaggerApi2Cart.ProductTaxAdd();
      //expect(instance).to.be.a(SwaggerApi2Cart.ProductTaxAdd);
    });
