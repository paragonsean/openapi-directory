...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseCategoryList();
  });
  ...
  describe('ModelResponseCategoryList', function() {
    it('should create an instance of ModelResponseCategoryList', function() {
      // uncomment below and update the code to test ModelResponseCategoryList
      //var instance = new SwaggerApi2Cart.ModelResponseCategoryList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseCategoryList);
    });
