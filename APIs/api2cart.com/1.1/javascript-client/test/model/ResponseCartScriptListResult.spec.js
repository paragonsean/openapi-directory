...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ResponseCartScriptListResult();
  });
  ...
  describe('ResponseCartScriptListResult', function() {
    it('should create an instance of ResponseCartScriptListResult', function() {
      ...
      //var instance = new SwaggerApi2Cart.ResponseCartScriptListResult();
      //expect(instance).to.be.a(SwaggerApi2Cart.ResponseCartScriptListResult);
    });
