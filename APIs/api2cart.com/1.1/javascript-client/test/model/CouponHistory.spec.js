...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.CouponHistory();
  });
  ...
  describe('CouponHistory', function() {
    it('should create an instance of CouponHistory', function() {
      // uncomment below and update the code to test CouponHistory
      //var instance = new SwaggerApi2Cart.CouponHistory();
      //expect(instance).to.be.a(SwaggerApi2Cart.CouponHistory);
    });
