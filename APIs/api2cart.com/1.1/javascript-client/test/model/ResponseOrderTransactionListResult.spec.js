...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ResponseOrderTransactionListResult();
  });
  ...
  describe('ResponseOrderTransactionListResult', function() {
    it('should create an instance of ResponseOrderTransactionListResult', function() {
      // uncomment below and update the code to test ResponseOrderTransactionListResult
      //var instance = new SwaggerApi2Cart.ResponseOrderTransactionListResult();
      //expect(instance).to.be.a(SwaggerApi2Cart.ResponseOrderTransactionListResult);
    });
