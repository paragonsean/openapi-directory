...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseOrderAbandonedList();
  });
  ...
  describe('ModelResponseOrderAbandonedList', function() {
    it('should create an instance of ModelResponseOrderAbandonedList', function() {
      // uncomment below and update the code to test ModelResponseOrderAbandonedList
      //var instance = new SwaggerApi2Cart.ModelResponseOrderAbandonedList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseOrderAbandonedList);
    });
