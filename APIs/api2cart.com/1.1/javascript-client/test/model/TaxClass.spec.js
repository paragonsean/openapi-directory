...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.TaxClass();
  });
  ...
  describe('TaxClass', function() {
    it('should create an instance of TaxClass', function() {
      // uncomment below and update the code to test TaxClass
      //var instance = new SwaggerApi2Cart.TaxClass();
      //expect(instance).to.be.a(SwaggerApi2Cart.TaxClass);
    });
