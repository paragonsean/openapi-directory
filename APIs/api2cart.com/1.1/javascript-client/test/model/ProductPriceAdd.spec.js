...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ProductPriceAdd();
  });
  ...
  describe('ProductPriceAdd', function() {
    it('should create an instance of ProductPriceAdd', function() {
      // uncomment below and update the code to test ProductPriceAdd
      //var instance = new SwaggerApi2Cart.ProductPriceAdd();
      //expect(instance).to.be.a(SwaggerApi2Cart.ProductPriceAdd);
    });
