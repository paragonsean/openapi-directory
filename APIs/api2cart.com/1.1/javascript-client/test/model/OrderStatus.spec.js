...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.OrderStatus();
  });
  ...
  describe('OrderStatus', function() {
    it('should create an instance of OrderStatus', function() {
      ...
      //var instance = new SwaggerApi2Cart.OrderStatus();
      //expect(instance).to.be.a(SwaggerApi2Cart.OrderStatus);
    });
    ...
    it('should have the property refundInfo (base name: "refund_info")', function() {
      // uncomment below and update the code to test the property refundInfo
      //var instance = new SwaggerApi2Cart.OrderStatus();
      //expect(instance).to.be();
    });
