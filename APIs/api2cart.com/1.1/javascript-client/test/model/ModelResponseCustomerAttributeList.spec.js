...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseCustomerAttributeList();
  });
  ...
  describe('ModelResponseCustomerAttributeList', function() {
    it('should create an instance of ModelResponseCustomerAttributeList', function() {
      // uncomment below and update the code to test ModelResponseCustomerAttributeList
      //var instance = new SwaggerApi2Cart.ModelResponseCustomerAttributeList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseCustomerAttributeList);
    });
