...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ProductVariantImageAdd();
  });
  ...
  describe('ProductVariantImageAdd', function() {
    it('should create an instance of ProductVariantImageAdd', function() {
      // uncomment below and update the code to test ProductVariantImageAdd
      //var instance = new SwaggerApi2Cart.ProductVariantImageAdd();
      //expect(instance).to.be.a(SwaggerApi2Cart.ProductVariantImageAdd);
    });
