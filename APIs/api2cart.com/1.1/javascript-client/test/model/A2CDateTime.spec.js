...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.A2CDateTime();
  });
  ...
  describe('A2CDateTime', function() {
    it('should create an instance of A2CDateTime', function() {
      // uncomment below and update the code to test A2CDateTime
      //var instance = new SwaggerApi2Cart.A2CDateTime();
      //expect(instance).to.be.a(SwaggerApi2Cart.A2CDateTime);
    });
