...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ResponseCustomerAttributeListResult();
  });
  ...
  describe('ResponseCustomerAttributeListResult', function() {
    it('should create an instance of ResponseCustomerAttributeListResult', function() {
      // uncomment below and update the code to test ResponseCustomerAttributeListResult
      //var instance = new SwaggerApi2Cart.ResponseCustomerAttributeListResult();
      //expect(instance).to.be.a(SwaggerApi2Cart.ResponseCustomerAttributeListResult);
    });
