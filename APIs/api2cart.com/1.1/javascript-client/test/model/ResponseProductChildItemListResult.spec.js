...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ResponseProductChildItemListResult();
  });
  ...
  describe('ResponseProductChildItemListResult', function() {
    it('should create an instance of ResponseProductChildItemListResult', function() {
      // uncomment below and update the code to test ResponseProductChildItemListResult
      //var instance = new SwaggerApi2Cart.ResponseProductChildItemListResult();
      //expect(instance).to.be.a(SwaggerApi2Cart.ResponseProductChildItemListResult);
    });
