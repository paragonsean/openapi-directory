...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ResponseCategoryListResult();
  });
  ...
  describe('ResponseCategoryListResult', function() {
    it('should create an instance of ResponseCategoryListResult', function() {
      ...
      //var instance = new SwaggerApi2Cart.ResponseCategoryListResult();
      //expect(instance).to.be.a(SwaggerApi2Cart.ResponseCategoryListResult);
    });
