...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.CustomerAttribute();
  });
  ...
  describe('CustomerAttribute', function() {
    it('should create an instance of CustomerAttribute', function() {
      // uncomment below and update the code to test CustomerAttribute
      //var instance = new SwaggerApi2Cart.CustomerAttribute();
      //expect(instance).to.be.a(SwaggerApi2Cart.CustomerAttribute);
    });
