...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseCartCouponList();
  });
  ...
  describe('ModelResponseCartCouponList', function() {
    it('should create an instance of ModelResponseCartCouponList', function() {
      // uncomment below and update the code to test ModelResponseCartCouponList
      //var instance = new SwaggerApi2Cart.ModelResponseCartCouponList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseCartCouponList);
    });
