...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseCustomerList();
  });
  ...
  describe('ModelResponseCustomerList', function() {
    it('should create an instance of ModelResponseCustomerList', function() {
      // uncomment below and update the code to test ModelResponseCustomerList
      //var instance = new SwaggerApi2Cart.ModelResponseCustomerList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseCustomerList);
    });
