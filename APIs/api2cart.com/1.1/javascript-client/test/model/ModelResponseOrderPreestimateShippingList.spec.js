...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseOrderPreestimateShippingList();
  });
  ...
  describe('ModelResponseOrderPreestimateShippingList', function() {
    it('should create an instance of ModelResponseOrderPreestimateShippingList', function() {
      // uncomment below and update the code to test ModelResponseOrderPreestimateShippingList
      //var instance = new SwaggerApi2Cart.ModelResponseOrderPreestimateShippingList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseOrderPreestimateShippingList);
    });
