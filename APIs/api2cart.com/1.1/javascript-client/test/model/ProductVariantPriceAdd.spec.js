...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ProductVariantPriceAdd();
  });
  ...
  describe('ProductVariantPriceAdd', function() {
    it('should create an instance of ProductVariantPriceAdd', function() {
      ...
      //var instance = new SwaggerApi2Cart.ProductVariantPriceAdd();
      //expect(instance).to.be.a(SwaggerApi2Cart.ProductVariantPriceAdd);
    });
