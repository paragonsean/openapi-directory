...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseOrderShipmentList();
  });
  ...
  describe('ModelResponseOrderShipmentList', function() {
    it('should create an instance of ModelResponseOrderShipmentList', function() {
      // uncomment below and update the code to test ModelResponseOrderShipmentList
      //var instance = new SwaggerApi2Cart.ModelResponseOrderShipmentList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseOrderShipmentList);
    });
