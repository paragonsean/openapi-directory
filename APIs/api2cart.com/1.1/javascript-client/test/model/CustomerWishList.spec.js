...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.CustomerWishList();
  });
  ...
  describe('CustomerWishList', function() {
    it('should create an instance of CustomerWishList', function() {
      // uncomment below and update the code to test CustomerWishList
      //var instance = new SwaggerApi2Cart.CustomerWishList();
      //expect(instance).to.be.a(SwaggerApi2Cart.CustomerWishList);
    });
