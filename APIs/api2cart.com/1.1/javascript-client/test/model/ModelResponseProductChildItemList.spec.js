...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.ModelResponseProductChildItemList();
  });
  ...
  describe('ModelResponseProductChildItemList', function() {
    it('should create an instance of ModelResponseProductChildItemList', function() {
      // uncomment below and update the code to test ModelResponseProductChildItemList
      //var instance = new SwaggerApi2Cart.ModelResponseProductChildItemList();
      //expect(instance).to.be.a(SwaggerApi2Cart.ModelResponseProductChildItemList);
    });
