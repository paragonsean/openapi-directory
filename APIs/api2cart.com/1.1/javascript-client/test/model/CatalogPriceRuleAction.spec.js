...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerApi2Cart.CatalogPriceRuleAction();
  });
  ...
  describe('CatalogPriceRuleAction', function() {
    it('should create an instance of CatalogPriceRuleAction', function() {
      // uncomment below and update the code to test CatalogPriceRuleAction
      //var instance = new SwaggerApi2Cart.CatalogPriceRuleAction();
      //expect(instance).to.be.a(SwaggerApi2Cart.CatalogPriceRuleAction);
    });
