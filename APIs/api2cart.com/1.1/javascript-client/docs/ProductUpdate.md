...
**increaseQuantity** | **Number** | Defines the incremental changes in product quantity | [optional] 
...
**price** | **Number** | Defines new product&#39;s price | [optional] 
**productClass** | **String** | A categorization for the product | [optional] 
**quantity** | **Number** | Defines new product&#39;s quantity | [optional] 
**reduceQuantity** | **Number** | Defines the decrement changes in product quantity | [optional] 
**reindex** | **Boolean** | Is reindex required | [optional] [default to true]
**reportRequestId** | **String** | Report request id | [optional] 
**reserveQuantity** | **Number** | This parameter allows to reserve/unreserve product quantity. | [optional] 
...
**specialPrice** | **Number** | Defines new product&#39;s special price | [optional] 
