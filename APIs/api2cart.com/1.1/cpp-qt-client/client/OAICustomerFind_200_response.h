...
#ifndef OAICustomerFind_200_response_H
#define OAICustomerFind_200_response_H
...
namespace OpenAPI {
class OAICustomerFind_200_response_result;

class OAICustomerFind_200_response : public OAIObject {
public:
    OAICustomerFind_200_response();
    OAICustomerFind_200_response(QString json);
    ~OAICustomerFind_200_response() override;
    ...
    OAICustomerFind_200_response_result getResult() const;
    void setResult(const OAICustomerFind_200_response_result &result);
...
private:
    ...
    OAICustomerFind_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerFind_200_response)

#endif // OAICustomerFind_200_response_H
