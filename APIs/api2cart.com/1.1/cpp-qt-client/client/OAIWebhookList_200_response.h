...
#ifndef OAIWebhookList_200_response_H
#define OAIWebhookList_200_response_H
...
namespace OpenAPI {
class OAIWebhookList_200_response_result;

class OAIWebhookList_200_response : public OAIObject {
public:
    OAIWebhookList_200_response();
    OAIWebhookList_200_response(QString json);
    ~OAIWebhookList_200_response() override;
    ...
    OAIWebhookList_200_response_result getResult() const;
    void setResult(const OAIWebhookList_200_response_result &result);
...
private:
    ...
    OAIWebhookList_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookList_200_response)

#endif // OAIWebhookList_200_response_H
