...
#ifndef OAIModel_Response_Customer_Group_List_H
#define OAIModel_Response_Customer_Group_List_H
...
namespace OpenAPI {
class OAIPagination;
class OAIResponse_Customer_Group_List_Result;

class OAIModel_Response_Customer_Group_List : public OAIObject {
public:
    OAIModel_Response_Customer_Group_List();
    OAIModel_Response_Customer_Group_List(QString json);
    ~OAIModel_Response_Customer_Group_List() override;
    ...
    OAIResponse_Customer_Group_List_Result getResult() const;
    void setResult(const OAIResponse_Customer_Group_List_Result &result);
...
private:
    ...
    OAIResponse_Customer_Group_List_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Customer_Group_List)

#endif // OAIModel_Response_Customer_Group_List_H
