...
#ifndef OAIModel_Response_Cart_GiftCard_List_H
#define OAIModel_Response_Cart_GiftCard_List_H
...
namespace OpenAPI {
class OAIPagination;
class OAIResponse_Cart_Giftcard_List_Result;

class OAIModel_Response_Cart_GiftCard_List : public OAIObject {
public:
    OAIModel_Response_Cart_GiftCard_List();
    OAIModel_Response_Cart_GiftCard_List(QString json);
    ~OAIModel_Response_Cart_GiftCard_List() override;
    ...
    OAIResponse_Cart_Giftcard_List_Result getResult() const;
    void setResult(const OAIResponse_Cart_Giftcard_List_Result &result);
...
private:
    ...
    OAIResponse_Cart_Giftcard_List_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Cart_GiftCard_List)

#endif // OAIModel_Response_Cart_GiftCard_List_H
