...
#ifndef OAICustomerGroupAdd_200_response_H
#define OAICustomerGroupAdd_200_response_H
...
class OAICustomerGroupAdd_200_response : public OAIObject {
public:
    OAICustomerGroupAdd_200_response();
    OAICustomerGroupAdd_200_response(QString json);
    ~OAICustomerGroupAdd_200_response() override;
    ...
    QList<OAICustomer_Group> getResult() const;
    void setResult(const QList<OAICustomer_Group> &result);
...
private:
    ...
    QList<OAICustomer_Group> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerGroupAdd_200_response)

#endif // OAICustomerGroupAdd_200_response_H
