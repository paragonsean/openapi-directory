...
/*
 * OAICartShippingZonesList_200_response.h
 *
 * 
 */

#ifndef OAICartShippingZonesList_200_response_H
#define OAICartShippingZonesList_200_response_H
...
class OAICartShippingZonesList_200_response : public OAIObject {
public:
    OAICartShippingZonesList_200_response();
    OAICartShippingZonesList_200_response(QString json);
    ~OAICartShippingZonesList_200_response() override;
    ...
    OAICart_ShippingZone getResult() const;
    void setResult(const OAICart_ShippingZone &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAICartShippingZonesList_200_response)

#endif // OAICartShippingZonesList_200_response_H
