...
/*
 * OAICartConfig_200_response.h
 *
 * 
 */

#ifndef OAICartConfig_200_response_H
#define OAICartConfig_200_response_H
...
namespace OpenAPI {
class OAICartConfig_200_response_result;

class OAICartConfig_200_response : public OAIObject {
public:
    OAICartConfig_200_response();
    OAICartConfig_200_response(QString json);
    ~OAICartConfig_200_response() override;
    ...
    OAICartConfig_200_response_result getResult() const;
    void setResult(const OAICartConfig_200_response_result &result);
...
private:
    ...
    OAICartConfig_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICartConfig_200_response)

#endif // OAICartConfig_200_response_H
