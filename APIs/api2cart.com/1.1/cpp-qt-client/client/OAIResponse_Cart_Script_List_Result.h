...
#ifndef OAIResponse_Cart_Script_List_Result_H
#define OAIResponse_Cart_Script_List_Result_H
...
class OAIResponse_Cart_Script_List_Result : public OAIObject {
public:
    OAIResponse_Cart_Script_List_Result();
    OAIResponse_Cart_Script_List_Result(QString json);
    ~OAIResponse_Cart_Script_List_Result() override;
    ...
    QList<OAIScript> getScripts() const;
    void setScripts(const QList<OAIScript> &scripts);
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse_Cart_Script_List_Result)

#endif // OAIResponse_Cart_Script_List_Result_H
