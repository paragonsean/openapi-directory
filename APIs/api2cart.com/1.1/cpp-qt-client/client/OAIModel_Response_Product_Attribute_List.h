...
#ifndef OAIModel_Response_Product_Attribute_List_H
#define OAIModel_Response_Product_Attribute_List_H

#include <QJsonObject>

#include "OAIObject.h"
#include "OAIPagination.h"
#include "OAIResponse_Product_Attribute_List_Result.h"
#include <QString>
...
namespace OpenAPI {
class OAIPagination;
class OAIResponse_Product_Attribute_List_Result;

class OAIModel_Response_Product_Attribute_List : public OAIObject {
public:
    OAIModel_Response_Product_Attribute_List();
    OAIModel_Response_Product_Attribute_List(QString json);
    ~OAIModel_Response_Product_Attribute_List() override;
    ...
    OAIResponse_Product_Attribute_List_Result getResult() const;
    void setResult(const OAIResponse_Product_Attribute_List_Result &result);
...
private:
    ...
    OAIResponse_Product_Attribute_List_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Product_Attribute_List)

#endif // OAIModel_Response_Product_Attribute_List_H
