...
#ifndef OAIModel_Response_Order_Transaction_List_H
#define OAIModel_Response_Order_Transaction_List_H
...
namespace OpenAPI {
class OAIPagination;
class OAIResponse_Order_Transaction_List_Result;

class OAIModel_Response_Order_Transaction_List : public OAIObject {
public:
    OAIModel_Response_Order_Transaction_List();
    OAIModel_Response_Order_Transaction_List(QString json);
    ~OAIModel_Response_Order_Transaction_List() override;
    ...
    OAIResponse_Order_Transaction_List_Result getResult() const;
    void setResult(const OAIResponse_Order_Transaction_List_Result &result);
...
private:
    ...
    OAIResponse_Order_Transaction_List_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Order_Transaction_List)

#endif // OAIModel_Response_Order_Transaction_List_H
