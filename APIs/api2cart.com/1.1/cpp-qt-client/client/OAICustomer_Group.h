...
#ifndef OAICustomer_Group_H
#define OAICustomer_Group_H
...
class OAICustomer_Group : public OAIObject {
public:
    OAICustomer_Group();
    OAICustomer_Group(QString json);
    ~OAICustomer_Group() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomer_Group)

#endif // OAICustomer_Group_H
