...
#ifndef OAIProductCount_200_response_H
#define OAIProductCount_200_response_H
...
namespace OpenAPI {
class OAIProductCount_200_response_result;

class OAIProductCount_200_response : public OAIObject {
public:
    OAIProductCount_200_response();
    OAIProductCount_200_response(QString json);
    ~OAIProductCount_200_response() override;
    ...
    OAIProductCount_200_response_result getResult() const;
    void setResult(const OAIProductCount_200_response_result &result);
...
private:
    ...
    OAIProductCount_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductCount_200_response)

#endif // OAIProductCount_200_response_H
