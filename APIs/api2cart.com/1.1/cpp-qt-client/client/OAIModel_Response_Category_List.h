...
#ifndef OAIModel_Response_Category_List_H
#define OAIModel_Response_Category_List_H
...
namespace OpenAPI {
class OAIPagination;
class OAIResponse_Category_List_Result;

class OAIModel_Response_Category_List : public OAIObject {
public:
    OAIModel_Response_Category_List();
    OAIModel_Response_Category_List(QString json);
    ~OAIModel_Response_Category_List() override;
    ...
    OAIResponse_Category_List_Result getResult() const;
    void setResult(const OAIResponse_Category_List_Result &result);
...
private:
    ...
    OAIResponse_Category_List_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Category_List)

#endif // OAIModel_Response_Category_List_H
