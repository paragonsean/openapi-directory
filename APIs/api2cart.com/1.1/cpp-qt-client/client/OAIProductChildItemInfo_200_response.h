...
#ifndef OAIProductChildItemInfo_200_response_H
#define OAIProductChildItemInfo_200_response_H
...
class OAIProductChildItemInfo_200_response : public OAIObject {
public:
    OAIProductChildItemInfo_200_response();
    OAIProductChildItemInfo_200_response(QString json);
    ~OAIProductChildItemInfo_200_response() override;
    ...
    OAIChild getResult() const;
    void setResult(const OAIChild &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductChildItemInfo_200_response)

#endif // OAIProductChildItemInfo_200_response_H
