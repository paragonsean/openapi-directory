...
public class OrderStatus {
  ...
  private List<OrderStatusHistoryItem> history = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_REFUND_INFO = "refund_info";
  @SerializedName(SERIALIZED_NAME_REFUND_INFO)
  private OrderStatusRefund refundInfo;

  public OrderStatus() {
  }

  public OrderStatus additionalFields(Object additionalFields) {
  ...
  public OrderStatus customFields(Object customFields) {
  ...
  public OrderStatus history(List<OrderStatusHistoryItem> history) {
    this.history = history;
    return this;
  }

  public OrderStatus addHistoryItem(OrderStatusHistoryItem historyItem) {
  ...
  public OrderStatus refundInfo(OrderStatusRefund refundInfo) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.additionalFields, orderStatus.additionalFields) &&
        Objects.equals(this.customFields, orderStatus.customFields) &&
        Objects.equals(this.history, orderStatus.history) &&
        Objects.equals(this.id, orderStatus.id) &&
        Objects.equals(this.name, orderStatus.name) &&
        Objects.equals(this.refundInfo, orderStatus.refundInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(additionalFields, customFields, history, id, name, refundInfo);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("history") != null && !jsonObj.get("history").isJsonNull()) {
        ...
        if (jsonArrayhistory != null) {
          ...
          for (int i = 0; i < jsonArrayhistory.size(); i++) {
            OrderStatusHistoryItem.validateJsonElement(jsonArrayhistory.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("refund_info") != null && !jsonObj.get("refund_info").isJsonNull()) {
        OrderStatusRefund.validateJsonElement(jsonObj.get("refund_info"));
      }
  }
