...
public class ApiClient {
    ...
    private String basePath = "https://api.api2cart.com/v1.1";
    ...
    public ApiClient() {
        ...
        authentications.put("store_key", new ApiKeyAuth("header", "x-store-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.api2cart.com/v1.1
