...
public class CustomerAttribute {
  ...
  private List<CustomerAttributeValue> values = new ArrayList<>();

  public CustomerAttribute() {
  }

  public CustomerAttribute additionalFields(Object additionalFields) {
  ...
  public CustomerAttribute attributeId(String attributeId) {
  ...
  public CustomerAttribute code(String code) {
    this.code = code;
    return this;
  }
  ...
  public CustomerAttribute customFields(Object customFields) {
  ...
  public CustomerAttribute name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CustomerAttribute type(String type) {
    this.type = type;
    return this;
  }
  ...
  public CustomerAttribute values(List<CustomerAttributeValue> values) {
    this.values = values;
    return this;
  }

  public CustomerAttribute addValuesItem(CustomerAttributeValue valuesItem) {
    if (this.values == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.additionalFields, customerAttribute.additionalFields) &&
        Objects.equals(this.attributeId, customerAttribute.attributeId) &&
        Objects.equals(this.code, customerAttribute.code) &&
        Objects.equals(this.customFields, customerAttribute.customFields) &&
        Objects.equals(this.name, customerAttribute.name) &&
        Objects.equals(this.type, customerAttribute.type) &&
        Objects.equals(this.values, customerAttribute.values);
  }

  @Override
  public int hashCode() {
    return Objects.hash(additionalFields, attributeId, code, customFields, name, type, values);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomerAttribute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomerAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("values") != null && !jsonObj.get("values").isJsonNull()) {
        ...
        if (jsonArrayvalues != null) {
          ...
          for (int i = 0; i < jsonArrayvalues.size(); i++) {
            CustomerAttributeValue.validateJsonElement(jsonArrayvalues.get(i));
          };
        }
      }
  }
