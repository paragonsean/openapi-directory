...
void Example::exampleFunction1(){
     OAIActivitiesApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIActivitiesApi::createActivitySignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIActivitiesApi::createActivitySignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIActivity oai_activity = create(); // OAIActivity | 
      apiInstance.createActivity(oai_activity);
