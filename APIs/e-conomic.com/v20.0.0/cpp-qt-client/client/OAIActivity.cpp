...
void OAIActivity::initializeModel() {
    ...
    m_cost_price_markup_percentage_isSet = false;
    m_cost_price_markup_percentage_isValid = false;

    m_cutoff_date_isSet = false;
    m_cutoff_date_isValid = false;
    ...
    m_in_lieu_code_isSet = false;
    m_in_lieu_code_isValid = false;
    ...
    m_sales_price_after_isSet = false;
    m_sales_price_after_isValid = false;

    m_sales_price_before_isSet = false;
    m_sales_price_before_isValid = false;
}
...
void OAIActivity::fromJsonObject(QJsonObject json) {
    ...
    m_cost_price_markup_percentage_isValid = ::OpenAPI::fromJsonValue(m_cost_price_markup_percentage, json[QString("costPriceMarkupPercentage")]);
    m_cost_price_markup_percentage_isSet = !json[QString("costPriceMarkupPercentage")].isNull() && m_cost_price_markup_percentage_isValid;

    m_cutoff_date_isValid = ::OpenAPI::fromJsonValue(m_cutoff_date, json[QString("cutoffDate")]);
    m_cutoff_date_isSet = !json[QString("cutoffDate")].isNull() && m_cutoff_date_isValid;
    ...
    m_in_lieu_code_isValid = ::OpenAPI::fromJsonValue(m_in_lieu_code, json[QString("inLieuCode")]);
    m_in_lieu_code_isSet = !json[QString("inLieuCode")].isNull() && m_in_lieu_code_isValid;
    ...
    m_sales_price_after_isValid = ::OpenAPI::fromJsonValue(m_sales_price_after, json[QString("salesPriceAfter")]);
    m_sales_price_after_isSet = !json[QString("salesPriceAfter")].isNull() && m_sales_price_after_isValid;

    m_sales_price_before_isValid = ::OpenAPI::fromJsonValue(m_sales_price_before, json[QString("salesPriceBefore")]);
    m_sales_price_before_isSet = !json[QString("salesPriceBefore")].isNull() && m_sales_price_before_isValid;
}
...
QJsonObject OAIActivity::asJsonObject() const {
    QJsonObject obj;
    if (m_cost_price_markup_percentage_isSet) {
        obj.insert(QString("costPriceMarkupPercentage"), ::OpenAPI::toJsonValue(m_cost_price_markup_percentage));
    }
    if (m_cutoff_date_isSet) {
        obj.insert(QString("cutoffDate"), ::OpenAPI::toJsonValue(m_cutoff_date));
    }
    ...
    if (m_in_lieu_code_isSet) {
        obj.insert(QString("inLieuCode"), ::OpenAPI::toJsonValue(m_in_lieu_code));
    }
    ...
    if (m_sales_price_after_isSet) {
        obj.insert(QString("salesPriceAfter"), ::OpenAPI::toJsonValue(m_sales_price_after));
    }
    if (m_sales_price_before_isSet) {
        obj.insert(QString("salesPriceBefore"), ::OpenAPI::toJsonValue(m_sales_price_before));
    }
    return obj;
}

double OAIActivity::getCostPriceMarkupPercentage() const {
    return m_cost_price_markup_percentage;
}
void OAIActivity::setCostPriceMarkupPercentage(const double &cost_price_markup_percentage) {
    m_cost_price_markup_percentage = cost_price_markup_percentage;
    m_cost_price_markup_percentage_isSet = true;
}

bool OAIActivity::is_cost_price_markup_percentage_Set() const{
    return m_cost_price_markup_percentage_isSet;
}

bool OAIActivity::is_cost_price_markup_percentage_Valid() const{
    return m_cost_price_markup_percentage_isValid;
}

QDateTime OAIActivity::getCutoffDate() const {
    return m_cutoff_date;
}
void OAIActivity::setCutoffDate(const QDateTime &cutoff_date) {
    m_cutoff_date = cutoff_date;
    m_cutoff_date_isSet = true;
}

bool OAIActivity::is_cutoff_date_Set() const{
    return m_cutoff_date_isSet;
}

bool OAIActivity::is_cutoff_date_Valid() const{
    return m_cutoff_date_isValid;
}

qint32 OAIActivity::getGroupNumber() const {
    return m_group_number;
}
void OAIActivity::setGroupNumber(const qint32 &group_number) {
    m_group_number = group_number;
    m_group_number_isSet = true;
}

bool OAIActivity::is_group_number_Set() const{
    return m_group_number_isSet;
}

bool OAIActivity::is_group_number_Valid() const{
    return m_group_number_isValid;
}

bool OAIActivity::isHideInSearch() const {
    return m_hide_in_search;
}
void OAIActivity::setHideInSearch(const bool &hide_in_search) {
    m_hide_in_search = hide_in_search;
    m_hide_in_search_isSet = true;
}

bool OAIActivity::is_hide_in_search_Set() const{
    return m_hide_in_search_isSet;
}

bool OAIActivity::is_hide_in_search_Valid() const{
    return m_hide_in_search_isValid;
}

qint32 OAIActivity::getInLieuCode() const {
    return m_in_lieu_code;
}
void OAIActivity::setInLieuCode(const qint32 &in_lieu_code) {
    m_in_lieu_code = in_lieu_code;
    m_in_lieu_code_isSet = true;
}

bool OAIActivity::is_in_lieu_code_Set() const{
    return m_in_lieu_code_isSet;
}

bool OAIActivity::is_in_lieu_code_Valid() const{
    return m_in_lieu_code_isValid;
}

bool OAIActivity::isIsAccessible() const {
    return m_is_accessible;
}
void OAIActivity::setIsAccessible(const bool &is_accessible) {
    m_is_accessible = is_accessible;
    m_is_accessible_isSet = true;
}

bool OAIActivity::is_is_accessible_Set() const{
    return m_is_accessible_isSet;
}

bool OAIActivity::is_is_accessible_Valid() const{
...
qint32 OAIActivity::getNumber() const {
    return m_number;
}
void OAIActivity::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIActivity::is_number_Set() const{
    return m_number_isSet;
}

bool OAIActivity::is_number_Valid() const{
    return m_number_isValid;
}

QString OAIActivity::getObjectVersion() const {
    return m_object_version;
}
void OAIActivity::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAIActivity::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAIActivity::is_object_version_Valid() const{
    return m_object_version_isValid;
}

double OAIActivity::getSalesPriceAfter() const {
    return m_sales_price_after;
}
void OAIActivity::setSalesPriceAfter(const double &sales_price_after) {
    m_sales_price_after = sales_price_after;
    m_sales_price_after_isSet = true;
}

bool OAIActivity::is_sales_price_after_Set() const{
    return m_sales_price_after_isSet;
}

bool OAIActivity::is_sales_price_after_Valid() const{
    return m_sales_price_after_isValid;
}

double OAIActivity::getSalesPriceBefore() const {
    return m_sales_price_before;
}
void OAIActivity::setSalesPriceBefore(const double &sales_price_before) {
    m_sales_price_before = sales_price_before;
    m_sales_price_before_isSet = true;
}

bool OAIActivity::is_sales_price_before_Set() const{
    return m_sales_price_before_isSet;
}

bool OAIActivity::is_sales_price_before_Valid() const{
    return m_sales_price_before_isValid;
}
...
bool OAIActivity::isValid() const {
    ...
    return m_group_number_isValid && m_name_isValid && m_number_isValid && true;
}
