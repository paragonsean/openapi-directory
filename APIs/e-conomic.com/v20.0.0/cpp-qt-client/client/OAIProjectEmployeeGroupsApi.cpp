...
#include "OAIProjectEmployeeGroupsApi.h"
...
OAIProjectEmployeeGroupsApi::OAIProjectEmployeeGroupsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIProjectEmployeeGroupsApi::~OAIProjectEmployeeGroupsApi() {
}

void OAIProjectEmployeeGroupsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("createProjectEmployeeGroup", defaultConf);
    _serverIndices.insert("createProjectEmployeeGroup", 0);
    _serverConfigs.insert("deleteProjectEmployeeGroupById", defaultConf);
    _serverIndices.insert("deleteProjectEmployeeGroupById", 0);
    _serverConfigs.insert("getAllProjectEmployeeGroups", defaultConf);
    _serverIndices.insert("getAllProjectEmployeeGroups", 0);
    _serverConfigs.insert("getNumberOfProjectEmployeeGroups", defaultConf);
    _serverIndices.insert("getNumberOfProjectEmployeeGroups", 0);
    _serverConfigs.insert("getPageOfProjectEmployeeGroups", defaultConf);
    _serverIndices.insert("getPageOfProjectEmployeeGroups", 0);
    _serverConfigs.insert("getProjectEmployeeGroupById", defaultConf);
    _serverIndices.insert("getProjectEmployeeGroupById", 0);
    _serverConfigs.insert("updateProjectEmployeeGroup", defaultConf);
    _serverIndices.insert("updateProjectEmployeeGroup", 0);
}
...
*/
int OAIProjectEmployeeGroupsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIProjectEmployeeGroupsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIProjectEmployeeGroupsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIProjectEmployeeGroupsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIProjectEmployeeGroupsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIProjectEmployeeGroupsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIProjectEmployeeGroupsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIProjectEmployeeGroupsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIProjectEmployeeGroupsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIProjectEmployeeGroupsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProjectEmployeeGroupsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProjectEmployeeGroupsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIProjectEmployeeGroupsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIProjectEmployeeGroupsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIProjectEmployeeGroupsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIProjectEmployeeGroupsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIProjectEmployeeGroupsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIProjectEmployeeGroupsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIProjectEmployeeGroupsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIProjectEmployeeGroupsApi::createProjectEmployeeGroup(const ::OpenAPI::OptionalParam<OAIProjectEmployeeGroup> &oai_project_employee_group) {
    QString fullPath = QString(_serverConfigs["createProjectEmployeeGroup"][_serverIndices.value("createProjectEmployeeGroup")].URL()+"/project-employeegroups");
    ...
    if (oai_project_employee_group.hasValue()){

        
        QByteArray output = oai_project_employee_group.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeeGroupsApi::createProjectEmployeeGroupCallback);
    connect(this, &OAIProjectEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIProjectEmployeeGroupsApi::createProjectEmployeeGroupCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createProjectEmployeeGroupSignal(output);
        Q_EMIT createProjectEmployeeGroupSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createProjectEmployeeGroupSignalE(output, error_type, error_str);
        Q_EMIT createProjectEmployeeGroupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createProjectEmployeeGroupSignalError(output, error_type, error_str);
        Q_EMIT createProjectEmployeeGroupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeeGroupsApi::deleteProjectEmployeeGroupById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["deleteProjectEmployeeGroupById"][_serverIndices.value("deleteProjectEmployeeGroupById")].URL()+"/project-employeegroups/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeeGroupsApi::deleteProjectEmployeeGroupByIdCallback);
    connect(this, &OAIProjectEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectEmployeeGroupsApi::deleteProjectEmployeeGroupByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteProjectEmployeeGroupByIdSignal();
        Q_EMIT deleteProjectEmployeeGroupByIdSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteProjectEmployeeGroupByIdSignalE(error_type, error_str);
        Q_EMIT deleteProjectEmployeeGroupByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteProjectEmployeeGroupByIdSignalError(error_type, error_str);
        Q_EMIT deleteProjectEmployeeGroupByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeeGroupsApi::getAllProjectEmployeeGroups(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllProjectEmployeeGroups"][_serverIndices.value("getAllProjectEmployeeGroups")].URL()+"/project-employeegroups");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeeGroupsApi::getAllProjectEmployeeGroupsCallback);
    connect(this, &OAIProjectEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectEmployeeGroupsApi::getAllProjectEmployeeGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProjectEmployeeGroupCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllProjectEmployeeGroupsSignal(output);
        Q_EMIT getAllProjectEmployeeGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllProjectEmployeeGroupsSignalE(output, error_type, error_str);
        Q_EMIT getAllProjectEmployeeGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllProjectEmployeeGroupsSignalError(output, error_type, error_str);
        Q_EMIT getAllProjectEmployeeGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeeGroupsApi::getNumberOfProjectEmployeeGroups(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfProjectEmployeeGroups"][_serverIndices.value("getNumberOfProjectEmployeeGroups")].URL()+"/project-employeegroups/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeeGroupsApi::getNumberOfProjectEmployeeGroupsCallback);
    connect(this, &OAIProjectEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectEmployeeGroupsApi::getNumberOfProjectEmployeeGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfProjectEmployeeGroupsSignal(output);
        Q_EMIT getNumberOfProjectEmployeeGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfProjectEmployeeGroupsSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfProjectEmployeeGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfProjectEmployeeGroupsSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfProjectEmployeeGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeeGroupsApi::getPageOfProjectEmployeeGroups(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfProjectEmployeeGroups"][_serverIndices.value("getPageOfProjectEmployeeGroups")].URL()+"/project-employeegroups/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeeGroupsApi::getPageOfProjectEmployeeGroupsCallback);
    connect(this, &OAIProjectEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectEmployeeGroupsApi::getPageOfProjectEmployeeGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIProjectEmployeeGroup> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIProjectEmployeeGroup val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfProjectEmployeeGroupsSignal(output);
        Q_EMIT getPageOfProjectEmployeeGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfProjectEmployeeGroupsSignalE(output, error_type, error_str);
        Q_EMIT getPageOfProjectEmployeeGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfProjectEmployeeGroupsSignalError(output, error_type, error_str);
        Q_EMIT getPageOfProjectEmployeeGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeeGroupsApi::getProjectEmployeeGroupById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getProjectEmployeeGroupById"][_serverIndices.value("getProjectEmployeeGroupById")].URL()+"/project-employeegroups/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeeGroupsApi::getProjectEmployeeGroupByIdCallback);
    connect(this, &OAIProjectEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectEmployeeGroupsApi::getProjectEmployeeGroupByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProjectEmployeeGroup output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getProjectEmployeeGroupByIdSignal(output);
        Q_EMIT getProjectEmployeeGroupByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getProjectEmployeeGroupByIdSignalE(output, error_type, error_str);
        Q_EMIT getProjectEmployeeGroupByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getProjectEmployeeGroupByIdSignalError(output, error_type, error_str);
        Q_EMIT getProjectEmployeeGroupByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeeGroupsApi::updateProjectEmployeeGroup(const ::OpenAPI::OptionalParam<OAIProjectEmployeeGroup> &oai_project_employee_group) {
    QString fullPath = QString(_serverConfigs["updateProjectEmployeeGroup"][_serverIndices.value("updateProjectEmployeeGroup")].URL()+"/project-employeegroups");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeeGroupsApi::updateProjectEmployeeGroupCallback);
    connect(this, &OAIProjectEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectEmployeeGroupsApi::updateProjectEmployeeGroupCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateProjectEmployeeGroupSignal();
        Q_EMIT updateProjectEmployeeGroupSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateProjectEmployeeGroupSignalE(error_type, error_str);
        Q_EMIT updateProjectEmployeeGroupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateProjectEmployeeGroupSignalError(error_type, error_str);
        Q_EMIT updateProjectEmployeeGroupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeeGroupsApi::tokenAvailable(){
