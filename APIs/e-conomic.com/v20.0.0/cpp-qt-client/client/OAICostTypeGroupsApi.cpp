...
#include "OAICostTypeGroupsApi.h"
...
OAICostTypeGroupsApi::OAICostTypeGroupsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAICostTypeGroupsApi::~OAICostTypeGroupsApi() {
}

void OAICostTypeGroupsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getAllCostTypeGroups", defaultConf);
    _serverIndices.insert("getAllCostTypeGroups", 0);
    _serverConfigs.insert("getCostTypeGroupById", defaultConf);
    _serverIndices.insert("getCostTypeGroupById", 0);
    _serverConfigs.insert("getNumberOfCostTypeGroups", defaultConf);
    _serverIndices.insert("getNumberOfCostTypeGroups", 0);
    _serverConfigs.insert("getPageOfCostTypeGroups", defaultConf);
    _serverIndices.insert("getPageOfCostTypeGroups", 0);
}
...
*/
int OAICostTypeGroupsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAICostTypeGroupsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAICostTypeGroupsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAICostTypeGroupsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAICostTypeGroupsApi::setUsername(const QString &username) {
    _username = username;
}

void OAICostTypeGroupsApi::setPassword(const QString &password) {
    _password = password;
}


void OAICostTypeGroupsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAICostTypeGroupsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAICostTypeGroupsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAICostTypeGroupsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAICostTypeGroupsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAICostTypeGroupsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAICostTypeGroupsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAICostTypeGroupsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAICostTypeGroupsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAICostTypeGroupsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAICostTypeGroupsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAICostTypeGroupsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAICostTypeGroupsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAICostTypeGroupsApi::getAllCostTypeGroups(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllCostTypeGroups"][_serverIndices.value("getAllCostTypeGroups")].URL()+"/costtypegroups");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICostTypeGroupsApi::getAllCostTypeGroupsCallback);
    connect(this, &OAICostTypeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAICostTypeGroupsApi::getAllCostTypeGroupsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICostTypeGroupCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllCostTypeGroupsSignal(output);
        Q_EMIT getAllCostTypeGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllCostTypeGroupsSignalE(output, error_type, error_str);
        Q_EMIT getAllCostTypeGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllCostTypeGroupsSignalError(output, error_type, error_str);
        Q_EMIT getAllCostTypeGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICostTypeGroupsApi::getCostTypeGroupById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getCostTypeGroupById"][_serverIndices.value("getCostTypeGroupById")].URL()+"/costtypegroups/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICostTypeGroupsApi::getCostTypeGroupByIdCallback);
    connect(this, &OAICostTypeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICostTypeGroupsApi::getCostTypeGroupByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAICostTypeGroup output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getCostTypeGroupByIdSignal(output);
        Q_EMIT getCostTypeGroupByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getCostTypeGroupByIdSignalE(output, error_type, error_str);
        Q_EMIT getCostTypeGroupByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getCostTypeGroupByIdSignalError(output, error_type, error_str);
        Q_EMIT getCostTypeGroupByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICostTypeGroupsApi::getNumberOfCostTypeGroups(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfCostTypeGroups"][_serverIndices.value("getNumberOfCostTypeGroups")].URL()+"/costtypegroups/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICostTypeGroupsApi::getNumberOfCostTypeGroupsCallback);
    connect(this, &OAICostTypeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICostTypeGroupsApi::getNumberOfCostTypeGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfCostTypeGroupsSignal(output);
        Q_EMIT getNumberOfCostTypeGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfCostTypeGroupsSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfCostTypeGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfCostTypeGroupsSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfCostTypeGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICostTypeGroupsApi::getPageOfCostTypeGroups(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfCostTypeGroups"][_serverIndices.value("getPageOfCostTypeGroups")].URL()+"/costtypegroups/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICostTypeGroupsApi::getPageOfCostTypeGroupsCallback);
    connect(this, &OAICostTypeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICostTypeGroupsApi::getPageOfCostTypeGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAICostTypeGroup> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAICostTypeGroup val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfCostTypeGroupsSignal(output);
        Q_EMIT getPageOfCostTypeGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfCostTypeGroupsSignalE(output, error_type, error_str);
        Q_EMIT getPageOfCostTypeGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfCostTypeGroupsSignalError(output, error_type, error_str);
        Q_EMIT getPageOfCostTypeGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICostTypeGroupsApi::tokenAvailable(){
