...
void OAIError::initializeModel() {
    ...
    m_developer_hint_isSet = false;
    m_developer_hint_isValid = false;
    ...
    m_log_time_utc_isSet = false;
    m_log_time_utc_isValid = false;
...
void OAIError::fromJsonObject(QJsonObject json) {
    ...
    m_developer_hint_isValid = ::OpenAPI::fromJsonValue(m_developer_hint, json[QString("developerHint")]);
    m_developer_hint_isSet = !json[QString("developerHint")].isNull() && m_developer_hint_isValid;
    ...
    m_log_time_utc_isValid = ::OpenAPI::fromJsonValue(m_log_time_utc, json[QString("logTimeUtc")]);
    m_log_time_utc_isSet = !json[QString("logTimeUtc")].isNull() && m_log_time_utc_isValid;
...
QJsonObject OAIError::asJsonObject() const {
    QJsonObject obj;
    if (m_developer_hint_isSet) {
        obj.insert(QString("developerHint"), ::OpenAPI::toJsonValue(m_developer_hint));
    }
    ...
    if (m_log_time_utc_isSet) {
        obj.insert(QString("logTimeUtc"), ::OpenAPI::toJsonValue(m_log_time_utc));
    }
    if (m_message_isSet) {
...
QString OAIError::getDeveloperHint() const {
    return m_developer_hint;
}
void OAIError::setDeveloperHint(const QString &developer_hint) {
    m_developer_hint = developer_hint;
    m_developer_hint_isSet = true;
}

bool OAIError::is_developer_hint_Set() const{
    return m_developer_hint_isSet;
}

bool OAIError::is_developer_hint_Valid() const{
    return m_developer_hint_isValid;
}
...
QString OAIError::getLogId() const {
    return m_log_id;
}
void OAIError::setLogId(const QString &log_id) {
    m_log_id = log_id;
    m_log_id_isSet = true;
}

bool OAIError::is_log_id_Set() const{
    return m_log_id_isSet;
}

bool OAIError::is_log_id_Valid() const{
    return m_log_id_isValid;
}

QString OAIError::getLogTimeUtc() const {
    return m_log_time_utc;
}
void OAIError::setLogTimeUtc(const QString &log_time_utc) {
    m_log_time_utc = log_time_utc;
    m_log_time_utc_isSet = true;
}

bool OAIError::is_log_time_utc_Set() const{
    return m_log_time_utc_isSet;
}

bool OAIError::is_log_time_utc_Valid() const{
    return m_log_time_utc_isValid;
}
...
QString OAIError::getProperty() const {
    return m_property;
}
void OAIError::setProperty(const QString &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAIError::is_property_Set() const{
    return m_property_isSet;
}

bool OAIError::is_property_Valid() const{
