...
void OAICostType::initializeModel() {
    ...
    m_cost_group_number_isSet = false;
    m_cost_group_number_isValid = false;
...
void OAICostType::fromJsonObject(QJsonObject json) {

    m_cost_group_number_isValid = ::OpenAPI::fromJsonValue(m_cost_group_number, json[QString("costGroupNumber")]);
    m_cost_group_number_isSet = !json[QString("costGroupNumber")].isNull() && m_cost_group_number_isValid;
...
QJsonObject OAICostType::asJsonObject() const {
    QJsonObject obj;
    if (m_cost_group_number_isSet) {
        obj.insert(QString("costGroupNumber"), ::OpenAPI::toJsonValue(m_cost_group_number));
    }
...
qint32 OAICostType::getCostGroupNumber() const {
    return m_cost_group_number;
}
void OAICostType::setCostGroupNumber(const qint32 &cost_group_number) {
    m_cost_group_number = cost_group_number;
    m_cost_group_number_isSet = true;
}

bool OAICostType::is_cost_group_number_Set() const{
    return m_cost_group_number_isSet;
}

bool OAICostType::is_cost_group_number_Valid() const{
    return m_cost_group_number_isValid;
}

bool OAICostType::isIsBarred() const {
    return m_is_barred;
}
void OAICostType::setIsBarred(const bool &is_barred) {
    m_is_barred = is_barred;
    m_is_barred_isSet = true;
}

bool OAICostType::is_is_barred_Set() const{
    return m_is_barred_isSet;
}

bool OAICostType::is_is_barred_Valid() const{
    return m_is_barred_isValid;
}

QDateTime OAICostType::getLastUpdated() const {
    return m_last_updated;
}
void OAICostType::setLastUpdated(const QDateTime &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAICostType::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAICostType::is_last_updated_Valid() const{
    return m_last_updated_isValid;
}

QString OAICostType::getName() const {
    return m_name;
}
void OAICostType::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICostType::is_name_Set() const{
    return m_name_isSet;
}

bool OAICostType::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAICostType::getNumber() const {
    return m_number;
}
void OAICostType::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAICostType::is_number_Set() const{
    return m_number_isSet;
}

bool OAICostType::is_number_Valid() const{
    return m_number_isValid;
}

QString OAICostType::getObjectVersion() const {
    return m_object_version;
}
void OAICostType::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAICostType::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAICostType::is_object_version_Valid() const{
    return m_object_version_isValid;
}

QString OAICostType::getVatCode() const {
    return m_vat_code;
}
void OAICostType::setVatCode(const QString &vat_code) {
    m_vat_code = vat_code;
    m_vat_code_isSet = true;
}

bool OAICostType::is_vat_code_Set() const{
    return m_vat_code_isSet;
}

bool OAICostType::is_vat_code_Valid() const{
...
bool OAICostType::isValid() const {
    ...
    return m_cost_group_number_isValid && m_name_isValid && m_number_isValid && true;
}
