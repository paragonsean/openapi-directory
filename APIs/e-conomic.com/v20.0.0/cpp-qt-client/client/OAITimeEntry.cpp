...
void OAITimeEntry::initializeModel() {
    ...
    m_number_of_hours_isSet = false;
    m_number_of_hours_isValid = false;
...
void OAITimeEntry::fromJsonObject(QJsonObject json) {
    ...
    m_number_of_hours_isValid = ::OpenAPI::fromJsonValue(m_number_of_hours, json[QString("numberOfHours")]);
    m_number_of_hours_isSet = !json[QString("numberOfHours")].isNull() && m_number_of_hours_isValid;
...
QJsonObject OAITimeEntry::asJsonObject() const {
    ...
    if (m_number_of_hours_isSet) {
        obj.insert(QString("numberOfHours"), ::OpenAPI::toJsonValue(m_number_of_hours));
    }
...
qint32 OAITimeEntry::getActivityNumber() const {
    return m_activity_number;
}
void OAITimeEntry::setActivityNumber(const qint32 &activity_number) {
    m_activity_number = activity_number;
    m_activity_number_isSet = true;
}

bool OAITimeEntry::is_activity_number_Set() const{
    return m_activity_number_isSet;
}

bool OAITimeEntry::is_activity_number_Valid() const{
    return m_activity_number_isValid;
}

QDateTime OAITimeEntry::getDate() const {
    return m_date;
}
void OAITimeEntry::setDate(const QDateTime &date) {
    m_date = date;
    m_date_isSet = true;
}

bool OAITimeEntry::is_date_Set() const{
    return m_date_isSet;
}

bool OAITimeEntry::is_date_Valid() const{
    return m_date_isValid;
}

qint32 OAITimeEntry::getEmployeeNumber() const {
    return m_employee_number;
}
void OAITimeEntry::setEmployeeNumber(const qint32 &employee_number) {
    m_employee_number = employee_number;
    m_employee_number_isSet = true;
}

bool OAITimeEntry::is_employee_number_Set() const{
    return m_employee_number_isSet;
}

bool OAITimeEntry::is_employee_number_Valid() const{
    return m_employee_number_isValid;
}

bool OAITimeEntry::isIsApproved() const {
    return m_is_approved;
}
void OAITimeEntry::setIsApproved(const bool &is_approved) {
    m_is_approved = is_approved;
    m_is_approved_isSet = true;
}

bool OAITimeEntry::is_is_approved_Set() const{
    return m_is_approved_isSet;
}

bool OAITimeEntry::is_is_approved_Valid() const{
    return m_is_approved_isValid;
}

bool OAITimeEntry::isIsReconciled() const {
    return m_is_reconciled;
}
void OAITimeEntry::setIsReconciled(const bool &is_reconciled) {
    m_is_reconciled = is_reconciled;
    m_is_reconciled_isSet = true;
}

bool OAITimeEntry::is_is_reconciled_Set() const{
    return m_is_reconciled_isSet;
}

bool OAITimeEntry::is_is_reconciled_Valid() const{
    return m_is_reconciled_isValid;
}

QDateTime OAITimeEntry::getLastUpdated() const {
    return m_last_updated;
}
void OAITimeEntry::setLastUpdated(const QDateTime &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAITimeEntry::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAITimeEntry::is_last_updated_Valid() const{
    return m_last_updated_isValid;
}

qint32 OAITimeEntry::getNumber() const {
    return m_number;
}
void OAITimeEntry::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAITimeEntry::is_number_Set() const{
    return m_number_isSet;
}

bool OAITimeEntry::is_number_Valid() const{
    return m_number_isValid;
}

double OAITimeEntry::getNumberOfHours() const {
    return m_number_of_hours;
}
void OAITimeEntry::setNumberOfHours(const double &number_of_hours) {
    m_number_of_hours = number_of_hours;
    m_number_of_hours_isSet = true;
}

bool OAITimeEntry::is_number_of_hours_Set() const{
    return m_number_of_hours_isSet;
}

bool OAITimeEntry::is_number_of_hours_Valid() const{
    return m_number_of_hours_isValid;
}

QString OAITimeEntry::getObjectVersion() const {
    return m_object_version;
}
void OAITimeEntry::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAITimeEntry::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAITimeEntry::is_object_version_Valid() const{
    return m_object_version_isValid;
}

qint32 OAITimeEntry::getProjectNumber() const {
    return m_project_number;
}
void OAITimeEntry::setProjectNumber(const qint32 &project_number) {
    m_project_number = project_number;
    m_project_number_isSet = true;
}

bool OAITimeEntry::is_project_number_Set() const{
    return m_project_number_isSet;
}

bool OAITimeEntry::is_project_number_Valid() const{
    return m_project_number_isValid;
}

QString OAITimeEntry::getText() const {
    return m_text;
}
void OAITimeEntry::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAITimeEntry::is_text_Set() const{
    return m_text_isSet;
}

bool OAITimeEntry::is_text_Valid() const{
...
bool OAITimeEntry::isValid() const {
    ...
    return m_activity_number_isValid && m_date_isValid && m_employee_number_isValid && m_project_number_isValid && true;
}
