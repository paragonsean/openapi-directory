...
OAIProjectEmployee::OAIProjectEmployee(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProjectEmployee::OAIProjectEmployee() {
    this->initializeModel();
}

OAIProjectEmployee::~OAIProjectEmployee() {}

void OAIProjectEmployee::initializeModel() {

    m_address_isSet = false;
    m_address_isValid = false;

    m_can_approve_isSet = false;
    m_can_approve_isValid = false;

    m_can_invoice_isSet = false;
    m_can_invoice_isValid = false;

    m_city_isSet = false;
    m_city_isValid = false;

    m_cost_price_after_isSet = false;
    m_cost_price_after_isValid = false;

    m_cost_price_before_isSet = false;
    m_cost_price_before_isValid = false;
    ...
    m_is_barred_isSet = false;
    m_is_barred_isValid = false;

    m_is_user_isSet = false;
    m_is_user_isValid = false;
...
void OAIProjectEmployee::fromJson(QString jsonString) {
...
void OAIProjectEmployee::fromJsonObject(QJsonObject json) {

    m_address_isValid = ::OpenAPI::fromJsonValue(m_address, json[QString("address")]);
    m_address_isSet = !json[QString("address")].isNull() && m_address_isValid;

    m_can_approve_isValid = ::OpenAPI::fromJsonValue(m_can_approve, json[QString("canApprove")]);
    m_can_approve_isSet = !json[QString("canApprove")].isNull() && m_can_approve_isValid;

    m_can_invoice_isValid = ::OpenAPI::fromJsonValue(m_can_invoice, json[QString("canInvoice")]);
    m_can_invoice_isSet = !json[QString("canInvoice")].isNull() && m_can_invoice_isValid;

    m_city_isValid = ::OpenAPI::fromJsonValue(m_city, json[QString("city")]);
    m_city_isSet = !json[QString("city")].isNull() && m_city_isValid;

    m_cost_price_after_isValid = ::OpenAPI::fromJsonValue(m_cost_price_after, json[QString("costPriceAfter")]);
    m_cost_price_after_isSet = !json[QString("costPriceAfter")].isNull() && m_cost_price_after_isValid;

    m_cost_price_before_isValid = ::OpenAPI::fromJsonValue(m_cost_price_before, json[QString("costPriceBefore")]);
    m_cost_price_before_isSet = !json[QString("costPriceBefore")].isNull() && m_cost_price_before_isValid;
    ...
    m_is_barred_isValid = ::OpenAPI::fromJsonValue(m_is_barred, json[QString("isBarred")]);
    m_is_barred_isSet = !json[QString("isBarred")].isNull() && m_is_barred_isValid;

    m_is_user_isValid = ::OpenAPI::fromJsonValue(m_is_user, json[QString("isUser")]);
    m_is_user_isSet = !json[QString("isUser")].isNull() && m_is_user_isValid;
...
QString OAIProjectEmployee::asJson() const {
...
QJsonObject OAIProjectEmployee::asJsonObject() const {
    QJsonObject obj;
    if (m_address_isSet) {
        obj.insert(QString("address"), ::OpenAPI::toJsonValue(m_address));
    }
    if (m_can_approve_isSet) {
        obj.insert(QString("canApprove"), ::OpenAPI::toJsonValue(m_can_approve));
    }
    if (m_can_invoice_isSet) {
        obj.insert(QString("canInvoice"), ::OpenAPI::toJsonValue(m_can_invoice));
    }
    if (m_city_isSet) {
        obj.insert(QString("city"), ::OpenAPI::toJsonValue(m_city));
    }
    if (m_cost_price_after_isSet) {
        obj.insert(QString("costPriceAfter"), ::OpenAPI::toJsonValue(m_cost_price_after));
    }
    if (m_cost_price_before_isSet) {
        obj.insert(QString("costPriceBefore"), ::OpenAPI::toJsonValue(m_cost_price_before));
    }
    if (m_cut_off_date_isSet) {
        obj.insert(QString("cutOffDate"), ::OpenAPI::toJsonValue(m_cut_off_date));
    }
    if (m_employee_type.isSet()) {
    ...
    if (m_is_barred_isSet) {
        obj.insert(QString("isBarred"), ::OpenAPI::toJsonValue(m_is_barred));
    }
    if (m_is_user_isSet) {
        obj.insert(QString("isUser"), ::OpenAPI::toJsonValue(m_is_user));
    }
    if (m_name_isSet) {
...
QString OAIProjectEmployee::getAddress() const {
    return m_address;
}
void OAIProjectEmployee::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIProjectEmployee::is_address_Set() const{
    return m_address_isSet;
}

bool OAIProjectEmployee::is_address_Valid() const{
    return m_address_isValid;
}

bool OAIProjectEmployee::isCanApprove() const {
    return m_can_approve;
}
void OAIProjectEmployee::setCanApprove(const bool &can_approve) {
    m_can_approve = can_approve;
    m_can_approve_isSet = true;
}

bool OAIProjectEmployee::is_can_approve_Set() const{
    return m_can_approve_isSet;
}

bool OAIProjectEmployee::is_can_approve_Valid() const{
    return m_can_approve_isValid;
}

bool OAIProjectEmployee::isCanInvoice() const {
    return m_can_invoice;
}
void OAIProjectEmployee::setCanInvoice(const bool &can_invoice) {
    m_can_invoice = can_invoice;
    m_can_invoice_isSet = true;
}

bool OAIProjectEmployee::is_can_invoice_Set() const{
    return m_can_invoice_isSet;
}

bool OAIProjectEmployee::is_can_invoice_Valid() const{
    return m_can_invoice_isValid;
}

QString OAIProjectEmployee::getCity() const {
    return m_city;
}
void OAIProjectEmployee::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIProjectEmployee::is_city_Set() const{
    return m_city_isSet;
}

bool OAIProjectEmployee::is_city_Valid() const{
    return m_city_isValid;
}

double OAIProjectEmployee::getCostPriceAfter() const {
    return m_cost_price_after;
}
void OAIProjectEmployee::setCostPriceAfter(const double &cost_price_after) {
    m_cost_price_after = cost_price_after;
    m_cost_price_after_isSet = true;
}

bool OAIProjectEmployee::is_cost_price_after_Set() const{
    return m_cost_price_after_isSet;
}

bool OAIProjectEmployee::is_cost_price_after_Valid() const{
    return m_cost_price_after_isValid;
}

double OAIProjectEmployee::getCostPriceBefore() const {
    return m_cost_price_before;
}
void OAIProjectEmployee::setCostPriceBefore(const double &cost_price_before) {
    m_cost_price_before = cost_price_before;
    m_cost_price_before_isSet = true;
}

bool OAIProjectEmployee::is_cost_price_before_Set() const{
    return m_cost_price_before_isSet;
}

bool OAIProjectEmployee::is_cost_price_before_Valid() const{
    return m_cost_price_before_isValid;
}

QDate OAIProjectEmployee::getCutOffDate() const {
    return m_cut_off_date;
}
void OAIProjectEmployee::setCutOffDate(const QDate &cut_off_date) {
    m_cut_off_date = cut_off_date;
    m_cut_off_date_isSet = true;
}

bool OAIProjectEmployee::is_cut_off_date_Set() const{
    return m_cut_off_date_isSet;
}

bool OAIProjectEmployee::is_cut_off_date_Valid() const{
    return m_cut_off_date_isValid;
}

OAIEmployeeType OAIProjectEmployee::getEmployeeType() const {
    return m_employee_type;
}
void OAIProjectEmployee::setEmployeeType(const OAIEmployeeType &employee_type) {
    m_employee_type = employee_type;
    m_employee_type_isSet = true;
}

bool OAIProjectEmployee::is_employee_type_Set() const{
    return m_employee_type_isSet;
}

bool OAIProjectEmployee::is_employee_type_Valid() const{
    return m_employee_type_isValid;
}

qint32 OAIProjectEmployee::getGroupNumber() const {
    return m_group_number;
}
void OAIProjectEmployee::setGroupNumber(const qint32 &group_number) {
    m_group_number = group_number;
    m_group_number_isSet = true;
}

bool OAIProjectEmployee::is_group_number_Set() const{
    return m_group_number_isSet;
}

bool OAIProjectEmployee::is_group_number_Valid() const{
    return m_group_number_isValid;
}

bool OAIProjectEmployee::isIsBarred() const {
    return m_is_barred;
}
void OAIProjectEmployee::setIsBarred(const bool &is_barred) {
    m_is_barred = is_barred;
    m_is_barred_isSet = true;
}

bool OAIProjectEmployee::is_is_barred_Set() const{
    return m_is_barred_isSet;
}

bool OAIProjectEmployee::is_is_barred_Valid() const{
    return m_is_barred_isValid;
}

bool OAIProjectEmployee::isIsUser() const {
    return m_is_user;
}
void OAIProjectEmployee::setIsUser(const bool &is_user) {
    m_is_user = is_user;
    m_is_user_isSet = true;
}

bool OAIProjectEmployee::is_is_user_Set() const{
    return m_is_user_isSet;
}

bool OAIProjectEmployee::is_is_user_Valid() const{
    return m_is_user_isValid;
}

QString OAIProjectEmployee::getName() const {
    return m_name;
}
void OAIProjectEmployee::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProjectEmployee::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProjectEmployee::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIProjectEmployee::getNumber() const {
    return m_number;
}
void OAIProjectEmployee::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIProjectEmployee::is_number_Set() const{
    return m_number_isSet;
}

bool OAIProjectEmployee::is_number_Valid() const{
    return m_number_isValid;
}

QString OAIProjectEmployee::getObjectVersion() const {
    return m_object_version;
}
void OAIProjectEmployee::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAIProjectEmployee::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAIProjectEmployee::is_object_version_Valid() const{
    return m_object_version_isValid;
}

double OAIProjectEmployee::getSalesPriceAfter() const {
    return m_sales_price_after;
}
void OAIProjectEmployee::setSalesPriceAfter(const double &sales_price_after) {
    m_sales_price_after = sales_price_after;
    m_sales_price_after_isSet = true;
}

bool OAIProjectEmployee::is_sales_price_after_Set() const{
    return m_sales_price_after_isSet;
}

bool OAIProjectEmployee::is_sales_price_after_Valid() const{
    return m_sales_price_after_isValid;
}

double OAIProjectEmployee::getSalesPriceBefore() const {
    return m_sales_price_before;
}
void OAIProjectEmployee::setSalesPriceBefore(const double &sales_price_before) {
    m_sales_price_before = sales_price_before;
    m_sales_price_before_isSet = true;
}

bool OAIProjectEmployee::is_sales_price_before_Set() const{
    return m_sales_price_before_isSet;
}

bool OAIProjectEmployee::is_sales_price_before_Valid() const{
    return m_sales_price_before_isValid;
}

QString OAIProjectEmployee::getUserId() const {
    return m_user_id;
}
void OAIProjectEmployee::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIProjectEmployee::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIProjectEmployee::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QString OAIProjectEmployee::getZipCode() const {
    return m_zip_code;
}
void OAIProjectEmployee::setZipCode(const QString &zip_code) {
    m_zip_code = zip_code;
    m_zip_code_isSet = true;
}

bool OAIProjectEmployee::is_zip_code_Set() const{
    return m_zip_code_isSet;
}

bool OAIProjectEmployee::is_zip_code_Valid() const{
    return m_zip_code_isValid;
}

bool OAIProjectEmployee::isSet() const {
...
bool OAIProjectEmployee::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_can_approve_isValid && m_can_invoice_isValid && m_group_number_isValid && m_is_barred_isValid && m_name_isValid && m_number_isValid && true;
}
