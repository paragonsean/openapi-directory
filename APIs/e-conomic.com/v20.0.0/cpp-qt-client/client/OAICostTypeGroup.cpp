...
OAICostTypeGroup::OAICostTypeGroup(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICostTypeGroup::OAICostTypeGroup() {
    this->initializeModel();
}

OAICostTypeGroup::~OAICostTypeGroup() {}

void OAICostTypeGroup::initializeModel() {

    m_account_closed_isSet = false;
    m_account_closed_isValid = false;

    m_account_on_going_isSet = false;
    m_account_on_going_isValid = false;
...
void OAICostTypeGroup::fromJson(QString jsonString) {
...
void OAICostTypeGroup::fromJsonObject(QJsonObject json) {

    m_account_closed_isValid = ::OpenAPI::fromJsonValue(m_account_closed, json[QString("accountClosed")]);
    m_account_closed_isSet = !json[QString("accountClosed")].isNull() && m_account_closed_isValid;

    m_account_on_going_isValid = ::OpenAPI::fromJsonValue(m_account_on_going, json[QString("accountOnGoing")]);
    m_account_on_going_isSet = !json[QString("accountOnGoing")].isNull() && m_account_on_going_isValid;
...
QString OAICostTypeGroup::asJson() const {
...
QJsonObject OAICostTypeGroup::asJsonObject() const {
    QJsonObject obj;
    if (m_account_closed_isSet) {
        obj.insert(QString("accountClosed"), ::OpenAPI::toJsonValue(m_account_closed));
    }
    if (m_account_on_going_isSet) {
        obj.insert(QString("accountOnGoing"), ::OpenAPI::toJsonValue(m_account_on_going));
    }
    if (m_markup_isSet) {
...
qint32 OAICostTypeGroup::getAccountClosed() const {
    return m_account_closed;
}
void OAICostTypeGroup::setAccountClosed(const qint32 &account_closed) {
    m_account_closed = account_closed;
    m_account_closed_isSet = true;
}

bool OAICostTypeGroup::is_account_closed_Set() const{
    return m_account_closed_isSet;
}

bool OAICostTypeGroup::is_account_closed_Valid() const{
    return m_account_closed_isValid;
}

qint32 OAICostTypeGroup::getAccountOnGoing() const {
    return m_account_on_going;
}
void OAICostTypeGroup::setAccountOnGoing(const qint32 &account_on_going) {
    m_account_on_going = account_on_going;
    m_account_on_going_isSet = true;
}

bool OAICostTypeGroup::is_account_on_going_Set() const{
    return m_account_on_going_isSet;
}

bool OAICostTypeGroup::is_account_on_going_Valid() const{
    return m_account_on_going_isValid;
}

double OAICostTypeGroup::getMarkup() const {
    return m_markup;
}
void OAICostTypeGroup::setMarkup(const double &markup) {
    m_markup = markup;
    m_markup_isSet = true;
}

bool OAICostTypeGroup::is_markup_Set() const{
    return m_markup_isSet;
}

bool OAICostTypeGroup::is_markup_Valid() const{
    return m_markup_isValid;
}

QString OAICostTypeGroup::getName() const {
    return m_name;
}
void OAICostTypeGroup::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICostTypeGroup::is_name_Set() const{
    return m_name_isSet;
}

bool OAICostTypeGroup::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAICostTypeGroup::getNumber() const {
    return m_number;
}
void OAICostTypeGroup::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAICostTypeGroup::is_number_Set() const{
    return m_number_isSet;
}

bool OAICostTypeGroup::is_number_Valid() const{
    return m_number_isValid;
}

QString OAICostTypeGroup::getObjectVersion() const {
    return m_object_version;
}
void OAICostTypeGroup::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAICostTypeGroup::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAICostTypeGroup::is_object_version_Valid() const{
    return m_object_version_isValid;
}

OAICostGroupType OAICostTypeGroup::getType() const {
    return m_type;
}
void OAICostTypeGroup::setType(const OAICostGroupType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICostTypeGroup::is_type_Set() const{
    return m_type_isSet;
}

bool OAICostTypeGroup::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICostTypeGroup::isSet() const {
...
bool OAICostTypeGroup::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_account_closed_isValid && m_account_on_going_isValid && m_name_isValid && m_number_isValid && m_type_isValid && true;
}
