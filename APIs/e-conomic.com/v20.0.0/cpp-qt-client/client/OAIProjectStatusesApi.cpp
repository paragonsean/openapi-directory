...
void OAIProjectStatusesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getAllProjectStatuses", defaultConf);
    _serverIndices.insert("getAllProjectStatuses", 0);
    _serverConfigs.insert("getNumberOfProjectStatuses", defaultConf);
    _serverIndices.insert("getNumberOfProjectStatuses", 0);
    _serverConfigs.insert("getPageOfProjectStatuses", defaultConf);
    _serverIndices.insert("getPageOfProjectStatuses", 0);
    _serverConfigs.insert("getProjectStatusById", defaultConf);
    _serverIndices.insert("getProjectStatusById", 0);
}
...
void OAIProjectStatusesApi::getAllProjectStatuses(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllProjectStatuses"][_serverIndices.value("getAllProjectStatuses")].URL()+"/projectstatuses");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectStatusesApi::getAllProjectStatusesCallback);
...
void OAIProjectStatusesApi::getAllProjectStatusesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIProjectStatusCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllProjectStatusesSignal(output);
        Q_EMIT getAllProjectStatusesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllProjectStatusesSignalE(output, error_type, error_str);
        Q_EMIT getAllProjectStatusesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllProjectStatusesSignalError(output, error_type, error_str);
        Q_EMIT getAllProjectStatusesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectStatusesApi::getNumberOfProjectStatuses(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfProjectStatuses"][_serverIndices.value("getNumberOfProjectStatuses")].URL()+"/projectstatuses/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectStatusesApi::getNumberOfProjectStatusesCallback);
    connect(this, &OAIProjectStatusesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectStatusesApi::getNumberOfProjectStatusesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfProjectStatusesSignal(output);
        Q_EMIT getNumberOfProjectStatusesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfProjectStatusesSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfProjectStatusesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfProjectStatusesSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfProjectStatusesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectStatusesApi::getPageOfProjectStatuses(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfProjectStatuses"][_serverIndices.value("getPageOfProjectStatuses")].URL()+"/projectstatuses/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectStatusesApi::getPageOfProjectStatusesCallback);
    connect(this, &OAIProjectStatusesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectStatusesApi::getPageOfProjectStatusesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIProjectStatus> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIProjectStatus val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfProjectStatusesSignal(output);
        Q_EMIT getPageOfProjectStatusesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfProjectStatusesSignalE(output, error_type, error_str);
        Q_EMIT getPageOfProjectStatusesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfProjectStatusesSignalError(output, error_type, error_str);
        Q_EMIT getPageOfProjectStatusesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectStatusesApi::getProjectStatusById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getProjectStatusById"][_serverIndices.value("getProjectStatusById")].URL()+"/projectstatuses/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectStatusesApi::getProjectStatusByIdCallback);
    connect(this, &OAIProjectStatusesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectStatusesApi::getProjectStatusByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProjectStatus output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getProjectStatusByIdSignal(output);
        Q_EMIT getProjectStatusByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getProjectStatusByIdSignalE(output, error_type, error_str);
        Q_EMIT getProjectStatusByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getProjectStatusByIdSignalError(output, error_type, error_str);
        Q_EMIT getProjectStatusByIdSignalErrorFull(worker, error_type, error_str);
    }
}
