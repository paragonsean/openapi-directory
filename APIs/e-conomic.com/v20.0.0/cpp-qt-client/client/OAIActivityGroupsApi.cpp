...
#include "OAIActivityGroupsApi.h"
...
OAIActivityGroupsApi::OAIActivityGroupsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIActivityGroupsApi::~OAIActivityGroupsApi() {
}

void OAIActivityGroupsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("createActivityGroup", defaultConf);
    _serverIndices.insert("createActivityGroup", 0);
    _serverConfigs.insert("getActivityGroupById", defaultConf);
    _serverIndices.insert("getActivityGroupById", 0);
    _serverConfigs.insert("getAllActivityGroups", defaultConf);
    _serverIndices.insert("getAllActivityGroups", 0);
    _serverConfigs.insert("getNumberOfActivityGroups", defaultConf);
    _serverIndices.insert("getNumberOfActivityGroups", 0);
    _serverConfigs.insert("getPageOfActivityGroups", defaultConf);
    _serverIndices.insert("getPageOfActivityGroups", 0);
}
...
*/
int OAIActivityGroupsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIActivityGroupsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIActivityGroupsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIActivityGroupsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIActivityGroupsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIActivityGroupsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIActivityGroupsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIActivityGroupsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIActivityGroupsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIActivityGroupsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIActivityGroupsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIActivityGroupsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIActivityGroupsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIActivityGroupsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIActivityGroupsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIActivityGroupsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIActivityGroupsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIActivityGroupsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIActivityGroupsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIActivityGroupsApi::createActivityGroup(const ::OpenAPI::OptionalParam<OAIActivityGroup> &oai_activity_group) {
    QString fullPath = QString(_serverConfigs["createActivityGroup"][_serverIndices.value("createActivityGroup")].URL()+"/activitygroups");
    ...
    if (oai_activity_group.hasValue()){

        
        QByteArray output = oai_activity_group.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIActivityGroupsApi::createActivityGroupCallback);
    connect(this, &OAIActivityGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIActivityGroupsApi::createActivityGroupCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createActivityGroupSignal(output);
        Q_EMIT createActivityGroupSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createActivityGroupSignalE(output, error_type, error_str);
        Q_EMIT createActivityGroupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createActivityGroupSignalError(output, error_type, error_str);
        Q_EMIT createActivityGroupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIActivityGroupsApi::getActivityGroupById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getActivityGroupById"][_serverIndices.value("getActivityGroupById")].URL()+"/activitygroups/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIActivityGroupsApi::getActivityGroupByIdCallback);
    connect(this, &OAIActivityGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIActivityGroupsApi::getActivityGroupByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIActivityGroup output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getActivityGroupByIdSignal(output);
        Q_EMIT getActivityGroupByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getActivityGroupByIdSignalE(output, error_type, error_str);
        Q_EMIT getActivityGroupByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getActivityGroupByIdSignalError(output, error_type, error_str);
        Q_EMIT getActivityGroupByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIActivityGroupsApi::getAllActivityGroups(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllActivityGroups"][_serverIndices.value("getAllActivityGroups")].URL()+"/activitygroups");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIActivityGroupsApi::getAllActivityGroupsCallback);
    connect(this, &OAIActivityGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIActivityGroupsApi::getAllActivityGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIActivityGroupCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllActivityGroupsSignal(output);
        Q_EMIT getAllActivityGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllActivityGroupsSignalE(output, error_type, error_str);
        Q_EMIT getAllActivityGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllActivityGroupsSignalError(output, error_type, error_str);
        Q_EMIT getAllActivityGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIActivityGroupsApi::getNumberOfActivityGroups(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfActivityGroups"][_serverIndices.value("getNumberOfActivityGroups")].URL()+"/activitygroups/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIActivityGroupsApi::getNumberOfActivityGroupsCallback);
    connect(this, &OAIActivityGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIActivityGroupsApi::getNumberOfActivityGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfActivityGroupsSignal(output);
        Q_EMIT getNumberOfActivityGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfActivityGroupsSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfActivityGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfActivityGroupsSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfActivityGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIActivityGroupsApi::getPageOfActivityGroups(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfActivityGroups"][_serverIndices.value("getPageOfActivityGroups")].URL()+"/activitygroups/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIActivityGroupsApi::getPageOfActivityGroupsCallback);
    connect(this, &OAIActivityGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIActivityGroupsApi::getPageOfActivityGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIActivityGroup> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIActivityGroup val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfActivityGroupsSignal(output);
        Q_EMIT getPageOfActivityGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfActivityGroupsSignalE(output, error_type, error_str);
        Q_EMIT getPageOfActivityGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfActivityGroupsSignalError(output, error_type, error_str);
        Q_EMIT getPageOfActivityGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIActivityGroupsApi::tokenAvailable(){
