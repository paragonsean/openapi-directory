...
void OAIProject::initializeModel() {
    ...
    m_delivery_location_number_isSet = false;
    m_delivery_location_number_isValid = false;

    m_department_number_isSet = false;
    m_department_number_isValid = false;
    ...
    m_invoiced_total_isSet = false;
    m_invoiced_total_isValid = false;
    ...
    m_is_main_project_isSet = false;
    m_is_main_project_isValid = false;

    m_is_mileage_invoiced_isSet = false;
    m_is_mileage_invoiced_isValid = false;

    m_last_updated_isSet = false;
    m_last_updated_isValid = false;

    m_main_project_number_isSet = false;
    m_main_project_number_isValid = false;

    m_mileage_isSet = false;
    m_mileage_isValid = false;
    ...
    m_other_responsible_employee_number_isSet = false;
    m_other_responsible_employee_number_isValid = false;

    m_project_group_number_isSet = false;
    m_project_group_number_isValid = false;
...
void OAIProject::fromJsonObject(QJsonObject json) {
    ...
    m_delivery_location_number_isValid = ::OpenAPI::fromJsonValue(m_delivery_location_number, json[QString("deliveryLocationNumber")]);
    m_delivery_location_number_isSet = !json[QString("deliveryLocationNumber")].isNull() && m_delivery_location_number_isValid;

    m_department_number_isValid = ::OpenAPI::fromJsonValue(m_department_number, json[QString("departmentNumber")]);
    m_department_number_isSet = !json[QString("departmentNumber")].isNull() && m_department_number_isValid;
    ...
    m_invoiced_total_isValid = ::OpenAPI::fromJsonValue(m_invoiced_total, json[QString("invoicedTotal")]);
    m_invoiced_total_isSet = !json[QString("invoicedTotal")].isNull() && m_invoiced_total_isValid;
    ...
    m_is_main_project_isValid = ::OpenAPI::fromJsonValue(m_is_main_project, json[QString("isMainProject")]);
    m_is_main_project_isSet = !json[QString("isMainProject")].isNull() && m_is_main_project_isValid;

    m_is_mileage_invoiced_isValid = ::OpenAPI::fromJsonValue(m_is_mileage_invoiced, json[QString("isMileageInvoiced")]);
    m_is_mileage_invoiced_isSet = !json[QString("isMileageInvoiced")].isNull() && m_is_mileage_invoiced_isValid;

    m_last_updated_isValid = ::OpenAPI::fromJsonValue(m_last_updated, json[QString("lastUpdated")]);
    m_last_updated_isSet = !json[QString("lastUpdated")].isNull() && m_last_updated_isValid;

    m_main_project_number_isValid = ::OpenAPI::fromJsonValue(m_main_project_number, json[QString("mainProjectNumber")]);
    m_main_project_number_isSet = !json[QString("mainProjectNumber")].isNull() && m_main_project_number_isValid;

    m_mileage_isValid = ::OpenAPI::fromJsonValue(m_mileage, json[QString("mileage")]);
    m_mileage_isSet = !json[QString("mileage")].isNull() && m_mileage_isValid;
    ...
    m_other_responsible_employee_number_isValid = ::OpenAPI::fromJsonValue(m_other_responsible_employee_number, json[QString("otherResponsibleEmployeeNumber")]);
    m_other_responsible_employee_number_isSet = !json[QString("otherResponsibleEmployeeNumber")].isNull() && m_other_responsible_employee_number_isValid;

    m_project_group_number_isValid = ::OpenAPI::fromJsonValue(m_project_group_number, json[QString("projectGroupNumber")]);
    m_project_group_number_isSet = !json[QString("projectGroupNumber")].isNull() && m_project_group_number_isValid;
...
QJsonObject OAIProject::asJsonObject() const {
    ...
    if (m_delivery_location_number_isSet) {
        obj.insert(QString("deliveryLocationNumber"), ::OpenAPI::toJsonValue(m_delivery_location_number));
    }
    if (m_department_number_isSet) {
        obj.insert(QString("departmentNumber"), ::OpenAPI::toJsonValue(m_department_number));
    }
    ...
    if (m_invoiced_total_isSet) {
        obj.insert(QString("invoicedTotal"), ::OpenAPI::toJsonValue(m_invoiced_total));
    }
    ...
    if (m_is_main_project_isSet) {
        obj.insert(QString("isMainProject"), ::OpenAPI::toJsonValue(m_is_main_project));
    }
    if (m_is_mileage_invoiced_isSet) {
        obj.insert(QString("isMileageInvoiced"), ::OpenAPI::toJsonValue(m_is_mileage_invoiced));
    }
    if (m_last_updated_isSet) {
        obj.insert(QString("lastUpdated"), ::OpenAPI::toJsonValue(m_last_updated));
    }
    if (m_main_project_number_isSet) {
        obj.insert(QString("mainProjectNumber"), ::OpenAPI::toJsonValue(m_main_project_number));
    }
    if (m_mileage_isSet) {
        obj.insert(QString("mileage"), ::OpenAPI::toJsonValue(m_mileage));
    }
    if (m_name_isSet) {
    ...
    if (m_other_responsible_employee_number_isSet) {
        obj.insert(QString("otherResponsibleEmployeeNumber"), ::OpenAPI::toJsonValue(m_other_responsible_employee_number));
    }
    if (m_project_group_number_isSet) {
        obj.insert(QString("projectGroupNumber"), ::OpenAPI::toJsonValue(m_project_group_number));
    }
...
QDateTime OAIProject::getClosedDate() const {
    return m_closed_date;
}
void OAIProject::setClosedDate(const QDateTime &closed_date) {
    m_closed_date = closed_date;
    m_closed_date_isSet = true;
}

bool OAIProject::is_closed_date_Set() const{
    return m_closed_date_isSet;
}

bool OAIProject::is_closed_date_Valid() const{
    return m_closed_date_isValid;
}

qint32 OAIProject::getContactPersonId() const {
    return m_contact_person_id;
}
void OAIProject::setContactPersonId(const qint32 &contact_person_id) {
    m_contact_person_id = contact_person_id;
    m_contact_person_id_isSet = true;
}

bool OAIProject::is_contact_person_id_Set() const{
    return m_contact_person_id_isSet;
}

bool OAIProject::is_contact_person_id_Valid() const{
    return m_contact_person_id_isValid;
}

double OAIProject::getCostPrice() const {
    return m_cost_price;
}
void OAIProject::setCostPrice(const double &cost_price) {
    m_cost_price = cost_price;
    m_cost_price_isSet = true;
}

bool OAIProject::is_cost_price_Set() const{
    return m_cost_price_isSet;
}

bool OAIProject::is_cost_price_Valid() const{
    return m_cost_price_isValid;
}

qint32 OAIProject::getCustomerNumber() const {
    return m_customer_number;
}
void OAIProject::setCustomerNumber(const qint32 &customer_number) {
    m_customer_number = customer_number;
    m_customer_number_isSet = true;
}

bool OAIProject::is_customer_number_Set() const{
    return m_customer_number_isSet;
}

bool OAIProject::is_customer_number_Valid() const{
    return m_customer_number_isValid;
}

QDateTime OAIProject::getDeliveryDate() const {
    return m_delivery_date;
}
void OAIProject::setDeliveryDate(const QDateTime &delivery_date) {
    m_delivery_date = delivery_date;
    m_delivery_date_isSet = true;
}

bool OAIProject::is_delivery_date_Set() const{
    return m_delivery_date_isSet;
}

bool OAIProject::is_delivery_date_Valid() const{
    return m_delivery_date_isValid;
}

qint32 OAIProject::getDeliveryLocationNumber() const {
    return m_delivery_location_number;
}
void OAIProject::setDeliveryLocationNumber(const qint32 &delivery_location_number) {
    m_delivery_location_number = delivery_location_number;
    m_delivery_location_number_isSet = true;
}

bool OAIProject::is_delivery_location_number_Set() const{
    return m_delivery_location_number_isSet;
}

bool OAIProject::is_delivery_location_number_Valid() const{
    return m_delivery_location_number_isValid;
}

qint32 OAIProject::getDepartmentNumber() const {
    return m_department_number;
}
void OAIProject::setDepartmentNumber(const qint32 &department_number) {
    m_department_number = department_number;
    m_department_number_isSet = true;
}

bool OAIProject::is_department_number_Set() const{
    return m_department_number_isSet;
}

bool OAIProject::is_department_number_Valid() const{
    return m_department_number_isValid;
}
...
double OAIProject::getFixedPrice() const {
    return m_fixed_price;
}
void OAIProject::setFixedPrice(const double &fixed_price) {
    m_fixed_price = fixed_price;
    m_fixed_price_isSet = true;
}

bool OAIProject::is_fixed_price_Set() const{
    return m_fixed_price_isSet;
}

bool OAIProject::is_fixed_price_Valid() const{
    return m_fixed_price_isValid;
}

double OAIProject::getInvoicedTotal() const {
    return m_invoiced_total;
}
void OAIProject::setInvoicedTotal(const double &invoiced_total) {
    m_invoiced_total = invoiced_total;
    m_invoiced_total_isSet = true;
}

bool OAIProject::is_invoiced_total_Set() const{
    return m_invoiced_total_isSet;
}

bool OAIProject::is_invoiced_total_Valid() const{
    return m_invoiced_total_isValid;
}

bool OAIProject::isIsBarred() const {
    return m_is_barred;
}
void OAIProject::setIsBarred(const bool &is_barred) {
    m_is_barred = is_barred;
    m_is_barred_isSet = true;
}

bool OAIProject::is_is_barred_Set() const{
    return m_is_barred_isSet;
}

bool OAIProject::is_is_barred_Valid() const{
    return m_is_barred_isValid;
}

bool OAIProject::isIsClosed() const {
    return m_is_closed;
}
void OAIProject::setIsClosed(const bool &is_closed) {
    m_is_closed = is_closed;
    m_is_closed_isSet = true;
}

bool OAIProject::is_is_closed_Set() const{
    return m_is_closed_isSet;
}

bool OAIProject::is_is_closed_Valid() const{
    return m_is_closed_isValid;
}

bool OAIProject::isIsMainProject() const {
    return m_is_main_project;
}
void OAIProject::setIsMainProject(const bool &is_main_project) {
    m_is_main_project = is_main_project;
    m_is_main_project_isSet = true;
}

bool OAIProject::is_is_main_project_Set() const{
    return m_is_main_project_isSet;
}

bool OAIProject::is_is_main_project_Valid() const{
    return m_is_main_project_isValid;
}

bool OAIProject::isIsMileageInvoiced() const {
    return m_is_mileage_invoiced;
}
void OAIProject::setIsMileageInvoiced(const bool &is_mileage_invoiced) {
    m_is_mileage_invoiced = is_mileage_invoiced;
    m_is_mileage_invoiced_isSet = true;
}

bool OAIProject::is_is_mileage_invoiced_Set() const{
    return m_is_mileage_invoiced_isSet;
}

bool OAIProject::is_is_mileage_invoiced_Valid() const{
    return m_is_mileage_invoiced_isValid;
}

QDateTime OAIProject::getLastUpdated() const {
    return m_last_updated;
}
void OAIProject::setLastUpdated(const QDateTime &last_updated) {
...
qint32 OAIProject::getMainProjectNumber() const {
    return m_main_project_number;
}
void OAIProject::setMainProjectNumber(const qint32 &main_project_number) {
    m_main_project_number = main_project_number;
    m_main_project_number_isSet = true;
}

bool OAIProject::is_main_project_number_Set() const{
    return m_main_project_number_isSet;
}

bool OAIProject::is_main_project_number_Valid() const{
    return m_main_project_number_isValid;
}

double OAIProject::getMileage() const {
    return m_mileage;
}
void OAIProject::setMileage(const double &mileage) {
    m_mileage = mileage;
    m_mileage_isSet = true;
}

bool OAIProject::is_mileage_Set() const{
    return m_mileage_isSet;
}

bool OAIProject::is_mileage_Valid() const{
    return m_mileage_isValid;
}
...
QString OAIProject::getObjectVersion() const {
    return m_object_version;
}
void OAIProject::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAIProject::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAIProject::is_object_version_Valid() const{
    return m_object_version_isValid;
}

qint32 OAIProject::getOtherResponsibleEmployeeNumber() const {
    return m_other_responsible_employee_number;
}
void OAIProject::setOtherResponsibleEmployeeNumber(const qint32 &other_responsible_employee_number) {
    m_other_responsible_employee_number = other_responsible_employee_number;
    m_other_responsible_employee_number_isSet = true;
}

bool OAIProject::is_other_responsible_employee_number_Set() const{
    return m_other_responsible_employee_number_isSet;
}

bool OAIProject::is_other_responsible_employee_number_Valid() const{
    return m_other_responsible_employee_number_isValid;
}

qint32 OAIProject::getProjectGroupNumber() const {
    return m_project_group_number;
}
void OAIProject::setProjectGroupNumber(const qint32 &project_group_number) {
    m_project_group_number = project_group_number;
    m_project_group_number_isSet = true;
}

bool OAIProject::is_project_group_number_Set() const{
    return m_project_group_number_isSet;
}

bool OAIProject::is_project_group_number_Valid() const{
    return m_project_group_number_isValid;
}

qint32 OAIProject::getResponsibleEmployeeNumber() const {
    return m_responsible_employee_number;
}
void OAIProject::setResponsibleEmployeeNumber(const qint32 &responsible_employee_number) {
    m_responsible_employee_number = responsible_employee_number;
    m_responsible_employee_number_isSet = true;
}

bool OAIProject::is_responsible_employee_number_Set() const{
    return m_responsible_employee_number_isSet;
}

bool OAIProject::is_responsible_employee_number_Valid() const{
    return m_responsible_employee_number_isValid;
}

double OAIProject::getSalesPrice() const {
    return m_sales_price;
}
void OAIProject::setSalesPrice(const double &sales_price) {
    m_sales_price = sales_price;
    m_sales_price_isSet = true;
}

bool OAIProject::is_sales_price_Set() const{
    return m_sales_price_isSet;
}

bool OAIProject::is_sales_price_Valid() const{
    return m_sales_price_isValid;
}

qint32 OAIProject::getStatus() const {
    return m_status;
}
void OAIProject::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}
...
bool OAIProject::isValid() const {
    ...
    return m_name_isValid && m_project_group_number_isValid && true;
}
