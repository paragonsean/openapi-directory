...
bool OAIEmployee::isAccess() const {
    return m_access;
}
void OAIEmployee::setAccess(const bool &access) {
    m_access = access;
    m_access_isSet = true;
}

bool OAIEmployee::is_access_Set() const{
    return m_access_isSet;
}

bool OAIEmployee::is_access_Valid() const{
...
qint32 OAIEmployee::getGroupNumber() const {
    return m_group_number;
}
void OAIEmployee::setGroupNumber(const qint32 &group_number) {
    m_group_number = group_number;
    m_group_number_isSet = true;
}

bool OAIEmployee::is_group_number_Set() const{
    return m_group_number_isSet;
}

bool OAIEmployee::is_group_number_Valid() const{
...
qint32 OAIEmployee::getNumber() const {
    return m_number;
}
void OAIEmployee::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIEmployee::is_number_Set() const{
    return m_number_isSet;
}

bool OAIEmployee::is_number_Valid() const{
    return m_number_isValid;
}

QString OAIEmployee::getObjectVersion() const {
    return m_object_version;
}
void OAIEmployee::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAIEmployee::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAIEmployee::is_object_version_Valid() const{
...
bool OAIEmployee::isValid() const {
    ...
    return m_access_isValid && m_group_number_isValid && m_name_isValid && m_number_isValid && true;
}
