...
#include "OAIProjectEmployeesApi.h"
...
OAIProjectEmployeesApi::OAIProjectEmployeesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIProjectEmployeesApi::~OAIProjectEmployeesApi() {
}

void OAIProjectEmployeesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("createProjectEmployee", defaultConf);
    _serverIndices.insert("createProjectEmployee", 0);
    _serverConfigs.insert("deleteProjectEmployeeById", defaultConf);
    _serverIndices.insert("deleteProjectEmployeeById", 0);
    _serverConfigs.insert("getAllProjectEmployees", defaultConf);
    _serverIndices.insert("getAllProjectEmployees", 0);
    _serverConfigs.insert("getNumberOfProjectEmployees", defaultConf);
    _serverIndices.insert("getNumberOfProjectEmployees", 0);
    _serverConfigs.insert("getPageOfProjectEmployees", defaultConf);
    _serverIndices.insert("getPageOfProjectEmployees", 0);
    _serverConfigs.insert("getProjectEmployeeById", defaultConf);
    _serverIndices.insert("getProjectEmployeeById", 0);
    _serverConfigs.insert("updateProjectEmployee", defaultConf);
    _serverIndices.insert("updateProjectEmployee", 0);
}
...
*/
int OAIProjectEmployeesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIProjectEmployeesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIProjectEmployeesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIProjectEmployeesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIProjectEmployeesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIProjectEmployeesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIProjectEmployeesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIProjectEmployeesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIProjectEmployeesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIProjectEmployeesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProjectEmployeesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProjectEmployeesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIProjectEmployeesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIProjectEmployeesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIProjectEmployeesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIProjectEmployeesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIProjectEmployeesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIProjectEmployeesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIProjectEmployeesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIProjectEmployeesApi::createProjectEmployee(const ::OpenAPI::OptionalParam<OAIProjectEmployee> &oai_project_employee) {
    QString fullPath = QString(_serverConfigs["createProjectEmployee"][_serverIndices.value("createProjectEmployee")].URL()+"/project-employees");
    ...
    if (oai_project_employee.hasValue()){

        
        QByteArray output = oai_project_employee.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeesApi::createProjectEmployeeCallback);
    connect(this, &OAIProjectEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIProjectEmployeesApi::createProjectEmployeeCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createProjectEmployeeSignal(output);
        Q_EMIT createProjectEmployeeSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createProjectEmployeeSignalE(output, error_type, error_str);
        Q_EMIT createProjectEmployeeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createProjectEmployeeSignalError(output, error_type, error_str);
        Q_EMIT createProjectEmployeeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeesApi::deleteProjectEmployeeById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["deleteProjectEmployeeById"][_serverIndices.value("deleteProjectEmployeeById")].URL()+"/project-employees/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeesApi::deleteProjectEmployeeByIdCallback);
    connect(this, &OAIProjectEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectEmployeesApi::deleteProjectEmployeeByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteProjectEmployeeByIdSignal();
        Q_EMIT deleteProjectEmployeeByIdSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteProjectEmployeeByIdSignalE(error_type, error_str);
        Q_EMIT deleteProjectEmployeeByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteProjectEmployeeByIdSignalError(error_type, error_str);
        Q_EMIT deleteProjectEmployeeByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeesApi::getAllProjectEmployees(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllProjectEmployees"][_serverIndices.value("getAllProjectEmployees")].URL()+"/project-employees");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeesApi::getAllProjectEmployeesCallback);
    connect(this, &OAIProjectEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectEmployeesApi::getAllProjectEmployeesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProjectEmployeeCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllProjectEmployeesSignal(output);
        Q_EMIT getAllProjectEmployeesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllProjectEmployeesSignalE(output, error_type, error_str);
        Q_EMIT getAllProjectEmployeesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllProjectEmployeesSignalError(output, error_type, error_str);
        Q_EMIT getAllProjectEmployeesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeesApi::getNumberOfProjectEmployees(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfProjectEmployees"][_serverIndices.value("getNumberOfProjectEmployees")].URL()+"/project-employees/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeesApi::getNumberOfProjectEmployeesCallback);
    connect(this, &OAIProjectEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectEmployeesApi::getNumberOfProjectEmployeesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfProjectEmployeesSignal(output);
        Q_EMIT getNumberOfProjectEmployeesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfProjectEmployeesSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfProjectEmployeesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfProjectEmployeesSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfProjectEmployeesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeesApi::getPageOfProjectEmployees(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfProjectEmployees"][_serverIndices.value("getPageOfProjectEmployees")].URL()+"/project-employees/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeesApi::getPageOfProjectEmployeesCallback);
    connect(this, &OAIProjectEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectEmployeesApi::getPageOfProjectEmployeesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIProjectEmployee> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIProjectEmployee val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfProjectEmployeesSignal(output);
        Q_EMIT getPageOfProjectEmployeesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfProjectEmployeesSignalE(output, error_type, error_str);
        Q_EMIT getPageOfProjectEmployeesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfProjectEmployeesSignalError(output, error_type, error_str);
        Q_EMIT getPageOfProjectEmployeesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeesApi::getProjectEmployeeById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getProjectEmployeeById"][_serverIndices.value("getProjectEmployeeById")].URL()+"/project-employees/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeesApi::getProjectEmployeeByIdCallback);
    connect(this, &OAIProjectEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectEmployeesApi::getProjectEmployeeByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProjectEmployee output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getProjectEmployeeByIdSignal(output);
        Q_EMIT getProjectEmployeeByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getProjectEmployeeByIdSignalE(output, error_type, error_str);
        Q_EMIT getProjectEmployeeByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getProjectEmployeeByIdSignalError(output, error_type, error_str);
        Q_EMIT getProjectEmployeeByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeesApi::updateProjectEmployee(const ::OpenAPI::OptionalParam<OAIProjectEmployee> &oai_project_employee) {
    QString fullPath = QString(_serverConfigs["updateProjectEmployee"][_serverIndices.value("updateProjectEmployee")].URL()+"/project-employees");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectEmployeesApi::updateProjectEmployeeCallback);
    connect(this, &OAIProjectEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectEmployeesApi::updateProjectEmployeeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateProjectEmployeeSignal();
        Q_EMIT updateProjectEmployeeSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateProjectEmployeeSignalE(error_type, error_str);
        Q_EMIT updateProjectEmployeeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateProjectEmployeeSignalError(error_type, error_str);
        Q_EMIT updateProjectEmployeeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectEmployeesApi::tokenAvailable(){
