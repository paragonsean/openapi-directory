...
OAICostTypesApi::OAICostTypesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAICostTypesApi::~OAICostTypesApi() {
}

void OAICostTypesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getAllCostTypes", defaultConf);
    _serverIndices.insert("getAllCostTypes", 0);
    _serverConfigs.insert("getCostTypeById", defaultConf);
    _serverIndices.insert("getCostTypeById", 0);
    _serverConfigs.insert("getNumberOfCostTypes", defaultConf);
    _serverIndices.insert("getNumberOfCostTypes", 0);
    _serverConfigs.insert("getPageOfCostTypes", defaultConf);
    _serverIndices.insert("getPageOfCostTypes", 0);
}
...
*/
int OAICostTypesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAICostTypesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAICostTypesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAICostTypesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAICostTypesApi::setUsername(const QString &username) {
    _username = username;
}

void OAICostTypesApi::setPassword(const QString &password) {
    _password = password;
}


void OAICostTypesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAICostTypesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAICostTypesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAICostTypesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAICostTypesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAICostTypesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAICostTypesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAICostTypesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAICostTypesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAICostTypesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAICostTypesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAICostTypesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAICostTypesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAICostTypesApi::getAllCostTypes(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllCostTypes"][_serverIndices.value("getAllCostTypes")].URL()+"/costtypes");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICostTypesApi::getAllCostTypesCallback);
    connect(this, &OAICostTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAICostTypesApi::getAllCostTypesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICostTypeCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllCostTypesSignal(output);
        Q_EMIT getAllCostTypesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllCostTypesSignalE(output, error_type, error_str);
        Q_EMIT getAllCostTypesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllCostTypesSignalError(output, error_type, error_str);
        Q_EMIT getAllCostTypesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICostTypesApi::getCostTypeById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getCostTypeById"][_serverIndices.value("getCostTypeById")].URL()+"/costtypes/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICostTypesApi::getCostTypeByIdCallback);
    connect(this, &OAICostTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICostTypesApi::getCostTypeByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAICostType output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getCostTypeByIdSignal(output);
        Q_EMIT getCostTypeByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getCostTypeByIdSignalE(output, error_type, error_str);
        Q_EMIT getCostTypeByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getCostTypeByIdSignalError(output, error_type, error_str);
        Q_EMIT getCostTypeByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICostTypesApi::getNumberOfCostTypes(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfCostTypes"][_serverIndices.value("getNumberOfCostTypes")].URL()+"/costtypes/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICostTypesApi::getNumberOfCostTypesCallback);
    connect(this, &OAICostTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICostTypesApi::getNumberOfCostTypesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfCostTypesSignal(output);
        Q_EMIT getNumberOfCostTypesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfCostTypesSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfCostTypesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfCostTypesSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfCostTypesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICostTypesApi::getPageOfCostTypes(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfCostTypes"][_serverIndices.value("getPageOfCostTypes")].URL()+"/costtypes/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICostTypesApi::getPageOfCostTypesCallback);
    connect(this, &OAICostTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICostTypesApi::getPageOfCostTypesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfCostTypesSignal(output);
        Q_EMIT getPageOfCostTypesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfCostTypesSignalE(output, error_type, error_str);
        Q_EMIT getPageOfCostTypesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfCostTypesSignalError(output, error_type, error_str);
        Q_EMIT getPageOfCostTypesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICostTypesApi::tokenAvailable(){
