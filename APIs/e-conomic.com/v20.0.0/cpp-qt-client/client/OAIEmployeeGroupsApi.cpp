...
#include "OAIEmployeeGroupsApi.h"
...
OAIEmployeeGroupsApi::OAIEmployeeGroupsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIEmployeeGroupsApi::~OAIEmployeeGroupsApi() {
}

void OAIEmployeeGroupsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("createEmployeeGroup", defaultConf);
    _serverIndices.insert("createEmployeeGroup", 0);
    _serverConfigs.insert("deleteEmployeeGroupById", defaultConf);
    _serverIndices.insert("deleteEmployeeGroupById", 0);
    _serverConfigs.insert("getAllEmployeeGroups", defaultConf);
    _serverIndices.insert("getAllEmployeeGroups", 0);
    _serverConfigs.insert("getEmployeeGroupById", defaultConf);
    _serverIndices.insert("getEmployeeGroupById", 0);
    _serverConfigs.insert("getNumberOfEmployeeGroups", defaultConf);
    _serverIndices.insert("getNumberOfEmployeeGroups", 0);
    _serverConfigs.insert("getPageOfEmployeeGroups", defaultConf);
    _serverIndices.insert("getPageOfEmployeeGroups", 0);
    _serverConfigs.insert("updateEmployeeGroup", defaultConf);
    _serverIndices.insert("updateEmployeeGroup", 0);
}
...
*/
int OAIEmployeeGroupsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIEmployeeGroupsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIEmployeeGroupsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIEmployeeGroupsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIEmployeeGroupsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIEmployeeGroupsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIEmployeeGroupsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIEmployeeGroupsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIEmployeeGroupsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIEmployeeGroupsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIEmployeeGroupsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIEmployeeGroupsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIEmployeeGroupsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIEmployeeGroupsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIEmployeeGroupsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIEmployeeGroupsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIEmployeeGroupsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIEmployeeGroupsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIEmployeeGroupsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIEmployeeGroupsApi::createEmployeeGroup(const ::OpenAPI::OptionalParam<OAIEmployeeGroup> &oai_employee_group) {
    QString fullPath = QString(_serverConfigs["createEmployeeGroup"][_serverIndices.value("createEmployeeGroup")].URL()+"/employeegroups");
    ...
    if (oai_employee_group.hasValue()){

        
        QByteArray output = oai_employee_group.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeGroupsApi::createEmployeeGroupCallback);
    connect(this, &OAIEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIEmployeeGroupsApi::createEmployeeGroupCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createEmployeeGroupSignal(output);
        Q_EMIT createEmployeeGroupSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createEmployeeGroupSignalE(output, error_type, error_str);
        Q_EMIT createEmployeeGroupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createEmployeeGroupSignalError(output, error_type, error_str);
        Q_EMIT createEmployeeGroupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeeGroupsApi::deleteEmployeeGroupById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["deleteEmployeeGroupById"][_serverIndices.value("deleteEmployeeGroupById")].URL()+"/employeegroups/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeGroupsApi::deleteEmployeeGroupByIdCallback);
    connect(this, &OAIEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeeGroupsApi::deleteEmployeeGroupByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteEmployeeGroupByIdSignal();
        Q_EMIT deleteEmployeeGroupByIdSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteEmployeeGroupByIdSignalE(error_type, error_str);
        Q_EMIT deleteEmployeeGroupByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteEmployeeGroupByIdSignalError(error_type, error_str);
        Q_EMIT deleteEmployeeGroupByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeeGroupsApi::getAllEmployeeGroups(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllEmployeeGroups"][_serverIndices.value("getAllEmployeeGroups")].URL()+"/employeegroups");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeGroupsApi::getAllEmployeeGroupsCallback);
    connect(this, &OAIEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeeGroupsApi::getAllEmployeeGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEmployeeGroupCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllEmployeeGroupsSignal(output);
        Q_EMIT getAllEmployeeGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllEmployeeGroupsSignalE(output, error_type, error_str);
        Q_EMIT getAllEmployeeGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllEmployeeGroupsSignalError(output, error_type, error_str);
        Q_EMIT getAllEmployeeGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeeGroupsApi::getEmployeeGroupById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getEmployeeGroupById"][_serverIndices.value("getEmployeeGroupById")].URL()+"/employeegroups/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeGroupsApi::getEmployeeGroupByIdCallback);
    connect(this, &OAIEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeeGroupsApi::getEmployeeGroupByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEmployeeGroup output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getEmployeeGroupByIdSignal(output);
        Q_EMIT getEmployeeGroupByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getEmployeeGroupByIdSignalE(output, error_type, error_str);
        Q_EMIT getEmployeeGroupByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getEmployeeGroupByIdSignalError(output, error_type, error_str);
        Q_EMIT getEmployeeGroupByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeeGroupsApi::getNumberOfEmployeeGroups(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfEmployeeGroups"][_serverIndices.value("getNumberOfEmployeeGroups")].URL()+"/employeegroups/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeGroupsApi::getNumberOfEmployeeGroupsCallback);
    connect(this, &OAIEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeeGroupsApi::getNumberOfEmployeeGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfEmployeeGroupsSignal(output);
        Q_EMIT getNumberOfEmployeeGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfEmployeeGroupsSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfEmployeeGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfEmployeeGroupsSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfEmployeeGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeeGroupsApi::getPageOfEmployeeGroups(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfEmployeeGroups"][_serverIndices.value("getPageOfEmployeeGroups")].URL()+"/employeegroups/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeGroupsApi::getPageOfEmployeeGroupsCallback);
    connect(this, &OAIEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeeGroupsApi::getPageOfEmployeeGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIEmployeeGroup> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIEmployeeGroup val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfEmployeeGroupsSignal(output);
        Q_EMIT getPageOfEmployeeGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfEmployeeGroupsSignalE(output, error_type, error_str);
        Q_EMIT getPageOfEmployeeGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfEmployeeGroupsSignalError(output, error_type, error_str);
        Q_EMIT getPageOfEmployeeGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeeGroupsApi::updateEmployeeGroup(const ::OpenAPI::OptionalParam<OAIEmployeeGroup> &oai_employee_group) {
    QString fullPath = QString(_serverConfigs["updateEmployeeGroup"][_serverIndices.value("updateEmployeeGroup")].URL()+"/employeegroups");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeGroupsApi::updateEmployeeGroupCallback);
    connect(this, &OAIEmployeeGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeeGroupsApi::updateEmployeeGroupCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateEmployeeGroupSignal();
        Q_EMIT updateEmployeeGroupSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateEmployeeGroupSignalE(error_type, error_str);
        Q_EMIT updateEmployeeGroupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateEmployeeGroupSignalError(error_type, error_str);
        Q_EMIT updateEmployeeGroupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeeGroupsApi::tokenAvailable(){
