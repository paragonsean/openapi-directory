...
#include "OAIMileageEntriesApi.h"
...
OAIMileageEntriesApi::OAIMileageEntriesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIMileageEntriesApi::~OAIMileageEntriesApi() {
}

void OAIMileageEntriesApi::initializeServerConfigs() {
    //Default server
    QList<OAIServerConfiguration> defaultConf = QList<OAIServerConfiguration>();
    //varying endpoint server
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://apis.e-conomic.com/api/v20.0.0/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("approveMileageEntries", defaultConf);
    _serverIndices.insert("approveMileageEntries", 0);
    _serverConfigs.insert("createMileage", defaultConf);
    _serverIndices.insert("createMileage", 0);
    _serverConfigs.insert("deleteMileageById", defaultConf);
    _serverIndices.insert("deleteMileageById", 0);
    _serverConfigs.insert("getAllMileageEntries", defaultConf);
    _serverIndices.insert("getAllMileageEntries", 0);
    _serverConfigs.insert("getMileageById", defaultConf);
    _serverIndices.insert("getMileageById", 0);
    _serverConfigs.insert("getNumberOfMileageEntries", defaultConf);
    _serverIndices.insert("getNumberOfMileageEntries", 0);
    _serverConfigs.insert("getPageOfMileageEntries", defaultConf);
    _serverIndices.insert("getPageOfMileageEntries", 0);
    _serverConfigs.insert("updateMileage", defaultConf);
    _serverIndices.insert("updateMileage", 0);
}
...
*/
int OAIMileageEntriesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIMileageEntriesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIMileageEntriesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIMileageEntriesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIMileageEntriesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIMileageEntriesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIMileageEntriesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIMileageEntriesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIMileageEntriesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIMileageEntriesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIMileageEntriesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIMileageEntriesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIMileageEntriesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIMileageEntriesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIMileageEntriesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIMileageEntriesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIMileageEntriesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIMileageEntriesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIMileageEntriesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIMileageEntriesApi::approveMileageEntries(const ::OpenAPI::OptionalParam<OAIMileageNumbersCollection> &oai_mileage_numbers_collection) {
    QString fullPath = QString(_serverConfigs["approveMileageEntries"][_serverIndices.value("approveMileageEntries")].URL()+"/mileages/approve");
    
    if (_apiKeys.contains("X-AgreementGrantToken")) {
        addHeaders("X-AgreementGrantToken",_apiKeys.find("X-AgreementGrantToken").value());
    }
    
    if (_apiKeys.contains("X-AppSecretToken")) {
        addHeaders("X-AppSecretToken",_apiKeys.find("X-AppSecretToken").value());
    }
    ...
    if (oai_mileage_numbers_collection.hasValue()){

        
        QByteArray output = oai_mileage_numbers_collection.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMileageEntriesApi::approveMileageEntriesCallback);
    connect(this, &OAIMileageEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIMileageEntriesApi::approveMileageEntriesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT approveMileageEntriesSignal();
        Q_EMIT approveMileageEntriesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT approveMileageEntriesSignalE(error_type, error_str);
        Q_EMIT approveMileageEntriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT approveMileageEntriesSignalError(error_type, error_str);
        Q_EMIT approveMileageEntriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMileageEntriesApi::createMileage(const ::OpenAPI::OptionalParam<OAIMileage> &oai_mileage) {
    QString fullPath = QString(_serverConfigs["createMileage"][_serverIndices.value("createMileage")].URL()+"/mileages");
    ...
    if (oai_mileage.hasValue()){

        
        QByteArray output = oai_mileage.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMileageEntriesApi::createMileageCallback);
    connect(this, &OAIMileageEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMileageEntriesApi::createMileageCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAICreatedResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createMileageSignal(output);
        Q_EMIT createMileageSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createMileageSignalE(output, error_type, error_str);
        Q_EMIT createMileageSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createMileageSignalError(output, error_type, error_str);
        Q_EMIT createMileageSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMileageEntriesApi::deleteMileageById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["deleteMileageById"][_serverIndices.value("deleteMileageById")].URL()+"/mileages/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMileageEntriesApi::deleteMileageByIdCallback);
    connect(this, &OAIMileageEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMileageEntriesApi::deleteMileageByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteMileageByIdSignal();
        Q_EMIT deleteMileageByIdSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteMileageByIdSignalE(error_type, error_str);
        Q_EMIT deleteMileageByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteMileageByIdSignalError(error_type, error_str);
        Q_EMIT deleteMileageByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMileageEntriesApi::getAllMileageEntries(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllMileageEntries"][_serverIndices.value("getAllMileageEntries")].URL()+"/mileages");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMileageEntriesApi::getAllMileageEntriesCallback);
    connect(this, &OAIMileageEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMileageEntriesApi::getAllMileageEntriesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIMileageCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllMileageEntriesSignal(output);
        Q_EMIT getAllMileageEntriesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllMileageEntriesSignalE(output, error_type, error_str);
        Q_EMIT getAllMileageEntriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllMileageEntriesSignalError(output, error_type, error_str);
        Q_EMIT getAllMileageEntriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMileageEntriesApi::getMileageById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getMileageById"][_serverIndices.value("getMileageById")].URL()+"/mileages/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMileageEntriesApi::getMileageByIdCallback);
    connect(this, &OAIMileageEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMileageEntriesApi::getMileageByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIMileage output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getMileageByIdSignal(output);
        Q_EMIT getMileageByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getMileageByIdSignalE(output, error_type, error_str);
        Q_EMIT getMileageByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getMileageByIdSignalError(output, error_type, error_str);
        Q_EMIT getMileageByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMileageEntriesApi::getNumberOfMileageEntries(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfMileageEntries"][_serverIndices.value("getNumberOfMileageEntries")].URL()+"/mileages/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMileageEntriesApi::getNumberOfMileageEntriesCallback);
    connect(this, &OAIMileageEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMileageEntriesApi::getNumberOfMileageEntriesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfMileageEntriesSignal(output);
        Q_EMIT getNumberOfMileageEntriesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfMileageEntriesSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfMileageEntriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfMileageEntriesSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfMileageEntriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMileageEntriesApi::getPageOfMileageEntries(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfMileageEntries"][_serverIndices.value("getPageOfMileageEntries")].URL()+"/mileages/paged");
    ...
    if (skip_pages.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "SkipPages", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("SkipPages")).append(querySuffix).append(QUrl::toPercentEncoding(skip_pages.stringValue()));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMileageEntriesApi::getPageOfMileageEntriesCallback);
    connect(this, &OAIMileageEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMileageEntriesApi::getPageOfMileageEntriesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfMileageEntriesSignal(output);
        Q_EMIT getPageOfMileageEntriesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfMileageEntriesSignalE(output, error_type, error_str);
        Q_EMIT getPageOfMileageEntriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfMileageEntriesSignalError(output, error_type, error_str);
        Q_EMIT getPageOfMileageEntriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMileageEntriesApi::updateMileage(const ::OpenAPI::OptionalParam<OAIMileage> &oai_mileage) {
    QString fullPath = QString(_serverConfigs["updateMileage"][_serverIndices.value("updateMileage")].URL()+"/mileages");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMileageEntriesApi::updateMileageCallback);
    connect(this, &OAIMileageEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMileageEntriesApi::updateMileageCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateMileageSignal();
        Q_EMIT updateMileageSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateMileageSignalE(error_type, error_str);
        Q_EMIT updateMileageSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateMileageSignalError(error_type, error_str);
        Q_EMIT updateMileageSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMileageEntriesApi::tokenAvailable(){
