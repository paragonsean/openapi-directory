...
void OAIEmployeesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("deleteEmployeeById", defaultConf);
    _serverIndices.insert("deleteEmployeeById", 0);
    _serverConfigs.insert("getAllEmployees", defaultConf);
    _serverIndices.insert("getAllEmployees", 0);
    _serverConfigs.insert("getEmployeeById", defaultConf);
    _serverIndices.insert("getEmployeeById", 0);
    _serverConfigs.insert("getNumberOfEmployees", defaultConf);
    _serverIndices.insert("getNumberOfEmployees", 0);
    _serverConfigs.insert("getPageOfEmployees", defaultConf);
    _serverIndices.insert("getPageOfEmployees", 0);
...
void OAIEmployeesApi::createEmployee(const ::OpenAPI::OptionalParam<OAIEmployee> &oai_employee) {
    ...
    if (oai_employee.hasValue()){
        ...
        QByteArray output = oai_employee.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeesApi::createEmployeeCallback);
...
void OAIEmployeesApi::createEmployeeCallback(OAIHttpRequestWorker *worker) {
...
void OAIEmployeesApi::deleteEmployeeById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["deleteEmployeeById"][_serverIndices.value("deleteEmployeeById")].URL()+"/employees/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeesApi::deleteEmployeeByIdCallback);
    connect(this, &OAIEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeesApi::deleteEmployeeByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteEmployeeByIdSignal();
        Q_EMIT deleteEmployeeByIdSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteEmployeeByIdSignalE(error_type, error_str);
        Q_EMIT deleteEmployeeByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteEmployeeByIdSignalError(error_type, error_str);
        Q_EMIT deleteEmployeeByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeesApi::getAllEmployees(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllEmployees"][_serverIndices.value("getAllEmployees")].URL()+"/employees");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeesApi::getAllEmployeesCallback);
    connect(this, &OAIEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeesApi::getAllEmployeesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEmployeeCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllEmployeesSignal(output);
        Q_EMIT getAllEmployeesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllEmployeesSignalE(output, error_type, error_str);
        Q_EMIT getAllEmployeesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllEmployeesSignalError(output, error_type, error_str);
        Q_EMIT getAllEmployeesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeesApi::getEmployeeById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getEmployeeById"][_serverIndices.value("getEmployeeById")].URL()+"/employees/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeesApi::getEmployeeByIdCallback);
    connect(this, &OAIEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeesApi::getEmployeeByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getEmployeeByIdSignal(output);
        Q_EMIT getEmployeeByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getEmployeeByIdSignalE(output, error_type, error_str);
        Q_EMIT getEmployeeByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getEmployeeByIdSignalError(output, error_type, error_str);
        Q_EMIT getEmployeeByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeesApi::getNumberOfEmployees(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfEmployees"][_serverIndices.value("getNumberOfEmployees")].URL()+"/employees/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeesApi::getNumberOfEmployeesCallback);
    connect(this, &OAIEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeesApi::getNumberOfEmployeesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfEmployeesSignal(output);
        Q_EMIT getNumberOfEmployeesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfEmployeesSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfEmployeesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfEmployeesSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfEmployeesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeesApi::getPageOfEmployees(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfEmployees"][_serverIndices.value("getPageOfEmployees")].URL()+"/employees/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeesApi::getPageOfEmployeesCallback);
    connect(this, &OAIEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeesApi::getPageOfEmployeesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfEmployeesSignal(output);
        Q_EMIT getPageOfEmployeesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfEmployeesSignalE(output, error_type, error_str);
        Q_EMIT getPageOfEmployeesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfEmployeesSignalError(output, error_type, error_str);
        Q_EMIT getPageOfEmployeesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeesApi::updateEmployee(const ::OpenAPI::OptionalParam<OAIEmployee> &oai_employee) {
    QString fullPath = QString(_serverConfigs["updateEmployee"][_serverIndices.value("updateEmployee")].URL()+"/employees");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeesApi::updateEmployeeCallback);
    connect(this, &OAIEmployeesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeesApi::updateEmployeeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateEmployeeSignal();
        Q_EMIT updateEmployeeSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateEmployeeSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateEmployeeSignalError(error_type, error_str);
