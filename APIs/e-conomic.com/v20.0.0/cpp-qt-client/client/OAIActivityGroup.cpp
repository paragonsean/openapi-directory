...
OAIActivityGroup::OAIActivityGroup(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActivityGroup::OAIActivityGroup() {
    this->initializeModel();
}

OAIActivityGroup::~OAIActivityGroup() {}

void OAIActivityGroup::initializeModel() {

    m_cost_account_closed_isSet = false;
    m_cost_account_closed_isValid = false;

    m_cost_account_ongoing_isSet = false;
    m_cost_account_ongoing_isValid = false;

    m_cost_account_ongoing_type_isSet = false;
    m_cost_account_ongoing_type_isValid = false;

    m_cost_contra_account_ongoing_isSet = false;
    m_cost_contra_account_ongoing_isValid = false;

    m_include_cost_price_in_finance_isSet = false;
    m_include_cost_price_in_finance_isValid = false;

    m_include_sales_price_in_finance_isSet = false;
    m_include_sales_price_in_finance_isValid = false;
    ...
    m_sales_account_closed_isSet = false;
    m_sales_account_closed_isValid = false;

    m_sales_account_ongoing_isSet = false;
    m_sales_account_ongoing_isValid = false;

    m_sales_account_ongoing_type_isSet = false;
    m_sales_account_ongoing_type_isValid = false;

    m_sales_contra_account_ongoing_isSet = false;
    m_sales_contra_account_ongoing_isValid = false;

    m_type_isSet = false;
    m_type_isValid = false;
}

void OAIActivityGroup::fromJson(QString jsonString) {
...
void OAIActivityGroup::fromJsonObject(QJsonObject json) {

    m_cost_account_closed_isValid = ::OpenAPI::fromJsonValue(m_cost_account_closed, json[QString("costAccountClosed")]);
    m_cost_account_closed_isSet = !json[QString("costAccountClosed")].isNull() && m_cost_account_closed_isValid;

    m_cost_account_ongoing_isValid = ::OpenAPI::fromJsonValue(m_cost_account_ongoing, json[QString("costAccountOngoing")]);
    m_cost_account_ongoing_isSet = !json[QString("costAccountOngoing")].isNull() && m_cost_account_ongoing_isValid;

    m_cost_account_ongoing_type_isValid = ::OpenAPI::fromJsonValue(m_cost_account_ongoing_type, json[QString("costAccountOngoingType")]);
    m_cost_account_ongoing_type_isSet = !json[QString("costAccountOngoingType")].isNull() && m_cost_account_ongoing_type_isValid;

    m_cost_contra_account_ongoing_isValid = ::OpenAPI::fromJsonValue(m_cost_contra_account_ongoing, json[QString("costContraAccountOngoing")]);
    m_cost_contra_account_ongoing_isSet = !json[QString("costContraAccountOngoing")].isNull() && m_cost_contra_account_ongoing_isValid;

    m_include_cost_price_in_finance_isValid = ::OpenAPI::fromJsonValue(m_include_cost_price_in_finance, json[QString("includeCostPriceInFinance")]);
    m_include_cost_price_in_finance_isSet = !json[QString("includeCostPriceInFinance")].isNull() && m_include_cost_price_in_finance_isValid;

    m_include_sales_price_in_finance_isValid = ::OpenAPI::fromJsonValue(m_include_sales_price_in_finance, json[QString("includeSalesPriceInFinance")]);
    m_include_sales_price_in_finance_isSet = !json[QString("includeSalesPriceInFinance")].isNull() && m_include_sales_price_in_finance_isValid;
    ...
    m_sales_account_closed_isValid = ::OpenAPI::fromJsonValue(m_sales_account_closed, json[QString("salesAccountClosed")]);
    m_sales_account_closed_isSet = !json[QString("salesAccountClosed")].isNull() && m_sales_account_closed_isValid;

    m_sales_account_ongoing_isValid = ::OpenAPI::fromJsonValue(m_sales_account_ongoing, json[QString("salesAccountOngoing")]);
    m_sales_account_ongoing_isSet = !json[QString("salesAccountOngoing")].isNull() && m_sales_account_ongoing_isValid;

    m_sales_account_ongoing_type_isValid = ::OpenAPI::fromJsonValue(m_sales_account_ongoing_type, json[QString("salesAccountOngoingType")]);
    m_sales_account_ongoing_type_isSet = !json[QString("salesAccountOngoingType")].isNull() && m_sales_account_ongoing_type_isValid;

    m_sales_contra_account_ongoing_isValid = ::OpenAPI::fromJsonValue(m_sales_contra_account_ongoing, json[QString("salesContraAccountOngoing")]);
    m_sales_contra_account_ongoing_isSet = !json[QString("salesContraAccountOngoing")].isNull() && m_sales_contra_account_ongoing_isValid;

    m_type_isValid = ::OpenAPI::fromJsonValue(m_type, json[QString("type")]);
    m_type_isSet = !json[QString("type")].isNull() && m_type_isValid;
}

QString OAIActivityGroup::asJson() const {
...
QJsonObject OAIActivityGroup::asJsonObject() const {
    QJsonObject obj;
    if (m_cost_account_closed_isSet) {
        obj.insert(QString("costAccountClosed"), ::OpenAPI::toJsonValue(m_cost_account_closed));
    }
    if (m_cost_account_ongoing_isSet) {
        obj.insert(QString("costAccountOngoing"), ::OpenAPI::toJsonValue(m_cost_account_ongoing));
    }
    if (m_cost_account_ongoing_type.isSet()) {
        obj.insert(QString("costAccountOngoingType"), ::OpenAPI::toJsonValue(m_cost_account_ongoing_type));
    }
    if (m_cost_contra_account_ongoing_isSet) {
        obj.insert(QString("costContraAccountOngoing"), ::OpenAPI::toJsonValue(m_cost_contra_account_ongoing));
    }
    if (m_include_cost_price_in_finance_isSet) {
        obj.insert(QString("includeCostPriceInFinance"), ::OpenAPI::toJsonValue(m_include_cost_price_in_finance));
    }
    if (m_include_sales_price_in_finance_isSet) {
        obj.insert(QString("includeSalesPriceInFinance"), ::OpenAPI::toJsonValue(m_include_sales_price_in_finance));
    }
    if (m_name_isSet) {
    ...
    if (m_sales_account_closed_isSet) {
        obj.insert(QString("salesAccountClosed"), ::OpenAPI::toJsonValue(m_sales_account_closed));
    }
    if (m_sales_account_ongoing_isSet) {
        obj.insert(QString("salesAccountOngoing"), ::OpenAPI::toJsonValue(m_sales_account_ongoing));
    }
    if (m_sales_account_ongoing_type.isSet()) {
        obj.insert(QString("salesAccountOngoingType"), ::OpenAPI::toJsonValue(m_sales_account_ongoing_type));
    }
    if (m_sales_contra_account_ongoing_isSet) {
        obj.insert(QString("salesContraAccountOngoing"), ::OpenAPI::toJsonValue(m_sales_contra_account_ongoing));
    }
    if (m_type.isSet()) {
...
qint32 OAIActivityGroup::getCostAccountClosed() const {
    return m_cost_account_closed;
}
void OAIActivityGroup::setCostAccountClosed(const qint32 &cost_account_closed) {
    m_cost_account_closed = cost_account_closed;
    m_cost_account_closed_isSet = true;
}

bool OAIActivityGroup::is_cost_account_closed_Set() const{
    return m_cost_account_closed_isSet;
}

bool OAIActivityGroup::is_cost_account_closed_Valid() const{
    return m_cost_account_closed_isValid;
}

qint32 OAIActivityGroup::getCostAccountOngoing() const {
    return m_cost_account_ongoing;
}
void OAIActivityGroup::setCostAccountOngoing(const qint32 &cost_account_ongoing) {
    m_cost_account_ongoing = cost_account_ongoing;
    m_cost_account_ongoing_isSet = true;
}

bool OAIActivityGroup::is_cost_account_ongoing_Set() const{
    return m_cost_account_ongoing_isSet;
}

bool OAIActivityGroup::is_cost_account_ongoing_Valid() const{
    return m_cost_account_ongoing_isValid;
}

OAIOngoingAccountType OAIActivityGroup::getCostAccountOngoingType() const {
    return m_cost_account_ongoing_type;
}
void OAIActivityGroup::setCostAccountOngoingType(const OAIOngoingAccountType &cost_account_ongoing_type) {
    m_cost_account_ongoing_type = cost_account_ongoing_type;
    m_cost_account_ongoing_type_isSet = true;
}

bool OAIActivityGroup::is_cost_account_ongoing_type_Set() const{
    return m_cost_account_ongoing_type_isSet;
}

bool OAIActivityGroup::is_cost_account_ongoing_type_Valid() const{
    return m_cost_account_ongoing_type_isValid;
}

qint32 OAIActivityGroup::getCostContraAccountOngoing() const {
    return m_cost_contra_account_ongoing;
}
void OAIActivityGroup::setCostContraAccountOngoing(const qint32 &cost_contra_account_ongoing) {
    m_cost_contra_account_ongoing = cost_contra_account_ongoing;
    m_cost_contra_account_ongoing_isSet = true;
}

bool OAIActivityGroup::is_cost_contra_account_ongoing_Set() const{
    return m_cost_contra_account_ongoing_isSet;
}

bool OAIActivityGroup::is_cost_contra_account_ongoing_Valid() const{
    return m_cost_contra_account_ongoing_isValid;
}

bool OAIActivityGroup::isIncludeCostPriceInFinance() const {
    return m_include_cost_price_in_finance;
}
void OAIActivityGroup::setIncludeCostPriceInFinance(const bool &include_cost_price_in_finance) {
    m_include_cost_price_in_finance = include_cost_price_in_finance;
    m_include_cost_price_in_finance_isSet = true;
}

bool OAIActivityGroup::is_include_cost_price_in_finance_Set() const{
    return m_include_cost_price_in_finance_isSet;
}

bool OAIActivityGroup::is_include_cost_price_in_finance_Valid() const{
    return m_include_cost_price_in_finance_isValid;
}

bool OAIActivityGroup::isIncludeSalesPriceInFinance() const {
    return m_include_sales_price_in_finance;
}
void OAIActivityGroup::setIncludeSalesPriceInFinance(const bool &include_sales_price_in_finance) {
    m_include_sales_price_in_finance = include_sales_price_in_finance;
    m_include_sales_price_in_finance_isSet = true;
}

bool OAIActivityGroup::is_include_sales_price_in_finance_Set() const{
    return m_include_sales_price_in_finance_isSet;
}

bool OAIActivityGroup::is_include_sales_price_in_finance_Valid() const{
    return m_include_sales_price_in_finance_isValid;
}

QString OAIActivityGroup::getName() const {
    return m_name;
}
void OAIActivityGroup::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIActivityGroup::is_name_Set() const{
    return m_name_isSet;
}

bool OAIActivityGroup::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIActivityGroup::getNumber() const {
    return m_number;
}
void OAIActivityGroup::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIActivityGroup::is_number_Set() const{
    return m_number_isSet;
}

bool OAIActivityGroup::is_number_Valid() const{
    return m_number_isValid;
}

QString OAIActivityGroup::getObjectVersion() const {
    return m_object_version;
}
void OAIActivityGroup::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAIActivityGroup::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAIActivityGroup::is_object_version_Valid() const{
    return m_object_version_isValid;
}

qint32 OAIActivityGroup::getSalesAccountClosed() const {
    return m_sales_account_closed;
}
void OAIActivityGroup::setSalesAccountClosed(const qint32 &sales_account_closed) {
    m_sales_account_closed = sales_account_closed;
    m_sales_account_closed_isSet = true;
}

bool OAIActivityGroup::is_sales_account_closed_Set() const{
    return m_sales_account_closed_isSet;
}

bool OAIActivityGroup::is_sales_account_closed_Valid() const{
    return m_sales_account_closed_isValid;
}

qint32 OAIActivityGroup::getSalesAccountOngoing() const {
    return m_sales_account_ongoing;
}
void OAIActivityGroup::setSalesAccountOngoing(const qint32 &sales_account_ongoing) {
    m_sales_account_ongoing = sales_account_ongoing;
    m_sales_account_ongoing_isSet = true;
}

bool OAIActivityGroup::is_sales_account_ongoing_Set() const{
    return m_sales_account_ongoing_isSet;
}

bool OAIActivityGroup::is_sales_account_ongoing_Valid() const{
    return m_sales_account_ongoing_isValid;
}

OAIOngoingAccountType OAIActivityGroup::getSalesAccountOngoingType() const {
    return m_sales_account_ongoing_type;
}
void OAIActivityGroup::setSalesAccountOngoingType(const OAIOngoingAccountType &sales_account_ongoing_type) {
    m_sales_account_ongoing_type = sales_account_ongoing_type;
    m_sales_account_ongoing_type_isSet = true;
}

bool OAIActivityGroup::is_sales_account_ongoing_type_Set() const{
    return m_sales_account_ongoing_type_isSet;
}

bool OAIActivityGroup::is_sales_account_ongoing_type_Valid() const{
    return m_sales_account_ongoing_type_isValid;
}

qint32 OAIActivityGroup::getSalesContraAccountOngoing() const {
    return m_sales_contra_account_ongoing;
}
void OAIActivityGroup::setSalesContraAccountOngoing(const qint32 &sales_contra_account_ongoing) {
    m_sales_contra_account_ongoing = sales_contra_account_ongoing;
    m_sales_contra_account_ongoing_isSet = true;
}

bool OAIActivityGroup::is_sales_contra_account_ongoing_Set() const{
    return m_sales_contra_account_ongoing_isSet;
}

bool OAIActivityGroup::is_sales_contra_account_ongoing_Valid() const{
    return m_sales_contra_account_ongoing_isValid;
}

OAIActivityGroupType OAIActivityGroup::getType() const {
    return m_type;
}
void OAIActivityGroup::setType(const OAIActivityGroupType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIActivityGroup::is_type_Set() const{
    return m_type_isSet;
}

bool OAIActivityGroup::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIActivityGroup::isSet() const {
...
bool OAIActivityGroup::isValid() const {
