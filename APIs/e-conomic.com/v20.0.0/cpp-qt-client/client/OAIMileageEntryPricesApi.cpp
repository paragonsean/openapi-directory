...
#include "OAIMileageEntryPricesApi.h"
...
OAIMileageEntryPricesApi::OAIMileageEntryPricesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIMileageEntryPricesApi::~OAIMileageEntryPricesApi() {
}

void OAIMileageEntryPricesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getAllMileageEntryPrices", defaultConf);
    _serverIndices.insert("getAllMileageEntryPrices", 0);
    _serverConfigs.insert("getMileagePricesById", defaultConf);
    _serverIndices.insert("getMileagePricesById", 0);
    _serverConfigs.insert("getPageOfMileageEntryPrices", defaultConf);
    _serverIndices.insert("getPageOfMileageEntryPrices", 0);
}
...
*/
int OAIMileageEntryPricesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIMileageEntryPricesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIMileageEntryPricesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIMileageEntryPricesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIMileageEntryPricesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIMileageEntryPricesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIMileageEntryPricesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIMileageEntryPricesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIMileageEntryPricesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIMileageEntryPricesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIMileageEntryPricesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIMileageEntryPricesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIMileageEntryPricesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIMileageEntryPricesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIMileageEntryPricesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIMileageEntryPricesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIMileageEntryPricesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIMileageEntryPricesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIMileageEntryPricesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIMileageEntryPricesApi::getAllMileageEntryPrices(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllMileageEntryPrices"][_serverIndices.value("getAllMileageEntryPrices")].URL()+"/mileageprices");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMileageEntryPricesApi::getAllMileageEntryPricesCallback);
    connect(this, &OAIMileageEntryPricesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIMileageEntryPricesApi::getAllMileageEntryPricesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIMileagePricesCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllMileageEntryPricesSignal(output);
        Q_EMIT getAllMileageEntryPricesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllMileageEntryPricesSignalE(output, error_type, error_str);
        Q_EMIT getAllMileageEntryPricesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllMileageEntryPricesSignalError(output, error_type, error_str);
        Q_EMIT getAllMileageEntryPricesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMileageEntryPricesApi::getMileagePricesById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getMileagePricesById"][_serverIndices.value("getMileagePricesById")].URL()+"/mileageprices/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMileageEntryPricesApi::getMileagePricesByIdCallback);
    connect(this, &OAIMileageEntryPricesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMileageEntryPricesApi::getMileagePricesByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIMileagePrices output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getMileagePricesByIdSignal(output);
        Q_EMIT getMileagePricesByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getMileagePricesByIdSignalE(output, error_type, error_str);
        Q_EMIT getMileagePricesByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getMileagePricesByIdSignalError(output, error_type, error_str);
        Q_EMIT getMileagePricesByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMileageEntryPricesApi::getPageOfMileageEntryPrices(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfMileageEntryPrices"][_serverIndices.value("getPageOfMileageEntryPrices")].URL()+"/mileageprices/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMileageEntryPricesApi::getPageOfMileageEntryPricesCallback);
    connect(this, &OAIMileageEntryPricesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMileageEntryPricesApi::getPageOfMileageEntryPricesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIMileagePrices> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIMileagePrices val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfMileageEntryPricesSignal(output);
        Q_EMIT getPageOfMileageEntryPricesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfMileageEntryPricesSignalE(output, error_type, error_str);
        Q_EMIT getPageOfMileageEntryPricesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfMileageEntryPricesSignalError(output, error_type, error_str);
        Q_EMIT getPageOfMileageEntryPricesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMileageEntryPricesApi::tokenAvailable(){
