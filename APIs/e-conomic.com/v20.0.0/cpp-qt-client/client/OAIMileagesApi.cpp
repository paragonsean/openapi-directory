...
OAIMileagesApi::OAIMileagesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIMileagesApi::~OAIMileagesApi() {
}

void OAIMileagesApi::initializeServerConfigs() {
    //Default server
...
*/
int OAIMileagesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIMileagesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIMileagesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIMileagesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIMileagesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIMileagesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIMileagesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIMileagesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIMileagesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIMileagesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIMileagesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIMileagesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIMileagesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIMileagesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIMileagesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIMileagesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIMileagesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIMileagesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIMileagesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIMileagesApi::approveMileageEntries(const ::OpenAPI::OptionalParam<OAIMileageNumbersCollection> &oai_mileage_numbers_collection) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMileagesApi::approveMileageEntriesCallback);
    connect(this, &OAIMileagesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIMileagesApi::approveMileageEntriesCallback(OAIHttpRequestWorker *worker) {
...
void OAIMileagesApi::tokenAvailable(){
