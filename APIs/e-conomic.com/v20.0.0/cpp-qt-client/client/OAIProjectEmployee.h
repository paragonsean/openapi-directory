...
/*
 * OAIProjectEmployee.h
 *
 * 
 */

#ifndef OAIProjectEmployee_H
#define OAIProjectEmployee_H

#include <QJsonObject>

#include "OAIEmployeeType.h"
#include <QDate>
#include <QString>
...
class OAIProjectEmployee : public OAIObject {
public:
    OAIProjectEmployee();
    OAIProjectEmployee(QString json);
    ~OAIProjectEmployee() override;
    ...
    bool isCanApprove() const;
    void setCanApprove(const bool &can_approve);
    bool is_can_approve_Set() const;
    bool is_can_approve_Valid() const;

    bool isCanInvoice() const;
    void setCanInvoice(const bool &can_invoice);
    bool is_can_invoice_Set() const;
    bool is_can_invoice_Valid() const;
    ...
    double getCostPriceAfter() const;
    void setCostPriceAfter(const double &cost_price_after);
    bool is_cost_price_after_Set() const;
    bool is_cost_price_after_Valid() const;

    double getCostPriceBefore() const;
    void setCostPriceBefore(const double &cost_price_before);
    bool is_cost_price_before_Set() const;
    bool is_cost_price_before_Valid() const;

    QDate getCutOffDate() const;
    void setCutOffDate(const QDate &cut_off_date);
    bool is_cut_off_date_Set() const;
    bool is_cut_off_date_Valid() const;

    OAIEmployeeType getEmployeeType() const;
    void setEmployeeType(const OAIEmployeeType &employee_type);
    ...
    bool isIsUser() const;
    void setIsUser(const bool &is_user);
    bool is_is_user_Set() const;
    bool is_is_user_Valid() const;
    ...
    double getSalesPriceAfter() const;
    void setSalesPriceAfter(const double &sales_price_after);
    bool is_sales_price_after_Set() const;
    bool is_sales_price_after_Valid() const;

    double getSalesPriceBefore() const;
    void setSalesPriceBefore(const double &sales_price_before);
    bool is_sales_price_before_Set() const;
    bool is_sales_price_before_Valid() const;
...
private:
    ...
    bool m_can_approve;
    bool m_can_approve_isSet;
    bool m_can_approve_isValid;

    bool m_can_invoice;
    bool m_can_invoice_isSet;
    bool m_can_invoice_isValid;

    QString m_city;
    bool m_city_isSet;
    bool m_city_isValid;

    double m_cost_price_after;
    bool m_cost_price_after_isSet;
    bool m_cost_price_after_isValid;

    double m_cost_price_before;
    bool m_cost_price_before_isSet;
    bool m_cost_price_before_isValid;

    QDate m_cut_off_date;
    bool m_cut_off_date_isSet;
    bool m_cut_off_date_isValid;

    OAIEmployeeType m_employee_type;
    ...
    double m_sales_price_after;
    bool m_sales_price_after_isSet;
    bool m_sales_price_after_isValid;

    double m_sales_price_before;
    bool m_sales_price_before_isSet;
    bool m_sales_price_before_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectEmployee)

#endif // OAIProjectEmployee_H
