...
#include "OAIProjectCustomersApi.h"
...
OAIProjectCustomersApi::OAIProjectCustomersApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIProjectCustomersApi::~OAIProjectCustomersApi() {
}

void OAIProjectCustomersApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getAllProjectCustomers", defaultConf);
    _serverIndices.insert("getAllProjectCustomers", 0);
    _serverConfigs.insert("getNumberOfProjectCustomers", defaultConf);
    _serverIndices.insert("getNumberOfProjectCustomers", 0);
    _serverConfigs.insert("getPageOfProjectCustomers", defaultConf);
    _serverIndices.insert("getPageOfProjectCustomers", 0);
    _serverConfigs.insert("getProjectCustomerById", defaultConf);
    _serverIndices.insert("getProjectCustomerById", 0);
}
...
*/
int OAIProjectCustomersApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIProjectCustomersApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIProjectCustomersApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIProjectCustomersApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIProjectCustomersApi::setUsername(const QString &username) {
    _username = username;
}

void OAIProjectCustomersApi::setPassword(const QString &password) {
    _password = password;
}


void OAIProjectCustomersApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIProjectCustomersApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIProjectCustomersApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIProjectCustomersApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProjectCustomersApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProjectCustomersApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIProjectCustomersApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIProjectCustomersApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIProjectCustomersApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIProjectCustomersApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIProjectCustomersApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIProjectCustomersApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIProjectCustomersApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIProjectCustomersApi::getAllProjectCustomers(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllProjectCustomers"][_serverIndices.value("getAllProjectCustomers")].URL()+"/project-customers");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectCustomersApi::getAllProjectCustomersCallback);
    connect(this, &OAIProjectCustomersApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIProjectCustomersApi::getAllProjectCustomersCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIProjectCustomerCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllProjectCustomersSignal(output);
        Q_EMIT getAllProjectCustomersSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllProjectCustomersSignalE(output, error_type, error_str);
        Q_EMIT getAllProjectCustomersSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllProjectCustomersSignalError(output, error_type, error_str);
        Q_EMIT getAllProjectCustomersSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectCustomersApi::getNumberOfProjectCustomers(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfProjectCustomers"][_serverIndices.value("getNumberOfProjectCustomers")].URL()+"/project-customers/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectCustomersApi::getNumberOfProjectCustomersCallback);
    connect(this, &OAIProjectCustomersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectCustomersApi::getNumberOfProjectCustomersCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfProjectCustomersSignal(output);
        Q_EMIT getNumberOfProjectCustomersSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfProjectCustomersSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfProjectCustomersSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfProjectCustomersSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfProjectCustomersSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectCustomersApi::getPageOfProjectCustomers(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfProjectCustomers"][_serverIndices.value("getPageOfProjectCustomers")].URL()+"/project-customers/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectCustomersApi::getPageOfProjectCustomersCallback);
    connect(this, &OAIProjectCustomersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectCustomersApi::getPageOfProjectCustomersCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIProjectCustomer> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIProjectCustomer val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfProjectCustomersSignal(output);
        Q_EMIT getPageOfProjectCustomersSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfProjectCustomersSignalE(output, error_type, error_str);
        Q_EMIT getPageOfProjectCustomersSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfProjectCustomersSignalError(output, error_type, error_str);
        Q_EMIT getPageOfProjectCustomersSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectCustomersApi::getProjectCustomerById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getProjectCustomerById"][_serverIndices.value("getProjectCustomerById")].URL()+"/project-customers/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectCustomersApi::getProjectCustomerByIdCallback);
    connect(this, &OAIProjectCustomersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectCustomersApi::getProjectCustomerByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProjectCustomer output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getProjectCustomerByIdSignal(output);
        Q_EMIT getProjectCustomerByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getProjectCustomerByIdSignalE(output, error_type, error_str);
        Q_EMIT getProjectCustomerByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getProjectCustomerByIdSignalError(output, error_type, error_str);
        Q_EMIT getProjectCustomerByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectCustomersApi::tokenAvailable(){
