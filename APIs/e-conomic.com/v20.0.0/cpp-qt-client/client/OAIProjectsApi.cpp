...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("deleteProjectById", defaultConf);
    _serverIndices.insert("deleteProjectById", 0);
    _serverConfigs.insert("getAllProjects", defaultConf);
    _serverIndices.insert("getAllProjects", 0);
    _serverConfigs.insert("getNumberOfProjects", defaultConf);
    _serverIndices.insert("getNumberOfProjects", 0);
    _serverConfigs.insert("getPageOfProjects", defaultConf);
    _serverIndices.insert("getPageOfProjects", 0);
    _serverConfigs.insert("getPagedListOfProjectUnderEmployee", defaultConf);
    _serverIndices.insert("getPagedListOfProjectUnderEmployee", 0);
    _serverConfigs.insert("getProjectById", defaultConf);
    _serverIndices.insert("getProjectById", 0);
...
void OAIProjectsApi::createProject(const ::OpenAPI::OptionalParam<OAIProject> &oai_project) {
...
void OAIProjectsApi::deleteProjectById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["deleteProjectById"][_serverIndices.value("deleteProjectById")].URL()+"/projects/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::deleteProjectByIdCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::deleteProjectByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteProjectByIdSignal();
        Q_EMIT deleteProjectByIdSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteProjectByIdSignalE(error_type, error_str);
        Q_EMIT deleteProjectByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteProjectByIdSignalError(error_type, error_str);
        Q_EMIT deleteProjectByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::getAllProjects(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllProjects"][_serverIndices.value("getAllProjects")].URL()+"/projects");
...
void OAIProjectsApi::getAllProjectsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIProjectCursorResults output(QString(worker->response));
    worker->deleteLater();
...
void OAIProjectsApi::getNumberOfProjects(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfProjects"][_serverIndices.value("getNumberOfProjects")].URL()+"/projects/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::getNumberOfProjectsCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::getNumberOfProjectsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfProjectsSignal(output);
        Q_EMIT getNumberOfProjectsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfProjectsSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfProjectsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfProjectsSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfProjectsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::getPageOfProjects(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfProjects"][_serverIndices.value("getPageOfProjects")].URL()+"/projects/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::getPageOfProjectsCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::getPageOfProjectsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfProjectsSignal(output);
        Q_EMIT getPageOfProjectsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfProjectsSignalE(output, error_type, error_str);
        Q_EMIT getPageOfProjectsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfProjectsSignalError(output, error_type, error_str);
        Q_EMIT getPageOfProjectsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::getPagedListOfProjectUnderEmployee(const qint32 &employee_number) {
    QString fullPath = QString(_serverConfigs["getPagedListOfProjectUnderEmployee"][_serverIndices.value("getPagedListOfProjectUnderEmployee")].URL()+"/projects/allowed");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::getPagedListOfProjectUnderEmployeeCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::getPagedListOfProjectUnderEmployeeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPagedListOfProjectUnderEmployeeSignal(output);
        Q_EMIT getPagedListOfProjectUnderEmployeeSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPagedListOfProjectUnderEmployeeSignalE(output, error_type, error_str);
        Q_EMIT getPagedListOfProjectUnderEmployeeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPagedListOfProjectUnderEmployeeSignalError(output, error_type, error_str);
        Q_EMIT getPagedListOfProjectUnderEmployeeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::getProjectById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getProjectById"][_serverIndices.value("getProjectById")].URL()+"/projects/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::getProjectByIdCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::getProjectByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getProjectByIdSignal(output);
        Q_EMIT getProjectByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getProjectByIdSignalE(output, error_type, error_str);
        Q_EMIT getProjectByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getProjectByIdSignalError(output, error_type, error_str);
        Q_EMIT getProjectByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::updateProject(const ::OpenAPI::OptionalParam<OAIProject> &oai_project) {
