...
public:
    ...
    qint32 getContactPersonId() const;
    void setContactPersonId(const qint32 &contact_person_id);
    ...
    qint32 getDeliveryLocationNumber() const;
    void setDeliveryLocationNumber(const qint32 &delivery_location_number);
    bool is_delivery_location_number_Set() const;
    bool is_delivery_location_number_Valid() const;

    qint32 getDepartmentNumber() const;
    void setDepartmentNumber(const qint32 &department_number);
    bool is_department_number_Set() const;
    bool is_department_number_Valid() const;
    ...
    double getInvoicedTotal() const;
    void setInvoicedTotal(const double &invoiced_total);
    bool is_invoiced_total_Set() const;
    bool is_invoiced_total_Valid() const;

    bool isIsBarred() const;
    void setIsBarred(const bool &is_barred);
    bool is_is_barred_Set() const;
    bool is_is_barred_Valid() const;
    ...
    bool isIsMainProject() const;
    void setIsMainProject(const bool &is_main_project);
    bool is_is_main_project_Set() const;
    bool is_is_main_project_Valid() const;

    bool isIsMileageInvoiced() const;
    void setIsMileageInvoiced(const bool &is_mileage_invoiced);
    bool is_is_mileage_invoiced_Set() const;
    bool is_is_mileage_invoiced_Valid() const;
    ...
    qint32 getMainProjectNumber() const;
    void setMainProjectNumber(const qint32 &main_project_number);
    bool is_main_project_number_Set() const;
    bool is_main_project_number_Valid() const;

    double getMileage() const;
    void setMileage(const double &mileage);
    bool is_mileage_Set() const;
    bool is_mileage_Valid() const;
    ...
    qint32 getOtherResponsibleEmployeeNumber() const;
    void setOtherResponsibleEmployeeNumber(const qint32 &other_responsible_employee_number);
    bool is_other_responsible_employee_number_Set() const;
    bool is_other_responsible_employee_number_Valid() const;

    qint32 getProjectGroupNumber() const;
    void setProjectGroupNumber(const qint32 &project_group_number);
    bool is_project_group_number_Set() const;
    bool is_project_group_number_Valid() const;

    qint32 getResponsibleEmployeeNumber() const;
    void setResponsibleEmployeeNumber(const qint32 &responsible_employee_number);
    bool is_responsible_employee_number_Set() const;
    bool is_responsible_employee_number_Valid() const;

    double getSalesPrice() const;
    void setSalesPrice(const double &sales_price);
...
private:
    ...
    qint32 m_delivery_location_number;
    bool m_delivery_location_number_isSet;
    bool m_delivery_location_number_isValid;

    qint32 m_department_number;
    bool m_department_number_isSet;
    bool m_department_number_isValid;
    ...
    double m_invoiced_total;
    bool m_invoiced_total_isSet;
    bool m_invoiced_total_isValid;

    bool m_is_barred;
    bool m_is_barred_isSet;
    bool m_is_barred_isValid;

    bool m_is_closed;
    bool m_is_closed_isSet;
    bool m_is_closed_isValid;

    bool m_is_main_project;
    bool m_is_main_project_isSet;
    bool m_is_main_project_isValid;

    bool m_is_mileage_invoiced;
    bool m_is_mileage_invoiced_isSet;
    bool m_is_mileage_invoiced_isValid;

    QDateTime m_last_updated;
    bool m_last_updated_isSet;
    bool m_last_updated_isValid;

    qint32 m_main_project_number;
    bool m_main_project_number_isSet;
    bool m_main_project_number_isValid;

    double m_mileage;
    bool m_mileage_isSet;
    bool m_mileage_isValid;
    ...
    qint32 m_other_responsible_employee_number;
    bool m_other_responsible_employee_number_isSet;
    bool m_other_responsible_employee_number_isValid;

    qint32 m_project_group_number;
    bool m_project_group_number_isSet;
    bool m_project_group_number_isValid;

    qint32 m_responsible_employee_number;
    bool m_responsible_employee_number_isSet;
    bool m_responsible_employee_number_isValid;

    double m_sales_price;
