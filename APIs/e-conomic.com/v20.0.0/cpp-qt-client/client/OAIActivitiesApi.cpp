...
void OAIActivitiesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getActivityById", defaultConf);
    _serverIndices.insert("getActivityById", 0);
    _serverConfigs.insert("getAllActivities", defaultConf);
    _serverIndices.insert("getAllActivities", 0);
    _serverConfigs.insert("getAllowedActivities", defaultConf);
    _serverIndices.insert("getAllowedActivities", 0);
    _serverConfigs.insert("getNumberOfActivities", defaultConf);
    _serverIndices.insert("getNumberOfActivities", 0);
    _serverConfigs.insert("getPageOfActivities", defaultConf);
    _serverIndices.insert("getPageOfActivities", 0);
    _serverConfigs.insert("updateActivity", defaultConf);
...
void OAIActivitiesApi::createActivity(const ::OpenAPI::OptionalParam<OAIActivity> &oai_activity) {
...
void OAIActivitiesApi::getActivityById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getActivityById"][_serverIndices.value("getActivityById")].URL()+"/activities/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIActivitiesApi::getActivityByIdCallback);
    connect(this, &OAIActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIActivitiesApi::getActivityByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getActivityByIdSignal(output);
        Q_EMIT getActivityByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getActivityByIdSignalE(output, error_type, error_str);
        Q_EMIT getActivityByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getActivityByIdSignalError(output, error_type, error_str);
        Q_EMIT getActivityByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIActivitiesApi::getAllActivities(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllActivities"][_serverIndices.value("getAllActivities")].URL()+"/activities");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIActivitiesApi::getAllActivitiesCallback);
    connect(this, &OAIActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIActivitiesApi::getAllActivitiesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIActivityCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllActivitiesSignal(output);
        Q_EMIT getAllActivitiesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllActivitiesSignalE(output, error_type, error_str);
        Q_EMIT getAllActivitiesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllActivitiesSignalError(output, error_type, error_str);
        Q_EMIT getAllActivitiesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIActivitiesApi::getAllowedActivities(const qint32 &employee_number, const qint32 &project_number) {
    QString fullPath = QString(_serverConfigs["getAllowedActivities"][_serverIndices.value("getAllowedActivities")].URL()+"/activities/allowed");
    ...
    
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "employeeNumber", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("employeeNumber")).append(querySuffix).append(QUrl::toPercentEncoding(employee_number));
    }
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("projectNumber")).append(querySuffix).append(QUrl::toPercentEncoding(project_number));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIActivitiesApi::getAllowedActivitiesCallback);
    connect(this, &OAIActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIActivitiesApi::getAllowedActivitiesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllowedActivitiesSignal(output);
        Q_EMIT getAllowedActivitiesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllowedActivitiesSignalE(output, error_type, error_str);
        Q_EMIT getAllowedActivitiesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllowedActivitiesSignalError(output, error_type, error_str);
        Q_EMIT getAllowedActivitiesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIActivitiesApi::getNumberOfActivities(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfActivities"][_serverIndices.value("getNumberOfActivities")].URL()+"/activities/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIActivitiesApi::getNumberOfActivitiesCallback);
    connect(this, &OAIActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIActivitiesApi::getNumberOfActivitiesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfActivitiesSignal(output);
        Q_EMIT getNumberOfActivitiesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfActivitiesSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfActivitiesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfActivitiesSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfActivitiesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIActivitiesApi::getPageOfActivities(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfActivities"][_serverIndices.value("getPageOfActivities")].URL()+"/activities/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIActivitiesApi::getPageOfActivitiesCallback);
    connect(this, &OAIActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIActivitiesApi::getPageOfActivitiesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfActivitiesSignal(output);
        Q_EMIT getPageOfActivitiesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfActivitiesSignalE(output, error_type, error_str);
        Q_EMIT getPageOfActivitiesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfActivitiesSignalError(output, error_type, error_str);
        Q_EMIT getPageOfActivitiesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIActivitiesApi::updateActivity(const ::OpenAPI::OptionalParam<OAIActivity> &oai_activity) {
    QString fullPath = QString(_serverConfigs["updateActivity"][_serverIndices.value("updateActivity")].URL()+"/activities");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIActivitiesApi::updateActivityCallback);
    connect(this, &OAIActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIActivitiesApi::updateActivityCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateActivitySignal();
        Q_EMIT updateActivitySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateActivitySignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateActivitySignalError(error_type, error_str);
