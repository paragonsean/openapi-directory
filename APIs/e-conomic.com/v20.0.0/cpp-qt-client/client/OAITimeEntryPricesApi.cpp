...
#include "OAITimeEntryPricesApi.h"
...
OAITimeEntryPricesApi::OAITimeEntryPricesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITimeEntryPricesApi::~OAITimeEntryPricesApi() {
}

void OAITimeEntryPricesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getAllTimeEntryPrices", defaultConf);
    _serverIndices.insert("getAllTimeEntryPrices", 0);
    _serverConfigs.insert("getPageOfTimeEntryPrices", defaultConf);
    _serverIndices.insert("getPageOfTimeEntryPrices", 0);
    _serverConfigs.insert("getTimeEntryPricesById", defaultConf);
    _serverIndices.insert("getTimeEntryPricesById", 0);
}
...
*/
int OAITimeEntryPricesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITimeEntryPricesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITimeEntryPricesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITimeEntryPricesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITimeEntryPricesApi::setUsername(const QString &username) {
    _username = username;
}

void OAITimeEntryPricesApi::setPassword(const QString &password) {
    _password = password;
}


void OAITimeEntryPricesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITimeEntryPricesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITimeEntryPricesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITimeEntryPricesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITimeEntryPricesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITimeEntryPricesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITimeEntryPricesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITimeEntryPricesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITimeEntryPricesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITimeEntryPricesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITimeEntryPricesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITimeEntryPricesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITimeEntryPricesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITimeEntryPricesApi::getAllTimeEntryPrices(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllTimeEntryPrices"][_serverIndices.value("getAllTimeEntryPrices")].URL()+"/timeentryprices");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITimeEntryPricesApi::getAllTimeEntryPricesCallback);
    connect(this, &OAITimeEntryPricesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITimeEntryPricesApi::getAllTimeEntryPricesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAITimeEntryPricesCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllTimeEntryPricesSignal(output);
        Q_EMIT getAllTimeEntryPricesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllTimeEntryPricesSignalE(output, error_type, error_str);
        Q_EMIT getAllTimeEntryPricesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllTimeEntryPricesSignalError(output, error_type, error_str);
        Q_EMIT getAllTimeEntryPricesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITimeEntryPricesApi::getPageOfTimeEntryPrices(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfTimeEntryPrices"][_serverIndices.value("getPageOfTimeEntryPrices")].URL()+"/timeentryprices/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITimeEntryPricesApi::getPageOfTimeEntryPricesCallback);
    connect(this, &OAITimeEntryPricesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITimeEntryPricesApi::getPageOfTimeEntryPricesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAITimeEntryPrices> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAITimeEntryPrices val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfTimeEntryPricesSignal(output);
        Q_EMIT getPageOfTimeEntryPricesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfTimeEntryPricesSignalE(output, error_type, error_str);
        Q_EMIT getPageOfTimeEntryPricesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfTimeEntryPricesSignalError(output, error_type, error_str);
        Q_EMIT getPageOfTimeEntryPricesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITimeEntryPricesApi::getTimeEntryPricesById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getTimeEntryPricesById"][_serverIndices.value("getTimeEntryPricesById")].URL()+"/timeentryprices/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITimeEntryPricesApi::getTimeEntryPricesByIdCallback);
    connect(this, &OAITimeEntryPricesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITimeEntryPricesApi::getTimeEntryPricesByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAITimeEntryPrices output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getTimeEntryPricesByIdSignal(output);
        Q_EMIT getTimeEntryPricesByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getTimeEntryPricesByIdSignalE(output, error_type, error_str);
        Q_EMIT getTimeEntryPricesByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getTimeEntryPricesByIdSignalError(output, error_type, error_str);
        Q_EMIT getTimeEntryPricesByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITimeEntryPricesApi::tokenAvailable(){
