...
OAIProjectActivity::OAIProjectActivity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProjectActivity::OAIProjectActivity() {
    this->initializeModel();
}

OAIProjectActivity::~OAIProjectActivity() {}

void OAIProjectActivity::initializeModel() {

    m_activity_number_isSet = false;
    m_activity_number_isValid = false;
    ...
    m_responsible_employee_number_isSet = false;
    m_responsible_employee_number_isValid = false;

    m_start_date_isSet = false;
    m_start_date_isValid = false;
}

void OAIProjectActivity::fromJson(QString jsonString) {
...
void OAIProjectActivity::fromJsonObject(QJsonObject json) {

    m_activity_number_isValid = ::OpenAPI::fromJsonValue(m_activity_number, json[QString("activityNumber")]);
    m_activity_number_isSet = !json[QString("activityNumber")].isNull() && m_activity_number_isValid;
    ...
    m_responsible_employee_number_isValid = ::OpenAPI::fromJsonValue(m_responsible_employee_number, json[QString("responsibleEmployeeNumber")]);
    m_responsible_employee_number_isSet = !json[QString("responsibleEmployeeNumber")].isNull() && m_responsible_employee_number_isValid;

    m_start_date_isValid = ::OpenAPI::fromJsonValue(m_start_date, json[QString("startDate")]);
    m_start_date_isSet = !json[QString("startDate")].isNull() && m_start_date_isValid;
}

QString OAIProjectActivity::asJson() const {
...
QJsonObject OAIProjectActivity::asJsonObject() const {
    QJsonObject obj;
    if (m_activity_number_isSet) {
        obj.insert(QString("activityNumber"), ::OpenAPI::toJsonValue(m_activity_number));
    }
    ...
    if (m_responsible_employee_number_isSet) {
        obj.insert(QString("responsibleEmployeeNumber"), ::OpenAPI::toJsonValue(m_responsible_employee_number));
    }
...
qint32 OAIProjectActivity::getActivityNumber() const {
    return m_activity_number;
}
void OAIProjectActivity::setActivityNumber(const qint32 &activity_number) {
    m_activity_number = activity_number;
    m_activity_number_isSet = true;
}

bool OAIProjectActivity::is_activity_number_Set() const{
    return m_activity_number_isSet;
}

bool OAIProjectActivity::is_activity_number_Valid() const{
    return m_activity_number_isValid;
}

bool OAIProjectActivity::isCompleted() const {
    return m_completed;
}
void OAIProjectActivity::setCompleted(const bool &completed) {
    m_completed = completed;
    m_completed_isSet = true;
}

bool OAIProjectActivity::is_completed_Set() const{
    return m_completed_isSet;
}

bool OAIProjectActivity::is_completed_Valid() const{
    return m_completed_isValid;
}

QDateTime OAIProjectActivity::getEndDate() const {
    return m_end_date;
}
void OAIProjectActivity::setEndDate(const QDateTime &end_date) {
    m_end_date = end_date;
    m_end_date_isSet = true;
}

bool OAIProjectActivity::is_end_date_Set() const{
    return m_end_date_isSet;
}

bool OAIProjectActivity::is_end_date_Valid() const{
    return m_end_date_isValid;
}

qint32 OAIProjectActivity::getNumber() const {
    return m_number;
}
void OAIProjectActivity::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIProjectActivity::is_number_Set() const{
    return m_number_isSet;
}

bool OAIProjectActivity::is_number_Valid() const{
    return m_number_isValid;
}

QString OAIProjectActivity::getObjectVersion() const {
    return m_object_version;
}
void OAIProjectActivity::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAIProjectActivity::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAIProjectActivity::is_object_version_Valid() const{
    return m_object_version_isValid;
}

qint32 OAIProjectActivity::getProjectNumber() const {
    return m_project_number;
}
void OAIProjectActivity::setProjectNumber(const qint32 &project_number) {
    m_project_number = project_number;
    m_project_number_isSet = true;
}

bool OAIProjectActivity::is_project_number_Set() const{
    return m_project_number_isSet;
}

bool OAIProjectActivity::is_project_number_Valid() const{
    return m_project_number_isValid;
}

qint32 OAIProjectActivity::getResponsibleEmployeeNumber() const {
    return m_responsible_employee_number;
}
void OAIProjectActivity::setResponsibleEmployeeNumber(const qint32 &responsible_employee_number) {
    m_responsible_employee_number = responsible_employee_number;
    m_responsible_employee_number_isSet = true;
}

bool OAIProjectActivity::is_responsible_employee_number_Set() const{
    return m_responsible_employee_number_isSet;
}

bool OAIProjectActivity::is_responsible_employee_number_Valid() const{
    return m_responsible_employee_number_isValid;
}

QDateTime OAIProjectActivity::getStartDate() const {
    return m_start_date;
}
void OAIProjectActivity::setStartDate(const QDateTime &start_date) {
    m_start_date = start_date;
    m_start_date_isSet = true;
}

bool OAIProjectActivity::is_start_date_Set() const{
    return m_start_date_isSet;
}

bool OAIProjectActivity::is_start_date_Valid() const{
    return m_start_date_isValid;
}

bool OAIProjectActivity::isSet() const {
...
bool OAIProjectActivity::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_activity_number_isValid && m_project_number_isValid && true;
}
