...
OAIMileage::OAIMileage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMileage::OAIMileage() {
    this->initializeModel();
}

OAIMileage::~OAIMileage() {}

void OAIMileage::initializeModel() {
    ...
    m_include_approve_isSet = false;
    m_include_approve_isValid = false;
...
void OAIMileage::fromJson(QString jsonString) {
...
void OAIMileage::fromJsonObject(QJsonObject json) {
    ...
    m_include_approve_isValid = ::OpenAPI::fromJsonValue(m_include_approve, json[QString("includeApprove")]);
    m_include_approve_isSet = !json[QString("includeApprove")].isNull() && m_include_approve_isValid;
...
QString OAIMileage::asJson() const {
...
QJsonObject OAIMileage::asJsonObject() const {
    QJsonObject obj;
    if (m_date_isSet) {
    ...
    if (m_include_approve_isSet) {
        obj.insert(QString("includeApprove"), ::OpenAPI::toJsonValue(m_include_approve));
    }
...
QDateTime OAIMileage::getDate() const {
    return m_date;
}
void OAIMileage::setDate(const QDateTime &date) {
    m_date = date;
    m_date_isSet = true;
}

bool OAIMileage::is_date_Set() const{
    return m_date_isSet;
}

bool OAIMileage::is_date_Valid() const{
    return m_date_isValid;
}

double OAIMileage::getDistance() const {
    return m_distance;
}
void OAIMileage::setDistance(const double &distance) {
    m_distance = distance;
    m_distance_isSet = true;
}

bool OAIMileage::is_distance_Set() const{
    return m_distance_isSet;
}

bool OAIMileage::is_distance_Valid() const{
    return m_distance_isValid;
}

qint32 OAIMileage::getEmployeeNumber() const {
    return m_employee_number;
}
void OAIMileage::setEmployeeNumber(const qint32 &employee_number) {
    m_employee_number = employee_number;
    m_employee_number_isSet = true;
}

bool OAIMileage::is_employee_number_Set() const{
    return m_employee_number_isSet;
}

bool OAIMileage::is_employee_number_Valid() const{
    return m_employee_number_isValid;
}

QString OAIMileage::getFrom() const {
    return m_from;
}
void OAIMileage::setFrom(const QString &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAIMileage::is_from_Set() const{
    return m_from_isSet;
}

bool OAIMileage::is_from_Valid() const{
    return m_from_isValid;
}

bool OAIMileage::isIncludeApprove() const {
    return m_include_approve;
}
void OAIMileage::setIncludeApprove(const bool &include_approve) {
    m_include_approve = include_approve;
    m_include_approve_isSet = true;
}

bool OAIMileage::is_include_approve_Set() const{
    return m_include_approve_isSet;
}

bool OAIMileage::is_include_approve_Valid() const{
    return m_include_approve_isValid;
}

bool OAIMileage::isIsApproved() const {
    return m_is_approved;
}
void OAIMileage::setIsApproved(const bool &is_approved) {
    m_is_approved = is_approved;
    m_is_approved_isSet = true;
}

bool OAIMileage::is_is_approved_Set() const{
    return m_is_approved_isSet;
}

bool OAIMileage::is_is_approved_Valid() const{
    return m_is_approved_isValid;
}

qint32 OAIMileage::getNumber() const {
    return m_number;
}
void OAIMileage::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIMileage::is_number_Set() const{
    return m_number_isSet;
}

bool OAIMileage::is_number_Valid() const{
    return m_number_isValid;
}

QString OAIMileage::getObjectVersion() const {
    return m_object_version;
}
void OAIMileage::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAIMileage::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAIMileage::is_object_version_Valid() const{
    return m_object_version_isValid;
}

qint32 OAIMileage::getProjectNumber() const {
    return m_project_number;
}
void OAIMileage::setProjectNumber(const qint32 &project_number) {
    m_project_number = project_number;
    m_project_number_isSet = true;
}

bool OAIMileage::is_project_number_Set() const{
    return m_project_number_isSet;
}

bool OAIMileage::is_project_number_Valid() const{
    return m_project_number_isValid;
}

QString OAIMileage::getTo() const {
    return m_to;
}
void OAIMileage::setTo(const QString &to) {
    m_to = to;
    m_to_isSet = true;
}

bool OAIMileage::is_to_Set() const{
    return m_to_isSet;
}

bool OAIMileage::is_to_Valid() const{
    return m_to_isValid;
}

bool OAIMileage::isSet() const {
...
bool OAIMileage::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_date_isValid && m_distance_isValid && m_employee_number_isValid && m_project_number_isValid && true;
}
