...
void OAITimeEntriesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("approveTimeEntries", defaultConf);
    _serverIndices.insert("approveTimeEntries", 0);
    _serverConfigs.insert("approveTimeEntries_1", defaultConf);
    _serverIndices.insert("approveTimeEntries_1", 0);
    _serverConfigs.insert("createTimeEntry", defaultConf);
    _serverIndices.insert("createTimeEntry", 0);
    _serverConfigs.insert("deleteTimeEntryById", defaultConf);
    _serverIndices.insert("deleteTimeEntryById", 0);
    _serverConfigs.insert("getAllTimeEntries", defaultConf);
    _serverIndices.insert("getAllTimeEntries", 0);
    _serverConfigs.insert("getNumberOfTimeEntries", defaultConf);
    _serverIndices.insert("getNumberOfTimeEntries", 0);
    _serverConfigs.insert("getPageOfTimeEntries", defaultConf);
    _serverIndices.insert("getPageOfTimeEntries", 0);
    _serverConfigs.insert("getTimeEntryById", defaultConf);
    _serverIndices.insert("getTimeEntryById", 0);
    _serverConfigs.insert("updateTimeEntry", defaultConf);
    _serverIndices.insert("updateTimeEntry", 0);
}
...
void OAITimeEntriesApi::approveTimeEntries(const ::OpenAPI::OptionalParam<OAITimeEntryNumbersCollection> &oai_time_entry_numbers_collection) {
    QString fullPath = QString(_serverConfigs["approveTimeEntries"][_serverIndices.value("approveTimeEntries")].URL()+"/timeentries/approve");
    ...
    if (oai_time_entry_numbers_collection.hasValue()){

        
        QByteArray output = oai_time_entry_numbers_collection.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITimeEntriesApi::approveTimeEntriesCallback);
...
void OAITimeEntriesApi::approveTimeEntriesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT approveTimeEntriesSignal();
        Q_EMIT approveTimeEntriesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT approveTimeEntriesSignalE(error_type, error_str);
        Q_EMIT approveTimeEntriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT approveTimeEntriesSignalError(error_type, error_str);
        Q_EMIT approveTimeEntriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITimeEntriesApi::approveTimeEntries_1(const ::OpenAPI::OptionalParam<OAITimeEntryNumbersCollection> &oai_time_entry_numbers_collection) {
    QString fullPath = QString(_serverConfigs["approveTimeEntries_1"][_serverIndices.value("approveTimeEntries_1")].URL()+"/timeentries/approve");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITimeEntriesApi::approveTimeEntries_1Callback);
    connect(this, &OAITimeEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITimeEntriesApi::approveTimeEntries_1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT approveTimeEntries_1Signal();
        Q_EMIT approveTimeEntries_1SignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT approveTimeEntries_1SignalE(error_type, error_str);
        Q_EMIT approveTimeEntries_1SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT approveTimeEntries_1SignalError(error_type, error_str);
        Q_EMIT approveTimeEntries_1SignalErrorFull(worker, error_type, error_str);
    }
}

void OAITimeEntriesApi::createTimeEntry(const ::OpenAPI::OptionalParam<OAITimeEntry> &oai_time_entry) {
    QString fullPath = QString(_serverConfigs["createTimeEntry"][_serverIndices.value("createTimeEntry")].URL()+"/timeentries");
    ...
    if (oai_time_entry.hasValue()){

        
        QByteArray output = oai_time_entry.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITimeEntriesApi::createTimeEntryCallback);
    connect(this, &OAITimeEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITimeEntriesApi::createTimeEntryCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createTimeEntrySignal(output);
        Q_EMIT createTimeEntrySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createTimeEntrySignalE(output, error_type, error_str);
        Q_EMIT createTimeEntrySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createTimeEntrySignalError(output, error_type, error_str);
        Q_EMIT createTimeEntrySignalErrorFull(worker, error_type, error_str);
    }
}

void OAITimeEntriesApi::deleteTimeEntryById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["deleteTimeEntryById"][_serverIndices.value("deleteTimeEntryById")].URL()+"/timeentries/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITimeEntriesApi::deleteTimeEntryByIdCallback);
    connect(this, &OAITimeEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITimeEntriesApi::deleteTimeEntryByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteTimeEntryByIdSignal();
        Q_EMIT deleteTimeEntryByIdSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteTimeEntryByIdSignalE(error_type, error_str);
        Q_EMIT deleteTimeEntryByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteTimeEntryByIdSignalError(error_type, error_str);
        Q_EMIT deleteTimeEntryByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITimeEntriesApi::getAllTimeEntries(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllTimeEntries"][_serverIndices.value("getAllTimeEntries")].URL()+"/timeentries");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITimeEntriesApi::getAllTimeEntriesCallback);
    connect(this, &OAITimeEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITimeEntriesApi::getAllTimeEntriesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAITimeEntryCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllTimeEntriesSignal(output);
        Q_EMIT getAllTimeEntriesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllTimeEntriesSignalE(output, error_type, error_str);
        Q_EMIT getAllTimeEntriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllTimeEntriesSignalError(output, error_type, error_str);
        Q_EMIT getAllTimeEntriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITimeEntriesApi::getNumberOfTimeEntries(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfTimeEntries"][_serverIndices.value("getNumberOfTimeEntries")].URL()+"/timeentries/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITimeEntriesApi::getNumberOfTimeEntriesCallback);
    connect(this, &OAITimeEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITimeEntriesApi::getNumberOfTimeEntriesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfTimeEntriesSignal(output);
        Q_EMIT getNumberOfTimeEntriesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfTimeEntriesSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfTimeEntriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfTimeEntriesSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfTimeEntriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITimeEntriesApi::getPageOfTimeEntries(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfTimeEntries"][_serverIndices.value("getPageOfTimeEntries")].URL()+"/timeentries/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITimeEntriesApi::getPageOfTimeEntriesCallback);
    connect(this, &OAITimeEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITimeEntriesApi::getPageOfTimeEntriesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfTimeEntriesSignal(output);
        Q_EMIT getPageOfTimeEntriesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfTimeEntriesSignalE(output, error_type, error_str);
        Q_EMIT getPageOfTimeEntriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfTimeEntriesSignalError(output, error_type, error_str);
        Q_EMIT getPageOfTimeEntriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITimeEntriesApi::getTimeEntryById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getTimeEntryById"][_serverIndices.value("getTimeEntryById")].URL()+"/timeentries/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITimeEntriesApi::getTimeEntryByIdCallback);
    connect(this, &OAITimeEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITimeEntriesApi::getTimeEntryByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAITimeEntry output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getTimeEntryByIdSignal(output);
        Q_EMIT getTimeEntryByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getTimeEntryByIdSignalE(output, error_type, error_str);
        Q_EMIT getTimeEntryByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getTimeEntryByIdSignalError(output, error_type, error_str);
        Q_EMIT getTimeEntryByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITimeEntriesApi::updateTimeEntry(const ::OpenAPI::OptionalParam<OAITimeEntry> &oai_time_entry) {
    QString fullPath = QString(_serverConfigs["updateTimeEntry"][_serverIndices.value("updateTimeEntry")].URL()+"/timeentries");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITimeEntriesApi::updateTimeEntryCallback);
    connect(this, &OAITimeEntriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITimeEntriesApi::updateTimeEntryCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateTimeEntrySignal();
        Q_EMIT updateTimeEntrySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateTimeEntrySignalE(error_type, error_str);
        Q_EMIT updateTimeEntrySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateTimeEntrySignalError(error_type, error_str);
        Q_EMIT updateTimeEntrySignalErrorFull(worker, error_type, error_str);
    }
}
