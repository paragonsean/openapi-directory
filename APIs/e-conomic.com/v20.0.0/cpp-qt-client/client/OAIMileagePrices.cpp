...
OAIMileagePrices::OAIMileagePrices(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMileagePrices::OAIMileagePrices() {
    this->initializeModel();
}

OAIMileagePrices::~OAIMileagePrices() {}

void OAIMileagePrices::initializeModel() {

    m_cost_price_isSet = false;
    m_cost_price_isValid = false;

    m_cost_rate_isSet = false;
    m_cost_rate_isValid = false;
    ...
    m_sales_rate_isSet = false;
    m_sales_rate_isValid = false;
}

void OAIMileagePrices::fromJson(QString jsonString) {
...
void OAIMileagePrices::fromJsonObject(QJsonObject json) {
    ...
    m_cost_rate_isValid = ::OpenAPI::fromJsonValue(m_cost_rate, json[QString("costRate")]);
    m_cost_rate_isSet = !json[QString("costRate")].isNull() && m_cost_rate_isValid;

    m_number_isValid = ::OpenAPI::fromJsonValue(m_number, json[QString("number")]);
    m_number_isSet = !json[QString("number")].isNull() && m_number_isValid;

    m_sales_price_isValid = ::OpenAPI::fromJsonValue(m_sales_price, json[QString("salesPrice")]);
    m_sales_price_isSet = !json[QString("salesPrice")].isNull() && m_sales_price_isValid;

    m_sales_rate_isValid = ::OpenAPI::fromJsonValue(m_sales_rate, json[QString("salesRate")]);
    m_sales_rate_isSet = !json[QString("salesRate")].isNull() && m_sales_rate_isValid;
}

QString OAIMileagePrices::asJson() const {
...
QJsonObject OAIMileagePrices::asJsonObject() const {
    QJsonObject obj;
    if (m_cost_price_isSet) {
        obj.insert(QString("costPrice"), ::OpenAPI::toJsonValue(m_cost_price));
    }
    if (m_cost_rate_isSet) {
        obj.insert(QString("costRate"), ::OpenAPI::toJsonValue(m_cost_rate));
    }
    if (m_number_isSet) {
        obj.insert(QString("number"), ::OpenAPI::toJsonValue(m_number));
    }
    if (m_sales_price_isSet) {
        obj.insert(QString("salesPrice"), ::OpenAPI::toJsonValue(m_sales_price));
    }
    if (m_sales_rate_isSet) {
        obj.insert(QString("salesRate"), ::OpenAPI::toJsonValue(m_sales_rate));
    }
    return obj;
}

double OAIMileagePrices::getCostPrice() const {
    return m_cost_price;
}
void OAIMileagePrices::setCostPrice(const double &cost_price) {
    m_cost_price = cost_price;
    m_cost_price_isSet = true;
}

bool OAIMileagePrices::is_cost_price_Set() const{
    return m_cost_price_isSet;
}

bool OAIMileagePrices::is_cost_price_Valid() const{
    return m_cost_price_isValid;
}

double OAIMileagePrices::getCostRate() const {
    return m_cost_rate;
}
void OAIMileagePrices::setCostRate(const double &cost_rate) {
    m_cost_rate = cost_rate;
    m_cost_rate_isSet = true;
}

bool OAIMileagePrices::is_cost_rate_Set() const{
    return m_cost_rate_isSet;
}

bool OAIMileagePrices::is_cost_rate_Valid() const{
    return m_cost_rate_isValid;
}

qint32 OAIMileagePrices::getNumber() const {
    return m_number;
}
void OAIMileagePrices::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIMileagePrices::is_number_Set() const{
    return m_number_isSet;
}

bool OAIMileagePrices::is_number_Valid() const{
    return m_number_isValid;
}

double OAIMileagePrices::getSalesPrice() const {
    return m_sales_price;
}
void OAIMileagePrices::setSalesPrice(const double &sales_price) {
    m_sales_price = sales_price;
    m_sales_price_isSet = true;
}

bool OAIMileagePrices::is_sales_price_Set() const{
    return m_sales_price_isSet;
}

bool OAIMileagePrices::is_sales_price_Valid() const{
    return m_sales_price_isValid;
}

double OAIMileagePrices::getSalesRate() const {
    return m_sales_rate;
}
void OAIMileagePrices::setSalesRate(const double &sales_rate) {
    m_sales_rate = sales_rate;
    m_sales_rate_isSet = true;
}

bool OAIMileagePrices::is_sales_rate_Set() const{
    return m_sales_rate_isSet;
}

bool OAIMileagePrices::is_sales_rate_Valid() const{
    return m_sales_rate_isValid;
}

bool OAIMileagePrices::isSet() const {
...
bool OAIMileagePrices::isValid() const {
