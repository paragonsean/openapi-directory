...
qint32 OAIProjectStatus::getNumber() const {
    return m_number;
}
void OAIProjectStatus::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIProjectStatus::is_number_Set() const{
    return m_number_isSet;
}

bool OAIProjectStatus::is_number_Valid() const{
    return m_number_isValid;
}

QString OAIProjectStatus::getObjectVersion() const {
    return m_object_version;
}
void OAIProjectStatus::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAIProjectStatus::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAIProjectStatus::is_object_version_Valid() const{
    return m_object_version_isValid;
}

qint32 OAIProjectStatus::getPriority() const {
    return m_priority;
}
void OAIProjectStatus::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIProjectStatus::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIProjectStatus::is_priority_Valid() const{
    return m_priority_isValid;
}

OAIProjectStatusType OAIProjectStatus::getType() const {
    return m_type;
}
void OAIProjectStatus::setType(const OAIProjectStatusType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIProjectStatus::is_type_Set() const{
    return m_type_isSet;
}

bool OAIProjectStatus::is_type_Valid() const{
