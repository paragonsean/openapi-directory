...
OAIProjectGroupsApi::OAIProjectGroupsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIProjectGroupsApi::~OAIProjectGroupsApi() {
}

void OAIProjectGroupsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("createProjectGroup", defaultConf);
    _serverIndices.insert("createProjectGroup", 0);
    _serverConfigs.insert("getAllProjectGroups", defaultConf);
    _serverIndices.insert("getAllProjectGroups", 0);
    _serverConfigs.insert("getNumberOfProjectGroups", defaultConf);
    _serverIndices.insert("getNumberOfProjectGroups", 0);
    _serverConfigs.insert("getPageOfProjectGroups", defaultConf);
    _serverIndices.insert("getPageOfProjectGroups", 0);
    _serverConfigs.insert("getProjectGroupById", defaultConf);
    _serverIndices.insert("getProjectGroupById", 0);
}
...
*/
int OAIProjectGroupsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIProjectGroupsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIProjectGroupsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIProjectGroupsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIProjectGroupsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIProjectGroupsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIProjectGroupsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIProjectGroupsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIProjectGroupsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIProjectGroupsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProjectGroupsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProjectGroupsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIProjectGroupsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIProjectGroupsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIProjectGroupsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIProjectGroupsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIProjectGroupsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIProjectGroupsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIProjectGroupsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIProjectGroupsApi::createProjectGroup(const ::OpenAPI::OptionalParam<OAIProjectGroup> &oai_project_group) {
    QString fullPath = QString(_serverConfigs["createProjectGroup"][_serverIndices.value("createProjectGroup")].URL()+"/projectgroups");
    ...
    if (oai_project_group.hasValue()){

        
        QByteArray output = oai_project_group.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectGroupsApi::createProjectGroupCallback);
    connect(this, &OAIProjectGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIProjectGroupsApi::createProjectGroupCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createProjectGroupSignal(output);
        Q_EMIT createProjectGroupSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createProjectGroupSignalE(output, error_type, error_str);
        Q_EMIT createProjectGroupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createProjectGroupSignalError(output, error_type, error_str);
        Q_EMIT createProjectGroupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectGroupsApi::getAllProjectGroups(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllProjectGroups"][_serverIndices.value("getAllProjectGroups")].URL()+"/projectgroups");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectGroupsApi::getAllProjectGroupsCallback);
    connect(this, &OAIProjectGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectGroupsApi::getAllProjectGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProjectGroupCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllProjectGroupsSignal(output);
        Q_EMIT getAllProjectGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllProjectGroupsSignalE(output, error_type, error_str);
        Q_EMIT getAllProjectGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllProjectGroupsSignalError(output, error_type, error_str);
        Q_EMIT getAllProjectGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectGroupsApi::getNumberOfProjectGroups(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfProjectGroups"][_serverIndices.value("getNumberOfProjectGroups")].URL()+"/projectgroups/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectGroupsApi::getNumberOfProjectGroupsCallback);
    connect(this, &OAIProjectGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectGroupsApi::getNumberOfProjectGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfProjectGroupsSignal(output);
        Q_EMIT getNumberOfProjectGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfProjectGroupsSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfProjectGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfProjectGroupsSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfProjectGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectGroupsApi::getPageOfProjectGroups(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfProjectGroups"][_serverIndices.value("getPageOfProjectGroups")].URL()+"/projectgroups/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectGroupsApi::getPageOfProjectGroupsCallback);
    connect(this, &OAIProjectGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectGroupsApi::getPageOfProjectGroupsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfProjectGroupsSignal(output);
        Q_EMIT getPageOfProjectGroupsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfProjectGroupsSignalE(output, error_type, error_str);
        Q_EMIT getPageOfProjectGroupsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfProjectGroupsSignalError(output, error_type, error_str);
        Q_EMIT getPageOfProjectGroupsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectGroupsApi::getProjectGroupById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getProjectGroupById"][_serverIndices.value("getProjectGroupById")].URL()+"/projectgroups/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectGroupsApi::getProjectGroupByIdCallback);
    connect(this, &OAIProjectGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectGroupsApi::getProjectGroupByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProjectGroup output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getProjectGroupByIdSignal(output);
        Q_EMIT getProjectGroupByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getProjectGroupByIdSignalE(output, error_type, error_str);
        Q_EMIT getProjectGroupByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getProjectGroupByIdSignalError(output, error_type, error_str);
        Q_EMIT getProjectGroupByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectGroupsApi::tokenAvailable(){
