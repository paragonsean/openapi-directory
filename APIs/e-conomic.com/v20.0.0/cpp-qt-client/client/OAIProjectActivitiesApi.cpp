...
#include "OAIProjectActivitiesApi.h"
...
OAIProjectActivitiesApi::OAIProjectActivitiesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIProjectActivitiesApi::~OAIProjectActivitiesApi() {
}

void OAIProjectActivitiesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("createProjectActivity", defaultConf);
    _serverIndices.insert("createProjectActivity", 0);
    _serverConfigs.insert("deleteProjectActivityById", defaultConf);
    _serverIndices.insert("deleteProjectActivityById", 0);
    _serverConfigs.insert("getAllProjectActivities", defaultConf);
    _serverIndices.insert("getAllProjectActivities", 0);
    _serverConfigs.insert("getNumberOfProjectActivities", defaultConf);
    _serverIndices.insert("getNumberOfProjectActivities", 0);
    _serverConfigs.insert("getPageOfProjectActivities", defaultConf);
    _serverIndices.insert("getPageOfProjectActivities", 0);
    _serverConfigs.insert("getProjectActivityById", defaultConf);
    _serverIndices.insert("getProjectActivityById", 0);
    _serverConfigs.insert("updateProjectActivity", defaultConf);
    _serverIndices.insert("updateProjectActivity", 0);
}
...
*/
int OAIProjectActivitiesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIProjectActivitiesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIProjectActivitiesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIProjectActivitiesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIProjectActivitiesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIProjectActivitiesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIProjectActivitiesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIProjectActivitiesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIProjectActivitiesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIProjectActivitiesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProjectActivitiesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProjectActivitiesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIProjectActivitiesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIProjectActivitiesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIProjectActivitiesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIProjectActivitiesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIProjectActivitiesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIProjectActivitiesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIProjectActivitiesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIProjectActivitiesApi::createProjectActivity(const ::OpenAPI::OptionalParam<OAIProjectActivity> &oai_project_activity) {
    QString fullPath = QString(_serverConfigs["createProjectActivity"][_serverIndices.value("createProjectActivity")].URL()+"/project-activities");
    ...
    if (oai_project_activity.hasValue()){

        
        QByteArray output = oai_project_activity.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectActivitiesApi::createProjectActivityCallback);
    connect(this, &OAIProjectActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIProjectActivitiesApi::createProjectActivityCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createProjectActivitySignal(output);
        Q_EMIT createProjectActivitySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createProjectActivitySignalE(output, error_type, error_str);
        Q_EMIT createProjectActivitySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createProjectActivitySignalError(output, error_type, error_str);
        Q_EMIT createProjectActivitySignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectActivitiesApi::deleteProjectActivityById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["deleteProjectActivityById"][_serverIndices.value("deleteProjectActivityById")].URL()+"/project-activities/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectActivitiesApi::deleteProjectActivityByIdCallback);
    connect(this, &OAIProjectActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectActivitiesApi::deleteProjectActivityByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteProjectActivityByIdSignal();
        Q_EMIT deleteProjectActivityByIdSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteProjectActivityByIdSignalE(error_type, error_str);
        Q_EMIT deleteProjectActivityByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteProjectActivityByIdSignalError(error_type, error_str);
        Q_EMIT deleteProjectActivityByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectActivitiesApi::getAllProjectActivities(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getAllProjectActivities"][_serverIndices.value("getAllProjectActivities")].URL()+"/project-activities");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectActivitiesApi::getAllProjectActivitiesCallback);
    connect(this, &OAIProjectActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectActivitiesApi::getAllProjectActivitiesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProjectActivityCursorResults output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllProjectActivitiesSignal(output);
        Q_EMIT getAllProjectActivitiesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllProjectActivitiesSignalE(output, error_type, error_str);
        Q_EMIT getAllProjectActivitiesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllProjectActivitiesSignalError(output, error_type, error_str);
        Q_EMIT getAllProjectActivitiesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectActivitiesApi::getNumberOfProjectActivities(const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["getNumberOfProjectActivities"][_serverIndices.value("getNumberOfProjectActivities")].URL()+"/project-activities/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectActivitiesApi::getNumberOfProjectActivitiesCallback);
    connect(this, &OAIProjectActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectActivitiesApi::getNumberOfProjectActivitiesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNumberOfProjectActivitiesSignal(output);
        Q_EMIT getNumberOfProjectActivitiesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNumberOfProjectActivitiesSignalE(output, error_type, error_str);
        Q_EMIT getNumberOfProjectActivitiesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNumberOfProjectActivitiesSignalError(output, error_type, error_str);
        Q_EMIT getNumberOfProjectActivitiesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectActivitiesApi::getPageOfProjectActivities(const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &skip_pages) {
    QString fullPath = QString(_serverConfigs["getPageOfProjectActivities"][_serverIndices.value("getPageOfProjectActivities")].URL()+"/project-activities/paged");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectActivitiesApi::getPageOfProjectActivitiesCallback);
    connect(this, &OAIProjectActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectActivitiesApi::getPageOfProjectActivitiesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIProjectActivity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIProjectActivity val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPageOfProjectActivitiesSignal(output);
        Q_EMIT getPageOfProjectActivitiesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPageOfProjectActivitiesSignalE(output, error_type, error_str);
        Q_EMIT getPageOfProjectActivitiesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPageOfProjectActivitiesSignalError(output, error_type, error_str);
        Q_EMIT getPageOfProjectActivitiesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectActivitiesApi::getProjectActivityById(const qint32 &number) {
    QString fullPath = QString(_serverConfigs["getProjectActivityById"][_serverIndices.value("getProjectActivityById")].URL()+"/project-activities/{number}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectActivitiesApi::getProjectActivityByIdCallback);
    connect(this, &OAIProjectActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectActivitiesApi::getProjectActivityByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProjectActivity output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getProjectActivityByIdSignal(output);
        Q_EMIT getProjectActivityByIdSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getProjectActivityByIdSignalE(output, error_type, error_str);
        Q_EMIT getProjectActivityByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getProjectActivityByIdSignalError(output, error_type, error_str);
        Q_EMIT getProjectActivityByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectActivitiesApi::updateProjectActivity(const ::OpenAPI::OptionalParam<OAIProjectActivity> &oai_project_activity) {
    QString fullPath = QString(_serverConfigs["updateProjectActivity"][_serverIndices.value("updateProjectActivity")].URL()+"/project-activities");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectActivitiesApi::updateProjectActivityCallback);
    connect(this, &OAIProjectActivitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectActivitiesApi::updateProjectActivityCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateProjectActivitySignal();
        Q_EMIT updateProjectActivitySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateProjectActivitySignalE(error_type, error_str);
        Q_EMIT updateProjectActivitySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateProjectActivitySignalError(error_type, error_str);
        Q_EMIT updateProjectActivitySignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectActivitiesApi::tokenAvailable(){
