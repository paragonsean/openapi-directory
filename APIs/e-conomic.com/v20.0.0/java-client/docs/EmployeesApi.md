...
# **createEmployee**
> CreatedResult createEmployee(employee)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CreatedResult result = apiInstance.createEmployee(employee);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteEmployeeById(number);
    } catch (ApiException e) {
      System.err.println("Exception when calling EmployeesApi#deleteEmployeeById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **getAllEmployees**
> EmployeeCursorResults getAllEmployees(cursor, filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      EmployeeCursorResults result = apiInstance.getAllEmployees(cursor, filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EmployeesApi#getAllEmployees");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer number = 56; // Integer | 
    try {
      Employee result = apiInstance.getEmployeeById(number);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="getNumberOfEmployees"></a>
# **getNumberOfEmployees**
> Integer getNumberOfEmployees(filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    String filter = "filter_example"; // String | 
    try {
      Integer result = apiInstance.getNumberOfEmployees(filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EmployeesApi#getNumberOfEmployees");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getPageOfEmployees"></a>
# **getPageOfEmployees**
> List&lt;Employee&gt; getPageOfEmployees(filter, sort, pageSize, skipPages)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<Employee> result = apiInstance.getPageOfEmployees(filter, sort, pageSize, skipPages);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EmployeesApi#getPageOfEmployees");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
