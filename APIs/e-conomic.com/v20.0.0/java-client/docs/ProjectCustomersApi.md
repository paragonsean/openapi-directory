...
|------------- | ------------- | -------------|
| [**getAllProjectCustomers**](ProjectCustomersApi.md#getAllProjectCustomers) | **GET** /project-customers | Retrieve all Project Customers |
| [**getNumberOfProjectCustomers**](ProjectCustomersApi.md#getNumberOfProjectCustomers) | **GET** /project-customers/count | Retrieve the number of Project Customers |
| [**getPageOfProjectCustomers**](ProjectCustomersApi.md#getPageOfProjectCustomers) | **GET** /project-customers/paged | Retrieve a page of Project Customers |
| [**getProjectCustomerById**](ProjectCustomersApi.md#getProjectCustomerById) | **GET** /project-customers/{number} | Retrieve single Project Customer |


<a id="getAllProjectCustomers"></a>
# **getAllProjectCustomers**
> ProjectCustomerCursorResults getAllProjectCustomers(cursor, filter)
...
import org.openapitools.client.api.ProjectCustomersApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectCustomersApi apiInstance = new ProjectCustomersApi(defaultClient);
    String cursor = "cursor_example"; // String | 
    String filter = "filter_example"; // String | 
    try {
      ProjectCustomerCursorResults result = apiInstance.getAllProjectCustomers(cursor, filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectCustomersApi#getAllProjectCustomers");
...
[**ProjectCustomerCursorResults**](ProjectCustomerCursorResults.md)
...
<a id="getNumberOfProjectCustomers"></a>
# **getNumberOfProjectCustomers**
> Integer getNumberOfProjectCustomers(filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    String filter = "filter_example"; // String | 
    try {
      Integer result = apiInstance.getNumberOfProjectCustomers(filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectCustomersApi#getNumberOfProjectCustomers");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getPageOfProjectCustomers"></a>
# **getPageOfProjectCustomers**
> List&lt;ProjectCustomer&gt; getPageOfProjectCustomers(filter, sort, pageSize, skipPages)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<ProjectCustomer> result = apiInstance.getPageOfProjectCustomers(filter, sort, pageSize, skipPages);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectCustomersApi#getPageOfProjectCustomers");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**List&lt;ProjectCustomer&gt;**](ProjectCustomer.md)
...
<a id="getProjectCustomerById"></a>
# **getProjectCustomerById**
> ProjectCustomer getProjectCustomerById(number)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ProjectCustomer result = apiInstance.getProjectCustomerById(number);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectCustomersApi#getProjectCustomerById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**ProjectCustomer**](ProjectCustomer.md)
