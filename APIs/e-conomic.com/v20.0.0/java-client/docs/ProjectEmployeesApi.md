...
<a id="createProjectEmployee"></a>
# **createProjectEmployee**
> CreatedResult createProjectEmployee(projectEmployee)
...
import org.openapitools.client.api.ProjectEmployeesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectEmployeesApi apiInstance = new ProjectEmployeesApi(defaultClient);
    ProjectEmployee projectEmployee = new ProjectEmployee(); // ProjectEmployee | 
    try {
      CreatedResult result = apiInstance.createProjectEmployee(projectEmployee);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectEmployeesApi#createProjectEmployee");
...
<a id="deleteProjectEmployeeById"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteProjectEmployeeById(number);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectEmployeesApi#deleteProjectEmployeeById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getAllProjectEmployees"></a>
# **getAllProjectEmployees**
> ProjectEmployeeCursorResults getAllProjectEmployees(cursor, filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ProjectEmployeeCursorResults result = apiInstance.getAllProjectEmployees(cursor, filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectEmployeesApi#getAllProjectEmployees");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getNumberOfProjectEmployees"></a>
# **getNumberOfProjectEmployees**
> Integer getNumberOfProjectEmployees(filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    String filter = "filter_example"; // String | 
    try {
      Integer result = apiInstance.getNumberOfProjectEmployees(filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectEmployeesApi#getNumberOfProjectEmployees");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getPageOfProjectEmployees"></a>
# **getPageOfProjectEmployees**
> List&lt;ProjectEmployee&gt; getPageOfProjectEmployees(filter, sort, pageSize, skipPages)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<ProjectEmployee> result = apiInstance.getPageOfProjectEmployees(filter, sort, pageSize, skipPages);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectEmployeesApi#getPageOfProjectEmployees");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**List&lt;ProjectEmployee&gt;**](ProjectEmployee.md)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer number = 56; // Integer | 
    try {
      ProjectEmployee result = apiInstance.getProjectEmployeeById(number);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectEmployeesApi#getProjectEmployeeById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateProjectEmployee"></a>
# **updateProjectEmployee**
> updateProjectEmployee(projectEmployee)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectEmployee projectEmployee = new ProjectEmployee(); // ProjectEmployee | 
    try {
      apiInstance.updateProjectEmployee(projectEmployee);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectEmployeesApi#updateProjectEmployee");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
