...
<a id="getAllProjectStatuses"></a>
# **getAllProjectStatuses**
> ProjectStatusCursorResults getAllProjectStatuses(cursor, filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ProjectStatusCursorResults result = apiInstance.getAllProjectStatuses(cursor, filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectStatusesApi#getAllProjectStatuses");
...
<a id="getNumberOfProjectStatuses"></a>
# **getNumberOfProjectStatuses**
> Integer getNumberOfProjectStatuses(filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    String filter = "filter_example"; // String | 
    try {
      Integer result = apiInstance.getNumberOfProjectStatuses(filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectStatusesApi#getNumberOfProjectStatuses");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getPageOfProjectStatuses"></a>
# **getPageOfProjectStatuses**
> List&lt;ProjectStatus&gt; getPageOfProjectStatuses(filter, sort, pageSize, skipPages)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<ProjectStatus> result = apiInstance.getPageOfProjectStatuses(filter, sort, pageSize, skipPages);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectStatusesApi#getPageOfProjectStatuses");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ProjectStatus result = apiInstance.getProjectStatusById(number);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectStatusesApi#getProjectStatusById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
