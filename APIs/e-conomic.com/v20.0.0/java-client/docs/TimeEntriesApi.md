...
<a id="approveTimeEntries"></a>
# **approveTimeEntries**
> approveTimeEntries(timeEntryNumbersCollection)
...
public class Example {
  public static void main(String[] args) {
    ...
    TimeEntryNumbersCollection timeEntryNumbersCollection = new TimeEntryNumbersCollection(); // TimeEntryNumbersCollection | 
    try {
      apiInstance.approveTimeEntries(timeEntryNumbersCollection);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeEntriesApi#approveTimeEntries");
...
<a id="approveTimeEntries_0"></a>
# **approveTimeEntries_0**
> approveTimeEntries_0(timeEntryNumbersCollection)
...
public class Example {
  public static void main(String[] args) {
    ...
    TimeEntryNumbersCollection timeEntryNumbersCollection = new TimeEntryNumbersCollection(); // TimeEntryNumbersCollection | 
    try {
      apiInstance.approveTimeEntries_0(timeEntryNumbersCollection);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeEntriesApi#approveTimeEntries_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="createTimeEntry"></a>
# **createTimeEntry**
> CreatedResult createTimeEntry(timeEntry)
...
public class Example {
  public static void main(String[] args) {
    ...
    TimeEntriesApi apiInstance = new TimeEntriesApi(defaultClient);
    TimeEntry timeEntry = new TimeEntry(); // TimeEntry | 
    try {
      CreatedResult result = apiInstance.createTimeEntry(timeEntry);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeEntriesApi#createTimeEntry");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteTimeEntryById(number);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeEntriesApi#deleteTimeEntryById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getAllTimeEntries"></a>
# **getAllTimeEntries**
> TimeEntryCursorResults getAllTimeEntries(cursor, filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      TimeEntryCursorResults result = apiInstance.getAllTimeEntries(cursor, filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeEntriesApi#getAllTimeEntries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getNumberOfTimeEntries"></a>
# **getNumberOfTimeEntries**
> Integer getNumberOfTimeEntries(filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    String filter = "filter_example"; // String | 
    try {
      Integer result = apiInstance.getNumberOfTimeEntries(filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeEntriesApi#getNumberOfTimeEntries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getPageOfTimeEntries"></a>
# **getPageOfTimeEntries**
> List&lt;TimeEntry&gt; getPageOfTimeEntries(filter, sort, pageSize, skipPages)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<TimeEntry> result = apiInstance.getPageOfTimeEntries(filter, sort, pageSize, skipPages);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeEntriesApi#getPageOfTimeEntries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer number = 56; // Integer | 
    try {
      TimeEntry result = apiInstance.getTimeEntryById(number);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeEntriesApi#getTimeEntryById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    TimeEntry timeEntry = new TimeEntry(); // TimeEntry | 
    try {
      apiInstance.updateTimeEntry(timeEntry);
    } catch (ApiException e) {
