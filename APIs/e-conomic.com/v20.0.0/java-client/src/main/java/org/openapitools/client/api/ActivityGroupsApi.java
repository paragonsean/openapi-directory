...
import org.openapitools.client.model.ActivityGroupCursorResults;
...
public class ActivityGroupsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ActivityGroupsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ActivityGroupsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for createActivityGroup
     * @param activityGroup  (optional)
     ...
     */
    public okhttp3.Call createActivityGroupCall(ActivityGroup activityGroup, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = activityGroup;

        // create path and map variables
        String localVarPath = "/activitygroups";
    ...
    private okhttp3.Call createActivityGroupValidateBeforeCall(ActivityGroup activityGroup, final ApiCallback _callback) throws ApiException {
        return createActivityGroupCall(activityGroup, _callback);
     ...
     */
    public CreatedResult createActivityGroup(ActivityGroup activityGroup) throws ApiException {
        ApiResponse<CreatedResult> localVarResp = createActivityGroupWithHttpInfo(activityGroup);
     ...
     */
    public ApiResponse<CreatedResult> createActivityGroupWithHttpInfo(ActivityGroup activityGroup) throws ApiException {
        okhttp3.Call localVarCall = createActivityGroupValidateBeforeCall(activityGroup, null);
        Type localVarReturnType = new TypeToken<CreatedResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create a single Activity Group (asynchronously)
     * Use this endpoint to create a single Activity Group.
     * @param activityGroup  (optional)
     ...
     */
    public okhttp3.Call createActivityGroupAsync(ActivityGroup activityGroup, final ApiCallback<CreatedResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = createActivityGroupValidateBeforeCall(activityGroup, _callback);
        Type localVarReturnType = new TypeToken<CreatedResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getActivityGroupById
     ...
     */
    public okhttp3.Call getActivityGroupByIdCall(Integer number, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/activitygroups/{number}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getActivityGroupByIdValidateBeforeCall(Integer number, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'number' is set
        if (number == null) {
            throw new ApiException("Missing the required parameter 'number' when calling getActivityGroupById(Async)");
        }

        return getActivityGroupByIdCall(number, _callback);
     ...
     */
    public ActivityGroup getActivityGroupById(Integer number) throws ApiException {
        ApiResponse<ActivityGroup> localVarResp = getActivityGroupByIdWithHttpInfo(number);
        return localVarResp.getData();
    }
     ...
     * Use this endpoint to load a single Activity Group by id/number.
     * @param number  (required)
     * @return ApiResponse&lt;ActivityGroup&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ActivityGroup> getActivityGroupByIdWithHttpInfo(Integer number) throws ApiException {
        okhttp3.Call localVarCall = getActivityGroupByIdValidateBeforeCall(number, null);
        Type localVarReturnType = new TypeToken<ActivityGroup>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve single Activity Group (asynchronously)
     * Use this endpoint to load a single Activity Group by id/number.
     * @param number  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getActivityGroupByIdAsync(Integer number, final ApiCallback<ActivityGroup> _callback) throws ApiException {

        okhttp3.Call localVarCall = getActivityGroupByIdValidateBeforeCall(number, _callback);
        Type localVarReturnType = new TypeToken<ActivityGroup>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getAllActivityGroups
     ...
     */
    public okhttp3.Call getAllActivityGroupsCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllActivityGroupsValidateBeforeCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        return getAllActivityGroupsCall(cursor, filter, _callback);
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return ActivityGroupCursorResults
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ActivityGroupCursorResults getAllActivityGroups(String cursor, String filter) throws ApiException {
        ApiResponse<ActivityGroupCursorResults> localVarResp = getAllActivityGroupsWithHttpInfo(cursor, filter);
        return localVarResp.getData();
    }
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return ApiResponse&lt;ActivityGroupCursorResults&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ActivityGroupCursorResults> getAllActivityGroupsWithHttpInfo(String cursor, String filter) throws ApiException {
        okhttp3.Call localVarCall = getAllActivityGroupsValidateBeforeCall(cursor, filter, null);
        Type localVarReturnType = new TypeToken<ActivityGroupCursorResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve all Activity Groups (asynchronously)
     * Use this endpoint to retrieve all Activity Groups in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
     * @param cursor  (optional)
     * @param filter  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getAllActivityGroupsAsync(String cursor, String filter, final ApiCallback<ActivityGroupCursorResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllActivityGroupsValidateBeforeCall(cursor, filter, _callback);
        Type localVarReturnType = new TypeToken<ActivityGroupCursorResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getNumberOfActivityGroups
     * @param filter  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getNumberOfActivityGroupsCall(String filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/activitygroups/count";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getNumberOfActivityGroupsValidateBeforeCall(String filter, final ApiCallback _callback) throws ApiException {
        return getNumberOfActivityGroupsCall(filter, _callback);
     ...
     */
    public Integer getNumberOfActivityGroups(String filter) throws ApiException {
        ApiResponse<Integer> localVarResp = getNumberOfActivityGroupsWithHttpInfo(filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Integer> getNumberOfActivityGroupsWithHttpInfo(String filter) throws ApiException {
        okhttp3.Call localVarCall = getNumberOfActivityGroupsValidateBeforeCall(filter, null);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve the number of Activity Groups (asynchronously)
     * Call this endpoint to get the number of Activity Groups. You can use a filtering as well.
     * @param filter  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getNumberOfActivityGroupsAsync(String filter, final ApiCallback<Integer> _callback) throws ApiException {

        okhttp3.Call localVarCall = getNumberOfActivityGroupsValidateBeforeCall(filter, _callback);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getPageOfActivityGroups
     * @param filter  (optional)
     * @param sort  (optional)
     ...
     */
    public okhttp3.Call getPageOfActivityGroupsCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/activitygroups/paged";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPageOfActivityGroupsValidateBeforeCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        return getPageOfActivityGroupsCall(filter, sort, pageSize, skipPages, _callback);
     ...
     */
    public List<ActivityGroup> getPageOfActivityGroups(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        ApiResponse<List<ActivityGroup>> localVarResp = getPageOfActivityGroupsWithHttpInfo(filter, sort, pageSize, skipPages);
        return localVarResp.getData();
    }
     ...
     * @param pageSize  (optional, default to 20)
     * @param skipPages  (optional, default to 0)
     * @return ApiResponse&lt;List&lt;ActivityGroup&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<ActivityGroup>> getPageOfActivityGroupsWithHttpInfo(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        okhttp3.Call localVarCall = getPageOfActivityGroupsValidateBeforeCall(filter, sort, pageSize, skipPages, null);
        Type localVarReturnType = new TypeToken<List<ActivityGroup>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve a page of Activity Groups (asynchronously)
     * Use this endpoint to load a page of Activity Groups.
     * @param filter  (optional)
     * @param sort  (optional)
     * @param pageSize  (optional, default to 20)
     ...
     */
    public okhttp3.Call getPageOfActivityGroupsAsync(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback<List<ActivityGroup>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPageOfActivityGroupsValidateBeforeCall(filter, sort, pageSize, skipPages, _callback);
        Type localVarReturnType = new TypeToken<List<ActivityGroup>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
