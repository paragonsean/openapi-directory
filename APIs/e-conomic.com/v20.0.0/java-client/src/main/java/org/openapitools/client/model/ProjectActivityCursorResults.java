...
import org.openapitools.client.model.ProjectActivity;
...
public class ProjectActivityCursorResults {
  ...
  public ProjectActivityCursorResults() {
  }
  ...
  public ProjectActivityCursorResults items(List<ProjectActivity> items) {
    this.items = items;
    return this;
  }

  public ProjectActivityCursorResults addItemsItem(ProjectActivity itemsItem) {
    if (this.items == null) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectActivityCursorResults projectActivityCursorResults = (ProjectActivityCursorResults) o;
    return Objects.equals(this.cursor, projectActivityCursorResults.cursor) &&
        Objects.equals(this.items, projectActivityCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectActivityCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectActivityCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectActivityCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectActivityCursorResults is not found in the empty JSON string", ProjectActivityCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectActivityCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectActivityCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            ProjectActivity.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectActivityCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectActivityCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectActivityCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectActivityCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectActivityCursorResults>() {
           @Override
           public void write(JsonWriter out, ProjectActivityCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectActivityCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectActivityCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectActivityCursorResults
   * @throws IOException if the JSON string is invalid with respect to ProjectActivityCursorResults
   */
  public static ProjectActivityCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectActivityCursorResults.class);
  }

  /**
   * Convert an instance of ProjectActivityCursorResults to an JSON string
   *
   * @return JSON string
   */
