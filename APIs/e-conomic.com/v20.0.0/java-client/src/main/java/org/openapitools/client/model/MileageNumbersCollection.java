...
public class MileageNumbersCollection {
  ...
  public MileageNumbersCollection() {
  }

  public MileageNumbersCollection numbers(List<Integer> numbers) {
    this.numbers = numbers;
    return this;
  }

  public MileageNumbersCollection addNumbersItem(Integer numbersItem) {
  ...
  public boolean equals(Object o) {
    ...
    MileageNumbersCollection mileageNumbersCollection = (MileageNumbersCollection) o;
    return Objects.equals(this.numbers, mileageNumbersCollection.numbers);
  }
  ...
  public String toString() {
    ...
    sb.append("class MileageNumbersCollection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MileageNumbersCollection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MileageNumbersCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MileageNumbersCollection is not found in the empty JSON string", MileageNumbersCollection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MileageNumbersCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MileageNumbersCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MileageNumbersCollection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MileageNumbersCollection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MileageNumbersCollection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MileageNumbersCollection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MileageNumbersCollection.class));

       return (TypeAdapter<T>) new TypeAdapter<MileageNumbersCollection>() {
           @Override
           public void write(JsonWriter out, MileageNumbersCollection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MileageNumbersCollection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MileageNumbersCollection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MileageNumbersCollection
   * @throws IOException if the JSON string is invalid with respect to MileageNumbersCollection
   */
  public static MileageNumbersCollection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MileageNumbersCollection.class);
  }

  /**
   * Convert an instance of MileageNumbersCollection to an JSON string
   *
   * @return JSON string
   */
