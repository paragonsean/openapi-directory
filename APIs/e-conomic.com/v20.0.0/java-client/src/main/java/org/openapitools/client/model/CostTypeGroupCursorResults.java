...
public class CostTypeGroupCursorResults {
  ...
  private List<CostTypeGroup> items;

  public CostTypeGroupCursorResults() {
  }
  ...
  public CostTypeGroupCursorResults items(List<CostTypeGroup> items) {
    this.items = items;
    return this;
  }

  public CostTypeGroupCursorResults addItemsItem(CostTypeGroup itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<CostTypeGroup> getItems() {
    return items;
  }

  public void setItems(List<CostTypeGroup> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    CostTypeGroupCursorResults costTypeGroupCursorResults = (CostTypeGroupCursorResults) o;
    return Objects.equals(this.cursor, costTypeGroupCursorResults.cursor) &&
        Objects.equals(this.items, costTypeGroupCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class CostTypeGroupCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CostTypeGroupCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CostTypeGroupCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CostTypeGroupCursorResults is not found in the empty JSON string", CostTypeGroupCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CostTypeGroupCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CostTypeGroupCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            CostTypeGroup.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CostTypeGroupCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CostTypeGroupCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CostTypeGroupCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CostTypeGroupCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<CostTypeGroupCursorResults>() {
           @Override
           public void write(JsonWriter out, CostTypeGroupCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CostTypeGroupCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CostTypeGroupCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CostTypeGroupCursorResults
   * @throws IOException if the JSON string is invalid with respect to CostTypeGroupCursorResults
   */
  public static CostTypeGroupCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CostTypeGroupCursorResults.class);
  }

  /**
   * Convert an instance of CostTypeGroupCursorResults to an JSON string
   *
   * @return JSON string
   */
