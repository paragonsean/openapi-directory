...
import org.openapitools.client.model.ProjectGroup;
...
public class ProjectGroupCursorResults {
  ...
  private List<ProjectGroup> items;

  public ProjectGroupCursorResults() {
  }
  ...
  public ProjectGroupCursorResults items(List<ProjectGroup> items) {
    this.items = items;
    return this;
  }

  public ProjectGroupCursorResults addItemsItem(ProjectGroup itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ProjectGroup> getItems() {
    return items;
  }

  public void setItems(List<ProjectGroup> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectGroupCursorResults projectGroupCursorResults = (ProjectGroupCursorResults) o;
    return Objects.equals(this.cursor, projectGroupCursorResults.cursor) &&
        Objects.equals(this.items, projectGroupCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectGroupCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectGroupCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectGroupCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectGroupCursorResults is not found in the empty JSON string", ProjectGroupCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectGroupCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectGroupCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            ProjectGroup.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectGroupCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectGroupCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectGroupCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectGroupCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectGroupCursorResults>() {
           @Override
           public void write(JsonWriter out, ProjectGroupCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectGroupCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectGroupCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectGroupCursorResults
   * @throws IOException if the JSON string is invalid with respect to ProjectGroupCursorResults
   */
  public static ProjectGroupCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectGroupCursorResults.class);
  }

  /**
   * Convert an instance of ProjectGroupCursorResults to an JSON string
   *
   * @return JSON string
   */
