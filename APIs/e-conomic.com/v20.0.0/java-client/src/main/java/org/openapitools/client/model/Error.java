...
public class Error {
  public static final String SERIALIZED_NAME_DEVELOPER_HINT = "developerHint";
  @SerializedName(SERIALIZED_NAME_DEVELOPER_HINT)
  ...
  public static final String SERIALIZED_NAME_LOG_TIME_UTC = "logTimeUtc";
  @SerializedName(SERIALIZED_NAME_LOG_TIME_UTC)
  private String logTimeUtc;
  ...
  public Error developerHint(String developerHint) {
  ...
  public boolean equals(Object o) {
    ...
    Error error = (Error) o;
    return Objects.equals(this.developerHint, error.developerHint) &&
        Objects.equals(this.errorCode, error.errorCode) &&
        Objects.equals(this.logId, error.logId) &&
        Objects.equals(this.logTimeUtc, error.logTimeUtc) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(developerHint, errorCode, logId, logTimeUtc, message, property);
  }
  ...
  public String toString() {
    ...
    sb.append("    developerHint: ").append(toIndentedString(developerHint)).append("\n");
    sb.append("    errorCode: ").append(toIndentedString(errorCode)).append("\n");
    sb.append("    logId: ").append(toIndentedString(logId)).append("\n");
    sb.append("    logTimeUtc: ").append(toIndentedString(logTimeUtc)).append("\n");
  ...
  static {
    ...
    openapiFields.add("developerHint");
    openapiFields.add("errorCode");
    openapiFields.add("logId");
    openapiFields.add("logTimeUtc");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("developerHint") != null && !jsonObj.get("developerHint").isJsonNull()) && !jsonObj.get("developerHint").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `developerHint` to be a primitive type in the JSON string but got `%s`", jsonObj.get("developerHint").toString()));
      }
      ...
      if ((jsonObj.get("logTimeUtc") != null && !jsonObj.get("logTimeUtc").isJsonNull()) && !jsonObj.get("logTimeUtc").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `logTimeUtc` to be a primitive type in the JSON string but got `%s`", jsonObj.get("logTimeUtc").toString()));
      }
