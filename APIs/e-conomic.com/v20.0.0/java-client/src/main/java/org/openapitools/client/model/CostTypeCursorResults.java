...
public class CostTypeCursorResults {
  ...
  private List<CostType> items;

  public CostTypeCursorResults() {
  }
  ...
  public CostTypeCursorResults items(List<CostType> items) {
    this.items = items;
    return this;
  }

  public CostTypeCursorResults addItemsItem(CostType itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<CostType> getItems() {
    return items;
  }

  public void setItems(List<CostType> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    CostTypeCursorResults costTypeCursorResults = (CostTypeCursorResults) o;
    return Objects.equals(this.cursor, costTypeCursorResults.cursor) &&
        Objects.equals(this.items, costTypeCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class CostTypeCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CostTypeCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CostTypeCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CostTypeCursorResults is not found in the empty JSON string", CostTypeCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CostTypeCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CostTypeCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            CostType.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CostTypeCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CostTypeCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CostTypeCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CostTypeCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<CostTypeCursorResults>() {
           @Override
           public void write(JsonWriter out, CostTypeCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CostTypeCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CostTypeCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CostTypeCursorResults
   * @throws IOException if the JSON string is invalid with respect to CostTypeCursorResults
   */
  public static CostTypeCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CostTypeCursorResults.class);
  }

  /**
   * Convert an instance of CostTypeCursorResults to an JSON string
   *
   * @return JSON string
   */
