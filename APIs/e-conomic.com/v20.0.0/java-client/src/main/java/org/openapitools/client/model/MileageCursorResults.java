...
public class MileageCursorResults {
  ...
  public MileageCursorResults items(List<Mileage> items) {
    this.items = items;
    return this;
  }

  public MileageCursorResults addItemsItem(Mileage itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<Mileage> getItems() {
    return items;
  }

  public void setItems(List<Mileage> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    MileageCursorResults mileageCursorResults = (MileageCursorResults) o;
    return Objects.equals(this.cursor, mileageCursorResults.cursor) &&
        Objects.equals(this.items, mileageCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class MileageCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MileageCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MileageCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MileageCursorResults is not found in the empty JSON string", MileageCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MileageCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MileageCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            Mileage.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MileageCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MileageCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MileageCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MileageCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<MileageCursorResults>() {
           @Override
           public void write(JsonWriter out, MileageCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MileageCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MileageCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MileageCursorResults
   * @throws IOException if the JSON string is invalid with respect to MileageCursorResults
   */
  public static MileageCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MileageCursorResults.class);
  }

  /**
   * Convert an instance of MileageCursorResults to an JSON string
   *
   * @return JSON string
   */
