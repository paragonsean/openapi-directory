...
import org.openapitools.client.model.CostGroupType;
...
public class CostTypeGroup {
  public static final String SERIALIZED_NAME_ACCOUNT_CLOSED = "accountClosed";
  @SerializedName(SERIALIZED_NAME_ACCOUNT_CLOSED)
  private Integer accountClosed;

  public static final String SERIALIZED_NAME_ACCOUNT_ON_GOING = "accountOnGoing";
  @SerializedName(SERIALIZED_NAME_ACCOUNT_ON_GOING)
  private Integer accountOnGoing;
  ...
  private CostGroupType type;

  public CostTypeGroup() {
  }

  public CostTypeGroup accountClosed(Integer accountClosed) {
  ...
  public Integer getAccountClosed() {
    return accountClosed;
  }

  public void setAccountClosed(Integer accountClosed) {
    this.accountClosed = accountClosed;
  }


  public CostTypeGroup accountOnGoing(Integer accountOnGoing) {
    this.accountOnGoing = accountOnGoing;
    return this;
  }

  /**
   * The account number to register ongoing costs.&lt;p class&#x3D;&#39;filter&#39;&gt;Filterable: not filterable&lt;/p&gt;&lt;p class&#x3D;&#39;sort&#39;&gt;Sortable: true&lt;/p&gt;
   * @return accountOnGoing
   */
  @javax.annotation.Nonnull
  public Integer getAccountOnGoing() {
    return accountOnGoing;
  }

  public void setAccountOnGoing(Integer accountOnGoing) {
    this.accountOnGoing = accountOnGoing;
  }


  public CostTypeGroup markup(Double markup) {
    this.markup = markup;
    return this;
  }
  ...
  public CostTypeGroup name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CostTypeGroup number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public CostTypeGroup objectVersion(String objectVersion) {
  ...
  public CostTypeGroup type(CostGroupType type) {
    this.type = type;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public CostGroupType getType() {
    return type;
  }

  public void setType(CostGroupType type) {
    this.type = type;
  }
  ...
  public boolean equals(Object o) {
    ...
    CostTypeGroup costTypeGroup = (CostTypeGroup) o;
    return Objects.equals(this.accountClosed, costTypeGroup.accountClosed) &&
        Objects.equals(this.accountOnGoing, costTypeGroup.accountOnGoing) &&
        Objects.equals(this.markup, costTypeGroup.markup) &&
        Objects.equals(this.name, costTypeGroup.name) &&
        Objects.equals(this.number, costTypeGroup.number) &&
        Objects.equals(this.objectVersion, costTypeGroup.objectVersion) &&
        Objects.equals(this.type, costTypeGroup.type);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountClosed, accountOnGoing, markup, name, number, objectVersion, type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CostTypeGroup {\n");
    sb.append("    accountClosed: ").append(toIndentedString(accountClosed)).append("\n");
    sb.append("    accountOnGoing: ").append(toIndentedString(accountOnGoing)).append("\n");
  ...
  static {
    ...
    openapiFields.add("accountClosed");
    openapiFields.add("accountOnGoing");
    ...
    openapiRequiredFields.add("accountClosed");
    openapiRequiredFields.add("accountOnGoing");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CostTypeGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CostTypeGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CostTypeGroup is not found in the empty JSON string", CostTypeGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CostTypeGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CostTypeGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CostTypeGroup.openapiRequiredFields) {
      ...
      CostGroupType.validateJsonElement(jsonObj.get("type"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CostTypeGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CostTypeGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CostTypeGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CostTypeGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<CostTypeGroup>() {
           @Override
           public void write(JsonWriter out, CostTypeGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CostTypeGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CostTypeGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CostTypeGroup
   * @throws IOException if the JSON string is invalid with respect to CostTypeGroup
   */
  public static CostTypeGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CostTypeGroup.class);
  }

  /**
   * Convert an instance of CostTypeGroup to an JSON string
   *
   * @return JSON string
   */
