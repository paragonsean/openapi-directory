...
public class EmployeeGroupCursorResults {
  ...
  private List<EmployeeGroup> items;

  public EmployeeGroupCursorResults() {
  }
  ...
  public EmployeeGroupCursorResults items(List<EmployeeGroup> items) {
    this.items = items;
    return this;
  }

  public EmployeeGroupCursorResults addItemsItem(EmployeeGroup itemsItem) {
    if (this.items == null) {
  ...
  public void setItems(List<EmployeeGroup> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmployeeGroupCursorResults employeeGroupCursorResults = (EmployeeGroupCursorResults) o;
    return Objects.equals(this.cursor, employeeGroupCursorResults.cursor) &&
        Objects.equals(this.items, employeeGroupCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeGroupCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeGroupCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeGroupCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeGroupCursorResults is not found in the empty JSON string", EmployeeGroupCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeGroupCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeGroupCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            EmployeeGroup.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeGroupCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeGroupCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeGroupCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeGroupCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeGroupCursorResults>() {
           @Override
           public void write(JsonWriter out, EmployeeGroupCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeGroupCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeGroupCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeGroupCursorResults
   * @throws IOException if the JSON string is invalid with respect to EmployeeGroupCursorResults
   */
  public static EmployeeGroupCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeGroupCursorResults.class);
  }

  /**
   * Convert an instance of EmployeeGroupCursorResults to an JSON string
   *
   * @return JSON string
   */
