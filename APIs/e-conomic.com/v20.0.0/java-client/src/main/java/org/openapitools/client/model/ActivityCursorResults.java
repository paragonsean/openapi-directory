...
public class ActivityCursorResults {
  ...
  public ActivityCursorResults items(List<Activity> items) {
    this.items = items;
    return this;
  }

  public ActivityCursorResults addItemsItem(Activity itemsItem) {
    if (this.items == null) {
  ...
  public boolean equals(Object o) {
    ...
    ActivityCursorResults activityCursorResults = (ActivityCursorResults) o;
    return Objects.equals(this.cursor, activityCursorResults.cursor) &&
        Objects.equals(this.items, activityCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActivityCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActivityCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActivityCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActivityCursorResults is not found in the empty JSON string", ActivityCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActivityCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActivityCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActivityCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActivityCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActivityCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActivityCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<ActivityCursorResults>() {
           @Override
           public void write(JsonWriter out, ActivityCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActivityCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActivityCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActivityCursorResults
   * @throws IOException if the JSON string is invalid with respect to ActivityCursorResults
   */
  public static ActivityCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActivityCursorResults.class);
  }

  /**
   * Convert an instance of ActivityCursorResults to an JSON string
   *
   * @return JSON string
   */
