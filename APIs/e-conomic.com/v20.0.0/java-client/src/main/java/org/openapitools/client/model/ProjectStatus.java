...
public class ProjectStatus {
  ...
  public ProjectStatus number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public ProjectStatus objectVersion(String objectVersion) {
  ...
  public ProjectStatus priority(Integer priority) {
  ...
  public ProjectStatus type(ProjectStatusType type) {
    this.type = type;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ProjectStatusType getType() {
    return type;
  }

  public void setType(ProjectStatusType type) {
    this.type = type;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, projectStatus.name) &&
        Objects.equals(this.number, projectStatus.number) &&
        Objects.equals(this.objectVersion, projectStatus.objectVersion) &&
        Objects.equals(this.priority, projectStatus.priority) &&
        Objects.equals(this.type, projectStatus.type);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, number, objectVersion, priority, type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("type") != null && !jsonObj.get("type").isJsonNull()) {
        ProjectStatusType.validateJsonElement(jsonObj.get("type"));
      }
  }
