...
public class MileagePricesCursorResults {
  ...
  private List<MileagePrices> items;

  public MileagePricesCursorResults() {
  }
  ...
  public MileagePricesCursorResults items(List<MileagePrices> items) {
    this.items = items;
    return this;
  }

  public MileagePricesCursorResults addItemsItem(MileagePrices itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<MileagePrices> getItems() {
    return items;
  }

  public void setItems(List<MileagePrices> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    MileagePricesCursorResults mileagePricesCursorResults = (MileagePricesCursorResults) o;
    return Objects.equals(this.cursor, mileagePricesCursorResults.cursor) &&
        Objects.equals(this.items, mileagePricesCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class MileagePricesCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MileagePricesCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MileagePricesCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MileagePricesCursorResults is not found in the empty JSON string", MileagePricesCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MileagePricesCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MileagePricesCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            MileagePrices.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MileagePricesCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MileagePricesCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MileagePricesCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MileagePricesCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<MileagePricesCursorResults>() {
           @Override
           public void write(JsonWriter out, MileagePricesCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MileagePricesCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MileagePricesCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MileagePricesCursorResults
   * @throws IOException if the JSON string is invalid with respect to MileagePricesCursorResults
   */
  public static MileagePricesCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MileagePricesCursorResults.class);
  }

  /**
   * Convert an instance of MileagePricesCursorResults to an JSON string
   *
   * @return JSON string
   */
