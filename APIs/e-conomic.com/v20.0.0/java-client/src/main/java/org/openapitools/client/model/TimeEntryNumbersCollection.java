...
public class TimeEntryNumbersCollection {
  ...
  public TimeEntryNumbersCollection() {
  }

  public TimeEntryNumbersCollection numbers(List<Integer> numbers) {
    this.numbers = numbers;
    return this;
  }

  public TimeEntryNumbersCollection addNumbersItem(Integer numbersItem) {
  ...
  public boolean equals(Object o) {
    ...
    TimeEntryNumbersCollection timeEntryNumbersCollection = (TimeEntryNumbersCollection) o;
    return Objects.equals(this.numbers, timeEntryNumbersCollection.numbers);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeEntryNumbersCollection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeEntryNumbersCollection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeEntryNumbersCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeEntryNumbersCollection is not found in the empty JSON string", TimeEntryNumbersCollection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimeEntryNumbersCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeEntryNumbersCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimeEntryNumbersCollection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimeEntryNumbersCollection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeEntryNumbersCollection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimeEntryNumbersCollection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeEntryNumbersCollection.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeEntryNumbersCollection>() {
           @Override
           public void write(JsonWriter out, TimeEntryNumbersCollection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimeEntryNumbersCollection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimeEntryNumbersCollection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimeEntryNumbersCollection
   * @throws IOException if the JSON string is invalid with respect to TimeEntryNumbersCollection
   */
  public static TimeEntryNumbersCollection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimeEntryNumbersCollection.class);
  }

  /**
   * Convert an instance of TimeEntryNumbersCollection to an JSON string
   *
   * @return JSON string
   */
