...
public class MileagePrices {
  ...
  public static final String SERIALIZED_NAME_COST_RATE = "costRate";
  @SerializedName(SERIALIZED_NAME_COST_RATE)
  ...
  public static final String SERIALIZED_NAME_SALES_RATE = "salesRate";
  @SerializedName(SERIALIZED_NAME_SALES_RATE)
  private Double salesRate;

  public MileagePrices() {
  }
  ...
  public MileagePrices number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MileagePrices mileagePrices = (MileagePrices) o;
    return Objects.equals(this.costPrice, mileagePrices.costPrice) &&
        Objects.equals(this.costRate, mileagePrices.costRate) &&
        Objects.equals(this.number, mileagePrices.number) &&
        Objects.equals(this.salesPrice, mileagePrices.salesPrice) &&
        Objects.equals(this.salesRate, mileagePrices.salesRate);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(costPrice, costRate, number, salesPrice, salesRate);
  }
  ...
  public String toString() {
    ...
    sb.append("    salesRate: ").append(toIndentedString(salesRate)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("costRate");
    openapiFields.add("number");
    openapiFields.add("salesPrice");
    openapiFields.add("salesRate");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MileagePrices
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MileagePrices.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MileagePrices is not found in the empty JSON string", MileagePrices.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MileagePrices.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MileagePrices` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MileagePrices.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MileagePrices' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MileagePrices> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MileagePrices.class));

       return (TypeAdapter<T>) new TypeAdapter<MileagePrices>() {
           @Override
           public void write(JsonWriter out, MileagePrices value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MileagePrices read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MileagePrices given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MileagePrices
   * @throws IOException if the JSON string is invalid with respect to MileagePrices
   */
  public static MileagePrices fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MileagePrices.class);
  }

  /**
   * Convert an instance of MileagePrices to an JSON string
   *
   * @return JSON string
   */
