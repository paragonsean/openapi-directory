...
import org.openapitools.client.model.ProjectCustomer;
import org.openapitools.client.model.ProjectCustomerCursorResults;
...
public class ProjectCustomersApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ProjectCustomersApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ProjectCustomersApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getAllProjectCustomers
     ...
     */
    public okhttp3.Call getAllProjectCustomersCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/project-customers";
    ...
    private okhttp3.Call getAllProjectCustomersValidateBeforeCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        return getAllProjectCustomersCall(cursor, filter, _callback);
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return ProjectCustomerCursorResults
     ...
     */
    public ProjectCustomerCursorResults getAllProjectCustomers(String cursor, String filter) throws ApiException {
        ApiResponse<ProjectCustomerCursorResults> localVarResp = getAllProjectCustomersWithHttpInfo(cursor, filter);
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return ApiResponse&lt;ProjectCustomerCursorResults&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ProjectCustomerCursorResults> getAllProjectCustomersWithHttpInfo(String cursor, String filter) throws ApiException {
        okhttp3.Call localVarCall = getAllProjectCustomersValidateBeforeCall(cursor, filter, null);
        Type localVarReturnType = new TypeToken<ProjectCustomerCursorResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve all Project Customers (asynchronously)
     * Use this endpoint to retrieve all Project Customers in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
     * @param cursor  (optional)
     * @param filter  (optional)
     ...
     */
    public okhttp3.Call getAllProjectCustomersAsync(String cursor, String filter, final ApiCallback<ProjectCustomerCursorResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllProjectCustomersValidateBeforeCall(cursor, filter, _callback);
        Type localVarReturnType = new TypeToken<ProjectCustomerCursorResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getNumberOfProjectCustomers
     * @param filter  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getNumberOfProjectCustomersCall(String filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/project-customers/count";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getNumberOfProjectCustomersValidateBeforeCall(String filter, final ApiCallback _callback) throws ApiException {
        return getNumberOfProjectCustomersCall(filter, _callback);
     ...
     */
    public Integer getNumberOfProjectCustomers(String filter) throws ApiException {
        ApiResponse<Integer> localVarResp = getNumberOfProjectCustomersWithHttpInfo(filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Integer> getNumberOfProjectCustomersWithHttpInfo(String filter) throws ApiException {
        okhttp3.Call localVarCall = getNumberOfProjectCustomersValidateBeforeCall(filter, null);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve the number of Project Customers (asynchronously)
     * Call this endpoint to get the number of Project Customers. You can use a filtering as well.
     * @param filter  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getNumberOfProjectCustomersAsync(String filter, final ApiCallback<Integer> _callback) throws ApiException {

        okhttp3.Call localVarCall = getNumberOfProjectCustomersValidateBeforeCall(filter, _callback);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getPageOfProjectCustomers
     * @param filter  (optional)
     * @param sort  (optional)
     ...
     */
    public okhttp3.Call getPageOfProjectCustomersCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/project-customers/paged";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPageOfProjectCustomersValidateBeforeCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        return getPageOfProjectCustomersCall(filter, sort, pageSize, skipPages, _callback);
     ...
     */
    public List<ProjectCustomer> getPageOfProjectCustomers(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        ApiResponse<List<ProjectCustomer>> localVarResp = getPageOfProjectCustomersWithHttpInfo(filter, sort, pageSize, skipPages);
        return localVarResp.getData();
    }
     ...
     * @param pageSize  (optional, default to 20)
     * @param skipPages  (optional, default to 0)
     * @return ApiResponse&lt;List&lt;ProjectCustomer&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<ProjectCustomer>> getPageOfProjectCustomersWithHttpInfo(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        okhttp3.Call localVarCall = getPageOfProjectCustomersValidateBeforeCall(filter, sort, pageSize, skipPages, null);
        Type localVarReturnType = new TypeToken<List<ProjectCustomer>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve a page of Project Customers (asynchronously)
     * Use this endpoint to load a page of Project Customers.
     * @param filter  (optional)
     * @param sort  (optional)
     * @param pageSize  (optional, default to 20)
     ...
     */
    public okhttp3.Call getPageOfProjectCustomersAsync(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback<List<ProjectCustomer>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPageOfProjectCustomersValidateBeforeCall(filter, sort, pageSize, skipPages, _callback);
        Type localVarReturnType = new TypeToken<List<ProjectCustomer>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getProjectCustomerById
     ...
     */
    public okhttp3.Call getProjectCustomerByIdCall(Integer number, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/project-customers/{number}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getProjectCustomerByIdValidateBeforeCall(Integer number, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'number' is set
        if (number == null) {
            throw new ApiException("Missing the required parameter 'number' when calling getProjectCustomerById(Async)");
        }

        return getProjectCustomerByIdCall(number, _callback);
     ...
     */
    public ProjectCustomer getProjectCustomerById(Integer number) throws ApiException {
        ApiResponse<ProjectCustomer> localVarResp = getProjectCustomerByIdWithHttpInfo(number);
        return localVarResp.getData();
    }
     ...
     * Use this endpoint to load a single Project Customer by id/number.
     * @param number  (required)
     * @return ApiResponse&lt;ProjectCustomer&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ProjectCustomer> getProjectCustomerByIdWithHttpInfo(Integer number) throws ApiException {
        okhttp3.Call localVarCall = getProjectCustomerByIdValidateBeforeCall(number, null);
        Type localVarReturnType = new TypeToken<ProjectCustomer>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve single Project Customer (asynchronously)
     * Use this endpoint to load a single Project Customer by id/number.
     * @param number  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getProjectCustomerByIdAsync(Integer number, final ApiCallback<ProjectCustomer> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProjectCustomerByIdValidateBeforeCall(number, _callback);
        Type localVarReturnType = new TypeToken<ProjectCustomer>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
