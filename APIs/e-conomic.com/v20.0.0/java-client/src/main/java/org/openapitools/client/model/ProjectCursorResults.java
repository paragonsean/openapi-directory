...
public class ProjectCursorResults {
  ...
  public ProjectCursorResults items(List<Project> items) {
    this.items = items;
    return this;
  }

  public ProjectCursorResults addItemsItem(Project itemsItem) {
    if (this.items == null) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectCursorResults projectCursorResults = (ProjectCursorResults) o;
    return Objects.equals(this.cursor, projectCursorResults.cursor) &&
        Objects.equals(this.items, projectCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectCursorResults is not found in the empty JSON string", ProjectCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectCursorResults>() {
           @Override
           public void write(JsonWriter out, ProjectCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectCursorResults
   * @throws IOException if the JSON string is invalid with respect to ProjectCursorResults
   */
  public static ProjectCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectCursorResults.class);
  }

  /**
   * Convert an instance of ProjectCursorResults to an JSON string
   *
   * @return JSON string
   */
