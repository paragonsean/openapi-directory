...
public class TimeEntryPricesCursorResults {
  ...
  private List<TimeEntryPrices> items;

  public TimeEntryPricesCursorResults() {
  }
  ...
  public TimeEntryPricesCursorResults items(List<TimeEntryPrices> items) {
    this.items = items;
    return this;
  }

  public TimeEntryPricesCursorResults addItemsItem(TimeEntryPrices itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<TimeEntryPrices> getItems() {
    return items;
  }

  public void setItems(List<TimeEntryPrices> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    TimeEntryPricesCursorResults timeEntryPricesCursorResults = (TimeEntryPricesCursorResults) o;
    return Objects.equals(this.cursor, timeEntryPricesCursorResults.cursor) &&
        Objects.equals(this.items, timeEntryPricesCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeEntryPricesCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeEntryPricesCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeEntryPricesCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeEntryPricesCursorResults is not found in the empty JSON string", TimeEntryPricesCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimeEntryPricesCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeEntryPricesCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            TimeEntryPrices.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimeEntryPricesCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeEntryPricesCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimeEntryPricesCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeEntryPricesCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeEntryPricesCursorResults>() {
           @Override
           public void write(JsonWriter out, TimeEntryPricesCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimeEntryPricesCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimeEntryPricesCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimeEntryPricesCursorResults
   * @throws IOException if the JSON string is invalid with respect to TimeEntryPricesCursorResults
   */
  public static TimeEntryPricesCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimeEntryPricesCursorResults.class);
  }

  /**
   * Convert an instance of TimeEntryPricesCursorResults to an JSON string
   *
   * @return JSON string
   */
