 ...
 * Project
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T10:10:24.018579-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class Project {
  ...
  public static final String SERIALIZED_NAME_DELIVERY_LOCATION_NUMBER = "deliveryLocationNumber";
  @SerializedName(SERIALIZED_NAME_DELIVERY_LOCATION_NUMBER)
  private Integer deliveryLocationNumber;
  ...
  public static final String SERIALIZED_NAME_INVOICED_TOTAL = "invoicedTotal";
  @SerializedName(SERIALIZED_NAME_INVOICED_TOTAL)
  private Double invoicedTotal;

  public static final String SERIALIZED_NAME_IS_BARRED = "isBarred";
  @SerializedName(SERIALIZED_NAME_IS_BARRED)
  ...
  public static final String SERIALIZED_NAME_IS_MAIN_PROJECT = "isMainProject";
  @SerializedName(SERIALIZED_NAME_IS_MAIN_PROJECT)
  private Boolean isMainProject;

  public static final String SERIALIZED_NAME_IS_MILEAGE_INVOICED = "isMileageInvoiced";
  @SerializedName(SERIALIZED_NAME_IS_MILEAGE_INVOICED)
  private Boolean isMileageInvoiced;

  public static final String SERIALIZED_NAME_LAST_UPDATED = "lastUpdated";
  @SerializedName(SERIALIZED_NAME_LAST_UPDATED)
  private OffsetDateTime lastUpdated;

  public static final String SERIALIZED_NAME_MAIN_PROJECT_NUMBER = "mainProjectNumber";
  @SerializedName(SERIALIZED_NAME_MAIN_PROJECT_NUMBER)
  ...
  public static final String SERIALIZED_NAME_OTHER_RESPONSIBLE_EMPLOYEE_NUMBER = "otherResponsibleEmployeeNumber";
  @SerializedName(SERIALIZED_NAME_OTHER_RESPONSIBLE_EMPLOYEE_NUMBER)
  private Integer otherResponsibleEmployeeNumber;

  public static final String SERIALIZED_NAME_PROJECT_GROUP_NUMBER = "projectGroupNumber";
  @SerializedName(SERIALIZED_NAME_PROJECT_GROUP_NUMBER)
  private Integer projectGroupNumber;

  public static final String SERIALIZED_NAME_RESPONSIBLE_EMPLOYEE_NUMBER = "responsibleEmployeeNumber";
  @SerializedName(SERIALIZED_NAME_RESPONSIBLE_EMPLOYEE_NUMBER)
  private Integer responsibleEmployeeNumber;
  ...
  public Project closedDate(OffsetDateTime closedDate) {
  ...
  public Project contactPersonId(Integer contactPersonId) {
  ...
  public Project customerNumber(Integer customerNumber) {
  ...
  public Project deliveryDate(OffsetDateTime deliveryDate) {
  ...
  public Project deliveryLocationNumber(Integer deliveryLocationNumber) {
   ...
   */
  @javax.annotation.Nullable
  public Integer getDeliveryLocationNumber() {
    return deliveryLocationNumber;
  }

  public void setDeliveryLocationNumber(Integer deliveryLocationNumber) {
    this.deliveryLocationNumber = deliveryLocationNumber;
  }


  public Project departmentNumber(Integer departmentNumber) {
  ...
  public Project fixedPrice(Double fixedPrice) {
  ...
  public Project isBarred(Boolean isBarred) {
  ...
  public Project isMainProject(Boolean isMainProject) {
  ...
  public Project isMileageInvoiced(Boolean isMileageInvoiced) {
    this.isMileageInvoiced = isMileageInvoiced;
    return this;
  }
   ...
   * @return isMileageInvoiced
   */
  @javax.annotation.Nullable
  public Boolean getIsMileageInvoiced() {
    return isMileageInvoiced;
  }

  public void setIsMileageInvoiced(Boolean isMileageInvoiced) {
    this.isMileageInvoiced = isMileageInvoiced;
  }
  ...
  public Project mainProjectNumber(Integer mainProjectNumber) {
    this.mainProjectNumber = mainProjectNumber;
    return this;
  }
   ...
   * @return mainProjectNumber
   */
  @javax.annotation.Nullable
  public Integer getMainProjectNumber() {
    return mainProjectNumber;
  }

  public void setMainProjectNumber(Integer mainProjectNumber) {
    this.mainProjectNumber = mainProjectNumber;
  }


  public Project mileage(Double mileage) {
  ...
  public Project objectVersion(String objectVersion) {
  ...
  public Project otherResponsibleEmployeeNumber(Integer otherResponsibleEmployeeNumber) {
    this.otherResponsibleEmployeeNumber = otherResponsibleEmployeeNumber;
    return this;
  }
   ...
   * @return otherResponsibleEmployeeNumber
   */
  @javax.annotation.Nullable
  public Integer getOtherResponsibleEmployeeNumber() {
    return otherResponsibleEmployeeNumber;
  }

  public void setOtherResponsibleEmployeeNumber(Integer otherResponsibleEmployeeNumber) {
    this.otherResponsibleEmployeeNumber = otherResponsibleEmployeeNumber;
  }


  public Project projectGroupNumber(Integer projectGroupNumber) {
   ...
   */
  @javax.annotation.Nonnull
  public Integer getProjectGroupNumber() {
    return projectGroupNumber;
  }

  public void setProjectGroupNumber(Integer projectGroupNumber) {
    this.projectGroupNumber = projectGroupNumber;
  }


  public Project responsibleEmployeeNumber(Integer responsibleEmployeeNumber) {
    this.responsibleEmployeeNumber = responsibleEmployeeNumber;
    return this;
  }
   ...
   * @return responsibleEmployeeNumber
   */
  @javax.annotation.Nullable
  public Integer getResponsibleEmployeeNumber() {
    return responsibleEmployeeNumber;
  }

  public void setResponsibleEmployeeNumber(Integer responsibleEmployeeNumber) {
    this.responsibleEmployeeNumber = responsibleEmployeeNumber;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.closedDate, project.closedDate) &&
        Objects.equals(this.contactPersonId, project.contactPersonId) &&
        Objects.equals(this.costPrice, project.costPrice) &&
        Objects.equals(this.customerNumber, project.customerNumber) &&
        Objects.equals(this.deliveryDate, project.deliveryDate) &&
        Objects.equals(this.deliveryLocationNumber, project.deliveryLocationNumber) &&
        Objects.equals(this.departmentNumber, project.departmentNumber) &&
        Objects.equals(this.description, project.description) &&
        Objects.equals(this.fixedPrice, project.fixedPrice) &&
        Objects.equals(this.invoicedTotal, project.invoicedTotal) &&
        Objects.equals(this.isBarred, project.isBarred) &&
        Objects.equals(this.isClosed, project.isClosed) &&
        Objects.equals(this.isMainProject, project.isMainProject) &&
        Objects.equals(this.isMileageInvoiced, project.isMileageInvoiced) &&
        Objects.equals(this.lastUpdated, project.lastUpdated) &&
        Objects.equals(this.mainProjectNumber, project.mainProjectNumber) &&
        Objects.equals(this.mileage, project.mileage) &&
        Objects.equals(this.name, project.name) &&
        Objects.equals(this.number, project.number) &&
        Objects.equals(this.objectVersion, project.objectVersion) &&
        Objects.equals(this.otherResponsibleEmployeeNumber, project.otherResponsibleEmployeeNumber) &&
        Objects.equals(this.projectGroupNumber, project.projectGroupNumber) &&
        Objects.equals(this.responsibleEmployeeNumber, project.responsibleEmployeeNumber) &&
        Objects.equals(this.salesPrice, project.salesPrice) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(closedDate, contactPersonId, costPrice, customerNumber, deliveryDate, deliveryLocationNumber, departmentNumber, description, fixedPrice, invoicedTotal, isBarred, isClosed, isMainProject, isMileageInvoiced, lastUpdated, mainProjectNumber, mileage, name, number, objectVersion, otherResponsibleEmployeeNumber, projectGroupNumber, responsibleEmployeeNumber, salesPrice, status);
  }
  ...
  public String toString() {
    ...
    sb.append("    deliveryLocationNumber: ").append(toIndentedString(deliveryLocationNumber)).append("\n");
    ...
    sb.append("    invoicedTotal: ").append(toIndentedString(invoicedTotal)).append("\n");
    sb.append("    isBarred: ").append(toIndentedString(isBarred)).append("\n");
    sb.append("    isClosed: ").append(toIndentedString(isClosed)).append("\n");
    sb.append("    isMainProject: ").append(toIndentedString(isMainProject)).append("\n");
    sb.append("    isMileageInvoiced: ").append(toIndentedString(isMileageInvoiced)).append("\n");
    sb.append("    lastUpdated: ").append(toIndentedString(lastUpdated)).append("\n");
    sb.append("    mainProjectNumber: ").append(toIndentedString(mainProjectNumber)).append("\n");
    ...
    sb.append("    otherResponsibleEmployeeNumber: ").append(toIndentedString(otherResponsibleEmployeeNumber)).append("\n");
    sb.append("    projectGroupNumber: ").append(toIndentedString(projectGroupNumber)).append("\n");
    sb.append("    responsibleEmployeeNumber: ").append(toIndentedString(responsibleEmployeeNumber)).append("\n");
  ...
  static {
    ...
    openapiFields.add("deliveryLocationNumber");
    openapiFields.add("departmentNumber");
    openapiFields.add("description");
    openapiFields.add("fixedPrice");
    openapiFields.add("invoicedTotal");
    openapiFields.add("isBarred");
    openapiFields.add("isClosed");
    openapiFields.add("isMainProject");
    openapiFields.add("isMileageInvoiced");
    openapiFields.add("lastUpdated");
    openapiFields.add("mainProjectNumber");
    openapiFields.add("mileage");
    openapiFields.add("name");
    openapiFields.add("number");
    openapiFields.add("objectVersion");
    openapiFields.add("otherResponsibleEmployeeNumber");
    openapiFields.add("projectGroupNumber");
    openapiFields.add("responsibleEmployeeNumber");
    ...
    openapiRequiredFields.add("projectGroupNumber");
  }
