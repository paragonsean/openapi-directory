...
public class ProjectActivity {
  public static final String SERIALIZED_NAME_ACTIVITY_NUMBER = "activityNumber";
  @SerializedName(SERIALIZED_NAME_ACTIVITY_NUMBER)
  ...
  public ProjectActivity completed(Boolean completed) {
  ...
  public ProjectActivity endDate(OffsetDateTime endDate) {
  ...
  public ProjectActivity number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public ProjectActivity objectVersion(String objectVersion) {
  ...
  public ProjectActivity projectNumber(Integer projectNumber) {
  ...
  public ProjectActivity responsibleEmployeeNumber(Integer responsibleEmployeeNumber) {
  ...
  public ProjectActivity startDate(OffsetDateTime startDate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activityNumber, projectActivity.activityNumber) &&
        Objects.equals(this.completed, projectActivity.completed) &&
        Objects.equals(this.endDate, projectActivity.endDate) &&
        Objects.equals(this.number, projectActivity.number) &&
        Objects.equals(this.objectVersion, projectActivity.objectVersion) &&
        Objects.equals(this.projectNumber, projectActivity.projectNumber) &&
        Objects.equals(this.responsibleEmployeeNumber, projectActivity.responsibleEmployeeNumber) &&
        Objects.equals(this.startDate, projectActivity.startDate);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activityNumber, completed, endDate, number, objectVersion, projectNumber, responsibleEmployeeNumber, startDate);
  }
  ...
  public String toString() {
    ...
    sb.append("    activityNumber: ").append(toIndentedString(activityNumber)).append("\n");
  ...
  static {
    ...
    openapiFields.add("activityNumber");
    ...
    openapiRequiredFields.add("activityNumber");
    openapiRequiredFields.add("projectNumber");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectActivity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectActivity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectActivity is not found in the empty JSON string", ProjectActivity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectActivity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectActivity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectActivity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectActivity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectActivity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectActivity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectActivity.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectActivity>() {
           @Override
           public void write(JsonWriter out, ProjectActivity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectActivity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectActivity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectActivity
   * @throws IOException if the JSON string is invalid with respect to ProjectActivity
   */
  public static ProjectActivity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectActivity.class);
  }

  /**
   * Convert an instance of ProjectActivity to an JSON string
   *
   * @return JSON string
   */
