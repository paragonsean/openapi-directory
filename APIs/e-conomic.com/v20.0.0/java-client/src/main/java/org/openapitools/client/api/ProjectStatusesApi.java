...
import org.openapitools.client.model.ProjectStatusCursorResults;
...
public class ProjectStatusesApi {
    ...
    /**
     * Build call for getAllProjectStatuses
     ...
     */
    public okhttp3.Call getAllProjectStatusesCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/projectstatuses";
    ...
    private okhttp3.Call getAllProjectStatusesValidateBeforeCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        return getAllProjectStatusesCall(cursor, filter, _callback);
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return ProjectStatusCursorResults
     ...
     */
    public ProjectStatusCursorResults getAllProjectStatuses(String cursor, String filter) throws ApiException {
        ApiResponse<ProjectStatusCursorResults> localVarResp = getAllProjectStatusesWithHttpInfo(cursor, filter);
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return ApiResponse&lt;ProjectStatusCursorResults&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ProjectStatusCursorResults> getAllProjectStatusesWithHttpInfo(String cursor, String filter) throws ApiException {
        okhttp3.Call localVarCall = getAllProjectStatusesValidateBeforeCall(cursor, filter, null);
        Type localVarReturnType = new TypeToken<ProjectStatusCursorResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve all Project Statuses (asynchronously)
     * Use this endpoint to retrieve all Project Statuses in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
     * @param cursor  (optional)
     * @param filter  (optional)
     ...
     */
    public okhttp3.Call getAllProjectStatusesAsync(String cursor, String filter, final ApiCallback<ProjectStatusCursorResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllProjectStatusesValidateBeforeCall(cursor, filter, _callback);
        Type localVarReturnType = new TypeToken<ProjectStatusCursorResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getNumberOfProjectStatuses
     * @param filter  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getNumberOfProjectStatusesCall(String filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/projectstatuses/count";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getNumberOfProjectStatusesValidateBeforeCall(String filter, final ApiCallback _callback) throws ApiException {
        return getNumberOfProjectStatusesCall(filter, _callback);
     ...
     */
    public Integer getNumberOfProjectStatuses(String filter) throws ApiException {
        ApiResponse<Integer> localVarResp = getNumberOfProjectStatusesWithHttpInfo(filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Integer> getNumberOfProjectStatusesWithHttpInfo(String filter) throws ApiException {
        okhttp3.Call localVarCall = getNumberOfProjectStatusesValidateBeforeCall(filter, null);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve the number of Project Statuses (asynchronously)
     * Call this endpoint to get the number of Project Statuses. You can use a filtering as well.
     * @param filter  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getNumberOfProjectStatusesAsync(String filter, final ApiCallback<Integer> _callback) throws ApiException {

        okhttp3.Call localVarCall = getNumberOfProjectStatusesValidateBeforeCall(filter, _callback);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getPageOfProjectStatuses
     * @param filter  (optional)
     * @param sort  (optional)
     ...
     */
    public okhttp3.Call getPageOfProjectStatusesCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/projectstatuses/paged";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPageOfProjectStatusesValidateBeforeCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        return getPageOfProjectStatusesCall(filter, sort, pageSize, skipPages, _callback);
     ...
     */
    public List<ProjectStatus> getPageOfProjectStatuses(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        ApiResponse<List<ProjectStatus>> localVarResp = getPageOfProjectStatusesWithHttpInfo(filter, sort, pageSize, skipPages);
        return localVarResp.getData();
    }
     ...
     * @param pageSize  (optional, default to 20)
     * @param skipPages  (optional, default to 0)
     * @return ApiResponse&lt;List&lt;ProjectStatus&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<ProjectStatus>> getPageOfProjectStatusesWithHttpInfo(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        okhttp3.Call localVarCall = getPageOfProjectStatusesValidateBeforeCall(filter, sort, pageSize, skipPages, null);
        Type localVarReturnType = new TypeToken<List<ProjectStatus>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve a page of Project Statuses (asynchronously)
     * Use this endpoint to load a page of Project Statuses.
     * @param filter  (optional)
     * @param sort  (optional)
     * @param pageSize  (optional, default to 20)
     ...
     */
    public okhttp3.Call getPageOfProjectStatusesAsync(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback<List<ProjectStatus>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPageOfProjectStatusesValidateBeforeCall(filter, sort, pageSize, skipPages, _callback);
        Type localVarReturnType = new TypeToken<List<ProjectStatus>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getProjectStatusById
     ...
     */
    public okhttp3.Call getProjectStatusByIdCall(Integer number, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/projectstatuses/{number}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getProjectStatusByIdValidateBeforeCall(Integer number, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'number' is set
        if (number == null) {
            throw new ApiException("Missing the required parameter 'number' when calling getProjectStatusById(Async)");
        }

        return getProjectStatusByIdCall(number, _callback);
     ...
     */
    public ProjectStatus getProjectStatusById(Integer number) throws ApiException {
        ApiResponse<ProjectStatus> localVarResp = getProjectStatusByIdWithHttpInfo(number);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ProjectStatus> getProjectStatusByIdWithHttpInfo(Integer number) throws ApiException {
        okhttp3.Call localVarCall = getProjectStatusByIdValidateBeforeCall(number, null);
        Type localVarReturnType = new TypeToken<ProjectStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve single Project Status (asynchronously)
     * Use this endpoint to load a single Project Status by id/number.
     * @param number  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getProjectStatusByIdAsync(Integer number, final ApiCallback<ProjectStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProjectStatusByIdValidateBeforeCall(number, _callback);
        Type localVarReturnType = new TypeToken<ProjectStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
