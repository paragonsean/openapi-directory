...
public class EmployeeGroup {
  ...
  public EmployeeGroup number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public EmployeeGroup objectVersion(String objectVersion) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, employeeGroup.name) &&
        Objects.equals(this.number, employeeGroup.number) &&
        Objects.equals(this.objectVersion, employeeGroup.objectVersion);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeGroup is not found in the empty JSON string", EmployeeGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeGroup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeGroup>() {
           @Override
           public void write(JsonWriter out, EmployeeGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeGroup
   * @throws IOException if the JSON string is invalid with respect to EmployeeGroup
   */
  public static EmployeeGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeGroup.class);
  }

  /**
   * Convert an instance of EmployeeGroup to an JSON string
   *
   * @return JSON string
   */
