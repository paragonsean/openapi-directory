...
public class EmployeeCursorResults {
  ...
  public EmployeeCursorResults items(List<Employee> items) {
    this.items = items;
    return this;
  }

  public EmployeeCursorResults addItemsItem(Employee itemsItem) {
    if (this.items == null) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeCursorResults employeeCursorResults = (EmployeeCursorResults) o;
    return Objects.equals(this.cursor, employeeCursorResults.cursor) &&
        Objects.equals(this.items, employeeCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeCursorResults is not found in the empty JSON string", EmployeeCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            Employee.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeCursorResults>() {
           @Override
           public void write(JsonWriter out, EmployeeCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeCursorResults
   * @throws IOException if the JSON string is invalid with respect to EmployeeCursorResults
   */
  public static EmployeeCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeCursorResults.class);
  }

  /**
   * Convert an instance of EmployeeCursorResults to an JSON string
   *
   * @return JSON string
   */
