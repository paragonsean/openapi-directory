...
public class TimeEntryPrices {
  ...
  public TimeEntryPrices number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TimeEntryPrices timeEntryPrices = (TimeEntryPrices) o;
    return Objects.equals(this.costPrice, timeEntryPrices.costPrice) &&
        Objects.equals(this.number, timeEntryPrices.number) &&
        Objects.equals(this.salesPrice, timeEntryPrices.salesPrice);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(costPrice, number, salesPrice);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeEntryPrices {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeEntryPrices
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeEntryPrices.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeEntryPrices is not found in the empty JSON string", TimeEntryPrices.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimeEntryPrices.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeEntryPrices` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimeEntryPrices.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeEntryPrices' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimeEntryPrices> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeEntryPrices.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeEntryPrices>() {
           @Override
           public void write(JsonWriter out, TimeEntryPrices value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimeEntryPrices read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimeEntryPrices given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimeEntryPrices
   * @throws IOException if the JSON string is invalid with respect to TimeEntryPrices
   */
  public static TimeEntryPrices fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimeEntryPrices.class);
  }

  /**
   * Convert an instance of TimeEntryPrices to an JSON string
   *
   * @return JSON string
   */
