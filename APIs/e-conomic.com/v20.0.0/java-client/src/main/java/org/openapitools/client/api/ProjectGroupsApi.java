...
import org.openapitools.client.model.ProjectGroupCursorResults;
...
public class ProjectGroupsApi {
    ...
    /**
     * Build call for createProjectGroup
     * @param projectGroup  (optional)
     ...
     */
    public okhttp3.Call createProjectGroupCall(ProjectGroup projectGroup, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = projectGroup;

        // create path and map variables
        String localVarPath = "/projectgroups";
    ...
    private okhttp3.Call createProjectGroupValidateBeforeCall(ProjectGroup projectGroup, final ApiCallback _callback) throws ApiException {
        return createProjectGroupCall(projectGroup, _callback);
     ...
     */
    public CreatedResult createProjectGroup(ProjectGroup projectGroup) throws ApiException {
        ApiResponse<CreatedResult> localVarResp = createProjectGroupWithHttpInfo(projectGroup);
     ...
     */
    public ApiResponse<CreatedResult> createProjectGroupWithHttpInfo(ProjectGroup projectGroup) throws ApiException {
        okhttp3.Call localVarCall = createProjectGroupValidateBeforeCall(projectGroup, null);
        Type localVarReturnType = new TypeToken<CreatedResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create a single Project Group (asynchronously)
     * Use this endpoint to create a single Project Group.
     * @param projectGroup  (optional)
     ...
     */
    public okhttp3.Call createProjectGroupAsync(ProjectGroup projectGroup, final ApiCallback<CreatedResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = createProjectGroupValidateBeforeCall(projectGroup, _callback);
        Type localVarReturnType = new TypeToken<CreatedResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getAllProjectGroups
     ...
     */
    public okhttp3.Call getAllProjectGroupsCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllProjectGroupsValidateBeforeCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        return getAllProjectGroupsCall(cursor, filter, _callback);
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return ProjectGroupCursorResults
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ProjectGroupCursorResults getAllProjectGroups(String cursor, String filter) throws ApiException {
        ApiResponse<ProjectGroupCursorResults> localVarResp = getAllProjectGroupsWithHttpInfo(cursor, filter);
        return localVarResp.getData();
    }
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return ApiResponse&lt;ProjectGroupCursorResults&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ProjectGroupCursorResults> getAllProjectGroupsWithHttpInfo(String cursor, String filter) throws ApiException {
        okhttp3.Call localVarCall = getAllProjectGroupsValidateBeforeCall(cursor, filter, null);
        Type localVarReturnType = new TypeToken<ProjectGroupCursorResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve all Project Groups (asynchronously)
     * Use this endpoint to retrieve all Project Groups in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
     * @param cursor  (optional)
     * @param filter  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getAllProjectGroupsAsync(String cursor, String filter, final ApiCallback<ProjectGroupCursorResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllProjectGroupsValidateBeforeCall(cursor, filter, _callback);
        Type localVarReturnType = new TypeToken<ProjectGroupCursorResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getNumberOfProjectGroups
     * @param filter  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getNumberOfProjectGroupsCall(String filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/projectgroups/count";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getNumberOfProjectGroupsValidateBeforeCall(String filter, final ApiCallback _callback) throws ApiException {
        return getNumberOfProjectGroupsCall(filter, _callback);
     ...
     */
    public Integer getNumberOfProjectGroups(String filter) throws ApiException {
        ApiResponse<Integer> localVarResp = getNumberOfProjectGroupsWithHttpInfo(filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Integer> getNumberOfProjectGroupsWithHttpInfo(String filter) throws ApiException {
        okhttp3.Call localVarCall = getNumberOfProjectGroupsValidateBeforeCall(filter, null);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve the number of Project Groups (asynchronously)
     * Call this endpoint to get the number of Project Groups. You can use a filtering as well.
     * @param filter  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getNumberOfProjectGroupsAsync(String filter, final ApiCallback<Integer> _callback) throws ApiException {

        okhttp3.Call localVarCall = getNumberOfProjectGroupsValidateBeforeCall(filter, _callback);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getPageOfProjectGroups
     * @param filter  (optional)
     * @param sort  (optional)
     ...
     */
    public okhttp3.Call getPageOfProjectGroupsCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/projectgroups/paged";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPageOfProjectGroupsValidateBeforeCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        return getPageOfProjectGroupsCall(filter, sort, pageSize, skipPages, _callback);
     ...
     */
    public List<ProjectGroup> getPageOfProjectGroups(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        ApiResponse<List<ProjectGroup>> localVarResp = getPageOfProjectGroupsWithHttpInfo(filter, sort, pageSize, skipPages);
        return localVarResp.getData();
    }
     ...
     * @param pageSize  (optional, default to 20)
     * @param skipPages  (optional, default to 0)
     * @return ApiResponse&lt;List&lt;ProjectGroup&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<ProjectGroup>> getPageOfProjectGroupsWithHttpInfo(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        okhttp3.Call localVarCall = getPageOfProjectGroupsValidateBeforeCall(filter, sort, pageSize, skipPages, null);
        Type localVarReturnType = new TypeToken<List<ProjectGroup>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve a page of Project Groups (asynchronously)
     * Use this endpoint to load a page of Project Groups.
     * @param filter  (optional)
     * @param sort  (optional)
     * @param pageSize  (optional, default to 20)
     ...
     */
    public okhttp3.Call getPageOfProjectGroupsAsync(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback<List<ProjectGroup>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPageOfProjectGroupsValidateBeforeCall(filter, sort, pageSize, skipPages, _callback);
        Type localVarReturnType = new TypeToken<List<ProjectGroup>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getProjectGroupById
     ...
     */
    public okhttp3.Call getProjectGroupByIdCall(Integer number, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/projectgroups/{number}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getProjectGroupByIdValidateBeforeCall(Integer number, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'number' is set
        if (number == null) {
            throw new ApiException("Missing the required parameter 'number' when calling getProjectGroupById(Async)");
        }

        return getProjectGroupByIdCall(number, _callback);
     ...
     */
    public ProjectGroup getProjectGroupById(Integer number) throws ApiException {
        ApiResponse<ProjectGroup> localVarResp = getProjectGroupByIdWithHttpInfo(number);
        return localVarResp.getData();
    }
     ...
     * Use this endpoint to load a single Project Group by id/number.
     * @param number  (required)
     * @return ApiResponse&lt;ProjectGroup&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ProjectGroup> getProjectGroupByIdWithHttpInfo(Integer number) throws ApiException {
        okhttp3.Call localVarCall = getProjectGroupByIdValidateBeforeCall(number, null);
        Type localVarReturnType = new TypeToken<ProjectGroup>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve single Project Group (asynchronously)
     * Use this endpoint to load a single Project Group by id/number.
     * @param number  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getProjectGroupByIdAsync(Integer number, final ApiCallback<ProjectGroup> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProjectGroupByIdValidateBeforeCall(number, _callback);
        Type localVarReturnType = new TypeToken<ProjectGroup>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
