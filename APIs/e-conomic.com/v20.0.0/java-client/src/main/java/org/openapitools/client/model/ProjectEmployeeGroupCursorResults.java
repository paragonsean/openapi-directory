...
public class ProjectEmployeeGroupCursorResults {
  ...
  private List<ProjectEmployeeGroup> items;

  public ProjectEmployeeGroupCursorResults() {
  }
  ...
  public ProjectEmployeeGroupCursorResults items(List<ProjectEmployeeGroup> items) {
    this.items = items;
    return this;
  }

  public ProjectEmployeeGroupCursorResults addItemsItem(ProjectEmployeeGroup itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ProjectEmployeeGroup> getItems() {
    return items;
  }

  public void setItems(List<ProjectEmployeeGroup> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectEmployeeGroupCursorResults projectEmployeeGroupCursorResults = (ProjectEmployeeGroupCursorResults) o;
    return Objects.equals(this.cursor, projectEmployeeGroupCursorResults.cursor) &&
        Objects.equals(this.items, projectEmployeeGroupCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectEmployeeGroupCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectEmployeeGroupCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectEmployeeGroupCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectEmployeeGroupCursorResults is not found in the empty JSON string", ProjectEmployeeGroupCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectEmployeeGroupCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectEmployeeGroupCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            ProjectEmployeeGroup.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectEmployeeGroupCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectEmployeeGroupCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectEmployeeGroupCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectEmployeeGroupCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectEmployeeGroupCursorResults>() {
           @Override
           public void write(JsonWriter out, ProjectEmployeeGroupCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectEmployeeGroupCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectEmployeeGroupCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectEmployeeGroupCursorResults
   * @throws IOException if the JSON string is invalid with respect to ProjectEmployeeGroupCursorResults
   */
  public static ProjectEmployeeGroupCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectEmployeeGroupCursorResults.class);
  }

  /**
   * Convert an instance of ProjectEmployeeGroupCursorResults to an JSON string
   *
   * @return JSON string
   */
