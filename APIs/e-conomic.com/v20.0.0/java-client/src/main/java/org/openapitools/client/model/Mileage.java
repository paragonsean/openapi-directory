...
public class Mileage {
  ...
  public static final String SERIALIZED_NAME_INCLUDE_APPROVE = "includeApprove";
  @SerializedName(SERIALIZED_NAME_INCLUDE_APPROVE)
  private Boolean includeApprove;
  ...
  public Mileage date(OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public Mileage distance(Double distance) {
  ...
  public Mileage employeeNumber(Integer employeeNumber) {
  ...
  public Mileage from(String from) {
    this.from = from;
    return this;
  }
  ...
  public Mileage objectVersion(String objectVersion) {
  ...
  public Mileage projectNumber(Integer projectNumber) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.date, mileage.date) &&
        Objects.equals(this.distance, mileage.distance) &&
        Objects.equals(this.employeeNumber, mileage.employeeNumber) &&
        Objects.equals(this.from, mileage.from) &&
        Objects.equals(this.includeApprove, mileage.includeApprove) &&
        Objects.equals(this.isApproved, mileage.isApproved) &&
        Objects.equals(this.number, mileage.number) &&
        Objects.equals(this.objectVersion, mileage.objectVersion) &&
        Objects.equals(this.projectNumber, mileage.projectNumber) &&
        Objects.equals(this.to, mileage.to);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(date, distance, employeeNumber, from, includeApprove, isApproved, number, objectVersion, projectNumber, to);
  }
  ...
  public String toString() {
    ...
    sb.append("    includeApprove: ").append(toIndentedString(includeApprove)).append("\n");
  ...
  static {
    ...
    openapiFields.add("includeApprove");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Mileage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Mileage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Mileage is not found in the empty JSON string", Mileage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Mileage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Mileage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Mileage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Mileage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Mileage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Mileage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Mileage.class));

       return (TypeAdapter<T>) new TypeAdapter<Mileage>() {
           @Override
           public void write(JsonWriter out, Mileage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Mileage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Mileage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Mileage
   * @throws IOException if the JSON string is invalid with respect to Mileage
   */
  public static Mileage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Mileage.class);
  }

  /**
   * Convert an instance of Mileage to an JSON string
   *
   * @return JSON string
   */
