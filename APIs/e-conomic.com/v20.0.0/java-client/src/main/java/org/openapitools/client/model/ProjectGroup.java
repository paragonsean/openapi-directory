...
import org.openapitools.client.model.ProjectGroupType;
...
public class ProjectGroup {
  ...
  public ProjectGroup costAccountClosed(Integer costAccountClosed) {
  ...
  public ProjectGroup costAccountOngoing(Integer costAccountOngoing) {
  ...
  public ProjectGroup costAccountOngoingType(OngoingAccountType costAccountOngoingType) {
  ...
  public ProjectGroup costContraAccountOngoing(Integer costContraAccountOngoing) {
  ...
  public ProjectGroup includeCostPriceInFinance(Boolean includeCostPriceInFinance) {
  ...
  public ProjectGroup includeSalesPriceInFinance(Boolean includeSalesPriceInFinance) {
  ...
  public ProjectGroup number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public ProjectGroup objectVersion(String objectVersion) {
  ...
  public ProjectGroup salesAccountClosed(Integer salesAccountClosed) {
  ...
  public ProjectGroup salesAccountOngoing(Integer salesAccountOngoing) {
  ...
  public ProjectGroup salesAccountOngoingType(OngoingAccountType salesAccountOngoingType) {
  ...
  public ProjectGroup salesContraAccountOngoing(Integer salesContraAccountOngoing) {
  ...
  public ProjectGroup type(ProjectGroupType type) {
    this.type = type;
    return this;
  }
  ...
  public void setType(ProjectGroupType type) {
    this.type = type;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.costAccountClosed, projectGroup.costAccountClosed) &&
        Objects.equals(this.costAccountOngoing, projectGroup.costAccountOngoing) &&
        Objects.equals(this.costAccountOngoingType, projectGroup.costAccountOngoingType) &&
        Objects.equals(this.costContraAccountOngoing, projectGroup.costContraAccountOngoing) &&
        Objects.equals(this.includeCostPriceInFinance, projectGroup.includeCostPriceInFinance) &&
        Objects.equals(this.includeSalesPriceInFinance, projectGroup.includeSalesPriceInFinance) &&
        Objects.equals(this.name, projectGroup.name) &&
        Objects.equals(this.number, projectGroup.number) &&
        Objects.equals(this.objectVersion, projectGroup.objectVersion) &&
        Objects.equals(this.salesAccountClosed, projectGroup.salesAccountClosed) &&
        Objects.equals(this.salesAccountOngoing, projectGroup.salesAccountOngoing) &&
        Objects.equals(this.salesAccountOngoingType, projectGroup.salesAccountOngoingType) &&
        Objects.equals(this.salesContraAccountOngoing, projectGroup.salesContraAccountOngoing) &&
        Objects.equals(this.type, projectGroup.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectGroup is not found in the empty JSON string", ProjectGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectGroup.openapiRequiredFields) {
      ...
      ProjectGroupType.validateJsonElement(jsonObj.get("type"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectGroup>() {
           @Override
           public void write(JsonWriter out, ProjectGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectGroup
   * @throws IOException if the JSON string is invalid with respect to ProjectGroup
   */
  public static ProjectGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectGroup.class);
  }

  /**
   * Convert an instance of ProjectGroup to an JSON string
   *
   * @return JSON string
   */
