...
import org.openapitools.client.model.CostTypeCursorResults;
...
public class CostTypesApi {
    ...
    public CostTypesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getAllCostTypes
     ...
     */
    public okhttp3.Call getAllCostTypesCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllCostTypesValidateBeforeCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        return getAllCostTypesCall(cursor, filter, _callback);
     ...
     */
    public CostTypeCursorResults getAllCostTypes(String cursor, String filter) throws ApiException {
        ApiResponse<CostTypeCursorResults> localVarResp = getAllCostTypesWithHttpInfo(cursor, filter);
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return ApiResponse&lt;CostTypeCursorResults&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CostTypeCursorResults> getAllCostTypesWithHttpInfo(String cursor, String filter) throws ApiException {
        okhttp3.Call localVarCall = getAllCostTypesValidateBeforeCall(cursor, filter, null);
        Type localVarReturnType = new TypeToken<CostTypeCursorResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve all Cost Types (asynchronously)
     * Use this endpoint to retrieve all Cost Types in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
     * @param cursor  (optional)
     * @param filter  (optional)
     ...
     */
    public okhttp3.Call getAllCostTypesAsync(String cursor, String filter, final ApiCallback<CostTypeCursorResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllCostTypesValidateBeforeCall(cursor, filter, _callback);
        Type localVarReturnType = new TypeToken<CostTypeCursorResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getCostTypeById
     ...
     */
    public okhttp3.Call getCostTypeByIdCall(Integer number, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/costtypes/{number}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCostTypeByIdValidateBeforeCall(Integer number, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'number' is set
        if (number == null) {
            throw new ApiException("Missing the required parameter 'number' when calling getCostTypeById(Async)");
        }

        return getCostTypeByIdCall(number, _callback);
     ...
     */
    public CostType getCostTypeById(Integer number) throws ApiException {
        ApiResponse<CostType> localVarResp = getCostTypeByIdWithHttpInfo(number);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CostType> getCostTypeByIdWithHttpInfo(Integer number) throws ApiException {
        okhttp3.Call localVarCall = getCostTypeByIdValidateBeforeCall(number, null);
        Type localVarReturnType = new TypeToken<CostType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve single Cost Type (asynchronously)
     * Use this endpoint to load a single Cost Type by id/number.
     * @param number  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getCostTypeByIdAsync(Integer number, final ApiCallback<CostType> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCostTypeByIdValidateBeforeCall(number, _callback);
        Type localVarReturnType = new TypeToken<CostType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getNumberOfCostTypes
     * @param filter  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getNumberOfCostTypesCall(String filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/costtypes/count";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getNumberOfCostTypesValidateBeforeCall(String filter, final ApiCallback _callback) throws ApiException {
        return getNumberOfCostTypesCall(filter, _callback);
     ...
     */
    public Integer getNumberOfCostTypes(String filter) throws ApiException {
        ApiResponse<Integer> localVarResp = getNumberOfCostTypesWithHttpInfo(filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Integer> getNumberOfCostTypesWithHttpInfo(String filter) throws ApiException {
        okhttp3.Call localVarCall = getNumberOfCostTypesValidateBeforeCall(filter, null);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve the number of Cost Types (asynchronously)
     * Call this endpoint to get the number of Cost Types. You can use a filtering as well.
     * @param filter  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getNumberOfCostTypesAsync(String filter, final ApiCallback<Integer> _callback) throws ApiException {

        okhttp3.Call localVarCall = getNumberOfCostTypesValidateBeforeCall(filter, _callback);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getPageOfCostTypes
     * @param filter  (optional)
     * @param sort  (optional)
     ...
     */
    public okhttp3.Call getPageOfCostTypesCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/costtypes/paged";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPageOfCostTypesValidateBeforeCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        return getPageOfCostTypesCall(filter, sort, pageSize, skipPages, _callback);
     ...
     */
    public List<CostType> getPageOfCostTypes(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        ApiResponse<List<CostType>> localVarResp = getPageOfCostTypesWithHttpInfo(filter, sort, pageSize, skipPages);
        return localVarResp.getData();
    }
     ...
     * @param pageSize  (optional, default to 20)
     * @param skipPages  (optional, default to 0)
     * @return ApiResponse&lt;List&lt;CostType&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<CostType>> getPageOfCostTypesWithHttpInfo(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        okhttp3.Call localVarCall = getPageOfCostTypesValidateBeforeCall(filter, sort, pageSize, skipPages, null);
        Type localVarReturnType = new TypeToken<List<CostType>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve a page of Cost Types (asynchronously)
     * Use this endpoint to load a page of Cost Types.
     * @param filter  (optional)
     * @param sort  (optional)
     * @param pageSize  (optional, default to 20)
     ...
     */
    public okhttp3.Call getPageOfCostTypesAsync(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback<List<CostType>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPageOfCostTypesValidateBeforeCall(filter, sort, pageSize, skipPages, _callback);
        Type localVarReturnType = new TypeToken<List<CostType>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
