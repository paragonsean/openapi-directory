...
import org.openapitools.client.model.TimeEntryPrices;
import org.openapitools.client.model.TimeEntryPricesCursorResults;
...
public class TimeEntryPricesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TimeEntryPricesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TimeEntryPricesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getAllTimeEntryPrices
     ...
     */
    public okhttp3.Call getAllTimeEntryPricesCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/timeentryprices";
    ...
    private okhttp3.Call getAllTimeEntryPricesValidateBeforeCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        return getAllTimeEntryPricesCall(cursor, filter, _callback);
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return TimeEntryPricesCursorResults
     ...
     */
    public TimeEntryPricesCursorResults getAllTimeEntryPrices(String cursor, String filter) throws ApiException {
        ApiResponse<TimeEntryPricesCursorResults> localVarResp = getAllTimeEntryPricesWithHttpInfo(cursor, filter);
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return ApiResponse&lt;TimeEntryPricesCursorResults&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TimeEntryPricesCursorResults> getAllTimeEntryPricesWithHttpInfo(String cursor, String filter) throws ApiException {
        okhttp3.Call localVarCall = getAllTimeEntryPricesValidateBeforeCall(cursor, filter, null);
        Type localVarReturnType = new TypeToken<TimeEntryPricesCursorResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve all Time entry prices (asynchronously)
     * Use this endpoint to retrieve all Time entry prices in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
     * @param cursor  (optional)
     * @param filter  (optional)
     ...
     */
    public okhttp3.Call getAllTimeEntryPricesAsync(String cursor, String filter, final ApiCallback<TimeEntryPricesCursorResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllTimeEntryPricesValidateBeforeCall(cursor, filter, _callback);
        Type localVarReturnType = new TypeToken<TimeEntryPricesCursorResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getPageOfTimeEntryPrices
     * @param filter  (optional)
     * @param sort  (optional)
     ...
     */
    public okhttp3.Call getPageOfTimeEntryPricesCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/timeentryprices/paged";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPageOfTimeEntryPricesValidateBeforeCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        return getPageOfTimeEntryPricesCall(filter, sort, pageSize, skipPages, _callback);
     ...
     */
    public List<TimeEntryPrices> getPageOfTimeEntryPrices(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        ApiResponse<List<TimeEntryPrices>> localVarResp = getPageOfTimeEntryPricesWithHttpInfo(filter, sort, pageSize, skipPages);
        return localVarResp.getData();
    }
     ...
     * @param pageSize  (optional, default to 20)
     * @param skipPages  (optional, default to 0)
     * @return ApiResponse&lt;List&lt;TimeEntryPrices&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<TimeEntryPrices>> getPageOfTimeEntryPricesWithHttpInfo(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        okhttp3.Call localVarCall = getPageOfTimeEntryPricesValidateBeforeCall(filter, sort, pageSize, skipPages, null);
        Type localVarReturnType = new TypeToken<List<TimeEntryPrices>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve a page of Time entry prices (asynchronously)
     * Use this endpoint to load a page of Time entry prices.
     * @param filter  (optional)
     * @param sort  (optional)
     * @param pageSize  (optional, default to 20)
     ...
     */
    public okhttp3.Call getPageOfTimeEntryPricesAsync(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback<List<TimeEntryPrices>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPageOfTimeEntryPricesValidateBeforeCall(filter, sort, pageSize, skipPages, _callback);
        Type localVarReturnType = new TypeToken<List<TimeEntryPrices>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getTimeEntryPricesById
     ...
     */
    public okhttp3.Call getTimeEntryPricesByIdCall(Integer number, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/timeentryprices/{number}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTimeEntryPricesByIdValidateBeforeCall(Integer number, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'number' is set
        if (number == null) {
            throw new ApiException("Missing the required parameter 'number' when calling getTimeEntryPricesById(Async)");
        }

        return getTimeEntryPricesByIdCall(number, _callback);
     ...
     */
    public TimeEntryPrices getTimeEntryPricesById(Integer number) throws ApiException {
        ApiResponse<TimeEntryPrices> localVarResp = getTimeEntryPricesByIdWithHttpInfo(number);
        return localVarResp.getData();
    }
     ...
     * Use this endpoint to load a single Time entry prices by id/number.
     * @param number  (required)
     * @return ApiResponse&lt;TimeEntryPrices&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TimeEntryPrices> getTimeEntryPricesByIdWithHttpInfo(Integer number) throws ApiException {
        okhttp3.Call localVarCall = getTimeEntryPricesByIdValidateBeforeCall(number, null);
        Type localVarReturnType = new TypeToken<TimeEntryPrices>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve single Time entry prices (asynchronously)
     * Use this endpoint to load a single Time entry prices by id/number.
     * @param number  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getTimeEntryPricesByIdAsync(Integer number, final ApiCallback<TimeEntryPrices> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTimeEntryPricesByIdValidateBeforeCall(number, _callback);
        Type localVarReturnType = new TypeToken<TimeEntryPrices>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
