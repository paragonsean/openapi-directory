...
import org.openapitools.client.model.ActivityGroup;
...
public class ActivityGroupCursorResults {
  ...
  private List<ActivityGroup> items;

  public ActivityGroupCursorResults() {
  }
  ...
  public ActivityGroupCursorResults items(List<ActivityGroup> items) {
    this.items = items;
    return this;
  }

  public ActivityGroupCursorResults addItemsItem(ActivityGroup itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ActivityGroup> getItems() {
    return items;
  }

  public void setItems(List<ActivityGroup> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    ActivityGroupCursorResults activityGroupCursorResults = (ActivityGroupCursorResults) o;
    return Objects.equals(this.cursor, activityGroupCursorResults.cursor) &&
        Objects.equals(this.items, activityGroupCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActivityGroupCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActivityGroupCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActivityGroupCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActivityGroupCursorResults is not found in the empty JSON string", ActivityGroupCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActivityGroupCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActivityGroupCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            ActivityGroup.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActivityGroupCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActivityGroupCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActivityGroupCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActivityGroupCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<ActivityGroupCursorResults>() {
           @Override
           public void write(JsonWriter out, ActivityGroupCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActivityGroupCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActivityGroupCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActivityGroupCursorResults
   * @throws IOException if the JSON string is invalid with respect to ActivityGroupCursorResults
   */
  public static ActivityGroupCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActivityGroupCursorResults.class);
  }

  /**
   * Convert an instance of ActivityGroupCursorResults to an JSON string
   *
   * @return JSON string
   */
