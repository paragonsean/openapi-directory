...
import org.openapitools.client.model.ProjectEmployee;
...
public class ProjectEmployeeCursorResults {
  ...
  private List<ProjectEmployee> items;

  public ProjectEmployeeCursorResults() {
  }
  ...
  public ProjectEmployeeCursorResults items(List<ProjectEmployee> items) {
    this.items = items;
    return this;
  }

  public ProjectEmployeeCursorResults addItemsItem(ProjectEmployee itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ProjectEmployee> getItems() {
    return items;
  }

  public void setItems(List<ProjectEmployee> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectEmployeeCursorResults projectEmployeeCursorResults = (ProjectEmployeeCursorResults) o;
    return Objects.equals(this.cursor, projectEmployeeCursorResults.cursor) &&
        Objects.equals(this.items, projectEmployeeCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectEmployeeCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectEmployeeCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectEmployeeCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectEmployeeCursorResults is not found in the empty JSON string", ProjectEmployeeCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectEmployeeCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectEmployeeCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            ProjectEmployee.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectEmployeeCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectEmployeeCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectEmployeeCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectEmployeeCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectEmployeeCursorResults>() {
           @Override
           public void write(JsonWriter out, ProjectEmployeeCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectEmployeeCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectEmployeeCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectEmployeeCursorResults
   * @throws IOException if the JSON string is invalid with respect to ProjectEmployeeCursorResults
   */
  public static ProjectEmployeeCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectEmployeeCursorResults.class);
  }

  /**
   * Convert an instance of ProjectEmployeeCursorResults to an JSON string
   *
   * @return JSON string
   */
