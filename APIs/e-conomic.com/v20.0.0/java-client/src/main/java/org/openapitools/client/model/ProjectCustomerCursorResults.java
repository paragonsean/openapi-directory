...
public class ProjectCustomerCursorResults {
  ...
  private List<ProjectCustomer> items;

  public ProjectCustomerCursorResults() {
  }
  ...
  public ProjectCustomerCursorResults items(List<ProjectCustomer> items) {
    this.items = items;
    return this;
  }

  public ProjectCustomerCursorResults addItemsItem(ProjectCustomer itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ProjectCustomer> getItems() {
    return items;
  }

  public void setItems(List<ProjectCustomer> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectCustomerCursorResults projectCustomerCursorResults = (ProjectCustomerCursorResults) o;
    return Objects.equals(this.cursor, projectCustomerCursorResults.cursor) &&
        Objects.equals(this.items, projectCustomerCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectCustomerCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectCustomerCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectCustomerCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectCustomerCursorResults is not found in the empty JSON string", ProjectCustomerCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectCustomerCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectCustomerCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            ProjectCustomer.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectCustomerCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectCustomerCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectCustomerCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectCustomerCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectCustomerCursorResults>() {
           @Override
           public void write(JsonWriter out, ProjectCustomerCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectCustomerCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectCustomerCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectCustomerCursorResults
   * @throws IOException if the JSON string is invalid with respect to ProjectCustomerCursorResults
   */
  public static ProjectCustomerCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectCustomerCursorResults.class);
  }

  /**
   * Convert an instance of ProjectCustomerCursorResults to an JSON string
   *
   * @return JSON string
   */
