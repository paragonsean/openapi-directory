...
import org.openapitools.client.model.ActivityGroupType;
import org.openapitools.client.model.OngoingAccountType;
...
public class ActivityGroup {
  public static final String SERIALIZED_NAME_COST_ACCOUNT_CLOSED = "costAccountClosed";
  @SerializedName(SERIALIZED_NAME_COST_ACCOUNT_CLOSED)
  private Integer costAccountClosed;

  public static final String SERIALIZED_NAME_COST_ACCOUNT_ONGOING = "costAccountOngoing";
  @SerializedName(SERIALIZED_NAME_COST_ACCOUNT_ONGOING)
  private Integer costAccountOngoing;

  public static final String SERIALIZED_NAME_COST_ACCOUNT_ONGOING_TYPE = "costAccountOngoingType";
  @SerializedName(SERIALIZED_NAME_COST_ACCOUNT_ONGOING_TYPE)
  private OngoingAccountType costAccountOngoingType;

  public static final String SERIALIZED_NAME_COST_CONTRA_ACCOUNT_ONGOING = "costContraAccountOngoing";
  @SerializedName(SERIALIZED_NAME_COST_CONTRA_ACCOUNT_ONGOING)
  private Integer costContraAccountOngoing;

  public static final String SERIALIZED_NAME_INCLUDE_COST_PRICE_IN_FINANCE = "includeCostPriceInFinance";
  @SerializedName(SERIALIZED_NAME_INCLUDE_COST_PRICE_IN_FINANCE)
  private Boolean includeCostPriceInFinance;

  public static final String SERIALIZED_NAME_INCLUDE_SALES_PRICE_IN_FINANCE = "includeSalesPriceInFinance";
  @SerializedName(SERIALIZED_NAME_INCLUDE_SALES_PRICE_IN_FINANCE)
  private Boolean includeSalesPriceInFinance;
  ...
  public static final String SERIALIZED_NAME_SALES_ACCOUNT_CLOSED = "salesAccountClosed";
  @SerializedName(SERIALIZED_NAME_SALES_ACCOUNT_CLOSED)
  private Integer salesAccountClosed;

  public static final String SERIALIZED_NAME_SALES_ACCOUNT_ONGOING = "salesAccountOngoing";
  @SerializedName(SERIALIZED_NAME_SALES_ACCOUNT_ONGOING)
  private Integer salesAccountOngoing;

  public static final String SERIALIZED_NAME_SALES_ACCOUNT_ONGOING_TYPE = "salesAccountOngoingType";
  @SerializedName(SERIALIZED_NAME_SALES_ACCOUNT_ONGOING_TYPE)
  private OngoingAccountType salesAccountOngoingType;

  public static final String SERIALIZED_NAME_SALES_CONTRA_ACCOUNT_ONGOING = "salesContraAccountOngoing";
  @SerializedName(SERIALIZED_NAME_SALES_CONTRA_ACCOUNT_ONGOING)
  private Integer salesContraAccountOngoing;
  ...
  public ActivityGroup costAccountClosed(Integer costAccountClosed) {
    this.costAccountClosed = costAccountClosed;
    return this;
  }
   ...
   * @return costAccountClosed
   */
  @javax.annotation.Nullable
  public Integer getCostAccountClosed() {
    return costAccountClosed;
  }

  public void setCostAccountClosed(Integer costAccountClosed) {
    this.costAccountClosed = costAccountClosed;
  }


  public ActivityGroup costAccountOngoing(Integer costAccountOngoing) {
    this.costAccountOngoing = costAccountOngoing;
    return this;
  }
   ...
   * @return costAccountOngoing
   */
  @javax.annotation.Nullable
  public Integer getCostAccountOngoing() {
    return costAccountOngoing;
  }

  public void setCostAccountOngoing(Integer costAccountOngoing) {
    this.costAccountOngoing = costAccountOngoing;
  }


  public ActivityGroup costAccountOngoingType(OngoingAccountType costAccountOngoingType) {
    this.costAccountOngoingType = costAccountOngoingType;
    return this;
  }
   ...
   * @return costAccountOngoingType
   */
  @javax.annotation.Nullable
  public OngoingAccountType getCostAccountOngoingType() {
    return costAccountOngoingType;
  }

  public void setCostAccountOngoingType(OngoingAccountType costAccountOngoingType) {
    this.costAccountOngoingType = costAccountOngoingType;
  }


  public ActivityGroup costContraAccountOngoing(Integer costContraAccountOngoing) {
    this.costContraAccountOngoing = costContraAccountOngoing;
    return this;
  }

  /**
   * The contra account number to register costs for ongoing activities.     If includeCostPriceInFinance is set to true, this property is required.     Otherwise, it cannot be provided.     Only accessible accounts (not barred) with accountType&#x3D;&#x3D;\&quot;status\&quot; or \&quot;profitAndLoss\&quot; are allowed.&lt;p class&#x3D;&#39;filter&#39;&gt;Filterable: eq, ne, lt, lte, gt, gte, in, nin&lt;/p&gt;&lt;p class&#x3D;&#39;sort&#39;&gt;Sortable: false&lt;/p&gt;
   * @return costContraAccountOngoing
   */
  @javax.annotation.Nullable
  public Integer getCostContraAccountOngoing() {
    return costContraAccountOngoing;
  }

  public void setCostContraAccountOngoing(Integer costContraAccountOngoing) {
    this.costContraAccountOngoing = costContraAccountOngoing;
  }


  public ActivityGroup includeCostPriceInFinance(Boolean includeCostPriceInFinance) {
    this.includeCostPriceInFinance = includeCostPriceInFinance;
    return this;
  }
   ...
   * @return includeCostPriceInFinance
   */
  @javax.annotation.Nullable
  public Boolean getIncludeCostPriceInFinance() {
    return includeCostPriceInFinance;
  }

  public void setIncludeCostPriceInFinance(Boolean includeCostPriceInFinance) {
    this.includeCostPriceInFinance = includeCostPriceInFinance;
  }


  public ActivityGroup includeSalesPriceInFinance(Boolean includeSalesPriceInFinance) {
    this.includeSalesPriceInFinance = includeSalesPriceInFinance;
    return this;
  }
   ...
   * @return includeSalesPriceInFinance
   */
  @javax.annotation.Nullable
  public Boolean getIncludeSalesPriceInFinance() {
    return includeSalesPriceInFinance;
  }

  public void setIncludeSalesPriceInFinance(Boolean includeSalesPriceInFinance) {
    this.includeSalesPriceInFinance = includeSalesPriceInFinance;
  }
  ...
  public ActivityGroup number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public ActivityGroup objectVersion(String objectVersion) {
  ...
  public ActivityGroup salesAccountClosed(Integer salesAccountClosed) {
    this.salesAccountClosed = salesAccountClosed;
    return this;
  }
   ...
   * @return salesAccountClosed
   */
  @javax.annotation.Nullable
  public Integer getSalesAccountClosed() {
    return salesAccountClosed;
  }

  public void setSalesAccountClosed(Integer salesAccountClosed) {
    this.salesAccountClosed = salesAccountClosed;
  }


  public ActivityGroup salesAccountOngoing(Integer salesAccountOngoing) {
    this.salesAccountOngoing = salesAccountOngoing;
    return this;
  }
   ...
   * @return salesAccountOngoing
   */
  @javax.annotation.Nullable
  public Integer getSalesAccountOngoing() {
    return salesAccountOngoing;
  }

  public void setSalesAccountOngoing(Integer salesAccountOngoing) {
    this.salesAccountOngoing = salesAccountOngoing;
  }


  public ActivityGroup salesAccountOngoingType(OngoingAccountType salesAccountOngoingType) {
    this.salesAccountOngoingType = salesAccountOngoingType;
    return this;
  }
   ...
   * @return salesAccountOngoingType
   */
  @javax.annotation.Nullable
  public OngoingAccountType getSalesAccountOngoingType() {
    return salesAccountOngoingType;
  }

  public void setSalesAccountOngoingType(OngoingAccountType salesAccountOngoingType) {
    this.salesAccountOngoingType = salesAccountOngoingType;
  }


  public ActivityGroup salesContraAccountOngoing(Integer salesContraAccountOngoing) {
    this.salesContraAccountOngoing = salesContraAccountOngoing;
    return this;
  }

  /**
   * The contra account number to register revenue for ongoing activities.     If includeSalesPriceInFinance is set to true, this property is required.     Otherwise, it cannot be provided.     Only accessible accounts (not barred) with accountType&#x3D;&#x3D;\&quot;status\&quot; or \&quot;profitAndLoss\&quot; are allowed.&lt;p class&#x3D;&#39;filter&#39;&gt;Filterable: eq, ne, lt, lte, gt, gte, in, nin&lt;/p&gt;&lt;p class&#x3D;&#39;sort&#39;&gt;Sortable: false&lt;/p&gt;
   * @return salesContraAccountOngoing
   */
  @javax.annotation.Nullable
  public Integer getSalesContraAccountOngoing() {
    return salesContraAccountOngoing;
  }

  public void setSalesContraAccountOngoing(Integer salesContraAccountOngoing) {
    this.salesContraAccountOngoing = salesContraAccountOngoing;
  }


  public ActivityGroup type(ActivityGroupType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.costAccountClosed, activityGroup.costAccountClosed) &&
        Objects.equals(this.costAccountOngoing, activityGroup.costAccountOngoing) &&
        Objects.equals(this.costAccountOngoingType, activityGroup.costAccountOngoingType) &&
        Objects.equals(this.costContraAccountOngoing, activityGroup.costContraAccountOngoing) &&
        Objects.equals(this.includeCostPriceInFinance, activityGroup.includeCostPriceInFinance) &&
        Objects.equals(this.includeSalesPriceInFinance, activityGroup.includeSalesPriceInFinance) &&
        Objects.equals(this.name, activityGroup.name) &&
        Objects.equals(this.number, activityGroup.number) &&
        Objects.equals(this.objectVersion, activityGroup.objectVersion) &&
        Objects.equals(this.salesAccountClosed, activityGroup.salesAccountClosed) &&
        Objects.equals(this.salesAccountOngoing, activityGroup.salesAccountOngoing) &&
        Objects.equals(this.salesAccountOngoingType, activityGroup.salesAccountOngoingType) &&
        Objects.equals(this.salesContraAccountOngoing, activityGroup.salesContraAccountOngoing) &&
        Objects.equals(this.type, activityGroup.type);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(costAccountClosed, costAccountOngoing, costAccountOngoingType, costContraAccountOngoing, includeCostPriceInFinance, includeSalesPriceInFinance, name, number, objectVersion, salesAccountClosed, salesAccountOngoing, salesAccountOngoingType, salesContraAccountOngoing, type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActivityGroup {\n");
    sb.append("    costAccountClosed: ").append(toIndentedString(costAccountClosed)).append("\n");
    sb.append("    costAccountOngoing: ").append(toIndentedString(costAccountOngoing)).append("\n");
    sb.append("    costAccountOngoingType: ").append(toIndentedString(costAccountOngoingType)).append("\n");
    sb.append("    costContraAccountOngoing: ").append(toIndentedString(costContraAccountOngoing)).append("\n");
    sb.append("    includeCostPriceInFinance: ").append(toIndentedString(includeCostPriceInFinance)).append("\n");
    sb.append("    includeSalesPriceInFinance: ").append(toIndentedString(includeSalesPriceInFinance)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    number: ").append(toIndentedString(number)).append("\n");
    sb.append("    objectVersion: ").append(toIndentedString(objectVersion)).append("\n");
    sb.append("    salesAccountClosed: ").append(toIndentedString(salesAccountClosed)).append("\n");
    sb.append("    salesAccountOngoing: ").append(toIndentedString(salesAccountOngoing)).append("\n");
    sb.append("    salesAccountOngoingType: ").append(toIndentedString(salesAccountOngoingType)).append("\n");
    sb.append("    salesContraAccountOngoing: ").append(toIndentedString(salesContraAccountOngoing)).append("\n");
  ...
  static {
    ...
    openapiFields.add("costAccountClosed");
    openapiFields.add("costAccountOngoing");
    openapiFields.add("costAccountOngoingType");
    openapiFields.add("costContraAccountOngoing");
    openapiFields.add("includeCostPriceInFinance");
    openapiFields.add("includeSalesPriceInFinance");
    openapiFields.add("name");
    openapiFields.add("number");
    openapiFields.add("objectVersion");
    openapiFields.add("salesAccountClosed");
    openapiFields.add("salesAccountOngoing");
    openapiFields.add("salesAccountOngoingType");
    openapiFields.add("salesContraAccountOngoing");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActivityGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActivityGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActivityGroup is not found in the empty JSON string", ActivityGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActivityGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActivityGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActivityGroup.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `costAccountOngoingType`
      if (jsonObj.get("costAccountOngoingType") != null && !jsonObj.get("costAccountOngoingType").isJsonNull()) {
        OngoingAccountType.validateJsonElement(jsonObj.get("costAccountOngoingType"));
      }
      ...
      // validate the optional field `salesAccountOngoingType`
      if (jsonObj.get("salesAccountOngoingType") != null && !jsonObj.get("salesAccountOngoingType").isJsonNull()) {
        OngoingAccountType.validateJsonElement(jsonObj.get("salesAccountOngoingType"));
      }
      // validate the required field `type`
      ActivityGroupType.validateJsonElement(jsonObj.get("type"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActivityGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActivityGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActivityGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActivityGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<ActivityGroup>() {
           @Override
           public void write(JsonWriter out, ActivityGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActivityGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActivityGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActivityGroup
   * @throws IOException if the JSON string is invalid with respect to ActivityGroup
   */
  public static ActivityGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActivityGroup.class);
  }

  /**
   * Convert an instance of ActivityGroup to an JSON string
   *
   * @return JSON string
   */
