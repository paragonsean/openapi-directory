...
public class Employee {
  ...
  public Employee access(Boolean access) {
    this.access = access;
    return this;
  }
  ...
  public Employee groupNumber(Integer groupNumber) {
  ...
  public Employee number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public Employee objectVersion(String objectVersion) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.access, employee.access) &&
        Objects.equals(this.email, employee.email) &&
        Objects.equals(this.groupNumber, employee.groupNumber) &&
        Objects.equals(this.name, employee.name) &&
        Objects.equals(this.number, employee.number) &&
        Objects.equals(this.objectVersion, employee.objectVersion) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(access, email, groupNumber, name, number, objectVersion, phone);
  }
