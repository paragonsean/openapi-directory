...
public class ProjectCustomer {
  ...
  public ProjectCustomer name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ProjectCustomer number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public ProjectCustomer objectVersion(String objectVersion) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectCustomer projectCustomer = (ProjectCustomer) o;
    return Objects.equals(this.name, projectCustomer.name) &&
        Objects.equals(this.number, projectCustomer.number) &&
        Objects.equals(this.objectVersion, projectCustomer.objectVersion);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, number, objectVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectCustomer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectCustomer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectCustomer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectCustomer is not found in the empty JSON string", ProjectCustomer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectCustomer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectCustomer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectCustomer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectCustomer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectCustomer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectCustomer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectCustomer.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectCustomer>() {
           @Override
           public void write(JsonWriter out, ProjectCustomer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectCustomer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectCustomer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectCustomer
   * @throws IOException if the JSON string is invalid with respect to ProjectCustomer
   */
  public static ProjectCustomer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectCustomer.class);
  }

  /**
   * Convert an instance of ProjectCustomer to an JSON string
   *
   * @return JSON string
   */
