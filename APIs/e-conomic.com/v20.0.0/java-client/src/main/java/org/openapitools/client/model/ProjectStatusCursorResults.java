...
public class ProjectStatusCursorResults {
  ...
  public ProjectStatusCursorResults() {
  }
  ...
  public ProjectStatusCursorResults items(List<ProjectStatus> items) {
    this.items = items;
    return this;
  }

  public ProjectStatusCursorResults addItemsItem(ProjectStatus itemsItem) {
    if (this.items == null) {
  ...
  public void setItems(List<ProjectStatus> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectStatusCursorResults projectStatusCursorResults = (ProjectStatusCursorResults) o;
    return Objects.equals(this.cursor, projectStatusCursorResults.cursor) &&
        Objects.equals(this.items, projectStatusCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectStatusCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectStatusCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectStatusCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectStatusCursorResults is not found in the empty JSON string", ProjectStatusCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectStatusCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectStatusCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            ProjectStatus.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectStatusCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectStatusCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectStatusCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectStatusCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectStatusCursorResults>() {
           @Override
           public void write(JsonWriter out, ProjectStatusCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectStatusCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectStatusCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectStatusCursorResults
   * @throws IOException if the JSON string is invalid with respect to ProjectStatusCursorResults
   */
  public static ProjectStatusCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectStatusCursorResults.class);
  }

  /**
   * Convert an instance of ProjectStatusCursorResults to an JSON string
   *
   * @return JSON string
   */
