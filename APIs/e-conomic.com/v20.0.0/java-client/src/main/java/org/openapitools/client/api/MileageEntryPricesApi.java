...
import org.openapitools.client.model.MileagePrices;
import org.openapitools.client.model.MileagePricesCursorResults;
...
public class MileageEntryPricesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public MileageEntryPricesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public MileageEntryPricesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getAllMileageEntryPrices
     ...
     */
    public okhttp3.Call getAllMileageEntryPricesCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/mileageprices";
    ...
    private okhttp3.Call getAllMileageEntryPricesValidateBeforeCall(String cursor, String filter, final ApiCallback _callback) throws ApiException {
        return getAllMileageEntryPricesCall(cursor, filter, _callback);
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return MileagePricesCursorResults
     ...
     */
    public MileagePricesCursorResults getAllMileageEntryPrices(String cursor, String filter) throws ApiException {
        ApiResponse<MileagePricesCursorResults> localVarResp = getAllMileageEntryPricesWithHttpInfo(cursor, filter);
     ...
     * @param cursor  (optional)
     * @param filter  (optional)
     * @return ApiResponse&lt;MileagePricesCursorResults&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<MileagePricesCursorResults> getAllMileageEntryPricesWithHttpInfo(String cursor, String filter) throws ApiException {
        okhttp3.Call localVarCall = getAllMileageEntryPricesValidateBeforeCall(cursor, filter, null);
        Type localVarReturnType = new TypeToken<MileagePricesCursorResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve all Mileage entry prices (asynchronously)
     * Use this endpoint to retrieve all Mileage entry prices in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
     * @param cursor  (optional)
     * @param filter  (optional)
     ...
     */
    public okhttp3.Call getAllMileageEntryPricesAsync(String cursor, String filter, final ApiCallback<MileagePricesCursorResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllMileageEntryPricesValidateBeforeCall(cursor, filter, _callback);
        Type localVarReturnType = new TypeToken<MileagePricesCursorResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getMileagePricesById
     ...
     */
    public okhttp3.Call getMileagePricesByIdCall(Integer number, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/mileageprices/{number}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMileagePricesByIdValidateBeforeCall(Integer number, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'number' is set
        if (number == null) {
            throw new ApiException("Missing the required parameter 'number' when calling getMileagePricesById(Async)");
        }

        return getMileagePricesByIdCall(number, _callback);
     ...
     */
    public MileagePrices getMileagePricesById(Integer number) throws ApiException {
        ApiResponse<MileagePrices> localVarResp = getMileagePricesByIdWithHttpInfo(number);
        return localVarResp.getData();
    }
     ...
     * Use this endpoint to load a single Mileage entry prices by id/number.
     * @param number  (required)
     * @return ApiResponse&lt;MileagePrices&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<MileagePrices> getMileagePricesByIdWithHttpInfo(Integer number) throws ApiException {
        okhttp3.Call localVarCall = getMileagePricesByIdValidateBeforeCall(number, null);
        Type localVarReturnType = new TypeToken<MileagePrices>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve single Mileage entry prices (asynchronously)
     * Use this endpoint to load a single Mileage entry prices by id/number.
     * @param number  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getMileagePricesByIdAsync(Integer number, final ApiCallback<MileagePrices> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMileagePricesByIdValidateBeforeCall(number, _callback);
        Type localVarReturnType = new TypeToken<MileagePrices>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getPageOfMileageEntryPrices
     * @param filter  (optional)
     * @param sort  (optional)
     ...
     */
    public okhttp3.Call getPageOfMileageEntryPricesCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/mileageprices/paged";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPageOfMileageEntryPricesValidateBeforeCall(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback _callback) throws ApiException {
        return getPageOfMileageEntryPricesCall(filter, sort, pageSize, skipPages, _callback);
     ...
     */
    public List<MileagePrices> getPageOfMileageEntryPrices(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        ApiResponse<List<MileagePrices>> localVarResp = getPageOfMileageEntryPricesWithHttpInfo(filter, sort, pageSize, skipPages);
        return localVarResp.getData();
    }
     ...
     * @param pageSize  (optional, default to 20)
     * @param skipPages  (optional, default to 0)
     * @return ApiResponse&lt;List&lt;MileagePrices&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<MileagePrices>> getPageOfMileageEntryPricesWithHttpInfo(String filter, String sort, Integer pageSize, Integer skipPages) throws ApiException {
        okhttp3.Call localVarCall = getPageOfMileageEntryPricesValidateBeforeCall(filter, sort, pageSize, skipPages, null);
        Type localVarReturnType = new TypeToken<List<MileagePrices>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve a page of Mileage entry prices (asynchronously)
     * Use this endpoint to load a page of Mileage entry prices.
     * @param filter  (optional)
     * @param sort  (optional)
     * @param pageSize  (optional, default to 20)
     ...
     */
    public okhttp3.Call getPageOfMileageEntryPricesAsync(String filter, String sort, Integer pageSize, Integer skipPages, final ApiCallback<List<MileagePrices>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPageOfMileageEntryPricesValidateBeforeCall(filter, sort, pageSize, skipPages, _callback);
        Type localVarReturnType = new TypeToken<List<MileagePrices>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
