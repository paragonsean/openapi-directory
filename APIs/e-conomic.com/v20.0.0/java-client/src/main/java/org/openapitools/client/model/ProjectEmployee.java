...
public class ProjectEmployee {
  ...
  public static final String SERIALIZED_NAME_CAN_APPROVE = "canApprove";
  @SerializedName(SERIALIZED_NAME_CAN_APPROVE)
  private Boolean canApprove;

  public static final String SERIALIZED_NAME_CAN_INVOICE = "canInvoice";
  @SerializedName(SERIALIZED_NAME_CAN_INVOICE)
  ...
  public static final String SERIALIZED_NAME_COST_PRICE_AFTER = "costPriceAfter";
  @SerializedName(SERIALIZED_NAME_COST_PRICE_AFTER)
  private Double costPriceAfter;

  public static final String SERIALIZED_NAME_COST_PRICE_BEFORE = "costPriceBefore";
  @SerializedName(SERIALIZED_NAME_COST_PRICE_BEFORE)
  private Double costPriceBefore;
  ...
  public static final String SERIALIZED_NAME_SALES_PRICE_AFTER = "salesPriceAfter";
  @SerializedName(SERIALIZED_NAME_SALES_PRICE_AFTER)
  private Double salesPriceAfter;

  public static final String SERIALIZED_NAME_SALES_PRICE_BEFORE = "salesPriceBefore";
  @SerializedName(SERIALIZED_NAME_SALES_PRICE_BEFORE)
  private Double salesPriceBefore;
  ...
  public ProjectEmployee address(String address) {
  ...
  public ProjectEmployee canApprove(Boolean canApprove) {
  ...
  public ProjectEmployee canInvoice(Boolean canInvoice) {
  ...
  public ProjectEmployee city(String city) {
    this.city = city;
    return this;
  }
  ...
  public ProjectEmployee costPriceAfter(Double costPriceAfter) {
   ...
   */
  @javax.annotation.Nullable
  public Double getCostPriceAfter() {
    return costPriceAfter;
  }

  public void setCostPriceAfter(Double costPriceAfter) {
    this.costPriceAfter = costPriceAfter;
  }


  public ProjectEmployee costPriceBefore(Double costPriceBefore) {
   ...
   */
  @javax.annotation.Nullable
  public Double getCostPriceBefore() {
    return costPriceBefore;
  }

  public void setCostPriceBefore(Double costPriceBefore) {
    this.costPriceBefore = costPriceBefore;
  }


  public ProjectEmployee cutOffDate(LocalDate cutOffDate) {
  ...
  public ProjectEmployee groupNumber(Integer groupNumber) {
  ...
  public ProjectEmployee isBarred(Boolean isBarred) {
  ...
  public ProjectEmployee name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ProjectEmployee number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public ProjectEmployee objectVersion(String objectVersion) {
  ...
  public ProjectEmployee salesPriceAfter(Double salesPriceAfter) {
   ...
   */
  @javax.annotation.Nullable
  public Double getSalesPriceAfter() {
    return salesPriceAfter;
  }

  public void setSalesPriceAfter(Double salesPriceAfter) {
    this.salesPriceAfter = salesPriceAfter;
  }


  public ProjectEmployee salesPriceBefore(Double salesPriceBefore) {
   ...
   */
  @javax.annotation.Nullable
  public Double getSalesPriceBefore() {
    return salesPriceBefore;
  }

  public void setSalesPriceBefore(Double salesPriceBefore) {
    this.salesPriceBefore = salesPriceBefore;
  }
  ...
  public ProjectEmployee zipCode(String zipCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, projectEmployee.address) &&
        Objects.equals(this.canApprove, projectEmployee.canApprove) &&
        Objects.equals(this.canInvoice, projectEmployee.canInvoice) &&
        Objects.equals(this.city, projectEmployee.city) &&
        Objects.equals(this.costPriceAfter, projectEmployee.costPriceAfter) &&
        Objects.equals(this.costPriceBefore, projectEmployee.costPriceBefore) &&
        Objects.equals(this.cutOffDate, projectEmployee.cutOffDate) &&
        Objects.equals(this.employeeType, projectEmployee.employeeType) &&
        Objects.equals(this.groupNumber, projectEmployee.groupNumber) &&
        Objects.equals(this.isBarred, projectEmployee.isBarred) &&
        Objects.equals(this.isUser, projectEmployee.isUser) &&
        Objects.equals(this.name, projectEmployee.name) &&
        Objects.equals(this.number, projectEmployee.number) &&
        Objects.equals(this.objectVersion, projectEmployee.objectVersion) &&
        Objects.equals(this.salesPriceAfter, projectEmployee.salesPriceAfter) &&
        Objects.equals(this.salesPriceBefore, projectEmployee.salesPriceBefore) &&
        Objects.equals(this.userId, projectEmployee.userId) &&
        Objects.equals(this.zipCode, projectEmployee.zipCode);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, canApprove, canInvoice, city, costPriceAfter, costPriceBefore, cutOffDate, employeeType, groupNumber, isBarred, isUser, name, number, objectVersion, salesPriceAfter, salesPriceBefore, userId, zipCode);
  }
  ...
  public String toString() {
    ...
    sb.append("    canInvoice: ").append(toIndentedString(canInvoice)).append("\n");
    sb.append("    city: ").append(toIndentedString(city)).append("\n");
    sb.append("    costPriceAfter: ").append(toIndentedString(costPriceAfter)).append("\n");
    sb.append("    costPriceBefore: ").append(toIndentedString(costPriceBefore)).append("\n");
    ...
    sb.append("    salesPriceAfter: ").append(toIndentedString(salesPriceAfter)).append("\n");
    sb.append("    salesPriceBefore: ").append(toIndentedString(salesPriceBefore)).append("\n");
  ...
  static {
    ...
    openapiFields.add("canInvoice");
    openapiFields.add("city");
    openapiFields.add("costPriceAfter");
    openapiFields.add("costPriceBefore");
    ...
    openapiFields.add("salesPriceAfter");
    openapiFields.add("salesPriceBefore");
    ...
    openapiRequiredFields.add("canInvoice");
    openapiRequiredFields.add("groupNumber");
    openapiRequiredFields.add("isBarred");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectEmployee
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectEmployee.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectEmployee is not found in the empty JSON string", ProjectEmployee.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectEmployee.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectEmployee` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectEmployee.openapiRequiredFields) {
      ...
      if (jsonObj.get("employeeType") != null && !jsonObj.get("employeeType").isJsonNull()) {
        EmployeeType.validateJsonElement(jsonObj.get("employeeType"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectEmployee.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectEmployee' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectEmployee> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectEmployee.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectEmployee>() {
           @Override
           public void write(JsonWriter out, ProjectEmployee value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectEmployee read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectEmployee given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectEmployee
   * @throws IOException if the JSON string is invalid with respect to ProjectEmployee
   */
  public static ProjectEmployee fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectEmployee.class);
  }

  /**
   * Convert an instance of ProjectEmployee to an JSON string
   *
   * @return JSON string
   */
