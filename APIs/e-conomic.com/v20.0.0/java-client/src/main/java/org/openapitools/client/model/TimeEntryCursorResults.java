...
public class TimeEntryCursorResults {
  ...
  public TimeEntryCursorResults items(List<TimeEntry> items) {
    this.items = items;
    return this;
  }

  public TimeEntryCursorResults addItemsItem(TimeEntry itemsItem) {
    if (this.items == null) {
  ...
  public boolean equals(Object o) {
    ...
    TimeEntryCursorResults timeEntryCursorResults = (TimeEntryCursorResults) o;
    return Objects.equals(this.cursor, timeEntryCursorResults.cursor) &&
        Objects.equals(this.items, timeEntryCursorResults.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeEntryCursorResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeEntryCursorResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeEntryCursorResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeEntryCursorResults is not found in the empty JSON string", TimeEntryCursorResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimeEntryCursorResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeEntryCursorResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            TimeEntry.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimeEntryCursorResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeEntryCursorResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimeEntryCursorResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeEntryCursorResults.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeEntryCursorResults>() {
           @Override
           public void write(JsonWriter out, TimeEntryCursorResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimeEntryCursorResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimeEntryCursorResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimeEntryCursorResults
   * @throws IOException if the JSON string is invalid with respect to TimeEntryCursorResults
   */
  public static TimeEntryCursorResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimeEntryCursorResults.class);
  }

  /**
   * Convert an instance of TimeEntryCursorResults to an JSON string
   *
   * @return JSON string
   */
