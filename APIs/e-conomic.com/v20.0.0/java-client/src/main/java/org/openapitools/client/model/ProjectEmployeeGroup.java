...
public class ProjectEmployeeGroup {
  ...
  public ProjectEmployeeGroup() {
  }

  public ProjectEmployeeGroup name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ProjectEmployeeGroup number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public ProjectEmployeeGroup objectVersion(String objectVersion) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectEmployeeGroup projectEmployeeGroup = (ProjectEmployeeGroup) o;
    return Objects.equals(this.name, projectEmployeeGroup.name) &&
        Objects.equals(this.number, projectEmployeeGroup.number) &&
        Objects.equals(this.objectVersion, projectEmployeeGroup.objectVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectEmployeeGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectEmployeeGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectEmployeeGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectEmployeeGroup is not found in the empty JSON string", ProjectEmployeeGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectEmployeeGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectEmployeeGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectEmployeeGroup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectEmployeeGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectEmployeeGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectEmployeeGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectEmployeeGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectEmployeeGroup>() {
           @Override
           public void write(JsonWriter out, ProjectEmployeeGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectEmployeeGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectEmployeeGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectEmployeeGroup
   * @throws IOException if the JSON string is invalid with respect to ProjectEmployeeGroup
   */
  public static ProjectEmployeeGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectEmployeeGroup.class);
  }

  /**
   * Convert an instance of ProjectEmployeeGroup to an JSON string
   *
   * @return JSON string
   */
