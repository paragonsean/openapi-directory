...
public class CostType {
  public static final String SERIALIZED_NAME_COST_GROUP_NUMBER = "costGroupNumber";
  @SerializedName(SERIALIZED_NAME_COST_GROUP_NUMBER)
  private Integer costGroupNumber;
  ...
  public static final String SERIALIZED_NAME_VAT_CODE = "vatCode";
  ...
  public CostType costGroupNumber(Integer costGroupNumber) {
    this.costGroupNumber = costGroupNumber;
    return this;
  }
   ...
   * @return costGroupNumber
   */
  @javax.annotation.Nonnull
  public Integer getCostGroupNumber() {
    return costGroupNumber;
  }

  public void setCostGroupNumber(Integer costGroupNumber) {
    this.costGroupNumber = costGroupNumber;
  }


  public CostType isBarred(Boolean isBarred) {
  ...
  public CostType number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public CostType objectVersion(String objectVersion) {
  ...
  public CostType vatCode(String vatCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.costGroupNumber, costType.costGroupNumber) &&
        Objects.equals(this.isBarred, costType.isBarred) &&
        Objects.equals(this.lastUpdated, costType.lastUpdated) &&
        Objects.equals(this.name, costType.name) &&
        Objects.equals(this.number, costType.number) &&
        Objects.equals(this.objectVersion, costType.objectVersion) &&
        Objects.equals(this.vatCode, costType.vatCode);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(costGroupNumber, isBarred, lastUpdated, name, number, objectVersion, vatCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CostType {\n");
    sb.append("    costGroupNumber: ").append(toIndentedString(costGroupNumber)).append("\n");
  ...
  static {
    ...
    openapiFields.add("costGroupNumber");
    ...
    openapiRequiredFields.add("costGroupNumber");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CostType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CostType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CostType is not found in the empty JSON string", CostType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CostType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CostType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CostType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CostType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CostType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CostType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CostType.class));

       return (TypeAdapter<T>) new TypeAdapter<CostType>() {
           @Override
           public void write(JsonWriter out, CostType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CostType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CostType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CostType
   * @throws IOException if the JSON string is invalid with respect to CostType
   */
  public static CostType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CostType.class);
  }

  /**
   * Convert an instance of CostType to an JSON string
   *
   * @return JSON string
   */
