...
async def get_all_time_entry_prices(request: web.Request, cursor=None, filter=None) -> web.Response:
...
async def get_page_of_time_entry_prices(request: web.Request, filter=None, sort=None, page_size=None, skip_pages=None) -> web.Response:
...
async def get_time_entry_prices_by_id(request: web.Request, number) -> web.Response:
