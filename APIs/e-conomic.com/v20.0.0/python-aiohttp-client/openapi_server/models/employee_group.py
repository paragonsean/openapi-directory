...
class EmployeeGroup(Model):
    ...
    def __init__(self, name: str=None, number: int=None, object_version: str=None):
        """EmployeeGroup - a model defined in OpenAPI

        :param name: The name of this EmployeeGroup.
        :param number: The number of this EmployeeGroup.
        :param object_version: The object_version of this EmployeeGroup.
        """
        self.openapi_types = {
            'name': str,
            'number': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EmployeeGroup':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EmployeeGroup of this EmployeeGroup.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self):
        """Gets the name of this EmployeeGroup.

        Name of the employee group.<p class='filter'>Filterable: eq, ne, lt, lte, gt, gte, in, nin, like</p><p class='sort'>Sortable: false</p>

        :return: The name of this EmployeeGroup.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this EmployeeGroup.
    ...
    @property
    def number(self):
        """Gets the number of this EmployeeGroup.
        ...
        :return: The number of this EmployeeGroup.
        :rtype: int
        """
        return self._number
    ...
    def number(self, number):
        """Sets the number of this EmployeeGroup.
    ...
    def object_version(self, object_version):
        """Sets the object_version of this EmployeeGroup.
