# VismaEConomicOpenApi.CostTypesApi

All URIs are relative to *https://apis.e-conomic.com/api/v20.0.0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getAllCostTypes**](CostTypesApi.md#getAllCostTypes) | **GET** /costtypes | Retrieve all Cost Types
[**getCostTypeById**](CostTypesApi.md#getCostTypeById) | **GET** /costtypes/{number} | Retrieve single Cost Type
[**getNumberOfCostTypes**](CostTypesApi.md#getNumberOfCostTypes) | **GET** /costtypes/count | Retrieve the number of Cost Types
[**getPageOfCostTypes**](CostTypesApi.md#getPageOfCostTypes) | **GET** /costtypes/paged | Retrieve a page of Cost Types



## getAllCostTypes

> CostTypeCursorResults getAllCostTypes(opts)
...
let apiInstance = new VismaEConomicOpenApi.CostTypesApi();
let opts = {
  'cursor': "cursor_example", // String | 
  'filter': "filter_example" // String | 
};
apiInstance.getAllCostTypes(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
[**CostTypeCursorResults**](CostTypeCursorResults.md)
...
> CostType getCostTypeById(number)
...
apiInstance.getCostTypeById(number, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## getNumberOfCostTypes

> Number getNumberOfCostTypes(opts)
...
apiInstance.getNumberOfCostTypes(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [CostType] getPageOfCostTypes(opts)
...
apiInstance.getPageOfCostTypes(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
