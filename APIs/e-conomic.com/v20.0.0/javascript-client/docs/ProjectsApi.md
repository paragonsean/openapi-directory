# VismaEConomicOpenApi.ProjectsApi
...
> CreatedResult createProject(opts)
...
let apiInstance = new VismaEConomicOpenApi.ProjectsApi();
let opts = {
  'project': new VismaEConomicOpenApi.Project() // Project | 
};
...
apiInstance.deleteProjectById(number, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ProjectCursorResults getAllProjects(opts)
...
> Number getNumberOfProjects(opts)
...
apiInstance.getNumberOfProjects(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Project] getPageOfProjects(opts)
...
apiInstance.getPageOfProjects(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Project] getPagedListOfProjectUnderEmployee(employeeNumber)
...
apiInstance.getPagedListOfProjectUnderEmployee(employeeNumber, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new VismaEConomicOpenApi.ProjectsApi();
let number = 56; // Number | 
apiInstance.getProjectById(number, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
