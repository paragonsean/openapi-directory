# VismaEConomicOpenApi.ProjectCustomersApi
...
> ProjectCustomerCursorResults getAllProjectCustomers(opts)
...
let apiInstance = new VismaEConomicOpenApi.ProjectCustomersApi();
let opts = {
  'cursor': "cursor_example", // String | 
  'filter': "filter_example" // String | 
};
apiInstance.getAllProjectCustomers(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Number getNumberOfProjectCustomers(opts)
...
apiInstance.getNumberOfProjectCustomers(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [ProjectCustomer] getPageOfProjectCustomers(opts)
...
apiInstance.getPageOfProjectCustomers(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getProjectCustomerById(number, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
