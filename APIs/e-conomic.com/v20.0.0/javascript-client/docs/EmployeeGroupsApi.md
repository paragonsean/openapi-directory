# VismaEConomicOpenApi.EmployeeGroupsApi
...
> CreatedResult createEmployeeGroup(opts)
...
let apiInstance = new VismaEConomicOpenApi.EmployeeGroupsApi();
let opts = {
  'employeeGroup': new VismaEConomicOpenApi.EmployeeGroup() // EmployeeGroup | 
};
apiInstance.createEmployeeGroup(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.deleteEmployeeGroupById(number, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> EmployeeGroupCursorResults getAllEmployeeGroups(opts)
...
apiInstance.getAllEmployeeGroups(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new VismaEConomicOpenApi.EmployeeGroupsApi();
let number = 56; // Number | 
apiInstance.getEmployeeGroupById(number, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Number getNumberOfEmployeeGroups(opts)
...
apiInstance.getNumberOfEmployeeGroups(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [EmployeeGroup] getPageOfEmployeeGroups(opts)
...
apiInstance.getPageOfEmployeeGroups(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.updateEmployeeGroup(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
