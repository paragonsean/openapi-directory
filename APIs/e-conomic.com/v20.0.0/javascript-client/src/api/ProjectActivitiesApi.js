...
* @module api/ProjectActivitiesApi
* @version v20.0.0
*/
export default class ProjectActivitiesApi {

    /**
    * Constructs a new ProjectActivitiesApi. 
    * @alias module:api/ProjectActivitiesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createProjectActivity operation.
     * @callback module:api/ProjectActivitiesApi~createProjectActivityCallback
     ...
     * @param {module:model/ProjectActivity} [projectActivity] 
     * @param {module:api/ProjectActivitiesApi~createProjectActivityCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreatedResult}
     */
    createProjectActivity(opts, callback) {
      opts = opts || {};
      let postBody = opts['projectActivity'];
    ...
    /**
     * Callback function to receive the result of the deleteProjectActivityById operation.
     * @callback module:api/ProjectActivitiesApi~deleteProjectActivityByIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} number 
     * @param {module:api/ProjectActivitiesApi~deleteProjectActivityByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteProjectActivityById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling deleteProjectActivityById");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/project-activities/{number}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getAllProjectActivities operation.
     * @callback module:api/ProjectActivitiesApi~getAllProjectActivitiesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProjectActivityCursorResults} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [cursor] 
     * @param {String} [filter] 
     * @param {module:api/ProjectActivitiesApi~getAllProjectActivitiesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProjectActivityCursorResults}
     */
    getAllProjectActivities(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ProjectActivityCursorResults;
      return this.apiClient.callApi(
        '/project-activities', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getNumberOfProjectActivities operation.
     * @callback module:api/ProjectActivitiesApi~getNumberOfProjectActivitiesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [filter] 
     * @param {module:api/ProjectActivitiesApi~getNumberOfProjectActivitiesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Number}
     */
    getNumberOfProjectActivities(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getPageOfProjectActivities operation.
     * @callback module:api/ProjectActivitiesApi~getPageOfProjectActivitiesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ProjectActivity>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ProjectActivitiesApi~getPageOfProjectActivitiesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ProjectActivity>}
     */
    getPageOfProjectActivities(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [ProjectActivity];
      return this.apiClient.callApi(
        '/project-activities/paged', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getProjectActivityById operation.
     * @callback module:api/ProjectActivitiesApi~getProjectActivityByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProjectActivity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} number 
     * @param {module:api/ProjectActivitiesApi~getProjectActivityByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProjectActivity}
     */
    getProjectActivityById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling getProjectActivityById");
      }
    ...
    /**
     * Callback function to receive the result of the updateProjectActivity operation.
     * @callback module:api/ProjectActivitiesApi~updateProjectActivityCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ProjectActivity} [projectActivity] 
     * @param {module:api/ProjectActivitiesApi~updateProjectActivityCallback} callback The callback function, accepting three arguments: error, data, response
     */
    updateProjectActivity(opts, callback) {
      opts = opts || {};
      let postBody = opts['projectActivity'];
