...
export default class TimeEntriesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the approveTimeEntries operation.
     * @callback module:api/TimeEntriesApi~approveTimeEntriesCallback
     ...
     * @param {module:model/TimeEntryNumbersCollection} [timeEntryNumbersCollection] 
     * @param {module:api/TimeEntriesApi~approveTimeEntriesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    approveTimeEntries(opts, callback) {
      opts = opts || {};
      let postBody = opts['timeEntryNumbersCollection'];
    ...
    /**
     * Callback function to receive the result of the approveTimeEntries_0 operation.
     * @callback module:api/TimeEntriesApi~approveTimeEntries_0Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/TimeEntryNumbersCollection} [timeEntryNumbersCollection] 
     * @param {module:api/TimeEntriesApi~approveTimeEntries_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    approveTimeEntries_0(opts, callback) {
      opts = opts || {};
      let postBody = opts['timeEntryNumbersCollection'];
    ...
    /**
     * Callback function to receive the result of the createTimeEntry operation.
     * @callback module:api/TimeEntriesApi~createTimeEntryCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/TimeEntry} [timeEntry] 
     * @param {module:api/TimeEntriesApi~createTimeEntryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreatedResult}
     */
    createTimeEntry(opts, callback) {
      opts = opts || {};
      let postBody = opts['timeEntry'];
    ...
    /**
     * Callback function to receive the result of the deleteTimeEntryById operation.
     * @callback module:api/TimeEntriesApi~deleteTimeEntryByIdCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} number 
     * @param {module:api/TimeEntriesApi~deleteTimeEntryByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteTimeEntryById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling deleteTimeEntryById");
      }
    ...
    /**
     * Callback function to receive the result of the getAllTimeEntries operation.
     * @callback module:api/TimeEntriesApi~getAllTimeEntriesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TimeEntryCursorResults} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [cursor] 
     * @param {String} [filter] 
     * @param {module:api/TimeEntriesApi~getAllTimeEntriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TimeEntryCursorResults}
     */
    getAllTimeEntries(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = TimeEntryCursorResults;
      return this.apiClient.callApi(
        '/timeentries', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the getNumberOfTimeEntries operation.
     * @callback module:api/TimeEntriesApi~getNumberOfTimeEntriesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [filter] 
     * @param {module:api/TimeEntriesApi~getNumberOfTimeEntriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Number}
     */
    getNumberOfTimeEntries(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getPageOfTimeEntries operation.
     * @callback module:api/TimeEntriesApi~getPageOfTimeEntriesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/TimeEntry>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TimeEntriesApi~getPageOfTimeEntriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/TimeEntry>}
     */
    getPageOfTimeEntries(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [TimeEntry];
      return this.apiClient.callApi(
        '/timeentries/paged', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getTimeEntryById operation.
     * @callback module:api/TimeEntriesApi~getTimeEntryByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TimeEntry} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} number 
     * @param {module:api/TimeEntriesApi~getTimeEntryByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TimeEntry}
     */
    getTimeEntryById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling getTimeEntryById");
      }
    ...
    /**
     * Callback function to receive the result of the updateTimeEntry operation.
     * @callback module:api/TimeEntriesApi~updateTimeEntryCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/TimeEntry} [timeEntry] 
     * @param {module:api/TimeEntriesApi~updateTimeEntryCallback} callback The callback function, accepting three arguments: error, data, response
     */
    updateTimeEntry(opts, callback) {
      opts = opts || {};
      let postBody = opts['timeEntry'];
