...
/**
* ActivityGroups service.
* @module api/ActivityGroupsApi
* @version v20.0.0
*/
export default class ActivityGroupsApi {

    /**
    * Constructs a new ActivityGroupsApi. 
    * @alias module:api/ActivityGroupsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createActivityGroup operation.
     * @callback module:api/ActivityGroupsApi~createActivityGroupCallback
     ...
     * @param {module:model/ActivityGroup} [activityGroup] 
     * @param {module:api/ActivityGroupsApi~createActivityGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreatedResult}
     */
    createActivityGroup(opts, callback) {
      opts = opts || {};
      let postBody = opts['activityGroup'];
    ...
    /**
     * Callback function to receive the result of the getActivityGroupById operation.
     * @callback module:api/ActivityGroupsApi~getActivityGroupByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActivityGroup} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} number 
     * @param {module:api/ActivityGroupsApi~getActivityGroupByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActivityGroup}
     */
    getActivityGroupById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling getActivityGroupById");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ActivityGroup;
      return this.apiClient.callApi(
        '/activitygroups/{number}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getAllActivityGroups operation.
     * @callback module:api/ActivityGroupsApi~getAllActivityGroupsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActivityGroupCursorResults} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [cursor] 
     * @param {String} [filter] 
     * @param {module:api/ActivityGroupsApi~getAllActivityGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActivityGroupCursorResults}
     */
    getAllActivityGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ActivityGroupCursorResults;
      return this.apiClient.callApi(
        '/activitygroups', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the getNumberOfActivityGroups operation.
     * @callback module:api/ActivityGroupsApi~getNumberOfActivityGroupsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [filter] 
     * @param {module:api/ActivityGroupsApi~getNumberOfActivityGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Number}
     */
    getNumberOfActivityGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getPageOfActivityGroups operation.
     * @callback module:api/ActivityGroupsApi~getPageOfActivityGroupsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ActivityGroup>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ActivityGroupsApi~getPageOfActivityGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ActivityGroup>}
     */
    getPageOfActivityGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
