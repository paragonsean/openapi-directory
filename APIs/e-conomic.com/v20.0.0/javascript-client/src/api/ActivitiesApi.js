...
export default class ActivitiesApi {
    ...
    */
     ...
     */
    getActivityById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling getActivityById");
      }
    ...
    /**
     * Callback function to receive the result of the getAllActivities operation.
     * @callback module:api/ActivitiesApi~getAllActivitiesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActivityCursorResults} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [cursor] 
     * @param {String} [filter] 
     * @param {module:api/ActivitiesApi~getAllActivitiesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActivityCursorResults}
     */
    getAllActivities(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ActivityCursorResults;
      return this.apiClient.callApi(
        '/activities', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the getAllowedActivities operation.
     * @callback module:api/ActivitiesApi~getAllowedActivitiesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ActivitiesApi~getAllowedActivitiesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Activity>}
     */
    getAllowedActivities(employeeNumber, projectNumber, callback) {
      let postBody = null;
      // verify the required parameter 'employeeNumber' is set
      if (employeeNumber === undefined || employeeNumber === null) {
        throw new Error("Missing the required parameter 'employeeNumber' when calling getAllowedActivities");
      }
      // verify the required parameter 'projectNumber' is set
      if (projectNumber === undefined || projectNumber === null) {
        throw new Error("Missing the required parameter 'projectNumber' when calling getAllowedActivities");
      }
    ...
    /**
     * Callback function to receive the result of the getNumberOfActivities operation.
     * @callback module:api/ActivitiesApi~getNumberOfActivitiesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [filter] 
     * @param {module:api/ActivitiesApi~getNumberOfActivitiesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Number}
     */
    getNumberOfActivities(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getPageOfActivities operation.
     * @callback module:api/ActivitiesApi~getPageOfActivitiesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Activity>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ActivitiesApi~getPageOfActivitiesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Activity>}
     */
    getPageOfActivities(opts, callback) {
      opts = opts || {};
      let postBody = null;
