...
export default class EmployeeGroupsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createEmployeeGroup operation.
     * @callback module:api/EmployeeGroupsApi~createEmployeeGroupCallback
     ...
     * @param {module:model/EmployeeGroup} [employeeGroup] 
     * @param {module:api/EmployeeGroupsApi~createEmployeeGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreatedResult}
     */
    createEmployeeGroup(opts, callback) {
      opts = opts || {};
      let postBody = opts['employeeGroup'];
    ...
    /**
     * Callback function to receive the result of the deleteEmployeeGroupById operation.
     * @callback module:api/EmployeeGroupsApi~deleteEmployeeGroupByIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} number 
     * @param {module:api/EmployeeGroupsApi~deleteEmployeeGroupByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteEmployeeGroupById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling deleteEmployeeGroupById");
      }
    ...
    /**
     * Callback function to receive the result of the getAllEmployeeGroups operation.
     * @callback module:api/EmployeeGroupsApi~getAllEmployeeGroupsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EmployeeGroupCursorResults} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [cursor] 
     * @param {String} [filter] 
     * @param {module:api/EmployeeGroupsApi~getAllEmployeeGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EmployeeGroupCursorResults}
     */
    getAllEmployeeGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = EmployeeGroupCursorResults;
      return this.apiClient.callApi(
        '/employeegroups', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the getEmployeeGroupById operation.
     * @callback module:api/EmployeeGroupsApi~getEmployeeGroupByIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} number 
     * @param {module:api/EmployeeGroupsApi~getEmployeeGroupByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EmployeeGroup}
     */
    getEmployeeGroupById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling getEmployeeGroupById");
      }
    ...
    /**
     * Callback function to receive the result of the getNumberOfEmployeeGroups operation.
     * @callback module:api/EmployeeGroupsApi~getNumberOfEmployeeGroupsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [filter] 
     * @param {module:api/EmployeeGroupsApi~getNumberOfEmployeeGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Number}
     */
    getNumberOfEmployeeGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getPageOfEmployeeGroups operation.
     * @callback module:api/EmployeeGroupsApi~getPageOfEmployeeGroupsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/EmployeeGroup>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/EmployeeGroupsApi~getPageOfEmployeeGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/EmployeeGroup>}
     */
    getPageOfEmployeeGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the updateEmployeeGroup operation.
     * @callback module:api/EmployeeGroupsApi~updateEmployeeGroupCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/EmployeeGroup} [employeeGroup] 
     * @param {module:api/EmployeeGroupsApi~updateEmployeeGroupCallback} callback The callback function, accepting three arguments: error, data, response
     */
    updateEmployeeGroup(opts, callback) {
      opts = opts || {};
      let postBody = opts['employeeGroup'];
