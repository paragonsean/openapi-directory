...
/**
* MileageEntries service.
* @module api/MileageEntriesApi
* @version v20.0.0
*/
export default class MileageEntriesApi {

    /**
    * Constructs a new MileageEntriesApi. 
    * @alias module:api/MileageEntriesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the approveMileageEntries_0 operation.
     * @callback module:api/MileageEntriesApi~approveMileageEntries_0Callback
     ...
     * @param {module:model/MileageNumbersCollection} [mileageNumbersCollection] 
     * @param {module:api/MileageEntriesApi~approveMileageEntries_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    approveMileageEntries_0(opts, callback) {
      opts = opts || {};
      let postBody = opts['mileageNumbersCollection'];
    ...
    /**
     * Callback function to receive the result of the createMileage operation.
     * @callback module:api/MileageEntriesApi~createMileageCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/Mileage} [mileage] 
     * @param {module:api/MileageEntriesApi~createMileageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreatedResult}
     */
    createMileage(opts, callback) {
      opts = opts || {};
      let postBody = opts['mileage'];
    ...
    /**
     * Callback function to receive the result of the deleteMileageById operation.
     * @callback module:api/MileageEntriesApi~deleteMileageByIdCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} number 
     * @param {module:api/MileageEntriesApi~deleteMileageByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteMileageById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling deleteMileageById");
      }
    ...
    /**
     * Callback function to receive the result of the getAllMileageEntries operation.
     * @callback module:api/MileageEntriesApi~getAllMileageEntriesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MileageCursorResults} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [cursor] 
     * @param {String} [filter] 
     * @param {module:api/MileageEntriesApi~getAllMileageEntriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MileageCursorResults}
     */
    getAllMileageEntries(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = MileageCursorResults;
      return this.apiClient.callApi(
        '/mileages', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the getMileageById operation.
     * @callback module:api/MileageEntriesApi~getMileageByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Mileage} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} number 
     * @param {module:api/MileageEntriesApi~getMileageByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Mileage}
     */
    getMileageById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling getMileageById");
      }
    ...
    /**
     * Callback function to receive the result of the getNumberOfMileageEntries operation.
     * @callback module:api/MileageEntriesApi~getNumberOfMileageEntriesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [filter] 
     * @param {module:api/MileageEntriesApi~getNumberOfMileageEntriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Number}
     */
    getNumberOfMileageEntries(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getPageOfMileageEntries operation.
     * @callback module:api/MileageEntriesApi~getPageOfMileageEntriesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Mileage>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MileageEntriesApi~getPageOfMileageEntriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Mileage>}
     */
    getPageOfMileageEntries(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the updateMileage operation.
     * @callback module:api/MileageEntriesApi~updateMileageCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/Mileage} [mileage] 
     * @param {module:api/MileageEntriesApi~updateMileageCallback} callback The callback function, accepting three arguments: error, data, response
     */
    updateMileage(opts, callback) {
      opts = opts || {};
      let postBody = opts['mileage'];
