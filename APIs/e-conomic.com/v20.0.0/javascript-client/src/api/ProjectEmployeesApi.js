...
/**
* ProjectEmployees service.
* @module api/ProjectEmployeesApi
* @version v20.0.0
*/
export default class ProjectEmployeesApi {

    /**
    * Constructs a new ProjectEmployeesApi. 
    * @alias module:api/ProjectEmployeesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createProjectEmployee operation.
     * @callback module:api/ProjectEmployeesApi~createProjectEmployeeCallback
     ...
     * @param {module:model/ProjectEmployee} [projectEmployee] 
     * @param {module:api/ProjectEmployeesApi~createProjectEmployeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreatedResult}
     */
    createProjectEmployee(opts, callback) {
      opts = opts || {};
      let postBody = opts['projectEmployee'];
    ...
    /**
     * Callback function to receive the result of the deleteProjectEmployeeById operation.
     * @callback module:api/ProjectEmployeesApi~deleteProjectEmployeeByIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} number 
     * @param {module:api/ProjectEmployeesApi~deleteProjectEmployeeByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteProjectEmployeeById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling deleteProjectEmployeeById");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/project-employees/{number}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getAllProjectEmployees operation.
     * @callback module:api/ProjectEmployeesApi~getAllProjectEmployeesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProjectEmployeeCursorResults} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [cursor] 
     * @param {String} [filter] 
     * @param {module:api/ProjectEmployeesApi~getAllProjectEmployeesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProjectEmployeeCursorResults}
     */
    getAllProjectEmployees(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ProjectEmployeeCursorResults;
      return this.apiClient.callApi(
        '/project-employees', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getNumberOfProjectEmployees operation.
     * @callback module:api/ProjectEmployeesApi~getNumberOfProjectEmployeesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [filter] 
     * @param {module:api/ProjectEmployeesApi~getNumberOfProjectEmployeesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Number}
     */
    getNumberOfProjectEmployees(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getPageOfProjectEmployees operation.
     * @callback module:api/ProjectEmployeesApi~getPageOfProjectEmployeesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ProjectEmployee>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ProjectEmployeesApi~getPageOfProjectEmployeesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ProjectEmployee>}
     */
    getPageOfProjectEmployees(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [ProjectEmployee];
      return this.apiClient.callApi(
        '/project-employees/paged', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getProjectEmployeeById operation.
     * @callback module:api/ProjectEmployeesApi~getProjectEmployeeByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProjectEmployee} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} number 
     * @param {module:api/ProjectEmployeesApi~getProjectEmployeeByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProjectEmployee}
     */
    getProjectEmployeeById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling getProjectEmployeeById");
      }
    ...
    /**
     * Callback function to receive the result of the updateProjectEmployee operation.
     * @callback module:api/ProjectEmployeesApi~updateProjectEmployeeCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ProjectEmployee} [projectEmployee] 
     * @param {module:api/ProjectEmployeesApi~updateProjectEmployeeCallback} callback The callback function, accepting three arguments: error, data, response
     */
    updateProjectEmployee(opts, callback) {
      opts = opts || {};
      let postBody = opts['projectEmployee'];
