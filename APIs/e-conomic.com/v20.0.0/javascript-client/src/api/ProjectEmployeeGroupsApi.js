...
/**
* ProjectEmployeeGroups service.
* @module api/ProjectEmployeeGroupsApi
* @version v20.0.0
*/
export default class ProjectEmployeeGroupsApi {

    /**
    * Constructs a new ProjectEmployeeGroupsApi. 
    * @alias module:api/ProjectEmployeeGroupsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createProjectEmployeeGroup operation.
     * @callback module:api/ProjectEmployeeGroupsApi~createProjectEmployeeGroupCallback
     ...
     * @param {module:model/ProjectEmployeeGroup} [projectEmployeeGroup] 
     * @param {module:api/ProjectEmployeeGroupsApi~createProjectEmployeeGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreatedResult}
     */
    createProjectEmployeeGroup(opts, callback) {
      opts = opts || {};
      let postBody = opts['projectEmployeeGroup'];
    ...
    /**
     * Callback function to receive the result of the deleteProjectEmployeeGroupById operation.
     * @callback module:api/ProjectEmployeeGroupsApi~deleteProjectEmployeeGroupByIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} number 
     * @param {module:api/ProjectEmployeeGroupsApi~deleteProjectEmployeeGroupByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteProjectEmployeeGroupById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling deleteProjectEmployeeGroupById");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/project-employeegroups/{number}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getAllProjectEmployeeGroups operation.
     * @callback module:api/ProjectEmployeeGroupsApi~getAllProjectEmployeeGroupsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProjectEmployeeGroupCursorResults} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [cursor] 
     * @param {String} [filter] 
     * @param {module:api/ProjectEmployeeGroupsApi~getAllProjectEmployeeGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProjectEmployeeGroupCursorResults}
     */
    getAllProjectEmployeeGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ProjectEmployeeGroupCursorResults;
      return this.apiClient.callApi(
        '/project-employeegroups', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getNumberOfProjectEmployeeGroups operation.
     * @callback module:api/ProjectEmployeeGroupsApi~getNumberOfProjectEmployeeGroupsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [filter] 
     * @param {module:api/ProjectEmployeeGroupsApi~getNumberOfProjectEmployeeGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Number}
     */
    getNumberOfProjectEmployeeGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/project-employeegroups/count', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getPageOfProjectEmployeeGroups operation.
     * @callback module:api/ProjectEmployeeGroupsApi~getPageOfProjectEmployeeGroupsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ProjectEmployeeGroup>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ProjectEmployeeGroupsApi~getPageOfProjectEmployeeGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ProjectEmployeeGroup>}
     */
    getPageOfProjectEmployeeGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [ProjectEmployeeGroup];
      return this.apiClient.callApi(
        '/project-employeegroups/paged', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getProjectEmployeeGroupById operation.
     * @callback module:api/ProjectEmployeeGroupsApi~getProjectEmployeeGroupByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProjectEmployeeGroup} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} number 
     * @param {module:api/ProjectEmployeeGroupsApi~getProjectEmployeeGroupByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProjectEmployeeGroup}
     */
    getProjectEmployeeGroupById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling getProjectEmployeeGroupById");
      }
      ...
      let returnType = ProjectEmployeeGroup;
      return this.apiClient.callApi(
        '/project-employeegroups/{number}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateProjectEmployeeGroup operation.
     * @callback module:api/ProjectEmployeeGroupsApi~updateProjectEmployeeGroupCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ProjectEmployeeGroup} [projectEmployeeGroup] 
     * @param {module:api/ProjectEmployeeGroupsApi~updateProjectEmployeeGroupCallback} callback The callback function, accepting three arguments: error, data, response
     */
    updateProjectEmployeeGroup(opts, callback) {
      opts = opts || {};
      let postBody = opts['projectEmployeeGroup'];
