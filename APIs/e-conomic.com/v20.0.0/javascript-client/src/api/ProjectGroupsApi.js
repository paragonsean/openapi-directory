...
/**
* ProjectGroups service.
* @module api/ProjectGroupsApi
* @version v20.0.0
*/
export default class ProjectGroupsApi {

    /**
    * Constructs a new ProjectGroupsApi. 
    * @alias module:api/ProjectGroupsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createProjectGroup operation.
     * @callback module:api/ProjectGroupsApi~createProjectGroupCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreatedResult} data The data returned by the service call.
     ...
     * @param {module:model/ProjectGroup} [projectGroup] 
     * @param {module:api/ProjectGroupsApi~createProjectGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreatedResult}
     */
    createProjectGroup(opts, callback) {
      opts = opts || {};
      let postBody = opts['projectGroup'];
    ...
    /**
     * Callback function to receive the result of the getAllProjectGroups operation.
     * @callback module:api/ProjectGroupsApi~getAllProjectGroupsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProjectGroupCursorResults} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [cursor] 
     * @param {String} [filter] 
     * @param {module:api/ProjectGroupsApi~getAllProjectGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProjectGroupCursorResults}
     */
    getAllProjectGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ProjectGroupCursorResults;
      return this.apiClient.callApi(
        '/projectgroups', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the getNumberOfProjectGroups operation.
     * @callback module:api/ProjectGroupsApi~getNumberOfProjectGroupsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [filter] 
     * @param {module:api/ProjectGroupsApi~getNumberOfProjectGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Number}
     */
    getNumberOfProjectGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getPageOfProjectGroups operation.
     * @callback module:api/ProjectGroupsApi~getPageOfProjectGroupsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ProjectGroup>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [skipPages = 0)] 
     * @param {module:api/ProjectGroupsApi~getPageOfProjectGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ProjectGroup>}
     */
    getPageOfProjectGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [ProjectGroup];
      return this.apiClient.callApi(
        '/projectgroups/paged', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getProjectGroupById operation.
     * @callback module:api/ProjectGroupsApi~getProjectGroupByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProjectGroup} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} number 
     * @param {module:api/ProjectGroupsApi~getProjectGroupByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProjectGroup}
     */
    getProjectGroupById(number, callback) {
      let postBody = null;
      // verify the required parameter 'number' is set
      if (number === undefined || number === null) {
        throw new Error("Missing the required parameter 'number' when calling getProjectGroupById");
      }
