...
/**
 * The ProjectEmployee model module.
 * @module model/ProjectEmployee
 * @version v20.0.0
 */
class ProjectEmployee {
    /**
     * Constructs a new <code>ProjectEmployee</code>.
     * @alias module:model/ProjectEmployee
     * @param canApprove {Boolean} Shows if the employee can approve for example time entries.<p class='filter'>Filterable: not filterable</p><p class='sort'>Sortable: false</p>
     * @param canInvoice {Boolean} Shows if the employee can take for example a time entry to the invoice process.<p class='filter'>Filterable: eq, ne, lt, lte, gt, gte</p><p class='sort'>Sortable: false</p>
     * @param groupNumber {Number} The number of the employee group that this employee belongs.<p class='filter'>Filterable: eq, ne, lt, lte, gt, gte, in, nin</p><p class='sort'>Sortable: false</p>
     * @param isBarred {Boolean} Shows if the employee can be registered on or is barred.<p class='filter'>Filterable: eq, ne, lt, lte, gt, gte</p><p class='sort'>Sortable: false</p>
     * @param name {String} Name of the employee.<p class='filter'>Filterable: eq, ne, lt, lte, gt, gte, in, nin, like</p><p class='sort'>Sortable: false</p>
     * @param number {Number} The unique number of the project employee.<p class='filter'>Filterable: eq, ne, lt, lte, gt, gte, in, nin</p><p class='sort'>Sortable: true</p>
     */
    constructor(canApprove, canInvoice, groupNumber, isBarred, name, number) { 
        
        ProjectEmployee.initialize(this, canApprove, canInvoice, groupNumber, isBarred, name, number);
    }
     ...
     */
    static initialize(obj, canApprove, canInvoice, groupNumber, isBarred, name, number) { 
        obj['canApprove'] = canApprove;
        obj['canInvoice'] = canInvoice;
        obj['groupNumber'] = groupNumber;
        obj['isBarred'] = isBarred;
        obj['name'] = name;
        obj['number'] = number;
    }

    /**
     * Constructs a <code>ProjectEmployee</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectEmployee} obj Optional instance to populate.
     * @return {module:model/ProjectEmployee} The populated <code>ProjectEmployee</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectEmployee();

            if (data.hasOwnProperty('address')) {
                obj['address'] = ApiClient.convertToType(data['address'], 'String');
            }
            if (data.hasOwnProperty('canApprove')) {
                obj['canApprove'] = ApiClient.convertToType(data['canApprove'], 'Boolean');
            }
            if (data.hasOwnProperty('canInvoice')) {
                obj['canInvoice'] = ApiClient.convertToType(data['canInvoice'], 'Boolean');
            }
            if (data.hasOwnProperty('city')) {
                obj['city'] = ApiClient.convertToType(data['city'], 'String');
            }
            if (data.hasOwnProperty('costPriceAfter')) {
                obj['costPriceAfter'] = ApiClient.convertToType(data['costPriceAfter'], 'Number');
            }
            if (data.hasOwnProperty('costPriceBefore')) {
                obj['costPriceBefore'] = ApiClient.convertToType(data['costPriceBefore'], 'Number');
            }
            ...
            if (data.hasOwnProperty('employeeType')) {
                obj['employeeType'] = ApiClient.convertToType(data['employeeType'], EmployeeType);
            }
            if (data.hasOwnProperty('groupNumber')) {
                obj['groupNumber'] = ApiClient.convertToType(data['groupNumber'], 'Number');
            }
            if (data.hasOwnProperty('isBarred')) {
                obj['isBarred'] = ApiClient.convertToType(data['isBarred'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('salesPriceAfter')) {
                obj['salesPriceAfter'] = ApiClient.convertToType(data['salesPriceAfter'], 'Number');
            }
            if (data.hasOwnProperty('salesPriceBefore')) {
                obj['salesPriceBefore'] = ApiClient.convertToType(data['salesPriceBefore'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectEmployee</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectEmployee</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProjectEmployee.RequiredProperties) {
...
ProjectEmployee.RequiredProperties = ["canApprove", "canInvoice", "groupNumber", "isBarred", "name", "number"];

/**
 * Employee's home address.<p class='filter'>Filterable: eq, ne, lt, lte, gt, gte, in, nin</p><p class='sort'>Sortable: false</p>
 * @member {String} address
 */
ProjectEmployee.prototype['address'] = undefined;
 ...
 * @member {Boolean} canApprove
 */
ProjectEmployee.prototype['canApprove'] = undefined;
 ...
 */
ProjectEmployee.prototype['cutOffDate'] = undefined;
 ...
 * @member {module:model/EmployeeType} employeeType
 */
ProjectEmployee.prototype['employeeType'] = undefined;
 ...
 */
ProjectEmployee.prototype['groupNumber'] = undefined;
 ...
 * @member {Boolean} isBarred
 */
ProjectEmployee.prototype['isBarred'] = undefined;
 ...
 */
ProjectEmployee.prototype['number'] = undefined;
 ...
 */
ProjectEmployee.prototype['objectVersion'] = undefined;
 ...
 * @member {Number} salesPriceAfter
 */
ProjectEmployee.prototype['salesPriceAfter'] = undefined;
 ...
 * @member {Number} salesPriceBefore
 */
ProjectEmployee.prototype['salesPriceBefore'] = undefined;
