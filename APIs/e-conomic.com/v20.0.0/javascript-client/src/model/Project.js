...
class Project {
     ...
     * @param name {String} Name of the project.<p class='filter'>Filterable: eq, ne, lt, lte, gt, gte, in, nin, like</p><p class='sort'>Sortable: false</p>
     * @param projectGroupNumber {Number} The number of the project group that this project belongs.<p class='filter'>Filterable: eq, ne, lt, lte, gt, gte, in, nin</p><p class='sort'>Sortable: false</p>
     */
    constructor(name, projectGroupNumber) { 
        
        Project.initialize(this, name, projectGroupNumber);
    }
     ...
     */
    static initialize(obj, name, projectGroupNumber) { 
        obj['name'] = name;
        obj['projectGroupNumber'] = projectGroupNumber;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('deliveryLocationNumber')) {
                obj['deliveryLocationNumber'] = ApiClient.convertToType(data['deliveryLocationNumber'], 'Number');
            }
            if (data.hasOwnProperty('departmentNumber')) {
                obj['departmentNumber'] = ApiClient.convertToType(data['departmentNumber'], 'Number');
            }
            ...
            if (data.hasOwnProperty('invoicedTotal')) {
                obj['invoicedTotal'] = ApiClient.convertToType(data['invoicedTotal'], 'Number');
            }
            ...
            if (data.hasOwnProperty('isMainProject')) {
                obj['isMainProject'] = ApiClient.convertToType(data['isMainProject'], 'Boolean');
            }
            if (data.hasOwnProperty('isMileageInvoiced')) {
                obj['isMileageInvoiced'] = ApiClient.convertToType(data['isMileageInvoiced'], 'Boolean');
            }
            if (data.hasOwnProperty('lastUpdated')) {
                obj['lastUpdated'] = ApiClient.convertToType(data['lastUpdated'], 'Date');
            }
            if (data.hasOwnProperty('mainProjectNumber')) {
                obj['mainProjectNumber'] = ApiClient.convertToType(data['mainProjectNumber'], 'Number');
            }
            ...
            if (data.hasOwnProperty('otherResponsibleEmployeeNumber')) {
                obj['otherResponsibleEmployeeNumber'] = ApiClient.convertToType(data['otherResponsibleEmployeeNumber'], 'Number');
            }
            if (data.hasOwnProperty('projectGroupNumber')) {
                obj['projectGroupNumber'] = ApiClient.convertToType(data['projectGroupNumber'], 'Number');
            }
            if (data.hasOwnProperty('responsibleEmployeeNumber')) {
                obj['responsibleEmployeeNumber'] = ApiClient.convertToType(data['responsibleEmployeeNumber'], 'Number');
            }
            if (data.hasOwnProperty('salesPrice')) {
                obj['salesPrice'] = ApiClient.convertToType(data['salesPrice'], 'Number');
            }
...
Project.RequiredProperties = ["name", "projectGroupNumber"];
 ...
 */
Project.prototype['closedDate'] = undefined;
 ...
 */
Project.prototype['contactPersonId'] = undefined;
 ...
 */
Project.prototype['costPrice'] = undefined;
 ...
 */
Project.prototype['customerNumber'] = undefined;
 ...
 */
Project.prototype['deliveryDate'] = undefined;
 ...
 * @member {Number} deliveryLocationNumber
 */
Project.prototype['deliveryLocationNumber'] = undefined;
 ...
 * @member {Number} departmentNumber
 */
Project.prototype['departmentNumber'] = undefined;
 ...
 */
Project.prototype['fixedPrice'] = undefined;
 ...
 * @member {Number} invoicedTotal
 */
Project.prototype['invoicedTotal'] = undefined;
 ...
 */
Project.prototype['isBarred'] = undefined;
 ...
 */
Project.prototype['isClosed'] = undefined;
 ...
 * @member {Boolean} isMainProject
 */
Project.prototype['isMainProject'] = undefined;
 ...
 * @member {Boolean} isMileageInvoiced
 */
Project.prototype['isMileageInvoiced'] = undefined;
 ...
 * @member {Number} mainProjectNumber
 */
Project.prototype['mainProjectNumber'] = undefined;
 ...
 */
Project.prototype['mileage'] = undefined;
 ...
 */
Project.prototype['objectVersion'] = undefined;
 ...
 * @member {Number} otherResponsibleEmployeeNumber
 */
Project.prototype['otherResponsibleEmployeeNumber'] = undefined;
 ...
 * @member {Number} projectGroupNumber
 */
Project.prototype['projectGroupNumber'] = undefined;
 ...
 * @member {Number} responsibleEmployeeNumber
 */
Project.prototype['responsibleEmployeeNumber'] = undefined;
 ...
 * @member {Number} salesPrice
 */
Project.prototype['salesPrice'] = undefined;
