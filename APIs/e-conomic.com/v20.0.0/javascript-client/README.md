...
VismaEConomicOpenApi - JavaScript client for visma_e_conomic_open_api
# Changelog
...
```shell
npm install visma_e_conomic_open_api --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your visma_e_conomic_open_api from, and run:
...
```javascript
var VismaEConomicOpenApi = require('visma_e_conomic_open_api');

var defaultClient = VismaEConomicOpenApi.ApiClient.instance;
// Configure API key authorization: X-AgreementGrantToken
var X-AgreementGrantToken = defaultClient.authentications['X-AgreementGrantToken'];
X-AgreementGrantToken.apiKey = "YOUR API KEY"
// Uncomment the following line to set a prefix for the API key, e.g. "Token" (defaults to null)
//X-AgreementGrantToken.apiKeyPrefix['X-AgreementGrantToken'] = "Token"
// Configure API key authorization: X-AppSecretToken
var X-AppSecretToken = defaultClient.authentications['X-AppSecretToken'];
X-AppSecretToken.apiKey = "YOUR API KEY"
// Uncomment the following line to set a prefix for the API key, e.g. "Token" (defaults to null)
//X-AppSecretToken.apiKeyPrefix['X-AppSecretToken'] = "Token"

var api = new VismaEConomicOpenApi.ActivitiesApi()
var opts = {
...
api.createActivity(opts, callback);
...
------------ | ------------- | ------------- | -------------
*VismaEConomicOpenApi.ActivitiesApi* | [**createActivity**](docs/ActivitiesApi.md#createActivity) | **POST** /activities | Create a single Activity
*VismaEConomicOpenApi.ActivitiesApi* | [**getActivityById**](docs/ActivitiesApi.md#getActivityById) | **GET** /activities/{number} | Retrieve single Activity
*VismaEConomicOpenApi.ActivitiesApi* | [**getAllActivities**](docs/ActivitiesApi.md#getAllActivities) | **GET** /activities | Retrieve all Activities
*VismaEConomicOpenApi.ActivitiesApi* | [**getAllowedActivities**](docs/ActivitiesApi.md#getAllowedActivities) | **GET** /activities/allowed | Retrieve allowed activities
*VismaEConomicOpenApi.ActivitiesApi* | [**getNumberOfActivities**](docs/ActivitiesApi.md#getNumberOfActivities) | **GET** /activities/count | Retrieve the number of Activities
*VismaEConomicOpenApi.ActivitiesApi* | [**getPageOfActivities**](docs/ActivitiesApi.md#getPageOfActivities) | **GET** /activities/paged | Retrieve a page of Activities
*VismaEConomicOpenApi.ActivitiesApi* | [**updateActivity**](docs/ActivitiesApi.md#updateActivity) | **PUT** /activities | Update a single Activity
*VismaEConomicOpenApi.ActivityGroupsApi* | [**createActivityGroup**](docs/ActivityGroupsApi.md#createActivityGroup) | **POST** /activitygroups | Create a single Activity Group
*VismaEConomicOpenApi.ActivityGroupsApi* | [**getActivityGroupById**](docs/ActivityGroupsApi.md#getActivityGroupById) | **GET** /activitygroups/{number} | Retrieve single Activity Group
*VismaEConomicOpenApi.ActivityGroupsApi* | [**getAllActivityGroups**](docs/ActivityGroupsApi.md#getAllActivityGroups) | **GET** /activitygroups | Retrieve all Activity Groups
*VismaEConomicOpenApi.ActivityGroupsApi* | [**getNumberOfActivityGroups**](docs/ActivityGroupsApi.md#getNumberOfActivityGroups) | **GET** /activitygroups/count | Retrieve the number of Activity Groups
*VismaEConomicOpenApi.ActivityGroupsApi* | [**getPageOfActivityGroups**](docs/ActivityGroupsApi.md#getPageOfActivityGroups) | **GET** /activitygroups/paged | Retrieve a page of Activity Groups
*VismaEConomicOpenApi.CostTypeGroupsApi* | [**getAllCostTypeGroups**](docs/CostTypeGroupsApi.md#getAllCostTypeGroups) | **GET** /costtypegroups | Retrieve all Cost Type Groups
*VismaEConomicOpenApi.CostTypeGroupsApi* | [**getCostTypeGroupById**](docs/CostTypeGroupsApi.md#getCostTypeGroupById) | **GET** /costtypegroups/{number} | Retrieve single Cost Type Group
*VismaEConomicOpenApi.CostTypeGroupsApi* | [**getNumberOfCostTypeGroups**](docs/CostTypeGroupsApi.md#getNumberOfCostTypeGroups) | **GET** /costtypegroups/count | Retrieve the number of Cost Type Groups
*VismaEConomicOpenApi.CostTypeGroupsApi* | [**getPageOfCostTypeGroups**](docs/CostTypeGroupsApi.md#getPageOfCostTypeGroups) | **GET** /costtypegroups/paged | Retrieve a page of Cost Type Groups
*VismaEConomicOpenApi.CostTypesApi* | [**getAllCostTypes**](docs/CostTypesApi.md#getAllCostTypes) | **GET** /costtypes | Retrieve all Cost Types
*VismaEConomicOpenApi.CostTypesApi* | [**getCostTypeById**](docs/CostTypesApi.md#getCostTypeById) | **GET** /costtypes/{number} | Retrieve single Cost Type
*VismaEConomicOpenApi.CostTypesApi* | [**getNumberOfCostTypes**](docs/CostTypesApi.md#getNumberOfCostTypes) | **GET** /costtypes/count | Retrieve the number of Cost Types
*VismaEConomicOpenApi.CostTypesApi* | [**getPageOfCostTypes**](docs/CostTypesApi.md#getPageOfCostTypes) | **GET** /costtypes/paged | Retrieve a page of Cost Types
*VismaEConomicOpenApi.EmployeeGroupsApi* | [**createEmployeeGroup**](docs/EmployeeGroupsApi.md#createEmployeeGroup) | **POST** /employeegroups | Create a single Employee group
*VismaEConomicOpenApi.EmployeeGroupsApi* | [**deleteEmployeeGroupById**](docs/EmployeeGroupsApi.md#deleteEmployeeGroupById) | **DELETE** /employeegroups/{number} | Delete single Employee group
*VismaEConomicOpenApi.EmployeeGroupsApi* | [**getAllEmployeeGroups**](docs/EmployeeGroupsApi.md#getAllEmployeeGroups) | **GET** /employeegroups | Retrieve all Employee groups
*VismaEConomicOpenApi.EmployeeGroupsApi* | [**getEmployeeGroupById**](docs/EmployeeGroupsApi.md#getEmployeeGroupById) | **GET** /employeegroups/{number} | Retrieve single Employee group
*VismaEConomicOpenApi.EmployeeGroupsApi* | [**getNumberOfEmployeeGroups**](docs/EmployeeGroupsApi.md#getNumberOfEmployeeGroups) | **GET** /employeegroups/count | Retrieve the number of Employee groups
*VismaEConomicOpenApi.EmployeeGroupsApi* | [**getPageOfEmployeeGroups**](docs/EmployeeGroupsApi.md#getPageOfEmployeeGroups) | **GET** /employeegroups/paged | Retrieve a page of Employee groups
*VismaEConomicOpenApi.EmployeeGroupsApi* | [**updateEmployeeGroup**](docs/EmployeeGroupsApi.md#updateEmployeeGroup) | **PUT** /employeegroups | Update a single Employee group
*VismaEConomicOpenApi.EmployeesApi* | [**createEmployee**](docs/EmployeesApi.md#createEmployee) | **POST** /employees | Create a single Employee
*VismaEConomicOpenApi.EmployeesApi* | [**deleteEmployeeById**](docs/EmployeesApi.md#deleteEmployeeById) | **DELETE** /employees/{number} | Delete single Employee
*VismaEConomicOpenApi.EmployeesApi* | [**getAllEmployees**](docs/EmployeesApi.md#getAllEmployees) | **GET** /employees | Retrieve all Employees
*VismaEConomicOpenApi.EmployeesApi* | [**getEmployeeById**](docs/EmployeesApi.md#getEmployeeById) | **GET** /employees/{number} | Retrieve single Employee
*VismaEConomicOpenApi.EmployeesApi* | [**getNumberOfEmployees**](docs/EmployeesApi.md#getNumberOfEmployees) | **GET** /employees/count | Retrieve the number of Employees
*VismaEConomicOpenApi.EmployeesApi* | [**getPageOfEmployees**](docs/EmployeesApi.md#getPageOfEmployees) | **GET** /employees/paged | Retrieve a page of Employees
*VismaEConomicOpenApi.EmployeesApi* | [**updateEmployee**](docs/EmployeesApi.md#updateEmployee) | **PUT** /employees | Update a single Employee
*VismaEConomicOpenApi.MileageEntriesApi* | [**approveMileageEntries_0**](docs/MileageEntriesApi.md#approveMileageEntries_0) | **POST** /mileages/approve | Approve a list of Mileage entries
*VismaEConomicOpenApi.MileageEntriesApi* | [**createMileage**](docs/MileageEntriesApi.md#createMileage) | **POST** /mileages | Create a single Mileage entry
*VismaEConomicOpenApi.MileageEntriesApi* | [**deleteMileageById**](docs/MileageEntriesApi.md#deleteMileageById) | **DELETE** /mileages/{number} | Delete single Mileage entry
*VismaEConomicOpenApi.MileageEntriesApi* | [**getAllMileageEntries**](docs/MileageEntriesApi.md#getAllMileageEntries) | **GET** /mileages | Retrieve all Mileage entries
*VismaEConomicOpenApi.MileageEntriesApi* | [**getMileageById**](docs/MileageEntriesApi.md#getMileageById) | **GET** /mileages/{number} | Retrieve single Mileage entry
*VismaEConomicOpenApi.MileageEntriesApi* | [**getNumberOfMileageEntries**](docs/MileageEntriesApi.md#getNumberOfMileageEntries) | **GET** /mileages/count | Retrieve the number of Mileage entries
*VismaEConomicOpenApi.MileageEntriesApi* | [**getPageOfMileageEntries**](docs/MileageEntriesApi.md#getPageOfMileageEntries) | **GET** /mileages/paged | Retrieve a page of Mileage entries
*VismaEConomicOpenApi.MileageEntriesApi* | [**updateMileage**](docs/MileageEntriesApi.md#updateMileage) | **PUT** /mileages | Update a single Mileage entry
*VismaEConomicOpenApi.MileageEntryPricesApi* | [**getAllMileageEntryPrices**](docs/MileageEntryPricesApi.md#getAllMileageEntryPrices) | **GET** /mileageprices | Retrieve all Mileage entry prices
*VismaEConomicOpenApi.MileageEntryPricesApi* | [**getMileagePricesById**](docs/MileageEntryPricesApi.md#getMileagePricesById) | **GET** /mileageprices/{number} | Retrieve single Mileage entry prices
*VismaEConomicOpenApi.MileageEntryPricesApi* | [**getPageOfMileageEntryPrices**](docs/MileageEntryPricesApi.md#getPageOfMileageEntryPrices) | **GET** /mileageprices/paged | Retrieve a page of Mileage entry prices
*VismaEConomicOpenApi.MileagesApi* | [**approveMileageEntries**](docs/MileagesApi.md#approveMileageEntries) | **POST** /mileages/approve | Approve a list of Mileage entries
*VismaEConomicOpenApi.ProjectActivitiesApi* | [**createProjectActivity**](docs/ProjectActivitiesApi.md#createProjectActivity) | **POST** /project-activities | Create a single Project Activity
*VismaEConomicOpenApi.ProjectActivitiesApi* | [**deleteProjectActivityById**](docs/ProjectActivitiesApi.md#deleteProjectActivityById) | **DELETE** /project-activities/{number} | Delete single Project Activity
*VismaEConomicOpenApi.ProjectActivitiesApi* | [**getAllProjectActivities**](docs/ProjectActivitiesApi.md#getAllProjectActivities) | **GET** /project-activities | Retrieve all Project Activities
*VismaEConomicOpenApi.ProjectActivitiesApi* | [**getNumberOfProjectActivities**](docs/ProjectActivitiesApi.md#getNumberOfProjectActivities) | **GET** /project-activities/count | Retrieve the number of Project Activities
*VismaEConomicOpenApi.ProjectActivitiesApi* | [**getPageOfProjectActivities**](docs/ProjectActivitiesApi.md#getPageOfProjectActivities) | **GET** /project-activities/paged | Retrieve a page of Project Activities
*VismaEConomicOpenApi.ProjectActivitiesApi* | [**getProjectActivityById**](docs/ProjectActivitiesApi.md#getProjectActivityById) | **GET** /project-activities/{number} | Retrieve single Project Activity
*VismaEConomicOpenApi.ProjectActivitiesApi* | [**updateProjectActivity**](docs/ProjectActivitiesApi.md#updateProjectActivity) | **PUT** /project-activities | Update a single Project Activity
*VismaEConomicOpenApi.ProjectCustomersApi* | [**getAllProjectCustomers**](docs/ProjectCustomersApi.md#getAllProjectCustomers) | **GET** /project-customers | Retrieve all Project Customers
*VismaEConomicOpenApi.ProjectCustomersApi* | [**getNumberOfProjectCustomers**](docs/ProjectCustomersApi.md#getNumberOfProjectCustomers) | **GET** /project-customers/count | Retrieve the number of Project Customers
*VismaEConomicOpenApi.ProjectCustomersApi* | [**getPageOfProjectCustomers**](docs/ProjectCustomersApi.md#getPageOfProjectCustomers) | **GET** /project-customers/paged | Retrieve a page of Project Customers
*VismaEConomicOpenApi.ProjectCustomersApi* | [**getProjectCustomerById**](docs/ProjectCustomersApi.md#getProjectCustomerById) | **GET** /project-customers/{number} | Retrieve single Project Customer
*VismaEConomicOpenApi.ProjectEmployeeGroupsApi* | [**createProjectEmployeeGroup**](docs/ProjectEmployeeGroupsApi.md#createProjectEmployeeGroup) | **POST** /project-employeegroups | Create a single Project employee group
*VismaEConomicOpenApi.ProjectEmployeeGroupsApi* | [**deleteProjectEmployeeGroupById**](docs/ProjectEmployeeGroupsApi.md#deleteProjectEmployeeGroupById) | **DELETE** /project-employeegroups/{number} | Delete single Project employee group
*VismaEConomicOpenApi.ProjectEmployeeGroupsApi* | [**getAllProjectEmployeeGroups**](docs/ProjectEmployeeGroupsApi.md#getAllProjectEmployeeGroups) | **GET** /project-employeegroups | Retrieve all Project employee groups
*VismaEConomicOpenApi.ProjectEmployeeGroupsApi* | [**getNumberOfProjectEmployeeGroups**](docs/ProjectEmployeeGroupsApi.md#getNumberOfProjectEmployeeGroups) | **GET** /project-employeegroups/count | Retrieve the number of Project employee groups
*VismaEConomicOpenApi.ProjectEmployeeGroupsApi* | [**getPageOfProjectEmployeeGroups**](docs/ProjectEmployeeGroupsApi.md#getPageOfProjectEmployeeGroups) | **GET** /project-employeegroups/paged | Retrieve a page of Project employee groups
*VismaEConomicOpenApi.ProjectEmployeeGroupsApi* | [**getProjectEmployeeGroupById**](docs/ProjectEmployeeGroupsApi.md#getProjectEmployeeGroupById) | **GET** /project-employeegroups/{number} | Retrieve single Project employee group
*VismaEConomicOpenApi.ProjectEmployeeGroupsApi* | [**updateProjectEmployeeGroup**](docs/ProjectEmployeeGroupsApi.md#updateProjectEmployeeGroup) | **PUT** /project-employeegroups | Update a single Project employee group
*VismaEConomicOpenApi.ProjectEmployeesApi* | [**createProjectEmployee**](docs/ProjectEmployeesApi.md#createProjectEmployee) | **POST** /project-employees | Create a single Project employee
*VismaEConomicOpenApi.ProjectEmployeesApi* | [**deleteProjectEmployeeById**](docs/ProjectEmployeesApi.md#deleteProjectEmployeeById) | **DELETE** /project-employees/{number} | Delete single Project employee
*VismaEConomicOpenApi.ProjectEmployeesApi* | [**getAllProjectEmployees**](docs/ProjectEmployeesApi.md#getAllProjectEmployees) | **GET** /project-employees | Retrieve all Project employees
*VismaEConomicOpenApi.ProjectEmployeesApi* | [**getNumberOfProjectEmployees**](docs/ProjectEmployeesApi.md#getNumberOfProjectEmployees) | **GET** /project-employees/count | Retrieve the number of Project employees
*VismaEConomicOpenApi.ProjectEmployeesApi* | [**getPageOfProjectEmployees**](docs/ProjectEmployeesApi.md#getPageOfProjectEmployees) | **GET** /project-employees/paged | Retrieve a page of Project employees
*VismaEConomicOpenApi.ProjectEmployeesApi* | [**getProjectEmployeeById**](docs/ProjectEmployeesApi.md#getProjectEmployeeById) | **GET** /project-employees/{number} | Retrieve single Project employee
*VismaEConomicOpenApi.ProjectEmployeesApi* | [**updateProjectEmployee**](docs/ProjectEmployeesApi.md#updateProjectEmployee) | **PUT** /project-employees | Update a single Project employee
*VismaEConomicOpenApi.ProjectGroupsApi* | [**createProjectGroup**](docs/ProjectGroupsApi.md#createProjectGroup) | **POST** /projectgroups | Create a single Project Group
*VismaEConomicOpenApi.ProjectGroupsApi* | [**getAllProjectGroups**](docs/ProjectGroupsApi.md#getAllProjectGroups) | **GET** /projectgroups | Retrieve all Project Groups
*VismaEConomicOpenApi.ProjectGroupsApi* | [**getNumberOfProjectGroups**](docs/ProjectGroupsApi.md#getNumberOfProjectGroups) | **GET** /projectgroups/count | Retrieve the number of Project Groups
*VismaEConomicOpenApi.ProjectGroupsApi* | [**getPageOfProjectGroups**](docs/ProjectGroupsApi.md#getPageOfProjectGroups) | **GET** /projectgroups/paged | Retrieve a page of Project Groups
*VismaEConomicOpenApi.ProjectGroupsApi* | [**getProjectGroupById**](docs/ProjectGroupsApi.md#getProjectGroupById) | **GET** /projectgroups/{number} | Retrieve single Project Group
*VismaEConomicOpenApi.ProjectStatusesApi* | [**getAllProjectStatuses**](docs/ProjectStatusesApi.md#getAllProjectStatuses) | **GET** /projectstatuses | Retrieve all Project Statuses
*VismaEConomicOpenApi.ProjectStatusesApi* | [**getNumberOfProjectStatuses**](docs/ProjectStatusesApi.md#getNumberOfProjectStatuses) | **GET** /projectstatuses/count | Retrieve the number of Project Statuses
*VismaEConomicOpenApi.ProjectStatusesApi* | [**getPageOfProjectStatuses**](docs/ProjectStatusesApi.md#getPageOfProjectStatuses) | **GET** /projectstatuses/paged | Retrieve a page of Project Statuses
*VismaEConomicOpenApi.ProjectStatusesApi* | [**getProjectStatusById**](docs/ProjectStatusesApi.md#getProjectStatusById) | **GET** /projectstatuses/{number} | Retrieve single Project Status
*VismaEConomicOpenApi.ProjectsApi* | [**createProject**](docs/ProjectsApi.md#createProject) | **POST** /projects | Create a single Project
*VismaEConomicOpenApi.ProjectsApi* | [**deleteProjectById**](docs/ProjectsApi.md#deleteProjectById) | **DELETE** /projects/{number} | Delete single Project
*VismaEConomicOpenApi.ProjectsApi* | [**getAllProjects**](docs/ProjectsApi.md#getAllProjects) | **GET** /projects | Retrieve all Projects
*VismaEConomicOpenApi.ProjectsApi* | [**getNumberOfProjects**](docs/ProjectsApi.md#getNumberOfProjects) | **GET** /projects/count | Retrieve the number of Projects
*VismaEConomicOpenApi.ProjectsApi* | [**getPageOfProjects**](docs/ProjectsApi.md#getPageOfProjects) | **GET** /projects/paged | Retrieve a page of Projects
*VismaEConomicOpenApi.ProjectsApi* | [**getPagedListOfProjectUnderEmployee**](docs/ProjectsApi.md#getPagedListOfProjectUnderEmployee) | **GET** /projects/allowed | Retrieve the allowed projects that employee can register an entry on.
*VismaEConomicOpenApi.ProjectsApi* | [**getProjectById**](docs/ProjectsApi.md#getProjectById) | **GET** /projects/{number} | Retrieve single Project
*VismaEConomicOpenApi.ProjectsApi* | [**updateProject**](docs/ProjectsApi.md#updateProject) | **PUT** /projects | Update a single Project
*VismaEConomicOpenApi.TimeEntriesApi* | [**approveTimeEntries**](docs/TimeEntriesApi.md#approveTimeEntries) | **POST** /timeentries/approve | Approve a list of Time entries
*VismaEConomicOpenApi.TimeEntriesApi* | [**approveTimeEntries_0**](docs/TimeEntriesApi.md#approveTimeEntries_0) | **POST** /timeentries/approve | Approve a list of Time entries
*VismaEConomicOpenApi.TimeEntriesApi* | [**createTimeEntry**](docs/TimeEntriesApi.md#createTimeEntry) | **POST** /timeentries | Create a single Time entry
*VismaEConomicOpenApi.TimeEntriesApi* | [**deleteTimeEntryById**](docs/TimeEntriesApi.md#deleteTimeEntryById) | **DELETE** /timeentries/{number} | Delete single Time entry
*VismaEConomicOpenApi.TimeEntriesApi* | [**getAllTimeEntries**](docs/TimeEntriesApi.md#getAllTimeEntries) | **GET** /timeentries | Retrieve all Time entries
*VismaEConomicOpenApi.TimeEntriesApi* | [**getNumberOfTimeEntries**](docs/TimeEntriesApi.md#getNumberOfTimeEntries) | **GET** /timeentries/count | Retrieve the number of Time entries
*VismaEConomicOpenApi.TimeEntriesApi* | [**getPageOfTimeEntries**](docs/TimeEntriesApi.md#getPageOfTimeEntries) | **GET** /timeentries/paged | Retrieve a page of Time entries
*VismaEConomicOpenApi.TimeEntriesApi* | [**getTimeEntryById**](docs/TimeEntriesApi.md#getTimeEntryById) | **GET** /timeentries/{number} | Retrieve single Time entry
*VismaEConomicOpenApi.TimeEntriesApi* | [**updateTimeEntry**](docs/TimeEntriesApi.md#updateTimeEntry) | **PUT** /timeentries | Update a single Time entry
*VismaEConomicOpenApi.TimeEntryPricesApi* | [**getAllTimeEntryPrices**](docs/TimeEntryPricesApi.md#getAllTimeEntryPrices) | **GET** /timeentryprices | Retrieve all Time entry prices
*VismaEConomicOpenApi.TimeEntryPricesApi* | [**getPageOfTimeEntryPrices**](docs/TimeEntryPricesApi.md#getPageOfTimeEntryPrices) | **GET** /timeentryprices/paged | Retrieve a page of Time entry prices
*VismaEConomicOpenApi.TimeEntryPricesApi* | [**getTimeEntryPricesById**](docs/TimeEntryPricesApi.md#getTimeEntryPricesById) | **GET** /timeentryprices/{number} | Retrieve single Time entry prices


## Documentation for Models

 - [VismaEConomicOpenApi.Activity](docs/Activity.md)
 - [VismaEConomicOpenApi.ActivityCursorResults](docs/ActivityCursorResults.md)
 - [VismaEConomicOpenApi.ActivityGroup](docs/ActivityGroup.md)
 - [VismaEConomicOpenApi.ActivityGroupCursorResults](docs/ActivityGroupCursorResults.md)
 - [VismaEConomicOpenApi.ActivityGroupType](docs/ActivityGroupType.md)
 - [VismaEConomicOpenApi.CostGroupType](docs/CostGroupType.md)
 - [VismaEConomicOpenApi.CostType](docs/CostType.md)
 - [VismaEConomicOpenApi.CostTypeCursorResults](docs/CostTypeCursorResults.md)
 - [VismaEConomicOpenApi.CostTypeGroup](docs/CostTypeGroup.md)
 - [VismaEConomicOpenApi.CostTypeGroupCursorResults](docs/CostTypeGroupCursorResults.md)
 - [VismaEConomicOpenApi.CreatedResult](docs/CreatedResult.md)
 - [VismaEConomicOpenApi.Employee](docs/Employee.md)
 - [VismaEConomicOpenApi.EmployeeCursorResults](docs/EmployeeCursorResults.md)
 - [VismaEConomicOpenApi.EmployeeGroup](docs/EmployeeGroup.md)
 - [VismaEConomicOpenApi.EmployeeGroupCursorResults](docs/EmployeeGroupCursorResults.md)
 - [VismaEConomicOpenApi.EmployeeType](docs/EmployeeType.md)
 - [VismaEConomicOpenApi.Error](docs/Error.md)
 - [VismaEConomicOpenApi.Mileage](docs/Mileage.md)
 - [VismaEConomicOpenApi.MileageCursorResults](docs/MileageCursorResults.md)
 - [VismaEConomicOpenApi.MileageNumbersCollection](docs/MileageNumbersCollection.md)
 - [VismaEConomicOpenApi.MileagePrices](docs/MileagePrices.md)
 - [VismaEConomicOpenApi.MileagePricesCursorResults](docs/MileagePricesCursorResults.md)
 - [VismaEConomicOpenApi.OngoingAccountType](docs/OngoingAccountType.md)
 - [VismaEConomicOpenApi.Project](docs/Project.md)
 - [VismaEConomicOpenApi.ProjectActivity](docs/ProjectActivity.md)
 - [VismaEConomicOpenApi.ProjectActivityCursorResults](docs/ProjectActivityCursorResults.md)
 - [VismaEConomicOpenApi.ProjectCursorResults](docs/ProjectCursorResults.md)
 - [VismaEConomicOpenApi.ProjectCustomer](docs/ProjectCustomer.md)
 - [VismaEConomicOpenApi.ProjectCustomerCursorResults](docs/ProjectCustomerCursorResults.md)
 - [VismaEConomicOpenApi.ProjectEmployee](docs/ProjectEmployee.md)
 - [VismaEConomicOpenApi.ProjectEmployeeCursorResults](docs/ProjectEmployeeCursorResults.md)
 - [VismaEConomicOpenApi.ProjectEmployeeGroup](docs/ProjectEmployeeGroup.md)
 - [VismaEConomicOpenApi.ProjectEmployeeGroupCursorResults](docs/ProjectEmployeeGroupCursorResults.md)
 - [VismaEConomicOpenApi.ProjectGroup](docs/ProjectGroup.md)
 - [VismaEConomicOpenApi.ProjectGroupCursorResults](docs/ProjectGroupCursorResults.md)
 - [VismaEConomicOpenApi.ProjectGroupType](docs/ProjectGroupType.md)
 - [VismaEConomicOpenApi.ProjectStatus](docs/ProjectStatus.md)
 - [VismaEConomicOpenApi.ProjectStatusCursorResults](docs/ProjectStatusCursorResults.md)
 - [VismaEConomicOpenApi.ProjectStatusType](docs/ProjectStatusType.md)
 - [VismaEConomicOpenApi.TimeEntry](docs/TimeEntry.md)
 - [VismaEConomicOpenApi.TimeEntryCursorResults](docs/TimeEntryCursorResults.md)
 - [VismaEConomicOpenApi.TimeEntryNumbersCollection](docs/TimeEntryNumbersCollection.md)
 - [VismaEConomicOpenApi.TimeEntryPrices](docs/TimeEntryPrices.md)
 - [VismaEConomicOpenApi.TimeEntryPricesCursorResults](docs/TimeEntryPricesCursorResults.md)
