...
#include "OAIBandwidthSnapshotsApi.h"
...
OAIBandwidthSnapshotsApi::OAIBandwidthSnapshotsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIBandwidthSnapshotsApi::~OAIBandwidthSnapshotsApi() {
}

void OAIBandwidthSnapshotsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getBandwidthSnapshots", defaultConf);
    _serverIndices.insert("getBandwidthSnapshots", 0);
}
...
*/
int OAIBandwidthSnapshotsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIBandwidthSnapshotsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIBandwidthSnapshotsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIBandwidthSnapshotsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIBandwidthSnapshotsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIBandwidthSnapshotsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIBandwidthSnapshotsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIBandwidthSnapshotsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIBandwidthSnapshotsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIBandwidthSnapshotsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBandwidthSnapshotsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBandwidthSnapshotsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIBandwidthSnapshotsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIBandwidthSnapshotsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIBandwidthSnapshotsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIBandwidthSnapshotsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIBandwidthSnapshotsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIBandwidthSnapshotsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIBandwidthSnapshotsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIBandwidthSnapshotsApi::getBandwidthSnapshots(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<qint32> &per_page, const ::OpenAPI::OptionalParam<OAIObject> &sort_by, const ::OpenAPI::OptionalParam<OAIObject> &filter, const ::OpenAPI::OptionalParam<OAIObject> &filter_gt, const ::OpenAPI::OptionalParam<OAIObject> &filter_gteq, const ::OpenAPI::OptionalParam<OAIObject> &filter_lt, const ::OpenAPI::OptionalParam<OAIObject> &filter_lteq) {
    QString fullPath = QString(_serverConfigs["getBandwidthSnapshots"][_serverIndices.value("getBandwidthSnapshots")].URL()+"/bandwidth_snapshots");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBandwidthSnapshotsApi::getBandwidthSnapshotsCallback);
    connect(this, &OAIBandwidthSnapshotsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIBandwidthSnapshotsApi::getBandwidthSnapshotsCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIBandwidthSnapshotEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIBandwidthSnapshotEntity val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getBandwidthSnapshotsSignal(output);
        Q_EMIT getBandwidthSnapshotsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getBandwidthSnapshotsSignalE(output, error_type, error_str);
        Q_EMIT getBandwidthSnapshotsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getBandwidthSnapshotsSignalError(output, error_type, error_str);
        Q_EMIT getBandwidthSnapshotsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBandwidthSnapshotsApi::tokenAvailable(){
