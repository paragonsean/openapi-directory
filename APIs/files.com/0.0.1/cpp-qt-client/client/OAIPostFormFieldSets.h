...
/*
 * OAIPostFormFieldSets.h
 *
 * Create Form Field Set
 */

#ifndef OAIPostFormFieldSets_H
#define OAIPostFormFieldSets_H
...
class OAIPostFormFieldSets : public OAIObject {
public:
    OAIPostFormFieldSets();
    OAIPostFormFieldSets(QString json);
    ~OAIPostFormFieldSets() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostFormFieldSets)

#endif // OAIPostFormFieldSets_H
