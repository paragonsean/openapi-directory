...
#include "OAIAs2OutgoingMessagesApi.h"
...
OAIAs2OutgoingMessagesApi::OAIAs2OutgoingMessagesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIAs2OutgoingMessagesApi::~OAIAs2OutgoingMessagesApi() {
}

void OAIAs2OutgoingMessagesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getAs2OutgoingMessages", defaultConf);
    _serverIndices.insert("getAs2OutgoingMessages", 0);
}
...
*/
int OAIAs2OutgoingMessagesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIAs2OutgoingMessagesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIAs2OutgoingMessagesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIAs2OutgoingMessagesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIAs2OutgoingMessagesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIAs2OutgoingMessagesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIAs2OutgoingMessagesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIAs2OutgoingMessagesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIAs2OutgoingMessagesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIAs2OutgoingMessagesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAs2OutgoingMessagesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAs2OutgoingMessagesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIAs2OutgoingMessagesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIAs2OutgoingMessagesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIAs2OutgoingMessagesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIAs2OutgoingMessagesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIAs2OutgoingMessagesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIAs2OutgoingMessagesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIAs2OutgoingMessagesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIAs2OutgoingMessagesApi::getAs2OutgoingMessages(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<qint32> &per_page, const ::OpenAPI::OptionalParam<OAIObject> &sort_by, const ::OpenAPI::OptionalParam<OAIObject> &filter, const ::OpenAPI::OptionalParam<OAIObject> &filter_gt, const ::OpenAPI::OptionalParam<OAIObject> &filter_gteq, const ::OpenAPI::OptionalParam<OAIObject> &filter_lt, const ::OpenAPI::OptionalParam<OAIObject> &filter_lteq, const ::OpenAPI::OptionalParam<qint32> &as2_partner_id) {
    QString fullPath = QString(_serverConfigs["getAs2OutgoingMessages"][_serverIndices.value("getAs2OutgoingMessages")].URL()+"/as2_outgoing_messages");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAs2OutgoingMessagesApi::getAs2OutgoingMessagesCallback);
    connect(this, &OAIAs2OutgoingMessagesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIAs2OutgoingMessagesApi::getAs2OutgoingMessagesCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIAs2OutgoingMessageEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIAs2OutgoingMessageEntity val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAs2OutgoingMessagesSignal(output);
        Q_EMIT getAs2OutgoingMessagesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAs2OutgoingMessagesSignalE(output, error_type, error_str);
        Q_EMIT getAs2OutgoingMessagesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAs2OutgoingMessagesSignalError(output, error_type, error_str);
        Q_EMIT getAs2OutgoingMessagesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAs2OutgoingMessagesApi::tokenAvailable(){
