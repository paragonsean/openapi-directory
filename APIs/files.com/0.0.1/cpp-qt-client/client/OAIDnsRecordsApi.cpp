...
void OAIDnsRecordsApi::getDnsRecords(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<qint32> &per_page) {
    QString fullPath = QString(_serverConfigs["getDnsRecords"][_serverIndices.value("getDnsRecords")].URL()+"/dns_records");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDnsRecordsApi::getDnsRecordsCallback);
...
void OAIDnsRecordsApi::getDnsRecordsCallback(OAIHttpRequestWorker *worker) {
