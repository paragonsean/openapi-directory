...
OAIInboxUploadsApi::OAIInboxUploadsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIInboxUploadsApi::~OAIInboxUploadsApi() {
}

void OAIInboxUploadsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getInboxUploads", defaultConf);
    _serverIndices.insert("getInboxUploads", 0);
}
...
*/
int OAIInboxUploadsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIInboxUploadsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIInboxUploadsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIInboxUploadsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIInboxUploadsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIInboxUploadsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIInboxUploadsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIInboxUploadsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIInboxUploadsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIInboxUploadsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIInboxUploadsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIInboxUploadsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIInboxUploadsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIInboxUploadsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIInboxUploadsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIInboxUploadsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIInboxUploadsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIInboxUploadsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIInboxUploadsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIInboxUploadsApi::getInboxUploads(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<qint32> &per_page, const ::OpenAPI::OptionalParam<OAIObject> &sort_by, const ::OpenAPI::OptionalParam<OAIObject> &filter, const ::OpenAPI::OptionalParam<OAIObject> &filter_gt, const ::OpenAPI::OptionalParam<OAIObject> &filter_gteq, const ::OpenAPI::OptionalParam<OAIObject> &filter_lt, const ::OpenAPI::OptionalParam<OAIObject> &filter_lteq, const ::OpenAPI::OptionalParam<qint32> &inbox_registration_id, const ::OpenAPI::OptionalParam<qint32> &inbox_id) {
    QString fullPath = QString(_serverConfigs["getInboxUploads"][_serverIndices.value("getInboxUploads")].URL()+"/inbox_uploads");
    ...
    if (inbox_registration_id.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "inbox_registration_id", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("inbox_registration_id")).append(querySuffix).append(QUrl::toPercentEncoding(inbox_registration_id.stringValue()));
    }
    if (inbox_id.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("inbox_id")).append(querySuffix).append(QUrl::toPercentEncoding(inbox_id.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIInboxUploadsApi::getInboxUploadsCallback);
    connect(this, &OAIInboxUploadsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIInboxUploadsApi::getInboxUploadsCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIInboxUploadEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIInboxUploadEntity val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getInboxUploadsSignal(output);
        Q_EMIT getInboxUploadsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getInboxUploadsSignalE(output, error_type, error_str);
        Q_EMIT getInboxUploadsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getInboxUploadsSignalError(output, error_type, error_str);
        Q_EMIT getInboxUploadsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIInboxUploadsApi::tokenAvailable(){
