...
void OAIAppsApi::getApps(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<qint32> &per_page, const ::OpenAPI::OptionalParam<OAIObject> &sort_by, const ::OpenAPI::OptionalParam<OAIObject> &filter, const ::OpenAPI::OptionalParam<OAIObject> &filter_prefix) {
    QString fullPath = QString(_serverConfigs["getApps"][_serverIndices.value("getApps")].URL()+"/apps");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAppsApi::getAppsCallback);
...
void OAIAppsApi::getAppsCallback(OAIHttpRequestWorker *worker) {
