...
#include "OAIUsageDailySnapshotsApi.h"
...
OAIUsageDailySnapshotsApi::OAIUsageDailySnapshotsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIUsageDailySnapshotsApi::~OAIUsageDailySnapshotsApi() {
}

void OAIUsageDailySnapshotsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getUsageDailySnapshots", defaultConf);
    _serverIndices.insert("getUsageDailySnapshots", 0);
}
...
*/
int OAIUsageDailySnapshotsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIUsageDailySnapshotsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIUsageDailySnapshotsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIUsageDailySnapshotsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIUsageDailySnapshotsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIUsageDailySnapshotsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIUsageDailySnapshotsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIUsageDailySnapshotsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIUsageDailySnapshotsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIUsageDailySnapshotsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIUsageDailySnapshotsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIUsageDailySnapshotsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIUsageDailySnapshotsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIUsageDailySnapshotsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIUsageDailySnapshotsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIUsageDailySnapshotsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIUsageDailySnapshotsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIUsageDailySnapshotsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIUsageDailySnapshotsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIUsageDailySnapshotsApi::getUsageDailySnapshots(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<qint32> &per_page, const ::OpenAPI::OptionalParam<OAIObject> &sort_by, const ::OpenAPI::OptionalParam<OAIObject> &filter, const ::OpenAPI::OptionalParam<OAIObject> &filter_gt, const ::OpenAPI::OptionalParam<OAIObject> &filter_gteq, const ::OpenAPI::OptionalParam<OAIObject> &filter_lt, const ::OpenAPI::OptionalParam<OAIObject> &filter_lteq) {
    QString fullPath = QString(_serverConfigs["getUsageDailySnapshots"][_serverIndices.value("getUsageDailySnapshots")].URL()+"/usage_daily_snapshots");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsageDailySnapshotsApi::getUsageDailySnapshotsCallback);
    connect(this, &OAIUsageDailySnapshotsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIUsageDailySnapshotsApi::getUsageDailySnapshotsCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIUsageDailySnapshotEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIUsageDailySnapshotEntity val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getUsageDailySnapshotsSignal(output);
        Q_EMIT getUsageDailySnapshotsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getUsageDailySnapshotsSignalE(output, error_type, error_str);
        Q_EMIT getUsageDailySnapshotsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getUsageDailySnapshotsSignalError(output, error_type, error_str);
        Q_EMIT getUsageDailySnapshotsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUsageDailySnapshotsApi::tokenAvailable(){
