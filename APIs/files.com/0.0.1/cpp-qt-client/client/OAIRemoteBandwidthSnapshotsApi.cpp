...
#include "OAIRemoteBandwidthSnapshotsApi.h"
...
OAIRemoteBandwidthSnapshotsApi::OAIRemoteBandwidthSnapshotsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIRemoteBandwidthSnapshotsApi::~OAIRemoteBandwidthSnapshotsApi() {
}

void OAIRemoteBandwidthSnapshotsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getRemoteBandwidthSnapshots", defaultConf);
    _serverIndices.insert("getRemoteBandwidthSnapshots", 0);
}
...
*/
int OAIRemoteBandwidthSnapshotsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIRemoteBandwidthSnapshotsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIRemoteBandwidthSnapshotsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIRemoteBandwidthSnapshotsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIRemoteBandwidthSnapshotsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIRemoteBandwidthSnapshotsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIRemoteBandwidthSnapshotsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIRemoteBandwidthSnapshotsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIRemoteBandwidthSnapshotsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIRemoteBandwidthSnapshotsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIRemoteBandwidthSnapshotsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIRemoteBandwidthSnapshotsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIRemoteBandwidthSnapshotsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIRemoteBandwidthSnapshotsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIRemoteBandwidthSnapshotsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIRemoteBandwidthSnapshotsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIRemoteBandwidthSnapshotsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIRemoteBandwidthSnapshotsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIRemoteBandwidthSnapshotsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIRemoteBandwidthSnapshotsApi::getRemoteBandwidthSnapshots(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<qint32> &per_page, const ::OpenAPI::OptionalParam<OAIObject> &sort_by, const ::OpenAPI::OptionalParam<OAIObject> &filter, const ::OpenAPI::OptionalParam<OAIObject> &filter_gt, const ::OpenAPI::OptionalParam<OAIObject> &filter_gteq, const ::OpenAPI::OptionalParam<OAIObject> &filter_lt, const ::OpenAPI::OptionalParam<OAIObject> &filter_lteq) {
    QString fullPath = QString(_serverConfigs["getRemoteBandwidthSnapshots"][_serverIndices.value("getRemoteBandwidthSnapshots")].URL()+"/remote_bandwidth_snapshots");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRemoteBandwidthSnapshotsApi::getRemoteBandwidthSnapshotsCallback);
    connect(this, &OAIRemoteBandwidthSnapshotsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIRemoteBandwidthSnapshotsApi::getRemoteBandwidthSnapshotsCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIRemoteBandwidthSnapshotEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIRemoteBandwidthSnapshotEntity val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getRemoteBandwidthSnapshotsSignal(output);
        Q_EMIT getRemoteBandwidthSnapshotsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getRemoteBandwidthSnapshotsSignalE(output, error_type, error_str);
        Q_EMIT getRemoteBandwidthSnapshotsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getRemoteBandwidthSnapshotsSignalError(output, error_type, error_str);
        Q_EMIT getRemoteBandwidthSnapshotsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIRemoteBandwidthSnapshotsApi::tokenAvailable(){
