...
#include "OAIBundleDownloadsApi.h"
...
OAIBundleDownloadsApi::OAIBundleDownloadsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIBundleDownloadsApi::~OAIBundleDownloadsApi() {
}

void OAIBundleDownloadsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getBundleDownloads", defaultConf);
    _serverIndices.insert("getBundleDownloads", 0);
}
...
*/
int OAIBundleDownloadsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIBundleDownloadsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIBundleDownloadsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIBundleDownloadsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIBundleDownloadsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIBundleDownloadsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIBundleDownloadsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIBundleDownloadsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIBundleDownloadsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIBundleDownloadsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBundleDownloadsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBundleDownloadsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIBundleDownloadsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIBundleDownloadsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIBundleDownloadsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIBundleDownloadsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIBundleDownloadsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIBundleDownloadsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIBundleDownloadsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIBundleDownloadsApi::getBundleDownloads(const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<qint32> &per_page, const ::OpenAPI::OptionalParam<OAIObject> &sort_by, const ::OpenAPI::OptionalParam<OAIObject> &filter, const ::OpenAPI::OptionalParam<OAIObject> &filter_gt, const ::OpenAPI::OptionalParam<OAIObject> &filter_gteq, const ::OpenAPI::OptionalParam<OAIObject> &filter_lt, const ::OpenAPI::OptionalParam<OAIObject> &filter_lteq, const ::OpenAPI::OptionalParam<qint32> &bundle_id, const ::OpenAPI::OptionalParam<qint32> &bundle_registration_id) {
    QString fullPath = QString(_serverConfigs["getBundleDownloads"][_serverIndices.value("getBundleDownloads")].URL()+"/bundle_downloads");
    ...
    if (bundle_registration_id.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "bundle_registration_id", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("bundle_registration_id")).append(querySuffix).append(QUrl::toPercentEncoding(bundle_registration_id.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBundleDownloadsApi::getBundleDownloadsCallback);
    connect(this, &OAIBundleDownloadsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIBundleDownloadsApi::getBundleDownloadsCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIBundleDownloadEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIBundleDownloadEntity val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getBundleDownloadsSignal(output);
        Q_EMIT getBundleDownloadsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getBundleDownloadsSignalE(output, error_type, error_str);
        Q_EMIT getBundleDownloadsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getBundleDownloadsSignalError(output, error_type, error_str);
        Q_EMIT getBundleDownloadsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBundleDownloadsApi::tokenAvailable(){
