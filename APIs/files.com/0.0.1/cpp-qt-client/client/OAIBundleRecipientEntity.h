...
/*
 * OAIBundleRecipientEntity.h
 *
 * List Bundle Recipients
 */

#ifndef OAIBundleRecipientEntity_H
#define OAIBundleRecipientEntity_H
...
class OAIBundleRecipientEntity : public OAIObject {
public:
    OAIBundleRecipientEntity();
    OAIBundleRecipientEntity(QString json);
    ~OAIBundleRecipientEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBundleRecipientEntity)

#endif // OAIBundleRecipientEntity_H
