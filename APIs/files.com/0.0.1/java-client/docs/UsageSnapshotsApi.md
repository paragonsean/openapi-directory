...
<a id="getUsageSnapshots"></a>
# **getUsageSnapshots**
> List&lt;UsageSnapshotEntity&gt; getUsageSnapshots(cursor, perPage)
...
import org.openapitools.client.api.UsageSnapshotsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    UsageSnapshotsApi apiInstance = new UsageSnapshotsApi(defaultClient);
    ...
    try {
      List<UsageSnapshotEntity> result = apiInstance.getUsageSnapshots(cursor, perPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UsageSnapshotsApi#getUsageSnapshots");
...
[**List&lt;UsageSnapshotEntity&gt;**](UsageSnapshotEntity.md)
