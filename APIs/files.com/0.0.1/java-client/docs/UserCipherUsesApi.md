...
<a id="getUserCipherUses"></a>
# **getUserCipherUses**
> List&lt;UserCipherUseEntity&gt; getUserCipherUses(userId, cursor, perPage)
...
import org.openapitools.client.api.UserCipherUsesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    UserCipherUsesApi apiInstance = new UserCipherUsesApi(defaultClient);
    ...
    try {
      List<UserCipherUseEntity> result = apiInstance.getUserCipherUses(userId, cursor, perPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserCipherUsesApi#getUserCipherUses");
