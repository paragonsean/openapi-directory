...
<a id="getBundleDownloads"></a>
# **getBundleDownloads**
> List&lt;BundleDownloadEntity&gt; getBundleDownloads(cursor, perPage, sortBy, filter, filterGt, filterGteq, filterLt, filterLteq, bundleId, bundleRegistrationId)
...
import org.openapitools.client.api.BundleDownloadsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    BundleDownloadsApi apiInstance = new BundleDownloadsApi(defaultClient);
    ...
    Integer bundleRegistrationId = 56; // Integer | BundleRegistration ID
    try {
      List<BundleDownloadEntity> result = apiInstance.getBundleDownloads(cursor, perPage, sortBy, filter, filterGt, filterGteq, filterLt, filterLteq, bundleId, bundleRegistrationId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling BundleDownloadsApi#getBundleDownloads");
...
| **bundleId** | **Integer**| Bundle ID | [optional] |
| **bundleRegistrationId** | **Integer**| BundleRegistration ID | [optional] |

### Return type

[**List&lt;BundleDownloadEntity&gt;**](BundleDownloadEntity.md)
...
|-------------|-------------|------------------|
| **200** | A list of BundleDownloads objects. |  -  |
| **400** | Bad Request |  -  |
| **401** | Unauthorized |  -  |
| **403** | Forbidden |  -  |
| **404** | Not Found |  -  |
