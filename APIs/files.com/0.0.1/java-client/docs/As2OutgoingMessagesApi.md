...
|------------- | ------------- | -------------|
| [**getAs2OutgoingMessages**](As2OutgoingMessagesApi.md#getAs2OutgoingMessages) | **GET** /as2_outgoing_messages | List As2 Outgoing Messages |


<a id="getAs2OutgoingMessages"></a>
# **getAs2OutgoingMessages**
> List&lt;As2OutgoingMessageEntity&gt; getAs2OutgoingMessages(cursor, perPage, sortBy, filter, filterGt, filterGteq, filterLt, filterLteq, as2PartnerId)
...
import org.openapitools.client.api.As2OutgoingMessagesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    As2OutgoingMessagesApi apiInstance = new As2OutgoingMessagesApi(defaultClient);
    ...
    try {
      List<As2OutgoingMessageEntity> result = apiInstance.getAs2OutgoingMessages(cursor, perPage, sortBy, filter, filterGt, filterGteq, filterLt, filterLteq, as2PartnerId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling As2OutgoingMessagesApi#getAs2OutgoingMessages");
...
[**List&lt;As2OutgoingMessageEntity&gt;**](As2OutgoingMessageEntity.md)
...
|-------------|-------------|------------------|
| **200** | A list of As2OutgoingMessages objects. |  -  |
| **400** | Bad Request |  -  |
| **401** | Unauthorized |  -  |
| **403** | Forbidden |  -  |
| **404** | Not Found |  -  |
