...
import org.openapitools.client.api.FileCommentsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    FileCommentsApi apiInstance = new FileCommentsApi(defaultClient);
    Integer id = 56; // Integer | File Comment ID.
    try {
      apiInstance.deleteFileCommentsId(id);
    } catch (ApiException e) {
      System.err.println("Exception when calling FileCommentsApi#deleteFileCommentsId");
...
<a id="fileCommentListForPath"></a>
# **fileCommentListForPath**
> List&lt;FileCommentEntity&gt; fileCommentListForPath(path, cursor, perPage)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<FileCommentEntity> result = apiInstance.fileCommentListForPath(path, cursor, perPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FileCommentsApi#fileCommentListForPath");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**List&lt;FileCommentEntity&gt;**](FileCommentEntity.md)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      FileCommentEntity result = apiInstance.patchFileCommentsId(id, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FileCommentsApi#patchFileCommentsId");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      FileCommentEntity result = apiInstance.postFileComments(body, path);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FileCommentsApi#postFileComments");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
