...
|------------- | ------------- | -------------|
| [**getInboxUploads**](InboxUploadsApi.md#getInboxUploads) | **GET** /inbox_uploads | List Inbox Uploads |


<a id="getInboxUploads"></a>
# **getInboxUploads**
> List&lt;InboxUploadEntity&gt; getInboxUploads(cursor, perPage, sortBy, filter, filterGt, filterGteq, filterLt, filterLteq, inboxRegistrationId, inboxId)
...
import org.openapitools.client.api.InboxUploadsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    InboxUploadsApi apiInstance = new InboxUploadsApi(defaultClient);
    ...
    Object sortBy = null; // Object | If set, sort records by the specified field in either `asc` or `desc` direction (e.g. `sort_by[created_at]=desc`). Valid fields are `created_at`.
    ...
    Integer inboxRegistrationId = 56; // Integer | InboxRegistration ID
    Integer inboxId = 56; // Integer | Inbox ID
    try {
      List<InboxUploadEntity> result = apiInstance.getInboxUploads(cursor, perPage, sortBy, filter, filterGt, filterGteq, filterLt, filterLteq, inboxRegistrationId, inboxId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling InboxUploadsApi#getInboxUploads");
...
| **inboxRegistrationId** | **Integer**| InboxRegistration ID | [optional] |
| **inboxId** | **Integer**| Inbox ID | [optional] |

### Return type

[**List&lt;InboxUploadEntity&gt;**](InboxUploadEntity.md)
...
|-------------|-------------|------------------|
| **200** | A list of InboxUploads objects. |  -  |
| **400** | Bad Request |  -  |
| **401** | Unauthorized |  -  |
| **403** | Forbidden |  -  |
| **404** | Not Found |  -  |
