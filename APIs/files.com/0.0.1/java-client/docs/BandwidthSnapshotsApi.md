...
<a id="getBandwidthSnapshots"></a>
# **getBandwidthSnapshots**
> List&lt;BandwidthSnapshotEntity&gt; getBandwidthSnapshots(cursor, perPage, sortBy, filter, filterGt, filterGteq, filterLt, filterLteq)
...
import org.openapitools.client.api.BandwidthSnapshotsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    BandwidthSnapshotsApi apiInstance = new BandwidthSnapshotsApi(defaultClient);
    ...
    try {
      List<BandwidthSnapshotEntity> result = apiInstance.getBandwidthSnapshots(cursor, perPage, sortBy, filter, filterGt, filterGteq, filterLt, filterLteq);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling BandwidthSnapshotsApi#getBandwidthSnapshots");
...
[**List&lt;BandwidthSnapshotEntity&gt;**](BandwidthSnapshotEntity.md)
...
|-------------|-------------|------------------|
| **200** | A list of BandwidthSnapshots objects. |  -  |
| **400** | Bad Request |  -  |
| **401** | Unauthorized |  -  |
| **403** | Forbidden |  -  |
| **404** | Not Found |  -  |
