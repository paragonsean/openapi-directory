...
<a id="getPayments"></a>
# **getPayments**
> List&lt;AccountLineItemEntity&gt; getPayments(cursor, perPage)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<AccountLineItemEntity> result = apiInstance.getPayments(cursor, perPage);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      AccountLineItemEntity result = apiInstance.getPaymentsId(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PaymentsApi#getPaymentsId");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
