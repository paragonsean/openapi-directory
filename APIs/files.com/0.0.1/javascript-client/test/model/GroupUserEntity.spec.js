...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FilesComApi.GroupUserEntity();
  });
  ...
  describe('GroupUserEntity', function() {
    it('should create an instance of GroupUserEntity', function() {
      // uncomment below and update the code to test GroupUserEntity
      //var instance = new FilesComApi.GroupUserEntity();
      //expect(instance).to.be.a(FilesComApi.GroupUserEntity);
    });
