...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FilesComApi.PublicIpAddressEntity();
  });
  ...
  describe('PublicIpAddressEntity', function() {
    it('should create an instance of PublicIpAddressEntity', function() {
      // uncomment below and update the code to test PublicIpAddressEntity
      //var instance = new FilesComApi.PublicIpAddressEntity();
      //expect(instance).to.be.a(FilesComApi.PublicIpAddressEntity);
    });
