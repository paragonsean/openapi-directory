...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FilesComApi.BundleRecipientEntity();
  });
  ...
  describe('BundleRecipientEntity', function() {
    it('should create an instance of BundleRecipientEntity', function() {
      // uncomment below and update the code to test BundleRecipientEntity
      //var instance = new FilesComApi.BundleRecipientEntity();
      //expect(instance).to.be.a(FilesComApi.BundleRecipientEntity);
    });
