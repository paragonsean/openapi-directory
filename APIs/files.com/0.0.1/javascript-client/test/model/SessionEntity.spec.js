...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FilesComApi.SessionEntity();
  });
  ...
  describe('SessionEntity', function() {
    it('should create an instance of SessionEntity', function() {
      // uncomment below and update the code to test SessionEntity
      //var instance = new FilesComApi.SessionEntity();
      //expect(instance).to.be.a(FilesComApi.SessionEntity);
    });
