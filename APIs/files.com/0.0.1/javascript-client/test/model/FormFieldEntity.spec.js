...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FilesComApi.FormFieldEntity();
  });
  ...
  describe('FormFieldEntity', function() {
    it('should create an instance of FormFieldEntity', function() {
      // uncomment below and update the code to test FormFieldEntity
      //var instance = new FilesComApi.FormFieldEntity();
      //expect(instance).to.be.a(FilesComApi.FormFieldEntity);
    });
