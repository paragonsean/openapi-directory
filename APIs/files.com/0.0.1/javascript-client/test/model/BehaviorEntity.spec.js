...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FilesComApi.BehaviorEntity();
  });
  ...
  describe('BehaviorEntity', function() {
    it('should create an instance of BehaviorEntity', function() {
      // uncomment below and update the code to test BehaviorEntity
      //var instance = new FilesComApi.BehaviorEntity();
      //expect(instance).to.be.a(FilesComApi.BehaviorEntity);
    });
