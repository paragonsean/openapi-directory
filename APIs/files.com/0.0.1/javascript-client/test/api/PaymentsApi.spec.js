...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FilesComApi.PaymentsApi();
  });
  ...
  describe('PaymentsApi', function() {
    ...
    describe('getPaymentsId', function() {
      it('should call getPaymentsId successfully', function(done) {
        //uncomment below and update the code to test getPaymentsId
        //instance.getPaymentsId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
