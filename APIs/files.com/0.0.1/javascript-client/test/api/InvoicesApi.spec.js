...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FilesComApi.InvoicesApi();
  });
  ...
  describe('InvoicesApi', function() {
    ...
    describe('getInvoicesId', function() {
      it('should call getInvoicesId successfully', function(done) {
        //uncomment below and update the code to test getInvoicesId
        //instance.getInvoicesId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
