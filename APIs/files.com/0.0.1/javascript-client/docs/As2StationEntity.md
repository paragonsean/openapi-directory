# FilesComApi.As2StationEntity

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**domain** | **String** | The station&#39;s AS2 domain name. | [optional] 
**hexPublicCertificateSerial** | **String** | Serial of public certificate used for message security in hex format. | [optional] 
**id** | **Number** | Id of the AS2 Station. | [optional] 
**name** | **String** | The station&#39;s formal AS2 name. | [optional] 
**privateKeyMd5** | **String** | MD5 hash of private key used for message security. | [optional] 
**privateKeyPasswordMd5** | **String** | MD5 hash of private key password used for message security. | [optional] 
