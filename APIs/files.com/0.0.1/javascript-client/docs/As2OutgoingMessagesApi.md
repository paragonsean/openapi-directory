# FilesComApi.As2OutgoingMessagesApi
...
> [As2OutgoingMessageEntity] getAs2OutgoingMessages(opts)
...
let apiInstance = new FilesComApi.As2OutgoingMessagesApi();
let opts = {
...
apiInstance.getAs2OutgoingMessages(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
[**[As2OutgoingMessageEntity]**](As2OutgoingMessageEntity.md)
