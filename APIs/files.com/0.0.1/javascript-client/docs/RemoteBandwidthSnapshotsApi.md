# FilesComApi.RemoteBandwidthSnapshotsApi
...
> [RemoteBandwidthSnapshotEntity] getRemoteBandwidthSnapshots(opts)
...
let apiInstance = new FilesComApi.RemoteBandwidthSnapshotsApi();
let opts = {
...
apiInstance.getRemoteBandwidthSnapshots(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
[**[RemoteBandwidthSnapshotEntity]**](RemoteBandwidthSnapshotEntity.md)
