...
async def get_ip_addresses(request: web.Request, cursor=None, per_page=None) -> web.Response:
...
async def get_ip_addresses_exavault_reserved(request: web.Request, cursor=None, per_page=None) -> web.Response:
...
async def get_ip_addresses_reserved(request: web.Request, cursor=None, per_page=None) -> web.Response:
