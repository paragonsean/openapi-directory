...
async def get_user_api_keys(request: web.Request, user_id=None, cursor=None, per_page=None, sort_by=None, filter=None, filter_gt=None, filter_gteq=None, filter_lt=None, filter_lteq=None) -> web.Response:
    """List Api Keys
...
async def get_user_groups(request: web.Request, user_id=None, cursor=None, per_page=None, group_id=None) -> web.Response:
    """List Group Users
...
async def get_user_public_keys(request: web.Request, user_id=None, cursor=None, per_page=None) -> web.Response:
    """List Public Keys
...
async def post_user_api_keys(request: web.Request, description=None, expires_at=None, name=None, path=None, permission_set=None, user_id=None) -> web.Response:
    """Create Api Key
...
async def post_user_public_keys(request: web.Request, public_key, title, user_id=None) -> web.Response:
    """Create Public Key
