...
async def get_history_export_results(request: web.Request, history_export_id, user_id=None, cursor=None, per_page=None) -> web.Response:
    """List History Export Results

    List History Export Results

    :param history_export_id: ID of the associated history export.
    :type history_export_id: int
