...
#ifndef OAIMappedQTL_H
#define OAIMappedQTL_H
...
class OAIMappedQTL : public OAIObject {
public:
    OAIMappedQTL();
    OAIMappedQTL(QString json);
    ~OAIMappedQTL() override;
    ...
    OAIQTL getQtl() const;
    void setQtl(const OAIQTL &qtl);
    bool is_qtl_Set() const;
    bool is_qtl_Valid() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMappedQTL)

#endif // OAIMappedQTL_H
