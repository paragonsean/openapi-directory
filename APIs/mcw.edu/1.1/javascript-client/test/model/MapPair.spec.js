...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RatGenomeDatabaseRestApi.MapPair();
  });
  ...
  describe('MapPair', function() {
    it('should create an instance of MapPair', function() {
      // uncomment below and update the code to test MapPair
      //var instance = new RatGenomeDatabaseRestApi.MapPair();
      //expect(instance).to.be.a(RatGenomeDatabaseRestApi.MapPair);
    });
