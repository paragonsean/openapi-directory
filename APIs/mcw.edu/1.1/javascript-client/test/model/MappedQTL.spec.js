...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RatGenomeDatabaseRestApi.MappedQTL();
  });
  ...
  describe('MappedQTL', function() {
    it('should create an instance of MappedQTL', function() {
      // uncomment below and update the code to test MappedQTL
      //var instance = new RatGenomeDatabaseRestApi.MappedQTL();
      //expect(instance).to.be.a(RatGenomeDatabaseRestApi.MappedQTL);
    });
    ...
    it('should have the property qtl (base name: "qtl")', function() {
      // uncomment below and update the code to test the property qtl
      //var instance = new RatGenomeDatabaseRestApi.MappedQTL();
      //expect(instance).to.be();
    });
