...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UpApi.WebhookDeliveryLogResourceAttributes();
  });
  ...
  describe('WebhookDeliveryLogResourceAttributes', function() {
    it('should create an instance of WebhookDeliveryLogResourceAttributes', function() {
      // uncomment below and update the code to test WebhookDeliveryLogResourceAttributes
      //var instance = new UpApi.WebhookDeliveryLogResourceAttributes();
      //expect(instance).to.be.a(UpApi.WebhookDeliveryLogResourceAttributes);
    });
