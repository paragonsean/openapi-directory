...
|**createdAt** | **OffsetDateTime** | The date-time at which this transaction was first encountered.  |  |
...
|**settledAt** | **OffsetDateTime** | The date-time at which this transaction settled. This field will be &#x60;null&#x60; for transactions that are currently in the &#x60;HELD&#x60; status.  |  |
|**status** | **TransactionStatusEnum** | The current processing status of this transaction, according to whether or not this transaction has settled or is still held.  |  |
