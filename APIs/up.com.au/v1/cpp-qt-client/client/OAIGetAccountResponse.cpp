...
OAIAccountResource OAIGetAccountResponse::getData() const {
    return m_data;
}
void OAIGetAccountResponse::setData(const OAIAccountResource &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetAccountResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetAccountResponse::is_data_Valid() const{
