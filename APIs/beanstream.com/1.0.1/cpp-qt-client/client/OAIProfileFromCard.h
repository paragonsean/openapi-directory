...
/*
 * OAIProfileFromCard.h
 *
 * 
 */

#ifndef OAIProfileFromCard_H
#define OAIProfileFromCard_H
...
class OAIProfileFromCard : public OAIObject {
public:
    OAIProfileFromCard();
    OAIProfileFromCard(QString json);
    ~OAIProfileFromCard() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProfileFromCard)

#endif // OAIProfileFromCard_H
