...
public:
    ...
    /**
    * @param[in]  search_query OAISearchQuery [optional]
    */
    virtual void reportsPost(const ::OpenAPI::OptionalParam<OAISearchQuery> &search_query = ::OpenAPI::OptionalParam<OAISearchQuery>());
...
Q_SIGNALS:
    ...
    void reportsPostSignal(OAISearchResult summary);


    void reportsPostSignalFull(OAIHttpRequestWorker *worker, OAISearchResult summary);

    Q_DECL_DEPRECATED_X("Use reportsPostSignalError() instead")
    void reportsPostSignalE(OAISearchResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void reportsPostSignalError(OAISearchResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
