...
public class Card {
  ...
  private String number = "5100000010001004";

  public Card() {
  }

  public Card complete(Boolean complete) {
  ...
  public boolean equals(Object o) {
    ...
    Card card = (Card) o;
    return Objects.equals(this.complete, card.complete) &&
        Objects.equals(this.cvd, card.cvd) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(complete, cvd, expiryMonth, expiryYear, name, number);
  }
