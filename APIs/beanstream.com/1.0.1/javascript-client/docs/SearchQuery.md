# BeanstreamPayments.SearchQuery

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**criteria** | [**[Criteria]**](Criteria.md) | Optional search criteria. All criteria are ANDed together. | [optional] 
**endDate** | **String** | The end date (inclusive) &#39;2015-04-22T10:03:19&#39; in the timezone of your merchant account. | 
**endRow** | **Number** | Used to page the results. 1-based. This should always be 1 larger than start_row. | 
...
**startRow** | **Number** | Used to page the results. 1-based | 
