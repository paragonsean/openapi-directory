...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeanstreamPayments.ProfileCards();
  });
  ...
  describe('ProfileCards', function() {
    it('should create an instance of ProfileCards', function() {
      // uncomment below and update the code to test ProfileCards
      //var instance = new BeanstreamPayments.ProfileCards();
      //expect(instance).to.be.a(BeanstreamPayments.ProfileCards);
    });
