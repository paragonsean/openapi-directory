...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeanstreamPayments.ProfilePurchase();
  });
  ...
  describe('ProfilePurchase', function() {
    it('should create an instance of ProfilePurchase', function() {
      // uncomment below and update the code to test ProfilePurchase
      //var instance = new BeanstreamPayments.ProfilePurchase();
      //expect(instance).to.be.a(BeanstreamPayments.ProfilePurchase);
    });
