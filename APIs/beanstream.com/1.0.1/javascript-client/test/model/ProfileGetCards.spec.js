...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeanstreamPayments.ProfileGetCards();
  });
  ...
  describe('ProfileGetCards', function() {
    it('should create an instance of ProfileGetCards', function() {
      // uncomment below and update the code to test ProfileGetCards
      //var instance = new BeanstreamPayments.ProfileGetCards();
      //expect(instance).to.be.a(BeanstreamPayments.ProfileGetCards);
    });
