...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeanstreamPayments.GetProfileDefaultCard();
  });
  ...
  describe('GetProfileDefaultCard', function() {
    it('should create an instance of GetProfileDefaultCard', function() {
      // uncomment below and update the code to test GetProfileDefaultCard
      //var instance = new BeanstreamPayments.GetProfileDefaultCard();
      //expect(instance).to.be.a(BeanstreamPayments.GetProfileDefaultCard);
    });
