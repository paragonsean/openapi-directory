...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeanstreamPayments.Transaction();
  });
  ...
  describe('Transaction', function() {
    it('should create an instance of Transaction', function() {
      ...
      //var instance = new BeanstreamPayments.Transaction();
      //expect(instance).to.be.a(BeanstreamPayments.Transaction);
    });

    it('should have the property adjustedBy (base name: "adjusted_by")', function() {
      // uncomment below and update the code to test the property adjustedBy
      //var instance = new BeanstreamPayments.Transaction();
    ...
    it('should have the property totalCompletions (base name: "total_completions")', function() {
      // uncomment below and update the code to test the property totalCompletions
      //var instance = new BeanstreamPayments.Transaction();
      //expect(instance).to.be();
    });

    it('should have the property totalRefunds (base name: "total_refunds")', function() {
