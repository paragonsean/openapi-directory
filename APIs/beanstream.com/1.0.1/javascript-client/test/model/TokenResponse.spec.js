...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeanstreamPayments.TokenResponse();
  });
  ...
  describe('TokenResponse', function() {
    it('should create an instance of TokenResponse', function() {
      ...
      //var instance = new BeanstreamPayments.TokenResponse();
      //expect(instance).to.be.a(BeanstreamPayments.TokenResponse);
    });
