...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeanstreamPayments.ProfileCard();
  });
  ...
  describe('ProfileCard', function() {
    it('should create an instance of ProfileCard', function() {
      // uncomment below and update the code to test ProfileCard
      //var instance = new BeanstreamPayments.ProfileCard();
      //expect(instance).to.be.a(BeanstreamPayments.ProfileCard);
    });
