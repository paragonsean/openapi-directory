...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeanstreamPayments.UpdateProfileBody();
  });
  ...
  describe('UpdateProfileBody', function() {
    it('should create an instance of UpdateProfileBody', function() {
      // uncomment below and update the code to test UpdateProfileBody
      //var instance = new BeanstreamPayments.UpdateProfileBody();
      //expect(instance).to.be.a(BeanstreamPayments.UpdateProfileBody);
    });
