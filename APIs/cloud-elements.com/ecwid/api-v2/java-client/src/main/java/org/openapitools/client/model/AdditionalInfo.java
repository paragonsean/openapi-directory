...
public class AdditionalInfo {
  public static final String SERIALIZED_NAME_GOOGLE_CUSTOMER_ID = "google_customer_id";
  @SerializedName(SERIALIZED_NAME_GOOGLE_CUSTOMER_ID)
  private String googleCustomerId;

  public AdditionalInfo() {
  }

  public AdditionalInfo googleCustomerId(String googleCustomerId) {
    this.googleCustomerId = googleCustomerId;
    return this;
  }

  /**
   * Get googleCustomerId
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.googleCustomerId, additionalInfo.googleCustomerId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(googleCustomerId);
  }
  ...
  public String toString() {
    ...
    sb.append("    googleCustomerId: ").append(toIndentedString(googleCustomerId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("google_customer_id");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("google_customer_id") != null && !jsonObj.get("google_customer_id").isJsonNull()) && !jsonObj.get("google_customer_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `google_customer_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("google_customer_id").toString()));
      }
  }
