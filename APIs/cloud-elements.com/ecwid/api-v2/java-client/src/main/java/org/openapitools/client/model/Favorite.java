...
public class Favorite {
  ...
  public static final String SERIALIZED_NAME_DISPLAYED_COUNT = "displayedCount";
  ...
  public Favorite count(Long count) {
    this.count = count;
    return this;
  }
  ...
  public Favorite displayedCount(String displayedCount) {
  ...
  public void setDisplayedCount(String displayedCount) {
    this.displayedCount = displayedCount;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, favorite.count) &&
        Objects.equals(this.displayedCount, favorite.displayedCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, displayedCount);
  }
  ...
  static {
    ...
    openapiFields.add("displayedCount");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Favorite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Favorite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("displayedCount") != null && !jsonObj.get("displayedCount").isJsonNull()) && !jsonObj.get("displayedCount").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `displayedCount` to be a primitive type in the JSON string but got `%s`", jsonObj.get("displayedCount").toString()));
      }
  }
