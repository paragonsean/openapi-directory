...
public class OrderPost {
  ...
  public OrderPost billingPerson(Person billingPerson) {
  ...
  public OrderPost couponDiscount(Double couponDiscount) {
  ...
  public OrderPost customerId(Double customerId) {
  ...
  public OrderPost customerTaxExempt(Boolean customerTaxExempt) {
  ...
  public OrderPost customerTaxId(Long customerTaxId) {
  ...
  public OrderPost customerTaxIdValid(Boolean customerTaxIdValid) {
  ...
  public OrderPost discount(Double discount) {
  ...
  public OrderPost email(String email) {
    this.email = email;
    return this;
  }
  ...
  public OrderPost fulfillmentStatus(String fulfillmentStatus) {
  ...
  public OrderPost globalReferer(String globalReferer) {
  ...
  public OrderPost hidden(Boolean hidden) {
    this.hidden = hidden;
    return this;
  }
  ...
  public OrderPost items(List<Item> items) {
    this.items = items;
    return this;
  }

  public OrderPost addItemsItem(Item itemsItem) {
    if (this.items == null) {
  ...
  public OrderPost membershipBasedDiscount(Double membershipBasedDiscount) {
  ...
  public OrderPost orderComments(String orderComments) {
  ...
  public OrderPost paymentMethod(String paymentMethod) {
  ...
  public OrderPost paymentModule(String paymentModule) {
  ...
  public OrderPost paymentStatus(String paymentStatus) {
  ...
  public OrderPost privateAdminNotes(String privateAdminNotes) {
  ...
  public OrderPost refererUrl(String refererUrl) {
  ...
  public OrderPost reversedTaxApplied(Boolean reversedTaxApplied) {
  ...
  public OrderPost sample(Boolean sample) {
    this.sample = sample;
    return this;
  }
  ...
  public OrderPost shippingMethod(String shippingMethod) {
  ...
  public OrderPost shippingOption(ShippingOption shippingOption) {
  ...
  public OrderPost shippingPerson(Person shippingPerson) {
  ...
  public OrderPost subtotal(Double subtotal) {
  ...
  public OrderPost tax(Double tax) {
    this.tax = tax;
    return this;
  }
  ...
  public OrderPost total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public OrderPost totalAndMembershipBasedDiscount(Double totalAndMembershipBasedDiscount) {
  ...
  public OrderPost volumeDiscount(Double volumeDiscount) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billingPerson, orderPost.billingPerson) &&
        Objects.equals(this.couponDiscount, orderPost.couponDiscount) &&
        Objects.equals(this.customerId, orderPost.customerId) &&
        Objects.equals(this.customerTaxExempt, orderPost.customerTaxExempt) &&
        Objects.equals(this.customerTaxId, orderPost.customerTaxId) &&
        Objects.equals(this.customerTaxIdValid, orderPost.customerTaxIdValid) &&
        Objects.equals(this.discount, orderPost.discount) &&
        Objects.equals(this.email, orderPost.email) &&
        Objects.equals(this.fulfillmentStatus, orderPost.fulfillmentStatus) &&
        Objects.equals(this.globalReferer, orderPost.globalReferer) &&
        Objects.equals(this.hidden, orderPost.hidden) &&
        Objects.equals(this.items, orderPost.items) &&
        Objects.equals(this.membershipBasedDiscount, orderPost.membershipBasedDiscount) &&
        Objects.equals(this.orderComments, orderPost.orderComments) &&
        Objects.equals(this.paymentMethod, orderPost.paymentMethod) &&
        Objects.equals(this.paymentModule, orderPost.paymentModule) &&
        Objects.equals(this.paymentStatus, orderPost.paymentStatus) &&
        Objects.equals(this.privateAdminNotes, orderPost.privateAdminNotes) &&
        Objects.equals(this.refererUrl, orderPost.refererUrl) &&
        Objects.equals(this.reversedTaxApplied, orderPost.reversedTaxApplied) &&
        Objects.equals(this.sample, orderPost.sample) &&
        Objects.equals(this.shippingMethod, orderPost.shippingMethod) &&
        Objects.equals(this.shippingOption, orderPost.shippingOption) &&
        Objects.equals(this.shippingPerson, orderPost.shippingPerson) &&
        Objects.equals(this.subtotal, orderPost.subtotal) &&
        Objects.equals(this.tax, orderPost.tax) &&
        Objects.equals(this.total, orderPost.total) &&
        Objects.equals(this.totalAndMembershipBasedDiscount, orderPost.totalAndMembershipBasedDiscount) &&
        Objects.equals(this.volumeDiscount, orderPost.volumeDiscount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(billingPerson, couponDiscount, customerId, customerTaxExempt, customerTaxId, customerTaxIdValid, discount, email, fulfillmentStatus, globalReferer, hidden, items, membershipBasedDiscount, orderComments, paymentMethod, paymentModule, paymentStatus, privateAdminNotes, refererUrl, reversedTaxApplied, sample, shippingMethod, shippingOption, shippingPerson, subtotal, tax, total, totalAndMembershipBasedDiscount, volumeDiscount);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderPost is not found in the empty JSON string", OrderPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderPost.openapiRequiredFields) {
      ...
      if (!jsonObj.get("fulfillmentStatus").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderPost.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderPost>() {
           @Override
           public void write(JsonWriter out, OrderPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderPost
   * @throws IOException if the JSON string is invalid with respect to OrderPost
   */
  public static OrderPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderPost.class);
  }

  /**
   * Convert an instance of OrderPost to an JSON string
   *
   * @return JSON string
   */
