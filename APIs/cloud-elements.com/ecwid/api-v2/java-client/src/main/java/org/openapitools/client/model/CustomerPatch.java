...
public class CustomerPatch {
  ...
  public CustomerPatch billingPerson(Person billingPerson) {
  ...
  public CustomerPatch customerGroupId(Long customerGroupId) {
  ...
  public CustomerPatch email(String email) {
    this.email = email;
    return this;
  }
  ...
  public CustomerPatch password(String password) {
  ...
  public CustomerPatch shippingAddresses(List<Person> shippingAddresses) {
    this.shippingAddresses = shippingAddresses;
    return this;
  }

  public CustomerPatch addShippingAddressesItem(Person shippingAddressesItem) {
  ...
  public CustomerPatch taxExempt(Boolean taxExempt) {
  ...
  public CustomerPatch taxId(Double taxId) {
    this.taxId = taxId;
    return this;
  }
  ...
  public CustomerPatch taxIdValid(Boolean taxIdValid) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billingPerson, customerPatch.billingPerson) &&
        Objects.equals(this.customerGroupId, customerPatch.customerGroupId) &&
        Objects.equals(this.email, customerPatch.email) &&
        Objects.equals(this.password, customerPatch.password) &&
        Objects.equals(this.shippingAddresses, customerPatch.shippingAddresses) &&
        Objects.equals(this.taxExempt, customerPatch.taxExempt) &&
        Objects.equals(this.taxId, customerPatch.taxId) &&
        Objects.equals(this.taxIdValid, customerPatch.taxIdValid);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomerPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomerPatch is not found in the empty JSON string", CustomerPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomerPatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomerPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomerPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomerPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomerPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomerPatch>() {
           @Override
           public void write(JsonWriter out, CustomerPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomerPatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomerPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomerPatch
   * @throws IOException if the JSON string is invalid with respect to CustomerPatch
   */
  public static CustomerPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomerPatch.class);
  }

  /**
   * Convert an instance of CustomerPatch to an JSON string
   *
   * @return JSON string
   */
