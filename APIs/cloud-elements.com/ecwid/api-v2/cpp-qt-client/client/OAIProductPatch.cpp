...
OAIProductPatch::OAIProductPatch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProductPatch::OAIProductPatch() {
    this->initializeModel();
}

OAIProductPatch::~OAIProductPatch() {}

void OAIProductPatch::initializeModel() {
...
void OAIProductPatch::fromJson(QString jsonString) {
...
void OAIProductPatch::fromJsonObject(QJsonObject json) {
...
QString OAIProductPatch::asJson() const {
...
QJsonObject OAIProductPatch::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIAttribute> OAIProductPatch::getAttributes() const {
    return m_attributes;
}
void OAIProductPatch::setAttributes(const QList<OAIAttribute> &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIProductPatch::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIProductPatch::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QList<qint64> OAIProductPatch::getCategoryIds() const {
    return m_category_ids;
}
void OAIProductPatch::setCategoryIds(const QList<qint64> &category_ids) {
    m_category_ids = category_ids;
    m_category_ids_isSet = true;
}

bool OAIProductPatch::is_category_ids_Set() const{
    return m_category_ids_isSet;
}

bool OAIProductPatch::is_category_ids_Valid() const{
    return m_category_ids_isValid;
}

double OAIProductPatch::getCompareAtPrice() const {
    return m_compare_at_price;
}
void OAIProductPatch::setCompareAtPrice(const double &compare_at_price) {
    m_compare_at_price = compare_at_price;
    m_compare_at_price_isSet = true;
}

bool OAIProductPatch::is_compare_at_price_Set() const{
    return m_compare_at_price_isSet;
}

bool OAIProductPatch::is_compare_at_price_Valid() const{
    return m_compare_at_price_isValid;
}

double OAIProductPatch::getCompareToPrice() const {
    return m_compare_to_price;
}
void OAIProductPatch::setCompareToPrice(const double &compare_to_price) {
    m_compare_to_price = compare_to_price;
    m_compare_to_price_isSet = true;
}

bool OAIProductPatch::is_compare_to_price_Set() const{
    return m_compare_to_price_isSet;
}

bool OAIProductPatch::is_compare_to_price_Valid() const{
    return m_compare_to_price_isValid;
}

qint64 OAIProductPatch::getDefaultCategoryId() const {
    return m_default_category_id;
}
void OAIProductPatch::setDefaultCategoryId(const qint64 &default_category_id) {
    m_default_category_id = default_category_id;
    m_default_category_id_isSet = true;
}

bool OAIProductPatch::is_default_category_id_Set() const{
    return m_default_category_id_isSet;
}

bool OAIProductPatch::is_default_category_id_Valid() const{
    return m_default_category_id_isValid;
}

QString OAIProductPatch::getDescription() const {
    return m_description;
}
void OAIProductPatch::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIProductPatch::is_description_Set() const{
    return m_description_isSet;
}

bool OAIProductPatch::is_description_Valid() const{
    return m_description_isValid;
}

OAIProductDimensions OAIProductPatch::getDimensions() const {
    return m_dimensions;
}
void OAIProductPatch::setDimensions(const OAIProductDimensions &dimensions) {
    m_dimensions = dimensions;
    m_dimensions_isSet = true;
}

bool OAIProductPatch::is_dimensions_Set() const{
    return m_dimensions_isSet;
}

bool OAIProductPatch::is_dimensions_Valid() const{
    return m_dimensions_isValid;
}

bool OAIProductPatch::isEnabled() const {
    return m_enabled;
}
void OAIProductPatch::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIProductPatch::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIProductPatch::is_enabled_Valid() const{
    return m_enabled_isValid;
}

double OAIProductPatch::getFixedShippingRate() const {
    return m_fixed_shipping_rate;
}
void OAIProductPatch::setFixedShippingRate(const double &fixed_shipping_rate) {
    m_fixed_shipping_rate = fixed_shipping_rate;
    m_fixed_shipping_rate_isSet = true;
}

bool OAIProductPatch::is_fixed_shipping_rate_Set() const{
    return m_fixed_shipping_rate_isSet;
}

bool OAIProductPatch::is_fixed_shipping_rate_Valid() const{
    return m_fixed_shipping_rate_isValid;
}

bool OAIProductPatch::isFixedShippingRateOnly() const {
    return m_fixed_shipping_rate_only;
}
void OAIProductPatch::setFixedShippingRateOnly(const bool &fixed_shipping_rate_only) {
    m_fixed_shipping_rate_only = fixed_shipping_rate_only;
    m_fixed_shipping_rate_only_isSet = true;
}

bool OAIProductPatch::is_fixed_shipping_rate_only_Set() const{
    return m_fixed_shipping_rate_only_isSet;
}

bool OAIProductPatch::is_fixed_shipping_rate_only_Valid() const{
    return m_fixed_shipping_rate_only_isValid;
}

QList<OAIGalleryImage> OAIProductPatch::getGalleryImages() const {
    return m_gallery_images;
}
void OAIProductPatch::setGalleryImages(const QList<OAIGalleryImage> &gallery_images) {
    m_gallery_images = gallery_images;
    m_gallery_images_isSet = true;
}

bool OAIProductPatch::is_gallery_images_Set() const{
    return m_gallery_images_isSet;
}

bool OAIProductPatch::is_gallery_images_Valid() const{
    return m_gallery_images_isValid;
}

QString OAIProductPatch::getGoogleItemCondition() const {
    return m_google_item_condition;
}
void OAIProductPatch::setGoogleItemCondition(const QString &google_item_condition) {
    m_google_item_condition = google_item_condition;
    m_google_item_condition_isSet = true;
}

bool OAIProductPatch::is_google_item_condition_Set() const{
    return m_google_item_condition_isSet;
}

bool OAIProductPatch::is_google_item_condition_Valid() const{
    return m_google_item_condition_isValid;
}

bool OAIProductPatch::isIsShippingRequired() const {
    return m_is_shipping_required;
}
void OAIProductPatch::setIsShippingRequired(const bool &is_shipping_required) {
    m_is_shipping_required = is_shipping_required;
    m_is_shipping_required_isSet = true;
}

bool OAIProductPatch::is_is_shipping_required_Set() const{
    return m_is_shipping_required_isSet;
}

bool OAIProductPatch::is_is_shipping_required_Valid() const{
    return m_is_shipping_required_isValid;
}

QString OAIProductPatch::getName() const {
    return m_name;
}
void OAIProductPatch::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProductPatch::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProductPatch::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAIOption> OAIProductPatch::getOptions() const {
    return m_options;
}
void OAIProductPatch::setOptions(const QList<OAIOption> &options) {
    m_options = options;
    m_options_isSet = true;
}

bool OAIProductPatch::is_options_Set() const{
    return m_options_isSet;
}

bool OAIProductPatch::is_options_Valid() const{
    return m_options_isValid;
}

double OAIProductPatch::getPrice() const {
    return m_price;
}
void OAIProductPatch::setPrice(const double &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIProductPatch::is_price_Set() const{
    return m_price_isSet;
}

bool OAIProductPatch::is_price_Valid() const{
    return m_price_isValid;
}

qint64 OAIProductPatch::getProductClassId() const {
    return m_product_class_id;
}
void OAIProductPatch::setProductClassId(const qint64 &product_class_id) {
    m_product_class_id = product_class_id;
    m_product_class_id_isSet = true;
}

bool OAIProductPatch::is_product_class_id_Set() const{
    return m_product_class_id_isSet;
}

bool OAIProductPatch::is_product_class_id_Valid() const{
    return m_product_class_id_isValid;
}

qint64 OAIProductPatch::getQuantity() const {
    return m_quantity;
}
void OAIProductPatch::setQuantity(const qint64 &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIProductPatch::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIProductPatch::is_quantity_Valid() const{
    return m_quantity_isValid;
}

OAIRelatedProducts OAIProductPatch::getRelatedProducts() const {
    return m_related_products;
}
void OAIProductPatch::setRelatedProducts(const OAIRelatedProducts &related_products) {
    m_related_products = related_products;
    m_related_products_isSet = true;
}

bool OAIProductPatch::is_related_products_Set() const{
    return m_related_products_isSet;
}

bool OAIProductPatch::is_related_products_Valid() const{
    return m_related_products_isValid;
}

QString OAIProductPatch::getSeoDescription() const {
    return m_seo_description;
}
void OAIProductPatch::setSeoDescription(const QString &seo_description) {
    m_seo_description = seo_description;
    m_seo_description_isSet = true;
}

bool OAIProductPatch::is_seo_description_Set() const{
    return m_seo_description_isSet;
}

bool OAIProductPatch::is_seo_description_Valid() const{
    return m_seo_description_isValid;
}

QString OAIProductPatch::getSeoTitle() const {
    return m_seo_title;
}
void OAIProductPatch::setSeoTitle(const QString &seo_title) {
    m_seo_title = seo_title;
    m_seo_title_isSet = true;
}

bool OAIProductPatch::is_seo_title_Set() const{
    return m_seo_title_isSet;
}

bool OAIProductPatch::is_seo_title_Valid() const{
    return m_seo_title_isValid;
}

OAIShipping OAIProductPatch::getShipping() const {
    return m_shipping;
}
void OAIProductPatch::setShipping(const OAIShipping &shipping) {
    m_shipping = shipping;
    m_shipping_isSet = true;
}

bool OAIProductPatch::is_shipping_Set() const{
    return m_shipping_isSet;
}

bool OAIProductPatch::is_shipping_Valid() const{
    return m_shipping_isValid;
}

double OAIProductPatch::getShowOnFrontpage() const {
    return m_show_on_frontpage;
}
void OAIProductPatch::setShowOnFrontpage(const double &show_on_frontpage) {
    m_show_on_frontpage = show_on_frontpage;
    m_show_on_frontpage_isSet = true;
}

bool OAIProductPatch::is_show_on_frontpage_Set() const{
    return m_show_on_frontpage_isSet;
}

bool OAIProductPatch::is_show_on_frontpage_Valid() const{
    return m_show_on_frontpage_isValid;
}

QString OAIProductPatch::getSku() const {
    return m_sku;
}
void OAIProductPatch::setSku(const QString &sku) {
    m_sku = sku;
    m_sku_isSet = true;
}

bool OAIProductPatch::is_sku_Set() const{
    return m_sku_isSet;
}

bool OAIProductPatch::is_sku_Valid() const{
    return m_sku_isValid;
}

OAIProductTax OAIProductPatch::getTax() const {
    return m_tax;
}
void OAIProductPatch::setTax(const OAIProductTax &tax) {
    m_tax = tax;
    m_tax_isSet = true;
}

bool OAIProductPatch::is_tax_Set() const{
    return m_tax_isSet;
}

bool OAIProductPatch::is_tax_Valid() const{
    return m_tax_isValid;
}

QList<OAITax> OAIProductPatch::getTaxes() const {
    return m_taxes;
}
void OAIProductPatch::setTaxes(const QList<OAITax> &taxes) {
    m_taxes = taxes;
    m_taxes_isSet = true;
}

bool OAIProductPatch::is_taxes_Set() const{
    return m_taxes_isSet;
}

bool OAIProductPatch::is_taxes_Valid() const{
    return m_taxes_isValid;
}

qint64 OAIProductPatch::getWarningLimit() const {
    return m_warning_limit;
}
void OAIProductPatch::setWarningLimit(const qint64 &warning_limit) {
    m_warning_limit = warning_limit;
    m_warning_limit_isSet = true;
}

bool OAIProductPatch::is_warning_limit_Set() const{
    return m_warning_limit_isSet;
}

bool OAIProductPatch::is_warning_limit_Valid() const{
    return m_warning_limit_isValid;
}

double OAIProductPatch::getWeight() const {
    return m_weight;
}
void OAIProductPatch::setWeight(const double &weight) {
    m_weight = weight;
    m_weight_isSet = true;
}

bool OAIProductPatch::is_weight_Set() const{
    return m_weight_isSet;
}

bool OAIProductPatch::is_weight_Valid() const{
    return m_weight_isValid;
}

OAIWholesalePrices OAIProductPatch::getWholesalePrices() const {
    return m_wholesale_prices;
}
void OAIProductPatch::setWholesalePrices(const OAIWholesalePrices &wholesale_prices) {
    m_wholesale_prices = wholesale_prices;
    m_wholesale_prices_isSet = true;
}

bool OAIProductPatch::is_wholesale_prices_Set() const{
    return m_wholesale_prices_isSet;
}

bool OAIProductPatch::is_wholesale_prices_Valid() const{
    return m_wholesale_prices_isValid;
}

bool OAIProductPatch::isSet() const {
...
bool OAIProductPatch::isValid() const {
