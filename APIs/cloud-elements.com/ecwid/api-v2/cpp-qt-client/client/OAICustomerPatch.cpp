...
OAICustomerPatch::OAICustomerPatch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomerPatch::OAICustomerPatch() {
    this->initializeModel();
}

OAICustomerPatch::~OAICustomerPatch() {}

void OAICustomerPatch::initializeModel() {
...
void OAICustomerPatch::fromJson(QString jsonString) {
...
void OAICustomerPatch::fromJsonObject(QJsonObject json) {
...
QString OAICustomerPatch::asJson() const {
...
QJsonObject OAICustomerPatch::asJsonObject() const {
    QJsonObject obj;
...
OAIPerson OAICustomerPatch::getBillingPerson() const {
    return m_billing_person;
}
void OAICustomerPatch::setBillingPerson(const OAIPerson &billing_person) {
    m_billing_person = billing_person;
    m_billing_person_isSet = true;
}

bool OAICustomerPatch::is_billing_person_Set() const{
    return m_billing_person_isSet;
}

bool OAICustomerPatch::is_billing_person_Valid() const{
    return m_billing_person_isValid;
}

qint64 OAICustomerPatch::getCustomerGroupId() const {
    return m_customer_group_id;
}
void OAICustomerPatch::setCustomerGroupId(const qint64 &customer_group_id) {
    m_customer_group_id = customer_group_id;
    m_customer_group_id_isSet = true;
}

bool OAICustomerPatch::is_customer_group_id_Set() const{
    return m_customer_group_id_isSet;
}

bool OAICustomerPatch::is_customer_group_id_Valid() const{
    return m_customer_group_id_isValid;
}

QString OAICustomerPatch::getEmail() const {
    return m_email;
}
void OAICustomerPatch::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAICustomerPatch::is_email_Set() const{
    return m_email_isSet;
}

bool OAICustomerPatch::is_email_Valid() const{
    return m_email_isValid;
}

QString OAICustomerPatch::getPassword() const {
    return m_password;
}
void OAICustomerPatch::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAICustomerPatch::is_password_Set() const{
    return m_password_isSet;
}

bool OAICustomerPatch::is_password_Valid() const{
    return m_password_isValid;
}

QList<OAIPerson> OAICustomerPatch::getShippingAddresses() const {
    return m_shipping_addresses;
}
void OAICustomerPatch::setShippingAddresses(const QList<OAIPerson> &shipping_addresses) {
    m_shipping_addresses = shipping_addresses;
    m_shipping_addresses_isSet = true;
}

bool OAICustomerPatch::is_shipping_addresses_Set() const{
    return m_shipping_addresses_isSet;
}

bool OAICustomerPatch::is_shipping_addresses_Valid() const{
    return m_shipping_addresses_isValid;
}

bool OAICustomerPatch::isTaxExempt() const {
    return m_tax_exempt;
}
void OAICustomerPatch::setTaxExempt(const bool &tax_exempt) {
    m_tax_exempt = tax_exempt;
    m_tax_exempt_isSet = true;
}

bool OAICustomerPatch::is_tax_exempt_Set() const{
    return m_tax_exempt_isSet;
}

bool OAICustomerPatch::is_tax_exempt_Valid() const{
    return m_tax_exempt_isValid;
}

double OAICustomerPatch::getTaxId() const {
    return m_tax_id;
}
void OAICustomerPatch::setTaxId(const double &tax_id) {
    m_tax_id = tax_id;
    m_tax_id_isSet = true;
}

bool OAICustomerPatch::is_tax_id_Set() const{
    return m_tax_id_isSet;
}

bool OAICustomerPatch::is_tax_id_Valid() const{
    return m_tax_id_isValid;
}

bool OAICustomerPatch::isTaxIdValid() const {
    return m_tax_id_valid;
}
void OAICustomerPatch::setTaxIdValid(const bool &tax_id_valid) {
    m_tax_id_valid = tax_id_valid;
    m_tax_id_valid_isSet = true;
}

bool OAICustomerPatch::is_tax_id_valid_Set() const{
    return m_tax_id_valid_isSet;
}

bool OAICustomerPatch::is_tax_id_valid_Valid() const{
    return m_tax_id_valid_isValid;
}

bool OAICustomerPatch::isSet() const {
...
bool OAICustomerPatch::isValid() const {
