...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ecwid.CustomerPost();
  });
  ...
  describe('CustomerPost', function() {
    it('should create an instance of CustomerPost', function() {
      // uncomment below and update the code to test CustomerPost
      //var instance = new Ecwid.CustomerPost();
      //expect(instance).to.be.a(Ecwid.CustomerPost);
    });
