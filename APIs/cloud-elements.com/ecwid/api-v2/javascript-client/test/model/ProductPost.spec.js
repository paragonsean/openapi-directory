...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ecwid.ProductPost();
  });
  ...
  describe('ProductPost', function() {
    it('should create an instance of ProductPost', function() {
      // uncomment below and update the code to test ProductPost
      //var instance = new Ecwid.ProductPost();
      //expect(instance).to.be.a(Ecwid.ProductPost);
    });
