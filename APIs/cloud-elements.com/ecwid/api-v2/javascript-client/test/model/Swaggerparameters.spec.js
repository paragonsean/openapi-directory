...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ecwid.Swaggerparameters();
  });
  ...
  describe('Swaggerparameters', function() {
    it('should create an instance of Swaggerparameters', function() {
      // uncomment below and update the code to test Swaggerparameters
      //var instance = new Ecwid.Swaggerparameters();
      //expect(instance).to.be.a(Ecwid.Swaggerparameters);
    });
