...
(function(root, factory) {
  ...
  describe('OrderPatch', function() {
    it('should create an instance of OrderPatch', function() {
      // uncomment below and update the code to test OrderPatch
      //var instance = new Ecwid.OrderPatch();
      //expect(instance).to.be.a(Ecwid.OrderPatch);
    });
