...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.cloud-elements.com/elements/api-v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.cloud-elements.com/elements/api-v2
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/api-v2/Javascript'
        };
