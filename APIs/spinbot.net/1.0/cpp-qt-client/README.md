...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::getInfoSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::getInfoSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString key = create(); // QString | Your api key
      apiInstance.getInfo(key);
