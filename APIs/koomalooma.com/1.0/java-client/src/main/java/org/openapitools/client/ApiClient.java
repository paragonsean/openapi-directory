...
public class ApiClient {
    ...
    private String basePath = "https://api.koomalooma.com/api";
    ...
    public ApiClient() {
        ...
        authentications.put("api_key", new ApiKeyAuth("header", "X-KoomaLooma-JWT"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.koomalooma.com/api
