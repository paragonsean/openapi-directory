...
public:
    ...
    virtual void usersPost();

    /**
    * @param[in]  user_id QString [required]
    * @param[in]  commitment_request OAICommitmentRequest [required]
    */
    virtual void usersUserIdCommitmentsPost(const QString &user_id, const OAICommitmentRequest &commitment_request);
...
private:
    ...
    void usersUserIdCommitmentsPostCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void usersPostSignal(OAIUser summary);
    void usersUserIdCommitmentsPostSignal(OAICommitment summary);


    void usersPostSignalFull(OAIHttpRequestWorker *worker, OAIUser summary);
    void usersUserIdCommitmentsPostSignalFull(OAIHttpRequestWorker *worker, OAICommitment summary);
    ...
    Q_DECL_DEPRECATED_X("Use usersUserIdCommitmentsPostSignalError() instead")
    void usersUserIdCommitmentsPostSignalE(OAICommitment summary, QNetworkReply::NetworkError error_type, QString error_str);
    void usersUserIdCommitmentsPostSignalError(OAICommitment summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use usersUserIdCommitmentsPostSignalErrorFull() instead")
    void usersUserIdCommitmentsPostSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void usersUserIdCommitmentsPostSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
