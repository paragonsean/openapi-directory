...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoomaloomaPartnerApi.User();
  });
  ...
  describe('User', function() {
    it('should create an instance of User', function() {
      ...
      //var instance = new KoomaloomaPartnerApi.User();
      //expect(instance).to.be.a(KoomaloomaPartnerApi.User);
    });
    ...
    it('should have the property partnerUserId (base name: "partner_user_id")', function() {
      // uncomment below and update the code to test the property partnerUserId
      //var instance = new KoomaloomaPartnerApi.User();
      //expect(instance).to.be();
    });

    it('should have the property userSessionId (base name: "user_session_id")', function() {
      // uncomment below and update the code to test the property userSessionId
      //var instance = new KoomaloomaPartnerApi.User();
      //expect(instance).to.be();
    });
