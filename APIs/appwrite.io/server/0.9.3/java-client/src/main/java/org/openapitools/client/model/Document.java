...
public class Document {
  ...
  public Document $permissions(List<Permissions> $permissions) {
    this.$permissions = $permissions;
    return this;
  }

  public Document add$PermissionsItem(Permissions $permissionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.$collection, document.$collection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash($collection, $id, $permissions, additionalProperties);
  }
