...
public class ApiClient {
    ...
    private String basePath = "https://appwrite.io/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("JWT", new ApiKeyAuth("header", "X-Appwrite-JWT"));
        authentications.put("Key", new ApiKeyAuth("header", "X-Appwrite-Key"));
        authentications.put("Locale", new ApiKeyAuth("header", "X-Appwrite-Locale"));
        authentications.put("Project", new ApiKeyAuth("header", "X-Appwrite-Project"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.9.3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://appwrite.io/v1
