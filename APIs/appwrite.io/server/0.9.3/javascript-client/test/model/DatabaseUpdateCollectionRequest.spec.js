...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Appwrite.DatabaseUpdateCollectionRequest();
  });
  ...
  describe('DatabaseUpdateCollectionRequest', function() {
    it('should create an instance of DatabaseUpdateCollectionRequest', function() {
      // uncomment below and update the code to test DatabaseUpdateCollectionRequest
      //var instance = new Appwrite.DatabaseUpdateCollectionRequest();
      //expect(instance).to.be.a(Appwrite.DatabaseUpdateCollectionRequest);
    });
