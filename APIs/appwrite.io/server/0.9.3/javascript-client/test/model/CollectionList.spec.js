...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Appwrite.CollectionList();
  });
  ...
  describe('CollectionList', function() {
    it('should create an instance of CollectionList', function() {
      // uncomment below and update the code to test CollectionList
      //var instance = new Appwrite.CollectionList();
      //expect(instance).to.be.a(Appwrite.CollectionList);
    });
