...
(function(root, factory) {
  ...
  describe('LogList', function() {
    it('should create an instance of LogList', function() {
      // uncomment below and update the code to test LogList
      //var instance = new Appwrite.LogList();
      //expect(instance).to.be.a(Appwrite.LogList);
    });
