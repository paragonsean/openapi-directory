...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Appwrite.MembershipList();
  });
  ...
  describe('MembershipList', function() {
    it('should create an instance of MembershipList', function() {
      // uncomment below and update the code to test MembershipList
      //var instance = new Appwrite.MembershipList();
      //expect(instance).to.be.a(Appwrite.MembershipList);
    });
