...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Appwrite.DatabaseCreateCollectionRequest();
  });
  ...
  describe('DatabaseCreateCollectionRequest', function() {
    it('should create an instance of DatabaseCreateCollectionRequest', function() {
      // uncomment below and update the code to test DatabaseCreateCollectionRequest
      //var instance = new Appwrite.DatabaseCreateCollectionRequest();
      //expect(instance).to.be.a(Appwrite.DatabaseCreateCollectionRequest);
    });
