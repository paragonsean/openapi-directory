...
public class MembershipList {
  ...
  public MembershipList sum(Integer sum) {
    this.sum = sum;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.memberships, membershipList.memberships) &&
        Objects.equals(this.sum, membershipList.sum);
  }

  @Override
  public int hashCode() {
    return Objects.hash(memberships, sum);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("memberships");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MembershipList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MembershipList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MembershipList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MembershipList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MembershipList.openapiRequiredFields) {
      ...
      // validate the required field `memberships` (array)
