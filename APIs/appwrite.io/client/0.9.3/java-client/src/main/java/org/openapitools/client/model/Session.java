...
public class Session {
  ...
  public static final String SERIALIZED_NAME_PROVIDER_TOKEN = "providerToken";
  ...
  public Session expire(Integer expire) {
    this.expire = expire;
    return this;
  }
  ...
  public Session providerToken(String providerToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.$id, session.$id) &&
        ...
        Objects.equals(this.providerToken, session.providerToken) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash($id, clientCode, clientEngine, clientEngineVersion, clientName, clientType, clientVersion, countryCode, countryName, current, deviceBrand, deviceModel, deviceName, expire, ip, osCode, osName, osVersion, provider, providerToken, providerUid, userId);
  }
  ...
  static {
    ...
    openapiFields.add("providerToken");
    ...
    openapiRequiredFields.add("providerToken");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("providerToken").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `providerToken` to be a primitive type in the JSON string but got `%s`", jsonObj.get("providerToken").toString()));
      }
