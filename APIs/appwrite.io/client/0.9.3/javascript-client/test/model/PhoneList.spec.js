...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Appwrite.PhoneList();
  });
  ...
  describe('PhoneList', function() {
    it('should create an instance of PhoneList', function() {
      // uncomment below and update the code to test PhoneList
      //var instance = new Appwrite.PhoneList();
      //expect(instance).to.be.a(Appwrite.PhoneList);
    });
