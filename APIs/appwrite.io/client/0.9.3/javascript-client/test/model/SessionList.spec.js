...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Appwrite.SessionList();
  });
  ...
  describe('SessionList', function() {
    it('should create an instance of SessionList', function() {
      // uncomment below and update the code to test SessionList
      //var instance = new Appwrite.SessionList();
      //expect(instance).to.be.a(Appwrite.SessionList);
    });
