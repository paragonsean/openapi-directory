...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://appwrite.io/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
        ...
        this.authentications = {
            'JWT': {type: 'apiKey', 'in': 'header', name: 'X-Appwrite-JWT'},
            'Locale': {type: 'apiKey', 'in': 'header', name: 'X-Appwrite-Locale'},
            'Project': {type: 'apiKey', 'in': 'header', name: 'X-Appwrite-Project'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/0.9.3/Javascript'
        };
