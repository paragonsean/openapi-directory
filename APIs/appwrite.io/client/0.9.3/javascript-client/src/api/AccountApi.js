...
export default class AccountApi {
    ...
    */
     ...
     * @param {module:model/AccountCreateRequest} [accountCreateRequest] 
     ...
     */
    accountCreate(opts, callback) {
      opts = opts || {};
      let postBody = opts['accountCreateRequest'];
    ...
    /**
     * Callback function to receive the result of the accountCreateAnonymousSession operation.
     * @callback module:api/AccountApi~accountCreateAnonymousSessionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/AccountApi~accountCreateAnonymousSessionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Session}
     */
    accountCreateAnonymousSession(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the accountCreateJWT operation.
     * @callback module:api/AccountApi~accountCreateJWTCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/AccountApi~accountCreateJWTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Jwt}
     */
    accountCreateJWT(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the accountCreateOAuth2Session operation.
     * @callback module:api/AccountApi~accountCreateOAuth2SessionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [success = 'https://appwrite.io/auth/oauth2/success')] URL to redirect back to your app after a successful login attempt.  Only URLs from hostnames in your project platform list are allowed. This requirement helps to prevent an [open redirect](https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html) attack against your project API.
     * @param {String} [failure = 'https://appwrite.io/auth/oauth2/failure')] URL to redirect back to your app after a failed login attempt.  Only URLs from hostnames in your project platform list are allowed. This requirement helps to prevent an [open redirect](https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html) attack against your project API.
     ...
     * @param {module:api/AccountApi~accountCreateOAuth2SessionCallback} callback The callback function, accepting three arguments: error, data, response
     */
    accountCreateOAuth2Session(provider, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'provider' is set
      if (provider === undefined || provider === null) {
        throw new Error("Missing the required parameter 'provider' when calling accountCreateOAuth2Session");
      }
    ...
    /**
     * Callback function to receive the result of the accountCreateSession operation.
     * @callback module:api/AccountApi~accountCreateSessionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Session} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/AccountApi~accountCreateSessionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Session}
     */
    accountCreateSession(opts, callback) {
      opts = opts || {};
