...
class Error {
     ...
     * @param version {String} Server version number.
     */
    constructor(code, message, version) { 
        
        Error.initialize(this, code, message, version);
    }
     ...
     */
    static initialize(obj, code, message, version) { 
        obj['code'] = code;
        obj['message'] = message;
        obj['version'] = version;
    }
...
Error.RequiredProperties = ["code", "message", "version"];
 ...
 */
Error.prototype['version'] = undefined;
