...
class Example : public QObject {
    Q_OBJECT
    OAIAccountCreate_request create();
public Q_SLOTS:
...
OAIAccountCreate_request Example::create(){
    OAIAccountCreate_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAccountApi apiInstance;
      ...
      OAIAccountCreate_request oai_account_create_request = create(); // OAIAccountCreate_request | 
      apiInstance.accountCreate(oai_account_create_request);
