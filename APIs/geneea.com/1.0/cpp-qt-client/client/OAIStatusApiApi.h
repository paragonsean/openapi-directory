...
private:
    ...
    void statusCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void statusSignal(QString summary);


    void statusSignalFull(OAIHttpRequestWorker *worker, QString summary);

    Q_DECL_DEPRECATED_X("Use statusSignalError() instead")
    void statusSignalE(QString summary, QNetworkReply::NetworkError error_type, QString error_str);
    void statusSignalError(QString summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use statusSignalErrorFull() instead")
    void statusSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void statusSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
