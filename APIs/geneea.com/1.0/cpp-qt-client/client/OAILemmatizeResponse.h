...
/*
 * OAILemmatizeResponse.h
 *
 * Response for the lemmatization
 */

#ifndef OAILemmatizeResponse_H
#define OAILemmatizeResponse_H
...
class OAILemmatizeResponse : public OAIObject {
public:
    OAILemmatizeResponse();
    OAILemmatizeResponse(QString json);
    ~OAILemmatizeResponse() override;
    ...
    QString getLemmatizedText() const;
    void setLemmatizedText(const QString &lemmatized_text);
    bool is_lemmatized_text_Set() const;
    bool is_lemmatized_text_Valid() const;
...
private:
    ...
    QString m_lemmatized_text;
    bool m_lemmatized_text_isSet;
    bool m_lemmatized_text_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILemmatizeResponse)

#endif // OAILemmatizeResponse_H
