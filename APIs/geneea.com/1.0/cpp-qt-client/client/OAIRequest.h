...
public:
    ...
    QString getExtractor() const;
    void setExtractor(const QString &extractor);
    bool is_extractor_Set() const;
    bool is_extractor_Valid() const;
    ...
    bool isReturnTextInfo() const;
    void setReturnTextInfo(const bool &return_text_info);
    bool is_return_text_info_Set() const;
    bool is_return_text_info_Valid() const;
...
private:
    ...
    QString m_extractor;
    bool m_extractor_isSet;
    bool m_extractor_isValid;
    ...
    bool m_return_text_info;
    bool m_return_text_info_isSet;
    bool m_return_text_info_isValid;
