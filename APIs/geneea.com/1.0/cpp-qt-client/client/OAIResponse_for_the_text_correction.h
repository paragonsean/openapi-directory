...
/*
 * OAIResponse_for_the_text_correction.h
 *
 * 
 */

#ifndef OAIResponse_for_the_text_correction_H
#define OAIResponse_for_the_text_correction_H
...
class OAIResponse_for_the_text_correction : public OAIObject {
public:
    OAIResponse_for_the_text_correction();
    OAIResponse_for_the_text_correction(QString json);
    ~OAIResponse_for_the_text_correction() override;
    ...
    bool isDiacritized() const;
    void setDiacritized(const bool &diacritized);
    bool is_diacritized_Set() const;
    bool is_diacritized_Valid() const;
...
private:
    ...
    bool m_diacritized;
    bool m_diacritized_isSet;
    bool m_diacritized_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse_for_the_text_correction)

#endif // OAIResponse_for_the_text_correction_H
