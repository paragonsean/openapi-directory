...
/*
 * OAIInformation_about_a_user_account_.h
 *
 * 
 */

#ifndef OAIInformation_about_a_user_account__H
#define OAIInformation_about_a_user_account__H
...
namespace OpenAPI {
class OAIEntrystringlong;

class OAIInformation_about_a_user_account_ : public OAIObject {
public:
    OAIInformation_about_a_user_account_();
    OAIInformation_about_a_user_account_(QString json);
    ~OAIInformation_about_a_user_account_() override;
    ...
    QList<OAIEntrystringlong> getRemainingQuotas() const;
    void setRemainingQuotas(const QList<OAIEntrystringlong> &remaining_quotas);
    bool is_remaining_quotas_Set() const;
    bool is_remaining_quotas_Valid() const;
...
private:
    ...
    QList<OAIEntrystringlong> m_remaining_quotas;
    bool m_remaining_quotas_isSet;
    bool m_remaining_quotas_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInformation_about_a_user_account_)

#endif // OAIInformation_about_a_user_account__H
