...
OAIEntrystringlong::OAIEntrystringlong(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntrystringlong::OAIEntrystringlong() {
    this->initializeModel();
}

OAIEntrystringlong::~OAIEntrystringlong() {}

void OAIEntrystringlong::initializeModel() {

    m_key_isSet = false;
    m_key_isValid = false;
}

void OAIEntrystringlong::fromJson(QString jsonString) {
...
void OAIEntrystringlong::fromJsonObject(QJsonObject json) {

    m_key_isValid = ::OpenAPI::fromJsonValue(m_key, json[QString("key")]);
    m_key_isSet = !json[QString("key")].isNull() && m_key_isValid;
}

QString OAIEntrystringlong::asJson() const {
...
QJsonObject OAIEntrystringlong::asJsonObject() const {
    QJsonObject obj;
    if (m_key_isSet) {
...
qint64 OAIEntrystringlong::getKey() const {
    return m_key;
}
void OAIEntrystringlong::setKey(const qint64 &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAIEntrystringlong::is_key_Set() const{
    return m_key_isSet;
}

bool OAIEntrystringlong::is_key_Valid() const{
    return m_key_isValid;
}

bool OAIEntrystringlong::isSet() const {
...
bool OAIEntrystringlong::isValid() const {
