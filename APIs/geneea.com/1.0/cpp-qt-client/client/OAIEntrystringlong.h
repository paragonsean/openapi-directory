...
/*
 * OAIEntrystringlong.h
 *
 * 
 */

#ifndef OAIEntrystringlong_H
#define OAIEntrystringlong_H
...
class OAIEntrystringlong : public OAIObject {
public:
    OAIEntrystringlong();
    OAIEntrystringlong(QString json);
    ~OAIEntrystringlong() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntrystringlong)

#endif // OAIEntrystringlong_H
