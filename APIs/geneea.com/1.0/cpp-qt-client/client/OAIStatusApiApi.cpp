...
void OAIStatusApiApi::status() {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStatusApiApi::statusCallback);
...
void OAIStatusApiApi::statusCallback(OAIHttpRequestWorker *worker) {
