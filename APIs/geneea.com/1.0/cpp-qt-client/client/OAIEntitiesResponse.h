...
/*
 * OAIEntitiesResponse.h
 *
 * Response for the named-entity recognition
 */

#ifndef OAIEntitiesResponse_H
#define OAIEntitiesResponse_H
...
class OAIEntitiesResponse : public OAIObject {
public:
    OAIEntitiesResponse();
    OAIEntitiesResponse(QString json);
    ~OAIEntitiesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntitiesResponse)

#endif // OAIEntitiesResponse_H
