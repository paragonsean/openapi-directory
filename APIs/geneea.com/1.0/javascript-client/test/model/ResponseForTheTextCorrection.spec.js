...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeneeaNaturalLanguageProcessing.ResponseForTheTextCorrection();
  });
  ...
  describe('ResponseForTheTextCorrection', function() {
    it('should create an instance of ResponseForTheTextCorrection', function() {
      // uncomment below and update the code to test ResponseForTheTextCorrection
      //var instance = new GeneeaNaturalLanguageProcessing.ResponseForTheTextCorrection();
      //expect(instance).to.be.a(GeneeaNaturalLanguageProcessing.ResponseForTheTextCorrection);
    });
    ...
    it('should have the property diacritized (base name: "diacritized")', function() {
      // uncomment below and update the code to test the property diacritized
      //var instance = new GeneeaNaturalLanguageProcessing.ResponseForTheTextCorrection();
      //expect(instance).to.be();
    });
