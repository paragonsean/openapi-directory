...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeneeaNaturalLanguageProcessing.Entity();
  });
  ...
  describe('Entity', function() {
    it('should create an instance of Entity', function() {
      ...
      //var instance = new GeneeaNaturalLanguageProcessing.Entity();
      //expect(instance).to.be.a(GeneeaNaturalLanguageProcessing.Entity);
    });
    ...
    it('should have the property textOffset (base name: "textOffset")', function() {
