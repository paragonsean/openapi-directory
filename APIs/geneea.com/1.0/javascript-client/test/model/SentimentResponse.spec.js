...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeneeaNaturalLanguageProcessing.SentimentResponse();
  });
  ...
  describe('SentimentResponse', function() {
    it('should create an instance of SentimentResponse', function() {
      ...
      //var instance = new GeneeaNaturalLanguageProcessing.SentimentResponse();
      //expect(instance).to.be.a(GeneeaNaturalLanguageProcessing.SentimentResponse);
    });
