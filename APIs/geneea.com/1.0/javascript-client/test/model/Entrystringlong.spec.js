...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeneeaNaturalLanguageProcessing.Entrystringlong();
  });
  ...
  describe('Entrystringlong', function() {
    it('should create an instance of Entrystringlong', function() {
      // uncomment below and update the code to test Entrystringlong
      //var instance = new GeneeaNaturalLanguageProcessing.Entrystringlong();
      //expect(instance).to.be.a(GeneeaNaturalLanguageProcessing.Entrystringlong);
    });
