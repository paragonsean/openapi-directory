...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeneeaNaturalLanguageProcessing.InformationAboutAUserAccount();
  });
  ...
  describe('InformationAboutAUserAccount', function() {
    it('should create an instance of InformationAboutAUserAccount', function() {
      // uncomment below and update the code to test InformationAboutAUserAccount
      //var instance = new GeneeaNaturalLanguageProcessing.InformationAboutAUserAccount();
      //expect(instance).to.be.a(GeneeaNaturalLanguageProcessing.InformationAboutAUserAccount);
    });

    it('should have the property remainingQuotas (base name: "remainingQuotas")', function() {
      // uncomment below and update the code to test the property remainingQuotas
      //var instance = new GeneeaNaturalLanguageProcessing.InformationAboutAUserAccount();
