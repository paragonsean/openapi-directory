...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeneeaNaturalLanguageProcessing.EntitiesResponse();
  });
  ...
  describe('EntitiesResponse', function() {
    it('should create an instance of EntitiesResponse', function() {
      // uncomment below and update the code to test EntitiesResponse
      //var instance = new GeneeaNaturalLanguageProcessing.EntitiesResponse();
      //expect(instance).to.be.a(GeneeaNaturalLanguageProcessing.EntitiesResponse);
    });
