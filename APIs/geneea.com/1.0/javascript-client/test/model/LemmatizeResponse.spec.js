...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeneeaNaturalLanguageProcessing.LemmatizeResponse();
  });
  ...
  describe('LemmatizeResponse', function() {
    it('should create an instance of LemmatizeResponse', function() {
      // uncomment below and update the code to test LemmatizeResponse
      //var instance = new GeneeaNaturalLanguageProcessing.LemmatizeResponse();
      //expect(instance).to.be.a(GeneeaNaturalLanguageProcessing.LemmatizeResponse);
    });
    ...
    it('should have the property lemmatizedText (base name: "lemmatizedText")', function() {
      // uncomment below and update the code to test the property lemmatizedText
      //var instance = new GeneeaNaturalLanguageProcessing.LemmatizeResponse();
      //expect(instance).to.be();
    });
