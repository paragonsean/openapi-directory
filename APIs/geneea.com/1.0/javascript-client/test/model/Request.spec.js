...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeneeaNaturalLanguageProcessing.Request();
  });
  ...
  describe('Request', function() {
    it('should create an instance of Request', function() {
      ...
      //var instance = new GeneeaNaturalLanguageProcessing.Request();
      //expect(instance).to.be.a(GeneeaNaturalLanguageProcessing.Request);
    });
    ...
    it('should have the property returnTextInfo (base name: "returnTextInfo")', function() {
      // uncomment below and update the code to test the property returnTextInfo
      //var instance = new GeneeaNaturalLanguageProcessing.Request();
      //expect(instance).to.be();
    });
