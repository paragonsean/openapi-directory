...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeneeaNaturalLanguageProcessing.Label();
  });
  ...
  describe('Label', function() {
    it('should create an instance of Label', function() {
      ...
      //var instance = new GeneeaNaturalLanguageProcessing.Label();
      //expect(instance).to.be.a(GeneeaNaturalLanguageProcessing.Label);
    });
