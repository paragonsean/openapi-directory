...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeneeaNaturalLanguageProcessing.GeneeaApiS1Api();
  });
  ...
  describe('GeneeaApiS1Api', function() {
    describe('correctionGet', function() {
      it('should call correctionGet successfully', function(done) {
        //uncomment below and update the code to test correctionGet
        //instance.correctionGet(function(error) {
    ...
    describe('correctionPost', function() {
      it('should call correctionPost successfully', function(done) {
        //uncomment below and update the code to test correctionPost
        //instance.correctionPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('lemmatizeGet', function() {
      it('should call lemmatizeGet successfully', function(done) {
        //uncomment below and update the code to test lemmatizeGet
        //instance.lemmatizeGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('lemmatizePost', function() {
      it('should call lemmatizePost successfully', function(done) {
        //uncomment below and update the code to test lemmatizePost
        //instance.lemmatizePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('sentimentGet', function() {
      it('should call sentimentGet successfully', function(done) {
        //uncomment below and update the code to test sentimentGet
        //instance.sentimentGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('sentimentPost', function() {
      it('should call sentimentPost successfully', function(done) {
        //uncomment below and update the code to test sentimentPost
        //instance.sentimentPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('topicGet', function() {
      it('should call topicGet successfully', function(done) {
        ...
        //instance.topicGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('topicPost', function() {
      it('should call topicPost successfully', function(done) {
        //uncomment below and update the code to test topicPost
        //instance.topicPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
