# GeneeaNaturalLanguageProcessing.Request

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**extractor** | **String** | [optional] Text extractor to be used when analyzing HTML document | [optional] 
...
* `keep-everything` (value: `"keep-everything"`)
