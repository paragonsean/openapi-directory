...
export default class StatusApiApi {
    ...
    */
     ...
     * @callback module:api/StatusApiApi~statusCallback
     ...
     * status
     * @param {module:api/StatusApiApi~statusCallback} callback The callback function, accepting three arguments: error, data, response
