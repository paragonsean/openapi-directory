...
export default class AccountApi {
    ...
    */
     ...
     * @callback module:api/AccountApi~getInfoCallback
     ...
     * getInfo
     * @param {module:api/AccountApi~getInfoCallback} callback The callback function, accepting three arguments: error, data, response
