...
import Entrystringlong from './Entrystringlong';

/**
 * The InformationAboutAUserAccount model module.
 * @module model/InformationAboutAUserAccount
 * @version 1.0
 */
class InformationAboutAUserAccount {
    /**
     * Constructs a new <code>InformationAboutAUserAccount</code>.
     * @alias module:model/InformationAboutAUserAccount
     */
    constructor() { 
        
        InformationAboutAUserAccount.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InformationAboutAUserAccount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InformationAboutAUserAccount} obj Optional instance to populate.
     * @return {module:model/InformationAboutAUserAccount} The populated <code>InformationAboutAUserAccount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InformationAboutAUserAccount();

            if (data.hasOwnProperty('remainingQuotas')) {
                obj['remainingQuotas'] = ApiClient.convertToType(data['remainingQuotas'], [Entrystringlong]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>InformationAboutAUserAccount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InformationAboutAUserAccount</code>.
     */
    static validateJSON(data) {
        if (data['remainingQuotas']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['remainingQuotas'])) {
                throw new Error("Expected the field `remainingQuotas` to be an array in the JSON data but got " + data['remainingQuotas']);
            }
            // validate the optional field `remainingQuotas` (array)
            for (const item of data['remainingQuotas']) {
                Entrystringlong.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/Entrystringlong>} remainingQuotas
 */
InformationAboutAUserAccount.prototype['remainingQuotas'] = undefined;

/**
 * Type (plan) of the user account.
 * @member {String} type
 */
InformationAboutAUserAccount.prototype['type'] = undefined;
...
export default InformationAboutAUserAccount;
