...
/**
 * The EntitiesResponse model module.
 * @module model/EntitiesResponse
 * @version 1.0
 */
class EntitiesResponse {
    /**
     * Constructs a new <code>EntitiesResponse</code>.
     * Response for the named-entity recognition
     * @alias module:model/EntitiesResponse
     * @param entities {Array.<module:model/Entity>} Found named entities in the document
     * @param language {String} The used language of the document
     */
    constructor(entities, language) { 
        
        EntitiesResponse.initialize(this, entities, language);
    }
     ...
     */
    static initialize(obj, entities, language) { 
        obj['entities'] = entities;
        obj['language'] = language;
    }

    /**
     * Constructs a <code>EntitiesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EntitiesResponse} obj Optional instance to populate.
     * @return {module:model/EntitiesResponse} The populated <code>EntitiesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EntitiesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>EntitiesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EntitiesResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EntitiesResponse.RequiredProperties) {
...
EntitiesResponse.RequiredProperties = ["entities", "language"];

/**
 * Found named entities in the document
 * @member {Array.<module:model/Entity>} entities
 */
EntitiesResponse.prototype['entities'] = undefined;

/**
 * Unique identifier of the document
 * @member {String} id
 */
EntitiesResponse.prototype['id'] = undefined;

/**
 * The used language of the document
 * @member {String} language
 */
EntitiesResponse.prototype['language'] = undefined;

/**
 * The raw text of the document which has been analysed
 * @member {String} text
 */
EntitiesResponse.prototype['text'] = undefined;
...
export default EntitiesResponse;
