...
class Label {
     ...
     * @param confidence {Number} Confidence (probability) of this label
     * @param label {String} The value of this label
     */
    constructor(confidence, label) { 
        
        Label.initialize(this, confidence, label);
    }
     ...
     */
    static initialize(obj, confidence, label) { 
...
Label.RequiredProperties = ["confidence", "label"];
