...
class TopicResponse {
     ...
     * @param confidence {Number} Confidence for the detected topic
     * @param labels {Array.<module:model/Label>} Probabilistic distribution over possible topic labels
     * @param language {String} The used language of the document
     * @param topic {String} Detected topic of the document
     */
    constructor(confidence, labels, language, topic) { 
        
        TopicResponse.initialize(this, confidence, labels, language, topic);
    }
     ...
     */
    static initialize(obj, confidence, labels, language, topic) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of TopicResponse.RequiredProperties) {
...
TopicResponse.RequiredProperties = ["confidence", "labels", "language", "topic"];

/**
 * Confidence for the detected topic
 * @member {Number} confidence
 */
TopicResponse.prototype['confidence'] = undefined;
 ...
 */
TopicResponse.prototype['labels'] = undefined;

/**
 * The used language of the document
 * @member {String} language
 */
TopicResponse.prototype['language'] = undefined;

/**
 * The raw text of the document which has been analysed
 * @member {String} text
 */
TopicResponse.prototype['text'] = undefined;

/**
 * Detected topic of the document
 * @member {String} topic
 */
TopicResponse.prototype['topic'] = undefined;
