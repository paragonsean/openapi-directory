...
/**
 * The LemmatizeResponse model module.
 * @module model/LemmatizeResponse
 * @version 1.0
 */
class LemmatizeResponse {
    /**
     * Constructs a new <code>LemmatizeResponse</code>.
     * Response for the lemmatization
     * @alias module:model/LemmatizeResponse
     * @param language {String} The used language of the document
     * @param lemmatizedText {String} Lemmatized text of the document, individual tokens are separated by a space and sentences are separated by a new-line character
     */
    constructor(language, lemmatizedText) { 
        
        LemmatizeResponse.initialize(this, language, lemmatizedText);
    }
     ...
     */
    static initialize(obj, language, lemmatizedText) { 
        obj['language'] = language;
        obj['lemmatizedText'] = lemmatizedText;
    }

    /**
     * Constructs a <code>LemmatizeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LemmatizeResponse} obj Optional instance to populate.
     * @return {module:model/LemmatizeResponse} The populated <code>LemmatizeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LemmatizeResponse();
            ...
            if (data.hasOwnProperty('lemmatizedText')) {
                obj['lemmatizedText'] = ApiClient.convertToType(data['lemmatizedText'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LemmatizeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LemmatizeResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LemmatizeResponse.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['lemmatizedText'] && !(typeof data['lemmatizedText'] === 'string' || data['lemmatizedText'] instanceof String)) {
            throw new Error("Expected the field `lemmatizedText` to be a primitive type in the JSON string but got " + data['lemmatizedText']);
        }
        // ensure the json data is a string
...
LemmatizeResponse.RequiredProperties = ["language", "lemmatizedText"];

/**
 * Unique identifier of the document
 * @member {String} id
 */
LemmatizeResponse.prototype['id'] = undefined;

/**
 * The used language of the document
 * @member {String} language
 */
LemmatizeResponse.prototype['language'] = undefined;
 ...
 * @member {String} lemmatizedText
 */
LemmatizeResponse.prototype['lemmatizedText'] = undefined;

/**
 * The raw text of the document which has been analysed
 * @member {String} text
 */
LemmatizeResponse.prototype['text'] = undefined;
...
export default LemmatizeResponse;
