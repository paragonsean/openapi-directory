...
/**
 * The Entrystringlong model module.
 * @module model/Entrystringlong
 * @version 1.0
 */
class Entrystringlong {
    /**
     * Constructs a new <code>Entrystringlong</code>.
     * @alias module:model/Entrystringlong
     */
    constructor() { 
        
        Entrystringlong.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Entrystringlong</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Entrystringlong} obj Optional instance to populate.
     * @return {module:model/Entrystringlong} The populated <code>Entrystringlong</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Entrystringlong();
    ...
    /**
     * Validates the JSON data with respect to <code>Entrystringlong</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Entrystringlong</code>.
     */
 ...
 * @member {Number} key
 */
Entrystringlong.prototype['key'] = undefined;
...
export default Entrystringlong;
