...
class Request {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('extractor')) {
                obj['extractor'] = ApiClient.convertToType(data['extractor'], 'String');
            }
            ...
            if (data.hasOwnProperty('returnTextInfo')) {
                obj['returnTextInfo'] = ApiClient.convertToType(data['returnTextInfo'], 'Boolean');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['extractor'] && !(typeof data['extractor'] === 'string' || data['extractor'] instanceof String)) {
            throw new Error("Expected the field `extractor` to be a primitive type in the JSON string but got " + data['extractor']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/Request.ExtractorEnum} extractor
 */
Request.prototype['extractor'] = undefined;
...
/**
 * Allowed values for the <code>extractor</code> property.
 * @enum {String}
 * @readonly
 */
Request['ExtractorEnum'] = {
