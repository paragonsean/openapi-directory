...
class SentimentResponse {
     ...
     * @param sentiment {Number} Detected sentiment of the document (value from -1.0 to 1.0)
     */
    constructor(language, sentiment) { 
        
        SentimentResponse.initialize(this, language, sentiment);
    }
     ...
     */
    static initialize(obj, language, sentiment) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of SentimentResponse.RequiredProperties) {
...
SentimentResponse.RequiredProperties = ["language", "sentiment"];

/**
 * Unique identifier of the document
 * @member {String} id
 */
SentimentResponse.prototype['id'] = undefined;

/**
 * The used language of the document
 * @member {String} language
 */
SentimentResponse.prototype['language'] = undefined;

/**
 * Detected sentiment of the document (value from -1.0 to 1.0)
 * @member {Number} sentiment
 */
SentimentResponse.prototype['sentiment'] = undefined;

/**
 * The raw text of the document which has been analysed
 * @member {String} text
 */
SentimentResponse.prototype['text'] = undefined;
