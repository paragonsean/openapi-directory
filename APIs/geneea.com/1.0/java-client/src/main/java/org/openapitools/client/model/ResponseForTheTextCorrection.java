...
public class ResponseForTheTextCorrection {
  ...
  public static final String SERIALIZED_NAME_DIACRITIZED = "diacritized";
  @SerializedName(SERIALIZED_NAME_DIACRITIZED)
  private Boolean diacritized;
  ...
  public ResponseForTheTextCorrection() {
  }

  public ResponseForTheTextCorrection corrected(Boolean corrected) {
  ...
  public ResponseForTheTextCorrection correctedText(String correctedText) {
  ...
  public ResponseForTheTextCorrection diacritized(Boolean diacritized) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getDiacritized() {
    return diacritized;
  }

  public void setDiacritized(Boolean diacritized) {
    this.diacritized = diacritized;
  }


  public ResponseForTheTextCorrection id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ResponseForTheTextCorrection language(String language) {
  ...
  public ResponseForTheTextCorrection text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResponseForTheTextCorrection responseForTheTextCorrection = (ResponseForTheTextCorrection) o;
    return Objects.equals(this.corrected, responseForTheTextCorrection.corrected) &&
        Objects.equals(this.correctedText, responseForTheTextCorrection.correctedText) &&
        Objects.equals(this.diacritized, responseForTheTextCorrection.diacritized) &&
        Objects.equals(this.id, responseForTheTextCorrection.id) &&
        Objects.equals(this.language, responseForTheTextCorrection.language) &&
        Objects.equals(this.text, responseForTheTextCorrection.text);
  }

  @Override
  public int hashCode() {
    return Objects.hash(corrected, correctedText, diacritized, id, language, text);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ResponseForTheTextCorrection {\n");
    ...
    sb.append("    diacritized: ").append(toIndentedString(diacritized)).append("\n");
  ...
  static {
    ...
    openapiRequiredFields.add("correctedText");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResponseForTheTextCorrection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseForTheTextCorrection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseForTheTextCorrection is not found in the empty JSON string", ResponseForTheTextCorrection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResponseForTheTextCorrection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseForTheTextCorrection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResponseForTheTextCorrection.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("correctedText").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseForTheTextCorrection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseForTheTextCorrection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseForTheTextCorrection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseForTheTextCorrection.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseForTheTextCorrection>() {
           @Override
           public void write(JsonWriter out, ResponseForTheTextCorrection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseForTheTextCorrection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResponseForTheTextCorrection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResponseForTheTextCorrection
   * @throws IOException if the JSON string is invalid with respect to ResponseForTheTextCorrection
   */
  public static ResponseForTheTextCorrection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseForTheTextCorrection.class);
  }

  /**
   * Convert an instance of ResponseForTheTextCorrection to an JSON string
   *
   * @return JSON string
   */
