...
public class LemmatizeResponse {
  ...
  public static final String SERIALIZED_NAME_LEMMATIZED_TEXT = "lemmatizedText";
  @SerializedName(SERIALIZED_NAME_LEMMATIZED_TEXT)
  ...
  public LemmatizeResponse() {
  }

  public LemmatizeResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public LemmatizeResponse language(String language) {
  ...
  public LemmatizeResponse lemmatizedText(String lemmatizedText) {
  ...
  public LemmatizeResponse text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LemmatizeResponse lemmatizeResponse = (LemmatizeResponse) o;
    return Objects.equals(this.id, lemmatizeResponse.id) &&
        Objects.equals(this.language, lemmatizeResponse.language) &&
        Objects.equals(this.lemmatizedText, lemmatizeResponse.lemmatizedText) &&
        Objects.equals(this.text, lemmatizeResponse.text);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, language, lemmatizedText, text);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LemmatizeResponse {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    language: ").append(toIndentedString(language)).append("\n");
    sb.append("    lemmatizedText: ").append(toIndentedString(lemmatizedText)).append("\n");
  ...
  static {
    ...
    openapiFields.add("lemmatizedText");
    openapiFields.add("text");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("language");
    openapiRequiredFields.add("lemmatizedText");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LemmatizeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LemmatizeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LemmatizeResponse is not found in the empty JSON string", LemmatizeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LemmatizeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LemmatizeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LemmatizeResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("lemmatizedText").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `lemmatizedText` to be a primitive type in the JSON string but got `%s`", jsonObj.get("lemmatizedText").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LemmatizeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LemmatizeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LemmatizeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LemmatizeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LemmatizeResponse>() {
           @Override
           public void write(JsonWriter out, LemmatizeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LemmatizeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LemmatizeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LemmatizeResponse
   * @throws IOException if the JSON string is invalid with respect to LemmatizeResponse
   */
  public static LemmatizeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LemmatizeResponse.class);
  }

  /**
   * Convert an instance of LemmatizeResponse to an JSON string
   *
   * @return JSON string
   */
