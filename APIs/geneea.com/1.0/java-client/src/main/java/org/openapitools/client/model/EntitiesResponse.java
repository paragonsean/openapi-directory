...
public class EntitiesResponse {
  ...
  public EntitiesResponse entities(List<Entity> entities) {
    this.entities = entities;
    return this;
  }

  public EntitiesResponse addEntitiesItem(Entity entitiesItem) {
  ...
  public EntitiesResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public EntitiesResponse language(String language) {
  ...
  public EntitiesResponse text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entities, entitiesResponse.entities) &&
        Objects.equals(this.id, entitiesResponse.id) &&
        Objects.equals(this.language, entitiesResponse.language) &&
        Objects.equals(this.text, entitiesResponse.text);
  }

  @Override
  public int hashCode() {
    return Objects.hash(entities, id, language, text);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntitiesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntitiesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntitiesResponse is not found in the empty JSON string", EntitiesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EntitiesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntitiesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EntitiesResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntitiesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntitiesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntitiesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntitiesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EntitiesResponse>() {
           @Override
           public void write(JsonWriter out, EntitiesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EntitiesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EntitiesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntitiesResponse
   * @throws IOException if the JSON string is invalid with respect to EntitiesResponse
   */
  public static EntitiesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntitiesResponse.class);
  }

  /**
   * Convert an instance of EntitiesResponse to an JSON string
   *
   * @return JSON string
   */
