...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDrvApi.TokensApi();
  });
  ...
  describe('TokensApi', function() {
    ...
    describe('postTokens', function() {
      it('should call postTokens successfully', function(done) {
        //uncomment below and update the code to test postTokens
        //instance.postTokens(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
