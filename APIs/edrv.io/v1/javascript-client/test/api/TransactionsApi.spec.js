...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDrvApi.TransactionsApi();
  });
  ...
  describe('TransactionsApi', function() {
    ...
    describe('getTransactionCost', function() {
      it('should call getTransactionCost successfully', function(done) {
        //uncomment below and update the code to test getTransactionCost
        //instance.getTransactionCost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
