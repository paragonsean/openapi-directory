...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDrvApi.ConfigurationsApi();
  });
  ...
  describe('ConfigurationsApi', function() {
    ...
    describe('postConfigurations', function() {
      it('should call postConfigurations successfully', function(done) {
        //uncomment below and update the code to test postConfigurations
        //instance.postConfigurations(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
