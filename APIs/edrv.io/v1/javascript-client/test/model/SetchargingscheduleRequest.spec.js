...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDrvApi.SetchargingscheduleRequest();
  });
  ...
  describe('SetchargingscheduleRequest', function() {
    it('should create an instance of SetchargingscheduleRequest', function() {
      // uncomment below and update the code to test SetchargingscheduleRequest
      //var instance = new EDrvApi.SetchargingscheduleRequest();
      //expect(instance).to.be.a(EDrvApi.SetchargingscheduleRequest);
    });
