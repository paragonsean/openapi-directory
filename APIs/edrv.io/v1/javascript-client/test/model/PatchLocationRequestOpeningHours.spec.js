...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDrvApi.PatchLocationRequestOpeningHours();
  });
  ...
  describe('PatchLocationRequestOpeningHours', function() {
    it('should create an instance of PatchLocationRequestOpeningHours', function() {
      // uncomment below and update the code to test PatchLocationRequestOpeningHours
      //var instance = new EDrvApi.PatchLocationRequestOpeningHours();
      //expect(instance).to.be.a(EDrvApi.PatchLocationRequestOpeningHours);
    });
