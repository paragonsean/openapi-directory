...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDrvApi.PatchOrganizationRequestLinks();
  });
  ...
  describe('PatchOrganizationRequestLinks', function() {
    it('should create an instance of PatchOrganizationRequestLinks', function() {
      // uncomment below and update the code to test PatchOrganizationRequestLinks
      //var instance = new EDrvApi.PatchOrganizationRequestLinks();
      //expect(instance).to.be.a(EDrvApi.PatchOrganizationRequestLinks);
    });
