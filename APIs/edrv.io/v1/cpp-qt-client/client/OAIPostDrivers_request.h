...
/*
 * OAIPostDrivers_request.h
 *
 * 
 */

#ifndef OAIPostDrivers_request_H
#define OAIPostDrivers_request_H
...
class OAIPostDrivers_request : public OAIObject {
public:
    OAIPostDrivers_request();
    OAIPostDrivers_request(QString json);
    ~OAIPostDrivers_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostDrivers_request)

#endif // OAIPostDrivers_request_H
