...
/*
 * OAIPostTokens_request.h
 *
 * 
 */

#ifndef OAIPostTokens_request_H
#define OAIPostTokens_request_H
...
class OAIPostTokens_request : public OAIObject {
public:
    OAIPostTokens_request();
    OAIPostTokens_request(QString json);
    ~OAIPostTokens_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostTokens_request)

#endif // OAIPostTokens_request_H
