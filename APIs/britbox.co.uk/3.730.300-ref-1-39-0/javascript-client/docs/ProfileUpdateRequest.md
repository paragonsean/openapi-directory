# RocketServices.ProfileUpdateRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**heroAutoplay** | **Boolean** | Sets the Hero row clip auto playback enabled | [optional] 
**heroWithAudio** | **Boolean** | Sets the Hero row clip auto playback audio enabled | [optional] 
...
**name** | **String** | The unique name of the profile. | [optional] 
