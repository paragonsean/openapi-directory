# RocketServices.RegistrationApi
...
> [AccessToken] register(registrationRequest, opts)
...
let apiInstance = new RocketServices.RegistrationApi();
let registrationRequest = new RocketServices.RegistrationRequest(); // RegistrationRequest | Registration details.
let opts = {
...
apiInstance.register(registrationRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
