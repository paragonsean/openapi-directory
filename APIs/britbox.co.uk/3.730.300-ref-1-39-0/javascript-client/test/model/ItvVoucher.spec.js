...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.ItvVoucher();
  });
  ...
  describe('ItvVoucher', function() {
    it('should create an instance of ItvVoucher', function() {
      // uncomment below and update the code to test ItvVoucher
      //var instance = new RocketServices.ItvVoucher();
      //expect(instance).to.be.a(RocketServices.ItvVoucher);
    });
