...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.EeSessionIdRequest();
  });
  ...
  describe('EeSessionIdRequest', function() {
    it('should create an instance of EeSessionIdRequest', function() {
      // uncomment below and update the code to test EeSessionIdRequest
      //var instance = new RocketServices.EeSessionIdRequest();
      //expect(instance).to.be.a(RocketServices.EeSessionIdRequest);
    });
