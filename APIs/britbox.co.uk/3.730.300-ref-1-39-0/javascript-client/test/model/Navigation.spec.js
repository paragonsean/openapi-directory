...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.Navigation();
  });
  ...
  describe('Navigation', function() {
    it('should create an instance of Navigation', function() {
      // uncomment below and update the code to test Navigation
      //var instance = new RocketServices.Navigation();
      //expect(instance).to.be.a(RocketServices.Navigation);
    });
