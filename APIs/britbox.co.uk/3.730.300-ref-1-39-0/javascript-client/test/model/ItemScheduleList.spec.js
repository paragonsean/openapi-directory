...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.ItemScheduleList();
  });
  ...
  describe('ItemScheduleList', function() {
    it('should create an instance of ItemScheduleList', function() {
      // uncomment below and update the code to test ItemScheduleList
      //var instance = new RocketServices.ItemScheduleList();
      //expect(instance).to.be.a(RocketServices.ItemScheduleList);
    });
