...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.AppConfigPlayback();
  });
  ...
  describe('AppConfigPlayback', function() {
    it('should create an instance of AppConfigPlayback', function() {
      // uncomment below and update the code to test AppConfigPlayback
      //var instance = new RocketServices.AppConfigPlayback();
      //expect(instance).to.be.a(RocketServices.AppConfigPlayback);
    });
