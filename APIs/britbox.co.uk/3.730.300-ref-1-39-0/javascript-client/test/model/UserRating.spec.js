...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.UserRating();
  });
  ...
  describe('UserRating', function() {
    it('should create an instance of UserRating', function() {
      // uncomment below and update the code to test UserRating
      //var instance = new RocketServices.UserRating();
      //expect(instance).to.be.a(RocketServices.UserRating);
    });
