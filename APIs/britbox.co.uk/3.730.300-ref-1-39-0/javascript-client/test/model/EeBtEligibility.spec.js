...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.EeBtEligibility();
  });
  ...
  describe('EeBtEligibility', function() {
    it('should create an instance of EeBtEligibility', function() {
      // uncomment below and update the code to test EeBtEligibility
      //var instance = new RocketServices.EeBtEligibility();
      //expect(instance).to.be.a(RocketServices.EeBtEligibility);
    });
