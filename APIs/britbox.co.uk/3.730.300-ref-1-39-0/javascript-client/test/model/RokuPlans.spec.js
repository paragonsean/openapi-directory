...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.RokuPlans();
  });
  ...
  describe('RokuPlans', function() {
    it('should create an instance of RokuPlans', function() {
      // uncomment below and update the code to test RokuPlans
      //var instance = new RocketServices.RokuPlans();
      //expect(instance).to.be.a(RocketServices.RokuPlans);
    });
