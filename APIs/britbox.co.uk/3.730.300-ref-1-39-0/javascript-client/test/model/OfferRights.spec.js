...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.OfferRights();
  });
  ...
  describe('OfferRights', function() {
    it('should create an instance of OfferRights', function() {
      // uncomment below and update the code to test OfferRights
      //var instance = new RocketServices.OfferRights();
      //expect(instance).to.be.a(RocketServices.OfferRights);
    });
