...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.ItvEntitlement();
  });
  ...
  describe('ItvEntitlement', function() {
    it('should create an instance of ItvEntitlement', function() {
      // uncomment below and update the code to test ItvEntitlement
      //var instance = new RocketServices.ItvEntitlement();
      //expect(instance).to.be.a(RocketServices.ItvEntitlement);
    });
