...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.NavContent();
  });
  ...
  describe('NavContent', function() {
    it('should create an instance of NavContent', function() {
      // uncomment below and update the code to test NavContent
      //var instance = new RocketServices.NavContent();
      //expect(instance).to.be.a(RocketServices.NavContent);
    });
