...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.EeIdentityRequest();
  });
  ...
  describe('EeIdentityRequest', function() {
    it('should create an instance of EeIdentityRequest', function() {
      // uncomment below and update the code to test EeIdentityRequest
      //var instance = new RocketServices.EeIdentityRequest();
      //expect(instance).to.be.a(RocketServices.EeIdentityRequest);
    });
