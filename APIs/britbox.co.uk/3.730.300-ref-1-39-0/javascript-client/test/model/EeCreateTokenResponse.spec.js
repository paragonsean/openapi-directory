...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.EeCreateTokenResponse();
  });
  ...
  describe('EeCreateTokenResponse', function() {
    it('should create an instance of EeCreateTokenResponse', function() {
      // uncomment below and update the code to test EeCreateTokenResponse
      //var instance = new RocketServices.EeCreateTokenResponse();
      //expect(instance).to.be.a(RocketServices.EeCreateTokenResponse);
    });
