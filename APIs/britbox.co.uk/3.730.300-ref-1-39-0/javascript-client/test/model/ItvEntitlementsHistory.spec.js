...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.ItvEntitlementsHistory();
  });
  ...
  describe('ItvEntitlementsHistory', function() {
    it('should create an instance of ItvEntitlementsHistory', function() {
      // uncomment below and update the code to test ItvEntitlementsHistory
      //var instance = new RocketServices.ItvEntitlementsHistory();
      //expect(instance).to.be.a(RocketServices.ItvEntitlementsHistory);
    });
