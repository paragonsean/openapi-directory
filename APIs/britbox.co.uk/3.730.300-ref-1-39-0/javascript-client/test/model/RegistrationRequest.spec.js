...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RocketServices.RegistrationRequest();
  });
  ...
  describe('RegistrationRequest', function() {
    it('should create an instance of RegistrationRequest', function() {
      ...
      //var instance = new RocketServices.RegistrationRequest();
      //expect(instance).to.be.a(RocketServices.RegistrationRequest);
    });
