...
class ApiClient {
    ...
    constructor(basePath = '/api') {
        ...
        this.authentications = {
            'accountAuth': {type: 'oauth2'},
            'profileAuth': {type: 'oauth2'},
            'resetPasswordAuth': {type: 'apiKey', 'in': 'header', name: 'authorization'},
            'verifyEmailAuth': {type: 'apiKey', 'in': 'header', name: 'authorization'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/3.730.300-ref-1-39-0/Javascript'
        };
