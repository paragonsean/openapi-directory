...
class DeviceAuthorizationCode {
    ...
    constructor(code) { 
        ...
        DeviceAuthorizationCode.initialize(this, code);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of DeviceAuthorizationCode.RequiredProperties) {
...
DeviceAuthorizationCode.RequiredProperties = ["code"];

/**
 * The generated device authorization code.
 * @member {String} code
 */
DeviceAuthorizationCode.prototype['code'] = undefined;
