...
|**entitlements** | [**List&lt;Entitlement&gt;**](Entitlement.md) | The list of entitlements to playback specific items. |  [optional] |
...
|**profiles** | [**List&lt;ProfileSummary&gt;**](ProfileSummary.md) | The list of profiles under this account. |  |
|**segments** | **List&lt;String&gt;** | The segments an account has been placed under |  [optional] |
...
|**subscriptions** | [**List&lt;Subscription&gt;**](Subscription.md) | The list of subscriptions, if any, the account has signed up to. |  [optional] |
