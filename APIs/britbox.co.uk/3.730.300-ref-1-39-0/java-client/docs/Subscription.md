...
|**endDate** | **OffsetDateTime** | The end date of a subscription.  After this date the subscription will become expired. If this is a recurring subscription which has not been cancelled then the account holder will be automatically charged and a new subscription will be activated.  Some subscriptions may not have an end date, in which case this property will not exist.  |  [optional] |
...
|**startDate** | **OffsetDateTime** | The start date of a subscription. |  |
|**status** | [**StatusEnum**](#StatusEnum) | The status of a subscription. |  |
