...
|------------ | ------------- | ------------- | -------------|
|**children** | [**List&lt;NavEntry&gt;**](NavEntry.md) | Child nav entries. |  [optional] |
|**content** | [**NavContent**](NavContent.md) |  |  [optional] |
|**customFields** | **Map&lt;String, Object&gt;** | A map of custom fields defined by a curator for a nav entry. |  [optional] |
|**depth** | **Integer** | The depth of the NavEntry (top level is 0) |  |
