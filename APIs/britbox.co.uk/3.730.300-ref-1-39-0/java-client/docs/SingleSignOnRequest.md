...
|**provider** | [**ProviderEnum**](#ProviderEnum) | The third party single-sign-on provider. |  |
|**scopes** | [**List&lt;ScopesEnum&gt;**](#List&lt;ScopesEnum&gt;) | The scope(s) of the tokens required. For each scope listed an Account and Profile token of that scope will be returned.  |  [optional] |
