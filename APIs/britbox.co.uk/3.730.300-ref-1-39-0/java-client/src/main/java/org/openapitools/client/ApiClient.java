...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("accountAuth", new OAuth());
        authentications.put("profileAuth", new OAuth());
        authentications.put("resetPasswordAuth", new ApiKeyAuth("header", "authorization"));
        authentications.put("verifyEmailAuth", new ApiKeyAuth("header", "authorization"));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "/account/authorization";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/3.730.300-ref-1-39-0/java");
