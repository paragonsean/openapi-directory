...
public class ProfileUpdateRequest {
  ...
  public ProfileUpdateRequest heroAutoplay(Boolean heroAutoplay) {
  ...
  public ProfileUpdateRequest heroWithAudio(Boolean heroWithAudio) {
  ...
  public ProfileUpdateRequest languageCode(String languageCode) {
  ...
  public ProfileUpdateRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ProfileUpdateRequest pinEnabled(Boolean pinEnabled) {
  ...
  public ProfileUpdateRequest purchaseEnabled(Boolean purchaseEnabled) {
  ...
  public ProfileUpdateRequest segments(List<String> segments) {
    this.segments = segments;
    return this;
  }

  public ProfileUpdateRequest addSegmentsItem(String segmentsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.heroAutoplay, profileUpdateRequest.heroAutoplay) &&
        Objects.equals(this.heroWithAudio, profileUpdateRequest.heroWithAudio) &&
        Objects.equals(this.languageCode, profileUpdateRequest.languageCode) &&
        Objects.equals(this.name, profileUpdateRequest.name) &&
        Objects.equals(this.pinEnabled, profileUpdateRequest.pinEnabled) &&
        Objects.equals(this.purchaseEnabled, profileUpdateRequest.purchaseEnabled) &&
        Objects.equals(this.segments, profileUpdateRequest.segments);
  }

  @Override
  public int hashCode() {
    return Objects.hash(heroAutoplay, heroWithAudio, languageCode, name, pinEnabled, purchaseEnabled, segments);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProfileUpdateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProfileUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProfileUpdateRequest is not found in the empty JSON string", ProfileUpdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProfileUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProfileUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProfileUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProfileUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProfileUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProfileUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProfileUpdateRequest>() {
           @Override
           public void write(JsonWriter out, ProfileUpdateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProfileUpdateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProfileUpdateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProfileUpdateRequest
   * @throws IOException if the JSON string is invalid with respect to ProfileUpdateRequest
   */
  public static ProfileUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProfileUpdateRequest.class);
  }

  /**
   * Convert an instance of ProfileUpdateRequest to an JSON string
   *
   * @return JSON string
   */
