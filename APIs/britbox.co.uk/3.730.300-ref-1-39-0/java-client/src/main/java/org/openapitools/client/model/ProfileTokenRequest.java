...
public class ProfileTokenRequest {
  ...
  public ProfileTokenRequest cookieType(CookieTypeEnum cookieType) {
  ...
  public ProfileTokenRequest pin(String pin) {
    this.pin = pin;
    return this;
  }
  ...
  public ProfileTokenRequest profileId(String profileId) {
  ...
  public ProfileTokenRequest scopes(List<ScopesEnum> scopes) {
    this.scopes = scopes;
    return this;
  }

  public ProfileTokenRequest addScopesItem(ScopesEnum scopesItem) {
    if (this.scopes == null) {
  ...
  public boolean equals(Object o) {
    ...
    ProfileTokenRequest profileTokenRequest = (ProfileTokenRequest) o;
    return Objects.equals(this.cookieType, profileTokenRequest.cookieType) &&
        Objects.equals(this.pin, profileTokenRequest.pin) &&
        Objects.equals(this.profileId, profileTokenRequest.profileId) &&
        Objects.equals(this.scopes, profileTokenRequest.scopes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cookieType, pin, profileId, scopes);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProfileTokenRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProfileTokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProfileTokenRequest is not found in the empty JSON string", ProfileTokenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProfileTokenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProfileTokenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProfileTokenRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProfileTokenRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProfileTokenRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProfileTokenRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProfileTokenRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProfileTokenRequest>() {
           @Override
           public void write(JsonWriter out, ProfileTokenRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProfileTokenRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProfileTokenRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProfileTokenRequest
   * @throws IOException if the JSON string is invalid with respect to ProfileTokenRequest
   */
  public static ProfileTokenRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProfileTokenRequest.class);
  }

  /**
   * Convert an instance of ProfileTokenRequest to an JSON string
   *
   * @return JSON string
   */
