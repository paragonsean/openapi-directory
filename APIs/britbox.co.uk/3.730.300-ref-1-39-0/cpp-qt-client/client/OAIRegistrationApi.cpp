...
void OAIRegistrationApi::r_register(const OAIRegistrationRequest &oai_registration_request, const ::OpenAPI::OptionalParam<QList<QString>> &ff, const ::OpenAPI::OptionalParam<QString> &lang) {
...

    {
        ...
        QByteArray output = oai_registration_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRegistrationApi::r_registerCallback);
...
void OAIRegistrationApi::r_registerCallback(OAIHttpRequestWorker *worker) {
