...
/*
 * OAIProfileTokenRequest.h
 *
 * 
 */

#ifndef OAIProfileTokenRequest_H
#define OAIProfileTokenRequest_H
...
class OAIProfileTokenRequest : public OAIObject {
public:
    OAIProfileTokenRequest();
    OAIProfileTokenRequest(QString json);
    ~OAIProfileTokenRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProfileTokenRequest)

#endif // OAIProfileTokenRequest_H
