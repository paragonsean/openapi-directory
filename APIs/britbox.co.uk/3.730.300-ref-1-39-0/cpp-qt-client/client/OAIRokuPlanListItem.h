...
/*
 * OAIRokuPlanListItem.h
 *
 * 
 */

#ifndef OAIRokuPlanListItem_H
#define OAIRokuPlanListItem_H
...
class OAIRokuPlanListItem : public OAIObject {
public:
    OAIRokuPlanListItem();
    OAIRokuPlanListItem(QString json);
    ~OAIRokuPlanListItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRokuPlanListItem)

#endif // OAIRokuPlanListItem_H
