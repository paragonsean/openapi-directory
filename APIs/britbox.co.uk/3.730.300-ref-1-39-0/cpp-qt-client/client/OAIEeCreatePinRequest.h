...
/*
 * OAIEeCreatePinRequest.h
 *
 * 
 */

#ifndef OAIEeCreatePinRequest_H
#define OAIEeCreatePinRequest_H
...
class OAIEeCreatePinRequest : public OAIObject {
public:
    OAIEeCreatePinRequest();
    OAIEeCreatePinRequest(QString json);
    ~OAIEeCreatePinRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEeCreatePinRequest)

#endif // OAIEeCreatePinRequest_H
