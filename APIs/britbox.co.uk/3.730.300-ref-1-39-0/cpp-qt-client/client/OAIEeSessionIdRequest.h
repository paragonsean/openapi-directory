...
/*
 * OAIEeSessionIdRequest.h
 *
 * 
 */

#ifndef OAIEeSessionIdRequest_H
#define OAIEeSessionIdRequest_H
...
class OAIEeSessionIdRequest : public OAIObject {
public:
    OAIEeSessionIdRequest();
    OAIEeSessionIdRequest(QString json);
    ~OAIEeSessionIdRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEeSessionIdRequest)

#endif // OAIEeSessionIdRequest_H
