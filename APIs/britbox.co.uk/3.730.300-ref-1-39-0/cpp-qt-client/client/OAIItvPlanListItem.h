...
/*
 * OAIItvPlanListItem.h
 *
 * 
 */

#ifndef OAIItvPlanListItem_H
#define OAIItvPlanListItem_H
...
class OAIItvPlanListItem : public OAIObject {
public:
    OAIItvPlanListItem();
    OAIItvPlanListItem(QString json);
    ~OAIItvPlanListItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItvPlanListItem)

#endif // OAIItvPlanListItem_H
