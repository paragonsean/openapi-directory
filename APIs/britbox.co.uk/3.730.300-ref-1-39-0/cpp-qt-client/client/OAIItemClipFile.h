...
#ifndef OAIItemClipFile_H
#define OAIItemClipFile_H
...
class OAIItemClipFile : public OAIObject {
public:
    OAIItemClipFile();
    OAIItemClipFile(QString json);
    ~OAIItemClipFile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemClipFile)

#endif // OAIItemClipFile_H
