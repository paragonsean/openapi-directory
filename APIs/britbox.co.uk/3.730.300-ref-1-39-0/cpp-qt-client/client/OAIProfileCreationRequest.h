...
/*
 * OAIProfileCreationRequest.h
 *
 * 
 */

#ifndef OAIProfileCreationRequest_H
#define OAIProfileCreationRequest_H
...
class OAIProfileCreationRequest : public OAIObject {
public:
    OAIProfileCreationRequest();
    OAIProfileCreationRequest(QString json);
    ~OAIProfileCreationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProfileCreationRequest)

#endif // OAIProfileCreationRequest_H
