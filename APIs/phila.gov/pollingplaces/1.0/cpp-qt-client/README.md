...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      qint32 ward = create(); // qint32 | Ward Number
      ...
      qint32 division = create(); // qint32 | Division Number
      ...
      QString callback = create(); // QString | Optional parameter for jsonp support.
      apiInstance.rootGet(warddivisioncallback);
