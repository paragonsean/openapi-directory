...
public:
    ...
    /**
    * @param[in]  ward qint32 [required]
    * @param[in]  division qint32 [required]
    * @param[in]  callback QString [optional]
    */
    virtual void rootGet(const qint32 &ward, const qint32 &division, const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void rootGetSignal(OAIFeatures summary);


    void rootGetSignalFull(OAIHttpRequestWorker *worker, OAIFeatures summary);

    Q_DECL_DEPRECATED_X("Use rootGetSignalError() instead")
    void rootGetSignalE(OAIFeatures summary, QNetworkReply::NetworkError error_type, QString error_str);
    void rootGetSignalError(OAIFeatures summary, QNetworkReply::NetworkError error_type, const QString &error_str);
