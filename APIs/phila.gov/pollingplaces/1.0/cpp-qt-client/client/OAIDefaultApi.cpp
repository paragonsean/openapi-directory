...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://api.phila.gov/polling-places/v1"),
...
void OAIDefaultApi::rootGet(const qint32 &ward, const qint32 &division, const ::OpenAPI::OptionalParam<QString> &callback) {
    ...
    
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "ward", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("ward")).append(querySuffix).append(QUrl::toPercentEncoding(ward));
    }
    
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "division", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("division")).append(querySuffix).append(QUrl::toPercentEncoding(division));
    }
...
void OAIDefaultApi::rootGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIFeatures output(QString(worker->response));
    worker->deleteLater();
