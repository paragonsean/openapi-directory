...
async def registry_namespaces_get(request: web.Request, x_auth_token, x_auth_project_id) -> web.Response:
...
async def registry_namespaces_namespace_get(request: web.Request, x_auth_token, x_auth_project_id, namespace) -> web.Response:
    ...
    :param x_auth_project_id: The unique ID of your organization space where you want to create or work with your containers. Run &#x60;cf space &lt;space_name&gt; --guid&#x60;, where &#x60;&lt;space_name&gt;&#x60; is the name of your space, to retrieve your space ID.
    :type x_auth_project_id: str
    :param namespace: The name of the namespace that you would like to use for your organization and for which you would like to check availability in Bluemix.
    :type namespace: str
...
async def registry_namespaces_namespace_put(request: web.Request, x_auth_token, x_auth_project_id, namespace) -> web.Response:
