...
**created** | **Number** | The time when the container was created. | [optional] 
**env** | **[String]** | A list of all the environment variables of the container. | [optional] 
...
**memory** | **Number** | The amount of container memory in Megabyte that was assigned to your container. The memory is counted towards the quota that is allocated for the space. | [optional] 
**name** | **String** | The name of the container.  | [optional] 
**names** | **[String]** | The name of the container. | [optional] 
**networkSettings** | [**NetworkSetting**](NetworkSetting.md) |  | [optional] 
**ports** | [**Port**](Port.md) |  | [optional] 
**sizeRootFs** | **Number** | Total size of all the files in the container, in bytes.  | [optional] 
**sizeRw** | **Number** | The size of the files which have been created or changed, if you compare the container to its base image. Just after creation, this should be zero. Ass you modify (or create) files, this size will increase. | [optional] 
**started** | **Number** | Time when the container was started. | [optional] 
...
**VCPU** | **Number** | Number of virtual CPUs that are assigned to the container. | [optional] 
