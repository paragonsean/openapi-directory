# IbmContainersApi.ContainersGroupsNameOrIdGetDetails
...
**cmd** | **[String]** | The Docker command that was specified to be run when the container instances are started.  | [optional] 
**creationTime** | **String** | Timestamp when the container group was created. | [optional] 
**env** | **[String]** | The list of environmental variables that were defined for the container group. Each environment variable consists of a unique key and a value. | [optional] 
...
**memory** | **Number** | The size of each container instance that runs in the container group in MegaByte. | [optional] 
...
**port** | **Number** | The public port that has been exposed. If you specified a route, your container group is accessible from the Internet.  | [optional] 
**routeStatus** | [**ContainersGroupsNameOrIdGetDetailsRouteStatus**](ContainersGroupsNameOrIdGetDetailsRouteStatus.md) |  | [optional] 
**routes** | **[String]** | The public route that is mapped to the container group. When you expose a public port, you can use the route to access your container group from the Internet. | [optional] 
...
**volumes** | **[String]** | List of volumes to be associated with the container, in the format of volume name:path:mode where mode can be ro or rw. | [optional] 
