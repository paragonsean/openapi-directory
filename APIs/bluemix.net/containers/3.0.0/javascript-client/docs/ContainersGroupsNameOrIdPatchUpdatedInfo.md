# IbmContainersApi.ContainersGroupsNameOrIdPatchUpdatedInfo
...
**environment** | **[String]** | A list of environment variables that you want to add to your container group. Every environment variable needs to be a key&#x3D;value pair. Every key that you use needs to be unique for this container group. Multiple environment variables are separated with comma (,) | [optional] 
