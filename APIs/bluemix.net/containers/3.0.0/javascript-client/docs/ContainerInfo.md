# IbmContainersApi.ContainerInfo
...
**created** | **Date** | The date and time the container was created. | [optional] 
...
**mounts** | **[String]** | A list of volumes that are mounted to the container. | [optional] 
...
**volumesRW** | **[String]** | LIst of volumes that is mounted to the container. | [optional] 
