# IbmContainersApi.ContainerConfig
...
**exposedPorts** | **[String]** | List of public ports that were exposed during container creation.  | [optional] 
...
**labels** | **[String]** | List of custom metadata that was added to the container. Labels serve a wide range of uses, such as adding notes to a container. Every label is a key/ value pair. | [optional] 
**memory** | **Number** | The amount of container memory that is assigned to the container in Megabyte. | [optional] 
