# IbmContainersApi.Fileshare

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**capacity** | **Number** | The size of the file share in gigabyte. | [optional] 
...
**iops** | **Number** | The number of Input/Output operations per second.  | [optional] 
**iopsTotal** | **Number** | The total number of IOPS considering the size of the file share. The size of your file share in gigabyte multiplied with the number of IOPS indicates the total number of IOPS. The higher the number of IOPS the faster you can read from and write to your volumes. | [optional] 
