# IbmContainersApi.ContainersGroupsGetListItem
...
**port** | **Number** | The port number that is exposed to the public during container group creation. | [optional] 
**routes** | **[String]** | The public route that is mapped to the container group. You can use this route to access your container group from the Internet. | [optional] 
