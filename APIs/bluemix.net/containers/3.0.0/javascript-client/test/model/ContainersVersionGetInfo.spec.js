...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IbmContainersApi.ContainersVersionGetInfo();
  });
  ...
  describe('ContainersVersionGetInfo', function() {
    it('should create an instance of ContainersVersionGetInfo', function() {
      // uncomment below and update the code to test ContainersVersionGetInfo
      //var instance = new IbmContainersApi.ContainersVersionGetInfo();
      //expect(instance).to.be.a(IbmContainersApi.ContainersVersionGetInfo);
    });
    ...
    it('should have the property buildDetail (base name: "BuildDetail")', function() {
      // uncomment below and update the code to test the property buildDetail
      //var instance = new IbmContainersApi.ContainersVersionGetInfo();
      //expect(instance).to.be();
    });
