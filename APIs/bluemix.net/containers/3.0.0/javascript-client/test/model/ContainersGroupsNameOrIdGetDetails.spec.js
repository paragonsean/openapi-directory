...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IbmContainersApi.ContainersGroupsNameOrIdGetDetails();
  });
  ...
  describe('ContainersGroupsNameOrIdGetDetails', function() {
    it('should create an instance of ContainersGroupsNameOrIdGetDetails', function() {
      // uncomment below and update the code to test ContainersGroupsNameOrIdGetDetails
      //var instance = new IbmContainersApi.ContainersGroupsNameOrIdGetDetails();
      //expect(instance).to.be.a(IbmContainersApi.ContainersGroupsNameOrIdGetDetails);
    });

    it('should have the property antiAffinity (base name: "Anti-affinity")', function() {
      // uncomment below and update the code to test the property antiAffinity
      //var instance = new IbmContainersApi.ContainersGroupsNameOrIdGetDetails();
    ...
    it('should have the property routeStatus (base name: "Route_Status")', function() {
      // uncomment below and update the code to test the property routeStatus
      //var instance = new IbmContainersApi.ContainersGroupsNameOrIdGetDetails();
      //expect(instance).to.be();
    });
