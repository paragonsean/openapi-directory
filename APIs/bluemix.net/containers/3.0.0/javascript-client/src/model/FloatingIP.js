...
class FloatingIP {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FloatingIP();

            if (data.hasOwnProperty('Bindings')) {
                obj['Bindings'] = Binding.constructFromObject(data['Bindings']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FloatingIP</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FloatingIP</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Bindings`
        if (data['Bindings']) { // data not null
          Binding.validateJSON(data['Bindings']);
        }
...
/**
 * @member {module:model/Binding} Bindings
 */
FloatingIP.prototype['Bindings'] = undefined;

/**
 * The public IP address that is allocated to the organization space.
 * @member {String} IpAddress
 */
FloatingIP.prototype['IpAddress'] = undefined;
