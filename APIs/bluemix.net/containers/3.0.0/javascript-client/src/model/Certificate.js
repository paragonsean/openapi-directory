...
class Certificate {
     ...
     * @param caCert {String} Certificate Authority (CA) certificate including the CA public key.
     * @param serverCert {String} Server certificate including the server's public key.
     * @param userCert {String} User certificate including the user's public key.
     * @param userKey {String} User's private key.
     */
    constructor(caCert, serverCert, userCert, userKey) { 
        
        Certificate.initialize(this, caCert, serverCert, userCert, userKey);
    }
     ...
     */
    static initialize(obj, caCert, serverCert, userCert, userKey) { 
        obj['ca_cert'] = caCert;
        obj['server_cert'] = serverCert;
        obj['user_cert'] = userCert;
