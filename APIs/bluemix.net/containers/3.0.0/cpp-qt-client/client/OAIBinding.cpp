...
QString OAIBinding::getContainerId() const {
    return m_container_id;
}
void OAIBinding::setContainerId(const QString &container_id) {
    m_container_id = container_id;
    m_container_id_isSet = true;
}

bool OAIBinding::is_container_id_Set() const{
    return m_container_id_isSet;
}

bool OAIBinding::is_container_id_Valid() const{
