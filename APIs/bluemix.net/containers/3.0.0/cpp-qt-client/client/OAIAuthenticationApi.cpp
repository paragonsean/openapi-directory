...
void OAIAuthenticationApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("tlskeyGet", defaultConf);
    _serverIndices.insert("tlskeyGet", 0);
    _serverConfigs.insert("tlskeyRefreshPut", defaultConf);
    _serverIndices.insert("tlskeyRefreshPut", 0);
}
...
void OAIAuthenticationApi::tlskeyGet(const QString &x_auth_token, const QString &x_auth_project_id) {
    QString fullPath = QString(_serverConfigs["tlskeyGet"][_serverIndices.value("tlskeyGet")].URL()+"/tlskey");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationApi::tlskeyGetCallback);
...
void OAIAuthenticationApi::tlskeyGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT tlskeyGetSignal(output);
        Q_EMIT tlskeyGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT tlskeyGetSignalE(output, error_type, error_str);
        Q_EMIT tlskeyGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT tlskeyGetSignalError(output, error_type, error_str);
        Q_EMIT tlskeyGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAuthenticationApi::tlskeyRefreshPut(const QString &x_auth_token, const QString &x_auth_project_id) {
    QString fullPath = QString(_serverConfigs["tlskeyRefreshPut"][_serverIndices.value("tlskeyRefreshPut")].URL()+"/tlskey/refresh");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationApi::tlskeyRefreshPutCallback);
    connect(this, &OAIAuthenticationApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAuthenticationApi::tlskeyRefreshPutCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAICertificateRefresh output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT tlskeyRefreshPutSignal(output);
        Q_EMIT tlskeyRefreshPutSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT tlskeyRefreshPutSignalE(output, error_type, error_str);
        Q_EMIT tlskeyRefreshPutSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT tlskeyRefreshPutSignalError(output, error_type, error_str);
        Q_EMIT tlskeyRefreshPutSignalErrorFull(worker, error_type, error_str);
    }
}
