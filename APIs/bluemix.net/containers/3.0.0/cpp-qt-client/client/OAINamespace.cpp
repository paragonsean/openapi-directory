...
QString OAINamespace::getRNamespace() const {
    return m_r_namespace;
}
void OAINamespace::setRNamespace(const QString &r_namespace) {
    m_r_namespace = r_namespace;
    m_r_namespace_isSet = true;
}

bool OAINamespace::is_r_namespace_Set() const{
    return m_r_namespace_isSet;
}

bool OAINamespace::is_r_namespace_Valid() const{
