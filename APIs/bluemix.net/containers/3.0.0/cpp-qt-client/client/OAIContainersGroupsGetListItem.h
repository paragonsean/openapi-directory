...
/*
 * OAIContainersGroupsGetListItem.h
 *
 * 
 */

#ifndef OAIContainersGroupsGetListItem_H
#define OAIContainersGroupsGetListItem_H
...
class OAIContainersGroupsGetListItem : public OAIObject {
public:
    OAIContainersGroupsGetListItem();
    OAIContainersGroupsGetListItem(QString json);
    ~OAIContainersGroupsGetListItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContainersGroupsGetListItem)

#endif // OAIContainersGroupsGetListItem_H
