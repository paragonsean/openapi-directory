...
public class ApiClient {
    ...
    private String basePath = "https://events.1password.com";
    ...
    public ApiClient() {
        ...
        authentications.put("jwtsa", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://events.1password.com
