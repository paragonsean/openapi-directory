...
/*
 * OAIAuditEventItems.h
 *
 * An object wrapping cursor properties and a list of audit events
 */

#ifndef OAIAuditEventItems_H
#define OAIAuditEventItems_H
...
class OAIAuditEventItems : public OAIObject {
public:
    OAIAuditEventItems();
    OAIAuditEventItems(QString json);
    ~OAIAuditEventItems() override;
    ...
    QList<OAIAuditEvent> getItems() const;
    void setItems(const QList<OAIAuditEvent> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuditEventItems)

#endif // OAIAuditEventItems_H
