...
class CalculateTaxOut(Model):
    ...
    def __init__(self, storage_required_fields: List[StorageRequiredFields]=None, tax_required_fields: List[TaxRequiredFields]=None, transaction: Transaction=None):
        """CalculateTaxOut - a model defined in OpenAPI

        :param storage_required_fields: The storage_required_fields of this CalculateTaxOut.
        :param tax_required_fields: The tax_required_fields of this CalculateTaxOut.
        :param transaction: The transaction of this CalculateTaxOut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CalculateTaxOut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The calculateTaxOut of this CalculateTaxOut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def storage_required_fields(self):
        """Gets the storage_required_fields of this CalculateTaxOut.
        ...
        :return: The storage_required_fields of this CalculateTaxOut.
    ...
    def storage_required_fields(self, storage_required_fields):
        """Sets the storage_required_fields of this CalculateTaxOut.
    ...
    def tax_required_fields(self):
        """Gets the tax_required_fields of this CalculateTaxOut.

        Fields required for tax calculation. Depends on the region/transaction type.

        :return: The tax_required_fields of this CalculateTaxOut.
    ...
    def tax_required_fields(self, tax_required_fields):
        """Sets the tax_required_fields of this CalculateTaxOut.
    ...
    def transaction(self):
        """Gets the transaction of this CalculateTaxOut.


        :return: The transaction of this CalculateTaxOut.
        :rtype: Transaction
        """
    ...
    def transaction(self, transaction):
        """Sets the transaction of this CalculateTaxOut.
