...
class CreateTransactionOut(Model):
    ...
    def __init__(self, storage_required_fields: List[StorageRequiredFields]=None, tax_required_fields: List[TaxRequiredFields]=None, transaction: Transaction=None):
        """CreateTransactionOut - a model defined in OpenAPI

        :param storage_required_fields: The storage_required_fields of this CreateTransactionOut.
        :param tax_required_fields: The tax_required_fields of this CreateTransactionOut.
        :param transaction: The transaction of this CreateTransactionOut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateTransactionOut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The createTransactionOut of this CreateTransactionOut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def storage_required_fields(self):
        """Gets the storage_required_fields of this CreateTransactionOut.
        ...
        :return: The storage_required_fields of this CreateTransactionOut.
    ...
    def storage_required_fields(self, storage_required_fields):
        """Sets the storage_required_fields of this CreateTransactionOut.
    ...
    def tax_required_fields(self):
        """Gets the tax_required_fields of this CreateTransactionOut.

        Fields required for tax calculation. Depends on the region/transaction type.

        :return: The tax_required_fields of this CreateTransactionOut.
    ...
    def tax_required_fields(self, tax_required_fields):
        """Sets the tax_required_fields of this CreateTransactionOut.
    ...
    def transaction(self):
        """Gets the transaction of this CreateTransactionOut.


        :return: The transaction of this CreateTransactionOut.
        :rtype: Transaction
        """
    ...
    def transaction(self, transaction):
        """Sets the transaction of this CreateTransactionOut.
