...
class ConfirmTransactionOut(Model):
    ...
    def __init__(self, storage_required_fields: List[StorageRequiredFields]=None, tax_required_fields: List[TaxRequiredFields]=None, transaction: Transaction=None):
        """ConfirmTransactionOut - a model defined in OpenAPI

        :param storage_required_fields: The storage_required_fields of this ConfirmTransactionOut.
        :param tax_required_fields: The tax_required_fields of this ConfirmTransactionOut.
        :param transaction: The transaction of this ConfirmTransactionOut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ConfirmTransactionOut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The confirmTransactionOut of this ConfirmTransactionOut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def storage_required_fields(self):
        """Gets the storage_required_fields of this ConfirmTransactionOut.
        ...
        :return: The storage_required_fields of this ConfirmTransactionOut.
    ...
    def storage_required_fields(self, storage_required_fields):
        """Sets the storage_required_fields of this ConfirmTransactionOut.
    ...
    def tax_required_fields(self):
        """Gets the tax_required_fields of this ConfirmTransactionOut.

        Fields required for tax calculation. Depends on the region/transaction type.

        :return: The tax_required_fields of this ConfirmTransactionOut.
    ...
    def tax_required_fields(self, tax_required_fields):
        """Sets the tax_required_fields of this ConfirmTransactionOut.
    ...
    def transaction(self):
        """Gets the transaction of this ConfirmTransactionOut.


        :return: The transaction of this ConfirmTransactionOut.
        :rtype: Transaction
        """
    ...
    def transaction(self, transaction):
        """Sets the transaction of this ConfirmTransactionOut.
