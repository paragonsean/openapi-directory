...
class CalculateSimpleTaxOut(Model):
    ...
    def __init__(self, storage_required_fields: List[StorageRequiredFields]=None, tax_required_fields: List[TaxRequiredFields]=None, transaction: Transaction=None):
        """CalculateSimpleTaxOut - a model defined in OpenAPI

        :param storage_required_fields: The storage_required_fields of this CalculateSimpleTaxOut.
        :param tax_required_fields: The tax_required_fields of this CalculateSimpleTaxOut.
        :param transaction: The transaction of this CalculateSimpleTaxOut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CalculateSimpleTaxOut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The calculateSimpleTaxOut of this CalculateSimpleTaxOut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def storage_required_fields(self):
        """Gets the storage_required_fields of this CalculateSimpleTaxOut.
        ...
        :return: The storage_required_fields of this CalculateSimpleTaxOut.
    ...
    def storage_required_fields(self, storage_required_fields):
        """Sets the storage_required_fields of this CalculateSimpleTaxOut.
    ...
    def tax_required_fields(self):
        """Gets the tax_required_fields of this CalculateSimpleTaxOut.

        Fields required for tax calculation. Depends on the region/transaction type.

        :return: The tax_required_fields of this CalculateSimpleTaxOut.
    ...
    def tax_required_fields(self, tax_required_fields):
        """Sets the tax_required_fields of this CalculateSimpleTaxOut.
    ...
    def transaction(self):
        """Gets the transaction of this CalculateSimpleTaxOut.


        :return: The transaction of this CalculateSimpleTaxOut.
        :rtype: Transaction
        """
    ...
    def transaction(self, transaction):
        """Sets the transaction of this CalculateSimpleTaxOut.
