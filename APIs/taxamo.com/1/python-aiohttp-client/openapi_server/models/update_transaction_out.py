...
class UpdateTransactionOut(Model):
    ...
    def __init__(self, storage_required_fields: List[StorageRequiredFields]=None, tax_required_fields: List[TaxRequiredFields]=None, transaction: Transaction=None):
        """UpdateTransactionOut - a model defined in OpenAPI

        :param storage_required_fields: The storage_required_fields of this UpdateTransactionOut.
        :param tax_required_fields: The tax_required_fields of this UpdateTransactionOut.
        :param transaction: The transaction of this UpdateTransactionOut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateTransactionOut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The updateTransactionOut of this UpdateTransactionOut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def storage_required_fields(self):
        """Gets the storage_required_fields of this UpdateTransactionOut.
        ...
        :return: The storage_required_fields of this UpdateTransactionOut.
    ...
    def storage_required_fields(self, storage_required_fields):
        """Sets the storage_required_fields of this UpdateTransactionOut.
    ...
    def tax_required_fields(self):
        """Gets the tax_required_fields of this UpdateTransactionOut.

        Fields required for tax calculation. Depends on the region/transaction type.

        :return: The tax_required_fields of this UpdateTransactionOut.
    ...
    def tax_required_fields(self, tax_required_fields):
        """Sets the tax_required_fields of this UpdateTransactionOut.
    ...
    def transaction(self):
        """Gets the transaction of this UpdateTransactionOut.


        :return: The transaction of this UpdateTransactionOut.
        :rtype: Transaction
        """
    ...
    def transaction(self, transaction):
        """Sets the transaction of this UpdateTransactionOut.
