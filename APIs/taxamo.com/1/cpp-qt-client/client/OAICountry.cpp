...
QList<QString> OAICountry::getCallingCode() const {
    return m_calling_code;
}
void OAICountry::setCallingCode(const QList<QString> &calling_code) {
...
QString OAICountry::getCca2() const {
    return m_cca2;
}
void OAICountry::setCca2(const QString &cca2) {
    m_cca2 = cca2;
    m_cca2_isSet = true;
}

bool OAICountry::is_cca2_Set() const{
    return m_cca2_isSet;
}

bool OAICountry::is_cca2_Valid() const{
    return m_cca2_isValid;
}

QString OAICountry::getCca3() const {
    return m_cca3;
}
void OAICountry::setCca3(const QString &cca3) {
    m_cca3 = cca3;
    m_cca3_isSet = true;
}

bool OAICountry::is_cca3_Set() const{
    return m_cca3_isSet;
}

bool OAICountry::is_cca3_Valid() const{
    return m_cca3_isValid;
}

QString OAICountry::getCcn3() const {
    return m_ccn3;
}
void OAICountry::setCcn3(const QString &ccn3) {
    m_ccn3 = ccn3;
    m_ccn3_isSet = true;
}

bool OAICountry::is_ccn3_Set() const{
    return m_ccn3_isSet;
}

bool OAICountry::is_ccn3_Valid() const{
...
QString OAICountry::getCodeLong() const {
    return m_code_long;
}
void OAICountry::setCodeLong(const QString &code_long) {
    m_code_long = code_long;
    m_code_long_isSet = true;
}

bool OAICountry::is_code_long_Set() const{
    return m_code_long_isSet;
}

bool OAICountry::is_code_long_Valid() const{
    return m_code_long_isValid;
}

QString OAICountry::getCodenum() const {
    return m_codenum;
}
void OAICountry::setCodenum(const QString &codenum) {
    m_codenum = codenum;
    m_codenum_isSet = true;
}

bool OAICountry::is_codenum_Set() const{
    return m_codenum_isSet;
}

bool OAICountry::is_codenum_Valid() const{
    return m_codenum_isValid;
}

QList<QString> OAICountry::getCurrency() const {
    return m_currency;
}
void OAICountry::setCurrency(const QList<QString> &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAICountry::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAICountry::is_currency_Valid() const{
...
QString OAICountry::getTaxNumberCountryCode() const {
    return m_tax_number_country_code;
}
void OAICountry::setTaxNumberCountryCode(const QString &tax_number_country_code) {
    m_tax_number_country_code = tax_number_country_code;
    m_tax_number_country_code_isSet = true;
}

bool OAICountry::is_tax_number_country_code_Set() const{
    return m_tax_number_country_code_isSet;
}

bool OAICountry::is_tax_number_country_code_Valid() const{
    return m_tax_number_country_code_isValid;
}

QString OAICountry::getTaxRegion() const {
    return m_tax_region;
}
void OAICountry::setTaxRegion(const QString &tax_region) {
    m_tax_region = tax_region;
    m_tax_region_isSet = true;
}

bool OAICountry::is_tax_region_Set() const{
    return m_tax_region_isSet;
}

bool OAICountry::is_tax_region_Valid() const{
    return m_tax_region_isValid;
}

bool OAICountry::isTaxSupported() const {
    return m_tax_supported;
}
void OAICountry::setTaxSupported(const bool &tax_supported) {
    m_tax_supported = tax_supported;
    m_tax_supported_isSet = true;
}

bool OAICountry::is_tax_supported_Set() const{
    return m_tax_supported_isSet;
}

bool OAICountry::is_tax_supported_Valid() const{
