...
/*
 * OAIInput_transaction.h
 *
 * 
 */

#ifndef OAIInput_transaction_H
#define OAIInput_transaction_H
...
class OAIInput_transaction : public OAIObject {
public:
    OAIInput_transaction();
    OAIInput_transaction(QString json);
    ~OAIInput_transaction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInput_transaction)

#endif // OAIInput_transaction_H
