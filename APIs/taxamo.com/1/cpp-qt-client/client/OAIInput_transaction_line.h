...
/*
 * OAIInput_transaction_line.h
 *
 * 
 */

#ifndef OAIInput_transaction_line_H
#define OAIInput_transaction_line_H
...
class OAIInput_transaction_line : public OAIObject {
public:
    OAIInput_transaction_line();
    OAIInput_transaction_line(QString json);
    ~OAIInput_transaction_line() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInput_transaction_line)

#endif // OAIInput_transaction_line_H
