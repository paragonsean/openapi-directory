...
OAIAdditional_currencies OAITransaction::getAdditionalCurrencies() const {
    return m_additional_currencies;
}
void OAITransaction::setAdditionalCurrencies(const OAIAdditional_currencies &additional_currencies) {
    m_additional_currencies = additional_currencies;
    m_additional_currencies_isSet = true;
}

bool OAITransaction::is_additional_currencies_Set() const{
    return m_additional_currencies_isSet;
}

bool OAITransaction::is_additional_currencies_Valid() const{
...
QString OAITransaction::getBillingCountryCode() const {
    return m_billing_country_code;
}
void OAITransaction::setBillingCountryCode(const QString &billing_country_code) {
    m_billing_country_code = billing_country_code;
    m_billing_country_code_isSet = true;
}

bool OAITransaction::is_billing_country_code_Set() const{
    return m_billing_country_code_isSet;
}

bool OAITransaction::is_billing_country_code_Valid() const{
    return m_billing_country_code_isValid;
}

QString OAITransaction::getBuyerCreditCardPrefix() const {
    return m_buyer_credit_card_prefix;
}
void OAITransaction::setBuyerCreditCardPrefix(const QString &buyer_credit_card_prefix) {
    m_buyer_credit_card_prefix = buyer_credit_card_prefix;
    m_buyer_credit_card_prefix_isSet = true;
}

bool OAITransaction::is_buyer_credit_card_prefix_Set() const{
    return m_buyer_credit_card_prefix_isSet;
}

bool OAITransaction::is_buyer_credit_card_prefix_Valid() const{
    return m_buyer_credit_card_prefix_isValid;
}

QString OAITransaction::getBuyerEmail() const {
    return m_buyer_email;
}
void OAITransaction::setBuyerEmail(const QString &buyer_email) {
    m_buyer_email = buyer_email;
    m_buyer_email_isSet = true;
}

bool OAITransaction::is_buyer_email_Set() const{
    return m_buyer_email_isSet;
}

bool OAITransaction::is_buyer_email_Valid() const{
    return m_buyer_email_isValid;
}

QString OAITransaction::getBuyerIp() const {
    return m_buyer_ip;
}
void OAITransaction::setBuyerIp(const QString &buyer_ip) {
    m_buyer_ip = buyer_ip;
    m_buyer_ip_isSet = true;
}

bool OAITransaction::is_buyer_ip_Set() const{
    return m_buyer_ip_isSet;
}

bool OAITransaction::is_buyer_ip_Valid() const{
    return m_buyer_ip_isValid;
}

QString OAITransaction::getBuyerName() const {
    return m_buyer_name;
}
void OAITransaction::setBuyerName(const QString &buyer_name) {
    m_buyer_name = buyer_name;
    m_buyer_name_isSet = true;
}

bool OAITransaction::is_buyer_name_Set() const{
    return m_buyer_name_isSet;
}

bool OAITransaction::is_buyer_name_Valid() const{
    return m_buyer_name_isValid;
}

QString OAITransaction::getBuyerTaxNumber() const {
    return m_buyer_tax_number;
}
void OAITransaction::setBuyerTaxNumber(const QString &buyer_tax_number) {
    m_buyer_tax_number = buyer_tax_number;
    m_buyer_tax_number_isSet = true;
}

bool OAITransaction::is_buyer_tax_number_Set() const{
    return m_buyer_tax_number_isSet;
}

bool OAITransaction::is_buyer_tax_number_Valid() const{
    return m_buyer_tax_number_isValid;
}

bool OAITransaction::isBuyerTaxNumberValid() const {
    return m_buyer_tax_number_valid;
}
void OAITransaction::setBuyerTaxNumberValid(const bool &buyer_tax_number_valid) {
    m_buyer_tax_number_valid = buyer_tax_number_valid;
    m_buyer_tax_number_valid_isSet = true;
}

bool OAITransaction::is_buyer_tax_number_valid_Set() const{
    return m_buyer_tax_number_valid_isSet;
}

bool OAITransaction::is_buyer_tax_number_valid_Valid() const{
...
QString OAITransaction::getConfirmTimestamp() const {
    return m_confirm_timestamp;
}
void OAITransaction::setConfirmTimestamp(const QString &confirm_timestamp) {
    m_confirm_timestamp = confirm_timestamp;
    m_confirm_timestamp_isSet = true;
}

bool OAITransaction::is_confirm_timestamp_Set() const{
    return m_confirm_timestamp_isSet;
}

bool OAITransaction::is_confirm_timestamp_Valid() const{
    return m_confirm_timestamp_isValid;
}

OAICountries OAITransaction::getCountries() const {
    return m_countries;
}
void OAITransaction::setCountries(const OAICountries &countries) {
    m_countries = countries;
    m_countries_isSet = true;
}

bool OAITransaction::is_countries_Set() const{
    return m_countries_isSet;
}

bool OAITransaction::is_countries_Valid() const{
    return m_countries_isValid;
}

QString OAITransaction::getCreateTimestamp() const {
    return m_create_timestamp;
}
void OAITransaction::setCreateTimestamp(const QString &create_timestamp) {
    m_create_timestamp = create_timestamp;
    m_create_timestamp_isSet = true;
}

bool OAITransaction::is_create_timestamp_Set() const{
    return m_create_timestamp_isSet;
}

bool OAITransaction::is_create_timestamp_Valid() const{
...
QString OAITransaction::getCustomData() const {
    return m_custom_data;
}
void OAITransaction::setCustomData(const QString &custom_data) {
...
QList<OAICustom_fields> OAITransaction::getCustomFields() const {
    return m_custom_fields;
}
void OAITransaction::setCustomFields(const QList<OAICustom_fields> &custom_fields) {
...
QString OAITransaction::getCustomId() const {
    return m_custom_id;
}
void OAITransaction::setCustomId(const QString &custom_id) {
    m_custom_id = custom_id;
    m_custom_id_isSet = true;
}

bool OAITransaction::is_custom_id_Set() const{
    return m_custom_id_isSet;
}

bool OAITransaction::is_custom_id_Valid() const{
...
double OAITransaction::getDeductedTaxAmount() const {
    return m_deducted_tax_amount;
}
void OAITransaction::setDeductedTaxAmount(const double &deducted_tax_amount) {
    m_deducted_tax_amount = deducted_tax_amount;
    m_deducted_tax_amount_isSet = true;
}

bool OAITransaction::is_deducted_tax_amount_Set() const{
    return m_deducted_tax_amount_isSet;
}

bool OAITransaction::is_deducted_tax_amount_Valid() const{
...
OAIEvidence OAITransaction::getEvidence() const {
    return m_evidence;
}
void OAITransaction::setEvidence(const OAIEvidence &evidence) {
    m_evidence = evidence;
    m_evidence_isSet = true;
}

bool OAITransaction::is_evidence_Set() const{
    return m_evidence_isSet;
}

bool OAITransaction::is_evidence_Valid() const{
    return m_evidence_isValid;
}

QString OAITransaction::getExternalKey() const {
    return m_external_key;
}
void OAITransaction::setExternalKey(const QString &external_key) {
    m_external_key = external_key;
    m_external_key_isSet = true;
}

bool OAITransaction::is_external_key_Set() const{
    return m_external_key_isSet;
}

bool OAITransaction::is_external_key_Valid() const{
    return m_external_key_isValid;
}

QString OAITransaction::getForceCountryCode() const {
    return m_force_country_code;
}
void OAITransaction::setForceCountryCode(const QString &force_country_code) {
    m_force_country_code = force_country_code;
    m_force_country_code_isSet = true;
}

bool OAITransaction::is_force_country_code_Set() const{
    return m_force_country_code_isSet;
}

bool OAITransaction::is_force_country_code_Valid() const{
    return m_force_country_code_isValid;
}

bool OAITransaction::isFullyInformative() const {
    return m_fully_informative;
}
void OAITransaction::setFullyInformative(const bool &fully_informative) {
    m_fully_informative = fully_informative;
    m_fully_informative_isSet = true;
}

bool OAITransaction::is_fully_informative_Set() const{
    return m_fully_informative_isSet;
}

bool OAITransaction::is_fully_informative_Valid() const{
    return m_fully_informative_isValid;
}

OAIInvoice_address OAITransaction::getInvoiceAddress() const {
    return m_invoice_address;
}
void OAITransaction::setInvoiceAddress(const OAIInvoice_address &invoice_address) {
    m_invoice_address = invoice_address;
    m_invoice_address_isSet = true;
}

bool OAITransaction::is_invoice_address_Set() const{
    return m_invoice_address_isSet;
}

bool OAITransaction::is_invoice_address_Valid() const{
    return m_invoice_address_isValid;
}

QString OAITransaction::getInvoiceDate() const {
    return m_invoice_date;
}
void OAITransaction::setInvoiceDate(const QString &invoice_date) {
    m_invoice_date = invoice_date;
    m_invoice_date_isSet = true;
}

bool OAITransaction::is_invoice_date_Set() const{
    return m_invoice_date_isSet;
}

bool OAITransaction::is_invoice_date_Valid() const{
    return m_invoice_date_isValid;
}

QString OAITransaction::getInvoiceImageUrl() const {
    return m_invoice_image_url;
}
void OAITransaction::setInvoiceImageUrl(const QString &invoice_image_url) {
    m_invoice_image_url = invoice_image_url;
    m_invoice_image_url_isSet = true;
}

bool OAITransaction::is_invoice_image_url_Set() const{
    return m_invoice_image_url_isSet;
}

bool OAITransaction::is_invoice_image_url_Valid() const{
    return m_invoice_image_url_isValid;
}

QString OAITransaction::getInvoiceNumber() const {
    return m_invoice_number;
}
void OAITransaction::setInvoiceNumber(const QString &invoice_number) {
    m_invoice_number = invoice_number;
    m_invoice_number_isSet = true;
}

bool OAITransaction::is_invoice_number_Set() const{
    return m_invoice_number_isSet;
}

bool OAITransaction::is_invoice_number_Valid() const{
    return m_invoice_number_isValid;
}

QString OAITransaction::getInvoicePlace() const {
    return m_invoice_place;
}
void OAITransaction::setInvoicePlace(const QString &invoice_place) {
    m_invoice_place = invoice_place;
    m_invoice_place_isSet = true;
}

bool OAITransaction::is_invoice_place_Set() const{
    return m_invoice_place_isSet;
}

bool OAITransaction::is_invoice_place_Valid() const{
    return m_invoice_place_isValid;
}

QString OAITransaction::getKey() const {
    return m_key;
}
void OAITransaction::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAITransaction::is_key_Set() const{
    return m_key_isSet;
}

bool OAITransaction::is_key_Valid() const{
    return m_key_isValid;
}

QString OAITransaction::getKind() const {
    return m_kind;
}
void OAITransaction::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAITransaction::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAITransaction::is_kind_Valid() const{
    return m_kind_isValid;
}

bool OAITransaction::isManual() const {
    return m_manual;
}
void OAITransaction::setManual(const bool &manual) {
    m_manual = manual;
    m_manual_isSet = true;
}

bool OAITransaction::is_manual_Set() const{
    return m_manual_isSet;
}

bool OAITransaction::is_manual_Valid() const{
...
QString OAITransaction::getOrderDate() const {
    return m_order_date;
}
void OAITransaction::setOrderDate(const QString &order_date) {
    m_order_date = order_date;
    m_order_date_isSet = true;
}

bool OAITransaction::is_order_date_Set() const{
    return m_order_date_isSet;
}

bool OAITransaction::is_order_date_Valid() const{
    return m_order_date_isValid;
}

QString OAITransaction::getOriginalTransactionKey() const {
    return m_original_transaction_key;
}
void OAITransaction::setOriginalTransactionKey(const QString &original_transaction_key) {
    m_original_transaction_key = original_transaction_key;
    m_original_transaction_key_isSet = true;
}

bool OAITransaction::is_original_transaction_key_Set() const{
    return m_original_transaction_key_isSet;
}

bool OAITransaction::is_original_transaction_key_Valid() const{
    return m_original_transaction_key_isValid;
}

double OAITransaction::getRefundedTaxAmount() const {
    return m_refunded_tax_amount;
}
void OAITransaction::setRefundedTaxAmount(const double &refunded_tax_amount) {
    m_refunded_tax_amount = refunded_tax_amount;
    m_refunded_tax_amount_isSet = true;
}

bool OAITransaction::is_refunded_tax_amount_Set() const{
    return m_refunded_tax_amount_isSet;
}

bool OAITransaction::is_refunded_tax_amount_Valid() const{
    return m_refunded_tax_amount_isValid;
}

double OAITransaction::getRefundedTotalAmount() const {
    return m_refunded_total_amount;
}
void OAITransaction::setRefundedTotalAmount(const double &refunded_total_amount) {
    m_refunded_total_amount = refunded_total_amount;
    m_refunded_total_amount_isSet = true;
}

bool OAITransaction::is_refunded_total_amount_Set() const{
    return m_refunded_total_amount_isSet;
}

bool OAITransaction::is_refunded_total_amount_Valid() const{
...
QString OAITransaction::getSubAccountId() const {
    return m_sub_account_id;
}
void OAITransaction::setSubAccountId(const QString &sub_account_id) {
    m_sub_account_id = sub_account_id;
    m_sub_account_id_isSet = true;
}

bool OAITransaction::is_sub_account_id_Set() const{
    return m_sub_account_id_isSet;
}

bool OAITransaction::is_sub_account_id_Valid() const{
    return m_sub_account_id_isValid;
}

QString OAITransaction::getSupplyDate() const {
    return m_supply_date;
}
void OAITransaction::setSupplyDate(const QString &supply_date) {
    m_supply_date = supply_date;
    m_supply_date_isSet = true;
}

bool OAITransaction::is_supply_date_Set() const{
    return m_supply_date_isSet;
}

bool OAITransaction::is_supply_date_Valid() const{
    return m_supply_date_isValid;
}

double OAITransaction::getTaxAmount() const {
    return m_tax_amount;
}
void OAITransaction::setTaxAmount(const double &tax_amount) {
...
QString OAITransaction::getTaxCountryCode() const {
    return m_tax_country_code;
}
void OAITransaction::setTaxCountryCode(const QString &tax_country_code) {
    m_tax_country_code = tax_country_code;
    m_tax_country_code_isSet = true;
}

bool OAITransaction::is_tax_country_code_Set() const{
    return m_tax_country_code_isSet;
}

bool OAITransaction::is_tax_country_code_Valid() const{
    return m_tax_country_code_isValid;
}

OAITax_data_schema OAITransaction::getTaxData() const {
    return m_tax_data;
}
void OAITransaction::setTaxData(const OAITax_data_schema &tax_data) {
    m_tax_data = tax_data;
    m_tax_data_isSet = true;
}

bool OAITransaction::is_tax_data_Set() const{
    return m_tax_data_isSet;
}

bool OAITransaction::is_tax_data_Valid() const{
    return m_tax_data_isValid;
}

bool OAITransaction::isTaxDeducted() const {
    return m_tax_deducted;
}
void OAITransaction::setTaxDeducted(const bool &tax_deducted) {
    m_tax_deducted = tax_deducted;
    m_tax_deducted_isSet = true;
}

bool OAITransaction::is_tax_deducted_Set() const{
    return m_tax_deducted_isSet;
}

bool OAITransaction::is_tax_deducted_Valid() const{
    return m_tax_deducted_isValid;
}

QString OAITransaction::getTaxEntityName() const {
    return m_tax_entity_name;
}
void OAITransaction::setTaxEntityName(const QString &tax_entity_name) {
    m_tax_entity_name = tax_entity_name;
    m_tax_entity_name_isSet = true;
}

bool OAITransaction::is_tax_entity_name_Set() const{
    return m_tax_entity_name_isSet;
}

bool OAITransaction::is_tax_entity_name_Valid() const{
    return m_tax_entity_name_isValid;
}

QString OAITransaction::getTaxNumberService() const {
    return m_tax_number_service;
}
void OAITransaction::setTaxNumberService(const QString &tax_number_service) {
    m_tax_number_service = tax_number_service;
    m_tax_number_service_isSet = true;
}

bool OAITransaction::is_tax_number_service_Set() const{
    return m_tax_number_service_isSet;
}

bool OAITransaction::is_tax_number_service_Valid() const{
    return m_tax_number_service_isValid;
}

bool OAITransaction::isTaxSupported() const {
    return m_tax_supported;
}
void OAITransaction::setTaxSupported(const bool &tax_supported) {
    m_tax_supported = tax_supported;
    m_tax_supported_isSet = true;
}

bool OAITransaction::is_tax_supported_Set() const{
    return m_tax_supported_isSet;
}

bool OAITransaction::is_tax_supported_Valid() const{
    return m_tax_supported_isValid;
}

QString OAITransaction::getTaxTimezone() const {
    return m_tax_timezone;
}
void OAITransaction::setTaxTimezone(const QString &tax_timezone) {
    m_tax_timezone = tax_timezone;
    m_tax_timezone_isSet = true;
}

bool OAITransaction::is_tax_timezone_Set() const{
    return m_tax_timezone_isSet;
}

bool OAITransaction::is_tax_timezone_Valid() const{
    return m_tax_timezone_isValid;
}

bool OAITransaction::isTest() const {
    return m_test;
}
void OAITransaction::setTest(const bool &test) {
    m_test = test;
    m_test_isSet = true;
}

bool OAITransaction::is_test_Set() const{
    return m_test_isSet;
}

bool OAITransaction::is_test_Valid() const{
    return m_test_isValid;
}

double OAITransaction::getTotalAmount() const {
    return m_total_amount;
}
void OAITransaction::setTotalAmount(const double &total_amount) {
...
QList<OAITransaction_lines> OAITransaction::getTransactionLines() const {
    return m_transaction_lines;
}
void OAITransaction::setTransactionLines(const QList<OAITransaction_lines> &transaction_lines) {
    m_transaction_lines = transaction_lines;
    m_transaction_lines_isSet = true;
}

bool OAITransaction::is_transaction_lines_Set() const{
    return m_transaction_lines_isSet;
}

bool OAITransaction::is_transaction_lines_Valid() const{
    return m_transaction_lines_isValid;
}

QString OAITransaction::getVerificationToken() const {
    return m_verification_token;
}
void OAITransaction::setVerificationToken(const QString &verification_token) {
    m_verification_token = verification_token;
    m_verification_token_isSet = true;
}

bool OAITransaction::is_verification_token_Set() const{
    return m_verification_token_isSet;
}

bool OAITransaction::is_verification_token_Valid() const{
