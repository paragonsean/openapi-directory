...
/*
 * OAIGetDailySettlementStatsIn.h
 *
 * 
 */

#ifndef OAIGetDailySettlementStatsIn_H
#define OAIGetDailySettlementStatsIn_H
...
class OAIGetDailySettlementStatsIn : public OAIObject {
public:
    OAIGetDailySettlementStatsIn();
    OAIGetDailySettlementStatsIn(QString json);
    ~OAIGetDailySettlementStatsIn() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDailySettlementStatsIn)

#endif // OAIGetDailySettlementStatsIn_H
