...
#ifndef OAILocateMyIPOut_H
#define OAILocateMyIPOut_H
...
class OAILocateMyIPOut : public OAIObject {
public:
    OAILocateMyIPOut();
    OAILocateMyIPOut(QString json);
    ~OAILocateMyIPOut() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocateMyIPOut)

#endif // OAILocateMyIPOut_H
