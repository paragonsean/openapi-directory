...
OAIConfirmTransactionOut::OAIConfirmTransactionOut(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfirmTransactionOut::OAIConfirmTransactionOut() {
    this->initializeModel();
}

OAIConfirmTransactionOut::~OAIConfirmTransactionOut() {}

void OAIConfirmTransactionOut::initializeModel() {
...
void OAIConfirmTransactionOut::fromJson(QString jsonString) {
...
void OAIConfirmTransactionOut::fromJsonObject(QJsonObject json) {
...
QString OAIConfirmTransactionOut::asJson() const {
...
QJsonObject OAIConfirmTransactionOut::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIStorage_required_fields> OAIConfirmTransactionOut::getStorageRequiredFields() const {
    return m_storage_required_fields;
}
void OAIConfirmTransactionOut::setStorageRequiredFields(const QList<OAIStorage_required_fields> &storage_required_fields) {
    m_storage_required_fields = storage_required_fields;
    m_storage_required_fields_isSet = true;
}

bool OAIConfirmTransactionOut::is_storage_required_fields_Set() const{
    return m_storage_required_fields_isSet;
}

bool OAIConfirmTransactionOut::is_storage_required_fields_Valid() const{
    return m_storage_required_fields_isValid;
}

QList<OAITax_required_fields> OAIConfirmTransactionOut::getTaxRequiredFields() const {
    return m_tax_required_fields;
}
void OAIConfirmTransactionOut::setTaxRequiredFields(const QList<OAITax_required_fields> &tax_required_fields) {
    m_tax_required_fields = tax_required_fields;
    m_tax_required_fields_isSet = true;
}

bool OAIConfirmTransactionOut::is_tax_required_fields_Set() const{
    return m_tax_required_fields_isSet;
}

bool OAIConfirmTransactionOut::is_tax_required_fields_Valid() const{
    return m_tax_required_fields_isValid;
}

OAITransaction OAIConfirmTransactionOut::getTransaction() const {
    return m_transaction;
}
void OAIConfirmTransactionOut::setTransaction(const OAITransaction &transaction) {
    m_transaction = transaction;
    m_transaction_isSet = true;
}

bool OAIConfirmTransactionOut::is_transaction_Set() const{
    return m_transaction_isSet;
}

bool OAIConfirmTransactionOut::is_transaction_Valid() const{
    return m_transaction_isValid;
}

bool OAIConfirmTransactionOut::isSet() const {
...
bool OAIConfirmTransactionOut::isValid() const {
