...
OAIGetTransactionOut::OAIGetTransactionOut(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTransactionOut::OAIGetTransactionOut() {
    this->initializeModel();
}

OAIGetTransactionOut::~OAIGetTransactionOut() {}

void OAIGetTransactionOut::initializeModel() {
...
void OAIGetTransactionOut::fromJson(QString jsonString) {
...
void OAIGetTransactionOut::fromJsonObject(QJsonObject json) {
...
QString OAIGetTransactionOut::asJson() const {
...
QJsonObject OAIGetTransactionOut::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIStorage_required_fields> OAIGetTransactionOut::getStorageRequiredFields() const {
    return m_storage_required_fields;
}
void OAIGetTransactionOut::setStorageRequiredFields(const QList<OAIStorage_required_fields> &storage_required_fields) {
    m_storage_required_fields = storage_required_fields;
    m_storage_required_fields_isSet = true;
}

bool OAIGetTransactionOut::is_storage_required_fields_Set() const{
    return m_storage_required_fields_isSet;
}

bool OAIGetTransactionOut::is_storage_required_fields_Valid() const{
    return m_storage_required_fields_isValid;
}

QList<OAITax_required_fields> OAIGetTransactionOut::getTaxRequiredFields() const {
    return m_tax_required_fields;
}
void OAIGetTransactionOut::setTaxRequiredFields(const QList<OAITax_required_fields> &tax_required_fields) {
    m_tax_required_fields = tax_required_fields;
    m_tax_required_fields_isSet = true;
}

bool OAIGetTransactionOut::is_tax_required_fields_Set() const{
    return m_tax_required_fields_isSet;
}

bool OAIGetTransactionOut::is_tax_required_fields_Valid() const{
    return m_tax_required_fields_isValid;
}

OAITransaction OAIGetTransactionOut::getTransaction() const {
    return m_transaction;
}
void OAIGetTransactionOut::setTransaction(const OAITransaction &transaction) {
    m_transaction = transaction;
    m_transaction_isSet = true;
}

bool OAIGetTransactionOut::is_transaction_Set() const{
    return m_transaction_isSet;
}

bool OAIGetTransactionOut::is_transaction_Valid() const{
    return m_transaction_isValid;
}

bool OAIGetTransactionOut::isSet() const {
...
bool OAIGetTransactionOut::isValid() const {
