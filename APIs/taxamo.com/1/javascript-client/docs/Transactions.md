...
**amount** | **Number** | Amount of transaction without tax. | [optional] 
...
**deductedTaxAmount** | **Number** | How much tax has been deducted. | [optional] 
...
**refundedTaxAmount** | **Number** | Refunded tax amount. | [optional] 
**refundedTotalAmount** | **Number** | Total amount refunde (including tax). | [optional] 
...
**taxAmount** | **Number** | Tax amount of transaction. | [optional] 
...
**totalAmount** | **Number** | Total amount of transaction. | [optional] 
**transactionLines** | [**[TransactionLines]**](TransactionLines.md) | Transaction lines. | 
