...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Taxamo.GetDailySettlementStatsIn();
  });
  ...
  describe('GetDailySettlementStatsIn', function() {
    it('should create an instance of GetDailySettlementStatsIn', function() {
      // uncomment below and update the code to test GetDailySettlementStatsIn
      //var instance = new Taxamo.GetDailySettlementStatsIn();
      //expect(instance).to.be.a(Taxamo.GetDailySettlementStatsIn);
    });
