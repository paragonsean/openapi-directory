...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Taxamo.GetTransactionsStatsByCountryIn();
  });
  ...
  describe('GetTransactionsStatsByCountryIn', function() {
    it('should create an instance of GetTransactionsStatsByCountryIn', function() {
      // uncomment below and update the code to test GetTransactionsStatsByCountryIn
      //var instance = new Taxamo.GetTransactionsStatsByCountryIn();
      //expect(instance).to.be.a(Taxamo.GetTransactionsStatsByCountryIn);
    });
