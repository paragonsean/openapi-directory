...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Taxamo.InputTransactionLine();
  });
  ...
  describe('InputTransactionLine', function() {
    it('should create an instance of InputTransactionLine', function() {
      // uncomment below and update the code to test InputTransactionLine
      //var instance = new Taxamo.InputTransactionLine();
      //expect(instance).to.be.a(Taxamo.InputTransactionLine);
    });
