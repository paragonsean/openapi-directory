...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Taxamo.ValidateTaxNumberOut();
  });
  ...
  describe('ValidateTaxNumberOut', function() {
    it('should create an instance of ValidateTaxNumberOut', function() {
      // uncomment below and update the code to test ValidateTaxNumberOut
      //var instance = new Taxamo.ValidateTaxNumberOut();
      //expect(instance).to.be.a(Taxamo.ValidateTaxNumberOut);
    });
