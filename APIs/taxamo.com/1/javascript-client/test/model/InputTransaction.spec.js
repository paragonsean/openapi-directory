...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Taxamo.InputTransaction();
  });
  ...
  describe('InputTransaction', function() {
    it('should create an instance of InputTransaction', function() {
      // uncomment below and update the code to test InputTransaction
      //var instance = new Taxamo.InputTransaction();
      //expect(instance).to.be.a(Taxamo.InputTransaction);
    });
