...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Taxamo.AdditionalCurrency();
  });
  ...
  describe('AdditionalCurrency', function() {
    it('should create an instance of AdditionalCurrency', function() {
      // uncomment below and update the code to test AdditionalCurrency
      //var instance = new Taxamo.AdditionalCurrency();
      //expect(instance).to.be.a(Taxamo.AdditionalCurrency);
    });
