...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Taxamo.GetTransactionsStatsIn();
  });
  ...
  describe('GetTransactionsStatsIn', function() {
    it('should create an instance of GetTransactionsStatsIn', function() {
      // uncomment below and update the code to test GetTransactionsStatsIn
      //var instance = new Taxamo.GetTransactionsStatsIn();
      //expect(instance).to.be.a(Taxamo.GetTransactionsStatsIn);
    });
