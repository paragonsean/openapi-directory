...
/**
 * The InputTransaction model module.
 * @module model/InputTransaction
 * @version 1
 */
class InputTransaction {
    /**
     * Constructs a new <code>InputTransaction</code>.
     * @alias module:model/InputTransaction
     * @param currencyCode {String} Currency code for transaction - e.g. EUR.
     * @param transactionLines {Array.<module:model/InputTransactionLine>} Transaction lines.
     */
    constructor(currencyCode, transactionLines) { 
        
        InputTransaction.initialize(this, currencyCode, transactionLines);
    }
    ...
    /**
     * Constructs a <code>InputTransaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InputTransaction} obj Optional instance to populate.
     * @return {module:model/InputTransaction} The populated <code>InputTransaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InputTransaction();
    ...
    /**
     * Validates the JSON data with respect to <code>InputTransaction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InputTransaction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InputTransaction.RequiredProperties) {
 ...
 * @member {String} note
 */
InputTransaction.prototype['note'] = undefined;
 ...
 */
InputTransaction.prototype['order_date'] = undefined;
 ...
 */
InputTransaction.prototype['original_transaction_key'] = undefined;
 ...
 */
InputTransaction.prototype['status'] = undefined;

/**
 * Sub account identifier.
 * @member {String} sub_account_id
 */
InputTransaction.prototype['sub_account_id'] = undefined;

/**
 * Supply date in yyyy-MM-dd format.
 * @member {String} supply_date
 */
InputTransaction.prototype['supply_date'] = undefined;
 ...
 */
InputTransaction.prototype['tax_country_code'] = undefined;

/**
 * @member {module:model/TaxDataSchema} tax_data
 */
InputTransaction.prototype['tax_data'] = undefined;
 ...
 */
InputTransaction.prototype['tax_deducted'] = undefined;

/**
 * Transaction lines.
 * @member {Array.<module:model/InputTransactionLine>} transaction_lines
 */
InputTransaction.prototype['transaction_lines'] = undefined;

/**
 * Verification token
 * @member {String} verification_token
 */
InputTransaction.prototype['verification_token'] = undefined;
