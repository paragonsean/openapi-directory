...
/**
 * The GetTransactionOut model module.
 * @module model/GetTransactionOut
 * @version 1
 */
class GetTransactionOut {
    /**
     * Constructs a new <code>GetTransactionOut</code>.
     * @alias module:model/GetTransactionOut
     */
    constructor() { 
        
        GetTransactionOut.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTransactionOut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTransactionOut} obj Optional instance to populate.
     * @return {module:model/GetTransactionOut} The populated <code>GetTransactionOut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTransactionOut();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionOut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionOut</code>.
     */
 ...
 */
GetTransactionOut.prototype['storage_required_fields'] = undefined;
 ...
 */
GetTransactionOut.prototype['tax_required_fields'] = undefined;

/**
 * @member {module:model/Transaction} transaction
 */
GetTransactionOut.prototype['transaction'] = undefined;
...
export default GetTransactionOut;
