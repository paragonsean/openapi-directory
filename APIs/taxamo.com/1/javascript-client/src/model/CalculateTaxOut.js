...
/**
 * The CalculateTaxOut model module.
 * @module model/CalculateTaxOut
 * @version 1
 */
class CalculateTaxOut {
    /**
     * Constructs a new <code>CalculateTaxOut</code>.
     * @alias module:model/CalculateTaxOut
     */
    constructor() { 
        
        CalculateTaxOut.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CalculateTaxOut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CalculateTaxOut} obj Optional instance to populate.
     * @return {module:model/CalculateTaxOut} The populated <code>CalculateTaxOut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CalculateTaxOut();
    ...
    /**
     * Validates the JSON data with respect to <code>CalculateTaxOut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CalculateTaxOut</code>.
     */
 ...
 */
CalculateTaxOut.prototype['storage_required_fields'] = undefined;
 ...
 */
CalculateTaxOut.prototype['tax_required_fields'] = undefined;

/**
 * @member {module:model/Transaction} transaction
 */
CalculateTaxOut.prototype['transaction'] = undefined;
...
export default CalculateTaxOut;
