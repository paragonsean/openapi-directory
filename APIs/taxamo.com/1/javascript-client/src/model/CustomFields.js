...
class CustomFields {
    ...
    /**
     * Validates the JSON data with respect to <code>CustomFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomFields</code>.
     */
 ...
 * @member {String} key
 */
CustomFields.prototype['key'] = undefined;

/**
 * Field's value.
 * @member {String} value
 */
CustomFields.prototype['value'] = undefined;
