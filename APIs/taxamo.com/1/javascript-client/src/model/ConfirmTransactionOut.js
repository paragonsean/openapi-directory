...
/**
 * The ConfirmTransactionOut model module.
 * @module model/ConfirmTransactionOut
 * @version 1
 */
class ConfirmTransactionOut {
    /**
     * Constructs a new <code>ConfirmTransactionOut</code>.
     * @alias module:model/ConfirmTransactionOut
     */
    constructor() { 
        
        ConfirmTransactionOut.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConfirmTransactionOut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfirmTransactionOut} obj Optional instance to populate.
     * @return {module:model/ConfirmTransactionOut} The populated <code>ConfirmTransactionOut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfirmTransactionOut();
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmTransactionOut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmTransactionOut</code>.
     */
 ...
 */
ConfirmTransactionOut.prototype['storage_required_fields'] = undefined;
 ...
 */
ConfirmTransactionOut.prototype['tax_required_fields'] = undefined;

/**
 * @member {module:model/Transaction} transaction
 */
ConfirmTransactionOut.prototype['transaction'] = undefined;
...
export default ConfirmTransactionOut;
