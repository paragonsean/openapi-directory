...
/**
 * The UpdateTransactionOut model module.
 * @module model/UpdateTransactionOut
 * @version 1
 */
class UpdateTransactionOut {
    /**
     * Constructs a new <code>UpdateTransactionOut</code>.
     * @alias module:model/UpdateTransactionOut
     */
    constructor() { 
        
        UpdateTransactionOut.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateTransactionOut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateTransactionOut} obj Optional instance to populate.
     * @return {module:model/UpdateTransactionOut} The populated <code>UpdateTransactionOut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateTransactionOut();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateTransactionOut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateTransactionOut</code>.
     */
 ...
 */
UpdateTransactionOut.prototype['storage_required_fields'] = undefined;
 ...
 */
UpdateTransactionOut.prototype['tax_required_fields'] = undefined;

/**
 * @member {module:model/Transaction} transaction
 */
UpdateTransactionOut.prototype['transaction'] = undefined;
...
export default UpdateTransactionOut;
