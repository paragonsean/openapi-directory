...
/**
 * The CreateTransactionOut model module.
 * @module model/CreateTransactionOut
 * @version 1
 */
class CreateTransactionOut {
    /**
     * Constructs a new <code>CreateTransactionOut</code>.
     * @alias module:model/CreateTransactionOut
     */
    constructor() { 
        
        CreateTransactionOut.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateTransactionOut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTransactionOut} obj Optional instance to populate.
     * @return {module:model/CreateTransactionOut} The populated <code>CreateTransactionOut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTransactionOut();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTransactionOut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTransactionOut</code>.
     */
 ...
 */
CreateTransactionOut.prototype['storage_required_fields'] = undefined;
 ...
 */
CreateTransactionOut.prototype['tax_required_fields'] = undefined;

/**
 * @member {module:model/Transaction} transaction
 */
CreateTransactionOut.prototype['transaction'] = undefined;
...
export default CreateTransactionOut;
