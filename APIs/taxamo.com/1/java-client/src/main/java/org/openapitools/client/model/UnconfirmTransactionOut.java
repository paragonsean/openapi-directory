...
public class UnconfirmTransactionOut {
  ...
  public UnconfirmTransactionOut() {
  }

  public UnconfirmTransactionOut storageRequiredFields(List<StorageRequiredFields> storageRequiredFields) {
    this.storageRequiredFields = storageRequiredFields;
    return this;
  }

  public UnconfirmTransactionOut addStorageRequiredFieldsItem(StorageRequiredFields storageRequiredFieldsItem) {
  ...
  public UnconfirmTransactionOut taxRequiredFields(List<TaxRequiredFields> taxRequiredFields) {
    this.taxRequiredFields = taxRequiredFields;
    return this;
  }

  public UnconfirmTransactionOut addTaxRequiredFieldsItem(TaxRequiredFields taxRequiredFieldsItem) {
  ...
  public UnconfirmTransactionOut transaction(Transaction transaction) {
  ...
  public boolean equals(Object o) {
    ...
    UnconfirmTransactionOut unconfirmTransactionOut = (UnconfirmTransactionOut) o;
    return Objects.equals(this.storageRequiredFields, unconfirmTransactionOut.storageRequiredFields) &&
        Objects.equals(this.taxRequiredFields, unconfirmTransactionOut.taxRequiredFields) &&
        Objects.equals(this.transaction, unconfirmTransactionOut.transaction);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnconfirmTransactionOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnconfirmTransactionOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnconfirmTransactionOut is not found in the empty JSON string", UnconfirmTransactionOut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnconfirmTransactionOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnconfirmTransactionOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnconfirmTransactionOut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnconfirmTransactionOut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnconfirmTransactionOut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnconfirmTransactionOut.class));

       return (TypeAdapter<T>) new TypeAdapter<UnconfirmTransactionOut>() {
           @Override
           public void write(JsonWriter out, UnconfirmTransactionOut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnconfirmTransactionOut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnconfirmTransactionOut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnconfirmTransactionOut
   * @throws IOException if the JSON string is invalid with respect to UnconfirmTransactionOut
   */
  public static UnconfirmTransactionOut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnconfirmTransactionOut.class);
  }

  /**
   * Convert an instance of UnconfirmTransactionOut to an JSON string
   *
   * @return JSON string
   */
