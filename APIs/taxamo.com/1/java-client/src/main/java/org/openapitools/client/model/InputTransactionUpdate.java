...
public class InputTransactionUpdate {
  ...
  public InputTransactionUpdate() {
  }

  public InputTransactionUpdate additionalCurrencies(AdditionalCurrencies additionalCurrencies) {
  ...
  public InputTransactionUpdate billingCountryCode(String billingCountryCode) {
  ...
  public InputTransactionUpdate buyerCreditCardPrefix(String buyerCreditCardPrefix) {
  ...
  public InputTransactionUpdate buyerEmail(String buyerEmail) {
  ...
  public InputTransactionUpdate buyerIp(String buyerIp) {
  ...
  public InputTransactionUpdate buyerName(String buyerName) {
  ...
  public InputTransactionUpdate buyerTaxNumber(String buyerTaxNumber) {
  ...
  public InputTransactionUpdate comments(String comments) {
  ...
  public InputTransactionUpdate currencyCode(String currencyCode) {
  ...
  public InputTransactionUpdate customData(String customData) {
  ...
  public InputTransactionUpdate customFields(List<CustomFields> customFields) {
    this.customFields = customFields;
    return this;
  }

  public InputTransactionUpdate addCustomFieldsItem(CustomFields customFieldsItem) {
  ...
  public InputTransactionUpdate customId(String customId) {
  ...
  public InputTransactionUpdate customerId(String customerId) {
  ...
  public InputTransactionUpdate description(String description) {
  ...
  public InputTransactionUpdate evidence(Evidence evidence) {
  ...
  public InputTransactionUpdate forceCountryCode(String forceCountryCode) {
  ...
  public InputTransactionUpdate invoiceAddress(InvoiceAddress invoiceAddress) {
  ...
  public InputTransactionUpdate invoiceDate(String invoiceDate) {
  ...
  public InputTransactionUpdate invoiceNumber(String invoiceNumber) {
  ...
  public InputTransactionUpdate invoicePlace(String invoicePlace) {
  ...
  public InputTransactionUpdate note(String note) {
    this.note = note;
    return this;
  }
  ...
  public InputTransactionUpdate orderDate(String orderDate) {
  ...
  public InputTransactionUpdate originalTransactionKey(String originalTransactionKey) {
  ...
  public InputTransactionUpdate status(String status) {
    this.status = status;
    return this;
  }
  ...
  public InputTransactionUpdate subAccountId(String subAccountId) {
  ...
  public InputTransactionUpdate supplyDate(String supplyDate) {
  ...
  public InputTransactionUpdate taxCountryCode(String taxCountryCode) {
  ...
  public InputTransactionUpdate taxData(TaxDataSchema taxData) {
  ...
  public InputTransactionUpdate taxDeducted(Boolean taxDeducted) {
  ...
  public InputTransactionUpdate transactionLines(List<InputTransactionLine> transactionLines) {
    this.transactionLines = transactionLines;
    return this;
  }

  public InputTransactionUpdate addTransactionLinesItem(InputTransactionLine transactionLinesItem) {
  ...
  public InputTransactionUpdate verificationToken(String verificationToken) {
  ...
  public boolean equals(Object o) {
    ...
    InputTransactionUpdate inputTransactionUpdate = (InputTransactionUpdate) o;
    return Objects.equals(this.additionalCurrencies, inputTransactionUpdate.additionalCurrencies) &&
        Objects.equals(this.billingCountryCode, inputTransactionUpdate.billingCountryCode) &&
        Objects.equals(this.buyerCreditCardPrefix, inputTransactionUpdate.buyerCreditCardPrefix) &&
        Objects.equals(this.buyerEmail, inputTransactionUpdate.buyerEmail) &&
        Objects.equals(this.buyerIp, inputTransactionUpdate.buyerIp) &&
        Objects.equals(this.buyerName, inputTransactionUpdate.buyerName) &&
        Objects.equals(this.buyerTaxNumber, inputTransactionUpdate.buyerTaxNumber) &&
        Objects.equals(this.comments, inputTransactionUpdate.comments) &&
        Objects.equals(this.currencyCode, inputTransactionUpdate.currencyCode) &&
        Objects.equals(this.customData, inputTransactionUpdate.customData) &&
        Objects.equals(this.customFields, inputTransactionUpdate.customFields) &&
        Objects.equals(this.customId, inputTransactionUpdate.customId) &&
        Objects.equals(this.customerId, inputTransactionUpdate.customerId) &&
        Objects.equals(this.description, inputTransactionUpdate.description) &&
        Objects.equals(this.evidence, inputTransactionUpdate.evidence) &&
        Objects.equals(this.forceCountryCode, inputTransactionUpdate.forceCountryCode) &&
        Objects.equals(this.invoiceAddress, inputTransactionUpdate.invoiceAddress) &&
        Objects.equals(this.invoiceDate, inputTransactionUpdate.invoiceDate) &&
        Objects.equals(this.invoiceNumber, inputTransactionUpdate.invoiceNumber) &&
        Objects.equals(this.invoicePlace, inputTransactionUpdate.invoicePlace) &&
        Objects.equals(this.note, inputTransactionUpdate.note) &&
        Objects.equals(this.orderDate, inputTransactionUpdate.orderDate) &&
        Objects.equals(this.originalTransactionKey, inputTransactionUpdate.originalTransactionKey) &&
        Objects.equals(this.status, inputTransactionUpdate.status) &&
        Objects.equals(this.subAccountId, inputTransactionUpdate.subAccountId) &&
        Objects.equals(this.supplyDate, inputTransactionUpdate.supplyDate) &&
        Objects.equals(this.taxCountryCode, inputTransactionUpdate.taxCountryCode) &&
        Objects.equals(this.taxData, inputTransactionUpdate.taxData) &&
        Objects.equals(this.taxDeducted, inputTransactionUpdate.taxDeducted) &&
        Objects.equals(this.transactionLines, inputTransactionUpdate.transactionLines) &&
        Objects.equals(this.verificationToken, inputTransactionUpdate.verificationToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InputTransactionUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InputTransactionUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InputTransactionUpdate is not found in the empty JSON string", InputTransactionUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InputTransactionUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InputTransactionUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("transaction_lines") != null && !jsonObj.get("transaction_lines").isJsonNull()) {
        JsonArray jsonArraytransactionLines = jsonObj.getAsJsonArray("transaction_lines");
        if (jsonArraytransactionLines != null) {
          // ensure the json data is an array
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InputTransactionUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InputTransactionUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InputTransactionUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InputTransactionUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<InputTransactionUpdate>() {
           @Override
           public void write(JsonWriter out, InputTransactionUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InputTransactionUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InputTransactionUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InputTransactionUpdate
   * @throws IOException if the JSON string is invalid with respect to InputTransactionUpdate
   */
  public static InputTransactionUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InputTransactionUpdate.class);
  }

  /**
   * Convert an instance of InputTransactionUpdate to an JSON string
   *
   * @return JSON string
   */
