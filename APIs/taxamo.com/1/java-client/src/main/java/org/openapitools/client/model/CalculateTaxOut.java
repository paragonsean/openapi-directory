...
public class CalculateTaxOut {
  ...
  public CalculateTaxOut() {
  }

  public CalculateTaxOut storageRequiredFields(List<StorageRequiredFields> storageRequiredFields) {
    this.storageRequiredFields = storageRequiredFields;
    return this;
  }

  public CalculateTaxOut addStorageRequiredFieldsItem(StorageRequiredFields storageRequiredFieldsItem) {
  ...
  public CalculateTaxOut taxRequiredFields(List<TaxRequiredFields> taxRequiredFields) {
    this.taxRequiredFields = taxRequiredFields;
    return this;
  }

  public CalculateTaxOut addTaxRequiredFieldsItem(TaxRequiredFields taxRequiredFieldsItem) {
  ...
  public CalculateTaxOut transaction(Transaction transaction) {
  ...
  public boolean equals(Object o) {
    ...
    CalculateTaxOut calculateTaxOut = (CalculateTaxOut) o;
    return Objects.equals(this.storageRequiredFields, calculateTaxOut.storageRequiredFields) &&
        Objects.equals(this.taxRequiredFields, calculateTaxOut.taxRequiredFields) &&
        Objects.equals(this.transaction, calculateTaxOut.transaction);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CalculateTaxOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CalculateTaxOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CalculateTaxOut is not found in the empty JSON string", CalculateTaxOut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CalculateTaxOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CalculateTaxOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CalculateTaxOut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CalculateTaxOut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CalculateTaxOut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CalculateTaxOut.class));

       return (TypeAdapter<T>) new TypeAdapter<CalculateTaxOut>() {
           @Override
           public void write(JsonWriter out, CalculateTaxOut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CalculateTaxOut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CalculateTaxOut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CalculateTaxOut
   * @throws IOException if the JSON string is invalid with respect to CalculateTaxOut
   */
  public static CalculateTaxOut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CalculateTaxOut.class);
  }

  /**
   * Convert an instance of CalculateTaxOut to an JSON string
   *
   * @return JSON string
   */
