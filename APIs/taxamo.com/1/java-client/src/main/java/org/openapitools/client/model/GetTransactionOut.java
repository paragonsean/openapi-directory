...
public class GetTransactionOut {
  ...
  public GetTransactionOut() {
  }

  public GetTransactionOut storageRequiredFields(List<StorageRequiredFields> storageRequiredFields) {
    this.storageRequiredFields = storageRequiredFields;
    return this;
  }

  public GetTransactionOut addStorageRequiredFieldsItem(StorageRequiredFields storageRequiredFieldsItem) {
  ...
  public GetTransactionOut taxRequiredFields(List<TaxRequiredFields> taxRequiredFields) {
    this.taxRequiredFields = taxRequiredFields;
    return this;
  }

  public GetTransactionOut addTaxRequiredFieldsItem(TaxRequiredFields taxRequiredFieldsItem) {
  ...
  public GetTransactionOut transaction(Transaction transaction) {
  ...
  public boolean equals(Object o) {
    ...
    GetTransactionOut getTransactionOut = (GetTransactionOut) o;
    return Objects.equals(this.storageRequiredFields, getTransactionOut.storageRequiredFields) &&
        Objects.equals(this.taxRequiredFields, getTransactionOut.taxRequiredFields) &&
        Objects.equals(this.transaction, getTransactionOut.transaction);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTransactionOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTransactionOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTransactionOut is not found in the empty JSON string", GetTransactionOut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTransactionOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTransactionOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTransactionOut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTransactionOut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTransactionOut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTransactionOut.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTransactionOut>() {
           @Override
           public void write(JsonWriter out, GetTransactionOut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTransactionOut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTransactionOut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTransactionOut
   * @throws IOException if the JSON string is invalid with respect to GetTransactionOut
   */
  public static GetTransactionOut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTransactionOut.class);
  }

  /**
   * Convert an instance of GetTransactionOut to an JSON string
   *
   * @return JSON string
   */
