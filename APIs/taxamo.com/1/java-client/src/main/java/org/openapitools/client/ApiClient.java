...
public class ApiClient {
    ...
    private String basePath = "https://api.taxamo.com";
    ...
    public ApiClient() {
        ...
        authentications.put("apiKey", new ApiKeyAuth("header", "Token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.taxamo.com
