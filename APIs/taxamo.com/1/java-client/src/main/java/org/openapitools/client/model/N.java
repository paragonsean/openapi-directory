...
public class N {
  ...
  public N value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    N N = (N) o;
    return Objects.equals(this.day, N.day) &&
        Objects.equals(this.dayRaw, N.dayRaw) &&
        Objects.equals(this.status, N.status) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to N
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!N.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in N is not found in the empty JSON string", N.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!N.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `N` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!N.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'N' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<N> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(N.class));

       return (TypeAdapter<T>) new TypeAdapter<N>() {
           @Override
  ...
  /**
   * Create an instance of N given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of N
   * @throws IOException if the JSON string is invalid with respect to N
   */
  public static N fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, N.class);
  }

  /**
   * Convert an instance of N to an JSON string
   *
   * @return JSON string
   */
