...
public class CalculateSimpleTaxOut {
  ...
  public CalculateSimpleTaxOut() {
  }

  public CalculateSimpleTaxOut storageRequiredFields(List<StorageRequiredFields> storageRequiredFields) {
    this.storageRequiredFields = storageRequiredFields;
    return this;
  }

  public CalculateSimpleTaxOut addStorageRequiredFieldsItem(StorageRequiredFields storageRequiredFieldsItem) {
  ...
  public CalculateSimpleTaxOut taxRequiredFields(List<TaxRequiredFields> taxRequiredFields) {
    this.taxRequiredFields = taxRequiredFields;
    return this;
  }

  public CalculateSimpleTaxOut addTaxRequiredFieldsItem(TaxRequiredFields taxRequiredFieldsItem) {
  ...
  public CalculateSimpleTaxOut transaction(Transaction transaction) {
  ...
  public boolean equals(Object o) {
    ...
    CalculateSimpleTaxOut calculateSimpleTaxOut = (CalculateSimpleTaxOut) o;
    return Objects.equals(this.storageRequiredFields, calculateSimpleTaxOut.storageRequiredFields) &&
        Objects.equals(this.taxRequiredFields, calculateSimpleTaxOut.taxRequiredFields) &&
        Objects.equals(this.transaction, calculateSimpleTaxOut.transaction);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CalculateSimpleTaxOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CalculateSimpleTaxOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CalculateSimpleTaxOut is not found in the empty JSON string", CalculateSimpleTaxOut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CalculateSimpleTaxOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CalculateSimpleTaxOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CalculateSimpleTaxOut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CalculateSimpleTaxOut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CalculateSimpleTaxOut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CalculateSimpleTaxOut.class));

       return (TypeAdapter<T>) new TypeAdapter<CalculateSimpleTaxOut>() {
           @Override
           public void write(JsonWriter out, CalculateSimpleTaxOut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CalculateSimpleTaxOut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CalculateSimpleTaxOut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CalculateSimpleTaxOut
   * @throws IOException if the JSON string is invalid with respect to CalculateSimpleTaxOut
   */
  public static CalculateSimpleTaxOut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CalculateSimpleTaxOut.class);
  }

  /**
   * Convert an instance of CalculateSimpleTaxOut to an JSON string
   *
   * @return JSON string
   */
