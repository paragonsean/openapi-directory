...
public class UpdateTransactionOut {
  ...
  public UpdateTransactionOut() {
  }

  public UpdateTransactionOut storageRequiredFields(List<StorageRequiredFields> storageRequiredFields) {
    this.storageRequiredFields = storageRequiredFields;
    return this;
  }

  public UpdateTransactionOut addStorageRequiredFieldsItem(StorageRequiredFields storageRequiredFieldsItem) {
  ...
  public UpdateTransactionOut taxRequiredFields(List<TaxRequiredFields> taxRequiredFields) {
    this.taxRequiredFields = taxRequiredFields;
    return this;
  }

  public UpdateTransactionOut addTaxRequiredFieldsItem(TaxRequiredFields taxRequiredFieldsItem) {
  ...
  public UpdateTransactionOut transaction(Transaction transaction) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateTransactionOut updateTransactionOut = (UpdateTransactionOut) o;
    return Objects.equals(this.storageRequiredFields, updateTransactionOut.storageRequiredFields) &&
        Objects.equals(this.taxRequiredFields, updateTransactionOut.taxRequiredFields) &&
        Objects.equals(this.transaction, updateTransactionOut.transaction);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateTransactionOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateTransactionOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateTransactionOut is not found in the empty JSON string", UpdateTransactionOut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateTransactionOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateTransactionOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateTransactionOut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateTransactionOut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateTransactionOut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTransactionOut.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateTransactionOut>() {
           @Override
           public void write(JsonWriter out, UpdateTransactionOut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateTransactionOut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateTransactionOut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateTransactionOut
   * @throws IOException if the JSON string is invalid with respect to UpdateTransactionOut
   */
  public static UpdateTransactionOut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateTransactionOut.class);
  }

  /**
   * Convert an instance of UpdateTransactionOut to an JSON string
   *
   * @return JSON string
   */
