...
import org.openapitools.client.api.DweetsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    DweetsApi apiInstance = new DweetsApi(defaultClient);
...
<a id="dweetQuietlyForThingPost"></a>
