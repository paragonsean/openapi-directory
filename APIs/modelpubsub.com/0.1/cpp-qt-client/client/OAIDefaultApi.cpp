...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("apiV10SafeUnsafeImageWithTagsPost", serverConf);
    _serverIndices.insert("apiV10SafeUnsafeImageWithTagsPost", 0);
}
...
void OAIDefaultApi::apiV10SafeUnsafeImageWithTagsPost(const ::OpenAPI::OptionalParam<OAIApiv1_0_SafeUnsafeImageWithTags_body> &oai_apiv1_0_safe_unsafe_image_with_tags_body) {
    QString fullPath = QString(_serverConfigs["apiV10SafeUnsafeImageWithTagsPost"][_serverIndices.value("apiV10SafeUnsafeImageWithTagsPost")].URL()+"/api-v1.0/SafeUnsafeImageWithTags");
    ...
    if (oai_apiv1_0_safe_unsafe_image_with_tags_body.hasValue()){

        
        QByteArray output = oai_apiv1_0_safe_unsafe_image_with_tags_body.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::apiV10SafeUnsafeImageWithTagsPostCallback);
...
void OAIDefaultApi::apiV10SafeUnsafeImageWithTagsPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiV10SafeUnsafeImageWithTagsPostSignal(output);
        Q_EMIT apiV10SafeUnsafeImageWithTagsPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiV10SafeUnsafeImageWithTagsPostSignalE(output, error_type, error_str);
        Q_EMIT apiV10SafeUnsafeImageWithTagsPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiV10SafeUnsafeImageWithTagsPostSignalError(output, error_type, error_str);
        Q_EMIT apiV10SafeUnsafeImageWithTagsPostSignalErrorFull(worker, error_type, error_str);
    }
}
