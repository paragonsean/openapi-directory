...
public class ApiClient {
    ...
    private String basePath = "https://www.zoomconnect.com/app";
    ...
    public ApiClient() {
        ...
        authentications.put("email", new ApiKeyAuth("header", "email"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.zoomconnect.com/app
