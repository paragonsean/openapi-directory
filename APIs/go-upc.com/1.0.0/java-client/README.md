...
- API version: 1.0.0
  - Build date: 2024-10-12T12:43:14.147316-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*ProductApi* | [**getProductInfo**](docs/ProductApi.md#getProductInfo) | **GET** /code/{code} | Retrieve product info for a particular barcode number (UPC, EAN, or ISBN).


## Documentation for Models

 - [Error](docs/Error.md)
 - [GetProductInfo200Response](docs/GetProductInfo200Response.md)
 - [GetProductInfo200ResponseProduct](docs/GetProductInfo200ResponseProduct.md)
