...
void OAIProductApi::getProductInfo(const QString &code) {
    QString fullPath = QString(_serverConfigs["getProductInfo"][_serverIndices.value("getProductInfo")].URL()+"/code/{code}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductApi::getProductInfoCallback);
...
void OAIProductApi::getProductInfoCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetProductInfo_200_response output(QString(worker->response));
    worker->deleteLater();
