...
class Error {
     ...
     * @param error {String} A human readable error message.
     */
    constructor(error) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('codeType')) {
                obj['codeType'] = ApiClient.convertToType(data['codeType'], Object);
            }
 ...
 * @member {Object} codeType
 */
Error.prototype['codeType'] = undefined;
