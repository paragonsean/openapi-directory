...
/**
 * The ExposedActionSchema model module.
 * @module model/ExposedActionSchema
 * @version 1.0.0
 */
class ExposedActionSchema {
    /**
     * Constructs a new <code>ExposedActionSchema</code>.
     * @alias module:model/ExposedActionSchema
     * @param description {String} Description of the action.
     * @param id {String} The unique ID of the exposed action.
     * @param operationId {String} The operation ID of the exposed action.
     * @param params {Object} Available hint fields for the action.
     */
    constructor(description, id, operationId, params) { 
        
        ExposedActionSchema.initialize(this, description, id, operationId, params);
    }
     ...
     */
    static initialize(obj, description, id, operationId, params) { 
    ...
    /**
     * Constructs a <code>ExposedActionSchema</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExposedActionSchema} obj Optional instance to populate.
     * @return {module:model/ExposedActionSchema} The populated <code>ExposedActionSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExposedActionSchema();
    ...
    /**
     * Validates the JSON data with respect to <code>ExposedActionSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExposedActionSchema</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExposedActionSchema.RequiredProperties) {
...
ExposedActionSchema.RequiredProperties = ["description", "id", "operation_id", "params"];

/**
 * Description of the action.
 * @member {String} description
 */
ExposedActionSchema.prototype['description'] = undefined;

/**
 * The unique ID of the exposed action.
 * @member {String} id
 */
ExposedActionSchema.prototype['id'] = undefined;

/**
 * The operation ID of the exposed action.
 * @member {String} operation_id
 */
ExposedActionSchema.prototype['operation_id'] = undefined;

/**
 * Available hint fields for the action.
 * @member {Object} params
 */
ExposedActionSchema.prototype['params'] = undefined;
...
export default ExposedActionSchema;
