...
import ExecuteRequest from '../model/ExecuteRequest';
import ExecuteResponse from '../model/ExecuteResponse';
import ExposedActionResponseSchema from '../model/ExposedActionResponseSchema';
...
export default class DefaultApi {
    ...
    */
    ...
    check(callback) {
      ...
      let authNames = ['AccessPointApiKeyQuery', 'SessionAuth', 'AccessPointApiKeyHeader', 'AccessPointOAuth'];
      let contentTypes = [];
      let accepts = [];
      let returnType = null;
    ...
    /**
     * Callback function to receive the result of the executeAppActionEndpoint operation.
     * @callback module:api/DefaultApi~executeAppActionEndpointCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ExecuteResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/ExecuteRequest} executeRequest 
     * @param {module:api/DefaultApi~executeAppActionEndpointCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ExecuteResponse}
     */
    executeAppActionEndpoint(exposedAppActionId, executeRequest, callback) {
      let postBody = executeRequest;
      // verify the required parameter 'exposedAppActionId' is set
      if (exposedAppActionId === undefined || exposedAppActionId === null) {
        throw new Error("Missing the required parameter 'exposedAppActionId' when calling executeAppActionEndpoint");
      }
      // verify the required parameter 'executeRequest' is set
      if (executeRequest === undefined || executeRequest === null) {
        throw new Error("Missing the required parameter 'executeRequest' when calling executeAppActionEndpoint");
      }

      let pathParams = {
        'exposed_app_action_id': exposedAppActionId
      };
      let queryParams = {
      };
      let headerParams = {
      ...
      let returnType = ExecuteResponse;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getConfigurationLink operation.
     * @callback module:api/DefaultApi~getConfigurationLinkCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/DefaultApi~getConfigurationLinkCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getConfigurationLink(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getExecutionLogEndpoint operation.
     * @callback module:api/DefaultApi~getExecutionLogEndpointCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ExecuteResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/DefaultApi~getExecutionLogEndpointCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ExecuteResponse}
     */
    getExecutionLogEndpoint(executionLogId, callback) {
      let postBody = null;
      // verify the required parameter 'executionLogId' is set
      if (executionLogId === undefined || executionLogId === null) {
        throw new Error("Missing the required parameter 'executionLogId' when calling getExecutionLogEndpoint");
      }
    ...
    /**
     * Callback function to receive the result of the listExposedActions operation.
     * @callback module:api/DefaultApi~listExposedActionsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ExposedActionResponseSchema} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/DefaultApi~listExposedActionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ExposedActionResponseSchema}
     */
    listExposedActions(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ExposedActionResponseSchema;
      return this.apiClient.callApi(
        '/api/v1/exposed/', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
