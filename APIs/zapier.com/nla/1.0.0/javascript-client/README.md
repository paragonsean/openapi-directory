# zapier_natural_language_actions__nla_api_beta

ZapierNaturalLanguageActionsNlaApiBeta - JavaScript client for zapier_natural_language_actions__nla_api_beta
...
```shell
npm install zapier_natural_language_actions__nla_api_beta --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your zapier_natural_language_actions__nla_api_beta from, and run:
...
```javascript
var ZapierNaturalLanguageActionsNlaApiBeta = require('zapier_natural_language_actions__nla_api_beta');

var defaultClient = ZapierNaturalLanguageActionsNlaApiBeta.ApiClient.instance;
// Configure API key authorization: AccessPointApiKeyQuery
var AccessPointApiKeyQuery = defaultClient.authentications['AccessPointApiKeyQuery'];
AccessPointApiKeyQuery.apiKey = "YOUR API KEY"
// Uncomment the following line to set a prefix for the API key, e.g. "Token" (defaults to null)
//AccessPointApiKeyQuery.apiKeyPrefix['api_key'] = "Token"
// Configure API key authorization: SessionAuth
var SessionAuth = defaultClient.authentications['SessionAuth'];
SessionAuth.apiKey = "YOUR API KEY"
// Uncomment the following line to set a prefix for the API key, e.g. "Token" (defaults to null)
//SessionAuth.apiKeyPrefix['sessionid'] = "Token"
// Configure API key authorization: AccessPointApiKeyHeader
var AccessPointApiKeyHeader = defaultClient.authentications['AccessPointApiKeyHeader'];
AccessPointApiKeyHeader.apiKey = "YOUR API KEY"
// Uncomment the following line to set a prefix for the API key, e.g. "Token" (defaults to null)
//AccessPointApiKeyHeader.apiKeyPrefix['X-API-Key'] = "Token"
// Configure OAuth2 access token for authorization: AccessPointOAuth
var AccessPointOAuth = defaultClient.authentications['AccessPointOAuth'];
AccessPointOAuth.accessToken = "YOUR ACCESS TOKEN"

var api = new ZapierNaturalLanguageActionsNlaApiBeta.DefaultApi()
...
------------ | ------------- | ------------- | -------------
*ZapierNaturalLanguageActionsNlaApiBeta.DefaultApi* | [**check**](docs/DefaultApi.md#check) | **GET** /api/v1/check/ | Check
*ZapierNaturalLanguageActionsNlaApiBeta.DefaultApi* | [**executeAppActionEndpoint**](docs/DefaultApi.md#executeAppActionEndpoint) | **POST** /api/v1/exposed/{exposed_app_action_id}/execute/ | Execute App Action Endpoint
*ZapierNaturalLanguageActionsNlaApiBeta.DefaultApi* | [**getConfigurationLink**](docs/DefaultApi.md#getConfigurationLink) | **GET** /api/v1/configuration-link/ | Get Configuration Link
*ZapierNaturalLanguageActionsNlaApiBeta.DefaultApi* | [**getExecutionLogEndpoint**](docs/DefaultApi.md#getExecutionLogEndpoint) | **GET** /api/v1/execution-log/{execution_log_id}/ | Get Execution Log Endpoint
*ZapierNaturalLanguageActionsNlaApiBeta.DefaultApi* | [**listExposedActions**](docs/DefaultApi.md#listExposedActions) | **GET** /api/v1/exposed/ | List Exposed Actions


## Documentation for Models

 - [ZapierNaturalLanguageActionsNlaApiBeta.ErrorResponse](docs/ErrorResponse.md)
 - [ZapierNaturalLanguageActionsNlaApiBeta.ExecuteRequest](docs/ExecuteRequest.md)
 - [ZapierNaturalLanguageActionsNlaApiBeta.ExecuteResponse](docs/ExecuteResponse.md)
 - [ZapierNaturalLanguageActionsNlaApiBeta.ExposedActionResponseSchema](docs/ExposedActionResponseSchema.md)
 - [ZapierNaturalLanguageActionsNlaApiBeta.ExposedActionSchema](docs/ExposedActionSchema.md)
