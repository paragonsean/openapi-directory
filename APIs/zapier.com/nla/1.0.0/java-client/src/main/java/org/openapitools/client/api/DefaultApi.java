...
import org.openapitools.client.model.ExecuteResponse;
import org.openapitools.client.model.ExposedActionResponseSchema;
...
public class DefaultApi {
    ...
    public okhttp3.Call checkCall(final ApiCallback _callback) throws ApiException {
        ...
        String[] localVarAuthNames = new String[] { "AccessPointApiKeyQuery", "SessionAuth", "AccessPointApiKeyHeader", "AccessPointOAuth" };
    ...
    /**
     * Build call for executeAppActionEndpoint
     ...
     */
    public okhttp3.Call executeAppActionEndpointCall(String exposedAppActionId, ExecuteRequest executeRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call executeAppActionEndpointValidateBeforeCall(String exposedAppActionId, ExecuteRequest executeRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'exposedAppActionId' is set
        if (exposedAppActionId == null) {
            throw new ApiException("Missing the required parameter 'exposedAppActionId' when calling executeAppActionEndpoint(Async)");
        }

        // verify the required parameter 'executeRequest' is set
        if (executeRequest == null) {
            throw new ApiException("Missing the required parameter 'executeRequest' when calling executeAppActionEndpoint(Async)");
        }

        return executeAppActionEndpointCall(exposedAppActionId, executeRequest, _callback);
     ...
     */
    public ExecuteResponse executeAppActionEndpoint(String exposedAppActionId, ExecuteRequest executeRequest) throws ApiException {
        ApiResponse<ExecuteResponse> localVarResp = executeAppActionEndpointWithHttpInfo(exposedAppActionId, executeRequest);
     ...
     */
    public ApiResponse<ExecuteResponse> executeAppActionEndpointWithHttpInfo(String exposedAppActionId, ExecuteRequest executeRequest) throws ApiException {
        okhttp3.Call localVarCall = executeAppActionEndpointValidateBeforeCall(exposedAppActionId, executeRequest, null);
        Type localVarReturnType = new TypeToken<ExecuteResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Execute App Action Endpoint (asynchronously)
     * Give us a plain english description of exact action you want to do. There should be dynamically generated documentation for this endpoint for each action that is exposed.
     * @param exposedAppActionId  (required)
     * @param executeRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call executeAppActionEndpointAsync(String exposedAppActionId, ExecuteRequest executeRequest, final ApiCallback<ExecuteResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = executeAppActionEndpointValidateBeforeCall(exposedAppActionId, executeRequest, _callback);
        Type localVarReturnType = new TypeToken<ExecuteResponse>(){}.getType();
     ...
     */
    public okhttp3.Call getConfigurationLinkCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
     ...
     */
    public void getConfigurationLink() throws ApiException {
     ...
     */
    public ApiResponse<Void> getConfigurationLinkWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getConfigurationLinkValidateBeforeCall(null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get Configuration Link (asynchronously)
     * Provides a link to configure more actions. Alternatively, searching through apps and actions will provide more specific configuration links.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getConfigurationLinkAsync(final ApiCallback<Void> _callback) throws ApiException {
    ...
    /**
     * Build call for getExecutionLogEndpoint
     ...
     */
    public okhttp3.Call getExecutionLogEndpointCall(String executionLogId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getExecutionLogEndpointValidateBeforeCall(String executionLogId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'executionLogId' is set
        if (executionLogId == null) {
            throw new ApiException("Missing the required parameter 'executionLogId' when calling getExecutionLogEndpoint(Async)");
        }

        return getExecutionLogEndpointCall(executionLogId, _callback);
     ...
     */
    public ExecuteResponse getExecutionLogEndpoint(String executionLogId) throws ApiException {
        ApiResponse<ExecuteResponse> localVarResp = getExecutionLogEndpointWithHttpInfo(executionLogId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ExecuteResponse> getExecutionLogEndpointWithHttpInfo(String executionLogId) throws ApiException {
        okhttp3.Call localVarCall = getExecutionLogEndpointValidateBeforeCall(executionLogId, null);
        Type localVarReturnType = new TypeToken<ExecuteResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Execution Log Endpoint (asynchronously)
     * Get the execution log for a given execution log id.
     * @param executionLogId  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getExecutionLogEndpointAsync(String executionLogId, final ApiCallback<ExecuteResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExecutionLogEndpointValidateBeforeCall(executionLogId, _callback);
        Type localVarReturnType = new TypeToken<ExecuteResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call listExposedActionsCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
     ...
     */
    public ExposedActionResponseSchema listExposedActions() throws ApiException {
     ...
     */
    public ApiResponse<ExposedActionResponseSchema> listExposedActionsWithHttpInfo() throws ApiException {
    ...
    /**
     * List Exposed Actions (asynchronously)
     * List all the currently exposed actions for the given account.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call listExposedActionsAsync(final ApiCallback<ExposedActionResponseSchema> _callback) throws ApiException {
