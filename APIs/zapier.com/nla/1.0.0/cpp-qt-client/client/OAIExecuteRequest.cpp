...
OAIExecuteRequest::OAIExecuteRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExecuteRequest::OAIExecuteRequest() {
    this->initializeModel();
}

OAIExecuteRequest::~OAIExecuteRequest() {}

void OAIExecuteRequest::initializeModel() {
...
void OAIExecuteRequest::fromJson(QString jsonString) {
...
void OAIExecuteRequest::fromJsonObject(QJsonObject json) {
...
QString OAIExecuteRequest::asJson() const {
...
QJsonObject OAIExecuteRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIExecuteRequest::getInstructions() const {
    return m_instructions;
}
void OAIExecuteRequest::setInstructions(const QString &instructions) {
    m_instructions = instructions;
    m_instructions_isSet = true;
}

bool OAIExecuteRequest::is_instructions_Set() const{
    return m_instructions_isSet;
}

bool OAIExecuteRequest::is_instructions_Valid() const{
    return m_instructions_isValid;
}

bool OAIExecuteRequest::isPreviewOnly() const {
    return m_preview_only;
}
void OAIExecuteRequest::setPreviewOnly(const bool &preview_only) {
    m_preview_only = preview_only;
    m_preview_only_isSet = true;
}

bool OAIExecuteRequest::is_preview_only_Set() const{
    return m_preview_only_isSet;
}

bool OAIExecuteRequest::is_preview_only_Valid() const{
    return m_preview_only_isValid;
}

bool OAIExecuteRequest::isSet() const {
...
bool OAIExecuteRequest::isValid() const {
