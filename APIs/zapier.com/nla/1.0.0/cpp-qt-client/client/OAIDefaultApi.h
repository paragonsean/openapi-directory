...
#include "OAIExecuteRequest.h"
#include "OAIExecuteResponse.h"
...
public:
    ...
    /**
    * @param[in]  exposed_app_action_id QString [required]
    * @param[in]  oai_execute_request OAIExecuteRequest [required]
    */
    virtual void executeAppActionEndpoint(const QString &exposed_app_action_id, const OAIExecuteRequest &oai_execute_request);


    virtual void getConfigurationLink();

    /**
    * @param[in]  execution_log_id QString [required]
    */
    virtual void getExecutionLogEndpoint(const QString &execution_log_id);


    virtual void listExposedActions();
...
private:
    ...
    void executeAppActionEndpointCallback(OAIHttpRequestWorker *worker);
    void getConfigurationLinkCallback(OAIHttpRequestWorker *worker);
    void getExecutionLogEndpointCallback(OAIHttpRequestWorker *worker);
    void listExposedActionsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void checkSignal();
    void executeAppActionEndpointSignal(OAIExecuteResponse summary);
    void getConfigurationLinkSignal();
    void getExecutionLogEndpointSignal(OAIExecuteResponse summary);
    void listExposedActionsSignal(OAIExposedActionResponseSchema summary);


    void checkSignalFull(OAIHttpRequestWorker *worker);
    void executeAppActionEndpointSignalFull(OAIHttpRequestWorker *worker, OAIExecuteResponse summary);
    void getConfigurationLinkSignalFull(OAIHttpRequestWorker *worker);
    void getExecutionLogEndpointSignalFull(OAIHttpRequestWorker *worker, OAIExecuteResponse summary);
    void listExposedActionsSignalFull(OAIHttpRequestWorker *worker, OAIExposedActionResponseSchema summary);

    Q_DECL_DEPRECATED_X("Use checkSignalError() instead")
    void checkSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void checkSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use executeAppActionEndpointSignalError() instead")
    void executeAppActionEndpointSignalE(OAIExecuteResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void executeAppActionEndpointSignalError(OAIExecuteResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getConfigurationLinkSignalError() instead")
    void getConfigurationLinkSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void getConfigurationLinkSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getExecutionLogEndpointSignalError() instead")
    void getExecutionLogEndpointSignalE(OAIExecuteResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getExecutionLogEndpointSignalError(OAIExecuteResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use listExposedActionsSignalError() instead")
    void listExposedActionsSignalE(OAIExposedActionResponseSchema summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listExposedActionsSignalError(OAIExposedActionResponseSchema summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use executeAppActionEndpointSignalErrorFull() instead")
    void executeAppActionEndpointSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void executeAppActionEndpointSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getConfigurationLinkSignalErrorFull() instead")
    void getConfigurationLinkSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getConfigurationLinkSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getExecutionLogEndpointSignalErrorFull() instead")
    void getExecutionLogEndpointSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getExecutionLogEndpointSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use listExposedActionsSignalErrorFull() instead")
    void listExposedActionsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void listExposedActionsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
