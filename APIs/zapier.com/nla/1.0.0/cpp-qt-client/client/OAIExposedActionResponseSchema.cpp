...
#include "OAIExposedActionResponseSchema.h"
...
OAIExposedActionResponseSchema::OAIExposedActionResponseSchema(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExposedActionResponseSchema::OAIExposedActionResponseSchema() {
    this->initializeModel();
}

OAIExposedActionResponseSchema::~OAIExposedActionResponseSchema() {}

void OAIExposedActionResponseSchema::initializeModel() {

    m_configuration_link_isSet = false;
    m_configuration_link_isValid = false;

    m_results_isSet = false;
    m_results_isValid = false;
}

void OAIExposedActionResponseSchema::fromJson(QString jsonString) {
...
void OAIExposedActionResponseSchema::fromJsonObject(QJsonObject json) {

    m_configuration_link_isValid = ::OpenAPI::fromJsonValue(m_configuration_link, json[QString("configuration_link")]);
    m_configuration_link_isSet = !json[QString("configuration_link")].isNull() && m_configuration_link_isValid;

    m_results_isValid = ::OpenAPI::fromJsonValue(m_results, json[QString("results")]);
    m_results_isSet = !json[QString("results")].isNull() && m_results_isValid;
}

QString OAIExposedActionResponseSchema::asJson() const {
...
QJsonObject OAIExposedActionResponseSchema::asJsonObject() const {
    QJsonObject obj;
    if (m_configuration_link_isSet) {
        obj.insert(QString("configuration_link"), ::OpenAPI::toJsonValue(m_configuration_link));
    }
    if (m_results.size() > 0) {
...
QString OAIExposedActionResponseSchema::getConfigurationLink() const {
    return m_configuration_link;
}
void OAIExposedActionResponseSchema::setConfigurationLink(const QString &configuration_link) {
    m_configuration_link = configuration_link;
    m_configuration_link_isSet = true;
}

bool OAIExposedActionResponseSchema::is_configuration_link_Set() const{
    return m_configuration_link_isSet;
}

bool OAIExposedActionResponseSchema::is_configuration_link_Valid() const{
    return m_configuration_link_isValid;
}

QList<OAIExposedActionSchema> OAIExposedActionResponseSchema::getResults() const {
    return m_results;
}
void OAIExposedActionResponseSchema::setResults(const QList<OAIExposedActionSchema> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIExposedActionResponseSchema::is_results_Set() const{
    return m_results_isSet;
}

bool OAIExposedActionResponseSchema::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIExposedActionResponseSchema::isSet() const {
...
bool OAIExposedActionResponseSchema::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_configuration_link_isValid && m_results_isValid && true;
}
