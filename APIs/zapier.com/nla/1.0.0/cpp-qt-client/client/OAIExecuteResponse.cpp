...
OAIExecuteResponse::OAIExecuteResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExecuteResponse::OAIExecuteResponse() {
    this->initializeModel();
}

OAIExecuteResponse::~OAIExecuteResponse() {}

void OAIExecuteResponse::initializeModel() {

    m_action_used_isSet = false;
    m_action_used_isValid = false;

    m_additional_results_isSet = false;
    m_additional_results_isValid = false;

    m_assistant_hint_isSet = false;
    m_assistant_hint_isValid = false;
    ...
    m_input_params_isSet = false;
    m_input_params_isValid = false;

    m_result_isSet = false;
    m_result_isValid = false;

    m_result_field_labels_isSet = false;
    m_result_field_labels_isValid = false;
...
void OAIExecuteResponse::fromJson(QString jsonString) {
...
void OAIExecuteResponse::fromJsonObject(QJsonObject json) {

    m_action_used_isValid = ::OpenAPI::fromJsonValue(m_action_used, json[QString("action_used")]);
    m_action_used_isSet = !json[QString("action_used")].isNull() && m_action_used_isValid;

    m_additional_results_isValid = ::OpenAPI::fromJsonValue(m_additional_results, json[QString("additional_results")]);
    m_additional_results_isSet = !json[QString("additional_results")].isNull() && m_additional_results_isValid;

    m_assistant_hint_isValid = ::OpenAPI::fromJsonValue(m_assistant_hint, json[QString("assistant_hint")]);
    m_assistant_hint_isSet = !json[QString("assistant_hint")].isNull() && m_assistant_hint_isValid;
    ...
    m_input_params_isValid = ::OpenAPI::fromJsonValue(m_input_params, json[QString("input_params")]);
    m_input_params_isSet = !json[QString("input_params")].isNull() && m_input_params_isValid;

    m_result_isValid = ::OpenAPI::fromJsonValue(m_result, json[QString("result")]);
    m_result_isSet = !json[QString("result")].isNull() && m_result_isValid;

    m_result_field_labels_isValid = ::OpenAPI::fromJsonValue(m_result_field_labels, json[QString("result_field_labels")]);
    m_result_field_labels_isSet = !json[QString("result_field_labels")].isNull() && m_result_field_labels_isValid;
...
QString OAIExecuteResponse::asJson() const {
...
QJsonObject OAIExecuteResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_action_used_isSet) {
        obj.insert(QString("action_used"), ::OpenAPI::toJsonValue(m_action_used));
    }
    if (m_additional_results.size() > 0) {
        obj.insert(QString("additional_results"), ::OpenAPI::toJsonValue(m_additional_results));
    }
    if (m_assistant_hint_isSet) {
        obj.insert(QString("assistant_hint"), ::OpenAPI::toJsonValue(m_assistant_hint));
    }
    if (m_error_isSet) {
    ...
    if (m_input_params_isSet) {
        obj.insert(QString("input_params"), ::OpenAPI::toJsonValue(m_input_params));
    }
    if (m_result_isSet) {
        obj.insert(QString("result"), ::OpenAPI::toJsonValue(m_result));
    }
    if (m_result_field_labels_isSet) {
        obj.insert(QString("result_field_labels"), ::OpenAPI::toJsonValue(m_result_field_labels));
    }
...
QString OAIExecuteResponse::getActionUsed() const {
    return m_action_used;
}
void OAIExecuteResponse::setActionUsed(const QString &action_used) {
    m_action_used = action_used;
    m_action_used_isSet = true;
}

bool OAIExecuteResponse::is_action_used_Set() const{
    return m_action_used_isSet;
}

bool OAIExecuteResponse::is_action_used_Valid() const{
    return m_action_used_isValid;
}

QList<OAIObject> OAIExecuteResponse::getAdditionalResults() const {
    return m_additional_results;
}
void OAIExecuteResponse::setAdditionalResults(const QList<OAIObject> &additional_results) {
    m_additional_results = additional_results;
    m_additional_results_isSet = true;
}

bool OAIExecuteResponse::is_additional_results_Set() const{
    return m_additional_results_isSet;
}

bool OAIExecuteResponse::is_additional_results_Valid() const{
    return m_additional_results_isValid;
}

QString OAIExecuteResponse::getAssistantHint() const {
    return m_assistant_hint;
}
void OAIExecuteResponse::setAssistantHint(const QString &assistant_hint) {
    m_assistant_hint = assistant_hint;
    m_assistant_hint_isSet = true;
}

bool OAIExecuteResponse::is_assistant_hint_Set() const{
    return m_assistant_hint_isSet;
}

bool OAIExecuteResponse::is_assistant_hint_Valid() const{
    return m_assistant_hint_isValid;
}

QString OAIExecuteResponse::getError() const {
    return m_error;
}
void OAIExecuteResponse::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIExecuteResponse::is_error_Set() const{
    return m_error_isSet;
}

bool OAIExecuteResponse::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIExecuteResponse::getId() const {
    return m_id;
}
void OAIExecuteResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIExecuteResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIExecuteResponse::is_id_Valid() const{
    return m_id_isValid;
}

OAIObject OAIExecuteResponse::getInputParams() const {
    return m_input_params;
}
void OAIExecuteResponse::setInputParams(const OAIObject &input_params) {
    m_input_params = input_params;
    m_input_params_isSet = true;
}

bool OAIExecuteResponse::is_input_params_Set() const{
    return m_input_params_isSet;
}

bool OAIExecuteResponse::is_input_params_Valid() const{
    return m_input_params_isValid;
}

OAIObject OAIExecuteResponse::getResult() const {
    return m_result;
}
void OAIExecuteResponse::setResult(const OAIObject &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIExecuteResponse::is_result_Set() const{
    return m_result_isSet;
}

bool OAIExecuteResponse::is_result_Valid() const{
    return m_result_isValid;
}

OAIObject OAIExecuteResponse::getResultFieldLabels() const {
    return m_result_field_labels;
}
void OAIExecuteResponse::setResultFieldLabels(const OAIObject &result_field_labels) {
    m_result_field_labels = result_field_labels;
    m_result_field_labels_isSet = true;
}

bool OAIExecuteResponse::is_result_field_labels_Set() const{
    return m_result_field_labels_isSet;
}

bool OAIExecuteResponse::is_result_field_labels_Valid() const{
    return m_result_field_labels_isValid;
}

QString OAIExecuteResponse::getReviewUrl() const {
    return m_review_url;
}
void OAIExecuteResponse::setReviewUrl(const QString &review_url) {
    m_review_url = review_url;
    m_review_url_isSet = true;
}

bool OAIExecuteResponse::is_review_url_Set() const{
    return m_review_url_isSet;
}

bool OAIExecuteResponse::is_review_url_Valid() const{
    return m_review_url_isValid;
}

QString OAIExecuteResponse::getStatus() const {
    return m_status;
}
void OAIExecuteResponse::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIExecuteResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIExecuteResponse::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIExecuteResponse::isSet() const {
...
bool OAIExecuteResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_action_used_isValid && m_additional_results_isValid && m_id_isValid && m_input_params_isValid && m_review_url_isValid && true;
}
