...
/*
 * OAIExecuteResponse.h
 *
 * This is a summary of the results given the action that was executed.
 */

#ifndef OAIExecuteResponse_H
#define OAIExecuteResponse_H
...
class OAIExecuteResponse : public OAIObject {
public:
    OAIExecuteResponse();
    OAIExecuteResponse(QString json);
    ~OAIExecuteResponse() override;
    ...
    QString getActionUsed() const;
    void setActionUsed(const QString &action_used);
    bool is_action_used_Set() const;
    bool is_action_used_Valid() const;

    QList<OAIObject> getAdditionalResults() const;
    void setAdditionalResults(const QList<OAIObject> &additional_results);
    bool is_additional_results_Set() const;
    bool is_additional_results_Valid() const;

    QString getAssistantHint() const;
    void setAssistantHint(const QString &assistant_hint);
    bool is_assistant_hint_Set() const;
    bool is_assistant_hint_Valid() const;
    ...
    OAIObject getInputParams() const;
    void setInputParams(const OAIObject &input_params);
    bool is_input_params_Set() const;
    bool is_input_params_Valid() const;
    ...
    OAIObject getResultFieldLabels() const;
    void setResultFieldLabels(const OAIObject &result_field_labels);
    bool is_result_field_labels_Set() const;
    bool is_result_field_labels_Valid() const;
...
private:
    ...
    QString m_action_used;
    bool m_action_used_isSet;
    bool m_action_used_isValid;

    QList<OAIObject> m_additional_results;
    bool m_additional_results_isSet;
    bool m_additional_results_isValid;

    QString m_assistant_hint;
    bool m_assistant_hint_isSet;
    bool m_assistant_hint_isValid;
    ...
    OAIObject m_input_params;
    bool m_input_params_isSet;
    bool m_input_params_isValid;

    OAIObject m_result;
    bool m_result_isSet;
    bool m_result_isValid;

    OAIObject m_result_field_labels;
    bool m_result_field_labels_isSet;
    bool m_result_field_labels_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecuteResponse)

#endif // OAIExecuteResponse_H
