...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://nla.zapier.com"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("check", defaultConf);
    _serverIndices.insert("check", 0);
    _serverConfigs.insert("executeAppActionEndpoint", defaultConf);
    _serverIndices.insert("executeAppActionEndpoint", 0);
    _serverConfigs.insert("getConfigurationLink", defaultConf);
    _serverIndices.insert("getConfigurationLink", 0);
    _serverConfigs.insert("getExecutionLogEndpoint", defaultConf);
    _serverIndices.insert("getExecutionLogEndpoint", 0);
    _serverConfigs.insert("listExposedActions", defaultConf);
    _serverIndices.insert("listExposedActions", 0);
}
...
void OAIDefaultApi::check() {
    QString fullPath = QString(_serverConfigs["check"][_serverIndices.value("check")].URL()+"/api/v1/check/");
    
    if (_apiKeys.contains("AccessPointApiKeyQuery")) {
        if (fullPath.indexOf("?") > 0)
            fullPath.append("&");
        else
            fullPath.append("?");
        fullPath.append("AccessPointApiKeyQuery=").append(_apiKeys.find("AccessPointApiKeyQuery").value());
    }
    
    if (_apiKeys.contains("AccessPointApiKeyHeader")) {
        addHeaders("AccessPointApiKeyHeader",_apiKeys.find("AccessPointApiKeyHeader").value());
    }
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::checkCallback);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT checkSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT checkSignalError(error_type, error_str);
        Q_EMIT checkSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::executeAppActionEndpoint(const QString &exposed_app_action_id, const OAIExecuteRequest &oai_execute_request) {
    QString fullPath = QString(_serverConfigs["executeAppActionEndpoint"][_serverIndices.value("executeAppActionEndpoint")].URL()+"/api/v1/exposed/{exposed_app_action_id}/execute/");
    ...
    {
        QString exposed_app_action_idPathParam("{");
        exposed_app_action_idPathParam.append("exposed_app_action_id").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "exposed_app_action_id", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"exposed_app_action_id"+pathSuffix : pathPrefix;
        fullPath.replace(exposed_app_action_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(exposed_app_action_id)));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
...

    {
        ...
        QByteArray output = oai_execute_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::executeAppActionEndpointCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::executeAppActionEndpointCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::executeAppActionEndpointCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIExecuteResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT executeAppActionEndpointSignal(output);
        Q_EMIT executeAppActionEndpointSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT executeAppActionEndpointSignalE(output, error_type, error_str);
        Q_EMIT executeAppActionEndpointSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT executeAppActionEndpointSignalError(output, error_type, error_str);
        Q_EMIT executeAppActionEndpointSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::getConfigurationLink() {
    QString fullPath = QString(_serverConfigs["getConfigurationLink"][_serverIndices.value("getConfigurationLink")].URL()+"/api/v1/configuration-link/");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getConfigurationLinkCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getConfigurationLinkCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::getConfigurationLinkCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getConfigurationLinkSignal();
        Q_EMIT getConfigurationLinkSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getConfigurationLinkSignalE(error_type, error_str);
        Q_EMIT getConfigurationLinkSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getConfigurationLinkSignalError(error_type, error_str);
        Q_EMIT getConfigurationLinkSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::getExecutionLogEndpoint(const QString &execution_log_id) {
    QString fullPath = QString(_serverConfigs["getExecutionLogEndpoint"][_serverIndices.value("getExecutionLogEndpoint")].URL()+"/api/v1/execution-log/{execution_log_id}/");
    ...
    {
        QString execution_log_idPathParam("{");
        execution_log_idPathParam.append("execution_log_id").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "execution_log_id", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"execution_log_id"+pathSuffix : pathPrefix;
        fullPath.replace(execution_log_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(execution_log_id)));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getExecutionLogEndpointCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getExecutionLogEndpointCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::getExecutionLogEndpointCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getExecutionLogEndpointSignal(output);
        Q_EMIT getExecutionLogEndpointSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getExecutionLogEndpointSignalE(output, error_type, error_str);
        Q_EMIT getExecutionLogEndpointSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getExecutionLogEndpointSignalError(output, error_type, error_str);
        Q_EMIT getExecutionLogEndpointSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::listExposedActions() {
    QString fullPath = QString(_serverConfigs["listExposedActions"][_serverIndices.value("listExposedActions")].URL()+"/api/v1/exposed/");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::listExposedActionsCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::listExposedActionsCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::listExposedActionsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIExposedActionResponseSchema output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listExposedActionsSignal(output);
        Q_EMIT listExposedActionsSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listExposedActionsSignalE(output, error_type, error_str);
        Q_EMIT listExposedActionsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listExposedActionsSignalError(output, error_type, error_str);
        Q_EMIT listExposedActionsSignalErrorFull(worker, error_type, error_str);
    }
}
