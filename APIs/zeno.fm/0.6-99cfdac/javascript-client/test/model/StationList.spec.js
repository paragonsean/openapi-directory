...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AggregatorsApiService.StationList();
  });
  ...
  describe('StationList', function() {
    it('should create an instance of StationList', function() {
      // uncomment below and update the code to test StationList
      //var instance = new AggregatorsApiService.StationList();
      //expect(instance).to.be.a(AggregatorsApiService.StationList);
    });
