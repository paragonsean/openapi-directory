...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.zeno.fm') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.zeno.fm
         */
        ...
        this.authentications = {
            'API_Key': {type: 'apiKey', 'in': 'header', name: 'x-zeno-api-key'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/0.6-99cfdac/Javascript'
        };
