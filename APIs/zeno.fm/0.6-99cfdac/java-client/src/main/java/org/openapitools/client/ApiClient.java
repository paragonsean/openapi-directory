...
public class ApiClient {
    ...
    private String basePath = "https://api.zeno.fm";
    ...
    public ApiClient() {
        ...
        authentications.put("API_Key", new ApiKeyAuth("header", "x-zeno-api-key"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.6-99cfdac/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.zeno.fm
