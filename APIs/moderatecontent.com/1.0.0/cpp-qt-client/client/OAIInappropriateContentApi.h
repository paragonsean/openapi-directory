...
#ifndef OAI_OAIInappropriateContentApi_H
#define OAI_OAIInappropriateContentApi_H
...
class OAIInappropriateContentApi : public QObject {
    Q_OBJECT

public:
    OAIInappropriateContentApi(const int timeOut = 0);
    ~OAIInappropriateContentApi();
    ...
    */
    virtual void rootGet(const QString &url);
