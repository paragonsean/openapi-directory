...
public class ArtistEventsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ArtistEventsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ArtistEventsApi(ApiClient apiClient) {
     ...
     * @param date Can be one of the following values: \&quot;upcoming\&quot;, \&quot;past\&quot;, \&quot;all\&quot;, or a date range e.g. \&quot;2015-05-05,2017-05-05\&quot;. If not specified, only upcoming shows are returned (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Shows within a date range for the selected artist </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call artistEventsCall(String artistname, String appId, String date, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/artists/{artistname}/events"
    ...
    private okhttp3.Call artistEventsValidateBeforeCall(String artistname, String appId, String date, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'artistname' is set
        if (artistname == null) {
            throw new ApiException("Missing the required parameter 'artistname' when calling artistEvents(Async)");
        }

        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling artistEvents(Async)");
        }

        return artistEventsCall(artistname, appId, date, _callback);
     ...
     */
    public List<EventData> artistEvents(String artistname, String appId, String date) throws ApiException {
        ApiResponse<List<EventData>> localVarResp = artistEventsWithHttpInfo(artistname, appId, date);
     ...
     * @param appId The application ID assigned to you by Bandsintown (required)
     * @param date Can be one of the following values: \&quot;upcoming\&quot;, \&quot;past\&quot;, \&quot;all\&quot;, or a date range e.g. \&quot;2015-05-05,2017-05-05\&quot;. If not specified, only upcoming shows are returned (optional)
     * @return ApiResponse&lt;List&lt;EventData&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<EventData>> artistEventsWithHttpInfo(String artistname, String appId, String date) throws ApiException {
        okhttp3.Call localVarCall = artistEventsValidateBeforeCall(artistname, appId, date, null);
        Type localVarReturnType = new TypeToken<List<EventData>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get upcoming, past, or all artist events, or events within a date range (asynchronously)
     * artist events 
     * @param artistname The name of the artist. If it contains one of the special characters below, please be sure to replace it by the corresponding code: for / use %252F, for ? use %253F, for * use %252A, and for \&quot; use %27C (required)
     * @param appId The application ID assigned to you by Bandsintown (required)
     * @param date Can be one of the following values: \&quot;upcoming\&quot;, \&quot;past\&quot;, \&quot;all\&quot;, or a date range e.g. \&quot;2015-05-05,2017-05-05\&quot;. If not specified, only upcoming shows are returned (optional)
     ...
     */
    public okhttp3.Call artistEventsAsync(String artistname, String appId, String date, final ApiCallback<List<EventData>> _callback) throws ApiException {

        okhttp3.Call localVarCall = artistEventsValidateBeforeCall(artistname, appId, date, _callback);
        Type localVarReturnType = new TypeToken<List<EventData>>(){}.getType();
