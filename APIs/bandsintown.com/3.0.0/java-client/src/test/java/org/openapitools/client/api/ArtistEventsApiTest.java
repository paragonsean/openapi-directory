...
/**
 * API tests for ArtistEventsApi
 */
@Disabled
public class ArtistEventsApiTest {

    private final ArtistEventsApi api = new ArtistEventsApi();
     ...
     */
    @Test
    public void artistEventsTest() throws ApiException {
        String artistname = null;
        String appId = null;
        String date = null;
        List<EventData> response = api.artistEvents(artistname, appId, date);
