...
#ifndef OAI_OAIArtistEventsApi_H
#define OAI_OAIArtistEventsApi_H
...
class OAIArtistEventsApi : public QObject {
    Q_OBJECT

public:
    OAIArtistEventsApi(const int timeOut = 0);
    ~OAIArtistEventsApi();
    ...
    */
    virtual void artistEvents(const QString &artistname, const QString &app_id, const ::OpenAPI::OptionalParam<QString> &date = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void artistEventsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void artistEventsSignal(QList<OAIEventData> summary);


    void artistEventsSignalFull(OAIHttpRequestWorker *worker, QList<OAIEventData> summary);

    Q_DECL_DEPRECATED_X("Use artistEventsSignalError() instead")
    void artistEventsSignalE(QList<OAIEventData> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void artistEventsSignalError(QList<OAIEventData> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use artistEventsSignalErrorFull() instead")
    void artistEventsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void artistEventsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
