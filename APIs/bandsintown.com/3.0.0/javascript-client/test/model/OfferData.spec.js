...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BandsintownApi.OfferData();
  });
  ...
  describe('OfferData', function() {
    it('should create an instance of OfferData', function() {
      // uncomment below and update the code to test OfferData
      //var instance = new BandsintownApi.OfferData();
      //expect(instance).to.be.a(BandsintownApi.OfferData);
    });
