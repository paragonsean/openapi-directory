...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BandsintownApi.VenueData();
  });
  ...
  describe('VenueData', function() {
    it('should create an instance of VenueData', function() {
      // uncomment below and update the code to test VenueData
      //var instance = new BandsintownApi.VenueData();
      //expect(instance).to.be.a(BandsintownApi.VenueData);
    });
