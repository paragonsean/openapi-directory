...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BandsintownApi.ArtistInformationApi();
  });
  ...
  describe('ArtistInformationApi', function() {
    describe('artist', function() {
      it('should call artist successfully', function(done) {
        //uncomment below and update the code to test artist
        //instance.artist(function(error) {
