...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BandsintownApi.ArtistEventsApi();
  });
  ...
  describe('ArtistEventsApi', function() {
    describe('artistEvents', function() {
      it('should call artistEvents successfully', function(done) {
        //uncomment below and update the code to test artistEvents
        //instance.artistEvents(function(error) {
