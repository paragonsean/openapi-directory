...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mailsquad.SubscriptionRequest();
  });
  ...
  describe('SubscriptionRequest', function() {
    it('should create an instance of SubscriptionRequest', function() {
      ...
      //var instance = new Mailsquad.SubscriptionRequest();
      //expect(instance).to.be.a(Mailsquad.SubscriptionRequest);
    });
    ...
    it('should have the property singleoptin (base name: "singleoptin")', function() {
      // uncomment below and update the code to test the property singleoptin
      //var instance = new Mailsquad.SubscriptionRequest();
      //expect(instance).to.be();
    });
