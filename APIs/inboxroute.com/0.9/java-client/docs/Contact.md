...
|**confirmed** | **OffsetDateTime** | Date+time subscriber confirmed his/her list opt-in |  [optional] |
...
|**status** | **Integer** | Status (   1- Active,   2- Unconfirmed,   3- Unsubscribed,   4- Deleted,   5- Cleaned because of hard bounce or spam complaint)  |  [optional] |
