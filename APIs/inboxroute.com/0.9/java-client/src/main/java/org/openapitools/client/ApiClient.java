...
public class ApiClient {
    ...
    private String basePath = "https://api.inboxroute.com/api";
    ...
    public ApiClient() {
        ...
        authentications.put("mqApiKey", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.inboxroute.com/api
