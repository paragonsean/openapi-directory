...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::getProfileSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::getProfileSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString id = create(); // QString | This is your unique username or member ID
      ...
      QString service = create(); // QString | The service name given to you by TruAnon
      apiInstance.getProfile(idservice);
