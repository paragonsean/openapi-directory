...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://staging.truanon.com"),
...
void OAIDefaultApi::getProfile(const ::OpenAPI::OptionalParam<QString> &id, const ::OpenAPI::OptionalParam<QString> &service) {
    QString fullPath = QString(_serverConfigs["getProfile"][_serverIndices.value("getProfile")].URL()+"/api/get_profile");
...
void OAIDefaultApi::getProfileCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getProfileSignal();
        Q_EMIT getProfileSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getProfileSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getProfileSignalError(error_type, error_str);
        Q_EMIT getProfileSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::getToken(const ::OpenAPI::OptionalParam<QString> &id, const ::OpenAPI::OptionalParam<QString> &service) {
    QString fullPath = QString(_serverConfigs["getToken"][_serverIndices.value("getToken")].URL()+"/api/request_token");
