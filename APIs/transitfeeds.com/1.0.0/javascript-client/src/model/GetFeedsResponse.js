...
import GetFeedsResponseResults from './GetFeedsResponseResults';
...
class GetFeedsResponse {
    ...
    constructor() { 
        ...
        GetFeedsResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = GetFeedsResponseResults.constructFromObject(data['results']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
          GetFeedsResponseResults.validateJSON(data['results']);
        }
        // ensure the json data is a string
 ...
 * @member {String} msg
 */
GetFeedsResponse.prototype['msg'] = undefined;

/**
 * @member {module:model/GetFeedsResponseResults} results
 */
GetFeedsResponse.prototype['results'] = undefined;
 ...
 * @member {module:model/GetFeedsResponse.StatusEnum} status
 */
GetFeedsResponse.prototype['status'] = undefined;

/**
 * Indicates the timestamp (in number of seconds since the epoch (January 1 1970 00:00:00 GMT).
 * @member {Number} ts
 */
GetFeedsResponse.prototype['ts'] = undefined;
