...
/*
 * OAIGetFeedVersionsResponse_results.h
 *
 * Contains requested data for a valid request.
 */

#ifndef OAIGetFeedVersionsResponse_results_H
#define OAIGetFeedVersionsResponse_results_H
...
namespace OpenAPI {
class OAIFeedVersion;

class OAIGetFeedVersionsResponse_results : public OAIObject {
public:
    OAIGetFeedVersionsResponse_results();
    OAIGetFeedVersionsResponse_results(QString json);
    ~OAIGetFeedVersionsResponse_results() override;
    ...
    QList<OAIFeedVersion> getFeeds() const;
    void setFeeds(const QList<OAIFeedVersion> &feeds);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFeedVersionsResponse_results)

#endif // OAIGetFeedVersionsResponse_results_H
