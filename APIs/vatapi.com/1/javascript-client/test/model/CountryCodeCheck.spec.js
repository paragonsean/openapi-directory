...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VatApi.CountryCodeCheck();
  });
  ...
  describe('CountryCodeCheck', function() {
    it('should create an instance of CountryCodeCheck', function() {
      // uncomment below and update the code to test CountryCodeCheck
      //var instance = new VatApi.CountryCodeCheck();
      //expect(instance).to.be.a(VatApi.CountryCodeCheck);
    });
