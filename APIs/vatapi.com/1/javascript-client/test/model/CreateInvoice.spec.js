...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VatApi.CreateInvoice();
  });
  ...
  describe('CreateInvoice', function() {
    it('should create an instance of CreateInvoice', function() {
      // uncomment below and update the code to test CreateInvoice
      //var instance = new VatApi.CreateInvoice();
      //expect(instance).to.be.a(VatApi.CreateInvoice);
    });
