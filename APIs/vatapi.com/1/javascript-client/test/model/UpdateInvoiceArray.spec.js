...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VatApi.UpdateInvoiceArray();
  });
  ...
  describe('UpdateInvoiceArray', function() {
    it('should create an instance of UpdateInvoiceArray', function() {
      // uncomment below and update the code to test UpdateInvoiceArray
      //var instance = new VatApi.UpdateInvoiceArray();
      //expect(instance).to.be.a(VatApi.UpdateInvoiceArray);
    });
    ...
    it('should have the property customervatNumber (base name: "customervat_number")', function() {
