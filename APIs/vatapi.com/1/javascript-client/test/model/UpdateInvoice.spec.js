...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VatApi.UpdateInvoice();
  });
  ...
  describe('UpdateInvoice', function() {
    it('should create an instance of UpdateInvoice', function() {
      // uncomment below and update the code to test UpdateInvoice
      //var instance = new VatApi.UpdateInvoice();
      //expect(instance).to.be.a(VatApi.UpdateInvoice);
    });
