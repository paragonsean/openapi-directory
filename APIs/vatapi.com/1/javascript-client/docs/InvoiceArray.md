...
**discountRate** | **Number** | The discount rate per item | [optional] 
**discountTotal** | **Number** | Total amount of discount | 
**invoiceNumber** | **Number** | A sequential invoice number | 
