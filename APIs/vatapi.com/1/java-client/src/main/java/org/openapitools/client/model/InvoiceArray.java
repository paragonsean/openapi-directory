...
public class InvoiceArray {
  ...
  public InvoiceArray businessAddress(String businessAddress) {
  ...
  public InvoiceArray businessName(String businessName) {
  ...
  public InvoiceArray conversionRate(Integer conversionRate) {
  ...
  public InvoiceArray currencyCode(String currencyCode) {
  ...
  public InvoiceArray currencyCodeConversion(String currencyCodeConversion) {
  ...
  public InvoiceArray customerAddress(String customerAddress) {
  ...
  public InvoiceArray customerName(String customerName) {
  ...
  public InvoiceArray customerVatNumber(String customerVatNumber) {
  ...
  public InvoiceArray date(String date) {
    this.date = date;
    return this;
  }
  ...
  public InvoiceArray discountRate(Integer discountRate) {
  ...
  public InvoiceArray discountTotal(Integer discountTotal) {
  ...
  public InvoiceArray invoiceNumber(Integer invoiceNumber) {
  ...
  public InvoiceArray invoiceUrl(String invoiceUrl) {
  ...
  public InvoiceArray items(List<InvoiceItems> items) {
    this.items = items;
    return this;
  }

  public InvoiceArray addItemsItem(InvoiceItems itemsItem) {
    if (this.items == null) {
  ...
  public InvoiceArray logoUrl(String logoUrl) {
  ...
  public InvoiceArray notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public InvoiceArray subtotal(Integer subtotal) {
  ...
  public InvoiceArray taxPoint(String taxPoint) {
  ...
  public InvoiceArray total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  public InvoiceArray type(String type) {
    this.type = type;
    return this;
  }
  ...
  public InvoiceArray vatNumber(String vatNumber) {
  ...
  public InvoiceArray vatTotal(Integer vatTotal) {
  ...
  public boolean equals(Object o) {
    ...
    InvoiceArray invoiceArray = (InvoiceArray) o;
    return Objects.equals(this.businessAddress, invoiceArray.businessAddress) &&
        Objects.equals(this.businessName, invoiceArray.businessName) &&
        Objects.equals(this.conversionRate, invoiceArray.conversionRate) &&
        Objects.equals(this.currencyCode, invoiceArray.currencyCode) &&
        Objects.equals(this.currencyCodeConversion, invoiceArray.currencyCodeConversion) &&
        Objects.equals(this.customerAddress, invoiceArray.customerAddress) &&
        Objects.equals(this.customerName, invoiceArray.customerName) &&
        Objects.equals(this.customerVatNumber, invoiceArray.customerVatNumber) &&
        Objects.equals(this.date, invoiceArray.date) &&
        Objects.equals(this.discountRate, invoiceArray.discountRate) &&
        Objects.equals(this.discountTotal, invoiceArray.discountTotal) &&
        Objects.equals(this.invoiceNumber, invoiceArray.invoiceNumber) &&
        Objects.equals(this.invoiceUrl, invoiceArray.invoiceUrl) &&
        Objects.equals(this.items, invoiceArray.items) &&
        Objects.equals(this.logoUrl, invoiceArray.logoUrl) &&
        Objects.equals(this.notes, invoiceArray.notes) &&
        Objects.equals(this.subtotal, invoiceArray.subtotal) &&
        Objects.equals(this.taxPoint, invoiceArray.taxPoint) &&
        Objects.equals(this.total, invoiceArray.total) &&
        Objects.equals(this.type, invoiceArray.type) &&
        Objects.equals(this.vatNumber, invoiceArray.vatNumber) &&
        Objects.equals(this.vatTotal, invoiceArray.vatTotal);
  }

  @Override
  public int hashCode() {
    return Objects.hash(businessAddress, businessName, conversionRate, currencyCode, currencyCodeConversion, customerAddress, customerName, customerVatNumber, date, discountRate, discountTotal, invoiceNumber, invoiceUrl, items, logoUrl, notes, subtotal, taxPoint, total, type, vatNumber, vatTotal);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InvoiceArray {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InvoiceArray
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InvoiceArray.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceArray is not found in the empty JSON string", InvoiceArray.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InvoiceArray.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InvoiceArray` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InvoiceArray.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceArray.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceArray' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceArray> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceArray.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceArray>() {
           @Override
           public void write(JsonWriter out, InvoiceArray value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InvoiceArray read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InvoiceArray given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InvoiceArray
   * @throws IOException if the JSON string is invalid with respect to InvoiceArray
   */
  public static InvoiceArray fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceArray.class);
  }

  /**
   * Convert an instance of InvoiceArray to an JSON string
   *
   * @return JSON string
   */
