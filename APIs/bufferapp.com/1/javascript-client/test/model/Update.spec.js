...
(function(root, factory) {
  ...
  describe('Update', function() {
    it('should create an instance of Update', function() {
      ...
      //var instance = new Bufferapp.Update();
      //expect(instance).to.be.a(Bufferapp.Update);
    });
    ...
    it('should have the property serviceUpdateId (base name: "service_update_id")', function() {
      // uncomment below and update the code to test the property serviceUpdateId
      //var instance = new Bufferapp.Update();
      //expect(instance).to.be();
    });
