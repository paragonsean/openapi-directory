...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bufferapp.IndividualUpdateUpdate();
  });
  ...
  describe('IndividualUpdateUpdate', function() {
    it('should create an instance of IndividualUpdateUpdate', function() {
      // uncomment below and update the code to test IndividualUpdateUpdate
      //var instance = new Bufferapp.IndividualUpdateUpdate();
      //expect(instance).to.be.a(Bufferapp.IndividualUpdateUpdate);
    });
