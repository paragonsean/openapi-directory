...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bufferapp.NewUpdateUpdatesInner();
  });
  ...
  describe('NewUpdateUpdatesInner', function() {
    it('should create an instance of NewUpdateUpdatesInner', function() {
      // uncomment below and update the code to test NewUpdateUpdatesInner
      //var instance = new Bufferapp.NewUpdateUpdatesInner();
      //expect(instance).to.be.a(Bufferapp.NewUpdateUpdatesInner);
    });
