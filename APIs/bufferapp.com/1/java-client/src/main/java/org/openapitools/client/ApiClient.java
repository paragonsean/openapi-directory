...
public class ApiClient {
    ...
    private String basePath = "https://api.bufferapp.com/1";
    ...
    public ApiClient() {
        ...
        authentications.put("oauth_2_0", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.bufferapp.com/1/oauth2/token.json";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.bufferapp.com/1
