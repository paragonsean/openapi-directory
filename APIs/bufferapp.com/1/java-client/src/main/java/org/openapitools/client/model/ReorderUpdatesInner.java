...
public class ReorderUpdatesInner {
  ...
  public ReorderUpdatesInner() {
  }

  public ReorderUpdatesInner createdAt(BigDecimal createdAt) {
  ...
  public ReorderUpdatesInner day(String day) {
    this.day = day;
    return this;
  }
  ...
  public ReorderUpdatesInner dueAt(BigDecimal dueAt) {
    this.dueAt = dueAt;
    return this;
  }
  ...
  public ReorderUpdatesInner dueTime(String dueTime) {
  ...
  public ReorderUpdatesInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ReorderUpdatesInner profileId(String profileId) {
  ...
  public ReorderUpdatesInner profileService(String profileService) {
  ...
  public ReorderUpdatesInner status(String status) {
    this.status = status;
    return this;
  }
  ...
  public ReorderUpdatesInner text(String text) {
    this.text = text;
    return this;
  }
  ...
  public ReorderUpdatesInner textFormatted(String textFormatted) {
  ...
  public ReorderUpdatesInner userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public ReorderUpdatesInner via(String via) {
    this.via = via;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ReorderUpdatesInner reorderUpdatesInner = (ReorderUpdatesInner) o;
    return Objects.equals(this.createdAt, reorderUpdatesInner.createdAt) &&
        Objects.equals(this.day, reorderUpdatesInner.day) &&
        Objects.equals(this.dueAt, reorderUpdatesInner.dueAt) &&
        Objects.equals(this.dueTime, reorderUpdatesInner.dueTime) &&
        Objects.equals(this.id, reorderUpdatesInner.id) &&
        Objects.equals(this.profileId, reorderUpdatesInner.profileId) &&
        Objects.equals(this.profileService, reorderUpdatesInner.profileService) &&
        Objects.equals(this.status, reorderUpdatesInner.status) &&
        Objects.equals(this.text, reorderUpdatesInner.text) &&
        Objects.equals(this.textFormatted, reorderUpdatesInner.textFormatted) &&
        Objects.equals(this.userId, reorderUpdatesInner.userId) &&
        Objects.equals(this.via, reorderUpdatesInner.via);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, day, dueAt, dueTime, id, profileId, profileService, status, text, textFormatted, userId, via);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReorderUpdatesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReorderUpdatesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReorderUpdatesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReorderUpdatesInner is not found in the empty JSON string", ReorderUpdatesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReorderUpdatesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReorderUpdatesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReorderUpdatesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReorderUpdatesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReorderUpdatesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReorderUpdatesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ReorderUpdatesInner>() {
           @Override
           public void write(JsonWriter out, ReorderUpdatesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReorderUpdatesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReorderUpdatesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReorderUpdatesInner
   * @throws IOException if the JSON string is invalid with respect to ReorderUpdatesInner
   */
  public static ReorderUpdatesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReorderUpdatesInner.class);
  }

  /**
   * Convert an instance of ReorderUpdatesInner to an JSON string
   *
   * @return JSON string
   */
