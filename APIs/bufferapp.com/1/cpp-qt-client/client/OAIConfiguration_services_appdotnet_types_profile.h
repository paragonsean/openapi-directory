...
/*
 * OAIConfiguration_services_appdotnet_types_profile.h
 *
 * 
 */

#ifndef OAIConfiguration_services_appdotnet_types_profile_H
#define OAIConfiguration_services_appdotnet_types_profile_H
...
class OAIConfiguration_services_appdotnet_types_profile : public OAIObject {
public:
    OAIConfiguration_services_appdotnet_types_profile();
    OAIConfiguration_services_appdotnet_types_profile(QString json);
    ~OAIConfiguration_services_appdotnet_types_profile() override;
    ...
    QList<OAIObject> getSupportedInteractions() const;
    void setSupportedInteractions(const QList<OAIObject> &supported_interactions);
...
private:
    ...
    QList<OAIObject> m_supported_interactions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfiguration_services_appdotnet_types_profile)

#endif // OAIConfiguration_services_appdotnet_types_profile_H
