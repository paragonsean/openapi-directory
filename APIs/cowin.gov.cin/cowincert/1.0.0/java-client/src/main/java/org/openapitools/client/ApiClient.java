...
public class ApiClient {
    ...
    private String basePath = "https://cowin.gov.cin/cert/external";
    ...
    public ApiClient() {
        ...
        authentications.put("cert_auth", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://divoc.xiv.in/auth/realms/divoc/protocol/openid-connect/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cowin.gov.cin/cert/external
