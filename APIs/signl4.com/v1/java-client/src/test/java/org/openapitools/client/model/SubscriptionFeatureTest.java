...
/**
 * Model tests for SubscriptionFeature
 */
public class SubscriptionFeatureTest {
    private final SubscriptionFeature model = new SubscriptionFeature();
