...
#ifndef OAIUserInvite_H
#define OAIUserInvite_H
...
class OAIUserInvite : public OAIObject {
public:
    OAIUserInvite();
    OAIUserInvite(QString json);
    ~OAIUserInvite() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserInvite)

#endif // OAIUserInvite_H
