...
/*
 * OAIUpdatePasswordInfo.h
 *
 * 
 */

#ifndef OAIUpdatePasswordInfo_H
#define OAIUpdatePasswordInfo_H
...
class OAIUpdatePasswordInfo : public OAIObject {
public:
    OAIUpdatePasswordInfo();
    OAIUpdatePasswordInfo(QString json);
    ~OAIUpdatePasswordInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePasswordInfo)

#endif // OAIUpdatePasswordInfo_H
