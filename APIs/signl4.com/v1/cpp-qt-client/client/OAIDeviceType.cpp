...
QString OAIDeviceType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIDeviceType::_0:
            val = QString::number(0);
            break;
        case eOAIDeviceType::_1:
            val = QString::number(1);
            break;
        case eOAIDeviceType::_2:
