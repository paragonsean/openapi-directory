...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.AlertAnnotationInfo();
  });
  ...
  describe('AlertAnnotationInfo', function() {
    it('should create an instance of AlertAnnotationInfo', function() {
      // uncomment below and update the code to test AlertAnnotationInfo
      //var instance = new Signl4Api.AlertAnnotationInfo();
      //expect(instance).to.be.a(Signl4Api.AlertAnnotationInfo);
    });
