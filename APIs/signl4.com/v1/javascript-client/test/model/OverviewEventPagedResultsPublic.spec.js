...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.OverviewEventPagedResultsPublic();
  });
  ...
  describe('OverviewEventPagedResultsPublic', function() {
    it('should create an instance of OverviewEventPagedResultsPublic', function() {
      // uncomment below and update the code to test OverviewEventPagedResultsPublic
      //var instance = new Signl4Api.OverviewEventPagedResultsPublic();
      //expect(instance).to.be.a(Signl4Api.OverviewEventPagedResultsPublic);
    });
