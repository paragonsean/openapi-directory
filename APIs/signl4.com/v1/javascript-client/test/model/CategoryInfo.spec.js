...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.CategoryInfo();
  });
  ...
  describe('CategoryInfo', function() {
    it('should create an instance of CategoryInfo', function() {
      // uncomment below and update the code to test CategoryInfo
      //var instance = new Signl4Api.CategoryInfo();
      //expect(instance).to.be.a(Signl4Api.CategoryInfo);
    });

    it('should have the property augmentations (base name: "augmentations")', function() {
      // uncomment below and update the code to test the property augmentations
      //var instance = new Signl4Api.CategoryInfo();
    ...
    it('should have the property keywordMatching (base name: "keywordMatching")', function() {
      // uncomment below and update the code to test the property keywordMatching
      //var instance = new Signl4Api.CategoryInfo();
      //expect(instance).to.be();
    });
    ...
    it('should have the property lastMatch (base name: "lastMatch")', function() {
