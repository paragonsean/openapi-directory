...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.OverviewEvent();
  });
  ...
  describe('OverviewEvent', function() {
    it('should create an instance of OverviewEvent', function() {
      // uncomment below and update the code to test OverviewEvent
      //var instance = new Signl4Api.OverviewEvent();
      //expect(instance).to.be.a(Signl4Api.OverviewEvent);
    });

    it('should have the property acknowledgedAlerts (base name: "acknowledgedAlerts")', function() {
      // uncomment below and update the code to test the property acknowledgedAlerts
      //var instance = new Signl4Api.OverviewEvent();
    ...
    it('should have the property closedAlerts (base name: "closedAlerts")', function() {
      // uncomment below and update the code to test the property closedAlerts
      //var instance = new Signl4Api.OverviewEvent();
      //expect(instance).to.be();
    });
