...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.ScheduleInfo();
  });
  ...
  describe('ScheduleInfo', function() {
    it('should create an instance of ScheduleInfo', function() {
      // uncomment below and update the code to test ScheduleInfo
      //var instance = new Signl4Api.ScheduleInfo();
      //expect(instance).to.be.a(Signl4Api.ScheduleInfo);
    });
