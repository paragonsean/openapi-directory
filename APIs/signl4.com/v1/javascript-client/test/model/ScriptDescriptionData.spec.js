...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.ScriptDescriptionData();
  });
  ...
  describe('ScriptDescriptionData', function() {
    it('should create an instance of ScriptDescriptionData', function() {
      // uncomment below and update the code to test ScriptDescriptionData
      //var instance = new Signl4Api.ScriptDescriptionData();
      //expect(instance).to.be.a(Signl4Api.ScriptDescriptionData);
    });
