...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.AlertNotificationInfo();
  });
  ...
  describe('AlertNotificationInfo', function() {
    it('should create an instance of AlertNotificationInfo', function() {
      // uncomment below and update the code to test AlertNotificationInfo
      //var instance = new Signl4Api.AlertNotificationInfo();
      //expect(instance).to.be.a(Signl4Api.AlertNotificationInfo);
    });
