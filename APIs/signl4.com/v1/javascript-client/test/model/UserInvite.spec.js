...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.UserInvite();
  });
  ...
  describe('UserInvite', function() {
    it('should create an instance of UserInvite', function() {
      // uncomment below and update the code to test UserInvite
      //var instance = new Signl4Api.UserInvite();
      //expect(instance).to.be.a(Signl4Api.UserInvite);
    });
