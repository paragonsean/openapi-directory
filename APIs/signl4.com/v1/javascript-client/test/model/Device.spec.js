...
(function(root, factory) {
  ...
  describe('Device', function() {
    it('should create an instance of Device', function() {
      ...
      //var instance = new Signl4Api.Device();
      //expect(instance).to.be.a(Signl4Api.Device);
    });
    ...
    it('should have the property ringtoneDisabled (base name: "ringtoneDisabled")', function() {
      // uncomment below and update the code to test the property ringtoneDisabled
      //var instance = new Signl4Api.Device();
      //expect(instance).to.be();
    });
