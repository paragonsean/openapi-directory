...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.RaiseAlertInfo();
  });
  ...
  describe('RaiseAlertInfo', function() {
    it('should create an instance of RaiseAlertInfo', function() {
      // uncomment below and update the code to test RaiseAlertInfo
      //var instance = new Signl4Api.RaiseAlertInfo();
      //expect(instance).to.be.a(Signl4Api.RaiseAlertInfo);
    });
