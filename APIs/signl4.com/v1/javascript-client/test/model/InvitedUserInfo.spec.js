...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.InvitedUserInfo();
  });
  ...
  describe('InvitedUserInfo', function() {
    it('should create an instance of InvitedUserInfo', function() {
      // uncomment below and update the code to test InvitedUserInfo
      //var instance = new Signl4Api.InvitedUserInfo();
      //expect(instance).to.be.a(Signl4Api.InvitedUserInfo);
    });
