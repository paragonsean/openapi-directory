...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.UpdatePasswordInfo();
  });
  ...
  describe('UpdatePasswordInfo', function() {
    it('should create an instance of UpdatePasswordInfo', function() {
      // uncomment below and update the code to test UpdatePasswordInfo
      //var instance = new Signl4Api.UpdatePasswordInfo();
      //expect(instance).to.be.a(Signl4Api.UpdatePasswordInfo);
    });
