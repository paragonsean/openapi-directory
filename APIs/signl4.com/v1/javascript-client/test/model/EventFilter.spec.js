...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.EventFilter();
  });
  ...
  describe('EventFilter', function() {
    it('should create an instance of EventFilter', function() {
      ...
      //var instance = new Signl4Api.EventFilter();
      //expect(instance).to.be.a(Signl4Api.EventFilter);
    });
    ...
    it('should have the property eventStatusCode (base name: "eventStatusCode")', function() {
      // uncomment below and update the code to test the property eventStatusCode
      //var instance = new Signl4Api.EventFilter();
      //expect(instance).to.be();
    });
