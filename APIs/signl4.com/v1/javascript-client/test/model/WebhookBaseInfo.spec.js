...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.WebhookBaseInfo();
  });
  ...
  describe('WebhookBaseInfo', function() {
    it('should create an instance of WebhookBaseInfo', function() {
      // uncomment below and update the code to test WebhookBaseInfo
      //var instance = new Signl4Api.WebhookBaseInfo();
      //expect(instance).to.be.a(Signl4Api.WebhookBaseInfo);
    });
