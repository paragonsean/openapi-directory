...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.AlertAttachment();
  });
  ...
  describe('AlertAttachment', function() {
    it('should create an instance of AlertAttachment', function() {
      // uncomment below and update the code to test AlertAttachment
      //var instance = new Signl4Api.AlertAttachment();
      //expect(instance).to.be.a(Signl4Api.AlertAttachment);
    });
