...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.AlertAttachmentInfo();
  });
  ...
  describe('AlertAttachmentInfo', function() {
    it('should create an instance of AlertAttachmentInfo', function() {
      // uncomment below and update the code to test AlertAttachmentInfo
      //var instance = new Signl4Api.AlertAttachmentInfo();
      //expect(instance).to.be.a(Signl4Api.AlertAttachmentInfo);
    });
