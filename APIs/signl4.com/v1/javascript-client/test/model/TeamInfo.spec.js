...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.TeamInfo();
  });
  ...
  describe('TeamInfo', function() {
    it('should create an instance of TeamInfo', function() {
      // uncomment below and update the code to test TeamInfo
      //var instance = new Signl4Api.TeamInfo();
      //expect(instance).to.be.a(Signl4Api.TeamInfo);
    });
