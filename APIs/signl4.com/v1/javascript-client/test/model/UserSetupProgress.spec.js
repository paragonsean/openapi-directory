...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.UserSetupProgress();
  });
  ...
  describe('UserSetupProgress', function() {
    it('should create an instance of UserSetupProgress', function() {
      // uncomment below and update the code to test UserSetupProgress
      //var instance = new Signl4Api.UserSetupProgress();
      //expect(instance).to.be.a(Signl4Api.UserSetupProgress);
    });
