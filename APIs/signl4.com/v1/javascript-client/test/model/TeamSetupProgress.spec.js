...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.TeamSetupProgress();
  });
  ...
  describe('TeamSetupProgress', function() {
    it('should create an instance of TeamSetupProgress', function() {
      // uncomment below and update the code to test TeamSetupProgress
      //var instance = new Signl4Api.TeamSetupProgress();
      //expect(instance).to.be.a(Signl4Api.TeamSetupProgress);
    });
