...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Signl4Api.OverviewAlertPagedResultsPublic();
  });
  ...
  describe('OverviewAlertPagedResultsPublic', function() {
    it('should create an instance of OverviewAlertPagedResultsPublic', function() {
      // uncomment below and update the code to test OverviewAlertPagedResultsPublic
      //var instance = new Signl4Api.OverviewAlertPagedResultsPublic();
      //expect(instance).to.be.a(Signl4Api.OverviewAlertPagedResultsPublic);
    });
