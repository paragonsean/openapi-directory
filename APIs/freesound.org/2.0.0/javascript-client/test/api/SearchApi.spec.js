...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Freesound.SearchApi();
  });
  ...
  describe('SearchApi', function() {
    describe('searchText', function() {
      it('should call searchText successfully', function(done) {
        //uncomment below and update the code to test searchText
        //instance.searchText(function(error) {
