...
(function(root, factory) {
  ...
  describe('Sound', function() {
    it('should create an instance of Sound', function() {
      // uncomment below and update the code to test Sound
      //var instance = new Freesound.Sound();
      //expect(instance).to.be.a(Freesound.Sound);
    });
