...
|**category** | [**CategoryEnum**](#CategoryEnum) | The category of the Event. We may add additional possible values for this enum over time; your application should be able to handle such additions gracefully. |  |
|**createdAt** | **OffsetDateTime** | The time the Event was created. |  |
|**id** | **String** | The Event identifier. |  |
|**type** | [**TypeEnum**](#TypeEnum) | A constant representing the object&#39;s type. For this resource it will always be &#x60;event&#x60;. |  |
