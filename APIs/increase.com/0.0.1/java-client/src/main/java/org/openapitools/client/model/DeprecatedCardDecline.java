...
public class DeprecatedCardDecline {
  ...
  public DeprecatedCardDecline() {
  }

  public DeprecatedCardDecline amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public DeprecatedCardDecline currency(CurrencyEnum currency) {
  ...
  public DeprecatedCardDecline merchantAcceptorId(String merchantAcceptorId) {
  ...
  public DeprecatedCardDecline merchantCategoryCode(String merchantCategoryCode) {
  ...
  public DeprecatedCardDecline merchantCity(String merchantCity) {
  ...
  public DeprecatedCardDecline merchantCountry(String merchantCountry) {
  ...
  public DeprecatedCardDecline merchantDescriptor(String merchantDescriptor) {
  ...
  public DeprecatedCardDecline merchantState(String merchantState) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecatedCardDecline deprecatedCardDecline = (DeprecatedCardDecline) o;
    return Objects.equals(this.amount, deprecatedCardDecline.amount) &&
        Objects.equals(this.currency, deprecatedCardDecline.currency) &&
        Objects.equals(this.merchantAcceptorId, deprecatedCardDecline.merchantAcceptorId) &&
        Objects.equals(this.merchantCategoryCode, deprecatedCardDecline.merchantCategoryCode) &&
        Objects.equals(this.merchantCity, deprecatedCardDecline.merchantCity) &&
        Objects.equals(this.merchantCountry, deprecatedCardDecline.merchantCountry) &&
        Objects.equals(this.merchantDescriptor, deprecatedCardDecline.merchantDescriptor) &&
        Objects.equals(this.merchantState, deprecatedCardDecline.merchantState);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecatedCardDecline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeprecatedCardDecline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeprecatedCardDecline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecatedCardDecline is not found in the empty JSON string", DeprecatedCardDecline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeprecatedCardDecline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeprecatedCardDecline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecatedCardDecline.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecatedCardDecline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecatedCardDecline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecatedCardDecline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecatedCardDecline.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecatedCardDecline>() {
           @Override
           public void write(JsonWriter out, DeprecatedCardDecline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeprecatedCardDecline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeprecatedCardDecline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeprecatedCardDecline
   * @throws IOException if the JSON string is invalid with respect to DeprecatedCardDecline
   */
  public static DeprecatedCardDecline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecatedCardDecline.class);
  }

  /**
   * Convert an instance of DeprecatedCardDecline to an JSON string
   *
   * @return JSON string
   */
