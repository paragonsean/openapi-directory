...
public class DeprecatedCardSettlement {
  ...
  public DeprecatedCardSettlement() {
  }

  public DeprecatedCardSettlement amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public DeprecatedCardSettlement currency(CurrencyEnum currency) {
  ...
  public DeprecatedCardSettlement merchantAcceptorId(String merchantAcceptorId) {
  ...
  public DeprecatedCardSettlement merchantCategoryCode(String merchantCategoryCode) {
  ...
  public DeprecatedCardSettlement merchantCity(String merchantCity) {
  ...
  public DeprecatedCardSettlement merchantCountry(String merchantCountry) {
  ...
  public DeprecatedCardSettlement merchantDescriptor(String merchantDescriptor) {
  ...
  public DeprecatedCardSettlement merchantState(String merchantState) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecatedCardSettlement deprecatedCardSettlement = (DeprecatedCardSettlement) o;
    return Objects.equals(this.amount, deprecatedCardSettlement.amount) &&
        Objects.equals(this.currency, deprecatedCardSettlement.currency) &&
        Objects.equals(this.merchantAcceptorId, deprecatedCardSettlement.merchantAcceptorId) &&
        Objects.equals(this.merchantCategoryCode, deprecatedCardSettlement.merchantCategoryCode) &&
        Objects.equals(this.merchantCity, deprecatedCardSettlement.merchantCity) &&
        Objects.equals(this.merchantCountry, deprecatedCardSettlement.merchantCountry) &&
        Objects.equals(this.merchantDescriptor, deprecatedCardSettlement.merchantDescriptor) &&
        Objects.equals(this.merchantState, deprecatedCardSettlement.merchantState);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecatedCardSettlement {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeprecatedCardSettlement
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeprecatedCardSettlement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecatedCardSettlement is not found in the empty JSON string", DeprecatedCardSettlement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeprecatedCardSettlement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeprecatedCardSettlement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecatedCardSettlement.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecatedCardSettlement.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecatedCardSettlement' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecatedCardSettlement> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecatedCardSettlement.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecatedCardSettlement>() {
           @Override
           public void write(JsonWriter out, DeprecatedCardSettlement value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeprecatedCardSettlement read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeprecatedCardSettlement given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeprecatedCardSettlement
   * @throws IOException if the JSON string is invalid with respect to DeprecatedCardSettlement
   */
  public static DeprecatedCardSettlement fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecatedCardSettlement.class);
  }

  /**
   * Convert an instance of DeprecatedCardSettlement to an JSON string
   *
   * @return JSON string
   */
