...
public class InboundWireReversal {
  ...
  public InboundWireReversal amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public InboundWireReversal createdAt(OffsetDateTime createdAt) {
  ...
  public InboundWireReversal description(String description) {
  ...
  public InboundWireReversal financialInstitutionToFinancialInstitutionInformation(String financialInstitutionToFinancialInstitutionInformation) {
  ...
  public InboundWireReversal inputCycleDate(LocalDate inputCycleDate) {
  ...
  public InboundWireReversal inputMessageAccountabilityData(String inputMessageAccountabilityData) {
  ...
  public InboundWireReversal inputSequenceNumber(String inputSequenceNumber) {
  ...
  public InboundWireReversal inputSource(String inputSource) {
  ...
  public InboundWireReversal previousMessageInputCycleDate(LocalDate previousMessageInputCycleDate) {
  ...
  public InboundWireReversal previousMessageInputMessageAccountabilityData(String previousMessageInputMessageAccountabilityData) {
  ...
  public InboundWireReversal previousMessageInputSequenceNumber(String previousMessageInputSequenceNumber) {
  ...
  public InboundWireReversal previousMessageInputSource(String previousMessageInputSource) {
  ...
  public InboundWireReversal receiverFinancialInstitutionInformation(String receiverFinancialInstitutionInformation) {
  ...
  public InboundWireReversal transactionId(String transactionId) {
  ...
  public boolean equals(Object o) {
    ...
    InboundWireReversal inboundWireReversal = (InboundWireReversal) o;
    return Objects.equals(this.amount, inboundWireReversal.amount) &&
        Objects.equals(this.createdAt, inboundWireReversal.createdAt) &&
        Objects.equals(this.description, inboundWireReversal.description) &&
        Objects.equals(this.financialInstitutionToFinancialInstitutionInformation, inboundWireReversal.financialInstitutionToFinancialInstitutionInformation) &&
        Objects.equals(this.inputCycleDate, inboundWireReversal.inputCycleDate) &&
        Objects.equals(this.inputMessageAccountabilityData, inboundWireReversal.inputMessageAccountabilityData) &&
        Objects.equals(this.inputSequenceNumber, inboundWireReversal.inputSequenceNumber) &&
        Objects.equals(this.inputSource, inboundWireReversal.inputSource) &&
        Objects.equals(this.previousMessageInputCycleDate, inboundWireReversal.previousMessageInputCycleDate) &&
        Objects.equals(this.previousMessageInputMessageAccountabilityData, inboundWireReversal.previousMessageInputMessageAccountabilityData) &&
        Objects.equals(this.previousMessageInputSequenceNumber, inboundWireReversal.previousMessageInputSequenceNumber) &&
        Objects.equals(this.previousMessageInputSource, inboundWireReversal.previousMessageInputSource) &&
        Objects.equals(this.receiverFinancialInstitutionInformation, inboundWireReversal.receiverFinancialInstitutionInformation) &&
        Objects.equals(this.transactionId, inboundWireReversal.transactionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class InboundWireReversal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InboundWireReversal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InboundWireReversal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InboundWireReversal is not found in the empty JSON string", InboundWireReversal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InboundWireReversal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InboundWireReversal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InboundWireReversal.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InboundWireReversal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InboundWireReversal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InboundWireReversal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InboundWireReversal.class));

       return (TypeAdapter<T>) new TypeAdapter<InboundWireReversal>() {
           @Override
           public void write(JsonWriter out, InboundWireReversal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InboundWireReversal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InboundWireReversal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InboundWireReversal
   * @throws IOException if the JSON string is invalid with respect to InboundWireReversal
   */
  public static InboundWireReversal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InboundWireReversal.class);
  }

  /**
   * Convert an instance of InboundWireReversal to an JSON string
   *
   * @return JSON string
   */
