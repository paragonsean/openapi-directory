...
public class DeclinedTransaction {
  ...
  public DeclinedTransaction accountId(String accountId) {
  ...
  public DeclinedTransaction amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public DeclinedTransaction createdAt(OffsetDateTime createdAt) {
  ...
  public DeclinedTransaction currency(CurrencyEnum currency) {
  ...
  public DeclinedTransaction description(String description) {
  ...
  public DeclinedTransaction id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DeclinedTransaction routeId(String routeId) {
  ...
  public DeclinedTransaction routeType(RouteTypeEnum routeType) {
  ...
  public DeclinedTransaction source(DeclinedTransactionSource source) {
    this.source = source;
    return this;
  }
  ...
  public DeclinedTransaction type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeclinedTransaction declinedTransaction = (DeclinedTransaction) o;
    return Objects.equals(this.accountId, declinedTransaction.accountId) &&
        Objects.equals(this.amount, declinedTransaction.amount) &&
        Objects.equals(this.createdAt, declinedTransaction.createdAt) &&
        Objects.equals(this.currency, declinedTransaction.currency) &&
        Objects.equals(this.description, declinedTransaction.description) &&
        Objects.equals(this.id, declinedTransaction.id) &&
        Objects.equals(this.routeId, declinedTransaction.routeId) &&
        Objects.equals(this.routeType, declinedTransaction.routeType) &&
        Objects.equals(this.source, declinedTransaction.source) &&
        Objects.equals(this.type, declinedTransaction.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeclinedTransaction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeclinedTransaction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeclinedTransaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeclinedTransaction is not found in the empty JSON string", DeclinedTransaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeclinedTransaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeclinedTransaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeclinedTransaction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeclinedTransaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeclinedTransaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeclinedTransaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeclinedTransaction.class));

       return (TypeAdapter<T>) new TypeAdapter<DeclinedTransaction>() {
           @Override
           public void write(JsonWriter out, DeclinedTransaction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeclinedTransaction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeclinedTransaction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeclinedTransaction
   * @throws IOException if the JSON string is invalid with respect to DeclinedTransaction
   */
  public static DeclinedTransaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeclinedTransaction.class);
  }

  /**
   * Convert an instance of DeclinedTransaction to an JSON string
   *
   * @return JSON string
   */
