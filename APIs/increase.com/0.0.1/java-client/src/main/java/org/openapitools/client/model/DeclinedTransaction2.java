...
public class DeclinedTransaction2 {
  ...
  public DeclinedTransaction2() {
  }

  public DeclinedTransaction2 accountId(String accountId) {
  ...
  public DeclinedTransaction2 amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public DeclinedTransaction2 createdAt(OffsetDateTime createdAt) {
  ...
  public DeclinedTransaction2 currency(CurrencyEnum currency) {
  ...
  public DeclinedTransaction2 description(String description) {
  ...
  public DeclinedTransaction2 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DeclinedTransaction2 routeId(String routeId) {
  ...
  public DeclinedTransaction2 routeType(RouteTypeEnum routeType) {
  ...
  public DeclinedTransaction2 source(DeclinedTransactionSource source) {
    this.source = source;
    return this;
  }
  ...
  public DeclinedTransaction2 type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeclinedTransaction2 declinedTransaction2 = (DeclinedTransaction2) o;
    return Objects.equals(this.accountId, declinedTransaction2.accountId) &&
        Objects.equals(this.amount, declinedTransaction2.amount) &&
        Objects.equals(this.createdAt, declinedTransaction2.createdAt) &&
        Objects.equals(this.currency, declinedTransaction2.currency) &&
        Objects.equals(this.description, declinedTransaction2.description) &&
        Objects.equals(this.id, declinedTransaction2.id) &&
        Objects.equals(this.routeId, declinedTransaction2.routeId) &&
        Objects.equals(this.routeType, declinedTransaction2.routeType) &&
        Objects.equals(this.source, declinedTransaction2.source) &&
        Objects.equals(this.type, declinedTransaction2.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeclinedTransaction2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeclinedTransaction2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeclinedTransaction2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeclinedTransaction2 is not found in the empty JSON string", DeclinedTransaction2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeclinedTransaction2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeclinedTransaction2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeclinedTransaction2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeclinedTransaction2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeclinedTransaction2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeclinedTransaction2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeclinedTransaction2.class));

       return (TypeAdapter<T>) new TypeAdapter<DeclinedTransaction2>() {
           @Override
           public void write(JsonWriter out, DeclinedTransaction2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeclinedTransaction2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeclinedTransaction2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeclinedTransaction2
   * @throws IOException if the JSON string is invalid with respect to DeclinedTransaction2
   */
  public static DeclinedTransaction2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeclinedTransaction2.class);
  }

  /**
   * Convert an instance of DeclinedTransaction2 to an JSON string
   *
   * @return JSON string
   */
