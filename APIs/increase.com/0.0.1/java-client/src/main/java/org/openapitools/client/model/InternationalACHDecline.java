...
public class InternationalACHDecline {
  ...
  public InternationalACHDecline() {
  }

  public InternationalACHDecline amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public InternationalACHDecline destinationCountryCode(String destinationCountryCode) {
  ...
  public InternationalACHDecline destinationCurrencyCode(String destinationCurrencyCode) {
  ...
  public InternationalACHDecline foreignExchangeIndicator(String foreignExchangeIndicator) {
  ...
  public InternationalACHDecline foreignExchangeReference(String foreignExchangeReference) {
  ...
  public InternationalACHDecline foreignExchangeReferenceIndicator(String foreignExchangeReferenceIndicator) {
  ...
  public InternationalACHDecline foreignPaymentAmount(Integer foreignPaymentAmount) {
  ...
  public InternationalACHDecline foreignTraceNumber(String foreignTraceNumber) {
  ...
  public InternationalACHDecline internationalTransactionTypeCode(String internationalTransactionTypeCode) {
  ...
  public InternationalACHDecline originatingCurrencyCode(String originatingCurrencyCode) {
  ...
  public InternationalACHDecline originatingDepositoryFinancialInstitutionBranchCountry(String originatingDepositoryFinancialInstitutionBranchCountry) {
  ...
  public InternationalACHDecline originatingDepositoryFinancialInstitutionId(String originatingDepositoryFinancialInstitutionId) {
  ...
  public InternationalACHDecline originatingDepositoryFinancialInstitutionIdQualifier(String originatingDepositoryFinancialInstitutionIdQualifier) {
  ...
  public InternationalACHDecline originatingDepositoryFinancialInstitutionName(String originatingDepositoryFinancialInstitutionName) {
  ...
  public InternationalACHDecline originatorCity(String originatorCity) {
  ...
  public InternationalACHDecline originatorCompanyEntryDescription(String originatorCompanyEntryDescription) {
  ...
  public InternationalACHDecline originatorCountry(String originatorCountry) {
  ...
  public InternationalACHDecline originatorIdentification(String originatorIdentification) {
  ...
  public InternationalACHDecline originatorName(String originatorName) {
  ...
  public InternationalACHDecline originatorPostalCode(String originatorPostalCode) {
  ...
  public InternationalACHDecline originatorStateOrProvince(String originatorStateOrProvince) {
  ...
  public InternationalACHDecline originatorStreetAddress(String originatorStreetAddress) {
  ...
  public InternationalACHDecline paymentRelatedInformation(String paymentRelatedInformation) {
  ...
  public InternationalACHDecline paymentRelatedInformation2(String paymentRelatedInformation2) {
  ...
  public InternationalACHDecline receiverCity(String receiverCity) {
  ...
  public InternationalACHDecline receiverCountry(String receiverCountry) {
  ...
  public InternationalACHDecline receiverIdentificationNumber(String receiverIdentificationNumber) {
  ...
  public InternationalACHDecline receiverPostalCode(String receiverPostalCode) {
  ...
  public InternationalACHDecline receiverStateOrProvince(String receiverStateOrProvince) {
  ...
  public InternationalACHDecline receiverStreetAddress(String receiverStreetAddress) {
  ...
  public InternationalACHDecline receivingCompanyOrIndividualName(String receivingCompanyOrIndividualName) {
  ...
  public InternationalACHDecline receivingDepositoryFinancialInstitutionCountry(String receivingDepositoryFinancialInstitutionCountry) {
  ...
  public InternationalACHDecline receivingDepositoryFinancialInstitutionId(String receivingDepositoryFinancialInstitutionId) {
  ...
  public InternationalACHDecline receivingDepositoryFinancialInstitutionIdQualifier(String receivingDepositoryFinancialInstitutionIdQualifier) {
  ...
  public InternationalACHDecline receivingDepositoryFinancialInstitutionName(String receivingDepositoryFinancialInstitutionName) {
  ...
  public InternationalACHDecline traceNumber(String traceNumber) {
  ...
  public boolean equals(Object o) {
    ...
    InternationalACHDecline internationalACHDecline = (InternationalACHDecline) o;
    return Objects.equals(this.amount, internationalACHDecline.amount) &&
        Objects.equals(this.destinationCountryCode, internationalACHDecline.destinationCountryCode) &&
        Objects.equals(this.destinationCurrencyCode, internationalACHDecline.destinationCurrencyCode) &&
        Objects.equals(this.foreignExchangeIndicator, internationalACHDecline.foreignExchangeIndicator) &&
        Objects.equals(this.foreignExchangeReference, internationalACHDecline.foreignExchangeReference) &&
        Objects.equals(this.foreignExchangeReferenceIndicator, internationalACHDecline.foreignExchangeReferenceIndicator) &&
        Objects.equals(this.foreignPaymentAmount, internationalACHDecline.foreignPaymentAmount) &&
        Objects.equals(this.foreignTraceNumber, internationalACHDecline.foreignTraceNumber) &&
        Objects.equals(this.internationalTransactionTypeCode, internationalACHDecline.internationalTransactionTypeCode) &&
        Objects.equals(this.originatingCurrencyCode, internationalACHDecline.originatingCurrencyCode) &&
        Objects.equals(this.originatingDepositoryFinancialInstitutionBranchCountry, internationalACHDecline.originatingDepositoryFinancialInstitutionBranchCountry) &&
        Objects.equals(this.originatingDepositoryFinancialInstitutionId, internationalACHDecline.originatingDepositoryFinancialInstitutionId) &&
        Objects.equals(this.originatingDepositoryFinancialInstitutionIdQualifier, internationalACHDecline.originatingDepositoryFinancialInstitutionIdQualifier) &&
        Objects.equals(this.originatingDepositoryFinancialInstitutionName, internationalACHDecline.originatingDepositoryFinancialInstitutionName) &&
        Objects.equals(this.originatorCity, internationalACHDecline.originatorCity) &&
        Objects.equals(this.originatorCompanyEntryDescription, internationalACHDecline.originatorCompanyEntryDescription) &&
        Objects.equals(this.originatorCountry, internationalACHDecline.originatorCountry) &&
        Objects.equals(this.originatorIdentification, internationalACHDecline.originatorIdentification) &&
        Objects.equals(this.originatorName, internationalACHDecline.originatorName) &&
        Objects.equals(this.originatorPostalCode, internationalACHDecline.originatorPostalCode) &&
        Objects.equals(this.originatorStateOrProvince, internationalACHDecline.originatorStateOrProvince) &&
        Objects.equals(this.originatorStreetAddress, internationalACHDecline.originatorStreetAddress) &&
        Objects.equals(this.paymentRelatedInformation, internationalACHDecline.paymentRelatedInformation) &&
        Objects.equals(this.paymentRelatedInformation2, internationalACHDecline.paymentRelatedInformation2) &&
        Objects.equals(this.receiverCity, internationalACHDecline.receiverCity) &&
        Objects.equals(this.receiverCountry, internationalACHDecline.receiverCountry) &&
        Objects.equals(this.receiverIdentificationNumber, internationalACHDecline.receiverIdentificationNumber) &&
        Objects.equals(this.receiverPostalCode, internationalACHDecline.receiverPostalCode) &&
        Objects.equals(this.receiverStateOrProvince, internationalACHDecline.receiverStateOrProvince) &&
        Objects.equals(this.receiverStreetAddress, internationalACHDecline.receiverStreetAddress) &&
        Objects.equals(this.receivingCompanyOrIndividualName, internationalACHDecline.receivingCompanyOrIndividualName) &&
        Objects.equals(this.receivingDepositoryFinancialInstitutionCountry, internationalACHDecline.receivingDepositoryFinancialInstitutionCountry) &&
        Objects.equals(this.receivingDepositoryFinancialInstitutionId, internationalACHDecline.receivingDepositoryFinancialInstitutionId) &&
        Objects.equals(this.receivingDepositoryFinancialInstitutionIdQualifier, internationalACHDecline.receivingDepositoryFinancialInstitutionIdQualifier) &&
        Objects.equals(this.receivingDepositoryFinancialInstitutionName, internationalACHDecline.receivingDepositoryFinancialInstitutionName) &&
        Objects.equals(this.traceNumber, internationalACHDecline.traceNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class InternationalACHDecline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InternationalACHDecline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InternationalACHDecline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InternationalACHDecline is not found in the empty JSON string", InternationalACHDecline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InternationalACHDecline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InternationalACHDecline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InternationalACHDecline.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InternationalACHDecline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InternationalACHDecline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InternationalACHDecline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InternationalACHDecline.class));

       return (TypeAdapter<T>) new TypeAdapter<InternationalACHDecline>() {
           @Override
           public void write(JsonWriter out, InternationalACHDecline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InternationalACHDecline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InternationalACHDecline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InternationalACHDecline
   * @throws IOException if the JSON string is invalid with respect to InternationalACHDecline
   */
  public static InternationalACHDecline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InternationalACHDecline.class);
  }

  /**
   * Convert an instance of InternationalACHDecline to an JSON string
   *
   * @return JSON string
   */
