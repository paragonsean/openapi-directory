...
public class ACHTransferReturn {
  ...
  public ACHTransferReturn createdAt(OffsetDateTime createdAt) {
  ...
  public ACHTransferReturn returnReasonCode(ReturnReasonCodeEnum returnReasonCode) {
  ...
  public ACHTransferReturn transactionId(String transactionId) {
  ...
  public ACHTransferReturn transferId(String transferId) {
  ...
  public boolean equals(Object o) {
    ...
    ACHTransferReturn acHTransferReturn = (ACHTransferReturn) o;
    return Objects.equals(this.createdAt, acHTransferReturn.createdAt) &&
        Objects.equals(this.returnReasonCode, acHTransferReturn.returnReasonCode) &&
        Objects.equals(this.transactionId, acHTransferReturn.transactionId) &&
        Objects.equals(this.transferId, acHTransferReturn.transferId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ACHTransferReturn {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ACHTransferReturn
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ACHTransferReturn.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ACHTransferReturn is not found in the empty JSON string", ACHTransferReturn.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ACHTransferReturn.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ACHTransferReturn` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ACHTransferReturn.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ACHTransferReturn.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ACHTransferReturn' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ACHTransferReturn> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ACHTransferReturn.class));

       return (TypeAdapter<T>) new TypeAdapter<ACHTransferReturn>() {
           @Override
           public void write(JsonWriter out, ACHTransferReturn value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ACHTransferReturn read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ACHTransferReturn given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ACHTransferReturn
   * @throws IOException if the JSON string is invalid with respect to ACHTransferReturn
   */
  public static ACHTransferReturn fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ACHTransferReturn.class);
  }

  /**
   * Convert an instance of ACHTransferReturn to an JSON string
   *
   * @return JSON string
   */
