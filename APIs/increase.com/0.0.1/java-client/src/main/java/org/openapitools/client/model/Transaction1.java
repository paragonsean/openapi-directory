...
public class Transaction1 {
  ...
  public Transaction1 accountId(String accountId) {
  ...
  public Transaction1 amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public Transaction1 createdAt(OffsetDateTime createdAt) {
  ...
  public Transaction1 currency(CurrencyEnum currency) {
  ...
  public Transaction1 description(String description) {
  ...
  public Transaction1 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Transaction1 routeId(String routeId) {
  ...
  public Transaction1 routeType(RouteTypeEnum routeType) {
  ...
  public Transaction1 source(TransactionSource source) {
    this.source = source;
    return this;
  }
  ...
  public Transaction1 type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, transaction1.accountId) &&
        Objects.equals(this.amount, transaction1.amount) &&
        Objects.equals(this.createdAt, transaction1.createdAt) &&
        Objects.equals(this.currency, transaction1.currency) &&
        Objects.equals(this.description, transaction1.description) &&
        Objects.equals(this.id, transaction1.id) &&
        Objects.equals(this.routeId, transaction1.routeId) &&
        Objects.equals(this.routeType, transaction1.routeType) &&
        Objects.equals(this.source, transaction1.source) &&
        Objects.equals(this.type, transaction1.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Transaction1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Transaction1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Transaction1 is not found in the empty JSON string", Transaction1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Transaction1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Transaction1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Transaction1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Transaction1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Transaction1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Transaction1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Transaction1.class));

       return (TypeAdapter<T>) new TypeAdapter<Transaction1>() {
           @Override
           public void write(JsonWriter out, Transaction1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Transaction1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Transaction1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Transaction1
   * @throws IOException if the JSON string is invalid with respect to Transaction1
   */
  public static Transaction1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Transaction1.class);
  }

  /**
   * Convert an instance of Transaction1 to an JSON string
   *
   * @return JSON string
   */
