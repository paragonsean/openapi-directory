...
public class CheckDepositReturn {
  ...
  public CheckDepositReturn amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public CheckDepositReturn checkDepositId(String checkDepositId) {
  ...
  public CheckDepositReturn currency(CurrencyEnum currency) {
  ...
  public CheckDepositReturn returnReason(ReturnReasonEnum returnReason) {
  ...
  public CheckDepositReturn returnedAt(OffsetDateTime returnedAt) {
  ...
  public CheckDepositReturn transactionId(String transactionId) {
  ...
  public boolean equals(Object o) {
    ...
    CheckDepositReturn checkDepositReturn = (CheckDepositReturn) o;
    return Objects.equals(this.amount, checkDepositReturn.amount) &&
        Objects.equals(this.checkDepositId, checkDepositReturn.checkDepositId) &&
        Objects.equals(this.currency, checkDepositReturn.currency) &&
        Objects.equals(this.returnReason, checkDepositReturn.returnReason) &&
        Objects.equals(this.returnedAt, checkDepositReturn.returnedAt) &&
        Objects.equals(this.transactionId, checkDepositReturn.transactionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CheckDepositReturn {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CheckDepositReturn
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckDepositReturn.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckDepositReturn is not found in the empty JSON string", CheckDepositReturn.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CheckDepositReturn.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckDepositReturn` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CheckDepositReturn.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckDepositReturn.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckDepositReturn' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckDepositReturn> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckDepositReturn.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckDepositReturn>() {
           @Override
           public void write(JsonWriter out, CheckDepositReturn value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CheckDepositReturn read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CheckDepositReturn given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CheckDepositReturn
   * @throws IOException if the JSON string is invalid with respect to CheckDepositReturn
   */
  public static CheckDepositReturn fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckDepositReturn.class);
  }

  /**
   * Convert an instance of CheckDepositReturn to an JSON string
   *
   * @return JSON string
   */
