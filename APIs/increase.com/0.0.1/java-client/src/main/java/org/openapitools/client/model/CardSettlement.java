...
public class CardSettlement {
  ...
  public CardSettlement amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public CardSettlement cardAuthorization(String cardAuthorization) {
  ...
  public CardSettlement currency(CurrencyEnum currency) {
  ...
  public CardSettlement id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CardSettlement merchantAcceptorId(String merchantAcceptorId) {
  ...
  public CardSettlement merchantCategoryCode(String merchantCategoryCode) {
  ...
  public CardSettlement merchantCity(String merchantCity) {
  ...
  public CardSettlement merchantCountry(String merchantCountry) {
  ...
  public CardSettlement merchantName(String merchantName) {
  ...
  public CardSettlement merchantState(String merchantState) {
  ...
  public CardSettlement pendingTransactionId(String pendingTransactionId) {
  ...
  public CardSettlement presentmentAmount(Integer presentmentAmount) {
  ...
  public CardSettlement presentmentCurrency(String presentmentCurrency) {
  ...
  public CardSettlement type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CardSettlement cardSettlement = (CardSettlement) o;
    return Objects.equals(this.amount, cardSettlement.amount) &&
        Objects.equals(this.cardAuthorization, cardSettlement.cardAuthorization) &&
        Objects.equals(this.currency, cardSettlement.currency) &&
        Objects.equals(this.id, cardSettlement.id) &&
        Objects.equals(this.merchantAcceptorId, cardSettlement.merchantAcceptorId) &&
        Objects.equals(this.merchantCategoryCode, cardSettlement.merchantCategoryCode) &&
        Objects.equals(this.merchantCity, cardSettlement.merchantCity) &&
        Objects.equals(this.merchantCountry, cardSettlement.merchantCountry) &&
        Objects.equals(this.merchantName, cardSettlement.merchantName) &&
        Objects.equals(this.merchantState, cardSettlement.merchantState) &&
        Objects.equals(this.pendingTransactionId, cardSettlement.pendingTransactionId) &&
        Objects.equals(this.presentmentAmount, cardSettlement.presentmentAmount) &&
        Objects.equals(this.presentmentCurrency, cardSettlement.presentmentCurrency) &&
        Objects.equals(this.type, cardSettlement.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, cardAuthorization, currency, id, merchantAcceptorId, merchantCategoryCode, merchantCity, merchantCountry, merchantName, merchantState, pendingTransactionId, presentmentAmount, presentmentCurrency, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CardSettlement {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CardSettlement
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CardSettlement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardSettlement is not found in the empty JSON string", CardSettlement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CardSettlement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CardSettlement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CardSettlement.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("card_authorization") != null && !jsonObj.get("card_authorization").isJsonNull()) && !jsonObj.get("card_authorization").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `card_authorization` to be a primitive type in the JSON string but got `%s`", jsonObj.get("card_authorization").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CardSettlement.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CardSettlement' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CardSettlement> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CardSettlement.class));

       return (TypeAdapter<T>) new TypeAdapter<CardSettlement>() {
           @Override
           public void write(JsonWriter out, CardSettlement value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CardSettlement read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CardSettlement given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CardSettlement
   * @throws IOException if the JSON string is invalid with respect to CardSettlement
   */
  public static CardSettlement fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CardSettlement.class);
  }

  /**
   * Convert an instance of CardSettlement to an JSON string
   *
   * @return JSON string
   */
