...
import org.openapitools.client.model.TransactionSource;
...
public class Transaction2 {
  ...
  public Transaction2 accountId(String accountId) {
  ...
  public Transaction2 amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public Transaction2 createdAt(OffsetDateTime createdAt) {
  ...
  public Transaction2 currency(CurrencyEnum currency) {
  ...
  public Transaction2 description(String description) {
  ...
  public Transaction2 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Transaction2 routeId(String routeId) {
  ...
  public Transaction2 routeType(RouteTypeEnum routeType) {
  ...
  public Transaction2 source(TransactionSource source) {
    this.source = source;
    return this;
  }
  ...
  public Transaction2 type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Transaction2 transaction2 = (Transaction2) o;
    return Objects.equals(this.accountId, transaction2.accountId) &&
        Objects.equals(this.amount, transaction2.amount) &&
        Objects.equals(this.createdAt, transaction2.createdAt) &&
        Objects.equals(this.currency, transaction2.currency) &&
        Objects.equals(this.description, transaction2.description) &&
        Objects.equals(this.id, transaction2.id) &&
        Objects.equals(this.routeId, transaction2.routeId) &&
        Objects.equals(this.routeType, transaction2.routeType) &&
        Objects.equals(this.source, transaction2.source) &&
        Objects.equals(this.type, transaction2.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Transaction2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Transaction2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Transaction2 is not found in the empty JSON string", Transaction2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Transaction2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Transaction2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Transaction2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Transaction2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Transaction2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Transaction2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Transaction2.class));

       return (TypeAdapter<T>) new TypeAdapter<Transaction2>() {
           @Override
           public void write(JsonWriter out, Transaction2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Transaction2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Transaction2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Transaction2
   * @throws IOException if the JSON string is invalid with respect to Transaction2
   */
  public static Transaction2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Transaction2.class);
  }

  /**
   * Convert an instance of Transaction2 to an JSON string
   *
   * @return JSON string
   */
