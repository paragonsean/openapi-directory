...
public class RealTimePaymentsTransferRejection {
  public static final String SERIALIZED_NAME_REJECT_REASON_ADDITIONAL_INFORMATION = "reject_reason_additional_information";
  @SerializedName(SERIALIZED_NAME_REJECT_REASON_ADDITIONAL_INFORMATION)
  private String rejectReasonAdditionalInformation;
  ...
  public RealTimePaymentsTransferRejection() {
  }

  public RealTimePaymentsTransferRejection rejectReasonAdditionalInformation(String rejectReasonAdditionalInformation) {
    this.rejectReasonAdditionalInformation = rejectReasonAdditionalInformation;
    return this;
  }

  /**
   * Additional information about the rejection provided by the recipient bank when the &#x60;reject_reason_code&#x60; is &#x60;NARRATIVE&#x60;.
   * @return rejectReasonAdditionalInformation
   */
  @javax.annotation.Nullable
  public String getRejectReasonAdditionalInformation() {
    return rejectReasonAdditionalInformation;
  }

  public void setRejectReasonAdditionalInformation(String rejectReasonAdditionalInformation) {
    this.rejectReasonAdditionalInformation = rejectReasonAdditionalInformation;
  }


  public RealTimePaymentsTransferRejection rejectReasonCode(RejectReasonCodeEnum rejectReasonCode) {
  ...
  public RealTimePaymentsTransferRejection rejectedAt(OffsetDateTime rejectedAt) {
  ...
  public boolean equals(Object o) {
    ...
    RealTimePaymentsTransferRejection realTimePaymentsTransferRejection = (RealTimePaymentsTransferRejection) o;
    return Objects.equals(this.rejectReasonAdditionalInformation, realTimePaymentsTransferRejection.rejectReasonAdditionalInformation) &&
        Objects.equals(this.rejectReasonCode, realTimePaymentsTransferRejection.rejectReasonCode) &&
        Objects.equals(this.rejectedAt, realTimePaymentsTransferRejection.rejectedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rejectReasonAdditionalInformation, rejectReasonCode, rejectedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RealTimePaymentsTransferRejection {\n");
    sb.append("    rejectReasonAdditionalInformation: ").append(toIndentedString(rejectReasonAdditionalInformation)).append("\n");
  ...
  static {
    ...
    openapiFields.add("reject_reason_additional_information");
    openapiFields.add("reject_reason_code");
    openapiFields.add("rejected_at");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("reject_reason_additional_information");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RealTimePaymentsTransferRejection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RealTimePaymentsTransferRejection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RealTimePaymentsTransferRejection is not found in the empty JSON string", RealTimePaymentsTransferRejection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RealTimePaymentsTransferRejection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RealTimePaymentsTransferRejection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RealTimePaymentsTransferRejection.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("reject_reason_additional_information") != null && !jsonObj.get("reject_reason_additional_information").isJsonNull()) && !jsonObj.get("reject_reason_additional_information").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `reject_reason_additional_information` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reject_reason_additional_information").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RealTimePaymentsTransferRejection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RealTimePaymentsTransferRejection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RealTimePaymentsTransferRejection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RealTimePaymentsTransferRejection.class));

       return (TypeAdapter<T>) new TypeAdapter<RealTimePaymentsTransferRejection>() {
           @Override
           public void write(JsonWriter out, RealTimePaymentsTransferRejection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RealTimePaymentsTransferRejection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RealTimePaymentsTransferRejection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RealTimePaymentsTransferRejection
   * @throws IOException if the JSON string is invalid with respect to RealTimePaymentsTransferRejection
   */
  public static RealTimePaymentsTransferRejection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RealTimePaymentsTransferRejection.class);
  }

  /**
   * Convert an instance of RealTimePaymentsTransferRejection to an JSON string
   *
   * @return JSON string
   */
