...
public class Transaction3 {
  ...
  public Transaction3 accountId(String accountId) {
  ...
  public Transaction3 amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public Transaction3 createdAt(OffsetDateTime createdAt) {
  ...
  public Transaction3 currency(CurrencyEnum currency) {
  ...
  public Transaction3 description(String description) {
  ...
  public Transaction3 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Transaction3 routeId(String routeId) {
  ...
  public Transaction3 routeType(RouteTypeEnum routeType) {
  ...
  public Transaction3 source(TransactionSource source) {
    this.source = source;
    return this;
  }
  ...
  public Transaction3 type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Transaction3 transaction3 = (Transaction3) o;
    return Objects.equals(this.accountId, transaction3.accountId) &&
        Objects.equals(this.amount, transaction3.amount) &&
        Objects.equals(this.createdAt, transaction3.createdAt) &&
        Objects.equals(this.currency, transaction3.currency) &&
        Objects.equals(this.description, transaction3.description) &&
        Objects.equals(this.id, transaction3.id) &&
        Objects.equals(this.routeId, transaction3.routeId) &&
        Objects.equals(this.routeType, transaction3.routeType) &&
        Objects.equals(this.source, transaction3.source) &&
        Objects.equals(this.type, transaction3.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Transaction3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Transaction3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Transaction3 is not found in the empty JSON string", Transaction3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Transaction3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Transaction3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Transaction3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Transaction3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Transaction3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Transaction3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Transaction3.class));

       return (TypeAdapter<T>) new TypeAdapter<Transaction3>() {
           @Override
           public void write(JsonWriter out, Transaction3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Transaction3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Transaction3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Transaction3
   * @throws IOException if the JSON string is invalid with respect to Transaction3
   */
  public static Transaction3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Transaction3.class);
  }

  /**
   * Convert an instance of Transaction3 to an JSON string
   *
   * @return JSON string
   */
