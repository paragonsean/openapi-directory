...
public class CreateACardProfileParametersDigitalWallets {
  ...
  private CreateACardProfileParametersDigitalWalletsTextColor textColor;

  public CreateACardProfileParametersDigitalWallets() {
  }

  public CreateACardProfileParametersDigitalWallets appIconFileId(String appIconFileId) {
  ...
  public CreateACardProfileParametersDigitalWallets backgroundImageFileId(String backgroundImageFileId) {
  ...
  public CreateACardProfileParametersDigitalWallets cardDescription(String cardDescription) {
  ...
  public CreateACardProfileParametersDigitalWallets contactEmail(String contactEmail) {
  ...
  public CreateACardProfileParametersDigitalWallets contactPhone(String contactPhone) {
  ...
  public CreateACardProfileParametersDigitalWallets contactWebsite(String contactWebsite) {
  ...
  public CreateACardProfileParametersDigitalWallets issuerName(String issuerName) {
  ...
  public CreateACardProfileParametersDigitalWallets textColor(CreateACardProfileParametersDigitalWalletsTextColor textColor) {
   ...
   */
  @javax.annotation.Nullable
  public CreateACardProfileParametersDigitalWalletsTextColor getTextColor() {
    return textColor;
  }

  public void setTextColor(CreateACardProfileParametersDigitalWalletsTextColor textColor) {
    this.textColor = textColor;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateACardProfileParametersDigitalWallets createACardProfileParametersDigitalWallets = (CreateACardProfileParametersDigitalWallets) o;
    return Objects.equals(this.appIconFileId, createACardProfileParametersDigitalWallets.appIconFileId) &&
        Objects.equals(this.backgroundImageFileId, createACardProfileParametersDigitalWallets.backgroundImageFileId) &&
        Objects.equals(this.cardDescription, createACardProfileParametersDigitalWallets.cardDescription) &&
        Objects.equals(this.contactEmail, createACardProfileParametersDigitalWallets.contactEmail) &&
        Objects.equals(this.contactPhone, createACardProfileParametersDigitalWallets.contactPhone) &&
        Objects.equals(this.contactWebsite, createACardProfileParametersDigitalWallets.contactWebsite) &&
        Objects.equals(this.issuerName, createACardProfileParametersDigitalWallets.issuerName) &&
        Objects.equals(this.textColor, createACardProfileParametersDigitalWallets.textColor);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateACardProfileParametersDigitalWallets {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateACardProfileParametersDigitalWallets
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateACardProfileParametersDigitalWallets.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateACardProfileParametersDigitalWallets is not found in the empty JSON string", CreateACardProfileParametersDigitalWallets.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateACardProfileParametersDigitalWallets.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateACardProfileParametersDigitalWallets` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateACardProfileParametersDigitalWallets.openapiRequiredFields) {
      ...
      if (jsonObj.get("text_color") != null && !jsonObj.get("text_color").isJsonNull()) {
        CreateACardProfileParametersDigitalWalletsTextColor.validateJsonElement(jsonObj.get("text_color"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateACardProfileParametersDigitalWallets.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateACardProfileParametersDigitalWallets' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateACardProfileParametersDigitalWallets> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateACardProfileParametersDigitalWallets.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateACardProfileParametersDigitalWallets>() {
           @Override
           public void write(JsonWriter out, CreateACardProfileParametersDigitalWallets value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateACardProfileParametersDigitalWallets read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateACardProfileParametersDigitalWallets given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateACardProfileParametersDigitalWallets
   * @throws IOException if the JSON string is invalid with respect to CreateACardProfileParametersDigitalWallets
   */
  public static CreateACardProfileParametersDigitalWallets fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateACardProfileParametersDigitalWallets.class);
  }

  /**
   * Convert an instance of CreateACardProfileParametersDigitalWallets to an JSON string
   *
   * @return JSON string
   */
