...
public class FileList {
  ...
  public FileList data(List<File> data) {
    this.data = data;
    return this;
  }

  public FileList addDataItem(File dataItem) {
    if (this.data == null) {
  ...
  public FileList nextCursor(String nextCursor) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, fileList.data) &&
        Objects.equals(this.nextCursor, fileList.nextCursor);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        File.validateJsonElement(jsonArraydata.get(i));
      };
