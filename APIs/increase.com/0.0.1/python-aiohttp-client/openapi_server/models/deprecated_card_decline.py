...
class DeprecatedCardDecline(Model):
    ...
    def __init__(self, amount: int=None, currency: str=None, merchant_acceptor_id: str=None, merchant_category_code: str=None, merchant_city: str=None, merchant_country: str=None, merchant_descriptor: str=None, merchant_state: str=None):
        """DeprecatedCardDecline - a model defined in OpenAPI

        :param amount: The amount of this DeprecatedCardDecline.
        :param currency: The currency of this DeprecatedCardDecline.
        :param merchant_acceptor_id: The merchant_acceptor_id of this DeprecatedCardDecline.
        :param merchant_category_code: The merchant_category_code of this DeprecatedCardDecline.
        :param merchant_city: The merchant_city of this DeprecatedCardDecline.
        :param merchant_country: The merchant_country of this DeprecatedCardDecline.
        :param merchant_descriptor: The merchant_descriptor of this DeprecatedCardDecline.
        :param merchant_state: The merchant_state of this DeprecatedCardDecline.
        """
        self.openapi_types = {
            'amount': int,
            'currency': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeprecatedCardDecline':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Deprecated_Card_Decline of this DeprecatedCardDecline.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def amount(self):
        """Gets the amount of this DeprecatedCardDecline.

        The declined amount in the minor unit of the destination account currency. For dollars, for example, this is cents.

        :return: The amount of this DeprecatedCardDecline.
        :rtype: int
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this DeprecatedCardDecline.
    ...
    @property
    def currency(self):
        """Gets the currency of this DeprecatedCardDecline.

        The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the destination account currency.

        :return: The currency of this DeprecatedCardDecline.
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this DeprecatedCardDecline.
    ...
    def merchant_acceptor_id(self):
        """Gets the merchant_acceptor_id of this DeprecatedCardDecline.

        

        :return: The merchant_acceptor_id of this DeprecatedCardDecline.
        :rtype: str
        """
    ...
    def merchant_acceptor_id(self, merchant_acceptor_id):
        """Sets the merchant_acceptor_id of this DeprecatedCardDecline.
    ...
    def merchant_category_code(self):
        """Gets the merchant_category_code of this DeprecatedCardDecline.

        

        :return: The merchant_category_code of this DeprecatedCardDecline.
        :rtype: str
        """
    ...
    def merchant_category_code(self, merchant_category_code):
        """Sets the merchant_category_code of this DeprecatedCardDecline.
    ...
    def merchant_city(self):
        """Gets the merchant_city of this DeprecatedCardDecline.

        

        :return: The merchant_city of this DeprecatedCardDecline.
        :rtype: str
        """
    ...
    def merchant_city(self, merchant_city):
        """Sets the merchant_city of this DeprecatedCardDecline.
    ...
    def merchant_country(self):
        """Gets the merchant_country of this DeprecatedCardDecline.

        

        :return: The merchant_country of this DeprecatedCardDecline.
        :rtype: str
        """
    ...
    def merchant_country(self, merchant_country):
        """Sets the merchant_country of this DeprecatedCardDecline.
    ...
    def merchant_descriptor(self):
        """Gets the merchant_descriptor of this DeprecatedCardDecline.

        

        :return: The merchant_descriptor of this DeprecatedCardDecline.
        :rtype: str
        """
    ...
    def merchant_descriptor(self, merchant_descriptor):
        """Sets the merchant_descriptor of this DeprecatedCardDecline.
    ...
    def merchant_state(self):
        """Gets the merchant_state of this DeprecatedCardDecline.

        

        :return: The merchant_state of this DeprecatedCardDecline.
        :rtype: str
        """
    ...
    def merchant_state(self, merchant_state):
        """Sets the merchant_state of this DeprecatedCardDecline.
