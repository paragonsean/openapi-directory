...
class DeprecatedCardRefund(Model):
    ...
    def __init__(self, amount: int=None, currency: str=None, merchant_acceptor_id: str=None, merchant_category_code: str=None, merchant_city: str=None, merchant_country: str=None, merchant_descriptor: str=None, merchant_state: str=None):
        """DeprecatedCardRefund - a model defined in OpenAPI

        :param amount: The amount of this DeprecatedCardRefund.
        :param currency: The currency of this DeprecatedCardRefund.
        :param merchant_acceptor_id: The merchant_acceptor_id of this DeprecatedCardRefund.
        :param merchant_category_code: The merchant_category_code of this DeprecatedCardRefund.
        :param merchant_city: The merchant_city of this DeprecatedCardRefund.
        :param merchant_country: The merchant_country of this DeprecatedCardRefund.
        :param merchant_descriptor: The merchant_descriptor of this DeprecatedCardRefund.
        :param merchant_state: The merchant_state of this DeprecatedCardRefund.
        """
        self.openapi_types = {
            'amount': int,
            'currency': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeprecatedCardRefund':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Deprecated_Card_Refund of this DeprecatedCardRefund.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def amount(self):
        """Gets the amount of this DeprecatedCardRefund.

        The refunded amount in the minor unit of the refunded currency. For dollars, for example, this is cents.

        :return: The amount of this DeprecatedCardRefund.
        :rtype: int
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this DeprecatedCardRefund.
    ...
    @property
    def currency(self):
        """Gets the currency of this DeprecatedCardRefund.

        The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the refund currency.

        :return: The currency of this DeprecatedCardRefund.
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this DeprecatedCardRefund.
    ...
    def merchant_acceptor_id(self):
        """Gets the merchant_acceptor_id of this DeprecatedCardRefund.

        

        :return: The merchant_acceptor_id of this DeprecatedCardRefund.
        :rtype: str
        """
    ...
    def merchant_acceptor_id(self, merchant_acceptor_id):
        """Sets the merchant_acceptor_id of this DeprecatedCardRefund.
    ...
    def merchant_category_code(self):
        """Gets the merchant_category_code of this DeprecatedCardRefund.

        

        :return: The merchant_category_code of this DeprecatedCardRefund.
        :rtype: str
        """
    ...
    def merchant_category_code(self, merchant_category_code):
        """Sets the merchant_category_code of this DeprecatedCardRefund.
    ...
    def merchant_city(self):
        """Gets the merchant_city of this DeprecatedCardRefund.

        

        :return: The merchant_city of this DeprecatedCardRefund.
        :rtype: str
        """
    ...
    def merchant_city(self, merchant_city):
        """Sets the merchant_city of this DeprecatedCardRefund.
    ...
    def merchant_country(self):
        """Gets the merchant_country of this DeprecatedCardRefund.

        

        :return: The merchant_country of this DeprecatedCardRefund.
        :rtype: str
        """
    ...
    def merchant_country(self, merchant_country):
        """Sets the merchant_country of this DeprecatedCardRefund.
    ...
    def merchant_descriptor(self):
        """Gets the merchant_descriptor of this DeprecatedCardRefund.

        

        :return: The merchant_descriptor of this DeprecatedCardRefund.
        :rtype: str
        """
    ...
    def merchant_descriptor(self, merchant_descriptor):
        """Sets the merchant_descriptor of this DeprecatedCardRefund.
    ...
    def merchant_state(self):
        """Gets the merchant_state of this DeprecatedCardRefund.

        

        :return: The merchant_state of this DeprecatedCardRefund.
        :rtype: str
        """
    ...
    def merchant_state(self, merchant_state):
        """Sets the merchant_state of this DeprecatedCardRefund.
