...
class ACHTransferReturn1(Model):
    ...
    def __init__(self, created_at: datetime=None, return_reason_code: str=None, transaction_id: str=None, transfer_id: str=None):
        """ACHTransferReturn1 - a model defined in OpenAPI

        :param created_at: The created_at of this ACHTransferReturn1.
        :param return_reason_code: The return_reason_code of this ACHTransferReturn1.
        :param transaction_id: The transaction_id of this ACHTransferReturn1.
        :param transfer_id: The transfer_id of this ACHTransferReturn1.
        """
        self.openapi_types = {
            'created_at': datetime,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ACHTransferReturn1':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ACH_Transfer_Return_1 of this ACHTransferReturn1.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def created_at(self):
        """Gets the created_at of this ACHTransferReturn1.

        The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date and time at which the transfer was created.

        :return: The created_at of this ACHTransferReturn1.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this ACHTransferReturn1.
    ...
    def return_reason_code(self):
        """Gets the return_reason_code of this ACHTransferReturn1.

        Why the ACH Transfer was returned.

        :return: The return_reason_code of this ACHTransferReturn1.
        :rtype: str
        """
    ...
    def return_reason_code(self, return_reason_code):
        """Sets the return_reason_code of this ACHTransferReturn1.
    ...
    def transaction_id(self):
        """Gets the transaction_id of this ACHTransferReturn1.

        The identifier of the Tranasaction associated with this return.

        :return: The transaction_id of this ACHTransferReturn1.
        :rtype: str
        """
    ...
    def transaction_id(self, transaction_id):
        """Sets the transaction_id of this ACHTransferReturn1.
    ...
    def transfer_id(self):
        """Gets the transfer_id of this ACHTransferReturn1.

        The identifier of the ACH Transfer associated with this return.

        :return: The transfer_id of this ACHTransferReturn1.
        :rtype: str
        """
    ...
    def transfer_id(self, transfer_id):
        """Sets the transfer_id of this ACHTransferReturn1.
