...
/*
 * OAIWire_Drawdown_Request_Submission.h
 *
 * After the drawdown request is submitted to Fedwire, this will contain supplemental details.
 */

#ifndef OAIWire_Drawdown_Request_Submission_H
#define OAIWire_Drawdown_Request_Submission_H
...
class OAIWire_Drawdown_Request_Submission : public OAIObject {
public:
    OAIWire_Drawdown_Request_Submission();
    OAIWire_Drawdown_Request_Submission(QString json);
    ~OAIWire_Drawdown_Request_Submission() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWire_Drawdown_Request_Submission)

#endif // OAIWire_Drawdown_Request_Submission_H
