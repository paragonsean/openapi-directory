...
#ifndef OAIIndividual_3_H
#define OAIIndividual_3_H
...
class OAIIndividual_3 : public OAIObject {
public:
    OAIIndividual_3();
    OAIIndividual_3(QString json);
    ~OAIIndividual_3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIndividual_3)

#endif // OAIIndividual_3_H
