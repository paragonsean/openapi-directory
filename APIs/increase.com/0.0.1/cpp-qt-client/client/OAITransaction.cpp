...
QString OAITransaction::getRouteId() const {
    return m_route_id;
}
void OAITransaction::setRouteId(const QString &route_id) {
    m_route_id = route_id;
    m_route_id_isSet = true;
}

bool OAITransaction::is_route_id_Set() const{
    return m_route_id_isSet;
}

bool OAITransaction::is_route_id_Valid() const{
    return m_route_id_isValid;
}

QString OAITransaction::getRouteType() const {
    return m_route_type;
}
void OAITransaction::setRouteType(const QString &route_type) {
    m_route_type = route_type;
    m_route_type_isSet = true;
}

bool OAITransaction::is_route_type_Set() const{
    return m_route_type_isSet;
}

bool OAITransaction::is_route_type_Valid() const{
    return m_route_type_isValid;
}

OAITransaction_Source OAITransaction::getSource() const {
    return m_source;
}
void OAITransaction::setSource(const OAITransaction_Source &source) {
    m_source = source;
    m_source_isSet = true;
}
