...
#ifndef OAIInbound_Wire_Reversal_H
#define OAIInbound_Wire_Reversal_H
...
class OAIInbound_Wire_Reversal : public OAIObject {
public:
    OAIInbound_Wire_Reversal();
    OAIInbound_Wire_Reversal(QString json);
    ~OAIInbound_Wire_Reversal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInbound_Wire_Reversal)

#endif // OAIInbound_Wire_Reversal_H
