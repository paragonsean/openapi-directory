...
/*
 * OAIDeprecated_Card_Settlement.h
 *
...
#ifndef OAIDeprecated_Card_Settlement_H
#define OAIDeprecated_Card_Settlement_H
...
class OAIDeprecated_Card_Settlement : public OAIObject {
public:
    OAIDeprecated_Card_Settlement();
    OAIDeprecated_Card_Settlement(QString json);
    ~OAIDeprecated_Card_Settlement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeprecated_Card_Settlement)

#endif // OAIDeprecated_Card_Settlement_H
