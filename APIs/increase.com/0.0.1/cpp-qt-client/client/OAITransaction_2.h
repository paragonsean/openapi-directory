...
#ifndef OAITransaction_2_H
#define OAITransaction_2_H
...
class OAITransaction_2 : public OAIObject {
public:
    OAITransaction_2();
    OAITransaction_2(QString json);
    ~OAITransaction_2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransaction_2)

#endif // OAITransaction_2_H
