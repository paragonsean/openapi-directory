...
QString OAIAddress_2::getCity() const {
    return m_city;
}
void OAIAddress_2::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIAddress_2::is_city_Set() const{
    return m_city_isSet;
}

bool OAIAddress_2::is_city_Valid() const{
    return m_city_isValid;
}

QString OAIAddress_2::getLine1() const {
    return m_line1;
}
void OAIAddress_2::setLine1(const QString &line1) {
    m_line1 = line1;
    m_line1_isSet = true;
}

bool OAIAddress_2::is_line1_Set() const{
    return m_line1_isSet;
}

bool OAIAddress_2::is_line1_Valid() const{
    return m_line1_isValid;
}

QString OAIAddress_2::getLine2() const {
    return m_line2;
}
void OAIAddress_2::setLine2(const QString &line2) {
    m_line2 = line2;
    m_line2_isSet = true;
}

bool OAIAddress_2::is_line2_Set() const{
    return m_line2_isSet;
}

bool OAIAddress_2::is_line2_Valid() const{
    return m_line2_isValid;
}

QString OAIAddress_2::getState() const {
    return m_state;
}
void OAIAddress_2::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIAddress_2::is_state_Set() const{
    return m_state_isSet;
}

bool OAIAddress_2::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIAddress_2::getZip() const {
    return m_zip;
}
void OAIAddress_2::setZip(const QString &zip) {
    m_zip = zip;
    m_zip_isSet = true;
}

bool OAIAddress_2::is_zip_Set() const{
    return m_zip_isSet;
}

bool OAIAddress_2::is_zip_Valid() const{
