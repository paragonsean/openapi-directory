...
namespace OpenAPI {
class OAIPending_Transaction_Source;

class OAIPending_transaction : public OAIObject {
public:
    OAIPending_transaction();
    OAIPending_transaction(QString json);
    ~OAIPending_transaction() override;
    ...
    OAIPending_Transaction_Source getSource() const;
    void setSource(const OAIPending_Transaction_Source &source);
...
private:
    ...
    OAIPending_Transaction_Source m_source;
    bool m_source_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPending_transaction)

#endif // OAIPending_transaction_H
