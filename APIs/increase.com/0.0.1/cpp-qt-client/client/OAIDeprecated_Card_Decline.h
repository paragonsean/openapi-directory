...
#ifndef OAIDeprecated_Card_Decline_H
#define OAIDeprecated_Card_Decline_H
...
class OAIDeprecated_Card_Decline : public OAIObject {
public:
    OAIDeprecated_Card_Decline();
    OAIDeprecated_Card_Decline(QString json);
    ~OAIDeprecated_Card_Decline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeprecated_Card_Decline)

#endif // OAIDeprecated_Card_Decline_H
