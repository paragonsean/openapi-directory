...
#ifndef OAICard_Decline_H
#define OAICard_Decline_H
...
class OAICard_Decline : public OAIObject {
public:
    OAICard_Decline();
    OAICard_Decline(QString json);
    ~OAICard_Decline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICard_Decline)

#endif // OAICard_Decline_H
