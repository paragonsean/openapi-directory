...
QList<OAIObject> OAIError::getErrors() const {
    return m_errors;
}
void OAIError::setErrors(const QList<OAIObject> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}
...
qint32 OAIError::getRetryAfter() const {
    return m_retry_after;
}
void OAIError::setRetryAfter(const qint32 &retry_after) {
    m_retry_after = retry_after;
    m_retry_after_isSet = true;
}

bool OAIError::is_retry_after_Set() const{
    return m_retry_after_isSet;
}

bool OAIError::is_retry_after_Valid() const{
...
bool OAIError::isValid() const {
    ...
    return m_detail_isValid && m_status_isValid && m_title_isValid && m_type_isValid && m_errors_isValid && true;
}
