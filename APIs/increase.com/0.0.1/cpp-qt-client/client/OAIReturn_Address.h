...
#ifndef OAIReturn_Address_H
#define OAIReturn_Address_H
...
class OAIReturn_Address : public OAIObject {
public:
    OAIReturn_Address();
    OAIReturn_Address(QString json);
    ~OAIReturn_Address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturn_Address)

#endif // OAIReturn_Address_H
