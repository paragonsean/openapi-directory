...
/*
 * OAIBilling_Address.h
 *
 * The Card&#39;s billing address.
 */

#ifndef OAIBilling_Address_H
#define OAIBilling_Address_H
...
class OAIBilling_Address : public OAIObject {
public:
    OAIBilling_Address();
    OAIBilling_Address(QString json);
    ~OAIBilling_Address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBilling_Address)

#endif // OAIBilling_Address_H
