...
OAIWire_Transfer_Instruction::OAIWire_Transfer_Instruction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWire_Transfer_Instruction::OAIWire_Transfer_Instruction() {
    this->initializeModel();
}

OAIWire_Transfer_Instruction::~OAIWire_Transfer_Instruction() {}

void OAIWire_Transfer_Instruction::initializeModel() {
...
void OAIWire_Transfer_Instruction::fromJson(QString jsonString) {
...
void OAIWire_Transfer_Instruction::fromJsonObject(QJsonObject json) {
...
QString OAIWire_Transfer_Instruction::asJson() const {
...
QJsonObject OAIWire_Transfer_Instruction::asJsonObject() const {
    QJsonObject obj;
...
QString OAIWire_Transfer_Instruction::getAccountNumber() const {
    return m_account_number;
}
void OAIWire_Transfer_Instruction::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIWire_Transfer_Instruction::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIWire_Transfer_Instruction::is_account_number_Valid() const{
    return m_account_number_isValid;
}

qint32 OAIWire_Transfer_Instruction::getAmount() const {
    return m_amount;
}
void OAIWire_Transfer_Instruction::setAmount(const qint32 &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIWire_Transfer_Instruction::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIWire_Transfer_Instruction::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAIWire_Transfer_Instruction::getMessageToRecipient() const {
    return m_message_to_recipient;
}
void OAIWire_Transfer_Instruction::setMessageToRecipient(const QString &message_to_recipient) {
    m_message_to_recipient = message_to_recipient;
    m_message_to_recipient_isSet = true;
}

bool OAIWire_Transfer_Instruction::is_message_to_recipient_Set() const{
    return m_message_to_recipient_isSet;
}

bool OAIWire_Transfer_Instruction::is_message_to_recipient_Valid() const{
    return m_message_to_recipient_isValid;
}

QString OAIWire_Transfer_Instruction::getRoutingNumber() const {
    return m_routing_number;
}
void OAIWire_Transfer_Instruction::setRoutingNumber(const QString &routing_number) {
    m_routing_number = routing_number;
    m_routing_number_isSet = true;
}

bool OAIWire_Transfer_Instruction::is_routing_number_Set() const{
    return m_routing_number_isSet;
}

bool OAIWire_Transfer_Instruction::is_routing_number_Valid() const{
    return m_routing_number_isValid;
}

QString OAIWire_Transfer_Instruction::getTransferId() const {
    return m_transfer_id;
}
void OAIWire_Transfer_Instruction::setTransferId(const QString &transfer_id) {
    m_transfer_id = transfer_id;
    m_transfer_id_isSet = true;
}

bool OAIWire_Transfer_Instruction::is_transfer_id_Set() const{
    return m_transfer_id_isSet;
}

bool OAIWire_Transfer_Instruction::is_transfer_id_Valid() const{
    return m_transfer_id_isValid;
}

bool OAIWire_Transfer_Instruction::isSet() const {
...
bool OAIWire_Transfer_Instruction::isValid() const {
