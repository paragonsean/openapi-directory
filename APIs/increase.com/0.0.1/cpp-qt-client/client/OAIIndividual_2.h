...
#ifndef OAIIndividual_2_H
#define OAIIndividual_2_H
...
class OAIIndividual_2 : public OAIObject {
public:
    OAIIndividual_2();
    OAIIndividual_2(QString json);
    ~OAIIndividual_2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIndividual_2)

#endif // OAIIndividual_2_H
