...
#ifndef OAIDeclined_Transaction_1_H
#define OAIDeclined_Transaction_1_H
...
class OAIDeclined_Transaction_1 : public OAIObject {
public:
    OAIDeclined_Transaction_1();
    OAIDeclined_Transaction_1(QString json);
    ~OAIDeclined_Transaction_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeclined_Transaction_1)

#endif // OAIDeclined_Transaction_1_H
