...
#ifndef OAITransaction_1_H
#define OAITransaction_1_H
...
class OAITransaction_1 : public OAIObject {
public:
    OAITransaction_1();
    OAITransaction_1(QString json);
    ~OAITransaction_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransaction_1)

#endif // OAITransaction_1_H
