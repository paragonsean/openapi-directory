...
#ifndef OAIIndividual_4_H
#define OAIIndividual_4_H
...
class OAIIndividual_4 : public OAIObject {
public:
    OAIIndividual_4();
    OAIIndividual_4(QString json);
    ~OAIIndividual_4() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIndividual_4)

#endif // OAIIndividual_4_H
