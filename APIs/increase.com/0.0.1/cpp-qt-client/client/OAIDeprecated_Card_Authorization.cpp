...
OAIDeprecated_Card_Authorization::OAIDeprecated_Card_Authorization(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeprecated_Card_Authorization::OAIDeprecated_Card_Authorization() {
    this->initializeModel();
}

OAIDeprecated_Card_Authorization::~OAIDeprecated_Card_Authorization() {}

void OAIDeprecated_Card_Authorization::initializeModel() {
...
void OAIDeprecated_Card_Authorization::fromJson(QString jsonString) {
...
void OAIDeprecated_Card_Authorization::fromJsonObject(QJsonObject json) {
...
QString OAIDeprecated_Card_Authorization::asJson() const {
...
QJsonObject OAIDeprecated_Card_Authorization::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
qint32 OAIDeprecated_Card_Authorization::getAmount() const {
    return m_amount;
}
void OAIDeprecated_Card_Authorization::setAmount(const qint32 &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIDeprecated_Card_Authorization::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIDeprecated_Card_Authorization::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAIDeprecated_Card_Authorization::getCurrency() const {
    return m_currency;
}
void OAIDeprecated_Card_Authorization::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAIDeprecated_Card_Authorization::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAIDeprecated_Card_Authorization::is_currency_Valid() const{
    return m_currency_isValid;
}

QString OAIDeprecated_Card_Authorization::getMerchantAcceptorId() const {
    return m_merchant_acceptor_id;
}
void OAIDeprecated_Card_Authorization::setMerchantAcceptorId(const QString &merchant_acceptor_id) {
    m_merchant_acceptor_id = merchant_acceptor_id;
    m_merchant_acceptor_id_isSet = true;
}

bool OAIDeprecated_Card_Authorization::is_merchant_acceptor_id_Set() const{
    return m_merchant_acceptor_id_isSet;
}

bool OAIDeprecated_Card_Authorization::is_merchant_acceptor_id_Valid() const{
    return m_merchant_acceptor_id_isValid;
}

QString OAIDeprecated_Card_Authorization::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIDeprecated_Card_Authorization::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIDeprecated_Card_Authorization::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIDeprecated_Card_Authorization::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

QString OAIDeprecated_Card_Authorization::getMerchantCity() const {
    return m_merchant_city;
}
void OAIDeprecated_Card_Authorization::setMerchantCity(const QString &merchant_city) {
    m_merchant_city = merchant_city;
    m_merchant_city_isSet = true;
}

bool OAIDeprecated_Card_Authorization::is_merchant_city_Set() const{
    return m_merchant_city_isSet;
}

bool OAIDeprecated_Card_Authorization::is_merchant_city_Valid() const{
    return m_merchant_city_isValid;
}

QString OAIDeprecated_Card_Authorization::getMerchantCountry() const {
    return m_merchant_country;
}
void OAIDeprecated_Card_Authorization::setMerchantCountry(const QString &merchant_country) {
    m_merchant_country = merchant_country;
    m_merchant_country_isSet = true;
}

bool OAIDeprecated_Card_Authorization::is_merchant_country_Set() const{
    return m_merchant_country_isSet;
}

bool OAIDeprecated_Card_Authorization::is_merchant_country_Valid() const{
    return m_merchant_country_isValid;
}

QString OAIDeprecated_Card_Authorization::getMerchantDescriptor() const {
    return m_merchant_descriptor;
}
void OAIDeprecated_Card_Authorization::setMerchantDescriptor(const QString &merchant_descriptor) {
    m_merchant_descriptor = merchant_descriptor;
    m_merchant_descriptor_isSet = true;
}

bool OAIDeprecated_Card_Authorization::is_merchant_descriptor_Set() const{
    return m_merchant_descriptor_isSet;
}

bool OAIDeprecated_Card_Authorization::is_merchant_descriptor_Valid() const{
    return m_merchant_descriptor_isValid;
}

QString OAIDeprecated_Card_Authorization::getMerchantState() const {
    return m_merchant_state;
}
void OAIDeprecated_Card_Authorization::setMerchantState(const QString &merchant_state) {
    m_merchant_state = merchant_state;
    m_merchant_state_isSet = true;
}

bool OAIDeprecated_Card_Authorization::is_merchant_state_Set() const{
    return m_merchant_state_isSet;
}

bool OAIDeprecated_Card_Authorization::is_merchant_state_Valid() const{
    return m_merchant_state_isValid;
}

bool OAIDeprecated_Card_Authorization::isSet() const {
...
bool OAIDeprecated_Card_Authorization::isValid() const {
