...
#ifndef OAIDeprecated_Card_Refund_H
#define OAIDeprecated_Card_Refund_H
...
class OAIDeprecated_Card_Refund : public OAIObject {
public:
    OAIDeprecated_Card_Refund();
    OAIDeprecated_Card_Refund(QString json);
    ~OAIDeprecated_Card_Refund() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeprecated_Card_Refund)

#endif // OAIDeprecated_Card_Refund_H
