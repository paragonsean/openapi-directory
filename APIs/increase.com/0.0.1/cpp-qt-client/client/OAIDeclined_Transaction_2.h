...
#ifndef OAIDeclined_Transaction_2_H
#define OAIDeclined_Transaction_2_H
...
class OAIDeclined_Transaction_2 : public OAIObject {
public:
    OAIDeclined_Transaction_2();
    OAIDeclined_Transaction_2(QString json);
    ~OAIDeclined_Transaction_2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeclined_Transaction_2)

#endif // OAIDeclined_Transaction_2_H
