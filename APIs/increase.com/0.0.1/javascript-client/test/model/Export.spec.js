...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.Export();
  });
  ...
  describe('Export', function() {
    it('should create an instance of Export', function() {
      ...
      //var instance = new IncreaseApi.Export();
      //expect(instance).to.be.a(IncreaseApi.Export);
    });
    ...
    it('should have the property fileDownloadUrl (base name: "file_download_url")', function() {
