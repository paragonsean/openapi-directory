...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.DeclinedTransaction();
  });
  ...
  describe('DeclinedTransaction', function() {
    it('should create an instance of DeclinedTransaction', function() {
      // uncomment below and update the code to test DeclinedTransaction
      //var instance = new IncreaseApi.DeclinedTransaction();
      //expect(instance).to.be.a(IncreaseApi.DeclinedTransaction);
    });
