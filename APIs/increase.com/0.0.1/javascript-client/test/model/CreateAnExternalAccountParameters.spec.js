...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.CreateAnExternalAccountParameters();
  });
  ...
  describe('CreateAnExternalAccountParameters', function() {
    it('should create an instance of CreateAnExternalAccountParameters', function() {
      // uncomment below and update the code to test CreateAnExternalAccountParameters
      //var instance = new IncreaseApi.CreateAnExternalAccountParameters();
      //expect(instance).to.be.a(IncreaseApi.CreateAnExternalAccountParameters);
    });
