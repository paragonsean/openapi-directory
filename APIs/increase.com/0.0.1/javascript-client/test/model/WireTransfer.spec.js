...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.WireTransfer();
  });
  ...
  describe('WireTransfer', function() {
    it('should create an instance of WireTransfer', function() {
      // uncomment below and update the code to test WireTransfer
      //var instance = new IncreaseApi.WireTransfer();
      //expect(instance).to.be.a(IncreaseApi.WireTransfer);
    });
