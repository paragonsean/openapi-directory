...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.ExportList();
  });
  ...
  describe('ExportList', function() {
    it('should create an instance of ExportList', function() {
      // uncomment below and update the code to test ExportList
      //var instance = new IncreaseApi.ExportList();
      //expect(instance).to.be.a(IncreaseApi.ExportList);
    });
