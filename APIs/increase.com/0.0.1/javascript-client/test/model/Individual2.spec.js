...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.Individual2();
  });
  ...
  describe('Individual2', function() {
    it('should create an instance of Individual2', function() {
      // uncomment below and update the code to test Individual2
      //var instance = new IncreaseApi.Individual2();
      //expect(instance).to.be.a(IncreaseApi.Individual2);
    });
