...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.ExternalAccount();
  });
  ...
  describe('ExternalAccount', function() {
    it('should create an instance of ExternalAccount', function() {
      // uncomment below and update the code to test ExternalAccount
      //var instance = new IncreaseApi.ExternalAccount();
      //expect(instance).to.be.a(IncreaseApi.ExternalAccount);
    });
