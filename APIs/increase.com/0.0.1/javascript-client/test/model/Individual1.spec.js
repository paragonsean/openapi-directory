...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.Individual1();
  });
  ...
  describe('Individual1', function() {
    it('should create an instance of Individual1', function() {
      // uncomment below and update the code to test Individual1
      //var instance = new IncreaseApi.Individual1();
      //expect(instance).to.be.a(IncreaseApi.Individual1);
    });
