...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.CreateALimitParameters();
  });
  ...
  describe('CreateALimitParameters', function() {
    it('should create an instance of CreateALimitParameters', function() {
      // uncomment below and update the code to test CreateALimitParameters
      //var instance = new IncreaseApi.CreateALimitParameters();
      //expect(instance).to.be.a(IncreaseApi.CreateALimitParameters);
    });
