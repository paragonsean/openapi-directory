...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.CardList();
  });
  ...
  describe('CardList', function() {
    it('should create an instance of CardList', function() {
      // uncomment below and update the code to test CardList
      //var instance = new IncreaseApi.CardList();
      //expect(instance).to.be.a(IncreaseApi.CardList);
    });
