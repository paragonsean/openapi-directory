...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.WireTransferInstruction();
  });
  ...
  describe('WireTransferInstruction', function() {
    it('should create an instance of WireTransferInstruction', function() {
      // uncomment below and update the code to test WireTransferInstruction
      //var instance = new IncreaseApi.WireTransferInstruction();
      //expect(instance).to.be.a(IncreaseApi.WireTransferInstruction);
    });
