...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.CheckTransferSubmission();
  });
  ...
  describe('CheckTransferSubmission', function() {
    it('should create an instance of CheckTransferSubmission', function() {
      // uncomment below and update the code to test CheckTransferSubmission
      //var instance = new IncreaseApi.CheckTransferSubmission();
      //expect(instance).to.be.a(IncreaseApi.CheckTransferSubmission);
    });
