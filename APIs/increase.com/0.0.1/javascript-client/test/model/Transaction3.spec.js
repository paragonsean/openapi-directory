...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.Transaction3();
  });
  ...
  describe('Transaction3', function() {
    it('should create an instance of Transaction3', function() {
      // uncomment below and update the code to test Transaction3
      //var instance = new IncreaseApi.Transaction3();
      //expect(instance).to.be.a(IncreaseApi.Transaction3);
    });
