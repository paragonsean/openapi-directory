...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.CheckTransferStopPaymentRequest1();
  });
  ...
  describe('CheckTransferStopPaymentRequest1', function() {
    it('should create an instance of CheckTransferStopPaymentRequest1', function() {
      // uncomment below and update the code to test CheckTransferStopPaymentRequest1
      //var instance = new IncreaseApi.CheckTransferStopPaymentRequest1();
      //expect(instance).to.be.a(IncreaseApi.CheckTransferStopPaymentRequest1);
    });
