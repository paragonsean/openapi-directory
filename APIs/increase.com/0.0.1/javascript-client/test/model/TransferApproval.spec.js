...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.TransferApproval();
  });
  ...
  describe('TransferApproval', function() {
    it('should create an instance of TransferApproval', function() {
      // uncomment below and update the code to test TransferApproval
      //var instance = new IncreaseApi.TransferApproval();
      //expect(instance).to.be.a(IncreaseApi.TransferApproval);
    });
