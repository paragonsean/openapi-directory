...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.DeclinedTransaction1();
  });
  ...
  describe('DeclinedTransaction1', function() {
    it('should create an instance of DeclinedTransaction1', function() {
      // uncomment below and update the code to test DeclinedTransaction1
      //var instance = new IncreaseApi.DeclinedTransaction1();
      //expect(instance).to.be.a(IncreaseApi.DeclinedTransaction1);
    });
