...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.Joint();
  });
  ...
  describe('Joint', function() {
    it('should create an instance of Joint', function() {
      // uncomment below and update the code to test Joint
      //var instance = new IncreaseApi.Joint();
      //expect(instance).to.be.a(IncreaseApi.Joint);
    });
