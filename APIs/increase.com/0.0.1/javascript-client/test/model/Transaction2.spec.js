...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.Transaction2();
  });
  ...
  describe('Transaction2', function() {
    it('should create an instance of Transaction2', function() {
      // uncomment below and update the code to test Transaction2
      //var instance = new IncreaseApi.Transaction2();
      //expect(instance).to.be.a(IncreaseApi.Transaction2);
    });
