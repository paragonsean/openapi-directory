...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.CreateACheckTransferParameters();
  });
  ...
  describe('CreateACheckTransferParameters', function() {
    it('should create an instance of CreateACheckTransferParameters', function() {
      // uncomment below and update the code to test CreateACheckTransferParameters
      //var instance = new IncreaseApi.CreateACheckTransferParameters();
      //expect(instance).to.be.a(IncreaseApi.CreateACheckTransferParameters);
    });
