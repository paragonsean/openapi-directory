...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.Individual3();
  });
  ...
  describe('Individual3', function() {
    it('should create an instance of Individual3', function() {
      // uncomment below and update the code to test Individual3
      //var instance = new IncreaseApi.Individual3();
      //expect(instance).to.be.a(IncreaseApi.Individual3);
    });
