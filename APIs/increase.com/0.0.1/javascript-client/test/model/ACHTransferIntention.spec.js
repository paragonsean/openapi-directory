...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.ACHTransferIntention();
  });
  ...
  describe('ACHTransferIntention', function() {
    it('should create an instance of ACHTransferIntention', function() {
      // uncomment below and update the code to test ACHTransferIntention
      //var instance = new IncreaseApi.ACHTransferIntention();
      //expect(instance).to.be.a(IncreaseApi.ACHTransferIntention);
    });
