...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.WireTransferIntention();
  });
  ...
  describe('WireTransferIntention', function() {
    it('should create an instance of WireTransferIntention', function() {
      // uncomment below and update the code to test WireTransferIntention
      //var instance = new IncreaseApi.WireTransferIntention();
      //expect(instance).to.be.a(IncreaseApi.WireTransferIntention);
    });
