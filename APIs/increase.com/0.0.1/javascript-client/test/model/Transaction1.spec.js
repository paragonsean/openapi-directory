...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.Transaction1();
  });
  ...
  describe('Transaction1', function() {
    it('should create an instance of Transaction1', function() {
      // uncomment below and update the code to test Transaction1
      //var instance = new IncreaseApi.Transaction1();
      //expect(instance).to.be.a(IncreaseApi.Transaction1);
    });
