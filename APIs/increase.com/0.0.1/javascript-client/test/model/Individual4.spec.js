...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.Individual4();
  });
  ...
  describe('Individual4', function() {
    it('should create an instance of Individual4', function() {
      // uncomment below and update the code to test Individual4
      //var instance = new IncreaseApi.Individual4();
      //expect(instance).to.be.a(IncreaseApi.Individual4);
    });
