...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.EventList();
  });
  ...
  describe('EventList', function() {
    it('should create an instance of EventList', function() {
      // uncomment below and update the code to test EventList
      //var instance = new IncreaseApi.EventList();
      //expect(instance).to.be.a(IncreaseApi.EventList);
    });
