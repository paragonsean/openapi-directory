...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncreaseApi.PendingTransaction();
  });
  ...
  describe('PendingTransaction', function() {
    it('should create an instance of PendingTransaction', function() {
      // uncomment below and update the code to test PendingTransaction
      //var instance = new IncreaseApi.PendingTransaction();
      //expect(instance).to.be.a(IncreaseApi.PendingTransaction);
    });
