...
/**
 * The DeprecatedCardDecline model module.
 * @module model/DeprecatedCardDecline
 * @version 0.0.1
 */
class DeprecatedCardDecline {
    /**
     * Constructs a new <code>DeprecatedCardDecline</code>.
     ...
     * @alias module:model/DeprecatedCardDecline
     ...
     * @param currency {module:model/DeprecatedCardDecline.CurrencyEnum} The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the destination account currency.
    ...
    constructor(amount, currency, merchantAcceptorId, merchantCategoryCode, merchantCity, merchantCountry, merchantDescriptor, merchantState) { 
        ...
        DeprecatedCardDecline.initialize(this, amount, currency, merchantAcceptorId, merchantCategoryCode, merchantCity, merchantCountry, merchantDescriptor, merchantState);
    }
    ...
    /**
     * Constructs a <code>DeprecatedCardDecline</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeprecatedCardDecline} obj Optional instance to populate.
     * @return {module:model/DeprecatedCardDecline} The populated <code>DeprecatedCardDecline</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeprecatedCardDecline();
    ...
    /**
     * Validates the JSON data with respect to <code>DeprecatedCardDecline</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeprecatedCardDecline</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeprecatedCardDecline.RequiredProperties) {
...
DeprecatedCardDecline.RequiredProperties = ["amount", "currency", "merchant_acceptor_id", "merchant_category_code", "merchant_city", "merchant_country", "merchant_descriptor", "merchant_state"];

/**
 * The declined amount in the minor unit of the destination account currency. For dollars, for example, this is cents.
 * @member {Number} amount
 */
DeprecatedCardDecline.prototype['amount'] = undefined;

/**
 * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the destination account currency.
 * @member {module:model/DeprecatedCardDecline.CurrencyEnum} currency
 */
DeprecatedCardDecline.prototype['currency'] = undefined;

/**
 * 
 * @member {String} merchant_acceptor_id
 */
DeprecatedCardDecline.prototype['merchant_acceptor_id'] = undefined;

/**
 * 
 * @member {String} merchant_category_code
 */
DeprecatedCardDecline.prototype['merchant_category_code'] = undefined;

/**
 * 
 * @member {String} merchant_city
 */
DeprecatedCardDecline.prototype['merchant_city'] = undefined;

/**
 * 
 * @member {String} merchant_country
 */
DeprecatedCardDecline.prototype['merchant_country'] = undefined;

/**
 * 
 * @member {String} merchant_descriptor
 */
DeprecatedCardDecline.prototype['merchant_descriptor'] = undefined;

/**
 * 
 * @member {String} merchant_state
 */
DeprecatedCardDecline.prototype['merchant_state'] = undefined;
 ...
 * @readonly
 */
DeprecatedCardDecline['CurrencyEnum'] = {
...
export default DeprecatedCardDecline;
