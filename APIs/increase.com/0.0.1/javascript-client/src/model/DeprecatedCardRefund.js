...
/**
 * The DeprecatedCardRefund model module.
 * @module model/DeprecatedCardRefund
 * @version 0.0.1
 */
class DeprecatedCardRefund {
    /**
     * Constructs a new <code>DeprecatedCardRefund</code>.
     ...
     * @alias module:model/DeprecatedCardRefund
     * @param amount {Number} The refunded amount in the minor unit of the refunded currency. For dollars, for example, this is cents.
     * @param currency {module:model/DeprecatedCardRefund.CurrencyEnum} The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the refund currency.
    ...
    constructor(amount, currency, merchantAcceptorId, merchantCategoryCode, merchantCity, merchantCountry, merchantDescriptor, merchantState) { 
        ...
        DeprecatedCardRefund.initialize(this, amount, currency, merchantAcceptorId, merchantCategoryCode, merchantCity, merchantCountry, merchantDescriptor, merchantState);
    }
    ...
    /**
     * Constructs a <code>DeprecatedCardRefund</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeprecatedCardRefund} obj Optional instance to populate.
     * @return {module:model/DeprecatedCardRefund} The populated <code>DeprecatedCardRefund</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeprecatedCardRefund();
    ...
    /**
     * Validates the JSON data with respect to <code>DeprecatedCardRefund</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeprecatedCardRefund</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeprecatedCardRefund.RequiredProperties) {
...
DeprecatedCardRefund.RequiredProperties = ["amount", "currency", "merchant_acceptor_id", "merchant_category_code", "merchant_city", "merchant_country", "merchant_descriptor", "merchant_state"];

/**
 * The refunded amount in the minor unit of the refunded currency. For dollars, for example, this is cents.
 * @member {Number} amount
 */
DeprecatedCardRefund.prototype['amount'] = undefined;

/**
 * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the refund currency.
 * @member {module:model/DeprecatedCardRefund.CurrencyEnum} currency
 */
DeprecatedCardRefund.prototype['currency'] = undefined;

/**
 * 
 * @member {String} merchant_acceptor_id
 */
DeprecatedCardRefund.prototype['merchant_acceptor_id'] = undefined;

/**
 * 
 * @member {String} merchant_category_code
 */
DeprecatedCardRefund.prototype['merchant_category_code'] = undefined;

/**
 * 
 * @member {String} merchant_city
 */
DeprecatedCardRefund.prototype['merchant_city'] = undefined;

/**
 * 
 * @member {String} merchant_country
 */
DeprecatedCardRefund.prototype['merchant_country'] = undefined;

/**
 * 
 * @member {String} merchant_descriptor
 */
DeprecatedCardRefund.prototype['merchant_descriptor'] = undefined;

/**
 * 
 * @member {String} merchant_state
 */
DeprecatedCardRefund.prototype['merchant_state'] = undefined;
 ...
 * @readonly
 */
DeprecatedCardRefund['CurrencyEnum'] = {
...
export default DeprecatedCardRefund;
