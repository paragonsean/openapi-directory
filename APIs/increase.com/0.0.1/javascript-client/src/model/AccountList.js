...
class AccountList {
     ...
     * @param data {Array.<module:model/Account>} The contents of the list.
     * @param nextCursor {String} A pointer to a place in the list.
     */
    constructor(data, nextCursor) { 
        
        AccountList.initialize(this, data, nextCursor);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountList.RequiredProperties) {
...
AccountList.RequiredProperties = ["data", "next_cursor"];

/**
 * The contents of the list.
 * @member {Array.<module:model/Account>} data
 */
AccountList.prototype['data'] = undefined;

/**
 * A pointer to a place in the list.
 * @member {String} next_cursor
 */
AccountList.prototype['next_cursor'] = undefined;
