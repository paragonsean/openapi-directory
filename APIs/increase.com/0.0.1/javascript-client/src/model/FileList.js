...
class FileList {
     ...
     * @param data {Array.<File>} The contents of the list.
     * @param nextCursor {String} A pointer to a place in the list.
     */
    constructor(data, nextCursor) { 
        
        FileList.initialize(this, data, nextCursor);
    }
...
FileList.RequiredProperties = ["data", "next_cursor"];

/**
 * The contents of the list.
 * @member {Array.<File>} data
 */
FileList.prototype['data'] = undefined;

/**
 * A pointer to a place in the list.
 * @member {String} next_cursor
 */
FileList.prototype['next_cursor'] = undefined;
