...
/**
 * The DeprecatedCardSettlement model module.
 * @module model/DeprecatedCardSettlement
 * @version 0.0.1
 */
class DeprecatedCardSettlement {
    /**
     * Constructs a new <code>DeprecatedCardSettlement</code>.
     ...
     * @alias module:model/DeprecatedCardSettlement
     * @param amount {Number} The settled amount in the minor unit of the settlement currency. For dollars, for example, this is cents.
     * @param currency {module:model/DeprecatedCardSettlement.CurrencyEnum} The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the settlement currency.
    ...
    constructor(amount, currency, merchantAcceptorId, merchantCategoryCode, merchantCity, merchantCountry, merchantDescriptor, merchantState) { 
        ...
        DeprecatedCardSettlement.initialize(this, amount, currency, merchantAcceptorId, merchantCategoryCode, merchantCity, merchantCountry, merchantDescriptor, merchantState);
    }
    ...
    /**
     * Constructs a <code>DeprecatedCardSettlement</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeprecatedCardSettlement} obj Optional instance to populate.
     * @return {module:model/DeprecatedCardSettlement} The populated <code>DeprecatedCardSettlement</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeprecatedCardSettlement();
    ...
    /**
     * Validates the JSON data with respect to <code>DeprecatedCardSettlement</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeprecatedCardSettlement</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeprecatedCardSettlement.RequiredProperties) {
...
DeprecatedCardSettlement.RequiredProperties = ["amount", "currency", "merchant_acceptor_id", "merchant_category_code", "merchant_city", "merchant_country", "merchant_descriptor", "merchant_state"];

/**
 * The settled amount in the minor unit of the settlement currency. For dollars, for example, this is cents.
 * @member {Number} amount
 */
DeprecatedCardSettlement.prototype['amount'] = undefined;

/**
 * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the settlement currency.
 * @member {module:model/DeprecatedCardSettlement.CurrencyEnum} currency
 */
DeprecatedCardSettlement.prototype['currency'] = undefined;

/**
 * 
 * @member {String} merchant_acceptor_id
 */
DeprecatedCardSettlement.prototype['merchant_acceptor_id'] = undefined;

/**
 * 
 * @member {String} merchant_category_code
 */
DeprecatedCardSettlement.prototype['merchant_category_code'] = undefined;

/**
 * 
 * @member {String} merchant_city
 */
DeprecatedCardSettlement.prototype['merchant_city'] = undefined;

/**
 * 
 * @member {String} merchant_country
 */
DeprecatedCardSettlement.prototype['merchant_country'] = undefined;

/**
 * 
 * @member {String} merchant_descriptor
 */
DeprecatedCardSettlement.prototype['merchant_descriptor'] = undefined;

/**
 * 
 * @member {String} merchant_state
 */
DeprecatedCardSettlement.prototype['merchant_state'] = undefined;
 ...
 * @readonly
 */
DeprecatedCardSettlement['CurrencyEnum'] = {
...
export default DeprecatedCardSettlement;
