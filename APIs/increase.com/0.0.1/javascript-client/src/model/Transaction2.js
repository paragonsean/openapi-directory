...
/**
 * The Transaction2 model module.
 * @module model/Transaction2
 * @version 0.0.1
 */
class Transaction2 {
    /**
     * Constructs a new <code>Transaction2</code>.
     ...
     * @alias module:model/Transaction2
     ...
     * @param currency {module:model/Transaction2.CurrencyEnum} The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the Transaction's currency. This will match the currency on the Transcation's Account.
     ...
     * @param routeType {module:model/Transaction2.RouteTypeEnum} The type of the route this Transaction came through.
     * @param source {module:model/TransactionSource} 
     * @param type {module:model/Transaction2.TypeEnum} A constant representing the object's type. For this resource it will always be `transaction`.
     */
    constructor(accountId, amount, createdAt, currency, description, id, routeId, routeType, source, type) { 
        
        Transaction2.initialize(this, accountId, amount, createdAt, currency, description, id, routeId, routeType, source, type);
    }
    ...
    /**
     * Constructs a <code>Transaction2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Transaction2} obj Optional instance to populate.
     * @return {module:model/Transaction2} The populated <code>Transaction2</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Transaction2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Transaction2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Transaction2.RequiredProperties) {
...
Transaction2.RequiredProperties = ["account_id", "amount", "created_at", "currency", "description", "id", "route_id", "route_type", "source", "type"];

/**
 * The identifier for the Account the Transaction belongs to.
 * @member {String} account_id
 */
Transaction2.prototype['account_id'] = undefined;

/**
 * The Transaction amount in the minor unit of its currency. For dollars, for example, this is cents.
 * @member {Number} amount
 */
Transaction2.prototype['amount'] = undefined;

/**
 * The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date on which the Transaction occured.
 * @member {Date} created_at
 */
Transaction2.prototype['created_at'] = undefined;
 ...
 * @member {module:model/Transaction2.CurrencyEnum} currency
 */
Transaction2.prototype['currency'] = undefined;
 ...
 */
Transaction2.prototype['description'] = undefined;

/**
 * The Transaction identifier.
 * @member {String} id
 */
Transaction2.prototype['id'] = undefined;
 ...
 */
Transaction2.prototype['route_id'] = undefined;

/**
 * The type of the route this Transaction came through.
 * @member {module:model/Transaction2.RouteTypeEnum} route_type
 */
Transaction2.prototype['route_type'] = undefined;

/**
 * @member {module:model/TransactionSource} source
 */
Transaction2.prototype['source'] = undefined;

/**
 * A constant representing the object's type. For this resource it will always be `transaction`.
 * @member {module:model/Transaction2.TypeEnum} type
 */
Transaction2.prototype['type'] = undefined;
