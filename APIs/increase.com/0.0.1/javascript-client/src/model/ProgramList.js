...
class ProgramList {
     ...
     * @param data {Array.<module:model/Program>} The contents of the list.
     * @param nextCursor {String} A pointer to a place in the list.
     */
    constructor(data, nextCursor) { 
        
        ProgramList.initialize(this, data, nextCursor);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Program]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ProgramList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProgramList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProgramList.RequiredProperties) {
...
ProgramList.RequiredProperties = ["data", "next_cursor"];

/**
 * The contents of the list.
 * @member {Array.<module:model/Program>} data
 */
ProgramList.prototype['data'] = undefined;

/**
 * A pointer to a place in the list.
 * @member {String} next_cursor
 */
ProgramList.prototype['next_cursor'] = undefined;
