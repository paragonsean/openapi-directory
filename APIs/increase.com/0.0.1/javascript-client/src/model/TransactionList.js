...
class TransactionList {
     ...
     * @param data {Array.<module:model/Transaction>} The contents of the list.
     * @param nextCursor {String} A pointer to a place in the list.
     */
    constructor(data, nextCursor) { 
        
        TransactionList.initialize(this, data, nextCursor);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TransactionList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransactionList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransactionList.RequiredProperties) {
...
TransactionList.RequiredProperties = ["data", "next_cursor"];

/**
 * The contents of the list.
 * @member {Array.<module:model/Transaction>} data
 */
TransactionList.prototype['data'] = undefined;

/**
 * A pointer to a place in the list.
 * @member {String} next_cursor
 */
TransactionList.prototype['next_cursor'] = undefined;
