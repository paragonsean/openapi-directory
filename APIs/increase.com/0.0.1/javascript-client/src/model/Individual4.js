...
/**
 * The Individual4 model module.
 * @module model/Individual4
 * @version 0.0.1
 */
class Individual4 {
    /**
     * Constructs a new <code>Individual4</code>.
     * The individual trustee of the trust. Will be present if the trustee&#39;s &#x60;structure&#x60; is equal to &#x60;individual&#x60;.
     * @alias module:model/Individual4
    ...
    constructor(address, dateOfBirth, identification, name) { 
        ...
        Individual4.initialize(this, address, dateOfBirth, identification, name);
    }
    ...
    /**
     * Constructs a <code>Individual4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Individual4} obj Optional instance to populate.
     * @return {module:model/Individual4} The populated <code>Individual4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Individual4();
    ...
    /**
     * Validates the JSON data with respect to <code>Individual4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Individual4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Individual4.RequiredProperties) {
...
Individual4.RequiredProperties = ["address", "date_of_birth", "identification", "name"];

/**
 * @member {module:model/Address1} address
 */
Individual4.prototype['address'] = undefined;

/**
 * The person's date of birth in YYYY-MM-DD format.
 * @member {Date} date_of_birth
 */
Individual4.prototype['date_of_birth'] = undefined;

/**
 * @member {module:model/Identification} identification
 */
Individual4.prototype['identification'] = undefined;

/**
 * The person's legal name.
 * @member {String} name
 */
Individual4.prototype['name'] = undefined;
