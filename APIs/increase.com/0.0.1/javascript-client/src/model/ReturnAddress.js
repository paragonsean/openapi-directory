...
class ReturnAddress {
     ...
     * @param state {String} The US state of the address.
     * @param zip {String} The postal code of the address.
     */
    constructor(city, line1, line2, name, state, zip) { 
        
        ReturnAddress.initialize(this, city, line1, line2, name, state, zip);
    }
     ...
     */
    static initialize(obj, city, line1, line2, name, state, zip) { 
        obj['city'] = city;
        obj['line1'] = line1;
        obj['line2'] = line2;
        obj['name'] = name;
...
ReturnAddress.RequiredProperties = ["city", "line1", "line2", "name", "state", "zip"];
 ...
 * @member {String} line1
 */
ReturnAddress.prototype['line1'] = undefined;

/**
 * The second line of the address.
 * @member {String} line2
 */
ReturnAddress.prototype['line2'] = undefined;

/**
 * The name of the address.
 * @member {String} name
 */
ReturnAddress.prototype['name'] = undefined;
