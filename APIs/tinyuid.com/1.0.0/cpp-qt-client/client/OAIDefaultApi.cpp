...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://tinyuid.com/api/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("v1ShortenPost", defaultConf);
    _serverIndices.insert("v1ShortenPost", 0);
}
...
void OAIDefaultApi::v1ShortenPost(const QString &url) {
    QString fullPath = QString(_serverConfigs["v1ShortenPost"][_serverIndices.value("v1ShortenPost")].URL()+"/v1/shorten");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::v1ShortenPostCallback);
...
void OAIDefaultApi::v1ShortenPostCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_v1_shorten_post_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT v1ShortenPostSignal(output);
        Q_EMIT v1ShortenPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT v1ShortenPostSignalE(output, error_type, error_str);
        Q_EMIT v1ShortenPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT v1ShortenPostSignalError(output, error_type, error_str);
        Q_EMIT v1ShortenPostSignalErrorFull(worker, error_type, error_str);
    }
}
