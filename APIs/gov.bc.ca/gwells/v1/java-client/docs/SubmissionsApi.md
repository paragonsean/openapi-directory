...
import org.openapitools.client.api.SubmissionsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.submissionsOptionsList();
    } catch (ApiException e) {
      System.err.println("Exception when calling SubmissionsApi#submissionsOptionsList");
