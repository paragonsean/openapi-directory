...
public class Qualification {
  ...
  public Qualification wellClass(String wellClass) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, qualification.description) &&
        Objects.equals(this.wellClass, qualification.wellClass);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, wellClass);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("well_class");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Qualification.openapiRequiredFields) {
      ...
      if (!jsonObj.get("well_class").isJsonPrimitive()) {
