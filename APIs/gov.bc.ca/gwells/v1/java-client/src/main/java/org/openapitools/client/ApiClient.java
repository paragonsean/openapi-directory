...
public class ApiClient {
    ...
    private String basePath = "https://apps.nrs.gov.bc.ca/gwells/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("Bearer", new ApiKeyAuth("header", "JWT"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apps.nrs.gov.bc.ca/gwells/api/v1
