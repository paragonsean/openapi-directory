...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GroundwaterWellsAquifersAndRegistryApi.WellList();
  });
  ...
  describe('WellList', function() {
    it('should create an instance of WellList', function() {
      // uncomment below and update the code to test WellList
      //var instance = new GroundwaterWellsAquifersAndRegistryApi.WellList();
      //expect(instance).to.be.a(GroundwaterWellsAquifersAndRegistryApi.WellList);
    });
