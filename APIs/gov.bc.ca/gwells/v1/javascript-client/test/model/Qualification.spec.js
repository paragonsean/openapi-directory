...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GroundwaterWellsAquifersAndRegistryApi.Qualification();
  });
  ...
  describe('Qualification', function() {
    it('should create an instance of Qualification', function() {
      ...
      //var instance = new GroundwaterWellsAquifersAndRegistryApi.Qualification();
      //expect(instance).to.be.a(GroundwaterWellsAquifersAndRegistryApi.Qualification);
    });
