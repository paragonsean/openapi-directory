...
/**
 * The WellDetail model module.
 * @module model/WellDetail
 * @version v1
 */
class WellDetail {
    /**
     * Constructs a new <code>WellDetail</code>.
     * @alias module:model/WellDetail
     * @param casingSet {Array.<module:model/Casing>} 
     * @param companyOfPersonResponsible {module:model/OrganizationNameList} 
     * @param decommissionDescriptionSet {Array.<module:model/DecommissionDescription>} 
     * @param linerperforationSet {Array.<module:model/LinerPerforation>} 
     * @param lithologydescriptionSet {Array.<module:model/LithologyDescription>} 
     * @param ownerFullName {String} 
     * @param personResponsible {module:model/PersonBasic} 
     * @param screenSet {Array.<module:model/Screen>} 
     * @param well {Number} 
     */
    constructor(casingSet, companyOfPersonResponsible, decommissionDescriptionSet, linerperforationSet, lithologydescriptionSet, ownerFullName, personResponsible, screenSet, well) { 
        
        WellDetail.initialize(this, casingSet, companyOfPersonResponsible, decommissionDescriptionSet, linerperforationSet, lithologydescriptionSet, ownerFullName, personResponsible, screenSet, well);
    }
     ...
     */
    static initialize(obj, casingSet, companyOfPersonResponsible, decommissionDescriptionSet, linerperforationSet, lithologydescriptionSet, ownerFullName, personResponsible, screenSet, well) { 
        obj['casing_set'] = casingSet;
        obj['company_of_person_responsible'] = companyOfPersonResponsible;
        obj['decommission_description_set'] = decommissionDescriptionSet;
        obj['linerperforation_set'] = linerperforationSet;
        obj['lithologydescription_set'] = lithologydescriptionSet;
        obj['owner_full_name'] = ownerFullName;
        obj['person_responsible'] = personResponsible;
        obj['screen_set'] = screenSet;
        obj['well'] = well;
    }

    /**
     * Constructs a <code>WellDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WellDetail} obj Optional instance to populate.
     * @return {module:model/WellDetail} The populated <code>WellDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WellDetail();
            ...
            if (data.hasOwnProperty('casing_set')) {
                obj['casing_set'] = ApiClient.convertToType(data['casing_set'], [Casing]);
            }
            ...
            if (data.hasOwnProperty('company_of_person_responsible')) {
                obj['company_of_person_responsible'] = OrganizationNameList.constructFromObject(data['company_of_person_responsible']);
            }
            ...
            if (data.hasOwnProperty('decommission_description_set')) {
                obj['decommission_description_set'] = ApiClient.convertToType(data['decommission_description_set'], [DecommissionDescription]);
            }
            ...
            if (data.hasOwnProperty('linerperforation_set')) {
                obj['linerperforation_set'] = ApiClient.convertToType(data['linerperforation_set'], [LinerPerforation]);
            }
            if (data.hasOwnProperty('lithologydescription_set')) {
                obj['lithologydescription_set'] = ApiClient.convertToType(data['lithologydescription_set'], [LithologyDescription]);
            }
            ...
            if (data.hasOwnProperty('person_responsible')) {
                obj['person_responsible'] = PersonBasic.constructFromObject(data['person_responsible']);
            }
            ...
            if (data.hasOwnProperty('screen_set')) {
                obj['screen_set'] = ApiClient.convertToType(data['screen_set'], [Screen]);
            }
            ...
            if (data.hasOwnProperty('well')) {
                obj['well'] = ApiClient.convertToType(data['well'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WellDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WellDetail</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WellDetail.RequiredProperties) {
        ...
        if (data['casing_set']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['casing_set'])) {
                throw new Error("Expected the field `casing_set` to be an array in the JSON data but got " + data['casing_set']);
            }
            // validate the optional field `casing_set` (array)
            for (const item of data['casing_set']) {
                Casing.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        // validate the optional field `company_of_person_responsible`
        if (data['company_of_person_responsible']) { // data not null
          OrganizationNameList.validateJSON(data['company_of_person_responsible']);
        }
        // ensure the json data is a string
        ...
        if (data['decommission_description_set']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['decommission_description_set'])) {
                throw new Error("Expected the field `decommission_description_set` to be an array in the JSON data but got " + data['decommission_description_set']);
            }
            // validate the optional field `decommission_description_set` (array)
            for (const item of data['decommission_description_set']) {
                DecommissionDescription.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['linerperforation_set']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['linerperforation_set'])) {
                throw new Error("Expected the field `linerperforation_set` to be an array in the JSON data but got " + data['linerperforation_set']);
            }
            // validate the optional field `linerperforation_set` (array)
            for (const item of data['linerperforation_set']) {
                LinerPerforation.validateJSON(item);
            };
        }
        if (data['lithologydescription_set']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['lithologydescription_set'])) {
                throw new Error("Expected the field `lithologydescription_set` to be an array in the JSON data but got " + data['lithologydescription_set']);
            }
            // validate the optional field `lithologydescription_set` (array)
            for (const item of data['lithologydescription_set']) {
                LithologyDescription.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        // validate the optional field `person_responsible`
        if (data['person_responsible']) { // data not null
          PersonBasic.validateJSON(data['person_responsible']);
        }
        // ensure the json data is a string
        ...
        if (data['screen_set']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['screen_set'])) {
                throw new Error("Expected the field `screen_set` to be an array in the JSON data but got " + data['screen_set']);
            }
            // validate the optional field `screen_set` (array)
            for (const item of data['screen_set']) {
...
WellDetail.RequiredProperties = ["casing_set", "company_of_person_responsible", "decommission_description_set", "linerperforation_set", "lithologydescription_set", "owner_full_name", "person_responsible", "screen_set", "well"];

/**
 * @member {Date} alteration_end_date
 */
WellDetail.prototype['alteration_end_date'] = undefined;

/**
 * @member {Boolean} alternative_specs_submitted
 */
WellDetail.prototype['alternative_specs_submitted'] = undefined;

/**
 * @member {Number} analytic_solution_type
 */
WellDetail.prototype['analytic_solution_type'] = undefined;

/**
 * @member {Number} aquifer
 */
WellDetail.prototype['aquifer'] = undefined;

/**
 * @member {Number} aquifer_vulnerability_index
 */
WellDetail.prototype['aquifer_vulnerability_index'] = undefined;

/**
 * @member {Number} artesian_flow
 */
WellDetail.prototype['artesian_flow'] = undefined;

/**
 * @member {Number} artesian_pressure
 */
WellDetail.prototype['artesian_pressure'] = undefined;

/**
 * @member {Number} backfill_depth
 */
WellDetail.prototype['backfill_depth'] = undefined;

/**
 * @member {String} backfill_material
 */
WellDetail.prototype['backfill_material'] = undefined;

/**
 * @member {String} backfill_type
 */
WellDetail.prototype['backfill_type'] = undefined;

/**
 * @member {Number} bcgs_id
 */
WellDetail.prototype['bcgs_id'] = undefined;

/**
 * @member {Number} bedrock_depth
 */
WellDetail.prototype['bedrock_depth'] = undefined;

/**
 * @member {Number} boundary_effect
 */
WellDetail.prototype['boundary_effect'] = undefined;

/**
 * @member {Array.<module:model/Casing>} casing_set
 */
WellDetail.prototype['casing_set'] = undefined;

/**
 * @member {String} city
 */
WellDetail.prototype['city'] = undefined;

/**
 * @member {String} comments
 */
WellDetail.prototype['comments'] = undefined;

/**
 * @member {module:model/OrganizationNameList} company_of_person_responsible
 */
WellDetail.prototype['company_of_person_responsible'] = undefined;

/**
 * @member {Date} construction_end_date
 */
WellDetail.prototype['construction_end_date'] = undefined;

/**
 * @member {Date} construction_start_date
 */
WellDetail.prototype['construction_start_date'] = undefined;

/**
 * @member {String} coordinate_acquisition_code
 */
WellDetail.prototype['coordinate_acquisition_code'] = undefined;

/**
 * @member {Array.<module:model/DecommissionDescription>} decommission_description_set
 */
WellDetail.prototype['decommission_description_set'] = undefined;

/**
 * @member {String} decommission_details
 */
WellDetail.prototype['decommission_details'] = undefined;

/**
 * @member {Date} decommission_end_date
 */
WellDetail.prototype['decommission_end_date'] = undefined;

/**
 * @member {String} decommission_method
 */
WellDetail.prototype['decommission_method'] = undefined;

/**
 * @member {String} decommission_reason
 */
WellDetail.prototype['decommission_reason'] = undefined;

/**
 * @member {Date} decommission_start_date
 */
WellDetail.prototype['decommission_start_date'] = undefined;

/**
 * @member {Number} development_hours
 */
WellDetail.prototype['development_hours'] = undefined;

/**
 * @member {String} development_method
 */
WellDetail.prototype['development_method'] = undefined;

/**
 * @member {String} development_notes
 */
WellDetail.prototype['development_notes'] = undefined;

/**
 * @member {String} diameter
 */
WellDetail.prototype['diameter'] = undefined;

/**
 * @member {Number} drawdown
 */
WellDetail.prototype['drawdown'] = undefined;

/**
 * @member {String} drilling_company
 */
WellDetail.prototype['drilling_company'] = undefined;

/**
 * @member {String} drilling_method
 */
WellDetail.prototype['drilling_method'] = undefined;

/**
 * @member {String} ems
 */
WellDetail.prototype['ems'] = undefined;

/**
 * @member {Number} filter_pack_from
 */
WellDetail.prototype['filter_pack_from'] = undefined;

/**
 * @member {String} filter_pack_material
 */
WellDetail.prototype['filter_pack_material'] = undefined;

/**
 * @member {String} filter_pack_material_size
 */
WellDetail.prototype['filter_pack_material_size'] = undefined;

/**
 * @member {Number} filter_pack_thickness
 */
WellDetail.prototype['filter_pack_thickness'] = undefined;

/**
 * @member {Number} filter_pack_to
 */
WellDetail.prototype['filter_pack_to'] = undefined;

/**
 * @member {Number} final_casing_stick_up
 */
WellDetail.prototype['final_casing_stick_up'] = undefined;

/**
 * @member {Number} finished_well_depth
 */
WellDetail.prototype['finished_well_depth'] = undefined;

/**
 * @member {Number} ground_elevation
 */
WellDetail.prototype['ground_elevation'] = undefined;

/**
 * @member {String} ground_elevation_method
 */
WellDetail.prototype['ground_elevation_method'] = undefined;

/**
 * @member {String} hydraulic_conductivity
 */
WellDetail.prototype['hydraulic_conductivity'] = undefined;

/**
 * @member {Boolean} hydro_fracturing_performed
 */
WellDetail.prototype['hydro_fracturing_performed'] = undefined;

/**
 * @member {Number} hydro_fracturing_yield_increase
 */
WellDetail.prototype['hydro_fracturing_yield_increase'] = undefined;

/**
 * @member {String} id_plate_attached_by
 */
WellDetail.prototype['id_plate_attached_by'] = undefined;

/**
 * @member {Number} identification_plate_number
 */
WellDetail.prototype['identification_plate_number'] = undefined;

/**
 * @member {String} intended_water_use
 */
WellDetail.prototype['intended_water_use'] = undefined;

/**
 * @member {String} land_district
 */
WellDetail.prototype['land_district'] = undefined;

/**
 * @member {Number} latitude
 */
WellDetail.prototype['latitude'] = undefined;

/**
 * @member {String} legal_block
 */
WellDetail.prototype['legal_block'] = undefined;

/**
 * @member {String} legal_district_lot
 */
WellDetail.prototype['legal_district_lot'] = undefined;

/**
 * @member {String} legal_lot
 */
WellDetail.prototype['legal_lot'] = undefined;

/**
 * @member {Number} legal_pid
 */
WellDetail.prototype['legal_pid'] = undefined;

/**
 * @member {String} legal_plan
 */
WellDetail.prototype['legal_plan'] = undefined;

/**
 * @member {String} legal_range
 */
WellDetail.prototype['legal_range'] = undefined;

/**
 * @member {String} legal_section
 */
WellDetail.prototype['legal_section'] = undefined;

/**
 * @member {String} legal_township
 */
WellDetail.prototype['legal_township'] = undefined;

/**
 * @member {String} licenced_status
 */
WellDetail.prototype['licenced_status'] = undefined;

/**
 * @member {Number} liner_diameter
 */
WellDetail.prototype['liner_diameter'] = undefined;

/**
 * @member {Number} liner_from
 */
WellDetail.prototype['liner_from'] = undefined;

/**
 * @member {String} liner_material
 */
WellDetail.prototype['liner_material'] = undefined;

/**
 * @member {Number} liner_thickness
 */
WellDetail.prototype['liner_thickness'] = undefined;

/**
 * @member {Number} liner_to
 */
WellDetail.prototype['liner_to'] = undefined;

/**
 * @member {Array.<module:model/LinerPerforation>} linerperforation_set
 */
WellDetail.prototype['linerperforation_set'] = undefined;

/**
 * @member {Array.<module:model/LithologyDescription>} lithologydescription_set
 */
WellDetail.prototype['lithologydescription_set'] = undefined;

/**
 * @member {Number} longitude
 */
WellDetail.prototype['longitude'] = undefined;

/**
 * @member {String} observation_well_number
 */
WellDetail.prototype['observation_well_number'] = undefined;

/**
 * @member {String} observation_well_status
 */
WellDetail.prototype['observation_well_status'] = undefined;

/**
 * @member {String} other_drilling_method
 */
WellDetail.prototype['other_drilling_method'] = undefined;

/**
 * @member {String} other_screen_bottom
 */
WellDetail.prototype['other_screen_bottom'] = undefined;

/**
 * @member {String} other_screen_material
 */
WellDetail.prototype['other_screen_material'] = undefined;

/**
 * @member {String} owner_full_name
 */
WellDetail.prototype['owner_full_name'] = undefined;

/**
 * @member {module:model/PersonBasic} person_responsible
 */
WellDetail.prototype['person_responsible'] = undefined;

/**
 * @member {Number} recommended_pump_depth
 */
WellDetail.prototype['recommended_pump_depth'] = undefined;

/**
 * @member {Number} recommended_pump_rate
 */
WellDetail.prototype['recommended_pump_rate'] = undefined;

/**
 * @member {String} screen_bottom
 */
WellDetail.prototype['screen_bottom'] = undefined;

/**
 * @member {String} screen_information
 */
WellDetail.prototype['screen_information'] = undefined;

/**
 * @member {String} screen_intake_method
 */
WellDetail.prototype['screen_intake_method'] = undefined;

/**
 * @member {String} screen_material
 */
WellDetail.prototype['screen_material'] = undefined;

/**
 * @member {String} screen_opening
 */
WellDetail.prototype['screen_opening'] = undefined;

/**
 * @member {Array.<module:model/Screen>} screen_set
 */
WellDetail.prototype['screen_set'] = undefined;

/**
 * @member {String} screen_type
 */
WellDetail.prototype['screen_type'] = undefined;

/**
 * @member {String} sealant_material
 */
WellDetail.prototype['sealant_material'] = undefined;

/**
 * @member {String} specific_storage
 */
WellDetail.prototype['specific_storage'] = undefined;

/**
 * @member {Number} specific_yield
 */
WellDetail.prototype['specific_yield'] = undefined;

/**
 * @member {Number} static_level_before_test
 */
WellDetail.prototype['static_level_before_test'] = undefined;

/**
 * @member {Number} static_water_level
 */
WellDetail.prototype['static_water_level'] = undefined;

/**
 * @member {Number} storativity
 */
WellDetail.prototype['storativity'] = undefined;

/**
 * @member {String} street_address
 */
WellDetail.prototype['street_address'] = undefined;

/**
 * @member {Number} surface_seal_depth
 */
WellDetail.prototype['surface_seal_depth'] = undefined;

/**
 * @member {Number} surface_seal_length
 */
WellDetail.prototype['surface_seal_length'] = undefined;

/**
 * @member {String} surface_seal_material
 */
WellDetail.prototype['surface_seal_material'] = undefined;

/**
 * @member {String} surface_seal_method
 */
WellDetail.prototype['surface_seal_method'] = undefined;

/**
 * @member {Number} surface_seal_thickness
 */
WellDetail.prototype['surface_seal_thickness'] = undefined;

/**
 * @member {Number} testing_duration
 */
WellDetail.prototype['testing_duration'] = undefined;

/**
 * @member {String} testing_method
 */
WellDetail.prototype['testing_method'] = undefined;

/**
 * @member {Number} total_depth_drilled
 */
WellDetail.prototype['total_depth_drilled'] = undefined;

/**
 * @member {Number} transmissivity
 */
WellDetail.prototype['transmissivity'] = undefined;

/**
 * @member {Number} utm_easting
 */
WellDetail.prototype['utm_easting'] = undefined;

/**
 * @member {Number} utm_northing
 */
WellDetail.prototype['utm_northing'] = undefined;

/**
 * @member {String} utm_zone_code
 */
WellDetail.prototype['utm_zone_code'] = undefined;

/**
 * @member {Array.<String>} water_quality_characteristics
 */
WellDetail.prototype['water_quality_characteristics'] = undefined;

/**
 * @member {String} water_quality_colour
 */
WellDetail.prototype['water_quality_colour'] = undefined;

/**
 * @member {String} water_quality_odour
 */
WellDetail.prototype['water_quality_odour'] = undefined;

/**
 * @member {String} water_supply_system_name
 */
WellDetail.prototype['water_supply_system_name'] = undefined;

/**
 * @member {String} water_supply_system_well_name
 */
WellDetail.prototype['water_supply_system_well_name'] = undefined;

/**
 * @member {Number} well
 */
WellDetail.prototype['well'] = undefined;

/**
 * @member {String} well_cap_type
 */
WellDetail.prototype['well_cap_type'] = undefined;

/**
 * @member {String} well_class
 */
WellDetail.prototype['well_class'] = undefined;

/**
 * @member {Boolean} well_disinfected
 */
WellDetail.prototype['well_disinfected'] = undefined;

/**
 * @member {String} well_guid
 */
WellDetail.prototype['well_guid'] = undefined;

/**
 * @member {String} well_identification_plate_attached
 */
WellDetail.prototype['well_identification_plate_attached'] = undefined;

/**
 * @member {String} well_location_description
 */
WellDetail.prototype['well_location_description'] = undefined;

/**
 * @member {Boolean} well_orientation
 */
WellDetail.prototype['well_orientation'] = undefined;

/**
 * @member {String} well_status
 */
WellDetail.prototype['well_status'] = undefined;

/**
 * @member {String} well_subclass
 */
WellDetail.prototype['well_subclass'] = undefined;

/**
 * @member {Number} well_tag_number
 */
WellDetail.prototype['well_tag_number'] = undefined;

/**
 * @member {Number} well_yield
 */
WellDetail.prototype['well_yield'] = undefined;

/**
 * @member {String} well_yield_unit
 */
WellDetail.prototype['well_yield_unit'] = undefined;

/**
 * @member {Number} yield_estimation_duration
 */
WellDetail.prototype['yield_estimation_duration'] = undefined;

/**
 * @member {String} yield_estimation_method
 */
WellDetail.prototype['yield_estimation_method'] = undefined;

/**
 * @member {Number} yield_estimation_rate
 */
WellDetail.prototype['yield_estimation_rate'] = undefined;
