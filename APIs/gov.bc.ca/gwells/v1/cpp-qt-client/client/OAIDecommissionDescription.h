...
/*
 * OAIDecommissionDescription.h
 *
 * 
 */

#ifndef OAIDecommissionDescription_H
#define OAIDecommissionDescription_H
...
class OAIDecommissionDescription : public OAIObject {
public:
    OAIDecommissionDescription();
    OAIDecommissionDescription(QString json);
    ~OAIDecommissionDescription() override;
    ...
    void setObservations(const QString &observations);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDecommissionDescription)

#endif // OAIDecommissionDescription_H
