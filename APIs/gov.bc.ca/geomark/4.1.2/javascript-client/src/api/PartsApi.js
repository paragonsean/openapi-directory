...
export default class PartsApi {
    ...
    /**
    * Constructs a new PartsApi. 
    * @alias module:api/PartsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the geomarksGeomarkIdPartsFileFormatExtensionGet operation.
     * @callback module:api/PartsApi~geomarksGeomarkIdPartsFileFormatExtensionGetCallback
     ...
     * @param {module:api/PartsApi~geomarksGeomarkIdPartsFileFormatExtensionGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    geomarksGeomarkIdPartsFileFormatExtensionGet(geomarkId, fileFormatExtension, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'geomarkId' is set
      if (geomarkId === undefined || geomarkId === null) {
        throw new Error("Missing the required parameter 'geomarkId' when calling geomarksGeomarkIdPartsFileFormatExtensionGet");
      }
      // verify the required parameter 'fileFormatExtension' is set
      if (fileFormatExtension === undefined || fileFormatExtension === null) {
        throw new Error("Missing the required parameter 'fileFormatExtension' when calling geomarksGeomarkIdPartsFileFormatExtensionGet");
      }
