...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoMarkWebServiceRestApi.PointApi();
  });
  ...
  describe('PointApi', function() {
    describe('geomarksGeomarkIdPointFileFormatExtensionGet', function() {
      it('should call geomarksGeomarkIdPointFileFormatExtensionGet successfully', function(done) {
        //uncomment below and update the code to test geomarksGeomarkIdPointFileFormatExtensionGet
        //instance.geomarksGeomarkIdPointFileFormatExtensionGet(function(error) {
