...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoMarkWebServiceRestApi.InfoApi();
  });
  ...
  describe('InfoApi', function() {
    describe('geomarksGeomarkIdFileFormatExtensionGet', function() {
      it('should call geomarksGeomarkIdFileFormatExtensionGet successfully', function(done) {
        //uncomment below and update the code to test geomarksGeomarkIdFileFormatExtensionGet
        //instance.geomarksGeomarkIdFileFormatExtensionGet(function(error) {
