...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoMarkWebServiceRestApi.FeatureApi();
  });
  ...
  describe('FeatureApi', function() {
    describe('geomarksGeomarkIdFeatureFileFormatExtensionGet', function() {
      it('should call geomarksGeomarkIdFeatureFileFormatExtensionGet successfully', function(done) {
        //uncomment below and update the code to test geomarksGeomarkIdFeatureFileFormatExtensionGet
        //instance.geomarksGeomarkIdFeatureFileFormatExtensionGet(function(error) {
