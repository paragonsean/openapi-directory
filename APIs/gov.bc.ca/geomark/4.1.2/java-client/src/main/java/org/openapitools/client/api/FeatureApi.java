...
public class FeatureApi {
    ...
    /**
     * Build call for geomarksGeomarkIdFeatureFileFormatExtensionGet
     ...
     */
    public okhttp3.Call geomarksGeomarkIdFeatureFileFormatExtensionGetCall(String geomarkId, String fileFormatExtension, Integer srid, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/geomarks/{geomarkId}/feature.{fileFormatExtension}"
    ...
    private okhttp3.Call geomarksGeomarkIdFeatureFileFormatExtensionGetValidateBeforeCall(String geomarkId, String fileFormatExtension, Integer srid, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'geomarkId' is set
        if (geomarkId == null) {
            throw new ApiException("Missing the required parameter 'geomarkId' when calling geomarksGeomarkIdFeatureFileFormatExtensionGet(Async)");
        }

        // verify the required parameter 'fileFormatExtension' is set
        if (fileFormatExtension == null) {
            throw new ApiException("Missing the required parameter 'fileFormatExtension' when calling geomarksGeomarkIdFeatureFileFormatExtensionGet(Async)");
        }

        return geomarksGeomarkIdFeatureFileFormatExtensionGetCall(geomarkId, fileFormatExtension, srid, _callback);
     ...
     */
    public void geomarksGeomarkIdFeatureFileFormatExtensionGet(String geomarkId, String fileFormatExtension, Integer srid) throws ApiException {
        geomarksGeomarkIdFeatureFileFormatExtensionGetWithHttpInfo(geomarkId, fileFormatExtension, srid);
    }
     ...
     */
    public ApiResponse<Void> geomarksGeomarkIdFeatureFileFormatExtensionGetWithHttpInfo(String geomarkId, String fileFormatExtension, Integer srid) throws ApiException {
        okhttp3.Call localVarCall = geomarksGeomarkIdFeatureFileFormatExtensionGetValidateBeforeCall(geomarkId, fileFormatExtension, srid, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get the feature and attribution of the geomark (asynchronously)
     * The geomark feature resource returns a single spatial feature with either a single (Point, LineString, Polygon) or multi-part geometry (MultiPoint, MultiLineString, MultiPolygon) and the geomark attribution.  The geometry and attribution can be downloaded as a spatial download file format in a supported coordinate system. The download files can then be used in a desktop GIS application (e.g. ArcMap), Google Earth or a web mapping application.
     * @param geomarkId The unique identifier for the geomark (required)
     * @param fileFormatExtension The file format name extension used to represent the geomark download. (required)
     * @param srid The srid of the coordinate system the geometry should be converted to. (optional, default to 4326)
     ...
     */
    public okhttp3.Call geomarksGeomarkIdFeatureFileFormatExtensionGetAsync(String geomarkId, String fileFormatExtension, Integer srid, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = geomarksGeomarkIdFeatureFileFormatExtensionGetValidateBeforeCall(geomarkId, fileFormatExtension, srid, _callback);
