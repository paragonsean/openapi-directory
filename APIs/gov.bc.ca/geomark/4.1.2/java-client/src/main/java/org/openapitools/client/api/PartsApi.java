...
public class PartsApi {
    ...
    /**
     * Build call for geomarksGeomarkIdPartsFileFormatExtensionGet
     ...
     */
    public okhttp3.Call geomarksGeomarkIdPartsFileFormatExtensionGetCall(String geomarkId, String fileFormatExtension, Integer srid, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/geomarks/{geomarkId}/parts.{fileFormatExtension}"
    ...
    private okhttp3.Call geomarksGeomarkIdPartsFileFormatExtensionGetValidateBeforeCall(String geomarkId, String fileFormatExtension, Integer srid, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'geomarkId' is set
        if (geomarkId == null) {
            throw new ApiException("Missing the required parameter 'geomarkId' when calling geomarksGeomarkIdPartsFileFormatExtensionGet(Async)");
        }

        // verify the required parameter 'fileFormatExtension' is set
        if (fileFormatExtension == null) {
            throw new ApiException("Missing the required parameter 'fileFormatExtension' when calling geomarksGeomarkIdPartsFileFormatExtensionGet(Async)");
        }

        return geomarksGeomarkIdPartsFileFormatExtensionGetCall(geomarkId, fileFormatExtension, srid, _callback);
     ...
     */
    public void geomarksGeomarkIdPartsFileFormatExtensionGet(String geomarkId, String fileFormatExtension, Integer srid) throws ApiException {
        geomarksGeomarkIdPartsFileFormatExtensionGetWithHttpInfo(geomarkId, fileFormatExtension, srid);
    }
     ...
     */
    public ApiResponse<Void> geomarksGeomarkIdPartsFileFormatExtensionGetWithHttpInfo(String geomarkId, String fileFormatExtension, Integer srid) throws ApiException {
        okhttp3.Call localVarCall = geomarksGeomarkIdPartsFileFormatExtensionGetValidateBeforeCall(geomarkId, fileFormatExtension, srid, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get the individual geometries within a multi-part geometry (asynchronously)
     * The geomark parts resource returns a one or more spatial features. One for each part of the Geomark&#39;s geomerty. Each part contains a single (Point, LineString, Polygon) geometry and the geomark attribution.
     * @param geomarkId The unique identifier for the geomark (required)
     * @param fileFormatExtension The file format name extension used to represent the geomark download. (required)
     * @param srid The srid of the coordinate system the geometry should be converted to. (optional, default to 4326)
     ...
     */
    public okhttp3.Call geomarksGeomarkIdPartsFileFormatExtensionGetAsync(String geomarkId, String fileFormatExtension, Integer srid, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = geomarksGeomarkIdPartsFileFormatExtensionGetValidateBeforeCall(geomarkId, fileFormatExtension, srid, _callback);
