...
public class FeatureApiTest {
     ...
     */
    @Test
    public void geomarksGeomarkIdFeatureFileFormatExtensionGetTest() throws ApiException {
        String geomarkId = null;
        String fileFormatExtension = null;
        Integer srid = null;
        api.geomarksGeomarkIdFeatureFileFormatExtensionGet(geomarkId, fileFormatExtension, srid);
