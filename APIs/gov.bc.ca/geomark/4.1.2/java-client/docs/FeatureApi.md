...
<a id="geomarksGeomarkIdFeatureFileFormatExtensionGet"></a>
# **geomarksGeomarkIdFeatureFileFormatExtensionGet**
> geomarksGeomarkIdFeatureFileFormatExtensionGet(geomarkId, fileFormatExtension, srid)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.geomarksGeomarkIdFeatureFileFormatExtensionGet(geomarkId, fileFormatExtension, srid);
    } catch (ApiException e) {
      System.err.println("Exception when calling FeatureApi#geomarksGeomarkIdFeatureFileFormatExtensionGet");
