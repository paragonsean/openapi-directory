...
public class ApiClient {
    ...
    private String basePath = "https://catalogue.data.gov.bc.ca/api/3";
    ...
    public ApiClient() {
        ...
        authentications.put("githubAccessCode", new OAuth());
        authentications.put("internalApiKey", new ApiKeyAuth("header", "ckan_api_key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://catalogue.data.gov.bc.ca/api/3
