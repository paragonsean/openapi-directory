...
def info_from_githubAccessCode(token: str) -> dict:
    """
...
def validate_scope_githubAccessCode(required_scopes: List[str], token_scopes: List[str]) -> bool:
    """ Validate required scopes are included in token scope """
    return set(required_scopes).issubset(set(token_scopes))


def info_from_internalApiKey(api_key: str, required_scopes: None) -> dict:
    """
