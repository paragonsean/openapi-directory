...
/**
* Occupants service.
* @module api/OccupantsApi
* @version 2.0.0
*/
export default class OccupantsApi {

    /**
    * Constructs a new OccupantsApi. 
    * @alias module:api/OccupantsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the occupantsAddressesOutputFormatGet operation.
     * @callback module:api/OccupantsApi~occupantsAddressesOutputFormatGetCallback
     ...
     * @param {Boolean} [echo = false)] If true, include unmatched address details such as site name in results.
     ...
     * @param {String} [matchPrecision = 'OCCUPANT')] Example: street,locality.  A comma separated list of individual match precision levels to include in results. See <a href=https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#matchPrecision target=\"_blank\">matchPrecision</a>
     ...
     * @param {module:api/OccupantsApi~occupantsAddressesOutputFormatGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    occupantsAddressesOutputFormatGet(outputFormat, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'outputFormat' is set
      if (outputFormat === undefined || outputFormat === null) {
        throw new Error("Missing the required parameter 'outputFormat' when calling occupantsAddressesOutputFormatGet");
      }
    ...
    /**
     * Callback function to receive the result of the occupantsNearOutputFormatGet operation.
     * @callback module:api/OccupantsApi~occupantsNearOutputFormatGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Boolean} [brief = false)] If true, include only basic match and address details in results. Not supported for shp, csv, and gml formats.
     * @param {Number} [setBack = 0)] The distance to move the accessPoint away from the curb and towards the inside of the parcel (in metres). Ignored if locationDescriptor not set to accessPoint.
     * @param {module:api/OccupantsApi~occupantsNearOutputFormatGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    occupantsNearOutputFormatGet(outputFormat, point, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'outputFormat' is set
      if (outputFormat === undefined || outputFormat === null) {
        throw new Error("Missing the required parameter 'outputFormat' when calling occupantsNearOutputFormatGet");
      }
      // verify the required parameter 'point' is set
      if (point === undefined || point === null) {
        throw new Error("Missing the required parameter 'point' when calling occupantsNearOutputFormatGet");
      }
    ...
    /**
     * Callback function to receive the result of the occupantsNearestOutputFormatGet operation.
     * @callback module:api/OccupantsApi~occupantsNearestOutputFormatGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Boolean} [brief = false)] If true, include only basic match and address details in results. Not supported for shp, csv, and gml formats.
     * @param {Number} [setBack = 0)] The distance to move the accessPoint away from the curb and towards the inside of the parcel (in metres). Ignored if locationDescriptor not set to accessPoint.
     * @param {module:api/OccupantsApi~occupantsNearestOutputFormatGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    occupantsNearestOutputFormatGet(outputFormat, point, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'outputFormat' is set
      if (outputFormat === undefined || outputFormat === null) {
        throw new Error("Missing the required parameter 'outputFormat' when calling occupantsNearestOutputFormatGet");
      }
      // verify the required parameter 'point' is set
      if (point === undefined || point === null) {
        throw new Error("Missing the required parameter 'point' when calling occupantsNearestOutputFormatGet");
      }
    ...
    /**
     * Callback function to receive the result of the occupantsOccupantIDOutputFormatGet operation.
     * @callback module:api/OccupantsApi~occupantsOccupantIDOutputFormatGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Boolean} [brief = false)] If true, include only basic match and address details in results. Not supported for shp, csv, and gml formats.
     * @param {Number} [setBack = 0)] The distance to move the accessPoint away from the curb and towards the inside of the parcel (in metres). Ignored if locationDescriptor not set to accessPoint.
     * @param {module:api/OccupantsApi~occupantsOccupantIDOutputFormatGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    occupantsOccupantIDOutputFormatGet(occupantID, outputFormat, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'occupantID' is set
      if (occupantID === undefined || occupantID === null) {
        throw new Error("Missing the required parameter 'occupantID' when calling occupantsOccupantIDOutputFormatGet");
      }
      // verify the required parameter 'outputFormat' is set
      if (outputFormat === undefined || outputFormat === null) {
        throw new Error("Missing the required parameter 'outputFormat' when calling occupantsOccupantIDOutputFormatGet");
      }
    ...
    /**
     * Callback function to receive the result of the occupantsWithinOutputFormatGet operation.
     * @callback module:api/OccupantsApi~occupantsWithinOutputFormatGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [tags] Example: schools;courts;employment<br>A list of tags separated by semicolons.
     * @param {module:model/Number} [outputSRS = 4326)] The EPSG code of the spatial reference system (SRS) to use for output geometries. See <a href=https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#outputSRS target=\"_blank\">outputSRS</a>
     * @param {Number} [maxResults = 200)] The maximum number of search results to return.
     * @param {module:model/String} [locationDescriptor = 'any')] Describes the nature of the address location. See <a href=https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#locationDescriptor target=\"_blank\">locationDescriptor</a>
     * @param {Boolean} [brief = false)] If true, include only basic match and address details in results. Not supported for shp, csv, and gml formats.
     * @param {Number} [setBack = 0)] The distance to move the accessPoint away from the curb and towards the inside of the parcel (in metres). Ignored if locationDescriptor not set to accessPoint.
     * @param {module:api/OccupantsApi~occupantsWithinOutputFormatGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    occupantsWithinOutputFormatGet(outputFormat, bbox, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'outputFormat' is set
      if (outputFormat === undefined || outputFormat === null) {
        throw new Error("Missing the required parameter 'outputFormat' when calling occupantsWithinOutputFormatGet");
      }
      // verify the required parameter 'bbox' is set
      if (bbox === undefined || bbox === null) {
        throw new Error("Missing the required parameter 'bbox' when calling occupantsWithinOutputFormatGet");
      }
