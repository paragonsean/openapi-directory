...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeocoderRestApi.ParcelsApi();
  });
  ...
  describe('ParcelsApi', function() {
    describe('parcelsPidsSiteIDOutputFormatGet', function() {
      it('should call parcelsPidsSiteIDOutputFormatGet successfully', function(done) {
        //uncomment below and update the code to test parcelsPidsSiteIDOutputFormatGet
        //instance.parcelsPidsSiteIDOutputFormatGet(function(error) {
