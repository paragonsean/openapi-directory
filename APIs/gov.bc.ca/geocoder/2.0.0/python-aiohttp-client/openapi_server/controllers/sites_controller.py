...
async def sites_near_output_format_get(request: web.Request, output_format, point, max_distance=None, output_srs=None, max_results=None, location_descriptor=None, set_back=None, brief=None, exclude_units=None, only_civic=None) -> web.Response:
    ...
    :param output_format: Results format. See &lt;a href&#x3D;https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#outputFormat target&#x3D;\&quot;_blank\&quot;&gt;outputFormat&lt;/a&gt;.   Note: GeoJSON and KML formats only support EPSG:4326 (outputSRS&#x3D;4326)
    :type output_format: str
    :param point: The point (x,y) from which the nearby sites will be identified. The coordinates must be specified in the same SRS as given by the &#39;outputSRS&#39; parameter.
    :type point: str
    :param max_distance: The maximum distance (in metres) to search from the given point.  If not specified, the search distance is unlimited.
    ...
    :param brief: If true, include only basic match and address details in results. Not supported for shp, csv, and gml formats.
    :type brief: bool
    :param exclude_units: If true, excludes sites that are units of a parent site
    :type exclude_units: bool
    :param only_civic: If true, excludes sites without a civic address
    :type only_civic: bool

    """
    return web.Response(status=200)


async def sites_nearest_output_format_get(request: web.Request, output_format, point, max_distance=None, output_srs=None, location_descriptor=None, set_back=None, brief=None, exclude_units=None, only_civic=None) -> web.Response:
    ...
    :param output_format: Results format. See &lt;a href&#x3D;https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#outputFormat target&#x3D;\&quot;_blank\&quot;&gt;outputFormat&lt;/a&gt;.   Note: GeoJSON and KML formats only support EPSG:4326 (outputSRS&#x3D;4326)
    :type output_format: str
    :param point: Centre point of search. See &lt;a href&#x3D;https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#point target&#x3D;\&quot;_blank\&quot;&gt;point&lt;/a&gt;
    :type point: str
    :param max_distance: The maximum distance (in metres) to search from the given point.  If not specified, the search distance is unlimited.
    :type max_distance: int
    :param output_srs: The EPSG code of the spatial reference system (SRS) to use for output geometries. See &lt;a href&#x3D;https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#outputSRS target&#x3D;\&quot;_blank\&quot;&gt;outputSRS&lt;/a&gt;
...
async def sites_site_id_output_format_get(request: web.Request, site_id, output_format, output_srs=None, location_descriptor=None, brief=None, set_back=None) -> web.Response:
...
async def sites_site_id_subsites_output_format_get(request: web.Request, site_id, output_format, output_srs=None, location_descriptor=None, brief=None, set_back=None) -> web.Response:
...
async def sites_within_output_format_get(request: web.Request, output_format, bbox, output_srs=None, max_results=None, location_descriptor=None, set_back=None, brief=None, exclude_units=None, only_civic=None) -> web.Response:
