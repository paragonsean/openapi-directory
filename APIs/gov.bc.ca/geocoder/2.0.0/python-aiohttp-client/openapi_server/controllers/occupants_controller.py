...
async def occupants_addresses_output_format_get(request: web.Request, output_format, address_string=None, tags=None, location_descriptor=None, max_results=None, interpolation=None, echo=None, brief=None, auto_complete=None, set_back=None, output_srs=None, min_score=None, match_precision=None, match_precision_not=None, site_name=None, unit_designator=None, unit_number=None, unit_number_suffix=None, civic_number=None, civic_number_suffix=None, street_name=None, street_type=None, street_direction=None, street_qualifier=None, locality_name=None, province_code=None, localities=None, not_localities=None, bbox=None, centre=None, max_distance=None, extrapolate=None, parcel_point=None) -> web.Response:
    ...
    :param address_string: Occupant name OR Occupant name ** address
    :type address_string: str
    :param tags: Example: schools;courts;employment&lt;br&gt;A list of tags separated by semicolons.
    :type tags: str
    ...
    :param street_qualifier: The qualifier of a street name (e.g., the Bridge in Johnson St Bridge)
    :type street_qualifier: str
    :param locality_name: The name of the locality assigned to a given site by an address authority. See &lt;a href&#x3D;https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#streetDirection target&#x3D;\&quot;_blank\&quot;&gt;streetDirection&lt;/a&gt;
...
async def occupants_near_output_format_get(request: web.Request, output_format, point, tags=None, max_distance=None, output_srs=None, max_results=None, location_descriptor=None, brief=None, set_back=None) -> web.Response:
...
async def occupants_nearest_output_format_get(request: web.Request, output_format, point, max_distance=None, tags=None, output_srs=None, location_descriptor=None, brief=None, set_back=None) -> web.Response:
...
async def occupants_occupant_id_output_format_get(request: web.Request, occupant_id, output_format, output_srs=None, location_descriptor=None, brief=None, set_back=None) -> web.Response:
    """Get an occupant (of a site) by its unique ID

    Represents an individual occupant

    :param occupant_id: Occupant identifier
    :type occupant_id: str
    :param output_format: Results format. See &lt;a href&#x3D;https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#outputFormat target&#x3D;\&quot;_blank\&quot;&gt;outputFormat&lt;/a&gt;.   Note: GeoJSON and KML formats only support EPSG:4326 (outputSRS&#x3D;4326)
    :type output_format: str
    :param output_srs: The EPSG code of the spatial reference system (SRS) to use for output geometries. See &lt;a href&#x3D;https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#outputSRS target&#x3D;\&quot;_blank\&quot;&gt;outputSRS&lt;/a&gt;
    :type output_srs: int
...
async def occupants_within_output_format_get(request: web.Request, output_format, bbox, tags=None, output_srs=None, max_results=None, location_descriptor=None, brief=None, set_back=None) -> web.Response:
