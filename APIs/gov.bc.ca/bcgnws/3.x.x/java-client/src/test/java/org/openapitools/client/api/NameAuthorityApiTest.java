...
/**
 * API tests for NameAuthorityApi
 */
@Disabled
public class NameAuthorityApiTest {

    private final NameAuthorityApi api = new NameAuthorityApi();
     ...
     */
    @Test
    public void nameAuthoritiesGetTest() throws ApiException {
        String outputFormat = null;
        api.nameAuthoritiesGet(outputFormat);
