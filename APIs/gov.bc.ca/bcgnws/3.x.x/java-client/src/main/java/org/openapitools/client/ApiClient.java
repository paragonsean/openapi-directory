...
public class ApiClient {
    ...
    private String basePath = "https://apps.gov.bc.ca/pub/bcgnws";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/3.x.x/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apps.gov.bc.ca/pub/bcgnws
