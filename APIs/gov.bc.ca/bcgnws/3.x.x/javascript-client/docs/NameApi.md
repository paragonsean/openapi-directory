# BcGeographicalNamesWebServiceRestApi.NameApi
...
> namesChangesGet_0(outputFormat, fromDate, toDate, opts)
...
let apiInstance = new BcGeographicalNamesWebServiceRestApi.NameApi();
...
apiInstance.namesChangesGet_0(outputFormat, fromDate, toDate, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> namesDecisionsRecentGet_0(outputFormat, days, opts)
...
apiInstance.namesDecisionsRecentGet_0(outputFormat, days, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> namesDecisionsYearGet_0(outputFormat, year, opts)
...
apiInstance.namesDecisionsYearGet_0(outputFormat, year, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> namesInsideGet_0(outputFormat, bbox, opts)
...
apiInstance.namesInsideGet_0(outputFormat, bbox, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new BcGeographicalNamesWebServiceRestApi.NameApi();
let nameId = 22474; // Number | The unique identifier for a name
let outputFormat = "json"; // String | The format of the output.
apiInstance.namesNameIdOutputFormatGet(nameId, outputFormat, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **nameId** | **Number**| The unique identifier for a name | 
 **outputFormat** | **String**| The format of the output. | [default to &#39;json&#39;]
...
> namesNearGet_0(outputFormat, featurePoint, distance, opts)
...
apiInstance.namesNearGet_0(outputFormat, featurePoint, distance, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> namesNotOfficialSearchGet_0(outputFormat, name, opts)
...
apiInstance.namesNotOfficialSearchGet_0(outputFormat, name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> namesOfficialSearchGet_0(outputFormat, name, opts)
...
apiInstance.namesOfficialSearchGet_0(outputFormat, name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> namesSearchGet_0(outputFormat, name, opts)
...
apiInstance.namesSearchGet_0(outputFormat, name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
