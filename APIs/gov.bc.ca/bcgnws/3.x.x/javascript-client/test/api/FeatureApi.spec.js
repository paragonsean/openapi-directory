...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BcGeographicalNamesWebServiceRestApi.FeatureApi();
  });
  ...
  describe('FeatureApi', function() {
    describe('featuresFeatureIdGet', function() {
      it('should call featuresFeatureIdGet successfully', function(done) {
        //uncomment below and update the code to test featuresFeatureIdGet
        //instance.featuresFeatureIdGet(function(error) {
