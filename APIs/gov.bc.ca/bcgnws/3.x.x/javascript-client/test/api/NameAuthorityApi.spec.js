...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BcGeographicalNamesWebServiceRestApi.NameAuthorityApi();
  });
  ...
  describe('NameAuthorityApi', function() {
    describe('nameAuthoritiesGet', function() {
      it('should call nameAuthoritiesGet successfully', function(done) {
        //uncomment below and update the code to test nameAuthoritiesGet
        //instance.nameAuthoritiesGet(function(error) {
