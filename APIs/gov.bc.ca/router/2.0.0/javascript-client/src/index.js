...
* <pre>
* var BcRoutePlannerRestApi = require('index'); // See note below*.
* var xxxSvc = new BcRoutePlannerRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new BcRoutePlannerRestApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new BcRoutePlannerRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new BcRoutePlannerRestApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    */
    ...
    /**
    * The DistanceApi service constructor.
    * @property {module:api/DistanceApi}
    */
    DistanceApi,
