...
(function(root, factory) {
  ...
  describe('Crew', function() {
    it('should create an instance of Crew', function() {
      // uncomment below and update the code to test Crew
      //var instance = new Shinobiapi.Crew();
      //expect(instance).to.be.a(Shinobiapi.Crew);
    });
