...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Shinobiapi.BandInfoExtended();
  });
  ...
  describe('BandInfoExtended', function() {
    it('should create an instance of BandInfoExtended', function() {
      // uncomment below and update the code to test BandInfoExtended
      //var instance = new Shinobiapi.BandInfoExtended();
      //expect(instance).to.be.a(Shinobiapi.BandInfoExtended);
    });
