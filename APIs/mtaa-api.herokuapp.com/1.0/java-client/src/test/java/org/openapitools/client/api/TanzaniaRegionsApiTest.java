...
/**
 * API tests for TanzaniaRegionsApi
 */
@Disabled
public class TanzaniaRegionsApiTest {

    private final TanzaniaRegionsApi api = new TanzaniaRegionsApi();
     ...
     */
    @Test
    public void tanzaniaRegionsTest() throws ApiException {
        String country = null;
        api.tanzaniaRegions(country);
