...
|------------ | ------------- | ------------- | -------------|
|**cid** | **Integer** | E-UTRA Cell Identifier (UC-Id), 28 bits (20 bits eNodeB and 8 bits Cell ID). MCC + MNC + CID uniquely identifies the LTE cell, TAC is optional.  |  |
...
|**nmr** | [**List&lt;LteNmr&gt;**](LteNmr.md) | LTE Network measurements |  [optional] |
...
|**ta** | **Integer** | Timing Advance. Expressed in the units of 16*Ts (16 Basic time units) &#x3D; 16/(15000*2048) seconds ~ 156meters. For reference see 3GPP TS 36.213 and 36.211.  |  [optional] |
|**tac** | **Integer** | Tracking Area Code (TAC) |  [optional] |
