...
|------------ | ------------- | ------------- | -------------|
|**firmware** | **String** | Device firmware version information |  [optional] |
...
|**platform** | **String** | Software platform information of the device, for example operating system name and version. |  [optional] |
