...
public class CdmaNmr {
  ...
  public CdmaNmr bsid(Integer bsid) {
    this.bsid = bsid;
    return this;
  }
  ...
  public CdmaNmr channel(Integer channel) {
  ...
  public CdmaNmr pilotPower(Integer pilotPower) {
  ...
  public CdmaNmr pnOffset(Integer pnOffset) {
  ...
  public boolean equals(Object o) {
    ...
    CdmaNmr cdmaNmr = (CdmaNmr) o;
    return Objects.equals(this.bsid, cdmaNmr.bsid) &&
        Objects.equals(this.channel, cdmaNmr.channel) &&
        Objects.equals(this.pilotPower, cdmaNmr.pilotPower) &&
        Objects.equals(this.pnOffset, cdmaNmr.pnOffset);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bsid, channel, pilotPower, pnOffset);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CdmaNmr {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CdmaNmr
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CdmaNmr.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CdmaNmr is not found in the empty JSON string", CdmaNmr.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CdmaNmr.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CdmaNmr` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CdmaNmr.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CdmaNmr.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CdmaNmr' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CdmaNmr> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CdmaNmr.class));

       return (TypeAdapter<T>) new TypeAdapter<CdmaNmr>() {
           @Override
           public void write(JsonWriter out, CdmaNmr value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CdmaNmr read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CdmaNmr given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CdmaNmr
   * @throws IOException if the JSON string is invalid with respect to CdmaNmr
   */
  public static CdmaNmr fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CdmaNmr.class);
  }

  /**
   * Convert an instance of CdmaNmr to an JSON string
   *
   * @return JSON string
   */
