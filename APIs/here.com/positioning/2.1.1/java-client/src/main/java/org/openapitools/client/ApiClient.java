...
public class ApiClient {
    ...
    private String basePath = "https://positioning.hereapi.com/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("AccessToken", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://positioning.hereapi.com/v2
