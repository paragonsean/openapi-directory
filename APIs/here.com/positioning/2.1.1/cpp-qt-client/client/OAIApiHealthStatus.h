...
/*
 * OAIApiHealthStatus.h
 *
 * 
 */

#ifndef OAIApiHealthStatus_H
#define OAIApiHealthStatus_H
...
class OAIApiHealthStatus : public OAIObject {
public:
    OAIApiHealthStatus();
    OAIApiHealthStatus(QString json);
    ~OAIApiHealthStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApiHealthStatus)

#endif // OAIApiHealthStatus_H
