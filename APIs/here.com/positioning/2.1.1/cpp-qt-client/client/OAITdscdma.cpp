...
OAITdscdma::OAITdscdma(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITdscdma::OAITdscdma() {
    this->initializeModel();
}

OAITdscdma::~OAITdscdma() {}

void OAITdscdma::initializeModel() {
...
void OAITdscdma::fromJson(QString jsonString) {
...
void OAITdscdma::fromJsonObject(QJsonObject json) {
...
QString OAITdscdma::asJson() const {
...
QJsonObject OAITdscdma::asJsonObject() const {
    QJsonObject obj;
    if (m_cid_isSet) {
...
qint32 OAITdscdma::getCid() const {
    return m_cid;
}
void OAITdscdma::setCid(const qint32 &cid) {
    m_cid = cid;
    m_cid_isSet = true;
}

bool OAITdscdma::is_cid_Set() const{
    return m_cid_isSet;
}

bool OAITdscdma::is_cid_Valid() const{
    return m_cid_isValid;
}

qint32 OAITdscdma::getLac() const {
    return m_lac;
}
void OAITdscdma::setLac(const qint32 &lac) {
    m_lac = lac;
    m_lac_isSet = true;
}

bool OAITdscdma::is_lac_Set() const{
    return m_lac_isSet;
}

bool OAITdscdma::is_lac_Valid() const{
    return m_lac_isValid;
}

OAITdscdmaLocalId OAITdscdma::getLocalId() const {
    return m_local_id;
}
void OAITdscdma::setLocalId(const OAITdscdmaLocalId &local_id) {
    m_local_id = local_id;
    m_local_id_isSet = true;
}

bool OAITdscdma::is_local_id_Set() const{
    return m_local_id_isSet;
}

bool OAITdscdma::is_local_id_Valid() const{
    return m_local_id_isValid;
}

qint32 OAITdscdma::getMcc() const {
    return m_mcc;
}
void OAITdscdma::setMcc(const qint32 &mcc) {
    m_mcc = mcc;
    m_mcc_isSet = true;
}

bool OAITdscdma::is_mcc_Set() const{
    return m_mcc_isSet;
}

bool OAITdscdma::is_mcc_Valid() const{
    return m_mcc_isValid;
}

qint32 OAITdscdma::getMnc() const {
    return m_mnc;
}
void OAITdscdma::setMnc(const qint32 &mnc) {
    m_mnc = mnc;
    m_mnc_isSet = true;
}

bool OAITdscdma::is_mnc_Set() const{
    return m_mnc_isSet;
}

bool OAITdscdma::is_mnc_Valid() const{
    return m_mnc_isValid;
}

QList<OAITdscdmaNmr> OAITdscdma::getNmr() const {
    return m_nmr;
}
void OAITdscdma::setNmr(const QList<OAITdscdmaNmr> &nmr) {
    m_nmr = nmr;
    m_nmr_isSet = true;
}

bool OAITdscdma::is_nmr_Set() const{
    return m_nmr_isSet;
}

bool OAITdscdma::is_nmr_Valid() const{
    return m_nmr_isValid;
}

qint32 OAITdscdma::getPathloss() const {
    return m_pathloss;
}
void OAITdscdma::setPathloss(const qint32 &pathloss) {
    m_pathloss = pathloss;
    m_pathloss_isSet = true;
}

bool OAITdscdma::is_pathloss_Set() const{
    return m_pathloss_isSet;
}

bool OAITdscdma::is_pathloss_Valid() const{
    return m_pathloss_isValid;
}

qint32 OAITdscdma::getRscp() const {
    return m_rscp;
}
void OAITdscdma::setRscp(const qint32 &rscp) {
    m_rscp = rscp;
    m_rscp_isSet = true;
}

bool OAITdscdma::is_rscp_Set() const{
    return m_rscp_isSet;
}

bool OAITdscdma::is_rscp_Valid() const{
    return m_rscp_isValid;
}

qint32 OAITdscdma::getTa() const {
    return m_ta;
}
void OAITdscdma::setTa(const qint32 &ta) {
    m_ta = ta;
    m_ta_isSet = true;
}

bool OAITdscdma::is_ta_Set() const{
    return m_ta_isSet;
}

bool OAITdscdma::is_ta_Valid() const{
    return m_ta_isValid;
}

bool OAITdscdma::isSet() const {
