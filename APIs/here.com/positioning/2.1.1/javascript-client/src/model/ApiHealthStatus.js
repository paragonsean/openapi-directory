...
/**
 * The ApiHealthStatus model module.
 * @module model/ApiHealthStatus
 * @version 2.1.1
 */
class ApiHealthStatus {
    /**
     * Constructs a new <code>ApiHealthStatus</code>.
     * @alias module:model/ApiHealthStatus
     */
    constructor() { 
        
        ApiHealthStatus.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiHealthStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiHealthStatus} obj Optional instance to populate.
     * @return {module:model/ApiHealthStatus} The populated <code>ApiHealthStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiHealthStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiHealthStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiHealthStatus</code>.
     */
 ...
 */
ApiHealthStatus.prototype['status'] = undefined;
