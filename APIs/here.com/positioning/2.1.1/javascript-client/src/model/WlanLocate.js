...
/**
 * The WlanLocate model module.
 * @module model/WlanLocate
 * @version 2.1.1
 */
class WlanLocate {
    /**
     * Constructs a new <code>WlanLocate</code>.
     * WLAN measurement
     * @alias module:model/WlanLocate
     * @param mac {String} The MAC address of the WLAN access point. MAC-48 address with colon (:) or hyphen (-) separators, upper or lower case hex digits. Note that if the SSID contains postfix \"_nomap\", the AP should not be used for positioning. 
     */
    constructor(mac) { 
        
        WlanLocate.initialize(this, mac);
    }
    ...
    /**
     * Constructs a <code>WlanLocate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WlanLocate} obj Optional instance to populate.
     * @return {module:model/WlanLocate} The populated <code>WlanLocate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WlanLocate();
    ...
    /**
     * Validates the JSON data with respect to <code>WlanLocate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WlanLocate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WlanLocate.RequiredProperties) {
...
WlanLocate.RequiredProperties = ["mac"];
 ...
 * @member {String} mac
 */
WlanLocate.prototype['mac'] = undefined;

/**
 * Received signal level (dBm) at the terminal
 * @member {Number} rss
 */
WlanLocate.prototype['rss'] = undefined;
