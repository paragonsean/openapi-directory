...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.CdmaNmr();
  });
  ...
  describe('CdmaNmr', function() {
    it('should create an instance of CdmaNmr', function() {
      // uncomment below and update the code to test CdmaNmr
      //var instance = new HereNetworkPositioningApiV2.CdmaNmr();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.CdmaNmr);
    });
    ...
    it('should have the property pnOffset (base name: "pnOffset")', function() {
      // uncomment below and update the code to test the property pnOffset
      //var instance = new HereNetworkPositioningApiV2.CdmaNmr();
      //expect(instance).to.be();
    });
