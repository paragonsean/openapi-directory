...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.ApiVersion();
  });
  ...
  describe('ApiVersion', function() {
    it('should create an instance of ApiVersion', function() {
      ...
      //var instance = new HereNetworkPositioningApiV2.ApiVersion();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.ApiVersion);
    });
