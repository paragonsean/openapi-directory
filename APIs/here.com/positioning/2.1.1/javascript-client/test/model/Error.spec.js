...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.Error();
  });
  ...
  describe('Error', function() {
    it('should create an instance of Error', function() {
      ...
      //var instance = new HereNetworkPositioningApiV2.Error();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.Error);
    });
