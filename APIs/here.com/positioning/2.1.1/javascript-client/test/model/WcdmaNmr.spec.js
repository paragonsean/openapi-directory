...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.WcdmaNmr();
  });
  ...
  describe('WcdmaNmr', function() {
    it('should create an instance of WcdmaNmr', function() {
      // uncomment below and update the code to test WcdmaNmr
      //var instance = new HereNetworkPositioningApiV2.WcdmaNmr();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.WcdmaNmr);
    });
