...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.LteNmr();
  });
  ...
  describe('LteNmr', function() {
    it('should create an instance of LteNmr', function() {
      // uncomment below and update the code to test LteNmr
      //var instance = new HereNetworkPositioningApiV2.LteNmr();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.LteNmr);
    });
    ...
    it('should have the property earfcn (base name: "earfcn")', function() {
      // uncomment below and update the code to test the property earfcn
      //var instance = new HereNetworkPositioningApiV2.LteNmr();
      //expect(instance).to.be();
    });
