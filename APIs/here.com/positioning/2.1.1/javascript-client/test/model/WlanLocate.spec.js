...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.WlanLocate();
  });
  ...
  describe('WlanLocate', function() {
    it('should create an instance of WlanLocate', function() {
      // uncomment below and update the code to test WlanLocate
      //var instance = new HereNetworkPositioningApiV2.WlanLocate();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.WlanLocate);
    });
