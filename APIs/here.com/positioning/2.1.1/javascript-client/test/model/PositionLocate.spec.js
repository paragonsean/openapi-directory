...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.PositionLocate();
  });
  ...
  describe('PositionLocate', function() {
    it('should create an instance of PositionLocate', function() {
      // uncomment below and update the code to test PositionLocate
      //var instance = new HereNetworkPositioningApiV2.PositionLocate();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.PositionLocate);
    });
    ...
    it('should have the property altAccuracy (base name: "altAccuracy")', function() {
      // uncomment below and update the code to test the property altAccuracy
      //var instance = new HereNetworkPositioningApiV2.PositionLocate();
      //expect(instance).to.be();
    });
