...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.ApiHealthStatus();
  });
  ...
  describe('ApiHealthStatus', function() {
    it('should create an instance of ApiHealthStatus', function() {
      // uncomment below and update the code to test ApiHealthStatus
      //var instance = new HereNetworkPositioningApiV2.ApiHealthStatus();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.ApiHealthStatus);
    });
