...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.Gsm();
  });
  ...
  describe('Gsm', function() {
    it('should create an instance of Gsm', function() {
      // uncomment below and update the code to test Gsm
      //var instance = new HereNetworkPositioningApiV2.Gsm();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.Gsm);
    });
