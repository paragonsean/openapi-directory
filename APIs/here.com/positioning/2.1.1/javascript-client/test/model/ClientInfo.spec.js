...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.ClientInfo();
  });
  ...
  describe('ClientInfo', function() {
    it('should create an instance of ClientInfo', function() {
      // uncomment below and update the code to test ClientInfo
      //var instance = new HereNetworkPositioningApiV2.ClientInfo();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.ClientInfo);
    });
