...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.AuthError();
  });
  ...
  describe('AuthError', function() {
    it('should create an instance of AuthError', function() {
      ...
      //var instance = new HereNetworkPositioningApiV2.AuthError();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.AuthError);
    });
