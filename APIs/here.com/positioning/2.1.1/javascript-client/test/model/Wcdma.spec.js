...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.Wcdma();
  });
  ...
  describe('Wcdma', function() {
    it('should create an instance of Wcdma', function() {
      // uncomment below and update the code to test Wcdma
      //var instance = new HereNetworkPositioningApiV2.Wcdma();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.Wcdma);
    });
