...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.ErrorDetail();
  });
  ...
  describe('ErrorDetail', function() {
    it('should create an instance of ErrorDetail', function() {
      ...
      //var instance = new HereNetworkPositioningApiV2.ErrorDetail();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.ErrorDetail);
    });
    ...
    it('should have the property messagePlaceholders (base name: "messagePlaceholders")', function() {
      // uncomment below and update the code to test the property messagePlaceholders
      //var instance = new HereNetworkPositioningApiV2.ErrorDetail();
      //expect(instance).to.be();
    });
