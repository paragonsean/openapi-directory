...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.TdscdmaLocalId();
  });
  ...
  describe('TdscdmaLocalId', function() {
    it('should create an instance of TdscdmaLocalId', function() {
      // uncomment below and update the code to test TdscdmaLocalId
      //var instance = new HereNetworkPositioningApiV2.TdscdmaLocalId();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.TdscdmaLocalId);
    });
