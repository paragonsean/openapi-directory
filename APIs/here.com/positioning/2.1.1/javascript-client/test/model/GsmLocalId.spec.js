...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.GsmLocalId();
  });
  ...
  describe('GsmLocalId', function() {
    it('should create an instance of GsmLocalId', function() {
      ...
      //var instance = new HereNetworkPositioningApiV2.GsmLocalId();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.GsmLocalId);
    });
