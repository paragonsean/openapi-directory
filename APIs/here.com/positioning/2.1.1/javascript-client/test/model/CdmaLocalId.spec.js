...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.CdmaLocalId();
  });
  ...
  describe('CdmaLocalId', function() {
    it('should create an instance of CdmaLocalId', function() {
      // uncomment below and update the code to test CdmaLocalId
      //var instance = new HereNetworkPositioningApiV2.CdmaLocalId();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.CdmaLocalId);
    });
