...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.LteLocalId();
  });
  ...
  describe('LteLocalId', function() {
    it('should create an instance of LteLocalId', function() {
      ...
      //var instance = new HereNetworkPositioningApiV2.LteLocalId();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.LteLocalId);
    });
