...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.TdscdmaNmr();
  });
  ...
  describe('TdscdmaNmr', function() {
    it('should create an instance of TdscdmaNmr', function() {
      // uncomment below and update the code to test TdscdmaNmr
      //var instance = new HereNetworkPositioningApiV2.TdscdmaNmr();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.TdscdmaNmr);
    });
