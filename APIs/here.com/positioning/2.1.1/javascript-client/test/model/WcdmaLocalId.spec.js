...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.WcdmaLocalId();
  });
  ...
  describe('WcdmaLocalId', function() {
    it('should create an instance of WcdmaLocalId', function() {
      // uncomment below and update the code to test WcdmaLocalId
      //var instance = new HereNetworkPositioningApiV2.WcdmaLocalId();
      //expect(instance).to.be.a(HereNetworkPositioningApiV2.WcdmaLocalId);
    });

    it('should have the property psc (base name: "psc")', function() {
      // uncomment below and update the code to test the property psc
      //var instance = new HereNetworkPositioningApiV2.WcdmaLocalId();
      //expect(instance).to.be();
    });

    it('should have the property uarfcndl (base name: "uarfcndl")', function() {
      // uncomment below and update the code to test the property uarfcndl
      //var instance = new HereNetworkPositioningApiV2.WcdmaLocalId();
      //expect(instance).to.be();
    });
