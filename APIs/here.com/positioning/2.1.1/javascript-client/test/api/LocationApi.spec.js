...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.LocationApi();
  });
  ...
  describe('LocationApi', function() {
    describe('postLocate', function() {
      it('should call postLocate successfully', function(done) {
        //uncomment below and update the code to test postLocate
        //instance.postLocate(function(error) {
