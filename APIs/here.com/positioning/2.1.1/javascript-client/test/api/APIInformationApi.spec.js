...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HereNetworkPositioningApiV2.APIInformationApi();
  });
  ...
  describe('APIInformationApi', function() {
    describe('getApiVersion', function() {
      it('should call getApiVersion successfully', function(done) {
        //uncomment below and update the code to test getApiVersion
        //instance.getApiVersion(function(error) {
