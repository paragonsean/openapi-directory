...
/*
 * OAIEnumCheckResultManualStatus.h
 *
...
#ifndef OAIEnumCheckResultManualStatus_H
#define OAIEnumCheckResultManualStatus_H
...
class OAIEnumCheckResultManualStatus : public OAIEnum {
public:
    OAIEnumCheckResultManualStatus();
    OAIEnumCheckResultManualStatus(QString json);
    ~OAIEnumCheckResultManualStatus() override;
    ...
    enum class eOAIEnumCheckResultManualStatus {
    ...
    OAIEnumCheckResultManualStatus::eOAIEnumCheckResultManualStatus getValue() const;
    void setValue(const OAIEnumCheckResultManualStatus::eOAIEnumCheckResultManualStatus& value);
...
private:
    ...
    eOAIEnumCheckResultManualStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnumCheckResultManualStatus)

#endif // OAIEnumCheckResultManualStatus_H
