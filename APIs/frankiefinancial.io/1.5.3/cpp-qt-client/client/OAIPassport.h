...
#ifndef OAIPassport_H
#define OAIPassport_H
...
class OAIPassport : public OAIObject {
public:
    OAIPassport();
    OAIPassport(QString json);
    ~OAIPassport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPassport)
