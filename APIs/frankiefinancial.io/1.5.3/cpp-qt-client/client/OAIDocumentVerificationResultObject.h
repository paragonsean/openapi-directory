...
/*
 * OAIDocumentVerificationResultObject.h
 *
 * Contains the details of a check on a given data point
 */

#ifndef OAIDocumentVerificationResultObject_H
#define OAIDocumentVerificationResultObject_H
...
class OAIDocumentVerificationResultObject : public OAIObject {
public:
    OAIDocumentVerificationResultObject();
    OAIDocumentVerificationResultObject(QString json);
    ~OAIDocumentVerificationResultObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentVerificationResultObject)

#endif // OAIDocumentVerificationResultObject_H
