...
/*
 * OAIEntityIDVDetailsObject.h
 *
 * Contains all the details we need to create/update an entity and generate an IDV token 
 */

#ifndef OAIEntityIDVDetailsObject_H
#define OAIEntityIDVDetailsObject_H
...
class OAIEntityIDVDetailsObject : public OAIObject {
public:
    OAIEntityIDVDetailsObject();
    OAIEntityIDVDetailsObject(QString json);
    ~OAIEntityIDVDetailsObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityIDVDetailsObject)

#endif // OAIEntityIDVDetailsObject_H
