...
#ifndef OAISwitchError_H
#define OAISwitchError_H
...
class OAISwitchError : public OAIObject {
public:
    OAISwitchError();
    OAISwitchError(QString json);
    ~OAISwitchError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISwitchError)

#endif // OAISwitchError_H
