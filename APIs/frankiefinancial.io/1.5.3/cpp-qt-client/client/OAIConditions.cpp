...
QString OAIConditions::getName() const {
    return m_name;
}
void OAIConditions::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIConditions::is_name_Set() const{
    return m_name_isSet;
}

bool OAIConditions::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAINameValue> OAIConditions::getValue() const {
    return m_value;
}
void OAIConditions::setValue(const QList<OAINameValue> &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIConditions::is_value_Set() const{
    return m_value_isSet;
}

bool OAIConditions::is_value_Valid() const{
