...
/*
 * OAIBusinessReportResultObject.h
 *
 * The positive result of a report generation request if any. 
 */

#ifndef OAIBusinessReportResultObject_H
#define OAIBusinessReportResultObject_H
...
class OAIBusinessReportResultObject : public OAIObject {
public:
    OAIBusinessReportResultObject();
    OAIBusinessReportResultObject(QString json);
    ~OAIBusinessReportResultObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBusinessReportResultObject)

#endif // OAIBusinessReportResultObject_H
