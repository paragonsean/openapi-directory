...
/*
 * OAIEntityResultObject.h
 *
 * Contains the results of a given document entity create/update or GET request.
 */

#ifndef OAIEntityResultObject_H
#define OAIEntityResultObject_H
...
class OAIEntityResultObject : public OAIObject {
public:
    OAIEntityResultObject();
    OAIEntityResultObject(QString json);
    ~OAIEntityResultObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityResultObject)

#endif // OAIEntityResultObject_H
