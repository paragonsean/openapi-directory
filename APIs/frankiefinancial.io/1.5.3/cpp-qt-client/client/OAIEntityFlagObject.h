...
#ifndef OAIEntityFlagObject_H
#define OAIEntityFlagObject_H
...
class OAIEntityFlagObject : public OAIObject {
public:
    OAIEntityFlagObject();
    OAIEntityFlagObject(QString json);
    ~OAIEntityFlagObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityFlagObject)

#endif // OAIEntityFlagObject_H
