...
/*
 * OAIComparisonError.h
 *
 * 
 */

#ifndef OAIComparisonError_H
#define OAIComparisonError_H
...
class OAIComparisonError : public OAIObject {
public:
    OAIComparisonError();
    OAIComparisonError(QString json);
    ~OAIComparisonError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComparisonError)

#endif // OAIComparisonError_H
