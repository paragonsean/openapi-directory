...
/*
 * OAIEnumScanDataRetrievalState.h
 *
...
#ifndef OAIEnumScanDataRetrievalState_H
#define OAIEnumScanDataRetrievalState_H
...
class OAIEnumScanDataRetrievalState : public OAIEnum {
public:
    OAIEnumScanDataRetrievalState();
    OAIEnumScanDataRetrievalState(QString json);
    ~OAIEnumScanDataRetrievalState() override;
    ...
    enum class eOAIEnumScanDataRetrievalState {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NORMAL, 
        EXCLUDED, 
        FAILED
    };
    OAIEnumScanDataRetrievalState::eOAIEnumScanDataRetrievalState getValue() const;
    void setValue(const OAIEnumScanDataRetrievalState::eOAIEnumScanDataRetrievalState& value);
...
private:
    ...
    eOAIEnumScanDataRetrievalState m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnumScanDataRetrievalState)

#endif // OAIEnumScanDataRetrievalState_H
