...
/*
 * OAIMercantileEnquiry.h
 *
 * 
 */

#ifndef OAIMercantileEnquiry_H
#define OAIMercantileEnquiry_H
...
class OAIMercantileEnquiry : public OAIObject {
public:
    OAIMercantileEnquiry();
    OAIMercantileEnquiry(QString json);
    ~OAIMercantileEnquiry() override;
    ...
    QDateTime getRegisteredDate() const;
    void setRegisteredDate(const QDateTime &registered_date);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMercantileEnquiry)

#endif // OAIMercantileEnquiry_H
