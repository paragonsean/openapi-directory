...
#ifndef OAIAddressLineDTO_H
#define OAIAddressLineDTO_H
...
class OAIAddressLineDTO : public OAIObject {
public:
    OAIAddressLineDTO();
    OAIAddressLineDTO(QString json);
    ~OAIAddressLineDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddressLineDTO)

#endif // OAIAddressLineDTO_H
