...
#ifndef OAIEICRequest_H
#define OAIEICRequest_H
...
class OAIEICRequest : public OAIObject {
public:
    OAIEICRequest();
    OAIEICRequest(QString json);
    ~OAIEICRequest() override;
    ...
    OAIEICDetails getDetails() const;
    void setDetails(const OAIEICDetails &details);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEICRequest)

#endif // OAIEICRequest_H
