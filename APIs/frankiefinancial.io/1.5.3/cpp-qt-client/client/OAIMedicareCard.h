...
#ifndef OAIMedicareCard_H
#define OAIMedicareCard_H
...
class OAIMedicareCard : public OAIObject {
public:
    OAIMedicareCard();
    OAIMedicareCard(QString json);
    ~OAIMedicareCard() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMedicareCard)

#endif // OAIMedicareCard_H
