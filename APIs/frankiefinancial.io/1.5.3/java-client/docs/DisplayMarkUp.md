...
|------------ | ------------- | ------------- | -------------|
|**attribute** | [**AttributeEnum**](#AttributeEnum) | Comma seperated list of attributes to apply to value when rendering. |  [optional] |
...
|**parameters** | [**Map&lt;String, DisplayMarkUpParametersValue&gt;**](DisplayMarkUpParametersValue.md) | Optional element which has a keyvalue pair associated with every data binding contained in the value element of the current object. |  [optional] |
|**type** | [**TypeEnum**](#TypeEnum) | Type of component to be used for rendering |  [optional] |
