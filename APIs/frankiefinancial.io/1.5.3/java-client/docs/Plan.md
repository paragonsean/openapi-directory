...
|**estimatedBaseCost** | **BigDecimal** | Estimated cost of this plan, based on the usage from the uploaded bill, with no conditional discounts applied. If this plan offers no conditional discounts the estimatedTotalCost and the estimatedBaseCost will be the same. |  |
|**estimatedSaving** | **BigDecimal** | The estimated saving the customer could have realised if they had been on this plan during the billing period |  |
|**estimatedTotalCost** | **BigDecimal** | Estimated cost of this plan, based on the usage from uploaded bill, with all conditional discounts applied. |  |
|**feesAndCharges** | [**Fees**](Fees.md) |  |  [optional] |
|**greenOptions** | [**NameValue**](NameValue.md) |  |  [optional] |
|**id** | **Integer** | Unique identifier for this plan. This ID is passed when calling the switch API. |  |
...
|**type** | [**TypeEnum**](#TypeEnum) | The type of energy plan * &#x60;SR&#x60; - Single Rate * &#x60;TOU&#x60; - Time Of Use |  |
