 ...
 */
@JsonAdapter(EnumAddressType.Adapter.class)
public enum EnumAddressType {
  ...
  public static EnumAddressType fromValue(String value) {
    for (EnumAddressType b : EnumAddressType.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumAddressType> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumAddressType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumAddressType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumAddressType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EnumAddressType.fromValue(value);
  }
}
