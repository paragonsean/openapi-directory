...
import org.openapitools.client.model.NameValueUnit;
...
public class Rates {
  ...
  private List<NameValueUnit> value = new ArrayList<>();

  public Rates() {
  }

  public Rates name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Rates value(List<NameValueUnit> value) {
    this.value = value;
    return this;
  }

  public Rates addValueItem(NameValueUnit valueItem) {
    if (this.value == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<NameValueUnit> getValue() {
    return value;
  }

  public void setValue(List<NameValueUnit> value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    Rates rates = (Rates) o;
    return Objects.equals(this.name, rates.name) &&
        Objects.equals(this.value, rates.value);
  }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ...
        if (jsonArrayvalue != null) {
          ...
          for (int i = 0; i < jsonArrayvalue.size(); i++) {
            NameValueUnit.validateJsonElement(jsonArrayvalue.get(i));
          };
        }
      }
  }
