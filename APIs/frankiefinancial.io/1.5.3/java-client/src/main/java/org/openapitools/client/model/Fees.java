...
import org.openapitools.client.model.NameValueDescription;
...
public class Fees {
  public static final String SERIALIZED_NAME_ADDITIONAL_FEE_INFO = "additionalFeeInfo";
  @SerializedName(SERIALIZED_NAME_ADDITIONAL_FEE_INFO)
  private String additionalFeeInfo;
  ...
  private List<NameValueDescription> value = new ArrayList<>();

  public Fees() {
  }

  public Fees additionalFeeInfo(String additionalFeeInfo) {
  ...
  public String getAdditionalFeeInfo() {
    return additionalFeeInfo;
  }

  public void setAdditionalFeeInfo(String additionalFeeInfo) {
    this.additionalFeeInfo = additionalFeeInfo;
  }


  public Fees name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Fees value(List<NameValueDescription> value) {
    this.value = value;
    return this;
  }

  public Fees addValueItem(NameValueDescription valueItem) {
    if (this.value == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<NameValueDescription> getValue() {
    return value;
  }

  public void setValue(List<NameValueDescription> value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    Fees fees = (Fees) o;
    return Objects.equals(this.additionalFeeInfo, fees.additionalFeeInfo) &&
        Objects.equals(this.name, fees.name) &&
        Objects.equals(this.value, fees.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(additionalFeeInfo, name, value);
  }
  ...
  public String toString() {
    ...
    sb.append("    additionalFeeInfo: ").append(toIndentedString(additionalFeeInfo)).append("\n");
  ...
  static {
    ...
    openapiFields.add("additionalFeeInfo");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("additionalFeeInfo") != null && !jsonObj.get("additionalFeeInfo").isJsonNull()) && !jsonObj.get("additionalFeeInfo").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `additionalFeeInfo` to be a primitive type in the JSON string but got `%s`", jsonObj.get("additionalFeeInfo").toString()));
      }
      ...
      for (int i = 0; i < jsonArrayvalue.size(); i++) {
        NameValueDescription.validateJsonElement(jsonArrayvalue.get(i));
      };
  }
