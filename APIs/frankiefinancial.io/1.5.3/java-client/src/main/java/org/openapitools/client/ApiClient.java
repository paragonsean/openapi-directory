...
public class ApiClient {
    ...
    private String basePath = "https://api.demo.frankiefinancial.io/compliance/v1.2";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.5.3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.demo.frankiefinancial.io/compliance/v1.2
