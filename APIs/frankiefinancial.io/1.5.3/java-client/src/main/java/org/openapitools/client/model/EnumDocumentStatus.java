 ...
 */
@JsonAdapter(EnumDocumentStatus.Adapter.class)
public enum EnumDocumentStatus {
  ...
  EnumDocumentStatus(String value) {
    this.value = value;
  }
  ...
  public static EnumDocumentStatus fromValue(String value) {
    for (EnumDocumentStatus b : EnumDocumentStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumDocumentStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumDocumentStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumDocumentStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumDocumentStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EnumDocumentStatus.fromValue(value);
  }
}
