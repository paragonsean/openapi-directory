...
public class RetrieveApiTest {
     ...
     */
    @Test
    public void retrieveResultTest() throws ApiException {
        UUID xFrankieCustomerID = null;
        String requestId = null;
        UUID xFrankieCustomerChildID = null;
        String payload = null;
        RetrievedResponseObject response = api.retrieveResult(xFrankieCustomerID, requestId, xFrankieCustomerChildID, payload);
