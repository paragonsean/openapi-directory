# FrankieFinancialApi.ErrorObject
...
**httpStatusCode** | **Number** | Deprecated: HTTP status code. Same as that which is passed back in the header.  | [optional] 
**issues** | [**[ErrorObjectIssuesInner]**](ErrorObjectIssuesInner.md) |  | [optional] 
