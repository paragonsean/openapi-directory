# FrankieFinancialApi.BusinessReportResponseDetails

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**checkId** | **String** | Unique identifier for the report operation.  | [optional] 
**entity** | [**EntityObject**](EntityObject.md) |  | [optional] 
**reports** | [**[BusinessReportResponseObject]**](BusinessReportResponseObject.md) | The collection of requested business reports.  | [optional] 
