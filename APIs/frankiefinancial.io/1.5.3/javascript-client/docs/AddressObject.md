# FrankieFinancialApi.AddressObject

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**addressId** | **String** | As addresses are added to an entity, they&#39;re assigned an id to assist with tracking.   If you&#39;re adjusting an address, you will need to include the addressId so as to be able to reference it correctly in the list.  | [optional] 
**addressType** | [**EnumAddressType**](EnumAddressType.md) |  | [optional] 
...
**endDate** | **Date** | The date this address was no longer used (if available). Used mostly with business addresses.  | [optional] 
...
**startDate** | **Date** | The date this address first because active. Used mostly with business addresses.  | [optional] 
