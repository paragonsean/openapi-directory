...
/**
 * The DOBObject model module.
 * @module model/DOBObject
 * @version 1.5.3
 */
class DOBObject {
    /**
     * Constructs a new <code>DOBObject</code>.
     * @alias module:model/DOBObject
     */
    constructor() { 
        
        DOBObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DOBObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DOBObject} obj Optional instance to populate.
     * @return {module:model/DOBObject} The populated <code>DOBObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DOBObject();
    ...
    /**
     * Validates the JSON data with respect to <code>DOBObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DOBObject</code>.
     */
