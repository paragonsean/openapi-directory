...
import NameValueUnit from './NameValueUnit';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('value')) {
                obj['value'] = ApiClient.convertToType(data['value'], [NameValueUnit]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['value']) { // data not null
            ...
            for (const item of data['value']) {
                NameValueUnit.validateJSON(item);
            };
        }
 ...
 * @member {String} name
 */
Rates.prototype['name'] = undefined;

/**
 * Rates for this plan
 * @member {Array.<module:model/NameValueUnit>} value
 */
Rates.prototype['value'] = undefined;
