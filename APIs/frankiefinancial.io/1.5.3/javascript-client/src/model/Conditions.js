...
class Conditions {
     ...
     * @param name {String} 
     * @param value {Array.<module:model/NameValue>} 
     */
    constructor(name, value) { 
        
        Conditions.initialize(this, name, value);
    }
...
Conditions.RequiredProperties = ["name", "value"];

/**
 * @member {String} name
 */
Conditions.prototype['name'] = undefined;

/**
 * @member {Array.<module:model/NameValue>} value
 */
Conditions.prototype['value'] = undefined;
