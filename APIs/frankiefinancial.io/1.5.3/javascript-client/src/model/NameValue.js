...
class NameValue {
    ...
    constructor(name, value) { 
        ...
        NameValue.initialize(this, name, value);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NameValue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NameValue</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NameValue.RequiredProperties) {
...
NameValue.RequiredProperties = ["name", "value"];
