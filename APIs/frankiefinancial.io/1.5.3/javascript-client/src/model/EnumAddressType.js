...
* @readonly
*/
export default class EnumAddressType {
    ...
    /**
    * Returns a <code>EnumAddressType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EnumAddressType} The enum <code>EnumAddressType</code> value.
    */
