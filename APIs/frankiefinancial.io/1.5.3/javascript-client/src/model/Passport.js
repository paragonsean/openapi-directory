...
class Passport {
     ...
     * @param country {String} Country of Issue
     * @param number {String} Passport Number
     * @param type {module:model/Passport.TypeEnum} Document identifier
     */
    constructor(country, number, type) { 
        
        Passport.initialize(this, country, number, type);
    }
     ...
     */
    static initialize(obj, country, number, type) { 
        obj['country'] = country;
        obj['number'] = number;
        obj['type'] = type;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Passport</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Passport</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Passport.RequiredProperties) {
...
Passport.RequiredProperties = ["country", "number", "type"];

/**
 * Country of Issue
 * @member {String} country
 */
Passport.prototype['country'] = undefined;

/**
 * Expiry date of passport
 * @member {String} expiryDate
 */
Passport.prototype['expiryDate'] = undefined;
...
/**
 * Document identifier
 * @member {module:model/Passport.TypeEnum} type
 */
Passport.prototype['type'] = undefined;
