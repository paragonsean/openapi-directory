...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.demo.frankiefinancial.io/compliance/v1.2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.demo.frankiefinancial.io/compliance/v1.2
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.5.3/Javascript'
        };
