...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.SuppliedData();
  });
  ...
  describe('SuppliedData', function() {
    it('should create an instance of SuppliedData', function() {
      // uncomment below and update the code to test SuppliedData
      //var instance = new FrankieFinancialApi.SuppliedData();
      //expect(instance).to.be.a(FrankieFinancialApi.SuppliedData);
    });
