...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.EICRequest();
  });
  ...
  describe('EICRequest', function() {
    it('should create an instance of EICRequest', function() {
      // uncomment below and update the code to test EICRequest
      //var instance = new FrankieFinancialApi.EICRequest();
      //expect(instance).to.be.a(FrankieFinancialApi.EICRequest);
    });
