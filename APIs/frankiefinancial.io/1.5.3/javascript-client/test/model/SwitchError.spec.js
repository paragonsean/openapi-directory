...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.SwitchError();
  });
  ...
  describe('SwitchError', function() {
    it('should create an instance of SwitchError', function() {
      // uncomment below and update the code to test SwitchError
      //var instance = new FrankieFinancialApi.SwitchError();
      //expect(instance).to.be.a(FrankieFinancialApi.SwitchError);
    });
