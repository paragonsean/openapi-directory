...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.EntityObject();
  });
  ...
  describe('EntityObject', function() {
    it('should create an instance of EntityObject', function() {
      ...
      //var instance = new FrankieFinancialApi.EntityObject();
      //expect(instance).to.be.a(FrankieFinancialApi.EntityObject);
    });
    ...
    it('should have the property entityProfile (base name: "entityProfile")', function() {
      // uncomment below and update the code to test the property entityProfile
      //var instance = new FrankieFinancialApi.EntityObject();
      //expect(instance).to.be();
    });
    ...
    it('should have the property identityDocs (base name: "identityDocs")', function() {
      // uncomment below and update the code to test the property identityDocs
      //var instance = new FrankieFinancialApi.EntityObject();
      //expect(instance).to.be();
    });
    ...
    it('should have the property organisationData (base name: "organisationData")', function() {
      // uncomment below and update the code to test the property organisationData
      //var instance = new FrankieFinancialApi.EntityObject();
      //expect(instance).to.be();
    });
