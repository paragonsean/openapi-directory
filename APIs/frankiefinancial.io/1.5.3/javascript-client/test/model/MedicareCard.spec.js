...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.MedicareCard();
  });
  ...
  describe('MedicareCard', function() {
    it('should create an instance of MedicareCard', function() {
      // uncomment below and update the code to test MedicareCard
      //var instance = new FrankieFinancialApi.MedicareCard();
      //expect(instance).to.be.a(FrankieFinancialApi.MedicareCard);
    });
