...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.EICError();
  });
  ...
  describe('EICError', function() {
    it('should create an instance of EICError', function() {
      // uncomment below and update the code to test EICError
      //var instance = new FrankieFinancialApi.EICError();
      //expect(instance).to.be.a(FrankieFinancialApi.EICError);
    });
