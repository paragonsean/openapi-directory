...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.EntityProfileItemMatchResultObject();
  });
  ...
  describe('EntityProfileItemMatchResultObject', function() {
    it('should create an instance of EntityProfileItemMatchResultObject', function() {
      // uncomment below and update the code to test EntityProfileItemMatchResultObject
      //var instance = new FrankieFinancialApi.EntityProfileItemMatchResultObject();
      //expect(instance).to.be.a(FrankieFinancialApi.EntityProfileItemMatchResultObject);
    });
