...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.SwitchRequest();
  });
  ...
  describe('SwitchRequest', function() {
    it('should create an instance of SwitchRequest', function() {
      // uncomment below and update the code to test SwitchRequest
      //var instance = new FrankieFinancialApi.SwitchRequest();
      //expect(instance).to.be.a(FrankieFinancialApi.SwitchRequest);
    });
