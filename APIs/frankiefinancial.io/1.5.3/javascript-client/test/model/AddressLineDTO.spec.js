...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.AddressLineDTO();
  });
  ...
  describe('AddressLineDTO', function() {
    it('should create an instance of AddressLineDTO', function() {
      // uncomment below and update the code to test AddressLineDTO
      //var instance = new FrankieFinancialApi.AddressLineDTO();
      //expect(instance).to.be.a(FrankieFinancialApi.AddressLineDTO);
    });
