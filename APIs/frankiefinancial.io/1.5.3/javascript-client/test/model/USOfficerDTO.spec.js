...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.USOfficerDTO();
  });
  ...
  describe('USOfficerDTO', function() {
    it('should create an instance of USOfficerDTO', function() {
      // uncomment below and update the code to test USOfficerDTO
      //var instance = new FrankieFinancialApi.USOfficerDTO();
      //expect(instance).to.be.a(FrankieFinancialApi.USOfficerDTO);
    });
