...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.PersonalNameObject();
  });
  ...
  describe('PersonalNameObject', function() {
    it('should create an instance of PersonalNameObject', function() {
      // uncomment below and update the code to test PersonalNameObject
      //var instance = new FrankieFinancialApi.PersonalNameObject();
      //expect(instance).to.be.a(FrankieFinancialApi.PersonalNameObject);
    });
    ...
    it('should have the property honourific (base name: "honourific")', function() {
      // uncomment below and update the code to test the property honourific
      //var instance = new FrankieFinancialApi.PersonalNameObject();
      //expect(instance).to.be();
    });
