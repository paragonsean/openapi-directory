...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.DOBObject();
  });
  ...
  describe('DOBObject', function() {
    it('should create an instance of DOBObject', function() {
      // uncomment below and update the code to test DOBObject
      //var instance = new FrankieFinancialApi.DOBObject();
      //expect(instance).to.be.a(FrankieFinancialApi.DOBObject);
    });
