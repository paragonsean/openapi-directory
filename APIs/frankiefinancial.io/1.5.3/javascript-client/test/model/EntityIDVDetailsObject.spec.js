...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.EntityIDVDetailsObject();
  });
  ...
  describe('EntityIDVDetailsObject', function() {
    it('should create an instance of EntityIDVDetailsObject', function() {
      // uncomment below and update the code to test EntityIDVDetailsObject
      //var instance = new FrankieFinancialApi.EntityIDVDetailsObject();
      //expect(instance).to.be.a(FrankieFinancialApi.EntityIDVDetailsObject);
    });
