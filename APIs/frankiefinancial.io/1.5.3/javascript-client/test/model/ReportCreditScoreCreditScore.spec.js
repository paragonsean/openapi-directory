...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.ReportCreditScoreCreditScore();
  });
  ...
  describe('ReportCreditScoreCreditScore', function() {
    it('should create an instance of ReportCreditScoreCreditScore', function() {
      // uncomment below and update the code to test ReportCreditScoreCreditScore
      //var instance = new FrankieFinancialApi.ReportCreditScoreCreditScore();
      //expect(instance).to.be.a(FrankieFinancialApi.ReportCreditScoreCreditScore);
    });
