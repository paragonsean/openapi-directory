...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.DisplayMarkUp();
  });
  ...
  describe('DisplayMarkUp', function() {
    it('should create an instance of DisplayMarkUp', function() {
      // uncomment below and update the code to test DisplayMarkUp
      //var instance = new FrankieFinancialApi.DisplayMarkUp();
      //expect(instance).to.be.a(FrankieFinancialApi.DisplayMarkUp);
    });
