...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrankieFinancialApi.SwitchDetailsCustomerDetailsName();
  });
  ...
  describe('SwitchDetailsCustomerDetailsName', function() {
    it('should create an instance of SwitchDetailsCustomerDetailsName', function() {
      // uncomment below and update the code to test SwitchDetailsCustomerDetailsName
      //var instance = new FrankieFinancialApi.SwitchDetailsCustomerDetailsName();
      //expect(instance).to.be.a(FrankieFinancialApi.SwitchDetailsCustomerDetailsName);
    });
