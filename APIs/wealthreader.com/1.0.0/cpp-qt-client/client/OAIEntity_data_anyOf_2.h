...
/*
 * OAIEntity_data_anyOf_2.h
 *
 * 
 */

#ifndef OAIEntity_data_anyOf_2_H
#define OAIEntity_data_anyOf_2_H
...
class OAIEntity_data_anyOf_2 : public OAIObject {
public:
    OAIEntity_data_anyOf_2();
    OAIEntity_data_anyOf_2(QString json);
    ~OAIEntity_data_anyOf_2() override;
    ...
    QList<QJsonValue> getCards() const;
    void setCards(const QList<QJsonValue> &cards);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntity_data_anyOf_2)

#endif // OAIEntity_data_anyOf_2_H
