...
OAIContracts::OAIContracts(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIContracts::OAIContracts() {
    this->initializeModel();
}

OAIContracts::~OAIContracts() {}

void OAIContracts::initializeModel() {

}

void OAIContracts::fromJson(QString jsonString) {
...
void OAIContracts::fromJsonObject(QJsonObject json) {

}

QString OAIContracts::asJson() const {
...
QJsonObject OAIContracts::asJsonObject() const {
    QJsonObject obj;
    return obj;
}

bool OAIContracts::isSet() const {
...
bool OAIContracts::isValid() const {
