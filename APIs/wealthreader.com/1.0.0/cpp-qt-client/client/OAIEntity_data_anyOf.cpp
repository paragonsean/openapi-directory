...
OAIEntity_data_anyOf::OAIEntity_data_anyOf(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntity_data_anyOf::OAIEntity_data_anyOf() {
    this->initializeModel();
}

OAIEntity_data_anyOf::~OAIEntity_data_anyOf() {}

void OAIEntity_data_anyOf::initializeModel() {

    m_portfolios_isSet = false;
    m_portfolios_isValid = false;
}

void OAIEntity_data_anyOf::fromJson(QString jsonString) {
...
void OAIEntity_data_anyOf::fromJsonObject(QJsonObject json) {
...
QString OAIEntity_data_anyOf::asJson() const {
...
QJsonObject OAIEntity_data_anyOf::asJsonObject() const {
    QJsonObject obj;
...
QList<QJsonValue> OAIEntity_data_anyOf::getPortfolios() const {
    return m_portfolios;
}
void OAIEntity_data_anyOf::setPortfolios(const QList<QJsonValue> &portfolios) {
    m_portfolios = portfolios;
    m_portfolios_isSet = true;
}

bool OAIEntity_data_anyOf::is_portfolios_Set() const{
    return m_portfolios_isSet;
}

bool OAIEntity_data_anyOf::is_portfolios_Valid() const{
    return m_portfolios_isValid;
}

bool OAIEntity_data_anyOf::isSet() const {
...
bool OAIEntity_data_anyOf::isValid() const {
