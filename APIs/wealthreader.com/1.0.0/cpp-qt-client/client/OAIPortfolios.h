...
#ifndef OAIPortfolios_H
#define OAIPortfolios_H
...
class OAIPortfolios : public OAIObject {
public:
    OAIPortfolios();
    OAIPortfolios(QString json);
    ~OAIPortfolios() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPortfolios)

#endif // OAIPortfolios_H
