...
#ifndef OAIError_codes_H
#define OAIError_codes_H
...
class OAIError_codes : public OAIObject {
public:
    OAIError_codes();
    OAIError_codes(QString json);
    ~OAIError_codes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIError_codes)

#endif // OAIError_codes_H
