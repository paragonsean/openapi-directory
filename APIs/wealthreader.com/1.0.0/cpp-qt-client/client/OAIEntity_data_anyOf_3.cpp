...
OAIEntity_data_anyOf_3::OAIEntity_data_anyOf_3(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntity_data_anyOf_3::OAIEntity_data_anyOf_3() {
    this->initializeModel();
}

OAIEntity_data_anyOf_3::~OAIEntity_data_anyOf_3() {}

void OAIEntity_data_anyOf_3::initializeModel() {

    m_properties_isSet = false;
    m_properties_isValid = false;
}

void OAIEntity_data_anyOf_3::fromJson(QString jsonString) {
...
void OAIEntity_data_anyOf_3::fromJsonObject(QJsonObject json) {

    m_properties_isValid = ::OpenAPI::fromJsonValue(m_properties, json[QString("properties")]);
    m_properties_isSet = !json[QString("properties")].isNull() && m_properties_isValid;
}

QString OAIEntity_data_anyOf_3::asJson() const {
...
QJsonObject OAIEntity_data_anyOf_3::asJsonObject() const {
    QJsonObject obj;
...
QList<QJsonValue> OAIEntity_data_anyOf_3::getProperties() const {
    return m_properties;
}
void OAIEntity_data_anyOf_3::setProperties(const QList<QJsonValue> &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIEntity_data_anyOf_3::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIEntity_data_anyOf_3::is_properties_Valid() const{
    return m_properties_isValid;
}

bool OAIEntity_data_anyOf_3::isSet() const {
...
bool OAIEntity_data_anyOf_3::isValid() const {
