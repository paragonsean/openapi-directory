...
/*
 * OAIEntity_data_anyOf_3.h
 *
 * 
 */

#ifndef OAIEntity_data_anyOf_3_H
#define OAIEntity_data_anyOf_3_H
...
class OAIEntity_data_anyOf_3 : public OAIObject {
public:
    OAIEntity_data_anyOf_3();
    OAIEntity_data_anyOf_3(QString json);
    ~OAIEntity_data_anyOf_3() override;
    ...
    QList<QJsonValue> getProperties() const;
    void setProperties(const QList<QJsonValue> &properties);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntity_data_anyOf_3)

#endif // OAIEntity_data_anyOf_3_H
