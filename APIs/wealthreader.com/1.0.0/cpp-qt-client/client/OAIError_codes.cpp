...
OAIError_codes::OAIError_codes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIError_codes::OAIError_codes() {
    this->initializeModel();
}

OAIError_codes::~OAIError_codes() {}

void OAIError_codes::initializeModel() {

}

void OAIError_codes::fromJson(QString jsonString) {
...
void OAIError_codes::fromJsonObject(QJsonObject json) {

}

QString OAIError_codes::asJson() const {
...
QJsonObject OAIError_codes::asJsonObject() const {
    QJsonObject obj;
    return obj;
}

bool OAIError_codes::isSet() const {
...
bool OAIError_codes::isValid() const {
