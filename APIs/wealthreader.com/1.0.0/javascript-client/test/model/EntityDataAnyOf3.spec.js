...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthReaderApi.EntityDataAnyOf3();
  });
  ...
  describe('EntityDataAnyOf3', function() {
    it('should create an instance of EntityDataAnyOf3', function() {
      // uncomment below and update the code to test EntityDataAnyOf3
      //var instance = new WealthReaderApi.EntityDataAnyOf3();
      //expect(instance).to.be.a(WealthReaderApi.EntityDataAnyOf3);
    });
