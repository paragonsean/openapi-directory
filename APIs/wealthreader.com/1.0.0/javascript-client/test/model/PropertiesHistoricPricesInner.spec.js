...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthReaderApi.PropertiesHistoricPricesInner();
  });
  ...
  describe('PropertiesHistoricPricesInner', function() {
    it('should create an instance of PropertiesHistoricPricesInner', function() {
      // uncomment below and update the code to test PropertiesHistoricPricesInner
      //var instance = new WealthReaderApi.PropertiesHistoricPricesInner();
      //expect(instance).to.be.a(WealthReaderApi.PropertiesHistoricPricesInner);
    });
