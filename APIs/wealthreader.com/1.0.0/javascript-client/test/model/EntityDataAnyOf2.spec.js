...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthReaderApi.EntityDataAnyOf2();
  });
  ...
  describe('EntityDataAnyOf2', function() {
    it('should create an instance of EntityDataAnyOf2', function() {
      // uncomment below and update the code to test EntityDataAnyOf2
      //var instance = new WealthReaderApi.EntityDataAnyOf2();
      //expect(instance).to.be.a(WealthReaderApi.EntityDataAnyOf2);
    });
