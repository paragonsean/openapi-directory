...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthReaderApi.EntityDataAnyOf();
  });
  ...
  describe('EntityDataAnyOf', function() {
    it('should create an instance of EntityDataAnyOf', function() {
      // uncomment below and update the code to test EntityDataAnyOf
      //var instance = new WealthReaderApi.EntityDataAnyOf();
      //expect(instance).to.be.a(WealthReaderApi.EntityDataAnyOf);
    });
