...
public class Eval extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Eval.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Eval' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Eval>() {
                @Override
                public void write(JsonWriter out, Eval value) throws IOException {
                ...
                @Override
                public Eval read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for Eval: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Eval
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for Eval with anyOf schemas: Boolean, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Eval given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Eval
     * @throws IOException if the JSON string is invalid with respect to Eval
     */
    public static Eval fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Eval.class);
    }

    /**
     * Convert an instance of Eval to an JSON string
     *
     * @return JSON string
     */
