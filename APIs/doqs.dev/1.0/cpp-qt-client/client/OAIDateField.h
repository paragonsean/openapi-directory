...
#ifndef OAIDateField_H
#define OAIDateField_H
...
class OAIDateField : public OAIObject {
public:
    OAIDateField();
    OAIDateField(QString json);
    ~OAIDateField() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDateField)

#endif // OAIDateField_H
