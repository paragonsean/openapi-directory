...
#ifndef OAIFields_inner_H
#define OAIFields_inner_H
...
class OAIFields_inner : public OAIObject {
public:
    OAIFields_inner();
    OAIFields_inner(QString json);
    ~OAIFields_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFields_inner)

#endif // OAIFields_inner_H
