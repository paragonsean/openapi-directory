...
public class ApiClient {
    ...
    private String basePath = "https://virtserver.swaggerhub.com/pcraig3/groundhog-day-api/1.2.1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://virtserver.swaggerhub.com/pcraig3/groundhog-day-api/1.2.1
