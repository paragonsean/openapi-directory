...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://virtserver.swaggerhub.com/pcraig3/groundhog-day-api/1.2.1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://virtserver.swaggerhub.com/pcraig3/groundhog-day-api/1.2.1
         */
