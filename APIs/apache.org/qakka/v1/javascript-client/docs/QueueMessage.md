...
**createDate** | **Number** | Date that message was received by system. | [optional] 
...
**messageId** | **String** | UUID of Message Data associated with this Queue Message | [optional] 
**queueMessageId** | **String** | UUID of Queue Message in local region. | [optional] 
