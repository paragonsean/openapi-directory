...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qakka.ApiResponse();
  });
  ...
  describe('ApiResponse', function() {
    it('should create an instance of ApiResponse', function() {
      ...
      //var instance = new Qakka.ApiResponse();
      //expect(instance).to.be.a(Qakka.ApiResponse);
    });
    ...
    it('should have the property queueMessages (base name: "queueMessages")', function() {
      // uncomment below and update the code to test the property queueMessages
      //var instance = new Qakka.ApiResponse();
      //expect(instance).to.be();
    });
