...
QString OAIConnection::getConnType() const {
    return m_conn_type;
}
void OAIConnection::setConnType(const QString &conn_type) {
    m_conn_type = conn_type;
    m_conn_type_isSet = true;
}

bool OAIConnection::is_conn_type_Set() const{
    return m_conn_type_isSet;
}

bool OAIConnection::is_conn_type_Valid() const{
...
void OAIConnection::setConnectionId(const QString &connection_id) {
    m_connection_id = connection_id;
    m_connection_id_isSet = true;
}

bool OAIConnection::is_connection_id_Set() const{
    return m_connection_id_isSet;
}

bool OAIConnection::is_connection_id_Valid() const{
...
qint32 OAIConnection::getPort() const {
    return m_port;
}
void OAIConnection::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}
...
QString OAIConnection::getSchema() const {
    return m_schema;
}
void OAIConnection::setSchema(const QString &schema) {
    m_schema = schema;
    m_schema_isSet = true;
}

bool OAIConnection::is_schema_Set() const{
    return m_schema_isSet;
}

bool OAIConnection::is_schema_Valid() const{
    return m_schema_isValid;
}

QString OAIConnection::getExtra() const {
    return m_extra;
}
void OAIConnection::setExtra(const QString &extra) {
    m_extra = extra;
    m_extra_isSet = true;
}

bool OAIConnection::is_extra_Set() const{
    return m_extra_isSet;
}

bool OAIConnection::is_extra_Valid() const{
