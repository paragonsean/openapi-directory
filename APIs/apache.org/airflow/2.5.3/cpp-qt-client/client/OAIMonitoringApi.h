...
Q_SIGNALS:
    ...
    void getHealthSignal(OAIHealthInfo summary);
    void getVersionSignal(OAIVersionInfo summary);


    void getHealthSignalFull(OAIHttpRequestWorker *worker, OAIHealthInfo summary);
    void getVersionSignalFull(OAIHttpRequestWorker *worker, OAIVersionInfo summary);

    Q_DECL_DEPRECATED_X("Use getHealthSignalError() instead")
    void getHealthSignalE(OAIHealthInfo summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getHealthSignalError(OAIHealthInfo summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getVersionSignalError() instead")
    void getVersionSignalE(OAIVersionInfo summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getVersionSignalError(OAIVersionInfo summary, QNetworkReply::NetworkError error_type, const QString &error_str);
