...
void OAIUserApi::deleteUser(const QString &username) {
    QString fullPath = QString(_serverConfigs["deleteUser"][_serverIndices.value("deleteUser")].URL()+"/users/{username}");
...
void OAIUserApi::getUser(const QString &username) {
    QString fullPath = QString(_serverConfigs["getUser"][_serverIndices.value("getUser")].URL()+"/users/{username}");
...
void OAIUserApi::getUserCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIUserCollectionItem output(QString(worker->response));
    worker->deleteLater();
...
void OAIUserApi::getUsers(const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<qint32> &offset, const ::OpenAPI::OptionalParam<QString> &order_by) {
...
void OAIUserApi::patchUser(const QString &username, const OAIUser &oai_user, const ::OpenAPI::OptionalParam<QList<QString>> &update_mask) {
    QString fullPath = QString(_serverConfigs["patchUser"][_serverIndices.value("patchUser")].URL()+"/users/{username}");
...
void OAIUserApi::postUser(const OAIUser &oai_user) {
