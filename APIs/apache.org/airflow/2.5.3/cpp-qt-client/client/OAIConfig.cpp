...
QList<OAIConfigSection> OAIConfig::getSections() const {
    return m_sections;
}
void OAIConfig::setSections(const QList<OAIConfigSection> &sections) {
    m_sections = sections;
    m_sections_isSet = true;
}

bool OAIConfig::is_sections_Set() const{
    return m_sections_isSet;
}

bool OAIConfig::is_sections_Valid() const{
