...
#ifndef OAIScheduleInterval_H
#define OAIScheduleInterval_H
...
class OAIScheduleInterval : public OAIObject {
public:
    OAIScheduleInterval();
    OAIScheduleInterval(QString json);
    ~OAIScheduleInterval() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleInterval)

#endif // OAIScheduleInterval_H
