...
/*
 * OAIDatasetCollection.h
 *
 * A collection of datasets.  *New in version 2.4.0* 
 */

#ifndef OAIDatasetCollection_H
#define OAIDatasetCollection_H
...
class OAIDatasetCollection : public OAIObject {
public:
    OAIDatasetCollection();
    OAIDatasetCollection(QString json);
    ~OAIDatasetCollection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatasetCollection)

#endif // OAIDatasetCollection_H
