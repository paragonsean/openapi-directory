...
public:
    ...
    QList<OAIConfigSection> getSections() const;
    void setSections(const QList<OAIConfigSection> &sections);
...
private:
    ...
    QList<OAIConfigSection> m_sections;
