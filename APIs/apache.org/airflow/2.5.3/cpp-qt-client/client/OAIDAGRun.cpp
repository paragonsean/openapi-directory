...
OAIDAGRun::OAIDAGRun(QString json) {
...
void OAIDAGRun::initializeModel() {
...
void OAIDAGRun::fromJson(QString jsonString) {
...
void OAIDAGRun::fromJsonObject(QJsonObject json) {
...
QString OAIDAGRun::asJson() const {
...
QJsonObject OAIDAGRun::asJsonObject() const {
    QJsonObject obj;
    if (m_conf_isSet) {
...
OAIObject OAIDAGRun::getConf() const {
    return m_conf;
}
void OAIDAGRun::setConf(const OAIObject &conf) {
    m_conf = conf;
    m_conf_isSet = true;
}

bool OAIDAGRun::is_conf_Set() const{
    return m_conf_isSet;
}

bool OAIDAGRun::is_conf_Valid() const{
    return m_conf_isValid;
}

QString OAIDAGRun::getDagId() const {
    return m_dag_id;
}
void OAIDAGRun::setDagId(const QString &dag_id) {
    m_dag_id = dag_id;
    m_dag_id_isSet = true;
}

bool OAIDAGRun::is_dag_id_Set() const{
    return m_dag_id_isSet;
}

bool OAIDAGRun::is_dag_id_Valid() const{
    return m_dag_id_isValid;
}

QString OAIDAGRun::getDagRunId() const {
    return m_dag_run_id;
}
void OAIDAGRun::setDagRunId(const QString &dag_run_id) {
    m_dag_run_id = dag_run_id;
    m_dag_run_id_isSet = true;
}

bool OAIDAGRun::is_dag_run_id_Set() const{
    return m_dag_run_id_isSet;
}

bool OAIDAGRun::is_dag_run_id_Valid() const{
    return m_dag_run_id_isValid;
}

QDateTime OAIDAGRun::getDataIntervalEnd() const {
    return m_data_interval_end;
}
void OAIDAGRun::setDataIntervalEnd(const QDateTime &data_interval_end) {
    m_data_interval_end = data_interval_end;
    m_data_interval_end_isSet = true;
}

bool OAIDAGRun::is_data_interval_end_Set() const{
    return m_data_interval_end_isSet;
}

bool OAIDAGRun::is_data_interval_end_Valid() const{
    return m_data_interval_end_isValid;
}

QDateTime OAIDAGRun::getDataIntervalStart() const {
    return m_data_interval_start;
}
void OAIDAGRun::setDataIntervalStart(const QDateTime &data_interval_start) {
    m_data_interval_start = data_interval_start;
    m_data_interval_start_isSet = true;
}

bool OAIDAGRun::is_data_interval_start_Set() const{
    return m_data_interval_start_isSet;
}

bool OAIDAGRun::is_data_interval_start_Valid() const{
    return m_data_interval_start_isValid;
}

QDateTime OAIDAGRun::getEndDate() const {
    return m_end_date;
}
void OAIDAGRun::setEndDate(const QDateTime &end_date) {
    m_end_date = end_date;
    m_end_date_isSet = true;
}

bool OAIDAGRun::is_end_date_Set() const{
    return m_end_date_isSet;
}

bool OAIDAGRun::is_end_date_Valid() const{
    return m_end_date_isValid;
}

QDateTime OAIDAGRun::getExecutionDate() const {
    return m_execution_date;
}
void OAIDAGRun::setExecutionDate(const QDateTime &execution_date) {
    m_execution_date = execution_date;
    m_execution_date_isSet = true;
}

bool OAIDAGRun::is_execution_date_Set() const{
    return m_execution_date_isSet;
}

bool OAIDAGRun::is_execution_date_Valid() const{
    return m_execution_date_isValid;
}

bool OAIDAGRun::isExternalTrigger() const {
    return m_external_trigger;
}
void OAIDAGRun::setExternalTrigger(const bool &external_trigger) {
    m_external_trigger = external_trigger;
    m_external_trigger_isSet = true;
}

bool OAIDAGRun::is_external_trigger_Set() const{
    return m_external_trigger_isSet;
}

bool OAIDAGRun::is_external_trigger_Valid() const{
    return m_external_trigger_isValid;
}

QDateTime OAIDAGRun::getLastSchedulingDecision() const {
    return m_last_scheduling_decision;
}
void OAIDAGRun::setLastSchedulingDecision(const QDateTime &last_scheduling_decision) {
    m_last_scheduling_decision = last_scheduling_decision;
    m_last_scheduling_decision_isSet = true;
}

bool OAIDAGRun::is_last_scheduling_decision_Set() const{
    return m_last_scheduling_decision_isSet;
}

bool OAIDAGRun::is_last_scheduling_decision_Valid() const{
    return m_last_scheduling_decision_isValid;
}

QDateTime OAIDAGRun::getLogicalDate() const {
    return m_logical_date;
}
void OAIDAGRun::setLogicalDate(const QDateTime &logical_date) {
    m_logical_date = logical_date;
    m_logical_date_isSet = true;
}

bool OAIDAGRun::is_logical_date_Set() const{
    return m_logical_date_isSet;
}

bool OAIDAGRun::is_logical_date_Valid() const{
    return m_logical_date_isValid;
}

QString OAIDAGRun::getNote() const {
    return m_note;
}
void OAIDAGRun::setNote(const QString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAIDAGRun::is_note_Set() const{
    return m_note_isSet;
}

bool OAIDAGRun::is_note_Valid() const{
    return m_note_isValid;
}

QString OAIDAGRun::getRunType() const {
    return m_run_type;
}
void OAIDAGRun::setRunType(const QString &run_type) {
    m_run_type = run_type;
    m_run_type_isSet = true;
}

bool OAIDAGRun::is_run_type_Set() const{
    return m_run_type_isSet;
}

bool OAIDAGRun::is_run_type_Valid() const{
    return m_run_type_isValid;
}

QDateTime OAIDAGRun::getStartDate() const {
    return m_start_date;
}
void OAIDAGRun::setStartDate(const QDateTime &start_date) {
    m_start_date = start_date;
    m_start_date_isSet = true;
}

bool OAIDAGRun::is_start_date_Set() const{
    return m_start_date_isSet;
}

bool OAIDAGRun::is_start_date_Valid() const{
    return m_start_date_isValid;
}

OAIDagState OAIDAGRun::getState() const {
    return m_state;
}
void OAIDAGRun::setState(const OAIDagState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIDAGRun::is_state_Set() const{
    return m_state_isSet;
}

bool OAIDAGRun::is_state_Valid() const{
    return m_state_isValid;
}

bool OAIDAGRun::isSet() const {
