...
#ifndef OAIActionResource_H
#define OAIActionResource_H
...
class OAIActionResource : public OAIObject {
public:
    OAIActionResource();
    OAIActionResource(QString json);
    ~OAIActionResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionResource)

#endif // OAIActionResource_H
