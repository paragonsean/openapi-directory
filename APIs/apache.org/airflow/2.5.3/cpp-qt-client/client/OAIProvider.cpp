...
QString OAIProvider::getPackageName() const {
    return m_package_name;
}
void OAIProvider::setPackageName(const QString &package_name) {
    m_package_name = package_name;
    m_package_name_isSet = true;
}

bool OAIProvider::is_package_name_Set() const{
    return m_package_name_isSet;
}

bool OAIProvider::is_package_name_Valid() const{
    return m_package_name_isValid;
}

QString OAIProvider::getVersion() const {
    return m_version;
}
void OAIProvider::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIProvider::is_version_Set() const{
    return m_version_isSet;
}

bool OAIProvider::is_version_Valid() const{
