...
#ifndef OAITimeDelta_H
#define OAITimeDelta_H
...
class OAITimeDelta : public OAIObject {
public:
    OAITimeDelta();
    OAITimeDelta(QString json);
    ~OAITimeDelta() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeDelta)

#endif // OAITimeDelta_H
