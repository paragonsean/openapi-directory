...
Q_SIGNALS:
    ...
    void getProvidersSignal(OAIGet_providers_200_response summary);


    void getProvidersSignalFull(OAIHttpRequestWorker *worker, OAIGet_providers_200_response summary);

    Q_DECL_DEPRECATED_X("Use getProvidersSignalError() instead")
    void getProvidersSignalE(OAIGet_providers_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getProvidersSignalError(OAIGet_providers_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
