...
class OAISLAMiss : public OAIObject {
public:
    OAISLAMiss();
    OAISLAMiss(QString json);
    ~OAISLAMiss() override;
    ...
    bool isEmailSent() const;
    void setEmailSent(const bool &email_sent);
    ...
    void setNotificationSent(const bool &notification_sent);
...
Q_DECLARE_METATYPE(OpenAPI::OAISLAMiss)
