...
/*
 * OAITaskInstanceReference.h
 *
 * 
 */

#ifndef OAITaskInstanceReference_H
#define OAITaskInstanceReference_H
...
class OAITaskInstanceReference : public OAIObject {
public:
    OAITaskInstanceReference();
    OAITaskInstanceReference(QString json);
    ~OAITaskInstanceReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskInstanceReference)

#endif // OAITaskInstanceReference_H
