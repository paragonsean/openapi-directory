...
public:
    ...
    QString getExecutorClass() const;
    void setExecutorClass(const QString &executor_class);
    bool is_executor_class_Set() const;
    bool is_executor_class_Valid() const;
    ...
    QString getLatestHeartbeat() const;
    void setLatestHeartbeat(const QString &latest_heartbeat);
...
private:
    ...
    QString m_executor_class;
    bool m_executor_class_isSet;
    bool m_executor_class_isValid;
