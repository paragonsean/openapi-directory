...
OAIDAGDetail::OAIDAGDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDAGDetail::OAIDAGDetail() {
    this->initializeModel();
}

OAIDAGDetail::~OAIDAGDetail() {}

void OAIDAGDetail::initializeModel() {
    ...
    m_catchup_isSet = false;
    m_catchup_isValid = false;

    m_concurrency_isSet = false;
    m_concurrency_isValid = false;

    m_dag_run_timeout_isSet = false;
    m_dag_run_timeout_isValid = false;

    m_doc_md_isSet = false;
    m_doc_md_isValid = false;

    m_end_date_isSet = false;
    m_end_date_isValid = false;

    m_is_paused_upon_creation_isSet = false;
    m_is_paused_upon_creation_isValid = false;

    m_last_parsed_isSet = false;
    m_last_parsed_isValid = false;
    ...
    m_render_template_as_native_obj_isSet = false;
    m_render_template_as_native_obj_isValid = false;

    m_start_date_isSet = false;
    m_start_date_isValid = false;

    m_template_search_path_isSet = false;
    m_template_search_path_isValid = false;

    m_timezone_isSet = false;
    m_timezone_isValid = false;
}

void OAIDAGDetail::fromJson(QString jsonString) {
...
void OAIDAGDetail::fromJsonObject(QJsonObject json) {
    ...
    m_catchup_isValid = ::OpenAPI::fromJsonValue(m_catchup, json[QString("catchup")]);
    m_catchup_isSet = !json[QString("catchup")].isNull() && m_catchup_isValid;
    ...
    m_dag_run_timeout_isValid = ::OpenAPI::fromJsonValue(m_dag_run_timeout, json[QString("dag_run_timeout")]);
    m_dag_run_timeout_isSet = !json[QString("dag_run_timeout")].isNull() && m_dag_run_timeout_isValid;

    m_doc_md_isValid = ::OpenAPI::fromJsonValue(m_doc_md, json[QString("doc_md")]);
    m_doc_md_isSet = !json[QString("doc_md")].isNull() && m_doc_md_isValid;
    ...
    m_is_paused_upon_creation_isValid = ::OpenAPI::fromJsonValue(m_is_paused_upon_creation, json[QString("is_paused_upon_creation")]);
    m_is_paused_upon_creation_isSet = !json[QString("is_paused_upon_creation")].isNull() && m_is_paused_upon_creation_isValid;

    m_last_parsed_isValid = ::OpenAPI::fromJsonValue(m_last_parsed, json[QString("last_parsed")]);
    m_last_parsed_isSet = !json[QString("last_parsed")].isNull() && m_last_parsed_isValid;
    ...
    m_render_template_as_native_obj_isValid = ::OpenAPI::fromJsonValue(m_render_template_as_native_obj, json[QString("render_template_as_native_obj")]);
    m_render_template_as_native_obj_isSet = !json[QString("render_template_as_native_obj")].isNull() && m_render_template_as_native_obj_isValid;
    ...
    m_template_search_path_isValid = ::OpenAPI::fromJsonValue(m_template_search_path, json[QString("template_search_path")]);
    m_template_search_path_isSet = !json[QString("template_search_path")].isNull() && m_template_search_path_isValid;

    m_timezone_isValid = ::OpenAPI::fromJsonValue(m_timezone, json[QString("timezone")]);
    m_timezone_isSet = !json[QString("timezone")].isNull() && m_timezone_isValid;
}

QString OAIDAGDetail::asJson() const {
...
QJsonObject OAIDAGDetail::asJsonObject() const {
    QJsonObject obj;
    if (m_dag_id_isSet) {
    ...
    if (m_catchup_isSet) {
        obj.insert(QString("catchup"), ::OpenAPI::toJsonValue(m_catchup));
    }
    if (m_concurrency_isSet) {
        obj.insert(QString("concurrency"), ::OpenAPI::toJsonValue(m_concurrency));
    }
    if (m_dag_run_timeout.isSet()) {
        obj.insert(QString("dag_run_timeout"), ::OpenAPI::toJsonValue(m_dag_run_timeout));
    }
    if (m_doc_md_isSet) {
        obj.insert(QString("doc_md"), ::OpenAPI::toJsonValue(m_doc_md));
    }
    if (m_end_date_isSet) {
        obj.insert(QString("end_date"), ::OpenAPI::toJsonValue(m_end_date));
    }
    if (m_is_paused_upon_creation_isSet) {
        obj.insert(QString("is_paused_upon_creation"), ::OpenAPI::toJsonValue(m_is_paused_upon_creation));
    }
    if (m_last_parsed_isSet) {
        obj.insert(QString("last_parsed"), ::OpenAPI::toJsonValue(m_last_parsed));
    }
    ...
    if (m_render_template_as_native_obj_isSet) {
        obj.insert(QString("render_template_as_native_obj"), ::OpenAPI::toJsonValue(m_render_template_as_native_obj));
    }
    if (m_start_date_isSet) {
        obj.insert(QString("start_date"), ::OpenAPI::toJsonValue(m_start_date));
    }
    if (m_template_search_path.size() > 0) {
        obj.insert(QString("template_search_path"), ::OpenAPI::toJsonValue(m_template_search_path));
    }
    if (m_timezone_isSet) {
...
QString OAIDAGDetail::getDagId() const {
    return m_dag_id;
}
void OAIDAGDetail::setDagId(const QString &dag_id) {
    m_dag_id = dag_id;
    m_dag_id_isSet = true;
}

bool OAIDAGDetail::is_dag_id_Set() const{
    return m_dag_id_isSet;
}

bool OAIDAGDetail::is_dag_id_Valid() const{
    return m_dag_id_isValid;
}

QString OAIDAGDetail::getDefaultView() const {
    return m_default_view;
}
void OAIDAGDetail::setDefaultView(const QString &default_view) {
    m_default_view = default_view;
    m_default_view_isSet = true;
}

bool OAIDAGDetail::is_default_view_Set() const{
    return m_default_view_isSet;
}

bool OAIDAGDetail::is_default_view_Valid() const{
    return m_default_view_isValid;
}

QString OAIDAGDetail::getDescription() const {
    return m_description;
}
void OAIDAGDetail::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDAGDetail::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDAGDetail::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIDAGDetail::getFileToken() const {
    return m_file_token;
}
void OAIDAGDetail::setFileToken(const QString &file_token) {
    m_file_token = file_token;
    m_file_token_isSet = true;
}

bool OAIDAGDetail::is_file_token_Set() const{
    return m_file_token_isSet;
}

bool OAIDAGDetail::is_file_token_Valid() const{
    return m_file_token_isValid;
}

QString OAIDAGDetail::getFileloc() const {
    return m_fileloc;
}
void OAIDAGDetail::setFileloc(const QString &fileloc) {
    m_fileloc = fileloc;
    m_fileloc_isSet = true;
}

bool OAIDAGDetail::is_fileloc_Set() const{
    return m_fileloc_isSet;
}

bool OAIDAGDetail::is_fileloc_Valid() const{
    return m_fileloc_isValid;
}

bool OAIDAGDetail::isHasImportErrors() const {
    return m_has_import_errors;
}
void OAIDAGDetail::setHasImportErrors(const bool &has_import_errors) {
    m_has_import_errors = has_import_errors;
    m_has_import_errors_isSet = true;
}

bool OAIDAGDetail::is_has_import_errors_Set() const{
    return m_has_import_errors_isSet;
}

bool OAIDAGDetail::is_has_import_errors_Valid() const{
    return m_has_import_errors_isValid;
}

bool OAIDAGDetail::isHasTaskConcurrencyLimits() const {
    return m_has_task_concurrency_limits;
}
void OAIDAGDetail::setHasTaskConcurrencyLimits(const bool &has_task_concurrency_limits) {
    m_has_task_concurrency_limits = has_task_concurrency_limits;
    m_has_task_concurrency_limits_isSet = true;
}

bool OAIDAGDetail::is_has_task_concurrency_limits_Set() const{
    return m_has_task_concurrency_limits_isSet;
}

bool OAIDAGDetail::is_has_task_concurrency_limits_Valid() const{
    return m_has_task_concurrency_limits_isValid;
}

bool OAIDAGDetail::isIsActive() const {
    return m_is_active;
}
void OAIDAGDetail::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAIDAGDetail::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIDAGDetail::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAIDAGDetail::isIsPaused() const {
    return m_is_paused;
}
void OAIDAGDetail::setIsPaused(const bool &is_paused) {
    m_is_paused = is_paused;
    m_is_paused_isSet = true;
}

bool OAIDAGDetail::is_is_paused_Set() const{
    return m_is_paused_isSet;
}

bool OAIDAGDetail::is_is_paused_Valid() const{
    return m_is_paused_isValid;
}

bool OAIDAGDetail::isIsSubdag() const {
    return m_is_subdag;
}
void OAIDAGDetail::setIsSubdag(const bool &is_subdag) {
    m_is_subdag = is_subdag;
    m_is_subdag_isSet = true;
}

bool OAIDAGDetail::is_is_subdag_Set() const{
    return m_is_subdag_isSet;
}

bool OAIDAGDetail::is_is_subdag_Valid() const{
    return m_is_subdag_isValid;
}

QDateTime OAIDAGDetail::getLastExpired() const {
    return m_last_expired;
}
void OAIDAGDetail::setLastExpired(const QDateTime &last_expired) {
    m_last_expired = last_expired;
    m_last_expired_isSet = true;
}

bool OAIDAGDetail::is_last_expired_Set() const{
    return m_last_expired_isSet;
}

bool OAIDAGDetail::is_last_expired_Valid() const{
    return m_last_expired_isValid;
}

QDateTime OAIDAGDetail::getLastParsedTime() const {
    return m_last_parsed_time;
}
void OAIDAGDetail::setLastParsedTime(const QDateTime &last_parsed_time) {
    m_last_parsed_time = last_parsed_time;
    m_last_parsed_time_isSet = true;
}

bool OAIDAGDetail::is_last_parsed_time_Set() const{
    return m_last_parsed_time_isSet;
}

bool OAIDAGDetail::is_last_parsed_time_Valid() const{
    return m_last_parsed_time_isValid;
}

QDateTime OAIDAGDetail::getLastPickled() const {
    return m_last_pickled;
}
void OAIDAGDetail::setLastPickled(const QDateTime &last_pickled) {
    m_last_pickled = last_pickled;
    m_last_pickled_isSet = true;
}

bool OAIDAGDetail::is_last_pickled_Set() const{
    return m_last_pickled_isSet;
}

bool OAIDAGDetail::is_last_pickled_Valid() const{
    return m_last_pickled_isValid;
}

qint32 OAIDAGDetail::getMaxActiveRuns() const {
    return m_max_active_runs;
}
void OAIDAGDetail::setMaxActiveRuns(const qint32 &max_active_runs) {
    m_max_active_runs = max_active_runs;
    m_max_active_runs_isSet = true;
}

bool OAIDAGDetail::is_max_active_runs_Set() const{
    return m_max_active_runs_isSet;
}

bool OAIDAGDetail::is_max_active_runs_Valid() const{
    return m_max_active_runs_isValid;
}

qint32 OAIDAGDetail::getMaxActiveTasks() const {
    return m_max_active_tasks;
}
void OAIDAGDetail::setMaxActiveTasks(const qint32 &max_active_tasks) {
    m_max_active_tasks = max_active_tasks;
    m_max_active_tasks_isSet = true;
}

bool OAIDAGDetail::is_max_active_tasks_Set() const{
    return m_max_active_tasks_isSet;
}

bool OAIDAGDetail::is_max_active_tasks_Valid() const{
    return m_max_active_tasks_isValid;
}

QDateTime OAIDAGDetail::getNextDagrun() const {
    return m_next_dagrun;
}
void OAIDAGDetail::setNextDagrun(const QDateTime &next_dagrun) {
    m_next_dagrun = next_dagrun;
    m_next_dagrun_isSet = true;
}

bool OAIDAGDetail::is_next_dagrun_Set() const{
    return m_next_dagrun_isSet;
}

bool OAIDAGDetail::is_next_dagrun_Valid() const{
    return m_next_dagrun_isValid;
}

QDateTime OAIDAGDetail::getNextDagrunCreateAfter() const {
    return m_next_dagrun_create_after;
}
void OAIDAGDetail::setNextDagrunCreateAfter(const QDateTime &next_dagrun_create_after) {
    m_next_dagrun_create_after = next_dagrun_create_after;
    m_next_dagrun_create_after_isSet = true;
}

bool OAIDAGDetail::is_next_dagrun_create_after_Set() const{
    return m_next_dagrun_create_after_isSet;
}

bool OAIDAGDetail::is_next_dagrun_create_after_Valid() const{
    return m_next_dagrun_create_after_isValid;
}

QDateTime OAIDAGDetail::getNextDagrunDataIntervalEnd() const {
    return m_next_dagrun_data_interval_end;
}
void OAIDAGDetail::setNextDagrunDataIntervalEnd(const QDateTime &next_dagrun_data_interval_end) {
    m_next_dagrun_data_interval_end = next_dagrun_data_interval_end;
    m_next_dagrun_data_interval_end_isSet = true;
}

bool OAIDAGDetail::is_next_dagrun_data_interval_end_Set() const{
    return m_next_dagrun_data_interval_end_isSet;
}

bool OAIDAGDetail::is_next_dagrun_data_interval_end_Valid() const{
    return m_next_dagrun_data_interval_end_isValid;
}

QDateTime OAIDAGDetail::getNextDagrunDataIntervalStart() const {
    return m_next_dagrun_data_interval_start;
}
void OAIDAGDetail::setNextDagrunDataIntervalStart(const QDateTime &next_dagrun_data_interval_start) {
    m_next_dagrun_data_interval_start = next_dagrun_data_interval_start;
    m_next_dagrun_data_interval_start_isSet = true;
}

bool OAIDAGDetail::is_next_dagrun_data_interval_start_Set() const{
    return m_next_dagrun_data_interval_start_isSet;
}

bool OAIDAGDetail::is_next_dagrun_data_interval_start_Valid() const{
    return m_next_dagrun_data_interval_start_isValid;
}

QList<QString> OAIDAGDetail::getOwners() const {
    return m_owners;
}
void OAIDAGDetail::setOwners(const QList<QString> &owners) {
    m_owners = owners;
    m_owners_isSet = true;
}

bool OAIDAGDetail::is_owners_Set() const{
    return m_owners_isSet;
}

bool OAIDAGDetail::is_owners_Valid() const{
    return m_owners_isValid;
}

QString OAIDAGDetail::getPickleId() const {
    return m_pickle_id;
}
void OAIDAGDetail::setPickleId(const QString &pickle_id) {
    m_pickle_id = pickle_id;
    m_pickle_id_isSet = true;
}

bool OAIDAGDetail::is_pickle_id_Set() const{
    return m_pickle_id_isSet;
}

bool OAIDAGDetail::is_pickle_id_Valid() const{
    return m_pickle_id_isValid;
}

QString OAIDAGDetail::getRootDagId() const {
    return m_root_dag_id;
}
void OAIDAGDetail::setRootDagId(const QString &root_dag_id) {
    m_root_dag_id = root_dag_id;
    m_root_dag_id_isSet = true;
}

bool OAIDAGDetail::is_root_dag_id_Set() const{
    return m_root_dag_id_isSet;
}

bool OAIDAGDetail::is_root_dag_id_Valid() const{
    return m_root_dag_id_isValid;
}

OAIScheduleInterval OAIDAGDetail::getScheduleInterval() const {
    return m_schedule_interval;
}
void OAIDAGDetail::setScheduleInterval(const OAIScheduleInterval &schedule_interval) {
    m_schedule_interval = schedule_interval;
    m_schedule_interval_isSet = true;
}

bool OAIDAGDetail::is_schedule_interval_Set() const{
    return m_schedule_interval_isSet;
}

bool OAIDAGDetail::is_schedule_interval_Valid() const{
    return m_schedule_interval_isValid;
}

bool OAIDAGDetail::isSchedulerLock() const {
    return m_scheduler_lock;
}
void OAIDAGDetail::setSchedulerLock(const bool &scheduler_lock) {
    m_scheduler_lock = scheduler_lock;
    m_scheduler_lock_isSet = true;
}

bool OAIDAGDetail::is_scheduler_lock_Set() const{
    return m_scheduler_lock_isSet;
}

bool OAIDAGDetail::is_scheduler_lock_Valid() const{
    return m_scheduler_lock_isValid;
}

QList<OAITag> OAIDAGDetail::getTags() const {
    return m_tags;
}
void OAIDAGDetail::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIDAGDetail::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIDAGDetail::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIDAGDetail::getTimetableDescription() const {
    return m_timetable_description;
}
void OAIDAGDetail::setTimetableDescription(const QString &timetable_description) {
    m_timetable_description = timetable_description;
    m_timetable_description_isSet = true;
}

bool OAIDAGDetail::is_timetable_description_Set() const{
    return m_timetable_description_isSet;
}

bool OAIDAGDetail::is_timetable_description_Valid() const{
    return m_timetable_description_isValid;
}

bool OAIDAGDetail::isCatchup() const {
    return m_catchup;
}
void OAIDAGDetail::setCatchup(const bool &catchup) {
    m_catchup = catchup;
    m_catchup_isSet = true;
}

bool OAIDAGDetail::is_catchup_Set() const{
    return m_catchup_isSet;
}

bool OAIDAGDetail::is_catchup_Valid() const{
    return m_catchup_isValid;
}

double OAIDAGDetail::getConcurrency() const {
    return m_concurrency;
}
void OAIDAGDetail::setConcurrency(const double &concurrency) {
    m_concurrency = concurrency;
    m_concurrency_isSet = true;
}

bool OAIDAGDetail::is_concurrency_Set() const{
    return m_concurrency_isSet;
}

bool OAIDAGDetail::is_concurrency_Valid() const{
    return m_concurrency_isValid;
}

OAITimeDelta OAIDAGDetail::getDagRunTimeout() const {
    return m_dag_run_timeout;
}
void OAIDAGDetail::setDagRunTimeout(const OAITimeDelta &dag_run_timeout) {
    m_dag_run_timeout = dag_run_timeout;
    m_dag_run_timeout_isSet = true;
}

bool OAIDAGDetail::is_dag_run_timeout_Set() const{
    return m_dag_run_timeout_isSet;
}

bool OAIDAGDetail::is_dag_run_timeout_Valid() const{
    return m_dag_run_timeout_isValid;
}

QString OAIDAGDetail::getDocMd() const {
    return m_doc_md;
}
void OAIDAGDetail::setDocMd(const QString &doc_md) {
    m_doc_md = doc_md;
    m_doc_md_isSet = true;
}

bool OAIDAGDetail::is_doc_md_Set() const{
    return m_doc_md_isSet;
}

bool OAIDAGDetail::is_doc_md_Valid() const{
    return m_doc_md_isValid;
}

QDateTime OAIDAGDetail::getEndDate() const {
    return m_end_date;
}
void OAIDAGDetail::setEndDate(const QDateTime &end_date) {
    m_end_date = end_date;
    m_end_date_isSet = true;
}

bool OAIDAGDetail::is_end_date_Set() const{
    return m_end_date_isSet;
}

bool OAIDAGDetail::is_end_date_Valid() const{
    return m_end_date_isValid;
}

bool OAIDAGDetail::isIsPausedUponCreation() const {
    return m_is_paused_upon_creation;
}
void OAIDAGDetail::setIsPausedUponCreation(const bool &is_paused_upon_creation) {
    m_is_paused_upon_creation = is_paused_upon_creation;
    m_is_paused_upon_creation_isSet = true;
}

bool OAIDAGDetail::is_is_paused_upon_creation_Set() const{
    return m_is_paused_upon_creation_isSet;
}

bool OAIDAGDetail::is_is_paused_upon_creation_Valid() const{
    return m_is_paused_upon_creation_isValid;
}

QDateTime OAIDAGDetail::getLastParsed() const {
    return m_last_parsed;
}
void OAIDAGDetail::setLastParsed(const QDateTime &last_parsed) {
    m_last_parsed = last_parsed;
    m_last_parsed_isSet = true;
}

bool OAIDAGDetail::is_last_parsed_Set() const{
    return m_last_parsed_isSet;
}

bool OAIDAGDetail::is_last_parsed_Valid() const{
    return m_last_parsed_isValid;
}

QString OAIDAGDetail::getOrientation() const {
    return m_orientation;
}
void OAIDAGDetail::setOrientation(const QString &orientation) {
    m_orientation = orientation;
    m_orientation_isSet = true;
}

bool OAIDAGDetail::is_orientation_Set() const{
    return m_orientation_isSet;
}

bool OAIDAGDetail::is_orientation_Valid() const{
    return m_orientation_isValid;
}

OAIObject OAIDAGDetail::getParams() const {
    return m_params;
}
void OAIDAGDetail::setParams(const OAIObject &params) {
    m_params = params;
    m_params_isSet = true;
}

bool OAIDAGDetail::is_params_Set() const{
    return m_params_isSet;
}

bool OAIDAGDetail::is_params_Valid() const{
    return m_params_isValid;
}

bool OAIDAGDetail::isRenderTemplateAsNativeObj() const {
    return m_render_template_as_native_obj;
}
void OAIDAGDetail::setRenderTemplateAsNativeObj(const bool &render_template_as_native_obj) {
    m_render_template_as_native_obj = render_template_as_native_obj;
    m_render_template_as_native_obj_isSet = true;
}

bool OAIDAGDetail::is_render_template_as_native_obj_Set() const{
    return m_render_template_as_native_obj_isSet;
}

bool OAIDAGDetail::is_render_template_as_native_obj_Valid() const{
    return m_render_template_as_native_obj_isValid;
}

QDateTime OAIDAGDetail::getStartDate() const {
    return m_start_date;
}
void OAIDAGDetail::setStartDate(const QDateTime &start_date) {
    m_start_date = start_date;
    m_start_date_isSet = true;
}

bool OAIDAGDetail::is_start_date_Set() const{
    return m_start_date_isSet;
}

bool OAIDAGDetail::is_start_date_Valid() const{
    return m_start_date_isValid;
}

QList<QString> OAIDAGDetail::getTemplateSearchPath() const {
    return m_template_search_path;
}
void OAIDAGDetail::setTemplateSearchPath(const QList<QString> &template_search_path) {
    m_template_search_path = template_search_path;
    m_template_search_path_isSet = true;
}

bool OAIDAGDetail::is_template_search_path_Set() const{
    return m_template_search_path_isSet;
}

bool OAIDAGDetail::is_template_search_path_Valid() const{
    return m_template_search_path_isValid;
}

QString OAIDAGDetail::getTimezone() const {
    return m_timezone;
}
void OAIDAGDetail::setTimezone(const QString &timezone) {
    m_timezone = timezone;
    m_timezone_isSet = true;
}

bool OAIDAGDetail::is_timezone_Set() const{
    return m_timezone_isSet;
}

bool OAIDAGDetail::is_timezone_Valid() const{
    return m_timezone_isValid;
}

bool OAIDAGDetail::isSet() const {
...
bool OAIDAGDetail::isValid() const {
