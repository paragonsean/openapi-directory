...
void OAIProviderApi::getProviders() {
    QString fullPath = QString(_serverConfigs["getProviders"][_serverIndices.value("getProviders")].URL()+"/providers");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProviderApi::getProvidersCallback);
...
void OAIProviderApi::getProvidersCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGet_providers_200_response output(QString(worker->response));
    worker->deleteLater();
