...
#ifndef OAICollectionInfo_H
#define OAICollectionInfo_H
...
class OAICollectionInfo : public OAIObject {
public:
    OAICollectionInfo();
    OAICollectionInfo(QString json);
    ~OAICollectionInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICollectionInfo)

#endif // OAICollectionInfo_H
