...
Q_SIGNALS:
    ...
    void getConfigSignal(OAIConfig summary);


    void getConfigSignalFull(OAIHttpRequestWorker *worker, OAIConfig summary);

    Q_DECL_DEPRECATED_X("Use getConfigSignalError() instead")
    void getConfigSignalE(OAIConfig summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getConfigSignalError(OAIConfig summary, QNetworkReply::NetworkError error_type, const QString &error_str);
