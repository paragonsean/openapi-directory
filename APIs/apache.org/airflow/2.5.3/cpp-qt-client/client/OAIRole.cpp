...
QList<OAIActionResource> OAIRole::getActions() const {
    return m_actions;
}
void OAIRole::setActions(const QList<OAIActionResource> &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIRole::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIRole::is_actions_Valid() const{
