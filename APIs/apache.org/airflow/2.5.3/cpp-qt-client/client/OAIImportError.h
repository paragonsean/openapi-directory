...
public:
    ...
    qint32 getImportErrorId() const;
    void setImportErrorId(const qint32 &import_error_id);
    bool is_import_error_id_Set() const;
    bool is_import_error_id_Valid() const;
...
private:
    ...
    qint32 m_import_error_id;
    bool m_import_error_id_isSet;
    bool m_import_error_id_isValid;
