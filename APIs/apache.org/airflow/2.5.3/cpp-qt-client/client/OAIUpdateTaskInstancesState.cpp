...
OAIUpdateTaskInstancesState::OAIUpdateTaskInstancesState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTaskInstancesState::OAIUpdateTaskInstancesState() {
    this->initializeModel();
}

OAIUpdateTaskInstancesState::~OAIUpdateTaskInstancesState() {}

void OAIUpdateTaskInstancesState::initializeModel() {
...
void OAIUpdateTaskInstancesState::fromJson(QString jsonString) {
...
void OAIUpdateTaskInstancesState::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateTaskInstancesState::asJson() const {
...
QJsonObject OAIUpdateTaskInstancesState::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateTaskInstancesState::getDagRunId() const {
    return m_dag_run_id;
}
void OAIUpdateTaskInstancesState::setDagRunId(const QString &dag_run_id) {
    m_dag_run_id = dag_run_id;
    m_dag_run_id_isSet = true;
}

bool OAIUpdateTaskInstancesState::is_dag_run_id_Set() const{
    return m_dag_run_id_isSet;
}

bool OAIUpdateTaskInstancesState::is_dag_run_id_Valid() const{
    return m_dag_run_id_isValid;
}

bool OAIUpdateTaskInstancesState::isDryRun() const {
    return m_dry_run;
}
void OAIUpdateTaskInstancesState::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIUpdateTaskInstancesState::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIUpdateTaskInstancesState::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

QString OAIUpdateTaskInstancesState::getExecutionDate() const {
    return m_execution_date;
}
void OAIUpdateTaskInstancesState::setExecutionDate(const QString &execution_date) {
    m_execution_date = execution_date;
    m_execution_date_isSet = true;
}

bool OAIUpdateTaskInstancesState::is_execution_date_Set() const{
    return m_execution_date_isSet;
}

bool OAIUpdateTaskInstancesState::is_execution_date_Valid() const{
    return m_execution_date_isValid;
}

bool OAIUpdateTaskInstancesState::isIncludeDownstream() const {
    return m_include_downstream;
}
void OAIUpdateTaskInstancesState::setIncludeDownstream(const bool &include_downstream) {
    m_include_downstream = include_downstream;
    m_include_downstream_isSet = true;
}

bool OAIUpdateTaskInstancesState::is_include_downstream_Set() const{
    return m_include_downstream_isSet;
}

bool OAIUpdateTaskInstancesState::is_include_downstream_Valid() const{
    return m_include_downstream_isValid;
}

bool OAIUpdateTaskInstancesState::isIncludeFuture() const {
    return m_include_future;
}
void OAIUpdateTaskInstancesState::setIncludeFuture(const bool &include_future) {
    m_include_future = include_future;
    m_include_future_isSet = true;
}

bool OAIUpdateTaskInstancesState::is_include_future_Set() const{
    return m_include_future_isSet;
}

bool OAIUpdateTaskInstancesState::is_include_future_Valid() const{
    return m_include_future_isValid;
}

bool OAIUpdateTaskInstancesState::isIncludePast() const {
    return m_include_past;
}
void OAIUpdateTaskInstancesState::setIncludePast(const bool &include_past) {
    m_include_past = include_past;
    m_include_past_isSet = true;
}

bool OAIUpdateTaskInstancesState::is_include_past_Set() const{
    return m_include_past_isSet;
}

bool OAIUpdateTaskInstancesState::is_include_past_Valid() const{
    return m_include_past_isValid;
}

bool OAIUpdateTaskInstancesState::isIncludeUpstream() const {
    return m_include_upstream;
}
void OAIUpdateTaskInstancesState::setIncludeUpstream(const bool &include_upstream) {
    m_include_upstream = include_upstream;
    m_include_upstream_isSet = true;
}

bool OAIUpdateTaskInstancesState::is_include_upstream_Set() const{
    return m_include_upstream_isSet;
}

bool OAIUpdateTaskInstancesState::is_include_upstream_Valid() const{
    return m_include_upstream_isValid;
}

QString OAIUpdateTaskInstancesState::getNewState() const {
    return m_new_state;
}
void OAIUpdateTaskInstancesState::setNewState(const QString &new_state) {
    m_new_state = new_state;
    m_new_state_isSet = true;
}

bool OAIUpdateTaskInstancesState::is_new_state_Set() const{
    return m_new_state_isSet;
}

bool OAIUpdateTaskInstancesState::is_new_state_Valid() const{
    return m_new_state_isValid;
}

QString OAIUpdateTaskInstancesState::getTaskId() const {
    return m_task_id;
}
void OAIUpdateTaskInstancesState::setTaskId(const QString &task_id) {
    m_task_id = task_id;
    m_task_id_isSet = true;
}

bool OAIUpdateTaskInstancesState::is_task_id_Set() const{
    return m_task_id_isSet;
}

bool OAIUpdateTaskInstancesState::is_task_id_Valid() const{
    return m_task_id_isValid;
}

bool OAIUpdateTaskInstancesState::isSet() const {
...
bool OAIUpdateTaskInstancesState::isValid() const {
