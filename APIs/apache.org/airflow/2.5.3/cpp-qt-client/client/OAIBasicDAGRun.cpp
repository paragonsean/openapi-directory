...
OAIBasicDAGRun::OAIBasicDAGRun(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBasicDAGRun::OAIBasicDAGRun() {
    this->initializeModel();
}

OAIBasicDAGRun::~OAIBasicDAGRun() {}

void OAIBasicDAGRun::initializeModel() {
...
void OAIBasicDAGRun::fromJson(QString jsonString) {
...
void OAIBasicDAGRun::fromJsonObject(QJsonObject json) {
...
QString OAIBasicDAGRun::asJson() const {
...
QJsonObject OAIBasicDAGRun::asJsonObject() const {
    QJsonObject obj;
    if (m_dag_id_isSet) {
...
QString OAIBasicDAGRun::getDagId() const {
    return m_dag_id;
}
void OAIBasicDAGRun::setDagId(const QString &dag_id) {
    m_dag_id = dag_id;
    m_dag_id_isSet = true;
}

bool OAIBasicDAGRun::is_dag_id_Set() const{
    return m_dag_id_isSet;
}

bool OAIBasicDAGRun::is_dag_id_Valid() const{
    return m_dag_id_isValid;
}

QDateTime OAIBasicDAGRun::getDataIntervalEnd() const {
    return m_data_interval_end;
}
void OAIBasicDAGRun::setDataIntervalEnd(const QDateTime &data_interval_end) {
    m_data_interval_end = data_interval_end;
    m_data_interval_end_isSet = true;
}

bool OAIBasicDAGRun::is_data_interval_end_Set() const{
    return m_data_interval_end_isSet;
}

bool OAIBasicDAGRun::is_data_interval_end_Valid() const{
    return m_data_interval_end_isValid;
}

QDateTime OAIBasicDAGRun::getDataIntervalStart() const {
    return m_data_interval_start;
}
void OAIBasicDAGRun::setDataIntervalStart(const QDateTime &data_interval_start) {
    m_data_interval_start = data_interval_start;
    m_data_interval_start_isSet = true;
}

bool OAIBasicDAGRun::is_data_interval_start_Set() const{
    return m_data_interval_start_isSet;
}

bool OAIBasicDAGRun::is_data_interval_start_Valid() const{
    return m_data_interval_start_isValid;
}

QDateTime OAIBasicDAGRun::getEndDate() const {
    return m_end_date;
}
void OAIBasicDAGRun::setEndDate(const QDateTime &end_date) {
    m_end_date = end_date;
    m_end_date_isSet = true;
}

bool OAIBasicDAGRun::is_end_date_Set() const{
    return m_end_date_isSet;
}

bool OAIBasicDAGRun::is_end_date_Valid() const{
    return m_end_date_isValid;
}

QDateTime OAIBasicDAGRun::getLogicalDate() const {
    return m_logical_date;
}
void OAIBasicDAGRun::setLogicalDate(const QDateTime &logical_date) {
    m_logical_date = logical_date;
    m_logical_date_isSet = true;
}

bool OAIBasicDAGRun::is_logical_date_Set() const{
    return m_logical_date_isSet;
}

bool OAIBasicDAGRun::is_logical_date_Valid() const{
    return m_logical_date_isValid;
}

QString OAIBasicDAGRun::getRunId() const {
    return m_run_id;
}
void OAIBasicDAGRun::setRunId(const QString &run_id) {
    m_run_id = run_id;
    m_run_id_isSet = true;
}

bool OAIBasicDAGRun::is_run_id_Set() const{
    return m_run_id_isSet;
}

bool OAIBasicDAGRun::is_run_id_Valid() const{
    return m_run_id_isValid;
}

QDateTime OAIBasicDAGRun::getStartDate() const {
    return m_start_date;
}
void OAIBasicDAGRun::setStartDate(const QDateTime &start_date) {
    m_start_date = start_date;
    m_start_date_isSet = true;
}

bool OAIBasicDAGRun::is_start_date_Set() const{
    return m_start_date_isSet;
}

bool OAIBasicDAGRun::is_start_date_Valid() const{
    return m_start_date_isValid;
}

OAIDagState OAIBasicDAGRun::getState() const {
    return m_state;
}
void OAIBasicDAGRun::setState(const OAIDagState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIBasicDAGRun::is_state_Set() const{
    return m_state_isSet;
}

bool OAIBasicDAGRun::is_state_Valid() const{
    return m_state_isValid;
}

bool OAIBasicDAGRun::isSet() const {
...
bool OAIBasicDAGRun::isValid() const {
