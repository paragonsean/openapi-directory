...
#ifndef OAIConnectionCollectionItem_H
#define OAIConnectionCollectionItem_H
...
class OAIConnectionCollectionItem : public OAIObject {
public:
    OAIConnectionCollectionItem();
    OAIConnectionCollectionItem(QString json);
    ~OAIConnectionCollectionItem() override;
    ...
    QString getConnType() const;
    void setConnType(const QString &conn_type);
    bool is_conn_type_Set() const;
    bool is_conn_type_Valid() const;
...
private:
    ...
    QString m_conn_type;
    bool m_conn_type_isSet;
    bool m_conn_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionCollectionItem)

#endif // OAIConnectionCollectionItem_H
