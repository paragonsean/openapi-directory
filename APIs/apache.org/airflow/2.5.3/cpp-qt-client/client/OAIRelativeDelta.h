...
#ifndef OAIRelativeDelta_H
#define OAIRelativeDelta_H
...
class OAIRelativeDelta : public OAIObject {
public:
    OAIRelativeDelta();
    OAIRelativeDelta(QString json);
    ~OAIRelativeDelta() override;
    ...
    void setType(const QString &__type);
    bool is___type_Set() const;
    bool is___type_Valid() const;
    ...
    qint32 getLeapdays() const;
    void setLeapdays(const qint32 &leapdays);
    bool is_leapdays_Set() const;
    bool is_leapdays_Valid() const;

    qint32 getMicrosecond() const;
    void setMicrosecond(const qint32 &microsecond);
    bool is_microsecond_Set() const;
    bool is_microsecond_Valid() const;
    ...
    qint32 getMonths() const;
    void setMonths(const qint32 &months);
...
private:
    ...
    qint32 m_leapdays;
    bool m_leapdays_isSet;
    bool m_leapdays_isValid;

    qint32 m_microsecond;
    bool m_microsecond_isSet;
    bool m_microsecond_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRelativeDelta)

#endif // OAIRelativeDelta_H
