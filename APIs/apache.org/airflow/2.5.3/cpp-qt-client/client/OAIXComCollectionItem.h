...
class OAIXComCollectionItem : public OAIObject {
public:
    OAIXComCollectionItem();
    OAIXComCollectionItem(QString json);
    ~OAIXComCollectionItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXComCollectionItem)

#endif // OAIXComCollectionItem_H
