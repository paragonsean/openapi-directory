...
void OAIVersionInfo::initializeModel() {
    ...
    m_git_version_isSet = false;
    m_git_version_isValid = false;
...
void OAIVersionInfo::fromJsonObject(QJsonObject json) {
    ...
    m_git_version_isValid = ::OpenAPI::fromJsonValue(m_git_version, json[QString("git_version")]);
    m_git_version_isSet = !json[QString("git_version")].isNull() && m_git_version_isValid;
...
QJsonObject OAIVersionInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_git_version_isSet) {
        obj.insert(QString("git_version"), ::OpenAPI::toJsonValue(m_git_version));
    }
    if (m_version_isSet) {
...
QString OAIVersionInfo::getGitVersion() const {
    return m_git_version;
}
void OAIVersionInfo::setGitVersion(const QString &git_version) {
    m_git_version = git_version;
    m_git_version_isSet = true;
}

bool OAIVersionInfo::is_git_version_Set() const{
    return m_git_version_isSet;
}

bool OAIVersionInfo::is_git_version_Valid() const{
    return m_git_version_isValid;
}
