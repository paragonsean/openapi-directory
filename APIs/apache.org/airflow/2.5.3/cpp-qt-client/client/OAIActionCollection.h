...
/*
 * OAIActionCollection.h
 *
 * A collection of actions.  *New in version 2.1.0* 
 */

#ifndef OAIActionCollection_H
#define OAIActionCollection_H
...
class OAIActionCollection : public OAIObject {
public:
    OAIActionCollection();
    OAIActionCollection(QString json);
    ~OAIActionCollection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionCollection)

#endif // OAIActionCollection_H
