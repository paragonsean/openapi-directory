...
#include "OAIUserCollectionItem.h"
#include <QString>
...
public:
    ...
    */
    virtual void getUsers(const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &offset = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &order_by = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void patchUser(const QString &username, const OAIUser &oai_user, const ::OpenAPI::OptionalParam<QList<QString>> &update_mask = ::OpenAPI::OptionalParam<QList<QString>>());

    /**
    * @param[in]  oai_user OAIUser [required]
    */
    virtual void postUser(const OAIUser &oai_user);
...
Q_SIGNALS:
    ...
    void getUserSignal(OAIUserCollectionItem summary);
    void getUsersSignal(OAIUserCollection summary);
    void patchUserSignal(OAIUserCollectionItem summary);
    void postUserSignal(OAIUser summary);


    void deleteUserSignalFull(OAIHttpRequestWorker *worker);
    void getUserSignalFull(OAIHttpRequestWorker *worker, OAIUserCollectionItem summary);
    void getUsersSignalFull(OAIHttpRequestWorker *worker, OAIUserCollection summary);
    void patchUserSignalFull(OAIHttpRequestWorker *worker, OAIUserCollectionItem summary);
    void postUserSignalFull(OAIHttpRequestWorker *worker, OAIUser summary);
    ...
    void getUserSignalE(OAIUserCollectionItem summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getUserSignalError(OAIUserCollectionItem summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void patchUserSignalE(OAIUserCollectionItem summary, QNetworkReply::NetworkError error_type, QString error_str);
    void patchUserSignalError(OAIUserCollectionItem summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postUserSignalError() instead")
    void postUserSignalE(OAIUser summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postUserSignalError(OAIUser summary, QNetworkReply::NetworkError error_type, const QString &error_str);
