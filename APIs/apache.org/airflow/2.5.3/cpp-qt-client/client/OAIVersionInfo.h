...
public:
    ...
    void setGitVersion(const QString &git_version);
    bool is_git_version_Set() const;
    bool is_git_version_Valid() const;
...
private:
    ...
    QString m_git_version;
    bool m_git_version_isSet;
    bool m_git_version_isValid;
