...
#ifndef OAIEventLog_H
#define OAIEventLog_H
...
class OAIEventLog : public OAIObject {
public:
    OAIEventLog();
    OAIEventLog(QString json);
    ~OAIEventLog() override;
    ...
    qint32 getEventLogId() const;
    void setEventLogId(const qint32 &event_log_id);
    bool is_event_log_id_Set() const;
    bool is_event_log_id_Valid() const;
...
private:
    ...
    qint32 m_event_log_id;
    bool m_event_log_id_isSet;
    bool m_event_log_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventLog)
