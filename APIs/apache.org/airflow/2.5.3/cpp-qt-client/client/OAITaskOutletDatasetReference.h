...
/*
 * OAITaskOutletDatasetReference.h
 *
 * A datasets reference to an upstream task.  *New in version 2.4.0* 
 */

#ifndef OAITaskOutletDatasetReference_H
#define OAITaskOutletDatasetReference_H
...
class OAITaskOutletDatasetReference : public OAIObject {
public:
    OAITaskOutletDatasetReference();
    OAITaskOutletDatasetReference(QString json);
    ~OAITaskOutletDatasetReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskOutletDatasetReference)

#endif // OAITaskOutletDatasetReference_H
