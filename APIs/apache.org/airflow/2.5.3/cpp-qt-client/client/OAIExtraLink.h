...
#ifndef OAIExtraLink_H
#define OAIExtraLink_H
...
class OAIExtraLink : public OAIObject {
public:
    OAIExtraLink();
    OAIExtraLink(QString json);
    ~OAIExtraLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtraLink)

#endif // OAIExtraLink_H
