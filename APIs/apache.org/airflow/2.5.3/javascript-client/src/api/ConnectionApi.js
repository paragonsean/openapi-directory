...
export default class ConnectionApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ConnectionTest} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ConnectionTest}
     */
    testConnection(connection, callback) {
      let postBody = connection;
      // verify the required parameter 'connection' is set
      if (connection === undefined || connection === null) {
        throw new Error("Missing the required parameter 'connection' when calling testConnection");
      }
