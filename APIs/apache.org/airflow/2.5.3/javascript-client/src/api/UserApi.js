...
export default class UserApi {
    ...
    */
     ...
     * @param {String} username The username of the user.  *New in version 2.1.0* 
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/UserCollectionItem} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/UserCollectionItem}
     */
    getUser(username, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = UserCollectionItem;
      return this.apiClient.callApi(
        '/users/{username}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
     ...
     * data is of type: {@link module:model/UserCollectionItem}
     */
    patchUser(username, user, opts, callback) {
      opts = opts || {};
      let postBody = user;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling patchUser");
      }
      // verify the required parameter 'user' is set
      if (user === undefined || user === null) {
        throw new Error("Missing the required parameter 'user' when calling patchUser");
      }
