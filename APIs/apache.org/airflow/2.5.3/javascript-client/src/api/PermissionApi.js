...
export default class PermissionApi {
    ...
    */
     ...
     * @param {module:model/ActionCollection} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/ActionCollection}
     */
    getPermissions(opts, callback) {
      ...
      let returnType = ActionCollection;
