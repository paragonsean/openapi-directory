...
class ActionResource {
    ...
    constructor() { 
        ...
        ActionResource.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ActionResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionResource</code>.
     */
 ...
 */
ActionResource.prototype['action'] = undefined;

/**
 * @member {module:model/Resource} resource
 */
ActionResource.prototype['resource'] = undefined;
