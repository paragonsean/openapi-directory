...
class VersionInfo {
    ...
    static validateJSON(data) {
        ...
        if (data['git_version'] && !(typeof data['git_version'] === 'string' || data['git_version'] instanceof String)) {
            throw new Error("Expected the field `git_version` to be a primitive type in the JSON string but got " + data['git_version']);
        }
        // ensure the json data is a string
