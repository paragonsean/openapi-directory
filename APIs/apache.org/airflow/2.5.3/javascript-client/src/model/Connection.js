...
class Connection {
     ...
     */
    constructor() { 
        ConnectionCollectionItem.initialize(this);
    ...
    static validateJSON(data) {
        ...
        if (data['conn_type'] && !(typeof data['conn_type'] === 'string' || data['conn_type'] instanceof String)) {
            throw new Error("Expected the field `conn_type` to be a primitive type in the JSON string but got " + data['conn_type']);
        }
        // ensure the json data is a string
 ...
 * @member {String} description
 */
ConnectionCollectionItem.prototype['description'] = undefined;
/**
 * Host of the connection.
 * @member {String} host
 */
