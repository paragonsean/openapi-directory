    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('users')) {
                obj['users'] = ApiClient.convertToType(data['users'], [UserCollectionItem]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        if (data['users']) { // data not null
            ...
            for (const item of data['users']) {
                UserCollectionItem.validateJSON(item);
            };
        }
 ...
 */
UserCollection.prototype['total_entries'] = undefined;

/**
 * @member {Array.<module:model/UserCollectionItem>} users
 */
UserCollection.prototype['users'] = undefined;
