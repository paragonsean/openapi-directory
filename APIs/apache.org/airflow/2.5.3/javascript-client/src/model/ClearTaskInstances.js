...
/**
 * The ClearTaskInstances model module.
 * @module model/ClearTaskInstances
 * @version 2.5.3
 */
class ClearTaskInstances {
    /**
     * Constructs a new <code>ClearTaskInstances</code>.
     * @alias module:model/ClearTaskInstances
     */
    constructor() { 
        
        ClearTaskInstances.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['dry_run'] = true;
        obj['include_downstream'] = false;
        obj['include_future'] = false;
        obj['include_past'] = false;
        obj['include_upstream'] = false;
        obj['only_failed'] = true;
        obj['only_running'] = false;
    }

    /**
     * Constructs a <code>ClearTaskInstances</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClearTaskInstances} obj Optional instance to populate.
     * @return {module:model/ClearTaskInstances} The populated <code>ClearTaskInstances</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClearTaskInstances();
            ...
            if (data.hasOwnProperty('include_downstream')) {
                obj['include_downstream'] = ApiClient.convertToType(data['include_downstream'], 'Boolean');
            }
            if (data.hasOwnProperty('include_future')) {
                obj['include_future'] = ApiClient.convertToType(data['include_future'], 'Boolean');
            }
            if (data.hasOwnProperty('include_parentdag')) {
                obj['include_parentdag'] = ApiClient.convertToType(data['include_parentdag'], 'Boolean');
            }
            if (data.hasOwnProperty('include_past')) {
                obj['include_past'] = ApiClient.convertToType(data['include_past'], 'Boolean');
            }
            if (data.hasOwnProperty('include_subdags')) {
                obj['include_subdags'] = ApiClient.convertToType(data['include_subdags'], 'Boolean');
            }
            if (data.hasOwnProperty('include_upstream')) {
                obj['include_upstream'] = ApiClient.convertToType(data['include_upstream'], 'Boolean');
            }
            if (data.hasOwnProperty('only_failed')) {
                obj['only_failed'] = ApiClient.convertToType(data['only_failed'], 'Boolean');
            }
            if (data.hasOwnProperty('only_running')) {
                obj['only_running'] = ApiClient.convertToType(data['only_running'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ClearTaskInstances</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClearTaskInstances</code>.
     */
 ...
 */
ClearTaskInstances.prototype['dag_run_id'] = undefined;
 ...
 * @default true
 */
ClearTaskInstances.prototype['dry_run'] = true;

/**
 * The maximum execution date to clear.
 * @member {String} end_date
 */
ClearTaskInstances.prototype['end_date'] = undefined;

/**
 * If set to true, downstream tasks are also affected.
 * @member {Boolean} include_downstream
 * @default false
 */
ClearTaskInstances.prototype['include_downstream'] = false;

/**
 * If set to True, also tasks from future DAG Runs are affected.
 * @member {Boolean} include_future
 * @default false
 */
ClearTaskInstances.prototype['include_future'] = false;

/**
 * Clear tasks in the parent dag of the subdag.
 * @member {Boolean} include_parentdag
 */
ClearTaskInstances.prototype['include_parentdag'] = undefined;

/**
 * If set to True, also tasks from past DAG Runs are affected.
 * @member {Boolean} include_past
 * @default false
 */
ClearTaskInstances.prototype['include_past'] = false;

/**
 * Clear tasks in subdags and clear external tasks indicated by ExternalTaskMarker.
 * @member {Boolean} include_subdags
 */
ClearTaskInstances.prototype['include_subdags'] = undefined;

/**
 * If set to true, upstream tasks are also affected.
 * @member {Boolean} include_upstream
 * @default false
 */
ClearTaskInstances.prototype['include_upstream'] = false;

/**
 * Only clear failed tasks.
 * @member {Boolean} only_failed
 * @default true
 */
ClearTaskInstances.prototype['only_failed'] = true;

/**
 * Only clear running tasks.
 * @member {Boolean} only_running
 * @default false
 */
ClearTaskInstances.prototype['only_running'] = false;

/**
 * Set state of DAG runs to RUNNING.
 * @member {Boolean} reset_dag_runs
 */
ClearTaskInstances.prototype['reset_dag_runs'] = undefined;

/**
 * The minimum execution date to clear.
 * @member {String} start_date
 */
ClearTaskInstances.prototype['start_date'] = undefined;

/**
 * A list of task ids to clear.  *New in version 2.1.0* 
 * @member {Array.<String>} task_ids
 */
ClearTaskInstances.prototype['task_ids'] = undefined;
...
export default ClearTaskInstances;
