    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('actions')) {
                obj['actions'] = ApiClient.convertToType(data['actions'], [ActionResource]);
            }
    ...
    static validateJSON(data) {
        if (data['actions']) { // data not null
            ...
            for (const item of data['actions']) {
                ActionResource.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/ActionResource>} actions
 */
Role.prototype['actions'] = undefined;
