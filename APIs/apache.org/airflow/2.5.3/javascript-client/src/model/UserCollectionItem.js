...
/**
 * The UserCollectionItem model module.
 * @module model/UserCollectionItem
 * @version 2.5.3
 */
class UserCollectionItem {
    /**
     * Constructs a new <code>UserCollectionItem</code>.
     * A user object.  *New in version 2.1.0* 
     * @alias module:model/UserCollectionItem
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>UserCollectionItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserCollectionItem} obj Optional instance to populate.
     * @return {module:model/UserCollectionItem} The populated <code>UserCollectionItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserCollectionItem();
    ...
    /**
     * Validates the JSON data with respect to <code>UserCollectionItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserCollectionItem</code>.
     */
