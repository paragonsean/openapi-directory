...
class ListTaskInstanceForm {
    ...
    /**
     * Validates the JSON data with respect to <code>ListTaskInstanceForm</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTaskInstanceForm</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['dag_ids'])) {
            throw new Error("Expected the field `dag_ids` to be an array in the JSON data but got " + data['dag_ids']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['pool'])) {
            throw new Error("Expected the field `pool` to be an array in the JSON data but got " + data['pool']);
        }
        // ensure the json data is an array
...
/**
 * The value can be repeated to retrieve multiple matching values (OR condition).
 * @member {Array.<module:model/TaskState>} state
 */
