...
class Trigger {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('classpath')) {
                obj['classpath'] = ApiClient.convertToType(data['classpath'], 'String');
            }
            ...
            if (data.hasOwnProperty('kwargs')) {
                obj['kwargs'] = ApiClient.convertToType(data['kwargs'], 'String');
            }
            if (data.hasOwnProperty('triggerer_id')) {
                obj['triggerer_id'] = ApiClient.convertToType(data['triggerer_id'], 'Number');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['classpath'] && !(typeof data['classpath'] === 'string' || data['classpath'] instanceof String)) {
            throw new Error("Expected the field `classpath` to be a primitive type in the JSON string but got " + data['classpath']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['kwargs'] && !(typeof data['kwargs'] === 'string' || data['kwargs'] instanceof String)) {
            throw new Error("Expected the field `kwargs` to be a primitive type in the JSON string but got " + data['kwargs']);
        }
...
/**
 * @member {String} classpath
 */
Trigger.prototype['classpath'] = undefined;

/**
 * @member {String} created_date
 */
Trigger.prototype['created_date'] = undefined;
...
/**
 * @member {String} kwargs
 */
Trigger.prototype['kwargs'] = undefined;

/**
 * @member {Number} triggerer_id
 */
Trigger.prototype['triggerer_id'] = undefined;
