...
**failedLoginCount** | **Number** | The number of times the login failed | [optional] [readonly] 
...
**loginCount** | **Number** | The login count | [optional] [readonly] 
**roles** | [**[UserCollectionItemRolesInner]**](UserCollectionItemRolesInner.md) | User roles.  *Changed in version 2.2.0*&amp;#58; Field is no longer read-only.  | [optional] 
