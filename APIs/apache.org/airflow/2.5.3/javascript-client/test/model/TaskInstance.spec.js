...
(function(root, factory) {
  ...
  describe('TaskInstance', function() {
    it('should create an instance of TaskInstance', function() {
      ...
      //var instance = new AirflowApiStable.TaskInstance();
    ...
    it('should have the property mapIndex (base name: "map_index")', function() {
      // uncomment below and update the code to test the property mapIndex
      //var instance = new AirflowApiStable.TaskInstance();
      //expect(instance).to.be();
    });
    ...
    it('should have the property renderedFields (base name: "rendered_fields")', function() {
    ...
    it('should have the property triggererJob (base name: "triggerer_job")', function() {
      // uncomment below and update the code to test the property triggererJob
      //var instance = new AirflowApiStable.TaskInstance();
      //expect(instance).to.be();
    });
