...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirflowApiStable.UserCollectionItem();
  });
  ...
  describe('UserCollectionItem', function() {
    it('should create an instance of UserCollectionItem', function() {
      // uncomment below and update the code to test UserCollectionItem
      //var instance = new AirflowApiStable.UserCollectionItem();
      //expect(instance).to.be.a(AirflowApiStable.UserCollectionItem);
    });
