...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirflowApiStable.User();
  });
  ...
  describe('User', function() {
    it('should create an instance of User', function() {
      ...
      //var instance = new AirflowApiStable.User();
      //expect(instance).to.be.a(AirflowApiStable.User);
    });
    ...
    it('should have the property failedLoginCount (base name: "failed_login_count")', function() {
