...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirflowApiStable.UpdateTaskInstance();
  });
  ...
  describe('UpdateTaskInstance', function() {
    it('should create an instance of UpdateTaskInstance', function() {
      // uncomment below and update the code to test UpdateTaskInstance
      //var instance = new AirflowApiStable.UpdateTaskInstance();
      //expect(instance).to.be.a(AirflowApiStable.UpdateTaskInstance);
    });
