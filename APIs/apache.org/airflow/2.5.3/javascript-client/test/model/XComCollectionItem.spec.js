...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirflowApiStable.XComCollectionItem();
  });
  ...
  describe('XComCollectionItem', function() {
    it('should create an instance of XComCollectionItem', function() {
      // uncomment below and update the code to test XComCollectionItem
      //var instance = new AirflowApiStable.XComCollectionItem();
      //expect(instance).to.be.a(AirflowApiStable.XComCollectionItem);
    });
