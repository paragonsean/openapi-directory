...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirflowApiStable.TaskInstanceReference();
  });
  ...
  describe('TaskInstanceReference', function() {
    it('should create an instance of TaskInstanceReference', function() {
      // uncomment below and update the code to test TaskInstanceReference
      //var instance = new AirflowApiStable.TaskInstanceReference();
      //expect(instance).to.be.a(AirflowApiStable.TaskInstanceReference);
    });
