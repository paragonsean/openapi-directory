  ...
  describe('ConnectionApi', function() {
    ...
    describe('patchConnection', function() {
      it('should call patchConnection successfully', function(done) {
        //uncomment below and update the code to test patchConnection
        //instance.patchConnection(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postConnection', function() {
      it('should call postConnection successfully', function(done) {
        //uncomment below and update the code to test postConnection
        //instance.postConnection(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
