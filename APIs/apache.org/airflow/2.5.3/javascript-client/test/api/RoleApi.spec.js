...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirflowApiStable.RoleApi();
  });
  ...
  describe('RoleApi', function() {
    ...
    describe('patchRole', function() {
      it('should call patchRole successfully', function(done) {
        //uncomment below and update the code to test patchRole
        //instance.patchRole(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postRole', function() {
      it('should call postRole successfully', function(done) {
        //uncomment below and update the code to test postRole
        //instance.postRole(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
