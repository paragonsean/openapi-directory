...
public class Job {
  ...
  public void setLatestHeartbeat(String latestHeartbeat) {
    this.latestHeartbeat = latestHeartbeat;
  }
  ...
  public boolean equals(Object o) {
    ...
    Job job = (Job) o;
    return Objects.equals(this.dagId, job.dagId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dagId, endDate, executorClass, hostname, id, jobType, latestHeartbeat, startDate, state, unixname);
  }
  ...
  static {
    ...
    openapiFields.add("executor_class");
    openapiFields.add("hostname");
    openapiFields.add("id");
    openapiFields.add("job_type");
    openapiFields.add("latest_heartbeat");
