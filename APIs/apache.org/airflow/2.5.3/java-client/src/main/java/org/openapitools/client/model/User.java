...
public class User {
  ...
  public User roles(List<UserCollectionItemRolesInner> roles) {
    this.roles = roles;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, changedOn, createdOn, email, failedLoginCount, firstName, lastLogin, lastName, loginCount, roles, username, password);
  }
