...
public class UserApi {
    ...
    private okhttp3.Call getUsersValidateBeforeCall(Integer limit, Integer offset, String orderBy, final ApiCallback _callback) throws ApiException {
        return getUsersCall(limit, offset, orderBy, _callback);
    ...
    private okhttp3.Call patchUserValidateBeforeCall(String username, User user, List<String> updateMask, final ApiCallback _callback) throws ApiException {
        ...
        return patchUserCall(username, user, updateMask, _callback);
     ...
     */
    public UserCollectionItem patchUser(String username, User user, List<String> updateMask) throws ApiException {
        ApiResponse<UserCollectionItem> localVarResp = patchUserWithHttpInfo(username, user, updateMask);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UserCollectionItem> patchUserWithHttpInfo(String username, User user, List<String> updateMask) throws ApiException {
     ...
     */
    public okhttp3.Call patchUserAsync(String username, User user, List<String> updateMask, final ApiCallback<UserCollectionItem> _callback) throws ApiException {
    ...
    private okhttp3.Call postUserValidateBeforeCall(User user, final ApiCallback _callback) throws ApiException {
        ...
        return postUserCall(user, _callback);
