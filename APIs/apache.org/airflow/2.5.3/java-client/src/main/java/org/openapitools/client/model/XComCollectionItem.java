...
public class XComCollectionItem {
   ...
   * @throws IOException if the JSON Element is invalid with respect to XComCollectionItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XComCollectionItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XComCollectionItem is not found in the empty JSON string", XComCollectionItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XComCollectionItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XComCollectionItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XComCollectionItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XComCollectionItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XComCollectionItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XComCollectionItem.class));

       return (TypeAdapter<T>) new TypeAdapter<XComCollectionItem>() {
           @Override
           public void write(JsonWriter out, XComCollectionItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XComCollectionItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XComCollectionItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XComCollectionItem
   * @throws IOException if the JSON string is invalid with respect to XComCollectionItem
   */
  public static XComCollectionItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XComCollectionItem.class);
  }

  /**
   * Convert an instance of XComCollectionItem to an JSON string
   *
   * @return JSON string
   */
