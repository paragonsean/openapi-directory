...
public class PluginCollectionItem {
  ...
  private List<Object> flaskBlueprints = new ArrayList<>();
  ...
  private List<Object> globalOperatorExtraLinks = new ArrayList<>();
  ...
  private List<Object> macros = new ArrayList<>();
  ...
  private List<Object> operatorExtraLinks = new ArrayList<>();
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appbuilderMenuItems, appbuilderViews, executors, flaskBlueprints, globalOperatorExtraLinks, hooks, macros, name, operatorExtraLinks, source);
  }
  ...
  static {
    ...
    openapiFields.add("appbuilder_menu_items");
    openapiFields.add("appbuilder_views");
    openapiFields.add("executors");
    openapiFields.add("flask_blueprints");
    openapiFields.add("global_operator_extra_links");
    openapiFields.add("hooks");
    openapiFields.add("macros");
    openapiFields.add("name");
    openapiFields.add("operator_extra_links");
