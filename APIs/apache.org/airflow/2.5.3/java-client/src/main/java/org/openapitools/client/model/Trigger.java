...
public class Trigger {
  public static final String SERIALIZED_NAME_CLASSPATH = "classpath";
  @SerializedName(SERIALIZED_NAME_CLASSPATH)
  ...
  public static final String SERIALIZED_NAME_TRIGGERER_ID = "triggerer_id";
  @SerializedName(SERIALIZED_NAME_TRIGGERER_ID)
   ...
   */
  @javax.annotation.Nullable
  public Integer getTriggererId() {
    return triggererId;
  }

  public void setTriggererId(Integer triggererId) {
    this.triggererId = triggererId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.classpath, trigger.classpath) &&
        ...
        Objects.equals(this.triggererId, trigger.triggererId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(classpath, createdDate, id, kwargs, triggererId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("classpath") != null && !jsonObj.get("classpath").isJsonNull()) && !jsonObj.get("classpath").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `classpath` to be a primitive type in the JSON string but got `%s`", jsonObj.get("classpath").toString()));
      }
      ...
      if ((jsonObj.get("kwargs") != null && !jsonObj.get("kwargs").isJsonNull()) && !jsonObj.get("kwargs").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `kwargs` to be a primitive type in the JSON string but got `%s`", jsonObj.get("kwargs").toString()));
      }
  }
