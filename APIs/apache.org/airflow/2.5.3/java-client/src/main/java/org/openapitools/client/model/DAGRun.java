...
public class DAGRun {
  ...
  public static final String SERIALIZED_NAME_DATA_INTERVAL_END = "data_interval_end";
  @SerializedName(SERIALIZED_NAME_DATA_INTERVAL_END)
  private OffsetDateTime dataIntervalEnd;

  public static final String SERIALIZED_NAME_DATA_INTERVAL_START = "data_interval_start";
  @SerializedName(SERIALIZED_NAME_DATA_INTERVAL_START)
  ...
  public static final String SERIALIZED_NAME_LAST_SCHEDULING_DECISION = "last_scheduling_decision";
  @SerializedName(SERIALIZED_NAME_LAST_SCHEDULING_DECISION)
  ...
  public DAGRun(
     String dagId, 
     OffsetDateTime dataIntervalEnd, 
     OffsetDateTime dataIntervalStart, 
     OffsetDateTime endDate, 
     Boolean externalTrigger, 
     OffsetDateTime lastSchedulingDecision, 
     RunTypeEnum runType, 
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.conf, daGRun.conf) &&
        ...
        Objects.equals(this.dagRunId, daGRun.dagRunId) &&
        ...
        Objects.equals(this.note, daGRun.note) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(conf, dagId, dagRunId, dataIntervalEnd, dataIntervalStart, endDate, executionDate, externalTrigger, lastSchedulingDecision, logicalDate, note, runType, startDate, state);
  }
  ...
  static {
    ...
    openapiFields.add("data_interval_end");
    openapiFields.add("data_interval_start");
    openapiFields.add("end_date");
    openapiFields.add("execution_date");
    openapiFields.add("external_trigger");
    openapiFields.add("last_scheduling_decision");
    openapiFields.add("logical_date");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DAGRun
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DAGRun.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DAGRun is not found in the empty JSON string", DAGRun.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DAGRun.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DAGRun` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("state") != null && !jsonObj.get("state").isJsonNull()) {
        DagState.validateJsonElement(jsonObj.get("state"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DAGRun.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DAGRun' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DAGRun> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DAGRun.class));

       return (TypeAdapter<T>) new TypeAdapter<DAGRun>() {
           @Override
           public void write(JsonWriter out, DAGRun value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DAGRun read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DAGRun given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DAGRun
   * @throws IOException if the JSON string is invalid with respect to DAGRun
   */
  public static DAGRun fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DAGRun.class);
  }

  /**
   * Convert an instance of DAGRun to an JSON string
   *
   * @return JSON string
   */
