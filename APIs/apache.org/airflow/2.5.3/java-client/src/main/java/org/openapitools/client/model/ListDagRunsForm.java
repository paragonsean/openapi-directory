...
public class ListDagRunsForm {
  ...
  static {
    ...
    openapiFields.add("dag_ids");
    openapiFields.add("end_date_gte");
    openapiFields.add("end_date_lte");
    openapiFields.add("execution_date_gte");
    openapiFields.add("execution_date_lte");
    openapiFields.add("order_by");
    openapiFields.add("page_limit");
    openapiFields.add("page_offset");
    openapiFields.add("start_date_gte");
    openapiFields.add("start_date_lte");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListDagRunsForm
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDagRunsForm.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListDagRunsForm is not found in the empty JSON string", ListDagRunsForm.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDagRunsForm.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListDagRunsForm` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDagRunsForm.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDagRunsForm' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDagRunsForm> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDagRunsForm.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDagRunsForm>() {
           @Override
           public void write(JsonWriter out, ListDagRunsForm value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDagRunsForm read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListDagRunsForm given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListDagRunsForm
   * @throws IOException if the JSON string is invalid with respect to ListDagRunsForm
   */
  public static ListDagRunsForm fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDagRunsForm.class);
  }

  /**
   * Convert an instance of ListDagRunsForm to an JSON string
   *
   * @return JSON string
   */
