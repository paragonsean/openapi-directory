...
public class Task {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(classRef, dependsOnPast, downstreamTaskIds, endDate, executionTimeout, extraLinks, isMapped, owner, pool, poolSlots, priorityWeight, queue, retries, retryDelay, retryExponentialBackoff, startDate, subDag, taskId, templateFields, triggerRule, uiColor, uiFgcolor, waitForDownstream, weightRule);
  }
  ...
  static {
    ...
    openapiFields.add("depends_on_past");
    openapiFields.add("downstream_task_ids");
    openapiFields.add("end_date");
    openapiFields.add("execution_timeout");
    openapiFields.add("extra_links");
    openapiFields.add("is_mapped");
    ...
    openapiFields.add("retry_delay");
    openapiFields.add("retry_exponential_backoff");
    openapiFields.add("start_date");
    openapiFields.add("sub_dag");
    openapiFields.add("task_id");
    openapiFields.add("template_fields");
    openapiFields.add("trigger_rule");
    openapiFields.add("ui_color");
    openapiFields.add("ui_fgcolor");
    openapiFields.add("wait_for_downstream");
    openapiFields.add("weight_rule");
