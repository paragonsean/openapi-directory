...
public class XComApi {
     ...
     */
    public okhttp3.Call getXcomEntriesCall(String dagId, String dagRunId, String taskId, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getXcomEntriesValidateBeforeCall(String dagId, String dagRunId, String taskId, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        ...
        return getXcomEntriesCall(dagId, dagRunId, taskId, limit, offset, _callback);
    ...
    public XComCollection getXcomEntries(String dagId, String dagRunId, String taskId, Integer limit, Integer offset) throws ApiException {
        ApiResponse<XComCollection> localVarResp = getXcomEntriesWithHttpInfo(dagId, dagRunId, taskId, limit, offset);
    ...
    public ApiResponse<XComCollection> getXcomEntriesWithHttpInfo(String dagId, String dagRunId, String taskId, Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = getXcomEntriesValidateBeforeCall(dagId, dagRunId, taskId, limit, offset, null);
     ...
     */
    public okhttp3.Call getXcomEntriesAsync(String dagId, String dagRunId, String taskId, Integer limit, Integer offset, final ApiCallback<XComCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getXcomEntriesValidateBeforeCall(dagId, dagRunId, taskId, limit, offset, _callback);
        Type localVarReturnType = new TypeToken<XComCollection>(){}.getType();
     ...
     */
    public okhttp3.Call getXcomEntryCall(String dagId, String dagRunId, String taskId, String xcomKey, Boolean deserialize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        String localVarPath = "/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/xcomEntries/{xcom_key}"
            ...
            .replace("{" + "dag_run_id" + "}", localVarApiClient.escapeString(dagRunId.toString()))
            .replace("{" + "task_id" + "}", localVarApiClient.escapeString(taskId.toString()))
            .replace("{" + "xcom_key" + "}", localVarApiClient.escapeString(xcomKey.toString()));
        ...
        if (deserialize != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("deserialize", deserialize));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getXcomEntryValidateBeforeCall(String dagId, String dagRunId, String taskId, String xcomKey, Boolean deserialize, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'dagId' is set
        if (dagId == null) {
        ...
        return getXcomEntryCall(dagId, dagRunId, taskId, xcomKey, deserialize, _callback);
    ...
    public XCom getXcomEntry(String dagId, String dagRunId, String taskId, String xcomKey, Boolean deserialize) throws ApiException {
        ApiResponse<XCom> localVarResp = getXcomEntryWithHttpInfo(dagId, dagRunId, taskId, xcomKey, deserialize);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<XCom> getXcomEntryWithHttpInfo(String dagId, String dagRunId, String taskId, String xcomKey, Boolean deserialize) throws ApiException {
        okhttp3.Call localVarCall = getXcomEntryValidateBeforeCall(dagId, dagRunId, taskId, xcomKey, deserialize, null);
     ...
     */
    public okhttp3.Call getXcomEntryAsync(String dagId, String dagRunId, String taskId, String xcomKey, Boolean deserialize, final ApiCallback<XCom> _callback) throws ApiException {

        okhttp3.Call localVarCall = getXcomEntryValidateBeforeCall(dagId, dagRunId, taskId, xcomKey, deserialize, _callback);
        Type localVarReturnType = new TypeToken<XCom>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
