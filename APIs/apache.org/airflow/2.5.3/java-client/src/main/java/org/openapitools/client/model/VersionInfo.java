...
public class VersionInfo {
  public static final String SERIALIZED_NAME_GIT_VERSION = "git_version";
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gitVersion, versionInfo.gitVersion) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gitVersion, version);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("git_version") != null && !jsonObj.get("git_version").isJsonNull()) && !jsonObj.get("git_version").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `git_version` to be a primitive type in the JSON string but got `%s`", jsonObj.get("git_version").toString()));
      }
