...
public class PoolApi {
    ...
    private okhttp3.Call deletePoolValidateBeforeCall(String poolName, final ApiCallback _callback) throws ApiException {
        ...
        return deletePoolCall(poolName, _callback);
    ...
    private okhttp3.Call getPoolValidateBeforeCall(String poolName, final ApiCallback _callback) throws ApiException {
        ...
        return getPoolCall(poolName, _callback);
    ...
    private okhttp3.Call getPoolsValidateBeforeCall(Integer limit, Integer offset, String orderBy, final ApiCallback _callback) throws ApiException {
        return getPoolsCall(limit, offset, orderBy, _callback);
    ...
    private okhttp3.Call patchPoolValidateBeforeCall(String poolName, Pool pool, List<String> updateMask, final ApiCallback _callback) throws ApiException {
        ...
        return patchPoolCall(poolName, pool, updateMask, _callback);
    ...
    private okhttp3.Call postPoolValidateBeforeCall(Pool pool, final ApiCallback _callback) throws ApiException {
        ...
        return postPoolCall(pool, _callback);
