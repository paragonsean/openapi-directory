...
public class DatasetApi {
     ...
     */
    public okhttp3.Call getDatasetCall(String uri, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getDatasetValidateBeforeCall(String uri, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getDatasetAsync(String uri, final ApiCallback<Dataset> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getDatasetEventsCall(Integer limit, Integer offset, String orderBy, Integer datasetId, String sourceDagId, String sourceTaskId, String sourceRunId, Integer sourceMapIndex, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDatasetEventsValidateBeforeCall(Integer limit, Integer offset, String orderBy, Integer datasetId, String sourceDagId, String sourceTaskId, String sourceRunId, Integer sourceMapIndex, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getDatasetEventsAsync(Integer limit, Integer offset, String orderBy, Integer datasetId, String sourceDagId, String sourceTaskId, String sourceRunId, Integer sourceMapIndex, final ApiCallback<DatasetEventCollection> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getDatasetsCall(Integer limit, Integer offset, String orderBy, String uriPattern, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDatasetsValidateBeforeCall(Integer limit, Integer offset, String orderBy, String uriPattern, final ApiCallback _callback) throws ApiException {
        return getDatasetsCall(limit, offset, orderBy, uriPattern, _callback);
    ...
    public DatasetCollection getDatasets(Integer limit, Integer offset, String orderBy, String uriPattern) throws ApiException {
        ApiResponse<DatasetCollection> localVarResp = getDatasetsWithHttpInfo(limit, offset, orderBy, uriPattern);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<DatasetCollection> getDatasetsWithHttpInfo(Integer limit, Integer offset, String orderBy, String uriPattern) throws ApiException {
        okhttp3.Call localVarCall = getDatasetsValidateBeforeCall(limit, offset, orderBy, uriPattern, null);
     ...
     */
    public okhttp3.Call getDatasetsAsync(Integer limit, Integer offset, String orderBy, String uriPattern, final ApiCallback<DatasetCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDatasetsValidateBeforeCall(limit, offset, orderBy, uriPattern, _callback);
        Type localVarReturnType = new TypeToken<DatasetCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getUpstreamDatasetEvents_0
     ...
     */
    public okhttp3.Call getUpstreamDatasetEvents_0Call(String dagId, String dagRunId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUpstreamDatasetEvents_0ValidateBeforeCall(String dagId, String dagRunId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'dagId' is set
        if (dagId == null) {
            throw new ApiException("Missing the required parameter 'dagId' when calling getUpstreamDatasetEvents_0(Async)");
        }

        // verify the required parameter 'dagRunId' is set
        if (dagRunId == null) {
            throw new ApiException("Missing the required parameter 'dagRunId' when calling getUpstreamDatasetEvents_0(Async)");
        }

        return getUpstreamDatasetEvents_0Call(dagId, dagRunId, _callback);
     ...
     */
    public DatasetEventCollection getUpstreamDatasetEvents_0(String dagId, String dagRunId) throws ApiException {
        ApiResponse<DatasetEventCollection> localVarResp = getUpstreamDatasetEvents_0WithHttpInfo(dagId, dagRunId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DatasetEventCollection> getUpstreamDatasetEvents_0WithHttpInfo(String dagId, String dagRunId) throws ApiException {
        okhttp3.Call localVarCall = getUpstreamDatasetEvents_0ValidateBeforeCall(dagId, dagRunId, null);
        Type localVarReturnType = new TypeToken<DatasetEventCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getUpstreamDatasetEvents_0Async(String dagId, String dagRunId, final ApiCallback<DatasetEventCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUpstreamDatasetEvents_0ValidateBeforeCall(dagId, dagRunId, _callback);
        Type localVarReturnType = new TypeToken<DatasetEventCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
