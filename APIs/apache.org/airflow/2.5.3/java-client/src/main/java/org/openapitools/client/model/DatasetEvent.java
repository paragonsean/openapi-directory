...
public class DatasetEvent {
  ...
  public DatasetEvent createdDagruns(List<BasicDAGRun> createdDagruns) {
  ...
  public void setCreatedDagruns(List<BasicDAGRun> createdDagruns) {
    this.createdDagruns = createdDagruns;
  }
  ...
  public void setSourceDagId(String sourceDagId) {
    this.sourceDagId = sourceDagId;
  }
  ...
  public void setSourceMapIndex(Integer sourceMapIndex) {
    this.sourceMapIndex = sourceMapIndex;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdDagruns, datasetId, datasetUri, extra, sourceDagId, sourceMapIndex, sourceRunId, sourceTaskId, timestamp);
  }
  ...
  static {
    ...
    openapiFields.add("created_dagruns");
    openapiFields.add("dataset_id");
    openapiFields.add("dataset_uri");
    openapiFields.add("extra");
    openapiFields.add("source_dag_id");
    openapiFields.add("source_map_index");
    openapiFields.add("source_run_id");
    openapiFields.add("source_task_id");
