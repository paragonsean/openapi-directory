...
public class RelativeDelta {
  ...
  static {
    ...
    openapiFields.add("leapdays");
    openapiFields.add("microsecond");
    ...
    openapiRequiredFields.add("leapdays");
    openapiRequiredFields.add("microsecond");
    ...
    openapiRequiredFields.add("years");
  }
