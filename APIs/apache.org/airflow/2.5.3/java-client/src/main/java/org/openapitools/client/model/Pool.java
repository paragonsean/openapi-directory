...
public class Pool {
  ...
  public boolean equals(Object o) {
    ...
    Pool pool = (Pool) o;
    return Objects.equals(this.description, pool.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, name, occupiedSlots, openSlots, queuedSlots, slots, usedSlots);
  }
  ...
  static {
    ...
    openapiFields.add("occupied_slots");
    openapiFields.add("open_slots");
    openapiFields.add("queued_slots");
