...
public class ConnectionCollectionItem {
  ...
  public ConnectionCollectionItem() {
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connType, connectionCollectionItem.connType) &&
        ...
        Objects.equals(this.description, connectionCollectionItem.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(connType, connectionId, description, host, login, port, schema);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectionCollectionItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectionCollectionItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectionCollectionItem is not found in the empty JSON string", ConnectionCollectionItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectionCollectionItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectionCollectionItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectionCollectionItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectionCollectionItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectionCollectionItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectionCollectionItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectionCollectionItem>() {
           @Override
           public void write(JsonWriter out, ConnectionCollectionItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectionCollectionItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectionCollectionItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectionCollectionItem
   * @throws IOException if the JSON string is invalid with respect to ConnectionCollectionItem
   */
  public static ConnectionCollectionItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectionCollectionItem.class);
  }

  /**
   * Convert an instance of ConnectionCollectionItem to an JSON string
   *
   * @return JSON string
   */
