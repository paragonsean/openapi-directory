...
public class DAG {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dagId, defaultView, description, fileToken, fileloc, hasImportErrors, hasTaskConcurrencyLimits, isActive, isPaused, isSubdag, lastExpired, lastParsedTime, lastPickled, maxActiveRuns, maxActiveTasks, nextDagrun, nextDagrunCreateAfter, nextDagrunDataIntervalEnd, nextDagrunDataIntervalStart, owners, pickleId, rootDagId, scheduleInterval, schedulerLock, tags, timetableDescription);
  }
