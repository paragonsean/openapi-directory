...
public class DagApi {
    ...
    private okhttp3.Call getDagValidateBeforeCall(String dagId, final ApiCallback _callback) throws ApiException {
        ...
        return getDagCall(dagId, _callback);
    ...
    private okhttp3.Call getDagDetailsValidateBeforeCall(String dagId, final ApiCallback _callback) throws ApiException {
        ...
        return getDagDetailsCall(dagId, _callback);
     ...
     */
    public GetDagSource200Response getDagSource(String fileToken) throws ApiException {
     ...
     */
    public ApiResponse<GetDagSource200Response> getDagSourceWithHttpInfo(String fileToken) throws ApiException {
     ...
     */
    public okhttp3.Call getDagSourceAsync(String fileToken, final ApiCallback<GetDagSource200Response> _callback) throws ApiException {
    ...
    private okhttp3.Call getDagsValidateBeforeCall(Integer limit, Integer offset, String orderBy, List<String> tags, Boolean onlyActive, String dagIdPattern, final ApiCallback _callback) throws ApiException {
        return getDagsCall(limit, offset, orderBy, tags, onlyActive, dagIdPattern, _callback);
     ...
     */
    public okhttp3.Call patchDagsCall(String dagIdPattern, DAG DAG, Integer limit, Integer offset, List<String> tags, List<String> updateMask, Boolean onlyActive, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchDagsValidateBeforeCall(String dagIdPattern, DAG DAG, Integer limit, Integer offset, List<String> tags, List<String> updateMask, Boolean onlyActive, final ApiCallback _callback) throws ApiException {
     ...
     */
    public DAGCollection patchDags(String dagIdPattern, DAG DAG, Integer limit, Integer offset, List<String> tags, List<String> updateMask, Boolean onlyActive) throws ApiException {
     ...
     */
    public ApiResponse<DAGCollection> patchDagsWithHttpInfo(String dagIdPattern, DAG DAG, Integer limit, Integer offset, List<String> tags, List<String> updateMask, Boolean onlyActive) throws ApiException {
     ...
     */
    public okhttp3.Call patchDagsAsync(String dagIdPattern, DAG DAG, Integer limit, Integer offset, List<String> tags, List<String> updateMask, Boolean onlyActive, final ApiCallback<DAGCollection> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call postClearTaskInstancesCall(String dagId, ClearTaskInstances clearTaskInstances, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postClearTaskInstancesValidateBeforeCall(String dagId, ClearTaskInstances clearTaskInstances, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'dagId' is set
        if (dagId == null) {
     ...
     */
    public TaskInstanceReferenceCollection postClearTaskInstances(String dagId, ClearTaskInstances clearTaskInstances) throws ApiException {
     ...
     */
    public ApiResponse<TaskInstanceReferenceCollection> postClearTaskInstancesWithHttpInfo(String dagId, ClearTaskInstances clearTaskInstances) throws ApiException {
     ...
     */
    public okhttp3.Call postClearTaskInstancesAsync(String dagId, ClearTaskInstances clearTaskInstances, final ApiCallback<TaskInstanceReferenceCollection> _callback) throws ApiException {
