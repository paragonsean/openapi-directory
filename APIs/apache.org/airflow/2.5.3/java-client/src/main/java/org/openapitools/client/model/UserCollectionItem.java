...
public class UserCollectionItem {
  ...
  public UserCollectionItem roles(List<UserCollectionItemRolesInner> roles) {
    this.roles = roles;
    return this;
  }
  ...
  public void setRoles(List<UserCollectionItemRolesInner> roles) {
    this.roles = roles;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.active, userCollectionItem.active) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, changedOn, createdOn, email, failedLoginCount, firstName, lastLogin, lastName, loginCount, roles, username);
  }
  ...
  static {
    ...
    openapiFields.add("failed_login_count");
