...
import org.openapitools.client.model.DagScheduleDatasetReference;
import org.openapitools.client.model.TaskOutletDatasetReference;
...
public class Dataset {
  public static final String SERIALIZED_NAME_CONSUMING_DAGS = "consuming_dags";
  @SerializedName(SERIALIZED_NAME_CONSUMING_DAGS)
  private List<DagScheduleDatasetReference> consumingDags = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_PRODUCING_TASKS = "producing_tasks";
  @SerializedName(SERIALIZED_NAME_PRODUCING_TASKS)
  private List<TaskOutletDatasetReference> producingTasks = new ArrayList<>();
  ...
  public Dataset consumingDags(List<DagScheduleDatasetReference> consumingDags) {
  ...
  public List<DagScheduleDatasetReference> getConsumingDags() {
    return consumingDags;
  }

  public void setConsumingDags(List<DagScheduleDatasetReference> consumingDags) {
    this.consumingDags = consumingDags;
  }
  ...
  public Dataset producingTasks(List<TaskOutletDatasetReference> producingTasks) {
   ...
   */
  @javax.annotation.Nullable
  public List<TaskOutletDatasetReference> getProducingTasks() {
    return producingTasks;
  }

  public void setProducingTasks(List<TaskOutletDatasetReference> producingTasks) {
    this.producingTasks = producingTasks;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(consumingDags, createdAt, extra, id, producingTasks, updatedAt, uri);
  }
  ...
  static {
    ...
    openapiFields.add("consuming_dags");
    openapiFields.add("created_at");
    openapiFields.add("extra");
    openapiFields.add("id");
    openapiFields.add("producing_tasks");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("consuming_dags") != null && !jsonObj.get("consuming_dags").isJsonNull()) {
        JsonArray jsonArrayconsumingDags = jsonObj.getAsJsonArray("consuming_dags");
        if (jsonArrayconsumingDags != null) {
          // ensure the json data is an array
          if (!jsonObj.get("consuming_dags").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `consuming_dags` to be an array in the JSON string but got `%s`", jsonObj.get("consuming_dags").toString()));
          }

          // validate the optional field `consuming_dags` (array)
          for (int i = 0; i < jsonArrayconsumingDags.size(); i++) {
            DagScheduleDatasetReference.validateJsonElement(jsonArrayconsumingDags.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("producing_tasks") != null && !jsonObj.get("producing_tasks").isJsonNull()) {
        JsonArray jsonArrayproducingTasks = jsonObj.getAsJsonArray("producing_tasks");
        if (jsonArrayproducingTasks != null) {
          // ensure the json data is an array
          if (!jsonObj.get("producing_tasks").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `producing_tasks` to be an array in the JSON string but got `%s`", jsonObj.get("producing_tasks").toString()));
          }

          // validate the optional field `producing_tasks` (array)
          for (int i = 0; i < jsonArrayproducingTasks.size(); i++) {
            TaskOutletDatasetReference.validateJsonElement(jsonArrayproducingTasks.get(i));
          };
        }
      }
