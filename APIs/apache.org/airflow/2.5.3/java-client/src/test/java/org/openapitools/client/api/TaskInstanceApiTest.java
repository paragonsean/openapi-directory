...
public class TaskInstanceApiTest {
    ...
    public void getMappedTaskInstancesTest() throws ApiException {
        ...
        String orderBy = null;
        TaskInstanceCollection response = api.getMappedTaskInstances(dagId, dagRunId, taskId, limit, offset, executionDateGte, executionDateLte, startDateGte, startDateLte, endDateGte, endDateLte, durationGte, durationLte, state, pool, queue, orderBy);
        // TODO: test validations
    }
