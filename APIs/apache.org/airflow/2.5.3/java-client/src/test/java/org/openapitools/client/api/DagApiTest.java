...
public class DagApiTest {
     ...
     */
    @Test
    public void deleteDagTest() throws ApiException {
        String dagId = null;
        api.deleteDag(dagId);
     ...
     */
    @Test
    public void getDagDetailsTest() throws ApiException {
        String dagId = null;
        DAGDetail response = api.getDagDetails(dagId);
        // TODO: test validations
    }
    ...
    public void getDagSourceTest() throws ApiException {
        ...
        GetDagSource200Response response = api.getDagSource(fileToken);
        // TODO: test validations
    }
    ...
    public void getDagsTest() throws ApiException {
        ...
        String dagIdPattern = null;
        DAGCollection response = api.getDags(limit, offset, orderBy, tags, onlyActive, dagIdPattern);
        // TODO: test validations
    }
    ...
    public void getTasksTest() throws ApiException {
        String dagId = null;
        String orderBy = null;
        TaskCollection response = api.getTasks(dagId, orderBy);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void patchDagTest() throws ApiException {
        String dagId = null;
        DAG DAG = null;
        List<String> updateMask = null;
        DAG response = api.patchDag(dagId, DAG, updateMask);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void patchDagsTest() throws ApiException {
        String dagIdPattern = null;
        DAG DAG = null;
        Integer limit = null;
        Integer offset = null;
        ...
        List<String> updateMask = null;
        Boolean onlyActive = null;
        DAGCollection response = api.patchDags(dagIdPattern, DAG, limit, offset, tags, updateMask, onlyActive);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void postClearTaskInstancesTest() throws ApiException {
        String dagId = null;
        ClearTaskInstances clearTaskInstances = null;
        TaskInstanceReferenceCollection response = api.postClearTaskInstances(dagId, clearTaskInstances);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void postSetTaskInstancesStateTest() throws ApiException {
        String dagId = null;
        UpdateTaskInstancesState updateTaskInstancesState = null;
        TaskInstanceReferenceCollection response = api.postSetTaskInstancesState(dagId, updateTaskInstancesState);
        // TODO: test validations
    }
