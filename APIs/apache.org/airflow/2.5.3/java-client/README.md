...
Airflow API (Stable)
- API version: 2.5.3
  - Build date: 2024-10-12T11:57:16.959637-04:00[America/New_York]
...
*DatasetApi* | [**getUpstreamDatasetEvents_0**](docs/DatasetApi.md#getUpstreamDatasetEvents_0) | **GET** /dags/{dag_id}/dagRuns/{dag_run_id}/upstreamDatasetEvents | Get dataset events for a DAG run
