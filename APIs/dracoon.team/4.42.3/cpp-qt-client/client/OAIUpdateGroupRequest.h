...
/*
 * OAIUpdateGroupRequest.h
 *
 * Request model for updating group&#39;s metadata
 */

#ifndef OAIUpdateGroupRequest_H
#define OAIUpdateGroupRequest_H
...
class OAIUpdateGroupRequest : public OAIObject {
public:
    OAIUpdateGroupRequest();
    OAIUpdateGroupRequest(QString json);
    ~OAIUpdateGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGroupRequest)

#endif // OAIUpdateGroupRequest_H
