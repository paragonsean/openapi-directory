...
/*
 * OAIUserAuthDataUpdateRequest.h
 *
 * User Authentication Data Update Request
 */

#ifndef OAIUserAuthDataUpdateRequest_H
#define OAIUserAuthDataUpdateRequest_H
...
class OAIUserAuthDataUpdateRequest : public OAIObject {
public:
    OAIUserAuthDataUpdateRequest();
    OAIUserAuthDataUpdateRequest(QString json);
    ~OAIUserAuthDataUpdateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserAuthDataUpdateRequest)

#endif // OAIUserAuthDataUpdateRequest_H
