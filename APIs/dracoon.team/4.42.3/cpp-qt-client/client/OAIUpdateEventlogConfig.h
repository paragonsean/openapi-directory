...
/*
 * OAIUpdateEventlogConfig.h
 *
 * Request model for updating eventlog settings
 */

#ifndef OAIUpdateEventlogConfig_H
#define OAIUpdateEventlogConfig_H
...
class OAIUpdateEventlogConfig : public OAIObject {
public:
    OAIUpdateEventlogConfig();
    OAIUpdateEventlogConfig(QString json);
    ~OAIUpdateEventlogConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEventlogConfig)

#endif // OAIUpdateEventlogConfig_H
