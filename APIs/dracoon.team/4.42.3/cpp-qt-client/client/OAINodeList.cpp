...
OAIRange OAINodeList::getRange() const {
    return m_range;
}
void OAINodeList::setRange(const OAIRange &range) {
    m_range = range;
    m_range_isSet = true;
}

bool OAINodeList::is_range_Set() const{
    return m_range_isSet;
}

bool OAINodeList::is_range_Valid() const{
