...
QList<OAICustomer> OAICustomerList::getItems() const {
    return m_items;
}
void OAICustomerList::setItems(const QList<OAICustomer> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAICustomerList::is_items_Set() const{
    return m_items_isSet;
}

bool OAICustomerList::is_items_Valid() const{
    return m_items_isValid;
}

OAIRange OAICustomerList::getRange() const {
    return m_range;
}
void OAICustomerList::setRange(const OAIRange &range) {
    m_range = range;
    m_range_isSet = true;
}

bool OAICustomerList::is_range_Set() const{
    return m_range_isSet;
}

bool OAICustomerList::is_range_Valid() const{
