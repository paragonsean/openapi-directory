...
/*
 * OAICustomerSettingsRequest.h
 *
 * Request model for setting the customer settings
 */

#ifndef OAICustomerSettingsRequest_H
#define OAICustomerSettingsRequest_H
...
class OAICustomerSettingsRequest : public OAIObject {
public:
    OAICustomerSettingsRequest();
    OAICustomerSettingsRequest(QString json);
    ~OAICustomerSettingsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerSettingsRequest)

#endif // OAICustomerSettingsRequest_H
