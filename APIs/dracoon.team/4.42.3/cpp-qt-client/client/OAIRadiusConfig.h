...
#ifndef OAIRadiusConfig_H
#define OAIRadiusConfig_H
...
class OAIRadiusConfig : public OAIObject {
public:
    OAIRadiusConfig();
    OAIRadiusConfig(QString json);
    ~OAIRadiusConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRadiusConfig)

#endif // OAIRadiusConfig_H
