...
/*
 * OAITestActiveDirectoryConfigRequest.h
 *
 * Request model for testing connection for Active Directory configuration
 */

#ifndef OAITestActiveDirectoryConfigRequest_H
#define OAITestActiveDirectoryConfigRequest_H
...
class OAITestActiveDirectoryConfigRequest : public OAIObject {
public:
    OAITestActiveDirectoryConfigRequest();
    OAITestActiveDirectoryConfigRequest(QString json);
    ~OAITestActiveDirectoryConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestActiveDirectoryConfigRequest)

#endif // OAITestActiveDirectoryConfigRequest_H
