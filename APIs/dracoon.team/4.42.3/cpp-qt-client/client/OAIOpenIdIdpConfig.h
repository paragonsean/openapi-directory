...
/*
 * OAIOpenIdIdpConfig.h
 *
 * OpenID Connect IDP configuration
 */

#ifndef OAIOpenIdIdpConfig_H
#define OAIOpenIdIdpConfig_H
...
class OAIOpenIdIdpConfig : public OAIObject {
public:
    OAIOpenIdIdpConfig();
    OAIOpenIdIdpConfig(QString json);
    ~OAIOpenIdIdpConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOpenIdIdpConfig)

#endif // OAIOpenIdIdpConfig_H
