...
/*
 * OAISharesPasswordPolicies.h
 *
 * Shares password policies
 */

#ifndef OAISharesPasswordPolicies_H
#define OAISharesPasswordPolicies_H
...
class OAISharesPasswordPolicies : public OAIObject {
public:
    OAISharesPasswordPolicies();
    OAISharesPasswordPolicies(QString json);
    ~OAISharesPasswordPolicies() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISharesPasswordPolicies)

#endif // OAISharesPasswordPolicies_H
