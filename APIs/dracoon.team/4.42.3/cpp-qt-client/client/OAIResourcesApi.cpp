...
void OAIResourcesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("requestSubscriptionScopes", defaultConf);
    _serverIndices.insert("requestSubscriptionScopes", 0);
    _serverConfigs.insert("requestUserAvatar", defaultConf);
    _serverIndices.insert("requestUserAvatar", 0);
}
...
void OAIResourcesApi::requestSubscriptionScopes() {
    QString fullPath = QString(_serverConfigs["requestSubscriptionScopes"][_serverIndices.value("requestSubscriptionScopes")].URL()+"/v4/resources/user/notifications/scopes");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIResourcesApi::requestSubscriptionScopesCallback);
...
void OAIResourcesApi::requestSubscriptionScopesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAINotificationScopeList output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT requestSubscriptionScopesSignal(output);
        Q_EMIT requestSubscriptionScopesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT requestSubscriptionScopesSignalE(output, error_type, error_str);
        Q_EMIT requestSubscriptionScopesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT requestSubscriptionScopesSignalError(output, error_type, error_str);
        Q_EMIT requestSubscriptionScopesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIResourcesApi::requestUserAvatar(const QString &uuid, const qint64 &user_id) {
    QString fullPath = QString(_serverConfigs["requestUserAvatar"][_serverIndices.value("requestUserAvatar")].URL()+"/v4/resources/users/{user_id}/avatar/{uuid}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIResourcesApi::requestUserAvatarCallback);
    connect(this, &OAIResourcesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIResourcesApi::requestUserAvatarCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT requestUserAvatarSignal(output);
        Q_EMIT requestUserAvatarSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT requestUserAvatarSignalE(output, error_type, error_str);
        Q_EMIT requestUserAvatarSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT requestUserAvatarSignalError(output, error_type, error_str);
        Q_EMIT requestUserAvatarSignalErrorFull(worker, error_type, error_str);
    }
}
