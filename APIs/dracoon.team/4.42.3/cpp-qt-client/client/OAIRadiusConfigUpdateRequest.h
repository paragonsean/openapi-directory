...
/*
 * OAIRadiusConfigUpdateRequest.h
 *
 * Request model for updating a RADIUS configuration
 */

#ifndef OAIRadiusConfigUpdateRequest_H
#define OAIRadiusConfigUpdateRequest_H
...
class OAIRadiusConfigUpdateRequest : public OAIObject {
public:
    OAIRadiusConfigUpdateRequest();
    OAIRadiusConfigUpdateRequest(QString json);
    ~OAIRadiusConfigUpdateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRadiusConfigUpdateRequest)

#endif // OAIRadiusConfigUpdateRequest_H
