...
QList<OAIUserItem> OAIUserList::getItems() const {
    return m_items;
}
void OAIUserList::setItems(const QList<OAIUserItem> &items) {
    m_items = items;
    m_items_isSet = true;
}
...
OAIRange OAIUserList::getRange() const {
    return m_range;
}
void OAIUserList::setRange(const OAIRange &range) {
    m_range = range;
    m_range_isSet = true;
}

bool OAIUserList::is_range_Set() const{
    return m_range_isSet;
}

bool OAIUserList::is_range_Valid() const{
