...
/*
 * OAIUpdateOpenIdIdpConfigRequest.h
 *
 * Request model for updating an OpenID Connect IDP configuration
 */

#ifndef OAIUpdateOpenIdIdpConfigRequest_H
#define OAIUpdateOpenIdIdpConfigRequest_H
...
class OAIUpdateOpenIdIdpConfigRequest : public OAIObject {
public:
    OAIUpdateOpenIdIdpConfigRequest();
    OAIUpdateOpenIdIdpConfigRequest(QString json);
    ~OAIUpdateOpenIdIdpConfigRequest() override;
    ...
    bool isResetFallbackMappingClaim() const;
    void setResetFallbackMappingClaim(const bool &reset_fallback_mapping_claim);
    bool is_reset_fallback_mapping_claim_Set() const;
    bool is_reset_fallback_mapping_claim_Valid() const;
...
private:
    ...
    bool m_reset_fallback_mapping_claim;
    bool m_reset_fallback_mapping_claim_isSet;
    bool m_reset_fallback_mapping_claim_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOpenIdIdpConfigRequest)

#endif // OAIUpdateOpenIdIdpConfigRequest_H
