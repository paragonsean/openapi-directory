...
/*
 * OAINewCustomerRequest.h
 *
 * Request model for creating a customer
 */

#ifndef OAINewCustomerRequest_H
#define OAINewCustomerRequest_H
...
class OAINewCustomerRequest : public OAIObject {
public:
    OAINewCustomerRequest();
    OAINewCustomerRequest(QString json);
    ~OAINewCustomerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewCustomerRequest)

#endif // OAINewCustomerRequest_H
