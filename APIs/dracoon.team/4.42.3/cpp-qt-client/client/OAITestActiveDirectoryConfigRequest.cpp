...
OAITestActiveDirectoryConfigRequest::OAITestActiveDirectoryConfigRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestActiveDirectoryConfigRequest::OAITestActiveDirectoryConfigRequest() {
    this->initializeModel();
}

OAITestActiveDirectoryConfigRequest::~OAITestActiveDirectoryConfigRequest() {}

void OAITestActiveDirectoryConfigRequest::initializeModel() {
...
void OAITestActiveDirectoryConfigRequest::fromJson(QString jsonString) {
...
void OAITestActiveDirectoryConfigRequest::fromJsonObject(QJsonObject json) {
...
QString OAITestActiveDirectoryConfigRequest::asJson() const {
...
QJsonObject OAITestActiveDirectoryConfigRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAITestActiveDirectoryConfigRequest::getLdapUsersDomain() const {
    return m_ldap_users_domain;
}
void OAITestActiveDirectoryConfigRequest::setLdapUsersDomain(const QString &ldap_users_domain) {
    m_ldap_users_domain = ldap_users_domain;
    m_ldap_users_domain_isSet = true;
}

bool OAITestActiveDirectoryConfigRequest::is_ldap_users_domain_Set() const{
    return m_ldap_users_domain_isSet;
}

bool OAITestActiveDirectoryConfigRequest::is_ldap_users_domain_Valid() const{
    return m_ldap_users_domain_isValid;
}

QString OAITestActiveDirectoryConfigRequest::getServerAdminName() const {
    return m_server_admin_name;
}
void OAITestActiveDirectoryConfigRequest::setServerAdminName(const QString &server_admin_name) {
    m_server_admin_name = server_admin_name;
    m_server_admin_name_isSet = true;
}

bool OAITestActiveDirectoryConfigRequest::is_server_admin_name_Set() const{
    return m_server_admin_name_isSet;
}

bool OAITestActiveDirectoryConfigRequest::is_server_admin_name_Valid() const{
    return m_server_admin_name_isValid;
}

QString OAITestActiveDirectoryConfigRequest::getServerAdminPassword() const {
    return m_server_admin_password;
}
void OAITestActiveDirectoryConfigRequest::setServerAdminPassword(const QString &server_admin_password) {
    m_server_admin_password = server_admin_password;
    m_server_admin_password_isSet = true;
}

bool OAITestActiveDirectoryConfigRequest::is_server_admin_password_Set() const{
    return m_server_admin_password_isSet;
}

bool OAITestActiveDirectoryConfigRequest::is_server_admin_password_Valid() const{
    return m_server_admin_password_isValid;
}

QString OAITestActiveDirectoryConfigRequest::getServerIp() const {
    return m_server_ip;
}
void OAITestActiveDirectoryConfigRequest::setServerIp(const QString &server_ip) {
    m_server_ip = server_ip;
    m_server_ip_isSet = true;
}

bool OAITestActiveDirectoryConfigRequest::is_server_ip_Set() const{
    return m_server_ip_isSet;
}

bool OAITestActiveDirectoryConfigRequest::is_server_ip_Valid() const{
    return m_server_ip_isValid;
}

qint32 OAITestActiveDirectoryConfigRequest::getServerPort() const {
    return m_server_port;
}
void OAITestActiveDirectoryConfigRequest::setServerPort(const qint32 &server_port) {
    m_server_port = server_port;
    m_server_port_isSet = true;
}

bool OAITestActiveDirectoryConfigRequest::is_server_port_Set() const{
    return m_server_port_isSet;
}

bool OAITestActiveDirectoryConfigRequest::is_server_port_Valid() const{
    return m_server_port_isValid;
}

QString OAITestActiveDirectoryConfigRequest::getSslFingerPrint() const {
    return m_ssl_finger_print;
}
void OAITestActiveDirectoryConfigRequest::setSslFingerPrint(const QString &ssl_finger_print) {
    m_ssl_finger_print = ssl_finger_print;
    m_ssl_finger_print_isSet = true;
}

bool OAITestActiveDirectoryConfigRequest::is_ssl_finger_print_Set() const{
    return m_ssl_finger_print_isSet;
}

bool OAITestActiveDirectoryConfigRequest::is_ssl_finger_print_Valid() const{
    return m_ssl_finger_print_isValid;
}

bool OAITestActiveDirectoryConfigRequest::isUseLdaps() const {
    return m_use_ldaps;
}
void OAITestActiveDirectoryConfigRequest::setUseLdaps(const bool &use_ldaps) {
    m_use_ldaps = use_ldaps;
    m_use_ldaps_isSet = true;
}

bool OAITestActiveDirectoryConfigRequest::is_use_ldaps_Set() const{
    return m_use_ldaps_isSet;
}

bool OAITestActiveDirectoryConfigRequest::is_use_ldaps_Valid() const{
    return m_use_ldaps_isValid;
}

bool OAITestActiveDirectoryConfigRequest::isSet() const {
...
bool OAITestActiveDirectoryConfigRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ldap_users_domain_isValid && m_server_admin_name_isValid && m_server_admin_password_isValid && m_server_ip_isValid && m_server_port_isValid && true;
}
