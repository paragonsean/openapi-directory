...
public:
    ...
    bool isIsMfaEnabled() const;
    void setIsMfaEnabled(const bool &is_mfa_enabled);
    bool is_is_mfa_enabled_Set() const;
    bool is_is_mfa_enabled_Valid() const;
...
private:
    ...
    bool m_is_mfa_enabled;
    bool m_is_mfa_enabled_isSet;
    bool m_is_mfa_enabled_isValid;
