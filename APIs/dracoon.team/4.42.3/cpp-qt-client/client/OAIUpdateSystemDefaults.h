...
/*
 * OAIUpdateSystemDefaults.h
 *
 * Request model for updating system defaults
 */

#ifndef OAIUpdateSystemDefaults_H
#define OAIUpdateSystemDefaults_H
...
class OAIUpdateSystemDefaults : public OAIObject {
public:
    OAIUpdateSystemDefaults();
    OAIUpdateSystemDefaults(QString json);
    ~OAIUpdateSystemDefaults() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSystemDefaults)

#endif // OAIUpdateSystemDefaults_H
