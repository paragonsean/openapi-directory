...
OAIUpdateSharesPasswordPolicies::OAIUpdateSharesPasswordPolicies(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSharesPasswordPolicies::OAIUpdateSharesPasswordPolicies() {
    this->initializeModel();
}

OAIUpdateSharesPasswordPolicies::~OAIUpdateSharesPasswordPolicies() {}

void OAIUpdateSharesPasswordPolicies::initializeModel() {
...
void OAIUpdateSharesPasswordPolicies::fromJson(QString jsonString) {
...
void OAIUpdateSharesPasswordPolicies::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSharesPasswordPolicies::asJson() const {
...
QJsonObject OAIUpdateSharesPasswordPolicies::asJsonObject() const {
    QJsonObject obj;
...
OAICharacterRules OAIUpdateSharesPasswordPolicies::getCharacterRules() const {
    return m_character_rules;
}
void OAIUpdateSharesPasswordPolicies::setCharacterRules(const OAICharacterRules &character_rules) {
    m_character_rules = character_rules;
    m_character_rules_isSet = true;
}

bool OAIUpdateSharesPasswordPolicies::is_character_rules_Set() const{
    return m_character_rules_isSet;
}

bool OAIUpdateSharesPasswordPolicies::is_character_rules_Valid() const{
    return m_character_rules_isValid;
}

qint32 OAIUpdateSharesPasswordPolicies::getMinLength() const {
    return m_min_length;
}
void OAIUpdateSharesPasswordPolicies::setMinLength(const qint32 &min_length) {
    m_min_length = min_length;
    m_min_length_isSet = true;
}

bool OAIUpdateSharesPasswordPolicies::is_min_length_Set() const{
    return m_min_length_isSet;
}

bool OAIUpdateSharesPasswordPolicies::is_min_length_Valid() const{
    return m_min_length_isValid;
}

bool OAIUpdateSharesPasswordPolicies::isRejectDictionaryWords() const {
    return m_reject_dictionary_words;
}
void OAIUpdateSharesPasswordPolicies::setRejectDictionaryWords(const bool &reject_dictionary_words) {
    m_reject_dictionary_words = reject_dictionary_words;
    m_reject_dictionary_words_isSet = true;
}

bool OAIUpdateSharesPasswordPolicies::is_reject_dictionary_words_Set() const{
    return m_reject_dictionary_words_isSet;
}

bool OAIUpdateSharesPasswordPolicies::is_reject_dictionary_words_Valid() const{
    return m_reject_dictionary_words_isValid;
}

bool OAIUpdateSharesPasswordPolicies::isRejectKeyboardPatterns() const {
    return m_reject_keyboard_patterns;
}
void OAIUpdateSharesPasswordPolicies::setRejectKeyboardPatterns(const bool &reject_keyboard_patterns) {
    m_reject_keyboard_patterns = reject_keyboard_patterns;
    m_reject_keyboard_patterns_isSet = true;
}

bool OAIUpdateSharesPasswordPolicies::is_reject_keyboard_patterns_Set() const{
    return m_reject_keyboard_patterns_isSet;
}

bool OAIUpdateSharesPasswordPolicies::is_reject_keyboard_patterns_Valid() const{
    return m_reject_keyboard_patterns_isValid;
}

bool OAIUpdateSharesPasswordPolicies::isRejectUserInfo() const {
    return m_reject_user_info;
}
void OAIUpdateSharesPasswordPolicies::setRejectUserInfo(const bool &reject_user_info) {
    m_reject_user_info = reject_user_info;
    m_reject_user_info_isSet = true;
}

bool OAIUpdateSharesPasswordPolicies::is_reject_user_info_Set() const{
    return m_reject_user_info_isSet;
}

bool OAIUpdateSharesPasswordPolicies::is_reject_user_info_Valid() const{
    return m_reject_user_info_isValid;
}

bool OAIUpdateSharesPasswordPolicies::isSet() const {
...
bool OAIUpdateSharesPasswordPolicies::isValid() const {
