...
/*
 * OAIUpdateLoginPasswordPolicies.h
 *
 * Request model for updating login password policies
 */

#ifndef OAIUpdateLoginPasswordPolicies_H
#define OAIUpdateLoginPasswordPolicies_H
...
class OAIUpdateLoginPasswordPolicies : public OAIObject {
public:
    OAIUpdateLoginPasswordPolicies();
    OAIUpdateLoginPasswordPolicies(QString json);
    ~OAIUpdateLoginPasswordPolicies() override;
    ...
    Q_DECL_DEPRECATED bool isEnforceLoginPasswordChange() const;
    Q_DECL_DEPRECATED void setEnforceLoginPasswordChange(const bool &enforce_login_password_change);
    Q_DECL_DEPRECATED bool is_enforce_login_password_change_Set() const;
    Q_DECL_DEPRECATED bool is_enforce_login_password_change_Valid() const;
...
private:
    ...
    bool m_enforce_login_password_change;
    bool m_enforce_login_password_change_isSet;
    bool m_enforce_login_password_change_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLoginPasswordPolicies)

#endif // OAIUpdateLoginPasswordPolicies_H
