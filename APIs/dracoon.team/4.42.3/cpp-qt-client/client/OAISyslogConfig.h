...
#ifndef OAISyslogConfig_H
#define OAISyslogConfig_H
...
class OAISyslogConfig : public OAIObject {
public:
    OAISyslogConfig();
    OAISyslogConfig(QString json);
    ~OAISyslogConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISyslogConfig)

#endif // OAISyslogConfig_H
