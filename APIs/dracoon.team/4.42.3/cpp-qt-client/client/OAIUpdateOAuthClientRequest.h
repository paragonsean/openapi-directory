...
/*
 * OAIUpdateOAuthClientRequest.h
 *
 * Request model for updating an OAuth client
 */

#ifndef OAIUpdateOAuthClientRequest_H
#define OAIUpdateOAuthClientRequest_H
...
class OAIUpdateOAuthClientRequest : public OAIObject {
public:
    OAIUpdateOAuthClientRequest();
    OAIUpdateOAuthClientRequest(QString json);
    ~OAIUpdateOAuthClientRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOAuthClientRequest)

#endif // OAIUpdateOAuthClientRequest_H
