...
#ifndef OAIPresignedUrl_H
#define OAIPresignedUrl_H
...
class OAIPresignedUrl : public OAIObject {
public:
    OAIPresignedUrl();
    OAIPresignedUrl(QString json);
    ~OAIPresignedUrl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPresignedUrl)

#endif // OAIPresignedUrl_H
