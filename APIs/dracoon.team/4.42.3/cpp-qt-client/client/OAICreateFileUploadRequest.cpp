...
OAICreateFileUploadRequest::OAICreateFileUploadRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFileUploadRequest::OAICreateFileUploadRequest() {
    this->initializeModel();
}

OAICreateFileUploadRequest::~OAICreateFileUploadRequest() {}

void OAICreateFileUploadRequest::initializeModel() {
...
void OAICreateFileUploadRequest::fromJson(QString jsonString) {
...
void OAICreateFileUploadRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateFileUploadRequest::asJson() const {
...
QJsonObject OAICreateFileUploadRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateFileUploadRequest::getClassification() const {
    return m_classification;
}
void OAICreateFileUploadRequest::setClassification(const qint32 &classification) {
    m_classification = classification;
    m_classification_isSet = true;
}

bool OAICreateFileUploadRequest::is_classification_Set() const{
    return m_classification_isSet;
}

bool OAICreateFileUploadRequest::is_classification_Valid() const{
    return m_classification_isValid;
}

bool OAICreateFileUploadRequest::isDirectS3Upload() const {
    return m_direct_s3_upload;
}
void OAICreateFileUploadRequest::setDirectS3Upload(const bool &direct_s3_upload) {
    m_direct_s3_upload = direct_s3_upload;
    m_direct_s3_upload_isSet = true;
}

bool OAICreateFileUploadRequest::is_direct_s3_upload_Set() const{
    return m_direct_s3_upload_isSet;
}

bool OAICreateFileUploadRequest::is_direct_s3_upload_Valid() const{
    return m_direct_s3_upload_isValid;
}

OAIObjectExpiration OAICreateFileUploadRequest::getExpiration() const {
    return m_expiration;
}
void OAICreateFileUploadRequest::setExpiration(const OAIObjectExpiration &expiration) {
    m_expiration = expiration;
    m_expiration_isSet = true;
}

bool OAICreateFileUploadRequest::is_expiration_Set() const{
    return m_expiration_isSet;
}

bool OAICreateFileUploadRequest::is_expiration_Valid() const{
    return m_expiration_isValid;
}

QString OAICreateFileUploadRequest::getName() const {
    return m_name;
}
void OAICreateFileUploadRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateFileUploadRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateFileUploadRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateFileUploadRequest::getNotes() const {
    return m_notes;
}
void OAICreateFileUploadRequest::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAICreateFileUploadRequest::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAICreateFileUploadRequest::is_notes_Valid() const{
    return m_notes_isValid;
}

qint64 OAICreateFileUploadRequest::getParentId() const {
    return m_parent_id;
}
void OAICreateFileUploadRequest::setParentId(const qint64 &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAICreateFileUploadRequest::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAICreateFileUploadRequest::is_parent_id_Valid() const{
    return m_parent_id_isValid;
}

qint64 OAICreateFileUploadRequest::getSize() const {
    return m_size;
}
void OAICreateFileUploadRequest::setSize(const qint64 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAICreateFileUploadRequest::is_size_Set() const{
    return m_size_isSet;
}

bool OAICreateFileUploadRequest::is_size_Valid() const{
    return m_size_isValid;
}

QDateTime OAICreateFileUploadRequest::getTimestampCreation() const {
    return m_timestamp_creation;
}
void OAICreateFileUploadRequest::setTimestampCreation(const QDateTime &timestamp_creation) {
    m_timestamp_creation = timestamp_creation;
    m_timestamp_creation_isSet = true;
}

bool OAICreateFileUploadRequest::is_timestamp_creation_Set() const{
    return m_timestamp_creation_isSet;
}

bool OAICreateFileUploadRequest::is_timestamp_creation_Valid() const{
    return m_timestamp_creation_isValid;
}

QDateTime OAICreateFileUploadRequest::getTimestampModification() const {
    return m_timestamp_modification;
}
void OAICreateFileUploadRequest::setTimestampModification(const QDateTime &timestamp_modification) {
    m_timestamp_modification = timestamp_modification;
    m_timestamp_modification_isSet = true;
}

bool OAICreateFileUploadRequest::is_timestamp_modification_Set() const{
    return m_timestamp_modification_isSet;
}

bool OAICreateFileUploadRequest::is_timestamp_modification_Valid() const{
    return m_timestamp_modification_isValid;
}

bool OAICreateFileUploadRequest::isSet() const {
...
bool OAICreateFileUploadRequest::isValid() const {
