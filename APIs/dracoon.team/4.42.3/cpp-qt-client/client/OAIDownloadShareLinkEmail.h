...
/*
 * OAIDownloadShareLinkEmail.h
 *
 * Request model for sending an email of a Download Share link
 */

#ifndef OAIDownloadShareLinkEmail_H
#define OAIDownloadShareLinkEmail_H
...
class OAIDownloadShareLinkEmail : public OAIObject {
public:
    OAIDownloadShareLinkEmail();
    OAIDownloadShareLinkEmail(QString json);
    ~OAIDownloadShareLinkEmail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDownloadShareLinkEmail)

#endif // OAIDownloadShareLinkEmail_H
