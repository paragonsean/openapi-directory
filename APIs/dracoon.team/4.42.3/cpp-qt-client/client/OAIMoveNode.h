...
#ifndef OAIMoveNode_H
#define OAIMoveNode_H
...
class OAIMoveNode : public OAIObject {
public:
    OAIMoveNode();
    OAIMoveNode(QString json);
    ~OAIMoveNode() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMoveNode)
