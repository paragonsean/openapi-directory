...
#ifndef OAICopyNode_H
#define OAICopyNode_H
...
class OAICopyNode : public OAIObject {
public:
    OAICopyNode();
    OAICopyNode(QString json);
    ~OAICopyNode() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyNode)
