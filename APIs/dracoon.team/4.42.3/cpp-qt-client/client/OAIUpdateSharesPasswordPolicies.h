...
/*
 * OAIUpdateSharesPasswordPolicies.h
 *
 * Request model for updating shares password policies
 */

#ifndef OAIUpdateSharesPasswordPolicies_H
#define OAIUpdateSharesPasswordPolicies_H
...
class OAIUpdateSharesPasswordPolicies : public OAIObject {
public:
    OAIUpdateSharesPasswordPolicies();
    OAIUpdateSharesPasswordPolicies(QString json);
    ~OAIUpdateSharesPasswordPolicies() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSharesPasswordPolicies)

#endif // OAIUpdateSharesPasswordPolicies_H
