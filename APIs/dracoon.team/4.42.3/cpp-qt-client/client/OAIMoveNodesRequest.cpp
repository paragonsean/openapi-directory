...
OAIMoveNodesRequest::OAIMoveNodesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMoveNodesRequest::OAIMoveNodesRequest() {
    this->initializeModel();
}

OAIMoveNodesRequest::~OAIMoveNodesRequest() {}

void OAIMoveNodesRequest::initializeModel() {
...
void OAIMoveNodesRequest::fromJson(QString jsonString) {
...
void OAIMoveNodesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIMoveNodesRequest::asJson() const {
...
QJsonObject OAIMoveNodesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_items.size() > 0) {
...
QList<OAIMoveNode> OAIMoveNodesRequest::getItems() const {
    return m_items;
}
void OAIMoveNodesRequest::setItems(const QList<OAIMoveNode> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIMoveNodesRequest::is_items_Set() const{
    return m_items_isSet;
}

bool OAIMoveNodesRequest::is_items_Valid() const{
    return m_items_isValid;
}

bool OAIMoveNodesRequest::isKeepShareLinks() const {
    return m_keep_share_links;
}
void OAIMoveNodesRequest::setKeepShareLinks(const bool &keep_share_links) {
    m_keep_share_links = keep_share_links;
    m_keep_share_links_isSet = true;
}

bool OAIMoveNodesRequest::is_keep_share_links_Set() const{
    return m_keep_share_links_isSet;
}

bool OAIMoveNodesRequest::is_keep_share_links_Valid() const{
    return m_keep_share_links_isValid;
}

QList<qint64> OAIMoveNodesRequest::getNodeIds() const {
    return m_node_ids;
}
void OAIMoveNodesRequest::setNodeIds(const QList<qint64> &node_ids) {
    m_node_ids = node_ids;
    m_node_ids_isSet = true;
}

bool OAIMoveNodesRequest::is_node_ids_Set() const{
    return m_node_ids_isSet;
}

bool OAIMoveNodesRequest::is_node_ids_Valid() const{
    return m_node_ids_isValid;
}

QString OAIMoveNodesRequest::getResolutionStrategy() const {
    return m_resolution_strategy;
}
void OAIMoveNodesRequest::setResolutionStrategy(const QString &resolution_strategy) {
    m_resolution_strategy = resolution_strategy;
    m_resolution_strategy_isSet = true;
}

bool OAIMoveNodesRequest::is_resolution_strategy_Set() const{
    return m_resolution_strategy_isSet;
}

bool OAIMoveNodesRequest::is_resolution_strategy_Valid() const{
    return m_resolution_strategy_isValid;
}

bool OAIMoveNodesRequest::isSet() const {
...
bool OAIMoveNodesRequest::isValid() const {
