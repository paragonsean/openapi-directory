...
/*
 * OAICreateActiveDirectoryConfigRequest.h
 *
 * Request model for creating an Active Directory configuration
 */

#ifndef OAICreateActiveDirectoryConfigRequest_H
#define OAICreateActiveDirectoryConfigRequest_H
...
class OAICreateActiveDirectoryConfigRequest : public OAIObject {
public:
    OAICreateActiveDirectoryConfigRequest();
    OAICreateActiveDirectoryConfigRequest(QString json);
    ~OAICreateActiveDirectoryConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateActiveDirectoryConfigRequest)

#endif // OAICreateActiveDirectoryConfigRequest_H
