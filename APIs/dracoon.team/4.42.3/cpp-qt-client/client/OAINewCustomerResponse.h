...
/*
 * OAINewCustomerResponse.h
 *
 * Customer information
 */

#ifndef OAINewCustomerResponse_H
#define OAINewCustomerResponse_H
...
class OAIFirstAdminUser;

class OAINewCustomerResponse : public OAIObject {
public:
    OAINewCustomerResponse();
    OAINewCustomerResponse(QString json);
    ~OAINewCustomerResponse() override;
    ...
    OAIFirstAdminUser getFirstAdminUser() const;
    void setFirstAdminUser(const OAIFirstAdminUser &first_admin_user);
    bool is_first_admin_user_Set() const;
    bool is_first_admin_user_Valid() const;
...
private:
    ...
    OAIFirstAdminUser m_first_admin_user;
    bool m_first_admin_user_isSet;
    bool m_first_admin_user_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewCustomerResponse)

#endif // OAINewCustomerResponse_H
