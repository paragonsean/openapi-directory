...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.UserAuthMethod();
  });
  ...
  describe('UserAuthMethod', function() {
    it('should create an instance of UserAuthMethod', function() {
      // uncomment below and update the code to test UserAuthMethod
      //var instance = new DracoonApi.UserAuthMethod();
      //expect(instance).to.be.a(DracoonApi.UserAuthMethod);
    });
