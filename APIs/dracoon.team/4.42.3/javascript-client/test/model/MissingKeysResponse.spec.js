...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.MissingKeysResponse();
  });
  ...
  describe('MissingKeysResponse', function() {
    it('should create an instance of MissingKeysResponse', function() {
      // uncomment below and update the code to test MissingKeysResponse
      //var instance = new DracoonApi.MissingKeysResponse();
      //expect(instance).to.be.a(DracoonApi.MissingKeysResponse);
    });
