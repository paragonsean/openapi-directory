...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.UpdateDownloadShareRequest();
  });
  ...
  describe('UpdateDownloadShareRequest', function() {
    it('should create an instance of UpdateDownloadShareRequest', function() {
      // uncomment below and update the code to test UpdateDownloadShareRequest
      //var instance = new DracoonApi.UpdateDownloadShareRequest();
      //expect(instance).to.be.a(DracoonApi.UpdateDownloadShareRequest);
    });
