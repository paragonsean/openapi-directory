...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.UpdateFolderRequest();
  });
  ...
  describe('UpdateFolderRequest', function() {
    it('should create an instance of UpdateFolderRequest', function() {
      // uncomment below and update the code to test UpdateFolderRequest
      //var instance = new DracoonApi.UpdateFolderRequest();
      //expect(instance).to.be.a(DracoonApi.UpdateFolderRequest);
    });
