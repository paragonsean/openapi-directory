...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.CreateFileUploadRequest();
  });
  ...
  describe('CreateFileUploadRequest', function() {
    it('should create an instance of CreateFileUploadRequest', function() {
      // uncomment below and update the code to test CreateFileUploadRequest
      //var instance = new DracoonApi.CreateFileUploadRequest();
      //expect(instance).to.be.a(DracoonApi.CreateFileUploadRequest);
    });
