...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.EncryptionPasswordPolicies();
  });
  ...
  describe('EncryptionPasswordPolicies', function() {
    it('should create an instance of EncryptionPasswordPolicies', function() {
      // uncomment below and update the code to test EncryptionPasswordPolicies
      //var instance = new DracoonApi.EncryptionPasswordPolicies();
      //expect(instance).to.be.a(DracoonApi.EncryptionPasswordPolicies);
    });
