...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.CopyNode();
  });
  ...
  describe('CopyNode', function() {
    it('should create an instance of CopyNode', function() {
      // uncomment below and update the code to test CopyNode
      //var instance = new DracoonApi.CopyNode();
      //expect(instance).to.be.a(DracoonApi.CopyNode);
    });
