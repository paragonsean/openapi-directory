...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.UpdateFilesBulkRequest();
  });
  ...
  describe('UpdateFilesBulkRequest', function() {
    it('should create an instance of UpdateFilesBulkRequest', function() {
      // uncomment below and update the code to test UpdateFilesBulkRequest
      //var instance = new DracoonApi.UpdateFilesBulkRequest();
      //expect(instance).to.be.a(DracoonApi.UpdateFilesBulkRequest);
    });
