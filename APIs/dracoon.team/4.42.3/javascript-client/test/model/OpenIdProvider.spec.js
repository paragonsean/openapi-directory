...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.OpenIdProvider();
  });
  ...
  describe('OpenIdProvider', function() {
    it('should create an instance of OpenIdProvider', function() {
      // uncomment below and update the code to test OpenIdProvider
      //var instance = new DracoonApi.OpenIdProvider();
      //expect(instance).to.be.a(DracoonApi.OpenIdProvider);
    });
    ...
    it('should have the property isGlobalAvailable (base name: "isGlobalAvailable")', function() {
      // uncomment below and update the code to test the property isGlobalAvailable
      //var instance = new DracoonApi.OpenIdProvider();
      //expect(instance).to.be();
    });
