...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.UpdateEncryptionPasswordPolicies();
  });
  ...
  describe('UpdateEncryptionPasswordPolicies', function() {
    it('should create an instance of UpdateEncryptionPasswordPolicies', function() {
      // uncomment below and update the code to test UpdateEncryptionPasswordPolicies
      //var instance = new DracoonApi.UpdateEncryptionPasswordPolicies();
      //expect(instance).to.be.a(DracoonApi.UpdateEncryptionPasswordPolicies);
    });
