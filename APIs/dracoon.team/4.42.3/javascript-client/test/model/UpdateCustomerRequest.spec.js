...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.UpdateCustomerRequest();
  });
  ...
  describe('UpdateCustomerRequest', function() {
    it('should create an instance of UpdateCustomerRequest', function() {
      ...
      //var instance = new DracoonApi.UpdateCustomerRequest();
      //expect(instance).to.be.a(DracoonApi.UpdateCustomerRequest);
    });
