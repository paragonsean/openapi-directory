...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.UpdateSharesPasswordPolicies();
  });
  ...
  describe('UpdateSharesPasswordPolicies', function() {
    it('should create an instance of UpdateSharesPasswordPolicies', function() {
      // uncomment below and update the code to test UpdateSharesPasswordPolicies
      //var instance = new DracoonApi.UpdateSharesPasswordPolicies();
      //expect(instance).to.be.a(DracoonApi.UpdateSharesPasswordPolicies);
    });
