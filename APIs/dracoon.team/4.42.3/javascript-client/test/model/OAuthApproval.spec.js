...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.OAuthApproval();
  });
  ...
  describe('OAuthApproval', function() {
    it('should create an instance of OAuthApproval', function() {
      // uncomment below and update the code to test OAuthApproval
      //var instance = new DracoonApi.OAuthApproval();
      //expect(instance).to.be.a(DracoonApi.OAuthApproval);
    });
