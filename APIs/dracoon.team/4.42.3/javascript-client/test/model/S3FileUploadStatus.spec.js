...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.S3FileUploadStatus();
  });
  ...
  describe('S3FileUploadStatus', function() {
    it('should create an instance of S3FileUploadStatus', function() {
      // uncomment below and update the code to test S3FileUploadStatus
      //var instance = new DracoonApi.S3FileUploadStatus();
      //expect(instance).to.be.a(DracoonApi.S3FileUploadStatus);
    });
