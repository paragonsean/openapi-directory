...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.NewCustomerRequest();
  });
  ...
  describe('NewCustomerRequest', function() {
    it('should create an instance of NewCustomerRequest', function() {
      // uncomment below and update the code to test NewCustomerRequest
      //var instance = new DracoonApi.NewCustomerRequest();
      //expect(instance).to.be.a(DracoonApi.NewCustomerRequest);
    });
    ...
    it('should have the property firstAdminUser (base name: "firstAdminUser")', function() {
      // uncomment below and update the code to test the property firstAdminUser
      //var instance = new DracoonApi.NewCustomerRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property trialDays (base name: "trialDays")', function() {
      // uncomment below and update the code to test the property trialDays
      //var instance = new DracoonApi.NewCustomerRequest();
      //expect(instance).to.be();
    });
