...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.S3ConfigUpdateRequest();
  });
  ...
  describe('S3ConfigUpdateRequest', function() {
    it('should create an instance of S3ConfigUpdateRequest', function() {
      // uncomment below and update the code to test S3ConfigUpdateRequest
      //var instance = new DracoonApi.S3ConfigUpdateRequest();
      //expect(instance).to.be.a(DracoonApi.S3ConfigUpdateRequest);
    });
    ...
    it('should have the property bucketUrl (base name: "bucketUrl")', function() {
      // uncomment below and update the code to test the property bucketUrl
      //var instance = new DracoonApi.S3ConfigUpdateRequest();
      //expect(instance).to.be();
    });
