...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.CreateFolderRequest();
  });
  ...
  describe('CreateFolderRequest', function() {
    it('should create an instance of CreateFolderRequest', function() {
      // uncomment below and update the code to test CreateFolderRequest
      //var instance = new DracoonApi.CreateFolderRequest();
      //expect(instance).to.be.a(DracoonApi.CreateFolderRequest);
    });
