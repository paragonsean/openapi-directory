...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.NewCustomerResponse();
  });
  ...
  describe('NewCustomerResponse', function() {
    it('should create an instance of NewCustomerResponse', function() {
      // uncomment below and update the code to test NewCustomerResponse
      //var instance = new DracoonApi.NewCustomerResponse();
      //expect(instance).to.be.a(DracoonApi.NewCustomerResponse);
    });
