...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.UpdateOpenIdIdpConfigRequest();
  });
  ...
  describe('UpdateOpenIdIdpConfigRequest', function() {
    it('should create an instance of UpdateOpenIdIdpConfigRequest', function() {
      // uncomment below and update the code to test UpdateOpenIdIdpConfigRequest
      //var instance = new DracoonApi.UpdateOpenIdIdpConfigRequest();
      //expect(instance).to.be.a(DracoonApi.UpdateOpenIdIdpConfigRequest);
    });
    ...
    it('should have the property resetFallbackMappingClaim (base name: "resetFallbackMappingClaim")', function() {
      // uncomment below and update the code to test the property resetFallbackMappingClaim
      //var instance = new DracoonApi.UpdateOpenIdIdpConfigRequest();
      //expect(instance).to.be();
    });
