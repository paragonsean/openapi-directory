...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.PendingAssignment();
  });
  ...
  describe('PendingAssignment', function() {
    it('should create an instance of PendingAssignment', function() {
      // uncomment below and update the code to test PendingAssignment
      //var instance = new DracoonApi.PendingAssignment();
      //expect(instance).to.be.a(DracoonApi.PendingAssignment);
    });
