...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.MoveNode();
  });
  ...
  describe('MoveNode', function() {
    it('should create an instance of MoveNode', function() {
      // uncomment below and update the code to test MoveNode
      //var instance = new DracoonApi.MoveNode();
      //expect(instance).to.be.a(DracoonApi.MoveNode);
    });
