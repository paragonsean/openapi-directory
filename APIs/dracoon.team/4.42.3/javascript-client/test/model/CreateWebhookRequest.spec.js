...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.CreateWebhookRequest();
  });
  ...
  describe('CreateWebhookRequest', function() {
    it('should create an instance of CreateWebhookRequest', function() {
      ...
      //var instance = new DracoonApi.CreateWebhookRequest();
      //expect(instance).to.be.a(DracoonApi.CreateWebhookRequest);
    });
    ...
    it('should have the property triggerExampleEvent (base name: "triggerExampleEvent")', function() {
      // uncomment below and update the code to test the property triggerExampleEvent
      //var instance = new DracoonApi.CreateWebhookRequest();
      //expect(instance).to.be();
    });
