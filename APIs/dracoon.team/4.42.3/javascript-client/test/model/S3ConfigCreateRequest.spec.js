...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.S3ConfigCreateRequest();
  });
  ...
  describe('S3ConfigCreateRequest', function() {
    it('should create an instance of S3ConfigCreateRequest', function() {
      // uncomment below and update the code to test S3ConfigCreateRequest
      //var instance = new DracoonApi.S3ConfigCreateRequest();
      //expect(instance).to.be.a(DracoonApi.S3ConfigCreateRequest);
    });
