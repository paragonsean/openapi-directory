...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.SharesPasswordPolicies();
  });
  ...
  describe('SharesPasswordPolicies', function() {
    it('should create an instance of SharesPasswordPolicies', function() {
      // uncomment below and update the code to test SharesPasswordPolicies
      //var instance = new DracoonApi.SharesPasswordPolicies();
      //expect(instance).to.be.a(DracoonApi.SharesPasswordPolicies);
    });
