...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.UpdateFileRequest();
  });
  ...
  describe('UpdateFileRequest', function() {
    it('should create an instance of UpdateFileRequest', function() {
      // uncomment below and update the code to test UpdateFileRequest
      //var instance = new DracoonApi.UpdateFileRequest();
      //expect(instance).to.be.a(DracoonApi.UpdateFileRequest);
    });
