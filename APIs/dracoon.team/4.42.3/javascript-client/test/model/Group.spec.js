...
(function(root, factory) {
  ...
  describe('Group', function() {
    it('should create an instance of Group', function() {
      ...
      //var instance = new DracoonApi.Group();
      //expect(instance).to.be.a(DracoonApi.Group);
    });

    it('should have the property cntUsers (base name: "cntUsers")', function() {
      // uncomment below and update the code to test the property cntUsers
      //var instance = new DracoonApi.Group();
