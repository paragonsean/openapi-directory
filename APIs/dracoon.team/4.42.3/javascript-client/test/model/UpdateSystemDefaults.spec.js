...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DracoonApi.UpdateSystemDefaults();
  });
  ...
  describe('UpdateSystemDefaults', function() {
    it('should create an instance of UpdateSystemDefaults', function() {
      // uncomment below and update the code to test UpdateSystemDefaults
      //var instance = new DracoonApi.UpdateSystemDefaults();
      //expect(instance).to.be.a(DracoonApi.UpdateSystemDefaults);
    });
