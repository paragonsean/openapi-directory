...
**isExternal** | **Boolean** | Determines whether client is an external client. | [optional] 
**isStandard** | **Boolean** | Determines whether client is a standard client. | [optional] 
