# DracoonApi.ActiveDirectoryConfig
...
**createHomeFolder** | **Boolean** | &amp;#128679; Deprecated since v4.10.0  DEPRECATED, will be ignored  Determines whether a room is created for each user that is created by automatic import (like a home folder).  Room&#39;s name will equal the user&#39;s login name. | [optional] [default to false]
**homeFolderParent** | **Number** | &amp;#128679; Deprecated since v4.10.0  DEPRECATED, will be ignored  ID of the room in which the individual rooms for users will be created. | [optional] 
**id** | **Number** | ID | 
