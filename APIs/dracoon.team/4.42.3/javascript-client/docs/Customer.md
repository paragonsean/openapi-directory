...
**cntGuestUser** | **Number** | Number of guest user accounts | 
**cntInternalUser** | **Number** | Number of internal user accounts | 
...
**lastLoginAt** | **Date** | Date of last seen login for the customer | [optional] 
...
**quotaUsed** | **Number** | Used amount of disc space in bytes | 
**trialDaysLeft** | **Number** | Number of days left for trial period (relevant only for type &#x60;demo&#x60;)  (not used) | [optional] 
**updatedAt** | **Date** | Modification date | [optional] 
**userMax** | **Number** | Maximal number of users | 
**userUsed** | **Number** | Number of users which are already allocated. | 
