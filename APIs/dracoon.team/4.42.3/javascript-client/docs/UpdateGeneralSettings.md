# DracoonApi.UpdateGeneralSettings

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**authTokenRestrictions** | [**UpdateAuthTokenRestrictions**](UpdateAuthTokenRestrictions.md) |  | [optional] 
...
**hideLoginInputFields** | **Boolean** | &amp;#128679; Deprecated since v4.13.0  Defines if login fields should be hidden | [optional] 
