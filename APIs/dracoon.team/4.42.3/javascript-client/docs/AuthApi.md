...
> LoginResponse completeOpenIdLogin(code, state, opts)
...
let apiInstance = new DracoonApi.AuthApi();
let code = "code_example"; // String | Authorization code
let state = "state_example"; // String | Authentication state
let opts = {
  'idToken': "idToken_example" // String | Identity token
};
apiInstance.completeOpenIdLogin(code, state, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new DracoonApi.AuthApi();
let issuer = "issuer_example"; // String | Issuer identifier of the OpenID Connect identity provider
let redirectUri = "redirectUri_example"; // String | Redirect URI to complete the OpenID Connect authentication
let language = "language_example"; // String | Language ID or ISO 639-1 code
let test = true; // Boolean | Flag to test the authentication parameters.  If the request is valid, the API will respond with `204 No Content`.
apiInstance.initiateOpenIdLogin(issuer, redirectUri, language, test, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new DracoonApi.AuthApi();
let loginRequest = new DracoonApi.LoginRequest(); // LoginRequest | 
...
let apiInstance = new DracoonApi.AuthApi();
let recoverUserNameRequest = new DracoonApi.RecoverUserNameRequest(); // RecoverUserNameRequest | 
apiInstance.recoverUserName(recoverUserNameRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new DracoonApi.AuthApi();
let resetPasswordRequest = new DracoonApi.ResetPasswordRequest(); // ResetPasswordRequest | 
apiInstance.requestPasswordReset(resetPasswordRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new DracoonApi.AuthApi();
let token = "token_example"; // String | Password reset token
let resetPasswordWithTokenRequest = new DracoonApi.ResetPasswordWithTokenRequest(); // ResetPasswordWithTokenRequest | 
apiInstance.resetPassword(token, resetPasswordWithTokenRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new DracoonApi.AuthApi();
let token = "token_example"; // String | Password reset token
apiInstance.validateResetPasswordToken(token, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
