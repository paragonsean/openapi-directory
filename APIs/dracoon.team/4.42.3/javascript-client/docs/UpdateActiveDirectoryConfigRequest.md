# DracoonApi.UpdateActiveDirectoryConfigRequest
...
**ldapUsersDomain** | **String** | Search scope of Active Directory; only users below this node can log on. | [optional] 
**sdsImportGroup** | **Number** | User group that is assigned to users who are created by automatic import.  Reset with &#x60;0&#x60; | [optional] 
**serverAdminName** | **String** | Distinguished Name (DN) of Active Directory administrative account | [optional] 
**serverAdminPassword** | **String** | Password of Active Directory administrative account | [optional] 
**serverIp** | **String** | IPv4 or IPv6 address or host name | [optional] 
**serverPort** | **Number** | Port | [optional] 
...
**useLdaps** | **Boolean** | Determines whether LDAPS should be used instead of plain LDAP. | [optional] 
**userFilter** | **String** | Name of Active Directory attribute that is used as login name. | [optional] 
**userImport** | **Boolean** | Determines if a DRACOON account is automatically created for a new user  who successfully logs on with his / her AD / IDP account. | [optional] 
