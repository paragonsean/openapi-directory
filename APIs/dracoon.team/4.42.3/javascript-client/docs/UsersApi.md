...
> UserData createUser(createUserRequest, opts)
...
let apiInstance = new DracoonApi.UsersApi();
let createUserRequest = new DracoonApi.CreateUserRequest(); // CreateUserRequest | 
let opts = {
...
apiInstance.removeUser(userId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> removeUserAttribute(userId, key, opts)
...
apiInstance.removeUserAttribute(userId, key, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> EmergencyMfaCodeResponse requestEmergencyMfaCode(userId, opts)
...
apiInstance.requestEmergencyMfaCode(userId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LastAdminUserRoomList requestLastAdminRoomsUsers(userId, opts)
...
apiInstance.requestLastAdminRoomsUsers(userId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UserData requestUser(userId, opts)
...
let opts = {
  'xSdsDateFormat': "xSdsDateFormat_example", // String | Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) & [leettime.de](http://leettime.de/))
  'effectiveRoles': true, // Boolean | Filter users with DIRECT or DIRECT **AND** EFFECTIVE roles.  * `false`: DIRECT roles  * `true`: DIRECT **AND** EFFECTIVE roles  DIRECT means: e.g. user gets role **directly** granted from someone with _grant permission_ right.  EFFECTIVE means: e.g. user gets role through **group membership**.
  'xSdsAuthToken': "xSdsAuthToken_example" // String | Authentication token
};
apiInstance.requestUser(userId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> AttributesResponse requestUserAttributes(userId, opts)
...
apiInstance.requestUserAttributes(userId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UserGroupList requestUserGroups(userId, opts)
...
apiInstance.requestUserGroups(userId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> RoleList requestUserRoles(userId, opts)
...
apiInstance.requestUserRoles(userId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.requestUsers(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> RoomTreeDataList requestUsersRooms(userId, opts)
...
apiInstance.requestUsersRooms(userId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UserData setUserAttributes(userId, userAttributes, opts)
...
let apiInstance = new DracoonApi.UsersApi();
let userId = 789; // Number | User ID
let userAttributes = new DracoonApi.UserAttributes(); // UserAttributes | 
let opts = {
  'xSdsDateFormat': "xSdsDateFormat_example", // String | Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) & [leettime.de](http://leettime.de/))
  'xSdsAuthToken': "xSdsAuthToken_example" // String | Authentication token
};
apiInstance.setUserAttributes(userId, userAttributes, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UserData updateUser(userId, updateUserRequest, opts)
...
let apiInstance = new DracoonApi.UsersApi();
let userId = 789; // Number | User ID
let updateUserRequest = new DracoonApi.UpdateUserRequest(); // UpdateUserRequest | 
let opts = {
  'xSdsDateFormat': "xSdsDateFormat_example", // String | Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) & [leettime.de](http://leettime.de/))
  'xSdsAuthToken': "xSdsAuthToken_example" // String | Authentication token
};
...
> UserData updateUserAttributes(userId, userAttributes, opts)
...
apiInstance.updateUserAttributes(userId, userAttributes, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
