# DracoonApi.SystemPoliciesConfigApi
...
> ClassificationPoliciesConfig changeClassificationPoliciesConfig(updateClassificationPoliciesConfig, opts)
...
let apiInstance = new DracoonApi.SystemPoliciesConfigApi();
let updateClassificationPoliciesConfig = new DracoonApi.UpdateClassificationPoliciesConfig(); // UpdateClassificationPoliciesConfig | 
let opts = {
  'xSdsAuthToken': "xSdsAuthToken_example" // String | Authentication token
};
apiInstance.changeClassificationPoliciesConfig(updateClassificationPoliciesConfig, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GuestUsersPoliciesConfig changeGuestUsersPoliciesConfig(updateGuestUsersPoliciesConfig, opts)
...
let apiInstance = new DracoonApi.SystemPoliciesConfigApi();
let updateGuestUsersPoliciesConfig = new DracoonApi.UpdateGuestUsersPoliciesConfig(); // UpdateGuestUsersPoliciesConfig | 
let opts = {
  'xSdsAuthToken': "xSdsAuthToken_example" // String | Authentication token
};
apiInstance.changeGuestUsersPoliciesConfig(updateGuestUsersPoliciesConfig, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> MfaPoliciesConfig changeMfaPoliciesConfig(updateMfaPoliciesConfig, opts)
...
let apiInstance = new DracoonApi.SystemPoliciesConfigApi();
let updateMfaPoliciesConfig = new DracoonApi.UpdateMfaPoliciesConfig(); // UpdateMfaPoliciesConfig | 
let opts = {
  'xSdsAuthToken': "xSdsAuthToken_example" // String | Authentication token
};
apiInstance.changeMfaPoliciesConfig(updateMfaPoliciesConfig, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PasswordPoliciesConfig changePasswordPoliciesConfig(updatePasswordPoliciesConfig, opts)
...
let apiInstance = new DracoonApi.SystemPoliciesConfigApi();
let updatePasswordPoliciesConfig = new DracoonApi.UpdatePasswordPoliciesConfig(); // UpdatePasswordPoliciesConfig | 
let opts = {
  'xSdsAuthToken': "xSdsAuthToken_example" // String | Authentication token
};
apiInstance.changePasswordPoliciesConfig(updatePasswordPoliciesConfig, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> enforceLoginPasswordChange(opts)
...
apiInstance.enforceLoginPasswordChange(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ClassificationPoliciesConfig requestClassificationPoliciesConfig(opts)
...
apiInstance.requestClassificationPoliciesConfig(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GuestUsersPoliciesConfig requestGuestUsersPoliciesConfig(opts)
...
apiInstance.requestGuestUsersPoliciesConfig(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> MfaPoliciesConfig requestMfaPoliciesConfig(opts)
...
apiInstance.requestMfaPoliciesConfig(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PasswordPoliciesConfig requestPasswordPoliciesConfig(opts)
...
apiInstance.requestPasswordPoliciesConfig(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PasswordPoliciesConfig requestPasswordPoliciesForPasswordType(passwordType, opts)
...
let apiInstance = new DracoonApi.SystemPoliciesConfigApi();
let passwordType = "passwordType_example"; // String | Password type
let opts = {
  'xSdsAuthToken': "xSdsAuthToken_example" // String | Authentication token
};
apiInstance.requestPasswordPoliciesForPasswordType(passwordType, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
