...
> AlgorithmVersionInfoList requestAlgorithms(opts)
...
let apiInstance = new DracoonApi.ConfigApi();
let opts = {
  'xSdsAuthToken': "xSdsAuthToken_example" // String | Authentication token
};
apiInstance.requestAlgorithms(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ClassificationPoliciesConfig requestClassificationPoliciesConfigInfo(opts)
...
apiInstance.requestClassificationPoliciesConfigInfo(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ProductPackageResponseList requestCurrentProductPackages(opts)
...
apiInstance.requestCurrentProductPackages(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GeneralSettingsInfo requestGeneralSettingsInfo(opts)
...
apiInstance.requestGeneralSettingsInfo(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GuestUsersPoliciesConfig requestGuestUsersPoliciesConfigInfo(opts)
...
apiInstance.requestGuestUsersPoliciesConfigInfo(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> InfrastructureProperties requestInfrastructurePropertiesInfo(opts)
...
apiInstance.requestInfrastructurePropertiesInfo(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> NotificationChannelList requestNotificationChannelsInfo(opts)
...
apiInstance.requestNotificationChannelsInfo(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PasswordPoliciesConfig requestPasswordPoliciesConfigInfo(opts)
...
apiInstance.requestPasswordPoliciesConfigInfo(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ProductPackageResponseList requestProductPackages(opts)
...
apiInstance.requestProductPackages(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> S3TagList requestS3TagsInfo(opts)
...
apiInstance.requestS3TagsInfo(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> SystemDefaults requestSystemDefaultsInfo(opts)
...
apiInstance.requestSystemDefaultsInfo(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ConfigOptionList requestSystemSettings(opts)
...
apiInstance.requestSystemSettings(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> updateSystemSettings(configOptionList, opts)
...
let apiInstance = new DracoonApi.ConfigApi();
let configOptionList = new DracoonApi.ConfigOptionList(); // ConfigOptionList | 
let opts = {
  'xSdsAuthToken': "xSdsAuthToken_example" // String | Authentication token
};
apiInstance.updateSystemSettings(configOptionList, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
