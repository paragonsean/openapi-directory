...
class CustomerList {
     ...
     * @param items {Array.<module:model/Customer>} List of customers
     * @param range {module:model/Range} 
     */
    constructor(items, range) { 
        
        CustomerList.initialize(this, items, range);
    }
...
CustomerList.RequiredProperties = ["items", "range"];

/**
 * List of customers
 * @member {Array.<module:model/Customer>} items
 */
CustomerList.prototype['items'] = undefined;

/**
 * @member {module:model/Range} range
 */
CustomerList.prototype['range'] = undefined;
