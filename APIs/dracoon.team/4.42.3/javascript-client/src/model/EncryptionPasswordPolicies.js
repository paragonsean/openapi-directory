...
/**
 * The EncryptionPasswordPolicies model module.
 * @module model/EncryptionPasswordPolicies
 * @version 4.42.3
 */
class EncryptionPasswordPolicies {
    /**
     * Constructs a new <code>EncryptionPasswordPolicies</code>.
     * Encryption password policies
     * @alias module:model/EncryptionPasswordPolicies
     */
    constructor() { 
        
        EncryptionPasswordPolicies.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EncryptionPasswordPolicies</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EncryptionPasswordPolicies} obj Optional instance to populate.
     * @return {module:model/EncryptionPasswordPolicies} The populated <code>EncryptionPasswordPolicies</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EncryptionPasswordPolicies();
    ...
    /**
     * Validates the JSON data with respect to <code>EncryptionPasswordPolicies</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EncryptionPasswordPolicies</code>.
     */
 ...
 */
EncryptionPasswordPolicies.prototype['characterRules'] = undefined;

/**
 * Minimum number of characters a password must contain
 * @member {Number} minLength
 */
EncryptionPasswordPolicies.prototype['minLength'] = undefined;
 ...
 */
EncryptionPasswordPolicies.prototype['rejectKeyboardPatterns'] = undefined;
 ...
 */
EncryptionPasswordPolicies.prototype['rejectUserInfo'] = undefined;

/**
 * Modification date
 * @member {Date} updatedAt
 */
EncryptionPasswordPolicies.prototype['updatedAt'] = undefined;

/**
 * @member {module:model/UserInfo} updatedBy
 */
EncryptionPasswordPolicies.prototype['updatedBy'] = undefined;
...
export default EncryptionPasswordPolicies;
