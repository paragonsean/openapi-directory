...
/**
 * The SharesPasswordPolicies model module.
 * @module model/SharesPasswordPolicies
 * @version 4.42.3
 */
class SharesPasswordPolicies {
    /**
     * Constructs a new <code>SharesPasswordPolicies</code>.
     * Shares password policies
     * @alias module:model/SharesPasswordPolicies
     */
    constructor() { 
        
        SharesPasswordPolicies.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SharesPasswordPolicies</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SharesPasswordPolicies} obj Optional instance to populate.
     * @return {module:model/SharesPasswordPolicies} The populated <code>SharesPasswordPolicies</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SharesPasswordPolicies();
    ...
    /**
     * Validates the JSON data with respect to <code>SharesPasswordPolicies</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SharesPasswordPolicies</code>.
     */
 ...
 */
SharesPasswordPolicies.prototype['rejectKeyboardPatterns'] = undefined;
 ...
 */
SharesPasswordPolicies.prototype['rejectUserInfo'] = undefined;

/**
 * Modification date
 * @member {Date} updatedAt
 */
SharesPasswordPolicies.prototype['updatedAt'] = undefined;

/**
 * @member {module:model/UserInfo} updatedBy
 */
SharesPasswordPolicies.prototype['updatedBy'] = undefined;
...
export default SharesPasswordPolicies;
