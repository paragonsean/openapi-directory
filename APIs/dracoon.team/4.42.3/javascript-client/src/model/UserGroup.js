...
class UserGroup {
     ...
     */
    constructor(id, isMember, name) { 
        
        UserGroup.initialize(this, id, isMember, name);
    }
     ...
     */
    static initialize(obj, id, isMember, name) { 
        obj['id'] = id;
...
UserGroup.RequiredProperties = ["id", "isMember", "name"];
 ...
 */
UserGroup.prototype['isMember'] = undefined;
