...
class NodeList {
     ...
     * @param items {Array.<module:model/Node>} List of nodes
     * @param range {module:model/Range} 
     */
    constructor(items, range) { 
        
        NodeList.initialize(this, items, range);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [Node]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>NodeList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NodeList.RequiredProperties) {
...
NodeList.RequiredProperties = ["items", "range"];

/**
 * List of nodes
 * @member {Array.<module:model/Node>} items
 */
NodeList.prototype['items'] = undefined;

/**
 * @member {module:model/Range} range
 */
NodeList.prototype['range'] = undefined;
