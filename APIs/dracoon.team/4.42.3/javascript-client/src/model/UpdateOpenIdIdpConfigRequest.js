...
/**
 * The UpdateOpenIdIdpConfigRequest model module.
 * @module model/UpdateOpenIdIdpConfigRequest
 * @version 4.42.3
 */
class UpdateOpenIdIdpConfigRequest {
    /**
     * Constructs a new <code>UpdateOpenIdIdpConfigRequest</code>.
     * Request model for updating an OpenID Connect IDP configuration
     * @alias module:model/UpdateOpenIdIdpConfigRequest
     */
    constructor() { 
        
        UpdateOpenIdIdpConfigRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateOpenIdIdpConfigRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateOpenIdIdpConfigRequest} obj Optional instance to populate.
     * @return {module:model/UpdateOpenIdIdpConfigRequest} The populated <code>UpdateOpenIdIdpConfigRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateOpenIdIdpConfigRequest();
            ...
            if (data.hasOwnProperty('resetFallbackMappingClaim')) {
                obj['resetFallbackMappingClaim'] = ApiClient.convertToType(data['resetFallbackMappingClaim'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateOpenIdIdpConfigRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateOpenIdIdpConfigRequest</code>.
     */
 ...
 */
UpdateOpenIdIdpConfigRequest.prototype['authorizationEndPointUrl'] = undefined;

/**
 * ID of the OpenID client
 * @member {String} clientId
 */
UpdateOpenIdIdpConfigRequest.prototype['clientId'] = undefined;

/**
 * Secret, which client uses at authentication.
 * @member {String} clientSecret
 */
UpdateOpenIdIdpConfigRequest.prototype['clientSecret'] = undefined;

/**
 * Name of the claim which is used for the user mapping fallback.
 * @member {String} fallbackMappingClaim
 */
UpdateOpenIdIdpConfigRequest.prototype['fallbackMappingClaim'] = undefined;

/**
 * &#128640; Since v4.11.0  Flow, which is used at authentication
 * @member {module:model/UpdateOpenIdIdpConfigRequest.FlowEnum} flow
 */
UpdateOpenIdIdpConfigRequest.prototype['flow'] = undefined;

/**
 * Issuer identifier of the IDP  The value is a case sensitive URL.
 * @member {String} issuer
 */
UpdateOpenIdIdpConfigRequest.prototype['issuer'] = undefined;

/**
 * URL of the JWKS endpoint
 * @member {String} jwksEndPointUrl
 */
UpdateOpenIdIdpConfigRequest.prototype['jwksEndPointUrl'] = undefined;

/**
 * Name of the claim which is used for the user mapping.
 * @member {String} mappingClaim
 */
UpdateOpenIdIdpConfigRequest.prototype['mappingClaim'] = undefined;

/**
 * Name of the IDP
 * @member {String} name
 */
UpdateOpenIdIdpConfigRequest.prototype['name'] = undefined;

/**
 * PKCE code challenge method.  cf. [RFC 7636](https://tools.ietf.org/html/rfc7636)
 * @member {String} pkceChallengeMethod
 */
UpdateOpenIdIdpConfigRequest.prototype['pkceChallengeMethod'] = undefined;
 ...
 * @default false
 */
UpdateOpenIdIdpConfigRequest.prototype['pkceEnabled'] = false;

/**
 * URIs, to which a user is redirected after authorization.
 * @member {Array.<String>} redirectUris
 */
UpdateOpenIdIdpConfigRequest.prototype['redirectUris'] = undefined;

/**
 * Set `true` to reset `fallbackMappingClaim`.
 * @member {Boolean} resetFallbackMappingClaim
 */
UpdateOpenIdIdpConfigRequest.prototype['resetFallbackMappingClaim'] = undefined;

/**
 * List of requested scopes  Usually `openid` and the names of the requested claims.
 * @member {Array.<String>} scopes
 */
UpdateOpenIdIdpConfigRequest.prototype['scopes'] = undefined;

/**
 * URL of the token endpoint
 * @member {String} tokenEndPointUrl
 */
UpdateOpenIdIdpConfigRequest.prototype['tokenEndPointUrl'] = undefined;
 ...
 * @default false
 */
UpdateOpenIdIdpConfigRequest.prototype['userImportEnabled'] = false;

/**
 * User group that is assigned to users who are created by automatic import.  Reset with `0`
 * @member {Number} userImportGroup
 */
UpdateOpenIdIdpConfigRequest.prototype['userImportGroup'] = undefined;

/**
 * URL of the user info endpoint
 * @member {String} userInfoEndPointUrl
 */
UpdateOpenIdIdpConfigRequest.prototype['userInfoEndPointUrl'] = undefined;

/**
 * &#128640; Since v4.23.0  Source, which is used to get user information at the import or update of a user.
 * @member {module:model/UpdateOpenIdIdpConfigRequest.UserInfoSourceEnum} userInfoSource
 */
UpdateOpenIdIdpConfigRequest.prototype['userInfoSource'] = undefined;

/**
 * URL of the user management UI.  Use empty string to remove.
 * @member {String} userManagementUrl
 */
UpdateOpenIdIdpConfigRequest.prototype['userManagementUrl'] = undefined;
 ...
 * @default false
 */
UpdateOpenIdIdpConfigRequest.prototype['userUpdateEnabled'] = false;
 ...
 * @readonly
 */
UpdateOpenIdIdpConfigRequest['FlowEnum'] = {
 ...
 * @readonly
 */
UpdateOpenIdIdpConfigRequest['UserInfoSourceEnum'] = {
...
export default UpdateOpenIdIdpConfigRequest;
