...
/**
 * The S3ConfigUpdateRequest model module.
 * @module model/S3ConfigUpdateRequest
 * @version 4.42.3
 */
class S3ConfigUpdateRequest {
    /**
     * Constructs a new <code>S3ConfigUpdateRequest</code>.
     * Request model for updating a S3 configuration
     * @alias module:model/S3ConfigUpdateRequest
     */
    constructor() { 
        
        S3ConfigUpdateRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>S3ConfigUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/S3ConfigUpdateRequest} obj Optional instance to populate.
     * @return {module:model/S3ConfigUpdateRequest} The populated <code>S3ConfigUpdateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new S3ConfigUpdateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>S3ConfigUpdateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>S3ConfigUpdateRequest</code>.
     */
 ...
 */
S3ConfigUpdateRequest.prototype['accessKey'] = undefined;

/**
 * &#128679; Deprecated since v4.24.0  S3 bucket name  use `bucketUrl` instead
 * @member {String} bucketName
 */
S3ConfigUpdateRequest.prototype['bucketName'] = undefined;

/**
 * S3 object storage bucket URL
 * @member {String} bucketUrl
 */
S3ConfigUpdateRequest.prototype['bucketUrl'] = undefined;

/**
 * &#128679; Deprecated since v4.24.0  S3 object storage endpoint URL  use `bucketUrl` instead
 * @member {String} endpointUrl
 */
S3ConfigUpdateRequest.prototype['endpointUrl'] = undefined;

/**
 * S3 region
 * @member {String} region
 */
S3ConfigUpdateRequest.prototype['region'] = undefined;

/**
 * Secret Access Key
 * @member {String} secretKey
 */
S3ConfigUpdateRequest.prototype['secretKey'] = undefined;
...
export default S3ConfigUpdateRequest;
