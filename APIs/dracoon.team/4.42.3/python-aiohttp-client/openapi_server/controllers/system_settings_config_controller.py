...
async def request_auth_config(request: web.Request, x_sds_auth_token=None) -> web.Response:
...
async def request_eventlog_config(request: web.Request, x_sds_auth_token=None) -> web.Response:
...
async def request_general_settings(request: web.Request, x_sds_auth_token=None) -> web.Response:
...
async def request_infrastructure_properties(request: web.Request, x_sds_auth_token=None) -> web.Response:
...
async def request_syslog_config(request: web.Request, x_sds_auth_token=None) -> web.Response:
...
async def request_system_defaults(request: web.Request, x_sds_auth_token=None) -> web.Response:
...
async def update_auth_config(request: web.Request, body, x_sds_auth_token=None) -> web.Response:
    ...
    """
    body = AuthConfig.from_dict(body)
    return web.Response(status=200)


async def update_eventlog_config(request: web.Request, body, x_sds_auth_token=None) -> web.Response:
    ...
    """
    body = UpdateEventlogConfig.from_dict(body)
    return web.Response(status=200)


async def update_general_settings(request: web.Request, body, x_sds_auth_token=None) -> web.Response:
    ...
    """
    body = UpdateGeneralSettings.from_dict(body)
    return web.Response(status=200)


async def update_syslog_config(request: web.Request, body, x_sds_auth_token=None) -> web.Response:
    ...
    """
    body = UpdateSyslogConfig.from_dict(body)
    return web.Response(status=200)


async def update_system_defaults(request: web.Request, body, x_sds_auth_token=None) -> web.Response:
    ...
    """
    body = UpdateSystemDefaults.from_dict(body)
    return web.Response(status=200)
