...
class GeneralSettings(Model):
    ...
    def __init__(self, auth_token_restrictions: AuthTokenRestrictions=None, crypto_enabled: bool=None, email_notification_button_enabled: bool=None, eula_enabled: bool=None, hide_login_input_fields: bool=None, media_server_enabled: bool=None, s3_tags_enabled: bool=None, share_password_sms_enabled: bool=None, use_s3_storage: bool=None, weak_password_enabled: bool=None):
        """GeneralSettings - a model defined in OpenAPI

        :param auth_token_restrictions: The auth_token_restrictions of this GeneralSettings.
        :param crypto_enabled: The crypto_enabled of this GeneralSettings.
        :param email_notification_button_enabled: The email_notification_button_enabled of this GeneralSettings.
        :param eula_enabled: The eula_enabled of this GeneralSettings.
        :param hide_login_input_fields: The hide_login_input_fields of this GeneralSettings.
        :param media_server_enabled: The media_server_enabled of this GeneralSettings.
        :param s3_tags_enabled: The s3_tags_enabled of this GeneralSettings.
        :param share_password_sms_enabled: The share_password_sms_enabled of this GeneralSettings.
        :param use_s3_storage: The use_s3_storage of this GeneralSettings.
        :param weak_password_enabled: The weak_password_enabled of this GeneralSettings.
        """
        self.openapi_types = {
    ...
    def auth_token_restrictions(self):
        """Gets the auth_token_restrictions of this GeneralSettings.


        :return: The auth_token_restrictions of this GeneralSettings.
    ...
    def auth_token_restrictions(self, auth_token_restrictions):
        """Sets the auth_token_restrictions of this GeneralSettings.
    ...
    def crypto_enabled(self):
        """Gets the crypto_enabled of this GeneralSettings.

        Activation status of client-side encryption.  Can only be enabled once; disabling is not possible.

        :return: The crypto_enabled of this GeneralSettings.
        :rtype: bool
        """
    ...
    def crypto_enabled(self, crypto_enabled):
        """Sets the crypto_enabled of this GeneralSettings.
    ...
    def email_notification_button_enabled(self):
        """Gets the email_notification_button_enabled of this GeneralSettings.

        Enable email notification button

        :return: The email_notification_button_enabled of this GeneralSettings.
        :rtype: bool
        """
    ...
    def email_notification_button_enabled(self, email_notification_button_enabled):
        """Sets the email_notification_button_enabled of this GeneralSettings.
    ...
    def eula_enabled(self):
        """Gets the eula_enabled of this GeneralSettings.

        Each user has to confirm the EULA at first login.

        :return: The eula_enabled of this GeneralSettings.
        :rtype: bool
        """
    ...
    def eula_enabled(self, eula_enabled):
        """Sets the eula_enabled of this GeneralSettings.
    ...
    def hide_login_input_fields(self):
        """Gets the hide_login_input_fields of this GeneralSettings.

        &#128679; Deprecated since v4.42.0  Defines if login fields should be hidden

        :return: The hide_login_input_fields of this GeneralSettings.
        :rtype: bool
        """
    ...
    def hide_login_input_fields(self, hide_login_input_fields):
        """Sets the hide_login_input_fields of this GeneralSettings.
    ...
    def media_server_enabled(self):
        """Gets the media_server_enabled of this GeneralSettings.

        &#128679; Deprecated since v4.12.0  Determines if the media server is enabled

        :return: The media_server_enabled of this GeneralSettings.
        :rtype: bool
        """
    ...
    def media_server_enabled(self, media_server_enabled):
        """Sets the media_server_enabled of this GeneralSettings.
    ...
    def s3_tags_enabled(self):
        """Gets the s3_tags_enabled of this GeneralSettings.

        &#128640; Since v4.9.0  Defines if S3 tags are enabled

        :return: The s3_tags_enabled of this GeneralSettings.
        :rtype: bool
        """
    ...
    def s3_tags_enabled(self, s3_tags_enabled):
        """Sets the s3_tags_enabled of this GeneralSettings.
    ...
    def share_password_sms_enabled(self):
        """Gets the share_password_sms_enabled of this GeneralSettings.

        Allow sending of share passwords via SMS

        :return: The share_password_sms_enabled of this GeneralSettings.
        :rtype: bool
        """
    ...
    def share_password_sms_enabled(self, share_password_sms_enabled):
        """Sets the share_password_sms_enabled of this GeneralSettings.
    ...
    def use_s3_storage(self):
        """Gets the use_s3_storage of this GeneralSettings.

        Defines if S3 is used as storage backend

        :return: The use_s3_storage of this GeneralSettings.
        :rtype: bool
        """
    ...
    def use_s3_storage(self, use_s3_storage):
        """Sets the use_s3_storage of this GeneralSettings.
    ...
    def weak_password_enabled(self):
        """Gets the weak_password_enabled of this GeneralSettings.
        ...
        :return: The weak_password_enabled of this GeneralSettings.
        :rtype: bool
        """
    ...
    def weak_password_enabled(self, weak_password_enabled):
        """Sets the weak_password_enabled of this GeneralSettings.
