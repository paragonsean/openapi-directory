...
public class EncryptionPasswordPolicies {
  ...
  public EncryptionPasswordPolicies() {
  }
  ...
  public EncryptionPasswordPolicies updatedAt(OffsetDateTime updatedAt) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(characterRules, minLength, rejectKeyboardPatterns, rejectUserInfo, updatedAt, updatedBy);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EncryptionPasswordPolicies
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EncryptionPasswordPolicies.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EncryptionPasswordPolicies is not found in the empty JSON string", EncryptionPasswordPolicies.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EncryptionPasswordPolicies.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EncryptionPasswordPolicies` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EncryptionPasswordPolicies.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EncryptionPasswordPolicies' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EncryptionPasswordPolicies> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EncryptionPasswordPolicies.class));

       return (TypeAdapter<T>) new TypeAdapter<EncryptionPasswordPolicies>() {
           @Override
           public void write(JsonWriter out, EncryptionPasswordPolicies value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EncryptionPasswordPolicies read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EncryptionPasswordPolicies given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EncryptionPasswordPolicies
   * @throws IOException if the JSON string is invalid with respect to EncryptionPasswordPolicies
   */
  public static EncryptionPasswordPolicies fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EncryptionPasswordPolicies.class);
  }

  /**
   * Convert an instance of EncryptionPasswordPolicies to an JSON string
   *
   * @return JSON string
   */
