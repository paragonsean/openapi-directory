...
public class UpdateOAuthClientRequest {
  ...
  public UpdateOAuthClientRequest grantTypes(GrantTypesEnum grantTypes) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessTokenValidity, updateOAuthClientRequest.accessTokenValidity) &&
        ...
        Objects.equals(this.clientSecret, updateOAuthClientRequest.clientSecret) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessTokenValidity, approvalValidity, clientName, clientSecret, clientType, grantTypes, isEnabled, redirectUris, refreshTokenValidity);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateOAuthClientRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateOAuthClientRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateOAuthClientRequest is not found in the empty JSON string", UpdateOAuthClientRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateOAuthClientRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateOAuthClientRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateOAuthClientRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateOAuthClientRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateOAuthClientRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateOAuthClientRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateOAuthClientRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateOAuthClientRequest>() {
           @Override
           public void write(JsonWriter out, UpdateOAuthClientRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateOAuthClientRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateOAuthClientRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateOAuthClientRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateOAuthClientRequest
   */
  public static UpdateOAuthClientRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateOAuthClientRequest.class);
  }

  /**
   * Convert an instance of UpdateOAuthClientRequest to an JSON string
   *
   * @return JSON string
   */
