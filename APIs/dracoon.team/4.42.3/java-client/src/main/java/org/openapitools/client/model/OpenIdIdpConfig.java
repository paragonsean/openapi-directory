...
public class OpenIdIdpConfig {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorizationEndPointUrl, openIdIdpConfig.authorizationEndPointUrl) &&
        ...
        Objects.equals(this.id, openIdIdpConfig.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorizationEndPointUrl, clientId, clientSecret, fallbackMappingClaim, flow, id, issuer, jwksEndPointUrl, mappingClaim, name, pkceChallengeMethod, pkceEnabled, redirectUris, scopes, tokenEndPointUrl, userImportEnabled, userImportGroup, userInfoEndPointUrl, userInfoSource, userManagementUrl, userUpdateEnabled);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OpenIdIdpConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpenIdIdpConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpenIdIdpConfig is not found in the empty JSON string", OpenIdIdpConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OpenIdIdpConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OpenIdIdpConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OpenIdIdpConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpenIdIdpConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpenIdIdpConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpenIdIdpConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpenIdIdpConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<OpenIdIdpConfig>() {
           @Override
           public void write(JsonWriter out, OpenIdIdpConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OpenIdIdpConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OpenIdIdpConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OpenIdIdpConfig
   * @throws IOException if the JSON string is invalid with respect to OpenIdIdpConfig
   */
  public static OpenIdIdpConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpenIdIdpConfig.class);
  }

  /**
   * Convert an instance of OpenIdIdpConfig to an JSON string
   *
   * @return JSON string
   */
