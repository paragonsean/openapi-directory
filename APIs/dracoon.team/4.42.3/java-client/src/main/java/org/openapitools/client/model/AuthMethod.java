...
public class AuthMethod {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isEnabled, authMethod.isEnabled) &&
        Objects.equals(this.name, authMethod.name) &&
        Objects.equals(this.priority, authMethod.priority);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isEnabled, name, priority);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : AuthMethod.openapiRequiredFields) {
