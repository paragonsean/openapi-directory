...
public class NewCustomerRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activationCode, newCustomerRequest.activationCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activationCode, companyName, customerAttributes, customerContractType, firstAdminUser, isLocked, lockStatus, providerCustomerId, quotaMax, trialDays, userMax, webhooksMax);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewCustomerRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewCustomerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewCustomerRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewCustomerRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
