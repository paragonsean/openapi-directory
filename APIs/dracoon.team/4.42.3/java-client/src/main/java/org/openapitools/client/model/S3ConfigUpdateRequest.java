...
public class S3ConfigUpdateRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessKey, s3ConfigUpdateRequest.accessKey) &&
        Objects.equals(this.bucketName, s3ConfigUpdateRequest.bucketName) &&
        Objects.equals(this.bucketUrl, s3ConfigUpdateRequest.bucketUrl) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3ConfigUpdateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3ConfigUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3ConfigUpdateRequest is not found in the empty JSON string", S3ConfigUpdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3ConfigUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3ConfigUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3ConfigUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3ConfigUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3ConfigUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3ConfigUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<S3ConfigUpdateRequest>() {
           @Override
           public void write(JsonWriter out, S3ConfigUpdateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3ConfigUpdateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3ConfigUpdateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3ConfigUpdateRequest
   * @throws IOException if the JSON string is invalid with respect to S3ConfigUpdateRequest
   */
  public static S3ConfigUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3ConfigUpdateRequest.class);
  }

  /**
   * Convert an instance of S3ConfigUpdateRequest to an JSON string
   *
   * @return JSON string
   */
