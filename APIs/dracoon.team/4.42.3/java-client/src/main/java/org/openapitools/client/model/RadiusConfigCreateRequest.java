...
public class RadiusConfigCreateRequest {
  ...
  public RadiusConfigCreateRequest() {
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.failoverServer, radiusConfigCreateRequest.failoverServer) &&
        Objects.equals(this.ipAddress, radiusConfigCreateRequest.ipAddress) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to RadiusConfigCreateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RadiusConfigCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RadiusConfigCreateRequest is not found in the empty JSON string", RadiusConfigCreateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RadiusConfigCreateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RadiusConfigCreateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RadiusConfigCreateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RadiusConfigCreateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RadiusConfigCreateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RadiusConfigCreateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RadiusConfigCreateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RadiusConfigCreateRequest>() {
           @Override
           public void write(JsonWriter out, RadiusConfigCreateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RadiusConfigCreateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RadiusConfigCreateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RadiusConfigCreateRequest
   * @throws IOException if the JSON string is invalid with respect to RadiusConfigCreateRequest
   */
  public static RadiusConfigCreateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RadiusConfigCreateRequest.class);
  }

  /**
   * Convert an instance of RadiusConfigCreateRequest to an JSON string
   *
   * @return JSON string
   */
