...
|**numResults** | **Integer** | Number of probabilities to return. |  [optional] |
|**sampleBase64Content** | **String** | The image contained in a base64 string. |  [optional] |
...
|**sampleLocation** | **String** | URL of the image file. |  [optional] |
