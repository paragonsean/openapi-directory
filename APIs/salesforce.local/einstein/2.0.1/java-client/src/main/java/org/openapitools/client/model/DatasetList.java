...
public class DatasetList {
  ...
  public DatasetList data(List<Dataset> data) {
    this.data = data;
    return this;
  }

  public DatasetList addDataItem(Dataset dataItem) {
    if (this.data == null) {
  ...
  public DatasetList _object(String _object) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, datasetList.data) &&
        Objects.equals(this._object, datasetList._object);
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Dataset.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
