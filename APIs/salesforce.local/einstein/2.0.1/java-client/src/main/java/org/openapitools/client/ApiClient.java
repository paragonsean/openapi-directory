...
public class ApiClient {
    ...
    private String basePath = "http://salesforce.local";
    ...
    public ApiClient() {
        ...
        authentications.put("bearer_token", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://salesforce.local
