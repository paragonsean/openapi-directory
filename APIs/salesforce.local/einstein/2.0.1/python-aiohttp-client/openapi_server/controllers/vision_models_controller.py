...
async def delete_model1(request: web.Request, model_id) -> web.Response:
    """Delete a Model
...
async def get_trained_model_learning_curve1(request: web.Request, model_id, offset=None, count=None) -> web.Response:
...
async def get_trained_model_metrics1(request: web.Request, model_id) -> web.Response:
    """Get Model Metrics
...
async def get_trained_models1(request: web.Request, dataset_id, offset=None, count=None) -> web.Response:
    """Get All Models
