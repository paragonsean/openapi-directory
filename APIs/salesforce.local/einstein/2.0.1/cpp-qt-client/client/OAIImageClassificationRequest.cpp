...
OAIImageClassificationRequest::OAIImageClassificationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImageClassificationRequest::OAIImageClassificationRequest() {
    this->initializeModel();
}

OAIImageClassificationRequest::~OAIImageClassificationRequest() {}

void OAIImageClassificationRequest::initializeModel() {
...
void OAIImageClassificationRequest::fromJson(QString jsonString) {
...
void OAIImageClassificationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIImageClassificationRequest::asJson() const {
...
QJsonObject OAIImageClassificationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_model_id_isSet) {
...
QString OAIImageClassificationRequest::getModelId() const {
    return m_model_id;
}
void OAIImageClassificationRequest::setModelId(const QString &model_id) {
    m_model_id = model_id;
    m_model_id_isSet = true;
}

bool OAIImageClassificationRequest::is_model_id_Set() const{
    return m_model_id_isSet;
}

bool OAIImageClassificationRequest::is_model_id_Valid() const{
    return m_model_id_isValid;
}

qint32 OAIImageClassificationRequest::getNumResults() const {
    return m_num_results;
}
void OAIImageClassificationRequest::setNumResults(const qint32 &num_results) {
    m_num_results = num_results;
    m_num_results_isSet = true;
}

bool OAIImageClassificationRequest::is_num_results_Set() const{
    return m_num_results_isSet;
}

bool OAIImageClassificationRequest::is_num_results_Valid() const{
    return m_num_results_isValid;
}

QString OAIImageClassificationRequest::getSampleBase64Content() const {
    return m_sample_base64_content;
}
void OAIImageClassificationRequest::setSampleBase64Content(const QString &sample_base64_content) {
    m_sample_base64_content = sample_base64_content;
    m_sample_base64_content_isSet = true;
}

bool OAIImageClassificationRequest::is_sample_base64_content_Set() const{
    return m_sample_base64_content_isSet;
}

bool OAIImageClassificationRequest::is_sample_base64_content_Valid() const{
    return m_sample_base64_content_isValid;
}

QString OAIImageClassificationRequest::getSampleId() const {
    return m_sample_id;
}
void OAIImageClassificationRequest::setSampleId(const QString &sample_id) {
    m_sample_id = sample_id;
    m_sample_id_isSet = true;
}

bool OAIImageClassificationRequest::is_sample_id_Set() const{
    return m_sample_id_isSet;
}

bool OAIImageClassificationRequest::is_sample_id_Valid() const{
    return m_sample_id_isValid;
}

QString OAIImageClassificationRequest::getSampleLocation() const {
    return m_sample_location;
}
void OAIImageClassificationRequest::setSampleLocation(const QString &sample_location) {
    m_sample_location = sample_location;
    m_sample_location_isSet = true;
}

bool OAIImageClassificationRequest::is_sample_location_Set() const{
    return m_sample_location_isSet;
}

bool OAIImageClassificationRequest::is_sample_location_Valid() const{
    return m_sample_location_isValid;
}

bool OAIImageClassificationRequest::isSet() const {
...
bool OAIImageClassificationRequest::isValid() const {
