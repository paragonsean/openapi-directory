...
/*
 * OAIImageClassificationRequest.h
 *
 * 
 */

#ifndef OAIImageClassificationRequest_H
#define OAIImageClassificationRequest_H
...
class OAIImageClassificationRequest : public OAIObject {
public:
    OAIImageClassificationRequest();
    OAIImageClassificationRequest(QString json);
    ~OAIImageClassificationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageClassificationRequest)

#endif // OAIImageClassificationRequest_H
