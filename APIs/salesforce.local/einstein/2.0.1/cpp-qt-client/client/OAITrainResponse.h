...
#ifndef OAITrainResponse_H
#define OAITrainResponse_H
...
class OAITrainResponse : public OAIObject {
public:
    OAITrainResponse();
    OAITrainResponse(QString json);
    ~OAITrainResponse() override;
    ...
    qint32 getEpochs() const;
    void setEpochs(const qint32 &epochs);
    bool is_epochs_Set() const;
    bool is_epochs_Valid() const;
    ...
    bool is_learning_rate_Set() const;
    bool is_learning_rate_Valid() const;
    ...
    QString getTrainParams() const;
    void setTrainParams(const QString &train_params);
    bool is_train_params_Set() const;
    bool is_train_params_Valid() const;

    QString getTrainStats() const;
    void setTrainStats(const QString &train_stats);
    bool is_train_stats_Set() const;
    bool is_train_stats_Valid() const;
...
private:
    ...
    bool m_learning_rate_isSet;
    bool m_learning_rate_isValid;
    ...
    QString m_train_params;
    bool m_train_params_isSet;
    bool m_train_params_isValid;

    QString m_train_stats;
    bool m_train_stats_isSet;
    bool m_train_stats_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainResponse)

#endif // OAITrainResponse_H
