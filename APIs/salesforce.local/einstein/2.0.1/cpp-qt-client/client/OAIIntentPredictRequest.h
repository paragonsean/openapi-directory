...
/*
 * OAIIntentPredictRequest.h
 *
 * 
 */

#ifndef OAIIntentPredictRequest_H
#define OAIIntentPredictRequest_H
...
class OAIIntentPredictRequest : public OAIObject {
public:
    OAIIntentPredictRequest();
    OAIIntentPredictRequest(QString json);
    ~OAIIntentPredictRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntentPredictRequest)

#endif // OAIIntentPredictRequest_H
