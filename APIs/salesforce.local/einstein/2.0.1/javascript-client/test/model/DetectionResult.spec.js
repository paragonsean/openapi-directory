...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EinsteinVisionAndEinsteinLanguage.DetectionResult();
  });
  ...
  describe('DetectionResult', function() {
    it('should create an instance of DetectionResult', function() {
      // uncomment below and update the code to test DetectionResult
      //var instance = new EinsteinVisionAndEinsteinLanguage.DetectionResult();
      //expect(instance).to.be.a(EinsteinVisionAndEinsteinLanguage.DetectionResult);
    });
