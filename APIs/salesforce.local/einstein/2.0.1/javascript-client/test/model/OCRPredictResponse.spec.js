...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EinsteinVisionAndEinsteinLanguage.OCRPredictResponse();
  });
  ...
  describe('OCRPredictResponse', function() {
    it('should create an instance of OCRPredictResponse', function() {
      // uncomment below and update the code to test OCRPredictResponse
      //var instance = new EinsteinVisionAndEinsteinLanguage.OCRPredictResponse();
      //expect(instance).to.be.a(EinsteinVisionAndEinsteinLanguage.OCRPredictResponse);
    });
