...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EinsteinVisionAndEinsteinLanguage.Label();
  });
  ...
  describe('Label', function() {
    it('should create an instance of Label', function() {
      ...
      //var instance = new EinsteinVisionAndEinsteinLanguage.Label();
      //expect(instance).to.be.a(EinsteinVisionAndEinsteinLanguage.Label);
    });
    ...
    it('should have the property numExamples (base name: "numExamples")', function() {
      // uncomment below and update the code to test the property numExamples
      //var instance = new EinsteinVisionAndEinsteinLanguage.Label();
      //expect(instance).to.be();
    });
