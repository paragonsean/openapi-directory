...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EinsteinVisionAndEinsteinLanguage.EntityObject();
  });
  ...
  describe('EntityObject', function() {
    it('should create an instance of EntityObject', function() {
      // uncomment below and update the code to test EntityObject
      //var instance = new EinsteinVisionAndEinsteinLanguage.EntityObject();
      //expect(instance).to.be.a(EinsteinVisionAndEinsteinLanguage.EntityObject);
    });
