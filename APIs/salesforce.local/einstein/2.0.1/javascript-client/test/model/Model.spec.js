...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EinsteinVisionAndEinsteinLanguage.Model();
  });
  ...
  describe('Model', function() {
    it('should create an instance of Model', function() {
      ...
      //var instance = new EinsteinVisionAndEinsteinLanguage.Model();
      //expect(instance).to.be.a(EinsteinVisionAndEinsteinLanguage.Model);
    });
