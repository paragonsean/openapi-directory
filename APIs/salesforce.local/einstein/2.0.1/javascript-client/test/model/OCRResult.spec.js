...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EinsteinVisionAndEinsteinLanguage.OCRResult();
  });
  ...
  describe('OCRResult', function() {
    it('should create an instance of OCRResult', function() {
      ...
      //var instance = new EinsteinVisionAndEinsteinLanguage.OCRResult();
      //expect(instance).to.be.a(EinsteinVisionAndEinsteinLanguage.OCRResult);
    });
