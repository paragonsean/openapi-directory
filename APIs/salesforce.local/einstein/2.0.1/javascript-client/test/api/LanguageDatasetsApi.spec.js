...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EinsteinVisionAndEinsteinLanguage.LanguageDatasetsApi();
  });
  ...
  describe('LanguageDatasetsApi', function() {
    ...
    describe('uploadDatasetAsync', function() {
      it('should call uploadDatasetAsync successfully', function(done) {
        //uncomment below and update the code to test uploadDatasetAsync
        //instance.uploadDatasetAsync(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('uploadDatasetSync', function() {
      it('should call uploadDatasetSync successfully', function(done) {
        //uncomment below and update the code to test uploadDatasetSync
        //instance.uploadDatasetSync(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
