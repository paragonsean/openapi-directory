...
class DetectionResult {
     ...
     * label
     * @alias module:model/DetectionResult
     */
    constructor() { 
        
        DetectionResult.initialize(this);
    }
     ...
     * @param {module:model/DetectionResult} obj Optional instance to populate.
     * @return {module:model/DetectionResult} The populated <code>DetectionResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectionResult();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectionResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectionResult</code>.
     */
 ...
 */
DetectionResult.prototype['boundingBox'] = undefined;

/**
 * Probability lable for the input. 
 * @member {String} label
 */
DetectionResult.prototype['label'] = undefined;

/**
 * Probability value for the input. Values are between 0�1.
 * @member {Number} probability
 */
DetectionResult.prototype['probability'] = undefined;
