...
/**
 * The ImageClassificationRequest model module.
 * @module model/ImageClassificationRequest
 * @version 2.0.1
 */
class ImageClassificationRequest {
    /**
     * Constructs a new <code>ImageClassificationRequest</code>.
     * @alias module:model/ImageClassificationRequest
     * @param modelId {String} ID of the model that makes the prediction.
     */
    constructor(modelId) { 
        
        ImageClassificationRequest.initialize(this, modelId);
    }
    ...
    /**
     * Constructs a <code>ImageClassificationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageClassificationRequest} obj Optional instance to populate.
     * @return {module:model/ImageClassificationRequest} The populated <code>ImageClassificationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageClassificationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ImageClassificationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageClassificationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImageClassificationRequest.RequiredProperties) {
...
ImageClassificationRequest.RequiredProperties = ["modelId"];

/**
 * ID of the model that makes the prediction.
 * @member {String} modelId
 */
ImageClassificationRequest.prototype['modelId'] = undefined;

/**
 * Number of probabilities to return.
 * @member {Number} numResults
 */
ImageClassificationRequest.prototype['numResults'] = undefined;

/**
 * The image contained in a base64 string.
 * @member {String} sampleBase64Content
 */
ImageClassificationRequest.prototype['sampleBase64Content'] = undefined;
 ...
 */
ImageClassificationRequest.prototype['sampleId'] = undefined;

/**
 * URL of the image file.
 * @member {String} sampleLocation
 */
ImageClassificationRequest.prototype['sampleLocation'] = undefined;
...
export default ImageClassificationRequest;
