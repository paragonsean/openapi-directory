...
/*
 * OAIGetSKUandContext.h
 *
 * 
 */

#ifndef OAIGetSKUandContext_H
#define OAIGetSKUandContext_H
...
class OAIGetSKUandContext : public OAIObject {
public:
    OAIGetSKUandContext();
    OAIGetSKUandContext(QString json);
    ~OAIGetSKUandContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSKUandContext)

#endif // OAIGetSKUandContext_H
