...
/*
 * OAI_api_catalog_pvt_stockkeepingunit__skuId__put_request.h
 *
 * 
 */

#ifndef OAI_api_catalog_pvt_stockkeepingunit__skuId__put_request_H
#define OAI_api_catalog_pvt_stockkeepingunit__skuId__put_request_H
...
class OAI_api_catalog_pvt_stockkeepingunit__skuId__put_request : public OAIObject {
public:
    OAI_api_catalog_pvt_stockkeepingunit__skuId__put_request();
    OAI_api_catalog_pvt_stockkeepingunit__skuId__put_request(QString json);
    ~OAI_api_catalog_pvt_stockkeepingunit__skuId__put_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_api_catalog_pvt_stockkeepingunit__skuId__put_request)

#endif // OAI_api_catalog_pvt_stockkeepingunit__skuId__put_request_H
