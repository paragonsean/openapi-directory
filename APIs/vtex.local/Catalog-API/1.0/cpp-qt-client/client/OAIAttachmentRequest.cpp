...
QList<OAIDomains_inner> OAIAttachmentRequest::getDomains() const {
    return m_domains;
}
void OAIAttachmentRequest::setDomains(const QList<OAIDomains_inner> &domains) {
    m_domains = domains;
    m_domains_isSet = true;
}

bool OAIAttachmentRequest::is_domains_Set() const{
    return m_domains_isSet;
}

bool OAIAttachmentRequest::is_domains_Valid() const{
    return m_domains_isValid;
}

bool OAIAttachmentRequest::isIsActive() const {
    return m_is_active;
}
void OAIAttachmentRequest::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAIAttachmentRequest::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIAttachmentRequest::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAIAttachmentRequest::isIsRequired() const {
    return m_is_required;
}
void OAIAttachmentRequest::setIsRequired(const bool &is_required) {
    m_is_required = is_required;
    m_is_required_isSet = true;
}

bool OAIAttachmentRequest::is_is_required_Set() const{
    return m_is_required_isSet;
}

bool OAIAttachmentRequest::is_is_required_Valid() const{
    return m_is_required_isValid;
}

QString OAIAttachmentRequest::getName() const {
    return m_name;
}
void OAIAttachmentRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAttachmentRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAttachmentRequest::is_name_Valid() const{
...
bool OAIAttachmentRequest::isValid() const {
    ...
    return m_domains_isValid && m_is_active_isValid && m_is_required_isValid && m_name_isValid && true;
}
