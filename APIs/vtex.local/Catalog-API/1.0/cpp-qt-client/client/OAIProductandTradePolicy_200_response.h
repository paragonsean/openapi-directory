...
/*
 * OAIProductandTradePolicy_200_response.h
 *
 * 
 */

#ifndef OAIProductandTradePolicy_200_response_H
#define OAIProductandTradePolicy_200_response_H
...
class OAIProductandTradePolicy_200_response : public OAIObject {
public:
    OAIProductandTradePolicy_200_response();
    OAIProductandTradePolicy_200_response(QString json);
    ~OAIProductandTradePolicy_200_response() override;
    ...
    QList<QJsonValue> getListStoreId() const;
    void setListStoreId(const QList<QJsonValue> &list_store_id);
    bool is_list_store_id_Set() const;
    bool is_list_store_id_Valid() const;
...
private:
    ...
    QList<QJsonValue> m_list_store_id;
    bool m_list_store_id_isSet;
    bool m_list_store_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductandTradePolicy_200_response)

#endif // OAIProductandTradePolicy_200_response_H
