...
#ifndef OAIAlternateIds_H
#define OAIAlternateIds_H
...
class OAIAlternateIds : public OAIObject {
public:
    OAIAlternateIds();
    OAIAlternateIds(QString json);
    ~OAIAlternateIds() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlternateIds)

#endif // OAIAlternateIds_H
