...
OAICreateSellerRequest::OAICreateSellerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSellerRequest::OAICreateSellerRequest() {
    this->initializeModel();
}

OAICreateSellerRequest::~OAICreateSellerRequest() {}

void OAICreateSellerRequest::initializeModel() {
...
void OAICreateSellerRequest::fromJson(QString jsonString) {
...
void OAICreateSellerRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateSellerRequest::asJson() const {
...
QJsonObject OAICreateSellerRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateSellerRequest::getArchiveId() const {
    return m_archive_id;
}
void OAICreateSellerRequest::setArchiveId(const qint32 &archive_id) {
    m_archive_id = archive_id;
    m_archive_id_isSet = true;
}

bool OAICreateSellerRequest::is_archive_id_Set() const{
    return m_archive_id_isSet;
}

bool OAICreateSellerRequest::is_archive_id_Valid() const{
    return m_archive_id_isValid;
}

QString OAICreateSellerRequest::getCnpj() const {
    return m_cnpj;
}
void OAICreateSellerRequest::setCnpj(const QString &cnpj) {
    m_cnpj = cnpj;
    m_cnpj_isSet = true;
}

bool OAICreateSellerRequest::is_cnpj_Set() const{
    return m_cnpj_isSet;
}

bool OAICreateSellerRequest::is_cnpj_Valid() const{
    return m_cnpj_isValid;
}

QString OAICreateSellerRequest::getCscIdentification() const {
    return m_csc_identification;
}
void OAICreateSellerRequest::setCscIdentification(const QString &csc_identification) {
    m_csc_identification = csc_identification;
    m_csc_identification_isSet = true;
}

bool OAICreateSellerRequest::is_csc_identification_Set() const{
    return m_csc_identification_isSet;
}

bool OAICreateSellerRequest::is_csc_identification_Valid() const{
    return m_csc_identification_isValid;
}

QString OAICreateSellerRequest::getCatalogSystemEndpoint() const {
    return m_catalog_system_endpoint;
}
void OAICreateSellerRequest::setCatalogSystemEndpoint(const QString &catalog_system_endpoint) {
    m_catalog_system_endpoint = catalog_system_endpoint;
    m_catalog_system_endpoint_isSet = true;
}

bool OAICreateSellerRequest::is_catalog_system_endpoint_Set() const{
    return m_catalog_system_endpoint_isSet;
}

bool OAICreateSellerRequest::is_catalog_system_endpoint_Valid() const{
    return m_catalog_system_endpoint_isValid;
}

QString OAICreateSellerRequest::getCategoryCommissionPercentage() const {
    return m_category_commission_percentage;
}
void OAICreateSellerRequest::setCategoryCommissionPercentage(const QString &category_commission_percentage) {
    m_category_commission_percentage = category_commission_percentage;
    m_category_commission_percentage_isSet = true;
}

bool OAICreateSellerRequest::is_category_commission_percentage_Set() const{
    return m_category_commission_percentage_isSet;
}

bool OAICreateSellerRequest::is_category_commission_percentage_Valid() const{
    return m_category_commission_percentage_isValid;
}

QString OAICreateSellerRequest::getDeliveryPolicy() const {
    return m_delivery_policy;
}
void OAICreateSellerRequest::setDeliveryPolicy(const QString &delivery_policy) {
    m_delivery_policy = delivery_policy;
    m_delivery_policy_isSet = true;
}

bool OAICreateSellerRequest::is_delivery_policy_Set() const{
    return m_delivery_policy_isSet;
}

bool OAICreateSellerRequest::is_delivery_policy_Valid() const{
    return m_delivery_policy_isValid;
}

QString OAICreateSellerRequest::getDescription() const {
    return m_description;
}
void OAICreateSellerRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateSellerRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateSellerRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateSellerRequest::getEmail() const {
    return m_email;
}
void OAICreateSellerRequest::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAICreateSellerRequest::is_email_Set() const{
    return m_email_isSet;
}

bool OAICreateSellerRequest::is_email_Valid() const{
    return m_email_isValid;
}

QString OAICreateSellerRequest::getExchangeReturnPolicy() const {
    return m_exchange_return_policy;
}
void OAICreateSellerRequest::setExchangeReturnPolicy(const QString &exchange_return_policy) {
    m_exchange_return_policy = exchange_return_policy;
    m_exchange_return_policy_isSet = true;
}

bool OAICreateSellerRequest::is_exchange_return_policy_Set() const{
    return m_exchange_return_policy_isSet;
}

bool OAICreateSellerRequest::is_exchange_return_policy_Valid() const{
    return m_exchange_return_policy_isValid;
}

double OAICreateSellerRequest::getFreightCommissionPercentage() const {
    return m_freight_commission_percentage;
}
void OAICreateSellerRequest::setFreightCommissionPercentage(const double &freight_commission_percentage) {
    m_freight_commission_percentage = freight_commission_percentage;
    m_freight_commission_percentage_isSet = true;
}

bool OAICreateSellerRequest::is_freight_commission_percentage_Set() const{
    return m_freight_commission_percentage_isSet;
}

bool OAICreateSellerRequest::is_freight_commission_percentage_Valid() const{
    return m_freight_commission_percentage_isValid;
}

QString OAICreateSellerRequest::getFulfillmentEndpoint() const {
    return m_fulfillment_endpoint;
}
void OAICreateSellerRequest::setFulfillmentEndpoint(const QString &fulfillment_endpoint) {
    m_fulfillment_endpoint = fulfillment_endpoint;
    m_fulfillment_endpoint_isSet = true;
}

bool OAICreateSellerRequest::is_fulfillment_endpoint_Set() const{
    return m_fulfillment_endpoint_isSet;
}

bool OAICreateSellerRequest::is_fulfillment_endpoint_Valid() const{
    return m_fulfillment_endpoint_isValid;
}

qint32 OAICreateSellerRequest::getFulfillmentSellerId() const {
    return m_fulfillment_seller_id;
}
void OAICreateSellerRequest::setFulfillmentSellerId(const qint32 &fulfillment_seller_id) {
    m_fulfillment_seller_id = fulfillment_seller_id;
    m_fulfillment_seller_id_isSet = true;
}

bool OAICreateSellerRequest::is_fulfillment_seller_id_Set() const{
    return m_fulfillment_seller_id_isSet;
}

bool OAICreateSellerRequest::is_fulfillment_seller_id_Valid() const{
    return m_fulfillment_seller_id_isValid;
}

bool OAICreateSellerRequest::isIsActive() const {
    return m_is_active;
}
void OAICreateSellerRequest::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAICreateSellerRequest::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAICreateSellerRequest::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAICreateSellerRequest::isIsBetterScope() const {
    return m_is_better_scope;
}
void OAICreateSellerRequest::setIsBetterScope(const bool &is_better_scope) {
    m_is_better_scope = is_better_scope;
    m_is_better_scope_isSet = true;
}

bool OAICreateSellerRequest::is_is_better_scope_Set() const{
    return m_is_better_scope_isSet;
}

bool OAICreateSellerRequest::is_is_better_scope_Valid() const{
    return m_is_better_scope_isValid;
}

QString OAICreateSellerRequest::getMerchantName() const {
    return m_merchant_name;
}
void OAICreateSellerRequest::setMerchantName(const QString &merchant_name) {
    m_merchant_name = merchant_name;
    m_merchant_name_isSet = true;
}

bool OAICreateSellerRequest::is_merchant_name_Set() const{
    return m_merchant_name_isSet;
}

bool OAICreateSellerRequest::is_merchant_name_Valid() const{
    return m_merchant_name_isValid;
}

QString OAICreateSellerRequest::getName() const {
    return m_name;
}
void OAICreateSellerRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateSellerRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateSellerRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateSellerRequest::getPassword() const {
    return m_password;
}
void OAICreateSellerRequest::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAICreateSellerRequest::is_password_Set() const{
    return m_password_isSet;
}

bool OAICreateSellerRequest::is_password_Valid() const{
    return m_password_isValid;
}

double OAICreateSellerRequest::getProductCommissionPercentage() const {
    return m_product_commission_percentage;
}
void OAICreateSellerRequest::setProductCommissionPercentage(const double &product_commission_percentage) {
    m_product_commission_percentage = product_commission_percentage;
    m_product_commission_percentage_isSet = true;
}

bool OAICreateSellerRequest::is_product_commission_percentage_Set() const{
    return m_product_commission_percentage_isSet;
}

bool OAICreateSellerRequest::is_product_commission_percentage_Valid() const{
    return m_product_commission_percentage_isValid;
}

QString OAICreateSellerRequest::getSecutityPrivacyPolicy() const {
    return m_secutity_privacy_policy;
}
void OAICreateSellerRequest::setSecutityPrivacyPolicy(const QString &secutity_privacy_policy) {
    m_secutity_privacy_policy = secutity_privacy_policy;
    m_secutity_privacy_policy_isSet = true;
}

bool OAICreateSellerRequest::is_secutity_privacy_policy_Set() const{
    return m_secutity_privacy_policy_isSet;
}

bool OAICreateSellerRequest::is_secutity_privacy_policy_Valid() const{
    return m_secutity_privacy_policy_isValid;
}

QString OAICreateSellerRequest::getSellerId() const {
    return m_seller_id;
}
void OAICreateSellerRequest::setSellerId(const QString &seller_id) {
    m_seller_id = seller_id;
    m_seller_id_isSet = true;
}

bool OAICreateSellerRequest::is_seller_id_Set() const{
    return m_seller_id_isSet;
}

bool OAICreateSellerRequest::is_seller_id_Valid() const{
    return m_seller_id_isValid;
}

qint32 OAICreateSellerRequest::getSellerType() const {
    return m_seller_type;
}
void OAICreateSellerRequest::setSellerType(const qint32 &seller_type) {
    m_seller_type = seller_type;
    m_seller_type_isSet = true;
}

bool OAICreateSellerRequest::is_seller_type_Set() const{
    return m_seller_type_isSet;
}

bool OAICreateSellerRequest::is_seller_type_Valid() const{
    return m_seller_type_isValid;
}

QString OAICreateSellerRequest::getTrustPolicy() const {
    return m_trust_policy;
}
void OAICreateSellerRequest::setTrustPolicy(const QString &trust_policy) {
    m_trust_policy = trust_policy;
    m_trust_policy_isSet = true;
}

bool OAICreateSellerRequest::is_trust_policy_Set() const{
    return m_trust_policy_isSet;
}

bool OAICreateSellerRequest::is_trust_policy_Valid() const{
    return m_trust_policy_isValid;
}

QString OAICreateSellerRequest::getUrlLogo() const {
    return m_url_logo;
}
void OAICreateSellerRequest::setUrlLogo(const QString &url_logo) {
    m_url_logo = url_logo;
    m_url_logo_isSet = true;
}

bool OAICreateSellerRequest::is_url_logo_Set() const{
    return m_url_logo_isSet;
}

bool OAICreateSellerRequest::is_url_logo_Valid() const{
    return m_url_logo_isValid;
}

bool OAICreateSellerRequest::isUseHybridPaymentOptions() const {
    return m_use_hybrid_payment_options;
}
void OAICreateSellerRequest::setUseHybridPaymentOptions(const bool &use_hybrid_payment_options) {
    m_use_hybrid_payment_options = use_hybrid_payment_options;
    m_use_hybrid_payment_options_isSet = true;
}

bool OAICreateSellerRequest::is_use_hybrid_payment_options_Set() const{
    return m_use_hybrid_payment_options_isSet;
}

bool OAICreateSellerRequest::is_use_hybrid_payment_options_Valid() const{
    return m_use_hybrid_payment_options_isValid;
}

QString OAICreateSellerRequest::getUserName() const {
    return m_user_name;
}
void OAICreateSellerRequest::setUserName(const QString &user_name) {
    m_user_name = user_name;
    m_user_name_isSet = true;
}

bool OAICreateSellerRequest::is_user_name_Set() const{
    return m_user_name_isSet;
}

bool OAICreateSellerRequest::is_user_name_Valid() const{
    return m_user_name_isValid;
}

bool OAICreateSellerRequest::isSet() const {
...
bool OAICreateSellerRequest::isValid() const {
