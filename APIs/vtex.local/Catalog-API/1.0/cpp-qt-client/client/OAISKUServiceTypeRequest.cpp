...
#include "OAISKUServiceTypeRequest.h"
...
OAISKUServiceTypeRequest::OAISKUServiceTypeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISKUServiceTypeRequest::OAISKUServiceTypeRequest() {
    this->initializeModel();
}

OAISKUServiceTypeRequest::~OAISKUServiceTypeRequest() {}

void OAISKUServiceTypeRequest::initializeModel() {
...
void OAISKUServiceTypeRequest::fromJson(QString jsonString) {
...
void OAISKUServiceTypeRequest::fromJsonObject(QJsonObject json) {
...
QString OAISKUServiceTypeRequest::asJson() const {
...
QJsonObject OAISKUServiceTypeRequest::asJsonObject() const {
    QJsonObject obj;
...
bool OAISKUServiceTypeRequest::isIsActive() const {
    return m_is_active;
}
void OAISKUServiceTypeRequest::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAISKUServiceTypeRequest::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAISKUServiceTypeRequest::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAISKUServiceTypeRequest::isIsGiftCard() const {
    return m_is_gift_card;
}
void OAISKUServiceTypeRequest::setIsGiftCard(const bool &is_gift_card) {
    m_is_gift_card = is_gift_card;
    m_is_gift_card_isSet = true;
}

bool OAISKUServiceTypeRequest::is_is_gift_card_Set() const{
    return m_is_gift_card_isSet;
}

bool OAISKUServiceTypeRequest::is_is_gift_card_Valid() const{
    return m_is_gift_card_isValid;
}

bool OAISKUServiceTypeRequest::isIsRequired() const {
    return m_is_required;
}
void OAISKUServiceTypeRequest::setIsRequired(const bool &is_required) {
    m_is_required = is_required;
    m_is_required_isSet = true;
}

bool OAISKUServiceTypeRequest::is_is_required_Set() const{
    return m_is_required_isSet;
}

bool OAISKUServiceTypeRequest::is_is_required_Valid() const{
    return m_is_required_isValid;
}

QString OAISKUServiceTypeRequest::getName() const {
    return m_name;
}
void OAISKUServiceTypeRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISKUServiceTypeRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAISKUServiceTypeRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAISKUServiceTypeRequest::isShowOnAttachmentFront() const {
    return m_show_on_attachment_front;
}
void OAISKUServiceTypeRequest::setShowOnAttachmentFront(const bool &show_on_attachment_front) {
    m_show_on_attachment_front = show_on_attachment_front;
    m_show_on_attachment_front_isSet = true;
}

bool OAISKUServiceTypeRequest::is_show_on_attachment_front_Set() const{
    return m_show_on_attachment_front_isSet;
}

bool OAISKUServiceTypeRequest::is_show_on_attachment_front_Valid() const{
    return m_show_on_attachment_front_isValid;
}

bool OAISKUServiceTypeRequest::isShowOnCartFront() const {
    return m_show_on_cart_front;
}
void OAISKUServiceTypeRequest::setShowOnCartFront(const bool &show_on_cart_front) {
    m_show_on_cart_front = show_on_cart_front;
    m_show_on_cart_front_isSet = true;
}

bool OAISKUServiceTypeRequest::is_show_on_cart_front_Set() const{
    return m_show_on_cart_front_isSet;
}

bool OAISKUServiceTypeRequest::is_show_on_cart_front_Valid() const{
    return m_show_on_cart_front_isValid;
}

bool OAISKUServiceTypeRequest::isShowOnFileUpload() const {
    return m_show_on_file_upload;
}
void OAISKUServiceTypeRequest::setShowOnFileUpload(const bool &show_on_file_upload) {
    m_show_on_file_upload = show_on_file_upload;
    m_show_on_file_upload_isSet = true;
}

bool OAISKUServiceTypeRequest::is_show_on_file_upload_Set() const{
    return m_show_on_file_upload_isSet;
}

bool OAISKUServiceTypeRequest::is_show_on_file_upload_Valid() const{
    return m_show_on_file_upload_isValid;
}

bool OAISKUServiceTypeRequest::isShowOnProductFront() const {
    return m_show_on_product_front;
}
void OAISKUServiceTypeRequest::setShowOnProductFront(const bool &show_on_product_front) {
    m_show_on_product_front = show_on_product_front;
    m_show_on_product_front_isSet = true;
}

bool OAISKUServiceTypeRequest::is_show_on_product_front_Set() const{
    return m_show_on_product_front_isSet;
}

bool OAISKUServiceTypeRequest::is_show_on_product_front_Valid() const{
    return m_show_on_product_front_isValid;
}

bool OAISKUServiceTypeRequest::isSet() const {
...
bool OAISKUServiceTypeRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_is_active_isValid && m_is_gift_card_isValid && m_is_required_isValid && m_name_isValid && m_show_on_attachment_front_isValid && m_show_on_cart_front_isValid && m_show_on_file_upload_isValid && m_show_on_product_front_isValid && true;
}
