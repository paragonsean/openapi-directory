...
/*
 * OAIGetCategoryTree.h
 *
 * 
 */

#ifndef OAIGetCategoryTree_H
#define OAIGetCategoryTree_H
...
namespace OpenAPI {
class OAIGetCategoryTreeChild;

class OAIGetCategoryTree : public OAIObject {
public:
    OAIGetCategoryTree();
    OAIGetCategoryTree(QString json);
    ~OAIGetCategoryTree() override;
    ...
    QList<OAIGetCategoryTreeChild> getChildren() const;
    void setChildren(const QList<OAIGetCategoryTreeChild> &children);
...
private:
    ...
    QList<OAIGetCategoryTreeChild> m_children;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCategoryTree)

#endif // OAIGetCategoryTree_H
