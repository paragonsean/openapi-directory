...
#include "OAISpecificationsInsertFieldRequest.h"
...
OAISpecificationsInsertFieldRequest::OAISpecificationsInsertFieldRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISpecificationsInsertFieldRequest::OAISpecificationsInsertFieldRequest() {
    this->initializeModel();
}

OAISpecificationsInsertFieldRequest::~OAISpecificationsInsertFieldRequest() {}

void OAISpecificationsInsertFieldRequest::initializeModel() {
...
void OAISpecificationsInsertFieldRequest::fromJson(QString jsonString) {
...
void OAISpecificationsInsertFieldRequest::fromJsonObject(QJsonObject json) {
...
QString OAISpecificationsInsertFieldRequest::asJson() const {
...
QJsonObject OAISpecificationsInsertFieldRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAISpecificationsInsertFieldRequest::getCategoryId() const {
    return m_category_id;
}
void OAISpecificationsInsertFieldRequest::setCategoryId(const qint32 &category_id) {
    m_category_id = category_id;
    m_category_id_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_category_id_Set() const{
    return m_category_id_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_category_id_Valid() const{
    return m_category_id_isValid;
}

QString OAISpecificationsInsertFieldRequest::getDefaultValue() const {
    return m_default_value;
}
void OAISpecificationsInsertFieldRequest::setDefaultValue(const QString &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAISpecificationsInsertFieldRequest::getDescription() const {
    return m_description;
}
void OAISpecificationsInsertFieldRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAISpecificationsInsertFieldRequest::getFieldGroupId() const {
    return m_field_group_id;
}
void OAISpecificationsInsertFieldRequest::setFieldGroupId(const qint32 &field_group_id) {
    m_field_group_id = field_group_id;
    m_field_group_id_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_field_group_id_Set() const{
    return m_field_group_id_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_field_group_id_Valid() const{
    return m_field_group_id_isValid;
}

QString OAISpecificationsInsertFieldRequest::getFieldGroupName() const {
    return m_field_group_name;
}
void OAISpecificationsInsertFieldRequest::setFieldGroupName(const QString &field_group_name) {
    m_field_group_name = field_group_name;
    m_field_group_name_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_field_group_name_Set() const{
    return m_field_group_name_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_field_group_name_Valid() const{
    return m_field_group_name_isValid;
}

qint32 OAISpecificationsInsertFieldRequest::getFieldId() const {
    return m_field_id;
}
void OAISpecificationsInsertFieldRequest::setFieldId(const qint32 &field_id) {
    m_field_id = field_id;
    m_field_id_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_field_id_Set() const{
    return m_field_id_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_field_id_Valid() const{
    return m_field_id_isValid;
}

qint32 OAISpecificationsInsertFieldRequest::getFieldTypeId() const {
    return m_field_type_id;
}
void OAISpecificationsInsertFieldRequest::setFieldTypeId(const qint32 &field_type_id) {
    m_field_type_id = field_type_id;
    m_field_type_id_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_field_type_id_Set() const{
    return m_field_type_id_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_field_type_id_Valid() const{
    return m_field_type_id_isValid;
}

qint32 OAISpecificationsInsertFieldRequest::getFieldValueId() const {
    return m_field_value_id;
}
void OAISpecificationsInsertFieldRequest::setFieldValueId(const qint32 &field_value_id) {
    m_field_value_id = field_value_id;
    m_field_value_id_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_field_value_id_Set() const{
    return m_field_value_id_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_field_value_id_Valid() const{
    return m_field_value_id_isValid;
}

bool OAISpecificationsInsertFieldRequest::isIsActive() const {
    return m_is_active;
}
void OAISpecificationsInsertFieldRequest::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAISpecificationsInsertFieldRequest::isIsFilter() const {
    return m_is_filter;
}
void OAISpecificationsInsertFieldRequest::setIsFilter(const bool &is_filter) {
    m_is_filter = is_filter;
    m_is_filter_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_is_filter_Set() const{
    return m_is_filter_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_is_filter_Valid() const{
    return m_is_filter_isValid;
}

bool OAISpecificationsInsertFieldRequest::isIsOnProductDetails() const {
    return m_is_on_product_details;
}
void OAISpecificationsInsertFieldRequest::setIsOnProductDetails(const bool &is_on_product_details) {
    m_is_on_product_details = is_on_product_details;
    m_is_on_product_details_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_is_on_product_details_Set() const{
    return m_is_on_product_details_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_is_on_product_details_Valid() const{
    return m_is_on_product_details_isValid;
}

bool OAISpecificationsInsertFieldRequest::isIsRequired() const {
    return m_is_required;
}
void OAISpecificationsInsertFieldRequest::setIsRequired(const bool &is_required) {
    m_is_required = is_required;
    m_is_required_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_is_required_Set() const{
    return m_is_required_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_is_required_Valid() const{
    return m_is_required_isValid;
}

bool OAISpecificationsInsertFieldRequest::isIsSideMenuLinkActive() const {
    return m_is_side_menu_link_active;
}
void OAISpecificationsInsertFieldRequest::setIsSideMenuLinkActive(const bool &is_side_menu_link_active) {
    m_is_side_menu_link_active = is_side_menu_link_active;
    m_is_side_menu_link_active_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_is_side_menu_link_active_Set() const{
    return m_is_side_menu_link_active_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_is_side_menu_link_active_Valid() const{
    return m_is_side_menu_link_active_isValid;
}

bool OAISpecificationsInsertFieldRequest::isIsStockKeepingUnit() const {
    return m_is_stock_keeping_unit;
}
void OAISpecificationsInsertFieldRequest::setIsStockKeepingUnit(const bool &is_stock_keeping_unit) {
    m_is_stock_keeping_unit = is_stock_keeping_unit;
    m_is_stock_keeping_unit_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_is_stock_keeping_unit_Set() const{
    return m_is_stock_keeping_unit_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_is_stock_keeping_unit_Valid() const{
    return m_is_stock_keeping_unit_isValid;
}

bool OAISpecificationsInsertFieldRequest::isIsTopMenuLinkActive() const {
    return m_is_top_menu_link_active;
}
void OAISpecificationsInsertFieldRequest::setIsTopMenuLinkActive(const bool &is_top_menu_link_active) {
    m_is_top_menu_link_active = is_top_menu_link_active;
    m_is_top_menu_link_active_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_is_top_menu_link_active_Set() const{
    return m_is_top_menu_link_active_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_is_top_menu_link_active_Valid() const{
    return m_is_top_menu_link_active_isValid;
}

bool OAISpecificationsInsertFieldRequest::isIsWizard() const {
    return m_is_wizard;
}
void OAISpecificationsInsertFieldRequest::setIsWizard(const bool &is_wizard) {
    m_is_wizard = is_wizard;
    m_is_wizard_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_is_wizard_Set() const{
    return m_is_wizard_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_is_wizard_Valid() const{
    return m_is_wizard_isValid;
}

QString OAISpecificationsInsertFieldRequest::getName() const {
    return m_name;
}
void OAISpecificationsInsertFieldRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAISpecificationsInsertFieldRequest::getPosition() const {
    return m_position;
}
void OAISpecificationsInsertFieldRequest::setPosition(const qint32 &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAISpecificationsInsertFieldRequest::is_position_Set() const{
    return m_position_isSet;
}

bool OAISpecificationsInsertFieldRequest::is_position_Valid() const{
    return m_position_isValid;
}

bool OAISpecificationsInsertFieldRequest::isSet() const {
