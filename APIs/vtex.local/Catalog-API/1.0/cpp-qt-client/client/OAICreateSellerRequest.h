...
/*
 * OAICreateSellerRequest.h
 *
 * 
 */

#ifndef OAICreateSellerRequest_H
#define OAICreateSellerRequest_H
...
class OAICreateSellerRequest : public OAIObject {
public:
    OAICreateSellerRequest();
    OAICreateSellerRequest(QString json);
    ~OAICreateSellerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSellerRequest)

#endif // OAICreateSellerRequest_H
