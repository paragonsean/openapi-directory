...
double OAIDimension::getCubicweight() const {
    return m_cubicweight;
}
void OAIDimension::setCubicweight(const double &cubicweight) {
    m_cubicweight = cubicweight;
    m_cubicweight_isSet = true;
}

bool OAIDimension::is_cubicweight_Set() const{
    return m_cubicweight_isSet;
}

bool OAIDimension::is_cubicweight_Valid() const{
    return m_cubicweight_isValid;
}

double OAIDimension::getHeight() const {
    return m_height;
}
void OAIDimension::setHeight(const double &height) {
    m_height = height;
    m_height_isSet = true;
}
...
double OAIDimension::getLength() const {
    return m_length;
}
void OAIDimension::setLength(const double &length) {
    m_length = length;
    m_length_isSet = true;
}
...
double OAIDimension::getWeight() const {
    return m_weight;
}
void OAIDimension::setWeight(const double &weight) {
    m_weight = weight;
    m_weight_isSet = true;
}
...
double OAIDimension::getWidth() const {
    return m_width;
}
void OAIDimension::setWidth(const double &width) {
    m_width = width;
    m_width_isSet = true;
}
...
bool OAIDimension::isValid() const {
    ...
    return m_cubicweight_isValid && m_height_isValid && m_length_isValid && m_weight_isValid && m_width_isValid && true;
}
