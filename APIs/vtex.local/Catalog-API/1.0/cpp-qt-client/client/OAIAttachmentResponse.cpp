...
QList<OAIDomains_inner> OAIAttachmentResponse::getDomains() const {
    return m_domains;
}
void OAIAttachmentResponse::setDomains(const QList<OAIDomains_inner> &domains) {
    m_domains = domains;
    m_domains_isSet = true;
}

bool OAIAttachmentResponse::is_domains_Set() const{
    return m_domains_isSet;
}

bool OAIAttachmentResponse::is_domains_Valid() const{
    return m_domains_isValid;
}

qint32 OAIAttachmentResponse::getId() const {
    return m_id;
}
void OAIAttachmentResponse::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
bool OAIAttachmentResponse::isIsActive() const {
    return m_is_active;
}
void OAIAttachmentResponse::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAIAttachmentResponse::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIAttachmentResponse::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAIAttachmentResponse::isIsRequired() const {
    return m_is_required;
}
void OAIAttachmentResponse::setIsRequired(const bool &is_required) {
    m_is_required = is_required;
    m_is_required_isSet = true;
}

bool OAIAttachmentResponse::is_is_required_Set() const{
    return m_is_required_isSet;
}

bool OAIAttachmentResponse::is_is_required_Valid() const{
...
bool OAIAttachmentResponse::isValid() const {
    ...
    return m_domains_isValid && m_id_isValid && m_is_active_isValid && m_is_required_isValid && m_name_isValid && true;
}
