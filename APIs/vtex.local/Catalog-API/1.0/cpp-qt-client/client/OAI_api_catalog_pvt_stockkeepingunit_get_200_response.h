...
/*
 * OAI_api_catalog_pvt_stockkeepingunit_get_200_response.h
 *
 * 
 */

#ifndef OAI_api_catalog_pvt_stockkeepingunit_get_200_response_H
#define OAI_api_catalog_pvt_stockkeepingunit_get_200_response_H
...
class OAI_api_catalog_pvt_stockkeepingunit_get_200_response : public OAIObject {
public:
    OAI_api_catalog_pvt_stockkeepingunit_get_200_response();
    OAI_api_catalog_pvt_stockkeepingunit_get_200_response(QString json);
    ~OAI_api_catalog_pvt_stockkeepingunit_get_200_response() override;
    ...
    double getPackagedWeightKg() const;
    void setPackagedWeightKg(const double &packaged_weight_kg);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_api_catalog_pvt_stockkeepingunit_get_200_response)

#endif // OAI_api_catalog_pvt_stockkeepingunit_get_200_response_H
