...
#ifndef OAIRequest_body_6_H
#define OAIRequest_body_6_H
...
class OAIRequest_body_6 : public OAIObject {
public:
    OAIRequest_body_6();
    OAIRequest_body_6(QString json);
    ~OAIRequest_body_6() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequest_body_6)

#endif // OAIRequest_body_6_H
