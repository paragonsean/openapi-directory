...
/*
 * OAIGetSpecFieldValue.h
 *
 * 
 */

#ifndef OAIGetSpecFieldValue_H
#define OAIGetSpecFieldValue_H
...
class OAIGetSpecFieldValue : public OAIObject {
public:
    OAIGetSpecFieldValue();
    OAIGetSpecFieldValue(QString json);
    ~OAIGetSpecFieldValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSpecFieldValue)

#endif // OAIGetSpecFieldValue_H
