...
OAISku_200_response::OAISku_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISku_200_response::OAISku_200_response() {
    this->initializeModel();
}

OAISku_200_response::~OAISku_200_response() {}

void OAISku_200_response::initializeModel() {
...
void OAISku_200_response::fromJson(QString jsonString) {
...
void OAISku_200_response::fromJsonObject(QJsonObject json) {
...
QString OAISku_200_response::asJson() const {
...
QJsonObject OAISku_200_response::asJsonObject() const {
    QJsonObject obj;
...
bool OAISku_200_response::isActivateIfPossible() const {
    return m_activate_if_possible;
}
void OAISku_200_response::setActivateIfPossible(const bool &activate_if_possible) {
    m_activate_if_possible = activate_if_possible;
    m_activate_if_possible_isSet = true;
}

bool OAISku_200_response::is_activate_if_possible_Set() const{
    return m_activate_if_possible_isSet;
}

bool OAISku_200_response::is_activate_if_possible_Valid() const{
    return m_activate_if_possible_isValid;
}

qint32 OAISku_200_response::getCommercialConditionId() const {
    return m_commercial_condition_id;
}
void OAISku_200_response::setCommercialConditionId(const qint32 &commercial_condition_id) {
    m_commercial_condition_id = commercial_condition_id;
    m_commercial_condition_id_isSet = true;
}

bool OAISku_200_response::is_commercial_condition_id_Set() const{
    return m_commercial_condition_id_isSet;
}

bool OAISku_200_response::is_commercial_condition_id_Valid() const{
    return m_commercial_condition_id_isValid;
}

QString OAISku_200_response::getCreationDate() const {
    return m_creation_date;
}
void OAISku_200_response::setCreationDate(const QString &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAISku_200_response::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAISku_200_response::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

double OAISku_200_response::getCubicWeight() const {
    return m_cubic_weight;
}
void OAISku_200_response::setCubicWeight(const double &cubic_weight) {
    m_cubic_weight = cubic_weight;
    m_cubic_weight_isSet = true;
}

bool OAISku_200_response::is_cubic_weight_Set() const{
    return m_cubic_weight_isSet;
}

bool OAISku_200_response::is_cubic_weight_Valid() const{
    return m_cubic_weight_isValid;
}

QString OAISku_200_response::getEstimatedDateArrival() const {
    return m_estimated_date_arrival;
}
void OAISku_200_response::setEstimatedDateArrival(const QString &estimated_date_arrival) {
    m_estimated_date_arrival = estimated_date_arrival;
    m_estimated_date_arrival_isSet = true;
}

bool OAISku_200_response::is_estimated_date_arrival_Set() const{
    return m_estimated_date_arrival_isSet;
}

bool OAISku_200_response::is_estimated_date_arrival_Valid() const{
    return m_estimated_date_arrival_isValid;
}

double OAISku_200_response::getHeight() const {
    return m_height;
}
void OAISku_200_response::setHeight(const double &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAISku_200_response::is_height_Set() const{
    return m_height_isSet;
}

bool OAISku_200_response::is_height_Valid() const{
    return m_height_isValid;
}

qint32 OAISku_200_response::getId() const {
    return m_id;
}
void OAISku_200_response::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISku_200_response::is_id_Set() const{
    return m_id_isSet;
}

bool OAISku_200_response::is_id_Valid() const{
    return m_id_isValid;
}

bool OAISku_200_response::isIsActive() const {
    return m_is_active;
}
void OAISku_200_response::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAISku_200_response::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAISku_200_response::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAISku_200_response::isIsKit() const {
    return m_is_kit;
}
void OAISku_200_response::setIsKit(const bool &is_kit) {
    m_is_kit = is_kit;
    m_is_kit_isSet = true;
}

bool OAISku_200_response::is_is_kit_Set() const{
    return m_is_kit_isSet;
}

bool OAISku_200_response::is_is_kit_Valid() const{
    return m_is_kit_isValid;
}

bool OAISku_200_response::isKitItensSellApart() const {
    return m_kit_itens_sell_apart;
}
void OAISku_200_response::setKitItensSellApart(const bool &kit_itens_sell_apart) {
    m_kit_itens_sell_apart = kit_itens_sell_apart;
    m_kit_itens_sell_apart_isSet = true;
}

bool OAISku_200_response::is_kit_itens_sell_apart_Set() const{
    return m_kit_itens_sell_apart_isSet;
}

bool OAISku_200_response::is_kit_itens_sell_apart_Valid() const{
    return m_kit_itens_sell_apart_isValid;
}

double OAISku_200_response::getLength() const {
    return m_length;
}
void OAISku_200_response::setLength(const double &length) {
    m_length = length;
    m_length_isSet = true;
}

bool OAISku_200_response::is_length_Set() const{
    return m_length_isSet;
}

bool OAISku_200_response::is_length_Valid() const{
    return m_length_isValid;
}

QString OAISku_200_response::getManufacturerCode() const {
    return m_manufacturer_code;
}
void OAISku_200_response::setManufacturerCode(const QString &manufacturer_code) {
    m_manufacturer_code = manufacturer_code;
    m_manufacturer_code_isSet = true;
}

bool OAISku_200_response::is_manufacturer_code_Set() const{
    return m_manufacturer_code_isSet;
}

bool OAISku_200_response::is_manufacturer_code_Valid() const{
    return m_manufacturer_code_isValid;
}

QString OAISku_200_response::getMeasurementUnit() const {
    return m_measurement_unit;
}
void OAISku_200_response::setMeasurementUnit(const QString &measurement_unit) {
    m_measurement_unit = measurement_unit;
    m_measurement_unit_isSet = true;
}

bool OAISku_200_response::is_measurement_unit_Set() const{
    return m_measurement_unit_isSet;
}

bool OAISku_200_response::is_measurement_unit_Valid() const{
    return m_measurement_unit_isValid;
}

QString OAISku_200_response::getModalType() const {
    return m_modal_type;
}
void OAISku_200_response::setModalType(const QString &modal_type) {
    m_modal_type = modal_type;
    m_modal_type_isSet = true;
}

bool OAISku_200_response::is_modal_type_Set() const{
    return m_modal_type_isSet;
}

bool OAISku_200_response::is_modal_type_Valid() const{
    return m_modal_type_isValid;
}

QString OAISku_200_response::getName() const {
    return m_name;
}
void OAISku_200_response::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISku_200_response::is_name_Set() const{
    return m_name_isSet;
}

bool OAISku_200_response::is_name_Valid() const{
    return m_name_isValid;
}

double OAISku_200_response::getPackagedHeight() const {
    return m_packaged_height;
}
void OAISku_200_response::setPackagedHeight(const double &packaged_height) {
    m_packaged_height = packaged_height;
    m_packaged_height_isSet = true;
}

bool OAISku_200_response::is_packaged_height_Set() const{
    return m_packaged_height_isSet;
}

bool OAISku_200_response::is_packaged_height_Valid() const{
    return m_packaged_height_isValid;
}

double OAISku_200_response::getPackagedLength() const {
    return m_packaged_length;
}
void OAISku_200_response::setPackagedLength(const double &packaged_length) {
    m_packaged_length = packaged_length;
    m_packaged_length_isSet = true;
}

bool OAISku_200_response::is_packaged_length_Set() const{
    return m_packaged_length_isSet;
}

bool OAISku_200_response::is_packaged_length_Valid() const{
    return m_packaged_length_isValid;
}

qint32 OAISku_200_response::getPackagedWeightKg() const {
    return m_packaged_weight_kg;
}
void OAISku_200_response::setPackagedWeightKg(const qint32 &packaged_weight_kg) {
    m_packaged_weight_kg = packaged_weight_kg;
    m_packaged_weight_kg_isSet = true;
}

bool OAISku_200_response::is_packaged_weight_kg_Set() const{
    return m_packaged_weight_kg_isSet;
}

bool OAISku_200_response::is_packaged_weight_kg_Valid() const{
    return m_packaged_weight_kg_isValid;
}

double OAISku_200_response::getPackagedWidth() const {
    return m_packaged_width;
}
void OAISku_200_response::setPackagedWidth(const double &packaged_width) {
    m_packaged_width = packaged_width;
    m_packaged_width_isSet = true;
}

bool OAISku_200_response::is_packaged_width_Set() const{
    return m_packaged_width_isSet;
}

bool OAISku_200_response::is_packaged_width_Valid() const{
    return m_packaged_width_isValid;
}

qint32 OAISku_200_response::getProductId() const {
    return m_product_id;
}
void OAISku_200_response::setProductId(const qint32 &product_id) {
    m_product_id = product_id;
    m_product_id_isSet = true;
}

bool OAISku_200_response::is_product_id_Set() const{
    return m_product_id_isSet;
}

bool OAISku_200_response::is_product_id_Valid() const{
    return m_product_id_isValid;
}

QString OAISku_200_response::getRefId() const {
    return m_ref_id;
}
void OAISku_200_response::setRefId(const QString &ref_id) {
    m_ref_id = ref_id;
    m_ref_id_isSet = true;
}

bool OAISku_200_response::is_ref_id_Set() const{
    return m_ref_id_isSet;
}

bool OAISku_200_response::is_ref_id_Valid() const{
    return m_ref_id_isValid;
}

double OAISku_200_response::getRewardValue() const {
    return m_reward_value;
}
void OAISku_200_response::setRewardValue(const double &reward_value) {
    m_reward_value = reward_value;
    m_reward_value_isSet = true;
}

bool OAISku_200_response::is_reward_value_Set() const{
    return m_reward_value_isSet;
}

bool OAISku_200_response::is_reward_value_Valid() const{
    return m_reward_value_isValid;
}

double OAISku_200_response::getUnitMultiplier() const {
    return m_unit_multiplier;
}
void OAISku_200_response::setUnitMultiplier(const double &unit_multiplier) {
    m_unit_multiplier = unit_multiplier;
    m_unit_multiplier_isSet = true;
}

bool OAISku_200_response::is_unit_multiplier_Set() const{
    return m_unit_multiplier_isSet;
}

bool OAISku_200_response::is_unit_multiplier_Valid() const{
    return m_unit_multiplier_isValid;
}

QList<QString> OAISku_200_response::getVideos() const {
    return m_videos;
}
void OAISku_200_response::setVideos(const QList<QString> &videos) {
    m_videos = videos;
    m_videos_isSet = true;
}

bool OAISku_200_response::is_videos_Set() const{
    return m_videos_isSet;
}

bool OAISku_200_response::is_videos_Valid() const{
    return m_videos_isValid;
}

double OAISku_200_response::getWeightKg() const {
    return m_weight_kg;
}
void OAISku_200_response::setWeightKg(const double &weight_kg) {
    m_weight_kg = weight_kg;
    m_weight_kg_isSet = true;
}

bool OAISku_200_response::is_weight_kg_Set() const{
    return m_weight_kg_isSet;
}

bool OAISku_200_response::is_weight_kg_Valid() const{
    return m_weight_kg_isValid;
}

double OAISku_200_response::getWidth() const {
    return m_width;
}
void OAISku_200_response::setWidth(const double &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAISku_200_response::is_width_Set() const{
    return m_width_isSet;
}

bool OAISku_200_response::is_width_Valid() const{
    return m_width_isValid;
}

bool OAISku_200_response::isSet() const {
...
bool OAISku_200_response::isValid() const {
