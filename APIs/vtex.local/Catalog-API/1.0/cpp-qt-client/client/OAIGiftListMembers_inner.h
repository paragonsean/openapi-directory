...
/*
 * OAIGiftListMembers_inner.h
 *
 * Object with information about each gift list member.
 */

#ifndef OAIGiftListMembers_inner_H
#define OAIGiftListMembers_inner_H
...
class OAIGiftListMembers_inner : public OAIObject {
public:
    OAIGiftListMembers_inner();
    OAIGiftListMembers_inner(QString json);
    ~OAIGiftListMembers_inner() override;
    ...
    qint32 getGiftListMemberId() const;
    void setGiftListMemberId(const qint32 &gift_list_member_id);
    bool is_gift_list_member_id_Set() const;
    bool is_gift_list_member_id_Valid() const;
...
private:
    ...
    qint32 m_gift_list_member_id;
    bool m_gift_list_member_id_isSet;
    bool m_gift_list_member_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGiftListMembers_inner)

#endif // OAIGiftListMembers_inner_H
