...
/*
 * OAISupplierRequest.h
 *
 * 
 */

#ifndef OAISupplierRequest_H
#define OAISupplierRequest_H
...
class OAISupplierRequest : public OAIObject {
public:
    OAISupplierRequest();
    OAISupplierRequest(QString json);
    ~OAISupplierRequest() override;
    ...
    QString getCorportePhone() const;
    void setCorportePhone(const QString &corporte_phone);
    bool is_corporte_phone_Set() const;
    bool is_corporte_phone_Valid() const;
...
private:
    ...
    QString m_corporte_phone;
    bool m_corporte_phone_isSet;
    bool m_corporte_phone_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupplierRequest)

#endif // OAISupplierRequest_H
