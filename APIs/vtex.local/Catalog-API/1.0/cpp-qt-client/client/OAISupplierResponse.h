...
/*
 * OAISupplierResponse.h
 *
 * 
 */

#ifndef OAISupplierResponse_H
#define OAISupplierResponse_H
...
class OAISupplierResponse : public OAIObject {
public:
    OAISupplierResponse();
    OAISupplierResponse(QString json);
    ~OAISupplierResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupplierResponse)

#endif // OAISupplierResponse_H
