...
/*
 * OAIGetCategoryTreeChild.h
 *
 * 
 */

#ifndef OAIGetCategoryTreeChild_H
#define OAIGetCategoryTreeChild_H
...
class OAIGetCategoryTreeChild : public OAIObject {
public:
    OAIGetCategoryTreeChild();
    OAIGetCategoryTreeChild(QString json);
    ~OAIGetCategoryTreeChild() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCategoryTreeChild)

#endif // OAIGetCategoryTreeChild_H
