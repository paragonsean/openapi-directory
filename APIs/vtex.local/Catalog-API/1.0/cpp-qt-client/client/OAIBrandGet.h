...
#ifndef OAIBrandGet_H
#define OAIBrandGet_H
...
class OAIBrandGet : public OAIObject {
public:
    OAIBrandGet();
    OAIBrandGet(QString json);
    ~OAIBrandGet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBrandGet)
