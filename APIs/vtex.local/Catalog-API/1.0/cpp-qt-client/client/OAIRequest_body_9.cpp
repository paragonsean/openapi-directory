...
OAIRequest_body_9::OAIRequest_body_9(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRequest_body_9::OAIRequest_body_9() {
    this->initializeModel();
}

OAIRequest_body_9::~OAIRequest_body_9() {}

void OAIRequest_body_9::initializeModel() {
...
void OAIRequest_body_9::fromJson(QString jsonString) {
...
void OAIRequest_body_9::fromJsonObject(QJsonObject json) {
...
QString OAIRequest_body_9::asJson() const {
...
QJsonObject OAIRequest_body_9::asJsonObject() const {
    QJsonObject obj;
    if (m_quantity_isSet) {
...
qint32 OAIRequest_body_9::getQuantity() const {
    return m_quantity;
}
void OAIRequest_body_9::setQuantity(const qint32 &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIRequest_body_9::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIRequest_body_9::is_quantity_Valid() const{
    return m_quantity_isValid;
}

qint32 OAIRequest_body_9::getStockKeepingUnitId() const {
    return m_stock_keeping_unit_id;
}
void OAIRequest_body_9::setStockKeepingUnitId(const qint32 &stock_keeping_unit_id) {
    m_stock_keeping_unit_id = stock_keeping_unit_id;
    m_stock_keeping_unit_id_isSet = true;
}

bool OAIRequest_body_9::is_stock_keeping_unit_id_Set() const{
    return m_stock_keeping_unit_id_isSet;
}

bool OAIRequest_body_9::is_stock_keeping_unit_id_Valid() const{
    return m_stock_keeping_unit_id_isValid;
}

qint32 OAIRequest_body_9::getStockKeepingUnitParent() const {
    return m_stock_keeping_unit_parent;
}
void OAIRequest_body_9::setStockKeepingUnitParent(const qint32 &stock_keeping_unit_parent) {
    m_stock_keeping_unit_parent = stock_keeping_unit_parent;
    m_stock_keeping_unit_parent_isSet = true;
}

bool OAIRequest_body_9::is_stock_keeping_unit_parent_Set() const{
    return m_stock_keeping_unit_parent_isSet;
}

bool OAIRequest_body_9::is_stock_keeping_unit_parent_Valid() const{
    return m_stock_keeping_unit_parent_isValid;
}

double OAIRequest_body_9::getUnitPrice() const {
    return m_unit_price;
}
void OAIRequest_body_9::setUnitPrice(const double &unit_price) {
    m_unit_price = unit_price;
    m_unit_price_isSet = true;
}

bool OAIRequest_body_9::is_unit_price_Set() const{
    return m_unit_price_isSet;
}

bool OAIRequest_body_9::is_unit_price_Valid() const{
    return m_unit_price_isValid;
}

bool OAIRequest_body_9::isSet() const {
...
bool OAIRequest_body_9::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_quantity_isValid && m_stock_keeping_unit_id_isValid && m_stock_keeping_unit_parent_isValid && m_unit_price_isValid && true;
}
