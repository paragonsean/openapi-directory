...
qint32 OAIRequest_body_1::getAttachmentId() const {
    return m_attachment_id;
}
void OAIRequest_body_1::setAttachmentId(const qint32 &attachment_id) {
    m_attachment_id = attachment_id;
    m_attachment_id_isSet = true;
}

bool OAIRequest_body_1::is_attachment_id_Set() const{
    return m_attachment_id_isSet;
}

bool OAIRequest_body_1::is_attachment_id_Valid() const{
    return m_attachment_id_isValid;
}

qint32 OAIRequest_body_1::getSkuId() const {
    return m_sku_id;
}
void OAIRequest_body_1::setSkuId(const qint32 &sku_id) {
    m_sku_id = sku_id;
    m_sku_id_isSet = true;
}

bool OAIRequest_body_1::is_sku_id_Set() const{
    return m_sku_id_isSet;
}

bool OAIRequest_body_1::is_sku_id_Valid() const{
...
bool OAIRequest_body_1::isValid() const {
    ...
    return m_attachment_id_isValid && m_sku_id_isValid && true;
}
