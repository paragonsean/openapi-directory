...
/*
 * OAI_api_catalog_pvt_stockkeepingunit_post_request.h
 *
 * 
 */

#ifndef OAI_api_catalog_pvt_stockkeepingunit_post_request_H
#define OAI_api_catalog_pvt_stockkeepingunit_post_request_H
...
class OAI_api_catalog_pvt_stockkeepingunit_post_request : public OAIObject {
public:
    OAI_api_catalog_pvt_stockkeepingunit_post_request();
    OAI_api_catalog_pvt_stockkeepingunit_post_request(QString json);
    ~OAI_api_catalog_pvt_stockkeepingunit_post_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_api_catalog_pvt_stockkeepingunit_post_request)

#endif // OAI_api_catalog_pvt_stockkeepingunit_post_request_H
