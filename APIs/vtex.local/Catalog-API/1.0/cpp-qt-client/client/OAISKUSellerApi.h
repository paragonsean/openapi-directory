...
#ifndef OAI_OAISKUSellerApi_H
#define OAI_OAISKUSellerApi_H
...
class OAISKUSellerApi : public QObject {
    Q_OBJECT

public:
    OAISKUSellerApi(const int timeOut = 0);
    ~OAISKUSellerApi();
    ...
    */
    virtual void apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPost(const QString &content_type, const QString &accept, const QString &seller_id, const QString &seller_sku_id);
...
private:
    ...
    void apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPostCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPostSignal();
    ...
    void apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPostSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPostSignalError() instead")
    void apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPostSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPostSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPostSignalErrorFull() instead")
    void apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPostSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPostSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
