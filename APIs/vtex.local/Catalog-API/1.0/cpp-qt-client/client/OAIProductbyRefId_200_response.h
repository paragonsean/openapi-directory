...
/*
 * OAIProductbyRefId_200_response.h
 *
 * 
 */

#ifndef OAIProductbyRefId_200_response_H
#define OAIProductbyRefId_200_response_H
...
class OAIProductbyRefId_200_response : public OAIObject {
public:
    OAIProductbyRefId_200_response();
    OAIProductbyRefId_200_response(QString json);
    ~OAIProductbyRefId_200_response() override;
    ...
    QList<qint32> getListStoreId() const;
    void setListStoreId(const QList<qint32> &list_store_id);
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductbyRefId_200_response)

#endif // OAIProductbyRefId_200_response_H
