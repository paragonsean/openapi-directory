...
/*
 * OAISpecificationsInsertFieldRequest.h
 *
 * 
 */

#ifndef OAISpecificationsInsertFieldRequest_H
#define OAISpecificationsInsertFieldRequest_H
...
class OAISpecificationsInsertFieldRequest : public OAIObject {
public:
    OAISpecificationsInsertFieldRequest();
    OAISpecificationsInsertFieldRequest(QString json);
    ~OAISpecificationsInsertFieldRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISpecificationsInsertFieldRequest)

#endif // OAISpecificationsInsertFieldRequest_H
