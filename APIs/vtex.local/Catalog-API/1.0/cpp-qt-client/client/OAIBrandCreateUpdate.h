...
/*
 * OAIBrandCreateUpdate.h
 *
 * Object containing Brand information.
 */

#ifndef OAIBrandCreateUpdate_H
#define OAIBrandCreateUpdate_H
...
class OAIBrandCreateUpdate : public OAIObject {
public:
    OAIBrandCreateUpdate();
    OAIBrandCreateUpdate(QString json);
    ~OAIBrandCreateUpdate() override;
    ...
    bool isMenuHome() const;
    void setMenuHome(const bool &menu_home);
    bool is_menu_home_Set() const;
    bool is_menu_home_Valid() const;
...
private:
    ...
    bool m_menu_home;
    bool m_menu_home_isSet;
    bool m_menu_home_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBrandCreateUpdate)

#endif // OAIBrandCreateUpdate_H
