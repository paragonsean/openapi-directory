...
OAIRequest_body_6::OAIRequest_body_6(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRequest_body_6::OAIRequest_body_6() {
    this->initializeModel();
}

OAIRequest_body_6::~OAIRequest_body_6() {}

void OAIRequest_body_6::initializeModel() {
...
void OAIRequest_body_6::fromJson(QString jsonString) {
...
void OAIRequest_body_6::fromJsonObject(QJsonObject json) {
...
QString OAIRequest_body_6::asJson() const {
...
QJsonObject OAIRequest_body_6::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIRequest_body_6::getCategoryId() const {
    return m_category_id;
}
void OAIRequest_body_6::setCategoryId(const qint32 &category_id) {
    m_category_id = category_id;
    m_category_id_isSet = true;
}

bool OAIRequest_body_6::is_category_id_Set() const{
    return m_category_id_isSet;
}

bool OAIRequest_body_6::is_category_id_Valid() const{
    return m_category_id_isValid;
}

QString OAIRequest_body_6::getDefaultValue() const {
    return m_default_value;
}
void OAIRequest_body_6::setDefaultValue(const QString &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIRequest_body_6::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIRequest_body_6::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIRequest_body_6::getDescription() const {
    return m_description;
}
void OAIRequest_body_6::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIRequest_body_6::is_description_Set() const{
    return m_description_isSet;
}

bool OAIRequest_body_6::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAIRequest_body_6::getFieldGroupId() const {
    return m_field_group_id;
}
void OAIRequest_body_6::setFieldGroupId(const qint32 &field_group_id) {
    m_field_group_id = field_group_id;
    m_field_group_id_isSet = true;
}

bool OAIRequest_body_6::is_field_group_id_Set() const{
    return m_field_group_id_isSet;
}

bool OAIRequest_body_6::is_field_group_id_Valid() const{
    return m_field_group_id_isValid;
}

qint32 OAIRequest_body_6::getFieldTypeId() const {
    return m_field_type_id;
}
void OAIRequest_body_6::setFieldTypeId(const qint32 &field_type_id) {
    m_field_type_id = field_type_id;
    m_field_type_id_isSet = true;
}

bool OAIRequest_body_6::is_field_type_id_Set() const{
    return m_field_type_id_isSet;
}

bool OAIRequest_body_6::is_field_type_id_Valid() const{
    return m_field_type_id_isValid;
}

qint32 OAIRequest_body_6::getId() const {
    return m_id;
}
void OAIRequest_body_6::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRequest_body_6::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRequest_body_6::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIRequest_body_6::isIsActive() const {
    return m_is_active;
}
void OAIRequest_body_6::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAIRequest_body_6::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIRequest_body_6::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAIRequest_body_6::isIsFilter() const {
    return m_is_filter;
}
void OAIRequest_body_6::setIsFilter(const bool &is_filter) {
    m_is_filter = is_filter;
    m_is_filter_isSet = true;
}

bool OAIRequest_body_6::is_is_filter_Set() const{
    return m_is_filter_isSet;
}

bool OAIRequest_body_6::is_is_filter_Valid() const{
    return m_is_filter_isValid;
}

bool OAIRequest_body_6::isIsOnProductDetails() const {
    return m_is_on_product_details;
}
void OAIRequest_body_6::setIsOnProductDetails(const bool &is_on_product_details) {
    m_is_on_product_details = is_on_product_details;
    m_is_on_product_details_isSet = true;
}

bool OAIRequest_body_6::is_is_on_product_details_Set() const{
    return m_is_on_product_details_isSet;
}

bool OAIRequest_body_6::is_is_on_product_details_Valid() const{
    return m_is_on_product_details_isValid;
}

bool OAIRequest_body_6::isIsRequired() const {
    return m_is_required;
}
void OAIRequest_body_6::setIsRequired(const bool &is_required) {
    m_is_required = is_required;
    m_is_required_isSet = true;
}

bool OAIRequest_body_6::is_is_required_Set() const{
    return m_is_required_isSet;
}

bool OAIRequest_body_6::is_is_required_Valid() const{
    return m_is_required_isValid;
}

bool OAIRequest_body_6::isIsSideMenuLinkActive() const {
    return m_is_side_menu_link_active;
}
void OAIRequest_body_6::setIsSideMenuLinkActive(const bool &is_side_menu_link_active) {
    m_is_side_menu_link_active = is_side_menu_link_active;
    m_is_side_menu_link_active_isSet = true;
}

bool OAIRequest_body_6::is_is_side_menu_link_active_Set() const{
    return m_is_side_menu_link_active_isSet;
}

bool OAIRequest_body_6::is_is_side_menu_link_active_Valid() const{
    return m_is_side_menu_link_active_isValid;
}

bool OAIRequest_body_6::isIsStockKeepingUnit() const {
    return m_is_stock_keeping_unit;
}
void OAIRequest_body_6::setIsStockKeepingUnit(const bool &is_stock_keeping_unit) {
    m_is_stock_keeping_unit = is_stock_keeping_unit;
    m_is_stock_keeping_unit_isSet = true;
}

bool OAIRequest_body_6::is_is_stock_keeping_unit_Set() const{
    return m_is_stock_keeping_unit_isSet;
}

bool OAIRequest_body_6::is_is_stock_keeping_unit_Valid() const{
    return m_is_stock_keeping_unit_isValid;
}

bool OAIRequest_body_6::isIsTopMenuLinkActive() const {
    return m_is_top_menu_link_active;
}
void OAIRequest_body_6::setIsTopMenuLinkActive(const bool &is_top_menu_link_active) {
    m_is_top_menu_link_active = is_top_menu_link_active;
    m_is_top_menu_link_active_isSet = true;
}

bool OAIRequest_body_6::is_is_top_menu_link_active_Set() const{
    return m_is_top_menu_link_active_isSet;
}

bool OAIRequest_body_6::is_is_top_menu_link_active_Valid() const{
    return m_is_top_menu_link_active_isValid;
}

bool OAIRequest_body_6::isIsWizard() const {
    return m_is_wizard;
}
void OAIRequest_body_6::setIsWizard(const bool &is_wizard) {
    m_is_wizard = is_wizard;
    m_is_wizard_isSet = true;
}

bool OAIRequest_body_6::is_is_wizard_Set() const{
    return m_is_wizard_isSet;
}

bool OAIRequest_body_6::is_is_wizard_Valid() const{
    return m_is_wizard_isValid;
}

QString OAIRequest_body_6::getName() const {
    return m_name;
}
void OAIRequest_body_6::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRequest_body_6::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRequest_body_6::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIRequest_body_6::getPosition() const {
    return m_position;
}
void OAIRequest_body_6::setPosition(const qint32 &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIRequest_body_6::is_position_Set() const{
    return m_position_isSet;
}

bool OAIRequest_body_6::is_position_Valid() const{
    return m_position_isValid;
}

bool OAIRequest_body_6::isSet() const {
