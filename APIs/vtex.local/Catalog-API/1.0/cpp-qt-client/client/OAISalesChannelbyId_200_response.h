...
/*
 * OAISalesChannelbyId_200_response.h
 *
 * 
 */

#ifndef OAISalesChannelbyId_200_response_H
#define OAISalesChannelbyId_200_response_H
...
class OAISalesChannelbyId_200_response : public OAIObject {
public:
    OAISalesChannelbyId_200_response();
    OAISalesChannelbyId_200_response(QString json);
    ~OAISalesChannelbyId_200_response() override;
    ...
    QString getConditionRule() const;
    void setConditionRule(const QString &condition_rule);
    bool is_condition_rule_Set() const;
    bool is_condition_rule_Valid() const;
    ...
    QString getCultureInfo() const;
    void setCultureInfo(const QString &culture_info);
    bool is_culture_info_Set() const;
    bool is_culture_info_Valid() const;
    ...
    qint32 getProductClusterId() const;
    void setProductClusterId(const qint32 &product_cluster_id);
...
private:
    ...
    QString m_condition_rule;
    bool m_condition_rule_isSet;
    bool m_condition_rule_isValid;

    QString m_country_code;
    bool m_country_code_isSet;
    bool m_country_code_isValid;

    QString m_culture_info;
    bool m_culture_info_isSet;
    bool m_culture_info_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISalesChannelbyId_200_response)

#endif // OAISalesChannelbyId_200_response_H
