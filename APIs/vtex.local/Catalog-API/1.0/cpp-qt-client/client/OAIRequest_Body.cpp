...
qint32 OAIRequest_Body::getFieldId() const {
    return m_field_id;
}
void OAIRequest_Body::setFieldId(const qint32 &field_id) {
    m_field_id = field_id;
    m_field_id_isSet = true;
}

bool OAIRequest_Body::is_field_id_Set() const{
    return m_field_id_isSet;
}

bool OAIRequest_Body::is_field_id_Valid() const{
    return m_field_id_isValid;
}

qint32 OAIRequest_Body::getFieldValueId() const {
    return m_field_value_id;
}
void OAIRequest_Body::setFieldValueId(const qint32 &field_value_id) {
    m_field_value_id = field_value_id;
    m_field_value_id_isSet = true;
}

bool OAIRequest_Body::is_field_value_id_Set() const{
    return m_field_value_id_isSet;
}

bool OAIRequest_Body::is_field_value_id_Valid() const{
    return m_field_value_id_isValid;
}

qint32 OAIRequest_Body::getId() const {
    return m_id;
}
void OAIRequest_Body::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
qint32 OAIRequest_Body::getSkuId() const {
    return m_sku_id;
}
void OAIRequest_Body::setSkuId(const qint32 &sku_id) {
    m_sku_id = sku_id;
    m_sku_id_isSet = true;
}

bool OAIRequest_Body::is_sku_id_Set() const{
    return m_sku_id_isSet;
}

bool OAIRequest_Body::is_sku_id_Valid() const{
    return m_sku_id_isValid;
}

QString OAIRequest_Body::getText() const {
    return m_text;
}
void OAIRequest_Body::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIRequest_Body::is_text_Set() const{
    return m_text_isSet;
}

bool OAIRequest_Body::is_text_Valid() const{
...
bool OAIRequest_Body::isValid() const {
    ...
    return m_field_id_isValid && m_field_value_id_isValid && m_id_isValid && true;
}
