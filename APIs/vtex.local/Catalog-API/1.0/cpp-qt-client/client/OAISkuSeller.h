...
#ifndef OAISkuSeller_H
#define OAISkuSeller_H
...
class OAISkuSeller : public OAIObject {
public:
    OAISkuSeller();
    OAISkuSeller(QString json);
    ~OAISkuSeller() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISkuSeller)

#endif // OAISkuSeller_H
