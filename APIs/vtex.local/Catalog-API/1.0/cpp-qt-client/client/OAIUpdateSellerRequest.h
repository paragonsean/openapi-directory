...
/*
 * OAIUpdateSellerRequest.h
 *
 * 
 */

#ifndef OAIUpdateSellerRequest_H
#define OAIUpdateSellerRequest_H
...
class OAIUpdateSellerRequest : public OAIObject {
public:
    OAIUpdateSellerRequest();
    OAIUpdateSellerRequest(QString json);
    ~OAIUpdateSellerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSellerRequest)

#endif // OAIUpdateSellerRequest_H
