...
bool OAICategory::isActiveStoreFrontLink() const {
    return m_active_store_front_link;
}
void OAICategory::setActiveStoreFrontLink(const bool &active_store_front_link) {
    m_active_store_front_link = active_store_front_link;
    m_active_store_front_link_isSet = true;
}

bool OAICategory::is_active_store_front_link_Set() const{
    return m_active_store_front_link_isSet;
}

bool OAICategory::is_active_store_front_link_Valid() const{
    return m_active_store_front_link_isValid;
}

QString OAICategory::getAdWordsRemarketingCode() const {
    return m_ad_words_remarketing_code;
}
void OAICategory::setAdWordsRemarketingCode(const QString &ad_words_remarketing_code) {
    m_ad_words_remarketing_code = ad_words_remarketing_code;
    m_ad_words_remarketing_code_isSet = true;
}

bool OAICategory::is_ad_words_remarketing_code_Set() const{
    return m_ad_words_remarketing_code_isSet;
}

bool OAICategory::is_ad_words_remarketing_code_Valid() const{
...
qint32 OAICategory::getFatherCategoryId() const {
    return m_father_category_id;
}
void OAICategory::setFatherCategoryId(const qint32 &father_category_id) {
    m_father_category_id = father_category_id;
    m_father_category_id_isSet = true;
}

bool OAICategory::is_father_category_id_Set() const{
    return m_father_category_id_isSet;
}

bool OAICategory::is_father_category_id_Valid() const{
    return m_father_category_id_isValid;
}

qint32 OAICategory::getGlobalCategoryId() const {
    return m_global_category_id;
}
void OAICategory::setGlobalCategoryId(const qint32 &global_category_id) {
    m_global_category_id = global_category_id;
    m_global_category_id_isSet = true;
}

bool OAICategory::is_global_category_id_Set() const{
    return m_global_category_id_isSet;
}

bool OAICategory::is_global_category_id_Valid() const{
    return m_global_category_id_isValid;
}

bool OAICategory::isHasChildren() const {
    return m_has_children;
}
void OAICategory::setHasChildren(const bool &has_children) {
    m_has_children = has_children;
    m_has_children_isSet = true;
}

bool OAICategory::is_has_children_Set() const{
    return m_has_children_isSet;
}

bool OAICategory::is_has_children_Valid() const{
...
bool OAICategory::isIsActive() const {
    return m_is_active;
}
void OAICategory::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAICategory::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAICategory::is_is_active_Valid() const{
...
QString OAICategory::getLinkId() const {
    return m_link_id;
}
void OAICategory::setLinkId(const QString &link_id) {
    m_link_id = link_id;
    m_link_id_isSet = true;
}

bool OAICategory::is_link_id_Set() const{
    return m_link_id_isSet;
}

bool OAICategory::is_link_id_Valid() const{
    return m_link_id_isValid;
}

QString OAICategory::getLomadeeCampaignCode() const {
    return m_lomadee_campaign_code;
}
void OAICategory::setLomadeeCampaignCode(const QString &lomadee_campaign_code) {
    m_lomadee_campaign_code = lomadee_campaign_code;
    m_lomadee_campaign_code_isSet = true;
}

bool OAICategory::is_lomadee_campaign_code_Set() const{
    return m_lomadee_campaign_code_isSet;
}

bool OAICategory::is_lomadee_campaign_code_Valid() const{
...
qint32 OAICategory::getScore() const {
    return m_score;
}
void OAICategory::setScore(const qint32 &score) {
    m_score = score;
    m_score_isSet = true;
}
...
bool OAICategory::isShowBrandFilter() const {
    return m_show_brand_filter;
}
void OAICategory::setShowBrandFilter(const bool &show_brand_filter) {
    m_show_brand_filter = show_brand_filter;
    m_show_brand_filter_isSet = true;
}

bool OAICategory::is_show_brand_filter_Set() const{
    return m_show_brand_filter_isSet;
}

bool OAICategory::is_show_brand_filter_Valid() const{
    return m_show_brand_filter_isValid;
}

bool OAICategory::isShowInStoreFront() const {
    return m_show_in_store_front;
}
void OAICategory::setShowInStoreFront(const bool &show_in_store_front) {
    m_show_in_store_front = show_in_store_front;
    m_show_in_store_front_isSet = true;
}

bool OAICategory::is_show_in_store_front_Set() const{
    return m_show_in_store_front_isSet;
}

bool OAICategory::is_show_in_store_front_Valid() const{
    return m_show_in_store_front_isValid;
}

QString OAICategory::getStockKeepingUnitSelectionMode() const {
    return m_stock_keeping_unit_selection_mode;
}
void OAICategory::setStockKeepingUnitSelectionMode(const QString &stock_keeping_unit_selection_mode) {
    m_stock_keeping_unit_selection_mode = stock_keeping_unit_selection_mode;
    m_stock_keeping_unit_selection_mode_isSet = true;
}

bool OAICategory::is_stock_keeping_unit_selection_mode_Set() const{
    return m_stock_keeping_unit_selection_mode_isSet;
}

bool OAICategory::is_stock_keeping_unit_selection_mode_Valid() const{
...
bool OAICategory::isValid() const {
    ...
    return m_active_store_front_link_isValid && m_ad_words_remarketing_code_isValid && m_description_isValid && m_father_category_id_isValid && m_global_category_id_isValid && m_has_children_isValid && m_id_isValid && m_is_active_isValid && m_keywords_isValid && m_link_id_isValid && m_lomadee_campaign_code_isValid && m_name_isValid && m_score_isValid && m_show_brand_filter_isValid && m_show_in_store_front_isValid && m_stock_keeping_unit_selection_mode_isValid && m_title_isValid && true;
}
