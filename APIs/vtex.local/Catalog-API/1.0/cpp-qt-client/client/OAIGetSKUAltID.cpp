...
OAIGetSKUAltID::OAIGetSKUAltID(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSKUAltID::OAIGetSKUAltID() {
    this->initializeModel();
}

OAIGetSKUAltID::~OAIGetSKUAltID() {}

void OAIGetSKUAltID::initializeModel() {
    ...
    m_categories_full_path_isSet = false;
    m_categories_full_path_isValid = false;
    ...
    m_is_direct_category_active_isSet = false;
    m_is_direct_category_active_isValid = false;
    ...
    m_positions_in_clusters_isSet = false;
    m_positions_in_clusters_isValid = false;
    ...
    m_product_cluster_highlights_isSet = false;
    m_product_cluster_highlights_isValid = false;

    m_product_cluster_names_isSet = false;
    m_product_cluster_names_isValid = false;
...
void OAIGetSKUAltID::fromJson(QString jsonString) {
...
void OAIGetSKUAltID::fromJsonObject(QJsonObject json) {
    ...
    m_categories_full_path_isValid = ::OpenAPI::fromJsonValue(m_categories_full_path, json[QString("CategoriesFullPath")]);
    m_categories_full_path_isSet = !json[QString("CategoriesFullPath")].isNull() && m_categories_full_path_isValid;
    ...
    m_is_direct_category_active_isValid = ::OpenAPI::fromJsonValue(m_is_direct_category_active, json[QString("IsDirectCategoryActive")]);
    m_is_direct_category_active_isSet = !json[QString("IsDirectCategoryActive")].isNull() && m_is_direct_category_active_isValid;
    ...
    if(json["PositionsInClusters"].isObject()){
        auto varmap = json["PositionsInClusters"].toObject().toVariantMap();
        m_positions_in_clusters_isValid = true;
        if(varmap.count() > 0){
            for(auto val : varmap.keys()){
                QMap<QString, qint32> item;
                auto jval = QJsonValue::fromVariant(varmap.value(val));
                m_positions_in_clusters_isValid &= ::OpenAPI::fromJsonValue(item, jval);
                m_positions_in_clusters_isSet &= !jval.isNull() && m_positions_in_clusters_isValid;
                m_positions_in_clusters.insert(m_positions_in_clusters.end(), val, item);
            }
        }
    }
    ...
    if(json["ProductClusterHighlights"].isObject()){
        auto varmap = json["ProductClusterHighlights"].toObject().toVariantMap();
        m_product_cluster_highlights_isValid = true;
        if(varmap.count() > 0){
            for(auto val : varmap.keys()){
                QMap<QString, QString> item;
                auto jval = QJsonValue::fromVariant(varmap.value(val));
                m_product_cluster_highlights_isValid &= ::OpenAPI::fromJsonValue(item, jval);
                m_product_cluster_highlights_isSet &= !jval.isNull() && m_product_cluster_highlights_isValid;
                m_product_cluster_highlights.insert(m_product_cluster_highlights.end(), val, item);
            }
        }
    }

    if(json["ProductClusterNames"].isObject()){
        auto varmap = json["ProductClusterNames"].toObject().toVariantMap();
        m_product_cluster_names_isValid = true;
        if(varmap.count() > 0){
            for(auto val : varmap.keys()){
                QMap<QString, QString> item;
                auto jval = QJsonValue::fromVariant(varmap.value(val));
                m_product_cluster_names_isValid &= ::OpenAPI::fromJsonValue(item, jval);
                m_product_cluster_names_isSet &= !jval.isNull() && m_product_cluster_names_isValid;
                m_product_cluster_names.insert(m_product_cluster_names.end(), val, item);
            }
        }
    }
...
QString OAIGetSKUAltID::asJson() const {
...
QJsonObject OAIGetSKUAltID::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_categories_full_path.size() > 0) {
        obj.insert(QString("CategoriesFullPath"), ::OpenAPI::toJsonValue(m_categories_full_path));
    }
    ...
    if (m_is_direct_category_active_isSet) {
        obj.insert(QString("IsDirectCategoryActive"), ::OpenAPI::toJsonValue(m_is_direct_category_active));
    }
    ...
    if (m_positions_in_clusters.size() > 0) {
        
        obj.insert(QString("PositionsInClusters"), toJsonValue(m_positions_in_clusters));
    }
    ...
    if (m_product_cluster_highlights.size() > 0) {
        
        obj.insert(QString("ProductClusterHighlights"), toJsonValue(m_product_cluster_highlights));
    }
    if (m_product_cluster_names.size() > 0) {
        
        obj.insert(QString("ProductClusterNames"), toJsonValue(m_product_cluster_names));
    }
...
QList<QString> OAIGetSKUAltID::getAlternateIdValues() const {
    return m_alternate_id_values;
}
void OAIGetSKUAltID::setAlternateIdValues(const QList<QString> &alternate_id_values) {
    m_alternate_id_values = alternate_id_values;
    m_alternate_id_values_isSet = true;
}

bool OAIGetSKUAltID::is_alternate_id_values_Set() const{
    return m_alternate_id_values_isSet;
}

bool OAIGetSKUAltID::is_alternate_id_values_Valid() const{
    return m_alternate_id_values_isValid;
}

OAIAlternateIds OAIGetSKUAltID::getAlternateIds() const {
    return m_alternate_ids;
}
void OAIGetSKUAltID::setAlternateIds(const OAIAlternateIds &alternate_ids) {
    m_alternate_ids = alternate_ids;
    m_alternate_ids_isSet = true;
}

bool OAIGetSKUAltID::is_alternate_ids_Set() const{
    return m_alternate_ids_isSet;
}

bool OAIGetSKUAltID::is_alternate_ids_Valid() const{
    return m_alternate_ids_isValid;
}

QList<OAIAttachment> OAIGetSKUAltID::getAttachments() const {
    return m_attachments;
}
void OAIGetSKUAltID::setAttachments(const QList<OAIAttachment> &attachments) {
    m_attachments = attachments;
    m_attachments_isSet = true;
}

bool OAIGetSKUAltID::is_attachments_Set() const{
    return m_attachments_isSet;
}

bool OAIGetSKUAltID::is_attachments_Valid() const{
    return m_attachments_isValid;
}

QString OAIGetSKUAltID::getBrandId() const {
    return m_brand_id;
}
void OAIGetSKUAltID::setBrandId(const QString &brand_id) {
    m_brand_id = brand_id;
    m_brand_id_isSet = true;
}

bool OAIGetSKUAltID::is_brand_id_Set() const{
    return m_brand_id_isSet;
}

bool OAIGetSKUAltID::is_brand_id_Valid() const{
    return m_brand_id_isValid;
}

QString OAIGetSKUAltID::getBrandName() const {
    return m_brand_name;
}
void OAIGetSKUAltID::setBrandName(const QString &brand_name) {
    m_brand_name = brand_name;
    m_brand_name_isSet = true;
}

bool OAIGetSKUAltID::is_brand_name_Set() const{
    return m_brand_name_isSet;
}

bool OAIGetSKUAltID::is_brand_name_Valid() const{
    return m_brand_name_isValid;
}

QString OAIGetSKUAltID::getCscIdentification() const {
    return m_csc_identification;
}
void OAIGetSKUAltID::setCscIdentification(const QString &csc_identification) {
    m_csc_identification = csc_identification;
    m_csc_identification_isSet = true;
}

bool OAIGetSKUAltID::is_csc_identification_Set() const{
    return m_csc_identification_isSet;
}

bool OAIGetSKUAltID::is_csc_identification_Valid() const{
    return m_csc_identification_isValid;
}

QList<QString> OAIGetSKUAltID::getCategories() const {
    return m_categories;
}
void OAIGetSKUAltID::setCategories(const QList<QString> &categories) {
    m_categories = categories;
    m_categories_isSet = true;
}

bool OAIGetSKUAltID::is_categories_Set() const{
    return m_categories_isSet;
}

bool OAIGetSKUAltID::is_categories_Valid() const{
    return m_categories_isValid;
}

QList<QString> OAIGetSKUAltID::getCategoriesFullPath() const {
    return m_categories_full_path;
}
void OAIGetSKUAltID::setCategoriesFullPath(const QList<QString> &categories_full_path) {
    m_categories_full_path = categories_full_path;
    m_categories_full_path_isSet = true;
}

bool OAIGetSKUAltID::is_categories_full_path_Set() const{
    return m_categories_full_path_isSet;
}

bool OAIGetSKUAltID::is_categories_full_path_Valid() const{
    return m_categories_full_path_isValid;
}

QList<QString> OAIGetSKUAltID::getCollections() const {
    return m_collections;
}
void OAIGetSKUAltID::setCollections(const QList<QString> &collections) {
    m_collections = collections;
    m_collections_isSet = true;
}

bool OAIGetSKUAltID::is_collections_Set() const{
    return m_collections_isSet;
}

bool OAIGetSKUAltID::is_collections_Valid() const{
    return m_collections_isValid;
}

qint32 OAIGetSKUAltID::getCommercialConditionId() const {
    return m_commercial_condition_id;
}
void OAIGetSKUAltID::setCommercialConditionId(const qint32 &commercial_condition_id) {
    m_commercial_condition_id = commercial_condition_id;
    m_commercial_condition_id_isSet = true;
}

bool OAIGetSKUAltID::is_commercial_condition_id_Set() const{
    return m_commercial_condition_id_isSet;
}

bool OAIGetSKUAltID::is_commercial_condition_id_Valid() const{
    return m_commercial_condition_id_isValid;
}

QString OAIGetSKUAltID::getComplementName() const {
    return m_complement_name;
}
void OAIGetSKUAltID::setComplementName(const QString &complement_name) {
    m_complement_name = complement_name;
    m_complement_name_isSet = true;
}

bool OAIGetSKUAltID::is_complement_name_Set() const{
    return m_complement_name_isSet;
}

bool OAIGetSKUAltID::is_complement_name_Valid() const{
    return m_complement_name_isValid;
}

QString OAIGetSKUAltID::getDetailUrl() const {
    return m_detail_url;
}
void OAIGetSKUAltID::setDetailUrl(const QString &detail_url) {
    m_detail_url = detail_url;
    m_detail_url_isSet = true;
}

bool OAIGetSKUAltID::is_detail_url_Set() const{
    return m_detail_url_isSet;
}

bool OAIGetSKUAltID::is_detail_url_Valid() const{
    return m_detail_url_isValid;
}

OAIDimension OAIGetSKUAltID::getDimension() const {
    return m_dimension;
}
void OAIGetSKUAltID::setDimension(const OAIDimension &dimension) {
    m_dimension = dimension;
    m_dimension_isSet = true;
}

bool OAIGetSKUAltID::is_dimension_Set() const{
    return m_dimension_isSet;
}

bool OAIGetSKUAltID::is_dimension_Valid() const{
    return m_dimension_isValid;
}

QString OAIGetSKUAltID::getEstimatedDateArrival() const {
    return m_estimated_date_arrival;
}
void OAIGetSKUAltID::setEstimatedDateArrival(const QString &estimated_date_arrival) {
    m_estimated_date_arrival = estimated_date_arrival;
    m_estimated_date_arrival_isSet = true;
}

bool OAIGetSKUAltID::is_estimated_date_arrival_Set() const{
    return m_estimated_date_arrival_isSet;
}

bool OAIGetSKUAltID::is_estimated_date_arrival_Valid() const{
    return m_estimated_date_arrival_isValid;
}

qint32 OAIGetSKUAltID::getId() const {
    return m_id;
}
void OAIGetSKUAltID::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetSKUAltID::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetSKUAltID::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGetSKUAltID::getImageUrl() const {
    return m_image_url;
}
void OAIGetSKUAltID::setImageUrl(const QString &image_url) {
    m_image_url = image_url;
    m_image_url_isSet = true;
}

bool OAIGetSKUAltID::is_image_url_Set() const{
    return m_image_url_isSet;
}

bool OAIGetSKUAltID::is_image_url_Valid() const{
    return m_image_url_isValid;
}

QList<OAIImage> OAIGetSKUAltID::getImages() const {
    return m_images;
}
void OAIGetSKUAltID::setImages(const QList<OAIImage> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAIGetSKUAltID::is_images_Set() const{
    return m_images_isSet;
}

bool OAIGetSKUAltID::is_images_Valid() const{
    return m_images_isValid;
}

QString OAIGetSKUAltID::getInformationSource() const {
    return m_information_source;
}
void OAIGetSKUAltID::setInformationSource(const QString &information_source) {
    m_information_source = information_source;
    m_information_source_isSet = true;
}

bool OAIGetSKUAltID::is_information_source_Set() const{
    return m_information_source_isSet;
}

bool OAIGetSKUAltID::is_information_source_Valid() const{
    return m_information_source_isValid;
}

bool OAIGetSKUAltID::isIsActive() const {
    return m_is_active;
}
void OAIGetSKUAltID::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAIGetSKUAltID::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIGetSKUAltID::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAIGetSKUAltID::isIsDirectCategoryActive() const {
    return m_is_direct_category_active;
}
void OAIGetSKUAltID::setIsDirectCategoryActive(const bool &is_direct_category_active) {
    m_is_direct_category_active = is_direct_category_active;
    m_is_direct_category_active_isSet = true;
}

bool OAIGetSKUAltID::is_is_direct_category_active_Set() const{
    return m_is_direct_category_active_isSet;
}

bool OAIGetSKUAltID::is_is_direct_category_active_Valid() const{
    return m_is_direct_category_active_isValid;
}

bool OAIGetSKUAltID::isIsGiftCardRecharge() const {
    return m_is_gift_card_recharge;
}
void OAIGetSKUAltID::setIsGiftCardRecharge(const bool &is_gift_card_recharge) {
    m_is_gift_card_recharge = is_gift_card_recharge;
    m_is_gift_card_recharge_isSet = true;
}

bool OAIGetSKUAltID::is_is_gift_card_recharge_Set() const{
    return m_is_gift_card_recharge_isSet;
}

bool OAIGetSKUAltID::is_is_gift_card_recharge_Valid() const{
    return m_is_gift_card_recharge_isValid;
}

bool OAIGetSKUAltID::isIsInventoried() const {
    return m_is_inventoried;
}
void OAIGetSKUAltID::setIsInventoried(const bool &is_inventoried) {
    m_is_inventoried = is_inventoried;
    m_is_inventoried_isSet = true;
}

bool OAIGetSKUAltID::is_is_inventoried_Set() const{
    return m_is_inventoried_isSet;
}

bool OAIGetSKUAltID::is_is_inventoried_Valid() const{
    return m_is_inventoried_isValid;
}

bool OAIGetSKUAltID::isIsKit() const {
    return m_is_kit;
}
void OAIGetSKUAltID::setIsKit(const bool &is_kit) {
    m_is_kit = is_kit;
    m_is_kit_isSet = true;
}

bool OAIGetSKUAltID::is_is_kit_Set() const{
    return m_is_kit_isSet;
}

bool OAIGetSKUAltID::is_is_kit_Valid() const{
    return m_is_kit_isValid;
}

bool OAIGetSKUAltID::isIsProductActive() const {
    return m_is_product_active;
}
void OAIGetSKUAltID::setIsProductActive(const bool &is_product_active) {
    m_is_product_active = is_product_active;
    m_is_product_active_isSet = true;
}

bool OAIGetSKUAltID::is_is_product_active_Set() const{
    return m_is_product_active_isSet;
}

bool OAIGetSKUAltID::is_is_product_active_Valid() const{
    return m_is_product_active_isValid;
}

bool OAIGetSKUAltID::isIsTransported() const {
    return m_is_transported;
}
void OAIGetSKUAltID::setIsTransported(const bool &is_transported) {
    m_is_transported = is_transported;
    m_is_transported_isSet = true;
}

bool OAIGetSKUAltID::is_is_transported_Set() const{
    return m_is_transported_isSet;
}

bool OAIGetSKUAltID::is_is_transported_Valid() const{
    return m_is_transported_isValid;
}

QString OAIGetSKUAltID::getKeyWords() const {
    return m_key_words;
}
void OAIGetSKUAltID::setKeyWords(const QString &key_words) {
    m_key_words = key_words;
    m_key_words_isSet = true;
}

bool OAIGetSKUAltID::is_key_words_Set() const{
    return m_key_words_isSet;
}

bool OAIGetSKUAltID::is_key_words_Valid() const{
    return m_key_words_isValid;
}

QList<QString> OAIGetSKUAltID::getKitItems() const {
    return m_kit_items;
}
void OAIGetSKUAltID::setKitItems(const QList<QString> &kit_items) {
    m_kit_items = kit_items;
    m_kit_items_isSet = true;
}

bool OAIGetSKUAltID::is_kit_items_Set() const{
    return m_kit_items_isSet;
}

bool OAIGetSKUAltID::is_kit_items_Valid() const{
    return m_kit_items_isValid;
}

QString OAIGetSKUAltID::getManufacturerCode() const {
    return m_manufacturer_code;
}
void OAIGetSKUAltID::setManufacturerCode(const QString &manufacturer_code) {
    m_manufacturer_code = manufacturer_code;
    m_manufacturer_code_isSet = true;
}

bool OAIGetSKUAltID::is_manufacturer_code_Set() const{
    return m_manufacturer_code_isSet;
}

bool OAIGetSKUAltID::is_manufacturer_code_Valid() const{
    return m_manufacturer_code_isValid;
}

QString OAIGetSKUAltID::getMeasurementUnit() const {
    return m_measurement_unit;
}
void OAIGetSKUAltID::setMeasurementUnit(const QString &measurement_unit) {
    m_measurement_unit = measurement_unit;
    m_measurement_unit_isSet = true;
}

bool OAIGetSKUAltID::is_measurement_unit_Set() const{
    return m_measurement_unit_isSet;
}

bool OAIGetSKUAltID::is_measurement_unit_Valid() const{
    return m_measurement_unit_isValid;
}

QString OAIGetSKUAltID::getModalType() const {
    return m_modal_type;
}
void OAIGetSKUAltID::setModalType(const QString &modal_type) {
    m_modal_type = modal_type;
    m_modal_type_isSet = true;
}

bool OAIGetSKUAltID::is_modal_type_Set() const{
    return m_modal_type_isSet;
}

bool OAIGetSKUAltID::is_modal_type_Valid() const{
    return m_modal_type_isValid;
}

QString OAIGetSKUAltID::getNameComplete() const {
    return m_name_complete;
}
void OAIGetSKUAltID::setNameComplete(const QString &name_complete) {
    m_name_complete = name_complete;
    m_name_complete_isSet = true;
}

bool OAIGetSKUAltID::is_name_complete_Set() const{
    return m_name_complete_isSet;
}

bool OAIGetSKUAltID::is_name_complete_Valid() const{
    return m_name_complete_isValid;
}

QMap<QString, QMap<QString, qint32>> OAIGetSKUAltID::getPositionsInClusters() const {
    return m_positions_in_clusters;
}
void OAIGetSKUAltID::setPositionsInClusters(const QMap<QString, QMap<QString, qint32>> &positions_in_clusters) {
    m_positions_in_clusters = positions_in_clusters;
    m_positions_in_clusters_isSet = true;
}

bool OAIGetSKUAltID::is_positions_in_clusters_Set() const{
    return m_positions_in_clusters_isSet;
}

bool OAIGetSKUAltID::is_positions_in_clusters_Valid() const{
    return m_positions_in_clusters_isValid;
}

QMap<QString, QMap<QString, QString>> OAIGetSKUAltID::getProductCategories() const {
    return m_product_categories;
}
void OAIGetSKUAltID::setProductCategories(const QMap<QString, QMap<QString, QString>> &product_categories) {
    m_product_categories = product_categories;
    m_product_categories_isSet = true;
}

bool OAIGetSKUAltID::is_product_categories_Set() const{
    return m_product_categories_isSet;
}

bool OAIGetSKUAltID::is_product_categories_Valid() const{
    return m_product_categories_isValid;
}

QString OAIGetSKUAltID::getProductCategoryIds() const {
    return m_product_category_ids;
}
void OAIGetSKUAltID::setProductCategoryIds(const QString &product_category_ids) {
    m_product_category_ids = product_category_ids;
    m_product_category_ids_isSet = true;
}

bool OAIGetSKUAltID::is_product_category_ids_Set() const{
    return m_product_category_ids_isSet;
}

bool OAIGetSKUAltID::is_product_category_ids_Valid() const{
    return m_product_category_ids_isValid;
}

QMap<QString, QMap<QString, QString>> OAIGetSKUAltID::getProductClusterHighlights() const {
    return m_product_cluster_highlights;
}
void OAIGetSKUAltID::setProductClusterHighlights(const QMap<QString, QMap<QString, QString>> &product_cluster_highlights) {
    m_product_cluster_highlights = product_cluster_highlights;
    m_product_cluster_highlights_isSet = true;
}

bool OAIGetSKUAltID::is_product_cluster_highlights_Set() const{
    return m_product_cluster_highlights_isSet;
}

bool OAIGetSKUAltID::is_product_cluster_highlights_Valid() const{
    return m_product_cluster_highlights_isValid;
}

QMap<QString, QMap<QString, QString>> OAIGetSKUAltID::getProductClusterNames() const {
    return m_product_cluster_names;
}
void OAIGetSKUAltID::setProductClusterNames(const QMap<QString, QMap<QString, QString>> &product_cluster_names) {
    m_product_cluster_names = product_cluster_names;
    m_product_cluster_names_isSet = true;
}

bool OAIGetSKUAltID::is_product_cluster_names_Set() const{
    return m_product_cluster_names_isSet;
}

bool OAIGetSKUAltID::is_product_cluster_names_Valid() const{
    return m_product_cluster_names_isValid;
}

QString OAIGetSKUAltID::getProductClustersIds() const {
    return m_product_clusters_ids;
}
void OAIGetSKUAltID::setProductClustersIds(const QString &product_clusters_ids) {
    m_product_clusters_ids = product_clusters_ids;
    m_product_clusters_ids_isSet = true;
}

bool OAIGetSKUAltID::is_product_clusters_ids_Set() const{
    return m_product_clusters_ids_isSet;
}

bool OAIGetSKUAltID::is_product_clusters_ids_Valid() const{
    return m_product_clusters_ids_isValid;
}

QString OAIGetSKUAltID::getProductDescription() const {
    return m_product_description;
}
void OAIGetSKUAltID::setProductDescription(const QString &product_description) {
    m_product_description = product_description;
    m_product_description_isSet = true;
}

bool OAIGetSKUAltID::is_product_description_Set() const{
    return m_product_description_isSet;
}

bool OAIGetSKUAltID::is_product_description_Valid() const{
    return m_product_description_isValid;
}

qint32 OAIGetSKUAltID::getProductFinalScore() const {
    return m_product_final_score;
}
void OAIGetSKUAltID::setProductFinalScore(const qint32 &product_final_score) {
    m_product_final_score = product_final_score;
    m_product_final_score_isSet = true;
}

bool OAIGetSKUAltID::is_product_final_score_Set() const{
    return m_product_final_score_isSet;
}

bool OAIGetSKUAltID::is_product_final_score_Valid() const{
    return m_product_final_score_isValid;
}

qint32 OAIGetSKUAltID::getProductGlobalCategoryId() const {
    return m_product_global_category_id;
}
void OAIGetSKUAltID::setProductGlobalCategoryId(const qint32 &product_global_category_id) {
    m_product_global_category_id = product_global_category_id;
    m_product_global_category_id_isSet = true;
}

bool OAIGetSKUAltID::is_product_global_category_id_Set() const{
    return m_product_global_category_id_isSet;
}

bool OAIGetSKUAltID::is_product_global_category_id_Valid() const{
    return m_product_global_category_id_isValid;
}

qint32 OAIGetSKUAltID::getProductId() const {
    return m_product_id;
}
void OAIGetSKUAltID::setProductId(const qint32 &product_id) {
    m_product_id = product_id;
    m_product_id_isSet = true;
}

bool OAIGetSKUAltID::is_product_id_Set() const{
    return m_product_id_isSet;
}

bool OAIGetSKUAltID::is_product_id_Valid() const{
    return m_product_id_isValid;
}

bool OAIGetSKUAltID::isProductIsVisible() const {
    return m_product_is_visible;
}
void OAIGetSKUAltID::setProductIsVisible(const bool &product_is_visible) {
    m_product_is_visible = product_is_visible;
    m_product_is_visible_isSet = true;
}

bool OAIGetSKUAltID::is_product_is_visible_Set() const{
    return m_product_is_visible_isSet;
}

bool OAIGetSKUAltID::is_product_is_visible_Valid() const{
    return m_product_is_visible_isValid;
}

QString OAIGetSKUAltID::getProductName() const {
    return m_product_name;
}
void OAIGetSKUAltID::setProductName(const QString &product_name) {
    m_product_name = product_name;
    m_product_name_isSet = true;
}

bool OAIGetSKUAltID::is_product_name_Set() const{
    return m_product_name_isSet;
}

bool OAIGetSKUAltID::is_product_name_Valid() const{
    return m_product_name_isValid;
}

QString OAIGetSKUAltID::getProductRefId() const {
    return m_product_ref_id;
}
void OAIGetSKUAltID::setProductRefId(const QString &product_ref_id) {
    m_product_ref_id = product_ref_id;
    m_product_ref_id_isSet = true;
}

bool OAIGetSKUAltID::is_product_ref_id_Set() const{
    return m_product_ref_id_isSet;
}

bool OAIGetSKUAltID::is_product_ref_id_Valid() const{
    return m_product_ref_id_isValid;
}

QList<OAIProductSpecification> OAIGetSKUAltID::getProductSpecifications() const {
    return m_product_specifications;
}
void OAIGetSKUAltID::setProductSpecifications(const QList<OAIProductSpecification> &product_specifications) {
    m_product_specifications = product_specifications;
    m_product_specifications_isSet = true;
}

bool OAIGetSKUAltID::is_product_specifications_Set() const{
    return m_product_specifications_isSet;
}

bool OAIGetSKUAltID::is_product_specifications_Valid() const{
    return m_product_specifications_isValid;
}

OAIRealDimension OAIGetSKUAltID::getRealDimension() const {
    return m_real_dimension;
}
void OAIGetSKUAltID::setRealDimension(const OAIRealDimension &real_dimension) {
    m_real_dimension = real_dimension;
    m_real_dimension_isSet = true;
}

bool OAIGetSKUAltID::is_real_dimension_Set() const{
    return m_real_dimension_isSet;
}

bool OAIGetSKUAltID::is_real_dimension_Valid() const{
    return m_real_dimension_isValid;
}

QString OAIGetSKUAltID::getReleaseDate() const {
    return m_release_date;
}
void OAIGetSKUAltID::setReleaseDate(const QString &release_date) {
    m_release_date = release_date;
    m_release_date_isSet = true;
}

bool OAIGetSKUAltID::is_release_date_Set() const{
    return m_release_date_isSet;
}

bool OAIGetSKUAltID::is_release_date_Valid() const{
    return m_release_date_isValid;
}

double OAIGetSKUAltID::getRewardValue() const {
    return m_reward_value;
}
void OAIGetSKUAltID::setRewardValue(const double &reward_value) {
    m_reward_value = reward_value;
    m_reward_value_isSet = true;
}

bool OAIGetSKUAltID::is_reward_value_Set() const{
    return m_reward_value_isSet;
}

bool OAIGetSKUAltID::is_reward_value_Valid() const{
    return m_reward_value_isValid;
}

QList<qint32> OAIGetSKUAltID::getSalesChannels() const {
    return m_sales_channels;
}
void OAIGetSKUAltID::setSalesChannels(const QList<qint32> &sales_channels) {
    m_sales_channels = sales_channels;
    m_sales_channels_isSet = true;
}

bool OAIGetSKUAltID::is_sales_channels_Set() const{
    return m_sales_channels_isSet;
}

bool OAIGetSKUAltID::is_sales_channels_Valid() const{
    return m_sales_channels_isValid;
}

QList<QString> OAIGetSKUAltID::getServices() const {
    return m_services;
}
void OAIGetSKUAltID::setServices(const QList<QString> &services) {
    m_services = services;
    m_services_isSet = true;
}

bool OAIGetSKUAltID::is_services_Set() const{
    return m_services_isSet;
}

bool OAIGetSKUAltID::is_services_Valid() const{
    return m_services_isValid;
}

bool OAIGetSKUAltID::isShowIfNotAvailable() const {
    return m_show_if_not_available;
}
void OAIGetSKUAltID::setShowIfNotAvailable(const bool &show_if_not_available) {
    m_show_if_not_available = show_if_not_available;
    m_show_if_not_available_isSet = true;
}

bool OAIGetSKUAltID::is_show_if_not_available_Set() const{
    return m_show_if_not_available_isSet;
}

bool OAIGetSKUAltID::is_show_if_not_available_Valid() const{
    return m_show_if_not_available_isValid;
}

QString OAIGetSKUAltID::getSkuName() const {
    return m_sku_name;
}
void OAIGetSKUAltID::setSkuName(const QString &sku_name) {
    m_sku_name = sku_name;
    m_sku_name_isSet = true;
}

bool OAIGetSKUAltID::is_sku_name_Set() const{
    return m_sku_name_isSet;
}

bool OAIGetSKUAltID::is_sku_name_Valid() const{
    return m_sku_name_isValid;
}

QList<OAISkuSeller> OAIGetSKUAltID::getSkuSellers() const {
    return m_sku_sellers;
}
void OAIGetSKUAltID::setSkuSellers(const QList<OAISkuSeller> &sku_sellers) {
    m_sku_sellers = sku_sellers;
    m_sku_sellers_isSet = true;
}

bool OAIGetSKUAltID::is_sku_sellers_Set() const{
    return m_sku_sellers_isSet;
}

bool OAIGetSKUAltID::is_sku_sellers_Valid() const{
    return m_sku_sellers_isValid;
}

QList<OAISkuSpecification> OAIGetSKUAltID::getSkuSpecifications() const {
    return m_sku_specifications;
}
void OAIGetSKUAltID::setSkuSpecifications(const QList<OAISkuSpecification> &sku_specifications) {
    m_sku_specifications = sku_specifications;
    m_sku_specifications_isSet = true;
}

bool OAIGetSKUAltID::is_sku_specifications_Set() const{
    return m_sku_specifications_isSet;
}

bool OAIGetSKUAltID::is_sku_specifications_Valid() const{
    return m_sku_specifications_isValid;
}

QString OAIGetSKUAltID::getTaxCode() const {
    return m_tax_code;
}
void OAIGetSKUAltID::setTaxCode(const QString &tax_code) {
    m_tax_code = tax_code;
    m_tax_code_isSet = true;
}

bool OAIGetSKUAltID::is_tax_code_Set() const{
    return m_tax_code_isSet;
}

bool OAIGetSKUAltID::is_tax_code_Valid() const{
    return m_tax_code_isValid;
}

double OAIGetSKUAltID::getUnitMultiplier() const {
    return m_unit_multiplier;
}
void OAIGetSKUAltID::setUnitMultiplier(const double &unit_multiplier) {
    m_unit_multiplier = unit_multiplier;
    m_unit_multiplier_isSet = true;
}

bool OAIGetSKUAltID::is_unit_multiplier_Set() const{
    return m_unit_multiplier_isSet;
}

bool OAIGetSKUAltID::is_unit_multiplier_Valid() const{
    return m_unit_multiplier_isValid;
}

bool OAIGetSKUAltID::isSet() const {
...
bool OAIGetSKUAltID::isValid() const {
