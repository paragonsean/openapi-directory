...
#ifndef OAIRequest_body_8_H
#define OAIRequest_body_8_H
...
class OAIRequest_body_8 : public OAIObject {
public:
    OAIRequest_body_8();
    OAIRequest_body_8(QString json);
    ~OAIRequest_body_8() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequest_body_8)

#endif // OAIRequest_body_8_H
