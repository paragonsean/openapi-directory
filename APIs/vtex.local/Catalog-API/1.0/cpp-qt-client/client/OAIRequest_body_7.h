...
#ifndef OAIRequest_body_7_H
#define OAIRequest_body_7_H
...
class OAIRequest_body_7 : public OAIObject {
public:
    OAIRequest_body_7();
    OAIRequest_body_7(QString json);
    ~OAIRequest_body_7() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequest_body_7)

#endif // OAIRequest_body_7_H
