...
#ifndef OAIResquest_body_H
#define OAIResquest_body_H
...
class OAIResquest_body : public OAIObject {
public:
    OAIResquest_body();
    OAIResquest_body(QString json);
    ~OAIResquest_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResquest_body)

#endif // OAIResquest_body_H
