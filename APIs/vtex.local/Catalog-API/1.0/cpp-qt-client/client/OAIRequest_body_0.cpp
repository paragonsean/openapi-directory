...
QString OAIRequest_body::getDateFrom() const {
    return m_date_from;
}
void OAIRequest_body::setDateFrom(const QString &date_from) {
    m_date_from = date_from;
    m_date_from_isSet = true;
}

bool OAIRequest_body::is_date_from_Set() const{
    return m_date_from_isSet;
}

bool OAIRequest_body::is_date_from_Valid() const{
    return m_date_from_isValid;
}

QString OAIRequest_body::getDateTo() const {
    return m_date_to;
}
void OAIRequest_body::setDateTo(const QString &date_to) {
    m_date_to = date_to;
    m_date_to_isSet = true;
}

bool OAIRequest_body::is_date_to_Set() const{
    return m_date_to_isSet;
}

bool OAIRequest_body::is_date_to_Valid() const{
    return m_date_to_isValid;
}

QString OAIRequest_body::getDescription() const {
    return m_description;
}
void OAIRequest_body::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIRequest_body::is_description_Set() const{
    return m_description_isSet;
}

bool OAIRequest_body::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIRequest_body::isHighlight() const {
    return m_highlight;
}
void OAIRequest_body::setHighlight(const bool &highlight) {
    m_highlight = highlight;
    m_highlight_isSet = true;
}

bool OAIRequest_body::is_highlight_Set() const{
    return m_highlight_isSet;
}

bool OAIRequest_body::is_highlight_Valid() const{
...
bool OAIRequest_body::isSearchable() const {
    return m_searchable;
}
void OAIRequest_body::setSearchable(const bool &searchable) {
    m_searchable = searchable;
    m_searchable_isSet = true;
}

bool OAIRequest_body::is_searchable_Set() const{
    return m_searchable_isSet;
}

bool OAIRequest_body::is_searchable_Valid() const{
...
bool OAIRequest_body::isValid() const {
    ...
    return m_date_from_isValid && m_date_to_isValid && m_description_isValid && m_highlight_isValid && m_name_isValid && m_searchable_isValid && true;
}
