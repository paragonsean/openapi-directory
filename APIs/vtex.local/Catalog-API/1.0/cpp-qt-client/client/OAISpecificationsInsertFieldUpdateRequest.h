...
/*
 * OAISpecificationsInsertFieldUpdateRequest.h
 *
 * 
 */

#ifndef OAISpecificationsInsertFieldUpdateRequest_H
#define OAISpecificationsInsertFieldUpdateRequest_H
...
class OAISpecificationsInsertFieldUpdateRequest : public OAIObject {
public:
    OAISpecificationsInsertFieldUpdateRequest();
    OAISpecificationsInsertFieldUpdateRequest(QString json);
    ~OAISpecificationsInsertFieldUpdateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISpecificationsInsertFieldUpdateRequest)

#endif // OAISpecificationsInsertFieldUpdateRequest_H
