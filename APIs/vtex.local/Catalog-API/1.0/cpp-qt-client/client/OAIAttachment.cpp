...
bool OAIAttachment::isIsActive() const {
    return m_is_active;
}
void OAIAttachment::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAIAttachment::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIAttachment::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAIAttachment::isIsRequired() const {
    return m_is_required;
}
void OAIAttachment::setIsRequired(const bool &is_required) {
    m_is_required = is_required;
    m_is_required_isSet = true;
}

bool OAIAttachment::is_is_required_Set() const{
    return m_is_required_isSet;
}

bool OAIAttachment::is_is_required_Valid() const{
    return m_is_required_isValid;
}

QList<QString> OAIAttachment::getKeys() const {
    return m_keys;
}
void OAIAttachment::setKeys(const QList<QString> &keys) {
    m_keys = keys;
    m_keys_isSet = true;
}

bool OAIAttachment::is_keys_Set() const{
    return m_keys_isSet;
}

bool OAIAttachment::is_keys_Valid() const{
...
bool OAIAttachment::isValid() const {
    ...
    return m_fields_isValid && m_id_isValid && m_is_active_isValid && m_is_required_isValid && m_keys_isValid && m_name_isValid && true;
}
