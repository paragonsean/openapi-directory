...
/*
 * OAICategorySpecification_inner.h
 *
 * Object containing Specification information.
 */

#ifndef OAICategorySpecification_inner_H
#define OAICategorySpecification_inner_H
...
class OAICategorySpecification_inner : public OAIObject {
public:
    OAICategorySpecification_inner();
    OAICategorySpecification_inner(QString json);
    ~OAICategorySpecification_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICategorySpecification_inner)

#endif // OAICategorySpecification_inner_H
