...
qint32 OAIImage::getFileId() const {
    return m_file_id;
}
void OAIImage::setFileId(const qint32 &file_id) {
    m_file_id = file_id;
    m_file_id_isSet = true;
}

bool OAIImage::is_file_id_Set() const{
    return m_file_id_isSet;
}

bool OAIImage::is_file_id_Valid() const{
...
bool OAIImage::isValid() const {
    ...
    return m_file_id_isValid && m_image_name_isValid && m_image_url_isValid && true;
}
