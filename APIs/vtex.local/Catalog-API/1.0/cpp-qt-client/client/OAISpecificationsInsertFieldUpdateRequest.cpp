...
#include "OAISpecificationsInsertFieldUpdateRequest.h"
...
OAISpecificationsInsertFieldUpdateRequest::OAISpecificationsInsertFieldUpdateRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISpecificationsInsertFieldUpdateRequest::OAISpecificationsInsertFieldUpdateRequest() {
    this->initializeModel();
}

OAISpecificationsInsertFieldUpdateRequest::~OAISpecificationsInsertFieldUpdateRequest() {}

void OAISpecificationsInsertFieldUpdateRequest::initializeModel() {
...
void OAISpecificationsInsertFieldUpdateRequest::fromJson(QString jsonString) {
...
void OAISpecificationsInsertFieldUpdateRequest::fromJsonObject(QJsonObject json) {
...
QString OAISpecificationsInsertFieldUpdateRequest::asJson() const {
...
QJsonObject OAISpecificationsInsertFieldUpdateRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAISpecificationsInsertFieldUpdateRequest::getCategoryId() const {
    return m_category_id;
}
void OAISpecificationsInsertFieldUpdateRequest::setCategoryId(const qint32 &category_id) {
    m_category_id = category_id;
    m_category_id_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_category_id_Set() const{
    return m_category_id_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_category_id_Valid() const{
    return m_category_id_isValid;
}

QString OAISpecificationsInsertFieldUpdateRequest::getDefaultValue() const {
    return m_default_value;
}
void OAISpecificationsInsertFieldUpdateRequest::setDefaultValue(const QString &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAISpecificationsInsertFieldUpdateRequest::getDescription() const {
    return m_description;
}
void OAISpecificationsInsertFieldUpdateRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAISpecificationsInsertFieldUpdateRequest::getFieldGroupId() const {
    return m_field_group_id;
}
void OAISpecificationsInsertFieldUpdateRequest::setFieldGroupId(const qint32 &field_group_id) {
    m_field_group_id = field_group_id;
    m_field_group_id_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_field_group_id_Set() const{
    return m_field_group_id_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_field_group_id_Valid() const{
    return m_field_group_id_isValid;
}

QString OAISpecificationsInsertFieldUpdateRequest::getFieldGroupName() const {
    return m_field_group_name;
}
void OAISpecificationsInsertFieldUpdateRequest::setFieldGroupName(const QString &field_group_name) {
    m_field_group_name = field_group_name;
    m_field_group_name_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_field_group_name_Set() const{
    return m_field_group_name_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_field_group_name_Valid() const{
    return m_field_group_name_isValid;
}

qint32 OAISpecificationsInsertFieldUpdateRequest::getFieldId() const {
    return m_field_id;
}
void OAISpecificationsInsertFieldUpdateRequest::setFieldId(const qint32 &field_id) {
    m_field_id = field_id;
    m_field_id_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_field_id_Set() const{
    return m_field_id_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_field_id_Valid() const{
    return m_field_id_isValid;
}

qint32 OAISpecificationsInsertFieldUpdateRequest::getFieldTypeId() const {
    return m_field_type_id;
}
void OAISpecificationsInsertFieldUpdateRequest::setFieldTypeId(const qint32 &field_type_id) {
    m_field_type_id = field_type_id;
    m_field_type_id_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_field_type_id_Set() const{
    return m_field_type_id_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_field_type_id_Valid() const{
    return m_field_type_id_isValid;
}

qint32 OAISpecificationsInsertFieldUpdateRequest::getFieldValueId() const {
    return m_field_value_id;
}
void OAISpecificationsInsertFieldUpdateRequest::setFieldValueId(const qint32 &field_value_id) {
    m_field_value_id = field_value_id;
    m_field_value_id_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_field_value_id_Set() const{
    return m_field_value_id_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_field_value_id_Valid() const{
    return m_field_value_id_isValid;
}

bool OAISpecificationsInsertFieldUpdateRequest::isIsActive() const {
    return m_is_active;
}
void OAISpecificationsInsertFieldUpdateRequest::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAISpecificationsInsertFieldUpdateRequest::isIsFilter() const {
    return m_is_filter;
}
void OAISpecificationsInsertFieldUpdateRequest::setIsFilter(const bool &is_filter) {
    m_is_filter = is_filter;
    m_is_filter_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_filter_Set() const{
    return m_is_filter_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_filter_Valid() const{
    return m_is_filter_isValid;
}

bool OAISpecificationsInsertFieldUpdateRequest::isIsOnProductDetails() const {
    return m_is_on_product_details;
}
void OAISpecificationsInsertFieldUpdateRequest::setIsOnProductDetails(const bool &is_on_product_details) {
    m_is_on_product_details = is_on_product_details;
    m_is_on_product_details_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_on_product_details_Set() const{
    return m_is_on_product_details_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_on_product_details_Valid() const{
    return m_is_on_product_details_isValid;
}

bool OAISpecificationsInsertFieldUpdateRequest::isIsRequired() const {
    return m_is_required;
}
void OAISpecificationsInsertFieldUpdateRequest::setIsRequired(const bool &is_required) {
    m_is_required = is_required;
    m_is_required_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_required_Set() const{
    return m_is_required_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_required_Valid() const{
    return m_is_required_isValid;
}

bool OAISpecificationsInsertFieldUpdateRequest::isIsSideMenuLinkActive() const {
    return m_is_side_menu_link_active;
}
void OAISpecificationsInsertFieldUpdateRequest::setIsSideMenuLinkActive(const bool &is_side_menu_link_active) {
    m_is_side_menu_link_active = is_side_menu_link_active;
    m_is_side_menu_link_active_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_side_menu_link_active_Set() const{
    return m_is_side_menu_link_active_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_side_menu_link_active_Valid() const{
    return m_is_side_menu_link_active_isValid;
}

bool OAISpecificationsInsertFieldUpdateRequest::isIsStockKeepingUnit() const {
    return m_is_stock_keeping_unit;
}
void OAISpecificationsInsertFieldUpdateRequest::setIsStockKeepingUnit(const bool &is_stock_keeping_unit) {
    m_is_stock_keeping_unit = is_stock_keeping_unit;
    m_is_stock_keeping_unit_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_stock_keeping_unit_Set() const{
    return m_is_stock_keeping_unit_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_stock_keeping_unit_Valid() const{
    return m_is_stock_keeping_unit_isValid;
}

bool OAISpecificationsInsertFieldUpdateRequest::isIsTopMenuLinkActive() const {
    return m_is_top_menu_link_active;
}
void OAISpecificationsInsertFieldUpdateRequest::setIsTopMenuLinkActive(const bool &is_top_menu_link_active) {
    m_is_top_menu_link_active = is_top_menu_link_active;
    m_is_top_menu_link_active_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_top_menu_link_active_Set() const{
    return m_is_top_menu_link_active_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_top_menu_link_active_Valid() const{
    return m_is_top_menu_link_active_isValid;
}

bool OAISpecificationsInsertFieldUpdateRequest::isIsWizard() const {
    return m_is_wizard;
}
void OAISpecificationsInsertFieldUpdateRequest::setIsWizard(const bool &is_wizard) {
    m_is_wizard = is_wizard;
    m_is_wizard_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_wizard_Set() const{
    return m_is_wizard_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_is_wizard_Valid() const{
    return m_is_wizard_isValid;
}

QString OAISpecificationsInsertFieldUpdateRequest::getName() const {
    return m_name;
}
void OAISpecificationsInsertFieldUpdateRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAISpecificationsInsertFieldUpdateRequest::getPosition() const {
    return m_position;
}
void OAISpecificationsInsertFieldUpdateRequest::setPosition(const qint32 &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_position_Set() const{
    return m_position_isSet;
}

bool OAISpecificationsInsertFieldUpdateRequest::is_position_Valid() const{
    return m_position_isValid;
}

bool OAISpecificationsInsertFieldUpdateRequest::isSet() const {
