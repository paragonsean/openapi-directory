...
/*
 * OAISKUSpecificationResponse.h
 *
 * 
 */

#ifndef OAISKUSpecificationResponse_H
#define OAISKUSpecificationResponse_H
...
class OAISKUSpecificationResponse : public OAIObject {
public:
    OAISKUSpecificationResponse();
    OAISKUSpecificationResponse(QString json);
    ~OAISKUSpecificationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISKUSpecificationResponse)

#endif // OAISKUSpecificationResponse_H
