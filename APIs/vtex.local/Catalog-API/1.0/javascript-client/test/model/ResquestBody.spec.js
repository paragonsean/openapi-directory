...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.ResquestBody();
  });
  ...
  describe('ResquestBody', function() {
    it('should create an instance of ResquestBody', function() {
      // uncomment below and update the code to test ResquestBody
      //var instance = new CatalogApi.ResquestBody();
      //expect(instance).to.be.a(CatalogApi.ResquestBody);
    });
