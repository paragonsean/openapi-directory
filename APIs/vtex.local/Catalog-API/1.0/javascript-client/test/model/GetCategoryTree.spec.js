...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.GetCategoryTree();
  });
  ...
  describe('GetCategoryTree', function() {
    it('should create an instance of GetCategoryTree', function() {
      // uncomment below and update the code to test GetCategoryTree
      //var instance = new CatalogApi.GetCategoryTree();
      //expect(instance).to.be.a(CatalogApi.GetCategoryTree);
    });
