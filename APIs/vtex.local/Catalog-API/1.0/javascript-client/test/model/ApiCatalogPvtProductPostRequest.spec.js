...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.ApiCatalogPvtProductPostRequest();
  });
  ...
  describe('ApiCatalogPvtProductPostRequest', function() {
    it('should create an instance of ApiCatalogPvtProductPostRequest', function() {
      // uncomment below and update the code to test ApiCatalogPvtProductPostRequest
      //var instance = new CatalogApi.ApiCatalogPvtProductPostRequest();
      //expect(instance).to.be.a(CatalogApi.ApiCatalogPvtProductPostRequest);
    });
