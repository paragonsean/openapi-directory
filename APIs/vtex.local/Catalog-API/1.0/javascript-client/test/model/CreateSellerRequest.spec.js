...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.CreateSellerRequest();
  });
  ...
  describe('CreateSellerRequest', function() {
    it('should create an instance of CreateSellerRequest', function() {
      // uncomment below and update the code to test CreateSellerRequest
      //var instance = new CatalogApi.CreateSellerRequest();
      //expect(instance).to.be.a(CatalogApi.CreateSellerRequest);
    });

    it('should have the property archiveId (base name: "ArchiveId")', function() {
    ...
    it('should have the property categoryCommissionPercentage (base name: "CategoryCommissionPercentage")', function() {
      // uncomment below and update the code to test the property categoryCommissionPercentage
      //var instance = new CatalogApi.CreateSellerRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property secutityPrivacyPolicy (base name: "SecutityPrivacyPolicy")', function() {
      // uncomment below and update the code to test the property secutityPrivacyPolicy
      //var instance = new CatalogApi.CreateSellerRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property urlLogo (base name: "UrlLogo")', function() {
      // uncomment below and update the code to test the property urlLogo
      //var instance = new CatalogApi.CreateSellerRequest();
      //expect(instance).to.be();
    });

    it('should have the property useHybridPaymentOptions (base name: "UseHybridPaymentOptions")', function() {
      // uncomment below and update the code to test the property useHybridPaymentOptions
      //var instance = new CatalogApi.CreateSellerRequest();
      //expect(instance).to.be();
    });
