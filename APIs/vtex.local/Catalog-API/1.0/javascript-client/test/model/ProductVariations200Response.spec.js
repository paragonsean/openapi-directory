...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.ProductVariations200Response();
  });
  ...
  describe('ProductVariations200Response', function() {
    it('should create an instance of ProductVariations200Response', function() {
      // uncomment below and update the code to test ProductVariations200Response
      //var instance = new CatalogApi.ProductVariations200Response();
      //expect(instance).to.be.a(CatalogApi.ProductVariations200Response);
    });
    ...
    it('should have the property dimensionsInputType (base name: "dimensionsInputType")', function() {
      // uncomment below and update the code to test the property dimensionsInputType
      //var instance = new CatalogApi.ProductVariations200Response();
      //expect(instance).to.be();
    });

    it('should have the property dimensionsMap (base name: "dimensionsMap")', function() {
      // uncomment below and update the code to test the property dimensionsMap
      //var instance = new CatalogApi.ProductVariations200Response();
      //expect(instance).to.be();
    });
