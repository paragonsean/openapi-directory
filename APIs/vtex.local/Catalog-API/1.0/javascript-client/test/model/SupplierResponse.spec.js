...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.SupplierResponse();
  });
  ...
  describe('SupplierResponse', function() {
    it('should create an instance of SupplierResponse', function() {
      // uncomment below and update the code to test SupplierResponse
      //var instance = new CatalogApi.SupplierResponse();
      //expect(instance).to.be.a(CatalogApi.SupplierResponse);
    });
    ...
    it('should have the property corportePhone (base name: "CorportePhone")', function() {
      // uncomment below and update the code to test the property corportePhone
      //var instance = new CatalogApi.SupplierResponse();
      //expect(instance).to.be();
    });
