...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.ProductVariations200ResponseSkusInner();
  });
  ...
  describe('ProductVariations200ResponseSkusInner', function() {
    it('should create an instance of ProductVariations200ResponseSkusInner', function() {
      // uncomment below and update the code to test ProductVariations200ResponseSkusInner
      //var instance = new CatalogApi.ProductVariations200ResponseSkusInner();
      //expect(instance).to.be.a(CatalogApi.ProductVariations200ResponseSkusInner);
    });
    ...
    it('should have the property bestPrice (base name: "bestPrice")', function() {
      // uncomment below and update the code to test the property bestPrice
      //var instance = new CatalogApi.ProductVariations200ResponseSkusInner();
      //expect(instance).to.be();
    });

    it('should have the property bestPriceFormated (base name: "bestPriceFormated")', function() {
      // uncomment below and update the code to test the property bestPriceFormated
      //var instance = new CatalogApi.ProductVariations200ResponseSkusInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property installmentsInsterestRate (base name: "installmentsInsterestRate")', function() {
      // uncomment below and update the code to test the property installmentsInsterestRate
      //var instance = new CatalogApi.ProductVariations200ResponseSkusInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property listPriceFormated (base name: "listPriceFormated")', function() {
      // uncomment below and update the code to test the property listPriceFormated
      //var instance = new CatalogApi.ProductVariations200ResponseSkusInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property taxAsInt (base name: "taxAsInt")', function() {
      // uncomment below and update the code to test the property taxAsInt
      //var instance = new CatalogApi.ProductVariations200ResponseSkusInner();
      //expect(instance).to.be();
    });

    it('should have the property taxFormated (base name: "taxFormated")', function() {
      // uncomment below and update the code to test the property taxFormated
      //var instance = new CatalogApi.ProductVariations200ResponseSkusInner();
      //expect(instance).to.be();
    });
