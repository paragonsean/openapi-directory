...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.ProductSpecification();
  });
  ...
  describe('ProductSpecification', function() {
    it('should create an instance of ProductSpecification', function() {
      // uncomment below and update the code to test ProductSpecification
      //var instance = new CatalogApi.ProductSpecification();
      //expect(instance).to.be.a(CatalogApi.ProductSpecification);
    });
    ...
    it('should have the property fieldValueIds (base name: "FieldValueIds")', function() {
      // uncomment below and update the code to test the property fieldValueIds
      //var instance = new CatalogApi.ProductSpecification();
      //expect(instance).to.be();
    });
