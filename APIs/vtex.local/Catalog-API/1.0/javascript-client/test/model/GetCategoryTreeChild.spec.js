...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.GetCategoryTreeChild();
  });
  ...
  describe('GetCategoryTreeChild', function() {
    it('should create an instance of GetCategoryTreeChild', function() {
      // uncomment below and update the code to test GetCategoryTreeChild
      //var instance = new CatalogApi.GetCategoryTreeChild();
      //expect(instance).to.be.a(CatalogApi.GetCategoryTreeChild);
    });
