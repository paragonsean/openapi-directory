...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.SupplierRequest();
  });
  ...
  describe('SupplierRequest', function() {
    it('should create an instance of SupplierRequest', function() {
      // uncomment below and update the code to test SupplierRequest
      //var instance = new CatalogApi.SupplierRequest();
      //expect(instance).to.be.a(CatalogApi.SupplierRequest);
    });
