...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.UpdateSellerRequest();
  });
  ...
  describe('UpdateSellerRequest', function() {
    it('should create an instance of UpdateSellerRequest', function() {
      // uncomment below and update the code to test UpdateSellerRequest
      //var instance = new CatalogApi.UpdateSellerRequest();
      //expect(instance).to.be.a(CatalogApi.UpdateSellerRequest);
    });
