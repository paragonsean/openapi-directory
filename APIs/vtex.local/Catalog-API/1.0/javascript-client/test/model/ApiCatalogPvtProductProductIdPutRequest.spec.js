...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.ApiCatalogPvtProductProductIdPutRequest();
  });
  ...
  describe('ApiCatalogPvtProductProductIdPutRequest', function() {
    it('should create an instance of ApiCatalogPvtProductProductIdPutRequest', function() {
      // uncomment below and update the code to test ApiCatalogPvtProductProductIdPutRequest
      //var instance = new CatalogApi.ApiCatalogPvtProductProductIdPutRequest();
      //expect(instance).to.be.a(CatalogApi.ApiCatalogPvtProductProductIdPutRequest);
    });
