...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.ProductandTradePolicy200Response();
  });
  ...
  describe('ProductandTradePolicy200Response', function() {
    it('should create an instance of ProductandTradePolicy200Response', function() {
      // uncomment below and update the code to test ProductandTradePolicy200Response
      //var instance = new CatalogApi.ProductandTradePolicy200Response();
      //expect(instance).to.be.a(CatalogApi.ProductandTradePolicy200Response);
    });

    it('should have the property adWordsRemarketingCode (base name: "AdWordsRemarketingCode")', function() {
      // uncomment below and update the code to test the property adWordsRemarketingCode
      //var instance = new CatalogApi.ProductandTradePolicy200Response();
    ...
    it('should have the property listStoreId (base name: "ListStoreId")', function() {
      // uncomment below and update the code to test the property listStoreId
      //var instance = new CatalogApi.ProductandTradePolicy200Response();
      //expect(instance).to.be();
    });

    it('should have the property lomadeeCampaignCode (base name: "LomadeeCampaignCode")', function() {
      // uncomment below and update the code to test the property lomadeeCampaignCode
      //var instance = new CatalogApi.ProductandTradePolicy200Response();
      //expect(instance).to.be();
    });
    ...
    it('should have the property showWithoutStock (base name: "ShowWithoutStock")', function() {
      // uncomment below and update the code to test the property showWithoutStock
      //var instance = new CatalogApi.ProductandTradePolicy200Response();
      //expect(instance).to.be();
    });
