...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.AlternateIds();
  });
  ...
  describe('AlternateIds', function() {
    it('should create an instance of AlternateIds', function() {
      // uncomment below and update the code to test AlternateIds
      //var instance = new CatalogApi.AlternateIds();
      //expect(instance).to.be.a(CatalogApi.AlternateIds);
    });
