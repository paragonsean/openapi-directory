...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApi.ResquestBody1();
  });
  ...
  describe('ResquestBody1', function() {
    it('should create an instance of ResquestBody1', function() {
      // uncomment below and update the code to test ResquestBody1
      //var instance = new CatalogApi.ResquestBody1();
      //expect(instance).to.be.a(CatalogApi.ResquestBody1);
    });
