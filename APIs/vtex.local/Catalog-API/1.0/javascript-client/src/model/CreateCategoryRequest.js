...
class CreateCategoryRequest {
    ...
    constructor(activeStoreFrontLink, adWordsRemarketingCode, description, fatherCategoryId, globalCategoryId, isActive, keywords, lomadeeCampaignCode, name, score, showBrandFilter, showInStoreFront, stockKeepingUnitSelectionMode, title) { 
        ...
        CreateCategoryRequest.initialize(this, activeStoreFrontLink, adWordsRemarketingCode, description, fatherCategoryId, globalCategoryId, isActive, keywords, lomadeeCampaignCode, name, score, showBrandFilter, showInStoreFront, stockKeepingUnitSelectionMode, title);
    }
...
CreateCategoryRequest.RequiredProperties = ["ActiveStoreFrontLink", "AdWordsRemarketingCode", "Description", "FatherCategoryId", "GlobalCategoryId", "IsActive", "Keywords", "LomadeeCampaignCode", "Name", "Score", "ShowBrandFilter", "ShowInStoreFront", "StockKeepingUnitSelectionMode", "Title"];

/**
 * If true, the Category link becomes active in store.
 * @member {Boolean} ActiveStoreFrontLink
 */
CreateCategoryRequest.prototype['ActiveStoreFrontLink'] = undefined;

/**
 * This is a legacy field. Do not take this information into consideration.
 * @member {String} AdWordsRemarketingCode
 */
CreateCategoryRequest.prototype['AdWordsRemarketingCode'] = undefined;

/**
 * Text used in meta description tag for Category page.
 * @member {String} Description
 */
CreateCategoryRequest.prototype['Description'] = undefined;

/**
 * ID of the parent category, apply in case of category and subcategory.
 * @member {Number} FatherCategoryId
 */
CreateCategoryRequest.prototype['FatherCategoryId'] = undefined;

/**
 * Google Global Category ID.
 * @member {Number} GlobalCategoryId
 */
CreateCategoryRequest.prototype['GlobalCategoryId'] = undefined;

/**
 * Category unique identifier. If not informed, it will be automatically generated by VTEX.
 * @member {Number} Id
 */
CreateCategoryRequest.prototype['Id'] = undefined;

/**
 * If true, the Category page becomes available in store.
 * @member {Boolean} IsActive
 */
CreateCategoryRequest.prototype['IsActive'] = undefined;

/**
 * Substitute words for the Category.
 * @member {String} Keywords
 */
CreateCategoryRequest.prototype['Keywords'] = undefined;

/**
 * This is a legacy field. Do not take this information into consideration.
 * @member {String} LomadeeCampaignCode
 */
CreateCategoryRequest.prototype['LomadeeCampaignCode'] = undefined;
