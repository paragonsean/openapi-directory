...
/**
 * The ApiCatalogPvtSpecificationPostRequest model module.
 * @module model/ApiCatalogPvtSpecificationPostRequest
 * @version 1.0
 */
class ApiCatalogPvtSpecificationPostRequest {
    /**
     * Constructs a new <code>ApiCatalogPvtSpecificationPostRequest</code>.
     * @alias module:model/ApiCatalogPvtSpecificationPostRequest
     * @param fieldGroupId {Number} ID of the group of specifications that contains the new specification.
     * @param fieldTypeId {Number} Field Type ID can be `1 - Text`, `2 - Multi-Line Text`, `4 - Number`, `5 - Combo`, `6 - Radio`, `7 - Checkbox`, `8 - Indexed Text`, `9 - Indexed Multi-Line Text`.
     * @param name {String} Specification name.
     */
    constructor(fieldGroupId, fieldTypeId, name) { 
        
        ApiCatalogPvtSpecificationPostRequest.initialize(this, fieldGroupId, fieldTypeId, name);
    }
     ...
     */
    static initialize(obj, fieldGroupId, fieldTypeId, name) { 
    ...
    /**
     * Constructs a <code>ApiCatalogPvtSpecificationPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiCatalogPvtSpecificationPostRequest} obj Optional instance to populate.
     * @return {module:model/ApiCatalogPvtSpecificationPostRequest} The populated <code>ApiCatalogPvtSpecificationPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiCatalogPvtSpecificationPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiCatalogPvtSpecificationPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiCatalogPvtSpecificationPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiCatalogPvtSpecificationPostRequest.RequiredProperties) {
...
ApiCatalogPvtSpecificationPostRequest.RequiredProperties = ["FieldGroupId", "FieldTypeId", "Name"];

/**
 * Category ID associated with this specification.
 * @member {Number} CategoryId
 */
ApiCatalogPvtSpecificationPostRequest.prototype['CategoryId'] = undefined;

/**
 * Specification default value.
 * @member {String} DefaultValue
 */
ApiCatalogPvtSpecificationPostRequest.prototype['DefaultValue'] = undefined;

/**
 * @member {String} Description
 */
ApiCatalogPvtSpecificationPostRequest.prototype['Description'] = undefined;

/**
 * ID of the group of specifications that contains the new specification.
 * @member {Number} FieldGroupId
 */
ApiCatalogPvtSpecificationPostRequest.prototype['FieldGroupId'] = undefined;
 ...
 */
ApiCatalogPvtSpecificationPostRequest.prototype['FieldTypeId'] = undefined;

/**
 * Enable (`true`) or disable (`false`) specification.
 * @member {Boolean} IsActive
 */
ApiCatalogPvtSpecificationPostRequest.prototype['IsActive'] = undefined;
 ...
 */
ApiCatalogPvtSpecificationPostRequest.prototype['IsFilter'] = undefined;
 ...
 */
ApiCatalogPvtSpecificationPostRequest.prototype['IsOnProductDetails'] = undefined;

/**
 * Makes the specification mandatory (`true`) or optional (`false`).
 * @member {Boolean} IsRequired
 */
ApiCatalogPvtSpecificationPostRequest.prototype['IsRequired'] = undefined;
 ...
 */
ApiCatalogPvtSpecificationPostRequest.prototype['IsSideMenuLinkActive'] = undefined;
 ...
 */
ApiCatalogPvtSpecificationPostRequest.prototype['IsStockKeepingUnit'] = undefined;
 ...
 */
ApiCatalogPvtSpecificationPostRequest.prototype['IsTopMenuLinkActive'] = undefined;

/**
 * @member {Boolean} IsWizard
 */
ApiCatalogPvtSpecificationPostRequest.prototype['IsWizard'] = undefined;

/**
 * Specification name.
 * @member {String} Name
 */
ApiCatalogPvtSpecificationPostRequest.prototype['Name'] = undefined;
 ...
 */
ApiCatalogPvtSpecificationPostRequest.prototype['Position'] = undefined;
...
export default ApiCatalogPvtSpecificationPostRequest;
