...
/**
 * The UpdateSellerRequest model module.
 * @module model/UpdateSellerRequest
 * @version 1.0
 */
class UpdateSellerRequest {
    /**
     * Constructs a new <code>UpdateSellerRequest</code>.
     * @alias module:model/UpdateSellerRequest
    ...
    constructor(archiveId, CNPJ, cSCIdentification, catalogSystemEndpoint, deliveryPolicy, description, email, exchangeReturnPolicy, freightCommissionPercentage, fulfillmentEndpoint, fulfillmentSellerId, isActive, isBetterScope, name, password, productCommissionPercentage, secutityPrivacyPolicy, sellerId, sellerType, urlLogo, useHybridPaymentOptions, userName) { 
        ...
        UpdateSellerRequest.initialize(this, archiveId, CNPJ, cSCIdentification, catalogSystemEndpoint, deliveryPolicy, description, email, exchangeReturnPolicy, freightCommissionPercentage, fulfillmentEndpoint, fulfillmentSellerId, isActive, isBetterScope, name, password, productCommissionPercentage, secutityPrivacyPolicy, sellerId, sellerType, urlLogo, useHybridPaymentOptions, userName);
    }
    ...
    /**
     * Constructs a <code>UpdateSellerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSellerRequest} obj Optional instance to populate.
     * @return {module:model/UpdateSellerRequest} The populated <code>UpdateSellerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSellerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSellerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSellerRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateSellerRequest.RequiredProperties) {
...
UpdateSellerRequest.RequiredProperties = ["ArchiveId", "CNPJ", "CSCIdentification", "CatalogSystemEndpoint", "DeliveryPolicy", "Description", "Email", "ExchangeReturnPolicy", "FreightCommissionPercentage", "FulfillmentEndpoint", "FulfillmentSellerId", "IsActive", "IsBetterScope", "Name", "Password", "ProductCommissionPercentage", "SecutityPrivacyPolicy", "SellerId", "SellerType", "UrlLogo", "UseHybridPaymentOptions", "UserName"];

/**
 * Seller archive ID.
 * @member {Number} ArchiveId
 */
UpdateSellerRequest.prototype['ArchiveId'] = undefined;

/**
 * Company registration number.
 * @member {String} CNPJ
 */
UpdateSellerRequest.prototype['CNPJ'] = undefined;

/**
 * CSC identification.
 * @member {String} CSCIdentification
 */
UpdateSellerRequest.prototype['CSCIdentification'] = undefined;
 ...
 */
UpdateSellerRequest.prototype['CatalogSystemEndpoint'] = undefined;
 ...
 */
UpdateSellerRequest.prototype['CategoryCommissionPercentage'] = undefined;

/**
 * Text describing the delivery policy previously agreed between the marketplace and the seller.
 * @member {String} DeliveryPolicy
 */
UpdateSellerRequest.prototype['DeliveryPolicy'] = undefined;
 ...
 */
UpdateSellerRequest.prototype['Description'] = undefined;

/**
 * Email of the admin responsible for the seller.
 * @member {String} Email
 */
UpdateSellerRequest.prototype['Email'] = undefined;
 ...
 */
UpdateSellerRequest.prototype['ExchangeReturnPolicy'] = undefined;

/**
 * The percentage that must be filled in as agreed between the marketplace and the seller. If there is no such commission, please fill in the field with the value: `0.00`.
 * @member {Number} FreightCommissionPercentage
 */
UpdateSellerRequest.prototype['FreightCommissionPercentage'] = undefined;

/**
 * URL of the endpoint for fulfillment of seller's orders, which the marketplace will use to communicate with the seller. This field applies to all sellers, regardless of their type. However, for `VTEX Stores`, you don’t need to fill it in because the system will do that automatically. You can edit this field once the seller has been successfully added.
 * @member {String} FulfillmentEndpoint
 */
UpdateSellerRequest.prototype['FulfillmentEndpoint'] = undefined;
 ...
 */
UpdateSellerRequest.prototype['FulfillmentSellerId'] = undefined;

/**
 * If the selle is active (`true`) or not (`false`).
 * @member {Boolean} IsActive
 */
UpdateSellerRequest.prototype['IsActive'] = undefined;
 ...
 */
UpdateSellerRequest.prototype['IsBetterScope'] = undefined;
 ...
 */
UpdateSellerRequest.prototype['MerchantName'] = undefined;
 ...
 * @member {String} Name
 */
UpdateSellerRequest.prototype['Name'] = undefined;

/**
 * Seller password.
 * @member {String} Password
 */
UpdateSellerRequest.prototype['Password'] = undefined;

/**
 * The percentage that must be filled in as agreed between the marketplace and the seller. If there is no such commission, please fill in the field with the value: `0.00`.
 * @member {Number} ProductCommissionPercentage
 */
UpdateSellerRequest.prototype['ProductCommissionPercentage'] = undefined;
 ...
 */
UpdateSellerRequest.prototype['SecutityPrivacyPolicy'] = undefined;
 ...
 */
UpdateSellerRequest.prototype['SellerId'] = undefined;

/**
 * Seller type.
 * @member {Number} SellerType
 */
UpdateSellerRequest.prototype['SellerType'] = undefined;
 ...
 */
UpdateSellerRequest.prototype['TrustPolicy'] = undefined;

/**
 * Seller URL logo.
 * @member {String} UrlLogo
 */
UpdateSellerRequest.prototype['UrlLogo'] = undefined;
 ...
 */
UpdateSellerRequest.prototype['UseHybridPaymentOptions'] = undefined;

/**
 * Seller username.
 * @member {String} UserName
 */
UpdateSellerRequest.prototype['UserName'] = undefined;
...
export default UpdateSellerRequest;
