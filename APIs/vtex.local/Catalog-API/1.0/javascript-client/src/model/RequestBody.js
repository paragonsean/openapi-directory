...
class RequestBody {
     ...
     * @param fieldId {Number} Specification unique identifier. This field cannot be updated.
     * @param fieldValueId {Number} Specification value unique identifier. This field can only be updated with other values of the same `FieldId`.
     * @param id {Number} Specification and SKU association unique identifier. This field cannot be updated.
     */
    constructor(fieldId, fieldValueId, id) { 
        
        RequestBody.initialize(this, fieldId, fieldValueId, id);
    }
     ...
     */
    static initialize(obj, fieldId, fieldValueId, id) { 
        obj['FieldId'] = fieldId;
...
RequestBody.RequiredProperties = ["FieldId", "FieldValueId", "Id"];

/**
 * Specification unique identifier. This field cannot be updated.
 * @member {Number} FieldId
 */
RequestBody.prototype['FieldId'] = undefined;
 ...
 */
RequestBody.prototype['FieldValueId'] = undefined;
 ...
 * @member {Number} SkuId
 */
RequestBody.prototype['SkuId'] = undefined;
 ...
 * @member {String} Text
 */
RequestBody.prototype['Text'] = undefined;
