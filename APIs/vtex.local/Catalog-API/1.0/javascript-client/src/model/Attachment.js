...
class Attachment {
     ...
     * @param fields {Array.<module:model/Field>} Array containing Attachment fields.
     ...
     * @param keys {Array.<String>} Attachment Keys.
     * @param name {String} Attachment Name.
     */
    constructor(fields, id, isActive, isRequired, keys, name) { 
        
        Attachment.initialize(this, fields, id, isActive, isRequired, keys, name);
    }
     ...
     */
    static initialize(obj, fields, id, isActive, isRequired, keys, name) { 
        obj['Fields'] = fields;
        obj['Id'] = id;
...
Attachment.RequiredProperties = ["Fields", "Id", "IsActive", "IsRequired", "Keys", "Name"];

/**
 * Array containing Attachment fields.
 * @member {Array.<module:model/Field>} Fields
 */
Attachment.prototype['Fields'] = undefined;
 ...
 */
Attachment.prototype['IsActive'] = undefined;

/**
 * Defines if the Attachment is required or not.
 * @member {Boolean} IsRequired
 */
Attachment.prototype['IsRequired'] = undefined;

/**
 * Attachment Keys.
 * @member {Array.<String>} Keys
 */
Attachment.prototype['Keys'] = undefined;
