...
/**
 * The ApiCatalogPvtStockkeepingunitSkuIdPutRequest model module.
 * @module model/ApiCatalogPvtStockkeepingunitSkuIdPutRequest
 * @version 1.0
 */
class ApiCatalogPvtStockkeepingunitSkuIdPutRequest {
    /**
     * Constructs a new <code>ApiCatalogPvtStockkeepingunitSkuIdPutRequest</code>.
     * @alias module:model/ApiCatalogPvtStockkeepingunitSkuIdPutRequest
     * @param name {String} SKU name, meaning the variation of the previously added product. For example: **Product** - _Fridge_, **SKU** - _110V_.
     * @param packagedHeight {Number} Height used for shipping calculation.
     * @param packagedLength {Number} Length used for shipping calculation.
     * @param packagedWeightKg {Number} Weight used for shipping calculation, in the measurement [configured in the store](https://help.vtex.com/en/tutorial/filling-in-system-settings--tutorials_269), which by default is in grams.
     * @param packagedWidth {Number} Width used for shipping calculation.
     * @param productId {Number} ID of the Product associated with this SKU.
     */
    constructor(name, packagedHeight, packagedLength, packagedWeightKg, packagedWidth, productId) { 
        
        ApiCatalogPvtStockkeepingunitSkuIdPutRequest.initialize(this, name, packagedHeight, packagedLength, packagedWeightKg, packagedWidth, productId);
    }
     ...
     */
    static initialize(obj, name, packagedHeight, packagedLength, packagedWeightKg, packagedWidth, productId) { 
        obj['Name'] = name;
        obj['PackagedHeight'] = packagedHeight;
        obj['PackagedLength'] = packagedLength;
        obj['PackagedWeightKg'] = packagedWeightKg;
        obj['PackagedWidth'] = packagedWidth;
        obj['ProductId'] = productId;
    }

    /**
     * Constructs a <code>ApiCatalogPvtStockkeepingunitSkuIdPutRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiCatalogPvtStockkeepingunitSkuIdPutRequest} obj Optional instance to populate.
     * @return {module:model/ApiCatalogPvtStockkeepingunitSkuIdPutRequest} The populated <code>ApiCatalogPvtStockkeepingunitSkuIdPutRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiCatalogPvtStockkeepingunitSkuIdPutRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiCatalogPvtStockkeepingunitSkuIdPutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiCatalogPvtStockkeepingunitSkuIdPutRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiCatalogPvtStockkeepingunitSkuIdPutRequest.RequiredProperties) {
...
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.RequiredProperties = ["Name", "PackagedHeight", "PackagedLength", "PackagedWeightKg", "PackagedWidth", "ProductId"];
 ...
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['ActivateIfPossible'] = undefined;
 ...
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['CommercialConditionId'] = undefined;

/**
 * Date and time of the SKU's creation.
 * @member {String} CreationDate
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['CreationDate'] = undefined;
 ...
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['CubicWeight'] = undefined;
 ...
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['EstimatedDateArrival'] = undefined;

/**
 * SKU real height.
 * @member {Number} Height
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['Height'] = undefined;

/**
 * Shows if the SKU is active (`true`) or not (`false`).
 * @member {Boolean} IsActive
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['IsActive'] = undefined;
 ...
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['IsKit'] = undefined;

/**
 * Defines if Kit components can be sold apart.
 * @member {Boolean} KitItensSellApart
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['KitItensSellApart'] = undefined;

/**
 * SKU real length.
 * @member {Number} Length
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['Length'] = undefined;
 ...
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['ManufacturerCode'] = undefined;
 ...
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['MeasurementUnit'] = undefined;
 ...
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['ModalType'] = undefined;

/**
 * SKU name, meaning the variation of the previously added product. For example: **Product** - _Fridge_, **SKU** - _110V_.
 * @member {String} Name
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['Name'] = undefined;

/**
 * Height used for shipping calculation.
 * @member {Number} PackagedHeight
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['PackagedHeight'] = undefined;

/**
 * Length used for shipping calculation.
 * @member {Number} PackagedLength
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['PackagedLength'] = undefined;
 ...
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['PackagedWeightKg'] = undefined;

/**
 * Width used for shipping calculation.
 * @member {Number} PackagedWidth
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['PackagedWidth'] = undefined;

/**
 * ID of the Product associated with this SKU.
 * @member {Number} ProductId
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['ProductId'] = undefined;
 ...
 * @member {String} RefId
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['RefId'] = undefined;
 ...
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['RewardValue'] = undefined;
 ...
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['UnitMultiplier'] = undefined;

/**
 * Videos URLs
 * @member {Array.<String>} Videos
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['Videos'] = undefined;
 ...
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['WeightKg'] = undefined;

/**
 * SKU real width.
 * @member {Number} Width
 */
ApiCatalogPvtStockkeepingunitSkuIdPutRequest.prototype['Width'] = undefined;
...
export default ApiCatalogPvtStockkeepingunitSkuIdPutRequest;
