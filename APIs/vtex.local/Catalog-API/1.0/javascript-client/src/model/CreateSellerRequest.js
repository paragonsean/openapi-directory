...
/**
 * The CreateSellerRequest model module.
 * @module model/CreateSellerRequest
 * @version 1.0
 */
class CreateSellerRequest {
    /**
     * Constructs a new <code>CreateSellerRequest</code>.
     * @alias module:model/CreateSellerRequest
     * @param archiveId {Number} Seller archive ID.
     * @param CNPJ {String} Company registration number.
     * @param cSCIdentification {String} CSC identification.
     * @param catalogSystemEndpoint {String} URL of the endpoint of the seller's catalog. This field will only be displayed if the seller type is VTEX Store. The field format will be as follows: `http://{sellerName}.vtexcommercestable.com.br/api/catalog_system/`.
     * @param deliveryPolicy {String} Text describing the delivery policy previously agreed between the marketplace and the seller.
     * @param description {String} Text describing the seller with a marketing tone. You can display this text in the marketplace window display by [customizing the CMS](https://help.vtex.com/en/tutorial/list-of-controls-for-templates--tutorials_563).
     ...
     * @param freightCommissionPercentage {Number} The percentage that must be filled in as agreed between the marketplace and the seller. If there is no such commission, please fill in the field with the value: `0.00`.
     ...
     * @param fulfillmentSellerId {Number} Identification code of the seller responsible for fulfilling the order. This is an optional field used when a seller sells SKUs from another seller. If the seller sells their own SKUs, it must be left blank.
     * @param isActive {Boolean} If the selle is active (`true`) or not (`false`).
     * @param isBetterScope {Boolean} Indicates whether it is a [comprehensive seller](https://help.vtex.com/en/tutorial/comprehensive-seller--5Qn4O2GpjUIzWTPpvLUfkI).
     * @param name {String} Name of the account in the seller's environment. You can find it on **Account settings > Account > Account Name**). Applicable only if the seller uses their own payment method.
     * @param password {String} Seller password.
     * @param productCommissionPercentage {Number} The percentage that must be filled in as agreed between the marketplace and the seller. If there is no such commission, please fill in the field with the value: `0.00`.
     * @param secutityPrivacyPolicy {String} Text describing the security policy previously agreed between the marketplace and the seller.
     * @param sellerId {String} Code used to identify the seller. It is assigned by the marketplace. We recommend filling it in with the seller's account name.
     * @param sellerType {Number} Seller type.
     * @param urlLogo {String} Seller URL logo.
     * @param useHybridPaymentOptions {Boolean} Allows customers to use gift cards from the seller to buy their products on the marketplace. It identifies purchases made with a gift card so that only the final price (with discounts applied) is paid to the seller.
     * @param userName {String} Seller username.
     */
    constructor(archiveId, CNPJ, cSCIdentification, catalogSystemEndpoint, deliveryPolicy, description, email, exchangeReturnPolicy, freightCommissionPercentage, fulfillmentEndpoint, fulfillmentSellerId, isActive, isBetterScope, name, password, productCommissionPercentage, secutityPrivacyPolicy, sellerId, sellerType, urlLogo, useHybridPaymentOptions, userName) { 
        
        CreateSellerRequest.initialize(this, archiveId, CNPJ, cSCIdentification, catalogSystemEndpoint, deliveryPolicy, description, email, exchangeReturnPolicy, freightCommissionPercentage, fulfillmentEndpoint, fulfillmentSellerId, isActive, isBetterScope, name, password, productCommissionPercentage, secutityPrivacyPolicy, sellerId, sellerType, urlLogo, useHybridPaymentOptions, userName);
    }
     ...
     */
    static initialize(obj, archiveId, CNPJ, cSCIdentification, catalogSystemEndpoint, deliveryPolicy, description, email, exchangeReturnPolicy, freightCommissionPercentage, fulfillmentEndpoint, fulfillmentSellerId, isActive, isBetterScope, name, password, productCommissionPercentage, secutityPrivacyPolicy, sellerId, sellerType, urlLogo, useHybridPaymentOptions, userName) { 
        obj['ArchiveId'] = archiveId;
        obj['CNPJ'] = CNPJ;
        obj['CSCIdentification'] = cSCIdentification;
        obj['CatalogSystemEndpoint'] = catalogSystemEndpoint;
        obj['DeliveryPolicy'] = deliveryPolicy;
        obj['Description'] = description;
        obj['Email'] = email;
        obj['ExchangeReturnPolicy'] = exchangeReturnPolicy;
        obj['FreightCommissionPercentage'] = freightCommissionPercentage;
        obj['FulfillmentEndpoint'] = fulfillmentEndpoint;
        obj['FulfillmentSellerId'] = fulfillmentSellerId;
        obj['IsActive'] = isActive;
        obj['IsBetterScope'] = isBetterScope;
        obj['Name'] = name;
        obj['Password'] = password;
        obj['ProductCommissionPercentage'] = productCommissionPercentage;
        obj['SecutityPrivacyPolicy'] = secutityPrivacyPolicy;
        obj['SellerId'] = sellerId;
        obj['SellerType'] = sellerType;
        obj['UrlLogo'] = urlLogo;
        obj['UseHybridPaymentOptions'] = useHybridPaymentOptions;
        obj['UserName'] = userName;
    }

    /**
     * Constructs a <code>CreateSellerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSellerRequest} obj Optional instance to populate.
     * @return {module:model/CreateSellerRequest} The populated <code>CreateSellerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSellerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSellerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSellerRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateSellerRequest.RequiredProperties) {
...
CreateSellerRequest.RequiredProperties = ["ArchiveId", "CNPJ", "CSCIdentification", "CatalogSystemEndpoint", "DeliveryPolicy", "Description", "Email", "ExchangeReturnPolicy", "FreightCommissionPercentage", "FulfillmentEndpoint", "FulfillmentSellerId", "IsActive", "IsBetterScope", "Name", "Password", "ProductCommissionPercentage", "SecutityPrivacyPolicy", "SellerId", "SellerType", "UrlLogo", "UseHybridPaymentOptions", "UserName"];

/**
 * Seller archive ID.
 * @member {Number} ArchiveId
 */
CreateSellerRequest.prototype['ArchiveId'] = undefined;

/**
 * Company registration number.
 * @member {String} CNPJ
 */
CreateSellerRequest.prototype['CNPJ'] = undefined;

/**
 * CSC identification.
 * @member {String} CSCIdentification
 */
CreateSellerRequest.prototype['CSCIdentification'] = undefined;
 ...
 */
CreateSellerRequest.prototype['CatalogSystemEndpoint'] = undefined;
 ...
 */
CreateSellerRequest.prototype['CategoryCommissionPercentage'] = undefined;

/**
 * Text describing the delivery policy previously agreed between the marketplace and the seller.
 * @member {String} DeliveryPolicy
 */
CreateSellerRequest.prototype['DeliveryPolicy'] = undefined;
 ...
 */
CreateSellerRequest.prototype['Description'] = undefined;

/**
 * Email of the admin responsible for the seller.
 * @member {String} Email
 */
CreateSellerRequest.prototype['Email'] = undefined;
 ...
 */
CreateSellerRequest.prototype['ExchangeReturnPolicy'] = undefined;

/**
 * The percentage that must be filled in as agreed between the marketplace and the seller. If there is no such commission, please fill in the field with the value: `0.00`.
 * @member {Number} FreightCommissionPercentage
 */
CreateSellerRequest.prototype['FreightCommissionPercentage'] = undefined;

/**
 * URL of the endpoint for fulfillment of seller's orders, which the marketplace will use to communicate with the seller. This field applies to all sellers, regardless of their type. However, for `VTEX Stores`, you don’t need to fill it in because the system will do that automatically. You can edit this field once the seller has been successfully added.
 * @member {String} FulfillmentEndpoint
 */
CreateSellerRequest.prototype['FulfillmentEndpoint'] = undefined;
 ...
 */
CreateSellerRequest.prototype['FulfillmentSellerId'] = undefined;

/**
 * If the selle is active (`true`) or not (`false`).
 * @member {Boolean} IsActive
 */
CreateSellerRequest.prototype['IsActive'] = undefined;
 ...
 */
CreateSellerRequest.prototype['IsBetterScope'] = undefined;
 ...
 */
CreateSellerRequest.prototype['MerchantName'] = undefined;
 ...
 * @member {String} Name
 */
CreateSellerRequest.prototype['Name'] = undefined;

/**
 * Seller password.
 * @member {String} Password
 */
CreateSellerRequest.prototype['Password'] = undefined;

/**
 * The percentage that must be filled in as agreed between the marketplace and the seller. If there is no such commission, please fill in the field with the value: `0.00`.
 * @member {Number} ProductCommissionPercentage
 */
CreateSellerRequest.prototype['ProductCommissionPercentage'] = undefined;
 ...
 */
CreateSellerRequest.prototype['SecutityPrivacyPolicy'] = undefined;
 ...
 */
CreateSellerRequest.prototype['SellerId'] = undefined;

/**
 * Seller type.
 * @member {Number} SellerType
 */
CreateSellerRequest.prototype['SellerType'] = undefined;
 ...
 */
CreateSellerRequest.prototype['TrustPolicy'] = undefined;

/**
 * Seller URL logo.
 * @member {String} UrlLogo
 */
CreateSellerRequest.prototype['UrlLogo'] = undefined;
 ...
 */
CreateSellerRequest.prototype['UseHybridPaymentOptions'] = undefined;

/**
 * Seller username.
 * @member {String} UserName
 */
CreateSellerRequest.prototype['UserName'] = undefined;
