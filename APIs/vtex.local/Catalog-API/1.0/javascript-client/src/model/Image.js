...
class Image {
     ...
     * @param fileId {Number} SKU image ID.
     * @param imageName {String} Image label.
     * @param imageUrl {String} Image URL.
     */
    constructor(fileId, imageName, imageUrl) { 
        
        Image.initialize(this, fileId, imageName, imageUrl);
    }
     ...
     */
    static initialize(obj, fileId, imageName, imageUrl) { 
        obj['FileId'] = fileId;
...
Image.RequiredProperties = ["FileId", "ImageName", "ImageUrl"];
