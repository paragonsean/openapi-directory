...
/**
 * The ProductandTradePolicy200Response model module.
 * @module model/ProductandTradePolicy200Response
 * @version 1.0
 */
class ProductandTradePolicy200Response {
    /**
     * Constructs a new <code>ProductandTradePolicy200Response</code>.
     * @alias module:model/ProductandTradePolicy200Response
     */
    constructor() { 
        
        ProductandTradePolicy200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProductandTradePolicy200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProductandTradePolicy200Response} obj Optional instance to populate.
     * @return {module:model/ProductandTradePolicy200Response} The populated <code>ProductandTradePolicy200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProductandTradePolicy200Response();
            ...
            if (data.hasOwnProperty('ListStoreId')) {
                obj['ListStoreId'] = ApiClient.convertToType(data['ListStoreId'], [Object]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ProductandTradePolicy200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductandTradePolicy200Response</code>.
     */
 ...
 */
ProductandTradePolicy200Response.prototype['AdWordsRemarketingCode'] = undefined;

/**
 * Product brand ID.
 * @member {Number} BrandId
 */
ProductandTradePolicy200Response.prototype['BrandId'] = undefined;

/**
 * Product category ID.
 * @member {Number} CategoryId
 */
ProductandTradePolicy200Response.prototype['CategoryId'] = undefined;

/**
 * Product department ID.
 * @member {Number} DepartmentId
 */
ProductandTradePolicy200Response.prototype['DepartmentId'] = undefined;

/**
 * Product description.
 * @member {String} Description
 */
ProductandTradePolicy200Response.prototype['Description'] = undefined;

/**
 * Product complement name.
 * @member {String} DescriptionShort
 */
ProductandTradePolicy200Response.prototype['DescriptionShort'] = undefined;

/**
 * Product ID.
 * @member {Number} Id
 */
ProductandTradePolicy200Response.prototype['Id'] = undefined;

/**
 * If the product is active (`true`) or not (`false`) at the store.
 * @member {Boolean} IsActive
 */
ProductandTradePolicy200Response.prototype['IsActive'] = undefined;

/**
 * If the Product is visible on the store.
 * @member {Boolean} IsVisible
 */
ProductandTradePolicy200Response.prototype['IsVisible'] = undefined;

/**
 * Substitutes words for the product.
 * @member {String} KeyWords
 */
ProductandTradePolicy200Response.prototype['KeyWords'] = undefined;

/**
 * Product text link.
 * @member {String} LinkId
 */
ProductandTradePolicy200Response.prototype['LinkId'] = undefined;

/**
 * List with the Trade Policies IDs that the product is included.
 * @member {Array.<Object>} ListStoreId
 */
ProductandTradePolicy200Response.prototype['ListStoreId'] = undefined;

/**
 * This is a legacy field. Do not take this information into consideration.
 * @member {String} LomadeeCampaignCode
 */
ProductandTradePolicy200Response.prototype['LomadeeCampaignCode'] = undefined;

/**
 * Product meta tag description.
 * @member {String} MetaTagDescription
 */
ProductandTradePolicy200Response.prototype['MetaTagDescription'] = undefined;

/**
 * Product's name. Limited to 150 characters.
 * @member {String} Name
 */
ProductandTradePolicy200Response.prototype['Name'] = undefined;

/**
 * Product referecial code.
 * @member {String} RefId
 */
ProductandTradePolicy200Response.prototype['RefId'] = undefined;

/**
 * Product release date.
 * @member {String} ReleaseDate
 */
ProductandTradePolicy200Response.prototype['ReleaseDate'] = undefined;

/**
 * Defines if the Product will remain being shown in the store even if it’s out of stock.
 * @member {Boolean} ShowWithoutStock
 */
ProductandTradePolicy200Response.prototype['ShowWithoutStock'] = undefined;

/**
 * Product supplier ID.
 * @member {Number} SupplierId
 */
ProductandTradePolicy200Response.prototype['SupplierId'] = undefined;

/**
 * Product fiscal code.
 * @member {String} TaxCode
 */
ProductandTradePolicy200Response.prototype['TaxCode'] = undefined;
 ...
 * @member {String} Title
 */
ProductandTradePolicy200Response.prototype['Title'] = undefined;
...
export default ProductandTradePolicy200Response;
