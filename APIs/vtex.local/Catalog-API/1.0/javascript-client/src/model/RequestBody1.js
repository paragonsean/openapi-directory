...
class RequestBody1 {
     ...
     */
    constructor(attachmentId, skuId) { 
        
        RequestBody1.initialize(this, attachmentId, skuId);
    }
     ...
     */
    static initialize(obj, attachmentId, skuId) { 
...
RequestBody1.RequiredProperties = ["AttachmentId", "SkuId"];

/**
 * Attachment ID.
 * @member {Number} AttachmentId
 */
RequestBody1.prototype['AttachmentId'] = undefined;

/**
 * Unique identifier of an SKU.
 * @member {Number} SkuId
 */
RequestBody1.prototype['SkuId'] = undefined;
