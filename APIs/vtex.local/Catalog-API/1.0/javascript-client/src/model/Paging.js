...
class Paging {
     ...
     * @param page {Number} Page number of the brand list.
     * @param pages {Number} Total number of pages.
     * @param perPage {Number} Quantity of brands per page.
     * @param total {Number} Total of brands in the store.
     */
