...
/**
 * The SpecificationsField200Response model module.
 * @module model/SpecificationsField200Response
 * @version 1.0
 */
class SpecificationsField200Response {
    /**
     * Constructs a new <code>SpecificationsField200Response</code>.
     * @alias module:model/SpecificationsField200Response
     */
    constructor() { 
        
        SpecificationsField200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SpecificationsField200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SpecificationsField200Response} obj Optional instance to populate.
     * @return {module:model/SpecificationsField200Response} The populated <code>SpecificationsField200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SpecificationsField200Response();
            ...
            if (data.hasOwnProperty('FieldTypeName')) {
                obj['FieldTypeName'] = ApiClient.convertToType(data['FieldTypeName'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SpecificationsField200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SpecificationsField200Response</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['FieldTypeName'] && !(typeof data['FieldTypeName'] === 'string' || data['FieldTypeName'] instanceof String)) {
            throw new Error("Expected the field `FieldTypeName` to be a primitive type in the JSON string but got " + data['FieldTypeName']);
        }
        // ensure the json data is a string
 ...
 */
SpecificationsField200Response.prototype['DefaultValue'] = undefined;

/**
 * @member {String} Description
 */
SpecificationsField200Response.prototype['Description'] = undefined;

/**
 * ID of the group of specifications that contains the new specification.
 * @member {Number} FieldGroupId
 */
SpecificationsField200Response.prototype['FieldGroupId'] = undefined;

/**
 * Specification Field Group Name.
 * @member {String} FieldGroupName
 */
SpecificationsField200Response.prototype['FieldGroupName'] = undefined;

/**
 * Specification field ID.
 * @member {Number} FieldId
 */
SpecificationsField200Response.prototype['FieldId'] = undefined;
 ...
 */
SpecificationsField200Response.prototype['FieldTypeId'] = undefined;

/**
 * Field Type name, which can be `Text`, `Multi-Line Text`, `Number`, `Combo`, `Radio`, `Checkbox`, `Indexed Text` or `Indexed Multi-Line Text`.
 * @member {String} FieldTypeName
 */
SpecificationsField200Response.prototype['FieldTypeName'] = undefined;

/**
 * Specification value ID.
 * @member {Number} FieldValueId
 */
SpecificationsField200Response.prototype['FieldValueId'] = undefined;

/**
 * Enable (`true`) or disable (`false`) specification.
 * @member {Boolean} IsActive
 */
SpecificationsField200Response.prototype['IsActive'] = undefined;
 ...
 */
SpecificationsField200Response.prototype['IsFilter'] = undefined;
 ...
 */
SpecificationsField200Response.prototype['IsOnProductDetails'] = undefined;

/**
 * Makes the specification mandatory (`true`) or optional (`false`).
 * @member {Boolean} IsRequired
 */
SpecificationsField200Response.prototype['IsRequired'] = undefined;
 ...
 */
SpecificationsField200Response.prototype['IsSideMenuLinkActive'] = undefined;
 ...
 */
SpecificationsField200Response.prototype['IsStockKeepingUnit'] = undefined;
 ...
 */
SpecificationsField200Response.prototype['IsTopMenuLinkActive'] = undefined;

/**
 * @member {Boolean} IsWizard
 */
SpecificationsField200Response.prototype['IsWizard'] = undefined;

/**
 * Specification field name.
 * @member {String} Name
 */
SpecificationsField200Response.prototype['Name'] = undefined;
 ...
 */
SpecificationsField200Response.prototype['Position'] = undefined;
...
export default SpecificationsField200Response;
