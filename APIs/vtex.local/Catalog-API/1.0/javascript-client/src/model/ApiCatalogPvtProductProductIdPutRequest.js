...
/**
 * The ApiCatalogPvtProductProductIdPutRequest model module.
 * @module model/ApiCatalogPvtProductProductIdPutRequest
 * @version 1.0
 */
class ApiCatalogPvtProductProductIdPutRequest {
    /**
     * Constructs a new <code>ApiCatalogPvtProductProductIdPutRequest</code>.
     * @alias module:model/ApiCatalogPvtProductProductIdPutRequest
     * @param brandId {Number} Brand ID associated with this product.
     * @param categoryId {Number} Category ID associated with this product.
     * @param name {String} Product's name. Limited to 150 characters.
     */
    constructor(brandId, categoryId, name) { 
        
        ApiCatalogPvtProductProductIdPutRequest.initialize(this, brandId, categoryId, name);
    }
     ...
     */
    static initialize(obj, brandId, categoryId, name) { 
        obj['BrandId'] = brandId;
    ...
    /**
     * Constructs a <code>ApiCatalogPvtProductProductIdPutRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiCatalogPvtProductProductIdPutRequest} obj Optional instance to populate.
     * @return {module:model/ApiCatalogPvtProductProductIdPutRequest} The populated <code>ApiCatalogPvtProductProductIdPutRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiCatalogPvtProductProductIdPutRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiCatalogPvtProductProductIdPutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiCatalogPvtProductProductIdPutRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiCatalogPvtProductProductIdPutRequest.RequiredProperties) {
...
ApiCatalogPvtProductProductIdPutRequest.RequiredProperties = ["BrandId", "CategoryId", "Name"];

/**
 * This is a legacy field. Do not take this information into consideration.
 * @member {String} AdWordsRemarketingCode
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['AdWordsRemarketingCode'] = undefined;

/**
 * Brand ID associated with this product.
 * @member {Number} BrandId
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['BrandId'] = undefined;

/**
 * Category ID associated with this product.
 * @member {Number} CategoryId
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['CategoryId'] = undefined;

/**
 * Department ID according to the product's category.
 * @member {Number} DepartmentId
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['DepartmentId'] = undefined;

/**
 * Product description.
 * @member {String} Description
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['Description'] = undefined;
 ...
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['DescriptionShort'] = undefined;

/**
 * Activate (`true`) or inactivate (`false`) product.
 * @member {Boolean} IsActive
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['IsActive'] = undefined;
 ...
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['IsVisible'] = undefined;
 ...
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['KeyWords'] = undefined;
 ...
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['LinkId'] = undefined;

/**
 * This is a legacy field. Do not take this information into consideration.
 * @member {String} LomadeeCampaignCode
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['LomadeeCampaignCode'] = undefined;

/**
 * Brief description of the product for SEO. It is recommended not to exceed 150 characters.
 * @member {String} MetaTagDescription
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['MetaTagDescription'] = undefined;

/**
 * Product's name. Limited to 150 characters.
 * @member {String} Name
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['Name'] = undefined;

/**
 * Product Reference Code.
 * @member {String} RefId
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['RefId'] = undefined;
 ...
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['ReleaseDate'] = undefined;

/**
 * Value used to set the priority on the search result page.
 * @member {Number} Score
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['Score'] = undefined;
 ...
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['ShowWithoutStock'] = undefined;

/**
 * @member {Number} SupplierId
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['SupplierId'] = undefined;

/**
 * Product tax code, used for tax calculation.
 * @member {String} TaxCode
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['TaxCode'] = undefined;
 ...
 * @member {String} Title
 */
ApiCatalogPvtProductProductIdPutRequest.prototype['Title'] = undefined;
...
export default ApiCatalogPvtProductProductIdPutRequest;
