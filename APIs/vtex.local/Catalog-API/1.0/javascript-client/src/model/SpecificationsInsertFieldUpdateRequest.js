...
/**
 * The SpecificationsInsertFieldUpdateRequest model module.
 * @module model/SpecificationsInsertFieldUpdateRequest
 * @version 1.0
 */
class SpecificationsInsertFieldUpdateRequest {
    /**
     * Constructs a new <code>SpecificationsInsertFieldUpdateRequest</code>.
     * @alias module:model/SpecificationsInsertFieldUpdateRequest
     ...
     * @param isActive {Boolean} Enables(`true`) or disables (`false`) the Specification Field.
     ...
     * @param isStockKeepingUnit {Boolean} If `true`, it will be added as a SKU specification field. If `false`, it will be added as a product specification field.
     ...
     */
    constructor(categoryId, defaultValue, description, fieldGroupId, fieldGroupName, fieldId, fieldTypeId, isActive, isFilter, isOnProductDetails, isRequired, isSideMenuLinkActive, isStockKeepingUnit, isTopMenuLinkActive, isWizard, name, position) { 
        
        SpecificationsInsertFieldUpdateRequest.initialize(this, categoryId, defaultValue, description, fieldGroupId, fieldGroupName, fieldId, fieldTypeId, isActive, isFilter, isOnProductDetails, isRequired, isSideMenuLinkActive, isStockKeepingUnit, isTopMenuLinkActive, isWizard, name, position);
    }
     ...
     */
    static initialize(obj, categoryId, defaultValue, description, fieldGroupId, fieldGroupName, fieldId, fieldTypeId, isActive, isFilter, isOnProductDetails, isRequired, isSideMenuLinkActive, isStockKeepingUnit, isTopMenuLinkActive, isWizard, name, position) { 
    ...
    /**
     * Constructs a <code>SpecificationsInsertFieldUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SpecificationsInsertFieldUpdateRequest} obj Optional instance to populate.
     * @return {module:model/SpecificationsInsertFieldUpdateRequest} The populated <code>SpecificationsInsertFieldUpdateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SpecificationsInsertFieldUpdateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SpecificationsInsertFieldUpdateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SpecificationsInsertFieldUpdateRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SpecificationsInsertFieldUpdateRequest.RequiredProperties) {
...
SpecificationsInsertFieldUpdateRequest.RequiredProperties = ["CategoryId", "DefaultValue", "Description", "FieldGroupId", "FieldGroupName", "FieldId", "FieldTypeId", "IsActive", "IsFilter", "IsOnProductDetails", "IsRequired", "IsSideMenuLinkActive", "IsStockKeepingUnit", "IsTopMenuLinkActive", "IsWizard", "Name", "Position"];

/**
 * Category ID.
 * @member {Number} CategoryId
 */
SpecificationsInsertFieldUpdateRequest.prototype['CategoryId'] = undefined;

/**
 * Specification Field default Value.
 * @member {String} DefaultValue
 */
SpecificationsInsertFieldUpdateRequest.prototype['DefaultValue'] = undefined;

/**
 * Specification Field Description.
 * @member {String} Description
 */
SpecificationsInsertFieldUpdateRequest.prototype['Description'] = undefined;

/**
 * Specification Field Group ID.
 * @member {Number} FieldGroupId
 */
SpecificationsInsertFieldUpdateRequest.prototype['FieldGroupId'] = undefined;

/**
 * Specification Field Group Name.
 * @member {String} FieldGroupName
 */
SpecificationsInsertFieldUpdateRequest.prototype['FieldGroupName'] = undefined;

/**
 * Specification Field ID.
 * @member {Number} FieldId
 */
SpecificationsInsertFieldUpdateRequest.prototype['FieldId'] = undefined;

/**
 * Specification Field Type ID.
 * @member {Number} FieldTypeId
 */
SpecificationsInsertFieldUpdateRequest.prototype['FieldTypeId'] = undefined;

/**
 * Specification Field Value ID.
 * @member {Number} FieldValueId
 */
SpecificationsInsertFieldUpdateRequest.prototype['FieldValueId'] = undefined;

/**
 * Enables(`true`) or disables (`false`) the Specification Field.
 * @member {Boolean} IsActive
 */
SpecificationsInsertFieldUpdateRequest.prototype['IsActive'] = undefined;
 ...
 */
SpecificationsInsertFieldUpdateRequest.prototype['IsFilter'] = undefined;
 ...
 */
SpecificationsInsertFieldUpdateRequest.prototype['IsOnProductDetails'] = undefined;

/**
 * Makes the Specification Field mandatory (`true`) or optional (`false`).
 * @member {Boolean} IsRequired
 */
SpecificationsInsertFieldUpdateRequest.prototype['IsRequired'] = undefined;
 ...
 */
SpecificationsInsertFieldUpdateRequest.prototype['IsSideMenuLinkActive'] = undefined;
 ...
 */
SpecificationsInsertFieldUpdateRequest.prototype['IsStockKeepingUnit'] = undefined;
 ...
 */
SpecificationsInsertFieldUpdateRequest.prototype['IsTopMenuLinkActive'] = undefined;

/**
 * Deprecated field.
 * @member {Boolean} IsWizard
 */
SpecificationsInsertFieldUpdateRequest.prototype['IsWizard'] = undefined;

/**
 * Specification Field ID.
 * @member {String} Name
 */
SpecificationsInsertFieldUpdateRequest.prototype['Name'] = undefined;

/**
 * Specification Field Position.
 * @member {Number} Position
 */
SpecificationsInsertFieldUpdateRequest.prototype['Position'] = undefined;
...
export default SpecificationsInsertFieldUpdateRequest;
