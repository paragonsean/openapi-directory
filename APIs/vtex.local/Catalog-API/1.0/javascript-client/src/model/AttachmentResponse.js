...
import DomainsInner from './DomainsInner';
...
class AttachmentResponse {
     ...
     * @param domains {Array.<module:model/DomainsInner>} List of characteristics related to the attachment.
     * @param id {Number} Attachment ID.
     * @param isActive {Boolean} Defines if the attachment is active or not.
     * @param isRequired {Boolean} Defines if the attachment is required or not.
     * @param name {String} Attachment Name.
     */
    constructor(domains, id, isActive, isRequired, name) { 
        
        AttachmentResponse.initialize(this, domains, id, isActive, isRequired, name);
    }
     ...
     */
    static initialize(obj, domains, id, isActive, isRequired, name) { 
        obj['Domains'] = domains;
        obj['Id'] = id;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Domains')) {
                obj['Domains'] = ApiClient.convertToType(data['Domains'], [DomainsInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['Domains']) { // data not null
            ...
            for (const item of data['Domains']) {
                DomainsInner.validateJSON(item);
            };
        }
...
AttachmentResponse.RequiredProperties = ["Domains", "Id", "IsActive", "IsRequired", "Name"];

/**
 * List of characteristics related to the attachment.
 * @member {Array.<module:model/DomainsInner>} Domains
 */
AttachmentResponse.prototype['Domains'] = undefined;

/**
 * Attachment ID.
 * @member {Number} Id
 */
AttachmentResponse.prototype['Id'] = undefined;

/**
 * Defines if the attachment is active or not.
 * @member {Boolean} IsActive
 */
AttachmentResponse.prototype['IsActive'] = undefined;

/**
 * Defines if the attachment is required or not.
 * @member {Boolean} IsRequired
 */
AttachmentResponse.prototype['IsRequired'] = undefined;
