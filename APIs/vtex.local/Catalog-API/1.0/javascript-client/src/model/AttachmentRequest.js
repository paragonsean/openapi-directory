...
class AttachmentRequest {
     ...
     */
    constructor(domains, isActive, isRequired, name) { 
        
        AttachmentRequest.initialize(this, domains, isActive, isRequired, name);
    }
     ...
     */
    static initialize(obj, domains, isActive, isRequired, name) { 
        obj['Domains'] = domains;
    ...
    static validateJSON(data) {
        ...
        for (const property of AttachmentRequest.RequiredProperties) {
