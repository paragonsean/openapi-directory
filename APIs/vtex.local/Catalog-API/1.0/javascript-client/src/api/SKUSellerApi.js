...
/**
* SKUSeller service.
* @module api/SKUSellerApi
* @version 1.0
*/
export default class SKUSellerApi {

    /**
    * Constructs a new SKUSellerApi. 
    * @alias module:api/SKUSellerApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPost operation.
     * @callback module:api/SKUSellerApi~apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPostCallback
     ...
     * @param {module:api/SKUSellerApi~apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
    apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPost(contentType, accept, sellerId, sellerSkuId, callback) {
      let postBody = null;
      // verify the required parameter 'contentType' is set
      if (contentType === undefined || contentType === null) {
        throw new Error("Missing the required parameter 'contentType' when calling apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPost");
      }
      // verify the required parameter 'accept' is set
      if (accept === undefined || accept === null) {
        throw new Error("Missing the required parameter 'accept' when calling apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPost");
      }
      // verify the required parameter 'sellerId' is set
      if (sellerId === undefined || sellerId === null) {
        throw new Error("Missing the required parameter 'sellerId' when calling apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPost");
      }
      // verify the required parameter 'sellerSkuId' is set
      if (sellerSkuId === undefined || sellerSkuId === null) {
        throw new Error("Missing the required parameter 'sellerSkuId' when calling apiCatalogSystemPvtSkusellerChangenotificationSellerIdSellerSkuIdPost");
      }
      ...
      return this.apiClient.callApi(
        '/api/catalog_system/pvt/skuseller/changenotification/{sellerId}/{sellerSkuId}', 'POST',
     ...
     * @callback module:api/SKUSellerApi~changeNotificationCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SKUSellerApi~changeNotificationCallback} callback The callback function, accepting three arguments: error, data, response
     */
    changeNotification(contentType, accept, skuId, callback) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/api/catalog_system/pvt/skuseller/changenotification/{skuId}', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:api/SKUSellerApi~deleteSKUsellerassociationCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SKUSellerApi~deleteSKUsellerassociationCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteSKUsellerassociation(contentType, accept, sellerId, sellerSkuId, callback) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/api/catalog_system/pvt/skuseller/remove/{sellerId}/{sellerSkuId}', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:api/SKUSellerApi~getSKUsellerCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} sellerId ID that identifies the seller in the marketplace. It can be the same as the seller name or a unique number. Check the **Sellers management** section in the Admin to get the correct ID.
     * @param {String} sellerSkuId SKU ID in the seller's store.
     * @param {module:api/SKUSellerApi~getSKUsellerCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    getSKUseller(contentType, accept, sellerId, sellerSkuId, callback) {
      ...
      return this.apiClient.callApi(
        '/api/catalog_system/pvt/skuseller/{sellerId}/{sellerSkuId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
