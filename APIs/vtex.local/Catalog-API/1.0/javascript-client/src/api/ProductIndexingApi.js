...
/**
* ProductIndexing service.
* @module api/ProductIndexingApi
* @version 1.0
*/
export default class ProductIndexingApi {

    /**
    * Constructs a new ProductIndexingApi. 
    * @alias module:api/ProductIndexingApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the indexedInfo operation.
     * @callback module:api/ProductIndexingApi~indexedInfoCallback
     ...
     * @param {module:api/ProductIndexingApi~indexedInfoCallback} callback The callback function, accepting three arguments: error, data, response
     */
    indexedInfo(contentType, accept, productId, callback) {
      let postBody = null;
      // verify the required parameter 'contentType' is set
      if (contentType === undefined || contentType === null) {
        throw new Error("Missing the required parameter 'contentType' when calling indexedInfo");
      }
      // verify the required parameter 'accept' is set
      if (accept === undefined || accept === null) {
        throw new Error("Missing the required parameter 'accept' when calling indexedInfo");
      }
      // verify the required parameter 'productId' is set
      if (productId === undefined || productId === null) {
        throw new Error("Missing the required parameter 'productId' when calling indexedInfo");
      }
      ...
      return this.apiClient.callApi(
        '/api/catalog_system/pvt/products/GetIndexedInfo/{productId}', 'GET',
