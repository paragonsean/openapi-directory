...
**commercialConditionId** | **Number** | Used to define SKU specific promotions or installment rules. In case of no specific condition, use &#x60;1&#x60; (default value). This field does not accept &#x60;0&#x60;. Find out more by reading [Registering a commercial condition](https://help.vtex.com/tutorial/registering-a-commercial-condition--tutorials_445). | [optional] 
...
**height** | **Number** | SKU real height. | [optional] 
**id** | **Number** | SKU unique identifier. | [optional] 
...
**length** | **Number** | SKU real length. | [optional] 
...
**packagedHeight** | **Number** | Height used for shipping calculation. | [optional] 
**packagedLength** | **Number** | Length used for shipping calculation. | [optional] 
**packagedWeightKg** | **Number** | Weight used for shipping calculation. | [optional] 
**packagedWidth** | **Number** | Width used for shipping calculation. | [optional] 
**productId** | **Number** | ID of the Product associated with this SKU. | [optional] 
...
**rewardValue** | **Number** | Credit that the customer receives when finalizing an order of one specific SKU unit. By filling this field out with &#x60;1&#x60;, the customer gets U$ 1 credit on the site. | [optional] 
...
**videos** | **[String]** | Videos URLs. | [optional] 
...
**width** | **Number** | SKU real width. | [optional] 
