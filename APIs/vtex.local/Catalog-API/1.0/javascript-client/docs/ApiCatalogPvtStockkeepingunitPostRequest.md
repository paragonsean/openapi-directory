# CatalogApi.ApiCatalogPvtStockkeepingunitPostRequest
...
**id** | **Number** | SKU unique identifier. If not informed, it will be automatically generated by VTEX. | [optional] 
...
**packagedWeightKg** | **Number** | Weight used for shipping calculation, in the measurement [configured in the store](https://help.vtex.com/en/tutorial/filling-in-system-settings--tutorials_269), which by default is in grams. | 
**packagedWidth** | **Number** | Width used for shipping calculation. | 
**productId** | **Number** | ID of the Product associated with this SKU. | 
