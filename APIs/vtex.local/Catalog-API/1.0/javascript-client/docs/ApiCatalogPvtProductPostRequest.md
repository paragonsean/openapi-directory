# CatalogApi.ApiCatalogPvtProductPostRequest
...
**brandId** | **Number** | ID of an existing Brand that will be associated with this product. It is mandatory to use either this field or the &#x60;BrandName&#x60; field. | [optional] 
...
**categoryId** | **Number** | ID of an existing Category that will be associated with this product. It is mandatory to use either this field or the &#x60;CategoryPath&#x60; field. | [optional] 
...
**id** | **Number** | Product’s unique numerical identifier. If not informed, it will be automatically generated by VTEX. | [optional] 
