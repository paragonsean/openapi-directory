# CatalogApi.SpecificationsInsertFieldUpdateRequest
...
**fieldGroupId** | **Number** | Specification Field Group ID. | 
**fieldGroupName** | **String** | Specification Field Group Name. | 
**fieldId** | **Number** | Specification Field ID. | 
**fieldTypeId** | **Number** | Specification Field Type ID. | 
**fieldValueId** | **Number** | Specification Field Value ID. | [optional] 
