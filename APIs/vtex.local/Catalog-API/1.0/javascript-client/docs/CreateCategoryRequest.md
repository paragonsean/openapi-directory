# CatalogApi.CreateCategoryRequest
...
**fatherCategoryId** | **Number** | ID of the parent category, apply in case of category and subcategory. | 
**globalCategoryId** | **Number** | Google Global Category ID. | 
**id** | **Number** | Category unique identifier. If not informed, it will be automatically generated by VTEX. | [optional] 
...
**score** | **Number** | Score for search sorting order. | 
