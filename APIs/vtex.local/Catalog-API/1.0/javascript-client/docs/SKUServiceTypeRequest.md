# CatalogApi.SKUServiceTypeRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**isActive** | **Boolean** | Defines if the SKU Service Type is active or not. | [default to true]
...
**name** | **String** | SKU Service Type Name. Maximum of 100 characters. | [default to &#39;Test API Sku Services&#39;]
