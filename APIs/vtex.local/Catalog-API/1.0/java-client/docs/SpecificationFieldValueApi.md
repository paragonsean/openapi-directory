...
<a id="specificationsGetFieldValue"></a>
...
import org.openapitools.client.api.SpecificationFieldValueApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    SpecificationFieldValueApi apiInstance = new SpecificationFieldValueApi(defaultClient);
    String contentType = "application/json"; // String | Describes the type of the content being sent.
    String accept = "application/json"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
    String fieldValueId = "143"; // String | 
    try {
      ApiCatalogPvtSpecificationvalueSpecificationValueIdGet200Response result = apiInstance.specificationsGetFieldValue(contentType, accept, fieldValueId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SpecificationFieldValueApi#specificationsGetFieldValue");
...
<a id="specificationsInsertFieldValue"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String contentType = "application/json"; // String | Describes the type of the content being sent.
    String accept = "application/json"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
    SpecificationsInsertFieldValueRequest specificationsInsertFieldValueRequest = new SpecificationsInsertFieldValueRequest(); // SpecificationsInsertFieldValueRequest | 
    try {
      ApiCatalogPvtSpecificationvalueSpecificationValueIdGet200Response result = apiInstance.specificationsInsertFieldValue(contentType, accept, specificationsInsertFieldValueRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SpecificationFieldValueApi#specificationsInsertFieldValue");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="specificationsUpdateFieldValue"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String contentType = "application/json"; // String | Describes the type of the content being sent.
    String accept = "application/json"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
    SpecificationsUpdateFieldValueRequest specificationsUpdateFieldValueRequest = new SpecificationsUpdateFieldValueRequest(); // SpecificationsUpdateFieldValueRequest | 
    try {
      String result = apiInstance.specificationsUpdateFieldValue(contentType, accept, specificationsUpdateFieldValueRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SpecificationFieldValueApi#specificationsUpdateFieldValue");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="specificationsValuesByFieldId"></a>
# **specificationsValuesByFieldId**
> List&lt;GetSpecFieldValue&gt; specificationsValuesByFieldId(contentType, accept, fieldId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String contentType = "application/json"; // String | Describes the type of the content being sent.
    String accept = "application/json"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
    Integer fieldId = 34; // Integer | Specification Field ID.
    try {
      List<GetSpecFieldValue> result = apiInstance.specificationsValuesByFieldId(contentType, accept, fieldId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SpecificationFieldValueApi#specificationsValuesByFieldId");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**List&lt;GetSpecFieldValue&gt;**](GetSpecFieldValue.md)
