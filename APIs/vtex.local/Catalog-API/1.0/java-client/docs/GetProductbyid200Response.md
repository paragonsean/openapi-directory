...
|**brandId** | **Integer** | Brand ID associated with this product. |  [optional] |
|**categoryId** | **Integer** | Category ID associated with this product. |  [optional] |
|**departmentId** | **Integer** | Department ID according to the product&#39;s category. |  [optional] |
...
|**id** | **Integer** | Product’s unique numerical identifier. |  [optional] |
...
|**score** | **Integer** | Value used to set the priority on the search result page. |  [optional] |
