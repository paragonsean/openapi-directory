...
|------------ | ------------- | ------------- | -------------|
|**archiveId** | **Integer** | Seller archive ID. |  [optional] |
...
|**freightCommissionPercentage** | **BigDecimal** | The percentage that must be filled in as agreed between the marketplace and the seller. If there is no such commission, please fill in the field with the value: &#x60;0.00&#x60;. |  [optional] |
...
|**fulfillmentSellerId** | **Integer** | Identification code of the seller responsible for fulfilling the order. This is an optional field used when a seller sells SKUs from another seller. If the seller sells their own SKUs, it must be left blank. |  [optional] |
...
|**productCommissionPercentage** | **BigDecimal** | The percentage that must be filled in as agreed between the marketplace and the seller. If there is no such commission, please fill in the field with the value: &#x60;0.00&#x60;. |  [optional] |
