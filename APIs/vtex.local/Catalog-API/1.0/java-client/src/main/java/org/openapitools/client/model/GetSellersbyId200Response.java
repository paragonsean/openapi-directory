...
public class GetSellersbyId200Response {
  ...
  public GetSellersbyId200Response() {
  }

  public GetSellersbyId200Response archiveId(Integer archiveId) {
  ...
  public GetSellersbyId200Response CNPJ(String CNPJ) {
    this.CNPJ = CNPJ;
    return this;
  }
  ...
  public GetSellersbyId200Response csCIdentification(String csCIdentification) {
  ...
  public GetSellersbyId200Response catalogSystemEndpoint(String catalogSystemEndpoint) {
  ...
  public GetSellersbyId200Response categoryCommissionPercentage(String categoryCommissionPercentage) {
  ...
  public GetSellersbyId200Response deliveryPolicy(String deliveryPolicy) {
  ...
  public GetSellersbyId200Response description(String description) {
  ...
  public GetSellersbyId200Response email(String email) {
    this.email = email;
    return this;
  }
  ...
  public GetSellersbyId200Response exchangeReturnPolicy(String exchangeReturnPolicy) {
  ...
  public GetSellersbyId200Response freightCommissionPercentage(BigDecimal freightCommissionPercentage) {
  ...
  public GetSellersbyId200Response fulfillmentEndpoint(String fulfillmentEndpoint) {
  ...
  public GetSellersbyId200Response fulfillmentSellerId(Integer fulfillmentSellerId) {
  ...
  public GetSellersbyId200Response isActive(Boolean isActive) {
  ...
  public GetSellersbyId200Response isBetterScope(Boolean isBetterScope) {
  ...
  public GetSellersbyId200Response merchantName(String merchantName) {
  ...
  public GetSellersbyId200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetSellersbyId200Response password(String password) {
  ...
  public GetSellersbyId200Response productCommissionPercentage(BigDecimal productCommissionPercentage) {
  ...
  public GetSellersbyId200Response secutityPrivacyPolicy(String secutityPrivacyPolicy) {
  ...
  public GetSellersbyId200Response sellerId(String sellerId) {
  ...
  public GetSellersbyId200Response sellerType(Integer sellerType) {
  ...
  public GetSellersbyId200Response trustPolicy(String trustPolicy) {
  ...
  public GetSellersbyId200Response urlLogo(String urlLogo) {
  ...
  public GetSellersbyId200Response useHybridPaymentOptions(Boolean useHybridPaymentOptions) {
  ...
  public GetSellersbyId200Response userName(String userName) {
  ...
  public boolean equals(Object o) {
    ...
    GetSellersbyId200Response getSellersbyId200Response = (GetSellersbyId200Response) o;
    return Objects.equals(this.archiveId, getSellersbyId200Response.archiveId) &&
        Objects.equals(this.CNPJ, getSellersbyId200Response.CNPJ) &&
        Objects.equals(this.csCIdentification, getSellersbyId200Response.csCIdentification) &&
        Objects.equals(this.catalogSystemEndpoint, getSellersbyId200Response.catalogSystemEndpoint) &&
        Objects.equals(this.categoryCommissionPercentage, getSellersbyId200Response.categoryCommissionPercentage) &&
        Objects.equals(this.deliveryPolicy, getSellersbyId200Response.deliveryPolicy) &&
        Objects.equals(this.description, getSellersbyId200Response.description) &&
        Objects.equals(this.email, getSellersbyId200Response.email) &&
        Objects.equals(this.exchangeReturnPolicy, getSellersbyId200Response.exchangeReturnPolicy) &&
        Objects.equals(this.freightCommissionPercentage, getSellersbyId200Response.freightCommissionPercentage) &&
        Objects.equals(this.fulfillmentEndpoint, getSellersbyId200Response.fulfillmentEndpoint) &&
        Objects.equals(this.fulfillmentSellerId, getSellersbyId200Response.fulfillmentSellerId) &&
        Objects.equals(this.isActive, getSellersbyId200Response.isActive) &&
        Objects.equals(this.isBetterScope, getSellersbyId200Response.isBetterScope) &&
        Objects.equals(this.merchantName, getSellersbyId200Response.merchantName) &&
        Objects.equals(this.name, getSellersbyId200Response.name) &&
        Objects.equals(this.password, getSellersbyId200Response.password) &&
        Objects.equals(this.productCommissionPercentage, getSellersbyId200Response.productCommissionPercentage) &&
        Objects.equals(this.secutityPrivacyPolicy, getSellersbyId200Response.secutityPrivacyPolicy) &&
        Objects.equals(this.sellerId, getSellersbyId200Response.sellerId) &&
        Objects.equals(this.sellerType, getSellersbyId200Response.sellerType) &&
        Objects.equals(this.trustPolicy, getSellersbyId200Response.trustPolicy) &&
        Objects.equals(this.urlLogo, getSellersbyId200Response.urlLogo) &&
        Objects.equals(this.useHybridPaymentOptions, getSellersbyId200Response.useHybridPaymentOptions) &&
        Objects.equals(this.userName, getSellersbyId200Response.userName);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSellersbyId200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSellersbyId200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSellersbyId200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSellersbyId200Response is not found in the empty JSON string", GetSellersbyId200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSellersbyId200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSellersbyId200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSellersbyId200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSellersbyId200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSellersbyId200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSellersbyId200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSellersbyId200Response>() {
           @Override
           public void write(JsonWriter out, GetSellersbyId200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSellersbyId200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSellersbyId200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSellersbyId200Response
   * @throws IOException if the JSON string is invalid with respect to GetSellersbyId200Response
   */
  public static GetSellersbyId200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSellersbyId200Response.class);
  }

  /**
   * Convert an instance of GetSellersbyId200Response to an JSON string
   *
   * @return JSON string
   */
