...
public class UpdateSeller200Response {
  ...
  public UpdateSeller200Response() {
  }

  public UpdateSeller200Response archiveId(Integer archiveId) {
  ...
  public UpdateSeller200Response CNPJ(String CNPJ) {
    this.CNPJ = CNPJ;
    return this;
  }
  ...
  public UpdateSeller200Response csCIdentification(String csCIdentification) {
  ...
  public UpdateSeller200Response catalogSystemEndpoint(String catalogSystemEndpoint) {
  ...
  public UpdateSeller200Response categoryCommissionPercentage(String categoryCommissionPercentage) {
  ...
  public UpdateSeller200Response deliveryPolicy(String deliveryPolicy) {
  ...
  public UpdateSeller200Response description(String description) {
  ...
  public UpdateSeller200Response email(String email) {
    this.email = email;
    return this;
  }
  ...
  public UpdateSeller200Response exchangeReturnPolicy(String exchangeReturnPolicy) {
  ...
  public UpdateSeller200Response freightCommissionPercentage(BigDecimal freightCommissionPercentage) {
  ...
  public UpdateSeller200Response fulfillmentEndpoint(String fulfillmentEndpoint) {
  ...
  public UpdateSeller200Response fulfillmentSellerId(Integer fulfillmentSellerId) {
  ...
  public UpdateSeller200Response isActive(Boolean isActive) {
  ...
  public UpdateSeller200Response isBetterScope(Boolean isBetterScope) {
  ...
  public UpdateSeller200Response merchantName(String merchantName) {
  ...
  public UpdateSeller200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateSeller200Response password(String password) {
  ...
  public UpdateSeller200Response productCommissionPercentage(BigDecimal productCommissionPercentage) {
  ...
  public UpdateSeller200Response secutityPrivacyPolicy(String secutityPrivacyPolicy) {
  ...
  public UpdateSeller200Response sellerId(String sellerId) {
  ...
  public UpdateSeller200Response sellerType(Integer sellerType) {
  ...
  public UpdateSeller200Response trustPolicy(String trustPolicy) {
  ...
  public UpdateSeller200Response urlLogo(String urlLogo) {
  ...
  public UpdateSeller200Response useHybridPaymentOptions(Boolean useHybridPaymentOptions) {
  ...
  public UpdateSeller200Response userName(String userName) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSeller200Response updateSeller200Response = (UpdateSeller200Response) o;
    return Objects.equals(this.archiveId, updateSeller200Response.archiveId) &&
        Objects.equals(this.CNPJ, updateSeller200Response.CNPJ) &&
        Objects.equals(this.csCIdentification, updateSeller200Response.csCIdentification) &&
        Objects.equals(this.catalogSystemEndpoint, updateSeller200Response.catalogSystemEndpoint) &&
        Objects.equals(this.categoryCommissionPercentage, updateSeller200Response.categoryCommissionPercentage) &&
        Objects.equals(this.deliveryPolicy, updateSeller200Response.deliveryPolicy) &&
        Objects.equals(this.description, updateSeller200Response.description) &&
        Objects.equals(this.email, updateSeller200Response.email) &&
        Objects.equals(this.exchangeReturnPolicy, updateSeller200Response.exchangeReturnPolicy) &&
        Objects.equals(this.freightCommissionPercentage, updateSeller200Response.freightCommissionPercentage) &&
        Objects.equals(this.fulfillmentEndpoint, updateSeller200Response.fulfillmentEndpoint) &&
        Objects.equals(this.fulfillmentSellerId, updateSeller200Response.fulfillmentSellerId) &&
        Objects.equals(this.isActive, updateSeller200Response.isActive) &&
        Objects.equals(this.isBetterScope, updateSeller200Response.isBetterScope) &&
        Objects.equals(this.merchantName, updateSeller200Response.merchantName) &&
        Objects.equals(this.name, updateSeller200Response.name) &&
        Objects.equals(this.password, updateSeller200Response.password) &&
        Objects.equals(this.productCommissionPercentage, updateSeller200Response.productCommissionPercentage) &&
        Objects.equals(this.secutityPrivacyPolicy, updateSeller200Response.secutityPrivacyPolicy) &&
        Objects.equals(this.sellerId, updateSeller200Response.sellerId) &&
        Objects.equals(this.sellerType, updateSeller200Response.sellerType) &&
        Objects.equals(this.trustPolicy, updateSeller200Response.trustPolicy) &&
        Objects.equals(this.urlLogo, updateSeller200Response.urlLogo) &&
        Objects.equals(this.useHybridPaymentOptions, updateSeller200Response.useHybridPaymentOptions) &&
        Objects.equals(this.userName, updateSeller200Response.userName);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSeller200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSeller200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSeller200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSeller200Response is not found in the empty JSON string", UpdateSeller200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSeller200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSeller200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSeller200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSeller200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSeller200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSeller200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSeller200Response>() {
           @Override
           public void write(JsonWriter out, UpdateSeller200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSeller200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSeller200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSeller200Response
   * @throws IOException if the JSON string is invalid with respect to UpdateSeller200Response
   */
  public static UpdateSeller200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSeller200Response.class);
  }

  /**
   * Convert an instance of UpdateSeller200Response to an JSON string
   *
   * @return JSON string
   */
