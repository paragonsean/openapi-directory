...
public class Attachment {
  ...
  public Attachment isActive(Boolean isActive) {
  ...
  public Attachment keys(List<String> keys) {
    this.keys = keys;
    return this;
  }

  public Attachment addKeysItem(String keysItem) {
    if (this.keys == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fields, attachment.fields) &&
        Objects.equals(this.id, attachment.id) &&
        Objects.equals(this.isActive, attachment.isActive) &&
        Objects.equals(this.isRequired, attachment.isRequired) &&
        Objects.equals(this.keys, attachment.keys) &&
        Objects.equals(this.name, attachment.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fields, id, isActive, isRequired, keys, name);
  }
