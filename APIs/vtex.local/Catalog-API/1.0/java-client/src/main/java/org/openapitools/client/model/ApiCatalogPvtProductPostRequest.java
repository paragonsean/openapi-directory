...
public class ApiCatalogPvtProductPostRequest {
  ...
  public ApiCatalogPvtProductPostRequest() {
  }

  @Deprecated
  public ApiCatalogPvtProductPostRequest adWordsRemarketingCode(String adWordsRemarketingCode) {
  ...
  public ApiCatalogPvtProductPostRequest brandId(Integer brandId) {
  ...
  public ApiCatalogPvtProductPostRequest brandName(String brandName) {
  ...
  public ApiCatalogPvtProductPostRequest categoryId(Integer categoryId) {
  ...
  public ApiCatalogPvtProductPostRequest categoryPath(String categoryPath) {
  ...
  public ApiCatalogPvtProductPostRequest description(String description) {
  ...
  public ApiCatalogPvtProductPostRequest descriptionShort(String descriptionShort) {
  ...
  public ApiCatalogPvtProductPostRequest id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ApiCatalogPvtProductPostRequest isActive(Boolean isActive) {
  ...
  public ApiCatalogPvtProductPostRequest isVisible(Boolean isVisible) {
  ...
  public ApiCatalogPvtProductPostRequest keyWords(String keyWords) {
  ...
  public ApiCatalogPvtProductPostRequest linkId(String linkId) {
    this.linkId = linkId;
    return this;
  }
  ...
  @Deprecated
  public ApiCatalogPvtProductPostRequest lomadeeCampaignCode(String lomadeeCampaignCode) {
  ...
  public ApiCatalogPvtProductPostRequest metaTagDescription(String metaTagDescription) {
  ...
  public ApiCatalogPvtProductPostRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ApiCatalogPvtProductPostRequest refId(String refId) {
    this.refId = refId;
    return this;
  }
  ...
  public ApiCatalogPvtProductPostRequest releaseDate(String releaseDate) {
  ...
  public ApiCatalogPvtProductPostRequest score(Integer score) {
    this.score = score;
    return this;
  }
  ...
  public ApiCatalogPvtProductPostRequest showWithoutStock(Boolean showWithoutStock) {
  ...
  @Deprecated
  public ApiCatalogPvtProductPostRequest supplierId(Integer supplierId) {
  ...
  public ApiCatalogPvtProductPostRequest taxCode(String taxCode) {
  ...
  public ApiCatalogPvtProductPostRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiCatalogPvtProductPostRequest apiCatalogPvtProductPostRequest = (ApiCatalogPvtProductPostRequest) o;
    return Objects.equals(this.adWordsRemarketingCode, apiCatalogPvtProductPostRequest.adWordsRemarketingCode) &&
        Objects.equals(this.brandId, apiCatalogPvtProductPostRequest.brandId) &&
        Objects.equals(this.brandName, apiCatalogPvtProductPostRequest.brandName) &&
        Objects.equals(this.categoryId, apiCatalogPvtProductPostRequest.categoryId) &&
        Objects.equals(this.categoryPath, apiCatalogPvtProductPostRequest.categoryPath) &&
        Objects.equals(this.description, apiCatalogPvtProductPostRequest.description) &&
        Objects.equals(this.descriptionShort, apiCatalogPvtProductPostRequest.descriptionShort) &&
        Objects.equals(this.id, apiCatalogPvtProductPostRequest.id) &&
        Objects.equals(this.isActive, apiCatalogPvtProductPostRequest.isActive) &&
        Objects.equals(this.isVisible, apiCatalogPvtProductPostRequest.isVisible) &&
        Objects.equals(this.keyWords, apiCatalogPvtProductPostRequest.keyWords) &&
        Objects.equals(this.linkId, apiCatalogPvtProductPostRequest.linkId) &&
        Objects.equals(this.lomadeeCampaignCode, apiCatalogPvtProductPostRequest.lomadeeCampaignCode) &&
        Objects.equals(this.metaTagDescription, apiCatalogPvtProductPostRequest.metaTagDescription) &&
        Objects.equals(this.name, apiCatalogPvtProductPostRequest.name) &&
        Objects.equals(this.refId, apiCatalogPvtProductPostRequest.refId) &&
        Objects.equals(this.releaseDate, apiCatalogPvtProductPostRequest.releaseDate) &&
        Objects.equals(this.score, apiCatalogPvtProductPostRequest.score) &&
        Objects.equals(this.showWithoutStock, apiCatalogPvtProductPostRequest.showWithoutStock) &&
        Objects.equals(this.supplierId, apiCatalogPvtProductPostRequest.supplierId) &&
        Objects.equals(this.taxCode, apiCatalogPvtProductPostRequest.taxCode) &&
        Objects.equals(this.title, apiCatalogPvtProductPostRequest.title);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adWordsRemarketingCode, brandId, brandName, categoryId, categoryPath, description, descriptionShort, id, isActive, isVisible, keyWords, linkId, lomadeeCampaignCode, metaTagDescription, name, refId, releaseDate, score, showWithoutStock, supplierId, taxCode, title);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiCatalogPvtProductPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiCatalogPvtProductPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiCatalogPvtProductPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiCatalogPvtProductPostRequest is not found in the empty JSON string", ApiCatalogPvtProductPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiCatalogPvtProductPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiCatalogPvtProductPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiCatalogPvtProductPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiCatalogPvtProductPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiCatalogPvtProductPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiCatalogPvtProductPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiCatalogPvtProductPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiCatalogPvtProductPostRequest>() {
           @Override
           public void write(JsonWriter out, ApiCatalogPvtProductPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiCatalogPvtProductPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiCatalogPvtProductPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiCatalogPvtProductPostRequest
   * @throws IOException if the JSON string is invalid with respect to ApiCatalogPvtProductPostRequest
   */
  public static ApiCatalogPvtProductPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiCatalogPvtProductPostRequest.class);
  }

  /**
   * Convert an instance of ApiCatalogPvtProductPostRequest to an JSON string
   *
   * @return JSON string
   */
