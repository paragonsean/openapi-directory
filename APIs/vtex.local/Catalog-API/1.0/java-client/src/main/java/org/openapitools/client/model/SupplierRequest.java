...
public class SupplierRequest {
  ...
  public SupplierRequest cellPhone(String cellPhone) {
  ...
  public SupplierRequest cnpj(String cnpj) {
    this.cnpj = cnpj;
    return this;
  }
  ...
  public SupplierRequest corporateName(String corporateName) {
  ...
  public SupplierRequest corportePhone(String corportePhone) {
  ...
  public SupplierRequest isActive(Boolean isActive) {
  ...
  public SupplierRequest stateInscription(String stateInscription) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cellPhone, supplierRequest.cellPhone) &&
        Objects.equals(this.cnpj, supplierRequest.cnpj) &&
        Objects.equals(this.corporateName, supplierRequest.corporateName) &&
        Objects.equals(this.corportePhone, supplierRequest.corportePhone) &&
        Objects.equals(this.email, supplierRequest.email) &&
        Objects.equals(this.isActive, supplierRequest.isActive) &&
        Objects.equals(this.name, supplierRequest.name) &&
        Objects.equals(this.phone, supplierRequest.phone) &&
        Objects.equals(this.stateInscription, supplierRequest.stateInscription);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cellPhone, cnpj, corporateName, corportePhone, email, isActive, name, phone, stateInscription);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("CorportePhone");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupplierRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupplierRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupplierRequest is not found in the empty JSON string", SupplierRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupplierRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupplierRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SupplierRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("CorporateName").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("CorportePhone").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("StateInscription").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupplierRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupplierRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupplierRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupplierRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SupplierRequest>() {
           @Override
           public void write(JsonWriter out, SupplierRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupplierRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupplierRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupplierRequest
   * @throws IOException if the JSON string is invalid with respect to SupplierRequest
   */
  public static SupplierRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupplierRequest.class);
  }

  /**
   * Convert an instance of SupplierRequest to an JSON string
   *
   * @return JSON string
   */
