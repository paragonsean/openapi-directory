...
public class RequestBody7 {
  ...
  public RequestBody7 categoryId(Integer categoryId) {
  ...
  public RequestBody7 defaultValue(String defaultValue) {
  ...
  public RequestBody7 description(String description) {
  ...
  public RequestBody7 fieldGroupId(Integer fieldGroupId) {
  ...
  public RequestBody7 fieldTypeId(Integer fieldTypeId) {
  ...
  public RequestBody7 isActive(Boolean isActive) {
  ...
  public RequestBody7 isFilter(Boolean isFilter) {
  ...
  public RequestBody7 isOnProductDetails(Boolean isOnProductDetails) {
  ...
  public RequestBody7 isRequired(Boolean isRequired) {
  ...
  public RequestBody7 isSideMenuLinkActive(Boolean isSideMenuLinkActive) {
  ...
  public RequestBody7 isStockKeepingUnit(Boolean isStockKeepingUnit) {
  ...
  public RequestBody7 isTopMenuLinkActive(Boolean isTopMenuLinkActive) {
  ...
  @Deprecated
  public RequestBody7 isWizard(Boolean isWizard) {
  ...
  public RequestBody7 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RequestBody7 position(Integer position) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.categoryId, requestBody7.categoryId) &&
        Objects.equals(this.defaultValue, requestBody7.defaultValue) &&
        Objects.equals(this.description, requestBody7.description) &&
        Objects.equals(this.fieldGroupId, requestBody7.fieldGroupId) &&
        Objects.equals(this.fieldTypeId, requestBody7.fieldTypeId) &&
        Objects.equals(this.isActive, requestBody7.isActive) &&
        Objects.equals(this.isFilter, requestBody7.isFilter) &&
        Objects.equals(this.isOnProductDetails, requestBody7.isOnProductDetails) &&
        Objects.equals(this.isRequired, requestBody7.isRequired) &&
        Objects.equals(this.isSideMenuLinkActive, requestBody7.isSideMenuLinkActive) &&
        Objects.equals(this.isStockKeepingUnit, requestBody7.isStockKeepingUnit) &&
        Objects.equals(this.isTopMenuLinkActive, requestBody7.isTopMenuLinkActive) &&
        Objects.equals(this.isWizard, requestBody7.isWizard) &&
        Objects.equals(this.name, requestBody7.name) &&
        Objects.equals(this.position, requestBody7.position);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RequestBody7
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RequestBody7.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RequestBody7 is not found in the empty JSON string", RequestBody7.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RequestBody7.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RequestBody7` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RequestBody7.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RequestBody7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RequestBody7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RequestBody7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RequestBody7.class));

       return (TypeAdapter<T>) new TypeAdapter<RequestBody7>() {
           @Override
           public void write(JsonWriter out, RequestBody7 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RequestBody7 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RequestBody7 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RequestBody7
   * @throws IOException if the JSON string is invalid with respect to RequestBody7
   */
  public static RequestBody7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RequestBody7.class);
  }

  /**
   * Convert an instance of RequestBody7 to an JSON string
   *
   * @return JSON string
   */
