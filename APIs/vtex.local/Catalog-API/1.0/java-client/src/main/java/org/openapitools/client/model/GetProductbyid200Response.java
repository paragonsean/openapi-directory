...
public class GetProductbyid200Response {
  ...
  public GetProductbyid200Response() {
  }

  @Deprecated
  public GetProductbyid200Response adWordsRemarketingCode(String adWordsRemarketingCode) {
  ...
  public GetProductbyid200Response brandId(Integer brandId) {
  ...
  public GetProductbyid200Response categoryId(Integer categoryId) {
  ...
  public GetProductbyid200Response departmentId(Integer departmentId) {
  ...
  public GetProductbyid200Response description(String description) {
  ...
  public GetProductbyid200Response descriptionShort(String descriptionShort) {
  ...
  public GetProductbyid200Response id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public GetProductbyid200Response isActive(Boolean isActive) {
  ...
  public GetProductbyid200Response isVisible(Boolean isVisible) {
  ...
  public GetProductbyid200Response keyWords(String keyWords) {
  ...
  public GetProductbyid200Response linkId(String linkId) {
    this.linkId = linkId;
    return this;
  }
  ...
  @Deprecated
  public GetProductbyid200Response lomadeeCampaignCode(String lomadeeCampaignCode) {
  ...
  public GetProductbyid200Response metaTagDescription(String metaTagDescription) {
  ...
  public GetProductbyid200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetProductbyid200Response refId(String refId) {
    this.refId = refId;
    return this;
  }
  ...
  public GetProductbyid200Response releaseDate(String releaseDate) {
  ...
  public GetProductbyid200Response score(Integer score) {
    this.score = score;
    return this;
  }
  ...
  public GetProductbyid200Response showWithoutStock(Boolean showWithoutStock) {
  ...
  @Deprecated
  public GetProductbyid200Response supplierId(Integer supplierId) {
  ...
  public GetProductbyid200Response taxCode(String taxCode) {
  ...
  public GetProductbyid200Response title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetProductbyid200Response getProductbyid200Response = (GetProductbyid200Response) o;
    return Objects.equals(this.adWordsRemarketingCode, getProductbyid200Response.adWordsRemarketingCode) &&
        Objects.equals(this.brandId, getProductbyid200Response.brandId) &&
        Objects.equals(this.categoryId, getProductbyid200Response.categoryId) &&
        Objects.equals(this.departmentId, getProductbyid200Response.departmentId) &&
        Objects.equals(this.description, getProductbyid200Response.description) &&
        Objects.equals(this.descriptionShort, getProductbyid200Response.descriptionShort) &&
        Objects.equals(this.id, getProductbyid200Response.id) &&
        Objects.equals(this.isActive, getProductbyid200Response.isActive) &&
        Objects.equals(this.isVisible, getProductbyid200Response.isVisible) &&
        Objects.equals(this.keyWords, getProductbyid200Response.keyWords) &&
        Objects.equals(this.linkId, getProductbyid200Response.linkId) &&
        Objects.equals(this.lomadeeCampaignCode, getProductbyid200Response.lomadeeCampaignCode) &&
        Objects.equals(this.metaTagDescription, getProductbyid200Response.metaTagDescription) &&
        Objects.equals(this.name, getProductbyid200Response.name) &&
        Objects.equals(this.refId, getProductbyid200Response.refId) &&
        Objects.equals(this.releaseDate, getProductbyid200Response.releaseDate) &&
        Objects.equals(this.score, getProductbyid200Response.score) &&
        Objects.equals(this.showWithoutStock, getProductbyid200Response.showWithoutStock) &&
        Objects.equals(this.supplierId, getProductbyid200Response.supplierId) &&
        Objects.equals(this.taxCode, getProductbyid200Response.taxCode) &&
        Objects.equals(this.title, getProductbyid200Response.title);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adWordsRemarketingCode, brandId, categoryId, departmentId, description, descriptionShort, id, isActive, isVisible, keyWords, linkId, lomadeeCampaignCode, metaTagDescription, name, refId, releaseDate, score, showWithoutStock, supplierId, taxCode, title);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProductbyid200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProductbyid200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProductbyid200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProductbyid200Response is not found in the empty JSON string", GetProductbyid200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProductbyid200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProductbyid200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProductbyid200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProductbyid200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProductbyid200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProductbyid200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProductbyid200Response>() {
           @Override
           public void write(JsonWriter out, GetProductbyid200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProductbyid200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProductbyid200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProductbyid200Response
   * @throws IOException if the JSON string is invalid with respect to GetProductbyid200Response
   */
  public static GetProductbyid200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProductbyid200Response.class);
  }

  /**
   * Convert an instance of GetProductbyid200Response to an JSON string
   *
   * @return JSON string
   */
