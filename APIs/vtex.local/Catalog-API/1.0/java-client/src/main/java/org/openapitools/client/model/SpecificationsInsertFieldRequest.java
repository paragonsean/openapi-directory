...
public class SpecificationsInsertFieldRequest {
  ...
  public SpecificationsInsertFieldRequest() {
  }

  public SpecificationsInsertFieldRequest categoryId(Integer categoryId) {
  ...
  public SpecificationsInsertFieldRequest defaultValue(String defaultValue) {
  ...
  public SpecificationsInsertFieldRequest description(String description) {
  ...
  public SpecificationsInsertFieldRequest fieldGroupId(Integer fieldGroupId) {
  ...
  public SpecificationsInsertFieldRequest fieldGroupName(String fieldGroupName) {
  ...
  public SpecificationsInsertFieldRequest fieldId(Integer fieldId) {
  ...
  public SpecificationsInsertFieldRequest fieldTypeId(Integer fieldTypeId) {
  ...
  public SpecificationsInsertFieldRequest fieldValueId(Integer fieldValueId) {
  ...
  public SpecificationsInsertFieldRequest isActive(Boolean isActive) {
  ...
  public SpecificationsInsertFieldRequest isFilter(Boolean isFilter) {
  ...
  public SpecificationsInsertFieldRequest isOnProductDetails(Boolean isOnProductDetails) {
  ...
  public SpecificationsInsertFieldRequest isRequired(Boolean isRequired) {
  ...
  public SpecificationsInsertFieldRequest isSideMenuLinkActive(Boolean isSideMenuLinkActive) {
  ...
  public SpecificationsInsertFieldRequest isStockKeepingUnit(Boolean isStockKeepingUnit) {
  ...
  public SpecificationsInsertFieldRequest isTopMenuLinkActive(Boolean isTopMenuLinkActive) {
  ...
  @Deprecated
  public SpecificationsInsertFieldRequest isWizard(Boolean isWizard) {
  ...
  public SpecificationsInsertFieldRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SpecificationsInsertFieldRequest position(Integer position) {
  ...
  public boolean equals(Object o) {
    ...
    SpecificationsInsertFieldRequest specificationsInsertFieldRequest = (SpecificationsInsertFieldRequest) o;
    return Objects.equals(this.categoryId, specificationsInsertFieldRequest.categoryId) &&
        Objects.equals(this.defaultValue, specificationsInsertFieldRequest.defaultValue) &&
        Objects.equals(this.description, specificationsInsertFieldRequest.description) &&
        Objects.equals(this.fieldGroupId, specificationsInsertFieldRequest.fieldGroupId) &&
        Objects.equals(this.fieldGroupName, specificationsInsertFieldRequest.fieldGroupName) &&
        Objects.equals(this.fieldId, specificationsInsertFieldRequest.fieldId) &&
        Objects.equals(this.fieldTypeId, specificationsInsertFieldRequest.fieldTypeId) &&
        Objects.equals(this.fieldValueId, specificationsInsertFieldRequest.fieldValueId) &&
        Objects.equals(this.isActive, specificationsInsertFieldRequest.isActive) &&
        Objects.equals(this.isFilter, specificationsInsertFieldRequest.isFilter) &&
        Objects.equals(this.isOnProductDetails, specificationsInsertFieldRequest.isOnProductDetails) &&
        Objects.equals(this.isRequired, specificationsInsertFieldRequest.isRequired) &&
        Objects.equals(this.isSideMenuLinkActive, specificationsInsertFieldRequest.isSideMenuLinkActive) &&
        Objects.equals(this.isStockKeepingUnit, specificationsInsertFieldRequest.isStockKeepingUnit) &&
        Objects.equals(this.isTopMenuLinkActive, specificationsInsertFieldRequest.isTopMenuLinkActive) &&
        Objects.equals(this.isWizard, specificationsInsertFieldRequest.isWizard) &&
        Objects.equals(this.name, specificationsInsertFieldRequest.name) &&
        Objects.equals(this.position, specificationsInsertFieldRequest.position);
  }
  ...
  public String toString() {
    ...
    sb.append("class SpecificationsInsertFieldRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SpecificationsInsertFieldRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpecificationsInsertFieldRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SpecificationsInsertFieldRequest is not found in the empty JSON string", SpecificationsInsertFieldRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SpecificationsInsertFieldRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SpecificationsInsertFieldRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SpecificationsInsertFieldRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SpecificationsInsertFieldRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SpecificationsInsertFieldRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SpecificationsInsertFieldRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SpecificationsInsertFieldRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SpecificationsInsertFieldRequest>() {
           @Override
           public void write(JsonWriter out, SpecificationsInsertFieldRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SpecificationsInsertFieldRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SpecificationsInsertFieldRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SpecificationsInsertFieldRequest
   * @throws IOException if the JSON string is invalid with respect to SpecificationsInsertFieldRequest
   */
  public static SpecificationsInsertFieldRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SpecificationsInsertFieldRequest.class);
  }

  /**
   * Convert an instance of SpecificationsInsertFieldRequest to an JSON string
   *
   * @return JSON string
   */
