...
public class ApiCatalogPvtCategoryCategoryIdPutRequest {
  ...
  public ApiCatalogPvtCategoryCategoryIdPutRequest() {
  }

  public ApiCatalogPvtCategoryCategoryIdPutRequest activeStoreFrontLink(Boolean activeStoreFrontLink) {
  ...
  @Deprecated
  public ApiCatalogPvtCategoryCategoryIdPutRequest adWordsRemarketingCode(String adWordsRemarketingCode) {
  ...
  public ApiCatalogPvtCategoryCategoryIdPutRequest description(String description) {
  ...
  public ApiCatalogPvtCategoryCategoryIdPutRequest fatherCategoryId(Integer fatherCategoryId) {
  ...
  public ApiCatalogPvtCategoryCategoryIdPutRequest globalCategoryId(Integer globalCategoryId) {
  ...
  public ApiCatalogPvtCategoryCategoryIdPutRequest isActive(Boolean isActive) {
  ...
  public ApiCatalogPvtCategoryCategoryIdPutRequest keywords(String keywords) {
  ...
  @Deprecated
  public ApiCatalogPvtCategoryCategoryIdPutRequest lomadeeCampaignCode(String lomadeeCampaignCode) {
  ...
  public ApiCatalogPvtCategoryCategoryIdPutRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ApiCatalogPvtCategoryCategoryIdPutRequest score(Integer score) {
    this.score = score;
    return this;
  }
  ...
  public ApiCatalogPvtCategoryCategoryIdPutRequest showBrandFilter(Boolean showBrandFilter) {
  ...
  public ApiCatalogPvtCategoryCategoryIdPutRequest showInStoreFront(Boolean showInStoreFront) {
  ...
  public ApiCatalogPvtCategoryCategoryIdPutRequest stockKeepingUnitSelectionMode(String stockKeepingUnitSelectionMode) {
  ...
  public ApiCatalogPvtCategoryCategoryIdPutRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiCatalogPvtCategoryCategoryIdPutRequest apiCatalogPvtCategoryCategoryIdPutRequest = (ApiCatalogPvtCategoryCategoryIdPutRequest) o;
    return Objects.equals(this.activeStoreFrontLink, apiCatalogPvtCategoryCategoryIdPutRequest.activeStoreFrontLink) &&
        Objects.equals(this.adWordsRemarketingCode, apiCatalogPvtCategoryCategoryIdPutRequest.adWordsRemarketingCode) &&
        Objects.equals(this.description, apiCatalogPvtCategoryCategoryIdPutRequest.description) &&
        Objects.equals(this.fatherCategoryId, apiCatalogPvtCategoryCategoryIdPutRequest.fatherCategoryId) &&
        Objects.equals(this.globalCategoryId, apiCatalogPvtCategoryCategoryIdPutRequest.globalCategoryId) &&
        Objects.equals(this.isActive, apiCatalogPvtCategoryCategoryIdPutRequest.isActive) &&
        Objects.equals(this.keywords, apiCatalogPvtCategoryCategoryIdPutRequest.keywords) &&
        Objects.equals(this.lomadeeCampaignCode, apiCatalogPvtCategoryCategoryIdPutRequest.lomadeeCampaignCode) &&
        Objects.equals(this.name, apiCatalogPvtCategoryCategoryIdPutRequest.name) &&
        Objects.equals(this.score, apiCatalogPvtCategoryCategoryIdPutRequest.score) &&
        Objects.equals(this.showBrandFilter, apiCatalogPvtCategoryCategoryIdPutRequest.showBrandFilter) &&
        Objects.equals(this.showInStoreFront, apiCatalogPvtCategoryCategoryIdPutRequest.showInStoreFront) &&
        Objects.equals(this.stockKeepingUnitSelectionMode, apiCatalogPvtCategoryCategoryIdPutRequest.stockKeepingUnitSelectionMode) &&
        Objects.equals(this.title, apiCatalogPvtCategoryCategoryIdPutRequest.title);
  }

  @Override
  public int hashCode() {
    return Objects.hash(activeStoreFrontLink, adWordsRemarketingCode, description, fatherCategoryId, globalCategoryId, isActive, keywords, lomadeeCampaignCode, name, score, showBrandFilter, showInStoreFront, stockKeepingUnitSelectionMode, title);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiCatalogPvtCategoryCategoryIdPutRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiCatalogPvtCategoryCategoryIdPutRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiCatalogPvtCategoryCategoryIdPutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiCatalogPvtCategoryCategoryIdPutRequest is not found in the empty JSON string", ApiCatalogPvtCategoryCategoryIdPutRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiCatalogPvtCategoryCategoryIdPutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiCatalogPvtCategoryCategoryIdPutRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiCatalogPvtCategoryCategoryIdPutRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiCatalogPvtCategoryCategoryIdPutRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiCatalogPvtCategoryCategoryIdPutRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiCatalogPvtCategoryCategoryIdPutRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiCatalogPvtCategoryCategoryIdPutRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiCatalogPvtCategoryCategoryIdPutRequest>() {
           @Override
           public void write(JsonWriter out, ApiCatalogPvtCategoryCategoryIdPutRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiCatalogPvtCategoryCategoryIdPutRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiCatalogPvtCategoryCategoryIdPutRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiCatalogPvtCategoryCategoryIdPutRequest
   * @throws IOException if the JSON string is invalid with respect to ApiCatalogPvtCategoryCategoryIdPutRequest
   */
  public static ApiCatalogPvtCategoryCategoryIdPutRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiCatalogPvtCategoryCategoryIdPutRequest.class);
  }

  /**
   * Convert an instance of ApiCatalogPvtCategoryCategoryIdPutRequest to an JSON string
   *
   * @return JSON string
   */
