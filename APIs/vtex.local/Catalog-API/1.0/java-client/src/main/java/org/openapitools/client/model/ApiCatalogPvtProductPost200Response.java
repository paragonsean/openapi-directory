...
public class ApiCatalogPvtProductPost200Response {
  ...
  public ApiCatalogPvtProductPost200Response() {
  }

  @Deprecated
  public ApiCatalogPvtProductPost200Response adWordsRemarketingCode(String adWordsRemarketingCode) {
  ...
  public ApiCatalogPvtProductPost200Response brandId(Integer brandId) {
  ...
  public ApiCatalogPvtProductPost200Response categoryId(Integer categoryId) {
  ...
  public ApiCatalogPvtProductPost200Response departmentId(Integer departmentId) {
  ...
  public ApiCatalogPvtProductPost200Response description(String description) {
  ...
  public ApiCatalogPvtProductPost200Response descriptionShort(String descriptionShort) {
  ...
  public ApiCatalogPvtProductPost200Response id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ApiCatalogPvtProductPost200Response isActive(Boolean isActive) {
  ...
  public ApiCatalogPvtProductPost200Response isVisible(Boolean isVisible) {
  ...
  public ApiCatalogPvtProductPost200Response keyWords(String keyWords) {
  ...
  public ApiCatalogPvtProductPost200Response linkId(String linkId) {
    this.linkId = linkId;
    return this;
  }
  ...
  @Deprecated
  public ApiCatalogPvtProductPost200Response lomadeeCampaignCode(String lomadeeCampaignCode) {
  ...
  public ApiCatalogPvtProductPost200Response metaTagDescription(String metaTagDescription) {
  ...
  public ApiCatalogPvtProductPost200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ApiCatalogPvtProductPost200Response refId(String refId) {
    this.refId = refId;
    return this;
  }
  ...
  public ApiCatalogPvtProductPost200Response releaseDate(String releaseDate) {
  ...
  public ApiCatalogPvtProductPost200Response score(Integer score) {
    this.score = score;
    return this;
  }
  ...
  public ApiCatalogPvtProductPost200Response showWithoutStock(Boolean showWithoutStock) {
  ...
  @Deprecated
  public ApiCatalogPvtProductPost200Response supplierId(Integer supplierId) {
  ...
  public ApiCatalogPvtProductPost200Response taxCode(String taxCode) {
  ...
  public ApiCatalogPvtProductPost200Response title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiCatalogPvtProductPost200Response apiCatalogPvtProductPost200Response = (ApiCatalogPvtProductPost200Response) o;
    return Objects.equals(this.adWordsRemarketingCode, apiCatalogPvtProductPost200Response.adWordsRemarketingCode) &&
        Objects.equals(this.brandId, apiCatalogPvtProductPost200Response.brandId) &&
        Objects.equals(this.categoryId, apiCatalogPvtProductPost200Response.categoryId) &&
        Objects.equals(this.departmentId, apiCatalogPvtProductPost200Response.departmentId) &&
        Objects.equals(this.description, apiCatalogPvtProductPost200Response.description) &&
        Objects.equals(this.descriptionShort, apiCatalogPvtProductPost200Response.descriptionShort) &&
        Objects.equals(this.id, apiCatalogPvtProductPost200Response.id) &&
        Objects.equals(this.isActive, apiCatalogPvtProductPost200Response.isActive) &&
        Objects.equals(this.isVisible, apiCatalogPvtProductPost200Response.isVisible) &&
        Objects.equals(this.keyWords, apiCatalogPvtProductPost200Response.keyWords) &&
        Objects.equals(this.linkId, apiCatalogPvtProductPost200Response.linkId) &&
        Objects.equals(this.lomadeeCampaignCode, apiCatalogPvtProductPost200Response.lomadeeCampaignCode) &&
        Objects.equals(this.metaTagDescription, apiCatalogPvtProductPost200Response.metaTagDescription) &&
        Objects.equals(this.name, apiCatalogPvtProductPost200Response.name) &&
        Objects.equals(this.refId, apiCatalogPvtProductPost200Response.refId) &&
        Objects.equals(this.releaseDate, apiCatalogPvtProductPost200Response.releaseDate) &&
        Objects.equals(this.score, apiCatalogPvtProductPost200Response.score) &&
        Objects.equals(this.showWithoutStock, apiCatalogPvtProductPost200Response.showWithoutStock) &&
        Objects.equals(this.supplierId, apiCatalogPvtProductPost200Response.supplierId) &&
        Objects.equals(this.taxCode, apiCatalogPvtProductPost200Response.taxCode) &&
        Objects.equals(this.title, apiCatalogPvtProductPost200Response.title);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiCatalogPvtProductPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiCatalogPvtProductPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiCatalogPvtProductPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiCatalogPvtProductPost200Response is not found in the empty JSON string", ApiCatalogPvtProductPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiCatalogPvtProductPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiCatalogPvtProductPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiCatalogPvtProductPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiCatalogPvtProductPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiCatalogPvtProductPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiCatalogPvtProductPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiCatalogPvtProductPost200Response>() {
           @Override
           public void write(JsonWriter out, ApiCatalogPvtProductPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiCatalogPvtProductPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiCatalogPvtProductPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiCatalogPvtProductPost200Response
   * @throws IOException if the JSON string is invalid with respect to ApiCatalogPvtProductPost200Response
   */
  public static ApiCatalogPvtProductPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiCatalogPvtProductPost200Response.class);
  }

  /**
   * Convert an instance of ApiCatalogPvtProductPost200Response to an JSON string
   *
   * @return JSON string
   */
