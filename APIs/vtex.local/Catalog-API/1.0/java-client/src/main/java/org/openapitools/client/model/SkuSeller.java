...
public class SkuSeller {
  ...
  public SkuSeller freightCommissionPercentage(BigDecimal freightCommissionPercentage) {
  ...
  public SkuSeller isActive(Boolean isActive) {
  ...
  public SkuSeller productCommissionPercentage(BigDecimal productCommissionPercentage) {
  ...
  public SkuSeller sellerId(String sellerId) {
  ...
  public SkuSeller sellerStockKeepingUnitId(String sellerStockKeepingUnitId) {
  ...
  public SkuSeller stockKeepingUnitId(Integer stockKeepingUnitId) {
  ...
  public boolean equals(Object o) {
    ...
    SkuSeller skuSeller = (SkuSeller) o;
    return Objects.equals(this.freightCommissionPercentage, skuSeller.freightCommissionPercentage) &&
        Objects.equals(this.isActive, skuSeller.isActive) &&
        Objects.equals(this.productCommissionPercentage, skuSeller.productCommissionPercentage) &&
        Objects.equals(this.sellerId, skuSeller.sellerId) &&
        Objects.equals(this.sellerStockKeepingUnitId, skuSeller.sellerStockKeepingUnitId) &&
        Objects.equals(this.stockKeepingUnitId, skuSeller.stockKeepingUnitId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SkuSeller
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SkuSeller.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SkuSeller is not found in the empty JSON string", SkuSeller.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SkuSeller.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SkuSeller` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SkuSeller.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SkuSeller.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SkuSeller' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SkuSeller> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SkuSeller.class));

       return (TypeAdapter<T>) new TypeAdapter<SkuSeller>() {
           @Override
           public void write(JsonWriter out, SkuSeller value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SkuSeller read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SkuSeller given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SkuSeller
   * @throws IOException if the JSON string is invalid with respect to SkuSeller
   */
  public static SkuSeller fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SkuSeller.class);
  }

  /**
   * Convert an instance of SkuSeller to an JSON string
   *
   * @return JSON string
   */
