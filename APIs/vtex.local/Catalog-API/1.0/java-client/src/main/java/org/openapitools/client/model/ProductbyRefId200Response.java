...
public class ProductbyRefId200Response {
  ...
  private List<Integer> listStoreId = new ArrayList<>();
  ...
  public ProductbyRefId200Response() {
  }

  @Deprecated
  public ProductbyRefId200Response adWordsRemarketingCode(String adWordsRemarketingCode) {
  ...
  public ProductbyRefId200Response brandId(Integer brandId) {
  ...
  public ProductbyRefId200Response categoryId(Integer categoryId) {
  ...
  public ProductbyRefId200Response departmentId(Integer departmentId) {
  ...
  public ProductbyRefId200Response description(String description) {
  ...
  public ProductbyRefId200Response descriptionShort(String descriptionShort) {
  ...
  public ProductbyRefId200Response id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ProductbyRefId200Response isActive(Boolean isActive) {
  ...
  public ProductbyRefId200Response isVisible(Boolean isVisible) {
  ...
  public ProductbyRefId200Response keyWords(String keyWords) {
  ...
  public ProductbyRefId200Response linkId(String linkId) {
    this.linkId = linkId;
    return this;
  }
  ...
  public ProductbyRefId200Response listStoreId(List<Integer> listStoreId) {
    this.listStoreId = listStoreId;
    return this;
  }

  public ProductbyRefId200Response addListStoreIdItem(Integer listStoreIdItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Integer> getListStoreId() {
    return listStoreId;
  }

  public void setListStoreId(List<Integer> listStoreId) {
    this.listStoreId = listStoreId;
  }


  @Deprecated
  public ProductbyRefId200Response lomadeeCampaignCode(String lomadeeCampaignCode) {
  ...
  public ProductbyRefId200Response metaTagDescription(String metaTagDescription) {
  ...
  public ProductbyRefId200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductbyRefId200Response refId(String refId) {
    this.refId = refId;
    return this;
  }
  ...
  public ProductbyRefId200Response releaseDate(String releaseDate) {
  ...
  public ProductbyRefId200Response showWithoutStock(Boolean showWithoutStock) {
  ...
  public ProductbyRefId200Response supplierId(Integer supplierId) {
  ...
  public ProductbyRefId200Response taxCode(String taxCode) {
  ...
  public ProductbyRefId200Response title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProductbyRefId200Response productbyRefId200Response = (ProductbyRefId200Response) o;
    return Objects.equals(this.adWordsRemarketingCode, productbyRefId200Response.adWordsRemarketingCode) &&
        Objects.equals(this.brandId, productbyRefId200Response.brandId) &&
        Objects.equals(this.categoryId, productbyRefId200Response.categoryId) &&
        Objects.equals(this.departmentId, productbyRefId200Response.departmentId) &&
        Objects.equals(this.description, productbyRefId200Response.description) &&
        Objects.equals(this.descriptionShort, productbyRefId200Response.descriptionShort) &&
        Objects.equals(this.id, productbyRefId200Response.id) &&
        Objects.equals(this.isActive, productbyRefId200Response.isActive) &&
        Objects.equals(this.isVisible, productbyRefId200Response.isVisible) &&
        Objects.equals(this.keyWords, productbyRefId200Response.keyWords) &&
        Objects.equals(this.linkId, productbyRefId200Response.linkId) &&
        Objects.equals(this.listStoreId, productbyRefId200Response.listStoreId) &&
        Objects.equals(this.lomadeeCampaignCode, productbyRefId200Response.lomadeeCampaignCode) &&
        Objects.equals(this.metaTagDescription, productbyRefId200Response.metaTagDescription) &&
        Objects.equals(this.name, productbyRefId200Response.name) &&
        Objects.equals(this.refId, productbyRefId200Response.refId) &&
        Objects.equals(this.releaseDate, productbyRefId200Response.releaseDate) &&
        Objects.equals(this.showWithoutStock, productbyRefId200Response.showWithoutStock) &&
        Objects.equals(this.supplierId, productbyRefId200Response.supplierId) &&
        Objects.equals(this.taxCode, productbyRefId200Response.taxCode) &&
        Objects.equals(this.title, productbyRefId200Response.title);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductbyRefId200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProductbyRefId200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductbyRefId200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductbyRefId200Response is not found in the empty JSON string", ProductbyRefId200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductbyRefId200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductbyRefId200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductbyRefId200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductbyRefId200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductbyRefId200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductbyRefId200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductbyRefId200Response>() {
           @Override
           public void write(JsonWriter out, ProductbyRefId200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductbyRefId200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProductbyRefId200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProductbyRefId200Response
   * @throws IOException if the JSON string is invalid with respect to ProductbyRefId200Response
   */
  public static ProductbyRefId200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductbyRefId200Response.class);
  }

  /**
   * Convert an instance of ProductbyRefId200Response to an JSON string
   *
   * @return JSON string
   */
