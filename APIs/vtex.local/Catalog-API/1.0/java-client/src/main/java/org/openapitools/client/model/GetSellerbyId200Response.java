...
public class GetSellerbyId200Response {
  ...
  public GetSellerbyId200Response() {
  }

  public GetSellerbyId200Response archiveId(Integer archiveId) {
  ...
  public GetSellerbyId200Response CNPJ(String CNPJ) {
    this.CNPJ = CNPJ;
    return this;
  }
  ...
  public GetSellerbyId200Response csCIdentification(String csCIdentification) {
  ...
  public GetSellerbyId200Response catalogSystemEndpoint(String catalogSystemEndpoint) {
  ...
  public GetSellerbyId200Response categoryCommissionPercentage(String categoryCommissionPercentage) {
  ...
  public GetSellerbyId200Response deliveryPolicy(String deliveryPolicy) {
  ...
  public GetSellerbyId200Response description(String description) {
  ...
  public GetSellerbyId200Response email(String email) {
    this.email = email;
    return this;
  }
  ...
  public GetSellerbyId200Response exchangeReturnPolicy(String exchangeReturnPolicy) {
  ...
  public GetSellerbyId200Response freightCommissionPercentage(BigDecimal freightCommissionPercentage) {
  ...
  public GetSellerbyId200Response fulfillmentEndpoint(String fulfillmentEndpoint) {
  ...
  public GetSellerbyId200Response fulfillmentSellerId(Integer fulfillmentSellerId) {
  ...
  public GetSellerbyId200Response isActive(Boolean isActive) {
  ...
  public GetSellerbyId200Response isBetterScope(Boolean isBetterScope) {
  ...
  public GetSellerbyId200Response merchantName(String merchantName) {
  ...
  public GetSellerbyId200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetSellerbyId200Response password(String password) {
  ...
  public GetSellerbyId200Response productCommissionPercentage(BigDecimal productCommissionPercentage) {
  ...
  public GetSellerbyId200Response secutityPrivacyPolicy(String secutityPrivacyPolicy) {
  ...
  public GetSellerbyId200Response sellerId(String sellerId) {
  ...
  public GetSellerbyId200Response sellerType(Integer sellerType) {
  ...
  public GetSellerbyId200Response trustPolicy(String trustPolicy) {
  ...
  public GetSellerbyId200Response urlLogo(String urlLogo) {
  ...
  public GetSellerbyId200Response useHybridPaymentOptions(Boolean useHybridPaymentOptions) {
  ...
  public GetSellerbyId200Response userName(String userName) {
  ...
  public boolean equals(Object o) {
    ...
    GetSellerbyId200Response getSellerbyId200Response = (GetSellerbyId200Response) o;
    return Objects.equals(this.archiveId, getSellerbyId200Response.archiveId) &&
        Objects.equals(this.CNPJ, getSellerbyId200Response.CNPJ) &&
        Objects.equals(this.csCIdentification, getSellerbyId200Response.csCIdentification) &&
        Objects.equals(this.catalogSystemEndpoint, getSellerbyId200Response.catalogSystemEndpoint) &&
        Objects.equals(this.categoryCommissionPercentage, getSellerbyId200Response.categoryCommissionPercentage) &&
        Objects.equals(this.deliveryPolicy, getSellerbyId200Response.deliveryPolicy) &&
        Objects.equals(this.description, getSellerbyId200Response.description) &&
        Objects.equals(this.email, getSellerbyId200Response.email) &&
        Objects.equals(this.exchangeReturnPolicy, getSellerbyId200Response.exchangeReturnPolicy) &&
        Objects.equals(this.freightCommissionPercentage, getSellerbyId200Response.freightCommissionPercentage) &&
        Objects.equals(this.fulfillmentEndpoint, getSellerbyId200Response.fulfillmentEndpoint) &&
        Objects.equals(this.fulfillmentSellerId, getSellerbyId200Response.fulfillmentSellerId) &&
        Objects.equals(this.isActive, getSellerbyId200Response.isActive) &&
        Objects.equals(this.isBetterScope, getSellerbyId200Response.isBetterScope) &&
        Objects.equals(this.merchantName, getSellerbyId200Response.merchantName) &&
        Objects.equals(this.name, getSellerbyId200Response.name) &&
        Objects.equals(this.password, getSellerbyId200Response.password) &&
        Objects.equals(this.productCommissionPercentage, getSellerbyId200Response.productCommissionPercentage) &&
        Objects.equals(this.secutityPrivacyPolicy, getSellerbyId200Response.secutityPrivacyPolicy) &&
        Objects.equals(this.sellerId, getSellerbyId200Response.sellerId) &&
        Objects.equals(this.sellerType, getSellerbyId200Response.sellerType) &&
        Objects.equals(this.trustPolicy, getSellerbyId200Response.trustPolicy) &&
        Objects.equals(this.urlLogo, getSellerbyId200Response.urlLogo) &&
        Objects.equals(this.useHybridPaymentOptions, getSellerbyId200Response.useHybridPaymentOptions) &&
        Objects.equals(this.userName, getSellerbyId200Response.userName);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSellerbyId200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSellerbyId200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSellerbyId200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSellerbyId200Response is not found in the empty JSON string", GetSellerbyId200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSellerbyId200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSellerbyId200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSellerbyId200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSellerbyId200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSellerbyId200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSellerbyId200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSellerbyId200Response>() {
           @Override
           public void write(JsonWriter out, GetSellerbyId200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSellerbyId200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSellerbyId200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSellerbyId200Response
   * @throws IOException if the JSON string is invalid with respect to GetSellerbyId200Response
   */
  public static GetSellerbyId200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSellerbyId200Response.class);
  }

  /**
   * Convert an instance of GetSellerbyId200Response to an JSON string
   *
   * @return JSON string
   */
