...
import org.openapitools.client.model.DomainsInner;
...
public class AttachmentRequest {
  ...
  private List<DomainsInner> domains = new ArrayList<>();
  ...
  public AttachmentRequest domains(List<DomainsInner> domains) {
    this.domains = domains;
    return this;
  }

  public AttachmentRequest addDomainsItem(DomainsInner domainsItem) {
  ...
  public List<DomainsInner> getDomains() {
    return domains;
  }

  public void setDomains(List<DomainsInner> domains) {
    this.domains = domains;
  }


  public AttachmentRequest isActive(Boolean isActive) {
  ...
  public AttachmentRequest isRequired(Boolean isRequired) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domains, attachmentRequest.domains) &&
        Objects.equals(this.isActive, attachmentRequest.isActive) &&
        Objects.equals(this.isRequired, attachmentRequest.isRequired) &&
        Objects.equals(this.name, attachmentRequest.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domains, isActive, isRequired, name);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttachmentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttachmentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArraydomains.size(); i++) {
        DomainsInner.validateJsonElement(jsonArraydomains.get(i));
      };
