...
class RequestBody6(Model):
    ...
    def __init__(self, category_id: int=None, default_value: str=None, description: str=None, field_group_id: int=None, field_type_id: int=None, id: int=None, is_active: bool=None, is_filter: bool=None, is_on_product_details: bool=None, is_required: bool=None, is_side_menu_link_active: bool=None, is_stock_keeping_unit: bool=None, is_top_menu_link_active: bool=None, is_wizard: bool=None, name: str=None, position: int=None):
        """RequestBody6 - a model defined in OpenAPI

        :param category_id: The category_id of this RequestBody6.
        :param default_value: The default_value of this RequestBody6.
        :param description: The description of this RequestBody6.
        :param field_group_id: The field_group_id of this RequestBody6.
        :param field_type_id: The field_type_id of this RequestBody6.
        :param id: The id of this RequestBody6.
        :param is_active: The is_active of this RequestBody6.
        :param is_filter: The is_filter of this RequestBody6.
        :param is_on_product_details: The is_on_product_details of this RequestBody6.
        :param is_required: The is_required of this RequestBody6.
        :param is_side_menu_link_active: The is_side_menu_link_active of this RequestBody6.
        :param is_stock_keeping_unit: The is_stock_keeping_unit of this RequestBody6.
        :param is_top_menu_link_active: The is_top_menu_link_active of this RequestBody6.
        :param is_wizard: The is_wizard of this RequestBody6.
        :param name: The name of this RequestBody6.
        :param position: The position of this RequestBody6.
        """
        self.openapi_types = {
            'category_id': int,
            'default_value': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RequestBody6':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Request_body_6 of this RequestBody6.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def category_id(self):
        """Gets the category_id of this RequestBody6.

        Specification Category ID.

        :return: The category_id of this RequestBody6.
        :rtype: int
        """
    ...
    def category_id(self, category_id):
        """Sets the category_id of this RequestBody6.
    ...
    def default_value(self):
        """Gets the default_value of this RequestBody6.

        Specification Default Value.

        :return: The default_value of this RequestBody6.
        :rtype: str
        """
    ...
    def default_value(self, default_value):
        """Sets the default_value of this RequestBody6.
    ...
    def description(self):
        """Gets the description of this RequestBody6.

        Specification Description.

        :return: The description of this RequestBody6.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this RequestBody6.
    ...
    def field_group_id(self):
        """Gets the field_group_id of this RequestBody6.

        Numerical ID of the Group of Specifications that contains the new Specification.

        :return: The field_group_id of this RequestBody6.
        :rtype: int
        """
    ...
    def field_group_id(self, field_group_id):
        """Sets the field_group_id of this RequestBody6.
    ...
    def field_type_id(self, field_type_id):
        """Sets the field_type_id of this RequestBody6.
    ...
    @property
    def id(self):
        """Gets the id of this RequestBody6.

        Created Specification’s ID.

        :return: The id of this RequestBody6.
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this RequestBody6.
    ...
    @property
    def is_active(self):
        """Gets the is_active of this RequestBody6.

        Defines if the Specification is active or not.

        :return: The is_active of this RequestBody6.
        :rtype: bool
        """
    ...
    def is_active(self, is_active):
        """Sets the is_active of this RequestBody6.
    ...
    @property
    def is_filter(self):
        """Gets the is_filter of this RequestBody6.

        Defines if the Specification can be used as a Filter.

        :return: The is_filter of this RequestBody6.
        :rtype: bool
        """
    ...
    def is_filter(self, is_filter):
        """Sets the is_filter of this RequestBody6.
    ...
    def is_on_product_details(self):
        """Gets the is_on_product_details of this RequestBody6.

        Defines if the Specification will be shown on the Product screen in the specification area.

        :return: The is_on_product_details of this RequestBody6.
        :rtype: bool
        """
    ...
    def is_on_product_details(self, is_on_product_details):
        """Sets the is_on_product_details of this RequestBody6.
    ...
    def is_required(self):
        """Gets the is_required of this RequestBody6.

        Defines if the Specification is required or not.

        :return: The is_required of this RequestBody6.
        :rtype: bool
        """
    ...
    def is_required(self, is_required):
        """Sets the is_required of this RequestBody6.
    ...
    def is_side_menu_link_active(self):
        """Gets the is_side_menu_link_active of this RequestBody6.

        Defines if the Specification is shown in the side menu.

        :return: The is_side_menu_link_active of this RequestBody6.
        :rtype: bool
        """
    ...
    def is_side_menu_link_active(self, is_side_menu_link_active):
        """Sets the is_side_menu_link_active of this RequestBody6.
    ...
    def is_stock_keeping_unit(self):
        """Gets the is_stock_keeping_unit of this RequestBody6.

        Defines if the Specification is applied to a specific SKU.

        :return: The is_stock_keeping_unit of this RequestBody6.
        :rtype: bool
        """
    ...
    def is_stock_keeping_unit(self, is_stock_keeping_unit):
        """Sets the is_stock_keeping_unit of this RequestBody6.
    ...
    def is_top_menu_link_active(self):
        """Gets the is_top_menu_link_active of this RequestBody6.

        Defines if the Specification is shown in the main menu of the site.

        :return: The is_top_menu_link_active of this RequestBody6.
        :rtype: bool
        """
    ...
    def is_top_menu_link_active(self, is_top_menu_link_active):
        """Sets the is_top_menu_link_active of this RequestBody6.
    ...
    @property
    def is_wizard(self):
        """Gets the is_wizard of this RequestBody6.

        Deprecated

        :return: The is_wizard of this RequestBody6.
        :rtype: bool
        """
    ...
    def is_wizard(self, is_wizard):
        """Sets the is_wizard of this RequestBody6.
    ...
    @property
    def name(self):
        """Gets the name of this RequestBody6.

        Specification Name.

        :return: The name of this RequestBody6.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RequestBody6.
    ...
    @property
    def position(self):
        """Gets the position of this RequestBody6.

        The current Specification's position in comparison to the other Specifications.

        :return: The position of this RequestBody6.
        :rtype: int
        """
    ...
    def position(self, position):
        """Sets the position of this RequestBody6.
