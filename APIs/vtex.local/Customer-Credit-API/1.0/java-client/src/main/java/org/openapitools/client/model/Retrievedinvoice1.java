...
public class Retrievedinvoice1 {
  ...
  public Retrievedinvoice1() {
  }

  public Retrievedinvoice1 checkingAccountId(String checkingAccountId) {
  ...
  public Retrievedinvoice1 createdAt(String createdAt) {
  ...
  public Retrievedinvoice1 description(String description) {
  ...
  public Retrievedinvoice1 dueDate(String dueDate) {
  ...
  public Retrievedinvoice1 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Retrievedinvoice1 observation(String observation) {
  ...
  public Retrievedinvoice1 originalDueDate(String originalDueDate) {
  ...
  public Retrievedinvoice1 paymentLink(String paymentLink) {
  ...
  public Retrievedinvoice1 status(String status) {
    this.status = status;
    return this;
  }
  ...
  public Retrievedinvoice1 updatedAt(String updatedAt) {
  ...
  public Retrievedinvoice1 value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Retrievedinvoice1 retrievedinvoice1 = (Retrievedinvoice1) o;
    return Objects.equals(this.checkingAccountId, retrievedinvoice1.checkingAccountId) &&
        Objects.equals(this.createdAt, retrievedinvoice1.createdAt) &&
        Objects.equals(this.description, retrievedinvoice1.description) &&
        Objects.equals(this.dueDate, retrievedinvoice1.dueDate) &&
        Objects.equals(this.id, retrievedinvoice1.id) &&
        Objects.equals(this.observation, retrievedinvoice1.observation) &&
        Objects.equals(this.originalDueDate, retrievedinvoice1.originalDueDate) &&
        Objects.equals(this.paymentLink, retrievedinvoice1.paymentLink) &&
        Objects.equals(this.status, retrievedinvoice1.status) &&
        Objects.equals(this.updatedAt, retrievedinvoice1.updatedAt) &&
        Objects.equals(this.value, retrievedinvoice1.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class Retrievedinvoice1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Retrievedinvoice1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Retrievedinvoice1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Retrievedinvoice1 is not found in the empty JSON string", Retrievedinvoice1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Retrievedinvoice1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Retrievedinvoice1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Retrievedinvoice1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Retrievedinvoice1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Retrievedinvoice1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Retrievedinvoice1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Retrievedinvoice1.class));

       return (TypeAdapter<T>) new TypeAdapter<Retrievedinvoice1>() {
           @Override
           public void write(JsonWriter out, Retrievedinvoice1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Retrievedinvoice1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Retrievedinvoice1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Retrievedinvoice1
   * @throws IOException if the JSON string is invalid with respect to Retrievedinvoice1
   */
  public static Retrievedinvoice1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Retrievedinvoice1.class);
  }

  /**
   * Convert an instance of Retrievedinvoice1 to an JSON string
   *
   * @return JSON string
   */
