...
public class Datum1 {
  ...
  public Datum1 checkingAccountId(String checkingAccountId) {
  ...
  public Datum1 createdAt(String createdAt) {
  ...
  public Datum1 dueDate(String dueDate) {
  ...
  public Datum1 observation(String observation) {
  ...
  public Datum1 originalDueDate(String originalDueDate) {
  ...
  public Datum1 paymentLink(String paymentLink) {
  ...
  public Datum1 status(String status) {
    this.status = status;
    return this;
  }
  ...
  public Datum1 updatedAt(String updatedAt) {
  ...
  public Datum1 value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checkingAccountId, datum1.checkingAccountId) &&
        Objects.equals(this.createdAt, datum1.createdAt) &&
        Objects.equals(this.description, datum1.description) &&
        Objects.equals(this.dueDate, datum1.dueDate) &&
        Objects.equals(this.id, datum1.id) &&
        Objects.equals(this.observation, datum1.observation) &&
        Objects.equals(this.originalDueDate, datum1.originalDueDate) &&
        Objects.equals(this.paymentLink, datum1.paymentLink) &&
        Objects.equals(this.status, datum1.status) &&
        Objects.equals(this.updatedAt, datum1.updatedAt) &&
        Objects.equals(this.value, datum1.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Datum1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Datum1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Datum1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Datum1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
