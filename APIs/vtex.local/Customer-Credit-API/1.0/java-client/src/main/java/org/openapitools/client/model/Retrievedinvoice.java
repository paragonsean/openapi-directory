...
public class Retrievedinvoice {
  ...
  public Retrievedinvoice() {
  }

  public Retrievedinvoice checkingAccountId(String checkingAccountId) {
  ...
  public Retrievedinvoice createdAt(String createdAt) {
  ...
  public Retrievedinvoice description(String description) {
  ...
  public Retrievedinvoice dueDate(String dueDate) {
  ...
  public Retrievedinvoice id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Retrievedinvoice observation(String observation) {
  ...
  public Retrievedinvoice originalDueDate(String originalDueDate) {
  ...
  public Retrievedinvoice paymentLink(String paymentLink) {
  ...
  public Retrievedinvoice status(String status) {
    this.status = status;
    return this;
  }
  ...
  public Retrievedinvoice updatedAt(String updatedAt) {
  ...
  public Retrievedinvoice value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Retrievedinvoice retrievedinvoice = (Retrievedinvoice) o;
    return Objects.equals(this.checkingAccountId, retrievedinvoice.checkingAccountId) &&
        Objects.equals(this.createdAt, retrievedinvoice.createdAt) &&
        Objects.equals(this.description, retrievedinvoice.description) &&
        Objects.equals(this.dueDate, retrievedinvoice.dueDate) &&
        Objects.equals(this.id, retrievedinvoice.id) &&
        Objects.equals(this.observation, retrievedinvoice.observation) &&
        Objects.equals(this.originalDueDate, retrievedinvoice.originalDueDate) &&
        Objects.equals(this.paymentLink, retrievedinvoice.paymentLink) &&
        Objects.equals(this.status, retrievedinvoice.status) &&
        Objects.equals(this.updatedAt, retrievedinvoice.updatedAt) &&
        Objects.equals(this.value, retrievedinvoice.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class Retrievedinvoice {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Retrievedinvoice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Retrievedinvoice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Retrievedinvoice is not found in the empty JSON string", Retrievedinvoice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Retrievedinvoice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Retrievedinvoice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Retrievedinvoice.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Retrievedinvoice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Retrievedinvoice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Retrievedinvoice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Retrievedinvoice.class));

       return (TypeAdapter<T>) new TypeAdapter<Retrievedinvoice>() {
           @Override
           public void write(JsonWriter out, Retrievedinvoice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Retrievedinvoice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Retrievedinvoice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Retrievedinvoice
   * @throws IOException if the JSON string is invalid with respect to Retrievedinvoice
   */
  public static Retrievedinvoice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Retrievedinvoice.class);
  }

  /**
   * Convert an instance of Retrievedinvoice to an JSON string
   *
   * @return JSON string
   */
