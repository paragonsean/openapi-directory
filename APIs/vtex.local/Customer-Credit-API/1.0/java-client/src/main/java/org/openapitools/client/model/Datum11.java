...
public class Datum11 {
  ...
  public Datum11 checkingAccountId(String checkingAccountId) {
  ...
  public Datum11 createdAt(String createdAt) {
  ...
  public Datum11 description(String description) {
  ...
  public Datum11 dueDate(String dueDate) {
  ...
  public Datum11 observation(String observation) {
  ...
  public Datum11 originalDueDate(String originalDueDate) {
  ...
  public Datum11 paymentLink(String paymentLink) {
  ...
  public Datum11 status(String status) {
    this.status = status;
    return this;
  }
  ...
  public Datum11 updatedAt(String updatedAt) {
  ...
  public Datum11 value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checkingAccountId, datum11.checkingAccountId) &&
        Objects.equals(this.createdAt, datum11.createdAt) &&
        Objects.equals(this.description, datum11.description) &&
        Objects.equals(this.dueDate, datum11.dueDate) &&
        Objects.equals(this.id, datum11.id) &&
        Objects.equals(this.observation, datum11.observation) &&
        Objects.equals(this.originalDueDate, datum11.originalDueDate) &&
        Objects.equals(this.paymentLink, datum11.paymentLink) &&
        Objects.equals(this.status, datum11.status) &&
        Objects.equals(this.updatedAt, datum11.updatedAt) &&
        Objects.equals(this.value, datum11.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Datum11
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Datum11.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Datum11.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Datum11` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Datum11.openapiRequiredFields) {
