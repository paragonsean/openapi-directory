...
/**
 * API tests for StoreConfigurationApi
 */
@Disabled
public class StoreConfigurationApiTest {

    private final StoreConfigurationApi api = new StoreConfigurationApi();
     ...
     */
    @Test
    public void createorchangestoreconfigurationTest() throws ApiException {
        String accept = null;
        String contentType = null;
        CreateorchangestoreconfigurationRequest1 createorchangestoreconfigurationRequest1 = null;
        Savestoreconfig1 response = api.createorchangestoreconfiguration(accept, contentType, createorchangestoreconfigurationRequest1);
     ...
     */
    @Test
    public void retrievestoreconfigurationTest() throws ApiException {
        String contentType = null;
        String accept = null;
        Storeconfig1 response = api.retrievestoreconfiguration(contentType, accept);
        // TODO: test validations
    }
