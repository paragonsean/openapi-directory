...
/*
 * OAISearchcheckingaccounts.h
 *
 * 
 */

#ifndef OAISearchcheckingaccounts_H
#define OAISearchcheckingaccounts_H
...
class OAISearchcheckingaccounts : public OAIObject {
public:
    OAISearchcheckingaccounts();
    OAISearchcheckingaccounts(QString json);
    ~OAISearchcheckingaccounts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchcheckingaccounts)

#endif // OAISearchcheckingaccounts_H
