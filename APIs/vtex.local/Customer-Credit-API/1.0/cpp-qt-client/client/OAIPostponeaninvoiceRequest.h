...
/*
 * OAIPostponeaninvoiceRequest.h
 *
 * 
 */

#ifndef OAIPostponeaninvoiceRequest_H
#define OAIPostponeaninvoiceRequest_H
...
class OAIPostponeaninvoiceRequest : public OAIObject {
public:
    OAIPostponeaninvoiceRequest();
    OAIPostponeaninvoiceRequest(QString json);
    ~OAIPostponeaninvoiceRequest() override;
    ...
    QString getDueDays() const;
    void setDueDays(const QString &due_days);
    bool is_due_days_Set() const;
    bool is_due_days_Valid() const;
...
private:
    ...
    QString m_due_days;
    bool m_due_days_isSet;
    bool m_due_days_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPostponeaninvoiceRequest)

#endif // OAIPostponeaninvoiceRequest_H
