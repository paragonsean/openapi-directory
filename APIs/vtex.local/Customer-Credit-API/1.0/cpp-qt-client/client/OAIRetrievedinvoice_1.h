...
/*
 * OAIRetrievedinvoice_1.h
 *
 * 
 */

#ifndef OAIRetrievedinvoice_1_H
#define OAIRetrievedinvoice_1_H
...
class OAIRetrievedinvoice_1 : public OAIObject {
public:
    OAIRetrievedinvoice_1();
    OAIRetrievedinvoice_1(QString json);
    ~OAIRetrievedinvoice_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetrievedinvoice_1)

#endif // OAIRetrievedinvoice_1_H
