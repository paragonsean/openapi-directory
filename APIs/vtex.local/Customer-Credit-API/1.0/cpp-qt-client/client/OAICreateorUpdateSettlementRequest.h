...
/*
 * OAICreateorUpdateSettlementRequest.h
 *
 * 
 */

#ifndef OAICreateorUpdateSettlementRequest_H
#define OAICreateorUpdateSettlementRequest_H
...
class OAICreateorUpdateSettlementRequest : public OAIObject {
public:
    OAICreateorUpdateSettlementRequest();
    OAICreateorUpdateSettlementRequest(QString json);
    ~OAICreateorUpdateSettlementRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateorUpdateSettlementRequest)

#endif // OAICreateorUpdateSettlementRequest_H
