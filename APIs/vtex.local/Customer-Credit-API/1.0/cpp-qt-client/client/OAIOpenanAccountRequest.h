...
/*
 * OAIOpenanAccountRequest.h
 *
 * 
 */

#ifndef OAIOpenanAccountRequest_H
#define OAIOpenanAccountRequest_H
...
class OAIOpenanAccountRequest : public OAIObject {
public:
    OAIOpenanAccountRequest();
    OAIOpenanAccountRequest(QString json);
    ~OAIOpenanAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOpenanAccountRequest)

#endif // OAIOpenanAccountRequest_H
