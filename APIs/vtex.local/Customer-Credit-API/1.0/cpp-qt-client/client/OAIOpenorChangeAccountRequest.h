...
/*
 * OAIOpenorChangeAccountRequest.h
 *
 * 
 */

#ifndef OAIOpenorChangeAccountRequest_H
#define OAIOpenorChangeAccountRequest_H
...
class OAIOpenorChangeAccountRequest : public OAIObject {
public:
    OAIOpenorChangeAccountRequest();
    OAIOpenorChangeAccountRequest(QString json);
    ~OAIOpenorChangeAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOpenorChangeAccountRequest)

#endif // OAIOpenorChangeAccountRequest_H
