...
OAIStoreconfig::OAIStoreconfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStoreconfig::OAIStoreconfig() {
    this->initializeModel();
}

OAIStoreconfig::~OAIStoreconfig() {}

void OAIStoreconfig::initializeModel() {
...
void OAIStoreconfig::fromJson(QString jsonString) {
...
void OAIStoreconfig::fromJsonObject(QJsonObject json) {
...
QString OAIStoreconfig::asJson() const {
...
QJsonObject OAIStoreconfig::asJsonObject() const {
    QJsonObject obj;
...
double OAIStoreconfig::getDailyInterestRate() const {
    return m_daily_interest_rate;
}
void OAIStoreconfig::setDailyInterestRate(const double &daily_interest_rate) {
    m_daily_interest_rate = daily_interest_rate;
    m_daily_interest_rate_isSet = true;
}

bool OAIStoreconfig::is_daily_interest_rate_Set() const{
    return m_daily_interest_rate_isSet;
}

bool OAIStoreconfig::is_daily_interest_rate_Valid() const{
    return m_daily_interest_rate_isValid;
}

qint32 OAIStoreconfig::getInvoicePostponementLimit() const {
    return m_invoice_postponement_limit;
}
void OAIStoreconfig::setInvoicePostponementLimit(const qint32 &invoice_postponement_limit) {
    m_invoice_postponement_limit = invoice_postponement_limit;
    m_invoice_postponement_limit_isSet = true;
}

bool OAIStoreconfig::is_invoice_postponement_limit_Set() const{
    return m_invoice_postponement_limit_isSet;
}

bool OAIStoreconfig::is_invoice_postponement_limit_Valid() const{
    return m_invoice_postponement_limit_isValid;
}

double OAIStoreconfig::getTaxRate() const {
    return m_tax_rate;
}
void OAIStoreconfig::setTaxRate(const double &tax_rate) {
    m_tax_rate = tax_rate;
    m_tax_rate_isSet = true;
}

bool OAIStoreconfig::is_tax_rate_Set() const{
    return m_tax_rate_isSet;
}

bool OAIStoreconfig::is_tax_rate_Valid() const{
    return m_tax_rate_isValid;
}

double OAIStoreconfig::getTolerancePercent() const {
    return m_tolerance_percent;
}
void OAIStoreconfig::setTolerancePercent(const double &tolerance_percent) {
    m_tolerance_percent = tolerance_percent;
    m_tolerance_percent_isSet = true;
}

bool OAIStoreconfig::is_tolerance_percent_Set() const{
    return m_tolerance_percent_isSet;
}

bool OAIStoreconfig::is_tolerance_percent_Valid() const{
    return m_tolerance_percent_isValid;
}

bool OAIStoreconfig::isSet() const {
...
bool OAIStoreconfig::isValid() const {
