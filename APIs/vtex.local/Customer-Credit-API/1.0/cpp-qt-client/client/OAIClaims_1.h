...
#ifndef OAIClaims_1_H
#define OAIClaims_1_H
...
class OAIClaims_1 : public OAIObject {
public:
    OAIClaims_1();
    OAIClaims_1(QString json);
    ~OAIClaims_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClaims_1)
