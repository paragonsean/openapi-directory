...
/*
 * OAIPartialorTotalRefundaSettlementRequest.h
 *
 * 
 */

#ifndef OAIPartialorTotalRefundaSettlementRequest_H
#define OAIPartialorTotalRefundaSettlementRequest_H
...
class OAIPartialorTotalRefundaSettlementRequest : public OAIObject {
public:
    OAIPartialorTotalRefundaSettlementRequest();
    OAIPartialorTotalRefundaSettlementRequest(QString json);
    ~OAIPartialorTotalRefundaSettlementRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartialorTotalRefundaSettlementRequest)

#endif // OAIPartialorTotalRefundaSettlementRequest_H
