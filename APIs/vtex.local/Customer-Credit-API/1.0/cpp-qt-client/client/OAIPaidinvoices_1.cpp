...
OAIPaidinvoices_1::OAIPaidinvoices_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaidinvoices_1::OAIPaidinvoices_1() {
    this->initializeModel();
}

OAIPaidinvoices_1::~OAIPaidinvoices_1() {}

void OAIPaidinvoices_1::initializeModel() {
...
void OAIPaidinvoices_1::fromJson(QString jsonString) {
...
void OAIPaidinvoices_1::fromJsonObject(QJsonObject json) {
...
QString OAIPaidinvoices_1::asJson() const {
...
QJsonObject OAIPaidinvoices_1::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIDatum_1> OAIPaidinvoices_1::getData() const {
    return m_data;
}
void OAIPaidinvoices_1::setData(const QList<OAIDatum_1> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPaidinvoices_1::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPaidinvoices_1::is_data_Valid() const{
    return m_data_isValid;
}

OAISummary_1 OAIPaidinvoices_1::getSummary() const {
    return m_summary;
}
void OAIPaidinvoices_1::setSummary(const OAISummary_1 &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAIPaidinvoices_1::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAIPaidinvoices_1::is_summary_Valid() const{
    return m_summary_isValid;
}

bool OAIPaidinvoices_1::isSet() const {
...
bool OAIPaidinvoices_1::isValid() const {
