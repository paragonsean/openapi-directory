...
#ifndef OAIPaidinvoices_1_H
#define OAIPaidinvoices_1_H
...
class OAIPaidinvoices_1 : public OAIObject {
public:
    OAIPaidinvoices_1();
    OAIPaidinvoices_1(QString json);
    ~OAIPaidinvoices_1() override;
    ...
    QList<OAIDatum_1> getData() const;
    void setData(const QList<OAIDatum_1> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaidinvoices_1)

#endif // OAIPaidinvoices_1_H
