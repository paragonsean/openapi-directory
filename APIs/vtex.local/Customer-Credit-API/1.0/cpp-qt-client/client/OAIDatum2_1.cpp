...
OAIDatum2_1::OAIDatum2_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatum2_1::OAIDatum2_1() {
    this->initializeModel();
}

OAIDatum2_1::~OAIDatum2_1() {}

void OAIDatum2_1::initializeModel() {
...
void OAIDatum2_1::fromJson(QString jsonString) {
...
void OAIDatum2_1::fromJsonObject(QJsonObject json) {
...
QString OAIDatum2_1::asJson() const {
...
QJsonObject OAIDatum2_1::asJsonObject() const {
    QJsonObject obj;
    if (m_account_isSet) {
...
QString OAIDatum2_1::getAccount() const {
    return m_account;
}
void OAIDatum2_1::setAccount(const QString &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAIDatum2_1::is_account_Set() const{
    return m_account_isSet;
}

bool OAIDatum2_1::is_account_Valid() const{
    return m_account_isValid;
}

double OAIDatum2_1::getBalance() const {
    return m_balance;
}
void OAIDatum2_1::setBalance(const double &balance) {
    m_balance = balance;
    m_balance_isSet = true;
}

bool OAIDatum2_1::is_balance_Set() const{
    return m_balance_isSet;
}

bool OAIDatum2_1::is_balance_Valid() const{
    return m_balance_isValid;
}

double OAIDatum2_1::getCreditLimit() const {
    return m_credit_limit;
}
void OAIDatum2_1::setCreditLimit(const double &credit_limit) {
    m_credit_limit = credit_limit;
    m_credit_limit_isSet = true;
}

bool OAIDatum2_1::is_credit_limit_Set() const{
    return m_credit_limit_isSet;
}

bool OAIDatum2_1::is_credit_limit_Valid() const{
    return m_credit_limit_isValid;
}

QString OAIDatum2_1::getDescription() const {
    return m_description;
}
void OAIDatum2_1::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDatum2_1::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDatum2_1::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIDatum2_1::getDocument() const {
    return m_document;
}
void OAIDatum2_1::setDocument(const QString &document) {
    m_document = document;
    m_document_isSet = true;
}

bool OAIDatum2_1::is_document_Set() const{
    return m_document_isSet;
}

bool OAIDatum2_1::is_document_Valid() const{
    return m_document_isValid;
}

QString OAIDatum2_1::getDocumentType() const {
    return m_document_type;
}
void OAIDatum2_1::setDocumentType(const QString &document_type) {
    m_document_type = document_type;
    m_document_type_isSet = true;
}

bool OAIDatum2_1::is_document_type_Set() const{
    return m_document_type_isSet;
}

bool OAIDatum2_1::is_document_type_Valid() const{
    return m_document_type_isValid;
}

QString OAIDatum2_1::getEmail() const {
    return m_email;
}
void OAIDatum2_1::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIDatum2_1::is_email_Set() const{
    return m_email_isSet;
}

bool OAIDatum2_1::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIDatum2_1::getLastUpdate() const {
    return m_last_update;
}
void OAIDatum2_1::setLastUpdate(const QString &last_update) {
    m_last_update = last_update;
    m_last_update_isSet = true;
}

bool OAIDatum2_1::is_last_update_Set() const{
    return m_last_update_isSet;
}

bool OAIDatum2_1::is_last_update_Valid() const{
    return m_last_update_isValid;
}

bool OAIDatum2_1::isSet() const {
...
bool OAIDatum2_1::isValid() const {
