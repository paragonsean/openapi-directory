...
/*
 * OAIDecreasebalanceofanaccountRequest_1.h
 *
 * 
 */

#ifndef OAIDecreasebalanceofanaccountRequest_1_H
#define OAIDecreasebalanceofanaccountRequest_1_H
...
class OAIDecreasebalanceofanaccountRequest_1 : public OAIObject {
public:
    OAIDecreasebalanceofanaccountRequest_1();
    OAIDecreasebalanceofanaccountRequest_1(QString json);
    ~OAIDecreasebalanceofanaccountRequest_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDecreasebalanceofanaccountRequest_1)

#endif // OAIDecreasebalanceofanaccountRequest_1_H
