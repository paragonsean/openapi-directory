...
#ifndef OAIStoreconfig_1_H
#define OAIStoreconfig_1_H
...
class OAIStoreconfig_1 : public OAIObject {
public:
    OAIStoreconfig_1();
    OAIStoreconfig_1(QString json);
    ~OAIStoreconfig_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoreconfig_1)

#endif // OAIStoreconfig_1_H
