...
/*
 * OAIGetinvoicesfromacheckingaccount_1.h
 *
 * 
 */

#ifndef OAIGetinvoicesfromacheckingaccount_1_H
#define OAIGetinvoicesfromacheckingaccount_1_H
...
class OAIGetinvoicesfromacheckingaccount_1 : public OAIObject {
public:
    OAIGetinvoicesfromacheckingaccount_1();
    OAIGetinvoicesfromacheckingaccount_1(QString json);
    ~OAIGetinvoicesfromacheckingaccount_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetinvoicesfromacheckingaccount_1)

#endif // OAIGetinvoicesfromacheckingaccount_1_H
