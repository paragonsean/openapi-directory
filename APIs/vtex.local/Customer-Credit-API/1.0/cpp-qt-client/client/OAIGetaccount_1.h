...
#ifndef OAIGetaccount_1_H
#define OAIGetaccount_1_H
...
class OAIGetaccount_1 : public OAIObject {
public:
    OAIGetaccount_1();
    OAIGetaccount_1(QString json);
    ~OAIGetaccount_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetaccount_1)

#endif // OAIGetaccount_1_H
