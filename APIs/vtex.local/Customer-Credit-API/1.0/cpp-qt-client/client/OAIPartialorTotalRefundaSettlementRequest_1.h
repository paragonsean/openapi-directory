...
/*
 * OAIPartialorTotalRefundaSettlementRequest_1.h
 *
 * 
 */

#ifndef OAIPartialorTotalRefundaSettlementRequest_1_H
#define OAIPartialorTotalRefundaSettlementRequest_1_H
...
class OAIPartialorTotalRefundaSettlementRequest_1 : public OAIObject {
public:
    OAIPartialorTotalRefundaSettlementRequest_1();
    OAIPartialorTotalRefundaSettlementRequest_1(QString json);
    ~OAIPartialorTotalRefundaSettlementRequest_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartialorTotalRefundaSettlementRequest_1)

#endif // OAIPartialorTotalRefundaSettlementRequest_1_H
