...
#ifndef OAIDatum2_1_H
#define OAIDatum2_1_H
...
class OAIDatum2_1 : public OAIObject {
public:
    OAIDatum2_1();
    OAIDatum2_1(QString json);
    ~OAIDatum2_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatum2_1)
