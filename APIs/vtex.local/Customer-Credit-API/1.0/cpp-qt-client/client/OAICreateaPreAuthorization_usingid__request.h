...
/*
 * OAICreateaPreAuthorization_usingid__request.h
 *
 * 
 */

#ifndef OAICreateaPreAuthorization_usingid__request_H
#define OAICreateaPreAuthorization_usingid__request_H
...
class OAICreateaPreAuthorization_usingid__request : public OAIObject {
public:
    OAICreateaPreAuthorization_usingid__request();
    OAICreateaPreAuthorization_usingid__request(QString json);
    ~OAICreateaPreAuthorization_usingid__request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateaPreAuthorization_usingid__request)

#endif // OAICreateaPreAuthorization_usingid__request_H
