...
/*
 * OAIIncreasebalanceofanaccountRequest.h
 *
 * 
 */

#ifndef OAIIncreasebalanceofanaccountRequest_H
#define OAIIncreasebalanceofanaccountRequest_H
...
class OAIIncreasebalanceofanaccountRequest : public OAIObject {
public:
    OAIIncreasebalanceofanaccountRequest();
    OAIIncreasebalanceofanaccountRequest(QString json);
    ~OAIIncreasebalanceofanaccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIncreasebalanceofanaccountRequest)

#endif // OAIIncreasebalanceofanaccountRequest_H
