...
OAIStatements_1::OAIStatements_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatements_1::OAIStatements_1() {
    this->initializeModel();
}

OAIStatements_1::~OAIStatements_1() {}

void OAIStatements_1::initializeModel() {
...
void OAIStatements_1::fromJson(QString jsonString) {
...
void OAIStatements_1::fromJsonObject(QJsonObject json) {
...
QString OAIStatements_1::asJson() const {
...
QJsonObject OAIStatements_1::asJsonObject() const {
    QJsonObject obj;
...
double OAIStatements_1::getCurrentBalance() const {
    return m_current_balance;
}
void OAIStatements_1::setCurrentBalance(const double &current_balance) {
    m_current_balance = current_balance;
    m_current_balance_isSet = true;
}

bool OAIStatements_1::is_current_balance_Set() const{
    return m_current_balance_isSet;
}

bool OAIStatements_1::is_current_balance_Valid() const{
    return m_current_balance_isValid;
}

double OAIStatements_1::getIntervalBalance() const {
    return m_interval_balance;
}
void OAIStatements_1::setIntervalBalance(const double &interval_balance) {
    m_interval_balance = interval_balance;
    m_interval_balance_isSet = true;
}

bool OAIStatements_1::is_interval_balance_Set() const{
    return m_interval_balance_isSet;
}

bool OAIStatements_1::is_interval_balance_Valid() const{
    return m_interval_balance_isValid;
}

double OAIStatements_1::getPreviousBalance() const {
    return m_previous_balance;
}
void OAIStatements_1::setPreviousBalance(const double &previous_balance) {
    m_previous_balance = previous_balance;
    m_previous_balance_isSet = true;
}

bool OAIStatements_1::is_previous_balance_Set() const{
    return m_previous_balance_isSet;
}

bool OAIStatements_1::is_previous_balance_Valid() const{
    return m_previous_balance_isValid;
}

QList<OAIStatements1_1> OAIStatements_1::getStatements() const {
    return m_statements;
}
void OAIStatements_1::setStatements(const QList<OAIStatements1_1> &statements) {
    m_statements = statements;
    m_statements_isSet = true;
}

bool OAIStatements_1::is_statements_Set() const{
    return m_statements_isSet;
}

bool OAIStatements_1::is_statements_Valid() const{
    return m_statements_isValid;
}

bool OAIStatements_1::isSet() const {
...
bool OAIStatements_1::isValid() const {
