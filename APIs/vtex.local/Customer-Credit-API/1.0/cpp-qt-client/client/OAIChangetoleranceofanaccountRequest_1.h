...
/*
 * OAIChangetoleranceofanaccountRequest_1.h
 *
 * 
 */

#ifndef OAIChangetoleranceofanaccountRequest_1_H
#define OAIChangetoleranceofanaccountRequest_1_H
...
class OAIChangetoleranceofanaccountRequest_1 : public OAIObject {
public:
    OAIChangetoleranceofanaccountRequest_1();
    OAIChangetoleranceofanaccountRequest_1(QString json);
    ~OAIChangetoleranceofanaccountRequest_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChangetoleranceofanaccountRequest_1)

#endif // OAIChangetoleranceofanaccountRequest_1_H
