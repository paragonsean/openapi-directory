...
/*
 * OAIChangecreditlimitofanAccountRequest.h
 *
 * 
 */

#ifndef OAIChangecreditlimitofanAccountRequest_H
#define OAIChangecreditlimitofanAccountRequest_H
...
class OAIChangecreditlimitofanAccountRequest : public OAIObject {
public:
    OAIChangecreditlimitofanAccountRequest();
    OAIChangecreditlimitofanAccountRequest(QString json);
    ~OAIChangecreditlimitofanAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChangecreditlimitofanAccountRequest)

#endif // OAIChangecreditlimitofanAccountRequest_H
