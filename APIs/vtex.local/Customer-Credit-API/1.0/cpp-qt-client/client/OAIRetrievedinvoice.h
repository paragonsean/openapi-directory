...
/*
 * OAIRetrievedinvoice.h
 *
 * 
 */

#ifndef OAIRetrievedinvoice_H
#define OAIRetrievedinvoice_H
...
class OAIRetrievedinvoice : public OAIObject {
public:
    OAIRetrievedinvoice();
    OAIRetrievedinvoice(QString json);
    ~OAIRetrievedinvoice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetrievedinvoice)

#endif // OAIRetrievedinvoice_H
