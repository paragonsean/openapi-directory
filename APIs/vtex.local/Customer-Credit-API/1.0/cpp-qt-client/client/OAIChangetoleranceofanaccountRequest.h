...
/*
 * OAIChangetoleranceofanaccountRequest.h
 *
 * 
 */

#ifndef OAIChangetoleranceofanaccountRequest_H
#define OAIChangetoleranceofanaccountRequest_H
...
class OAIChangetoleranceofanaccountRequest : public OAIObject {
public:
    OAIChangetoleranceofanaccountRequest();
    OAIChangetoleranceofanaccountRequest(QString json);
    ~OAIChangetoleranceofanaccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChangetoleranceofanaccountRequest)

#endif // OAIChangetoleranceofanaccountRequest_H
