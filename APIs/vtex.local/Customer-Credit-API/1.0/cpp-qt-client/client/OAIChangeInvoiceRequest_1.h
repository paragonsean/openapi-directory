...
/*
 * OAIChangeInvoiceRequest_1.h
 *
 * 
 */

#ifndef OAIChangeInvoiceRequest_1_H
#define OAIChangeInvoiceRequest_1_H
...
class OAIChangeInvoiceRequest_1 : public OAIObject {
public:
    OAIChangeInvoiceRequest_1();
    OAIChangeInvoiceRequest_1(QString json);
    ~OAIChangeInvoiceRequest_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChangeInvoiceRequest_1)

#endif // OAIChangeInvoiceRequest_1_H
