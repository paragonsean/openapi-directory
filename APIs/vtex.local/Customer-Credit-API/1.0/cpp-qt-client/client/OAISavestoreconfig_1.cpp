...
OAISavestoreconfig_1::OAISavestoreconfig_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISavestoreconfig_1::OAISavestoreconfig_1() {
    this->initializeModel();
}

OAISavestoreconfig_1::~OAISavestoreconfig_1() {}

void OAISavestoreconfig_1::initializeModel() {
...
void OAISavestoreconfig_1::fromJson(QString jsonString) {
...
void OAISavestoreconfig_1::fromJsonObject(QJsonObject json) {
...
QString OAISavestoreconfig_1::asJson() const {
...
QJsonObject OAISavestoreconfig_1::asJsonObject() const {
    QJsonObject obj;
...
double OAISavestoreconfig_1::getDailyInterestRate() const {
    return m_daily_interest_rate;
}
void OAISavestoreconfig_1::setDailyInterestRate(const double &daily_interest_rate) {
    m_daily_interest_rate = daily_interest_rate;
    m_daily_interest_rate_isSet = true;
}

bool OAISavestoreconfig_1::is_daily_interest_rate_Set() const{
    return m_daily_interest_rate_isSet;
}

bool OAISavestoreconfig_1::is_daily_interest_rate_Valid() const{
    return m_daily_interest_rate_isValid;
}

qint32 OAISavestoreconfig_1::getInvoicePostponementLimit() const {
    return m_invoice_postponement_limit;
}
void OAISavestoreconfig_1::setInvoicePostponementLimit(const qint32 &invoice_postponement_limit) {
    m_invoice_postponement_limit = invoice_postponement_limit;
    m_invoice_postponement_limit_isSet = true;
}

bool OAISavestoreconfig_1::is_invoice_postponement_limit_Set() const{
    return m_invoice_postponement_limit_isSet;
}

bool OAISavestoreconfig_1::is_invoice_postponement_limit_Valid() const{
    return m_invoice_postponement_limit_isValid;
}

double OAISavestoreconfig_1::getTaxRate() const {
    return m_tax_rate;
}
void OAISavestoreconfig_1::setTaxRate(const double &tax_rate) {
    m_tax_rate = tax_rate;
    m_tax_rate_isSet = true;
}

bool OAISavestoreconfig_1::is_tax_rate_Set() const{
    return m_tax_rate_isSet;
}

bool OAISavestoreconfig_1::is_tax_rate_Valid() const{
    return m_tax_rate_isValid;
}

double OAISavestoreconfig_1::getTolerancePercent() const {
    return m_tolerance_percent;
}
void OAISavestoreconfig_1::setTolerancePercent(const double &tolerance_percent) {
    m_tolerance_percent = tolerance_percent;
    m_tolerance_percent_isSet = true;
}

bool OAISavestoreconfig_1::is_tolerance_percent_Set() const{
    return m_tolerance_percent_isSet;
}

bool OAISavestoreconfig_1::is_tolerance_percent_Valid() const{
    return m_tolerance_percent_isValid;
}

bool OAISavestoreconfig_1::isSet() const {
...
bool OAISavestoreconfig_1::isValid() const {
