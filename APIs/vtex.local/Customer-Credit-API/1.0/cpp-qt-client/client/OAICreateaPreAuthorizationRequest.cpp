...
#include "OAICreateaPreAuthorizationRequest.h"
...
OAICreateaPreAuthorizationRequest::OAICreateaPreAuthorizationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateaPreAuthorizationRequest::OAICreateaPreAuthorizationRequest() {
    this->initializeModel();
}

OAICreateaPreAuthorizationRequest::~OAICreateaPreAuthorizationRequest() {}

void OAICreateaPreAuthorizationRequest::initializeModel() {
...
void OAICreateaPreAuthorizationRequest::fromJson(QString jsonString) {
...
void OAICreateaPreAuthorizationRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateaPreAuthorizationRequest::asJson() const {
...
QJsonObject OAICreateaPreAuthorizationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateaPreAuthorizationRequest::getExpirationDate() const {
    return m_expiration_date;
}
void OAICreateaPreAuthorizationRequest::setExpirationDate(const QString &expiration_date) {
    m_expiration_date = expiration_date;
    m_expiration_date_isSet = true;
}

bool OAICreateaPreAuthorizationRequest::is_expiration_date_Set() const{
    return m_expiration_date_isSet;
}

bool OAICreateaPreAuthorizationRequest::is_expiration_date_Valid() const{
    return m_expiration_date_isValid;
}

QString OAICreateaPreAuthorizationRequest::getInstallments() const {
    return m_installments;
}
void OAICreateaPreAuthorizationRequest::setInstallments(const QString &installments) {
    m_installments = installments;
    m_installments_isSet = true;
}

bool OAICreateaPreAuthorizationRequest::is_installments_Set() const{
    return m_installments_isSet;
}

bool OAICreateaPreAuthorizationRequest::is_installments_Valid() const{
    return m_installments_isValid;
}

bool OAICreateaPreAuthorizationRequest::isSettle() const {
    return m_settle;
}
void OAICreateaPreAuthorizationRequest::setSettle(const bool &settle) {
    m_settle = settle;
    m_settle_isSet = true;
}

bool OAICreateaPreAuthorizationRequest::is_settle_Set() const{
    return m_settle_isSet;
}

bool OAICreateaPreAuthorizationRequest::is_settle_Valid() const{
    return m_settle_isValid;
}

QString OAICreateaPreAuthorizationRequest::getValue() const {
    return m_value;
}
void OAICreateaPreAuthorizationRequest::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAICreateaPreAuthorizationRequest::is_value_Set() const{
    return m_value_isSet;
}

bool OAICreateaPreAuthorizationRequest::is_value_Valid() const{
    return m_value_isValid;
}

bool OAICreateaPreAuthorizationRequest::isSet() const {
...
bool OAICreateaPreAuthorizationRequest::isValid() const {
