...
OAIClaims_2::OAIClaims_2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClaims_2::OAIClaims_2() {
    this->initializeModel();
}

OAIClaims_2::~OAIClaims_2() {}

void OAIClaims_2::initializeModel() {

    m_email_isSet = false;
    m_email_isValid = false;
}

void OAIClaims_2::fromJson(QString jsonString) {
...
void OAIClaims_2::fromJsonObject(QJsonObject json) {

    m_email_isValid = ::OpenAPI::fromJsonValue(m_email, json[QString("email")]);
    m_email_isSet = !json[QString("email")].isNull() && m_email_isValid;
}

QString OAIClaims_2::asJson() const {
...
QJsonObject OAIClaims_2::asJsonObject() const {
    QJsonObject obj;
    if (m_email_isSet) {
...
QString OAIClaims_2::getEmail() const {
    return m_email;
}
void OAIClaims_2::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIClaims_2::is_email_Set() const{
    return m_email_isSet;
}

bool OAIClaims_2::is_email_Valid() const{
    return m_email_isValid;
}

bool OAIClaims_2::isSet() const {
...
bool OAIClaims_2::isValid() const {
