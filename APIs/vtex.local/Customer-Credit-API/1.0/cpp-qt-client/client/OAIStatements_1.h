...
#ifndef OAIStatements_1_H
#define OAIStatements_1_H
...
class OAIStatements_1 : public OAIObject {
public:
    OAIStatements_1();
    OAIStatements_1(QString json);
    ~OAIStatements_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatements_1)

#endif // OAIStatements_1_H
