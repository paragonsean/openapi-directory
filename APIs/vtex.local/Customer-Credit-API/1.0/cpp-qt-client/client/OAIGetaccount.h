...
#ifndef OAIGetaccount_H
#define OAIGetaccount_H
...
class OAIGetaccount : public OAIObject {
public:
    OAIGetaccount();
    OAIGetaccount(QString json);
    ~OAIGetaccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetaccount)

#endif // OAIGetaccount_H
