...
/*
 * OAIMarkaninvoiceasPaidRequest.h
 *
 * 
 */

#ifndef OAIMarkaninvoiceasPaidRequest_H
#define OAIMarkaninvoiceasPaidRequest_H
...
class OAIMarkaninvoiceasPaidRequest : public OAIObject {
public:
    OAIMarkaninvoiceasPaidRequest();
    OAIMarkaninvoiceasPaidRequest(QString json);
    ~OAIMarkaninvoiceasPaidRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarkaninvoiceasPaidRequest)

#endif // OAIMarkaninvoiceasPaidRequest_H
