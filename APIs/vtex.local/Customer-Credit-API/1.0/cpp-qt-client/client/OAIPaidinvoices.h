...
#ifndef OAIPaidinvoices_H
#define OAIPaidinvoices_H
...
class OAIPaidinvoices : public OAIObject {
public:
    OAIPaidinvoices();
    OAIPaidinvoices(QString json);
    ~OAIPaidinvoices() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaidinvoices)

#endif // OAIPaidinvoices_H
