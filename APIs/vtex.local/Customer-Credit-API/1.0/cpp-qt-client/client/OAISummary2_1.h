...
#ifndef OAISummary2_1_H
#define OAISummary2_1_H
...
class OAISummary2_1 : public OAIObject {
public:
    OAISummary2_1();
    OAISummary2_1(QString json);
    ~OAISummary2_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISummary2_1)

#endif // OAISummary2_1_H
