...
OAIDatum_1::OAIDatum_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatum_1::OAIDatum_1() {
    this->initializeModel();
}

OAIDatum_1::~OAIDatum_1() {}

void OAIDatum_1::initializeModel() {
...
void OAIDatum_1::fromJson(QString jsonString) {
...
void OAIDatum_1::fromJsonObject(QJsonObject json) {
...
QString OAIDatum_1::asJson() const {
...
QJsonObject OAIDatum_1::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDatum_1::getCheckingAccountId() const {
    return m_checking_account_id;
}
void OAIDatum_1::setCheckingAccountId(const QString &checking_account_id) {
    m_checking_account_id = checking_account_id;
    m_checking_account_id_isSet = true;
}

bool OAIDatum_1::is_checking_account_id_Set() const{
    return m_checking_account_id_isSet;
}

bool OAIDatum_1::is_checking_account_id_Valid() const{
    return m_checking_account_id_isValid;
}

QString OAIDatum_1::getCreatedAt() const {
    return m_created_at;
}
void OAIDatum_1::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDatum_1::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDatum_1::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIDatum_1::getDescription() const {
    return m_description;
}
void OAIDatum_1::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDatum_1::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDatum_1::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIDatum_1::getDueDate() const {
    return m_due_date;
}
void OAIDatum_1::setDueDate(const QString &due_date) {
    m_due_date = due_date;
    m_due_date_isSet = true;
}

bool OAIDatum_1::is_due_date_Set() const{
    return m_due_date_isSet;
}

bool OAIDatum_1::is_due_date_Valid() const{
    return m_due_date_isValid;
}

QString OAIDatum_1::getId() const {
    return m_id;
}
void OAIDatum_1::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDatum_1::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDatum_1::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDatum_1::getObservation() const {
    return m_observation;
}
void OAIDatum_1::setObservation(const QString &observation) {
    m_observation = observation;
    m_observation_isSet = true;
}

bool OAIDatum_1::is_observation_Set() const{
    return m_observation_isSet;
}

bool OAIDatum_1::is_observation_Valid() const{
    return m_observation_isValid;
}

QString OAIDatum_1::getOriginalDueDate() const {
    return m_original_due_date;
}
void OAIDatum_1::setOriginalDueDate(const QString &original_due_date) {
    m_original_due_date = original_due_date;
    m_original_due_date_isSet = true;
}

bool OAIDatum_1::is_original_due_date_Set() const{
    return m_original_due_date_isSet;
}

bool OAIDatum_1::is_original_due_date_Valid() const{
    return m_original_due_date_isValid;
}

QString OAIDatum_1::getPaymentLink() const {
    return m_payment_link;
}
void OAIDatum_1::setPaymentLink(const QString &payment_link) {
    m_payment_link = payment_link;
    m_payment_link_isSet = true;
}

bool OAIDatum_1::is_payment_link_Set() const{
    return m_payment_link_isSet;
}

bool OAIDatum_1::is_payment_link_Valid() const{
    return m_payment_link_isValid;
}

QString OAIDatum_1::getStatus() const {
    return m_status;
}
void OAIDatum_1::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDatum_1::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDatum_1::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIDatum_1::getUpdatedAt() const {
    return m_updated_at;
}
void OAIDatum_1::setUpdatedAt(const QString &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIDatum_1::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIDatum_1::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

double OAIDatum_1::getValue() const {
    return m_value;
}
void OAIDatum_1::setValue(const double &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIDatum_1::is_value_Set() const{
    return m_value_isSet;
}

bool OAIDatum_1::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIDatum_1::isSet() const {
