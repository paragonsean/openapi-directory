...
OAIGetaccount::OAIGetaccount(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetaccount::OAIGetaccount() {
    this->initializeModel();
}

OAIGetaccount::~OAIGetaccount() {}

void OAIGetaccount::initializeModel() {
...
void OAIGetaccount::fromJson(QString jsonString) {
...
void OAIGetaccount::fromJsonObject(QJsonObject json) {
...
QString OAIGetaccount::asJson() const {
...
QJsonObject OAIGetaccount::asJsonObject() const {
    QJsonObject obj;
    if (m_account_isSet) {
...
QString OAIGetaccount::getAccount() const {
    return m_account;
}
void OAIGetaccount::setAccount(const QString &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAIGetaccount::is_account_Set() const{
    return m_account_isSet;
}

bool OAIGetaccount::is_account_Valid() const{
    return m_account_isValid;
}

double OAIGetaccount::getBalance() const {
    return m_balance;
}
void OAIGetaccount::setBalance(const double &balance) {
    m_balance = balance;
    m_balance_isSet = true;
}

bool OAIGetaccount::is_balance_Set() const{
    return m_balance_isSet;
}

bool OAIGetaccount::is_balance_Valid() const{
    return m_balance_isValid;
}

double OAIGetaccount::getCreditLimit() const {
    return m_credit_limit;
}
void OAIGetaccount::setCreditLimit(const double &credit_limit) {
    m_credit_limit = credit_limit;
    m_credit_limit_isSet = true;
}

bool OAIGetaccount::is_credit_limit_Set() const{
    return m_credit_limit_isSet;
}

bool OAIGetaccount::is_credit_limit_Valid() const{
    return m_credit_limit_isValid;
}

QString OAIGetaccount::getDescription() const {
    return m_description;
}
void OAIGetaccount::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGetaccount::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGetaccount::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIGetaccount::getEmail() const {
    return m_email;
}
void OAIGetaccount::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIGetaccount::is_email_Set() const{
    return m_email_isSet;
}

bool OAIGetaccount::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIGetaccount::getLastUpdate() const {
    return m_last_update;
}
void OAIGetaccount::setLastUpdate(const QString &last_update) {
    m_last_update = last_update;
    m_last_update_isSet = true;
}

bool OAIGetaccount::is_last_update_Set() const{
    return m_last_update_isSet;
}

bool OAIGetaccount::is_last_update_Valid() const{
    return m_last_update_isValid;
}

bool OAIGetaccount::isSet() const {
...
bool OAIGetaccount::isValid() const {
