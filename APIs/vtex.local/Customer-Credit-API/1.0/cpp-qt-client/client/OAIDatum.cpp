...
QString OAIDatum::getCheckingAccountId() const {
    return m_checking_account_id;
}
void OAIDatum::setCheckingAccountId(const QString &checking_account_id) {
    m_checking_account_id = checking_account_id;
    m_checking_account_id_isSet = true;
}

bool OAIDatum::is_checking_account_id_Set() const{
    return m_checking_account_id_isSet;
}

bool OAIDatum::is_checking_account_id_Valid() const{
    return m_checking_account_id_isValid;
}

QString OAIDatum::getCreatedAt() const {
    return m_created_at;
}
void OAIDatum::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDatum::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDatum::is_created_at_Valid() const{
...
QString OAIDatum::getDueDate() const {
    return m_due_date;
}
void OAIDatum::setDueDate(const QString &due_date) {
    m_due_date = due_date;
    m_due_date_isSet = true;
}

bool OAIDatum::is_due_date_Set() const{
    return m_due_date_isSet;
}

bool OAIDatum::is_due_date_Valid() const{
...
QString OAIDatum::getObservation() const {
    return m_observation;
}
void OAIDatum::setObservation(const QString &observation) {
    m_observation = observation;
    m_observation_isSet = true;
}

bool OAIDatum::is_observation_Set() const{
    return m_observation_isSet;
}

bool OAIDatum::is_observation_Valid() const{
    return m_observation_isValid;
}

QString OAIDatum::getOriginalDueDate() const {
    return m_original_due_date;
}
void OAIDatum::setOriginalDueDate(const QString &original_due_date) {
    m_original_due_date = original_due_date;
    m_original_due_date_isSet = true;
}

bool OAIDatum::is_original_due_date_Set() const{
    return m_original_due_date_isSet;
}

bool OAIDatum::is_original_due_date_Valid() const{
    return m_original_due_date_isValid;
}

QString OAIDatum::getPaymentLink() const {
    return m_payment_link;
}
void OAIDatum::setPaymentLink(const QString &payment_link) {
    m_payment_link = payment_link;
    m_payment_link_isSet = true;
}

bool OAIDatum::is_payment_link_Set() const{
    return m_payment_link_isSet;
}

bool OAIDatum::is_payment_link_Valid() const{
    return m_payment_link_isValid;
}

QString OAIDatum::getStatus() const {
    return m_status;
}
void OAIDatum::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDatum::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDatum::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIDatum::getUpdatedAt() const {
    return m_updated_at;
}
void OAIDatum::setUpdatedAt(const QString &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIDatum::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIDatum::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

double OAIDatum::getValue() const {
    return m_value;
}
void OAIDatum::setValue(const double &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIDatum::is_value_Set() const{
    return m_value_isSet;
}

bool OAIDatum::is_value_Valid() const{
