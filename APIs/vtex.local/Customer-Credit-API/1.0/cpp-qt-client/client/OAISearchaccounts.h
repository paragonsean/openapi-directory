...
#ifndef OAISearchaccounts_H
#define OAISearchaccounts_H

#include <QJsonObject>

#include "OAIDatum2_1.h"
...
class OAISearchaccounts : public OAIObject {
public:
    OAISearchaccounts();
    OAISearchaccounts(QString json);
    ~OAISearchaccounts() override;
    ...
    QList<OAIDatum2_1> getData() const;
    void setData(const QList<OAIDatum2_1> &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAISummary2_1 getSummary() const;
    void setSummary(const OAISummary2_1 &summary);
...
private:
    ...
    QList<OAIDatum2_1> m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAISummary2_1 m_summary;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchaccounts)

#endif // OAISearchaccounts_H
