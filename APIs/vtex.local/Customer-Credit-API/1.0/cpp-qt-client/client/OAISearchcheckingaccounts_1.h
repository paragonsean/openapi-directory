...
/*
 * OAISearchcheckingaccounts_1.h
 *
 * 
 */

#ifndef OAISearchcheckingaccounts_1_H
#define OAISearchcheckingaccounts_1_H
...
class OAISearchcheckingaccounts_1 : public OAIObject {
public:
    OAISearchcheckingaccounts_1();
    OAISearchcheckingaccounts_1(QString json);
    ~OAISearchcheckingaccounts_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchcheckingaccounts_1)

#endif // OAISearchcheckingaccounts_1_H
