...
/*
 * OAICloseanAccountRequest.h
 *
 * 
 */

#ifndef OAICloseanAccountRequest_H
#define OAICloseanAccountRequest_H
...
class OAICloseanAccountRequest : public OAIObject {
public:
    OAICloseanAccountRequest();
    OAICloseanAccountRequest(QString json);
    ~OAICloseanAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloseanAccountRequest)

#endif // OAICloseanAccountRequest_H
