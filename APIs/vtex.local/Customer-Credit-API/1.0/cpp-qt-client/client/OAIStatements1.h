...
#ifndef OAIStatements1_H
#define OAIStatements1_H
...
class OAIStatements1 : public OAIObject {
public:
    OAIStatements1();
    OAIStatements1(QString json);
    ~OAIStatements1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatements1)

#endif // OAIStatements1_H
