...
#ifndef OAIDatum1_1_H
#define OAIDatum1_1_H
...
class OAIDatum1_1 : public OAIObject {
public:
    OAIDatum1_1();
    OAIDatum1_1(QString json);
    ~OAIDatum1_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatum1_1)
