...
#include "OAIOpenorChangeAccountRequest.h"
...
OAIOpenorChangeAccountRequest::OAIOpenorChangeAccountRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOpenorChangeAccountRequest::OAIOpenorChangeAccountRequest() {
    this->initializeModel();
}

OAIOpenorChangeAccountRequest::~OAIOpenorChangeAccountRequest() {}

void OAIOpenorChangeAccountRequest::initializeModel() {
...
void OAIOpenorChangeAccountRequest::fromJson(QString jsonString) {
...
void OAIOpenorChangeAccountRequest::fromJsonObject(QJsonObject json) {
...
QString OAIOpenorChangeAccountRequest::asJson() const {
...
QJsonObject OAIOpenorChangeAccountRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIOpenorChangeAccountRequest::getCreditLimit() const {
    return m_credit_limit;
}
void OAIOpenorChangeAccountRequest::setCreditLimit(const QString &credit_limit) {
    m_credit_limit = credit_limit;
    m_credit_limit_isSet = true;
}

bool OAIOpenorChangeAccountRequest::is_credit_limit_Set() const{
    return m_credit_limit_isSet;
}

bool OAIOpenorChangeAccountRequest::is_credit_limit_Valid() const{
    return m_credit_limit_isValid;
}

QString OAIOpenorChangeAccountRequest::getEmail() const {
    return m_email;
}
void OAIOpenorChangeAccountRequest::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIOpenorChangeAccountRequest::is_email_Set() const{
    return m_email_isSet;
}

bool OAIOpenorChangeAccountRequest::is_email_Valid() const{
    return m_email_isValid;
}

bool OAIOpenorChangeAccountRequest::isSet() const {
...
bool OAIOpenorChangeAccountRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_credit_limit_isValid && m_email_isValid && true;
}
