...
/*
 * OAICreateaPreAuthorizationUsingidRequest.h
 *
 * 
 */

#ifndef OAICreateaPreAuthorizationUsingidRequest_H
#define OAICreateaPreAuthorizationUsingidRequest_H
...
class OAICreateaPreAuthorizationUsingidRequest : public OAIObject {
public:
    OAICreateaPreAuthorizationUsingidRequest();
    OAICreateaPreAuthorizationUsingidRequest(QString json);
    ~OAICreateaPreAuthorizationUsingidRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateaPreAuthorizationUsingidRequest)

#endif // OAICreateaPreAuthorizationUsingidRequest_H
