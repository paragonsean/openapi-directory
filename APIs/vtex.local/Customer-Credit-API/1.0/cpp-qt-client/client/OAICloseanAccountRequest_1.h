...
/*
 * OAICloseanAccountRequest_1.h
 *
 * 
 */

#ifndef OAICloseanAccountRequest_1_H
#define OAICloseanAccountRequest_1_H
...
class OAICloseanAccountRequest_1 : public OAIObject {
public:
    OAICloseanAccountRequest_1();
    OAICloseanAccountRequest_1(QString json);
    ~OAICloseanAccountRequest_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloseanAccountRequest_1)

#endif // OAICloseanAccountRequest_1_H
