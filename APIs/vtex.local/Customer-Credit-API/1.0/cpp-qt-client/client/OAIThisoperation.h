...
#ifndef OAIThisoperation_H
#define OAIThisoperation_H
...
class OAIThisoperation : public OAIObject {
public:
    OAIThisoperation();
    OAIThisoperation(QString json);
    ~OAIThisoperation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThisoperation)

#endif // OAIThisoperation_H
