...
OAICreateorUpdateSettlementRequest_1::OAICreateorUpdateSettlementRequest_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateorUpdateSettlementRequest_1::OAICreateorUpdateSettlementRequest_1() {
    this->initializeModel();
}

OAICreateorUpdateSettlementRequest_1::~OAICreateorUpdateSettlementRequest_1() {}

void OAICreateorUpdateSettlementRequest_1::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
}

void OAICreateorUpdateSettlementRequest_1::fromJson(QString jsonString) {
...
void OAICreateorUpdateSettlementRequest_1::fromJsonObject(QJsonObject json) {

    m_value_isValid = ::OpenAPI::fromJsonValue(m_value, json[QString("value")]);
    m_value_isSet = !json[QString("value")].isNull() && m_value_isValid;
}

QString OAICreateorUpdateSettlementRequest_1::asJson() const {
...
QJsonObject OAICreateorUpdateSettlementRequest_1::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
QString OAICreateorUpdateSettlementRequest_1::getValue() const {
    return m_value;
}
void OAICreateorUpdateSettlementRequest_1::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAICreateorUpdateSettlementRequest_1::is_value_Set() const{
    return m_value_isSet;
}

bool OAICreateorUpdateSettlementRequest_1::is_value_Valid() const{
    return m_value_isValid;
}

bool OAICreateorUpdateSettlementRequest_1::isSet() const {
...
bool OAICreateorUpdateSettlementRequest_1::isValid() const {
