...
/*
 * OAISavestoreconfig.h
 *
 * 
 */

#ifndef OAISavestoreconfig_H
#define OAISavestoreconfig_H
...
class OAISavestoreconfig : public OAIObject {
public:
    OAISavestoreconfig();
    OAISavestoreconfig(QString json);
    ~OAISavestoreconfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISavestoreconfig)

#endif // OAISavestoreconfig_H
