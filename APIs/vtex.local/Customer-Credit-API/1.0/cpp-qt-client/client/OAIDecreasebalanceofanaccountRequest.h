...
/*
 * OAIDecreasebalanceofanaccountRequest.h
 *
 * 
 */

#ifndef OAIDecreasebalanceofanaccountRequest_H
#define OAIDecreasebalanceofanaccountRequest_H
...
class OAIDecreasebalanceofanaccountRequest : public OAIObject {
public:
    OAIDecreasebalanceofanaccountRequest();
    OAIDecreasebalanceofanaccountRequest(QString json);
    ~OAIDecreasebalanceofanaccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDecreasebalanceofanaccountRequest)

#endif // OAIDecreasebalanceofanaccountRequest_H
