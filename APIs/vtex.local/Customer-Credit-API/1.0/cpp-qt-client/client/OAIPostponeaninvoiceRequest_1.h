...
/*
 * OAIPostponeaninvoiceRequest_1.h
 *
 * 
 */

#ifndef OAIPostponeaninvoiceRequest_1_H
#define OAIPostponeaninvoiceRequest_1_H
...
class OAIPostponeaninvoiceRequest_1 : public OAIObject {
public:
    OAIPostponeaninvoiceRequest_1();
    OAIPostponeaninvoiceRequest_1(QString json);
    ~OAIPostponeaninvoiceRequest_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostponeaninvoiceRequest_1)

#endif // OAIPostponeaninvoiceRequest_1_H
