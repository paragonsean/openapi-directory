...
#ifndef OAIClaims_2_H
#define OAIClaims_2_H
...
class OAIClaims_2 : public OAIObject {
public:
    OAIClaims_2();
    OAIClaims_2(QString json);
    ~OAIClaims_2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClaims_2)
