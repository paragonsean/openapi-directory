...
#ifndef OAIStoreconfig_H
#define OAIStoreconfig_H
...
class OAIStoreconfig : public OAIObject {
public:
    OAIStoreconfig();
    OAIStoreconfig(QString json);
    ~OAIStoreconfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoreconfig)

#endif // OAIStoreconfig_H
