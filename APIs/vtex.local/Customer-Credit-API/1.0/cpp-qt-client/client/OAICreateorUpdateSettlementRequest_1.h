...
/*
 * OAICreateorUpdateSettlementRequest_1.h
 *
 * 
 */

#ifndef OAICreateorUpdateSettlementRequest_1_H
#define OAICreateorUpdateSettlementRequest_1_H
...
class OAICreateorUpdateSettlementRequest_1 : public OAIObject {
public:
    OAICreateorUpdateSettlementRequest_1();
    OAICreateorUpdateSettlementRequest_1(QString json);
    ~OAICreateorUpdateSettlementRequest_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateorUpdateSettlementRequest_1)

#endif // OAICreateorUpdateSettlementRequest_1_H
