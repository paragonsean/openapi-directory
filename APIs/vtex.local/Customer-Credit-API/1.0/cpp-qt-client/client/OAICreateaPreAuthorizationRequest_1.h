...
/*
 * OAICreateaPreAuthorizationRequest_1.h
 *
 * 
 */

#ifndef OAICreateaPreAuthorizationRequest_1_H
#define OAICreateaPreAuthorizationRequest_1_H
...
class OAICreateaPreAuthorizationRequest_1 : public OAIObject {
public:
    OAICreateaPreAuthorizationRequest_1();
    OAICreateaPreAuthorizationRequest_1(QString json);
    ~OAICreateaPreAuthorizationRequest_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateaPreAuthorizationRequest_1)

#endif // OAICreateaPreAuthorizationRequest_1_H
