...
#include "OAICloseanAccountRequest.h"
...
OAICloseanAccountRequest::OAICloseanAccountRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICloseanAccountRequest::OAICloseanAccountRequest() {
    this->initializeModel();
}

OAICloseanAccountRequest::~OAICloseanAccountRequest() {}

void OAICloseanAccountRequest::initializeModel() {
...
void OAICloseanAccountRequest::fromJson(QString jsonString) {
...
void OAICloseanAccountRequest::fromJsonObject(QJsonObject json) {
...
QString OAICloseanAccountRequest::asJson() const {
...
QJsonObject OAICloseanAccountRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_document_isSet) {
...
QString OAICloseanAccountRequest::getDocument() const {
    return m_document;
}
void OAICloseanAccountRequest::setDocument(const QString &document) {
    m_document = document;
    m_document_isSet = true;
}

bool OAICloseanAccountRequest::is_document_Set() const{
    return m_document_isSet;
}

bool OAICloseanAccountRequest::is_document_Valid() const{
    return m_document_isValid;
}

QString OAICloseanAccountRequest::getDocumentType() const {
    return m_document_type;
}
void OAICloseanAccountRequest::setDocumentType(const QString &document_type) {
    m_document_type = document_type;
    m_document_type_isSet = true;
}

bool OAICloseanAccountRequest::is_document_type_Set() const{
    return m_document_type_isSet;
}

bool OAICloseanAccountRequest::is_document_type_Valid() const{
    return m_document_type_isValid;
}

QString OAICloseanAccountRequest::getEmail() const {
    return m_email;
}
void OAICloseanAccountRequest::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAICloseanAccountRequest::is_email_Set() const{
    return m_email_isSet;
}

bool OAICloseanAccountRequest::is_email_Valid() const{
    return m_email_isValid;
}

bool OAICloseanAccountRequest::isSet() const {
...
bool OAICloseanAccountRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_document_isValid && m_document_type_isValid && m_email_isValid && true;
}
