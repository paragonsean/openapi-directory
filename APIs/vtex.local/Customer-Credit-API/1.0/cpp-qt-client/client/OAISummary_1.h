...
#ifndef OAISummary_1_H
#define OAISummary_1_H
...
class OAISummary_1 : public OAIObject {
public:
    OAISummary_1();
    OAISummary_1(QString json);
    ~OAISummary_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISummary_1)

#endif // OAISummary_1_H
