...
class Savestoreconfig(Model):
    ...
    def __init__(self, daily_interest_rate: float=None, invoice_postponement_limit: int=None, tax_rate: float=None, tolerance_percent: float=None):
        """Savestoreconfig - a model defined in OpenAPI

        :param daily_interest_rate: The daily_interest_rate of this Savestoreconfig.
        :param invoice_postponement_limit: The invoice_postponement_limit of this Savestoreconfig.
        :param tax_rate: The tax_rate of this Savestoreconfig.
        :param tolerance_percent: The tolerance_percent of this Savestoreconfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Savestoreconfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Savestoreconfig of this Savestoreconfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def daily_interest_rate(self):
        """Gets the daily_interest_rate of this Savestoreconfig.


        :return: The daily_interest_rate of this Savestoreconfig.
        :rtype: float
        """
    ...
    def daily_interest_rate(self, daily_interest_rate):
        """Sets the daily_interest_rate of this Savestoreconfig.
    ...
    def invoice_postponement_limit(self):
        """Gets the invoice_postponement_limit of this Savestoreconfig.


        :return: The invoice_postponement_limit of this Savestoreconfig.
        :rtype: int
        """
    ...
    def invoice_postponement_limit(self, invoice_postponement_limit):
        """Sets the invoice_postponement_limit of this Savestoreconfig.
    ...
    @property
    def tax_rate(self):
        """Gets the tax_rate of this Savestoreconfig.


        :return: The tax_rate of this Savestoreconfig.
        :rtype: float
        """
    ...
    def tax_rate(self, tax_rate):
        """Sets the tax_rate of this Savestoreconfig.
    ...
    def tolerance_percent(self):
        """Gets the tolerance_percent of this Savestoreconfig.


        :return: The tolerance_percent of this Savestoreconfig.
        :rtype: float
        """
    ...
    def tolerance_percent(self, tolerance_percent):
        """Sets the tolerance_percent of this Savestoreconfig.
