...
class Getaccount {
    ...
    constructor(account, balance, creditLimit, description, email, lastUpdate) { 
        ...
        Getaccount.initialize(this, account, balance, creditLimit, description, email, lastUpdate);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Getaccount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Getaccount</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Getaccount.RequiredProperties) {
...
Getaccount.RequiredProperties = ["account", "balance", "creditLimit", "description", "email", "lastUpdate"];

/**
 * @member {String} account
 */
Getaccount.prototype['account'] = undefined;

/**
 * @member {Number} balance
 */
Getaccount.prototype['balance'] = undefined;

/**
 * @member {Number} creditLimit
 */
Getaccount.prototype['creditLimit'] = undefined;

/**
 * @member {String} description
 */
Getaccount.prototype['description'] = undefined;

/**
 * @member {String} email
 */
Getaccount.prototype['email'] = undefined;

/**
 * @member {String} lastUpdate
 */
Getaccount.prototype['lastUpdate'] = undefined;
