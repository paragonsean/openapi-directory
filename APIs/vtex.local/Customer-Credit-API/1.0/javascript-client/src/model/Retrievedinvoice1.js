...
/**
 * The Retrievedinvoice1 model module.
 * @module model/Retrievedinvoice1
 * @version 1.0
 */
class Retrievedinvoice1 {
    /**
     * Constructs a new <code>Retrievedinvoice1</code>.
     * @alias module:model/Retrievedinvoice1
    ...
    constructor(checkingAccountId, createdAt, description, dueDate, id, observation, originalDueDate, paymentLink, status, updatedAt, value) { 
        ...
        Retrievedinvoice1.initialize(this, checkingAccountId, createdAt, description, dueDate, id, observation, originalDueDate, paymentLink, status, updatedAt, value);
    }
    ...
    /**
     * Constructs a <code>Retrievedinvoice1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Retrievedinvoice1} obj Optional instance to populate.
     * @return {module:model/Retrievedinvoice1} The populated <code>Retrievedinvoice1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Retrievedinvoice1();
    ...
    /**
     * Validates the JSON data with respect to <code>Retrievedinvoice1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Retrievedinvoice1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Retrievedinvoice1.RequiredProperties) {
...
Retrievedinvoice1.RequiredProperties = ["checkingAccountId", "createdAt", "description", "dueDate", "id", "observation", "originalDueDate", "paymentLink", "status", "updatedAt", "value"];

/**
 * @member {String} checkingAccountId
 */
Retrievedinvoice1.prototype['checkingAccountId'] = undefined;

/**
 * @member {String} createdAt
 */
Retrievedinvoice1.prototype['createdAt'] = undefined;

/**
 * @member {String} description
 */
Retrievedinvoice1.prototype['description'] = undefined;

/**
 * @member {String} dueDate
 */
Retrievedinvoice1.prototype['dueDate'] = undefined;

/**
 * @member {String} id
 */
Retrievedinvoice1.prototype['id'] = undefined;

/**
 * @member {String} observation
 */
Retrievedinvoice1.prototype['observation'] = undefined;

/**
 * @member {String} originalDueDate
 */
Retrievedinvoice1.prototype['originalDueDate'] = undefined;

/**
 * @member {String} paymentLink
 */
Retrievedinvoice1.prototype['paymentLink'] = undefined;

/**
 * @member {String} status
 */
Retrievedinvoice1.prototype['status'] = undefined;

/**
 * @member {String} updatedAt
 */
Retrievedinvoice1.prototype['updatedAt'] = undefined;

/**
 * @member {Number} value
 */
Retrievedinvoice1.prototype['value'] = undefined;
...
export default Retrievedinvoice1;
