...
/**
 * The ChangeInvoiceRequest1 model module.
 * @module model/ChangeInvoiceRequest1
 * @version 1.0
 */
class ChangeInvoiceRequest1 {
    /**
     * Constructs a new <code>ChangeInvoiceRequest1</code>.
     * @alias module:model/ChangeInvoiceRequest1
     * @param observation {String} 
     * @param paymentLink {String} 
     * @param status {String} Invoice's status. It must be completed with &quot;Paid&quot;, &quot;Cancelled&quot; or &quot;Open&quot; value.
     */
    constructor(observation, paymentLink, status) { 
        
        ChangeInvoiceRequest1.initialize(this, observation, paymentLink, status);
    }
    ...
    static initialize(obj, observation, paymentLink, status) { 
        obj['observation'] = observation || 'example';
        obj['paymentLink'] = paymentLink || 'example';
        obj['status'] = status || 'Paid';
    }

    /**
     * Constructs a <code>ChangeInvoiceRequest1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChangeInvoiceRequest1} obj Optional instance to populate.
     * @return {module:model/ChangeInvoiceRequest1} The populated <code>ChangeInvoiceRequest1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangeInvoiceRequest1();
    ...
    /**
     * Validates the JSON data with respect to <code>ChangeInvoiceRequest1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChangeInvoiceRequest1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChangeInvoiceRequest1.RequiredProperties) {
...
ChangeInvoiceRequest1.RequiredProperties = ["observation", "paymentLink", "status"];

/**
 * @member {String} observation
 * @default 'example'
 */
ChangeInvoiceRequest1.prototype['observation'] = 'example';

/**
 * @member {String} paymentLink
 * @default 'example'
 */
ChangeInvoiceRequest1.prototype['paymentLink'] = 'example';
 ...
 * @default 'Paid'
 */
ChangeInvoiceRequest1.prototype['status'] = 'Paid';
...
export default ChangeInvoiceRequest1;
