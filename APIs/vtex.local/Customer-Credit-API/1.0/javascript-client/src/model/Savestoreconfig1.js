...
/**
 * The Savestoreconfig1 model module.
 * @module model/Savestoreconfig1
 * @version 1.0
 */
class Savestoreconfig1 {
    /**
     * Constructs a new <code>Savestoreconfig1</code>.
     * @alias module:model/Savestoreconfig1
    ...
    constructor(dailyInterestRate, invoicePostponementLimit, taxRate, tolerancePercent) { 
        ...
        Savestoreconfig1.initialize(this, dailyInterestRate, invoicePostponementLimit, taxRate, tolerancePercent);
    }
    ...
    /**
     * Constructs a <code>Savestoreconfig1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Savestoreconfig1} obj Optional instance to populate.
     * @return {module:model/Savestoreconfig1} The populated <code>Savestoreconfig1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Savestoreconfig1();
    ...
    /**
     * Validates the JSON data with respect to <code>Savestoreconfig1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Savestoreconfig1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Savestoreconfig1.RequiredProperties) {
...
Savestoreconfig1.RequiredProperties = ["dailyInterestRate", "invoicePostponementLimit", "taxRate", "tolerancePercent"];

/**
 * @member {Number} dailyInterestRate
 */
Savestoreconfig1.prototype['dailyInterestRate'] = undefined;

/**
 * @member {Number} invoicePostponementLimit
 */
Savestoreconfig1.prototype['invoicePostponementLimit'] = undefined;

/**
 * @member {Number} taxRate
 */
Savestoreconfig1.prototype['taxRate'] = undefined;

/**
 * @member {Number} tolerancePercent
 */
Savestoreconfig1.prototype['tolerancePercent'] = undefined;
...
export default Savestoreconfig1;
