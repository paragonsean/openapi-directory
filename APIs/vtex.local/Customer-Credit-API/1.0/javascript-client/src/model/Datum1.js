...
/**
 * The Datum1 model module.
 * @module model/Datum1
 * @version 1.0
 */
class Datum1 {
    /**
     * Constructs a new <code>Datum1</code>.
     * @alias module:model/Datum1
    ...
    constructor(checkingAccountId, createdAt, description, dueDate, id, observation, originalDueDate, paymentLink, status, updatedAt, value) { 
        ...
        Datum1.initialize(this, checkingAccountId, createdAt, description, dueDate, id, observation, originalDueDate, paymentLink, status, updatedAt, value);
    }
    ...
    /**
     * Constructs a <code>Datum1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Datum1} obj Optional instance to populate.
     * @return {module:model/Datum1} The populated <code>Datum1</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Datum1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Datum1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Datum1.RequiredProperties) {
...
Datum1.RequiredProperties = ["checkingAccountId", "createdAt", "description", "dueDate", "id", "observation", "originalDueDate", "paymentLink", "status", "updatedAt", "value"];

/**
 * @member {String} checkingAccountId
 */
Datum1.prototype['checkingAccountId'] = undefined;

/**
 * @member {String} createdAt
 */
Datum1.prototype['createdAt'] = undefined;

/**
 * @member {String} description
 */
Datum1.prototype['description'] = undefined;

/**
 * @member {String} dueDate
 */
Datum1.prototype['dueDate'] = undefined;

/**
 * @member {String} id
 */
Datum1.prototype['id'] = undefined;

/**
 * @member {String} observation
 */
Datum1.prototype['observation'] = undefined;

/**
 * @member {String} originalDueDate
 */
Datum1.prototype['originalDueDate'] = undefined;

/**
 * @member {String} paymentLink
 */
Datum1.prototype['paymentLink'] = undefined;

/**
 * @member {String} status
 */
Datum1.prototype['status'] = undefined;

/**
 * @member {String} updatedAt
 */
Datum1.prototype['updatedAt'] = undefined;

/**
 * @member {Number} value
 */
Datum1.prototype['value'] = undefined;
