...
/**
 * The Summary1 model module.
 * @module model/Summary1
 * @version 1.0
 */
class Summary1 {
    /**
     * Constructs a new <code>Summary1</code>.
     * @alias module:model/Summary1
     * @param count {Number} 
     * @param total {Number} 
     */
    constructor(count, total) { 
        
        Summary1.initialize(this, count, total);
    }
    ...
    /**
     * Constructs a <code>Summary1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Summary1} obj Optional instance to populate.
     * @return {module:model/Summary1} The populated <code>Summary1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Summary1();
    ...
    /**
     * Validates the JSON data with respect to <code>Summary1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Summary1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Summary1.RequiredProperties) {
...
Summary1.RequiredProperties = ["count", "total"];

/**
 * @member {Number} count
 */
Summary1.prototype['count'] = undefined;

/**
 * @member {Number} total
 */
Summary1.prototype['total'] = undefined;
