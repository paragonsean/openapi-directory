...
class Storeconfig {
    ...
    constructor(dailyInterestRate, invoicePostponementLimit, taxRate, tolerancePercent) { 
        ...
        Storeconfig.initialize(this, dailyInterestRate, invoicePostponementLimit, taxRate, tolerancePercent);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Storeconfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Storeconfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Storeconfig.RequiredProperties) {
...
Storeconfig.RequiredProperties = ["dailyInterestRate", "invoicePostponementLimit", "taxRate", "tolerancePercent"];

/**
 * @member {Number} dailyInterestRate
 */
Storeconfig.prototype['dailyInterestRate'] = undefined;

/**
 * @member {Number} invoicePostponementLimit
 */
Storeconfig.prototype['invoicePostponementLimit'] = undefined;

/**
 * @member {Number} taxRate
 */
Storeconfig.prototype['taxRate'] = undefined;

/**
 * @member {Number} tolerancePercent
 */
Storeconfig.prototype['tolerancePercent'] = undefined;
