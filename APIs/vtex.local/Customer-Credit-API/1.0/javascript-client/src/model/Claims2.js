...
/**
 * The Claims2 model module.
 * @module model/Claims2
 * @version 1.0
 */
class Claims2 {
    /**
     * Constructs a new <code>Claims2</code>.
     * @alias module:model/Claims2
     * @param email {String} 
     */
    constructor(email) { 
        
        Claims2.initialize(this, email);
    }
    ...
    /**
     * Constructs a <code>Claims2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Claims2} obj Optional instance to populate.
     * @return {module:model/Claims2} The populated <code>Claims2</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Claims2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Claims2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Claims2.RequiredProperties) {
...
Claims2.RequiredProperties = ["email"];

/**
 * @member {String} email
 */
Claims2.prototype['email'] = undefined;
