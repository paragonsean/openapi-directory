...
/**
 * The CloseanAccountRequest1 model module.
 * @module model/CloseanAccountRequest1
 * @version 1.0
 */
class CloseanAccountRequest1 {
    /**
     * Constructs a new <code>CloseanAccountRequest1</code>.
     * @alias module:model/CloseanAccountRequest1
     */
    constructor() { 
        
        CloseanAccountRequest1.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['document'] = '99999999999';
        obj['documentType'] = 'CPF';
        obj['email'] = 'email@domain.com';
    }

    /**
     * Constructs a <code>CloseanAccountRequest1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CloseanAccountRequest1} obj Optional instance to populate.
     * @return {module:model/CloseanAccountRequest1} The populated <code>CloseanAccountRequest1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CloseanAccountRequest1();
    ...
    /**
     * Validates the JSON data with respect to <code>CloseanAccountRequest1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CloseanAccountRequest1</code>.
     */
 ...
 * @default '99999999999'
 */
CloseanAccountRequest1.prototype['document'] = '99999999999';

/**
 * @member {String} documentType
 * @default 'CPF'
 */
CloseanAccountRequest1.prototype['documentType'] = 'CPF';

/**
 * @member {String} email
 * @default 'email@domain.com'
 */
CloseanAccountRequest1.prototype['email'] = 'email@domain.com';
...
export default CloseanAccountRequest1;
