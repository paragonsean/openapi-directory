...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.StoreConfigurationApi();
  });
  ...
  describe('StoreConfigurationApi', function() {
    describe('createorchangestoreconfiguration', function() {
      it('should call createorchangestoreconfiguration successfully', function(done) {
        //uncomment below and update the code to test createorchangestoreconfiguration
        //instance.createorchangestoreconfiguration(function(error) {
    ...
    describe('retrievestoreconfiguration', function() {
      it('should call retrievestoreconfiguration successfully', function(done) {
        //uncomment below and update the code to test retrievestoreconfiguration
        //instance.retrievestoreconfiguration(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
