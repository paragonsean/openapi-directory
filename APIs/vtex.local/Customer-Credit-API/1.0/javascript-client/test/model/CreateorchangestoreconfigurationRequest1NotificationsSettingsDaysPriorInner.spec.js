...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.CreateorchangestoreconfigurationRequest1NotificationsSettingsDaysPriorInner();
  });
  ...
  describe('CreateorchangestoreconfigurationRequest1NotificationsSettingsDaysPriorInner', function() {
    it('should create an instance of CreateorchangestoreconfigurationRequest1NotificationsSettingsDaysPriorInner', function() {
      // uncomment below and update the code to test CreateorchangestoreconfigurationRequest1NotificationsSettingsDaysPriorInner
      //var instance = new CustomerCreditApi.CreateorchangestoreconfigurationRequest1NotificationsSettingsDaysPriorInner();
      //expect(instance).to.be.a(CustomerCreditApi.CreateorchangestoreconfigurationRequest1NotificationsSettingsDaysPriorInner);
    });
