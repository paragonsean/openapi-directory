...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.CreateorUpdateSettlementRequest1();
  });
  ...
  describe('CreateorUpdateSettlementRequest1', function() {
    it('should create an instance of CreateorUpdateSettlementRequest1', function() {
      // uncomment below and update the code to test CreateorUpdateSettlementRequest1
      //var instance = new CustomerCreditApi.CreateorUpdateSettlementRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.CreateorUpdateSettlementRequest1);
    });
