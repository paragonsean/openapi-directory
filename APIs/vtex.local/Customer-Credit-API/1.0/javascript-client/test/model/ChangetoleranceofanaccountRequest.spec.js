...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.ChangetoleranceofanaccountRequest();
  });
  ...
  describe('ChangetoleranceofanaccountRequest', function() {
    it('should create an instance of ChangetoleranceofanaccountRequest', function() {
      // uncomment below and update the code to test ChangetoleranceofanaccountRequest
      //var instance = new CustomerCreditApi.ChangetoleranceofanaccountRequest();
      //expect(instance).to.be.a(CustomerCreditApi.ChangetoleranceofanaccountRequest);
    });
