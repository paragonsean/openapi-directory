...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Storeconfig1();
  });
  ...
  describe('Storeconfig1', function() {
    it('should create an instance of Storeconfig1', function() {
      // uncomment below and update the code to test Storeconfig1
      //var instance = new CustomerCreditApi.Storeconfig1();
      //expect(instance).to.be.a(CustomerCreditApi.Storeconfig1);
    });
