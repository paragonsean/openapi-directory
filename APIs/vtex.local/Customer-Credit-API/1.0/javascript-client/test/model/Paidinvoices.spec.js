...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Paidinvoices();
  });
  ...
  describe('Paidinvoices', function() {
    it('should create an instance of Paidinvoices', function() {
      // uncomment below and update the code to test Paidinvoices
      //var instance = new CustomerCreditApi.Paidinvoices();
      //expect(instance).to.be.a(CustomerCreditApi.Paidinvoices);
    });
