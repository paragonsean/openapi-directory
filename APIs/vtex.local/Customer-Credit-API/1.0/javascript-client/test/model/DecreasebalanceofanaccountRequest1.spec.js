...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.DecreasebalanceofanaccountRequest1();
  });
  ...
  describe('DecreasebalanceofanaccountRequest1', function() {
    it('should create an instance of DecreasebalanceofanaccountRequest1', function() {
      // uncomment below and update the code to test DecreasebalanceofanaccountRequest1
      //var instance = new CustomerCreditApi.DecreasebalanceofanaccountRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.DecreasebalanceofanaccountRequest1);
    });
