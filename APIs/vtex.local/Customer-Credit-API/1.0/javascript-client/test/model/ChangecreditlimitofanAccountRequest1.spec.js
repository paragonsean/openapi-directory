...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.ChangecreditlimitofanAccountRequest1();
  });
  ...
  describe('ChangecreditlimitofanAccountRequest1', function() {
    it('should create an instance of ChangecreditlimitofanAccountRequest1', function() {
      // uncomment below and update the code to test ChangecreditlimitofanAccountRequest1
      //var instance = new CustomerCreditApi.ChangecreditlimitofanAccountRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.ChangecreditlimitofanAccountRequest1);
    });
