...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Getinvoicesfromacheckingaccount1();
  });
  ...
  describe('Getinvoicesfromacheckingaccount1', function() {
    it('should create an instance of Getinvoicesfromacheckingaccount1', function() {
      // uncomment below and update the code to test Getinvoicesfromacheckingaccount1
      //var instance = new CustomerCreditApi.Getinvoicesfromacheckingaccount1();
      //expect(instance).to.be.a(CustomerCreditApi.Getinvoicesfromacheckingaccount1);
    });
