...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.MarkaninvoiceasPaidRequest1();
  });
  ...
  describe('MarkaninvoiceasPaidRequest1', function() {
    it('should create an instance of MarkaninvoiceasPaidRequest1', function() {
      // uncomment below and update the code to test MarkaninvoiceasPaidRequest1
      //var instance = new CustomerCreditApi.MarkaninvoiceasPaidRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.MarkaninvoiceasPaidRequest1);
    });
