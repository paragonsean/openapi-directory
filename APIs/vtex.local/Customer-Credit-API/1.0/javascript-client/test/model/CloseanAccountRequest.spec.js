...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.CloseanAccountRequest();
  });
  ...
  describe('CloseanAccountRequest', function() {
    it('should create an instance of CloseanAccountRequest', function() {
      // uncomment below and update the code to test CloseanAccountRequest
      //var instance = new CustomerCreditApi.CloseanAccountRequest();
      //expect(instance).to.be.a(CustomerCreditApi.CloseanAccountRequest);
    });
