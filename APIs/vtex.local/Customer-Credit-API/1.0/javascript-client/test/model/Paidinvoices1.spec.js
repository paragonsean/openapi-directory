...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Paidinvoices1();
  });
  ...
  describe('Paidinvoices1', function() {
    it('should create an instance of Paidinvoices1', function() {
      // uncomment below and update the code to test Paidinvoices1
      //var instance = new CustomerCreditApi.Paidinvoices1();
      //expect(instance).to.be.a(CustomerCreditApi.Paidinvoices1);
    });
