...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Searchcheckingaccounts();
  });
  ...
  describe('Searchcheckingaccounts', function() {
    it('should create an instance of Searchcheckingaccounts', function() {
      // uncomment below and update the code to test Searchcheckingaccounts
      //var instance = new CustomerCreditApi.Searchcheckingaccounts();
      //expect(instance).to.be.a(CustomerCreditApi.Searchcheckingaccounts);
    });
