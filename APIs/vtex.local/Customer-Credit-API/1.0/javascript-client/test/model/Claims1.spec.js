...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Claims1();
  });
  ...
  describe('Claims1', function() {
    it('should create an instance of Claims1', function() {
      // uncomment below and update the code to test Claims1
      //var instance = new CustomerCreditApi.Claims1();
      //expect(instance).to.be.a(CustomerCreditApi.Claims1);
    });
