...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Summary1();
  });
  ...
  describe('Summary1', function() {
    it('should create an instance of Summary1', function() {
      // uncomment below and update the code to test Summary1
      //var instance = new CustomerCreditApi.Summary1();
      //expect(instance).to.be.a(CustomerCreditApi.Summary1);
    });
