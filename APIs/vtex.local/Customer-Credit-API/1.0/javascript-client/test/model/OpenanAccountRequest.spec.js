...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.OpenanAccountRequest();
  });
  ...
  describe('OpenanAccountRequest', function() {
    it('should create an instance of OpenanAccountRequest', function() {
      // uncomment below and update the code to test OpenanAccountRequest
      //var instance = new CustomerCreditApi.OpenanAccountRequest();
      //expect(instance).to.be.a(CustomerCreditApi.OpenanAccountRequest);
    });
