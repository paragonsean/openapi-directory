...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.OpenorChangeAccountRequest1();
  });
  ...
  describe('OpenorChangeAccountRequest1', function() {
    it('should create an instance of OpenorChangeAccountRequest1', function() {
      // uncomment below and update the code to test OpenorChangeAccountRequest1
      //var instance = new CustomerCreditApi.OpenorChangeAccountRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.OpenorChangeAccountRequest1);
    });
