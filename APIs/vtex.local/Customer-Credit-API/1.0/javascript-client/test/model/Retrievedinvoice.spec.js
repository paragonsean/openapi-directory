...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Retrievedinvoice();
  });
  ...
  describe('Retrievedinvoice', function() {
    it('should create an instance of Retrievedinvoice', function() {
      // uncomment below and update the code to test Retrievedinvoice
      //var instance = new CustomerCreditApi.Retrievedinvoice();
      //expect(instance).to.be.a(CustomerCreditApi.Retrievedinvoice);
    });
