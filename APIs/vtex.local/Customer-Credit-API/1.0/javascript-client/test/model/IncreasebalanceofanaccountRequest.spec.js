...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.IncreasebalanceofanaccountRequest();
  });
  ...
  describe('IncreasebalanceofanaccountRequest', function() {
    it('should create an instance of IncreasebalanceofanaccountRequest', function() {
      // uncomment below and update the code to test IncreasebalanceofanaccountRequest
      //var instance = new CustomerCreditApi.IncreasebalanceofanaccountRequest();
      //expect(instance).to.be.a(CustomerCreditApi.IncreasebalanceofanaccountRequest);
    });
