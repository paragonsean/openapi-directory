...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Statements1();
  });
  ...
  describe('Statements1', function() {
    it('should create an instance of Statements1', function() {
      // uncomment below and update the code to test Statements1
      //var instance = new CustomerCreditApi.Statements1();
      //expect(instance).to.be.a(CustomerCreditApi.Statements1);
    });
