...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Statements11();
  });
  ...
  describe('Statements11', function() {
    it('should create an instance of Statements11', function() {
      // uncomment below and update the code to test Statements11
      //var instance = new CustomerCreditApi.Statements11();
      //expect(instance).to.be.a(CustomerCreditApi.Statements11);
    });
