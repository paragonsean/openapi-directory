...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Searchcheckingaccounts1();
  });
  ...
  describe('Searchcheckingaccounts1', function() {
    it('should create an instance of Searchcheckingaccounts1', function() {
      // uncomment below and update the code to test Searchcheckingaccounts1
      //var instance = new CustomerCreditApi.Searchcheckingaccounts1();
      //expect(instance).to.be.a(CustomerCreditApi.Searchcheckingaccounts1);
    });
