...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Savestoreconfig();
  });
  ...
  describe('Savestoreconfig', function() {
    it('should create an instance of Savestoreconfig', function() {
      // uncomment below and update the code to test Savestoreconfig
      //var instance = new CustomerCreditApi.Savestoreconfig();
      //expect(instance).to.be.a(CustomerCreditApi.Savestoreconfig);
    });

    it('should have the property dailyInterestRate (base name: "dailyInterestRate")', function() {
      // uncomment below and update the code to test the property dailyInterestRate
      //var instance = new CustomerCreditApi.Savestoreconfig();
      //expect(instance).to.be();
    });

    it('should have the property invoicePostponementLimit (base name: "invoicePostponementLimit")', function() {
      // uncomment below and update the code to test the property invoicePostponementLimit
      //var instance = new CustomerCreditApi.Savestoreconfig();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tolerancePercent (base name: "tolerancePercent")', function() {
      // uncomment below and update the code to test the property tolerancePercent
      //var instance = new CustomerCreditApi.Savestoreconfig();
      //expect(instance).to.be();
    });
