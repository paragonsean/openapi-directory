...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.PostponeaninvoiceRequest();
  });
  ...
  describe('PostponeaninvoiceRequest', function() {
    it('should create an instance of PostponeaninvoiceRequest', function() {
      // uncomment below and update the code to test PostponeaninvoiceRequest
      //var instance = new CustomerCreditApi.PostponeaninvoiceRequest();
      //expect(instance).to.be.a(CustomerCreditApi.PostponeaninvoiceRequest);
    });
