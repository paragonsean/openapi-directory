...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.PartialorTotalRefundaSettlementRequest1();
  });
  ...
  describe('PartialorTotalRefundaSettlementRequest1', function() {
    it('should create an instance of PartialorTotalRefundaSettlementRequest1', function() {
      // uncomment below and update the code to test PartialorTotalRefundaSettlementRequest1
      //var instance = new CustomerCreditApi.PartialorTotalRefundaSettlementRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.PartialorTotalRefundaSettlementRequest1);
    });
