...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.DecreasebalanceofanaccountRequest();
  });
  ...
  describe('DecreasebalanceofanaccountRequest', function() {
    it('should create an instance of DecreasebalanceofanaccountRequest', function() {
      // uncomment below and update the code to test DecreasebalanceofanaccountRequest
      //var instance = new CustomerCreditApi.DecreasebalanceofanaccountRequest();
      //expect(instance).to.be.a(CustomerCreditApi.DecreasebalanceofanaccountRequest);
    });
