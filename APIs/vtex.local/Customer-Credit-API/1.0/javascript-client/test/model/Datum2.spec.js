...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Datum2();
  });
  ...
  describe('Datum2', function() {
    it('should create an instance of Datum2', function() {
      // uncomment below and update the code to test Datum2
      //var instance = new CustomerCreditApi.Datum2();
      //expect(instance).to.be.a(CustomerCreditApi.Datum2);
    });
