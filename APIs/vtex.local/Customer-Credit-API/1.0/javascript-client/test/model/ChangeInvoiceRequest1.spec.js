...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.ChangeInvoiceRequest1();
  });
  ...
  describe('ChangeInvoiceRequest1', function() {
    it('should create an instance of ChangeInvoiceRequest1', function() {
      // uncomment below and update the code to test ChangeInvoiceRequest1
      //var instance = new CustomerCreditApi.ChangeInvoiceRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.ChangeInvoiceRequest1);
    });
