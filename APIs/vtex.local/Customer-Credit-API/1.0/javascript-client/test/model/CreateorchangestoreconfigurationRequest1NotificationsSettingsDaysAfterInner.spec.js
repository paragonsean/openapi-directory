...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.CreateorchangestoreconfigurationRequest1NotificationsSettingsDaysAfterInner();
  });
  ...
  describe('CreateorchangestoreconfigurationRequest1NotificationsSettingsDaysAfterInner', function() {
    it('should create an instance of CreateorchangestoreconfigurationRequest1NotificationsSettingsDaysAfterInner', function() {
      // uncomment below and update the code to test CreateorchangestoreconfigurationRequest1NotificationsSettingsDaysAfterInner
      //var instance = new CustomerCreditApi.CreateorchangestoreconfigurationRequest1NotificationsSettingsDaysAfterInner();
      //expect(instance).to.be.a(CustomerCreditApi.CreateorchangestoreconfigurationRequest1NotificationsSettingsDaysAfterInner);
    });
