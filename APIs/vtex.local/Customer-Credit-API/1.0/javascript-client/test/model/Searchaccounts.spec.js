...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Searchaccounts();
  });
  ...
  describe('Searchaccounts', function() {
    it('should create an instance of Searchaccounts', function() {
      // uncomment below and update the code to test Searchaccounts
      //var instance = new CustomerCreditApi.Searchaccounts();
      //expect(instance).to.be.a(CustomerCreditApi.Searchaccounts);
    });
