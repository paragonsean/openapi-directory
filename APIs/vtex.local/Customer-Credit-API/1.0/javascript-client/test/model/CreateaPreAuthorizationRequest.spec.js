...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.CreateaPreAuthorizationRequest();
  });
  ...
  describe('CreateaPreAuthorizationRequest', function() {
    it('should create an instance of CreateaPreAuthorizationRequest', function() {
      // uncomment below and update the code to test CreateaPreAuthorizationRequest
      //var instance = new CustomerCreditApi.CreateaPreAuthorizationRequest();
      //expect(instance).to.be.a(CustomerCreditApi.CreateaPreAuthorizationRequest);
    });
