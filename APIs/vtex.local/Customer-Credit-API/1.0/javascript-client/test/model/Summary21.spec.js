...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Summary21();
  });
  ...
  describe('Summary21', function() {
    it('should create an instance of Summary21', function() {
      // uncomment below and update the code to test Summary21
      //var instance = new CustomerCreditApi.Summary21();
      //expect(instance).to.be.a(CustomerCreditApi.Summary21);
    });
