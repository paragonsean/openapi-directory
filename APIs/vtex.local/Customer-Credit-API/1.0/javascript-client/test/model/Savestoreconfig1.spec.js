...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Savestoreconfig1();
  });
  ...
  describe('Savestoreconfig1', function() {
    it('should create an instance of Savestoreconfig1', function() {
      // uncomment below and update the code to test Savestoreconfig1
      //var instance = new CustomerCreditApi.Savestoreconfig1();
      //expect(instance).to.be.a(CustomerCreditApi.Savestoreconfig1);
    });
