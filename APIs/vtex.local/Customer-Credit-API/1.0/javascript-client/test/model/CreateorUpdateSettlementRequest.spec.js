...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.CreateorUpdateSettlementRequest();
  });
  ...
  describe('CreateorUpdateSettlementRequest', function() {
    it('should create an instance of CreateorUpdateSettlementRequest', function() {
      // uncomment below and update the code to test CreateorUpdateSettlementRequest
      //var instance = new CustomerCreditApi.CreateorUpdateSettlementRequest();
      //expect(instance).to.be.a(CustomerCreditApi.CreateorUpdateSettlementRequest);
    });
