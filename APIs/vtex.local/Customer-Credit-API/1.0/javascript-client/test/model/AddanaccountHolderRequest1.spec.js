...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.AddanaccountHolderRequest1();
  });
  ...
  describe('AddanaccountHolderRequest1', function() {
    it('should create an instance of AddanaccountHolderRequest1', function() {
      // uncomment below and update the code to test AddanaccountHolderRequest1
      //var instance = new CustomerCreditApi.AddanaccountHolderRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.AddanaccountHolderRequest1);
    });
