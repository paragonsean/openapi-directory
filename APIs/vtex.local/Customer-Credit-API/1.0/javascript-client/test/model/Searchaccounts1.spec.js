...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Searchaccounts1();
  });
  ...
  describe('Searchaccounts1', function() {
    it('should create an instance of Searchaccounts1', function() {
      // uncomment below and update the code to test Searchaccounts1
      //var instance = new CustomerCreditApi.Searchaccounts1();
      //expect(instance).to.be.a(CustomerCreditApi.Searchaccounts1);
    });
