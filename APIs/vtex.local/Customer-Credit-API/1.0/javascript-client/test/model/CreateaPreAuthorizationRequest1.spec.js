...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.CreateaPreAuthorizationRequest1();
  });
  ...
  describe('CreateaPreAuthorizationRequest1', function() {
    it('should create an instance of CreateaPreAuthorizationRequest1', function() {
      // uncomment below and update the code to test CreateaPreAuthorizationRequest1
      //var instance = new CustomerCreditApi.CreateaPreAuthorizationRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.CreateaPreAuthorizationRequest1);
    });
