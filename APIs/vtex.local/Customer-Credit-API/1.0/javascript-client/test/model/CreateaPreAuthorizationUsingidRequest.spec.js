...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.CreateaPreAuthorizationUsingidRequest();
  });
  ...
  describe('CreateaPreAuthorizationUsingidRequest', function() {
    it('should create an instance of CreateaPreAuthorizationUsingidRequest', function() {
      // uncomment below and update the code to test CreateaPreAuthorizationUsingidRequest
      //var instance = new CustomerCreditApi.CreateaPreAuthorizationUsingidRequest();
      //expect(instance).to.be.a(CustomerCreditApi.CreateaPreAuthorizationUsingidRequest);
    });
