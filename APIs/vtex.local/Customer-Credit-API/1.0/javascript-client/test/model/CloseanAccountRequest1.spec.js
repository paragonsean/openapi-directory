...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.CloseanAccountRequest1();
  });
  ...
  describe('CloseanAccountRequest1', function() {
    it('should create an instance of CloseanAccountRequest1', function() {
      // uncomment below and update the code to test CloseanAccountRequest1
      //var instance = new CustomerCreditApi.CloseanAccountRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.CloseanAccountRequest1);
    });
