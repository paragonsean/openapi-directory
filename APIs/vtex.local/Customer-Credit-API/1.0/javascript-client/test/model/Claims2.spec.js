...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Claims2();
  });
  ...
  describe('Claims2', function() {
    it('should create an instance of Claims2', function() {
      // uncomment below and update the code to test Claims2
      //var instance = new CustomerCreditApi.Claims2();
      //expect(instance).to.be.a(CustomerCreditApi.Claims2);
    });
