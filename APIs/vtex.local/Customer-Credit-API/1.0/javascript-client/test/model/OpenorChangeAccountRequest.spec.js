...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.OpenorChangeAccountRequest();
  });
  ...
  describe('OpenorChangeAccountRequest', function() {
    it('should create an instance of OpenorChangeAccountRequest', function() {
      // uncomment below and update the code to test OpenorChangeAccountRequest
      //var instance = new CustomerCreditApi.OpenorChangeAccountRequest();
      //expect(instance).to.be.a(CustomerCreditApi.OpenorChangeAccountRequest);
    });
