...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.UpdateemailanddescriptionofaaccountRequest1();
  });
  ...
  describe('UpdateemailanddescriptionofaaccountRequest1', function() {
    it('should create an instance of UpdateemailanddescriptionofaaccountRequest1', function() {
      // uncomment below and update the code to test UpdateemailanddescriptionofaaccountRequest1
      //var instance = new CustomerCreditApi.UpdateemailanddescriptionofaaccountRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.UpdateemailanddescriptionofaaccountRequest1);
    });
