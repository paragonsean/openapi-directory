...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Datum11();
  });
  ...
  describe('Datum11', function() {
    it('should create an instance of Datum11', function() {
      // uncomment below and update the code to test Datum11
      //var instance = new CustomerCreditApi.Datum11();
      //expect(instance).to.be.a(CustomerCreditApi.Datum11);
    });
