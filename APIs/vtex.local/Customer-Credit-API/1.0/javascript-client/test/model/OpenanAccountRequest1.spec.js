...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.OpenanAccountRequest1();
  });
  ...
  describe('OpenanAccountRequest1', function() {
    it('should create an instance of OpenanAccountRequest1', function() {
      // uncomment below and update the code to test OpenanAccountRequest1
      //var instance = new CustomerCreditApi.OpenanAccountRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.OpenanAccountRequest1);
    });
