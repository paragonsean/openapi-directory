...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Getinvoicesfromacheckingaccount();
  });
  ...
  describe('Getinvoicesfromacheckingaccount', function() {
    it('should create an instance of Getinvoicesfromacheckingaccount', function() {
      // uncomment below and update the code to test Getinvoicesfromacheckingaccount
      //var instance = new CustomerCreditApi.Getinvoicesfromacheckingaccount();
      //expect(instance).to.be.a(CustomerCreditApi.Getinvoicesfromacheckingaccount);
    });
