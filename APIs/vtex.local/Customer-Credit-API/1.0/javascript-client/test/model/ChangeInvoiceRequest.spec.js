...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.ChangeInvoiceRequest();
  });
  ...
  describe('ChangeInvoiceRequest', function() {
    it('should create an instance of ChangeInvoiceRequest', function() {
      // uncomment below and update the code to test ChangeInvoiceRequest
      //var instance = new CustomerCreditApi.ChangeInvoiceRequest();
      //expect(instance).to.be.a(CustomerCreditApi.ChangeInvoiceRequest);
    });
