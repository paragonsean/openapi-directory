...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Datum21();
  });
  ...
  describe('Datum21', function() {
    it('should create an instance of Datum21', function() {
      // uncomment below and update the code to test Datum21
      //var instance = new CustomerCreditApi.Datum21();
      //expect(instance).to.be.a(CustomerCreditApi.Datum21);
    });
