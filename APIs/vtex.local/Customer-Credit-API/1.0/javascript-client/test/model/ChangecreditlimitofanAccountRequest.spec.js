...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.ChangecreditlimitofanAccountRequest();
  });
  ...
  describe('ChangecreditlimitofanAccountRequest', function() {
    it('should create an instance of ChangecreditlimitofanAccountRequest', function() {
      // uncomment below and update the code to test ChangecreditlimitofanAccountRequest
      //var instance = new CustomerCreditApi.ChangecreditlimitofanAccountRequest();
      //expect(instance).to.be.a(CustomerCreditApi.ChangecreditlimitofanAccountRequest);
    });
