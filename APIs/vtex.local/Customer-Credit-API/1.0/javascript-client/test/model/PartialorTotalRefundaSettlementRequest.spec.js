...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.PartialorTotalRefundaSettlementRequest();
  });
  ...
  describe('PartialorTotalRefundaSettlementRequest', function() {
    it('should create an instance of PartialorTotalRefundaSettlementRequest', function() {
      // uncomment below and update the code to test PartialorTotalRefundaSettlementRequest
      //var instance = new CustomerCreditApi.PartialorTotalRefundaSettlementRequest();
      //expect(instance).to.be.a(CustomerCreditApi.PartialorTotalRefundaSettlementRequest);
    });
