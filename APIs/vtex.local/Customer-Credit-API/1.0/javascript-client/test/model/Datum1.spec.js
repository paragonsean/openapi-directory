...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Datum1();
  });
  ...
  describe('Datum1', function() {
    it('should create an instance of Datum1', function() {
      // uncomment below and update the code to test Datum1
      //var instance = new CustomerCreditApi.Datum1();
      //expect(instance).to.be.a(CustomerCreditApi.Datum1);
    });

    it('should have the property checkingAccountId (base name: "checkingAccountId")', function() {
      // uncomment below and update the code to test the property checkingAccountId
      //var instance = new CustomerCreditApi.Datum1();
    ...
    it('should have the property originalDueDate (base name: "originalDueDate")', function() {
      // uncomment below and update the code to test the property originalDueDate
      //var instance = new CustomerCreditApi.Datum1();
      //expect(instance).to.be();
    });
