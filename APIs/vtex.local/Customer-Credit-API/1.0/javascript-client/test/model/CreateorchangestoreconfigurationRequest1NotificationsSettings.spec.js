...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.CreateorchangestoreconfigurationRequest1NotificationsSettings();
  });
  ...
  describe('CreateorchangestoreconfigurationRequest1NotificationsSettings', function() {
    it('should create an instance of CreateorchangestoreconfigurationRequest1NotificationsSettings', function() {
      // uncomment below and update the code to test CreateorchangestoreconfigurationRequest1NotificationsSettings
      //var instance = new CustomerCreditApi.CreateorchangestoreconfigurationRequest1NotificationsSettings();
      //expect(instance).to.be.a(CustomerCreditApi.CreateorchangestoreconfigurationRequest1NotificationsSettings);
    });

    it('should have the property daysAfter (base name: "daysAfter")', function() {
      // uncomment below and update the code to test the property daysAfter
      //var instance = new CustomerCreditApi.CreateorchangestoreconfigurationRequest1NotificationsSettings();
      //expect(instance).to.be();
    });

    it('should have the property daysPrior (base name: "daysPrior")', function() {
      // uncomment below and update the code to test the property daysPrior
      //var instance = new CustomerCreditApi.CreateorchangestoreconfigurationRequest1NotificationsSettings();
      //expect(instance).to.be();
    });
