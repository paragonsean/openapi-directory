...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Getaccount1();
  });
  ...
  describe('Getaccount1', function() {
    it('should create an instance of Getaccount1', function() {
      // uncomment below and update the code to test Getaccount1
      //var instance = new CustomerCreditApi.Getaccount1();
      //expect(instance).to.be.a(CustomerCreditApi.Getaccount1);
    });
