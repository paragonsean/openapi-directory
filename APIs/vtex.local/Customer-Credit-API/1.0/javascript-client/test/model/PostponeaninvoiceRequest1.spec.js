...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.PostponeaninvoiceRequest1();
  });
  ...
  describe('PostponeaninvoiceRequest1', function() {
    it('should create an instance of PostponeaninvoiceRequest1', function() {
      // uncomment below and update the code to test PostponeaninvoiceRequest1
      //var instance = new CustomerCreditApi.PostponeaninvoiceRequest1();
      //expect(instance).to.be.a(CustomerCreditApi.PostponeaninvoiceRequest1);
    });

    it('should have the property dueDays (base name: "dueDays")', function() {
      // uncomment below and update the code to test the property dueDays
      //var instance = new CustomerCreditApi.PostponeaninvoiceRequest1();
