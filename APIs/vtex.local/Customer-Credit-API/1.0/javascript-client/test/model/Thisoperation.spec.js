...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.Thisoperation();
  });
  ...
  describe('Thisoperation', function() {
    it('should create an instance of Thisoperation', function() {
      // uncomment below and update the code to test Thisoperation
      //var instance = new CustomerCreditApi.Thisoperation();
      //expect(instance).to.be.a(CustomerCreditApi.Thisoperation);
    });
