...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.AddanaccountHolderRequest();
  });
  ...
  describe('AddanaccountHolderRequest', function() {
    it('should create an instance of AddanaccountHolderRequest', function() {
      // uncomment below and update the code to test AddanaccountHolderRequest
      //var instance = new CustomerCreditApi.AddanaccountHolderRequest();
      //expect(instance).to.be.a(CustomerCreditApi.AddanaccountHolderRequest);
    });
