...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerCreditApi.MarkaninvoiceasPaidRequest();
  });
  ...
  describe('MarkaninvoiceasPaidRequest', function() {
    it('should create an instance of MarkaninvoiceasPaidRequest', function() {
      // uncomment below and update the code to test MarkaninvoiceasPaidRequest
      //var instance = new CustomerCreditApi.MarkaninvoiceasPaidRequest();
      //expect(instance).to.be.a(CustomerCreditApi.MarkaninvoiceasPaidRequest);
    });
