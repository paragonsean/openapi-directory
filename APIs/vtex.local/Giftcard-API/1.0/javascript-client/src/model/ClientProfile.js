...
class ClientProfile {
     ...
     * @param phone {String} 
     */
    constructor(birthDate, document, email, firstName, isCorporate, lastName, phone) { 
        
        ClientProfile.initialize(this, birthDate, document, email, firstName, isCorporate, lastName, phone);
    }
     ...
     */
    static initialize(obj, birthDate, document, email, firstName, isCorporate, lastName, phone) { 
...
ClientProfile.RequiredProperties = ["birthDate", "document", "email", "firstName", "isCorporate", "lastName", "phone"];
