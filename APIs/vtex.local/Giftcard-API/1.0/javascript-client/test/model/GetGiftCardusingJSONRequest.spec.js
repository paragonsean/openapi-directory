...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiftCardApi.GetGiftCardusingJSONRequest();
  });
  ...
  describe('GetGiftCardusingJSONRequest', function() {
    it('should create an instance of GetGiftCardusingJSONRequest', function() {
      // uncomment below and update the code to test GetGiftCardusingJSONRequest
      //var instance = new GiftCardApi.GetGiftCardusingJSONRequest();
      //expect(instance).to.be.a(GiftCardApi.GetGiftCardusingJSONRequest);
    });
