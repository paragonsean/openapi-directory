...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiftCardApi.SettleGiftCardTransactionRequest();
  });
  ...
  describe('SettleGiftCardTransactionRequest', function() {
    it('should create an instance of SettleGiftCardTransactionRequest', function() {
      // uncomment below and update the code to test SettleGiftCardTransactionRequest
      //var instance = new GiftCardApi.SettleGiftCardTransactionRequest();
      //expect(instance).to.be.a(GiftCardApi.SettleGiftCardTransactionRequest);
    });
