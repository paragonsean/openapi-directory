...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiftCardApi.Response2();
  });
  ...
  describe('Response2', function() {
    it('should create an instance of Response2', function() {
      // uncomment below and update the code to test Response2
      //var instance = new GiftCardApi.Response2();
      //expect(instance).to.be.a(GiftCardApi.Response2);
    });
