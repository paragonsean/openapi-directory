...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiftCardApi.CancelGiftCardTransactionRequest();
  });
  ...
  describe('CancelGiftCardTransactionRequest', function() {
    it('should create an instance of CancelGiftCardTransactionRequest', function() {
      // uncomment below and update the code to test CancelGiftCardTransactionRequest
      //var instance = new GiftCardApi.CancelGiftCardTransactionRequest();
      //expect(instance).to.be.a(GiftCardApi.CancelGiftCardTransactionRequest);
    });
