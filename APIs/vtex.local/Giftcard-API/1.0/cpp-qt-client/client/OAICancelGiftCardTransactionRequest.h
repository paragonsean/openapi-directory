...
/*
 * OAICancelGiftCardTransactionRequest.h
 *
 * 
 */

#ifndef OAICancelGiftCardTransactionRequest_H
#define OAICancelGiftCardTransactionRequest_H
...
class OAICancelGiftCardTransactionRequest : public OAIObject {
public:
    OAICancelGiftCardTransactionRequest();
    OAICancelGiftCardTransactionRequest(QString json);
    ~OAICancelGiftCardTransactionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelGiftCardTransactionRequest)

#endif // OAICancelGiftCardTransactionRequest_H
