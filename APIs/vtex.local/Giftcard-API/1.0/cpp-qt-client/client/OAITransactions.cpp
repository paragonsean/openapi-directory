...
QString OAITransactions::getHref() const {
    return m_href;
}
void OAITransactions::setHref(const QString &href) {
    m_href = href;
    m_href_isSet = true;
}

bool OAITransactions::is_href_Set() const{
    return m_href_isSet;
}

bool OAITransactions::is_href_Valid() const{
