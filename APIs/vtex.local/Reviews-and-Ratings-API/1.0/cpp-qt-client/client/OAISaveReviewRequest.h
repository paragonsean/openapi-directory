...
/*
 * OAISaveReviewRequest.h
 *
 * 
 */

#ifndef OAISaveReviewRequest_H
#define OAISaveReviewRequest_H
...
class OAISaveReviewRequest : public OAIObject {
public:
    OAISaveReviewRequest();
    OAISaveReviewRequest(QString json);
    ~OAISaveReviewRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISaveReviewRequest)

#endif // OAISaveReviewRequest_H
