...
void Example::exampleFunction1(){
     OAIRatingApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIRatingApi::getProductRatingSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIRatingApi::getProductRatingSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString product_id = create(); // QString | Product ID.
      ...
      apiInstance.getProductRating(product_idcontent_typeaccept);
