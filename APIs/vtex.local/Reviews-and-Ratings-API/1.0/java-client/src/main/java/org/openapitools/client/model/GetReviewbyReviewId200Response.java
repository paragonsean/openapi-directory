...
public class GetReviewbyReviewId200Response {
  ...
  public GetReviewbyReviewId200Response() {
  }

  public GetReviewbyReviewId200Response approved(Boolean approved) {
  ...
  public GetReviewbyReviewId200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetReviewbyReviewId200Response locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public GetReviewbyReviewId200Response location(String location) {
  ...
  public GetReviewbyReviewId200Response pastReviews(String pastReviews) {
  ...
  public GetReviewbyReviewId200Response productId(String productId) {
  ...
  public GetReviewbyReviewId200Response rating(BigDecimal rating) {
    this.rating = rating;
    return this;
  }
  ...
  public GetReviewbyReviewId200Response reviewDateTime(String reviewDateTime) {
  ...
  public GetReviewbyReviewId200Response reviewerName(String reviewerName) {
  ...
  public GetReviewbyReviewId200Response searchDate(String searchDate) {
  ...
  public GetReviewbyReviewId200Response shopperId(String shopperId) {
  ...
  public GetReviewbyReviewId200Response sku(String sku) {
    this.sku = sku;
    return this;
  }
  ...
  public GetReviewbyReviewId200Response text(String text) {
    this.text = text;
    return this;
  }
  ...
  public GetReviewbyReviewId200Response title(String title) {
    this.title = title;
    return this;
  }
  ...
  public GetReviewbyReviewId200Response verifiedPurchaser(Boolean verifiedPurchaser) {
  ...
  public boolean equals(Object o) {
    ...
    GetReviewbyReviewId200Response getReviewbyReviewId200Response = (GetReviewbyReviewId200Response) o;
    return Objects.equals(this.approved, getReviewbyReviewId200Response.approved) &&
        Objects.equals(this.id, getReviewbyReviewId200Response.id) &&
        Objects.equals(this.locale, getReviewbyReviewId200Response.locale) &&
        Objects.equals(this.location, getReviewbyReviewId200Response.location) &&
        Objects.equals(this.pastReviews, getReviewbyReviewId200Response.pastReviews) &&
        Objects.equals(this.productId, getReviewbyReviewId200Response.productId) &&
        Objects.equals(this.rating, getReviewbyReviewId200Response.rating) &&
        Objects.equals(this.reviewDateTime, getReviewbyReviewId200Response.reviewDateTime) &&
        Objects.equals(this.reviewerName, getReviewbyReviewId200Response.reviewerName) &&
        Objects.equals(this.searchDate, getReviewbyReviewId200Response.searchDate) &&
        Objects.equals(this.shopperId, getReviewbyReviewId200Response.shopperId) &&
        Objects.equals(this.sku, getReviewbyReviewId200Response.sku) &&
        Objects.equals(this.text, getReviewbyReviewId200Response.text) &&
        Objects.equals(this.title, getReviewbyReviewId200Response.title) &&
        Objects.equals(this.verifiedPurchaser, getReviewbyReviewId200Response.verifiedPurchaser);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetReviewbyReviewId200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetReviewbyReviewId200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetReviewbyReviewId200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetReviewbyReviewId200Response is not found in the empty JSON string", GetReviewbyReviewId200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetReviewbyReviewId200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetReviewbyReviewId200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetReviewbyReviewId200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetReviewbyReviewId200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetReviewbyReviewId200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetReviewbyReviewId200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetReviewbyReviewId200Response>() {
           @Override
           public void write(JsonWriter out, GetReviewbyReviewId200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetReviewbyReviewId200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetReviewbyReviewId200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetReviewbyReviewId200Response
   * @throws IOException if the JSON string is invalid with respect to GetReviewbyReviewId200Response
   */
  public static GetReviewbyReviewId200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetReviewbyReviewId200Response.class);
  }

  /**
   * Convert an instance of GetReviewbyReviewId200Response to an JSON string
   *
   * @return JSON string
   */
