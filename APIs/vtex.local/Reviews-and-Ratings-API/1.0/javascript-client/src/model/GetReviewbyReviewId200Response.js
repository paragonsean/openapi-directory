...
/**
 * The GetReviewbyReviewId200Response model module.
 * @module model/GetReviewbyReviewId200Response
 * @version 1.0
 */
class GetReviewbyReviewId200Response {
    /**
     * Constructs a new <code>GetReviewbyReviewId200Response</code>.
     * 
     * @alias module:model/GetReviewbyReviewId200Response
     */
    constructor() { 
        
        GetReviewbyReviewId200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetReviewbyReviewId200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetReviewbyReviewId200Response} obj Optional instance to populate.
     * @return {module:model/GetReviewbyReviewId200Response} The populated <code>GetReviewbyReviewId200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetReviewbyReviewId200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetReviewbyReviewId200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetReviewbyReviewId200Response</code>.
     */
 ...
 */
GetReviewbyReviewId200Response.prototype['approved'] = undefined;

/**
 * Review ID.
 * @member {String} id
 */
GetReviewbyReviewId200Response.prototype['id'] = undefined;

/**
 * Review's locale.
 * @member {String} locale
 */
GetReviewbyReviewId200Response.prototype['locale'] = undefined;

/**
 * Review's origin location.
 * @member {String} location
 */
GetReviewbyReviewId200Response.prototype['location'] = undefined;

/**
 * Past reviews of the same product.
 * @member {String} pastReviews
 */
GetReviewbyReviewId200Response.prototype['pastReviews'] = undefined;

/**
 * Product ID.
 * @member {String} productId
 */
GetReviewbyReviewId200Response.prototype['productId'] = undefined;

/**
 * Customer rating.
 * @member {Number} rating
 */
GetReviewbyReviewId200Response.prototype['rating'] = undefined;

/**
 * Review's date and time.
 * @member {String} reviewDateTime
 */
GetReviewbyReviewId200Response.prototype['reviewDateTime'] = undefined;

/**
 * Reviewer name.
 * @member {String} reviewerName
 */
GetReviewbyReviewId200Response.prototype['reviewerName'] = undefined;

/**
 * Review's search date.
 * @member {String} searchDate
 */
GetReviewbyReviewId200Response.prototype['searchDate'] = undefined;

/**
 * Shopper email.
 * @member {String} shopperId
 */
GetReviewbyReviewId200Response.prototype['shopperId'] = undefined;

/**
 * SKU ID.
 * @member {String} sku
 */
GetReviewbyReviewId200Response.prototype['sku'] = undefined;

/**
 * Review's text.
 * @member {String} text
 */
GetReviewbyReviewId200Response.prototype['text'] = undefined;

/**
 * Review's title.
 * @member {String} title
 */
GetReviewbyReviewId200Response.prototype['title'] = undefined;

/**
 * If the reviewer is a verified purchaser (`true`) or not (`false`).
 * @member {Boolean} verifiedPurchaser
 */
GetReviewbyReviewId200Response.prototype['verifiedPurchaser'] = undefined;
...
export default GetReviewbyReviewId200Response;
