...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReviewsAndRatingsApi.GetalistofReviews200ResponseRange();
  });
  ...
  describe('GetalistofReviews200ResponseRange', function() {
    it('should create an instance of GetalistofReviews200ResponseRange', function() {
      // uncomment below and update the code to test GetalistofReviews200ResponseRange
      //var instance = new ReviewsAndRatingsApi.GetalistofReviews200ResponseRange();
      //expect(instance).to.be.a(ReviewsAndRatingsApi.GetalistofReviews200ResponseRange);
    });
