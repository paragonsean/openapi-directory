...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReviewsAndRatingsApi.GetProductRating200Response();
  });
  ...
  describe('GetProductRating200Response', function() {
    it('should create an instance of GetProductRating200Response', function() {
      // uncomment below and update the code to test GetProductRating200Response
      //var instance = new ReviewsAndRatingsApi.GetProductRating200Response();
      //expect(instance).to.be.a(ReviewsAndRatingsApi.GetProductRating200Response);
    });
