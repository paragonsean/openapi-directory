...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReviewsAndRatingsApi.GetalistofReviews200ResponseDataInner();
  });
  ...
  describe('GetalistofReviews200ResponseDataInner', function() {
    it('should create an instance of GetalistofReviews200ResponseDataInner', function() {
      // uncomment below and update the code to test GetalistofReviews200ResponseDataInner
      //var instance = new ReviewsAndRatingsApi.GetalistofReviews200ResponseDataInner();
      //expect(instance).to.be.a(ReviewsAndRatingsApi.GetalistofReviews200ResponseDataInner);
    });
