...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReviewsAndRatingsApi.GetalistofReviews200Response();
  });
  ...
  describe('GetalistofReviews200Response', function() {
    it('should create an instance of GetalistofReviews200Response', function() {
      // uncomment below and update the code to test GetalistofReviews200Response
      //var instance = new ReviewsAndRatingsApi.GetalistofReviews200Response();
      //expect(instance).to.be.a(ReviewsAndRatingsApi.GetalistofReviews200Response);
    });
