...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReviewsAndRatingsApi.SaveReviewRequest();
  });
  ...
  describe('SaveReviewRequest', function() {
    it('should create an instance of SaveReviewRequest', function() {
      // uncomment below and update the code to test SaveReviewRequest
      //var instance = new ReviewsAndRatingsApi.SaveReviewRequest();
      //expect(instance).to.be.a(ReviewsAndRatingsApi.SaveReviewRequest);
    });
