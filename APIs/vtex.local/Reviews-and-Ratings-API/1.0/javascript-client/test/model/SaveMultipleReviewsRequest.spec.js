...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReviewsAndRatingsApi.SaveMultipleReviewsRequest();
  });
  ...
  describe('SaveMultipleReviewsRequest', function() {
    it('should create an instance of SaveMultipleReviewsRequest', function() {
      // uncomment below and update the code to test SaveMultipleReviewsRequest
      //var instance = new ReviewsAndRatingsApi.SaveMultipleReviewsRequest();
      //expect(instance).to.be.a(ReviewsAndRatingsApi.SaveMultipleReviewsRequest);
    });
