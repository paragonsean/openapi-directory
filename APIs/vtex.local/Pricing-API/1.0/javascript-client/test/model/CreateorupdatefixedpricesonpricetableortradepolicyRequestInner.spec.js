...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.CreateorupdatefixedpricesonpricetableortradepolicyRequestInner();
  });
  ...
  describe('CreateorupdatefixedpricesonpricetableortradepolicyRequestInner', function() {
    it('should create an instance of CreateorupdatefixedpricesonpricetableortradepolicyRequestInner', function() {
      // uncomment below and update the code to test CreateorupdatefixedpricesonpricetableortradepolicyRequestInner
      //var instance = new PricingApi.CreateorupdatefixedpricesonpricetableortradepolicyRequestInner();
      //expect(instance).to.be.a(PricingApi.CreateorupdatefixedpricesonpricetableortradepolicyRequestInner);
    });
