...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.CreateUpdatePriceOrFixedPriceRequest();
  });
  ...
  describe('CreateUpdatePriceOrFixedPriceRequest', function() {
    it('should create an instance of CreateUpdatePriceOrFixedPriceRequest', function() {
      // uncomment below and update the code to test CreateUpdatePriceOrFixedPriceRequest
      //var instance = new PricingApi.CreateUpdatePriceOrFixedPriceRequest();
      //expect(instance).to.be.a(PricingApi.CreateUpdatePriceOrFixedPriceRequest);
    });
