...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.Getallpricetablesandrules200ResponseInnerRulesInnerContext();
  });
  ...
  describe('Getallpricetablesandrules200ResponseInnerRulesInnerContext', function() {
    it('should create an instance of Getallpricetablesandrules200ResponseInnerRulesInnerContext', function() {
      // uncomment below and update the code to test Getallpricetablesandrules200ResponseInnerRulesInnerContext
      //var instance = new PricingApi.Getallpricetablesandrules200ResponseInnerRulesInnerContext();
      //expect(instance).to.be.a(PricingApi.Getallpricetablesandrules200ResponseInnerRulesInnerContext);
    });
