...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.FixedPrices();
  });
  ...
  describe('FixedPrices', function() {
    it('should create an instance of FixedPrices', function() {
      // uncomment below and update the code to test FixedPrices
      //var instance = new PricingApi.FixedPrices();
      //expect(instance).to.be.a(PricingApi.FixedPrices);
    });
