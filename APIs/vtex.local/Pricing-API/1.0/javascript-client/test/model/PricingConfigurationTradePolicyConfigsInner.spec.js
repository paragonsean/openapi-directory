...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.PricingConfigurationTradePolicyConfigsInner();
  });
  ...
  describe('PricingConfigurationTradePolicyConfigsInner', function() {
    it('should create an instance of PricingConfigurationTradePolicyConfigsInner', function() {
      // uncomment below and update the code to test PricingConfigurationTradePolicyConfigsInner
      //var instance = new PricingApi.PricingConfigurationTradePolicyConfigsInner();
      //expect(instance).to.be.a(PricingApi.PricingConfigurationTradePolicyConfigsInner);
    });

    it('should have the property minimumMarkup (base name: "minimumMarkup")', function() {
      // uncomment below and update the code to test the property minimumMarkup
      //var instance = new PricingApi.PricingConfigurationTradePolicyConfigsInner();
      //expect(instance).to.be();
    });

    it('should have the property rulesShouldAffectListPrice (base name: "rulesShouldAffectListPrice")', function() {
      // uncomment below and update the code to test the property rulesShouldAffectListPrice
      //var instance = new PricingApi.PricingConfigurationTradePolicyConfigsInner();
      //expect(instance).to.be();
    });
