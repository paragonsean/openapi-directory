...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.Getrulesforapricetable200Response();
  });
  ...
  describe('Getrulesforapricetable200Response', function() {
    it('should create an instance of Getrulesforapricetable200Response', function() {
      // uncomment below and update the code to test Getrulesforapricetable200Response
      //var instance = new PricingApi.Getrulesforapricetable200Response();
      //expect(instance).to.be.a(PricingApi.Getrulesforapricetable200Response);
    });
