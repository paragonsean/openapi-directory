...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.PricingConfigurationPriceVariation();
  });
  ...
  describe('PricingConfigurationPriceVariation', function() {
    it('should create an instance of PricingConfigurationPriceVariation', function() {
      // uncomment below and update the code to test PricingConfigurationPriceVariation
      //var instance = new PricingApi.PricingConfigurationPriceVariation();
      //expect(instance).to.be.a(PricingApi.PricingConfigurationPriceVariation);
    });
