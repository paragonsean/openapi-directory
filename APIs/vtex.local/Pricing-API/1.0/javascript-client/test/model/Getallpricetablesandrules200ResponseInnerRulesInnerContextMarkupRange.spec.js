...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange();
  });
  ...
  describe('Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange', function() {
    it('should create an instance of Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange', function() {
      // uncomment below and update the code to test Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange
      //var instance = new PricingApi.Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange();
      //expect(instance).to.be.a(PricingApi.Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange);
    });
