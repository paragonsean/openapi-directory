...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.PricingPipelineCatalogPriceTableIdPutRequest();
  });
  ...
  describe('PricingPipelineCatalogPriceTableIdPutRequest', function() {
    it('should create an instance of PricingPipelineCatalogPriceTableIdPutRequest', function() {
      // uncomment below and update the code to test PricingPipelineCatalogPriceTableIdPutRequest
      //var instance = new PricingApi.PricingPipelineCatalogPriceTableIdPutRequest();
      //expect(instance).to.be.a(PricingApi.PricingPipelineCatalogPriceTableIdPutRequest);
    });
