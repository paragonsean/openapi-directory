...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.GetPricingv2Status200Response();
  });
  ...
  describe('GetPricingv2Status200Response', function() {
    it('should create an instance of GetPricingv2Status200Response', function() {
      // uncomment below and update the code to test GetPricingv2Status200Response
      //var instance = new PricingApi.GetPricingv2Status200Response();
      //expect(instance).to.be.a(PricingApi.GetPricingv2Status200Response);
    });

    it('should have the property hasMigrated (base name: "hasMigrated")', function() {
      // uncomment below and update the code to test the property hasMigrated
      //var instance = new PricingApi.GetPricingv2Status200Response();
