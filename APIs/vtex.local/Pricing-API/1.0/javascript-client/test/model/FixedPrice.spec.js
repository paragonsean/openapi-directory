...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.FixedPrice();
  });
  ...
  describe('FixedPrice', function() {
    it('should create an instance of FixedPrice', function() {
      // uncomment below and update the code to test FixedPrice
      //var instance = new PricingApi.FixedPrice();
      //expect(instance).to.be.a(PricingApi.FixedPrice);
    });
