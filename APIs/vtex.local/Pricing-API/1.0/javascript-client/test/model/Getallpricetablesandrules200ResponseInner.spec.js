...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.Getallpricetablesandrules200ResponseInner();
  });
  ...
  describe('Getallpricetablesandrules200ResponseInner', function() {
    it('should create an instance of Getallpricetablesandrules200ResponseInner', function() {
      // uncomment below and update the code to test Getallpricetablesandrules200ResponseInner
      //var instance = new PricingApi.Getallpricetablesandrules200ResponseInner();
      //expect(instance).to.be.a(PricingApi.Getallpricetablesandrules200ResponseInner);
    });

    it('should have the property percentualModifier (base name: "percentualModifier")', function() {
      // uncomment below and update the code to test the property percentualModifier
      //var instance = new PricingApi.Getallpricetablesandrules200ResponseInner();
    ...
    it('should have the property tradePolicyId (base name: "tradePolicyId")', function() {
      // uncomment below and update the code to test the property tradePolicyId
      //var instance = new PricingApi.Getallpricetablesandrules200ResponseInner();
      //expect(instance).to.be();
    });
