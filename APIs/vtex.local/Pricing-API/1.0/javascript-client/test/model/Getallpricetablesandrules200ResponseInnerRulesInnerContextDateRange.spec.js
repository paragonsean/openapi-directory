...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange();
  });
  ...
  describe('Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange', function() {
    it('should create an instance of Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange', function() {
      // uncomment below and update the code to test Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange
      //var instance = new PricingApi.Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange();
      //expect(instance).to.be.a(PricingApi.Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange);
    });
