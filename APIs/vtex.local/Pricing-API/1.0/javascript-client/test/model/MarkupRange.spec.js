...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.MarkupRange();
  });
  ...
  describe('MarkupRange', function() {
    it('should create an instance of MarkupRange', function() {
      // uncomment below and update the code to test MarkupRange
      //var instance = new PricingApi.MarkupRange();
      //expect(instance).to.be.a(PricingApi.MarkupRange);
    });
