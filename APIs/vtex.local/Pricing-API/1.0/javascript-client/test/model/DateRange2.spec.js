...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.DateRange2();
  });
  ...
  describe('DateRange2', function() {
    it('should create an instance of DateRange2', function() {
      // uncomment below and update the code to test DateRange2
      //var instance = new PricingApi.DateRange2();
      //expect(instance).to.be.a(PricingApi.DateRange2);
    });
