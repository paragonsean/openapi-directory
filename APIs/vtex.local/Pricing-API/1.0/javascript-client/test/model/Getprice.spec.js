...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.Getprice();
  });
  ...
  describe('Getprice', function() {
    it('should create an instance of Getprice', function() {
      // uncomment below and update the code to test Getprice
      //var instance = new PricingApi.Getprice();
      //expect(instance).to.be.a(PricingApi.Getprice);
    });
