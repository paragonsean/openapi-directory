...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.DateRange1();
  });
  ...
  describe('DateRange1', function() {
    it('should create an instance of DateRange1', function() {
      // uncomment below and update the code to test DateRange1
      //var instance = new PricingApi.DateRange1();
      //expect(instance).to.be.a(PricingApi.DateRange1);
    });
