...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.Getcomputedprice();
  });
  ...
  describe('Getcomputedprice', function() {
    it('should create an instance of Getcomputedprice', function() {
      // uncomment below and update the code to test Getcomputedprice
      //var instance = new PricingApi.Getcomputedprice();
      //expect(instance).to.be.a(PricingApi.Getcomputedprice);
    });
