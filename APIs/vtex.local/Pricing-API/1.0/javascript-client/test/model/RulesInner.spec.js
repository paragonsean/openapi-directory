...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.RulesInner();
  });
  ...
  describe('RulesInner', function() {
    it('should create an instance of RulesInner', function() {
      // uncomment below and update the code to test RulesInner
      //var instance = new PricingApi.RulesInner();
      //expect(instance).to.be.a(PricingApi.RulesInner);
    });
