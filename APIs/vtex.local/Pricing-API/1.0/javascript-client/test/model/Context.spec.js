...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.Context();
  });
  ...
  describe('Context', function() {
    it('should create an instance of Context', function() {
      ...
      //var instance = new PricingApi.Context();
      //expect(instance).to.be.a(PricingApi.Context);
    });
    ...
    it('should have the property internalCategories (base name: "internalCategories")', function() {
      // uncomment below and update the code to test the property internalCategories
      //var instance = new PricingApi.Context();
      //expect(instance).to.be();
    });

    it('should have the property markupRange (base name: "markupRange")', function() {
      // uncomment below and update the code to test the property markupRange
      //var instance = new PricingApi.Context();
      //expect(instance).to.be();
    });

    it('should have the property stockStatuses (base name: "stockStatuses")', function() {
      // uncomment below and update the code to test the property stockStatuses
      //var instance = new PricingApi.Context();
      //expect(instance).to.be();
    });
