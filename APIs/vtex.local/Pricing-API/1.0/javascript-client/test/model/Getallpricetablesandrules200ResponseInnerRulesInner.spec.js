...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.Getallpricetablesandrules200ResponseInnerRulesInner();
  });
  ...
  describe('Getallpricetablesandrules200ResponseInnerRulesInner', function() {
    it('should create an instance of Getallpricetablesandrules200ResponseInnerRulesInner', function() {
      // uncomment below and update the code to test Getallpricetablesandrules200ResponseInnerRulesInner
      //var instance = new PricingApi.Getallpricetablesandrules200ResponseInnerRulesInner();
      //expect(instance).to.be.a(PricingApi.Getallpricetablesandrules200ResponseInnerRulesInner);
    });
