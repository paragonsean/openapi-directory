...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.PricingConfiguration();
  });
  ...
  describe('PricingConfiguration', function() {
    it('should create an instance of PricingConfiguration', function() {
      // uncomment below and update the code to test PricingConfiguration
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be.a(PricingApi.PricingConfiguration);
    });

    it('should have the property blockAccount (base name: "blockAccount")', function() {
      // uncomment below and update the code to test the property blockAccount
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property blockedRoutes (base name: "blockedRoutes")', function() {
      // uncomment below and update the code to test the property blockedRoutes
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property defaultMarkup (base name: "defaultMarkup")', function() {
      // uncomment below and update the code to test the property defaultMarkup
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be();
    });
    ...
    it('should have the property hasOptionalBasePrice (base name: "hasOptionalBasePrice")', function() {
      // uncomment below and update the code to test the property hasOptionalBasePrice
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property hasPriceInheritance (base name: "hasPriceInheritance")', function() {
      // uncomment below and update the code to test the property hasPriceInheritance
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be();
    });
    ...
    it('should have the property minimumMarkups (base name: "minimumMarkups")', function() {
      // uncomment below and update the code to test the property minimumMarkups
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property priceInheritance (base name: "priceInheritance")', function() {
      // uncomment below and update the code to test the property priceInheritance
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property priceTableLimit (base name: "priceTableLimit")', function() {
      // uncomment below and update the code to test the property priceTableLimit
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property priceTableSelectionStrategy (base name: "priceTableSelectionStrategy")', function() {
      // uncomment below and update the code to test the property priceTableSelectionStrategy
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property priceVariation (base name: "priceVariation")', function() {
      // uncomment below and update the code to test the property priceVariation
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property sellersToOverride (base name: "sellersToOverride")', function() {
      // uncomment below and update the code to test the property sellersToOverride
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property tradePolicyConfigs (base name: "tradePolicyConfigs")', function() {
      // uncomment below and update the code to test the property tradePolicyConfigs
      //var instance = new PricingApi.PricingConfiguration();
      //expect(instance).to.be();
    });
