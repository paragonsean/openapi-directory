...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.PricingConfigurationApi();
  });
  ...
  describe('PricingConfigurationApi', function() {
    describe('getPricingConfig', function() {
      it('should call getPricingConfig successfully', function(done) {
        //uncomment below and update the code to test getPricingConfig
        //instance.getPricingConfig(function(error) {
    ...
    describe('getPricingv2Status', function() {
      it('should call getPricingv2Status successfully', function(done) {
        //uncomment below and update the code to test getPricingv2Status
        //instance.getPricingv2Status(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
