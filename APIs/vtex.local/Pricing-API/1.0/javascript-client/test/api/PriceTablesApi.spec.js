...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.PriceTablesApi();
  });
  ...
  describe('PriceTablesApi', function() {
    describe('getallpricetablesandrules', function() {
      it('should call getallpricetablesandrules successfully', function(done) {
        //uncomment below and update the code to test getallpricetablesandrules
        //instance.getallpricetablesandrules(function(error) {
    ...
    describe('getrulesforapricetable', function() {
      it('should call getrulesforapricetable successfully', function(done) {
        //uncomment below and update the code to test getrulesforapricetable
        //instance.getrulesforapricetable(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listpricetables', function() {
      it('should call listpricetables successfully', function(done) {
        //uncomment below and update the code to test listpricetables
        //instance.listpricetables(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pricingPipelineCatalogPriceTableIdPut', function() {
      it('should call pricingPipelineCatalogPriceTableIdPut successfully', function(done) {
        //uncomment below and update the code to test pricingPipelineCatalogPriceTableIdPut
        //instance.pricingPipelineCatalogPriceTableIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
