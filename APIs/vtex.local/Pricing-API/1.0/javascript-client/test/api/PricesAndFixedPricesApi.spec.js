...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingApi.PricesAndFixedPricesApi();
  });
  ...
  describe('PricesAndFixedPricesApi', function() {
    describe('createUpdatePriceOrFixedPrice', function() {
      it('should call createUpdatePriceOrFixedPrice successfully', function(done) {
        //uncomment below and update the code to test createUpdatePriceOrFixedPrice
        //instance.createUpdatePriceOrFixedPrice(function(error) {
    ...
    describe('createorupdatefixedpricesonpricetableortradepolicy', function() {
      it('should call createorupdatefixedpricesonpricetableortradepolicy successfully', function(done) {
        //uncomment below and update the code to test createorupdatefixedpricesonpricetableortradepolicy
        //instance.createorupdatefixedpricesonpricetableortradepolicy(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deletefixedpricesonapricetableortradepolicy', function() {
      it('should call deletefixedpricesonapricetableortradepolicy successfully', function(done) {
        //uncomment below and update the code to test deletefixedpricesonapricetableortradepolicy
        //instance.deletefixedpricesonapricetableortradepolicy(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getComputedPricebypricetable', function() {
      it('should call getComputedPricebypricetable successfully', function(done) {
        //uncomment below and update the code to test getComputedPricebypricetable
        //instance.getComputedPricebypricetable(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getFixedPrices', function() {
      it('should call getFixedPrices successfully', function(done) {
        //uncomment below and update the code to test getFixedPrices
        //instance.getFixedPrices(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getFixedPricesonapricetable', function() {
      it('should call getFixedPricesonapricetable successfully', function(done) {
        //uncomment below and update the code to test getFixedPricesonapricetable
        //instance.getFixedPricesonapricetable(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
