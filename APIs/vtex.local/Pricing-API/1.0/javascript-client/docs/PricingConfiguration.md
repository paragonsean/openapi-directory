# PricingApi.PricingConfiguration
...
**blockedRoutes** | **[String]** | Array with all blocked routes. | [optional] 
**defaultMarkup** | **Number** | Account default markup. | 
...
**minimumMarkups** | **{String: Number}** | Account minimum markup. | 
...
**priceTableLimit** | **Number** | Price Table Limit. | [optional] 
**priceTableSelectionStrategy** | **String** | The strategy used to get prices when there is more than one option. Possible values: &#x60;first&#x60;, &#x60;highest&#x60;, &#x60;lowest&#x60;. Default: &#x60;first&#x60;. | [optional] [default to &#39;first&#39;]
**priceVariation** | [**PricingConfigurationPriceVariation**](PricingConfigurationPriceVariation.md) |  | [optional] 
**sellersToOverride** | **[Object]** | Overrides prices from sellers. | [optional] 
**tradePolicyConfigs** | [**[PricingConfigurationTradePolicyConfigsInner]**](PricingConfigurationTradePolicyConfigsInner.md) | Trade Policy Configurations array. | [optional] 
