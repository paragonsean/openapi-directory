...
/**
 * The PricingConfigurationPriceVariation model module.
 * @module model/PricingConfigurationPriceVariation
 * @version 1.0
 */
class PricingConfigurationPriceVariation {
    /**
     * Constructs a new <code>PricingConfigurationPriceVariation</code>.
     * Price Variation object.
     * @alias module:model/PricingConfigurationPriceVariation
     */
    constructor() { 
        
        PricingConfigurationPriceVariation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PricingConfigurationPriceVariation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingConfigurationPriceVariation} obj Optional instance to populate.
     * @return {module:model/PricingConfigurationPriceVariation} The populated <code>PricingConfigurationPriceVariation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingConfigurationPriceVariation();
    ...
    /**
     * Validates the JSON data with respect to <code>PricingConfigurationPriceVariation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingConfigurationPriceVariation</code>.
     */
 ...
 */
PricingConfigurationPriceVariation.prototype['lowerLimit'] = undefined;

/**
 * Upper variation limit.
 * @member {Number} upperLimit
 */
PricingConfigurationPriceVariation.prototype['upperLimit'] = undefined;
...
export default PricingConfigurationPriceVariation;
