...
import Getallpricetablesandrules200ResponseInnerRulesInner from './Getallpricetablesandrules200ResponseInnerRulesInner';

/**
 * The Getallpricetablesandrules200ResponseInner model module.
 * @module model/Getallpricetablesandrules200ResponseInner
 * @version 1.0
 */
class Getallpricetablesandrules200ResponseInner {
    /**
     * Constructs a new <code>Getallpricetablesandrules200ResponseInner</code>.
     * @alias module:model/Getallpricetablesandrules200ResponseInner
     */
    constructor() { 
        
        Getallpricetablesandrules200ResponseInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Getallpricetablesandrules200ResponseInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Getallpricetablesandrules200ResponseInner} obj Optional instance to populate.
     * @return {module:model/Getallpricetablesandrules200ResponseInner} The populated <code>Getallpricetablesandrules200ResponseInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Getallpricetablesandrules200ResponseInner();

            if (data.hasOwnProperty('percentualModifier')) {
                obj['percentualModifier'] = ApiClient.convertToType(data['percentualModifier'], 'Number');
            }
            if (data.hasOwnProperty('rules')) {
                obj['rules'] = ApiClient.convertToType(data['rules'], [Getallpricetablesandrules200ResponseInnerRulesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Getallpricetablesandrules200ResponseInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Getallpricetablesandrules200ResponseInner</code>.
     */
    static validateJSON(data) {
        if (data['rules']) { // data not null
            ...
            for (const item of data['rules']) {
                Getallpricetablesandrules200ResponseInnerRulesInner.validateJSON(item);
            };
        }
...
/**
 * Percentual modifier.
 * @member {Number} percentualModifier
 */
Getallpricetablesandrules200ResponseInner.prototype['percentualModifier'] = undefined;

/**
 * Array of rules for the price table.
 * @member {Array.<module:model/Getallpricetablesandrules200ResponseInnerRulesInner>} rules
 */
Getallpricetablesandrules200ResponseInner.prototype['rules'] = undefined;

/**
 * Trade Policy ID (Price Table ID).
 * @member {String} tradePolicyId
 */
Getallpricetablesandrules200ResponseInner.prototype['tradePolicyId'] = undefined;
...
export default Getallpricetablesandrules200ResponseInner;
