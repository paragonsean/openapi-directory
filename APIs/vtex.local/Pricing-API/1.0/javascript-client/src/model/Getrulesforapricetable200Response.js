...
/**
 * The Getrulesforapricetable200Response model module.
 * @module model/Getrulesforapricetable200Response
 * @version 1.0
 */
class Getrulesforapricetable200Response {
    /**
     * Constructs a new <code>Getrulesforapricetable200Response</code>.
     * @alias module:model/Getrulesforapricetable200Response
     */
    constructor() { 
        
        Getrulesforapricetable200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Getrulesforapricetable200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Getrulesforapricetable200Response} obj Optional instance to populate.
     * @return {module:model/Getrulesforapricetable200Response} The populated <code>Getrulesforapricetable200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Getrulesforapricetable200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Getrulesforapricetable200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Getrulesforapricetable200Response</code>.
     */
 ...
 */
Getrulesforapricetable200Response.prototype['percentualModifier'] = undefined;

/**
 * Array of rules for the price table.
 * @member {Array.<module:model/Getallpricetablesandrules200ResponseInnerRulesInner>} rules
 */
Getrulesforapricetable200Response.prototype['rules'] = undefined;

/**
 * Trade Policy ID (Price Table ID).
 * @member {String} tradePolicyId
 */
Getrulesforapricetable200Response.prototype['tradePolicyId'] = undefined;
...
export default Getrulesforapricetable200Response;
