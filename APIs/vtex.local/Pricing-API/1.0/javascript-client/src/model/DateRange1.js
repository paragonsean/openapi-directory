...
/**
 * The DateRange1 model module.
 * @module model/DateRange1
 * @version 1.0
 */
class DateRange1 {
    /**
     * Constructs a new <code>DateRange1</code>.
     * Period of time when the fixed price will be applied to the SKU.
     * @alias module:model/DateRange1
     * @param from {String} Start date of the price.
     * @param to {String} End date of the price.
     */
    constructor(from, to) { 
        
        DateRange1.initialize(this, from, to);
    }
    ...
    /**
     * Constructs a <code>DateRange1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DateRange1} obj Optional instance to populate.
     * @return {module:model/DateRange1} The populated <code>DateRange1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DateRange1();
    ...
    /**
     * Validates the JSON data with respect to <code>DateRange1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DateRange1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DateRange1.RequiredProperties) {
...
DateRange1.RequiredProperties = ["from", "to"];

/**
 * Start date of the price.
 * @member {String} from
 */
DateRange1.prototype['from'] = undefined;

/**
 * End date of the price.
 * @member {String} to
 */
DateRange1.prototype['to'] = undefined;
