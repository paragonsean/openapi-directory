...
/**
 * The MarkupRange model module.
 * @module model/MarkupRange
 * @version 1.0
 */
class MarkupRange {
    /**
     * Constructs a new <code>MarkupRange</code>.
     * For an item to be eligible to the rule, it&#39;s markup should be in this Markup Range.
     * @alias module:model/MarkupRange
     * @param from {Number} Item markup should be greater than or equal to this value.
     * @param to {Number} Item markup should be less than or equal to this value.
     */
    constructor(from, to) { 
        
        MarkupRange.initialize(this, from, to);
    }
    ...
    /**
     * Constructs a <code>MarkupRange</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MarkupRange} obj Optional instance to populate.
     * @return {module:model/MarkupRange} The populated <code>MarkupRange</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MarkupRange();
    ...
    /**
     * Validates the JSON data with respect to <code>MarkupRange</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MarkupRange</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MarkupRange.RequiredProperties) {
