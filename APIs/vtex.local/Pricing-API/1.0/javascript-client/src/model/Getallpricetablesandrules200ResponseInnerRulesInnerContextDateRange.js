...
/**
 * The Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange model module.
 * @module model/Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange
 * @version 1.0
 */
class Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange {
    /**
     * Constructs a new <code>Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange</code>.
     * The rule will be active during this time range.
     * @alias module:model/Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange
     */
    constructor() { 
        
        Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange} obj Optional instance to populate.
     * @return {module:model/Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange} The populated <code>Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange();
    ...
    /**
     * Validates the JSON data with respect to <code>Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange</code>.
     */
 ...
 * @member {String} from
 */
Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange.prototype['from'] = undefined;

/**
 * Date when the rule will be deactivated. Date format: `RFC3339`.
 * @member {String} to
 */
Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange.prototype['to'] = undefined;
...
export default Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange;
