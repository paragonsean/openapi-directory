...
import DateRange2 from './DateRange2';

/**
 * The CreateorupdatefixedpricesonpricetableortradepolicyRequestInner model module.
 * @module model/CreateorupdatefixedpricesonpricetableortradepolicyRequestInner
 * @version 1.0
 */
class CreateorupdatefixedpricesonpricetableortradepolicyRequestInner {
    /**
     * Constructs a new <code>CreateorupdatefixedpricesonpricetableortradepolicyRequestInner</code>.
     * @alias module:model/CreateorupdatefixedpricesonpricetableortradepolicyRequestInner
     * @param minQuantity {Number} The minimum SKU quantity for the fixed price to be applied.
     * @param value {Number} Fixed price value.
     */
    constructor(minQuantity, value) { 
        
        CreateorupdatefixedpricesonpricetableortradepolicyRequestInner.initialize(this, minQuantity, value);
    }
     ...
     */
    static initialize(obj, minQuantity, value) { 
        obj['minQuantity'] = minQuantity;
        obj['value'] = value;
    }

    /**
     * Constructs a <code>CreateorupdatefixedpricesonpricetableortradepolicyRequestInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateorupdatefixedpricesonpricetableortradepolicyRequestInner} obj Optional instance to populate.
     * @return {module:model/CreateorupdatefixedpricesonpricetableortradepolicyRequestInner} The populated <code>CreateorupdatefixedpricesonpricetableortradepolicyRequestInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateorupdatefixedpricesonpricetableortradepolicyRequestInner();

            if (data.hasOwnProperty('dateRange')) {
                obj['dateRange'] = DateRange2.constructFromObject(data['dateRange']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateorupdatefixedpricesonpricetableortradepolicyRequestInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateorupdatefixedpricesonpricetableortradepolicyRequestInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateorupdatefixedpricesonpricetableortradepolicyRequestInner.RequiredProperties) {
        ...
        if (data['dateRange']) { // data not null
          DateRange2.validateJSON(data['dateRange']);
        }
...
CreateorupdatefixedpricesonpricetableortradepolicyRequestInner.RequiredProperties = ["minQuantity", "value"];

/**
 * @member {module:model/DateRange2} dateRange
 */
CreateorupdatefixedpricesonpricetableortradepolicyRequestInner.prototype['dateRange'] = undefined;

/**
 * SKU List Fixed Price.
 * @member {Number} listPrice
 */
CreateorupdatefixedpricesonpricetableortradepolicyRequestInner.prototype['listPrice'] = undefined;

/**
 * The minimum SKU quantity for the fixed price to be applied.
 * @member {Number} minQuantity
 */
CreateorupdatefixedpricesonpricetableortradepolicyRequestInner.prototype['minQuantity'] = undefined;

/**
 * Fixed price value.
 * @member {Number} value
 */
CreateorupdatefixedpricesonpricetableortradepolicyRequestInner.prototype['value'] = undefined;
...
export default CreateorupdatefixedpricesonpricetableortradepolicyRequestInner;
