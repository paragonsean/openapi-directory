...
/**
 * The FixedPrice model module.
 * @module model/FixedPrice
 * @version 1.0
 */
class FixedPrice {
    /**
     * Constructs a new <code>FixedPrice</code>.
     * @alias module:model/FixedPrice
     * @param listPrice {Number} Trade Policy List Price Value.
     * @param minQuantity {Number} Trade Policy Fixed Price Minimum Item Quantity.
     * @param tradePolicyId {String} Trade Policy ID.
     * @param value {Number} Trade Policy Fixed Price Value.
     */
    constructor(listPrice, minQuantity, tradePolicyId, value) { 
        
        FixedPrice.initialize(this, listPrice, minQuantity, tradePolicyId, value);
    }
     ...
     */
    static initialize(obj, listPrice, minQuantity, tradePolicyId, value) { 
    ...
    /**
     * Constructs a <code>FixedPrice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FixedPrice} obj Optional instance to populate.
     * @return {module:model/FixedPrice} The populated <code>FixedPrice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FixedPrice();
    ...
    /**
     * Validates the JSON data with respect to <code>FixedPrice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FixedPrice</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FixedPrice.RequiredProperties) {
...
FixedPrice.RequiredProperties = ["listPrice", "minQuantity", "tradePolicyId", "value"];

/**
 * @member {module:model/DateRange} dateRange
 */
FixedPrice.prototype['dateRange'] = undefined;

/**
 * Trade Policy List Price Value.
 * @member {Number} listPrice
 */
FixedPrice.prototype['listPrice'] = undefined;

/**
 * Trade Policy Fixed Price Minimum Item Quantity.
 * @member {Number} minQuantity
 */
FixedPrice.prototype['minQuantity'] = undefined;

/**
 * Trade Policy ID.
 * @member {String} tradePolicyId
 */
FixedPrice.prototype['tradePolicyId'] = undefined;

/**
 * Trade Policy Fixed Price Value.
 * @member {Number} value
 */
FixedPrice.prototype['value'] = undefined;
