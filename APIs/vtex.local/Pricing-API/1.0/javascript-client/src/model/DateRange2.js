...
/**
 * The DateRange2 model module.
 * @module model/DateRange2
 * @version 1.0
 */
class DateRange2 {
    /**
     * Constructs a new <code>DateRange2</code>.
     * Period of time when the fixed price will be applied to the SKU.
     * @alias module:model/DateRange2
     * @param from {String} Start date of the price.
     * @param to {String} End date of the price.
     */
    constructor(from, to) { 
        
        DateRange2.initialize(this, from, to);
    }
    ...
    /**
     * Constructs a <code>DateRange2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DateRange2} obj Optional instance to populate.
     * @return {module:model/DateRange2} The populated <code>DateRange2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DateRange2();
    ...
    /**
     * Validates the JSON data with respect to <code>DateRange2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DateRange2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DateRange2.RequiredProperties) {
...
DateRange2.RequiredProperties = ["from", "to"];

/**
 * Start date of the price.
 * @member {String} from
 */
DateRange2.prototype['from'] = undefined;

/**
 * End date of the price.
 * @member {String} to
 */
DateRange2.prototype['to'] = undefined;
