...
/**
 * The PricingPipelineCatalogPriceTableIdPutRequest model module.
 * @module model/PricingPipelineCatalogPriceTableIdPutRequest
 * @version 1.0
 */
class PricingPipelineCatalogPriceTableIdPutRequest {
    /**
     * Constructs a new <code>PricingPipelineCatalogPriceTableIdPutRequest</code>.
     * @alias module:model/PricingPipelineCatalogPriceTableIdPutRequest
     * @param rules {Array.<module:model/RulesInner>} Array of rules for the price table.
     */
    constructor(rules) { 
        
        PricingPipelineCatalogPriceTableIdPutRequest.initialize(this, rules);
    }
    ...
    /**
     * Constructs a <code>PricingPipelineCatalogPriceTableIdPutRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingPipelineCatalogPriceTableIdPutRequest} obj Optional instance to populate.
     * @return {module:model/PricingPipelineCatalogPriceTableIdPutRequest} The populated <code>PricingPipelineCatalogPriceTableIdPutRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingPipelineCatalogPriceTableIdPutRequest();

            if (data.hasOwnProperty('rules')) {
                obj['rules'] = ApiClient.convertToType(data['rules'], [RulesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PricingPipelineCatalogPriceTableIdPutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingPipelineCatalogPriceTableIdPutRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingPipelineCatalogPriceTableIdPutRequest.RequiredProperties) {
...
PricingPipelineCatalogPriceTableIdPutRequest.RequiredProperties = ["rules"];

/**
 * Array of rules for the price table.
 * @member {Array.<module:model/RulesInner>} rules
 */
PricingPipelineCatalogPriceTableIdPutRequest.prototype['rules'] = undefined;
...
export default PricingPipelineCatalogPriceTableIdPutRequest;
