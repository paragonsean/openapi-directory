...
/**
 * The GetPricingv2Status200Response model module.
 * @module model/GetPricingv2Status200Response
 * @version 1.0
 */
class GetPricingv2Status200Response {
    /**
     * Constructs a new <code>GetPricingv2Status200Response</code>.
     * @alias module:model/GetPricingv2Status200Response
     */
    constructor() { 
        
        GetPricingv2Status200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPricingv2Status200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPricingv2Status200Response} obj Optional instance to populate.
     * @return {module:model/GetPricingv2Status200Response} The populated <code>GetPricingv2Status200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPricingv2Status200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPricingv2Status200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPricingv2Status200Response</code>.
     */
 ...
 */
GetPricingv2Status200Response.prototype['hasMigrated'] = undefined;

/**
 * Defines if the account is active.
 * @member {Boolean} isActive
 */
GetPricingv2Status200Response.prototype['isActive'] = undefined;
...
export default GetPricingv2Status200Response;
