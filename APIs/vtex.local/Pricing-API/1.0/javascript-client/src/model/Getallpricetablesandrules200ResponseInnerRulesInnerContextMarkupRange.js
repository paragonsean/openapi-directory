...
/**
 * The Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange model module.
 * @module model/Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange
 * @version 1.0
 */
class Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange {
    /**
     * Constructs a new <code>Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange</code>.
     * For an item to be eligible to the rule, it&#39;s markup should be in this Markup Range.
     * @alias module:model/Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange
     */
    constructor() { 
        
        Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange} obj Optional instance to populate.
     * @return {module:model/Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange} The populated <code>Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange();
    ...
    /**
     * Validates the JSON data with respect to <code>Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange</code>.
     */
 ...
 * @member {Number} from
 */
Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange.prototype['from'] = undefined;

/**
 * Item markup should be less than or equal to this value.
 * @member {Number} to
 */
Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange.prototype['to'] = undefined;
...
export default Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange;
