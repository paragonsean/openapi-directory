...
/**
 * The RulesInner model module.
 * @module model/RulesInner
 * @version 1.0
 */
class RulesInner {
    /**
     * Constructs a new <code>RulesInner</code>.
     * Object containing a price table rule.
     * @alias module:model/RulesInner
     * @param context {module:model/Context} 
     * @param id {Number} Rule ID.
     * @param percentualModifier {Number} Percentual modifier.
     */
    constructor(context, id, percentualModifier) { 
        
        RulesInner.initialize(this, context, id, percentualModifier);
    }
     ...
     */
    static initialize(obj, context, id, percentualModifier) { 
        obj['context'] = context;
        obj['id'] = id;
        obj['percentualModifier'] = percentualModifier;
    }

    /**
     * Constructs a <code>RulesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RulesInner} obj Optional instance to populate.
     * @return {module:model/RulesInner} The populated <code>RulesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RulesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>RulesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RulesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RulesInner.RequiredProperties) {
...
RulesInner.RequiredProperties = ["context", "id", "percentualModifier"];

/**
 * @member {module:model/Context} context
 */
RulesInner.prototype['context'] = undefined;

/**
 * Rule ID.
 * @member {Number} id
 */
RulesInner.prototype['id'] = undefined;

/**
 * Percentual modifier.
 * @member {Number} percentualModifier
 */
RulesInner.prototype['percentualModifier'] = undefined;
