...
public class Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange {
  ...
  public Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange() {
  }

  public Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange from(String from) {
    this.from = from;
    return this;
  }
  ...
  public Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange to(String to) {
    this.to = to;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange = (Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange) o;
    return Objects.equals(this.from, getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange.from) &&
        Objects.equals(this.to, getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange.to);
  }
  ...
  public String toString() {
    ...
    sb.append("class Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange is not found in the empty JSON string", Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange.class));

       return (TypeAdapter<T>) new TypeAdapter<Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange>() {
           @Override
           public void write(JsonWriter out, Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange
   * @throws IOException if the JSON string is invalid with respect to Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange
   */
  public static Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange.class);
  }

  /**
   * Convert an instance of Getallpricetablesandrules200ResponseInnerRulesInnerContextDateRange to an JSON string
   *
   * @return JSON string
   */
