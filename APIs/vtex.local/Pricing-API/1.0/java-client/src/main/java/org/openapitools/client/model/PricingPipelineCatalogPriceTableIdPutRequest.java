...
public class PricingPipelineCatalogPriceTableIdPutRequest {
  public static final String SERIALIZED_NAME_RULES = "rules";
  @SerializedName(SERIALIZED_NAME_RULES)
  private List<RulesInner> rules = new ArrayList<>();

  public PricingPipelineCatalogPriceTableIdPutRequest() {
  }

  public PricingPipelineCatalogPriceTableIdPutRequest rules(List<RulesInner> rules) {
    this.rules = rules;
    return this;
  }

  public PricingPipelineCatalogPriceTableIdPutRequest addRulesItem(RulesInner rulesItem) {
    if (this.rules == null) {
  ...
  public boolean equals(Object o) {
    ...
    PricingPipelineCatalogPriceTableIdPutRequest pricingPipelineCatalogPriceTableIdPutRequest = (PricingPipelineCatalogPriceTableIdPutRequest) o;
    return Objects.equals(this.rules, pricingPipelineCatalogPriceTableIdPutRequest.rules);
  }
  ...
  public String toString() {
    ...
    sb.append("class PricingPipelineCatalogPriceTableIdPutRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PricingPipelineCatalogPriceTableIdPutRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PricingPipelineCatalogPriceTableIdPutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricingPipelineCatalogPriceTableIdPutRequest is not found in the empty JSON string", PricingPipelineCatalogPriceTableIdPutRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PricingPipelineCatalogPriceTableIdPutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PricingPipelineCatalogPriceTableIdPutRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PricingPipelineCatalogPriceTableIdPutRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PricingPipelineCatalogPriceTableIdPutRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PricingPipelineCatalogPriceTableIdPutRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PricingPipelineCatalogPriceTableIdPutRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PricingPipelineCatalogPriceTableIdPutRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PricingPipelineCatalogPriceTableIdPutRequest>() {
           @Override
           public void write(JsonWriter out, PricingPipelineCatalogPriceTableIdPutRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PricingPipelineCatalogPriceTableIdPutRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PricingPipelineCatalogPriceTableIdPutRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PricingPipelineCatalogPriceTableIdPutRequest
   * @throws IOException if the JSON string is invalid with respect to PricingPipelineCatalogPriceTableIdPutRequest
   */
  public static PricingPipelineCatalogPriceTableIdPutRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PricingPipelineCatalogPriceTableIdPutRequest.class);
  }

  /**
   * Convert an instance of PricingPipelineCatalogPriceTableIdPutRequest to an JSON string
   *
   * @return JSON string
   */
