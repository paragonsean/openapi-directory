...
public class Getallpricetablesandrules200ResponseInner {
  ...
  public Getallpricetablesandrules200ResponseInner() {
  }

  public Getallpricetablesandrules200ResponseInner percentualModifier(Integer percentualModifier) {
  ...
  public Getallpricetablesandrules200ResponseInner rules(List<Getallpricetablesandrules200ResponseInnerRulesInner> rules) {
    this.rules = rules;
    return this;
  }

  public Getallpricetablesandrules200ResponseInner addRulesItem(Getallpricetablesandrules200ResponseInnerRulesInner rulesItem) {
    if (this.rules == null) {
  ...
  public Getallpricetablesandrules200ResponseInner tradePolicyId(String tradePolicyId) {
  ...
  public boolean equals(Object o) {
    ...
    Getallpricetablesandrules200ResponseInner getallpricetablesandrules200ResponseInner = (Getallpricetablesandrules200ResponseInner) o;
    return Objects.equals(this.percentualModifier, getallpricetablesandrules200ResponseInner.percentualModifier) &&
        Objects.equals(this.rules, getallpricetablesandrules200ResponseInner.rules) &&
        Objects.equals(this.tradePolicyId, getallpricetablesandrules200ResponseInner.tradePolicyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class Getallpricetablesandrules200ResponseInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Getallpricetablesandrules200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Getallpricetablesandrules200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Getallpricetablesandrules200ResponseInner is not found in the empty JSON string", Getallpricetablesandrules200ResponseInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Getallpricetablesandrules200ResponseInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Getallpricetablesandrules200ResponseInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Getallpricetablesandrules200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Getallpricetablesandrules200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Getallpricetablesandrules200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Getallpricetablesandrules200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Getallpricetablesandrules200ResponseInner>() {
           @Override
           public void write(JsonWriter out, Getallpricetablesandrules200ResponseInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Getallpricetablesandrules200ResponseInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Getallpricetablesandrules200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Getallpricetablesandrules200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to Getallpricetablesandrules200ResponseInner
   */
  public static Getallpricetablesandrules200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Getallpricetablesandrules200ResponseInner.class);
  }

  /**
   * Convert an instance of Getallpricetablesandrules200ResponseInner to an JSON string
   *
   * @return JSON string
   */
