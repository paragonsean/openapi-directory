...
public class GetPricingv2Status200Response {
  ...
  public GetPricingv2Status200Response() {
  }

  public GetPricingv2Status200Response hasMigrated(Boolean hasMigrated) {
  ...
  public GetPricingv2Status200Response isActive(Boolean isActive) {
  ...
  public boolean equals(Object o) {
    ...
    GetPricingv2Status200Response getPricingv2Status200Response = (GetPricingv2Status200Response) o;
    return Objects.equals(this.hasMigrated, getPricingv2Status200Response.hasMigrated) &&
        Objects.equals(this.isActive, getPricingv2Status200Response.isActive);
  }

  @Override
  public int hashCode() {
    return Objects.hash(hasMigrated, isActive);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPricingv2Status200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPricingv2Status200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPricingv2Status200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPricingv2Status200Response is not found in the empty JSON string", GetPricingv2Status200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPricingv2Status200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPricingv2Status200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPricingv2Status200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPricingv2Status200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPricingv2Status200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPricingv2Status200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPricingv2Status200Response>() {
           @Override
           public void write(JsonWriter out, GetPricingv2Status200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPricingv2Status200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPricingv2Status200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPricingv2Status200Response
   * @throws IOException if the JSON string is invalid with respect to GetPricingv2Status200Response
   */
  public static GetPricingv2Status200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPricingv2Status200Response.class);
  }

  /**
   * Convert an instance of GetPricingv2Status200Response to an JSON string
   *
   * @return JSON string
   */
