...
public class MarkupRange {
  ...
  public MarkupRange from(Integer from) {
    this.from = from;
    return this;
  }
  ...
  public MarkupRange to(Integer to) {
    this.to = to;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MarkupRange markupRange = (MarkupRange) o;
    return Objects.equals(this.from, markupRange.from) &&
        Objects.equals(this.to, markupRange.to);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MarkupRange
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MarkupRange.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MarkupRange is not found in the empty JSON string", MarkupRange.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MarkupRange.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MarkupRange` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MarkupRange.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MarkupRange.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MarkupRange' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MarkupRange> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MarkupRange.class));

       return (TypeAdapter<T>) new TypeAdapter<MarkupRange>() {
           @Override
           public void write(JsonWriter out, MarkupRange value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MarkupRange read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MarkupRange given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MarkupRange
   * @throws IOException if the JSON string is invalid with respect to MarkupRange
   */
  public static MarkupRange fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MarkupRange.class);
  }

  /**
   * Convert an instance of MarkupRange to an JSON string
   *
   * @return JSON string
   */
