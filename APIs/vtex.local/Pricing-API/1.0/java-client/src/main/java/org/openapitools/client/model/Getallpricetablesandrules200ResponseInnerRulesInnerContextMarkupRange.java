...
public class Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange {
  ...
  public Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange() {
  }

  public Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange from(Integer from) {
    this.from = from;
    return this;
  }
  ...
  public Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange to(Integer to) {
    this.to = to;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange = (Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange) o;
    return Objects.equals(this.from, getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange.from) &&
        Objects.equals(this.to, getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange.to);
  }
  ...
  public String toString() {
    ...
    sb.append("class Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange is not found in the empty JSON string", Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange.class));

       return (TypeAdapter<T>) new TypeAdapter<Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange>() {
           @Override
           public void write(JsonWriter out, Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange
   * @throws IOException if the JSON string is invalid with respect to Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange
   */
  public static Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange.class);
  }

  /**
   * Convert an instance of Getallpricetablesandrules200ResponseInnerRulesInnerContextMarkupRange to an JSON string
   *
   * @return JSON string
   */
