...
public class FixedPrice {
  ...
  public FixedPrice dateRange(DateRange dateRange) {
  ...
  public FixedPrice listPrice(BigDecimal listPrice) {
  ...
  public FixedPrice minQuantity(Integer minQuantity) {
  ...
  public FixedPrice tradePolicyId(String tradePolicyId) {
  ...
  public FixedPrice value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dateRange, fixedPrice.dateRange) &&
        Objects.equals(this.listPrice, fixedPrice.listPrice) &&
        Objects.equals(this.minQuantity, fixedPrice.minQuantity) &&
        Objects.equals(this.tradePolicyId, fixedPrice.tradePolicyId) &&
        Objects.equals(this.value, fixedPrice.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FixedPrice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FixedPrice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FixedPrice is not found in the empty JSON string", FixedPrice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FixedPrice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FixedPrice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FixedPrice.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FixedPrice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FixedPrice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FixedPrice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FixedPrice.class));

       return (TypeAdapter<T>) new TypeAdapter<FixedPrice>() {
           @Override
           public void write(JsonWriter out, FixedPrice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FixedPrice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FixedPrice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FixedPrice
   * @throws IOException if the JSON string is invalid with respect to FixedPrice
   */
  public static FixedPrice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FixedPrice.class);
  }

  /**
   * Convert an instance of FixedPrice to an JSON string
   *
   * @return JSON string
   */
