...
public class DateRange2 {
  ...
  public DateRange2 from(String from) {
    this.from = from;
    return this;
  }
  ...
  public DateRange2 to(String to) {
    this.to = to;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DateRange2 dateRange2 = (DateRange2) o;
    return Objects.equals(this.from, dateRange2.from) &&
        Objects.equals(this.to, dateRange2.to);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DateRange2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DateRange2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DateRange2 is not found in the empty JSON string", DateRange2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DateRange2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DateRange2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DateRange2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DateRange2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DateRange2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DateRange2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DateRange2.class));

       return (TypeAdapter<T>) new TypeAdapter<DateRange2>() {
           @Override
           public void write(JsonWriter out, DateRange2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DateRange2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DateRange2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DateRange2
   * @throws IOException if the JSON string is invalid with respect to DateRange2
   */
  public static DateRange2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DateRange2.class);
  }

  /**
   * Convert an instance of DateRange2 to an JSON string
   *
   * @return JSON string
   */
