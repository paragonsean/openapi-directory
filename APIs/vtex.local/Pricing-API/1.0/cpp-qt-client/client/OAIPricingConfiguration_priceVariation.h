...
/*
 * OAIPricingConfiguration_priceVariation.h
 *
 * Price Variation object.
 */

#ifndef OAIPricingConfiguration_priceVariation_H
#define OAIPricingConfiguration_priceVariation_H
...
class OAIPricingConfiguration_priceVariation : public OAIObject {
public:
    OAIPricingConfiguration_priceVariation();
    OAIPricingConfiguration_priceVariation(QString json);
    ~OAIPricingConfiguration_priceVariation() override;
    ...
    qint32 getLowerLimit() const;
    void setLowerLimit(const qint32 &lower_limit);
    bool is_lower_limit_Set() const;
    bool is_lower_limit_Valid() const;

    qint32 getUpperLimit() const;
    void setUpperLimit(const qint32 &upper_limit);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPricingConfiguration_priceVariation)

#endif // OAIPricingConfiguration_priceVariation_H
