...
OAIDateRange_2::OAIDateRange_2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDateRange_2::OAIDateRange_2() {
    this->initializeModel();
}

OAIDateRange_2::~OAIDateRange_2() {}

void OAIDateRange_2::initializeModel() {
...
void OAIDateRange_2::fromJson(QString jsonString) {
...
void OAIDateRange_2::fromJsonObject(QJsonObject json) {
...
QString OAIDateRange_2::asJson() const {
...
QJsonObject OAIDateRange_2::asJsonObject() const {
    QJsonObject obj;
    if (m_from_isSet) {
...
QString OAIDateRange_2::getFrom() const {
    return m_from;
}
void OAIDateRange_2::setFrom(const QString &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAIDateRange_2::is_from_Set() const{
    return m_from_isSet;
}

bool OAIDateRange_2::is_from_Valid() const{
    return m_from_isValid;
}

QString OAIDateRange_2::getTo() const {
    return m_to;
}
void OAIDateRange_2::setTo(const QString &to) {
    m_to = to;
    m_to_isSet = true;
}

bool OAIDateRange_2::is_to_Set() const{
    return m_to_isSet;
}

bool OAIDateRange_2::is_to_Valid() const{
    return m_to_isValid;
}

bool OAIDateRange_2::isSet() const {
...
bool OAIDateRange_2::isValid() const {
