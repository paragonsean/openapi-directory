...
OAIGetallpricetablesandrules_200_response_inner::OAIGetallpricetablesandrules_200_response_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetallpricetablesandrules_200_response_inner::OAIGetallpricetablesandrules_200_response_inner() {
    this->initializeModel();
}

OAIGetallpricetablesandrules_200_response_inner::~OAIGetallpricetablesandrules_200_response_inner() {}

void OAIGetallpricetablesandrules_200_response_inner::initializeModel() {
...
void OAIGetallpricetablesandrules_200_response_inner::fromJson(QString jsonString) {
...
void OAIGetallpricetablesandrules_200_response_inner::fromJsonObject(QJsonObject json) {
...
QString OAIGetallpricetablesandrules_200_response_inner::asJson() const {
...
QJsonObject OAIGetallpricetablesandrules_200_response_inner::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIGetallpricetablesandrules_200_response_inner::getPercentualModifier() const {
    return m_percentual_modifier;
}
void OAIGetallpricetablesandrules_200_response_inner::setPercentualModifier(const qint32 &percentual_modifier) {
    m_percentual_modifier = percentual_modifier;
    m_percentual_modifier_isSet = true;
}

bool OAIGetallpricetablesandrules_200_response_inner::is_percentual_modifier_Set() const{
    return m_percentual_modifier_isSet;
}

bool OAIGetallpricetablesandrules_200_response_inner::is_percentual_modifier_Valid() const{
    return m_percentual_modifier_isValid;
}

QList<OAIGetallpricetablesandrules_200_response_inner_rules_inner> OAIGetallpricetablesandrules_200_response_inner::getRules() const {
    return m_rules;
}
void OAIGetallpricetablesandrules_200_response_inner::setRules(const QList<OAIGetallpricetablesandrules_200_response_inner_rules_inner> &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}

bool OAIGetallpricetablesandrules_200_response_inner::is_rules_Set() const{
    return m_rules_isSet;
}

bool OAIGetallpricetablesandrules_200_response_inner::is_rules_Valid() const{
    return m_rules_isValid;
}

QString OAIGetallpricetablesandrules_200_response_inner::getTradePolicyId() const {
    return m_trade_policy_id;
}
void OAIGetallpricetablesandrules_200_response_inner::setTradePolicyId(const QString &trade_policy_id) {
    m_trade_policy_id = trade_policy_id;
    m_trade_policy_id_isSet = true;
}

bool OAIGetallpricetablesandrules_200_response_inner::is_trade_policy_id_Set() const{
    return m_trade_policy_id_isSet;
}

bool OAIGetallpricetablesandrules_200_response_inner::is_trade_policy_id_Valid() const{
    return m_trade_policy_id_isValid;
}

bool OAIGetallpricetablesandrules_200_response_inner::isSet() const {
...
bool OAIGetallpricetablesandrules_200_response_inner::isValid() const {
