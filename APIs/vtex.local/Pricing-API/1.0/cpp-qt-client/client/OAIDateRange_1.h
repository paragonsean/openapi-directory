...
#ifndef OAIDateRange_1_H
#define OAIDateRange_1_H
...
class OAIDateRange_1 : public OAIObject {
public:
    OAIDateRange_1();
    OAIDateRange_1(QString json);
    ~OAIDateRange_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDateRange_1)

#endif // OAIDateRange_1_H
