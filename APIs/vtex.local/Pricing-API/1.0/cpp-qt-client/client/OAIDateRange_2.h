...
#ifndef OAIDateRange_2_H
#define OAIDateRange_2_H
...
class OAIDateRange_2 : public OAIObject {
public:
    OAIDateRange_2();
    OAIDateRange_2(QString json);
    ~OAIDateRange_2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDateRange_2)

#endif // OAIDateRange_2_H
