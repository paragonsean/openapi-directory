...
/*
 * OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange.h
 *
 * For an item to be eligible to the rule, it&#39;s markup should be in this Markup Range.
 */

#ifndef OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange_H
#define OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange_H
...
class OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange : public OAIObject {
public:
    OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange();
    OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange(QString json);
    ~OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange)

#endif // OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange_H
