...
/*
 * OAIGetallpricetablesandrules_200_response_inner_rules_inner.h
 *
 * Object containing a price table rule.
 */

#ifndef OAIGetallpricetablesandrules_200_response_inner_rules_inner_H
#define OAIGetallpricetablesandrules_200_response_inner_rules_inner_H
...
namespace OpenAPI {
class OAIGetallpricetablesandrules_200_response_inner_rules_inner_context;

class OAIGetallpricetablesandrules_200_response_inner_rules_inner : public OAIObject {
public:
    OAIGetallpricetablesandrules_200_response_inner_rules_inner();
    OAIGetallpricetablesandrules_200_response_inner_rules_inner(QString json);
    ~OAIGetallpricetablesandrules_200_response_inner_rules_inner() override;
    ...
    OAIGetallpricetablesandrules_200_response_inner_rules_inner_context getContext() const;
    void setContext(const OAIGetallpricetablesandrules_200_response_inner_rules_inner_context &context);
...
private:
    ...
    OAIGetallpricetablesandrules_200_response_inner_rules_inner_context m_context;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetallpricetablesandrules_200_response_inner_rules_inner)

#endif // OAIGetallpricetablesandrules_200_response_inner_rules_inner_H
