...
OAIDateRange_1::OAIDateRange_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDateRange_1::OAIDateRange_1() {
    this->initializeModel();
}

OAIDateRange_1::~OAIDateRange_1() {}

void OAIDateRange_1::initializeModel() {
...
void OAIDateRange_1::fromJson(QString jsonString) {
...
void OAIDateRange_1::fromJsonObject(QJsonObject json) {
...
QString OAIDateRange_1::asJson() const {
...
QJsonObject OAIDateRange_1::asJsonObject() const {
    QJsonObject obj;
    if (m_from_isSet) {
...
QString OAIDateRange_1::getFrom() const {
    return m_from;
}
void OAIDateRange_1::setFrom(const QString &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAIDateRange_1::is_from_Set() const{
    return m_from_isSet;
}

bool OAIDateRange_1::is_from_Valid() const{
    return m_from_isValid;
}

QString OAIDateRange_1::getTo() const {
    return m_to;
}
void OAIDateRange_1::setTo(const QString &to) {
    m_to = to;
    m_to_isSet = true;
}

bool OAIDateRange_1::is_to_Set() const{
    return m_to_isSet;
}

bool OAIDateRange_1::is_to_Valid() const{
    return m_to_isValid;
}

bool OAIDateRange_1::isSet() const {
...
bool OAIDateRange_1::isValid() const {
