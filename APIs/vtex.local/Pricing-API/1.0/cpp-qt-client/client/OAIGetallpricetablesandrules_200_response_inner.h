...
/*
 * OAIGetallpricetablesandrules_200_response_inner.h
 *
 * 
 */

#ifndef OAIGetallpricetablesandrules_200_response_inner_H
#define OAIGetallpricetablesandrules_200_response_inner_H

#include <QJsonObject>

#include "OAIGetallpricetablesandrules_200_response_inner_rules_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIGetallpricetablesandrules_200_response_inner_rules_inner;

class OAIGetallpricetablesandrules_200_response_inner : public OAIObject {
public:
    OAIGetallpricetablesandrules_200_response_inner();
    OAIGetallpricetablesandrules_200_response_inner(QString json);
    ~OAIGetallpricetablesandrules_200_response_inner() override;
    ...
    qint32 getPercentualModifier() const;
    void setPercentualModifier(const qint32 &percentual_modifier);
    bool is_percentual_modifier_Set() const;
    bool is_percentual_modifier_Valid() const;

    QList<OAIGetallpricetablesandrules_200_response_inner_rules_inner> getRules() const;
    void setRules(const QList<OAIGetallpricetablesandrules_200_response_inner_rules_inner> &rules);
...
private:
    ...
    qint32 m_percentual_modifier;
    bool m_percentual_modifier_isSet;
    bool m_percentual_modifier_isValid;

    QList<OAIGetallpricetablesandrules_200_response_inner_rules_inner> m_rules;
    bool m_rules_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetallpricetablesandrules_200_response_inner)

#endif // OAIGetallpricetablesandrules_200_response_inner_H
