...
/*
 * OAI_pricing_pipeline_catalog__priceTableId__put_request.h
 *
 * 
 */

#ifndef OAI_pricing_pipeline_catalog__priceTableId__put_request_H
#define OAI_pricing_pipeline_catalog__priceTableId__put_request_H
...
namespace OpenAPI {
class OAIRules_inner;

class OAI_pricing_pipeline_catalog__priceTableId__put_request : public OAIObject {
public:
    OAI_pricing_pipeline_catalog__priceTableId__put_request();
    OAI_pricing_pipeline_catalog__priceTableId__put_request(QString json);
    ~OAI_pricing_pipeline_catalog__priceTableId__put_request() override;
    ...
    QList<OAIRules_inner> getRules() const;
    void setRules(const QList<OAIRules_inner> &rules);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_pricing_pipeline_catalog__priceTableId__put_request)

#endif // OAI_pricing_pipeline_catalog__priceTableId__put_request_H
