...
OAIFixedPrice::OAIFixedPrice(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFixedPrice::OAIFixedPrice() {
    this->initializeModel();
}

OAIFixedPrice::~OAIFixedPrice() {}

void OAIFixedPrice::initializeModel() {
...
void OAIFixedPrice::fromJson(QString jsonString) {
...
void OAIFixedPrice::fromJsonObject(QJsonObject json) {
...
QString OAIFixedPrice::asJson() const {
...
QJsonObject OAIFixedPrice::asJsonObject() const {
    QJsonObject obj;
...
OAIDateRange OAIFixedPrice::getDateRange() const {
    return m_date_range;
}
void OAIFixedPrice::setDateRange(const OAIDateRange &date_range) {
    m_date_range = date_range;
    m_date_range_isSet = true;
}

bool OAIFixedPrice::is_date_range_Set() const{
    return m_date_range_isSet;
}

bool OAIFixedPrice::is_date_range_Valid() const{
    return m_date_range_isValid;
}

double OAIFixedPrice::getListPrice() const {
    return m_list_price;
}
void OAIFixedPrice::setListPrice(const double &list_price) {
    m_list_price = list_price;
    m_list_price_isSet = true;
}

bool OAIFixedPrice::is_list_price_Set() const{
    return m_list_price_isSet;
}

bool OAIFixedPrice::is_list_price_Valid() const{
    return m_list_price_isValid;
}

qint32 OAIFixedPrice::getMinQuantity() const {
    return m_min_quantity;
}
void OAIFixedPrice::setMinQuantity(const qint32 &min_quantity) {
    m_min_quantity = min_quantity;
    m_min_quantity_isSet = true;
}

bool OAIFixedPrice::is_min_quantity_Set() const{
    return m_min_quantity_isSet;
}

bool OAIFixedPrice::is_min_quantity_Valid() const{
    return m_min_quantity_isValid;
}

QString OAIFixedPrice::getTradePolicyId() const {
    return m_trade_policy_id;
}
void OAIFixedPrice::setTradePolicyId(const QString &trade_policy_id) {
    m_trade_policy_id = trade_policy_id;
    m_trade_policy_id_isSet = true;
}

bool OAIFixedPrice::is_trade_policy_id_Set() const{
    return m_trade_policy_id_isSet;
}

bool OAIFixedPrice::is_trade_policy_id_Valid() const{
    return m_trade_policy_id_isValid;
}

double OAIFixedPrice::getValue() const {
    return m_value;
}
void OAIFixedPrice::setValue(const double &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIFixedPrice::is_value_Set() const{
    return m_value_isSet;
}

bool OAIFixedPrice::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIFixedPrice::isSet() const {
...
bool OAIFixedPrice::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_list_price_isValid && m_min_quantity_isValid && m_trade_policy_id_isValid && m_value_isValid && true;
}
