...
QMap<QString, QMap<QString, QString>> OAIContext::getBrands() const {
    return m_brands;
}
void OAIContext::setBrands(const QMap<QString, QMap<QString, QString>> &brands) {
    m_brands = brands;
    m_brands_isSet = true;
}

bool OAIContext::is_brands_Set() const{
    return m_brands_isSet;
}

bool OAIContext::is_brands_Valid() const{
    return m_brands_isValid;
}

QMap<QString, QMap<QString, QString>> OAIContext::getCategories() const {
    return m_categories;
}
void OAIContext::setCategories(const QMap<QString, QMap<QString, QString>> &categories) {
    m_categories = categories;
    m_categories_isSet = true;
}

bool OAIContext::is_categories_Set() const{
    return m_categories_isSet;
}

bool OAIContext::is_categories_Valid() const{
    return m_categories_isValid;
}

OAIDateRange OAIContext::getDateRange() const {
    return m_date_range;
}
void OAIContext::setDateRange(const OAIDateRange &date_range) {
    m_date_range = date_range;
    m_date_range_isSet = true;
}

bool OAIContext::is_date_range_Set() const{
    return m_date_range_isSet;
}

bool OAIContext::is_date_range_Valid() const{
    return m_date_range_isValid;
}

OAIObject OAIContext::getInternalCategories() const {
    return m_internal_categories;
}
void OAIContext::setInternalCategories(const OAIObject &internal_categories) {
    m_internal_categories = internal_categories;
    m_internal_categories_isSet = true;
}

bool OAIContext::is_internal_categories_Set() const{
    return m_internal_categories_isSet;
}

bool OAIContext::is_internal_categories_Valid() const{
    return m_internal_categories_isValid;
}

OAIMarkupRange OAIContext::getMarkupRange() const {
    return m_markup_range;
}
void OAIContext::setMarkupRange(const OAIMarkupRange &markup_range) {
    m_markup_range = markup_range;
    m_markup_range_isSet = true;
}

bool OAIContext::is_markup_range_Set() const{
    return m_markup_range_isSet;
}

bool OAIContext::is_markup_range_Valid() const{
    return m_markup_range_isValid;
}

OAIObject OAIContext::getStockStatuses() const {
    return m_stock_statuses;
}
void OAIContext::setStockStatuses(const OAIObject &stock_statuses) {
    m_stock_statuses = stock_statuses;
    m_stock_statuses_isSet = true;
}

bool OAIContext::is_stock_statuses_Set() const{
    return m_stock_statuses_isSet;
}

bool OAIContext::is_stock_statuses_Valid() const{
...
bool OAIContext::isValid() const {
    ...
    return m_brands_isValid && m_categories_isValid && m_date_range_isValid && m_markup_range_isValid && true;
}
