...
#ifndef OAIRules_inner_H
#define OAIRules_inner_H
...
class OAIRules_inner : public OAIObject {
public:
    OAIRules_inner();
    OAIRules_inner(QString json);
    ~OAIRules_inner() override;
    ...
    double getPercentualModifier() const;
    void setPercentualModifier(const double &percentual_modifier);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRules_inner)

#endif // OAIRules_inner_H
