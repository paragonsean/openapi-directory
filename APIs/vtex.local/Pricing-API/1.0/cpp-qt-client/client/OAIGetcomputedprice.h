...
/*
 * OAIGetcomputedprice.h
 *
 * 
 */

#ifndef OAIGetcomputedprice_H
#define OAIGetcomputedprice_H
...
class OAIGetcomputedprice : public OAIObject {
public:
    OAIGetcomputedprice();
    OAIGetcomputedprice(QString json);
    ~OAIGetcomputedprice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetcomputedprice)

#endif // OAIGetcomputedprice_H
