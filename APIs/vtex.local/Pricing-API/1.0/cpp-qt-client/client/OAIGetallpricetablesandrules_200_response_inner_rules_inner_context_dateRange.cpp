...
OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange() {
    this->initializeModel();
}

OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::~OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange() {}

void OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::initializeModel() {
...
void OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::fromJson(QString jsonString) {
...
void OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::fromJsonObject(QJsonObject json) {
...
QString OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::asJson() const {
...
QJsonObject OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::asJsonObject() const {
    QJsonObject obj;
    if (m_from_isSet) {
...
QString OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::getFrom() const {
    return m_from;
}
void OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::setFrom(const QString &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::is_from_Set() const{
    return m_from_isSet;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::is_from_Valid() const{
    return m_from_isValid;
}

QString OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::getTo() const {
    return m_to;
}
void OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::setTo(const QString &to) {
    m_to = to;
    m_to_isSet = true;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::is_to_Set() const{
    return m_to_isSet;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::is_to_Valid() const{
    return m_to_isValid;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::isSet() const {
...
bool OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange::isValid() const {
