...
#ifndef OAIFixedPrices_H
#define OAIFixedPrices_H

#include <QJsonObject>

#include "OAIDateRange_1.h"
#include <QString>
...
namespace OpenAPI {
class OAIDateRange_1;

class OAIFixedPrices : public OAIObject {
public:
    OAIFixedPrices();
    OAIFixedPrices(QString json);
    ~OAIFixedPrices() override;
    ...
    OAIDateRange_1 getDateRange() const;
    void setDateRange(const OAIDateRange_1 &date_range);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFixedPrices)

#endif // OAIFixedPrices_H
