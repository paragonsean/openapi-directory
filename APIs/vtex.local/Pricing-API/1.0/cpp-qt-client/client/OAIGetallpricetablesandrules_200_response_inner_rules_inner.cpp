...
OAIGetallpricetablesandrules_200_response_inner_rules_inner::OAIGetallpricetablesandrules_200_response_inner_rules_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetallpricetablesandrules_200_response_inner_rules_inner::OAIGetallpricetablesandrules_200_response_inner_rules_inner() {
    this->initializeModel();
}

OAIGetallpricetablesandrules_200_response_inner_rules_inner::~OAIGetallpricetablesandrules_200_response_inner_rules_inner() {}

void OAIGetallpricetablesandrules_200_response_inner_rules_inner::initializeModel() {
...
void OAIGetallpricetablesandrules_200_response_inner_rules_inner::fromJson(QString jsonString) {
...
void OAIGetallpricetablesandrules_200_response_inner_rules_inner::fromJsonObject(QJsonObject json) {
...
QString OAIGetallpricetablesandrules_200_response_inner_rules_inner::asJson() const {
...
QJsonObject OAIGetallpricetablesandrules_200_response_inner_rules_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_context.isSet()) {
...
OAIGetallpricetablesandrules_200_response_inner_rules_inner_context OAIGetallpricetablesandrules_200_response_inner_rules_inner::getContext() const {
    return m_context;
}
void OAIGetallpricetablesandrules_200_response_inner_rules_inner::setContext(const OAIGetallpricetablesandrules_200_response_inner_rules_inner_context &context) {
    m_context = context;
    m_context_isSet = true;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner::is_context_Set() const{
    return m_context_isSet;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner::is_context_Valid() const{
    return m_context_isValid;
}

double OAIGetallpricetablesandrules_200_response_inner_rules_inner::getId() const {
    return m_id;
}
void OAIGetallpricetablesandrules_200_response_inner_rules_inner::setId(const double &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner::isSet() const {
...
bool OAIGetallpricetablesandrules_200_response_inner_rules_inner::isValid() const {
