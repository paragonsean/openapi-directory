...
#ifndef OAIMarkupRange_H
#define OAIMarkupRange_H
...
class OAIMarkupRange : public OAIObject {
public:
    OAIMarkupRange();
    OAIMarkupRange(QString json);
    ~OAIMarkupRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarkupRange)

#endif // OAIMarkupRange_H
