...
/*
 * OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange.h
 *
 * The rule will be active during this time range.
 */

#ifndef OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange_H
#define OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange_H
...
class OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange : public OAIObject {
public:
    OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange();
    OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange(QString json);
    ~OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange)

#endif // OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_dateRange_H
