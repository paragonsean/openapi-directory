...
#ifndef OAIFixedPrice_H
#define OAIFixedPrice_H
...
class OAIFixedPrice : public OAIObject {
public:
    OAIFixedPrice();
    OAIFixedPrice(QString json);
    ~OAIFixedPrice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFixedPrice)

#endif // OAIFixedPrice_H
