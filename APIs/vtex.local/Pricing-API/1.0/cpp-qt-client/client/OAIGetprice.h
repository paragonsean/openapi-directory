...
#ifndef OAIGetprice_H
#define OAIGetprice_H
...
class OAIGetprice : public OAIObject {
public:
    OAIGetprice();
    OAIGetprice(QString json);
    ~OAIGetprice() override;
    ...
    qint32 getBasePrice() const;
    void setBasePrice(const qint32 &base_price);
    ...
    QList<OAIFixedPrice> getFixedPrices() const;
    void setFixedPrices(const QList<OAIFixedPrice> &fixed_prices);
...
private:
    ...
    QList<OAIFixedPrice> m_fixed_prices;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetprice)
