...
OAIMarkupRange::OAIMarkupRange(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMarkupRange::OAIMarkupRange() {
    this->initializeModel();
}

OAIMarkupRange::~OAIMarkupRange() {}

void OAIMarkupRange::initializeModel() {
...
void OAIMarkupRange::fromJson(QString jsonString) {
...
void OAIMarkupRange::fromJsonObject(QJsonObject json) {
...
QString OAIMarkupRange::asJson() const {
...
QJsonObject OAIMarkupRange::asJsonObject() const {
    QJsonObject obj;
    if (m_from_isSet) {
...
qint32 OAIMarkupRange::getFrom() const {
    return m_from;
}
void OAIMarkupRange::setFrom(const qint32 &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAIMarkupRange::is_from_Set() const{
    return m_from_isSet;
}

bool OAIMarkupRange::is_from_Valid() const{
    return m_from_isValid;
}

qint32 OAIMarkupRange::getTo() const {
    return m_to;
}
void OAIMarkupRange::setTo(const qint32 &to) {
    m_to = to;
    m_to_isSet = true;
}

bool OAIMarkupRange::is_to_Set() const{
    return m_to_isSet;
}

bool OAIMarkupRange::is_to_Valid() const{
    return m_to_isValid;
}

bool OAIMarkupRange::isSet() const {
...
bool OAIMarkupRange::isValid() const {
