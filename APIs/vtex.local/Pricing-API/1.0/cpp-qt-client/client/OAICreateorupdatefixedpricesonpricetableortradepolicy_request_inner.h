...
/*
 * OAICreateorupdatefixedpricesonpricetableortradepolicy_request_inner.h
 *
 * 
 */

#ifndef OAICreateorupdatefixedpricesonpricetableortradepolicy_request_inner_H
#define OAICreateorupdatefixedpricesonpricetableortradepolicy_request_inner_H
...
namespace OpenAPI {
class OAIDateRange_2;

class OAICreateorupdatefixedpricesonpricetableortradepolicy_request_inner : public OAIObject {
public:
    OAICreateorupdatefixedpricesonpricetableortradepolicy_request_inner();
    OAICreateorupdatefixedpricesonpricetableortradepolicy_request_inner(QString json);
    ~OAICreateorupdatefixedpricesonpricetableortradepolicy_request_inner() override;
    ...
    OAIDateRange_2 getDateRange() const;
    void setDateRange(const OAIDateRange_2 &date_range);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateorupdatefixedpricesonpricetableortradepolicy_request_inner)

#endif // OAICreateorupdatefixedpricesonpricetableortradepolicy_request_inner_H
