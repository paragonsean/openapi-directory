...
OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange() {
    this->initializeModel();
}

OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::~OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange() {}

void OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::initializeModel() {
...
void OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::fromJson(QString jsonString) {
...
void OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::fromJsonObject(QJsonObject json) {
...
QString OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::asJson() const {
...
QJsonObject OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::asJsonObject() const {
    QJsonObject obj;
    if (m_from_isSet) {
...
qint32 OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::getFrom() const {
    return m_from;
}
void OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::setFrom(const qint32 &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::is_from_Set() const{
    return m_from_isSet;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::is_from_Valid() const{
    return m_from_isValid;
}

qint32 OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::getTo() const {
    return m_to;
}
void OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::setTo(const qint32 &to) {
    m_to = to;
    m_to_isSet = true;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::is_to_Set() const{
    return m_to_isSet;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::is_to_Valid() const{
    return m_to_isValid;
}

bool OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::isSet() const {
...
bool OAIGetallpricetablesandrules_200_response_inner_rules_inner_context_markupRange::isValid() const {
