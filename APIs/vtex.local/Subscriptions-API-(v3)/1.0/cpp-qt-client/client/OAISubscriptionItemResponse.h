...
/*
 * OAISubscriptionItemResponse.h
 *
 * 
 */

#ifndef OAISubscriptionItemResponse_H
#define OAISubscriptionItemResponse_H
...
class OAISubscriptionItemResponse : public OAIObject {
public:
    OAISubscriptionItemResponse();
    OAISubscriptionItemResponse(QString json);
    ~OAISubscriptionItemResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscriptionItemResponse)

#endif // OAISubscriptionItemResponse_H
