...
OAIPaymentMethodThinRequest::OAIPaymentMethodThinRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentMethodThinRequest::OAIPaymentMethodThinRequest() {
    this->initializeModel();
}

OAIPaymentMethodThinRequest::~OAIPaymentMethodThinRequest() {}

void OAIPaymentMethodThinRequest::initializeModel() {
...
void OAIPaymentMethodThinRequest::fromJson(QString jsonString) {
...
void OAIPaymentMethodThinRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentMethodThinRequest::asJson() const {
...
QJsonObject OAIPaymentMethodThinRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIPaymentMethodThinRequest::getInstallments() const {
    return m_installments;
}
void OAIPaymentMethodThinRequest::setInstallments(const qint32 &installments) {
    m_installments = installments;
    m_installments_isSet = true;
}

bool OAIPaymentMethodThinRequest::is_installments_Set() const{
    return m_installments_isSet;
}

bool OAIPaymentMethodThinRequest::is_installments_Valid() const{
    return m_installments_isValid;
}

QString OAIPaymentMethodThinRequest::getPaymentAccountId() const {
    return m_payment_account_id;
}
void OAIPaymentMethodThinRequest::setPaymentAccountId(const QString &payment_account_id) {
    m_payment_account_id = payment_account_id;
    m_payment_account_id_isSet = true;
}

bool OAIPaymentMethodThinRequest::is_payment_account_id_Set() const{
    return m_payment_account_id_isSet;
}

bool OAIPaymentMethodThinRequest::is_payment_account_id_Valid() const{
    return m_payment_account_id_isValid;
}

QString OAIPaymentMethodThinRequest::getPaymentSystem() const {
    return m_payment_system;
}
void OAIPaymentMethodThinRequest::setPaymentSystem(const QString &payment_system) {
    m_payment_system = payment_system;
    m_payment_system_isSet = true;
}

bool OAIPaymentMethodThinRequest::is_payment_system_Set() const{
    return m_payment_system_isSet;
}

bool OAIPaymentMethodThinRequest::is_payment_system_Valid() const{
    return m_payment_system_isValid;
}

bool OAIPaymentMethodThinRequest::isSet() const {
...
bool OAIPaymentMethodThinRequest::isValid() const {
