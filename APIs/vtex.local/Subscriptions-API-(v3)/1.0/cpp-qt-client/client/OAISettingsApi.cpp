...
void OAISettingsApi::editSettings(const QString &content_type, const QString &accept, const OAISettings &oai_settings) {
    QString fullPath = QString(_serverConfigs["editSettings"][_serverIndices.value("editSettings")].URL()+"/api/rns/settings");
...
void OAISettingsApi::getSettings(const QString &content_type, const QString &accept) {
    QString fullPath = QString(_serverConfigs["getSettings"][_serverIndices.value("getSettings")].URL()+"/api/rns/settings");
