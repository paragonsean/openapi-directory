...
void OAIPlansApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("apiRnsPvtPlansGet", defaultConf);
    _serverIndices.insert("apiRnsPvtPlansGet", 0);
    _serverConfigs.insert("apiRnsPvtPlansIdGet", defaultConf);
    _serverIndices.insert("apiRnsPvtPlansIdGet", 0);
}
...
void OAIPlansApi::apiRnsPvtPlansGet(const QString &content_type, const QString &accept, const ::OpenAPI::OptionalParam<QString> &periodicity, const ::OpenAPI::OptionalParam<QString> &interval, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &size) {
    QString fullPath = QString(_serverConfigs["apiRnsPvtPlansGet"][_serverIndices.value("apiRnsPvtPlansGet")].URL()+"/api/rns/pvt/plans");
    ...
    if (periodicity.hasValue())
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "periodicity", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("periodicity")).append(querySuffix).append(QUrl::toPercentEncoding(periodicity.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPlansApi::apiRnsPvtPlansGetCallback);
...
void OAIPlansApi::apiRnsPvtPlansGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiRnsPvtPlansGetSignal(output);
        Q_EMIT apiRnsPvtPlansGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiRnsPvtPlansGetSignalE(output, error_type, error_str);
        Q_EMIT apiRnsPvtPlansGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiRnsPvtPlansGetSignalError(output, error_type, error_str);
        Q_EMIT apiRnsPvtPlansGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPlansApi::apiRnsPvtPlansIdGet(const QString &id, const QString &content_type, const QString &accept) {
    QString fullPath = QString(_serverConfigs["apiRnsPvtPlansIdGet"][_serverIndices.value("apiRnsPvtPlansIdGet")].URL()+"/api/rns/pvt/plans/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPlansApi::apiRnsPvtPlansIdGetCallback);
    connect(this, &OAIPlansApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPlansApi::apiRnsPvtPlansIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIStorePlan output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiRnsPvtPlansIdGetSignal(output);
        Q_EMIT apiRnsPvtPlansIdGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiRnsPvtPlansIdGetSignalE(output, error_type, error_str);
        Q_EMIT apiRnsPvtPlansIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiRnsPvtPlansIdGetSignalError(output, error_type, error_str);
        Q_EMIT apiRnsPvtPlansIdGetSignalErrorFull(worker, error_type, error_str);
    }
}
