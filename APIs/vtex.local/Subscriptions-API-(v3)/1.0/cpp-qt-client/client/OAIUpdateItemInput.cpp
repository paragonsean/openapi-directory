...
bool OAIUpdateItemInput::isIsSkipped() const {
    return m_is_skipped;
}
void OAIUpdateItemInput::setIsSkipped(const bool &is_skipped) {
    m_is_skipped = is_skipped;
    m_is_skipped_isSet = true;
}

bool OAIUpdateItemInput::is_is_skipped_Set() const{
    return m_is_skipped_isSet;
}

bool OAIUpdateItemInput::is_is_skipped_Valid() const{
    return m_is_skipped_isValid;
}

qint32 OAIUpdateItemInput::getManualPrice() const {
    return m_manual_price;
}
void OAIUpdateItemInput::setManualPrice(const qint32 &manual_price) {
    m_manual_price = manual_price;
    m_manual_price_isSet = true;
}

bool OAIUpdateItemInput::is_manual_price_Set() const{
    return m_manual_price_isSet;
}

bool OAIUpdateItemInput::is_manual_price_Valid() const{
    return m_manual_price_isValid;
}

qint32 OAIUpdateItemInput::getQuantity() const {
    return m_quantity;
}
void OAIUpdateItemInput::setQuantity(const qint32 &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIUpdateItemInput::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIUpdateItemInput::is_quantity_Valid() const{
    return m_quantity_isValid;
}

QString OAIUpdateItemInput::getStatus() const {
    return m_status;
}
void OAIUpdateItemInput::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateItemInput::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateItemInput::is_status_Valid() const{
