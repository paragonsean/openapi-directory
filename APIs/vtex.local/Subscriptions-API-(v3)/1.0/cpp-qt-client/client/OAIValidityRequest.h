...
/*
 * OAIValidityRequest.h
 *
 * Information about the period during which the subscription will be valid.
 */

#ifndef OAIValidityRequest_H
#define OAIValidityRequest_H
...
class OAIValidityRequest : public OAIObject {
public:
    OAIValidityRequest();
    OAIValidityRequest(QString json);
    ~OAIValidityRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidityRequest)

#endif // OAIValidityRequest_H
