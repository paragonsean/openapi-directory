...
class ShippingAddress {
     ...
     * @param addressType {String} Type of the address. Possible values are `residential` or `pickup`.
     */
    constructor(addressId, addressType) { 
        
        ShippingAddress.initialize(this, addressId, addressType);
    }
...
ShippingAddress.RequiredProperties = ["addressId", "addressType"];
