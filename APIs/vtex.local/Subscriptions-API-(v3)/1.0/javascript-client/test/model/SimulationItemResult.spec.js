...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV3.SimulationItemResult();
  });
  ...
  describe('SimulationItemResult', function() {
    it('should create an instance of SimulationItemResult', function() {
      // uncomment below and update the code to test SimulationItemResult
      //var instance = new SubscriptionsApiV3.SimulationItemResult();
      //expect(instance).to.be.a(SubscriptionsApiV3.SimulationItemResult);
    });
