...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV3.FrequencyRequest();
  });
  ...
  describe('FrequencyRequest', function() {
    it('should create an instance of FrequencyRequest', function() {
      ...
      //var instance = new SubscriptionsApiV3.FrequencyRequest();
      //expect(instance).to.be.a(SubscriptionsApiV3.FrequencyRequest);
    });
