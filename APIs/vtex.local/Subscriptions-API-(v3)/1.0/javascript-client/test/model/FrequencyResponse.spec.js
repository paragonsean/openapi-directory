...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV3.FrequencyResponse();
  });
  ...
  describe('FrequencyResponse', function() {
    it('should create an instance of FrequencyResponse', function() {
      ...
      //var instance = new SubscriptionsApiV3.FrequencyResponse();
      //expect(instance).to.be.a(SubscriptionsApiV3.FrequencyResponse);
    });
