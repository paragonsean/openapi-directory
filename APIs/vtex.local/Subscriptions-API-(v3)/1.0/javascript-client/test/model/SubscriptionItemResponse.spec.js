...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV3.SubscriptionItemResponse();
  });
  ...
  describe('SubscriptionItemResponse', function() {
    it('should create an instance of SubscriptionItemResponse', function() {
      // uncomment below and update the code to test SubscriptionItemResponse
      //var instance = new SubscriptionsApiV3.SubscriptionItemResponse();
      //expect(instance).to.be.a(SubscriptionsApiV3.SubscriptionItemResponse);
    });
