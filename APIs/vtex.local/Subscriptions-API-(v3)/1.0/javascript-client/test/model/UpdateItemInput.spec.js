...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV3.UpdateItemInput();
  });
  ...
  describe('UpdateItemInput', function() {
    it('should create an instance of UpdateItemInput', function() {
      ...
      //var instance = new SubscriptionsApiV3.UpdateItemInput();
      //expect(instance).to.be.a(SubscriptionsApiV3.UpdateItemInput);
    });
