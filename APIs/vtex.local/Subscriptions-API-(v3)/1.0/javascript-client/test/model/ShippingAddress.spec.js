...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV3.ShippingAddress();
  });
  ...
  describe('ShippingAddress', function() {
    it('should create an instance of ShippingAddress', function() {
      ...
      //var instance = new SubscriptionsApiV3.ShippingAddress();
      //expect(instance).to.be.a(SubscriptionsApiV3.ShippingAddress);
    });
