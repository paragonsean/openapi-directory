...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV3.LogisticsInfoSLA();
  });
  ...
  describe('LogisticsInfoSLA', function() {
    it('should create an instance of LogisticsInfoSLA', function() {
      // uncomment below and update the code to test LogisticsInfoSLA
      //var instance = new SubscriptionsApiV3.LogisticsInfoSLA();
      //expect(instance).to.be.a(SubscriptionsApiV3.LogisticsInfoSLA);
    });
