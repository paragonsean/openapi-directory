...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV3.PaymentMethodThinRequest();
  });
  ...
  describe('PaymentMethodThinRequest', function() {
    it('should create an instance of PaymentMethodThinRequest', function() {
      // uncomment below and update the code to test PaymentMethodThinRequest
      //var instance = new SubscriptionsApiV3.PaymentMethodThinRequest();
      //expect(instance).to.be.a(SubscriptionsApiV3.PaymentMethodThinRequest);
    });
