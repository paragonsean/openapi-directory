...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV3.ShippingAddressResponse();
  });
  ...
  describe('ShippingAddressResponse', function() {
    it('should create an instance of ShippingAddressResponse', function() {
      // uncomment below and update the code to test ShippingAddressResponse
      //var instance = new SubscriptionsApiV3.ShippingAddressResponse();
      //expect(instance).to.be.a(SubscriptionsApiV3.ShippingAddressResponse);
    });
