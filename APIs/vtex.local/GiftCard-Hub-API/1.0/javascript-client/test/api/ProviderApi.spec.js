...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiftCardHubApi.ProviderApi();
  });
  ...
  describe('ProviderApi', function() {
    describe('createUpdateGiftCardProviderbyID', function() {
      it('should call createUpdateGiftCardProviderbyID successfully', function(done) {
        //uncomment below and update the code to test createUpdateGiftCardProviderbyID
        //instance.createUpdateGiftCardProviderbyID(function(error) {
    ...
    describe('deleteGiftCardProviderbyID', function() {
      it('should call deleteGiftCardProviderbyID successfully', function(done) {
        //uncomment below and update the code to test deleteGiftCardProviderbyID
        //instance.deleteGiftCardProviderbyID(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getGiftCardProviderbyID', function() {
      it('should call getGiftCardProviderbyID successfully', function(done) {
        //uncomment below and update the code to test getGiftCardProviderbyID
        //instance.getGiftCardProviderbyID(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listAllGiftCardProviders', function() {
      it('should call listAllGiftCardProviders successfully', function(done) {
        //uncomment below and update the code to test listAllGiftCardProviders
        //instance.listAllGiftCardProviders(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
