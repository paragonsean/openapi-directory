...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiftCardHubApi.CreateGiftCardCancellationTransactionRequest();
  });
  ...
  describe('CreateGiftCardCancellationTransactionRequest', function() {
    it('should create an instance of CreateGiftCardCancellationTransactionRequest', function() {
      // uncomment below and update the code to test CreateGiftCardCancellationTransactionRequest
      //var instance = new GiftCardHubApi.CreateGiftCardCancellationTransactionRequest();
      //expect(instance).to.be.a(GiftCardHubApi.CreateGiftCardCancellationTransactionRequest);
    });
