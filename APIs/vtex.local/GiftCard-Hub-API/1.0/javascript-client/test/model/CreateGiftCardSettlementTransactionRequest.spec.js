...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiftCardHubApi.CreateGiftCardSettlementTransactionRequest();
  });
  ...
  describe('CreateGiftCardSettlementTransactionRequest', function() {
    it('should create an instance of CreateGiftCardSettlementTransactionRequest', function() {
      // uncomment below and update the code to test CreateGiftCardSettlementTransactionRequest
      //var instance = new GiftCardHubApi.CreateGiftCardSettlementTransactionRequest();
      //expect(instance).to.be.a(GiftCardHubApi.CreateGiftCardSettlementTransactionRequest);
    });
