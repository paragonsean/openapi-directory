...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiftCardHubApi.CreateGiftCardTransactionRequest();
  });
  ...
  describe('CreateGiftCardTransactionRequest', function() {
    it('should create an instance of CreateGiftCardTransactionRequest', function() {
      ...
      //var instance = new GiftCardHubApi.CreateGiftCardTransactionRequest();
      //expect(instance).to.be.a(GiftCardHubApi.CreateGiftCardTransactionRequest);
    });
