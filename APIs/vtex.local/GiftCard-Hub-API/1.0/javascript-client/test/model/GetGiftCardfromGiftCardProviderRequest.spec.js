...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiftCardHubApi.GetGiftCardfromGiftCardProviderRequest();
  });
  ...
  describe('GetGiftCardfromGiftCardProviderRequest', function() {
    it('should create an instance of GetGiftCardfromGiftCardProviderRequest', function() {
      // uncomment below and update the code to test GetGiftCardfromGiftCardProviderRequest
      //var instance = new GiftCardHubApi.GetGiftCardfromGiftCardProviderRequest();
      //expect(instance).to.be.a(GiftCardHubApi.GetGiftCardfromGiftCardProviderRequest);
    });
