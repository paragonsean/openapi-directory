...
public class Cart2 {
  ...
  public Cart2 discounts(Integer discounts) {
  ...
  public Cart2 grandTotal(Integer grandTotal) {
  ...
  public Cart2 items(List<Item> items) {
    this.items = items;
    return this;
  }

  public Cart2 addItemsItem(Item itemsItem) {
    if (this.items == null) {
  ...
  public Cart2 itemsTotal(Integer itemsTotal) {
  ...
  public Cart2 redemptionCode(String redemptionCode) {
  ...
  public Cart2 relationName(String relationName) {
  ...
  public Cart2 shipping(Integer shipping) {
  ...
  public Cart2 taxes(Integer taxes) {
    this.taxes = taxes;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Cart2 cart2 = (Cart2) o;
    return Objects.equals(this.discounts, cart2.discounts) &&
        Objects.equals(this.grandTotal, cart2.grandTotal) &&
        Objects.equals(this.items, cart2.items) &&
        Objects.equals(this.itemsTotal, cart2.itemsTotal) &&
        Objects.equals(this.redemptionCode, cart2.redemptionCode) &&
        Objects.equals(this.relationName, cart2.relationName) &&
        Objects.equals(this.shipping, cart2.shipping) &&
        Objects.equals(this.taxes, cart2.taxes);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cart2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cart2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cart2 is not found in the empty JSON string", Cart2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cart2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cart2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Cart2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cart2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cart2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cart2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cart2.class));

       return (TypeAdapter<T>) new TypeAdapter<Cart2>() {
           @Override
           public void write(JsonWriter out, Cart2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cart2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cart2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cart2
   * @throws IOException if the JSON string is invalid with respect to Cart2
   */
  public static Cart2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cart2.class);
  }

  /**
   * Convert an instance of Cart2 to an JSON string
   *
   * @return JSON string
   */
