...
class CreateGiftCardTransactionRequest(Model):
    ...
    def __init__(self, description: str=None, operation: str=None, order_info: OrderInfo=None, redemption_code: str=None, redemption_token: str=None, request_id: str=None, value: float=None):
    ...
    def order_info(self, order_info):
        ...
        if order_info is None:
            raise ValueError("Invalid value for `order_info`, must not be `None`")
