...
```javascript
import SkuBindingsApi from 'sku_bindings_api';
let defaultClient = SkuBindingsApi.ApiClient.instance;
...
let apiInstance = new SkuBindingsApi.SKUBindingsApi();
let contentType = "'application/json'"; // String | Describes the type of the content being sent.
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let sellerId = "vtxkfj7352"; // String | ID that identifies the seller in the marketplace. It can be the same as the seller name or a unique number. Check the **Sellers management** section in the Admin to get the correct ID.
let skuSellerId = "71"; // String | SKU ID in the seller's store.
apiInstance.activateSKUBinding(contentType, accept, sellerId, skuSellerId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> bindtoanothersku(contentType, accept, sellerId, sellerSkuId, opts)
...
let opts = {
  'bindtoanotherskuRequest': new SkuBindingsApi.BindtoanotherskuRequest() // BindtoanotherskuRequest | Request body
};
apiInstance.bindtoanothersku(contentType, accept, sellerId, sellerSkuId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let sellerId = "vtxkfj7352"; // String | ID that identifies the seller in the marketplace. It can be the same as the seller name or a unique number. Check the **Sellers management** section in the Admin to get the correct ID.
let skuSellerId = "71"; // String | SKU ID in the seller's store.
apiInstance.deactivateSKUBinding(contentType, accept, sellerId, skuSellerId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let sellerId = "vtxkfj7352"; // String | ID that identifies the seller in the marketplace. It can be the same as the seller name or a unique number. Check the **Sellers management** section in the Admin to get the correct ID.
let sellerSkuId = "71"; // String | SKU ID in the seller's store.
...
> [GetallbySellerId200ResponseInner] getallbySellerId(contentType, accept, sellerId)
...
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let sellerId = "vtxkfj7352"; // String | ID that identifies the seller in the marketplace. It can be the same as the seller name or a unique number. Check the **Sellers management** section in the Admin to get the correct ID.
apiInstance.getallbySellerId(contentType, accept, sellerId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
[**[GetallbySellerId200ResponseInner]**](GetallbySellerId200ResponseInner.md)
...
> [GetbySkuId200ResponseInner] getbySkuId(contentType, accept, skuId)
...
let contentType = "'application/json'"; // String | Describes the type of the content being sent.
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let skuId = "1"; // String | SKU's unique identifier in the marketplace.
apiInstance.getbySkuId(contentType, accept, skuId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
[**[GetbySkuId200ResponseInner]**](GetbySkuId200ResponseInner.md)
...
> Getpagedadmin200Response getpagedadmin(contentType, accept, opts)
...
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let opts = {
  'sellerId': "vtxkfj7352", // String | ID that identifies the seller in the marketplace. It can be the same as the seller name or a unique number. Check the **Sellers management** section in the Admin to get the correct ID.
  'skuId': "1", // String | SKU's unique identifier in the marketplace.
  'sellerSkuId': "71", // String | SKU ID in the seller's store.
  'isActive': true, // Boolean | Defines if the SKU binding is active.
  'size': "1" // String | Amount of results.
};
apiInstance.getpagedadmin(contentType, accept, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [GetallbySellerId200ResponseInner] getpagedbySellerId(page, size, contentType, accept, sellerId)
...
let apiInstance = new SkuBindingsApi.SKUBindingsApi();
let page = "1"; // String | Page number.
let size = "2"; // String | Amount of results per page.
let contentType = "'application/json'"; // String | Describes the type of the content being sent.
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let sellerId = "vtxkfj7352"; // String | ID that identifies the seller in the marketplace. It can be the same as the seller name or a unique number. Check the **Sellers management** section in the Admin to get the correct ID.
apiInstance.getpagedbySellerId(page, size, contentType, accept, sellerId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let contentType = "'application/json'"; // String | Describes the type of the content being sent.
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let insertSKUBindingRequest = {"IsActive":true,"SellerId":"vtxkfj7352","SellerStockKeepingUnitId":"71","StockKeepingUnitId":1}; // InsertSKUBindingRequest | Request body
apiInstance.insertSKUBinding(contentType, accept, insertSKUBindingRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.skuBindingPvtSkusellerChangenotificationSellerIdSellerSkuIdPost(contentType, accept, sellerId, sellerSkuId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
