...
public class Getpagedadmin200Response {
  ...
  public Getpagedadmin200Response() {
  }

  public Getpagedadmin200Response isActive(Boolean isActive) {
  ...
  public Getpagedadmin200Response isPersisted(Boolean isPersisted) {
  ...
  public Getpagedadmin200Response isRemoved(Boolean isRemoved) {
  ...
  public Getpagedadmin200Response requestedUpdateDate(String requestedUpdateDate) {
  ...
  public Getpagedadmin200Response sellerId(String sellerId) {
  ...
  public Getpagedadmin200Response sellerStockKeepingUnitId(String sellerStockKeepingUnitId) {
  ...
  public Getpagedadmin200Response skuSellerId(Integer skuSellerId) {
  ...
  public Getpagedadmin200Response stockKeepingUnitId(Integer stockKeepingUnitId) {
  ...
  public Getpagedadmin200Response updateDate(String updateDate) {
  ...
  public boolean equals(Object o) {
    ...
    Getpagedadmin200Response getpagedadmin200Response = (Getpagedadmin200Response) o;
    return Objects.equals(this.isActive, getpagedadmin200Response.isActive) &&
        Objects.equals(this.isPersisted, getpagedadmin200Response.isPersisted) &&
        Objects.equals(this.isRemoved, getpagedadmin200Response.isRemoved) &&
        Objects.equals(this.requestedUpdateDate, getpagedadmin200Response.requestedUpdateDate) &&
        Objects.equals(this.sellerId, getpagedadmin200Response.sellerId) &&
        Objects.equals(this.sellerStockKeepingUnitId, getpagedadmin200Response.sellerStockKeepingUnitId) &&
        Objects.equals(this.skuSellerId, getpagedadmin200Response.skuSellerId) &&
        Objects.equals(this.stockKeepingUnitId, getpagedadmin200Response.stockKeepingUnitId) &&
        Objects.equals(this.updateDate, getpagedadmin200Response.updateDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class Getpagedadmin200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Getpagedadmin200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Getpagedadmin200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Getpagedadmin200Response is not found in the empty JSON string", Getpagedadmin200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Getpagedadmin200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Getpagedadmin200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Getpagedadmin200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Getpagedadmin200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Getpagedadmin200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Getpagedadmin200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Getpagedadmin200Response>() {
           @Override
           public void write(JsonWriter out, Getpagedadmin200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Getpagedadmin200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Getpagedadmin200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Getpagedadmin200Response
   * @throws IOException if the JSON string is invalid with respect to Getpagedadmin200Response
   */
  public static Getpagedadmin200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Getpagedadmin200Response.class);
  }

  /**
   * Convert an instance of Getpagedadmin200Response to an JSON string
   *
   * @return JSON string
   */
