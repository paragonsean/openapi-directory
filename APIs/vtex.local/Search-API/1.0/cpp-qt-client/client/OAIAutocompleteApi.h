...
public:
    ...
    * @param[in]  product_name_contains QString [required]
    */
    virtual void autoComplete(const QString &content_type, const QString &accept, const QString &product_name_contains);
...
Q_SIGNALS:
    ...
    void autoCompleteSignal(OAIThe_root_schema summary);


    void autoCompleteSignalFull(OAIHttpRequestWorker *worker, OAIThe_root_schema summary);

    Q_DECL_DEPRECATED_X("Use autoCompleteSignalError() instead")
    void autoCompleteSignalE(OAIThe_root_schema summary, QNetworkReply::NetworkError error_type, QString error_str);
    void autoCompleteSignalError(OAIThe_root_schema summary, QNetworkReply::NetworkError error_type, const QString &error_str);
