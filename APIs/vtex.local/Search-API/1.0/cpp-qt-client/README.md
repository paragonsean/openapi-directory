...
void Example::exampleFunction1(){
     OAIAutocompleteApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAutocompleteApi::autoCompleteSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAutocompleteApi::autoCompleteSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      QString product_name_contains = create(); // QString | Part of the string that will be searched.
      apiInstance.autoComplete(content_typeacceptproduct_name_contains);
