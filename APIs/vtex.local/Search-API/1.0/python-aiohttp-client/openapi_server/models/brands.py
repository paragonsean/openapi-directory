...
class Brands(Model):
    ...
    def __init__(self, displayed_items: int=None, total_items: int=None):
        """Brands - a model defined in OpenAPI

        :param displayed_items: The displayed_items of this Brands.
        :param total_items: The total_items of this Brands.
        """
        self.openapi_types = {
            'displayed_items': int,
            'total_items': int
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Brands':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Brands of this Brands.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def displayed_items(self):
        """Gets the displayed_items of this Brands.

        Quantity of displayed items.

        :return: The displayed_items of this Brands.
        :rtype: int
        """
    ...
    def displayed_items(self, displayed_items):
        """Sets the displayed_items of this Brands.
    ...
    def total_items(self):
        """Gets the total_items of this Brands.

        Quantity of total items.

        :return: The total_items of this Brands.
        :rtype: int
        """
    ...
    def total_items(self, total_items):
        """Sets the total_items of this Brands.
