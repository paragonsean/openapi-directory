...
class Department(Model):
    ...
    def __init__(self, link: str=None, name: str=None, quantity: int=None):
        ...
        :param link: The link of this Department.
        :param name: The name of this Department.
        :param quantity: The quantity of this Department.
        """
        self.openapi_types = {
            'link': str,
            'name': str,
    ...
    @property
    def link(self):
        """Gets the link of this Department.


        :return: The link of this Department.
        :rtype: str
        """
        return self._link
    ...
    @link.setter
    def link(self, link):
        """Sets the link of this Department.
    ...
    @property
    def quantity(self):
        """Gets the quantity of this Department.


        :return: The quantity of this Department.
        :rtype: int
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this Department.
