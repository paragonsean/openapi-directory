...
import org.openapitools.client.model.Child1;
...
public class Child {
  ...
  public Child children(List<Child1> children) {
    this.children = children;
    return this;
  }

  public Child addChildrenItem(Child1 childrenItem) {
  ...
  public void setChildren(List<Child1> children) {
    this.children = children;
  }


  public Child link(String link) {
    this.link = link;
    return this;
  }
  ...
  public Child quantity(Integer quantity) {
  ...
  public boolean equals(Object o) {
    ...
    Child child = (Child) o;
    return Objects.equals(this.children, child.children) &&
        Objects.equals(this.link, child.link) &&
        Objects.equals(this.name, child.name) &&
        Objects.equals(this.quantity, child.quantity);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Child.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraychildren.size(); i++) {
        Child1.validateJsonElement(jsonArraychildren.get(i));
      };
