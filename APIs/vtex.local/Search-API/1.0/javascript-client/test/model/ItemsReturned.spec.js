...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegacySearchApi.ItemsReturned();
  });
  ...
  describe('ItemsReturned', function() {
    it('should create an instance of ItemsReturned', function() {
      // uncomment below and update the code to test ItemsReturned
      //var instance = new LegacySearchApi.ItemsReturned();
      //expect(instance).to.be.a(LegacySearchApi.ItemsReturned);
    });
