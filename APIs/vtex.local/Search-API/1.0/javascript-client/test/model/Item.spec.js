...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegacySearchApi.Item();
  });
  ...
  describe('Item', function() {
    it('should create an instance of Item', function() {
      ...
      //var instance = new LegacySearchApi.Item();
      //expect(instance).to.be.a(LegacySearchApi.Item);
    });

    it('should have the property COR (base name: "COR")', function() {
      // uncomment below and update the code to test the property COR
      //var instance = new LegacySearchApi.Item();
      //expect(instance).to.be();
    });

    it('should have the property TAMANHO (base name: "TAMANHO")', function() {
      // uncomment below and update the code to test the property TAMANHO
      //var instance = new LegacySearchApi.Item();
      //expect(instance).to.be();
    });
