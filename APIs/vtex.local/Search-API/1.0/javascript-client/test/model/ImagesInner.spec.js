...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegacySearchApi.ImagesInner();
  });
  ...
  describe('ImagesInner', function() {
    it('should create an instance of ImagesInner', function() {
      ...
      //var instance = new LegacySearchApi.ImagesInner();
      //expect(instance).to.be.a(LegacySearchApi.ImagesInner);
    });
    ...
    it('should have the property imageLastModified (base name: "imageLastModified")', function() {
      // uncomment below and update the code to test the property imageLastModified
      //var instance = new LegacySearchApi.ImagesInner();
      //expect(instance).to.be();
    });
