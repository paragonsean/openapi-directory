...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegacySearchApi.Child1();
  });
  ...
  describe('Child1', function() {
    it('should create an instance of Child1', function() {
      // uncomment below and update the code to test Child1
      //var instance = new LegacySearchApi.Child1();
      //expect(instance).to.be.a(LegacySearchApi.Child1);
    });
