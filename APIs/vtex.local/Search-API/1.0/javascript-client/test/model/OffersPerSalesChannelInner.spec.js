...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LegacySearchApi.OffersPerSalesChannelInner();
  });
  ...
  describe('OffersPerSalesChannelInner', function() {
    it('should create an instance of OffersPerSalesChannelInner', function() {
      // uncomment below and update the code to test OffersPerSalesChannelInner
      //var instance = new LegacySearchApi.OffersPerSalesChannelInner();
      //expect(instance).to.be.a(LegacySearchApi.OffersPerSalesChannelInner);
    });
