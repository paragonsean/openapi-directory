...
class Department {
    ...
    constructor(link, name, quantity) { 
        ...
        Department.initialize(this, link, name, quantity);
    }
...
Department.RequiredProperties = ["Link", "Name", "Quantity"];

/**
 * @member {String} Link
 */
Department.prototype['Link'] = undefined;
 ...
 */
Department.prototype['Quantity'] = undefined;
