...
void Example::exampleFunction1(){
     OAIPagesApi apiInstance;
     
      QEventLoop loop;
      connect(&apiInstance, &OAIPagesApi::getAllContentTypesSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIPagesApi::getAllContentTypesSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString builder_id = create(); // QString | Builder ID specified in the settings of the CMS app.
      apiInstance.getAllContentTypes(builder_id);
