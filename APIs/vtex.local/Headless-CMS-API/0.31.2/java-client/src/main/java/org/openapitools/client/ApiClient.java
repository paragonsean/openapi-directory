...
public class ApiClient {
    ...
    new ServerConfiguration(
      ...
      "No description provided",
      new HashMap<String, ServerVariable>() {{
        put("account", new ServerVariable(
    ...
    new ServerConfiguration(
      ...
      new HashMap<String, ServerVariable>() {{
        ...
        put("workspace", new ServerVariable(
          "Name of the VTEX workspace. Used as part of the URL.",
          "test",
          new HashSet<String>(
          )
        ));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.31.2/java");
