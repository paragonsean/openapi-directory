...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VtexHeadlessCms.GetCMSpage200ResponseSectionsInner();
  });
  ...
  describe('GetCMSpage200ResponseSectionsInner', function() {
    it('should create an instance of GetCMSpage200ResponseSectionsInner', function() {
      // uncomment below and update the code to test GetCMSpage200ResponseSectionsInner
      //var instance = new VtexHeadlessCms.GetCMSpage200ResponseSectionsInner();
      //expect(instance).to.be.a(VtexHeadlessCms.GetCMSpage200ResponseSectionsInner);
    });
