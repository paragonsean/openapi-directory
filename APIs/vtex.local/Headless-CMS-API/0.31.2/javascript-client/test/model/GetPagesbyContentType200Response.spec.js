...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VtexHeadlessCms.GetPagesbyContentType200Response();
  });
  ...
  describe('GetPagesbyContentType200Response', function() {
    it('should create an instance of GetPagesbyContentType200Response', function() {
      // uncomment below and update the code to test GetPagesbyContentType200Response
      //var instance = new VtexHeadlessCms.GetPagesbyContentType200Response();
      //expect(instance).to.be.a(VtexHeadlessCms.GetPagesbyContentType200Response);
    });
