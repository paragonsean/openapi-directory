...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VtexHeadlessCms.GetAllContentTypes200Response();
  });
  ...
  describe('GetAllContentTypes200Response', function() {
    it('should create an instance of GetAllContentTypes200Response', function() {
      // uncomment below and update the code to test GetAllContentTypes200Response
      //var instance = new VtexHeadlessCms.GetAllContentTypes200Response();
      //expect(instance).to.be.a(VtexHeadlessCms.GetAllContentTypes200Response);
    });
