...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VtexHeadlessCms.GetAllContentTypes200ResponseContentTypesInner();
  });
  ...
  describe('GetAllContentTypes200ResponseContentTypesInner', function() {
    it('should create an instance of GetAllContentTypes200ResponseContentTypesInner', function() {
      // uncomment below and update the code to test GetAllContentTypes200ResponseContentTypesInner
      //var instance = new VtexHeadlessCms.GetAllContentTypes200ResponseContentTypesInner();
      //expect(instance).to.be.a(VtexHeadlessCms.GetAllContentTypes200ResponseContentTypesInner);
    });

    it('should have the property configurationSchemaSets (base name: "configurationSchemaSets")', function() {
      // uncomment below and update the code to test the property configurationSchemaSets
      //var instance = new VtexHeadlessCms.GetAllContentTypes200ResponseContentTypesInner();
