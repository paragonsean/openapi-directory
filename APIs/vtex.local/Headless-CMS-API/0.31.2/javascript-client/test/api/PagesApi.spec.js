...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VtexHeadlessCms.PagesApi();
  });
  ...
  describe('PagesApi', function() {
    describe('getAllContentTypes', function() {
      it('should call getAllContentTypes successfully', function(done) {
        //uncomment below and update the code to test getAllContentTypes
        //instance.getAllContentTypes(function(error) {
    ...
    describe('getCMSpage', function() {
      it('should call getCMSpage successfully', function(done) {
        //uncomment below and update the code to test getCMSpage
        //instance.getCMSpage(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPagesbyContentType', function() {
      it('should call getPagesbyContentType successfully', function(done) {
        //uncomment below and update the code to test getPagesbyContentType
        //instance.getPagesbyContentType(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
