...
public class ConfigExternalPriceSourceRequest {
  ...
  public ConfigExternalPriceSourceRequest() {
  }

  public ConfigExternalPriceSourceRequest active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public ConfigExternalPriceSourceRequest appName(String appName) {
  ...
  public boolean equals(Object o) {
    ...
    ConfigExternalPriceSourceRequest configExternalPriceSourceRequest = (ConfigExternalPriceSourceRequest) o;
    return Objects.equals(this.active, configExternalPriceSourceRequest.active) &&
        Objects.equals(this.appName, configExternalPriceSourceRequest.appName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, appName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConfigExternalPriceSourceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfigExternalPriceSourceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfigExternalPriceSourceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfigExternalPriceSourceRequest is not found in the empty JSON string", ConfigExternalPriceSourceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfigExternalPriceSourceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfigExternalPriceSourceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConfigExternalPriceSourceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfigExternalPriceSourceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfigExternalPriceSourceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfigExternalPriceSourceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfigExternalPriceSourceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfigExternalPriceSourceRequest>() {
           @Override
           public void write(JsonWriter out, ConfigExternalPriceSourceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfigExternalPriceSourceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfigExternalPriceSourceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfigExternalPriceSourceRequest
   * @throws IOException if the JSON string is invalid with respect to ConfigExternalPriceSourceRequest
   */
  public static ConfigExternalPriceSourceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfigExternalPriceSourceRequest.class);
  }

  /**
   * Convert an instance of ConfigExternalPriceSourceRequest to an JSON string
   *
   * @return JSON string
   */
