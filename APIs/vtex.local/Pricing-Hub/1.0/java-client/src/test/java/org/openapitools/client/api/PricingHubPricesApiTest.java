...
/**
 * API tests for PricingHubPricesApi
 */
@Disabled
public class PricingHubPricesApiTest {

    private final PricingHubPricesApi api = new PricingHubPricesApi();
     ...
     */
    @Test
    public void apiPricingHubPricesPostTest() throws ApiException {
        String accountName = null;
        String accept = null;
        String contentType = null;
        String xVTEXAPIAppKey = null;
        String xVTEXAPIAppToken = null;
        GetPricesRequestObject getPricesRequestObject = null;
        Response2 response = api.apiPricingHubPricesPost(accountName, accept, contentType, xVTEXAPIAppKey, xVTEXAPIAppToken, getPricesRequestObject);
     ...
     */
    @Test
    public void configExternalPriceSourceTest() throws ApiException {
        String accept = null;
        String contentType = null;
        String xVTEXAPIAppKey = null;
        String xVTEXAPIAppToken = null;
        ConfigExternalPriceSourceRequest configExternalPriceSourceRequest = null;
        String an = null;
        api.configExternalPriceSource(accept, contentType, xVTEXAPIAppKey, xVTEXAPIAppToken, configExternalPriceSourceRequest, an);
        // TODO: test validations
    }
