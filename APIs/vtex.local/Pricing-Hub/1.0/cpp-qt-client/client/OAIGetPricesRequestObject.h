...
/*
 * OAIGetPricesRequestObject.h
 *
 * 
 */

#ifndef OAIGetPricesRequestObject_H
#define OAIGetPricesRequestObject_H
...
class OAIGetPricesRequestObject : public OAIObject {
public:
    OAIGetPricesRequestObject();
    OAIGetPricesRequestObject(QString json);
    ~OAIGetPricesRequestObject() override;
    ...
    QString getUtmInternalCampaign() const;
    void setUtmInternalCampaign(const QString &utm_internal_campaign);
    bool is_utm_internal_campaign_Set() const;
    bool is_utm_internal_campaign_Valid() const;
...
private:
    ...
    QString m_utm_internal_campaign;
    bool m_utm_internal_campaign_isSet;
    bool m_utm_internal_campaign_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPricesRequestObject)

#endif // OAIGetPricesRequestObject_H
