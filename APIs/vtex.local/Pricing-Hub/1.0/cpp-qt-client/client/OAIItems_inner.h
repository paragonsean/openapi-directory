...
public:
    ...
    QList<QString> getPriceTableIds() const;
    void setPriceTableIds(const QList<QString> &price_table_ids);
    bool is_price_table_ids_Set() const;
    bool is_price_table_ids_Valid() const;
...
private:
    ...
    QList<QString> m_price_table_ids;
    bool m_price_table_ids_isSet;
    bool m_price_table_ids_isValid;
