...
/*
 * OAIConfigExternalPriceSourceRequest.h
 *
 * 
 */

#ifndef OAIConfigExternalPriceSourceRequest_H
#define OAIConfigExternalPriceSourceRequest_H
...
class OAIConfigExternalPriceSourceRequest : public OAIObject {
public:
    OAIConfigExternalPriceSourceRequest();
    OAIConfigExternalPriceSourceRequest(QString json);
    ~OAIConfigExternalPriceSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigExternalPriceSourceRequest)

#endif // OAIConfigExternalPriceSourceRequest_H
