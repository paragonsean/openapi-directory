...
OAIConfigExternalPriceSourceRequest::OAIConfigExternalPriceSourceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfigExternalPriceSourceRequest::OAIConfigExternalPriceSourceRequest() {
    this->initializeModel();
}

OAIConfigExternalPriceSourceRequest::~OAIConfigExternalPriceSourceRequest() {}

void OAIConfigExternalPriceSourceRequest::initializeModel() {
...
void OAIConfigExternalPriceSourceRequest::fromJson(QString jsonString) {
...
void OAIConfigExternalPriceSourceRequest::fromJsonObject(QJsonObject json) {
...
QString OAIConfigExternalPriceSourceRequest::asJson() const {
...
QJsonObject OAIConfigExternalPriceSourceRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_active_isSet) {
...
bool OAIConfigExternalPriceSourceRequest::isActive() const {
    return m_active;
}
void OAIConfigExternalPriceSourceRequest::setActive(const bool &active) {
    m_active = active;
    m_active_isSet = true;
}

bool OAIConfigExternalPriceSourceRequest::is_active_Set() const{
    return m_active_isSet;
}

bool OAIConfigExternalPriceSourceRequest::is_active_Valid() const{
    return m_active_isValid;
}

QString OAIConfigExternalPriceSourceRequest::getAppName() const {
    return m_app_name;
}
void OAIConfigExternalPriceSourceRequest::setAppName(const QString &app_name) {
    m_app_name = app_name;
    m_app_name_isSet = true;
}

bool OAIConfigExternalPriceSourceRequest::is_app_name_Set() const{
    return m_app_name_isSet;
}

bool OAIConfigExternalPriceSourceRequest::is_app_name_Valid() const{
    return m_app_name_isValid;
}

bool OAIConfigExternalPriceSourceRequest::isSet() const {
...
bool OAIConfigExternalPriceSourceRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_app_name_isValid && true;
}
