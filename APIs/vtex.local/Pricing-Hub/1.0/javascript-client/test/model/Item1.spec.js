...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.PricingHub);
  }
}(this, function(expect, PricingHub) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new PricingHub.Item1();
  });
  ...
  describe('Item1', function() {
    it('should create an instance of Item1', function() {
      ...
      //var instance = new PricingHub.Item1();
      //expect(instance).to.be.a(PricingHub.Item1);
    });
