...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingHub.GetPricesRequestObject();
  });
  ...
  describe('GetPricesRequestObject', function() {
    it('should create an instance of GetPricesRequestObject', function() {
      // uncomment below and update the code to test GetPricesRequestObject
      //var instance = new PricingHub.GetPricesRequestObject();
      //expect(instance).to.be.a(PricingHub.GetPricesRequestObject);
    });
    ...
    it('should have the property utmInternalCampaign (base name: "UtmInternalCampaign")', function() {
      // uncomment below and update the code to test the property utmInternalCampaign
      //var instance = new PricingHub.GetPricesRequestObject();
      //expect(instance).to.be();
    });
