...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingHub.ItemsInner();
  });
  ...
  describe('ItemsInner', function() {
    it('should create an instance of ItemsInner', function() {
      ...
      //var instance = new PricingHub.ItemsInner();
      //expect(instance).to.be.a(PricingHub.ItemsInner);
    });
    ...
    it('should have the property priceTableIds (base name: "priceTableIds")', function() {
      // uncomment below and update the code to test the property priceTableIds
      //var instance = new PricingHub.ItemsInner();
      //expect(instance).to.be();
    });
