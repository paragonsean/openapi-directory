...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingHub.ConfigExternalPriceSourceRequest();
  });
  ...
  describe('ConfigExternalPriceSourceRequest', function() {
    it('should create an instance of ConfigExternalPriceSourceRequest', function() {
      // uncomment below and update the code to test ConfigExternalPriceSourceRequest
      //var instance = new PricingHub.ConfigExternalPriceSourceRequest();
      //expect(instance).to.be.a(PricingHub.ConfigExternalPriceSourceRequest);
    });
