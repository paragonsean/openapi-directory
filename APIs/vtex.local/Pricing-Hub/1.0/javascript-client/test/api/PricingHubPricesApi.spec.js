...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PricingHub.PricingHubPricesApi();
  });
  ...
  describe('PricingHubPricesApi', function() {
    describe('apiPricingHubPricesPost', function() {
      it('should call apiPricingHubPricesPost successfully', function(done) {
        //uncomment below and update the code to test apiPricingHubPricesPost
        //instance.apiPricingHubPricesPost(function(error) {
    ...
    describe('configExternalPriceSource', function() {
      it('should call configExternalPriceSource successfully', function(done) {
        //uncomment below and update the code to test configExternalPriceSource
        //instance.configExternalPriceSource(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
