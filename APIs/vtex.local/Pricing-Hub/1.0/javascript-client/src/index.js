...
import PricingHubPricesApi from './api/PricingHubPricesApi';
...
* <pre>
* var PricingHub = require('index'); // See note below*.
* var xxxSvc = new PricingHub.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new PricingHub.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new PricingHub.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new PricingHub.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The ConfigExternalPriceSourceRequest model constructor.
     * @property {module:model/ConfigExternalPriceSourceRequest}
     */
    ConfigExternalPriceSourceRequest,

    /**
     * The GetPricesRequestObject model constructor.
     * @property {module:model/GetPricesRequestObject}
     */
    ...
    /**
    * The PricingHubPricesApi service constructor.
    * @property {module:api/PricingHubPricesApi}
    */
    PricingHubPricesApi
};
