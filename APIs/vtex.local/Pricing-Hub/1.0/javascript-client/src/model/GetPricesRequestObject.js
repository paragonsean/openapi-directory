...
/**
 * The GetPricesRequestObject model module.
 * @module model/GetPricesRequestObject
 * @version 1.0
 */
class GetPricesRequestObject {
    /**
     * Constructs a new <code>GetPricesRequestObject</code>.
     * @alias module:model/GetPricesRequestObject
     * @param email {String} The customer's email address. If there is no value, use an empty string
     * @param items {Array.<module:model/ItemsInner>} The list of items that are to be priced by Pricing Hub
     * @param salesChannel {String} Represents Checkout's sales channel
     */
    constructor(email, items, salesChannel) { 
        
        GetPricesRequestObject.initialize(this, email, items, salesChannel);
    }
     ...
     */
    static initialize(obj, email, items, salesChannel) { 
        obj['UtmCampaign'] = 'summer';
        obj['UtmInternalCampaign'] = 'sale';
        obj['UtmMedium'] = 'social';
        obj['UtmSource'] = 'facebook';
        obj['email'] = email || 'customer@email.com';
        obj['items'] = items;
        obj['salesChannel'] = salesChannel || '1';
    }

    /**
     * Constructs a <code>GetPricesRequestObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPricesRequestObject} obj Optional instance to populate.
     * @return {module:model/GetPricesRequestObject} The populated <code>GetPricesRequestObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPricesRequestObject();

            if (data.hasOwnProperty('UtmCampaign')) {
                obj['UtmCampaign'] = ApiClient.convertToType(data['UtmCampaign'], 'String');
            }
            if (data.hasOwnProperty('UtmInternalCampaign')) {
                obj['UtmInternalCampaign'] = ApiClient.convertToType(data['UtmInternalCampaign'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPricesRequestObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPricesRequestObject</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPricesRequestObject.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['UtmInternalCampaign'] && !(typeof data['UtmInternalCampaign'] === 'string' || data['UtmInternalCampaign'] instanceof String)) {
            throw new Error("Expected the field `UtmInternalCampaign` to be a primitive type in the JSON string but got " + data['UtmInternalCampaign']);
        }
        // ensure the json data is a string
...
GetPricesRequestObject.RequiredProperties = ["email", "items", "salesChannel"];
 ...
 * @default 'summer'
 */
GetPricesRequestObject.prototype['UtmCampaign'] = 'summer';

/**
 * Internal campaign name, represented by the `utmi_cp` value in the URL that led to the order. If there is no value, use `null`
 * @member {String} UtmInternalCampaign
 * @default 'sale'
 */
GetPricesRequestObject.prototype['UtmInternalCampaign'] = 'sale';
 ...
 * @default 'social'
 */
GetPricesRequestObject.prototype['UtmMedium'] = 'social';
 ...
 * @default 'facebook'
 */
GetPricesRequestObject.prototype['UtmSource'] = 'facebook';
 ...
 */
GetPricesRequestObject.prototype['email'] = 'customer@email.com';

/**
 * The list of items that are to be priced by Pricing Hub
 * @member {Array.<module:model/ItemsInner>} items
 */
GetPricesRequestObject.prototype['items'] = undefined;
 ...
 * @default '1'
 */
GetPricesRequestObject.prototype['salesChannel'] = '1';
...
export default GetPricesRequestObject;
