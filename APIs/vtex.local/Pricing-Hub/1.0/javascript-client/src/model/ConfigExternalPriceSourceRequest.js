...
/**
 * The ConfigExternalPriceSourceRequest model module.
 * @module model/ConfigExternalPriceSourceRequest
 * @version 1.0
 */
class ConfigExternalPriceSourceRequest {
    /**
     * Constructs a new <code>ConfigExternalPriceSourceRequest</code>.
     * @alias module:model/ConfigExternalPriceSourceRequest
     * @param appName {String} Name of the app that communicates with the external pricing source
     */
    constructor(appName) { 
        
        ConfigExternalPriceSourceRequest.initialize(this, appName);
    }
     ...
     */
    static initialize(obj, appName) { 
        obj['active'] = false;
        obj['appName'] = appName;
    }

    /**
     * Constructs a <code>ConfigExternalPriceSourceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfigExternalPriceSourceRequest} obj Optional instance to populate.
     * @return {module:model/ConfigExternalPriceSourceRequest} The populated <code>ConfigExternalPriceSourceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfigExternalPriceSourceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ConfigExternalPriceSourceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfigExternalPriceSourceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConfigExternalPriceSourceRequest.RequiredProperties) {
...
ConfigExternalPriceSourceRequest.RequiredProperties = ["appName"];
 ...
 * @default false
 */
ConfigExternalPriceSourceRequest.prototype['active'] = false;

/**
 * Name of the app that communicates with the external pricing source
 * @member {String} appName
 */
ConfigExternalPriceSourceRequest.prototype['appName'] = undefined;
...
export default ConfigExternalPriceSourceRequest;
