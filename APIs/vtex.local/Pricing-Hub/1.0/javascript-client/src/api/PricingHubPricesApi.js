...
import ConfigExternalPriceSourceRequest from '../model/ConfigExternalPriceSourceRequest';
import GetPricesRequestObject from '../model/GetPricesRequestObject';
import Response2 from '../model/Response2';

/**
* PricingHubPrices service.
* @module api/PricingHubPricesApi
* @version 1.0
*/
export default class PricingHubPricesApi {

    /**
    * Constructs a new PricingHubPricesApi. 
    * @alias module:api/PricingHubPricesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apiPricingHubPricesPost operation.
     * @callback module:api/PricingHubPricesApi~apiPricingHubPricesPostCallback
     ...
     * @param {module:model/GetPricesRequestObject} getPricesRequestObject 
     * @param {module:api/PricingHubPricesApi~apiPricingHubPricesPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Response2}
     */
    apiPricingHubPricesPost(accountName, accept, contentType, xVTEXAPIAppKey, xVTEXAPIAppToken, getPricesRequestObject, callback) {
      let postBody = getPricesRequestObject;
      // verify the required parameter 'accountName' is set
      if (accountName === undefined || accountName === null) {
        throw new Error("Missing the required parameter 'accountName' when calling apiPricingHubPricesPost");
      }
      // verify the required parameter 'accept' is set
      if (accept === undefined || accept === null) {
        throw new Error("Missing the required parameter 'accept' when calling apiPricingHubPricesPost");
      }
      // verify the required parameter 'contentType' is set
      if (contentType === undefined || contentType === null) {
        throw new Error("Missing the required parameter 'contentType' when calling apiPricingHubPricesPost");
      }
      // verify the required parameter 'xVTEXAPIAppKey' is set
      if (xVTEXAPIAppKey === undefined || xVTEXAPIAppKey === null) {
        throw new Error("Missing the required parameter 'xVTEXAPIAppKey' when calling apiPricingHubPricesPost");
      }
      // verify the required parameter 'xVTEXAPIAppToken' is set
      if (xVTEXAPIAppToken === undefined || xVTEXAPIAppToken === null) {
        throw new Error("Missing the required parameter 'xVTEXAPIAppToken' when calling apiPricingHubPricesPost");
      }
      // verify the required parameter 'getPricesRequestObject' is set
      if (getPricesRequestObject === undefined || getPricesRequestObject === null) {
        throw new Error("Missing the required parameter 'getPricesRequestObject' when calling apiPricingHubPricesPost");
      }
    ...
    /**
     * Callback function to receive the result of the configExternalPriceSource operation.
     * @callback module:api/PricingHubPricesApi~configExternalPriceSourceCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} xVTEXAPIAppKey The AppKey configured by the merchant
     * @param {String} xVTEXAPIAppToken The AppToken configured by the merchant
     * @param {module:model/ConfigExternalPriceSourceRequest} configExternalPriceSourceRequest 
     * @param {Object} opts Optional parameters
     * @param {String} [an] Name of the VTEX account
     * @param {module:api/PricingHubPricesApi~configExternalPriceSourceCallback} callback The callback function, accepting three arguments: error, data, response
     */
    configExternalPriceSource(accept, contentType, xVTEXAPIAppKey, xVTEXAPIAppToken, configExternalPriceSourceRequest, opts, callback) {
      opts = opts || {};
      let postBody = configExternalPriceSourceRequest;
      // verify the required parameter 'accept' is set
      if (accept === undefined || accept === null) {
        throw new Error("Missing the required parameter 'accept' when calling configExternalPriceSource");
      }
      // verify the required parameter 'contentType' is set
      if (contentType === undefined || contentType === null) {
        throw new Error("Missing the required parameter 'contentType' when calling configExternalPriceSource");
      }
      // verify the required parameter 'xVTEXAPIAppKey' is set
      if (xVTEXAPIAppKey === undefined || xVTEXAPIAppKey === null) {
        throw new Error("Missing the required parameter 'xVTEXAPIAppKey' when calling configExternalPriceSource");
      }
      // verify the required parameter 'xVTEXAPIAppToken' is set
      if (xVTEXAPIAppToken === undefined || xVTEXAPIAppToken === null) {
        throw new Error("Missing the required parameter 'xVTEXAPIAppToken' when calling configExternalPriceSource");
      }
      // verify the required parameter 'configExternalPriceSourceRequest' is set
      if (configExternalPriceSourceRequest === undefined || configExternalPriceSourceRequest === null) {
        throw new Error("Missing the required parameter 'configExternalPriceSourceRequest' when calling configExternalPriceSource");
      }
