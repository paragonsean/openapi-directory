...
class CreateReservationRequest(Model):
    ...
    def __init__(self, autorization_expiration_ttl: str=None, delivery_item_options: List[DeliveryItemOption1]=None, lock_id: str=None, sales_channel: str=None):
        """CreateReservationRequest - a model defined in OpenAPI

        :param autorization_expiration_ttl: The autorization_expiration_ttl of this CreateReservationRequest.
        :param delivery_item_options: The delivery_item_options of this CreateReservationRequest.
        :param lock_id: The lock_id of this CreateReservationRequest.
        :param sales_channel: The sales_channel of this CreateReservationRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateReservationRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateReservationRequest of this CreateReservationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def autorization_expiration_ttl(self):
        """Gets the autorization_expiration_ttl of this CreateReservationRequest.


        :return: The autorization_expiration_ttl of this CreateReservationRequest.
        :rtype: str
        """
    ...
    def autorization_expiration_ttl(self, autorization_expiration_ttl):
        """Sets the autorization_expiration_ttl of this CreateReservationRequest.
    ...
    def delivery_item_options(self):
        """Gets the delivery_item_options of this CreateReservationRequest.

        

        :return: The delivery_item_options of this CreateReservationRequest.
    ...
    def delivery_item_options(self, delivery_item_options):
        """Sets the delivery_item_options of this CreateReservationRequest.
    ...
    @property
    def lock_id(self):
        """Gets the lock_id of this CreateReservationRequest.


        :return: The lock_id of this CreateReservationRequest.
        :rtype: str
        """
    ...
    def lock_id(self, lock_id):
        """Sets the lock_id of this CreateReservationRequest.
    ...
    def sales_channel(self):
        """Gets the sales_channel of this CreateReservationRequest.


        :return: The sales_channel of this CreateReservationRequest.
        :rtype: str
        """
    ...
    def sales_channel(self, sales_channel):
        """Sets the sales_channel of this CreateReservationRequest.
