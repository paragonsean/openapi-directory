...
class ListAllDocks(Model):
    ...
    def __init__(self, dock_time_fake: str=None, freight_table_ids: List[str]=None, id: str=None, name: str=None, pickup_store_info: PickupStoreInfo11=None, priority: int=None, sales_channel: str=None, sales_channels: List[str]=None, time_fake_overhead: str=None, wms_end_point: str=None):
        """ListAllDocks - a model defined in OpenAPI

        :param dock_time_fake: The dock_time_fake of this ListAllDocks.
        :param freight_table_ids: The freight_table_ids of this ListAllDocks.
        :param id: The id of this ListAllDocks.
        :param name: The name of this ListAllDocks.
        :param pickup_store_info: The pickup_store_info of this ListAllDocks.
        :param priority: The priority of this ListAllDocks.
        :param sales_channel: The sales_channel of this ListAllDocks.
        :param sales_channels: The sales_channels of this ListAllDocks.
        :param time_fake_overhead: The time_fake_overhead of this ListAllDocks.
        :param wms_end_point: The wms_end_point of this ListAllDocks.
        """
        self.openapi_types = {
            'dock_time_fake': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListAllDocks':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListAllDocks of this ListAllDocks.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def dock_time_fake(self):
        """Gets the dock_time_fake of this ListAllDocks.


        :return: The dock_time_fake of this ListAllDocks.
        :rtype: str
        """
    ...
    def dock_time_fake(self, dock_time_fake):
        """Sets the dock_time_fake of this ListAllDocks.
    ...
    def freight_table_ids(self):
        """Gets the freight_table_ids of this ListAllDocks.

        

        :return: The freight_table_ids of this ListAllDocks.
        :rtype: List[str]
        """
    ...
    def freight_table_ids(self, freight_table_ids):
        """Sets the freight_table_ids of this ListAllDocks.
    ...
    @property
    def id(self):
        """Gets the id of this ListAllDocks.


        :return: The id of this ListAllDocks.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ListAllDocks.
    ...
    @property
    def name(self):
        """Gets the name of this ListAllDocks.


        :return: The name of this ListAllDocks.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ListAllDocks.
    ...
    def pickup_store_info(self):
        """Gets the pickup_store_info of this ListAllDocks.


        :return: The pickup_store_info of this ListAllDocks.
    ...
    def pickup_store_info(self, pickup_store_info):
        """Sets the pickup_store_info of this ListAllDocks.
    ...
    @property
    def priority(self):
        """Gets the priority of this ListAllDocks.


        :return: The priority of this ListAllDocks.
        :rtype: int
        """
    ...
    def priority(self, priority):
        """Sets the priority of this ListAllDocks.
    ...
    def sales_channel(self):
        """Gets the sales_channel of this ListAllDocks.


        :return: The sales_channel of this ListAllDocks.
        :rtype: str
        """
    ...
    def sales_channel(self, sales_channel):
        """Sets the sales_channel of this ListAllDocks.
    ...
    def sales_channels(self):
        """Gets the sales_channels of this ListAllDocks.

        

        :return: The sales_channels of this ListAllDocks.
        :rtype: List[str]
        """
    ...
    def sales_channels(self, sales_channels):
        """Sets the sales_channels of this ListAllDocks.
    ...
    def time_fake_overhead(self):
        """Gets the time_fake_overhead of this ListAllDocks.


        :return: The time_fake_overhead of this ListAllDocks.
        :rtype: str
        """
    ...
    def time_fake_overhead(self, time_fake_overhead):
        """Sets the time_fake_overhead of this ListAllDocks.
    ...
    def wms_end_point(self):
        """Gets the wms_end_point of this ListAllDocks.


        :return: The wms_end_point of this ListAllDocks.
        :rtype: str
        """
    ...
    def wms_end_point(self, wms_end_point):
        """Sets the wms_end_point of this ListAllDocks.
