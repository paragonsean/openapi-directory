...
class Address(Model):
    ...
    def __init__(self, city: str=None, complement: str=None, coordinates: str=None, country: Country1=None, neighborhood: str=None, number: str=None, postal_code: str=None, state: str=None, street: str=None):
