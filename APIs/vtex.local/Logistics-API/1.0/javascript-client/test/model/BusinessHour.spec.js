...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.BusinessHour();
  });
  ...
  describe('BusinessHour', function() {
    it('should create an instance of BusinessHour', function() {
      // uncomment below and update the code to test BusinessHour
      //var instance = new LogisticsApi.BusinessHour();
      //expect(instance).to.be.a(LogisticsApi.BusinessHour);
    });
