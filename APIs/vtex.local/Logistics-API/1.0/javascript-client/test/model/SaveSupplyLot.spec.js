...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.SaveSupplyLot();
  });
  ...
  describe('SaveSupplyLot', function() {
    it('should create an instance of SaveSupplyLot', function() {
      // uncomment below and update the code to test SaveSupplyLot
      //var instance = new LogisticsApi.SaveSupplyLot();
      //expect(instance).to.be.a(LogisticsApi.SaveSupplyLot);
    });
