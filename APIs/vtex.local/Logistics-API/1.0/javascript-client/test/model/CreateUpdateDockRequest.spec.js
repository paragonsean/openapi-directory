...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.CreateUpdateDockRequest();
  });
  ...
  describe('CreateUpdateDockRequest', function() {
    it('should create an instance of CreateUpdateDockRequest', function() {
      // uncomment below and update the code to test CreateUpdateDockRequest
      //var instance = new LogisticsApi.CreateUpdateDockRequest();
      //expect(instance).to.be.a(LogisticsApi.CreateUpdateDockRequest);
    });
