...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.BusinessHour1();
  });
  ...
  describe('BusinessHour1', function() {
    it('should create an instance of BusinessHour1', function() {
      // uncomment below and update the code to test BusinessHour1
      //var instance = new LogisticsApi.BusinessHour1();
      //expect(instance).to.be.a(LogisticsApi.BusinessHour1);
    });
