...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.ListAllPickupPpoints200ResponseInner();
  });
  ...
  describe('ListAllPickupPpoints200ResponseInner', function() {
    it('should create an instance of ListAllPickupPpoints200ResponseInner', function() {
      // uncomment below and update the code to test ListAllPickupPpoints200ResponseInner
      //var instance = new LogisticsApi.ListAllPickupPpoints200ResponseInner();
      //expect(instance).to.be.a(LogisticsApi.ListAllPickupPpoints200ResponseInner);
    });

    it('should have the property accountGroupId (base name: "accountGroupId")', function() {
      // uncomment below and update the code to test the property accountGroupId
      //var instance = new LogisticsApi.ListAllPickupPpoints200ResponseInner();
    ...
    it('should have the property pickupHolidays (base name: "pickupHolidays")', function() {
      // uncomment below and update the code to test the property pickupHolidays
      //var instance = new LogisticsApi.ListAllPickupPpoints200ResponseInner();
      //expect(instance).to.be();
    });
