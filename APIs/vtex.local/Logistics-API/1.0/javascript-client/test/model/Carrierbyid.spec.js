...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.Carrierbyid();
  });
  ...
  describe('Carrierbyid', function() {
    it('should create an instance of Carrierbyid', function() {
      // uncomment below and update the code to test Carrierbyid
      //var instance = new LogisticsApi.Carrierbyid();
      //expect(instance).to.be.a(LogisticsApi.Carrierbyid);
    });
