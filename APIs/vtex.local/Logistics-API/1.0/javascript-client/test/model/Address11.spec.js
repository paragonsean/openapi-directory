...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.Address11();
  });
  ...
  describe('Address11', function() {
    it('should create an instance of Address11', function() {
      // uncomment below and update the code to test Address11
      //var instance = new LogisticsApi.Address11();
      //expect(instance).to.be.a(LogisticsApi.Address11);
    });
