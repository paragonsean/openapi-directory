...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.CalculateSLA200ResponseInnerInner();
  });
  ...
  describe('CalculateSLA200ResponseInnerInner', function() {
    it('should create an instance of CalculateSLA200ResponseInnerInner', function() {
      // uncomment below and update the code to test CalculateSLA200ResponseInnerInner
      //var instance = new LogisticsApi.CalculateSLA200ResponseInnerInner();
      //expect(instance).to.be.a(LogisticsApi.CalculateSLA200ResponseInnerInner);
    });
