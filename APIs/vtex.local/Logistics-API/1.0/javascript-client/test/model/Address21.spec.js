...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.Address21();
  });
  ...
  describe('Address21', function() {
    it('should create an instance of Address21', function() {
      // uncomment below and update the code to test Address21
      //var instance = new LogisticsApi.Address21();
      //expect(instance).to.be.a(LogisticsApi.Address21);
    });
