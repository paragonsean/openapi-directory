...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.KitItem();
  });
  ...
  describe('KitItem', function() {
    it('should create an instance of KitItem', function() {
      // uncomment below and update the code to test KitItem
      //var instance = new LogisticsApi.KitItem();
      //expect(instance).to.be.a(LogisticsApi.KitItem);
    });
