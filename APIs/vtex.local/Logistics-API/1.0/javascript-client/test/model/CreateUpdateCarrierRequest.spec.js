...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.CreateUpdateCarrierRequest();
  });
  ...
  describe('CreateUpdateCarrierRequest', function() {
    it('should create an instance of CreateUpdateCarrierRequest', function() {
      // uncomment below and update the code to test CreateUpdateCarrierRequest
      //var instance = new LogisticsApi.CreateUpdateCarrierRequest();
      //expect(instance).to.be.a(LogisticsApi.CreateUpdateCarrierRequest);
    });
