...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.Address41();
  });
  ...
  describe('Address41', function() {
    it('should create an instance of Address41', function() {
      // uncomment below and update the code to test Address41
      //var instance = new LogisticsApi.Address41();
      //expect(instance).to.be.a(LogisticsApi.Address41);
    });
