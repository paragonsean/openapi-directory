...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.CreateUpdate();
  });
  ...
  describe('CreateUpdate', function() {
    it('should create an instance of CreateUpdate', function() {
      // uncomment below and update the code to test CreateUpdate
      //var instance = new LogisticsApi.CreateUpdate();
      //expect(instance).to.be.a(LogisticsApi.CreateUpdate);
    });
