...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.InStore1();
  });
  ...
  describe('InStore1', function() {
    it('should create an instance of InStore1', function() {
      // uncomment below and update the code to test InStore1
      //var instance = new LogisticsApi.InStore1();
      //expect(instance).to.be.a(LogisticsApi.InStore1);
    });
