...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.ListAllDocks();
  });
  ...
  describe('ListAllDocks', function() {
    it('should create an instance of ListAllDocks', function() {
      // uncomment below and update the code to test ListAllDocks
      //var instance = new LogisticsApi.ListAllDocks();
      //expect(instance).to.be.a(LogisticsApi.ListAllDocks);
    });
