...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.GetById1();
  });
  ...
  describe('GetById1', function() {
    it('should create an instance of GetById1', function() {
      // uncomment below and update the code to test GetById1
      //var instance = new LogisticsApi.GetById1();
      //expect(instance).to.be.a(LogisticsApi.GetById1);
    });
