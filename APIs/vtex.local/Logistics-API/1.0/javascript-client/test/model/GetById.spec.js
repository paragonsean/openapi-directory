...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.GetById();
  });
  ...
  describe('GetById', function() {
    it('should create an instance of GetById', function() {
      // uncomment below and update the code to test GetById
      //var instance = new LogisticsApi.GetById();
      //expect(instance).to.be.a(LogisticsApi.GetById);
    });
