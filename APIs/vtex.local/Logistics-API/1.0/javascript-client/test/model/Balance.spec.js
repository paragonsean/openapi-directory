...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.Balance();
  });
  ...
  describe('Balance', function() {
    it('should create an instance of Balance', function() {
      ...
      //var instance = new LogisticsApi.Balance();
      //expect(instance).to.be.a(LogisticsApi.Balance);
    });

    it('should have the property hasUnlimitedQuantity (base name: "hasUnlimitedQuantity")', function() {
      // uncomment below and update the code to test the property hasUnlimitedQuantity
      //var instance = new LogisticsApi.Balance();
