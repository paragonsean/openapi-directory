...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.Balance1();
  });
  ...
  describe('Balance1', function() {
    it('should create an instance of Balance1', function() {
      // uncomment below and update the code to test Balance1
      //var instance = new LogisticsApi.Balance1();
      //expect(instance).to.be.a(LogisticsApi.Balance1);
    });
