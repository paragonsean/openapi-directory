...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.Item3();
  });
  ...
  describe('Item3', function() {
    it('should create an instance of Item3', function() {
      // uncomment below and update the code to test Item3
      //var instance = new LogisticsApi.Item3();
      //expect(instance).to.be.a(LogisticsApi.Item3);
    });
