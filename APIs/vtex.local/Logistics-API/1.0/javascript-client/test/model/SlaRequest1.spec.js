...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.SlaRequest1();
  });
  ...
  describe('SlaRequest1', function() {
    it('should create an instance of SlaRequest1', function() {
      // uncomment below and update the code to test SlaRequest1
      //var instance = new LogisticsApi.SlaRequest1();
      //expect(instance).to.be.a(LogisticsApi.SlaRequest1);
    });
