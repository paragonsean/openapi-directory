...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.SlaRequest();
  });
  ...
  describe('SlaRequest', function() {
    it('should create an instance of SlaRequest', function() {
      // uncomment below and update the code to test SlaRequest
      //var instance = new LogisticsApi.SlaRequest();
      //expect(instance).to.be.a(LogisticsApi.SlaRequest);
    });
