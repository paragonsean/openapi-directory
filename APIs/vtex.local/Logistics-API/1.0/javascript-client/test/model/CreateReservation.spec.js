...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.CreateReservation();
  });
  ...
  describe('CreateReservation', function() {
    it('should create an instance of CreateReservation', function() {
      // uncomment below and update the code to test CreateReservation
      //var instance = new LogisticsApi.CreateReservation();
      //expect(instance).to.be.a(LogisticsApi.CreateReservation);
    });
