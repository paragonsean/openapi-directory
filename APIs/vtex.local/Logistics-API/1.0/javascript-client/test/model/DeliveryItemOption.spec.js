...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.DeliveryItemOption();
  });
  ...
  describe('DeliveryItemOption', function() {
    it('should create an instance of DeliveryItemOption', function() {
      // uncomment below and update the code to test DeliveryItemOption
      //var instance = new LogisticsApi.DeliveryItemOption();
      //expect(instance).to.be.a(LogisticsApi.DeliveryItemOption);
    });
