...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.InStore11();
  });
  ...
  describe('InStore11', function() {
    it('should create an instance of InStore11', function() {
      // uncomment below and update the code to test InStore11
      //var instance = new LogisticsApi.InStore11();
      //expect(instance).to.be.a(LogisticsApi.InStore11);
    });
