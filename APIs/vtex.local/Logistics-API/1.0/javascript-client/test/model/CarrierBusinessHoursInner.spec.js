...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.CarrierBusinessHoursInner();
  });
  ...
  describe('CarrierBusinessHoursInner', function() {
    it('should create an instance of CarrierBusinessHoursInner', function() {
      // uncomment below and update the code to test CarrierBusinessHoursInner
      //var instance = new LogisticsApi.CarrierBusinessHoursInner();
      //expect(instance).to.be.a(LogisticsApi.CarrierBusinessHoursInner);
    });
