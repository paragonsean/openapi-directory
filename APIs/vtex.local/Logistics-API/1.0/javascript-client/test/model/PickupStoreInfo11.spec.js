...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.PickupStoreInfo11();
  });
  ...
  describe('PickupStoreInfo11', function() {
    it('should create an instance of PickupStoreInfo11', function() {
      // uncomment below and update the code to test PickupStoreInfo11
      //var instance = new LogisticsApi.PickupStoreInfo11();
      //expect(instance).to.be.a(LogisticsApi.PickupStoreInfo11);
    });
