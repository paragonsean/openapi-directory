...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.KitItem1();
  });
  ...
  describe('KitItem1', function() {
    it('should create an instance of KitItem1', function() {
      // uncomment below and update the code to test KitItem1
      //var instance = new LogisticsApi.KitItem1();
      //expect(instance).to.be.a(LogisticsApi.KitItem1);
    });
