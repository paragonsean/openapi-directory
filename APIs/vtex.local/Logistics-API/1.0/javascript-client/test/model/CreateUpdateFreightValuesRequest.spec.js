...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogisticsApi.CreateUpdateFreightValuesRequest();
  });
  ...
  describe('CreateUpdateFreightValuesRequest', function() {
    it('should create an instance of CreateUpdateFreightValuesRequest', function() {
      // uncomment below and update the code to test CreateUpdateFreightValuesRequest
      //var instance = new LogisticsApi.CreateUpdateFreightValuesRequest();
      //expect(instance).to.be.a(LogisticsApi.CreateUpdateFreightValuesRequest);
    });
