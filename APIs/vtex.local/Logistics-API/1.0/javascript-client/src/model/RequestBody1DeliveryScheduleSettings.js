...
/**
 * The RequestBody1DeliveryScheduleSettings model module.
 * @module model/RequestBody1DeliveryScheduleSettings
 * @version 1.0
 */
class RequestBody1DeliveryScheduleSettings {
    /**
     * Constructs a new <code>RequestBody1DeliveryScheduleSettings</code>.
     * Settings for the Scheduled Delivery feature.
     * @alias module:model/RequestBody1DeliveryScheduleSettings
    ...
    constructor(dayOfWeekForDelivery, maxRangeDelivery, useDeliverySchedule) { 
        ...
        RequestBody1DeliveryScheduleSettings.initialize(this, dayOfWeekForDelivery, maxRangeDelivery, useDeliverySchedule);
    }
    ...
    /**
     * Constructs a <code>RequestBody1DeliveryScheduleSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RequestBody1DeliveryScheduleSettings} obj Optional instance to populate.
     * @return {module:model/RequestBody1DeliveryScheduleSettings} The populated <code>RequestBody1DeliveryScheduleSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RequestBody1DeliveryScheduleSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>RequestBody1DeliveryScheduleSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RequestBody1DeliveryScheduleSettings</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RequestBody1DeliveryScheduleSettings.RequiredProperties) {
...
RequestBody1DeliveryScheduleSettings.RequiredProperties = ["dayOfWeekForDelivery", "maxRangeDelivery", "useDeliverySchedule"];
 ...
 */
RequestBody1DeliveryScheduleSettings.prototype['dayOfWeekForDelivery'] = undefined;
 ...
 */
RequestBody1DeliveryScheduleSettings.prototype['maxRangeDelivery'] = undefined;

/**
 * Select the Scheduled Delivery configuration.
 * @member {Boolean} useDeliverySchedule
 */
RequestBody1DeliveryScheduleSettings.prototype['useDeliverySchedule'] = undefined;
...
export default RequestBody1DeliveryScheduleSettings;
