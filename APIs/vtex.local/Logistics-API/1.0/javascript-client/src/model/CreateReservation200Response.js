...
/**
 * The CreateReservation200Response model module.
 * @module model/CreateReservation200Response
 * @version 1.0
 */
class CreateReservation200Response {
    /**
     * Constructs a new <code>CreateReservation200Response</code>.
     * @alias module:model/CreateReservation200Response
    ...
    constructor(authorizedDateUtc, canceledDateUtc, confirmedDateUtc, errors, isSucess, lastUpdateDateUtc, lockId, maximumConfirmationDateUtc, pickupPointItemOptions, reservationDateUtc, salesChannel, slaRequest, status) { 
        ...
        CreateReservation200Response.initialize(this, authorizedDateUtc, canceledDateUtc, confirmedDateUtc, errors, isSucess, lastUpdateDateUtc, lockId, maximumConfirmationDateUtc, pickupPointItemOptions, reservationDateUtc, salesChannel, slaRequest, status);
    }
    ...
    /**
     * Constructs a <code>CreateReservation200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateReservation200Response} obj Optional instance to populate.
     * @return {module:model/CreateReservation200Response} The populated <code>CreateReservation200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateReservation200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateReservation200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateReservation200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateReservation200Response.RequiredProperties) {
...
CreateReservation200Response.RequiredProperties = ["AuthorizedDateUtc", "CanceledDateUtc", "ConfirmedDateUtc", "Errors", "IsSucess", "LastUpdateDateUtc", "LockId", "MaximumConfirmationDateUtc", "PickupPointItemOptions", "ReservationDateUtc", "SalesChannel", "SlaRequest", "Status"];

/**
 * @member {String} AuthorizedDateUtc
 */
CreateReservation200Response.prototype['AuthorizedDateUtc'] = undefined;

/**
 * @member {String} CanceledDateUtc
 */
CreateReservation200Response.prototype['CanceledDateUtc'] = undefined;

/**
 * @member {String} ConfirmedDateUtc
 */
CreateReservation200Response.prototype['ConfirmedDateUtc'] = undefined;

/**
 * 
 * @member {Array.<String>} Errors
 */
CreateReservation200Response.prototype['Errors'] = undefined;

/**
 * @member {Boolean} IsSucess
 */
CreateReservation200Response.prototype['IsSucess'] = undefined;

/**
 * @member {String} LastUpdateDateUtc
 */
CreateReservation200Response.prototype['LastUpdateDateUtc'] = undefined;

/**
 * @member {String} LockId
 */
CreateReservation200Response.prototype['LockId'] = undefined;

/**
 * @member {String} MaximumConfirmationDateUtc
 */
CreateReservation200Response.prototype['MaximumConfirmationDateUtc'] = undefined;

/**
 * @member {String} PickupPointItemOptions
 */
CreateReservation200Response.prototype['PickupPointItemOptions'] = undefined;

/**
 * @member {String} ReservationDateUtc
 */
CreateReservation200Response.prototype['ReservationDateUtc'] = undefined;

/**
 * @member {String} SalesChannel
 */
CreateReservation200Response.prototype['SalesChannel'] = undefined;

/**
 * 
 * @member {Array.<module:model/SlaRequest1>} SlaRequest
 */
CreateReservation200Response.prototype['SlaRequest'] = undefined;

/**
 * @member {Number} Status
 */
CreateReservation200Response.prototype['Status'] = undefined;
...
export default CreateReservation200Response;
