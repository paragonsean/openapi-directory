...
void Example::exampleFunction1(){
     OAIDocksApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDocksApi::activateDockSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDocksApi::activateDockSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      QString dock_id = create(); // QString | 
      apiInstance.activateDock(content_typeacceptdock_id);
