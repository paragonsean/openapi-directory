...
/*
 * OAICreateUpdateCarrierRequest.h
 *
 * 
 */

#ifndef OAICreateUpdateCarrierRequest_H
#define OAICreateUpdateCarrierRequest_H
...
class OAICreateUpdateCarrierRequest : public OAIObject {
public:
    OAICreateUpdateCarrierRequest();
    OAICreateUpdateCarrierRequest(QString json);
    ~OAICreateUpdateCarrierRequest() override;
    ...
    qint32 getMinimunCubicWeight() const;
    void setMinimunCubicWeight(const qint32 &minimun_cubic_weight);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUpdateCarrierRequest)

#endif // OAICreateUpdateCarrierRequest_H
