...
#ifndef OAIGetById_1_H
#define OAIGetById_1_H
...
class OAIGetById_1 : public OAIObject {
public:
    OAIGetById_1();
    OAIGetById_1(QString json);
    ~OAIGetById_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetById_1)

#endif // OAIGetById_1_H
