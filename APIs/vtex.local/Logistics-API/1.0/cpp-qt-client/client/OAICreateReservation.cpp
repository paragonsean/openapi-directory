...
#include "OAICreateReservation.h"
...
OAICreateReservation::OAICreateReservation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateReservation::OAICreateReservation() {
    this->initializeModel();
}

OAICreateReservation::~OAICreateReservation() {}

void OAICreateReservation::initializeModel() {
...
void OAICreateReservation::fromJson(QString jsonString) {
...
void OAICreateReservation::fromJsonObject(QJsonObject json) {
...
QString OAICreateReservation::asJson() const {
...
QJsonObject OAICreateReservation::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateReservation::getAuthorizedDateUtc() const {
    return m_authorized_date_utc;
}
void OAICreateReservation::setAuthorizedDateUtc(const QString &authorized_date_utc) {
    m_authorized_date_utc = authorized_date_utc;
    m_authorized_date_utc_isSet = true;
}

bool OAICreateReservation::is_authorized_date_utc_Set() const{
    return m_authorized_date_utc_isSet;
}

bool OAICreateReservation::is_authorized_date_utc_Valid() const{
    return m_authorized_date_utc_isValid;
}

QString OAICreateReservation::getCanceledDateUtc() const {
    return m_canceled_date_utc;
}
void OAICreateReservation::setCanceledDateUtc(const QString &canceled_date_utc) {
    m_canceled_date_utc = canceled_date_utc;
    m_canceled_date_utc_isSet = true;
}

bool OAICreateReservation::is_canceled_date_utc_Set() const{
    return m_canceled_date_utc_isSet;
}

bool OAICreateReservation::is_canceled_date_utc_Valid() const{
    return m_canceled_date_utc_isValid;
}

QString OAICreateReservation::getConfirmedDateUtc() const {
    return m_confirmed_date_utc;
}
void OAICreateReservation::setConfirmedDateUtc(const QString &confirmed_date_utc) {
    m_confirmed_date_utc = confirmed_date_utc;
    m_confirmed_date_utc_isSet = true;
}

bool OAICreateReservation::is_confirmed_date_utc_Set() const{
    return m_confirmed_date_utc_isSet;
}

bool OAICreateReservation::is_confirmed_date_utc_Valid() const{
    return m_confirmed_date_utc_isValid;
}

QList<QString> OAICreateReservation::getErrors() const {
    return m_errors;
}
void OAICreateReservation::setErrors(const QList<QString> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAICreateReservation::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAICreateReservation::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAICreateReservation::isIsSucess() const {
    return m_is_sucess;
}
void OAICreateReservation::setIsSucess(const bool &is_sucess) {
    m_is_sucess = is_sucess;
    m_is_sucess_isSet = true;
}

bool OAICreateReservation::is_is_sucess_Set() const{
    return m_is_sucess_isSet;
}

bool OAICreateReservation::is_is_sucess_Valid() const{
    return m_is_sucess_isValid;
}

QString OAICreateReservation::getLastUpdateDateUtc() const {
    return m_last_update_date_utc;
}
void OAICreateReservation::setLastUpdateDateUtc(const QString &last_update_date_utc) {
    m_last_update_date_utc = last_update_date_utc;
    m_last_update_date_utc_isSet = true;
}

bool OAICreateReservation::is_last_update_date_utc_Set() const{
    return m_last_update_date_utc_isSet;
}

bool OAICreateReservation::is_last_update_date_utc_Valid() const{
    return m_last_update_date_utc_isValid;
}

QString OAICreateReservation::getLockId() const {
    return m_lock_id;
}
void OAICreateReservation::setLockId(const QString &lock_id) {
    m_lock_id = lock_id;
    m_lock_id_isSet = true;
}

bool OAICreateReservation::is_lock_id_Set() const{
    return m_lock_id_isSet;
}

bool OAICreateReservation::is_lock_id_Valid() const{
    return m_lock_id_isValid;
}

QString OAICreateReservation::getMaximumConfirmationDateUtc() const {
    return m_maximum_confirmation_date_utc;
}
void OAICreateReservation::setMaximumConfirmationDateUtc(const QString &maximum_confirmation_date_utc) {
    m_maximum_confirmation_date_utc = maximum_confirmation_date_utc;
    m_maximum_confirmation_date_utc_isSet = true;
}

bool OAICreateReservation::is_maximum_confirmation_date_utc_Set() const{
    return m_maximum_confirmation_date_utc_isSet;
}

bool OAICreateReservation::is_maximum_confirmation_date_utc_Valid() const{
    return m_maximum_confirmation_date_utc_isValid;
}

QString OAICreateReservation::getPickupPointItemOptions() const {
    return m_pickup_point_item_options;
}
void OAICreateReservation::setPickupPointItemOptions(const QString &pickup_point_item_options) {
    m_pickup_point_item_options = pickup_point_item_options;
    m_pickup_point_item_options_isSet = true;
}

bool OAICreateReservation::is_pickup_point_item_options_Set() const{
    return m_pickup_point_item_options_isSet;
}

bool OAICreateReservation::is_pickup_point_item_options_Valid() const{
    return m_pickup_point_item_options_isValid;
}

QString OAICreateReservation::getReservationDateUtc() const {
    return m_reservation_date_utc;
}
void OAICreateReservation::setReservationDateUtc(const QString &reservation_date_utc) {
    m_reservation_date_utc = reservation_date_utc;
    m_reservation_date_utc_isSet = true;
}

bool OAICreateReservation::is_reservation_date_utc_Set() const{
    return m_reservation_date_utc_isSet;
}

bool OAICreateReservation::is_reservation_date_utc_Valid() const{
    return m_reservation_date_utc_isValid;
}

QString OAICreateReservation::getSalesChannel() const {
    return m_sales_channel;
}
void OAICreateReservation::setSalesChannel(const QString &sales_channel) {
    m_sales_channel = sales_channel;
    m_sales_channel_isSet = true;
}

bool OAICreateReservation::is_sales_channel_Set() const{
    return m_sales_channel_isSet;
}

bool OAICreateReservation::is_sales_channel_Valid() const{
    return m_sales_channel_isValid;
}

QList<OAISlaRequest_1> OAICreateReservation::getSlaRequest() const {
    return m_sla_request;
}
void OAICreateReservation::setSlaRequest(const QList<OAISlaRequest_1> &sla_request) {
    m_sla_request = sla_request;
    m_sla_request_isSet = true;
}

bool OAICreateReservation::is_sla_request_Set() const{
    return m_sla_request_isSet;
}

bool OAICreateReservation::is_sla_request_Valid() const{
    return m_sla_request_isValid;
}

qint32 OAICreateReservation::getStatus() const {
    return m_status;
}
void OAICreateReservation::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateReservation::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateReservation::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICreateReservation::isSet() const {
...
bool OAICreateReservation::isValid() const {
