...
OAIItem3::OAIItem3(QString json) {
...
void OAIItem3::fromJson(QString jsonString) {
...
void OAIItem3::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIItem3::asJsonObject() const {
    QJsonObject obj;
...
QString OAIItem3::getAdditionalHandlingTime() const {
    return m_additional_handling_time;
}
void OAIItem3::setAdditionalHandlingTime(const QString &additional_handling_time) {
    m_additional_handling_time = additional_handling_time;
    m_additional_handling_time_isSet = true;
}

bool OAIItem3::is_additional_handling_time_Set() const{
    return m_additional_handling_time_isSet;
}

bool OAIItem3::is_additional_handling_time_Valid() const{
    return m_additional_handling_time_isValid;
}

OAIDimension_1 OAIItem3::getDimension() const {
    return m_dimension;
}
void OAIItem3::setDimension(const OAIDimension_1 &dimension) {
    m_dimension = dimension;
    m_dimension_isSet = true;
}

bool OAIItem3::is_dimension_Set() const{
    return m_dimension_isSet;
}

bool OAIItem3::is_dimension_Valid() const{
    return m_dimension_isValid;
}

QString OAIItem3::getGroupItemId() const {
    return m_group_item_id;
}
void OAIItem3::setGroupItemId(const QString &group_item_id) {
    m_group_item_id = group_item_id;
    m_group_item_id_isSet = true;
}

bool OAIItem3::is_group_item_id_Set() const{
    return m_group_item_id_isSet;
}

bool OAIItem3::is_group_item_id_Valid() const{
    return m_group_item_id_isValid;
}

QString OAIItem3::getId() const {
    return m_id;
}
void OAIItem3::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIItem3::is_id_Set() const{
    return m_id_isSet;
}

bool OAIItem3::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAIKitItem_1> OAIItem3::getKitItem() const {
    return m_kit_item;
}
void OAIItem3::setKitItem(const QList<OAIKitItem_1> &kit_item) {
    m_kit_item = kit_item;
    m_kit_item_isSet = true;
}

bool OAIItem3::is_kit_item_Set() const{
    return m_kit_item_isSet;
}

bool OAIItem3::is_kit_item_Valid() const{
    return m_kit_item_isValid;
}

qint32 OAIItem3::getPrice() const {
    return m_price;
}
void OAIItem3::setPrice(const qint32 &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIItem3::is_price_Set() const{
    return m_price_isSet;
}

bool OAIItem3::is_price_Valid() const{
    return m_price_isValid;
}

qint32 OAIItem3::getQuantity() const {
    return m_quantity;
}
void OAIItem3::setQuantity(const qint32 &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIItem3::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIItem3::is_quantity_Valid() const{
    return m_quantity_isValid;
}

bool OAIItem3::isSet() const {
