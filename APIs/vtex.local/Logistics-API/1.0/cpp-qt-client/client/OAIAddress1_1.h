...
#ifndef OAIAddress1_1_H
#define OAIAddress1_1_H
...
class OAIAddress1_1 : public OAIObject {
public:
    OAIAddress1_1();
    OAIAddress1_1(QString json);
    ~OAIAddress1_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddress1_1)

#endif // OAIAddress1_1_H
