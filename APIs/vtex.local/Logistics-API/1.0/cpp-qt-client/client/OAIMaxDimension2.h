...
#ifndef OAIMaxDimension2_H
#define OAIMaxDimension2_H
...
class OAIMaxDimension2 : public OAIObject {
public:
    OAIMaxDimension2();
    OAIMaxDimension2(QString json);
    ~OAIMaxDimension2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMaxDimension2)

#endif // OAIMaxDimension2_H
