...
#ifndef OAIAllcarrier_H
#define OAIAllcarrier_H
...
class OAIAllcarrier : public OAIObject {
public:
    OAIAllcarrier();
    OAIAllcarrier(QString json);
    ~OAIAllcarrier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAllcarrier)

#endif // OAIAllcarrier_H
