...
/*
 * OAIListReservationByWarehouseAndSKU.h
 *
 * 
 */

#ifndef OAIListReservationByWarehouseAndSKU_H
#define OAIListReservationByWarehouseAndSKU_H
...
class OAIListReservationByWarehouseAndSKU : public OAIObject {
public:
    OAIListReservationByWarehouseAndSKU();
    OAIListReservationByWarehouseAndSKU(QString json);
    ~OAIListReservationByWarehouseAndSKU() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListReservationByWarehouseAndSKU)

#endif // OAIListReservationByWarehouseAndSKU_H
