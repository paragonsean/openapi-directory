...
OAIBusinessHour_1::OAIBusinessHour_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBusinessHour_1::OAIBusinessHour_1() {
    this->initializeModel();
}

OAIBusinessHour_1::~OAIBusinessHour_1() {}

void OAIBusinessHour_1::initializeModel() {
...
void OAIBusinessHour_1::fromJson(QString jsonString) {
...
void OAIBusinessHour_1::fromJsonObject(QJsonObject json) {
...
QString OAIBusinessHour_1::asJson() const {
...
QJsonObject OAIBusinessHour_1::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBusinessHour_1::getClosingTime() const {
    return m_closing_time;
}
void OAIBusinessHour_1::setClosingTime(const QString &closing_time) {
    m_closing_time = closing_time;
    m_closing_time_isSet = true;
}

bool OAIBusinessHour_1::is_closing_time_Set() const{
    return m_closing_time_isSet;
}

bool OAIBusinessHour_1::is_closing_time_Valid() const{
    return m_closing_time_isValid;
}

qint32 OAIBusinessHour_1::getDayOfWeek() const {
    return m_day_of_week;
}
void OAIBusinessHour_1::setDayOfWeek(const qint32 &day_of_week) {
    m_day_of_week = day_of_week;
    m_day_of_week_isSet = true;
}

bool OAIBusinessHour_1::is_day_of_week_Set() const{
    return m_day_of_week_isSet;
}

bool OAIBusinessHour_1::is_day_of_week_Valid() const{
    return m_day_of_week_isValid;
}

QString OAIBusinessHour_1::getOpeningTime() const {
    return m_opening_time;
}
void OAIBusinessHour_1::setOpeningTime(const QString &opening_time) {
    m_opening_time = opening_time;
    m_opening_time_isSet = true;
}

bool OAIBusinessHour_1::is_opening_time_Set() const{
    return m_opening_time_isSet;
}

bool OAIBusinessHour_1::is_opening_time_Valid() const{
    return m_opening_time_isValid;
}

bool OAIBusinessHour_1::isSet() const {
...
bool OAIBusinessHour_1::isValid() const {
