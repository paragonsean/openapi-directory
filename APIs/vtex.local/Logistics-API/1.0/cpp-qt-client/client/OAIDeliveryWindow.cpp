...
OAIDeliveryWindow::OAIDeliveryWindow(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeliveryWindow::OAIDeliveryWindow() {
    this->initializeModel();
}

OAIDeliveryWindow::~OAIDeliveryWindow() {}

void OAIDeliveryWindow::initializeModel() {
...
void OAIDeliveryWindow::fromJson(QString jsonString) {
...
void OAIDeliveryWindow::fromJsonObject(QJsonObject json) {
...
QString OAIDeliveryWindow::asJson() const {
...
QJsonObject OAIDeliveryWindow::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeliveryWindow::getEndDateUtc() const {
    return m_end_date_utc;
}
void OAIDeliveryWindow::setEndDateUtc(const QString &end_date_utc) {
    m_end_date_utc = end_date_utc;
    m_end_date_utc_isSet = true;
}

bool OAIDeliveryWindow::is_end_date_utc_Set() const{
    return m_end_date_utc_isSet;
}

bool OAIDeliveryWindow::is_end_date_utc_Valid() const{
    return m_end_date_utc_isValid;
}

double OAIDeliveryWindow::getListPrice() const {
    return m_list_price;
}
void OAIDeliveryWindow::setListPrice(const double &list_price) {
    m_list_price = list_price;
    m_list_price_isSet = true;
}

bool OAIDeliveryWindow::is_list_price_Set() const{
    return m_list_price_isSet;
}

bool OAIDeliveryWindow::is_list_price_Valid() const{
    return m_list_price_isValid;
}

QString OAIDeliveryWindow::getStartDateUtc() const {
    return m_start_date_utc;
}
void OAIDeliveryWindow::setStartDateUtc(const QString &start_date_utc) {
    m_start_date_utc = start_date_utc;
    m_start_date_utc_isSet = true;
}

bool OAIDeliveryWindow::is_start_date_utc_Set() const{
    return m_start_date_utc_isSet;
}

bool OAIDeliveryWindow::is_start_date_utc_Valid() const{
    return m_start_date_utc_isValid;
}

bool OAIDeliveryWindow::isSet() const {
...
bool OAIDeliveryWindow::isValid() const {
