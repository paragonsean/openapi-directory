...
#ifndef OAIListAllDocks_H
#define OAIListAllDocks_H
...
class OAIListAllDocks : public OAIObject {
public:
    OAIListAllDocks();
    OAIListAllDocks(QString json);
    ~OAIListAllDocks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAllDocks)

#endif // OAIListAllDocks_H
