...
#ifndef OAIAddress2_H
#define OAIAddress2_H
...
class OAIAddress2 : public OAIObject {
public:
    OAIAddress2();
    OAIAddress2(QString json);
    ~OAIAddress2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddress2)
