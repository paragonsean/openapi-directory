...
/*
 * OAIReservationById_200_response_SlaRequest_inner.h
 *
 * 
 */

#ifndef OAIReservationById_200_response_SlaRequest_inner_H
#define OAIReservationById_200_response_SlaRequest_inner_H
...
class OAIReservationById_200_response_SlaRequest_inner : public OAIObject {
public:
    OAIReservationById_200_response_SlaRequest_inner();
    OAIReservationById_200_response_SlaRequest_inner(QString json);
    ~OAIReservationById_200_response_SlaRequest_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReservationById_200_response_SlaRequest_inner)

#endif // OAIReservationById_200_response_SlaRequest_inner_H
