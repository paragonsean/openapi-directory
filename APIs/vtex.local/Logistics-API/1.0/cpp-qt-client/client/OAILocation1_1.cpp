...
OAILocation1_1::OAILocation1_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILocation1_1::OAILocation1_1() {
    this->initializeModel();
}

OAILocation1_1::~OAILocation1_1() {}

void OAILocation1_1::initializeModel() {
...
void OAILocation1_1::fromJson(QString jsonString) {
...
void OAILocation1_1::fromJsonObject(QJsonObject json) {
...
QString OAILocation1_1::asJson() const {
...
QJsonObject OAILocation1_1::asJsonObject() const {
    QJsonObject obj;
    if (m_country_isSet) {
...
QString OAILocation1_1::getCountry() const {
    return m_country;
}
void OAILocation1_1::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAILocation1_1::is_country_Set() const{
    return m_country_isSet;
}

bool OAILocation1_1::is_country_Valid() const{
    return m_country_isValid;
}

QString OAILocation1_1::getDeliveryPointId() const {
    return m_delivery_point_id;
}
void OAILocation1_1::setDeliveryPointId(const QString &delivery_point_id) {
    m_delivery_point_id = delivery_point_id;
    m_delivery_point_id_isSet = true;
}

bool OAILocation1_1::is_delivery_point_id_Set() const{
    return m_delivery_point_id_isSet;
}

bool OAILocation1_1::is_delivery_point_id_Valid() const{
    return m_delivery_point_id_isValid;
}

OAIInStore1_1 OAILocation1_1::getInStore() const {
    return m_in_store;
}
void OAILocation1_1::setInStore(const OAIInStore1_1 &in_store) {
    m_in_store = in_store;
    m_in_store_isSet = true;
}

bool OAILocation1_1::is_in_store_Set() const{
    return m_in_store_isSet;
}

bool OAILocation1_1::is_in_store_Valid() const{
    return m_in_store_isValid;
}

QString OAILocation1_1::getPoint() const {
    return m_point;
}
void OAILocation1_1::setPoint(const QString &point) {
    m_point = point;
    m_point_isSet = true;
}

bool OAILocation1_1::is_point_Set() const{
    return m_point_isSet;
}

bool OAILocation1_1::is_point_Valid() const{
    return m_point_isValid;
}

QString OAILocation1_1::getZipCode() const {
    return m_zip_code;
}
void OAILocation1_1::setZipCode(const QString &zip_code) {
    m_zip_code = zip_code;
    m_zip_code_isSet = true;
}

bool OAILocation1_1::is_zip_code_Set() const{
    return m_zip_code_isSet;
}

bool OAILocation1_1::is_zip_code_Valid() const{
    return m_zip_code_isValid;
}

bool OAILocation1_1::isSet() const {
...
bool OAILocation1_1::isValid() const {
