...
OAIAddress_1 OAIPickupStoreInfo::getAddress() const {
    return m_address;
}
void OAIPickupStoreInfo::setAddress(const OAIAddress_1 &address) {
    m_address = address;
...
QString OAIPickupStoreInfo::getStoreId() const {
    return m_store_id;
}
void OAIPickupStoreInfo::setStoreId(const QString &store_id) {
    m_store_id = store_id;
    m_store_id_isSet = true;
}

bool OAIPickupStoreInfo::is_store_id_Set() const{
    return m_store_id_isSet;
}

bool OAIPickupStoreInfo::is_store_id_Valid() const{
