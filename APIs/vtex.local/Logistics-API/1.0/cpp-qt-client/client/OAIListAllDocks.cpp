...
OAIListAllDocks::OAIListAllDocks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAllDocks::OAIListAllDocks() {
    this->initializeModel();
}

OAIListAllDocks::~OAIListAllDocks() {}

void OAIListAllDocks::initializeModel() {
...
void OAIListAllDocks::fromJson(QString jsonString) {
...
void OAIListAllDocks::fromJsonObject(QJsonObject json) {
...
QString OAIListAllDocks::asJson() const {
...
QJsonObject OAIListAllDocks::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListAllDocks::getDockTimeFake() const {
    return m_dock_time_fake;
}
void OAIListAllDocks::setDockTimeFake(const QString &dock_time_fake) {
    m_dock_time_fake = dock_time_fake;
    m_dock_time_fake_isSet = true;
}

bool OAIListAllDocks::is_dock_time_fake_Set() const{
    return m_dock_time_fake_isSet;
}

bool OAIListAllDocks::is_dock_time_fake_Valid() const{
    return m_dock_time_fake_isValid;
}

QList<QString> OAIListAllDocks::getFreightTableIds() const {
    return m_freight_table_ids;
}
void OAIListAllDocks::setFreightTableIds(const QList<QString> &freight_table_ids) {
    m_freight_table_ids = freight_table_ids;
    m_freight_table_ids_isSet = true;
}

bool OAIListAllDocks::is_freight_table_ids_Set() const{
    return m_freight_table_ids_isSet;
}

bool OAIListAllDocks::is_freight_table_ids_Valid() const{
    return m_freight_table_ids_isValid;
}

QString OAIListAllDocks::getId() const {
    return m_id;
}
void OAIListAllDocks::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIListAllDocks::is_id_Set() const{
    return m_id_isSet;
}

bool OAIListAllDocks::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIListAllDocks::getName() const {
    return m_name;
}
void OAIListAllDocks::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIListAllDocks::is_name_Set() const{
    return m_name_isSet;
}

bool OAIListAllDocks::is_name_Valid() const{
    return m_name_isValid;
}

OAIPickupStoreInfo1_1 OAIListAllDocks::getPickupStoreInfo() const {
    return m_pickup_store_info;
}
void OAIListAllDocks::setPickupStoreInfo(const OAIPickupStoreInfo1_1 &pickup_store_info) {
    m_pickup_store_info = pickup_store_info;
    m_pickup_store_info_isSet = true;
}

bool OAIListAllDocks::is_pickup_store_info_Set() const{
    return m_pickup_store_info_isSet;
}

bool OAIListAllDocks::is_pickup_store_info_Valid() const{
    return m_pickup_store_info_isValid;
}

qint32 OAIListAllDocks::getPriority() const {
    return m_priority;
}
void OAIListAllDocks::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIListAllDocks::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIListAllDocks::is_priority_Valid() const{
    return m_priority_isValid;
}

QString OAIListAllDocks::getSalesChannel() const {
    return m_sales_channel;
}
void OAIListAllDocks::setSalesChannel(const QString &sales_channel) {
    m_sales_channel = sales_channel;
    m_sales_channel_isSet = true;
}

bool OAIListAllDocks::is_sales_channel_Set() const{
    return m_sales_channel_isSet;
}

bool OAIListAllDocks::is_sales_channel_Valid() const{
    return m_sales_channel_isValid;
}

QList<QString> OAIListAllDocks::getSalesChannels() const {
    return m_sales_channels;
}
void OAIListAllDocks::setSalesChannels(const QList<QString> &sales_channels) {
    m_sales_channels = sales_channels;
    m_sales_channels_isSet = true;
}

bool OAIListAllDocks::is_sales_channels_Set() const{
    return m_sales_channels_isSet;
}

bool OAIListAllDocks::is_sales_channels_Valid() const{
    return m_sales_channels_isValid;
}

QString OAIListAllDocks::getTimeFakeOverhead() const {
    return m_time_fake_overhead;
}
void OAIListAllDocks::setTimeFakeOverhead(const QString &time_fake_overhead) {
    m_time_fake_overhead = time_fake_overhead;
    m_time_fake_overhead_isSet = true;
}

bool OAIListAllDocks::is_time_fake_overhead_Set() const{
    return m_time_fake_overhead_isSet;
}

bool OAIListAllDocks::is_time_fake_overhead_Valid() const{
    return m_time_fake_overhead_isValid;
}

QString OAIListAllDocks::getWmsEndPoint() const {
    return m_wms_end_point;
}
void OAIListAllDocks::setWmsEndPoint(const QString &wms_end_point) {
    m_wms_end_point = wms_end_point;
    m_wms_end_point_isSet = true;
}

bool OAIListAllDocks::is_wms_end_point_Set() const{
    return m_wms_end_point_isSet;
}

bool OAIListAllDocks::is_wms_end_point_Valid() const{
    return m_wms_end_point_isValid;
}

bool OAIListAllDocks::isSet() const {
...
bool OAIListAllDocks::isValid() const {
