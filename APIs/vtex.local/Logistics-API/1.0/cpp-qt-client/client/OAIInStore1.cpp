...
OAIInStore1::OAIInStore1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInStore1::OAIInStore1() {
    this->initializeModel();
}

OAIInStore1::~OAIInStore1() {}

void OAIInStore1::initializeModel() {
...
void OAIInStore1::fromJson(QString jsonString) {
...
void OAIInStore1::fromJsonObject(QJsonObject json) {
...
QString OAIInStore1::asJson() const {
...
QJsonObject OAIInStore1::asJsonObject() const {
    QJsonObject obj;
...
bool OAIInStore1::isIsCheckedIn() const {
    return m_is_checked_in;
}
void OAIInStore1::setIsCheckedIn(const bool &is_checked_in) {
    m_is_checked_in = is_checked_in;
    m_is_checked_in_isSet = true;
}

bool OAIInStore1::is_is_checked_in_Set() const{
    return m_is_checked_in_isSet;
}

bool OAIInStore1::is_is_checked_in_Valid() const{
    return m_is_checked_in_isValid;
}

QString OAIInStore1::getStoreId() const {
    return m_store_id;
}
void OAIInStore1::setStoreId(const QString &store_id) {
    m_store_id = store_id;
    m_store_id_isSet = true;
}

bool OAIInStore1::is_store_id_Set() const{
    return m_store_id_isSet;
}

bool OAIInStore1::is_store_id_Valid() const{
    return m_store_id_isValid;
}

bool OAIInStore1::isSet() const {
...
bool OAIInStore1::isValid() const {
