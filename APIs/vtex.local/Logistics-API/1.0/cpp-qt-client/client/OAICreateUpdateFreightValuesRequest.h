...
/*
 * OAICreateUpdateFreightValuesRequest.h
 *
 * 
 */

#ifndef OAICreateUpdateFreightValuesRequest_H
#define OAICreateUpdateFreightValuesRequest_H
...
class OAICreateUpdateFreightValuesRequest : public OAIObject {
public:
    OAICreateUpdateFreightValuesRequest();
    OAICreateUpdateFreightValuesRequest(QString json);
    ~OAICreateUpdateFreightValuesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUpdateFreightValuesRequest)

#endif // OAICreateUpdateFreightValuesRequest_H
