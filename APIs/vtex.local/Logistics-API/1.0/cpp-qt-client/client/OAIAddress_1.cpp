...
QString OAIAddress_1::getComplement() const {
    return m_complement;
}
void OAIAddress_1::setComplement(const QString &complement) {
    m_complement = complement;
    m_complement_isSet = true;
}

bool OAIAddress_1::is_complement_Set() const{
    return m_complement_isSet;
}

bool OAIAddress_1::is_complement_Valid() const{
    return m_complement_isValid;
}

QString OAIAddress_1::getCoordinates() const {
    return m_coordinates;
}
void OAIAddress_1::setCoordinates(const QString &coordinates) {
    m_coordinates = coordinates;
    m_coordinates_isSet = true;
}

bool OAIAddress_1::is_coordinates_Set() const{
    return m_coordinates_isSet;
}

bool OAIAddress_1::is_coordinates_Valid() const{
    return m_coordinates_isValid;
}

OAICountry_1 OAIAddress_1::getCountry() const {
    return m_country;
}
void OAIAddress_1::setCountry(const OAICountry_1 &country) {
    m_country = country;
...
QString OAIAddress_1::getNeighborhood() const {
    return m_neighborhood;
}
void OAIAddress_1::setNeighborhood(const QString &neighborhood) {
    m_neighborhood = neighborhood;
    m_neighborhood_isSet = true;
}

bool OAIAddress_1::is_neighborhood_Set() const{
    return m_neighborhood_isSet;
}

bool OAIAddress_1::is_neighborhood_Valid() const{
    return m_neighborhood_isValid;
}

QString OAIAddress_1::getNumber() const {
    return m_number;
}
void OAIAddress_1::setNumber(const QString &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIAddress_1::is_number_Set() const{
    return m_number_isSet;
}

bool OAIAddress_1::is_number_Valid() const{
    return m_number_isValid;
}

QString OAIAddress_1::getPostalCode() const {
    return m_postal_code;
}
void OAIAddress_1::setPostalCode(const QString &postal_code) {
    m_postal_code = postal_code;
    m_postal_code_isSet = true;
}

bool OAIAddress_1::is_postal_code_Set() const{
    return m_postal_code_isSet;
}

bool OAIAddress_1::is_postal_code_Valid() const{
...
QString OAIAddress_1::getStreet() const {
    return m_street;
}
void OAIAddress_1::setStreet(const QString &street) {
    m_street = street;
    m_street_isSet = true;
}

bool OAIAddress_1::is_street_Set() const{
    return m_street_isSet;
}

bool OAIAddress_1::is_street_Valid() const{
