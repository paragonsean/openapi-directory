...
#ifndef OAIInStore_1_H
#define OAIInStore_1_H
...
class OAIInStore_1 : public OAIObject {
public:
    OAIInStore_1();
    OAIInStore_1(QString json);
    ~OAIInStore_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInStore_1)

#endif // OAIInStore_1_H
