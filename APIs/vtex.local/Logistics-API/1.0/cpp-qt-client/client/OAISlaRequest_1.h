...
#ifndef OAISlaRequest_1_H
#define OAISlaRequest_1_H
...
class OAISlaRequest_1 : public OAIObject {
public:
    OAISlaRequest_1();
    OAISlaRequest_1(QString json);
    ~OAISlaRequest_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISlaRequest_1)

#endif // OAISlaRequest_1_H
