...
#ifndef OAIDimension_1_H
#define OAIDimension_1_H
...
class OAIDimension_1 : public OAIObject {
public:
    OAIDimension_1();
    OAIDimension_1(QString json);
    ~OAIDimension_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDimension_1)

#endif // OAIDimension_1_H
