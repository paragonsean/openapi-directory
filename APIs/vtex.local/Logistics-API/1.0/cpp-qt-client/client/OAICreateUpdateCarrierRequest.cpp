...
#include "OAICreateUpdateCarrierRequest.h"
...
OAICreateUpdateCarrierRequest::OAICreateUpdateCarrierRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUpdateCarrierRequest::OAICreateUpdateCarrierRequest() {
    this->initializeModel();
}

OAICreateUpdateCarrierRequest::~OAICreateUpdateCarrierRequest() {}

void OAICreateUpdateCarrierRequest::initializeModel() {
...
void OAICreateUpdateCarrierRequest::fromJson(QString jsonString) {
...
void OAICreateUpdateCarrierRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateUpdateCarrierRequest::asJson() const {
...
QJsonObject OAICreateUpdateCarrierRequest::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAICreateUpdateCarrierRequest::getCarrierSchedule() const {
    return m_carrier_schedule;
}
void OAICreateUpdateCarrierRequest::setCarrierSchedule(const QList<QString> &carrier_schedule) {
    m_carrier_schedule = carrier_schedule;
    m_carrier_schedule_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_carrier_schedule_Set() const{
    return m_carrier_schedule_isSet;
}

bool OAICreateUpdateCarrierRequest::is_carrier_schedule_Valid() const{
    return m_carrier_schedule_isValid;
}

QList<QString> OAICreateUpdateCarrierRequest::getDayOfWeekBlockeds() const {
    return m_day_of_week_blockeds;
}
void OAICreateUpdateCarrierRequest::setDayOfWeekBlockeds(const QList<QString> &day_of_week_blockeds) {
    m_day_of_week_blockeds = day_of_week_blockeds;
    m_day_of_week_blockeds_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_day_of_week_blockeds_Set() const{
    return m_day_of_week_blockeds_isSet;
}

bool OAICreateUpdateCarrierRequest::is_day_of_week_blockeds_Valid() const{
    return m_day_of_week_blockeds_isValid;
}

QList<OAIDayOfWeekForDelivery_inner> OAICreateUpdateCarrierRequest::getDayOfWeekForDelivery() const {
    return m_day_of_week_for_delivery;
}
void OAICreateUpdateCarrierRequest::setDayOfWeekForDelivery(const QList<OAIDayOfWeekForDelivery_inner> &day_of_week_for_delivery) {
    m_day_of_week_for_delivery = day_of_week_for_delivery;
    m_day_of_week_for_delivery_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_day_of_week_for_delivery_Set() const{
    return m_day_of_week_for_delivery_isSet;
}

bool OAICreateUpdateCarrierRequest::is_day_of_week_for_delivery_Valid() const{
    return m_day_of_week_for_delivery_isValid;
}

bool OAICreateUpdateCarrierRequest::isDeliveryOnWeekends() const {
    return m_delivery_on_weekends;
}
void OAICreateUpdateCarrierRequest::setDeliveryOnWeekends(const bool &delivery_on_weekends) {
    m_delivery_on_weekends = delivery_on_weekends;
    m_delivery_on_weekends_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_delivery_on_weekends_Set() const{
    return m_delivery_on_weekends_isSet;
}

bool OAICreateUpdateCarrierRequest::is_delivery_on_weekends_Valid() const{
    return m_delivery_on_weekends_isValid;
}

bool OAICreateUpdateCarrierRequest::isExclusiveToDeliveryPoints() const {
    return m_exclusive_to_delivery_points;
}
void OAICreateUpdateCarrierRequest::setExclusiveToDeliveryPoints(const bool &exclusive_to_delivery_points) {
    m_exclusive_to_delivery_points = exclusive_to_delivery_points;
    m_exclusive_to_delivery_points_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_exclusive_to_delivery_points_Set() const{
    return m_exclusive_to_delivery_points_isSet;
}

bool OAICreateUpdateCarrierRequest::is_exclusive_to_delivery_points_Valid() const{
    return m_exclusive_to_delivery_points_isValid;
}

QString OAICreateUpdateCarrierRequest::getFactorCubicWeight() const {
    return m_factor_cubic_weight;
}
void OAICreateUpdateCarrierRequest::setFactorCubicWeight(const QString &factor_cubic_weight) {
    m_factor_cubic_weight = factor_cubic_weight;
    m_factor_cubic_weight_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_factor_cubic_weight_Set() const{
    return m_factor_cubic_weight_isSet;
}

bool OAICreateUpdateCarrierRequest::is_factor_cubic_weight_Valid() const{
    return m_factor_cubic_weight_isValid;
}

qint32 OAICreateUpdateCarrierRequest::getFreightTableProcessStatus() const {
    return m_freight_table_process_status;
}
void OAICreateUpdateCarrierRequest::setFreightTableProcessStatus(const qint32 &freight_table_process_status) {
    m_freight_table_process_status = freight_table_process_status;
    m_freight_table_process_status_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_freight_table_process_status_Set() const{
    return m_freight_table_process_status_isSet;
}

bool OAICreateUpdateCarrierRequest::is_freight_table_process_status_Valid() const{
    return m_freight_table_process_status_isValid;
}

QString OAICreateUpdateCarrierRequest::getFreightTableValueError() const {
    return m_freight_table_value_error;
}
void OAICreateUpdateCarrierRequest::setFreightTableValueError(const QString &freight_table_value_error) {
    m_freight_table_value_error = freight_table_value_error;
    m_freight_table_value_error_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_freight_table_value_error_Set() const{
    return m_freight_table_value_error_isSet;
}

bool OAICreateUpdateCarrierRequest::is_freight_table_value_error_Valid() const{
    return m_freight_table_value_error_isValid;
}

QList<QString> OAICreateUpdateCarrierRequest::getFreightValue() const {
    return m_freight_value;
}
void OAICreateUpdateCarrierRequest::setFreightValue(const QList<QString> &freight_value) {
    m_freight_value = freight_value;
    m_freight_value_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_freight_value_Set() const{
    return m_freight_value_isSet;
}

bool OAICreateUpdateCarrierRequest::is_freight_value_Valid() const{
    return m_freight_value_isValid;
}

QString OAICreateUpdateCarrierRequest::getId() const {
    return m_id;
}
void OAICreateUpdateCarrierRequest::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreateUpdateCarrierRequest::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICreateUpdateCarrierRequest::isIsPolygon() const {
    return m_is_polygon;
}
void OAICreateUpdateCarrierRequest::setIsPolygon(const bool &is_polygon) {
    m_is_polygon = is_polygon;
    m_is_polygon_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_is_polygon_Set() const{
    return m_is_polygon_isSet;
}

bool OAICreateUpdateCarrierRequest::is_is_polygon_Valid() const{
    return m_is_polygon_isValid;
}

OAIMaxDimension_1 OAICreateUpdateCarrierRequest::getMaxDimension() const {
    return m_max_dimension;
}
void OAICreateUpdateCarrierRequest::setMaxDimension(const OAIMaxDimension_1 &max_dimension) {
    m_max_dimension = max_dimension;
    m_max_dimension_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_max_dimension_Set() const{
    return m_max_dimension_isSet;
}

bool OAICreateUpdateCarrierRequest::is_max_dimension_Valid() const{
    return m_max_dimension_isValid;
}

qint32 OAICreateUpdateCarrierRequest::getMaxRangeDelivery() const {
    return m_max_range_delivery;
}
void OAICreateUpdateCarrierRequest::setMaxRangeDelivery(const qint32 &max_range_delivery) {
    m_max_range_delivery = max_range_delivery;
    m_max_range_delivery_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_max_range_delivery_Set() const{
    return m_max_range_delivery_isSet;
}

bool OAICreateUpdateCarrierRequest::is_max_range_delivery_Valid() const{
    return m_max_range_delivery_isValid;
}

qint32 OAICreateUpdateCarrierRequest::getMinimunCubicWeight() const {
    return m_minimun_cubic_weight;
}
void OAICreateUpdateCarrierRequest::setMinimunCubicWeight(const qint32 &minimun_cubic_weight) {
    m_minimun_cubic_weight = minimun_cubic_weight;
    m_minimun_cubic_weight_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_minimun_cubic_weight_Set() const{
    return m_minimun_cubic_weight_isSet;
}

bool OAICreateUpdateCarrierRequest::is_minimun_cubic_weight_Valid() const{
    return m_minimun_cubic_weight_isValid;
}

QList<QString> OAICreateUpdateCarrierRequest::getModals() const {
    return m_modals;
}
void OAICreateUpdateCarrierRequest::setModals(const QList<QString> &modals) {
    m_modals = modals;
    m_modals_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_modals_Set() const{
    return m_modals_isSet;
}

bool OAICreateUpdateCarrierRequest::is_modals_Valid() const{
    return m_modals_isValid;
}

QString OAICreateUpdateCarrierRequest::getName() const {
    return m_name;
}
void OAICreateUpdateCarrierRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateUpdateCarrierRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateUpdateCarrierRequest::getNumberOfItemsPerShipment() const {
    return m_number_of_items_per_shipment;
}
void OAICreateUpdateCarrierRequest::setNumberOfItemsPerShipment(const QString &number_of_items_per_shipment) {
    m_number_of_items_per_shipment = number_of_items_per_shipment;
    m_number_of_items_per_shipment_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_number_of_items_per_shipment_Set() const{
    return m_number_of_items_per_shipment_isSet;
}

bool OAICreateUpdateCarrierRequest::is_number_of_items_per_shipment_Valid() const{
    return m_number_of_items_per_shipment_isValid;
}

bool OAICreateUpdateCarrierRequest::isOnlyItemsWithDefinedModal() const {
    return m_only_items_with_defined_modal;
}
void OAICreateUpdateCarrierRequest::setOnlyItemsWithDefinedModal(const bool &only_items_with_defined_modal) {
    m_only_items_with_defined_modal = only_items_with_defined_modal;
    m_only_items_with_defined_modal_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_only_items_with_defined_modal_Set() const{
    return m_only_items_with_defined_modal_isSet;
}

bool OAICreateUpdateCarrierRequest::is_only_items_with_defined_modal_Valid() const{
    return m_only_items_with_defined_modal_isValid;
}

bool OAICreateUpdateCarrierRequest::isScheduledDelivery() const {
    return m_scheduled_delivery;
}
void OAICreateUpdateCarrierRequest::setScheduledDelivery(const bool &scheduled_delivery) {
    m_scheduled_delivery = scheduled_delivery;
    m_scheduled_delivery_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_scheduled_delivery_Set() const{
    return m_scheduled_delivery_isSet;
}

bool OAICreateUpdateCarrierRequest::is_scheduled_delivery_Valid() const{
    return m_scheduled_delivery_isValid;
}

QString OAICreateUpdateCarrierRequest::getSlaType() const {
    return m_sla_type;
}
void OAICreateUpdateCarrierRequest::setSlaType(const QString &sla_type) {
    m_sla_type = sla_type;
    m_sla_type_isSet = true;
}

bool OAICreateUpdateCarrierRequest::is_sla_type_Set() const{
    return m_sla_type_isSet;
}

bool OAICreateUpdateCarrierRequest::is_sla_type_Valid() const{
    return m_sla_type_isValid;
}

bool OAICreateUpdateCarrierRequest::isSet() const {
...
bool OAICreateUpdateCarrierRequest::isValid() const {
