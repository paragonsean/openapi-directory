...
class OAIItem3_1 : public OAIObject {
public:
    OAIItem3_1();
    OAIItem3_1(QString json);
    ~OAIItem3_1() override;
    ...
    QList<OAIKitItem_1> getKitItem() const;
    void setKitItem(const QList<OAIKitItem_1> &kit_item);
...
Q_DECLARE_METATYPE(OpenAPI::OAIItem3_1)
