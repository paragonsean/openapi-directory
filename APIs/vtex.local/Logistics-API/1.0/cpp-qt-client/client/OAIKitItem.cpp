...
OAIKitItem::OAIKitItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKitItem::OAIKitItem() {
    this->initializeModel();
}

OAIKitItem::~OAIKitItem() {}

void OAIKitItem::initializeModel() {
...
void OAIKitItem::fromJson(QString jsonString) {
...
void OAIKitItem::fromJsonObject(QJsonObject json) {
...
QString OAIKitItem::asJson() const {
...
QJsonObject OAIKitItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAIKitItem::getAdditionalHandlingTime() const {
    return m_additional_handling_time;
}
void OAIKitItem::setAdditionalHandlingTime(const QString &additional_handling_time) {
    m_additional_handling_time = additional_handling_time;
    m_additional_handling_time_isSet = true;
}

bool OAIKitItem::is_additional_handling_time_Set() const{
    return m_additional_handling_time_isSet;
}

bool OAIKitItem::is_additional_handling_time_Valid() const{
    return m_additional_handling_time_isValid;
}

OAIDimension_1 OAIKitItem::getDimension() const {
    return m_dimension;
}
void OAIKitItem::setDimension(const OAIDimension_1 &dimension) {
    m_dimension = dimension;
    m_dimension_isSet = true;
}

bool OAIKitItem::is_dimension_Set() const{
    return m_dimension_isSet;
}

bool OAIKitItem::is_dimension_Valid() const{
    return m_dimension_isValid;
}

QString OAIKitItem::getGroupItemId() const {
    return m_group_item_id;
}
void OAIKitItem::setGroupItemId(const QString &group_item_id) {
    m_group_item_id = group_item_id;
    m_group_item_id_isSet = true;
}

bool OAIKitItem::is_group_item_id_Set() const{
    return m_group_item_id_isSet;
}

bool OAIKitItem::is_group_item_id_Valid() const{
    return m_group_item_id_isValid;
}

QString OAIKitItem::getId() const {
    return m_id;
}
void OAIKitItem::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIKitItem::is_id_Set() const{
    return m_id_isSet;
}

bool OAIKitItem::is_id_Valid() const{
    return m_id_isValid;
}

QList<QString> OAIKitItem::getKitItem() const {
    return m_kit_item;
}
void OAIKitItem::setKitItem(const QList<QString> &kit_item) {
    m_kit_item = kit_item;
    m_kit_item_isSet = true;
}

bool OAIKitItem::is_kit_item_Set() const{
    return m_kit_item_isSet;
}

bool OAIKitItem::is_kit_item_Valid() const{
    return m_kit_item_isValid;
}

qint32 OAIKitItem::getPrice() const {
    return m_price;
}
void OAIKitItem::setPrice(const qint32 &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIKitItem::is_price_Set() const{
    return m_price_isSet;
}

bool OAIKitItem::is_price_Valid() const{
    return m_price_isValid;
}

qint32 OAIKitItem::getQuantity() const {
    return m_quantity;
}
void OAIKitItem::setQuantity(const qint32 &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIKitItem::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIKitItem::is_quantity_Valid() const{
    return m_quantity_isValid;
}

bool OAIKitItem::isSet() const {
