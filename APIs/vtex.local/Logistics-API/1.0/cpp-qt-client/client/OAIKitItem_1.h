...
#ifndef OAIKitItem_1_H
#define OAIKitItem_1_H
...
class OAIKitItem_1 : public OAIObject {
public:
    OAIKitItem_1();
    OAIKitItem_1(QString json);
    ~OAIKitItem_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKitItem_1)

#endif // OAIKitItem_1_H
