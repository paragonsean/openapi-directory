...
#ifndef OAIAddress4_H
#define OAIAddress4_H
...
class OAIAddress4 : public OAIObject {
public:
    OAIAddress4();
    OAIAddress4(QString json);
    ~OAIAddress4() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddress4)
