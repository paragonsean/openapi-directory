...
/*
 * OAICreateUpdateDockRequest.h
 *
 * 
 */

#ifndef OAICreateUpdateDockRequest_H
#define OAICreateUpdateDockRequest_H

#include <QJsonObject>

#include "OAIAddress1_1.h"
#include "OAIPickupStoreInfo_1.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIAddress1_1;
class OAIPickupStoreInfo_1;

class OAICreateUpdateDockRequest : public OAIObject {
public:
    OAICreateUpdateDockRequest();
    OAICreateUpdateDockRequest(QString json);
    ~OAICreateUpdateDockRequest() override;
    ...
    OAIPickupStoreInfo_1 getPickupStoreInfo() const;
    void setPickupStoreInfo(const OAIPickupStoreInfo_1 &pickup_store_info);
...
private:
    ...
    OAIPickupStoreInfo_1 m_pickup_store_info;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUpdateDockRequest)

#endif // OAICreateUpdateDockRequest_H
