...
OAIDeliveryItemOption_1::OAIDeliveryItemOption_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeliveryItemOption_1::OAIDeliveryItemOption_1() {
    this->initializeModel();
}

OAIDeliveryItemOption_1::~OAIDeliveryItemOption_1() {}

void OAIDeliveryItemOption_1::initializeModel() {
...
void OAIDeliveryItemOption_1::fromJson(QString jsonString) {
...
void OAIDeliveryItemOption_1::fromJsonObject(QJsonObject json) {
...
QString OAIDeliveryItemOption_1::asJson() const {
...
QJsonObject OAIDeliveryItemOption_1::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeliveryItemOption_1::getAditionalTimeBlockedDays() const {
    return m_aditional_time_blocked_days;
}
void OAIDeliveryItemOption_1::setAditionalTimeBlockedDays(const QString &aditional_time_blocked_days) {
    m_aditional_time_blocked_days = aditional_time_blocked_days;
    m_aditional_time_blocked_days_isSet = true;
}

bool OAIDeliveryItemOption_1::is_aditional_time_blocked_days_Set() const{
    return m_aditional_time_blocked_days_isSet;
}

bool OAIDeliveryItemOption_1::is_aditional_time_blocked_days_Valid() const{
    return m_aditional_time_blocked_days_isValid;
}

QList<QString> OAIDeliveryItemOption_1::getDeliveryWindows() const {
    return m_delivery_windows;
}
void OAIDeliveryItemOption_1::setDeliveryWindows(const QList<QString> &delivery_windows) {
    m_delivery_windows = delivery_windows;
    m_delivery_windows_isSet = true;
}

bool OAIDeliveryItemOption_1::is_delivery_windows_Set() const{
    return m_delivery_windows_isSet;
}

bool OAIDeliveryItemOption_1::is_delivery_windows_Valid() const{
    return m_delivery_windows_isValid;
}

QString OAIDeliveryItemOption_1::getDockId() const {
    return m_dock_id;
}
void OAIDeliveryItemOption_1::setDockId(const QString &dock_id) {
    m_dock_id = dock_id;
    m_dock_id_isSet = true;
}

bool OAIDeliveryItemOption_1::is_dock_id_Set() const{
    return m_dock_id_isSet;
}

bool OAIDeliveryItemOption_1::is_dock_id_Valid() const{
    return m_dock_id_isValid;
}

QString OAIDeliveryItemOption_1::getDockTime() const {
    return m_dock_time;
}
void OAIDeliveryItemOption_1::setDockTime(const QString &dock_time) {
    m_dock_time = dock_time;
    m_dock_time_isSet = true;
}

bool OAIDeliveryItemOption_1::is_dock_time_Set() const{
    return m_dock_time_isSet;
}

bool OAIDeliveryItemOption_1::is_dock_time_Valid() const{
    return m_dock_time_isValid;
}

OAIItem_1 OAIDeliveryItemOption_1::getItem() const {
    return m_item;
}
void OAIDeliveryItemOption_1::setItem(const OAIItem_1 &item) {
    m_item = item;
    m_item_isSet = true;
}

bool OAIDeliveryItemOption_1::is_item_Set() const{
    return m_item_isSet;
}

bool OAIDeliveryItemOption_1::is_item_Valid() const{
    return m_item_isValid;
}

double OAIDeliveryItemOption_1::getListPrice() const {
    return m_list_price;
}
void OAIDeliveryItemOption_1::setListPrice(const double &list_price) {
    m_list_price = list_price;
    m_list_price_isSet = true;
}

bool OAIDeliveryItemOption_1::is_list_price_Set() const{
    return m_list_price_isSet;
}

bool OAIDeliveryItemOption_1::is_list_price_Valid() const{
    return m_list_price_isValid;
}

OAILocation_1 OAIDeliveryItemOption_1::getLocation() const {
    return m_location;
}
void OAIDeliveryItemOption_1::setLocation(const OAILocation_1 &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIDeliveryItemOption_1::is_location_Set() const{
    return m_location_isSet;
}

bool OAIDeliveryItemOption_1::is_location_Valid() const{
    return m_location_isValid;
}

double OAIDeliveryItemOption_1::getPromotionalPrice() const {
    return m_promotional_price;
}
void OAIDeliveryItemOption_1::setPromotionalPrice(const double &promotional_price) {
    m_promotional_price = promotional_price;
    m_promotional_price_isSet = true;
}

bool OAIDeliveryItemOption_1::is_promotional_price_Set() const{
    return m_promotional_price_isSet;
}

bool OAIDeliveryItemOption_1::is_promotional_price_Valid() const{
    return m_promotional_price_isValid;
}

QString OAIDeliveryItemOption_1::getSlaType() const {
    return m_sla_type;
}
void OAIDeliveryItemOption_1::setSlaType(const QString &sla_type) {
    m_sla_type = sla_type;
    m_sla_type_isSet = true;
}

bool OAIDeliveryItemOption_1::is_sla_type_Set() const{
    return m_sla_type_isSet;
}

bool OAIDeliveryItemOption_1::is_sla_type_Valid() const{
    return m_sla_type_isValid;
}

QString OAIDeliveryItemOption_1::getSlaTypeName() const {
    return m_sla_type_name;
}
void OAIDeliveryItemOption_1::setSlaTypeName(const QString &sla_type_name) {
    m_sla_type_name = sla_type_name;
    m_sla_type_name_isSet = true;
}

bool OAIDeliveryItemOption_1::is_sla_type_name_Set() const{
    return m_sla_type_name_isSet;
}

bool OAIDeliveryItemOption_1::is_sla_type_name_Valid() const{
    return m_sla_type_name_isValid;
}

QString OAIDeliveryItemOption_1::getTimeToDockPlusDockTime() const {
    return m_time_to_dock_plus_dock_time;
}
void OAIDeliveryItemOption_1::setTimeToDockPlusDockTime(const QString &time_to_dock_plus_dock_time) {
    m_time_to_dock_plus_dock_time = time_to_dock_plus_dock_time;
    m_time_to_dock_plus_dock_time_isSet = true;
}

bool OAIDeliveryItemOption_1::is_time_to_dock_plus_dock_time_Set() const{
    return m_time_to_dock_plus_dock_time_isSet;
}

bool OAIDeliveryItemOption_1::is_time_to_dock_plus_dock_time_Valid() const{
    return m_time_to_dock_plus_dock_time_isValid;
}

QString OAIDeliveryItemOption_1::getTotalTime() const {
    return m_total_time;
}
void OAIDeliveryItemOption_1::setTotalTime(const QString &total_time) {
    m_total_time = total_time;
    m_total_time_isSet = true;
}

bool OAIDeliveryItemOption_1::is_total_time_Set() const{
    return m_total_time_isSet;
}

bool OAIDeliveryItemOption_1::is_total_time_Valid() const{
    return m_total_time_isValid;
}

QString OAIDeliveryItemOption_1::getTransitTime() const {
    return m_transit_time;
}
void OAIDeliveryItemOption_1::setTransitTime(const QString &transit_time) {
    m_transit_time = transit_time;
    m_transit_time_isSet = true;
}

bool OAIDeliveryItemOption_1::is_transit_time_Set() const{
    return m_transit_time_isSet;
}

bool OAIDeliveryItemOption_1::is_transit_time_Valid() const{
    return m_transit_time_isValid;
}

QString OAIDeliveryItemOption_1::getWareHouseId() const {
    return m_ware_house_id;
}
void OAIDeliveryItemOption_1::setWareHouseId(const QString &ware_house_id) {
    m_ware_house_id = ware_house_id;
    m_ware_house_id_isSet = true;
}

bool OAIDeliveryItemOption_1::is_ware_house_id_Set() const{
    return m_ware_house_id_isSet;
}

bool OAIDeliveryItemOption_1::is_ware_house_id_Valid() const{
    return m_ware_house_id_isValid;
}

bool OAIDeliveryItemOption_1::isSet() const {
...
bool OAIDeliveryItemOption_1::isValid() const {
