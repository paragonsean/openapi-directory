...
#ifndef OAICreate_Update_H
#define OAICreate_Update_H
...
class OAICreate_Update : public OAIObject {
public:
    OAICreate_Update();
    OAICreate_Update(QString json);
    ~OAICreate_Update() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreate_Update)

#endif // OAICreate_Update_H
