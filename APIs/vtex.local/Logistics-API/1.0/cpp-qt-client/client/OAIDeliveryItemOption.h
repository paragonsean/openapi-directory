...
/*
 * OAIDeliveryItemOption.h
 *
 * 
 */

#ifndef OAIDeliveryItemOption_H
#define OAIDeliveryItemOption_H
...
class OAIDeliveryItemOption : public OAIObject {
public:
    OAIDeliveryItemOption();
    OAIDeliveryItemOption(QString json);
    ~OAIDeliveryItemOption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeliveryItemOption)

#endif // OAIDeliveryItemOption_H
