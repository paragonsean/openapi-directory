...
OAIPickupStoreInfo1_1::OAIPickupStoreInfo1_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPickupStoreInfo1_1::OAIPickupStoreInfo1_1() {
    this->initializeModel();
}

OAIPickupStoreInfo1_1::~OAIPickupStoreInfo1_1() {}

void OAIPickupStoreInfo1_1::initializeModel() {
...
void OAIPickupStoreInfo1_1::fromJson(QString jsonString) {
...
void OAIPickupStoreInfo1_1::fromJsonObject(QJsonObject json) {
...
QString OAIPickupStoreInfo1_1::asJson() const {
...
QJsonObject OAIPickupStoreInfo1_1::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPickupStoreInfo1_1::getAdditionalInfo() const {
    return m_additional_info;
}
void OAIPickupStoreInfo1_1::setAdditionalInfo(const QString &additional_info) {
    m_additional_info = additional_info;
    m_additional_info_isSet = true;
}

bool OAIPickupStoreInfo1_1::is_additional_info_Set() const{
    return m_additional_info_isSet;
}

bool OAIPickupStoreInfo1_1::is_additional_info_Valid() const{
    return m_additional_info_isValid;
}

QString OAIPickupStoreInfo1_1::getAddress() const {
    return m_address;
}
void OAIPickupStoreInfo1_1::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIPickupStoreInfo1_1::is_address_Set() const{
    return m_address_isSet;
}

bool OAIPickupStoreInfo1_1::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIPickupStoreInfo1_1::getDockId() const {
    return m_dock_id;
}
void OAIPickupStoreInfo1_1::setDockId(const QString &dock_id) {
    m_dock_id = dock_id;
    m_dock_id_isSet = true;
}

bool OAIPickupStoreInfo1_1::is_dock_id_Set() const{
    return m_dock_id_isSet;
}

bool OAIPickupStoreInfo1_1::is_dock_id_Valid() const{
    return m_dock_id_isValid;
}

QString OAIPickupStoreInfo1_1::getFriendlyName() const {
    return m_friendly_name;
}
void OAIPickupStoreInfo1_1::setFriendlyName(const QString &friendly_name) {
    m_friendly_name = friendly_name;
    m_friendly_name_isSet = true;
}

bool OAIPickupStoreInfo1_1::is_friendly_name_Set() const{
    return m_friendly_name_isSet;
}

bool OAIPickupStoreInfo1_1::is_friendly_name_Valid() const{
    return m_friendly_name_isValid;
}

bool OAIPickupStoreInfo1_1::isIsPickupStore() const {
    return m_is_pickup_store;
}
void OAIPickupStoreInfo1_1::setIsPickupStore(const bool &is_pickup_store) {
    m_is_pickup_store = is_pickup_store;
    m_is_pickup_store_isSet = true;
}

bool OAIPickupStoreInfo1_1::is_is_pickup_store_Set() const{
    return m_is_pickup_store_isSet;
}

bool OAIPickupStoreInfo1_1::is_is_pickup_store_Valid() const{
    return m_is_pickup_store_isValid;
}

QString OAIPickupStoreInfo1_1::getStoreId() const {
    return m_store_id;
}
void OAIPickupStoreInfo1_1::setStoreId(const QString &store_id) {
    m_store_id = store_id;
    m_store_id_isSet = true;
}

bool OAIPickupStoreInfo1_1::is_store_id_Set() const{
    return m_store_id_isSet;
}

bool OAIPickupStoreInfo1_1::is_store_id_Valid() const{
    return m_store_id_isValid;
}

bool OAIPickupStoreInfo1_1::isSet() const {
...
bool OAIPickupStoreInfo1_1::isValid() const {
