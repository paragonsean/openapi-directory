...
/*
 * OAIReservationById_200_response.h
 *
 * 
 */

#ifndef OAIReservationById_200_response_H
#define OAIReservationById_200_response_H
...
namespace OpenAPI {
class OAIReservationById_200_response_SlaRequest_inner;

class OAIReservationById_200_response : public OAIObject {
public:
    OAIReservationById_200_response();
    OAIReservationById_200_response(QString json);
    ~OAIReservationById_200_response() override;
    ...
    QList<OAIReservationById_200_response_SlaRequest_inner> getSlaRequest() const;
    void setSlaRequest(const QList<OAIReservationById_200_response_SlaRequest_inner> &sla_request);
...
private:
    ...
    QList<OAIReservationById_200_response_SlaRequest_inner> m_sla_request;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReservationById_200_response)

#endif // OAIReservationById_200_response_H
