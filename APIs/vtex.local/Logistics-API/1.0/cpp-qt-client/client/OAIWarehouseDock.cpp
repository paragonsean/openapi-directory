...
OAIWarehouseDock::OAIWarehouseDock(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWarehouseDock::OAIWarehouseDock() {
    this->initializeModel();
}

OAIWarehouseDock::~OAIWarehouseDock() {}

void OAIWarehouseDock::initializeModel() {
...
void OAIWarehouseDock::fromJson(QString jsonString) {
...
void OAIWarehouseDock::fromJsonObject(QJsonObject json) {
...
QString OAIWarehouseDock::asJson() const {
...
QJsonObject OAIWarehouseDock::asJsonObject() const {
    QJsonObject obj;
    if (m_cost_isSet) {
...
QString OAIWarehouseDock::getCost() const {
    return m_cost;
}
void OAIWarehouseDock::setCost(const QString &cost) {
    m_cost = cost;
    m_cost_isSet = true;
}

bool OAIWarehouseDock::is_cost_Set() const{
    return m_cost_isSet;
}

bool OAIWarehouseDock::is_cost_Valid() const{
    return m_cost_isValid;
}

QString OAIWarehouseDock::getCostToDisplay() const {
    return m_cost_to_display;
}
void OAIWarehouseDock::setCostToDisplay(const QString &cost_to_display) {
    m_cost_to_display = cost_to_display;
    m_cost_to_display_isSet = true;
}

bool OAIWarehouseDock::is_cost_to_display_Set() const{
    return m_cost_to_display_isSet;
}

bool OAIWarehouseDock::is_cost_to_display_Valid() const{
    return m_cost_to_display_isValid;
}

QString OAIWarehouseDock::getDockId() const {
    return m_dock_id;
}
void OAIWarehouseDock::setDockId(const QString &dock_id) {
    m_dock_id = dock_id;
    m_dock_id_isSet = true;
}

bool OAIWarehouseDock::is_dock_id_Set() const{
    return m_dock_id_isSet;
}

bool OAIWarehouseDock::is_dock_id_Valid() const{
    return m_dock_id_isValid;
}

QString OAIWarehouseDock::getName() const {
    return m_name;
}
void OAIWarehouseDock::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIWarehouseDock::is_name_Set() const{
    return m_name_isSet;
}

bool OAIWarehouseDock::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIWarehouseDock::getTime() const {
    return m_time;
}
void OAIWarehouseDock::setTime(const QString &time) {
    m_time = time;
    m_time_isSet = true;
}

bool OAIWarehouseDock::is_time_Set() const{
    return m_time_isSet;
}

bool OAIWarehouseDock::is_time_Valid() const{
    return m_time_isValid;
}

QString OAIWarehouseDock::getTranslateDays() const {
    return m_translate_days;
}
void OAIWarehouseDock::setTranslateDays(const QString &translate_days) {
    m_translate_days = translate_days;
    m_translate_days_isSet = true;
}

bool OAIWarehouseDock::is_translate_days_Set() const{
    return m_translate_days_isSet;
}

bool OAIWarehouseDock::is_translate_days_Valid() const{
    return m_translate_days_isValid;
}

bool OAIWarehouseDock::isSet() const {
...
bool OAIWarehouseDock::isValid() const {
