...
#ifndef OAIMaxDimension_1_H
#define OAIMaxDimension_1_H
...
class OAIMaxDimension_1 : public OAIObject {
public:
    OAIMaxDimension_1();
    OAIMaxDimension_1(QString json);
    ~OAIMaxDimension_1() override;
    ...
    qint32 getMaxSumDimension() const;
    void setMaxSumDimension(const qint32 &max_sum_dimension);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMaxDimension_1)

#endif // OAIMaxDimension_1_H
