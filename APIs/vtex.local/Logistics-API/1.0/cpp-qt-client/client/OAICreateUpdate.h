...
#ifndef OAICreateUpdate_H
#define OAICreateUpdate_H

#include <QJsonObject>

#include "OAIAddress2_1.h"
...
class OAICreateUpdate : public OAIObject {
public:
    OAICreateUpdate();
    OAICreateUpdate(QString json);
    ~OAICreateUpdate() override;
    ...
    OAIAddress2_1 getAddress() const;
    void setAddress(const OAIAddress2_1 &address);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUpdate)

#endif // OAICreateUpdate_H
