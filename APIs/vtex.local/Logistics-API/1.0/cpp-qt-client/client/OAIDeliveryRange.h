...
#ifndef OAIDeliveryRange_H
#define OAIDeliveryRange_H
...
class OAIDeliveryRange : public OAIObject {
public:
    OAIDeliveryRange();
    OAIDeliveryRange(QString json);
    ~OAIDeliveryRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeliveryRange)

#endif // OAIDeliveryRange_H
