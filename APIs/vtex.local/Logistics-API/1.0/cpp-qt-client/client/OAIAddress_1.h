...
#ifndef OAIAddress_1_H
#define OAIAddress_1_H
...
class OAIAddress_1 : public OAIObject {
public:
    OAIAddress_1();
    OAIAddress_1(QString json);
    ~OAIAddress_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddress_1)

#endif // OAIAddress_1_H
