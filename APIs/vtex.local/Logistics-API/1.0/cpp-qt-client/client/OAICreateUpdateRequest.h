...
/*
 * OAICreateUpdateRequest.h
 *
 * 
 */

#ifndef OAICreateUpdateRequest_H
#define OAICreateUpdateRequest_H
...
class OAICreateUpdateRequest : public OAIObject {
public:
    OAICreateUpdateRequest();
    OAICreateUpdateRequest(QString json);
    ~OAICreateUpdateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUpdateRequest)

#endif // OAICreateUpdateRequest_H
