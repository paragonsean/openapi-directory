...
OAIItem3_1::OAIItem3_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIItem3_1::OAIItem3_1() {
    this->initializeModel();
}

OAIItem3_1::~OAIItem3_1() {}

void OAIItem3_1::initializeModel() {
...
void OAIItem3_1::fromJson(QString jsonString) {
...
void OAIItem3_1::fromJsonObject(QJsonObject json) {
...
QString OAIItem3_1::asJson() const {
...
QJsonObject OAIItem3_1::asJsonObject() const {
    QJsonObject obj;
...
QString OAIItem3_1::getAdditionalHandlingTime() const {
    return m_additional_handling_time;
}
void OAIItem3_1::setAdditionalHandlingTime(const QString &additional_handling_time) {
    m_additional_handling_time = additional_handling_time;
    m_additional_handling_time_isSet = true;
}

bool OAIItem3_1::is_additional_handling_time_Set() const{
    return m_additional_handling_time_isSet;
}

bool OAIItem3_1::is_additional_handling_time_Valid() const{
    return m_additional_handling_time_isValid;
}

OAIDimension_1 OAIItem3_1::getDimension() const {
    return m_dimension;
}
void OAIItem3_1::setDimension(const OAIDimension_1 &dimension) {
    m_dimension = dimension;
    m_dimension_isSet = true;
}

bool OAIItem3_1::is_dimension_Set() const{
    return m_dimension_isSet;
}

bool OAIItem3_1::is_dimension_Valid() const{
    return m_dimension_isValid;
}

QString OAIItem3_1::getGroupItemId() const {
    return m_group_item_id;
}
void OAIItem3_1::setGroupItemId(const QString &group_item_id) {
    m_group_item_id = group_item_id;
    m_group_item_id_isSet = true;
}

bool OAIItem3_1::is_group_item_id_Set() const{
    return m_group_item_id_isSet;
}

bool OAIItem3_1::is_group_item_id_Valid() const{
    return m_group_item_id_isValid;
}

QString OAIItem3_1::getId() const {
    return m_id;
}
void OAIItem3_1::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIItem3_1::is_id_Set() const{
    return m_id_isSet;
}

bool OAIItem3_1::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAIKitItem_1> OAIItem3_1::getKitItem() const {
    return m_kit_item;
}
void OAIItem3_1::setKitItem(const QList<OAIKitItem_1> &kit_item) {
    m_kit_item = kit_item;
    m_kit_item_isSet = true;
}

bool OAIItem3_1::is_kit_item_Set() const{
    return m_kit_item_isSet;
}

bool OAIItem3_1::is_kit_item_Valid() const{
    return m_kit_item_isValid;
}

qint32 OAIItem3_1::getPrice() const {
    return m_price;
}
void OAIItem3_1::setPrice(const qint32 &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIItem3_1::is_price_Set() const{
    return m_price_isSet;
}

bool OAIItem3_1::is_price_Valid() const{
    return m_price_isValid;
}

qint32 OAIItem3_1::getQuantity() const {
    return m_quantity;
}
void OAIItem3_1::setQuantity(const qint32 &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIItem3_1::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIItem3_1::is_quantity_Valid() const{
    return m_quantity_isValid;
}

bool OAIItem3_1::isSet() const {
