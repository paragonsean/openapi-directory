...
#ifndef OAIDimension1_H
#define OAIDimension1_H
...
class OAIDimension1 : public OAIObject {
public:
    OAIDimension1();
    OAIDimension1(QString json);
    ~OAIDimension1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDimension1)

#endif // OAIDimension1_H
