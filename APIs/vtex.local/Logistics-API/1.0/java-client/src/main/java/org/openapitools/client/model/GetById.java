...
public class GetById {
  ...
  public GetById address(Address41 address) {
  ...
  public GetById businessHours(List<BusinessHour1> businessHours) {
    this.businessHours = businessHours;
    return this;
  }

  public GetById addBusinessHoursItem(BusinessHour1 businessHoursItem) {
  ...
  public GetById description(String description) {
  ...
  public GetById formattedAddress(String formattedAddress) {
  ...
  public GetById instructions(String instructions) {
  ...
  public GetById isActive(Boolean isActive) {
  ...
  public GetById name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetById warehouseId(String warehouseId) {
  ...
  public boolean equals(Object o) {
    ...
    GetById getById = (GetById) o;
    return Objects.equals(this.address, getById.address) &&
        Objects.equals(this.businessHours, getById.businessHours) &&
        Objects.equals(this.description, getById.description) &&
        Objects.equals(this.formattedAddress, getById.formattedAddress) &&
        Objects.equals(this.id, getById.id) &&
        Objects.equals(this.instructions, getById.instructions) &&
        Objects.equals(this.isActive, getById.isActive) &&
        Objects.equals(this.name, getById.name) &&
        Objects.equals(this.warehouseId, getById.warehouseId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetById
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetById.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetById is not found in the empty JSON string", GetById.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetById.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetById` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetById.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetById.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetById' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetById> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetById.class));

       return (TypeAdapter<T>) new TypeAdapter<GetById>() {
           @Override
           public void write(JsonWriter out, GetById value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetById read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetById given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetById
   * @throws IOException if the JSON string is invalid with respect to GetById
   */
  public static GetById fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetById.class);
  }

  /**
   * Convert an instance of GetById to an JSON string
   *
   * @return JSON string
   */
