...
public class SlaRequest {
  ...
  public SlaRequest deliveryWindows(String deliveryWindows) {
  ...
  public SlaRequest dockId(String dockId) {
    this.dockId = dockId;
    return this;
  }
  ...
  public SlaRequest dockTime(String dockTime) {
  ...
  public SlaRequest freightTableId(String freightTableId) {
  ...
  public SlaRequest freightTableName(String freightTableName) {
  ...
  public SlaRequest item(Item11 item) {
    this.item = item;
    return this;
  }
  ...
  public SlaRequest listPrice(BigDecimal listPrice) {
  ...
  public SlaRequest location(Location11 location) {
  ...
  public SlaRequest pickupStoreInfo(String pickupStoreInfo) {
  ...
  public SlaRequest promotionalPrice(BigDecimal promotionalPrice) {
  ...
  public SlaRequest slaType(String slaType) {
  ...
  public SlaRequest slaTypeName(String slaTypeName) {
  ...
  public SlaRequest timeToDockPlusDockTime(String timeToDockPlusDockTime) {
  ...
  public SlaRequest totalTime(String totalTime) {
  ...
  public SlaRequest transitTime(String transitTime) {
  ...
  public SlaRequest wareHouseId(String wareHouseId) {
  ...
  public SlaRequest wmsEndPoint(String wmsEndPoint) {
  ...
  public boolean equals(Object o) {
    ...
    SlaRequest slaRequest = (SlaRequest) o;
    return Objects.equals(this.deliveryWindows, slaRequest.deliveryWindows) &&
        Objects.equals(this.dockId, slaRequest.dockId) &&
        Objects.equals(this.dockTime, slaRequest.dockTime) &&
        Objects.equals(this.freightTableId, slaRequest.freightTableId) &&
        Objects.equals(this.freightTableName, slaRequest.freightTableName) &&
        Objects.equals(this.item, slaRequest.item) &&
        Objects.equals(this.listPrice, slaRequest.listPrice) &&
        Objects.equals(this.location, slaRequest.location) &&
        Objects.equals(this.pickupStoreInfo, slaRequest.pickupStoreInfo) &&
        Objects.equals(this.promotionalPrice, slaRequest.promotionalPrice) &&
        Objects.equals(this.slaType, slaRequest.slaType) &&
        Objects.equals(this.slaTypeName, slaRequest.slaTypeName) &&
        Objects.equals(this.timeToDockPlusDockTime, slaRequest.timeToDockPlusDockTime) &&
        Objects.equals(this.totalTime, slaRequest.totalTime) &&
        Objects.equals(this.transitTime, slaRequest.transitTime) &&
        Objects.equals(this.wareHouseId, slaRequest.wareHouseId) &&
        Objects.equals(this.wmsEndPoint, slaRequest.wmsEndPoint);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SlaRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SlaRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SlaRequest is not found in the empty JSON string", SlaRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SlaRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SlaRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SlaRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SlaRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SlaRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SlaRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SlaRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SlaRequest>() {
           @Override
           public void write(JsonWriter out, SlaRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SlaRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SlaRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SlaRequest
   * @throws IOException if the JSON string is invalid with respect to SlaRequest
   */
  public static SlaRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SlaRequest.class);
  }

  /**
   * Convert an instance of SlaRequest to an JSON string
   *
   * @return JSON string
   */
