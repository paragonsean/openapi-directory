...
public class WarehouseDock {
  ...
  public WarehouseDock() {
  }

  public WarehouseDock cost(String cost) {
    this.cost = cost;
    return this;
  }
  ...
  public WarehouseDock costToDisplay(String costToDisplay) {
  ...
  public WarehouseDock dockId(String dockId) {
    this.dockId = dockId;
    return this;
  }
  ...
  public WarehouseDock name(String name) {
    this.name = name;
    return this;
  }
  ...
  public WarehouseDock time(String time) {
    this.time = time;
    return this;
  }
  ...
  public WarehouseDock translateDays(String translateDays) {
  ...
  public boolean equals(Object o) {
    ...
    WarehouseDock warehouseDock = (WarehouseDock) o;
    return Objects.equals(this.cost, warehouseDock.cost) &&
        Objects.equals(this.costToDisplay, warehouseDock.costToDisplay) &&
        Objects.equals(this.dockId, warehouseDock.dockId) &&
        Objects.equals(this.name, warehouseDock.name) &&
        Objects.equals(this.time, warehouseDock.time) &&
        Objects.equals(this.translateDays, warehouseDock.translateDays);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WarehouseDock
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WarehouseDock.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WarehouseDock is not found in the empty JSON string", WarehouseDock.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WarehouseDock.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WarehouseDock` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WarehouseDock.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WarehouseDock.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WarehouseDock' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WarehouseDock> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WarehouseDock.class));

       return (TypeAdapter<T>) new TypeAdapter<WarehouseDock>() {
           @Override
           public void write(JsonWriter out, WarehouseDock value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WarehouseDock read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WarehouseDock given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WarehouseDock
   * @throws IOException if the JSON string is invalid with respect to WarehouseDock
   */
  public static WarehouseDock fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WarehouseDock.class);
  }

  /**
   * Convert an instance of WarehouseDock to an JSON string
   *
   * @return JSON string
   */
