...
public class CreateReservation200Response {
  ...
  public CreateReservation200Response() {
  }

  public CreateReservation200Response authorizedDateUtc(String authorizedDateUtc) {
  ...
  public CreateReservation200Response canceledDateUtc(String canceledDateUtc) {
  ...
  public CreateReservation200Response confirmedDateUtc(String confirmedDateUtc) {
  ...
  public CreateReservation200Response errors(List<String> errors) {
    this.errors = errors;
    return this;
  }

  public CreateReservation200Response addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  public CreateReservation200Response isSucess(Boolean isSucess) {
  ...
  public CreateReservation200Response lastUpdateDateUtc(String lastUpdateDateUtc) {
  ...
  public CreateReservation200Response lockId(String lockId) {
    this.lockId = lockId;
    return this;
  }
  ...
  public CreateReservation200Response maximumConfirmationDateUtc(String maximumConfirmationDateUtc) {
  ...
  public CreateReservation200Response pickupPointItemOptions(String pickupPointItemOptions) {
  ...
  public CreateReservation200Response reservationDateUtc(String reservationDateUtc) {
  ...
  public CreateReservation200Response salesChannel(String salesChannel) {
  ...
  public CreateReservation200Response slaRequest(List<SlaRequest1> slaRequest) {
    this.slaRequest = slaRequest;
    return this;
  }

  public CreateReservation200Response addSlaRequestItem(SlaRequest1 slaRequestItem) {
  ...
  public CreateReservation200Response status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateReservation200Response createReservation200Response = (CreateReservation200Response) o;
    return Objects.equals(this.authorizedDateUtc, createReservation200Response.authorizedDateUtc) &&
        Objects.equals(this.canceledDateUtc, createReservation200Response.canceledDateUtc) &&
        Objects.equals(this.confirmedDateUtc, createReservation200Response.confirmedDateUtc) &&
        Objects.equals(this.errors, createReservation200Response.errors) &&
        Objects.equals(this.isSucess, createReservation200Response.isSucess) &&
        Objects.equals(this.lastUpdateDateUtc, createReservation200Response.lastUpdateDateUtc) &&
        Objects.equals(this.lockId, createReservation200Response.lockId) &&
        Objects.equals(this.maximumConfirmationDateUtc, createReservation200Response.maximumConfirmationDateUtc) &&
        Objects.equals(this.pickupPointItemOptions, createReservation200Response.pickupPointItemOptions) &&
        Objects.equals(this.reservationDateUtc, createReservation200Response.reservationDateUtc) &&
        Objects.equals(this.salesChannel, createReservation200Response.salesChannel) &&
        Objects.equals(this.slaRequest, createReservation200Response.slaRequest) &&
        Objects.equals(this.status, createReservation200Response.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateReservation200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateReservation200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateReservation200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateReservation200Response is not found in the empty JSON string", CreateReservation200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateReservation200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateReservation200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateReservation200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateReservation200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateReservation200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateReservation200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateReservation200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateReservation200Response>() {
           @Override
           public void write(JsonWriter out, CreateReservation200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateReservation200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateReservation200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateReservation200Response
   * @throws IOException if the JSON string is invalid with respect to CreateReservation200Response
   */
  public static CreateReservation200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateReservation200Response.class);
  }

  /**
   * Convert an instance of CreateReservation200Response to an JSON string
   *
   * @return JSON string
   */
