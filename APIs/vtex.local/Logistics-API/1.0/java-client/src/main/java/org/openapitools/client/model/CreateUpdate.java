...
public class CreateUpdate {
  ...
  public CreateUpdate address(Address21 address) {
  ...
  public CreateUpdate businessHours(List<BusinessHour1> businessHours) {
    this.businessHours = businessHours;
    return this;
  }

  public CreateUpdate addBusinessHoursItem(BusinessHour1 businessHoursItem) {
  ...
  public CreateUpdate description(String description) {
  ...
  public CreateUpdate formattedAddress(String formattedAddress) {
  ...
  public CreateUpdate id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CreateUpdate instructions(String instructions) {
  ...
  public CreateUpdate isActive(Boolean isActive) {
  ...
  public CreateUpdate name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateUpdate pickupHolidays(List<String> pickupHolidays) {
    this.pickupHolidays = pickupHolidays;
    return this;
  }

  public CreateUpdate addPickupHolidaysItem(String pickupHolidaysItem) {
  ...
  public CreateUpdate tagsLabel(List<String> tagsLabel) {
    this.tagsLabel = tagsLabel;
    return this;
  }

  public CreateUpdate addTagsLabelItem(String tagsLabelItem) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUpdate createUpdate = (CreateUpdate) o;
    return Objects.equals(this.address, createUpdate.address) &&
        Objects.equals(this.businessHours, createUpdate.businessHours) &&
        Objects.equals(this.description, createUpdate.description) &&
        Objects.equals(this.formattedAddress, createUpdate.formattedAddress) &&
        Objects.equals(this.id, createUpdate.id) &&
        Objects.equals(this.instructions, createUpdate.instructions) &&
        Objects.equals(this.isActive, createUpdate.isActive) &&
        Objects.equals(this.name, createUpdate.name) &&
        Objects.equals(this.pickupHolidays, createUpdate.pickupHolidays) &&
        Objects.equals(this.tagsLabel, createUpdate.tagsLabel);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, businessHours, description, formattedAddress, id, instructions, isActive, name, pickupHolidays, tagsLabel);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateUpdate {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("pickupHolidays");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUpdate is not found in the empty JSON string", CreateUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateUpdate.openapiRequiredFields) {
      ...
      if (jsonObj.get("pickupHolidays") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("pickupHolidays").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUpdate>() {
           @Override
           public void write(JsonWriter out, CreateUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUpdate
   * @throws IOException if the JSON string is invalid with respect to CreateUpdate
   */
  public static CreateUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUpdate.class);
  }

  /**
   * Convert an instance of CreateUpdate to an JSON string
   *
   * @return JSON string
   */
