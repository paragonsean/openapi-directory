...
public class ListAllDocks {
  ...
  public ListAllDocks dockTimeFake(String dockTimeFake) {
  ...
  public ListAllDocks freightTableIds(List<String> freightTableIds) {
    this.freightTableIds = freightTableIds;
    return this;
  }

  public ListAllDocks addFreightTableIdsItem(String freightTableIdsItem) {
  ...
  public ListAllDocks id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ListAllDocks name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ListAllDocks pickupStoreInfo(PickupStoreInfo11 pickupStoreInfo) {
  ...
  public ListAllDocks priority(Integer priority) {
  ...
  public ListAllDocks salesChannel(String salesChannel) {
  ...
  public ListAllDocks salesChannels(List<String> salesChannels) {
    this.salesChannels = salesChannels;
    return this;
  }

  public ListAllDocks addSalesChannelsItem(String salesChannelsItem) {
  ...
  public ListAllDocks timeFakeOverhead(String timeFakeOverhead) {
  ...
  public ListAllDocks wmsEndPoint(String wmsEndPoint) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllDocks listAllDocks = (ListAllDocks) o;
    return Objects.equals(this.dockTimeFake, listAllDocks.dockTimeFake) &&
        Objects.equals(this.freightTableIds, listAllDocks.freightTableIds) &&
        Objects.equals(this.id, listAllDocks.id) &&
        Objects.equals(this.name, listAllDocks.name) &&
        Objects.equals(this.pickupStoreInfo, listAllDocks.pickupStoreInfo) &&
        Objects.equals(this.priority, listAllDocks.priority) &&
        Objects.equals(this.salesChannel, listAllDocks.salesChannel) &&
        Objects.equals(this.salesChannels, listAllDocks.salesChannels) &&
        Objects.equals(this.timeFakeOverhead, listAllDocks.timeFakeOverhead) &&
        Objects.equals(this.wmsEndPoint, listAllDocks.wmsEndPoint);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllDocks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllDocks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllDocks is not found in the empty JSON string", ListAllDocks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllDocks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllDocks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListAllDocks.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllDocks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllDocks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllDocks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllDocks.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllDocks>() {
           @Override
           public void write(JsonWriter out, ListAllDocks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllDocks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllDocks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllDocks
   * @throws IOException if the JSON string is invalid with respect to ListAllDocks
   */
  public static ListAllDocks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllDocks.class);
  }

  /**
   * Convert an instance of ListAllDocks to an JSON string
   *
   * @return JSON string
   */
