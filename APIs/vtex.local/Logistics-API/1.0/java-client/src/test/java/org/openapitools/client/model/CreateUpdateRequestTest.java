...
/**
 * Model tests for CreateUpdateRequest
 */
public class CreateUpdateRequestTest {
    private final CreateUpdateRequest model = new CreateUpdateRequest();
