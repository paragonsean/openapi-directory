...
#include <iostream>
#include "../client/OAIGetSuggestionsApi.h"
...
void Example::exampleFunction1(){
     OAIGetSuggestionsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIGetSuggestionsApi::getSuggestionSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIGetSuggestionsApi::getSuggestionSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      QString seller_id = create(); // QString | A string that identifies the seller in the marketplace. This ID must be created by the marketplace and informed to the seller before the integration is built.
      ...
      QString seller_sku_id = create(); // QString | A string that identifies the SKU in the marketplace. This is the ID that the marketplace will use for future references to this SKU, such as price and inventory notifications.
      apiInstance.getSuggestion(account_nameacceptcontent_typeseller_idseller_sku_id);
