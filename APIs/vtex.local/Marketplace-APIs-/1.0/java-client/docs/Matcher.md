...
|**hookBaseAddress** | **String** | The chosen Matcher&#39;s url. It is the endpoint that the Received SKUs module calls, to send new suggestions for the Matcher&#39;s review. |  |
