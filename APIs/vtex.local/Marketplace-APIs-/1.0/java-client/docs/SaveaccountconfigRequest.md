...
|**matchers** | [**List&lt;Matcher&gt;**](Matcher.md) | Matchers for approving and rejecting SKUs received from sellers. |  |
|**score** | [**Score**](Score.md) |  |  |
|**specificationsMapping** | **List&lt;String&gt;** | This attribute maps product and SKU specifications. |  |
