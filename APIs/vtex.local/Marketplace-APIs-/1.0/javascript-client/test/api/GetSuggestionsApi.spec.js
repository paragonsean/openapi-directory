...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Suggestions.GetSuggestionsApi();
  });
  ...
  describe('GetSuggestionsApi', function() {
    describe('getSuggestion', function() {
      it('should call getSuggestion successfully', function(done) {
        //uncomment below and update the code to test getSuggestion
        //instance.getSuggestion(function(error) {
