...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Suggestions.SkuSpecification();
  });
  ...
  describe('SkuSpecification', function() {
    it('should create an instance of SkuSpecification', function() {
      // uncomment below and update the code to test SkuSpecification
      //var instance = new Suggestions.SkuSpecification();
      //expect(instance).to.be.a(Suggestions.SkuSpecification);
    });
