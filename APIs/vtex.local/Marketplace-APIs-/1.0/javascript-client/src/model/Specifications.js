...
class Specifications {
     ...
     * @param embalagem {String} Packaging specifications. Should include package's weight.
     */
    constructor(embalagem) { 
        
        Specifications.initialize(this, embalagem);
    }
     ...
     */
    static initialize(obj, embalagem) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Embalagem')) {
                obj['Embalagem'] = ApiClient.convertToType(data['Embalagem'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Embalagem'] && !(typeof data['Embalagem'] === 'string' || data['Embalagem'] instanceof String)) {
            throw new Error("Expected the field `Embalagem` to be a primitive type in the JSON string but got " + data['Embalagem']);
        }
...
Specifications.RequiredProperties = ["Embalagem"];

/**
 * Packaging specifications. Should include package's weight.
 * @member {String} Embalagem
 */
Specifications.prototype['Embalagem'] = undefined;
