...
class Image {
     ...
     * @param imageName {String} Name of the SKU image.
     * @param imageUrl {String} URL of the SKU image. The image must be sent through `https` protocol, otherwise it will not be rendered in VTEX Admin.
     */
    constructor(imageName, imageUrl) { 
        
        Image.initialize(this, imageName, imageUrl);
    }
     ...
     */
    static initialize(obj, imageName, imageUrl) { 
        obj['imageName'] = imageName;
        obj['imageUrl'] = imageUrl || 'https://imageurl.example';
    }
...
Image.RequiredProperties = ["imageName", "imageUrl"];
 ...
 */
Image.prototype['imageUrl'] = 'https://imageurl.example';
