...
/*
 * OAIFacets_queryArgs_selectedFacets_inner.h
 *
 * 
 */

#ifndef OAIFacets_queryArgs_selectedFacets_inner_H
#define OAIFacets_queryArgs_selectedFacets_inner_H
...
class OAIFacets_queryArgs_selectedFacets_inner : public OAIObject {
public:
    OAIFacets_queryArgs_selectedFacets_inner();
    OAIFacets_queryArgs_selectedFacets_inner(QString json);
    ~OAIFacets_queryArgs_selectedFacets_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFacets_queryArgs_selectedFacets_inner)

#endif // OAIFacets_queryArgs_selectedFacets_inner_H
