...
/*
 * OAIProductSearch_correction.h
 *
 * Object with information of misspelled terms.
 */

#ifndef OAIProductSearch_correction_H
#define OAIProductSearch_correction_H
...
class OAIProductSearch_correction : public OAIObject {
public:
    OAIProductSearch_correction();
    OAIProductSearch_correction(QString json);
    ~OAIProductSearch_correction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductSearch_correction)

#endif // OAIProductSearch_correction_H
