...
OAISearchSuggestions::OAISearchSuggestions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchSuggestions::OAISearchSuggestions() {
    this->initializeModel();
}

OAISearchSuggestions::~OAISearchSuggestions() {}

void OAISearchSuggestions::initializeModel() {

    m_searches_isSet = false;
    m_searches_isValid = false;
}

void OAISearchSuggestions::fromJson(QString jsonString) {
...
void OAISearchSuggestions::fromJsonObject(QJsonObject json) {
...
QString OAISearchSuggestions::asJson() const {
...
QJsonObject OAISearchSuggestions::asJsonObject() const {
    QJsonObject obj;
...
QList<OAISearchSuggestions_searches_inner> OAISearchSuggestions::getSearches() const {
    return m_searches;
}
void OAISearchSuggestions::setSearches(const QList<OAISearchSuggestions_searches_inner> &searches) {
    m_searches = searches;
    m_searches_isSet = true;
}

bool OAISearchSuggestions::is_searches_Set() const{
    return m_searches_isSet;
}

bool OAISearchSuggestions::is_searches_Valid() const{
    return m_searches_isValid;
}

bool OAISearchSuggestions::isSet() const {
...
bool OAISearchSuggestions::isValid() const {
