...
/*
 * OAIAutocompleteSearchSuggestions.h
 *
 * 
 */

#ifndef OAIAutocompleteSearchSuggestions_H
#define OAIAutocompleteSearchSuggestions_H
...
namespace OpenAPI {
class OAIAutocompleteSearchSuggestions_searches_inner;

class OAIAutocompleteSearchSuggestions : public OAIObject {
public:
    OAIAutocompleteSearchSuggestions();
    OAIAutocompleteSearchSuggestions(QString json);
    ~OAIAutocompleteSearchSuggestions() override;
    ...
    QList<OAIAutocompleteSearchSuggestions_searches_inner> getSearches() const;
    void setSearches(const QList<OAIAutocompleteSearchSuggestions_searches_inner> &searches);
...
private:
    ...
    QList<OAIAutocompleteSearchSuggestions_searches_inner> m_searches;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutocompleteSearchSuggestions)

#endif // OAIAutocompleteSearchSuggestions_H
