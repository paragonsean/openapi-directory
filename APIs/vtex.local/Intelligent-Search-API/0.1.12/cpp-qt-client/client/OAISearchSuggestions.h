...
/*
 * OAISearchSuggestions.h
 *
 * 
 */

#ifndef OAISearchSuggestions_H
#define OAISearchSuggestions_H
...
class OAISearchSuggestions : public OAIObject {
public:
    OAISearchSuggestions();
    OAISearchSuggestions(QString json);
    ~OAISearchSuggestions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchSuggestions)

#endif // OAISearchSuggestions_H
