...
/*
 * OAIFacets_breadcrumb_inner.h
 *
 * 
 */

#ifndef OAIFacets_breadcrumb_inner_H
#define OAIFacets_breadcrumb_inner_H
...
class OAIFacets_breadcrumb_inner : public OAIObject {
public:
    OAIFacets_breadcrumb_inner();
    OAIFacets_breadcrumb_inner(QString json);
    ~OAIFacets_breadcrumb_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFacets_breadcrumb_inner)

#endif // OAIFacets_breadcrumb_inner_H
