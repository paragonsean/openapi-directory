...
namespace OpenAPI {
class OAIBanners_banners_inner;

class OAIBanners : public OAIObject {
public:
    OAIBanners();
    OAIBanners(QString json);
    ~OAIBanners() override;
    ...
    QList<OAIBanners_banners_inner> getBanners() const;
    void setBanners(const QList<OAIBanners_banners_inner> &banners);
...
private:
    ...
    QList<OAIBanners_banners_inner> m_banners;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBanners)
