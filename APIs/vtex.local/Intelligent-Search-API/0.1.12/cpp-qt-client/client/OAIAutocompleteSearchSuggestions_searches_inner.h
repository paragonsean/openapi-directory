...
/*
 * OAIAutocompleteSearchSuggestions_searches_inner.h
 *
 * 
 */

#ifndef OAIAutocompleteSearchSuggestions_searches_inner_H
#define OAIAutocompleteSearchSuggestions_searches_inner_H

#include <QJsonObject>

#include "OAIAutocompleteSearchSuggestions_searches_inner_attributes_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIAutocompleteSearchSuggestions_searches_inner_attributes_inner;

class OAIAutocompleteSearchSuggestions_searches_inner : public OAIObject {
public:
    OAIAutocompleteSearchSuggestions_searches_inner();
    OAIAutocompleteSearchSuggestions_searches_inner(QString json);
    ~OAIAutocompleteSearchSuggestions_searches_inner() override;
    ...
    QList<OAIAutocompleteSearchSuggestions_searches_inner_attributes_inner> getAttributes() const;
    void setAttributes(const QList<OAIAutocompleteSearchSuggestions_searches_inner_attributes_inner> &attributes);
...
private:
    ...
    QList<OAIAutocompleteSearchSuggestions_searches_inner_attributes_inner> m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutocompleteSearchSuggestions_searches_inner)

#endif // OAIAutocompleteSearchSuggestions_searches_inner_H
