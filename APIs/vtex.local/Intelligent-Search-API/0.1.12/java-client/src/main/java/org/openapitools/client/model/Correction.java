...
import org.openapitools.client.model.CorrectionCorrection;
...
public class Correction {
  ...
  private CorrectionCorrection correction;

  public Correction() {
  }

  public Correction correction(CorrectionCorrection correction) {
  ...
  public CorrectionCorrection getCorrection() {
    return correction;
  }

  public void setCorrection(CorrectionCorrection correction) {
    this.correction = correction;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.correction, correction.correction);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("correction") != null && !jsonObj.get("correction").isJsonNull()) {
        CorrectionCorrection.validateJsonElement(jsonObj.get("correction"));
      }
  }
