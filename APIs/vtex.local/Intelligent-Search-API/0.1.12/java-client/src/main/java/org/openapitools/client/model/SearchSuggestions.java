...
public class SearchSuggestions {
  ...
  public SearchSuggestions searches(List<SearchSuggestionsSearchesInner> searches) {
    this.searches = searches;
    return this;
  }

  public SearchSuggestions addSearchesItem(SearchSuggestionsSearchesInner searchesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.searches, searchSuggestions.searches);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchSuggestions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchSuggestions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchSuggestions is not found in the empty JSON string", SearchSuggestions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchSuggestions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchSuggestions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchSuggestions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchSuggestions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchSuggestions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchSuggestions.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchSuggestions>() {
           @Override
           public void write(JsonWriter out, SearchSuggestions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchSuggestions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchSuggestions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchSuggestions
   * @throws IOException if the JSON string is invalid with respect to SearchSuggestions
   */
  public static SearchSuggestions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchSuggestions.class);
  }

  /**
   * Convert an instance of SearchSuggestions to an JSON string
   *
   * @return JSON string
   */
