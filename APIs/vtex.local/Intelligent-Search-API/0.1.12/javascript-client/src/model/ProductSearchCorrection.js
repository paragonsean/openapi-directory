...
/**
 * The ProductSearchCorrection model module.
 * @module model/ProductSearchCorrection
 * @version 0.1.12
 */
class ProductSearchCorrection {
    /**
     * Constructs a new <code>ProductSearchCorrection</code>.
     * Object with information of misspelled terms.
     * @alias module:model/ProductSearchCorrection
     */
    constructor() { 
        
        ProductSearchCorrection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProductSearchCorrection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProductSearchCorrection} obj Optional instance to populate.
     * @return {module:model/ProductSearchCorrection} The populated <code>ProductSearchCorrection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProductSearchCorrection();
    ...
    /**
     * Validates the JSON data with respect to <code>ProductSearchCorrection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductSearchCorrection</code>.
     */
 ...
 */
ProductSearchCorrection.prototype['misspelled'] = undefined;
...
export default ProductSearchCorrection;
