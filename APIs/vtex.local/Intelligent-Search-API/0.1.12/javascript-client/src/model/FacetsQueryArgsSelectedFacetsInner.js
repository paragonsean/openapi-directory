...
/**
 * The FacetsQueryArgsSelectedFacetsInner model module.
 * @module model/FacetsQueryArgsSelectedFacetsInner
 * @version 0.1.12
 */
class FacetsQueryArgsSelectedFacetsInner {
    /**
     * Constructs a new <code>FacetsQueryArgsSelectedFacetsInner</code>.
     * @alias module:model/FacetsQueryArgsSelectedFacetsInner
     */
    constructor() { 
        
        FacetsQueryArgsSelectedFacetsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FacetsQueryArgsSelectedFacetsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FacetsQueryArgsSelectedFacetsInner} obj Optional instance to populate.
     * @return {module:model/FacetsQueryArgsSelectedFacetsInner} The populated <code>FacetsQueryArgsSelectedFacetsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FacetsQueryArgsSelectedFacetsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>FacetsQueryArgsSelectedFacetsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FacetsQueryArgsSelectedFacetsInner</code>.
     */
 ...
 * @member {String} key
 */
FacetsQueryArgsSelectedFacetsInner.prototype['key'] = undefined;

/**
 * facet value.
 * @member {String} value
 */
FacetsQueryArgsSelectedFacetsInner.prototype['value'] = undefined;
...
export default FacetsQueryArgsSelectedFacetsInner;
