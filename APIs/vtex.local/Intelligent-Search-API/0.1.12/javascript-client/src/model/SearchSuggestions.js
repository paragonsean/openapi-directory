...
import SearchSuggestionsSearchesInner from './SearchSuggestionsSearchesInner';

/**
 * The SearchSuggestions model module.
 * @module model/SearchSuggestions
 * @version 0.1.12
 */
class SearchSuggestions {
    /**
     * Constructs a new <code>SearchSuggestions</code>.
     * @alias module:model/SearchSuggestions
     */
    constructor() { 
        
        SearchSuggestions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchSuggestions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchSuggestions} obj Optional instance to populate.
     * @return {module:model/SearchSuggestions} The populated <code>SearchSuggestions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchSuggestions();

            if (data.hasOwnProperty('searches')) {
                obj['searches'] = ApiClient.convertToType(data['searches'], [SearchSuggestionsSearchesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SearchSuggestions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchSuggestions</code>.
     */
    static validateJSON(data) {
        if (data['searches']) { // data not null
            ...
            for (const item of data['searches']) {
                SearchSuggestionsSearchesInner.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/SearchSuggestionsSearchesInner>} searches
 */
SearchSuggestions.prototype['searches'] = undefined;
