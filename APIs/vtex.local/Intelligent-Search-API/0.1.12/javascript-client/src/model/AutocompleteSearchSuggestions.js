...
import AutocompleteSearchSuggestionsSearchesInner from './AutocompleteSearchSuggestionsSearchesInner';

/**
 * The AutocompleteSearchSuggestions model module.
 * @module model/AutocompleteSearchSuggestions
 * @version 0.1.12
 */
class AutocompleteSearchSuggestions {
    /**
     * Constructs a new <code>AutocompleteSearchSuggestions</code>.
     * @alias module:model/AutocompleteSearchSuggestions
     */
    constructor() { 
        
        AutocompleteSearchSuggestions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AutocompleteSearchSuggestions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AutocompleteSearchSuggestions} obj Optional instance to populate.
     * @return {module:model/AutocompleteSearchSuggestions} The populated <code>AutocompleteSearchSuggestions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutocompleteSearchSuggestions();

            if (data.hasOwnProperty('searches')) {
                obj['searches'] = ApiClient.convertToType(data['searches'], [AutocompleteSearchSuggestionsSearchesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AutocompleteSearchSuggestions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutocompleteSearchSuggestions</code>.
     */
    static validateJSON(data) {
        if (data['searches']) { // data not null
            ...
            for (const item of data['searches']) {
                AutocompleteSearchSuggestionsSearchesInner.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/AutocompleteSearchSuggestionsSearchesInner>} searches
 */
AutocompleteSearchSuggestions.prototype['searches'] = undefined;
