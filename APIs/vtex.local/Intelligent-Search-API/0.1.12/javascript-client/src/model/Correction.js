...
import CorrectionCorrection from './CorrectionCorrection';
...
class Correction {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('correction')) {
                obj['correction'] = CorrectionCorrection.constructFromObject(data['correction']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['correction']) { // data not null
          CorrectionCorrection.validateJSON(data['correction']);
        }
...
/**
 * @member {module:model/CorrectionCorrection} correction
 */
Correction.prototype['correction'] = undefined;
