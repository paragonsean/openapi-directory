...
/**
 * The TopSearches model module.
 * @module model/TopSearches
 * @version 0.1.12
 */
class TopSearches {
    /**
     * Constructs a new <code>TopSearches</code>.
     * @alias module:model/TopSearches
     */
    constructor() { 
        
        TopSearches.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TopSearches</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TopSearches} obj Optional instance to populate.
     * @return {module:model/TopSearches} The populated <code>TopSearches</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TopSearches();
    ...
    /**
     * Validates the JSON data with respect to <code>TopSearches</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TopSearches</code>.
     */
 ...
 */
TopSearches.prototype['searches'] = undefined;
