...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.FacetsQueryArgsSelectedFacetsInner();
  });
  ...
  describe('FacetsQueryArgsSelectedFacetsInner', function() {
    it('should create an instance of FacetsQueryArgsSelectedFacetsInner', function() {
      // uncomment below and update the code to test FacetsQueryArgsSelectedFacetsInner
      //var instance = new IntelligentSearchApi.FacetsQueryArgsSelectedFacetsInner();
      //expect(instance).to.be.a(IntelligentSearchApi.FacetsQueryArgsSelectedFacetsInner);
    });
