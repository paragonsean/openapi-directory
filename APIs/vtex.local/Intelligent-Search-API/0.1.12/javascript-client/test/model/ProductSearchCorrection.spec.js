...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.ProductSearchCorrection();
  });
  ...
  describe('ProductSearchCorrection', function() {
    it('should create an instance of ProductSearchCorrection', function() {
      // uncomment below and update the code to test ProductSearchCorrection
      //var instance = new IntelligentSearchApi.ProductSearchCorrection();
      //expect(instance).to.be.a(IntelligentSearchApi.ProductSearchCorrection);
    });

    it('should have the property misspelled (base name: "misspelled")', function() {
      // uncomment below and update the code to test the property misspelled
      //var instance = new IntelligentSearchApi.ProductSearchCorrection();
