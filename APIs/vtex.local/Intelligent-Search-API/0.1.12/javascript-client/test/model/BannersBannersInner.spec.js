...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.BannersBannersInner();
  });
  ...
  describe('BannersBannersInner', function() {
    it('should create an instance of BannersBannersInner', function() {
      // uncomment below and update the code to test BannersBannersInner
      //var instance = new IntelligentSearchApi.BannersBannersInner();
      //expect(instance).to.be.a(IntelligentSearchApi.BannersBannersInner);
    });
