...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.TopSearches();
  });
  ...
  describe('TopSearches', function() {
    it('should create an instance of TopSearches', function() {
      // uncomment below and update the code to test TopSearches
      //var instance = new IntelligentSearchApi.TopSearches();
      //expect(instance).to.be.a(IntelligentSearchApi.TopSearches);
    });
