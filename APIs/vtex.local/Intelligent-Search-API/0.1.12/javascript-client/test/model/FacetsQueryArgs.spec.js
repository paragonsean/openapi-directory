...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.FacetsQueryArgs();
  });
  ...
  describe('FacetsQueryArgs', function() {
    it('should create an instance of FacetsQueryArgs', function() {
      // uncomment below and update the code to test FacetsQueryArgs
      //var instance = new IntelligentSearchApi.FacetsQueryArgs();
      //expect(instance).to.be.a(IntelligentSearchApi.FacetsQueryArgs);
    });
    ...
    it('should have the property selectedFacets (base name: "selectedFacets")', function() {
      // uncomment below and update the code to test the property selectedFacets
      //var instance = new IntelligentSearchApi.FacetsQueryArgs();
      //expect(instance).to.be();
    });
