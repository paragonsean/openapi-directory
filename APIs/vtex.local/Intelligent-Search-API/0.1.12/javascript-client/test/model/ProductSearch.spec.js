...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.ProductSearch();
  });
  ...
  describe('ProductSearch', function() {
    it('should create an instance of ProductSearch', function() {
      // uncomment below and update the code to test ProductSearch
      //var instance = new IntelligentSearchApi.ProductSearch();
      //expect(instance).to.be.a(IntelligentSearchApi.ProductSearch);
    });
