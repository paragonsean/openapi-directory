...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.Banners();
  });
  ...
  describe('Banners', function() {
    it('should create an instance of Banners', function() {
      // uncomment below and update the code to test Banners
      //var instance = new IntelligentSearchApi.Banners();
      //expect(instance).to.be.a(IntelligentSearchApi.Banners);
    });
