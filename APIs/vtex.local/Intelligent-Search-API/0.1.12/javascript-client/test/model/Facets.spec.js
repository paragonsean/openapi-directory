...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.Facets();
  });
  ...
  describe('Facets', function() {
    it('should create an instance of Facets', function() {
      ...
      //var instance = new IntelligentSearchApi.Facets();
      //expect(instance).to.be.a(IntelligentSearchApi.Facets);
    });
    ...
    it('should have the property queryArgs (base name: "queryArgs")', function() {
      // uncomment below and update the code to test the property queryArgs
      //var instance = new IntelligentSearchApi.Facets();
      //expect(instance).to.be();
    });
