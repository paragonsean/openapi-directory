...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.FacetsFacetsInner();
  });
  ...
  describe('FacetsFacetsInner', function() {
    it('should create an instance of FacetsFacetsInner', function() {
      // uncomment below and update the code to test FacetsFacetsInner
      //var instance = new IntelligentSearchApi.FacetsFacetsInner();
      //expect(instance).to.be.a(IntelligentSearchApi.FacetsFacetsInner);
    });
