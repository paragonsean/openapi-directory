...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.AutocompleteSearchSuggestionsSearchesInnerAttributesInner();
  });
  ...
  describe('AutocompleteSearchSuggestionsSearchesInnerAttributesInner', function() {
    it('should create an instance of AutocompleteSearchSuggestionsSearchesInnerAttributesInner', function() {
      // uncomment below and update the code to test AutocompleteSearchSuggestionsSearchesInnerAttributesInner
      //var instance = new IntelligentSearchApi.AutocompleteSearchSuggestionsSearchesInnerAttributesInner();
      //expect(instance).to.be.a(IntelligentSearchApi.AutocompleteSearchSuggestionsSearchesInnerAttributesInner);
    });
