...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.SearchSuggestionsSearchesInner();
  });
  ...
  describe('SearchSuggestionsSearchesInner', function() {
    it('should create an instance of SearchSuggestionsSearchesInner', function() {
      // uncomment below and update the code to test SearchSuggestionsSearchesInner
      //var instance = new IntelligentSearchApi.SearchSuggestionsSearchesInner();
      //expect(instance).to.be.a(IntelligentSearchApi.SearchSuggestionsSearchesInner);
    });
