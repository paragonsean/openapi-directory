...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.Correction();
  });
  ...
  describe('Correction', function() {
    it('should create an instance of Correction', function() {
      ...
      //var instance = new IntelligentSearchApi.Correction();
      //expect(instance).to.be.a(IntelligentSearchApi.Correction);
    });

    it('should have the property correction (base name: "correction")', function() {
      // uncomment below and update the code to test the property correction
      //var instance = new IntelligentSearchApi.Correction();
