...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.FacetsFacetsInnerValuesInner();
  });
  ...
  describe('FacetsFacetsInnerValuesInner', function() {
    it('should create an instance of FacetsFacetsInnerValuesInner', function() {
      // uncomment below and update the code to test FacetsFacetsInnerValuesInner
      //var instance = new IntelligentSearchApi.FacetsFacetsInnerValuesInner();
      //expect(instance).to.be.a(IntelligentSearchApi.FacetsFacetsInnerValuesInner);
    });
