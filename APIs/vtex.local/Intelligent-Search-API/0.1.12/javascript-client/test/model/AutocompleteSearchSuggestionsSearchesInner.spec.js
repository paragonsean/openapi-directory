...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.AutocompleteSearchSuggestionsSearchesInner();
  });
  ...
  describe('AutocompleteSearchSuggestionsSearchesInner', function() {
    it('should create an instance of AutocompleteSearchSuggestionsSearchesInner', function() {
      // uncomment below and update the code to test AutocompleteSearchSuggestionsSearchesInner
      //var instance = new IntelligentSearchApi.AutocompleteSearchSuggestionsSearchesInner();
      //expect(instance).to.be.a(IntelligentSearchApi.AutocompleteSearchSuggestionsSearchesInner);
    });
