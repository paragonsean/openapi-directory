...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.FacetsBreadcrumbInner();
  });
  ...
  describe('FacetsBreadcrumbInner', function() {
    it('should create an instance of FacetsBreadcrumbInner', function() {
      // uncomment below and update the code to test FacetsBreadcrumbInner
      //var instance = new IntelligentSearchApi.FacetsBreadcrumbInner();
      //expect(instance).to.be.a(IntelligentSearchApi.FacetsBreadcrumbInner);
    });
