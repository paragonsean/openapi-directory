...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.AutocompleteSearchSuggestions();
  });
  ...
  describe('AutocompleteSearchSuggestions', function() {
    it('should create an instance of AutocompleteSearchSuggestions', function() {
      // uncomment below and update the code to test AutocompleteSearchSuggestions
      //var instance = new IntelligentSearchApi.AutocompleteSearchSuggestions();
      //expect(instance).to.be.a(IntelligentSearchApi.AutocompleteSearchSuggestions);
    });
