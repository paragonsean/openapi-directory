...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.CorrectionCorrection();
  });
  ...
  describe('CorrectionCorrection', function() {
    it('should create an instance of CorrectionCorrection', function() {
      // uncomment below and update the code to test CorrectionCorrection
      //var instance = new IntelligentSearchApi.CorrectionCorrection();
      //expect(instance).to.be.a(IntelligentSearchApi.CorrectionCorrection);
    });
