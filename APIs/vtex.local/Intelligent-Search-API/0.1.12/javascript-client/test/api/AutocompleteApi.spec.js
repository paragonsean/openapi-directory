...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.AutocompleteApi();
  });
  ...
  describe('AutocompleteApi', function() {
    describe('autocompleteSuggestionsGet', function() {
      it('should call autocompleteSuggestionsGet successfully', function(done) {
        //uncomment below and update the code to test autocompleteSuggestionsGet
        //instance.autocompleteSuggestionsGet(function(error) {
    ...
    describe('topSearchesGet', function() {
      it('should call topSearchesGet successfully', function(done) {
        //uncomment below and update the code to test topSearchesGet
        //instance.topSearchesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
