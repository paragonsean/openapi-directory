...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentSearchApi.ProductListPageApi();
  });
  ...
  describe('ProductListPageApi', function() {
    describe('bannersFacetsGet', function() {
      it('should call bannersFacetsGet successfully', function(done) {
        //uncomment below and update the code to test bannersFacetsGet
        //instance.bannersFacetsGet(function(error) {
    ...
    describe('correctionSearchGet', function() {
      it('should call correctionSearchGet successfully', function(done) {
        //uncomment below and update the code to test correctionSearchGet
        //instance.correctionSearchGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('facetsFacetsGet', function() {
      it('should call facetsFacetsGet successfully', function(done) {
        //uncomment below and update the code to test facetsFacetsGet
        //instance.facetsFacetsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('productSearchFacetsGet', function() {
      it('should call productSearchFacetsGet successfully', function(done) {
        //uncomment below and update the code to test productSearchFacetsGet
        //instance.productSearchFacetsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('searchSuggestionsGet', function() {
      it('should call searchSuggestionsGet successfully', function(done) {
        //uncomment below and update the code to test searchSuggestionsGet
        //instance.searchSuggestionsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
