...
class To(Model):
    ...
    def __init__(self, alias_mask_type: int=None, conversation_related_to: str=None, conversation_subject: str=None, email: str=None, email_alias: str=None, name: str=None, role: str=None):
        ...
        :param alias_mask_type: The alias_mask_type of this To.
        :param conversation_related_to: The conversation_related_to of this To.
        :param conversation_subject: The conversation_subject of this To.
        :param email: The email of this To.
        :param email_alias: The email_alias of this To.
        :param name: The name of this To.
        :param role: The role of this To.
        """
        self.openapi_types = {
            'alias_mask_type': int,
    ...
    def alias_mask_type(self):
        """Gets the alias_mask_type of this To.

        Conversation tracker mask type.

        :return: The alias_mask_type of this To.
        :rtype: int
        """
    ...
    def alias_mask_type(self, alias_mask_type):
        """Sets the alias_mask_type of this To.
    ...
    def conversation_related_to(self):
        """Gets the conversation_related_to of this To.

        Related order ID.

        :return: The conversation_related_to of this To.
        :rtype: str
        """
    ...
    def conversation_related_to(self, conversation_related_to):
        """Sets the conversation_related_to of this To.
    ...
    def conversation_subject(self):
        """Gets the conversation_subject of this To.

        Conversation subject.

        :return: The conversation_subject of this To.
        :rtype: str
        """
    ...
    def conversation_subject(self, conversation_subject):
        """Sets the conversation_subject of this To.
    ...
    @property
    def email(self):
        """Gets the email of this To.

        Receiver's email.

        :return: The email of this To.
        :rtype: str
        """
        return self._email
    ...
    def email_alias(self):
        """Gets the email_alias of this To.

        Sender transactional tracker email.

        :return: The email_alias of this To.
        :rtype: str
        """
    ...
    def email_alias(self, email_alias):
        """Sets the email_alias of this To.
    ...
    @property
    def name(self):
        """Gets the name of this To.

        Receiver's name.

        :return: The name of this To.
        :rtype: str
        """
        return self._name
