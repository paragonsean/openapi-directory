...
class List1(Model):
    ...
    def __init__(self, shipping_estimated_date: str=None, shipping_estimated_date_max: str=None, shipping_estimated_date_min: str=None, affiliate_id: str=None, authorized_date: str=None, call_center_operator_name: str=None, client_name: str=None, creation_date: str=None, currency_code: str=None, items: List[Item2]=None, last_message_unread: str=None, list_id: str=None, list_type: str=None, market_place_order_id: str=None, order_id: str=None, order_is_complete: bool=None, origin: str=None, payment_names: str=None, sales_channel: str=None, sequence: str=None, status: str=None, status_description: str=None, total_items: int=None, total_value: int=None, workflow_in_error_state: bool=None, workflow_in_retry: bool=None):
        """List1 - a model defined in OpenAPI

        :param shipping_estimated_date: The shipping_estimated_date of this List1.
        :param shipping_estimated_date_max: The shipping_estimated_date_max of this List1.
        :param shipping_estimated_date_min: The shipping_estimated_date_min of this List1.
        :param affiliate_id: The affiliate_id of this List1.
        :param authorized_date: The authorized_date of this List1.
        :param call_center_operator_name: The call_center_operator_name of this List1.
        :param client_name: The client_name of this List1.
        :param creation_date: The creation_date of this List1.
        :param currency_code: The currency_code of this List1.
        :param items: The items of this List1.
        :param last_message_unread: The last_message_unread of this List1.
        :param list_id: The list_id of this List1.
        :param list_type: The list_type of this List1.
        :param market_place_order_id: The market_place_order_id of this List1.
        :param order_id: The order_id of this List1.
        :param order_is_complete: The order_is_complete of this List1.
        :param origin: The origin of this List1.
        :param payment_names: The payment_names of this List1.
        :param sales_channel: The sales_channel of this List1.
        :param sequence: The sequence of this List1.
        :param status: The status of this List1.
        :param status_description: The status_description of this List1.
        :param total_items: The total_items of this List1.
        :param total_value: The total_value of this List1.
        :param workflow_in_error_state: The workflow_in_error_state of this List1.
        :param workflow_in_retry: The workflow_in_retry of this List1.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'List1':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The List1 of this List1.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def shipping_estimated_date(self):
        """Gets the shipping_estimated_date of this List1.

        Estimate shipping date.

        :return: The shipping_estimated_date of this List1.
        :rtype: str
        """
    ...
    def shipping_estimated_date(self, shipping_estimated_date):
        """Sets the shipping_estimated_date of this List1.
    ...
    def shipping_estimated_date_max(self):
        """Gets the shipping_estimated_date_max of this List1.

        The most extended shipping estimation possible.

        :return: The shipping_estimated_date_max of this List1.
        :rtype: str
        """
    ...
    def shipping_estimated_date_max(self, shipping_estimated_date_max):
        """Sets the shipping_estimated_date_max of this List1.
    ...
    def shipping_estimated_date_min(self):
        """Gets the shipping_estimated_date_min of this List1.

        The least extended shipping estimation possible.

        :return: The shipping_estimated_date_min of this List1.
        :rtype: str
        """
    ...
    def shipping_estimated_date_min(self, shipping_estimated_date_min):
        """Sets the shipping_estimated_date_min of this List1.
    ...
    def affiliate_id(self):
        """Gets the affiliate_id of this List1.
        ...
        :return: The affiliate_id of this List1.
        :rtype: str
        """
    ...
    def affiliate_id(self, affiliate_id):
        """Sets the affiliate_id of this List1.
    ...
    def authorized_date(self):
        """Gets the authorized_date of this List1.

        Authorized order date.

        :return: The authorized_date of this List1.
        :rtype: str
        """
    ...
    def authorized_date(self, authorized_date):
        """Sets the authorized_date of this List1.
    ...
    def call_center_operator_name(self):
        """Gets the call_center_operator_name of this List1.

        Call center operator responsible for the order.

        :return: The call_center_operator_name of this List1.
        :rtype: str
        """
    ...
    def call_center_operator_name(self, call_center_operator_name):
        """Sets the call_center_operator_name of this List1.
    ...
    def client_name(self):
        """Gets the client_name of this List1.

        Order's customer name.

        :return: The client_name of this List1.
        :rtype: str
        """
    ...
    def client_name(self, client_name):
        """Sets the client_name of this List1.
    ...
    def creation_date(self):
        """Gets the creation_date of this List1.

        Order's creation date.

        :return: The creation_date of this List1.
        :rtype: str
        """
    ...
    def creation_date(self, creation_date):
        """Sets the creation_date of this List1.
    ...
    def currency_code(self):
        """Gets the currency_code of this List1.

        Currency code in ISO 4217. For example, `BRL`.

        :return: The currency_code of this List1.
        :rtype: str
        """
    ...
    def currency_code(self, currency_code):
        """Sets the currency_code of this List1.
    ...
    @property
    def items(self):
        """Gets the items of this List1.

        Information about order's items

        :return: The items of this List1.
        :rtype: List[Item2]
        """
        return self._items
    ...
    def last_message_unread(self):
        """Gets the last_message_unread of this List1.

        Last sent transactional message.

        :return: The last_message_unread of this List1.
        :rtype: str
        """
    ...
    def last_message_unread(self, last_message_unread):
        """Sets the last_message_unread of this List1.
    ...
    @property
    def list_id(self):
        """Gets the list_id of this List1.

        Related Gift List ID.

        :return: The list_id of this List1.
        :rtype: str
        """
    ...
    @property
    def list_type(self):
        """Gets the list_type of this List1.

        Related Gift list type.

        :return: The list_type of this List1.
        :rtype: str
        """
    ...
    def list_type(self, list_type):
        """Sets the list_type of this List1.
    ...
    def market_place_order_id(self):
        """Gets the market_place_order_id of this List1.

        Marketplace order ID.

        :return: The market_place_order_id of this List1.
        :rtype: str
        """
    ...
    def market_place_order_id(self, market_place_order_id):
        """Sets the market_place_order_id of this List1.
    ...
    @property
    def order_id(self):
        """Gets the order_id of this List1.

        Order ID is a unique code that identifies an order.

        :return: The order_id of this List1.
        :rtype: str
        """
    ...
    def order_id(self, order_id):
        """Sets the order_id of this List1.
    ...
    def order_is_complete(self):
        """Gets the order_is_complete of this List1.
        ...
        :return: The order_is_complete of this List1.
        :rtype: bool
        """
    ...
    def order_is_complete(self, order_is_complete):
        """Sets the order_is_complete of this List1.
    ...
    @property
    def origin(self):
        """Gets the origin of this List1.

        Order Origin, if `Marketplace` or `Fulfillment`.

        :return: The origin of this List1.
        :rtype: str
        """
        return self._origin
    ...
    def payment_names(self):
        """Gets the payment_names of this List1.

        Payment system name.

        :return: The payment_names of this List1.
        :rtype: str
        """
    ...
    def payment_names(self, payment_names):
        """Sets the payment_names of this List1.
    ...
    def sales_channel(self):
        """Gets the sales_channel of this List1.
        ...
        :return: The sales_channel of this List1.
        :rtype: str
        """
    ...
    def sales_channel(self, sales_channel):
        """Sets the sales_channel of this List1.
    ...
    def sequence(self, sequence):
        """Sets the sequence of this List1.
    ...
    def status_description(self, status_description):
        """Sets the status_description of this List1.
    ...
    def total_items(self):
        """Gets the total_items of this List1.

        Order's total amount of items.

        :return: The total_items of this List1.
        :rtype: int
        """
    ...
    def total_items(self, total_items):
        """Sets the total_items of this List1.
    ...
    def total_value(self):
        """Gets the total_value of this List1.

        Total value amount.

        :return: The total_value of this List1.
        :rtype: int
        """
    ...
    def total_value(self, total_value):
        """Sets the total_value of this List1.
    ...
    def workflow_in_error_state(self):
        """Gets the workflow_in_error_state of this List1.

        If there is a work flow error (`true`) or not (`false`).

        :return: The workflow_in_error_state of this List1.
        :rtype: bool
        """
    ...
    def workflow_in_error_state(self, workflow_in_error_state):
        """Sets the workflow_in_error_state of this List1.
    ...
    def workflow_in_retry(self):
        """Gets the workflow_in_retry of this List1.

        If the order is in a work flow retry (`true`) or not (`false`).

        :return: The workflow_in_retry of this List1.
        :rtype: bool
        """
    ...
    def workflow_in_retry(self, workflow_in_retry):
        """Sets the workflow_in_retry of this List1.
