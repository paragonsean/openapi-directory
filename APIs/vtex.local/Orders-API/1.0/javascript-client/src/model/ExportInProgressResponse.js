...
/**
 * The ExportInProgressResponse model module.
 * @module model/ExportInProgressResponse
 * @version 1.0
 */
class ExportInProgressResponse {
    /**
     * Constructs a new <code>ExportInProgressResponse</code>.
     * @alias module:model/ExportInProgressResponse
    ...
    constructor(cancelled, completedDate, dateOfRequest, email, filter, hostUri, id, instanceId, lasUpdateTime, linkToDownload, publishId, query, rowNumber, rowsProcessed, startDate, utcTime) { 
        ...
        ExportInProgressResponse.initialize(this, cancelled, completedDate, dateOfRequest, email, filter, hostUri, id, instanceId, lasUpdateTime, linkToDownload, publishId, query, rowNumber, rowsProcessed, startDate, utcTime);
    }
    ...
    /**
     * Constructs a <code>ExportInProgressResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExportInProgressResponse} obj Optional instance to populate.
     * @return {module:model/ExportInProgressResponse} The populated <code>ExportInProgressResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExportInProgressResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ExportInProgressResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportInProgressResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExportInProgressResponse.RequiredProperties) {
...
ExportInProgressResponse.RequiredProperties = ["cancelled", "completedDate", "dateOfRequest", "email", "filter", "hostUri", "id", "instanceId", "lasUpdateTime", "linkToDownload", "publishId", "query", "rowNumber", "rowsProcessed", "startDate", "utcTime"];

/**
 * If the export request was cancelled (`true`) or not (`false`).
 * @member {Boolean} cancelled
 */
ExportInProgressResponse.prototype['cancelled'] = undefined;

/**
 * Order export process completed date.
 * @member {String} completedDate
 */
ExportInProgressResponse.prototype['completedDate'] = undefined;

/**
 * Order export request date.
 * @member {String} dateOfRequest
 */
ExportInProgressResponse.prototype['dateOfRequest'] = undefined;

/**
 * Order export requester email.
 * @member {String} email
 */
ExportInProgressResponse.prototype['email'] = undefined;

/**
 * Order export request filter.
 * @member {String} filter
 */
ExportInProgressResponse.prototype['filter'] = undefined;

/**
 * Host URL.
 * @member {String} hostUri
 */
ExportInProgressResponse.prototype['hostUri'] = undefined;

/**
 * Order export request ID.
 * @member {String} id
 */
ExportInProgressResponse.prototype['id'] = undefined;

/**
 * Instance ID.
 * @member {String} instanceId
 */
ExportInProgressResponse.prototype['instanceId'] = undefined;

/**
 * Order export process update time.
 * @member {String} lasUpdateTime
 */
ExportInProgressResponse.prototype['lasUpdateTime'] = undefined;

/**
 * Link to order export download.
 * @member {String} linkToDownload
 */
ExportInProgressResponse.prototype['linkToDownload'] = undefined;

/**
 * Order export publish ID.
 * @member {String} publishId
 */
ExportInProgressResponse.prototype['publishId'] = undefined;

/**
 * Order export request filter query.
 * @member {String} query
 */
ExportInProgressResponse.prototype['query'] = undefined;

/**
 * Order export total rows.
 * @member {Number} rowNumber
 */
ExportInProgressResponse.prototype['rowNumber'] = undefined;

/**
 * Order export total processed rows.
 * @member {Number} rowsProcessed
 */
ExportInProgressResponse.prototype['rowsProcessed'] = undefined;

/**
 * Order export process start date.
 * @member {String} startDate
 */
ExportInProgressResponse.prototype['startDate'] = undefined;

/**
 * UTC time.
 * @member {String} utcTime
 */
ExportInProgressResponse.prototype['utcTime'] = undefined;
...
export default ExportInProgressResponse;
