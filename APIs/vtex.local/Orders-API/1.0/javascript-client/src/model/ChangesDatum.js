...
class ChangesDatum {
     ...
     * @param discountValue {Number} Order change discount value.
     * @param incrementValue {Number} Order change increment value.
     * @param itemsAdded {Array.<String>} List of items added to the order.
     * @param itemsRemoved {Array.<module:model/ItemsRemoved>} List of items removed from the order.
     * @param reason {String} Text explaining why there was a change in the order. This information may be shown to the customer in the UI or transactional emails.
