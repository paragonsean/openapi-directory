...
class RatesAndBenefitsData {
     ...
     * @param id {String} ID of the rate or benefit.
     * @param rateAndBenefitsIdentifiers {Array.<String>} Information about order's promotions and taxes identifiers.
     */
 ...
 * @member {String} id
 */
RatesAndBenefitsData.prototype['id'] = undefined;
