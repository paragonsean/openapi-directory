...
class CurrencyFormatInfo {
     ...
     * @param currencyDecimalDigits {Number} Quantity of currency decimal digits.
     * @param currencyDecimalSeparator {String} Defines what currency decimal separator will be applied.
     * @param currencyGroupSeparator {String} Defines what currency group separator will be applied.
     * @param currencyGroupSize {Number} Defines how many characters will be grouped.
     * @param startsWithCurrencySymbol {Boolean} Defines if all prices will be initiated with the currency symbol (`true`) or not (`false`).
     */
