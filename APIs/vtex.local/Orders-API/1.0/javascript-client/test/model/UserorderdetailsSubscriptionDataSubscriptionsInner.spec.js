...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApi.UserorderdetailsSubscriptionDataSubscriptionsInner();
  });
  ...
  describe('UserorderdetailsSubscriptionDataSubscriptionsInner', function() {
    it('should create an instance of UserorderdetailsSubscriptionDataSubscriptionsInner', function() {
      // uncomment below and update the code to test UserorderdetailsSubscriptionDataSubscriptionsInner
      //var instance = new OrdersApi.UserorderdetailsSubscriptionDataSubscriptionsInner();
      //expect(instance).to.be.a(OrdersApi.UserorderdetailsSubscriptionDataSubscriptionsInner);
    });
