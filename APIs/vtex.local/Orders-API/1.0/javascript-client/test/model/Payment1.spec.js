...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApi.Payment1();
  });
  ...
  describe('Payment1', function() {
    it('should create an instance of Payment1', function() {
      // uncomment below and update the code to test Payment1
      //var instance = new OrdersApi.Payment1();
      //expect(instance).to.be.a(OrdersApi.Payment1);
    });
