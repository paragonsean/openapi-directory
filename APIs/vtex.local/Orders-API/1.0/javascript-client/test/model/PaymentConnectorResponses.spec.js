...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApi.PaymentConnectorResponses();
  });
  ...
  describe('PaymentConnectorResponses', function() {
    it('should create an instance of PaymentConnectorResponses', function() {
      // uncomment below and update the code to test PaymentConnectorResponses
      //var instance = new OrdersApi.PaymentConnectorResponses();
      //expect(instance).to.be.a(OrdersApi.PaymentConnectorResponses);
    });
