...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApi.RegisterChangeRequest();
  });
  ...
  describe('RegisterChangeRequest', function() {
    it('should create an instance of RegisterChangeRequest', function() {
      // uncomment below and update the code to test RegisterChangeRequest
      //var instance = new OrdersApi.RegisterChangeRequest();
      //expect(instance).to.be.a(OrdersApi.RegisterChangeRequest);
    });
