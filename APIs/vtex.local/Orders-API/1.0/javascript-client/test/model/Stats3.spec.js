...
(function(root, factory) {
  ...
  describe('Stats3', function() {
    it('should create an instance of Stats3', function() {
      // uncomment below and update the code to test Stats3
      //var instance = new OrdersApi.Stats3();
      //expect(instance).to.be.a(OrdersApi.Stats3);
    });
