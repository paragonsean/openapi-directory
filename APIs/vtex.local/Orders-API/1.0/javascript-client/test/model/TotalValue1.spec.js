...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApi.TotalValue1();
  });
  ...
  describe('TotalValue1', function() {
    it('should create an instance of TotalValue1', function() {
      // uncomment below and update the code to test TotalValue1
      //var instance = new OrdersApi.TotalValue1();
      //expect(instance).to.be.a(OrdersApi.TotalValue1);
    });
