...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApi.TotalItems1();
  });
  ...
  describe('TotalItems1', function() {
    it('should create an instance of TotalItems1', function() {
      // uncomment below and update the code to test TotalItems1
      //var instance = new OrdersApi.TotalItems1();
      //expect(instance).to.be.a(OrdersApi.TotalItems1);
    });
