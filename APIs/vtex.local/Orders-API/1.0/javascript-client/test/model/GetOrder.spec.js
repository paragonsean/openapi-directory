...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApi.GetOrder();
  });
  ...
  describe('GetOrder', function() {
    it('should create an instance of GetOrder', function() {
      // uncomment below and update the code to test GetOrder
      //var instance = new OrdersApi.GetOrder();
      //expect(instance).to.be.a(OrdersApi.GetOrder);
    });
    ...
    it('should have the property emailTracked (base name: "emailTracked")', function() {
      // uncomment below and update the code to test the property emailTracked
      //var instance = new OrdersApi.GetOrder();
      //expect(instance).to.be();
    });
