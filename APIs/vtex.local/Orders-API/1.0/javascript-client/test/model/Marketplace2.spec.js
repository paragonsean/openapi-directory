...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApi.Marketplace2();
  });
  ...
  describe('Marketplace2', function() {
    it('should create an instance of Marketplace2', function() {
      // uncomment below and update the code to test Marketplace2
      //var instance = new OrdersApi.Marketplace2();
      //expect(instance).to.be.a(OrdersApi.Marketplace2);
    });
