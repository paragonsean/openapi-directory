...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApi.TestJSONataExpression();
  });
  ...
  describe('TestJSONataExpression', function() {
    it('should create an instance of TestJSONataExpression', function() {
      // uncomment below and update the code to test TestJSONataExpression
      //var instance = new OrdersApi.TestJSONataExpression();
      //expect(instance).to.be.a(OrdersApi.TestJSONataExpression);
    });
