# OrdersApi.CurrencyFormatInfo

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**currencyDecimalDigits** | **Number** | Quantity of currency decimal digits. | 
...
**currencyGroupSize** | **Number** | Defines how many characters will be grouped. | 
