...
**entityId** | **String** | Shipping address entity ID  of the selected address. | 
**geoCoordinates** | **[String]** | Array with two numbers with the selected address&#39;s geocoordinates, first longitude then latitude. | 
...
**versionId** | **String** | Shipping address version ID of the selected address. | 
