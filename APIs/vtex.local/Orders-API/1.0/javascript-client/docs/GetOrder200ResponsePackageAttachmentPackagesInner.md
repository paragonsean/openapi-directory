# OrdersApi.GetOrder200ResponsePackageAttachmentPackagesInner
...
**invoiceValue** | **Number** | Invoice value in cents. | [optional] 
**issuanceDate** | **String** | Issuance date. | [optional] 
**items** | [**[GetOrder200ResponsePackageAttachmentPackagesInnerItemsInner]**](GetOrder200ResponsePackageAttachmentPackagesInnerItemsInner.md) | Information on each item in the package. | [optional] 
...
**volumes** | **Number** | Quantity of packages involved in the order. | [optional] 
