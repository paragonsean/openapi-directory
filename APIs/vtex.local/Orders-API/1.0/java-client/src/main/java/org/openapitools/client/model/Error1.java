...
public class Error1 {
  ...
  public Error1 exception(String exception) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, error1.code) &&
        Objects.equals(this.exception, error1.exception) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Error1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Error1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
