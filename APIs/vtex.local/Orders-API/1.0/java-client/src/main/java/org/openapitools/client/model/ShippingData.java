...
public class ShippingData {
  ...
  private List<SelectedAddress> selectedAddresses = new ArrayList<>();
  ...
  public ShippingData selectedAddresses(List<SelectedAddress> selectedAddresses) {
    this.selectedAddresses = selectedAddresses;
    return this;
  }

  public ShippingData addSelectedAddressesItem(SelectedAddress selectedAddressesItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<SelectedAddress> getSelectedAddresses() {
    return selectedAddresses;
  }

  public void setSelectedAddresses(List<SelectedAddress> selectedAddresses) {
    this.selectedAddresses = selectedAddresses;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayselectedAddresses.size(); i++) {
        SelectedAddress.validateJsonElement(jsonArrayselectedAddresses.get(i));
      };
