...
|**priceAtSubscriptionDate** | **BigDecimal** | Price of the order when the customer signed up for subscriptions. Subscriptions created from Admin UI or APIs do not have an original order, so the field returns &#x60;0.0&#x60;. This field was valid only for Subscriptions v2 and is deprecated in Subscriptions v3. |  |
