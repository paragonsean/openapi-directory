...
public class Example {
  public static void main(String[] args) {
    ...
    AddLogRequest addLogRequest = new AddLogRequest(); // AddLogRequest | 
    try {
      apiInstance.addLog(contentType, accept, orderId, addLogRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrdersApi#addLog");
...
<a id="cancelOrder"></a>
# **cancelOrder**
> CancelOrder200Response cancelOrder(accept, contentType, orderId, cancelOrderRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String orderId = "1172452900788-01"; // String | ID that identifies the order in the seller.
    CancelOrderRequest cancelOrderRequest = new CancelOrderRequest(); // CancelOrderRequest | 
    try {
      CancelOrder200Response result = apiInstance.cancelOrder(accept, contentType, orderId, cancelOrderRequest);
...
public class Example {
  public static void main(String[] args) {
    ...
    String accept = "application/json"; // String | HTTP Client Negotiation Accept Header. Indicates the types of responses the client can understand.
    String contentType = "application/json"; // String | Type of the content being sent.
    String fCreationDate = "creationDate:[2016-01-01T02:00:00.000Z TO 2021-01-01T01:59:59.999Z]"; // String | Concatened value sufix `{{creationDate}}` and range date in Timestamp format. To use the `utc` query parameter, to filter orders by time zone, you must also fill the `f_creationDate` date parameter.
    String orderBy = "v502556llux-01,asc"; // String | You can retrieve orders lists filtering by an `OrderField` combined with an `OrderType`. To do so, you have to concatenate them: `orderBy={{OrderField}},{{OrderType}}`.   - `OrderField` values accepted: `creationDate`, `orderId`, `items`, `totalValue` and `origin`.   - `OrderType` values accepted: `asc` and `desc`.
    Integer page = 10; // Integer | Define the number of pages you wish to retrieve, restricted to the limit of 30 pages.
    Integer perPage = 15; // Integer | Quantity of orders for each page, the default value is 15 and it goes up to 100 orders per page. Be aware that the limit of retrieval ofthis endpoint is 30 pages.
    ...
    String q = "- OrderID: v212333lux-02   - Client email: taylor@email.com   - Client document: 21133355524   - Client name: Taylor"; // String | This parameter filters using Fulltext and accepts the values below. Be aware that the `+` caracter is not allowed in Fulltext Search.   - Order Id   - Client email   - Client document   - Client name
    Integer utc = -2000; // Integer | Converts orders' time zone to the Universal Time Coordinated (UTC) format and shows the amount of orders set for that UTC, up to the limit of 30 pages. For it to work properly, you have to associate it with the `f_creationDate` parameter.
    String fShippingEstimate = "0.days"; // String | You can filter orders by shipping estimate time in days by concatenating the desired number of days with the sufix `.days`. For example:   - Next 7 days: `7.days`   - Tomorrow: `1.days`   - Today: `0.days`   - Late: `-1.days`
    String fInvoicedDate = "invoicedDate:[2022-01-01T02:00:00.000Z TO 2022-01-02T01:59:59.999Z]"; // String | You can filter orders by invoiced date by concatenating the sufix `invoicedDate:` with the range date in Timestamp format. For example:   - 1 Day: `invoicedDate:[2022-01-01T02:00:00.000Z TO 2022-01-02T01:59:59.999Z]`  - 1 Month: `invoicedDate:[2022-01-01T02:00:00.000Z TO 2022-02-01T01:59:59.999Z]`   - 1 Year: `invoicedDate:[2022-01-01T02:00:00.000Z TO 2022-01-01T01:59:59.999Z]`
    String fAuthorizedDate = "creationDate:[2022-01-01T02:00:00.000Z TO 2022-01-02T01:59:59.999Z]"; // String | You can filter orders by creation date by concatenating the sufix `authorizedDate:` with the range date in Timestamp format. For example:   - 1 Day: `authorizedDate:[2022-01-01T02:00:00.000Z TO 2022-01-02T01:59:59.999Z]`  - 1 Month: `authorizedDate:[2022-01-01T02:00:00.000Z TO 2022-02-01T01:59:59.999Z]`   - 1 Year: `authorizedDate:[2022-01-01T02:00:00.000Z TO 2022-01-01T01:59:59.999Z]`
    String fUtmSource = "christmas_campaign"; // String | You can filter orders by using a Universal Transverse Mercator (UTM) source.
    String fSellerNames = "SellerName"; // String | You can filter orders by using a seller's name.
    String fCallCenterOperatorName = "Operator%20Name"; // String | You can filter orders by using a Call Center Operator's identification.
    String fSalesChannel = "Main"; // String | You can filter orders by sales channel's ([or trade policy](https://help.vtex.com/en/tutorial/how-trade-policies-work--6Xef8PZiFm40kg2STrMkMV)) name.
    String salesChannelId = "1"; // String | You can filter orders by sales channel's ([or trade policy](https://help.vtex.com/en/tutorial/how-trade-policies-work--6Xef8PZiFm40kg2STrMkMV)) ID.
    String fAffiliateId = "WLM"; // String | You can filter orders by affiliate ID.
    String fStatus = "ready-for-handling"; // String | You can filter orders by the following [order status](https://help.vtex.com/en/tutorial/order-flow-and-status--tutorials_196):   - `waiting-for-sellers-confirmation`   - `payment-pending`   - `payment-approved`   - `ready-for-handling`   - `handling`   - `invoiced`   - `canceled`
    Boolean incompleteOrders = true; // Boolean | When set as `true`, you retrieve [incomplete orders](https://help.vtex.com/en/tutorial/understanding-incomplete-orders), when set as `false`, you retrieve orders that are not incomplete.
    String fPaymentNames = "Visa"; // String | You can filter orders by payment type.
    String fRnB = "Free+Shipping"; // String | You can filter orders by rates and benefits (promotions).
    String searchField = "  - SKU ID: `25`   - Gift List ID: `11223`   - Transaction ID (TID): `54546300238810034995829230012`   - PCI Connector's Transaction ID (TID): `7032909234899834298423209`   - Payment ID (PID): `2`   - Connector's NSU: `2437281`"; // String | You can search orders by using one of the following criterias:   - SKU ID - `sku_Ids&sku_Ids`   - Gift List ID - `listId&listId`   - Transaction ID (TID) - `tid&tid`   - PCI Connector's Transaction ID (TID) - `pci_tid&pci_tid`   - Payment ID (PID) - `paymentId&paymentId`   - Connector's NSU - `nsu&nsu`
    Boolean fIsInstore = true; // Boolean | When set as `true`, this parameter filters orders made via [inStore](https://help.vtex.com/en/tracks/what-is-instore--zav76TFEZlAjnyBVL5tRc), and when set as `false`, it filters orders that were not made via inStore.
    try {
      ListOrders result = apiInstance.listOrders(accept, contentType, fCreationDate, orderBy, page, perPage, fHasInputInvoice, q, utc, fShippingEstimate, fInvoicedDate, fAuthorizedDate, fUtmSource, fSellerNames, fCallCenterOperatorName, fSalesChannel, salesChannelId, fAffiliateId, fStatus, incompleteOrders, fPaymentNames, fRnB, searchField, fIsInstore);
      System.out.println(result);
    } catch (ApiException e) {
...
| **page** | **Integer**| Define the number of pages you wish to retrieve, restricted to the limit of 30 pages. | [optional] [default to 10] |
| **perPage** | **Integer**| Quantity of orders for each page, the default value is 15 and it goes up to 100 orders per page. Be aware that the limit of retrieval ofthis endpoint is 30 pages. | [optional] [default to 15] |
...
- Client name: Taylor] |
| **utc** | **Integer**| Converts orders&#39; time zone to the Universal Time Coordinated (UTC) format and shows the amount of orders set for that UTC, up to the limit of 30 pages. For it to work properly, you have to associate it with the &#x60;f_creationDate&#x60; parameter. | [optional] [default to -2000] |
...
public class Example {
  public static void main(String[] args) {
    ...
    String accept = "application/json"; // String | HTTP Client Negotiation Accept Header. Indicates the types of responses the client can understand.
    String orderId = "1172452900788-01"; // String | ID that identifies the order in the seller.
    RegisterChangeRequest registerChangeRequest = new RegisterChangeRequest(); // RegisterChangeRequest | 
    try {
      RegisterChange result = apiInstance.registerChange(contentType, accept, orderId, registerChangeRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrdersApi#registerChange");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String orderId = "1172452900788-01"; // String | Order ID is a unique code that identifies an order.
    try {
      apiInstance.startHandling(accept, contentType, orderId);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrdersApi#startHandling");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
