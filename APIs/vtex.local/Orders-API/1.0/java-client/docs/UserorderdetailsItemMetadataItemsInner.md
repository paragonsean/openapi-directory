...
|------------ | ------------- | ------------- | -------------|
|**assemblyOptions** | [**List&lt;UserorderdetailsItemMetadataItemsInnerAssemblyOptionsInner&gt;**](UserorderdetailsItemMetadataItemsInnerAssemblyOptionsInner.md) | Displays information about [assembly options](https://help.vtex.com/en/tutorial/assembly-options--5x5FhNr4f5RUGDEGWzV1nH) related to the item, if there are any. |  |
