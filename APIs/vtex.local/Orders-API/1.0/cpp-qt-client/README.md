...
#include <iostream>
#include "../client/OAIChangeSellerApi.h"
...
void Example::exampleFunction1(){
     OAIChangeSellerApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIChangeSellerApi::getWindowToChangeSellerSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIChangeSellerApi::getWindowToChangeSellerSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      apiInstance.getWindowToChangeSeller(content_typeaccept);
