...
OAITotalValue1::OAITotalValue1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITotalValue1::OAITotalValue1() {
    this->initializeModel();
}

OAITotalValue1::~OAITotalValue1() {}

void OAITotalValue1::initializeModel() {
...
void OAITotalValue1::fromJson(QString jsonString) {
...
void OAITotalValue1::fromJsonObject(QJsonObject json) {
...
QString OAITotalValue1::asJson() const {
...
QJsonObject OAITotalValue1::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
qint32 OAITotalValue1::getCount() const {
    return m_count;
}
void OAITotalValue1::setCount(const qint32 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAITotalValue1::is_count_Set() const{
    return m_count_isSet;
}

bool OAITotalValue1::is_count_Valid() const{
    return m_count_isValid;
}

OAIObject OAITotalValue1::getFacets() const {
    return m_facets;
}
void OAITotalValue1::setFacets(const OAIObject &facets) {
    m_facets = facets;
    m_facets_isSet = true;
}

bool OAITotalValue1::is_facets_Set() const{
    return m_facets_isSet;
}

bool OAITotalValue1::is_facets_Valid() const{
    return m_facets_isValid;
}

qint32 OAITotalValue1::getMax() const {
    return m_max;
}
void OAITotalValue1::setMax(const qint32 &max) {
    m_max = max;
    m_max_isSet = true;
}

bool OAITotalValue1::is_max_Set() const{
    return m_max_isSet;
}

bool OAITotalValue1::is_max_Valid() const{
    return m_max_isValid;
}

qint32 OAITotalValue1::getMean() const {
    return m_mean;
}
void OAITotalValue1::setMean(const qint32 &mean) {
    m_mean = mean;
    m_mean_isSet = true;
}

bool OAITotalValue1::is_mean_Set() const{
    return m_mean_isSet;
}

bool OAITotalValue1::is_mean_Valid() const{
    return m_mean_isValid;
}

qint32 OAITotalValue1::getMin() const {
    return m_min;
}
void OAITotalValue1::setMin(const qint32 &min) {
    m_min = min;
    m_min_isSet = true;
}

bool OAITotalValue1::is_min_Set() const{
    return m_min_isSet;
}

bool OAITotalValue1::is_min_Valid() const{
    return m_min_isValid;
}

qint32 OAITotalValue1::getMissing() const {
    return m_missing;
}
void OAITotalValue1::setMissing(const qint32 &missing) {
    m_missing = missing;
    m_missing_isSet = true;
}

bool OAITotalValue1::is_missing_Set() const{
    return m_missing_isSet;
}

bool OAITotalValue1::is_missing_Valid() const{
    return m_missing_isValid;
}

qint32 OAITotalValue1::getStdDev() const {
    return m_std_dev;
}
void OAITotalValue1::setStdDev(const qint32 &std_dev) {
    m_std_dev = std_dev;
    m_std_dev_isSet = true;
}

bool OAITotalValue1::is_std_dev_Set() const{
    return m_std_dev_isSet;
}

bool OAITotalValue1::is_std_dev_Valid() const{
    return m_std_dev_isValid;
}

qint32 OAITotalValue1::getSum() const {
    return m_sum;
}
void OAITotalValue1::setSum(const qint32 &sum) {
    m_sum = sum;
    m_sum_isSet = true;
}

bool OAITotalValue1::is_sum_Set() const{
    return m_sum_isSet;
}

bool OAITotalValue1::is_sum_Valid() const{
    return m_sum_isValid;
}

qint32 OAITotalValue1::getSumOfSquares() const {
    return m_sum_of_squares;
}
void OAITotalValue1::setSumOfSquares(const qint32 &sum_of_squares) {
    m_sum_of_squares = sum_of_squares;
    m_sum_of_squares_isSet = true;
}

bool OAITotalValue1::is_sum_of_squares_Set() const{
    return m_sum_of_squares_isSet;
}

bool OAITotalValue1::is_sum_of_squares_Valid() const{
    return m_sum_of_squares_isValid;
}

bool OAITotalValue1::isSet() const {
...
bool OAITotalValue1::isValid() const {
