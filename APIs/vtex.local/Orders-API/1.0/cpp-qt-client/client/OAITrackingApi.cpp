...
void OAITrackingApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("updateTrackingStatus", defaultConf);
    _serverIndices.insert("updateTrackingStatus", 0);
}
...
void OAITrackingApi::updateTrackingStatus(const QString &content_type, const QString &accept, const QString &order_id, const QString &invoice_number, const OAIUpdateTrackingStatusRequest &oai_update_tracking_status_request) {
    QString fullPath = QString(_serverConfigs["updateTrackingStatus"][_serverIndices.value("updateTrackingStatus")].URL()+"/api/oms/pvt/orders/{orderId}/invoice/{invoiceNumber}/tracking");
...

    {
        ...
        QByteArray output = oai_update_tracking_status_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITrackingApi::updateTrackingStatusCallback);
...
void OAITrackingApi::updateTrackingStatusCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIUpdateTrackingStatus output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateTrackingStatusSignal(output);
        Q_EMIT updateTrackingStatusSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateTrackingStatusSignalE(output, error_type, error_str);
        Q_EMIT updateTrackingStatusSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateTrackingStatusSignalError(output, error_type, error_str);
        Q_EMIT updateTrackingStatusSignalErrorFull(worker, error_type, error_str);
    }
}
