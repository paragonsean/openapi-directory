...
void OAIBRL::fromJson(QString jsonString) {
...
void OAIBRL::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIBRL::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
qint32 OAIBRL::getCount() const {
    return m_count;
}
void OAIBRL::setCount(const qint32 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIBRL::is_count_Set() const{
    return m_count_isSet;
}

bool OAIBRL::is_count_Valid() const{
    return m_count_isValid;
}

QString OAIBRL::getFacets() const {
    return m_facets;
}
void OAIBRL::setFacets(const QString &facets) {
    m_facets = facets;
    m_facets_isSet = true;
}

bool OAIBRL::is_facets_Set() const{
    return m_facets_isSet;
}

bool OAIBRL::is_facets_Valid() const{
    return m_facets_isValid;
}

qint32 OAIBRL::getMax() const {
    return m_max;
}
void OAIBRL::setMax(const qint32 &max) {
    m_max = max;
    m_max_isSet = true;
}

bool OAIBRL::is_max_Set() const{
    return m_max_isSet;
}

bool OAIBRL::is_max_Valid() const{
    return m_max_isValid;
}

double OAIBRL::getMean() const {
    return m_mean;
}
void OAIBRL::setMean(const double &mean) {
    m_mean = mean;
    m_mean_isSet = true;
}

bool OAIBRL::is_mean_Set() const{
    return m_mean_isSet;
}

bool OAIBRL::is_mean_Valid() const{
    return m_mean_isValid;
}

qint32 OAIBRL::getMin() const {
    return m_min;
}
void OAIBRL::setMin(const qint32 &min) {
    m_min = min;
    m_min_isSet = true;
}

bool OAIBRL::is_min_Set() const{
    return m_min_isSet;
}

bool OAIBRL::is_min_Valid() const{
    return m_min_isValid;
}

qint32 OAIBRL::getMissing() const {
    return m_missing;
}
void OAIBRL::setMissing(const qint32 &missing) {
    m_missing = missing;
    m_missing_isSet = true;
}

bool OAIBRL::is_missing_Set() const{
    return m_missing_isSet;
}

bool OAIBRL::is_missing_Valid() const{
    return m_missing_isValid;
}

double OAIBRL::getStdDev() const {
    return m_std_dev;
}
void OAIBRL::setStdDev(const double &std_dev) {
    m_std_dev = std_dev;
    m_std_dev_isSet = true;
}

bool OAIBRL::is_std_dev_Set() const{
    return m_std_dev_isSet;
}

bool OAIBRL::is_std_dev_Valid() const{
    return m_std_dev_isValid;
}

qint32 OAIBRL::getSum() const {
    return m_sum;
}
void OAIBRL::setSum(const qint32 &sum) {
    m_sum = sum;
    m_sum_isSet = true;
}

bool OAIBRL::is_sum_Set() const{
    return m_sum_isSet;
}

bool OAIBRL::is_sum_Valid() const{
    return m_sum_isValid;
}

qint64 OAIBRL::getSumOfSquares() const {
    return m_sum_of_squares;
}
void OAIBRL::setSumOfSquares(const qint64 &sum_of_squares) {
    m_sum_of_squares = sum_of_squares;
    m_sum_of_squares_isSet = true;
}

bool OAIBRL::is_sum_of_squares_Set() const{
    return m_sum_of_squares_isSet;
}

bool OAIBRL::is_sum_of_squares_Valid() const{
    return m_sum_of_squares_isValid;
}

bool OAIBRL::isSet() const {
