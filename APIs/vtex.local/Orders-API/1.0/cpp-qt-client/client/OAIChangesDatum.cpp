...
OAIChangesDatum::OAIChangesDatum(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChangesDatum::OAIChangesDatum() {
    this->initializeModel();
}

OAIChangesDatum::~OAIChangesDatum() {}

void OAIChangesDatum::initializeModel() {
...
void OAIChangesDatum::fromJson(QString jsonString) {
...
void OAIChangesDatum::fromJsonObject(QJsonObject json) {
...
QString OAIChangesDatum::asJson() const {
...
QJsonObject OAIChangesDatum::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIChangesDatum::getDiscountValue() const {
    return m_discount_value;
}
void OAIChangesDatum::setDiscountValue(const qint32 &discount_value) {
    m_discount_value = discount_value;
    m_discount_value_isSet = true;
}

bool OAIChangesDatum::is_discount_value_Set() const{
    return m_discount_value_isSet;
}

bool OAIChangesDatum::is_discount_value_Valid() const{
    return m_discount_value_isValid;
}

qint32 OAIChangesDatum::getIncrementValue() const {
    return m_increment_value;
}
void OAIChangesDatum::setIncrementValue(const qint32 &increment_value) {
    m_increment_value = increment_value;
    m_increment_value_isSet = true;
}

bool OAIChangesDatum::is_increment_value_Set() const{
    return m_increment_value_isSet;
}

bool OAIChangesDatum::is_increment_value_Valid() const{
    return m_increment_value_isValid;
}

QList<QString> OAIChangesDatum::getItemsAdded() const {
    return m_items_added;
}
void OAIChangesDatum::setItemsAdded(const QList<QString> &items_added) {
    m_items_added = items_added;
    m_items_added_isSet = true;
}

bool OAIChangesDatum::is_items_added_Set() const{
    return m_items_added_isSet;
}

bool OAIChangesDatum::is_items_added_Valid() const{
    return m_items_added_isValid;
}

QList<OAIItemsRemoved> OAIChangesDatum::getItemsRemoved() const {
    return m_items_removed;
}
void OAIChangesDatum::setItemsRemoved(const QList<OAIItemsRemoved> &items_removed) {
    m_items_removed = items_removed;
    m_items_removed_isSet = true;
}

bool OAIChangesDatum::is_items_removed_Set() const{
    return m_items_removed_isSet;
}

bool OAIChangesDatum::is_items_removed_Valid() const{
    return m_items_removed_isValid;
}

QString OAIChangesDatum::getReason() const {
    return m_reason;
}
void OAIChangesDatum::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIChangesDatum::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIChangesDatum::is_reason_Valid() const{
    return m_reason_isValid;
}

OAIReceipt OAIChangesDatum::getReceipt() const {
    return m_receipt;
}
void OAIChangesDatum::setReceipt(const OAIReceipt &receipt) {
    m_receipt = receipt;
    m_receipt_isSet = true;
}

bool OAIChangesDatum::is_receipt_Set() const{
    return m_receipt_isSet;
}

bool OAIChangesDatum::is_receipt_Valid() const{
    return m_receipt_isValid;
}

bool OAIChangesDatum::isSet() const {
...
bool OAIChangesDatum::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_discount_value_isValid && m_increment_value_isValid && m_items_added_isValid && m_items_removed_isValid && m_reason_isValid && m_receipt_isValid && true;
}
