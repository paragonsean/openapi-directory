...
#ifndef OAITotalValue1_H
#define OAITotalValue1_H
...
class OAITotalValue1 : public OAIObject {
public:
    OAITotalValue1();
    OAITotalValue1(QString json);
    ~OAITotalValue1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITotalValue1)

#endif // OAITotalValue1_H
