...
QString OAIError::getException() const {
    return m_exception;
}
void OAIError::setException(const QString &exception) {
    m_exception = exception;
    m_exception_isSet = true;
}

bool OAIError::is_exception_Set() const{
    return m_exception_isSet;
}

bool OAIError::is_exception_Valid() const{
