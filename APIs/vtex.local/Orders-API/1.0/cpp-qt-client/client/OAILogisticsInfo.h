...
namespace OpenAPI {
class OAILogisticsInfo_deliveryChannels_inner;
class OAIDeliveryId;
...
public:
    ...
    QList<OAILogisticsInfo_deliveryChannels_inner> getDeliveryChannels() const;
    void setDeliveryChannels(const QList<OAILogisticsInfo_deliveryChannels_inner> &delivery_channels);
...
private:
    ...
    QList<OAILogisticsInfo_deliveryChannels_inner> m_delivery_channels;
