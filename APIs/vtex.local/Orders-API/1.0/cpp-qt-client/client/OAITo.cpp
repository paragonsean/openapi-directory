...
qint32 OAITo::getAliasMaskType() const {
    return m_alias_mask_type;
}
void OAITo::setAliasMaskType(const qint32 &alias_mask_type) {
    m_alias_mask_type = alias_mask_type;
    m_alias_mask_type_isSet = true;
}

bool OAITo::is_alias_mask_type_Set() const{
    return m_alias_mask_type_isSet;
}

bool OAITo::is_alias_mask_type_Valid() const{
    return m_alias_mask_type_isValid;
}

QString OAITo::getConversationRelatedTo() const {
    return m_conversation_related_to;
}
void OAITo::setConversationRelatedTo(const QString &conversation_related_to) {
    m_conversation_related_to = conversation_related_to;
    m_conversation_related_to_isSet = true;
}

bool OAITo::is_conversation_related_to_Set() const{
    return m_conversation_related_to_isSet;
}

bool OAITo::is_conversation_related_to_Valid() const{
    return m_conversation_related_to_isValid;
}

QString OAITo::getConversationSubject() const {
    return m_conversation_subject;
}
void OAITo::setConversationSubject(const QString &conversation_subject) {
    m_conversation_subject = conversation_subject;
    m_conversation_subject_isSet = true;
}

bool OAITo::is_conversation_subject_Set() const{
    return m_conversation_subject_isSet;
}

bool OAITo::is_conversation_subject_Valid() const{
    return m_conversation_subject_isValid;
}

QString OAITo::getEmail() const {
    return m_email;
}
void OAITo::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAITo::is_email_Set() const{
    return m_email_isSet;
}

bool OAITo::is_email_Valid() const{
    return m_email_isValid;
}

QString OAITo::getEmailAlias() const {
    return m_email_alias;
}
void OAITo::setEmailAlias(const QString &email_alias) {
    m_email_alias = email_alias;
    m_email_alias_isSet = true;
}

bool OAITo::is_email_alias_Set() const{
    return m_email_alias_isSet;
}

bool OAITo::is_email_alias_Valid() const{
    return m_email_alias_isValid;
}

QString OAITo::getName() const {
    return m_name;
}
void OAITo::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAITo::is_name_Set() const{
    return m_name_isSet;
}

bool OAITo::is_name_Valid() const{
    return m_name_isValid;
}

QString OAITo::getRole() const {
    return m_role;
}
void OAITo::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAITo::is_role_Set() const{
    return m_role_isSet;
}

bool OAITo::is_role_Valid() const{
