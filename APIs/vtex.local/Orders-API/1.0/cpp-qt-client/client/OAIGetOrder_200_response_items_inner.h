...
/*
 * OAIGetOrder_200_response_items_inner.h
 *
 * 
 */

#ifndef OAIGetOrder_200_response_items_inner_H
#define OAIGetOrder_200_response_items_inner_H

#include <QJsonObject>

#include "OAIGetOrder_200_response_items_inner_additionalInfo.h"
#include "OAIGetOrder_200_response_items_inner_bundleItems_inner.h"
...
namespace OpenAPI {
class OAIGetOrder_200_response_items_inner_additionalInfo;
class OAIGetOrder_200_response_items_inner_bundleItems_inner;
class OAIGetOrder_200_response_items_inner_priceDefinition;
class OAIGetOrder_200_response_items_inner_priceTags_inner;
class OAIGetOrder_200_response_items_inner_productCategories;

class OAIGetOrder_200_response_items_inner : public OAIObject {
public:
    OAIGetOrder_200_response_items_inner();
    OAIGetOrder_200_response_items_inner(QString json);
    ~OAIGetOrder_200_response_items_inner() override;
    ...
    OAIGetOrder_200_response_items_inner_additionalInfo getAdditionalInfo() const;
    void setAdditionalInfo(const OAIGetOrder_200_response_items_inner_additionalInfo &additional_info);
    ...
    QList<OAIGetOrder_200_response_items_inner_bundleItems_inner> getBundleItems() const;
    void setBundleItems(const QList<OAIGetOrder_200_response_items_inner_bundleItems_inner> &bundle_items);
    ...
    OAIGetOrder_200_response_items_inner_priceDefinition getPriceDefinition() const;
    void setPriceDefinition(const OAIGetOrder_200_response_items_inner_priceDefinition &price_definition);
    bool is_price_definition_Set() const;
    bool is_price_definition_Valid() const;

    QList<OAIGetOrder_200_response_items_inner_priceTags_inner> getPriceTags() const;
    void setPriceTags(const QList<OAIGetOrder_200_response_items_inner_priceTags_inner> &price_tags);
    ...
    OAIGetOrder_200_response_items_inner_productCategories getProductCategories() const;
    void setProductCategories(const OAIGetOrder_200_response_items_inner_productCategories &product_categories);
...
private:
    ...
    OAIGetOrder_200_response_items_inner_additionalInfo m_additional_info;
    ...
    QList<OAIGetOrder_200_response_items_inner_bundleItems_inner> m_bundle_items;
    ...
    OAIGetOrder_200_response_items_inner_priceDefinition m_price_definition;
    bool m_price_definition_isSet;
    bool m_price_definition_isValid;

    QList<OAIGetOrder_200_response_items_inner_priceTags_inner> m_price_tags;
    ...
    OAIGetOrder_200_response_items_inner_productCategories m_product_categories;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOrder_200_response_items_inner)

#endif // OAIGetOrder_200_response_items_inner_H
