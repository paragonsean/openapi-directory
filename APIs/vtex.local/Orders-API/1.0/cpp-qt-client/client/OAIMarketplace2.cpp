...
OAIMarketplace2::OAIMarketplace2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMarketplace2::OAIMarketplace2() {
    this->initializeModel();
}

OAIMarketplace2::~OAIMarketplace2() {}

void OAIMarketplace2::initializeModel() {
...
void OAIMarketplace2::fromJson(QString jsonString) {
...
void OAIMarketplace2::fromJsonObject(QJsonObject json) {
...
QString OAIMarketplace2::asJson() const {
...
QJsonObject OAIMarketplace2::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
qint32 OAIMarketplace2::getCount() const {
    return m_count;
}
void OAIMarketplace2::setCount(const qint32 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIMarketplace2::is_count_Set() const{
    return m_count_isSet;
}

bool OAIMarketplace2::is_count_Valid() const{
    return m_count_isValid;
}

QString OAIMarketplace2::getFacets() const {
    return m_facets;
}
void OAIMarketplace2::setFacets(const QString &facets) {
    m_facets = facets;
    m_facets_isSet = true;
}

bool OAIMarketplace2::is_facets_Set() const{
    return m_facets_isSet;
}

bool OAIMarketplace2::is_facets_Valid() const{
    return m_facets_isValid;
}

qint32 OAIMarketplace2::getMax() const {
    return m_max;
}
void OAIMarketplace2::setMax(const qint32 &max) {
    m_max = max;
    m_max_isSet = true;
}

bool OAIMarketplace2::is_max_Set() const{
    return m_max_isSet;
}

bool OAIMarketplace2::is_max_Valid() const{
    return m_max_isValid;
}

double OAIMarketplace2::getMean() const {
    return m_mean;
}
void OAIMarketplace2::setMean(const double &mean) {
    m_mean = mean;
    m_mean_isSet = true;
}

bool OAIMarketplace2::is_mean_Set() const{
    return m_mean_isSet;
}

bool OAIMarketplace2::is_mean_Valid() const{
    return m_mean_isValid;
}

qint32 OAIMarketplace2::getMin() const {
    return m_min;
}
void OAIMarketplace2::setMin(const qint32 &min) {
    m_min = min;
    m_min_isSet = true;
}

bool OAIMarketplace2::is_min_Set() const{
    return m_min_isSet;
}

bool OAIMarketplace2::is_min_Valid() const{
    return m_min_isValid;
}

qint32 OAIMarketplace2::getMissing() const {
    return m_missing;
}
void OAIMarketplace2::setMissing(const qint32 &missing) {
    m_missing = missing;
    m_missing_isSet = true;
}

bool OAIMarketplace2::is_missing_Set() const{
    return m_missing_isSet;
}

bool OAIMarketplace2::is_missing_Valid() const{
    return m_missing_isValid;
}

double OAIMarketplace2::getStdDev() const {
    return m_std_dev;
}
void OAIMarketplace2::setStdDev(const double &std_dev) {
    m_std_dev = std_dev;
    m_std_dev_isSet = true;
}

bool OAIMarketplace2::is_std_dev_Set() const{
    return m_std_dev_isSet;
}

bool OAIMarketplace2::is_std_dev_Valid() const{
    return m_std_dev_isValid;
}

qint32 OAIMarketplace2::getSum() const {
    return m_sum;
}
void OAIMarketplace2::setSum(const qint32 &sum) {
    m_sum = sum;
    m_sum_isSet = true;
}

bool OAIMarketplace2::is_sum_Set() const{
    return m_sum_isSet;
}

bool OAIMarketplace2::is_sum_Valid() const{
    return m_sum_isValid;
}

qint32 OAIMarketplace2::getSumOfSquares() const {
    return m_sum_of_squares;
}
void OAIMarketplace2::setSumOfSquares(const qint32 &sum_of_squares) {
    m_sum_of_squares = sum_of_squares;
    m_sum_of_squares_isSet = true;
}

bool OAIMarketplace2::is_sum_of_squares_Set() const{
    return m_sum_of_squares_isSet;
}

bool OAIMarketplace2::is_sum_of_squares_Valid() const{
    return m_sum_of_squares_isValid;
}

bool OAIMarketplace2::isSet() const {
...
bool OAIMarketplace2::isValid() const {
