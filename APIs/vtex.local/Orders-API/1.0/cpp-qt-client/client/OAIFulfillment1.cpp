...
OAIFulfillment1::OAIFulfillment1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFulfillment1::OAIFulfillment1() {
    this->initializeModel();
}

OAIFulfillment1::~OAIFulfillment1() {}

void OAIFulfillment1::initializeModel() {
...
void OAIFulfillment1::fromJson(QString jsonString) {
...
void OAIFulfillment1::fromJsonObject(QJsonObject json) {
...
QString OAIFulfillment1::asJson() const {
...
QJsonObject OAIFulfillment1::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
qint32 OAIFulfillment1::getCount() const {
    return m_count;
}
void OAIFulfillment1::setCount(const qint32 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIFulfillment1::is_count_Set() const{
    return m_count_isSet;
}

bool OAIFulfillment1::is_count_Valid() const{
    return m_count_isValid;
}

QString OAIFulfillment1::getFacets() const {
    return m_facets;
}
void OAIFulfillment1::setFacets(const QString &facets) {
    m_facets = facets;
    m_facets_isSet = true;
}

bool OAIFulfillment1::is_facets_Set() const{
    return m_facets_isSet;
}

bool OAIFulfillment1::is_facets_Valid() const{
    return m_facets_isValid;
}

qint32 OAIFulfillment1::getMax() const {
    return m_max;
}
void OAIFulfillment1::setMax(const qint32 &max) {
    m_max = max;
    m_max_isSet = true;
}

bool OAIFulfillment1::is_max_Set() const{
    return m_max_isSet;
}

bool OAIFulfillment1::is_max_Valid() const{
    return m_max_isValid;
}

qint32 OAIFulfillment1::getMean() const {
    return m_mean;
}
void OAIFulfillment1::setMean(const qint32 &mean) {
    m_mean = mean;
    m_mean_isSet = true;
}

bool OAIFulfillment1::is_mean_Set() const{
    return m_mean_isSet;
}

bool OAIFulfillment1::is_mean_Valid() const{
    return m_mean_isValid;
}

qint32 OAIFulfillment1::getMin() const {
    return m_min;
}
void OAIFulfillment1::setMin(const qint32 &min) {
    m_min = min;
    m_min_isSet = true;
}

bool OAIFulfillment1::is_min_Set() const{
    return m_min_isSet;
}

bool OAIFulfillment1::is_min_Valid() const{
    return m_min_isValid;
}

qint32 OAIFulfillment1::getMissing() const {
    return m_missing;
}
void OAIFulfillment1::setMissing(const qint32 &missing) {
    m_missing = missing;
    m_missing_isSet = true;
}

bool OAIFulfillment1::is_missing_Set() const{
    return m_missing_isSet;
}

bool OAIFulfillment1::is_missing_Valid() const{
    return m_missing_isValid;
}

qint32 OAIFulfillment1::getStdDev() const {
    return m_std_dev;
}
void OAIFulfillment1::setStdDev(const qint32 &std_dev) {
    m_std_dev = std_dev;
    m_std_dev_isSet = true;
}

bool OAIFulfillment1::is_std_dev_Set() const{
    return m_std_dev_isSet;
}

bool OAIFulfillment1::is_std_dev_Valid() const{
    return m_std_dev_isValid;
}

qint32 OAIFulfillment1::getSum() const {
    return m_sum;
}
void OAIFulfillment1::setSum(const qint32 &sum) {
    m_sum = sum;
    m_sum_isSet = true;
}

bool OAIFulfillment1::is_sum_Set() const{
    return m_sum_isSet;
}

bool OAIFulfillment1::is_sum_Valid() const{
    return m_sum_isValid;
}

qint32 OAIFulfillment1::getSumOfSquares() const {
    return m_sum_of_squares;
}
void OAIFulfillment1::setSumOfSquares(const qint32 &sum_of_squares) {
    m_sum_of_squares = sum_of_squares;
    m_sum_of_squares_isSet = true;
}

bool OAIFulfillment1::is_sum_of_squares_Set() const{
    return m_sum_of_squares_isSet;
}

bool OAIFulfillment1::is_sum_of_squares_Valid() const{
    return m_sum_of_squares_isValid;
}

bool OAIFulfillment1::isSet() const {
...
bool OAIFulfillment1::isValid() const {
