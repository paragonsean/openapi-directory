...
/*
 * OAIUserorderdetails.h
 *
 * 
 */

#ifndef OAIUserorderdetails_H
#define OAIUserorderdetails_H
...
namespace OpenAPI {
class OAIUserorderdetails_cancellationData;
class OAIChangesAttachment;
class OAIUserorderdetails_clientPreferencesData;
class OAIClientProfileData;
class OAIUserorderdetails_itemMetadata;
class OAIItem;
class OAIUserorderdetails_marketingData;
...
class OAIUserorderdetails_subscriptionData;
class OAIUserorderdetails_taxData;
class OAITotal;

class OAIUserorderdetails : public OAIObject {
public:
    OAIUserorderdetails();
    OAIUserorderdetails(QString json);
    ~OAIUserorderdetails() override;
    ...
    OAIUserorderdetails_cancellationData getCancellationData() const;
    void setCancellationData(const OAIUserorderdetails_cancellationData &cancellation_data);
    bool is_cancellation_data_Set() const;
    bool is_cancellation_data_Valid() const;
    ...
    OAIUserorderdetails_clientPreferencesData getClientPreferencesData() const;
    void setClientPreferencesData(const OAIUserorderdetails_clientPreferencesData &client_preferences_data);
    ...
    OAIUserorderdetails_itemMetadata getItemMetadata() const;
    void setItemMetadata(const OAIUserorderdetails_itemMetadata &item_metadata);
    ...
    OAIUserorderdetails_marketingData getMarketingData() const;
    void setMarketingData(const OAIUserorderdetails_marketingData &marketing_data);
    ...
    OAIUserorderdetails_subscriptionData getSubscriptionData() const;
    void setSubscriptionData(const OAIUserorderdetails_subscriptionData &subscription_data);
    bool is_subscription_data_Set() const;
    bool is_subscription_data_Valid() const;

    OAIUserorderdetails_taxData getTaxData() const;
    void setTaxData(const OAIUserorderdetails_taxData &tax_data);
...
private:
    ...
    OAIUserorderdetails_cancellationData m_cancellation_data;
    bool m_cancellation_data_isSet;
    bool m_cancellation_data_isValid;
    ...
    OAIUserorderdetails_clientPreferencesData m_client_preferences_data;
    ...
    OAIUserorderdetails_itemMetadata m_item_metadata;
    ...
    OAIUserorderdetails_marketingData m_marketing_data;
    ...
    OAIUserorderdetails_subscriptionData m_subscription_data;
    bool m_subscription_data_isSet;
    bool m_subscription_data_isValid;

    OAIUserorderdetails_taxData m_tax_data;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserorderdetails)

#endif // OAIUserorderdetails_H
