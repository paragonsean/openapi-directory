...
void OAIPayment::initializeModel() {
    ...
    m_bank_issued_invoice_bar_code_number_isSet = false;
    m_bank_issued_invoice_bar_code_number_isValid = false;

    m_bank_issued_invoice_bar_code_type_isSet = false;
    m_bank_issued_invoice_bar_code_type_isValid = false;

    m_bank_issued_invoice_identification_number_isSet = false;
    m_bank_issued_invoice_identification_number_isValid = false;

    m_bank_issued_invoice_identification_number_formatted_isSet = false;
    m_bank_issued_invoice_identification_number_formatted_isValid = false;
    ...
    m_gift_card_as_discount_isSet = false;
    m_gift_card_as_discount_isValid = false;
    ...
    m_koin_url_isSet = false;
    m_koin_url_isValid = false;
...
void OAIPayment::fromJsonObject(QJsonObject json) {
    ...
    m_bank_issued_invoice_bar_code_number_isValid = ::OpenAPI::fromJsonValue(m_bank_issued_invoice_bar_code_number, json[QString("bankIssuedInvoiceBarCodeNumber")]);
    m_bank_issued_invoice_bar_code_number_isSet = !json[QString("bankIssuedInvoiceBarCodeNumber")].isNull() && m_bank_issued_invoice_bar_code_number_isValid;

    m_bank_issued_invoice_bar_code_type_isValid = ::OpenAPI::fromJsonValue(m_bank_issued_invoice_bar_code_type, json[QString("bankIssuedInvoiceBarCodeType")]);
    m_bank_issued_invoice_bar_code_type_isSet = !json[QString("bankIssuedInvoiceBarCodeType")].isNull() && m_bank_issued_invoice_bar_code_type_isValid;

    m_bank_issued_invoice_identification_number_isValid = ::OpenAPI::fromJsonValue(m_bank_issued_invoice_identification_number, json[QString("bankIssuedInvoiceIdentificationNumber")]);
    m_bank_issued_invoice_identification_number_isSet = !json[QString("bankIssuedInvoiceIdentificationNumber")].isNull() && m_bank_issued_invoice_identification_number_isValid;

    m_bank_issued_invoice_identification_number_formatted_isValid = ::OpenAPI::fromJsonValue(m_bank_issued_invoice_identification_number_formatted, json[QString("bankIssuedInvoiceIdentificationNumberFormatted")]);
    m_bank_issued_invoice_identification_number_formatted_isSet = !json[QString("bankIssuedInvoiceIdentificationNumberFormatted")].isNull() && m_bank_issued_invoice_identification_number_formatted_isValid;
    ...
    m_gift_card_as_discount_isValid = ::OpenAPI::fromJsonValue(m_gift_card_as_discount, json[QString("giftCardAsDiscount")]);
    m_gift_card_as_discount_isSet = !json[QString("giftCardAsDiscount")].isNull() && m_gift_card_as_discount_isValid;
    ...
    m_koin_url_isValid = ::OpenAPI::fromJsonValue(m_koin_url, json[QString("koinUrl")]);
    m_koin_url_isSet = !json[QString("koinUrl")].isNull() && m_koin_url_isValid;
...
QJsonObject OAIPayment::asJsonObject() const {
    ...
    if (m_bank_issued_invoice_bar_code_number_isSet) {
        obj.insert(QString("bankIssuedInvoiceBarCodeNumber"), ::OpenAPI::toJsonValue(m_bank_issued_invoice_bar_code_number));
    }
    if (m_bank_issued_invoice_bar_code_type_isSet) {
        obj.insert(QString("bankIssuedInvoiceBarCodeType"), ::OpenAPI::toJsonValue(m_bank_issued_invoice_bar_code_type));
    }
    if (m_bank_issued_invoice_identification_number_isSet) {
        obj.insert(QString("bankIssuedInvoiceIdentificationNumber"), ::OpenAPI::toJsonValue(m_bank_issued_invoice_identification_number));
    }
    if (m_bank_issued_invoice_identification_number_formatted_isSet) {
        obj.insert(QString("bankIssuedInvoiceIdentificationNumberFormatted"), ::OpenAPI::toJsonValue(m_bank_issued_invoice_identification_number_formatted));
    }
    ...
    if (m_gift_card_as_discount_isSet) {
        obj.insert(QString("giftCardAsDiscount"), ::OpenAPI::toJsonValue(m_gift_card_as_discount));
    }
    ...
    if (m_koin_url_isSet) {
        obj.insert(QString("koinUrl"), ::OpenAPI::toJsonValue(m_koin_url));
    }
...
QString OAIPayment::getBankIssuedInvoiceBarCodeNumber() const {
    return m_bank_issued_invoice_bar_code_number;
}
void OAIPayment::setBankIssuedInvoiceBarCodeNumber(const QString &bank_issued_invoice_bar_code_number) {
    m_bank_issued_invoice_bar_code_number = bank_issued_invoice_bar_code_number;
    m_bank_issued_invoice_bar_code_number_isSet = true;
}

bool OAIPayment::is_bank_issued_invoice_bar_code_number_Set() const{
    return m_bank_issued_invoice_bar_code_number_isSet;
}

bool OAIPayment::is_bank_issued_invoice_bar_code_number_Valid() const{
    return m_bank_issued_invoice_bar_code_number_isValid;
}

QString OAIPayment::getBankIssuedInvoiceBarCodeType() const {
    return m_bank_issued_invoice_bar_code_type;
}
void OAIPayment::setBankIssuedInvoiceBarCodeType(const QString &bank_issued_invoice_bar_code_type) {
    m_bank_issued_invoice_bar_code_type = bank_issued_invoice_bar_code_type;
    m_bank_issued_invoice_bar_code_type_isSet = true;
}

bool OAIPayment::is_bank_issued_invoice_bar_code_type_Set() const{
    return m_bank_issued_invoice_bar_code_type_isSet;
}

bool OAIPayment::is_bank_issued_invoice_bar_code_type_Valid() const{
    return m_bank_issued_invoice_bar_code_type_isValid;
}

QString OAIPayment::getBankIssuedInvoiceIdentificationNumber() const {
    return m_bank_issued_invoice_identification_number;
}
void OAIPayment::setBankIssuedInvoiceIdentificationNumber(const QString &bank_issued_invoice_identification_number) {
    m_bank_issued_invoice_identification_number = bank_issued_invoice_identification_number;
    m_bank_issued_invoice_identification_number_isSet = true;
}

bool OAIPayment::is_bank_issued_invoice_identification_number_Set() const{
    return m_bank_issued_invoice_identification_number_isSet;
}

bool OAIPayment::is_bank_issued_invoice_identification_number_Valid() const{
    return m_bank_issued_invoice_identification_number_isValid;
}

QString OAIPayment::getBankIssuedInvoiceIdentificationNumberFormatted() const {
    return m_bank_issued_invoice_identification_number_formatted;
}
void OAIPayment::setBankIssuedInvoiceIdentificationNumberFormatted(const QString &bank_issued_invoice_identification_number_formatted) {
    m_bank_issued_invoice_identification_number_formatted = bank_issued_invoice_identification_number_formatted;
    m_bank_issued_invoice_identification_number_formatted_isSet = true;
}

bool OAIPayment::is_bank_issued_invoice_identification_number_formatted_Set() const{
    return m_bank_issued_invoice_identification_number_formatted_isSet;
}

bool OAIPayment::is_bank_issued_invoice_identification_number_formatted_Valid() const{
    return m_bank_issued_invoice_identification_number_formatted_isValid;
}

OAIObject OAIPayment::getBillingAddress() const {
    return m_billing_address;
}
void OAIPayment::setBillingAddress(const OAIObject &billing_address) {
...
OAIPayment_connectorResponses OAIPayment::getConnectorResponses() const {
    return m_connector_responses;
}
void OAIPayment::setConnectorResponses(const OAIPayment_connectorResponses &connector_responses) {
...
bool OAIPayment::isGiftCardAsDiscount() const {
    return m_gift_card_as_discount;
}
void OAIPayment::setGiftCardAsDiscount(const bool &gift_card_as_discount) {
    m_gift_card_as_discount = gift_card_as_discount;
    m_gift_card_as_discount_isSet = true;
}

bool OAIPayment::is_gift_card_as_discount_Set() const{
    return m_gift_card_as_discount_isSet;
}

bool OAIPayment::is_gift_card_as_discount_Valid() const{
    return m_gift_card_as_discount_isValid;
}
...
QString OAIPayment::getGiftCardProvider() const {
    return m_gift_card_provider;
}
void OAIPayment::setGiftCardProvider(const QString &gift_card_provider) {
    m_gift_card_provider = gift_card_provider;
    m_gift_card_provider_isSet = true;
}

bool OAIPayment::is_gift_card_provider_Set() const{
    return m_gift_card_provider_isSet;
}

bool OAIPayment::is_gift_card_provider_Valid() const{
...
QString OAIPayment::getKoinUrl() const {
    return m_koin_url;
}
void OAIPayment::setKoinUrl(const QString &koin_url) {
    m_koin_url = koin_url;
    m_koin_url_isSet = true;
}

bool OAIPayment::is_koin_url_Set() const{
    return m_koin_url_isSet;
}

bool OAIPayment::is_koin_url_Valid() const{
    return m_koin_url_isValid;
}
...
bool OAIPayment::isValid() const {
    ...
    return m_account_id_isValid && m_bank_issued_invoice_bar_code_number_isValid && m_bank_issued_invoice_bar_code_type_isValid && m_bank_issued_invoice_identification_number_isValid && m_bank_issued_invoice_identification_number_formatted_isValid && m_billing_address_isValid && m_card_holder_isValid && m_card_number_isValid && m_connector_responses_isValid && m_cvv2_isValid && m_due_date_isValid && m_expire_month_isValid && m_expire_year_isValid && m_first_digits_isValid && m_gift_card_as_discount_isValid && m_gift_card_caption_isValid && m_gift_card_id_isValid && m_gift_card_name_isValid && m_gift_card_provider_isValid && m_group_isValid && m_id_isValid && m_installments_isValid && m_koin_url_isValid && m_last_digits_isValid && m_parent_account_id_isValid && m_payment_system_isValid && m_payment_system_name_isValid && m_redemption_code_isValid && m_reference_value_isValid && m_tid_isValid && m_url_isValid && m_value_isValid && true;
}
