...
QString OAIReceipt::getOrderId() const {
    return m_order_id;
}
void OAIReceipt::setOrderId(const QString &order_id) {
    m_order_id = order_id;
    m_order_id_isSet = true;
}

bool OAIReceipt::is_order_id_Set() const{
    return m_order_id_isSet;
}

bool OAIReceipt::is_order_id_Valid() const{
    return m_order_id_isValid;
}

QString OAIReceipt::getReceipt() const {
    return m_receipt;
}
void OAIReceipt::setReceipt(const QString &receipt) {
    m_receipt = receipt;
    m_receipt_isSet = true;
}

bool OAIReceipt::is_receipt_Set() const{
    return m_receipt_isSet;
}

bool OAIReceipt::is_receipt_Valid() const{
