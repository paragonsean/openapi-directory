...
QList<OAILogisticsInfo_deliveryChannels_inner> OAILogisticsInfo::getDeliveryChannels() const {
    return m_delivery_channels;
}
void OAILogisticsInfo::setDeliveryChannels(const QList<OAILogisticsInfo_deliveryChannels_inner> &delivery_channels) {
    m_delivery_channels = delivery_channels;
    m_delivery_channels_isSet = true;
}

bool OAILogisticsInfo::is_delivery_channels_Set() const{
    return m_delivery_channels_isSet;
}

bool OAILogisticsInfo::is_delivery_channels_Valid() const{
...
QString OAILogisticsInfo::getEntityId() const {
    return m_entity_id;
}
void OAILogisticsInfo::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAILogisticsInfo::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAILogisticsInfo::is_entity_id_Valid() const{
...
QString OAILogisticsInfo::getPickupPointId() const {
    return m_pickup_point_id;
}
void OAILogisticsInfo::setPickupPointId(const QString &pickup_point_id) {
    m_pickup_point_id = pickup_point_id;
    m_pickup_point_id_isSet = true;
}

bool OAILogisticsInfo::is_pickup_point_id_Set() const{
    return m_pickup_point_id_isSet;
}

bool OAILogisticsInfo::is_pickup_point_id_Valid() const{
...
QString OAILogisticsInfo::getTransitTime() const {
    return m_transit_time;
}
void OAILogisticsInfo::setTransitTime(const QString &transit_time) {
    m_transit_time = transit_time;
    m_transit_time_isSet = true;
}

bool OAILogisticsInfo::is_transit_time_Set() const{
    return m_transit_time_isSet;
}

bool OAILogisticsInfo::is_transit_time_Valid() const{
    return m_transit_time_isValid;
}

QString OAILogisticsInfo::getVersionId() const {
    return m_version_id;
}
void OAILogisticsInfo::setVersionId(const QString &version_id) {
    m_version_id = version_id;
    m_version_id_isSet = true;
}

bool OAILogisticsInfo::is_version_id_Set() const{
    return m_version_id_isSet;
}

bool OAILogisticsInfo::is_version_id_Valid() const{
...
bool OAILogisticsInfo::isValid() const {
    ...
    return m_address_id_isValid && m_delivery_channel_isValid && m_delivery_channels_isValid && m_delivery_company_isValid && m_delivery_ids_isValid && m_delivery_window_isValid && m_entity_id_isValid && m_item_index_isValid && m_list_price_isValid && m_lock_ttl_isValid && m_pickup_point_id_isValid && m_pickup_store_info_isValid && m_polygon_name_isValid && m_price_isValid && m_selected_sla_isValid && m_selling_price_isValid && m_shipping_estimate_isValid && m_shipping_estimate_date_isValid && m_ships_to_isValid && m_slas_isValid && m_transit_time_isValid && m_version_id_isValid && true;
}
