...
#ifndef OAITotalItems1_H
#define OAITotalItems1_H
...
class OAITotalItems1 : public OAIObject {
public:
    OAITotalItems1();
    OAITotalItems1(QString json);
    ~OAITotalItems1() override;
    ...
    OAIObject getFacets() const;
    void setFacets(const OAIObject &facets);
...
Q_DECLARE_METATYPE(OpenAPI::OAITotalItems1)

#endif // OAITotalItems1_H
