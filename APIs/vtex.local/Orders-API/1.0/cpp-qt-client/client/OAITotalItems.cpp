...
OAIFacets1 OAITotalItems::getFacets() const {
    return m_facets;
}
void OAITotalItems::setFacets(const OAIFacets1 &facets) {
    m_facets = facets;
    m_facets_isSet = true;
}
...
qint32 OAITotalItems::getSumOfSquares() const {
    return m_sum_of_squares;
}
void OAITotalItems::setSumOfSquares(const qint32 &sum_of_squares) {
