...
/*
 * OAIGetFeedConfiguration_200_response_filter.h
 *
 * Information on how orders are filtered to show on the feed.
 */

#ifndef OAIGetFeedConfiguration_200_response_filter_H
#define OAIGetFeedConfiguration_200_response_filter_H
...
class OAIGetFeedConfiguration_200_response_filter : public OAIObject {
public:
    OAIGetFeedConfiguration_200_response_filter();
    OAIGetFeedConfiguration_200_response_filter(QString json);
    ~OAIGetFeedConfiguration_200_response_filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFeedConfiguration_200_response_filter)

#endif // OAIGetFeedConfiguration_200_response_filter_H
