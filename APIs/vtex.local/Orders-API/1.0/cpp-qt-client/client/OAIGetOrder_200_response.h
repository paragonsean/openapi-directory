...
/*
 * OAIGetOrder_200_response.h
 *
 * 
 */

#ifndef OAIGetOrder_200_response_H
#define OAIGetOrder_200_response_H

#include <QJsonObject>

#include "OAIChangesAttachment.h"
#include "OAIClientProfileData.h"
#include "OAIGetOrder_200_response_items_inner.h"
...
class OAIGetOrder_200_response_items_inner;
class OAIMarketplace;
class OAIGetOrder_200_response_packageAttachment;
class OAIPaymentData;
class OAIRatesAndBenefitsData;
class OAISeller;
class OAIShippingData;
class OAIStorePreferencesData;
class OAIGetOrder_200_response_totals_inner;

class OAIGetOrder_200_response : public OAIObject {
public:
    OAIGetOrder_200_response();
    OAIGetOrder_200_response(QString json);
    ~OAIGetOrder_200_response() override;
    ...
    QList<OAIGetOrder_200_response_items_inner> getItems() const;
    void setItems(const QList<OAIGetOrder_200_response_items_inner> &items);
    ...
    OAIGetOrder_200_response_packageAttachment getPackageAttachment() const;
    void setPackageAttachment(const OAIGetOrder_200_response_packageAttachment &package_attachment);
    ...
    QList<OAIGetOrder_200_response_totals_inner> getTotals() const;
    void setTotals(const QList<OAIGetOrder_200_response_totals_inner> &totals);
...
private:
    ...
    QList<OAIGetOrder_200_response_items_inner> m_items;
    bool m_items_isSet;
    ...
    OAIGetOrder_200_response_packageAttachment m_package_attachment;
    ...
    QList<OAIGetOrder_200_response_totals_inner> m_totals;
    bool m_totals_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOrder_200_response)

#endif // OAIGetOrder_200_response_H
