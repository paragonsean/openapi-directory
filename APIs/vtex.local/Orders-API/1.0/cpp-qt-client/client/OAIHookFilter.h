...
#ifndef OAIHookFilter_H
#define OAIHookFilter_H
...
class OAIHookFilter : public OAIObject {
public:
    OAIHookFilter();
    OAIHookFilter(QString json);
    ~OAIHookFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHookFilter)

#endif // OAIHookFilter_H
