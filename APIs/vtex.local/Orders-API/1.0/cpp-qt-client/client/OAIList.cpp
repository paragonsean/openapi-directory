...
QString OAIList::getShippingEstimatedDate() const {
    return m_shipping_estimated_date;
}
void OAIList::setShippingEstimatedDate(const QString &shipping_estimated_date) {
    m_shipping_estimated_date = shipping_estimated_date;
    m_shipping_estimated_date_isSet = true;
}

bool OAIList::is_shipping_estimated_date_Set() const{
    return m_shipping_estimated_date_isSet;
}

bool OAIList::is_shipping_estimated_date_Valid() const{
    return m_shipping_estimated_date_isValid;
}

QString OAIList::getShippingEstimatedDateMax() const {
    return m_shipping_estimated_date_max;
}
void OAIList::setShippingEstimatedDateMax(const QString &shipping_estimated_date_max) {
    m_shipping_estimated_date_max = shipping_estimated_date_max;
    m_shipping_estimated_date_max_isSet = true;
}

bool OAIList::is_shipping_estimated_date_max_Set() const{
    return m_shipping_estimated_date_max_isSet;
}

bool OAIList::is_shipping_estimated_date_max_Valid() const{
    return m_shipping_estimated_date_max_isValid;
}

QString OAIList::getShippingEstimatedDateMin() const {
    return m_shipping_estimated_date_min;
}
void OAIList::setShippingEstimatedDateMin(const QString &shipping_estimated_date_min) {
    m_shipping_estimated_date_min = shipping_estimated_date_min;
    m_shipping_estimated_date_min_isSet = true;
}

bool OAIList::is_shipping_estimated_date_min_Set() const{
    return m_shipping_estimated_date_min_isSet;
}

bool OAIList::is_shipping_estimated_date_min_Valid() const{
    return m_shipping_estimated_date_min_isValid;
}

QString OAIList::getAffiliateId() const {
    return m_affiliate_id;
}
void OAIList::setAffiliateId(const QString &affiliate_id) {
    m_affiliate_id = affiliate_id;
    m_affiliate_id_isSet = true;
}

bool OAIList::is_affiliate_id_Set() const{
    return m_affiliate_id_isSet;
}

bool OAIList::is_affiliate_id_Valid() const{
    return m_affiliate_id_isValid;
}

QString OAIList::getAuthorizedDate() const {
    return m_authorized_date;
}
void OAIList::setAuthorizedDate(const QString &authorized_date) {
    m_authorized_date = authorized_date;
    m_authorized_date_isSet = true;
}

bool OAIList::is_authorized_date_Set() const{
    return m_authorized_date_isSet;
}

bool OAIList::is_authorized_date_Valid() const{
    return m_authorized_date_isValid;
}

QString OAIList::getCallCenterOperatorName() const {
    return m_call_center_operator_name;
}
void OAIList::setCallCenterOperatorName(const QString &call_center_operator_name) {
    m_call_center_operator_name = call_center_operator_name;
    m_call_center_operator_name_isSet = true;
}

bool OAIList::is_call_center_operator_name_Set() const{
    return m_call_center_operator_name_isSet;
}

bool OAIList::is_call_center_operator_name_Valid() const{
    return m_call_center_operator_name_isValid;
}

QString OAIList::getClientName() const {
    return m_client_name;
}
void OAIList::setClientName(const QString &client_name) {
    m_client_name = client_name;
    m_client_name_isSet = true;
}

bool OAIList::is_client_name_Set() const{
    return m_client_name_isSet;
}

bool OAIList::is_client_name_Valid() const{
    return m_client_name_isValid;
}

QString OAIList::getCreationDate() const {
    return m_creation_date;
}
void OAIList::setCreationDate(const QString &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIList::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIList::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAIList::getCurrencyCode() const {
    return m_currency_code;
}
void OAIList::setCurrencyCode(const QString &currency_code) {
    m_currency_code = currency_code;
    m_currency_code_isSet = true;
}

bool OAIList::is_currency_code_Set() const{
    return m_currency_code_isSet;
}

bool OAIList::is_currency_code_Valid() const{
    return m_currency_code_isValid;
}

QString OAIList::getItems() const {
    return m_items;
}
void OAIList::setItems(const QString &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIList::is_items_Set() const{
    return m_items_isSet;
}

bool OAIList::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIList::getLastMessageUnread() const {
    return m_last_message_unread;
}
void OAIList::setLastMessageUnread(const QString &last_message_unread) {
    m_last_message_unread = last_message_unread;
    m_last_message_unread_isSet = true;
}

bool OAIList::is_last_message_unread_Set() const{
    return m_last_message_unread_isSet;
}

bool OAIList::is_last_message_unread_Valid() const{
...
QString OAIList::getListType() const {
    return m_list_type;
}
void OAIList::setListType(const QString &list_type) {
    m_list_type = list_type;
    m_list_type_isSet = true;
}

bool OAIList::is_list_type_Set() const{
    return m_list_type_isSet;
}

bool OAIList::is_list_type_Valid() const{
    return m_list_type_isValid;
}

QString OAIList::getMarketPlaceOrderId() const {
    return m_market_place_order_id;
}
void OAIList::setMarketPlaceOrderId(const QString &market_place_order_id) {
    m_market_place_order_id = market_place_order_id;
    m_market_place_order_id_isSet = true;
}

bool OAIList::is_market_place_order_id_Set() const{
    return m_market_place_order_id_isSet;
}

bool OAIList::is_market_place_order_id_Valid() const{
    return m_market_place_order_id_isValid;
}

QString OAIList::getOrderId() const {
    return m_order_id;
}
void OAIList::setOrderId(const QString &order_id) {
    m_order_id = order_id;
    m_order_id_isSet = true;
}

bool OAIList::is_order_id_Set() const{
    return m_order_id_isSet;
}

bool OAIList::is_order_id_Valid() const{
    return m_order_id_isValid;
}

bool OAIList::isOrderIsComplete() const {
    return m_order_is_complete;
}
void OAIList::setOrderIsComplete(const bool &order_is_complete) {
    m_order_is_complete = order_is_complete;
    m_order_is_complete_isSet = true;
}

bool OAIList::is_order_is_complete_Set() const{
    return m_order_is_complete_isSet;
}

bool OAIList::is_order_is_complete_Valid() const{
    return m_order_is_complete_isValid;
}

QString OAIList::getOrigin() const {
    return m_origin;
}
void OAIList::setOrigin(const QString &origin) {
    m_origin = origin;
    m_origin_isSet = true;
}

bool OAIList::is_origin_Set() const{
    return m_origin_isSet;
}

bool OAIList::is_origin_Valid() const{
    return m_origin_isValid;
}

QString OAIList::getPaymentNames() const {
    return m_payment_names;
}
void OAIList::setPaymentNames(const QString &payment_names) {
    m_payment_names = payment_names;
    m_payment_names_isSet = true;
}

bool OAIList::is_payment_names_Set() const{
    return m_payment_names_isSet;
}

bool OAIList::is_payment_names_Valid() const{
    return m_payment_names_isValid;
}

QString OAIList::getSalesChannel() const {
    return m_sales_channel;
}
void OAIList::setSalesChannel(const QString &sales_channel) {
    m_sales_channel = sales_channel;
    m_sales_channel_isSet = true;
}

bool OAIList::is_sales_channel_Set() const{
    return m_sales_channel_isSet;
}

bool OAIList::is_sales_channel_Valid() const{
    return m_sales_channel_isValid;
}

QString OAIList::getSequence() const {
    return m_sequence;
}
void OAIList::setSequence(const QString &sequence) {
    m_sequence = sequence;
    m_sequence_isSet = true;
}

bool OAIList::is_sequence_Set() const{
    return m_sequence_isSet;
}

bool OAIList::is_sequence_Valid() const{
    return m_sequence_isValid;
}

QString OAIList::getStatus() const {
    return m_status;
}
void OAIList::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIList::is_status_Set() const{
    return m_status_isSet;
}

bool OAIList::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIList::getStatusDescription() const {
    return m_status_description;
}
void OAIList::setStatusDescription(const QString &status_description) {
    m_status_description = status_description;
    m_status_description_isSet = true;
}

bool OAIList::is_status_description_Set() const{
    return m_status_description_isSet;
}

bool OAIList::is_status_description_Valid() const{
    return m_status_description_isValid;
}

qint32 OAIList::getTotalItems() const {
    return m_total_items;
}
void OAIList::setTotalItems(const qint32 &total_items) {
    m_total_items = total_items;
    m_total_items_isSet = true;
}

bool OAIList::is_total_items_Set() const{
    return m_total_items_isSet;
}

bool OAIList::is_total_items_Valid() const{
    return m_total_items_isValid;
}

qint32 OAIList::getTotalValue() const {
    return m_total_value;
}
void OAIList::setTotalValue(const qint32 &total_value) {
    m_total_value = total_value;
    m_total_value_isSet = true;
}

bool OAIList::is_total_value_Set() const{
    return m_total_value_isSet;
}

bool OAIList::is_total_value_Valid() const{
    return m_total_value_isValid;
}

bool OAIList::isWorkflowInErrorState() const {
    return m_workflow_in_error_state;
}
void OAIList::setWorkflowInErrorState(const bool &workflow_in_error_state) {
    m_workflow_in_error_state = workflow_in_error_state;
    m_workflow_in_error_state_isSet = true;
}

bool OAIList::is_workflow_in_error_state_Set() const{
    return m_workflow_in_error_state_isSet;
}

bool OAIList::is_workflow_in_error_state_Valid() const{
    return m_workflow_in_error_state_isValid;
}

bool OAIList::isWorkflowInRetry() const {
    return m_workflow_in_retry;
}
void OAIList::setWorkflowInRetry(const bool &workflow_in_retry) {
    m_workflow_in_retry = workflow_in_retry;
    m_workflow_in_retry_isSet = true;
}

bool OAIList::is_workflow_in_retry_Set() const{
    return m_workflow_in_retry_isSet;
}

bool OAIList::is_workflow_in_retry_Valid() const{
