...
#ifndef OAITotalItems_H
#define OAITotalItems_H
...
class OAITotalItems : public OAIObject {
public:
    OAITotalItems();
    OAITotalItems(QString json);
    ~OAITotalItems() override;
    ...
    OAIFacets1 getFacets() const;
    void setFacets(const OAIFacets1 &facets);
...
Q_DECLARE_METATYPE(OpenAPI::OAITotalItems)

#endif // OAITotalItems_H
