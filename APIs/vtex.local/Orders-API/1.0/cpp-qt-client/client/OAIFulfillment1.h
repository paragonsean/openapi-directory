...
#ifndef OAIFulfillment1_H
#define OAIFulfillment1_H
...
class OAIFulfillment1 : public OAIObject {
public:
    OAIFulfillment1();
    OAIFulfillment1(QString json);
    ~OAIFulfillment1() override;
    ...
    qint32 getStdDev() const;
    void setStdDev(const qint32 &std_dev);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFulfillment1)

#endif // OAIFulfillment1_H
