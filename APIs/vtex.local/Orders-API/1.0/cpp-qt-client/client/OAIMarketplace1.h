...
#ifndef OAIMarketplace1_H
#define OAIMarketplace1_H
...
class OAIMarketplace1 : public OAIObject {
public:
    OAIMarketplace1();
    OAIMarketplace1(QString json);
    ~OAIMarketplace1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarketplace1)

#endif // OAIMarketplace1_H
