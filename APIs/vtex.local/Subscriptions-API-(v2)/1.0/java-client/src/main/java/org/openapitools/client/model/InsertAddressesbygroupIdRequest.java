...
public class InsertAddressesbygroupIdRequest {
  ...
  public InsertAddressesbygroupIdRequest() {
  }

  public InsertAddressesbygroupIdRequest additionalComponents(List<AdditionalComponent> additionalComponents) {
    this.additionalComponents = additionalComponents;
    return this;
  }

  public InsertAddressesbygroupIdRequest addAdditionalComponentsItem(AdditionalComponent additionalComponentsItem) {
  ...
  public InsertAddressesbygroupIdRequest addressId(String addressId) {
  ...
  public InsertAddressesbygroupIdRequest addressName(String addressName) {
  ...
  public InsertAddressesbygroupIdRequest addressType(String addressType) {
  ...
  public InsertAddressesbygroupIdRequest city(String city) {
    this.city = city;
    return this;
  }
  ...
  public InsertAddressesbygroupIdRequest complement(String complement) {
  ...
  public InsertAddressesbygroupIdRequest country(String country) {
  ...
  public InsertAddressesbygroupIdRequest formattedAddress(String formattedAddress) {
  ...
  public InsertAddressesbygroupIdRequest geoCoordinate(List<Integer> geoCoordinate) {
    this.geoCoordinate = geoCoordinate;
    return this;
  }

  public InsertAddressesbygroupIdRequest addGeoCoordinateItem(Integer geoCoordinateItem) {
  ...
  public InsertAddressesbygroupIdRequest neighborhood(String neighborhood) {
  ...
  public InsertAddressesbygroupIdRequest number(String number) {
    this.number = number;
    return this;
  }
  ...
  public InsertAddressesbygroupIdRequest postalCode(String postalCode) {
  ...
  public InsertAddressesbygroupIdRequest receiverName(String receiverName) {
  ...
  public InsertAddressesbygroupIdRequest reference(String reference) {
  ...
  public InsertAddressesbygroupIdRequest state(String state) {
    this.state = state;
    return this;
  }
  ...
  public InsertAddressesbygroupIdRequest street(String street) {
    this.street = street;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InsertAddressesbygroupIdRequest insertAddressesbygroupIdRequest = (InsertAddressesbygroupIdRequest) o;
    return Objects.equals(this.additionalComponents, insertAddressesbygroupIdRequest.additionalComponents) &&
        Objects.equals(this.addressId, insertAddressesbygroupIdRequest.addressId) &&
        Objects.equals(this.addressName, insertAddressesbygroupIdRequest.addressName) &&
        Objects.equals(this.addressType, insertAddressesbygroupIdRequest.addressType) &&
        Objects.equals(this.city, insertAddressesbygroupIdRequest.city) &&
        Objects.equals(this.complement, insertAddressesbygroupIdRequest.complement) &&
        Objects.equals(this.country, insertAddressesbygroupIdRequest.country) &&
        Objects.equals(this.formattedAddress, insertAddressesbygroupIdRequest.formattedAddress) &&
        Objects.equals(this.geoCoordinate, insertAddressesbygroupIdRequest.geoCoordinate) &&
        Objects.equals(this.neighborhood, insertAddressesbygroupIdRequest.neighborhood) &&
        Objects.equals(this.number, insertAddressesbygroupIdRequest.number) &&
        Objects.equals(this.postalCode, insertAddressesbygroupIdRequest.postalCode) &&
        Objects.equals(this.receiverName, insertAddressesbygroupIdRequest.receiverName) &&
        Objects.equals(this.reference, insertAddressesbygroupIdRequest.reference) &&
        Objects.equals(this.state, insertAddressesbygroupIdRequest.state) &&
        Objects.equals(this.street, insertAddressesbygroupIdRequest.street);
  }
  ...
  public String toString() {
    ...
    sb.append("class InsertAddressesbygroupIdRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InsertAddressesbygroupIdRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InsertAddressesbygroupIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InsertAddressesbygroupIdRequest is not found in the empty JSON string", InsertAddressesbygroupIdRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsertAddressesbygroupIdRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsertAddressesbygroupIdRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InsertAddressesbygroupIdRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InsertAddressesbygroupIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InsertAddressesbygroupIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InsertAddressesbygroupIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InsertAddressesbygroupIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<InsertAddressesbygroupIdRequest>() {
           @Override
           public void write(JsonWriter out, InsertAddressesbygroupIdRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InsertAddressesbygroupIdRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InsertAddressesbygroupIdRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InsertAddressesbygroupIdRequest
   * @throws IOException if the JSON string is invalid with respect to InsertAddressesbygroupIdRequest
   */
  public static InsertAddressesbygroupIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InsertAddressesbygroupIdRequest.class);
  }

  /**
   * Convert an instance of InsertAddressesbygroupIdRequest to an JSON string
   *
   * @return JSON string
   */
