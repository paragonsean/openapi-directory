...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV2Deprecated.Plan();
  });
  ...
  describe('Plan', function() {
    it('should create an instance of Plan', function() {
      ...
      //var instance = new SubscriptionsApiV2Deprecated.Plan();
      //expect(instance).to.be.a(SubscriptionsApiV2Deprecated.Plan);
    });
