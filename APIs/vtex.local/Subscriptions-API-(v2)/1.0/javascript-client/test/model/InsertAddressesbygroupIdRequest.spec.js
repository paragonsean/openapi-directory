...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV2Deprecated.InsertAddressesbygroupIdRequest();
  });
  ...
  describe('InsertAddressesbygroupIdRequest', function() {
    it('should create an instance of InsertAddressesbygroupIdRequest', function() {
      // uncomment below and update the code to test InsertAddressesbygroupIdRequest
      //var instance = new SubscriptionsApiV2Deprecated.InsertAddressesbygroupIdRequest();
      //expect(instance).to.be.a(SubscriptionsApiV2Deprecated.InsertAddressesbygroupIdRequest);
    });
