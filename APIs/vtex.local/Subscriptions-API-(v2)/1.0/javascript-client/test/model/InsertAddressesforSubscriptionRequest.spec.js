...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV2Deprecated.InsertAddressesforSubscriptionRequest();
  });
  ...
  describe('InsertAddressesforSubscriptionRequest', function() {
    it('should create an instance of InsertAddressesforSubscriptionRequest', function() {
      // uncomment below and update the code to test InsertAddressesforSubscriptionRequest
      //var instance = new SubscriptionsApiV2Deprecated.InsertAddressesforSubscriptionRequest();
      //expect(instance).to.be.a(SubscriptionsApiV2Deprecated.InsertAddressesforSubscriptionRequest);
    });
