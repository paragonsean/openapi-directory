...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV2Deprecated.Frequency();
  });
  ...
  describe('Frequency', function() {
    it('should create an instance of Frequency', function() {
      ...
      //var instance = new SubscriptionsApiV2Deprecated.Frequency();
      //expect(instance).to.be.a(SubscriptionsApiV2Deprecated.Frequency);
    });
