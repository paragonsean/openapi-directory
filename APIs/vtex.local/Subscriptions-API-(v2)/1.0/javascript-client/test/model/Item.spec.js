...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV2Deprecated.Item();
  });
  ...
  describe('Item', function() {
    it('should create an instance of Item', function() {
      ...
      //var instance = new SubscriptionsApiV2Deprecated.Item();
      //expect(instance).to.be.a(SubscriptionsApiV2Deprecated.Item);
    });
