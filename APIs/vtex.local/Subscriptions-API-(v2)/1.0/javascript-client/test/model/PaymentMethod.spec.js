...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV2Deprecated.PaymentMethod();
  });
  ...
  describe('PaymentMethod', function() {
    it('should create an instance of PaymentMethod', function() {
      ...
      //var instance = new SubscriptionsApiV2Deprecated.PaymentMethod();
      //expect(instance).to.be.a(SubscriptionsApiV2Deprecated.PaymentMethod);
    });
