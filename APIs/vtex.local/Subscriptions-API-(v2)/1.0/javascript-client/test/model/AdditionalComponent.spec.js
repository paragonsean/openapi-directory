...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionsApiV2Deprecated.AdditionalComponent();
  });
  ...
  describe('AdditionalComponent', function() {
    it('should create an instance of AdditionalComponent', function() {
      // uncomment below and update the code to test AdditionalComponent
      //var instance = new SubscriptionsApiV2Deprecated.AdditionalComponent();
      //expect(instance).to.be.a(SubscriptionsApiV2Deprecated.AdditionalComponent);
    });
