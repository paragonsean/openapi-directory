...
void Example::exampleFunction1(){
     OAIReportApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIReportApi::getreportstatusbyIDSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIReportApi::getreportstatusbyIDSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      QString report_id = create(); // QString | Report ID.
      apiInstance.getreportstatusbyID(content_typeacceptreport_id);
