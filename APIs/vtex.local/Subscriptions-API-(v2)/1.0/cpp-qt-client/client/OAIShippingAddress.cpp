...
QList<OAIAdditionalComponent> OAIShippingAddress::getAdditionalComponents() const {
    return m_additional_components;
}
void OAIShippingAddress::setAdditionalComponents(const QList<OAIAdditionalComponent> &additional_components) {
    m_additional_components = additional_components;
    m_additional_components_isSet = true;
}

bool OAIShippingAddress::is_additional_components_Set() const{
    return m_additional_components_isSet;
}

bool OAIShippingAddress::is_additional_components_Valid() const{
...
QString OAIShippingAddress::getAddressName() const {
    return m_address_name;
}
void OAIShippingAddress::setAddressName(const QString &address_name) {
    m_address_name = address_name;
    m_address_name_isSet = true;
}

bool OAIShippingAddress::is_address_name_Set() const{
    return m_address_name_isSet;
}

bool OAIShippingAddress::is_address_name_Valid() const{
...
QString OAIShippingAddress::getComplement() const {
    return m_complement;
}
void OAIShippingAddress::setComplement(const QString &complement) {
    m_complement = complement;
    m_complement_isSet = true;
}

bool OAIShippingAddress::is_complement_Set() const{
    return m_complement_isSet;
}

bool OAIShippingAddress::is_complement_Valid() const{
...
QString OAIShippingAddress::getFormattedAddress() const {
    return m_formatted_address;
}
void OAIShippingAddress::setFormattedAddress(const QString &formatted_address) {
    m_formatted_address = formatted_address;
    m_formatted_address_isSet = true;
}

bool OAIShippingAddress::is_formatted_address_Set() const{
    return m_formatted_address_isSet;
}

bool OAIShippingAddress::is_formatted_address_Valid() const{
    return m_formatted_address_isValid;
}

QList<qint32> OAIShippingAddress::getGeoCoordinate() const {
    return m_geo_coordinate;
}
void OAIShippingAddress::setGeoCoordinate(const QList<qint32> &geo_coordinate) {
    m_geo_coordinate = geo_coordinate;
    m_geo_coordinate_isSet = true;
}

bool OAIShippingAddress::is_geo_coordinate_Set() const{
    return m_geo_coordinate_isSet;
}

bool OAIShippingAddress::is_geo_coordinate_Valid() const{
    return m_geo_coordinate_isValid;
}

QString OAIShippingAddress::getNeighborhood() const {
    return m_neighborhood;
}
void OAIShippingAddress::setNeighborhood(const QString &neighborhood) {
    m_neighborhood = neighborhood;
    m_neighborhood_isSet = true;
}

bool OAIShippingAddress::is_neighborhood_Set() const{
    return m_neighborhood_isSet;
}

bool OAIShippingAddress::is_neighborhood_Valid() const{
    return m_neighborhood_isValid;
}

QString OAIShippingAddress::getNumber() const {
    return m_number;
}
void OAIShippingAddress::setNumber(const QString &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIShippingAddress::is_number_Set() const{
    return m_number_isSet;
}

bool OAIShippingAddress::is_number_Valid() const{
...
QString OAIShippingAddress::getReceiverName() const {
    return m_receiver_name;
}
void OAIShippingAddress::setReceiverName(const QString &receiver_name) {
    m_receiver_name = receiver_name;
    m_receiver_name_isSet = true;
}

bool OAIShippingAddress::is_receiver_name_Set() const{
    return m_receiver_name_isSet;
}

bool OAIShippingAddress::is_receiver_name_Valid() const{
    return m_receiver_name_isValid;
}

QString OAIShippingAddress::getReference() const {
    return m_reference;
}
void OAIShippingAddress::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAIShippingAddress::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAIShippingAddress::is_reference_Valid() const{
...
QString OAIShippingAddress::getStreet() const {
    return m_street;
}
void OAIShippingAddress::setStreet(const QString &street) {
    m_street = street;
    m_street_isSet = true;
}

bool OAIShippingAddress::is_street_Set() const{
    return m_street_isSet;
}

bool OAIShippingAddress::is_street_Valid() const{
