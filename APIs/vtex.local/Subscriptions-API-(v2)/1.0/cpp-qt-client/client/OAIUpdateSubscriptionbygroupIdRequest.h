...
/*
 * OAIUpdateSubscriptionbygroupIdRequest.h
 *
 * 
 */

#ifndef OAIUpdateSubscriptionbygroupIdRequest_H
#define OAIUpdateSubscriptionbygroupIdRequest_H
...
class OAIUpdateSubscriptionbygroupIdRequest : public OAIObject {
public:
    OAIUpdateSubscriptionbygroupIdRequest();
    OAIUpdateSubscriptionbygroupIdRequest(QString json);
    ~OAIUpdateSubscriptionbygroupIdRequest() override;
    ...
    QList<OAIItem1> getItem() const;
    void setItem(const QList<OAIItem1> &item);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSubscriptionbygroupIdRequest)

#endif // OAIUpdateSubscriptionbygroupIdRequest_H
