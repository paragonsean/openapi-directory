...
public:
    ...
    QList<OAIAdditionalComponent> getAdditionalComponents() const;
    void setAdditionalComponents(const QList<OAIAdditionalComponent> &additional_components);
    ...
    QList<qint32> getGeoCoordinate() const;
    void setGeoCoordinate(const QList<qint32> &geo_coordinate);
...
private:
    ...
    QList<OAIAdditionalComponent> m_additional_components;
