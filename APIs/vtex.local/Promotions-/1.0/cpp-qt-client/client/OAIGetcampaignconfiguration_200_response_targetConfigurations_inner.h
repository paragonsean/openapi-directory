...
/*
 * OAIGetcampaignconfiguration_200_response_targetConfigurations_inner.h
 *
 * Object with information about the target audience.
 */

#ifndef OAIGetcampaignconfiguration_200_response_targetConfigurations_inner_H
#define OAIGetcampaignconfiguration_200_response_targetConfigurations_inner_H
...
class OAIGetcampaignconfiguration_200_response_targetConfigurations_inner : public OAIObject {
public:
    OAIGetcampaignconfiguration_200_response_targetConfigurations_inner();
    OAIGetcampaignconfiguration_200_response_targetConfigurations_inner(QString json);
    ~OAIGetcampaignconfiguration_200_response_targetConfigurations_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetcampaignconfiguration_200_response_targetConfigurations_inner)

#endif // OAIGetcampaignconfiguration_200_response_targetConfigurations_inner_H
