...
/*
 * OAIMassiveGeneration_request.h
 *
 * 
 */

#ifndef OAIMassiveGeneration_request_H
#define OAIMassiveGeneration_request_H
...
class OAIMassiveGeneration_request : public OAIObject {
public:
    OAIMassiveGeneration_request();
    OAIMassiveGeneration_request(QString json);
    ~OAIMassiveGeneration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMassiveGeneration_request)

#endif // OAIMassiveGeneration_request_H
