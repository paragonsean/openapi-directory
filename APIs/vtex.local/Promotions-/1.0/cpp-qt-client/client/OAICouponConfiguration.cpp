...
QString OAICouponConfiguration::getExpirationIntervalPerUse() const {
    return m_expiration_interval_per_use;
}
void OAICouponConfiguration::setExpirationIntervalPerUse(const QString &expiration_interval_per_use) {
    m_expiration_interval_per_use = expiration_interval_per_use;
    m_expiration_interval_per_use_isSet = true;
}

bool OAICouponConfiguration::is_expiration_interval_per_use_Set() const{
    return m_expiration_interval_per_use_isSet;
}

bool OAICouponConfiguration::is_expiration_interval_per_use_Valid() const{
    return m_expiration_interval_per_use_isValid;
}

bool OAICouponConfiguration::isIsArchived() const {
    return m_is_archived;
}
void OAICouponConfiguration::setIsArchived(const bool &is_archived) {
    m_is_archived = is_archived;
    m_is_archived_isSet = true;
}

bool OAICouponConfiguration::is_is_archived_Set() const{
    return m_is_archived_isSet;
}

bool OAICouponConfiguration::is_is_archived_Valid() const{
    return m_is_archived_isValid;
}

qint32 OAICouponConfiguration::getMaxItemsPerClient() const {
    return m_max_items_per_client;
}
void OAICouponConfiguration::setMaxItemsPerClient(const qint32 &max_items_per_client) {
    m_max_items_per_client = max_items_per_client;
    m_max_items_per_client_isSet = true;
}

bool OAICouponConfiguration::is_max_items_per_client_Set() const{
    return m_max_items_per_client_isSet;
}

bool OAICouponConfiguration::is_max_items_per_client_Valid() const{
    return m_max_items_per_client_isValid;
}

QString OAICouponConfiguration::getUtmCampaign() const {
    return m_utm_campaign;
}
void OAICouponConfiguration::setUtmCampaign(const QString &utm_campaign) {
    m_utm_campaign = utm_campaign;
    m_utm_campaign_isSet = true;
}

bool OAICouponConfiguration::is_utm_campaign_Set() const{
    return m_utm_campaign_isSet;
}

bool OAICouponConfiguration::is_utm_campaign_Valid() const{
    return m_utm_campaign_isValid;
}

QString OAICouponConfiguration::getUtmSource() const {
    return m_utm_source;
}
void OAICouponConfiguration::setUtmSource(const QString &utm_source) {
    m_utm_source = utm_source;
    m_utm_source_isSet = true;
}

bool OAICouponConfiguration::is_utm_source_Set() const{
    return m_utm_source_isSet;
}

bool OAICouponConfiguration::is_utm_source_Valid() const{
