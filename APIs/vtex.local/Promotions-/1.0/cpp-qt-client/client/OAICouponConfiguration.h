...
/*
 * OAICouponConfiguration.h
 *
 * Object that contains all coupon configuration.
 */

#ifndef OAICouponConfiguration_H
#define OAICouponConfiguration_H
...
class OAICouponConfiguration : public OAIObject {
public:
    OAICouponConfiguration();
    OAICouponConfiguration(QString json);
    ~OAICouponConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICouponConfiguration)

#endif // OAICouponConfiguration_H
