...
#ifndef OAIUpdate_request_H
#define OAIUpdate_request_H
...
class OAIUpdate_request : public OAIObject {
public:
    OAIUpdate_request();
    OAIUpdate_request(QString json);
    ~OAIUpdate_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdate_request)

#endif // OAIUpdate_request_H
