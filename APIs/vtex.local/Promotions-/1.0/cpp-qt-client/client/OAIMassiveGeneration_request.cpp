...
OAIMassiveGeneration_request::OAIMassiveGeneration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMassiveGeneration_request::OAIMassiveGeneration_request() {
    this->initializeModel();
}

OAIMassiveGeneration_request::~OAIMassiveGeneration_request() {}

void OAIMassiveGeneration_request::initializeModel() {
...
void OAIMassiveGeneration_request::fromJson(QString jsonString) {
...
void OAIMassiveGeneration_request::fromJsonObject(QJsonObject json) {
...
QString OAIMassiveGeneration_request::asJson() const {
...
QJsonObject OAIMassiveGeneration_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMassiveGeneration_request::getCouponCode() const {
    return m_coupon_code;
}
void OAIMassiveGeneration_request::setCouponCode(const QString &coupon_code) {
    m_coupon_code = coupon_code;
    m_coupon_code_isSet = true;
}

bool OAIMassiveGeneration_request::is_coupon_code_Set() const{
    return m_coupon_code_isSet;
}

bool OAIMassiveGeneration_request::is_coupon_code_Valid() const{
    return m_coupon_code_isValid;
}

QString OAIMassiveGeneration_request::getExpirationIntervalPerUse() const {
    return m_expiration_interval_per_use;
}
void OAIMassiveGeneration_request::setExpirationIntervalPerUse(const QString &expiration_interval_per_use) {
    m_expiration_interval_per_use = expiration_interval_per_use;
    m_expiration_interval_per_use_isSet = true;
}

bool OAIMassiveGeneration_request::is_expiration_interval_per_use_Set() const{
    return m_expiration_interval_per_use_isSet;
}

bool OAIMassiveGeneration_request::is_expiration_interval_per_use_Valid() const{
    return m_expiration_interval_per_use_isValid;
}

qint32 OAIMassiveGeneration_request::getMaxItemsPerClient() const {
    return m_max_items_per_client;
}
void OAIMassiveGeneration_request::setMaxItemsPerClient(const qint32 &max_items_per_client) {
    m_max_items_per_client = max_items_per_client;
    m_max_items_per_client_isSet = true;
}

bool OAIMassiveGeneration_request::is_max_items_per_client_Set() const{
    return m_max_items_per_client_isSet;
}

bool OAIMassiveGeneration_request::is_max_items_per_client_Valid() const{
    return m_max_items_per_client_isValid;
}

QString OAIMassiveGeneration_request::getUtmCampaign() const {
    return m_utm_campaign;
}
void OAIMassiveGeneration_request::setUtmCampaign(const QString &utm_campaign) {
    m_utm_campaign = utm_campaign;
    m_utm_campaign_isSet = true;
}

bool OAIMassiveGeneration_request::is_utm_campaign_Set() const{
    return m_utm_campaign_isSet;
}

bool OAIMassiveGeneration_request::is_utm_campaign_Valid() const{
    return m_utm_campaign_isValid;
}

QString OAIMassiveGeneration_request::getUtmSource() const {
    return m_utm_source;
}
void OAIMassiveGeneration_request::setUtmSource(const QString &utm_source) {
    m_utm_source = utm_source;
    m_utm_source_isSet = true;
}

bool OAIMassiveGeneration_request::is_utm_source_Set() const{
    return m_utm_source_isSet;
}

bool OAIMassiveGeneration_request::is_utm_source_Valid() const{
    return m_utm_source_isValid;
}

bool OAIMassiveGeneration_request::isSet() const {
...
bool OAIMassiveGeneration_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_coupon_code_isValid && m_expiration_interval_per_use_isValid && m_max_items_per_client_isValid && m_utm_campaign_isValid && m_utm_source_isValid && true;
}
