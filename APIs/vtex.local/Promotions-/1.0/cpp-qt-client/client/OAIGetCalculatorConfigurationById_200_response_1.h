...
/*
 * OAIGetCalculatorConfigurationById_200_response_1.h
 *
 * 
 */

#ifndef OAIGetCalculatorConfigurationById_200_response_1_H
#define OAIGetCalculatorConfigurationById_200_response_1_H
...
#include "OAIGetCalculatorConfigurationById_200_response_1_zipCodeRanges_inner.h"
#include <QJsonValue>
#include <QList>
#include <QString>
...
class OAIGetCalculatorConfigurationById_200_response_1_zipCodeRanges_inner;

class OAIGetCalculatorConfigurationById_200_response_1 : public OAIObject {
public:
    OAIGetCalculatorConfigurationById_200_response_1();
    OAIGetCalculatorConfigurationById_200_response_1(QString json);
    ~OAIGetCalculatorConfigurationById_200_response_1() override;
    ...
    QList<qint32> getListSku1BuyTogether() const;
    void setListSku1BuyTogether(const QList<qint32> &list_sku1_buy_together);
    bool is_list_sku1_buy_together_Set() const;
    bool is_list_sku1_buy_together_Valid() const;

    QList<qint32> getListSku2BuyTogether() const;
    void setListSku2BuyTogether(const QList<qint32> &list_sku2_buy_together);
    ...
    QList<OAIGetCalculatorConfigurationById_200_response_1_zipCodeRanges_inner> getZipCodeRanges() const;
    void setZipCodeRanges(const QList<OAIGetCalculatorConfigurationById_200_response_1_zipCodeRanges_inner> &zip_code_ranges);
...
private:
    ...
    QList<qint32> m_list_sku1_buy_together;
    bool m_list_sku1_buy_together_isSet;
    bool m_list_sku1_buy_together_isValid;

    QList<qint32> m_list_sku2_buy_together;
    ...
    QList<OAIGetCalculatorConfigurationById_200_response_1_zipCodeRanges_inner> m_zip_code_ranges;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCalculatorConfigurationById_200_response_1)

#endif // OAIGetCalculatorConfigurationById_200_response_1_H
