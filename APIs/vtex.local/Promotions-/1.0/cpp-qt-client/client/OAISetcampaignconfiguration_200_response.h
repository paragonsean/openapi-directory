...
/*
 * OAISetcampaignconfiguration_200_response.h
 *
 * 
 */

#ifndef OAISetcampaignconfiguration_200_response_H
#define OAISetcampaignconfiguration_200_response_H
...
class OAISetcampaignconfiguration_200_response_targetConfigurations_inner;

class OAISetcampaignconfiguration_200_response : public OAIObject {
public:
    OAISetcampaignconfiguration_200_response();
    OAISetcampaignconfiguration_200_response(QString json);
    ~OAISetcampaignconfiguration_200_response() override;
    ...
    QList<OAISetcampaignconfiguration_200_response_targetConfigurations_inner> getTargetConfigurations() const;
    void setTargetConfigurations(const QList<OAISetcampaignconfiguration_200_response_targetConfigurations_inner> &target_configurations);
...
private:
    ...
    QList<OAISetcampaignconfiguration_200_response_targetConfigurations_inner> m_target_configurations;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetcampaignconfiguration_200_response)

#endif // OAISetcampaignconfiguration_200_response_H
