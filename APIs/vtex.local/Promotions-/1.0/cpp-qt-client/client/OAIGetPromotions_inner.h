...
/*
 * OAIGetPromotions_inner.h
 *
 * Object with information about a promotion.
 */

#ifndef OAIGetPromotions_inner_H
#define OAIGetPromotions_inner_H
...
namespace OpenAPI {
class OAIGetPromotions_inner_scope;

class OAIGetPromotions_inner : public OAIObject {
public:
    OAIGetPromotions_inner();
    OAIGetPromotions_inner(QString json);
    ~OAIGetPromotions_inner() override;
    ...
    OAIGetPromotions_inner_scope getScope() const;
    void setScope(const OAIGetPromotions_inner_scope &scope);
...
private:
    ...
    OAIGetPromotions_inner_scope m_scope;
    bool m_scope_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPromotions_inner)

#endif // OAIGetPromotions_inner_H
