...
/*
 * OAIGetcampaignconfiguration_200_response.h
 *
 * 
 */

#ifndef OAIGetcampaignconfiguration_200_response_H
#define OAIGetcampaignconfiguration_200_response_H
...
class OAIGetcampaignconfiguration_200_response_targetConfigurations_inner;

class OAIGetcampaignconfiguration_200_response : public OAIObject {
public:
    OAIGetcampaignconfiguration_200_response();
    OAIGetcampaignconfiguration_200_response(QString json);
    ~OAIGetcampaignconfiguration_200_response() override;
    ...
    QList<OAIGetcampaignconfiguration_200_response_targetConfigurations_inner> getTargetConfigurations() const;
    void setTargetConfigurations(const QList<OAIGetcampaignconfiguration_200_response_targetConfigurations_inner> &target_configurations);
...
private:
    ...
    QList<OAIGetcampaignconfiguration_200_response_targetConfigurations_inner> m_target_configurations;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetcampaignconfiguration_200_response)

#endif // OAIGetcampaignconfiguration_200_response_H
