...
OAIGetarchivedbycouponcode_200_response::OAIGetarchivedbycouponcode_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetarchivedbycouponcode_200_response::OAIGetarchivedbycouponcode_200_response() {
    this->initializeModel();
}

OAIGetarchivedbycouponcode_200_response::~OAIGetarchivedbycouponcode_200_response() {}

void OAIGetarchivedbycouponcode_200_response::initializeModel() {
...
void OAIGetarchivedbycouponcode_200_response::fromJson(QString jsonString) {
...
void OAIGetarchivedbycouponcode_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetarchivedbycouponcode_200_response::asJson() const {
...
QJsonObject OAIGetarchivedbycouponcode_200_response::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetarchivedbycouponcode_200_response::getCouponCode() const {
    return m_coupon_code;
}
void OAIGetarchivedbycouponcode_200_response::setCouponCode(const QString &coupon_code) {
    m_coupon_code = coupon_code;
    m_coupon_code_isSet = true;
}

bool OAIGetarchivedbycouponcode_200_response::is_coupon_code_Set() const{
    return m_coupon_code_isSet;
}

bool OAIGetarchivedbycouponcode_200_response::is_coupon_code_Valid() const{
    return m_coupon_code_isValid;
}

QString OAIGetarchivedbycouponcode_200_response::getExpirationIntervalPerUse() const {
    return m_expiration_interval_per_use;
}
void OAIGetarchivedbycouponcode_200_response::setExpirationIntervalPerUse(const QString &expiration_interval_per_use) {
    m_expiration_interval_per_use = expiration_interval_per_use;
    m_expiration_interval_per_use_isSet = true;
}

bool OAIGetarchivedbycouponcode_200_response::is_expiration_interval_per_use_Set() const{
    return m_expiration_interval_per_use_isSet;
}

bool OAIGetarchivedbycouponcode_200_response::is_expiration_interval_per_use_Valid() const{
    return m_expiration_interval_per_use_isValid;
}

bool OAIGetarchivedbycouponcode_200_response::isIsArchived() const {
    return m_is_archived;
}
void OAIGetarchivedbycouponcode_200_response::setIsArchived(const bool &is_archived) {
    m_is_archived = is_archived;
    m_is_archived_isSet = true;
}

bool OAIGetarchivedbycouponcode_200_response::is_is_archived_Set() const{
    return m_is_archived_isSet;
}

bool OAIGetarchivedbycouponcode_200_response::is_is_archived_Valid() const{
    return m_is_archived_isValid;
}

QString OAIGetarchivedbycouponcode_200_response::getLastModifiedUtc() const {
    return m_last_modified_utc;
}
void OAIGetarchivedbycouponcode_200_response::setLastModifiedUtc(const QString &last_modified_utc) {
    m_last_modified_utc = last_modified_utc;
    m_last_modified_utc_isSet = true;
}

bool OAIGetarchivedbycouponcode_200_response::is_last_modified_utc_Set() const{
    return m_last_modified_utc_isSet;
}

bool OAIGetarchivedbycouponcode_200_response::is_last_modified_utc_Valid() const{
    return m_last_modified_utc_isValid;
}

qint32 OAIGetarchivedbycouponcode_200_response::getMaxItemsPerClient() const {
    return m_max_items_per_client;
}
void OAIGetarchivedbycouponcode_200_response::setMaxItemsPerClient(const qint32 &max_items_per_client) {
    m_max_items_per_client = max_items_per_client;
    m_max_items_per_client_isSet = true;
}

bool OAIGetarchivedbycouponcode_200_response::is_max_items_per_client_Set() const{
    return m_max_items_per_client_isSet;
}

bool OAIGetarchivedbycouponcode_200_response::is_max_items_per_client_Valid() const{
    return m_max_items_per_client_isValid;
}

QString OAIGetarchivedbycouponcode_200_response::getUtmCampaign() const {
    return m_utm_campaign;
}
void OAIGetarchivedbycouponcode_200_response::setUtmCampaign(const QString &utm_campaign) {
    m_utm_campaign = utm_campaign;
    m_utm_campaign_isSet = true;
}

bool OAIGetarchivedbycouponcode_200_response::is_utm_campaign_Set() const{
    return m_utm_campaign_isSet;
}

bool OAIGetarchivedbycouponcode_200_response::is_utm_campaign_Valid() const{
    return m_utm_campaign_isValid;
}

QString OAIGetarchivedbycouponcode_200_response::getUtmSource() const {
    return m_utm_source;
}
void OAIGetarchivedbycouponcode_200_response::setUtmSource(const QString &utm_source) {
    m_utm_source = utm_source;
    m_utm_source_isSet = true;
}

bool OAIGetarchivedbycouponcode_200_response::is_utm_source_Set() const{
    return m_utm_source_isSet;
}

bool OAIGetarchivedbycouponcode_200_response::is_utm_source_Valid() const{
    return m_utm_source_isValid;
}

bool OAIGetarchivedbycouponcode_200_response::isSet() const {
...
bool OAIGetarchivedbycouponcode_200_response::isValid() const {
