...
OAIGetTaxes_inner::OAIGetTaxes_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTaxes_inner::OAIGetTaxes_inner() {
    this->initializeModel();
}

OAIGetTaxes_inner::~OAIGetTaxes_inner() {}

void OAIGetTaxes_inner::initializeModel() {
...
void OAIGetTaxes_inner::fromJson(QString jsonString) {
...
void OAIGetTaxes_inner::fromJsonObject(QJsonObject json) {
...
QString OAIGetTaxes_inner::asJson() const {
...
QJsonObject OAIGetTaxes_inner::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIGetTaxes_inner::getCampaigns() const {
    return m_campaigns;
}
void OAIGetTaxes_inner::setCampaigns(const QList<QString> &campaigns) {
    m_campaigns = campaigns;
    m_campaigns_isSet = true;
}

bool OAIGetTaxes_inner::is_campaigns_Set() const{
    return m_campaigns_isSet;
}

bool OAIGetTaxes_inner::is_campaigns_Valid() const{
    return m_campaigns_isValid;
}

bool OAIGetTaxes_inner::isActivateGiftsMultiplier() const {
    return m_activate_gifts_multiplier;
}
void OAIGetTaxes_inner::setActivateGiftsMultiplier(const bool &activate_gifts_multiplier) {
    m_activate_gifts_multiplier = activate_gifts_multiplier;
    m_activate_gifts_multiplier_isSet = true;
}

bool OAIGetTaxes_inner::is_activate_gifts_multiplier_Set() const{
    return m_activate_gifts_multiplier_isSet;
}

bool OAIGetTaxes_inner::is_activate_gifts_multiplier_Valid() const{
    return m_activate_gifts_multiplier_isValid;
}

bool OAIGetTaxes_inner::isAreSalesChannelIdsExclusive() const {
    return m_are_sales_channel_ids_exclusive;
}
void OAIGetTaxes_inner::setAreSalesChannelIdsExclusive(const bool &are_sales_channel_ids_exclusive) {
    m_are_sales_channel_ids_exclusive = are_sales_channel_ids_exclusive;
    m_are_sales_channel_ids_exclusive_isSet = true;
}

bool OAIGetTaxes_inner::is_are_sales_channel_ids_exclusive_Set() const{
    return m_are_sales_channel_ids_exclusive_isSet;
}

bool OAIGetTaxes_inner::is_are_sales_channel_ids_exclusive_Valid() const{
    return m_are_sales_channel_ids_exclusive_isValid;
}

QString OAIGetTaxes_inner::getBeginDate() const {
    return m_begin_date;
}
void OAIGetTaxes_inner::setBeginDate(const QString &begin_date) {
    m_begin_date = begin_date;
    m_begin_date_isSet = true;
}

bool OAIGetTaxes_inner::is_begin_date_Set() const{
    return m_begin_date_isSet;
}

bool OAIGetTaxes_inner::is_begin_date_Valid() const{
    return m_begin_date_isValid;
}

QString OAIGetTaxes_inner::getDescription() const {
    return m_description;
}
void OAIGetTaxes_inner::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGetTaxes_inner::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGetTaxes_inner::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIGetTaxes_inner::getEndDate() const {
    return m_end_date;
}
void OAIGetTaxes_inner::setEndDate(const QString &end_date) {
    m_end_date = end_date;
    m_end_date_isSet = true;
}

bool OAIGetTaxes_inner::is_end_date_Set() const{
    return m_end_date_isSet;
}

bool OAIGetTaxes_inner::is_end_date_Valid() const{
    return m_end_date_isValid;
}

bool OAIGetTaxes_inner::isHasMaxPricePerItem() const {
    return m_has_max_price_per_item;
}
void OAIGetTaxes_inner::setHasMaxPricePerItem(const bool &has_max_price_per_item) {
    m_has_max_price_per_item = has_max_price_per_item;
    m_has_max_price_per_item_isSet = true;
}

bool OAIGetTaxes_inner::is_has_max_price_per_item_Set() const{
    return m_has_max_price_per_item_isSet;
}

bool OAIGetTaxes_inner::is_has_max_price_per_item_Valid() const{
    return m_has_max_price_per_item_isValid;
}

QString OAIGetTaxes_inner::getIdCalculatorConfiguration() const {
    return m_id_calculator_configuration;
}
void OAIGetTaxes_inner::setIdCalculatorConfiguration(const QString &id_calculator_configuration) {
    m_id_calculator_configuration = id_calculator_configuration;
    m_id_calculator_configuration_isSet = true;
}

bool OAIGetTaxes_inner::is_id_calculator_configuration_Set() const{
    return m_id_calculator_configuration_isSet;
}

bool OAIGetTaxes_inner::is_id_calculator_configuration_Valid() const{
    return m_id_calculator_configuration_isValid;
}

QList<QString> OAIGetTaxes_inner::getIdsSalesChannel() const {
    return m_ids_sales_channel;
}
void OAIGetTaxes_inner::setIdsSalesChannel(const QList<QString> &ids_sales_channel) {
    m_ids_sales_channel = ids_sales_channel;
    m_ids_sales_channel_isSet = true;
}

bool OAIGetTaxes_inner::is_ids_sales_channel_Set() const{
    return m_ids_sales_channel_isSet;
}

bool OAIGetTaxes_inner::is_ids_sales_channel_Valid() const{
    return m_ids_sales_channel_isValid;
}

bool OAIGetTaxes_inner::isIsActive() const {
    return m_is_active;
}
void OAIGetTaxes_inner::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAIGetTaxes_inner::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIGetTaxes_inner::is_is_active_Valid() const{
    return m_is_active_isValid;
}

bool OAIGetTaxes_inner::isIsArchived() const {
    return m_is_archived;
}
void OAIGetTaxes_inner::setIsArchived(const bool &is_archived) {
    m_is_archived = is_archived;
    m_is_archived_isSet = true;
}

bool OAIGetTaxes_inner::is_is_archived_Set() const{
    return m_is_archived_isSet;
}

bool OAIGetTaxes_inner::is_is_archived_Valid() const{
    return m_is_archived_isValid;
}

bool OAIGetTaxes_inner::isIsTax() const {
    return m_is_tax;
}
void OAIGetTaxes_inner::setIsTax(const bool &is_tax) {
    m_is_tax = is_tax;
    m_is_tax_isSet = true;
}

bool OAIGetTaxes_inner::is_is_tax_Set() const{
    return m_is_tax_isSet;
}

bool OAIGetTaxes_inner::is_is_tax_Valid() const{
    return m_is_tax_isValid;
}

QString OAIGetTaxes_inner::getLastModifiedUtc() const {
    return m_last_modified_utc;
}
void OAIGetTaxes_inner::setLastModifiedUtc(const QString &last_modified_utc) {
    m_last_modified_utc = last_modified_utc;
    m_last_modified_utc_isSet = true;
}

bool OAIGetTaxes_inner::is_last_modified_utc_Set() const{
    return m_last_modified_utc_isSet;
}

bool OAIGetTaxes_inner::is_last_modified_utc_Valid() const{
    return m_last_modified_utc_isValid;
}

double OAIGetTaxes_inner::getMaxUsage() const {
    return m_max_usage;
}
void OAIGetTaxes_inner::setMaxUsage(const double &max_usage) {
    m_max_usage = max_usage;
    m_max_usage_isSet = true;
}

bool OAIGetTaxes_inner::is_max_usage_Set() const{
    return m_max_usage_isSet;
}

bool OAIGetTaxes_inner::is_max_usage_Valid() const{
    return m_max_usage_isValid;
}

QString OAIGetTaxes_inner::getName() const {
    return m_name;
}
void OAIGetTaxes_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetTaxes_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetTaxes_inner::is_name_Valid() const{
    return m_name_isValid;
}

double OAIGetTaxes_inner::getPercentualTax() const {
    return m_percentual_tax;
}
void OAIGetTaxes_inner::setPercentualTax(const double &percentual_tax) {
    m_percentual_tax = percentual_tax;
    m_percentual_tax_isSet = true;
}

bool OAIGetTaxes_inner::is_percentual_tax_Set() const{
    return m_percentual_tax_isSet;
}

bool OAIGetTaxes_inner::is_percentual_tax_Valid() const{
    return m_percentual_tax_isValid;
}

OAIGetTaxes_inner_scope OAIGetTaxes_inner::getScope() const {
    return m_scope;
}
void OAIGetTaxes_inner::setScope(const OAIGetTaxes_inner_scope &scope) {
    m_scope = scope;
    m_scope_isSet = true;
}

bool OAIGetTaxes_inner::is_scope_Set() const{
    return m_scope_isSet;
}

bool OAIGetTaxes_inner::is_scope_Valid() const{
    return m_scope_isValid;
}

QString OAIGetTaxes_inner::getStatus() const {
    return m_status;
}
void OAIGetTaxes_inner::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetTaxes_inner::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetTaxes_inner::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIGetTaxes_inner::getType() const {
    return m_type;
}
void OAIGetTaxes_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIGetTaxes_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAIGetTaxes_inner::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIGetTaxes_inner::getUtmCampain() const {
    return m_utm_campain;
}
void OAIGetTaxes_inner::setUtmCampain(const QString &utm_campain) {
    m_utm_campain = utm_campain;
    m_utm_campain_isSet = true;
}

bool OAIGetTaxes_inner::is_utm_campain_Set() const{
    return m_utm_campain_isSet;
}

bool OAIGetTaxes_inner::is_utm_campain_Valid() const{
    return m_utm_campain_isValid;
}

QString OAIGetTaxes_inner::getUtmSource() const {
    return m_utm_source;
}
void OAIGetTaxes_inner::setUtmSource(const QString &utm_source) {
    m_utm_source = utm_source;
    m_utm_source_isSet = true;
}

bool OAIGetTaxes_inner::is_utm_source_Set() const{
    return m_utm_source_isSet;
}

bool OAIGetTaxes_inner::is_utm_source_Valid() const{
    return m_utm_source_isValid;
}

QString OAIGetTaxes_inner::getUtmiCampaign() const {
    return m_utmi_campaign;
}
void OAIGetTaxes_inner::setUtmiCampaign(const QString &utmi_campaign) {
    m_utmi_campaign = utmi_campaign;
    m_utmi_campaign_isSet = true;
}

bool OAIGetTaxes_inner::is_utmi_campaign_Set() const{
    return m_utmi_campaign_isSet;
}

bool OAIGetTaxes_inner::is_utmi_campaign_Valid() const{
    return m_utmi_campaign_isValid;
}

bool OAIGetTaxes_inner::isSet() const {
...
bool OAIGetTaxes_inner::isValid() const {
