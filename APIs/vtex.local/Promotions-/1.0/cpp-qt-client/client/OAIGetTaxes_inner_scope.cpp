...
OAIGetTaxes_inner_scope::OAIGetTaxes_inner_scope(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTaxes_inner_scope::OAIGetTaxes_inner_scope() {
    this->initializeModel();
}

OAIGetTaxes_inner_scope::~OAIGetTaxes_inner_scope() {}

void OAIGetTaxes_inner_scope::initializeModel() {
...
void OAIGetTaxes_inner_scope::fromJson(QString jsonString) {
...
void OAIGetTaxes_inner_scope::fromJsonObject(QJsonObject json) {
...
QString OAIGetTaxes_inner_scope::asJson() const {
...
QJsonObject OAIGetTaxes_inner_scope::asJsonObject() const {
    QJsonObject obj;
...
bool OAIGetTaxes_inner_scope::isAllCatalog() const {
    return m_all_catalog;
}
void OAIGetTaxes_inner_scope::setAllCatalog(const bool &all_catalog) {
    m_all_catalog = all_catalog;
    m_all_catalog_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_all_catalog_Set() const{
    return m_all_catalog_isSet;
}

bool OAIGetTaxes_inner_scope::is_all_catalog_Valid() const{
    return m_all_catalog_isValid;
}

double OAIGetTaxes_inner_scope::getBrands() const {
    return m_brands;
}
void OAIGetTaxes_inner_scope::setBrands(const double &brands) {
    m_brands = brands;
    m_brands_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_brands_Set() const{
    return m_brands_isSet;
}

bool OAIGetTaxes_inner_scope::is_brands_Valid() const{
    return m_brands_isValid;
}

bool OAIGetTaxes_inner_scope::isBrandsAreInclusive() const {
    return m_brands_are_inclusive;
}
void OAIGetTaxes_inner_scope::setBrandsAreInclusive(const bool &brands_are_inclusive) {
    m_brands_are_inclusive = brands_are_inclusive;
    m_brands_are_inclusive_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_brands_are_inclusive_Set() const{
    return m_brands_are_inclusive_isSet;
}

bool OAIGetTaxes_inner_scope::is_brands_are_inclusive_Valid() const{
    return m_brands_are_inclusive_isValid;
}

double OAIGetTaxes_inner_scope::getCategories() const {
    return m_categories;
}
void OAIGetTaxes_inner_scope::setCategories(const double &categories) {
    m_categories = categories;
    m_categories_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_categories_Set() const{
    return m_categories_isSet;
}

bool OAIGetTaxes_inner_scope::is_categories_Valid() const{
    return m_categories_isValid;
}

bool OAIGetTaxes_inner_scope::isCategoriesAreInclusive() const {
    return m_categories_are_inclusive;
}
void OAIGetTaxes_inner_scope::setCategoriesAreInclusive(const bool &categories_are_inclusive) {
    m_categories_are_inclusive = categories_are_inclusive;
    m_categories_are_inclusive_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_categories_are_inclusive_Set() const{
    return m_categories_are_inclusive_isSet;
}

bool OAIGetTaxes_inner_scope::is_categories_are_inclusive_Valid() const{
    return m_categories_are_inclusive_isValid;
}

double OAIGetTaxes_inner_scope::getCollections() const {
    return m_collections;
}
void OAIGetTaxes_inner_scope::setCollections(const double &collections) {
    m_collections = collections;
    m_collections_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_collections_Set() const{
    return m_collections_isSet;
}

bool OAIGetTaxes_inner_scope::is_collections_Valid() const{
    return m_collections_isValid;
}

bool OAIGetTaxes_inner_scope::isCollectionsAreInclusive() const {
    return m_collections_are_inclusive;
}
void OAIGetTaxes_inner_scope::setCollectionsAreInclusive(const bool &collections_are_inclusive) {
    m_collections_are_inclusive = collections_are_inclusive;
    m_collections_are_inclusive_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_collections_are_inclusive_Set() const{
    return m_collections_are_inclusive_isSet;
}

bool OAIGetTaxes_inner_scope::is_collections_are_inclusive_Valid() const{
    return m_collections_are_inclusive_isValid;
}

double OAIGetTaxes_inner_scope::getProducts() const {
    return m_products;
}
void OAIGetTaxes_inner_scope::setProducts(const double &products) {
    m_products = products;
    m_products_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_products_Set() const{
    return m_products_isSet;
}

bool OAIGetTaxes_inner_scope::is_products_Valid() const{
    return m_products_isValid;
}

bool OAIGetTaxes_inner_scope::isProductsAreInclusive() const {
    return m_products_are_inclusive;
}
void OAIGetTaxes_inner_scope::setProductsAreInclusive(const bool &products_are_inclusive) {
    m_products_are_inclusive = products_are_inclusive;
    m_products_are_inclusive_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_products_are_inclusive_Set() const{
    return m_products_are_inclusive_isSet;
}

bool OAIGetTaxes_inner_scope::is_products_are_inclusive_Valid() const{
    return m_products_are_inclusive_isValid;
}

double OAIGetTaxes_inner_scope::getSellers() const {
    return m_sellers;
}
void OAIGetTaxes_inner_scope::setSellers(const double &sellers) {
    m_sellers = sellers;
    m_sellers_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_sellers_Set() const{
    return m_sellers_isSet;
}

bool OAIGetTaxes_inner_scope::is_sellers_Valid() const{
    return m_sellers_isValid;
}

bool OAIGetTaxes_inner_scope::isSellersAreInclusive() const {
    return m_sellers_are_inclusive;
}
void OAIGetTaxes_inner_scope::setSellersAreInclusive(const bool &sellers_are_inclusive) {
    m_sellers_are_inclusive = sellers_are_inclusive;
    m_sellers_are_inclusive_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_sellers_are_inclusive_Set() const{
    return m_sellers_are_inclusive_isSet;
}

bool OAIGetTaxes_inner_scope::is_sellers_are_inclusive_Valid() const{
    return m_sellers_are_inclusive_isValid;
}

double OAIGetTaxes_inner_scope::getSkus() const {
    return m_skus;
}
void OAIGetTaxes_inner_scope::setSkus(const double &skus) {
    m_skus = skus;
    m_skus_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_skus_Set() const{
    return m_skus_isSet;
}

bool OAIGetTaxes_inner_scope::is_skus_Valid() const{
    return m_skus_isValid;
}

bool OAIGetTaxes_inner_scope::isSkusAreInclusive() const {
    return m_skus_are_inclusive;
}
void OAIGetTaxes_inner_scope::setSkusAreInclusive(const bool &skus_are_inclusive) {
    m_skus_are_inclusive = skus_are_inclusive;
    m_skus_are_inclusive_isSet = true;
}

bool OAIGetTaxes_inner_scope::is_skus_are_inclusive_Set() const{
    return m_skus_are_inclusive_isSet;
}

bool OAIGetTaxes_inner_scope::is_skus_are_inclusive_Valid() const{
    return m_skus_are_inclusive_isValid;
}

bool OAIGetTaxes_inner_scope::isSet() const {
...
bool OAIGetTaxes_inner_scope::isValid() const {
