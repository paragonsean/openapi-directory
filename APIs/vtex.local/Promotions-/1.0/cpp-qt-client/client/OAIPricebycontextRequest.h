...
/*
 * OAIPricebycontextRequest.h
 *
 * 
 */

#ifndef OAIPricebycontextRequest_H
#define OAIPricebycontextRequest_H
...
class OAIPricebycontextRequest : public OAIObject {
public:
    OAIPricebycontextRequest();
    OAIPricebycontextRequest(QString json);
    ~OAIPricebycontextRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPricebycontextRequest)

#endif // OAIPricebycontextRequest_H
