...
OAIUpdate_request::OAIUpdate_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdate_request::OAIUpdate_request() {
    this->initializeModel();
}

OAIUpdate_request::~OAIUpdate_request() {}

void OAIUpdate_request::initializeModel() {
...
void OAIUpdate_request::fromJson(QString jsonString) {
...
void OAIUpdate_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdate_request::asJson() const {
...
QJsonObject OAIUpdate_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdate_request::getCouponCode() const {
    return m_coupon_code;
}
void OAIUpdate_request::setCouponCode(const QString &coupon_code) {
    m_coupon_code = coupon_code;
    m_coupon_code_isSet = true;
}

bool OAIUpdate_request::is_coupon_code_Set() const{
    return m_coupon_code_isSet;
}

bool OAIUpdate_request::is_coupon_code_Valid() const{
    return m_coupon_code_isValid;
}

QString OAIUpdate_request::getExpirationIntervalPerUse() const {
    return m_expiration_interval_per_use;
}
void OAIUpdate_request::setExpirationIntervalPerUse(const QString &expiration_interval_per_use) {
    m_expiration_interval_per_use = expiration_interval_per_use;
    m_expiration_interval_per_use_isSet = true;
}

bool OAIUpdate_request::is_expiration_interval_per_use_Set() const{
    return m_expiration_interval_per_use_isSet;
}

bool OAIUpdate_request::is_expiration_interval_per_use_Valid() const{
    return m_expiration_interval_per_use_isValid;
}

bool OAIUpdate_request::isIsArchived() const {
    return m_is_archived;
}
void OAIUpdate_request::setIsArchived(const bool &is_archived) {
    m_is_archived = is_archived;
    m_is_archived_isSet = true;
}

bool OAIUpdate_request::is_is_archived_Set() const{
    return m_is_archived_isSet;
}

bool OAIUpdate_request::is_is_archived_Valid() const{
    return m_is_archived_isValid;
}

qint32 OAIUpdate_request::getMaxItemsPerClient() const {
    return m_max_items_per_client;
}
void OAIUpdate_request::setMaxItemsPerClient(const qint32 &max_items_per_client) {
    m_max_items_per_client = max_items_per_client;
    m_max_items_per_client_isSet = true;
}

bool OAIUpdate_request::is_max_items_per_client_Set() const{
    return m_max_items_per_client_isSet;
}

bool OAIUpdate_request::is_max_items_per_client_Valid() const{
    return m_max_items_per_client_isValid;
}

QString OAIUpdate_request::getUtmCampaign() const {
    return m_utm_campaign;
}
void OAIUpdate_request::setUtmCampaign(const QString &utm_campaign) {
    m_utm_campaign = utm_campaign;
    m_utm_campaign_isSet = true;
}

bool OAIUpdate_request::is_utm_campaign_Set() const{
    return m_utm_campaign_isSet;
}

bool OAIUpdate_request::is_utm_campaign_Valid() const{
    return m_utm_campaign_isValid;
}

QString OAIUpdate_request::getUtmSource() const {
    return m_utm_source;
}
void OAIUpdate_request::setUtmSource(const QString &utm_source) {
    m_utm_source = utm_source;
    m_utm_source_isSet = true;
}

bool OAIUpdate_request::is_utm_source_Set() const{
    return m_utm_source_isSet;
}

bool OAIUpdate_request::is_utm_source_Valid() const{
    return m_utm_source_isValid;
}

bool OAIUpdate_request::isSet() const {
...
bool OAIUpdate_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_coupon_code_isValid && m_expiration_interval_per_use_isValid && m_is_archived_isValid && m_max_items_per_client_isValid && m_utm_campaign_isValid && m_utm_source_isValid && true;
}
