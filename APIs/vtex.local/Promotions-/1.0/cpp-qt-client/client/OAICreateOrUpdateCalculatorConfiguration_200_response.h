...
/*
 * OAICreateOrUpdateCalculatorConfiguration_200_response.h
 *
 * 
 */

#ifndef OAICreateOrUpdateCalculatorConfiguration_200_response_H
#define OAICreateOrUpdateCalculatorConfiguration_200_response_H
...
class OAICreateOrUpdateCalculatorConfiguration_200_response : public OAIObject {
public:
    OAICreateOrUpdateCalculatorConfiguration_200_response();
    OAICreateOrUpdateCalculatorConfiguration_200_response(QString json);
    ~OAICreateOrUpdateCalculatorConfiguration_200_response() override;
    ...
    QList<QJsonValue> getZipCodeRanges() const;
    void setZipCodeRanges(const QList<QJsonValue> &zip_code_ranges);
...
private:
    ...
    QList<QJsonValue> m_zip_code_ranges;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOrUpdateCalculatorConfiguration_200_response)

#endif // OAICreateOrUpdateCalculatorConfiguration_200_response_H
