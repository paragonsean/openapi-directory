...
/*
 * OAIGetPromotions_inner_scope.h
 *
 * Scope of the promotion.
 */

#ifndef OAIGetPromotions_inner_scope_H
#define OAIGetPromotions_inner_scope_H
...
class OAIGetPromotions_inner_scope : public OAIObject {
public:
    OAIGetPromotions_inner_scope();
    OAIGetPromotions_inner_scope(QString json);
    ~OAIGetPromotions_inner_scope() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPromotions_inner_scope)

#endif // OAIGetPromotions_inner_scope_H
