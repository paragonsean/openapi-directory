...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PromotionsTaxesApi.UsagenotificationRequest();
  });
  ...
  describe('UsagenotificationRequest', function() {
    it('should create an instance of UsagenotificationRequest', function() {
      // uncomment below and update the code to test UsagenotificationRequest
      //var instance = new PromotionsTaxesApi.UsagenotificationRequest();
      //expect(instance).to.be.a(PromotionsTaxesApi.UsagenotificationRequest);
    });
    ...
    it('should have the property calculatorIds (base name: "calculatorIds")', function() {
      // uncomment below and update the code to test the property calculatorIds
      //var instance = new PromotionsTaxesApi.UsagenotificationRequest();
      //expect(instance).to.be();
    });
