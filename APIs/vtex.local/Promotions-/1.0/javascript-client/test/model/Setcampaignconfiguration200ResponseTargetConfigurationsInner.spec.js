...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PromotionsTaxesApi.Setcampaignconfiguration200ResponseTargetConfigurationsInner();
  });
  ...
  describe('Setcampaignconfiguration200ResponseTargetConfigurationsInner', function() {
    it('should create an instance of Setcampaignconfiguration200ResponseTargetConfigurationsInner', function() {
      // uncomment below and update the code to test Setcampaignconfiguration200ResponseTargetConfigurationsInner
      //var instance = new PromotionsTaxesApi.Setcampaignconfiguration200ResponseTargetConfigurationsInner();
      //expect(instance).to.be.a(PromotionsTaxesApi.Setcampaignconfiguration200ResponseTargetConfigurationsInner);
    });
