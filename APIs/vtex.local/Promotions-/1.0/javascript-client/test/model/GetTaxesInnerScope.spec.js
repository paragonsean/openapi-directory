...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PromotionsTaxesApi.GetTaxesInnerScope();
  });
  ...
  describe('GetTaxesInnerScope', function() {
    it('should create an instance of GetTaxesInnerScope', function() {
      // uncomment below and update the code to test GetTaxesInnerScope
      //var instance = new PromotionsTaxesApi.GetTaxesInnerScope();
      //expect(instance).to.be.a(PromotionsTaxesApi.GetTaxesInnerScope);
    });
