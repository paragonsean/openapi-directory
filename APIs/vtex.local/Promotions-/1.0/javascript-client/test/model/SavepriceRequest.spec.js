...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PromotionsTaxesApi.SavepriceRequest();
  });
  ...
  describe('SavepriceRequest', function() {
    it('should create an instance of SavepriceRequest', function() {
      // uncomment below and update the code to test SavepriceRequest
      //var instance = new PromotionsTaxesApi.SavepriceRequest();
      //expect(instance).to.be.a(PromotionsTaxesApi.SavepriceRequest);
    });
