...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PromotionsTaxesApi.PricebycontextRequest();
  });
  ...
  describe('PricebycontextRequest', function() {
    it('should create an instance of PricebycontextRequest', function() {
      // uncomment below and update the code to test PricebycontextRequest
      //var instance = new PromotionsTaxesApi.PricebycontextRequest();
      //expect(instance).to.be.a(PromotionsTaxesApi.PricebycontextRequest);
    });
