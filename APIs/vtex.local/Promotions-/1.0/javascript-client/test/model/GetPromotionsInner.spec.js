...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PromotionsTaxesApi.GetPromotionsInner();
  });
  ...
  describe('GetPromotionsInner', function() {
    it('should create an instance of GetPromotionsInner', function() {
      // uncomment below and update the code to test GetPromotionsInner
      //var instance = new PromotionsTaxesApi.GetPromotionsInner();
      //expect(instance).to.be.a(PromotionsTaxesApi.GetPromotionsInner);
    });
