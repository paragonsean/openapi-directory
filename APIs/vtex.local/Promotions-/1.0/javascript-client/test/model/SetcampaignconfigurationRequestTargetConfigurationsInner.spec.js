...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PromotionsTaxesApi.SetcampaignconfigurationRequestTargetConfigurationsInner();
  });
  ...
  describe('SetcampaignconfigurationRequestTargetConfigurationsInner', function() {
    it('should create an instance of SetcampaignconfigurationRequestTargetConfigurationsInner', function() {
      // uncomment below and update the code to test SetcampaignconfigurationRequestTargetConfigurationsInner
      //var instance = new PromotionsTaxesApi.SetcampaignconfigurationRequestTargetConfigurationsInner();
      //expect(instance).to.be.a(PromotionsTaxesApi.SetcampaignconfigurationRequestTargetConfigurationsInner);
    });
