...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PromotionsTaxesApi.UpdateRequest();
  });
  ...
  describe('UpdateRequest', function() {
    it('should create an instance of UpdateRequest', function() {
      ...
      //var instance = new PromotionsTaxesApi.UpdateRequest();
      //expect(instance).to.be.a(PromotionsTaxesApi.UpdateRequest);
    });
