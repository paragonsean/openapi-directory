...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PromotionsTaxesApi.Getcampaignconfiguration200ResponseTargetConfigurationsInner();
  });
  ...
  describe('Getcampaignconfiguration200ResponseTargetConfigurationsInner', function() {
    it('should create an instance of Getcampaignconfiguration200ResponseTargetConfigurationsInner', function() {
      // uncomment below and update the code to test Getcampaignconfiguration200ResponseTargetConfigurationsInner
      //var instance = new PromotionsTaxesApi.Getcampaignconfiguration200ResponseTargetConfigurationsInner();
      //expect(instance).to.be.a(PromotionsTaxesApi.Getcampaignconfiguration200ResponseTargetConfigurationsInner);
    });
