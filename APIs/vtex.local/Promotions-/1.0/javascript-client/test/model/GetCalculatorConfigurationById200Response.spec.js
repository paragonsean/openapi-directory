...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PromotionsTaxesApi.GetCalculatorConfigurationById200Response();
  });
  ...
  describe('GetCalculatorConfigurationById200Response', function() {
    it('should create an instance of GetCalculatorConfigurationById200Response', function() {
      // uncomment below and update the code to test GetCalculatorConfigurationById200Response
      //var instance = new PromotionsTaxesApi.GetCalculatorConfigurationById200Response();
      //expect(instance).to.be.a(PromotionsTaxesApi.GetCalculatorConfigurationById200Response);
    });
    ...
    it('should have the property multipleSkusCause (base name: "multipleSkusCause")', function() {
      // uncomment below and update the code to test the property multipleSkusCause
      //var instance = new PromotionsTaxesApi.GetCalculatorConfigurationById200Response();
      //expect(instance).to.be();
    });
