...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PromotionsTaxesApi.CreateOrUpdateCalculatorConfiguration200Response();
  });
  ...
  describe('CreateOrUpdateCalculatorConfiguration200Response', function() {
    it('should create an instance of CreateOrUpdateCalculatorConfiguration200Response', function() {
      // uncomment below and update the code to test CreateOrUpdateCalculatorConfiguration200Response
      //var instance = new PromotionsTaxesApi.CreateOrUpdateCalculatorConfiguration200Response();
      //expect(instance).to.be.a(PromotionsTaxesApi.CreateOrUpdateCalculatorConfiguration200Response);
    });
