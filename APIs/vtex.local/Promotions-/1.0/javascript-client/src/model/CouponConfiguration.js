...
class CouponConfiguration {
     ...
     * @param utmCampaign {String} utmCampaign code.
     * @param utmSource {String} utmSource code.
     */
    constructor(couponCode, expirationIntervalPerUse, maxItemsPerClient, utmCampaign, utmSource) { 
        
        CouponConfiguration.initialize(this, couponCode, expirationIntervalPerUse, maxItemsPerClient, utmCampaign, utmSource);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of CouponConfiguration.RequiredProperties) {
...
CouponConfiguration.RequiredProperties = ["couponCode", "expirationIntervalPerUse", "maxItemsPerClient", "utmCampaign", "utmSource"];
 ...
 */
CouponConfiguration.prototype['expirationIntervalPerUse'] = undefined;

/**
 * Defines if the coupon is archived (`true`) or not (`false`).
 * @member {Boolean} isArchived
 */
CouponConfiguration.prototype['isArchived'] = undefined;

/**
 * Maximum items per client that the coupon can be applied.
 * @member {Number} maxItemsPerClient
 */
CouponConfiguration.prototype['maxItemsPerClient'] = undefined;

/**
 * utmCampaign code.
 * @member {String} utmCampaign
 */
CouponConfiguration.prototype['utmCampaign'] = undefined;

/**
 * utmSource code.
 * @member {String} utmSource
 */
CouponConfiguration.prototype['utmSource'] = undefined;
