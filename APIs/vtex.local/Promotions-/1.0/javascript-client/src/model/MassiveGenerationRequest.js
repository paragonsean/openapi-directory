...
/**
 * The MassiveGenerationRequest model module.
 * @module model/MassiveGenerationRequest
 * @version 1.0
 */
class MassiveGenerationRequest {
    /**
     * Constructs a new <code>MassiveGenerationRequest</code>.
     * @alias module:model/MassiveGenerationRequest
     * @param couponCode {String} Coupon code.
     * @param expirationIntervalPerUse {String} Coupon expiration interval per use.
     * @param maxItemsPerClient {Number} Defines if the coupon is archived (`true`) or not (`false`).
     * @param utmCampaign {String} UTM campaign code.
     * @param utmSource {String} UTM source code.
     */
    constructor(couponCode, expirationIntervalPerUse, maxItemsPerClient, utmCampaign, utmSource) { 
        
        MassiveGenerationRequest.initialize(this, couponCode, expirationIntervalPerUse, maxItemsPerClient, utmCampaign, utmSource);
    }
     ...
     */
    static initialize(obj, couponCode, expirationIntervalPerUse, maxItemsPerClient, utmCampaign, utmSource) { 
    ...
    /**
     * Constructs a <code>MassiveGenerationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MassiveGenerationRequest} obj Optional instance to populate.
     * @return {module:model/MassiveGenerationRequest} The populated <code>MassiveGenerationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MassiveGenerationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>MassiveGenerationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MassiveGenerationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MassiveGenerationRequest.RequiredProperties) {
...
MassiveGenerationRequest.RequiredProperties = ["couponCode", "expirationIntervalPerUse", "maxItemsPerClient", "utmCampaign", "utmSource"];

/**
 * Coupon code.
 * @member {String} couponCode
 */
MassiveGenerationRequest.prototype['couponCode'] = undefined;

/**
 * Coupon expiration interval per use.
 * @member {String} expirationIntervalPerUse
 */
MassiveGenerationRequest.prototype['expirationIntervalPerUse'] = undefined;

/**
 * Defines if the coupon is archived (`true`) or not (`false`).
 * @member {Number} maxItemsPerClient
 */
MassiveGenerationRequest.prototype['maxItemsPerClient'] = undefined;

/**
 * UTM campaign code.
 * @member {String} utmCampaign
 */
MassiveGenerationRequest.prototype['utmCampaign'] = undefined;

/**
 * UTM source code.
 * @member {String} utmSource
 */
MassiveGenerationRequest.prototype['utmSource'] = undefined;
...
export default MassiveGenerationRequest;
