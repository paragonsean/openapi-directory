...
import Setcampaignconfiguration200ResponseTargetConfigurationsInner from './Setcampaignconfiguration200ResponseTargetConfigurationsInner';

/**
 * The Setcampaignconfiguration200Response model module.
 * @module model/Setcampaignconfiguration200Response
 * @version 1.0
 */
class Setcampaignconfiguration200Response {
    /**
     * Constructs a new <code>Setcampaignconfiguration200Response</code>.
     * @alias module:model/Setcampaignconfiguration200Response
     */
    constructor() { 
        
        Setcampaignconfiguration200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Setcampaignconfiguration200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Setcampaignconfiguration200Response} obj Optional instance to populate.
     * @return {module:model/Setcampaignconfiguration200Response} The populated <code>Setcampaignconfiguration200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Setcampaignconfiguration200Response();
            ...
            if (data.hasOwnProperty('targetConfigurations')) {
                obj['targetConfigurations'] = ApiClient.convertToType(data['targetConfigurations'], [Setcampaignconfiguration200ResponseTargetConfigurationsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Setcampaignconfiguration200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Setcampaignconfiguration200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['targetConfigurations']) { // data not null
            ...
            for (const item of data['targetConfigurations']) {
                Setcampaignconfiguration200ResponseTargetConfigurationsInner.validateJSON(item);
            };
        }
 ...
 */
Setcampaignconfiguration200Response.prototype['beginDateUtc'] = undefined;

/**
 * End date of the campaign audience in UTC format.
 * @member {String} endDateUtc
 */
Setcampaignconfiguration200Response.prototype['endDateUtc'] = undefined;

/**
 * Campaign audience ID.
 * @member {String} id
 */
Setcampaignconfiguration200Response.prototype['id'] = undefined;

/**
 * Defines if the campaign audience is active (`true`) or not (`false`).
 * @member {Boolean} isActive
 */
Setcampaignconfiguration200Response.prototype['isActive'] = undefined;
 ...
 */
Setcampaignconfiguration200Response.prototype['isAndOperator'] = undefined;

/**
 * Defines if the campaign audience is archived (`true`) or not (`false`).
 * @member {Boolean} isArchived
 */
Setcampaignconfiguration200Response.prototype['isArchived'] = undefined;

/**
 * @member {module:model/Getcampaignaudiences200ResponseInnerLastModified} lastModified
 */
Setcampaignconfiguration200Response.prototype['lastModified'] = undefined;

/**
 * Campaign audience name.
 * @member {String} name
 */
Setcampaignconfiguration200Response.prototype['name'] = undefined;

/**
 * Array that contains all target audience that the campaign audience will be valid.
 * @member {Array.<module:model/Setcampaignconfiguration200ResponseTargetConfigurationsInner>} targetConfigurations
 */
Setcampaignconfiguration200Response.prototype['targetConfigurations'] = undefined;
...
export default Setcampaignconfiguration200Response;
