...
/**
 * The Getcampaignaudiences200ResponseInnerTargetConfigurationsInner model module.
 * @module model/Getcampaignaudiences200ResponseInnerTargetConfigurationsInner
 * @version 1.0
 */
class Getcampaignaudiences200ResponseInnerTargetConfigurationsInner {
    /**
     * Constructs a new <code>Getcampaignaudiences200ResponseInnerTargetConfigurationsInner</code>.
     * Object with information about the target audience.
     * @alias module:model/Getcampaignaudiences200ResponseInnerTargetConfigurationsInner
     */
    constructor() { 
        
        Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Getcampaignaudiences200ResponseInnerTargetConfigurationsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Getcampaignaudiences200ResponseInnerTargetConfigurationsInner} obj Optional instance to populate.
     * @return {module:model/Getcampaignaudiences200ResponseInnerTargetConfigurationsInner} The populated <code>Getcampaignaudiences200ResponseInnerTargetConfigurationsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Getcampaignaudiences200ResponseInnerTargetConfigurationsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>Getcampaignaudiences200ResponseInnerTargetConfigurationsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Getcampaignaudiences200ResponseInnerTargetConfigurationsInner</code>.
     */
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['affiliates'] = undefined;

/**
 * Defines if the trade policy IDs are exclusive.
 * @member {Boolean} areSalesChannelIdsExclusive
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['areSalesChannelIdsExclusive'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['brands'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['brandsAreInclusive'] = undefined;

/**
 * Campaign Audiences that activate this promotion.
 * @member {Array.<Object>} campaigns
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['campaigns'] = undefined;

/**
 * @member {Array.<Object>} cardIssuers
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['cardIssuers'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['categories'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['categoriesAreInclusive'] = undefined;

/**
 * An expression to use with clusters.
 * @member {Array.<String>} clusterExpressions
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['clusterExpressions'] = undefined;

/**
 * @member {String} clusterOperator
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['clusterOperator'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['collections'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['collections1BuyTogether'] = undefined;

/**
 * @member {Array.<Object>} collections2BuyTogether
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['collections2BuyTogether'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['collectionsIsInclusive'] = undefined;

/**
 * If the **List Price** and **Price** are the same.
 * @member {Boolean} compareListPriceAndPrice
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['compareListPriceAndPrice'] = undefined;

/**
 * @member {Array.<Object>} coupon
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['coupon'] = undefined;

/**
 * Number of days that are considered to add the purchase history.
 * @member {Number} daysAgoOfPurchases
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['daysAgoOfPurchases'] = undefined;

/**
 * Enable **Buy Together** per SKU.
 * @member {Boolean} enableBuyTogetherPerSku
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['enableBuyTogetherPerSku'] = undefined;

/**
 * Defines if the target audience is featured (`true`) or not (`false`).
 * @member {Boolean} featured
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['featured'] = undefined;

/**
 * Applies the discount even if the user is not logged.
 * @member {Boolean} firstBuyIsProfileOptimistic
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['firstBuyIsProfileOptimistic'] = undefined;

/**
 * Gifts List Type.
 * @member {Array.<String>} giftListTypes
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['giftListTypes'] = undefined;

/**
 * Target audience ID.
 * @member {String} id
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['id'] = undefined;

/**
 * Defines if at least one of the sellers must be valid to active the campaign audience.
 * @member {Boolean} idSellerIsInclusive
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['idSellerIsInclusive'] = undefined;

/**
 * Array with all the trade policies that activate the campaign audience.
 * @member {Array.<String>} idsSalesChannel
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['idsSalesChannel'] = undefined;

/**
 * @member {Number} installment
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['installment'] = undefined;

/**
 * Applies the campaign audience only if the list price and price is different.
 * @member {Boolean} isDifferentListPriceAndPrice
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['isDifferentListPriceAndPrice'] = undefined;

/**
 * Applies the discount only if it's a first buy.
 * @member {Boolean} isFirstBuy
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['isFirstBuy'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['isMinMaxInstallments'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['isSlaSelected'] = undefined;

/**
 * Maximum price of the item.
 * @member {Number} itemMaxPrice
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['itemMaxPrice'] = undefined;

/**
 * Minimum price of the item.
 * @member {Number} itemMinPrice
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['itemMinPrice'] = undefined;

/**
 * Brand first list for the promotion **Buy Together.
 * @member {Array.<Object>} listBrand1BuyTogether
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['listBrand1BuyTogether'] = undefined;

/**
 * Category first list for the promotion **Buy Together**.
 * @member {Array.<Object>} listCategory1BuyTogether
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['listCategory1BuyTogether'] = undefined;

/**
 * SKU first list for the promotion **Buy Together**.
 * @member {Array.<Object>} listSku1BuyTogether
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['listSku1BuyTogether'] = undefined;

/**
 * SKU second list for the promotion **Buy Together**.
 * @member {Array.<Object>} listSku2BuyTogether
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['listSku2BuyTogether'] = undefined;

/**
 * Array with all the campaign audience's marketing tags.
 * @member {Array.<String>} marketingTags
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['marketingTags'] = undefined;

/**
 * Defines if marketing tags are not inclusive.
 * @member {Boolean} marketingTagsAreNotInclusive
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['marketingTagsAreNotInclusive'] = undefined;

/**
 * Maximum value for installment.
 * @member {Number} maxInstallment
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['maxInstallment'] = undefined;

/**
 * Defines how many times the campaign audience can be used.
 * @member {Number} maxUsage
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['maxUsage'] = undefined;

/**
 * Defines if the campaign audience can be used multiple times per client.
 * @member {Number} maxUsagePerClient
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['maxUsagePerClient'] = undefined;

/**
 * @member {Array.<Object>} merchants
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['merchants'] = undefined;

/**
 * Minimum value for installment.
 * @member {Number} minInstallment
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['minInstallment'] = undefined;

/**
 * Minimum quantity for **Buy Together** promotion.
 * @member {Number} minimumQuantityBuyTogether
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['minimumQuantityBuyTogether'] = undefined;

/**
 * Defines if the campaign audience can be used multiple times per client.
 * @member {Boolean} multipleUsePerClient
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['multipleUsePerClient'] = undefined;

/**
 * Target audience name.
 * @member {String} name
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['name'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['origin'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['paymentsMethods'] = undefined;

/**
 * @member {Array.<Object>} paymentsRules
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['paymentsRules'] = undefined;

/**
 * Percentual discount value list.
 * @member {Array.<Number>} percentualDiscountValueList
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['percentualDiscountValueList'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['products'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['productsAreInclusive'] = undefined;

/**
 * @member {Array.<Object>} productsSpecifications
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['productsSpecifications'] = undefined;

/**
 * Quantity to affect **Buy Together** promotion.
 * @member {Number} quantityToAffectBuyTogether
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['quantityToAffectBuyTogether'] = undefined;

/**
 * The discount will be granted if the card's BIN is given.
 * @member {Array.<String>} restrictionsBins
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['restrictionsBins'] = undefined;

/**
 * Should distribute discount among matched items.
 * @member {Boolean} shouldDistributeDiscountAmongMatchedItems
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['shouldDistributeDiscountAmongMatchedItems'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['skus'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['skusAreInclusive'] = undefined;

/**
 * The discount will be granted if the shipping method is the same as the one given.
 * @member {Array.<String>} slasIds
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['slasIds'] = undefined;

/**
 * @member {Array.<Object>} stores
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['stores'] = undefined;

/**
 * @member {Boolean} storesAreInclusive
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['storesAreInclusive'] = undefined;

/**
 * Maximum chart value to active the campaign audience.
 * @member {Number} totalValueCeling
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['totalValueCeling'] = undefined;

/**
 * Minimum chart value to active the campaign audience.
 * @member {Number} totalValueFloor
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['totalValueFloor'] = undefined;

/**
 * @member {Boolean} totalValueIncludeAllItems
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['totalValueIncludeAllItems'] = undefined;

/**
 * Total chart value to active the campaign audience.
 * @member {String} totalValueMode
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['totalValueMode'] = undefined;

/**
 * Total value a client must have in past orders to active the campaign audience.
 * @member {Number} totalValuePurchase
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['totalValuePurchase'] = undefined;

/**
 * Use new progressive algorithm.
 * @member {Boolean} useNewProgressiveAlgorithm
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['useNewProgressiveAlgorithm'] = undefined;
 ...
 */
Getcampaignaudiences200ResponseInnerTargetConfigurationsInner.prototype['zipCodeRanges'] = undefined;
...
export default Getcampaignaudiences200ResponseInnerTargetConfigurationsInner;
