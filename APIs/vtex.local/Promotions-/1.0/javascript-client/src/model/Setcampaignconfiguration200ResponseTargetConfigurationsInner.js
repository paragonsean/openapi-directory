...
/**
 * The Setcampaignconfiguration200ResponseTargetConfigurationsInner model module.
 * @module model/Setcampaignconfiguration200ResponseTargetConfigurationsInner
 * @version 1.0
 */
class Setcampaignconfiguration200ResponseTargetConfigurationsInner {
    /**
     * Constructs a new <code>Setcampaignconfiguration200ResponseTargetConfigurationsInner</code>.
     * Object with information about the target audience.
     * @alias module:model/Setcampaignconfiguration200ResponseTargetConfigurationsInner
     */
    constructor() { 
        
        Setcampaignconfiguration200ResponseTargetConfigurationsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Setcampaignconfiguration200ResponseTargetConfigurationsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Setcampaignconfiguration200ResponseTargetConfigurationsInner} obj Optional instance to populate.
     * @return {module:model/Setcampaignconfiguration200ResponseTargetConfigurationsInner} The populated <code>Setcampaignconfiguration200ResponseTargetConfigurationsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Setcampaignconfiguration200ResponseTargetConfigurationsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>Setcampaignconfiguration200ResponseTargetConfigurationsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Setcampaignconfiguration200ResponseTargetConfigurationsInner</code>.
     */
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['affiliates'] = undefined;

/**
 * Defines if the trade policy IDs are exclusive.
 * @member {Boolean} areSalesChannelIdsExclusive
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['areSalesChannelIdsExclusive'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['brands'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['brandsAreInclusive'] = undefined;

/**
 * Campaign Audiences that activate this promotion.
 * @member {Array.<Object>} campaigns
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['campaigns'] = undefined;

/**
 * @member {Array.<Object>} cardIssuers
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['cardIssuers'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['categories'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['categoriesAreInclusive'] = undefined;

/**
 * An expression to use with clusters.
 * @member {Array.<String>} clusterExpressions
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['clusterExpressions'] = undefined;

/**
 * @member {String} clusterOperator
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['clusterOperator'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['collections'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['collections1BuyTogether'] = undefined;

/**
 * @member {Array.<Object>} collections2BuyTogether
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['collections2BuyTogether'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['collectionsIsInclusive'] = undefined;

/**
 * If the **List Price** and **Price** are the same.
 * @member {Boolean} compareListPriceAndPrice
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['compareListPriceAndPrice'] = undefined;

/**
 * @member {Array.<Object>} coupon
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['coupon'] = undefined;

/**
 * Number of days that are considered to add the purchase history.
 * @member {Number} daysAgoOfPurchases
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['daysAgoOfPurchases'] = undefined;

/**
 * Enable **Buy Together** per SKU.
 * @member {Boolean} enableBuyTogetherPerSku
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['enableBuyTogetherPerSku'] = undefined;

/**
 * Defines if the target audience is feature (`true`) or not (`false`).
 * @member {Boolean} featured
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['featured'] = undefined;

/**
 * Applies the discount even if the user is not logged.
 * @member {Boolean} firstBuyIsProfileOptimistic
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['firstBuyIsProfileOptimistic'] = undefined;

/**
 * Gifts List Type.
 * @member {Array.<String>} giftListTypes
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['giftListTypes'] = undefined;

/**
 * Target audience ID.
 * @member {String} id
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['id'] = undefined;

/**
 * Defines if at least one of the sellers must be valid to active the campaign audience.
 * @member {Boolean} idSellerIsInclusive
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['idSellerIsInclusive'] = undefined;

/**
 * Array with all the trade policies that activate the campaign audience.
 * @member {Array.<String>} idsSalesChannel
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['idsSalesChannel'] = undefined;

/**
 * @member {Number} installment
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['installment'] = undefined;

/**
 * Applies the campaign audience only if the list price and price is different.
 * @member {Boolean} isDifferentListPriceAndPrice
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['isDifferentListPriceAndPrice'] = undefined;

/**
 * Applies the discount only if it's a first buy.
 * @member {Boolean} isFirstBuy
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['isFirstBuy'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['isMinMaxInstallments'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['isSlaSelected'] = undefined;

/**
 * Maximum price of the item.
 * @member {Number} itemMaxPrice
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['itemMaxPrice'] = undefined;

/**
 * Minimum price of the item.
 * @member {Number} itemMinPrice
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['itemMinPrice'] = undefined;

/**
 * Brand first list for the promotion **Buy Together.
 * @member {Array.<Object>} listBrand1BuyTogether
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['listBrand1BuyTogether'] = undefined;

/**
 * Category first list for the promotion **Buy Together**.
 * @member {Array.<Object>} listCategory1BuyTogether
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['listCategory1BuyTogether'] = undefined;

/**
 * SKU first list for the promotion **Buy Together**.
 * @member {Array.<Object>} listSku1BuyTogether
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['listSku1BuyTogether'] = undefined;

/**
 * SKU second list for the promotion **Buy Together**.
 * @member {Array.<Object>} listSku2BuyTogether
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['listSku2BuyTogether'] = undefined;

/**
 * Array with all the campaign audience's marketing tags.
 * @member {Array.<String>} marketingTags
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['marketingTags'] = undefined;

/**
 * Defines if marketing tags are not inclusive.
 * @member {Boolean} marketingTagsAreNotInclusive
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['marketingTagsAreNotInclusive'] = undefined;

/**
 * Maximum value for installment.
 * @member {Number} maxInstallment
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['maxInstallment'] = undefined;

/**
 * Defines how many times the campaign audience can be used.
 * @member {Number} maxUsage
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['maxUsage'] = undefined;

/**
 * Defines if the campaign audience can be used multiple times per client.
 * @member {Number} maxUsagePerClient
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['maxUsagePerClient'] = undefined;

/**
 * @member {Array.<Object>} merchants
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['merchants'] = undefined;

/**
 * Minimum value for installment.
 * @member {Number} minInstallment
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['minInstallment'] = undefined;

/**
 * Minimum quantity for **Buy Together** promotion.
 * @member {Number} minimumQuantityBuyTogether
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['minimumQuantityBuyTogether'] = undefined;

/**
 * Defines if the campaign audience can be used multiple times per client.
 * @member {Boolean} multipleUsePerClient
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['multipleUsePerClient'] = undefined;

/**
 * Target audience name.
 * @member {String} name
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['name'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['origin'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['paymentsMethods'] = undefined;

/**
 * @member {Array.<Object>} paymentsRules
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['paymentsRules'] = undefined;

/**
 * Percentual discount value list.
 * @member {Array.<Number>} percentualDiscountValueList
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['percentualDiscountValueList'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['products'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['productsAreInclusive'] = undefined;

/**
 * @member {Array.<Object>} productsSpecifications
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['productsSpecifications'] = undefined;

/**
 * Quantity to affect **Buy Together** promotion.
 * @member {Number} quantityToAffectBuyTogether
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['quantityToAffectBuyTogether'] = undefined;

/**
 * The discount will be granted if the card's BIN is given.
 * @member {Array.<String>} restrictionsBins
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['restrictionsBins'] = undefined;

/**
 * Should distribute discount among matched items.
 * @member {Boolean} shouldDistributeDiscountAmongMatchedItems
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['shouldDistributeDiscountAmongMatchedItems'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['skus'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['skusAreInclusive'] = undefined;

/**
 * The discount will be granted if the shipping method is the same as the one given.
 * @member {Array.<String>} slasIds
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['slasIds'] = undefined;

/**
 * @member {Array.<Object>} stores
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['stores'] = undefined;

/**
 * @member {Boolean} storesAreInclusive
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['storesAreInclusive'] = undefined;

/**
 * Maximum chart value to active the campaign audience.
 * @member {Number} totalValueCeling
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['totalValueCeling'] = undefined;

/**
 * Minimum chart value to active the campaign audience.
 * @member {Number} totalValueFloor
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['totalValueFloor'] = undefined;

/**
 * @member {Boolean} totalValueIncludeAllItems
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['totalValueIncludeAllItems'] = undefined;

/**
 * Total chart value to active the campaign audience.
 * @member {String} totalValueMode
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['totalValueMode'] = undefined;

/**
 * Total value a client must have in past orders to active the campaign audience.
 * @member {Number} totalValuePurchase
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['totalValuePurchase'] = undefined;

/**
 * Use new progressive algorithm.
 * @member {Boolean} useNewProgressiveAlgorithm
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['useNewProgressiveAlgorithm'] = undefined;
 ...
 */
Setcampaignconfiguration200ResponseTargetConfigurationsInner.prototype['zipCodeRanges'] = undefined;
...
export default Setcampaignconfiguration200ResponseTargetConfigurationsInner;
