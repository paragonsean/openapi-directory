...
class UpdateRequest(Model):
    ...
    def __init__(self, coupon_code: str=None, expiration_interval_per_use: str=None, is_archived: bool=None, max_items_per_client: int=None, utm_campaign: str=None, utm_source: str=None):
        ...
        :param coupon_code: The coupon_code of this UpdateRequest.
        :param expiration_interval_per_use: The expiration_interval_per_use of this UpdateRequest.
        :param is_archived: The is_archived of this UpdateRequest.
        :param max_items_per_client: The max_items_per_client of this UpdateRequest.
        :param utm_campaign: The utm_campaign of this UpdateRequest.
        :param utm_source: The utm_source of this UpdateRequest.
        """
        self.openapi_types = {
            'coupon_code': str,
    ...
    def coupon_code(self):
        """Gets the coupon_code of this UpdateRequest.

        Coupon code.

        :return: The coupon_code of this UpdateRequest.
        :rtype: str
        """
    ...
    def coupon_code(self, coupon_code):
        """Sets the coupon_code of this UpdateRequest.
    ...
    def expiration_interval_per_use(self):
        """Gets the expiration_interval_per_use of this UpdateRequest.

        Coupon expiration interval per use.

        :return: The expiration_interval_per_use of this UpdateRequest.
        :rtype: str
        """
    ...
    def expiration_interval_per_use(self, expiration_interval_per_use):
        """Sets the expiration_interval_per_use of this UpdateRequest.
    ...
    def is_archived(self):
        """Gets the is_archived of this UpdateRequest.

        Defines if the coupon is archived (`true`) or not (`false`).

        :return: The is_archived of this UpdateRequest.
        :rtype: bool
        """
    ...
    def is_archived(self, is_archived):
        """Sets the is_archived of this UpdateRequest.
    ...
    def max_items_per_client(self):
        """Gets the max_items_per_client of this UpdateRequest.

        Maximum items per client that the coupon can be applied.

        :return: The max_items_per_client of this UpdateRequest.
        :rtype: int
        """
    ...
    def max_items_per_client(self, max_items_per_client):
        """Sets the max_items_per_client of this UpdateRequest.
    ...
    def utm_campaign(self):
        """Gets the utm_campaign of this UpdateRequest.

        UTM campaign code.

        :return: The utm_campaign of this UpdateRequest.
        :rtype: str
        """
    ...
    def utm_campaign(self, utm_campaign):
        """Sets the utm_campaign of this UpdateRequest.
    ...
    @property
    def utm_source(self):
        """Gets the utm_source of this UpdateRequest.

        UTM source code.

        :return: The utm_source of this UpdateRequest.
        :rtype: str
        """
    ...
    def utm_source(self, utm_source):
        """Sets the utm_source of this UpdateRequest.
