...
|------------ | ------------- | ------------- | -------------|
|**affiliates** | [**List&lt;CreateOrUpdateCalculatorConfiguration200ResponseAffiliatesInner&gt;**](CreateOrUpdateCalculatorConfiguration200ResponseAffiliatesInner.md) | Marketplace order identifier. The discount will apply to selected affiliates. |  [optional] |
|**areSalesChannelIdsExclusive** | **Boolean** | Defines if the trade policy IDs are exclusive. |  [optional] |
|**brands** | [**List&lt;CreateOrUpdateCalculatorConfiguration200ResponseBrandsInner&gt;**](CreateOrUpdateCalculatorConfiguration200ResponseBrandsInner.md) | Object composed by the brands that will activate or deactivate the campaign audience. |  [optional] |
...
|**categories** | [**List&lt;CreateOrUpdateCalculatorConfiguration200ResponseCategoriesInner&gt;**](CreateOrUpdateCalculatorConfiguration200ResponseCategoriesInner.md) | Object composed by the categories that will activate or deactivate the campaign audience. |  [optional] |
...
|**collections** | [**List&lt;CreateOrUpdateCalculatorConfiguration200ResponseCollectionsInner&gt;**](CreateOrUpdateCalculatorConfiguration200ResponseCollectionsInner.md) | Object composed by the collections that will activate or deactivate the campaign audience. |  [optional] |
...
|**idsSalesChannel** | **List&lt;String&gt;** | Array with all the trade policies that activate the campaign audience. |  [optional] |
...
|**listCategory1BuyTogether** | **List&lt;Object&gt;** | Category first list for the promotion **Buy Together**. |  [optional] |
...
|**marketingTags** | **List&lt;String&gt;** | Array with all the campaign audience&#39;s marketing tags. |  [optional] |
...
|**paymentsMethods** | [**List&lt;CreateOrUpdateCalculatorConfiguration200ResponsePaymentsMethodsInner&gt;**](CreateOrUpdateCalculatorConfiguration200ResponsePaymentsMethodsInner.md) | Array composed by all the Payments Methods. |  [optional] |
|**paymentsRules** | **List&lt;Object&gt;** |  |  [optional] |
|**percentualDiscountValueList** | **List&lt;BigDecimal&gt;** | Percentual discount value list. |  [optional] |
|**products** | [**List&lt;CreateOrUpdateCalculatorConfiguration200ResponseProductsInner&gt;**](CreateOrUpdateCalculatorConfiguration200ResponseProductsInner.md) | Object composed by the products that will activate or deactivate the campaign audience. |  [optional] |
...
|**skus** | [**List&lt;CreateOrUpdateCalculatorConfiguration200ResponseSkusInner&gt;**](CreateOrUpdateCalculatorConfiguration200ResponseSkusInner.md) | Object composed by the SKUs that will activate or deactivate the campaign audience. |  [optional] |
...
|**zipCodeRanges** | [**List&lt;Getcampaignaudiences200ResponseInnerTargetConfigurationsInnerZipCodeRangesInner&gt;**](Getcampaignaudiences200ResponseInnerTargetConfigurationsInnerZipCodeRangesInner.md) | Range of the zip code that applies the campaign audience. |  [optional] |
