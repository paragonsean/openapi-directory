...
|**targetConfigurations** | [**List&lt;SetcampaignconfigurationRequestTargetConfigurationsInner&gt;**](SetcampaignconfigurationRequestTargetConfigurationsInner.md) | Array that contains all target audience that the campaign audience will be valid. |  [optional] |
