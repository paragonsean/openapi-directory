...
|------------ | ------------- | ------------- | -------------|
|**campaigns** | **List&lt;String&gt;** | Array with campaign audiences that activate this promotion. |  [optional] |
...
|**idsSalesChannel** | **List&lt;String&gt;** | List of Trade Policies that activate this promotion. |  [optional] |
...
|**maxUsage** | **BigDecimal** | Defines how many times the promotion can be used. |  [optional] |
|**name** | **String** | Promotion Name. |  [optional] |
|**percentualTax** | **BigDecimal** | Percentual tax applied. |  [optional] |
