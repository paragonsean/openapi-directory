...
|------------ | ------------- | ------------- | -------------|
|**campaigns** | **List&lt;String&gt;** | Array with campaign audiences that activate this tax. |  [optional] |
...
|**idsSalesChannel** | **List&lt;String&gt;** | List of Trade Policies that activate this tax. |  [optional] |
...
|**maxUsage** | **BigDecimal** | Defines how many times the tax can be used. |  [optional] |
