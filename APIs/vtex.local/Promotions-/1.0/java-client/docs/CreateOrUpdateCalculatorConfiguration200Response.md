...
|**activeDaysOfWeek** | **List&lt;String&gt;** | Defines which days of the week the promotion will applied. |  [optional] |
...
|**brands** | [**List&lt;CreateOrUpdateCalculatorConfiguration200ResponseBrandsInner&gt;**](CreateOrUpdateCalculatorConfiguration200ResponseBrandsInner.md) | Object composed by the brands that will activate or deactivate the promotion. |  [optional] |
...
|**categories** | [**List&lt;CreateOrUpdateCalculatorConfiguration200ResponseCategoriesInner&gt;**](CreateOrUpdateCalculatorConfiguration200ResponseCategoriesInner.md) | Object composed by the categories that will activate or deactivate the promotion. |  [optional] |
...
|**collections** | [**List&lt;CreateOrUpdateCalculatorConfiguration200ResponseCollectionsInner&gt;**](CreateOrUpdateCalculatorConfiguration200ResponseCollectionsInner.md) | Object composed by the collections that will activate or deactivate the promotion. |  [optional] |
...
|**marketingTags** | **List&lt;String&gt;** | Promotion Marketing tags. |  [optional] |
...
|**maxUsage** | **Integer** | Defines how many times the promotion can be used. |  [optional] |
...
|**products** | [**List&lt;CreateOrUpdateCalculatorConfiguration200ResponseProductsInner&gt;**](CreateOrUpdateCalculatorConfiguration200ResponseProductsInner.md) | Object composed by the products that will activate or deactivate the promotion. |  [optional] |
...
|**skus** | [**List&lt;CreateOrUpdateCalculatorConfiguration200ResponseSkusInner&gt;**](CreateOrUpdateCalculatorConfiguration200ResponseSkusInner.md) | Object composed by the SKUs that will activate or deactivate the promotion. |  [optional] |
...
|**totalValueCeling** | **BigDecimal** | Maximum chart value to activate the promotion. |  [optional] |
|**totalValueFloor** | **BigDecimal** | Minimum chart value to activate the promotion. |  [optional] |
...
|**totalValuePurchase** | **BigDecimal** | Total value a client must have in past orders to active the promotion. |  [optional] |
...
|**zipCodeRanges** | **List&lt;Object&gt;** | Range of the zip code that applies the promotion. |  [optional] |
