...
#ifndef OAINewValue_H
#define OAINewValue_H
...
class OAINewValue : public OAIObject {
public:
    OAINewValue();
    OAINewValue(QString json);
    ~OAINewValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewValue)
