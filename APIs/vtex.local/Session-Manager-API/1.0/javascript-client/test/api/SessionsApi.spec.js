...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SessionManagerApi.SessionsApi();
  });
  ...
  describe('SessionsApi', function() {
    describe('createnewsession', function() {
      it('should call createnewsession successfully', function(done) {
        //uncomment below and update the code to test createnewsession
        //instance.createnewsession(function(error) {
    ...
    describe('editsession', function() {
      it('should call editsession successfully', function(done) {
        ...
        //instance.editsession(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
