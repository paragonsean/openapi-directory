...
public class Example {
  public static void main(String[] args) {
    ...
    CreatenewsessionRequest createnewsessionRequest = new CreatenewsessionRequest(); // CreatenewsessionRequest | 
    try {
      apiInstance.createnewsession(createnewsessionRequest);
...
public class Example {
  public static void main(String[] args) {
    ...
    SessionsApi apiInstance = new SessionsApi(defaultClient);
    EditsessionRequest editsessionRequest = new EditsessionRequest(); // EditsessionRequest | 
    try {
      apiInstance.editsession(editsessionRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling SessionsApi#editsession");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    SessionsApi apiInstance = new SessionsApi(defaultClient);
    String items = "namespace1.key1,namespace2.key2"; // String | Items are the keys of the values you wish to get. It follows the format `namespace1.key1,namespace2.key2`
    try {
      apiInstance.getSession(items);
    } catch (ApiException e) {
