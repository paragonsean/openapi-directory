...
public class PetsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> An paged array of pets </td><td>  * x-next - A link to the next page of responses <br>  </td></tr>
        <tr><td> 0 </td><td> unexpected error </td><td>  -  </td></tr>
     </table>
     */
     ...
     */
    public List<Pet> showPetById(String petId) throws ApiException {
        ApiResponse<List<Pet>> localVarResp = showPetByIdWithHttpInfo(petId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Pet>> showPetByIdWithHttpInfo(String petId) throws ApiException {
     ...
     */
    public okhttp3.Call showPetByIdAsync(String petId, final ApiCallback<List<Pet>> _callback) throws ApiException {
