# CheckoutApi.CartAttachmentsApi
...
let apiInstance = new CheckoutApi.CartAttachmentsApi();
let contentType = "'application/json'"; // String | Type of the content being sent.
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let orderFormId = "orderFormId_example"; // String | ID of the orderForm that will receive client profile information.
let addClientPreferencesRequest = new CheckoutApi.AddClientPreferencesRequest(); // AddClientPreferencesRequest | 
apiInstance.addClientPreferences(contentType, accept, orderFormId, addClientPreferencesRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let orderFormId = "orderFormId_example"; // String | ID of the orderForm that will receive client profile information.
let addClientProfileRequest = new CheckoutApi.AddClientProfileRequest(); // AddClientProfileRequest | 
apiInstance.addClientProfile(contentType, accept, orderFormId, addClientProfileRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let orderFormId = "orderFormId_example"; // String | ID of the orderForm that will receive client profile information.
let addMarketingDataRequest = new CheckoutApi.AddMarketingDataRequest(); // AddMarketingDataRequest | 
apiInstance.addMarketingData(contentType, accept, orderFormId, addMarketingDataRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let contentType = "'application/json'"; // String | Type of the content being sent.
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let orderFormId = "29154e27383145cc8ce1f7a1df0d99c4"; // String | ID of the orderForm that will receive the relevant information added by the merchant.
let addMerchantContextDataRequest = new CheckoutApi.AddMerchantContextDataRequest(); // AddMerchantContextDataRequest | 
apiInstance.addMerchantContextData(contentType, accept, orderFormId, addMerchantContextDataRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let orderFormId = "orderFormId_example"; // String | ID of the orderForm that will receive client profile information.
let addPaymentDataRequest = new CheckoutApi.AddPaymentDataRequest(); // AddPaymentDataRequest | 
apiInstance.addPaymentData(contentType, accept, orderFormId, addPaymentDataRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let orderFormId = "orderFormId_example"; // String | ID of the orderForm that will receive client profile information.
let addShippingAddressRequest = new CheckoutApi.AddShippingAddressRequest(); // AddShippingAddressRequest | 
apiInstance.addShippingAddress(contentType, accept, orderFormId, addShippingAddressRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let contentType = "'application/json'"; // String | Type of the content being sent.
let accept = "'application/json'"; // String | HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
let email = "'clark.kent@examplemail.com'"; // String | Client's email address to be searched.
apiInstance.getClientProfileByEmail(contentType, accept, email, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
