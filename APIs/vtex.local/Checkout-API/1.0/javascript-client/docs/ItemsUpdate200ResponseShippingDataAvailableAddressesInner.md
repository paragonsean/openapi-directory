# CheckoutApi.ItemsUpdate200ResponseShippingDataAvailableAddressesInner
...
**geoCoordinates** | **[String]** | Array with two strings with geocoordinates, first latitude, then longitude. | [optional] 
