# CheckoutApi.UpdateorderFormconfigurationRequest
...
**apps** | [**[UpdateorderFormconfigurationRequestAppsInner]**](UpdateorderFormconfigurationRequestAppsInner.md) | Array of objects containing Apps configuration information. | 
**decimalDigitsPrecision** | **Number** | Number of price digits. | 
...
**maxNumberOfWhiteLabelSellers** | **Number** | Allows the input of a limit of white label sellers involved on the cart. | [optional] 
**minimumQuantityAccumulatedForItems** | **Number** | Minimum SKU quantity by cart. | 
**minimumValueAccumulated** | **Number** | Minimum cart value. | 
