# CheckoutApi.PlaceOrder200ResponseOrdersInner
...
**isCheckedIn** | **Boolean** | Indicates whether order is checked in. | [optional] [default to false]
...
**items** | [**[PlaceOrder200ResponseOrdersInnerItemsInner]**](PlaceOrder200ResponseOrdersInnerItemsInner.md) | Information on each item in the order. | [optional] 
...
**roundingError** | **Number** | Rounding error. | [optional] 
