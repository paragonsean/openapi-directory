...
/**
 * The AddCoupons200ResponseItemsInnerAdditionalInfo model module.
 * @module model/AddCoupons200ResponseItemsInnerAdditionalInfo
 * @version 1.0
 */
class AddCoupons200ResponseItemsInnerAdditionalInfo {
    /**
     * Constructs a new <code>AddCoupons200ResponseItemsInnerAdditionalInfo</code>.
     * Additional information.
     * @alias module:model/AddCoupons200ResponseItemsInnerAdditionalInfo
     */
    constructor() { 
        
        AddCoupons200ResponseItemsInnerAdditionalInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddCoupons200ResponseItemsInnerAdditionalInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddCoupons200ResponseItemsInnerAdditionalInfo} obj Optional instance to populate.
     * @return {module:model/AddCoupons200ResponseItemsInnerAdditionalInfo} The populated <code>AddCoupons200ResponseItemsInnerAdditionalInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddCoupons200ResponseItemsInnerAdditionalInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>AddCoupons200ResponseItemsInnerAdditionalInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddCoupons200ResponseItemsInnerAdditionalInfo</code>.
     */
 ...
 */
AddCoupons200ResponseItemsInnerAdditionalInfo.prototype['brandId'] = undefined;

/**
 * Brand name.
 * @member {String} brandName
 */
AddCoupons200ResponseItemsInnerAdditionalInfo.prototype['brandName'] = undefined;

/**
 * Dimension.
 * @member {String} dimension
 */
AddCoupons200ResponseItemsInnerAdditionalInfo.prototype['dimension'] = undefined;

/**
 * Offering information.
 * @member {String} offeringInfo
 */
AddCoupons200ResponseItemsInnerAdditionalInfo.prototype['offeringInfo'] = undefined;

/**
 * Offering type.
 * @member {String} offeringType
 */
AddCoupons200ResponseItemsInnerAdditionalInfo.prototype['offeringType'] = undefined;

/**
 * Offering type ID.
 * @member {String} offeringTypeId
 */
AddCoupons200ResponseItemsInnerAdditionalInfo.prototype['offeringTypeId'] = undefined;
...
export default AddCoupons200ResponseItemsInnerAdditionalInfo;
