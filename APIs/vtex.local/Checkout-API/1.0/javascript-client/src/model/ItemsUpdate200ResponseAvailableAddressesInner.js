...
/**
 * The ItemsUpdate200ResponseAvailableAddressesInner model module.
 * @module model/ItemsUpdate200ResponseAvailableAddressesInner
 * @version 1.0
 */
class ItemsUpdate200ResponseAvailableAddressesInner {
    /**
     * Constructs a new <code>ItemsUpdate200ResponseAvailableAddressesInner</code>.
     * @alias module:model/ItemsUpdate200ResponseAvailableAddressesInner
     */
    constructor() { 
        
        ItemsUpdate200ResponseAvailableAddressesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemsUpdate200ResponseAvailableAddressesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemsUpdate200ResponseAvailableAddressesInner} obj Optional instance to populate.
     * @return {module:model/ItemsUpdate200ResponseAvailableAddressesInner} The populated <code>ItemsUpdate200ResponseAvailableAddressesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemsUpdate200ResponseAvailableAddressesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ItemsUpdate200ResponseAvailableAddressesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemsUpdate200ResponseAvailableAddressesInner</code>.
     */
 ...
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['addressId'] = undefined;

/**
 * Address type.
 * @member {String} addressType
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['addressType'] = undefined;

/**
 * City of the address.
 * @member {String} city
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['city'] = undefined;

/**
 * Complement to the address.
 * @member {String} complement
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['complement'] = undefined;

/**
 * Country of the address. ISO three-letter code.
 * @member {String} country
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['country'] = undefined;

/**
 * List with the two geocoordinates.
 * @member {Array.<String>} geoCoordinates
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['geoCoordinates'] = undefined;

/**
 * Indicates whether address is disposable.
 * @member {Boolean} isDisposable
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['isDisposable'] = undefined;

/**
 * Neighborhood of the address.
 * @member {String} neighborhood
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['neighborhood'] = undefined;

/**
 * Number of the address.
 * @member {String} number
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['number'] = undefined;

/**
 * Name of the receiver.
 * @member {String} receiverName
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['receiverName'] = undefined;

/**
 * Reference that may help in the location of the address.
 * @member {String} reference
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['reference'] = undefined;

/**
 * State of the address.
 * @member {String} state
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['state'] = undefined;

/**
 * Street of the address.
 * @member {String} street
 */
ItemsUpdate200ResponseAvailableAddressesInner.prototype['street'] = undefined;
...
export default ItemsUpdate200ResponseAvailableAddressesInner;
