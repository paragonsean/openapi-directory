...
/**
 * The ItemsUpdate200ResponseShippingDataAvailableAddressesInner model module.
 * @module model/ItemsUpdate200ResponseShippingDataAvailableAddressesInner
 * @version 1.0
 */
class ItemsUpdate200ResponseShippingDataAvailableAddressesInner {
    /**
     * Constructs a new <code>ItemsUpdate200ResponseShippingDataAvailableAddressesInner</code>.
     * @alias module:model/ItemsUpdate200ResponseShippingDataAvailableAddressesInner
     */
    constructor() { 
        
        ItemsUpdate200ResponseShippingDataAvailableAddressesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemsUpdate200ResponseShippingDataAvailableAddressesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemsUpdate200ResponseShippingDataAvailableAddressesInner} obj Optional instance to populate.
     * @return {module:model/ItemsUpdate200ResponseShippingDataAvailableAddressesInner} The populated <code>ItemsUpdate200ResponseShippingDataAvailableAddressesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemsUpdate200ResponseShippingDataAvailableAddressesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ItemsUpdate200ResponseShippingDataAvailableAddressesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemsUpdate200ResponseShippingDataAvailableAddressesInner</code>.
     */
 ...
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['addressId'] = undefined;

/**
 * Type of address. For example, `Residential` or `Pickup`.
 * @member {String} addressType
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['addressType'] = undefined;

/**
 * City of the shipping address.
 * @member {String} city
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['city'] = undefined;

/**
 * Complement to the shipping address, in case it applies.
 * @member {String} complement
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['complement'] = undefined;

/**
 * Three letter ISO code of the country of the shipping address.
 * @member {String} country
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['country'] = undefined;

/**
 * Array with two strings with geocoordinates, first latitude, then longitude.
 * @member {Array.<String>} geoCoordinates
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['geoCoordinates'] = undefined;

/**
 * Indicates whether address is disposable.
 * @member {Boolean} isDisposable
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['isDisposable'] = undefined;

/**
 * Neighborhood of the shipping address.
 * @member {String} neighborhood
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['neighborhood'] = undefined;

/**
 * Number of the building, house or apartment in the shipping address.
 * @member {String} number
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['number'] = undefined;

/**
 * Postal code.
 * @member {String} postalCode
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['postalCode'] = undefined;

/**
 * Name of the person who is going to receive the order.
 * @member {String} receiverName
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['receiverName'] = undefined;

/**
 * Complement that might help locate the shipping address more precisely in case of delivery.
 * @member {String} reference
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['reference'] = undefined;

/**
 * State of the shipping address.
 * @member {String} state
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['state'] = undefined;

/**
 * Street of the shipping address.
 * @member {String} street
 */
ItemsUpdate200ResponseShippingDataAvailableAddressesInner.prototype['street'] = undefined;
...
export default ItemsUpdate200ResponseShippingDataAvailableAddressesInner;
