...
/**
 * The AddCoupons200ResponseShippingDataAvailableAddressesInner model module.
 * @module model/AddCoupons200ResponseShippingDataAvailableAddressesInner
 * @version 1.0
 */
class AddCoupons200ResponseShippingDataAvailableAddressesInner {
    /**
     * Constructs a new <code>AddCoupons200ResponseShippingDataAvailableAddressesInner</code>.
     * @alias module:model/AddCoupons200ResponseShippingDataAvailableAddressesInner
     */
    constructor() { 
        
        AddCoupons200ResponseShippingDataAvailableAddressesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddCoupons200ResponseShippingDataAvailableAddressesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddCoupons200ResponseShippingDataAvailableAddressesInner} obj Optional instance to populate.
     * @return {module:model/AddCoupons200ResponseShippingDataAvailableAddressesInner} The populated <code>AddCoupons200ResponseShippingDataAvailableAddressesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddCoupons200ResponseShippingDataAvailableAddressesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>AddCoupons200ResponseShippingDataAvailableAddressesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddCoupons200ResponseShippingDataAvailableAddressesInner</code>.
     */
 ...
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['addressId'] = undefined;

/**
 * Type of address. For example, `Residential` or `Pickup`.
 * @member {String} addressType
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['addressType'] = undefined;

/**
 * City of the shipping address.
 * @member {String} city
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['city'] = undefined;

/**
 * Complement to the shipping address, in case it applies.
 * @member {String} complement
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['complement'] = undefined;

/**
 * Three letter ISO code of the country of the shipping address.
 * @member {String} country
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['country'] = undefined;

/**
 * Array containing two floats with geocoordinates, first longitude, then latitude.
 * @member {Array.<Number>} geoCoordinates
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['geoCoordinates'] = undefined;

/**
 * Indicates whether address is disposable.
 * @member {Boolean} isDisposable
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['isDisposable'] = undefined;

/**
 * Neighborhood of the shipping address.
 * @member {String} neighborhood
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['neighborhood'] = undefined;

/**
 * Number of the building, house or apartment in the shipping address.
 * @member {String} number
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['number'] = undefined;

/**
 * Postal code.
 * @member {String} postalCode
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['postalCode'] = undefined;

/**
 * Name of the person who is going to receive the order.
 * @member {String} receiverName
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['receiverName'] = undefined;

/**
 * Complement that might help locate the shipping address more precisely in case of delivery.
 * @member {String} reference
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['reference'] = undefined;

/**
 * State of the shipping address.
 * @member {String} state
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['state'] = undefined;

/**
 * Street of the shipping address.
 * @member {String} street
 */
AddCoupons200ResponseShippingDataAvailableAddressesInner.prototype['street'] = undefined;
...
export default AddCoupons200ResponseShippingDataAvailableAddressesInner;
