...
import ClearorderFormMessages200ResponseMarketingData from './ClearorderFormMessages200ResponseMarketingData';
...
/**
 * The ClearorderFormMessages200Response model module.
 * @module model/ClearorderFormMessages200Response
 * @version 1.0
 */
class ClearorderFormMessages200Response {
    /**
     * Constructs a new <code>ClearorderFormMessages200Response</code>.
     * @alias module:model/ClearorderFormMessages200Response
     */
    constructor() { 
        
        ClearorderFormMessages200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClearorderFormMessages200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClearorderFormMessages200Response} obj Optional instance to populate.
     * @return {module:model/ClearorderFormMessages200Response} The populated <code>ClearorderFormMessages200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClearorderFormMessages200Response();
            ...
            if (data.hasOwnProperty('marketingData')) {
                obj['marketingData'] = ClearorderFormMessages200ResponseMarketingData.constructFromObject(data['marketingData']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ClearorderFormMessages200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClearorderFormMessages200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['marketingData']) { // data not null
          ClearorderFormMessages200ResponseMarketingData.validateJSON(data['marketingData']);
        }
        // ensure the json data is an array
 ...
 */
ClearorderFormMessages200Response.prototype['allowManualPrice'] = undefined;

/**
 * Available accounts.
 * @member {Array.<String>} availableAccounts
 */
ClearorderFormMessages200Response.prototype['availableAccounts'] = undefined;
 ...
 */
ClearorderFormMessages200Response.prototype['availableAddresses'] = undefined;

/**
 * Data can be edited.
 * @member {Boolean} canEditData
 */
ClearorderFormMessages200Response.prototype['canEditData'] = undefined;

/**
 * @member {module:model/Items200ResponseClientPreferencesData} clientPreferencesData
 */
ClearorderFormMessages200Response.prototype['clientPreferencesData'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponseClientProfileData} clientProfileData
 */
ClearorderFormMessages200Response.prototype['clientProfileData'] = undefined;

/**
 * Object containing commercial condition information.
 * @member {Object} commercialConditionData
 */
ClearorderFormMessages200Response.prototype['commercialConditionData'] = undefined;

/**
 * Customer additional information.
 * @member {Object} customData
 */
ClearorderFormMessages200Response.prototype['customData'] = undefined;

/**
 * Gift registry list information.
 * @member {Object} giftRegistryData
 */
ClearorderFormMessages200Response.prototype['giftRegistryData'] = undefined;

/**
 * Hooks information.
 * @member {Object} hooksData
 */
ClearorderFormMessages200Response.prototype['hooksData'] = undefined;

/**
 * Ignore customer profile data.
 * @member {Boolean} ignoreProfileData
 */
ClearorderFormMessages200Response.prototype['ignoreProfileData'] = undefined;

/**
 * Object containing information pertinent to the order's invoice.
 * @member {Object} invoiceData
 */
ClearorderFormMessages200Response.prototype['invoiceData'] = undefined;

/**
 * Indicates whether order is checked in.
 * @member {Boolean} isCheckedIn
 */
ClearorderFormMessages200Response.prototype['isCheckedIn'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponseItemMetadata} itemMetadata
 */
ClearorderFormMessages200Response.prototype['itemMetadata'] = undefined;

/**
 * Information on each item in the order.
 * @member {Array.<module:model/Items200ResponseItemsInner>} items
 */
ClearorderFormMessages200Response.prototype['items'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponseItemsOrdination} itemsOrdination
 */
ClearorderFormMessages200Response.prototype['itemsOrdination'] = undefined;

/**
 * Indicates whether the user is logged into the store.
 * @member {Boolean} loggedIn
 */
ClearorderFormMessages200Response.prototype['loggedIn'] = undefined;

/**
 * @member {module:model/ClearorderFormMessages200ResponseMarketingData} marketingData
 */
ClearorderFormMessages200Response.prototype['marketingData'] = undefined;
 ...
 */
ClearorderFormMessages200Response.prototype['messages'] = undefined;
 ...
 */
ClearorderFormMessages200Response.prototype['openTextField'] = 'open-text-example';

/**
 * ID of the orderForm corresponding to a specific cart.
 * @member {String} orderFormId
 */
ClearorderFormMessages200Response.prototype['orderFormId'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponsePaymentData} paymentData
 */
ClearorderFormMessages200Response.prototype['paymentData'] = undefined;

/**
 * Profile provider.
 * @member {String} profileProvider
 */
ClearorderFormMessages200Response.prototype['profileProvider'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponseRatesAndBenefitsData} ratesAndBenefitsData
 */
ClearorderFormMessages200Response.prototype['ratesAndBenefitsData'] = undefined;

/**
 * Attribute created by the seller, in their VTEX store configuration.
 * @member {String} salesChannel
 */
ClearorderFormMessages200Response.prototype['salesChannel'] = undefined;

/**
 * Array containing the data of the item selected as a gift.
 * @member {Array.<Object>} selectableGifts
 */
ClearorderFormMessages200Response.prototype['selectableGifts'] = undefined;

/**
 * Information on each seller.
 * @member {Array.<module:model/AddCoupons200ResponseSellersInner>} sellers
 */
ClearorderFormMessages200Response.prototype['sellers'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponseShippingData} shippingData
 */
ClearorderFormMessages200Response.prototype['shippingData'] = undefined;

/**
 * ID of the store.
 * @member {String} storeId
 */
ClearorderFormMessages200Response.prototype['storeId'] = undefined;

/**
 * Object containing data from the store's configuration (stored in VTEX's License Manager).
 * @member {Object} storePreferencesData
 */
ClearorderFormMessages200Response.prototype['storePreferencesData'] = undefined;

/**
 * Subscription information.
 * @member {Object} subscriptionData
 */
ClearorderFormMessages200Response.prototype['subscriptionData'] = undefined;
 ...
 */
ClearorderFormMessages200Response.prototype['totalizers'] = undefined;

/**
 * Unique ID associated with the customer profile.
 * @member {String} userProfileId
 */
ClearorderFormMessages200Response.prototype['userProfileId'] = undefined;

/**
 * User type.
 * @member {String} userType
 */
ClearorderFormMessages200Response.prototype['userType'] = undefined;

/**
 * Total value of the order without separating cents. For example, $24.99 is represented `2499`.
 * @member {Number} value
 */
ClearorderFormMessages200Response.prototype['value'] = undefined;
...
export default ClearorderFormMessages200Response;
