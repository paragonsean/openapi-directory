...
import AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInnerPickupStoreInfo from './AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInnerPickupStoreInfo';

/**
 * The AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner model module.
 * @module model/AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner
 * @version 1.0
 */
class AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner {
    /**
     * Constructs a new <code>AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner</code>.
     * @alias module:model/AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner
     */
    constructor() { 
        
        AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner} obj Optional instance to populate.
     * @return {module:model/AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner} The populated <code>AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner();
            ...
            if (data.hasOwnProperty('pickupStoreInfo')) {
                obj['pickupStoreInfo'] = AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInnerPickupStoreInfo.constructFromObject(data['pickupStoreInfo']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner</code>.
     */
    static validateJSON(data) {
        ...
        if (data['pickupStoreInfo']) { // data not null
          AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInnerPickupStoreInfo.validateJSON(data['pickupStoreInfo']);
        }
        // ensure the json data is a string
 ...
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['deliveryChannel'] = undefined;
 ...
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['deliveryIds'] = undefined;

/**
 * SLA ID.
 * @member {String} id
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['id'] = undefined;

/**
 * List price in cents.
 * @member {Number} listPrice
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['listPrice'] = undefined;

/**
 * Estimate date of delivery.
 * @member {String} lockTTL
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['lockTTL'] = undefined;

/**
 * SLA name.
 * @member {String} name
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['name'] = undefined;

/**
 * Pickup point distance.
 * @member {Number} pickupDistance
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['pickupDistance'] = undefined;

/**
 * Pickup point ID.
 * @member {String} pickupPointId
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['pickupPointId'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInnerPickupStoreInfo} pickupStoreInfo
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['pickupStoreInfo'] = undefined;

/**
 * Polygon name.
 * @member {String} polygonName
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['polygonName'] = undefined;

/**
 * Price in cents.
 * @member {Number} price
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['price'] = undefined;

/**
 * Shipping estimate. For instance, Three business days will be represented `3bd`.
 * @member {String} shippingEstimate
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['shippingEstimate'] = undefined;

/**
 * Shipping estimate date.
 * @member {String} shippingEstimateDate
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['shippingEstimateDate'] = undefined;

/**
 * Tax in cents.
 * @member {Number} tax
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['tax'] = undefined;

/**
 * Transit time. For instance, \"three business days\" is represented `3bd`.
 * @member {String} transitTime
 */
AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.prototype['transitTime'] = undefined;
...
export default AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner;
