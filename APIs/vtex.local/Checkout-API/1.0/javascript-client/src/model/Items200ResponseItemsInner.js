...
/**
 * The Items200ResponseItemsInner model module.
 * @module model/Items200ResponseItemsInner
 * @version 1.0
 */
class Items200ResponseItemsInner {
    /**
     * Constructs a new <code>Items200ResponseItemsInner</code>.
     * @alias module:model/Items200ResponseItemsInner
     */
    constructor() { 
        
        Items200ResponseItemsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Items200ResponseItemsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Items200ResponseItemsInner} obj Optional instance to populate.
     * @return {module:model/Items200ResponseItemsInner} The populated <code>Items200ResponseItemsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Items200ResponseItemsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>Items200ResponseItemsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Items200ResponseItemsInner</code>.
     */
 ...
 */
Items200ResponseItemsInner.prototype['additionalInfo'] = undefined;

/**
 * Array containing information on attachments.
 * @member {Array.<String>} attachments
 */
Items200ResponseItemsInner.prototype['attachments'] = undefined;

/**
 * Availability.
 * @member {String} availability
 */
Items200ResponseItemsInner.prototype['availability'] = undefined;
 ...
 */
Items200ResponseItemsInner.prototype['bundleItems'] = undefined;

/**
 * Detail URL.
 * @member {String} detailUrl
 */
Items200ResponseItemsInner.prototype['detailUrl'] = undefined;

/**
 * European Article Number.
 * @member {String} ean
 */
Items200ResponseItemsInner.prototype['ean'] = undefined;

/**
 * ID of the item.
 * @member {String} id
 */
Items200ResponseItemsInner.prototype['id'] = undefined;

/**
 * Image URL.
 * @member {String} imageUrl
 */
Items200ResponseItemsInner.prototype['imageUrl'] = undefined;

/**
 * Indicates whether item is a gift.
 * @member {Boolean} isGift
 */
Items200ResponseItemsInner.prototype['isGift'] = undefined;

/**
 * List price in cents.
 * @member {Number} listPrice
 */
Items200ResponseItemsInner.prototype['listPrice'] = undefined;

/**
 * Manual price in cents.
 * @member {Number} manualPrice
 */
Items200ResponseItemsInner.prototype['manualPrice'] = undefined;

/**
 * User that applied the manual price, if that is the case.
 * @member {String} manualPriceAppliedBy
 */
Items200ResponseItemsInner.prototype['manualPriceAppliedBy'] = undefined;

/**
 * Manufacturer code.
 * @member {String} manufacturerCode
 */
Items200ResponseItemsInner.prototype['manufacturerCode'] = undefined;

/**
 * Measurement unit.
 * @member {String} measurementUnit
 */
Items200ResponseItemsInner.prototype['measurementUnit'] = undefined;

/**
 * Modal type.
 * @member {String} modalType
 */
Items200ResponseItemsInner.prototype['modalType'] = undefined;

/**
 * Product name.
 * @member {String} name
 */
Items200ResponseItemsInner.prototype['name'] = undefined;

/**
 * Parent assembly binding.
 * @member {String} parentAssemblyBinding
 */
Items200ResponseItemsInner.prototype['parentAssemblyBinding'] = undefined;

/**
 * Parent item index.
 * @member {Number} parentItemIndex
 */
Items200ResponseItemsInner.prototype['parentItemIndex'] = undefined;

/**
 * Presale date.
 * @member {String} preSaleDate
 */
Items200ResponseItemsInner.prototype['preSaleDate'] = undefined;

/**
 * Price in cents.
 * @member {Number} price
 */
Items200ResponseItemsInner.prototype['price'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponseItemsInnerPriceDefinition} priceDefinition
 */
Items200ResponseItemsInner.prototype['priceDefinition'] = undefined;
 ...
 */
Items200ResponseItemsInner.prototype['priceTags'] = undefined;

/**
 * Price expiration date and time.
 * @member {String} priceValidUntil
 */
Items200ResponseItemsInner.prototype['priceValidUntil'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponseItemsInnerProductCategories} productCategories
 */
Items200ResponseItemsInner.prototype['productCategories'] = undefined;

/**
 * Product category IDs.
 * @member {String} productCategoryIds
 */
Items200ResponseItemsInner.prototype['productCategoryIds'] = undefined;

/**
 * Product ID.
 * @member {String} productId
 */
Items200ResponseItemsInner.prototype['productId'] = undefined;

/**
 * Product Ref ID.
 * @member {String} productRefId
 */
Items200ResponseItemsInner.prototype['productRefId'] = undefined;

/**
 * Quantity.
 * @member {Number} quantity
 */
Items200ResponseItemsInner.prototype['quantity'] = undefined;

/**
 * Ref ID.
 * @member {String} refId
 */
Items200ResponseItemsInner.prototype['refId'] = undefined;

/**
 * Reward value in cents.
 * @member {Number} rewardValue
 */
Items200ResponseItemsInner.prototype['rewardValue'] = undefined;

/**
 * Seller.
 * @member {String} seller
 */
Items200ResponseItemsInner.prototype['seller'] = undefined;
 ...
 */
Items200ResponseItemsInner.prototype['sellerChain'] = undefined;
 ...
 */
Items200ResponseItemsInner.prototype['sellingPrice'] = undefined;

/**
 * SKU name.
 * @member {String} skuName
 */
Items200ResponseItemsInner.prototype['skuName'] = undefined;

/**
 * Tax value in cents.
 * @member {Number} tax
 */
Items200ResponseItemsInner.prototype['tax'] = undefined;

/**
 * Unique ID.
 * @member {String} uniqueId
 */
Items200ResponseItemsInner.prototype['uniqueId'] = undefined;

/**
 * Unit multiplier.
 * @member {Number} unitMultiplier
 */
Items200ResponseItemsInner.prototype['unitMultiplier'] = undefined;
...
export default Items200ResponseItemsInner;
