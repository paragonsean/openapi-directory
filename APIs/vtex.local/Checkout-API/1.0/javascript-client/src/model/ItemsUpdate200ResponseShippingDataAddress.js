...
/**
 * The ItemsUpdate200ResponseShippingDataAddress model module.
 * @module model/ItemsUpdate200ResponseShippingDataAddress
 * @version 1.0
 */
class ItemsUpdate200ResponseShippingDataAddress {
    /**
     * Constructs a new <code>ItemsUpdate200ResponseShippingDataAddress</code>.
     * Address information.
     * @alias module:model/ItemsUpdate200ResponseShippingDataAddress
     */
    constructor() { 
        
        ItemsUpdate200ResponseShippingDataAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemsUpdate200ResponseShippingDataAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemsUpdate200ResponseShippingDataAddress} obj Optional instance to populate.
     * @return {module:model/ItemsUpdate200ResponseShippingDataAddress} The populated <code>ItemsUpdate200ResponseShippingDataAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemsUpdate200ResponseShippingDataAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>ItemsUpdate200ResponseShippingDataAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemsUpdate200ResponseShippingDataAddress</code>.
     */
 ...
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['addressId'] = undefined;

/**
 * Type of address. For example, `Residential` or `Pickup`.
 * @member {String} addressType
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['addressType'] = undefined;

/**
 * City of the shipping address.
 * @member {String} city
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['city'] = undefined;

/**
 * Complement to the shipping address, in case it applies.
 * @member {String} complement
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['complement'] = undefined;

/**
 * Three letter ISO code of the country of the shipping address.
 * @member {String} country
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['country'] = undefined;

/**
 * Array with two strings with geocoordinates, first latitude, then longitude.
 * @member {Array.<String>} geoCoordinates
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['geoCoordinates'] = undefined;

/**
 * Indicates whether address is disposable.
 * @member {Boolean} isDisposable
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['isDisposable'] = undefined;

/**
 * Neighborhood of the shipping address.
 * @member {String} neighborhood
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['neighborhood'] = undefined;

/**
 * Number of the building, house or apartment in the shipping address.
 * @member {String} number
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['number'] = undefined;

/**
 * Postal code.
 * @member {String} postalCode
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['postalCode'] = undefined;

/**
 * Name of the person who is going to receive the order.
 * @member {String} receiverName
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['receiverName'] = undefined;

/**
 * Complement that might help locate the shipping address more precisely in case of delivery.
 * @member {String} reference
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['reference'] = undefined;

/**
 * State of the shipping address.
 * @member {String} state
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['state'] = undefined;

/**
 * Street of the shipping address.
 * @member {String} street
 */
ItemsUpdate200ResponseShippingDataAddress.prototype['street'] = undefined;
...
export default ItemsUpdate200ResponseShippingDataAddress;
