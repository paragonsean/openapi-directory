...
/**
 * The PlaceOrderRequestShippingDataAddress model module.
 * @module model/PlaceOrderRequestShippingDataAddress
 * @version 1.0
 */
class PlaceOrderRequestShippingDataAddress {
    /**
     * Constructs a new <code>PlaceOrderRequestShippingDataAddress</code>.
     ...
     * @alias module:model/PlaceOrderRequestShippingDataAddress
     */
    constructor() { 
        
        PlaceOrderRequestShippingDataAddress.initialize(this);
    }
    ...
    static initialize(obj) { 
        ...
        obj['complement'] = '3rd floor';
        obj['country'] = 'BRA';
        obj['neighborhood'] = 'Botafogo';
        obj['number'] = '300';
        obj['postalCode'] = '12345-000';
        obj['receiverName'] = 'receiver-name';
        obj['reference'] = 'Grey building';
        obj['state'] = 'Rio de Janeiro';
        obj['street'] = 'Praia de Botafogo';
    }

    /**
     * Constructs a <code>PlaceOrderRequestShippingDataAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlaceOrderRequestShippingDataAddress} obj Optional instance to populate.
     * @return {module:model/PlaceOrderRequestShippingDataAddress} The populated <code>PlaceOrderRequestShippingDataAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlaceOrderRequestShippingDataAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>PlaceOrderRequestShippingDataAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlaceOrderRequestShippingDataAddress</code>.
     */
 ...
 * @default 'Home'
 */
PlaceOrderRequestShippingDataAddress.prototype['addressId'] = 'Home';

/**
 * Type of address. For example, `Residential` or `Pickup`, among others.
 * @member {String} addressType
 */
PlaceOrderRequestShippingDataAddress.prototype['addressType'] = undefined;
 ...
 */
PlaceOrderRequestShippingDataAddress.prototype['city'] = 'Rio de Janeiro';
 ...
 * @default '3rd floor'
 */
PlaceOrderRequestShippingDataAddress.prototype['complement'] = '3rd floor';
 ...
 * @default 'BRA'
 */
PlaceOrderRequestShippingDataAddress.prototype['country'] = 'BRA';

/**
 * Array containing two floats with geocoordinates, first longitude, then latitude.
 * @member {Array.<Number>} geoCoordinates
 */
PlaceOrderRequestShippingDataAddress.prototype['geoCoordinates'] = undefined;
 ...
 * @default 'Botafogo'
 */
PlaceOrderRequestShippingDataAddress.prototype['neighborhood'] = 'Botafogo';
 ...
 * @default '300'
 */
PlaceOrderRequestShippingDataAddress.prototype['number'] = '300';
 ...
 * @default '12345-000'
 */
PlaceOrderRequestShippingDataAddress.prototype['postalCode'] = '12345-000';
 ...
 */
PlaceOrderRequestShippingDataAddress.prototype['receiverName'] = 'receiver-name';
 ...
 */
PlaceOrderRequestShippingDataAddress.prototype['reference'] = 'Grey building';
 ...
 * @default 'Rio de Janeiro'
 */
PlaceOrderRequestShippingDataAddress.prototype['state'] = 'Rio de Janeiro';
 ...
 */
PlaceOrderRequestShippingDataAddress.prototype['street'] = 'Praia de Botafogo';
...
export default PlaceOrderRequestShippingDataAddress;
