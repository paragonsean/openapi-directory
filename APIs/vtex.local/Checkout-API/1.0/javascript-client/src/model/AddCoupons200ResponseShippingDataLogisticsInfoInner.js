...
import AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner from './AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner';

/**
 * The AddCoupons200ResponseShippingDataLogisticsInfoInner model module.
 * @module model/AddCoupons200ResponseShippingDataLogisticsInfoInner
 * @version 1.0
 */
class AddCoupons200ResponseShippingDataLogisticsInfoInner {
    /**
     * Constructs a new <code>AddCoupons200ResponseShippingDataLogisticsInfoInner</code>.
     * @alias module:model/AddCoupons200ResponseShippingDataLogisticsInfoInner
     */
    constructor() { 
        
        AddCoupons200ResponseShippingDataLogisticsInfoInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddCoupons200ResponseShippingDataLogisticsInfoInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddCoupons200ResponseShippingDataLogisticsInfoInner} obj Optional instance to populate.
     * @return {module:model/AddCoupons200ResponseShippingDataLogisticsInfoInner} The populated <code>AddCoupons200ResponseShippingDataLogisticsInfoInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddCoupons200ResponseShippingDataLogisticsInfoInner();
            ...
            if (data.hasOwnProperty('slas')) {
                obj['slas'] = ApiClient.convertToType(data['slas'], [AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddCoupons200ResponseShippingDataLogisticsInfoInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddCoupons200ResponseShippingDataLogisticsInfoInner</code>.
     */
    static validateJSON(data) {
        ...
        if (data['slas']) { // data not null
            ...
            for (const item of data['slas']) {
                AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.validateJSON(item);
            };
        }
 ...
 */
AddCoupons200ResponseShippingDataLogisticsInfoInner.prototype['addressId'] = undefined;
 ...
 */
AddCoupons200ResponseShippingDataLogisticsInfoInner.prototype['deliveryChannels'] = undefined;

/**
 * Item ID.
 * @member {String} itemId
 */
AddCoupons200ResponseShippingDataLogisticsInfoInner.prototype['itemId'] = undefined;

/**
 * Index corresponding to the position of the object in the `items` array.
 * @member {Number} itemIndex
 */
AddCoupons200ResponseShippingDataLogisticsInfoInner.prototype['itemIndex'] = undefined;

/**
 * Delivery channel selected by the customer.
 * @member {String} selectedDeliveryChannel
 */
AddCoupons200ResponseShippingDataLogisticsInfoInner.prototype['selectedDeliveryChannel'] = undefined;

/**
 * SLA selected by the customer.
 * @member {String} selectedSla
 */
AddCoupons200ResponseShippingDataLogisticsInfoInner.prototype['selectedSla'] = undefined;

/**
 * List of countries that the item may be shipped to.
 * @member {Array.<String>} shipsTo
 */
AddCoupons200ResponseShippingDataLogisticsInfoInner.prototype['shipsTo'] = undefined;

/**
 * Information on available SLAs.
 * @member {Array.<module:model/AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner>} slas
 */
AddCoupons200ResponseShippingDataLogisticsInfoInner.prototype['slas'] = undefined;
...
export default AddCoupons200ResponseShippingDataLogisticsInfoInner;
