...
/**
 * The AddShippingAddressRequestSelectedAddressesInner model module.
 * @module model/AddShippingAddressRequestSelectedAddressesInner
 * @version 1.0
 */
class AddShippingAddressRequestSelectedAddressesInner {
    /**
     * Constructs a new <code>AddShippingAddressRequestSelectedAddressesInner</code>.
     * @alias module:model/AddShippingAddressRequestSelectedAddressesInner
     */
    constructor() { 
        
        AddShippingAddressRequestSelectedAddressesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddShippingAddressRequestSelectedAddressesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddShippingAddressRequestSelectedAddressesInner} obj Optional instance to populate.
     * @return {module:model/AddShippingAddressRequestSelectedAddressesInner} The populated <code>AddShippingAddressRequestSelectedAddressesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddShippingAddressRequestSelectedAddressesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>AddShippingAddressRequestSelectedAddressesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddShippingAddressRequestSelectedAddressesInner</code>.
     */
 ...
 */
AddShippingAddressRequestSelectedAddressesInner.prototype['addressType'] = undefined;

/**
 * City of the shipping address.
 * @member {String} city
 */
AddShippingAddressRequestSelectedAddressesInner.prototype['city'] = undefined;

/**
 * Complement to the shipping address in case it applies.
 * @member {String} complement
 */
AddShippingAddressRequestSelectedAddressesInner.prototype['complement'] = undefined;

/**
 * Three letter ISO code of the country of the shipping address.
 * @member {String} country
 */
AddShippingAddressRequestSelectedAddressesInner.prototype['country'] = undefined;

/**
 * Array containing two floats with geocoordinates, first longitude, then latitude.
 * @member {Array.<Number>} geoCoordinates
 */
AddShippingAddressRequestSelectedAddressesInner.prototype['geoCoordinates'] = undefined;

/**
 * Neighborhood of the shipping address.
 * @member {String} neighborhood
 */
AddShippingAddressRequestSelectedAddressesInner.prototype['neighborhood'] = undefined;

/**
 * Number of the building, house or apartment in the shipping address.
 * @member {String} number
 */
AddShippingAddressRequestSelectedAddressesInner.prototype['number'] = undefined;

/**
 * Postal Code.
 * @member {String} postalCode
 */
AddShippingAddressRequestSelectedAddressesInner.prototype['postalCode'] = undefined;

/**
 * Name of the person who is going to receive the order.
 * @member {String} receiverName
 */
AddShippingAddressRequestSelectedAddressesInner.prototype['receiverName'] = undefined;

/**
 * Complement that might help locate the shipping address more precisely in case of delivery.
 * @member {String} reference
 */
AddShippingAddressRequestSelectedAddressesInner.prototype['reference'] = undefined;

/**
 * State of the shipping address.
 * @member {String} state
 */
AddShippingAddressRequestSelectedAddressesInner.prototype['state'] = undefined;

/**
 * Street of the shipping address.
 * @member {String} street
 */
AddShippingAddressRequestSelectedAddressesInner.prototype['street'] = undefined;
...
export default AddShippingAddressRequestSelectedAddressesInner;
