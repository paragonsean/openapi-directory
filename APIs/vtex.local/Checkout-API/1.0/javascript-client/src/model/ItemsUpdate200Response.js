...
import Items200ResponseClientPreferencesData from './Items200ResponseClientPreferencesData';
import Items200ResponseItemsInner from './Items200ResponseItemsInner';
import Items200ResponseMarketingData from './Items200ResponseMarketingData';
import ItemsUpdate200ResponseAvailableAddressesInner from './ItemsUpdate200ResponseAvailableAddressesInner';
import ItemsUpdate200ResponseItemsOrdination from './ItemsUpdate200ResponseItemsOrdination';
import ItemsUpdate200ResponseShippingData from './ItemsUpdate200ResponseShippingData';

/**
 * The ItemsUpdate200Response model module.
 * @module model/ItemsUpdate200Response
 * @version 1.0
 */
class ItemsUpdate200Response {
    /**
     * Constructs a new <code>ItemsUpdate200Response</code>.
     * @alias module:model/ItemsUpdate200Response
     */
    constructor() { 
        
        ItemsUpdate200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemsUpdate200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemsUpdate200Response} obj Optional instance to populate.
     * @return {module:model/ItemsUpdate200Response} The populated <code>ItemsUpdate200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemsUpdate200Response();
            ...
            if (data.hasOwnProperty('availableAddresses')) {
                obj['availableAddresses'] = ApiClient.convertToType(data['availableAddresses'], [ItemsUpdate200ResponseAvailableAddressesInner]);
            }
            ...
            if (data.hasOwnProperty('clientPreferencesData')) {
                obj['clientPreferencesData'] = Items200ResponseClientPreferencesData.constructFromObject(data['clientPreferencesData']);
            }
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [Items200ResponseItemsInner]);
            }
            if (data.hasOwnProperty('itemsOrdination')) {
                obj['itemsOrdination'] = ItemsUpdate200ResponseItemsOrdination.constructFromObject(data['itemsOrdination']);
            }
            ...
            if (data.hasOwnProperty('marketingData')) {
                obj['marketingData'] = Items200ResponseMarketingData.constructFromObject(data['marketingData']);
            }
            ...
            if (data.hasOwnProperty('shippingData')) {
                obj['shippingData'] = ItemsUpdate200ResponseShippingData.constructFromObject(data['shippingData']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ItemsUpdate200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemsUpdate200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['availableAddresses']) { // data not null
            ...
            for (const item of data['availableAddresses']) {
                ItemsUpdate200ResponseAvailableAddressesInner.validateJSON(item);
            };
        }
        // validate the optional field `clientPreferencesData`
        if (data['clientPreferencesData']) { // data not null
          Items200ResponseClientPreferencesData.validateJSON(data['clientPreferencesData']);
        }
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                Items200ResponseItemsInner.validateJSON(item);
            };
        }
        // validate the optional field `itemsOrdination`
        if (data['itemsOrdination']) { // data not null
          ItemsUpdate200ResponseItemsOrdination.validateJSON(data['itemsOrdination']);
        }
        // validate the optional field `marketingData`
        if (data['marketingData']) { // data not null
          Items200ResponseMarketingData.validateJSON(data['marketingData']);
        }
        // ensure the json data is an array
        ...
        if (data['shippingData']) { // data not null
          ItemsUpdate200ResponseShippingData.validateJSON(data['shippingData']);
        }
        // ensure the json data is a string
 ...
 */
ItemsUpdate200Response.prototype['allowManualPrice'] = undefined;

/**
 * Available accounts.
 * @member {Array.<String>} availableAccounts
 */
ItemsUpdate200Response.prototype['availableAccounts'] = undefined;

/**
 * Information on each available address.
 * @member {Array.<module:model/ItemsUpdate200ResponseAvailableAddressesInner>} availableAddresses
 */
ItemsUpdate200Response.prototype['availableAddresses'] = undefined;

/**
 * Data can be edited.
 * @member {Boolean} canEditData
 */
ItemsUpdate200Response.prototype['canEditData'] = undefined;

/**
 * @member {module:model/Items200ResponseClientPreferencesData} clientPreferencesData
 */
ItemsUpdate200Response.prototype['clientPreferencesData'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponseClientProfileData} clientProfileData
 */
ItemsUpdate200Response.prototype['clientProfileData'] = undefined;

/**
 * Object containing commercial condition information.
 * @member {Object} commercialConditionData
 */
ItemsUpdate200Response.prototype['commercialConditionData'] = undefined;

/**
 * Customer additional information.
 * @member {Object} customData
 */
ItemsUpdate200Response.prototype['customData'] = undefined;

/**
 * Gift registry list information.
 * @member {Object} giftRegistryData
 */
ItemsUpdate200Response.prototype['giftRegistryData'] = undefined;

/**
 * Hooks information.
 * @member {Object} hooksData
 */
ItemsUpdate200Response.prototype['hooksData'] = undefined;

/**
 * Ignore customer profile data.
 * @member {Boolean} ignoreProfileData
 */
ItemsUpdate200Response.prototype['ignoreProfileData'] = undefined;

/**
 * Object containing information pertinent to the order's invoice.
 * @member {Object} invoiceData
 */
ItemsUpdate200Response.prototype['invoiceData'] = undefined;

/**
 * Indicates whether order is checked in.
 * @member {Boolean} isCheckedIn
 */
ItemsUpdate200Response.prototype['isCheckedIn'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponseItemMetadata} itemMetadata
 */
ItemsUpdate200Response.prototype['itemMetadata'] = undefined;

/**
 * Information on each item in the order.
 * @member {Array.<module:model/Items200ResponseItemsInner>} items
 */
ItemsUpdate200Response.prototype['items'] = undefined;

/**
 * @member {module:model/ItemsUpdate200ResponseItemsOrdination} itemsOrdination
 */
ItemsUpdate200Response.prototype['itemsOrdination'] = undefined;

/**
 * Indicates whether the user is logged into the store.
 * @member {Boolean} loggedIn
 */
ItemsUpdate200Response.prototype['loggedIn'] = undefined;

/**
 * @member {module:model/Items200ResponseMarketingData} marketingData
 */
ItemsUpdate200Response.prototype['marketingData'] = undefined;
 ...
 */
ItemsUpdate200Response.prototype['messages'] = undefined;
 ...
 */
ItemsUpdate200Response.prototype['openTextField'] = 'open-text-example';

/**
 * ID of the orderForm corresponding to a specific cart.
 * @member {String} orderFormId
 */
ItemsUpdate200Response.prototype['orderFormId'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponsePaymentData} paymentData
 */
ItemsUpdate200Response.prototype['paymentData'] = undefined;

/**
 * Profile provider.
 * @member {String} profileProvider
 */
ItemsUpdate200Response.prototype['profileProvider'] = undefined;

/**
 * @member {module:model/AddCoupons200ResponseRatesAndBenefitsData} ratesAndBenefitsData
 */
ItemsUpdate200Response.prototype['ratesAndBenefitsData'] = undefined;

/**
 * Attribute created by the seller, in their VTEX store configuration.
 * @member {String} salesChannel
 */
ItemsUpdate200Response.prototype['salesChannel'] = undefined;

/**
 * Array containing the data of the item selected as a gift.
 * @member {Array.<Object>} selectableGifts
 */
ItemsUpdate200Response.prototype['selectableGifts'] = undefined;

/**
 * Information on each seller.
 * @member {Array.<module:model/AddCoupons200ResponseSellersInner>} sellers
 */
ItemsUpdate200Response.prototype['sellers'] = undefined;

/**
 * @member {module:model/ItemsUpdate200ResponseShippingData} shippingData
 */
ItemsUpdate200Response.prototype['shippingData'] = undefined;

/**
 * ID of the store.
 * @member {String} storeId
 */
ItemsUpdate200Response.prototype['storeId'] = undefined;

/**
 * Object containing data from the store's configuration (stored in VTEX's License Manager).
 * @member {Object} storePreferencesData
 */
ItemsUpdate200Response.prototype['storePreferencesData'] = undefined;

/**
 * Subscription information.
 * @member {Object} subscriptionData
 */
ItemsUpdate200Response.prototype['subscriptionData'] = undefined;
 ...
 */
ItemsUpdate200Response.prototype['totalizers'] = undefined;

/**
 * Unique ID associated with the customer profile.
 * @member {String} userProfileId
 */
ItemsUpdate200Response.prototype['userProfileId'] = undefined;

/**
 * User type.
 * @member {String} userType
 */
ItemsUpdate200Response.prototype['userType'] = undefined;

/**
 * Total value of the order without separating cents. For example, $24.99 is represented as `2499`.
 * @member {Number} value
 */
ItemsUpdate200Response.prototype['value'] = undefined;
...
export default ItemsUpdate200Response;
