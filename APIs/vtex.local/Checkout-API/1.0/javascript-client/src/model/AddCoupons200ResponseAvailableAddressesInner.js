...
/**
 * The AddCoupons200ResponseAvailableAddressesInner model module.
 * @module model/AddCoupons200ResponseAvailableAddressesInner
 * @version 1.0
 */
class AddCoupons200ResponseAvailableAddressesInner {
    /**
     * Constructs a new <code>AddCoupons200ResponseAvailableAddressesInner</code>.
     * @alias module:model/AddCoupons200ResponseAvailableAddressesInner
     */
    constructor() { 
        
        AddCoupons200ResponseAvailableAddressesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddCoupons200ResponseAvailableAddressesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddCoupons200ResponseAvailableAddressesInner} obj Optional instance to populate.
     * @return {module:model/AddCoupons200ResponseAvailableAddressesInner} The populated <code>AddCoupons200ResponseAvailableAddressesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddCoupons200ResponseAvailableAddressesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>AddCoupons200ResponseAvailableAddressesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddCoupons200ResponseAvailableAddressesInner</code>.
     */
 ...
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['addressId'] = undefined;

/**
 * Address type.
 * @member {String} addressType
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['addressType'] = undefined;

/**
 * City of the address.
 * @member {String} city
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['city'] = undefined;

/**
 * Complement to the address.
 * @member {String} complement
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['complement'] = undefined;

/**
 * Country of the address. ISO three-letter code.
 * @member {String} country
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['country'] = undefined;

/**
 * Array containing two floats with geocoordinates, first longitude, then latitude.
 * @member {Array.<Number>} geoCoordinates
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['geoCoordinates'] = undefined;

/**
 * Indicates whether address is disposable.
 * @member {Boolean} isDisposable
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['isDisposable'] = undefined;

/**
 * Neighborhood of the address.
 * @member {String} neighborhood
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['neighborhood'] = undefined;

/**
 * Number of the address.
 * @member {String} number
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['number'] = undefined;

/**
 * Name of the receiver.
 * @member {String} receiverName
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['receiverName'] = undefined;

/**
 * Reference that may help in the location of the address.
 * @member {String} reference
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['reference'] = undefined;

/**
 * State of the address.
 * @member {String} state
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['state'] = undefined;

/**
 * Street of the address.
 * @member {String} street
 */
AddCoupons200ResponseAvailableAddressesInner.prototype['street'] = undefined;
...
export default AddCoupons200ResponseAvailableAddressesInner;
