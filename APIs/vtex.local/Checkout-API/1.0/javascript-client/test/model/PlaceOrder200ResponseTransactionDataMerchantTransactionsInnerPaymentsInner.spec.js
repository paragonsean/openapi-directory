...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.PlaceOrder200ResponseTransactionDataMerchantTransactionsInnerPaymentsInner();
  });
  ...
  describe('PlaceOrder200ResponseTransactionDataMerchantTransactionsInnerPaymentsInner', function() {
    it('should create an instance of PlaceOrder200ResponseTransactionDataMerchantTransactionsInnerPaymentsInner', function() {
      // uncomment below and update the code to test PlaceOrder200ResponseTransactionDataMerchantTransactionsInnerPaymentsInner
      //var instance = new CheckoutApi.PlaceOrder200ResponseTransactionDataMerchantTransactionsInnerPaymentsInner();
      //expect(instance).to.be.a(CheckoutApi.PlaceOrder200ResponseTransactionDataMerchantTransactionsInnerPaymentsInner);
    });
    ...
    it('should have the property giftCardRedemptionCode (base name: "giftCardRedemptionCode")', function() {
      // uncomment below and update the code to test the property giftCardRedemptionCode
      //var instance = new CheckoutApi.PlaceOrder200ResponseTransactionDataMerchantTransactionsInnerPaymentsInner();
      //expect(instance).to.be();
    });
