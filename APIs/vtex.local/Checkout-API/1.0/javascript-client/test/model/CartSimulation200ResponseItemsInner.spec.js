...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.CartSimulation200ResponseItemsInner();
  });
  ...
  describe('CartSimulation200ResponseItemsInner', function() {
    it('should create an instance of CartSimulation200ResponseItemsInner', function() {
      // uncomment below and update the code to test CartSimulation200ResponseItemsInner
      //var instance = new CheckoutApi.CartSimulation200ResponseItemsInner();
      //expect(instance).to.be.a(CheckoutApi.CartSimulation200ResponseItemsInner);
    });
    ...
    it('should have the property requestIndex (base name: "requestIndex")', function() {
      // uncomment below and update the code to test the property requestIndex
      //var instance = new CheckoutApi.CartSimulation200ResponseItemsInner();
      //expect(instance).to.be();
    });
