...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.PlaceOrderRequestShippingDataLogisticsInfoInner();
  });
  ...
  describe('PlaceOrderRequestShippingDataLogisticsInfoInner', function() {
    it('should create an instance of PlaceOrderRequestShippingDataLogisticsInfoInner', function() {
      // uncomment below and update the code to test PlaceOrderRequestShippingDataLogisticsInfoInner
      //var instance = new CheckoutApi.PlaceOrderRequestShippingDataLogisticsInfoInner();
      //expect(instance).to.be.a(CheckoutApi.PlaceOrderRequestShippingDataLogisticsInfoInner);
    });
