...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.Items200ResponseMarketingData();
  });
  ...
  describe('Items200ResponseMarketingData', function() {
    it('should create an instance of Items200ResponseMarketingData', function() {
      // uncomment below and update the code to test Items200ResponseMarketingData
      //var instance = new CheckoutApi.Items200ResponseMarketingData();
      //expect(instance).to.be.a(CheckoutApi.Items200ResponseMarketingData);
    });
