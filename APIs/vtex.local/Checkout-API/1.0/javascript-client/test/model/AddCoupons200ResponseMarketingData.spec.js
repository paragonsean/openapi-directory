...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddCoupons200ResponseMarketingData();
  });
  ...
  describe('AddCoupons200ResponseMarketingData', function() {
    it('should create an instance of AddCoupons200ResponseMarketingData', function() {
      // uncomment below and update the code to test AddCoupons200ResponseMarketingData
      //var instance = new CheckoutApi.AddCoupons200ResponseMarketingData();
      //expect(instance).to.be.a(CheckoutApi.AddCoupons200ResponseMarketingData);
    });
