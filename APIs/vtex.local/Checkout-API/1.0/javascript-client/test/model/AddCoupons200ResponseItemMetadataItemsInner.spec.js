...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddCoupons200ResponseItemMetadataItemsInner();
  });
  ...
  describe('AddCoupons200ResponseItemMetadataItemsInner', function() {
    it('should create an instance of AddCoupons200ResponseItemMetadataItemsInner', function() {
      // uncomment below and update the code to test AddCoupons200ResponseItemMetadataItemsInner
      //var instance = new CheckoutApi.AddCoupons200ResponseItemMetadataItemsInner();
      //expect(instance).to.be.a(CheckoutApi.AddCoupons200ResponseItemMetadataItemsInner);
    });
