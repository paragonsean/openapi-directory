...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.PlaceOrderRequestMarketingData();
  });
  ...
  describe('PlaceOrderRequestMarketingData', function() {
    it('should create an instance of PlaceOrderRequestMarketingData', function() {
      // uncomment below and update the code to test PlaceOrderRequestMarketingData
      //var instance = new CheckoutApi.PlaceOrderRequestMarketingData();
      //expect(instance).to.be.a(CheckoutApi.PlaceOrderRequestMarketingData);
    });
