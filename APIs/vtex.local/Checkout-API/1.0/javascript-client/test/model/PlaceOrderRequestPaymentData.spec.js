...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.PlaceOrderRequestPaymentData();
  });
  ...
  describe('PlaceOrderRequestPaymentData', function() {
    it('should create an instance of PlaceOrderRequestPaymentData', function() {
      // uncomment below and update the code to test PlaceOrderRequestPaymentData
      //var instance = new CheckoutApi.PlaceOrderRequestPaymentData();
      //expect(instance).to.be.a(CheckoutApi.PlaceOrderRequestPaymentData);
    });
