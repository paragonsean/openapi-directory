...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.PlaceOrderRequestClientProfileData();
  });
  ...
  describe('PlaceOrderRequestClientProfileData', function() {
    it('should create an instance of PlaceOrderRequestClientProfileData', function() {
      // uncomment below and update the code to test PlaceOrderRequestClientProfileData
      //var instance = new CheckoutApi.PlaceOrderRequestClientProfileData();
      //expect(instance).to.be.a(CheckoutApi.PlaceOrderRequestClientProfileData);
    });
