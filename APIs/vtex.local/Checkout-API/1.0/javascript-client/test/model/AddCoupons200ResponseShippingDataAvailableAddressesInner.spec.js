...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddCoupons200ResponseShippingDataAvailableAddressesInner();
  });
  ...
  describe('AddCoupons200ResponseShippingDataAvailableAddressesInner', function() {
    it('should create an instance of AddCoupons200ResponseShippingDataAvailableAddressesInner', function() {
      // uncomment below and update the code to test AddCoupons200ResponseShippingDataAvailableAddressesInner
      //var instance = new CheckoutApi.AddCoupons200ResponseShippingDataAvailableAddressesInner();
      //expect(instance).to.be.a(CheckoutApi.AddCoupons200ResponseShippingDataAvailableAddressesInner);
    });
