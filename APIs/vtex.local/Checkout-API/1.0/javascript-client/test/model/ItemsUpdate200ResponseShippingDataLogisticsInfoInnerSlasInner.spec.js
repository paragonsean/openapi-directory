...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner();
  });
  ...
  describe('ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner', function() {
    it('should create an instance of ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner', function() {
      // uncomment below and update the code to test ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner
      //var instance = new CheckoutApi.ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner();
      //expect(instance).to.be.a(CheckoutApi.ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner);
    });
