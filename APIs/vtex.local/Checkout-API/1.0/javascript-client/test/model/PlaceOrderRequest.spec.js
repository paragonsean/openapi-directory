...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.PlaceOrderRequest();
  });
  ...
  describe('PlaceOrderRequest', function() {
    it('should create an instance of PlaceOrderRequest', function() {
      // uncomment below and update the code to test PlaceOrderRequest
      //var instance = new CheckoutApi.PlaceOrderRequest();
      //expect(instance).to.be.a(CheckoutApi.PlaceOrderRequest);
    });
