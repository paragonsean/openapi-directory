...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddCoupons200ResponseClientProfileData();
  });
  ...
  describe('AddCoupons200ResponseClientProfileData', function() {
    it('should create an instance of AddCoupons200ResponseClientProfileData', function() {
      // uncomment below and update the code to test AddCoupons200ResponseClientProfileData
      //var instance = new CheckoutApi.AddCoupons200ResponseClientProfileData();
      //expect(instance).to.be.a(CheckoutApi.AddCoupons200ResponseClientProfileData);
    });
    ...
    it('should have the property profileCompleteOnLoading (base name: "profileCompleteOnLoading")', function() {
      // uncomment below and update the code to test the property profileCompleteOnLoading
      //var instance = new CheckoutApi.AddCoupons200ResponseClientProfileData();
      //expect(instance).to.be();
    });

    it('should have the property profileErrorOnLoading (base name: "profileErrorOnLoading")', function() {
      // uncomment below and update the code to test the property profileErrorOnLoading
      //var instance = new CheckoutApi.AddCoupons200ResponseClientProfileData();
      //expect(instance).to.be();
    });
