...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.PlaceOrderRequestItemsInner();
  });
  ...
  describe('PlaceOrderRequestItemsInner', function() {
    it('should create an instance of PlaceOrderRequestItemsInner', function() {
      // uncomment below and update the code to test PlaceOrderRequestItemsInner
      //var instance = new CheckoutApi.PlaceOrderRequestItemsInner();
      //expect(instance).to.be.a(CheckoutApi.PlaceOrderRequestItemsInner);
    });
