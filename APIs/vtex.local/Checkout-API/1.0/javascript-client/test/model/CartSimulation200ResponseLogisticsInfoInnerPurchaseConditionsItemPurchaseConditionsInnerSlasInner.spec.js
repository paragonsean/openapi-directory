...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.CartSimulation200ResponseLogisticsInfoInnerPurchaseConditionsItemPurchaseConditionsInnerSlasInner();
  });
  ...
  describe('CartSimulation200ResponseLogisticsInfoInnerPurchaseConditionsItemPurchaseConditionsInnerSlasInner', function() {
    it('should create an instance of CartSimulation200ResponseLogisticsInfoInnerPurchaseConditionsItemPurchaseConditionsInnerSlasInner', function() {
      // uncomment below and update the code to test CartSimulation200ResponseLogisticsInfoInnerPurchaseConditionsItemPurchaseConditionsInnerSlasInner
      //var instance = new CheckoutApi.CartSimulation200ResponseLogisticsInfoInnerPurchaseConditionsItemPurchaseConditionsInnerSlasInner();
      //expect(instance).to.be.a(CheckoutApi.CartSimulation200ResponseLogisticsInfoInnerPurchaseConditionsItemPurchaseConditionsInnerSlasInner);
    });

    it('should have the property availableDeliveryWindows (base name: "availableDeliveryWindows")', function() {
      // uncomment below and update the code to test the property availableDeliveryWindows
      //var instance = new CheckoutApi.CartSimulation200ResponseLogisticsInfoInnerPurchaseConditionsItemPurchaseConditionsInnerSlasInner();
