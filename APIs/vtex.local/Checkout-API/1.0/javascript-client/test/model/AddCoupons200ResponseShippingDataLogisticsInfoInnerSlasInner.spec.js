...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner();
  });
  ...
  describe('AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner', function() {
    it('should create an instance of AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner', function() {
      // uncomment below and update the code to test AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner
      //var instance = new CheckoutApi.AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner();
      //expect(instance).to.be.a(CheckoutApi.AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner);
    });
