...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddPaymentDataRequestPaymentsInner();
  });
  ...
  describe('AddPaymentDataRequestPaymentsInner', function() {
    it('should create an instance of AddPaymentDataRequestPaymentsInner', function() {
      // uncomment below and update the code to test AddPaymentDataRequestPaymentsInner
      //var instance = new CheckoutApi.AddPaymentDataRequestPaymentsInner();
      //expect(instance).to.be.a(CheckoutApi.AddPaymentDataRequestPaymentsInner);
    });
    ...
    it('should have the property hasDefaultBillingAddress (base name: "hasDefaultBillingAddress")', function() {
      // uncomment below and update the code to test the property hasDefaultBillingAddress
      //var instance = new CheckoutApi.AddPaymentDataRequestPaymentsInner();
      //expect(instance).to.be();
    });
