...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.PlaceOrderRequestPaymentDataPaymentSystemsInner();
  });
  ...
  describe('PlaceOrderRequestPaymentDataPaymentSystemsInner', function() {
    it('should create an instance of PlaceOrderRequestPaymentDataPaymentSystemsInner', function() {
      // uncomment below and update the code to test PlaceOrderRequestPaymentDataPaymentSystemsInner
      //var instance = new CheckoutApi.PlaceOrderRequestPaymentDataPaymentSystemsInner();
      //expect(instance).to.be.a(CheckoutApi.PlaceOrderRequestPaymentDataPaymentSystemsInner);
    });
