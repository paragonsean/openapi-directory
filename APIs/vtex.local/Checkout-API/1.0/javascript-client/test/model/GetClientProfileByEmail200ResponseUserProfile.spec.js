...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.GetClientProfileByEmail200ResponseUserProfile();
  });
  ...
  describe('GetClientProfileByEmail200ResponseUserProfile', function() {
    it('should create an instance of GetClientProfileByEmail200ResponseUserProfile', function() {
      // uncomment below and update the code to test GetClientProfileByEmail200ResponseUserProfile
      //var instance = new CheckoutApi.GetClientProfileByEmail200ResponseUserProfile();
      //expect(instance).to.be.a(CheckoutApi.GetClientProfileByEmail200ResponseUserProfile);
    });
