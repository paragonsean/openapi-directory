...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.CartSimulation200ResponsePaymentData();
  });
  ...
  describe('CartSimulation200ResponsePaymentData', function() {
    it('should create an instance of CartSimulation200ResponsePaymentData', function() {
      // uncomment below and update the code to test CartSimulation200ResponsePaymentData
      //var instance = new CheckoutApi.CartSimulation200ResponsePaymentData();
      //expect(instance).to.be.a(CheckoutApi.CartSimulation200ResponsePaymentData);
    });
    ...
    it('should have the property availableAssociations (base name: "availableAssociations")', function() {
      // uncomment below and update the code to test the property availableAssociations
      //var instance = new CheckoutApi.CartSimulation200ResponsePaymentData();
      //expect(instance).to.be();
    });
