...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.CartSimulation200ResponseLogisticsInfoInner();
  });
  ...
  describe('CartSimulation200ResponseLogisticsInfoInner', function() {
    it('should create an instance of CartSimulation200ResponseLogisticsInfoInner', function() {
      // uncomment below and update the code to test CartSimulation200ResponseLogisticsInfoInner
      //var instance = new CheckoutApi.CartSimulation200ResponseLogisticsInfoInner();
      //expect(instance).to.be.a(CheckoutApi.CartSimulation200ResponseLogisticsInfoInner);
    });
    ...
    it('should have the property pickupPoints (base name: "pickupPoints")', function() {
      // uncomment below and update the code to test the property pickupPoints
      //var instance = new CheckoutApi.CartSimulation200ResponseLogisticsInfoInner();
      //expect(instance).to.be();
    });

    it('should have the property purchaseConditions (base name: "purchaseConditions")', function() {
      // uncomment below and update the code to test the property purchaseConditions
      //var instance = new CheckoutApi.CartSimulation200ResponseLogisticsInfoInner();
      //expect(instance).to.be();
    });
