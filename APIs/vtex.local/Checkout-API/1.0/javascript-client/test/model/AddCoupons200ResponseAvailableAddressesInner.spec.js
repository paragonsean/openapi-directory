...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddCoupons200ResponseAvailableAddressesInner();
  });
  ...
  describe('AddCoupons200ResponseAvailableAddressesInner', function() {
    it('should create an instance of AddCoupons200ResponseAvailableAddressesInner', function() {
      // uncomment below and update the code to test AddCoupons200ResponseAvailableAddressesInner
      //var instance = new CheckoutApi.AddCoupons200ResponseAvailableAddressesInner();
      //expect(instance).to.be.a(CheckoutApi.AddCoupons200ResponseAvailableAddressesInner);
    });
