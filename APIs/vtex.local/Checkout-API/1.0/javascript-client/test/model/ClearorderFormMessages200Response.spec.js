...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.ClearorderFormMessages200Response();
  });
  ...
  describe('ClearorderFormMessages200Response', function() {
    it('should create an instance of ClearorderFormMessages200Response', function() {
      // uncomment below and update the code to test ClearorderFormMessages200Response
      //var instance = new CheckoutApi.ClearorderFormMessages200Response();
      //expect(instance).to.be.a(CheckoutApi.ClearorderFormMessages200Response);
    });
