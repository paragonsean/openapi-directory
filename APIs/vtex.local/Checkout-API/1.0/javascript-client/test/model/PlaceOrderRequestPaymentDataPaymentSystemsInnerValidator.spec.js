...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.PlaceOrderRequestPaymentDataPaymentSystemsInnerValidator();
  });
  ...
  describe('PlaceOrderRequestPaymentDataPaymentSystemsInnerValidator', function() {
    it('should create an instance of PlaceOrderRequestPaymentDataPaymentSystemsInnerValidator', function() {
      // uncomment below and update the code to test PlaceOrderRequestPaymentDataPaymentSystemsInnerValidator
      //var instance = new CheckoutApi.PlaceOrderRequestPaymentDataPaymentSystemsInnerValidator();
      //expect(instance).to.be.a(CheckoutApi.PlaceOrderRequestPaymentDataPaymentSystemsInnerValidator);
    });
