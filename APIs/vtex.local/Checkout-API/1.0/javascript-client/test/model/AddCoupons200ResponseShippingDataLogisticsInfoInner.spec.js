...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddCoupons200ResponseShippingDataLogisticsInfoInner();
  });
  ...
  describe('AddCoupons200ResponseShippingDataLogisticsInfoInner', function() {
    it('should create an instance of AddCoupons200ResponseShippingDataLogisticsInfoInner', function() {
      // uncomment below and update the code to test AddCoupons200ResponseShippingDataLogisticsInfoInner
      //var instance = new CheckoutApi.AddCoupons200ResponseShippingDataLogisticsInfoInner();
      //expect(instance).to.be.a(CheckoutApi.AddCoupons200ResponseShippingDataLogisticsInfoInner);
    });
