...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.PlaceOrder200ResponseOrdersInnerItemsInner();
  });
  ...
  describe('PlaceOrder200ResponseOrdersInnerItemsInner', function() {
    it('should create an instance of PlaceOrder200ResponseOrdersInnerItemsInner', function() {
      // uncomment below and update the code to test PlaceOrder200ResponseOrdersInnerItemsInner
      //var instance = new CheckoutApi.PlaceOrder200ResponseOrdersInnerItemsInner();
      //expect(instance).to.be.a(CheckoutApi.PlaceOrder200ResponseOrdersInnerItemsInner);
    });
