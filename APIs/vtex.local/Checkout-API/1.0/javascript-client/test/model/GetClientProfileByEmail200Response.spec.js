...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.GetClientProfileByEmail200Response();
  });
  ...
  describe('GetClientProfileByEmail200Response', function() {
    it('should create an instance of GetClientProfileByEmail200Response', function() {
      // uncomment below and update the code to test GetClientProfileByEmail200Response
      //var instance = new CheckoutApi.GetClientProfileByEmail200Response();
      //expect(instance).to.be.a(CheckoutApi.GetClientProfileByEmail200Response);
    });
