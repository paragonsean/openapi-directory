...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.ClearorderFormMessages200ResponseMarketingData();
  });
  ...
  describe('ClearorderFormMessages200ResponseMarketingData', function() {
    it('should create an instance of ClearorderFormMessages200ResponseMarketingData', function() {
      // uncomment below and update the code to test ClearorderFormMessages200ResponseMarketingData
      //var instance = new CheckoutApi.ClearorderFormMessages200ResponseMarketingData();
      //expect(instance).to.be.a(CheckoutApi.ClearorderFormMessages200ResponseMarketingData);
    });
