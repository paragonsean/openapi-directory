...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.ItemsUpdate200ResponseShippingDataAvailableAddressesInner();
  });
  ...
  describe('ItemsUpdate200ResponseShippingDataAvailableAddressesInner', function() {
    it('should create an instance of ItemsUpdate200ResponseShippingDataAvailableAddressesInner', function() {
      // uncomment below and update the code to test ItemsUpdate200ResponseShippingDataAvailableAddressesInner
      //var instance = new CheckoutApi.ItemsUpdate200ResponseShippingDataAvailableAddressesInner();
      //expect(instance).to.be.a(CheckoutApi.ItemsUpdate200ResponseShippingDataAvailableAddressesInner);
    });
