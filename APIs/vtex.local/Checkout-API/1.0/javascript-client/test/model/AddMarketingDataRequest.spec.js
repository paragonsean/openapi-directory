...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddMarketingDataRequest();
  });
  ...
  describe('AddMarketingDataRequest', function() {
    it('should create an instance of AddMarketingDataRequest', function() {
      // uncomment below and update the code to test AddMarketingDataRequest
      //var instance = new CheckoutApi.AddMarketingDataRequest();
      //expect(instance).to.be.a(CheckoutApi.AddMarketingDataRequest);
    });
