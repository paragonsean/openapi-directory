...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.PlaceOrderRequestShippingDataAddress();
  });
  ...
  describe('PlaceOrderRequestShippingDataAddress', function() {
    it('should create an instance of PlaceOrderRequestShippingDataAddress', function() {
      // uncomment below and update the code to test PlaceOrderRequestShippingDataAddress
      //var instance = new CheckoutApi.PlaceOrderRequestShippingDataAddress();
      //expect(instance).to.be.a(CheckoutApi.PlaceOrderRequestShippingDataAddress);
    });
