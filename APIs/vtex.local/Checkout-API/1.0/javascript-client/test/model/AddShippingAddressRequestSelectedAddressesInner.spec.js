...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddShippingAddressRequestSelectedAddressesInner();
  });
  ...
  describe('AddShippingAddressRequestSelectedAddressesInner', function() {
    it('should create an instance of AddShippingAddressRequestSelectedAddressesInner', function() {
      // uncomment below and update the code to test AddShippingAddressRequestSelectedAddressesInner
      //var instance = new CheckoutApi.AddShippingAddressRequestSelectedAddressesInner();
      //expect(instance).to.be.a(CheckoutApi.AddShippingAddressRequestSelectedAddressesInner);
    });
