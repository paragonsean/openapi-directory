...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddCoupons200ResponseShippingDataAddress();
  });
  ...
  describe('AddCoupons200ResponseShippingDataAddress', function() {
    it('should create an instance of AddCoupons200ResponseShippingDataAddress', function() {
      // uncomment below and update the code to test AddCoupons200ResponseShippingDataAddress
      //var instance = new CheckoutApi.AddCoupons200ResponseShippingDataAddress();
      //expect(instance).to.be.a(CheckoutApi.AddCoupons200ResponseShippingDataAddress);
    });
