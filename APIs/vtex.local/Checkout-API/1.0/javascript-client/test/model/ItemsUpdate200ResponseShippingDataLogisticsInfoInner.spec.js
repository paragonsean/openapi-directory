...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.ItemsUpdate200ResponseShippingDataLogisticsInfoInner();
  });
  ...
  describe('ItemsUpdate200ResponseShippingDataLogisticsInfoInner', function() {
    it('should create an instance of ItemsUpdate200ResponseShippingDataLogisticsInfoInner', function() {
      // uncomment below and update the code to test ItemsUpdate200ResponseShippingDataLogisticsInfoInner
      //var instance = new CheckoutApi.ItemsUpdate200ResponseShippingDataLogisticsInfoInner();
      //expect(instance).to.be.a(CheckoutApi.ItemsUpdate200ResponseShippingDataLogisticsInfoInner);
    });
