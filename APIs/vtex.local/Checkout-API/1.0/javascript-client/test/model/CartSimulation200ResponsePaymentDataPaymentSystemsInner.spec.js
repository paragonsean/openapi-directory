...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.CartSimulation200ResponsePaymentDataPaymentSystemsInner();
  });
  ...
  describe('CartSimulation200ResponsePaymentDataPaymentSystemsInner', function() {
    it('should create an instance of CartSimulation200ResponsePaymentDataPaymentSystemsInner', function() {
      // uncomment below and update the code to test CartSimulation200ResponsePaymentDataPaymentSystemsInner
      //var instance = new CheckoutApi.CartSimulation200ResponsePaymentDataPaymentSystemsInner();
      //expect(instance).to.be.a(CheckoutApi.CartSimulation200ResponsePaymentDataPaymentSystemsInner);
    });
    ...
    it('should have the property displayDocument (base name: "displayDocument")', function() {
      // uncomment below and update the code to test the property displayDocument
      //var instance = new CheckoutApi.CartSimulation200ResponsePaymentDataPaymentSystemsInner();
      //expect(instance).to.be();
    });
