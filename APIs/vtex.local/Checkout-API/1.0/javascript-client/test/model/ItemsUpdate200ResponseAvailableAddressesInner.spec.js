...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.ItemsUpdate200ResponseAvailableAddressesInner();
  });
  ...
  describe('ItemsUpdate200ResponseAvailableAddressesInner', function() {
    it('should create an instance of ItemsUpdate200ResponseAvailableAddressesInner', function() {
      // uncomment below and update the code to test ItemsUpdate200ResponseAvailableAddressesInner
      //var instance = new CheckoutApi.ItemsUpdate200ResponseAvailableAddressesInner();
      //expect(instance).to.be.a(CheckoutApi.ItemsUpdate200ResponseAvailableAddressesInner);
    });
