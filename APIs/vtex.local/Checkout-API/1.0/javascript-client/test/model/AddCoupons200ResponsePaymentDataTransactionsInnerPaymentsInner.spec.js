...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddCoupons200ResponsePaymentDataTransactionsInnerPaymentsInner();
  });
  ...
  describe('AddCoupons200ResponsePaymentDataTransactionsInnerPaymentsInner', function() {
    it('should create an instance of AddCoupons200ResponsePaymentDataTransactionsInnerPaymentsInner', function() {
      // uncomment below and update the code to test AddCoupons200ResponsePaymentDataTransactionsInnerPaymentsInner
      //var instance = new CheckoutApi.AddCoupons200ResponsePaymentDataTransactionsInnerPaymentsInner();
      //expect(instance).to.be.a(CheckoutApi.AddCoupons200ResponsePaymentDataTransactionsInnerPaymentsInner);
    });
