...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutApi.AddClientProfileRequest();
  });
  ...
  describe('AddClientProfileRequest', function() {
    it('should create an instance of AddClientProfileRequest', function() {
      // uncomment below and update the code to test AddClientProfileRequest
      //var instance = new CheckoutApi.AddClientProfileRequest();
      //expect(instance).to.be.a(CheckoutApi.AddClientProfileRequest);
    });
