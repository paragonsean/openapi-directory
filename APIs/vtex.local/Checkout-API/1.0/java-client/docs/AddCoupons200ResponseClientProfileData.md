...
|**document** | **String** | Document informed by the customer. |  [optional] |
|**documentType** | **String** | Type of the document informed by the customer. |  [optional] |
|**email** | **String** | Email address. |  [optional] |
|**firstName** | **String** | First name. |  [optional] |
|**isCorporate** | **Boolean** | Indicates whether the customer is a legal entity. |  [optional] |
|**lastName** | **String** | Last name. |  [optional] |
|**phone** | **String** | Phone number. |  [optional] |
|**profileCompleteOnLoading** | **Boolean** | Indicates whether profile is complete on loading. |  [optional] |
|**profileErrorOnLoading** | **Boolean** | Indicates whether profile presents error on loading. |  [optional] |
