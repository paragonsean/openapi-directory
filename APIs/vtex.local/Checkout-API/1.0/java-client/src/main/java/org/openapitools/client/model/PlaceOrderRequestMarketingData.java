...
public class PlaceOrderRequestMarketingData {
  ...
  public PlaceOrderRequestMarketingData() {
  }

  public PlaceOrderRequestMarketingData coupon(String coupon) {
    this.coupon = coupon;
    return this;
  }
  ...
  public PlaceOrderRequestMarketingData utmCampaign(String utmCampaign) {
  ...
  public PlaceOrderRequestMarketingData utmMedium(String utmMedium) {
  ...
  public PlaceOrderRequestMarketingData utmSource(String utmSource) {
  ...
  public PlaceOrderRequestMarketingData utmiCampaign(String utmiCampaign) {
  ...
  public PlaceOrderRequestMarketingData utmiPage(String utmiPage) {
  ...
  public PlaceOrderRequestMarketingData utmiPart(String utmiPart) {
  ...
  public boolean equals(Object o) {
    ...
    PlaceOrderRequestMarketingData placeOrderRequestMarketingData = (PlaceOrderRequestMarketingData) o;
    return Objects.equals(this.coupon, placeOrderRequestMarketingData.coupon) &&
        Objects.equals(this.utmCampaign, placeOrderRequestMarketingData.utmCampaign) &&
        Objects.equals(this.utmMedium, placeOrderRequestMarketingData.utmMedium) &&
        Objects.equals(this.utmSource, placeOrderRequestMarketingData.utmSource) &&
        Objects.equals(this.utmiCampaign, placeOrderRequestMarketingData.utmiCampaign) &&
        Objects.equals(this.utmiPage, placeOrderRequestMarketingData.utmiPage) &&
        Objects.equals(this.utmiPart, placeOrderRequestMarketingData.utmiPart);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlaceOrderRequestMarketingData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlaceOrderRequestMarketingData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlaceOrderRequestMarketingData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlaceOrderRequestMarketingData is not found in the empty JSON string", PlaceOrderRequestMarketingData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlaceOrderRequestMarketingData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlaceOrderRequestMarketingData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlaceOrderRequestMarketingData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlaceOrderRequestMarketingData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlaceOrderRequestMarketingData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlaceOrderRequestMarketingData.class));

       return (TypeAdapter<T>) new TypeAdapter<PlaceOrderRequestMarketingData>() {
           @Override
           public void write(JsonWriter out, PlaceOrderRequestMarketingData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlaceOrderRequestMarketingData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlaceOrderRequestMarketingData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlaceOrderRequestMarketingData
   * @throws IOException if the JSON string is invalid with respect to PlaceOrderRequestMarketingData
   */
  public static PlaceOrderRequestMarketingData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlaceOrderRequestMarketingData.class);
  }

  /**
   * Convert an instance of PlaceOrderRequestMarketingData to an JSON string
   *
   * @return JSON string
   */
