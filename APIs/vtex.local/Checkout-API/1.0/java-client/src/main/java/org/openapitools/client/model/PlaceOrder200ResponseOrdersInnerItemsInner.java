...
public class PlaceOrder200ResponseOrdersInnerItemsInner {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner() {
  }

  public PlaceOrder200ResponseOrdersInnerItemsInner additionalInfo(AddCoupons200ResponseItemsInnerAdditionalInfo additionalInfo) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner attachments(List<String> attachments) {
    this.attachments = attachments;
    return this;
  }

  public PlaceOrder200ResponseOrdersInnerItemsInner addAttachmentsItem(String attachmentsItem) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner availability(String availability) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner bundleItems(List<AddCoupons200ResponseItemsInnerBundleItemsInner> bundleItems) {
    this.bundleItems = bundleItems;
    return this;
  }

  public PlaceOrder200ResponseOrdersInnerItemsInner addBundleItemsItem(AddCoupons200ResponseItemsInnerBundleItemsInner bundleItemsItem) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner detailUrl(String detailUrl) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner ean(String ean) {
    this.ean = ean;
    return this;
  }
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner imageUrl(String imageUrl) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner isGift(Boolean isGift) {
    this.isGift = isGift;
    return this;
  }
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner listPrice(Integer listPrice) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner manualPrice(Integer manualPrice) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner manualPriceAppliedBy(String manualPriceAppliedBy) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner manufacturerCode(String manufacturerCode) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner measurementUnit(String measurementUnit) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner modalType(String modalType) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner parentAssemblyBinding(String parentAssemblyBinding) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner parentItemIndex(Integer parentItemIndex) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner preSaleDate(String preSaleDate) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner price(Integer price) {
    this.price = price;
    return this;
  }
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner priceDefinition(AddCoupons200ResponseItemsInnerPriceDefinition priceDefinition) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner priceTags(List<AddCoupons200ResponseItemsInnerPriceTagsInner> priceTags) {
    this.priceTags = priceTags;
    return this;
  }

  public PlaceOrder200ResponseOrdersInnerItemsInner addPriceTagsItem(AddCoupons200ResponseItemsInnerPriceTagsInner priceTagsItem) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner priceValidUntil(String priceValidUntil) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner productCategories(AddCoupons200ResponseItemsInnerProductCategories productCategories) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner productCategoryIds(String productCategoryIds) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner productId(String productId) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner productRefId(String productRefId) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner quantity(Integer quantity) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner refId(String refId) {
    this.refId = refId;
    return this;
  }
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner rewardValue(Integer rewardValue) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner seller(String seller) {
    this.seller = seller;
    return this;
  }
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner sellerChain(List<String> sellerChain) {
    this.sellerChain = sellerChain;
    return this;
  }

  public PlaceOrder200ResponseOrdersInnerItemsInner addSellerChainItem(String sellerChainItem) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner sellingPrice(Integer sellingPrice) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner skuName(String skuName) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner tax(Integer tax) {
    this.tax = tax;
    return this;
  }
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner uniqueId(String uniqueId) {
  ...
  public PlaceOrder200ResponseOrdersInnerItemsInner unitMultiplier(Integer unitMultiplier) {
  ...
  public boolean equals(Object o) {
    ...
    PlaceOrder200ResponseOrdersInnerItemsInner placeOrder200ResponseOrdersInnerItemsInner = (PlaceOrder200ResponseOrdersInnerItemsInner) o;
    return Objects.equals(this.additionalInfo, placeOrder200ResponseOrdersInnerItemsInner.additionalInfo) &&
        Objects.equals(this.attachments, placeOrder200ResponseOrdersInnerItemsInner.attachments) &&
        Objects.equals(this.availability, placeOrder200ResponseOrdersInnerItemsInner.availability) &&
        Objects.equals(this.bundleItems, placeOrder200ResponseOrdersInnerItemsInner.bundleItems) &&
        Objects.equals(this.detailUrl, placeOrder200ResponseOrdersInnerItemsInner.detailUrl) &&
        Objects.equals(this.ean, placeOrder200ResponseOrdersInnerItemsInner.ean) &&
        Objects.equals(this.id, placeOrder200ResponseOrdersInnerItemsInner.id) &&
        Objects.equals(this.imageUrl, placeOrder200ResponseOrdersInnerItemsInner.imageUrl) &&
        Objects.equals(this.isGift, placeOrder200ResponseOrdersInnerItemsInner.isGift) &&
        Objects.equals(this.listPrice, placeOrder200ResponseOrdersInnerItemsInner.listPrice) &&
        Objects.equals(this.manualPrice, placeOrder200ResponseOrdersInnerItemsInner.manualPrice) &&
        Objects.equals(this.manualPriceAppliedBy, placeOrder200ResponseOrdersInnerItemsInner.manualPriceAppliedBy) &&
        Objects.equals(this.manufacturerCode, placeOrder200ResponseOrdersInnerItemsInner.manufacturerCode) &&
        Objects.equals(this.measurementUnit, placeOrder200ResponseOrdersInnerItemsInner.measurementUnit) &&
        Objects.equals(this.modalType, placeOrder200ResponseOrdersInnerItemsInner.modalType) &&
        Objects.equals(this.name, placeOrder200ResponseOrdersInnerItemsInner.name) &&
        Objects.equals(this.parentAssemblyBinding, placeOrder200ResponseOrdersInnerItemsInner.parentAssemblyBinding) &&
        Objects.equals(this.parentItemIndex, placeOrder200ResponseOrdersInnerItemsInner.parentItemIndex) &&
        Objects.equals(this.preSaleDate, placeOrder200ResponseOrdersInnerItemsInner.preSaleDate) &&
        Objects.equals(this.price, placeOrder200ResponseOrdersInnerItemsInner.price) &&
        Objects.equals(this.priceDefinition, placeOrder200ResponseOrdersInnerItemsInner.priceDefinition) &&
        Objects.equals(this.priceTags, placeOrder200ResponseOrdersInnerItemsInner.priceTags) &&
        Objects.equals(this.priceValidUntil, placeOrder200ResponseOrdersInnerItemsInner.priceValidUntil) &&
        Objects.equals(this.productCategories, placeOrder200ResponseOrdersInnerItemsInner.productCategories) &&
        Objects.equals(this.productCategoryIds, placeOrder200ResponseOrdersInnerItemsInner.productCategoryIds) &&
        Objects.equals(this.productId, placeOrder200ResponseOrdersInnerItemsInner.productId) &&
        Objects.equals(this.productRefId, placeOrder200ResponseOrdersInnerItemsInner.productRefId) &&
        Objects.equals(this.quantity, placeOrder200ResponseOrdersInnerItemsInner.quantity) &&
        Objects.equals(this.refId, placeOrder200ResponseOrdersInnerItemsInner.refId) &&
        Objects.equals(this.rewardValue, placeOrder200ResponseOrdersInnerItemsInner.rewardValue) &&
        Objects.equals(this.seller, placeOrder200ResponseOrdersInnerItemsInner.seller) &&
        Objects.equals(this.sellerChain, placeOrder200ResponseOrdersInnerItemsInner.sellerChain) &&
        Objects.equals(this.sellingPrice, placeOrder200ResponseOrdersInnerItemsInner.sellingPrice) &&
        Objects.equals(this.skuName, placeOrder200ResponseOrdersInnerItemsInner.skuName) &&
        Objects.equals(this.tax, placeOrder200ResponseOrdersInnerItemsInner.tax) &&
        Objects.equals(this.uniqueId, placeOrder200ResponseOrdersInnerItemsInner.uniqueId) &&
        Objects.equals(this.unitMultiplier, placeOrder200ResponseOrdersInnerItemsInner.unitMultiplier);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlaceOrder200ResponseOrdersInnerItemsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlaceOrder200ResponseOrdersInnerItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlaceOrder200ResponseOrdersInnerItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlaceOrder200ResponseOrdersInnerItemsInner is not found in the empty JSON string", PlaceOrder200ResponseOrdersInnerItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlaceOrder200ResponseOrdersInnerItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlaceOrder200ResponseOrdersInnerItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlaceOrder200ResponseOrdersInnerItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlaceOrder200ResponseOrdersInnerItemsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlaceOrder200ResponseOrdersInnerItemsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlaceOrder200ResponseOrdersInnerItemsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PlaceOrder200ResponseOrdersInnerItemsInner>() {
           @Override
           public void write(JsonWriter out, PlaceOrder200ResponseOrdersInnerItemsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlaceOrder200ResponseOrdersInnerItemsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlaceOrder200ResponseOrdersInnerItemsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlaceOrder200ResponseOrdersInnerItemsInner
   * @throws IOException if the JSON string is invalid with respect to PlaceOrder200ResponseOrdersInnerItemsInner
   */
  public static PlaceOrder200ResponseOrdersInnerItemsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlaceOrder200ResponseOrdersInnerItemsInner.class);
  }

  /**
   * Convert an instance of PlaceOrder200ResponseOrdersInnerItemsInner to an JSON string
   *
   * @return JSON string
   */
