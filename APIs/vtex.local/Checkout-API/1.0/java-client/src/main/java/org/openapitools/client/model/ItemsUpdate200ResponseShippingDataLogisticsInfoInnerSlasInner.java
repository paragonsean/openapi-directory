...
import org.openapitools.client.model.ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInnerPickupStoreInfo;
...
public class ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner {
  ...
  private ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInnerPickupStoreInfo pickupStoreInfo;
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner() {
  }

  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner deliveryChannel(String deliveryChannel) {
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner deliveryIds(List<AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInnerDeliveryIdsInner> deliveryIds) {
    this.deliveryIds = deliveryIds;
    return this;
  }

  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner addDeliveryIdsItem(AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInnerDeliveryIdsInner deliveryIdsItem) {
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner listPrice(Integer listPrice) {
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner lockTTL(String lockTTL) {
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner pickupDistance(Integer pickupDistance) {
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner pickupPointId(String pickupPointId) {
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner pickupStoreInfo(ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInnerPickupStoreInfo pickupStoreInfo) {
   ...
   */
  @javax.annotation.Nullable
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInnerPickupStoreInfo getPickupStoreInfo() {
    return pickupStoreInfo;
  }

  public void setPickupStoreInfo(ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInnerPickupStoreInfo pickupStoreInfo) {
    this.pickupStoreInfo = pickupStoreInfo;
  }


  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner polygonName(String polygonName) {
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner price(Integer price) {
    this.price = price;
    return this;
  }
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner shippingEstimate(String shippingEstimate) {
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner shippingEstimateDate(String shippingEstimateDate) {
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner tax(Integer tax) {
    this.tax = tax;
    return this;
  }
  ...
  public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner transitTime(String transitTime) {
  ...
  public boolean equals(Object o) {
    ...
    ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner = (ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner) o;
    return Objects.equals(this.deliveryChannel, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.deliveryChannel) &&
        Objects.equals(this.deliveryIds, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.deliveryIds) &&
        Objects.equals(this.id, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.id) &&
        Objects.equals(this.listPrice, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.listPrice) &&
        Objects.equals(this.lockTTL, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.lockTTL) &&
        Objects.equals(this.name, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.name) &&
        Objects.equals(this.pickupDistance, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.pickupDistance) &&
        Objects.equals(this.pickupPointId, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.pickupPointId) &&
        Objects.equals(this.pickupStoreInfo, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.pickupStoreInfo) &&
        Objects.equals(this.polygonName, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.polygonName) &&
        Objects.equals(this.price, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.price) &&
        Objects.equals(this.shippingEstimate, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.shippingEstimate) &&
        Objects.equals(this.shippingEstimateDate, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.shippingEstimateDate) &&
        Objects.equals(this.tax, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.tax) &&
        Objects.equals(this.transitTime, itemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.transitTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner is not found in the empty JSON string", ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("pickupStoreInfo") != null && !jsonObj.get("pickupStoreInfo").isJsonNull()) {
        ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInnerPickupStoreInfo.validateJsonElement(jsonObj.get("pickupStoreInfo"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner>() {
           @Override
           public void write(JsonWriter out, ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner
   * @throws IOException if the JSON string is invalid with respect to ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner
   */
  public static ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner.class);
  }

  /**
   * Convert an instance of ItemsUpdate200ResponseShippingDataLogisticsInfoInnerSlasInner to an JSON string
   *
   * @return JSON string
   */
