...
public class Items200ResponseItemsInner {
  ...
  public Items200ResponseItemsInner() {
  }

  public Items200ResponseItemsInner additionalInfo(AddCoupons200ResponseItemsInnerAdditionalInfo additionalInfo) {
  ...
  public Items200ResponseItemsInner attachments(List<String> attachments) {
    this.attachments = attachments;
    return this;
  }

  public Items200ResponseItemsInner addAttachmentsItem(String attachmentsItem) {
  ...
  public Items200ResponseItemsInner availability(String availability) {
  ...
  public Items200ResponseItemsInner bundleItems(List<AddCoupons200ResponseItemsInnerBundleItemsInner> bundleItems) {
    this.bundleItems = bundleItems;
    return this;
  }

  public Items200ResponseItemsInner addBundleItemsItem(AddCoupons200ResponseItemsInnerBundleItemsInner bundleItemsItem) {
  ...
  public Items200ResponseItemsInner detailUrl(String detailUrl) {
  ...
  public Items200ResponseItemsInner ean(String ean) {
    this.ean = ean;
    return this;
  }
  ...
  public Items200ResponseItemsInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Items200ResponseItemsInner imageUrl(String imageUrl) {
  ...
  public Items200ResponseItemsInner isGift(Boolean isGift) {
    this.isGift = isGift;
    return this;
  }
  ...
  public Items200ResponseItemsInner listPrice(Integer listPrice) {
  ...
  public Items200ResponseItemsInner manualPrice(Integer manualPrice) {
  ...
  public Items200ResponseItemsInner manualPriceAppliedBy(String manualPriceAppliedBy) {
  ...
  public Items200ResponseItemsInner manufacturerCode(String manufacturerCode) {
  ...
  public Items200ResponseItemsInner measurementUnit(String measurementUnit) {
  ...
  public Items200ResponseItemsInner modalType(String modalType) {
  ...
  public Items200ResponseItemsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Items200ResponseItemsInner parentAssemblyBinding(String parentAssemblyBinding) {
  ...
  public Items200ResponseItemsInner parentItemIndex(Integer parentItemIndex) {
  ...
  public Items200ResponseItemsInner preSaleDate(String preSaleDate) {
  ...
  public Items200ResponseItemsInner price(Integer price) {
    this.price = price;
    return this;
  }
  ...
  public Items200ResponseItemsInner priceDefinition(AddCoupons200ResponseItemsInnerPriceDefinition priceDefinition) {
  ...
  public Items200ResponseItemsInner priceTags(List<AddCoupons200ResponseItemsInnerPriceTagsInner> priceTags) {
    this.priceTags = priceTags;
    return this;
  }

  public Items200ResponseItemsInner addPriceTagsItem(AddCoupons200ResponseItemsInnerPriceTagsInner priceTagsItem) {
  ...
  public Items200ResponseItemsInner priceValidUntil(String priceValidUntil) {
  ...
  public Items200ResponseItemsInner productCategories(AddCoupons200ResponseItemsInnerProductCategories productCategories) {
  ...
  public Items200ResponseItemsInner productCategoryIds(String productCategoryIds) {
  ...
  public Items200ResponseItemsInner productId(String productId) {
  ...
  public Items200ResponseItemsInner productRefId(String productRefId) {
  ...
  public Items200ResponseItemsInner quantity(Integer quantity) {
  ...
  public Items200ResponseItemsInner refId(String refId) {
    this.refId = refId;
    return this;
  }
  ...
  public Items200ResponseItemsInner rewardValue(Integer rewardValue) {
  ...
  public Items200ResponseItemsInner seller(String seller) {
    this.seller = seller;
    return this;
  }
  ...
  public Items200ResponseItemsInner sellerChain(List<String> sellerChain) {
    this.sellerChain = sellerChain;
    return this;
  }

  public Items200ResponseItemsInner addSellerChainItem(String sellerChainItem) {
  ...
  public Items200ResponseItemsInner sellingPrice(Integer sellingPrice) {
  ...
  public Items200ResponseItemsInner skuName(String skuName) {
  ...
  public Items200ResponseItemsInner tax(Integer tax) {
    this.tax = tax;
    return this;
  }
  ...
  public Items200ResponseItemsInner uniqueId(String uniqueId) {
  ...
  public Items200ResponseItemsInner unitMultiplier(Integer unitMultiplier) {
  ...
  public boolean equals(Object o) {
    ...
    Items200ResponseItemsInner items200ResponseItemsInner = (Items200ResponseItemsInner) o;
    return Objects.equals(this.additionalInfo, items200ResponseItemsInner.additionalInfo) &&
        Objects.equals(this.attachments, items200ResponseItemsInner.attachments) &&
        Objects.equals(this.availability, items200ResponseItemsInner.availability) &&
        Objects.equals(this.bundleItems, items200ResponseItemsInner.bundleItems) &&
        Objects.equals(this.detailUrl, items200ResponseItemsInner.detailUrl) &&
        Objects.equals(this.ean, items200ResponseItemsInner.ean) &&
        Objects.equals(this.id, items200ResponseItemsInner.id) &&
        Objects.equals(this.imageUrl, items200ResponseItemsInner.imageUrl) &&
        Objects.equals(this.isGift, items200ResponseItemsInner.isGift) &&
        Objects.equals(this.listPrice, items200ResponseItemsInner.listPrice) &&
        Objects.equals(this.manualPrice, items200ResponseItemsInner.manualPrice) &&
        Objects.equals(this.manualPriceAppliedBy, items200ResponseItemsInner.manualPriceAppliedBy) &&
        Objects.equals(this.manufacturerCode, items200ResponseItemsInner.manufacturerCode) &&
        Objects.equals(this.measurementUnit, items200ResponseItemsInner.measurementUnit) &&
        Objects.equals(this.modalType, items200ResponseItemsInner.modalType) &&
        Objects.equals(this.name, items200ResponseItemsInner.name) &&
        Objects.equals(this.parentAssemblyBinding, items200ResponseItemsInner.parentAssemblyBinding) &&
        Objects.equals(this.parentItemIndex, items200ResponseItemsInner.parentItemIndex) &&
        Objects.equals(this.preSaleDate, items200ResponseItemsInner.preSaleDate) &&
        Objects.equals(this.price, items200ResponseItemsInner.price) &&
        Objects.equals(this.priceDefinition, items200ResponseItemsInner.priceDefinition) &&
        Objects.equals(this.priceTags, items200ResponseItemsInner.priceTags) &&
        Objects.equals(this.priceValidUntil, items200ResponseItemsInner.priceValidUntil) &&
        Objects.equals(this.productCategories, items200ResponseItemsInner.productCategories) &&
        Objects.equals(this.productCategoryIds, items200ResponseItemsInner.productCategoryIds) &&
        Objects.equals(this.productId, items200ResponseItemsInner.productId) &&
        Objects.equals(this.productRefId, items200ResponseItemsInner.productRefId) &&
        Objects.equals(this.quantity, items200ResponseItemsInner.quantity) &&
        Objects.equals(this.refId, items200ResponseItemsInner.refId) &&
        Objects.equals(this.rewardValue, items200ResponseItemsInner.rewardValue) &&
        Objects.equals(this.seller, items200ResponseItemsInner.seller) &&
        Objects.equals(this.sellerChain, items200ResponseItemsInner.sellerChain) &&
        Objects.equals(this.sellingPrice, items200ResponseItemsInner.sellingPrice) &&
        Objects.equals(this.skuName, items200ResponseItemsInner.skuName) &&
        Objects.equals(this.tax, items200ResponseItemsInner.tax) &&
        Objects.equals(this.uniqueId, items200ResponseItemsInner.uniqueId) &&
        Objects.equals(this.unitMultiplier, items200ResponseItemsInner.unitMultiplier);
  }
  ...
  public String toString() {
    ...
    sb.append("class Items200ResponseItemsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Items200ResponseItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Items200ResponseItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Items200ResponseItemsInner is not found in the empty JSON string", Items200ResponseItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Items200ResponseItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Items200ResponseItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Items200ResponseItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Items200ResponseItemsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Items200ResponseItemsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Items200ResponseItemsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Items200ResponseItemsInner>() {
           @Override
           public void write(JsonWriter out, Items200ResponseItemsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Items200ResponseItemsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Items200ResponseItemsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Items200ResponseItemsInner
   * @throws IOException if the JSON string is invalid with respect to Items200ResponseItemsInner
   */
  public static Items200ResponseItemsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Items200ResponseItemsInner.class);
  }

  /**
   * Convert an instance of Items200ResponseItemsInner to an JSON string
   *
   * @return JSON string
   */
