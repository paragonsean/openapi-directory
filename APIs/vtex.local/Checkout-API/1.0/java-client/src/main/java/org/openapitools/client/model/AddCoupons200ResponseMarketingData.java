...
public class AddCoupons200ResponseMarketingData {
  ...
  public AddCoupons200ResponseMarketingData() {
  }

  public AddCoupons200ResponseMarketingData coupon(String coupon) {
    this.coupon = coupon;
    return this;
  }
  ...
  public AddCoupons200ResponseMarketingData utmCampaign(String utmCampaign) {
  ...
  public AddCoupons200ResponseMarketingData utmMedium(String utmMedium) {
  ...
  public AddCoupons200ResponseMarketingData utmSource(String utmSource) {
  ...
  public AddCoupons200ResponseMarketingData utmiCampaign(String utmiCampaign) {
  ...
  public AddCoupons200ResponseMarketingData utmiPage(String utmiPage) {
  ...
  public AddCoupons200ResponseMarketingData utmiPart(String utmiPart) {
  ...
  public boolean equals(Object o) {
    ...
    AddCoupons200ResponseMarketingData addCoupons200ResponseMarketingData = (AddCoupons200ResponseMarketingData) o;
    return Objects.equals(this.coupon, addCoupons200ResponseMarketingData.coupon) &&
        Objects.equals(this.utmCampaign, addCoupons200ResponseMarketingData.utmCampaign) &&
        Objects.equals(this.utmMedium, addCoupons200ResponseMarketingData.utmMedium) &&
        Objects.equals(this.utmSource, addCoupons200ResponseMarketingData.utmSource) &&
        Objects.equals(this.utmiCampaign, addCoupons200ResponseMarketingData.utmiCampaign) &&
        Objects.equals(this.utmiPage, addCoupons200ResponseMarketingData.utmiPage) &&
        Objects.equals(this.utmiPart, addCoupons200ResponseMarketingData.utmiPart);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddCoupons200ResponseMarketingData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddCoupons200ResponseMarketingData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddCoupons200ResponseMarketingData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCoupons200ResponseMarketingData is not found in the empty JSON string", AddCoupons200ResponseMarketingData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddCoupons200ResponseMarketingData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddCoupons200ResponseMarketingData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCoupons200ResponseMarketingData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCoupons200ResponseMarketingData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCoupons200ResponseMarketingData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCoupons200ResponseMarketingData.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCoupons200ResponseMarketingData>() {
           @Override
           public void write(JsonWriter out, AddCoupons200ResponseMarketingData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddCoupons200ResponseMarketingData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddCoupons200ResponseMarketingData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddCoupons200ResponseMarketingData
   * @throws IOException if the JSON string is invalid with respect to AddCoupons200ResponseMarketingData
   */
  public static AddCoupons200ResponseMarketingData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCoupons200ResponseMarketingData.class);
  }

  /**
   * Convert an instance of AddCoupons200ResponseMarketingData to an JSON string
   *
   * @return JSON string
   */
