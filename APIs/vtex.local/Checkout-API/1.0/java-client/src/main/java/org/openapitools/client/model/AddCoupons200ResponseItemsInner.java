...
public class AddCoupons200ResponseItemsInner {
  public static final String SERIALIZED_NAME_ADDITIONAL_INFO = "additionalInfo";
  @SerializedName(SERIALIZED_NAME_ADDITIONAL_INFO)
  private AddCoupons200ResponseItemsInnerAdditionalInfo additionalInfo;
  ...
  private List<AddCoupons200ResponseItemsInnerBundleItemsInner> bundleItems = new ArrayList<>();
  ...
  private List<AddCoupons200ResponseItemsInnerPriceTagsInner> priceTags = new ArrayList<>();
  ...
  private AddCoupons200ResponseItemsInnerProductCategories productCategories;
  ...
  public AddCoupons200ResponseItemsInner() {
  }

  public AddCoupons200ResponseItemsInner additionalInfo(AddCoupons200ResponseItemsInnerAdditionalInfo additionalInfo) {
  ...
  public AddCoupons200ResponseItemsInnerAdditionalInfo getAdditionalInfo() {
    return additionalInfo;
  }

  public void setAdditionalInfo(AddCoupons200ResponseItemsInnerAdditionalInfo additionalInfo) {
    this.additionalInfo = additionalInfo;
  }


  public AddCoupons200ResponseItemsInner attachments(List<String> attachments) {
    this.attachments = attachments;
    return this;
  }

  public AddCoupons200ResponseItemsInner addAttachmentsItem(String attachmentsItem) {
  ...
  public AddCoupons200ResponseItemsInner availability(String availability) {
  ...
  public AddCoupons200ResponseItemsInner bundleItems(List<AddCoupons200ResponseItemsInnerBundleItemsInner> bundleItems) {
    this.bundleItems = bundleItems;
    return this;
  }

  public AddCoupons200ResponseItemsInner addBundleItemsItem(AddCoupons200ResponseItemsInnerBundleItemsInner bundleItemsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddCoupons200ResponseItemsInnerBundleItemsInner> getBundleItems() {
    return bundleItems;
  }

  public void setBundleItems(List<AddCoupons200ResponseItemsInnerBundleItemsInner> bundleItems) {
    this.bundleItems = bundleItems;
  }


  public AddCoupons200ResponseItemsInner detailUrl(String detailUrl) {
  ...
  public AddCoupons200ResponseItemsInner ean(String ean) {
    this.ean = ean;
    return this;
  }
  ...
  public AddCoupons200ResponseItemsInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AddCoupons200ResponseItemsInner imageUrl(String imageUrl) {
  ...
  public AddCoupons200ResponseItemsInner isGift(Boolean isGift) {
    this.isGift = isGift;
    return this;
  }
  ...
  public AddCoupons200ResponseItemsInner listPrice(Integer listPrice) {
  ...
  public AddCoupons200ResponseItemsInner manualPrice(Integer manualPrice) {
  ...
  public AddCoupons200ResponseItemsInner manualPriceAppliedBy(String manualPriceAppliedBy) {
  ...
  public AddCoupons200ResponseItemsInner manufacturerCode(String manufacturerCode) {
  ...
  public AddCoupons200ResponseItemsInner measurementUnit(String measurementUnit) {
  ...
  public AddCoupons200ResponseItemsInner modalType(String modalType) {
  ...
  public AddCoupons200ResponseItemsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AddCoupons200ResponseItemsInner parentAssemblyBinding(String parentAssemblyBinding) {
  ...
  public AddCoupons200ResponseItemsInner parentItemIndex(Integer parentItemIndex) {
  ...
  public AddCoupons200ResponseItemsInner preSaleDate(String preSaleDate) {
  ...
  public AddCoupons200ResponseItemsInner price(Integer price) {
    this.price = price;
    return this;
  }
  ...
  public AddCoupons200ResponseItemsInner priceDefinition(AddCoupons200ResponseItemsInnerPriceDefinition priceDefinition) {
  ...
  public AddCoupons200ResponseItemsInner priceTags(List<AddCoupons200ResponseItemsInnerPriceTagsInner> priceTags) {
    this.priceTags = priceTags;
    return this;
  }

  public AddCoupons200ResponseItemsInner addPriceTagsItem(AddCoupons200ResponseItemsInnerPriceTagsInner priceTagsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddCoupons200ResponseItemsInnerPriceTagsInner> getPriceTags() {
    return priceTags;
  }

  public void setPriceTags(List<AddCoupons200ResponseItemsInnerPriceTagsInner> priceTags) {
    this.priceTags = priceTags;
  }


  public AddCoupons200ResponseItemsInner priceValidUntil(String priceValidUntil) {
  ...
  public AddCoupons200ResponseItemsInner productCategories(AddCoupons200ResponseItemsInnerProductCategories productCategories) {
   ...
   */
  @javax.annotation.Nullable
  public AddCoupons200ResponseItemsInnerProductCategories getProductCategories() {
    return productCategories;
  }

  public void setProductCategories(AddCoupons200ResponseItemsInnerProductCategories productCategories) {
    this.productCategories = productCategories;
  }


  public AddCoupons200ResponseItemsInner productCategoryIds(String productCategoryIds) {
  ...
  public AddCoupons200ResponseItemsInner productId(String productId) {
  ...
  public AddCoupons200ResponseItemsInner productRefId(String productRefId) {
  ...
  public AddCoupons200ResponseItemsInner quantity(Integer quantity) {
  ...
  public AddCoupons200ResponseItemsInner refId(String refId) {
    this.refId = refId;
    return this;
  }
  ...
  public AddCoupons200ResponseItemsInner rewardValue(Integer rewardValue) {
  ...
  public AddCoupons200ResponseItemsInner seller(String seller) {
    this.seller = seller;
    return this;
  }
  ...
  public AddCoupons200ResponseItemsInner sellerChain(List<String> sellerChain) {
    this.sellerChain = sellerChain;
    return this;
  }

  public AddCoupons200ResponseItemsInner addSellerChainItem(String sellerChainItem) {
  ...
  public AddCoupons200ResponseItemsInner sellingPrice(Integer sellingPrice) {
  ...
  public AddCoupons200ResponseItemsInner skuName(String skuName) {
  ...
  public AddCoupons200ResponseItemsInner tax(Integer tax) {
    this.tax = tax;
    return this;
  }
  ...
  public AddCoupons200ResponseItemsInner uniqueId(String uniqueId) {
  ...
  public AddCoupons200ResponseItemsInner unitMultiplier(Integer unitMultiplier) {
  ...
  public boolean equals(Object o) {
    ...
    AddCoupons200ResponseItemsInner addCoupons200ResponseItemsInner = (AddCoupons200ResponseItemsInner) o;
    return Objects.equals(this.additionalInfo, addCoupons200ResponseItemsInner.additionalInfo) &&
        Objects.equals(this.attachments, addCoupons200ResponseItemsInner.attachments) &&
        Objects.equals(this.availability, addCoupons200ResponseItemsInner.availability) &&
        Objects.equals(this.bundleItems, addCoupons200ResponseItemsInner.bundleItems) &&
        Objects.equals(this.detailUrl, addCoupons200ResponseItemsInner.detailUrl) &&
        Objects.equals(this.ean, addCoupons200ResponseItemsInner.ean) &&
        Objects.equals(this.id, addCoupons200ResponseItemsInner.id) &&
        Objects.equals(this.imageUrl, addCoupons200ResponseItemsInner.imageUrl) &&
        Objects.equals(this.isGift, addCoupons200ResponseItemsInner.isGift) &&
        Objects.equals(this.listPrice, addCoupons200ResponseItemsInner.listPrice) &&
        Objects.equals(this.manualPrice, addCoupons200ResponseItemsInner.manualPrice) &&
        Objects.equals(this.manualPriceAppliedBy, addCoupons200ResponseItemsInner.manualPriceAppliedBy) &&
        Objects.equals(this.manufacturerCode, addCoupons200ResponseItemsInner.manufacturerCode) &&
        Objects.equals(this.measurementUnit, addCoupons200ResponseItemsInner.measurementUnit) &&
        Objects.equals(this.modalType, addCoupons200ResponseItemsInner.modalType) &&
        Objects.equals(this.name, addCoupons200ResponseItemsInner.name) &&
        Objects.equals(this.parentAssemblyBinding, addCoupons200ResponseItemsInner.parentAssemblyBinding) &&
        Objects.equals(this.parentItemIndex, addCoupons200ResponseItemsInner.parentItemIndex) &&
        Objects.equals(this.preSaleDate, addCoupons200ResponseItemsInner.preSaleDate) &&
        Objects.equals(this.price, addCoupons200ResponseItemsInner.price) &&
        Objects.equals(this.priceDefinition, addCoupons200ResponseItemsInner.priceDefinition) &&
        Objects.equals(this.priceTags, addCoupons200ResponseItemsInner.priceTags) &&
        Objects.equals(this.priceValidUntil, addCoupons200ResponseItemsInner.priceValidUntil) &&
        Objects.equals(this.productCategories, addCoupons200ResponseItemsInner.productCategories) &&
        Objects.equals(this.productCategoryIds, addCoupons200ResponseItemsInner.productCategoryIds) &&
        Objects.equals(this.productId, addCoupons200ResponseItemsInner.productId) &&
        Objects.equals(this.productRefId, addCoupons200ResponseItemsInner.productRefId) &&
        Objects.equals(this.quantity, addCoupons200ResponseItemsInner.quantity) &&
        Objects.equals(this.refId, addCoupons200ResponseItemsInner.refId) &&
        Objects.equals(this.rewardValue, addCoupons200ResponseItemsInner.rewardValue) &&
        Objects.equals(this.seller, addCoupons200ResponseItemsInner.seller) &&
        Objects.equals(this.sellerChain, addCoupons200ResponseItemsInner.sellerChain) &&
        Objects.equals(this.sellingPrice, addCoupons200ResponseItemsInner.sellingPrice) &&
        Objects.equals(this.skuName, addCoupons200ResponseItemsInner.skuName) &&
        Objects.equals(this.tax, addCoupons200ResponseItemsInner.tax) &&
        Objects.equals(this.uniqueId, addCoupons200ResponseItemsInner.uniqueId) &&
        Objects.equals(this.unitMultiplier, addCoupons200ResponseItemsInner.unitMultiplier);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddCoupons200ResponseItemsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddCoupons200ResponseItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddCoupons200ResponseItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCoupons200ResponseItemsInner is not found in the empty JSON string", AddCoupons200ResponseItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddCoupons200ResponseItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddCoupons200ResponseItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("additionalInfo") != null && !jsonObj.get("additionalInfo").isJsonNull()) {
        AddCoupons200ResponseItemsInnerAdditionalInfo.validateJsonElement(jsonObj.get("additionalInfo"));
      }
      ...
      if (jsonObj.get("bundleItems") != null && !jsonObj.get("bundleItems").isJsonNull()) {
        ...
        if (jsonArraybundleItems != null) {
          ...
          for (int i = 0; i < jsonArraybundleItems.size(); i++) {
            AddCoupons200ResponseItemsInnerBundleItemsInner.validateJsonElement(jsonArraybundleItems.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("priceTags") != null && !jsonObj.get("priceTags").isJsonNull()) {
        ...
        if (jsonArraypriceTags != null) {
          ...
          for (int i = 0; i < jsonArraypriceTags.size(); i++) {
            AddCoupons200ResponseItemsInnerPriceTagsInner.validateJsonElement(jsonArraypriceTags.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("productCategories") != null && !jsonObj.get("productCategories").isJsonNull()) {
        AddCoupons200ResponseItemsInnerProductCategories.validateJsonElement(jsonObj.get("productCategories"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCoupons200ResponseItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCoupons200ResponseItemsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCoupons200ResponseItemsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCoupons200ResponseItemsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCoupons200ResponseItemsInner>() {
           @Override
           public void write(JsonWriter out, AddCoupons200ResponseItemsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddCoupons200ResponseItemsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddCoupons200ResponseItemsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddCoupons200ResponseItemsInner
   * @throws IOException if the JSON string is invalid with respect to AddCoupons200ResponseItemsInner
   */
  public static AddCoupons200ResponseItemsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCoupons200ResponseItemsInner.class);
  }

  /**
   * Convert an instance of AddCoupons200ResponseItemsInner to an JSON string
   *
   * @return JSON string
   */
