...
import org.openapitools.client.model.AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner;
...
public class AddCoupons200ResponseShippingDataLogisticsInfoInner {
  ...
  private List<AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner> slas = new ArrayList<>();

  public AddCoupons200ResponseShippingDataLogisticsInfoInner() {
  }

  public AddCoupons200ResponseShippingDataLogisticsInfoInner addressId(String addressId) {
  ...
  public AddCoupons200ResponseShippingDataLogisticsInfoInner deliveryChannels(List<AddCoupons200ResponseShippingDataLogisticsInfoInnerDeliveryChannelsInner> deliveryChannels) {
    this.deliveryChannels = deliveryChannels;
    return this;
  }

  public AddCoupons200ResponseShippingDataLogisticsInfoInner addDeliveryChannelsItem(AddCoupons200ResponseShippingDataLogisticsInfoInnerDeliveryChannelsInner deliveryChannelsItem) {
  ...
  public AddCoupons200ResponseShippingDataLogisticsInfoInner itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public AddCoupons200ResponseShippingDataLogisticsInfoInner itemIndex(Integer itemIndex) {
  ...
  public AddCoupons200ResponseShippingDataLogisticsInfoInner selectedDeliveryChannel(String selectedDeliveryChannel) {
  ...
  public AddCoupons200ResponseShippingDataLogisticsInfoInner selectedSla(String selectedSla) {
  ...
  public AddCoupons200ResponseShippingDataLogisticsInfoInner shipsTo(List<String> shipsTo) {
    this.shipsTo = shipsTo;
    return this;
  }

  public AddCoupons200ResponseShippingDataLogisticsInfoInner addShipsToItem(String shipsToItem) {
  ...
  public AddCoupons200ResponseShippingDataLogisticsInfoInner slas(List<AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner> slas) {
    this.slas = slas;
    return this;
  }

  public AddCoupons200ResponseShippingDataLogisticsInfoInner addSlasItem(AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner slasItem) {
    if (this.slas == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner> getSlas() {
    return slas;
  }

  public void setSlas(List<AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner> slas) {
    this.slas = slas;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddCoupons200ResponseShippingDataLogisticsInfoInner addCoupons200ResponseShippingDataLogisticsInfoInner = (AddCoupons200ResponseShippingDataLogisticsInfoInner) o;
    return Objects.equals(this.addressId, addCoupons200ResponseShippingDataLogisticsInfoInner.addressId) &&
        Objects.equals(this.deliveryChannels, addCoupons200ResponseShippingDataLogisticsInfoInner.deliveryChannels) &&
        Objects.equals(this.itemId, addCoupons200ResponseShippingDataLogisticsInfoInner.itemId) &&
        Objects.equals(this.itemIndex, addCoupons200ResponseShippingDataLogisticsInfoInner.itemIndex) &&
        Objects.equals(this.selectedDeliveryChannel, addCoupons200ResponseShippingDataLogisticsInfoInner.selectedDeliveryChannel) &&
        Objects.equals(this.selectedSla, addCoupons200ResponseShippingDataLogisticsInfoInner.selectedSla) &&
        Objects.equals(this.shipsTo, addCoupons200ResponseShippingDataLogisticsInfoInner.shipsTo) &&
        Objects.equals(this.slas, addCoupons200ResponseShippingDataLogisticsInfoInner.slas);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddCoupons200ResponseShippingDataLogisticsInfoInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddCoupons200ResponseShippingDataLogisticsInfoInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddCoupons200ResponseShippingDataLogisticsInfoInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCoupons200ResponseShippingDataLogisticsInfoInner is not found in the empty JSON string", AddCoupons200ResponseShippingDataLogisticsInfoInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddCoupons200ResponseShippingDataLogisticsInfoInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddCoupons200ResponseShippingDataLogisticsInfoInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("slas") != null && !jsonObj.get("slas").isJsonNull()) {
        ...
        if (jsonArrayslas != null) {
          ...
          for (int i = 0; i < jsonArrayslas.size(); i++) {
            AddCoupons200ResponseShippingDataLogisticsInfoInnerSlasInner.validateJsonElement(jsonArrayslas.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCoupons200ResponseShippingDataLogisticsInfoInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCoupons200ResponseShippingDataLogisticsInfoInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCoupons200ResponseShippingDataLogisticsInfoInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCoupons200ResponseShippingDataLogisticsInfoInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCoupons200ResponseShippingDataLogisticsInfoInner>() {
           @Override
           public void write(JsonWriter out, AddCoupons200ResponseShippingDataLogisticsInfoInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddCoupons200ResponseShippingDataLogisticsInfoInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddCoupons200ResponseShippingDataLogisticsInfoInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddCoupons200ResponseShippingDataLogisticsInfoInner
   * @throws IOException if the JSON string is invalid with respect to AddCoupons200ResponseShippingDataLogisticsInfoInner
   */
  public static AddCoupons200ResponseShippingDataLogisticsInfoInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCoupons200ResponseShippingDataLogisticsInfoInner.class);
  }

  /**
   * Convert an instance of AddCoupons200ResponseShippingDataLogisticsInfoInner to an JSON string
   *
   * @return JSON string
   */
