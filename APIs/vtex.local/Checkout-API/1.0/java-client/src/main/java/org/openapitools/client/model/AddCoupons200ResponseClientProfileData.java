...
public class AddCoupons200ResponseClientProfileData {
  ...
  private Boolean profileCompleteOnLoading;
  ...
  private Boolean profileErrorOnLoading;
  ...
  public AddCoupons200ResponseClientProfileData() {
  }

  public AddCoupons200ResponseClientProfileData corporateDocument(String corporateDocument) {
  ...
  public AddCoupons200ResponseClientProfileData corporateName(String corporateName) {
  ...
  public AddCoupons200ResponseClientProfileData corporatePhone(String corporatePhone) {
  ...
  public AddCoupons200ResponseClientProfileData customerClass(String customerClass) {
  ...
  public AddCoupons200ResponseClientProfileData document(String document) {
  ...
  public AddCoupons200ResponseClientProfileData documentType(String documentType) {
  ...
  public AddCoupons200ResponseClientProfileData email(String email) {
    this.email = email;
    return this;
  }
  ...
  public AddCoupons200ResponseClientProfileData firstName(String firstName) {
  ...
  public AddCoupons200ResponseClientProfileData isCorporate(Boolean isCorporate) {
  ...
  public AddCoupons200ResponseClientProfileData lastName(String lastName) {
  ...
  public AddCoupons200ResponseClientProfileData phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public AddCoupons200ResponseClientProfileData profileCompleteOnLoading(Boolean profileCompleteOnLoading) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getProfileCompleteOnLoading() {
    return profileCompleteOnLoading;
  }

  public void setProfileCompleteOnLoading(Boolean profileCompleteOnLoading) {
    this.profileCompleteOnLoading = profileCompleteOnLoading;
  }


  public AddCoupons200ResponseClientProfileData profileErrorOnLoading(Boolean profileErrorOnLoading) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getProfileErrorOnLoading() {
    return profileErrorOnLoading;
  }

  public void setProfileErrorOnLoading(Boolean profileErrorOnLoading) {
    this.profileErrorOnLoading = profileErrorOnLoading;
  }


  public AddCoupons200ResponseClientProfileData stateInscription(String stateInscription) {
  ...
  public AddCoupons200ResponseClientProfileData tradeName(String tradeName) {
  ...
  public boolean equals(Object o) {
    ...
    AddCoupons200ResponseClientProfileData addCoupons200ResponseClientProfileData = (AddCoupons200ResponseClientProfileData) o;
    return Objects.equals(this.corporateDocument, addCoupons200ResponseClientProfileData.corporateDocument) &&
        Objects.equals(this.corporateName, addCoupons200ResponseClientProfileData.corporateName) &&
        Objects.equals(this.corporatePhone, addCoupons200ResponseClientProfileData.corporatePhone) &&
        Objects.equals(this.customerClass, addCoupons200ResponseClientProfileData.customerClass) &&
        Objects.equals(this.document, addCoupons200ResponseClientProfileData.document) &&
        Objects.equals(this.documentType, addCoupons200ResponseClientProfileData.documentType) &&
        Objects.equals(this.email, addCoupons200ResponseClientProfileData.email) &&
        Objects.equals(this.firstName, addCoupons200ResponseClientProfileData.firstName) &&
        Objects.equals(this.isCorporate, addCoupons200ResponseClientProfileData.isCorporate) &&
        Objects.equals(this.lastName, addCoupons200ResponseClientProfileData.lastName) &&
        Objects.equals(this.phone, addCoupons200ResponseClientProfileData.phone) &&
        Objects.equals(this.profileCompleteOnLoading, addCoupons200ResponseClientProfileData.profileCompleteOnLoading) &&
        Objects.equals(this.profileErrorOnLoading, addCoupons200ResponseClientProfileData.profileErrorOnLoading) &&
        Objects.equals(this.stateInscription, addCoupons200ResponseClientProfileData.stateInscription) &&
        Objects.equals(this.tradeName, addCoupons200ResponseClientProfileData.tradeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddCoupons200ResponseClientProfileData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddCoupons200ResponseClientProfileData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddCoupons200ResponseClientProfileData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCoupons200ResponseClientProfileData is not found in the empty JSON string", AddCoupons200ResponseClientProfileData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddCoupons200ResponseClientProfileData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddCoupons200ResponseClientProfileData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCoupons200ResponseClientProfileData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCoupons200ResponseClientProfileData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCoupons200ResponseClientProfileData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCoupons200ResponseClientProfileData.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCoupons200ResponseClientProfileData>() {
           @Override
           public void write(JsonWriter out, AddCoupons200ResponseClientProfileData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddCoupons200ResponseClientProfileData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddCoupons200ResponseClientProfileData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddCoupons200ResponseClientProfileData
   * @throws IOException if the JSON string is invalid with respect to AddCoupons200ResponseClientProfileData
   */
  public static AddCoupons200ResponseClientProfileData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCoupons200ResponseClientProfileData.class);
  }

  /**
   * Convert an instance of AddCoupons200ResponseClientProfileData to an JSON string
   *
   * @return JSON string
   */
