...
public class Items200ResponseMarketingData {
  ...
  public Items200ResponseMarketingData() {
  }

  public Items200ResponseMarketingData coupon(String coupon) {
    this.coupon = coupon;
    return this;
  }
  ...
  public Items200ResponseMarketingData utmCampaign(String utmCampaign) {
  ...
  public Items200ResponseMarketingData utmMedium(String utmMedium) {
  ...
  public Items200ResponseMarketingData utmSource(String utmSource) {
  ...
  public Items200ResponseMarketingData utmiCampaign(String utmiCampaign) {
  ...
  public Items200ResponseMarketingData utmiPage(String utmiPage) {
  ...
  public Items200ResponseMarketingData utmiPart(String utmiPart) {
  ...
  public boolean equals(Object o) {
    ...
    Items200ResponseMarketingData items200ResponseMarketingData = (Items200ResponseMarketingData) o;
    return Objects.equals(this.coupon, items200ResponseMarketingData.coupon) &&
        Objects.equals(this.utmCampaign, items200ResponseMarketingData.utmCampaign) &&
        Objects.equals(this.utmMedium, items200ResponseMarketingData.utmMedium) &&
        Objects.equals(this.utmSource, items200ResponseMarketingData.utmSource) &&
        Objects.equals(this.utmiCampaign, items200ResponseMarketingData.utmiCampaign) &&
        Objects.equals(this.utmiPage, items200ResponseMarketingData.utmiPage) &&
        Objects.equals(this.utmiPart, items200ResponseMarketingData.utmiPart);
  }
  ...
  public String toString() {
    ...
    sb.append("class Items200ResponseMarketingData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Items200ResponseMarketingData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Items200ResponseMarketingData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Items200ResponseMarketingData is not found in the empty JSON string", Items200ResponseMarketingData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Items200ResponseMarketingData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Items200ResponseMarketingData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Items200ResponseMarketingData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Items200ResponseMarketingData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Items200ResponseMarketingData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Items200ResponseMarketingData.class));

       return (TypeAdapter<T>) new TypeAdapter<Items200ResponseMarketingData>() {
           @Override
           public void write(JsonWriter out, Items200ResponseMarketingData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Items200ResponseMarketingData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Items200ResponseMarketingData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Items200ResponseMarketingData
   * @throws IOException if the JSON string is invalid with respect to Items200ResponseMarketingData
   */
  public static Items200ResponseMarketingData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Items200ResponseMarketingData.class);
  }

  /**
   * Convert an instance of Items200ResponseMarketingData to an JSON string
   *
   * @return JSON string
   */
