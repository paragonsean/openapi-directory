...
public class FulfillmentApiTest {
     ...
     */
    @Test
    public void getAddressByPostalCodeTest() throws ApiException {
        String contentType = null;
        String accept = null;
        String countryCode = null;
        String postalCode = null;
        api.getAddressByPostalCode(contentType, accept, countryCode, postalCode);
     ...
     */
    @Test
    public void listPickupPpointsByLocationTest() throws ApiException {
        String contentType = null;
        String accept = null;
        List<BigDecimal> geoCoordinates = null;
        String postalCode = null;
        String countryCode = null;
        api.listPickupPpointsByLocation(contentType, accept, geoCoordinates, postalCode, countryCode);
        // TODO: test validations
    }
