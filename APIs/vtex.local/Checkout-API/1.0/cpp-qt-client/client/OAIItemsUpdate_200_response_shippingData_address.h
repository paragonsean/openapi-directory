...
/*
 * OAIItemsUpdate_200_response_shippingData_address.h
 *
 * Address information.
 */

#ifndef OAIItemsUpdate_200_response_shippingData_address_H
#define OAIItemsUpdate_200_response_shippingData_address_H
...
class OAIItemsUpdate_200_response_shippingData_address : public OAIObject {
public:
    OAIItemsUpdate_200_response_shippingData_address();
    OAIItemsUpdate_200_response_shippingData_address(QString json);
    ~OAIItemsUpdate_200_response_shippingData_address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemsUpdate_200_response_shippingData_address)

#endif // OAIItemsUpdate_200_response_shippingData_address_H
