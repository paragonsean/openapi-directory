...
/*
 * OAICartSimulation_200_response_logisticsInfo_inner_purchaseConditions_itemPurchaseConditions_inner.h
 *
 * 
 */

#ifndef OAICartSimulation_200_response_logisticsInfo_inner_purchaseConditions_itemPurchaseConditions_inner_H
#define OAICartSimulation_200_response_logisticsInfo_inner_purchaseConditions_itemPurchaseConditions_inner_H
...
class OAICartSimulation_200_response_logisticsInfo_inner_purchaseConditions_itemPurchaseConditions_inner : public OAIObject {
public:
    OAICartSimulation_200_response_logisticsInfo_inner_purchaseConditions_itemPurchaseConditions_inner();
    OAICartSimulation_200_response_logisticsInfo_inner_purchaseConditions_itemPurchaseConditions_inner(QString json);
    ~OAICartSimulation_200_response_logisticsInfo_inner_purchaseConditions_itemPurchaseConditions_inner() override;
    ...
    QList<QJsonValue> getSellerChain() const;
    void setSellerChain(const QList<QJsonValue> &seller_chain);
...
private:
    ...
    QList<QJsonValue> m_seller_chain;
...
Q_DECLARE_METATYPE(OpenAPI::OAICartSimulation_200_response_logisticsInfo_inner_purchaseConditions_itemPurchaseConditions_inner)

#endif // OAICartSimulation_200_response_logisticsInfo_inner_purchaseConditions_itemPurchaseConditions_inner_H
