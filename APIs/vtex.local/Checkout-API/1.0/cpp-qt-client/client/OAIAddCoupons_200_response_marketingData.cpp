...
OAIAddCoupons_200_response_marketingData::OAIAddCoupons_200_response_marketingData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddCoupons_200_response_marketingData::OAIAddCoupons_200_response_marketingData() {
    this->initializeModel();
}

OAIAddCoupons_200_response_marketingData::~OAIAddCoupons_200_response_marketingData() {}

void OAIAddCoupons_200_response_marketingData::initializeModel() {
...
void OAIAddCoupons_200_response_marketingData::fromJson(QString jsonString) {
...
void OAIAddCoupons_200_response_marketingData::fromJsonObject(QJsonObject json) {
...
QString OAIAddCoupons_200_response_marketingData::asJson() const {
...
QJsonObject OAIAddCoupons_200_response_marketingData::asJsonObject() const {
    QJsonObject obj;
    if (m_coupon_isSet) {
...
QString OAIAddCoupons_200_response_marketingData::getCoupon() const {
    return m_coupon;
}
void OAIAddCoupons_200_response_marketingData::setCoupon(const QString &coupon) {
    m_coupon = coupon;
    m_coupon_isSet = true;
}

bool OAIAddCoupons_200_response_marketingData::is_coupon_Set() const{
    return m_coupon_isSet;
}

bool OAIAddCoupons_200_response_marketingData::is_coupon_Valid() const{
    return m_coupon_isValid;
}

QString OAIAddCoupons_200_response_marketingData::getUtmCampaign() const {
    return m_utm_campaign;
}
void OAIAddCoupons_200_response_marketingData::setUtmCampaign(const QString &utm_campaign) {
    m_utm_campaign = utm_campaign;
    m_utm_campaign_isSet = true;
}

bool OAIAddCoupons_200_response_marketingData::is_utm_campaign_Set() const{
    return m_utm_campaign_isSet;
}

bool OAIAddCoupons_200_response_marketingData::is_utm_campaign_Valid() const{
    return m_utm_campaign_isValid;
}

QString OAIAddCoupons_200_response_marketingData::getUtmMedium() const {
    return m_utm_medium;
}
void OAIAddCoupons_200_response_marketingData::setUtmMedium(const QString &utm_medium) {
    m_utm_medium = utm_medium;
    m_utm_medium_isSet = true;
}

bool OAIAddCoupons_200_response_marketingData::is_utm_medium_Set() const{
    return m_utm_medium_isSet;
}

bool OAIAddCoupons_200_response_marketingData::is_utm_medium_Valid() const{
    return m_utm_medium_isValid;
}

QString OAIAddCoupons_200_response_marketingData::getUtmSource() const {
    return m_utm_source;
}
void OAIAddCoupons_200_response_marketingData::setUtmSource(const QString &utm_source) {
    m_utm_source = utm_source;
    m_utm_source_isSet = true;
}

bool OAIAddCoupons_200_response_marketingData::is_utm_source_Set() const{
    return m_utm_source_isSet;
}

bool OAIAddCoupons_200_response_marketingData::is_utm_source_Valid() const{
    return m_utm_source_isValid;
}

QString OAIAddCoupons_200_response_marketingData::getUtmiCampaign() const {
    return m_utmi_campaign;
}
void OAIAddCoupons_200_response_marketingData::setUtmiCampaign(const QString &utmi_campaign) {
    m_utmi_campaign = utmi_campaign;
    m_utmi_campaign_isSet = true;
}

bool OAIAddCoupons_200_response_marketingData::is_utmi_campaign_Set() const{
    return m_utmi_campaign_isSet;
}

bool OAIAddCoupons_200_response_marketingData::is_utmi_campaign_Valid() const{
    return m_utmi_campaign_isValid;
}

QString OAIAddCoupons_200_response_marketingData::getUtmiPage() const {
    return m_utmi_page;
}
void OAIAddCoupons_200_response_marketingData::setUtmiPage(const QString &utmi_page) {
    m_utmi_page = utmi_page;
    m_utmi_page_isSet = true;
}

bool OAIAddCoupons_200_response_marketingData::is_utmi_page_Set() const{
    return m_utmi_page_isSet;
}

bool OAIAddCoupons_200_response_marketingData::is_utmi_page_Valid() const{
    return m_utmi_page_isValid;
}

QString OAIAddCoupons_200_response_marketingData::getUtmiPart() const {
    return m_utmi_part;
}
void OAIAddCoupons_200_response_marketingData::setUtmiPart(const QString &utmi_part) {
    m_utmi_part = utmi_part;
    m_utmi_part_isSet = true;
}

bool OAIAddCoupons_200_response_marketingData::is_utmi_part_Set() const{
    return m_utmi_part_isSet;
}

bool OAIAddCoupons_200_response_marketingData::is_utmi_part_Valid() const{
    return m_utmi_part_isValid;
}

bool OAIAddCoupons_200_response_marketingData::isSet() const {
...
bool OAIAddCoupons_200_response_marketingData::isValid() const {
