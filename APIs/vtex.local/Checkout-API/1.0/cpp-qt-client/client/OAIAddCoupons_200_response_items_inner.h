...
/*
 * OAIAddCoupons_200_response_items_inner.h
 *
 * 
 */

#ifndef OAIAddCoupons_200_response_items_inner_H
#define OAIAddCoupons_200_response_items_inner_H
...
class OAIAddCoupons_200_response_items_inner : public OAIObject {
public:
    OAIAddCoupons_200_response_items_inner();
    OAIAddCoupons_200_response_items_inner(QString json);
    ~OAIAddCoupons_200_response_items_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddCoupons_200_response_items_inner)

#endif // OAIAddCoupons_200_response_items_inner_H
