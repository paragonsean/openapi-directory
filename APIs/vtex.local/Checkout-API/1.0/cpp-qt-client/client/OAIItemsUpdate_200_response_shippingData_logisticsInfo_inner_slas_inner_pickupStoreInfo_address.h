...
/*
 * OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address.h
 *
 * Address information.
 */

#ifndef OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address_H
#define OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address_H
...
class OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address : public OAIObject {
public:
    OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address();
    OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address(QString json);
    ~OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address)

#endif // OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address_H
