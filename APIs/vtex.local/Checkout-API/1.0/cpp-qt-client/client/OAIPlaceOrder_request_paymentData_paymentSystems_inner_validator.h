...
/*
 * OAIPlaceOrder_request_paymentData_paymentSystems_inner_validator.h
 *
 * Payment system validator.
 */

#ifndef OAIPlaceOrder_request_paymentData_paymentSystems_inner_validator_H
#define OAIPlaceOrder_request_paymentData_paymentSystems_inner_validator_H
...
class OAIPlaceOrder_request_paymentData_paymentSystems_inner_validator : public OAIObject {
public:
    OAIPlaceOrder_request_paymentData_paymentSystems_inner_validator();
    OAIPlaceOrder_request_paymentData_paymentSystems_inner_validator(QString json);
    ~OAIPlaceOrder_request_paymentData_paymentSystems_inner_validator() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaceOrder_request_paymentData_paymentSystems_inner_validator)

#endif // OAIPlaceOrder_request_paymentData_paymentSystems_inner_validator_H
