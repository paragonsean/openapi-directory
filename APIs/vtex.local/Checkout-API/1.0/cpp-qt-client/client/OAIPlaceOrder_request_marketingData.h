...
/*
 * OAIPlaceOrder_request_marketingData.h
 *
 * 
 */

#ifndef OAIPlaceOrder_request_marketingData_H
#define OAIPlaceOrder_request_marketingData_H
...
class OAIPlaceOrder_request_marketingData : public OAIObject {
public:
    OAIPlaceOrder_request_marketingData();
    OAIPlaceOrder_request_marketingData(QString json);
    ~OAIPlaceOrder_request_marketingData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaceOrder_request_marketingData)

#endif // OAIPlaceOrder_request_marketingData_H
