...
/*
 * OAIItemsUpdate_200_response.h
 *
 * 
 */

#ifndef OAIItemsUpdate_200_response_H
#define OAIItemsUpdate_200_response_H
...
#include "OAIItemsUpdate_200_response_availableAddresses_inner.h"
...
namespace OpenAPI {
class OAIItemsUpdate_200_response_availableAddresses_inner;
...
class OAIItemsUpdate_200_response_itemsOrdination;
...
class OAIItemsUpdate_200_response_shippingData;

class OAIItemsUpdate_200_response : public OAIObject {
public:
    OAIItemsUpdate_200_response();
    OAIItemsUpdate_200_response(QString json);
    ~OAIItemsUpdate_200_response() override;
    ...
    QList<OAIItemsUpdate_200_response_availableAddresses_inner> getAvailableAddresses() const;
    void setAvailableAddresses(const QList<OAIItemsUpdate_200_response_availableAddresses_inner> &available_addresses);
    ...
    OAIItemsUpdate_200_response_itemsOrdination getItemsOrdination() const;
    void setItemsOrdination(const OAIItemsUpdate_200_response_itemsOrdination &items_ordination);
    ...
    OAIItemsUpdate_200_response_shippingData getShippingData() const;
    void setShippingData(const OAIItemsUpdate_200_response_shippingData &shipping_data);
...
private:
    ...
    QList<OAIItemsUpdate_200_response_availableAddresses_inner> m_available_addresses;
    ...
    OAIItemsUpdate_200_response_itemsOrdination m_items_ordination;
    ...
    OAIItemsUpdate_200_response_shippingData m_shipping_data;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemsUpdate_200_response)

#endif // OAIItemsUpdate_200_response_H
