...
/*
 * OAIAddCoupons_200_response_clientProfileData.h
 *
 * Customer&#39;s profile information.
 */

#ifndef OAIAddCoupons_200_response_clientProfileData_H
#define OAIAddCoupons_200_response_clientProfileData_H
...
class OAIAddCoupons_200_response_clientProfileData : public OAIObject {
public:
    OAIAddCoupons_200_response_clientProfileData();
    OAIAddCoupons_200_response_clientProfileData(QString json);
    ~OAIAddCoupons_200_response_clientProfileData() override;
    ...
    bool isProfileCompleteOnLoading() const;
    void setProfileCompleteOnLoading(const bool &profile_complete_on_loading);
    bool is_profile_complete_on_loading_Set() const;
    bool is_profile_complete_on_loading_Valid() const;

    bool isProfileErrorOnLoading() const;
    void setProfileErrorOnLoading(const bool &profile_error_on_loading);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddCoupons_200_response_clientProfileData)

#endif // OAIAddCoupons_200_response_clientProfileData_H
