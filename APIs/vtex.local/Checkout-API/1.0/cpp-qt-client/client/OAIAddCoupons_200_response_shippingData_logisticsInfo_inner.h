...
/*
 * OAIAddCoupons_200_response_shippingData_logisticsInfo_inner.h
 *
 * 
 */

#ifndef OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_H
#define OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_H
...
class OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner;

class OAIAddCoupons_200_response_shippingData_logisticsInfo_inner : public OAIObject {
public:
    OAIAddCoupons_200_response_shippingData_logisticsInfo_inner();
    OAIAddCoupons_200_response_shippingData_logisticsInfo_inner(QString json);
    ~OAIAddCoupons_200_response_shippingData_logisticsInfo_inner() override;
    ...
    QList<OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner> getSlas() const;
    void setSlas(const QList<OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner> &slas);
...
private:
    ...
    QList<OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner> m_slas;
    bool m_slas_isSet;
    bool m_slas_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddCoupons_200_response_shippingData_logisticsInfo_inner)

#endif // OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_H
