...
/*
 * OAIAddShippingAddress_request_selectedAddresses_inner.h
 *
 * 
 */

#ifndef OAIAddShippingAddress_request_selectedAddresses_inner_H
#define OAIAddShippingAddress_request_selectedAddresses_inner_H
...
class OAIAddShippingAddress_request_selectedAddresses_inner : public OAIObject {
public:
    OAIAddShippingAddress_request_selectedAddresses_inner();
    OAIAddShippingAddress_request_selectedAddresses_inner(QString json);
    ~OAIAddShippingAddress_request_selectedAddresses_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddShippingAddress_request_selectedAddresses_inner)

#endif // OAIAddShippingAddress_request_selectedAddresses_inner_H
