...
/*
 * OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner.h
 *
 * 
 */

#ifndef OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_H
#define OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_H
...
class OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo;

class OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner : public OAIObject {
public:
    OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner();
    OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner(QString json);
    ~OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner() override;
    ...
    OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo getPickupStoreInfo() const;
    void setPickupStoreInfo(const OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo &pickup_store_info);
...
private:
    ...
    OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo m_pickup_store_info;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner)

#endif // OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_H
