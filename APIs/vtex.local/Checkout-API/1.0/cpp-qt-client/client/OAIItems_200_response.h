...
/*
 * OAIItems_200_response.h
 *
 * 
 */

#ifndef OAIItems_200_response_H
#define OAIItems_200_response_H
...
#include "OAIItems_200_response_clientPreferencesData.h"
#include "OAIItems_200_response_items_inner.h"
...
class OAIItems_200_response : public OAIObject {
public:
    OAIItems_200_response();
    OAIItems_200_response(QString json);
    ~OAIItems_200_response() override;
    ...
    OAIItems_200_response_clientPreferencesData getClientPreferencesData() const;
    void setClientPreferencesData(const OAIItems_200_response_clientPreferencesData &client_preferences_data);
    ...
    QList<OAIItems_200_response_items_inner> getItems() const;
    void setItems(const QList<OAIItems_200_response_items_inner> &items);
    ...
    OAIItems_200_response_marketingData getMarketingData() const;
    void setMarketingData(const OAIItems_200_response_marketingData &marketing_data);
...
private:
    ...
    OAIItems_200_response_clientPreferencesData m_client_preferences_data;
    ...
    QList<OAIItems_200_response_items_inner> m_items;
    bool m_items_isSet;
    ...
    OAIItems_200_response_marketingData m_marketing_data;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItems_200_response)

#endif // OAIItems_200_response_H
