...
/*
 * OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner.h
 *
 * 
 */

#ifndef OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_H
#define OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_H
...
class OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner;

class OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner : public OAIObject {
public:
    OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner();
    OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner(QString json);
    ~OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner() override;
    ...
    QList<OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner> getSlas() const;
    void setSlas(const QList<OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner> &slas);
...
private:
    ...
    QList<OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_slas_inner> m_slas;
    bool m_slas_isSet;
    bool m_slas_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner)

#endif // OAIItemsUpdate_200_response_shippingData_logisticsInfo_inner_H
