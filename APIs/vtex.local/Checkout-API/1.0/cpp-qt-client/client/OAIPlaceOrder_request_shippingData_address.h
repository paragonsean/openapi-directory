...
/*
 * OAIPlaceOrder_request_shippingData_address.h
 *
...
#ifndef OAIPlaceOrder_request_shippingData_address_H
#define OAIPlaceOrder_request_shippingData_address_H
...
class OAIPlaceOrder_request_shippingData_address : public OAIObject {
public:
    OAIPlaceOrder_request_shippingData_address();
    OAIPlaceOrder_request_shippingData_address(QString json);
    ~OAIPlaceOrder_request_shippingData_address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaceOrder_request_shippingData_address)

#endif // OAIPlaceOrder_request_shippingData_address_H
