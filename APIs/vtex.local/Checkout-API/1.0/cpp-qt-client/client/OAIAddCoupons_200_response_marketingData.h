...
/*
 * OAIAddCoupons_200_response_marketingData.h
 *
 * Object containIng promotion data such as coupon tracking information and internal or external UTMs.
 */

#ifndef OAIAddCoupons_200_response_marketingData_H
#define OAIAddCoupons_200_response_marketingData_H
...
class OAIAddCoupons_200_response_marketingData : public OAIObject {
public:
    OAIAddCoupons_200_response_marketingData();
    OAIAddCoupons_200_response_marketingData(QString json);
    ~OAIAddCoupons_200_response_marketingData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddCoupons_200_response_marketingData)

#endif // OAIAddCoupons_200_response_marketingData_H
