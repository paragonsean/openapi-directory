...
/*
 * OAIAddShippingAddress_request_logisticsInfo_inner.h
 *
 * 
 */

#ifndef OAIAddShippingAddress_request_logisticsInfo_inner_H
#define OAIAddShippingAddress_request_logisticsInfo_inner_H
...
class OAIAddShippingAddress_request_logisticsInfo_inner : public OAIObject {
public:
    OAIAddShippingAddress_request_logisticsInfo_inner();
    OAIAddShippingAddress_request_logisticsInfo_inner(QString json);
    ~OAIAddShippingAddress_request_logisticsInfo_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddShippingAddress_request_logisticsInfo_inner)

#endif // OAIAddShippingAddress_request_logisticsInfo_inner_H
