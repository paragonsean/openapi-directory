...
/*
 * OAIPlaceOrder_request_clientProfileData.h
 *
...
#ifndef OAIPlaceOrder_request_clientProfileData_H
#define OAIPlaceOrder_request_clientProfileData_H
...
class OAIPlaceOrder_request_clientProfileData : public OAIObject {
public:
    OAIPlaceOrder_request_clientProfileData();
    OAIPlaceOrder_request_clientProfileData(QString json);
    ~OAIPlaceOrder_request_clientProfileData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaceOrder_request_clientProfileData)

#endif // OAIPlaceOrder_request_clientProfileData_H
