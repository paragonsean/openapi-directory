...
/*
 * OAIGetClientProfileByEmail_200_response_userProfile.h
 *
 * Customer profile information.
 */

#ifndef OAIGetClientProfileByEmail_200_response_userProfile_H
#define OAIGetClientProfileByEmail_200_response_userProfile_H
...
class OAIGetClientProfileByEmail_200_response_userProfile : public OAIObject {
public:
    OAIGetClientProfileByEmail_200_response_userProfile();
    OAIGetClientProfileByEmail_200_response_userProfile(QString json);
    ~OAIGetClientProfileByEmail_200_response_userProfile() override;
    ...
    QString getProfileCompleteOnLoading() const;
    void setProfileCompleteOnLoading(const QString &profile_complete_on_loading);
    bool is_profile_complete_on_loading_Set() const;
    bool is_profile_complete_on_loading_Valid() const;

    QString getProfileErrorOnLoading() const;
    void setProfileErrorOnLoading(const QString &profile_error_on_loading);
    bool is_profile_error_on_loading_Set() const;
    bool is_profile_error_on_loading_Valid() const;
...
private:
    ...
    QString m_profile_complete_on_loading;
    bool m_profile_complete_on_loading_isSet;
    bool m_profile_complete_on_loading_isValid;

    QString m_profile_error_on_loading;
    bool m_profile_error_on_loading_isSet;
    bool m_profile_error_on_loading_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetClientProfileByEmail_200_response_userProfile)

#endif // OAIGetClientProfileByEmail_200_response_userProfile_H
