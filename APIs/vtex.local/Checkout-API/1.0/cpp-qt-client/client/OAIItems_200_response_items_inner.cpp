...
OAIItems_200_response_items_inner::OAIItems_200_response_items_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIItems_200_response_items_inner::OAIItems_200_response_items_inner() {
    this->initializeModel();
}

OAIItems_200_response_items_inner::~OAIItems_200_response_items_inner() {}

void OAIItems_200_response_items_inner::initializeModel() {
...
void OAIItems_200_response_items_inner::fromJson(QString jsonString) {
...
void OAIItems_200_response_items_inner::fromJsonObject(QJsonObject json) {
...
QString OAIItems_200_response_items_inner::asJson() const {
...
QJsonObject OAIItems_200_response_items_inner::asJsonObject() const {
    QJsonObject obj;
...
OAIAddCoupons_200_response_items_inner_additionalInfo OAIItems_200_response_items_inner::getAdditionalInfo() const {
    return m_additional_info;
}
void OAIItems_200_response_items_inner::setAdditionalInfo(const OAIAddCoupons_200_response_items_inner_additionalInfo &additional_info) {
    m_additional_info = additional_info;
    m_additional_info_isSet = true;
}

bool OAIItems_200_response_items_inner::is_additional_info_Set() const{
    return m_additional_info_isSet;
}

bool OAIItems_200_response_items_inner::is_additional_info_Valid() const{
    return m_additional_info_isValid;
}

QList<QString> OAIItems_200_response_items_inner::getAttachments() const {
    return m_attachments;
}
void OAIItems_200_response_items_inner::setAttachments(const QList<QString> &attachments) {
    m_attachments = attachments;
    m_attachments_isSet = true;
}

bool OAIItems_200_response_items_inner::is_attachments_Set() const{
    return m_attachments_isSet;
}

bool OAIItems_200_response_items_inner::is_attachments_Valid() const{
    return m_attachments_isValid;
}

QString OAIItems_200_response_items_inner::getAvailability() const {
    return m_availability;
}
void OAIItems_200_response_items_inner::setAvailability(const QString &availability) {
    m_availability = availability;
    m_availability_isSet = true;
}

bool OAIItems_200_response_items_inner::is_availability_Set() const{
    return m_availability_isSet;
}

bool OAIItems_200_response_items_inner::is_availability_Valid() const{
    return m_availability_isValid;
}

QList<OAIAddCoupons_200_response_items_inner_bundleItems_inner> OAIItems_200_response_items_inner::getBundleItems() const {
    return m_bundle_items;
}
void OAIItems_200_response_items_inner::setBundleItems(const QList<OAIAddCoupons_200_response_items_inner_bundleItems_inner> &bundle_items) {
    m_bundle_items = bundle_items;
    m_bundle_items_isSet = true;
}

bool OAIItems_200_response_items_inner::is_bundle_items_Set() const{
    return m_bundle_items_isSet;
}

bool OAIItems_200_response_items_inner::is_bundle_items_Valid() const{
    return m_bundle_items_isValid;
}

QString OAIItems_200_response_items_inner::getDetailUrl() const {
    return m_detail_url;
}
void OAIItems_200_response_items_inner::setDetailUrl(const QString &detail_url) {
    m_detail_url = detail_url;
    m_detail_url_isSet = true;
}

bool OAIItems_200_response_items_inner::is_detail_url_Set() const{
    return m_detail_url_isSet;
}

bool OAIItems_200_response_items_inner::is_detail_url_Valid() const{
    return m_detail_url_isValid;
}

QString OAIItems_200_response_items_inner::getEan() const {
    return m_ean;
}
void OAIItems_200_response_items_inner::setEan(const QString &ean) {
    m_ean = ean;
    m_ean_isSet = true;
}

bool OAIItems_200_response_items_inner::is_ean_Set() const{
    return m_ean_isSet;
}

bool OAIItems_200_response_items_inner::is_ean_Valid() const{
    return m_ean_isValid;
}

QString OAIItems_200_response_items_inner::getId() const {
    return m_id;
}
void OAIItems_200_response_items_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIItems_200_response_items_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIItems_200_response_items_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIItems_200_response_items_inner::getImageUrl() const {
    return m_image_url;
}
void OAIItems_200_response_items_inner::setImageUrl(const QString &image_url) {
    m_image_url = image_url;
    m_image_url_isSet = true;
}

bool OAIItems_200_response_items_inner::is_image_url_Set() const{
    return m_image_url_isSet;
}

bool OAIItems_200_response_items_inner::is_image_url_Valid() const{
    return m_image_url_isValid;
}

bool OAIItems_200_response_items_inner::isIsGift() const {
    return m_is_gift;
}
void OAIItems_200_response_items_inner::setIsGift(const bool &is_gift) {
    m_is_gift = is_gift;
    m_is_gift_isSet = true;
}

bool OAIItems_200_response_items_inner::is_is_gift_Set() const{
    return m_is_gift_isSet;
}

bool OAIItems_200_response_items_inner::is_is_gift_Valid() const{
    return m_is_gift_isValid;
}

qint32 OAIItems_200_response_items_inner::getListPrice() const {
    return m_list_price;
}
void OAIItems_200_response_items_inner::setListPrice(const qint32 &list_price) {
    m_list_price = list_price;
    m_list_price_isSet = true;
}

bool OAIItems_200_response_items_inner::is_list_price_Set() const{
    return m_list_price_isSet;
}

bool OAIItems_200_response_items_inner::is_list_price_Valid() const{
    return m_list_price_isValid;
}

qint32 OAIItems_200_response_items_inner::getManualPrice() const {
    return m_manual_price;
}
void OAIItems_200_response_items_inner::setManualPrice(const qint32 &manual_price) {
    m_manual_price = manual_price;
    m_manual_price_isSet = true;
}

bool OAIItems_200_response_items_inner::is_manual_price_Set() const{
    return m_manual_price_isSet;
}

bool OAIItems_200_response_items_inner::is_manual_price_Valid() const{
    return m_manual_price_isValid;
}

QString OAIItems_200_response_items_inner::getManualPriceAppliedBy() const {
    return m_manual_price_applied_by;
}
void OAIItems_200_response_items_inner::setManualPriceAppliedBy(const QString &manual_price_applied_by) {
    m_manual_price_applied_by = manual_price_applied_by;
    m_manual_price_applied_by_isSet = true;
}

bool OAIItems_200_response_items_inner::is_manual_price_applied_by_Set() const{
    return m_manual_price_applied_by_isSet;
}

bool OAIItems_200_response_items_inner::is_manual_price_applied_by_Valid() const{
    return m_manual_price_applied_by_isValid;
}

QString OAIItems_200_response_items_inner::getManufacturerCode() const {
    return m_manufacturer_code;
}
void OAIItems_200_response_items_inner::setManufacturerCode(const QString &manufacturer_code) {
    m_manufacturer_code = manufacturer_code;
    m_manufacturer_code_isSet = true;
}

bool OAIItems_200_response_items_inner::is_manufacturer_code_Set() const{
    return m_manufacturer_code_isSet;
}

bool OAIItems_200_response_items_inner::is_manufacturer_code_Valid() const{
    return m_manufacturer_code_isValid;
}

QString OAIItems_200_response_items_inner::getMeasurementUnit() const {
    return m_measurement_unit;
}
void OAIItems_200_response_items_inner::setMeasurementUnit(const QString &measurement_unit) {
    m_measurement_unit = measurement_unit;
    m_measurement_unit_isSet = true;
}

bool OAIItems_200_response_items_inner::is_measurement_unit_Set() const{
    return m_measurement_unit_isSet;
}

bool OAIItems_200_response_items_inner::is_measurement_unit_Valid() const{
    return m_measurement_unit_isValid;
}

QString OAIItems_200_response_items_inner::getModalType() const {
    return m_modal_type;
}
void OAIItems_200_response_items_inner::setModalType(const QString &modal_type) {
    m_modal_type = modal_type;
    m_modal_type_isSet = true;
}

bool OAIItems_200_response_items_inner::is_modal_type_Set() const{
    return m_modal_type_isSet;
}

bool OAIItems_200_response_items_inner::is_modal_type_Valid() const{
    return m_modal_type_isValid;
}

QString OAIItems_200_response_items_inner::getName() const {
    return m_name;
}
void OAIItems_200_response_items_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIItems_200_response_items_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIItems_200_response_items_inner::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIItems_200_response_items_inner::getParentAssemblyBinding() const {
    return m_parent_assembly_binding;
}
void OAIItems_200_response_items_inner::setParentAssemblyBinding(const QString &parent_assembly_binding) {
    m_parent_assembly_binding = parent_assembly_binding;
    m_parent_assembly_binding_isSet = true;
}

bool OAIItems_200_response_items_inner::is_parent_assembly_binding_Set() const{
    return m_parent_assembly_binding_isSet;
}

bool OAIItems_200_response_items_inner::is_parent_assembly_binding_Valid() const{
    return m_parent_assembly_binding_isValid;
}

qint32 OAIItems_200_response_items_inner::getParentItemIndex() const {
    return m_parent_item_index;
}
void OAIItems_200_response_items_inner::setParentItemIndex(const qint32 &parent_item_index) {
    m_parent_item_index = parent_item_index;
    m_parent_item_index_isSet = true;
}

bool OAIItems_200_response_items_inner::is_parent_item_index_Set() const{
    return m_parent_item_index_isSet;
}

bool OAIItems_200_response_items_inner::is_parent_item_index_Valid() const{
    return m_parent_item_index_isValid;
}

QString OAIItems_200_response_items_inner::getPreSaleDate() const {
    return m_pre_sale_date;
}
void OAIItems_200_response_items_inner::setPreSaleDate(const QString &pre_sale_date) {
    m_pre_sale_date = pre_sale_date;
    m_pre_sale_date_isSet = true;
}

bool OAIItems_200_response_items_inner::is_pre_sale_date_Set() const{
    return m_pre_sale_date_isSet;
}

bool OAIItems_200_response_items_inner::is_pre_sale_date_Valid() const{
    return m_pre_sale_date_isValid;
}

qint32 OAIItems_200_response_items_inner::getPrice() const {
    return m_price;
}
void OAIItems_200_response_items_inner::setPrice(const qint32 &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIItems_200_response_items_inner::is_price_Set() const{
    return m_price_isSet;
}

bool OAIItems_200_response_items_inner::is_price_Valid() const{
    return m_price_isValid;
}

OAIAddCoupons_200_response_items_inner_priceDefinition OAIItems_200_response_items_inner::getPriceDefinition() const {
    return m_price_definition;
}
void OAIItems_200_response_items_inner::setPriceDefinition(const OAIAddCoupons_200_response_items_inner_priceDefinition &price_definition) {
    m_price_definition = price_definition;
    m_price_definition_isSet = true;
}

bool OAIItems_200_response_items_inner::is_price_definition_Set() const{
    return m_price_definition_isSet;
}

bool OAIItems_200_response_items_inner::is_price_definition_Valid() const{
    return m_price_definition_isValid;
}

QList<OAIAddCoupons_200_response_items_inner_priceTags_inner> OAIItems_200_response_items_inner::getPriceTags() const {
    return m_price_tags;
}
void OAIItems_200_response_items_inner::setPriceTags(const QList<OAIAddCoupons_200_response_items_inner_priceTags_inner> &price_tags) {
    m_price_tags = price_tags;
    m_price_tags_isSet = true;
}

bool OAIItems_200_response_items_inner::is_price_tags_Set() const{
    return m_price_tags_isSet;
}

bool OAIItems_200_response_items_inner::is_price_tags_Valid() const{
    return m_price_tags_isValid;
}

QString OAIItems_200_response_items_inner::getPriceValidUntil() const {
    return m_price_valid_until;
}
void OAIItems_200_response_items_inner::setPriceValidUntil(const QString &price_valid_until) {
    m_price_valid_until = price_valid_until;
    m_price_valid_until_isSet = true;
}

bool OAIItems_200_response_items_inner::is_price_valid_until_Set() const{
    return m_price_valid_until_isSet;
}

bool OAIItems_200_response_items_inner::is_price_valid_until_Valid() const{
    return m_price_valid_until_isValid;
}

OAIAddCoupons_200_response_items_inner_productCategories OAIItems_200_response_items_inner::getProductCategories() const {
    return m_product_categories;
}
void OAIItems_200_response_items_inner::setProductCategories(const OAIAddCoupons_200_response_items_inner_productCategories &product_categories) {
    m_product_categories = product_categories;
    m_product_categories_isSet = true;
}

bool OAIItems_200_response_items_inner::is_product_categories_Set() const{
    return m_product_categories_isSet;
}

bool OAIItems_200_response_items_inner::is_product_categories_Valid() const{
    return m_product_categories_isValid;
}

QString OAIItems_200_response_items_inner::getProductCategoryIds() const {
    return m_product_category_ids;
}
void OAIItems_200_response_items_inner::setProductCategoryIds(const QString &product_category_ids) {
    m_product_category_ids = product_category_ids;
    m_product_category_ids_isSet = true;
}

bool OAIItems_200_response_items_inner::is_product_category_ids_Set() const{
    return m_product_category_ids_isSet;
}

bool OAIItems_200_response_items_inner::is_product_category_ids_Valid() const{
    return m_product_category_ids_isValid;
}

QString OAIItems_200_response_items_inner::getProductId() const {
    return m_product_id;
}
void OAIItems_200_response_items_inner::setProductId(const QString &product_id) {
    m_product_id = product_id;
    m_product_id_isSet = true;
}

bool OAIItems_200_response_items_inner::is_product_id_Set() const{
    return m_product_id_isSet;
}

bool OAIItems_200_response_items_inner::is_product_id_Valid() const{
    return m_product_id_isValid;
}

QString OAIItems_200_response_items_inner::getProductRefId() const {
    return m_product_ref_id;
}
void OAIItems_200_response_items_inner::setProductRefId(const QString &product_ref_id) {
    m_product_ref_id = product_ref_id;
    m_product_ref_id_isSet = true;
}

bool OAIItems_200_response_items_inner::is_product_ref_id_Set() const{
    return m_product_ref_id_isSet;
}

bool OAIItems_200_response_items_inner::is_product_ref_id_Valid() const{
    return m_product_ref_id_isValid;
}

qint32 OAIItems_200_response_items_inner::getQuantity() const {
    return m_quantity;
}
void OAIItems_200_response_items_inner::setQuantity(const qint32 &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIItems_200_response_items_inner::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIItems_200_response_items_inner::is_quantity_Valid() const{
    return m_quantity_isValid;
}

QString OAIItems_200_response_items_inner::getRefId() const {
    return m_ref_id;
}
void OAIItems_200_response_items_inner::setRefId(const QString &ref_id) {
    m_ref_id = ref_id;
    m_ref_id_isSet = true;
}

bool OAIItems_200_response_items_inner::is_ref_id_Set() const{
    return m_ref_id_isSet;
}

bool OAIItems_200_response_items_inner::is_ref_id_Valid() const{
    return m_ref_id_isValid;
}

qint32 OAIItems_200_response_items_inner::getRewardValue() const {
    return m_reward_value;
}
void OAIItems_200_response_items_inner::setRewardValue(const qint32 &reward_value) {
    m_reward_value = reward_value;
    m_reward_value_isSet = true;
}

bool OAIItems_200_response_items_inner::is_reward_value_Set() const{
    return m_reward_value_isSet;
}

bool OAIItems_200_response_items_inner::is_reward_value_Valid() const{
    return m_reward_value_isValid;
}

QString OAIItems_200_response_items_inner::getSeller() const {
    return m_seller;
}
void OAIItems_200_response_items_inner::setSeller(const QString &seller) {
    m_seller = seller;
    m_seller_isSet = true;
}

bool OAIItems_200_response_items_inner::is_seller_Set() const{
    return m_seller_isSet;
}

bool OAIItems_200_response_items_inner::is_seller_Valid() const{
    return m_seller_isValid;
}

QList<QString> OAIItems_200_response_items_inner::getSellerChain() const {
    return m_seller_chain;
}
void OAIItems_200_response_items_inner::setSellerChain(const QList<QString> &seller_chain) {
    m_seller_chain = seller_chain;
    m_seller_chain_isSet = true;
}

bool OAIItems_200_response_items_inner::is_seller_chain_Set() const{
    return m_seller_chain_isSet;
}

bool OAIItems_200_response_items_inner::is_seller_chain_Valid() const{
    return m_seller_chain_isValid;
}

qint32 OAIItems_200_response_items_inner::getSellingPrice() const {
    return m_selling_price;
}
void OAIItems_200_response_items_inner::setSellingPrice(const qint32 &selling_price) {
    m_selling_price = selling_price;
    m_selling_price_isSet = true;
}

bool OAIItems_200_response_items_inner::is_selling_price_Set() const{
    return m_selling_price_isSet;
}

bool OAIItems_200_response_items_inner::is_selling_price_Valid() const{
    return m_selling_price_isValid;
}

QString OAIItems_200_response_items_inner::getSkuName() const {
    return m_sku_name;
}
void OAIItems_200_response_items_inner::setSkuName(const QString &sku_name) {
    m_sku_name = sku_name;
    m_sku_name_isSet = true;
}

bool OAIItems_200_response_items_inner::is_sku_name_Set() const{
    return m_sku_name_isSet;
}

bool OAIItems_200_response_items_inner::is_sku_name_Valid() const{
    return m_sku_name_isValid;
}

qint32 OAIItems_200_response_items_inner::getTax() const {
    return m_tax;
}
void OAIItems_200_response_items_inner::setTax(const qint32 &tax) {
    m_tax = tax;
    m_tax_isSet = true;
}

bool OAIItems_200_response_items_inner::is_tax_Set() const{
    return m_tax_isSet;
}

bool OAIItems_200_response_items_inner::is_tax_Valid() const{
    return m_tax_isValid;
}

QString OAIItems_200_response_items_inner::getUniqueId() const {
    return m_unique_id;
}
void OAIItems_200_response_items_inner::setUniqueId(const QString &unique_id) {
    m_unique_id = unique_id;
    m_unique_id_isSet = true;
}

bool OAIItems_200_response_items_inner::is_unique_id_Set() const{
    return m_unique_id_isSet;
}

bool OAIItems_200_response_items_inner::is_unique_id_Valid() const{
    return m_unique_id_isValid;
}

qint32 OAIItems_200_response_items_inner::getUnitMultiplier() const {
    return m_unit_multiplier;
}
void OAIItems_200_response_items_inner::setUnitMultiplier(const qint32 &unit_multiplier) {
    m_unit_multiplier = unit_multiplier;
    m_unit_multiplier_isSet = true;
}

bool OAIItems_200_response_items_inner::is_unit_multiplier_Set() const{
    return m_unit_multiplier_isSet;
}

bool OAIItems_200_response_items_inner::is_unit_multiplier_Valid() const{
    return m_unit_multiplier_isValid;
}

bool OAIItems_200_response_items_inner::isSet() const {
...
bool OAIItems_200_response_items_inner::isValid() const {
