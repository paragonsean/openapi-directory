...
/*
 * OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address.h
 *
 * Address information.
 */

#ifndef OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address_H
#define OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address_H
...
class OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address : public OAIObject {
public:
    OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address();
    OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address(QString json);
    ~OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address)

#endif // OAIAddCoupons_200_response_shippingData_logisticsInfo_inner_slas_inner_pickupStoreInfo_address_H
