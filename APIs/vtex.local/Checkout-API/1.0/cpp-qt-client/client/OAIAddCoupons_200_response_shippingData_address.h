...
/*
 * OAIAddCoupons_200_response_shippingData_address.h
 *
 * Address information.
 */

#ifndef OAIAddCoupons_200_response_shippingData_address_H
#define OAIAddCoupons_200_response_shippingData_address_H
...
class OAIAddCoupons_200_response_shippingData_address : public OAIObject {
public:
    OAIAddCoupons_200_response_shippingData_address();
    OAIAddCoupons_200_response_shippingData_address(QString json);
    ~OAIAddCoupons_200_response_shippingData_address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddCoupons_200_response_shippingData_address)

#endif // OAIAddCoupons_200_response_shippingData_address_H
