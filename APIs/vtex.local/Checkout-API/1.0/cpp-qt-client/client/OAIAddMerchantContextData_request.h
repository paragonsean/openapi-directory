...
/*
 * OAIAddMerchantContextData_request.h
 *
 * 
 */

#ifndef OAIAddMerchantContextData_request_H
#define OAIAddMerchantContextData_request_H
...
class OAIAddMerchantContextData_request : public OAIObject {
public:
    OAIAddMerchantContextData_request();
    OAIAddMerchantContextData_request(QString json);
    ~OAIAddMerchantContextData_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddMerchantContextData_request)

#endif // OAIAddMerchantContextData_request_H
