...
OAIPlaceOrder_request_marketingData::OAIPlaceOrder_request_marketingData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlaceOrder_request_marketingData::OAIPlaceOrder_request_marketingData() {
    this->initializeModel();
}

OAIPlaceOrder_request_marketingData::~OAIPlaceOrder_request_marketingData() {}

void OAIPlaceOrder_request_marketingData::initializeModel() {
...
void OAIPlaceOrder_request_marketingData::fromJson(QString jsonString) {
...
void OAIPlaceOrder_request_marketingData::fromJsonObject(QJsonObject json) {
...
QString OAIPlaceOrder_request_marketingData::asJson() const {
...
QJsonObject OAIPlaceOrder_request_marketingData::asJsonObject() const {
    QJsonObject obj;
    if (m_coupon_isSet) {
...
QString OAIPlaceOrder_request_marketingData::getCoupon() const {
    return m_coupon;
}
void OAIPlaceOrder_request_marketingData::setCoupon(const QString &coupon) {
    m_coupon = coupon;
    m_coupon_isSet = true;
}

bool OAIPlaceOrder_request_marketingData::is_coupon_Set() const{
    return m_coupon_isSet;
}

bool OAIPlaceOrder_request_marketingData::is_coupon_Valid() const{
    return m_coupon_isValid;
}

QString OAIPlaceOrder_request_marketingData::getUtmCampaign() const {
    return m_utm_campaign;
}
void OAIPlaceOrder_request_marketingData::setUtmCampaign(const QString &utm_campaign) {
    m_utm_campaign = utm_campaign;
    m_utm_campaign_isSet = true;
}

bool OAIPlaceOrder_request_marketingData::is_utm_campaign_Set() const{
    return m_utm_campaign_isSet;
}

bool OAIPlaceOrder_request_marketingData::is_utm_campaign_Valid() const{
    return m_utm_campaign_isValid;
}

QString OAIPlaceOrder_request_marketingData::getUtmMedium() const {
    return m_utm_medium;
}
void OAIPlaceOrder_request_marketingData::setUtmMedium(const QString &utm_medium) {
    m_utm_medium = utm_medium;
    m_utm_medium_isSet = true;
}

bool OAIPlaceOrder_request_marketingData::is_utm_medium_Set() const{
    return m_utm_medium_isSet;
}

bool OAIPlaceOrder_request_marketingData::is_utm_medium_Valid() const{
    return m_utm_medium_isValid;
}

QString OAIPlaceOrder_request_marketingData::getUtmSource() const {
    return m_utm_source;
}
void OAIPlaceOrder_request_marketingData::setUtmSource(const QString &utm_source) {
    m_utm_source = utm_source;
    m_utm_source_isSet = true;
}

bool OAIPlaceOrder_request_marketingData::is_utm_source_Set() const{
    return m_utm_source_isSet;
}

bool OAIPlaceOrder_request_marketingData::is_utm_source_Valid() const{
    return m_utm_source_isValid;
}

QString OAIPlaceOrder_request_marketingData::getUtmiCampaign() const {
    return m_utmi_campaign;
}
void OAIPlaceOrder_request_marketingData::setUtmiCampaign(const QString &utmi_campaign) {
    m_utmi_campaign = utmi_campaign;
    m_utmi_campaign_isSet = true;
}

bool OAIPlaceOrder_request_marketingData::is_utmi_campaign_Set() const{
    return m_utmi_campaign_isSet;
}

bool OAIPlaceOrder_request_marketingData::is_utmi_campaign_Valid() const{
    return m_utmi_campaign_isValid;
}

QString OAIPlaceOrder_request_marketingData::getUtmiPage() const {
    return m_utmi_page;
}
void OAIPlaceOrder_request_marketingData::setUtmiPage(const QString &utmi_page) {
    m_utmi_page = utmi_page;
    m_utmi_page_isSet = true;
}

bool OAIPlaceOrder_request_marketingData::is_utmi_page_Set() const{
    return m_utmi_page_isSet;
}

bool OAIPlaceOrder_request_marketingData::is_utmi_page_Valid() const{
    return m_utmi_page_isValid;
}

QString OAIPlaceOrder_request_marketingData::getUtmiPart() const {
    return m_utmi_part;
}
void OAIPlaceOrder_request_marketingData::setUtmiPart(const QString &utmi_part) {
    m_utmi_part = utmi_part;
    m_utmi_part_isSet = true;
}

bool OAIPlaceOrder_request_marketingData::is_utmi_part_Set() const{
    return m_utmi_part_isSet;
}

bool OAIPlaceOrder_request_marketingData::is_utmi_part_Valid() const{
    return m_utmi_part_isValid;
}

bool OAIPlaceOrder_request_marketingData::isSet() const {
...
bool OAIPlaceOrder_request_marketingData::isValid() const {
