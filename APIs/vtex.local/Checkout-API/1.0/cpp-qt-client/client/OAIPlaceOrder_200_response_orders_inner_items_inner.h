...
/*
 * OAIPlaceOrder_200_response_orders_inner_items_inner.h
 *
 * 
 */

#ifndef OAIPlaceOrder_200_response_orders_inner_items_inner_H
#define OAIPlaceOrder_200_response_orders_inner_items_inner_H
...
class OAIPlaceOrder_200_response_orders_inner_items_inner : public OAIObject {
public:
    OAIPlaceOrder_200_response_orders_inner_items_inner();
    OAIPlaceOrder_200_response_orders_inner_items_inner(QString json);
    ~OAIPlaceOrder_200_response_orders_inner_items_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaceOrder_200_response_orders_inner_items_inner)

#endif // OAIPlaceOrder_200_response_orders_inner_items_inner_H
