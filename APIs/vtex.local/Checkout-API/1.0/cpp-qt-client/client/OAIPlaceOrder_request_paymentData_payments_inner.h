...
/*
 * OAIPlaceOrder_request_paymentData_payments_inner.h
 *
 * 
 */

#ifndef OAIPlaceOrder_request_paymentData_payments_inner_H
#define OAIPlaceOrder_request_paymentData_payments_inner_H
...
class OAIPlaceOrder_request_paymentData_payments_inner : public OAIObject {
public:
    OAIPlaceOrder_request_paymentData_payments_inner();
    OAIPlaceOrder_request_paymentData_payments_inner(QString json);
    ~OAIPlaceOrder_request_paymentData_payments_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaceOrder_request_paymentData_payments_inner)

#endif // OAIPlaceOrder_request_paymentData_payments_inner_H
