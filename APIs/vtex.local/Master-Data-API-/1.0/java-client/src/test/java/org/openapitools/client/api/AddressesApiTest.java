...
public class AddressesApiTest {
     ...
     */
    @Test
    public void createNewCustomerAddressTest() throws ApiException {
        String contentType = null;
        String accept = null;
        CreateUpdateAddressRequests createUpdateAddressRequests = null;
        String schema = null;
        DocumentResponse response = api.createNewCustomerAddress(contentType, accept, createUpdateAddressRequests, schema);
     ...
     */
    @Test
    public void deleteCustomerAddressTest() throws ApiException {
        String contentType = null;
        String accept = null;
        String id = null;
        DocumentResponse response = api.deleteCustomerAddress(contentType, accept, id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateCustomerAddressTest() throws ApiException {
        String contentType = null;
        String accept = null;
        String id = null;
        CreateUpdateAddressRequests createUpdateAddressRequests = null;
        String schema = null;
        DocumentResponse response = api.updateCustomerAddress(contentType, accept, id, createUpdateAddressRequests, schema);
        // TODO: test validations
    }
