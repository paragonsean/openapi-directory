...
public class SaveschemabynameRequest {
  ...
  public SaveschemabynameRequest() {
  }

  public SaveschemabynameRequest properties(Properties properties) {
  ...
  public boolean equals(Object o) {
    ...
    SaveschemabynameRequest saveschemabynameRequest = (SaveschemabynameRequest) o;
    return Objects.equals(this.properties, saveschemabynameRequest.properties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SaveschemabynameRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SaveschemabynameRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SaveschemabynameRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SaveschemabynameRequest is not found in the empty JSON string", SaveschemabynameRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SaveschemabynameRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SaveschemabynameRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SaveschemabynameRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SaveschemabynameRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SaveschemabynameRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SaveschemabynameRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SaveschemabynameRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SaveschemabynameRequest>() {
           @Override
           public void write(JsonWriter out, SaveschemabynameRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SaveschemabynameRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SaveschemabynameRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SaveschemabynameRequest
   * @throws IOException if the JSON string is invalid with respect to SaveschemabynameRequest
   */
  public static SaveschemabynameRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SaveschemabynameRequest.class);
  }

  /**
   * Convert an instance of SaveschemabynameRequest to an JSON string
   *
   * @return JSON string
   */
