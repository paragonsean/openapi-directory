...
class DocumentResponse {
     ...
     * @param href {String} Document reference URL.
     * @param id {String} ID of the document that was created or updated.
     */
    constructor(href, id) { 
        
        DocumentResponse.initialize(this, href, id);
    }
...
DocumentResponse.RequiredProperties = ["Href", "Id"];

/**
 * Document reference URL.
 * @member {String} Href
 */
DocumentResponse.prototype['Href'] = undefined;
