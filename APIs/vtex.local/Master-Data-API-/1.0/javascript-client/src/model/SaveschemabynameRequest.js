...
/**
 * The SaveschemabynameRequest model module.
 * @module model/SaveschemabynameRequest
 * @version 1.0
 */
class SaveschemabynameRequest {
    /**
     * Constructs a new <code>SaveschemabynameRequest</code>.
     * @alias module:model/SaveschemabynameRequest
     * @param properties {module:model/Properties} 
     */
    constructor(properties) { 
        
        SaveschemabynameRequest.initialize(this, properties);
    }
    ...
    /**
     * Constructs a <code>SaveschemabynameRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SaveschemabynameRequest} obj Optional instance to populate.
     * @return {module:model/SaveschemabynameRequest} The populated <code>SaveschemabynameRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SaveschemabynameRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SaveschemabynameRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SaveschemabynameRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SaveschemabynameRequest.RequiredProperties) {
...
SaveschemabynameRequest.RequiredProperties = ["properties"];

/**
 * @member {module:model/Properties} properties
 */
SaveschemabynameRequest.prototype['properties'] = undefined;
...
export default SaveschemabynameRequest;
