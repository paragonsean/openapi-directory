...
export default class AddressesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createNewCustomerAddress operation.
     * @callback module:api/AddressesApi~createNewCustomerAddressCallback
     ...
     * @param {module:model/CreateUpdateAddressRequests} createUpdateAddressRequests 
     * @param {Object} opts Optional parameters
     * @param {String} [schema] Name of the schema the document to be created needs to be compliant with.
     * @param {module:api/AddressesApi~createNewCustomerAddressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DocumentResponse}
     */
    createNewCustomerAddress(contentType, accept, createUpdateAddressRequests, opts, callback) {
      opts = opts || {};
      let postBody = createUpdateAddressRequests;
      // verify the required parameter 'contentType' is set
      if (contentType === undefined || contentType === null) {
        throw new Error("Missing the required parameter 'contentType' when calling createNewCustomerAddress");
      }
      // verify the required parameter 'accept' is set
      if (accept === undefined || accept === null) {
        throw new Error("Missing the required parameter 'accept' when calling createNewCustomerAddress");
      }
      // verify the required parameter 'createUpdateAddressRequests' is set
      if (createUpdateAddressRequests === undefined || createUpdateAddressRequests === null) {
        throw new Error("Missing the required parameter 'createUpdateAddressRequests' when calling createNewCustomerAddress");
      }
      ...
      return this.apiClient.callApi(
        '/api/dataentities/Address/documents', 'POST',
    ...
    /**
     * Callback function to receive the result of the deleteCustomerAddress operation.
     * @callback module:api/AddressesApi~deleteCustomerAddressCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DocumentResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/AddressesApi~deleteCustomerAddressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DocumentResponse}
     */
    deleteCustomerAddress(contentType, accept, id, callback) {
      let postBody = null;
      // verify the required parameter 'contentType' is set
      if (contentType === undefined || contentType === null) {
        throw new Error("Missing the required parameter 'contentType' when calling deleteCustomerAddress");
      }
      // verify the required parameter 'accept' is set
      if (accept === undefined || accept === null) {
        throw new Error("Missing the required parameter 'accept' when calling deleteCustomerAddress");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteCustomerAddress");
      }
      ...
      let returnType = DocumentResponse;
      return this.apiClient.callApi(
        '/api/dataentities/Address/documents/{id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateCustomerAddress operation.
     * @callback module:api/AddressesApi~updateCustomerAddressCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DocumentResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [schema] Name of the schema the document to be created needs to be compliant with.
     * @param {module:api/AddressesApi~updateCustomerAddressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DocumentResponse}
     */
    updateCustomerAddress(contentType, accept, id, createUpdateAddressRequests, opts, callback) {
      opts = opts || {};
      let postBody = createUpdateAddressRequests;
      // verify the required parameter 'contentType' is set
      if (contentType === undefined || contentType === null) {
        throw new Error("Missing the required parameter 'contentType' when calling updateCustomerAddress");
      }
      // verify the required parameter 'accept' is set
      if (accept === undefined || accept === null) {
        throw new Error("Missing the required parameter 'accept' when calling updateCustomerAddress");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateCustomerAddress");
      }
      // verify the required parameter 'createUpdateAddressRequests' is set
      if (createUpdateAddressRequests === undefined || createUpdateAddressRequests === null) {
        throw new Error("Missing the required parameter 'createUpdateAddressRequests' when calling updateCustomerAddress");
      }
      ...
      let returnType = DocumentResponse;
      return this.apiClient.callApi(
        '/api/dataentities/Address/documents/{id}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
