# MasterDataApiV2.CreateUpdateAddressRequests

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**addressName** | **String** | Address name. | [optional] 
...
**neighborhood** | **String** | Neighborhood of the address. | [optional] 
...
**userId** | **String** | ID of the customer to whom the address belongs. | [optional] 
