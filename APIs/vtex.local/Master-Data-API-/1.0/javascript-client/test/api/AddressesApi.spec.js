...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV2.AddressesApi();
  });
  ...
  describe('AddressesApi', function() {
    describe('createNewCustomerAddress', function() {
      it('should call createNewCustomerAddress successfully', function(done) {
        //uncomment below and update the code to test createNewCustomerAddress
        //instance.createNewCustomerAddress(function(error) {
    ...
    describe('deleteCustomerAddress', function() {
      it('should call deleteCustomerAddress successfully', function(done) {
        //uncomment below and update the code to test deleteCustomerAddress
        //instance.deleteCustomerAddress(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateCustomerAddress', function() {
      it('should call updateCustomerAddress successfully', function(done) {
        //uncomment below and update the code to test updateCustomerAddress
        //instance.updateCustomerAddress(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
