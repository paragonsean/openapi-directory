...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV2.IndicesApi();
  });
  ...
  describe('IndicesApi', function() {
    describe('deleteindexbyname', function() {
      it('should call deleteindexbyname successfully', function(done) {
        //uncomment below and update the code to test deleteindexbyname
        //instance.deleteindexbyname(function(error) {
    ...
    describe('getindexbyname', function() {
      it('should call getindexbyname successfully', function(done) {
        //uncomment below and update the code to test getindexbyname
        //instance.getindexbyname(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getindices', function() {
      it('should call getindices successfully', function(done) {
        //uncomment below and update the code to test getindices
        //instance.getindices(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('putindices', function() {
      it('should call putindices successfully', function(done) {
        //uncomment below and update the code to test putindices
        //instance.putindices(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
