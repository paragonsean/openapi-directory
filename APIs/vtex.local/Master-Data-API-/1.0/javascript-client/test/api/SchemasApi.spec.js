...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV2.SchemasApi();
  });
  ...
  describe('SchemasApi', function() {
    describe('deleteschemabyname', function() {
      it('should call deleteschemabyname successfully', function(done) {
        //uncomment below and update the code to test deleteschemabyname
        //instance.deleteschemabyname(function(error) {
    ...
    describe('getschemabyname', function() {
      it('should call getschemabyname successfully', function(done) {
        //uncomment below and update the code to test getschemabyname
        //instance.getschemabyname(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('saveschemabyname', function() {
      it('should call saveschemabyname successfully', function(done) {
        //uncomment below and update the code to test saveschemabyname
        //instance.saveschemabyname(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
