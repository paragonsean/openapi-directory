...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV2.Scores();
  });
  ...
  describe('Scores', function() {
    it('should create an instance of Scores', function() {
      // uncomment below and update the code to test Scores
      //var instance = new MasterDataApiV2.Scores();
      //expect(instance).to.be.a(MasterDataApiV2.Scores);
    });

    it('should have the property arEVentilao (base name: "Ar e Ventilação")', function() {
      // uncomment below and update the code to test the property arEVentilao
      //var instance = new MasterDataApiV2.Scores();
