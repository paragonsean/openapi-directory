...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV2.ValidatedocumentbyclustersRequest();
  });
  ...
  describe('ValidatedocumentbyclustersRequest', function() {
    it('should create an instance of ValidatedocumentbyclustersRequest', function() {
      ...
      //var instance = new MasterDataApiV2.ValidatedocumentbyclustersRequest();
      //expect(instance).to.be.a(MasterDataApiV2.ValidatedocumentbyclustersRequest);
    });
