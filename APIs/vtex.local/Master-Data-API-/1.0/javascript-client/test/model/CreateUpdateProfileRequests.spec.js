...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV2.CreateUpdateProfileRequests();
  });
  ...
  describe('CreateUpdateProfileRequests', function() {
    it('should create an instance of CreateUpdateProfileRequests', function() {
      // uncomment below and update the code to test CreateUpdateProfileRequests
      //var instance = new MasterDataApiV2.CreateUpdateProfileRequests();
      //expect(instance).to.be.a(MasterDataApiV2.CreateUpdateProfileRequests);
    });
    ...
    it('should have the property isNewsletterOptIn (base name: "isNewsletterOptIn")', function() {
      // uncomment below and update the code to test the property isNewsletterOptIn
      //var instance = new MasterDataApiV2.CreateUpdateProfileRequests();
      //expect(instance).to.be();
    });
    ...
    it('should have the property localeDefault (base name: "localeDefault")', function() {
