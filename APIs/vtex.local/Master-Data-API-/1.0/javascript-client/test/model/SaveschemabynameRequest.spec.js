...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV2.SaveschemabynameRequest();
  });
  ...
  describe('SaveschemabynameRequest', function() {
    it('should create an instance of SaveschemabynameRequest', function() {
      // uncomment below and update the code to test SaveschemabynameRequest
      //var instance = new MasterDataApiV2.SaveschemabynameRequest();
      //expect(instance).to.be.a(MasterDataApiV2.SaveschemabynameRequest);
    });
