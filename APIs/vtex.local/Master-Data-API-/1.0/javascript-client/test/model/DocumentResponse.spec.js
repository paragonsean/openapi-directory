...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV2.DocumentResponse();
  });
  ...
  describe('DocumentResponse', function() {
    it('should create an instance of DocumentResponse', function() {
      ...
      //var instance = new MasterDataApiV2.DocumentResponse();
      //expect(instance).to.be.a(MasterDataApiV2.DocumentResponse);
    });
