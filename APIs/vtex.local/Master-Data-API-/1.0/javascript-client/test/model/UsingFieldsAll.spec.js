...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV2.UsingFieldsAll();
  });
  ...
  describe('UsingFieldsAll', function() {
    it('should create an instance of UsingFieldsAll', function() {
      // uncomment below and update the code to test UsingFieldsAll
      //var instance = new MasterDataApiV2.UsingFieldsAll();
      //expect(instance).to.be.a(MasterDataApiV2.UsingFieldsAll);
    });
