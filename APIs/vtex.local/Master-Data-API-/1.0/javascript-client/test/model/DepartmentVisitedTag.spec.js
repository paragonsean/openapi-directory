...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV2.DepartmentVisitedTag();
  });
  ...
  describe('DepartmentVisitedTag', function() {
    it('should create an instance of DepartmentVisitedTag', function() {
      // uncomment below and update the code to test DepartmentVisitedTag
      //var instance = new MasterDataApiV2.DepartmentVisitedTag();
      //expect(instance).to.be.a(MasterDataApiV2.DepartmentVisitedTag);
    });
