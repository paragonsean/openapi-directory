...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV2.PutindicesRequest();
  });
  ...
  describe('PutindicesRequest', function() {
    it('should create an instance of PutindicesRequest', function() {
      // uncomment below and update the code to test PutindicesRequest
      //var instance = new MasterDataApiV2.PutindicesRequest();
      //expect(instance).to.be.a(MasterDataApiV2.PutindicesRequest);
    });
