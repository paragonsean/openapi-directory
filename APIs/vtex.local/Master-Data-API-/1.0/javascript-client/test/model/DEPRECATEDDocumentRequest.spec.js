...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV2.DEPRECATEDDocumentRequest();
  });
  ...
  describe('DEPRECATEDDocumentRequest', function() {
    it('should create an instance of DEPRECATEDDocumentRequest', function() {
      // uncomment below and update the code to test DEPRECATEDDocumentRequest
      //var instance = new MasterDataApiV2.DEPRECATEDDocumentRequest();
      //expect(instance).to.be.a(MasterDataApiV2.DEPRECATEDDocumentRequest);
    });
