...
void OAIClustersApi::validatedocumentbyclusters(const QString &data_entity_name, const QString &accept, const QString &id, const QString &body) {
    QString fullPath = QString(_serverConfigs["validatedocumentbyclusters"][_serverIndices.value("validatedocumentbyclusters")].URL()+"/api/dataentities/{dataEntityName}/documents/{id}/clusters");
