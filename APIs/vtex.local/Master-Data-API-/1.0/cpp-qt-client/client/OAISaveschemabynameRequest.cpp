...
OAISaveschemabynameRequest::OAISaveschemabynameRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISaveschemabynameRequest::OAISaveschemabynameRequest() {
    this->initializeModel();
}

OAISaveschemabynameRequest::~OAISaveschemabynameRequest() {}

void OAISaveschemabynameRequest::initializeModel() {

    m_properties_isSet = false;
    m_properties_isValid = false;
}

void OAISaveschemabynameRequest::fromJson(QString jsonString) {
...
void OAISaveschemabynameRequest::fromJsonObject(QJsonObject json) {

    m_properties_isValid = ::OpenAPI::fromJsonValue(m_properties, json[QString("properties")]);
    m_properties_isSet = !json[QString("properties")].isNull() && m_properties_isValid;
}

QString OAISaveschemabynameRequest::asJson() const {
...
QJsonObject OAISaveschemabynameRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIProperties OAISaveschemabynameRequest::getProperties() const {
    return m_properties;
}
void OAISaveschemabynameRequest::setProperties(const OAIProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAISaveschemabynameRequest::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAISaveschemabynameRequest::is_properties_Valid() const{
    return m_properties_isValid;
}

bool OAISaveschemabynameRequest::isSet() const {
...
bool OAISaveschemabynameRequest::isValid() const {
