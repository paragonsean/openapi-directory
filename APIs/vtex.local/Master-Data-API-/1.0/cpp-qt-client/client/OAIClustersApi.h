...
public:
    ...
    */
    virtual void validatedocumentbyclusters(const QString &data_entity_name, const QString &accept, const QString &id, const QString &body);
...
private:
    ...
    void validatedocumentbyclustersCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void validatedocumentbyclustersSignal();


    void validatedocumentbyclustersSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use validatedocumentbyclustersSignalError() instead")
    void validatedocumentbyclustersSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void validatedocumentbyclustersSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use validatedocumentbyclustersSignalErrorFull() instead")
    void validatedocumentbyclustersSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void validatedocumentbyclustersSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
