...
void OAISearchApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("searchdocuments", defaultConf);
    _serverIndices.insert("searchdocuments", 0);
}
...
void OAISearchApi::searchdocuments(const QString &data_entity_name, const QString &content_type, const QString &accept, const QString &rest_range, const ::OpenAPI::OptionalParam<QString> &_fields, const ::OpenAPI::OptionalParam<QString> &_where, const ::OpenAPI::OptionalParam<QString> &_schema, const ::OpenAPI::OptionalParam<QString> &_keyword, const ::OpenAPI::OptionalParam<QString> &_sort) {
    QString fullPath = QString(_serverConfigs["searchdocuments"][_serverIndices.value("searchdocuments")].URL()+"/api/dataentities/{dataEntityName}/search");
    ...
    if (_fields.hasValue())
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "_fields", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("_fields")).append(querySuffix).append(QUrl::toPercentEncoding(_fields.stringValue()));
    }
    if (_where.hasValue())
    {
        queryStyle = "form";
    ...
    if (_keyword.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "_keyword", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("_keyword")).append(querySuffix).append(QUrl::toPercentEncoding(_keyword.stringValue()));
    }
    if (_sort.hasValue())
    {
        queryStyle = "form";
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "_sort", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("_sort")).append(querySuffix).append(QUrl::toPercentEncoding(_sort.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::searchdocumentsCallback);
...
void OAISearchApi::searchdocumentsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchdocumentsSignal();
        Q_EMIT searchdocumentsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchdocumentsSignalE(error_type, error_str);
        Q_EMIT searchdocumentsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchdocumentsSignalError(error_type, error_str);
        Q_EMIT searchdocumentsSignalErrorFull(worker, error_type, error_str);
    }
}
