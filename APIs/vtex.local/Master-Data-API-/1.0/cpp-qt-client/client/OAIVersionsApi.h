...
public:
    ...
    */
    virtual void getversion(const QString &data_entity_name, const QString &content_type, const QString &accept, const QString &id, const QString &version_id);
    ...
    * @param[in]  accept QString [required]
    * @param[in]  id QString [required]
    * @param[in]  load bool [optional]
    * @param[in]  fields QString [optional]
    */
    virtual void listversions(const QString &data_entity_name, const QString &content_type, const QString &accept, const QString &id, const ::OpenAPI::OptionalParam<bool> &load = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  version_id QString [required]
    */
    virtual void putversion(const QString &data_entity_name, const QString &content_type, const QString &accept, const QString &id, const QString &version_id);
...
Q_SIGNALS:
    ...
    void putversionSignal(OAIDocumentResponse summary);
    ...
    void putversionSignalFull(OAIHttpRequestWorker *worker, OAIDocumentResponse summary);
    ...
    void putversionSignalE(OAIDocumentResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void putversionSignalError(OAIDocumentResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
