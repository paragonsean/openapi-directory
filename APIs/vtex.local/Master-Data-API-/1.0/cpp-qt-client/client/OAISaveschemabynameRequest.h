...
/*
 * OAISaveschemabynameRequest.h
 *
 * 
 */

#ifndef OAISaveschemabynameRequest_H
#define OAISaveschemabynameRequest_H
...
class OAISaveschemabynameRequest : public OAIObject {
public:
    OAISaveschemabynameRequest();
    OAISaveschemabynameRequest(QString json);
    ~OAISaveschemabynameRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISaveschemabynameRequest)

#endif // OAISaveschemabynameRequest_H
