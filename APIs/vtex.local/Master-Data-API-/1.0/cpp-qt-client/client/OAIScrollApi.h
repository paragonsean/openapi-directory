...
public:
    ...
    */
    virtual void scrolldocuments(const QString &data_entity_name, const QString &content_type, const QString &accept, const QString &rest_range, const ::OpenAPI::OptionalParam<QString> &_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &_fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &_where = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &_schema = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &_keyword = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &_sort = ::OpenAPI::OptionalParam<QString>());
