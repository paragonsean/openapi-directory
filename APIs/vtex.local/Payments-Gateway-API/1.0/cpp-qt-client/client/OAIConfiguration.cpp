...
QString OAIConfiguration::getValue() const {
    return m_value;
}
void OAIConfiguration::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIConfiguration::is_value_Set() const{
    return m_value_isSet;
}

bool OAIConfiguration::is_value_Valid() const{
