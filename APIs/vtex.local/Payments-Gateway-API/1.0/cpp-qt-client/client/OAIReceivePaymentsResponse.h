...
/*
 * OAIReceivePaymentsResponse.h
 *
 * 
 */

#ifndef OAIReceivePaymentsResponse_H
#define OAIReceivePaymentsResponse_H
...
class OAIReceivePaymentsResponse : public OAIObject {
public:
    OAIReceivePaymentsResponse();
    OAIReceivePaymentsResponse(QString json);
    ~OAIReceivePaymentsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReceivePaymentsResponse)

#endif // OAIReceivePaymentsResponse_H
