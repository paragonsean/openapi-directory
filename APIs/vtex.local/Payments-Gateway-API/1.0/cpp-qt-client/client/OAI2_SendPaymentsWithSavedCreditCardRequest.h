...
/*
 * OAI2_SendPaymentsWithSavedCreditCardRequest.h
 *
 * 
 */

#ifndef OAI2_SendPaymentsWithSavedCreditCardRequest_H
#define OAI2_SendPaymentsWithSavedCreditCardRequest_H
...
class OAI2_SendPaymentsWithSavedCreditCardRequest : public OAIObject {
public:
    OAI2_SendPaymentsWithSavedCreditCardRequest();
    OAI2_SendPaymentsWithSavedCreditCardRequest(QString json);
    ~OAI2_SendPaymentsWithSavedCreditCardRequest() override;
    ...
    OAIFields3 getFields() const;
    void setFields(const OAIFields3 &fields);
...
Q_DECLARE_METATYPE(OpenAPI::OAI2_SendPaymentsWithSavedCreditCardRequest)

#endif // OAI2_SendPaymentsWithSavedCreditCardRequest_H
