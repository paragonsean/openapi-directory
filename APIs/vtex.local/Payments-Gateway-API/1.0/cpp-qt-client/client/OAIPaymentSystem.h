...
#ifndef OAIPaymentSystem_H
#define OAIPaymentSystem_H
...
class OAIPaymentSystem : public OAIObject {
public:
    OAIPaymentSystem();
    OAIPaymentSystem(QString json);
    ~OAIPaymentSystem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentSystem)

#endif // OAIPaymentSystem_H
