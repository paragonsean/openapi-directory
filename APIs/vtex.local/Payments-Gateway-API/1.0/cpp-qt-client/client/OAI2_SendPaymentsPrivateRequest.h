...
/*
 * OAI2_SendPaymentsPrivateRequest.h
 *
 * 
 */

#ifndef OAI2_SendPaymentsPrivateRequest_H
#define OAI2_SendPaymentsPrivateRequest_H
...
class OAI2_SendPaymentsPrivateRequest : public OAIObject {
public:
    OAI2_SendPaymentsPrivateRequest();
    OAI2_SendPaymentsPrivateRequest(QString json);
    ~OAI2_SendPaymentsPrivateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI2_SendPaymentsPrivateRequest)

#endif // OAI2_SendPaymentsPrivateRequest_H
