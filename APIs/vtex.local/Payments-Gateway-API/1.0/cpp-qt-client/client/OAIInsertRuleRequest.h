...
/*
 * OAIInsertRuleRequest.h
 *
 * 
 */

#ifndef OAIInsertRuleRequest_H
#define OAIInsertRuleRequest_H
...
class OAIInsertRuleRequest : public OAIObject {
public:
    OAIInsertRuleRequest();
    OAIInsertRuleRequest(QString json);
    ~OAIInsertRuleRequest() override;
    ...
    OAIAntifraud getAntifraud() const;
    void setAntifraud(const OAIAntifraud &antifraud);
    ...
    QString getInstallmentOptions() const;
    void setInstallmentOptions(const QString &installment_options);
    bool is_installment_options_Set() const;
    bool is_installment_options_Valid() const;

    QString getInstallmentsService() const;
    void setInstallmentsService(const QString &installments_service);
    bool is_installments_service_Set() const;
    bool is_installments_service_Valid() const;
    ...
    QString getRequiresAuthentication() const;
    void setRequiresAuthentication(const QString &requires_authentication);
...
private:
    ...
    QString m_installment_options;
    bool m_installment_options_isSet;
    bool m_installment_options_isValid;

    QString m_installments_service;
    bool m_installments_service_isSet;
    bool m_installments_service_isValid;
    ...
    QString m_requires_authentication;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInsertRuleRequest)

#endif // OAIInsertRuleRequest_H
