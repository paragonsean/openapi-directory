...
OAI2_SendPaymentsPublicRequest::OAI2_SendPaymentsPublicRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI2_SendPaymentsPublicRequest::OAI2_SendPaymentsPublicRequest() {
    this->initializeModel();
}

OAI2_SendPaymentsPublicRequest::~OAI2_SendPaymentsPublicRequest() {}

void OAI2_SendPaymentsPublicRequest::initializeModel() {
...
void OAI2_SendPaymentsPublicRequest::fromJson(QString jsonString) {
...
void OAI2_SendPaymentsPublicRequest::fromJsonObject(QJsonObject json) {
...
QString OAI2_SendPaymentsPublicRequest::asJson() const {
...
QJsonObject OAI2_SendPaymentsPublicRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAI2_SendPaymentsPublicRequest::getCurrencyCode() const {
    return m_currency_code;
}
void OAI2_SendPaymentsPublicRequest::setCurrencyCode(const QString &currency_code) {
    m_currency_code = currency_code;
    m_currency_code_isSet = true;
}

bool OAI2_SendPaymentsPublicRequest::is_currency_code_Set() const{
    return m_currency_code_isSet;
}

bool OAI2_SendPaymentsPublicRequest::is_currency_code_Valid() const{
    return m_currency_code_isValid;
}

OAIFields OAI2_SendPaymentsPublicRequest::getFields() const {
    return m_fields;
}
void OAI2_SendPaymentsPublicRequest::setFields(const OAIFields &fields) {
    m_fields = fields;
    m_fields_isSet = true;
}

bool OAI2_SendPaymentsPublicRequest::is_fields_Set() const{
    return m_fields_isSet;
}

bool OAI2_SendPaymentsPublicRequest::is_fields_Valid() const{
    return m_fields_isValid;
}

qint32 OAI2_SendPaymentsPublicRequest::getInstallments() const {
    return m_installments;
}
void OAI2_SendPaymentsPublicRequest::setInstallments(const qint32 &installments) {
    m_installments = installments;
    m_installments_isSet = true;
}

bool OAI2_SendPaymentsPublicRequest::is_installments_Set() const{
    return m_installments_isSet;
}

bool OAI2_SendPaymentsPublicRequest::is_installments_Valid() const{
    return m_installments_isValid;
}

qint32 OAI2_SendPaymentsPublicRequest::getInstallmentsInterestRate() const {
    return m_installments_interest_rate;
}
void OAI2_SendPaymentsPublicRequest::setInstallmentsInterestRate(const qint32 &installments_interest_rate) {
    m_installments_interest_rate = installments_interest_rate;
    m_installments_interest_rate_isSet = true;
}

bool OAI2_SendPaymentsPublicRequest::is_installments_interest_rate_Set() const{
    return m_installments_interest_rate_isSet;
}

bool OAI2_SendPaymentsPublicRequest::is_installments_interest_rate_Valid() const{
    return m_installments_interest_rate_isValid;
}

qint32 OAI2_SendPaymentsPublicRequest::getInstallmentsValue() const {
    return m_installments_value;
}
void OAI2_SendPaymentsPublicRequest::setInstallmentsValue(const qint32 &installments_value) {
    m_installments_value = installments_value;
    m_installments_value_isSet = true;
}

bool OAI2_SendPaymentsPublicRequest::is_installments_value_Set() const{
    return m_installments_value_isSet;
}

bool OAI2_SendPaymentsPublicRequest::is_installments_value_Valid() const{
    return m_installments_value_isValid;
}

qint32 OAI2_SendPaymentsPublicRequest::getPaymentSystem() const {
    return m_payment_system;
}
void OAI2_SendPaymentsPublicRequest::setPaymentSystem(const qint32 &payment_system) {
    m_payment_system = payment_system;
    m_payment_system_isSet = true;
}

bool OAI2_SendPaymentsPublicRequest::is_payment_system_Set() const{
    return m_payment_system_isSet;
}

bool OAI2_SendPaymentsPublicRequest::is_payment_system_Valid() const{
    return m_payment_system_isValid;
}

qint32 OAI2_SendPaymentsPublicRequest::getReferenceValue() const {
    return m_reference_value;
}
void OAI2_SendPaymentsPublicRequest::setReferenceValue(const qint32 &reference_value) {
    m_reference_value = reference_value;
    m_reference_value_isSet = true;
}

bool OAI2_SendPaymentsPublicRequest::is_reference_value_Set() const{
    return m_reference_value_isSet;
}

bool OAI2_SendPaymentsPublicRequest::is_reference_value_Valid() const{
    return m_reference_value_isValid;
}

OAITransaction OAI2_SendPaymentsPublicRequest::getTransaction() const {
    return m_transaction;
}
void OAI2_SendPaymentsPublicRequest::setTransaction(const OAITransaction &transaction) {
    m_transaction = transaction;
    m_transaction_isSet = true;
}

bool OAI2_SendPaymentsPublicRequest::is_transaction_Set() const{
    return m_transaction_isSet;
}

bool OAI2_SendPaymentsPublicRequest::is_transaction_Valid() const{
    return m_transaction_isValid;
}

qint32 OAI2_SendPaymentsPublicRequest::getValue() const {
    return m_value;
}
void OAI2_SendPaymentsPublicRequest::setValue(const qint32 &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAI2_SendPaymentsPublicRequest::is_value_Set() const{
    return m_value_isSet;
}

bool OAI2_SendPaymentsPublicRequest::is_value_Valid() const{
    return m_value_isValid;
}

bool OAI2_SendPaymentsPublicRequest::isSet() const {
...
bool OAI2_SendPaymentsPublicRequest::isValid() const {
