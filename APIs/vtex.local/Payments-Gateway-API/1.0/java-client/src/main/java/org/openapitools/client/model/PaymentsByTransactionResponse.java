...
public class PaymentsByTransactionResponse {
  ...
  public PaymentsByTransactionResponse() {
  }

  public PaymentsByTransactionResponse connectorResponses(String connectorResponses) {
  ...
  public PaymentsByTransactionResponse showConnectorResponses(Boolean showConnectorResponses) {
  ...
  public PaymentsByTransactionResponse allowInstallments(Boolean allowInstallments) {
  ...
  public PaymentsByTransactionResponse allowIssuer(Boolean allowIssuer) {
  ...
  public PaymentsByTransactionResponse allowNotification(Boolean allowNotification) {
  ...
  public PaymentsByTransactionResponse connector(String connector) {
  ...
  public PaymentsByTransactionResponse connectorResponse(String connectorResponse) {
  ...
  public PaymentsByTransactionResponse currencyCode(String currencyCode) {
  ...
  public PaymentsByTransactionResponse description(String description) {
  ...
  public PaymentsByTransactionResponse fields(List<Fields1> fields) {
    this.fields = fields;
    return this;
  }

  public PaymentsByTransactionResponse addFieldsItem(Fields1 fieldsItem) {
    if (this.fields == null) {
  ...
  public PaymentsByTransactionResponse group(String group) {
    this.group = group;
    return this;
  }
  ...
  public PaymentsByTransactionResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public PaymentsByTransactionResponse installments(Integer installments) {
  ...
  public PaymentsByTransactionResponse installmentsInterestRate(Integer installmentsInterestRate) {
  ...
  public PaymentsByTransactionResponse installmentsValue(Integer installmentsValue) {
  ...
  public PaymentsByTransactionResponse isAvailable(Boolean isAvailable) {
  ...
  public PaymentsByTransactionResponse isCustom(Boolean isCustom) {
  ...
  public PaymentsByTransactionResponse merchantName(String merchantName) {
  ...
  public PaymentsByTransactionResponse paymentSystem(Integer paymentSystem) {
  ...
  public PaymentsByTransactionResponse paymentSystemName(String paymentSystemName) {
  ...
  public PaymentsByTransactionResponse provider(String provider) {
  ...
  public PaymentsByTransactionResponse referenceValue(Integer referenceValue) {
  ...
  public PaymentsByTransactionResponse returnCode(String returnCode) {
  ...
  public PaymentsByTransactionResponse returnMessage(String returnMessage) {
  ...
  public PaymentsByTransactionResponse self(Self self) {
    this.self = self;
    return this;
  }
  ...
  public PaymentsByTransactionResponse sheets(String sheets) {
    this.sheets = sheets;
    return this;
  }
  ...
  public PaymentsByTransactionResponse status(String status) {
    this.status = status;
    return this;
  }
  ...
  public PaymentsByTransactionResponse tid(String tid) {
    this.tid = tid;
    return this;
  }
  ...
  public PaymentsByTransactionResponse value(Integer value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentsByTransactionResponse paymentsByTransactionResponse = (PaymentsByTransactionResponse) o;
    return Objects.equals(this.connectorResponses, paymentsByTransactionResponse.connectorResponses) &&
        Objects.equals(this.showConnectorResponses, paymentsByTransactionResponse.showConnectorResponses) &&
        Objects.equals(this.allowInstallments, paymentsByTransactionResponse.allowInstallments) &&
        Objects.equals(this.allowIssuer, paymentsByTransactionResponse.allowIssuer) &&
        Objects.equals(this.allowNotification, paymentsByTransactionResponse.allowNotification) &&
        Objects.equals(this.connector, paymentsByTransactionResponse.connector) &&
        Objects.equals(this.connectorResponse, paymentsByTransactionResponse.connectorResponse) &&
        Objects.equals(this.currencyCode, paymentsByTransactionResponse.currencyCode) &&
        Objects.equals(this.description, paymentsByTransactionResponse.description) &&
        Objects.equals(this.fields, paymentsByTransactionResponse.fields) &&
        Objects.equals(this.group, paymentsByTransactionResponse.group) &&
        Objects.equals(this.id, paymentsByTransactionResponse.id) &&
        Objects.equals(this.installments, paymentsByTransactionResponse.installments) &&
        Objects.equals(this.installmentsInterestRate, paymentsByTransactionResponse.installmentsInterestRate) &&
        Objects.equals(this.installmentsValue, paymentsByTransactionResponse.installmentsValue) &&
        Objects.equals(this.isAvailable, paymentsByTransactionResponse.isAvailable) &&
        Objects.equals(this.isCustom, paymentsByTransactionResponse.isCustom) &&
        Objects.equals(this.merchantName, paymentsByTransactionResponse.merchantName) &&
        Objects.equals(this.paymentSystem, paymentsByTransactionResponse.paymentSystem) &&
        Objects.equals(this.paymentSystemName, paymentsByTransactionResponse.paymentSystemName) &&
        Objects.equals(this.provider, paymentsByTransactionResponse.provider) &&
        Objects.equals(this.referenceValue, paymentsByTransactionResponse.referenceValue) &&
        Objects.equals(this.returnCode, paymentsByTransactionResponse.returnCode) &&
        Objects.equals(this.returnMessage, paymentsByTransactionResponse.returnMessage) &&
        Objects.equals(this.self, paymentsByTransactionResponse.self) &&
        Objects.equals(this.sheets, paymentsByTransactionResponse.sheets) &&
        Objects.equals(this.status, paymentsByTransactionResponse.status) &&
        Objects.equals(this.tid, paymentsByTransactionResponse.tid) &&
        Objects.equals(this.value, paymentsByTransactionResponse.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentsByTransactionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentsByTransactionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentsByTransactionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsByTransactionResponse is not found in the empty JSON string", PaymentsByTransactionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentsByTransactionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentsByTransactionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentsByTransactionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsByTransactionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsByTransactionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsByTransactionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsByTransactionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsByTransactionResponse>() {
           @Override
           public void write(JsonWriter out, PaymentsByTransactionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentsByTransactionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentsByTransactionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentsByTransactionResponse
   * @throws IOException if the JSON string is invalid with respect to PaymentsByTransactionResponse
   */
  public static PaymentsByTransactionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsByTransactionResponse.class);
  }

  /**
   * Convert an instance of PaymentsByTransactionResponse to an JSON string
   *
   * @return JSON string
   */
