...
class TransactionDetailsResponse {
    ...
    constructor(acceptHeader, antifraudAffiliationId, antifraudTid, authorizationDate, authorizationToken, buyer, cancelationDate, cancelationToken, cancellations, channel, commitmentDate, commitmentToken, fields, id, interactions, ipAddress, markedForRecurrence, owner, payments, receiverUri, referenceKey, refundingDate, refundingToken, refunds, salesChannel, settlements, softDescriptor, startDate, status, timeoutStatus, totalRefunds, transactionId, urn, userAgent, value) { 
        ...
        TransactionDetailsResponse.initialize(this, acceptHeader, antifraudAffiliationId, antifraudTid, authorizationDate, authorizationToken, buyer, cancelationDate, cancelationToken, cancellations, channel, commitmentDate, commitmentToken, fields, id, interactions, ipAddress, markedForRecurrence, owner, payments, receiverUri, referenceKey, refundingDate, refundingToken, refunds, salesChannel, settlements, softDescriptor, startDate, status, timeoutStatus, totalRefunds, transactionId, urn, userAgent, value);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TransactionDetailsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransactionDetailsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransactionDetailsResponse.RequiredProperties) {
...
TransactionDetailsResponse.RequiredProperties = ["acceptHeader", "antifraudAffiliationId", "antifraudTid", "authorizationDate", "authorizationToken", "buyer", "cancelationDate", "cancelationToken", "cancellations", "channel", "commitmentDate", "commitmentToken", "fields", "id", "interactions", "ipAddress", "markedForRecurrence", "owner", "payments", "receiverUri", "referenceKey", "refundingDate", "refundingToken", "refunds", "salesChannel", "settlements", "softDescriptor", "startDate", "status", "timeoutStatus", "totalRefunds", "transactionId", "urn", "userAgent", "value"];

/**
 * @member {String} acceptHeader
 */
TransactionDetailsResponse.prototype['acceptHeader'] = undefined;

/**
 * @member {String} antifraudAffiliationId
 */
TransactionDetailsResponse.prototype['antifraudAffiliationId'] = undefined;

/**
 * @member {String} antifraudTid
 */
TransactionDetailsResponse.prototype['antifraudTid'] = undefined;

/**
 * @member {String} authorizationDate
 */
TransactionDetailsResponse.prototype['authorizationDate'] = undefined;

/**
 * @member {String} authorizationToken
 */
TransactionDetailsResponse.prototype['authorizationToken'] = undefined;

/**
 * @member {String} buyer
 */
TransactionDetailsResponse.prototype['buyer'] = undefined;

/**
 * @member {String} cancelationDate
 */
TransactionDetailsResponse.prototype['cancelationDate'] = undefined;

/**
 * @member {String} cancelationToken
 */
TransactionDetailsResponse.prototype['cancelationToken'] = undefined;

/**
 * @member {module:model/Cancellations} cancellations
 */
TransactionDetailsResponse.prototype['cancellations'] = undefined;

/**
 * @member {String} channel
 */
TransactionDetailsResponse.prototype['channel'] = undefined;

/**
 * @member {String} commitmentDate
 */
TransactionDetailsResponse.prototype['commitmentDate'] = undefined;

/**
 * @member {String} commitmentToken
 */
TransactionDetailsResponse.prototype['commitmentToken'] = undefined;

/**
 * 
 * @member {Array.<module:model/Fields1>} fields
 */
TransactionDetailsResponse.prototype['fields'] = undefined;

/**
 * @member {String} id
 */
TransactionDetailsResponse.prototype['id'] = undefined;

/**
 * @member {module:model/Interactions} interactions
 */
TransactionDetailsResponse.prototype['interactions'] = undefined;

/**
 * @member {String} ipAddress
 */
TransactionDetailsResponse.prototype['ipAddress'] = undefined;

/**
 * @member {Boolean} markedForRecurrence
 */
TransactionDetailsResponse.prototype['markedForRecurrence'] = undefined;

/**
 * @member {String} owner
 */
TransactionDetailsResponse.prototype['owner'] = undefined;

/**
 * @member {module:model/Payments} payments
 */
TransactionDetailsResponse.prototype['payments'] = undefined;

/**
 * @member {String} receiverUri
 */
TransactionDetailsResponse.prototype['receiverUri'] = undefined;

/**
 * @member {String} referenceKey
 */
TransactionDetailsResponse.prototype['referenceKey'] = undefined;

/**
 * @member {String} refundingDate
 */
TransactionDetailsResponse.prototype['refundingDate'] = undefined;

/**
 * @member {String} refundingToken
 */
TransactionDetailsResponse.prototype['refundingToken'] = undefined;

/**
 * @member {module:model/Refunds} refunds
 */
TransactionDetailsResponse.prototype['refunds'] = undefined;

/**
 * @member {String} salesChannel
 */
TransactionDetailsResponse.prototype['salesChannel'] = undefined;

/**
 * @member {module:model/Settlements} settlements
 */
TransactionDetailsResponse.prototype['settlements'] = undefined;

/**
 * @member {String} softDescriptor
 */
TransactionDetailsResponse.prototype['softDescriptor'] = undefined;

/**
 * @member {String} startDate
 */
TransactionDetailsResponse.prototype['startDate'] = undefined;

/**
 * @member {String} status
 */
TransactionDetailsResponse.prototype['status'] = undefined;

/**
 * @member {Number} timeoutStatus
 */
TransactionDetailsResponse.prototype['timeoutStatus'] = undefined;

/**
 * @member {Number} totalRefunds
 */
TransactionDetailsResponse.prototype['totalRefunds'] = undefined;

/**
 * @member {String} transactionId
 */
TransactionDetailsResponse.prototype['transactionId'] = undefined;

/**
 * @member {String} urn
 */
TransactionDetailsResponse.prototype['urn'] = undefined;

/**
 * @member {String} userAgent
 */
TransactionDetailsResponse.prototype['userAgent'] = undefined;

/**
 * @member {Number} value
 */
TransactionDetailsResponse.prototype['value'] = undefined;
