...
class PaymentDetailsResponse {
    ...
    constructor(connectorResponses, showConnectorResponses, allowInstallments, allowIssuer, allowNotification, connector, connectorResponse, currencyCode, description, fields, group, id, installments, installmentsInterestRate, installmentsValue, isAvailable, isCustom, merchantName, paymentSystem, paymentSystemName, provider, referenceValue, returnCode, returnMessage, self, sheets, status, tid, value) { 
        ...
        PaymentDetailsResponse.initialize(this, connectorResponses, showConnectorResponses, allowInstallments, allowIssuer, allowNotification, connector, connectorResponse, currencyCode, description, fields, group, id, installments, installmentsInterestRate, installmentsValue, isAvailable, isCustom, merchantName, paymentSystem, paymentSystemName, provider, referenceValue, returnCode, returnMessage, self, sheets, status, tid, value);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of PaymentDetailsResponse.RequiredProperties) {
...
PaymentDetailsResponse.RequiredProperties = ["ConnectorResponses", "ShowConnectorResponses", "allowInstallments", "allowIssuer", "allowNotification", "connector", "connectorResponse", "currencyCode", "description", "fields", "group", "id", "installments", "installmentsInterestRate", "installmentsValue", "isAvailable", "isCustom", "merchantName", "paymentSystem", "paymentSystemName", "provider", "referenceValue", "returnCode", "returnMessage", "self", "sheets", "status", "tid", "value"];

/**
 * @member {String} ConnectorResponses
 */
PaymentDetailsResponse.prototype['ConnectorResponses'] = undefined;

/**
 * @member {Boolean} ShowConnectorResponses
 */
PaymentDetailsResponse.prototype['ShowConnectorResponses'] = undefined;

/**
 * @member {Boolean} allowInstallments
 */
PaymentDetailsResponse.prototype['allowInstallments'] = undefined;

/**
 * @member {Boolean} allowIssuer
 */
PaymentDetailsResponse.prototype['allowIssuer'] = undefined;

/**
 * @member {Boolean} allowNotification
 */
PaymentDetailsResponse.prototype['allowNotification'] = undefined;

/**
 * @member {String} connector
 */
PaymentDetailsResponse.prototype['connector'] = undefined;

/**
 * @member {String} connectorResponse
 */
PaymentDetailsResponse.prototype['connectorResponse'] = undefined;

/**
 * @member {String} currencyCode
 */
PaymentDetailsResponse.prototype['currencyCode'] = undefined;

/**
 * @member {String} description
 */
PaymentDetailsResponse.prototype['description'] = undefined;

/**
 * 
 * @member {Array.<module:model/Fields1>} fields
 */
PaymentDetailsResponse.prototype['fields'] = undefined;

/**
 * @member {String} group
 */
PaymentDetailsResponse.prototype['group'] = undefined;

/**
 * @member {String} id
 */
PaymentDetailsResponse.prototype['id'] = undefined;

/**
 * @member {Number} installments
 */
PaymentDetailsResponse.prototype['installments'] = undefined;

/**
 * @member {Number} installmentsInterestRate
 */
PaymentDetailsResponse.prototype['installmentsInterestRate'] = undefined;

/**
 * @member {Number} installmentsValue
 */
PaymentDetailsResponse.prototype['installmentsValue'] = undefined;

/**
 * @member {Boolean} isAvailable
 */
PaymentDetailsResponse.prototype['isAvailable'] = undefined;

/**
 * @member {Boolean} isCustom
 */
PaymentDetailsResponse.prototype['isCustom'] = undefined;

/**
 * @member {String} merchantName
 */
PaymentDetailsResponse.prototype['merchantName'] = undefined;

/**
 * @member {Number} paymentSystem
 */
PaymentDetailsResponse.prototype['paymentSystem'] = undefined;

/**
 * @member {String} paymentSystemName
 */
PaymentDetailsResponse.prototype['paymentSystemName'] = undefined;

/**
 * @member {String} provider
 */
PaymentDetailsResponse.prototype['provider'] = undefined;

/**
 * @member {Number} referenceValue
 */
PaymentDetailsResponse.prototype['referenceValue'] = undefined;

/**
 * @member {String} returnCode
 */
PaymentDetailsResponse.prototype['returnCode'] = undefined;

/**
 * @member {String} returnMessage
 */
PaymentDetailsResponse.prototype['returnMessage'] = undefined;

/**
 * @member {module:model/Self} self
 */
PaymentDetailsResponse.prototype['self'] = undefined;

/**
 * @member {String} sheets
 */
PaymentDetailsResponse.prototype['sheets'] = undefined;

/**
 * @member {String} status
 */
PaymentDetailsResponse.prototype['status'] = undefined;

/**
 * @member {String} tid
 */
PaymentDetailsResponse.prototype['tid'] = undefined;

/**
 * @member {Number} value
 */
PaymentDetailsResponse.prototype['value'] = undefined;
