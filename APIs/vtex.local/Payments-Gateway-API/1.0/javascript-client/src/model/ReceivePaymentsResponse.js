...
/**
 * The ReceivePaymentsResponse model module.
 * @module model/ReceivePaymentsResponse
 * @version 1.0
 */
class ReceivePaymentsResponse {
    /**
     * Constructs a new <code>ReceivePaymentsResponse</code>.
     * @alias module:model/ReceivePaymentsResponse
    ...
    constructor(connectorResponses, showConnectorResponses, allowInstallments, allowIssuer, allowNotification, connector, connectorResponse, currencyCode, description, fields, group, id, installments, installmentsInterestRate, installmentsValue, isAvailable, isCustom, merchantName, paymentSystem, paymentSystemName, provider, referenceValue, returnCode, returnMessage, self, sheets, status, tid, value) { 
        ...
        ReceivePaymentsResponse.initialize(this, connectorResponses, showConnectorResponses, allowInstallments, allowIssuer, allowNotification, connector, connectorResponse, currencyCode, description, fields, group, id, installments, installmentsInterestRate, installmentsValue, isAvailable, isCustom, merchantName, paymentSystem, paymentSystemName, provider, referenceValue, returnCode, returnMessage, self, sheets, status, tid, value);
    }
    ...
    /**
     * Constructs a <code>ReceivePaymentsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReceivePaymentsResponse} obj Optional instance to populate.
     * @return {module:model/ReceivePaymentsResponse} The populated <code>ReceivePaymentsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReceivePaymentsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ReceivePaymentsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReceivePaymentsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReceivePaymentsResponse.RequiredProperties) {
...
ReceivePaymentsResponse.RequiredProperties = ["ConnectorResponses", "ShowConnectorResponses", "allowInstallments", "allowIssuer", "allowNotification", "connector", "connectorResponse", "currencyCode", "description", "fields", "group", "id", "installments", "installmentsInterestRate", "installmentsValue", "isAvailable", "isCustom", "merchantName", "paymentSystem", "paymentSystemName", "provider", "referenceValue", "returnCode", "returnMessage", "self", "sheets", "status", "tid", "value"];

/**
 * @member {String} ConnectorResponses
 */
ReceivePaymentsResponse.prototype['ConnectorResponses'] = undefined;

/**
 * @member {Boolean} ShowConnectorResponses
 */
ReceivePaymentsResponse.prototype['ShowConnectorResponses'] = undefined;

/**
 * @member {Boolean} allowInstallments
 */
ReceivePaymentsResponse.prototype['allowInstallments'] = undefined;

/**
 * @member {Boolean} allowIssuer
 */
ReceivePaymentsResponse.prototype['allowIssuer'] = undefined;

/**
 * @member {Boolean} allowNotification
 */
ReceivePaymentsResponse.prototype['allowNotification'] = undefined;

/**
 * @member {String} connector
 */
ReceivePaymentsResponse.prototype['connector'] = undefined;

/**
 * @member {String} connectorResponse
 */
ReceivePaymentsResponse.prototype['connectorResponse'] = undefined;

/**
 * @member {String} currencyCode
 */
ReceivePaymentsResponse.prototype['currencyCode'] = undefined;

/**
 * @member {String} description
 */
ReceivePaymentsResponse.prototype['description'] = undefined;

/**
 * 
 * @member {Array.<module:model/Fields1>} fields
 */
ReceivePaymentsResponse.prototype['fields'] = undefined;

/**
 * @member {String} group
 */
ReceivePaymentsResponse.prototype['group'] = undefined;

/**
 * @member {String} id
 */
ReceivePaymentsResponse.prototype['id'] = undefined;

/**
 * @member {Number} installments
 */
ReceivePaymentsResponse.prototype['installments'] = undefined;

/**
 * @member {Number} installmentsInterestRate
 */
ReceivePaymentsResponse.prototype['installmentsInterestRate'] = undefined;

/**
 * @member {Number} installmentsValue
 */
ReceivePaymentsResponse.prototype['installmentsValue'] = undefined;

/**
 * @member {Boolean} isAvailable
 */
ReceivePaymentsResponse.prototype['isAvailable'] = undefined;

/**
 * @member {Boolean} isCustom
 */
ReceivePaymentsResponse.prototype['isCustom'] = undefined;

/**
 * @member {String} merchantName
 */
ReceivePaymentsResponse.prototype['merchantName'] = undefined;

/**
 * @member {Number} paymentSystem
 */
ReceivePaymentsResponse.prototype['paymentSystem'] = undefined;

/**
 * @member {String} paymentSystemName
 */
ReceivePaymentsResponse.prototype['paymentSystemName'] = undefined;

/**
 * @member {String} provider
 */
ReceivePaymentsResponse.prototype['provider'] = undefined;

/**
 * @member {Number} referenceValue
 */
ReceivePaymentsResponse.prototype['referenceValue'] = undefined;

/**
 * @member {String} returnCode
 */
ReceivePaymentsResponse.prototype['returnCode'] = undefined;

/**
 * @member {String} returnMessage
 */
ReceivePaymentsResponse.prototype['returnMessage'] = undefined;

/**
 * @member {module:model/Self} self
 */
ReceivePaymentsResponse.prototype['self'] = undefined;

/**
 * @member {String} sheets
 */
ReceivePaymentsResponse.prototype['sheets'] = undefined;

/**
 * @member {String} status
 */
ReceivePaymentsResponse.prototype['status'] = undefined;

/**
 * @member {String} tid
 */
ReceivePaymentsResponse.prototype['tid'] = undefined;

/**
 * @member {Number} value
 */
ReceivePaymentsResponse.prototype['value'] = undefined;
...
export default ReceivePaymentsResponse;
