# PaymentsGatewayApi.InsertRuleRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**antifraud** | [**Antifraud**](Antifraud.md) |  | 
**beginDate** | **String** |  | 
**condition** | **String** |  | 
...
**name** | **String** |  | 
**paymentSystem** | [**PaymentSystem**](PaymentSystem.md) |  | 
**requiresAuthentication** | **String** |  | 
**salesChannels** | [**[SalesChannel]**](SalesChannel.md) |  | 
