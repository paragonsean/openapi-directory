...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.PaymentsByTransactionResponse();
  });
  ...
  describe('PaymentsByTransactionResponse', function() {
    it('should create an instance of PaymentsByTransactionResponse', function() {
      // uncomment below and update the code to test PaymentsByTransactionResponse
      //var instance = new PaymentsGatewayApi.PaymentsByTransactionResponse();
      //expect(instance).to.be.a(PaymentsGatewayApi.PaymentsByTransactionResponse);
    });
