...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.InsertAffiliationRequest();
  });
  ...
  describe('InsertAffiliationRequest', function() {
    it('should create an instance of InsertAffiliationRequest', function() {
      // uncomment below and update the code to test InsertAffiliationRequest
      //var instance = new PaymentsGatewayApi.InsertAffiliationRequest();
      //expect(instance).to.be.a(PaymentsGatewayApi.InsertAffiliationRequest);
    });
