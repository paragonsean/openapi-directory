...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.PaymentDetailsResponse();
  });
  ...
  describe('PaymentDetailsResponse', function() {
    it('should create an instance of PaymentDetailsResponse', function() {
      ...
      //var instance = new PaymentsGatewayApi.PaymentDetailsResponse();
      //expect(instance).to.be.a(PaymentsGatewayApi.PaymentDetailsResponse);
    });
