...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.TransactionDetailsResponse();
  });
  ...
  describe('TransactionDetailsResponse', function() {
    it('should create an instance of TransactionDetailsResponse', function() {
      // uncomment below and update the code to test TransactionDetailsResponse
      //var instance = new PaymentsGatewayApi.TransactionDetailsResponse();
      //expect(instance).to.be.a(PaymentsGatewayApi.TransactionDetailsResponse);
    });
