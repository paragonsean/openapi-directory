...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.Model2SendPaymentsPrivateRequest();
  });
  ...
  describe('Model2SendPaymentsPrivateRequest', function() {
    it('should create an instance of Model2SendPaymentsPrivateRequest', function() {
      // uncomment below and update the code to test Model2SendPaymentsPrivateRequest
      //var instance = new PaymentsGatewayApi.Model2SendPaymentsPrivateRequest();
      //expect(instance).to.be.a(PaymentsGatewayApi.Model2SendPaymentsPrivateRequest);
    });
