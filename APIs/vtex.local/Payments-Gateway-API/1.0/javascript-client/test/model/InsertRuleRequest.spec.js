...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.InsertRuleRequest();
  });
  ...
  describe('InsertRuleRequest', function() {
    it('should create an instance of InsertRuleRequest', function() {
      // uncomment below and update the code to test InsertRuleRequest
      //var instance = new PaymentsGatewayApi.InsertRuleRequest();
      //expect(instance).to.be.a(PaymentsGatewayApi.InsertRuleRequest);
    });
    ...
    it('should have the property installmentsService (base name: "installmentsService")', function() {
      // uncomment below and update the code to test the property installmentsService
      //var instance = new PaymentsGatewayApi.InsertRuleRequest();
      //expect(instance).to.be();
    });
