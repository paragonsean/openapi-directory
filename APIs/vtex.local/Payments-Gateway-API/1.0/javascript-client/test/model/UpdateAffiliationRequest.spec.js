...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.UpdateAffiliationRequest();
  });
  ...
  describe('UpdateAffiliationRequest', function() {
    it('should create an instance of UpdateAffiliationRequest', function() {
      // uncomment below and update the code to test UpdateAffiliationRequest
      //var instance = new PaymentsGatewayApi.UpdateAffiliationRequest();
      //expect(instance).to.be.a(PaymentsGatewayApi.UpdateAffiliationRequest);
    });
