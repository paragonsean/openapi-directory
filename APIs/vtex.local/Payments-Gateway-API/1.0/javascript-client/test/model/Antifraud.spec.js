...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.Antifraud();
  });
  ...
  describe('Antifraud', function() {
    it('should create an instance of Antifraud', function() {
      // uncomment below and update the code to test Antifraud
      //var instance = new PaymentsGatewayApi.Antifraud();
      //expect(instance).to.be.a(PaymentsGatewayApi.Antifraud);
    });
