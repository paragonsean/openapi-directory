...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.Rule();
  });
  ...
  describe('Rule', function() {
    it('should create an instance of Rule', function() {
      ...
      //var instance = new PaymentsGatewayApi.Rule();
      //expect(instance).to.be.a(PaymentsGatewayApi.Rule);
    });

    it('should have the property antifraudImplementation (base name: "antifraudImplementation")', function() {
      // uncomment below and update the code to test the property antifraudImplementation
      //var instance = new PaymentsGatewayApi.Rule();
