...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.Model2SendPaymentsPublicRequest();
  });
  ...
  describe('Model2SendPaymentsPublicRequest', function() {
    it('should create an instance of Model2SendPaymentsPublicRequest', function() {
      // uncomment below and update the code to test Model2SendPaymentsPublicRequest
      //var instance = new PaymentsGatewayApi.Model2SendPaymentsPublicRequest();
      //expect(instance).to.be.a(PaymentsGatewayApi.Model2SendPaymentsPublicRequest);
    });
