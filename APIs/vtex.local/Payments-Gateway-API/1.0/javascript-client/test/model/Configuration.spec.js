...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.Configuration();
  });
  ...
  describe('Configuration', function() {
    it('should create an instance of Configuration', function() {
      ...
      //var instance = new PaymentsGatewayApi.Configuration();
      //expect(instance).to.be.a(PaymentsGatewayApi.Configuration);
    });
