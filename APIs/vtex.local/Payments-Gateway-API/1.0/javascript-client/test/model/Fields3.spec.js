...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.Fields3();
  });
  ...
  describe('Fields3', function() {
    it('should create an instance of Fields3', function() {
      // uncomment below and update the code to test Fields3
      //var instance = new PaymentsGatewayApi.Fields3();
      //expect(instance).to.be.a(PaymentsGatewayApi.Fields3);
    });
