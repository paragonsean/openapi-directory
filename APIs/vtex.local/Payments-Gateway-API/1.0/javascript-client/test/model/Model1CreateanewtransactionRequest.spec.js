...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaymentsGatewayApi.Model1CreateanewtransactionRequest();
  });
  ...
  describe('Model1CreateanewtransactionRequest', function() {
    it('should create an instance of Model1CreateanewtransactionRequest', function() {
      // uncomment below and update the code to test Model1CreateanewtransactionRequest
      //var instance = new PaymentsGatewayApi.Model1CreateanewtransactionRequest();
      //expect(instance).to.be.a(PaymentsGatewayApi.Model1CreateanewtransactionRequest);
    });
