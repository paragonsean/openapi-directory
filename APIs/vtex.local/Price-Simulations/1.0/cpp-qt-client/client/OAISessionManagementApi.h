...
#ifndef OAI_OAISessionManagementApi_H
#define OAI_OAISessionManagementApi_H
...
class OAISessionManagementApi : public QObject {
    Q_OBJECT

public:
    OAISessionManagementApi(const int timeOut = 0);
    ...
    */
    virtual void sessionsPost(const QString &content_type, const QString &accept, const ::OpenAPI::OptionalParam<OAIRequest_Body> &oai_request_body = ::OpenAPI::OptionalParam<OAIRequest_Body>());
...
private:
    ...
    void sessionsPostCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void sessionsPostSignal(QJsonValue summary);


    void sessionsPostSignalFull(OAIHttpRequestWorker *worker, QJsonValue summary);

    Q_DECL_DEPRECATED_X("Use sessionsPostSignalError() instead")
    void sessionsPostSignalE(QJsonValue summary, QNetworkReply::NetworkError error_type, QString error_str);
    void sessionsPostSignalError(QJsonValue summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use sessionsPostSignalErrorFull() instead")
    void sessionsPostSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void sessionsPostSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
