...
/*
 * OAICustomSessionKeys.h
 *
 * Contains every schema criteria. This is a serialized JSON object
 */

#ifndef OAICustomSessionKeys_H
#define OAICustomSessionKeys_H
...
class OAICustomSessionKeys : public OAIObject {
public:
    OAICustomSessionKeys();
    OAICustomSessionKeys(QString json);
    ~OAICustomSessionKeys() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomSessionKeys)

#endif // OAICustomSessionKeys_H
