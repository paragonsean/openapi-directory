...
public:
    ...
    OAICustomSessionKeys getCustomSessionKeys() const;
    void setCustomSessionKeys(const OAICustomSessionKeys &custom_session_keys);
    bool is_custom_session_keys_Set() const;
    bool is_custom_session_keys_Valid() const;
...
private:
    ...
    OAICustomSessionKeys m_custom_session_keys;
    bool m_custom_session_keys_isSet;
    bool m_custom_session_keys_isValid;
};
