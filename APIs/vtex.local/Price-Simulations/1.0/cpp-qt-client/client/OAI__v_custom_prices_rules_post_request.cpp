...
OAI__v_custom_prices_rules_post_request::OAI__v_custom_prices_rules_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI__v_custom_prices_rules_post_request::OAI__v_custom_prices_rules_post_request() {
    this->initializeModel();
}

OAI__v_custom_prices_rules_post_request::~OAI__v_custom_prices_rules_post_request() {}

void OAI__v_custom_prices_rules_post_request::initializeModel() {
...
void OAI__v_custom_prices_rules_post_request::fromJson(QString jsonString) {
...
void OAI__v_custom_prices_rules_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI__v_custom_prices_rules_post_request::asJson() const {
...
QJsonObject OAI__v_custom_prices_rules_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_email_isSet) {
...
QJsonValue OAI__v_custom_prices_rules_post_request::getEmail() const {
    return m_email;
}
void OAI__v_custom_prices_rules_post_request::setEmail(const QJsonValue &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAI__v_custom_prices_rules_post_request::is_email_Set() const{
    return m_email_isSet;
}

bool OAI__v_custom_prices_rules_post_request::is_email_Valid() const{
    return m_email_isValid;
}

QString OAI__v_custom_prices_rules_post_request::getOrderType() const {
    return m_order_type;
}
void OAI__v_custom_prices_rules_post_request::setOrderType(const QString &order_type) {
    m_order_type = order_type;
    m_order_type_isSet = true;
}

bool OAI__v_custom_prices_rules_post_request::is_order_type_Set() const{
    return m_order_type_isSet;
}

bool OAI__v_custom_prices_rules_post_request::is_order_type_Valid() const{
    return m_order_type_isValid;
}

QString OAI__v_custom_prices_rules_post_request::getPricetable() const {
    return m_pricetable;
}
void OAI__v_custom_prices_rules_post_request::setPricetable(const QString &pricetable) {
    m_pricetable = pricetable;
    m_pricetable_isSet = true;
}

bool OAI__v_custom_prices_rules_post_request::is_pricetable_Set() const{
    return m_pricetable_isSet;
}

bool OAI__v_custom_prices_rules_post_request::is_pricetable_Valid() const{
    return m_pricetable_isValid;
}

QString OAI__v_custom_prices_rules_post_request::getState() const {
    return m_state;
}
void OAI__v_custom_prices_rules_post_request::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAI__v_custom_prices_rules_post_request::is_state_Set() const{
    return m_state_isSet;
}

bool OAI__v_custom_prices_rules_post_request::is_state_Valid() const{
    return m_state_isValid;
}

bool OAI__v_custom_prices_rules_post_request::isSet() const {
...
bool OAI__v_custom_prices_rules_post_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pricetable_isValid && true;
}
