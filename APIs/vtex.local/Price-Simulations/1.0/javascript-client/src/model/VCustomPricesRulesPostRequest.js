...
/**
 * The VCustomPricesRulesPostRequest model module.
 * @module model/VCustomPricesRulesPostRequest
 * @version 1.0
 */
class VCustomPricesRulesPostRequest {
    /**
     * Constructs a new <code>VCustomPricesRulesPostRequest</code>.
     * @alias module:model/VCustomPricesRulesPostRequest
     * @param pricetable {String} Name of the Price Table associated with the scenario
     */
    constructor(pricetable) { 
        
        VCustomPricesRulesPostRequest.initialize(this, pricetable);
    }
     ...
     */
    static initialize(obj, pricetable) { 
        obj['orderType'] = '';
    ...
    /**
     * Constructs a <code>VCustomPricesRulesPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VCustomPricesRulesPostRequest} obj Optional instance to populate.
     * @return {module:model/VCustomPricesRulesPostRequest} The populated <code>VCustomPricesRulesPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VCustomPricesRulesPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>VCustomPricesRulesPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VCustomPricesRulesPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VCustomPricesRulesPostRequest.RequiredProperties) {
...
VCustomPricesRulesPostRequest.RequiredProperties = ["pricetable"];

/**
 * User's email
 * @member {Object} email
 */
VCustomPricesRulesPostRequest.prototype['email'] = undefined;
 ...
 * @default ''
 */
VCustomPricesRulesPostRequest.prototype['orderType'] = '';
 ...
 * @default ''
 */
VCustomPricesRulesPostRequest.prototype['pricetable'] = '';
 ...
 * @default ''
 */
VCustomPricesRulesPostRequest.prototype['state'] = '';
...
export default VCustomPricesRulesPostRequest;
