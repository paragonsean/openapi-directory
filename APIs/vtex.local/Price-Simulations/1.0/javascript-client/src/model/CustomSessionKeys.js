...
/**
 * The CustomSessionKeys model module.
 * @module model/CustomSessionKeys
 * @version 1.0
 */
class CustomSessionKeys {
    /**
     * Constructs a new <code>CustomSessionKeys</code>.
     * Contains every schema criteria. This is a serialized JSON object
     * @alias module:model/CustomSessionKeys
     * @param value {String} Order Configuration criteria
     */
    constructor(value) { 
        
        CustomSessionKeys.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>CustomSessionKeys</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomSessionKeys} obj Optional instance to populate.
     * @return {module:model/CustomSessionKeys} The populated <code>CustomSessionKeys</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomSessionKeys();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomSessionKeys</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomSessionKeys</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomSessionKeys.RequiredProperties) {
...
CustomSessionKeys.RequiredProperties = ["value"];
 ...
 * @default ''
 */
CustomSessionKeys.prototype['value'] = '';
...
export default CustomSessionKeys;
