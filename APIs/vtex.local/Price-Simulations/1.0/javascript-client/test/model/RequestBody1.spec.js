...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PriceSimulationsApi.RequestBody1();
  });
  ...
  describe('RequestBody1', function() {
    it('should create an instance of RequestBody1', function() {
      ...
      //var instance = new PriceSimulationsApi.RequestBody1();
      //expect(instance).to.be.a(PriceSimulationsApi.RequestBody1);
    });
    ...
    it('should have the property useEmail (base name: "useEmail")', function() {
      // uncomment below and update the code to test the property useEmail
      //var instance = new PriceSimulationsApi.RequestBody1();
      //expect(instance).to.be();
    });
