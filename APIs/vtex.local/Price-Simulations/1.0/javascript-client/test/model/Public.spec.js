...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PriceSimulationsApi.Public();
  });
  ...
  describe('Public', function() {
    it('should create an instance of Public', function() {
      ...
      //var instance = new PriceSimulationsApi.Public();
      //expect(instance).to.be.a(PriceSimulationsApi.Public);
    });

    it('should have the property customSessionKeys (base name: "customSessionKeys")', function() {
      // uncomment below and update the code to test the property customSessionKeys
      //var instance = new PriceSimulationsApi.Public();
