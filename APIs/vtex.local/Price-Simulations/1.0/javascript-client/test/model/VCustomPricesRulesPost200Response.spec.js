...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PriceSimulationsApi.VCustomPricesRulesPost200Response();
  });
  ...
  describe('VCustomPricesRulesPost200Response', function() {
    it('should create an instance of VCustomPricesRulesPost200Response', function() {
      // uncomment below and update the code to test VCustomPricesRulesPost200Response
      //var instance = new PriceSimulationsApi.VCustomPricesRulesPost200Response();
      //expect(instance).to.be.a(PriceSimulationsApi.VCustomPricesRulesPost200Response);
    });
