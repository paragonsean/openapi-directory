...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PriceSimulationsApi.CustomSessionKeys();
  });
  ...
  describe('CustomSessionKeys', function() {
    it('should create an instance of CustomSessionKeys', function() {
      // uncomment below and update the code to test CustomSessionKeys
      //var instance = new PriceSimulationsApi.CustomSessionKeys();
      //expect(instance).to.be.a(PriceSimulationsApi.CustomSessionKeys);
    });
