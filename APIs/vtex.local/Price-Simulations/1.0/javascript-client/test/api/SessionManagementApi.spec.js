...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PriceSimulationsApi.SessionManagementApi();
  });
  ...
  describe('SessionManagementApi', function() {
    describe('sessionsPost', function() {
      it('should call sessionsPost successfully', function(done) {
        //uncomment below and update the code to test sessionsPost
        //instance.sessionsPost(function(error) {
