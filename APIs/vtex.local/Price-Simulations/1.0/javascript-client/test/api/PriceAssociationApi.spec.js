...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PriceSimulationsApi.PriceAssociationApi();
  });
  ...
  describe('PriceAssociationApi', function() {
    describe('vCustomPricesRulesPost', function() {
      it('should call vCustomPricesRulesPost successfully', function(done) {
        //uncomment below and update the code to test vCustomPricesRulesPost
        //instance.vCustomPricesRulesPost(function(error) {
    ...
    describe('vCustomPricesRulesPriceAssociationIdDelete', function() {
      it('should call vCustomPricesRulesPriceAssociationIdDelete successfully', function(done) {
        //uncomment below and update the code to test vCustomPricesRulesPriceAssociationIdDelete
        //instance.vCustomPricesRulesPriceAssociationIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('vCustomPricesRulesPriceAssociationIdGet', function() {
      it('should call vCustomPricesRulesPriceAssociationIdGet successfully', function(done) {
        //uncomment below and update the code to test vCustomPricesRulesPriceAssociationIdGet
        //instance.vCustomPricesRulesPriceAssociationIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('vCustomPricesRulesPriceAssociationIdPut', function() {
      it('should call vCustomPricesRulesPriceAssociationIdPut successfully', function(done) {
        //uncomment below and update the code to test vCustomPricesRulesPriceAssociationIdPut
        //instance.vCustomPricesRulesPriceAssociationIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
