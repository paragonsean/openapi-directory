...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PriceSimulationsApi.CustomPricesApi();
  });
  ...
  describe('CustomPricesApi', function() {
    describe('vCustomPricesSessionSchemaGet', function() {
      it('should call vCustomPricesSessionSchemaGet successfully', function(done) {
        //uncomment below and update the code to test vCustomPricesSessionSchemaGet
        //instance.vCustomPricesSessionSchemaGet(function(error) {
    ...
    describe('vCustomPricesSessionSchemaPost', function() {
      it('should call vCustomPricesSessionSchemaPost successfully', function(done) {
        //uncomment below and update the code to test vCustomPricesSessionSchemaPost
        //instance.vCustomPricesSessionSchemaPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
