...
public class VCustomPricesRulesPostRequest {
  ...
  public VCustomPricesRulesPostRequest() {
  }

  public VCustomPricesRulesPostRequest email(Object email) {
    this.email = email;
    return this;
  }
  ...
  public VCustomPricesRulesPostRequest orderType(String orderType) {
  ...
  public VCustomPricesRulesPostRequest pricetable(String pricetable) {
  ...
  public VCustomPricesRulesPostRequest state(String state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    VCustomPricesRulesPostRequest vCustomPricesRulesPostRequest = (VCustomPricesRulesPostRequest) o;
    return Objects.equals(this.email, vCustomPricesRulesPostRequest.email) &&
        Objects.equals(this.orderType, vCustomPricesRulesPostRequest.orderType) &&
        Objects.equals(this.pricetable, vCustomPricesRulesPostRequest.pricetable) &&
        Objects.equals(this.state, vCustomPricesRulesPostRequest.state);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, orderType, pricetable, state);
  }
  ...
  public String toString() {
    ...
    sb.append("class VCustomPricesRulesPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VCustomPricesRulesPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VCustomPricesRulesPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VCustomPricesRulesPostRequest is not found in the empty JSON string", VCustomPricesRulesPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VCustomPricesRulesPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VCustomPricesRulesPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VCustomPricesRulesPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VCustomPricesRulesPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VCustomPricesRulesPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VCustomPricesRulesPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VCustomPricesRulesPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VCustomPricesRulesPostRequest>() {
           @Override
           public void write(JsonWriter out, VCustomPricesRulesPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VCustomPricesRulesPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VCustomPricesRulesPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VCustomPricesRulesPostRequest
   * @throws IOException if the JSON string is invalid with respect to VCustomPricesRulesPostRequest
   */
  public static VCustomPricesRulesPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VCustomPricesRulesPostRequest.class);
  }

  /**
   * Convert an instance of VCustomPricesRulesPostRequest to an JSON string
   *
   * @return JSON string
   */
