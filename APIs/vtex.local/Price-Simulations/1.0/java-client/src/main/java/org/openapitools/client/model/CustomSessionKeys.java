...
public class CustomSessionKeys {
  ...
  public CustomSessionKeys value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CustomSessionKeys customSessionKeys = (CustomSessionKeys) o;
    return Objects.equals(this.value, customSessionKeys.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomSessionKeys {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomSessionKeys
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomSessionKeys.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomSessionKeys is not found in the empty JSON string", CustomSessionKeys.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomSessionKeys.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomSessionKeys` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustomSessionKeys.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomSessionKeys.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomSessionKeys' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomSessionKeys> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomSessionKeys.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomSessionKeys>() {
           @Override
           public void write(JsonWriter out, CustomSessionKeys value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomSessionKeys read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomSessionKeys given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomSessionKeys
   * @throws IOException if the JSON string is invalid with respect to CustomSessionKeys
   */
  public static CustomSessionKeys fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomSessionKeys.class);
  }

  /**
   * Convert an instance of CustomSessionKeys to an JSON string
   *
   * @return JSON string
   */
