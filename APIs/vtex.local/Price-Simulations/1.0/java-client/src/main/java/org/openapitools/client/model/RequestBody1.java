...
public class RequestBody1 {
  ...
  private List<FieldsInner> fields = new ArrayList<>(Arrays.asList(, ));

  public static final String SERIALIZED_NAME_USE_EMAIL = "useEmail";
  @SerializedName(SERIALIZED_NAME_USE_EMAIL)
  private Boolean useEmail = true;

  public RequestBody1() {
  }

  public RequestBody1 fields(List<FieldsInner> fields) {
    this.fields = fields;
    return this;
  }

  public RequestBody1 addFieldsItem(FieldsInner fieldsItem) {
    if (this.fields == null) {
      this.fields = new ArrayList<>(Arrays.asList(, ));
    }
  ...
  public RequestBody1 useEmail(Boolean useEmail) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fields, requestBody1.fields) &&
        Objects.equals(this.useEmail, requestBody1.useEmail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fields, useEmail);
  }
  ...
  public String toString() {
    ...
    sb.append("    useEmail: ").append(toIndentedString(useEmail)).append("\n");
    sb.append("}");
    return sb.toString();
  }
