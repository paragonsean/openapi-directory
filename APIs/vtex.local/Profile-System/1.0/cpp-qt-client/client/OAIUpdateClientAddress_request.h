...
/*
 * OAIUpdateClientAddress_request.h
 *
 * 
 */

#ifndef OAIUpdateClientAddress_request_H
#define OAIUpdateClientAddress_request_H
...
class OAIUpdateClientAddress_request : public OAIObject {
public:
    OAIUpdateClientAddress_request();
    OAIUpdateClientAddress_request(QString json);
    ~OAIUpdateClientAddress_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateClientAddress_request)

#endif // OAIUpdateClientAddress_request_H
