...
async def create_purchase_information(request: web.Request, content_type, accept, profile_id, alternative_key=None, body=None) -> web.Response:
...
async def delete_purchase_information(request: web.Request, content_type, accept, profile_id, alternative_key=None) -> web.Response:
...
async def get_purchase_information(request: web.Request, content_type, accept, profile_id, alternative_key=None) -> web.Response:
...
async def get_unmasked_purchase_information(request: web.Request, content_type, accept, profile_id) -> web.Response:
...
async def update_purchase_information(request: web.Request, content_type, accept, profile_id, alternative_key=None, body=None) -> web.Response:
