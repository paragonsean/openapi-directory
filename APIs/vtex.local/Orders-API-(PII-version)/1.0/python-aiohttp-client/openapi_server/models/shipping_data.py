...
class ShippingData(Model):
    ...
    def __init__(self, address: Address=None, id: str='shippingData', logistics_info: List[LogisticsInfo]=None, selected_addresses: List[Address]=None, tracking_hints: str=None):
    ...
    def selected_addresses(self, selected_addresses):
        ...
        :param selected_addresses: The selected_addresses of this ShippingData.
        :type selected_addresses: List[Address]
        """
