...
class List {
     ...
     * @param shippingEstimatedDate {String} Shipping estimate date.
     * @param shippingEstimatedDateMax {String} Maximum shipping estimate date.
     * @param shippingEstimatedDateMin {String} Minimum shipping estimate date.
     * @param affiliateId {String} Three letter code indicating the marketplace in which the order was placed.
     * @param authorizedDate {String} Authorized date.
     * @param callCenterOperatorName {String} Call center operator name.
     * @param clientName {String} Client name.
     * @param creationDate {String} Creation date.
     * @param currencyCode {String} Currency code.
     * @param items {String} Order items.
     * @param lastMessageUnread {String} Last unread message.
     * @param listId {String} List ID.
     * @param listType {String} List type.
     * @param marketPlaceOrderId {String} ID of the order in the marketplace.
     * @param orderId {String} Order ID.
     * @param orderIsComplete {Boolean} Indicates whether order is complete.
     * @param origin {String} Indicates whether order is marketplace, fulfillment or chain.
     * @param paymentNames {String} Order payment names.
     * @param salesChannel {String} Sales channel.
     * @param sequence {String} Order sequence number.
     * @param status {String} Order status.
     * @param statusDescription {String} Order status description.
     * @param totalItems {Number} Total items.
     * @param totalValue {Number} Order total value in cents.
     * @param workflowInErrorState {Boolean} Indicates whether order workflow is in error state.
     * @param workflowInRetry {Boolean} Indicates whether workflow is in retry.
     */
