...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApiPiiVersion.Stats1();
  });
  ...
  describe('Stats1', function() {
    it('should create an instance of Stats1', function() {
      // uncomment below and update the code to test Stats1
      //var instance = new OrdersApiPiiVersion.Stats1();
      //expect(instance).to.be.a(OrdersApiPiiVersion.Stats1);
    });
