...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApiPiiVersion.GetOrder2200ResponseItemsInner();
  });
  ...
  describe('GetOrder2200ResponseItemsInner', function() {
    it('should create an instance of GetOrder2200ResponseItemsInner', function() {
      // uncomment below and update the code to test GetOrder2200ResponseItemsInner
      //var instance = new OrdersApiPiiVersion.GetOrder2200ResponseItemsInner();
      //expect(instance).to.be.a(OrdersApiPiiVersion.GetOrder2200ResponseItemsInner);
    });
