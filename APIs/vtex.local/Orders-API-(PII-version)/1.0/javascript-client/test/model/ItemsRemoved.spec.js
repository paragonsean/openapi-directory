...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApiPiiVersion.ItemsRemoved();
  });
  ...
  describe('ItemsRemoved', function() {
    it('should create an instance of ItemsRemoved', function() {
      ...
      //var instance = new OrdersApiPiiVersion.ItemsRemoved();
      //expect(instance).to.be.a(OrdersApiPiiVersion.ItemsRemoved);
    });
