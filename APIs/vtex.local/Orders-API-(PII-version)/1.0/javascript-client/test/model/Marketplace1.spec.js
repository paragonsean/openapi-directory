...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApiPiiVersion.Marketplace1();
  });
  ...
  describe('Marketplace1', function() {
    it('should create an instance of Marketplace1', function() {
      // uncomment below and update the code to test Marketplace1
      //var instance = new OrdersApiPiiVersion.Marketplace1();
      //expect(instance).to.be.a(OrdersApiPiiVersion.Marketplace1);
    });
