...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApiPiiVersion.InvoiceNotificationRequest();
  });
  ...
  describe('InvoiceNotificationRequest', function() {
    it('should create an instance of InvoiceNotificationRequest', function() {
      ...
      //var instance = new OrdersApiPiiVersion.InvoiceNotificationRequest();
      //expect(instance).to.be.a(OrdersApiPiiVersion.InvoiceNotificationRequest);
    });
    ...
    it('should have the property extraValue (base name: "extraValue")', function() {
      // uncomment below and update the code to test the property extraValue
      //var instance = new OrdersApiPiiVersion.InvoiceNotificationRequest();
      //expect(instance).to.be();
    });
