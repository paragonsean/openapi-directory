...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApiPiiVersion.ListOrders();
  });
  ...
  describe('ListOrders', function() {
    it('should create an instance of ListOrders', function() {
      // uncomment below and update the code to test ListOrders
      //var instance = new OrdersApiPiiVersion.ListOrders();
      //expect(instance).to.be.a(OrdersApiPiiVersion.ListOrders);
    });
