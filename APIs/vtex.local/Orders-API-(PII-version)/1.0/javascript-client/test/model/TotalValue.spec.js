...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApiPiiVersion.TotalValue();
  });
  ...
  describe('TotalValue', function() {
    it('should create an instance of TotalValue', function() {
      // uncomment below and update the code to test TotalValue
      //var instance = new OrdersApiPiiVersion.TotalValue();
      //expect(instance).to.be.a(OrdersApiPiiVersion.TotalValue);
    });
