...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApiPiiVersion.Origin1();
  });
  ...
  describe('Origin1', function() {
    it('should create an instance of Origin1', function() {
      // uncomment below and update the code to test Origin1
      //var instance = new OrdersApiPiiVersion.Origin1();
      //expect(instance).to.be.a(OrdersApiPiiVersion.Origin1);
    });
