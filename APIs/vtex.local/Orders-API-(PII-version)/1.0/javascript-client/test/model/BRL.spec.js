...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApiPiiVersion.BRL();
  });
  ...
  describe('BRL', function() {
    it('should create an instance of BRL', function() {
      // uncomment below and update the code to test BRL
      //var instance = new OrdersApiPiiVersion.BRL();
      //expect(instance).to.be.a(OrdersApiPiiVersion.BRL);
    });
