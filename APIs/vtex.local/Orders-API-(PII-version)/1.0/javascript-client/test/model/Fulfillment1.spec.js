...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApiPiiVersion.Fulfillment1();
  });
  ...
  describe('Fulfillment1', function() {
    it('should create an instance of Fulfillment1', function() {
      // uncomment below and update the code to test Fulfillment1
      //var instance = new OrdersApiPiiVersion.Fulfillment1();
      //expect(instance).to.be.a(OrdersApiPiiVersion.Fulfillment1);
    });
