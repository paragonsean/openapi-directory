...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersApiPiiVersion.Marketplace2();
  });
  ...
  describe('Marketplace2', function() {
    it('should create an instance of Marketplace2', function() {
      ...
      //var instance = new OrdersApiPiiVersion.Marketplace2();
      //expect(instance).to.be.a(OrdersApiPiiVersion.Marketplace2);
    });
