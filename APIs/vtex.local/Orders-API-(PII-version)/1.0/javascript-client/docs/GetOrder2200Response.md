# OrdersApiPiiVersion.GetOrder2200Response
...
**items** | [**[GetOrder2200ResponseItemsInner]**](GetOrder2200ResponseItemsInner.md) | Information on each item in the order. | [optional] 
...
**marketplaceItems** | **[String]** | Marketplace items. | [optional] 
...
**roundingError** | **Number** | Rounding error in cents. | [optional] 
**salesChannel** | **String** | Sales channel. | [optional] 
**sellerOrderId** | **String** | Seller order ID. | [optional] 
**sellers** | [**[Seller]**](Seller.md) | Array with sellers information. | [optional] 
...
**totals** | [**[GetOrder2200ResponseTotalsInner]**](GetOrder2200ResponseTotalsInner.md) | Information on each of the order&#39;s totals. | [optional] 
**value** | **Number** | Value in cents. | [optional] 
