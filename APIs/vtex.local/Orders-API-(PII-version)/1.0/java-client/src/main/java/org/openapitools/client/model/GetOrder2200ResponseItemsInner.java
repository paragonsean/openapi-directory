...
public class GetOrder2200ResponseItemsInner {
  public static final String SERIALIZED_NAME_ADDITIONAL_INFO = "additionalInfo";
  @SerializedName(SERIALIZED_NAME_ADDITIONAL_INFO)
  private GetOrder2200ResponseItemsInnerAdditionalInfo additionalInfo;
  ...
  private List<GetOrder2200ResponseItemsInnerBundleItemsInner> bundleItems = new ArrayList<>();
  ...
  private GetOrder2200ResponseItemsInnerPriceDefinition priceDefinition;

  public static final String SERIALIZED_NAME_PRICE_TAGS = "priceTags";
  @SerializedName(SERIALIZED_NAME_PRICE_TAGS)
  private List<GetOrder2200ResponseItemsInnerPriceTagsInner> priceTags = new ArrayList<>();
  ...
  private GetOrder2200ResponseItemsInnerProductCategories productCategories;
  ...
  public GetOrder2200ResponseItemsInner() {
  }

  public GetOrder2200ResponseItemsInner additionalInfo(GetOrder2200ResponseItemsInnerAdditionalInfo additionalInfo) {
  ...
  public GetOrder2200ResponseItemsInnerAdditionalInfo getAdditionalInfo() {
    return additionalInfo;
  }

  public void setAdditionalInfo(GetOrder2200ResponseItemsInnerAdditionalInfo additionalInfo) {
    this.additionalInfo = additionalInfo;
  }


  public GetOrder2200ResponseItemsInner attachments(List<String> attachments) {
    this.attachments = attachments;
    return this;
  }

  public GetOrder2200ResponseItemsInner addAttachmentsItem(String attachmentsItem) {
  ...
  public GetOrder2200ResponseItemsInner availability(String availability) {
  ...
  public GetOrder2200ResponseItemsInner bundleItems(List<GetOrder2200ResponseItemsInnerBundleItemsInner> bundleItems) {
    this.bundleItems = bundleItems;
    return this;
  }

  public GetOrder2200ResponseItemsInner addBundleItemsItem(GetOrder2200ResponseItemsInnerBundleItemsInner bundleItemsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GetOrder2200ResponseItemsInnerBundleItemsInner> getBundleItems() {
    return bundleItems;
  }

  public void setBundleItems(List<GetOrder2200ResponseItemsInnerBundleItemsInner> bundleItems) {
    this.bundleItems = bundleItems;
  }


  public GetOrder2200ResponseItemsInner detailUrl(String detailUrl) {
  ...
  public GetOrder2200ResponseItemsInner ean(String ean) {
    this.ean = ean;
    return this;
  }
  ...
  public GetOrder2200ResponseItemsInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetOrder2200ResponseItemsInner imageUrl(String imageUrl) {
  ...
  public GetOrder2200ResponseItemsInner isGift(Boolean isGift) {
    this.isGift = isGift;
    return this;
  }
  ...
  public GetOrder2200ResponseItemsInner listPrice(Integer listPrice) {
  ...
  public GetOrder2200ResponseItemsInner manualPrice(Integer manualPrice) {
  ...
  public GetOrder2200ResponseItemsInner manualPriceAppliedBy(String manualPriceAppliedBy) {
  ...
  public GetOrder2200ResponseItemsInner manufacturerCode(String manufacturerCode) {
  ...
  public GetOrder2200ResponseItemsInner measurementUnit(String measurementUnit) {
  ...
  public GetOrder2200ResponseItemsInner modalType(String modalType) {
  ...
  public GetOrder2200ResponseItemsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetOrder2200ResponseItemsInner parentAssemblyBinding(String parentAssemblyBinding) {
  ...
  public GetOrder2200ResponseItemsInner parentItemIndex(Integer parentItemIndex) {
  ...
  public GetOrder2200ResponseItemsInner preSaleDate(String preSaleDate) {
  ...
  public GetOrder2200ResponseItemsInner price(Integer price) {
    this.price = price;
    return this;
  }
  ...
  public GetOrder2200ResponseItemsInner priceDefinition(GetOrder2200ResponseItemsInnerPriceDefinition priceDefinition) {
   ...
   */
  @javax.annotation.Nullable
  public GetOrder2200ResponseItemsInnerPriceDefinition getPriceDefinition() {
    return priceDefinition;
  }

  public void setPriceDefinition(GetOrder2200ResponseItemsInnerPriceDefinition priceDefinition) {
    this.priceDefinition = priceDefinition;
  }


  public GetOrder2200ResponseItemsInner priceTags(List<GetOrder2200ResponseItemsInnerPriceTagsInner> priceTags) {
    this.priceTags = priceTags;
    return this;
  }

  public GetOrder2200ResponseItemsInner addPriceTagsItem(GetOrder2200ResponseItemsInnerPriceTagsInner priceTagsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GetOrder2200ResponseItemsInnerPriceTagsInner> getPriceTags() {
    return priceTags;
  }

  public void setPriceTags(List<GetOrder2200ResponseItemsInnerPriceTagsInner> priceTags) {
    this.priceTags = priceTags;
  }


  public GetOrder2200ResponseItemsInner priceValidUntil(String priceValidUntil) {
  ...
  public GetOrder2200ResponseItemsInner productCategories(GetOrder2200ResponseItemsInnerProductCategories productCategories) {
   ...
   */
  @javax.annotation.Nullable
  public GetOrder2200ResponseItemsInnerProductCategories getProductCategories() {
    return productCategories;
  }

  public void setProductCategories(GetOrder2200ResponseItemsInnerProductCategories productCategories) {
    this.productCategories = productCategories;
  }


  public GetOrder2200ResponseItemsInner productCategoryIds(String productCategoryIds) {
  ...
  public GetOrder2200ResponseItemsInner productId(String productId) {
  ...
  public GetOrder2200ResponseItemsInner productRefId(String productRefId) {
  ...
  public GetOrder2200ResponseItemsInner quantity(Integer quantity) {
  ...
  public GetOrder2200ResponseItemsInner refId(String refId) {
    this.refId = refId;
    return this;
  }
  ...
  public GetOrder2200ResponseItemsInner rewardValue(Integer rewardValue) {
  ...
  public GetOrder2200ResponseItemsInner seller(String seller) {
    this.seller = seller;
    return this;
  }
  ...
  public GetOrder2200ResponseItemsInner sellerChain(List<String> sellerChain) {
    this.sellerChain = sellerChain;
    return this;
  }

  public GetOrder2200ResponseItemsInner addSellerChainItem(String sellerChainItem) {
  ...
  public GetOrder2200ResponseItemsInner sellingPrice(Integer sellingPrice) {
  ...
  public GetOrder2200ResponseItemsInner skuName(String skuName) {
  ...
  public GetOrder2200ResponseItemsInner tax(Integer tax) {
    this.tax = tax;
    return this;
  }
  ...
  public GetOrder2200ResponseItemsInner uniqueId(String uniqueId) {
  ...
  public GetOrder2200ResponseItemsInner unitMultiplier(Integer unitMultiplier) {
  ...
  public boolean equals(Object o) {
    ...
    GetOrder2200ResponseItemsInner getOrder2200ResponseItemsInner = (GetOrder2200ResponseItemsInner) o;
    return Objects.equals(this.additionalInfo, getOrder2200ResponseItemsInner.additionalInfo) &&
        Objects.equals(this.attachments, getOrder2200ResponseItemsInner.attachments) &&
        Objects.equals(this.availability, getOrder2200ResponseItemsInner.availability) &&
        Objects.equals(this.bundleItems, getOrder2200ResponseItemsInner.bundleItems) &&
        Objects.equals(this.detailUrl, getOrder2200ResponseItemsInner.detailUrl) &&
        Objects.equals(this.ean, getOrder2200ResponseItemsInner.ean) &&
        Objects.equals(this.id, getOrder2200ResponseItemsInner.id) &&
        Objects.equals(this.imageUrl, getOrder2200ResponseItemsInner.imageUrl) &&
        Objects.equals(this.isGift, getOrder2200ResponseItemsInner.isGift) &&
        Objects.equals(this.listPrice, getOrder2200ResponseItemsInner.listPrice) &&
        Objects.equals(this.manualPrice, getOrder2200ResponseItemsInner.manualPrice) &&
        Objects.equals(this.manualPriceAppliedBy, getOrder2200ResponseItemsInner.manualPriceAppliedBy) &&
        Objects.equals(this.manufacturerCode, getOrder2200ResponseItemsInner.manufacturerCode) &&
        Objects.equals(this.measurementUnit, getOrder2200ResponseItemsInner.measurementUnit) &&
        Objects.equals(this.modalType, getOrder2200ResponseItemsInner.modalType) &&
        Objects.equals(this.name, getOrder2200ResponseItemsInner.name) &&
        Objects.equals(this.parentAssemblyBinding, getOrder2200ResponseItemsInner.parentAssemblyBinding) &&
        Objects.equals(this.parentItemIndex, getOrder2200ResponseItemsInner.parentItemIndex) &&
        Objects.equals(this.preSaleDate, getOrder2200ResponseItemsInner.preSaleDate) &&
        Objects.equals(this.price, getOrder2200ResponseItemsInner.price) &&
        Objects.equals(this.priceDefinition, getOrder2200ResponseItemsInner.priceDefinition) &&
        Objects.equals(this.priceTags, getOrder2200ResponseItemsInner.priceTags) &&
        Objects.equals(this.priceValidUntil, getOrder2200ResponseItemsInner.priceValidUntil) &&
        Objects.equals(this.productCategories, getOrder2200ResponseItemsInner.productCategories) &&
        Objects.equals(this.productCategoryIds, getOrder2200ResponseItemsInner.productCategoryIds) &&
        Objects.equals(this.productId, getOrder2200ResponseItemsInner.productId) &&
        Objects.equals(this.productRefId, getOrder2200ResponseItemsInner.productRefId) &&
        Objects.equals(this.quantity, getOrder2200ResponseItemsInner.quantity) &&
        Objects.equals(this.refId, getOrder2200ResponseItemsInner.refId) &&
        Objects.equals(this.rewardValue, getOrder2200ResponseItemsInner.rewardValue) &&
        Objects.equals(this.seller, getOrder2200ResponseItemsInner.seller) &&
        Objects.equals(this.sellerChain, getOrder2200ResponseItemsInner.sellerChain) &&
        Objects.equals(this.sellingPrice, getOrder2200ResponseItemsInner.sellingPrice) &&
        Objects.equals(this.skuName, getOrder2200ResponseItemsInner.skuName) &&
        Objects.equals(this.tax, getOrder2200ResponseItemsInner.tax) &&
        Objects.equals(this.uniqueId, getOrder2200ResponseItemsInner.uniqueId) &&
        Objects.equals(this.unitMultiplier, getOrder2200ResponseItemsInner.unitMultiplier);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetOrder2200ResponseItemsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOrder2200ResponseItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOrder2200ResponseItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOrder2200ResponseItemsInner is not found in the empty JSON string", GetOrder2200ResponseItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOrder2200ResponseItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOrder2200ResponseItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("additionalInfo") != null && !jsonObj.get("additionalInfo").isJsonNull()) {
        GetOrder2200ResponseItemsInnerAdditionalInfo.validateJsonElement(jsonObj.get("additionalInfo"));
      }
      ...
      if (jsonObj.get("bundleItems") != null && !jsonObj.get("bundleItems").isJsonNull()) {
        ...
        if (jsonArraybundleItems != null) {
          ...
          for (int i = 0; i < jsonArraybundleItems.size(); i++) {
            GetOrder2200ResponseItemsInnerBundleItemsInner.validateJsonElement(jsonArraybundleItems.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("priceDefinition") != null && !jsonObj.get("priceDefinition").isJsonNull()) {
        GetOrder2200ResponseItemsInnerPriceDefinition.validateJsonElement(jsonObj.get("priceDefinition"));
      }
      if (jsonObj.get("priceTags") != null && !jsonObj.get("priceTags").isJsonNull()) {
        ...
        if (jsonArraypriceTags != null) {
          ...
          for (int i = 0; i < jsonArraypriceTags.size(); i++) {
            GetOrder2200ResponseItemsInnerPriceTagsInner.validateJsonElement(jsonArraypriceTags.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("productCategories") != null && !jsonObj.get("productCategories").isJsonNull()) {
        GetOrder2200ResponseItemsInnerProductCategories.validateJsonElement(jsonObj.get("productCategories"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOrder2200ResponseItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOrder2200ResponseItemsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOrder2200ResponseItemsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOrder2200ResponseItemsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOrder2200ResponseItemsInner>() {
           @Override
           public void write(JsonWriter out, GetOrder2200ResponseItemsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOrder2200ResponseItemsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOrder2200ResponseItemsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOrder2200ResponseItemsInner
   * @throws IOException if the JSON string is invalid with respect to GetOrder2200ResponseItemsInner
   */
  public static GetOrder2200ResponseItemsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOrder2200ResponseItemsInner.class);
  }

  /**
   * Convert an instance of GetOrder2200ResponseItemsInner to an JSON string
   *
   * @return JSON string
   */
