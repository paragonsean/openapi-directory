...
public class GetOrder2200Response {
  ...
  private List<GetOrder2200ResponseItemsInner> items = new ArrayList<>();
  ...
  private GetOrder2200ResponsePackageAttachment packageAttachment;
  ...
  private List<GetOrder2200ResponseTotalsInner> totals = new ArrayList<>();

  public static final String SERIALIZED_NAME_VALUE = "value";
  @SerializedName(SERIALIZED_NAME_VALUE)
  private Integer value;

  public GetOrder2200Response() {
  }

  public GetOrder2200Response affiliateId(String affiliateId) {
  ...
  public GetOrder2200Response allowCancellation(Boolean allowCancellation) {
  ...
  public GetOrder2200Response allowEdition(Boolean allowEdition) {
  ...
  public GetOrder2200Response approvedBy(String approvedBy) {
  ...
  public GetOrder2200Response authorizedDate(String authorizedDate) {
  ...
  public GetOrder2200Response callCenterOperatorData(String callCenterOperatorData) {
  ...
  public GetOrder2200Response cancelReason(String cancelReason) {
  ...
  public GetOrder2200Response cancelledBy(String cancelledBy) {
  ...
  public GetOrder2200Response changesAttachment(ChangesAttachment changesAttachment) {
  ...
  public GetOrder2200Response clientProfileData(ClientProfileData clientProfileData) {
  ...
  public GetOrder2200Response commercialConditionData(String commercialConditionData) {
  ...
  public GetOrder2200Response creationDate(String creationDate) {
  ...
  public GetOrder2200Response customData(String customData) {
  ...
  public GetOrder2200Response emailTracked(String emailTracked) {
  ...
  public GetOrder2200Response followUpEmail(String followUpEmail) {
  ...
  public GetOrder2200Response giftRegistryData(String giftRegistryData) {
  ...
  public GetOrder2200Response hostname(String hostname) {
  ...
  public GetOrder2200Response invoiceData(Object invoiceData) {
  ...
  public GetOrder2200Response invoicedDate(String invoicedDate) {
  ...
  public GetOrder2200Response isCheckedIn(Boolean isCheckedIn) {
  ...
  public GetOrder2200Response isCompleted(Boolean isCompleted) {
  ...
  public GetOrder2200Response items(List<GetOrder2200ResponseItemsInner> items) {
    this.items = items;
    return this;
  }

  public GetOrder2200Response addItemsItem(GetOrder2200ResponseItemsInner itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<GetOrder2200ResponseItemsInner> getItems() {
    return items;
  }

  public void setItems(List<GetOrder2200ResponseItemsInner> items) {
    this.items = items;
  }


  public GetOrder2200Response lastChange(String lastChange) {
  ...
  public GetOrder2200Response lastMessage(String lastMessage) {
  ...
  public GetOrder2200Response marketingData(String marketingData) {
  ...
  public GetOrder2200Response marketplace(Marketplace marketplace) {
  ...
  public GetOrder2200Response marketplaceItems(List<String> marketplaceItems) {
    this.marketplaceItems = marketplaceItems;
    return this;
  }

  public GetOrder2200Response addMarketplaceItemsItem(String marketplaceItemsItem) {
  ...
  public GetOrder2200Response marketplaceOrderId(String marketplaceOrderId) {
  ...
  public GetOrder2200Response marketplaceServicesEndpoint(String marketplaceServicesEndpoint) {
  ...
  public GetOrder2200Response merchantName(String merchantName) {
  ...
  public GetOrder2200Response openTextField(String openTextField) {
  ...
  public GetOrder2200Response orderFormId(String orderFormId) {
  ...
  public GetOrder2200Response orderGroup(String orderGroup) {
  ...
  public GetOrder2200Response orderId(String orderId) {
  ...
  public GetOrder2200Response origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public GetOrder2200Response packageAttachment(GetOrder2200ResponsePackageAttachment packageAttachment) {
   ...
   */
  @javax.annotation.Nullable
  public GetOrder2200ResponsePackageAttachment getPackageAttachment() {
    return packageAttachment;
  }

  public void setPackageAttachment(GetOrder2200ResponsePackageAttachment packageAttachment) {
    this.packageAttachment = packageAttachment;
  }


  public GetOrder2200Response paymentData(PaymentData paymentData) {
  ...
  public GetOrder2200Response ratesAndBenefitsData(RatesAndBenefitsData ratesAndBenefitsData) {
  ...
  public GetOrder2200Response roundingError(Integer roundingError) {
  ...
  public GetOrder2200Response salesChannel(String salesChannel) {
  ...
  public GetOrder2200Response sellerOrderId(String sellerOrderId) {
  ...
  public GetOrder2200Response sellers(List<Seller> sellers) {
    this.sellers = sellers;
    return this;
  }

  public GetOrder2200Response addSellersItem(Seller sellersItem) {
  ...
  public GetOrder2200Response sequence(String sequence) {
  ...
  public GetOrder2200Response shippingData(ShippingData shippingData) {
  ...
  public GetOrder2200Response status(String status) {
    this.status = status;
    return this;
  }
  ...
  public GetOrder2200Response statusDescription(String statusDescription) {
  ...
  public GetOrder2200Response storePreferencesData(StorePreferencesData storePreferencesData) {
  ...
  public GetOrder2200Response totals(List<GetOrder2200ResponseTotalsInner> totals) {
    this.totals = totals;
    return this;
  }

  public GetOrder2200Response addTotalsItem(GetOrder2200ResponseTotalsInner totalsItem) {
    if (this.totals == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<GetOrder2200ResponseTotalsInner> getTotals() {
    return totals;
  }

  public void setTotals(List<GetOrder2200ResponseTotalsInner> totals) {
    this.totals = totals;
  }


  public GetOrder2200Response value(Integer value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetOrder2200Response getOrder2200Response = (GetOrder2200Response) o;
    return Objects.equals(this.affiliateId, getOrder2200Response.affiliateId) &&
        Objects.equals(this.allowCancellation, getOrder2200Response.allowCancellation) &&
        Objects.equals(this.allowEdition, getOrder2200Response.allowEdition) &&
        Objects.equals(this.approvedBy, getOrder2200Response.approvedBy) &&
        Objects.equals(this.authorizedDate, getOrder2200Response.authorizedDate) &&
        Objects.equals(this.callCenterOperatorData, getOrder2200Response.callCenterOperatorData) &&
        Objects.equals(this.cancelReason, getOrder2200Response.cancelReason) &&
        Objects.equals(this.cancelledBy, getOrder2200Response.cancelledBy) &&
        Objects.equals(this.changesAttachment, getOrder2200Response.changesAttachment) &&
        Objects.equals(this.clientProfileData, getOrder2200Response.clientProfileData) &&
        Objects.equals(this.commercialConditionData, getOrder2200Response.commercialConditionData) &&
        Objects.equals(this.creationDate, getOrder2200Response.creationDate) &&
        Objects.equals(this.customData, getOrder2200Response.customData) &&
        Objects.equals(this.emailTracked, getOrder2200Response.emailTracked) &&
        Objects.equals(this.followUpEmail, getOrder2200Response.followUpEmail) &&
        Objects.equals(this.giftRegistryData, getOrder2200Response.giftRegistryData) &&
        Objects.equals(this.hostname, getOrder2200Response.hostname) &&
        Objects.equals(this.invoiceData, getOrder2200Response.invoiceData) &&
        Objects.equals(this.invoicedDate, getOrder2200Response.invoicedDate) &&
        Objects.equals(this.isCheckedIn, getOrder2200Response.isCheckedIn) &&
        Objects.equals(this.isCompleted, getOrder2200Response.isCompleted) &&
        Objects.equals(this.items, getOrder2200Response.items) &&
        Objects.equals(this.lastChange, getOrder2200Response.lastChange) &&
        Objects.equals(this.lastMessage, getOrder2200Response.lastMessage) &&
        Objects.equals(this.marketingData, getOrder2200Response.marketingData) &&
        Objects.equals(this.marketplace, getOrder2200Response.marketplace) &&
        Objects.equals(this.marketplaceItems, getOrder2200Response.marketplaceItems) &&
        Objects.equals(this.marketplaceOrderId, getOrder2200Response.marketplaceOrderId) &&
        Objects.equals(this.marketplaceServicesEndpoint, getOrder2200Response.marketplaceServicesEndpoint) &&
        Objects.equals(this.merchantName, getOrder2200Response.merchantName) &&
        Objects.equals(this.openTextField, getOrder2200Response.openTextField) &&
        Objects.equals(this.orderFormId, getOrder2200Response.orderFormId) &&
        Objects.equals(this.orderGroup, getOrder2200Response.orderGroup) &&
        Objects.equals(this.orderId, getOrder2200Response.orderId) &&
        Objects.equals(this.origin, getOrder2200Response.origin) &&
        Objects.equals(this.packageAttachment, getOrder2200Response.packageAttachment) &&
        Objects.equals(this.paymentData, getOrder2200Response.paymentData) &&
        Objects.equals(this.ratesAndBenefitsData, getOrder2200Response.ratesAndBenefitsData) &&
        Objects.equals(this.roundingError, getOrder2200Response.roundingError) &&
        Objects.equals(this.salesChannel, getOrder2200Response.salesChannel) &&
        Objects.equals(this.sellerOrderId, getOrder2200Response.sellerOrderId) &&
        Objects.equals(this.sellers, getOrder2200Response.sellers) &&
        Objects.equals(this.sequence, getOrder2200Response.sequence) &&
        Objects.equals(this.shippingData, getOrder2200Response.shippingData) &&
        Objects.equals(this.status, getOrder2200Response.status) &&
        Objects.equals(this.statusDescription, getOrder2200Response.statusDescription) &&
        Objects.equals(this.storePreferencesData, getOrder2200Response.storePreferencesData) &&
        Objects.equals(this.totals, getOrder2200Response.totals) &&
        Objects.equals(this.value, getOrder2200Response.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetOrder2200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOrder2200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOrder2200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOrder2200Response is not found in the empty JSON string", GetOrder2200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOrder2200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOrder2200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            GetOrder2200ResponseItemsInner.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("packageAttachment") != null && !jsonObj.get("packageAttachment").isJsonNull()) {
        GetOrder2200ResponsePackageAttachment.validateJsonElement(jsonObj.get("packageAttachment"));
      }
      ...
      if (jsonObj.get("totals") != null && !jsonObj.get("totals").isJsonNull()) {
        ...
        if (jsonArraytotals != null) {
          ...
          for (int i = 0; i < jsonArraytotals.size(); i++) {
            GetOrder2200ResponseTotalsInner.validateJsonElement(jsonArraytotals.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOrder2200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOrder2200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOrder2200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOrder2200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOrder2200Response>() {
           @Override
           public void write(JsonWriter out, GetOrder2200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOrder2200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOrder2200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOrder2200Response
   * @throws IOException if the JSON string is invalid with respect to GetOrder2200Response
   */
  public static GetOrder2200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOrder2200Response.class);
  }

  /**
   * Convert an instance of GetOrder2200Response to an JSON string
   *
   * @return JSON string
   */
