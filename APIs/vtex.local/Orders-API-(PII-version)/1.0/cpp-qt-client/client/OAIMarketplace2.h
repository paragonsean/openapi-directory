...
#ifndef OAIMarketplace2_H
#define OAIMarketplace2_H
...
class OAIMarketplace2 : public OAIObject {
public:
    OAIMarketplace2();
    OAIMarketplace2(QString json);
    ~OAIMarketplace2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarketplace2)

#endif // OAIMarketplace2_H
