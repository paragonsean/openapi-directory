...
bool OAIAddress::isValid() const {
    ...
    return m_address_id_isValid && m_address_type_isValid && m_city_isValid && m_complement_isValid && m_country_isValid && m_geo_coordinates_isValid && m_neighborhood_isValid && m_number_isValid && m_postal_code_isValid && m_receiver_name_isValid && m_reference_isValid && m_state_isValid && m_street_isValid && true;
}
