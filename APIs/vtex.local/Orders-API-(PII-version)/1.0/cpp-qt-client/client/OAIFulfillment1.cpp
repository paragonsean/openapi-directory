...
double OAIFulfillment1::getMean() const {
    return m_mean;
}
void OAIFulfillment1::setMean(const double &mean) {
    m_mean = mean;
    m_mean_isSet = true;
}
...
double OAIFulfillment1::getStdDev() const {
    return m_std_dev;
}
void OAIFulfillment1::setStdDev(const double &std_dev) {
    m_std_dev = std_dev;
...
qint64 OAIFulfillment1::getSumOfSquares() const {
    return m_sum_of_squares;
}
void OAIFulfillment1::setSumOfSquares(const qint64 &sum_of_squares) {
