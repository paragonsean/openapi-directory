...
void OAIBRL1::fromJson(QString jsonString) {
...
void OAIBRL1::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIBRL1::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
qint32 OAIBRL1::getCount() const {
    return m_count;
}
void OAIBRL1::setCount(const qint32 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIBRL1::is_count_Set() const{
    return m_count_isSet;
}

bool OAIBRL1::is_count_Valid() const{
    return m_count_isValid;
}

QString OAIBRL1::getFacets() const {
    return m_facets;
}
void OAIBRL1::setFacets(const QString &facets) {
    m_facets = facets;
    m_facets_isSet = true;
}

bool OAIBRL1::is_facets_Set() const{
    return m_facets_isSet;
}

bool OAIBRL1::is_facets_Valid() const{
    return m_facets_isValid;
}

qint32 OAIBRL1::getMax() const {
    return m_max;
}
void OAIBRL1::setMax(const qint32 &max) {
    m_max = max;
    m_max_isSet = true;
}

bool OAIBRL1::is_max_Set() const{
    return m_max_isSet;
}

bool OAIBRL1::is_max_Valid() const{
    return m_max_isValid;
}

double OAIBRL1::getMean() const {
    return m_mean;
}
void OAIBRL1::setMean(const double &mean) {
    m_mean = mean;
    m_mean_isSet = true;
}

bool OAIBRL1::is_mean_Set() const{
    return m_mean_isSet;
}

bool OAIBRL1::is_mean_Valid() const{
    return m_mean_isValid;
}

qint32 OAIBRL1::getMin() const {
    return m_min;
}
void OAIBRL1::setMin(const qint32 &min) {
    m_min = min;
    m_min_isSet = true;
}

bool OAIBRL1::is_min_Set() const{
    return m_min_isSet;
}

bool OAIBRL1::is_min_Valid() const{
    return m_min_isValid;
}

qint32 OAIBRL1::getMissing() const {
    return m_missing;
}
void OAIBRL1::setMissing(const qint32 &missing) {
    m_missing = missing;
    m_missing_isSet = true;
}

bool OAIBRL1::is_missing_Set() const{
    return m_missing_isSet;
}

bool OAIBRL1::is_missing_Valid() const{
    return m_missing_isValid;
}

double OAIBRL1::getStdDev() const {
    return m_std_dev;
}
void OAIBRL1::setStdDev(const double &std_dev) {
    m_std_dev = std_dev;
    m_std_dev_isSet = true;
}

bool OAIBRL1::is_std_dev_Set() const{
    return m_std_dev_isSet;
}

bool OAIBRL1::is_std_dev_Valid() const{
    return m_std_dev_isValid;
}

qint32 OAIBRL1::getSum() const {
    return m_sum;
}
void OAIBRL1::setSum(const qint32 &sum) {
    m_sum = sum;
    m_sum_isSet = true;
}

bool OAIBRL1::is_sum_Set() const{
    return m_sum_isSet;
}

bool OAIBRL1::is_sum_Valid() const{
    return m_sum_isValid;
}

qint64 OAIBRL1::getSumOfSquares() const {
    return m_sum_of_squares;
}
void OAIBRL1::setSumOfSquares(const qint64 &sum_of_squares) {
    m_sum_of_squares = sum_of_squares;
    m_sum_of_squares_isSet = true;
}

bool OAIBRL1::is_sum_of_squares_Set() const{
    return m_sum_of_squares_isSet;
}

bool OAIBRL1::is_sum_of_squares_Valid() const{
    return m_sum_of_squares_isValid;
}

bool OAIBRL1::isSet() const {
