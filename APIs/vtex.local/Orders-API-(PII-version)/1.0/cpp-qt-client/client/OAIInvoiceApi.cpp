...
void OAIInvoiceApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("invoiceNotification2", defaultConf);
    _serverIndices.insert("invoiceNotification2", 0);
}
...
void OAIInvoiceApi::invoiceNotification2(const QString &content_type, const QString &accept, const QString &order_id, const OAIInvoiceNotificationRequest &oai_invoice_notification_request) {
    QString fullPath = QString(_serverConfigs["invoiceNotification2"][_serverIndices.value("invoiceNotification2")].URL()+"/api/orders/pvt/document/{orderId}/invoices");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIInvoiceApi::invoiceNotification2Callback);
...
void OAIInvoiceApi::invoiceNotification2Callback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT invoiceNotification2Signal(output);
        Q_EMIT invoiceNotification2SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT invoiceNotification2SignalE(output, error_type, error_str);
        Q_EMIT invoiceNotification2SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT invoiceNotification2SignalError(output, error_type, error_str);
        Q_EMIT invoiceNotification2SignalErrorFull(worker, error_type, error_str);
    }
}
