...
OAITotalItems::OAITotalItems(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITotalItems::OAITotalItems() {
    this->initializeModel();
}

OAITotalItems::~OAITotalItems() {}

void OAITotalItems::initializeModel() {
...
void OAITotalItems::fromJson(QString jsonString) {
...
void OAITotalItems::fromJsonObject(QJsonObject json) {
...
QString OAITotalItems::asJson() const {
...
QJsonObject OAITotalItems::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
qint32 OAITotalItems::getCount() const {
    return m_count;
}
void OAITotalItems::setCount(const qint32 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAITotalItems::is_count_Set() const{
    return m_count_isSet;
}

bool OAITotalItems::is_count_Valid() const{
    return m_count_isValid;
}

QString OAITotalItems::getFacets() const {
    return m_facets;
}
void OAITotalItems::setFacets(const QString &facets) {
    m_facets = facets;
    m_facets_isSet = true;
}

bool OAITotalItems::is_facets_Set() const{
    return m_facets_isSet;
}

bool OAITotalItems::is_facets_Valid() const{
    return m_facets_isValid;
}

qint32 OAITotalItems::getMax() const {
    return m_max;
}
void OAITotalItems::setMax(const qint32 &max) {
    m_max = max;
    m_max_isSet = true;
}

bool OAITotalItems::is_max_Set() const{
    return m_max_isSet;
}

bool OAITotalItems::is_max_Valid() const{
    return m_max_isValid;
}

double OAITotalItems::getMean() const {
    return m_mean;
}
void OAITotalItems::setMean(const double &mean) {
    m_mean = mean;
    m_mean_isSet = true;
}

bool OAITotalItems::is_mean_Set() const{
    return m_mean_isSet;
}

bool OAITotalItems::is_mean_Valid() const{
    return m_mean_isValid;
}

qint32 OAITotalItems::getMin() const {
    return m_min;
}
void OAITotalItems::setMin(const qint32 &min) {
    m_min = min;
    m_min_isSet = true;
}

bool OAITotalItems::is_min_Set() const{
    return m_min_isSet;
}

bool OAITotalItems::is_min_Valid() const{
    return m_min_isValid;
}

qint32 OAITotalItems::getMissing() const {
    return m_missing;
}
void OAITotalItems::setMissing(const qint32 &missing) {
    m_missing = missing;
    m_missing_isSet = true;
}

bool OAITotalItems::is_missing_Set() const{
    return m_missing_isSet;
}

bool OAITotalItems::is_missing_Valid() const{
    return m_missing_isValid;
}

double OAITotalItems::getStdDev() const {
    return m_std_dev;
}
void OAITotalItems::setStdDev(const double &std_dev) {
    m_std_dev = std_dev;
    m_std_dev_isSet = true;
}

bool OAITotalItems::is_std_dev_Set() const{
    return m_std_dev_isSet;
}

bool OAITotalItems::is_std_dev_Valid() const{
    return m_std_dev_isValid;
}

qint32 OAITotalItems::getSum() const {
    return m_sum;
}
void OAITotalItems::setSum(const qint32 &sum) {
    m_sum = sum;
    m_sum_isSet = true;
}

bool OAITotalItems::is_sum_Set() const{
    return m_sum_isSet;
}

bool OAITotalItems::is_sum_Valid() const{
    return m_sum_isValid;
}

qint64 OAITotalItems::getSumOfSquares() const {
    return m_sum_of_squares;
}
void OAITotalItems::setSumOfSquares(const qint64 &sum_of_squares) {
    m_sum_of_squares = sum_of_squares;
    m_sum_of_squares_isSet = true;
}

bool OAITotalItems::is_sum_of_squares_Set() const{
    return m_sum_of_squares_isSet;
}

bool OAITotalItems::is_sum_of_squares_Valid() const{
    return m_sum_of_squares_isValid;
}

bool OAITotalItems::isSet() const {
...
bool OAITotalItems::isValid() const {
