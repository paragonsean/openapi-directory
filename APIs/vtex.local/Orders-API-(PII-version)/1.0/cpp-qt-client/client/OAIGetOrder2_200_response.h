...
/*
 * OAIGetOrder2_200_response.h
 *
 * 
 */

#ifndef OAIGetOrder2_200_response_H
#define OAIGetOrder2_200_response_H
...
class OAIGetOrder2_200_response_items_inner;
class OAIMarketplace;
class OAIGetOrder2_200_response_packageAttachment;
class OAIPaymentData;
class OAIRatesAndBenefitsData;
class OAISeller;
class OAIShippingData;
class OAIStorePreferencesData;
class OAIGetOrder2_200_response_totals_inner;

class OAIGetOrder2_200_response : public OAIObject {
public:
    OAIGetOrder2_200_response();
    OAIGetOrder2_200_response(QString json);
    ~OAIGetOrder2_200_response() override;
    ...
    QList<OAIGetOrder2_200_response_items_inner> getItems() const;
    void setItems(const QList<OAIGetOrder2_200_response_items_inner> &items);
    ...
    OAIGetOrder2_200_response_packageAttachment getPackageAttachment() const;
    void setPackageAttachment(const OAIGetOrder2_200_response_packageAttachment &package_attachment);
    ...
    QList<OAIGetOrder2_200_response_totals_inner> getTotals() const;
    void setTotals(const QList<OAIGetOrder2_200_response_totals_inner> &totals);
...
private:
    ...
    QList<OAIGetOrder2_200_response_items_inner> m_items;
    bool m_items_isSet;
    ...
    OAIGetOrder2_200_response_packageAttachment m_package_attachment;
    ...
    QList<OAIGetOrder2_200_response_totals_inner> m_totals;
    bool m_totals_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOrder2_200_response)

#endif // OAIGetOrder2_200_response_H
