...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketplaceApi.GetMatchedOffersResponse();
  });
  ...
  describe('GetMatchedOffersResponse', function() {
    it('should create an instance of GetMatchedOffersResponse', function() {
      // uncomment below and update the code to test GetMatchedOffersResponse
      //var instance = new MarketplaceApi.GetMatchedOffersResponse();
      //expect(instance).to.be.a(MarketplaceApi.GetMatchedOffersResponse);
    });
