...
/**
 * The CreateSellerLeadRequest model module.
 * @module model/CreateSellerLeadRequest
 * @version 1.0
 */
class CreateSellerLeadRequest {
    /**
     * Constructs a new <code>CreateSellerLeadRequest</code>.
     * @alias module:model/CreateSellerLeadRequest
    ...
    constructor(accountId, accountable, address, document, email, hasAcceptedLegalTerms, salesChannel, sellerAccountName, sellerEmail, sellerName, sellerType) { 
        ...
        CreateSellerLeadRequest.initialize(this, accountId, accountable, address, document, email, hasAcceptedLegalTerms, salesChannel, sellerAccountName, sellerEmail, sellerName, sellerType);
    }
    ...
    /**
     * Constructs a <code>CreateSellerLeadRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSellerLeadRequest} obj Optional instance to populate.
     * @return {module:model/CreateSellerLeadRequest} The populated <code>CreateSellerLeadRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSellerLeadRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSellerLeadRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSellerLeadRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateSellerLeadRequest.RequiredProperties) {
...
CreateSellerLeadRequest.RequiredProperties = ["accountId", "accountable", "address", "document", "email", "hasAcceptedLegalTerms", "salesChannel", "sellerAccountName", "sellerEmail", "sellerName", "sellerType"];
 ...
 */
CreateSellerLeadRequest.prototype['accountId'] = '5fb38ace-d95e-45ad-970d-ee97cce9fbcd';

/**
 * @member {module:model/Accountable} accountable
 */
CreateSellerLeadRequest.prototype['accountable'] = undefined;

/**
 * @member {module:model/Address} address
 */
CreateSellerLeadRequest.prototype['address'] = undefined;
 ...
 * @default '12345671000'
 */
CreateSellerLeadRequest.prototype['document'] = '12345671000';

/**
 * @member {String} email
 * @default 'email@email.com'
 */
CreateSellerLeadRequest.prototype['email'] = 'email@email.com';
 ...
 * @default true
 */
CreateSellerLeadRequest.prototype['hasAcceptedLegalTerms'] = true;
 ...
 * @default '1'
 */
CreateSellerLeadRequest.prototype['salesChannel'] = '1';
 ...
 * @default 'seller123'
 */
CreateSellerLeadRequest.prototype['sellerAccountName'] = 'seller123';
 ...
 */
CreateSellerLeadRequest.prototype['sellerEmail'] = 'selleremail@email.com';
 ...
 * @default 'Seller Name'
 */
CreateSellerLeadRequest.prototype['sellerName'] = 'Seller Name';
 ...
 * @default 1
 */
CreateSellerLeadRequest.prototype['sellerType'] = 1;
...
export default CreateSellerLeadRequest;
