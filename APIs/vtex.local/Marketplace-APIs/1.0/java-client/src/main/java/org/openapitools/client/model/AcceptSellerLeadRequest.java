...
public class AcceptSellerLeadRequest {
  ...
  public AcceptSellerLeadRequest accountId(String accountId) {
  ...
  public AcceptSellerLeadRequest accountable(Accountable accountable) {
  ...
  public AcceptSellerLeadRequest address(Address address) {
  ...
  public AcceptSellerLeadRequest document(String document) {
  ...
  public AcceptSellerLeadRequest email(String email) {
    this.email = email;
    return this;
  }
  ...
  public AcceptSellerLeadRequest hasAcceptedLegalTerms(Boolean hasAcceptedLegalTerms) {
  ...
  public AcceptSellerLeadRequest salesChannel(String salesChannel) {
  ...
  public AcceptSellerLeadRequest sellerAccountName(String sellerAccountName) {
  ...
  public AcceptSellerLeadRequest sellerEmail(String sellerEmail) {
  ...
  public AcceptSellerLeadRequest sellerName(String sellerName) {
  ...
  public AcceptSellerLeadRequest sellerType(Integer sellerType) {
  ...
  public boolean equals(Object o) {
    ...
    AcceptSellerLeadRequest acceptSellerLeadRequest = (AcceptSellerLeadRequest) o;
    return Objects.equals(this.accountId, acceptSellerLeadRequest.accountId) &&
        Objects.equals(this.accountable, acceptSellerLeadRequest.accountable) &&
        Objects.equals(this.address, acceptSellerLeadRequest.address) &&
        Objects.equals(this.document, acceptSellerLeadRequest.document) &&
        Objects.equals(this.email, acceptSellerLeadRequest.email) &&
        Objects.equals(this.hasAcceptedLegalTerms, acceptSellerLeadRequest.hasAcceptedLegalTerms) &&
        Objects.equals(this.salesChannel, acceptSellerLeadRequest.salesChannel) &&
        Objects.equals(this.sellerAccountName, acceptSellerLeadRequest.sellerAccountName) &&
        Objects.equals(this.sellerEmail, acceptSellerLeadRequest.sellerEmail) &&
        Objects.equals(this.sellerName, acceptSellerLeadRequest.sellerName) &&
        Objects.equals(this.sellerType, acceptSellerLeadRequest.sellerType);
  }
  ...
  public String toString() {
    ...
    sb.append("class AcceptSellerLeadRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AcceptSellerLeadRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AcceptSellerLeadRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AcceptSellerLeadRequest is not found in the empty JSON string", AcceptSellerLeadRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AcceptSellerLeadRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AcceptSellerLeadRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AcceptSellerLeadRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AcceptSellerLeadRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AcceptSellerLeadRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AcceptSellerLeadRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AcceptSellerLeadRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AcceptSellerLeadRequest>() {
           @Override
           public void write(JsonWriter out, AcceptSellerLeadRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AcceptSellerLeadRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AcceptSellerLeadRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AcceptSellerLeadRequest
   * @throws IOException if the JSON string is invalid with respect to AcceptSellerLeadRequest
   */
  public static AcceptSellerLeadRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AcceptSellerLeadRequest.class);
  }

  /**
   * Convert an instance of AcceptSellerLeadRequest to an JSON string
   *
   * @return JSON string
   */
