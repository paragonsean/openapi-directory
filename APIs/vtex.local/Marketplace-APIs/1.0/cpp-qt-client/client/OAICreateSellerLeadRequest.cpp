...
OAICreateSellerLeadRequest::OAICreateSellerLeadRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSellerLeadRequest::OAICreateSellerLeadRequest() {
    this->initializeModel();
}

OAICreateSellerLeadRequest::~OAICreateSellerLeadRequest() {}

void OAICreateSellerLeadRequest::initializeModel() {
...
void OAICreateSellerLeadRequest::fromJson(QString jsonString) {
...
void OAICreateSellerLeadRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateSellerLeadRequest::asJson() const {
...
QJsonObject OAICreateSellerLeadRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSellerLeadRequest::getAccountId() const {
    return m_account_id;
}
void OAICreateSellerLeadRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAICreateSellerLeadRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAICreateSellerLeadRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

OAIAccountable OAICreateSellerLeadRequest::getAccountable() const {
    return m_accountable;
}
void OAICreateSellerLeadRequest::setAccountable(const OAIAccountable &accountable) {
    m_accountable = accountable;
    m_accountable_isSet = true;
}

bool OAICreateSellerLeadRequest::is_accountable_Set() const{
    return m_accountable_isSet;
}

bool OAICreateSellerLeadRequest::is_accountable_Valid() const{
    return m_accountable_isValid;
}

OAIAddress OAICreateSellerLeadRequest::getAddress() const {
    return m_address;
}
void OAICreateSellerLeadRequest::setAddress(const OAIAddress &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAICreateSellerLeadRequest::is_address_Set() const{
    return m_address_isSet;
}

bool OAICreateSellerLeadRequest::is_address_Valid() const{
    return m_address_isValid;
}

QString OAICreateSellerLeadRequest::getDocument() const {
    return m_document;
}
void OAICreateSellerLeadRequest::setDocument(const QString &document) {
    m_document = document;
    m_document_isSet = true;
}

bool OAICreateSellerLeadRequest::is_document_Set() const{
    return m_document_isSet;
}

bool OAICreateSellerLeadRequest::is_document_Valid() const{
    return m_document_isValid;
}

QString OAICreateSellerLeadRequest::getEmail() const {
    return m_email;
}
void OAICreateSellerLeadRequest::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAICreateSellerLeadRequest::is_email_Set() const{
    return m_email_isSet;
}

bool OAICreateSellerLeadRequest::is_email_Valid() const{
    return m_email_isValid;
}

bool OAICreateSellerLeadRequest::isHasAcceptedLegalTerms() const {
    return m_has_accepted_legal_terms;
}
void OAICreateSellerLeadRequest::setHasAcceptedLegalTerms(const bool &has_accepted_legal_terms) {
    m_has_accepted_legal_terms = has_accepted_legal_terms;
    m_has_accepted_legal_terms_isSet = true;
}

bool OAICreateSellerLeadRequest::is_has_accepted_legal_terms_Set() const{
    return m_has_accepted_legal_terms_isSet;
}

bool OAICreateSellerLeadRequest::is_has_accepted_legal_terms_Valid() const{
    return m_has_accepted_legal_terms_isValid;
}

QString OAICreateSellerLeadRequest::getSalesChannel() const {
    return m_sales_channel;
}
void OAICreateSellerLeadRequest::setSalesChannel(const QString &sales_channel) {
    m_sales_channel = sales_channel;
    m_sales_channel_isSet = true;
}

bool OAICreateSellerLeadRequest::is_sales_channel_Set() const{
    return m_sales_channel_isSet;
}

bool OAICreateSellerLeadRequest::is_sales_channel_Valid() const{
    return m_sales_channel_isValid;
}

QString OAICreateSellerLeadRequest::getSellerAccountName() const {
    return m_seller_account_name;
}
void OAICreateSellerLeadRequest::setSellerAccountName(const QString &seller_account_name) {
    m_seller_account_name = seller_account_name;
    m_seller_account_name_isSet = true;
}

bool OAICreateSellerLeadRequest::is_seller_account_name_Set() const{
    return m_seller_account_name_isSet;
}

bool OAICreateSellerLeadRequest::is_seller_account_name_Valid() const{
    return m_seller_account_name_isValid;
}

QString OAICreateSellerLeadRequest::getSellerEmail() const {
    return m_seller_email;
}
void OAICreateSellerLeadRequest::setSellerEmail(const QString &seller_email) {
    m_seller_email = seller_email;
    m_seller_email_isSet = true;
}

bool OAICreateSellerLeadRequest::is_seller_email_Set() const{
    return m_seller_email_isSet;
}

bool OAICreateSellerLeadRequest::is_seller_email_Valid() const{
    return m_seller_email_isValid;
}

QString OAICreateSellerLeadRequest::getSellerName() const {
    return m_seller_name;
}
void OAICreateSellerLeadRequest::setSellerName(const QString &seller_name) {
    m_seller_name = seller_name;
    m_seller_name_isSet = true;
}

bool OAICreateSellerLeadRequest::is_seller_name_Set() const{
    return m_seller_name_isSet;
}

bool OAICreateSellerLeadRequest::is_seller_name_Valid() const{
    return m_seller_name_isValid;
}

qint32 OAICreateSellerLeadRequest::getSellerType() const {
    return m_seller_type;
}
void OAICreateSellerLeadRequest::setSellerType(const qint32 &seller_type) {
    m_seller_type = seller_type;
    m_seller_type_isSet = true;
}

bool OAICreateSellerLeadRequest::is_seller_type_Set() const{
    return m_seller_type_isSet;
}

bool OAICreateSellerLeadRequest::is_seller_type_Valid() const{
    return m_seller_type_isValid;
}

bool OAICreateSellerLeadRequest::isSet() const {
...
bool OAICreateSellerLeadRequest::isValid() const {
