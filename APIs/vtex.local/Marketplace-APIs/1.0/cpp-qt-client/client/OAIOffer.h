...
namespace OpenAPI {
class OAIOffersPerSalesChannel;
...
public:
    ...
    QList<OAIOffersPerSalesChannel> getOffersPerSalesChannel() const;
    void setOffersPerSalesChannel(const QList<OAIOffersPerSalesChannel> &offers_per_sales_channel);
...
private:
    ...
    QList<OAIOffersPerSalesChannel> m_offers_per_sales_channel;
