...
/*
 * OAIBulkUpsertSellerCommissionsRequest.h
 *
 * 
 */

#ifndef OAIBulkUpsertSellerCommissionsRequest_H
#define OAIBulkUpsertSellerCommissionsRequest_H
...
class OAIBulkUpsertSellerCommissionsRequest : public OAIObject {
public:
    OAIBulkUpsertSellerCommissionsRequest();
    OAIBulkUpsertSellerCommissionsRequest(QString json);
    ~OAIBulkUpsertSellerCommissionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBulkUpsertSellerCommissionsRequest)

#endif // OAIBulkUpsertSellerCommissionsRequest_H
