...
/*
 * OAICreateSellerLeadRequest.h
 *
 * 
 */

#ifndef OAICreateSellerLeadRequest_H
#define OAICreateSellerLeadRequest_H
...
class OAICreateSellerLeadRequest : public OAIObject {
public:
    OAICreateSellerLeadRequest();
    OAICreateSellerLeadRequest(QString json);
    ~OAICreateSellerLeadRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSellerLeadRequest)

#endif // OAICreateSellerLeadRequest_H
