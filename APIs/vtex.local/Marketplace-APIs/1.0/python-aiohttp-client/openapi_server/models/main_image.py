...
class MainImage(Model):
    ...
    def __init__(self, image_id: str='53878805', image_label: str='Image 1', image_path: str='~/archives/ids/155411-#width#-#height#/Webp.net-resizeimage.jpg', image_tag: str='<img src="~/archives/ids/155411-#width#-#height#/Webp.net-resizeimage.jpg" width="#width#" height="#height#" alt="Image name and description" id="" />', image_text: str='Image name and description', is_main: bool=True, is_zoom_size: bool=True, last_modified: str='2021-05-06T21:37:24.262529'):
