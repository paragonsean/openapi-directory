...
public class PutProductDescriptionRequest {
  ...
  public PutProductDescriptionRequest() {
  }

  public PutProductDescriptionRequest description(String description) {
  ...
  public PutProductDescriptionRequest productId(String productId) {
  ...
  public boolean equals(Object o) {
    ...
    PutProductDescriptionRequest putProductDescriptionRequest = (PutProductDescriptionRequest) o;
    return Objects.equals(this.description, putProductDescriptionRequest.description) &&
        Objects.equals(this.productId, putProductDescriptionRequest.productId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, productId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutProductDescriptionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutProductDescriptionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutProductDescriptionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutProductDescriptionRequest is not found in the empty JSON string", PutProductDescriptionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutProductDescriptionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutProductDescriptionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutProductDescriptionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutProductDescriptionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutProductDescriptionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutProductDescriptionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutProductDescriptionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutProductDescriptionRequest>() {
           @Override
           public void write(JsonWriter out, PutProductDescriptionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutProductDescriptionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutProductDescriptionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutProductDescriptionRequest
   * @throws IOException if the JSON string is invalid with respect to PutProductDescriptionRequest
   */
  public static PutProductDescriptionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutProductDescriptionRequest.class);
  }

  /**
   * Convert an instance of PutProductDescriptionRequest to an JSON string
   *
   * @return JSON string
   */
