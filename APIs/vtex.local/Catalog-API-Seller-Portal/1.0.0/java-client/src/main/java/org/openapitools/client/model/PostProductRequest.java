...
public class PostProductRequest {
  ...
  private List<SkusInner> skus = new ArrayList<>();
  ...
  public PostProductRequest attributes(List<AttributesInner> attributes) {
    this.attributes = attributes;
    return this;
  }

  public PostProductRequest addAttributesItem(AttributesInner attributesItem) {
  ...
  public PostProductRequest brandId(String brandId) {
  ...
  public PostProductRequest categoryIds(List<String> categoryIds) {
    this.categoryIds = categoryIds;
    return this;
  }

  public PostProductRequest addCategoryIdsItem(String categoryIdsItem) {
  ...
  public PostProductRequest description(String description) {
  ...
  public PostProductRequest externalId(String externalId) {
  ...
  public PostProductRequest images(List<ImagesInner> images) {
    this.images = images;
    return this;
  }

  public PostProductRequest addImagesItem(ImagesInner imagesItem) {
    if (this.images == null) {
  ...
  public PostProductRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PostProductRequest origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public PostProductRequest skus(List<SkusInner> skus) {
    this.skus = skus;
    return this;
  }

  public PostProductRequest addSkusItem(SkusInner skusItem) {
    if (this.skus == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<SkusInner> getSkus() {
    return skus;
  }

  public void setSkus(List<SkusInner> skus) {
    this.skus = skus;
  }


  public PostProductRequest slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public PostProductRequest specs(List<SpecsInner1> specs) {
    this.specs = specs;
    return this;
  }

  public PostProductRequest addSpecsItem(SpecsInner1 specsItem) {
    if (this.specs == null) {
  ...
  public PostProductRequest status(String status) {
    this.status = status;
    return this;
  }
  ...
  public PostProductRequest taxCode(String taxCode) {
  ...
  public PostProductRequest transportModal(String transportModal) {
  ...
  public boolean equals(Object o) {
    ...
    PostProductRequest postProductRequest = (PostProductRequest) o;
    return Objects.equals(this.attributes, postProductRequest.attributes) &&
        Objects.equals(this.brandId, postProductRequest.brandId) &&
        Objects.equals(this.categoryIds, postProductRequest.categoryIds) &&
        Objects.equals(this.description, postProductRequest.description) &&
        Objects.equals(this.externalId, postProductRequest.externalId) &&
        Objects.equals(this.images, postProductRequest.images) &&
        Objects.equals(this.name, postProductRequest.name) &&
        Objects.equals(this.origin, postProductRequest.origin) &&
        Objects.equals(this.skus, postProductRequest.skus) &&
        Objects.equals(this.slug, postProductRequest.slug) &&
        Objects.equals(this.specs, postProductRequest.specs) &&
        Objects.equals(this.status, postProductRequest.status) &&
        Objects.equals(this.taxCode, postProductRequest.taxCode) &&
        Objects.equals(this.transportModal, postProductRequest.transportModal);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attributes, brandId, categoryIds, description, externalId, images, name, origin, skus, slug, specs, status, taxCode, transportModal);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostProductRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostProductRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostProductRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostProductRequest is not found in the empty JSON string", PostProductRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostProductRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostProductRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostProductRequest.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayskus.size(); i++) {
        SkusInner.validateJsonElement(jsonArrayskus.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostProductRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostProductRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostProductRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostProductRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostProductRequest>() {
           @Override
           public void write(JsonWriter out, PostProductRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostProductRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostProductRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostProductRequest
   * @throws IOException if the JSON string is invalid with respect to PostProductRequest
   */
  public static PostProductRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostProductRequest.class);
  }

  /**
   * Convert an instance of PostProductRequest to an JSON string
   *
   * @return JSON string
   */
