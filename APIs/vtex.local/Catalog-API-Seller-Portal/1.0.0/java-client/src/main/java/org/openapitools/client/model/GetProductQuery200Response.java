...
public class GetProductQuery200Response {
  ...
  public GetProductQuery200Response() {
  }

  public GetProductQuery200Response attributes(List<AttributesInner> attributes) {
    this.attributes = attributes;
    return this;
  }

  public GetProductQuery200Response addAttributesItem(AttributesInner attributesItem) {
  ...
  public GetProductQuery200Response brandId(String brandId) {
  ...
  public GetProductQuery200Response brandName(String brandName) {
  ...
  public GetProductQuery200Response categoryIds(List<String> categoryIds) {
    this.categoryIds = categoryIds;
    return this;
  }

  public GetProductQuery200Response addCategoryIdsItem(String categoryIdsItem) {
  ...
  public GetProductQuery200Response categoryNames(List<String> categoryNames) {
    this.categoryNames = categoryNames;
    return this;
  }

  public GetProductQuery200Response addCategoryNamesItem(String categoryNamesItem) {
  ...
  public GetProductQuery200Response createdAt(String createdAt) {
  ...
  public GetProductQuery200Response externalId(String externalId) {
  ...
  public GetProductQuery200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetProductQuery200Response images(List<ImagesInner> images) {
    this.images = images;
    return this;
  }

  public GetProductQuery200Response addImagesItem(ImagesInner imagesItem) {
    if (this.images == null) {
  ...
  public GetProductQuery200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetProductQuery200Response origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public GetProductQuery200Response skus(List<SkusInner2> skus) {
    this.skus = skus;
    return this;
  }

  public GetProductQuery200Response addSkusItem(SkusInner2 skusItem) {
    if (this.skus == null) {
  ...
  public GetProductQuery200Response slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public GetProductQuery200Response specs(List<SpecsInner1> specs) {
    this.specs = specs;
    return this;
  }

  public GetProductQuery200Response addSpecsItem(SpecsInner1 specsItem) {
    if (this.specs == null) {
  ...
  public GetProductQuery200Response status(String status) {
    this.status = status;
    return this;
  }
  ...
  public GetProductQuery200Response taxCode(String taxCode) {
  ...
  public GetProductQuery200Response transportModal(String transportModal) {
  ...
  public GetProductQuery200Response updatedAt(String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    GetProductQuery200Response getProductQuery200Response = (GetProductQuery200Response) o;
    return Objects.equals(this.attributes, getProductQuery200Response.attributes) &&
        Objects.equals(this.brandId, getProductQuery200Response.brandId) &&
        Objects.equals(this.brandName, getProductQuery200Response.brandName) &&
        Objects.equals(this.categoryIds, getProductQuery200Response.categoryIds) &&
        Objects.equals(this.categoryNames, getProductQuery200Response.categoryNames) &&
        Objects.equals(this.createdAt, getProductQuery200Response.createdAt) &&
        Objects.equals(this.externalId, getProductQuery200Response.externalId) &&
        Objects.equals(this.id, getProductQuery200Response.id) &&
        Objects.equals(this.images, getProductQuery200Response.images) &&
        Objects.equals(this.name, getProductQuery200Response.name) &&
        Objects.equals(this.origin, getProductQuery200Response.origin) &&
        Objects.equals(this.skus, getProductQuery200Response.skus) &&
        Objects.equals(this.slug, getProductQuery200Response.slug) &&
        Objects.equals(this.specs, getProductQuery200Response.specs) &&
        Objects.equals(this.status, getProductQuery200Response.status) &&
        Objects.equals(this.taxCode, getProductQuery200Response.taxCode) &&
        Objects.equals(this.transportModal, getProductQuery200Response.transportModal) &&
        Objects.equals(this.updatedAt, getProductQuery200Response.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProductQuery200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProductQuery200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProductQuery200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProductQuery200Response is not found in the empty JSON string", GetProductQuery200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProductQuery200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProductQuery200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProductQuery200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProductQuery200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProductQuery200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProductQuery200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProductQuery200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProductQuery200Response>() {
           @Override
           public void write(JsonWriter out, GetProductQuery200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProductQuery200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProductQuery200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProductQuery200Response
   * @throws IOException if the JSON string is invalid with respect to GetProductQuery200Response
   */
  public static GetProductQuery200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProductQuery200Response.class);
  }

  /**
   * Convert an instance of GetProductQuery200Response to an JSON string
   *
   * @return JSON string
   */
