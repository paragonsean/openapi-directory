...
public class PostProduct200Response {
  ...
  private List<SkusInner1> skus = new ArrayList<>();
  ...
  public PostProduct200Response() {
  }

  public PostProduct200Response attributes(List<AttributesInner> attributes) {
    this.attributes = attributes;
    return this;
  }

  public PostProduct200Response addAttributesItem(AttributesInner attributesItem) {
  ...
  public PostProduct200Response brandId(String brandId) {
  ...
  public PostProduct200Response brandName(String brandName) {
  ...
  public PostProduct200Response categoryIds(List<String> categoryIds) {
    this.categoryIds = categoryIds;
    return this;
  }

  public PostProduct200Response addCategoryIdsItem(String categoryIdsItem) {
  ...
  public PostProduct200Response categoryNames(List<String> categoryNames) {
    this.categoryNames = categoryNames;
    return this;
  }

  public PostProduct200Response addCategoryNamesItem(String categoryNamesItem) {
  ...
  public PostProduct200Response createdAt(String createdAt) {
  ...
  public PostProduct200Response externalId(String externalId) {
  ...
  public PostProduct200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public PostProduct200Response images(List<ImagesInner> images) {
    this.images = images;
    return this;
  }

  public PostProduct200Response addImagesItem(ImagesInner imagesItem) {
    if (this.images == null) {
  ...
  public PostProduct200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PostProduct200Response origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public PostProduct200Response skus(List<SkusInner1> skus) {
    this.skus = skus;
    return this;
  }

  public PostProduct200Response addSkusItem(SkusInner1 skusItem) {
    if (this.skus == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<SkusInner1> getSkus() {
    return skus;
  }

  public void setSkus(List<SkusInner1> skus) {
    this.skus = skus;
  }


  public PostProduct200Response slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public PostProduct200Response specs(List<SpecsInner1> specs) {
    this.specs = specs;
    return this;
  }

  public PostProduct200Response addSpecsItem(SpecsInner1 specsItem) {
    if (this.specs == null) {
  ...
  public PostProduct200Response status(String status) {
    this.status = status;
    return this;
  }
  ...
  public PostProduct200Response taxCode(String taxCode) {
  ...
  public PostProduct200Response transportModal(String transportModal) {
  ...
  public PostProduct200Response updatedAt(String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    PostProduct200Response postProduct200Response = (PostProduct200Response) o;
    return Objects.equals(this.attributes, postProduct200Response.attributes) &&
        Objects.equals(this.brandId, postProduct200Response.brandId) &&
        Objects.equals(this.brandName, postProduct200Response.brandName) &&
        Objects.equals(this.categoryIds, postProduct200Response.categoryIds) &&
        Objects.equals(this.categoryNames, postProduct200Response.categoryNames) &&
        Objects.equals(this.createdAt, postProduct200Response.createdAt) &&
        Objects.equals(this.externalId, postProduct200Response.externalId) &&
        Objects.equals(this.id, postProduct200Response.id) &&
        Objects.equals(this.images, postProduct200Response.images) &&
        Objects.equals(this.name, postProduct200Response.name) &&
        Objects.equals(this.origin, postProduct200Response.origin) &&
        Objects.equals(this.skus, postProduct200Response.skus) &&
        Objects.equals(this.slug, postProduct200Response.slug) &&
        Objects.equals(this.specs, postProduct200Response.specs) &&
        Objects.equals(this.status, postProduct200Response.status) &&
        Objects.equals(this.taxCode, postProduct200Response.taxCode) &&
        Objects.equals(this.transportModal, postProduct200Response.transportModal) &&
        Objects.equals(this.updatedAt, postProduct200Response.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostProduct200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostProduct200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostProduct200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostProduct200Response is not found in the empty JSON string", PostProduct200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostProduct200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostProduct200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostProduct200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayskus.size(); i++) {
        SkusInner1.validateJsonElement(jsonArrayskus.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostProduct200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostProduct200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostProduct200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostProduct200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PostProduct200Response>() {
           @Override
           public void write(JsonWriter out, PostProduct200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostProduct200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostProduct200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostProduct200Response
   * @throws IOException if the JSON string is invalid with respect to PostProduct200Response
   */
  public static PostProduct200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostProduct200Response.class);
  }

  /**
   * Convert an instance of PostProduct200Response to an JSON string
   *
   * @return JSON string
   */
