...
public class SkusInner {
  ...
  public SkusInner dimensions(Dimensions dimensions) {
  ...
  public SkusInner ean(String ean) {
    this.ean = ean;
    return this;
  }
  ...
  public SkusInner externalId(String externalId) {
  ...
  public SkusInner images(List<Object> images) {
    this.images = images;
    return this;
  }

  public SkusInner addImagesItem(Object imagesItem) {
    if (this.images == null) {
  ...
  public SkusInner isActive(Boolean isActive) {
  ...
  public SkusInner manufacturerCode(String manufacturerCode) {
  ...
  public SkusInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SkusInner specs(List<SpecsInner> specs) {
    this.specs = specs;
    return this;
  }

  public SkusInner addSpecsItem(SpecsInner specsItem) {
    if (this.specs == null) {
  ...
  public SkusInner weight(Integer weight) {
    this.weight = weight;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SkusInner skusInner = (SkusInner) o;
    return Objects.equals(this.dimensions, skusInner.dimensions) &&
        Objects.equals(this.ean, skusInner.ean) &&
        Objects.equals(this.externalId, skusInner.externalId) &&
        Objects.equals(this.images, skusInner.images) &&
        Objects.equals(this.isActive, skusInner.isActive) &&
        Objects.equals(this.manufacturerCode, skusInner.manufacturerCode) &&
        Objects.equals(this.name, skusInner.name) &&
        Objects.equals(this.specs, skusInner.specs) &&
        Objects.equals(this.weight, skusInner.weight);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dimensions, ean, externalId, images, isActive, manufacturerCode, name, specs, weight);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SkusInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SkusInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SkusInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SkusInner is not found in the empty JSON string", SkusInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SkusInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SkusInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SkusInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SkusInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SkusInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SkusInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SkusInner.class));

       return (TypeAdapter<T>) new TypeAdapter<SkusInner>() {
           @Override
           public void write(JsonWriter out, SkusInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SkusInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SkusInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SkusInner
   * @throws IOException if the JSON string is invalid with respect to SkusInner
   */
  public static SkusInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SkusInner.class);
  }

  /**
   * Convert an instance of SkusInner to an JSON string
   *
   * @return JSON string
   */
