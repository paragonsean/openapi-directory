...
public class Value2 {
  ...
  public Value2 isActive(Boolean isActive) {
  ...
  public Value2 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, value2.id) &&
        Objects.equals(this.isActive, value2.isActive) &&
        Objects.equals(this.name, value2.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Value2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Value2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Value2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Value2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
