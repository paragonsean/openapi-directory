...
public class ApiClient {
    ...
    private String basePath = "https://vtex.local";
    ...
    new ServerConfiguration(
      ...
      "VTEX server URL.",
      new HashMap<String, ServerVariable>() {{
        put("accountName", new ServerVariable(
          "Name of the VTEX account. Used as part of the URL.",
          "{accountName}",
          new HashSet<String>(
          )
        ));
        put("environment", new ServerVariable(
    ...
    public ApiClient() {
        ...
        authentications.put("appKey", new ApiKeyAuth("header", "X-VTEX-API-AppKey"));
        authentications.put("appToken", new ApiKeyAuth("header", "X-VTEX-API-AppToken"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://vtex.local
