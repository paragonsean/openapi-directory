...
public class GetBrand200Response {
  ...
  public GetBrand200Response() {
  }

  public GetBrand200Response createdAt(String createdAt) {
  ...
  public GetBrand200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetBrand200Response isActive(Boolean isActive) {
  ...
  public GetBrand200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetBrand200Response updatedAt(String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    GetBrand200Response getBrand200Response = (GetBrand200Response) o;
    return Objects.equals(this.createdAt, getBrand200Response.createdAt) &&
        Objects.equals(this.id, getBrand200Response.id) &&
        Objects.equals(this.isActive, getBrand200Response.isActive) &&
        Objects.equals(this.name, getBrand200Response.name) &&
        Objects.equals(this.updatedAt, getBrand200Response.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetBrand200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBrand200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBrand200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBrand200Response is not found in the empty JSON string", GetBrand200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBrand200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBrand200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBrand200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBrand200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBrand200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBrand200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBrand200Response>() {
           @Override
           public void write(JsonWriter out, GetBrand200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBrand200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBrand200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBrand200Response
   * @throws IOException if the JSON string is invalid with respect to GetBrand200Response
   */
  public static GetBrand200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBrand200Response.class);
  }

  /**
   * Convert an instance of GetBrand200Response to an JSON string
   *
   * @return JSON string
   */
