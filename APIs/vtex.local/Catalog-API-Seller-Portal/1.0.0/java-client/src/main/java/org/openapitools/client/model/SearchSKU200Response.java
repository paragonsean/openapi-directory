...
import org.openapitools.client.model.SearchSKU200ResponseDataInner;
...
public class SearchSKU200Response {
  ...
  private List<SearchSKU200ResponseDataInner> data = new ArrayList<>();

  public SearchSKU200Response() {
  }

  public SearchSKU200Response metadata(SearchSKU200ResponseMetadata metadata) {
  ...
  public SearchSKU200Response data(List<SearchSKU200ResponseDataInner> data) {
    this.data = data;
    return this;
  }

  public SearchSKU200Response addDataItem(SearchSKU200ResponseDataInner dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<SearchSKU200ResponseDataInner> getData() {
    return data;
  }

  public void setData(List<SearchSKU200ResponseDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchSKU200Response searchSKU200Response = (SearchSKU200Response) o;
    return Objects.equals(this.metadata, searchSKU200Response.metadata) &&
        Objects.equals(this.data, searchSKU200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchSKU200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchSKU200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchSKU200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchSKU200Response is not found in the empty JSON string", SearchSKU200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchSKU200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchSKU200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            SearchSKU200ResponseDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchSKU200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchSKU200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchSKU200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchSKU200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchSKU200Response>() {
           @Override
           public void write(JsonWriter out, SearchSKU200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchSKU200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchSKU200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchSKU200Response
   * @throws IOException if the JSON string is invalid with respect to SearchSKU200Response
   */
  public static SearchSKU200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchSKU200Response.class);
  }

  /**
   * Convert an instance of SearchSKU200Response to an JSON string
   *
   * @return JSON string
   */
