...
public class PutBrandRequest {
  ...
  public PutBrandRequest() {
  }

  public PutBrandRequest id(String id) {
    this.id = id;
    return this;
  }
  ...
  public PutBrandRequest isActive(Boolean isActive) {
  ...
  public PutBrandRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutBrandRequest putBrandRequest = (PutBrandRequest) o;
    return Objects.equals(this.id, putBrandRequest.id) &&
        Objects.equals(this.isActive, putBrandRequest.isActive) &&
        Objects.equals(this.name, putBrandRequest.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutBrandRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutBrandRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutBrandRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutBrandRequest is not found in the empty JSON string", PutBrandRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutBrandRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutBrandRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutBrandRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutBrandRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutBrandRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutBrandRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutBrandRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutBrandRequest>() {
           @Override
           public void write(JsonWriter out, PutBrandRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutBrandRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutBrandRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutBrandRequest
   * @throws IOException if the JSON string is invalid with respect to PutBrandRequest
   */
  public static PutBrandRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutBrandRequest.class);
  }

  /**
   * Convert an instance of PutBrandRequest to an JSON string
   *
   * @return JSON string
   */
