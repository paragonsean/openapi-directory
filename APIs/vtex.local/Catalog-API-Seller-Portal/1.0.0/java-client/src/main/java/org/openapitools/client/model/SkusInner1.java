...
public class SkusInner1 {
  ...
  public SkusInner1 dimensions(Dimensions dimensions) {
  ...
  public SkusInner1 ean(String ean) {
    this.ean = ean;
    return this;
  }
  ...
  public SkusInner1 externalId(String externalId) {
  ...
  public SkusInner1 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SkusInner1 images(List<Object> images) {
    this.images = images;
    return this;
  }

  public SkusInner1 addImagesItem(Object imagesItem) {
    if (this.images == null) {
  ...
  public SkusInner1 isActive(Boolean isActive) {
  ...
  public SkusInner1 manufacturerCode(String manufacturerCode) {
  ...
  public SkusInner1 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SkusInner1 specs(List<SpecsInner> specs) {
    this.specs = specs;
    return this;
  }

  public SkusInner1 addSpecsItem(SpecsInner specsItem) {
    if (this.specs == null) {
  ...
  public SkusInner1 weight(Integer weight) {
    this.weight = weight;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SkusInner1 skusInner1 = (SkusInner1) o;
    return Objects.equals(this.dimensions, skusInner1.dimensions) &&
        Objects.equals(this.ean, skusInner1.ean) &&
        Objects.equals(this.externalId, skusInner1.externalId) &&
        Objects.equals(this.id, skusInner1.id) &&
        Objects.equals(this.images, skusInner1.images) &&
        Objects.equals(this.isActive, skusInner1.isActive) &&
        Objects.equals(this.manufacturerCode, skusInner1.manufacturerCode) &&
        Objects.equals(this.name, skusInner1.name) &&
        Objects.equals(this.specs, skusInner1.specs) &&
        Objects.equals(this.weight, skusInner1.weight);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SkusInner1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SkusInner1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SkusInner1 is not found in the empty JSON string", SkusInner1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SkusInner1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SkusInner1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SkusInner1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SkusInner1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SkusInner1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SkusInner1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SkusInner1.class));

       return (TypeAdapter<T>) new TypeAdapter<SkusInner1>() {
           @Override
           public void write(JsonWriter out, SkusInner1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SkusInner1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SkusInner1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SkusInner1
   * @throws IOException if the JSON string is invalid with respect to SkusInner1
   */
  public static SkusInner1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SkusInner1.class);
  }

  /**
   * Convert an instance of SkusInner1 to an JSON string
   *
   * @return JSON string
   */
