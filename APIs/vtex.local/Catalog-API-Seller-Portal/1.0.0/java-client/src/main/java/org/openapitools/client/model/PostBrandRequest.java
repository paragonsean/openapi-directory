...
public class PostBrandRequest {
  ...
  public PostBrandRequest isActive(Boolean isActive) {
  ...
  public PostBrandRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostBrandRequest postBrandRequest = (PostBrandRequest) o;
    return Objects.equals(this.isActive, postBrandRequest.isActive) &&
        Objects.equals(this.name, postBrandRequest.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isActive, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostBrandRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostBrandRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostBrandRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostBrandRequest is not found in the empty JSON string", PostBrandRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostBrandRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostBrandRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostBrandRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostBrandRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostBrandRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostBrandRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostBrandRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostBrandRequest>() {
           @Override
           public void write(JsonWriter out, PostBrandRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostBrandRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostBrandRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostBrandRequest
   * @throws IOException if the JSON string is invalid with respect to PostBrandRequest
   */
  public static PostBrandRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostBrandRequest.class);
  }

  /**
   * Convert an instance of PostBrandRequest to an JSON string
   *
   * @return JSON string
   */
