...
public class UpdateCategoryTreeRequest {
  ...
  public UpdateCategoryTreeRequest() {
  }

  public UpdateCategoryTreeRequest roots(List<RootsInner> roots) {
    this.roots = roots;
    return this;
  }

  public UpdateCategoryTreeRequest addRootsItem(RootsInner rootsItem) {
    if (this.roots == null) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateCategoryTreeRequest updateCategoryTreeRequest = (UpdateCategoryTreeRequest) o;
    return Objects.equals(this.roots, updateCategoryTreeRequest.roots);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateCategoryTreeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCategoryTreeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCategoryTreeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCategoryTreeRequest is not found in the empty JSON string", UpdateCategoryTreeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCategoryTreeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCategoryTreeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateCategoryTreeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCategoryTreeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCategoryTreeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCategoryTreeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCategoryTreeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCategoryTreeRequest>() {
           @Override
           public void write(JsonWriter out, UpdateCategoryTreeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCategoryTreeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateCategoryTreeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCategoryTreeRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateCategoryTreeRequest
   */
  public static UpdateCategoryTreeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCategoryTreeRequest.class);
  }

  /**
   * Convert an instance of UpdateCategoryTreeRequest to an JSON string
   *
   * @return JSON string
   */
