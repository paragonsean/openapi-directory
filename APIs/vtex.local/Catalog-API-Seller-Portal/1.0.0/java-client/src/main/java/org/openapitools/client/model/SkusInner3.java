...
public class SkusInner3 {
  ...
  public SkusInner3 dimensions(Dimensions dimensions) {
  ...
  public SkusInner3 ean(String ean) {
    this.ean = ean;
    return this;
  }
  ...
  public SkusInner3 externalId(String externalId) {
  ...
  public SkusInner3 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SkusInner3 images(List<Object> images) {
    this.images = images;
    return this;
  }

  public SkusInner3 addImagesItem(Object imagesItem) {
    if (this.images == null) {
  ...
  public SkusInner3 isActive(Boolean isActive) {
  ...
  public SkusInner3 manufacturerCode(String manufacturerCode) {
  ...
  public SkusInner3 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SkusInner3 specs(List<SpecsInner> specs) {
    this.specs = specs;
    return this;
  }

  public SkusInner3 addSpecsItem(SpecsInner specsItem) {
    if (this.specs == null) {
  ...
  public SkusInner3 weight(Integer weight) {
    this.weight = weight;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SkusInner3 skusInner3 = (SkusInner3) o;
    return Objects.equals(this.dimensions, skusInner3.dimensions) &&
        Objects.equals(this.ean, skusInner3.ean) &&
        Objects.equals(this.externalId, skusInner3.externalId) &&
        Objects.equals(this.id, skusInner3.id) &&
        Objects.equals(this.images, skusInner3.images) &&
        Objects.equals(this.isActive, skusInner3.isActive) &&
        Objects.equals(this.manufacturerCode, skusInner3.manufacturerCode) &&
        Objects.equals(this.name, skusInner3.name) &&
        Objects.equals(this.specs, skusInner3.specs) &&
        Objects.equals(this.weight, skusInner3.weight);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dimensions, ean, externalId, id, images, isActive, manufacturerCode, name, specs, weight);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SkusInner3 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SkusInner3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SkusInner3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SkusInner3 is not found in the empty JSON string", SkusInner3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SkusInner3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SkusInner3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SkusInner3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SkusInner3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SkusInner3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SkusInner3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SkusInner3.class));

       return (TypeAdapter<T>) new TypeAdapter<SkusInner3>() {
           @Override
           public void write(JsonWriter out, SkusInner3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SkusInner3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SkusInner3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SkusInner3
   * @throws IOException if the JSON string is invalid with respect to SkusInner3
   */
  public static SkusInner3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SkusInner3.class);
  }

  /**
   * Convert an instance of SkusInner3 to an JSON string
   *
   * @return JSON string
   */
