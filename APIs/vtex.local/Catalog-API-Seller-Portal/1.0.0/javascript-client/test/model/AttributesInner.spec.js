...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.AttributesInner();
  });
  ...
  describe('AttributesInner', function() {
    it('should create an instance of AttributesInner', function() {
      // uncomment below and update the code to test AttributesInner
      //var instance = new CatalogApiSellerPortal.AttributesInner();
      //expect(instance).to.be.a(CatalogApiSellerPortal.AttributesInner);
    });
