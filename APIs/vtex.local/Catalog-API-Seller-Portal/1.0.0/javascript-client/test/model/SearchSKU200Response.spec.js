...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.SearchSKU200Response();
  });
  ...
  describe('SearchSKU200Response', function() {
    it('should create an instance of SearchSKU200Response', function() {
      // uncomment below and update the code to test SearchSKU200Response
      //var instance = new CatalogApiSellerPortal.SearchSKU200Response();
      //expect(instance).to.be.a(CatalogApiSellerPortal.SearchSKU200Response);
    });

    it('should have the property metadata (base name: "_metadata")', function() {
