...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.SkusInner1();
  });
  ...
  describe('SkusInner1', function() {
    it('should create an instance of SkusInner1', function() {
      // uncomment below and update the code to test SkusInner1
      //var instance = new CatalogApiSellerPortal.SkusInner1();
      //expect(instance).to.be.a(CatalogApiSellerPortal.SkusInner1);
    });
