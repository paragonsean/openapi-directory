...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.DataInner();
  });
  ...
  describe('DataInner', function() {
    it('should create an instance of DataInner', function() {
      // uncomment below and update the code to test DataInner
      //var instance = new CatalogApiSellerPortal.DataInner();
      //expect(instance).to.be.a(CatalogApiSellerPortal.DataInner);
    });
