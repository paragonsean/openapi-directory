...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.ChildrenInner1();
  });
  ...
  describe('ChildrenInner1', function() {
    it('should create an instance of ChildrenInner1', function() {
      // uncomment below and update the code to test ChildrenInner1
      //var instance = new CatalogApiSellerPortal.ChildrenInner1();
      //expect(instance).to.be.a(CatalogApiSellerPortal.ChildrenInner1);
    });
