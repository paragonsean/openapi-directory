...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.SkusInner3();
  });
  ...
  describe('SkusInner3', function() {
    it('should create an instance of SkusInner3', function() {
      // uncomment below and update the code to test SkusInner3
      //var instance = new CatalogApiSellerPortal.SkusInner3();
      //expect(instance).to.be.a(CatalogApiSellerPortal.SkusInner3);
    });
