...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.GetProductDescription200Response();
  });
  ...
  describe('GetProductDescription200Response', function() {
    it('should create an instance of GetProductDescription200Response', function() {
      // uncomment below and update the code to test GetProductDescription200Response
      //var instance = new CatalogApiSellerPortal.GetProductDescription200Response();
      //expect(instance).to.be.a(CatalogApiSellerPortal.GetProductDescription200Response);
    });
