...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.PostBrandRequest();
  });
  ...
  describe('PostBrandRequest', function() {
    it('should create an instance of PostBrandRequest', function() {
      // uncomment below and update the code to test PostBrandRequest
      //var instance = new CatalogApiSellerPortal.PostBrandRequest();
      //expect(instance).to.be.a(CatalogApiSellerPortal.PostBrandRequest);
    });
