...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.ImagesInner();
  });
  ...
  describe('ImagesInner', function() {
    it('should create an instance of ImagesInner', function() {
      // uncomment below and update the code to test ImagesInner
      //var instance = new CatalogApiSellerPortal.ImagesInner();
      //expect(instance).to.be.a(CatalogApiSellerPortal.ImagesInner);
    });
