...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.SkusInner();
  });
  ...
  describe('SkusInner', function() {
    it('should create an instance of SkusInner', function() {
      // uncomment below and update the code to test SkusInner
      //var instance = new CatalogApiSellerPortal.SkusInner();
      //expect(instance).to.be.a(CatalogApiSellerPortal.SkusInner);
    });
