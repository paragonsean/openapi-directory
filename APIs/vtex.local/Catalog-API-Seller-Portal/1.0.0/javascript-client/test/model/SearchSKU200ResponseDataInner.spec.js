...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.SearchSKU200ResponseDataInner();
  });
  ...
  describe('SearchSKU200ResponseDataInner', function() {
    it('should create an instance of SearchSKU200ResponseDataInner', function() {
      // uncomment below and update the code to test SearchSKU200ResponseDataInner
      //var instance = new CatalogApiSellerPortal.SearchSKU200ResponseDataInner();
      //expect(instance).to.be.a(CatalogApiSellerPortal.SearchSKU200ResponseDataInner);
    });
