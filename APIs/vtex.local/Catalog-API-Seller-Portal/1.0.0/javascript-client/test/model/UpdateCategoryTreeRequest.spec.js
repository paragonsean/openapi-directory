...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.UpdateCategoryTreeRequest();
  });
  ...
  describe('UpdateCategoryTreeRequest', function() {
    it('should create an instance of UpdateCategoryTreeRequest', function() {
      // uncomment below and update the code to test UpdateCategoryTreeRequest
      //var instance = new CatalogApiSellerPortal.UpdateCategoryTreeRequest();
      //expect(instance).to.be.a(CatalogApiSellerPortal.UpdateCategoryTreeRequest);
    });
