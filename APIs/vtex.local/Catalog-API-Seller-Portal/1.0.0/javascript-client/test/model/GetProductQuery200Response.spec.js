...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.GetProductQuery200Response();
  });
  ...
  describe('GetProductQuery200Response', function() {
    it('should create an instance of GetProductQuery200Response', function() {
      // uncomment below and update the code to test GetProductQuery200Response
      //var instance = new CatalogApiSellerPortal.GetProductQuery200Response();
      //expect(instance).to.be.a(CatalogApiSellerPortal.GetProductQuery200Response);
    });
    ...
    it('should have the property transportModal (base name: "transportModal")', function() {
      // uncomment below and update the code to test the property transportModal
      //var instance = new CatalogApiSellerPortal.GetProductQuery200Response();
      //expect(instance).to.be();
    });
