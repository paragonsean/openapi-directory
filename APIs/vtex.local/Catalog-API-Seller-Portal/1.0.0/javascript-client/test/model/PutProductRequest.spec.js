...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.PutProductRequest();
  });
  ...
  describe('PutProductRequest', function() {
    it('should create an instance of PutProductRequest', function() {
      // uncomment below and update the code to test PutProductRequest
      //var instance = new CatalogApiSellerPortal.PutProductRequest();
      //expect(instance).to.be.a(CatalogApiSellerPortal.PutProductRequest);
    });
