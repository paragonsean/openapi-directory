...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.Dimensions();
  });
  ...
  describe('Dimensions', function() {
    it('should create an instance of Dimensions', function() {
      ...
      //var instance = new CatalogApiSellerPortal.Dimensions();
      //expect(instance).to.be.a(CatalogApiSellerPortal.Dimensions);
    });
