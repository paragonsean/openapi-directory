...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.PostProductRequest();
  });
  ...
  describe('PostProductRequest', function() {
    it('should create an instance of PostProductRequest', function() {
      // uncomment below and update the code to test PostProductRequest
      //var instance = new CatalogApiSellerPortal.PostProductRequest();
      //expect(instance).to.be.a(CatalogApiSellerPortal.PostProductRequest);
    });
