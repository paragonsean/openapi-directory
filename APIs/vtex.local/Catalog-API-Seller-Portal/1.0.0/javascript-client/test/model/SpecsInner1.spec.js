...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.SpecsInner1();
  });
  ...
  describe('SpecsInner1', function() {
    it('should create an instance of SpecsInner1', function() {
      // uncomment below and update the code to test SpecsInner1
      //var instance = new CatalogApiSellerPortal.SpecsInner1();
      //expect(instance).to.be.a(CatalogApiSellerPortal.SpecsInner1);
    });
