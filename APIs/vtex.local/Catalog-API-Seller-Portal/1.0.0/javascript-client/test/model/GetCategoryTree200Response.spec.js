...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.GetCategoryTree200Response();
  });
  ...
  describe('GetCategoryTree200Response', function() {
    it('should create an instance of GetCategoryTree200Response', function() {
      // uncomment below and update the code to test GetCategoryTree200Response
      //var instance = new CatalogApiSellerPortal.GetCategoryTree200Response();
      //expect(instance).to.be.a(CatalogApiSellerPortal.GetCategoryTree200Response);
    });
