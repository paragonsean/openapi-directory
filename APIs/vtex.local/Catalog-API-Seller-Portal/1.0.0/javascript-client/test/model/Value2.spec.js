...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.Value2();
  });
  ...
  describe('Value2', function() {
    it('should create an instance of Value2', function() {
      // uncomment below and update the code to test Value2
      //var instance = new CatalogApiSellerPortal.Value2();
      //expect(instance).to.be.a(CatalogApiSellerPortal.Value2);
    });
