...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.SearchSKU200ResponseMetadata();
  });
  ...
  describe('SearchSKU200ResponseMetadata', function() {
    it('should create an instance of SearchSKU200ResponseMetadata', function() {
      // uncomment below and update the code to test SearchSKU200ResponseMetadata
      //var instance = new CatalogApiSellerPortal.SearchSKU200ResponseMetadata();
      //expect(instance).to.be.a(CatalogApiSellerPortal.SearchSKU200ResponseMetadata);
    });
