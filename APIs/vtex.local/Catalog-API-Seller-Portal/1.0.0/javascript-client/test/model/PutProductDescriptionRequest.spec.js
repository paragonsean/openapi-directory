...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.PutProductDescriptionRequest();
  });
  ...
  describe('PutProductDescriptionRequest', function() {
    it('should create an instance of PutProductDescriptionRequest', function() {
      // uncomment below and update the code to test PutProductDescriptionRequest
      //var instance = new CatalogApiSellerPortal.PutProductDescriptionRequest();
      //expect(instance).to.be.a(CatalogApiSellerPortal.PutProductDescriptionRequest);
    });
