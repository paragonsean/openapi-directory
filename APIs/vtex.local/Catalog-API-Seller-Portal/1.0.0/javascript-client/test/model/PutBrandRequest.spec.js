...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.PutBrandRequest();
  });
  ...
  describe('PutBrandRequest', function() {
    it('should create an instance of PutBrandRequest', function() {
      // uncomment below and update the code to test PutBrandRequest
      //var instance = new CatalogApiSellerPortal.PutBrandRequest();
      //expect(instance).to.be.a(CatalogApiSellerPortal.PutBrandRequest);
    });
