...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.SpecsInner();
  });
  ...
  describe('SpecsInner', function() {
    it('should create an instance of SpecsInner', function() {
      // uncomment below and update the code to test SpecsInner
      //var instance = new CatalogApiSellerPortal.SpecsInner();
      //expect(instance).to.be.a(CatalogApiSellerPortal.SpecsInner);
    });
