...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.Value1();
  });
  ...
  describe('Value1', function() {
    it('should create an instance of Value1', function() {
      // uncomment below and update the code to test Value1
      //var instance = new CatalogApiSellerPortal.Value1();
      //expect(instance).to.be.a(CatalogApiSellerPortal.Value1);
    });
