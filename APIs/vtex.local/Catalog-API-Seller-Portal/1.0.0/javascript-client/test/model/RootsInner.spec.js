...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.RootsInner();
  });
  ...
  describe('RootsInner', function() {
    it('should create an instance of RootsInner', function() {
      // uncomment below and update the code to test RootsInner
      //var instance = new CatalogApiSellerPortal.RootsInner();
      //expect(instance).to.be.a(CatalogApiSellerPortal.RootsInner);
    });
