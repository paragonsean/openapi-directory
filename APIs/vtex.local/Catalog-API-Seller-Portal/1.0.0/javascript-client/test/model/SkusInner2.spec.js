...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.SkusInner2();
  });
  ...
  describe('SkusInner2', function() {
    it('should create an instance of SkusInner2', function() {
      // uncomment below and update the code to test SkusInner2
      //var instance = new CatalogApiSellerPortal.SkusInner2();
      //expect(instance).to.be.a(CatalogApiSellerPortal.SkusInner2);
    });
