...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.BrandApi();
  });
  ...
  describe('BrandApi', function() {
    ...
    describe('listBrand', function() {
      it('should call listBrand successfully', function(done) {
        //uncomment below and update the code to test listBrand
        //instance.listBrand(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postBrand', function() {
      it('should call postBrand successfully', function(done) {
        //uncomment below and update the code to test postBrand
        //instance.postBrand(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('putBrand', function() {
      it('should call putBrand successfully', function(done) {
        //uncomment below and update the code to test putBrand
        //instance.putBrand(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
