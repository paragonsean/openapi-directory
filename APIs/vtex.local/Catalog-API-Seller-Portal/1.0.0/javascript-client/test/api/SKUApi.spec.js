...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogApiSellerPortal.SKUApi();
  });
  ...
  describe('SKUApi', function() {
    describe('listSKU', function() {
      it('should call listSKU successfully', function(done) {
        //uncomment below and update the code to test listSKU
        //instance.listSKU(function(error) {
    ...
    describe('searchSKU', function() {
      it('should call searchSKU successfully', function(done) {
        //uncomment below and update the code to test searchSKU
        //instance.searchSKU(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
