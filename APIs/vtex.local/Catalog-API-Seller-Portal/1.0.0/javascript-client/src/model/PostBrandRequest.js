...
/**
 * The PostBrandRequest model module.
 * @module model/PostBrandRequest
 * @version 1.0.0
 */
class PostBrandRequest {
    /**
     * Constructs a new <code>PostBrandRequest</code>.
     * @alias module:model/PostBrandRequest
     * @param isActive {Boolean} The condition defines if the brand is active (`true`) or inactive (`false`).
     * @param name {String} Brand Name.
     */
    constructor(isActive, name) { 
        
        PostBrandRequest.initialize(this, isActive, name);
    }
     ...
     */
    static initialize(obj, isActive, name) { 
        obj['isActive'] = isActive;
        obj['name'] = name;
    }

    /**
     * Constructs a <code>PostBrandRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostBrandRequest} obj Optional instance to populate.
     * @return {module:model/PostBrandRequest} The populated <code>PostBrandRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostBrandRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PostBrandRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostBrandRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostBrandRequest.RequiredProperties) {
...
PostBrandRequest.RequiredProperties = ["isActive", "name"];

/**
 * The condition defines if the brand is active (`true`) or inactive (`false`).
 * @member {Boolean} isActive
 */
PostBrandRequest.prototype['isActive'] = undefined;

/**
 * Brand Name.
 * @member {String} name
 */
PostBrandRequest.prototype['name'] = undefined;
...
export default PostBrandRequest;
