...
/**
 * The SkusInner1 model module.
 * @module model/SkusInner1
 * @version 1.0.0
 */
class SkusInner1 {
    /**
     * Constructs a new <code>SkusInner1</code>.
     * @alias module:model/SkusInner1
    ...
    constructor(dimensions, id, images, isActive, specs, weight) { 
        ...
        SkusInner1.initialize(this, dimensions, id, images, isActive, specs, weight);
    }
    ...
    /**
     * Constructs a <code>SkusInner1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SkusInner1} obj Optional instance to populate.
     * @return {module:model/SkusInner1} The populated <code>SkusInner1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SkusInner1();
    ...
    /**
     * Validates the JSON data with respect to <code>SkusInner1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SkusInner1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SkusInner1.RequiredProperties) {
 ...
 * @member {String} name
 */
SkusInner1.prototype['name'] = undefined;
 ...
 */
SkusInner1.prototype['specs'] = undefined;

/**
 * SKU weight.
 * @member {Number} weight
 */
SkusInner1.prototype['weight'] = undefined;
