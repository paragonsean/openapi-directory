...
/**
 * The PutBrandRequest model module.
 * @module model/PutBrandRequest
 * @version 1.0.0
 */
class PutBrandRequest {
    /**
     * Constructs a new <code>PutBrandRequest</code>.
     * @alias module:model/PutBrandRequest
    ...
    constructor(id, isActive, name) { 
        ...
        PutBrandRequest.initialize(this, id, isActive, name);
    }
    ...
    /**
     * Constructs a <code>PutBrandRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutBrandRequest} obj Optional instance to populate.
     * @return {module:model/PutBrandRequest} The populated <code>PutBrandRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutBrandRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutBrandRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutBrandRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutBrandRequest.RequiredProperties) {
...
PutBrandRequest.RequiredProperties = ["id", "isActive", "name"];

/**
 * Brand unique identifier number.
 * @member {String} id
 */
PutBrandRequest.prototype['id'] = undefined;

/**
 * The condition defines if the brand is active (`true`) or inactive (`false`).
 * @member {Boolean} isActive
 */
PutBrandRequest.prototype['isActive'] = undefined;

/**
 * Brand Name.
 * @member {String} name
 */
PutBrandRequest.prototype['name'] = undefined;
...
export default PutBrandRequest;
