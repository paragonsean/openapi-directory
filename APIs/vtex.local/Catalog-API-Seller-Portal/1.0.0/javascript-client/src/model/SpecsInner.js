...
/**
 * The SpecsInner model module.
 * @module model/SpecsInner
 * @version 1.0.0
 */
class SpecsInner {
    /**
     * Constructs a new <code>SpecsInner</code>.
     * @alias module:model/SpecsInner
     * @param name {String} SKU's specification name.
     * @param value {String} SKU's specification values.
     */
    constructor(name, value) { 
        
        SpecsInner.initialize(this, name, value);
    }
    ...
    /**
     * Constructs a <code>SpecsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SpecsInner} obj Optional instance to populate.
     * @return {module:model/SpecsInner} The populated <code>SpecsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SpecsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>SpecsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SpecsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SpecsInner.RequiredProperties) {
...
SpecsInner.RequiredProperties = ["name", "value"];

/**
 * SKU's specification name.
 * @member {String} name
 */
SpecsInner.prototype['name'] = undefined;

/**
 * SKU's specification values.
 * @member {String} value
 */
SpecsInner.prototype['value'] = undefined;
