...
/**
 * The SkusInner3 model module.
 * @module model/SkusInner3
 * @version 1.0.0
 */
class SkusInner3 {
    /**
     * Constructs a new <code>SkusInner3</code>.
     * @alias module:model/SkusInner3
     * @param dimensions {module:model/Dimensions} 
     * @param images {Array.<Object>} SKU's images IDs.
     * @param isActive {Boolean} Defines if the SKU is active (`true`) or inactive (`false`).
     ...
     */
    constructor(dimensions, images, isActive, specs, weight) { 
        
        SkusInner3.initialize(this, dimensions, images, isActive, specs, weight);
    }
     ...
     */
    static initialize(obj, dimensions, images, isActive, specs, weight) { 
    ...
    /**
     * Constructs a <code>SkusInner3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SkusInner3} obj Optional instance to populate.
     * @return {module:model/SkusInner3} The populated <code>SkusInner3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SkusInner3();
    ...
    /**
     * Validates the JSON data with respect to <code>SkusInner3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SkusInner3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SkusInner3.RequiredProperties) {
 ...
 * @member {String} name
 */
SkusInner3.prototype['name'] = undefined;
 ...
 */
SkusInner3.prototype['specs'] = undefined;

/**
 * SKU weight.
 * @member {Number} weight
 */
SkusInner3.prototype['weight'] = undefined;
