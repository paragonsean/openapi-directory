...
/**
 * The SpecsInner1 model module.
 * @module model/SpecsInner1
 * @version 1.0.0
 */
class SpecsInner1 {
    /**
     * Constructs a new <code>SpecsInner1</code>.
     * @alias module:model/SpecsInner1
     * @param name {String} Specification name.
     * @param values {Array.<String>} Specification values.
     */
    constructor(name, values) { 
        
        SpecsInner1.initialize(this, name, values);
    }
    ...
    /**
     * Constructs a <code>SpecsInner1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SpecsInner1} obj Optional instance to populate.
     * @return {module:model/SpecsInner1} The populated <code>SpecsInner1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SpecsInner1();
    ...
    /**
     * Validates the JSON data with respect to <code>SpecsInner1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SpecsInner1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SpecsInner1.RequiredProperties) {
...
SpecsInner1.RequiredProperties = ["name", "values"];

/**
 * Specification name.
 * @member {String} name
 */
SpecsInner1.prototype['name'] = undefined;

/**
 * Specification values.
 * @member {Array.<String>} values
 */
SpecsInner1.prototype['values'] = undefined;
