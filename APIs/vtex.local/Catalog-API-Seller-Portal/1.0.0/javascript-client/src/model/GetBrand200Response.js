...
/**
 * The GetBrand200Response model module.
 * @module model/GetBrand200Response
 * @version 1.0.0
 */
class GetBrand200Response {
    /**
     * Constructs a new <code>GetBrand200Response</code>.
     * @alias module:model/GetBrand200Response
     */
    constructor() { 
        
        GetBrand200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetBrand200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBrand200Response} obj Optional instance to populate.
     * @return {module:model/GetBrand200Response} The populated <code>GetBrand200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBrand200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetBrand200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBrand200Response</code>.
     */
 ...
 */
GetBrand200Response.prototype['createdAt'] = undefined;

/**
 * Brand unique identifier number.
 * @member {String} id
 */
GetBrand200Response.prototype['id'] = undefined;

/**
 * The condition defines if the brand is active (`true`) or inactive (`false`).
 * @member {Boolean} isActive
 */
GetBrand200Response.prototype['isActive'] = undefined;

/**
 * Brand Name.
 * @member {String} name
 */
GetBrand200Response.prototype['name'] = undefined;

/**
 * Last date when the brand was updated.
 * @member {String} updatedAt
 */
GetBrand200Response.prototype['updatedAt'] = undefined;
...
export default GetBrand200Response;
