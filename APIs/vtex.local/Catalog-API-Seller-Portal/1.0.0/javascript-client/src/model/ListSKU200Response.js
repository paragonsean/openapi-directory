...
/**
 * The ListSKU200Response model module.
 * @module model/ListSKU200Response
 * @version 1.0.0
 */
class ListSKU200Response {
    /**
     * Constructs a new <code>ListSKU200Response</code>.
     * @alias module:model/ListSKU200Response
     */
    constructor() { 
        
        ListSKU200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSKU200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSKU200Response} obj Optional instance to populate.
     * @return {module:model/ListSKU200Response} The populated <code>ListSKU200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSKU200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ListSKU200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSKU200Response</code>.
     */
 ...
 */
ListSKU200Response.prototype['_metadata'] = undefined;

/**
 * List with information about the SKU.
 * @member {Array.<String>} data
 */
ListSKU200Response.prototype['data'] = undefined;
...
export default ListSKU200Response;
