...
/**
 * The Value2 model module.
 * @module model/Value2
 * @version 1.0.0
 */
class Value2 {
    /**
     * Constructs a new <code>Value2</code>.
     * Object with values of a children category.
     * @alias module:model/Value2
    ...
    constructor(id, isActive, name) { 
        ...
        Value2.initialize(this, id, isActive, name);
    }
    ...
    /**
     * Constructs a <code>Value2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Value2} obj Optional instance to populate.
     * @return {module:model/Value2} The populated <code>Value2</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Value2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Value2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Value2.RequiredProperties) {
...
Value2.RequiredProperties = ["id", "isActive", "name"];

/**
 * Children category unique identifier number.
 * @member {String} id
 */
Value2.prototype['id'] = undefined;

/**
 * The condition defines if the children category is active (`true`) or inactive (`false`).
 * @member {Boolean} isActive
 */
Value2.prototype['isActive'] = undefined;

/**
 * Children category Name.
 * @member {String} name
 */
Value2.prototype['name'] = undefined;
