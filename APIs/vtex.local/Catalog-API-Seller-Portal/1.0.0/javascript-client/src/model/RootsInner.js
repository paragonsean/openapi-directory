...
/**
 * The RootsInner model module.
 * @module model/RootsInner
 * @version 1.0.0
 */
class RootsInner {
    /**
     * Constructs a new <code>RootsInner</code>.
     * @alias module:model/RootsInner
     * @param children {Array.<module:model/ChildrenInner>} List of all children categories of the parent category.
     * @param value {module:model/Value1} 
     */
    constructor(children, value) { 
        
        RootsInner.initialize(this, children, value);
    }
    ...
    /**
     * Constructs a <code>RootsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RootsInner} obj Optional instance to populate.
     * @return {module:model/RootsInner} The populated <code>RootsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RootsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>RootsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RootsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RootsInner.RequiredProperties) {
