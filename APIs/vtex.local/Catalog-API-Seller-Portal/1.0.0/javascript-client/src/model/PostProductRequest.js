...
import SkusInner from './SkusInner';
...
class PostProductRequest {
     ...
     * @param skus {Array.<module:model/SkusInner>} SKUs of the product.
    ...
    constructor(attributes, brandId, categoryIds, images, name, origin, skus, slug, specs, status) { 
        ...
        PostProductRequest.initialize(this, attributes, brandId, categoryIds, images, name, origin, skus, slug, specs, status);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('skus')) {
                obj['skus'] = ApiClient.convertToType(data['skus'], [SkusInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PostProductRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostProductRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostProductRequest.RequiredProperties) {
...
PostProductRequest.RequiredProperties = ["attributes", "brandId", "categoryIds", "images", "name", "origin", "skus", "slug", "specs", "status"];
 ...
 */
PostProductRequest.prototype['attributes'] = undefined;

/**
 * Product's Brand unique identifier number.
 * @member {String} brandId
 */
PostProductRequest.prototype['brandId'] = undefined;
 ...
 */
PostProductRequest.prototype['categoryIds'] = undefined;
 ...
 */
PostProductRequest.prototype['externalId'] = undefined;

/**
 * Information of the images of the product.
 * @member {Array.<module:model/ImagesInner>} images
 */
PostProductRequest.prototype['images'] = undefined;
 ...
 */
PostProductRequest.prototype['origin'] = undefined;

/**
 * SKUs of the product.
 * @member {Array.<module:model/SkusInner>} skus
 */
PostProductRequest.prototype['skus'] = undefined;

/**
 * Reference of the product in the URL of the store.
 * @member {String} slug
 */
PostProductRequest.prototype['slug'] = undefined;

/**
 * Specifications that will differentiate the possible product SKUs.
 * @member {Array.<module:model/SpecsInner1>} specs
 */
PostProductRequest.prototype['specs'] = undefined;
 ...
 */
PostProductRequest.prototype['taxCode'] = undefined;

/**
 * Transport modal of the product.
 * @member {String} transportModal
 */
PostProductRequest.prototype['transportModal'] = undefined;
...
export default PostProductRequest;
