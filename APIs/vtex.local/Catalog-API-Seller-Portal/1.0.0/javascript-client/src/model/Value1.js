...
class Value1 {
     ...
     * @param id {String} Category unique identifier number.
     * @param isActive {Boolean} The condition defines if the category is active (`true`) or inactive (`false`).
     * @param name {String} Category Name.
     */
    constructor(id, isActive, name) { 
        
        Value1.initialize(this, id, isActive, name);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Value1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Value1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Value1.RequiredProperties) {
...
Value1.RequiredProperties = ["id", "isActive", "name"];

/**
 * Category unique identifier number.
 * @member {String} id
 */
Value1.prototype['id'] = undefined;

/**
 * The condition defines if the category is active (`true`) or inactive (`false`).
 * @member {Boolean} isActive
 */
Value1.prototype['isActive'] = undefined;

/**
 * Category Name.
 * @member {String} name
 */
Value1.prototype['name'] = undefined;
