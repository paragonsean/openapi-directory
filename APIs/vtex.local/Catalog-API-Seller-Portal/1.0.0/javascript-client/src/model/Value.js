...
class Value {
     ...
     * @param id {String} Children category unique identifier number.
     * @param isActive {Boolean} The condition defines if the children category is active (`true`) or inactive (`false`).
     * @param name {String} Children category Name.
     */
    constructor(id, isActive, name) { 
        
        Value.initialize(this, id, isActive, name);
    }
     ...
     */
    static initialize(obj, id, isActive, name) { 
        obj['id'] = id;
...
Value.RequiredProperties = ["id", "isActive", "name"];
 ...
 */
Value.prototype['isActive'] = undefined;
