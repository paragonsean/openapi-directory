...
import SkusInner1 from './SkusInner1';
import SpecsInner1 from './SpecsInner1';

/**
 * The PostProduct200Response model module.
 * @module model/PostProduct200Response
 * @version 1.0.0
 */
class PostProduct200Response {
    /**
     * Constructs a new <code>PostProduct200Response</code>.
     * @alias module:model/PostProduct200Response
     ...
     * @param skus {Array.<module:model/SkusInner1>} SKUs of the product.
    ...
    constructor(attributes, brandId, brandName, categoryIds, categoryNames, createdAt, images, name, origin, skus, slug, specs, status, updatedAt) { 
        ...
        PostProduct200Response.initialize(this, attributes, brandId, brandName, categoryIds, categoryNames, createdAt, images, name, origin, skus, slug, specs, status, updatedAt);
    }
    ...
    /**
     * Constructs a <code>PostProduct200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostProduct200Response} obj Optional instance to populate.
     * @return {module:model/PostProduct200Response} The populated <code>PostProduct200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostProduct200Response();
            ...
            if (data.hasOwnProperty('skus')) {
                obj['skus'] = ApiClient.convertToType(data['skus'], [SkusInner1]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PostProduct200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostProduct200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostProduct200Response.RequiredProperties) {
...
PostProduct200Response.RequiredProperties = ["attributes", "brandId", "brandName", "categoryIds", "categoryNames", "createdAt", "images", "name", "origin", "skus", "slug", "specs", "status", "updatedAt"];
 ...
 */
PostProduct200Response.prototype['attributes'] = undefined;

/**
 * Product's Brand unique identifier number.
 * @member {String} brandId
 */
PostProduct200Response.prototype['brandId'] = undefined;

/**
 * Name of the Brand associated with the product.
 * @member {String} brandName
 */
PostProduct200Response.prototype['brandName'] = undefined;
 ...
 */
PostProduct200Response.prototype['categoryIds'] = undefined;

/**
 * Names of the product's categories, displayed in a path format.
 * @member {Array.<String>} categoryNames
 */
PostProduct200Response.prototype['categoryNames'] = undefined;

/**
 * Date when the product was created.
 * @member {String} createdAt
 */
PostProduct200Response.prototype['createdAt'] = undefined;

/**
 * Product reference unique identifier number in the store.
 * @member {String} externalId
 */
PostProduct200Response.prototype['externalId'] = undefined;

/**
 * Product's unique identifier number.
 * @member {String} id
 */
PostProduct200Response.prototype['id'] = undefined;

/**
 * Information of the images of the product.
 * @member {Array.<module:model/ImagesInner>} images
 */
PostProduct200Response.prototype['images'] = undefined;
 ...
 * @member {String} name
 */
PostProduct200Response.prototype['name'] = undefined;

/**
 * Origin account of the product. It is not possible to alter products where the origin is `marketplace`.
 * @member {String} origin
 */
PostProduct200Response.prototype['origin'] = undefined;

/**
 * SKUs of the product.
 * @member {Array.<module:model/SkusInner1>} skus
 */
PostProduct200Response.prototype['skus'] = undefined;

/**
 * Reference of the product in the URL of the store.
 * @member {String} slug
 */
PostProduct200Response.prototype['slug'] = undefined;

/**
 * Specifications that will differentiate the possible product SKUs.
 * @member {Array.<module:model/SpecsInner1>} specs
 */
PostProduct200Response.prototype['specs'] = undefined;

/**
 * Status of the product. Its values can be `active` or `inactive`.
 * @member {String} status
 */
PostProduct200Response.prototype['status'] = undefined;

/**
 * Product tax code.
 * @member {String} taxCode
 */
PostProduct200Response.prototype['taxCode'] = undefined;

/**
 * Transport modal of the product.
 * @member {String} transportModal
 */
PostProduct200Response.prototype['transportModal'] = undefined;

/**
 * Last date when the product was updated.
 * @member {String} updatedAt
 */
PostProduct200Response.prototype['updatedAt'] = undefined;
...
export default PostProduct200Response;
