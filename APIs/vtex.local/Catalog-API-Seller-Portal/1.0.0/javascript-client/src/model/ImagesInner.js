...
class ImagesInner {
     ...
     * @param url {String} Image URL, which must be in the following format: `https://{accountName}.vtexassets.com/assets/{path}`, saved using the [Catalog Images app](https://developers.vtex.com/vtex-developer-docs/docs/vtex-catalog-images).
     */
    constructor(id, url) { 
        
        ImagesInner.initialize(this, id, url);
    }
...
ImagesInner.RequiredProperties = ["id", "url"];

/**
 * Image alternative description.
 * @member {String} alt
 */
ImagesInner.prototype['alt'] = undefined;

/**
 * Image ID.
 * @member {String} id
 */
ImagesInner.prototype['id'] = undefined;
 ...
 * @member {String} url
 */
ImagesInner.prototype['url'] = undefined;
