...
/**
 * The GetProduct200Response model module.
 * @module model/GetProduct200Response
 * @version 1.0.0
 */
class GetProduct200Response {
    /**
     * Constructs a new <code>GetProduct200Response</code>.
     * @alias module:model/GetProduct200Response
    ...
    constructor(attributes, brandId, brandName, categoryIds, categoryNames, createdAt, images, name, origin, skus, slug, specs, status, updatedAt) { 
        ...
        GetProduct200Response.initialize(this, attributes, brandId, brandName, categoryIds, categoryNames, createdAt, images, name, origin, skus, slug, specs, status, updatedAt);
    }
    ...
    /**
     * Constructs a <code>GetProduct200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetProduct200Response} obj Optional instance to populate.
     * @return {module:model/GetProduct200Response} The populated <code>GetProduct200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetProduct200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetProduct200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetProduct200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetProduct200Response.RequiredProperties) {
...
GetProduct200Response.RequiredProperties = ["attributes", "brandId", "brandName", "categoryIds", "categoryNames", "createdAt", "images", "name", "origin", "skus", "slug", "specs", "status", "updatedAt"];
 ...
 */
GetProduct200Response.prototype['attributes'] = undefined;

/**
 * Product's Brand unique identifier number.
 * @member {String} brandId
 */
GetProduct200Response.prototype['brandId'] = undefined;

/**
 * Name of the Brand associated with the product.
 * @member {String} brandName
 */
GetProduct200Response.prototype['brandName'] = undefined;
 ...
 */
GetProduct200Response.prototype['categoryIds'] = undefined;

/**
 * Names of the product's categories, displayed in a path format.
 * @member {Array.<String>} categoryNames
 */
GetProduct200Response.prototype['categoryNames'] = undefined;

/**
 * Date when the product was created.
 * @member {String} createdAt
 */
GetProduct200Response.prototype['createdAt'] = undefined;

/**
 * Product reference unique identifier number in the store.
 * @member {String} externalId
 */
GetProduct200Response.prototype['externalId'] = undefined;

/**
 * Product's unique identifier number.
 * @member {String} id
 */
GetProduct200Response.prototype['id'] = undefined;

/**
 * Information of the images of the product.
 * @member {Array.<module:model/ImagesInner>} images
 */
GetProduct200Response.prototype['images'] = undefined;
...
export default GetProduct200Response;
