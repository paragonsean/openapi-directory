...
#ifndef OAISkus_inner_3_H
#define OAISkus_inner_3_H
...
class OAISkus_inner_3 : public OAIObject {
public:
    OAISkus_inner_3();
    OAISkus_inner_3(QString json);
    ~OAISkus_inner_3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISkus_inner_3)

#endif // OAISkus_inner_3_H
