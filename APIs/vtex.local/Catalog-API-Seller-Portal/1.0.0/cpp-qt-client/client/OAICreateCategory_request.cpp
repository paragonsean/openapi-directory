...
QString OAICreateCategory_request::getParentId() const {
    return m_parent_id;
}
void OAICreateCategory_request::setParentId(const QString &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAICreateCategory_request::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAICreateCategory_request::is_parent_id_Valid() const{
