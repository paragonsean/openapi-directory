...
#ifndef OAISkus_inner_2_H
#define OAISkus_inner_2_H
...
class OAISkus_inner_2 : public OAIObject {
public:
    OAISkus_inner_2();
    OAISkus_inner_2(QString json);
    ~OAISkus_inner_2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISkus_inner_2)

#endif // OAISkus_inner_2_H
