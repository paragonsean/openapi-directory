...
#ifndef OAIRoots_inner_H
#define OAIRoots_inner_H
...
class OAIRoots_inner : public OAIObject {
public:
    OAIRoots_inner();
    OAIRoots_inner(QString json);
    ~OAIRoots_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoots_inner)

#endif // OAIRoots_inner_H
