...
/*
 * OAIPostProduct_request.h
 *
 * 
 */

#ifndef OAIPostProduct_request_H
#define OAIPostProduct_request_H

#include <QJsonObject>

#include "OAIAttributes_inner.h"
#include "OAIImages_inner.h"
#include "OAISkus_inner.h"
...
class OAIPostProduct_request : public OAIObject {
public:
    OAIPostProduct_request();
    OAIPostProduct_request(QString json);
    ~OAIPostProduct_request() override;
    ...
    QList<OAISkus_inner> getSkus() const;
    void setSkus(const QList<OAISkus_inner> &skus);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostProduct_request)

#endif // OAIPostProduct_request_H
