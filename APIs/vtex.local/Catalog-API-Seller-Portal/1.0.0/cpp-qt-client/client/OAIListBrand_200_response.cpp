...
OAIListBrand_200_response::OAIListBrand_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListBrand_200_response::OAIListBrand_200_response() {
    this->initializeModel();
}

OAIListBrand_200_response::~OAIListBrand_200_response() {}

void OAIListBrand_200_response::initializeModel() {
...
void OAIListBrand_200_response::fromJson(QString jsonString) {
...
void OAIListBrand_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIListBrand_200_response::asJson() const {
...
QJsonObject OAIListBrand_200_response::asJsonObject() const {
    QJsonObject obj;
...
OAI_metadata OAIListBrand_200_response::getMetadata() const {
    return m__metadata;
}
void OAIListBrand_200_response::setMetadata(const OAI_metadata &_metadata) {
    m__metadata = _metadata;
    m__metadata_isSet = true;
}

bool OAIListBrand_200_response::is__metadata_Set() const{
    return m__metadata_isSet;
}

bool OAIListBrand_200_response::is__metadata_Valid() const{
    return m__metadata_isValid;
}

QList<OAIData_inner> OAIListBrand_200_response::getData() const {
    return m_data;
}
void OAIListBrand_200_response::setData(const QList<OAIData_inner> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIListBrand_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIListBrand_200_response::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIListBrand_200_response::isSet() const {
...
bool OAIListBrand_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m__metadata_isValid && m_data_isValid && true;
}
