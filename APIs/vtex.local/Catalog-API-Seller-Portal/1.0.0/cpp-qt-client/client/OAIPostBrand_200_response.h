...
/*
 * OAIPostBrand_200_response.h
 *
 * 
 */

#ifndef OAIPostBrand_200_response_H
#define OAIPostBrand_200_response_H
...
class OAIPostBrand_200_response : public OAIObject {
public:
    OAIPostBrand_200_response();
    OAIPostBrand_200_response(QString json);
    ~OAIPostBrand_200_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostBrand_200_response)

#endif // OAIPostBrand_200_response_H
