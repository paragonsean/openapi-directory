...
bool OAIValue::isIsActive() const {
    return m_is_active;
}
void OAIValue::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAIValue::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIValue::is_is_active_Valid() const{
