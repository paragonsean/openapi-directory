...
OAISearchSKU_200_response::OAISearchSKU_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchSKU_200_response::OAISearchSKU_200_response() {
    this->initializeModel();
}

OAISearchSKU_200_response::~OAISearchSKU_200_response() {}

void OAISearchSKU_200_response::initializeModel() {
...
void OAISearchSKU_200_response::fromJson(QString jsonString) {
...
void OAISearchSKU_200_response::fromJsonObject(QJsonObject json) {
...
QString OAISearchSKU_200_response::asJson() const {
...
QJsonObject OAISearchSKU_200_response::asJsonObject() const {
    QJsonObject obj;
...
OAISearchSKU_200_response__metadata OAISearchSKU_200_response::getMetadata() const {
    return m__metadata;
}
void OAISearchSKU_200_response::setMetadata(const OAISearchSKU_200_response__metadata &_metadata) {
    m__metadata = _metadata;
    m__metadata_isSet = true;
}

bool OAISearchSKU_200_response::is__metadata_Set() const{
    return m__metadata_isSet;
}

bool OAISearchSKU_200_response::is__metadata_Valid() const{
    return m__metadata_isValid;
}

QList<OAISearchSKU_200_response_data_inner> OAISearchSKU_200_response::getData() const {
    return m_data;
}
void OAISearchSKU_200_response::setData(const QList<OAISearchSKU_200_response_data_inner> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAISearchSKU_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAISearchSKU_200_response::is_data_Valid() const{
    return m_data_isValid;
}

bool OAISearchSKU_200_response::isSet() const {
...
bool OAISearchSKU_200_response::isValid() const {
