...
/*
 * OAIPostBrand_request.h
 *
 * 
 */

#ifndef OAIPostBrand_request_H
#define OAIPostBrand_request_H
...
class OAIPostBrand_request : public OAIObject {
public:
    OAIPostBrand_request();
    OAIPostBrand_request(QString json);
    ~OAIPostBrand_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostBrand_request)

#endif // OAIPostBrand_request_H
