...
OAISkus_inner_2::OAISkus_inner_2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISkus_inner_2::OAISkus_inner_2() {
    this->initializeModel();
}

OAISkus_inner_2::~OAISkus_inner_2() {}

void OAISkus_inner_2::initializeModel() {
...
void OAISkus_inner_2::fromJson(QString jsonString) {
...
void OAISkus_inner_2::fromJsonObject(QJsonObject json) {
...
QString OAISkus_inner_2::asJson() const {
...
QJsonObject OAISkus_inner_2::asJsonObject() const {
    QJsonObject obj;
...
OAIDimensions OAISkus_inner_2::getDimensions() const {
    return m_dimensions;
}
void OAISkus_inner_2::setDimensions(const OAIDimensions &dimensions) {
    m_dimensions = dimensions;
    m_dimensions_isSet = true;
}

bool OAISkus_inner_2::is_dimensions_Set() const{
    return m_dimensions_isSet;
}

bool OAISkus_inner_2::is_dimensions_Valid() const{
    return m_dimensions_isValid;
}

QString OAISkus_inner_2::getEan() const {
    return m_ean;
}
void OAISkus_inner_2::setEan(const QString &ean) {
    m_ean = ean;
    m_ean_isSet = true;
}

bool OAISkus_inner_2::is_ean_Set() const{
    return m_ean_isSet;
}

bool OAISkus_inner_2::is_ean_Valid() const{
    return m_ean_isValid;
}

QString OAISkus_inner_2::getExternalId() const {
    return m_external_id;
}
void OAISkus_inner_2::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAISkus_inner_2::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAISkus_inner_2::is_external_id_Valid() const{
    return m_external_id_isValid;
}

QString OAISkus_inner_2::getId() const {
    return m_id;
}
void OAISkus_inner_2::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISkus_inner_2::is_id_Set() const{
    return m_id_isSet;
}

bool OAISkus_inner_2::is_id_Valid() const{
    return m_id_isValid;
}

QList<QJsonValue> OAISkus_inner_2::getImages() const {
    return m_images;
}
void OAISkus_inner_2::setImages(const QList<QJsonValue> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAISkus_inner_2::is_images_Set() const{
    return m_images_isSet;
}

bool OAISkus_inner_2::is_images_Valid() const{
    return m_images_isValid;
}

bool OAISkus_inner_2::isIsActive() const {
    return m_is_active;
}
void OAISkus_inner_2::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAISkus_inner_2::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAISkus_inner_2::is_is_active_Valid() const{
    return m_is_active_isValid;
}

QString OAISkus_inner_2::getManufacturerCode() const {
    return m_manufacturer_code;
}
void OAISkus_inner_2::setManufacturerCode(const QString &manufacturer_code) {
    m_manufacturer_code = manufacturer_code;
    m_manufacturer_code_isSet = true;
}

bool OAISkus_inner_2::is_manufacturer_code_Set() const{
    return m_manufacturer_code_isSet;
}

bool OAISkus_inner_2::is_manufacturer_code_Valid() const{
    return m_manufacturer_code_isValid;
}

QList<OAISpecs_inner> OAISkus_inner_2::getSpecs() const {
    return m_specs;
}
void OAISkus_inner_2::setSpecs(const QList<OAISpecs_inner> &specs) {
    m_specs = specs;
    m_specs_isSet = true;
}

bool OAISkus_inner_2::is_specs_Set() const{
    return m_specs_isSet;
}

bool OAISkus_inner_2::is_specs_Valid() const{
    return m_specs_isValid;
}

qint32 OAISkus_inner_2::getWeight() const {
    return m_weight;
}
void OAISkus_inner_2::setWeight(const qint32 &weight) {
    m_weight = weight;
    m_weight_isSet = true;
}

bool OAISkus_inner_2::is_weight_Set() const{
    return m_weight_isSet;
}

bool OAISkus_inner_2::is_weight_Valid() const{
    return m_weight_isValid;
}

bool OAISkus_inner_2::isSet() const {
...
bool OAISkus_inner_2::isValid() const {
