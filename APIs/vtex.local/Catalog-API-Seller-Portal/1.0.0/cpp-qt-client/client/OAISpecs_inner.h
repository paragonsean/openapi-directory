...
#ifndef OAISpecs_inner_H
#define OAISpecs_inner_H
...
class OAISpecs_inner : public OAIObject {
public:
    OAISpecs_inner();
    OAISpecs_inner(QString json);
    ~OAISpecs_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISpecs_inner)

#endif // OAISpecs_inner_H
