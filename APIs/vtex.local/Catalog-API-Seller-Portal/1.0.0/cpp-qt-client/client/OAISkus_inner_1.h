...
#ifndef OAISkus_inner_1_H
#define OAISkus_inner_1_H
...
class OAISkus_inner_1 : public OAIObject {
public:
    OAISkus_inner_1();
    OAISkus_inner_1(QString json);
    ~OAISkus_inner_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISkus_inner_1)

#endif // OAISkus_inner_1_H
