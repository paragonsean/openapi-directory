...
/*
 * OAIPutProduct_request.h
 *
 * 
 */

#ifndef OAIPutProduct_request_H
#define OAIPutProduct_request_H

#include <QJsonObject>

#include "OAIAttributes_inner.h"
#include "OAIImages_inner.h"
#include "OAISkus_inner_3.h"
...
class OAISkus_inner_3;
class OAISpecs_inner_1;

class OAIPutProduct_request : public OAIObject {
public:
    OAIPutProduct_request();
    OAIPutProduct_request(QString json);
    ~OAIPutProduct_request() override;
    ...
    QList<OAISkus_inner_3> getSkus() const;
    void setSkus(const QList<OAISkus_inner_3> &skus);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutProduct_request)

#endif // OAIPutProduct_request_H
