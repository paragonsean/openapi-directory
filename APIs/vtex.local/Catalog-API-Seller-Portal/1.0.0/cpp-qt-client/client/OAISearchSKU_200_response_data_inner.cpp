...
OAISearchSKU_200_response_data_inner::OAISearchSKU_200_response_data_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchSKU_200_response_data_inner::OAISearchSKU_200_response_data_inner() {
    this->initializeModel();
}

OAISearchSKU_200_response_data_inner::~OAISearchSKU_200_response_data_inner() {}

void OAISearchSKU_200_response_data_inner::initializeModel() {
...
void OAISearchSKU_200_response_data_inner::fromJson(QString jsonString) {
...
void OAISearchSKU_200_response_data_inner::fromJsonObject(QJsonObject json) {
...
QString OAISearchSKU_200_response_data_inner::asJson() const {
...
QJsonObject OAISearchSKU_200_response_data_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAISearchSKU_200_response_data_inner::getExternalId() const {
    return m_external_id;
}
void OAISearchSKU_200_response_data_inner::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAISearchSKU_200_response_data_inner::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAISearchSKU_200_response_data_inner::is_external_id_Valid() const{
    return m_external_id_isValid;
}

QString OAISearchSKU_200_response_data_inner::getId() const {
    return m_id;
}
void OAISearchSKU_200_response_data_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISearchSKU_200_response_data_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAISearchSKU_200_response_data_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISearchSKU_200_response_data_inner::getProductId() const {
    return m_product_id;
}
void OAISearchSKU_200_response_data_inner::setProductId(const QString &product_id) {
    m_product_id = product_id;
    m_product_id_isSet = true;
}

bool OAISearchSKU_200_response_data_inner::is_product_id_Set() const{
    return m_product_id_isSet;
}

bool OAISearchSKU_200_response_data_inner::is_product_id_Valid() const{
    return m_product_id_isValid;
}

bool OAISearchSKU_200_response_data_inner::isSet() const {
...
bool OAISearchSKU_200_response_data_inner::isValid() const {
