...
OAIPostProduct_request::OAIPostProduct_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostProduct_request::OAIPostProduct_request() {
    this->initializeModel();
}

OAIPostProduct_request::~OAIPostProduct_request() {}

void OAIPostProduct_request::initializeModel() {
...
void OAIPostProduct_request::fromJson(QString jsonString) {
...
void OAIPostProduct_request::fromJsonObject(QJsonObject json) {
...
QString OAIPostProduct_request::asJson() const {
...
QJsonObject OAIPostProduct_request::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIAttributes_inner> OAIPostProduct_request::getAttributes() const {
    return m_attributes;
}
void OAIPostProduct_request::setAttributes(const QList<OAIAttributes_inner> &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIPostProduct_request::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIPostProduct_request::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIPostProduct_request::getBrandId() const {
    return m_brand_id;
}
void OAIPostProduct_request::setBrandId(const QString &brand_id) {
    m_brand_id = brand_id;
    m_brand_id_isSet = true;
}

bool OAIPostProduct_request::is_brand_id_Set() const{
    return m_brand_id_isSet;
}

bool OAIPostProduct_request::is_brand_id_Valid() const{
    return m_brand_id_isValid;
}

QList<QString> OAIPostProduct_request::getCategoryIds() const {
    return m_category_ids;
}
void OAIPostProduct_request::setCategoryIds(const QList<QString> &category_ids) {
    m_category_ids = category_ids;
    m_category_ids_isSet = true;
}

bool OAIPostProduct_request::is_category_ids_Set() const{
    return m_category_ids_isSet;
}

bool OAIPostProduct_request::is_category_ids_Valid() const{
    return m_category_ids_isValid;
}

QString OAIPostProduct_request::getDescription() const {
    return m_description;
}
void OAIPostProduct_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPostProduct_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPostProduct_request::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIPostProduct_request::getExternalId() const {
    return m_external_id;
}
void OAIPostProduct_request::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAIPostProduct_request::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAIPostProduct_request::is_external_id_Valid() const{
    return m_external_id_isValid;
}

QList<OAIImages_inner> OAIPostProduct_request::getImages() const {
    return m_images;
}
void OAIPostProduct_request::setImages(const QList<OAIImages_inner> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAIPostProduct_request::is_images_Set() const{
    return m_images_isSet;
}

bool OAIPostProduct_request::is_images_Valid() const{
    return m_images_isValid;
}

QString OAIPostProduct_request::getName() const {
    return m_name;
}
void OAIPostProduct_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPostProduct_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPostProduct_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPostProduct_request::getOrigin() const {
    return m_origin;
}
void OAIPostProduct_request::setOrigin(const QString &origin) {
    m_origin = origin;
    m_origin_isSet = true;
}

bool OAIPostProduct_request::is_origin_Set() const{
    return m_origin_isSet;
}

bool OAIPostProduct_request::is_origin_Valid() const{
    return m_origin_isValid;
}

QList<OAISkus_inner> OAIPostProduct_request::getSkus() const {
    return m_skus;
}
void OAIPostProduct_request::setSkus(const QList<OAISkus_inner> &skus) {
    m_skus = skus;
    m_skus_isSet = true;
}

bool OAIPostProduct_request::is_skus_Set() const{
    return m_skus_isSet;
}

bool OAIPostProduct_request::is_skus_Valid() const{
    return m_skus_isValid;
}

QString OAIPostProduct_request::getSlug() const {
    return m_slug;
}
void OAIPostProduct_request::setSlug(const QString &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAIPostProduct_request::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAIPostProduct_request::is_slug_Valid() const{
    return m_slug_isValid;
}

QList<OAISpecs_inner_1> OAIPostProduct_request::getSpecs() const {
    return m_specs;
}
void OAIPostProduct_request::setSpecs(const QList<OAISpecs_inner_1> &specs) {
    m_specs = specs;
    m_specs_isSet = true;
}

bool OAIPostProduct_request::is_specs_Set() const{
    return m_specs_isSet;
}

bool OAIPostProduct_request::is_specs_Valid() const{
    return m_specs_isValid;
}

QString OAIPostProduct_request::getStatus() const {
    return m_status;
}
void OAIPostProduct_request::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPostProduct_request::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPostProduct_request::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIPostProduct_request::getTaxCode() const {
    return m_tax_code;
}
void OAIPostProduct_request::setTaxCode(const QString &tax_code) {
    m_tax_code = tax_code;
    m_tax_code_isSet = true;
}

bool OAIPostProduct_request::is_tax_code_Set() const{
    return m_tax_code_isSet;
}

bool OAIPostProduct_request::is_tax_code_Valid() const{
    return m_tax_code_isValid;
}

QString OAIPostProduct_request::getTransportModal() const {
    return m_transport_modal;
}
void OAIPostProduct_request::setTransportModal(const QString &transport_modal) {
    m_transport_modal = transport_modal;
    m_transport_modal_isSet = true;
}

bool OAIPostProduct_request::is_transport_modal_Set() const{
    return m_transport_modal_isSet;
}

bool OAIPostProduct_request::is_transport_modal_Valid() const{
    return m_transport_modal_isValid;
}

bool OAIPostProduct_request::isSet() const {
...
bool OAIPostProduct_request::isValid() const {
