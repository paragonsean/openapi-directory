...
OAISKUApi::OAISKUApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
void OAISKUApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("listSKU", defaultConf);
    _serverIndices.insert("listSKU", 0);
    _serverConfigs.insert("searchSKU", defaultConf);
    _serverIndices.insert("searchSKU", 0);
}
...
*/
int OAISKUApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAISKUApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAISKUApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAISKUApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAISKUApi::setUsername(const QString &username) {
    _username = username;
}

void OAISKUApi::setPassword(const QString &password) {
    _password = password;
}


void OAISKUApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAISKUApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAISKUApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAISKUApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAISKUApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAISKUApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAISKUApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAISKUApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAISKUApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAISKUApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAISKUApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAISKUApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAISKUApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAISKUApi::listSKU(const QString &content_type, const QString &accept, const ::OpenAPI::OptionalParam<QString> &from, const ::OpenAPI::OptionalParam<QString> &to) {
    QString fullPath = QString(_serverConfigs["listSKU"][_serverIndices.value("listSKU")].URL()+"/api/catalog-seller-portal/skus/ids");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISKUApi::listSKUCallback);
    connect(this, &OAISKUApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAISKUApi::listSKUCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIListSKU_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listSKUSignal(output);
        Q_EMIT listSKUSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listSKUSignalE(output, error_type, error_str);
        Q_EMIT listSKUSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listSKUSignalError(output, error_type, error_str);
        Q_EMIT listSKUSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISKUApi::searchSKU(const QString &content_type, const QString &accept, const ::OpenAPI::OptionalParam<QString> &from, const ::OpenAPI::OptionalParam<QString> &to, const ::OpenAPI::OptionalParam<qint32> &id, const ::OpenAPI::OptionalParam<qint32> &externalid) {
    QString fullPath = QString(_serverConfigs["searchSKU"][_serverIndices.value("searchSKU")].URL()+"/api/catalog-seller-portal/skus/_search");
    ...
    if (externalid.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("externalid")).append(querySuffix).append(QUrl::toPercentEncoding(externalid.stringValue()));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISKUApi::searchSKUCallback);
    connect(this, &OAISKUApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISKUApi::searchSKUCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAISearchSKU_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchSKUSignal(output);
        Q_EMIT searchSKUSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchSKUSignalE(output, error_type, error_str);
        Q_EMIT searchSKUSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchSKUSignalError(output, error_type, error_str);
        Q_EMIT searchSKUSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISKUApi::tokenAvailable(){
