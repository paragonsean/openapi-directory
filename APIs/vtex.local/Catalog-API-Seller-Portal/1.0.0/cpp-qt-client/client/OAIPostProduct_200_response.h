...
/*
 * OAIPostProduct_200_response.h
 *
 * 
 */

#ifndef OAIPostProduct_200_response_H
#define OAIPostProduct_200_response_H
...
class OAISkus_inner_1;
class OAISpecs_inner_1;

class OAIPostProduct_200_response : public OAIObject {
public:
    OAIPostProduct_200_response();
    OAIPostProduct_200_response(QString json);
    ~OAIPostProduct_200_response() override;
    ...
    QList<OAISkus_inner_1> getSkus() const;
    void setSkus(const QList<OAISkus_inner_1> &skus);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostProduct_200_response)

#endif // OAIPostProduct_200_response_H
