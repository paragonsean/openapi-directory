...
OAIValue_1::OAIValue_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIValue_1::OAIValue_1() {
    this->initializeModel();
}

OAIValue_1::~OAIValue_1() {}

void OAIValue_1::initializeModel() {
...
void OAIValue_1::fromJson(QString jsonString) {
...
void OAIValue_1::fromJsonObject(QJsonObject json) {
...
QString OAIValue_1::asJson() const {
...
QJsonObject OAIValue_1::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIValue_1::getId() const {
    return m_id;
}
void OAIValue_1::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIValue_1::is_id_Set() const{
    return m_id_isSet;
}

bool OAIValue_1::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIValue_1::isIsActive() const {
    return m_is_active;
}
void OAIValue_1::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAIValue_1::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIValue_1::is_is_active_Valid() const{
    return m_is_active_isValid;
}

QString OAIValue_1::getName() const {
    return m_name;
}
void OAIValue_1::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIValue_1::is_name_Set() const{
    return m_name_isSet;
}

bool OAIValue_1::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIValue_1::isSet() const {
