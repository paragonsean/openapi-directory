...
/*
 * OAIPutProductDescription_request.h
 *
 * 
 */

#ifndef OAIPutProductDescription_request_H
#define OAIPutProductDescription_request_H
...
class OAIPutProductDescription_request : public OAIObject {
public:
    OAIPutProductDescription_request();
    OAIPutProductDescription_request(QString json);
    ~OAIPutProductDescription_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutProductDescription_request)

#endif // OAIPutProductDescription_request_H
