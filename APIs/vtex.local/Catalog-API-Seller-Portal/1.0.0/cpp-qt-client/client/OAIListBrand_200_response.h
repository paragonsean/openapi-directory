...
/*
 * OAIListBrand_200_response.h
 *
 * 
 */

#ifndef OAIListBrand_200_response_H
#define OAIListBrand_200_response_H

#include <QJsonObject>

#include "OAIData_inner.h"
#include "OAI_metadata.h"
#include <QList>
...
class OAIListBrand_200_response : public OAIObject {
public:
    OAIListBrand_200_response();
    OAIListBrand_200_response(QString json);
    ~OAIListBrand_200_response() override;
    ...
    OAI_metadata getMetadata() const;
    void setMetadata(const OAI_metadata &_metadata);
    bool is__metadata_Set() const;
    bool is__metadata_Valid() const;

    QList<OAIData_inner> getData() const;
    void setData(const QList<OAIData_inner> &data);
...
private:
    ...
    OAI_metadata m__metadata;
    bool m__metadata_isSet;
    bool m__metadata_isValid;

    QList<OAIData_inner> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIListBrand_200_response)

#endif // OAIListBrand_200_response_H
