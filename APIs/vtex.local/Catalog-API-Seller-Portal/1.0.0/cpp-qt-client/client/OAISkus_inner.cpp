...
OAISkus_inner::OAISkus_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISkus_inner::OAISkus_inner() {
    this->initializeModel();
}

OAISkus_inner::~OAISkus_inner() {}

void OAISkus_inner::initializeModel() {
...
void OAISkus_inner::fromJson(QString jsonString) {
...
void OAISkus_inner::fromJsonObject(QJsonObject json) {
...
QString OAISkus_inner::asJson() const {
...
QJsonObject OAISkus_inner::asJsonObject() const {
    QJsonObject obj;
...
OAIDimensions OAISkus_inner::getDimensions() const {
    return m_dimensions;
}
void OAISkus_inner::setDimensions(const OAIDimensions &dimensions) {
    m_dimensions = dimensions;
    m_dimensions_isSet = true;
}

bool OAISkus_inner::is_dimensions_Set() const{
    return m_dimensions_isSet;
}

bool OAISkus_inner::is_dimensions_Valid() const{
    return m_dimensions_isValid;
}

QString OAISkus_inner::getEan() const {
    return m_ean;
}
void OAISkus_inner::setEan(const QString &ean) {
    m_ean = ean;
    m_ean_isSet = true;
}

bool OAISkus_inner::is_ean_Set() const{
    return m_ean_isSet;
}

bool OAISkus_inner::is_ean_Valid() const{
    return m_ean_isValid;
}

QString OAISkus_inner::getExternalId() const {
    return m_external_id;
}
void OAISkus_inner::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAISkus_inner::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAISkus_inner::is_external_id_Valid() const{
    return m_external_id_isValid;
}

QList<QJsonValue> OAISkus_inner::getImages() const {
    return m_images;
}
void OAISkus_inner::setImages(const QList<QJsonValue> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAISkus_inner::is_images_Set() const{
    return m_images_isSet;
}

bool OAISkus_inner::is_images_Valid() const{
    return m_images_isValid;
}

bool OAISkus_inner::isIsActive() const {
    return m_is_active;
}
void OAISkus_inner::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAISkus_inner::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAISkus_inner::is_is_active_Valid() const{
    return m_is_active_isValid;
}

QString OAISkus_inner::getManufacturerCode() const {
    return m_manufacturer_code;
}
void OAISkus_inner::setManufacturerCode(const QString &manufacturer_code) {
    m_manufacturer_code = manufacturer_code;
    m_manufacturer_code_isSet = true;
}

bool OAISkus_inner::is_manufacturer_code_Set() const{
    return m_manufacturer_code_isSet;
}

bool OAISkus_inner::is_manufacturer_code_Valid() const{
    return m_manufacturer_code_isValid;
}

QString OAISkus_inner::getName() const {
    return m_name;
}
void OAISkus_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISkus_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAISkus_inner::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAISpecs_inner> OAISkus_inner::getSpecs() const {
    return m_specs;
}
void OAISkus_inner::setSpecs(const QList<OAISpecs_inner> &specs) {
    m_specs = specs;
    m_specs_isSet = true;
}

bool OAISkus_inner::is_specs_Set() const{
    return m_specs_isSet;
}

bool OAISkus_inner::is_specs_Valid() const{
    return m_specs_isValid;
}

qint32 OAISkus_inner::getWeight() const {
    return m_weight;
}
void OAISkus_inner::setWeight(const qint32 &weight) {
    m_weight = weight;
    m_weight_isSet = true;
}

bool OAISkus_inner::is_weight_Set() const{
    return m_weight_isSet;
}

bool OAISkus_inner::is_weight_Valid() const{
    return m_weight_isValid;
}

bool OAISkus_inner::isSet() const {
...
bool OAISkus_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_dimensions_isValid && m_images_isValid && m_is_active_isValid && m_name_isValid && m_specs_isValid && m_weight_isValid && true;
}
