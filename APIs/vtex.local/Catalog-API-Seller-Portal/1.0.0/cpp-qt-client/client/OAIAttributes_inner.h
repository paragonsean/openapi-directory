...
/*
 * OAIAttributes_inner.h
 *
 * 
 */

#ifndef OAIAttributes_inner_H
#define OAIAttributes_inner_H
...
class OAIAttributes_inner : public OAIObject {
public:
    OAIAttributes_inner();
    OAIAttributes_inner(QString json);
    ~OAIAttributes_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttributes_inner)

#endif // OAIAttributes_inner_H
