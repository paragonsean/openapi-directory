...
OAIPostBrand_request::OAIPostBrand_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostBrand_request::OAIPostBrand_request() {
    this->initializeModel();
}

OAIPostBrand_request::~OAIPostBrand_request() {}

void OAIPostBrand_request::initializeModel() {
...
void OAIPostBrand_request::fromJson(QString jsonString) {
...
void OAIPostBrand_request::fromJsonObject(QJsonObject json) {
...
QString OAIPostBrand_request::asJson() const {
...
QJsonObject OAIPostBrand_request::asJsonObject() const {
    QJsonObject obj;
...
bool OAIPostBrand_request::isIsActive() const {
    return m_is_active;
}
void OAIPostBrand_request::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAIPostBrand_request::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIPostBrand_request::is_is_active_Valid() const{
    return m_is_active_isValid;
}

QString OAIPostBrand_request::getName() const {
    return m_name;
}
void OAIPostBrand_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPostBrand_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPostBrand_request::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIPostBrand_request::isSet() const {
...
bool OAIPostBrand_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_is_active_isValid && m_name_isValid && true;
}
