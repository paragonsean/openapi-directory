...
#ifndef OAIData_inner_H
#define OAIData_inner_H
...
class OAIData_inner : public OAIObject {
public:
    OAIData_inner();
    OAIData_inner(QString json);
    ~OAIData_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIData_inner)

#endif // OAIData_inner_H
