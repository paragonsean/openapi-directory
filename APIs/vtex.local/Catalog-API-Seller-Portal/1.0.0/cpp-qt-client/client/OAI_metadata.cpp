...
OAI_metadata::OAI_metadata(QString json) {
...
void OAI_metadata::initializeModel() {
...
void OAI_metadata::fromJson(QString jsonString) {
...
void OAI_metadata::fromJsonObject(QJsonObject json) {
...
QString OAI_metadata::asJson() const {
...
QJsonObject OAI_metadata::asJsonObject() const {
    QJsonObject obj;
    if (m_from_isSet) {
...
qint32 OAI_metadata::getFrom() const {
    return m_from;
}
void OAI_metadata::setFrom(const qint32 &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAI_metadata::is_from_Set() const{
    return m_from_isSet;
}

bool OAI_metadata::is_from_Valid() const{
    return m_from_isValid;
}

QString OAI_metadata::getOrderBy() const {
    return m_order_by;
}
void OAI_metadata::setOrderBy(const QString &order_by) {
    m_order_by = order_by;
    m_order_by_isSet = true;
}

bool OAI_metadata::is_order_by_Set() const{
    return m_order_by_isSet;
}

bool OAI_metadata::is_order_by_Valid() const{
    return m_order_by_isValid;
}

qint32 OAI_metadata::getTo() const {
    return m_to;
}
void OAI_metadata::setTo(const qint32 &to) {
    m_to = to;
    m_to_isSet = true;
}

bool OAI_metadata::is_to_Set() const{
    return m_to_isSet;
}

bool OAI_metadata::is_to_Valid() const{
    return m_to_isValid;
}

qint32 OAI_metadata::getTotal() const {
    return m_total;
}
void OAI_metadata::setTotal(const qint32 &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAI_metadata::is_total_Set() const{
    return m_total_isSet;
}

bool OAI_metadata::is_total_Valid() const{
    return m_total_isValid;
}

bool OAI_metadata::isSet() const {
...
bool OAI_metadata::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_from_isValid && m_order_by_isValid && m_to_isValid && m_total_isValid && true;
}
