...
/*
 * OAIPutBrand_request.h
 *
 * 
 */

#ifndef OAIPutBrand_request_H
#define OAIPutBrand_request_H
...
class OAIPutBrand_request : public OAIObject {
public:
    OAIPutBrand_request();
    OAIPutBrand_request(QString json);
    ~OAIPutBrand_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutBrand_request)

#endif // OAIPutBrand_request_H
