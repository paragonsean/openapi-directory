...
/*
 * OAICondition_conditions_inner.h
 *
 * 
 */

#ifndef OAICondition_conditions_inner_H
#define OAICondition_conditions_inner_H
...
class OAICondition_conditions_inner : public OAIObject {
public:
    OAICondition_conditions_inner();
    OAICondition_conditions_inner(QString json);
    ~OAICondition_conditions_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICondition_conditions_inner)

#endif // OAICondition_conditions_inner_H
