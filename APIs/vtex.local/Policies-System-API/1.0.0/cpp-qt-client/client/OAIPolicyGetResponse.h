...
/*
 * OAIPolicyGetResponse.h
 *
 * 
 */

#ifndef OAIPolicyGetResponse_H
#define OAIPolicyGetResponse_H
...
class OAIPolicyGetResponse : public OAIObject {
public:
    OAIPolicyGetResponse();
    OAIPolicyGetResponse(QString json);
    ~OAIPolicyGetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyGetResponse)

#endif // OAIPolicyGetResponse_H
