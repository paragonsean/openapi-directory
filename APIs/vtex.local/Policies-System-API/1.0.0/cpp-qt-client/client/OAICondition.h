...
namespace OpenAPI {
class OAICondition_conditions_inner;
...
public:
    ...
    QList<OAICondition_conditions_inner> getConditions() const;
    void setConditions(const QList<OAICondition_conditions_inner> &conditions);
...
private:
    ...
    QList<OAICondition_conditions_inner> m_conditions;
