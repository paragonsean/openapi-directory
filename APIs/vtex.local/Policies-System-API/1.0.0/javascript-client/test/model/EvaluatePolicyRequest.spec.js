...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PoliciesSystemApi.EvaluatePolicyRequest();
  });
  ...
  describe('EvaluatePolicyRequest', function() {
    it('should create an instance of EvaluatePolicyRequest', function() {
      // uncomment below and update the code to test EvaluatePolicyRequest
      //var instance = new PoliciesSystemApi.EvaluatePolicyRequest();
      //expect(instance).to.be.a(PoliciesSystemApi.EvaluatePolicyRequest);
    });
