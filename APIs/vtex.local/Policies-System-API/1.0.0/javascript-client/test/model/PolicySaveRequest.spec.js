...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PoliciesSystemApi.PolicySaveRequest();
  });
  ...
  describe('PolicySaveRequest', function() {
    it('should create an instance of PolicySaveRequest', function() {
      // uncomment below and update the code to test PolicySaveRequest
      //var instance = new PoliciesSystemApi.PolicySaveRequest();
      //expect(instance).to.be.a(PoliciesSystemApi.PolicySaveRequest);
    });
