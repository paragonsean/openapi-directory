...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PoliciesSystemApi.ConditionConditionsInner();
  });
  ...
  describe('ConditionConditionsInner', function() {
    it('should create an instance of ConditionConditionsInner', function() {
      // uncomment below and update the code to test ConditionConditionsInner
      //var instance = new PoliciesSystemApi.ConditionConditionsInner();
      //expect(instance).to.be.a(PoliciesSystemApi.ConditionConditionsInner);
    });
