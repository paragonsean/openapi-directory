...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PoliciesSystemApi.StatementGetResponse();
  });
  ...
  describe('StatementGetResponse', function() {
    it('should create an instance of StatementGetResponse', function() {
      // uncomment below and update the code to test StatementGetResponse
      //var instance = new PoliciesSystemApi.StatementGetResponse();
      //expect(instance).to.be.a(PoliciesSystemApi.StatementGetResponse);
    });
