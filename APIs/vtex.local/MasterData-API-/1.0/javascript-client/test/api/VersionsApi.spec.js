...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterDataApiV1.VersionsApi();
  });
  ...
  describe('VersionsApi', function() {
    ...
    describe('putversion', function() {
      it('should call putversion successfully', function(done) {
        //uncomment below and update the code to test putversion
        //instance.putversion(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
