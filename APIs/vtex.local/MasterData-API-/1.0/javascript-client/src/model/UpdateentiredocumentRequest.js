...
/**
 * The UpdateentiredocumentRequest model module.
 * @module model/UpdateentiredocumentRequest
 * @version 1.0
 */
class UpdateentiredocumentRequest {
    /**
     * Constructs a new <code>UpdateentiredocumentRequest</code>.
     * @alias module:model/UpdateentiredocumentRequest
    ...
    constructor(_boolean, currency, date, dateTime, decimal, email, integer, _long, percent, relationship, text, time, URL, varchar10, varchar100, varchar50, varchar750) { 
        ...
        UpdateentiredocumentRequest.initialize(this, _boolean, currency, date, dateTime, decimal, email, integer, _long, percent, relationship, text, time, URL, varchar10, varchar100, varchar50, varchar750);
    }
    ...
    /**
     * Constructs a <code>UpdateentiredocumentRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateentiredocumentRequest} obj Optional instance to populate.
     * @return {module:model/UpdateentiredocumentRequest} The populated <code>UpdateentiredocumentRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateentiredocumentRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateentiredocumentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateentiredocumentRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateentiredocumentRequest.RequiredProperties) {
...
UpdateentiredocumentRequest.RequiredProperties = ["Boolean", "Currency", "Date", "Date_Time", "Decimal", "Email", "Integer", "Long", "Percent", "Relationship", "Text", "Time", "URL", "Varchar10", "Varchar100", "Varchar50", "Varchar750"];

/**
 * @member {Boolean} Boolean
 */
UpdateentiredocumentRequest.prototype['Boolean'] = undefined;

/**
 * @member {Number} Currency
 */
UpdateentiredocumentRequest.prototype['Currency'] = undefined;

/**
 * @member {String} Date
 */
UpdateentiredocumentRequest.prototype['Date'] = undefined;

/**
 * @member {String} Date_Time
 */
UpdateentiredocumentRequest.prototype['Date_Time'] = undefined;

/**
 * @member {Number} Decimal
 */
UpdateentiredocumentRequest.prototype['Decimal'] = undefined;

/**
 * @member {String} Email
 */
UpdateentiredocumentRequest.prototype['Email'] = undefined;

/**
 * @member {Number} Integer
 */
UpdateentiredocumentRequest.prototype['Integer'] = undefined;

/**
 * @member {Number} Long
 */
UpdateentiredocumentRequest.prototype['Long'] = undefined;

/**
 * @member {Number} Percent
 */
UpdateentiredocumentRequest.prototype['Percent'] = undefined;

/**
 * @member {String} Relationship
 */
UpdateentiredocumentRequest.prototype['Relationship'] = undefined;

/**
 * @member {String} Text
 */
UpdateentiredocumentRequest.prototype['Text'] = undefined;

/**
 * @member {String} Time
 */
UpdateentiredocumentRequest.prototype['Time'] = undefined;

/**
 * @member {String} URL
 */
UpdateentiredocumentRequest.prototype['URL'] = undefined;

/**
 * @member {String} Varchar10
 */
UpdateentiredocumentRequest.prototype['Varchar10'] = undefined;

/**
 * @member {String} Varchar100
 */
UpdateentiredocumentRequest.prototype['Varchar100'] = undefined;

/**
 * @member {String} Varchar50
 */
UpdateentiredocumentRequest.prototype['Varchar50'] = undefined;

/**
 * @member {String} Varchar750
 */
UpdateentiredocumentRequest.prototype['Varchar750'] = undefined;
...
export default UpdateentiredocumentRequest;
