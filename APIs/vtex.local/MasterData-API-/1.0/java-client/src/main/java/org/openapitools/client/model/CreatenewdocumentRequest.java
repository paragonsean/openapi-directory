...
public class CreatenewdocumentRequest {
  ...
  public CreatenewdocumentRequest _boolean(Boolean _boolean) {
  ...
  public CreatenewdocumentRequest currency(BigDecimal currency) {
  ...
  public CreatenewdocumentRequest date(String date) {
    this.date = date;
    return this;
  }
  ...
  public CreatenewdocumentRequest dateTime(String dateTime) {
  ...
  public CreatenewdocumentRequest decimal(BigDecimal decimal) {
  ...
  public CreatenewdocumentRequest email(String email) {
    this.email = email;
    return this;
  }
  ...
  public CreatenewdocumentRequest integer(Integer integer) {
  ...
  public CreatenewdocumentRequest _long(Integer _long) {
    this._long = _long;
    return this;
  }
  ...
  public CreatenewdocumentRequest percent(BigDecimal percent) {
  ...
  public CreatenewdocumentRequest relationship(String relationship) {
  ...
  public CreatenewdocumentRequest text(String text) {
    this.text = text;
    return this;
  }
  ...
  public CreatenewdocumentRequest time(String time) {
    this.time = time;
    return this;
  }
  ...
  public CreatenewdocumentRequest URL(String URL) {
    this.URL = URL;
    return this;
  }
  ...
  public CreatenewdocumentRequest varchar10(String varchar10) {
  ...
  public CreatenewdocumentRequest varchar100(String varchar100) {
  ...
  public CreatenewdocumentRequest varchar50(String varchar50) {
  ...
  public CreatenewdocumentRequest varchar750(String varchar750) {
  ...
  public boolean equals(Object o) {
    ...
    CreatenewdocumentRequest createnewdocumentRequest = (CreatenewdocumentRequest) o;
    return Objects.equals(this._boolean, createnewdocumentRequest._boolean) &&
        Objects.equals(this.currency, createnewdocumentRequest.currency) &&
        Objects.equals(this.date, createnewdocumentRequest.date) &&
        Objects.equals(this.dateTime, createnewdocumentRequest.dateTime) &&
        Objects.equals(this.decimal, createnewdocumentRequest.decimal) &&
        Objects.equals(this.email, createnewdocumentRequest.email) &&
        Objects.equals(this.integer, createnewdocumentRequest.integer) &&
        Objects.equals(this._long, createnewdocumentRequest._long) &&
        Objects.equals(this.percent, createnewdocumentRequest.percent) &&
        Objects.equals(this.relationship, createnewdocumentRequest.relationship) &&
        Objects.equals(this.text, createnewdocumentRequest.text) &&
        Objects.equals(this.time, createnewdocumentRequest.time) &&
        Objects.equals(this.URL, createnewdocumentRequest.URL) &&
        Objects.equals(this.varchar10, createnewdocumentRequest.varchar10) &&
        Objects.equals(this.varchar100, createnewdocumentRequest.varchar100) &&
        Objects.equals(this.varchar50, createnewdocumentRequest.varchar50) &&
        Objects.equals(this.varchar750, createnewdocumentRequest.varchar750);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatenewdocumentRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatenewdocumentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatenewdocumentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatenewdocumentRequest is not found in the empty JSON string", CreatenewdocumentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatenewdocumentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatenewdocumentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatenewdocumentRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatenewdocumentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatenewdocumentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatenewdocumentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatenewdocumentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatenewdocumentRequest>() {
           @Override
           public void write(JsonWriter out, CreatenewdocumentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatenewdocumentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatenewdocumentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatenewdocumentRequest
   * @throws IOException if the JSON string is invalid with respect to CreatenewdocumentRequest
   */
  public static CreatenewdocumentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatenewdocumentRequest.class);
  }

  /**
   * Convert an instance of CreatenewdocumentRequest to an JSON string
   *
   * @return JSON string
   */
