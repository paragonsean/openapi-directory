...
void OAISearchApi::searchdocuments(const QString &content_type, const QString &accept, const QString &rest_range, const QString &acronym, const ::OpenAPI::OptionalParam<QString> &_fields, const ::OpenAPI::OptionalParam<QString> &_where, const ::OpenAPI::OptionalParam<QString> &_schema, const ::OpenAPI::OptionalParam<QString> &_keyword, const ::OpenAPI::OptionalParam<QString> &_sort) {
    QString fullPath = QString(_serverConfigs["searchdocuments"][_serverIndices.value("searchdocuments")].URL()+"/api/dataentities/{acronym}/search");
