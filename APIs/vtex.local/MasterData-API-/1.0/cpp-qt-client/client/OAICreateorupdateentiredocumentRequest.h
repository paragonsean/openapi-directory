...
/*
 * OAICreateorupdateentiredocumentRequest.h
 *
 * 
 */

#ifndef OAICreateorupdateentiredocumentRequest_H
#define OAICreateorupdateentiredocumentRequest_H
...
class OAICreateorupdateentiredocumentRequest : public OAIObject {
public:
    OAICreateorupdateentiredocumentRequest();
    OAICreateorupdateentiredocumentRequest(QString json);
    ~OAICreateorupdateentiredocumentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateorupdateentiredocumentRequest)

#endif // OAICreateorupdateentiredocumentRequest_H
