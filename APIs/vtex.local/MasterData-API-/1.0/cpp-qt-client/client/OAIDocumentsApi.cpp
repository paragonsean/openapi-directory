...
void OAIDocumentsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("createorupdateentiredocument", defaultConf);
    _serverIndices.insert("createorupdateentiredocument", 0);
...
void OAIDocumentsApi::createnewdocument(const QString &accept, const QString &acronym, const OAIObject &body) {
    QString fullPath = QString(_serverConfigs["createnewdocument"][_serverIndices.value("createnewdocument")].URL()+"/api/dataentities/{acronym}/documents");
...
void OAIDocumentsApi::createnewdocumentCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICreatenewdocument output(QString(worker->response));
    worker->deleteLater();
...
void OAIDocumentsApi::createorupdateentiredocument(const QString &accept, const QString &acronym, const OAIObject &body) {
    QString fullPath = QString(_serverConfigs["createorupdateentiredocument"][_serverIndices.value("createorupdateentiredocument")].URL()+"/api/dataentities/{acronym}/documents");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDocumentsApi::createorupdateentiredocumentCallback);
    connect(this, &OAIDocumentsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDocumentsApi::createorupdateentiredocumentCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createorupdateentiredocumentSignal();
        Q_EMIT createorupdateentiredocumentSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createorupdateentiredocumentSignalE(error_type, error_str);
        Q_EMIT createorupdateentiredocumentSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createorupdateentiredocumentSignalError(error_type, error_str);
        Q_EMIT createorupdateentiredocumentSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDocumentsApi::createorupdatepartialdocument(const QString &accept, const QString &acronym, const OAIObject &body) {
    QString fullPath = QString(_serverConfigs["createorupdatepartialdocument"][_serverIndices.value("createorupdatepartialdocument")].URL()+"/api/dataentities/{acronym}/documents");
...
void OAIDocumentsApi::createorupdatepartialdocumentCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createorupdatepartialdocumentSignal();
        Q_EMIT createorupdatepartialdocumentSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createorupdatepartialdocumentSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createorupdatepartialdocumentSignalError(error_type, error_str);
        Q_EMIT createorupdatepartialdocumentSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDocumentsApi::deletedocument(const QString &content_type, const QString &accept, const QString &acronym, const QString &id) {
    QString fullPath = QString(_serverConfigs["deletedocument"][_serverIndices.value("deletedocument")].URL()+"/api/dataentities/{acronym}/documents/{id}");
...
void OAIDocumentsApi::getdocument(const QString &content_type, const QString &accept, const QString &acronym, const QString &id) {
    QString fullPath = QString(_serverConfigs["getdocument"][_serverIndices.value("getdocument")].URL()+"/api/dataentities/{acronym}/documents/{id}");
...
void OAIDocumentsApi::getdocumentCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIUsingfilters output(QString(worker->response));
    worker->deleteLater();
...
void OAIDocumentsApi::updateentiredocument(const QString &accept, const QString &acronym, const QString &id, const OAIObject &body) {
    QString fullPath = QString(_serverConfigs["updateentiredocument"][_serverIndices.value("updateentiredocument")].URL()+"/api/dataentities/{acronym}/documents/{id}");
...
void OAIDocumentsApi::updateentiredocumentCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateentiredocumentSignal();
        Q_EMIT updateentiredocumentSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateentiredocumentSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateentiredocumentSignalError(error_type, error_str);
        Q_EMIT updateentiredocumentSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDocumentsApi::updatepartialdocument(const QString &accept, const QString &acronym, const QString &id, const OAIObject &body) {
    QString fullPath = QString(_serverConfigs["updatepartialdocument"][_serverIndices.value("updatepartialdocument")].URL()+"/api/dataentities/{acronym}/documents/{id}");
...
void OAIDocumentsApi::updatepartialdocumentCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updatepartialdocumentSignal();
        Q_EMIT updatepartialdocumentSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updatepartialdocumentSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updatepartialdocumentSignalError(error_type, error_str);
