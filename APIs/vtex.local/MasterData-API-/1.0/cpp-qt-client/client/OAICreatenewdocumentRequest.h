...
/*
 * OAICreatenewdocumentRequest.h
 *
 * 
 */

#ifndef OAICreatenewdocumentRequest_H
#define OAICreatenewdocumentRequest_H
...
class OAICreatenewdocumentRequest : public OAIObject {
public:
    OAICreatenewdocumentRequest();
    OAICreatenewdocumentRequest(QString json);
    ~OAICreatenewdocumentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatenewdocumentRequest)

#endif // OAICreatenewdocumentRequest_H
