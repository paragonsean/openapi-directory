...
public class CreateUser400Response {
  ...
  public CreateUser400Response message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUser400Response createUser400Response = (CreateUser400Response) o;
    return Objects.equals(this.message, createUser400Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUser400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUser400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUser400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUser400Response is not found in the empty JSON string", CreateUser400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUser400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUser400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CreateUser400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUser400Response.class));
