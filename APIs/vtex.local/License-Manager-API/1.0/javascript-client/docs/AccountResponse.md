# LicenseManagerApi.AccountResponse
...
**appKeys** | [**[AppKeyItems]**](AppKeyItems.md) | Array of application keys | [optional] 
...
**creationDate** | **Date** | The date when the account was created | [optional] 
...
**hosts** | **[String]** | Hosts of all stores | [optional] 
**id** | **String** | ID of the account | [optional] 
**inactivationDate** | **Date** | The date when the account was deactivated | [optional] 
**isActive** | **Boolean** | If account is active or not | [optional] 
**isOperating** | **Boolean** | If it is in production | [optional] 
**licenses** | [**[LicenseItems]**](LicenseItems.md) | Licenses of the account | [optional] 
...
**operationDate** | **Date** | The date when the account went into production | [optional] 
...
**sites** | [**[SiteItems]**](SiteItems.md) | Array of objects representing a store | [optional] 
