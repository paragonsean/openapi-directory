...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LicenseManagerApi.AccountResponseContact();
  });
  ...
  describe('AccountResponseContact', function() {
    it('should create an instance of AccountResponseContact', function() {
      // uncomment below and update the code to test AccountResponseContact
      //var instance = new LicenseManagerApi.AccountResponseContact();
      //expect(instance).to.be.a(LicenseManagerApi.AccountResponseContact);
    });
