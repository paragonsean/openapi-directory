...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LicenseManagerApi.LicenseItemsProductsInner();
  });
  ...
  describe('LicenseItemsProductsInner', function() {
    it('should create an instance of LicenseItemsProductsInner', function() {
      // uncomment below and update the code to test LicenseItemsProductsInner
      //var instance = new LicenseManagerApi.LicenseItemsProductsInner();
      //expect(instance).to.be.a(LicenseManagerApi.LicenseItemsProductsInner);
    });
