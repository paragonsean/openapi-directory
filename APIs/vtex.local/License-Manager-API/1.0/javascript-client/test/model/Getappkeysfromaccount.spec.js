...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LicenseManagerApi.Getappkeysfromaccount();
  });
  ...
  describe('Getappkeysfromaccount', function() {
    it('should create an instance of Getappkeysfromaccount', function() {
      // uncomment below and update the code to test Getappkeysfromaccount
      //var instance = new LicenseManagerApi.Getappkeysfromaccount();
      //expect(instance).to.be.a(LicenseManagerApi.Getappkeysfromaccount);
    });
