...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LicenseManagerApi.CreatenewappkeyRequest();
  });
  ...
  describe('CreatenewappkeyRequest', function() {
    it('should create an instance of CreatenewappkeyRequest', function() {
      // uncomment below and update the code to test CreatenewappkeyRequest
      //var instance = new LicenseManagerApi.CreatenewappkeyRequest();
      //expect(instance).to.be.a(LicenseManagerApi.CreatenewappkeyRequest);
    });
