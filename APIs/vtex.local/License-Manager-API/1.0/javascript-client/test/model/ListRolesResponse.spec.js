...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LicenseManagerApi.ListRolesResponse();
  });
  ...
  describe('ListRolesResponse', function() {
    it('should create an instance of ListRolesResponse', function() {
      // uncomment below and update the code to test ListRolesResponse
      //var instance = new LicenseManagerApi.ListRolesResponse();
      //expect(instance).to.be.a(LicenseManagerApi.ListRolesResponse);
    });
