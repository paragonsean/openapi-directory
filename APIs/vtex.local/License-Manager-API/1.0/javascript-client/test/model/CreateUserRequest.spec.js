...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LicenseManagerApi.CreateUserRequest();
  });
  ...
  describe('CreateUserRequest', function() {
    it('should create an instance of CreateUserRequest', function() {
      ...
      //var instance = new LicenseManagerApi.CreateUserRequest();
      //expect(instance).to.be.a(LicenseManagerApi.CreateUserRequest);
    });
