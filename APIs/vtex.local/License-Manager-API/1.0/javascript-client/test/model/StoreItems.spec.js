...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LicenseManagerApi.StoreItems();
  });
  ...
  describe('StoreItems', function() {
    it('should create an instance of StoreItems', function() {
      // uncomment below and update the code to test StoreItems
      //var instance = new LicenseManagerApi.StoreItems();
      //expect(instance).to.be.a(LicenseManagerApi.StoreItems);
    });
