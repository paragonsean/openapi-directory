...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LicenseManagerApi.AccountResponseSponsor();
  });
  ...
  describe('AccountResponseSponsor', function() {
    it('should create an instance of AccountResponseSponsor', function() {
      // uncomment below and update the code to test AccountResponseSponsor
      //var instance = new LicenseManagerApi.AccountResponseSponsor();
      //expect(instance).to.be.a(LicenseManagerApi.AccountResponseSponsor);
    });
