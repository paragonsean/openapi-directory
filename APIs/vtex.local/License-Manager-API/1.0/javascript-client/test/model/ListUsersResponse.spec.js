...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LicenseManagerApi.ListUsersResponse();
  });
  ...
  describe('ListUsersResponse', function() {
    it('should create an instance of ListUsersResponse', function() {
      ...
      //var instance = new LicenseManagerApi.ListUsersResponse();
      //expect(instance).to.be.a(LicenseManagerApi.ListUsersResponse);
    });
