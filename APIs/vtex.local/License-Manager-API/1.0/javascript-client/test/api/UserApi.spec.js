...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LicenseManagerApi.UserApi();
  });
  ...
  describe('UserApi', function() {
    ...
    describe('getListUsers', function() {
      it('should call getListUsers successfully', function(done) {
        //uncomment below and update the code to test getListUsers
        //instance.getListUsers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
