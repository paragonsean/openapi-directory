...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LicenseManagerApi.StoreApi();
  });
  ...
  describe('StoreApi', function() {
    describe('getByAccount', function() {
      it('should call getByAccount successfully', function(done) {
        //uncomment below and update the code to test getByAccount
        //instance.getByAccount(function(error) {
