    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [UserItems]);
            }
 ...
 * @member {Array.<module:model/UserItems>} items
 */
ListUsersResponse.prototype['items'] = undefined;

/**
 * @member {module:model/Paging} paging
 */
ListUsersResponse.prototype['paging'] = undefined;
