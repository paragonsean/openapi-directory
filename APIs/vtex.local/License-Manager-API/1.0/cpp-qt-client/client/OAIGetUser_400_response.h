...
/*
 * OAIGetUser_400_response.h
 *
 * 
 */

#ifndef OAIGetUser_400_response_H
#define OAIGetUser_400_response_H
...
class OAIGetUser_400_response : public OAIObject {
public:
    OAIGetUser_400_response();
    OAIGetUser_400_response(QString json);
    ~OAIGetUser_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUser_400_response)

#endif // OAIGetUser_400_response_H
