...
/*
 * OAIAccountResponse_contact.h
 *
 * 
 */

#ifndef OAIAccountResponse_contact_H
#define OAIAccountResponse_contact_H
...
class OAIAccountResponse_contact : public OAIObject {
public:
    OAIAccountResponse_contact();
    OAIAccountResponse_contact(QString json);
    ~OAIAccountResponse_contact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountResponse_contact)

#endif // OAIAccountResponse_contact_H
