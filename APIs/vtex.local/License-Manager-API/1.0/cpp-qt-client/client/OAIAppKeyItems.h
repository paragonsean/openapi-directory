...
#ifndef OAIAppKeyItems_H
#define OAIAppKeyItems_H
...
class OAIAppKeyItems : public OAIObject {
public:
    OAIAppKeyItems();
    OAIAppKeyItems(QString json);
    ~OAIAppKeyItems() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppKeyItems)

#endif // OAIAppKeyItems_H
