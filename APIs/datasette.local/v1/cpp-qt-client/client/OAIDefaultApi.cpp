...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://datasette.local"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://datasette.io"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
...
void OAIDefaultApi::query(const QString &sql, const QString &_shape) {
    QString fullPath = QString(_serverConfigs["query"][_serverIndices.value("query")].URL()+"/content.json");
    ...
    
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "sql", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("sql")).append(querySuffix).append(QUrl::toPercentEncoding(sql));
    }
    
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "_shape", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("_shape")).append(querySuffix).append(QUrl::toPercentEncoding(_shape));
    }
