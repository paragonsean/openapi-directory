...
async def v2_email_template_attachments_json_get(request: web.Request, ids=None, email_template_id=None, per_page=None, page=None, include_paging_counts=None, limit_paging_counts=None) -> web.Response:
    ...
    :param ids: IDs of email template attachments to fetch. If a record can&#39;t be found, that record won&#39;t be returned and your request will be successful
    :type ids: List[int]
    :param email_template_id: Filters email template attachments by email template IDs
    :type email_template_id: List[int]
