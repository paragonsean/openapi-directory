...
async def v2_account_stages_id_json_get(request: web.Request, id) -> web.Response:
    """Fetch an account stage

    Fetches an account stage, by ID only. 

    :param id: Account Stage ID
    :type id: str
...
async def v2_account_stages_json_get(request: web.Request, ids=None, updated_at=None, sort_by=None, sort_direction=None, per_page=None, page=None, include_paging_counts=None, limit_paging_counts=None) -> web.Response:
    """List account stages
    ...
    :param ids: IDs of account stages to fetch. If a record can&#39;t be found, that record won&#39;t be returned and your request will be successful
    :type ids: List[int]
