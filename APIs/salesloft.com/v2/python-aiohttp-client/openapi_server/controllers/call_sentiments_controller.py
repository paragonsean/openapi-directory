...
async def v2_call_sentiments_json_get(request: web.Request, name=None, sort_by=None, sort_direction=None, per_page=None, page=None, include_paging_counts=None, limit_paging_counts=None) -> web.Response:
    ...
    :param name: Filters call sentiments by name
    :type name: str
