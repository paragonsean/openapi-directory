...
async def v2_successes_json_get(request: web.Request, ids=None, person_id=None, updated_at=None, sort_by=None, sort_direction=None, per_page=None, page=None, include_paging_counts=None, limit_paging_counts=None) -> web.Response:
    """List successes

    Fetches multiple success records. The records can be filtered, paged, and sorted according to the respective parameters. 

    :param ids: IDs of successes to fetch. If a record can&#39;t be found, that record won&#39;t be returned and your request will be successful
    :type ids: List[int]
    :param person_id: Filters successes by person_id. Multiple person ids can be applied
    ...
    :param sort_by: Key to sort on, must be one of: created_at, updated_at, succeeded_at. Defaults to updated_at
    :type sort_by: str
