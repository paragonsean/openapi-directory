...
/**
* CallDispositions service.
* @module api/CallDispositionsApi
* @version v2
*/
export default class CallDispositionsApi {

    /**
    * Constructs a new CallDispositionsApi. 
    * @alias module:api/CallDispositionsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the v2CallDispositionsJsonGet operation.
     * @callback module:api/CallDispositionsApi~v2CallDispositionsJsonGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/CallDisposition>} data The data returned by the service call.
     ...
     * @param {module:api/CallDispositionsApi~v2CallDispositionsJsonGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/CallDisposition>}
     */
    v2CallDispositionsJsonGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['*/*'];
      let returnType = [CallDisposition];
      return this.apiClient.callApi(
        '/v2/call_dispositions.json', 'GET',
