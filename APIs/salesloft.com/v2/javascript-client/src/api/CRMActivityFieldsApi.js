...
/**
* CRMActivityFields service.
* @module api/CRMActivityFieldsApi
* @version v2
*/
export default class CRMActivityFieldsApi {

    /**
    * Constructs a new CRMActivityFieldsApi. 
    * @alias module:api/CRMActivityFieldsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the v2CrmActivityFieldsJsonGet operation.
     * @callback module:api/CRMActivityFieldsApi~v2CrmActivityFieldsJsonGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/CrmActivityField>} data The data returned by the service call.
     ...
     * @param {module:api/CRMActivityFieldsApi~v2CrmActivityFieldsJsonGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/CrmActivityField>}
     */
    v2CrmActivityFieldsJsonGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['*/*'];
      let returnType = [CrmActivityField];
      return this.apiClient.callApi(
        '/v2/crm_activity_fields.json', 'GET',
