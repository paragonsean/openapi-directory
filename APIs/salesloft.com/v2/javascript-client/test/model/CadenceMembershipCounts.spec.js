...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesLoftPlatform.CadenceMembershipCounts();
  });
  ...
  describe('CadenceMembershipCounts', function() {
    it('should create an instance of CadenceMembershipCounts', function() {
      // uncomment below and update the code to test CadenceMembershipCounts
      //var instance = new SalesLoftPlatform.CadenceMembershipCounts();
      //expect(instance).to.be.a(SalesLoftPlatform.CadenceMembershipCounts);
    });
