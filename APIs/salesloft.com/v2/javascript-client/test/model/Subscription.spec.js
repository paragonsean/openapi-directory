...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesLoftPlatform.Subscription();
  });
  ...
  describe('Subscription', function() {
    it('should create an instance of Subscription', function() {
      ...
      //var instance = new SalesLoftPlatform.Subscription();
      //expect(instance).to.be.a(SalesLoftPlatform.Subscription);
    });

    it('should have the property callbackToken (base name: "callback_token")', function() {
