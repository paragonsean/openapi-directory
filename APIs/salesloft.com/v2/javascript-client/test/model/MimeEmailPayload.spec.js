...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesLoftPlatform.MimeEmailPayload();
  });
  ...
  describe('MimeEmailPayload', function() {
    it('should create an instance of MimeEmailPayload', function() {
      // uncomment below and update the code to test MimeEmailPayload
      //var instance = new SalesLoftPlatform.MimeEmailPayload();
      //expect(instance).to.be.a(SalesLoftPlatform.MimeEmailPayload);
    });
