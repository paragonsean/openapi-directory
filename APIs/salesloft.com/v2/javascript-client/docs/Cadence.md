...
**archivedAt** | **Date** | Datetime of when the cadence was archived, if archived | [optional] 
**bouncedStage** | [**EmbeddedResource**](EmbeddedResource.md) |  | [optional] 
**cadenceFrameworkId** | **Number** | ID of the cadence framework used to create steps for the cadence | [optional] 
...
**createdAt** | **Date** | Datetime of when the cadence was created | [optional] 
...
**groups** | [**[EmbeddedResource]**](EmbeddedResource.md) | Groups to which this cadence is assigned, if any | [optional] 
**id** | **Number** | ID of cadence | [optional] 
...
**tags** | **[String]** | All tags applied to this cadence | [optional] 
...
**updatedAt** | **Date** | Datetime of when the cadence was last updated | [optional] 
