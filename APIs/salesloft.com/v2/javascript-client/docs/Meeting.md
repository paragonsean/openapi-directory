...
**attendees** | [**[EmbeddedAttendeeResource]**](EmbeddedAttendeeResource.md) | The attendees of the meeting. Each attendee includes the following fields: status, email, name, organizer | [optional] 
...
**canceledAt** | **Date** | Datetime of when the meeting was canceled | [optional] 
**createdAt** | **Date** | Datetime of when the meeting was created | [optional] 
...
**endTime** | **Date** | End time of the meeting | [optional] 
...
**guests** | **[String]** | The list of attendees emails of the meeting | [optional] 
**iCalUid** | **String** | UID of the meeting provided by target calendar provider | [optional] 
**id** | **Number** | ID of the meeting | [optional] 
...
**startTime** | **Date** | Start time of the meeting | [optional] 
...
**updatedAt** | **Date** | Datetime of when the meeting was last updated | [optional] 
