# SalesLoftPlatform.SuccessesApi

All URIs are relative to *https://api.salesloft.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**v2SuccessesJsonGet**](SuccessesApi.md#v2SuccessesJsonGet) | **GET** /v2/successes.json | List successes



## v2SuccessesJsonGet

> [Success] v2SuccessesJsonGet(opts)
...
let apiInstance = new SalesLoftPlatform.SuccessesApi();
let opts = {
  'ids': [null], // [Number] | IDs of successes to fetch. If a record can't be found, that record won't be returned and your request will be successful
  'personId': [null], // [Number] | Filters successes by person_id. Multiple person ids can be applied
  ...
  'sortBy': "sortBy_example", // String | Key to sort on, must be one of: created_at, updated_at, succeeded_at. Defaults to updated_at
...
apiInstance.v2SuccessesJsonGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
------------- | ------------- | ------------- | -------------
 **ids** | [**[Number]**](Number.md)| IDs of successes to fetch. If a record can&#39;t be found, that record won&#39;t be returned and your request will be successful | [optional] 
 **personId** | [**[Number]**](Number.md)| Filters successes by person_id. Multiple person ids can be applied | [optional] 
 ...
 **sortBy** | **String**| Key to sort on, must be one of: created_at, updated_at, succeeded_at. Defaults to updated_at | [optional] 
