...
**createdAt** | **Date** | Datetime of when the Action was created | [optional] 
**due** | **Boolean** | Whether this step is due | [optional] 
**dueOn** | **Date** | When action is due | [optional] 
**id** | **Number** | ID of Action | [optional] 
**multitouchGroupId** | **Number** | ID of the multitouch group | [optional] 
...
**updatedAt** | **Date** | Datetime of when the Action was last updated | [optional] 
