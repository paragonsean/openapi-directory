...
**archivedAt** | **Date** | Datetime of when the Account was archived, if archived | [optional] 
...
**createdAt** | **Date** | Datetime of when the Account was created | [optional] 
...
**id** | **Number** | ID of Account | [optional] 
**industry** | **String** | Industry | [optional] 
**lastContactedAt** | **Date** | Datetime this Account was last contacted | [optional] 
...
**tags** | **[String]** | All tags applied to this Account | [optional] 
**twitterHandle** | **String** | Twitter handle, with @ | [optional] 
**updatedAt** | **Date** | Datetime of when the Account was last updated | [optional] 
