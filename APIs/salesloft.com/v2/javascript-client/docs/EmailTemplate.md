# SalesLoftPlatform.EmailTemplate
...
**archivedAt** | **Date** | Datetime of when the email template was archived, if archived | [optional] 
...
**createdAt** | **Date** | Datetime of when the email template was created | [optional] 
**groups** | [**[EmbeddedResource]**](EmbeddedResource.md) | Groups to which this template is assigned, if any | [optional] 
**id** | **Number** | ID of email template | [optional] 
**lastUsedAt** | **Date** | Datetime of when the email template was last used | [optional] 
...
**tags** | **[String]** | All tags applied to this email template | [optional] 
...
**updatedAt** | **Date** | Datetime of when the email template was last updated | [optional] 
