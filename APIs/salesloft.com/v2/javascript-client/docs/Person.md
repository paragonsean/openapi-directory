...
**lastContactedAt** | **Date** | Last datetime this person was contacted | [optional] 
...
**lastRepliedAt** | **Date** | Last datetime this person replied to an email | [optional] 
**linkedinUrl** | **String** | Linkedin URL | [optional] 
**locale** | **String** | Time locale of the person | [optional] 
**localeUtcOffset** | **Number** | The locale&#39;s timezone offset from UTC in minutes | [optional] 
...
**successCount** | **Number** | The person&#39;s success count. 1 if person has any active successes, 0 otherwise. | [optional] 
**tags** | **[String]** | All tags applied to this person | [optional] 
...
**updatedAt** | **Date** | Datetime of when the person was last updated | [optional] 
