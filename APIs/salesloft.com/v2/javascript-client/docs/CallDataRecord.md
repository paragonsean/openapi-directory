# SalesLoftPlatform.CallDataRecord
...
**createdAt** | **Date** | Datetime of when the call was created | [optional] 
**direction** | **String** | Direction of the call. Can be one of: inbound, outbound | [optional] 
**duration** | **Number** | Length of the call in seconds | [optional] 
**from** | **String** | Phone number that placed the call | [optional] 
**id** | **Number** | ID of CallDataRecord | [optional] 
...
**updatedAt** | **Date** | Datetime of when the call was last updated | [optional] 
