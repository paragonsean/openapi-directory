# SalesLoftPlatform.CadenceMembership

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**addedAt** | **Date** | Datetime of when the person was last added to this cadence | [optional] 
**cadence** | [**EmbeddedResource**](EmbeddedResource.md) |  | [optional] 
**counts** | [**CadenceMembershipCounts**](CadenceMembershipCounts.md) |  | [optional] 
**createdAt** | **Date** | Datetime of when the person was first added to this cadence | [optional] 
...
**id** | **Number** | Cadence membership ID | [optional] 
...
**updatedAt** | **Date** | Datetime of when the record was last updated | [optional] 
