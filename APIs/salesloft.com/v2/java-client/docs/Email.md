...
|**createdAt** | **OffsetDateTime** | Datetime of when the email was created |  [optional] |
...
|**id** | **Integer** | ID of Email |  [optional] |
...
|**sendAfter** | **OffsetDateTime** | When this email will be sent, or null if already sent |  [optional] |
|**sentAt** | **OffsetDateTime** | When this email was sent, or null if it was not sent |  [optional] |
...
|**updatedAt** | **OffsetDateTime** | Datetime of when the email was last updated |  [optional] |
