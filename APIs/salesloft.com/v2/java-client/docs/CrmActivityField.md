...
|------------ | ------------- | ------------- | -------------|
|**createdAt** | **OffsetDateTime** | Datetime of when the CrmActivityField was created |  [optional] |
...
|**id** | **Integer** | ID of CrmActivityField |  [optional] |
...
|**updatedAt** | **OffsetDateTime** | Datetime of when the CrmActivityField was last updated |  [optional] |
