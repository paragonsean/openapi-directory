...
import org.openapitools.client.model.PayRun3;
...
public class PayRun {
  ...
  private PayRun3 payRun;

  public PayRun() {
  }

  public PayRun payRun(PayRun3 payRun) {
    this.payRun = payRun;
    return this;
  }
  ...
  public PayRun3 getPayRun() {
    return payRun;
  }

  public void setPayRun(PayRun3 payRun) {
    this.payRun = payRun;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.payRun, payRun.payRun);
  }

  @Override
  public int hashCode() {
    return Objects.hash(payRun);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("PayRun") != null && !jsonObj.get("PayRun").isJsonNull()) {
        PayRun3.validateJsonElement(jsonObj.get("PayRun"));
      }
  }
