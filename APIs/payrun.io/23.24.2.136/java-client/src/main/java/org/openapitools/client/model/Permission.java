...
import org.openapitools.client.model.Permission1;
...
public class Permission {
  ...
  private Permission1 permission;

  public Permission() {
  }

  public Permission permission(Permission1 permission) {
  ...
  public Permission1 getPermission() {
    return permission;
  }

  public void setPermission(Permission1 permission) {
    this.permission = permission;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Permission") != null && !jsonObj.get("Permission").isJsonNull()) {
        Permission1.validateJsonElement(jsonObj.get("Permission"));
      }
  }
