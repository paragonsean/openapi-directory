...
public class ApiClient {
    ...
    private String basePath = "https://api.test.payrun.io";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/23.24.2.136/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.test.payrun.io
