...
public class Variable {
  ...
  private List<VariableVariableInner> variable = new ArrayList<>();

  public Variable() {
  }

  public Variable variable(List<VariableVariableInner> variable) {
    this.variable = variable;
    return this;
  }

  public Variable addVariableItem(VariableVariableInner variableItem) {
  ...
  public List<VariableVariableInner> getVariable() {
    return variable;
  }

  public void setVariable(List<VariableVariableInner> variable) {
    this.variable = variable;
  }
      ...
      if (jsonObj.get("Variable") != null && !jsonObj.get("Variable").isJsonNull()) {
        ...
        if (jsonArrayvariable != null) {
          ...
          for (int i = 0; i < jsonArrayvariable.size(); i++) {
            VariableVariableInner.validateJsonElement(jsonArrayvariable.get(i));
          };
        }
      }
  }
