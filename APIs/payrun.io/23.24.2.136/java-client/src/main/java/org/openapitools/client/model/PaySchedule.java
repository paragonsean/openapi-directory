...
public class PaySchedule {
  ...
  private PaySchedule4 paySchedule;

  public PaySchedule() {
  }

  public PaySchedule paySchedule(PaySchedule4 paySchedule) {
  ...
  public PaySchedule4 getPaySchedule() {
    return paySchedule;
  }

  public void setPaySchedule(PaySchedule4 paySchedule) {
    this.paySchedule = paySchedule;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.paySchedule, paySchedule.paySchedule);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paySchedule);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaySchedule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaySchedule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaySchedule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaySchedule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `PaySchedule`
      if (jsonObj.get("PaySchedule") != null && !jsonObj.get("PaySchedule").isJsonNull()) {
        PaySchedule4.validateJsonElement(jsonObj.get("PaySchedule"));
      }
  }
