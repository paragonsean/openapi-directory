...
/**
 * The SecondaryAddress model module.
 * @module model/SecondaryAddress
 * @version 23.24.2.136
 */
class SecondaryAddress {
    /**
     * Constructs a new <code>SecondaryAddress</code>.
     * The employer auto enrolments&#39; secondary address
     * @alias module:model/SecondaryAddress
     */
    constructor() { 
        
        SecondaryAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SecondaryAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SecondaryAddress} obj Optional instance to populate.
     * @return {module:model/SecondaryAddress} The populated <code>SecondaryAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SecondaryAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>SecondaryAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SecondaryAddress</code>.
     */
 ...
 */
SecondaryAddress.prototype['Address1'] = undefined;

/**
 * The addresss' line 2
 * @member {String} Address2
 */
SecondaryAddress.prototype['Address2'] = undefined;

/**
 * The addresss' line 3
 * @member {String} Address3
 */
SecondaryAddress.prototype['Address3'] = undefined;

/**
 * The addresss' line 4
 * @member {String} Address4
 */
SecondaryAddress.prototype['Address4'] = undefined;

/**
 * The addresss' country
 * @member {String} Country
 */
SecondaryAddress.prototype['Country'] = undefined;

/**
 * The addresss' postcode
 * @member {String} Postcode
 */
SecondaryAddress.prototype['Postcode'] = undefined;
