...
class ReportQuery {
     ...
     * @param {module:model/ReportQuery} obj Optional instance to populate.
     * @return {module:model/ReportQuery} The populated <code>ReportQuery</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportQuery();
    ...
    /**
     * Validates the JSON data with respect to <code>ReportQuery</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReportQuery</code>.
     */
