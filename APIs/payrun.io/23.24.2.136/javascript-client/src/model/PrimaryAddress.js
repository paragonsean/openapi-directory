...
/**
 * The PrimaryAddress model module.
 * @module model/PrimaryAddress
 * @version 23.24.2.136
 */
class PrimaryAddress {
    /**
     * Constructs a new <code>PrimaryAddress</code>.
     * The employer auto enrolments&#39; primary address
     * @alias module:model/PrimaryAddress
     */
    constructor() { 
        
        PrimaryAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PrimaryAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrimaryAddress} obj Optional instance to populate.
     * @return {module:model/PrimaryAddress} The populated <code>PrimaryAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PrimaryAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>PrimaryAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrimaryAddress</code>.
     */
 ...
 */
PrimaryAddress.prototype['Address1'] = undefined;

/**
 * The addresss' line 2
 * @member {String} Address2
 */
PrimaryAddress.prototype['Address2'] = undefined;

/**
 * The addresss' line 3
 * @member {String} Address3
 */
PrimaryAddress.prototype['Address3'] = undefined;

/**
 * The addresss' line 4
 * @member {String} Address4
 */
PrimaryAddress.prototype['Address4'] = undefined;

/**
 * The addresss' country
 * @member {String} Country
 */
PrimaryAddress.prototype['Country'] = undefined;

/**
 * The addresss' postcode
 * @member {String} Postcode
 */
PrimaryAddress.prototype['Postcode'] = undefined;
