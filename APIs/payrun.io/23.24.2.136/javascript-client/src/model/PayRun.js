...
class PayRun {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('PayRun')) {
                obj['PayRun'] = PayRun3.constructFromObject(data['PayRun']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['PayRun']) { // data not null
          PayRun3.validateJSON(data['PayRun']);
        }
...
/**
 * @member {module:model/PayRun3} PayRun
 */
PayRun.prototype['PayRun'] = undefined;
