...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.Commentary();
  });
  ...
  describe('Commentary', function() {
    it('should create an instance of Commentary', function() {
      // uncomment below and update the code to test Commentary
      //var instance = new PayRunIo.Commentary();
      //expect(instance).to.be.a(PayRunIo.Commentary);
    });
