...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.SecondaryAddress();
  });
  ...
  describe('SecondaryAddress', function() {
    it('should create an instance of SecondaryAddress', function() {
      // uncomment below and update the code to test SecondaryAddress
      //var instance = new PayRunIo.SecondaryAddress();
      //expect(instance).to.be.a(PayRunIo.SecondaryAddress);
    });
