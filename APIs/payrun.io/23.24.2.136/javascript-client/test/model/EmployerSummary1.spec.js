...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.EmployerSummary1();
  });
  ...
  describe('EmployerSummary1', function() {
    it('should create an instance of EmployerSummary1', function() {
      // uncomment below and update the code to test EmployerSummary1
      //var instance = new PayRunIo.EmployerSummary1();
      //expect(instance).to.be.a(PayRunIo.EmployerSummary1);
    });
