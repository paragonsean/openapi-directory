...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.Address2();
  });
  ...
  describe('Address2', function() {
    it('should create an instance of Address2', function() {
      // uncomment below and update the code to test Address2
      //var instance = new PayRunIo.Address2();
      //expect(instance).to.be.a(PayRunIo.Address2);
    });
