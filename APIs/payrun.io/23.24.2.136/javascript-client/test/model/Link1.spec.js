...
(function(root, factory) {
  ...
  describe('Link1', function() {
    it('should create an instance of Link1', function() {
      // uncomment below and update the code to test Link1
      //var instance = new PayRunIo.Link1();
      //expect(instance).to.be.a(PayRunIo.Link1);
    });
