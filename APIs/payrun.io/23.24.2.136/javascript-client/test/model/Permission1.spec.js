...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.Permission1();
  });
  ...
  describe('Permission1', function() {
    it('should create an instance of Permission1', function() {
      // uncomment below and update the code to test Permission1
      //var instance = new PayRunIo.Permission1();
      //expect(instance).to.be.a(PayRunIo.Permission1);
    });
