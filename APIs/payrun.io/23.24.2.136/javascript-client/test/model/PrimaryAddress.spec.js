...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.PrimaryAddress();
  });
  ...
  describe('PrimaryAddress', function() {
    it('should create an instance of PrimaryAddress', function() {
      // uncomment below and update the code to test PrimaryAddress
      //var instance = new PayRunIo.PrimaryAddress();
      //expect(instance).to.be.a(PayRunIo.PrimaryAddress);
    });
