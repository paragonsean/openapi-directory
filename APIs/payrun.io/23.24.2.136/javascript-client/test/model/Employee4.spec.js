...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.Employee4();
  });
  ...
  describe('Employee4', function() {
    it('should create an instance of Employee4', function() {
      // uncomment below and update the code to test Employee4
      //var instance = new PayRunIo.Employee4();
      //expect(instance).to.be.a(PayRunIo.Employee4);
    });
