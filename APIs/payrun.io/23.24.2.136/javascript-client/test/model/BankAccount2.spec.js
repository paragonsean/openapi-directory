...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.BankAccount2();
  });
  ...
  describe('BankAccount2', function() {
    it('should create an instance of BankAccount2', function() {
      // uncomment below and update the code to test BankAccount2
      //var instance = new PayRunIo.BankAccount2();
      //expect(instance).to.be.a(PayRunIo.BankAccount2);
    });
