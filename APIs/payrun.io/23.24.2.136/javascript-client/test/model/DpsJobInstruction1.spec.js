...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.DpsJobInstruction1();
  });
  ...
  describe('DpsJobInstruction1', function() {
    it('should create an instance of DpsJobInstruction1', function() {
      // uncomment below and update the code to test DpsJobInstruction1
      //var instance = new PayRunIo.DpsJobInstruction1();
      //expect(instance).to.be.a(PayRunIo.DpsJobInstruction1);
    });
    ...
    it('should have the property messagesToProcess (base name: "MessagesToProcess")', function() {
      // uncomment below and update the code to test the property messagesToProcess
      //var instance = new PayRunIo.DpsJobInstruction1();
      //expect(instance).to.be();
    });

    it('should have the property retrieve (base name: "Retrieve")', function() {
      // uncomment below and update the code to test the property retrieve
      //var instance = new PayRunIo.DpsJobInstruction1();
      //expect(instance).to.be();
    });
