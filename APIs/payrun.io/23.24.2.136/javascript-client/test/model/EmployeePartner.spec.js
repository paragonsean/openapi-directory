...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.EmployeePartner();
  });
  ...
  describe('EmployeePartner', function() {
    it('should create an instance of EmployeePartner', function() {
      // uncomment below and update the code to test EmployeePartner
      //var instance = new PayRunIo.EmployeePartner();
      //expect(instance).to.be.a(PayRunIo.EmployeePartner);
    });
