...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.BankAccount1();
  });
  ...
  describe('BankAccount1', function() {
    it('should create an instance of BankAccount1', function() {
      // uncomment below and update the code to test BankAccount1
      //var instance = new PayRunIo.BankAccount1();
      //expect(instance).to.be.a(PayRunIo.BankAccount1);
    });
