...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.OutputInner();
  });
  ...
  describe('OutputInner', function() {
    it('should create an instance of OutputInner', function() {
      // uncomment below and update the code to test OutputInner
      //var instance = new PayRunIo.OutputInner();
      //expect(instance).to.be.a(PayRunIo.OutputInner);
    });
