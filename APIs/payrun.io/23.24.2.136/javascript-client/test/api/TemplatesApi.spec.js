...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayRunIo.TemplatesApi();
  });
  ...
  describe('TemplatesApi', function() {
    describe('getTemplateModel', function() {
      it('should call getTemplateModel successfully', function(done) {
        //uncomment below and update the code to test getTemplateModel
        //instance.getTemplateModel(function(error) {
