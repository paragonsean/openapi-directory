...
#ifndef OAIPayRun_2_H
#define OAIPayRun_2_H
...
class OAIPayRun_2 : public OAIObject {
public:
    OAIPayRun_2();
    OAIPayRun_2(QString json);
    ~OAIPayRun_2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayRun_2)
