...
#ifndef OAIPrimaryAddress_H
#define OAIPrimaryAddress_H
...
class OAIPrimaryAddress : public OAIObject {
public:
    OAIPrimaryAddress();
    OAIPrimaryAddress(QString json);
    ~OAIPrimaryAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPrimaryAddress)

#endif // OAIPrimaryAddress_H
