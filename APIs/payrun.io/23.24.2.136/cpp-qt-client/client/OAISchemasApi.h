...
public:
    ...
    */
    virtual void getSchema(const QString &dto_data_type, const QString &authorization, const QString &api_version);

    /**
    * @param[in]  authorization QString [required]
    * @param[in]  api_version QString [required]
    */
    virtual void getSchemas(const QString &authorization, const QString &api_version);
...
Q_SIGNALS:
    ...
    void getSchemaSignal(OAIHttpFileElement summary);
    void getSchemasSignal(OAILinkCollection summary);


    void getSchemaSignalFull(OAIHttpRequestWorker *worker, OAIHttpFileElement summary);
    void getSchemasSignalFull(OAIHttpRequestWorker *worker, OAILinkCollection summary);

    Q_DECL_DEPRECATED_X("Use getSchemaSignalError() instead")
    void getSchemaSignalE(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getSchemaSignalError(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSchemasSignalError() instead")
    void getSchemasSignalE(OAILinkCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getSchemasSignalError(OAILinkCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
