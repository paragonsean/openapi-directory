...
#ifndef OAIAddress_2_H
#define OAIAddress_2_H
...
class OAIAddress_2 : public OAIObject {
public:
    OAIAddress_2();
    OAIAddress_2(QString json);
    ~OAIAddress_2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddress_2)

#endif // OAIAddress_2_H
