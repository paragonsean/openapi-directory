...
OAIPrimaryAddress::OAIPrimaryAddress(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPrimaryAddress::OAIPrimaryAddress() {
    this->initializeModel();
}

OAIPrimaryAddress::~OAIPrimaryAddress() {}

void OAIPrimaryAddress::initializeModel() {
...
void OAIPrimaryAddress::fromJson(QString jsonString) {
...
void OAIPrimaryAddress::fromJsonObject(QJsonObject json) {
...
QString OAIPrimaryAddress::asJson() const {
...
QJsonObject OAIPrimaryAddress::asJsonObject() const {
    QJsonObject obj;
    if (m_address1_isSet) {
...
QString OAIPrimaryAddress::getAddress1() const {
    return m_address1;
}
void OAIPrimaryAddress::setAddress1(const QString &address1) {
    m_address1 = address1;
    m_address1_isSet = true;
}

bool OAIPrimaryAddress::is_address1_Set() const{
    return m_address1_isSet;
}

bool OAIPrimaryAddress::is_address1_Valid() const{
    return m_address1_isValid;
}

QString OAIPrimaryAddress::getAddress2() const {
    return m_address2;
}
void OAIPrimaryAddress::setAddress2(const QString &address2) {
    m_address2 = address2;
    m_address2_isSet = true;
}

bool OAIPrimaryAddress::is_address2_Set() const{
    return m_address2_isSet;
}

bool OAIPrimaryAddress::is_address2_Valid() const{
    return m_address2_isValid;
}

QString OAIPrimaryAddress::getAddress3() const {
    return m_address3;
}
void OAIPrimaryAddress::setAddress3(const QString &address3) {
    m_address3 = address3;
    m_address3_isSet = true;
}

bool OAIPrimaryAddress::is_address3_Set() const{
    return m_address3_isSet;
}

bool OAIPrimaryAddress::is_address3_Valid() const{
    return m_address3_isValid;
}

QString OAIPrimaryAddress::getAddress4() const {
    return m_address4;
}
void OAIPrimaryAddress::setAddress4(const QString &address4) {
    m_address4 = address4;
    m_address4_isSet = true;
}

bool OAIPrimaryAddress::is_address4_Set() const{
    return m_address4_isSet;
}

bool OAIPrimaryAddress::is_address4_Valid() const{
    return m_address4_isValid;
}

QString OAIPrimaryAddress::getCountry() const {
    return m_country;
}
void OAIPrimaryAddress::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIPrimaryAddress::is_country_Set() const{
    return m_country_isSet;
}

bool OAIPrimaryAddress::is_country_Valid() const{
    return m_country_isValid;
}

QString OAIPrimaryAddress::getPostcode() const {
    return m_postcode;
}
void OAIPrimaryAddress::setPostcode(const QString &postcode) {
    m_postcode = postcode;
    m_postcode_isSet = true;
}

bool OAIPrimaryAddress::is_postcode_Set() const{
    return m_postcode_isSet;
}

bool OAIPrimaryAddress::is_postcode_Valid() const{
    return m_postcode_isValid;
}

bool OAIPrimaryAddress::isSet() const {
...
bool OAIPrimaryAddress::isValid() const {
