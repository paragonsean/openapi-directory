...
#ifndef OAIBankAccount_1_H
#define OAIBankAccount_1_H
...
class OAIBankAccount_1 : public OAIObject {
public:
    OAIBankAccount_1();
    OAIBankAccount_1(QString json);
    ~OAIBankAccount_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankAccount_1)

#endif // OAIBankAccount_1_H
