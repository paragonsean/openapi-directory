...
QString OAIBankAccount::getBranchName() const {
    return m_branch_name;
}
void OAIBankAccount::setBranchName(const QString &branch_name) {
    m_branch_name = branch_name;
    m_branch_name_isSet = true;
}

bool OAIBankAccount::is_branch_name_Set() const{
    return m_branch_name_isSet;
}

bool OAIBankAccount::is_branch_name_Valid() const{
    return m_branch_name_isValid;
}

QString OAIBankAccount::getReference() const {
    return m_reference;
}
void OAIBankAccount::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAIBankAccount::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAIBankAccount::is_reference_Valid() const{
    return m_reference_isValid;
}

QString OAIBankAccount::getSortCode() const {
    return m_sort_code;
}
void OAIBankAccount::setSortCode(const QString &sort_code) {
    m_sort_code = sort_code;
    m_sort_code_isSet = true;
}

bool OAIBankAccount::is_sort_code_Set() const{
    return m_sort_code_isSet;
}

bool OAIBankAccount::is_sort_code_Valid() const{
