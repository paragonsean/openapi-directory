...
QString OAIAddress_1::getAddress1() const {
    return m_address1;
}
void OAIAddress_1::setAddress1(const QString &address1) {
    m_address1 = address1;
    m_address1_isSet = true;
}

bool OAIAddress_1::is_address1_Set() const{
    return m_address1_isSet;
}

bool OAIAddress_1::is_address1_Valid() const{
    return m_address1_isValid;
}

QString OAIAddress_1::getAddress2() const {
    return m_address2;
}
void OAIAddress_1::setAddress2(const QString &address2) {
    m_address2 = address2;
    m_address2_isSet = true;
}

bool OAIAddress_1::is_address2_Set() const{
    return m_address2_isSet;
}

bool OAIAddress_1::is_address2_Valid() const{
    return m_address2_isValid;
}

QString OAIAddress_1::getAddress3() const {
    return m_address3;
}
void OAIAddress_1::setAddress3(const QString &address3) {
    m_address3 = address3;
    m_address3_isSet = true;
}

bool OAIAddress_1::is_address3_Set() const{
    return m_address3_isSet;
}

bool OAIAddress_1::is_address3_Valid() const{
    return m_address3_isValid;
}

QString OAIAddress_1::getAddress4() const {
    return m_address4;
}
void OAIAddress_1::setAddress4(const QString &address4) {
    m_address4 = address4;
    m_address4_isSet = true;
}

bool OAIAddress_1::is_address4_Set() const{
    return m_address4_isSet;
}

bool OAIAddress_1::is_address4_Valid() const{
    return m_address4_isValid;
}

QString OAIAddress_1::getCountry() const {
    return m_country;
}
void OAIAddress_1::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIAddress_1::is_country_Set() const{
    return m_country_isSet;
}

bool OAIAddress_1::is_country_Valid() const{
    return m_country_isValid;
}

QString OAIAddress_1::getPostcode() const {
    return m_postcode;
}
void OAIAddress_1::setPostcode(const QString &postcode) {
    m_postcode = postcode;
    m_postcode_isSet = true;
}

bool OAIAddress_1::is_postcode_Set() const{
    return m_postcode_isSet;
}

bool OAIAddress_1::is_postcode_Valid() const{
