...
#ifndef OAIPayRun_1_H
#define OAIPayRun_1_H
...
class OAIPayRun_1 : public OAIObject {
public:
    OAIPayRun_1();
    OAIPayRun_1(QString json);
    ~OAIPayRun_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayRun_1)
