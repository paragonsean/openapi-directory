...
async def get_schema(request: web.Request, dto_data_type, authorization, api_version) -> web.Response:
    """Get XSD schema
...
async def get_schemas(request: web.Request, authorization, api_version) -> web.Response:
