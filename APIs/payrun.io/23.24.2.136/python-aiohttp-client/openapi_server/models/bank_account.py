...
class BankAccount(Model):
    ...
    def __init__(self, account_name: str=None, account_number: str=None, branch_name: str=None, reference: str=None, sort_code: str=None):
        ...
        :param branch_name: The branch_name of this BankAccount.
        :param reference: The reference of this BankAccount.
        :param sort_code: The sort_code of this BankAccount.
        """
        self.openapi_types = {
            'account_name': str,
            'account_number': str,
    ...
    def branch_name(self):
        """Gets the branch_name of this BankAccount.

        The bank accounts' branch name

        :return: The branch_name of this BankAccount.
        :rtype: str
        """
    ...
    def branch_name(self, branch_name):
        """Sets the branch_name of this BankAccount.
    ...
    @property
    def reference(self):
        """Gets the reference of this BankAccount.

        The bank accounts' reference

        :return: The reference of this BankAccount.
        :rtype: str
        """
    ...
    @property
    def sort_code(self):
        """Gets the sort_code of this BankAccount.

        The bank accounts' sort code

        :return: The sort_code of this BankAccount.
        :rtype: str
        """
