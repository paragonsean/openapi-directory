...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AIceptionInteractive.Task();
  });
  ...
  describe('Task', function() {
    it('should create an instance of Task', function() {
      ...
      //var instance = new AIceptionInteractive.Task();
      //expect(instance).to.be.a(AIceptionInteractive.Task);
    });
    ...
    it('should have the property thisUrl (base name: "this_url")', function() {
      // uncomment below and update the code to test the property thisUrl
      //var instance = new AIceptionInteractive.Task();
      //expect(instance).to.be();
    });
