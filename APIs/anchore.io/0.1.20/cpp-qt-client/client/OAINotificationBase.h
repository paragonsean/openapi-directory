...
/*
 * OAINotificationBase.h
 *
 * base object for Notifications (every notification has this basic structure)
 */

#ifndef OAINotificationBase_H
#define OAINotificationBase_H
...
class OAINotificationBase : public OAIObject {
public:
    OAINotificationBase();
    OAINotificationBase(QString json);
    ~OAINotificationBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationBase)

#endif // OAINotificationBase_H
