...
#ifndef OAICVSSV3Scores_H
#define OAICVSSV3Scores_H
...
class OAICVSSV3Scores : public OAIObject {
public:
    OAICVSSV3Scores();
    OAICVSSV3Scores(QString json);
    ~OAICVSSV3Scores() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICVSSV3Scores)

#endif // OAICVSSV3Scores_H
