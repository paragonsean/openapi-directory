...
/*
 * OAIVulnUpdateNotification.h
 *
 * 
 */

#ifndef OAIVulnUpdateNotification_H
#define OAIVulnUpdateNotification_H
...
namespace OpenAPI {
class OAIVulnUpdateNotificationData;

class OAIVulnUpdateNotification : public OAIObject {
public:
    OAIVulnUpdateNotification();
    OAIVulnUpdateNotification(QString json);
    ~OAIVulnUpdateNotification() override;
    ...
    OAIVulnUpdateNotificationData getData() const;
    void setData(const OAIVulnUpdateNotificationData &data);
...
private:
    ...
    OAIVulnUpdateNotificationData m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIVulnUpdateNotification)

#endif // OAIVulnUpdateNotification_H
