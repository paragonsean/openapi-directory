...
/*
 * OAITagUpdateNotificationPayload.h
 *
 * 
 */

#ifndef OAITagUpdateNotificationPayload_H
#define OAITagUpdateNotificationPayload_H
...
class OAITagUpdateNotificationPayload : public OAIObject {
public:
    OAITagUpdateNotificationPayload();
    OAITagUpdateNotificationPayload(QString json);
    ~OAITagUpdateNotificationPayload() override;
    ...
    QList<QJsonValue> getCurrEval() const;
    void setCurrEval(const QList<QJsonValue> &curr_eval);
    bool is_curr_eval_Set() const;
    bool is_curr_eval_Valid() const;

    QList<QJsonValue> getLastEval() const;
    void setLastEval(const QList<QJsonValue> &last_eval);
...
private:
    ...
    QList<QJsonValue> m_curr_eval;
    bool m_curr_eval_isSet;
    bool m_curr_eval_isValid;

    QList<QJsonValue> m_last_eval;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagUpdateNotificationPayload)

#endif // OAITagUpdateNotificationPayload_H
