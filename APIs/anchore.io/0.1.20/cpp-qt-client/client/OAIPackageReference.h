...
class OAIPackageReference : public OAIObject {
public:
    OAIPackageReference();
    OAIPackageReference(QString json);
    ~OAIPackageReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageReference)

#endif // OAIPackageReference_H
