...
#include "OAIAnalysisUpdateNotificationData.h"
...
OAIAnalysisUpdateNotificationData::OAIAnalysisUpdateNotificationData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAnalysisUpdateNotificationData::OAIAnalysisUpdateNotificationData() {
    this->initializeModel();
}

OAIAnalysisUpdateNotificationData::~OAIAnalysisUpdateNotificationData() {}

void OAIAnalysisUpdateNotificationData::initializeModel() {
...
void OAIAnalysisUpdateNotificationData::fromJson(QString jsonString) {
...
void OAIAnalysisUpdateNotificationData::fromJsonObject(QJsonObject json) {
...
QString OAIAnalysisUpdateNotificationData::asJson() const {
...
QJsonObject OAIAnalysisUpdateNotificationData::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAnalysisUpdateNotificationData::getNotificationType() const {
    return m_notification_type;
}
void OAIAnalysisUpdateNotificationData::setNotificationType(const QString &notification_type) {
    m_notification_type = notification_type;
    m_notification_type_isSet = true;
}

bool OAIAnalysisUpdateNotificationData::is_notification_type_Set() const{
    return m_notification_type_isSet;
}

bool OAIAnalysisUpdateNotificationData::is_notification_type_Valid() const{
    return m_notification_type_isValid;
}

QString OAIAnalysisUpdateNotificationData::getNotificationUser() const {
    return m_notification_user;
}
void OAIAnalysisUpdateNotificationData::setNotificationUser(const QString &notification_user) {
    m_notification_user = notification_user;
    m_notification_user_isSet = true;
}

bool OAIAnalysisUpdateNotificationData::is_notification_user_Set() const{
    return m_notification_user_isSet;
}

bool OAIAnalysisUpdateNotificationData::is_notification_user_Valid() const{
    return m_notification_user_isValid;
}

QString OAIAnalysisUpdateNotificationData::getNotificationUserEmail() const {
    return m_notification_user_email;
}
void OAIAnalysisUpdateNotificationData::setNotificationUserEmail(const QString &notification_user_email) {
    m_notification_user_email = notification_user_email;
    m_notification_user_email_isSet = true;
}

bool OAIAnalysisUpdateNotificationData::is_notification_user_email_Set() const{
    return m_notification_user_email_isSet;
}

bool OAIAnalysisUpdateNotificationData::is_notification_user_email_Valid() const{
    return m_notification_user_email_isValid;
}

OAIAnalysisUpdateNotificationPayload OAIAnalysisUpdateNotificationData::getNotificationPayload() const {
    return m_notification_payload;
}
void OAIAnalysisUpdateNotificationData::setNotificationPayload(const OAIAnalysisUpdateNotificationPayload &notification_payload) {
    m_notification_payload = notification_payload;
    m_notification_payload_isSet = true;
}

bool OAIAnalysisUpdateNotificationData::is_notification_payload_Set() const{
    return m_notification_payload_isSet;
}

bool OAIAnalysisUpdateNotificationData::is_notification_payload_Valid() const{
    return m_notification_payload_isValid;
}

bool OAIAnalysisUpdateNotificationData::isSet() const {
...
bool OAIAnalysisUpdateNotificationData::isValid() const {
