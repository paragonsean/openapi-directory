...
/*
 * OAIAnalysisUpdateNotification.h
 *
 * 
 */

#ifndef OAIAnalysisUpdateNotification_H
#define OAIAnalysisUpdateNotification_H
...
namespace OpenAPI {
class OAIAnalysisUpdateNotificationData;

class OAIAnalysisUpdateNotification : public OAIObject {
public:
    OAIAnalysisUpdateNotification();
    OAIAnalysisUpdateNotification(QString json);
    ~OAIAnalysisUpdateNotification() override;
    ...
    OAIAnalysisUpdateNotificationData getData() const;
    void setData(const OAIAnalysisUpdateNotificationData &data);
...
private:
    ...
    OAIAnalysisUpdateNotificationData m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnalysisUpdateNotification)

#endif // OAIAnalysisUpdateNotification_H
