...
/*
 * OAITagUpdateNotification.h
 *
 * 
 */

#ifndef OAITagUpdateNotification_H
#define OAITagUpdateNotification_H
...
namespace OpenAPI {
class OAITagUpdateNotificationData;

class OAITagUpdateNotification : public OAIObject {
public:
    OAITagUpdateNotification();
    OAITagUpdateNotification(QString json);
    ~OAITagUpdateNotification() override;
    ...
    OAITagUpdateNotificationData getData() const;
    void setData(const OAITagUpdateNotificationData &data);
...
private:
    ...
    OAITagUpdateNotificationData m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAITagUpdateNotification)

#endif // OAITagUpdateNotification_H
