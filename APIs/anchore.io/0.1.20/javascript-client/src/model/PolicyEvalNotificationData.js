...
import PolicyEvalNotificationPayload from './PolicyEvalNotificationPayload';

/**
 * The PolicyEvalNotificationData model module.
 * @module model/PolicyEvalNotificationData
 * @version 0.1.20
 */
class PolicyEvalNotificationData {
    /**
     * Constructs a new <code>PolicyEvalNotificationData</code>.
     * @alias module:model/PolicyEvalNotificationData
     * @implements module:model/BaseNotificationData
     */
    constructor() { 
        BaseNotificationData.initialize(this);
        PolicyEvalNotificationData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyEvalNotificationData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyEvalNotificationData} obj Optional instance to populate.
     * @return {module:model/PolicyEvalNotificationData} The populated <code>PolicyEvalNotificationData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyEvalNotificationData();
            ...
            if (data.hasOwnProperty('notification_payload')) {
                obj['notification_payload'] = PolicyEvalNotificationPayload.constructFromObject(data['notification_payload']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyEvalNotificationData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyEvalNotificationData</code>.
     */
    static validateJSON(data) {
        ...
        if (data['notification_payload']) { // data not null
          PolicyEvalNotificationPayload.validateJSON(data['notification_payload']);
        }
 ...
 */
PolicyEvalNotificationData.prototype['notification_type'] = undefined;

/**
 * @member {String} notification_user
 */
PolicyEvalNotificationData.prototype['notification_user'] = undefined;

/**
 * @member {String} notification_user_email
 */
PolicyEvalNotificationData.prototype['notification_user_email'] = undefined;

/**
 * @member {module:model/PolicyEvalNotificationPayload} notification_payload
 */
PolicyEvalNotificationData.prototype['notification_payload'] = undefined;
...
export default PolicyEvalNotificationData;
