...
/**
 * The BaseNotificationData model module.
 * @module model/BaseNotificationData
 * @version 0.1.20
 */
class BaseNotificationData {
    /**
     * Constructs a new <code>BaseNotificationData</code>.
     * Every notification has a payload, which follows this basic structure
     * @alias module:model/BaseNotificationData
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>BaseNotificationData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BaseNotificationData} obj Optional instance to populate.
     * @return {module:model/BaseNotificationData} The populated <code>BaseNotificationData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BaseNotificationData();
    ...
    /**
     * Validates the JSON data with respect to <code>BaseNotificationData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BaseNotificationData</code>.
     */
...
export default BaseNotificationData;
