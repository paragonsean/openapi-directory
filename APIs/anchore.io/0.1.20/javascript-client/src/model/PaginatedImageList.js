...
import ImageWithPackages from './ImageWithPackages';
...
class PaginatedImageList {
    ...
    constructor() { 
        ...
        PaginatedImageList.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('images')) {
                obj['images'] = ApiClient.convertToType(data['images'], [ImageWithPackages]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['images']) { // data not null
            ...
            for (const item of data['images']) {
                ImageWithPackages.validateJSON(item);
            };
        }
 ...
 */
PaginatedImageList.prototype['next_page'] = undefined;

/**
 * The page number returned (should match the requested page query string param)
 * @member {String} page
 */
PaginatedImageList.prototype['page'] = undefined;

/**
 * The number of items sent in this response
 * @member {Number} returned_count
 */
PaginatedImageList.prototype['returned_count'] = undefined;

/**
 * @member {Array.<module:model/ImageWithPackages>} images
 */
PaginatedImageList.prototype['images'] = undefined;
