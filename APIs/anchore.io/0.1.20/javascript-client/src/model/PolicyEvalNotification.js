...
import PolicyEvalNotificationData from './PolicyEvalNotificationData';

/**
 * The PolicyEvalNotification model module.
 * @module model/PolicyEvalNotification
 * @version 0.1.20
 */
class PolicyEvalNotification {
    /**
     * Constructs a new <code>PolicyEvalNotification</code>.
     * @alias module:model/PolicyEvalNotification
     * @implements module:model/NotificationBase
     */
    constructor() { 
        NotificationBase.initialize(this);
        PolicyEvalNotification.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyEvalNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyEvalNotification} obj Optional instance to populate.
     * @return {module:model/PolicyEvalNotification} The populated <code>PolicyEvalNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyEvalNotification();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PolicyEvalNotificationData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyEvalNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyEvalNotification</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          PolicyEvalNotificationData.validateJSON(data['data']);
        }
 ...
 */
PolicyEvalNotification.prototype['created_at'] = undefined;

/**
 * @member {String} dataId
 */
PolicyEvalNotification.prototype['dataId'] = undefined;

/**
 * @member {Number} last_updated
 */
PolicyEvalNotification.prototype['last_updated'] = undefined;

/**
 * @member {Number} max_tries
 */
PolicyEvalNotification.prototype['max_tries'] = undefined;

/**
 * @member {String} queueId
 */
PolicyEvalNotification.prototype['queueId'] = undefined;

/**
 * @member {String} record_state_key
 * @default 'active'
 */
PolicyEvalNotification.prototype['record_state_key'] = 'active';

/**
 * @member {String} record_state_val
 */
PolicyEvalNotification.prototype['record_state_val'] = undefined;

/**
 * @member {Number} tries
 */
PolicyEvalNotification.prototype['tries'] = undefined;

/**
 * @member {String} userId
 */
PolicyEvalNotification.prototype['userId'] = undefined;

/**
 * @member {module:model/PolicyEvalNotificationData} data
 */
PolicyEvalNotification.prototype['data'] = undefined;
...
export default PolicyEvalNotification;
