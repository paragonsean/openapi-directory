...
import VulnUpdateNotificationPayload from './VulnUpdateNotificationPayload';

/**
 * The VulnUpdateNotificationData model module.
 * @module model/VulnUpdateNotificationData
 * @version 0.1.20
 */
class VulnUpdateNotificationData {
    /**
     * Constructs a new <code>VulnUpdateNotificationData</code>.
     * @alias module:model/VulnUpdateNotificationData
     * @implements module:model/BaseNotificationData
     */
    constructor() { 
        BaseNotificationData.initialize(this);
        VulnUpdateNotificationData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VulnUpdateNotificationData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VulnUpdateNotificationData} obj Optional instance to populate.
     * @return {module:model/VulnUpdateNotificationData} The populated <code>VulnUpdateNotificationData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VulnUpdateNotificationData();
            ...
            if (data.hasOwnProperty('notification_payload')) {
                obj['notification_payload'] = VulnUpdateNotificationPayload.constructFromObject(data['notification_payload']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VulnUpdateNotificationData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VulnUpdateNotificationData</code>.
     */
    static validateJSON(data) {
        ...
        if (data['notification_payload']) { // data not null
          VulnUpdateNotificationPayload.validateJSON(data['notification_payload']);
        }
 ...
 */
VulnUpdateNotificationData.prototype['notification_type'] = undefined;

/**
 * @member {String} notification_user
 */
VulnUpdateNotificationData.prototype['notification_user'] = undefined;

/**
 * @member {String} notification_user_email
 */
VulnUpdateNotificationData.prototype['notification_user_email'] = undefined;

/**
 * @member {module:model/VulnUpdateNotificationPayload} notification_payload
 */
VulnUpdateNotificationData.prototype['notification_payload'] = undefined;
...
export default VulnUpdateNotificationData;
