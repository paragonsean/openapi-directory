...
import VulnUpdateNotificationData from './VulnUpdateNotificationData';

/**
 * The VulnUpdateNotification model module.
 * @module model/VulnUpdateNotification
 * @version 0.1.20
 */
class VulnUpdateNotification {
    /**
     * Constructs a new <code>VulnUpdateNotification</code>.
     * @alias module:model/VulnUpdateNotification
     * @implements module:model/NotificationBase
     */
    constructor() { 
        NotificationBase.initialize(this);
        VulnUpdateNotification.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VulnUpdateNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VulnUpdateNotification} obj Optional instance to populate.
     * @return {module:model/VulnUpdateNotification} The populated <code>VulnUpdateNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VulnUpdateNotification();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = VulnUpdateNotificationData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VulnUpdateNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VulnUpdateNotification</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          VulnUpdateNotificationData.validateJSON(data['data']);
        }
 ...
 */
VulnUpdateNotification.prototype['created_at'] = undefined;

/**
 * @member {String} dataId
 */
VulnUpdateNotification.prototype['dataId'] = undefined;

/**
 * @member {Number} last_updated
 */
VulnUpdateNotification.prototype['last_updated'] = undefined;

/**
 * @member {Number} max_tries
 */
VulnUpdateNotification.prototype['max_tries'] = undefined;

/**
 * @member {String} queueId
 */
VulnUpdateNotification.prototype['queueId'] = undefined;

/**
 * @member {String} record_state_key
 * @default 'active'
 */
VulnUpdateNotification.prototype['record_state_key'] = 'active';

/**
 * @member {String} record_state_val
 */
VulnUpdateNotification.prototype['record_state_val'] = undefined;

/**
 * @member {Number} tries
 */
VulnUpdateNotification.prototype['tries'] = undefined;

/**
 * @member {String} userId
 */
VulnUpdateNotification.prototype['userId'] = undefined;

/**
 * @member {module:model/VulnUpdateNotificationData} data
 */
VulnUpdateNotification.prototype['data'] = undefined;
...
export default VulnUpdateNotification;
