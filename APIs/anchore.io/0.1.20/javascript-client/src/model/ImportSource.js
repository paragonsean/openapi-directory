...
class ImportSource {
     ...
     * @extends Object
     * @param target {Object.<String, Object>} 
     * @param type {String} 
     */
    constructor(target, type) { 
        
        ImportSource.initialize(this, target, type);
    }
     ...
     */
    static initialize(obj, target, type) { 
        obj['target'] = target;
        obj['type'] = type;
    }
...
ImportSource.RequiredProperties = ["target", "type"];

/**
 * @member {Object.<String, Object>} target
 */
ImportSource.prototype['target'] = undefined;

/**
 * @member {String} type
 */
ImportSource.prototype['type'] = undefined;
