...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnchoreEngineApiServer.IdentityApi();
  });
  ...
  describe('IdentityApi', function() {
    describe('addCredential', function() {
      it('should call addCredential successfully', function(done) {
        //uncomment below and update the code to test addCredential
        //instance.addCredential(function(error) {
    ...
    describe('getUsersAccount', function() {
      it('should call getUsersAccount successfully', function(done) {
        //uncomment below and update the code to test getUsersAccount
        //instance.getUsersAccount(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
