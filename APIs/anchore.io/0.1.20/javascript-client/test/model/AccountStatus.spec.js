...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnchoreEngineApiServer.AccountStatus();
  });
  ...
  describe('AccountStatus', function() {
    it('should create an instance of AccountStatus', function() {
      ...
      //var instance = new AnchoreEngineApiServer.AccountStatus();
      //expect(instance).to.be.a(AnchoreEngineApiServer.AccountStatus);
    });
