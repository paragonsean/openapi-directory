...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnchoreEngineApiServer.EventsList();
  });
  ...
  describe('EventsList', function() {
    it('should create an instance of EventsList', function() {
      // uncomment below and update the code to test EventsList
      //var instance = new AnchoreEngineApiServer.EventsList();
      //expect(instance).to.be.a(AnchoreEngineApiServer.EventsList);
    });
