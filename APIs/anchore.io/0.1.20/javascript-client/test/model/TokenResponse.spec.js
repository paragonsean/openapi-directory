...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnchoreEngineApiServer.TokenResponse();
  });
  ...
  describe('TokenResponse', function() {
    it('should create an instance of TokenResponse', function() {
      ...
      //var instance = new AnchoreEngineApiServer.TokenResponse();
      //expect(instance).to.be.a(AnchoreEngineApiServer.TokenResponse);
    });
