...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnchoreEngineApiServer.ImageSelectionRule();
  });
  ...
  describe('ImageSelectionRule', function() {
    it('should create an instance of ImageSelectionRule', function() {
      // uncomment below and update the code to test ImageSelectionRule
      //var instance = new AnchoreEngineApiServer.ImageSelectionRule();
      //expect(instance).to.be.a(AnchoreEngineApiServer.ImageSelectionRule);
    });
