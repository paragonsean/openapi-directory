...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnchoreEngineApiServer.ContentResponse();
  });
  ...
  describe('ContentResponse', function() {
    it('should create an instance of ContentResponse', function() {
      // uncomment below and update the code to test ContentResponse
      //var instance = new AnchoreEngineApiServer.ContentResponse();
      //expect(instance).to.be.a(AnchoreEngineApiServer.ContentResponse);
    });
