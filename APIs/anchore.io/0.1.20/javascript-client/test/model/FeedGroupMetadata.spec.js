...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnchoreEngineApiServer.FeedGroupMetadata();
  });
  ...
  describe('FeedGroupMetadata', function() {
    it('should create an instance of FeedGroupMetadata', function() {
      // uncomment below and update the code to test FeedGroupMetadata
      //var instance = new AnchoreEngineApiServer.FeedGroupMetadata();
      //expect(instance).to.be.a(AnchoreEngineApiServer.FeedGroupMetadata);
    });
