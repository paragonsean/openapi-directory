...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnchoreEngineApiServer.ImageSelector();
  });
  ...
  describe('ImageSelector', function() {
    it('should create an instance of ImageSelector', function() {
      // uncomment below and update the code to test ImageSelector
      //var instance = new AnchoreEngineApiServer.ImageSelector();
      //expect(instance).to.be.a(AnchoreEngineApiServer.ImageSelector);
    });
