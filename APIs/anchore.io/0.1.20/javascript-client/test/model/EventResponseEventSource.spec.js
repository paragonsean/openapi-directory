...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnchoreEngineApiServer.EventResponseEventSource();
  });
  ...
  describe('EventResponseEventSource', function() {
    it('should create an instance of EventResponseEventSource', function() {
      // uncomment below and update the code to test EventResponseEventSource
      //var instance = new AnchoreEngineApiServer.EventResponseEventSource();
      //expect(instance).to.be.a(AnchoreEngineApiServer.EventResponseEventSource);
    });
