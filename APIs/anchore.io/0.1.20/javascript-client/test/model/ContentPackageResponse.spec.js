...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnchoreEngineApiServer.ContentPackageResponse();
  });
  ...
  describe('ContentPackageResponse', function() {
    it('should create an instance of ContentPackageResponse', function() {
      // uncomment below and update the code to test ContentPackageResponse
      //var instance = new AnchoreEngineApiServer.ContentPackageResponse();
      //expect(instance).to.be.a(AnchoreEngineApiServer.ContentPackageResponse);
    });
