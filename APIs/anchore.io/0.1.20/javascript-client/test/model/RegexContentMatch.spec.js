...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnchoreEngineApiServer.RegexContentMatch();
  });
  ...
  describe('RegexContentMatch', function() {
    it('should create an instance of RegexContentMatch', function() {
      // uncomment below and update the code to test RegexContentMatch
      //var instance = new AnchoreEngineApiServer.RegexContentMatch();
      //expect(instance).to.be.a(AnchoreEngineApiServer.RegexContentMatch);
    });
