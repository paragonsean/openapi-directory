...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnchoreEngineApiServer.ContentFilesResponse();
  });
  ...
  describe('ContentFilesResponse', function() {
    it('should create an instance of ContentFilesResponse', function() {
      // uncomment below and update the code to test ContentFilesResponse
      //var instance = new AnchoreEngineApiServer.ContentFilesResponse();
      //expect(instance).to.be.a(AnchoreEngineApiServer.ContentFilesResponse);
    });
