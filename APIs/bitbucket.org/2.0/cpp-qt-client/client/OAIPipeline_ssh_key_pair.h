...
/*
 * OAIPipeline_ssh_key_pair.h
 *
 * 
 */

#ifndef OAIPipeline_ssh_key_pair_H
#define OAIPipeline_ssh_key_pair_H
...
class OAIPipeline_ssh_key_pair : public OAIObject {
public:
    OAIPipeline_ssh_key_pair();
    OAIPipeline_ssh_key_pair(QString json);
    ~OAIPipeline_ssh_key_pair() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipeline_ssh_key_pair)

#endif // OAIPipeline_ssh_key_pair_H
