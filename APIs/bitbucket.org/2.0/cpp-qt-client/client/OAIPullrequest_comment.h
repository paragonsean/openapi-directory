...
/*
 * OAIPullrequest_comment.h
 *
 * 
 */

#ifndef OAIPullrequest_comment_H
#define OAIPullrequest_comment_H
...
class OAIPullrequest_comment : public OAIObject {
public:
    OAIPullrequest_comment();
    OAIPullrequest_comment(QString json);
    ~OAIPullrequest_comment() override;
    ...
    OAIPullrequest getPullrequest() const;
    void setPullrequest(const OAIPullrequest &pullrequest);
    bool is_pullrequest_Set() const;
    bool is_pullrequest_Valid() const;
...
private:
    ...
    OAIPullrequest m_pullrequest;
    bool m_pullrequest_isSet;
    bool m_pullrequest_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPullrequest_comment)

#endif // OAIPullrequest_comment_H
