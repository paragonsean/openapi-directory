...
OAIBase_Commit_summary OAIComment::getContent() const {
    return m_content;
}
void OAIComment::setContent(const OAIBase_Commit_summary &content) {
    m_content = content;
...
QDateTime OAIComment::getCreatedOn() const {
    return m_created_on;
}
void OAIComment::setCreatedOn(const QDateTime &created_on) {
...
OAIComment_inline OAIComment::getRInline() const {
    return m_r_inline;
}
void OAIComment::setRInline(const OAIComment_inline &r_inline) {
    m_r_inline = r_inline;
    m_r_inline_isSet = true;
}

bool OAIComment::is_r_inline_Set() const{
    return m_r_inline_isSet;
}

bool OAIComment::is_r_inline_Valid() const{
    return m_r_inline_isValid;
}

OAIComment_links OAIComment::getLinks() const {
    return m_links;
}
void OAIComment::setLinks(const OAIComment_links &links) {
    m_links = links;
    m_links_isSet = true;
}
...
OAIComment OAIComment::getParent() const {
    return m_parent;
}
void OAIComment::setParent(const OAIComment &parent) {
    m_parent = parent;
    m_parent_isSet = true;
}

bool OAIComment::is_parent_Set() const{
    return m_parent_isSet;
}

bool OAIComment::is_parent_Valid() const{
    return m_parent_isValid;
}

QDateTime OAIComment::getUpdatedOn() const {
    return m_updated_on;
}
void OAIComment::setUpdatedOn(const QDateTime &updated_on) {
    m_updated_on = updated_on;
    m_updated_on_isSet = true;
}

bool OAIComment::is_updated_on_Set() const{
    return m_updated_on_isSet;
}

bool OAIComment::is_updated_on_Valid() const{
    return m_updated_on_isValid;
}

OAIAccount OAIComment::getUser() const {
    return m_user;
}
void OAIComment::setUser(const OAIAccount &user) {
    m_user = user;
    m_user_isSet = true;
}
