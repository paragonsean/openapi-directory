...
/*
 * OAIPaginated_files.h
 *
 * A paginated list of commit_file objects.
 */

#ifndef OAIPaginated_files_H
#define OAIPaginated_files_H
...
class OAIPaginated_files : public OAIObject {
public:
    OAIPaginated_files();
    OAIPaginated_files(QString json);
    ~OAIPaginated_files() override;
    ...
    QSet<OAICommit_file> getValues() const;
    void setValues(const QSet<OAICommit_file> &values);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaginated_files)

#endif // OAIPaginated_files_H
