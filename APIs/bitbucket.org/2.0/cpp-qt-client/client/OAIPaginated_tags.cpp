...
qint32 OAIPaginated_tags::getPage() const {
    return m_page;
}
void OAIPaginated_tags::setPage(const qint32 &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIPaginated_tags::is_page_Set() const{
    return m_page_isSet;
}

bool OAIPaginated_tags::is_page_Valid() const{
    return m_page_isValid;
}

qint32 OAIPaginated_tags::getPagelen() const {
    return m_pagelen;
}
void OAIPaginated_tags::setPagelen(const qint32 &pagelen) {
    m_pagelen = pagelen;
    m_pagelen_isSet = true;
}

bool OAIPaginated_tags::is_pagelen_Set() const{
    return m_pagelen_isSet;
}

bool OAIPaginated_tags::is_pagelen_Valid() const{
...
qint32 OAIPaginated_tags::getSize() const {
    return m_size;
}
void OAIPaginated_tags::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIPaginated_tags::is_size_Set() const{
    return m_size_isSet;
}

bool OAIPaginated_tags::is_size_Valid() const{
    return m_size_isValid;
}

QSet<OAITag> OAIPaginated_tags::getValues() const {
    return m_values;
}
void OAIPaginated_tags::setValues(const QSet<OAITag> &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAIPaginated_tags::is_values_Set() const{
    return m_values_isSet;
}

bool OAIPaginated_tags::is_values_Valid() const{
