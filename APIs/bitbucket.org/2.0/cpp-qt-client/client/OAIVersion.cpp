...
qint32 OAIVersion::getId() const {
    return m_id;
}
void OAIVersion::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
OAIBranching_Model_Settings_links OAIVersion::getLinks() const {
    return m_links;
}
void OAIVersion::setLinks(const OAIBranching_Model_Settings_links &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIVersion::is_links_Set() const{
    return m_links_isSet;
}

bool OAIVersion::is_links_Valid() const{
