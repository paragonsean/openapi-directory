...
#ifndef OAIApp_user_H
#define OAIApp_user_H
...
class OAIApp_user : public OAIObject {
public:
    OAIApp_user();
    OAIApp_user(QString json);
    ~OAIApp_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApp_user)
