...
#ifndef OAIPaginated_refs_H
#define OAIPaginated_refs_H
...
class OAIPaginated_refs : public OAIObject {
public:
    OAIPaginated_refs();
    OAIPaginated_refs(QString json);
    ~OAIPaginated_refs() override;
    ...
    QSet<OAIRef> getValues() const;
    void setValues(const QSet<OAIRef> &values);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaginated_refs)

#endif // OAIPaginated_refs_H
