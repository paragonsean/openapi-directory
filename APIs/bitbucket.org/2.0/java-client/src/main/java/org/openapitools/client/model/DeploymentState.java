...
public class DeploymentState extends ModelObject {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeploymentState
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeploymentState.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
