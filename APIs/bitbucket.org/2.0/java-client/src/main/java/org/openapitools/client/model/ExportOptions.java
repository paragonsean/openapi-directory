...
public class ExportOptions {
  public static final String SERIALIZED_NAME_INCLUDE_ATTACHMENTS = "include_attachments";
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.includeAttachments, exportOptions.includeAttachments) &&
        ...
        Objects.equals(this.type, exportOptions.type)&&
        Objects.equals(this.additionalProperties, exportOptions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(includeAttachments, projectKey, projectName, sendEmail, type, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("include_attachments");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("project_key") != null && !jsonObj.get("project_key").isJsonNull()) && !jsonObj.get("project_key").isJsonPrimitive()) {
