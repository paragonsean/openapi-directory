...
public class ErrorError {
  ...
  public ErrorError data(Map<String, Object> data) {
    this.data = data;
    return this;
  }

  public ErrorError putDataItem(String key, Object dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, errorError.data) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(data, detail, message);
  }
