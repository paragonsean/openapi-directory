...
<a id="bulkCreateOrUpdateAnnotations_0"></a>
# **bulkCreateOrUpdateAnnotations_0**
> List&lt;ReportAnnotation&gt; bulkCreateOrUpdateAnnotations_0(workspace, repoSlug, commit, reportId, reportAnnotation)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<ReportAnnotation> result = apiInstance.bulkCreateOrUpdateAnnotations_0(workspace, repoSlug, commit, reportId, reportAnnotation);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#bulkCreateOrUpdateAnnotations_0");
...
<a id="createOrUpdateAnnotation_0"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ReportAnnotation result = apiInstance.createOrUpdateAnnotation_0(workspace, repoSlug, commit, reportId, annotationId, reportAnnotation);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#createOrUpdateAnnotation_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Report result = apiInstance.createOrUpdateReport_0(workspace, repoSlug, commit, reportId, report);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#createOrUpdateReport_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String annotationId = "annotationId_example"; // String | Either the uuid or external-id of the annotation.
    try {
      apiInstance.deleteAnnotation_0(workspace, repoSlug, commit, reportId, annotationId);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#deleteAnnotation_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String reportId = "reportId_example"; // String | Either the uuid or external-id of the report.
    try {
      apiInstance.deleteReport_0(workspace, repoSlug, commit, reportId);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#deleteReport_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String annotationId = "annotationId_example"; // String | Either the uuid or external-id of the annotation.
    try {
      ReportAnnotation result = apiInstance.getAnnotation_0(workspace, repoSlug, commit, reportId, annotationId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#getAnnotation_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getAnnotationsForReport_0"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String reportId = "reportId_example"; // String | Uuid or external-if of the report for which to get annotations for.
    try {
      PaginatedAnnotations result = apiInstance.getAnnotationsForReport_0(workspace, repoSlug, commit, reportId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#getAnnotationsForReport_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String reportId = "reportId_example"; // String | Either the uuid or external-id of the report.
    try {
      Report result = apiInstance.getReport_0(workspace, repoSlug, commit, reportId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#getReport_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String commit = "commit_example"; // String | The commit for which to retrieve reports.
    try {
      PaginatedReports result = apiInstance.getReportsForCommit_0(workspace, repoSlug, commit);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#getReportsForCommit_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="repositoriesWorkspaceRepoSlugCommitCommitApproveDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String workspace = "workspace_example"; // String | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`. 
    try {
      apiInstance.repositoriesWorkspaceRepoSlugCommitCommitApproveDelete(commit, repoSlug, workspace);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#repositoriesWorkspaceRepoSlugCommitCommitApproveDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="repositoriesWorkspaceRepoSlugCommitCommitApprovePost"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String workspace = "workspace_example"; // String | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`. 
    try {
      Participant result = apiInstance.repositoriesWorkspaceRepoSlugCommitCommitApprovePost(commit, repoSlug, workspace);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#repositoriesWorkspaceRepoSlugCommitCommitApprovePost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="repositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String workspace = "workspace_example"; // String | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`. 
    try {
      apiInstance.repositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdDelete(commentId, commit, repoSlug, workspace);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#repositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="repositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String workspace = "workspace_example"; // String | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`. 
    try {
      CommitComment result = apiInstance.repositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdGet(commentId, commit, repoSlug, workspace);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#repositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="repositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdPut"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String repoSlug = "repoSlug_example"; // String | This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: `{repository UUID}`. 
    String workspace = "workspace_example"; // String | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`. 
    CommitComment commitComment = new CommitComment(); // CommitComment | The updated comment.
    try {
      apiInstance.repositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdPut(commentId, commit, repoSlug, workspace, commitComment);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#repositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="repositoriesWorkspaceRepoSlugCommitCommitCommentsGet"></a>
# **repositoriesWorkspaceRepoSlugCommitCommitCommentsGet**
> PaginatedCommitComments repositoriesWorkspaceRepoSlugCommitCommitCommentsGet(commit, repoSlug, workspace, q, sort)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PaginatedCommitComments result = apiInstance.repositoriesWorkspaceRepoSlugCommitCommitCommentsGet(commit, repoSlug, workspace, q, sort);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#repositoriesWorkspaceRepoSlugCommitCommitCommentsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="repositoriesWorkspaceRepoSlugCommitCommitCommentsPost"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String repoSlug = "repoSlug_example"; // String | This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: `{repository UUID}`. 
    String workspace = "workspace_example"; // String | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`. 
    CommitComment commitComment = new CommitComment(); // CommitComment | The specified comment.
    try {
      apiInstance.repositoriesWorkspaceRepoSlugCommitCommitCommentsPost(commit, repoSlug, workspace, commitComment);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#repositoriesWorkspaceRepoSlugCommitCommitCommentsPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="repositoriesWorkspaceRepoSlugCommitCommitGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String workspace = "workspace_example"; // String | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`. 
    try {
      Commit result = apiInstance.repositoriesWorkspaceRepoSlugCommitCommitGet(commit, repoSlug, workspace);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#repositoriesWorkspaceRepoSlugCommitCommitGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="repositoriesWorkspaceRepoSlugCommitsGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String workspace = "workspace_example"; // String | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`. 
    try {
      PaginatedChangeset result = apiInstance.repositoriesWorkspaceRepoSlugCommitsGet(repoSlug, workspace);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="repositoriesWorkspaceRepoSlugCommitsPost"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String workspace = "workspace_example"; // String | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`. 
    try {
      PaginatedChangeset result = apiInstance.repositoriesWorkspaceRepoSlugCommitsPost(repoSlug, workspace);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="repositoriesWorkspaceRepoSlugCommitsRevisionGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    CommitsApi apiInstance = new CommitsApi(defaultClient);
    String repoSlug = "repoSlug_example"; // String | This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: `{repository UUID}`. 
    String revision = "revision_example"; // String | A commit SHA1 or ref name.
    String workspace = "workspace_example"; // String | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`. 
    try {
      PaginatedChangeset result = apiInstance.repositoriesWorkspaceRepoSlugCommitsRevisionGet(repoSlug, revision, workspace);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="repositoriesWorkspaceRepoSlugCommitsRevisionPost"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String workspace = "workspace_example"; // String | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`. 
    try {
      PaginatedChangeset result = apiInstance.repositoriesWorkspaceRepoSlugCommitsRevisionPost(repoSlug, revision, workspace);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="repositoriesWorkspaceRepoSlugDiffSpecGet"></a>
# **repositoriesWorkspaceRepoSlugDiffSpecGet**
> repositoriesWorkspaceRepoSlugDiffSpecGet(repoSlug, spec, workspace, context, path, ignoreWhitespace, binary, renames, merge, topic)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean merge = true; // Boolean | This parameter is deprecated and will be removed at the end of 2022. The 'topic' parameter should be used instead. The 'merge' and 'topic' parameters cannot be both used at the same time.  If true, the source commit is merged into the destination commit, and then a diff from the destination to the merge result is returned. If false, a simple 'two dot' diff between the source and destination is returned. True if omitted.
    Boolean topic = true; // Boolean | If true, returns 2-way 'three-dot' diff. This is a diff between the source commit and the merge base of the source commit and the destination commit. If false, a simple 'two dot' diff between the source and destination is returned.
    try {
      apiInstance.repositoriesWorkspaceRepoSlugDiffSpecGet(repoSlug, spec, workspace, context, path, ignoreWhitespace, binary, renames, merge, topic);
    } catch (ApiException e) {
...
<a id="repositoriesWorkspaceRepoSlugDiffstatSpecGet"></a>
# **repositoriesWorkspaceRepoSlugDiffstatSpecGet**
> PaginatedDiffstats repositoriesWorkspaceRepoSlugDiffstatSpecGet(repoSlug, spec, workspace, ignoreWhitespace, merge, path, renames, topic)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean topic = true; // Boolean | If true, returns 2-way 'three-dot' diff. This is a diff between the source commit and the merge base of the source commit and the destination commit. If false, a simple 'two dot' diff between the source and destination is returned.
    try {
      PaginatedDiffstats result = apiInstance.repositoriesWorkspaceRepoSlugDiffstatSpecGet(repoSlug, spec, workspace, ignoreWhitespace, merge, path, renames, topic);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommitsApi#repositoriesWorkspaceRepoSlugDiffstatSpecGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="repositoriesWorkspaceRepoSlugMergeBaseRevspecGet"></a>
...
<a id="repositoriesWorkspaceRepoSlugPatchSpecGet"></a>
