...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PullrequestEndpoint();
  });
  ...
  describe('PullrequestEndpoint', function() {
    it('should create an instance of PullrequestEndpoint', function() {
      ...
      //var instance = new BitbucketApi.PullrequestEndpoint();
      //expect(instance).to.be.a(BitbucketApi.PullrequestEndpoint);
    });
