...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedBranches();
  });
  ...
  describe('PaginatedBranches', function() {
    it('should create an instance of PaginatedBranches', function() {
      // uncomment below and update the code to test PaginatedBranches
      //var instance = new BitbucketApi.PaginatedBranches();
      //expect(instance).to.be.a(BitbucketApi.PaginatedBranches);
    });
