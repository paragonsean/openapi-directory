...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.SnippetCommitLinks();
  });
  ...
  describe('SnippetCommitLinks', function() {
    it('should create an instance of SnippetCommitLinks', function() {
      // uncomment below and update the code to test SnippetCommitLinks
      //var instance = new BitbucketApi.SnippetCommitLinks();
      //expect(instance).to.be.a(BitbucketApi.SnippetCommitLinks);
    });
