...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedProjects();
  });
  ...
  describe('PaginatedProjects', function() {
    it('should create an instance of PaginatedProjects', function() {
      // uncomment below and update the code to test PaginatedProjects
      //var instance = new BitbucketApi.PaginatedProjects();
      //expect(instance).to.be.a(BitbucketApi.PaginatedProjects);
    });
