...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.IssueLinks();
  });
  ...
  describe('IssueLinks', function() {
    it('should create an instance of IssueLinks', function() {
      // uncomment below and update the code to test IssueLinks
      //var instance = new BitbucketApi.IssueLinks();
      //expect(instance).to.be.a(BitbucketApi.IssueLinks);
    });
