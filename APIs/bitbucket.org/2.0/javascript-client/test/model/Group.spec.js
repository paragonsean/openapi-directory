...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.Group();
  });
  ...
  describe('Group', function() {
    it('should create an instance of Group', function() {
      ...
      //var instance = new BitbucketApi.Group();
      //expect(instance).to.be.a(BitbucketApi.Group);
    });

    it('should have the property fullSlug (base name: "full_slug")', function() {
      // uncomment below and update the code to test the property fullSlug
      //var instance = new BitbucketApi.Group();
