...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedTreeentries();
  });
  ...
  describe('PaginatedTreeentries', function() {
    it('should create an instance of PaginatedTreeentries', function() {
      // uncomment below and update the code to test PaginatedTreeentries
      //var instance = new BitbucketApi.PaginatedTreeentries();
      //expect(instance).to.be.a(BitbucketApi.PaginatedTreeentries);
    });
