...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedVersions();
  });
  ...
  describe('PaginatedVersions', function() {
    it('should create an instance of PaginatedVersions', function() {
      // uncomment below and update the code to test PaginatedVersions
      //var instance = new BitbucketApi.PaginatedVersions();
      //expect(instance).to.be.a(BitbucketApi.PaginatedVersions);
    });
