...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedSshUserKeys();
  });
  ...
  describe('PaginatedSshUserKeys', function() {
    it('should create an instance of PaginatedSshUserKeys', function() {
      ...
      //var instance = new BitbucketApi.PaginatedSshUserKeys();
      //expect(instance).to.be.a(BitbucketApi.PaginatedSshUserKeys);
    });
