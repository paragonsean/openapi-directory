...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedChangeset();
  });
  ...
  describe('PaginatedChangeset', function() {
    it('should create an instance of PaginatedChangeset', function() {
      // uncomment below and update the code to test PaginatedChangeset
      //var instance = new BitbucketApi.PaginatedChangeset();
      //expect(instance).to.be.a(BitbucketApi.PaginatedChangeset);
    });
