...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedAccounts();
  });
  ...
  describe('PaginatedAccounts', function() {
    it('should create an instance of PaginatedAccounts', function() {
      // uncomment below and update the code to test PaginatedAccounts
      //var instance = new BitbucketApi.PaginatedAccounts();
      //expect(instance).to.be.a(BitbucketApi.PaginatedAccounts);
    });
