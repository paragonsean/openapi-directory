...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.IssueChangeMessage();
  });
  ...
  describe('IssueChangeMessage', function() {
    it('should create an instance of IssueChangeMessage', function() {
      // uncomment below and update the code to test IssueChangeMessage
      //var instance = new BitbucketApi.IssueChangeMessage();
      //expect(instance).to.be.a(BitbucketApi.IssueChangeMessage);
    });
