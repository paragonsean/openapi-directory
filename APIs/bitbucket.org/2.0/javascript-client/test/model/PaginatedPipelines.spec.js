...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedPipelines();
  });
  ...
  describe('PaginatedPipelines', function() {
    it('should create an instance of PaginatedPipelines', function() {
      // uncomment below and update the code to test PaginatedPipelines
      //var instance = new BitbucketApi.PaginatedPipelines();
      //expect(instance).to.be.a(BitbucketApi.PaginatedPipelines);
    });
