...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedHookEvents();
  });
  ...
  describe('PaginatedHookEvents', function() {
    it('should create an instance of PaginatedHookEvents', function() {
      // uncomment below and update the code to test PaginatedHookEvents
      //var instance = new BitbucketApi.PaginatedHookEvents();
      //expect(instance).to.be.a(BitbucketApi.PaginatedHookEvents);
    });
