...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedMilestones();
  });
  ...
  describe('PaginatedMilestones', function() {
    it('should create an instance of PaginatedMilestones', function() {
      // uncomment below and update the code to test PaginatedMilestones
      //var instance = new BitbucketApi.PaginatedMilestones();
      //expect(instance).to.be.a(BitbucketApi.PaginatedMilestones);
    });
