...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.CommitFile();
  });
  ...
  describe('CommitFile', function() {
    it('should create an instance of CommitFile', function() {
      // uncomment below and update the code to test CommitFile
      //var instance = new BitbucketApi.CommitFile();
      //expect(instance).to.be.a(BitbucketApi.CommitFile);
    });
