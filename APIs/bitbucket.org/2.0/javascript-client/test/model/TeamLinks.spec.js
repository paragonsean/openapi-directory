...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.TeamLinks();
  });
  ...
  describe('TeamLinks', function() {
    it('should create an instance of TeamLinks', function() {
      // uncomment below and update the code to test TeamLinks
      //var instance = new BitbucketApi.TeamLinks();
      //expect(instance).to.be.a(BitbucketApi.TeamLinks);
    });
