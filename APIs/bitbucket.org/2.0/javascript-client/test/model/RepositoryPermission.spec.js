...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.RepositoryPermission();
  });
  ...
  describe('RepositoryPermission', function() {
    it('should create an instance of RepositoryPermission', function() {
      // uncomment below and update the code to test RepositoryPermission
      //var instance = new BitbucketApi.RepositoryPermission();
      //expect(instance).to.be.a(BitbucketApi.RepositoryPermission);
    });
