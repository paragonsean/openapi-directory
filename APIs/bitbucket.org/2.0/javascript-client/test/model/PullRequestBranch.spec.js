...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PullRequestBranch();
  });
  ...
  describe('PullRequestBranch', function() {
    it('should create an instance of PullRequestBranch', function() {
      // uncomment below and update the code to test PullRequestBranch
      //var instance = new BitbucketApi.PullRequestBranch();
      //expect(instance).to.be.a(BitbucketApi.PullRequestBranch);
    });
