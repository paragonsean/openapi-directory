...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedRepositories();
  });
  ...
  describe('PaginatedRepositories', function() {
    it('should create an instance of PaginatedRepositories', function() {
      // uncomment below and update the code to test PaginatedRepositories
      //var instance = new BitbucketApi.PaginatedRepositories();
      //expect(instance).to.be.a(BitbucketApi.PaginatedRepositories);
    });
