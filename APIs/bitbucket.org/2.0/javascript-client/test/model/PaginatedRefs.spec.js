...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedRefs();
  });
  ...
  describe('PaginatedRefs', function() {
    it('should create an instance of PaginatedRefs', function() {
      // uncomment below and update the code to test PaginatedRefs
      //var instance = new BitbucketApi.PaginatedRefs();
      //expect(instance).to.be.a(BitbucketApi.PaginatedRefs);
    });
