...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.WorkspaceLinks();
  });
  ...
  describe('WorkspaceLinks', function() {
    it('should create an instance of WorkspaceLinks', function() {
      // uncomment below and update the code to test WorkspaceLinks
      //var instance = new BitbucketApi.WorkspaceLinks();
      //expect(instance).to.be.a(BitbucketApi.WorkspaceLinks);
    });
