...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedFiles();
  });
  ...
  describe('PaginatedFiles', function() {
    it('should create an instance of PaginatedFiles', function() {
      // uncomment below and update the code to test PaginatedFiles
      //var instance = new BitbucketApi.PaginatedFiles();
      //expect(instance).to.be.a(BitbucketApi.PaginatedFiles);
    });
