...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.BaseCommit();
  });
  ...
  describe('BaseCommit', function() {
    it('should create an instance of BaseCommit', function() {
      // uncomment below and update the code to test BaseCommit
      //var instance = new BitbucketApi.BaseCommit();
      //expect(instance).to.be.a(BitbucketApi.BaseCommit);
    });
