...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PipelineCommitTarget();
  });
  ...
  describe('PipelineCommitTarget', function() {
    it('should create an instance of PipelineCommitTarget', function() {
      // uncomment below and update the code to test PipelineCommitTarget
      //var instance = new BitbucketApi.PipelineCommitTarget();
      //expect(instance).to.be.a(BitbucketApi.PipelineCommitTarget);
    });
