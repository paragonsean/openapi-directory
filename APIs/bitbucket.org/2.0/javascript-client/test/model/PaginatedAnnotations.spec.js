...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedAnnotations();
  });
  ...
  describe('PaginatedAnnotations', function() {
    it('should create an instance of PaginatedAnnotations', function() {
      // uncomment below and update the code to test PaginatedAnnotations
      //var instance = new BitbucketApi.PaginatedAnnotations();
      //expect(instance).to.be.a(BitbucketApi.PaginatedAnnotations);
    });
