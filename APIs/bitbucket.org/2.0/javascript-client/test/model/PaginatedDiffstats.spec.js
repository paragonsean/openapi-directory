...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedDiffstats();
  });
  ...
  describe('PaginatedDiffstats', function() {
    it('should create an instance of PaginatedDiffstats', function() {
      // uncomment below and update the code to test PaginatedDiffstats
      //var instance = new BitbucketApi.PaginatedDiffstats();
      //expect(instance).to.be.a(BitbucketApi.PaginatedDiffstats);
    });
