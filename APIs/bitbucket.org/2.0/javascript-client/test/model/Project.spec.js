...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.Project();
  });
  ...
  describe('Project', function() {
    it('should create an instance of Project', function() {
      ...
      //var instance = new BitbucketApi.Project();
      //expect(instance).to.be.a(BitbucketApi.Project);
    });
    ...
    it('should have the property hasPubliclyVisibleRepos (base name: "has_publicly_visible_repos")', function() {
      // uncomment below and update the code to test the property hasPubliclyVisibleRepos
      //var instance = new BitbucketApi.Project();
      //expect(instance).to.be();
    });
