...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedDeployKeys();
  });
  ...
  describe('PaginatedDeployKeys', function() {
    it('should create an instance of PaginatedDeployKeys', function() {
      ...
      //var instance = new BitbucketApi.PaginatedDeployKeys();
      //expect(instance).to.be.a(BitbucketApi.PaginatedDeployKeys);
    });
