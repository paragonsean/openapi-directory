...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.RepositoryUserPermission();
  });
  ...
  describe('RepositoryUserPermission', function() {
    it('should create an instance of RepositoryUserPermission', function() {
      // uncomment below and update the code to test RepositoryUserPermission
      //var instance = new BitbucketApi.RepositoryUserPermission();
      //expect(instance).to.be.a(BitbucketApi.RepositoryUserPermission);
    });
