...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedComponents();
  });
  ...
  describe('PaginatedComponents', function() {
    it('should create an instance of PaginatedComponents', function() {
      // uncomment below and update the code to test PaginatedComponents
      //var instance = new BitbucketApi.PaginatedComponents();
      //expect(instance).to.be.a(BitbucketApi.PaginatedComponents);
    });
