...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.DeploymentStateCompleted();
  });
  ...
  describe('DeploymentStateCompleted', function() {
    it('should create an instance of DeploymentStateCompleted', function() {
      // uncomment below and update the code to test DeploymentStateCompleted
      //var instance = new BitbucketApi.DeploymentStateCompleted();
      //expect(instance).to.be.a(BitbucketApi.DeploymentStateCompleted);
    });
