...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedWorkspaces();
  });
  ...
  describe('PaginatedWorkspaces', function() {
    it('should create an instance of PaginatedWorkspaces', function() {
      // uncomment below and update the code to test PaginatedWorkspaces
      //var instance = new BitbucketApi.PaginatedWorkspaces();
      //expect(instance).to.be.a(BitbucketApi.PaginatedWorkspaces);
    });
