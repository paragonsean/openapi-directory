...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedIssues();
  });
  ...
  describe('PaginatedIssues', function() {
    it('should create an instance of PaginatedIssues', function() {
      // uncomment below and update the code to test PaginatedIssues
      //var instance = new BitbucketApi.PaginatedIssues();
      //expect(instance).to.be.a(BitbucketApi.PaginatedIssues);
    });
