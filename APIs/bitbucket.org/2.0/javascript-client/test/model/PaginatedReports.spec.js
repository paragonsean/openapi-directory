...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedReports();
  });
  ...
  describe('PaginatedReports', function() {
    it('should create an instance of PaginatedReports', function() {
      // uncomment below and update the code to test PaginatedReports
      //var instance = new BitbucketApi.PaginatedReports();
      //expect(instance).to.be.a(BitbucketApi.PaginatedReports);
    });
