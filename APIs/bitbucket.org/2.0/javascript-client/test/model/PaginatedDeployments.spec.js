...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedDeployments();
  });
  ...
  describe('PaginatedDeployments', function() {
    it('should create an instance of PaginatedDeployments', function() {
      // uncomment below and update the code to test PaginatedDeployments
      //var instance = new BitbucketApi.PaginatedDeployments();
      //expect(instance).to.be.a(BitbucketApi.PaginatedDeployments);
    });
