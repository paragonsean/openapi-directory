...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedEnvironments();
  });
  ...
  describe('PaginatedEnvironments', function() {
    it('should create an instance of PaginatedEnvironments', function() {
      // uncomment below and update the code to test PaginatedEnvironments
      //var instance = new BitbucketApi.PaginatedEnvironments();
      //expect(instance).to.be.a(BitbucketApi.PaginatedEnvironments);
    });
