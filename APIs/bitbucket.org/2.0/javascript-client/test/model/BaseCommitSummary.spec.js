...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.BaseCommitSummary();
  });
  ...
  describe('BaseCommitSummary', function() {
    it('should create an instance of BaseCommitSummary', function() {
      // uncomment below and update the code to test BaseCommitSummary
      //var instance = new BitbucketApi.BaseCommitSummary();
      //expect(instance).to.be.a(BitbucketApi.BaseCommitSummary);
    });
