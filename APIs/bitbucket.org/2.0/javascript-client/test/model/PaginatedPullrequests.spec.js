...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitbucketApi.PaginatedPullrequests();
  });
  ...
  describe('PaginatedPullrequests', function() {
    it('should create an instance of PaginatedPullrequests', function() {
      // uncomment below and update the code to test PaginatedPullrequests
      //var instance = new BitbucketApi.PaginatedPullrequests();
      //expect(instance).to.be.a(BitbucketApi.PaginatedPullrequests);
    });
