...
> PaginatedFiles repositoriesWorkspaceRepoSlugFilehistoryCommitPathGet(commit, path, repoSlug, workspace, opts)
...
let apiInstance = new BitbucketApi.SourceApi();
...
apiInstance.repositoriesWorkspaceRepoSlugFilehistoryCommitPathGet(commit, path, repoSlug, workspace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> PaginatedTreeentries repositoriesWorkspaceRepoSlugSrcCommitPathGet(commit, path, repoSlug, workspace, opts)
...
apiInstance.repositoriesWorkspaceRepoSlugSrcCommitPathGet(commit, path, repoSlug, workspace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PaginatedTreeentries repositoriesWorkspaceRepoSlugSrcGet(repoSlug, workspace, opts)
...
apiInstance.repositoriesWorkspaceRepoSlugSrcGet(repoSlug, workspace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> repositoriesWorkspaceRepoSlugSrcPost(repoSlug, workspace, opts)
...
apiInstance.repositoriesWorkspaceRepoSlugSrcPost(repoSlug, workspace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
