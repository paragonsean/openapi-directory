# BitbucketApi.DeploymentsDdevPaginatedEnvironments
...
**values** | [**[DeploymentsDdevDeploymentEnvironment]**](DeploymentsDdevDeploymentEnvironment.md) | The values of the current page. | [optional] 
