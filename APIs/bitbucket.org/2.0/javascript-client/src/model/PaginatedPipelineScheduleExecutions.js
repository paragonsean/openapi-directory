 ...
 * @version 2.0
 */
class PaginatedPipelineScheduleExecutions {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('values')) {
                obj['values'] = ApiClient.convertToType(data['values'], [PipelineScheduleExecution]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaginatedPipelineScheduleExecutions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaginatedPipelineScheduleExecutions</code>.
     */
    static validateJSON(data) {
        ...
        if (data['values']) { // data not null
            ...
            for (const item of data['values']) {
                PipelineScheduleExecution.validateJSON(item);
            };
        }
...
export default PaginatedPipelineScheduleExecutions;
