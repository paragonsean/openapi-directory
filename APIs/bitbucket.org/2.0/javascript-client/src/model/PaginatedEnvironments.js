...
class PaginatedEnvironments {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('values')) {
                obj['values'] = ApiClient.convertToType(data['values'], [DeploymentEnvironment]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaginatedEnvironments</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaginatedEnvironments</code>.
     */
    static validateJSON(data) {
        ...
        if (data['values']) { // data not null
            ...
            for (const item of data['values']) {
                DeploymentEnvironment.validateJSON(item);
            };
        }
...
export default PaginatedEnvironments;
