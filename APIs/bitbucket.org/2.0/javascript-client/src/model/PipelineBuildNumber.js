...
class PipelineBuildNumber {
    ...
    /**
     * Validates the JSON data with respect to <code>PipelineBuildNumber</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PipelineBuildNumber</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PipelineBuildNumber.RequiredProperties) {
...
PipelineBuildNumber.RequiredProperties = ["type"];

/**
 * The next number that will be used as build number.
 * @member {Number} next
 */
PipelineBuildNumber.prototype['next'] = undefined;
...
export default PipelineBuildNumber;
