...
class PaginatedHookEvents {
    /**
     * Constructs a new <code>PaginatedHookEvents</code>.
     * A paginated list of webhook types available to subscribe on.
     * @alias module:model/PaginatedHookEvents
     */
    constructor() { 
        
        PaginatedHookEvents.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaginatedHookEvents</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaginatedHookEvents} obj Optional instance to populate.
     * @return {module:model/PaginatedHookEvents} The populated <code>PaginatedHookEvents</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>PaginatedHookEvents</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaginatedHookEvents</code>.
     */
 ...
 * @member {Number} page
 */
PaginatedHookEvents.prototype['page'] = undefined;
 ...
 */
PaginatedHookEvents.prototype['values'] = undefined;
...
export default PaginatedHookEvents;
