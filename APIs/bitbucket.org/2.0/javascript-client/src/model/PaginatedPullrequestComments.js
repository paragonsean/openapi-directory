...
class PaginatedPullrequestComments {
    ...
    /**
     * Validates the JSON data with respect to <code>PaginatedPullrequestComments</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaginatedPullrequestComments</code>.
     */
    static validateJSON(data) {
        ...
        if (data['values']) { // data not null
            ...
            for (const item of data['values']) {
                PullrequestComment.validateJSON(item);
            };
        }
