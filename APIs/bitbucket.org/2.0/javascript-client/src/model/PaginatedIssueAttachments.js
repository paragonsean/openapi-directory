...
class PaginatedIssueAttachments {
    ...
    /**
     * Validates the JSON data with respect to <code>PaginatedIssueAttachments</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaginatedIssueAttachments</code>.
     */
    static validateJSON(data) {
        ...
        if (data['values']) { // data not null
            ...
            for (const item of data['values']) {
                IssueAttachment.validateJSON(item);
            };
        }
