...
Api Documentation
- API version: 1.0
  - Build date: 2024-10-12T09:56:11.491147-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*AuthenticationApiControllerApi* | [**authenticateUser**](docs/AuthenticationApiControllerApi.md#authenticateUser) | **POST** /authentication/customer/token | Get Token
