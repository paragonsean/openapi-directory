...
public class ApiClient {
    ...
    private String basePath = "http://faceidentity-beta.azurewebsites.net/api/v1.0.0";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "//faceidentity-beta.azurewebsites.net/api/v1.0.0",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://faceidentity-beta.azurewebsites.net/api/v1.0.0
