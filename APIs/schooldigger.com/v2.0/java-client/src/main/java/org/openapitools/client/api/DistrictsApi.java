...
public class DistrictsApi {
    ...
    /**
     * Build call for districtsGetAllDistricts2
    ...
    public okhttp3.Call districtsGetAllDistricts2Call(String st, String appID, String appKey, String q, String city, String zip, Double nearLatitude, Double nearLongitude, String boundaryAddress, Integer distanceMiles, Boolean isInBoundaryOnly, Double boxLatitudeNW, Double boxLongitudeNW, Double boxLatitudeSE, Double boxLongitudeSE, Integer page, Integer perPage, String sortBy, Boolean includeUnrankedDistrictsInRankSort, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v2.0/districts";
    ...
    private okhttp3.Call districtsGetAllDistricts2ValidateBeforeCall(String st, String appID, String appKey, String q, String city, String zip, Double nearLatitude, Double nearLongitude, String boundaryAddress, Integer distanceMiles, Boolean isInBoundaryOnly, Double boxLatitudeNW, Double boxLongitudeNW, Double boxLatitudeSE, Double boxLongitudeSE, Integer page, Integer perPage, String sortBy, Boolean includeUnrankedDistrictsInRankSort, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'st' is set
        if (st == null) {
            throw new ApiException("Missing the required parameter 'st' when calling districtsGetAllDistricts2(Async)");
        }

        // verify the required parameter 'appID' is set
        if (appID == null) {
            throw new ApiException("Missing the required parameter 'appID' when calling districtsGetAllDistricts2(Async)");
        }

        // verify the required parameter 'appKey' is set
        if (appKey == null) {
            throw new ApiException("Missing the required parameter 'appKey' when calling districtsGetAllDistricts2(Async)");
        }

        return districtsGetAllDistricts2Call(st, appID, appKey, q, city, zip, nearLatitude, nearLongitude, boundaryAddress, distanceMiles, isInBoundaryOnly, boxLatitudeNW, boxLongitudeNW, boxLatitudeSE, boxLongitudeSE, page, perPage, sortBy, includeUnrankedDistrictsInRankSort, _callback);
     ...
     */
    public APIDistrictList2 districtsGetAllDistricts2(String st, String appID, String appKey, String q, String city, String zip, Double nearLatitude, Double nearLongitude, String boundaryAddress, Integer distanceMiles, Boolean isInBoundaryOnly, Double boxLatitudeNW, Double boxLongitudeNW, Double boxLatitudeSE, Double boxLongitudeSE, Integer page, Integer perPage, String sortBy, Boolean includeUnrankedDistrictsInRankSort) throws ApiException {
        ApiResponse<APIDistrictList2> localVarResp = districtsGetAllDistricts2WithHttpInfo(st, appID, appKey, q, city, zip, nearLatitude, nearLongitude, boundaryAddress, distanceMiles, isInBoundaryOnly, boxLatitudeNW, boxLongitudeNW, boxLatitudeSE, boxLongitudeSE, page, perPage, sortBy, includeUnrankedDistrictsInRankSort);
     ...
     * @param sortBy Sort list. Values are: districtname, distance, rank. For descending order, precede with &#39;-&#39; i.e. -districtname (optional, default: districtname) (optional)
     * @param includeUnrankedDistrictsInRankSort If sortBy is &#39;rank&#39;, this boolean determines if districts with no rank are included in the result (optional, default: false) (optional)
     * @return ApiResponse&lt;APIDistrictList2&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<APIDistrictList2> districtsGetAllDistricts2WithHttpInfo(String st, String appID, String appKey, String q, String city, String zip, Double nearLatitude, Double nearLongitude, String boundaryAddress, Integer distanceMiles, Boolean isInBoundaryOnly, Double boxLatitudeNW, Double boxLongitudeNW, Double boxLatitudeSE, Double boxLongitudeSE, Integer page, Integer perPage, String sortBy, Boolean includeUnrankedDistrictsInRankSort) throws ApiException {
        okhttp3.Call localVarCall = districtsGetAllDistricts2ValidateBeforeCall(st, appID, appKey, q, city, zip, nearLatitude, nearLongitude, boundaryAddress, distanceMiles, isInBoundaryOnly, boxLatitudeNW, boxLongitudeNW, boxLatitudeSE, boxLongitudeSE, page, perPage, sortBy, includeUnrankedDistrictsInRankSort, null);
        Type localVarReturnType = new TypeToken<APIDistrictList2>(){}.getType();
     ...
     */
    public okhttp3.Call districtsGetAllDistricts2Async(String st, String appID, String appKey, String q, String city, String zip, Double nearLatitude, Double nearLongitude, String boundaryAddress, Integer distanceMiles, Boolean isInBoundaryOnly, Double boxLatitudeNW, Double boxLongitudeNW, Double boxLatitudeSE, Double boxLongitudeSE, Integer page, Integer perPage, String sortBy, Boolean includeUnrankedDistrictsInRankSort, final ApiCallback<APIDistrictList2> _callback) throws ApiException {

        okhttp3.Call localVarCall = districtsGetAllDistricts2ValidateBeforeCall(st, appID, appKey, q, city, zip, nearLatitude, nearLongitude, boundaryAddress, distanceMiles, isInBoundaryOnly, boxLatitudeNW, boxLongitudeNW, boxLatitudeSE, boxLongitudeSE, page, perPage, sortBy, includeUnrankedDistrictsInRankSort, _callback);
        Type localVarReturnType = new TypeToken<APIDistrictList2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for districtsGetDistrict2
     ...
     */
    public okhttp3.Call districtsGetDistrict2Call(String id, String appID, String appKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v2.0/districts/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call districtsGetDistrict2ValidateBeforeCall(String id, String appID, String appKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling districtsGetDistrict2(Async)");
        }

        // verify the required parameter 'appID' is set
        if (appID == null) {
            throw new ApiException("Missing the required parameter 'appID' when calling districtsGetDistrict2(Async)");
        }

        // verify the required parameter 'appKey' is set
        if (appKey == null) {
            throw new ApiException("Missing the required parameter 'appKey' when calling districtsGetDistrict2(Async)");
        }

        return districtsGetDistrict2Call(id, appID, appKey, _callback);
     ...
     */
    public APIDistrict12 districtsGetDistrict2(String id, String appID, String appKey) throws ApiException {
        ApiResponse<APIDistrict12> localVarResp = districtsGetDistrict2WithHttpInfo(id, appID, appKey);
        return localVarResp.getData();
    }
     ...
     * @param appID Your API app id (required)
     * @param appKey Your API app key (required)
     * @return ApiResponse&lt;APIDistrict12&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<APIDistrict12> districtsGetDistrict2WithHttpInfo(String id, String appID, String appKey) throws ApiException {
        okhttp3.Call localVarCall = districtsGetDistrict2ValidateBeforeCall(id, appID, appKey, null);
        Type localVarReturnType = new TypeToken<APIDistrict12>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call districtsGetDistrict2Async(String id, String appID, String appKey, final ApiCallback<APIDistrict12> _callback) throws ApiException {

        okhttp3.Call localVarCall = districtsGetDistrict2ValidateBeforeCall(id, appID, appKey, _callback);
        Type localVarReturnType = new TypeToken<APIDistrict12>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
