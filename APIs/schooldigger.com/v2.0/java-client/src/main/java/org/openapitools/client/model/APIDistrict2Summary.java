...
public class APIDistrict2Summary {
  ...
  public APIDistrict2Summary() {
  }

  public APIDistrict2Summary address(APILocation address) {
  ...
  public APIDistrict2Summary county(APICounty county) {
    this.county = county;
    return this;
  }
  ...
  public APIDistrict2Summary distance(Double distance) {
  ...
  public APIDistrict2Summary districtID(String districtID) {
  ...
  public APIDistrict2Summary districtName(String districtName) {
  ...
  public APIDistrict2Summary districtYearlyDetails(List<APILEAYearlyDetail> districtYearlyDetails) {
    this.districtYearlyDetails = districtYearlyDetails;
    return this;
  }

  public APIDistrict2Summary addDistrictYearlyDetailsItem(APILEAYearlyDetail districtYearlyDetailsItem) {
  ...
  public APIDistrict2Summary hasBoundary(Boolean hasBoundary) {
  ...
  public APIDistrict2Summary highGrade(String highGrade) {
  ...
  public APIDistrict2Summary isWithinBoundary(Boolean isWithinBoundary) {
  ...
  public APIDistrict2Summary locationIsWithinBoundary(Boolean locationIsWithinBoundary) {
  ...
  public APIDistrict2Summary lowGrade(String lowGrade) {
  ...
  public APIDistrict2Summary numberAlternativeSchools(Integer numberAlternativeSchools) {
  ...
  public APIDistrict2Summary numberHighSchools(Integer numberHighSchools) {
  ...
  public APIDistrict2Summary numberMiddleSchools(Integer numberMiddleSchools) {
  ...
  public APIDistrict2Summary numberPrimarySchools(Integer numberPrimarySchools) {
  ...
  public APIDistrict2Summary numberTotalSchools(Integer numberTotalSchools) {
  ...
  public APIDistrict2Summary phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public APIDistrict2Summary rankHistory(List<APILEARankHistory> rankHistory) {
    this.rankHistory = rankHistory;
    return this;
  }

  public APIDistrict2Summary addRankHistoryItem(APILEARankHistory rankHistoryItem) {
  ...
  public APIDistrict2Summary url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    APIDistrict2Summary apIDistrict2Summary = (APIDistrict2Summary) o;
    return Objects.equals(this.address, apIDistrict2Summary.address) &&
        Objects.equals(this.county, apIDistrict2Summary.county) &&
        Objects.equals(this.distance, apIDistrict2Summary.distance) &&
        Objects.equals(this.districtID, apIDistrict2Summary.districtID) &&
        Objects.equals(this.districtName, apIDistrict2Summary.districtName) &&
        Objects.equals(this.districtYearlyDetails, apIDistrict2Summary.districtYearlyDetails) &&
        Objects.equals(this.hasBoundary, apIDistrict2Summary.hasBoundary) &&
        Objects.equals(this.highGrade, apIDistrict2Summary.highGrade) &&
        Objects.equals(this.isWithinBoundary, apIDistrict2Summary.isWithinBoundary) &&
        Objects.equals(this.locationIsWithinBoundary, apIDistrict2Summary.locationIsWithinBoundary) &&
        Objects.equals(this.lowGrade, apIDistrict2Summary.lowGrade) &&
        Objects.equals(this.numberAlternativeSchools, apIDistrict2Summary.numberAlternativeSchools) &&
        Objects.equals(this.numberHighSchools, apIDistrict2Summary.numberHighSchools) &&
        Objects.equals(this.numberMiddleSchools, apIDistrict2Summary.numberMiddleSchools) &&
        Objects.equals(this.numberPrimarySchools, apIDistrict2Summary.numberPrimarySchools) &&
        Objects.equals(this.numberTotalSchools, apIDistrict2Summary.numberTotalSchools) &&
        Objects.equals(this.phone, apIDistrict2Summary.phone) &&
        Objects.equals(this.rankHistory, apIDistrict2Summary.rankHistory) &&
        Objects.equals(this.url, apIDistrict2Summary.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIDistrict2Summary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to APIDistrict2Summary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APIDistrict2Summary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APIDistrict2Summary is not found in the empty JSON string", APIDistrict2Summary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!APIDistrict2Summary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `APIDistrict2Summary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APIDistrict2Summary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APIDistrict2Summary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APIDistrict2Summary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APIDistrict2Summary.class));

       return (TypeAdapter<T>) new TypeAdapter<APIDistrict2Summary>() {
           @Override
           public void write(JsonWriter out, APIDistrict2Summary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public APIDistrict2Summary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of APIDistrict2Summary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of APIDistrict2Summary
   * @throws IOException if the JSON string is invalid with respect to APIDistrict2Summary
   */
  public static APIDistrict2Summary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APIDistrict2Summary.class);
  }

  /**
   * Convert an instance of APIDistrict2Summary to an JSON string
   *
   * @return JSON string
   */
