...
OAIAPISchool2Summary::OAIAPISchool2Summary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAPISchool2Summary::OAIAPISchool2Summary() {
    this->initializeModel();
}

OAIAPISchool2Summary::~OAIAPISchool2Summary() {}

void OAIAPISchool2Summary::initializeModel() {
...
void OAIAPISchool2Summary::fromJson(QString jsonString) {
...
void OAIAPISchool2Summary::fromJsonObject(QJsonObject json) {
...
QString OAIAPISchool2Summary::asJson() const {
...
QJsonObject OAIAPISchool2Summary::asJsonObject() const {
    QJsonObject obj;
    if (m_address.isSet()) {
...
OAIAPILocation OAIAPISchool2Summary::getAddress() const {
    return m_address;
}
void OAIAPISchool2Summary::setAddress(const OAIAPILocation &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIAPISchool2Summary::is_address_Set() const{
    return m_address_isSet;
}

bool OAIAPISchool2Summary::is_address_Valid() const{
    return m_address_isValid;
}

OAIAPICounty OAIAPISchool2Summary::getCounty() const {
    return m_county;
}
void OAIAPISchool2Summary::setCounty(const OAIAPICounty &county) {
    m_county = county;
    m_county_isSet = true;
}

bool OAIAPISchool2Summary::is_county_Set() const{
    return m_county_isSet;
}

bool OAIAPISchool2Summary::is_county_Valid() const{
    return m_county_isValid;
}

double OAIAPISchool2Summary::getDistance() const {
    return m_distance;
}
void OAIAPISchool2Summary::setDistance(const double &distance) {
    m_distance = distance;
    m_distance_isSet = true;
}

bool OAIAPISchool2Summary::is_distance_Set() const{
    return m_distance_isSet;
}

bool OAIAPISchool2Summary::is_distance_Valid() const{
    return m_distance_isValid;
}

OAIAPIDistrictSum OAIAPISchool2Summary::getDistrict() const {
    return m_district;
}
void OAIAPISchool2Summary::setDistrict(const OAIAPIDistrictSum &district) {
    m_district = district;
    m_district_isSet = true;
}

bool OAIAPISchool2Summary::is_district_Set() const{
    return m_district_isSet;
}

bool OAIAPISchool2Summary::is_district_Valid() const{
    return m_district_isValid;
}

bool OAIAPISchool2Summary::isHasBoundary() const {
    return m_has_boundary;
}
void OAIAPISchool2Summary::setHasBoundary(const bool &has_boundary) {
    m_has_boundary = has_boundary;
    m_has_boundary_isSet = true;
}

bool OAIAPISchool2Summary::is_has_boundary_Set() const{
    return m_has_boundary_isSet;
}

bool OAIAPISchool2Summary::is_has_boundary_Valid() const{
    return m_has_boundary_isValid;
}

QString OAIAPISchool2Summary::getHighGrade() const {
    return m_high_grade;
}
void OAIAPISchool2Summary::setHighGrade(const QString &high_grade) {
    m_high_grade = high_grade;
    m_high_grade_isSet = true;
}

bool OAIAPISchool2Summary::is_high_grade_Set() const{
    return m_high_grade_isSet;
}

bool OAIAPISchool2Summary::is_high_grade_Valid() const{
    return m_high_grade_isValid;
}

QString OAIAPISchool2Summary::getIsCharterSchool() const {
    return m_is_charter_school;
}
void OAIAPISchool2Summary::setIsCharterSchool(const QString &is_charter_school) {
    m_is_charter_school = is_charter_school;
    m_is_charter_school_isSet = true;
}

bool OAIAPISchool2Summary::is_is_charter_school_Set() const{
    return m_is_charter_school_isSet;
}

bool OAIAPISchool2Summary::is_is_charter_school_Valid() const{
    return m_is_charter_school_isValid;
}

QString OAIAPISchool2Summary::getIsMagnetSchool() const {
    return m_is_magnet_school;
}
void OAIAPISchool2Summary::setIsMagnetSchool(const QString &is_magnet_school) {
    m_is_magnet_school = is_magnet_school;
    m_is_magnet_school_isSet = true;
}

bool OAIAPISchool2Summary::is_is_magnet_school_Set() const{
    return m_is_magnet_school_isSet;
}

bool OAIAPISchool2Summary::is_is_magnet_school_Valid() const{
    return m_is_magnet_school_isValid;
}

bool OAIAPISchool2Summary::isIsPrivate() const {
    return m_is_private;
}
void OAIAPISchool2Summary::setIsPrivate(const bool &is_private) {
    m_is_private = is_private;
    m_is_private_isSet = true;
}

bool OAIAPISchool2Summary::is_is_private_Set() const{
    return m_is_private_isSet;
}

bool OAIAPISchool2Summary::is_is_private_Valid() const{
    return m_is_private_isValid;
}

QString OAIAPISchool2Summary::getIsTitleISchool() const {
    return m_is_title_i_school;
}
void OAIAPISchool2Summary::setIsTitleISchool(const QString &is_title_i_school) {
    m_is_title_i_school = is_title_i_school;
    m_is_title_i_school_isSet = true;
}

bool OAIAPISchool2Summary::is_is_title_i_school_Set() const{
    return m_is_title_i_school_isSet;
}

bool OAIAPISchool2Summary::is_is_title_i_school_Valid() const{
    return m_is_title_i_school_isValid;
}

QString OAIAPISchool2Summary::getIsTitleISchoolwideSchool() const {
    return m_is_title_i_schoolwide_school;
}
void OAIAPISchool2Summary::setIsTitleISchoolwideSchool(const QString &is_title_i_schoolwide_school) {
    m_is_title_i_schoolwide_school = is_title_i_schoolwide_school;
    m_is_title_i_schoolwide_school_isSet = true;
}

bool OAIAPISchool2Summary::is_is_title_i_schoolwide_school_Set() const{
    return m_is_title_i_schoolwide_school_isSet;
}

bool OAIAPISchool2Summary::is_is_title_i_schoolwide_school_Valid() const{
    return m_is_title_i_schoolwide_school_isValid;
}

QString OAIAPISchool2Summary::getIsVirtualSchool() const {
    return m_is_virtual_school;
}
void OAIAPISchool2Summary::setIsVirtualSchool(const QString &is_virtual_school) {
    m_is_virtual_school = is_virtual_school;
    m_is_virtual_school_isSet = true;
}

bool OAIAPISchool2Summary::is_is_virtual_school_Set() const{
    return m_is_virtual_school_isSet;
}

bool OAIAPISchool2Summary::is_is_virtual_school_Valid() const{
    return m_is_virtual_school_isValid;
}

QString OAIAPISchool2Summary::getLocale() const {
    return m_locale;
}
void OAIAPISchool2Summary::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIAPISchool2Summary::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIAPISchool2Summary::is_locale_Valid() const{
    return m_locale_isValid;
}

bool OAIAPISchool2Summary::isLocationIsWithinBoundary() const {
    return m_location_is_within_boundary;
}
void OAIAPISchool2Summary::setLocationIsWithinBoundary(const bool &location_is_within_boundary) {
    m_location_is_within_boundary = location_is_within_boundary;
    m_location_is_within_boundary_isSet = true;
}

bool OAIAPISchool2Summary::is_location_is_within_boundary_Set() const{
    return m_location_is_within_boundary_isSet;
}

bool OAIAPISchool2Summary::is_location_is_within_boundary_Valid() const{
    return m_location_is_within_boundary_isValid;
}

QString OAIAPISchool2Summary::getLowGrade() const {
    return m_low_grade;
}
void OAIAPISchool2Summary::setLowGrade(const QString &low_grade) {
    m_low_grade = low_grade;
    m_low_grade_isSet = true;
}

bool OAIAPISchool2Summary::is_low_grade_Set() const{
    return m_low_grade_isSet;
}

bool OAIAPISchool2Summary::is_low_grade_Valid() const{
    return m_low_grade_isValid;
}

QString OAIAPISchool2Summary::getPhone() const {
    return m_phone;
}
void OAIAPISchool2Summary::setPhone(const QString &phone) {
    m_phone = phone;
    m_phone_isSet = true;
}

bool OAIAPISchool2Summary::is_phone_Set() const{
    return m_phone_isSet;
}

bool OAIAPISchool2Summary::is_phone_Valid() const{
    return m_phone_isValid;
}

QString OAIAPISchool2Summary::getPrivateCoed() const {
    return m_private_coed;
}
void OAIAPISchool2Summary::setPrivateCoed(const QString &private_coed) {
    m_private_coed = private_coed;
    m_private_coed_isSet = true;
}

bool OAIAPISchool2Summary::is_private_coed_Set() const{
    return m_private_coed_isSet;
}

bool OAIAPISchool2Summary::is_private_coed_Valid() const{
    return m_private_coed_isValid;
}

qint32 OAIAPISchool2Summary::getPrivateDays() const {
    return m_private_days;
}
void OAIAPISchool2Summary::setPrivateDays(const qint32 &private_days) {
    m_private_days = private_days;
    m_private_days_isSet = true;
}

bool OAIAPISchool2Summary::is_private_days_Set() const{
    return m_private_days_isSet;
}

bool OAIAPISchool2Summary::is_private_days_Valid() const{
    return m_private_days_isValid;
}

bool OAIAPISchool2Summary::isPrivateHasLibrary() const {
    return m_private_has_library;
}
void OAIAPISchool2Summary::setPrivateHasLibrary(const bool &private_has_library) {
    m_private_has_library = private_has_library;
    m_private_has_library_isSet = true;
}

bool OAIAPISchool2Summary::is_private_has_library_Set() const{
    return m_private_has_library_isSet;
}

bool OAIAPISchool2Summary::is_private_has_library_Valid() const{
    return m_private_has_library_isValid;
}

double OAIAPISchool2Summary::getPrivateHours() const {
    return m_private_hours;
}
void OAIAPISchool2Summary::setPrivateHours(const double &private_hours) {
    m_private_hours = private_hours;
    m_private_hours_isSet = true;
}

bool OAIAPISchool2Summary::is_private_hours_Set() const{
    return m_private_hours_isSet;
}

bool OAIAPISchool2Summary::is_private_hours_Valid() const{
    return m_private_hours_isValid;
}

QString OAIAPISchool2Summary::getPrivateOrientation() const {
    return m_private_orientation;
}
void OAIAPISchool2Summary::setPrivateOrientation(const QString &private_orientation) {
    m_private_orientation = private_orientation;
    m_private_orientation_isSet = true;
}

bool OAIAPISchool2Summary::is_private_orientation_Set() const{
    return m_private_orientation_isSet;
}

bool OAIAPISchool2Summary::is_private_orientation_Valid() const{
    return m_private_orientation_isValid;
}

QList<OAIAPIRankHistory> OAIAPISchool2Summary::getRankHistory() const {
    return m_rank_history;
}
void OAIAPISchool2Summary::setRankHistory(const QList<OAIAPIRankHistory> &rank_history) {
    m_rank_history = rank_history;
    m_rank_history_isSet = true;
}

bool OAIAPISchool2Summary::is_rank_history_Set() const{
    return m_rank_history_isSet;
}

bool OAIAPISchool2Summary::is_rank_history_Valid() const{
    return m_rank_history_isValid;
}

qint32 OAIAPISchool2Summary::getRankMovement() const {
    return m_rank_movement;
}
void OAIAPISchool2Summary::setRankMovement(const qint32 &rank_movement) {
    m_rank_movement = rank_movement;
    m_rank_movement_isSet = true;
}

bool OAIAPISchool2Summary::is_rank_movement_Set() const{
    return m_rank_movement_isSet;
}

bool OAIAPISchool2Summary::is_rank_movement_Valid() const{
    return m_rank_movement_isValid;
}

QString OAIAPISchool2Summary::getSchoolLevel() const {
    return m_school_level;
}
void OAIAPISchool2Summary::setSchoolLevel(const QString &school_level) {
    m_school_level = school_level;
    m_school_level_isSet = true;
}

bool OAIAPISchool2Summary::is_school_level_Set() const{
    return m_school_level_isSet;
}

bool OAIAPISchool2Summary::is_school_level_Valid() const{
    return m_school_level_isValid;
}

QString OAIAPISchool2Summary::getSchoolName() const {
    return m_school_name;
}
void OAIAPISchool2Summary::setSchoolName(const QString &school_name) {
    m_school_name = school_name;
    m_school_name_isSet = true;
}

bool OAIAPISchool2Summary::is_school_name_Set() const{
    return m_school_name_isSet;
}

bool OAIAPISchool2Summary::is_school_name_Valid() const{
    return m_school_name_isValid;
}

QList<OAIAPIYearlyDemographics> OAIAPISchool2Summary::getSchoolYearlyDetails() const {
    return m_school_yearly_details;
}
void OAIAPISchool2Summary::setSchoolYearlyDetails(const QList<OAIAPIYearlyDemographics> &school_yearly_details) {
    m_school_yearly_details = school_yearly_details;
    m_school_yearly_details_isSet = true;
}

bool OAIAPISchool2Summary::is_school_yearly_details_Set() const{
    return m_school_yearly_details_isSet;
}

bool OAIAPISchool2Summary::is_school_yearly_details_Valid() const{
    return m_school_yearly_details_isValid;
}

QString OAIAPISchool2Summary::getSchoolid() const {
    return m_schoolid;
}
void OAIAPISchool2Summary::setSchoolid(const QString &schoolid) {
    m_schoolid = schoolid;
    m_schoolid_isSet = true;
}

bool OAIAPISchool2Summary::is_schoolid_Set() const{
    return m_schoolid_isSet;
}

bool OAIAPISchool2Summary::is_schoolid_Valid() const{
    return m_schoolid_isValid;
}

QString OAIAPISchool2Summary::getUrl() const {
    return m_url;
}
void OAIAPISchool2Summary::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIAPISchool2Summary::is_url_Set() const{
    return m_url_isSet;
}

bool OAIAPISchool2Summary::is_url_Valid() const{
    return m_url_isValid;
}

QString OAIAPISchool2Summary::getUrlCompare() const {
    return m_url_compare;
}
void OAIAPISchool2Summary::setUrlCompare(const QString &url_compare) {
    m_url_compare = url_compare;
    m_url_compare_isSet = true;
}

bool OAIAPISchool2Summary::is_url_compare_Set() const{
    return m_url_compare_isSet;
}

bool OAIAPISchool2Summary::is_url_compare_Valid() const{
    return m_url_compare_isValid;
}

bool OAIAPISchool2Summary::isSet() const {
...
bool OAIAPISchool2Summary::isValid() const {
