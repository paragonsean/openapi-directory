...
async def schools_get_all_schools20(request: web.Request, st, app_id, app_key, q=None, q_search_school_name_only=None, district_id=None, level=None, city=None, zip=None, is_magnet=None, is_charter=None, is_virtual=None, is_title_i=None, is_title_i_schoolwide=None, near_latitude=None, near_longitude=None, near_address=None, distance_miles=None, boundary_latitude=None, boundary_longitude=None, boundary_address=None, is_in_boundary_only=None, box_latitude_nw=None, box_longitude_nw=None, box_latitude_se=None, box_longitude_se=None, page=None, per_page=None, sort_by=None, include_unranked_schools_in_rank_sort=None) -> web.Response:
    ...
    :param boundary_latitude: Search for schools that include this (boundaryLatitude)/(boundaryLongitude) in its attendance boundary (e.g. 44.982560) (optional) (Requires School Boundary API Plan add-on. Calls with this parameter supplied will count toward your monthly call limit.)
    :type boundary_latitude: float
    :param boundary_longitude: Search for schools that include this (boundaryLatitude)/(boundaryLongitude) in its attendance boundary (e.g. -124.289185) (optional) (Requires School Boundary API Plan add-on. Calls with this parameter supplied will count toward your monthly call limit.
    :type boundary_longitude: float
    :param boundary_address: Full U.S. address: flag returned schools that include this address in its attendance boundary. Example: &#39;123 Main St. AnyTown CA 90001&#39; (optional) (Requires School Boundary API Plan add-on. Calls with this parameter supplied will count toward your monthly call limit.) IMPORTANT NOTE: If you have the lat/long of the address, use boundaryLatitude and boundaryLongitude instead for much faster response times
    :type boundary_address: str
    :param is_in_boundary_only: Return only the schools that include given location (boundaryLatitude/boundaryLongitude) or (boundaryAddress) in its attendance boundary (Requires School Boundary API Plan add-on.)
...
async def schools_get_school20(request: web.Request, id, app_id, app_key) -> web.Response:
