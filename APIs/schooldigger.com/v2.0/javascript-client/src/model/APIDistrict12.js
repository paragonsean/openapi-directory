...
/**
 * The APIDistrict12 model module.
 * @module model/APIDistrict12
 * @version v2.0
 */
class APIDistrict12 {
    /**
     * Constructs a new <code>APIDistrict12</code>.
     * @alias module:model/APIDistrict12
     */
    constructor() { 
        
        APIDistrict12.initialize(this);
    }
    ...
    /**
     * Constructs a <code>APIDistrict12</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/APIDistrict12} obj Optional instance to populate.
     * @return {module:model/APIDistrict12} The populated <code>APIDistrict12</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new APIDistrict12();

            if (data.hasOwnProperty('address')) {
                obj['address'] = APILocation.constructFromObject(data['address']);
            }
            if (data.hasOwnProperty('boundary')) {
                obj['boundary'] = APIBoundary12.constructFromObject(data['boundary']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>APIDistrict12</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>APIDistrict12</code>.
     */
    static validateJSON(data) {
        ...
        if (data['boundary']) { // data not null
          APIBoundary12.validateJSON(data['boundary']);
        }
 ...
 */
APIDistrict12.prototype['address'] = undefined;

/**
 * @member {module:model/APIBoundary12} boundary
 */
APIDistrict12.prototype['boundary'] = undefined;

/**
 * @member {module:model/APICounty} county
 */
APIDistrict12.prototype['county'] = undefined;

/**
 * SchoolDigger District ID Number (7 digits)
 * @member {String} districtID
 */
APIDistrict12.prototype['districtID'] = undefined;

/**
 * District name
 * @member {String} districtName
 */
APIDistrict12.prototype['districtName'] = undefined;

/**
 * District yearly metrics
 * @member {Array.<module:model/APILEAYearlyDetail>} districtYearlyDetails
 */
APIDistrict12.prototype['districtYearlyDetails'] = undefined;

/**
 * The high grade served by this district
 * @member {String} highGrade
 */
APIDistrict12.prototype['highGrade'] = undefined;
 ...
 */
APIDistrict12.prototype['isWithinBoundary'] = undefined;

/**
 * The low grade served by this district (PK = Prekindergarten, K = Kindergarten)
 * @member {String} lowGrade
 */
APIDistrict12.prototype['lowGrade'] = undefined;

/**
 * @member {Number} numberAlternativeSchools
 */
APIDistrict12.prototype['numberAlternativeSchools'] = undefined;

/**
 * @member {Number} numberHighSchools
 */
APIDistrict12.prototype['numberHighSchools'] = undefined;

/**
 * @member {Number} numberMiddleSchools
 */
APIDistrict12.prototype['numberMiddleSchools'] = undefined;

/**
 * @member {Number} numberPrimarySchools
 */
APIDistrict12.prototype['numberPrimarySchools'] = undefined;

/**
 * @member {Number} numberTotalSchools
 */
APIDistrict12.prototype['numberTotalSchools'] = undefined;

/**
 * District phone number
 * @member {String} phone
 */
APIDistrict12.prototype['phone'] = undefined;

/**
 * SchoolDigger yearly rank history of the district
 * @member {Array.<module:model/APILEARankHistory>} rankHistory
 */
APIDistrict12.prototype['rankHistory'] = undefined;
 ...
 */
APIDistrict12.prototype['testScores'] = undefined;

/**
 * SchoolDigger URL for this district
 * @member {String} url
 */
APIDistrict12.prototype['url'] = undefined;
