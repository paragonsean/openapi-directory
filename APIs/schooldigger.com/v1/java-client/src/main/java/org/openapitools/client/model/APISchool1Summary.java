...
public class APISchool1Summary {
  ...
  public APISchool1Summary() {
  }

  public APISchool1Summary address(APILocation address) {
  ...
  public APISchool1Summary county(APICounty county) {
    this.county = county;
    return this;
  }
  ...
  public APISchool1Summary distance(Double distance) {
  ...
  public APISchool1Summary district(APIDistrictSum district) {
  ...
  public APISchool1Summary hasBoundary(Boolean hasBoundary) {
  ...
  public APISchool1Summary highGrade(String highGrade) {
  ...
  public APISchool1Summary isCharterSchool(String isCharterSchool) {
  ...
  public APISchool1Summary isMagnetSchool(String isMagnetSchool) {
  ...
  public APISchool1Summary isPrivate(Boolean isPrivate) {
  ...
  public APISchool1Summary isTitleISchool(String isTitleISchool) {
  ...
  public APISchool1Summary isTitleISchoolwideSchool(String isTitleISchoolwideSchool) {
  ...
  public APISchool1Summary isVirtualSchool(String isVirtualSchool) {
  ...
  public APISchool1Summary locationIsWithinBoundary(Boolean locationIsWithinBoundary) {
  ...
  public APISchool1Summary lowGrade(String lowGrade) {
  ...
  public APISchool1Summary phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public APISchool1Summary privateCoed(String privateCoed) {
  ...
  public APISchool1Summary privateDays(Integer privateDays) {
  ...
  public APISchool1Summary privateHasLibrary(Boolean privateHasLibrary) {
  ...
  public APISchool1Summary privateHours(Double privateHours) {
  ...
  public APISchool1Summary privateOrientation(String privateOrientation) {
  ...
  public APISchool1Summary rankHistory(List<APIRankHistory> rankHistory) {
    this.rankHistory = rankHistory;
    return this;
  }

  public APISchool1Summary addRankHistoryItem(APIRankHistory rankHistoryItem) {
  ...
  public APISchool1Summary rankMovement(Integer rankMovement) {
  ...
  public APISchool1Summary schoolLevel(String schoolLevel) {
  ...
  public APISchool1Summary schoolName(String schoolName) {
  ...
  public APISchool1Summary schoolYearlyDetails(List<APIYearlyDemographics> schoolYearlyDetails) {
    this.schoolYearlyDetails = schoolYearlyDetails;
    return this;
  }

  public APISchool1Summary addSchoolYearlyDetailsItem(APIYearlyDemographics schoolYearlyDetailsItem) {
  ...
  public APISchool1Summary schoolid(String schoolid) {
  ...
  public APISchool1Summary url(String url) {
    this.url = url;
    return this;
  }
  ...
  public APISchool1Summary urlCompare(String urlCompare) {
  ...
  public boolean equals(Object o) {
    ...
    APISchool1Summary apISchool1Summary = (APISchool1Summary) o;
    return Objects.equals(this.address, apISchool1Summary.address) &&
        Objects.equals(this.county, apISchool1Summary.county) &&
        Objects.equals(this.distance, apISchool1Summary.distance) &&
        Objects.equals(this.district, apISchool1Summary.district) &&
        Objects.equals(this.hasBoundary, apISchool1Summary.hasBoundary) &&
        Objects.equals(this.highGrade, apISchool1Summary.highGrade) &&
        Objects.equals(this.isCharterSchool, apISchool1Summary.isCharterSchool) &&
        Objects.equals(this.isMagnetSchool, apISchool1Summary.isMagnetSchool) &&
        Objects.equals(this.isPrivate, apISchool1Summary.isPrivate) &&
        Objects.equals(this.isTitleISchool, apISchool1Summary.isTitleISchool) &&
        Objects.equals(this.isTitleISchoolwideSchool, apISchool1Summary.isTitleISchoolwideSchool) &&
        Objects.equals(this.isVirtualSchool, apISchool1Summary.isVirtualSchool) &&
        Objects.equals(this.locationIsWithinBoundary, apISchool1Summary.locationIsWithinBoundary) &&
        Objects.equals(this.lowGrade, apISchool1Summary.lowGrade) &&
        Objects.equals(this.phone, apISchool1Summary.phone) &&
        Objects.equals(this.privateCoed, apISchool1Summary.privateCoed) &&
        Objects.equals(this.privateDays, apISchool1Summary.privateDays) &&
        Objects.equals(this.privateHasLibrary, apISchool1Summary.privateHasLibrary) &&
        Objects.equals(this.privateHours, apISchool1Summary.privateHours) &&
        Objects.equals(this.privateOrientation, apISchool1Summary.privateOrientation) &&
        Objects.equals(this.rankHistory, apISchool1Summary.rankHistory) &&
        Objects.equals(this.rankMovement, apISchool1Summary.rankMovement) &&
        Objects.equals(this.schoolLevel, apISchool1Summary.schoolLevel) &&
        Objects.equals(this.schoolName, apISchool1Summary.schoolName) &&
        Objects.equals(this.schoolYearlyDetails, apISchool1Summary.schoolYearlyDetails) &&
        Objects.equals(this.schoolid, apISchool1Summary.schoolid) &&
        Objects.equals(this.url, apISchool1Summary.url) &&
        Objects.equals(this.urlCompare, apISchool1Summary.urlCompare);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, county, distance, district, hasBoundary, highGrade, isCharterSchool, isMagnetSchool, isPrivate, isTitleISchool, isTitleISchoolwideSchool, isVirtualSchool, locationIsWithinBoundary, lowGrade, phone, privateCoed, privateDays, privateHasLibrary, privateHours, privateOrientation, rankHistory, rankMovement, schoolLevel, schoolName, schoolYearlyDetails, schoolid, url, urlCompare);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class APISchool1Summary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to APISchool1Summary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APISchool1Summary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APISchool1Summary is not found in the empty JSON string", APISchool1Summary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!APISchool1Summary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `APISchool1Summary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APISchool1Summary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APISchool1Summary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APISchool1Summary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APISchool1Summary.class));

       return (TypeAdapter<T>) new TypeAdapter<APISchool1Summary>() {
           @Override
           public void write(JsonWriter out, APISchool1Summary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public APISchool1Summary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of APISchool1Summary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of APISchool1Summary
   * @throws IOException if the JSON string is invalid with respect to APISchool1Summary
   */
  public static APISchool1Summary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APISchool1Summary.class);
  }

  /**
   * Convert an instance of APISchool1Summary to an JSON string
   *
   * @return JSON string
   */
