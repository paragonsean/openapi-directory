...
public:
    ...
    * @param[in]  app_key QString [required]
    */
    virtual void districtsGetDistrict(const QString &id, const QString &app_id, const QString &app_key);
...
private:
    ...
    void districtsGetAllDistrictsCallback(OAIHttpRequestWorker *worker);
    void districtsGetDistrictCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void districtsGetAllDistrictsSignal(OAIAPIDistrictList summary);
    void districtsGetDistrictSignal(OAIAPIDistrict summary);


    void districtsGetAllDistrictsSignalFull(OAIHttpRequestWorker *worker, OAIAPIDistrictList summary);
    void districtsGetDistrictSignalFull(OAIHttpRequestWorker *worker, OAIAPIDistrict summary);

    Q_DECL_DEPRECATED_X("Use districtsGetAllDistrictsSignalError() instead")
    void districtsGetAllDistrictsSignalE(OAIAPIDistrictList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void districtsGetAllDistrictsSignalError(OAIAPIDistrictList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use districtsGetDistrictSignalError() instead")
    void districtsGetDistrictSignalE(OAIAPIDistrict summary, QNetworkReply::NetworkError error_type, QString error_str);
    void districtsGetDistrictSignalError(OAIAPIDistrict summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use districtsGetAllDistrictsSignalErrorFull() instead")
    void districtsGetAllDistrictsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void districtsGetAllDistrictsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use districtsGetDistrictSignalErrorFull() instead")
    void districtsGetDistrictSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void districtsGetDistrictSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
