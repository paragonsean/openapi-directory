...
OAIAPISchool10Full::OAIAPISchool10Full(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAPISchool10Full::OAIAPISchool10Full() {
    this->initializeModel();
}

OAIAPISchool10Full::~OAIAPISchool10Full() {}

void OAIAPISchool10Full::initializeModel() {
...
void OAIAPISchool10Full::fromJson(QString jsonString) {
...
void OAIAPISchool10Full::fromJsonObject(QJsonObject json) {
...
QString OAIAPISchool10Full::asJson() const {
...
QJsonObject OAIAPISchool10Full::asJsonObject() const {
    QJsonObject obj;
    if (m_address.isSet()) {
...
OAIAPILocation OAIAPISchool10Full::getAddress() const {
    return m_address;
}
void OAIAPISchool10Full::setAddress(const OAIAPILocation &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIAPISchool10Full::is_address_Set() const{
    return m_address_isSet;
}

bool OAIAPISchool10Full::is_address_Valid() const{
    return m_address_isValid;
}

OAIAPIBoundary OAIAPISchool10Full::getBoundary() const {
    return m_boundary;
}
void OAIAPISchool10Full::setBoundary(const OAIAPIBoundary &boundary) {
    m_boundary = boundary;
    m_boundary_isSet = true;
}

bool OAIAPISchool10Full::is_boundary_Set() const{
    return m_boundary_isSet;
}

bool OAIAPISchool10Full::is_boundary_Valid() const{
    return m_boundary_isValid;
}

OAIAPICounty OAIAPISchool10Full::getCounty() const {
    return m_county;
}
void OAIAPISchool10Full::setCounty(const OAIAPICounty &county) {
    m_county = county;
    m_county_isSet = true;
}

bool OAIAPISchool10Full::is_county_Set() const{
    return m_county_isSet;
}

bool OAIAPISchool10Full::is_county_Valid() const{
    return m_county_isValid;
}

OAIAPIDistrictSum OAIAPISchool10Full::getDistrict() const {
    return m_district;
}
void OAIAPISchool10Full::setDistrict(const OAIAPIDistrictSum &district) {
    m_district = district;
    m_district_isSet = true;
}

bool OAIAPISchool10Full::is_district_Set() const{
    return m_district_isSet;
}

bool OAIAPISchool10Full::is_district_Valid() const{
    return m_district_isValid;
}

QString OAIAPISchool10Full::getHighGrade() const {
    return m_high_grade;
}
void OAIAPISchool10Full::setHighGrade(const QString &high_grade) {
    m_high_grade = high_grade;
    m_high_grade_isSet = true;
}

bool OAIAPISchool10Full::is_high_grade_Set() const{
    return m_high_grade_isSet;
}

bool OAIAPISchool10Full::is_high_grade_Valid() const{
    return m_high_grade_isValid;
}

QString OAIAPISchool10Full::getIsCharterSchool() const {
    return m_is_charter_school;
}
void OAIAPISchool10Full::setIsCharterSchool(const QString &is_charter_school) {
    m_is_charter_school = is_charter_school;
    m_is_charter_school_isSet = true;
}

bool OAIAPISchool10Full::is_is_charter_school_Set() const{
    return m_is_charter_school_isSet;
}

bool OAIAPISchool10Full::is_is_charter_school_Valid() const{
    return m_is_charter_school_isValid;
}

QString OAIAPISchool10Full::getIsMagnetSchool() const {
    return m_is_magnet_school;
}
void OAIAPISchool10Full::setIsMagnetSchool(const QString &is_magnet_school) {
    m_is_magnet_school = is_magnet_school;
    m_is_magnet_school_isSet = true;
}

bool OAIAPISchool10Full::is_is_magnet_school_Set() const{
    return m_is_magnet_school_isSet;
}

bool OAIAPISchool10Full::is_is_magnet_school_Valid() const{
    return m_is_magnet_school_isValid;
}

bool OAIAPISchool10Full::isIsPrivate() const {
    return m_is_private;
}
void OAIAPISchool10Full::setIsPrivate(const bool &is_private) {
    m_is_private = is_private;
    m_is_private_isSet = true;
}

bool OAIAPISchool10Full::is_is_private_Set() const{
    return m_is_private_isSet;
}

bool OAIAPISchool10Full::is_is_private_Valid() const{
    return m_is_private_isValid;
}

QString OAIAPISchool10Full::getIsTitleISchool() const {
    return m_is_title_i_school;
}
void OAIAPISchool10Full::setIsTitleISchool(const QString &is_title_i_school) {
    m_is_title_i_school = is_title_i_school;
    m_is_title_i_school_isSet = true;
}

bool OAIAPISchool10Full::is_is_title_i_school_Set() const{
    return m_is_title_i_school_isSet;
}

bool OAIAPISchool10Full::is_is_title_i_school_Valid() const{
    return m_is_title_i_school_isValid;
}

QString OAIAPISchool10Full::getIsTitleISchoolwideSchool() const {
    return m_is_title_i_schoolwide_school;
}
void OAIAPISchool10Full::setIsTitleISchoolwideSchool(const QString &is_title_i_schoolwide_school) {
    m_is_title_i_schoolwide_school = is_title_i_schoolwide_school;
    m_is_title_i_schoolwide_school_isSet = true;
}

bool OAIAPISchool10Full::is_is_title_i_schoolwide_school_Set() const{
    return m_is_title_i_schoolwide_school_isSet;
}

bool OAIAPISchool10Full::is_is_title_i_schoolwide_school_Valid() const{
    return m_is_title_i_schoolwide_school_isValid;
}

QString OAIAPISchool10Full::getIsVirtualSchool() const {
    return m_is_virtual_school;
}
void OAIAPISchool10Full::setIsVirtualSchool(const QString &is_virtual_school) {
    m_is_virtual_school = is_virtual_school;
    m_is_virtual_school_isSet = true;
}

bool OAIAPISchool10Full::is_is_virtual_school_Set() const{
    return m_is_virtual_school_isSet;
}

bool OAIAPISchool10Full::is_is_virtual_school_Valid() const{
    return m_is_virtual_school_isValid;
}

QString OAIAPISchool10Full::getLocale() const {
    return m_locale;
}
void OAIAPISchool10Full::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIAPISchool10Full::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIAPISchool10Full::is_locale_Valid() const{
    return m_locale_isValid;
}

QString OAIAPISchool10Full::getLowGrade() const {
    return m_low_grade;
}
void OAIAPISchool10Full::setLowGrade(const QString &low_grade) {
    m_low_grade = low_grade;
    m_low_grade_isSet = true;
}

bool OAIAPISchool10Full::is_low_grade_Set() const{
    return m_low_grade_isSet;
}

bool OAIAPISchool10Full::is_low_grade_Valid() const{
    return m_low_grade_isValid;
}

QString OAIAPISchool10Full::getPhone() const {
    return m_phone;
}
void OAIAPISchool10Full::setPhone(const QString &phone) {
    m_phone = phone;
    m_phone_isSet = true;
}

bool OAIAPISchool10Full::is_phone_Set() const{
    return m_phone_isSet;
}

bool OAIAPISchool10Full::is_phone_Valid() const{
    return m_phone_isValid;
}

QString OAIAPISchool10Full::getPrivateCoed() const {
    return m_private_coed;
}
void OAIAPISchool10Full::setPrivateCoed(const QString &private_coed) {
    m_private_coed = private_coed;
    m_private_coed_isSet = true;
}

bool OAIAPISchool10Full::is_private_coed_Set() const{
    return m_private_coed_isSet;
}

bool OAIAPISchool10Full::is_private_coed_Valid() const{
    return m_private_coed_isValid;
}

qint32 OAIAPISchool10Full::getPrivateDays() const {
    return m_private_days;
}
void OAIAPISchool10Full::setPrivateDays(const qint32 &private_days) {
    m_private_days = private_days;
    m_private_days_isSet = true;
}

bool OAIAPISchool10Full::is_private_days_Set() const{
    return m_private_days_isSet;
}

bool OAIAPISchool10Full::is_private_days_Valid() const{
    return m_private_days_isValid;
}

bool OAIAPISchool10Full::isPrivateHasLibrary() const {
    return m_private_has_library;
}
void OAIAPISchool10Full::setPrivateHasLibrary(const bool &private_has_library) {
    m_private_has_library = private_has_library;
    m_private_has_library_isSet = true;
}

bool OAIAPISchool10Full::is_private_has_library_Set() const{
    return m_private_has_library_isSet;
}

bool OAIAPISchool10Full::is_private_has_library_Valid() const{
    return m_private_has_library_isValid;
}

double OAIAPISchool10Full::getPrivateHours() const {
    return m_private_hours;
}
void OAIAPISchool10Full::setPrivateHours(const double &private_hours) {
    m_private_hours = private_hours;
    m_private_hours_isSet = true;
}

bool OAIAPISchool10Full::is_private_hours_Set() const{
    return m_private_hours_isSet;
}

bool OAIAPISchool10Full::is_private_hours_Valid() const{
    return m_private_hours_isValid;
}

QString OAIAPISchool10Full::getPrivateOrientation() const {
    return m_private_orientation;
}
void OAIAPISchool10Full::setPrivateOrientation(const QString &private_orientation) {
    m_private_orientation = private_orientation;
    m_private_orientation_isSet = true;
}

bool OAIAPISchool10Full::is_private_orientation_Set() const{
    return m_private_orientation_isSet;
}

bool OAIAPISchool10Full::is_private_orientation_Valid() const{
    return m_private_orientation_isValid;
}

QList<OAIAPIRankHistory> OAIAPISchool10Full::getRankHistory() const {
    return m_rank_history;
}
void OAIAPISchool10Full::setRankHistory(const QList<OAIAPIRankHistory> &rank_history) {
    m_rank_history = rank_history;
    m_rank_history_isSet = true;
}

bool OAIAPISchool10Full::is_rank_history_Set() const{
    return m_rank_history_isSet;
}

bool OAIAPISchool10Full::is_rank_history_Valid() const{
    return m_rank_history_isValid;
}

qint32 OAIAPISchool10Full::getRankMovement() const {
    return m_rank_movement;
}
void OAIAPISchool10Full::setRankMovement(const qint32 &rank_movement) {
    m_rank_movement = rank_movement;
    m_rank_movement_isSet = true;
}

bool OAIAPISchool10Full::is_rank_movement_Set() const{
    return m_rank_movement_isSet;
}

bool OAIAPISchool10Full::is_rank_movement_Valid() const{
    return m_rank_movement_isValid;
}

QString OAIAPISchool10Full::getSchoolLevel() const {
    return m_school_level;
}
void OAIAPISchool10Full::setSchoolLevel(const QString &school_level) {
    m_school_level = school_level;
    m_school_level_isSet = true;
}

bool OAIAPISchool10Full::is_school_level_Set() const{
    return m_school_level_isSet;
}

bool OAIAPISchool10Full::is_school_level_Valid() const{
    return m_school_level_isValid;
}

QString OAIAPISchool10Full::getSchoolName() const {
    return m_school_name;
}
void OAIAPISchool10Full::setSchoolName(const QString &school_name) {
    m_school_name = school_name;
    m_school_name_isSet = true;
}

bool OAIAPISchool10Full::is_school_name_Set() const{
    return m_school_name_isSet;
}

bool OAIAPISchool10Full::is_school_name_Valid() const{
    return m_school_name_isValid;
}

QList<OAIAPIYearlyDemographics> OAIAPISchool10Full::getSchoolYearlyDetails() const {
    return m_school_yearly_details;
}
void OAIAPISchool10Full::setSchoolYearlyDetails(const QList<OAIAPIYearlyDemographics> &school_yearly_details) {
    m_school_yearly_details = school_yearly_details;
    m_school_yearly_details_isSet = true;
}

bool OAIAPISchool10Full::is_school_yearly_details_Set() const{
    return m_school_yearly_details_isSet;
}

bool OAIAPISchool10Full::is_school_yearly_details_Valid() const{
    return m_school_yearly_details_isValid;
}

QString OAIAPISchool10Full::getSchoolid() const {
    return m_schoolid;
}
void OAIAPISchool10Full::setSchoolid(const QString &schoolid) {
    m_schoolid = schoolid;
    m_schoolid_isSet = true;
}

bool OAIAPISchool10Full::is_schoolid_Set() const{
    return m_schoolid_isSet;
}

bool OAIAPISchool10Full::is_schoolid_Valid() const{
    return m_schoolid_isValid;
}

QList<OAIAPITestScoreWrapper> OAIAPISchool10Full::getTestScores() const {
    return m_test_scores;
}
void OAIAPISchool10Full::setTestScores(const QList<OAIAPITestScoreWrapper> &test_scores) {
    m_test_scores = test_scores;
    m_test_scores_isSet = true;
}

bool OAIAPISchool10Full::is_test_scores_Set() const{
    return m_test_scores_isSet;
}

bool OAIAPISchool10Full::is_test_scores_Valid() const{
    return m_test_scores_isValid;
}

QString OAIAPISchool10Full::getUrl() const {
    return m_url;
}
void OAIAPISchool10Full::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIAPISchool10Full::is_url_Set() const{
    return m_url_isSet;
}

bool OAIAPISchool10Full::is_url_Valid() const{
    return m_url_isValid;
}

QString OAIAPISchool10Full::getUrlCompare() const {
    return m_url_compare;
}
void OAIAPISchool10Full::setUrlCompare(const QString &url_compare) {
    m_url_compare = url_compare;
    m_url_compare_isSet = true;
}

bool OAIAPISchool10Full::is_url_compare_Set() const{
    return m_url_compare_isSet;
}

bool OAIAPISchool10Full::is_url_compare_Valid() const{
    return m_url_compare_isValid;
}

bool OAIAPISchool10Full::isSet() const {
...
bool OAIAPISchool10Full::isValid() const {
