...
/**
 * The APIDistrict1Summary model module.
 * @module model/APIDistrict1Summary
 * @version v1
 */
class APIDistrict1Summary {
    /**
     * Constructs a new <code>APIDistrict1Summary</code>.
     * @alias module:model/APIDistrict1Summary
     */
    constructor() { 
        
        APIDistrict1Summary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>APIDistrict1Summary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/APIDistrict1Summary} obj Optional instance to populate.
     * @return {module:model/APIDistrict1Summary} The populated <code>APIDistrict1Summary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new APIDistrict1Summary();
    ...
    /**
     * Validates the JSON data with respect to <code>APIDistrict1Summary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>APIDistrict1Summary</code>.
     */
 ...
 */
APIDistrict1Summary.prototype['address'] = undefined;

/**
 * @member {module:model/APICounty} county
 */
APIDistrict1Summary.prototype['county'] = undefined;

/**
 * Distance from nearLatitude/nearLongitude (if supplied)
 * @member {Number} distance
 */
APIDistrict1Summary.prototype['distance'] = undefined;
 ...
 */
APIDistrict1Summary.prototype['districtID'] = undefined;

/**
 * District name
 * @member {String} districtName
 */
APIDistrict1Summary.prototype['districtName'] = undefined;

/**
 * District yearly metrics
 * @member {Array.<module:model/APILEAYearlyDetail>} districtYearlyDetails
 */
APIDistrict1Summary.prototype['districtYearlyDetails'] = undefined;
 ...
 */
APIDistrict1Summary.prototype['hasBoundary'] = undefined;

/**
 * The high grade served by this district
 * @member {String} highGrade
 */
APIDistrict1Summary.prototype['highGrade'] = undefined;
 ...
 */
APIDistrict1Summary.prototype['isWithinBoundary'] = undefined;
...
export default APIDistrict1Summary;
