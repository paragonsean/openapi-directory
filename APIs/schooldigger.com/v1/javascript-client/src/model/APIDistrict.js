...
/**
 * The APIDistrict model module.
 * @module model/APIDistrict
 * @version v1
 */
class APIDistrict {
    /**
     * Constructs a new <code>APIDistrict</code>.
     * @alias module:model/APIDistrict
     */
    constructor() { 
        
        APIDistrict.initialize(this);
    }
    ...
    /**
     * Constructs a <code>APIDistrict</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/APIDistrict} obj Optional instance to populate.
     * @return {module:model/APIDistrict} The populated <code>APIDistrict</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new APIDistrict();
    ...
    /**
     * Validates the JSON data with respect to <code>APIDistrict</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>APIDistrict</code>.
     */
 ...
 */
APIDistrict.prototype['isWithinBoundary'] = undefined;

/**
 * The low grade served by this district (PK = Prekindergarten, K = Kindergarten)
 * @member {String} lowGrade
 */
APIDistrict.prototype['lowGrade'] = undefined;

/**
 * @member {Number} numberAlternativeSchools
 */
APIDistrict.prototype['numberAlternativeSchools'] = undefined;

/**
 * @member {Number} numberHighSchools
 */
APIDistrict.prototype['numberHighSchools'] = undefined;

/**
 * @member {Number} numberMiddleSchools
 */
APIDistrict.prototype['numberMiddleSchools'] = undefined;

/**
 * @member {Number} numberPrimarySchools
 */
APIDistrict.prototype['numberPrimarySchools'] = undefined;

/**
 * @member {Number} numberTotalSchools
 */
APIDistrict.prototype['numberTotalSchools'] = undefined;

/**
 * District phone number
 * @member {String} phone
 */
APIDistrict.prototype['phone'] = undefined;

/**
 * SchoolDigger yearly rank history of the district
 * @member {Array.<module:model/APILEARankHistory>} rankHistory
 */
APIDistrict.prototype['rankHistory'] = undefined;
 ...
 */
APIDistrict.prototype['testScores'] = undefined;

/**
 * SchoolDigger URL for this district
 * @member {String} url
 */
APIDistrict.prototype['url'] = undefined;
