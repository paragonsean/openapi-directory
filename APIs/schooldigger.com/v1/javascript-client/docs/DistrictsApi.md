# SchoolDiggerApiV1.DistrictsApi
...
> APIDistrictList districtsGetAllDistricts(st, appID, appKey, opts)
...
let apiInstance = new SchoolDiggerApiV1.DistrictsApi();
...
apiInstance.districtsGetAllDistricts(st, appID, appKey, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let appID = "appID_example"; // String | Your API app id
let appKey = "appKey_example"; // String | Your API app key
apiInstance.districtsGetDistrict(id, appID, appKey, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
