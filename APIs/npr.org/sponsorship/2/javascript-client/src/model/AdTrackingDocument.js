...
import AdTrackingData from './AdTrackingData';
import CollectionDocument from './CollectionDocument';

/**
 * The AdTrackingDocument model module.
 * @module model/AdTrackingDocument
 * @version 2
 */
class AdTrackingDocument {
    /**
     * Constructs a new <code>AdTrackingDocument</code>.
     ...
     * @alias module:model/AdTrackingDocument
     * @implements module:model/CollectionDocument
     * @param attributes {module:model/AdTrackingData} 
    ...
    constructor(attributes, errors, href, items, links, version) { 
        ...
        AdTrackingDocument.initialize(this, attributes, errors, href, items, links, version);
    }
    ...
    /**
     * Constructs a <code>AdTrackingDocument</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdTrackingDocument} obj Optional instance to populate.
     * @return {module:model/AdTrackingDocument} The populated <code>AdTrackingDocument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdTrackingDocument();
            CollectionDocument.constructFromObject(data, obj);

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = AdTrackingData.constructFromObject(data['attributes']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AdTrackingDocument</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdTrackingDocument</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdTrackingDocument.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          AdTrackingData.validateJSON(data['attributes']);
        }
...
AdTrackingDocument.RequiredProperties = ["attributes", "errors", "href", "items", "links", "version"];

/**
 * @member {module:model/AdTrackingData} attributes
 */
AdTrackingDocument.prototype['attributes'] = undefined;

/**
 * A list of encountered errors, ignored on POST, PUT
 * @member {Array.<Object>} errors
 */
AdTrackingDocument.prototype['errors'] = undefined;

/**
 * A URL representation of the resource; should generally be ignored by clients unless noted otherwise
 * @member {String} href
 */
AdTrackingDocument.prototype['href'] = undefined;

/**
 * Not used
 * @member {Array.<Object>} items
 */
AdTrackingDocument.prototype['items'] = undefined;

/**
 * @member {Object} links
 */
AdTrackingDocument.prototype['links'] = undefined;
 ...
 * @default '1.0'
 */
AdTrackingDocument.prototype['version'] = '1.0';
...
export default AdTrackingDocument;
