...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NprListeningService.SearchMetaData();
  });
  ...
  describe('SearchMetaData', function() {
    it('should create an instance of SearchMetaData', function() {
      ...
      //var instance = new NprListeningService.SearchMetaData();
      //expect(instance).to.be.a(NprListeningService.SearchMetaData);
    });
