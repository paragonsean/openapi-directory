...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NprListeningService.AudioLink();
  });
  ...
  describe('AudioLink', function() {
    it('should create an instance of AudioLink', function() {
      // uncomment below and update the code to test AudioLink
      //var instance = new NprListeningService.AudioLink();
      //expect(instance).to.be.a(NprListeningService.AudioLink);
    });
