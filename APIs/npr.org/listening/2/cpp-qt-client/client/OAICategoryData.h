...
#ifndef OAICategoryData_H
#define OAICategoryData_H
...
class OAICategoryData : public OAIObject {
public:
    OAICategoryData();
    OAICategoryData(QString json);
    ~OAICategoryData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICategoryData)

#endif // OAICategoryData_H
