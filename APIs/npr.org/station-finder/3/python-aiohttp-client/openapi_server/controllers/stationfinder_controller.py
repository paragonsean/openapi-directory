...
async def get_station_by_id(request: web.Request, authorization, station_id) -> web.Response:
    ...
    :param station_id: The numeric ID of a station
    :type station_id: int
...
async def search_stations(request: web.Request, authorization, q=None, city=None, state=None, lat=None, lon=None) -> web.Response:
    ...
    :param authorization: Your access token from the Authorization Service. Should start with &#x60;Bearer&#x60;, followed by a space, followed by the token.
    :type authorization: str
    :param q: Search terms to search on; can be a station name, network name, call letters, or zipcode
    :type q: str
    :param city: A city to look for stations from; intended to be paired with &#x60;state&#x60;
    :type city: str
    :param state: A state to look for stations from (using the 2-letter abbreviation); intended to be paired with &#x60;city&#x60;
    :type state: str
    :param lat: A latitude value from a geographic coordinate system; only works if paired with &#x60;lon&#x60;
    :type lat: float
    :param lon: A longitude value from a geographic coordinate system; only works if paired with &#x60;lat&#x60;
    :type lon: float
