...
/*
 * OAIStationDonationLink.h
 *
 * A link to a pledge page for the station
 */

#ifndef OAIStationDonationLink_H
#define OAIStationDonationLink_H
...
class OAIStationDonationLink : public OAIObject {
public:
    OAIStationDonationLink();
    OAIStationDonationLink(QString json);
    ~OAIStationDonationLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStationDonationLink)

#endif // OAIStationDonationLink_H
