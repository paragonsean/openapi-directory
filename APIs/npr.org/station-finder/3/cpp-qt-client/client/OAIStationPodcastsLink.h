...
/*
 * OAIStationPodcastsLink.h
 *
 * A link to an audio podcast or podcast feed related to the station
 */

#ifndef OAIStationPodcastsLink_H
#define OAIStationPodcastsLink_H
...
class OAIStationPodcastsLink : public OAIObject {
public:
    OAIStationPodcastsLink();
    OAIStationPodcastsLink(QString json);
    ~OAIStationPodcastsLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStationPodcastsLink)

#endif // OAIStationPodcastsLink_H
