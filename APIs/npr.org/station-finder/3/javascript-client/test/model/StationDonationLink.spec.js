...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NprStationFinderService.StationDonationLink();
  });
  ...
  describe('StationDonationLink', function() {
    it('should create an instance of StationDonationLink', function() {
      // uncomment below and update the code to test StationDonationLink
      //var instance = new NprStationFinderService.StationDonationLink();
      //expect(instance).to.be.a(NprStationFinderService.StationDonationLink);
    });
