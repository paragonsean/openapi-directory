...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NprStationFinderService.StationRelatedLink();
  });
  ...
  describe('StationRelatedLink', function() {
    it('should create an instance of StationRelatedLink', function() {
      // uncomment below and update the code to test StationRelatedLink
      //var instance = new NprStationFinderService.StationRelatedLink();
      //expect(instance).to.be.a(NprStationFinderService.StationRelatedLink);
    });
