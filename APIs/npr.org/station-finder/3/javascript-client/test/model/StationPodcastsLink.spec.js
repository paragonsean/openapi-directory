...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NprStationFinderService.StationPodcastsLink();
  });
  ...
  describe('StationPodcastsLink', function() {
    it('should create an instance of StationPodcastsLink', function() {
      // uncomment below and update the code to test StationPodcastsLink
      //var instance = new NprStationFinderService.StationPodcastsLink();
      //expect(instance).to.be.a(NprStationFinderService.StationPodcastsLink);
    });
