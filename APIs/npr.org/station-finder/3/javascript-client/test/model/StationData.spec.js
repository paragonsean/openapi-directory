...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NprStationFinderService.StationData();
  });
  ...
  describe('StationData', function() {
    it('should create an instance of StationData', function() {
      // uncomment below and update the code to test StationData
      //var instance = new NprStationFinderService.StationData();
      //expect(instance).to.be.a(NprStationFinderService.StationData);
    });
    ...
    it('should have the property newscast (base name: "newscast")', function() {
      // uncomment below and update the code to test the property newscast
      //var instance = new NprStationFinderService.StationData();
      //expect(instance).to.be();
    });
