# NprAuthorizationService.AccessTokenData
...
**expiresIn** | **Number** | The remaining lifetime of the access token (in seconds) | 
...
**tokenType** | **String** | Identifies the type of token returned. At this time, this field always has the value &#x60;Bearer&#x60;. | 
