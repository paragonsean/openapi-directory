...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NprAuthorizationService.AccessTokenData();
  });
  ...
  describe('AccessTokenData', function() {
    it('should create an instance of AccessTokenData', function() {
      // uncomment below and update the code to test AccessTokenData
      //var instance = new NprAuthorizationService.AccessTokenData();
      //expect(instance).to.be.a(NprAuthorizationService.AccessTokenData);
    });
