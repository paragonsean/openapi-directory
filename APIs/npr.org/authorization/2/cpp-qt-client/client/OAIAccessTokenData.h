...
/*
 * OAIAccessTokenData.h
 *
 * 
 */

#ifndef OAIAccessTokenData_H
#define OAIAccessTokenData_H
...
class OAIAccessTokenData : public OAIObject {
public:
    OAIAccessTokenData();
    OAIAccessTokenData(QString json);
    ~OAIAccessTokenData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessTokenData)

#endif // OAIAccessTokenData_H
