...
class Affiliation(Model):
    ...
    def __init__(self, days_since_last_listen: int=None, following: bool=False, href: str=None, id: str=None, notif_following: List[str]=None, notif_rated: List[str]=None, rating: float=None, title: str=None):
