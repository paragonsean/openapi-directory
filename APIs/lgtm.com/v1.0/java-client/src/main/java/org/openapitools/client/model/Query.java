...
public class Query {
  ...
  public static final String SERIALIZED_NAME_PACK = "pack";
  @SerializedName(SERIALIZED_NAME_PACK)
  private String pack;
  ...
  public Query properties(QueryProperties properties) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, query.id) &&
        Objects.equals(this.language, query.language) &&
        Objects.equals(this.name, query.name) &&
        Objects.equals(this.pack, query.pack) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, language, name, pack, properties, url);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("pack") != null && !jsonObj.get("pack").isJsonNull()) && !jsonObj.get("pack").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `pack` to be a primitive type in the JSON string but got `%s`", jsonObj.get("pack").toString()));
      }
      // validate the optional field `properties`
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        QueryProperties.validateJsonElement(jsonObj.get("properties"));
      }
