...
/**
 * The LanguageStats model module.
 * @module model/LanguageStats
 * @version v1.0
 */
class LanguageStats {
    /**
     * Constructs a new <code>LanguageStats</code>.
     * @alias module:model/LanguageStats
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>LanguageStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LanguageStats} obj Optional instance to populate.
     * @return {module:model/LanguageStats} The populated <code>LanguageStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LanguageStats();
    ...
    /**
     * Validates the JSON data with respect to <code>LanguageStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LanguageStats</code>.
     */
