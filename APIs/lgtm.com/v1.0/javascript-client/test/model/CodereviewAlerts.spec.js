...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LgtmApiSpecification.CodereviewAlerts();
  });
  ...
  describe('CodereviewAlerts', function() {
    it('should create an instance of CodereviewAlerts', function() {
      // uncomment below and update the code to test CodereviewAlerts
      //var instance = new LgtmApiSpecification.CodereviewAlerts();
      //expect(instance).to.be.a(LgtmApiSpecification.CodereviewAlerts);
    });
