...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LgtmApiSpecification.Measurement();
  });
  ...
  describe('Measurement', function() {
    it('should create an instance of Measurement', function() {
      ...
      //var instance = new LgtmApiSpecification.Measurement();
      //expect(instance).to.be.a(LgtmApiSpecification.Measurement);
    });
