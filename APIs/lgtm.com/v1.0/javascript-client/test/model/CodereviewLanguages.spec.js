...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LgtmApiSpecification.CodereviewLanguages();
  });
  ...
  describe('CodereviewLanguages', function() {
    it('should create an instance of CodereviewLanguages', function() {
      // uncomment below and update the code to test CodereviewLanguages
      //var instance = new LgtmApiSpecification.CodereviewLanguages();
      //expect(instance).to.be.a(LgtmApiSpecification.CodereviewLanguages);
    });
