...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LgtmApiSpecification.Metric();
  });
  ...
  describe('Metric', function() {
    it('should create an instance of Metric', function() {
      ...
      //var instance = new LgtmApiSpecification.Metric();
      //expect(instance).to.be.a(LgtmApiSpecification.Metric);
    });
    ...
    it('should have the property metricId (base name: "metric-id")', function() {
