...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LgtmApiSpecification.ProjectList();
  });
  ...
  describe('ProjectList', function() {
    it('should create an instance of ProjectList', function() {
      ...
      //var instance = new LgtmApiSpecification.ProjectList();
      //expect(instance).to.be.a(LgtmApiSpecification.ProjectList);
    });
