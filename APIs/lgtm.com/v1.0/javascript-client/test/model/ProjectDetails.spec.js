...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LgtmApiSpecification.ProjectDetails();
  });
  ...
  describe('ProjectDetails', function() {
    it('should create an instance of ProjectDetails', function() {
      ...
      //var instance = new LgtmApiSpecification.ProjectDetails();
      //expect(instance).to.be.a(LgtmApiSpecification.ProjectDetails);
    });
    ...
    it('should have the property urlIdentifier (base name: "url-identifier")', function() {
      // uncomment below and update the code to test the property urlIdentifier
      //var instance = new LgtmApiSpecification.ProjectDetails();
      //expect(instance).to.be();
    });
