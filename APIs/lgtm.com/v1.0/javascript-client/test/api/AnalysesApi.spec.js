...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LgtmApiSpecification.AnalysesApi();
  });
  ...
  describe('AnalysesApi', function() {
    ...
    describe('getAnalysisForCommit', function() {
      it('should call getAnalysisForCommit successfully', function(done) {
        //uncomment below and update the code to test getAnalysisForCommit
        //instance.getAnalysisForCommit(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('requestAnalysis', function() {
      it('should call requestAnalysis successfully', function(done) {
        //uncomment below and update the code to test requestAnalysis
        //instance.requestAnalysis(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
