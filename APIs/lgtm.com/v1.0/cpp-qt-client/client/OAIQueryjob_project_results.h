...
/*
 * OAIQueryjob_project_results.h
 *
 * 
 */

#ifndef OAIQueryjob_project_results_H
#define OAIQueryjob_project_results_H
...
namespace OpenAPI {
class OAIQuery_result_entry;
class OAIProject;

class OAIQueryjob_project_results : public OAIObject {
public:
    OAIQueryjob_project_results();
    OAIQueryjob_project_results(QString json);
    ~OAIQueryjob_project_results() override;
    ...
    QList<QList<OAIQuery_result_entry>> getData() const;
    void setData(const QList<QList<OAIQuery_result_entry>> &data);
...
private:
    ...
    QList<QList<OAIQuery_result_entry>> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueryjob_project_results)

#endif // OAIQueryjob_project_results_H
