...
#ifndef OAISubAccountDto_H
#define OAISubAccountDto_H
...
class OAISubAccountDto : public OAIObject {
public:
    OAISubAccountDto();
    OAISubAccountDto(QString json);
    ~OAISubAccountDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubAccountDto)

#endif // OAISubAccountDto_H
