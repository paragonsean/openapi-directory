...
/*
 * OAIInventoryReceiptDto.h
 *
 * This class represents a inventory issue in InventoryIssueController. Used by getting data.
 */

#ifndef OAIInventoryReceiptDto_H
#define OAIInventoryReceiptDto_H

#include <QJsonObject>

#include "OAIAttachmentDto.h"
#include "OAIBranchNumberInInventoryReceiptDto.h"
...
class OAIBranchNumberInInventoryReceiptDto;
class OAIMetadataDto;
class OAIInventoryReceiptLineDto;

class OAIInventoryReceiptDto : public OAIObject {
public:
    OAIInventoryReceiptDto();
    OAIInventoryReceiptDto(QString json);
    ~OAIInventoryReceiptDto() override;
    ...
    OAIBranchNumberInInventoryReceiptDto getBranchNumber() const;
    void setBranchNumber(const OAIBranchNumberInInventoryReceiptDto &branch_number);
    bool is_branch_number_Set() const;
    bool is_branch_number_Valid() const;

    double getControlCost() const;
    void setControlCost(const double &control_cost);
    ...
    QList<OAIInventoryReceiptLineDto> getReceiptLines() const;
    void setReceiptLines(const QList<OAIInventoryReceiptLineDto> &receipt_lines);
...
private:
    ...
    OAIBranchNumberInInventoryReceiptDto m_branch_number;
    bool m_branch_number_isSet;
    bool m_branch_number_isValid;

    double m_control_cost;
    ...
    QList<OAIInventoryReceiptLineDto> m_receipt_lines;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryReceiptDto)

#endif // OAIInventoryReceiptDto_H
