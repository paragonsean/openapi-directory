...
/*
 * OAIPaymentMethodQueryParameters.h
 *
 * 
 */

#ifndef OAIPaymentMethodQueryParameters_H
#define OAIPaymentMethodQueryParameters_H
...
class OAIPaymentMethodQueryParameters : public OAIObject {
public:
    OAIPaymentMethodQueryParameters();
    OAIPaymentMethodQueryParameters(QString json);
    ~OAIPaymentMethodQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentMethodQueryParameters)

#endif // OAIPaymentMethodQueryParameters_H
