...
/*
 * OAIPaymentQueryParameters.h
 *
 * 
 */

#ifndef OAIPaymentQueryParameters_H
#define OAIPaymentQueryParameters_H
...
class OAIPaymentQueryParameters : public OAIObject {
public:
    OAIPaymentQueryParameters();
    OAIPaymentQueryParameters(QString json);
    ~OAIPaymentQueryParameters() override;
    ...
    QString getPaymentNbr() const;
    void setPaymentNbr(const QString &payment_nbr);
    bool is_payment_nbr_Set() const;
    bool is_payment_nbr_Valid() const;
...
private:
    ...
    QString m_payment_nbr;
    bool m_payment_nbr_isSet;
    bool m_payment_nbr_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentQueryParameters)

#endif // OAIPaymentQueryParameters_H
