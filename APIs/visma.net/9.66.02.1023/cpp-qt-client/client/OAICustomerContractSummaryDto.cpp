...
OAICustomerContractSummaryDto::OAICustomerContractSummaryDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomerContractSummaryDto::OAICustomerContractSummaryDto() {
    this->initializeModel();
}

OAICustomerContractSummaryDto::~OAICustomerContractSummaryDto() {}

void OAICustomerContractSummaryDto::initializeModel() {
...
void OAICustomerContractSummaryDto::fromJson(QString jsonString) {
...
void OAICustomerContractSummaryDto::fromJsonObject(QJsonObject json) {
...
QString OAICustomerContractSummaryDto::asJson() const {
...
QJsonObject OAICustomerContractSummaryDto::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAICustomerContractSummaryDto::getActivationDate() const {
    return m_activation_date;
}
void OAICustomerContractSummaryDto::setActivationDate(const QDateTime &activation_date) {
    m_activation_date = activation_date;
    m_activation_date_isSet = true;
}

bool OAICustomerContractSummaryDto::is_activation_date_Set() const{
    return m_activation_date_isSet;
}

bool OAICustomerContractSummaryDto::is_activation_date_Valid() const{
    return m_activation_date_isValid;
}

OAICaseCountItemInCustomerContractSummaryDto OAICustomerContractSummaryDto::getCaseCountItem() const {
    return m_case_count_item;
}
void OAICustomerContractSummaryDto::setCaseCountItem(const OAICaseCountItemInCustomerContractSummaryDto &case_count_item) {
    m_case_count_item = case_count_item;
    m_case_count_item_isSet = true;
}

bool OAICustomerContractSummaryDto::is_case_count_item_Set() const{
    return m_case_count_item_isSet;
}

bool OAICustomerContractSummaryDto::is_case_count_item_Valid() const{
    return m_case_count_item_isValid;
}

QString OAICustomerContractSummaryDto::getCurrency() const {
    return m_currency;
}
void OAICustomerContractSummaryDto::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAICustomerContractSummaryDto::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAICustomerContractSummaryDto::is_currency_Valid() const{
    return m_currency_isValid;
}

QDateTime OAICustomerContractSummaryDto::getExpirationDate() const {
    return m_expiration_date;
}
void OAICustomerContractSummaryDto::setExpirationDate(const QDateTime &expiration_date) {
    m_expiration_date = expiration_date;
    m_expiration_date_isSet = true;
}

bool OAICustomerContractSummaryDto::is_expiration_date_Set() const{
    return m_expiration_date_isSet;
}

bool OAICustomerContractSummaryDto::is_expiration_date_Valid() const{
    return m_expiration_date_isValid;
}

qint32 OAICustomerContractSummaryDto::getGracePeriod() const {
    return m_grace_period;
}
void OAICustomerContractSummaryDto::setGracePeriod(const qint32 &grace_period) {
    m_grace_period = grace_period;
    m_grace_period_isSet = true;
}

bool OAICustomerContractSummaryDto::is_grace_period_Set() const{
    return m_grace_period_isSet;
}

bool OAICustomerContractSummaryDto::is_grace_period_Valid() const{
    return m_grace_period_isValid;
}

OAIInvoiceAccountInCustomerContractSummaryDto OAICustomerContractSummaryDto::getInvoiceAccount() const {
    return m_invoice_account;
}
void OAICustomerContractSummaryDto::setInvoiceAccount(const OAIInvoiceAccountInCustomerContractSummaryDto &invoice_account) {
    m_invoice_account = invoice_account;
    m_invoice_account_isSet = true;
}

bool OAICustomerContractSummaryDto::is_invoice_account_Set() const{
    return m_invoice_account_isSet;
}

bool OAICustomerContractSummaryDto::is_invoice_account_Valid() const{
    return m_invoice_account_isValid;
}

OAILocationNameDescriptionDto OAICustomerContractSummaryDto::getInvoiceLocation() const {
    return m_invoice_location;
}
void OAICustomerContractSummaryDto::setInvoiceLocation(const OAILocationNameDescriptionDto &invoice_location) {
    m_invoice_location = invoice_location;
    m_invoice_location_isSet = true;
}

bool OAICustomerContractSummaryDto::is_invoice_location_Set() const{
    return m_invoice_location_isSet;
}

bool OAICustomerContractSummaryDto::is_invoice_location_Valid() const{
    return m_invoice_location_isValid;
}

QString OAICustomerContractSummaryDto::getInvoiceTo() const {
    return m_invoice_to;
}
void OAICustomerContractSummaryDto::setInvoiceTo(const QString &invoice_to) {
    m_invoice_to = invoice_to;
    m_invoice_to_isSet = true;
}

bool OAICustomerContractSummaryDto::is_invoice_to_Set() const{
    return m_invoice_to_isSet;
}

bool OAICustomerContractSummaryDto::is_invoice_to_Valid() const{
    return m_invoice_to_isValid;
}

QString OAICustomerContractSummaryDto::getInvoicingPeriod() const {
    return m_invoicing_period;
}
void OAICustomerContractSummaryDto::setInvoicingPeriod(const QString &invoicing_period) {
    m_invoicing_period = invoicing_period;
    m_invoicing_period_isSet = true;
}

bool OAICustomerContractSummaryDto::is_invoicing_period_Set() const{
    return m_invoicing_period_isSet;
}

bool OAICustomerContractSummaryDto::is_invoicing_period_Valid() const{
    return m_invoicing_period_isValid;
}

QDateTime OAICustomerContractSummaryDto::getInvoicingScheduleStartsOn() const {
    return m_invoicing_schedule_starts_on;
}
void OAICustomerContractSummaryDto::setInvoicingScheduleStartsOn(const QDateTime &invoicing_schedule_starts_on) {
    m_invoicing_schedule_starts_on = invoicing_schedule_starts_on;
    m_invoicing_schedule_starts_on_isSet = true;
}

bool OAICustomerContractSummaryDto::is_invoicing_schedule_starts_on_Set() const{
    return m_invoicing_schedule_starts_on_isSet;
}

bool OAICustomerContractSummaryDto::is_invoicing_schedule_starts_on_Valid() const{
    return m_invoicing_schedule_starts_on_isValid;
}

QDateTime OAICustomerContractSummaryDto::getLastInvoicingDate() const {
    return m_last_invoicing_date;
}
void OAICustomerContractSummaryDto::setLastInvoicingDate(const QDateTime &last_invoicing_date) {
    m_last_invoicing_date = last_invoicing_date;
    m_last_invoicing_date_isSet = true;
}

bool OAICustomerContractSummaryDto::is_last_invoicing_date_Set() const{
    return m_last_invoicing_date_isSet;
}

bool OAICustomerContractSummaryDto::is_last_invoicing_date_Valid() const{
    return m_last_invoicing_date_isValid;
}

bool OAICustomerContractSummaryDto::isMassRenewal() const {
    return m_mass_renewal;
}
void OAICustomerContractSummaryDto::setMassRenewal(const bool &mass_renewal) {
    m_mass_renewal = mass_renewal;
    m_mass_renewal_isSet = true;
}

bool OAICustomerContractSummaryDto::is_mass_renewal_Set() const{
    return m_mass_renewal_isSet;
}

bool OAICustomerContractSummaryDto::is_mass_renewal_Valid() const{
    return m_mass_renewal_isValid;
}

QDateTime OAICustomerContractSummaryDto::getNextInvoicingDate() const {
    return m_next_invoicing_date;
}
void OAICustomerContractSummaryDto::setNextInvoicingDate(const QDateTime &next_invoicing_date) {
    m_next_invoicing_date = next_invoicing_date;
    m_next_invoicing_date_isSet = true;
}

bool OAICustomerContractSummaryDto::is_next_invoicing_date_Set() const{
    return m_next_invoicing_date_isSet;
}

bool OAICustomerContractSummaryDto::is_next_invoicing_date_Valid() const{
    return m_next_invoicing_date_isValid;
}

OAIOwnerInCustomerContractSummaryDto OAICustomerContractSummaryDto::getOwner() const {
    return m_owner;
}
void OAICustomerContractSummaryDto::setOwner(const OAIOwnerInCustomerContractSummaryDto &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAICustomerContractSummaryDto::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAICustomerContractSummaryDto::is_owner_Valid() const{
    return m_owner_isValid;
}

qint32 OAICustomerContractSummaryDto::getRenewalPoint() const {
    return m_renewal_point;
}
void OAICustomerContractSummaryDto::setRenewalPoint(const qint32 &renewal_point) {
    m_renewal_point = renewal_point;
    m_renewal_point_isSet = true;
}

bool OAICustomerContractSummaryDto::is_renewal_point_Set() const{
    return m_renewal_point_isSet;
}

bool OAICustomerContractSummaryDto::is_renewal_point_Valid() const{
    return m_renewal_point_isValid;
}

OAISalesPersonInCustomerContractSummaryDto OAICustomerContractSummaryDto::getSalesPerson() const {
    return m_sales_person;
}
void OAICustomerContractSummaryDto::setSalesPerson(const OAISalesPersonInCustomerContractSummaryDto &sales_person) {
    m_sales_person = sales_person;
    m_sales_person_isSet = true;
}

bool OAICustomerContractSummaryDto::is_sales_person_Set() const{
    return m_sales_person_isSet;
}

bool OAICustomerContractSummaryDto::is_sales_person_Valid() const{
    return m_sales_person_isValid;
}

QDateTime OAICustomerContractSummaryDto::getSetupDate() const {
    return m_setup_date;
}
void OAICustomerContractSummaryDto::setSetupDate(const QDateTime &setup_date) {
    m_setup_date = setup_date;
    m_setup_date_isSet = true;
}

bool OAICustomerContractSummaryDto::is_setup_date_Set() const{
    return m_setup_date_isSet;
}

bool OAICustomerContractSummaryDto::is_setup_date_Valid() const{
    return m_setup_date_isValid;
}

QDateTime OAICustomerContractSummaryDto::getTerminationDate() const {
    return m_termination_date;
}
void OAICustomerContractSummaryDto::setTerminationDate(const QDateTime &termination_date) {
    m_termination_date = termination_date;
    m_termination_date_isSet = true;
}

bool OAICustomerContractSummaryDto::is_termination_date_Set() const{
    return m_termination_date_isSet;
}

bool OAICustomerContractSummaryDto::is_termination_date_Valid() const{
    return m_termination_date_isValid;
}

bool OAICustomerContractSummaryDto::isSet() const {
...
bool OAICustomerContractSummaryDto::isValid() const {
