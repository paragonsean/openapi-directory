...
/*
 * OAISupplierQueryParameters.h
 *
 * 
 */

#ifndef OAISupplierQueryParameters_H
#define OAISupplierQueryParameters_H
...
class OAISupplierQueryParameters : public OAIObject {
public:
    OAISupplierQueryParameters();
    OAISupplierQueryParameters(QString json);
    ~OAISupplierQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupplierQueryParameters)

#endif // OAISupplierQueryParameters_H
