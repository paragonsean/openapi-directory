...
/*
 * OAIVatQueryParameters.h
 *
 * 
 */

#ifndef OAIVatQueryParameters_H
#define OAIVatQueryParameters_H
...
class OAIVatQueryParameters : public OAIObject {
public:
    OAIVatQueryParameters();
    OAIVatQueryParameters(QString json);
    ~OAIVatQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVatQueryParameters)

#endif // OAIVatQueryParameters_H
