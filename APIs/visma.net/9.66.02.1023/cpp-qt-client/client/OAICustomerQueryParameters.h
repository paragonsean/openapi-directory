...
/*
 * OAICustomerQueryParameters.h
 *
 * 
 */

#ifndef OAICustomerQueryParameters_H
#define OAICustomerQueryParameters_H
...
class OAICustomerQueryParameters : public OAIObject {
public:
    OAICustomerQueryParameters();
    OAICustomerQueryParameters(QString json);
    ~OAICustomerQueryParameters() override;
    ...
    bool isExpandDirectDebit() const;
    void setExpandDirectDebit(const bool &expand_direct_debit);
    bool is_expand_direct_debit_Set() const;
    bool is_expand_direct_debit_Valid() const;

    bool isExpandPaymentMethods() const;
    void setExpandPaymentMethods(const bool &expand_payment_methods);
    bool is_expand_payment_methods_Set() const;
    bool is_expand_payment_methods_Valid() const;
...
private:
    ...
    bool m_expand_direct_debit;
    bool m_expand_direct_debit_isSet;
    bool m_expand_direct_debit_isValid;

    bool m_expand_payment_methods;
    bool m_expand_payment_methods_isSet;
    bool m_expand_payment_methods_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerQueryParameters)

#endif // OAICustomerQueryParameters_H
