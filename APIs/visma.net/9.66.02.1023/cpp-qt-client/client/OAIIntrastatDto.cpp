...
OAIIntrastatDto::OAIIntrastatDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIntrastatDto::OAIIntrastatDto() {
    this->initializeModel();
}

OAIIntrastatDto::~OAIIntrastatDto() {}

void OAIIntrastatDto::initializeModel() {
...
void OAIIntrastatDto::fromJson(QString jsonString) {
...
void OAIIntrastatDto::fromJsonObject(QJsonObject json) {
...
QString OAIIntrastatDto::asJson() const {
...
QJsonObject OAIIntrastatDto::asJsonObject() const {
    QJsonObject obj;
    if (m_c_n8_isSet) {
...
QString OAIIntrastatDto::getCN8() const {
    return m_c_n8;
}
void OAIIntrastatDto::setCN8(const QString &c_n8) {
    m_c_n8 = c_n8;
    m_c_n8_isSet = true;
}

bool OAIIntrastatDto::is_c_n8_Set() const{
    return m_c_n8_isSet;
}

bool OAIIntrastatDto::is_c_n8_Valid() const{
    return m_c_n8_isValid;
}

QString OAIIntrastatDto::getCountryOfOrigin() const {
    return m_country_of_origin;
}
void OAIIntrastatDto::setCountryOfOrigin(const QString &country_of_origin) {
    m_country_of_origin = country_of_origin;
    m_country_of_origin_isSet = true;
}

bool OAIIntrastatDto::is_country_of_origin_Set() const{
    return m_country_of_origin_isSet;
}

bool OAIIntrastatDto::is_country_of_origin_Valid() const{
    return m_country_of_origin_isValid;
}

QString OAIIntrastatDto::getSupplementaryMeasureUnit() const {
    return m_supplementary_measure_unit;
}
void OAIIntrastatDto::setSupplementaryMeasureUnit(const QString &supplementary_measure_unit) {
    m_supplementary_measure_unit = supplementary_measure_unit;
    m_supplementary_measure_unit_isSet = true;
}

bool OAIIntrastatDto::is_supplementary_measure_unit_Set() const{
    return m_supplementary_measure_unit_isSet;
}

bool OAIIntrastatDto::is_supplementary_measure_unit_Valid() const{
    return m_supplementary_measure_unit_isValid;
}

bool OAIIntrastatDto::isSet() const {
...
bool OAIIntrastatDto::isValid() const {
