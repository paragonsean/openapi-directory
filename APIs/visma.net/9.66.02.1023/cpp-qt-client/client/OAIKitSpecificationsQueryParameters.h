...
/*
 * OAIKitSpecificationsQueryParameters.h
 *
 * 
 */

#ifndef OAIKitSpecificationsQueryParameters_H
#define OAIKitSpecificationsQueryParameters_H
...
class OAIKitSpecificationsQueryParameters : public OAIObject {
public:
    OAIKitSpecificationsQueryParameters();
    OAIKitSpecificationsQueryParameters(QString json);
    ~OAIKitSpecificationsQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKitSpecificationsQueryParameters)

#endif // OAIKitSpecificationsQueryParameters_H
