...
/*
 * OAIVatZoneQueryParameters.h
 *
 * 
 */

#ifndef OAIVatZoneQueryParameters_H
#define OAIVatZoneQueryParameters_H
...
class OAIVatZoneQueryParameters : public OAIObject {
public:
    OAIVatZoneQueryParameters();
    OAIVatZoneQueryParameters(QString json);
    ~OAIVatZoneQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVatZoneQueryParameters)

#endif // OAIVatZoneQueryParameters_H
