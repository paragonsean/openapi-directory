...
/*
 * OAICarrierQueryParameters.h
 *
 * 
 */

#ifndef OAICarrierQueryParameters_H
#define OAICarrierQueryParameters_H
...
class OAICarrierQueryParameters : public OAIObject {
public:
    OAICarrierQueryParameters();
    OAICarrierQueryParameters(QString json);
    ~OAICarrierQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICarrierQueryParameters)

#endif // OAICarrierQueryParameters_H
