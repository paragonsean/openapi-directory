...
/*
 * OAIDiscountQueryParameters.h
 *
 * 
 */

#ifndef OAIDiscountQueryParameters_H
#define OAIDiscountQueryParameters_H
...
class OAIDiscountQueryParameters : public OAIObject {
public:
    OAIDiscountQueryParameters();
    OAIDiscountQueryParameters(QString json);
    ~OAIDiscountQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiscountQueryParameters)

#endif // OAIDiscountQueryParameters_H
