...
/*
 * OAIContactInWarehouseDto.h
 *
 * Address information tab &amp;gt; Contact section &amp;gt;
 */

#ifndef OAIContactInWarehouseDto_H
#define OAIContactInWarehouseDto_H
...
class OAIContactInWarehouseDto : public OAIObject {
public:
    OAIContactInWarehouseDto();
    OAIContactInWarehouseDto(QString json);
    ~OAIContactInWarehouseDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactInWarehouseDto)

#endif // OAIContactInWarehouseDto_H
