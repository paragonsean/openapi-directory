...
/*
 * OAICountryInWarehouseAddressDto.h
 *
 * Country &amp;gt; The country where the warehouse is located.
 */

#ifndef OAICountryInWarehouseAddressDto_H
#define OAICountryInWarehouseAddressDto_H
...
class OAICountryInWarehouseAddressDto : public OAIObject {
public:
    OAICountryInWarehouseAddressDto();
    OAICountryInWarehouseAddressDto(QString json);
    ~OAICountryInWarehouseAddressDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICountryInWarehouseAddressDto)

#endif // OAICountryInWarehouseAddressDto_H
