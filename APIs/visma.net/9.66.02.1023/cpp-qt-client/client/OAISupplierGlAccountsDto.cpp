...
#include "OAISupplierGlAccountsDto.h"
...
OAISupplierGlAccountsDto::OAISupplierGlAccountsDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISupplierGlAccountsDto::OAISupplierGlAccountsDto() {
    this->initializeModel();
}

OAISupplierGlAccountsDto::~OAISupplierGlAccountsDto() {}

void OAISupplierGlAccountsDto::initializeModel() {
...
void OAISupplierGlAccountsDto::fromJson(QString jsonString) {
...
void OAISupplierGlAccountsDto::fromJsonObject(QJsonObject json) {
...
QString OAISupplierGlAccountsDto::asJson() const {
...
QJsonObject OAISupplierGlAccountsDto::asJsonObject() const {
    QJsonObject obj;
...
OAIExpenseAccountInSupplierGlAccountsDto OAISupplierGlAccountsDto::getExpenseAccount() const {
    return m_expense_account;
}
void OAISupplierGlAccountsDto::setExpenseAccount(const OAIExpenseAccountInSupplierGlAccountsDto &expense_account) {
    m_expense_account = expense_account;
    m_expense_account_isSet = true;
}

bool OAISupplierGlAccountsDto::is_expense_account_Set() const{
    return m_expense_account_isSet;
}

bool OAISupplierGlAccountsDto::is_expense_account_Valid() const{
    return m_expense_account_isValid;
}

OAIExpenseAccountImportInSupplierGlAccountsDto OAISupplierGlAccountsDto::getExpenseAccountImport() const {
    return m_expense_account_import;
}
void OAISupplierGlAccountsDto::setExpenseAccountImport(const OAIExpenseAccountImportInSupplierGlAccountsDto &expense_account_import) {
    m_expense_account_import = expense_account_import;
    m_expense_account_import_isSet = true;
}

bool OAISupplierGlAccountsDto::is_expense_account_import_Set() const{
    return m_expense_account_import_isSet;
}

bool OAISupplierGlAccountsDto::is_expense_account_import_Valid() const{
    return m_expense_account_import_isValid;
}

OAIExpenseAccountNonTaxInSupplierGlAccountsDto OAISupplierGlAccountsDto::getExpenseAccountNonTax() const {
    return m_expense_account_non_tax;
}
void OAISupplierGlAccountsDto::setExpenseAccountNonTax(const OAIExpenseAccountNonTaxInSupplierGlAccountsDto &expense_account_non_tax) {
    m_expense_account_non_tax = expense_account_non_tax;
    m_expense_account_non_tax_isSet = true;
}

bool OAISupplierGlAccountsDto::is_expense_account_non_tax_Set() const{
    return m_expense_account_non_tax_isSet;
}

bool OAISupplierGlAccountsDto::is_expense_account_non_tax_Valid() const{
    return m_expense_account_non_tax_isValid;
}

OAIExpenseEUAccountInSupplierGlAccountsDto OAISupplierGlAccountsDto::getExpenseEuAccount() const {
    return m_expense_eu_account;
}
void OAISupplierGlAccountsDto::setExpenseEuAccount(const OAIExpenseEUAccountInSupplierGlAccountsDto &expense_eu_account) {
    m_expense_eu_account = expense_eu_account;
    m_expense_eu_account_isSet = true;
}

bool OAISupplierGlAccountsDto::is_expense_eu_account_Set() const{
    return m_expense_eu_account_isSet;
}

bool OAISupplierGlAccountsDto::is_expense_eu_account_Valid() const{
    return m_expense_eu_account_isValid;
}

OAIExpenseSubaccountInSupplierGlAccountsDto OAISupplierGlAccountsDto::getExpenseSubaccount() const {
    return m_expense_subaccount;
}
void OAISupplierGlAccountsDto::setExpenseSubaccount(const OAIExpenseSubaccountInSupplierGlAccountsDto &expense_subaccount) {
    m_expense_subaccount = expense_subaccount;
    m_expense_subaccount_isSet = true;
}

bool OAISupplierGlAccountsDto::is_expense_subaccount_Set() const{
    return m_expense_subaccount_isSet;
}

bool OAISupplierGlAccountsDto::is_expense_subaccount_Valid() const{
    return m_expense_subaccount_isValid;
}

OAISupplierAccountInSupplierGlAccountsDto OAISupplierGlAccountsDto::getSupplierAccount() const {
    return m_supplier_account;
}
void OAISupplierGlAccountsDto::setSupplierAccount(const OAISupplierAccountInSupplierGlAccountsDto &supplier_account) {
    m_supplier_account = supplier_account;
    m_supplier_account_isSet = true;
}

bool OAISupplierGlAccountsDto::is_supplier_account_Set() const{
    return m_supplier_account_isSet;
}

bool OAISupplierGlAccountsDto::is_supplier_account_Valid() const{
    return m_supplier_account_isValid;
}

bool OAISupplierGlAccountsDto::isSet() const {
...
bool OAISupplierGlAccountsDto::isValid() const {
