...
/*
 * OAIDepartmentQueryParameters.h
 *
 * 
 */

#ifndef OAIDepartmentQueryParameters_H
#define OAIDepartmentQueryParameters_H
...
class OAIDepartmentQueryParameters : public OAIObject {
public:
    OAIDepartmentQueryParameters();
    OAIDepartmentQueryParameters(QString json);
    ~OAIDepartmentQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDepartmentQueryParameters)

#endif // OAIDepartmentQueryParameters_H
