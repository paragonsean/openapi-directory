...
/*
 * OAIBasePaginationDtoOfKitAssemblyDto.h
 *
 * 
 */

#ifndef OAIBasePaginationDtoOfKitAssemblyDto_H
#define OAIBasePaginationDtoOfKitAssemblyDto_H
...
namespace OpenAPI {
class OAIKitAssemblyDto;

class OAIBasePaginationDtoOfKitAssemblyDto : public OAIObject {
public:
    OAIBasePaginationDtoOfKitAssemblyDto();
    OAIBasePaginationDtoOfKitAssemblyDto(QString json);
    ~OAIBasePaginationDtoOfKitAssemblyDto() override;
    ...
    QList<OAIKitAssemblyDto> getRecords() const;
    void setRecords(const QList<OAIKitAssemblyDto> &records);
...
private:
    ...
    QList<OAIKitAssemblyDto> m_records;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBasePaginationDtoOfKitAssemblyDto)

#endif // OAIBasePaginationDtoOfKitAssemblyDto_H
