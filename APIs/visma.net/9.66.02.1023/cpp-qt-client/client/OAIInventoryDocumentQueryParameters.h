...
/*
 * OAIInventoryDocumentQueryParameters.h
 *
 * 
 */

#ifndef OAIInventoryDocumentQueryParameters_H
#define OAIInventoryDocumentQueryParameters_H
...
class OAIInventoryDocumentQueryParameters : public OAIObject {
public:
    OAIInventoryDocumentQueryParameters();
    OAIInventoryDocumentQueryParameters(QString json);
    ~OAIInventoryDocumentQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryDocumentQueryParameters)

#endif // OAIInventoryDocumentQueryParameters_H
