...
/*
 * OAILocationInFixedAssetDto.h
 *
 * The current location of this fixed asset
 */

#ifndef OAILocationInFixedAssetDto_H
#define OAILocationInFixedAssetDto_H
...
class OAILocationInFixedAssetDto : public OAIObject {
public:
    OAILocationInFixedAssetDto();
    OAILocationInFixedAssetDto(QString json);
    ~OAILocationInFixedAssetDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocationInFixedAssetDto)

#endif // OAILocationInFixedAssetDto_H
