...
/*
 * OAIDeliveryAddressInBranchDto.h
 *
 * The Delivery settings tab &amp;gt; Delivery address section &amp;gt;
 */

#ifndef OAIDeliveryAddressInBranchDto_H
#define OAIDeliveryAddressInBranchDto_H
...
class OAIDeliveryAddressInBranchDto : public OAIObject {
public:
    OAIDeliveryAddressInBranchDto();
    OAIDeliveryAddressInBranchDto(QString json);
    ~OAIDeliveryAddressInBranchDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeliveryAddressInBranchDto)

#endif // OAIDeliveryAddressInBranchDto_H
