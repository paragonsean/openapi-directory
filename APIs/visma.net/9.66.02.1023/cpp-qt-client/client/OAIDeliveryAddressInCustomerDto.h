...
/*
 * OAIDeliveryAddressInCustomerDto.h
 *
 * Delivery settings tab &amp;gt; Shipping address section &amp;gt;
 */

#ifndef OAIDeliveryAddressInCustomerDto_H
#define OAIDeliveryAddressInCustomerDto_H
...
class OAIDeliveryAddressInCustomerDto : public OAIObject {
public:
    OAIDeliveryAddressInCustomerDto();
    OAIDeliveryAddressInCustomerDto(QString json);
    ~OAIDeliveryAddressInCustomerDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeliveryAddressInCustomerDto)

#endif // OAIDeliveryAddressInCustomerDto_H
