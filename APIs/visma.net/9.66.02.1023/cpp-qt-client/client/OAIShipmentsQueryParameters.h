...
/*
 * OAIShipmentsQueryParameters.h
 *
 * 
 */

#ifndef OAIShipmentsQueryParameters_H
#define OAIShipmentsQueryParameters_H
...
class OAIShipmentsQueryParameters : public OAIObject {
public:
    OAIShipmentsQueryParameters();
    OAIShipmentsQueryParameters(QString json);
    ~OAIShipmentsQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShipmentsQueryParameters)

#endif // OAIShipmentsQueryParameters_H
