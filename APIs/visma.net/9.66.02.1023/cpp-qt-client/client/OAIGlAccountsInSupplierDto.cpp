...
OAIGlAccountsInSupplierDto::OAIGlAccountsInSupplierDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGlAccountsInSupplierDto::OAIGlAccountsInSupplierDto() {
    this->initializeModel();
}

OAIGlAccountsInSupplierDto::~OAIGlAccountsInSupplierDto() {}

void OAIGlAccountsInSupplierDto::initializeModel() {
...
void OAIGlAccountsInSupplierDto::fromJson(QString jsonString) {
...
void OAIGlAccountsInSupplierDto::fromJsonObject(QJsonObject json) {
...
QString OAIGlAccountsInSupplierDto::asJson() const {
...
QJsonObject OAIGlAccountsInSupplierDto::asJsonObject() const {
    QJsonObject obj;
...
OAIExpenseAccountInSupplierGlAccountsDto OAIGlAccountsInSupplierDto::getExpenseAccount() const {
    return m_expense_account;
}
void OAIGlAccountsInSupplierDto::setExpenseAccount(const OAIExpenseAccountInSupplierGlAccountsDto &expense_account) {
    m_expense_account = expense_account;
    m_expense_account_isSet = true;
}

bool OAIGlAccountsInSupplierDto::is_expense_account_Set() const{
    return m_expense_account_isSet;
}

bool OAIGlAccountsInSupplierDto::is_expense_account_Valid() const{
    return m_expense_account_isValid;
}

OAIExpenseAccountImportInSupplierGlAccountsDto OAIGlAccountsInSupplierDto::getExpenseAccountImport() const {
    return m_expense_account_import;
}
void OAIGlAccountsInSupplierDto::setExpenseAccountImport(const OAIExpenseAccountImportInSupplierGlAccountsDto &expense_account_import) {
    m_expense_account_import = expense_account_import;
    m_expense_account_import_isSet = true;
}

bool OAIGlAccountsInSupplierDto::is_expense_account_import_Set() const{
    return m_expense_account_import_isSet;
}

bool OAIGlAccountsInSupplierDto::is_expense_account_import_Valid() const{
    return m_expense_account_import_isValid;
}

OAIExpenseAccountNonTaxInSupplierGlAccountsDto OAIGlAccountsInSupplierDto::getExpenseAccountNonTax() const {
    return m_expense_account_non_tax;
}
void OAIGlAccountsInSupplierDto::setExpenseAccountNonTax(const OAIExpenseAccountNonTaxInSupplierGlAccountsDto &expense_account_non_tax) {
    m_expense_account_non_tax = expense_account_non_tax;
    m_expense_account_non_tax_isSet = true;
}

bool OAIGlAccountsInSupplierDto::is_expense_account_non_tax_Set() const{
    return m_expense_account_non_tax_isSet;
}

bool OAIGlAccountsInSupplierDto::is_expense_account_non_tax_Valid() const{
    return m_expense_account_non_tax_isValid;
}

OAIExpenseEUAccountInSupplierGlAccountsDto OAIGlAccountsInSupplierDto::getExpenseEuAccount() const {
    return m_expense_eu_account;
}
void OAIGlAccountsInSupplierDto::setExpenseEuAccount(const OAIExpenseEUAccountInSupplierGlAccountsDto &expense_eu_account) {
    m_expense_eu_account = expense_eu_account;
    m_expense_eu_account_isSet = true;
}

bool OAIGlAccountsInSupplierDto::is_expense_eu_account_Set() const{
    return m_expense_eu_account_isSet;
}

bool OAIGlAccountsInSupplierDto::is_expense_eu_account_Valid() const{
    return m_expense_eu_account_isValid;
}

OAIExpenseSubaccountInSupplierGlAccountsDto OAIGlAccountsInSupplierDto::getExpenseSubaccount() const {
    return m_expense_subaccount;
}
void OAIGlAccountsInSupplierDto::setExpenseSubaccount(const OAIExpenseSubaccountInSupplierGlAccountsDto &expense_subaccount) {
    m_expense_subaccount = expense_subaccount;
    m_expense_subaccount_isSet = true;
}

bool OAIGlAccountsInSupplierDto::is_expense_subaccount_Set() const{
    return m_expense_subaccount_isSet;
}

bool OAIGlAccountsInSupplierDto::is_expense_subaccount_Valid() const{
    return m_expense_subaccount_isValid;
}

OAISupplierAccountInSupplierGlAccountsDto OAIGlAccountsInSupplierDto::getSupplierAccount() const {
    return m_supplier_account;
}
void OAIGlAccountsInSupplierDto::setSupplierAccount(const OAISupplierAccountInSupplierGlAccountsDto &supplier_account) {
    m_supplier_account = supplier_account;
    m_supplier_account_isSet = true;
}

bool OAIGlAccountsInSupplierDto::is_supplier_account_Set() const{
    return m_supplier_account_isSet;
}

bool OAIGlAccountsInSupplierDto::is_supplier_account_Valid() const{
    return m_supplier_account_isValid;
}

bool OAIGlAccountsInSupplierDto::isSet() const {
...
bool OAIGlAccountsInSupplierDto::isValid() const {
