...
OAIIntrastatInInventoryDto::OAIIntrastatInInventoryDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIntrastatInInventoryDto::OAIIntrastatInInventoryDto() {
    this->initializeModel();
}

OAIIntrastatInInventoryDto::~OAIIntrastatInInventoryDto() {}

void OAIIntrastatInInventoryDto::initializeModel() {
...
void OAIIntrastatInInventoryDto::fromJson(QString jsonString) {
...
void OAIIntrastatInInventoryDto::fromJsonObject(QJsonObject json) {
...
QString OAIIntrastatInInventoryDto::asJson() const {
...
QJsonObject OAIIntrastatInInventoryDto::asJsonObject() const {
    QJsonObject obj;
    if (m_c_n8_isSet) {
...
QString OAIIntrastatInInventoryDto::getCN8() const {
    return m_c_n8;
}
void OAIIntrastatInInventoryDto::setCN8(const QString &c_n8) {
    m_c_n8 = c_n8;
    m_c_n8_isSet = true;
}

bool OAIIntrastatInInventoryDto::is_c_n8_Set() const{
    return m_c_n8_isSet;
}

bool OAIIntrastatInInventoryDto::is_c_n8_Valid() const{
    return m_c_n8_isValid;
}

QString OAIIntrastatInInventoryDto::getCountryOfOrigin() const {
    return m_country_of_origin;
}
void OAIIntrastatInInventoryDto::setCountryOfOrigin(const QString &country_of_origin) {
    m_country_of_origin = country_of_origin;
    m_country_of_origin_isSet = true;
}

bool OAIIntrastatInInventoryDto::is_country_of_origin_Set() const{
    return m_country_of_origin_isSet;
}

bool OAIIntrastatInInventoryDto::is_country_of_origin_Valid() const{
    return m_country_of_origin_isValid;
}

QString OAIIntrastatInInventoryDto::getSupplementaryMeasureUnit() const {
    return m_supplementary_measure_unit;
}
void OAIIntrastatInInventoryDto::setSupplementaryMeasureUnit(const QString &supplementary_measure_unit) {
    m_supplementary_measure_unit = supplementary_measure_unit;
    m_supplementary_measure_unit_isSet = true;
}

bool OAIIntrastatInInventoryDto::is_supplementary_measure_unit_Set() const{
    return m_supplementary_measure_unit_isSet;
}

bool OAIIntrastatInInventoryDto::is_supplementary_measure_unit_Valid() const{
    return m_supplementary_measure_unit_isValid;
}

bool OAIIntrastatInInventoryDto::isSet() const {
...
bool OAIIntrastatInInventoryDto::isValid() const {
