...
void OAIAttachmentApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("attachmentGetByattachmentId", defaultConf);
    _serverIndices.insert("attachmentGetByattachmentId", 0);
    _serverConfigs.insert("attachmentPutByattachmentId", defaultConf);
    _serverIndices.insert("attachmentPutByattachmentId", 0);
}
...
void OAIAttachmentApi::attachmentGetByattachmentId(const QString &attachment_id, const ::OpenAPI::OptionalParam<QString> &erp_api_background) {
    QString fullPath = QString(_serverConfigs["attachmentGetByattachmentId"][_serverIndices.value("attachmentGetByattachmentId")].URL()+"/controller/api/v1/attachment/{attachmentId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAttachmentApi::attachmentGetByattachmentIdCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAttachmentApi::attachmentGetByattachmentIdCallback);
    connect(this, &OAIAttachmentApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIAttachmentApi::attachmentGetByattachmentIdCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT attachmentGetByattachmentIdSignal(output);
        Q_EMIT attachmentGetByattachmentIdSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT attachmentGetByattachmentIdSignalE(output, error_type, error_str);
        Q_EMIT attachmentGetByattachmentIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT attachmentGetByattachmentIdSignalError(output, error_type, error_str);
        Q_EMIT attachmentGetByattachmentIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAttachmentApi::attachmentPutByattachmentId(const QString &attachment_id, const OAIAttachmentMetadataUpdateDto &oai_attachment_metadata_update_dto, const ::OpenAPI::OptionalParam<QString> &erp_api_background) {
    QString fullPath = QString(_serverConfigs["attachmentPutByattachmentId"][_serverIndices.value("attachmentPutByattachmentId")].URL()+"/controller/api/v1/attachment/{attachmentId}");
...

    {
        ...
        QByteArray output = oai_attachment_metadata_update_dto.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAttachmentApi::attachmentPutByattachmentIdCallback);
    connect(this, &OAIAttachmentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAttachmentApi::attachmentPutByattachmentIdCallback);
    connect(this, &OAIAttachmentApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAttachmentApi::attachmentPutByattachmentIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT attachmentPutByattachmentIdSignal(output);
        Q_EMIT attachmentPutByattachmentIdSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT attachmentPutByattachmentIdSignalE(output, error_type, error_str);
        Q_EMIT attachmentPutByattachmentIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT attachmentPutByattachmentIdSignalError(output, error_type, error_str);
        Q_EMIT attachmentPutByattachmentIdSignalErrorFull(worker, error_type, error_str);
    }
}
