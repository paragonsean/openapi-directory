...
/*
 * OAIContractTemplateQueryParameters.h
 *
 * 
 */

#ifndef OAIContractTemplateQueryParameters_H
#define OAIContractTemplateQueryParameters_H
...
class OAIContractTemplateQueryParameters : public OAIObject {
public:
    OAIContractTemplateQueryParameters();
    OAIContractTemplateQueryParameters(QString json);
    ~OAIContractTemplateQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContractTemplateQueryParameters)

#endif // OAIContractTemplateQueryParameters_H
