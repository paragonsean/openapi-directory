...
/*
 * OAISupplierAddressInSupplierDto.h
 *
 * Purchase settings tab &amp;gt; Shipping address section &amp;gt;
 */

#ifndef OAISupplierAddressInSupplierDto_H
#define OAISupplierAddressInSupplierDto_H
...
class OAISupplierAddressInSupplierDto : public OAIObject {
public:
    OAISupplierAddressInSupplierDto();
    OAISupplierAddressInSupplierDto(QString json);
    ~OAISupplierAddressInSupplierDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupplierAddressInSupplierDto)

#endif // OAISupplierAddressInSupplierDto_H
