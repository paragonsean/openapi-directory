...
/*
 * OAIKitSpecificationNonStockComponentDto.h
 *
 * 
 */

#ifndef OAIKitSpecificationNonStockComponentDto_H
#define OAIKitSpecificationNonStockComponentDto_H
...
class OAIKitSpecificationNonStockComponentDto : public OAIObject {
public:
    OAIKitSpecificationNonStockComponentDto();
    OAIKitSpecificationNonStockComponentDto(QString json);
    ~OAIKitSpecificationNonStockComponentDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKitSpecificationNonStockComponentDto)

#endif // OAIKitSpecificationNonStockComponentDto_H
