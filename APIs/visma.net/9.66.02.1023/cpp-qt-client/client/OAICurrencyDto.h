...
#ifndef OAICurrencyDto_H
#define OAICurrencyDto_H
...
class OAICurrencyDto : public OAIObject {
public:
    OAICurrencyDto();
    OAICurrencyDto(QString json);
    ~OAICurrencyDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyDto)

#endif // OAICurrencyDto_H
