...
/*
 * OAIEarningTypeQueryParameters.h
 *
 * 
 */

#ifndef OAIEarningTypeQueryParameters_H
#define OAIEarningTypeQueryParameters_H
...
class OAIEarningTypeQueryParameters : public OAIObject {
public:
    OAIEarningTypeQueryParameters();
    OAIEarningTypeQueryParameters(QString json);
    ~OAIEarningTypeQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEarningTypeQueryParameters)

#endif // OAIEarningTypeQueryParameters_H
