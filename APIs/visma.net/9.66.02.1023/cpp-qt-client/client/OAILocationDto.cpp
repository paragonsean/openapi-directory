...
bool OAILocationDto::isActive() const {
    return m_active;
}
void OAILocationDto::setActive(const bool &active) {
    m_active = active;
    m_active_isSet = true;
}

bool OAILocationDto::is_active_Set() const{
    return m_active_isSet;
}

bool OAILocationDto::is_active_Valid() const{
    return m_active_isValid;
}

OAIAddressInLocationDto OAILocationDto::getAddress() const {
    return m_address;
}
void OAILocationDto::setAddress(const OAIAddressInLocationDto &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAILocationDto::is_address_Set() const{
    return m_address_isSet;
}

bool OAILocationDto::is_address_Valid() const{
    return m_address_isValid;
}

OAIBaccountInLocationDto OAILocationDto::getBaccount() const {
    return m_baccount;
}
void OAILocationDto::setBaccount(const OAIBaccountInLocationDto &baccount) {
    m_baccount = baccount;
    m_baccount_isSet = true;
}

bool OAILocationDto::is_baccount_Set() const{
    return m_baccount_isSet;
}

bool OAILocationDto::is_baccount_Valid() const{
    return m_baccount_isValid;
}

OAIContactInLocationDto OAILocationDto::getContact() const {
    return m_contact;
}
void OAILocationDto::setContact(const OAIContactInLocationDto &contact) {
    m_contact = contact;
    m_contact_isSet = true;
}

bool OAILocationDto::is_contact_Set() const{
    return m_contact_isSet;
}

bool OAILocationDto::is_contact_Valid() const{
    return m_contact_isValid;
}

QString OAILocationDto::getCorporateId() const {
    return m_corporate_id;
}
void OAILocationDto::setCorporateId(const QString &corporate_id) {
    m_corporate_id = corporate_id;
    m_corporate_id_isSet = true;
}

bool OAILocationDto::is_corporate_id_Set() const{
    return m_corporate_id_isSet;
}

bool OAILocationDto::is_corporate_id_Valid() const{
    return m_corporate_id_isValid;
}

QString OAILocationDto::getEdiCode() const {
    return m_edi_code;
}
void OAILocationDto::setEdiCode(const QString &edi_code) {
    m_edi_code = edi_code;
    m_edi_code_isSet = true;
}

bool OAILocationDto::is_edi_code_Set() const{
    return m_edi_code_isSet;
}

bool OAILocationDto::is_edi_code_Valid() const{
    return m_edi_code_isValid;
}

QString OAILocationDto::getErrorInfo() const {
    return m_error_info;
}
void OAILocationDto::setErrorInfo(const QString &error_info) {
    m_error_info = error_info;
    m_error_info_isSet = true;
}

bool OAILocationDto::is_error_info_Set() const{
    return m_error_info_isSet;
}

bool OAILocationDto::is_error_info_Valid() const{
    return m_error_info_isValid;
}

QString OAILocationDto::getGln() const {
    return m_gln;
}
void OAILocationDto::setGln(const QString &gln) {
    m_gln = gln;
    m_gln_isSet = true;
}

bool OAILocationDto::is_gln_Set() const{
    return m_gln_isSet;
}

bool OAILocationDto::is_gln_Valid() const{
    return m_gln_isValid;
}

QDateTime OAILocationDto::getLastModifiedDateTime() const {
    return m_last_modified_date_time;
}
void OAILocationDto::setLastModifiedDateTime(const QDateTime &last_modified_date_time) {
    m_last_modified_date_time = last_modified_date_time;
    m_last_modified_date_time_isSet = true;
}

bool OAILocationDto::is_last_modified_date_time_Set() const{
    return m_last_modified_date_time_isSet;
}

bool OAILocationDto::is_last_modified_date_time_Valid() const{
    return m_last_modified_date_time_isValid;
}

QString OAILocationDto::getLocationId() const {
    return m_location_id;
}
void OAILocationDto::setLocationId(const QString &location_id) {
    m_location_id = location_id;
    m_location_id_isSet = true;
}

bool OAILocationDto::is_location_id_Set() const{
    return m_location_id_isSet;
}

bool OAILocationDto::is_location_id_Valid() const{
    return m_location_id_isValid;
}

QString OAILocationDto::getLocationName() const {
    return m_location_name;
}
void OAILocationDto::setLocationName(const QString &location_name) {
    m_location_name = location_name;
    m_location_name_isSet = true;
}

bool OAILocationDto::is_location_name_Set() const{
    return m_location_name_isSet;
}

bool OAILocationDto::is_location_name_Valid() const{
    return m_location_name_isValid;
}

OAIMetadataDto OAILocationDto::getMetadata() const {
    return m_metadata;
}
void OAILocationDto::setMetadata(const OAIMetadataDto &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAILocationDto::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAILocationDto::is_metadata_Valid() const{
    return m_metadata_isValid;
}

OAIPeppolSchemeInLocationDto OAILocationDto::getPeppolScheme() const {
    return m_peppol_scheme;
}
void OAILocationDto::setPeppolScheme(const OAIPeppolSchemeInLocationDto &peppol_scheme) {
    m_peppol_scheme = peppol_scheme;
    m_peppol_scheme_isSet = true;
}

bool OAILocationDto::is_peppol_scheme_Set() const{
    return m_peppol_scheme_isSet;
}

bool OAILocationDto::is_peppol_scheme_Valid() const{
    return m_peppol_scheme_isValid;
}

QString OAILocationDto::getVatRegistrationId() const {
    return m_vat_registration_id;
}
void OAILocationDto::setVatRegistrationId(const QString &vat_registration_id) {
    m_vat_registration_id = vat_registration_id;
    m_vat_registration_id_isSet = true;
}

bool OAILocationDto::is_vat_registration_id_Set() const{
    return m_vat_registration_id_isSet;
}

bool OAILocationDto::is_vat_registration_id_Valid() const{
    return m_vat_registration_id_isValid;
}

OAIVatZoneInLocationDto OAILocationDto::getVatZone() const {
    return m_vat_zone;
}
void OAILocationDto::setVatZone(const OAIVatZoneInLocationDto &vat_zone) {
    m_vat_zone = vat_zone;
    m_vat_zone_isSet = true;
}

bool OAILocationDto::is_vat_zone_Set() const{
    return m_vat_zone_isSet;
}

bool OAILocationDto::is_vat_zone_Valid() const{
