...
/*
 * OAICreditTermQueryParameters.h
 *
 * 
 */

#ifndef OAICreditTermQueryParameters_H
#define OAICreditTermQueryParameters_H
...
class OAICreditTermQueryParameters : public OAIObject {
public:
    OAICreditTermQueryParameters();
    OAICreditTermQueryParameters(QString json);
    ~OAICreditTermQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreditTermQueryParameters)

#endif // OAICreditTermQueryParameters_H
