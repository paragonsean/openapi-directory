...
/*
 * OAIInventoryAdjustmentDto.h
 *
 * This class represents a inventory issue in InventoryIssueController. Used by getting data.
 */

#ifndef OAIInventoryAdjustmentDto_H
#define OAIInventoryAdjustmentDto_H
...
namespace OpenAPI {
class OAIInventoryAdjustmentLineDto;
class OAIAttachmentDto;
class OAIBranchNumberInInventoryAdjustmentDto;
class OAIMetadataDto;

class OAIInventoryAdjustmentDto : public OAIObject {
public:
    OAIInventoryAdjustmentDto();
    OAIInventoryAdjustmentDto(QString json);
    ~OAIInventoryAdjustmentDto() override;
    ...
    QList<OAIInventoryAdjustmentLineDto> getAdjusmentLines() const;
    void setAdjusmentLines(const QList<OAIInventoryAdjustmentLineDto> &adjusment_lines);
    bool is_adjusment_lines_Set() const;
    bool is_adjusment_lines_Valid() const;
    ...
    OAIBranchNumberInInventoryAdjustmentDto getBranchNumber() const;
    void setBranchNumber(const OAIBranchNumberInInventoryAdjustmentDto &branch_number);
...
private:
    ...
    QList<OAIInventoryAdjustmentLineDto> m_adjusment_lines;
    bool m_adjusment_lines_isSet;
    bool m_adjusment_lines_isValid;
    ...
    OAIBranchNumberInInventoryAdjustmentDto m_branch_number;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryAdjustmentDto)

#endif // OAIInventoryAdjustmentDto_H
