...
#ifndef OAIDetailsDto_H
#define OAIDetailsDto_H
...
class OAIDetailsDto : public OAIObject {
public:
    OAIDetailsDto();
    OAIDetailsDto(QString json);
    ~OAIDetailsDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetailsDto)

#endif // OAIDetailsDto_H
