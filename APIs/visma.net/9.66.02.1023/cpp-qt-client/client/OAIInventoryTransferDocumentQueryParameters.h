...
/*
 * OAIInventoryTransferDocumentQueryParameters.h
 *
 * 
 */

#ifndef OAIInventoryTransferDocumentQueryParameters_H
#define OAIInventoryTransferDocumentQueryParameters_H
...
class OAIInventoryTransferDocumentQueryParameters : public OAIObject {
public:
    OAIInventoryTransferDocumentQueryParameters();
    OAIInventoryTransferDocumentQueryParameters(QString json);
    ~OAIInventoryTransferDocumentQueryParameters() override;
    ...
    QString getToWarehouse() const;
    void setToWarehouse(const QString &to_warehouse);
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryTransferDocumentQueryParameters)

#endif // OAIInventoryTransferDocumentQueryParameters_H
