...
/*
 * OAISubaccountInCustomerCreditWriteOffDto.h
 *
 * The Document details tab &amp;gt; Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCustomerCreditWriteOffDto_H
#define OAISubaccountInCustomerCreditWriteOffDto_H
...
class OAISubaccountInCustomerCreditWriteOffDto : public OAIObject {
public:
    OAISubaccountInCustomerCreditWriteOffDto();
    OAISubaccountInCustomerCreditWriteOffDto(QString json);
    ~OAISubaccountInCustomerCreditWriteOffDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCustomerCreditWriteOffDto)

#endif // OAISubaccountInCustomerCreditWriteOffDto_H
