...
/*
 * OAIPackagingTypeQueryParameters.h
 *
 * 
 */

#ifndef OAIPackagingTypeQueryParameters_H
#define OAIPackagingTypeQueryParameters_H
...
class OAIPackagingTypeQueryParameters : public OAIObject {
public:
    OAIPackagingTypeQueryParameters();
    OAIPackagingTypeQueryParameters(QString json);
    ~OAIPackagingTypeQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackagingTypeQueryParameters)

#endif // OAIPackagingTypeQueryParameters_H
