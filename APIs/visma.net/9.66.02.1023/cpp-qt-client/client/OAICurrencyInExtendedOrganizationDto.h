...
/*
 * OAICurrencyInExtendedOrganizationDto.h
 *
 * Currency
 */

#ifndef OAICurrencyInExtendedOrganizationDto_H
#define OAICurrencyInExtendedOrganizationDto_H
...
class OAICurrencyInExtendedOrganizationDto : public OAIObject {
public:
    OAICurrencyInExtendedOrganizationDto();
    OAICurrencyInExtendedOrganizationDto(QString json);
    ~OAICurrencyInExtendedOrganizationDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyInExtendedOrganizationDto)

#endif // OAICurrencyInExtendedOrganizationDto_H
