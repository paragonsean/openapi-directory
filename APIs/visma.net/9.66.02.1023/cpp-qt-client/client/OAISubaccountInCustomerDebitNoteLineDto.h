...
/*
 * OAISubaccountInCustomerDebitNoteLineDto.h
 *
 * Mandatory field: Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCustomerDebitNoteLineDto_H
#define OAISubaccountInCustomerDebitNoteLineDto_H
...
class OAISubaccountInCustomerDebitNoteLineDto : public OAIObject {
public:
    OAISubaccountInCustomerDebitNoteLineDto();
    OAISubaccountInCustomerDebitNoteLineDto(QString json);
    ~OAISubaccountInCustomerDebitNoteLineDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCustomerDebitNoteLineDto)

#endif // OAISubaccountInCustomerDebitNoteLineDto_H
