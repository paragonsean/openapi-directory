...
/*
 * OAISubaccountInSupplierDocumentDto.h
 *
 * Mandatory field: Document details tab &amp;gt; Subaccount* &amp;gt; The corresponding subaccount to be used for invoices and adjustments.
 */

#ifndef OAISubaccountInSupplierDocumentDto_H
#define OAISubaccountInSupplierDocumentDto_H
...
class OAISubaccountInSupplierDocumentDto : public OAIObject {
public:
    OAISubaccountInSupplierDocumentDto();
    OAISubaccountInSupplierDocumentDto(QString json);
    ~OAISubaccountInSupplierDocumentDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInSupplierDocumentDto)

#endif // OAISubaccountInSupplierDocumentDto_H
