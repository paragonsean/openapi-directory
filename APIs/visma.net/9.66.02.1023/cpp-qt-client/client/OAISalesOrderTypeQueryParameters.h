...
/*
 * OAISalesOrderTypeQueryParameters.h
 *
 * 
 */

#ifndef OAISalesOrderTypeQueryParameters_H
#define OAISalesOrderTypeQueryParameters_H
...
class OAISalesOrderTypeQueryParameters : public OAIObject {
public:
    OAISalesOrderTypeQueryParameters();
    OAISalesOrderTypeQueryParameters(QString json);
    ~OAISalesOrderTypeQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISalesOrderTypeQueryParameters)

#endif // OAISalesOrderTypeQueryParameters_H
