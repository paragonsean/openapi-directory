...
#ifndef OAIOwnerInSalesOrderDto_H
#define OAIOwnerInSalesOrderDto_H
...
class OAIOwnerInSalesOrderDto : public OAIObject {
public:
    OAIOwnerInSalesOrderDto();
    OAIOwnerInSalesOrderDto(QString json);
    ~OAIOwnerInSalesOrderDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOwnerInSalesOrderDto)

#endif // OAIOwnerInSalesOrderDto_H
