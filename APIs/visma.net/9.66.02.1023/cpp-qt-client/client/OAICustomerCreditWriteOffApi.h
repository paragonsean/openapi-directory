...
#ifndef OAI_OAICustomerCreditWriteOffApi_H
#define OAI_OAICustomerCreditWriteOffApi_H
...
class OAICustomerCreditWriteOffApi : public QObject {
    Q_OBJECT

public:
    OAICustomerCreditWriteOffApi(const int timeOut = 0);
    ~OAICustomerCreditWriteOffApi();
...
private:
    ...
    void customerCreditWriteOffGetAllCallback(OAIHttpRequestWorker *worker);
    void customerCreditWriteOffGetBycreditWriteOffNumberCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void customerCreditWriteOffGetAllSignal(QList<OAICustomerCreditWriteOffDto> summary);
    void customerCreditWriteOffGetBycreditWriteOffNumberSignal(OAICustomerCreditWriteOffDto summary);


    void customerCreditWriteOffGetAllSignalFull(OAIHttpRequestWorker *worker, QList<OAICustomerCreditWriteOffDto> summary);
    void customerCreditWriteOffGetBycreditWriteOffNumberSignalFull(OAIHttpRequestWorker *worker, OAICustomerCreditWriteOffDto summary);

    Q_DECL_DEPRECATED_X("Use customerCreditWriteOffGetAllSignalError() instead")
    void customerCreditWriteOffGetAllSignalE(QList<OAICustomerCreditWriteOffDto> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void customerCreditWriteOffGetAllSignalError(QList<OAICustomerCreditWriteOffDto> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use customerCreditWriteOffGetBycreditWriteOffNumberSignalError() instead")
    void customerCreditWriteOffGetBycreditWriteOffNumberSignalE(OAICustomerCreditWriteOffDto summary, QNetworkReply::NetworkError error_type, QString error_str);
    void customerCreditWriteOffGetBycreditWriteOffNumberSignalError(OAICustomerCreditWriteOffDto summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use customerCreditWriteOffGetAllSignalErrorFull() instead")
    void customerCreditWriteOffGetAllSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void customerCreditWriteOffGetAllSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use customerCreditWriteOffGetBycreditWriteOffNumberSignalErrorFull() instead")
    void customerCreditWriteOffGetBycreditWriteOffNumberSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void customerCreditWriteOffGetBycreditWriteOffNumberSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
