...
/*
 * OAIAddressInLocationDto.h
 *
 * General information tab &amp;gt; Location address section &amp;gt;
 */

#ifndef OAIAddressInLocationDto_H
#define OAIAddressInLocationDto_H
...
class OAIAddressInLocationDto : public OAIObject {
public:
    OAIAddressInLocationDto();
    OAIAddressInLocationDto(QString json);
    ~OAIAddressInLocationDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddressInLocationDto)

#endif // OAIAddressInLocationDto_H
