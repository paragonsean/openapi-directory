...
/*
 * OAIPurchaseReceiptQueryParameters.h
 *
 * 
 */

#ifndef OAIPurchaseReceiptQueryParameters_H
#define OAIPurchaseReceiptQueryParameters_H
...
class OAIPurchaseReceiptQueryParameters : public OAIObject {
public:
    OAIPurchaseReceiptQueryParameters();
    OAIPurchaseReceiptQueryParameters(QString json);
    ~OAIPurchaseReceiptQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPurchaseReceiptQueryParameters)

#endif // OAIPurchaseReceiptQueryParameters_H
