...
namespace OpenAPI {
class OAIBranchNumberInPurchaseReceiptDto;
class OAILandedCostDto;
class OAIPurchaseReceiptLineDto;
class OAILocationInPurchaseReceiptDto;
class OAIMetadataDto;
class OAISupplierInPurchaseReceiptDto;
class OAIWarehouseInPurchaseReceiptDto;

class OAIPurchaseReceiptDto : public OAIObject {
public:
    OAIPurchaseReceiptDto();
    OAIPurchaseReceiptDto(QString json);
    ~OAIPurchaseReceiptDto() override;
    ...
    OAIBranchNumberInPurchaseReceiptDto getBranchNumber() const;
    void setBranchNumber(const OAIBranchNumberInPurchaseReceiptDto &branch_number);
    ...
    QList<OAILandedCostDto> getLandedCost() const;
    void setLandedCost(const QList<OAILandedCostDto> &landed_cost);
    ...
    OAILocationInPurchaseReceiptDto getLocation() const;
    void setLocation(const OAILocationInPurchaseReceiptDto &location);
    ...
    OAISupplierInPurchaseReceiptDto getSupplier() const;
    void setSupplier(const OAISupplierInPurchaseReceiptDto &supplier);
    ...
    OAIWarehouseInPurchaseReceiptDto getWarehouse() const;
    void setWarehouse(const OAIWarehouseInPurchaseReceiptDto &warehouse);
...
private:
    ...
    OAIBranchNumberInPurchaseReceiptDto m_branch_number;
    ...
    QList<OAILandedCostDto> m_landed_cost;
    ...
    OAILocationInPurchaseReceiptDto m_location;
    ...
    OAISupplierInPurchaseReceiptDto m_supplier;
    ...
    OAIWarehouseInPurchaseReceiptDto m_warehouse;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPurchaseReceiptDto)

#endif // OAIPurchaseReceiptDto_H
