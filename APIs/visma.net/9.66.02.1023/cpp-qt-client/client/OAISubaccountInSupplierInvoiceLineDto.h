...
/*
 * OAISubaccountInSupplierInvoiceLineDto.h
 *
 * The table &amp;gt; Mandatory field: Subaccount* &amp;gt; The corresponding subaccount used for this invoice line.
 */

#ifndef OAISubaccountInSupplierInvoiceLineDto_H
#define OAISubaccountInSupplierInvoiceLineDto_H
...
class OAISubaccountInSupplierInvoiceLineDto : public OAIObject {
public:
    OAISubaccountInSupplierInvoiceLineDto();
    OAISubaccountInSupplierInvoiceLineDto(QString json);
    ~OAISubaccountInSupplierInvoiceLineDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInSupplierInvoiceLineDto)

#endif // OAISubaccountInSupplierInvoiceLineDto_H
