...
OAIDetailsInFixedAssetDto::OAIDetailsInFixedAssetDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetailsInFixedAssetDto::OAIDetailsInFixedAssetDto() {
    this->initializeModel();
}

OAIDetailsInFixedAssetDto::~OAIDetailsInFixedAssetDto() {}

void OAIDetailsInFixedAssetDto::initializeModel() {
...
void OAIDetailsInFixedAssetDto::fromJson(QString jsonString) {
...
void OAIDetailsInFixedAssetDto::fromJsonObject(QJsonObject json) {
...
QString OAIDetailsInFixedAssetDto::asJson() const {
...
QJsonObject OAIDetailsInFixedAssetDto::asJsonObject() const {
    QJsonObject obj;
...
double OAIDetailsInFixedAssetDto::getAcquisitionCost() const {
    return m_acquisition_cost;
}
void OAIDetailsInFixedAssetDto::setAcquisitionCost(const double &acquisition_cost) {
    m_acquisition_cost = acquisition_cost;
    m_acquisition_cost_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_acquisition_cost_Set() const{
    return m_acquisition_cost_isSet;
}

bool OAIDetailsInFixedAssetDto::is_acquisition_cost_Valid() const{
    return m_acquisition_cost_isValid;
}

QString OAIDetailsInFixedAssetDto::getBillNumber() const {
    return m_bill_number;
}
void OAIDetailsInFixedAssetDto::setBillNumber(const QString &bill_number) {
    m_bill_number = bill_number;
    m_bill_number_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_bill_number_Set() const{
    return m_bill_number_isSet;
}

bool OAIDetailsInFixedAssetDto::is_bill_number_Valid() const{
    return m_bill_number_isValid;
}

QDateTime OAIDetailsInFixedAssetDto::getDepreciateFromDate() const {
    return m_depreciate_from_date;
}
void OAIDetailsInFixedAssetDto::setDepreciateFromDate(const QDateTime &depreciate_from_date) {
    m_depreciate_from_date = depreciate_from_date;
    m_depreciate_from_date_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_depreciate_from_date_Set() const{
    return m_depreciate_from_date_isSet;
}

bool OAIDetailsInFixedAssetDto::is_depreciate_from_date_Valid() const{
    return m_depreciate_from_date_isValid;
}

QDateTime OAIDetailsInFixedAssetDto::getDisposalDate() const {
    return m_disposal_date;
}
void OAIDetailsInFixedAssetDto::setDisposalDate(const QDateTime &disposal_date) {
    m_disposal_date = disposal_date;
    m_disposal_date_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_disposal_date_Set() const{
    return m_disposal_date_isSet;
}

bool OAIDetailsInFixedAssetDto::is_disposal_date_Valid() const{
    return m_disposal_date_isValid;
}

OAIDisposalMethodInDetailsDto OAIDetailsInFixedAssetDto::getDisposalMethod() const {
    return m_disposal_method;
}
void OAIDetailsInFixedAssetDto::setDisposalMethod(const OAIDisposalMethodInDetailsDto &disposal_method) {
    m_disposal_method = disposal_method;
    m_disposal_method_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_disposal_method_Set() const{
    return m_disposal_method_isSet;
}

bool OAIDetailsInFixedAssetDto::is_disposal_method_Valid() const{
    return m_disposal_method_isValid;
}

qint32 OAIDetailsInFixedAssetDto::getDisposalMethodId() const {
    return m_disposal_method_id;
}
void OAIDetailsInFixedAssetDto::setDisposalMethodId(const qint32 &disposal_method_id) {
    m_disposal_method_id = disposal_method_id;
    m_disposal_method_id_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_disposal_method_id_Set() const{
    return m_disposal_method_id_isSet;
}

bool OAIDetailsInFixedAssetDto::is_disposal_method_id_Valid() const{
    return m_disposal_method_id_isValid;
}

QString OAIDetailsInFixedAssetDto::getDisposalPeriodId() const {
    return m_disposal_period_id;
}
void OAIDetailsInFixedAssetDto::setDisposalPeriodId(const QString &disposal_period_id) {
    m_disposal_period_id = disposal_period_id;
    m_disposal_period_id_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_disposal_period_id_Set() const{
    return m_disposal_period_id_isSet;
}

bool OAIDetailsInFixedAssetDto::is_disposal_period_id_Valid() const{
    return m_disposal_period_id_isValid;
}

OAILeaseAndRentInfoInDetailsDto OAIDetailsInFixedAssetDto::getLeaseAndRentInfo() const {
    return m_lease_and_rent_info;
}
void OAIDetailsInFixedAssetDto::setLeaseAndRentInfo(const OAILeaseAndRentInfoInDetailsDto &lease_and_rent_info) {
    m_lease_and_rent_info = lease_and_rent_info;
    m_lease_and_rent_info_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_lease_and_rent_info_Set() const{
    return m_lease_and_rent_info_isSet;
}

bool OAIDetailsInFixedAssetDto::is_lease_and_rent_info_Valid() const{
    return m_lease_and_rent_info_isValid;
}

QString OAIDetailsInFixedAssetDto::getPropertyType() const {
    return m_property_type;
}
void OAIDetailsInFixedAssetDto::setPropertyType(const QString &property_type) {
    m_property_type = property_type;
    m_property_type_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_property_type_Set() const{
    return m_property_type_isSet;
}

bool OAIDetailsInFixedAssetDto::is_property_type_Valid() const{
    return m_property_type_isValid;
}

QDateTime OAIDetailsInFixedAssetDto::getReceiptDate() const {
    return m_receipt_date;
}
void OAIDetailsInFixedAssetDto::setReceiptDate(const QDateTime &receipt_date) {
    m_receipt_date = receipt_date;
    m_receipt_date_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_receipt_date_Set() const{
    return m_receipt_date_isSet;
}

bool OAIDetailsInFixedAssetDto::is_receipt_date_Valid() const{
    return m_receipt_date_isValid;
}

double OAIDetailsInFixedAssetDto::getSaleAmount() const {
    return m_sale_amount;
}
void OAIDetailsInFixedAssetDto::setSaleAmount(const double &sale_amount) {
    m_sale_amount = sale_amount;
    m_sale_amount_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_sale_amount_Set() const{
    return m_sale_amount_isSet;
}

bool OAIDetailsInFixedAssetDto::is_sale_amount_Valid() const{
    return m_sale_amount_isValid;
}

double OAIDetailsInFixedAssetDto::getSalvageAmount() const {
    return m_salvage_amount;
}
void OAIDetailsInFixedAssetDto::setSalvageAmount(const double &salvage_amount) {
    m_salvage_amount = salvage_amount;
    m_salvage_amount_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_salvage_amount_Set() const{
    return m_salvage_amount_isSet;
}

bool OAIDetailsInFixedAssetDto::is_salvage_amount_Valid() const{
    return m_salvage_amount_isValid;
}

QString OAIDetailsInFixedAssetDto::getSerialNumber() const {
    return m_serial_number;
}
void OAIDetailsInFixedAssetDto::setSerialNumber(const QString &serial_number) {
    m_serial_number = serial_number;
    m_serial_number_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_serial_number_Set() const{
    return m_serial_number_isSet;
}

bool OAIDetailsInFixedAssetDto::is_serial_number_Valid() const{
    return m_serial_number_isValid;
}

QString OAIDetailsInFixedAssetDto::getStatus() const {
    return m_status;
}
void OAIDetailsInFixedAssetDto::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDetailsInFixedAssetDto::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDetailsInFixedAssetDto::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIDetailsInFixedAssetDto::isSet() const {
...
bool OAIDetailsInFixedAssetDto::isValid() const {
