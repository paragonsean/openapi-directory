...
/*
 * OAISubaccountInCustomerInvoiceDto.h
 *
 * The Document details tab &amp;gt; Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCustomerInvoiceDto_H
#define OAISubaccountInCustomerInvoiceDto_H
...
class OAISubaccountInCustomerInvoiceDto : public OAIObject {
public:
    OAISubaccountInCustomerInvoiceDto();
    OAISubaccountInCustomerInvoiceDto(QString json);
    ~OAISubaccountInCustomerInvoiceDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCustomerInvoiceDto)

#endif // OAISubaccountInCustomerInvoiceDto_H
