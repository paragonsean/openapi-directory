...
/*
 * OAIBasePaginationDtoOfKitSpecificationDto.h
 *
 * 
 */

#ifndef OAIBasePaginationDtoOfKitSpecificationDto_H
#define OAIBasePaginationDtoOfKitSpecificationDto_H
...
namespace OpenAPI {
class OAIKitSpecificationDto;

class OAIBasePaginationDtoOfKitSpecificationDto : public OAIObject {
public:
    OAIBasePaginationDtoOfKitSpecificationDto();
    OAIBasePaginationDtoOfKitSpecificationDto(QString json);
    ~OAIBasePaginationDtoOfKitSpecificationDto() override;
    ...
    QList<OAIKitSpecificationDto> getRecords() const;
    void setRecords(const QList<OAIKitSpecificationDto> &records);
...
private:
    ...
    QList<OAIKitSpecificationDto> m_records;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBasePaginationDtoOfKitSpecificationDto)

#endif // OAIBasePaginationDtoOfKitSpecificationDto_H
