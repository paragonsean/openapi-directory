...
/*
 * OAICountryInAddressDto.h
 *
 * Country &amp;gt; The country.
 */

#ifndef OAICountryInAddressDto_H
#define OAICountryInAddressDto_H
...
class OAICountryInAddressDto : public OAIObject {
public:
    OAICountryInAddressDto();
    OAICountryInAddressDto(QString json);
    ~OAICountryInAddressDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICountryInAddressDto)

#endif // OAICountryInAddressDto_H
