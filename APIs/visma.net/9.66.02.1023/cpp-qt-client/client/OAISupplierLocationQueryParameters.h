...
/*
 * OAISupplierLocationQueryParameters.h
 *
 * 
 */

#ifndef OAISupplierLocationQueryParameters_H
#define OAISupplierLocationQueryParameters_H
...
class OAISupplierLocationQueryParameters : public OAIObject {
public:
    OAISupplierLocationQueryParameters();
    OAISupplierLocationQueryParameters(QString json);
    ~OAISupplierLocationQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupplierLocationQueryParameters)

#endif // OAISupplierLocationQueryParameters_H
