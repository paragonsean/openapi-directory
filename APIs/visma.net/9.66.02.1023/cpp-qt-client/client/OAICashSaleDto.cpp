...
OAICashSaleDto::OAICashSaleDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICashSaleDto::OAICashSaleDto() {
    this->initializeModel();
}

OAICashSaleDto::~OAICashSaleDto() {}

void OAICashSaleDto::initializeModel() {
...
void OAICashSaleDto::fromJson(QString jsonString) {
...
void OAICashSaleDto::fromJsonObject(QJsonObject json) {
...
QString OAICashSaleDto::asJson() const {
...
QJsonObject OAICashSaleDto::asJsonObject() const {
    QJsonObject obj;
    if (m_account.isSet()) {
...
OAIAccountInCashSaleDto OAICashSaleDto::getAccount() const {
    return m_account;
}
void OAICashSaleDto::setAccount(const OAIAccountInCashSaleDto &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAICashSaleDto::is_account_Set() const{
    return m_account_isSet;
}

bool OAICashSaleDto::is_account_Valid() const{
    return m_account_isValid;
}

double OAICashSaleDto::getAmount() const {
    return m_amount;
}
void OAICashSaleDto::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAICashSaleDto::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAICashSaleDto::is_amount_Valid() const{
    return m_amount_isValid;
}

double OAICashSaleDto::getAmountInCurrency() const {
    return m_amount_in_currency;
}
void OAICashSaleDto::setAmountInCurrency(const double &amount_in_currency) {
    m_amount_in_currency = amount_in_currency;
    m_amount_in_currency_isSet = true;
}

bool OAICashSaleDto::is_amount_in_currency_Set() const{
    return m_amount_in_currency_isSet;
}

bool OAICashSaleDto::is_amount_in_currency_Valid() const{
    return m_amount_in_currency_isValid;
}

QList<OAIArAdjustDto> OAICashSaleDto::getApplications() const {
    return m_applications;
}
void OAICashSaleDto::setApplications(const QList<OAIArAdjustDto> &applications) {
    m_applications = applications;
    m_applications_isSet = true;
}

bool OAICashSaleDto::is_applications_Set() const{
    return m_applications_isSet;
}

bool OAICashSaleDto::is_applications_Valid() const{
    return m_applications_isValid;
}

double OAICashSaleDto::getBalance() const {
    return m_balance;
}
void OAICashSaleDto::setBalance(const double &balance) {
    m_balance = balance;
    m_balance_isSet = true;
}

bool OAICashSaleDto::is_balance_Set() const{
    return m_balance_isSet;
}

bool OAICashSaleDto::is_balance_Valid() const{
    return m_balance_isValid;
}

double OAICashSaleDto::getBalanceInCurrency() const {
    return m_balance_in_currency;
}
void OAICashSaleDto::setBalanceInCurrency(const double &balance_in_currency) {
    m_balance_in_currency = balance_in_currency;
    m_balance_in_currency_isSet = true;
}

bool OAICashSaleDto::is_balance_in_currency_Set() const{
    return m_balance_in_currency_isSet;
}

bool OAICashSaleDto::is_balance_in_currency_Valid() const{
    return m_balance_in_currency_isValid;
}

OAIBranchNumberInCashSaleDto OAICashSaleDto::getBranchNumber() const {
    return m_branch_number;
}
void OAICashSaleDto::setBranchNumber(const OAIBranchNumberInCashSaleDto &branch_number) {
    m_branch_number = branch_number;
    m_branch_number_isSet = true;
}

bool OAICashSaleDto::is_branch_number_Set() const{
    return m_branch_number_isSet;
}

bool OAICashSaleDto::is_branch_number_Valid() const{
    return m_branch_number_isValid;
}

QString OAICashSaleDto::getCashAccount() const {
    return m_cash_account;
}
void OAICashSaleDto::setCashAccount(const QString &cash_account) {
    m_cash_account = cash_account;
    m_cash_account_isSet = true;
}

bool OAICashSaleDto::is_cash_account_Set() const{
    return m_cash_account_isSet;
}

bool OAICashSaleDto::is_cash_account_Valid() const{
    return m_cash_account_isValid;
}

double OAICashSaleDto::getCashDiscount() const {
    return m_cash_discount;
}
void OAICashSaleDto::setCashDiscount(const double &cash_discount) {
    m_cash_discount = cash_discount;
    m_cash_discount_isSet = true;
}

bool OAICashSaleDto::is_cash_discount_Set() const{
    return m_cash_discount_isSet;
}

bool OAICashSaleDto::is_cash_discount_Valid() const{
    return m_cash_discount_isValid;
}

double OAICashSaleDto::getCashDiscountInCurrency() const {
    return m_cash_discount_in_currency;
}
void OAICashSaleDto::setCashDiscountInCurrency(const double &cash_discount_in_currency) {
    m_cash_discount_in_currency = cash_discount_in_currency;
    m_cash_discount_in_currency_isSet = true;
}

bool OAICashSaleDto::is_cash_discount_in_currency_Set() const{
    return m_cash_discount_in_currency_isSet;
}

bool OAICashSaleDto::is_cash_discount_in_currency_Valid() const{
    return m_cash_discount_in_currency_isValid;
}

QList<OAICashSaleLineDto> OAICashSaleDto::getCashSaleLines() const {
    return m_cash_sale_lines;
}
void OAICashSaleDto::setCashSaleLines(const QList<OAICashSaleLineDto> &cash_sale_lines) {
    m_cash_sale_lines = cash_sale_lines;
    m_cash_sale_lines_isSet = true;
}

bool OAICashSaleDto::is_cash_sale_lines_Set() const{
    return m_cash_sale_lines_isSet;
}

bool OAICashSaleDto::is_cash_sale_lines_Valid() const{
    return m_cash_sale_lines_isValid;
}

QString OAICashSaleDto::getClosedFinancialPeriod() const {
    return m_closed_financial_period;
}
void OAICashSaleDto::setClosedFinancialPeriod(const QString &closed_financial_period) {
    m_closed_financial_period = closed_financial_period;
    m_closed_financial_period_isSet = true;
}

bool OAICashSaleDto::is_closed_financial_period_Set() const{
    return m_closed_financial_period_isSet;
}

bool OAICashSaleDto::is_closed_financial_period_Valid() const{
    return m_closed_financial_period_isValid;
}

QDateTime OAICashSaleDto::getCreatedDateTime() const {
    return m_created_date_time;
}
void OAICashSaleDto::setCreatedDateTime(const QDateTime &created_date_time) {
    m_created_date_time = created_date_time;
    m_created_date_time_isSet = true;
}

bool OAICashSaleDto::is_created_date_time_Set() const{
    return m_created_date_time_isSet;
}

bool OAICashSaleDto::is_created_date_time_Valid() const{
    return m_created_date_time_isValid;
}

OAICreditTermsInCashSaleDto OAICashSaleDto::getCreditTerms() const {
    return m_credit_terms;
}
void OAICashSaleDto::setCreditTerms(const OAICreditTermsInCashSaleDto &credit_terms) {
    m_credit_terms = credit_terms;
    m_credit_terms_isSet = true;
}

bool OAICashSaleDto::is_credit_terms_Set() const{
    return m_credit_terms_isSet;
}

bool OAICashSaleDto::is_credit_terms_Valid() const{
    return m_credit_terms_isValid;
}

QString OAICashSaleDto::getCurrencyId() const {
    return m_currency_id;
}
void OAICashSaleDto::setCurrencyId(const QString &currency_id) {
    m_currency_id = currency_id;
    m_currency_id_isSet = true;
}

bool OAICashSaleDto::is_currency_id_Set() const{
    return m_currency_id_isSet;
}

bool OAICashSaleDto::is_currency_id_Valid() const{
    return m_currency_id_isValid;
}

OAICustomerInCashSaleDto OAICashSaleDto::getCustomer() const {
    return m_customer;
}
void OAICashSaleDto::setCustomer(const OAICustomerInCashSaleDto &customer) {
    m_customer = customer;
    m_customer_isSet = true;
}

bool OAICashSaleDto::is_customer_Set() const{
    return m_customer_isSet;
}

bool OAICashSaleDto::is_customer_Valid() const{
    return m_customer_isValid;
}

QString OAICashSaleDto::getCustomerProject() const {
    return m_customer_project;
}
void OAICashSaleDto::setCustomerProject(const QString &customer_project) {
    m_customer_project = customer_project;
    m_customer_project_isSet = true;
}

bool OAICashSaleDto::is_customer_project_Set() const{
    return m_customer_project_isSet;
}

bool OAICashSaleDto::is_customer_project_Valid() const{
    return m_customer_project_isValid;
}

QString OAICashSaleDto::getCustomerRefNumber() const {
    return m_customer_ref_number;
}
void OAICashSaleDto::setCustomerRefNumber(const QString &customer_ref_number) {
    m_customer_ref_number = customer_ref_number;
    m_customer_ref_number_isSet = true;
}

bool OAICashSaleDto::is_customer_ref_number_Set() const{
    return m_customer_ref_number_isSet;
}

bool OAICashSaleDto::is_customer_ref_number_Valid() const{
    return m_customer_ref_number_isValid;
}

double OAICashSaleDto::getDetailTotal() const {
    return m_detail_total;
}
void OAICashSaleDto::setDetailTotal(const double &detail_total) {
    m_detail_total = detail_total;
    m_detail_total_isSet = true;
}

bool OAICashSaleDto::is_detail_total_Set() const{
    return m_detail_total_isSet;
}

bool OAICashSaleDto::is_detail_total_Valid() const{
    return m_detail_total_isValid;
}

double OAICashSaleDto::getDetailTotalInCurrency() const {
    return m_detail_total_in_currency;
}
void OAICashSaleDto::setDetailTotalInCurrency(const double &detail_total_in_currency) {
    m_detail_total_in_currency = detail_total_in_currency;
    m_detail_total_in_currency_isSet = true;
}

bool OAICashSaleDto::is_detail_total_in_currency_Set() const{
    return m_detail_total_in_currency_isSet;
}

bool OAICashSaleDto::is_detail_total_in_currency_Valid() const{
    return m_detail_total_in_currency_isValid;
}

double OAICashSaleDto::getDiscountTotal() const {
    return m_discount_total;
}
void OAICashSaleDto::setDiscountTotal(const double &discount_total) {
    m_discount_total = discount_total;
    m_discount_total_isSet = true;
}

bool OAICashSaleDto::is_discount_total_Set() const{
    return m_discount_total_isSet;
}

bool OAICashSaleDto::is_discount_total_Valid() const{
    return m_discount_total_isValid;
}

double OAICashSaleDto::getDiscountTotalInCurrency() const {
    return m_discount_total_in_currency;
}
void OAICashSaleDto::setDiscountTotalInCurrency(const double &discount_total_in_currency) {
    m_discount_total_in_currency = discount_total_in_currency;
    m_discount_total_in_currency_isSet = true;
}

bool OAICashSaleDto::is_discount_total_in_currency_Set() const{
    return m_discount_total_in_currency_isSet;
}

bool OAICashSaleDto::is_discount_total_in_currency_Valid() const{
    return m_discount_total_in_currency_isValid;
}

QDateTime OAICashSaleDto::getDocumentDate() const {
    return m_document_date;
}
void OAICashSaleDto::setDocumentDate(const QDateTime &document_date) {
    m_document_date = document_date;
    m_document_date_isSet = true;
}

bool OAICashSaleDto::is_document_date_Set() const{
    return m_document_date_isSet;
}

bool OAICashSaleDto::is_document_date_Valid() const{
    return m_document_date_isValid;
}

QString OAICashSaleDto::getDocumentType() const {
    return m_document_type;
}
void OAICashSaleDto::setDocumentType(const QString &document_type) {
    m_document_type = document_type;
    m_document_type_isSet = true;
}

bool OAICashSaleDto::is_document_type_Set() const{
    return m_document_type_isSet;
}

bool OAICashSaleDto::is_document_type_Valid() const{
    return m_document_type_isValid;
}

bool OAICashSaleDto::isDontEmail() const {
    return m_dont_email;
}
void OAICashSaleDto::setDontEmail(const bool &dont_email) {
    m_dont_email = dont_email;
    m_dont_email_isSet = true;
}

bool OAICashSaleDto::is_dont_email_Set() const{
    return m_dont_email_isSet;
}

bool OAICashSaleDto::is_dont_email_Valid() const{
    return m_dont_email_isValid;
}

bool OAICashSaleDto::isDontPrint() const {
    return m_dont_print;
}
void OAICashSaleDto::setDontPrint(const bool &dont_print) {
    m_dont_print = dont_print;
    m_dont_print_isSet = true;
}

bool OAICashSaleDto::is_dont_print_Set() const{
    return m_dont_print_isSet;
}

bool OAICashSaleDto::is_dont_print_Valid() const{
    return m_dont_print_isValid;
}

QString OAICashSaleDto::getErrorInfo() const {
    return m_error_info;
}
void OAICashSaleDto::setErrorInfo(const QString &error_info) {
    m_error_info = error_info;
    m_error_info_isSet = true;
}

bool OAICashSaleDto::is_error_info_Set() const{
    return m_error_info_isSet;
}

bool OAICashSaleDto::is_error_info_Valid() const{
    return m_error_info_isValid;
}

QString OAICashSaleDto::getFinancialPeriod() const {
    return m_financial_period;
}
void OAICashSaleDto::setFinancialPeriod(const QString &financial_period) {
    m_financial_period = financial_period;
    m_financial_period_isSet = true;
}

bool OAICashSaleDto::is_financial_period_Set() const{
    return m_financial_period_isSet;
}

bool OAICashSaleDto::is_financial_period_Valid() const{
    return m_financial_period_isValid;
}

bool OAICashSaleDto::isHold() const {
    return m_hold;
}
void OAICashSaleDto::setHold(const bool &hold) {
    m_hold = hold;
    m_hold_isSet = true;
}

bool OAICashSaleDto::is_hold_Set() const{
    return m_hold_isSet;
}

bool OAICashSaleDto::is_hold_Valid() const{
    return m_hold_isValid;
}

OAIInvoiceAddressInCashSaleDto OAICashSaleDto::getInvoiceAddress() const {
    return m_invoice_address;
}
void OAICashSaleDto::setInvoiceAddress(const OAIInvoiceAddressInCashSaleDto &invoice_address) {
    m_invoice_address = invoice_address;
    m_invoice_address_isSet = true;
}

bool OAICashSaleDto::is_invoice_address_Set() const{
    return m_invoice_address_isSet;
}

bool OAICashSaleDto::is_invoice_address_Valid() const{
    return m_invoice_address_isValid;
}

OAIInvoiceContactInCashSaleDto OAICashSaleDto::getInvoiceContact() const {
    return m_invoice_contact;
}
void OAICashSaleDto::setInvoiceContact(const OAIInvoiceContactInCashSaleDto &invoice_contact) {
    m_invoice_contact = invoice_contact;
    m_invoice_contact_isSet = true;
}

bool OAICashSaleDto::is_invoice_contact_Set() const{
    return m_invoice_contact_isSet;
}

bool OAICashSaleDto::is_invoice_contact_Valid() const{
    return m_invoice_contact_isValid;
}

QString OAICashSaleDto::getInvoiceText() const {
    return m_invoice_text;
}
void OAICashSaleDto::setInvoiceText(const QString &invoice_text) {
    m_invoice_text = invoice_text;
    m_invoice_text_isSet = true;
}

bool OAICashSaleDto::is_invoice_text_Set() const{
    return m_invoice_text_isSet;
}

bool OAICashSaleDto::is_invoice_text_Valid() const{
    return m_invoice_text_isValid;
}

QDateTime OAICashSaleDto::getLastModifiedDateTime() const {
    return m_last_modified_date_time;
}
void OAICashSaleDto::setLastModifiedDateTime(const QDateTime &last_modified_date_time) {
    m_last_modified_date_time = last_modified_date_time;
    m_last_modified_date_time_isSet = true;
}

bool OAICashSaleDto::is_last_modified_date_time_Set() const{
    return m_last_modified_date_time_isSet;
}

bool OAICashSaleDto::is_last_modified_date_time_Valid() const{
    return m_last_modified_date_time_isValid;
}

OAILocationInCashSaleDto OAICashSaleDto::getLocation() const {
    return m_location;
}
void OAICashSaleDto::setLocation(const OAILocationInCashSaleDto &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAICashSaleDto::is_location_Set() const{
    return m_location_isSet;
}

bool OAICashSaleDto::is_location_Valid() const{
    return m_location_isValid;
}

OAIMetadataDto OAICashSaleDto::getMetadata() const {
    return m_metadata;
}
void OAICashSaleDto::setMetadata(const OAIMetadataDto &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAICashSaleDto::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAICashSaleDto::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QString OAICashSaleDto::getNote() const {
    return m_note;
}
void OAICashSaleDto::setNote(const QString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAICashSaleDto::is_note_Set() const{
    return m_note_isSet;
}

bool OAICashSaleDto::is_note_Valid() const{
    return m_note_isValid;
}

QDateTime OAICashSaleDto::getOrigInvoiceDate() const {
    return m_orig_invoice_date;
}
void OAICashSaleDto::setOrigInvoiceDate(const QDateTime &orig_invoice_date) {
    m_orig_invoice_date = orig_invoice_date;
    m_orig_invoice_date_isSet = true;
}

bool OAICashSaleDto::is_orig_invoice_date_Set() const{
    return m_orig_invoice_date_isSet;
}

bool OAICashSaleDto::is_orig_invoice_date_Valid() const{
    return m_orig_invoice_date_isValid;
}

OAIPaymentMethodInCashSaleDto OAICashSaleDto::getPaymentMethod() const {
    return m_payment_method;
}
void OAICashSaleDto::setPaymentMethod(const OAIPaymentMethodInCashSaleDto &payment_method) {
    m_payment_method = payment_method;
    m_payment_method_isSet = true;
}

bool OAICashSaleDto::is_payment_method_Set() const{
    return m_payment_method_isSet;
}

bool OAICashSaleDto::is_payment_method_Valid() const{
    return m_payment_method_isValid;
}

QString OAICashSaleDto::getPaymentReference() const {
    return m_payment_reference;
}
void OAICashSaleDto::setPaymentReference(const QString &payment_reference) {
    m_payment_reference = payment_reference;
    m_payment_reference_isSet = true;
}

bool OAICashSaleDto::is_payment_reference_Set() const{
    return m_payment_reference_isSet;
}

bool OAICashSaleDto::is_payment_reference_Valid() const{
    return m_payment_reference_isValid;
}

QString OAICashSaleDto::getPostPeriod() const {
    return m_post_period;
}
void OAICashSaleDto::setPostPeriod(const QString &post_period) {
    m_post_period = post_period;
    m_post_period_isSet = true;
}

bool OAICashSaleDto::is_post_period_Set() const{
    return m_post_period_isSet;
}

bool OAICashSaleDto::is_post_period_Valid() const{
    return m_post_period_isValid;
}

OAIProjectInCashSaleDto OAICashSaleDto::getProject() const {
    return m_project;
}
void OAICashSaleDto::setProject(const OAIProjectInCashSaleDto &project) {
    m_project = project;
    m_project_isSet = true;
}

bool OAICashSaleDto::is_project_Set() const{
    return m_project_isSet;
}

bool OAICashSaleDto::is_project_Valid() const{
    return m_project_isValid;
}

QString OAICashSaleDto::getReferenceNumber() const {
    return m_reference_number;
}
void OAICashSaleDto::setReferenceNumber(const QString &reference_number) {
    m_reference_number = reference_number;
    m_reference_number_isSet = true;
}

bool OAICashSaleDto::is_reference_number_Set() const{
    return m_reference_number_isSet;
}

bool OAICashSaleDto::is_reference_number_Valid() const{
    return m_reference_number_isValid;
}

OAISalesPersonInCashSaleDto OAICashSaleDto::getSalesPerson() const {
    return m_sales_person;
}
void OAICashSaleDto::setSalesPerson(const OAISalesPersonInCashSaleDto &sales_person) {
    m_sales_person = sales_person;
    m_sales_person_isSet = true;
}

bool OAICashSaleDto::is_sales_person_Set() const{
    return m_sales_person_isSet;
}

bool OAICashSaleDto::is_sales_person_Valid() const{
    return m_sales_person_isValid;
}

QString OAICashSaleDto::getSalesPersonDescr() const {
    return m_sales_person_descr;
}
void OAICashSaleDto::setSalesPersonDescr(const QString &sales_person_descr) {
    m_sales_person_descr = sales_person_descr;
    m_sales_person_descr_isSet = true;
}

bool OAICashSaleDto::is_sales_person_descr_Set() const{
    return m_sales_person_descr_isSet;
}

bool OAICashSaleDto::is_sales_person_descr_Valid() const{
    return m_sales_person_descr_isValid;
}

qint32 OAICashSaleDto::getSalesPersonId() const {
    return m_sales_person_id;
}
void OAICashSaleDto::setSalesPersonId(const qint32 &sales_person_id) {
    m_sales_person_id = sales_person_id;
    m_sales_person_id_isSet = true;
}

bool OAICashSaleDto::is_sales_person_id_Set() const{
    return m_sales_person_id_isSet;
}

bool OAICashSaleDto::is_sales_person_id_Valid() const{
    return m_sales_person_id_isValid;
}

QString OAICashSaleDto::getStatus() const {
    return m_status;
}
void OAICashSaleDto::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICashSaleDto::is_status_Set() const{
    return m_status_isSet;
}

bool OAICashSaleDto::is_status_Valid() const{
    return m_status_isValid;
}

OAISubaccountInCashSaleDto OAICashSaleDto::getSubaccount() const {
    return m_subaccount;
}
void OAICashSaleDto::setSubaccount(const OAISubaccountInCashSaleDto &subaccount) {
    m_subaccount = subaccount;
    m_subaccount_isSet = true;
}

bool OAICashSaleDto::is_subaccount_Set() const{
    return m_subaccount_isSet;
}

bool OAICashSaleDto::is_subaccount_Valid() const{
    return m_subaccount_isValid;
}

double OAICashSaleDto::getVatExemptTotal() const {
    return m_vat_exempt_total;
}
void OAICashSaleDto::setVatExemptTotal(const double &vat_exempt_total) {
    m_vat_exempt_total = vat_exempt_total;
    m_vat_exempt_total_isSet = true;
}

bool OAICashSaleDto::is_vat_exempt_total_Set() const{
    return m_vat_exempt_total_isSet;
}

bool OAICashSaleDto::is_vat_exempt_total_Valid() const{
    return m_vat_exempt_total_isValid;
}

double OAICashSaleDto::getVatExemptTotalInCurrency() const {
    return m_vat_exempt_total_in_currency;
}
void OAICashSaleDto::setVatExemptTotalInCurrency(const double &vat_exempt_total_in_currency) {
    m_vat_exempt_total_in_currency = vat_exempt_total_in_currency;
    m_vat_exempt_total_in_currency_isSet = true;
}

bool OAICashSaleDto::is_vat_exempt_total_in_currency_Set() const{
    return m_vat_exempt_total_in_currency_isSet;
}

bool OAICashSaleDto::is_vat_exempt_total_in_currency_Valid() const{
    return m_vat_exempt_total_in_currency_isValid;
}

double OAICashSaleDto::getVatTaxableTotal() const {
    return m_vat_taxable_total;
}
void OAICashSaleDto::setVatTaxableTotal(const double &vat_taxable_total) {
    m_vat_taxable_total = vat_taxable_total;
    m_vat_taxable_total_isSet = true;
}

bool OAICashSaleDto::is_vat_taxable_total_Set() const{
    return m_vat_taxable_total_isSet;
}

bool OAICashSaleDto::is_vat_taxable_total_Valid() const{
    return m_vat_taxable_total_isValid;
}

double OAICashSaleDto::getVatTaxableTotalInCurrency() const {
    return m_vat_taxable_total_in_currency;
}
void OAICashSaleDto::setVatTaxableTotalInCurrency(const double &vat_taxable_total_in_currency) {
    m_vat_taxable_total_in_currency = vat_taxable_total_in_currency;
    m_vat_taxable_total_in_currency_isSet = true;
}

bool OAICashSaleDto::is_vat_taxable_total_in_currency_Set() const{
    return m_vat_taxable_total_in_currency_isSet;
}

bool OAICashSaleDto::is_vat_taxable_total_in_currency_Valid() const{
    return m_vat_taxable_total_in_currency_isValid;
}

double OAICashSaleDto::getVatTotal() const {
    return m_vat_total;
}
void OAICashSaleDto::setVatTotal(const double &vat_total) {
    m_vat_total = vat_total;
    m_vat_total_isSet = true;
}

bool OAICashSaleDto::is_vat_total_Set() const{
    return m_vat_total_isSet;
}

bool OAICashSaleDto::is_vat_total_Valid() const{
    return m_vat_total_isValid;
}

double OAICashSaleDto::getVatTotalInCurrency() const {
    return m_vat_total_in_currency;
}
void OAICashSaleDto::setVatTotalInCurrency(const double &vat_total_in_currency) {
    m_vat_total_in_currency = vat_total_in_currency;
    m_vat_total_in_currency_isSet = true;
}

bool OAICashSaleDto::is_vat_total_in_currency_Set() const{
    return m_vat_total_in_currency_isSet;
}

bool OAICashSaleDto::is_vat_total_in_currency_Valid() const{
    return m_vat_total_in_currency_isValid;
}

bool OAICashSaleDto::isSet() const {
...
bool OAICashSaleDto::isValid() const {
