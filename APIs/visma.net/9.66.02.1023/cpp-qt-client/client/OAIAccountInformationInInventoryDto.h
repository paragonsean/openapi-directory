...
/*
 * OAIAccountInformationInInventoryDto.h
 *
 * General ledger account tab &amp;gt;
 */

#ifndef OAIAccountInformationInInventoryDto_H
#define OAIAccountInformationInInventoryDto_H
...
class OAIAccountInformationInInventoryDto : public OAIObject {
public:
    OAIAccountInformationInInventoryDto();
    OAIAccountInformationInInventoryDto(QString json);
    ~OAIAccountInformationInInventoryDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountInformationInInventoryDto)

#endif // OAIAccountInformationInInventoryDto_H
