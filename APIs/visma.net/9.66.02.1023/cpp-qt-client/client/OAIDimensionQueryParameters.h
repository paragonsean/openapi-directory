...
/*
 * OAIDimensionQueryParameters.h
 *
 * 
 */

#ifndef OAIDimensionQueryParameters_H
#define OAIDimensionQueryParameters_H
...
class OAIDimensionQueryParameters : public OAIObject {
public:
    OAIDimensionQueryParameters();
    OAIDimensionQueryParameters(QString json);
    ~OAIDimensionQueryParameters() override;
    ...
    bool isExpandSegmentsValues() const;
    void setExpandSegmentsValues(const bool &expand_segments_values);
    bool is_expand_segments_values_Set() const;
    bool is_expand_segments_values_Valid() const;
...
private:
    ...
    bool m_expand_segments_values;
    bool m_expand_segments_values_isSet;
    bool m_expand_segments_values_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDimensionQueryParameters)

#endif // OAIDimensionQueryParameters_H
