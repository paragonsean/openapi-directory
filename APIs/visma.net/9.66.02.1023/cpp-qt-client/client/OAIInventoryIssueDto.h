...
class OAIBranchNumberInInventoryIssueDto;
class OAIInventoryIssueLineDto;
class OAIMetadataDto;

class OAIInventoryIssueDto : public OAIObject {
public:
    OAIInventoryIssueDto();
    OAIInventoryIssueDto(QString json);
    ~OAIInventoryIssueDto() override;
    ...
    OAIBranchNumberInInventoryIssueDto getBranchNumber() const;
    void setBranchNumber(const OAIBranchNumberInInventoryIssueDto &branch_number);
    bool is_branch_number_Set() const;
    bool is_branch_number_Valid() const;

    double getControlAmount() const;
    void setControlAmount(const double &control_amount);
    ...
    QList<OAIInventoryIssueLineDto> getIssueLines() const;
    void setIssueLines(const QList<OAIInventoryIssueLineDto> &issue_lines);
...
private:
    ...
    OAIBranchNumberInInventoryIssueDto m_branch_number;
    bool m_branch_number_isSet;
    bool m_branch_number_isValid;

    double m_control_amount;
    ...
    QList<OAIInventoryIssueLineDto> m_issue_lines;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryIssueDto)

#endif // OAIInventoryIssueDto_H
