...
QJsonObject OAICustomerInvoiceDto::asJsonObject() const {
    ...
    if (m_accounting_cost_ref_isSet) {
...
OAIAccountInCustomerInvoiceDto OAICustomerInvoiceDto::getAccount() const {
    return m_account;
}
void OAICustomerInvoiceDto::setAccount(const OAIAccountInCustomerInvoiceDto &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAICustomerInvoiceDto::is_account_Set() const{
    return m_account_isSet;
}

bool OAICustomerInvoiceDto::is_account_Valid() const{
    return m_account_isValid;
}

QString OAICustomerInvoiceDto::getAccountingCostRef() const {
    return m_accounting_cost_ref;
}
void OAICustomerInvoiceDto::setAccountingCostRef(const QString &accounting_cost_ref) {
    m_accounting_cost_ref = accounting_cost_ref;
    m_accounting_cost_ref_isSet = true;
}

bool OAICustomerInvoiceDto::is_accounting_cost_ref_Set() const{
    return m_accounting_cost_ref_isSet;
}

bool OAICustomerInvoiceDto::is_accounting_cost_ref_Valid() const{
    return m_accounting_cost_ref_isValid;
}

double OAICustomerInvoiceDto::getAmount() const {
    return m_amount;
}
void OAICustomerInvoiceDto::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAICustomerInvoiceDto::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAICustomerInvoiceDto::is_amount_Valid() const{
    return m_amount_isValid;
}

double OAICustomerInvoiceDto::getAmountInCurrency() const {
    return m_amount_in_currency;
}
void OAICustomerInvoiceDto::setAmountInCurrency(const double &amount_in_currency) {
    m_amount_in_currency = amount_in_currency;
    m_amount_in_currency_isSet = true;
}

bool OAICustomerInvoiceDto::is_amount_in_currency_Set() const{
    return m_amount_in_currency_isSet;
}

bool OAICustomerInvoiceDto::is_amount_in_currency_Valid() const{
    return m_amount_in_currency_isValid;
}

QList<OAIArAdjustDto> OAICustomerInvoiceDto::getApplications() const {
    return m_applications;
}
void OAICustomerInvoiceDto::setApplications(const QList<OAIArAdjustDto> &applications) {
    m_applications = applications;
    m_applications_isSet = true;
}

bool OAICustomerInvoiceDto::is_applications_Set() const{
    return m_applications_isSet;
}

bool OAICustomerInvoiceDto::is_applications_Valid() const{
    return m_applications_isValid;
}

QList<OAIAttachmentDto> OAICustomerInvoiceDto::getAttachments() const {
    return m_attachments;
}
void OAICustomerInvoiceDto::setAttachments(const QList<OAIAttachmentDto> &attachments) {
    m_attachments = attachments;
    m_attachments_isSet = true;
}

bool OAICustomerInvoiceDto::is_attachments_Set() const{
    return m_attachments_isSet;
}

bool OAICustomerInvoiceDto::is_attachments_Valid() const{
    return m_attachments_isValid;
}

double OAICustomerInvoiceDto::getBalance() const {
    return m_balance;
}
void OAICustomerInvoiceDto::setBalance(const double &balance) {
    m_balance = balance;
    m_balance_isSet = true;
}

bool OAICustomerInvoiceDto::is_balance_Set() const{
    return m_balance_isSet;
}

bool OAICustomerInvoiceDto::is_balance_Valid() const{
    return m_balance_isValid;
}

double OAICustomerInvoiceDto::getBalanceInCurrency() const {
    return m_balance_in_currency;
}
void OAICustomerInvoiceDto::setBalanceInCurrency(const double &balance_in_currency) {
    m_balance_in_currency = balance_in_currency;
    m_balance_in_currency_isSet = true;
}

bool OAICustomerInvoiceDto::is_balance_in_currency_Set() const{
    return m_balance_in_currency_isSet;
}

bool OAICustomerInvoiceDto::is_balance_in_currency_Valid() const{
    return m_balance_in_currency_isValid;
}

OAIBranchNumberInCustomerInvoiceDto OAICustomerInvoiceDto::getBranchNumber() const {
    return m_branch_number;
}
void OAICustomerInvoiceDto::setBranchNumber(const OAIBranchNumberInCustomerInvoiceDto &branch_number) {
    m_branch_number = branch_number;
    m_branch_number_isSet = true;
}

bool OAICustomerInvoiceDto::is_branch_number_Set() const{
    return m_branch_number_isSet;
}

bool OAICustomerInvoiceDto::is_branch_number_Valid() const{
    return m_branch_number_isValid;
}

QString OAICustomerInvoiceDto::getCashAccount() const {
    return m_cash_account;
}
void OAICustomerInvoiceDto::setCashAccount(const QString &cash_account) {
    m_cash_account = cash_account;
    m_cash_account_isSet = true;
}

bool OAICustomerInvoiceDto::is_cash_account_Set() const{
    return m_cash_account_isSet;
}

bool OAICustomerInvoiceDto::is_cash_account_Valid() const{
    return m_cash_account_isValid;
}

double OAICustomerInvoiceDto::getCashDiscount() const {
    return m_cash_discount;
}
void OAICustomerInvoiceDto::setCashDiscount(const double &cash_discount) {
    m_cash_discount = cash_discount;
    m_cash_discount_isSet = true;
}

bool OAICustomerInvoiceDto::is_cash_discount_Set() const{
    return m_cash_discount_isSet;
}

bool OAICustomerInvoiceDto::is_cash_discount_Valid() const{
    return m_cash_discount_isValid;
}

QDateTime OAICustomerInvoiceDto::getCashDiscountDate() const {
    return m_cash_discount_date;
}
void OAICustomerInvoiceDto::setCashDiscountDate(const QDateTime &cash_discount_date) {
    m_cash_discount_date = cash_discount_date;
    m_cash_discount_date_isSet = true;
}

bool OAICustomerInvoiceDto::is_cash_discount_date_Set() const{
    return m_cash_discount_date_isSet;
}

bool OAICustomerInvoiceDto::is_cash_discount_date_Valid() const{
    return m_cash_discount_date_isValid;
}

double OAICustomerInvoiceDto::getCashDiscountInCurrency() const {
    return m_cash_discount_in_currency;
}
void OAICustomerInvoiceDto::setCashDiscountInCurrency(const double &cash_discount_in_currency) {
    m_cash_discount_in_currency = cash_discount_in_currency;
    m_cash_discount_in_currency_isSet = true;
}

bool OAICustomerInvoiceDto::is_cash_discount_in_currency_Set() const{
    return m_cash_discount_in_currency_isSet;
}

bool OAICustomerInvoiceDto::is_cash_discount_in_currency_Valid() const{
    return m_cash_discount_in_currency_isValid;
}

QString OAICustomerInvoiceDto::getClosedFinancialPeriod() const {
    return m_closed_financial_period;
}
void OAICustomerInvoiceDto::setClosedFinancialPeriod(const QString &closed_financial_period) {
    m_closed_financial_period = closed_financial_period;
    m_closed_financial_period_isSet = true;
}

bool OAICustomerInvoiceDto::is_closed_financial_period_Set() const{
    return m_closed_financial_period_isSet;
}

bool OAICustomerInvoiceDto::is_closed_financial_period_Valid() const{
    return m_closed_financial_period_isValid;
}

OAIContactInCustomerInvoiceDto OAICustomerInvoiceDto::getContact() const {
    return m_contact;
}
void OAICustomerInvoiceDto::setContact(const OAIContactInCustomerInvoiceDto &contact) {
    m_contact = contact;
    m_contact_isSet = true;
}

bool OAICustomerInvoiceDto::is_contact_Set() const{
    return m_contact_isSet;
}

bool OAICustomerInvoiceDto::is_contact_Valid() const{
    return m_contact_isValid;
}

QString OAICustomerInvoiceDto::getContractDocRef() const {
    return m_contract_doc_ref;
}
void OAICustomerInvoiceDto::setContractDocRef(const QString &contract_doc_ref) {
    m_contract_doc_ref = contract_doc_ref;
    m_contract_doc_ref_isSet = true;
}

bool OAICustomerInvoiceDto::is_contract_doc_ref_Set() const{
    return m_contract_doc_ref_isSet;
}

bool OAICustomerInvoiceDto::is_contract_doc_ref_Valid() const{
    return m_contract_doc_ref_isValid;
}

QDateTime OAICustomerInvoiceDto::getCreatedDateTime() const {
    return m_created_date_time;
}
void OAICustomerInvoiceDto::setCreatedDateTime(const QDateTime &created_date_time) {
    m_created_date_time = created_date_time;
    m_created_date_time_isSet = true;
}

bool OAICustomerInvoiceDto::is_created_date_time_Set() const{
    return m_created_date_time_isSet;
}

bool OAICustomerInvoiceDto::is_created_date_time_Valid() const{
    return m_created_date_time_isValid;
}

OAICreditTermsInCustomerInvoiceDto OAICustomerInvoiceDto::getCreditTerms() const {
    return m_credit_terms;
}
void OAICustomerInvoiceDto::setCreditTerms(const OAICreditTermsInCustomerInvoiceDto &credit_terms) {
    m_credit_terms = credit_terms;
    m_credit_terms_isSet = true;
}

bool OAICustomerInvoiceDto::is_credit_terms_Set() const{
    return m_credit_terms_isSet;
}

bool OAICustomerInvoiceDto::is_credit_terms_Valid() const{
    return m_credit_terms_isValid;
}

QString OAICustomerInvoiceDto::getCurrencyId() const {
    return m_currency_id;
}
void OAICustomerInvoiceDto::setCurrencyId(const QString &currency_id) {
...
OAICustomerInCustomerInvoiceDto OAICustomerInvoiceDto::getCustomer() const {
    return m_customer;
}
void OAICustomerInvoiceDto::setCustomer(const OAICustomerInCustomerInvoiceDto &customer) {
    m_customer = customer;
    m_customer_isSet = true;
}

bool OAICustomerInvoiceDto::is_customer_Set() const{
    return m_customer_isSet;
}

bool OAICustomerInvoiceDto::is_customer_Valid() const{
    return m_customer_isValid;
}

QString OAICustomerInvoiceDto::getCustomerProject() const {
    return m_customer_project;
}
void OAICustomerInvoiceDto::setCustomerProject(const QString &customer_project) {
    m_customer_project = customer_project;
    m_customer_project_isSet = true;
}

bool OAICustomerInvoiceDto::is_customer_project_Set() const{
    return m_customer_project_isSet;
}

bool OAICustomerInvoiceDto::is_customer_project_Valid() const{
    return m_customer_project_isValid;
}

QString OAICustomerInvoiceDto::getCustomerRefNumber() const {
    return m_customer_ref_number;
}
void OAICustomerInvoiceDto::setCustomerRefNumber(const QString &customer_ref_number) {
    m_customer_ref_number = customer_ref_number;
    m_customer_ref_number_isSet = true;
}

bool OAICustomerInvoiceDto::is_customer_ref_number_Set() const{
    return m_customer_ref_number_isSet;
}

bool OAICustomerInvoiceDto::is_customer_ref_number_Valid() const{
    return m_customer_ref_number_isValid;
}

OAICustomerVatZoneInCustomerInvoiceDto OAICustomerInvoiceDto::getCustomerVatZone() const {
    return m_customer_vat_zone;
}
void OAICustomerInvoiceDto::setCustomerVatZone(const OAICustomerVatZoneInCustomerInvoiceDto &customer_vat_zone) {
    m_customer_vat_zone = customer_vat_zone;
    m_customer_vat_zone_isSet = true;
}

bool OAICustomerInvoiceDto::is_customer_vat_zone_Set() const{
    return m_customer_vat_zone_isSet;
}

bool OAICustomerInvoiceDto::is_customer_vat_zone_Valid() const{
    return m_customer_vat_zone_isValid;
}

double OAICustomerInvoiceDto::getDetailTotal() const {
    return m_detail_total;
}
void OAICustomerInvoiceDto::setDetailTotal(const double &detail_total) {
    m_detail_total = detail_total;
    m_detail_total_isSet = true;
}

bool OAICustomerInvoiceDto::is_detail_total_Set() const{
    return m_detail_total_isSet;
}

bool OAICustomerInvoiceDto::is_detail_total_Valid() const{
    return m_detail_total_isValid;
}

double OAICustomerInvoiceDto::getDetailTotalInCurrency() const {
    return m_detail_total_in_currency;
}
void OAICustomerInvoiceDto::setDetailTotalInCurrency(const double &detail_total_in_currency) {
    m_detail_total_in_currency = detail_total_in_currency;
    m_detail_total_in_currency_isSet = true;
}

bool OAICustomerInvoiceDto::is_detail_total_in_currency_Set() const{
    return m_detail_total_in_currency_isSet;
}

bool OAICustomerInvoiceDto::is_detail_total_in_currency_Valid() const{
    return m_detail_total_in_currency_isValid;
}

double OAICustomerInvoiceDto::getDiscountTotal() const {
    return m_discount_total;
}
void OAICustomerInvoiceDto::setDiscountTotal(const double &discount_total) {
    m_discount_total = discount_total;
    m_discount_total_isSet = true;
}

bool OAICustomerInvoiceDto::is_discount_total_Set() const{
    return m_discount_total_isSet;
}

bool OAICustomerInvoiceDto::is_discount_total_Valid() const{
    return m_discount_total_isValid;
}

double OAICustomerInvoiceDto::getDiscountTotalInCurrency() const {
    return m_discount_total_in_currency;
}
void OAICustomerInvoiceDto::setDiscountTotalInCurrency(const double &discount_total_in_currency) {
    m_discount_total_in_currency = discount_total_in_currency;
    m_discount_total_in_currency_isSet = true;
}

bool OAICustomerInvoiceDto::is_discount_total_in_currency_Set() const{
    return m_discount_total_in_currency_isSet;
}

bool OAICustomerInvoiceDto::is_discount_total_in_currency_Valid() const{
    return m_discount_total_in_currency_isValid;
}

QDateTime OAICustomerInvoiceDto::getDocumentDate() const {
    return m_document_date;
}
void OAICustomerInvoiceDto::setDocumentDate(const QDateTime &document_date) {
    m_document_date = document_date;
    m_document_date_isSet = true;
}

bool OAICustomerInvoiceDto::is_document_date_Set() const{
    return m_document_date_isSet;
}

bool OAICustomerInvoiceDto::is_document_date_Valid() const{
    return m_document_date_isValid;
}

QDateTime OAICustomerInvoiceDto::getDocumentDueDate() const {
    return m_document_due_date;
}
void OAICustomerInvoiceDto::setDocumentDueDate(const QDateTime &document_due_date) {
    m_document_due_date = document_due_date;
    m_document_due_date_isSet = true;
}

bool OAICustomerInvoiceDto::is_document_due_date_Set() const{
    return m_document_due_date_isSet;
}

bool OAICustomerInvoiceDto::is_document_due_date_Valid() const{
    return m_document_due_date_isValid;
}

QString OAICustomerInvoiceDto::getDocumentType() const {
    return m_document_type;
}
void OAICustomerInvoiceDto::setDocumentType(const QString &document_type) {
    m_document_type = document_type;
    m_document_type_isSet = true;
}

bool OAICustomerInvoiceDto::is_document_type_Set() const{
    return m_document_type_isSet;
}

bool OAICustomerInvoiceDto::is_document_type_Valid() const{
    return m_document_type_isValid;
}

bool OAICustomerInvoiceDto::isDontEmail() const {
    return m_dont_email;
}
void OAICustomerInvoiceDto::setDontEmail(const bool &dont_email) {
    m_dont_email = dont_email;
    m_dont_email_isSet = true;
}

bool OAICustomerInvoiceDto::is_dont_email_Set() const{
    return m_dont_email_isSet;
}

bool OAICustomerInvoiceDto::is_dont_email_Valid() const{
    return m_dont_email_isValid;
}

bool OAICustomerInvoiceDto::isDontPrint() const {
    return m_dont_print;
}
void OAICustomerInvoiceDto::setDontPrint(const bool &dont_print) {
    m_dont_print = dont_print;
    m_dont_print_isSet = true;
}

bool OAICustomerInvoiceDto::is_dont_print_Set() const{
    return m_dont_print_isSet;
}

bool OAICustomerInvoiceDto::is_dont_print_Valid() const{
    return m_dont_print_isValid;
}

QDateTime OAICustomerInvoiceDto::getDunningLetterDate() const {
    return m_dunning_letter_date;
}
void OAICustomerInvoiceDto::setDunningLetterDate(const QDateTime &dunning_letter_date) {
    m_dunning_letter_date = dunning_letter_date;
    m_dunning_letter_date_isSet = true;
}

bool OAICustomerInvoiceDto::is_dunning_letter_date_Set() const{
    return m_dunning_letter_date_isSet;
}

bool OAICustomerInvoiceDto::is_dunning_letter_date_Valid() const{
    return m_dunning_letter_date_isValid;
}

qint32 OAICustomerInvoiceDto::getDunningLetterLevel() const {
    return m_dunning_letter_level;
}
void OAICustomerInvoiceDto::setDunningLetterLevel(const qint32 &dunning_letter_level) {
    m_dunning_letter_level = dunning_letter_level;
    m_dunning_letter_level_isSet = true;
}

bool OAICustomerInvoiceDto::is_dunning_letter_level_Set() const{
    return m_dunning_letter_level_isSet;
}

bool OAICustomerInvoiceDto::is_dunning_letter_level_Valid() const{
    return m_dunning_letter_level_isValid;
}

QDateTime OAICustomerInvoiceDto::getEndDate() const {
    return m_end_date;
}
void OAICustomerInvoiceDto::setEndDate(const QDateTime &end_date) {
    m_end_date = end_date;
    m_end_date_isSet = true;
}

bool OAICustomerInvoiceDto::is_end_date_Set() const{
    return m_end_date_isSet;
}

bool OAICustomerInvoiceDto::is_end_date_Valid() const{
    return m_end_date_isValid;
}

QString OAICustomerInvoiceDto::getErrorInfo() const {
    return m_error_info;
}
void OAICustomerInvoiceDto::setErrorInfo(const QString &error_info) {
    m_error_info = error_info;
    m_error_info_isSet = true;
}

bool OAICustomerInvoiceDto::is_error_info_Set() const{
    return m_error_info_isSet;
}

bool OAICustomerInvoiceDto::is_error_info_Valid() const{
    return m_error_info_isValid;
}

double OAICustomerInvoiceDto::getExchangeRate() const {
    return m_exchange_rate;
}
void OAICustomerInvoiceDto::setExchangeRate(const double &exchange_rate) {
    m_exchange_rate = exchange_rate;
    m_exchange_rate_isSet = true;
}

bool OAICustomerInvoiceDto::is_exchange_rate_Set() const{
    return m_exchange_rate_isSet;
}

bool OAICustomerInvoiceDto::is_exchange_rate_Valid() const{
    return m_exchange_rate_isValid;
}

QString OAICustomerInvoiceDto::getExternalReference() const {
    return m_external_reference;
}
void OAICustomerInvoiceDto::setExternalReference(const QString &external_reference) {
    m_external_reference = external_reference;
    m_external_reference_isSet = true;
}

bool OAICustomerInvoiceDto::is_external_reference_Set() const{
    return m_external_reference_isSet;
}

bool OAICustomerInvoiceDto::is_external_reference_Valid() const{
    return m_external_reference_isValid;
}

QString OAICustomerInvoiceDto::getFinancialPeriod() const {
    return m_financial_period;
}
void OAICustomerInvoiceDto::setFinancialPeriod(const QString &financial_period) {
    m_financial_period = financial_period;
    m_financial_period_isSet = true;
}

bool OAICustomerInvoiceDto::is_financial_period_Set() const{
    return m_financial_period_isSet;
}

bool OAICustomerInvoiceDto::is_financial_period_Valid() const{
    return m_financial_period_isValid;
}

bool OAICustomerInvoiceDto::isHold() const {
    return m_hold;
}
void OAICustomerInvoiceDto::setHold(const bool &hold) {
    m_hold = hold;
    m_hold_isSet = true;
}

bool OAICustomerInvoiceDto::is_hold_Set() const{
    return m_hold_isSet;
}

bool OAICustomerInvoiceDto::is_hold_Valid() const{
    return m_hold_isValid;
}

OAIInvoiceAddressInCustomerInvoiceDto OAICustomerInvoiceDto::getInvoiceAddress() const {
    return m_invoice_address;
}
void OAICustomerInvoiceDto::setInvoiceAddress(const OAIInvoiceAddressInCustomerInvoiceDto &invoice_address) {
    m_invoice_address = invoice_address;
    m_invoice_address_isSet = true;
}

bool OAICustomerInvoiceDto::is_invoice_address_Set() const{
    return m_invoice_address_isSet;
}

bool OAICustomerInvoiceDto::is_invoice_address_Valid() const{
    return m_invoice_address_isValid;
}

OAIInvoiceContactInCustomerInvoiceDto OAICustomerInvoiceDto::getInvoiceContact() const {
    return m_invoice_contact;
}
void OAICustomerInvoiceDto::setInvoiceContact(const OAIInvoiceContactInCustomerInvoiceDto &invoice_contact) {
    m_invoice_contact = invoice_contact;
    m_invoice_contact_isSet = true;
}

bool OAICustomerInvoiceDto::is_invoice_contact_Set() const{
    return m_invoice_contact_isSet;
}

bool OAICustomerInvoiceDto::is_invoice_contact_Valid() const{
    return m_invoice_contact_isValid;
}

QList<OAICustomerInvoiceLineDto> OAICustomerInvoiceDto::getInvoiceLines() const {
    return m_invoice_lines;
}
void OAICustomerInvoiceDto::setInvoiceLines(const QList<OAICustomerInvoiceLineDto> &invoice_lines) {
    m_invoice_lines = invoice_lines;
    m_invoice_lines_isSet = true;
}

bool OAICustomerInvoiceDto::is_invoice_lines_Set() const{
    return m_invoice_lines_isSet;
}

bool OAICustomerInvoiceDto::is_invoice_lines_Valid() const{
    return m_invoice_lines_isValid;
}

QString OAICustomerInvoiceDto::getInvoiceText() const {
    return m_invoice_text;
}
void OAICustomerInvoiceDto::setInvoiceText(const QString &invoice_text) {
    m_invoice_text = invoice_text;
    m_invoice_text_isSet = true;
}

bool OAICustomerInvoiceDto::is_invoice_text_Set() const{
    return m_invoice_text_isSet;
}

bool OAICustomerInvoiceDto::is_invoice_text_Valid() const{
    return m_invoice_text_isValid;
}

bool OAICustomerInvoiceDto::isIsRotRutDeductible() const {
    return m_is_rot_rut_deductible;
}
void OAICustomerInvoiceDto::setIsRotRutDeductible(const bool &is_rot_rut_deductible) {
    m_is_rot_rut_deductible = is_rot_rut_deductible;
    m_is_rot_rut_deductible_isSet = true;
}

bool OAICustomerInvoiceDto::is_is_rot_rut_deductible_Set() const{
    return m_is_rot_rut_deductible_isSet;
}

bool OAICustomerInvoiceDto::is_is_rot_rut_deductible_Valid() const{
    return m_is_rot_rut_deductible_isValid;
}

QDateTime OAICustomerInvoiceDto::getLastModifiedDateTime() const {
    return m_last_modified_date_time;
}
void OAICustomerInvoiceDto::setLastModifiedDateTime(const QDateTime &last_modified_date_time) {
    m_last_modified_date_time = last_modified_date_time;
    m_last_modified_date_time_isSet = true;
}

bool OAICustomerInvoiceDto::is_last_modified_date_time_Set() const{
    return m_last_modified_date_time_isSet;
}

bool OAICustomerInvoiceDto::is_last_modified_date_time_Valid() const{
    return m_last_modified_date_time_isValid;
}

OAILocationInCustomerInvoiceDto OAICustomerInvoiceDto::getLocation() const {
    return m_location;
}
void OAICustomerInvoiceDto::setLocation(const OAILocationInCustomerInvoiceDto &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAICustomerInvoiceDto::is_location_Set() const{
    return m_location_isSet;
}

bool OAICustomerInvoiceDto::is_location_Valid() const{
    return m_location_isValid;
}

OAIMetadataDto OAICustomerInvoiceDto::getMetadata() const {
    return m_metadata;
}
void OAICustomerInvoiceDto::setMetadata(const OAIMetadataDto &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAICustomerInvoiceDto::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAICustomerInvoiceDto::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QString OAICustomerInvoiceDto::getNote() const {
    return m_note;
}
void OAICustomerInvoiceDto::setNote(const QString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAICustomerInvoiceDto::is_note_Set() const{
    return m_note_isSet;
}

bool OAICustomerInvoiceDto::is_note_Valid() const{
    return m_note_isValid;
}

QDateTime OAICustomerInvoiceDto::getOrigInvoiceDate() const {
    return m_orig_invoice_date;
}
void OAICustomerInvoiceDto::setOrigInvoiceDate(const QDateTime &orig_invoice_date) {
    m_orig_invoice_date = orig_invoice_date;
    m_orig_invoice_date_isSet = true;
}

bool OAICustomerInvoiceDto::is_orig_invoice_date_Set() const{
    return m_orig_invoice_date_isSet;
}

bool OAICustomerInvoiceDto::is_orig_invoice_date_Valid() const{
    return m_orig_invoice_date_isValid;
}

QString OAICustomerInvoiceDto::getOriginatorDocRef() const {
    return m_originator_doc_ref;
}
void OAICustomerInvoiceDto::setOriginatorDocRef(const QString &originator_doc_ref) {
    m_originator_doc_ref = originator_doc_ref;
    m_originator_doc_ref_isSet = true;
}

bool OAICustomerInvoiceDto::is_originator_doc_ref_Set() const{
    return m_originator_doc_ref_isSet;
}

bool OAICustomerInvoiceDto::is_originator_doc_ref_Valid() const{
    return m_originator_doc_ref_isValid;
}

OAIPaymentMethodInCustomerInvoiceDto OAICustomerInvoiceDto::getPaymentMethod() const {
    return m_payment_method;
}
void OAICustomerInvoiceDto::setPaymentMethod(const OAIPaymentMethodInCustomerInvoiceDto &payment_method) {
    m_payment_method = payment_method;
    m_payment_method_isSet = true;
}

bool OAICustomerInvoiceDto::is_payment_method_Set() const{
    return m_payment_method_isSet;
}

bool OAICustomerInvoiceDto::is_payment_method_Valid() const{
    return m_payment_method_isValid;
}

QString OAICustomerInvoiceDto::getPaymentReference() const {
    return m_payment_reference;
}
void OAICustomerInvoiceDto::setPaymentReference(const QString &payment_reference) {
    m_payment_reference = payment_reference;
    m_payment_reference_isSet = true;
}

bool OAICustomerInvoiceDto::is_payment_reference_Set() const{
    return m_payment_reference_isSet;
}

bool OAICustomerInvoiceDto::is_payment_reference_Valid() const{
    return m_payment_reference_isValid;
}

QString OAICustomerInvoiceDto::getPostPeriod() const {
    return m_post_period;
}
void OAICustomerInvoiceDto::setPostPeriod(const QString &post_period) {
    m_post_period = post_period;
    m_post_period_isSet = true;
}

bool OAICustomerInvoiceDto::is_post_period_Set() const{
    return m_post_period_isSet;
}

bool OAICustomerInvoiceDto::is_post_period_Valid() const{
    return m_post_period_isValid;
}

OAIProjectInCustomerInvoiceDto OAICustomerInvoiceDto::getProject() const {
    return m_project;
}
void OAICustomerInvoiceDto::setProject(const OAIProjectInCustomerInvoiceDto &project) {
    m_project = project;
    m_project_isSet = true;
}

bool OAICustomerInvoiceDto::is_project_Set() const{
    return m_project_isSet;
}

bool OAICustomerInvoiceDto::is_project_Valid() const{
    return m_project_isValid;
}

QString OAICustomerInvoiceDto::getReferenceNumber() const {
    return m_reference_number;
}
void OAICustomerInvoiceDto::setReferenceNumber(const QString &reference_number) {
    m_reference_number = reference_number;
    m_reference_number_isSet = true;
}

bool OAICustomerInvoiceDto::is_reference_number_Set() const{
    return m_reference_number_isSet;
}

bool OAICustomerInvoiceDto::is_reference_number_Valid() const{
    return m_reference_number_isValid;
}

double OAICustomerInvoiceDto::getRoundingDiff() const {
    return m_rounding_diff;
}
void OAICustomerInvoiceDto::setRoundingDiff(const double &rounding_diff) {
    m_rounding_diff = rounding_diff;
    m_rounding_diff_isSet = true;
}

bool OAICustomerInvoiceDto::is_rounding_diff_Set() const{
    return m_rounding_diff_isSet;
}

bool OAICustomerInvoiceDto::is_rounding_diff_Valid() const{
    return m_rounding_diff_isValid;
}

OAISalesPersonInCustomerInvoiceDto OAICustomerInvoiceDto::getSalesPerson() const {
    return m_sales_person;
}
void OAICustomerInvoiceDto::setSalesPerson(const OAISalesPersonInCustomerInvoiceDto &sales_person) {
    m_sales_person = sales_person;
    m_sales_person_isSet = true;
}

bool OAICustomerInvoiceDto::is_sales_person_Set() const{
    return m_sales_person_isSet;
}

bool OAICustomerInvoiceDto::is_sales_person_Valid() const{
    return m_sales_person_isValid;
}

QString OAICustomerInvoiceDto::getSalesPersonDescr() const {
    return m_sales_person_descr;
}
void OAICustomerInvoiceDto::setSalesPersonDescr(const QString &sales_person_descr) {
    m_sales_person_descr = sales_person_descr;
    m_sales_person_descr_isSet = true;
}

bool OAICustomerInvoiceDto::is_sales_person_descr_Set() const{
    return m_sales_person_descr_isSet;
}

bool OAICustomerInvoiceDto::is_sales_person_descr_Valid() const{
    return m_sales_person_descr_isValid;
}

qint32 OAICustomerInvoiceDto::getSalesPersonId() const {
    return m_sales_person_id;
}
void OAICustomerInvoiceDto::setSalesPersonId(const qint32 &sales_person_id) {
    m_sales_person_id = sales_person_id;
    m_sales_person_id_isSet = true;
}

bool OAICustomerInvoiceDto::is_sales_person_id_Set() const{
    return m_sales_person_id_isSet;
}

bool OAICustomerInvoiceDto::is_sales_person_id_Valid() const{
    return m_sales_person_id_isValid;
}

bool OAICustomerInvoiceDto::isSendToAutoInvoice() const {
    return m_send_to_auto_invoice;
}
void OAICustomerInvoiceDto::setSendToAutoInvoice(const bool &send_to_auto_invoice) {
    m_send_to_auto_invoice = send_to_auto_invoice;
    m_send_to_auto_invoice_isSet = true;
}

bool OAICustomerInvoiceDto::is_send_to_auto_invoice_Set() const{
    return m_send_to_auto_invoice_isSet;
}

bool OAICustomerInvoiceDto::is_send_to_auto_invoice_Valid() const{
    return m_send_to_auto_invoice_isValid;
}

QDateTime OAICustomerInvoiceDto::getStartDate() const {
    return m_start_date;
}
void OAICustomerInvoiceDto::setStartDate(const QDateTime &start_date) {
    m_start_date = start_date;
    m_start_date_isSet = true;
}

bool OAICustomerInvoiceDto::is_start_date_Set() const{
    return m_start_date_isSet;
}

bool OAICustomerInvoiceDto::is_start_date_Valid() const{
...
OAISubaccountInCustomerInvoiceDto OAICustomerInvoiceDto::getSubaccount() const {
    return m_subaccount;
}
void OAICustomerInvoiceDto::setSubaccount(const OAISubaccountInCustomerInvoiceDto &subaccount) {
    m_subaccount = subaccount;
    m_subaccount_isSet = true;
}

bool OAICustomerInvoiceDto::is_subaccount_Set() const{
    return m_subaccount_isSet;
}

bool OAICustomerInvoiceDto::is_subaccount_Valid() const{
    return m_subaccount_isValid;
}

QList<OAITaxDetailDto> OAICustomerInvoiceDto::getTaxDetails() const {
    return m_tax_details;
}
void OAICustomerInvoiceDto::setTaxDetails(const QList<OAITaxDetailDto> &tax_details) {
    m_tax_details = tax_details;
    m_tax_details_isSet = true;
}

bool OAICustomerInvoiceDto::is_tax_details_Set() const{
    return m_tax_details_isSet;
}

bool OAICustomerInvoiceDto::is_tax_details_Valid() const{
    return m_tax_details_isValid;
}

double OAICustomerInvoiceDto::getVatExemptTotal() const {
    return m_vat_exempt_total;
}
void OAICustomerInvoiceDto::setVatExemptTotal(const double &vat_exempt_total) {
    m_vat_exempt_total = vat_exempt_total;
    m_vat_exempt_total_isSet = true;
}

bool OAICustomerInvoiceDto::is_vat_exempt_total_Set() const{
    return m_vat_exempt_total_isSet;
}

bool OAICustomerInvoiceDto::is_vat_exempt_total_Valid() const{
    return m_vat_exempt_total_isValid;
}

double OAICustomerInvoiceDto::getVatExemptTotalInCurrency() const {
    return m_vat_exempt_total_in_currency;
}
void OAICustomerInvoiceDto::setVatExemptTotalInCurrency(const double &vat_exempt_total_in_currency) {
    m_vat_exempt_total_in_currency = vat_exempt_total_in_currency;
    m_vat_exempt_total_in_currency_isSet = true;
}

bool OAICustomerInvoiceDto::is_vat_exempt_total_in_currency_Set() const{
    return m_vat_exempt_total_in_currency_isSet;
}

bool OAICustomerInvoiceDto::is_vat_exempt_total_in_currency_Valid() const{
    return m_vat_exempt_total_in_currency_isValid;
}

double OAICustomerInvoiceDto::getVatTaxableTotal() const {
    return m_vat_taxable_total;
}
void OAICustomerInvoiceDto::setVatTaxableTotal(const double &vat_taxable_total) {
    m_vat_taxable_total = vat_taxable_total;
    m_vat_taxable_total_isSet = true;
}

bool OAICustomerInvoiceDto::is_vat_taxable_total_Set() const{
    return m_vat_taxable_total_isSet;
}

bool OAICustomerInvoiceDto::is_vat_taxable_total_Valid() const{
    return m_vat_taxable_total_isValid;
}

double OAICustomerInvoiceDto::getVatTaxableTotalInCurrency() const {
    return m_vat_taxable_total_in_currency;
}
void OAICustomerInvoiceDto::setVatTaxableTotalInCurrency(const double &vat_taxable_total_in_currency) {
    m_vat_taxable_total_in_currency = vat_taxable_total_in_currency;
    m_vat_taxable_total_in_currency_isSet = true;
}

bool OAICustomerInvoiceDto::is_vat_taxable_total_in_currency_Set() const{
    return m_vat_taxable_total_in_currency_isSet;
}

bool OAICustomerInvoiceDto::is_vat_taxable_total_in_currency_Valid() const{
    return m_vat_taxable_total_in_currency_isValid;
}

double OAICustomerInvoiceDto::getVatTotal() const {
    return m_vat_total;
}
void OAICustomerInvoiceDto::setVatTotal(const double &vat_total) {
    m_vat_total = vat_total;
    m_vat_total_isSet = true;
}

bool OAICustomerInvoiceDto::is_vat_total_Set() const{
    return m_vat_total_isSet;
}

bool OAICustomerInvoiceDto::is_vat_total_Valid() const{
    return m_vat_total_isValid;
}

double OAICustomerInvoiceDto::getVatTotalInCurrency() const {
    return m_vat_total_in_currency;
}
void OAICustomerInvoiceDto::setVatTotalInCurrency(const double &vat_total_in_currency) {
    m_vat_total_in_currency = vat_total_in_currency;
    m_vat_total_in_currency_isSet = true;
}

bool OAICustomerInvoiceDto::is_vat_total_in_currency_Set() const{
    return m_vat_total_in_currency_isSet;
}

bool OAICustomerInvoiceDto::is_vat_total_in_currency_Valid() const{
