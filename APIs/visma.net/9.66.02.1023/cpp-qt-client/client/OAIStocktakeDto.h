...
#ifndef OAIStocktakeDto_H
#define OAIStocktakeDto_H
...
namespace OpenAPI {
class OAIStocktakeLineDto;

class OAIStocktakeDto : public OAIObject {
public:
    OAIStocktakeDto();
    OAIStocktakeDto(QString json);
    ~OAIStocktakeDto() override;
    ...
    QList<OAIStocktakeLineDto> getLines() const;
    void setLines(const QList<OAIStocktakeLineDto> &lines);
...
private:
    ...
    QList<OAIStocktakeLineDto> m_lines;
    bool m_lines_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStocktakeDto)

#endif // OAIStocktakeDto_H
