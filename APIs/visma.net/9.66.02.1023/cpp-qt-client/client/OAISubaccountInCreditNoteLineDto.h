...
/*
 * OAISubaccountInCreditNoteLineDto.h
 *
 * Mandatory field: Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCreditNoteLineDto_H
#define OAISubaccountInCreditNoteLineDto_H
...
class OAISubaccountInCreditNoteLineDto : public OAIObject {
public:
    OAISubaccountInCreditNoteLineDto();
    OAISubaccountInCreditNoteLineDto(QString json);
    ~OAISubaccountInCreditNoteLineDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCreditNoteLineDto)

#endif // OAISubaccountInCreditNoteLineDto_H
