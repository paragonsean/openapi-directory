...
#include "OAISupplierBalanceQueryParameters.h"
...
OAISupplierBalanceQueryParameters::OAISupplierBalanceQueryParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISupplierBalanceQueryParameters::OAISupplierBalanceQueryParameters() {
    this->initializeModel();
}

OAISupplierBalanceQueryParameters::~OAISupplierBalanceQueryParameters() {}

void OAISupplierBalanceQueryParameters::initializeModel() {
...
void OAISupplierBalanceQueryParameters::fromJson(QString jsonString) {
...
void OAISupplierBalanceQueryParameters::fromJsonObject(QJsonObject json) {
...
QString OAISupplierBalanceQueryParameters::asJson() const {
...
QJsonObject OAISupplierBalanceQueryParameters::asJsonObject() const {
    QJsonObject obj;
...
QString OAISupplierBalanceQueryParameters::getGreaterThanValue() const {
    return m_greater_than_value;
}
void OAISupplierBalanceQueryParameters::setGreaterThanValue(const QString &greater_than_value) {
    m_greater_than_value = greater_than_value;
    m_greater_than_value_isSet = true;
}

bool OAISupplierBalanceQueryParameters::is_greater_than_value_Set() const{
    return m_greater_than_value_isSet;
}

bool OAISupplierBalanceQueryParameters::is_greater_than_value_Valid() const{
    return m_greater_than_value_isValid;
}

QString OAISupplierBalanceQueryParameters::getLastModifiedDateTime() const {
    return m_last_modified_date_time;
}
void OAISupplierBalanceQueryParameters::setLastModifiedDateTime(const QString &last_modified_date_time) {
    m_last_modified_date_time = last_modified_date_time;
    m_last_modified_date_time_isSet = true;
}

bool OAISupplierBalanceQueryParameters::is_last_modified_date_time_Set() const{
    return m_last_modified_date_time_isSet;
}

bool OAISupplierBalanceQueryParameters::is_last_modified_date_time_Valid() const{
    return m_last_modified_date_time_isValid;
}

QString OAISupplierBalanceQueryParameters::getLastModifiedDateTimeCondition() const {
    return m_last_modified_date_time_condition;
}
void OAISupplierBalanceQueryParameters::setLastModifiedDateTimeCondition(const QString &last_modified_date_time_condition) {
    m_last_modified_date_time_condition = last_modified_date_time_condition;
    m_last_modified_date_time_condition_isSet = true;
}

bool OAISupplierBalanceQueryParameters::is_last_modified_date_time_condition_Set() const{
    return m_last_modified_date_time_condition_isSet;
}

bool OAISupplierBalanceQueryParameters::is_last_modified_date_time_condition_Valid() const{
    return m_last_modified_date_time_condition_isValid;
}

qint32 OAISupplierBalanceQueryParameters::getNumberToRead() const {
    return m_number_to_read;
}
void OAISupplierBalanceQueryParameters::setNumberToRead(const qint32 &number_to_read) {
    m_number_to_read = number_to_read;
    m_number_to_read_isSet = true;
}

bool OAISupplierBalanceQueryParameters::is_number_to_read_Set() const{
    return m_number_to_read_isSet;
}

bool OAISupplierBalanceQueryParameters::is_number_to_read_Valid() const{
    return m_number_to_read_isValid;
}

QString OAISupplierBalanceQueryParameters::getOrderBy() const {
    return m_order_by;
}
void OAISupplierBalanceQueryParameters::setOrderBy(const QString &order_by) {
    m_order_by = order_by;
    m_order_by_isSet = true;
}

bool OAISupplierBalanceQueryParameters::is_order_by_Set() const{
    return m_order_by_isSet;
}

bool OAISupplierBalanceQueryParameters::is_order_by_Valid() const{
    return m_order_by_isValid;
}

qint32 OAISupplierBalanceQueryParameters::getSkipRecords() const {
    return m_skip_records;
}
void OAISupplierBalanceQueryParameters::setSkipRecords(const qint32 &skip_records) {
    m_skip_records = skip_records;
    m_skip_records_isSet = true;
}

bool OAISupplierBalanceQueryParameters::is_skip_records_Set() const{
    return m_skip_records_isSet;
}

bool OAISupplierBalanceQueryParameters::is_skip_records_Valid() const{
    return m_skip_records_isValid;
}

bool OAISupplierBalanceQueryParameters::isSet() const {
...
bool OAISupplierBalanceQueryParameters::isValid() const {
