...
/*
 * OAISubaccountInCustomerDebitNoteDto.h
 *
 * The Document details tab &amp;gt; Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCustomerDebitNoteDto_H
#define OAISubaccountInCustomerDebitNoteDto_H
...
class OAISubaccountInCustomerDebitNoteDto : public OAIObject {
public:
    OAISubaccountInCustomerDebitNoteDto();
    OAISubaccountInCustomerDebitNoteDto(QString json);
    ~OAISubaccountInCustomerDebitNoteDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCustomerDebitNoteDto)

#endif // OAISubaccountInCustomerDebitNoteDto_H
