...
/*
 * OAIDetailsInCustomerContractDto.h
 *
 * Details tab &amp;gt;
 */

#ifndef OAIDetailsInCustomerContractDto_H
#define OAIDetailsInCustomerContractDto_H
...
class OAIDetailsInCustomerContractDto : public OAIObject {
public:
    OAIDetailsInCustomerContractDto();
    OAIDetailsInCustomerContractDto(QString json);
    ~OAIDetailsInCustomerContractDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetailsInCustomerContractDto)

#endif // OAIDetailsInCustomerContractDto_H
