...
/*
 * OAISupplierBalanceQueryParameters.h
 *
 * 
 */

#ifndef OAISupplierBalanceQueryParameters_H
#define OAISupplierBalanceQueryParameters_H
...
class OAISupplierBalanceQueryParameters : public OAIObject {
public:
    OAISupplierBalanceQueryParameters();
    OAISupplierBalanceQueryParameters(QString json);
    ~OAISupplierBalanceQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupplierBalanceQueryParameters)

#endif // OAISupplierBalanceQueryParameters_H
