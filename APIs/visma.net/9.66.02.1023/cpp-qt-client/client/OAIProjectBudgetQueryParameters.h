...
/*
 * OAIProjectBudgetQueryParameters.h
 *
 * 
 */

#ifndef OAIProjectBudgetQueryParameters_H
#define OAIProjectBudgetQueryParameters_H
...
class OAIProjectBudgetQueryParameters : public OAIObject {
public:
    OAIProjectBudgetQueryParameters();
    OAIProjectBudgetQueryParameters(QString json);
    ~OAIProjectBudgetQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectBudgetQueryParameters)

#endif // OAIProjectBudgetQueryParameters_H
