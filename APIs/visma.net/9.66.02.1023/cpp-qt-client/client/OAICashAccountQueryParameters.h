...
/*
 * OAICashAccountQueryParameters.h
 *
 * 
 */

#ifndef OAICashAccountQueryParameters_H
#define OAICashAccountQueryParameters_H
...
class OAICashAccountQueryParameters : public OAIObject {
public:
    OAICashAccountQueryParameters();
    OAICashAccountQueryParameters(QString json);
    ~OAICashAccountQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICashAccountQueryParameters)

#endif // OAICashAccountQueryParameters_H
