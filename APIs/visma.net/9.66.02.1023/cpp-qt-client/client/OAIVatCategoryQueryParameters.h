...
/*
 * OAIVatCategoryQueryParameters.h
 *
 * 
 */

#ifndef OAIVatCategoryQueryParameters_H
#define OAIVatCategoryQueryParameters_H
...
class OAIVatCategoryQueryParameters : public OAIObject {
public:
    OAIVatCategoryQueryParameters();
    OAIVatCategoryQueryParameters(QString json);
    ~OAIVatCategoryQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVatCategoryQueryParameters)

#endif // OAIVatCategoryQueryParameters_H
