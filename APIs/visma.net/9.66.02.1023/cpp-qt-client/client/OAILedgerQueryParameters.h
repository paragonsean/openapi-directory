...
/*
 * OAILedgerQueryParameters.h
 *
 * 
 */

#ifndef OAILedgerQueryParameters_H
#define OAILedgerQueryParameters_H
...
class OAILedgerQueryParameters : public OAIObject {
public:
    OAILedgerQueryParameters();
    OAILedgerQueryParameters(QString json);
    ~OAILedgerQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILedgerQueryParameters)

#endif // OAILedgerQueryParameters_H
