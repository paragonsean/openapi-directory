...
/*
 * OAIOffsetSubAccountInTransactionDetailDto.h
 *
 * Mandatory field: Offset subaccount* &amp;gt; The corresponding subaccount to be used for the transaction.
 */

#ifndef OAIOffsetSubAccountInTransactionDetailDto_H
#define OAIOffsetSubAccountInTransactionDetailDto_H
...
class OAIOffsetSubAccountInTransactionDetailDto : public OAIObject {
public:
    OAIOffsetSubAccountInTransactionDetailDto();
    OAIOffsetSubAccountInTransactionDetailDto(QString json);
    ~OAIOffsetSubAccountInTransactionDetailDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOffsetSubAccountInTransactionDetailDto)

#endif // OAIOffsetSubAccountInTransactionDetailDto_H
