...
/*
 * OAISubaccountInCashSaleLineDto.h
 *
 * Mandatory field: Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCashSaleLineDto_H
#define OAISubaccountInCashSaleLineDto_H
...
class OAISubaccountInCashSaleLineDto : public OAIObject {
public:
    OAISubaccountInCashSaleLineDto();
    OAISubaccountInCashSaleLineDto(QString json);
    ~OAISubaccountInCashSaleLineDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCashSaleLineDto)

#endif // OAISubaccountInCashSaleLineDto_H
