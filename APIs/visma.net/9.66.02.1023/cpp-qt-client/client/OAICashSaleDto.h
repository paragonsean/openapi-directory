...
#ifndef OAICashSaleDto_H
#define OAICashSaleDto_H

#include <QJsonObject>

#include "OAIAccountInCashSaleDto.h"
#include "OAIArAdjustDto.h"
#include "OAIBranchNumberInCashSaleDto.h"
#include "OAICashSaleLineDto.h"
#include "OAICreditTermsInCashSaleDto.h"
#include "OAICustomerInCashSaleDto.h"
#include "OAIInvoiceAddressInCashSaleDto.h"
#include "OAIInvoiceContactInCashSaleDto.h"
#include "OAILocationInCashSaleDto.h"
#include "OAIMetadataDto.h"
#include "OAIPaymentMethodInCashSaleDto.h"
#include "OAIProjectInCashSaleDto.h"
#include "OAISalesPersonInCashSaleDto.h"
#include "OAISubaccountInCashSaleDto.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIAccountInCashSaleDto;
class OAIArAdjustDto;
class OAIBranchNumberInCashSaleDto;
class OAICashSaleLineDto;
class OAICreditTermsInCashSaleDto;
class OAICustomerInCashSaleDto;
class OAIInvoiceAddressInCashSaleDto;
class OAIInvoiceContactInCashSaleDto;
class OAILocationInCashSaleDto;
class OAIMetadataDto;
class OAIPaymentMethodInCashSaleDto;
class OAIProjectInCashSaleDto;
class OAISalesPersonInCashSaleDto;
class OAISubaccountInCashSaleDto;

class OAICashSaleDto : public OAIObject {
public:
    OAICashSaleDto();
    OAICashSaleDto(QString json);
    ~OAICashSaleDto() override;
    ...
    OAIAccountInCashSaleDto getAccount() const;
    void setAccount(const OAIAccountInCashSaleDto &account);
    ...
    OAIBranchNumberInCashSaleDto getBranchNumber() const;
    void setBranchNumber(const OAIBranchNumberInCashSaleDto &branch_number);
    ...
    QList<OAICashSaleLineDto> getCashSaleLines() const;
    void setCashSaleLines(const QList<OAICashSaleLineDto> &cash_sale_lines);
    ...
    OAICreditTermsInCashSaleDto getCreditTerms() const;
    void setCreditTerms(const OAICreditTermsInCashSaleDto &credit_terms);
    ...
    OAICustomerInCashSaleDto getCustomer() const;
    void setCustomer(const OAICustomerInCashSaleDto &customer);
    ...
    OAIInvoiceAddressInCashSaleDto getInvoiceAddress() const;
    void setInvoiceAddress(const OAIInvoiceAddressInCashSaleDto &invoice_address);
    bool is_invoice_address_Set() const;
    bool is_invoice_address_Valid() const;

    OAIInvoiceContactInCashSaleDto getInvoiceContact() const;
    void setInvoiceContact(const OAIInvoiceContactInCashSaleDto &invoice_contact);
    ...
    OAILocationInCashSaleDto getLocation() const;
    void setLocation(const OAILocationInCashSaleDto &location);
    ...
    OAIPaymentMethodInCashSaleDto getPaymentMethod() const;
    void setPaymentMethod(const OAIPaymentMethodInCashSaleDto &payment_method);
    ...
    OAIProjectInCashSaleDto getProject() const;
    void setProject(const OAIProjectInCashSaleDto &project);
    ...
    OAISalesPersonInCashSaleDto getSalesPerson() const;
    void setSalesPerson(const OAISalesPersonInCashSaleDto &sales_person);
    ...
    OAISubaccountInCashSaleDto getSubaccount() const;
    void setSubaccount(const OAISubaccountInCashSaleDto &subaccount);
...
private:
    ...
    OAIAccountInCashSaleDto m_account;
    ...
    OAIBranchNumberInCashSaleDto m_branch_number;
    ...
    QList<OAICashSaleLineDto> m_cash_sale_lines;
    ...
    OAICreditTermsInCashSaleDto m_credit_terms;
    ...
    OAICustomerInCashSaleDto m_customer;
    ...
    OAIInvoiceAddressInCashSaleDto m_invoice_address;
    bool m_invoice_address_isSet;
    bool m_invoice_address_isValid;

    OAIInvoiceContactInCashSaleDto m_invoice_contact;
    ...
    OAILocationInCashSaleDto m_location;
    ...
    OAIPaymentMethodInCashSaleDto m_payment_method;
    ...
    OAIProjectInCashSaleDto m_project;
    ...
    OAISalesPersonInCashSaleDto m_sales_person;
    ...
    OAISubaccountInCashSaleDto m_subaccount;
...
Q_DECLARE_METATYPE(OpenAPI::OAICashSaleDto)

#endif // OAICashSaleDto_H
