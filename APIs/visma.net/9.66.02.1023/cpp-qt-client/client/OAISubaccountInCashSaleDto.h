...
/*
 * OAISubaccountInCashSaleDto.h
 *
 * The Document details tab &amp;gt; Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCashSaleDto_H
#define OAISubaccountInCashSaleDto_H
...
class OAISubaccountInCashSaleDto : public OAIObject {
public:
    OAISubaccountInCashSaleDto();
    OAISubaccountInCashSaleDto(QString json);
    ~OAISubaccountInCashSaleDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCashSaleDto)

#endif // OAISubaccountInCashSaleDto_H
