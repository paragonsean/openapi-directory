...
#include "OAICustomerGlAccountsDto.h"
...
OAICustomerGlAccountsDto::OAICustomerGlAccountsDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomerGlAccountsDto::OAICustomerGlAccountsDto() {
    this->initializeModel();
}

OAICustomerGlAccountsDto::~OAICustomerGlAccountsDto() {}

void OAICustomerGlAccountsDto::initializeModel() {
...
void OAICustomerGlAccountsDto::fromJson(QString jsonString) {
...
void OAICustomerGlAccountsDto::fromJsonObject(QJsonObject json) {
...
QString OAICustomerGlAccountsDto::asJson() const {
...
QJsonObject OAICustomerGlAccountsDto::asJsonObject() const {
    QJsonObject obj;
...
OAIAccountNumberTypeDescriptionDto OAICustomerGlAccountsDto::getCashDiscountAccount() const {
    return m_cash_discount_account;
}
void OAICustomerGlAccountsDto::setCashDiscountAccount(const OAIAccountNumberTypeDescriptionDto &cash_discount_account) {
    m_cash_discount_account = cash_discount_account;
    m_cash_discount_account_isSet = true;
}

bool OAICustomerGlAccountsDto::is_cash_discount_account_Set() const{
    return m_cash_discount_account_isSet;
}

bool OAICustomerGlAccountsDto::is_cash_discount_account_Valid() const{
    return m_cash_discount_account_isValid;
}

OAISubAccountDto OAICustomerGlAccountsDto::getCashDiscountSubaccount() const {
    return m_cash_discount_subaccount;
}
void OAICustomerGlAccountsDto::setCashDiscountSubaccount(const OAISubAccountDto &cash_discount_subaccount) {
    m_cash_discount_subaccount = cash_discount_subaccount;
    m_cash_discount_subaccount_isSet = true;
}

bool OAICustomerGlAccountsDto::is_cash_discount_subaccount_Set() const{
    return m_cash_discount_subaccount_isSet;
}

bool OAICustomerGlAccountsDto::is_cash_discount_subaccount_Valid() const{
    return m_cash_discount_subaccount_isValid;
}

OAIAccountNumberTypeDescriptionDto OAICustomerGlAccountsDto::getCustomerLedgerAccount() const {
    return m_customer_ledger_account;
}
void OAICustomerGlAccountsDto::setCustomerLedgerAccount(const OAIAccountNumberTypeDescriptionDto &customer_ledger_account) {
    m_customer_ledger_account = customer_ledger_account;
    m_customer_ledger_account_isSet = true;
}

bool OAICustomerGlAccountsDto::is_customer_ledger_account_Set() const{
    return m_customer_ledger_account_isSet;
}

bool OAICustomerGlAccountsDto::is_customer_ledger_account_Valid() const{
    return m_customer_ledger_account_isValid;
}

OAISubAccountDto OAICustomerGlAccountsDto::getCustomerLedgerSubaccount() const {
    return m_customer_ledger_subaccount;
}
void OAICustomerGlAccountsDto::setCustomerLedgerSubaccount(const OAISubAccountDto &customer_ledger_subaccount) {
    m_customer_ledger_subaccount = customer_ledger_subaccount;
    m_customer_ledger_subaccount_isSet = true;
}

bool OAICustomerGlAccountsDto::is_customer_ledger_subaccount_Set() const{
    return m_customer_ledger_subaccount_isSet;
}

bool OAICustomerGlAccountsDto::is_customer_ledger_subaccount_Valid() const{
    return m_customer_ledger_subaccount_isValid;
}

OAIAccountNumberTypeDescriptionDto OAICustomerGlAccountsDto::getDiscountAccount() const {
    return m_discount_account;
}
void OAICustomerGlAccountsDto::setDiscountAccount(const OAIAccountNumberTypeDescriptionDto &discount_account) {
    m_discount_account = discount_account;
    m_discount_account_isSet = true;
}

bool OAICustomerGlAccountsDto::is_discount_account_Set() const{
    return m_discount_account_isSet;
}

bool OAICustomerGlAccountsDto::is_discount_account_Valid() const{
    return m_discount_account_isValid;
}

OAISubAccountDto OAICustomerGlAccountsDto::getDiscountSubaccount() const {
    return m_discount_subaccount;
}
void OAICustomerGlAccountsDto::setDiscountSubaccount(const OAISubAccountDto &discount_subaccount) {
    m_discount_subaccount = discount_subaccount;
    m_discount_subaccount_isSet = true;
}

bool OAICustomerGlAccountsDto::is_discount_subaccount_Set() const{
    return m_discount_subaccount_isSet;
}

bool OAICustomerGlAccountsDto::is_discount_subaccount_Valid() const{
    return m_discount_subaccount_isValid;
}

OAIAccountNumberTypeDescriptionDto OAICustomerGlAccountsDto::getFreightAccount() const {
    return m_freight_account;
}
void OAICustomerGlAccountsDto::setFreightAccount(const OAIAccountNumberTypeDescriptionDto &freight_account) {
    m_freight_account = freight_account;
    m_freight_account_isSet = true;
}

bool OAICustomerGlAccountsDto::is_freight_account_Set() const{
    return m_freight_account_isSet;
}

bool OAICustomerGlAccountsDto::is_freight_account_Valid() const{
    return m_freight_account_isValid;
}

OAISubAccountDto OAICustomerGlAccountsDto::getFreightSubaccount() const {
    return m_freight_subaccount;
}
void OAICustomerGlAccountsDto::setFreightSubaccount(const OAISubAccountDto &freight_subaccount) {
    m_freight_subaccount = freight_subaccount;
    m_freight_subaccount_isSet = true;
}

bool OAICustomerGlAccountsDto::is_freight_subaccount_Set() const{
    return m_freight_subaccount_isSet;
}

bool OAICustomerGlAccountsDto::is_freight_subaccount_Valid() const{
    return m_freight_subaccount_isValid;
}

OAIAccountNumberTypeDescriptionDto OAICustomerGlAccountsDto::getPrepaymentAccount() const {
    return m_prepayment_account;
}
void OAICustomerGlAccountsDto::setPrepaymentAccount(const OAIAccountNumberTypeDescriptionDto &prepayment_account) {
    m_prepayment_account = prepayment_account;
    m_prepayment_account_isSet = true;
}

bool OAICustomerGlAccountsDto::is_prepayment_account_Set() const{
    return m_prepayment_account_isSet;
}

bool OAICustomerGlAccountsDto::is_prepayment_account_Valid() const{
    return m_prepayment_account_isValid;
}

OAISubAccountDto OAICustomerGlAccountsDto::getPrepaymentSubaccount() const {
    return m_prepayment_subaccount;
}
void OAICustomerGlAccountsDto::setPrepaymentSubaccount(const OAISubAccountDto &prepayment_subaccount) {
    m_prepayment_subaccount = prepayment_subaccount;
    m_prepayment_subaccount_isSet = true;
}

bool OAICustomerGlAccountsDto::is_prepayment_subaccount_Set() const{
    return m_prepayment_subaccount_isSet;
}

bool OAICustomerGlAccountsDto::is_prepayment_subaccount_Valid() const{
    return m_prepayment_subaccount_isValid;
}

OAIAccountNumberTypeDescriptionDto OAICustomerGlAccountsDto::getSalesAccount() const {
    return m_sales_account;
}
void OAICustomerGlAccountsDto::setSalesAccount(const OAIAccountNumberTypeDescriptionDto &sales_account) {
    m_sales_account = sales_account;
    m_sales_account_isSet = true;
}

bool OAICustomerGlAccountsDto::is_sales_account_Set() const{
    return m_sales_account_isSet;
}

bool OAICustomerGlAccountsDto::is_sales_account_Valid() const{
    return m_sales_account_isValid;
}

OAIAccountNumberTypeDescriptionDto OAICustomerGlAccountsDto::getSalesEuAccount() const {
    return m_sales_eu_account;
}
void OAICustomerGlAccountsDto::setSalesEuAccount(const OAIAccountNumberTypeDescriptionDto &sales_eu_account) {
    m_sales_eu_account = sales_eu_account;
    m_sales_eu_account_isSet = true;
}

bool OAICustomerGlAccountsDto::is_sales_eu_account_Set() const{
    return m_sales_eu_account_isSet;
}

bool OAICustomerGlAccountsDto::is_sales_eu_account_Valid() const{
    return m_sales_eu_account_isValid;
}

OAIAccountNumberTypeDescriptionDto OAICustomerGlAccountsDto::getSalesExportAccount() const {
    return m_sales_export_account;
}
void OAICustomerGlAccountsDto::setSalesExportAccount(const OAIAccountNumberTypeDescriptionDto &sales_export_account) {
    m_sales_export_account = sales_export_account;
    m_sales_export_account_isSet = true;
}

bool OAICustomerGlAccountsDto::is_sales_export_account_Set() const{
    return m_sales_export_account_isSet;
}

bool OAICustomerGlAccountsDto::is_sales_export_account_Valid() const{
    return m_sales_export_account_isValid;
}

OAIAccountNumberTypeDescriptionDto OAICustomerGlAccountsDto::getSalesNonTaxableAccount() const {
    return m_sales_non_taxable_account;
}
void OAICustomerGlAccountsDto::setSalesNonTaxableAccount(const OAIAccountNumberTypeDescriptionDto &sales_non_taxable_account) {
    m_sales_non_taxable_account = sales_non_taxable_account;
    m_sales_non_taxable_account_isSet = true;
}

bool OAICustomerGlAccountsDto::is_sales_non_taxable_account_Set() const{
    return m_sales_non_taxable_account_isSet;
}

bool OAICustomerGlAccountsDto::is_sales_non_taxable_account_Valid() const{
    return m_sales_non_taxable_account_isValid;
}

OAISubAccountDto OAICustomerGlAccountsDto::getSalesSubaccount() const {
    return m_sales_subaccount;
}
void OAICustomerGlAccountsDto::setSalesSubaccount(const OAISubAccountDto &sales_subaccount) {
    m_sales_subaccount = sales_subaccount;
    m_sales_subaccount_isSet = true;
}

bool OAICustomerGlAccountsDto::is_sales_subaccount_Set() const{
    return m_sales_subaccount_isSet;
}

bool OAICustomerGlAccountsDto::is_sales_subaccount_Valid() const{
    return m_sales_subaccount_isValid;
}

bool OAICustomerGlAccountsDto::isSet() const {
...
bool OAICustomerGlAccountsDto::isValid() const {
