...
/*
 * OAISubaccountInCustomerDocumentDto.h
 *
 * The Document details tab &amp;gt; Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCustomerDocumentDto_H
#define OAISubaccountInCustomerDocumentDto_H
...
class OAISubaccountInCustomerDocumentDto : public OAIObject {
public:
    OAISubaccountInCustomerDocumentDto();
    OAISubaccountInCustomerDocumentDto(QString json);
    ~OAISubaccountInCustomerDocumentDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCustomerDocumentDto)

#endif // OAISubaccountInCustomerDocumentDto_H
