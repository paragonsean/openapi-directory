...
/*
 * OAISubaccountInCustomerOverdueChargeLineDto.h
 *
 * Mandatory field: Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCustomerOverdueChargeLineDto_H
#define OAISubaccountInCustomerOverdueChargeLineDto_H
...
class OAISubaccountInCustomerOverdueChargeLineDto : public OAIObject {
public:
    OAISubaccountInCustomerOverdueChargeLineDto();
    OAISubaccountInCustomerOverdueChargeLineDto(QString json);
    ~OAISubaccountInCustomerOverdueChargeLineDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCustomerOverdueChargeLineDto)

#endif // OAISubaccountInCustomerOverdueChargeLineDto_H
