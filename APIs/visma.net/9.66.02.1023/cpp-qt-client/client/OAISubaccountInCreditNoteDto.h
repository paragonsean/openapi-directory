...
/*
 * OAISubaccountInCreditNoteDto.h
 *
 * The Document details tab &amp;gt; Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCreditNoteDto_H
#define OAISubaccountInCreditNoteDto_H
...
class OAISubaccountInCreditNoteDto : public OAIObject {
public:
    OAISubaccountInCreditNoteDto();
    OAISubaccountInCreditNoteDto(QString json);
    ~OAISubaccountInCreditNoteDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCreditNoteDto)

#endif // OAISubaccountInCreditNoteDto_H
