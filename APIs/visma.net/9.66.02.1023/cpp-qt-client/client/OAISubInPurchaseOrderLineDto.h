...
/*
 * OAISubInPurchaseOrderLineDto.h
 *
...
#ifndef OAISubInPurchaseOrderLineDto_H
#define OAISubInPurchaseOrderLineDto_H
...
class OAISubInPurchaseOrderLineDto : public OAIObject {
public:
    OAISubInPurchaseOrderLineDto();
    OAISubInPurchaseOrderLineDto(QString json);
    ~OAISubInPurchaseOrderLineDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubInPurchaseOrderLineDto)

#endif // OAISubInPurchaseOrderLineDto_H
