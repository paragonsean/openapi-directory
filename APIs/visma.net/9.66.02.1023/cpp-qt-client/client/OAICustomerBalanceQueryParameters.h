...
/*
 * OAICustomerBalanceQueryParameters.h
 *
 * 
 */

#ifndef OAICustomerBalanceQueryParameters_H
#define OAICustomerBalanceQueryParameters_H
...
class OAICustomerBalanceQueryParameters : public OAIObject {
public:
    OAICustomerBalanceQueryParameters();
    OAICustomerBalanceQueryParameters(QString json);
    ~OAICustomerBalanceQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerBalanceQueryParameters)

#endif // OAICustomerBalanceQueryParameters_H
