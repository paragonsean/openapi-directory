...
#ifndef OAIContactInfoDto_H
#define OAIContactInfoDto_H
...
class OAIContactInfoDto : public OAIObject {
public:
    OAIContactInfoDto();
    OAIContactInfoDto(QString json);
    ~OAIContactInfoDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactInfoDto)

#endif // OAIContactInfoDto_H
