...
/*
 * OAIEmployeeQueryParameters.h
 *
 * 
 */

#ifndef OAIEmployeeQueryParameters_H
#define OAIEmployeeQueryParameters_H
...
class OAIEmployeeQueryParameters : public OAIObject {
public:
    OAIEmployeeQueryParameters();
    OAIEmployeeQueryParameters(QString json);
    ~OAIEmployeeQueryParameters() override;
    ...
    bool isLinkedToUser() const;
    void setLinkedToUser(const bool &linked_to_user);
    bool is_linked_to_user_Set() const;
    bool is_linked_to_user_Valid() const;
...
private:
    ...
    bool m_linked_to_user;
    bool m_linked_to_user_isSet;
    bool m_linked_to_user_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployeeQueryParameters)

#endif // OAIEmployeeQueryParameters_H
