...
OAIRotRutUpdateDto::OAIRotRutUpdateDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRotRutUpdateDto::OAIRotRutUpdateDto() {
    this->initializeModel();
}

OAIRotRutUpdateDto::~OAIRotRutUpdateDto() {}

void OAIRotRutUpdateDto::initializeModel() {
...
void OAIRotRutUpdateDto::fromJson(QString jsonString) {
...
void OAIRotRutUpdateDto::fromJsonObject(QJsonObject json) {
...
QString OAIRotRutUpdateDto::asJson() const {
...
QJsonObject OAIRotRutUpdateDto::asJsonObject() const {
    QJsonObject obj;
    if (m_appartment.isSet()) {
        obj.insert(QString("appartment"), ::OpenAPI::toJsonValue(m_appartment));
    }
    if (m_distributed_automaticaly.isSet()) {
...
OAIDtoValueOfString OAIRotRutUpdateDto::getAppartment() const {
    return m_appartment;
}
void OAIRotRutUpdateDto::setAppartment(const OAIDtoValueOfString &appartment) {
    m_appartment = appartment;
    m_appartment_isSet = true;
}

bool OAIRotRutUpdateDto::is_appartment_Set() const{
    return m_appartment_isSet;
}

bool OAIRotRutUpdateDto::is_appartment_Valid() const{
    return m_appartment_isValid;
}

OAIDtoValueOfNullableOfBoolean OAIRotRutUpdateDto::getDistributedAutomaticaly() const {
    return m_distributed_automaticaly;
}
void OAIRotRutUpdateDto::setDistributedAutomaticaly(const OAIDtoValueOfNullableOfBoolean &distributed_automaticaly) {
    m_distributed_automaticaly = distributed_automaticaly;
    m_distributed_automaticaly_isSet = true;
}

bool OAIRotRutUpdateDto::is_distributed_automaticaly_Set() const{
    return m_distributed_automaticaly_isSet;
}

bool OAIRotRutUpdateDto::is_distributed_automaticaly_Valid() const{
    return m_distributed_automaticaly_isValid;
}

QList<OAIRotRutDistributionUpdateDto> OAIRotRutUpdateDto::getDistribution() const {
    return m_distribution;
}
void OAIRotRutUpdateDto::setDistribution(const QList<OAIRotRutDistributionUpdateDto> &distribution) {
    m_distribution = distribution;
    m_distribution_isSet = true;
}

bool OAIRotRutUpdateDto::is_distribution_Set() const{
    return m_distribution_isSet;
}

bool OAIRotRutUpdateDto::is_distribution_Valid() const{
    return m_distribution_isValid;
}

OAIDtoValueOfString OAIRotRutUpdateDto::getEstate() const {
    return m_estate;
}
void OAIRotRutUpdateDto::setEstate(const OAIDtoValueOfString &estate) {
    m_estate = estate;
    m_estate_isSet = true;
}

bool OAIRotRutUpdateDto::is_estate_Set() const{
    return m_estate_isSet;
}

bool OAIRotRutUpdateDto::is_estate_Valid() const{
    return m_estate_isValid;
}

OAIDtoValueOfString OAIRotRutUpdateDto::getOrganizationNbr() const {
    return m_organization_nbr;
}
void OAIRotRutUpdateDto::setOrganizationNbr(const OAIDtoValueOfString &organization_nbr) {
    m_organization_nbr = organization_nbr;
    m_organization_nbr_isSet = true;
}

bool OAIRotRutUpdateDto::is_organization_nbr_Set() const{
    return m_organization_nbr_isSet;
}

bool OAIRotRutUpdateDto::is_organization_nbr_Valid() const{
    return m_organization_nbr_isValid;
}

OAIDtoValueOfNullableOfRutRotTypes OAIRotRutUpdateDto::getType() const {
    return m_type;
}
void OAIRotRutUpdateDto::setType(const OAIDtoValueOfNullableOfRutRotTypes &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIRotRutUpdateDto::is_type_Set() const{
    return m_type_isSet;
}

bool OAIRotRutUpdateDto::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIRotRutUpdateDto::isSet() const {
...
bool OAIRotRutUpdateDto::isValid() const {
