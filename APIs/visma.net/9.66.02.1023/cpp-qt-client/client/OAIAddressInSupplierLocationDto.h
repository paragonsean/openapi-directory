...
/*
 * OAIAddressInSupplierLocationDto.h
 *
 * General information tab &amp;gt; Location address section &amp;gt;
 */

#ifndef OAIAddressInSupplierLocationDto_H
#define OAIAddressInSupplierLocationDto_H
...
class OAIAddressInSupplierLocationDto : public OAIObject {
public:
    OAIAddressInSupplierLocationDto();
    OAIAddressInSupplierLocationDto(QString json);
    ~OAIAddressInSupplierLocationDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddressInSupplierLocationDto)

#endif // OAIAddressInSupplierLocationDto_H
