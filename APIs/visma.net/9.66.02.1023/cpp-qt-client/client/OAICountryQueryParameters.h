...
/*
 * OAICountryQueryParameters.h
 *
 * 
 */

#ifndef OAICountryQueryParameters_H
#define OAICountryQueryParameters_H
...
class OAICountryQueryParameters : public OAIObject {
public:
    OAICountryQueryParameters();
    OAICountryQueryParameters(QString json);
    ~OAICountryQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICountryQueryParameters)

#endif // OAICountryQueryParameters_H
