...
/*
 * OAIFixedAssetQueryParameters.h
 *
 * 
 */

#ifndef OAIFixedAssetQueryParameters_H
#define OAIFixedAssetQueryParameters_H
...
class OAIFixedAssetQueryParameters : public OAIObject {
public:
    OAIFixedAssetQueryParameters();
    OAIFixedAssetQueryParameters(QString json);
    ~OAIFixedAssetQueryParameters() override;
    ...
    bool isExpandAccounts() const;
    void setExpandAccounts(const bool &expand_accounts);
    bool is_expand_accounts_Set() const;
    bool is_expand_accounts_Valid() const;
...
private:
    ...
    bool m_expand_accounts;
    bool m_expand_accounts_isSet;
    bool m_expand_accounts_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFixedAssetQueryParameters)

#endif // OAIFixedAssetQueryParameters_H
