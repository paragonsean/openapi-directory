...
/*
 * OAISubaccountInCustomerCreditNoteLineDto.h
 *
 * Mandatory field: Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCustomerCreditNoteLineDto_H
#define OAISubaccountInCustomerCreditNoteLineDto_H
...
class OAISubaccountInCustomerCreditNoteLineDto : public OAIObject {
public:
    OAISubaccountInCustomerCreditNoteLineDto();
    OAISubaccountInCustomerCreditNoteLineDto(QString json);
    ~OAISubaccountInCustomerCreditNoteLineDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCustomerCreditNoteLineDto)

#endif // OAISubaccountInCustomerCreditNoteLineDto_H
