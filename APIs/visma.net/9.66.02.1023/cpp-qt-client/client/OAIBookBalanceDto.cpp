...
OAIBookBalanceDto::OAIBookBalanceDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBookBalanceDto::OAIBookBalanceDto() {
    this->initializeModel();
}

OAIBookBalanceDto::~OAIBookBalanceDto() {}

void OAIBookBalanceDto::initializeModel() {
...
void OAIBookBalanceDto::fromJson(QString jsonString) {
...
void OAIBookBalanceDto::fromJsonObject(QJsonObject json) {
...
QString OAIBookBalanceDto::asJson() const {
...
QJsonObject OAIBookBalanceDto::asJsonObject() const {
    QJsonObject obj;
...
double OAIBookBalanceDto::getAcquisitionCost() const {
    return m_acquisition_cost;
}
void OAIBookBalanceDto::setAcquisitionCost(const double &acquisition_cost) {
    m_acquisition_cost = acquisition_cost;
    m_acquisition_cost_isSet = true;
}

bool OAIBookBalanceDto::is_acquisition_cost_Set() const{
    return m_acquisition_cost_isSet;
}

bool OAIBookBalanceDto::is_acquisition_cost_Valid() const{
    return m_acquisition_cost_isValid;
}

OAIBookInBookBalanceDto OAIBookBalanceDto::getBook() const {
    return m_book;
}
void OAIBookBalanceDto::setBook(const OAIBookInBookBalanceDto &book) {
    m_book = book;
    m_book_isSet = true;
}

bool OAIBookBalanceDto::is_book_Set() const{
    return m_book_isSet;
}

bool OAIBookBalanceDto::is_book_Valid() const{
    return m_book_isValid;
}

QDateTime OAIBookBalanceDto::getDepreciationFromDate() const {
    return m_depreciation_from_date;
}
void OAIBookBalanceDto::setDepreciationFromDate(const QDateTime &depreciation_from_date) {
    m_depreciation_from_date = depreciation_from_date;
    m_depreciation_from_date_isSet = true;
}

bool OAIBookBalanceDto::is_depreciation_from_date_Set() const{
    return m_depreciation_from_date_isSet;
}

bool OAIBookBalanceDto::is_depreciation_from_date_Valid() const{
    return m_depreciation_from_date_isValid;
}

QString OAIBookBalanceDto::getDepreciationFromPeriod() const {
    return m_depreciation_from_period;
}
void OAIBookBalanceDto::setDepreciationFromPeriod(const QString &depreciation_from_period) {
    m_depreciation_from_period = depreciation_from_period;
    m_depreciation_from_period_isSet = true;
}

bool OAIBookBalanceDto::is_depreciation_from_period_Set() const{
    return m_depreciation_from_period_isSet;
}

bool OAIBookBalanceDto::is_depreciation_from_period_Valid() const{
    return m_depreciation_from_period_isValid;
}

QString OAIBookBalanceDto::getDepreciationMethodId() const {
    return m_depreciation_method_id;
}
void OAIBookBalanceDto::setDepreciationMethodId(const QString &depreciation_method_id) {
    m_depreciation_method_id = depreciation_method_id;
    m_depreciation_method_id_isSet = true;
}

bool OAIBookBalanceDto::is_depreciation_method_id_Set() const{
    return m_depreciation_method_id_isSet;
}

bool OAIBookBalanceDto::is_depreciation_method_id_Valid() const{
    return m_depreciation_method_id_isValid;
}

QString OAIBookBalanceDto::getDepreciationToPeriod() const {
    return m_depreciation_to_period;
}
void OAIBookBalanceDto::setDepreciationToPeriod(const QString &depreciation_to_period) {
    m_depreciation_to_period = depreciation_to_period;
    m_depreciation_to_period_isSet = true;
}

bool OAIBookBalanceDto::is_depreciation_to_period_Set() const{
    return m_depreciation_to_period_isSet;
}

bool OAIBookBalanceDto::is_depreciation_to_period_Valid() const{
    return m_depreciation_to_period_isValid;
}

QString OAIBookBalanceDto::getLastDepreciationPeriod() const {
    return m_last_depreciation_period;
}
void OAIBookBalanceDto::setLastDepreciationPeriod(const QString &last_depreciation_period) {
    m_last_depreciation_period = last_depreciation_period;
    m_last_depreciation_period_isSet = true;
}

bool OAIBookBalanceDto::is_last_depreciation_period_Set() const{
    return m_last_depreciation_period_isSet;
}

bool OAIBookBalanceDto::is_last_depreciation_period_Valid() const{
    return m_last_depreciation_period_isValid;
}

double OAIBookBalanceDto::getSalvageAmount() const {
    return m_salvage_amount;
}
void OAIBookBalanceDto::setSalvageAmount(const double &salvage_amount) {
    m_salvage_amount = salvage_amount;
    m_salvage_amount_isSet = true;
}

bool OAIBookBalanceDto::is_salvage_amount_Set() const{
    return m_salvage_amount_isSet;
}

bool OAIBookBalanceDto::is_salvage_amount_Valid() const{
    return m_salvage_amount_isValid;
}

double OAIBookBalanceDto::getUsefulLife() const {
    return m_useful_life;
}
void OAIBookBalanceDto::setUsefulLife(const double &useful_life) {
    m_useful_life = useful_life;
    m_useful_life_isSet = true;
}

bool OAIBookBalanceDto::is_useful_life_Set() const{
    return m_useful_life_isSet;
}

bool OAIBookBalanceDto::is_useful_life_Valid() const{
    return m_useful_life_isValid;
}

bool OAIBookBalanceDto::isSet() const {
...
bool OAIBookBalanceDto::isValid() const {
