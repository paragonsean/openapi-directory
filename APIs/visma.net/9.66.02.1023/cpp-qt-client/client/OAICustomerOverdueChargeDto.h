...
/*
 * OAICustomerOverdueChargeDto.h
 *
 * This class represents a invoice in CustomerOverdueChargeController. Used by getting data.
 */

#ifndef OAICustomerOverdueChargeDto_H
#define OAICustomerOverdueChargeDto_H

#include <QJsonObject>

#include "OAIAccountInCustomerOverdueChargeDto.h"
#include "OAIArAdjustDto.h"
#include "OAIAttachmentDto.h"
#include "OAIBranchNumberInCustomerOverdueChargeDto.h"
#include "OAIContactInCustomerOverdueChargeDto.h"
#include "OAICreditTermsInCustomerOverdueChargeDto.h"
#include "OAICustomerInCustomerOverdueChargeDto.h"
#include "OAICustomerOverdueChargeLineDto.h"
#include "OAICustomerVatZoneInCustomerOverdueChargeDto.h"
#include "OAIInvoiceAddressInCustomerOverdueChargeDto.h"
#include "OAIInvoiceContactInCustomerOverdueChargeDto.h"
#include "OAILocationInCustomerOverdueChargeDto.h"
#include "OAIMetadataDto.h"
#include "OAIPaymentMethodInCustomerOverdueChargeDto.h"
#include "OAIProjectInCustomerOverdueChargeDto.h"
#include "OAISalesPersonInCustomerOverdueChargeDto.h"
#include "OAISubaccountInCustomerOverdueChargeDto.h"
...
namespace OpenAPI {
class OAIAccountInCustomerOverdueChargeDto;
class OAIArAdjustDto;
class OAIAttachmentDto;
class OAIBranchNumberInCustomerOverdueChargeDto;
class OAIContactInCustomerOverdueChargeDto;
class OAICreditTermsInCustomerOverdueChargeDto;
class OAICustomerInCustomerOverdueChargeDto;
class OAICustomerVatZoneInCustomerOverdueChargeDto;
class OAIInvoiceAddressInCustomerOverdueChargeDto;
class OAIInvoiceContactInCustomerOverdueChargeDto;
class OAICustomerOverdueChargeLineDto;
class OAILocationInCustomerOverdueChargeDto;
class OAIMetadataDto;
class OAIPaymentMethodInCustomerOverdueChargeDto;
class OAIProjectInCustomerOverdueChargeDto;
class OAISalesPersonInCustomerOverdueChargeDto;
class OAISubaccountInCustomerOverdueChargeDto;
class OAITaxDetailDto;

class OAICustomerOverdueChargeDto : public OAIObject {
public:
    OAICustomerOverdueChargeDto();
    OAICustomerOverdueChargeDto(QString json);
    ~OAICustomerOverdueChargeDto() override;
    ...
    OAIAccountInCustomerOverdueChargeDto getAccount() const;
    void setAccount(const OAIAccountInCustomerOverdueChargeDto &account);
    ...
    OAIBranchNumberInCustomerOverdueChargeDto getBranchNumber() const;
    void setBranchNumber(const OAIBranchNumberInCustomerOverdueChargeDto &branch_number);
    ...
    OAIContactInCustomerOverdueChargeDto getContact() const;
    void setContact(const OAIContactInCustomerOverdueChargeDto &contact);
    ...
    OAICreditTermsInCustomerOverdueChargeDto getCreditTerms() const;
    void setCreditTerms(const OAICreditTermsInCustomerOverdueChargeDto &credit_terms);
    ...
    OAICustomerInCustomerOverdueChargeDto getCustomer() const;
    void setCustomer(const OAICustomerInCustomerOverdueChargeDto &customer);
    ...
    OAICustomerVatZoneInCustomerOverdueChargeDto getCustomerVatZone() const;
    void setCustomerVatZone(const OAICustomerVatZoneInCustomerOverdueChargeDto &customer_vat_zone);
    ...
    OAIInvoiceAddressInCustomerOverdueChargeDto getInvoiceAddress() const;
    void setInvoiceAddress(const OAIInvoiceAddressInCustomerOverdueChargeDto &invoice_address);
    bool is_invoice_address_Set() const;
    bool is_invoice_address_Valid() const;

    OAIInvoiceContactInCustomerOverdueChargeDto getInvoiceContact() const;
    void setInvoiceContact(const OAIInvoiceContactInCustomerOverdueChargeDto &invoice_contact);
    ...
    QList<OAICustomerOverdueChargeLineDto> getLines() const;
    void setLines(const QList<OAICustomerOverdueChargeLineDto> &lines);
    bool is_lines_Set() const;
    bool is_lines_Valid() const;

    OAILocationInCustomerOverdueChargeDto getLocation() const;
    void setLocation(const OAILocationInCustomerOverdueChargeDto &location);
    ...
    OAIPaymentMethodInCustomerOverdueChargeDto getPaymentMethod() const;
    void setPaymentMethod(const OAIPaymentMethodInCustomerOverdueChargeDto &payment_method);
    ...
    OAIProjectInCustomerOverdueChargeDto getProject() const;
    void setProject(const OAIProjectInCustomerOverdueChargeDto &project);
    ...
    OAISalesPersonInCustomerOverdueChargeDto getSalesPerson() const;
    void setSalesPerson(const OAISalesPersonInCustomerOverdueChargeDto &sales_person);
    ...
    OAISubaccountInCustomerOverdueChargeDto getSubaccount() const;
    void setSubaccount(const OAISubaccountInCustomerOverdueChargeDto &subaccount);
...
private:
    ...
    OAIAccountInCustomerOverdueChargeDto m_account;
    ...
    OAIBranchNumberInCustomerOverdueChargeDto m_branch_number;
    ...
    OAIContactInCustomerOverdueChargeDto m_contact;
    ...
    OAICreditTermsInCustomerOverdueChargeDto m_credit_terms;
    ...
    OAICustomerInCustomerOverdueChargeDto m_customer;
    ...
    OAICustomerVatZoneInCustomerOverdueChargeDto m_customer_vat_zone;
    ...
    OAIInvoiceAddressInCustomerOverdueChargeDto m_invoice_address;
    bool m_invoice_address_isSet;
    bool m_invoice_address_isValid;

    OAIInvoiceContactInCustomerOverdueChargeDto m_invoice_contact;
    ...
    QList<OAICustomerOverdueChargeLineDto> m_lines;
    bool m_lines_isSet;
    bool m_lines_isValid;

    OAILocationInCustomerOverdueChargeDto m_location;
    ...
    OAIPaymentMethodInCustomerOverdueChargeDto m_payment_method;
    ...
    OAIProjectInCustomerOverdueChargeDto m_project;
    ...
    OAISalesPersonInCustomerOverdueChargeDto m_sales_person;
    ...
    OAISubaccountInCustomerOverdueChargeDto m_subaccount;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerOverdueChargeDto)

#endif // OAICustomerOverdueChargeDto_H
