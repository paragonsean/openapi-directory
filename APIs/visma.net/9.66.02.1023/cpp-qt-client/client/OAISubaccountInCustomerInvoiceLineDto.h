...
/*
 * OAISubaccountInCustomerInvoiceLineDto.h
 *
 * Mandatory field: Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCustomerInvoiceLineDto_H
#define OAISubaccountInCustomerInvoiceLineDto_H
...
class OAISubaccountInCustomerInvoiceLineDto : public OAIObject {
public:
    OAISubaccountInCustomerInvoiceLineDto();
    OAISubaccountInCustomerInvoiceLineDto(QString json);
    ~OAISubaccountInCustomerInvoiceLineDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCustomerInvoiceLineDto)

#endif // OAISubaccountInCustomerInvoiceLineDto_H
