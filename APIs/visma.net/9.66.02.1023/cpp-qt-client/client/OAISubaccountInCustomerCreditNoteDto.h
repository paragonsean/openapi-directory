...
/*
 * OAISubaccountInCustomerCreditNoteDto.h
 *
 * The Document details tab &amp;gt; Subaccount* &amp;gt; The corresponding subaccount used for this transaction.
 */

#ifndef OAISubaccountInCustomerCreditNoteDto_H
#define OAISubaccountInCustomerCreditNoteDto_H
...
class OAISubaccountInCustomerCreditNoteDto : public OAIObject {
public:
    OAISubaccountInCustomerCreditNoteDto();
    OAISubaccountInCustomerCreditNoteDto(QString json);
    ~OAISubaccountInCustomerCreditNoteDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubaccountInCustomerCreditNoteDto)

#endif // OAISubaccountInCustomerCreditNoteDto_H
