...
/*
 * OAIDiscountCodeQueryParameters.h
 *
 * 
 */

#ifndef OAIDiscountCodeQueryParameters_H
#define OAIDiscountCodeQueryParameters_H
...
class OAIDiscountCodeQueryParameters : public OAIObject {
public:
    OAIDiscountCodeQueryParameters();
    OAIDiscountCodeQueryParameters(QString json);
    ~OAIDiscountCodeQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiscountCodeQueryParameters)

#endif // OAIDiscountCodeQueryParameters_H
