...
/*
 * OAIAddressInEmployeeDto.h
 *
 * General information tab &amp;gt; Address info section &amp;gt;
 */

#ifndef OAIAddressInEmployeeDto_H
#define OAIAddressInEmployeeDto_H
...
class OAIAddressInEmployeeDto : public OAIObject {
public:
    OAIAddressInEmployeeDto();
    OAIAddressInEmployeeDto(QString json);
    ~OAIAddressInEmployeeDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddressInEmployeeDto)

#endif // OAIAddressInEmployeeDto_H
