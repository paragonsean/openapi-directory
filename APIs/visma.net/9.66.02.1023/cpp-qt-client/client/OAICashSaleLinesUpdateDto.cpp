...
OAICashSaleLinesUpdateDto::OAICashSaleLinesUpdateDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICashSaleLinesUpdateDto::OAICashSaleLinesUpdateDto() {
    this->initializeModel();
}

OAICashSaleLinesUpdateDto::~OAICashSaleLinesUpdateDto() {}

void OAICashSaleLinesUpdateDto::initializeModel() {
...
void OAICashSaleLinesUpdateDto::fromJson(QString jsonString) {
...
void OAICashSaleLinesUpdateDto::fromJsonObject(QJsonObject json) {
...
QString OAICashSaleLinesUpdateDto::asJson() const {
...
QJsonObject OAICashSaleLinesUpdateDto::asJsonObject() const {
    QJsonObject obj;
...
OAIDtoValueOfString OAICashSaleLinesUpdateDto::getAccountNumber() const {
    return m_account_number;
}
void OAICashSaleLinesUpdateDto::setAccountNumber(const OAIDtoValueOfString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAICashSaleLinesUpdateDto::is_account_number_Valid() const{
    return m_account_number_isValid;
}

OAIDtoValueOfString OAICashSaleLinesUpdateDto::getBranchNumber() const {
    return m_branch_number;
}
void OAICashSaleLinesUpdateDto::setBranchNumber(const OAIDtoValueOfString &branch_number) {
    m_branch_number = branch_number;
    m_branch_number_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_branch_number_Set() const{
    return m_branch_number_isSet;
}

bool OAICashSaleLinesUpdateDto::is_branch_number_Valid() const{
    return m_branch_number_isValid;
}

OAIDtoValueOfString OAICashSaleLinesUpdateDto::getDeferralCode() const {
    return m_deferral_code;
}
void OAICashSaleLinesUpdateDto::setDeferralCode(const OAIDtoValueOfString &deferral_code) {
    m_deferral_code = deferral_code;
    m_deferral_code_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_deferral_code_Set() const{
    return m_deferral_code_isSet;
}

bool OAICashSaleLinesUpdateDto::is_deferral_code_Valid() const{
    return m_deferral_code_isValid;
}

OAIDtoValueOfInt32 OAICashSaleLinesUpdateDto::getDeferralSchedule() const {
    return m_deferral_schedule;
}
void OAICashSaleLinesUpdateDto::setDeferralSchedule(const OAIDtoValueOfInt32 &deferral_schedule) {
    m_deferral_schedule = deferral_schedule;
    m_deferral_schedule_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_deferral_schedule_Set() const{
    return m_deferral_schedule_isSet;
}

bool OAICashSaleLinesUpdateDto::is_deferral_schedule_Valid() const{
    return m_deferral_schedule_isValid;
}

OAIDtoValueOfString OAICashSaleLinesUpdateDto::getDescription() const {
    return m_description;
}
void OAICashSaleLinesUpdateDto::setDescription(const OAIDtoValueOfString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_description_Set() const{
    return m_description_isSet;
}

bool OAICashSaleLinesUpdateDto::is_description_Valid() const{
    return m_description_isValid;
}

OAIDtoValueOfDecimal OAICashSaleLinesUpdateDto::getDiscountAmountInCurrency() const {
    return m_discount_amount_in_currency;
}
void OAICashSaleLinesUpdateDto::setDiscountAmountInCurrency(const OAIDtoValueOfDecimal &discount_amount_in_currency) {
    m_discount_amount_in_currency = discount_amount_in_currency;
    m_discount_amount_in_currency_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_discount_amount_in_currency_Set() const{
    return m_discount_amount_in_currency_isSet;
}

bool OAICashSaleLinesUpdateDto::is_discount_amount_in_currency_Valid() const{
    return m_discount_amount_in_currency_isValid;
}

OAIDtoValueOfDecimal OAICashSaleLinesUpdateDto::getDiscountPercent() const {
    return m_discount_percent;
}
void OAICashSaleLinesUpdateDto::setDiscountPercent(const OAIDtoValueOfDecimal &discount_percent) {
    m_discount_percent = discount_percent;
    m_discount_percent_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_discount_percent_Set() const{
    return m_discount_percent_isSet;
}

bool OAICashSaleLinesUpdateDto::is_discount_percent_Valid() const{
    return m_discount_percent_isValid;
}

OAIDtoValueOfString OAICashSaleLinesUpdateDto::getInventoryNumber() const {
    return m_inventory_number;
}
void OAICashSaleLinesUpdateDto::setInventoryNumber(const OAIDtoValueOfString &inventory_number) {
    m_inventory_number = inventory_number;
    m_inventory_number_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_inventory_number_Set() const{
    return m_inventory_number_isSet;
}

bool OAICashSaleLinesUpdateDto::is_inventory_number_Valid() const{
    return m_inventory_number_isValid;
}

OAIDtoValueOfInt32 OAICashSaleLinesUpdateDto::getLineNumber() const {
    return m_line_number;
}
void OAICashSaleLinesUpdateDto::setLineNumber(const OAIDtoValueOfInt32 &line_number) {
    m_line_number = line_number;
    m_line_number_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_line_number_Set() const{
    return m_line_number_isSet;
}

bool OAICashSaleLinesUpdateDto::is_line_number_Valid() const{
    return m_line_number_isValid;
}

OAIDtoValueOfDecimal OAICashSaleLinesUpdateDto::getManualAmountInCurrency() const {
    return m_manual_amount_in_currency;
}
void OAICashSaleLinesUpdateDto::setManualAmountInCurrency(const OAIDtoValueOfDecimal &manual_amount_in_currency) {
    m_manual_amount_in_currency = manual_amount_in_currency;
    m_manual_amount_in_currency_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_manual_amount_in_currency_Set() const{
    return m_manual_amount_in_currency_isSet;
}

bool OAICashSaleLinesUpdateDto::is_manual_amount_in_currency_Valid() const{
    return m_manual_amount_in_currency_isValid;
}

OAIDtoValueOfBoolean OAICashSaleLinesUpdateDto::getManualDiscount() const {
    return m_manual_discount;
}
void OAICashSaleLinesUpdateDto::setManualDiscount(const OAIDtoValueOfBoolean &manual_discount) {
    m_manual_discount = manual_discount;
    m_manual_discount_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_manual_discount_Set() const{
    return m_manual_discount_isSet;
}

bool OAICashSaleLinesUpdateDto::is_manual_discount_Valid() const{
    return m_manual_discount_isValid;
}

OAIDtoValueOfString OAICashSaleLinesUpdateDto::getNote() const {
    return m_note;
}
void OAICashSaleLinesUpdateDto::setNote(const OAIDtoValueOfString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_note_Set() const{
    return m_note_isSet;
}

bool OAICashSaleLinesUpdateDto::is_note_Valid() const{
    return m_note_isValid;
}

QString OAICashSaleLinesUpdateDto::getOperation() const {
    return m_operation;
}
void OAICashSaleLinesUpdateDto::setOperation(const QString &operation) {
    m_operation = operation;
    m_operation_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_operation_Set() const{
    return m_operation_isSet;
}

bool OAICashSaleLinesUpdateDto::is_operation_Valid() const{
    return m_operation_isValid;
}

OAIDtoValueOfDecimal OAICashSaleLinesUpdateDto::getQuantity() const {
    return m_quantity;
}
void OAICashSaleLinesUpdateDto::setQuantity(const OAIDtoValueOfDecimal &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAICashSaleLinesUpdateDto::is_quantity_Valid() const{
    return m_quantity_isValid;
}

OAIDtoValueOfString OAICashSaleLinesUpdateDto::getSalesperson() const {
    return m_salesperson;
}
void OAICashSaleLinesUpdateDto::setSalesperson(const OAIDtoValueOfString &salesperson) {
    m_salesperson = salesperson;
    m_salesperson_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_salesperson_Set() const{
    return m_salesperson_isSet;
}

bool OAICashSaleLinesUpdateDto::is_salesperson_Valid() const{
    return m_salesperson_isValid;
}

QList<OAISegmentUpdateDto> OAICashSaleLinesUpdateDto::getSubaccount() const {
    return m_subaccount;
}
void OAICashSaleLinesUpdateDto::setSubaccount(const QList<OAISegmentUpdateDto> &subaccount) {
    m_subaccount = subaccount;
    m_subaccount_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_subaccount_Set() const{
    return m_subaccount_isSet;
}

bool OAICashSaleLinesUpdateDto::is_subaccount_Valid() const{
    return m_subaccount_isValid;
}

OAIDtoValueOfDateTime OAICashSaleLinesUpdateDto::getTermEndDate() const {
    return m_term_end_date;
}
void OAICashSaleLinesUpdateDto::setTermEndDate(const OAIDtoValueOfDateTime &term_end_date) {
    m_term_end_date = term_end_date;
    m_term_end_date_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_term_end_date_Set() const{
    return m_term_end_date_isSet;
}

bool OAICashSaleLinesUpdateDto::is_term_end_date_Valid() const{
    return m_term_end_date_isValid;
}

OAIDtoValueOfDateTime OAICashSaleLinesUpdateDto::getTermStartDate() const {
    return m_term_start_date;
}
void OAICashSaleLinesUpdateDto::setTermStartDate(const OAIDtoValueOfDateTime &term_start_date) {
    m_term_start_date = term_start_date;
    m_term_start_date_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_term_start_date_Set() const{
    return m_term_start_date_isSet;
}

bool OAICashSaleLinesUpdateDto::is_term_start_date_Valid() const{
    return m_term_start_date_isValid;
}

OAIDtoValueOfDecimal OAICashSaleLinesUpdateDto::getUnitPriceInCurrency() const {
    return m_unit_price_in_currency;
}
void OAICashSaleLinesUpdateDto::setUnitPriceInCurrency(const OAIDtoValueOfDecimal &unit_price_in_currency) {
    m_unit_price_in_currency = unit_price_in_currency;
    m_unit_price_in_currency_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_unit_price_in_currency_Set() const{
    return m_unit_price_in_currency_isSet;
}

bool OAICashSaleLinesUpdateDto::is_unit_price_in_currency_Valid() const{
    return m_unit_price_in_currency_isValid;
}

OAIDtoValueOfString OAICashSaleLinesUpdateDto::getUom() const {
    return m_uom;
}
void OAICashSaleLinesUpdateDto::setUom(const OAIDtoValueOfString &uom) {
    m_uom = uom;
    m_uom_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_uom_Set() const{
    return m_uom_isSet;
}

bool OAICashSaleLinesUpdateDto::is_uom_Valid() const{
    return m_uom_isValid;
}

OAIDtoValueOfString OAICashSaleLinesUpdateDto::getVatCodeId() const {
    return m_vat_code_id;
}
void OAICashSaleLinesUpdateDto::setVatCodeId(const OAIDtoValueOfString &vat_code_id) {
    m_vat_code_id = vat_code_id;
    m_vat_code_id_isSet = true;
}

bool OAICashSaleLinesUpdateDto::is_vat_code_id_Set() const{
    return m_vat_code_id_isSet;
}

bool OAICashSaleLinesUpdateDto::is_vat_code_id_Valid() const{
    return m_vat_code_id_isValid;
}

bool OAICashSaleLinesUpdateDto::isSet() const {
...
bool OAICashSaleLinesUpdateDto::isValid() const {
