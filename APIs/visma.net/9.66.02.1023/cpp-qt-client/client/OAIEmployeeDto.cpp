...
OAIAddressInEmployeeDto OAIEmployeeDto::getAddress() const {
    return m_address;
}
void OAIEmployeeDto::setAddress(const OAIAddressInEmployeeDto &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIEmployeeDto::is_address_Set() const{
    return m_address_isSet;
}

bool OAIEmployeeDto::is_address_Valid() const{
    return m_address_isValid;
}

OAIBranchNumberDto OAIEmployeeDto::getBranch() const {
    return m_branch;
}
void OAIEmployeeDto::setBranch(const OAIBranchNumberDto &branch) {
    m_branch = branch;
    m_branch_isSet = true;
}

bool OAIEmployeeDto::is_branch_Set() const{
    return m_branch_isSet;
}

bool OAIEmployeeDto::is_branch_Valid() const{
    return m_branch_isValid;
}

QString OAIEmployeeDto::getCalendarId() const {
    return m_calendar_id;
}
void OAIEmployeeDto::setCalendarId(const QString &calendar_id) {
    m_calendar_id = calendar_id;
    m_calendar_id_isSet = true;
}

bool OAIEmployeeDto::is_calendar_id_Set() const{
    return m_calendar_id_isSet;
}

bool OAIEmployeeDto::is_calendar_id_Valid() const{
    return m_calendar_id_isValid;
}

OAIContactInEmployeeDto OAIEmployeeDto::getContact() const {
    return m_contact;
}
void OAIEmployeeDto::setContact(const OAIContactInEmployeeDto &contact) {
    m_contact = contact;
    m_contact_isSet = true;
}

bool OAIEmployeeDto::is_contact_Set() const{
    return m_contact_isSet;
}

bool OAIEmployeeDto::is_contact_Valid() const{
    return m_contact_isValid;
}

QString OAIEmployeeDto::getDepartment() const {
    return m_department;
}
void OAIEmployeeDto::setDepartment(const QString &department) {
    m_department = department;
    m_department_isSet = true;
}

bool OAIEmployeeDto::is_department_Set() const{
    return m_department_isSet;
}

bool OAIEmployeeDto::is_department_Valid() const{
    return m_department_isValid;
}

OAIEmployeeClassInEmployeeDto OAIEmployeeDto::getEmployeeClass() const {
    return m_employee_class;
}
void OAIEmployeeDto::setEmployeeClass(const OAIEmployeeClassInEmployeeDto &employee_class) {
    m_employee_class = employee_class;
    m_employee_class_isSet = true;
}

bool OAIEmployeeDto::is_employee_class_Set() const{
    return m_employee_class_isSet;
}

bool OAIEmployeeDto::is_employee_class_Valid() const{
    return m_employee_class_isValid;
}

qint32 OAIEmployeeDto::getEmployeeId() const {
    return m_employee_id;
}
void OAIEmployeeDto::setEmployeeId(const qint32 &employee_id) {
    m_employee_id = employee_id;
    m_employee_id_isSet = true;
}

bool OAIEmployeeDto::is_employee_id_Set() const{
    return m_employee_id_isSet;
}

bool OAIEmployeeDto::is_employee_id_Valid() const{
    return m_employee_id_isValid;
}

QString OAIEmployeeDto::getEmployeeLogin() const {
    return m_employee_login;
}
void OAIEmployeeDto::setEmployeeLogin(const QString &employee_login) {
    m_employee_login = employee_login;
    m_employee_login_isSet = true;
}

bool OAIEmployeeDto::is_employee_login_Set() const{
    return m_employee_login_isSet;
}

bool OAIEmployeeDto::is_employee_login_Valid() const{
    return m_employee_login_isValid;
}

QString OAIEmployeeDto::getEmployeeName() const {
    return m_employee_name;
}
void OAIEmployeeDto::setEmployeeName(const QString &employee_name) {
    m_employee_name = employee_name;
    m_employee_name_isSet = true;
}

bool OAIEmployeeDto::is_employee_name_Set() const{
    return m_employee_name_isSet;
}

bool OAIEmployeeDto::is_employee_name_Valid() const{
    return m_employee_name_isValid;
}

QString OAIEmployeeDto::getEmployeeNumber() const {
    return m_employee_number;
}
void OAIEmployeeDto::setEmployeeNumber(const QString &employee_number) {
    m_employee_number = employee_number;
    m_employee_number_isSet = true;
}

bool OAIEmployeeDto::is_employee_number_Set() const{
    return m_employee_number_isSet;
}

bool OAIEmployeeDto::is_employee_number_Valid() const{
    return m_employee_number_isValid;
}

QString OAIEmployeeDto::getEmployeeUserId() const {
    return m_employee_user_id;
}
void OAIEmployeeDto::setEmployeeUserId(const QString &employee_user_id) {
    m_employee_user_id = employee_user_id;
    m_employee_user_id_isSet = true;
}

bool OAIEmployeeDto::is_employee_user_id_Set() const{
    return m_employee_user_id_isSet;
}

bool OAIEmployeeDto::is_employee_user_id_Valid() const{
    return m_employee_user_id_isValid;
}

QString OAIEmployeeDto::getErrorInfo() const {
    return m_error_info;
}
void OAIEmployeeDto::setErrorInfo(const QString &error_info) {
    m_error_info = error_info;
    m_error_info_isSet = true;
}

bool OAIEmployeeDto::is_error_info_Set() const{
    return m_error_info_isSet;
}

bool OAIEmployeeDto::is_error_info_Valid() const{
    return m_error_info_isValid;
}

QDateTime OAIEmployeeDto::getLastModifiedDateTime() const {
    return m_last_modified_date_time;
}
void OAIEmployeeDto::setLastModifiedDateTime(const QDateTime &last_modified_date_time) {
    m_last_modified_date_time = last_modified_date_time;
    m_last_modified_date_time_isSet = true;
}

bool OAIEmployeeDto::is_last_modified_date_time_Set() const{
    return m_last_modified_date_time_isSet;
}

bool OAIEmployeeDto::is_last_modified_date_time_Valid() const{
    return m_last_modified_date_time_isValid;
}

OAIMetadataDto OAIEmployeeDto::getMetadata() const {
    return m_metadata;
}
void OAIEmployeeDto::setMetadata(const OAIMetadataDto &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIEmployeeDto::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIEmployeeDto::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QString OAIEmployeeDto::getStatus() const {
    return m_status;
}
void OAIEmployeeDto::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIEmployeeDto::is_status_Set() const{
    return m_status_isSet;
}

bool OAIEmployeeDto::is_status_Valid() const{
    return m_status_isValid;
}

QList<QString> OAIEmployeeDto::getWorkGroupDescription() const {
    return m_work_group_description;
}
void OAIEmployeeDto::setWorkGroupDescription(const QList<QString> &work_group_description) {
    m_work_group_description = work_group_description;
    m_work_group_description_isSet = true;
}

bool OAIEmployeeDto::is_work_group_description_Set() const{
    return m_work_group_description_isSet;
}

bool OAIEmployeeDto::is_work_group_description_Valid() const{
