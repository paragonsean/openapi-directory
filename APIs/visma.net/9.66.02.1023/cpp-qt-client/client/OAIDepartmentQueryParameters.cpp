...
#include "OAIDepartmentQueryParameters.h"
...
OAIDepartmentQueryParameters::OAIDepartmentQueryParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDepartmentQueryParameters::OAIDepartmentQueryParameters() {
    this->initializeModel();
}

OAIDepartmentQueryParameters::~OAIDepartmentQueryParameters() {}

void OAIDepartmentQueryParameters::initializeModel() {
...
void OAIDepartmentQueryParameters::fromJson(QString jsonString) {
...
void OAIDepartmentQueryParameters::fromJsonObject(QJsonObject json) {
...
QString OAIDepartmentQueryParameters::asJson() const {
...
QJsonObject OAIDepartmentQueryParameters::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDepartmentQueryParameters::getGreaterThanValue() const {
    return m_greater_than_value;
}
void OAIDepartmentQueryParameters::setGreaterThanValue(const QString &greater_than_value) {
    m_greater_than_value = greater_than_value;
    m_greater_than_value_isSet = true;
}

bool OAIDepartmentQueryParameters::is_greater_than_value_Set() const{
    return m_greater_than_value_isSet;
}

bool OAIDepartmentQueryParameters::is_greater_than_value_Valid() const{
    return m_greater_than_value_isValid;
}

QString OAIDepartmentQueryParameters::getLastModifiedDateTime() const {
    return m_last_modified_date_time;
}
void OAIDepartmentQueryParameters::setLastModifiedDateTime(const QString &last_modified_date_time) {
    m_last_modified_date_time = last_modified_date_time;
    m_last_modified_date_time_isSet = true;
}

bool OAIDepartmentQueryParameters::is_last_modified_date_time_Set() const{
    return m_last_modified_date_time_isSet;
}

bool OAIDepartmentQueryParameters::is_last_modified_date_time_Valid() const{
    return m_last_modified_date_time_isValid;
}

QString OAIDepartmentQueryParameters::getLastModifiedDateTimeCondition() const {
    return m_last_modified_date_time_condition;
}
void OAIDepartmentQueryParameters::setLastModifiedDateTimeCondition(const QString &last_modified_date_time_condition) {
    m_last_modified_date_time_condition = last_modified_date_time_condition;
    m_last_modified_date_time_condition_isSet = true;
}

bool OAIDepartmentQueryParameters::is_last_modified_date_time_condition_Set() const{
    return m_last_modified_date_time_condition_isSet;
}

bool OAIDepartmentQueryParameters::is_last_modified_date_time_condition_Valid() const{
    return m_last_modified_date_time_condition_isValid;
}

qint32 OAIDepartmentQueryParameters::getNumberToRead() const {
    return m_number_to_read;
}
void OAIDepartmentQueryParameters::setNumberToRead(const qint32 &number_to_read) {
    m_number_to_read = number_to_read;
    m_number_to_read_isSet = true;
}

bool OAIDepartmentQueryParameters::is_number_to_read_Set() const{
    return m_number_to_read_isSet;
}

bool OAIDepartmentQueryParameters::is_number_to_read_Valid() const{
    return m_number_to_read_isValid;
}

QString OAIDepartmentQueryParameters::getOrderBy() const {
    return m_order_by;
}
void OAIDepartmentQueryParameters::setOrderBy(const QString &order_by) {
    m_order_by = order_by;
    m_order_by_isSet = true;
}

bool OAIDepartmentQueryParameters::is_order_by_Set() const{
    return m_order_by_isSet;
}

bool OAIDepartmentQueryParameters::is_order_by_Valid() const{
    return m_order_by_isValid;
}

qint32 OAIDepartmentQueryParameters::getSkipRecords() const {
    return m_skip_records;
}
void OAIDepartmentQueryParameters::setSkipRecords(const qint32 &skip_records) {
    m_skip_records = skip_records;
    m_skip_records_isSet = true;
}

bool OAIDepartmentQueryParameters::is_skip_records_Set() const{
    return m_skip_records_isSet;
}

bool OAIDepartmentQueryParameters::is_skip_records_Valid() const{
    return m_skip_records_isValid;
}

bool OAIDepartmentQueryParameters::isSet() const {
...
bool OAIDepartmentQueryParameters::isValid() const {
