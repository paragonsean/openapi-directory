...
OAICreditNoteLineUpdateDto::OAICreditNoteLineUpdateDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreditNoteLineUpdateDto::OAICreditNoteLineUpdateDto() {
    this->initializeModel();
}

OAICreditNoteLineUpdateDto::~OAICreditNoteLineUpdateDto() {}

void OAICreditNoteLineUpdateDto::initializeModel() {
...
void OAICreditNoteLineUpdateDto::fromJson(QString jsonString) {
...
void OAICreditNoteLineUpdateDto::fromJsonObject(QJsonObject json) {
...
QString OAICreditNoteLineUpdateDto::asJson() const {
...
QJsonObject OAICreditNoteLineUpdateDto::asJsonObject() const {
    QJsonObject obj;
...
OAIDtoValueOfString OAICreditNoteLineUpdateDto::getAccountNumber() const {
    return m_account_number;
}
void OAICreditNoteLineUpdateDto::setAccountNumber(const OAIDtoValueOfString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAICreditNoteLineUpdateDto::is_account_number_Valid() const{
    return m_account_number_isValid;
}

OAIDtoValueOfString OAICreditNoteLineUpdateDto::getBranchNumber() const {
    return m_branch_number;
}
void OAICreditNoteLineUpdateDto::setBranchNumber(const OAIDtoValueOfString &branch_number) {
    m_branch_number = branch_number;
    m_branch_number_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_branch_number_Set() const{
    return m_branch_number_isSet;
}

bool OAICreditNoteLineUpdateDto::is_branch_number_Valid() const{
    return m_branch_number_isValid;
}

OAIDtoValueOfString OAICreditNoteLineUpdateDto::getDeferralCode() const {
    return m_deferral_code;
}
void OAICreditNoteLineUpdateDto::setDeferralCode(const OAIDtoValueOfString &deferral_code) {
    m_deferral_code = deferral_code;
    m_deferral_code_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_deferral_code_Set() const{
    return m_deferral_code_isSet;
}

bool OAICreditNoteLineUpdateDto::is_deferral_code_Valid() const{
    return m_deferral_code_isValid;
}

OAIDtoValueOfInt32 OAICreditNoteLineUpdateDto::getDeferralSchedule() const {
    return m_deferral_schedule;
}
void OAICreditNoteLineUpdateDto::setDeferralSchedule(const OAIDtoValueOfInt32 &deferral_schedule) {
    m_deferral_schedule = deferral_schedule;
    m_deferral_schedule_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_deferral_schedule_Set() const{
    return m_deferral_schedule_isSet;
}

bool OAICreditNoteLineUpdateDto::is_deferral_schedule_Valid() const{
    return m_deferral_schedule_isValid;
}

OAIDtoValueOfString OAICreditNoteLineUpdateDto::getDescription() const {
    return m_description;
}
void OAICreditNoteLineUpdateDto::setDescription(const OAIDtoValueOfString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreditNoteLineUpdateDto::is_description_Valid() const{
    return m_description_isValid;
}

OAIDtoValueOfDecimal OAICreditNoteLineUpdateDto::getDiscountAmountInCurrency() const {
    return m_discount_amount_in_currency;
}
void OAICreditNoteLineUpdateDto::setDiscountAmountInCurrency(const OAIDtoValueOfDecimal &discount_amount_in_currency) {
    m_discount_amount_in_currency = discount_amount_in_currency;
    m_discount_amount_in_currency_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_discount_amount_in_currency_Set() const{
    return m_discount_amount_in_currency_isSet;
}

bool OAICreditNoteLineUpdateDto::is_discount_amount_in_currency_Valid() const{
    return m_discount_amount_in_currency_isValid;
}

OAIDtoValueOfString OAICreditNoteLineUpdateDto::getDiscountCode() const {
    return m_discount_code;
}
void OAICreditNoteLineUpdateDto::setDiscountCode(const OAIDtoValueOfString &discount_code) {
    m_discount_code = discount_code;
    m_discount_code_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_discount_code_Set() const{
    return m_discount_code_isSet;
}

bool OAICreditNoteLineUpdateDto::is_discount_code_Valid() const{
    return m_discount_code_isValid;
}

OAIDtoValueOfDecimal OAICreditNoteLineUpdateDto::getDiscountPercent() const {
    return m_discount_percent;
}
void OAICreditNoteLineUpdateDto::setDiscountPercent(const OAIDtoValueOfDecimal &discount_percent) {
    m_discount_percent = discount_percent;
    m_discount_percent_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_discount_percent_Set() const{
    return m_discount_percent_isSet;
}

bool OAICreditNoteLineUpdateDto::is_discount_percent_Valid() const{
    return m_discount_percent_isValid;
}

OAIDtoValueOfString OAICreditNoteLineUpdateDto::getInventoryNumber() const {
    return m_inventory_number;
}
void OAICreditNoteLineUpdateDto::setInventoryNumber(const OAIDtoValueOfString &inventory_number) {
    m_inventory_number = inventory_number;
    m_inventory_number_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_inventory_number_Set() const{
    return m_inventory_number_isSet;
}

bool OAICreditNoteLineUpdateDto::is_inventory_number_Valid() const{
    return m_inventory_number_isValid;
}

OAIDtoValueOfInt32 OAICreditNoteLineUpdateDto::getLineNumber() const {
    return m_line_number;
}
void OAICreditNoteLineUpdateDto::setLineNumber(const OAIDtoValueOfInt32 &line_number) {
    m_line_number = line_number;
    m_line_number_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_line_number_Set() const{
    return m_line_number_isSet;
}

bool OAICreditNoteLineUpdateDto::is_line_number_Valid() const{
    return m_line_number_isValid;
}

OAIDtoValueOfDecimal OAICreditNoteLineUpdateDto::getManualAmountInCurrency() const {
    return m_manual_amount_in_currency;
}
void OAICreditNoteLineUpdateDto::setManualAmountInCurrency(const OAIDtoValueOfDecimal &manual_amount_in_currency) {
    m_manual_amount_in_currency = manual_amount_in_currency;
    m_manual_amount_in_currency_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_manual_amount_in_currency_Set() const{
    return m_manual_amount_in_currency_isSet;
}

bool OAICreditNoteLineUpdateDto::is_manual_amount_in_currency_Valid() const{
    return m_manual_amount_in_currency_isValid;
}

OAIDtoValueOfBoolean OAICreditNoteLineUpdateDto::getManualDiscount() const {
    return m_manual_discount;
}
void OAICreditNoteLineUpdateDto::setManualDiscount(const OAIDtoValueOfBoolean &manual_discount) {
    m_manual_discount = manual_discount;
    m_manual_discount_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_manual_discount_Set() const{
    return m_manual_discount_isSet;
}

bool OAICreditNoteLineUpdateDto::is_manual_discount_Valid() const{
    return m_manual_discount_isValid;
}

OAIDtoValueOfString OAICreditNoteLineUpdateDto::getNote() const {
    return m_note;
}
void OAICreditNoteLineUpdateDto::setNote(const OAIDtoValueOfString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_note_Set() const{
    return m_note_isSet;
}

bool OAICreditNoteLineUpdateDto::is_note_Valid() const{
    return m_note_isValid;
}

QString OAICreditNoteLineUpdateDto::getOperation() const {
    return m_operation;
}
void OAICreditNoteLineUpdateDto::setOperation(const QString &operation) {
    m_operation = operation;
    m_operation_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_operation_Set() const{
    return m_operation_isSet;
}

bool OAICreditNoteLineUpdateDto::is_operation_Valid() const{
    return m_operation_isValid;
}

OAIDtoValueOfDecimal OAICreditNoteLineUpdateDto::getQuantity() const {
    return m_quantity;
}
void OAICreditNoteLineUpdateDto::setQuantity(const OAIDtoValueOfDecimal &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAICreditNoteLineUpdateDto::is_quantity_Valid() const{
    return m_quantity_isValid;
}

OAIDtoValueOfString OAICreditNoteLineUpdateDto::getSalesperson() const {
    return m_salesperson;
}
void OAICreditNoteLineUpdateDto::setSalesperson(const OAIDtoValueOfString &salesperson) {
    m_salesperson = salesperson;
    m_salesperson_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_salesperson_Set() const{
    return m_salesperson_isSet;
}

bool OAICreditNoteLineUpdateDto::is_salesperson_Valid() const{
    return m_salesperson_isValid;
}

QList<OAISegmentUpdateDto> OAICreditNoteLineUpdateDto::getSubaccount() const {
    return m_subaccount;
}
void OAICreditNoteLineUpdateDto::setSubaccount(const QList<OAISegmentUpdateDto> &subaccount) {
    m_subaccount = subaccount;
    m_subaccount_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_subaccount_Set() const{
    return m_subaccount_isSet;
}

bool OAICreditNoteLineUpdateDto::is_subaccount_Valid() const{
    return m_subaccount_isValid;
}

OAIDtoValueOfString OAICreditNoteLineUpdateDto::getTaskId() const {
    return m_task_id;
}
void OAICreditNoteLineUpdateDto::setTaskId(const OAIDtoValueOfString &task_id) {
    m_task_id = task_id;
    m_task_id_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_task_id_Set() const{
    return m_task_id_isSet;
}

bool OAICreditNoteLineUpdateDto::is_task_id_Valid() const{
    return m_task_id_isValid;
}

OAIDtoValueOfDateTime OAICreditNoteLineUpdateDto::getTermEndDate() const {
    return m_term_end_date;
}
void OAICreditNoteLineUpdateDto::setTermEndDate(const OAIDtoValueOfDateTime &term_end_date) {
    m_term_end_date = term_end_date;
    m_term_end_date_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_term_end_date_Set() const{
    return m_term_end_date_isSet;
}

bool OAICreditNoteLineUpdateDto::is_term_end_date_Valid() const{
    return m_term_end_date_isValid;
}

OAIDtoValueOfDateTime OAICreditNoteLineUpdateDto::getTermStartDate() const {
    return m_term_start_date;
}
void OAICreditNoteLineUpdateDto::setTermStartDate(const OAIDtoValueOfDateTime &term_start_date) {
    m_term_start_date = term_start_date;
    m_term_start_date_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_term_start_date_Set() const{
    return m_term_start_date_isSet;
}

bool OAICreditNoteLineUpdateDto::is_term_start_date_Valid() const{
    return m_term_start_date_isValid;
}

OAIDtoValueOfDecimal OAICreditNoteLineUpdateDto::getUnitPriceInCurrency() const {
    return m_unit_price_in_currency;
}
void OAICreditNoteLineUpdateDto::setUnitPriceInCurrency(const OAIDtoValueOfDecimal &unit_price_in_currency) {
    m_unit_price_in_currency = unit_price_in_currency;
    m_unit_price_in_currency_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_unit_price_in_currency_Set() const{
    return m_unit_price_in_currency_isSet;
}

bool OAICreditNoteLineUpdateDto::is_unit_price_in_currency_Valid() const{
    return m_unit_price_in_currency_isValid;
}

OAIDtoValueOfString OAICreditNoteLineUpdateDto::getUom() const {
    return m_uom;
}
void OAICreditNoteLineUpdateDto::setUom(const OAIDtoValueOfString &uom) {
    m_uom = uom;
    m_uom_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_uom_Set() const{
    return m_uom_isSet;
}

bool OAICreditNoteLineUpdateDto::is_uom_Valid() const{
    return m_uom_isValid;
}

OAIDtoValueOfString OAICreditNoteLineUpdateDto::getVatCodeId() const {
    return m_vat_code_id;
}
void OAICreditNoteLineUpdateDto::setVatCodeId(const OAIDtoValueOfString &vat_code_id) {
    m_vat_code_id = vat_code_id;
    m_vat_code_id_isSet = true;
}

bool OAICreditNoteLineUpdateDto::is_vat_code_id_Set() const{
    return m_vat_code_id_isSet;
}

bool OAICreditNoteLineUpdateDto::is_vat_code_id_Valid() const{
    return m_vat_code_id_isValid;
}

bool OAICreditNoteLineUpdateDto::isSet() const {
...
bool OAICreditNoteLineUpdateDto::isValid() const {
