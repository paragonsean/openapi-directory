...
#include "OAIVatQueryParameters.h"
...
OAIVatQueryParameters::OAIVatQueryParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVatQueryParameters::OAIVatQueryParameters() {
    this->initializeModel();
}

OAIVatQueryParameters::~OAIVatQueryParameters() {}

void OAIVatQueryParameters::initializeModel() {
...
void OAIVatQueryParameters::fromJson(QString jsonString) {
...
void OAIVatQueryParameters::fromJsonObject(QJsonObject json) {
...
QString OAIVatQueryParameters::asJson() const {
...
QJsonObject OAIVatQueryParameters::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVatQueryParameters::getLastModifiedDateTime() const {
    return m_last_modified_date_time;
}
void OAIVatQueryParameters::setLastModifiedDateTime(const QString &last_modified_date_time) {
    m_last_modified_date_time = last_modified_date_time;
    m_last_modified_date_time_isSet = true;
}

bool OAIVatQueryParameters::is_last_modified_date_time_Set() const{
    return m_last_modified_date_time_isSet;
}

bool OAIVatQueryParameters::is_last_modified_date_time_Valid() const{
    return m_last_modified_date_time_isValid;
}

QString OAIVatQueryParameters::getLastModifiedDateTimeCondition() const {
    return m_last_modified_date_time_condition;
}
void OAIVatQueryParameters::setLastModifiedDateTimeCondition(const QString &last_modified_date_time_condition) {
    m_last_modified_date_time_condition = last_modified_date_time_condition;
    m_last_modified_date_time_condition_isSet = true;
}

bool OAIVatQueryParameters::is_last_modified_date_time_condition_Set() const{
    return m_last_modified_date_time_condition_isSet;
}

bool OAIVatQueryParameters::is_last_modified_date_time_condition_Valid() const{
    return m_last_modified_date_time_condition_isValid;
}

qint32 OAIVatQueryParameters::getNumberToRead() const {
    return m_number_to_read;
}
void OAIVatQueryParameters::setNumberToRead(const qint32 &number_to_read) {
    m_number_to_read = number_to_read;
    m_number_to_read_isSet = true;
}

bool OAIVatQueryParameters::is_number_to_read_Set() const{
    return m_number_to_read_isSet;
}

bool OAIVatQueryParameters::is_number_to_read_Valid() const{
    return m_number_to_read_isValid;
}

qint32 OAIVatQueryParameters::getSkipRecords() const {
    return m_skip_records;
}
void OAIVatQueryParameters::setSkipRecords(const qint32 &skip_records) {
    m_skip_records = skip_records;
    m_skip_records_isSet = true;
}

bool OAIVatQueryParameters::is_skip_records_Set() const{
    return m_skip_records_isSet;
}

bool OAIVatQueryParameters::is_skip_records_Valid() const{
    return m_skip_records_isValid;
}

bool OAIVatQueryParameters::isSet() const {
...
bool OAIVatQueryParameters::isValid() const {
