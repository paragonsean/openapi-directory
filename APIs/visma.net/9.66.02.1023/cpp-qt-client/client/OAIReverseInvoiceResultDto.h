...
/*
 * OAIReverseInvoiceResultDto.h
 *
 * 
 */

#ifndef OAIReverseInvoiceResultDto_H
#define OAIReverseInvoiceResultDto_H
...
class OAIReverseInvoiceResultDto : public OAIObject {
public:
    OAIReverseInvoiceResultDto();
    OAIReverseInvoiceResultDto(QString json);
    ~OAIReverseInvoiceResultDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReverseInvoiceResultDto)

#endif // OAIReverseInvoiceResultDto_H
