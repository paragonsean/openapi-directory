...
/*
 * OAISupplierInvoiceQueryParameters.h
 *
 * 
 */

#ifndef OAISupplierInvoiceQueryParameters_H
#define OAISupplierInvoiceQueryParameters_H
...
class OAISupplierInvoiceQueryParameters : public OAIObject {
public:
    OAISupplierInvoiceQueryParameters();
    OAISupplierInvoiceQueryParameters(QString json);
    ~OAISupplierInvoiceQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupplierInvoiceQueryParameters)

#endif // OAISupplierInvoiceQueryParameters_H
