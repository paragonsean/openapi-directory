...
#include "OAIPackagingTypeQueryParameters.h"
...
OAIPackagingTypeQueryParameters::OAIPackagingTypeQueryParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackagingTypeQueryParameters::OAIPackagingTypeQueryParameters() {
    this->initializeModel();
}

OAIPackagingTypeQueryParameters::~OAIPackagingTypeQueryParameters() {}

void OAIPackagingTypeQueryParameters::initializeModel() {
...
void OAIPackagingTypeQueryParameters::fromJson(QString jsonString) {
...
void OAIPackagingTypeQueryParameters::fromJsonObject(QJsonObject json) {
...
QString OAIPackagingTypeQueryParameters::asJson() const {
...
QJsonObject OAIPackagingTypeQueryParameters::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPackagingTypeQueryParameters::getGreaterThanValue() const {
    return m_greater_than_value;
}
void OAIPackagingTypeQueryParameters::setGreaterThanValue(const QString &greater_than_value) {
    m_greater_than_value = greater_than_value;
    m_greater_than_value_isSet = true;
}

bool OAIPackagingTypeQueryParameters::is_greater_than_value_Set() const{
    return m_greater_than_value_isSet;
}

bool OAIPackagingTypeQueryParameters::is_greater_than_value_Valid() const{
    return m_greater_than_value_isValid;
}

QString OAIPackagingTypeQueryParameters::getLastModifiedDateTime() const {
    return m_last_modified_date_time;
}
void OAIPackagingTypeQueryParameters::setLastModifiedDateTime(const QString &last_modified_date_time) {
    m_last_modified_date_time = last_modified_date_time;
    m_last_modified_date_time_isSet = true;
}

bool OAIPackagingTypeQueryParameters::is_last_modified_date_time_Set() const{
    return m_last_modified_date_time_isSet;
}

bool OAIPackagingTypeQueryParameters::is_last_modified_date_time_Valid() const{
    return m_last_modified_date_time_isValid;
}

QString OAIPackagingTypeQueryParameters::getLastModifiedDateTimeCondition() const {
    return m_last_modified_date_time_condition;
}
void OAIPackagingTypeQueryParameters::setLastModifiedDateTimeCondition(const QString &last_modified_date_time_condition) {
    m_last_modified_date_time_condition = last_modified_date_time_condition;
    m_last_modified_date_time_condition_isSet = true;
}

bool OAIPackagingTypeQueryParameters::is_last_modified_date_time_condition_Set() const{
    return m_last_modified_date_time_condition_isSet;
}

bool OAIPackagingTypeQueryParameters::is_last_modified_date_time_condition_Valid() const{
    return m_last_modified_date_time_condition_isValid;
}

qint32 OAIPackagingTypeQueryParameters::getNumberToRead() const {
    return m_number_to_read;
}
void OAIPackagingTypeQueryParameters::setNumberToRead(const qint32 &number_to_read) {
    m_number_to_read = number_to_read;
    m_number_to_read_isSet = true;
}

bool OAIPackagingTypeQueryParameters::is_number_to_read_Set() const{
    return m_number_to_read_isSet;
}

bool OAIPackagingTypeQueryParameters::is_number_to_read_Valid() const{
    return m_number_to_read_isValid;
}

QString OAIPackagingTypeQueryParameters::getOrderBy() const {
    return m_order_by;
}
void OAIPackagingTypeQueryParameters::setOrderBy(const QString &order_by) {
    m_order_by = order_by;
    m_order_by_isSet = true;
}

bool OAIPackagingTypeQueryParameters::is_order_by_Set() const{
    return m_order_by_isSet;
}

bool OAIPackagingTypeQueryParameters::is_order_by_Valid() const{
    return m_order_by_isValid;
}

qint32 OAIPackagingTypeQueryParameters::getSkipRecords() const {
    return m_skip_records;
}
void OAIPackagingTypeQueryParameters::setSkipRecords(const qint32 &skip_records) {
    m_skip_records = skip_records;
    m_skip_records_isSet = true;
}

bool OAIPackagingTypeQueryParameters::is_skip_records_Set() const{
    return m_skip_records_isSet;
}

bool OAIPackagingTypeQueryParameters::is_skip_records_Valid() const{
    return m_skip_records_isValid;
}

bool OAIPackagingTypeQueryParameters::isSet() const {
...
bool OAIPackagingTypeQueryParameters::isValid() const {
