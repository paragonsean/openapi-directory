...
/*
 * OAIInvoiceAddressInCustomerDto.h
 *
 * Invoicing settings tab &amp;gt; Invoice address section &amp;gt;
 */

#ifndef OAIInvoiceAddressInCustomerDto_H
#define OAIInvoiceAddressInCustomerDto_H
...
class OAIInvoiceAddressInCustomerDto : public OAIObject {
public:
    OAIInvoiceAddressInCustomerDto();
    OAIInvoiceAddressInCustomerDto(QString json);
    ~OAIInvoiceAddressInCustomerDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceAddressInCustomerDto)

#endif // OAIInvoiceAddressInCustomerDto_H
