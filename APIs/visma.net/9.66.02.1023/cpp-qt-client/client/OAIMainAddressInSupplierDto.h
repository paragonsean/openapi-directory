...
/*
 * OAIMainAddressInSupplierDto.h
 *
 * General information tab &amp;gt; Main address section &amp;gt;
 */

#ifndef OAIMainAddressInSupplierDto_H
#define OAIMainAddressInSupplierDto_H
...
class OAIMainAddressInSupplierDto : public OAIObject {
public:
    OAIMainAddressInSupplierDto();
    OAIMainAddressInSupplierDto(QString json);
    ~OAIMainAddressInSupplierDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMainAddressInSupplierDto)

#endif // OAIMainAddressInSupplierDto_H
