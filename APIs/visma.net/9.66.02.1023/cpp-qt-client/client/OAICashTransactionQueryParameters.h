...
/*
 * OAICashTransactionQueryParameters.h
 *
 * 
 */

#ifndef OAICashTransactionQueryParameters_H
#define OAICashTransactionQueryParameters_H
...
class OAICashTransactionQueryParameters : public OAIObject {
public:
    OAICashTransactionQueryParameters();
    OAICashTransactionQueryParameters(QString json);
    ~OAICashTransactionQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICashTransactionQueryParameters)

#endif // OAICashTransactionQueryParameters_H
