...
/*
 * OAISendToAutoInvoiceArDocumentActionResultDto.h
 *
 * 
 */

#ifndef OAISendToAutoInvoiceArDocumentActionResultDto_H
#define OAISendToAutoInvoiceArDocumentActionResultDto_H
...
class OAISendToAutoInvoiceArDocumentActionResultDto : public OAIObject {
public:
    OAISendToAutoInvoiceArDocumentActionResultDto();
    OAISendToAutoInvoiceArDocumentActionResultDto(QString json);
    ~OAISendToAutoInvoiceArDocumentActionResultDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendToAutoInvoiceArDocumentActionResultDto)

#endif // OAISendToAutoInvoiceArDocumentActionResultDto_H
