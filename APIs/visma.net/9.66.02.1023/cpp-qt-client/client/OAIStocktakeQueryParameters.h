...
/*
 * OAIStocktakeQueryParameters.h
 *
 * 
 */

#ifndef OAIStocktakeQueryParameters_H
#define OAIStocktakeQueryParameters_H
...
class OAIStocktakeQueryParameters : public OAIObject {
public:
    OAIStocktakeQueryParameters();
    OAIStocktakeQueryParameters(QString json);
    ~OAIStocktakeQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStocktakeQueryParameters)

#endif // OAIStocktakeQueryParameters_H
