...
/*
 * OAIDeliveryAddressInExtendedOrganizationDto.h
 *
 * Delivery Address
 */

#ifndef OAIDeliveryAddressInExtendedOrganizationDto_H
#define OAIDeliveryAddressInExtendedOrganizationDto_H
...
class OAIDeliveryAddressInExtendedOrganizationDto : public OAIObject {
public:
    OAIDeliveryAddressInExtendedOrganizationDto();
    OAIDeliveryAddressInExtendedOrganizationDto(QString json);
    ~OAIDeliveryAddressInExtendedOrganizationDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeliveryAddressInExtendedOrganizationDto)

#endif // OAIDeliveryAddressInExtendedOrganizationDto_H
