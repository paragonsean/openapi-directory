...
/*
 * OAIBasePaginationDtoOfSalesPersonDto.h
 *
 * 
 */

#ifndef OAIBasePaginationDtoOfSalesPersonDto_H
#define OAIBasePaginationDtoOfSalesPersonDto_H
...
class OAIBasePaginationDtoOfSalesPersonDto : public OAIObject {
public:
    OAIBasePaginationDtoOfSalesPersonDto();
    OAIBasePaginationDtoOfSalesPersonDto(QString json);
    ~OAIBasePaginationDtoOfSalesPersonDto() override;
    ...
    QList<OAISalesPersonDto> getRecords() const;
    void setRecords(const QList<OAISalesPersonDto> &records);
...
private:
    ...
    QList<OAISalesPersonDto> m_records;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBasePaginationDtoOfSalesPersonDto)

#endif // OAIBasePaginationDtoOfSalesPersonDto_H
