...
/*
 * OAIAddressInContactDto.h
 *
 * The Details tab &amp;gt; Address section &amp;gt;
 */

#ifndef OAIAddressInContactDto_H
#define OAIAddressInContactDto_H
...
class OAIAddressInContactDto : public OAIObject {
public:
    OAIAddressInContactDto();
    OAIAddressInContactDto(QString json);
    ~OAIAddressInContactDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddressInContactDto)

#endif // OAIAddressInContactDto_H
