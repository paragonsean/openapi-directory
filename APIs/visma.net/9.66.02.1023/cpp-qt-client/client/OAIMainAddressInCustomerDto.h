...
/*
 * OAIMainAddressInCustomerDto.h
 *
 * General information tab &amp;gt; Main address section &amp;gt;
 */

#ifndef OAIMainAddressInCustomerDto_H
#define OAIMainAddressInCustomerDto_H
...
class OAIMainAddressInCustomerDto : public OAIObject {
public:
    OAIMainAddressInCustomerDto();
    OAIMainAddressInCustomerDto(QString json);
    ~OAIMainAddressInCustomerDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMainAddressInCustomerDto)

#endif // OAIMainAddressInCustomerDto_H
