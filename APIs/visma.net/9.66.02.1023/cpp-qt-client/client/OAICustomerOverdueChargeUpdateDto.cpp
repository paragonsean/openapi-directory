...
OAICustomerOverdueChargeUpdateDto::OAICustomerOverdueChargeUpdateDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomerOverdueChargeUpdateDto::OAICustomerOverdueChargeUpdateDto() {
    this->initializeModel();
}

OAICustomerOverdueChargeUpdateDto::~OAICustomerOverdueChargeUpdateDto() {}

void OAICustomerOverdueChargeUpdateDto::initializeModel() {
...
void OAICustomerOverdueChargeUpdateDto::fromJson(QString jsonString) {
...
void OAICustomerOverdueChargeUpdateDto::fromJsonObject(QJsonObject json) {
...
QString OAICustomerOverdueChargeUpdateDto::asJson() const {
...
QJsonObject OAICustomerOverdueChargeUpdateDto::asJsonObject() const {
    QJsonObject obj;
...
OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getBranchNumber() const {
    return m_branch_number;
}
void OAICustomerOverdueChargeUpdateDto::setBranchNumber(const OAIDtoValueOfString &branch_number) {
    m_branch_number = branch_number;
    m_branch_number_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_branch_number_Set() const{
    return m_branch_number_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_branch_number_Valid() const{
    return m_branch_number_isValid;
}

OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getCashAccount() const {
    return m_cash_account;
}
void OAICustomerOverdueChargeUpdateDto::setCashAccount(const OAIDtoValueOfString &cash_account) {
    m_cash_account = cash_account;
    m_cash_account_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_cash_account_Set() const{
    return m_cash_account_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_cash_account_Valid() const{
    return m_cash_account_isValid;
}

OAIDtoValueOfDateTime OAICustomerOverdueChargeUpdateDto::getCashDiscountDate() const {
    return m_cash_discount_date;
}
void OAICustomerOverdueChargeUpdateDto::setCashDiscountDate(const OAIDtoValueOfDateTime &cash_discount_date) {
    m_cash_discount_date = cash_discount_date;
    m_cash_discount_date_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_cash_discount_date_Set() const{
    return m_cash_discount_date_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_cash_discount_date_Valid() const{
    return m_cash_discount_date_isValid;
}

OAIDtoValueOfNullableOfInt32 OAICustomerOverdueChargeUpdateDto::getContact() const {
    return m_contact;
}
void OAICustomerOverdueChargeUpdateDto::setContact(const OAIDtoValueOfNullableOfInt32 &contact) {
    m_contact = contact;
    m_contact_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_contact_Set() const{
    return m_contact_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_contact_Valid() const{
    return m_contact_isValid;
}

OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getCreditTermsId() const {
    return m_credit_terms_id;
}
void OAICustomerOverdueChargeUpdateDto::setCreditTermsId(const OAIDtoValueOfString &credit_terms_id) {
    m_credit_terms_id = credit_terms_id;
    m_credit_terms_id_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_credit_terms_id_Set() const{
    return m_credit_terms_id_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_credit_terms_id_Valid() const{
    return m_credit_terms_id_isValid;
}

OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getCurrencyId() const {
    return m_currency_id;
}
void OAICustomerOverdueChargeUpdateDto::setCurrencyId(const OAIDtoValueOfString &currency_id) {
    m_currency_id = currency_id;
    m_currency_id_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_currency_id_Set() const{
    return m_currency_id_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_currency_id_Valid() const{
    return m_currency_id_isValid;
}

OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getCustomerNumber() const {
    return m_customer_number;
}
void OAICustomerOverdueChargeUpdateDto::setCustomerNumber(const OAIDtoValueOfString &customer_number) {
    m_customer_number = customer_number;
    m_customer_number_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_customer_number_Set() const{
    return m_customer_number_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_customer_number_Valid() const{
    return m_customer_number_isValid;
}

OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getCustomerRefNumber() const {
    return m_customer_ref_number;
}
void OAICustomerOverdueChargeUpdateDto::setCustomerRefNumber(const OAIDtoValueOfString &customer_ref_number) {
    m_customer_ref_number = customer_ref_number;
    m_customer_ref_number_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_customer_ref_number_Set() const{
    return m_customer_ref_number_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_customer_ref_number_Valid() const{
    return m_customer_ref_number_isValid;
}

OAIDtoValueOfDateTime OAICustomerOverdueChargeUpdateDto::getDocumentDate() const {
    return m_document_date;
}
void OAICustomerOverdueChargeUpdateDto::setDocumentDate(const OAIDtoValueOfDateTime &document_date) {
    m_document_date = document_date;
    m_document_date_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_document_date_Set() const{
    return m_document_date_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_document_date_Valid() const{
    return m_document_date_isValid;
}

OAIDtoValueOfDateTime OAICustomerOverdueChargeUpdateDto::getDocumentDueDate() const {
    return m_document_due_date;
}
void OAICustomerOverdueChargeUpdateDto::setDocumentDueDate(const OAIDtoValueOfDateTime &document_due_date) {
    m_document_due_date = document_due_date;
    m_document_due_date_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_document_due_date_Set() const{
    return m_document_due_date_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_document_due_date_Valid() const{
    return m_document_due_date_isValid;
}

OAIDtoValueOfNullableOfBoolean OAICustomerOverdueChargeUpdateDto::getDomesticServicesDeductibleDocument() const {
    return m_domestic_services_deductible_document;
}
void OAICustomerOverdueChargeUpdateDto::setDomesticServicesDeductibleDocument(const OAIDtoValueOfNullableOfBoolean &domestic_services_deductible_document) {
...
bool OAICustomerOverdueChargeUpdateDto::is_domestic_services_deductible_document_Set() const{
    return m_domestic_services_deductible_document_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_domestic_services_deductible_document_Valid() const{
    return m_domestic_services_deductible_document_isValid;
}

OAIDtoValueOfBoolean OAICustomerOverdueChargeUpdateDto::getDontEmail() const {
    return m_dont_email;
}
void OAICustomerOverdueChargeUpdateDto::setDontEmail(const OAIDtoValueOfBoolean &dont_email) {
    m_dont_email = dont_email;
    m_dont_email_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_dont_email_Set() const{
    return m_dont_email_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_dont_email_Valid() const{
    return m_dont_email_isValid;
}

OAIDtoValueOfBoolean OAICustomerOverdueChargeUpdateDto::getDontPrint() const {
    return m_dont_print;
}
void OAICustomerOverdueChargeUpdateDto::setDontPrint(const OAIDtoValueOfBoolean &dont_print) {
    m_dont_print = dont_print;
    m_dont_print_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_dont_print_Set() const{
    return m_dont_print_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_dont_print_Valid() const{
    return m_dont_print_isValid;
}

OAIDtoValueOfDecimal OAICustomerOverdueChargeUpdateDto::getExchangeRate() const {
    return m_exchange_rate;
}
void OAICustomerOverdueChargeUpdateDto::setExchangeRate(const OAIDtoValueOfDecimal &exchange_rate) {
    m_exchange_rate = exchange_rate;
    m_exchange_rate_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_exchange_rate_Set() const{
    return m_exchange_rate_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_exchange_rate_Valid() const{
    return m_exchange_rate_isValid;
}

OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getExternalReference() const {
    return m_external_reference;
}
void OAICustomerOverdueChargeUpdateDto::setExternalReference(const OAIDtoValueOfString &external_reference) {
    m_external_reference = external_reference;
    m_external_reference_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_external_reference_Set() const{
    return m_external_reference_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_external_reference_Valid() const{
    return m_external_reference_isValid;
}

OAIFinancialPeriodInCustomerOverdueChargeUpdateDto OAICustomerOverdueChargeUpdateDto::getFinancialPeriod() const {
    return m_financial_period;
}
void OAICustomerOverdueChargeUpdateDto::setFinancialPeriod(const OAIFinancialPeriodInCustomerOverdueChargeUpdateDto &financial_period) {
    m_financial_period = financial_period;
    m_financial_period_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_financial_period_Set() const{
    return m_financial_period_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_financial_period_Valid() const{
    return m_financial_period_isValid;
}

OAIDtoValueOfBoolean OAICustomerOverdueChargeUpdateDto::getHold() const {
    return m_hold;
}
void OAICustomerOverdueChargeUpdateDto::setHold(const OAIDtoValueOfBoolean &hold) {
    m_hold = hold;
    m_hold_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_hold_Set() const{
    return m_hold_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_hold_Valid() const{
    return m_hold_isValid;
}

OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getInvoiceText() const {
    return m_invoice_text;
}
void OAICustomerOverdueChargeUpdateDto::setInvoiceText(const OAIDtoValueOfString &invoice_text) {
    m_invoice_text = invoice_text;
    m_invoice_text_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_invoice_text_Set() const{
    return m_invoice_text_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_invoice_text_Valid() const{
    return m_invoice_text_isValid;
}

QList<OAICustomerOverdueChargeLineUpdateDto> OAICustomerOverdueChargeUpdateDto::getLines() const {
    return m_lines;
}
void OAICustomerOverdueChargeUpdateDto::setLines(const QList<OAICustomerOverdueChargeLineUpdateDto> &lines) {
    m_lines = lines;
    m_lines_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_lines_Set() const{
    return m_lines_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_lines_Valid() const{
    return m_lines_isValid;
}

OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getLocationId() const {
    return m_location_id;
}
void OAICustomerOverdueChargeUpdateDto::setLocationId(const OAIDtoValueOfString &location_id) {
    m_location_id = location_id;
    m_location_id_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_location_id_Set() const{
    return m_location_id_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_location_id_Valid() const{
    return m_location_id_isValid;
}

OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getNote() const {
    return m_note;
}
void OAICustomerOverdueChargeUpdateDto::setNote(const OAIDtoValueOfString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_note_Set() const{
    return m_note_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_note_Valid() const{
    return m_note_isValid;
}

OAIDtoValueOfDateTime OAICustomerOverdueChargeUpdateDto::getOrigInvoiceDate() const {
    return m_orig_invoice_date;
}
void OAICustomerOverdueChargeUpdateDto::setOrigInvoiceDate(const OAIDtoValueOfDateTime &orig_invoice_date) {
    m_orig_invoice_date = orig_invoice_date;
    m_orig_invoice_date_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_orig_invoice_date_Set() const{
    return m_orig_invoice_date_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_orig_invoice_date_Valid() const{
    return m_orig_invoice_date_isValid;
}

OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getPaymentMethodId() const {
    return m_payment_method_id;
}
void OAICustomerOverdueChargeUpdateDto::setPaymentMethodId(const OAIDtoValueOfString &payment_method_id) {
    m_payment_method_id = payment_method_id;
    m_payment_method_id_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_payment_method_id_Set() const{
    return m_payment_method_id_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_payment_method_id_Valid() const{
    return m_payment_method_id_isValid;
}

OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getPaymentReference() const {
    return m_payment_reference;
}
void OAICustomerOverdueChargeUpdateDto::setPaymentReference(const OAIDtoValueOfString &payment_reference) {
    m_payment_reference = payment_reference;
    m_payment_reference_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_payment_reference_Set() const{
    return m_payment_reference_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_payment_reference_Valid() const{
    return m_payment_reference_isValid;
}

OAIPostPeriodInCustomerOverdueChargeUpdateDto OAICustomerOverdueChargeUpdateDto::getPostPeriod() const {
    return m_post_period;
}
void OAICustomerOverdueChargeUpdateDto::setPostPeriod(const OAIPostPeriodInCustomerOverdueChargeUpdateDto &post_period) {
    m_post_period = post_period;
    m_post_period_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_post_period_Set() const{
    return m_post_period_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_post_period_Valid() const{
    return m_post_period_isValid;
}

OAIDtoValueOfString OAICustomerOverdueChargeUpdateDto::getReferenceNumber() const {
    return m_reference_number;
}
void OAICustomerOverdueChargeUpdateDto::setReferenceNumber(const OAIDtoValueOfString &reference_number) {
    m_reference_number = reference_number;
    m_reference_number_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_reference_number_Set() const{
    return m_reference_number_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_reference_number_Valid() const{
    return m_reference_number_isValid;
}

OAISalesPersonIDInCustomerOverdueChargeUpdateDto OAICustomerOverdueChargeUpdateDto::getSalesPersonId() const {
    return m_sales_person_id;
}
void OAICustomerOverdueChargeUpdateDto::setSalesPersonId(const OAISalesPersonIDInCustomerOverdueChargeUpdateDto &sales_person_id) {
    m_sales_person_id = sales_person_id;
    m_sales_person_id_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_sales_person_id_Set() const{
    return m_sales_person_id_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_sales_person_id_Valid() const{
    return m_sales_person_id_isValid;
}

OAISalespersonInCustomerOverdueChargeUpdateDto OAICustomerOverdueChargeUpdateDto::getSalesperson() const {
    return m_salesperson;
}
void OAICustomerOverdueChargeUpdateDto::setSalesperson(const OAISalespersonInCustomerOverdueChargeUpdateDto &salesperson) {
    m_salesperson = salesperson;
    m_salesperson_isSet = true;
}

bool OAICustomerOverdueChargeUpdateDto::is_salesperson_Set() const{
    return m_salesperson_isSet;
}

bool OAICustomerOverdueChargeUpdateDto::is_salesperson_Valid() const{
    return m_salesperson_isValid;
}

bool OAICustomerOverdueChargeUpdateDto::isSet() const {
...
bool OAICustomerOverdueChargeUpdateDto::isValid() const {
