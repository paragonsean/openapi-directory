...
/*
 * OAIRemitAddressInSupplierDto.h
 *
 * Payment settings tab &amp;gt; Remittance address section &amp;gt;
 */

#ifndef OAIRemitAddressInSupplierDto_H
#define OAIRemitAddressInSupplierDto_H
...
class OAIRemitAddressInSupplierDto : public OAIObject {
public:
    OAIRemitAddressInSupplierDto();
    OAIRemitAddressInSupplierDto(QString json);
    ~OAIRemitAddressInSupplierDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemitAddressInSupplierDto)

#endif // OAIRemitAddressInSupplierDto_H
