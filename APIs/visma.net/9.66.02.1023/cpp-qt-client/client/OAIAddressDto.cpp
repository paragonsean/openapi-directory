...
qint32 OAIAddressDto::getAddressId() const {
    return m_address_id;
}
void OAIAddressDto::setAddressId(const qint32 &address_id) {
    m_address_id = address_id;
    m_address_id_isSet = true;
}

bool OAIAddressDto::is_address_id_Set() const{
    return m_address_id_isSet;
}

bool OAIAddressDto::is_address_id_Valid() const{
...
OAICountryInAddressDto OAIAddressDto::getCountry() const {
    return m_country;
}
void OAIAddressDto::setCountry(const OAICountryInAddressDto &country) {
    m_country = country;
...
OAICountyInAddressDto OAIAddressDto::getCounty() const {
    return m_county;
}
void OAIAddressDto::setCounty(const OAICountyInAddressDto &county) {
    m_county = county;
    m_county_isSet = true;
}
