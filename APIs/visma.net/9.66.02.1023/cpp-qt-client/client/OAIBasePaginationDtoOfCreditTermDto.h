...
/*
 * OAIBasePaginationDtoOfCreditTermDto.h
 *
 * 
 */

#ifndef OAIBasePaginationDtoOfCreditTermDto_H
#define OAIBasePaginationDtoOfCreditTermDto_H
...
namespace OpenAPI {
class OAICreditTermDto;

class OAIBasePaginationDtoOfCreditTermDto : public OAIObject {
public:
    OAIBasePaginationDtoOfCreditTermDto();
    OAIBasePaginationDtoOfCreditTermDto(QString json);
    ~OAIBasePaginationDtoOfCreditTermDto() override;
    ...
    QList<OAICreditTermDto> getRecords() const;
    void setRecords(const QList<OAICreditTermDto> &records);
...
private:
    ...
    QList<OAICreditTermDto> m_records;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBasePaginationDtoOfCreditTermDto)

#endif // OAIBasePaginationDtoOfCreditTermDto_H
