...
/*
 * OAIBasePaginationDtoOfDiscountDto.h
 *
 * 
 */

#ifndef OAIBasePaginationDtoOfDiscountDto_H
#define OAIBasePaginationDtoOfDiscountDto_H
...
namespace OpenAPI {
class OAIDiscountDto;

class OAIBasePaginationDtoOfDiscountDto : public OAIObject {
public:
    OAIBasePaginationDtoOfDiscountDto();
    OAIBasePaginationDtoOfDiscountDto(QString json);
    ~OAIBasePaginationDtoOfDiscountDto() override;
    ...
    QList<OAIDiscountDto> getRecords() const;
    void setRecords(const QList<OAIDiscountDto> &records);
...
private:
    ...
    QList<OAIDiscountDto> m_records;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBasePaginationDtoOfDiscountDto)

#endif // OAIBasePaginationDtoOfDiscountDto_H
