...
/*
 * OAIWarehouseContactDto.h
 *
 * 
 */

#ifndef OAIWarehouseContactDto_H
#define OAIWarehouseContactDto_H
...
class OAIWarehouseContactDto : public OAIObject {
public:
    OAIWarehouseContactDto();
    OAIWarehouseContactDto(QString json);
    ~OAIWarehouseContactDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWarehouseContactDto)

#endif // OAIWarehouseContactDto_H
