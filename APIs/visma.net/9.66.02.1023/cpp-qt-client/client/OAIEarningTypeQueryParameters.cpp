...
#include "OAIEarningTypeQueryParameters.h"
...
OAIEarningTypeQueryParameters::OAIEarningTypeQueryParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEarningTypeQueryParameters::OAIEarningTypeQueryParameters() {
    this->initializeModel();
}

OAIEarningTypeQueryParameters::~OAIEarningTypeQueryParameters() {}

void OAIEarningTypeQueryParameters::initializeModel() {
...
void OAIEarningTypeQueryParameters::fromJson(QString jsonString) {
...
void OAIEarningTypeQueryParameters::fromJsonObject(QJsonObject json) {
...
QString OAIEarningTypeQueryParameters::asJson() const {
...
QJsonObject OAIEarningTypeQueryParameters::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEarningTypeQueryParameters::getGreaterThanValue() const {
    return m_greater_than_value;
}
void OAIEarningTypeQueryParameters::setGreaterThanValue(const QString &greater_than_value) {
    m_greater_than_value = greater_than_value;
    m_greater_than_value_isSet = true;
}

bool OAIEarningTypeQueryParameters::is_greater_than_value_Set() const{
    return m_greater_than_value_isSet;
}

bool OAIEarningTypeQueryParameters::is_greater_than_value_Valid() const{
    return m_greater_than_value_isValid;
}

QString OAIEarningTypeQueryParameters::getLastModifiedDateTime() const {
    return m_last_modified_date_time;
}
void OAIEarningTypeQueryParameters::setLastModifiedDateTime(const QString &last_modified_date_time) {
    m_last_modified_date_time = last_modified_date_time;
    m_last_modified_date_time_isSet = true;
}

bool OAIEarningTypeQueryParameters::is_last_modified_date_time_Set() const{
    return m_last_modified_date_time_isSet;
}

bool OAIEarningTypeQueryParameters::is_last_modified_date_time_Valid() const{
    return m_last_modified_date_time_isValid;
}

QString OAIEarningTypeQueryParameters::getLastModifiedDateTimeCondition() const {
    return m_last_modified_date_time_condition;
}
void OAIEarningTypeQueryParameters::setLastModifiedDateTimeCondition(const QString &last_modified_date_time_condition) {
    m_last_modified_date_time_condition = last_modified_date_time_condition;
    m_last_modified_date_time_condition_isSet = true;
}

bool OAIEarningTypeQueryParameters::is_last_modified_date_time_condition_Set() const{
    return m_last_modified_date_time_condition_isSet;
}

bool OAIEarningTypeQueryParameters::is_last_modified_date_time_condition_Valid() const{
    return m_last_modified_date_time_condition_isValid;
}

qint32 OAIEarningTypeQueryParameters::getNumberToRead() const {
    return m_number_to_read;
}
void OAIEarningTypeQueryParameters::setNumberToRead(const qint32 &number_to_read) {
    m_number_to_read = number_to_read;
    m_number_to_read_isSet = true;
}

bool OAIEarningTypeQueryParameters::is_number_to_read_Set() const{
    return m_number_to_read_isSet;
}

bool OAIEarningTypeQueryParameters::is_number_to_read_Valid() const{
    return m_number_to_read_isValid;
}

QString OAIEarningTypeQueryParameters::getOrderBy() const {
    return m_order_by;
}
void OAIEarningTypeQueryParameters::setOrderBy(const QString &order_by) {
    m_order_by = order_by;
    m_order_by_isSet = true;
}

bool OAIEarningTypeQueryParameters::is_order_by_Set() const{
    return m_order_by_isSet;
}

bool OAIEarningTypeQueryParameters::is_order_by_Valid() const{
    return m_order_by_isValid;
}

qint32 OAIEarningTypeQueryParameters::getSkipRecords() const {
    return m_skip_records;
}
void OAIEarningTypeQueryParameters::setSkipRecords(const qint32 &skip_records) {
    m_skip_records = skip_records;
    m_skip_records_isSet = true;
}

bool OAIEarningTypeQueryParameters::is_skip_records_Set() const{
    return m_skip_records_isSet;
}

bool OAIEarningTypeQueryParameters::is_skip_records_Valid() const{
    return m_skip_records_isValid;
}

bool OAIEarningTypeQueryParameters::isSet() const {
...
bool OAIEarningTypeQueryParameters::isValid() const {
