...
/*
 * OAICustomerContractSummaryDto.h
 *
 * This class represents the CustomerContractSummary in CustomerContractController. Used for getting data.
 */

#ifndef OAICustomerContractSummaryDto_H
#define OAICustomerContractSummaryDto_H
...
class OAICustomerContractSummaryDto : public OAIObject {
public:
    OAICustomerContractSummaryDto();
    OAICustomerContractSummaryDto(QString json);
    ~OAICustomerContractSummaryDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerContractSummaryDto)

#endif // OAICustomerContractSummaryDto_H
