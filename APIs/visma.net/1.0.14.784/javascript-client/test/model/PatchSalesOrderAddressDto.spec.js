...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VismaNetErpSalesOrdersApi.PatchSalesOrderAddressDto();
  });
  ...
  describe('PatchSalesOrderAddressDto', function() {
    it('should create an instance of PatchSalesOrderAddressDto', function() {
      // uncomment below and update the code to test PatchSalesOrderAddressDto
      //var instance = new VismaNetErpSalesOrdersApi.PatchSalesOrderAddressDto();
      //expect(instance).to.be.a(VismaNetErpSalesOrdersApi.PatchSalesOrderAddressDto);
    });
