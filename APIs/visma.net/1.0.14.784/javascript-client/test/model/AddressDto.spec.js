...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VismaNetErpSalesOrdersApi.AddressDto();
  });
  ...
  describe('AddressDto', function() {
    it('should create an instance of AddressDto', function() {
      ...
      //var instance = new VismaNetErpSalesOrdersApi.AddressDto();
      //expect(instance).to.be.a(VismaNetErpSalesOrdersApi.AddressDto);
    });
