# VismaNetErpSalesOrdersApi.CustomerLocationItemDto
...
**internalId** | **Number** | An internal id of the customer location | [optional] 
**leadTime** | **Number** | The number of days required for the shipped goods to reach the customer.  Used in the calculation of the scheduled shipment date | [optional] 
...
**priority** | **Number** | Default Priority | [optional] 
