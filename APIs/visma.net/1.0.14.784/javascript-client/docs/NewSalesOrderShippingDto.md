# VismaNetErpSalesOrdersApi.NewSalesOrderShippingDto
...
**intrastatTransactionTypeId** | **Number** | Sets the intrastat transaction type id for the sales order, if not supplied the default value from the ordertype will be used. Must be a valid intrastat transaction type id. | [optional] 
...
**priority** | **Number** | Sets priority of the order | [optional] 
...
**scheduledDate** | **Date** | Sets the date the shipment is scheduled for  Unless a specific time zone offset is specified with the date (e.g. &#39;2012-12-24T13:30:23+02:00&#39;), the passed date is considered to be in the UTC time zone. | [optional] 
