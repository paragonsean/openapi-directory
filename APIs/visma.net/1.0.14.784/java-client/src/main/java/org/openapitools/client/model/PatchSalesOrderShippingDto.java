...
public class PatchSalesOrderShippingDto {
  ...
  public PatchSalesOrderShippingDto() {
  }

  public PatchSalesOrderShippingDto address(PatchSalesOrderAddressDto address) {
  ...
  public PatchSalesOrderShippingDto contact(PatchSalesOrderContactDto contact) {
  ...
  public PatchSalesOrderShippingDto fobPointId(String fobPointId) {
  ...
  public PatchSalesOrderShippingDto insurance(Boolean insurance) {
  ...
  public PatchSalesOrderShippingDto intrastatTransactionTypeId(Integer intrastatTransactionTypeId) {
  ...
  public PatchSalesOrderShippingDto preferredWarehouseId(String preferredWarehouseId) {
  ...
  public PatchSalesOrderShippingDto priority(Integer priority) {
  ...
  public PatchSalesOrderShippingDto residentialDelivery(Boolean residentialDelivery) {
  ...
  public PatchSalesOrderShippingDto rule(String rule) {
    this.rule = rule;
    return this;
  }
  ...
  public PatchSalesOrderShippingDto saturdayDelivery(Boolean saturdayDelivery) {
  ...
  public PatchSalesOrderShippingDto scheduledDate(OffsetDateTime scheduledDate) {
  ...
  public PatchSalesOrderShippingDto shipSeparately(Boolean shipSeparately) {
  ...
  public PatchSalesOrderShippingDto shipViaId(String shipViaId) {
  ...
  public PatchSalesOrderShippingDto termsId(String termsId) {
  ...
  public PatchSalesOrderShippingDto zoneId(String zoneId) {
    this.zoneId = zoneId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PatchSalesOrderShippingDto patchSalesOrderShippingDto = (PatchSalesOrderShippingDto) o;
    return Objects.equals(this.address, patchSalesOrderShippingDto.address) &&
        Objects.equals(this.contact, patchSalesOrderShippingDto.contact) &&
        Objects.equals(this.fobPointId, patchSalesOrderShippingDto.fobPointId) &&
        Objects.equals(this.insurance, patchSalesOrderShippingDto.insurance) &&
        Objects.equals(this.intrastatTransactionTypeId, patchSalesOrderShippingDto.intrastatTransactionTypeId) &&
        Objects.equals(this.preferredWarehouseId, patchSalesOrderShippingDto.preferredWarehouseId) &&
        Objects.equals(this.priority, patchSalesOrderShippingDto.priority) &&
        Objects.equals(this.residentialDelivery, patchSalesOrderShippingDto.residentialDelivery) &&
        Objects.equals(this.rule, patchSalesOrderShippingDto.rule) &&
        Objects.equals(this.saturdayDelivery, patchSalesOrderShippingDto.saturdayDelivery) &&
        Objects.equals(this.scheduledDate, patchSalesOrderShippingDto.scheduledDate) &&
        Objects.equals(this.shipSeparately, patchSalesOrderShippingDto.shipSeparately) &&
        Objects.equals(this.shipViaId, patchSalesOrderShippingDto.shipViaId) &&
        Objects.equals(this.termsId, patchSalesOrderShippingDto.termsId) &&
        Objects.equals(this.zoneId, patchSalesOrderShippingDto.zoneId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchSalesOrderShippingDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchSalesOrderShippingDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchSalesOrderShippingDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchSalesOrderShippingDto is not found in the empty JSON string", PatchSalesOrderShippingDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchSalesOrderShippingDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchSalesOrderShippingDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchSalesOrderShippingDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchSalesOrderShippingDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchSalesOrderShippingDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchSalesOrderShippingDto.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchSalesOrderShippingDto>() {
           @Override
           public void write(JsonWriter out, PatchSalesOrderShippingDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchSalesOrderShippingDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchSalesOrderShippingDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchSalesOrderShippingDto
   * @throws IOException if the JSON string is invalid with respect to PatchSalesOrderShippingDto
   */
  public static PatchSalesOrderShippingDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchSalesOrderShippingDto.class);
  }

  /**
   * Convert an instance of PatchSalesOrderShippingDto to an JSON string
   *
   * @return JSON string
   */
