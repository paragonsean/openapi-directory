...
public class NewSalesOrderLineDto {
  ...
  public NewSalesOrderLineDto() {
  }

  public NewSalesOrderLineDto branchId(String branchId) {
  ...
  public NewSalesOrderLineDto commissionable(Boolean commissionable) {
  ...
  public NewSalesOrderLineDto description(String description) {
  ...
  public NewSalesOrderLineDto discountAmount(Double discountAmount) {
  ...
  public NewSalesOrderLineDto discountCode(String discountCode) {
  ...
  public NewSalesOrderLineDto discountPercent(Double discountPercent) {
  ...
  public NewSalesOrderLineDto externalLink(String externalLink) {
  ...
  public NewSalesOrderLineDto hasManualDiscount(Boolean hasManualDiscount) {
  ...
  public NewSalesOrderLineDto hasManualPrice(Boolean hasManualPrice) {
  ...
  public NewSalesOrderLineDto inventoryId(String inventoryId) {
  ...
  public NewSalesOrderLineDto note(String note) {
    this.note = note;
    return this;
  }
  ...
  public NewSalesOrderLineDto operation(String operation) {
  ...
  public NewSalesOrderLineDto overshipThreshold(Double overshipThreshold) {
  ...
  public NewSalesOrderLineDto projectTaskId(String projectTaskId) {
  ...
  public NewSalesOrderLineDto purchaseOrderSource(String purchaseOrderSource) {
  ...
  public NewSalesOrderLineDto quantity(Double quantity) {
  ...
  public NewSalesOrderLineDto reasonCode(String reasonCode) {
  ...
  public NewSalesOrderLineDto requestDate(OffsetDateTime requestDate) {
  ...
  public NewSalesOrderLineDto salesAccountId(String salesAccountId) {
  ...
  public NewSalesOrderLineDto salesPersonId(String salesPersonId) {
  ...
  public NewSalesOrderLineDto shipDate(OffsetDateTime shipDate) {
  ...
  public NewSalesOrderLineDto shippingRule(String shippingRule) {
  ...
  public NewSalesOrderLineDto subaccount(Map<String, String> subaccount) {
    this.subaccount = subaccount;
    return this;
  }

  public NewSalesOrderLineDto putSubaccountItem(String key, String subaccountItem) {
  ...
  public NewSalesOrderLineDto supplierId(String supplierId) {
  ...
  public NewSalesOrderLineDto supplierPrice(Double supplierPrice) {
  ...
  public NewSalesOrderLineDto taxCategoryId(String taxCategoryId) {
  ...
  public NewSalesOrderLineDto undershipThreshold(Double undershipThreshold) {
  ...
  public NewSalesOrderLineDto unitCost(Double unitCost) {
  ...
  public NewSalesOrderLineDto unitOfMeasure(String unitOfMeasure) {
  ...
  public NewSalesOrderLineDto unitPrice(Double unitPrice) {
  ...
  public NewSalesOrderLineDto warehouseId(String warehouseId) {
  ...
  public NewSalesOrderLineDto warehouseLocationId(String warehouseLocationId) {
  ...
  public boolean equals(Object o) {
    ...
    NewSalesOrderLineDto newSalesOrderLineDto = (NewSalesOrderLineDto) o;
    return Objects.equals(this.branchId, newSalesOrderLineDto.branchId) &&
        Objects.equals(this.commissionable, newSalesOrderLineDto.commissionable) &&
        Objects.equals(this.description, newSalesOrderLineDto.description) &&
        Objects.equals(this.discountAmount, newSalesOrderLineDto.discountAmount) &&
        Objects.equals(this.discountCode, newSalesOrderLineDto.discountCode) &&
        Objects.equals(this.discountPercent, newSalesOrderLineDto.discountPercent) &&
        Objects.equals(this.externalLink, newSalesOrderLineDto.externalLink) &&
        Objects.equals(this.hasManualDiscount, newSalesOrderLineDto.hasManualDiscount) &&
        Objects.equals(this.hasManualPrice, newSalesOrderLineDto.hasManualPrice) &&
        Objects.equals(this.inventoryId, newSalesOrderLineDto.inventoryId) &&
        Objects.equals(this.note, newSalesOrderLineDto.note) &&
        Objects.equals(this.operation, newSalesOrderLineDto.operation) &&
        Objects.equals(this.overshipThreshold, newSalesOrderLineDto.overshipThreshold) &&
        Objects.equals(this.projectTaskId, newSalesOrderLineDto.projectTaskId) &&
        Objects.equals(this.purchaseOrderSource, newSalesOrderLineDto.purchaseOrderSource) &&
        Objects.equals(this.quantity, newSalesOrderLineDto.quantity) &&
        Objects.equals(this.reasonCode, newSalesOrderLineDto.reasonCode) &&
        Objects.equals(this.requestDate, newSalesOrderLineDto.requestDate) &&
        Objects.equals(this.salesAccountId, newSalesOrderLineDto.salesAccountId) &&
        Objects.equals(this.salesPersonId, newSalesOrderLineDto.salesPersonId) &&
        Objects.equals(this.shipDate, newSalesOrderLineDto.shipDate) &&
        Objects.equals(this.shippingRule, newSalesOrderLineDto.shippingRule) &&
        Objects.equals(this.subaccount, newSalesOrderLineDto.subaccount) &&
        Objects.equals(this.supplierId, newSalesOrderLineDto.supplierId) &&
        Objects.equals(this.supplierPrice, newSalesOrderLineDto.supplierPrice) &&
        Objects.equals(this.taxCategoryId, newSalesOrderLineDto.taxCategoryId) &&
        Objects.equals(this.undershipThreshold, newSalesOrderLineDto.undershipThreshold) &&
        Objects.equals(this.unitCost, newSalesOrderLineDto.unitCost) &&
        Objects.equals(this.unitOfMeasure, newSalesOrderLineDto.unitOfMeasure) &&
        Objects.equals(this.unitPrice, newSalesOrderLineDto.unitPrice) &&
        Objects.equals(this.warehouseId, newSalesOrderLineDto.warehouseId) &&
        Objects.equals(this.warehouseLocationId, newSalesOrderLineDto.warehouseLocationId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(branchId, commissionable, description, discountAmount, discountCode, discountPercent, externalLink, hasManualDiscount, hasManualPrice, inventoryId, note, operation, overshipThreshold, projectTaskId, purchaseOrderSource, quantity, reasonCode, requestDate, salesAccountId, salesPersonId, shipDate, shippingRule, subaccount, supplierId, supplierPrice, taxCategoryId, undershipThreshold, unitCost, unitOfMeasure, unitPrice, warehouseId, warehouseLocationId);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewSalesOrderLineDto {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("inventoryId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewSalesOrderLineDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewSalesOrderLineDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewSalesOrderLineDto is not found in the empty JSON string", NewSalesOrderLineDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewSalesOrderLineDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewSalesOrderLineDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewSalesOrderLineDto.openapiRequiredFields) {
      ...
      if (!jsonObj.get("inventoryId").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewSalesOrderLineDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewSalesOrderLineDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewSalesOrderLineDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewSalesOrderLineDto.class));

       return (TypeAdapter<T>) new TypeAdapter<NewSalesOrderLineDto>() {
           @Override
           public void write(JsonWriter out, NewSalesOrderLineDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewSalesOrderLineDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewSalesOrderLineDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewSalesOrderLineDto
   * @throws IOException if the JSON string is invalid with respect to NewSalesOrderLineDto
   */
  public static NewSalesOrderLineDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewSalesOrderLineDto.class);
  }

  /**
   * Convert an instance of NewSalesOrderLineDto to an JSON string
   *
   * @return JSON string
   */
