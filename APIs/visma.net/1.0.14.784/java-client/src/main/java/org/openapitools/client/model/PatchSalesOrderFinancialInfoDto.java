...
public class PatchSalesOrderFinancialInfoDto {
  ...
  public PatchSalesOrderFinancialInfoDto() {
  }

  public PatchSalesOrderFinancialInfoDto cashDiscountDate(OffsetDateTime cashDiscountDate) {
  ...
  public PatchSalesOrderFinancialInfoDto dueDate(OffsetDateTime dueDate) {
  ...
  public PatchSalesOrderFinancialInfoDto invoiceDate(OffsetDateTime invoiceDate) {
  ...
  public PatchSalesOrderFinancialInfoDto invoiceId(String invoiceId) {
  ...
  public PatchSalesOrderFinancialInfoDto invoiceSeparately(Boolean invoiceSeparately) {
  ...
  public PatchSalesOrderFinancialInfoDto postPeriod(String postPeriod) {
  ...
  public boolean equals(Object o) {
    ...
    PatchSalesOrderFinancialInfoDto patchSalesOrderFinancialInfoDto = (PatchSalesOrderFinancialInfoDto) o;
    return Objects.equals(this.cashDiscountDate, patchSalesOrderFinancialInfoDto.cashDiscountDate) &&
        Objects.equals(this.dueDate, patchSalesOrderFinancialInfoDto.dueDate) &&
        Objects.equals(this.invoiceDate, patchSalesOrderFinancialInfoDto.invoiceDate) &&
        Objects.equals(this.invoiceId, patchSalesOrderFinancialInfoDto.invoiceId) &&
        Objects.equals(this.invoiceSeparately, patchSalesOrderFinancialInfoDto.invoiceSeparately) &&
        Objects.equals(this.postPeriod, patchSalesOrderFinancialInfoDto.postPeriod);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchSalesOrderFinancialInfoDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchSalesOrderFinancialInfoDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchSalesOrderFinancialInfoDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchSalesOrderFinancialInfoDto is not found in the empty JSON string", PatchSalesOrderFinancialInfoDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchSalesOrderFinancialInfoDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchSalesOrderFinancialInfoDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchSalesOrderFinancialInfoDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchSalesOrderFinancialInfoDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchSalesOrderFinancialInfoDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchSalesOrderFinancialInfoDto.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchSalesOrderFinancialInfoDto>() {
           @Override
           public void write(JsonWriter out, PatchSalesOrderFinancialInfoDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchSalesOrderFinancialInfoDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchSalesOrderFinancialInfoDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchSalesOrderFinancialInfoDto
   * @throws IOException if the JSON string is invalid with respect to PatchSalesOrderFinancialInfoDto
   */
  public static PatchSalesOrderFinancialInfoDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchSalesOrderFinancialInfoDto.class);
  }

  /**
   * Convert an instance of PatchSalesOrderFinancialInfoDto to an JSON string
   *
   * @return JSON string
   */
