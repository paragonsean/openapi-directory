...
|**internalLocationId** | **Integer** | The internal id used by the sytem for this location |  [optional] |
|**lastModified** | **OffsetDateTime** | Date and time this entry for this location was modified  Unless a specific time zone offset is included (e.g. &#39;2012-12-24T12:15:14+02:00&#39;), the date is considered to be in the UTC time zone. |  [optional] |
...
|**quantityOnHand** | **Double** | Physical quantity on-hand of items in the specific location |  [optional] |
|**quantityPurchaseOrders** | **Double** | The quantity of the inventory item included in open purchase orders.  Note: For quantities on warehouse location level, only quantities added specifically for the location are taken into consideration |  [optional] |
