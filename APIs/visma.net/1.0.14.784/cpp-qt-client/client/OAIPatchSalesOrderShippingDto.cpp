...
OAIPatchSalesOrderShippingDto::OAIPatchSalesOrderShippingDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPatchSalesOrderShippingDto::OAIPatchSalesOrderShippingDto() {
    this->initializeModel();
}

OAIPatchSalesOrderShippingDto::~OAIPatchSalesOrderShippingDto() {}

void OAIPatchSalesOrderShippingDto::initializeModel() {
...
void OAIPatchSalesOrderShippingDto::fromJson(QString jsonString) {
...
void OAIPatchSalesOrderShippingDto::fromJsonObject(QJsonObject json) {
...
QString OAIPatchSalesOrderShippingDto::asJson() const {
...
QJsonObject OAIPatchSalesOrderShippingDto::asJsonObject() const {
    QJsonObject obj;
    if (m_address.isSet()) {
...
OAIPatchSalesOrderAddressDto OAIPatchSalesOrderShippingDto::getAddress() const {
    return m_address;
}
void OAIPatchSalesOrderShippingDto::setAddress(const OAIPatchSalesOrderAddressDto &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_address_Set() const{
    return m_address_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_address_Valid() const{
    return m_address_isValid;
}

OAIPatchSalesOrderContactDto OAIPatchSalesOrderShippingDto::getContact() const {
    return m_contact;
}
void OAIPatchSalesOrderShippingDto::setContact(const OAIPatchSalesOrderContactDto &contact) {
    m_contact = contact;
    m_contact_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_contact_Set() const{
    return m_contact_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_contact_Valid() const{
    return m_contact_isValid;
}

QString OAIPatchSalesOrderShippingDto::getFobPointId() const {
    return m_fob_point_id;
}
void OAIPatchSalesOrderShippingDto::setFobPointId(const QString &fob_point_id) {
    m_fob_point_id = fob_point_id;
    m_fob_point_id_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_fob_point_id_Set() const{
    return m_fob_point_id_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_fob_point_id_Valid() const{
    return m_fob_point_id_isValid;
}

bool OAIPatchSalesOrderShippingDto::isInsurance() const {
    return m_insurance;
}
void OAIPatchSalesOrderShippingDto::setInsurance(const bool &insurance) {
    m_insurance = insurance;
    m_insurance_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_insurance_Set() const{
    return m_insurance_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_insurance_Valid() const{
    return m_insurance_isValid;
}

qint32 OAIPatchSalesOrderShippingDto::getIntrastatTransactionTypeId() const {
    return m_intrastat_transaction_type_id;
}
void OAIPatchSalesOrderShippingDto::setIntrastatTransactionTypeId(const qint32 &intrastat_transaction_type_id) {
    m_intrastat_transaction_type_id = intrastat_transaction_type_id;
    m_intrastat_transaction_type_id_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_intrastat_transaction_type_id_Set() const{
    return m_intrastat_transaction_type_id_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_intrastat_transaction_type_id_Valid() const{
    return m_intrastat_transaction_type_id_isValid;
}

QString OAIPatchSalesOrderShippingDto::getPreferredWarehouseId() const {
    return m_preferred_warehouse_id;
}
void OAIPatchSalesOrderShippingDto::setPreferredWarehouseId(const QString &preferred_warehouse_id) {
    m_preferred_warehouse_id = preferred_warehouse_id;
    m_preferred_warehouse_id_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_preferred_warehouse_id_Set() const{
    return m_preferred_warehouse_id_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_preferred_warehouse_id_Valid() const{
    return m_preferred_warehouse_id_isValid;
}

qint32 OAIPatchSalesOrderShippingDto::getPriority() const {
    return m_priority;
}
void OAIPatchSalesOrderShippingDto::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_priority_Valid() const{
    return m_priority_isValid;
}

bool OAIPatchSalesOrderShippingDto::isResidentialDelivery() const {
    return m_residential_delivery;
}
void OAIPatchSalesOrderShippingDto::setResidentialDelivery(const bool &residential_delivery) {
    m_residential_delivery = residential_delivery;
    m_residential_delivery_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_residential_delivery_Set() const{
    return m_residential_delivery_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_residential_delivery_Valid() const{
    return m_residential_delivery_isValid;
}

QString OAIPatchSalesOrderShippingDto::getRule() const {
    return m_rule;
}
void OAIPatchSalesOrderShippingDto::setRule(const QString &rule) {
    m_rule = rule;
    m_rule_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_rule_Set() const{
    return m_rule_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_rule_Valid() const{
    return m_rule_isValid;
}

bool OAIPatchSalesOrderShippingDto::isSaturdayDelivery() const {
    return m_saturday_delivery;
}
void OAIPatchSalesOrderShippingDto::setSaturdayDelivery(const bool &saturday_delivery) {
    m_saturday_delivery = saturday_delivery;
    m_saturday_delivery_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_saturday_delivery_Set() const{
    return m_saturday_delivery_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_saturday_delivery_Valid() const{
    return m_saturday_delivery_isValid;
}

QDateTime OAIPatchSalesOrderShippingDto::getScheduledDate() const {
    return m_scheduled_date;
}
void OAIPatchSalesOrderShippingDto::setScheduledDate(const QDateTime &scheduled_date) {
    m_scheduled_date = scheduled_date;
    m_scheduled_date_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_scheduled_date_Set() const{
    return m_scheduled_date_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_scheduled_date_Valid() const{
    return m_scheduled_date_isValid;
}

bool OAIPatchSalesOrderShippingDto::isShipSeparately() const {
    return m_ship_separately;
}
void OAIPatchSalesOrderShippingDto::setShipSeparately(const bool &ship_separately) {
    m_ship_separately = ship_separately;
    m_ship_separately_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_ship_separately_Set() const{
    return m_ship_separately_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_ship_separately_Valid() const{
    return m_ship_separately_isValid;
}

QString OAIPatchSalesOrderShippingDto::getShipViaId() const {
    return m_ship_via_id;
}
void OAIPatchSalesOrderShippingDto::setShipViaId(const QString &ship_via_id) {
    m_ship_via_id = ship_via_id;
    m_ship_via_id_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_ship_via_id_Set() const{
    return m_ship_via_id_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_ship_via_id_Valid() const{
    return m_ship_via_id_isValid;
}

QString OAIPatchSalesOrderShippingDto::getTermsId() const {
    return m_terms_id;
}
void OAIPatchSalesOrderShippingDto::setTermsId(const QString &terms_id) {
    m_terms_id = terms_id;
    m_terms_id_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_terms_id_Set() const{
    return m_terms_id_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_terms_id_Valid() const{
    return m_terms_id_isValid;
}

QString OAIPatchSalesOrderShippingDto::getZoneId() const {
    return m_zone_id;
}
void OAIPatchSalesOrderShippingDto::setZoneId(const QString &zone_id) {
    m_zone_id = zone_id;
    m_zone_id_isSet = true;
}

bool OAIPatchSalesOrderShippingDto::is_zone_id_Set() const{
    return m_zone_id_isSet;
}

bool OAIPatchSalesOrderShippingDto::is_zone_id_Valid() const{
    return m_zone_id_isValid;
}

bool OAIPatchSalesOrderShippingDto::isSet() const {
...
bool OAIPatchSalesOrderShippingDto::isValid() const {
