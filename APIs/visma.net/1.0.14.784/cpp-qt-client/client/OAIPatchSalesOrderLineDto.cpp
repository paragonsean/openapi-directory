...
OAIPatchSalesOrderLineDto::OAIPatchSalesOrderLineDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPatchSalesOrderLineDto::OAIPatchSalesOrderLineDto() {
    this->initializeModel();
}

OAIPatchSalesOrderLineDto::~OAIPatchSalesOrderLineDto() {}

void OAIPatchSalesOrderLineDto::initializeModel() {
...
void OAIPatchSalesOrderLineDto::fromJson(QString jsonString) {
...
void OAIPatchSalesOrderLineDto::fromJsonObject(QJsonObject json) {
...
QString OAIPatchSalesOrderLineDto::asJson() const {
...
QJsonObject OAIPatchSalesOrderLineDto::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPatchSalesOrderLineDto::getBranchId() const {
    return m_branch_id;
}
void OAIPatchSalesOrderLineDto::setBranchId(const QString &branch_id) {
    m_branch_id = branch_id;
    m_branch_id_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_branch_id_Set() const{
    return m_branch_id_isSet;
}

bool OAIPatchSalesOrderLineDto::is_branch_id_Valid() const{
    return m_branch_id_isValid;
}

bool OAIPatchSalesOrderLineDto::isCommissionable() const {
    return m_commissionable;
}
void OAIPatchSalesOrderLineDto::setCommissionable(const bool &commissionable) {
    m_commissionable = commissionable;
    m_commissionable_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_commissionable_Set() const{
    return m_commissionable_isSet;
}

bool OAIPatchSalesOrderLineDto::is_commissionable_Valid() const{
    return m_commissionable_isValid;
}

QString OAIPatchSalesOrderLineDto::getDescription() const {
    return m_description;
}
void OAIPatchSalesOrderLineDto::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPatchSalesOrderLineDto::is_description_Valid() const{
    return m_description_isValid;
}

double OAIPatchSalesOrderLineDto::getDiscountAmount() const {
    return m_discount_amount;
}
void OAIPatchSalesOrderLineDto::setDiscountAmount(const double &discount_amount) {
    m_discount_amount = discount_amount;
    m_discount_amount_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_discount_amount_Set() const{
    return m_discount_amount_isSet;
}

bool OAIPatchSalesOrderLineDto::is_discount_amount_Valid() const{
    return m_discount_amount_isValid;
}

QString OAIPatchSalesOrderLineDto::getDiscountCode() const {
    return m_discount_code;
}
void OAIPatchSalesOrderLineDto::setDiscountCode(const QString &discount_code) {
    m_discount_code = discount_code;
    m_discount_code_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_discount_code_Set() const{
    return m_discount_code_isSet;
}

bool OAIPatchSalesOrderLineDto::is_discount_code_Valid() const{
    return m_discount_code_isValid;
}

double OAIPatchSalesOrderLineDto::getDiscountPercent() const {
    return m_discount_percent;
}
void OAIPatchSalesOrderLineDto::setDiscountPercent(const double &discount_percent) {
    m_discount_percent = discount_percent;
    m_discount_percent_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_discount_percent_Set() const{
    return m_discount_percent_isSet;
}

bool OAIPatchSalesOrderLineDto::is_discount_percent_Valid() const{
    return m_discount_percent_isValid;
}

QString OAIPatchSalesOrderLineDto::getExternalLink() const {
    return m_external_link;
}
void OAIPatchSalesOrderLineDto::setExternalLink(const QString &external_link) {
    m_external_link = external_link;
    m_external_link_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_external_link_Set() const{
    return m_external_link_isSet;
}

bool OAIPatchSalesOrderLineDto::is_external_link_Valid() const{
    return m_external_link_isValid;
}

bool OAIPatchSalesOrderLineDto::isHasManualDiscount() const {
    return m_has_manual_discount;
}
void OAIPatchSalesOrderLineDto::setHasManualDiscount(const bool &has_manual_discount) {
    m_has_manual_discount = has_manual_discount;
    m_has_manual_discount_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_has_manual_discount_Set() const{
    return m_has_manual_discount_isSet;
}

bool OAIPatchSalesOrderLineDto::is_has_manual_discount_Valid() const{
    return m_has_manual_discount_isValid;
}

bool OAIPatchSalesOrderLineDto::isHasManualPrice() const {
    return m_has_manual_price;
}
void OAIPatchSalesOrderLineDto::setHasManualPrice(const bool &has_manual_price) {
    m_has_manual_price = has_manual_price;
    m_has_manual_price_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_has_manual_price_Set() const{
    return m_has_manual_price_isSet;
}

bool OAIPatchSalesOrderLineDto::is_has_manual_price_Valid() const{
    return m_has_manual_price_isValid;
}

qint32 OAIPatchSalesOrderLineDto::getLineId() const {
    return m_line_id;
}
void OAIPatchSalesOrderLineDto::setLineId(const qint32 &line_id) {
    m_line_id = line_id;
    m_line_id_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_line_id_Set() const{
    return m_line_id_isSet;
}

bool OAIPatchSalesOrderLineDto::is_line_id_Valid() const{
    return m_line_id_isValid;
}

QString OAIPatchSalesOrderLineDto::getNote() const {
    return m_note;
}
void OAIPatchSalesOrderLineDto::setNote(const QString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_note_Set() const{
    return m_note_isSet;
}

bool OAIPatchSalesOrderLineDto::is_note_Valid() const{
    return m_note_isValid;
}

QString OAIPatchSalesOrderLineDto::getOperation() const {
    return m_operation;
}
void OAIPatchSalesOrderLineDto::setOperation(const QString &operation) {
    m_operation = operation;
    m_operation_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_operation_Set() const{
    return m_operation_isSet;
}

bool OAIPatchSalesOrderLineDto::is_operation_Valid() const{
    return m_operation_isValid;
}

double OAIPatchSalesOrderLineDto::getOvershipThreshold() const {
    return m_overship_threshold;
}
void OAIPatchSalesOrderLineDto::setOvershipThreshold(const double &overship_threshold) {
    m_overship_threshold = overship_threshold;
    m_overship_threshold_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_overship_threshold_Set() const{
    return m_overship_threshold_isSet;
}

bool OAIPatchSalesOrderLineDto::is_overship_threshold_Valid() const{
    return m_overship_threshold_isValid;
}

QString OAIPatchSalesOrderLineDto::getProjectTaskId() const {
    return m_project_task_id;
}
void OAIPatchSalesOrderLineDto::setProjectTaskId(const QString &project_task_id) {
    m_project_task_id = project_task_id;
    m_project_task_id_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_project_task_id_Set() const{
    return m_project_task_id_isSet;
}

bool OAIPatchSalesOrderLineDto::is_project_task_id_Valid() const{
    return m_project_task_id_isValid;
}

QString OAIPatchSalesOrderLineDto::getPurchaseOrderSource() const {
    return m_purchase_order_source;
}
void OAIPatchSalesOrderLineDto::setPurchaseOrderSource(const QString &purchase_order_source) {
    m_purchase_order_source = purchase_order_source;
    m_purchase_order_source_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_purchase_order_source_Set() const{
    return m_purchase_order_source_isSet;
}

bool OAIPatchSalesOrderLineDto::is_purchase_order_source_Valid() const{
    return m_purchase_order_source_isValid;
}

double OAIPatchSalesOrderLineDto::getQuantity() const {
    return m_quantity;
}
void OAIPatchSalesOrderLineDto::setQuantity(const double &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIPatchSalesOrderLineDto::is_quantity_Valid() const{
    return m_quantity_isValid;
}

QString OAIPatchSalesOrderLineDto::getReasonCode() const {
    return m_reason_code;
}
void OAIPatchSalesOrderLineDto::setReasonCode(const QString &reason_code) {
    m_reason_code = reason_code;
    m_reason_code_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_reason_code_Set() const{
    return m_reason_code_isSet;
}

bool OAIPatchSalesOrderLineDto::is_reason_code_Valid() const{
    return m_reason_code_isValid;
}

QDateTime OAIPatchSalesOrderLineDto::getRequestDate() const {
    return m_request_date;
}
void OAIPatchSalesOrderLineDto::setRequestDate(const QDateTime &request_date) {
    m_request_date = request_date;
    m_request_date_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_request_date_Set() const{
    return m_request_date_isSet;
}

bool OAIPatchSalesOrderLineDto::is_request_date_Valid() const{
    return m_request_date_isValid;
}

QString OAIPatchSalesOrderLineDto::getSalesAccountId() const {
    return m_sales_account_id;
}
void OAIPatchSalesOrderLineDto::setSalesAccountId(const QString &sales_account_id) {
    m_sales_account_id = sales_account_id;
    m_sales_account_id_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_sales_account_id_Set() const{
    return m_sales_account_id_isSet;
}

bool OAIPatchSalesOrderLineDto::is_sales_account_id_Valid() const{
    return m_sales_account_id_isValid;
}

QString OAIPatchSalesOrderLineDto::getSalesPersonId() const {
    return m_sales_person_id;
}
void OAIPatchSalesOrderLineDto::setSalesPersonId(const QString &sales_person_id) {
    m_sales_person_id = sales_person_id;
    m_sales_person_id_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_sales_person_id_Set() const{
    return m_sales_person_id_isSet;
}

bool OAIPatchSalesOrderLineDto::is_sales_person_id_Valid() const{
    return m_sales_person_id_isValid;
}

QDateTime OAIPatchSalesOrderLineDto::getShipDate() const {
    return m_ship_date;
}
void OAIPatchSalesOrderLineDto::setShipDate(const QDateTime &ship_date) {
    m_ship_date = ship_date;
    m_ship_date_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_ship_date_Set() const{
    return m_ship_date_isSet;
}

bool OAIPatchSalesOrderLineDto::is_ship_date_Valid() const{
    return m_ship_date_isValid;
}

QString OAIPatchSalesOrderLineDto::getShippingRule() const {
    return m_shipping_rule;
}
void OAIPatchSalesOrderLineDto::setShippingRule(const QString &shipping_rule) {
    m_shipping_rule = shipping_rule;
    m_shipping_rule_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_shipping_rule_Set() const{
    return m_shipping_rule_isSet;
}

bool OAIPatchSalesOrderLineDto::is_shipping_rule_Valid() const{
    return m_shipping_rule_isValid;
}

qint32 OAIPatchSalesOrderLineDto::getSortOrder() const {
    return m_sort_order;
}
void OAIPatchSalesOrderLineDto::setSortOrder(const qint32 &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIPatchSalesOrderLineDto::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

QMap<QString, QString> OAIPatchSalesOrderLineDto::getSubaccount() const {
    return m_subaccount;
}
void OAIPatchSalesOrderLineDto::setSubaccount(const QMap<QString, QString> &subaccount) {
    m_subaccount = subaccount;
    m_subaccount_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_subaccount_Set() const{
    return m_subaccount_isSet;
}

bool OAIPatchSalesOrderLineDto::is_subaccount_Valid() const{
    return m_subaccount_isValid;
}

QString OAIPatchSalesOrderLineDto::getSupplierId() const {
    return m_supplier_id;
}
void OAIPatchSalesOrderLineDto::setSupplierId(const QString &supplier_id) {
    m_supplier_id = supplier_id;
    m_supplier_id_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_supplier_id_Set() const{
    return m_supplier_id_isSet;
}

bool OAIPatchSalesOrderLineDto::is_supplier_id_Valid() const{
    return m_supplier_id_isValid;
}

double OAIPatchSalesOrderLineDto::getSupplierPrice() const {
    return m_supplier_price;
}
void OAIPatchSalesOrderLineDto::setSupplierPrice(const double &supplier_price) {
    m_supplier_price = supplier_price;
    m_supplier_price_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_supplier_price_Set() const{
    return m_supplier_price_isSet;
}

bool OAIPatchSalesOrderLineDto::is_supplier_price_Valid() const{
    return m_supplier_price_isValid;
}

QString OAIPatchSalesOrderLineDto::getTaxCategoryId() const {
    return m_tax_category_id;
}
void OAIPatchSalesOrderLineDto::setTaxCategoryId(const QString &tax_category_id) {
    m_tax_category_id = tax_category_id;
    m_tax_category_id_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_tax_category_id_Set() const{
    return m_tax_category_id_isSet;
}

bool OAIPatchSalesOrderLineDto::is_tax_category_id_Valid() const{
    return m_tax_category_id_isValid;
}

double OAIPatchSalesOrderLineDto::getUndershipThreshold() const {
    return m_undership_threshold;
}
void OAIPatchSalesOrderLineDto::setUndershipThreshold(const double &undership_threshold) {
    m_undership_threshold = undership_threshold;
    m_undership_threshold_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_undership_threshold_Set() const{
    return m_undership_threshold_isSet;
}

bool OAIPatchSalesOrderLineDto::is_undership_threshold_Valid() const{
    return m_undership_threshold_isValid;
}

double OAIPatchSalesOrderLineDto::getUnitCost() const {
    return m_unit_cost;
}
void OAIPatchSalesOrderLineDto::setUnitCost(const double &unit_cost) {
    m_unit_cost = unit_cost;
    m_unit_cost_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_unit_cost_Set() const{
    return m_unit_cost_isSet;
}

bool OAIPatchSalesOrderLineDto::is_unit_cost_Valid() const{
    return m_unit_cost_isValid;
}

QString OAIPatchSalesOrderLineDto::getUnitOfMeasure() const {
    return m_unit_of_measure;
}
void OAIPatchSalesOrderLineDto::setUnitOfMeasure(const QString &unit_of_measure) {
    m_unit_of_measure = unit_of_measure;
    m_unit_of_measure_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_unit_of_measure_Set() const{
    return m_unit_of_measure_isSet;
}

bool OAIPatchSalesOrderLineDto::is_unit_of_measure_Valid() const{
    return m_unit_of_measure_isValid;
}

double OAIPatchSalesOrderLineDto::getUnitPrice() const {
    return m_unit_price;
}
void OAIPatchSalesOrderLineDto::setUnitPrice(const double &unit_price) {
    m_unit_price = unit_price;
    m_unit_price_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_unit_price_Set() const{
    return m_unit_price_isSet;
}

bool OAIPatchSalesOrderLineDto::is_unit_price_Valid() const{
    return m_unit_price_isValid;
}

QString OAIPatchSalesOrderLineDto::getWarehouseId() const {
    return m_warehouse_id;
}
void OAIPatchSalesOrderLineDto::setWarehouseId(const QString &warehouse_id) {
    m_warehouse_id = warehouse_id;
    m_warehouse_id_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_warehouse_id_Set() const{
    return m_warehouse_id_isSet;
}

bool OAIPatchSalesOrderLineDto::is_warehouse_id_Valid() const{
    return m_warehouse_id_isValid;
}

QString OAIPatchSalesOrderLineDto::getWarehouseLocationId() const {
    return m_warehouse_location_id;
}
void OAIPatchSalesOrderLineDto::setWarehouseLocationId(const QString &warehouse_location_id) {
    m_warehouse_location_id = warehouse_location_id;
    m_warehouse_location_id_isSet = true;
}

bool OAIPatchSalesOrderLineDto::is_warehouse_location_id_Set() const{
    return m_warehouse_location_id_isSet;
}

bool OAIPatchSalesOrderLineDto::is_warehouse_location_id_Valid() const{
    return m_warehouse_location_id_isValid;
}

bool OAIPatchSalesOrderLineDto::isSet() const {
...
bool OAIPatchSalesOrderLineDto::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_line_id_isValid && true;
}
