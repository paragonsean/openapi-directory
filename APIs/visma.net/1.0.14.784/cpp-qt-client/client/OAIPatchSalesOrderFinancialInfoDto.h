...
/*
 * OAIPatchSalesOrderFinancialInfoDto.h
 *
 * 
 */

#ifndef OAIPatchSalesOrderFinancialInfoDto_H
#define OAIPatchSalesOrderFinancialInfoDto_H
...
class OAIPatchSalesOrderFinancialInfoDto : public OAIObject {
public:
    OAIPatchSalesOrderFinancialInfoDto();
    OAIPatchSalesOrderFinancialInfoDto(QString json);
    ~OAIPatchSalesOrderFinancialInfoDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatchSalesOrderFinancialInfoDto)

#endif // OAIPatchSalesOrderFinancialInfoDto_H
