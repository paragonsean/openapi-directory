...
/*
 * OAINewSalesOrderLineDto.h
 *
 * 
 */

#ifndef OAINewSalesOrderLineDto_H
#define OAINewSalesOrderLineDto_H
...
class OAINewSalesOrderLineDto : public OAIObject {
public:
    OAINewSalesOrderLineDto();
    OAINewSalesOrderLineDto(QString json);
    ~OAINewSalesOrderLineDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewSalesOrderLineDto)

#endif // OAINewSalesOrderLineDto_H
