...
/*
 * OAINewSalesOrderCustomerDto.h
 *
 * 
 */

#ifndef OAINewSalesOrderCustomerDto_H
#define OAINewSalesOrderCustomerDto_H
...
class OAINewSalesOrderCustomerDto : public OAIObject {
public:
    OAINewSalesOrderCustomerDto();
    OAINewSalesOrderCustomerDto(QString json);
    ~OAINewSalesOrderCustomerDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewSalesOrderCustomerDto)

#endif // OAINewSalesOrderCustomerDto_H
