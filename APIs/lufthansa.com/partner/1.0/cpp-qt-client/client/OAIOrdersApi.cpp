...
void OAIOrdersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("orders", defaultConf);
    _serverIndices.insert("orders", 0);
}
...
void OAIOrdersApi::orders(const QString &order_id, const QString &accept, const QString &name) {
    QString fullPath = QString(_serverConfigs["orders"][_serverIndices.value("orders")].URL()+"/orders/orders/{orderID}/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::ordersCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::ordersCallback);
...
void OAIOrdersApi::ordersCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ordersSignal(output);
        Q_EMIT ordersSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT ordersSignalE(output, error_type, error_str);
        Q_EMIT ordersSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT ordersSignalError(output, error_type, error_str);
        Q_EMIT ordersSignalErrorFull(worker, error_type, error_str);
    }
}
