...
#include <iostream>
#include "../client/OAIDispatchGreenEnergyDistributionAPIApi.h"
...
void Example::exampleFunction1(){
     OAIDispatchGreenEnergyDistributionAPIApi apiInstance;
     
      QEventLoop loop;
      connect(&apiInstance, &OAIDispatchGreenEnergyDistributionAPIApi::gsiDispatchSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDispatchGreenEnergyDistributionAPIApi::gsiDispatchSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString zip = create(); // QString | Zipcode (Postleitzahl) of a city in Germany.
      ...
      QString key = create(); // QString | Any valid Stromkonto account (address).
      apiInstance.gsiDispatch_0(zipkey);
