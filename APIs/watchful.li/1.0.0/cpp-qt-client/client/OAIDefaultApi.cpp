...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("packagesPost", defaultConf);
    _serverIndices.insert("packagesPost", 0);
}
...
void OAIDefaultApi::packagesPost() {
    QString fullPath = QString(_serverConfigs["packagesPost"][_serverIndices.value("packagesPost")].URL()+"/packages");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::packagesPostCallback);
...
void OAIDefaultApi::packagesPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT packagesPostSignal();
        Q_EMIT packagesPostSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT packagesPostSignalE(error_type, error_str);
        Q_EMIT packagesPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT packagesPostSignalError(error_type, error_str);
        Q_EMIT packagesPostSignalErrorFull(worker, error_type, error_str);
    }
}
