...
public class V3BulkDeparturesStopResponse {
  ...
  public V3BulkDeparturesStopResponse() {
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.stopId, v3BulkDeparturesStopResponse.stopId) &&
        ...
        Objects.equals(this.stopName, v3BulkDeparturesStopResponse.stopName) &&
        Objects.equals(this.stopSuburb, v3BulkDeparturesStopResponse.stopSuburb);
  }

  @Override
  public int hashCode() {
    return Objects.hash(stopId, stopLandmark, stopLatitude, stopLongitude, stopName, stopSuburb);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V3BulkDeparturesStopResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V3BulkDeparturesStopResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V3BulkDeparturesStopResponse is not found in the empty JSON string", V3BulkDeparturesStopResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V3BulkDeparturesStopResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V3BulkDeparturesStopResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V3BulkDeparturesStopResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V3BulkDeparturesStopResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V3BulkDeparturesStopResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V3BulkDeparturesStopResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<V3BulkDeparturesStopResponse>() {
           @Override
           public void write(JsonWriter out, V3BulkDeparturesStopResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V3BulkDeparturesStopResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V3BulkDeparturesStopResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V3BulkDeparturesStopResponse
   * @throws IOException if the JSON string is invalid with respect to V3BulkDeparturesStopResponse
   */
  public static V3BulkDeparturesStopResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V3BulkDeparturesStopResponse.class);
  }

  /**
   * Convert an instance of V3BulkDeparturesStopResponse to an JSON string
   *
   * @return JSON string
   */
