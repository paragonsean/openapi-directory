...
public class V3StopStaffing {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(friAmFrom, friAmTo, friPmFrom, friPmTo, monAmFrom, monAmTo, monPmFrom, monPmTo, phAdditionalText, phFrom, phTo, satAmFrom, satAmTo, satPmFrom, satPmTo, sunAmFrom, sunAmTo, sunPmFrom, sunPmTo, thuAmFrom, thuAmTo, thuPmFrom, thuPmTo, tueAmFrom, tueAmTo, tuePmFrom, tuePmTo, wedAmFrom, wedAmTo, wedPmTo, wedPmFrom);
  }
