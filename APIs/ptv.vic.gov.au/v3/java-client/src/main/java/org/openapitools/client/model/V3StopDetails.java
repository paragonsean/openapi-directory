...
public class V3StopDetails {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(disruptionIds, routeType, routes, stationDescription, stationType, stopAccessibility, stopAmenities, stopId, stopLandmark, stopLocation, stopName, stopStaffing);
  }
