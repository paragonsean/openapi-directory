...
public class V3StopGeosearch {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(disruptionIds, routeType, routes, stopDistance, stopId, stopLandmark, stopLatitude, stopLongitude, stopName, stopSequence, stopSuburb);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V3StopGeosearch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V3StopGeosearch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V3StopGeosearch is not found in the empty JSON string", V3StopGeosearch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V3StopGeosearch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V3StopGeosearch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V3StopGeosearch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V3StopGeosearch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V3StopGeosearch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V3StopGeosearch.class));

       return (TypeAdapter<T>) new TypeAdapter<V3StopGeosearch>() {
           @Override
           public void write(JsonWriter out, V3StopGeosearch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V3StopGeosearch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V3StopGeosearch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V3StopGeosearch
   * @throws IOException if the JSON string is invalid with respect to V3StopGeosearch
   */
  public static V3StopGeosearch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V3StopGeosearch.class);
  }

  /**
   * Convert an instance of V3StopGeosearch to an JSON string
   *
   * @return JSON string
   */
