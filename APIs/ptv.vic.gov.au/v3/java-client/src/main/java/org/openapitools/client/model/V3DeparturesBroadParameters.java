...
public class V3DeparturesBroadParameters {
  ...
  public static final String SERIALIZED_NAME_PLATFORM_NUMBERS = "platform_numbers";
  @SerializedName(SERIALIZED_NAME_PLATFORM_NUMBERS)
  private List<Integer> platformNumbers = new ArrayList<>();

  public V3DeparturesBroadParameters() {
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dateUtc, v3DeparturesBroadParameters.dateUtc) &&
        ...
        Objects.equals(this.platformNumbers, v3DeparturesBroadParameters.platformNumbers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dateUtc, directionId, expand, gtfs, includeCancelled, includeGeopath, lookBackwards, maxResults, platformNumbers);
  }
  ...
  static {
    ...
    openapiFields.add("platform_numbers");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V3DeparturesBroadParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V3DeparturesBroadParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V3DeparturesBroadParameters is not found in the empty JSON string", V3DeparturesBroadParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V3DeparturesBroadParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V3DeparturesBroadParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("platform_numbers") != null && !jsonObj.get("platform_numbers").isJsonNull() && !jsonObj.get("platform_numbers").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `platform_numbers` to be an array in the JSON string but got `%s`", jsonObj.get("platform_numbers").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V3DeparturesBroadParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V3DeparturesBroadParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V3DeparturesBroadParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V3DeparturesBroadParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<V3DeparturesBroadParameters>() {
           @Override
           public void write(JsonWriter out, V3DeparturesBroadParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V3DeparturesBroadParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V3DeparturesBroadParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V3DeparturesBroadParameters
   * @throws IOException if the JSON string is invalid with respect to V3DeparturesBroadParameters
   */
  public static V3DeparturesBroadParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V3DeparturesBroadParameters.class);
  }

  /**
   * Convert an instance of V3DeparturesBroadParameters to an JSON string
   *
   * @return JSON string
   */
