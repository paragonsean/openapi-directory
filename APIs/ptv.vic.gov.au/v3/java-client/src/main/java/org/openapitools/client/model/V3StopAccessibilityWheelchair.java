...
public class V3StopAccessibilityWheelchair {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessibleRamp, lowTicketCounter, manouvering, parking, raisedPlatform, raisedPlatformShelther, ramp, secondaryPath, steepRamp, telephone, toilet);
  }
