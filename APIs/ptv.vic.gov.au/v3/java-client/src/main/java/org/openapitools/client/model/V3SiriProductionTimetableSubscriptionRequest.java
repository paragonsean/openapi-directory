...
public class V3SiriProductionTimetableSubscriptionRequest {
  ...
  public V3SiriProductionTimetableSubscriptionRequest() {
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.consumerAddress, v3SiriProductionTimetableSubscriptionRequest.consumerAddress) &&
        ...
        Objects.equals(this.startTime, v3SiriProductionTimetableSubscriptionRequest.startTime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(consumerAddress, endTime, initialTerminationTime, siriFormat, siriVersion, startTime, subscriberRef, subscriptionRef, topics);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V3SiriProductionTimetableSubscriptionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V3SiriProductionTimetableSubscriptionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V3SiriProductionTimetableSubscriptionRequest is not found in the empty JSON string", V3SiriProductionTimetableSubscriptionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V3SiriProductionTimetableSubscriptionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V3SiriProductionTimetableSubscriptionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V3SiriProductionTimetableSubscriptionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V3SiriProductionTimetableSubscriptionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V3SiriProductionTimetableSubscriptionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V3SiriProductionTimetableSubscriptionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V3SiriProductionTimetableSubscriptionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<V3SiriProductionTimetableSubscriptionRequest>() {
           @Override
           public void write(JsonWriter out, V3SiriProductionTimetableSubscriptionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V3SiriProductionTimetableSubscriptionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V3SiriProductionTimetableSubscriptionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V3SiriProductionTimetableSubscriptionRequest
   * @throws IOException if the JSON string is invalid with respect to V3SiriProductionTimetableSubscriptionRequest
   */
  public static V3SiriProductionTimetableSubscriptionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V3SiriProductionTimetableSubscriptionRequest.class);
  }

  /**
   * Convert an instance of V3SiriProductionTimetableSubscriptionRequest to an JSON string
   *
   * @return JSON string
   */
