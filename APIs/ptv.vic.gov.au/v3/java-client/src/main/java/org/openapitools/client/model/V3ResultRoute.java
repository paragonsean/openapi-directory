...
public class V3ResultRoute {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.routeGtfsId, v3ResultRoute.routeGtfsId) &&
        Objects.equals(this.routeId, v3ResultRoute.routeId) &&
        Objects.equals(this.routeName, v3ResultRoute.routeName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(routeGtfsId, routeId, routeName, routeNumber, routeServiceStatus, routeType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V3ResultRoute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V3ResultRoute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V3ResultRoute is not found in the empty JSON string", V3ResultRoute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V3ResultRoute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V3ResultRoute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V3ResultRoute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V3ResultRoute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V3ResultRoute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V3ResultRoute.class));

       return (TypeAdapter<T>) new TypeAdapter<V3ResultRoute>() {
           @Override
           public void write(JsonWriter out, V3ResultRoute value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V3ResultRoute read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V3ResultRoute given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V3ResultRoute
   * @throws IOException if the JSON string is invalid with respect to V3ResultRoute
   */
  public static V3ResultRoute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V3ResultRoute.class);
  }

  /**
   * Convert an instance of V3ResultRoute to an JSON string
   *
   * @return JSON string
   */
