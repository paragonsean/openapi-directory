...
public class V3OutletGeolocation {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.outletBusiness, v3OutletGeolocation.outletBusiness) &&
        ...
        Objects.equals(this.outletDistance, v3OutletGeolocation.outletDistance) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(outletBusiness, outletBusinessHourFri, outletBusinessHourMon, outletBusinessHourSat, outletBusinessHourSun, outletBusinessHourThur, outletBusinessHourTue, outletBusinessHourWed, outletDistance, outletLatitude, outletLongitude, outletName, outletNotes, outletPostcode, outletSlidSpid, outletSuburb);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V3OutletGeolocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V3OutletGeolocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V3OutletGeolocation is not found in the empty JSON string", V3OutletGeolocation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V3OutletGeolocation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V3OutletGeolocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V3OutletGeolocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V3OutletGeolocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V3OutletGeolocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V3OutletGeolocation.class));

       return (TypeAdapter<T>) new TypeAdapter<V3OutletGeolocation>() {
           @Override
           public void write(JsonWriter out, V3OutletGeolocation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V3OutletGeolocation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V3OutletGeolocation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V3OutletGeolocation
   * @throws IOException if the JSON string is invalid with respect to V3OutletGeolocation
   */
  public static V3OutletGeolocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V3OutletGeolocation.class);
  }

  /**
   * Convert an instance of V3OutletGeolocation to an JSON string
   *
   * @return JSON string
   */
