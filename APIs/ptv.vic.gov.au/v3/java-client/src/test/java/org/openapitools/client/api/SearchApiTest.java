...
public class SearchApiTest {
    ...
    public void searchSearchTest() throws ApiException {
        ...
        V3SearchResult response = api.searchSearch(searchTerm, routeTypes, latitude, longitude, maxDistance, includeAddresses, includeOutlets, matchStopBySuburb, matchRouteBySuburb, matchStopByGtfsStopId, token, devid, signature);
