...
/**
 * API tests for RouteTypesApi
 */
@Disabled
public class RouteTypesApiTest {

    private final RouteTypesApi api = new RouteTypesApi();
     ...
     */
    @Test
    public void routeTypesGetRouteTypesTest() throws ApiException {
        String token = null;
        String devid = null;
        String signature = null;
        V3RouteTypesResponse response = api.routeTypesGetRouteTypes(token, devid, signature);
