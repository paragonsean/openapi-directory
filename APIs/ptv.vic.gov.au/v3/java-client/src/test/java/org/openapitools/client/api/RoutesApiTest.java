...
public class RoutesApiTest {
     ...
     */
    @Test
    public void routesOneOrMoreRoutesTest() throws ApiException {
        List<Integer> routeTypes = null;
        String routeName = null;
        String token = null;
        String devid = null;
        String signature = null;
        V3RouteResponse response = api.routesOneOrMoreRoutes(routeTypes, routeName, token, devid, signature);
     ...
     */
    @Test
    public void routesRouteFromIdTest() throws ApiException {
        ...
        String devid = null;
        String signature = null;
        V3RouteResponse response = api.routesRouteFromId(routeId, includeGeopath, geopathUtc, token, devid, signature);
        // TODO: test validations
    }
