...
/**
 * API tests for FareEstimateApi
 */
@Disabled
public class FareEstimateApiTest {

    private final FareEstimateApi api = new FareEstimateApi();
     ...
     */
    @Test
    public void fareEstimateGetFareEstimateByZoneTest() throws ApiException {
        ...
        Object response = api.fareEstimateGetFareEstimateByZone(minZone, maxZone, journeyTouchOnUtc, journeyTouchOffUtc, isJourneyInFreeTramZone, travelledRouteTypes, token, devid, signature);
