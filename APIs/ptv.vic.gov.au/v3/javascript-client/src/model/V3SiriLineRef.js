...
class V3SiriLineRef {
    ...
    constructor(lineRef) { 
        ...
        V3SiriLineRef.initialize(this, lineRef);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>V3SiriLineRef</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V3SiriLineRef</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of V3SiriLineRef.RequiredProperties) {
...
V3SiriLineRef.RequiredProperties = ["line_ref"];

/**
 * Siri DirectionRef  (in, out, up, down, clockwise, counterclockwise, Inbound, Outbound)
 * @member {module:model/V3SiriLineRef.DirectionRefEnum} direction_ref
 */
V3SiriLineRef.prototype['direction_ref'] = undefined;

/**
 * Siri LineRef
 * @member {String} line_ref
 */
V3SiriLineRef.prototype['line_ref'] = undefined;
