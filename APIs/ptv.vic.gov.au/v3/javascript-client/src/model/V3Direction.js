...
/**
 * The V3Direction model module.
 * @module model/V3Direction
 * @version v3
 */
class V3Direction {
    /**
     * Constructs a new <code>V3Direction</code>.
     * @alias module:model/V3Direction
     */
    constructor() { 
        
        V3Direction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V3Direction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V3Direction} obj Optional instance to populate.
     * @return {module:model/V3Direction} The populated <code>V3Direction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V3Direction();
    ...
    /**
     * Validates the JSON data with respect to <code>V3Direction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V3Direction</code>.
     */
 ...
 */
V3Direction.prototype['direction_id'] = undefined;

/**
 * Name of direction of travel
 * @member {String} direction_name
 */
V3Direction.prototype['direction_name'] = undefined;

/**
 * Route identifier
 * @member {Number} route_id
 */
V3Direction.prototype['route_id'] = undefined;

/**
 * Transport mode identifier
 * @member {Number} route_type
 */
V3Direction.prototype['route_type'] = undefined;
