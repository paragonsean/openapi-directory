...
* @version v3
*/
export default class DisruptionsApi {
    ...
    */
     ...
     * @callback module:api/DisruptionsApi~disruptionsGetAllDisruptionsCallback
     ...
     * @param {Array.<module:model/Number>} [disruptionModes] Filter by disruption_mode; values returned via v3/disruptions/modes API
     * @param {module:model/String} [disruptionStatus] Filter by status of disruption
     ...
     * data is of type: {@link module:model/V3DisruptionsResponse}
     */
    disruptionsGetAllDisruptions(opts, callback) {
      ...
      let queryParams = {
        ...
        'disruption_modes': this.apiClient.buildCollectionParam(opts['disruptionModes'], 'multi'),
        'disruption_status': opts['disruptionStatus'],
        'token': opts['token'],
        'devid': opts['devid'],
     ...
     * @callback module:api/DisruptionsApi~disruptionsGetDisruptionByIdCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link module:model/V3DisruptionResponse}
     */
     ...
     * @callback module:api/DisruptionsApi~disruptionsGetDisruptionModesCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link module:model/V3DisruptionModesResponse}
     */
     ...
     * @callback module:api/DisruptionsApi~disruptionsGetDisruptionsByRouteCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V3DisruptionsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @callback module:api/DisruptionsApi~disruptionsGetDisruptionsByRouteAndStopCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V3DisruptionsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @callback module:api/DisruptionsApi~disruptionsGetDisruptionsByStopCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V3DisruptionsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
