...
export default class DeparturesApi {
    ...
    */
     ...
     * @callback module:api/DeparturesApi~departuresGetForStopCallback
     ...
     * @param {Array.<module:model/String>} [expand] List of objects to be returned in full (i.e. expanded) - options include: All, Stop, Route, Run, Direction, Disruption, VehiclePosition, VehicleDescriptor or None.              Run must be expanded to receive VehiclePosition and VehicleDescriptor information.
     ...
     * data is of type: {@link module:model/V3DeparturesResponse}
     */
    departuresGetForStop(routeType, stopId, opts, callback) {
      ...
      let queryParams = {
        'platform_numbers': this.apiClient.buildCollectionParam(opts['platformNumbers'], 'multi'),
        'direction_id': opts['directionId'],
        'gtfs': opts['gtfs'],
        'date_utc': opts['dateUtc'],
        'max_results': opts['maxResults'],
        'include_cancelled': opts['includeCancelled'],
        'look_backwards': opts['lookBackwards'],
     ...
     * @callback module:api/DeparturesApi~departuresGetForStopAndRouteCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V3DeparturesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
