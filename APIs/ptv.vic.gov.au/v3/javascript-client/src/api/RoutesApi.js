...
export default class RoutesApi {
    ...
    */
     ...
     * @callback module:api/RoutesApi~routesOneOrMoreRoutesCallback
     ...
     * data is of type: {@link module:model/V3RouteResponse}
     */
     ...
     * @callback module:api/RoutesApi~routesRouteFromIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V3RouteResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
