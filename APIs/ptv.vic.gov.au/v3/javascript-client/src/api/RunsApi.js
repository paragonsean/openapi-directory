...
export default class RunsApi {
    ...
    */
     ...
     * @callback module:api/RunsApi~runsForRouteCallback
     ...
     * data is of type: {@link module:model/V3RunsResponse}
     */
     ...
     * @callback module:api/RunsApi~runsForRouteAndRouteTypeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V3RunsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @callback module:api/RunsApi~runsForRunCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V3RunsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @callback module:api/RunsApi~runsForRunAndRouteTypeCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link module:model/V3RunResponse}
     */
