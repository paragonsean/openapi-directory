# ptv_timetable_api_version_3

PtvTimetableApiVersion3 - JavaScript client for ptv_timetable_api_version_3
...
```shell
npm install ptv_timetable_api_version_3 --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your ptv_timetable_api_version_3 from, and run:
...
```javascript
var PtvTimetableApiVersion3 = require('ptv_timetable_api_version_3');
...
var opts = {
  'platformNumbers': [null], // {[Number]} Filter by platform number at stop
  ...
  'expand': ["null"], // {[String]} List of objects to be returned in full (i.e. expanded) - options include: All, Stop, Route, Run, Direction, Disruption, VehiclePosition, VehicleDescriptor or None.              Run must be expanded to receive VehiclePosition and VehicleDescriptor information.
