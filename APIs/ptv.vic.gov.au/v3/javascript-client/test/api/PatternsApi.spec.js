...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.PatternsApi();
  });
  ...
  describe('PatternsApi', function() {
    describe('patternsGetPatternByRun', function() {
      it('should call patternsGetPatternByRun successfully', function(done) {
        //uncomment below and update the code to test patternsGetPatternByRun
        //instance.patternsGetPatternByRun(function(error) {
