...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.FareEstimateApi();
  });
  ...
  describe('FareEstimateApi', function() {
    describe('fareEstimateGetFareEstimateByZone', function() {
      it('should call fareEstimateGetFareEstimateByZone successfully', function(done) {
        //uncomment below and update the code to test fareEstimateGetFareEstimateByZone
        //instance.fareEstimateGetFareEstimateByZone(function(error) {
