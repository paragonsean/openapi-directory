...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3StopGps();
  });
  ...
  describe('V3StopGps', function() {
    it('should create an instance of V3StopGps', function() {
      // uncomment below and update the code to test V3StopGps
      //var instance = new PtvTimetableApiVersion3.V3StopGps();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3StopGps);
    });
