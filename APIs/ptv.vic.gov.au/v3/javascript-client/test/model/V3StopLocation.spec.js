...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3StopLocation();
  });
  ...
  describe('V3StopLocation', function() {
    it('should create an instance of V3StopLocation', function() {
      // uncomment below and update the code to test V3StopLocation
      //var instance = new PtvTimetableApiVersion3.V3StopLocation();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3StopLocation);
    });
