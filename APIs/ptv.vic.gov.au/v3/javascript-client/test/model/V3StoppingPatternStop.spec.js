...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3StoppingPatternStop();
  });
  ...
  describe('V3StoppingPatternStop', function() {
    it('should create an instance of V3StoppingPatternStop', function() {
      // uncomment below and update the code to test V3StoppingPatternStop
      //var instance = new PtvTimetableApiVersion3.V3StoppingPatternStop();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3StoppingPatternStop);
    });
    ...
    it('should have the property stopTicket (base name: "stop_ticket")', function() {
      // uncomment below and update the code to test the property stopTicket
      //var instance = new PtvTimetableApiVersion3.V3StoppingPatternStop();
      //expect(instance).to.be();
    });
