...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3VehicleDescriptor();
  });
  ...
  describe('V3VehicleDescriptor', function() {
    it('should create an instance of V3VehicleDescriptor', function() {
      // uncomment below and update the code to test V3VehicleDescriptor
      //var instance = new PtvTimetableApiVersion3.V3VehicleDescriptor();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3VehicleDescriptor);
    });

    it('should have the property airConditioned (base name: "air_conditioned")', function() {
      // uncomment below and update the code to test the property airConditioned
      //var instance = new PtvTimetableApiVersion3.V3VehicleDescriptor();
    ...
    it('should have the property lowFloor (base name: "low_floor")', function() {
      // uncomment below and update the code to test the property lowFloor
      //var instance = new PtvTimetableApiVersion3.V3VehicleDescriptor();
      //expect(instance).to.be();
    });
