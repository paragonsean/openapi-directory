...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3DisruptionRoute();
  });
  ...
  describe('V3DisruptionRoute', function() {
    it('should create an instance of V3DisruptionRoute', function() {
      // uncomment below and update the code to test V3DisruptionRoute
      //var instance = new PtvTimetableApiVersion3.V3DisruptionRoute();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3DisruptionRoute);
    });
