...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3ResultStop();
  });
  ...
  describe('V3ResultStop', function() {
    it('should create an instance of V3ResultStop', function() {
      // uncomment below and update the code to test V3ResultStop
      //var instance = new PtvTimetableApiVersion3.V3ResultStop();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3ResultStop);
    });
    ...
    it('should have the property stopDistance (base name: "stop_distance")', function() {
      // uncomment below and update the code to test the property stopDistance
      //var instance = new PtvTimetableApiVersion3.V3ResultStop();
      //expect(instance).to.be();
    });
    ...
    it('should have the property stopLandmark (base name: "stop_landmark")', function() {
      // uncomment below and update the code to test the property stopLandmark
      //var instance = new PtvTimetableApiVersion3.V3ResultStop();
      //expect(instance).to.be();
    });

    it('should have the property stopLatitude (base name: "stop_latitude")', function() {
      // uncomment below and update the code to test the property stopLatitude
      //var instance = new PtvTimetableApiVersion3.V3ResultStop();
      //expect(instance).to.be();
    });

    it('should have the property stopLongitude (base name: "stop_longitude")', function() {
      // uncomment below and update the code to test the property stopLongitude
      //var instance = new PtvTimetableApiVersion3.V3ResultStop();
      //expect(instance).to.be();
    });
    ...
    it('should have the property stopSequence (base name: "stop_sequence")', function() {
      // uncomment below and update the code to test the property stopSequence
      //var instance = new PtvTimetableApiVersion3.V3ResultStop();
      //expect(instance).to.be();
    });

    it('should have the property stopSuburb (base name: "stop_suburb")', function() {
      // uncomment below and update the code to test the property stopSuburb
      //var instance = new PtvTimetableApiVersion3.V3ResultStop();
      //expect(instance).to.be();
    });
