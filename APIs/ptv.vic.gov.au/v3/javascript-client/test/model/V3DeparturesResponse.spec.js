...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3DeparturesResponse();
  });
  ...
  describe('V3DeparturesResponse', function() {
    it('should create an instance of V3DeparturesResponse', function() {
      // uncomment below and update the code to test V3DeparturesResponse
      //var instance = new PtvTimetableApiVersion3.V3DeparturesResponse();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3DeparturesResponse);
    });
