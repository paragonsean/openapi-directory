...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3SearchResult();
  });
  ...
  describe('V3SearchResult', function() {
    it('should create an instance of V3SearchResult', function() {
      // uncomment below and update the code to test V3SearchResult
      //var instance = new PtvTimetableApiVersion3.V3SearchResult();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3SearchResult);
    });
