...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3VehiclePosition();
  });
  ...
  describe('V3VehiclePosition', function() {
    it('should create an instance of V3VehiclePosition', function() {
      // uncomment below and update the code to test V3VehiclePosition
      //var instance = new PtvTimetableApiVersion3.V3VehiclePosition();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3VehiclePosition);
    });
    ...
    it('should have the property datetimeUtc (base name: "datetime_utc")', function() {
