...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3RouteType();
  });
  ...
  describe('V3RouteType', function() {
    it('should create an instance of V3RouteType', function() {
      // uncomment below and update the code to test V3RouteType
      //var instance = new PtvTimetableApiVersion3.V3RouteType();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3RouteType);
    });
    ...
    it('should have the property routeTypeName (base name: "route_type_name")', function() {
      // uncomment below and update the code to test the property routeTypeName
      //var instance = new PtvTimetableApiVersion3.V3RouteType();
      //expect(instance).to.be();
    });
