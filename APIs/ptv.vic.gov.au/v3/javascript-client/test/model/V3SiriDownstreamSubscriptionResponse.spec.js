...
(function(root, factory) {
  ...
  describe('V3SiriDownstreamSubscriptionResponse', function() {
    it('should create an instance of V3SiriDownstreamSubscriptionResponse', function() {
      // uncomment below and update the code to test V3SiriDownstreamSubscriptionResponse
      //var instance = new PtvTimetableApiVersion3.V3SiriDownstreamSubscriptionResponse();
