...
(function(root, factory) {
  ...
  describe('V3Disruption', function() {
    it('should create an instance of V3Disruption', function() {
      // uncomment below and update the code to test V3Disruption
      //var instance = new PtvTimetableApiVersion3.V3Disruption();
    ...
    it('should have the property displayOnBoard (base name: "display_on_board")', function() {
      // uncomment below and update the code to test the property displayOnBoard
      //var instance = new PtvTimetableApiVersion3.V3Disruption();
      //expect(instance).to.be();
    });
    ...
    it('should have the property disruptionId (base name: "disruption_id")', function() {
      // uncomment below and update the code to test the property disruptionId
      //var instance = new PtvTimetableApiVersion3.V3Disruption();
      //expect(instance).to.be();
    });

    it('should have the property disruptionStatus (base name: "disruption_status")', function() {
      // uncomment below and update the code to test the property disruptionStatus
      //var instance = new PtvTimetableApiVersion3.V3Disruption();
      //expect(instance).to.be();
    });

    it('should have the property disruptionType (base name: "disruption_type")', function() {
      // uncomment below and update the code to test the property disruptionType
      //var instance = new PtvTimetableApiVersion3.V3Disruption();
      //expect(instance).to.be();
    });
