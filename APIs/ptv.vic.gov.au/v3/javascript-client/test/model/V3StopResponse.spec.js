...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3StopResponse();
  });
  ...
  describe('V3StopResponse', function() {
    it('should create an instance of V3StopResponse', function() {
      // uncomment below and update the code to test V3StopResponse
      //var instance = new PtvTimetableApiVersion3.V3StopResponse();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3StopResponse);
    });
