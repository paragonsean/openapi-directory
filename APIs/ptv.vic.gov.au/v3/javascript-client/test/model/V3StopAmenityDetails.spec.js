...
(function(root, factory) {
  ...
  describe('V3StopAmenityDetails', function() {
    it('should create an instance of V3StopAmenityDetails', function() {
      // uncomment below and update the code to test V3StopAmenityDetails
      //var instance = new PtvTimetableApiVersion3.V3StopAmenityDetails();
    ...
    it('should have the property carParking (base name: "car_parking")', function() {
      // uncomment below and update the code to test the property carParking
      //var instance = new PtvTimetableApiVersion3.V3StopAmenityDetails();
      //expect(instance).to.be();
    });

    it('should have the property cctv (base name: "cctv")', function() {
      // uncomment below and update the code to test the property cctv
      //var instance = new PtvTimetableApiVersion3.V3StopAmenityDetails();
      //expect(instance).to.be();
    });

    it('should have the property taxiRank (base name: "taxi_rank")', function() {
      // uncomment below and update the code to test the property taxiRank
      //var instance = new PtvTimetableApiVersion3.V3StopAmenityDetails();
      //expect(instance).to.be();
    });
