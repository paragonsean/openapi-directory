...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3StopBasic();
  });
  ...
  describe('V3StopBasic', function() {
    it('should create an instance of V3StopBasic', function() {
      // uncomment below and update the code to test V3StopBasic
      //var instance = new PtvTimetableApiVersion3.V3StopBasic();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3StopBasic);
    });
