...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3RouteServiceStatus();
  });
  ...
  describe('V3RouteServiceStatus', function() {
    it('should create an instance of V3RouteServiceStatus', function() {
      // uncomment below and update the code to test V3RouteServiceStatus
      //var instance = new PtvTimetableApiVersion3.V3RouteServiceStatus();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3RouteServiceStatus);
    });
