...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3Outlet();
  });
  ...
  describe('V3Outlet', function() {
    it('should create an instance of V3Outlet', function() {
      // uncomment below and update the code to test V3Outlet
      //var instance = new PtvTimetableApiVersion3.V3Outlet();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3Outlet);
    });
