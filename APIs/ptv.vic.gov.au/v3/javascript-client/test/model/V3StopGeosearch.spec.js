...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3StopGeosearch();
  });
  ...
  describe('V3StopGeosearch', function() {
    it('should create an instance of V3StopGeosearch', function() {
      // uncomment below and update the code to test V3StopGeosearch
      //var instance = new PtvTimetableApiVersion3.V3StopGeosearch();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3StopGeosearch);
    });
