...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3DirectionsResponse();
  });
  ...
  describe('V3DirectionsResponse', function() {
    it('should create an instance of V3DirectionsResponse', function() {
      // uncomment below and update the code to test V3DirectionsResponse
      //var instance = new PtvTimetableApiVersion3.V3DirectionsResponse();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3DirectionsResponse);
    });
