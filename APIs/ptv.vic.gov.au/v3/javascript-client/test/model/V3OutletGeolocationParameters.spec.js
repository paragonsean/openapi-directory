...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3OutletGeolocationParameters();
  });
  ...
  describe('V3OutletGeolocationParameters', function() {
    it('should create an instance of V3OutletGeolocationParameters', function() {
      // uncomment below and update the code to test V3OutletGeolocationParameters
      //var instance = new PtvTimetableApiVersion3.V3OutletGeolocationParameters();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3OutletGeolocationParameters);
    });
