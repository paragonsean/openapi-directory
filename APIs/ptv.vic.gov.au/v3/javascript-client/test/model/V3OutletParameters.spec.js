...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3OutletParameters();
  });
  ...
  describe('V3OutletParameters', function() {
    it('should create an instance of V3OutletParameters', function() {
      // uncomment below and update the code to test V3OutletParameters
      //var instance = new PtvTimetableApiVersion3.V3OutletParameters();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3OutletParameters);
    });
