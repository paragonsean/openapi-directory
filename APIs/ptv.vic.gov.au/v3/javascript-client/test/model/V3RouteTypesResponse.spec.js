...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3RouteTypesResponse();
  });
  ...
  describe('V3RouteTypesResponse', function() {
    it('should create an instance of V3RouteTypesResponse', function() {
      // uncomment below and update the code to test V3RouteTypesResponse
      //var instance = new PtvTimetableApiVersion3.V3RouteTypesResponse();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3RouteTypesResponse);
    });
