...
(function(root, factory) {
  ...
  describe('V3StopDepartureRequest', function() {
    it('should create an instance of V3StopDepartureRequest', function() {
      // uncomment below and update the code to test V3StopDepartureRequest
      //var instance = new PtvTimetableApiVersion3.V3StopDepartureRequest();
    ...
    it('should have the property routeDirections (base name: "route_directions")', function() {
      // uncomment below and update the code to test the property routeDirections
      //var instance = new PtvTimetableApiVersion3.V3StopDepartureRequest();
      //expect(instance).to.be();
    });
