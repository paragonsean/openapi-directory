...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3DisruptionStop();
  });
  ...
  describe('V3DisruptionStop', function() {
    it('should create an instance of V3DisruptionStop', function() {
      // uncomment below and update the code to test V3DisruptionStop
      //var instance = new PtvTimetableApiVersion3.V3DisruptionStop();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3DisruptionStop);
    });
