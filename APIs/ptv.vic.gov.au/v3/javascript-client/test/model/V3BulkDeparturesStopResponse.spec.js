...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3BulkDeparturesStopResponse();
  });
  ...
  describe('V3BulkDeparturesStopResponse', function() {
    it('should create an instance of V3BulkDeparturesStopResponse', function() {
      // uncomment below and update the code to test V3BulkDeparturesStopResponse
      //var instance = new PtvTimetableApiVersion3.V3BulkDeparturesStopResponse();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3BulkDeparturesStopResponse);
    });
