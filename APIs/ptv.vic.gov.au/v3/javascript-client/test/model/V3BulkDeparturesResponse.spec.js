...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3BulkDeparturesResponse();
  });
  ...
  describe('V3BulkDeparturesResponse', function() {
    it('should create an instance of V3BulkDeparturesResponse', function() {
      // uncomment below and update the code to test V3BulkDeparturesResponse
      //var instance = new PtvTimetableApiVersion3.V3BulkDeparturesResponse();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3BulkDeparturesResponse);
    });
