...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3DeparturesSpecificParameters();
  });
  ...
  describe('V3DeparturesSpecificParameters', function() {
    it('should create an instance of V3DeparturesSpecificParameters', function() {
      // uncomment below and update the code to test V3DeparturesSpecificParameters
      //var instance = new PtvTimetableApiVersion3.V3DeparturesSpecificParameters();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3DeparturesSpecificParameters);
    });
