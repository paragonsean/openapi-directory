...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3StopsByDistanceResponse();
  });
  ...
  describe('V3StopsByDistanceResponse', function() {
    it('should create an instance of V3StopsByDistanceResponse', function() {
      // uncomment below and update the code to test V3StopsByDistanceResponse
      //var instance = new PtvTimetableApiVersion3.V3StopsByDistanceResponse();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3StopsByDistanceResponse);
    });
