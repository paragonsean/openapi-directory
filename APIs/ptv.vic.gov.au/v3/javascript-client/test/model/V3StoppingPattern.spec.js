...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3StoppingPattern();
  });
  ...
  describe('V3StoppingPattern', function() {
    it('should create an instance of V3StoppingPattern', function() {
      // uncomment below and update the code to test V3StoppingPattern
      //var instance = new PtvTimetableApiVersion3.V3StoppingPattern();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3StoppingPattern);
    });
