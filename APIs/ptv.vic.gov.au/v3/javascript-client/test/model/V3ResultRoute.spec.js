...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3ResultRoute();
  });
  ...
  describe('V3ResultRoute', function() {
    it('should create an instance of V3ResultRoute', function() {
      // uncomment below and update the code to test V3ResultRoute
      //var instance = new PtvTimetableApiVersion3.V3ResultRoute();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3ResultRoute);
    });

    it('should have the property routeGtfsId (base name: "route_gtfs_id")', function() {
      // uncomment below and update the code to test the property routeGtfsId
      //var instance = new PtvTimetableApiVersion3.V3ResultRoute();
    ...
    it('should have the property routeName (base name: "route_name")', function() {
      // uncomment below and update the code to test the property routeName
      //var instance = new PtvTimetableApiVersion3.V3ResultRoute();
      //expect(instance).to.be();
    });

    it('should have the property routeNumber (base name: "route_number")', function() {
      // uncomment below and update the code to test the property routeNumber
      //var instance = new PtvTimetableApiVersion3.V3ResultRoute();
      //expect(instance).to.be();
    });

    it('should have the property routeServiceStatus (base name: "route_service_status")', function() {
      // uncomment below and update the code to test the property routeServiceStatus
      //var instance = new PtvTimetableApiVersion3.V3ResultRoute();
      //expect(instance).to.be();
    });
