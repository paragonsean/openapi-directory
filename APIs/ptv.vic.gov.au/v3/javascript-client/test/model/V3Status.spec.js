...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PtvTimetableApiVersion3.V3Status();
  });
  ...
  describe('V3Status', function() {
    it('should create an instance of V3Status', function() {
      // uncomment below and update the code to test V3Status
      //var instance = new PtvTimetableApiVersion3.V3Status();
      //expect(instance).to.be.a(PtvTimetableApiVersion3.V3Status);
    });
