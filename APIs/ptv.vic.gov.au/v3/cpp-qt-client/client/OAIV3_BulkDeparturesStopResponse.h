...
/*
 * OAIV3_BulkDeparturesStopResponse.h
 *
 * 
 */

#ifndef OAIV3_BulkDeparturesStopResponse_H
#define OAIV3_BulkDeparturesStopResponse_H
...
class OAIV3_BulkDeparturesStopResponse : public OAIObject {
public:
    OAIV3_BulkDeparturesStopResponse();
    OAIV3_BulkDeparturesStopResponse(QString json);
    ~OAIV3_BulkDeparturesStopResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_BulkDeparturesStopResponse)

#endif // OAIV3_BulkDeparturesStopResponse_H
