...
/*
 * OAIV3_SearchResult.h
 *
 * 
 */

#ifndef OAIV3_SearchResult_H
#define OAIV3_SearchResult_H
...
namespace OpenAPI {
class OAIV3_ResultOutlet;
class OAIV3_ResultRoute;
class OAIV3_Status;
class OAIV3_ResultStop;

class OAIV3_SearchResult : public OAIObject {
public:
    OAIV3_SearchResult();
    OAIV3_SearchResult(QString json);
    ~OAIV3_SearchResult() override;
    ...
    QList<OAIV3_ResultOutlet> getOutlets() const;
    void setOutlets(const QList<OAIV3_ResultOutlet> &outlets);
    ...
    QList<OAIV3_ResultStop> getStops() const;
    void setStops(const QList<OAIV3_ResultStop> &stops);
...
private:
    ...
    QList<OAIV3_ResultOutlet> m_outlets;
    ...
    QList<OAIV3_ResultStop> m_stops;
    bool m_stops_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_SearchResult)

#endif // OAIV3_SearchResult_H
