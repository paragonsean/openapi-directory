...
/*
 * OAIV3_RouteResponse.h
 *
 * 
 */

#ifndef OAIV3_RouteResponse_H
#define OAIV3_RouteResponse_H
...
class OAIV3_RouteResponse : public OAIObject {
public:
    OAIV3_RouteResponse();
    OAIV3_RouteResponse(QString json);
    ~OAIV3_RouteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_RouteResponse)

#endif // OAIV3_RouteResponse_H
