...
/*
 * OAIV3_RunsResponse.h
 *
 * 
 */

#ifndef OAIV3_RunsResponse_H
#define OAIV3_RunsResponse_H
...
class OAIV3_RunsResponse : public OAIObject {
public:
    OAIV3_RunsResponse();
    OAIV3_RunsResponse(QString json);
    ~OAIV3_RunsResponse() override;
    ...
    QList<OAIV3_Run> getRuns() const;
    void setRuns(const QList<OAIV3_Run> &runs);
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_RunsResponse)

#endif // OAIV3_RunsResponse_H
