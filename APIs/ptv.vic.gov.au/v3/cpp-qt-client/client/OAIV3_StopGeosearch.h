...
/*
 * OAIV3_StopGeosearch.h
 *
 * 
 */

#ifndef OAIV3_StopGeosearch_H
#define OAIV3_StopGeosearch_H
...
class OAIV3_StopGeosearch : public OAIObject {
public:
    OAIV3_StopGeosearch();
    OAIV3_StopGeosearch(QString json);
    ~OAIV3_StopGeosearch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_StopGeosearch)

#endif // OAIV3_StopGeosearch_H
