...
#ifndef OAIV3_StopOnRoute_H
#define OAIV3_StopOnRoute_H
...
class OAIV3_StopOnRoute : public OAIObject {
public:
    OAIV3_StopOnRoute();
    OAIV3_StopOnRoute(QString json);
    ~OAIV3_StopOnRoute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_StopOnRoute)

#endif // OAIV3_StopOnRoute_H
