...
/*
 * OAIV3_DeparturesSpecificParameters.h
 *
 * 
 */

#ifndef OAIV3_DeparturesSpecificParameters_H
#define OAIV3_DeparturesSpecificParameters_H
...
class OAIV3_DeparturesSpecificParameters : public OAIObject {
public:
    OAIV3_DeparturesSpecificParameters();
    OAIV3_DeparturesSpecificParameters(QString json);
    ~OAIV3_DeparturesSpecificParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_DeparturesSpecificParameters)

#endif // OAIV3_DeparturesSpecificParameters_H
