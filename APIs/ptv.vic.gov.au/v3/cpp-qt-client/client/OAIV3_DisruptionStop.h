...
/*
 * OAIV3_DisruptionStop.h
 *
 * 
 */

#ifndef OAIV3_DisruptionStop_H
#define OAIV3_DisruptionStop_H
...
class OAIV3_DisruptionStop : public OAIObject {
public:
    OAIV3_DisruptionStop();
    OAIV3_DisruptionStop(QString json);
    ~OAIV3_DisruptionStop() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_DisruptionStop)

#endif // OAIV3_DisruptionStop_H
