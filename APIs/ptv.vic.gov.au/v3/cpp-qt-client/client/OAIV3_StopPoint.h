...
#ifndef OAIV3_StopPoint_H
#define OAIV3_StopPoint_H
...
class OAIV3_StopPoint : public OAIObject {
public:
    OAIV3_StopPoint();
    OAIV3_StopPoint(QString json);
    ~OAIV3_StopPoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_StopPoint)

#endif // OAIV3_StopPoint_H
