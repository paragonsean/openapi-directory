...
/*
 * OAIV3_OutletGeolocation.h
 *
 * 
 */

#ifndef OAIV3_OutletGeolocation_H
#define OAIV3_OutletGeolocation_H
...
class OAIV3_OutletGeolocation : public OAIObject {
public:
    OAIV3_OutletGeolocation();
    OAIV3_OutletGeolocation(QString json);
    ~OAIV3_OutletGeolocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_OutletGeolocation)

#endif // OAIV3_OutletGeolocation_H
