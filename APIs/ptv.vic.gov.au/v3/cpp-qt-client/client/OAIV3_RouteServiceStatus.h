...
/*
 * OAIV3_RouteServiceStatus.h
 *
 * 
 */

#ifndef OAIV3_RouteServiceStatus_H
#define OAIV3_RouteServiceStatus_H
...
class OAIV3_RouteServiceStatus : public OAIObject {
public:
    OAIV3_RouteServiceStatus();
    OAIV3_RouteServiceStatus(QString json);
    ~OAIV3_RouteServiceStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_RouteServiceStatus)

#endif // OAIV3_RouteServiceStatus_H
