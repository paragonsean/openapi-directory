...
#ifndef OAIV3_StopModel_H
#define OAIV3_StopModel_H
...
class OAIV3_StopModel : public OAIObject {
public:
    OAIV3_StopModel();
    OAIV3_StopModel(QString json);
    ~OAIV3_StopModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_StopModel)

#endif // OAIV3_StopModel_H
