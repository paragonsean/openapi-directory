...
#ifndef OAIV3_Departure_H
#define OAIV3_Departure_H
...
class OAIV3_Departure : public OAIObject {
public:
    OAIV3_Departure();
    OAIV3_Departure(QString json);
    ~OAIV3_Departure() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_Departure)

#endif // OAIV3_Departure_H
