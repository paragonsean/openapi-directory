...
#ifndef OAIV3_Outlet_H
#define OAIV3_Outlet_H
...
class OAIV3_Outlet : public OAIObject {
public:
    OAIV3_Outlet();
    OAIV3_Outlet(QString json);
    ~OAIV3_Outlet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_Outlet)

#endif // OAIV3_Outlet_H
