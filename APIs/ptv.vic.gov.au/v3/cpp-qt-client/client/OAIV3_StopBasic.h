...
#ifndef OAIV3_StopBasic_H
#define OAIV3_StopBasic_H
...
class OAIV3_StopBasic : public OAIObject {
public:
    OAIV3_StopBasic();
    OAIV3_StopBasic(QString json);
    ~OAIV3_StopBasic() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_StopBasic)

#endif // OAIV3_StopBasic_H
