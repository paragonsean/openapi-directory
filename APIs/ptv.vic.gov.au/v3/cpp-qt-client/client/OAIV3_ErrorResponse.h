...
/*
 * OAIV3_ErrorResponse.h
 *
 * An error response
 */

#ifndef OAIV3_ErrorResponse_H
#define OAIV3_ErrorResponse_H
...
class OAIV3_ErrorResponse : public OAIObject {
public:
    OAIV3_ErrorResponse();
    OAIV3_ErrorResponse(QString json);
    ~OAIV3_ErrorResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_ErrorResponse)

#endif // OAIV3_ErrorResponse_H
