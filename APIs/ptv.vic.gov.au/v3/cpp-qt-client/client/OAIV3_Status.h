...
#ifndef OAIV3_Status_H
#define OAIV3_Status_H
...
class OAIV3_Status : public OAIObject {
public:
    OAIV3_Status();
    OAIV3_Status(QString json);
    ~OAIV3_Status() override;
    ...
    qint32 getHealth() const;
    void setHealth(const qint32 &health);
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_Status)

#endif // OAIV3_Status_H
