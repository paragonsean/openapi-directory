...
/*
 * OAIV3_StopDepartureRequestRouteDirection.h
 *
 * 
 */

#ifndef OAIV3_StopDepartureRequestRouteDirection_H
#define OAIV3_StopDepartureRequestRouteDirection_H
...
class OAIV3_StopDepartureRequestRouteDirection : public OAIObject {
public:
    OAIV3_StopDepartureRequestRouteDirection();
    OAIV3_StopDepartureRequestRouteDirection(QString json);
    ~OAIV3_StopDepartureRequestRouteDirection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_StopDepartureRequestRouteDirection)

#endif // OAIV3_StopDepartureRequestRouteDirection_H
