...
/*
 * OAIV3_StopsOnRouteResponse.h
 *
 * 
 */

#ifndef OAIV3_StopsOnRouteResponse_H
#define OAIV3_StopsOnRouteResponse_H
...
class OAIV3_Status;
class OAIV3_StopOnRoute;

class OAIV3_StopsOnRouteResponse : public OAIObject {
public:
    OAIV3_StopsOnRouteResponse();
    OAIV3_StopsOnRouteResponse(QString json);
    ~OAIV3_StopsOnRouteResponse() override;
    ...
    QList<OAIV3_StopOnRoute> getStops() const;
    void setStops(const QList<OAIV3_StopOnRoute> &stops);
...
private:
    ...
    QList<OAIV3_StopOnRoute> m_stops;
    bool m_stops_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_StopsOnRouteResponse)

#endif // OAIV3_StopsOnRouteResponse_H
