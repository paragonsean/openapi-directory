...
/*
 * OAIV3_SiriEstimatedTimetableSubscriptionRequest.h
 *
 * 
 */

#ifndef OAIV3_SiriEstimatedTimetableSubscriptionRequest_H
#define OAIV3_SiriEstimatedTimetableSubscriptionRequest_H
...
class OAIV3_SiriEstimatedTimetableSubscriptionRequest : public OAIObject {
public:
    OAIV3_SiriEstimatedTimetableSubscriptionRequest();
    OAIV3_SiriEstimatedTimetableSubscriptionRequest(QString json);
    ~OAIV3_SiriEstimatedTimetableSubscriptionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_SiriEstimatedTimetableSubscriptionRequest)

#endif // OAIV3_SiriEstimatedTimetableSubscriptionRequest_H
