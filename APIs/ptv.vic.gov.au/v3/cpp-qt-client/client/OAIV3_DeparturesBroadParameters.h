...
/*
 * OAIV3_DeparturesBroadParameters.h
 *
 * 
 */

#ifndef OAIV3_DeparturesBroadParameters_H
#define OAIV3_DeparturesBroadParameters_H
...
class OAIV3_DeparturesBroadParameters : public OAIObject {
public:
    OAIV3_DeparturesBroadParameters();
    OAIV3_DeparturesBroadParameters(QString json);
    ~OAIV3_DeparturesBroadParameters() override;
    ...
    QList<qint32> getPlatformNumbers() const;
    void setPlatformNumbers(const QList<qint32> &platform_numbers);
    bool is_platform_numbers_Set() const;
    bool is_platform_numbers_Valid() const;
...
private:
    ...
    QList<qint32> m_platform_numbers;
    bool m_platform_numbers_isSet;
    bool m_platform_numbers_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIV3_DeparturesBroadParameters)

#endif // OAIV3_DeparturesBroadParameters_H
