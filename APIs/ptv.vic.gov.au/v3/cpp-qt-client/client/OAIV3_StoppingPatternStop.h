...
/*
 * OAIV3_StoppingPatternStop.h
 *
 * 
 */

#ifndef OAIV3_StoppingPatternStop_H
#define OAIV3_StoppingPatternStop_H
...
namespace OpenAPI {
class OAIV3_StopTicket;

class OAIV3_StoppingPatternStop : public OAIObject {
public:
    OAIV3_StoppingPatternStop();
    OAIV3_StoppingPatternStop(QString json);
    ~OAIV3_StoppingPatternStop() override;
    ...
    OAIV3_StopTicket getStopTicket() const;
    void setStopTicket(const OAIV3_StopTicket &stop_ticket);
    bool is_stop_ticket_Set() const;
    bool is_stop_ticket_Valid() const;
...
private:
    ...
    OAIV3_StopTicket m_stop_ticket;
    bool m_stop_ticket_isSet;
    bool m_stop_ticket_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIV3_StoppingPatternStop)

#endif // OAIV3_StoppingPatternStop_H
