...
/*
 * OAIV3_SiriDownstreamSubscriptionResponse.h
 *
 * 
 */

#ifndef OAIV3_SiriDownstreamSubscriptionResponse_H
#define OAIV3_SiriDownstreamSubscriptionResponse_H
...
class OAIV3_SiriDownstreamSubscriptionResponse : public OAIObject {
public:
    OAIV3_SiriDownstreamSubscriptionResponse();
    OAIV3_SiriDownstreamSubscriptionResponse(QString json);
    ~OAIV3_SiriDownstreamSubscriptionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_SiriDownstreamSubscriptionResponse)

#endif // OAIV3_SiriDownstreamSubscriptionResponse_H
