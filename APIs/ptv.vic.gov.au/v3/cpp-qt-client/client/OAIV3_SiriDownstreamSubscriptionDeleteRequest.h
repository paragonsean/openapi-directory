...
/*
 * OAIV3_SiriDownstreamSubscriptionDeleteRequest.h
 *
 * 
 */

#ifndef OAIV3_SiriDownstreamSubscriptionDeleteRequest_H
#define OAIV3_SiriDownstreamSubscriptionDeleteRequest_H
...
class OAIV3_SiriDownstreamSubscriptionDeleteRequest : public OAIObject {
public:
    OAIV3_SiriDownstreamSubscriptionDeleteRequest();
    OAIV3_SiriDownstreamSubscriptionDeleteRequest(QString json);
    ~OAIV3_SiriDownstreamSubscriptionDeleteRequest() override;
    ...
    QList<QString> getSubscriptionRef() const;
    void setSubscriptionRef(const QList<QString> &subscription_ref);
...
private:
    ...
    QList<QString> m_subscription_ref;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_SiriDownstreamSubscriptionDeleteRequest)

#endif // OAIV3_SiriDownstreamSubscriptionDeleteRequest_H
