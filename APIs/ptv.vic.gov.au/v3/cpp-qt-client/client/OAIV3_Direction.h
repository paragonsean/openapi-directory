...
#ifndef OAIV3_Direction_H
#define OAIV3_Direction_H
...
class OAIV3_Direction : public OAIObject {
public:
    OAIV3_Direction();
    OAIV3_Direction(QString json);
    ~OAIV3_Direction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_Direction)

#endif // OAIV3_Direction_H
