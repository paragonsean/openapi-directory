...
/*
 * OAIV3_StopLocation.h
 *
 * 
 */

#ifndef OAIV3_StopLocation_H
#define OAIV3_StopLocation_H
...
class OAIV3_StopLocation : public OAIObject {
public:
    OAIV3_StopLocation();
    OAIV3_StopLocation(QString json);
    ~OAIV3_StopLocation() override;
    ...
    OAIV3_StopGps getGps() const;
    void setGps(const OAIV3_StopGps &gps);
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_StopLocation)

#endif // OAIV3_StopLocation_H
