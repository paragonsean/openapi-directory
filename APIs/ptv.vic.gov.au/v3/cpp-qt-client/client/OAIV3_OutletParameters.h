...
/*
 * OAIV3_OutletParameters.h
 *
 * 
 */

#ifndef OAIV3_OutletParameters_H
#define OAIV3_OutletParameters_H
...
class OAIV3_OutletParameters : public OAIObject {
public:
    OAIV3_OutletParameters();
    OAIV3_OutletParameters(QString json);
    ~OAIV3_OutletParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_OutletParameters)

#endif // OAIV3_OutletParameters_H
