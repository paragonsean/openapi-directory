...
#ifndef OAIV3_StopGps_H
#define OAIV3_StopGps_H
...
class OAIV3_StopGps : public OAIObject {
public:
    OAIV3_StopGps();
    OAIV3_StopGps(QString json);
    ~OAIV3_StopGps() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_StopGps)

#endif // OAIV3_StopGps_H
