...
/*
 * OAIV3_DisruptionsResponse.h
 *
 * 
 */

#ifndef OAIV3_DisruptionsResponse_H
#define OAIV3_DisruptionsResponse_H
...
namespace OpenAPI {
class OAIV3_Disruptions;
class OAIV3_Status;

class OAIV3_DisruptionsResponse : public OAIObject {
public:
    OAIV3_DisruptionsResponse();
    OAIV3_DisruptionsResponse(QString json);
    ~OAIV3_DisruptionsResponse() override;
    ...
    OAIV3_Disruptions getDisruptions() const;
    void setDisruptions(const OAIV3_Disruptions &disruptions);
...
private:
    ...
    OAIV3_Disruptions m_disruptions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV3_DisruptionsResponse)

#endif // OAIV3_DisruptionsResponse_H
