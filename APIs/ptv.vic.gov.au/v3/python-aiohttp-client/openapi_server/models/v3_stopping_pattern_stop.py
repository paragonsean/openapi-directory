...
class V3StoppingPatternStop(Model):
    ...
    def __init__(self, route_type: int=None, stop_distance: float=None, stop_id: int=None, stop_landmark: str=None, stop_latitude: float=None, stop_longitude: float=None, stop_name: str=None, stop_sequence: int=None, stop_suburb: str=None, stop_ticket: V3StopTicket=None):
        """V3StoppingPatternStop - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'V3StoppingPatternStop':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The V3.StoppingPatternStop of this V3StoppingPatternStop.
        """
