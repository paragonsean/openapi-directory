...
class V3DeparturesSpecificParameters(Model):
    ...
    def __init__(self, date_utc: datetime=None, direction_id: int=None, expand: List[str]=None, gtfs: bool=None, include_cancelled: bool=None, include_geopath: bool=None, look_backwards: bool=None, max_results: int=None):
        """V3DeparturesSpecificParameters - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'V3DeparturesSpecificParameters':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The V3.DeparturesSpecificParameters of this V3DeparturesSpecificParameters.
        """
