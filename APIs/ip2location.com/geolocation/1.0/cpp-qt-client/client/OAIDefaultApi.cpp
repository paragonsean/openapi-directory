...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.ip2location.com/v2"),
...
void OAIDefaultApi::rootGet(const QString &ip, const QString &key, const ::OpenAPI::OptionalParam<QString> &package, const ::OpenAPI::OptionalParam<QList<QString>> &addon, const ::OpenAPI::OptionalParam<QString> &format, const ::OpenAPI::OptionalParam<QString> &lang) {
    ...
    if (addon.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "addon", false);
        if (addon.value().size() > 0) {
            if (QString("csv").indexOf("multi") == 0) {
                for (QString t : addon.value()) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
                    fullPath.append("addon=").append(::OpenAPI::toStringValue(t));
                }
            } else if (QString("csv").indexOf("ssv") == 0) {
                if (fullPath.indexOf("?") > 0)
                    fullPath.append("&");
                else
                    fullPath.append("?").append(queryPrefix).append("addon").append(querySuffix);
                qint32 count = 0;
                for (QString t : addon.value()) {
                    if (count > 0) {
