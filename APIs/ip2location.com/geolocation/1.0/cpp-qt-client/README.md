...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QString ip = create(); // QString | IP address (IPv4 or IPv6) for reverse IP location lookup purpose. If not present, the server IP address will be used for the location lookup.
      ...
      QString package = create(); // QString | Web service package of different granularity of return information.
      ...
      QList<QString> addon = create(); // QList<QString> | Extra information in addition to the above selected package.
      ...
      QString lang = create(); // QString | Translation information. The translation only applicable for continent, country, region and city name for the addon package.
      apiInstance.rootGet(ipkeypackageaddonformatlang);
