...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Healthcare.QuestionsListQuestionsInner();
  });
  ...
  describe('QuestionsListQuestionsInner', function() {
    it('should create an instance of QuestionsListQuestionsInner', function() {
      // uncomment below and update the code to test QuestionsListQuestionsInner
      //var instance = new Healthcare.QuestionsListQuestionsInner();
      //expect(instance).to.be.a(Healthcare.QuestionsListQuestionsInner);
    });
