...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Healthcare.QuestionPage();
  });
  ...
  describe('QuestionPage', function() {
    it('should create an instance of QuestionPage', function() {
      // uncomment below and update the code to test QuestionPage
      //var instance = new Healthcare.QuestionPage();
      //expect(instance).to.be.a(Healthcare.QuestionPage);
    });
