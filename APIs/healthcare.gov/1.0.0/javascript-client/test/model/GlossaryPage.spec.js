...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Healthcare.GlossaryPage();
  });
  ...
  describe('GlossaryPage', function() {
    it('should create an instance of GlossaryPage', function() {
      // uncomment below and update the code to test GlossaryPage
      //var instance = new Healthcare.GlossaryPage();
      //expect(instance).to.be.a(Healthcare.GlossaryPage);
    });
