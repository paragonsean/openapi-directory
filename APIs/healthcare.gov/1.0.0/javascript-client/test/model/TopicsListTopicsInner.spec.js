...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Healthcare.TopicsListTopicsInner();
  });
  ...
  describe('TopicsListTopicsInner', function() {
    it('should create an instance of TopicsListTopicsInner', function() {
      // uncomment below and update the code to test TopicsListTopicsInner
      //var instance = new Healthcare.TopicsListTopicsInner();
      //expect(instance).to.be.a(Healthcare.TopicsListTopicsInner);
    });

    it('should have the property articleorder (base name: "articleorder")', function() {
      // uncomment below and update the code to test the property articleorder
      //var instance = new Healthcare.TopicsListTopicsInner();
