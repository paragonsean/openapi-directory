...
/**
 * The StatePage model module.
 * @module model/StatePage
 * @version 1.0.0
 */
class StatePage {
    /**
     * Constructs a new <code>StatePage</code>.
     * @alias module:model/StatePage
     */
    constructor() { 
        
        StatePage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StatePage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatePage} obj Optional instance to populate.
     * @return {module:model/StatePage} The populated <code>StatePage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatePage();
    ...
    /**
     * Validates the JSON data with respect to <code>StatePage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatePage</code>.
     */
 ...
 */
StatePage.prototype['categories'] = undefined;

/**
 * @member {String} content
 */
StatePage.prototype['content'] = undefined;

/**
 * @member {String} date
 */
StatePage.prototype['date'] = undefined;

/**
 * @member {String} excerpt
 */
StatePage.prototype['excerpt'] = undefined;

/**
 * @member {String} id
 */
StatePage.prototype['id'] = undefined;

/**
 * @member {String} lang
 */
StatePage.prototype['lang'] = undefined;

/**
 * @member {String} path
 */
StatePage.prototype['path'] = undefined;

/**
 * @member {Number} sort
 */
StatePage.prototype['sort'] = undefined;

/**
 * @member {String} stateurl
 */
StatePage.prototype['stateurl'] = undefined;

/**
 * @member {Array.<Array.<String>>} tags
 */
StatePage.prototype['tags'] = undefined;

/**
 * @member {String} title
 */
StatePage.prototype['title'] = undefined;

/**
 * @member {String} url
 */
StatePage.prototype['url'] = undefined;
