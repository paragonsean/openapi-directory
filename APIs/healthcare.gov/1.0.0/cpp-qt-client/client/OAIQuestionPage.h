...
#ifndef OAIQuestionPage_H
#define OAIQuestionPage_H
...
class OAIQuestionPage : public OAIObject {
public:
    OAIQuestionPage();
    OAIQuestionPage(QString json);
    ~OAIQuestionPage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuestionPage)

#endif // OAIQuestionPage_H
