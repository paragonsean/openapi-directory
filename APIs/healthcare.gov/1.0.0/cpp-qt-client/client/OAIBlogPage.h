...
#ifndef OAIBlogPage_H
#define OAIBlogPage_H
...
class OAIBlogPage : public OAIObject {
public:
    OAIBlogPage();
    OAIBlogPage(QString json);
    ~OAIBlogPage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlogPage)
