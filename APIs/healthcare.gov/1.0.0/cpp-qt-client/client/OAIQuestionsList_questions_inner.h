...
/*
 * OAIQuestionsList_questions_inner.h
 *
 * 
 */

#ifndef OAIQuestionsList_questions_inner_H
#define OAIQuestionsList_questions_inner_H
...
class OAIQuestionsList_questions_inner : public OAIObject {
public:
    OAIQuestionsList_questions_inner();
    OAIQuestionsList_questions_inner(QString json);
    ~OAIQuestionsList_questions_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuestionsList_questions_inner)

#endif // OAIQuestionsList_questions_inner_H
