...
#ifndef OAIGlossaryPage_H
#define OAIGlossaryPage_H
...
class OAIGlossaryPage : public OAIObject {
public:
    OAIGlossaryPage();
    OAIGlossaryPage(QString json);
    ~OAIGlossaryPage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGlossaryPage)

#endif // OAIGlossaryPage_H
