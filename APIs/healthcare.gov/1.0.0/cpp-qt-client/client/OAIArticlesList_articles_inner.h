...
/*
 * OAIArticlesList_articles_inner.h
 *
 * 
 */

#ifndef OAIArticlesList_articles_inner_H
#define OAIArticlesList_articles_inner_H
...
class OAIArticlesList_articles_inner : public OAIObject {
public:
    OAIArticlesList_articles_inner();
    OAIArticlesList_articles_inner(QString json);
    ~OAIArticlesList_articles_inner() override;
    ...
    QString getBite() const;
    void setBite(const QString &bite);
    bool is_bite_Set() const;
    bool is_bite_Valid() const;
    ...
    QList<QList<QString>> getRelated() const;
    void setRelated(const QList<QList<QString>> &related);
    ...
    QString getTitleShort() const;
    void setTitleShort(const QString &title_short);
    bool is_title_short_Set() const;
    bool is_title_short_Valid() const;
...
private:
    ...
    QString m_title_short;
    bool m_title_short_isSet;
    bool m_title_short_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArticlesList_articles_inner)

#endif // OAIArticlesList_articles_inner_H
