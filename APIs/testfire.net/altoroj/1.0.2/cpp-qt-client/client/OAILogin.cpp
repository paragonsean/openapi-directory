...
QString OAILogin::getUsername() const {
    return m_username;
}
void OAILogin::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAILogin::is_username_Set() const{
    return m_username_isSet;
}

bool OAILogin::is_username_Valid() const{
