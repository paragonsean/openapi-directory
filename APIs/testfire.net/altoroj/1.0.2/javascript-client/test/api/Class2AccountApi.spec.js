...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AltoroJRestApi.Class2AccountApi();
  });
  ...
  describe('Class2AccountApi', function() {
    ...
    describe('showLastTenTransactions', function() {
      it('should call showLastTenTransactions successfully', function(done) {
        //uncomment below and update the code to test showLastTenTransactions
        //instance.showLastTenTransactions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
