...
/*
 * OAIDiscrepantFieldBoolean.h
 *
 * 
 */

#ifndef OAIDiscrepantFieldBoolean_H
#define OAIDiscrepantFieldBoolean_H
...
class OAIDiscrepantFieldBoolean : public OAIObject {
public:
    OAIDiscrepantFieldBoolean();
    OAIDiscrepantFieldBoolean(QString json);
    ~OAIDiscrepantFieldBoolean() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiscrepantFieldBoolean)

#endif // OAIDiscrepantFieldBoolean_H
