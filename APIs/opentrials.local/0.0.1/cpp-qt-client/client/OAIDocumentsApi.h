...
public:
    ...
    */
    virtual void getDocument(const QString &id);

    /**
    * @param[in]  page qint32 [optional]
    * @param[in]  per_page qint32 [optional]
    */
    virtual void listDocuments(const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &per_page = ::OpenAPI::OptionalParam<qint32>());
...
Q_SIGNALS:
    ...
    void listDocumentsSignal(OAIDocumentList summary);


    void getDocumentSignalFull(OAIHttpRequestWorker *worker, OAIDocument summary);
    void listDocumentsSignalFull(OAIHttpRequestWorker *worker, OAIDocumentList summary);
    ...
    void listDocumentsSignalE(OAIDocumentList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listDocumentsSignalError(OAIDocumentList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
