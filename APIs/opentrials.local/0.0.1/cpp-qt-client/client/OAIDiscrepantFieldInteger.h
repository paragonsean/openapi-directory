...
/*
 * OAIDiscrepantFieldInteger.h
 *
 * 
 */

#ifndef OAIDiscrepantFieldInteger_H
#define OAIDiscrepantFieldInteger_H
...
class OAIDiscrepantFieldInteger : public OAIObject {
public:
    OAIDiscrepantFieldInteger();
    OAIDiscrepantFieldInteger(QString json);
    ~OAIDiscrepantFieldInteger() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiscrepantFieldInteger)

#endif // OAIDiscrepantFieldInteger_H
