...
import FileAllOfPages from './FileAllOfPages';
...
class File {
     ...
     * @implements module:model/FileSummary
     */
    constructor() { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new File();
            FileSummary.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('pages')) {
                obj['pages'] = ApiClient.convertToType(data['pages'], [FileAllOfPages]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['pages']) { // data not null
            ...
            for (const item of data['pages']) {
                FileAllOfPages.validateJSON(item);
            };
        }
 ...
 */
File.prototype['documentcloud_id'] = undefined;
 ...
 */
File.prototype['source_url'] = undefined;

/**
 * Array with text of each of the file's pages
 * @member {Array.<module:model/FileAllOfPages>} pages
 */
File.prototype['pages'] = undefined;


// Implement FileSummary interface:
/**
 * @member {String} documentcloud_id
 */
