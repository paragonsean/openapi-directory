...
/**
 * The FDADocumentSearchResult model module.
 * @module model/FDADocumentSearchResult
 * @version 0.0.1
 */
class FDADocumentSearchResult {
    /**
     * Constructs a new <code>FDADocumentSearchResult</code>.
     * @alias module:model/FDADocumentSearchResult
     * @implements module:model/DocumentSummary
    ...
    constructor(documentCategory, id, name, url) { 
        ...
        FDADocumentSearchResult.initialize(this, documentCategory, id, name, url);
    }
    ...
    /**
     * Constructs a <code>FDADocumentSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FDADocumentSearchResult} obj Optional instance to populate.
     * @return {module:model/FDADocumentSearchResult} The populated <code>FDADocumentSearchResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FDADocumentSearchResult();
            DocumentSummary.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>FDADocumentSearchResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FDADocumentSearchResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FDADocumentSearchResult.RequiredProperties) {
...
FDADocumentSearchResult.RequiredProperties = ["document_category", "id", "name", "url"];

/**
 * @member {module:model/DocumentCategory} document_category
 */
FDADocumentSearchResult.prototype['document_category'] = undefined;

/**
 * @member {module:model/FDAApplication} fda_application
 */
FDADocumentSearchResult.prototype['fda_application'] = undefined;

/**
 * @member {File} file
 */
FDADocumentSearchResult.prototype['file'] = undefined;

/**
 * @member {String} id
 */
FDADocumentSearchResult.prototype['id'] = undefined;

/**
 * @member {String} name
 */
FDADocumentSearchResult.prototype['name'] = undefined;

/**
 * ID of the document's source
 * @member {String} source_id
 */
FDADocumentSearchResult.prototype['source_id'] = undefined;

/**
 * URL of origin for this document
 * @member {String} source_url
 */
FDADocumentSearchResult.prototype['source_url'] = undefined;

/**
 * @member {Array.<module:model/TrialSummary>} trials
 */
FDADocumentSearchResult.prototype['trials'] = undefined;

/**
 * OpenTrials API URL of the document
 * @member {String} url
 */
FDADocumentSearchResult.prototype['url'] = undefined;


// Implement DocumentSummary interface:
/**
 * @member {module:model/DocumentCategory} document_category
 */
...
export default FDADocumentSearchResult;
