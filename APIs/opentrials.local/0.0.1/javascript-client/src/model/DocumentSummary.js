...
class DocumentSummary {
    ...
    constructor(documentCategory, id, name, url) { 
        ...
        DocumentSummary.initialize(this, documentCategory, id, name, url);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('file')) {
                obj['file'] = FileSummary.constructFromObject(data['file']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of DocumentSummary.RequiredProperties) {
        ...
        if (data['file']) { // data not null
          FileSummary.validateJSON(data['file']);
        }
...
DocumentSummary.RequiredProperties = ["document_category", "id", "name", "url"];

/**
 * @member {module:model/DocumentCategory} document_category
 */
DocumentSummary.prototype['document_category'] = undefined;

/**
 * @member {module:model/FDAApplication} fda_application
 */
DocumentSummary.prototype['fda_application'] = undefined;

/**
 * @member {module:model/FileSummary} file
 */
DocumentSummary.prototype['file'] = undefined;
 ...
 * @member {String} name
 */
DocumentSummary.prototype['name'] = undefined;

/**
 * ID of the document's source
 * @member {String} source_id
 */
DocumentSummary.prototype['source_id'] = undefined;

/**
 * URL of origin for this document
 * @member {String} source_url
 */
DocumentSummary.prototype['source_url'] = undefined;

/**
 * @member {Array.<module:model/TrialSummary>} trials
 */
DocumentSummary.prototype['trials'] = undefined;

/**
 * OpenTrials API URL of the document
 * @member {String} url
 */
DocumentSummary.prototype['url'] = undefined;
