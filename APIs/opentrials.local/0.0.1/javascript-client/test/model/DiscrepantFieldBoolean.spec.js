...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenTrialsApi.DiscrepantFieldBoolean();
  });
  ...
  describe('DiscrepantFieldBoolean', function() {
    it('should create an instance of DiscrepantFieldBoolean', function() {
      // uncomment below and update the code to test DiscrepantFieldBoolean
      //var instance = new OpenTrialsApi.DiscrepantFieldBoolean();
      //expect(instance).to.be.a(OpenTrialsApi.DiscrepantFieldBoolean);
    });
