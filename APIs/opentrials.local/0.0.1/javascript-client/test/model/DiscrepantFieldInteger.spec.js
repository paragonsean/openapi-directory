...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenTrialsApi.DiscrepantFieldInteger();
  });
  ...
  describe('DiscrepantFieldInteger', function() {
    it('should create an instance of DiscrepantFieldInteger', function() {
      // uncomment below and update the code to test DiscrepantFieldInteger
      //var instance = new OpenTrialsApi.DiscrepantFieldInteger();
      //expect(instance).to.be.a(OpenTrialsApi.DiscrepantFieldInteger);
    });
