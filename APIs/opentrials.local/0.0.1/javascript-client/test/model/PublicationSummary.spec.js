...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenTrialsApi.PublicationSummary();
  });
  ...
  describe('PublicationSummary', function() {
    it('should create an instance of PublicationSummary', function() {
      // uncomment below and update the code to test PublicationSummary
      //var instance = new OpenTrialsApi.PublicationSummary();
      //expect(instance).to.be.a(OpenTrialsApi.PublicationSummary);
    });
