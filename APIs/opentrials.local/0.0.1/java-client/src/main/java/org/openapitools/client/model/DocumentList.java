...
public class DocumentList {
  ...
  public DocumentList items(List<DocumentSummary> items) {
    this.items = items;
    return this;
  }

  public DocumentList addItemsItem(DocumentSummary itemsItem) {
    if (this.items == null) {
  ...
  public DocumentList totalCount(Integer totalCount) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, documentList.items) &&
        Objects.equals(this.totalCount, documentList.totalCount);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        DocumentSummary.validateJsonElement(jsonArrayitems.get(i));
      };
  }
