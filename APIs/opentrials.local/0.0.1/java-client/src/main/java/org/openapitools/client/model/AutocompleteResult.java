...
public class AutocompleteResult {
  ...
  public AutocompleteResult name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, autocompleteResult.id) &&
        Objects.equals(this.name, autocompleteResult.name);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : AutocompleteResult.openapiRequiredFields) {
