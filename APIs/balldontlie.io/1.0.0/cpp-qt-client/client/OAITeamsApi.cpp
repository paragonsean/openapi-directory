...
void OAITeamsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("allTeams", defaultConf);
    _serverIndices.insert("allTeams", 0);
    _serverConfigs.insert("specificTeam", defaultConf);
    _serverIndices.insert("specificTeam", 0);
}
...
void OAITeamsApi::allTeams() {
    QString fullPath = QString(_serverConfigs["allTeams"][_serverIndices.value("allTeams")].URL()+"/api/v1/teams");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITeamsApi::allTeamsCallback);
...
void OAITeamsApi::allTeamsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT allTeamsSignal();
        Q_EMIT allTeamsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT allTeamsSignalE(error_type, error_str);
        Q_EMIT allTeamsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT allTeamsSignalError(error_type, error_str);
        Q_EMIT allTeamsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITeamsApi::specificTeam() {
    QString fullPath = QString(_serverConfigs["specificTeam"][_serverIndices.value("specificTeam")].URL()+"/api/v1/teams/1");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITeamsApi::specificTeamCallback);
    connect(this, &OAITeamsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITeamsApi::specificTeamCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT specificTeamSignal();
        Q_EMIT specificTeamSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT specificTeamSignalE(error_type, error_str);
        Q_EMIT specificTeamSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT specificTeamSignalError(error_type, error_str);
        Q_EMIT specificTeamSignalErrorFull(worker, error_type, error_str);
    }
}
