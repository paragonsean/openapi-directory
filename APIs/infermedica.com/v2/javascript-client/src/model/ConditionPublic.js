...
/**
 * The ConditionPublic model module.
 * @module model/ConditionPublic
 * @version v2
 */
class ConditionPublic {
    /**
     * Constructs a new <code>ConditionPublic</code>.
     * @alias module:model/ConditionPublic
     * @param categories {Array.<String>} 
     * @param id {String} 
     * @param name {String} 
     * @param sexFilter {module:model/ConditionPublic.SexFilterEnum} 
     */
    constructor(categories, id, name, sexFilter) { 
        
        ConditionPublic.initialize(this, categories, id, name, sexFilter);
    }
    ...
    /**
     * Constructs a <code>ConditionPublic</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConditionPublic} obj Optional instance to populate.
     * @return {module:model/ConditionPublic} The populated <code>ConditionPublic</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConditionPublic();
    ...
    /**
     * Validates the JSON data with respect to <code>ConditionPublic</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConditionPublic</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConditionPublic.RequiredProperties) {
...
ConditionPublic.RequiredProperties = ["categories", "id", "name", "sex_filter"];

/**
 * @member {module:model/ConditionPublic.AcutenessEnum} acuteness
 */
ConditionPublic.prototype['acuteness'] = undefined;

/**
 * @member {Array.<String>} categories
 */
ConditionPublic.prototype['categories'] = undefined;

/**
 * @member {String} common_name
 */
ConditionPublic.prototype['common_name'] = undefined;

/**
 * additional content, like custom properties or images
 * @member {Object.<String, Object>} extras
 */
ConditionPublic.prototype['extras'] = undefined;

/**
 * @member {String} id
 */
ConditionPublic.prototype['id'] = undefined;

/**
 * @member {String} name
 */
ConditionPublic.prototype['name'] = undefined;

/**
 * @member {module:model/ConditionPublic.PrevalenceEnum} prevalence
 */
ConditionPublic.prototype['prevalence'] = undefined;

/**
 * @member {module:model/ConditionPublic.SeverityEnum} severity
 */
ConditionPublic.prototype['severity'] = undefined;

/**
 * @member {module:model/ConditionPublic.SexFilterEnum} sex_filter
 */
ConditionPublic.prototype['sex_filter'] = undefined;

/**
 * @member {module:model/ConditionPublic.TriageLevelEnum} triage_level
 */
ConditionPublic.prototype['triage_level'] = undefined;
 ...
 * @readonly
 */
ConditionPublic['PrevalenceEnum'] = {
 ...
 * @readonly
 */
ConditionPublic['TriageLevelEnum'] = {
...
export default ConditionPublic;
