...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfermedicaApi.ExplanationRequest();
  });
  ...
  describe('ExplanationRequest', function() {
    it('should create an instance of ExplanationRequest', function() {
      // uncomment below and update the code to test ExplanationRequest
      //var instance = new InfermedicaApi.ExplanationRequest();
      //expect(instance).to.be.a(InfermedicaApi.ExplanationRequest);
    });
