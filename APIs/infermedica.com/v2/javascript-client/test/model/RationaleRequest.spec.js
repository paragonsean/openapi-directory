...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfermedicaApi.RationaleRequest();
  });
  ...
  describe('RationaleRequest', function() {
    it('should create an instance of RationaleRequest', function() {
      // uncomment below and update the code to test RationaleRequest
      //var instance = new InfermedicaApi.RationaleRequest();
      //expect(instance).to.be.a(InfermedicaApi.RationaleRequest);
    });
