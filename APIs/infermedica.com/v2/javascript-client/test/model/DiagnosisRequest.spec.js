...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfermedicaApi.DiagnosisRequest();
  });
  ...
  describe('DiagnosisRequest', function() {
    it('should create an instance of DiagnosisRequest', function() {
      // uncomment below and update the code to test DiagnosisRequest
      //var instance = new InfermedicaApi.DiagnosisRequest();
      //expect(instance).to.be.a(InfermedicaApi.DiagnosisRequest);
    });
