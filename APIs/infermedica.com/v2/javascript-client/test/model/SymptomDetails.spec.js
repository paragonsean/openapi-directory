...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfermedicaApi.SymptomDetails();
  });
  ...
  describe('SymptomDetails', function() {
    it('should create an instance of SymptomDetails', function() {
      // uncomment below and update the code to test SymptomDetails
      //var instance = new InfermedicaApi.SymptomDetails();
      //expect(instance).to.be.a(InfermedicaApi.SymptomDetails);
    });
    ...
    it('should have the property parentRelation (base name: "parent_relation")', function() {
      // uncomment below and update the code to test the property parentRelation
      //var instance = new InfermedicaApi.SymptomDetails();
      //expect(instance).to.be();
    });
