...
public class ConditionDetails {
  ...
  public ConditionDetails acuteness(AcutenessEnum acuteness) {
  ...
  public ConditionDetails categories(List<String> categories) {
    this.categories = categories;
    return this;
  }

  public ConditionDetails addCategoriesItem(String categoriesItem) {
  ...
  public ConditionDetails commonName(String commonName) {
  ...
  public ConditionDetails extras(Map<String, Object> extras) {
    this.extras = extras;
    return this;
  }

  public ConditionDetails putExtrasItem(String key, Object extrasItem) {
    if (this.extras == null) {
  ...
  public ConditionDetails id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ConditionDetails prevalence(PrevalenceEnum prevalence) {
  ...
  public ConditionDetails severity(SeverityEnum severity) {
  ...
  public ConditionDetails sexFilter(SexFilterEnum sexFilter) {
  ...
  public ConditionDetails triageLevel(TriageLevelEnum triageLevel) {
  ...
  public boolean equals(Object o) {
    ...
    ConditionDetails conditionDetails = (ConditionDetails) o;
    return Objects.equals(this.acuteness, conditionDetails.acuteness) &&
        Objects.equals(this.categories, conditionDetails.categories) &&
        Objects.equals(this.commonName, conditionDetails.commonName) &&
        Objects.equals(this.extras, conditionDetails.extras) &&
        Objects.equals(this.id, conditionDetails.id) &&
        Objects.equals(this.name, conditionDetails.name) &&
        Objects.equals(this.prevalence, conditionDetails.prevalence) &&
        Objects.equals(this.severity, conditionDetails.severity) &&
        Objects.equals(this.sexFilter, conditionDetails.sexFilter) &&
        Objects.equals(this.triageLevel, conditionDetails.triageLevel);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConditionDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConditionDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConditionDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConditionDetails is not found in the empty JSON string", ConditionDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConditionDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConditionDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConditionDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConditionDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConditionDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConditionDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConditionDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ConditionDetails>() {
           @Override
           public void write(JsonWriter out, ConditionDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConditionDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConditionDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConditionDetails
   * @throws IOException if the JSON string is invalid with respect to ConditionDetails
   */
  public static ConditionDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConditionDetails.class);
  }

  /**
   * Convert an instance of ConditionDetails to an JSON string
   *
   * @return JSON string
   */
