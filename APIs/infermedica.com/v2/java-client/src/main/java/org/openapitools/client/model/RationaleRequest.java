...
public class RationaleRequest {
  ...
  public RationaleRequest age(Object age) {
    this.age = age;
    return this;
  }
  ...
  public RationaleRequest evidence(List<Evidence> evidence) {
    this.evidence = evidence;
    return this;
  }

  public RationaleRequest addEvidenceItem(Evidence evidenceItem) {
  ...
  public RationaleRequest extras(Map<String, Object> extras) {
    this.extras = extras;
    return this;
  }

  public RationaleRequest putExtrasItem(String key, Object extrasItem) {
    if (this.extras == null) {
  ...
  public RationaleRequest sex(SexEnum sex) {
    this.sex = sex;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RationaleRequest rationaleRequest = (RationaleRequest) o;
    return Objects.equals(this.age, rationaleRequest.age) &&
        Objects.equals(this.evaluatedAt, rationaleRequest.evaluatedAt) &&
        Objects.equals(this.evidence, rationaleRequest.evidence) &&
        Objects.equals(this.extras, rationaleRequest.extras) &&
        Objects.equals(this.sex, rationaleRequest.sex);
  }
  ...
  public String toString() {
    ...
    sb.append("class RationaleRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RationaleRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RationaleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RationaleRequest is not found in the empty JSON string", RationaleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RationaleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RationaleRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RationaleRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RationaleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RationaleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RationaleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RationaleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RationaleRequest>() {
           @Override
           public void write(JsonWriter out, RationaleRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RationaleRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RationaleRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RationaleRequest
   * @throws IOException if the JSON string is invalid with respect to RationaleRequest
   */
  public static RationaleRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RationaleRequest.class);
  }

  /**
   * Convert an instance of RationaleRequest to an JSON string
   *
   * @return JSON string
   */
