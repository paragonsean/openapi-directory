...
void OAILookupApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getMatchingObservation", defaultConf);
    _serverIndices.insert("getMatchingObservation", 0);
}
...
void OAILookupApi::getMatchingObservation(const QString &phrase, const ::OpenAPI::OptionalParam<QString> &sex, const ::OpenAPI::OptionalParam<qint32> &age_value, const ::OpenAPI::OptionalParam<QString> &age_unit) {
    QString fullPath = QString(_serverConfigs["getMatchingObservation"][_serverIndices.value("getMatchingObservation")].URL()+"/lookup");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILookupApi::getMatchingObservationCallback);
...
void OAILookupApi::getMatchingObservationCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getMatchingObservationSignal(output);
        Q_EMIT getMatchingObservationSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getMatchingObservationSignalE(output, error_type, error_str);
        Q_EMIT getMatchingObservationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getMatchingObservationSignalError(output, error_type, error_str);
        Q_EMIT getMatchingObservationSignalErrorFull(worker, error_type, error_str);
    }
}
