...
/*
 * OAIRationaleRequest.h
 *
 * 
 */

#ifndef OAIRationaleRequest_H
#define OAIRationaleRequest_H
...
class OAIRationaleRequest : public OAIObject {
public:
    OAIRationaleRequest();
    OAIRationaleRequest(QString json);
    ~OAIRationaleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRationaleRequest)

#endif // OAIRationaleRequest_H
