...
OAIObject OAIDiagnosisRequest::getAge() const {
    return m_age;
}
void OAIDiagnosisRequest::setAge(const OAIObject &age) {
    m_age = age;
    m_age_isSet = true;
}

bool OAIDiagnosisRequest::is_age_Set() const{
    return m_age_isSet;
}

bool OAIDiagnosisRequest::is_age_Valid() const{
    return m_age_isValid;
}

QString OAIDiagnosisRequest::getEvaluatedAt() const {
    return m_evaluated_at;
}
void OAIDiagnosisRequest::setEvaluatedAt(const QString &evaluated_at) {
    m_evaluated_at = evaluated_at;
    m_evaluated_at_isSet = true;
}

bool OAIDiagnosisRequest::is_evaluated_at_Set() const{
    return m_evaluated_at_isSet;
}

bool OAIDiagnosisRequest::is_evaluated_at_Valid() const{
    return m_evaluated_at_isValid;
}

QList<OAIEvidence> OAIDiagnosisRequest::getEvidence() const {
    return m_evidence;
}
void OAIDiagnosisRequest::setEvidence(const QList<OAIEvidence> &evidence) {
    m_evidence = evidence;
    m_evidence_isSet = true;
}

bool OAIDiagnosisRequest::is_evidence_Set() const{
    return m_evidence_isSet;
}

bool OAIDiagnosisRequest::is_evidence_Valid() const{
    return m_evidence_isValid;
}

QMap<QString, OAIObject> OAIDiagnosisRequest::getExtras() const {
    return m_extras;
}
void OAIDiagnosisRequest::setExtras(const QMap<QString, OAIObject> &extras) {
    m_extras = extras;
    m_extras_isSet = true;
}

bool OAIDiagnosisRequest::is_extras_Set() const{
    return m_extras_isSet;
}

bool OAIDiagnosisRequest::is_extras_Valid() const{
    return m_extras_isValid;
}

QString OAIDiagnosisRequest::getSex() const {
    return m_sex;
}
void OAIDiagnosisRequest::setSex(const QString &sex) {
    m_sex = sex;
    m_sex_isSet = true;
}

bool OAIDiagnosisRequest::is_sex_Set() const{
    return m_sex_isSet;
}

bool OAIDiagnosisRequest::is_sex_Valid() const{
