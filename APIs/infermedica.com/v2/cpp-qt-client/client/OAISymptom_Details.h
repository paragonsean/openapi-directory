...
/*
 * OAISymptom_Details.h
 *
 * 
 */

#ifndef OAISymptom_Details_H
#define OAISymptom_Details_H
...
class OAISymptom_Details : public OAIObject {
public:
    OAISymptom_Details();
    OAISymptom_Details(QString json);
    ~OAISymptom_Details() override;
    ...
    OAIObject getChildren() const;
    void setChildren(const OAIObject &children);
    ...
    QString getParentRelation() const;
    void setParentRelation(const QString &parent_relation);
    bool is_parent_relation_Set() const;
    bool is_parent_relation_Valid() const;
...
private:
    ...
    QString m_parent_relation;
    bool m_parent_relation_isSet;
    bool m_parent_relation_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISymptom_Details)

#endif // OAISymptom_Details_H
