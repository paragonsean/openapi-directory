...
/*
 * OAIExplanationRequest.h
 *
 * 
 */

#ifndef OAIExplanationRequest_H
#define OAIExplanationRequest_H
...
class OAIExplanationRequest : public OAIObject {
public:
    OAIExplanationRequest();
    OAIExplanationRequest(QString json);
    ~OAIExplanationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExplanationRequest)

#endif // OAIExplanationRequest_H
