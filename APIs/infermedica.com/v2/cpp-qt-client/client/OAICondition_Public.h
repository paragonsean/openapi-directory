...
/*
 * OAICondition_Public.h
 *
 * 
 */

#ifndef OAICondition_Public_H
#define OAICondition_Public_H
...
class OAICondition_Public : public OAIObject {
public:
    OAICondition_Public();
    OAICondition_Public(QString json);
    ~OAICondition_Public() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICondition_Public)

#endif // OAICondition_Public_H
