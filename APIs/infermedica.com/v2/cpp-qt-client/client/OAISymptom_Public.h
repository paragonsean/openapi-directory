...
#ifndef OAISymptom_Public_H
#define OAISymptom_Public_H
...
class OAISymptom_Public : public OAIObject {
public:
    OAISymptom_Public();
    OAISymptom_Public(QString json);
    ~OAISymptom_Public() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISymptom_Public)

#endif // OAISymptom_Public_H
