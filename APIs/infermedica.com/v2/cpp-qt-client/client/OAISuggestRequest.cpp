...
OAIObject OAISuggestRequest::getAge() const {
    return m_age;
}
void OAISuggestRequest::setAge(const OAIObject &age) {
    m_age = age;
    m_age_isSet = true;
}

bool OAISuggestRequest::is_age_Set() const{
    return m_age_isSet;
}

bool OAISuggestRequest::is_age_Valid() const{
    return m_age_isValid;
}

QString OAISuggestRequest::getEvaluatedAt() const {
    return m_evaluated_at;
}
void OAISuggestRequest::setEvaluatedAt(const QString &evaluated_at) {
    m_evaluated_at = evaluated_at;
    m_evaluated_at_isSet = true;
}

bool OAISuggestRequest::is_evaluated_at_Set() const{
    return m_evaluated_at_isSet;
}

bool OAISuggestRequest::is_evaluated_at_Valid() const{
    return m_evaluated_at_isValid;
}

QList<OAIEvidence> OAISuggestRequest::getEvidence() const {
    return m_evidence;
}
void OAISuggestRequest::setEvidence(const QList<OAIEvidence> &evidence) {
    m_evidence = evidence;
    m_evidence_isSet = true;
}

bool OAISuggestRequest::is_evidence_Set() const{
    return m_evidence_isSet;
}

bool OAISuggestRequest::is_evidence_Valid() const{
    return m_evidence_isValid;
}

QMap<QString, OAIObject> OAISuggestRequest::getExtras() const {
    return m_extras;
}
void OAISuggestRequest::setExtras(const QMap<QString, OAIObject> &extras) {
    m_extras = extras;
    m_extras_isSet = true;
}

bool OAISuggestRequest::is_extras_Set() const{
    return m_extras_isSet;
}

bool OAISuggestRequest::is_extras_Valid() const{
    return m_extras_isValid;
}

QString OAISuggestRequest::getSex() const {
    return m_sex;
}
void OAISuggestRequest::setSex(const QString &sex) {
    m_sex = sex;
    m_sex_isSet = true;
}

bool OAISuggestRequest::is_sex_Set() const{
    return m_sex_isSet;
}

bool OAISuggestRequest::is_sex_Valid() const{
