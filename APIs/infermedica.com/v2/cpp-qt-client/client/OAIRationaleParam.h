...
#ifndef OAIRationaleParam_H
#define OAIRationaleParam_H
...
class OAIRationaleParam : public OAIObject {
public:
    OAIRationaleParam();
    OAIRationaleParam(QString json);
    ~OAIRationaleParam() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRationaleParam)

#endif // OAIRationaleParam_H
