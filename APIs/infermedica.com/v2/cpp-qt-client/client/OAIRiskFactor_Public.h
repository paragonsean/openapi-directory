...
/*
 * OAIRiskFactor_Public.h
 *
 * 
 */

#ifndef OAIRiskFactor_Public_H
#define OAIRiskFactor_Public_H
...
class OAIRiskFactor_Public : public OAIObject {
public:
    OAIRiskFactor_Public();
    OAIRiskFactor_Public(QString json);
    ~OAIRiskFactor_Public() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRiskFactor_Public)

#endif // OAIRiskFactor_Public_H
