...
**amount** | **Number** | total amount of all shopping cart items in lowest denomination | [optional] 
**backgroundImage** | **String** | backgroundImage css property | [optional] 
**billing** | [**AddressDataDto**](AddressDataDto.md) |  | [optional] 
**created** | **Number** | created time in ISO 8601 format | [optional] 
...
**mode** | **String** | execution mode | [optional] 
**modified** | **Number** | last modified time in ISO 8601 format | [optional] 
**notifyUrl** | **String** | notify url. If unset no notification will be send | [optional] 
**paymentMethod** | **String** | available payment methods | [optional] 
...
**shoppingCart** | [**[CartItemDto]**](CartItemDto.md) |  | [optional] 
**status** | **String** | link status | [optional] 
