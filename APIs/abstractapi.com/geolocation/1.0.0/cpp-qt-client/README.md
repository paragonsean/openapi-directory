...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::v1GetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::v1GetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      QString ip_address = create(); // QString | 
      ...
      QString fields = create(); // QString | 
      apiInstance.v1Get(api_keyip_addressfields);
