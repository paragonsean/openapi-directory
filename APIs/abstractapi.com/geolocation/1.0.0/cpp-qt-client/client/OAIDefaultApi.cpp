...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://ipgeolocation.abstractapi.com"),
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("v1Get", serverConf);
    _serverIndices.insert("v1Get", 0);
}
...
void OAIDefaultApi::v1Get(const QString &api_key, const ::OpenAPI::OptionalParam<QString> &ip_address, const ::OpenAPI::OptionalParam<QString> &fields) {
    QString fullPath = QString(_serverConfigs["v1Get"][_serverIndices.value("v1Get")].URL()+"/v1/");
    ...
    if (ip_address.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "ip_address", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("ip_address")).append(querySuffix).append(QUrl::toPercentEncoding(ip_address.stringValue()));
    }
    if (fields.hasValue())
    {
        queryStyle = "form";
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::v1GetCallback);
...
void OAIDefaultApi::v1GetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT v1GetSignal(output);
        Q_EMIT v1GetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT v1GetSignalE(output, error_type, error_str);
        Q_EMIT v1GetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT v1GetSignalError(output, error_type, error_str);
        Q_EMIT v1GetSignalErrorFull(worker, error_type, error_str);
    }
}
