...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IpGeolocationApi.InlineResponse200Currency();
  });
  ...
  describe('InlineResponse200Currency', function() {
    it('should create an instance of InlineResponse200Currency', function() {
      // uncomment below and update the code to test InlineResponse200Currency
      //var instance = new IpGeolocationApi.InlineResponse200Currency();
      //expect(instance).to.be.a(IpGeolocationApi.InlineResponse200Currency);
    });
