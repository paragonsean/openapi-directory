...
/*
 * OAIStringArrayValue.h
 *
 * 
 */

#ifndef OAIStringArrayValue_H
#define OAIStringArrayValue_H
...
class OAIStringArrayValue : public OAIObject {
public:
    OAIStringArrayValue();
    OAIStringArrayValue(QString json);
    ~OAIStringArrayValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStringArrayValue)

#endif // OAIStringArrayValue_H
