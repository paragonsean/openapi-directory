...
#ifndef OAIBooleanValue_H
#define OAIBooleanValue_H
...
class OAIBooleanValue : public OAIObject {
public:
    OAIBooleanValue();
    OAIBooleanValue(QString json);
    ~OAIBooleanValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBooleanValue)

#endif // OAIBooleanValue_H
