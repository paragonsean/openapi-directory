...
#ifndef OAIFloatValue_H
#define OAIFloatValue_H
...
class OAIFloatValue : public OAIObject {
public:
    OAIFloatValue();
    OAIFloatValue(QString json);
    ~OAIFloatValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFloatValue)

#endif // OAIFloatValue_H
