...
#ifndef OAI_OAIWhoamiApi_H
#define OAI_OAIWhoamiApi_H
...
class OAIWhoamiApi : public QObject {
    Q_OBJECT

public:
    OAIWhoamiApi(const int timeOut = 0);
    ~OAIWhoamiApi();
...
Q_SIGNALS:
    ...
    void whoAmISignal(OAIUser summary);


    void whoAmISignalFull(OAIHttpRequestWorker *worker, OAIUser summary);

    Q_DECL_DEPRECATED_X("Use whoAmISignalError() instead")
    void whoAmISignalE(OAIUser summary, QNetworkReply::NetworkError error_type, QString error_str);
    void whoAmISignalError(OAIUser summary, QNetworkReply::NetworkError error_type, const QString &error_str);
