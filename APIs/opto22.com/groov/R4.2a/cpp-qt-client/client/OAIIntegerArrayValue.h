...
/*
 * OAIIntegerArrayValue.h
 *
 * 
 */

#ifndef OAIIntegerArrayValue_H
#define OAIIntegerArrayValue_H
...
class OAIIntegerArrayValue : public OAIObject {
public:
    OAIIntegerArrayValue();
    OAIIntegerArrayValue(QString json);
    ~OAIIntegerArrayValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntegerArrayValue)

#endif // OAIIntegerArrayValue_H
