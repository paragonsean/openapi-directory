...
/**
 * Model tests for BooleanArrayValue
 */
public class BooleanArrayValueTest {
    private final BooleanArrayValue model = new BooleanArrayValue();
