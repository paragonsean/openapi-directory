...
public class Device {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      String discriminatorValue = jsonElement.getAsJsonObject().get("deviceType").getAsString();
      switch (discriminatorValue) {
        case "dataStoreDevice":
          DataStoreDevice.validateJsonElement(jsonElement);
          break;
        default:
          throw new IllegalArgumentException(String.format("The value of the `deviceType` field `%s` does not match any key defined in the discriminator's mapping.", discriminatorValue));
      }
  }
