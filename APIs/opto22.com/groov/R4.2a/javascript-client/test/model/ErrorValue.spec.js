...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GroovViewPublicApi.ErrorValue();
  });
  ...
  describe('ErrorValue', function() {
    it('should create an instance of ErrorValue', function() {
      // uncomment below and update the code to test ErrorValue
      //var instance = new GroovViewPublicApi.ErrorValue();
      //expect(instance).to.be.a(GroovViewPublicApi.ErrorValue);
    });
