...
/*
 * OAIInt64VarAsString.h
 *
 * 
 */

#ifndef OAIInt64VarAsString_H
#define OAIInt64VarAsString_H
...
class OAIInt64VarAsString : public OAIObject {
public:
    OAIInt64VarAsString();
    OAIInt64VarAsString(QString json);
    ~OAIInt64VarAsString() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInt64VarAsString)

#endif // OAIInt64VarAsString_H
