...
/*
 * OAIErrorResponse404NotFound.h
 *
 * 
 */

#ifndef OAIErrorResponse404NotFound_H
#define OAIErrorResponse404NotFound_H
...
class OAIErrorResponse404NotFound : public OAIObject {
public:
    OAIErrorResponse404NotFound();
    OAIErrorResponse404NotFound(QString json);
    ~OAIErrorResponse404NotFound() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorResponse404NotFound)

#endif // OAIErrorResponse404NotFound_H
