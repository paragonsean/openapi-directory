...
#ifndef OAIFloatVar_H
#define OAIFloatVar_H
...
class OAIFloatVar : public OAIObject {
public:
    OAIFloatVar();
    OAIFloatVar(QString json);
    ~OAIFloatVar() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFloatVar)
