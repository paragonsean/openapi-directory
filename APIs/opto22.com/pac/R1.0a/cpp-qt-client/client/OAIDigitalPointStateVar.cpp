...
OAIDigitalPointStateVar::OAIDigitalPointStateVar(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDigitalPointStateVar::OAIDigitalPointStateVar() {
    this->initializeModel();
}

OAIDigitalPointStateVar::~OAIDigitalPointStateVar() {}

void OAIDigitalPointStateVar::initializeModel() {
...
void OAIDigitalPointStateVar::fromJson(QString jsonString) {
...
void OAIDigitalPointStateVar::fromJsonObject(QJsonObject json) {
...
QString OAIDigitalPointStateVar::asJson() const {
...
QJsonObject OAIDigitalPointStateVar::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDigitalPointStateVar::getName() const {
    return m_name;
}
void OAIDigitalPointStateVar::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDigitalPointStateVar::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDigitalPointStateVar::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIDigitalPointStateVar::isValue() const {
    return m_value;
}
void OAIDigitalPointStateVar::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIDigitalPointStateVar::is_value_Set() const{
    return m_value_isSet;
}

bool OAIDigitalPointStateVar::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIDigitalPointStateVar::isSet() const {
...
bool OAIDigitalPointStateVar::isValid() const {
