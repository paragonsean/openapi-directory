...
OAIInt32Var::OAIInt32Var(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInt32Var::OAIInt32Var() {
    this->initializeModel();
}

OAIInt32Var::~OAIInt32Var() {}

void OAIInt32Var::initializeModel() {
...
void OAIInt32Var::fromJson(QString jsonString) {
...
void OAIInt32Var::fromJsonObject(QJsonObject json) {
...
QString OAIInt32Var::asJson() const {
...
QJsonObject OAIInt32Var::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIInt32Var::getName() const {
    return m_name;
}
void OAIInt32Var::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIInt32Var::is_name_Set() const{
    return m_name_isSet;
}

bool OAIInt32Var::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIInt32Var::getValue() const {
    return m_value;
}
void OAIInt32Var::setValue(const qint32 &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIInt32Var::is_value_Set() const{
    return m_value_isSet;
}

bool OAIInt32Var::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIInt32Var::isSet() const {
...
bool OAIInt32Var::isValid() const {
