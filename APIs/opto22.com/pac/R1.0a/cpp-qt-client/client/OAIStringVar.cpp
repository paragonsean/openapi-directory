...
OAIStringVar::OAIStringVar(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStringVar::OAIStringVar() {
    this->initializeModel();
}

OAIStringVar::~OAIStringVar() {}

void OAIStringVar::initializeModel() {
...
void OAIStringVar::fromJson(QString jsonString) {
...
void OAIStringVar::fromJsonObject(QJsonObject json) {
...
QString OAIStringVar::asJson() const {
...
QJsonObject OAIStringVar::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIStringVar::getName() const {
    return m_name;
}
void OAIStringVar::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStringVar::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStringVar::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIStringVar::getValue() const {
    return m_value;
}
void OAIStringVar::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIStringVar::is_value_Set() const{
    return m_value_isSet;
}

bool OAIStringVar::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIStringVar::isSet() const {
...
bool OAIStringVar::isValid() const {
