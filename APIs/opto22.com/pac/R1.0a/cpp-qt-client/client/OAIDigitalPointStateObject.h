...
/*
 * OAIDigitalPointStateObject.h
 *
 * 
 */

#ifndef OAIDigitalPointStateObject_H
#define OAIDigitalPointStateObject_H
...
class OAIDigitalPointStateObject : public OAIObject {
public:
    OAIDigitalPointStateObject();
    OAIDigitalPointStateObject(QString json);
    ~OAIDigitalPointStateObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDigitalPointStateObject)

#endif // OAIDigitalPointStateObject_H
