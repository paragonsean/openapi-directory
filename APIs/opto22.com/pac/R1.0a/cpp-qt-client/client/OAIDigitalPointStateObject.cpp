...
OAIDigitalPointStateObject::OAIDigitalPointStateObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDigitalPointStateObject::OAIDigitalPointStateObject() {
    this->initializeModel();
}

OAIDigitalPointStateObject::~OAIDigitalPointStateObject() {}

void OAIDigitalPointStateObject::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
}

void OAIDigitalPointStateObject::fromJson(QString jsonString) {
...
void OAIDigitalPointStateObject::fromJsonObject(QJsonObject json) {

    m_value_isValid = ::OpenAPI::fromJsonValue(m_value, json[QString("value")]);
    m_value_isSet = !json[QString("value")].isNull() && m_value_isValid;
}

QString OAIDigitalPointStateObject::asJson() const {
...
QJsonObject OAIDigitalPointStateObject::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
bool OAIDigitalPointStateObject::isValue() const {
    return m_value;
}
void OAIDigitalPointStateObject::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIDigitalPointStateObject::is_value_Set() const{
    return m_value_isSet;
}

bool OAIDigitalPointStateObject::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIDigitalPointStateObject::isSet() const {
...
bool OAIDigitalPointStateObject::isValid() const {
