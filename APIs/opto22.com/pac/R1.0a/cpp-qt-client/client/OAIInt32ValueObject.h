...
/*
 * OAIInt32ValueObject.h
 *
 * 
 */

#ifndef OAIInt32ValueObject_H
#define OAIInt32ValueObject_H
...
class OAIInt32ValueObject : public OAIObject {
public:
    OAIInt32ValueObject();
    OAIInt32ValueObject(QString json);
    ~OAIInt32ValueObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInt32ValueObject)

#endif // OAIInt32ValueObject_H
