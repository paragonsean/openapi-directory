...
OAIInt64VarAsString::OAIInt64VarAsString(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInt64VarAsString::OAIInt64VarAsString() {
    this->initializeModel();
}

OAIInt64VarAsString::~OAIInt64VarAsString() {}

void OAIInt64VarAsString::initializeModel() {
...
void OAIInt64VarAsString::fromJson(QString jsonString) {
...
void OAIInt64VarAsString::fromJsonObject(QJsonObject json) {
...
QString OAIInt64VarAsString::asJson() const {
...
QJsonObject OAIInt64VarAsString::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIInt64VarAsString::getName() const {
    return m_name;
}
void OAIInt64VarAsString::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIInt64VarAsString::is_name_Set() const{
    return m_name_isSet;
}

bool OAIInt64VarAsString::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIInt64VarAsString::getValue() const {
    return m_value;
}
void OAIInt64VarAsString::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIInt64VarAsString::is_value_Set() const{
    return m_value_isSet;
}

bool OAIInt64VarAsString::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIInt64VarAsString::isSet() const {
...
bool OAIInt64VarAsString::isValid() const {
