...
OAIInt32ValueObject::OAIInt32ValueObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInt32ValueObject::OAIInt32ValueObject() {
    this->initializeModel();
}

OAIInt32ValueObject::~OAIInt32ValueObject() {}

void OAIInt32ValueObject::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
}

void OAIInt32ValueObject::fromJson(QString jsonString) {
...
void OAIInt32ValueObject::fromJsonObject(QJsonObject json) {

    m_value_isValid = ::OpenAPI::fromJsonValue(m_value, json[QString("value")]);
    m_value_isSet = !json[QString("value")].isNull() && m_value_isValid;
}

QString OAIInt32ValueObject::asJson() const {
...
QJsonObject OAIInt32ValueObject::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
qint32 OAIInt32ValueObject::getValue() const {
    return m_value;
}
void OAIInt32ValueObject::setValue(const qint32 &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIInt32ValueObject::is_value_Set() const{
    return m_value_isSet;
}

bool OAIInt32ValueObject::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIInt32ValueObject::isSet() const {
...
bool OAIInt32ValueObject::isValid() const {
