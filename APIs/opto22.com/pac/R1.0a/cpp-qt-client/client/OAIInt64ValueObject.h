...
/*
 * OAIInt64ValueObject.h
 *
 * 
 */

#ifndef OAIInt64ValueObject_H
#define OAIInt64ValueObject_H
...
class OAIInt64ValueObject : public OAIObject {
public:
    OAIInt64ValueObject();
    OAIInt64ValueObject(QString json);
    ~OAIInt64ValueObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInt64ValueObject)

#endif // OAIInt64ValueObject_H
