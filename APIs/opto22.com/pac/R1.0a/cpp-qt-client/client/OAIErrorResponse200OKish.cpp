...
OAIErrorResponse200OKish::OAIErrorResponse200OKish(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIErrorResponse200OKish::OAIErrorResponse200OKish() {
    this->initializeModel();
}

OAIErrorResponse200OKish::~OAIErrorResponse200OKish() {}

void OAIErrorResponse200OKish::initializeModel() {
...
void OAIErrorResponse200OKish::fromJson(QString jsonString) {
...
void OAIErrorResponse200OKish::fromJsonObject(QJsonObject json) {
...
QString OAIErrorResponse200OKish::asJson() const {
...
QJsonObject OAIErrorResponse200OKish::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIErrorResponse200OKish::getErrorCode() const {
    return m_error_code;
}
void OAIErrorResponse200OKish::setErrorCode(const qint32 &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIErrorResponse200OKish::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIErrorResponse200OKish::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QString OAIErrorResponse200OKish::getMessage() const {
    return m_message;
}
void OAIErrorResponse200OKish::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIErrorResponse200OKish::is_message_Set() const{
    return m_message_isSet;
}

bool OAIErrorResponse200OKish::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIErrorResponse200OKish::isSet() const {
...
bool OAIErrorResponse200OKish::isValid() const {
