...
OAIErrorResponse401BadKeyForBasicAuth::OAIErrorResponse401BadKeyForBasicAuth(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIErrorResponse401BadKeyForBasicAuth::OAIErrorResponse401BadKeyForBasicAuth() {
    this->initializeModel();
}

OAIErrorResponse401BadKeyForBasicAuth::~OAIErrorResponse401BadKeyForBasicAuth() {}

void OAIErrorResponse401BadKeyForBasicAuth::initializeModel() {
...
void OAIErrorResponse401BadKeyForBasicAuth::fromJson(QString jsonString) {
...
void OAIErrorResponse401BadKeyForBasicAuth::fromJsonObject(QJsonObject json) {
...
QString OAIErrorResponse401BadKeyForBasicAuth::asJson() const {
...
QJsonObject OAIErrorResponse401BadKeyForBasicAuth::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIErrorResponse401BadKeyForBasicAuth::getErrorCode() const {
    return m_error_code;
}
void OAIErrorResponse401BadKeyForBasicAuth::setErrorCode(const qint32 &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIErrorResponse401BadKeyForBasicAuth::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIErrorResponse401BadKeyForBasicAuth::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QString OAIErrorResponse401BadKeyForBasicAuth::getMessage() const {
    return m_message;
}
void OAIErrorResponse401BadKeyForBasicAuth::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIErrorResponse401BadKeyForBasicAuth::is_message_Set() const{
    return m_message_isSet;
}

bool OAIErrorResponse401BadKeyForBasicAuth::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIErrorResponse401BadKeyForBasicAuth::isSet() const {
...
bool OAIErrorResponse401BadKeyForBasicAuth::isValid() const {
