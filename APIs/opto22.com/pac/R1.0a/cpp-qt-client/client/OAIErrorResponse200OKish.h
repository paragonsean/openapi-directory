...
/*
 * OAIErrorResponse200OKish.h
 *
 * 
 */

#ifndef OAIErrorResponse200OKish_H
#define OAIErrorResponse200OKish_H
...
class OAIErrorResponse200OKish : public OAIObject {
public:
    OAIErrorResponse200OKish();
    OAIErrorResponse200OKish(QString json);
    ~OAIErrorResponse200OKish() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorResponse200OKish)

#endif // OAIErrorResponse200OKish_H
