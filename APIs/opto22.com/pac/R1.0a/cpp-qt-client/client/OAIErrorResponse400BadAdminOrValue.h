...
/*
 * OAIErrorResponse400BadAdminOrValue.h
 *
 * 
 */

#ifndef OAIErrorResponse400BadAdminOrValue_H
#define OAIErrorResponse400BadAdminOrValue_H
...
class OAIErrorResponse400BadAdminOrValue : public OAIObject {
public:
    OAIErrorResponse400BadAdminOrValue();
    OAIErrorResponse400BadAdminOrValue(QString json);
    ~OAIErrorResponse400BadAdminOrValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorResponse400BadAdminOrValue)

#endif // OAIErrorResponse400BadAdminOrValue_H
