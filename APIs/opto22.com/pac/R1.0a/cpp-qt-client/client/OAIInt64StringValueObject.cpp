...
OAIInt64StringValueObject::OAIInt64StringValueObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInt64StringValueObject::OAIInt64StringValueObject() {
    this->initializeModel();
}

OAIInt64StringValueObject::~OAIInt64StringValueObject() {}

void OAIInt64StringValueObject::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
}

void OAIInt64StringValueObject::fromJson(QString jsonString) {
...
void OAIInt64StringValueObject::fromJsonObject(QJsonObject json) {

    m_value_isValid = ::OpenAPI::fromJsonValue(m_value, json[QString("value")]);
    m_value_isSet = !json[QString("value")].isNull() && m_value_isValid;
}

QString OAIInt64StringValueObject::asJson() const {
...
QJsonObject OAIInt64StringValueObject::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
QString OAIInt64StringValueObject::getValue() const {
    return m_value;
}
void OAIInt64StringValueObject::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIInt64StringValueObject::is_value_Set() const{
    return m_value_isSet;
}

bool OAIInt64StringValueObject::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIInt64StringValueObject::isSet() const {
...
bool OAIInt64StringValueObject::isValid() const {
