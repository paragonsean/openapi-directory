...
#ifndef OAIInt32Var_H
#define OAIInt32Var_H
...
class OAIInt32Var : public OAIObject {
public:
    OAIInt32Var();
    OAIInt32Var(QString json);
    ~OAIInt32Var() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInt32Var)
