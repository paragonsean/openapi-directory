...
OAIFloatVar::OAIFloatVar(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFloatVar::OAIFloatVar() {
    this->initializeModel();
}

OAIFloatVar::~OAIFloatVar() {}

void OAIFloatVar::initializeModel() {
...
void OAIFloatVar::fromJson(QString jsonString) {
...
void OAIFloatVar::fromJsonObject(QJsonObject json) {
...
QString OAIFloatVar::asJson() const {
...
QJsonObject OAIFloatVar::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIFloatVar::getName() const {
    return m_name;
}
void OAIFloatVar::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFloatVar::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFloatVar::is_name_Valid() const{
    return m_name_isValid;
}

float OAIFloatVar::getValue() const {
    return m_value;
}
void OAIFloatVar::setValue(const float &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIFloatVar::is_value_Set() const{
    return m_value_isSet;
}

bool OAIFloatVar::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIFloatVar::isSet() const {
...
bool OAIFloatVar::isValid() const {
