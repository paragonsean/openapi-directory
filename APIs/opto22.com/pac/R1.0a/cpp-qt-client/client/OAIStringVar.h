...
#ifndef OAIStringVar_H
#define OAIStringVar_H
...
class OAIStringVar : public OAIObject {
public:
    OAIStringVar();
    OAIStringVar(QString json);
    ~OAIStringVar() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStringVar)

#endif // OAIStringVar_H
