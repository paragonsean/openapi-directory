...
OAIErrorResponse404NotFound::OAIErrorResponse404NotFound(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIErrorResponse404NotFound::OAIErrorResponse404NotFound() {
    this->initializeModel();
}

OAIErrorResponse404NotFound::~OAIErrorResponse404NotFound() {}

void OAIErrorResponse404NotFound::initializeModel() {
...
void OAIErrorResponse404NotFound::fromJson(QString jsonString) {
...
void OAIErrorResponse404NotFound::fromJsonObject(QJsonObject json) {
...
QString OAIErrorResponse404NotFound::asJson() const {
...
QJsonObject OAIErrorResponse404NotFound::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIErrorResponse404NotFound::getErrorCode() const {
    return m_error_code;
}
void OAIErrorResponse404NotFound::setErrorCode(const qint32 &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIErrorResponse404NotFound::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIErrorResponse404NotFound::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QString OAIErrorResponse404NotFound::getMessage() const {
    return m_message;
}
void OAIErrorResponse404NotFound::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIErrorResponse404NotFound::is_message_Set() const{
    return m_message_isSet;
}

bool OAIErrorResponse404NotFound::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIErrorResponse404NotFound::isSet() const {
...
bool OAIErrorResponse404NotFound::isValid() const {
