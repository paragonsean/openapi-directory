...
OAIInt64Var::OAIInt64Var(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInt64Var::OAIInt64Var() {
    this->initializeModel();
}

OAIInt64Var::~OAIInt64Var() {}

void OAIInt64Var::initializeModel() {
...
void OAIInt64Var::fromJson(QString jsonString) {
...
void OAIInt64Var::fromJsonObject(QJsonObject json) {
...
QString OAIInt64Var::asJson() const {
...
QJsonObject OAIInt64Var::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIInt64Var::getName() const {
    return m_name;
}
void OAIInt64Var::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIInt64Var::is_name_Set() const{
    return m_name_isSet;
}

bool OAIInt64Var::is_name_Valid() const{
    return m_name_isValid;
}

qint64 OAIInt64Var::getValue() const {
    return m_value;
}
void OAIInt64Var::setValue(const qint64 &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIInt64Var::is_value_Set() const{
    return m_value_isSet;
}

bool OAIInt64Var::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIInt64Var::isSet() const {
...
bool OAIInt64Var::isValid() const {
