...
OAIFloatValueObject::OAIFloatValueObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFloatValueObject::OAIFloatValueObject() {
    this->initializeModel();
}

OAIFloatValueObject::~OAIFloatValueObject() {}

void OAIFloatValueObject::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
}

void OAIFloatValueObject::fromJson(QString jsonString) {
...
void OAIFloatValueObject::fromJsonObject(QJsonObject json) {

    m_value_isValid = ::OpenAPI::fromJsonValue(m_value, json[QString("value")]);
    m_value_isSet = !json[QString("value")].isNull() && m_value_isValid;
}

QString OAIFloatValueObject::asJson() const {
...
QJsonObject OAIFloatValueObject::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
float OAIFloatValueObject::getValue() const {
    return m_value;
}
void OAIFloatValueObject::setValue(const float &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIFloatValueObject::is_value_Set() const{
    return m_value_isSet;
}

bool OAIFloatValueObject::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIFloatValueObject::isSet() const {
...
bool OAIFloatValueObject::isValid() const {
