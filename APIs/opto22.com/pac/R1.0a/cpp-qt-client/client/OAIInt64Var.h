...
#ifndef OAIInt64Var_H
#define OAIInt64Var_H
...
class OAIInt64Var : public OAIObject {
public:
    OAIInt64Var();
    OAIInt64Var(QString json);
    ~OAIInt64Var() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInt64Var)
