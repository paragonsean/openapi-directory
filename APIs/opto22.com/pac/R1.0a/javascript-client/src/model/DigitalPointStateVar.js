...
/**
 * The DigitalPointStateVar model module.
 * @module model/DigitalPointStateVar
 * @version R1.0a
 */
class DigitalPointStateVar {
    /**
     * Constructs a new <code>DigitalPointStateVar</code>.
     * @alias module:model/DigitalPointStateVar
     */
    constructor() { 
        
        DigitalPointStateVar.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DigitalPointStateVar</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DigitalPointStateVar} obj Optional instance to populate.
     * @return {module:model/DigitalPointStateVar} The populated <code>DigitalPointStateVar</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DigitalPointStateVar();
    ...
    /**
     * Validates the JSON data with respect to <code>DigitalPointStateVar</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DigitalPointStateVar</code>.
     */
 ...
 * @member {String} name
 */
DigitalPointStateVar.prototype['name'] = undefined;

/**
 * State of a digital point (true = on, false = off)
 * @member {Boolean} value
 */
DigitalPointStateVar.prototype['value'] = undefined;
...
export default DigitalPointStateVar;
