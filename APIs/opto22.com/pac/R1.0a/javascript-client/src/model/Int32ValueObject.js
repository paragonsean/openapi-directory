...
/**
 * The Int32ValueObject model module.
 * @module model/Int32ValueObject
 * @version R1.0a
 */
class Int32ValueObject {
    /**
     * Constructs a new <code>Int32ValueObject</code>.
     * @alias module:model/Int32ValueObject
     */
    constructor() { 
        
        Int32ValueObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Int32ValueObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Int32ValueObject} obj Optional instance to populate.
     * @return {module:model/Int32ValueObject} The populated <code>Int32ValueObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Int32ValueObject();
    ...
    /**
     * Validates the JSON data with respect to <code>Int32ValueObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Int32ValueObject</code>.
     */
 ...
 * @member {Number} value
 */
Int32ValueObject.prototype['value'] = undefined;
...
export default Int32ValueObject;
