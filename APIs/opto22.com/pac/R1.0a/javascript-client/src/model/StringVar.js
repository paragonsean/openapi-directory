...
/**
 * The StringVar model module.
 * @module model/StringVar
 * @version R1.0a
 */
class StringVar {
    /**
     * Constructs a new <code>StringVar</code>.
     * @alias module:model/StringVar
     */
    constructor() { 
        
        StringVar.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StringVar</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StringVar} obj Optional instance to populate.
     * @return {module:model/StringVar} The populated <code>StringVar</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StringVar();
    ...
    /**
     * Validates the JSON data with respect to <code>StringVar</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StringVar</code>.
     */
