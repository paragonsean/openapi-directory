...
/**
 * The Int64StringValueObject model module.
 * @module model/Int64StringValueObject
 * @version R1.0a
 */
class Int64StringValueObject {
    /**
     * Constructs a new <code>Int64StringValueObject</code>.
     * @alias module:model/Int64StringValueObject
     */
    constructor() { 
        
        Int64StringValueObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Int64StringValueObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Int64StringValueObject} obj Optional instance to populate.
     * @return {module:model/Int64StringValueObject} The populated <code>Int64StringValueObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Int64StringValueObject();
    ...
    /**
     * Validates the JSON data with respect to <code>Int64StringValueObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Int64StringValueObject</code>.
     */
 ...
 * @member {String} value
 */
Int64StringValueObject.prototype['value'] = undefined;
...
export default Int64StringValueObject;
