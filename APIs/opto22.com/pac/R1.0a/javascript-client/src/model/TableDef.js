...
/**
 * The TableDef model module.
 * @module model/TableDef
 * @version R1.0a
 */
class TableDef {
    /**
     * Constructs a new <code>TableDef</code>.
     * @alias module:model/TableDef
     */
    constructor() { 
        
        TableDef.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TableDef</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TableDef} obj Optional instance to populate.
     * @return {module:model/TableDef} The populated <code>TableDef</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TableDef();
    ...
    /**
     * Validates the JSON data with respect to <code>TableDef</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TableDef</code>.
     */
 ...
 */
TableDef.prototype['length'] = undefined;

/**
 * Name of the tag (strategy variable, i/o point, etc.)
 * @member {String} name
 */
TableDef.prototype['name'] = undefined;
