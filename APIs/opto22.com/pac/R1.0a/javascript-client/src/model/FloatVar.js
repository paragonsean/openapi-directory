...
/**
 * The FloatVar model module.
 * @module model/FloatVar
 * @version R1.0a
 */
class FloatVar {
    /**
     * Constructs a new <code>FloatVar</code>.
     * @alias module:model/FloatVar
     */
    constructor() { 
        
        FloatVar.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FloatVar</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FloatVar} obj Optional instance to populate.
     * @return {module:model/FloatVar} The populated <code>FloatVar</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FloatVar();
    ...
    /**
     * Validates the JSON data with respect to <code>FloatVar</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FloatVar</code>.
     */
 ...
 * @member {String} name
 */
FloatVar.prototype['name'] = undefined;

/**
 * Value of the float variable
 * @member {Number} value
 */
FloatVar.prototype['value'] = undefined;
