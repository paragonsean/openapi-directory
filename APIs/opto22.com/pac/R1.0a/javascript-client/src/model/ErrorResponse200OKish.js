...
/**
 * The ErrorResponse200OKish model module.
 * @module model/ErrorResponse200OKish
 * @version R1.0a
 */
class ErrorResponse200OKish {
    /**
     * Constructs a new <code>ErrorResponse200OKish</code>.
     * @alias module:model/ErrorResponse200OKish
     * @param errorCode {Number} Details: ** -23 ** The string you passed is longer than the width of PAC Control string variable or table element you are writing to.
     * @param message {String} 
     */
    constructor(errorCode, message) { 
        
        ErrorResponse200OKish.initialize(this, errorCode, message);
    }
    ...
    /**
     * Constructs a <code>ErrorResponse200OKish</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ErrorResponse200OKish} obj Optional instance to populate.
     * @return {module:model/ErrorResponse200OKish} The populated <code>ErrorResponse200OKish</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorResponse200OKish();
    ...
    /**
     * Validates the JSON data with respect to <code>ErrorResponse200OKish</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ErrorResponse200OKish</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ErrorResponse200OKish.RequiredProperties) {
...
ErrorResponse200OKish.RequiredProperties = ["errorCode", "message"];
 ...
 */
ErrorResponse200OKish.prototype['errorCode'] = undefined;

/**
 * @member {String} message
 */
ErrorResponse200OKish.prototype['message'] = undefined;
...
export default ErrorResponse200OKish;
