...
/**
* Strategy service.
* @module api/StrategyApi
* @version R1.0a
*/
export default class StrategyApi {

    /**
    * Constructs a new StrategyApi. 
    * @alias module:api/StrategyApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the readStrategyDetails_0 operation.
     * @callback module:api/StrategyApi~readStrategyDetails_0Callback
     ...
     * @param {module:api/StrategyApi~readStrategyDetails_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StrategyResponse}
     */
    readStrategyDetails_0(callback) {
      let postBody = null;
