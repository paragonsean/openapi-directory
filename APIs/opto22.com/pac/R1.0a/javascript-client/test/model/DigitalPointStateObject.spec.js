...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.DigitalPointStateObject();
  });
  ...
  describe('DigitalPointStateObject', function() {
    it('should create an instance of DigitalPointStateObject', function() {
      // uncomment below and update the code to test DigitalPointStateObject
      //var instance = new PacControlRestApi.DigitalPointStateObject();
      //expect(instance).to.be.a(PacControlRestApi.DigitalPointStateObject);
    });
