...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.ErrorResponse404NotFound();
  });
  ...
  describe('ErrorResponse404NotFound', function() {
    it('should create an instance of ErrorResponse404NotFound', function() {
      // uncomment below and update the code to test ErrorResponse404NotFound
      //var instance = new PacControlRestApi.ErrorResponse404NotFound();
      //expect(instance).to.be.a(PacControlRestApi.ErrorResponse404NotFound);
    });
