...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.TableDef();
  });
  ...
  describe('TableDef', function() {
    it('should create an instance of TableDef', function() {
      // uncomment below and update the code to test TableDef
      //var instance = new PacControlRestApi.TableDef();
      //expect(instance).to.be.a(PacControlRestApi.TableDef);
    });
