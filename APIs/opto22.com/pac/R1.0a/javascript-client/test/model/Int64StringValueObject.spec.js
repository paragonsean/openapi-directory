...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.Int64StringValueObject();
  });
  ...
  describe('Int64StringValueObject', function() {
    it('should create an instance of Int64StringValueObject', function() {
      // uncomment below and update the code to test Int64StringValueObject
      //var instance = new PacControlRestApi.Int64StringValueObject();
      //expect(instance).to.be.a(PacControlRestApi.Int64StringValueObject);
    });
