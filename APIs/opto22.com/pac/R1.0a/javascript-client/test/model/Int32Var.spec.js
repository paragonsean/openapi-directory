...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.Int32Var();
  });
  ...
  describe('Int32Var', function() {
    it('should create an instance of Int32Var', function() {
      // uncomment below and update the code to test Int32Var
      //var instance = new PacControlRestApi.Int32Var();
      //expect(instance).to.be.a(PacControlRestApi.Int32Var);
    });
