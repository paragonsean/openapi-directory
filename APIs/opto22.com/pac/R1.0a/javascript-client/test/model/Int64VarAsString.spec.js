...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.Int64VarAsString();
  });
  ...
  describe('Int64VarAsString', function() {
    it('should create an instance of Int64VarAsString', function() {
      // uncomment below and update the code to test Int64VarAsString
      //var instance = new PacControlRestApi.Int64VarAsString();
      //expect(instance).to.be.a(PacControlRestApi.Int64VarAsString);
    });
