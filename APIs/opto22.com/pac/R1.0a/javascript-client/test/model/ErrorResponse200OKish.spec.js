...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.ErrorResponse200OKish();
  });
  ...
  describe('ErrorResponse200OKish', function() {
    it('should create an instance of ErrorResponse200OKish', function() {
      // uncomment below and update the code to test ErrorResponse200OKish
      //var instance = new PacControlRestApi.ErrorResponse200OKish();
      //expect(instance).to.be.a(PacControlRestApi.ErrorResponse200OKish);
    });
