...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.FloatVar();
  });
  ...
  describe('FloatVar', function() {
    it('should create an instance of FloatVar', function() {
      // uncomment below and update the code to test FloatVar
      //var instance = new PacControlRestApi.FloatVar();
      //expect(instance).to.be.a(PacControlRestApi.FloatVar);
    });
