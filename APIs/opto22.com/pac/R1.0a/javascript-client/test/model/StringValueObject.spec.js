...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.StringValueObject();
  });
  ...
  describe('StringValueObject', function() {
    it('should create an instance of StringValueObject', function() {
      // uncomment below and update the code to test StringValueObject
      //var instance = new PacControlRestApi.StringValueObject();
      //expect(instance).to.be.a(PacControlRestApi.StringValueObject);
    });
