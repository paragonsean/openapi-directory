...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.DigitalPointStateVar();
  });
  ...
  describe('DigitalPointStateVar', function() {
    it('should create an instance of DigitalPointStateVar', function() {
      // uncomment below and update the code to test DigitalPointStateVar
      //var instance = new PacControlRestApi.DigitalPointStateVar();
      //expect(instance).to.be.a(PacControlRestApi.DigitalPointStateVar);
    });
