...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.ErrorResponse400BadAdminOrValue();
  });
  ...
  describe('ErrorResponse400BadAdminOrValue', function() {
    it('should create an instance of ErrorResponse400BadAdminOrValue', function() {
      // uncomment below and update the code to test ErrorResponse400BadAdminOrValue
      //var instance = new PacControlRestApi.ErrorResponse400BadAdminOrValue();
      //expect(instance).to.be.a(PacControlRestApi.ErrorResponse400BadAdminOrValue);
    });
