...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.Int32ValueObject();
  });
  ...
  describe('Int32ValueObject', function() {
    it('should create an instance of Int32ValueObject', function() {
      // uncomment below and update the code to test Int32ValueObject
      //var instance = new PacControlRestApi.Int32ValueObject();
      //expect(instance).to.be.a(PacControlRestApi.Int32ValueObject);
    });
