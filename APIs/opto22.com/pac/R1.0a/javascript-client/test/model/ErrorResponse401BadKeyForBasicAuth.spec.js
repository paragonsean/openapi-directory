...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.ErrorResponse401BadKeyForBasicAuth();
  });
  ...
  describe('ErrorResponse401BadKeyForBasicAuth', function() {
    it('should create an instance of ErrorResponse401BadKeyForBasicAuth', function() {
      // uncomment below and update the code to test ErrorResponse401BadKeyForBasicAuth
      //var instance = new PacControlRestApi.ErrorResponse401BadKeyForBasicAuth();
      //expect(instance).to.be.a(PacControlRestApi.ErrorResponse401BadKeyForBasicAuth);
    });
