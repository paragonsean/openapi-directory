...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.StringVar();
  });
  ...
  describe('StringVar', function() {
    it('should create an instance of StringVar', function() {
      // uncomment below and update the code to test StringVar
      //var instance = new PacControlRestApi.StringVar();
      //expect(instance).to.be.a(PacControlRestApi.StringVar);
    });
