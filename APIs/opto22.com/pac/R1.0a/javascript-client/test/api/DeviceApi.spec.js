...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.DeviceApi();
  });
  ...
  describe('DeviceApi', function() {
    describe('readDeviceDetails_0', function() {
      it('should call readDeviceDetails_0 successfully', function(done) {
        //uncomment below and update the code to test readDeviceDetails_0
        //instance.readDeviceDetails_0(function(error) {
