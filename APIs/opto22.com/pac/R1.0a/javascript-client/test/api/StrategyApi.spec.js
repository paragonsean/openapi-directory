...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PacControlRestApi.StrategyApi();
  });
  ...
  describe('StrategyApi', function() {
    describe('readStrategyDetails_0', function() {
      it('should call readStrategyDetails_0 successfully', function(done) {
        //uncomment below and update the code to test readStrategyDetails_0
        //instance.readStrategyDetails_0(function(error) {
