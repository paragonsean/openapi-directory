...
public class Int32Var {
  ...
  public Int32Var name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Int32Var value(Integer value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Int32Var int32Var = (Int32Var) o;
    return Objects.equals(this.name, int32Var.name) &&
        Objects.equals(this.value, int32Var.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Int32Var
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Int32Var.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Int32Var is not found in the empty JSON string", Int32Var.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Int32Var.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Int32Var` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Int32Var.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Int32Var' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Int32Var> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Int32Var.class));

       return (TypeAdapter<T>) new TypeAdapter<Int32Var>() {
           @Override
           public void write(JsonWriter out, Int32Var value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Int32Var read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Int32Var given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Int32Var
   * @throws IOException if the JSON string is invalid with respect to Int32Var
   */
  public static Int32Var fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Int32Var.class);
  }

  /**
   * Convert an instance of Int32Var to an JSON string
   *
   * @return JSON string
   */
