...
public class StrategyApi {
    ...
    public StrategyApi(ApiClient apiClient) {
    ...
    /**
     * Build call for readStrategyDetails_0
     ...
     */
    public okhttp3.Call readStrategyDetails_0Call(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call readStrategyDetails_0ValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return readStrategyDetails_0Call(_callback);
     ...
     */
    public StrategyResponse readStrategyDetails_0() throws ApiException {
        ApiResponse<StrategyResponse> localVarResp = readStrategyDetails_0WithHttpInfo();
     ...
     */
    public ApiResponse<StrategyResponse> readStrategyDetails_0WithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = readStrategyDetails_0ValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call readStrategyDetails_0Async(final ApiCallback<StrategyResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = readStrategyDetails_0ValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<StrategyResponse>(){}.getType();
