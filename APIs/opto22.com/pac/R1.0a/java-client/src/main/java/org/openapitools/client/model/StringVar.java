...
public class StringVar {
  ...
  public StringVar name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StringVar value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StringVar stringVar = (StringVar) o;
    return Objects.equals(this.name, stringVar.name) &&
        Objects.equals(this.value, stringVar.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StringVar
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StringVar.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StringVar is not found in the empty JSON string", StringVar.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StringVar.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StringVar` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StringVar.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StringVar' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StringVar> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StringVar.class));

       return (TypeAdapter<T>) new TypeAdapter<StringVar>() {
           @Override
           public void write(JsonWriter out, StringVar value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StringVar read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StringVar given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StringVar
   * @throws IOException if the JSON string is invalid with respect to StringVar
   */
  public static StringVar fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StringVar.class);
  }

  /**
   * Convert an instance of StringVar to an JSON string
   *
   * @return JSON string
   */
