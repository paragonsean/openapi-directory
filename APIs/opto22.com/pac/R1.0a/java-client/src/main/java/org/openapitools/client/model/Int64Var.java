...
public class Int64Var {
  ...
  public Int64Var name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Int64Var value(Long value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Int64Var int64Var = (Int64Var) o;
    return Objects.equals(this.name, int64Var.name) &&
        Objects.equals(this.value, int64Var.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Int64Var
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Int64Var.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Int64Var is not found in the empty JSON string", Int64Var.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Int64Var.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Int64Var` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Int64Var.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Int64Var' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Int64Var> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Int64Var.class));

       return (TypeAdapter<T>) new TypeAdapter<Int64Var>() {
           @Override
           public void write(JsonWriter out, Int64Var value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Int64Var read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Int64Var given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Int64Var
   * @throws IOException if the JSON string is invalid with respect to Int64Var
   */
  public static Int64Var fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Int64Var.class);
  }

  /**
   * Convert an instance of Int64Var to an JSON string
   *
   * @return JSON string
   */
