...
public class Int32ValueObject {
  ...
  public Int32ValueObject value(Integer value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Int32ValueObject int32ValueObject = (Int32ValueObject) o;
    return Objects.equals(this.value, int32ValueObject.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class Int32ValueObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Int32ValueObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Int32ValueObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Int32ValueObject is not found in the empty JSON string", Int32ValueObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Int32ValueObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Int32ValueObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Int32ValueObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Int32ValueObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Int32ValueObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Int32ValueObject.class));

       return (TypeAdapter<T>) new TypeAdapter<Int32ValueObject>() {
           @Override
           public void write(JsonWriter out, Int32ValueObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Int32ValueObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Int32ValueObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Int32ValueObject
   * @throws IOException if the JSON string is invalid with respect to Int32ValueObject
   */
  public static Int32ValueObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Int32ValueObject.class);
  }

  /**
   * Convert an instance of Int32ValueObject to an JSON string
   *
   * @return JSON string
   */
