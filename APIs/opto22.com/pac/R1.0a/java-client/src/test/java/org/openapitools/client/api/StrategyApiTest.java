...
/**
 * API tests for StrategyApi
 */
@Disabled
public class StrategyApiTest {

    private final StrategyApi api = new StrategyApi();
     ...
     */
    @Test
    public void readStrategyDetails_0Test() throws ApiException {
        StrategyResponse response = api.readStrategyDetails_0();
