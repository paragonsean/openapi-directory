...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://tf689y3hbj.execute-api.us-east-1.amazonaws.com/prod/authorization') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://tf689y3hbj.execute-api.us-east-1.amazonaws.com/prod/authorization
         */
        ...
        this.authentications = {
            'api_key': {type: 'apiKey', 'in': 'query', name: 'token'}
        }
