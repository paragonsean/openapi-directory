...
public class ApiClient {
    ...
    private String basePath = "https://tf689y3hbj.execute-api.us-east-1.amazonaws.com/prod/authorization";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://tf689y3hbj.execute-api.us-east-1.amazonaws.com/prod/authorization
