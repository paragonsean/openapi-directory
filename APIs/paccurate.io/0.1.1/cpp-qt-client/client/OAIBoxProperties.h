...
#ifndef OAIBoxProperties_H
#define OAIBoxProperties_H
...
class OAIBoxProperties : public OAIObject {
public:
    OAIBoxProperties();
    OAIBoxProperties(QString json);
    ~OAIBoxProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBoxProperties)

#endif // OAIBoxProperties_H
