...
void OAIDefaultApi::rootPost(const ::OpenAPI::OptionalParam<OAIPack> &pack) {
    ...
    if (pack.hasValue()){
        ...
        QByteArray output = pack.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::rootPostCallback);
...
void OAIDefaultApi::rootPostCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPackResponse output(QString(worker->response));
    worker->deleteLater();
