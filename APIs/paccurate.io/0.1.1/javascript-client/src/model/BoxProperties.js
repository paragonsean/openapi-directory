...
/**
 * The BoxProperties model module.
 * @module model/BoxProperties
 * @version 0.1.1
 */
class BoxProperties {
    /**
     * Constructs a new <code>BoxProperties</code>.
     * @alias module:model/BoxProperties
    ...
    /**
     * Constructs a <code>BoxProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BoxProperties} obj Optional instance to populate.
     * @return {module:model/BoxProperties} The populated <code>BoxProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BoxProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>BoxProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BoxProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BoxProperties.RequiredProperties) {
...
BoxProperties.RequiredProperties = ["dimensions", "weightMax"];
