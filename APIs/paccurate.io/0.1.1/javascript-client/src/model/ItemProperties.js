...
/**
 * The ItemProperties model module.
 * @module model/ItemProperties
 * @version 0.1.1
 */
class ItemProperties {
    /**
     * Constructs a new <code>ItemProperties</code>.
     * general properties of an item
     * @alias module:model/ItemProperties
    ...
    /**
     * Constructs a <code>ItemProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemProperties} obj Optional instance to populate.
     * @return {module:model/ItemProperties} The populated <code>ItemProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>ItemProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ItemProperties.RequiredProperties) {
...
ItemProperties.RequiredProperties = ["dimensions", "weight"];
