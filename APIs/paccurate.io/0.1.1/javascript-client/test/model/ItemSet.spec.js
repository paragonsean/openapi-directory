...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaccurateIo.ItemSet();
  });
  ...
  describe('ItemSet', function() {
    it('should create an instance of ItemSet', function() {
      // uncomment below and update the code to test ItemSet
      //var instance = new PaccurateIo.ItemSet();
      //expect(instance).to.be.a(PaccurateIo.ItemSet);
    });
