...
|**refId** | **Integer** | item type reference identifier passed backed from request. |  [optional] |
...
|**weight** | **BigDecimal** | weight of this single packed item. |  |
|**index** | **Integer** | the sequence at which the item was packed. |  [optional] |
