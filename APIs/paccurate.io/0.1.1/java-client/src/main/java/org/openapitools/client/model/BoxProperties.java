...
public class BoxProperties {
  ...
  public BoxProperties dimensions(Point dimensions) {
  ...
  public BoxProperties name(String name) {
    this.name = name;
    return this;
  }
  ...
  public BoxProperties price(Integer price) {
    this.price = price;
    return this;
  }
  ...
  public BoxProperties rateTable(RateTable rateTable) {
  ...
  public BoxProperties weightMax(BigDecimal weightMax) {
  ...
  public BoxProperties weightTare(BigDecimal weightTare) {
  ...
  public boolean equals(Object o) {
    ...
    BoxProperties boxProperties = (BoxProperties) o;
    return Objects.equals(this.dimensions, boxProperties.dimensions) &&
        Objects.equals(this.name, boxProperties.name) &&
        Objects.equals(this.price, boxProperties.price) &&
        Objects.equals(this.rateTable, boxProperties.rateTable) &&
        Objects.equals(this.weightMax, boxProperties.weightMax) &&
        Objects.equals(this.weightTare, boxProperties.weightTare);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BoxProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BoxProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BoxProperties is not found in the empty JSON string", BoxProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BoxProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BoxProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BoxProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BoxProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BoxProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BoxProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BoxProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<BoxProperties>() {
           @Override
           public void write(JsonWriter out, BoxProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BoxProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BoxProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BoxProperties
   * @throws IOException if the JSON string is invalid with respect to BoxProperties
   */
  public static BoxProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BoxProperties.class);
  }

  /**
   * Convert an instance of BoxProperties to an JSON string
   *
   * @return JSON string
   */
