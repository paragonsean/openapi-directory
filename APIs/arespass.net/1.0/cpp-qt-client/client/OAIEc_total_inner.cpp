...
OAIEc_total_inner::OAIEc_total_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEc_total_inner::OAIEc_total_inner() {
    this->initializeModel();
}

OAIEc_total_inner::~OAIEc_total_inner() {}

void OAIEc_total_inner::initializeModel() {
...
void OAIEc_total_inner::fromJson(QString jsonString) {
...
void OAIEc_total_inner::fromJsonObject(QJsonObject json) {
...
QString OAIEc_total_inner::asJson() const {
...
QJsonObject OAIEc_total_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_r_char_isSet) {
...
QString OAIEc_total_inner::getRChar() const {
    return m_r_char;
}
void OAIEc_total_inner::setRChar(const QString &r_char) {
    m_r_char = r_char;
    m_r_char_isSet = true;
}

bool OAIEc_total_inner::is_r_char_Set() const{
    return m_r_char_isSet;
}

bool OAIEc_total_inner::is_r_char_Valid() const{
    return m_r_char_isValid;
}

QString OAIEc_total_inner::getL33tchar() const {
    return m_l33tchar;
}
void OAIEc_total_inner::setL33tchar(const QString &l33tchar) {
    m_l33tchar = l33tchar;
    m_l33tchar_isSet = true;
}

bool OAIEc_total_inner::is_l33tchar_Set() const{
    return m_l33tchar_isSet;
}

bool OAIEc_total_inner::is_l33tchar_Valid() const{
    return m_l33tchar_isValid;
}

double OAIEc_total_inner::getPenalty() const {
    return m_penalty;
}
void OAIEc_total_inner::setPenalty(const double &penalty) {
    m_penalty = penalty;
    m_penalty_isSet = true;
}

bool OAIEc_total_inner::is_penalty_Set() const{
    return m_penalty_isSet;
}

bool OAIEc_total_inner::is_penalty_Valid() const{
    return m_penalty_isValid;
}

bool OAIEc_total_inner::isSet() const {
...
bool OAIEc_total_inner::isValid() const {
