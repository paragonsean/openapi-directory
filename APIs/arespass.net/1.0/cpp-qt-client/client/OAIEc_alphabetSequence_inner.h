...
/*
 * OAIEc_alphabetSequence_inner.h
 *
 * 
 */

#ifndef OAIEc_alphabetSequence_inner_H
#define OAIEc_alphabetSequence_inner_H
...
class OAIEc_alphabetSequence_inner : public OAIObject {
public:
    OAIEc_alphabetSequence_inner();
    OAIEc_alphabetSequence_inner(QString json);
    ~OAIEc_alphabetSequence_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEc_alphabetSequence_inner)

#endif // OAIEc_alphabetSequence_inner_H
