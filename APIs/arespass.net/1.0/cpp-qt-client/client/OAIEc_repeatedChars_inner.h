...
/*
 * OAIEc_repeatedChars_inner.h
 *
 * 
 */

#ifndef OAIEc_repeatedChars_inner_H
#define OAIEc_repeatedChars_inner_H
...
class OAIEc_repeatedChars_inner : public OAIObject {
public:
    OAIEc_repeatedChars_inner();
    OAIEc_repeatedChars_inner(QString json);
    ~OAIEc_repeatedChars_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEc_repeatedChars_inner)

#endif // OAIEc_repeatedChars_inner_H
