...
OAIEc_words_inner::OAIEc_words_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEc_words_inner::OAIEc_words_inner() {
    this->initializeModel();
}

OAIEc_words_inner::~OAIEc_words_inner() {}

void OAIEc_words_inner::initializeModel() {
...
void OAIEc_words_inner::fromJson(QString jsonString) {
...
void OAIEc_words_inner::fromJsonObject(QJsonObject json) {
...
QString OAIEc_words_inner::asJson() const {
...
QJsonObject OAIEc_words_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_r_char_isSet) {
...
QString OAIEc_words_inner::getRChar() const {
    return m_r_char;
}
void OAIEc_words_inner::setRChar(const QString &r_char) {
    m_r_char = r_char;
    m_r_char_isSet = true;
}

bool OAIEc_words_inner::is_r_char_Set() const{
    return m_r_char_isSet;
}

bool OAIEc_words_inner::is_r_char_Valid() const{
    return m_r_char_isValid;
}

QString OAIEc_words_inner::getL33tchar() const {
    return m_l33tchar;
}
void OAIEc_words_inner::setL33tchar(const QString &l33tchar) {
    m_l33tchar = l33tchar;
    m_l33tchar_isSet = true;
}

bool OAIEc_words_inner::is_l33tchar_Set() const{
    return m_l33tchar_isSet;
}

bool OAIEc_words_inner::is_l33tchar_Valid() const{
    return m_l33tchar_isValid;
}

double OAIEc_words_inner::getPenalty() const {
    return m_penalty;
}
void OAIEc_words_inner::setPenalty(const double &penalty) {
    m_penalty = penalty;
    m_penalty_isSet = true;
}

bool OAIEc_words_inner::is_penalty_Set() const{
    return m_penalty_isSet;
}

bool OAIEc_words_inner::is_penalty_Valid() const{
    return m_penalty_isValid;
}

bool OAIEc_words_inner::isSet() const {
...
bool OAIEc_words_inner::isValid() const {
