...
/*
 * OAIEc_entropyDistribution_inner.h
 *
 * 
 */

#ifndef OAIEc_entropyDistribution_inner_H
#define OAIEc_entropyDistribution_inner_H
...
class OAIEc_entropyDistribution_inner : public OAIObject {
public:
    OAIEc_entropyDistribution_inner();
    OAIEc_entropyDistribution_inner(QString json);
    ~OAIEc_entropyDistribution_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEc_entropyDistribution_inner)

#endif // OAIEc_entropyDistribution_inner_H
