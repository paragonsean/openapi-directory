...
/*
 * OAIEc_keyboardSequence_inner.h
 *
 * 
 */

#ifndef OAIEc_keyboardSequence_inner_H
#define OAIEc_keyboardSequence_inner_H
...
class OAIEc_keyboardSequence_inner : public OAIObject {
public:
    OAIEc_keyboardSequence_inner();
    OAIEc_keyboardSequence_inner(QString json);
    ~OAIEc_keyboardSequence_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEc_keyboardSequence_inner)

#endif // OAIEc_keyboardSequence_inner_H
