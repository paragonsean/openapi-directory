...
#ifndef OAIEc_total_inner_H
#define OAIEc_total_inner_H
...
class OAIEc_total_inner : public OAIObject {
public:
    OAIEc_total_inner();
    OAIEc_total_inner(QString json);
    ~OAIEc_total_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEc_total_inner)

#endif // OAIEc_total_inner_H
