...
/*
 * OAIPaymentDetailForSearch.h
 *
 * 
 */

#ifndef OAIPaymentDetailForSearch_H
#define OAIPaymentDetailForSearch_H
...
namespace OpenAPI {
class OAIPaymentLinksForSearch;
class OAICardDetails;
class OAIRefundSummary;
class OAIPaymentSettlementSummary;
class OAIPaymentState;

class OAIPaymentDetailForSearch : public OAIObject {
public:
    OAIPaymentDetailForSearch();
    OAIPaymentDetailForSearch(QString json);
    ~OAIPaymentDetailForSearch() override;
    ...
    OAIPaymentLinksForSearch getLinks() const;
    void setLinks(const OAIPaymentLinksForSearch &_links);
...
private:
    ...
    OAIPaymentLinksForSearch m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentDetailForSearch)

#endif // OAIPaymentDetailForSearch_H
