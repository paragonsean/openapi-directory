...
#ifndef OAIRefundError_H
#define OAIRefundError_H
...
class OAIRefundError : public OAIObject {
public:
    OAIRefundError();
    OAIRefundError(QString json);
    ~OAIRefundError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefundError)

#endif // OAIRefundError_H
