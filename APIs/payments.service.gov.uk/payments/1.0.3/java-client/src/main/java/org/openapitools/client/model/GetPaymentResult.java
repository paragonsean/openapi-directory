...
public class GetPaymentResult {
  ...
  public GetPaymentResult cardDetails(CardDetails cardDetails) {
  ...
  public GetPaymentResult refundSummary(RefundSummary refundSummary) {
  ...
  public GetPaymentResult settlementSummary(PaymentSettlementSummary settlementSummary) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, getPaymentResult.links) &&
        Objects.equals(this.amount, getPaymentResult.amount) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPaymentResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPaymentResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPaymentResult is not found in the empty JSON string", GetPaymentResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPaymentResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPaymentResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPaymentResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPaymentResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPaymentResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPaymentResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPaymentResult>() {
           @Override
           public void write(JsonWriter out, GetPaymentResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPaymentResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPaymentResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPaymentResult
   * @throws IOException if the JSON string is invalid with respect to GetPaymentResult
   */
  public static GetPaymentResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPaymentResult.class);
  }

  /**
   * Convert an instance of GetPaymentResult to an JSON string
   *
   * @return JSON string
   */
