...
|**language** | [**LanguageEnum**](#LanguageEnum) | Which language your users will see on the payment pages when they make a payment. |  [optional] |
|**metadata** | **Map&lt;String, String&gt;** | [Custom metadata](https://docs.payments.service.gov.uk/optional_features/custom_metadata/) you added to the payment. |  [optional] |
