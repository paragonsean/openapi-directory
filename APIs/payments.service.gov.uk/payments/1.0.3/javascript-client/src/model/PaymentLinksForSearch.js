...
/**
 * The PaymentLinksForSearch model module.
 * @module model/PaymentLinksForSearch
 * @version 1.0.3
 */
class PaymentLinksForSearch {
    /**
     * Constructs a new <code>PaymentLinksForSearch</code>.
     * links for search payment resource
     * @alias module:model/PaymentLinksForSearch
     */
    constructor() { 
        
        PaymentLinksForSearch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentLinksForSearch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentLinksForSearch} obj Optional instance to populate.
     * @return {module:model/PaymentLinksForSearch} The populated <code>PaymentLinksForSearch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentLinksForSearch();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentLinksForSearch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentLinksForSearch</code>.
     */
 ...
 */
PaymentLinksForSearch.prototype['cancel'] = undefined;

/**
 * @member {module:model/PostLink} capture
 */
PaymentLinksForSearch.prototype['capture'] = undefined;

/**
 * @member {module:model/Link} events
 */
PaymentLinksForSearch.prototype['events'] = undefined;

/**
 * @member {module:model/Link} refunds
 */
PaymentLinksForSearch.prototype['refunds'] = undefined;

/**
 * @member {module:model/Link} self
 */
PaymentLinksForSearch.prototype['self'] = undefined;
...
export default PaymentLinksForSearch;
