...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GovUkPayApi.PaymentLinksForSearch();
  });
  ...
  describe('PaymentLinksForSearch', function() {
    it('should create an instance of PaymentLinksForSearch', function() {
      // uncomment below and update the code to test PaymentLinksForSearch
      //var instance = new GovUkPayApi.PaymentLinksForSearch();
      //expect(instance).to.be.a(GovUkPayApi.PaymentLinksForSearch);
    });
