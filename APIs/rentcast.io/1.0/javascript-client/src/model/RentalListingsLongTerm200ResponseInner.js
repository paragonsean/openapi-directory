...
/**
 * The RentalListingsLongTerm200ResponseInner model module.
 * @module model/RentalListingsLongTerm200ResponseInner
 * @version 1.0
 */
class RentalListingsLongTerm200ResponseInner {
    /**
     * Constructs a new <code>RentalListingsLongTerm200ResponseInner</code>.
     * @alias module:model/RentalListingsLongTerm200ResponseInner
     */
    constructor() { 
        
        RentalListingsLongTerm200ResponseInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RentalListingsLongTerm200ResponseInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RentalListingsLongTerm200ResponseInner} obj Optional instance to populate.
     * @return {module:model/RentalListingsLongTerm200ResponseInner} The populated <code>RentalListingsLongTerm200ResponseInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RentalListingsLongTerm200ResponseInner();
    ...
    /**
     * Validates the JSON data with respect to <code>RentalListingsLongTerm200ResponseInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RentalListingsLongTerm200ResponseInner</code>.
     */
 ...
 */
RentalListingsLongTerm200ResponseInner.prototype['addressLine1'] = undefined;

/**
 * @member {Number} bathrooms
 * @default 0
 */
RentalListingsLongTerm200ResponseInner.prototype['bathrooms'] = 0;

/**
 * @member {Number} bedrooms
 * @default 0
 */
RentalListingsLongTerm200ResponseInner.prototype['bedrooms'] = 0;

/**
 * @member {String} city
 */
RentalListingsLongTerm200ResponseInner.prototype['city'] = undefined;

/**
 * @member {String} county
 */
RentalListingsLongTerm200ResponseInner.prototype['county'] = undefined;

/**
 * @member {String} createdDate
 */
RentalListingsLongTerm200ResponseInner.prototype['createdDate'] = undefined;

/**
 * @member {Number} daysOnMarket
 * @default 0
 */
RentalListingsLongTerm200ResponseInner.prototype['daysOnMarket'] = 0;

/**
 * @member {String} formattedAddress
 */
RentalListingsLongTerm200ResponseInner.prototype['formattedAddress'] = undefined;

/**
 * @member {String} id
 */
RentalListingsLongTerm200ResponseInner.prototype['id'] = undefined;

/**
 * @member {String} lastSeenDate
 */
RentalListingsLongTerm200ResponseInner.prototype['lastSeenDate'] = undefined;

/**
 * @member {Number} latitude
 * @default 0
 */
RentalListingsLongTerm200ResponseInner.prototype['latitude'] = 0;

/**
 * @member {String} listedDate
 */
RentalListingsLongTerm200ResponseInner.prototype['listedDate'] = undefined;

/**
 * @member {Number} longitude
 * @default 0
 */
RentalListingsLongTerm200ResponseInner.prototype['longitude'] = 0;

/**
 * @member {Number} price
 * @default 0
 */
RentalListingsLongTerm200ResponseInner.prototype['price'] = 0;

/**
 * @member {String} propertyType
 */
RentalListingsLongTerm200ResponseInner.prototype['propertyType'] = undefined;

/**
 * @member {Object} removedDate
 */
RentalListingsLongTerm200ResponseInner.prototype['removedDate'] = undefined;

/**
 * @member {Number} squareFootage
 * @default 0
 */
RentalListingsLongTerm200ResponseInner.prototype['squareFootage'] = 0;

/**
 * @member {String} state
 */
RentalListingsLongTerm200ResponseInner.prototype['state'] = undefined;

/**
 * @member {String} status
 */
RentalListingsLongTerm200ResponseInner.prototype['status'] = undefined;

/**
 * @member {Number} yearBuilt
 * @default 0
 */
RentalListingsLongTerm200ResponseInner.prototype['yearBuilt'] = 0;

/**
 * @member {String} zipCode
 */
RentalListingsLongTerm200ResponseInner.prototype['zipCode'] = undefined;
...
export default RentalListingsLongTerm200ResponseInner;
