...
/*
 * OAIProperty_records_200_response_inner_features.h
 *
 * 
 */

#ifndef OAIProperty_records_200_response_inner_features_H
#define OAIProperty_records_200_response_inner_features_H
...
class OAIProperty_records_200_response_inner_features : public OAIObject {
public:
    OAIProperty_records_200_response_inner_features();
    OAIProperty_records_200_response_inner_features(QString json);
    ~OAIProperty_records_200_response_inner_features() override;
    ...
    QString getFoundationType() const;
    void setFoundationType(const QString &foundation_type);
    bool is_foundation_type_Set() const;
    bool is_foundation_type_Valid() const;
...
private:
    ...
    QString m_foundation_type;
    bool m_foundation_type_isSet;
    bool m_foundation_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProperty_records_200_response_inner_features)

#endif // OAIProperty_records_200_response_inner_features_H
