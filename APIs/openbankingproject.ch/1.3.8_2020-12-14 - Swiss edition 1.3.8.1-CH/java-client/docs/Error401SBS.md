...
|**additionalErrors** | [**List&lt;Error401SBSAdditionalErrorsInner&gt;**](Error401SBSAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
