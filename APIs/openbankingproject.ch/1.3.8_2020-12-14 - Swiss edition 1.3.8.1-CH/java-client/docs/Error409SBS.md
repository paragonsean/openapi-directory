...
|**additionalErrors** | [**List&lt;Error409SBSAdditionalErrorsInner&gt;**](Error409SBSAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
