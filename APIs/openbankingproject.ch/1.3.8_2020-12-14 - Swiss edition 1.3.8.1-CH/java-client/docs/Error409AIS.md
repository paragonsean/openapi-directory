...
|**additionalErrors** | [**List&lt;Error409AISAdditionalErrorsInner&gt;**](Error409AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
