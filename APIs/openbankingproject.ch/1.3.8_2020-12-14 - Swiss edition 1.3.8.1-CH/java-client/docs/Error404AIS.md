...
|**additionalErrors** | [**List&lt;Error404AISAdditionalErrorsInner&gt;**](Error404AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
