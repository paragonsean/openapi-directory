...
|**additionalErrors** | [**List&lt;Error401AISAdditionalErrorsInner&gt;**](Error401AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
