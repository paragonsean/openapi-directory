...
|------------ | ------------- | ------------- | -------------|
|**links** | **LinksTransactionDetails** |  |  [optional] |
...
|**bookingDate** | **LocalDate** | The date when an entry is posted to an account on the ASPSPs books.  |  [optional] |
...
|**entryDetails** | [**List&lt;EntryDetailsElement&gt;**](EntryDetailsElement.md) | Might be used by the ASPSP to transport details about transactions within a batch.  |  [optional] |
...
|**valueDate** | **LocalDate** | The Date at which assets become available to the account owner in case of a credit. |  [optional] |
