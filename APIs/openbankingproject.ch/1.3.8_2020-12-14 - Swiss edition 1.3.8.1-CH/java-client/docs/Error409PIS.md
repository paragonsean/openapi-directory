...
|**additionalErrors** | [**List&lt;Error409PISAdditionalErrorsInner&gt;**](Error409PISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
