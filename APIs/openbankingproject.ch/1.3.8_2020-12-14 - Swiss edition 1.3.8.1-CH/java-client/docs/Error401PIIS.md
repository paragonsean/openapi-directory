...
|**additionalErrors** | [**List&lt;Error401PIISAdditionalErrorsInner&gt;**](Error401PIISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
