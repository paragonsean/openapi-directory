...
|**additionalErrors** | [**List&lt;Error400SBSAdditionalErrorsInner&gt;**](Error400SBSAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
