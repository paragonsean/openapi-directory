...
|**additionalErrors** | [**List&lt;Error400PISAdditionalErrorsInner&gt;**](Error400PISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
