...
|**additionalErrors** | [**List&lt;Error405AISAdditionalErrorsInner&gt;**](Error405AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
