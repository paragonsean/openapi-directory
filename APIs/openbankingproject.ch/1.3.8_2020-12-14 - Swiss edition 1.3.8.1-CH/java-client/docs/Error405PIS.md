...
|**additionalErrors** | [**List&lt;Error405PISAdditionalErrorsInner&gt;**](Error405PISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
