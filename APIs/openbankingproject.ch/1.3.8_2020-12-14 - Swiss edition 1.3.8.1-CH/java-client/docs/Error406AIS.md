...
|**additionalErrors** | [**List&lt;Error406AISAdditionalErrorsInner&gt;**](Error406AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
