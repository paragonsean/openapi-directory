...
|**additionalErrors** | [**List&lt;Error405PISCANCAdditionalErrorsInner&gt;**](Error405PISCANCAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
