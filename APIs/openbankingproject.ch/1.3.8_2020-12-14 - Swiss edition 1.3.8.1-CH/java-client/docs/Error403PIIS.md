...
|**additionalErrors** | [**List&lt;Error403PIISAdditionalErrorsInner&gt;**](Error403PIISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
