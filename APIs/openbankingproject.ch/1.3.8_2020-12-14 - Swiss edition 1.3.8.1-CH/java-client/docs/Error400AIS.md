...
|**additionalErrors** | [**List&lt;Error400AISAdditionalErrorsInner&gt;**](Error400AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
