...
|**additionalErrors** | [**List&lt;Error401PISAdditionalErrorsInner&gt;**](Error401PISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
