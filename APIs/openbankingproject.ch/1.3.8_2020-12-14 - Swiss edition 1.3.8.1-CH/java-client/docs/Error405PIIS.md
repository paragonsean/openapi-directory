...
|**additionalErrors** | [**List&lt;Error405PIISAdditionalErrorsInner&gt;**](Error405PIISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
