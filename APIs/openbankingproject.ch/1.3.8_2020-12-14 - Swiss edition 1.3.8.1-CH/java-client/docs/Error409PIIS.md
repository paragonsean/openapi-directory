...
|**additionalErrors** | [**List&lt;Error409PIISAdditionalErrorsInner&gt;**](Error409PIISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
