...
|**additionalErrors** | [**List&lt;Error429AISAdditionalErrorsInner&gt;**](Error429AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
