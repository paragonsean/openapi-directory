...
|**additionalErrors** | [**List&lt;Error405SBSAdditionalErrorsInner&gt;**](Error405SBSAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
