...
|**additionalErrors** | [**List&lt;Error404PIISAdditionalErrorsInner&gt;**](Error404PIISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
