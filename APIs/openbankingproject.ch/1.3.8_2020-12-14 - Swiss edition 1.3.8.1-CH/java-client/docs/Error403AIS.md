...
|**additionalErrors** | [**List&lt;Error403AISAdditionalErrorsInner&gt;**](Error403AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
...
|**type** | **URI** | A URI reference [RFC3986] that identifies the problem type. Remark For Future: These URI will be provided by NextGen in future.  |  |
