...
|**additionalErrors** | [**List&lt;Error400PIISAdditionalErrorsInner&gt;**](Error400PIISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
