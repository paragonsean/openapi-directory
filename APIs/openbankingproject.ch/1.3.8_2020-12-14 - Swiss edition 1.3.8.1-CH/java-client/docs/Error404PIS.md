...
|**additionalErrors** | [**List&lt;Error404PISAdditionalErrorsInner&gt;**](Error404PISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
