...
|------------ | ------------- | ------------- | -------------|
|**acceptorTransactionDateTime** | **OffsetDateTime** | Timestamp of the actual card transaction within the acceptance system |  [optional] |
...
|**transactionDate** | **LocalDate** | Date of the actual card transaction. |  [optional] |
