...
|**additionalErrors** | [**List&lt;Error404SBSAdditionalErrorsInner&gt;**](Error404SBSAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional] |
