# SwissNextGenBankingApiFramework.Error403PIIS
...
**additionalErrors** | [**[Error403PIISAdditionalErrorsInner]**](Error403PIISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
**code** | [**MessageCode403PIIS**](MessageCode403PIIS.md) |  | 
