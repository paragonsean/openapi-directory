# SwissNextGenBankingApiFramework.Error429AIS
...
**additionalErrors** | [**[Error429AISAdditionalErrorsInner]**](Error429AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
**code** | [**MessageCode429AIS**](MessageCode429AIS.md) |  | 
