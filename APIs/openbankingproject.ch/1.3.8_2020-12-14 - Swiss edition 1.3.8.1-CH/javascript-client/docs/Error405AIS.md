# SwissNextGenBankingApiFramework.Error405AIS
...
**additionalErrors** | [**[Error405AISAdditionalErrorsInner]**](Error405AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
