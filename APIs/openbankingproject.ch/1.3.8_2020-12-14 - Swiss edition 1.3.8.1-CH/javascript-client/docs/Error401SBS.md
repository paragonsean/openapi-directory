# SwissNextGenBankingApiFramework.Error401SBS
...
**additionalErrors** | [**[Error401SBSAdditionalErrorsInner]**](Error401SBSAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
**code** | [**MessageCode401SBS**](MessageCode401SBS.md) |  | 
