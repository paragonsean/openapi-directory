# SwissNextGenBankingApiFramework.Error405PIS
...
**additionalErrors** | [**[Error405PISAdditionalErrorsInner]**](Error405PISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
