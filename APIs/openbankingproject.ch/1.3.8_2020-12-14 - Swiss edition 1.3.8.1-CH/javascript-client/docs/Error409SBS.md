# SwissNextGenBankingApiFramework.Error409SBS
...
**additionalErrors** | [**[Error409SBSAdditionalErrorsInner]**](Error409SBSAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
