# SwissNextGenBankingApiFramework.Error403SBS
...
**additionalErrors** | [**[Error403SBSAdditionalErrorsInner]**](Error403SBSAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
