# SwissNextGenBankingApiFramework.Error409AIS
...
**additionalErrors** | [**[Error409AISAdditionalErrorsInner]**](Error409AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
**code** | [**MessageCode409AIS**](MessageCode409AIS.md) |  | 
