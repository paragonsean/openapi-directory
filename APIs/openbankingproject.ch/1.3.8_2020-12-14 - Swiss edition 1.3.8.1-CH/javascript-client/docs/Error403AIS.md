# SwissNextGenBankingApiFramework.Error403AIS
...
**additionalErrors** | [**[Error403AISAdditionalErrorsInner]**](Error403AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
