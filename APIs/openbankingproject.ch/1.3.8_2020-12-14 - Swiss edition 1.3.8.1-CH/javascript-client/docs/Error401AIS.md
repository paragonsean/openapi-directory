# SwissNextGenBankingApiFramework.Error401AIS
...
**additionalErrors** | [**[Error401AISAdditionalErrorsInner]**](Error401AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
**code** | [**MessageCode401AIS**](MessageCode401AIS.md) |  | 
