# SwissNextGenBankingApiFramework.Error405PISCANC
...
**additionalErrors** | [**[Error405PISCANCAdditionalErrorsInner]**](Error405PISCANCAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
**code** | [**MessageCode405PISCANC**](MessageCode405PISCANC.md) |  | 
