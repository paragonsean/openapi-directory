# SwissNextGenBankingApiFramework.Error404PIS
...
**additionalErrors** | [**[Error404PISAdditionalErrorsInner]**](Error404PISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
**code** | [**MessageCode404PIS**](MessageCode404PIS.md) |  | 
