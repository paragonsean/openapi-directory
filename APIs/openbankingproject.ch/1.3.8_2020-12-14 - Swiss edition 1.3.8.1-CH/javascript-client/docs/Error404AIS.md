# SwissNextGenBankingApiFramework.Error404AIS
...
**additionalErrors** | [**[Error404AISAdditionalErrorsInner]**](Error404AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
**code** | [**MessageCode404AIS**](MessageCode404AIS.md) |  | 
