# SwissNextGenBankingApiFramework.Error400PIIS
...
**additionalErrors** | [**[Error400PIISAdditionalErrorsInner]**](Error400PIISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
**code** | [**MessageCode400PIIS**](MessageCode400PIIS.md) |  | 
