# SwissNextGenBankingApiFramework.Error400SBS
...
**additionalErrors** | [**[Error400SBSAdditionalErrorsInner]**](Error400SBSAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
