# SwissNextGenBankingApiFramework.Error409PIIS
...
**additionalErrors** | [**[Error409PIISAdditionalErrorsInner]**](Error409PIISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
