# SwissNextGenBankingApiFramework.Error401PIIS
...
**additionalErrors** | [**[Error401PIISAdditionalErrorsInner]**](Error401PIISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
