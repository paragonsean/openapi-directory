# SwissNextGenBankingApiFramework.Error404SBS
...
**additionalErrors** | [**[Error404SBSAdditionalErrorsInner]**](Error404SBSAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
**code** | [**MessageCode404SBS**](MessageCode404SBS.md) |  | 
