# SwissNextGenBankingApiFramework.Error403PIS
...
**additionalErrors** | [**[Error403PISAdditionalErrorsInner]**](Error403PISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
