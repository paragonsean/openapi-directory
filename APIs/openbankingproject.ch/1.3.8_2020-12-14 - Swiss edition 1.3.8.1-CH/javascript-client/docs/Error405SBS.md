# SwissNextGenBankingApiFramework.Error405SBS
...
**additionalErrors** | [**[Error405SBSAdditionalErrorsInner]**](Error405SBSAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
**code** | [**MessageCode405SBS**](MessageCode405SBS.md) |  | 
