# SwissNextGenBankingApiFramework.Error406AIS
...
**additionalErrors** | [**[Error406AISAdditionalErrorsInner]**](Error406AISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
