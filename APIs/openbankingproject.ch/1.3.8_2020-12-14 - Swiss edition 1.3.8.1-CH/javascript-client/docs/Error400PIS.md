# SwissNextGenBankingApiFramework.Error400PIS
...
**additionalErrors** | [**[Error400PISAdditionalErrorsInner]**](Error400PISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
