# SwissNextGenBankingApiFramework.Error404PIIS
...
**additionalErrors** | [**[Error404PIISAdditionalErrorsInner]**](Error404PIISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
