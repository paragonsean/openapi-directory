# SwissNextGenBankingApiFramework.Balance
...
**lastChangeDateTime** | **Date** | This data element might be used to indicate e.g. with the expected or booked balance that no action is known on the account, which is not yet booked.  | [optional] 
...
**referenceDate** | **Date** | Indicates the date of the balance. | [optional] 
