# SwissNextGenBankingApiFramework.Error405PIIS
...
**additionalErrors** | [**[Error405PIISAdditionalErrorsInner]**](Error405PIISAdditionalErrorsInner.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
**code** | [**MessageCode405PIIS**](MessageCode405PIIS.md) |  | 
