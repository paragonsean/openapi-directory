...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.ListGroups200ResponseGroupsInner();
  });
  ...
  describe('ListGroups200ResponseGroupsInner', function() {
    it('should create an instance of ListGroups200ResponseGroupsInner', function() {
      // uncomment below and update the code to test ListGroups200ResponseGroupsInner
      //var instance = new DiscourseApiDocumentation.ListGroups200ResponseGroupsInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.ListGroups200ResponseGroupsInner);
    });
    ...
    it('should have the property isGroupOwner (base name: "is_group_owner")', function() {
      // uncomment below and update the code to test the property isGroupOwner
      //var instance = new DiscourseApiDocumentation.ListGroups200ResponseGroupsInner();
      //expect(instance).to.be();
    });
