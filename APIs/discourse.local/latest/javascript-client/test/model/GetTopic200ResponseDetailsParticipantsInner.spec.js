...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.GetTopic200ResponseDetailsParticipantsInner();
  });
  ...
  describe('GetTopic200ResponseDetailsParticipantsInner', function() {
    it('should create an instance of GetTopic200ResponseDetailsParticipantsInner', function() {
      // uncomment below and update the code to test GetTopic200ResponseDetailsParticipantsInner
      //var instance = new DiscourseApiDocumentation.GetTopic200ResponseDetailsParticipantsInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.GetTopic200ResponseDetailsParticipantsInner);
    });
