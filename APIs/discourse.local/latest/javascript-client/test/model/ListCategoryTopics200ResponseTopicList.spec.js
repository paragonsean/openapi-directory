...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.ListCategoryTopics200ResponseTopicList();
  });
  ...
  describe('ListCategoryTopics200ResponseTopicList', function() {
    it('should create an instance of ListCategoryTopics200ResponseTopicList', function() {
      // uncomment below and update the code to test ListCategoryTopics200ResponseTopicList
      //var instance = new DiscourseApiDocumentation.ListCategoryTopics200ResponseTopicList();
      //expect(instance).to.be.a(DiscourseApiDocumentation.ListCategoryTopics200ResponseTopicList);
    });
