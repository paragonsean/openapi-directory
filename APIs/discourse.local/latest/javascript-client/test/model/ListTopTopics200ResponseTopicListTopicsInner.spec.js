...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.ListTopTopics200ResponseTopicListTopicsInner();
  });
  ...
  describe('ListTopTopics200ResponseTopicListTopicsInner', function() {
    it('should create an instance of ListTopTopics200ResponseTopicListTopicsInner', function() {
      // uncomment below and update the code to test ListTopTopics200ResponseTopicListTopicsInner
      //var instance = new DiscourseApiDocumentation.ListTopTopics200ResponseTopicListTopicsInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.ListTopTopics200ResponseTopicListTopicsInner);
    });
    ...
    it('should have the property opLikeCount (base name: "op_like_count")', function() {
      // uncomment below and update the code to test the property opLikeCount
      //var instance = new DiscourseApiDocumentation.ListTopTopics200ResponseTopicListTopicsInner();
      //expect(instance).to.be();
    });
