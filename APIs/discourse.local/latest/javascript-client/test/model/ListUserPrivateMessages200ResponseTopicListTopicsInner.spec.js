...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.ListUserPrivateMessages200ResponseTopicListTopicsInner();
  });
  ...
  describe('ListUserPrivateMessages200ResponseTopicListTopicsInner', function() {
    it('should create an instance of ListUserPrivateMessages200ResponseTopicListTopicsInner', function() {
      // uncomment below and update the code to test ListUserPrivateMessages200ResponseTopicListTopicsInner
      //var instance = new DiscourseApiDocumentation.ListUserPrivateMessages200ResponseTopicListTopicsInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.ListUserPrivateMessages200ResponseTopicListTopicsInner);
    });

    it('should have the property allowedUserCount (base name: "allowed_user_count")', function() {
      // uncomment below and update the code to test the property allowedUserCount
      //var instance = new DiscourseApiDocumentation.ListUserPrivateMessages200ResponseTopicListTopicsInner();
    ...
    it('should have the property lastPosterUsername (base name: "last_poster_username")', function() {
      // uncomment below and update the code to test the property lastPosterUsername
      //var instance = new DiscourseApiDocumentation.ListUserPrivateMessages200ResponseTopicListTopicsInner();
      //expect(instance).to.be();
    });

    it('should have the property lastReadPostNumber (base name: "last_read_post_number")', function() {
      // uncomment below and update the code to test the property lastReadPostNumber
      //var instance = new DiscourseApiDocumentation.ListUserPrivateMessages200ResponseTopicListTopicsInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property unreadPosts (base name: "unread_posts")', function() {
      // uncomment below and update the code to test the property unreadPosts
      //var instance = new DiscourseApiDocumentation.ListUserPrivateMessages200ResponseTopicListTopicsInner();
      //expect(instance).to.be();
    });
