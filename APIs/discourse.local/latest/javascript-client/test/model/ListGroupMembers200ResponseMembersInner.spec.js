...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.ListGroupMembers200ResponseMembersInner();
  });
  ...
  describe('ListGroupMembers200ResponseMembersInner', function() {
    it('should create an instance of ListGroupMembers200ResponseMembersInner', function() {
      // uncomment below and update the code to test ListGroupMembers200ResponseMembersInner
      //var instance = new DiscourseApiDocumentation.ListGroupMembers200ResponseMembersInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.ListGroupMembers200ResponseMembersInner);
    });
