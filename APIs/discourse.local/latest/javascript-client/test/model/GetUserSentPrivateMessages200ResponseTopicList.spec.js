...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.GetUserSentPrivateMessages200ResponseTopicList();
  });
  ...
  describe('GetUserSentPrivateMessages200ResponseTopicList', function() {
    it('should create an instance of GetUserSentPrivateMessages200ResponseTopicList', function() {
      // uncomment below and update the code to test GetUserSentPrivateMessages200ResponseTopicList
      //var instance = new DiscourseApiDocumentation.GetUserSentPrivateMessages200ResponseTopicList();
      //expect(instance).to.be.a(DiscourseApiDocumentation.GetUserSentPrivateMessages200ResponseTopicList);
    });
