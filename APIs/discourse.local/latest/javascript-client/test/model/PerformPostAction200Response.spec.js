...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.PerformPostAction200Response();
  });
  ...
  describe('PerformPostAction200Response', function() {
    it('should create an instance of PerformPostAction200Response', function() {
      // uncomment below and update the code to test PerformPostAction200Response
      //var instance = new DiscourseApiDocumentation.PerformPostAction200Response();
      //expect(instance).to.be.a(DiscourseApiDocumentation.PerformPostAction200Response);
    });
