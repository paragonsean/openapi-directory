...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.GetTag200ResponseTopicList();
  });
  ...
  describe('GetTag200ResponseTopicList', function() {
    it('should create an instance of GetTag200ResponseTopicList', function() {
      // uncomment below and update the code to test GetTag200ResponseTopicList
      //var instance = new DiscourseApiDocumentation.GetTag200ResponseTopicList();
      //expect(instance).to.be.a(DiscourseApiDocumentation.GetTag200ResponseTopicList);
    });
