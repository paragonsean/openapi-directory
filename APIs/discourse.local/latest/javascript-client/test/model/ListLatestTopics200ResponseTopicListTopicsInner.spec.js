...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.ListLatestTopics200ResponseTopicListTopicsInner();
  });
  ...
  describe('ListLatestTopics200ResponseTopicListTopicsInner', function() {
    it('should create an instance of ListLatestTopics200ResponseTopicListTopicsInner', function() {
      // uncomment below and update the code to test ListLatestTopics200ResponseTopicListTopicsInner
      //var instance = new DiscourseApiDocumentation.ListLatestTopics200ResponseTopicListTopicsInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.ListLatestTopics200ResponseTopicListTopicsInner);
    });
