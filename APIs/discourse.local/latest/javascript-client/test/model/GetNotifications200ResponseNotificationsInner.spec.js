...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.GetNotifications200ResponseNotificationsInner();
  });
  ...
  describe('GetNotifications200ResponseNotificationsInner', function() {
    it('should create an instance of GetNotifications200ResponseNotificationsInner', function() {
      // uncomment below and update the code to test GetNotifications200ResponseNotificationsInner
      //var instance = new DiscourseApiDocumentation.GetNotifications200ResponseNotificationsInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.GetNotifications200ResponseNotificationsInner);
    });
