...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.CreateInvite200Response();
  });
  ...
  describe('CreateInvite200Response', function() {
    it('should create an instance of CreateInvite200Response', function() {
      // uncomment below and update the code to test CreateInvite200Response
      //var instance = new DiscourseApiDocumentation.CreateInvite200Response();
      //expect(instance).to.be.a(DiscourseApiDocumentation.CreateInvite200Response);
    });
