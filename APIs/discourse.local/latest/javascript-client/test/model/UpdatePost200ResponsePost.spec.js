...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.UpdatePost200ResponsePost();
  });
  ...
  describe('UpdatePost200ResponsePost', function() {
    it('should create an instance of UpdatePost200ResponsePost', function() {
      // uncomment below and update the code to test UpdatePost200ResponsePost
      //var instance = new DiscourseApiDocumentation.UpdatePost200ResponsePost();
      //expect(instance).to.be.a(DiscourseApiDocumentation.UpdatePost200ResponsePost);
    });
