...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.ListCategoryTopics200ResponseTopicListTopicsInner();
  });
  ...
  describe('ListCategoryTopics200ResponseTopicListTopicsInner', function() {
    it('should create an instance of ListCategoryTopics200ResponseTopicListTopicsInner', function() {
      // uncomment below and update the code to test ListCategoryTopics200ResponseTopicListTopicsInner
      //var instance = new DiscourseApiDocumentation.ListCategoryTopics200ResponseTopicListTopicsInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.ListCategoryTopics200ResponseTopicListTopicsInner);
    });
