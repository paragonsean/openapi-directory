...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.GetUserSentPrivateMessages200ResponseTopicListTopicsInner();
  });
  ...
  describe('GetUserSentPrivateMessages200ResponseTopicListTopicsInner', function() {
    it('should create an instance of GetUserSentPrivateMessages200ResponseTopicListTopicsInner', function() {
      // uncomment below and update the code to test GetUserSentPrivateMessages200ResponseTopicListTopicsInner
      //var instance = new DiscourseApiDocumentation.GetUserSentPrivateMessages200ResponseTopicListTopicsInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.GetUserSentPrivateMessages200ResponseTopicListTopicsInner);
    });
