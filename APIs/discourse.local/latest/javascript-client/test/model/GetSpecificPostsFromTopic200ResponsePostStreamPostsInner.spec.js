...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.GetSpecificPostsFromTopic200ResponsePostStreamPostsInner();
  });
  ...
  describe('GetSpecificPostsFromTopic200ResponsePostStreamPostsInner', function() {
    it('should create an instance of GetSpecificPostsFromTopic200ResponsePostStreamPostsInner', function() {
      // uncomment below and update the code to test GetSpecificPostsFromTopic200ResponsePostStreamPostsInner
      //var instance = new DiscourseApiDocumentation.GetSpecificPostsFromTopic200ResponsePostStreamPostsInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.GetSpecificPostsFromTopic200ResponsePostStreamPostsInner);
    });
