...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.AdminGetUser200ResponseGroupsInner();
  });
  ...
  describe('AdminGetUser200ResponseGroupsInner', function() {
    it('should create an instance of AdminGetUser200ResponseGroupsInner', function() {
      // uncomment below and update the code to test AdminGetUser200ResponseGroupsInner
      //var instance = new DiscourseApiDocumentation.AdminGetUser200ResponseGroupsInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.AdminGetUser200ResponseGroupsInner);
    });
