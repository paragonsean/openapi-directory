...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.GetTopic200ResponsePostStreamPostsInner();
  });
  ...
  describe('GetTopic200ResponsePostStreamPostsInner', function() {
    it('should create an instance of GetTopic200ResponsePostStreamPostsInner', function() {
      // uncomment below and update the code to test GetTopic200ResponsePostStreamPostsInner
      //var instance = new DiscourseApiDocumentation.GetTopic200ResponsePostStreamPostsInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.GetTopic200ResponsePostStreamPostsInner);
    });
    ...
    it('should have the property linkCounts (base name: "link_counts")', function() {
      // uncomment below and update the code to test the property linkCounts
      //var instance = new DiscourseApiDocumentation.GetTopic200ResponsePostStreamPostsInner();
      //expect(instance).to.be();
    });
