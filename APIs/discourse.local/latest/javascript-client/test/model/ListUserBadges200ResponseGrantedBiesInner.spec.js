...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.ListUserBadges200ResponseGrantedBiesInner();
  });
  ...
  describe('ListUserBadges200ResponseGrantedBiesInner', function() {
    it('should create an instance of ListUserBadges200ResponseGrantedBiesInner', function() {
      // uncomment below and update the code to test ListUserBadges200ResponseGrantedBiesInner
      //var instance = new DiscourseApiDocumentation.ListUserBadges200ResponseGrantedBiesInner();
      //expect(instance).to.be.a(DiscourseApiDocumentation.ListUserBadges200ResponseGrantedBiesInner);
    });
