...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.ListLatestTopics200ResponseTopicList();
  });
  ...
  describe('ListLatestTopics200ResponseTopicList', function() {
    it('should create an instance of ListLatestTopics200ResponseTopicList', function() {
      // uncomment below and update the code to test ListLatestTopics200ResponseTopicList
      //var instance = new DiscourseApiDocumentation.ListLatestTopics200ResponseTopicList();
      //expect(instance).to.be.a(DiscourseApiDocumentation.ListLatestTopics200ResponseTopicList);
    });
