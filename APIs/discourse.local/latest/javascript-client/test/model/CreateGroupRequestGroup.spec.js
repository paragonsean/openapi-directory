...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.CreateGroupRequestGroup();
  });
  ...
  describe('CreateGroupRequestGroup', function() {
    it('should create an instance of CreateGroupRequestGroup', function() {
      // uncomment below and update the code to test CreateGroupRequestGroup
      //var instance = new DiscourseApiDocumentation.CreateGroupRequestGroup();
      //expect(instance).to.be.a(DiscourseApiDocumentation.CreateGroupRequestGroup);
    });
