...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.ListTopTopics200ResponseTopicList();
  });
  ...
  describe('ListTopTopics200ResponseTopicList', function() {
    it('should create an instance of ListTopTopics200ResponseTopicList', function() {
      // uncomment below and update the code to test ListTopTopics200ResponseTopicList
      //var instance = new DiscourseApiDocumentation.ListTopTopics200ResponseTopicList();
      //expect(instance).to.be.a(DiscourseApiDocumentation.ListTopTopics200ResponseTopicList);
    });
    ...
    it('should have the property forPeriod (base name: "for_period")', function() {
      // uncomment below and update the code to test the property forPeriod
      //var instance = new DiscourseApiDocumentation.ListTopTopics200ResponseTopicList();
      //expect(instance).to.be();
    });
