...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.ListUserPrivateMessages200ResponseTopicList();
  });
  ...
  describe('ListUserPrivateMessages200ResponseTopicList', function() {
    it('should create an instance of ListUserPrivateMessages200ResponseTopicList', function() {
      // uncomment below and update the code to test ListUserPrivateMessages200ResponseTopicList
      //var instance = new DiscourseApiDocumentation.ListUserPrivateMessages200ResponseTopicList();
      //expect(instance).to.be.a(DiscourseApiDocumentation.ListUserPrivateMessages200ResponseTopicList);
    });
