...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.CreateUserRequest();
  });
  ...
  describe('CreateUserRequest', function() {
    it('should create an instance of CreateUserRequest', function() {
      ...
      //var instance = new DiscourseApiDocumentation.CreateUserRequest();
      //expect(instance).to.be.a(DiscourseApiDocumentation.CreateUserRequest);
    });
    ...
    it('should have the property userFields1 (base name: "user_fields[1]")', function() {
      // uncomment below and update the code to test the property userFields1
      //var instance = new DiscourseApiDocumentation.CreateUserRequest();
      //expect(instance).to.be();
    });
