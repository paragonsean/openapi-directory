...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.InvitesApi();
  });
  ...
  describe('InvitesApi', function() {
    ...
    describe('inviteToTopic_0', function() {
      it('should call inviteToTopic_0 successfully', function(done) {
        //uncomment below and update the code to test inviteToTopic_0
        //instance.inviteToTopic_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
