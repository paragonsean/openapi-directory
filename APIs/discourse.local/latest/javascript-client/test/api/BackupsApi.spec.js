...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.BackupsApi();
  });
  ...
  describe('BackupsApi', function() {
    ...
    describe('downloadBackup', function() {
      it('should call downloadBackup successfully', function(done) {
        //uncomment below and update the code to test downloadBackup
        //instance.downloadBackup(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('sendDownloadBackupEmail', function() {
      it('should call sendDownloadBackupEmail successfully', function(done) {
        //uncomment below and update the code to test sendDownloadBackupEmail
        //instance.sendDownloadBackupEmail(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
