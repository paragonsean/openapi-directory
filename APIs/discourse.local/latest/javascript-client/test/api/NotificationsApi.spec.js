...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.NotificationsApi();
  });
  ...
  describe('NotificationsApi', function() {
    ...
    describe('markNotificationsAsRead', function() {
      it('should call markNotificationsAsRead successfully', function(done) {
        //uncomment below and update the code to test markNotificationsAsRead
        //instance.markNotificationsAsRead(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
