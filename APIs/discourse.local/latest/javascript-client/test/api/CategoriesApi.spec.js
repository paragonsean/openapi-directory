...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscourseApiDocumentation.CategoriesApi();
  });
  ...
  describe('CategoriesApi', function() {
    ...
    describe('getSite_0', function() {
      it('should call getSite_0 successfully', function(done) {
        //uncomment below and update the code to test getSite_0
        //instance.getSite_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listCategoryTopics', function() {
      it('should call listCategoryTopics successfully', function(done) {
        //uncomment below and update the code to test listCategoryTopics
        //instance.listCategoryTopics(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
