...
import UpdatePostRequestPost from './UpdatePostRequestPost';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('post')) {
                obj['post'] = UpdatePostRequestPost.constructFromObject(data['post']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/UpdatePostRequestPost} post
 */
UpdatePostRequest.prototype['post'] = undefined;
